...
var flatbuffers = (() => {
  ...
  var _ = I(l => {
    ...
    l.SIZE_PREFIX_LENGTH = l.FILE_IDENTIFIER_LENGTH = l.SIZEOF_INT = l.SIZEOF_SHORT = void 0;
    l.SIZEOF_SHORT = 2;
    l.SIZEOF_INT = 4;
  ...
  var T = I(b => {
    ...
    var j;
    (function(u) {
      u[u.UTF8_BYTES = 1] = "UTF8_BYTES", u[u.UTF16_STRING = 2] = "UTF16_STRING"
  ...
  var N = I(F => {
    ...
    var d = _(),
      ...
      f = class {
        ...
        readFloat64(t) {
          return a.int32[a.isLittleEndian ? 0 : 1] = this.readInt32(t), a.int32[a.isLittleEndian ? 1 : 0] = this.readInt32(t + 4), a.float64[0]
        }
        writeInt8(t, e) {
          this.bytes_[t] = e
        }
        ...
        writeFloat64(t, e) {
          a.float64[0] = e, this.writeInt32(t, a.int32[a.isLittleEndian ? 0 : 1]), this.writeInt32(t + 4, a.int32[a.isLittleEndian ? 1 : 0])
        }
        getBufferIdentifier() {
          if (this.bytes_.length < this.position_ + d.SIZEOF_INT + d.FILE_IDENTIFIER_LENGTH) throw new Error("FlatBuffers: ByteBuffer is too short to contain an identifier.");
          let t = "";
          for (let e = 0; e < d.FILE_IDENTIFIER_LENGTH; e++) t += String.fromCharCode(this.readInt8(this.position_ + d.SIZEOF_INT + e));
          return t
        }
        __offset(t, e) {
        ...
        __has_identifier(t) {
          if (t.length != d.FILE_IDENTIFIER_LENGTH) throw new Error("FlatBuffers: file identifier must be length " + d.FILE_IDENTIFIER_LENGTH);
          for (let e = 0; e < d.FILE_IDENTIFIER_LENGTH; e++)
            if (t.charCodeAt(e) != this.readInt8(this.position() + d.SIZEOF_INT + e)) return !1;
          return !0
        }
    ...
    var S = N(),
      ...
      E = class {
        constructor(t) {
          ...
          let e;
          t ? e = t : e = 1024, this.bb = S.ByteBuffer.allocate(e), this.space = e
        }
        clear() {
        ...
        prep(t, e) {
          ...
          for (; this.space < i + t + e;) {
            ...
            this.bb = E.growByteBuffer(this.bb), this.space += this.bb.capacity() - s
          }
          this.pad(i)
        }
        pad(t) {
        ...
        addOffset(t) {
          this.prep(h.SIZEOF_INT, 0), this.writeInt32(this.offset() - t + h.SIZEOF_INT)
        }
        startObject(t) {
          ...
          t: for (e = 0; e < this.vtables.length; e++) {
            ...
            if (n == this.bb.readInt16(O)) {
              for (let p = h.SIZEOF_SHORT; p < n; p += h.SIZEOF_SHORT)
                if (this.bb.readInt16(B + p) != this.bb.readInt16(O + p)) continue t;
              c = this.vtables[e];
              break
            }
          }
        ...
        finish(t, e, i) {
          ...
          if (e) {
            let n = e;
            if (this.prep(this.minalign, h.SIZEOF_INT + h.FILE_IDENTIFIER_LENGTH + s), n.length != h.FILE_IDENTIFIER_LENGTH) throw new TypeError("FlatBuffers: file identifier must be length " + h.FILE_IDENTIFIER_LENGTH);
            for (let c = h.FILE_IDENTIFIER_LENGTH - 1; c >= 0; c--) this.writeInt8(n.charCodeAt(c))
          }
          this.prep(this.minalign, h.SIZEOF_INT + s), this.addOffset(t), s && this.addInt32(this.bb.capacity() - this.space), this.bb.setPosition(this.space)
        }
        ...
        requiredField(t, e) {
          ...
          if (!(e < this.bb.readInt16(s) && this.bb.readInt16(s + e) != 0)) throw new TypeError("FlatBuffers: field " + e + " must be set")
        }
        startVector(t, e, i) {
          this.notNested(), this.vector_num_elems = e, this.prep(h.SIZEOF_INT, t * e), this.prep(i, t * e)
        }
        endVector() {
        ...
        createString(t) {
          ...
          for (let i = 0, s = this.space, n = this.bb.bytes(); i < e.length; i++) n[s++] = e[i];
  ...
  var D = I(r => {
    ...
    r.ByteBuffer = r.Builder = r.Encoding = r.isLittleEndian = r.float64 = r.float32 = r.int32 = r.SIZE_PREFIX_LENGTH = r.FILE_IDENTIFIER_LENGTH = r.SIZEOF_INT = r.SIZEOF_SHORT = void 0;
    var v = _();
