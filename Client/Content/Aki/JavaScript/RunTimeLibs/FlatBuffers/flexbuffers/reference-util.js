...
exports.keyForIndex = exports.diffKeys = exports.keyIndex = exports.indirect = exports.readFloat = exports.readUInt = exports.readInt = exports.validateOffset = undefined;
...
function diffKeys(input, index, dataView, offset, width) {
  ...
  if (dataView.getUint8(keyIndirectOffset + input.length) === 0) {
    return 0;
  } else {
    return -1;
  }
