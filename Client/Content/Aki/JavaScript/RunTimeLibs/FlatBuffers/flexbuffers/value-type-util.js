...
function isTypedVectorElement(value) {
  return value === value_type_js_1.ValueType.BOOL || value >= value_type_js_1.ValueType.INT && value <= value_type_js_1.ValueType.STRING;
}
exports.isTypedVectorElement = isTypedVectorElement;
function isTypedVector(value) {
  return value === value_type_js_1.ValueType.VECTOR_BOOL || value >= value_type_js_1.ValueType.VECTOR_INT && value <= value_type_js_1.ValueType.VECTOR_STRING_DEPRECATED;
}
...
function isAVector(value) {
  return isTypedVector(value) || isFixedTypedVector(value) || value === value_type_js_1.ValueType.VECTOR;
}
