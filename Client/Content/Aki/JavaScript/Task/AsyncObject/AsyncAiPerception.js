...
class AsyncAiPerception {
  ...
  OnTick(perceptionHandle, lineTrace) {
    ...
    this._private_IsEntitiesToAddDirty = false;
    this._private_IsEntitiesNotSenseDirty = false;
    cpp_1.FAiModel.InitTsAsyncAiPerceptionData(this._private_PerceptionData, this._private_ActivateAiSenseObjects, this._private_EntitiesRemoveTime, this._private_EntitiesInSense);
    this._private_FindNewInSenseActor();
    this._private_FindOutSenseActor();
    cpp_1.FAiModel.UpdateAsyncAiPerceptionData(this._private_PerceptionData, this._private_IsEntitiesRemoveTimeDirty ? this._private_EntitiesRemoveTime : undefined, this._private_IsEntitiesInSenseDirty ? this._private_EntitiesInSense : undefined, this._private_IsEntitiesToAddDirty ? this._private_EntitiesToAdd : undefined, this._private_IsEntitiesNotSenseDirty ? this._private_EntitiesNotSense : undefined);
    this._private_PerceptionData = undefined;
    this._private_EntityData = undefined;
    this._private_LineTrace = undefined;
  }
  _private_FindNewInSenseActor() {
    ...
    for (const [senseTargetType, activateAiSenseObjectSet] of this._private_ActivateAiSenseObjects) {
  ...
  _private_IsActorInSense(entity, selfLocation, inSenseBefore, senseTargetType, debugLog = false) {
    ...
    const activateAiSenseObjects = this._private_ActivateAiSenseObjects.get(senseTargetType);
