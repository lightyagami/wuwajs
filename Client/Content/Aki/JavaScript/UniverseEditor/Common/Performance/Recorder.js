...
class PerfRecorder {
  ...
  Measure(t, r, s, i = 2) {
    ...
    if (n) {
      let e = void 0;
      s && !(e = this.TAa.get(s)) ? (0, Log_1.error)(`Measure ${t} failed, end mark not found.`) : (a = n.Timestamp, o = s ? e.Timestamp : Date.now(), this.Zho.push({
        Type: "measure",
        Path: (0, SouceMap_1.getCallerLocation)(i),
        Timestamp: Date.now(),
        Name: t,
        Duration: o - a
      }), n.IsTemp && this.TAa.delete(r), e?.IsTemp && this.TAa.delete(s))
...
function perfTiming(s, i, e) {
  ...
  return e.value = function(...e) {
    ...
    e = a.apply(this, e);
    return e instanceof Promise ? e.then(e => (exports.perfRecorder.Measure(r), e)) : (exports.perfRecorder.EndMeasure(r), e)
  }, e
}
exports.PerfRecorder = PerfRecorder, exports.perfRecorder = new PerfRecorder, exports.perfTiming = perfTiming;
