...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.getContextBranch = exports.getBranchFullNameFromShortName = exports.getBranchShortName = exports.getNearestSourceBranch = exports.branchToStream = exports.streamsToDepotBranches = exports.isBranchInRange = exports.isBranchDefined = exports.isReachBranch = exports.isWorkspacePreBranch = exports.isHigherBranch = exports.isLowerBranch = exports.getHigherBranches = exports.getLowerBranches = exports.getPlannedBranchSegment = exports.getBranchSegment = exports.getLatestBranch = exports.getEarliestBranch = exports.getAllBranches = exports.isInDevelopmentBranch = exports.isPulledDepotBranch = exports.isPlannedBranch = exports.getDefaultPlannedBranch = exports.getAllOperatingAndDevelopingBranches = exports.getAllPublishedBranches = exports.getAllPlannedBranches = exports.getAllDepotBranches = exports.getPlannedBranchDefineData = exports.getDepotBranchDefineData = void 0;
...
function getAllPublishedBranches() {
  return BranchConfig_1.allDepotBranchConfig.filter(e => e.IsPublished).map(e => e.Branch)
}

function getAllOperatingAndDevelopingBranches() {
  let e = void 0;
  var r = [];
  for (const n of BranchConfig_1.allDepotBranchConfig) n.IsPublished ? e = n.Branch : r.push(n.Branch);
  return e ? [e, ...r] : r
}
...
function isPlannedBranch(e) {
  for (const r of getAllPlannedBranches())
    if (e === r) return !0;
  return !1
}
...
function getAllBranches(e = !0) {
  return e ? (0, BranchConfig_1.getAllBranchConfigs)().map(e => e.Branch) : BranchConfig_1.allDepotBranchConfig.map(e => e.Branch)
}
...
function isBranchInRange(r, n, e) {
  ...
  if (!t.includes(r) || !t.includes(n)) throw new Error(`分支区间非法, 有不存在的分支：[${r}, ${n}]`);
...
function streamToDepotBranch(r) {
  return BranchConfig_1.allDepotBranchConfig.find(e => e.Stream === r)?.Branch
}
