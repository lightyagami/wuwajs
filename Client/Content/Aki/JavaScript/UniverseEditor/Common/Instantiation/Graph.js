...
class Node {
  constructor(t, s) {
    this.Key = t, this.Data = s, this.Incoming = new Map, this.Outgoing = new Map
  }
}
exports.Node = Node;
class Graph {
  ...
  RemoveNode(t) {
    const s = this.jDa(t);
    this.fZ.delete(s), this.fZ.forEach(t => {
