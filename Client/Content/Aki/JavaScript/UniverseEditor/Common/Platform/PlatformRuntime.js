...
class PlatformRuntime extends Interface_1.Platform {
  ...
  async ReadFileAsync(r) {
    return new Promise((t, e) => {
      const s = (e, r) => {
        (0, puerts_1.releaseManualReleaseDelegate)(s), t({
          IsSuccess: e,
          FileContent: r
        })
      };
      UE.EditorRuntimeOperations.ReadFileAsync(r, (0, puerts_1.toManualReleaseDelegate)(s))
    })
  }
  async ReadBatchFilesAsync(r) {
    return new Promise((s, e) => {
      const o = (r, e) => {
        ...
        var t = new Map;
        for (let e = 0; e < r.Num(); e++) t.set(r.Get(e).FilePath, r.Get(e).FileContent);
        s({
          FileMap: t,
          FailedFiles: this.HUa(e)
        })
      };
      UE.EditorRuntimeOperations.ReadBatchFilesAsync(this.VUa(r, UE.BuiltinString), (0, puerts_1.toManualReleaseDelegate)(o))
    })
  }
  WriteFile(e, r) {
  ...
  GetUserDirPath(e) {
    return this.GetAbsolutePath(UE.KismetSystemLibrary.GetPlatformUserDir() + "..") + "/" + e
  }
  ListFiles(e, r, t) {
    let s = void 0;
    if (s = t ? (t = (r = r?.startsWith(".") ? r.substring(1) : r) ? "*." + r : "*", UE.KuroStaticLibrary.GetFilesRecursive(e, t, !0, !1)) : (void 0 === r && (r = ""), UE.KuroStaticLibrary.GetFiles(e, r))) {
      var o = [];
  ...
  GetRelativePathToDir(e, r) {
    var r = r.endsWith("/") ? r : r + "/",
      t = (0, puerts_1.$ref)("");
    return UE.BlueprintPathsLibrary.MakePathRelativeTo(e, r, t), (0, puerts_1.$unref)(t)
  }
  GetAbsolutePath(e) {
  ...
  async DoJsonHttpReq(e, r, t) {
    ...
    return new Promise((s, o) => {
      const n = (e, r, t) => {
        (0, puerts_1.releaseManualReleaseDelegate)(n), e ? s({
          Status: r,
          Data: t ? JSON.parse(t) : void 0
        }) : o(new Error(`Http request failed, code: ${r}, response: ` + t))
      };
      UE.EditorRuntimeOperations.SendHttpRequest(e, r, i, t ? JSON.stringify(t) : "", (0, puerts_1.toManualReleaseDelegate)(n))
    })
  }
...
exports.PlatformRuntime = PlatformRuntime, exports.platformRuntime = new PlatformRuntime;
