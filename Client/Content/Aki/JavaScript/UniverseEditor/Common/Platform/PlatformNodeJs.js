...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.platformNodeJs = exports.PlatformNodeJs = exports.HttpClient = void 0;
...
class HttpClient {
  async QZl(e) {
    const {
      ...
      headers: r,
      data: a
    } = e, s = new url_1.URL(t), i = ("GET" === n && a && Object.keys(a).forEach(e => {
    ...
    return new Promise((r, s) => {
      ...
      e.on("error", e => {
        s(e)
      }), !a || "POST" !== n && "PUT" !== n || e.write(JSON.stringify(a)), e.end()
    })
  }
...
class PlatformNodeJs extends Interface_1.Platform {
  ...
  ReadFile(e) {
    return (0, fs_1.existsSync)(e) ? (0, fs_1.readFileSync)(e, "utf8").replace(/^\uFEFF/, "") : ""
  }
  async ReadFileAsync(e) {
    try {
      return {
        IsSuccess: !0,
        FileContent: (await (0, util_1.promisify)(fs_1.readFile)(e, {
          encoding: "utf8"
        })).replace(/^\uFEFF/, "")
      }
    } catch (e) {
  ...
  WriteFile(e, t) {
    ...
    (0, fs_1.existsSync)(r) || (0, fs_1.mkdirSync)(r, {
      recursive: !0
  ...
  CreateDir(e) {
    return void 0 !== (0, fs_1.mkdirSync)(e, {
      recursive: !0
    })
  }
  RemoveFile(t) {
    try {
      ...
      return e instanceof Error ? this.Log(2, e.message) : this.Log(2, "remove file failed: " + t), !1
    }
  }
  RemoveDir(e) {
    (0, fs_1.rmSync)(e, {
  ...
  De(t, r, s = []) {
    (0, fs_1.readdirSync)(t).forEach(e => {
      e = t + "/" + e;
      (0, fs_1.lstatSync)(e).isDirectory() && r && (s.push(e), this.De(e, r, s))
    })
  }
  ...
  Exec(t) {
    try {
      return [!0, (0, child_process_1.execSync)(t, {
        encoding: "utf8"
      })]
    } catch (e) {
      return e instanceof Error ? [!1, e.message] : [!1, `execute command failed. (${t})`]
    }
  }
  GetMacAddress() {
  ...
  GetPhysicMacAddress() {
    var [e, t] = this.Exec(`wmic path Win32_NetworkAdapter where "PNPDeviceID like '%PCI%' AND AdapterTypeID='0'" get name, MacAddress`);
    return e && t ? (e = t.split(`

`)[1].split(" ")[0].split(":"))[0] + e[1] + e[2] + e[3] + e[4] + e[5] : ""
  }
  GetPlatformType() {
    return 1
  }
  Oe(r, s, n, a = []) {
    (0, fs_1.existsSync)(r) && (s && !s.startsWith(".") && (s = "." + s), (0, fs_1.readdirSync)(r).forEach(e => {
      var t = r + "/" + e;
      (0, fs_1.lstatSync)(t).isDirectory() && n ? this.Oe(t, s, n, a) : s && path.extname(e) !== s || a.push(t)
    }))
  }
  Ae() {
  ...
  ReadUassetInfo(a) {
    if (a.endsWith(".uasset") && this.ExistFile(a)) {
      ...
      let e = !1,
        t = this.be("##KUROS##"),
        r = this.qe(t, a),
        s = (r < 0 && (t = this.Ue("##KUROS##"), r = this.qe(t, a), e = !0), void 0),
        n = -1;
      n = (s = e ? this.Ue("##KUROE##") : this.be("##KUROE##"), this.qe(s, a));
      var i = r + t.length;
      if (0 <= r && 0 <= n && i < n) {
  ...
  GetProcessImagePathsByName(e) {
    var e = (0, child_process_1.execSync)(`wmic process where "name='${e}.exe'" get ExecutablePath /format:value`).toString().match(/ExecutablePath=(.*)/g);
    return e ? (e = new Set(e.map(e => e.split("=")[1])), Array.from(e)) : []
  }
  GetProcessPathAndCommandLine(e) {
    var t = (0, child_process_1.execSync)(`wmic process where "name='${e}.exe'" get ExecutablePath,CommandLine /format:value`).toString().split("\n").filter(e => "" !== e.trim());
  ...
  GetProcessImagePathsByPort(e) {
    ...
    var n = [];
    for (const c of r) {
      var [a, i] = this.Exec(`wmic process where "ProcessId=${c}" get ExecutablePath`);
      a && (a = /ExecutablePath\s+(?<path>\S+)/.exec(i)) && a.groups?.path && n.push(a.groups.path)
    }
    return n
  }
  async ExecAsync(e) {
    return new Promise((s, n) => {
      try {
        (0, child_process_1.exec)(e, (e, t, r) => {
          r && this.Log(2, "execAsync log error: " + r), e && (this.Log(2, "execAsync error: " + JSON.stringify(e)), n(e)), s(t)
        })
      } catch (e) {
...
exports.PlatformNodeJs = PlatformNodeJs, exports.platformNodeJs = new PlatformNodeJs;
