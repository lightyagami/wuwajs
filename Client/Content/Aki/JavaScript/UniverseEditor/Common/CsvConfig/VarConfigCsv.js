...
const IVar_1 = require("../../Interface/IVar"),
  ...
  varConfigCsvFields = [(0, CsvLoader_1.createCsvField)({
    Name: "Id",
    CnName: "Id",
    Type: "Int",
    Filter: "1",
...
class VarConfigCsvLoader extends CsvLoader_1.CsvLoader {
  ...
  re(e) {
    ...
    r = "" === e.DefaultValue && "String" !== e.Type ? (0, IVar_1.getVarDefaultValue)(e.Type) : (0, Util_1.parseVarValue)(e.Type, e.DefaultValue), e.DefaultValue = r.toString()
  }
}
exports.VarConfigCsvLoader = VarConfigCsvLoader;
class VarConfigCsv extends CsvLoader_1.GlobalCsv {
  CreateDefault(e) {
    var r = this.GetAllRowsData().flatMap(e => e.Rows.map(e => e.Name)),
      r = (0, Util_1.getUniqueName)(r, e.Name, "");
    return {
      ...e,
      Name: r
    }
