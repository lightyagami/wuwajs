...
function toTable(t, e) {
  ...
  var r = t[0];
  if ("object" != typeof r) return (0, Log_1.warn)("The object is not an object. type = " + typeof r), "";
  ...
  for (let e = 0; e < n.length; e++) {
    var i = s[e],
      p = a.map(t => t[e]);
    c[e] = Math.max(i, p.reduce((t, e) => Math.max(t, e), 0))
  }
  var f, h = [];
  const v = [],
    L = (e?.HideId || (u = r.padEnd(g - (u - r.length), " "), v.push(u)), n.forEach((t, e) => {
      var r = t.length,
        o = s[e],
        e = c[e];
      v.push(t.padEnd(e - (o - r), " "))
    }), h.push(`| ${v.join(" | ")} |`), []);
  e?.HideId || L.push("-".repeat(g)), c.forEach(t => {
    L.push("-".repeat(t))
  }), h.push(`| ${L.join(" | ")} |`);
  for (const b of t) {
    const l = t.indexOf(b),
      O = [];
    e?.HideId || (f = (l + 1).toString().padEnd(g, " "), O.push(f)), o.forEach((t, e) => {
      var t = b[t],
        r = t.toString().length,
        o = a[l][e],
        e = c[e];
...
exports.getStringOutputLength = getStringOutputLength, exports.toTable = toTable;
