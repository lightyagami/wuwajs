...
class CircularQueue {
  constructor(t) {
    this.f7 = t, this.e4 = new Array(t), this.uAa = 0, this.cAa = -1, this.t6 = 0
  }
  mAa() {
    var t = 2 * this.f7,
      s = new Array(t);
  ...
  EnQueue(t) {
    this.IsFull() && this.mAa(), this.cAa = (this.cAa + 1) % this.f7, this.e4[this.cAa] = t, this.t6++
  }
  DeQueue() {
    var t;
    if (!this.IsEmpty()) return t = this.e4[this.uAa], this.uAa = (this.uAa + 1) % this.f7, this.t6--, t
  }
  Peek() {
