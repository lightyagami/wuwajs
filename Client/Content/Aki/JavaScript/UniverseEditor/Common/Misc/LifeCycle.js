...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.Disposable = exports.DisposableStore = exports.combinedDisposable = exports.toDisposable = exports.disposeIfDisposable = exports.isDisposable = exports.dispose = exports.markAsSingleton = exports.markAsDisposed = exports.trackDisposable = exports.setDisposableTracker = void 0;
...
function setParentOfDisposables(s, e) {
  if (disposableTracker)
    for (const o of s) disposableTracker.SetParent(o, e)
}
...
exports.setDisposableTracker = setDisposableTracker, exports.trackDisposable = trackDisposable, exports.markAsDisposed = markAsDisposed, exports.markAsSingleton = markAsSingleton, exports.dispose = dispose, exports.isDisposable = isDisposable, exports.disposeIfDisposable = disposeIfDisposable, exports.toDisposable = toDisposable, exports.combinedDisposable = combinedDisposable;
class DisposableStore {
  ...
  Add(s) {
    if (s) {
      ...
      setParentOfDisposable(s, this), this.vAa ? DisposableStore.DisableDisposedWarning || (0, Log_1.warn)(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack ?? "") : this.pAa.add(s)
    }
    return s
  }
...
class Disposable {
  constructor() {
    this.MAa = new DisposableStore, trackDisposable(this), setParentOfDisposable(this.MAa, this)
  }
  Dispose() {
...
}(exports.Disposable = Disposable).None = Object.freeze({
  Dispose() {}
});
