...
function fillDefault(t, i) {
  for (const o in i) {
    var s = t[o],
      e = i[o];
    void 0 === s ? t[o] = e : "object" == typeof e && ("object" != typeof s ? t[o] = e : e instanceof Array || fillDefault(s, e))
  }
}
class JsonConfig {
  constructor(t, i, s, e) {
    this.Name = t, this.Path = s || (0, File_1.getProjectPath)(SAVE_DIR) + `/${t}.json`, this.ce = (0, Util_1.deepCopyData)(i), this.Data = (0, Util_1.readJsonObj)(this.Path, i), this.Data !== i && fillDefault(this.Data, i), e && e(this.Data) && this.Save()
  }
  Get(t) {
    return this.Data[t]
  }
