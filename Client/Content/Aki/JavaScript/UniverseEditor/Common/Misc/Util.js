...
function getEnumValues(t) {
  return Object.keys(t).filter(e => Number.isNaN(Number(e))).map(e => t[e])
}
...
function parse(e, t) {
  return JSON.parse(e, (e, r) => {
    if (!t || !e.startsWith("_")) return r instanceof Array && r.forEach((e, t) => {
      null === e && (r[t] = void 0)
    }), r
  })
}
...
function stringFormat(e, ...r) {
  return e.replace(/{([0-9])}/g, (e, t) => void 0 !== r[t] ? r[t].toString() : e)
}
...
function parseCsvIntArray(e) {
  return e.replace(/^\s*["\\[]|["\]]\s*$/g, "").replace(/^\[|\]$/g, "").split(",").map(e => {
...
function parseCsvFloatArray(e) {
  return e.substring(1, e.length - 1).split(",").map(e => parseFloatSafe(e))
}

function parseCsvLongArray(e) {
  return e.substring(1, e.length - 1).split(",").map(e => parseIntSafe(e))
}
...
function stringifyEditor(e) {
  return JSON.stringify(e, (e, t) => {
    if (!("string" == typeof e && 0 < e.length) || e.startsWith("_") || "object" == typeof t) return t
  }, 2)
}
...
function getClassNameFromBpPath(e) {
  var t = e.lastIndexOf(".");
  return t < 0 ? ((0, Log_1.error)("Blueprint path is invalid: " + e), e) : e.slice(t + 1)
}
exports.getEnumValues = getEnumValues, exports.getEnumNames = getEnumNames, exports.getEnumNameByValue = getEnumNameByValue, exports.subArray = subArray, exports.addArray = addArray, exports.unionArray = unionArray, exports.arrayToMap = arrayToMap, exports.arrayToRecord = arrayToRecord, exports.calHash = calHash, exports.getFieldCount = getFieldCount, exports.stringify = stringify, exports.parse = parse, exports.stringFormat = stringFormat, exports.isNumber2dArray = isNumber2dArray, exports.stringifyCsvInt2Array = stringifyCsvInt2Array, exports.isValidNumberString = isValidNumberString, exports.parseFloatSafe = parseFloatSafe, exports.parseIntSafe = parseIntSafe, exports.parseBool = parseBool, exports.parseCsvIntArray = parseCsvIntArray, exports.parseCsvIntToIntMap = parseCsvIntToIntMap, exports.parseCsvInt2Array = parseCsvInt2Array, exports.parseCsvStringArray = parseCsvStringArray, exports.parseCsvFloatArray = parseCsvFloatArray, exports.parseCsvLongArray = parseCsvLongArray, exports.parsePos = parsePos, exports.parseVarValue = parseVarValue, exports.stringifyBool = stringifyBool, exports.stringifyEditor = stringifyEditor, exports.alignNumber = alignNumber, exports.clampAngle = clampAngle, exports.clampNumber = clampNumber, exports.isNumText = isNumText, exports.isIntText = isIntText, exports.isPipelineEnv = isPipelineEnv, exports.readJsonObj = readJsonObj, exports.writeJson = writeJson, exports.writeDataJson = writeDataJson, exports.getClassNameFromBpPath = getClassNameFromBpPath;
const ARRAY_INDEX_KEY = "_arrayIndex";

function createMultiData(t, e, r) {
  if (void 0 === t) return (0, IUtil_1.clearIgnoreField)(e, r);
  if (null == e) return null;
  if ("object" != typeof e || "object" != typeof t) return e !== t ? null : (0, IUtil_1.clearIgnoreField)(e, r);
  ...
  for (const p in e) {
    var s;
    r?.(p) || (s = e[p], void 0 === t[p] && (a[p] = void 0 === s ? void 0 : null))
  }
  for (const f in t) {
    var i, u, c;
    r?.(f) || (i = e[f], u = t[f], null === i || null === u ? a[f] = null : void 0 === i ? a[f] = void 0 === u ? void 0 : null : (c = typeof i) == typeof u && "object" == c ? (c = createMultiData(i, u, r), a[f] = c) : a[f] = i !== u ? null : i)
  }
  return a
}
...
function applyMultiData(e, t, r) {
  ...
  if (e instanceof Array) {
    ...
    if (null === t) return u;
    {
      ...
      return t.forEach((e, t) => {
        null === e ? void 0 !== u[t] && null !== u[t] && (t = applyMultiData(u[t], e, r), n.push(t)) : void 0 !== (t = e[ARRAY_INDEX_KEY]) && t < u.length ? (t = applyMultiData(u[t], e, r), n.push(t)) : n.push(e)
      }), n
    }
  }
  const n = {};
  for (const c in t) {
    var o;
    r?.(c) || null === t || c === ARRAY_INDEX_KEY || (o = t[c], void 0 === e[c] && null !== o && (n[c] = (0, IUtil_1.removeNullField)(o)))
  }
  for (const p in e) {
    var a, s, i;
    r?.(p) || p === ARRAY_INDEX_KEY || (a = t[p], s = e[p], null !== a ? (i = typeof a) == typeof s && "object" == i ? (i = applyMultiData(s, a, r), n[p] = i) : n[p] = a : n[p] = s)
  }
  return n
}
...
function regenerateField(t) {
  ...
  var e, n = {};
  for (const o in t)(0, IUtil_1.isGuid)(o) ? n[o] = genGuid() : (0, IUtil_1.isTidText)(o) ? n[o] = "" : (e = t[o], n[o] = regenerateField(e));
  return n
}
...
function execAsUser(e, t) {
  return exec((0, File_1.getTsRoot)() + "/Src/UniverseEditor/Tool/run_as_standard_user.bat" + " " + e, t)
}
...
function isProcessRunningInPath(e) {
  const t = e.replace(/\\/g, "/");
  return getProcessImagePathsByName(t.split("/").pop()).some(e => e.replace(/\\/g, "/") === t)
}
...
function isRunInStandaloneGame() {
  for (const e of getProcessPathAndCommandLine("UE4Editor.exe"))
    if (e.CommandLine.includes('-SessionName="Play in Standalone Game"')) return !0;
  return !1
}
exports.createMultiData = createMultiData, exports.applyMultiData = applyMultiData, exports.strcmp = strcmp, exports.strcmpi = strcmpi, exports.forEachField = forEachField, exports.hasFieldMatch = hasFieldMatch, exports.getMacAddress = getMacAddress, exports.getNetWorkAddress = getNetWorkAddress, exports.genGuid = genGuid, exports.regenerateField = regenerateField, exports.getTimeSeconds = getTimeSeconds, exports.exec = exec, exports.execAsUser = execAsUser, exports.isRunAsAdmin = isRunAsAdmin, exports.getProcessImagePathsByName = getProcessImagePathsByName, exports.getProcessPathAndCommandLine = getProcessPathAndCommandLine, exports.getProcessImagePathsByPort = getProcessImagePathsByPort, exports.isProcessRunningInPath = isProcessRunningInPath, exports.isProcessRunning = isProcessRunning, exports.killProcess = killProcess, exports.isRunInStandaloneGame = isRunInStandaloneGame;
let isStandaloneGame = !1,
  lastCheckNewProcessTime = 0;

function isRunInStandaloneGameWithCache() {
  var e = getTimeSeconds();
  return e - lastCheckNewProcessTime < 5 || (lastCheckNewProcessTime = e, isStandaloneGame = isRunInStandaloneGame()), isStandaloneGame
}
...
function getNextName(e, t = "-") {
  ...
  let r = -1,
    n = "";
  if (n = t ? (r = e.lastIndexOf(t), e.substring(r + 1)) : (o = e.match(/[^0-9]/g), r = e.lastIndexOf(o ? o[o.length - 1] : "") + 1, e.substring(r)), r < 0) return "" + e + t + "1";
...
function getPreName(e, t = "-") {
  var r, n;
  return e ? (r = e.lastIndexOf(t)) < 0 || (n = Number.parseInt(e.substring(r + 1)), isNaN(n)) ? "" + e + t + "1" : (n = n <= 1 ? n : n - 1, "" + e.substring(0, r) + t + n) : `user${t}1`
}
...
function checkMonsterValid(e) {
  ...
  for (c = 2; c < e.length; c++) {
    var p = e[c].X ?? 0,
      f = e[c].Y ?? 0;
    a = p < a ? p : a, s = p > s ? p : s, i = f < i ? f : i, u = f > u ? f : u
  }
  return [{
    X: (a + s) / 2,
    Y: (u + i) / 2,
...
function getP4CurrentDirectory() {
  ...
  return (e = e && t.split("\n").find(e => e.includes("Current directory: "))) ? 0 <= (e = (t = e.replace(/\\/g, "/")).indexOf("/Package/Engine/")) ? t.substring("Current directory: ".length, e) : t.substring("Current directory: ".length) : ""
}
exports.isRunInStandaloneGameWithCache = isRunInStandaloneGameWithCache, exports.getNameWithoutIndex = getNameWithoutIndex, exports.getNextName = getNextName, exports.getUniqueName = getUniqueName, exports.getPreName = getPreName, exports.getNextPathName = getNextPathName, exports.checkMonsterValid = checkMonsterValid, exports.upperStringFirstLetter = upperStringFirstLetter;
let clientInfos = void 0;

function getClientDatas() {
  if (clientInfos) return clientInfos;
  let e = [];
  var t, r, n = "p4 -ztag -Mj clients -t --me";
  return 0 !== (e = 0 === (e = isPipelineEnv() && "" !== (t = getP4CurrentDirectory()) && (t = t.split("/").map(e => `find /I "${e}"`).join(" | "), [t, r] = (0, Platform_1.getPlatform)().Exec(n + " | " + t), t) ? r.trim().split("\n") : e).length && ([t, r] = (0, Platform_1.getPlatform)().Exec(n), t) ? r.trim().split("\n") : e).length ? clientInfos = e.map(e => parse(e.trim().replace('"client"', '"Client"'))) : void 0
}
...
exports.getClientDatas = getClientDatas, exports.checkP4Connection = checkP4Connection;
...
function getP4ClientData() {
  ...
  if (checkP4Connection()) {
    ...
    if (e) {
      ...
      return currentP4ClientData = e.find(e => t.startsWith((upperStringFirstLetter(e.Root).replace(/\\/g, "/") + "/").replace(/\/+/g, "/")))
    }
  }
}
...
function getP4ClientDataByFilePath(e) {
  ...
  if (t) {
    ...
    return t.find(e => r.startsWith((upperStringFirstLetter(e.Root).replace(/\\/g, "/") + "/").replace(/\/+/g, "/")))
  }
}

function getStreamFromSpecFile(e) {
  if (e) {
    var t = (0, File_1.getProjectPath)("Content/Aki/JavaScript_Raw/UniverseEditor/Interface/IGlobal.js").replace(/\\/g, "/"),
      [e, t] = (0, Platform_1.getPlatform)().Exec(`p4 -ztag -c ${e} filelog -m 1 ` + t);
    if (e) {
      e = t.split("\n").find(e => e.includes("depotFile"));
      if (e) return (t = /\/\/([^/]+\/[^/]+)\//.exec(e)) && t[1] ? "//" + t[1] : void 0
    }
  }
}

function getStreamFromEnv() {
  var e = process.env.Stream ?? process.env.STREAM ?? process.env.AKI_Stream ?? process.env.Branch;
...
function getCurrentP4Stream() {
  var e;
  return currentStream || ((currentStream = getStreamFromEnv()) || (e = getP4ClientData(), currentStream = e?.Stream ?? getStreamFromSpecFile(e?.Client)), (0, Log_1.log)("Run in Stream: " + currentStream)), currentStream
}
...
exports.getCurrentP4Stream = getCurrentP4Stream, exports.getCurrentClientRoot = getCurrentClientRoot, exports.getCurrentClientName = getCurrentClientName, exports.getCurrentP4Branch = getCurrentP4Branch, exports.getWorkspaceBranch = getWorkspaceBranch, exports.getCurrentP4Owner = getCurrentP4Owner, exports.getChangeListShelveFiles = getChangeListShelveFiles;
...
exports.getAkiBaseLocalPath = getAkiBaseLocalPath, exports.getAkiBaseProjectPath = getAkiBaseProjectPath;
...
function loadUgsSyncConfig() {
  ...
  if ((0, File_1.existFile)(e)) {
    e = readJsonObj(e);
    if (e) return e.Type = "Ugs", e.Timestamp = Date.parse(e.LastSyncTime), e
  }
}

function getCurrentSyncData() {
  var e, t = getCurrentClientEditorSaviorSyncData(),
    r = loadUgsSyncConfig();
  return t && r ? (e = isNaN(t.Timestamp) ? -1 : t.Timestamp, (isNaN(r.Timestamp) ? -1 : r.Timestamp) < e ? t : r) : t ?? r
}
exports.getAkiBaseClient = getAkiBaseClient, exports.loadEditorSaviorSyncConfig = loadEditorSaviorSyncConfig, exports.getCurrentClientEditorSaviorSyncData = getCurrentClientEditorSaviorSyncData, exports.loadUgsSyncConfig = loadUgsSyncConfig, exports.getCurrentSyncData = getCurrentSyncData;
let currentSafeVersion = void 0;

function getLocalSafeVersion() {
  if (void 0 === currentSafeVersion) {
    var e = getCurrentSyncData();
    if (!e) return (currentSafeVersion = 0, Log_1.warn)("当前未从【编辑器救世主】或【UGS】更新过安全版本，请先拉取安全版本"), 0;
    switch (e.Type) {
      case "EditorSavior":
...
function isVectorEqual(e, t, r = 0, n = 1e-4) {
  return Math.abs((e?.X ?? r) - (t?.X ?? r)) <= n && Math.abs((e?.Y ?? r) - (t?.Y ?? r)) <= n && Math.abs((e?.Z ?? r) - (t?.Z ?? r)) <= n
}
...
function isVector2Equal(e, t, r = 0, n = 1e-4) {
  return Math.abs((e?.X ?? r) - (t?.X ?? r)) <= n && Math.abs((e?.Y ?? r) - (t?.Y ?? r)) <= n
}
...
function isSphereInsideSphere(e, t, r, n, o = .01) {
  var a = e.X ?? 0,
    s = e.Y ?? 0,
    e = e.Z ?? 0,
    a = a - (r.X ?? 0),
...
function isTransformEqual(e, t, r = 1e-4, n = 1e-4, o = 1e-4) {
  ...
  return isVectorEqual(e.Pos || a, t.Pos || a, 0, r) && isVectorEqual(e.Rot ?? a, t.Rot ?? a, 0, n) && isVectorEqual(e.Scale ?? s, t.Scale ?? s, 1, o)
}
...
function getEditorCommandArgs() {
  ...
  for (let t = 1; t < r.length; t++) {
    ...
    if (a.startsWith("-")) {
      a = a.slice(1);
      let e = "";
      o.includes(a) && (t + 1 < r.length && !r[t + 1].startsWith("-") && (e = r[t + 1], t++), n[a] = e)
    }
  }
  return n
}
...
function isValidVarName(e, t = 16) {
  return e.length > t ? [!1, `变量【${e}】名称长度不能超过16`] : !e[0] || "0" <= e[0] && e[0] <= "9" ? [!1, `变量【${e}】名称不能以数字开头`] : "q_count" === e ? [!1, `变量【${e}】名称不能包含程序定义字符【q_count】`] : /^[\u4e00-\u9fa5_a-zA-Z0-9]+$/.test(e) ? [!0, void 0] : [!1, `变量【${e}】名称不能包含特殊字符`]
}
...
function formatDateTime(e, t = "cn") {
  ...
  switch (t) {
    case "cn":
      return n + `-${o}-${a}-${"星期"+"日一二三四五六".charAt(r.getDay())} ${s}:${i}:` + u;
    case "simple":
      return "" + n + o + a + s + i + u
  }
...
function toDepotPath(e) {
  ...
  var n;
  return t && r ? (e = (0, File_1.getAbsolutePath)(e), (r = r.replace(/\\/g, "/")).endsWith("/") && !t.endsWith("/") && (t += "/"), n = new RegExp(r, "gi"), e.replace(/\\/g, "/").replace(n, t)) : void 0
}
...
async function doJsonHttpGet(e, t) {
  ...
  if (200 !== r.Status) throw new Error(`doJsonHttpGet ${e} ${t} failed, status: ${r.Status}, data: ` + r.Data);
  return r.Data
}
async function doJsonHttpPost(e, t) {
  var r = await (0, Platform_1.getPlatform)().DoJsonHttpReq("POST", e, t);
  if (201 !== r.Status && 200 !== r.Status) throw new Error(`doJsonHttpPost ${e} ${t} failed, status: ${r.Status}, data: ` + r.Data);
  return r.Data
}
async function doJsonHttpDelete(e, t) {
  var r = await (0, Platform_1.getPlatform)().DoJsonHttpReq("DELETE", e, t);
  if (204 !== r.Status) throw new Error(`doJsonHttpDelete ${e} ${t} failed, status: ${r.Status}, data: ` + r.Data);
  return r.Data
}
...
function compareTextOrder(e, t) {
  var r = e.replace(/_[^_]*$/, ""),
    n = t.replace(/_[^_]*$/, "");
  return r !== n ? r < n ? -1 : 1 : (r = e.split("_").pop()) === (n = t.split("_").pop()) ? 0 : Number(r) && Number(n) ? Number(r) < Number(n) ? -1 : 1 : r < n ? -1 : 1
}

function getBranchReqShortPath(e) {
  var t = (0, File_1.getAbsolutePath)(e).replace(/\\/g, "/"),
    r = t.indexOf("Source/");
  if (r < 0)(0, Log_1.error)(`文件: ${e} 不在分支 Source/ 目录下管理, 请确认是否为分支内文件 `);
...
function getBranchOriginsDataSync(e) {
  ...
  if (t) {
    var [t, r] = exec(`curl -X POST http://tools.aki.kuro.com:1025/multibranch/aki/file_origins -H "Content-Type:application/json" -d "{\\"filePath\\":\\"${t}\\"}"`);
    if (t) {
      t = r.indexOf('{"code":');
      if (!(t < 0)) return {
...
async function getFileDepotInfoAsyncBatch(e) {
  ...
  for (let e = 0; e < 2 && !(r = await (async () => {
      try {
        var e = await doJsonHttpPost("http://tools.aki.kuro.com:1025/multibranch/aki/file/batch/exist", t);
        return e ? {
          Success: !0,
          Result: e.data
        } : {
...
exports.getAllDepotBranchDataSync = getAllDepotBranchDataSync, exports.isCurrentBranchAsset = isCurrentBranchAsset, exports.getFileDepotInfoAsyncBatch = getFileDepotInfoAsyncBatch;
let fileOriginRequiredList = void 0;
async function getTextFileOriginRequiredList() {
  var e;
  return fileOriginRequiredList || ((e = await doJsonHttpGet("http://tools.aki.kuro.com:1025/multibranch/aki/originrequiredlist")) ? fileOriginRequiredList = e.data : (e = "获取分支管理文本文件路径信息失败: " + e, void(0, Log_1.error)(e)))
}

function isTextFileByExtension(e) {
  e = e.split(".").pop()?.toLowerCase();
  return !(!e || !["txt", "md", "html", "htm", "css", "js", "ts", "json", "xml", "csv", "log", "ini", "yaml", "yml", "py", "java", "c", "cpp", "h", "hpp", "php", "rb", "sh", "bat", "cmd", "pl", "sql", "r", "go", "kt"].includes(e))
}
...
async function getBatchFileBranchDataAsync(t) {
  ...
  if (t.Success)
    for (var [s, i] of Object.entries(t.Result)) {
      var u = r + "/" + s;
      i.findIndex(e => e.endsWith(r)) < 0 ? e.set(u, {
        IsInDepot: !1,
        Origins: [r]
  ...
  try {
    var c, p = await doJsonHttpPost("http://tools.aki.kuro.com:1025/multibranch/aki/file_origins/batch", t);
    if (!p) return c = `获取分支信息失败: ${p} (${stringify(t)})`, (0, Log_1.error)(c), {
      Success: !1,
      Error: c
    };
    for (const [x, g] of Object.entries(p.data)) {
      var f = o.get(x);
      if (f)
        if (isTextFileByExtension(f) && !await isTextFileInOriginRequiredListAsync(f)) e.set(f, {
          IsInDepot: !0,
...
async function getFileSourceBranchAsync(e) {
  ...
  return t.Success ? toDepotPath(e) ? {
    Success: !0,
    Result: t.Result.get(e)
  } : {
    Success: !1,
    Error: "文件路径非法，不是项目内的文件"
  } : {
    Success: !1,
    Error: t.Error
  }
...
async function isCurrentBranchAssetAsync(e) {
  ...
  try {
    var n = await doJsonHttpPost("http://tools.aki.kuro.com:1025/multibranch/aki/file_origins", t);
    return n ? n.data.origins.includes(r) : ((0, Log_1.error)(`获取分支信息失败: ${n} (${e})`), !1)
  } catch (e) {
    t = "获取分支信息失败: " + e;
...
function isIpAddress(e) {
  return /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(e)
}
  ...
  const s = [],
    i = (r, n, e, o) => {
      if (r !== n)
        ...
        } else r instanceof Object && n instanceof Object ? new Set([...Object.keys(r), ...Object.keys(n)]).forEach(e => {
          var t = o ? o + "." + e : e;
          i(r[e], n[e], e, t)
        }) : void 0 === r ? s.push({
          Path: o,
...
function getValueByDataPath(e, t) {
  let r = e;
  var n;
  for (const o of t.split(".")) r instanceof Array ? (n = parseInt(o.slice(1, -1), 10), isNaN(n) || (r = r[n])) : r instanceof Object && (r = r[o]);
  return r
}

function createValueStackByDataPath(e, t) {
  var r, n = new ValueStack;
  let o = e;
  for (const a of t.split(".")) o instanceof Array ? (r = parseInt(a.slice(1, -1), 10), isNaN(r) || (o = o[r], n.Push(o, r))) : o instanceof Object && (o = o[a], n.Push(o, a));
  return n
}

function isSubdirectoryDataPath(e, t) {
  const r = e.split(".").filter(e => e.length);
  return t.split(".").filter(e => e.length).every((e, t) => r[t] === e)
}
...
function updateObjectByStack(e, t, r) {
  let n = t;
  var o = e.GetStack().filter(e => void 0 !== e.Key).map(e => e.Key);
  if (0 !== o.length && "object" == typeof n && null !== n) {
    for (let e = 0; e < o.length - 1; e++) {
      var a, s = o[e];
      s && "object" == typeof n && null !== n && (s in (a = n) || (a[s] = {}), n = a[s])
    }
    t = o[o.length - 1];
    n[t] = r
  }
...
function updateValueByDiffResults(e, t) {
  for (const r of t) updateObjectByStack(createValueStackByDataPath(e, r.Path), e, r.Value2)
}
exports.ValueStack = ValueStack, exports.getValueByDataPath = getValueByDataPath, exports.createValueStackByDataPath = createValueStackByDataPath, exports.isSubdirectoryDataPath = isSubdirectoryDataPath, exports.objectIterator = objectIterator, exports.isArrayElementSame = isArrayElementSame, exports.updateObjectByStack = updateObjectByStack, exports.updateValueByDiffResults = updateValueByDiffResults;
