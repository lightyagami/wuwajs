...
async function requestServerResponse(e, r, t = "localhost", o, a = "POST") {
  if (!((0, Util_2.isInPie)() || Config_1.Config.IsPkgRunning || Config_1.Config.IsServerAttaching || (0, Util_2.isRuntimePlatform)())) return [!1, void 0];
  let n = o;
  let i = `http://${t}:${n=void 0===o?Config_1.Config.Instance.ServerPort:n}/GameCurrStateDebug/` + e;
  r && (t = Object.entries(r).map(([e, r]) => e + "=" + r).join("&"), i += "?" + t);
  o = "POST" === a ? await (0, Util_2.doJsonHttpPost)(i) : await (0, Util_2.doJsonHttpGet)(i);
  return o ? [!0, o] : [!1, void 0]
}
async function requestServerData(e, r, t = "localhost", o) {
  var [e, r] = await requestServerResponse(e, r, t, o);
  return e && r && r.data && "null" !== r.data ? [!0, (0, Util_2.parse)(r.data)] : [!1, void 0]
}
async function requestServerEntityRunningData(e, r, t, o) {
  ...
  for (const u of a) {
    var i = u.join(","),
      [s, d] = await requestServerData("GetEntityCurrState", {
        playerId: e,
        configIdList: i,
        instId: r
      }, o);
    s ? d.States && 0 < d.States.length && n.push(...d.States) : (0, Log_1.warn)(`request server entity running data failed. playerId = ${e}, entityIds = [${i}]`)
  }
  return n
}
async function requestServerBehaviorTreeRunningData(e, r) {
  var [r, t] = await requestServerData("GetGameCurrState", {
    playerId: e
  }, r);
  if (r) return t;
  (0, Log_1.warn)("request server BehaviorTree running data failed. playerId = " + e)
}
...
async function requestCondition(e, r, t) {
  var [r, t] = await requestServerResponse("GetGameCurrCondition", {
    playerId: e,
    requestId: r.RequestId,
    conditionType: r.ConditionGroup.Type,
    uuid: r.Uid,
    conditionGroup: encodeURIComponent((0, Util_2.stringify)(r.ConditionGroup.Type === ICondition_1.EConditionLogicType.BaseAccessQuest ? r.ConditionGroup.BaseAccessQuestConditionGroup : r.ConditionGroup.Condition2Group, !0, !1))
  }, t, void 0, "GET");
...
async function getPlayerPosInfo(e, r) {
  e = e + "/GameCurrStateDebug/GetPlayerPosInfo?playerId=" + r, r = await (0, Util_2.doJsonHttpGet)(e).catch(void 0);
  if (void 0 !== r && 0 === r.code) return (0, Util_2.parse)(r.data)
}

function sendBreakPointConfigsServer(e, r, t) {
  e = `http://${e}:${Config_1.Config.Instance.ServerPort}/GameCurrStateDebug/UpdateBtBreakPointData?playerId=` + t;
  try {
    (0, Util_1.sendHttpRequest)("POST", e, void 0, r)
  } catch (e) {
    (0, Log_1.warn)("sendPrepareReloadServer failed: " + e)
  }
}

function sendResumeBreakPointServer(e, r) {
  e = `http://${e}:${Config_1.Config.Instance.ServerPort}/GmHandler/ExecuteCmdList`;
  try {
    (0, Util_1.sendHttpRequest)("POST", e, void 0, r)
  } catch (e) {
    (0, Log_1.warn)("sendPrepareReloadServer failed: " + e)
