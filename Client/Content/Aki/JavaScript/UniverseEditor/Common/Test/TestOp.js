...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.getCurrentTestRunningContextName = exports.popTestRunningContextName = exports.pushTestRunningContextName = exports.getTestContext = exports.TestOp = exports.TestFilter = exports.TestResult = exports.TestContext = exports.logTestMsg = exports.enableTestLog = exports.TEST_LOG_TAG = exports.resetDefaultTestCaseTimeout = exports.setDefaultTestCaseTimeout = exports.DEFAULT_TEST_TIMEOUT = void 0;
...
exports.setDefaultTestCaseTimeout = setDefaultTestCaseTimeout, exports.resetDefaultTestCaseTimeout = resetDefaultTestCaseTimeout;
...
class TestContext {
  constructor() {
    this.ze = [], this.Ze = 0, this.RootSuite = {
      Type: "suite",
      Name: "root",
      Id: 0,
      Cases: [],
...
class TestResult {
  ...
  ContainsAny(t) {
    return "case" === t.Type ? this.nt.has(t.Id) : t.Cases.some(t => "suite" === t.Type ? this.ContainsAny(t) : this.nt.has(t.Id))
  }
}
...
class TestFilter {
  ...
  Contains(t) {
    return "case" === t.Type ? this.rt.has(t.Id) : t.Cases.some(t => "suite" === t.Type ? this.Contains(t) : this.rt.has(t.Id))
  }
  GetAllTestNames() {
...
class TestOp {
  ...
  static st(t, e, s) {
    var i;
    "case" === t.Type ? (i = s.Get(t.Id)) && (e.Total += 1, i.Result ? e.Passed += 1 : e.Failed += 1, e.Time += i.RunTime) : t.Cases.forEach(t => {
      TestOp.st(t, e, s)
    })
  }
  static Output(t, e, s = "") {
    if (e.ContainsAny(t)) {
      var i;
      if ("case" === t.Type) return (i = e.Get(t.Id)) ? ((0, Log_1.log)(`${s}[${(0,ColorDefine_1.blue)(t.Name)}] ${i.Result?(0,ColorDefine_1.green)("OK"):(0,ColorDefine_1.red)("FAIL")} ${i.RunTime}ms ` + t.FileLocation), void(!i.Result && i.Error && (0, Log_1.log)(beatifyError(i.Error, s + "  ")))) : void 0;
      (0, Log_1.log)(`${s}# ${(0,ColorDefine_1.cyan)(t.Name)} ${t.RunTime}ms`), t.Cases.forEach(t => {
        TestOp.Output(t, e, s + "  ")
      })
    }
  }
  static GenTestReport(t, e) {
    if (e.ContainsAny(t)) {
      var s;
      if ("case" === t.Type) return (s = e.Get(t.Id)) ? {
        Name: t.Name,
        File: t.FileLocation,
        RunTime: s.RunTime,
  ...
  static async RunSuite(t, e, s, i) {
    if (s.Contains(e)) {
      var r, n = Date.now();
      await e.BeforeAll?.();
      for (const o of e.Cases) "suite" === o.Type ? await TestOp.RunSuite(t, o, s, i) : s.Contains(o) && (r = i.Gen(o.Id), await this.RunCase(t, e, o, r));
  ...
  static async lt(e, t, s) {
    ...
    var n = Date.now();
    try {
      await e.BeforeEach?.(), i = !0, await t.Run(), await e.AfterEach?.(), r = !0, s.Result = !0, s.RunTime = Date.now() - n
    } catch (t) {
      s.RunTime = Date.now() - n, s.Result = !1, s.Error = t, i && !r && await e.AfterEach?.()
    }
  }
  static async RunCase(i, r, n, o) {
    return logTestMsg("开始运行测试用例: " + n.Name), n.TestCaseInterval && 0 < n.TestCaseInterval && await (0, Async_1.delayMs)(n.TestCaseInterval), new Promise(e => {
      const t = (i.CurrentTest = n).TimeOut ?? defaultTestCaseTimeout,
        s = setTimeout(() => {
          o.Result = !1, o.Error = new Error(`Reason: timeout for ${t} ms
File  : ` + n.FileLocation), e()
        }, n.TimeOut ?? defaultTestCaseTimeout);
      this.lt(r, n, o).then(() => {
        o.Error || (logTestMsg("测试用例运行结束: " + n.Name), clearTimeout(s), e())
      }).catch(t => {
  ...
  static AddTestToFilter(t, e) {
    "case" === t.Type ? e.Add(t) : t.Cases.forEach(t => {
...
function getCurrentTestRunningContextName() {
  if (0 !== testRunningContextStack.length) return testRunningContextStack[testRunningContextStack.length - 1]
}
exports.pushTestRunningContextName = pushTestRunningContextName, exports.popTestRunningContextName = popTestRunningContextName, exports.getCurrentTestRunningContextName = getCurrentTestRunningContextName;
