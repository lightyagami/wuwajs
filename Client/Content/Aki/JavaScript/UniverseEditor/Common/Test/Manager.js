...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.getUseCaseTestManager = exports.getUnitTestProxy = exports.getUnitTestManager = exports.UnitTestProxy = exports.RunTestProxy = exports.TestManager = void 0;
...
` + e.stack)
  ...
  async RunAllTests() {
    ...
    return TestOp_1.TestOp.AddTestToFilter(this.Context.RootSuite, e), this.RunTests(e)
  }
  async RunTests(e) {
    var t = this.Context["RootSuite"],
      s = ((0, TestOp_1.pushTestRunningContextName)(this.Name), new TestOp_1.TestResult);
    return await TestOp_1.TestOp.RunSuite(this.Context, t, e, s), (0, TestOp_1.popTestRunningContextName)(), s
  }
  ...
  $e(e) {
    var t, s = this.Context.PickSuite(e);
    if (s) return t = new TestOp_1.TestFilter, TestOp_1.TestOp.AddTestToFilter(s, t), t;
    throw new Error(`[${this.Name}] cannot find test suite: ` + e)
  }
  OutputTestResults(e) {
    var t = this.Context["RootSuite"],
      t = ((0, Log_1.log)(""), TestOp_1.TestOp.Output(t, e), TestOp_1.TestOp.GetSummary(t, e)),
      e = ((0, Log_1.log)(""), [`${(0,ColorDefine_1.cyan)("汇总")}: 总数: ${t.Total}, 成功: ${(0,ColorDefine_1.green)(t.Passed.toString())}, `]);
    0 < t.Failed && e.push(`失败: ${(0,ColorDefine_1.red)(t.Failed.toString())}, `), e.push(`耗时: ${t.Time}ms`), (0, Log_1.log)(e.join("")), (0, Log_1.log)("")
  }
  GetTestReport(e) {
    var t = this.Context["RootSuite"];
  ...
  OpenTestLine(e) {
    ...
    return !!t && !!t.FileLocation && (e = (0, File_1.joinPath)((0, File_1.getTsRoot)(), t.FileLocation), (0, Util_1.exec)("code --goto " + e), !0)
  }
}
...
class RunTestProxy {
  ...
  set IsRunning(e) {
    this.He = e, UseCaseTestEvent_1.useCaseTestEventDispatcher.Dispatch("RunningStateChanged", e)
  }
  get IsRunning() {
    return this.He
  }
  ...
  Qe(e, t) {
    if ("case" === e.Type) t.Add(e);
      ...
      for (const s of e.Cases) this.Qe(s, t)
  }
  CreateTestFilter(e) {
    var t = new TestOp_1.TestFilter;
  ...
  We(e, t) {
    if (t(e), "suite" === e.Type)
      for (const s of e.Cases) this.We(s, t)
  }
  CreateTestFilterByNames(t) {
    const s = new TestOp_1.TestFilter;
    return this.We(this.Manager.Context.RootSuite, e => {
...
function getUnitTestManager() {
  return unitTestManager = unitTestManager || new TestManager("UnitTest", (0, File_1.joinPath)((0, File_1.getJsRoot)(), "Tests/UnitTests"))
}
exports.getUnitTestManager = getUnitTestManager;
let unitTestProxy = void 0;

function getUnitTestProxy() {
  return unitTestProxy = unitTestProxy || new UnitTestProxy(getUnitTestManager(), "UnitTest")
}
exports.getUnitTestProxy = getUnitTestProxy;
let useCaseTestManager = void 0;

function getUseCaseTestManager() {
  return useCaseTestManager = useCaseTestManager || new TestManager("UseCaseTest", (0, File_1.joinPath)((0, File_1.getJsRoot)(), "Tests/UsecaseTests"))
}
