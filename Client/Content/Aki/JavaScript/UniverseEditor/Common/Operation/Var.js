...
const CsvRegistry_1 = require("../CsvConfig/CsvRegistry"),
  Interface_1 = require("../CsvConfig/Interface"),
...
class VarConfigManager {
  constructor() {
    this.Pe = [], this.z$ = r => {
      r === Interface_1.ECsvName.Var && this.Refresh()
    }, this.Init(), EventSystem_1.editorEventDispatcher.Reg("SaveCsvEditor", this.z$)
  }
  static get Instance() {
    return VarConfigManager.m || (VarConfigManager.m = new VarConfigManager), VarConfigManager.m
  }
  Init() {
    this.Refresh()
  }
  ...
  LoadVarConfig() {
    var r = CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(VarConfigCsv_1.VarConfigCsv);
    const e = [];
    return r.forEach(r => {
      e.push({
        Name: r.Name,
  ...
  ExportVarConfig() {
    ...
    return r.forEach(r => {
      var e;
      r.HasDefaultValue && (e = r.Type, t.push({
        Name: r.Name,
        Type: e,
...
exports.getVarConfigArray = getVarConfigArray, exports.exportVarConfig = exportVarConfig;
