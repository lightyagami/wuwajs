...
function getDescText(e) {
  ...
  for (const s of CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(DescTextCsv_1.DescTextCsv)) descTextMap.set(s.Id, s.Text);
  const t = descTextMap.get(e);
  return t || ""
}
...
exports.getDescText = getDescText, exports.testGetDescText = testGetDescText;
