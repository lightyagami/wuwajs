...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.getAllSceneItemAttributeTagsByType = exports.getAllPerformanceAttributeTypes = exports.EntityPrefabPerformanceUtil = void 0;
...
class EntityPrefabPerformanceUtil {
  ...
  static GetEntityPrefabPerformanceKeyByTag(t, e) {
    var r, n, a = EntityPrefabPerformanceUtil.pe.get(t);
    if (!a) throw new Error(`GetEntityPrefabPerformanceKeyByTag: ${t} not found`);
    for ([r, n] of a)
      if (n === e) return r;
...
function getAllPerformanceAttributeTypes() {
  var t = CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(EntityPerformanceAttributeCsv_1.EntityPerformanceAttributeCsv);
  const e = [];
  return t.forEach(t => {
    e.push(t.Type)
  }), e
...
function getAllSceneItemAttributeTagsByType(e) {
  var t = CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(EntityPerformanceAttributeCsv_1.EntityPerformanceAttributeCsv).find(t => t.Type === e);
  return t ? t.Tags : []
}(exports.EntityPrefabPerformanceUtil = EntityPrefabPerformanceUtil)._e = Object.keys(IAction_1.entityPrefabPerformanceConfig), EntityPrefabPerformanceUtil.ue = new Map, exports.getAllPerformanceAttributeTypes = getAllPerformanceAttributeTypes, exports.getAllSceneItemAttributeTagsByType = getAllSceneItemAttributeTagsByType;
