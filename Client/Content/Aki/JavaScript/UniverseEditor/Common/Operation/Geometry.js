...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.getExtraShapeParam = exports.isShapesOverlapping = exports.getCylinderCorners = exports.getBoxCorners = exports.getNormalVector2D = exports.isClockwise = exports.rotateVertex = exports.isInSimpleShape = exports.isInSphereRange = exports.isInRangeConfig = exports.Vector3Op = exports.transformInfoToFixed = exports.toEuler = exports.degreesToRadians = exports.toVectorInfo = exports.toVector3R = exports.RectOp = exports.Vector2Op = exports.toVector2R = void 0;
const IShape_1 = require("../../Interface/IShape"),
...
class Vector2Op {
  ...
  static Format(t) {
    return t ? void 0 === t.X || void 0 === t.Y ? Vector2Op.New(t.X ?? 0, t.Y ?? 0) : t : Vector2Op.Zero
  }
  static Str(t) {
    return `(${t.X}, ${t.Y})`
  }
  ...
  static Intersect(t, r, e, o) {
    var n = r.X - t.X,
      ...
      o = o.Y - e.Y,
      c = -a * r + n * o;
    return 0 != c && (r = (-r * (t.X - e.X) + n * (t.Y - e.Y)) / c, n = (a * (t.Y - e.Y) - o * (t.X - e.X)) / c, 0 <= r) && r <= 1 && 0 <= n && n <= 1
  }
}
exports.Vector2Op = Vector2Op, (_a = Vector2Op).One = _a.New(1, 1), Vector2Op.Zero = _a.New(0, 0), Vector2Op.ve = new Map;
class RectOp {
  static New(t, r) {
    return {
      Min: {
  ...
  static NewByMin(t, r) {
    return {
      Min: t,
      Max: Vector2Op.Add(t, r)
    }
  }
  static NewByPos(t, r) {
    if (t.X < r.X && t.Y < r.Y) return {
      Min: t,
      Max: r
    };
    let e = t.X,
      ...
      a = r.Y;
    return t.Y > r.Y && (n = r.Y, a = t.Y), {
      Min: Vector2Op.New(e, n),
      Max: Vector2Op.New(o, a)
    }
  }
  static RoundS(t) {
  ...
  static Clone(t) {
    return {
      Min: Vector2Op.Clone(t.Min),
      Max: Vector2Op.Clone(t.Max)
    }
  }
  static Str(t) {
    return `中心: ${Vector2Op.Str(this.GetCenter(t))} 大小: ` + Vector2Op.Str(this.GetSize(t))
  }
  static GetCenter(t) {
  ...
  static IntersectLine(t, r, e) {
    ...
    return Vector2Op.Intersect(r, e, n, a) || Vector2Op.Intersect(r, e, a, c) || Vector2Op.Intersect(r, e, c, o) || Vector2Op.Intersect(r, e, o, n)
  }
  static IntersectOrIncludeLine(t, r, e) {
    var o, n, a;
    return !(!RectOp.Contains(t, r) && !RectOp.Contains(t, e)) || (a = t.Min, n = {
      X: (t = t.Max).X,
      Y: (o = a).Y
    }, t = {
      X: a.X,
      Y: (a = t).Y
    }, Vector2Op.Intersect(r, e, o, n)) || Vector2Op.Intersect(r, e, n, a) || Vector2Op.Intersect(r, e, a, t) || Vector2Op.Intersect(r, e, t, o)
  }
}
...
function transformInfoToFixed(t, r) {
  ...
  r = t => {
    var r = 10 ** e;
    return t.X && (t.X = Math.round(t.X * r) / r), t.Y && (t.Y = Math.round(t.Y * r) / r), t.Z && (t.Z = Math.round(t.Z * r) / r), t
  };
  return t.Pos && (t.Pos = r(t.Pos)), t.Rot && (t.Rot = r(t.Rot)), t.Scale && (t.Scale = r(t.Scale)), t
}
exports.RectOp = RectOp, (_b = RectOp).One = _b.New(Vector2Op.Zero, Vector2Op.One), RectOp.Zero = _b.New(Vector2Op.Zero, Vector2Op.Zero), exports.toVector3R = toVector3R, exports.toVectorInfo = toVectorInfo, exports.degreesToRadians = degreesToRadians, exports.toEuler = toEuler, exports.transformInfoToFixed = transformInfoToFixed;
class Vector3Op {
  static New(t, r, e) {
    return {
      X: t,
  ...
  static Format(t) {
    return t ? void 0 === t.X || void 0 === t.Y || void 0 === t.Z ? Vector3Op.New(t.X ?? 0, t.Y ?? 0, t.Z ?? 0) : t : Vector3Op.Zero
  }
  static Add(t, r) {
    return {
      X: (t.X ?? 0) + (r.X ?? 0),
  ...
  static GetRotationMatrix(t) {
    var {
      ...
      Y: r = 0,
      Z: e = 0
    } = t, o = Math.cos(r), r = Math.sin(r), n = Math.cos(e), e = Math.sin(e), a = Math.cos(t), t = Math.sin(t);
    return [
...
function isInBoxRange(t, r, e) {
  ...
  return (t.X ?? 0) > o && (t.X ?? 0) < n && (t.Y ?? 0) > a && (t.Y ?? 0) < c && (t.Z ?? 0) > i && (t.Z ?? 0) < e
}

function isInCylinderRange(t, r, e) {
  var e = Math.sqrt(((t.X ?? 0) - ((e.X ?? 0) + (r.Center.X ?? 0))) ** 2 + ((t.Y ?? 0) - ((e.Y ?? 0) + (r.Center.Y ?? 0))) ** 2),
...
function isInHollowCylinderRange(t, r, e) {
  var o = Math.sqrt(((t.X ?? 0) - ((e.X ?? 0) + (r.Center.X ?? 0))) ** 2 + ((t.Y ?? 0) - ((e.Y ?? 0) + (r.Center.Y ?? 0))) ** 2),
    n = (e.Z ?? 0) + (r.Center.Z ?? 0) - r.Height / 2,
    e = (e.Z ?? 0) + (r.Center.Z ?? 0) + r.Height / 2;
  return o <= r.Radius && o >= r.InnerRadius && (t.Z ?? 0) > n && (t.Z ?? 0) < e
}
...
function getCylinderCorners(t, r) {
  var {
    ...
    Y: 0,
    Z: o / 2
  }, t = toVector3R(t.Center), a = Vector3Op.Add(t, Vector3Op.Rotate(n, r)), c = Vector3Op.Add(t, Vector3Op.Rotate(o, r)), i = [];
...
function calculateNormal(t, r, e) {
  r = Vector3Op.Sub(r, t), e = Vector3Op.Sub(e, t), t = Vector3Op.Cross(r, e);
...
function getCrossProductAxes(r, e) {
  ...
  for (let t = 0; t < r.length; t++) {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      .001 < Vector3Op.Magnitude(i) && o.push(Vector3Op.Normalize(i))
    }
  }
  return o
}
...
function isBoxesOverlapping(t, r, e = Vector3Op.Zero, o = Vector3Op.Zero) {
  var n, a, c, i, s, p, u, V, O, h, l, x;
  if (e === Vector3Op.Zero && o === Vector3Op.Zero) return {
    X: n = 0,
    Y: a = 0,
    Z: c = 0
    ...
    Y: l = 0,
    Z: x = 0
  } = Vector3Op.Add(toVector3R(r.Center), toVector3R(r.Size)), n <= h && u <= i && a <= l && V <= s && c <= x && O <= p;
  var M = getBoxCorners(t, e ?? Vector3Op.Zero),
    g = getBoxCorners(r, o ?? Vector3Op.Zero);
  for (const v of [{
      X: 1,
      Y: 0,
      Z: 0
      ...
      Y: 0,
      Z: 1
    }, ...getCrossProductAxes(M, g)])
    if (!isSeparatingAxisOverlapping(M, g, v)) return !1;
  return !0
}
...
function isBoxOverlappingSphere(t, r, e = Vector3Op.Zero) {
  ...
  a = Vector3Op.GetRotationMatrix(e), e = Vector3Op.ApplyMatrix(Vector3Op.Sub(o, n), a, !0), o = Vector3Op.Clamp(e, {
    X: -t.X,
    Y: -t.Y,
    Z: -t.Z
  }, {
...
function isCylindersOverlapping(t, r, e = Vector3Op.Zero, o = Vector3Op.Zero) {
  var n, a = Math.abs(t.Center.Z ?? 0 - (r.Center.Z ?? 0)) <= (t.Height + r.Height) / 2;
  if (e === Vector3Op.Zero && o === Vector3Op.Zero) return c = Vector3Op.PowDistance(toVector3R(t.Center), toVector3R(r.Center)), n = t.Radius + r.Radius, a && c <= n * n;
  var a = getAxis(e),
    c = getAxis(o),
...
function isCylinderOverlappingSphere(t, r, e = Vector3Op.Zero) {
  ...
  return !(Math.abs(Vector3Op.Dot(Vector3Op.Sub(n, o), i)) > t.Height / 2 + r.Radius) && (o = Vector3Op.Dot(Vector3Op.Sub(n, c), i) / a, i = Math.max(0, Math.min(1, o)), a = Vector3Op.Add(c, Vector3Op.Mul(e, i)), Vector3Op.PowDistance(a, n) <= (r.Radius + t.Radius) ** 2)
}
...
function isBoxOverlappingCylinderPrecise(t, r) {
  ...
  return !(!c && !e) && (o = toVector3R(t.Center), c = toVector3R(t.Size), e = o.Z - c.Z, t = o.Z + c.Z, o = (r.Center.Z ?? 0) - r.Height / 2, c = (r.Center.Z ?? 0) + r.Height / 2, o <= t) && e <= c
}

function isBoxOverlappingCylinder(t, r, e = Vector3Op.Zero, o = Vector3Op.Zero) {
  if (e === Vector3Op.Zero && o === Vector3Op.Zero) return isBoxOverlappingCylinderPrecise(t, r);
...
function isShapesOverlapping(t, r) {
  if ("Sphere" === t.Type && "Sphere" === r.Type) return isSpheresOverlapping(t, r);
  if ("Box" === t.Type && "Box" === r.Type) return isBoxesOverlapping(t, r, t.Rotator, r.Rotator);
  if ("Cylinder" === t.Type && "Cylinder" === r.Type) return isCylindersOverlapping(t, r, t.Rotator, r.Rotator);
  if ("Box" === t.Type && "Sphere" === r.Type) return isBoxOverlappingSphere(t, r, t.Rotator);
  if ("Sphere" === t.Type && "Box" === r.Type) return isBoxOverlappingSphere(r, t, r.Rotator);
  if ("Cylinder" === t.Type && "Sphere" === r.Type) return isCylinderOverlappingSphere(t, r, t.Rotator);
  if ("Sphere" === t.Type && "Cylinder" === r.Type) return isCylinderOverlappingSphere(r, t, r.Rotator);
  if ("Box" === t.Type && "Cylinder" === r.Type) return isBoxOverlappingCylinder(t, r, t.Rotator, r.Rotator);
  if ("Cylinder" === t.Type && "Box" === r.Type) return isBoxOverlappingCylinder(r, t, r.Rotator, t.Rotator);
  throw new Error(`不支持重叠检测的形状类型：${t.Type} 和 ` + r.Type)
}

function getExtraShapeParam(t, r) {
  if (!r) return t;
  switch (t.Type) {
    case IShape_1.ETipsActorType.Box:
      return {
        ...t, ColorType: IShape_1.ETipsActorColorType.Outer, X: t.X + r, Y: t.Y + r, Z: t.Z + r
      };
    case IShape_1.ETipsActorType.Sphere:
      return {
        ...t, ColorType: IShape_1.ETipsActorColorType.Outer, Radius: t.Radius + r
      };
    case IShape_1.ETipsActorType.Cylinder:
    case IShape_1.ETipsActorType.Cone:
      return {
        ...t, ColorType: IShape_1.ETipsActorColorType.Outer, Radius: t.Radius + r, Height: t.Height + r
      };
    default:
      return t
  }
}
exports.Vector3Op = Vector3Op, (_c = Vector3Op).One = _c.New(1, 1, 1), Vector3Op.Zero = _c.New(0, 0, 0), exports.isInRangeConfig = isInRangeConfig, exports.isInSphereRange = isInSphereRange, exports.isInSimpleShape = isInSimpleShape, exports.rotateVertex = rotateVertex, exports.isClockwise = isClockwise, exports.getNormalVector2D = getNormalVector2D, exports.getBoxCorners = getBoxCorners, exports.getCylinderCorners = getCylinderCorners, exports.isShapesOverlapping = isShapesOverlapping, exports.getExtraShapeParam = getExtraShapeParam;
