...
class TalkerListOp {
  ...
  static GetNames() {
    return this.Fe || (this.Fe = this.Get().Talkers.map(t => t.Name)), this.Fe
  }
  static GetNameAndTitles() {
    return this.sZ_ || (this.sZ_ = this.Get().Talkers.map(t => this.GetNameAndTitle(t))), this.sZ_
  }
  static GetId(t, e) {
  ...
  static Load() {
    var t = CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(TalkerCsv_1.TalkerCsv);
    const e = [];
    return t.forEach(t => {
      e.push({
        Id: t.Id,
