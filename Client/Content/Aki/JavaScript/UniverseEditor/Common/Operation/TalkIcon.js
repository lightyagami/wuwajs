...
class TalkIconOp {
  ...
  GetIconByName(e) {
    return CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(TalkIconCsv_1.TalkIconCsv).find(s => s.Type === e)?.Id
  }
  GetIconTextureById(e) {
    return CsvRegistry_1.CsvRegistry.Instance.GetAllCsvRows(TalkIconCsv_1.TalkIconCsv).find(s => s.Id === e)?.Icon
  }
}
