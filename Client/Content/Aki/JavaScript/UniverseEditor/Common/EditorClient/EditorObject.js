...
async function getServerEditorObjMeta(e, t) {
  ...
  t = encodeURIComponent(e), t = await (0, Util_1.doJsonHttpGet)(EDITOR_SERVER_URL + "/" + t);
  return cache.set(e, {
    Obj: t,
    FetchTime: Date.now()
  }), t
}
exports.setServerEditorObjMeta = setServerEditorObjMeta, exports.getServerEditorObjMeta = getServerEditorObjMeta;
