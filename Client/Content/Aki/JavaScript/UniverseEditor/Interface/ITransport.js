...
class Stcp {
  constructor(t, e, s, i) {
    this.Name = t, this.sFn = e, this.x5 = s, this.IsServer = i, this.S5 = [], this.W3 = [], this.E5 = 0, this.R5 = 0, this.I5 = 0, this.N5 = 0, this.L5 = !1, this.w5 = EConnectStatus.Disconnected, this.M5 = 0, this.Verbose = !1, i || (this.M5 = Stcp.F5())
  }
  static F5() {
  ...
  D5() {
    var t;
    this.IsServer || 0 !== this.S5.length && (t = {
      Type: EPackage.Connect,
      ConnectId: this.M5
    }, this.sFn.Send(t), this.w5 = EConnectStatus.Connecting)
  }
  k5() {
    var t;
    this.IsServer || (t = {
  ...
  b5() {
    var t;
    0 === this.S5.length && !this.L5 || (t = this.O5(), this.sFn.Send(t), 0 === this.S5.length && (this.L5 = !1), this.A5(this.Name + " send " + packageToString(t)))
  }
  q5() {
    switch (this.w5) {
  ...
  Send(t) {
    if (this.S5.length >= Stcp.MaxSeqId) throw new Error("SendQueue.length >= Stcp.MaxSeqId");
    this.S5.push({
      Seq: this.E5,
      Payload: t
    }), this.E5++, this.q5()
  ...
  B5(t) {
    if (t.Type !== EPackage.Message) t.Type === EPackage.Connect ? this.IsServer ? t.ConnectId > this.M5 ? this.G5(t) : t.ConnectId === this.M5 && this.U5(t.ConnectId) : this.x5.Error("client recv connect") : this.IsServer && this.x5.Error("sv recv connect ack");
    else {
      if (0 < t.Msgs.length && (this.L5 = !0), t.Ack > this.I5)
        for (this.I5 = t.Ack; 0 < this.S5.length && this.S5[0].Seq < this.I5;) this.S5.shift();
      t.Msgs.forEach(t => {
  ...
  V5(t) {
    this.IsServer || t.Type === EPackage.ConnectAck && t.ConnectId === this.M5 && this.j5()
  }
  Reset() {
    this.IsServer ? this.x5.Error("sv can not reset") : this.H5()
  }
  H5() {
    this.S5 = [], this.W3 = [], this.E5 = 0, this.R5 = 0, this.I5 = 0, this.N5 = 0, this.L5 = !1, this.w5 = EConnectStatus.Disconnected, this.M5 = Stcp.F5()
  }
  Q5() {
    this.S5 = [], this.W3 = [], this.E5 = 0, this.R5 = 0, this.I5 = 0, this.N5 = 0, this.L5 = !1, this.w5 = EConnectStatus.Disconnected
  }
  j5() {
    this.w5 = EConnectStatus.Connected
  }
  G5(t) {
    this.Q5(), this.w5 = EConnectStatus.Connected, this.M5 = t.ConnectId, this.U5(t.ConnectId)
  }
  W5(t) {
    !this.IsServer || t.Type !== EPackage.Connect || t.ConnectId <= this.M5 || this.G5(t)
  }
  X5() {
...
}(exports.Stcp = Stcp).RefreshInterval = 20, Stcp.MaxSeqId = 256, Stcp.P5 = 0;
class RpcServer {
  constructor(t, e, s) {
  ...
  Update() {
    ...
    if (e) {
      ...
      if (e) {
        var t, s = void 0;
        try {
          (s = e(...i.Args)) instanceof Promise ? s.then(t => {
            t = {
              Id: i.Id,
              Result: t
            };
      ...
      } else this.x5.Error(`RpcServer: function ${i.Name} not found`), s = {
        Id: i.Id,
        Result: void 0,
  ...
  Start() {
    this.j3 || (this.G3.Start(), this.j3 = setInterval(this.Update.bind(this), 1))
  }
  Stop() {
