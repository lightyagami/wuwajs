...
exports.globalConfigTemp = exports.globalConfig = exports.BRANCH_EXTENSIONS_DIR = exports.USE_TEMP_PATH = exports.GLOBAL_CONFIG_PATH = undefined;
...
function getGlobalConfig() {
  if ((0, Init_1.isUe5)()) {
    return {
      ...
      FlowTemplateCameraConfigPath: "Content/Data/Json/FlowTemplateCamera.json",
      FlowTemplateCameraConfgSourcePath: "Content/Data/FlowTemplateCamera/FlowTemplateCamera.json",
      GlobalVarConfigPath: "Content/Data/Json/GlobalVar.json",
      SystemVarConfigPath: "Content/Data/Json/SystemVar.json",
      VehicleRidingRolesConfigPath: "Content/Data/Json/VehicleRidingRoles.json",
      GridItemShapeConfigPath: "Content/Data/Json/GridItemShapeConfigPath.json",
      ...
      AbpOverlayMontageConfigPath: "Content/Data/Json/AbpOverlayMontageConfig.json",
      AbpStateConfigPath: "Content/Data/Json/AbpStateConfig.json",
      FaceExpressionConfigPath: "Content/Data/Json/FaceExpressionConfig.json",
      AoiGroupPath: "Content/Data/Json/AoiGroupPath.json",
      EntityPerformanceDataPath: "Content/Data/Json/EntityPerformanceData.json",
      ...
      TextLibraryDir: "Content/Data/Tables",
    ...
    return {
      ...
      TextLibraryDir: "../Config/Raw/Tables/w.文本库",
      ...
      BehaviorTreeFragmentDir: "../Config/Raw/Tables/k.可视化编辑/x.行为树片段",
      ...
      EntityConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Entity.json",
      BlueprintConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Blueprint.json",
      EntityStateConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/EntityState.json",
      EntityOwnerConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/EntityOwner.json",
      AlwaysLoadEntityConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/AlwaysLoadEntity.json",
      LevelsDataDir: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Levels",
      TemplateConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/Template.json",
      PrefabConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/Prefab.json",
      EntityDataConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/EntityData.json",
      OccupationConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/Occupation.json",
      OccupiedExportPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/OccupiedExport.json",
      FlowTemplateConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/FlowTemplate.json",
      FlowTemplateCameraConfgSourcePath: "../Config/Raw/Tables/k.可视化编辑/y.演出模板/FlowTemplateCamera.json",
      FlowTemplateCameraConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/FlowTemplateCamera.json",
      InteractOptionConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/InteractOption.json",
      BtConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/BtConfig.json",
      MontageConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/MontageConfig.json",
      AbpMontageConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/AbpMontageConfig.json",
      AbpOverlayMontageConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/AbpOverlayMontageConfig.json",
      AbpStateConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/AbpStateConfig.json",
      FaceExpressionConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/FaceExpressionConfig.json",
      AoiGroupPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/AoiGroupPath.json",
      ActorRefConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/ActorRefConfig.json",
      AoiDefineDataPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/AoiDefine.json",
      EditorStartConfig: "../Config/Raw/Tables/k.可视化编辑/__Temp__/EditorStartConfig.json",
      BubbleConfigPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/BubbleConfig.json",
      TidTextTempPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Csv/TidText.csv",
      AudioStatePath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/a.AudioState.json",
      PlotHandBookPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/PlotHandBook.json",
      PlotPositionPath: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/PlotPosition.json",
      EnrichmentArea: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/EnrichmentArea.json",
      BrokenRockConfig: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/BrokenRockConfig.json",
      FishingRouletteConfig: "../Config/Raw/Tables/k.可视化编辑/__Temp__/Json/FishingRouletteConfig.json",
...
exports.GLOBAL_CONFIG_PATH = (0, Init_1.isUe5)() ? "Content/Aki/Data/Json/Global.json" : "../Config/Raw/Tables/k.可视化编辑/Global.json";
exports.USE_TEMP_PATH = "../Config/Raw/Tables/k.可视化编辑/__Temp__/UseTemp";
exports.BRANCH_EXTENSIONS_DIR = "../Config/Raw/Tables/k.可视化编辑/b.BranchExtensions";
...
exports.globalConfigTemp = {
  ...
  EntityDataConfigPath: "Content/Aki/UniverseEditorConfig/Json/EntityData.json",
  FlowTemplateConfigPath: "Content/Aki/UniverseEditorConfig/Json/FlowTemplate.json",
  FlowTemplateCameraConfgSourcePath: "Content/Aki/UniverseEditorConfig/FlowTemplateCamera/FlowTemplateCamera.json",
  FlowTemplateCameraConfigPath: "Content/Aki/UniverseEditorConfig/Json/FlowTemplateCamera.json",
  TypeScriptRoot: "TypeScript/Src",
  ...
  VehicleRidingRolesConfigPath: "Content/Aki/UniverseEditorConfig/Json/VehicleRidingRoles.json",
  GridItemShapeConfigPath: "Content/Aki/UniverseEditorConfig/Json/GridItemShapeConfigPath.json",
  OccupationConfigPath: "Content/Aki/UniverseEditorConfig/Json/Occupation.json",
  OccupiedExportPath: "Content/Aki/UniverseEditorConfig/Json/OccupiedExport.json",
  InteractOptionConfigPath: "Content/Aki/UniverseEditorConfig/InteractOption.json",
  ...
  MontageConfigPath: "Content/Aki/UniverseEditorConfig/Json/MontageConfig.json",
  AbpMontageConfigPath: "Content/Aki/UniverseEditorConfig/Json/AbpMontageConfig.json",
  AbpOverlayMontageConfigPath: "Content/Aki/UniverseEditorConfig/Json/AbpOverlayMontageConfig.json",
  AbpStateConfigPath: "Content/Aki/UniverseEditorConfig/Json/AbpStateConfig.json",
  FaceExpressionConfigPath: "Content/Aki/UniverseEditorConfig/Json/FaceExpressionConfig.json",
  AoiGroupPath: "Content/Aki/UniverseEditorConfig/Json/AoiGroupPath.json",
  ActorRefConfigPath: "Content/Aki/UniverseEditorConfig/Json/ActorRefConfig.json",
  EntityPerformanceDataPath: "Content/Aki/UniverseEditorConfig/EntityPerformanceData.json",
  ...
  BrokenRockConfig: "Content/Aki/UniverseEditorConfig/Json/BrokenRockConfig.json",
  FishingRouletteConfig: "Content/Aki/UniverseEditorConfig/Json/FishingRouletteConfig.json",
  AreaQuestTracking: "Content/Aki/UniverseEditorConfig/AreaQuestTracking.json",
  LevelBuildingGrids: "Content/Aki/UniverseEditorConfig/LevelBuildingGrids.json",
  HideGroupFixConfigPath: "Content/Aki/UniverseEditorConfig/Json/HideGroupFixConfig.json",
