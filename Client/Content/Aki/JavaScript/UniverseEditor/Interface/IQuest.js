...
var EBindingProgressType;
var EStatisticsEventType;
...
var EAtomicProcess;
var EUseWeatherSwitchCheckType;
...
(function (e) {
  e.Task = "Task";
  e.LevelPlay = "LevelPlay";
})(EQuestScheduleUiType = exports.EQuestScheduleUiType ||= {});
(function (e) {
  e.None = "None";
...
(function (e) {
  e.UseCount = "UseCount";
  e.UseVar = "UseVar";
})(EProgressBarLeftType = exports.EProgressBarLeftType ||= {});
(EBindingProgressType = exports.EBindingProgressType ||= {}).PlayerHavingItemCount = "PlayerHavingItemCount";
(function (e) {
  e.Collect = "Collect";
  e.UseSkill = "UseSkill";
...
})(EStatisticsEventType = exports.EStatisticsEventType ||= {});
(function (e) {
  e.HitCount = "HitCount";
  e.BeDamage = "BeDamage";
})(EPlayerHitStatisticsType = exports.EPlayerHitStatisticsType ||= {});
(function (e) {
  e.DamagePoint = "DamagePoint";
  e.DamagePercentage = "DamagePercentage";
})(EPlayerDamageInfoType = exports.EPlayerDamageInfoType ||= {});
(function (e) {
  ...
  e.CompareActorVar = "CompareActorVar";
...
exports.childQuestForLevelPlay = new Set(childQuestAll.filter(e => e !== EChildQuest.EnterDungeon && e !== EChildQuest.FinishDungeon));
...
})(EUseSkillCheckType = exports.EUseSkillCheckType ||= {});
exports.combatStateConfig = {
  无冠者: {
...
(function (e) {
  e.Player = "Player";
  e.Monster = "Monster";
})(ETargetBattleAttribute = exports.ETargetBattleAttribute ||= {});
(EAttributeToTarget = exports.EAttributeToTarget ||= {}).Health = "Health";
(function (e) {
  e.DisableHLOD = "DisableHLOD";
...
(function (e) {
  e.Interact = "Interact";
  e.Range = "Range";
})(ERollBlockLaunchMethod = exports.ERollBlockLaunchMethod ||= {});
(EAtomicProcess = exports.EAtomicProcess ||= {}).StoveCoreFall = "StoveCoreFall";
(function (e) {
  e.SpecifiedWeather = "SpecifiedWeather";
  e.AnyWeather = "AnyWeather";
})(EUseWeatherSwitchCheckType = exports.EUseWeatherSwitchCheckType ||= {});
...
exports.repeatBanList = ["GetItem", "SendNpcMail", "ManualOccupations", "DestroyQuest", "TeleportDungeon", "FinishDungeon"]; //# sourceMappingURL=IQuest.js.map