...
const LanguageSystem_1 = require("../../Common/LanguageSystem"),
  ...
  getLocalTextStat = Stats_1.Stat.CreateNoFlameGraph("configCommonParamLang.GetLocalText"),
...
exports.configCommonParamLang = {
  ...
  GetLocalText: (o, a = void 0) => {
    ...
    if (getLocalTextStat?.Start(), t?.Start(), LanguageSystem_1.LanguageSystem.GmShowLanguageKey) return n = LanguageSystem_1.LanguageSystem.GetCultureOrDefault(a), t?.Stop(), getLocalTextStat?.Stop(), `CommonParam|${o}|` + n;
    ...
    if (C = ConfigCommon_1.ConfigCommon.CheckStatement(m)) {
      if (C = (C = ConfigCommon_1.ConfigCommon.BindInt(m, 1, o, ...logPair, ["Id", o])) && 0 < ConfigCommon_1.ConfigCommon.Step(m, !0, ...logPair, ["传入语言", a], ["查询语言", n], ["文本Id", o])) {
        var g = void 0;
        if ([C, g] = ConfigCommon_1.ConfigCommon.GetValue(m, 0, ...logPair, ["传入语言", a], ["查询语言", n], ["文本Id", o]), C) {
          var C = DeserializeConfig_1.DeserializeConfig.ParseString(g, 0, ...logPair, ["传入语言", a], ["查询语言", n], ["文本Id", o]);
          if (C.Success) return i = C.Value, e.set(n, i), ConfigCommon_1.ConfigCommon.Reset(m), t?.Stop(), getLocalTextStat?.Stop(), i
        }
      }
