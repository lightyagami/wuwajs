...
class Area {
  ...
  get SunSpiritAreaCollectMaxNum() {
    return this.sunspiritareacollectmaxnum();
  }
  ...
  get IsEnableSceneInteractionEffects() {
    return this.isenablesceneinteractioneffects();
  }
  __init(t, e) {
    this.z7 = t;
    this.J7 = e;
  ...
  isenablesceneinteractioneffects() {
