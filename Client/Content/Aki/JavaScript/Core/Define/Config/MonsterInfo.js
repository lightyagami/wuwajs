...
class MonsterInfo {
  ...
  get ElementIdArray() {
    return GameUtils_1.GameUtils.ConvertToArray(this.elementidarrayLength(), this.elementidarray, this)
  }
  get MonsterEntityID() {
  ...
  get PerchId() {
    return GameUtils_1.GameUtils.ConvertToArray(this.perchidLength(), this.perchid, this)
  }
  __init(t, i) {
    return this.z7 = t, this.J7 = i, this
  }
  static getRootAsMonsterInfo(t, i) {
    return (i || new MonsterInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
