...
class MotorSkin {
  ...
  static getRootAsMotorSkin(t, i) {
    return (i || new MotorSkin()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
...
exports.MotorSkin = MotorSkin;
//# sourceMappingURL=MotorSkin.js.map