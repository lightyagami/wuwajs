...
exports.WorldNewJourney = undefined;
...
class WorldNewJourney {
  ...
  static getRootAsWorldNewJourney(t, i) {
    return (i || new WorldNewJourney()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
  ...
  jumpto(t, i) {
    ...
    if (r) {
      return (i || new DicIntString_1.DicIntString()).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + t * 4), this.J7);
    } else {
      return null;
    }
  }
