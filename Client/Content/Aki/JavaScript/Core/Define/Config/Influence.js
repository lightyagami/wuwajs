...
class Influence {
  ...
  get ReputationItem() {
    return GameUtils_1.GameUtils.ConvertToArray(this.reputationitemLength(), this.reputationitem, this);
  }
  get ReputationReward() {
    return GameUtils_1.GameUtils.ConvertToArray(this.reputationrewardLength(), this.reputationreward, this);
  }
  get PartyTags() {
    return GameUtils_1.GameUtils.ConvertToArray(this.partytagsLength(), this.partytags, this);
  }
  __init(t, i) {
    this.z7 = t;
    this.J7 = i;
  ...
  static getRootAsInfluence(t, i) {
    return (i || new Influence()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
