...
exports.AreaTerminal = undefined;
...
class AreaTerminal {
  ...
  static getRootAsAreaTerminal(t, i) {
    return (i || new AreaTerminal()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
...
exports.AreaTerminal = AreaTerminal;
//# sourceMappingURL=AreaTerminal.js.map