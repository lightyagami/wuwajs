...
exports.EnrichmentAreaConfig = undefined;
...
class EnrichmentAreaConfig {
  ...
  get EntityIds() {
    return GameUtils_1.GameUtils.ConvertToArray(this.entityidsLength(), this.entityids, this);
  }
  __init(t, i) {
    this.z7 = t;
    this.J7 = i;
  ...
  static getRootAsEnrichmentAreaConfig(t, i) {
    return (i || new EnrichmentAreaConfig()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
