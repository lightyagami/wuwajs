...
class ChatDialog {
  ...
  static getRootAsChatDialog(t, i) {
    return (i || new ChatDialog()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
...
//# sourceMappingURL=ChatDialog.js.map