...
exports.SilentAreaDetection = undefined;
...
class SilentAreaDetection {
  ...
  get PeriodicityChallengeType() {
    return this.periodicitychallengetype();
  }
  get DetectionTitlePanel() {
    return this.detectiontitlepanel();
  }
  get LeftBgSprite() {
    return this.leftbgsprite();
  }
  get RightBgSprite() {
    return this.rightbgsprite();
  }
  get DungeonId() {
  ...
  static getRootAsSilentAreaDetection(t, i) {
    return (i || new SilentAreaDetection()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
