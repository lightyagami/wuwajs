...
class RecordCondition {
  ...
  get Nullenable() {
    return GameUtils_1.GameUtils.ConvertToArray(this.nullenableLength(), this.nullenable, this)
  }
  get Param1() {
  ...
  static getRootAsRecordCondition(t, i) {
    return (i || new RecordCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  typeid() {
