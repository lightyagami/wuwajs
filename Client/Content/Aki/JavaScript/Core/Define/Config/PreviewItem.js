...
class PreviewItem {
  ...
  get PreviewItemAccess() {
    return GameUtils_1.GameUtils.ConvertToArray(this.previewitemaccessLength(), this.previewitemaccess, this)
  }
  __init(t, i) {
    return this.z7 = t, this.J7 = i, this
  }
  static getRootAsPreviewItem(t, i) {
    return (i || new PreviewItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
