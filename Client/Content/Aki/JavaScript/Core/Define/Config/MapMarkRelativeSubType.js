...
exports.MapMarkRelativeSubType = undefined;
...
class MapMarkRelativeSubType {
  ...
  static getRootAsMapMarkRelativeSubType(t, e) {
    return (e || new MapMarkRelativeSubType()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
  ...
  position(t) {
    ...
    if (e) {
      return (t || new IntVector_1.IntVector()).__init(this.J7.__indirect(this.z7 + e), this.J7);
    } else {
      return null;
    }
  }
