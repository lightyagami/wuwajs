...
exports.DangoMonopolyGrid = undefined;
...
class DangoMonopolyGrid {
  ...
  get GridInfo() {
    return GameUtils_1.GameUtils.ConvertToArray(this.gridinfoLength(), this.gridinfo, this);
  }
  get AddPropertyId() {
  ...
  static getRootAsDangoMonopolyGrid(t, i) {
    return (i || new DangoMonopolyGrid()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
