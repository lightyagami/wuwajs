...
class FlySkinConfig {
  ...
  get PreviewTextureInBuyView() {
    return this.previewtextureinbuyview()
  }
  get PreviewTextureInPayShop() {
    return this.previewtextureinpayshop()
  }
  get PreviewTextureInPop() {
    return this.previewtextureinpop()
  }
  get SkinObtainColor1() {
    return this.skinobtaincolor1()
  }
  get SkinObtainColor2() {
    return this.skinobtaincolor2()
  }
  get SkinObtainImage() {
    return this.skinobtainimage()
  }
  get IsSpecialViewAfterObtain() {
    return this.isspecialviewafterobtain()
  }
  __init(t, i) {
    return this.z7 = t, this.J7 = i, this
  }
  static getRootAsFlySkinConfig(t, i) {
    return (i || new FlySkinConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  previewtextureinbuyview(t) {
    var i = this.J7.__offset(this.z7, 42),
      i = i ? this.J7.__string(this.z7 + i, t) : null;
    return "string" == typeof i && GameUtils_1.GameUtils.IsOptimizeDbString && GameUtils_1.GameUtils.InternalizedString(i), i
  }
  previewtextureinpayshop(t) {
    var i = this.J7.__offset(this.z7, 44),
      i = i ? this.J7.__string(this.z7 + i, t) : null;
    return "string" == typeof i && GameUtils_1.GameUtils.IsOptimizeDbString && GameUtils_1.GameUtils.InternalizedString(i), i
  }
  previewtextureinpop(t) {
