...
class FishingEntrust {
  ...
  entrusttarget(t, s) {
    ...
    return r ? (s || new DicIntInt_1.DicIntInt).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  entrusttargetLength() {
  ...
  targetdestext(t, s) {
    ...
    return r ? (s || new DicIntString_1.DicIntString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  targetdestextLength() {
