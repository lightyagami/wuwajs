...
class Shield {
  ...
  get AttributeRate() {
    return GameUtils_1.GameUtils.ConvertToArray(this.attributerateLength(), this.attributerate, this)
  }
  get Value() {
    return GameUtils_1.GameUtils.ConvertToArray(this.valueLength(), this.value, this)
  }
  __init(t, i) {
    return this.z7 = t, this.J7 = i, this
  }
  static getRootAsShield(t, i) {
    return (i || new Shield).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
