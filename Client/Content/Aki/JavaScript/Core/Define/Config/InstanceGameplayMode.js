...
exports.InstanceGameplayMode = undefined;
...
class InstanceGameplayMode {
  ...
  get CameraParams() {
    return GameUtils_1.GameUtils.ConvertToArray(this.cameraparamsLength(), this.cameraparams, this);
  }
  __init(t, s) {
    this.z7 = t;
    this.J7 = s;
  ...
  static getRootAsInstanceGameplayMode(t, s) {
    return (s || new InstanceGameplayMode()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
