...
exports.PhonographMusic = undefined;
...
class PhonographMusic {
  ...
  get Album() {
    return GameUtils_1.GameUtils.ConvertToArray(this.albumLength(), this.album, this);
  }
  get Lock() {
    return this.lock();
  }
  ...
  static getRootAsPhonographMusic(t, i) {
    return (i || new PhonographMusic()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
