...
class AbyssRoleLevel {
  ...
  consume(t, s) {
    ...
    return e ? (s || new DicIntInt_1.DicIntInt).__init(this.J7.__indirect(this.J7.__vector(this.z7 + e) + 4 * t), this.J7) : null
  }
  consumeLength() {
  ...
  prop(t, s) {
    ...
    return e ? (s || new ConfigPropValue_1.ConfigPropValue).__init(this.J7.__indirect(this.J7.__vector(this.z7 + e) + 4 * t), this.J7) : null
  }
  propLength() {
