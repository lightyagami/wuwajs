...
exports.SkillFollowerButton = undefined;
...
class SkillFollowerButton {
  ...
  get NotOccupyTags() {
    return GameUtils_1.GameUtils.ConvertToArray(this.notoccupytagsLength(), this.notoccupytags, this);
  }
  get ElementId() {
  ...
  static getRootAsSkillFollowerButton(t, i) {
    return (i || new SkillFollowerButton()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
