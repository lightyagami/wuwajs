...
exports.InstanceTrialRoleConfig = undefined;
...
class InstanceTrialRoleConfig {
  ...
  get MaleFormation() {
    return GameUtils_1.GameUtils.ConvertToArray(this.maleformationLength(), this.maleformation, this);
  }
  get FemaleFormation() {
    return GameUtils_1.GameUtils.ConvertToArray(this.femaleformationLength(), this.femaleformation, this);
  }
  get MaleDelayFormation() {
    return GameUtils_1.GameUtils.ConvertToArray(this.maledelayformationLength(), this.maledelayformation, this);
  }
  get FemaleDelayFormation() {
    return GameUtils_1.GameUtils.ConvertToArray(this.femaledelayformationLength(), this.femaledelayformation, this);
  }
  get OnlyTrial() {
  ...
  static getRootAsInstanceTrialRoleConfig(t, i) {
    return (i || new InstanceTrialRoleConfig()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
