...
class WeaponSkin {
  ...
  get StandAnim() {
    return GameUtils_1.GameUtils.ConvertToArray(this.standanimLength(), this.standanim, this);
  }
  get TypeDescription() {
  ...
  static getRootAsWeaponSkin(t, i) {
    return (i || new WeaponSkin()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
