...
exports.LordGymEntrance = undefined;
...
class LordGymEntrance {
  ...
  get LordGymList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.lordgymlistLength(), this.lordgymlist, this);
  }
  get EntranceTitle() {
  ...
  static getRootAsLordGymEntrance(t, i) {
    return (i || new LordGymEntrance()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
