...
class SpecialFormation {
  ...
  get CharacterId() {
    return GameUtils_1.GameUtils.ConvertToArray(this.characteridLength(), this.characterid, this)
  }
  __init(t, i) {
    return this.z7 = t, this.J7 = i, this
  }
  static getRootAsSpecialFormation(t, i) {
    return (i || new SpecialFormation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
