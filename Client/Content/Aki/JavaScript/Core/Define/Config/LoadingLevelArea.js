...
exports.LoadingLevelArea = undefined;
...
class LoadingLevelArea {
  ...
  get AreaId() {
    return GameUtils_1.GameUtils.ConvertToArray(this.areaidLength(), this.areaid, this);
  }
  get MapId() {
    return GameUtils_1.GameUtils.ConvertToArray(this.mapidLength(), this.mapid, this);
  }
  get ConditionGroup() {
  ...
  static getRootAsLoadingLevelArea(t, i) {
    return (i || new LoadingLevelArea()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
