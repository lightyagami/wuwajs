...
class DreamLinkRoleDungeon {
  ...
  get WeaponShowConfig() {
    return GameUtils_1.GameUtils.ConvertToMap(this.weaponshowconfigLength(), this.weaponshowconfigKey, this.weaponshowconfigValue, this)
  }
  ...
  get WeaponShowCase() {
    return GameUtils_1.GameUtils.ConvertToMap(this.weaponshowcaseLength(), this.weaponshowcaseKey, this.weaponshowcaseValue, this)
  }
  weaponshowcaseKey(t) {
  ...
  static getRootAsDreamLinkRoleDungeon(t, i) {
    return (i || new DreamLinkRoleDungeon).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  weaponshowconfig(t, i) {
    ...
    return e ? (i || new DicStringString_1.DicStringString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + e) + 4 * t), this.J7) : null
  }
