...
class SCreatureGenNavAssistFileExportDefine {
  ...
  areas(e, t) {
    ...
    return s ? (t || new SCreatureGenNavAssistAreaExportDefine_1.SCreatureGenNavAssistAreaExportDefine).__init(this.J7.__indirect(this.J7.__vector(this.z7 + s) + 4 * e), this.J7) : null
  }
  areasLength() {
