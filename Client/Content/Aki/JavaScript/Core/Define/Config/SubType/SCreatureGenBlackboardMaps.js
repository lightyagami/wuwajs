...
class SCreatureGenBlackboardMaps {
  ...
  mapstring(t, i) {
    ...
    return r ? (i || new DicStringString_1.DicStringString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  mapstringLength() {
  ...
  mapint(t, i) {
    ...
    return r ? (i || new DicStringInt_1.DicStringInt).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  mapintLength() {
  ...
  mapbool(t, i) {
    ...
    return r ? (i || new DicStringBool_1.DicStringBool).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  mapboolLength() {
