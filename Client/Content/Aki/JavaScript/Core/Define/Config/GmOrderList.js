...
class GmOrderList {
  ...
  get OrderList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.orderlistLength(), this.orderlist, this)
  }
  __init(t, s) {
    return this.z7 = t, this.J7 = s, this
  }
  static getRootAsGmOrderList(t, s) {
    return (s || new GmOrderList).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
