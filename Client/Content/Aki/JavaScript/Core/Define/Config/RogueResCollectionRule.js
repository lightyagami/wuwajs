...
class RogueResCollectionRule {
  ...
  get Seasons() {
    return GameUtils_1.GameUtils.ConvertToArray(this.seasonsLength(), this.seasons, this)
  }
  __init(t, s) {
    return this.z7 = t, this.J7 = s, this
  }
  static getRootAsRogueResCollectionRule(t, s) {
    return (s || new RogueResCollectionRule).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
