...
class SpringChat {
  ...
  get ContentList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.contentlistLength(), this.contentlist, this);
  }
  get PosList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.poslistLength(), this.poslist, this);
  }
  get AnimNameList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.animnamelistLength(), this.animnamelist, this);
  }
  get LeftSpineAtlas() {
  ...
  static getRootAsSpringChat(t, i) {
    return (i || new SpringChat()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
