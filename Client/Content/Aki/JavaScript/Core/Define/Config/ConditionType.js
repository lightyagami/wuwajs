...
class ConditionType {
  ...
  get RegisterPlaces() {
    return GameUtils_1.GameUtils.ConvertToArray(this.registerplacesLength(), this.registerplaces, this)
  }
  get Param1() {
  ...
  get Param8() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param8Length(), this.param8Key, this.param8Value, this)
  }
  param8Key(t) {
  ...
  get Param9() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param9Length(), this.param9Key, this.param9Value, this)
  }
  param9Key(t) {
  ...
  get Param10() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param10Length(), this.param10Key, this.param10Value, this)
  }
  param10Key(t) {
  ...
  get Param11() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param11Length(), this.param11Key, this.param11Value, this)
  }
  param11Key(t) {
  ...
  get Param12() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param12Length(), this.param12Key, this.param12Value, this)
  }
  param12Key(t) {
  ...
  get Param13() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param13Length(), this.param13Key, this.param13Value, this)
  }
  param13Key(t) {
  ...
  get Param14() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param14Length(), this.param14Key, this.param14Value, this)
  }
  param14Key(t) {
  ...
  get Param15() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param15Length(), this.param15Key, this.param15Value, this)
  }
  param15Key(t) {
  ...
  get Param16() {
    return GameUtils_1.GameUtils.ConvertToMap(this.param16Length(), this.param16Key, this.param16Value, this)
  }
  param16Key(t) {
  ...
  static getRootAsConditionType(t, r) {
    return (r || new ConditionType).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  param1(t, r) {
    ...
    return i ? (r || new DicStringString_1.DicStringString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + i) + 4 * t), this.J7) : null
  }
  param1Length() {
