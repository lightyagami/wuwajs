...
class InstanceDungeon {
  ...
  onlinetype() {
    ...
    return t ? this.J7.readInt8(this.z7 + t) : InstOnlineType_1.InstOnlineType.Single
  }
  GetCustomtypesAt(t) {
  ...
  entranceentities(t, i) {
    ...
    return s ? (i || new DungeonEntrance_1.DungeonEntrance).__init(this.J7.__indirect(this.J7.__vector(this.z7 + s) + 4 * t), this.J7) : null
  }
  ...
  subtitle(t, i) {
    ...
    return s ? (i || new DicIntString_1.DicIntString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + s) + 4 * t), this.J7) : null
  }
  subtitleLength() {
