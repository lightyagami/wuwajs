...
class InstanceDungeon {
  ...
  get EntityLevelIds() {
    return GameUtils_1.GameUtils.ConvertToArray(this.entitylevelidsLength(), this.entitylevelids, this);
  }
  get MiniMapId() {
  ...
  GetEntitylevelidsAt(t) {
    return this.entitylevelids(t);
  }
  entitylevelids(t) {
  ...
  limitviewname(t, i) {
    var s = this.J7.__offset(this.z7, 96);
    var s = s ? this.J7.__string(this.J7.__vector(this.z7 + s) + t * 4, i) : null;
    if (typeof s == "string" && GameUtils_1.GameUtils.IsOptimizeDbString) {
      GameUtils_1.GameUtils.InternalizedString(s);
    }
  ...
  drop(t) {
    var i = this.J7.__offset(this.z7, 132);
    if (i) {
      return this.J7.readInt32(this.J7.__vector(this.z7 + i) + t * 4);
    } else {
      return 0;
  ...
  icontagpath(t) {
    var i = this.J7.__offset(this.z7, 138);
    var i = i ? this.J7.__string(this.z7 + i, t) : null;
    if (typeof i == "string" && GameUtils_1.GameUtils.IsOptimizeDbString) {
      GameUtils_1.GameUtils.InternalizedString(i);
    }
