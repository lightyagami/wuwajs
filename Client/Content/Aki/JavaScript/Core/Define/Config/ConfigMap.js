...
class ConfigMap extends ConfigDefineBase_1.ConfigBase {
  constructor() {
    super(...arguments), this.TableName = "", this.ConfigDb = "", this.TextDb = ""
  }
}

function getConfigTypeInfo() {
  return ["tableMap", (0, ConfigDefineBase_1.createTypeInfo)("ConfigMap", "ConfigMap", ConfigMap, [
    ["RowId", "Int"],
    ["TableName", "String"],
    ["ConfigDb", "String"],
    ["TextDb", "String"]
...
exports.ConfigMap = ConfigMap, exports.getConfigTypeInfo = getConfigTypeInfo;
