...
class MotorFrame {
  ...
  get ModelBuff() {
    return GameUtils_1.GameUtils.ConvertToArray(this.modelbuffLength(), this.modelbuff, this);
  }
  get ModelAnim() {
  ...
  static getRootAsMotorFrame(t, i) {
    return (i || new MotorFrame()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
...
exports.MotorFrame = MotorFrame;
//# sourceMappingURL=MotorFrame.js.map