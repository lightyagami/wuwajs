...
class FishingQteConfig {
  ...
  static getRootAsFishingQteConfig(t, e) {
    return (e || new FishingQteConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  invalidarea(t, e) {
    ...
    return r ? (e || new IntArray_1.IntArray).__init(this.J7.__indirect(this.J7.__vector(this.z7 + r) + 4 * t), this.J7) : null
  }
  invalidareaLength() {
