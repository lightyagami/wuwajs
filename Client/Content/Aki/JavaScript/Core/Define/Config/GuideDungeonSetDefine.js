...
exports.GuideDungeonSetDefine = undefined;
...
class GuideDungeonSetDefine {
  ...
  get DungeonIdList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.dungeonidlistLength(), this.dungeonidlist, this);
  }
  __init(t, i) {
    this.z7 = t;
    this.J7 = i;
  ...
  static getRootAsGuideDungeonSetDefine(t, i) {
    return (i || new GuideDungeonSetDefine()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  strid(t) {
