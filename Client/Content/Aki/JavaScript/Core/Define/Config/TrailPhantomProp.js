...
class TrailPhantomProp {
  ...
  mainprop(t) {
    ...
    return r ? (t || new ConfigPropValue_1.ConfigPropValue).__init(this.J7.__indirect(this.z7 + r), this.J7) : null
  }
  breachprop(t) {
  ...
  subprop(t, r) {
    ...
    return i ? (r || new ConfigPropValue_1.ConfigPropValue).__init(this.J7.__indirect(this.J7.__vector(this.z7 + i) + 4 * t), this.J7) : null
  }
  subpropLength() {
  ...
  subprops(t, r) {
    ...
    return i ? (r || new IntArray_1.IntArray).__init(this.J7.__indirect(this.J7.__vector(this.z7 + i) + 4 * t), this.J7) : null
  }
  subpropsLength() {
