...
exports.FoleySynthConfig = undefined;
...
class FoleySynthConfig {
  ...
  get Model1Config() {
    return GameUtils_1.GameUtils.ConvertToArray(this.model1configLength(), this.model1config, this);
  }
  get Model2Config() {
    return GameUtils_1.GameUtils.ConvertToArray(this.model2configLength(), this.model2config, this);
  }
  ...
  static getRootAsFoleySynthConfig(t, i) {
    return (i || new FoleySynthConfig()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
