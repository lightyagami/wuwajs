...
class RegressBase {
  ...
  get ArgId() {
    return GameUtils_1.GameUtils.ConvertToArray(this.argidLength(), this.argid, this);
  }
  get GachaId() {
    return this.gachaid();
  }
  ...
  static getRootAsRegressBase(t, s) {
    return (s || new RegressBase()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
