...
class RogueResBond {
  ...
  battleeffect(t, e) {
    ...
    return i ? (e || new DicIntIntArray_1.DicIntIntArray).__init(this.J7.__indirect(this.J7.__vector(this.z7 + i) + 4 * t), this.J7) : null
  }
  battleeffectLength() {
  ...
  linkeffectdesc(t, e) {
    ...
    return i ? (e || new DicIntString_1.DicIntString).__init(this.J7.__indirect(this.J7.__vector(this.z7 + i) + 4 * t), this.J7) : null
  }
