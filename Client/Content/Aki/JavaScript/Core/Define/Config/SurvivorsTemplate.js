...
class SurvivorsTemplate {
  ...
  static getRootAsSurvivorsTemplate(t, s) {
    return (s || new SurvivorsTemplate()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  id() {
...
exports.SurvivorsTemplate = SurvivorsTemplate;
//# sourceMappingURL=SurvivorsTemplate.js.map