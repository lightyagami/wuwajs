...
exports.DailyAdventureActivity = undefined;
...
class DailyAdventureActivity {
  ...
  get TaskList() {
    return GameUtils_1.GameUtils.ConvertToArray(this.tasklistLength(), this.tasklist, this);
  }
  get RewardList() {
  ...
  static getRootAsDailyAdventureActivity(t, i) {
    return (i || new DailyAdventureActivity()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  activityid() {
