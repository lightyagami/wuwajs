...
! function(undefined) {
  ...
  ! function t(r, u, n) {
          ...
          r[s] = function t(n) {
            if (h)
              if (h = !1, n) e(n);
                ...
                for (var i = new Array(arguments.length - 1), r = 0; r < i.length;) i[r++] = arguments[r];
                u.apply(null, i)
              }
          };
          try {
    ...
    2: [function(t, n, i) {
      ...
      for (var c = new Array(64), f = new Array(123), r = 0; r < 64;) f[c[r] = r < 26 ? r + 65 : r < 52 ? r + 71 : r < 62 ? r - 4 : r - 59 | 43] = r++;
      i.encode = function t(n, i, r) {
        for (var u, e = null, s = [], h = 0, o = 0; i < r;) {
          ...
          8191 < h && ((e = e || []).push(String.fromCharCode.apply(String, s)), h = 0)
        }
        return o && (s[h++] = c[u], s[h++] = 61, 1 === o) && (s[h++] = 61), e ? (h && e.push(String.fromCharCode.apply(String, s.slice(0, h))), e.join("")) : String.fromCharCode.apply(String, s.slice(0, h))
      };
    ...
    3: [function(t, n, i) {
      function r() {
        ...
        if (n === undefined) this._listeners = {};
          ...
          for (var r = this._listeners[n], u = 0; u < r.length;) r[u].fn === i ? r.splice(u, 1) : ++u;
        return this
      }, r.prototype.emit = function t(n) {
        var i = this._listeners[n];
        if (i) {
          for (var r = [], u = 1; u < arguments.length;) r.push(arguments[u++]);
    ...
    4: [function(t, n, i) {
      function r(t) {
        function n(t, n, i, r) {
          var u = n < 0 ? 1 : 0;
          0 === (n = u ? -n : n) ? t(0 < 1 / n ? 0 : 2147483648, i, r) : isNaN(n) ? t(2143289344, i, r) : t(34028234663852886e22 < n ? (u << 31 | 2139095040) >>> 0 : n < 11754943508222875e-54 ? (u << 31 | Math.round(n / 1401298464324817e-60)) >>> 0 : (u << 31 | (t = Math.floor(Math.log(n) / Math.LN2)) + 127 << 23 | 8388607 & Math.round(n * Math.pow(2, -t) * 8388608)) >>> 0, i, r)
        }

        function i(t, n, i) {
          t = t(n, i), n = 2 * (t >> 31) + 1, i = t >>> 23 & 255, t &= 8388607;
          return 255 == i ? t ? NaN : 1 / 0 * n : 0 == i ? 1401298464324817e-60 * n * t : n * Math.pow(2, i - 150) * (8388608 + t)
        }
        ...
        function l(t, n, i, r, u, e) {
          var s, h, o = r < 0 ? 1 : 0;
          0 === (r = o ? -r : r) ? (t(0, u, e + n), t(0 < 1 / r ? 0 : 2147483648, u, e + i)) : isNaN(r) ? (t(0, u, e + n), t(2146959360, u, e + i)) : 17976931348623157e292 < r ? (t(0, u, e + n), t((o << 31 | 2146435072) >>> 0, u, e + i)) : r < 22250738585072014e-324 ? (t((s = r / 5e-324) >>> 0, u, e + n), t((o << 31 | s / 4294967296) >>> 0, u, e + i)) : (1024 === (h = Math.floor(Math.log(r) / Math.LN2)) && (h = 1023), t(4503599627370496 * (s = r * Math.pow(2, -h)) >>> 0, u, e + n), t((o << 31 | h + 1023 << 20 | 1048576 * s & 1048575) >>> 0, u, e + i))
        }

        function d(t, n, i, r, u) {
          n = t(r, u + n), t = t(r, u + i), r = 2 * (t >> 31) + 1, u = t >>> 20 & 2047, i = 4294967296 * (1048575 & t) + n;
          return 2047 == u ? i ? NaN : 1 / 0 * r : 0 == u ? 5e-324 * r * i : r * Math.pow(2, u - 1075) * (i + 4503599627370496)
        }

        function v(t, n, i) {
          f[0] = t, n[i] = c[0], n[i + 1] = c[1], n[i + 2] = c[2], n[i + 3] = c[3], n[i + 4] = c[4], n[i + 5] = c[5], n[i + 6] = c[6], n[i + 7] = c[7]
        }

        function w(t, n, i) {
          f[0] = t, n[i] = c[7], n[i + 1] = c[6], n[i + 2] = c[5], n[i + 3] = c[4], n[i + 4] = c[3], n[i + 5] = c[2], n[i + 6] = c[1], n[i + 7] = c[0]
        }

        function y(t, n) {
          return c[0] = t[n], c[1] = t[n + 1], c[2] = t[n + 2], c[3] = t[n + 3], c[4] = t[n + 4], c[5] = t[n + 5], c[6] = t[n + 6], c[7] = t[n + 7], f[0]
        }

        function b(t, n) {
          return c[7] = t[n], c[6] = t[n + 1], c[5] = t[n + 2], c[4] = t[n + 3], c[3] = t[n + 4], c[2] = t[n + 5], c[1] = t[n + 6], c[0] = t[n + 7], f[0]
        }
        return "undefined" != typeof Float32Array ? (h = new Float32Array([-0]), o = new Uint8Array(h.buffer), a = 128 === o[3], t.writeFloatLE = a ? r : u, t.writeFloatBE = a ? u : r, t.readFloatLE = a ? e : s, t.readFloatBE = a ? s : e) : (t.writeFloatLE = n.bind(null, g), t.writeFloatBE = n.bind(null, m), t.readFloatLE = i.bind(null, p), t.readFloatBE = i.bind(null, A)), "undefined" != typeof Float64Array ? (f = new Float64Array([-0]), c = new Uint8Array(f.buffer), a = 128 === c[7], t.writeDoubleLE = a ? v : w, t.writeDoubleBE = a ? w : v, t.readDoubleLE = a ? y : b, t.readDoubleBE = a ? b : y) : (t.writeDoubleLE = l.bind(null, g, 0, 4), t.writeDoubleBE = l.bind(null, m, 4, 0), t.readDoubleLE = d.bind(null, p, 0, 4), t.readDoubleBE = d.bind(null, A, 4, 0)), t
      }
    ...
    7: [function(t, n, i) {
      i.length = function t(n) {
        for (var i, r = 0, u = 0; u < n.length; ++u)(i = n.charCodeAt(u)) < 128 ? r += 1 : i < 2048 ? r += 2 : 55296 == (64512 & i) && 56320 == (64512 & n.charCodeAt(u + 1)) ? (++u, r += 4) : r += 3;
        return r
      }, i.read = function t(n, i, r) {
        if (r - i < 1) return "";
        for (var u, e = null, s = [], h = 0; i < r;)(u = n[i++]) < 128 ? s[h++] = u : 191 < u && u < 224 ? s[h++] = (31 & u) << 6 | 63 & n[i++] : 239 < u && u < 365 ? (u = ((7 & u) << 18 | (63 & n[i++]) << 12 | (63 & n[i++]) << 6 | 63 & n[i++]) - 65536, s[h++] = 55296 + (u >> 10), s[h++] = 56320 + (1023 & u)) : s[h++] = (15 & u) << 12 | (63 & n[i++]) << 6 | 63 & n[i++], 8191 < h && ((e = e || []).push(String.fromCharCode.apply(String, s)), h = 0);
        return e ? (h && e.push(String.fromCharCode.apply(String, s.slice(0, h))), e.join("")) : String.fromCharCode.apply(String, s.slice(0, h))
      }, i.write = function t(n, i, r) {
        for (var u, e, s = r, h = 0; h < n.length; ++h)(u = n.charCodeAt(h)) < 128 ? i[r++] = u : (u < 2048 ? i[r++] = u >> 6 | 192 : (55296 == (64512 & u) && 56320 == (64512 & (e = n.charCodeAt(h + 1))) ? (++h, i[r++] = (u = 65536 + ((1023 & u) << 10) + (1023 & e)) >> 18 | 240, i[r++] = u >> 12 & 63 | 128) : i[r++] = u >> 12 | 224, i[r++] = u >> 6 & 63 | 128), i[r++] = 63 & u | 128);
        return r - s
      }
    }, {}],
    8: [function(t, n, i) {
      ...
      r.build = "minimal", r.Writer = t(16), r.BufferWriter = t(17), r.Reader = t(9), r.BufferReader = t(10), r.util = t(15), r.rpc = t(12), r.roots = t(11), r.configure = u, u()
    }, {
      10: 10,
      11: 11,
      12: 12,
    ...
    9: [function(t, n, i) {
      ...
      var f = "undefined" != typeof Uint8Array ? function t(n) {
          if (n instanceof Uint8Array || Array.isArray(n)) return new o(n);
      ...
      o.create = c(), o.prototype._slice = u.Array.prototype.subarray || u.Array.prototype.slice, o.prototype.uint32 = function t() {
        var n = 4294967295;
        return function t() {
          if (n = (127 & this.buf[this.pos]) >>> 0, this.buf[this.pos++] < 128 || (n = (n | (127 & this.buf[this.pos]) << 7) >>> 0, this.buf[this.pos++] < 128) || (n = (n | (127 & this.buf[this.pos]) << 14) >>> 0, this.buf[this.pos++] < 128) || (n = (n | (127 & this.buf[this.pos]) << 21) >>> 0, this.buf[this.pos++] < 128) || (n = (n | (15 & this.buf[this.pos]) << 28) >>> 0, this.buf[this.pos++] < 128) || !((this.pos += 5) > this.len)) return n;
        ...
        return this.pos += n, Array.isArray(this.buf) ? this.buf.slice(i, r) : i === r ? new this.buf.constructor(0) : this._slice.call(this.buf, i, r)
    ...
    13: [function(t, n, i) {
      ...
      function r(t, n, i) {
        ...
        h.EventEmitter.call(this), this.rpcImpl = t, this.requestDelimited = Boolean(n), this.responseDelimited = Boolean(i)
        ...
        try {
          ...
          return s.emit("error", t, r), setTimeout(function() {
            e(t)
          }, 0), undefined
        }
    ...
    14: [function(t, n, i) {
      ...
      var e = u.zero = new u(0, 0),
        s = (e.toNumber = function() {
          return 0
        }, e.zzEncode = e.zzDecode = function() {
          return this
        }, e.length = function() {
          return 1
        }, u.zeroHash = "\0\0\0\0\0\0\0\0", u.fromNumber = function t(n) {
          var i, r;
          return 0 === n ? e : (r = (n = (i = n < 0) ? -n : n) >>> 0, n = (n - r) / 4294967296 >>> 0, i && (n = ~n >>> 0, r = ~r >>> 0, 4294967295 < ++r) && (r = 0, 4294967295 < ++n) && (n = 0), new u(r, n))
        }, u.from = function t(n) {
          ...
          var i;
          return !n && this.hi >>> 31 ? (n = 1 + ~this.lo >>> 0, i = ~this.hi >>> 0, -(n + 4294967296 * (i = n ? i : i + 1 >>> 0))) : this.lo + 4294967296 * this.hi
        }, u.prototype.toLong = function t(n) {
          return r.Long ? new r.Long(0 | this.lo, 0 | this.hi, Boolean(n)) : {
            low: 0 | this.lo,
            high: 0 | this.hi,
            unsigned: Boolean(n)
          }
      ...
      u.fromHash = function t(n) {
        return "\0\0\0\0\0\0\0\0" === n ? e : new u((s.call(n, 0) | s.call(n, 1) << 8 | s.call(n, 2) << 16 | s.call(n, 3) << 24) >>> 0, (s.call(n, 4) | s.call(n, 5) << 8 | s.call(n, 6) << 16 | s.call(n, 7) << 24) >>> 0)
        ...
        var n = this.lo,
          ...
          r = this.hi >>> 24;
        return 0 == r ? 0 == i ? n < 16384 ? n < 128 ? 1 : 2 : n < 2097152 ? 3 : 4 : i < 16384 ? i < 128 ? 5 : 6 : i < 2097152 ? 7 : 8 : r < 128 ? 9 : 10
      }
    }, {
      15: 15
    }],
    15: [function(t, n, i) {
      ...
      function r(t, n, i) {
        for (var r = Object.keys(n), u = 0; u < r.length; ++u) t[r[u]] !== undefined && i || (t[r[u]] = n[r[u]]);
        return t
      }
      ...
      u.asPromise = t(1), u.base64 = t(2), u.EventEmitter = t(3), u.float = t(4), u.inquire = t(5), u.utf8 = t(7), u.pool = t(6), u.LongBits = t(14), u.isNode = Boolean("undefined" != typeof global && global && global.process && global.process.versions && global.process.versions.node), u.global = u.isNode && global || "undefined" != typeof window && window || "undefined" != typeof self && self || this, u.emptyArray = Object.freeze ? Object.freeze([]) : [], u.emptyObject = Object.freeze ? Object.freeze({}) : {}, u.isInteger = Number.isInteger || function t(n) {
        ...
        var r = n[i];
        return !(null == r || !n.hasOwnProperty(i)) && ("object" != typeof r || 0 < (Array.isArray(r) ? r : Object.keys(r)).length)
      }, u.Buffer = function() {
        try {
      ...
      }(), u._Buffer_from = null, u._Buffer_allocUnsafe = null, u.newBuffer = function t(n) {
        return "number" == typeof n ? u.Buffer ? u._Buffer_allocUnsafe(n) : new u.Array(n) : u.Buffer ? u._Buffer_from(n) : "undefined" == typeof Uint8Array ? n : new Uint8Array(n)
      }, u.Array = "undefined" != typeof Uint8Array ? Uint8Array : Array, u.Long = Long, u.key2Re = /^true|false|0|1$/, u.key32Re = /^-?(?:0|[1-9][0-9]*)$/, u.key64Re = /^(?:[\\x00-\\xff]{8}|-?(?:0|[1-9][0-9]*))$/, u.longToHash = function t(n) {
        return n ? u.LongBits.from(n).toHash() : u.LongBits.zeroHash
      }, u.longFromHash = function t(n, i) {
        n = u.LongBits.fromHash(n);
        return u.Long ? u.Long.fromBits(n.lo, n.hi, i) : n.toNumber(Boolean(i))
      }, u.merge = r, u.lcFirst = function t(n) {
        return n.charAt(0).toLowerCase() + n.substring(1)
      }, u.newError = e, u.ProtocolError = e("ProtocolError"), u.oneOfGetter = function t(n) {
        ...
        return function(t) {
          for (var n = 0; n < i.length; ++n) i[n] !== t && (this[i[n]] = undefined)
        }
      }, u.toJSONOptions = {
        longs: String,
        enums: String,
        ...
        var r = u.Buffer;
        r ? (u._Buffer_from = r.from !== Uint8Array.from && r.from || function t(n, i) {
          return new r(n, i)
    ...
    16: [function(t, n, i) {
      ...
      function o(t, n, i) {
        this.fn = t, this.len = n, this.next = undefined, this.val = i
      }
      ...
      a.create = l(), a.alloc = function t(n) {
        return new u.Array(n)
      }, u.Array !== Array && (a.alloc = u.pool(a.alloc, u.Array.prototype.subarray)), a.prototype._push = function t(n, i, r) {
        return this.tail = this.tail.next = new o(n, i, r), this.len += i, this
      }, (v.prototype = Object.create(o.prototype)).fn = function t(n, i, r) {
        for (; 127 < n;) i[r++] = 127 & n | 128, n >>>= 7;
        i[r] = n
      }, a.prototype.uint32 = function t(n) {
        return this.len += (this.tail = this.tail.next = new v((n >>>= 0) < 128 ? 1 : n < 16384 ? 2 : n < 2097152 ? 3 : n < 268435456 ? 4 : 5, n)).len, this
      }, a.prototype.int32 = function t(n) {
        return n < 0 ? this._push(w, 10, e.fromNumber(n)) : this.uint32(n)
      ...
      a.prototype.bytes = function t(n) {
        var i, r = n.length >>> 0;
        return r ? (u.isString(n) && (i = a.alloc(r = s.length(n)), s.decode(n, i, 0), n = i), this.uint32(r)._push(b, r, n)) : this._push(d, 1, 0)
      }, a.prototype.string = function t(n) {
        var i = h.length(n);
        return i ? this.uint32(i)._push(h.write, i, n) : this._push(d, 1, 0)
        ...
        var n = this.head,
          i = this.tail,
          r = this.len;
        return this.reset().uint32(r), r && (this.tail.next = n.next, this.tail = i, this.len += r), this
      }, a.prototype.finish = function t() {
        for (var n = this.head.next, i = this.constructor.alloc(this.len), r = 0; n;) n.fn(n.val, i, r), r += n.len, n = n.next;
        return i
    ...
    17: [function(t, n, i) {
      ...
      e._configure = function() {
        e.alloc = u._Buffer_allocUnsafe, e.writeBytesBuffer = u.Buffer && u.Buffer.prototype instanceof Uint8Array && "set" === u.Buffer.prototype.set.name ? function t(n, i, r) {
          i.set(n, r)
        } : function t(n, i, r) {
          if (n.copy) n.copy(i, r, 0, n.length);
          else
            for (var u = 0; u < n.length;) i[r++] = n[u++]
        }
      }, e.prototype.bytes = function t(n) {
        var i = (n = u.isString(n) ? u._Buffer_from(n, "base64") : n).length >>> 0;
        return this.uint32(i), i && this._push(e.writeBytesBuffer, i, n), this
