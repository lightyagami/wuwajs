...
exports.getLangInterface = getLangInterface, langMap.set("CustomSequence", CustomSequenceLang_1.configCustomSequenceLang), langMap.set("FlowText", FlowTextLang_1.configFlowTextLang), langMap.set("HotPatchText", HotPatchTextLang_1.configHotPatchTextLang), langMap.set("MonsterDisplay", MonsterDisplayLang_1.configMonsterDisplayLang), langMap.set("MultiText", MultiTextLang_1.configMultiTextLang), langMap.set("OccupationConfig", OccupationConfigLang_1.configOccupationConfigLang), langMap.set("Speaker", SpeakerLang_1.configSpeakerLang), langMap.set("SubtitleText", SubtitleTextLang_1.configSubtitleTextLang), langMap.set("CommonParam", CommonParamLang_1.configCommonParamLang);
