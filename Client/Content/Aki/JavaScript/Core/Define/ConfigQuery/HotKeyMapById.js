...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configHotKeyMapById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configHotKeyMapById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const C = HotKeyMap_1.HotKeyMap.getRootAsHotKeyMap(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
