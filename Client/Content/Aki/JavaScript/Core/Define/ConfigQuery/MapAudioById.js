...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapAudioById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapAudioById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const a = MapAudio_1.MapAudio.getRootAsMapAudio(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
