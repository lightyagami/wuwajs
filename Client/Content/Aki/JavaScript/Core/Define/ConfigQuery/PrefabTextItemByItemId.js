...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabTextItemByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabTextItemByItemId.GetConfig"),
...
exports.configPrefabTextItemByItemId = {
  ...
  GetConfig: (e, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindBigInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", e])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", e]), n) {
          const f = PrefabTextItem_1.PrefabTextItem.getRootAsPrefabTextItem(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (n = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
