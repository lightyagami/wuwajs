...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomLevelById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomLevelById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), t) {
          const f = TowerDefencePhantomLevel_1.TowerDefencePhantomLevel.getRootAsTowerDefencePhantomLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (t = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
