...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMobileBattleUiSetAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMobileBattleUiSetAll.GetConfigList");
exports.configMobileBattleUiSetAll = {
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return t && (i = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(i, n, n.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), n
    }
