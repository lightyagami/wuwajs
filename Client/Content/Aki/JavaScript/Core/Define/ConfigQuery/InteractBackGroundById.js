...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInteractBackGroundById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInteractBackGroundById.GetConfig"),
