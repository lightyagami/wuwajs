...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configWeaponSceneInteractById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  WeaponSceneInteract_1 = require("../Config/WeaponSceneInteract"),
  DB = "db_weapon.db",
  FILE = "w.武器基础配置.xlsx",
  TABLE = "WeaponSceneInteract",
  COMMAND = "select BinData from `WeaponSceneInteract` where Id = ?",
  KEY_PREFIX = "WeaponSceneInteractById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponSceneInteractById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponSceneInteractById.GetConfig"),
  CONFIG_STAT_PREFIX = "configWeaponSceneInteractById.GetConfig(";
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          ...
          return o && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
