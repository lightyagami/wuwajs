...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDamageTextAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configDamageTextAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), t = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = DamageText_1.DamageText.getRootAsDamageText(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
