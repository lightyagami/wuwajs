...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressAll.GetConfigList");
