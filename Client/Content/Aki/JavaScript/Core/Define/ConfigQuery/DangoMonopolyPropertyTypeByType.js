...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `DangoMonopolyPropertyType` where PropertyType=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyPropertyTypeByType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyPropertyTypeByType.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      if (n) {
        ...
        if (r) return e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PropertyType", o])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PropertyType", o]), t) {
          ...
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
