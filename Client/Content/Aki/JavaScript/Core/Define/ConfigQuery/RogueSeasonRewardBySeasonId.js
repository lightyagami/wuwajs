...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueSeasonRewardBySeasonId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRogueSeasonRewardBySeasonId.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (i) {
      if (n) {
        ...
        if (g) return e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SeasonId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = RogueSeasonReward_1.RogueSeasonReward.getRootAsRogueSeasonReward(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          g.push(a)
        }
        return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
