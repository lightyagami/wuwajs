...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomFetterGroupAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomFetterGroupAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), t = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = PhantomFetterGroup_1.PhantomFetterGroup.getRootAsPhantomFetterGroup(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
