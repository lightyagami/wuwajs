...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `TimePointRewardActivity` where ActivityId = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTimePointRewardActivityByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTimePointRewardActivityByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configTimePointRewardActivityByActivityId.GetConfigList(";
