...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTakeWeedsDifficultyById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTakeWeedsDifficultyById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([t, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), t) {
          ...
          return o && (t = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
