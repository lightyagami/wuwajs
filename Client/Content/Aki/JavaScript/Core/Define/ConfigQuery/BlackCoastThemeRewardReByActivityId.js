...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeRewardReByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeRewardReByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configBlackCoastThemeRewardReByActivityId.GetConfigList(";
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
