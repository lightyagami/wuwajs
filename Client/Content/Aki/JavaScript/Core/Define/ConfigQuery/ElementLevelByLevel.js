...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configElementLevelByLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configElementLevelByLevel.GetConfig"),
...
exports.configElementLevelByLevel = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", e])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", e]), t) {
          const l = ElementLevel_1.ElementLevel.getRootAsElementLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (t = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, l)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
        }
      }
