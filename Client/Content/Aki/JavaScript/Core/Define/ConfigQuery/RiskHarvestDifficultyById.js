...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestDifficultyById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestDifficultyById.GetConfig"),
  ...
  GetConfig: (i, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        f = void 0;
        if ([n, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), n) {
          ...
          return t && (n = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
