...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMaterialReplaceByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMaterialReplaceByItemId.GetConfig"),
...
exports.configMaterialReplaceByItemId = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", e])) {
        i = void 0;
