...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbnormalDamageConfigByLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAbnormalDamageConfigByLevel.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", o])) {
        a = void 0;
        if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", o]), i) {
