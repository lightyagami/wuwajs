...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCommonRewardViewDisplayById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCommonRewardViewDisplayById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
          const a = CommonRewardViewDisplay_1.CommonRewardViewDisplay.getRootAsCommonRewardViewDisplay(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return i && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
