...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatVoteById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatVoteById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const a = PreheatVote_1.PreheatVote.getRootAsPreheatVote(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
