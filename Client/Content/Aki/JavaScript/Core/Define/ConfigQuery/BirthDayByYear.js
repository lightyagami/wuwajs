...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBirthDayByYear.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBirthDayByYear.GetConfig"),
...
exports.configBirthDayByYear = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["LimitYear", o])) {
        e = void 0;
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["LimitYear", o]), n) {
