...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RegressInvestigation` where InvestigationType=? And IfGlobal=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRegressInvestigationByInvestigationTypeAndIfGlobal.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRegressInvestigationByInvestigationTypeAndIfGlobal.GetConfig"),
  CONFIG_STAT_PREFIX = "configRegressInvestigationByInvestigationTypeAndIfGlobal.GetConfig(";
exports.configRegressInvestigationByInvestigationTypeAndIfGlobal = {
  ...
  GetConfig: (n, o, i = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindBool(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["InvestigationType", n], ["IfGlobal", o])) {
        g = void 0;
        if ([e, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InvestigationType", n], ["IfGlobal", o]), e) {
          ...
          return i && (e = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
