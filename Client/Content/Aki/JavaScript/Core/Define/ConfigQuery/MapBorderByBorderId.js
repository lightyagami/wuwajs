...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapBorderByBorderId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapBorderByBorderId.GetConfig"),
...
exports.configMapBorderByBorderId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    var e = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      r = (e?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (r) {
      if (n) {
        var i = KEY_PREFIX + `#${o})`;
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BorderId", o])) {
        i = void 0;
        if ([r, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BorderId", o]), r) {
          const t = MapBorder_1.MapBorder.getRootAsMapBorder(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (r = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
