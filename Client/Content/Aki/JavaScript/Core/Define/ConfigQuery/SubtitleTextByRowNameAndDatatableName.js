...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  TABLE = "SubtitleText",
  COMMAND = "select BinData from `SubtitleText` where RowName = ? AND DatatableName = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSubtitleTextByRowNameAndDatatableName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSubtitleTextByRowNameAndDatatableName.GetConfig"),
  ...
  GetConfig: (t, e, o = !0) => {
    ...
    if (a) {
      if (o) {
        ...
        if (m) return n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
      }
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && ConfigCommon_1.ConfigCommon.BindString(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["RowName", t], ["DatatableName", e])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RowName", t], ["DatatableName", e]), a) {
          const m = SubtitleText_1.SubtitleText.getRootAsSubtitleText(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (a = KEY_PREFIX + `#${t}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, m)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
        }
      }
