...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementCategoryAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementCategoryAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = AchievementCategory_1.AchievementCategory.getRootAsAchievementCategory(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        i.push(n)
      }
