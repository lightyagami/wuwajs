...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemBySeason.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemBySeason.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Season", o])) break;
          var f = void 0;
          if ([i, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Season", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
