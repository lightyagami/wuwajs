...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInteractDataByGuid.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInteractDataByGuid.GetConfig"),
...
exports.configInteractDataByGuid = {
  ...
  GetConfig: (t, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Guid", t])) {
        a = void 0;
        if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Guid", t]), i) {
          const e = InteractData_1.InteractData.getRootAsInteractData(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (i = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
