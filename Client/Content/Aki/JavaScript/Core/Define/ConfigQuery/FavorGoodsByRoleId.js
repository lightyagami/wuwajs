...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFavorGoodsByRoleId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFavorGoodsByRoleId.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = FavorGoods_1.FavorGoods.getRootAsFavorGoods(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          a.push(r)
        }
