...
exports.configRougePopularEntrieAll = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRougePopularEntrieAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRougePopularEntrieAll.GetConfigList");
  ...
  GetConfigList: (o = true) => {
    ...
    if (n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        i = RougePopularEntrie_1.RougePopularEntrie.getRootAsRougePopularEntrie(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i);
      }
      if (o) {
        t = KEY_PREFIX + ")";
