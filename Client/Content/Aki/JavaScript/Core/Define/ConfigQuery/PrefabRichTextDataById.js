...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabRichTextDataById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabRichTextDataById.GetConfig"),
...
exports.configPrefabRichTextDataById = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", t])) {
        n = void 0;
        if ([i, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", t]), i) {
