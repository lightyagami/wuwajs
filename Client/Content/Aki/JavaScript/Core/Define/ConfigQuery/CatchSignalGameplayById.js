...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCatchSignalGameplayById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCatchSignalGameplayById.GetConfig"),
...
exports.configCatchSignalGameplayById = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        t = void 0;
