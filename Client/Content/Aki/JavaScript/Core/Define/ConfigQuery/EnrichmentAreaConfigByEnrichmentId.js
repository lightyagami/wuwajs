...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEnrichmentAreaConfigByEnrichmentId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configEnrichmentAreaConfigByEnrichmentId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configEnrichmentAreaConfigByEnrichmentId.GetConfigList(";
  ...
  GetConfigList: (n, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["EnrichmentId", n])) break;
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["EnrichmentId", n]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return i && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
