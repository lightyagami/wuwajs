...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreScoreByArea.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExploreScoreByArea.GetConfig"),
...
exports.configExploreScoreByArea = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (r) {
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Area", o])) {
        t = void 0;
        if ([r, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Area", o]), r) {
          const i = ExploreScore_1.ExploreScore.getRootAsExploreScore(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return e && (r = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
