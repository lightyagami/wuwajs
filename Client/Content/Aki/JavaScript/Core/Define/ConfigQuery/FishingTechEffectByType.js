...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechEffectByType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechEffectByType.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair)) {
        ...
        for (;;) {
          ...
          var f = void 0;
          if ([t, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Type", i]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          f = FishingTechEffect_1.FishingTechEffect.getRootAsFishingTechEffect(new byte_buffer_1.ByteBuffer(new Uint8Array(f.buffer)));
          g.push(f)
        }
        return o && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
