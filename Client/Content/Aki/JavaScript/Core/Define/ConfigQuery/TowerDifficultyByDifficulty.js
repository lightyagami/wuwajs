...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDifficultyByDifficulty.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDifficultyByDifficulty.GetConfig"),
...
exports.configTowerDifficultyByDifficulty = {
  ...
  GetConfig: (i, o = !0) => {
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Difficulty", i])) {
        n = void 0;
        if ([f, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Difficulty", i]), f) {
          const e = TowerDifficulty_1.TowerDifficulty.getRootAsTowerDifficulty(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
          return o && (f = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
