...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResDungeonConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResDungeonConfigById.GetConfig"),
...
exports.configRogueResDungeonConfigById = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (g) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        i = void 0;
        if ([g, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), g) {
          ...
          return n && (g = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(g, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
