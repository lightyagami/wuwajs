...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `EntityVoxelInfo` where MapId=? and EntityId=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntityVoxelInfoByMapIdAndEntityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntityVoxelInfoByMapIdAndEntityId.GetConfig"),
...
exports.configEntityVoxelInfoByMapIdAndEntityId = {
  ...
  GetConfig: (n, o, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapId", n], ["EntityId", o])) {
        f = void 0;
        if ([e, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", n], ["EntityId", o]), e) {
          const C = EntityVoxelInfo_1.EntityVoxelInfo.getRootAsEntityVoxelInfo(new byte_buffer_1.ByteBuffer(new Uint8Array(f.buffer)));
          return t && (e = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
