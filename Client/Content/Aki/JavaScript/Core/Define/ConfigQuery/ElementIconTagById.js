...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configElementIconTagById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configElementIconTagById.GetConfig"),
...
exports.configElementIconTagById = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), e) {
          ...
          return o && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
