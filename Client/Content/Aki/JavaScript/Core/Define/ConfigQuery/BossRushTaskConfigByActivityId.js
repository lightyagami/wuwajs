...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskConfigByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskConfigByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configBossRushTaskConfigByActivityId.GetConfigList(";
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([n, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return i && (s = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(s, f, f.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
