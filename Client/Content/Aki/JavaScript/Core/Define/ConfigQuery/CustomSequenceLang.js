...
exports.configCustomSequenceLang = undefined;
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCustomSequenceLang.Init");
const getLocalTextStat = Stats_1.Stat.CreateNoFlameGraph("configCustomSequenceLang.GetLocalText");
      ...
      if (m) {
        ...
        if (m.Success) {
          ...
          if (StringUtils_1.StringUtils.IsEmpty(a) && o !== CommonDefine_1.CHS) {
            C = exports.configCustomSequenceLang.GetLocalText(e, CommonDefine_1.CHS);
