...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressRewardAll.GetConfigList");
exports.configExploreProgressRewardAll = {
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return o && (r = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(r, t, t.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
    }
