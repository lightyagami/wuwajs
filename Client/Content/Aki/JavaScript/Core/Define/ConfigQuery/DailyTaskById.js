...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDailyTaskById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDailyTaskById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const e = DailyTask_1.DailyTask.getRootAsDailyTask(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
