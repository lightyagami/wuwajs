...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResBuffPoolById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResBuffPoolById.GetConfig"),
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        t = void 0;
        if ([f, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), f) {
          ...
          return e && (f = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
