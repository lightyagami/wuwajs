...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RoleTrainingDegree` where DifficultyLevel = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleTrainingDegreeByDifficultyLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRoleTrainingDegreeByDifficultyLevel.GetConfig"),
...
exports.configRoleTrainingDegreeByDifficultyLevel = {
  ...
  GetConfig: (e, i = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["DifficultyLevel", e])) {
        t = void 0;
        if ([o, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["DifficultyLevel", e]), o) {
          ...
          return i && (o = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
