...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBanInfoByTypeAndReason.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBanInfoByTypeAndReason.GetConfig"),
...
exports.configBanInfoByTypeAndReason = {
  ...
  GetConfig: (n, o, e = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BanType", n], ["BanReason", o])) {
        t = void 0;
        if ([a, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BanType", n], ["BanReason", o]), a) {
          const f = BanInfo_1.BanInfo.getRootAsBanInfo(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return e && (a = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
