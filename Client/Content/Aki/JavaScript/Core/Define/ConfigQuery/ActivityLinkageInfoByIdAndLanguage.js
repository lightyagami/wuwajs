...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `ActivityLinkageInfo` where ActivityLinkageId=? And Language=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageInfoByIdAndLanguage.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageInfoByIdAndLanguage.GetConfig"),
...
exports.configActivityLinkageInfoByIdAndLanguage = {
  ...
  GetConfig: (n, i, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityLinkageId", n], ["Language", i])) {
        g = void 0;
        if ([e, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityLinkageId", n], ["Language", i]), e) {
          ...
          return o && (e = KEY_PREFIX + `#${n}#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
