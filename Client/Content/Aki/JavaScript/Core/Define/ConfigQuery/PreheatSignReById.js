...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatSignReById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatSignReById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), t) {
          const g = PreheatSignRe_1.PreheatSignRe.getRootAsPreheatSignRe(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (t = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
