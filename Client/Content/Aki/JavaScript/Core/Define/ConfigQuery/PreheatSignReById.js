...
exports.configPreheatSignReById = undefined;
...
const COMMAND = "select BinData from `PreheatSignRe` where Id=?";
const KEY_PREFIX = "PreheatSignReById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatSignReById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatSignReById.GetConfig");
const CONFIG_STAT_PREFIX = "configPreheatSignReById.GetConfig(";
