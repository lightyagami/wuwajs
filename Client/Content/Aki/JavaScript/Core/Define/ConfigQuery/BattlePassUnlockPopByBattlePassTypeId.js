...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBattlePassUnlockPopByBattlePassTypeId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBattlePassUnlockPopByBattlePassTypeId.GetConfig"),
...
exports.configBattlePassUnlockPopByBattlePassTypeId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TpyeID", o])) {
        a = void 0;
        if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TpyeID", o]), e) {
