...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMainTypeAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMainTypeAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = MainType_1.MainType.getRootAsMainType(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        e.push(t)
      }
