...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableTaskByTaskId.GetConfig"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", n])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", n]), a) {
          const e = TurntableTask_1.TurntableTask.getRootAsTurntableTask(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (a = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
