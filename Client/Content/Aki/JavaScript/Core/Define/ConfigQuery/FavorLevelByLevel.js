...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFavorLevelByLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFavorLevelByLevel.GetConfig"),
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", o])) {
        t = void 0;
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", o]), i) {
