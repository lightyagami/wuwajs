...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleMasterTitleAll = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleMasterTitle`",
  KEY_PREFIX = "PhantomBattleMasterTitleAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleMasterTitleAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleMasterTitleAll.GetConfigList");
exports.configPhantomBattleMasterTitleAll = {
  Init: () => {
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = PhantomBattleMasterTitle_1.PhantomBattleMasterTitle.getRootAsPhantomBattleMasterTitle(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
...
//# sourceMappingURL=PhantomBattleMasterTitleAll.js.map