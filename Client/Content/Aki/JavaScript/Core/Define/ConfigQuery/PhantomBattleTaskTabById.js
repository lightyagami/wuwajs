...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleTaskTabById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  PhantomBattleTaskTab_1 = require("../Config/PhantomBattleTaskTab"),
  DB = "db_phantombattle.db",
  FILE = "s.声骸大作战外围.xlsx",
  TABLE = "PhantomBattleTaskTab",
  COMMAND = "select BinData from `PhantomBattleTaskTab` where Id=?",
  KEY_PREFIX = "PhantomBattleTaskTabById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleTaskTabById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleTaskTabById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleTaskTabById.GetConfig(";
