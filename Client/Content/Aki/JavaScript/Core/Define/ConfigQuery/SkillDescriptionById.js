...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillDescriptionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSkillDescriptionById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), t) {
          const C = SkillDescription_1.SkillDescription.getRootAsSkillDescription(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return o && (t = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
