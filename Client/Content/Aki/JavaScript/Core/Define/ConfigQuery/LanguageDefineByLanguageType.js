...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLanguageDefineByLanguageType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLanguageDefineByLanguageType.GetConfig"),
...
exports.configLanguageDefineByLanguageType = {
  ...
  GetConfig: (n, e = !0) => {
    ...
    if (g) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["LanguageType", n])) {
        a = void 0;
        if ([g, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["LanguageType", n]), g) {
