...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFogBlockByBlockAndMapId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFogBlockByBlockAndMapId.GetConfig"),
...
exports.configFogBlockByBlockAndMapId = {
  ...
  GetConfig: (o, n, i = !0) => {
    ...
    var t = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o}#${n})`),
      g = (t?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (g) {
      if (i) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Block", o], ["MapId", n])) {
        e = void 0;
        if ([g, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Block", o], ["MapId", n]), g) {
          const C = FogBlock_1.FogBlock.getRootAsFogBlock(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return i && (g = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(g, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
