...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskTabByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskTabByActivityId.GetConfigList"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = BossRushTaskTab_1.BossRushTaskTab.getRootAsBossRushTaskTab(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          e.push(a)
        }
        return i && (s = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(s, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
