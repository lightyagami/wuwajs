...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMaterialReplaceByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMaterialReplaceByGroupId.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = MaterialReplace_1.MaterialReplace.getRootAsMaterialReplace(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          r.push(a)
        }
        return e && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
