...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configRoleMorphAll = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.角色.xlsx",
  TABLE = "RoleMorph",
  COMMAND = "select BinData from `RoleMorph`",
  KEY_PREFIX = "RoleMorphAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleMorphAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleMorphAll.GetConfigList");
