...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTemplateConfigByBlueprintType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTemplateConfigByBlueprintType.GetConfig"),
...
exports.configTemplateConfigByBlueprintType = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BlueprintType", e])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BlueprintType", e]), t) {
          const C = TemplateConfig_1.TemplateConfig.getRootAsTemplateConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (t = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
