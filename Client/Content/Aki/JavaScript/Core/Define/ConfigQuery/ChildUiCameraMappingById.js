...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configChildUiCameraMappingById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configChildUiCameraMappingById.GetConfig"),
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        C = void 0;
        if ([a, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), a) {
