...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponSkinByType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponSkinByType.GetConfigList"),
  ...
  GetConfigList: (n, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["WeaponSkinType", n])) break;
          var a = void 0;
          if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["WeaponSkinType", n]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = WeaponSkin_1.WeaponSkin.getRootAsWeaponSkin(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          C.push(a)
        }
        return o && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
