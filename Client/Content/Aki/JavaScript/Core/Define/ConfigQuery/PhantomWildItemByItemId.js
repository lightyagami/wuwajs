...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomWildItemByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomWildItemByItemId.GetConfig"),
...
exports.configPhantomWildItemByItemId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", o])) {
        e = void 0;
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", o]), i) {
          const m = PhantomWildItem_1.PhantomWildItem.getRootAsPhantomWildItem(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return t && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, m)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
        }
      }
