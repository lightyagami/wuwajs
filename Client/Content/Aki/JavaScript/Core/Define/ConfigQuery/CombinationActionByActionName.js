...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCombinationActionByActionName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCombinationActionByActionName.GetConfig"),
...
exports.configCombinationActionByActionName = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActionName", o])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActionName", o]), t) {
          const C = CombinationAction_1.CombinationAction.getRootAsCombinationAction(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
