...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemByItemIdAndSeason.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemByItemIdAndSeason.GetConfig"),
...
exports.configSlashBuffToItemByItemIdAndSeason = {
  ...
  GetConfig: (o, n, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", o], ["Season", n])) {
        f = void 0;
        if ([i, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", o], ["Season", n]), i) {
