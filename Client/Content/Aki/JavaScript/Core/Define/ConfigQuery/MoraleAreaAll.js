...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configMoraleAreaAll = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "c.插旗玩法.xlsx",
  TABLE = "MoraleArea",
  COMMAND = "select BinData from `MoraleArea`",
  KEY_PREFIX = "MoraleAreaAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleAreaAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleAreaAll.GetConfigList");
exports.configMoraleAreaAll = {
  Init: () => {
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = MoraleArea_1.MoraleArea.getRootAsMoraleArea(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
...
//# sourceMappingURL=MoraleAreaAll.js.map