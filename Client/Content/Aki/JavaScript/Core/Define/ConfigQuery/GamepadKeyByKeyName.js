...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGamepadKeyByKeyName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGamepadKeyByKeyName.GetConfig"),
...
exports.configGamepadKeyByKeyName = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["KeyName", e])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["KeyName", e]), a) {
