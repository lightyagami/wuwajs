...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSortRuleByIdAndDataId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSortRuleByIdAndDataId.GetConfig"),
...
exports.configSortRuleByIdAndDataId = {
  ...
  GetConfig: (o, t, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o], ["DataId", t])) {
        a = void 0;
        if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o], ["DataId", t]), e) {
          const C = SortRule_1.SortRule.getRootAsSortRule(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (e = KEY_PREFIX + `#${o}#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
