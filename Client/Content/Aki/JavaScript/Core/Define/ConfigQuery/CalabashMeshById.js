...
exports.configCalabashMeshById = undefined;
...
const COMMAND = "select BinData from `CalabashMesh` where Id=?";
const KEY_PREFIX = "CalabashMeshById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashMeshById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashMeshById.GetConfig");
const CONFIG_STAT_PREFIX = "configCalabashMeshById.GetConfig(";
exports.configCalabashMeshById = {
  Init: () => {
    initStat?.Start();
...
//# sourceMappingURL=CalabashMeshById.js.map