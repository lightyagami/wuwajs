...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGenericPromptByTipsId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGenericPromptByTipsId.GetConfig"),
...
exports.configGenericPromptByTipsId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TipsId", o])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TipsId", o]), e) {
