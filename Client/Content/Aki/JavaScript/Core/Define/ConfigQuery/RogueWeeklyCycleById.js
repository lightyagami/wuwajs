...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyCycleById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyCycleById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), i) {
          ...
          return o && (i = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
