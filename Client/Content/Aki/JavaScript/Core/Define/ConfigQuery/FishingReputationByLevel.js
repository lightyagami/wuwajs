...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingReputationByLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingReputationByLevel.GetConfig"),
...
exports.configFishingReputationByLevel = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", i])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", i]), t) {
