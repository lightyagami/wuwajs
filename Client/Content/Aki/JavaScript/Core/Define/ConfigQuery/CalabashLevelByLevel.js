...
exports.configCalabashLevelByLevel = undefined;
...
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashLevelByLevel.GetConfig");
...
exports.configCalabashLevelByLevel = {
  ...
  GetConfig: (e, o = true) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["Level", e]) > 0) {
        i = undefined;
        [a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", e]);
        if (a) {
