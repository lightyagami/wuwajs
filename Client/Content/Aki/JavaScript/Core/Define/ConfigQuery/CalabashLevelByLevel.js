...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashLevelByLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashLevelByLevel.GetConfig"),
...
exports.configCalabashLevelByLevel = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", e])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", e]), a) {
          const t = CalabashLevel_1.CalabashLevel.getRootAsCalabashLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (a = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
