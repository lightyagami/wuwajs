...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.技能树.xlsx",
  TABLE = "SkillTree",
  COMMAND = "select BinData from `SkillTree` where NodeGroup = ? AND NodeIndex = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillTreeByNodeGroupAndNodeIndex.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSkillTreeByNodeGroupAndNodeIndex.GetConfig"),
  ...
  GetConfig: (o, e, n = !0) => {
    ...
    if (t) {
      if (n) {
        ...
        if (d) return i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["NodeGroup", o], ["NodeIndex", e])) {
        r = void 0;
        if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["NodeGroup", o], ["NodeIndex", e]), t) {
          const d = SkillTree_1.SkillTree.getRootAsSkillTree(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          return n && (t = KEY_PREFIX + `#${o}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, d)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
        }
      }
