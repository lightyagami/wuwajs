...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRouteByRouterAndFloor.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRouteByRouterAndFloor.GetConfigList"),
  ...
  GetConfigList: (o, t, n = !0) => {
    ...
    if (e) {
      if (n) {
        ...
        if (s) return i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
      }
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, t, ...logPair)) {
        const s = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["RouteId", o], ["Floor", t])) break;
          var C = void 0;
          if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RouteId", o], ["Floor", t]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = AbyssRoute_1.AbyssRoute.getRootAsAbyssRoute(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          s.push(C)
        }
        return n && (r = KEY_PREFIX + `#${o}#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, s, s.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
      }
