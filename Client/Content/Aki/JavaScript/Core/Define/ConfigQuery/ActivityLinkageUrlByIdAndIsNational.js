...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `ActivityLinkageUrl` where ActivityLinkageId=? And IsNational=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageUrlByIdAndIsNational.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageUrlByIdAndIsNational.GetConfig"),
...
exports.configActivityLinkageUrlByIdAndIsNational = {
  ...
  GetConfig: (i, n, t = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && ConfigCommon_1.ConfigCommon.BindBool(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityLinkageId", i], ["IsNational", n])) {
        e = void 0;
        if ([a, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityLinkageId", i], ["IsNational", n]), a) {
          ...
          return t && (a = KEY_PREFIX + `#${i}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
