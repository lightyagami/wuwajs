...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFuncMenuWheelAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFuncMenuWheelAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = FuncMenuWheel_1.FuncMenuWheel.getRootAsFuncMenuWheel(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
