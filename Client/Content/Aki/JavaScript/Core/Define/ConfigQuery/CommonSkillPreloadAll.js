...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCommonSkillPreloadAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCommonSkillPreloadAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = CommonSkillPreload_1.CommonSkillPreload.getRootAsCommonSkillPreload(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        e.push(t)
      }
