...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFlySkinConfigByType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFlySkinConfigByType.GetConfigList"),
  ...
  GetConfigList: (n, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const f = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["SkinType", n])) break;
          var C = void 0;
          if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SkinType", n]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
