...
exports.configQuestReviewEntryAll = undefined;
...
const COMMAND = "select BinData from `QuestReviewEntry`";
const KEY_PREFIX = "QuestReviewEntryAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewEntryAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewEntryAll.GetConfigList");
