...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBirthDayByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBirthDayByItemId.GetConfig"),
...
exports.configBirthDayByItemId = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BirthDayCardItemId", t])) {
        e = void 0;
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BirthDayCardItemId", t]), n) {
