...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAxisMappingByAxisName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAxisMappingByAxisName.GetConfig"),
...
exports.configAxisMappingByAxisName = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["AxisName", i])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["AxisName", i]), t) {
