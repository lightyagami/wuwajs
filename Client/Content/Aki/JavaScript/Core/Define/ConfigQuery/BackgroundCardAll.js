...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBackgroundCardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBackgroundCardAll.GetConfigList");
exports.configBackgroundCardAll = {
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return o && (t = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(t, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
    }
