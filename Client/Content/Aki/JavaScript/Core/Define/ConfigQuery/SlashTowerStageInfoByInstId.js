...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSlashTowerStageInfoByInstId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSlashTowerStageInfoByInstId.GetConfig"),
...
exports.configSlashTowerStageInfoByInstId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["InstId", o])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InstId", o]), e) {
