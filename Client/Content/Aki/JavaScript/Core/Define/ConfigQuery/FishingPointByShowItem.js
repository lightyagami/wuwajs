...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingPointByShowItem.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFishingPointByShowItem.GetConfigList"),
  ...
  GetConfigList: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["ShowItem", o])) break;
          var g = void 0;
          if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ShowItem", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          g = FishingPoint_1.FishingPoint.getRootAsFishingPoint(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          C.push(g)
        }
        return i && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
