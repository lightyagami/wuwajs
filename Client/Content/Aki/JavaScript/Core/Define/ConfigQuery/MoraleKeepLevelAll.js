...
exports.configMoraleKeepLevelAll = undefined;
...
const COMMAND = "select BinData from `MoraleKeepLevel`";
const KEY_PREFIX = "MoraleKeepLevelAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleKeepLevelAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleKeepLevelAll.GetConfigList");
