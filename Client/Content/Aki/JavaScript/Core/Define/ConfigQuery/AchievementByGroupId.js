...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementByGroupId.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = Achievement_1.Achievement.getRootAsAchievement(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          m.push(C)
        }
        return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, m, m.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
      }
