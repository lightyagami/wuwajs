...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleAnimAudioByRoleId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleAnimAudioByRoleId.GetConfigList"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = RoleAnimAudio_1.RoleAnimAudio.getRootAsRoleAnimAudio(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          f.push(C)
        }
        return i && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, f, f.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
