...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleInfluenceById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRoleInfluenceById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), i) {
          const f = RoleInfluence_1.RoleInfluence.getRootAsRoleInfluence(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return o && (i = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
