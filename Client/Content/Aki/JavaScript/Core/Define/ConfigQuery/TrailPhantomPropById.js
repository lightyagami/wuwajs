...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrailPhantomPropById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTrailPhantomPropById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const r = TrailPhantomProp_1.TrailPhantomProp.getRootAsTrailPhantomProp(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
