...
exports.configSpringFestivalSubTaskById = undefined;
...
const COMMAND = "select BinData from `SpringFestivalSubTask` where Id=?";
const KEY_PREFIX = "SpringFestivalSubTaskById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSpringFestivalSubTaskById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSpringFestivalSubTaskById.GetConfig");
const CONFIG_STAT_PREFIX = "configSpringFestivalSubTaskById.GetConfig(";
exports.configSpringFestivalSubTaskById = {
  Init: () => {
    initStat?.Start();
...
//# sourceMappingURL=SpringFestivalSubTaskById.js.map