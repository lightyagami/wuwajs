...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisFormulaByFormulaType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisFormulaByFormulaType.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configSynthesisFormulaByFormulaType.GetConfigList(";
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const r = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["FormulaType", o])) break;
          var a = void 0;
          if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FormulaType", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = SynthesisFormula_1.SynthesisFormula.getRootAsSynthesisFormula(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          r.push(a)
        }
