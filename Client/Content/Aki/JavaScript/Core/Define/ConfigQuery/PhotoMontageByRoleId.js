...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMontageByRoleId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMontageByRoleId.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var g = void 0;
          if ([i, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
