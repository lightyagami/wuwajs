...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configHandBookQuestTabAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configHandBookQuestTabAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = HandBookQuestTab_1.HandBookQuestTab.getRootAsHandBookQuestTab(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
