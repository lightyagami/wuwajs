...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configUiCameraMappingById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configUiCameraMappingById.GetConfig"),
...
exports.configUiCameraMappingById = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        e = void 0;
        if ([a, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), a) {
          const t = UiCameraMapping_1.UiCameraMapping.getRootAsUiCameraMapping(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return n && (a = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
