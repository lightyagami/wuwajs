...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillBySkillGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSkillBySkillGroupId.GetConfigList"),
  ...
  GetConfigList: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["SkillGroupId", o])) break;
          var e = void 0;
          if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SkillGroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = Skill_1.Skill.getRootAsSkill(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          C.push(e)
        }
        return i && (l = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(l, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
