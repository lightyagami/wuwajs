...
exports.configOccupyScoreById = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const OccupyScore_1 = require("../Config/OccupyScore");
const DB = "db_moraleplay.db";
const FILE = "c.插旗玩法.xlsx";
const TABLE = "OccupyScore";
const COMMAND = "select BinData from `OccupyScore` where Id=?";
const KEY_PREFIX = "OccupyScoreById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configOccupyScoreById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configOccupyScoreById.GetConfig");
const CONFIG_STAT_PREFIX = "configOccupyScoreById.GetConfig(";
