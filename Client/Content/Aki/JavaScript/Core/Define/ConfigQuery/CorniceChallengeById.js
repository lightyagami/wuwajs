...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCorniceChallengeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCorniceChallengeById.GetConfig"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        C = void 0;
        if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), i) {
