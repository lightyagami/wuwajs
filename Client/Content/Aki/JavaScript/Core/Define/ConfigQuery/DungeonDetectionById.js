...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDungeonDetectionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDungeonDetectionById.GetConfig"),
