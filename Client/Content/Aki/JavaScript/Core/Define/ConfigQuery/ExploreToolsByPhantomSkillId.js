...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreToolsByPhantomSkillId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExploreToolsByPhantomSkillId.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      if (n) {
        ...
        if (l) return i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PhantomSkillId", o])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PhantomSkillId", o]), t) {
          const l = ExploreTools_1.ExploreTools.getRootAsExploreTools(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, l)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
        }
      }
