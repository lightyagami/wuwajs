...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInteractBackGroundByViewName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInteractBackGroundByViewName.GetConfig"),
...
exports.configInteractBackGroundByViewName = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ViewName", o])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ViewName", o]), e) {
