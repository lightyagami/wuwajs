...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configMoraleLevelDiffShowAll = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  MoraleLevelDiffShow_1 = require("../Config/MoraleLevelDiffShow"),
  DB = "db_moraleplay.db",
  FILE = "c.插旗玩法.xlsx",
  TABLE = "MoraleLevelDiffShow",
  COMMAND = "select BinData from `MoraleLevelDiffShow`",
  KEY_PREFIX = "MoraleLevelDiffShowAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLevelDiffShowAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLevelDiffShowAll.GetConfigList");
