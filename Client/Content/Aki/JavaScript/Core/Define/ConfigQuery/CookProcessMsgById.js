...
exports.configCookProcessMsgById = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCookProcessMsgById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCookProcessMsgById.GetConfig");
  ...
  GetConfig: (o, n = true) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["Id", o]) > 0) {
        ...
        if (i) {
          const C = CookProcessMsg_1.CookProcessMsg.getRootAsCookProcessMsg(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          if (n) {
            i = `${KEY_PREFIX}#${o})`;
