...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestMainTypeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestMainTypeById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const C = QuestMainType_1.QuestMainType.getRootAsQuestMainType(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
