...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configMoraleFlagTypeByType = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `MoraleFlagType` where TypeId=?",
  KEY_PREFIX = "MoraleFlagTypeByType",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleFlagTypeByType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleFlagTypeByType.GetConfig"),
  CONFIG_STAT_PREFIX = "configMoraleFlagTypeByType.GetConfig(";
