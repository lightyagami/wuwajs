...
exports.configAbyssCastDescById = undefined;
...
const COMMAND = "select BinData from `AbyssCastDesc` where Id=?";
const KEY_PREFIX = "AbyssCastDescById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssCastDescById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssCastDescById.GetConfig");
const CONFIG_STAT_PREFIX = "configAbyssCastDescById.GetConfig(";
