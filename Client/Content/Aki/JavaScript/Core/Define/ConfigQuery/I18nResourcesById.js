...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configI18nResourcesById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "i.i18n资源.xlsx",
  TABLE = "I18nResources",
  COMMAND = "select BinData from `I18nResources` where Id=?",
  KEY_PREFIX = "I18nResourcesById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configI18nResourcesById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configI18nResourcesById.GetConfig"),
  CONFIG_STAT_PREFIX = "configI18nResourcesById.GetConfig(";
exports.configI18nResourcesById = {
  Init: () => {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        t = void 0;
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const C = I18nResources_1.I18nResources.getRootAsI18nResources(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
...
//# sourceMappingURL=I18nResourcesById.js.map