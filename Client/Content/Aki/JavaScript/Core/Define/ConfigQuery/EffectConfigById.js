...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEffectConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEffectConfigById.GetConfig"),
...
exports.configEffectConfigById = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    var f = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      t = (f?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (t) {
      if (n) {
        var i = KEY_PREFIX + `#${o})`;
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          ...
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), f?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
