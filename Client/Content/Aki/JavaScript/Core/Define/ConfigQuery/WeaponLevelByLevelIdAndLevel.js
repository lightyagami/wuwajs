...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponLevelByLevelIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponLevelByLevelIdAndLevel.GetConfig"),
...
exports.configWeaponLevelByLevelIdAndLevel = {
  ...
  GetConfig: (e, o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["LevelId", e], ["Level", o])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["LevelId", e], ["Level", o]), t) {
          const C = WeaponLevel_1.WeaponLevel.getRootAsWeaponLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (t = KEY_PREFIX + `#${e}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
