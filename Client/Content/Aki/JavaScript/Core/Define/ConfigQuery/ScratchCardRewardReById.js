...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configScratchCardRewardReById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configScratchCardRewardReById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        a = void 0;
        if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
