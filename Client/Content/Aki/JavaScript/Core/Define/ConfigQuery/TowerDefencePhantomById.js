...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const f = TowerDefencePhantom_1.TowerDefencePhantom.getRootAsTowerDefencePhantom(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
