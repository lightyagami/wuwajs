...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomGrowthByGrowthIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomGrowthByGrowthIdAndLevel.GetConfig"),
...
exports.configPhantomGrowthByGrowthIdAndLevel = {
  ...
  GetConfig: (o, n, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GrowthId", o], ["Level", n])) {
        r = void 0;
        if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GrowthId", o], ["Level", n]), i) {
          const a = PhantomGrowth_1.PhantomGrowth.getRootAsPhantomGrowth(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          return t && (i = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
