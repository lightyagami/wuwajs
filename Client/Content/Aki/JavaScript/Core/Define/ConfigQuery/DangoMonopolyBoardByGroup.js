...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyBoardByGroup.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyBoardByGroup.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const e = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["BoardGroupId", o])) break;
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BoardGroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
