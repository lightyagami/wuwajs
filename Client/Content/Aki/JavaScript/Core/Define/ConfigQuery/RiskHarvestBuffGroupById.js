...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestBuffGroupById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestBuffGroupById.GetConfig"),
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        f = void 0;
        if ([n, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
