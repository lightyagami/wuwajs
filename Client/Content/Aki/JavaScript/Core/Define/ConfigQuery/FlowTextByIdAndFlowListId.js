...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFlowTextByIdAndFlowListId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFlowTextByIdAndFlowListId.GetConfig"),
...
exports.configFlowTextByIdAndFlowListId = {
  ...
  GetConfig: (o, t, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindString(handleId, 2, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o], ["FlowListId", t])) {
        C = void 0;
        if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o], ["FlowListId", t]), e) {
          const f = FlowText_1.FlowText.getRootAsFlowText(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          return n && (e = KEY_PREFIX + `#${o}#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
