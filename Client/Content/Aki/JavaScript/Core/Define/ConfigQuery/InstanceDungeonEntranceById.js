...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInstanceDungeonEntranceById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInstanceDungeonEntranceById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const a = InstanceDungeonEntrance_1.InstanceDungeonEntrance.getRootAsInstanceDungeonEntrance(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
