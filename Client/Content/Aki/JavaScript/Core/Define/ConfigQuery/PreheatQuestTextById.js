...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatQuestTextById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatQuestTextById.GetConfig"),
  ...
  GetConfig: (e, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), n) {
          const a = PreheatQuestText_1.PreheatQuestText.getRootAsPreheatQuestText(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (n = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
