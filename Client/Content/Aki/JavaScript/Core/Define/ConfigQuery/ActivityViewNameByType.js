...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActivityViewNameByType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configActivityViewNameByType.GetConfigList"),
  ...
  GetConfigList: (i, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Type", i])) break;
          var a = void 0;
          if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Type", i]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = ActivityViewName_1.ActivityViewName.getRootAsActivityViewName(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          C.push(a)
        }
        return t && (n = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
