...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomSkillById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomSkillById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const a = PhantomSkill_1.PhantomSkill.getRootAsPhantomSkill(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
