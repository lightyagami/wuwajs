...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleChallengeByGymId = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleChallenge` where GymId=?",
  KEY_PREFIX = "PhantomBattleChallengeByGymId",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleChallengeByGymId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleChallengeByGymId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configPhantomBattleChallengeByGymId.GetConfigList(";
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["GymId", t])) break;
          var a = void 0;
          if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GymId", t]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return o && (i = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
