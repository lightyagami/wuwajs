...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configScratchCardActivityReById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configScratchCardActivityReById.GetConfig"),
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", t])) {
        e = void 0;
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", t]), n) {
          const a = ScratchCardActivityRe_1.ScratchCardActivityRe.getRootAsScratchCardActivityRe(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return o && (n = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
