...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanActivityConfigByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanActivityConfigByActivityId.GetConfig"),
...
exports.configLongShanActivityConfigByActivityId = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", i])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), t) {
