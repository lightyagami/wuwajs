...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashDevelopRewardByMonsterId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashDevelopRewardByMonsterId.GetConfig"),
...
exports.configCalabashDevelopRewardByMonsterId = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MonsterId", o])) {
        t = void 0;
        if ([a, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MonsterId", o]), a) {
          ...
          return e && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
