...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  TABLE = "Interjection",
  COMMAND = "select BinData from `Interjection` where TimberId = ? AND UniversalToneId = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInterjectionByTimberIdAndUniversalToneId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInterjectionByTimberIdAndUniversalToneId.GetConfig"),
  CONFIG_STAT_PREFIX = "configInterjectionByTimberIdAndUniversalToneId.GetConfig(";
exports.configInterjectionByTimberIdAndUniversalToneId = {
  ...
  GetConfig: (n, o, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TimberId", n], ["UniversalToneId", o])) {
        r = void 0;
        if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TimberId", n], ["UniversalToneId", o]), t) {
          const C = Interjection_1.Interjection.getRootAsInterjection(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          return e && (t = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
