...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMemoryTopicById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMemoryTopicById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const m = PhotoMemoryTopic_1.PhotoMemoryTopic.getRootAsPhotoMemoryTopic(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
