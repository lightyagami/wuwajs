...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLevelPlayInfoMappingConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLevelPlayInfoMappingConfigById.GetConfig"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        f = void 0;
        if ([e, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), e) {
