...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushBuffById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushBuffById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        f = void 0;
        if ([t, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const e = BossRushBuff_1.BossRushBuff.getRootAsBossRushBuff(new byte_buffer_1.ByteBuffer(new Uint8Array(f.buffer)));
