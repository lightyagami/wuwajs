...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configUiDynamicTabById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configUiDynamicTabById.GetConfig"),
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), t) {
          const e = UiDynamicTab_1.UiDynamicTab.getRootAsUiDynamicTab(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (t = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
