...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashDevelopRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCalabashDevelopRewardAll.GetConfigList");
exports.configCalabashDevelopRewardAll = {
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return o && (a = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(a, t, t.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
    }
