...
exports.configRiskHarvestInstById = undefined;
...
const COMMAND = "select BinData from `RiskHarvestInst` where Id = ?";
const KEY_PREFIX = "RiskHarvestInstById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstById.GetConfig");
const CONFIG_STAT_PREFIX = "configRiskHarvestInstById.GetConfig(";
