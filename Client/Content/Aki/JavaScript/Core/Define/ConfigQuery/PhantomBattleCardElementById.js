...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleCardElementById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  PhantomBattleCardElement_1 = require("../Config/PhantomBattleCardElement"),
  DB = "db_phantombattle.db",
  FILE = "s.声骸大作战外围.xlsx",
  TABLE = "PhantomBattleCardElement",
  COMMAND = "select BinData from `PhantomBattleCardElement` where Id=?",
  KEY_PREFIX = "PhantomBattleCardElementById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardElementById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardElementById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleCardElementById.GetConfig(";
