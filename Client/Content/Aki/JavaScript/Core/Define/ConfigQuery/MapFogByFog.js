...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapFogByFog.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapFogByFog.GetConfig"),
...
exports.configMapFogByFog = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Fog", o])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Fog", o]), t) {
