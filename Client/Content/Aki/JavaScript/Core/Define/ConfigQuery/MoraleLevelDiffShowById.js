...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configMoraleLevelDiffShowById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `MoraleLevelDiffShow` where Id=?",
  KEY_PREFIX = "MoraleLevelDiffShowById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLevelDiffShowById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLevelDiffShowById.GetConfig"),
  CONFIG_STAT_PREFIX = "configMoraleLevelDiffShowById.GetConfig(";
