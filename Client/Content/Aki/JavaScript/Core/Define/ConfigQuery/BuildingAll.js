...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBuildingAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBuildingAll.GetConfigList");
  ...
  GetConfigList: (i = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = Building_1.Building.getRootAsBuilding(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        e.push(t)
      }
