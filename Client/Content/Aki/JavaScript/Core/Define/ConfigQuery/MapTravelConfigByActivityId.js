...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapTravelConfigByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapTravelConfigByActivityId.GetConfig"),
...
exports.configMapTravelConfigByActivityId = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", o])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), t) {
          const a = MapTravelConfig_1.MapTravelConfig.getRootAsMapTravelConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
