...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssSettleById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssSettleById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
          const C = AbyssSettle_1.AbyssSettle.getRootAsAbyssSettle(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
