...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGlobalConfigFromCsvByName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGlobalConfigFromCsvByName.GetConfig"),
...
exports.configGlobalConfigFromCsvByName = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    var i = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      C = (i?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (C) {
      if (n) {
        var t = KEY_PREFIX + `#${o})`;
      ...
      if (C = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Name", o])) {
        t = void 0;
        if ([C, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Name", o]), C) {
          ...
          return n && (C = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(C, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
