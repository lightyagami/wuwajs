...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceRewardAll.GetConfigList");
  ...
  GetConfigList: (e = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = TowerDefenceReward_1.TowerDefenceReward.getRootAsTowerDefenceReward(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
