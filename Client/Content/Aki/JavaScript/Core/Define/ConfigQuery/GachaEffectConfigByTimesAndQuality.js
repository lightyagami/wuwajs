...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `GachaEffectConfig` where Times=? AND Quality=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGachaEffectConfigByTimesAndQuality.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGachaEffectConfigByTimesAndQuality.GetConfig"),
...
exports.configGachaEffectConfigByTimesAndQuality = {
  ...
  GetConfig: (o, n, i = !0) => {
    ...
    var t = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o}#${n})`),
      f = (t?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (f) {
      if (i) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Times", o], ["Quality", n])) {
        e = void 0;
        if ([f, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Times", o], ["Quality", n]), f) {
          ...
          return i && (f = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
