...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGachaAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configGachaAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = Gacha_1.Gacha.getRootAsGacha(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        a.push(i)
      }
