...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCharacterAudioConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCharacterAudioConfigById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const e = CharacterAudioConfig_1.CharacterAudioConfig.getRootAsCharacterAudioConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
