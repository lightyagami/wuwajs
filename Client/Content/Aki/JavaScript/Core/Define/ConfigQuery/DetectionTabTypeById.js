...
exports.configDetectionTabTypeById = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const DetectionTabType_1 = require("../Config/DetectionTabType");
const DB = "db_adventure_detect.db";
const FILE = "k.开拓探测.xlsx";
const TABLE = "DetectionTabType";
const COMMAND = "select BinData from `DetectionTabType` where Id=?";
const KEY_PREFIX = "DetectionTabTypeById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDetectionTabTypeById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDetectionTabTypeById.GetConfig");
const CONFIG_STAT_PREFIX = "configDetectionTabTypeById.GetConfig(";
