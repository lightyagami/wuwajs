...
exports.configEntitySkillPreloadByAll = undefined;
...
const COMMAND = "select BinData from `EntitySkillPreload`";
const KEY_PREFIX = "EntitySkillPreloadByAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByAll.GetConfigList");
