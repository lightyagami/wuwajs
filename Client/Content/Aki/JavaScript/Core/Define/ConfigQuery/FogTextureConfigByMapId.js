...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFogTextureConfigByMapId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFogTextureConfigByMapId.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var g = void 0;
          if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
