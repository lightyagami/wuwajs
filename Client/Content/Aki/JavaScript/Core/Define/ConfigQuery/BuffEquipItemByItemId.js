...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBuffEquipItemByItemId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBuffEquipItemByItemId.GetConfigList"),
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        const m = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["ItemId", t])) break;
          var f = void 0;
          if ([n, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", t]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
