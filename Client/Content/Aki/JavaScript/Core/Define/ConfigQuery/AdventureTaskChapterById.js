...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAdventureTaskChapterById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAdventureTaskChapterById.GetConfig"),
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([o, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), o) {
          ...
          return n && (o = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
