...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configShopFixedByShopIdAndId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configShopFixedByShopIdAndId.GetConfig"),
...
exports.configShopFixedByShopIdAndId = {
  ...
  GetConfig: (o, n, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ShopId", o], ["Id", n])) {
        d = void 0;
        if ([t, d] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ShopId", o], ["Id", n]), t) {
