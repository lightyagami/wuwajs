...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSpringSignById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSpringSignById.GetConfig"),
  ...
  GetConfig: (n, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const e = SpringSign_1.SpringSign.getRootAsSpringSign(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          return i && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
