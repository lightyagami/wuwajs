...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueEffectById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueEffectById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const i = RogueEffect_1.RogueEffect.getRootAsRogueEffect(new byte_buffer_1.ByteBuffer(new Uint8Array(f.buffer)));
          return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
