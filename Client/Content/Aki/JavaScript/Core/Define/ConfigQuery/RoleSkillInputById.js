...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleSkillInputById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRoleSkillInputById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["RoleId", o])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), t) {
