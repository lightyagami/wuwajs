...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configChildUiCameraMappingByViewName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configChildUiCameraMappingByViewName.GetConfig"),
...
exports.configChildUiCameraMappingByViewName = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ViewName", i])) {
        a = void 0;
        if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ViewName", i]), e) {
          ...
          return n && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
