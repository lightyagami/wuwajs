...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `FoleySynthConfig` where id = ? AND (SELECT count() from `FoleySynthConfig` WHERE id = ?) <= 0 OR id = ? AND (SELECT count(0) from `FoleySynthConfig` WHERE id = ?) >0;",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFoleySynthConfigByIdWithDefaultId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFoleySynthConfigByIdWithDefaultId.GetConfig"),
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 3, i, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 4, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o], ["Id", n], ["Id", i], ["Id", t])) {
        ...
        if ([f, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o], ["Id", n], ["Id", i], ["Id", t]), f) {
          ...
          return e && (f = KEY_PREFIX + `#${o}#${n}#${i}#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, d)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), C?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
        }
      }
