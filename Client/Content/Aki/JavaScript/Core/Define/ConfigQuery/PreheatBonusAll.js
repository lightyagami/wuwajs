...
exports.configPreheatBonusAll = undefined;
...
const COMMAND = "select BinData from `PreheatBonus`";
const KEY_PREFIX = "PreheatBonusAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatBonusAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatBonusAll.GetConfigList");
