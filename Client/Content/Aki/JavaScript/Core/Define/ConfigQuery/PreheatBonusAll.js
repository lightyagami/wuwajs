...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatBonusAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPreheatBonusAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = PreheatBonus_1.PreheatBonus.getRootAsPreheatBonus(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
