...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestNodeDataByKey.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestNodeDataByKey.GetConfig"),
...
exports.configQuestNodeDataByKey = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Key", o])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Key", o]), n) {
          const a = QuestNodeData_1.QuestNodeData.getRootAsQuestNodeData(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
