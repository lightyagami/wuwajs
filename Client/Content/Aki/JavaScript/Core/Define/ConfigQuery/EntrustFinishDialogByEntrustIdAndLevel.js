...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `EntrustFinishDialog` where EntrustId=? AND Level=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntrustFinishDialogByEntrustIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntrustFinishDialogByEntrustIdAndLevel.GetConfig"),
  CONFIG_STAT_PREFIX = "configEntrustFinishDialogByEntrustIdAndLevel.GetConfig(";
  ...
  GetConfig: (n, o, t = !0) => {
    ...
    if (e) {
      if (t) {
        ...
        if (r) return i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["EntrustId", n], ["Level", o])) {
        g = void 0;
        if ([e, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["EntrustId", n], ["Level", o]), e) {
          ...
          return t && (e = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
