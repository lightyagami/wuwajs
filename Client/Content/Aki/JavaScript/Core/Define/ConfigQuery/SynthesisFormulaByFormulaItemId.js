...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisFormulaByFormulaItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisFormulaByFormulaItemId.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      if (n) {
        ...
        if (m) return t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
      }
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["FormulaItemId", o])) {
        e = void 0;
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FormulaItemId", o]), i) {
          ...
          return n && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, m)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
        }
      }
