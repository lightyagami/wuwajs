...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyBoardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyBoardById.GetConfig"),
...
exports.configDangoMonopolyBoardById = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BoardId", o])) {
        a = void 0;
        if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BoardId", o]), i) {
