...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleCardFilterById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleCardFilter` where Id=?",
  KEY_PREFIX = "PhantomBattleCardFilterById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardFilterById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardFilterById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleCardFilterById.GetConfig(";
