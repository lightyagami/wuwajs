...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPayShopTabByShopIdAndTabId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPayShopTabByShopIdAndTabId.GetConfig"),
...
exports.configPayShopTabByShopIdAndTabId = {
  ...
  GetConfig: (o, n, a = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ShopId", o], ["TabId", n])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ShopId", o], ["TabId", n]), t) {
