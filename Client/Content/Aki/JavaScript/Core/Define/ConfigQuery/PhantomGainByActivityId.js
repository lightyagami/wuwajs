...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomGainByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomGainByActivityId.GetConfigList"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair)) {
        ...
        for (;;) {
          ...
          var e = void 0;
          if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = PhantomGain_1.PhantomGain.getRootAsPhantomGain(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          C.push(e)
        }
        return t && (a = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
