...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRegressBonusRewardByIdAndGrade.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRegressBonusRewardByIdAndGrade.GetConfig"),
...
exports.configRegressBonusRewardByIdAndGrade = {
  ...
  GetConfig: (o, n, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o], ["Grade", n])) {
        r = void 0;
        if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o], ["Grade", n]), t) {
          ...
          return e && (t = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
