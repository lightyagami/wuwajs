...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreSkillInteractById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExploreSkillInteractById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
          const r = ExploreSkillInteract_1.ExploreSkillInteract.getRootAsExploreSkillInteract(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
