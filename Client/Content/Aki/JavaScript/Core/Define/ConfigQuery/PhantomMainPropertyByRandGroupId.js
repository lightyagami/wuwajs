...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomMainPropertyByRandGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomMainPropertyByRandGroupId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configPhantomMainPropertyByRandGroupId.GetConfigList(";
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (i) {
      if (n) {
        ...
        if (e) return t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const e = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["RandGroupId", o])) break;
          var r = void 0;
          if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RandGroupId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
