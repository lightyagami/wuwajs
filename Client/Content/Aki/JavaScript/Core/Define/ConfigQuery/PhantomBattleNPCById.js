...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleNPCById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleNPC` where Id=?",
  KEY_PREFIX = "PhantomBattleNPCById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleNPCById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleNPCById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleNPCById.GetConfig(";
