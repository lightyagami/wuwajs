...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPreOpenDetectionAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPreOpenDetectionAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        var o = void 0;
        if ([e, o] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        o = PreOpenDetection_1.PreOpenDetection.getRootAsPreOpenDetection(new byte_buffer_1.ByteBuffer(new Uint8Array(o.buffer)));
        i.push(o)
      }
