...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabTextItemByPrefabPathHash.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPrefabTextItemByPrefabPathHash.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configPrefabTextItemByPrefabPathHash.GetConfigList(";
  ...
  GetConfigList: (t, e = !0) => {
    ...
    if (i) {
      if (e) {
        ...
        if (f) return o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
      if (i = ConfigCommon_1.ConfigCommon.BindBigInt(handleId, 1, t, ...logPair)) {
        const f = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["PrefabPathHash", t])) break;
          var a = void 0;
          if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PrefabPathHash", t]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = PrefabTextItem_1.PrefabTextItem.getRootAsPrefabTextItem(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          f.push(a)
        }
        return e && (n = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, f, f.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
