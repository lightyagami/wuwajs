...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configUiResourceById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configUiResourceById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const C = UiResource_1.UiResource.getRootAsUiResource(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
