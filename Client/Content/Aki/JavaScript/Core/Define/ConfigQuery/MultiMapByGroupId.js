...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMultiMapByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMultiMapByGroupId.GetConfigList"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
