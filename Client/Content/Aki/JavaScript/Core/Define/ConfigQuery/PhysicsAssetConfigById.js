...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhysicsAssetConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhysicsAssetConfigById.GetConfig"),
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (t) {
      if (i) {
        ...
        if (s) return n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
      }
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          ...
          return i && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, s)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
        }
      }
