...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWhiteCatById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWhiteCatById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const C = RogueWhiteCat_1.RogueWhiteCat.getRootAsRogueWhiteCat(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return t && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
