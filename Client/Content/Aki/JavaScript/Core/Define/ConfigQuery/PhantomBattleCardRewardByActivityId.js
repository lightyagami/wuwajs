...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleCardRewardByActivityId = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleCardReward` where ActivityId=?",
  KEY_PREFIX = "PhantomBattleCardRewardByActivityId",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardRewardByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardRewardByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configPhantomBattleCardRewardByActivityId.GetConfigList(";
