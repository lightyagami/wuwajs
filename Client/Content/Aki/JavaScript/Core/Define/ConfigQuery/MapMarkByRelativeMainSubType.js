...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "d.地图标记.xlsx",
  TABLE = "MapMark",
  COMMAND = "select BinData from `MapMark` where RelativeType=? and RelativeSubType=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByRelativeMainSubType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByRelativeMainSubType.GetConfig"),
...
exports.configMapMarkByRelativeMainSubType = {
  ...
  GetConfig: (o, e, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["RelativeType", o], ["RelativeSubType", e])) {
        t = void 0;
        if ([a, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RelativeType", o], ["RelativeSubType", e]), a) {
          const C = MapMark_1.MapMark.getRootAsMapMark(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return n && (a = KEY_PREFIX + `#${o}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
