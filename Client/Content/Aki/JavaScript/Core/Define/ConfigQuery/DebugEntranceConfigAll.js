...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDebugEntranceConfigAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configDebugEntranceConfigAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = DebugEntranceConfig_1.DebugEntranceConfig.getRootAsDebugEntranceConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
