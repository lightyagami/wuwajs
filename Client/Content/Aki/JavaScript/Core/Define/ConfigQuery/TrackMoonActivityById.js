...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonActivityById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonActivityById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const a = TrackMoonActivity_1.TrackMoonActivity.getRootAsTrackMoonActivity(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
