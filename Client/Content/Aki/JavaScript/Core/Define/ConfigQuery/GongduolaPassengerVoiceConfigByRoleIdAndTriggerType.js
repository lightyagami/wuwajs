...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `GongduolaPassengerVoiceConfig` where RoleId=? And TriggerType=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGongduolaPassengerVoiceConfigByRoleIdAndTriggerType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configGongduolaPassengerVoiceConfigByRoleIdAndTriggerType.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configGongduolaPassengerVoiceConfigByRoleIdAndTriggerType.GetConfigList(";
exports.configGongduolaPassengerVoiceConfigByRoleIdAndTriggerType = {
  ...
  GetConfigList: (o, n, e = !0) => {
    ...
    var i = Stats_1.Stat.CreateNoFlameGraph(CONFIG_LIST_STAT_PREFIX + `#${o}#${n})`),
      g = (i?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (g) {
      if (e) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["RoleId", o], ["TriggerType", n])) break;
          var r = void 0;
          if ([g, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o], ["TriggerType", n]), !g) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return e && (t = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
