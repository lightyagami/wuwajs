...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configVideoDataByCgNameAndGirlOrBoy.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configVideoDataByCgNameAndGirlOrBoy.GetConfig"),
...
exports.configVideoDataByCgNameAndGirlOrBoy = {
  ...
  GetConfig: (o, i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["CgName", o], ["GirlOrBoy", i])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CgName", o], ["GirlOrBoy", i]), t) {
          const C = VideoData_1.VideoData.getRootAsVideoData(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (t = KEY_PREFIX + `#${o}#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
