...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonHandbookRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonHandbookRewardById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          ...
          return n && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), a?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
