...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCircumEntryByEntryType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCircumEntryByEntryType.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        ...
        for (;;) {
          ...
          var e = void 0;
          if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["EntryType", n]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = CircumEntry_1.CircumEntry.getRootAsCircumEntry(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          C.push(e)
        }
        return t && (r = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
