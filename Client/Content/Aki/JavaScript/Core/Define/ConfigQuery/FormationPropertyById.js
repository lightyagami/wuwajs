...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFormationPropertyById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFormationPropertyById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        r = void 0;
        if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
