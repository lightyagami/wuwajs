...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTravelPhantomQuestByMapMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTravelPhantomQuestByMapMarkId.GetConfig"),
...
exports.configTravelPhantomQuestByMapMarkId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapMarkId", o])) {
        e = void 0;
        if ([a, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapMarkId", o]), a) {
