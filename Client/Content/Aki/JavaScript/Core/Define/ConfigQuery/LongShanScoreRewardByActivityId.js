...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configLongShanScoreRewardByActivityId = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  LongShanScoreReward_1 = require("../Config/LongShanScoreReward"),
  DB = "db_activity.db",
  FILE = "l.龙山主题活动.xlsx",
  TABLE = "LongShanScoreReward",
  COMMAND = "select BinData from `LongShanScoreReward` where ActivityId=?",
  KEY_PREFIX = "LongShanScoreRewardByActivityId",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanScoreRewardByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanScoreRewardByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configLongShanScoreRewardByActivityId.GetConfigList(";
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
