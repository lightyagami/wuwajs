...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByInstanceDungeonId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByInstanceDungeonId.GetConfigList"),
  ...
  GetConfigList: (n, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["InstanceDungeonId", n])) break;
          var e = void 0;
          if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InstanceDungeonId", n]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = MapMark_1.MapMark.getRootAsMapMark(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          g.push(e)
        }
        return o && (a = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
