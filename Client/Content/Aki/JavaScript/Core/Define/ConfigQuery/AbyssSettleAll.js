...
exports.configAbyssSettleAll = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const AbyssSettle_1 = require("../Config/AbyssSettle");
const DB = "db_dangoabyss.db";
const FILE = "s.深渊爬塔副本.xlsx";
const TABLE = "AbyssSettle";
const COMMAND = "select BinData from `AbyssSettle`";
const KEY_PREFIX = "AbyssSettleAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssSettleAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssSettleAll.GetConfigList");
  ...
  GetConfigList: (t = true) => {
    ...
    if (o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        e = AbyssSettle_1.AbyssSettle.getRootAsAbyssSettle(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e);
      }
      if (t) {
        n = KEY_PREFIX + ")";
