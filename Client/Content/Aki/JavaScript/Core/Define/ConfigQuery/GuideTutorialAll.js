...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGuideTutorialAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configGuideTutorialAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), i = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = GuideTutorial_1.GuideTutorial.getRootAsGuideTutorial(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        e.push(n)
      }
