...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomSkillByPhantomSkillId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomSkillByPhantomSkillId.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const e = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["PhantomSkillId", o])) break;
          var l = void 0;
          if ([t, l] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PhantomSkillId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          l = PhantomSkill_1.PhantomSkill.getRootAsPhantomSkill(new byte_buffer_1.ByteBuffer(new Uint8Array(l.buffer)));
          e.push(l)
        }
        return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
