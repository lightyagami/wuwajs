...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSettleRewardByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSettleRewardByActivityId.GetConfig"),
...
exports.configSettleRewardByActivityId = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", t])) {
        n = void 0;
        if ([i, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", t]), i) {
          const a = SettleReward_1.SettleReward.getRootAsSettleReward(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
          return o && (i = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
