...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTemporaryTeleportMarkByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTemporaryTeleportMarkByMarkId.GetConfig"),
...
exports.configTemporaryTeleportMarkByMarkId = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", o])) {
        t = void 0;
        if ([n, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", o]), n) {
          ...
          return e && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), r?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
