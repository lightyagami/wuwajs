...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerHeadReById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerHeadReById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), i) {
          const a = PlayerHeadRe_1.PlayerHeadRe.getRootAsPlayerHeadRe(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
