...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLongPressConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLongPressConfigById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        g = void 0;
        if ([e, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
