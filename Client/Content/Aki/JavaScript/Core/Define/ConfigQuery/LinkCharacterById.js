...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLinkCharacterById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLinkCharacterById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const C = LinkCharacter_1.LinkCharacter.getRootAsLinkCharacter(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
