...
exports.configShareRewardById = undefined;
...
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configShareRewardById.GetConfig");
  ...
  GetConfig: (o, n = true) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["Id", o]) > 0) {
        ...
        if (i) {
          const a = ShareReward_1.ShareReward.getRootAsShareReward(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          if (n) {
            i = `${KEY_PREFIX}#${o})`;
