...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySelfEventConfigByKey.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySelfEventConfigByKey.GetConfig"),
...
exports.configEntitySelfEventConfigByKey = {
  ...
  GetConfig: (n, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Key", n])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Key", n]), e) {
          ...
          return t && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
