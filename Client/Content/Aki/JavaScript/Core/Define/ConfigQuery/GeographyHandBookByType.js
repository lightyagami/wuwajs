...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGeographyHandBookByType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configGeographyHandBookByType.GetConfigList"),
