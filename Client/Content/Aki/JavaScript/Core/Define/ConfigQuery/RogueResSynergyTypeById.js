...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResSynergyTypeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResSynergyTypeById.GetConfig"),
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), t) {
