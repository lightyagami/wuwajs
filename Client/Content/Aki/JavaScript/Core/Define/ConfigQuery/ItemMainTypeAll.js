...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configItemMainTypeAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configItemMainTypeAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = ItemMainType_1.ItemMainType.getRootAsItemMainType(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
