...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSilentAreaDetectionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSilentAreaDetectionById.GetConfig"),
  ...
  GetConfig: (e, t = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        i = void 0;
        if ([o, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), o) {
          const a = SilentAreaDetection_1.SilentAreaDetection.getRootAsSilentAreaDetection(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (o = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
