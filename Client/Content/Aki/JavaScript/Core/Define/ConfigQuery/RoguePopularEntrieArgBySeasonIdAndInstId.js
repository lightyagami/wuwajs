...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RoguePopularEntrieArg` where SeasonId=? AND InstId=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoguePopularEntrieArgBySeasonIdAndInstId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRoguePopularEntrieArgBySeasonIdAndInstId.GetConfig"),
  CONFIG_STAT_PREFIX = "configRoguePopularEntrieArgBySeasonIdAndInstId.GetConfig(";
exports.configRoguePopularEntrieArgBySeasonIdAndInstId = {
  ...
  GetConfig: (o, n, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["SeasonId", o], ["InstId", n])) {
        r = void 0;
        if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SeasonId", o], ["InstId", n]), i) {
          ...
          return e && (i = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
