...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configForgeFormulaById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configForgeFormulaById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const r = ForgeFormula_1.ForgeFormula.getRootAsForgeFormula(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
