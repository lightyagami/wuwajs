...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntityAudioConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntityAudioConfigById.GetConfig"),
...
exports.configEntityAudioConfigById = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        C = void 0;
        if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const e = EntityAudioConfig_1.EntityAudioConfig.getRootAsEntityAudioConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          return i && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
