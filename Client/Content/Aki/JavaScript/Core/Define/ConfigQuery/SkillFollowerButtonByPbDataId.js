...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillFollowerButtonByPbDataId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSkillFollowerButtonByPbDataId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configSkillFollowerButtonByPbDataId.GetConfigList(";
  ...
  GetConfigList: (o, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["PbDataId", o])) break;
          var l = void 0;
          if ([i, l] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PbDataId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
