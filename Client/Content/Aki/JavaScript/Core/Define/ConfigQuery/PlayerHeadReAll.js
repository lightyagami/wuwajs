...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerHeadReAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerHeadReAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = PlayerHeadRe_1.PlayerHeadRe.getRootAsPlayerHeadRe(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
