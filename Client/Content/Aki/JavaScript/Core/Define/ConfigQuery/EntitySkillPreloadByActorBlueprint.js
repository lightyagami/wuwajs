...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByActorBlueprint.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByActorBlueprint.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configEntitySkillPreloadByActorBlueprint.GetConfigList(";
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, t, ...logPair)) {
        const l = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["ActorBlueprint", t])) break;
          var r = void 0;
          if ([n, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActorBlueprint", t]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return o && (e = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, l, l.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
