...
exports.configRogueWeeklyRewardById = undefined;
...
const COMMAND = "select BinData from `RogueWeeklyReward` where Id=?";
const KEY_PREFIX = "RogueWeeklyRewardById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyRewardById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyRewardById.GetConfig");
const CONFIG_STAT_PREFIX = "configRogueWeeklyRewardById.GetConfig(";
