...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configStateByStateId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configStateByStateId.GetConfig"),
...
exports.configStateByStateId = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["StateId", t])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["StateId", t]), e) {
