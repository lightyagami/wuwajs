...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBattlePassById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBattlePassById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", t])) {
        ...
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", t]), e) {
          const a = BattlePass_1.BattlePass.getRootAsBattlePass(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
