...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleQuestByRoleIdAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleQuestByRoleIdAll.GetConfigList"),
  ...
  GetConfigList: (o, e = !0) => {
    ...
    if (n) {
      if (e) {
        ...
        if (l) return t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([n, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = RoleQuest_1.RoleQuest.getRootAsRoleQuest(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          l.push(C)
        }
        return e && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, l, l.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
