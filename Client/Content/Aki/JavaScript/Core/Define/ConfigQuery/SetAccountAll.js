...
exports.configSetAccountAll = undefined;
...
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSetAccountAll.GetConfigList");
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        while (true) {
          ...
          var C = undefined;
          [i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PackageType", o]);
          if (!i) {
