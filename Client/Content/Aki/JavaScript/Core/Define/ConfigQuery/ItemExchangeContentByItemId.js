...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeContentByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeContentByItemId.GetConfig"),
...
exports.configItemExchangeContentByItemId = {
  ...
  GetConfig: (n, t = !0) => {
    ...
    var e = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${n})`),
      o = (e?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (o) {
      if (t) {
        var i = KEY_PREFIX + `#${n})`;
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", n])) {
        i = void 0;
        if ([o, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", n]), o) {
          ...
          return t && (o = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
