...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSwimBuffById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSwimBuffById.GetConfig"),
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([f, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), f) {
          ...
          return i && (f = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
