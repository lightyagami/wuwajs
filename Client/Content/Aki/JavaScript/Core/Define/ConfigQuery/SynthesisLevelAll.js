...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisLevelAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSynthesisLevelAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = SynthesisLevel_1.SynthesisLevel.getRootAsSynthesisLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
