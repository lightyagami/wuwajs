...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLivenessTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLivenessTaskByTaskId.GetConfig"),
...
exports.configLivenessTaskByTaskId = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", n])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", n]), e) {
