...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFunctionOpenViewLimitAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFunctionOpenViewLimitAll.GetConfigList");
  ...
  GetConfigList: (i = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = FunctionOpenViewLimit_1.FunctionOpenViewLimit.getRootAsFunctionOpenViewLimit(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        e.push(t)
      }
