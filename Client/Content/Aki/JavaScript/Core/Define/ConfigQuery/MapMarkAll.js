...
exports.configMapMarkAll = undefined;
...
const TABLE = "MapMark";
const COMMAND = "select BinData from `MapMark`";
const KEY_PREFIX = "MapMarkAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkAll.GetConfigList");
