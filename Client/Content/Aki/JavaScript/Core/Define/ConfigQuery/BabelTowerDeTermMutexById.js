...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerDeTermMutexById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerDeTermMutexById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), n) {
          ...
          return o && (n = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
