...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFaceExpressionDataById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFaceExpressionDataById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const a = FaceExpressionData_1.FaceExpressionData.getRootAsFaceExpressionData(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
