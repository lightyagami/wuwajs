...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMenuConfigByFunctionId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMenuConfigByFunctionId.GetConfig"),
  CONFIG_STAT_PREFIX = "configMenuConfigByFunctionId.GetConfig(",
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMenuConfigByFunctionId.GetConfigList"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (t) {
      if (o) {
        ...
        if (g) return i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["FunctionId", n])) {
        C = void 0;
        if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FunctionId", n]), t) {
          const g = MenuConfig_1.MenuConfig.getRootAsMenuConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          return o && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
  ...
  GetConfigList: (n, o = !0) => {
    ...
    if (t) {
      if (o) {
        ...
        if (e) return i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const e = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["FunctionId", n])) break;
          var g = void 0;
          if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FunctionId", n]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          g = MenuConfig_1.MenuConfig.getRootAsMenuConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          e.push(g)
        }
        return o && (C = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(C, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
      }
      ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair)
    }
