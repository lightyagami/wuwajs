...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlotHandBookConfigByQuestId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPlotHandBookConfigByQuestId.GetConfig"),
...
exports.configPlotHandBookConfigByQuestId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["QuestId", o])) {
        e = void 0;
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["QuestId", o]), i) {
