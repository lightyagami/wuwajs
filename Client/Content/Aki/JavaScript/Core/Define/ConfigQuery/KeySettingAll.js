...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configKeySettingAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configKeySettingAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = KeySetting_1.KeySetting.getRootAsKeySetting(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
