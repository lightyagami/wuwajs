...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), e) {
          const g = FishingTech_1.FishingTech.getRootAsFishingTech(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
