...
exports.configFishingTechById = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const FishingTech_1 = require("../Config/FishingTech");
const DB = "db_fishing.db";
const FILE = "b.捕鱼船坞.xlsx";
const TABLE = "FishingTech";
const COMMAND = "select BinData from `FishingTech` where Id=?";
const KEY_PREFIX = "FishingTechById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTechById.GetConfig");
const CONFIG_STAT_PREFIX = "configFishingTechById.GetConfig(";
