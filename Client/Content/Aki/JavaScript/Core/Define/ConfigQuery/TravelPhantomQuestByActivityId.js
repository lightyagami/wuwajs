...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTravelPhantomQuestByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTravelPhantomQuestByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configTravelPhantomQuestByActivityId.GetConfigList(";
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        ...
        for (;;) {
          ...
          a = TravelPhantomQuest_1.TravelPhantomQuest.getRootAsTravelPhantomQuest(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          r.push(a)
        }
        return o && (e = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
