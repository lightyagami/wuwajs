...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDaySelectPresetById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDaySelectPresetById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        ...
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), n) {
          const a = DaySelectPreset_1.DaySelectPreset.getRootAsDaySelectPreset(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
