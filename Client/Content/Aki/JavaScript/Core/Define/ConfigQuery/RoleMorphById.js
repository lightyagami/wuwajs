...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configRoleMorphById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.角色.xlsx",
  TABLE = "RoleMorph",
  COMMAND = "select BinData from `RoleMorph` where Id =?",
  KEY_PREFIX = "RoleMorphById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleMorphById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRoleMorphById.GetConfig"),
  CONFIG_STAT_PREFIX = "configRoleMorphById.GetConfig(";
exports.configRoleMorphById = {
  Init: () => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const C = RoleMorph_1.RoleMorph.getRootAsRoleMorph(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
...
//# sourceMappingURL=RoleMorphById.js.map