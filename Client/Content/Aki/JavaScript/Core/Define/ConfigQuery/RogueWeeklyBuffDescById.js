...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffDescById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffDescById.GetConfig"),
...
exports.configRogueWeeklyBuffDescById = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", e])) {
        i = void 0;
        if ([f, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", e]), f) {
          ...
          return o && (f = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
