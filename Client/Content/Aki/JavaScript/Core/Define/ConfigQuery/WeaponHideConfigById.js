...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponHideConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponHideConfigById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
          const C = WeaponHideConfig_1.WeaponHideConfig.getRootAsWeaponHideConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
