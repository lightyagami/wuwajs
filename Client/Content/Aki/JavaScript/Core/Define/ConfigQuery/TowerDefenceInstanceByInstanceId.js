...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceByInstanceId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceByInstanceId.GetConfig"),
...
exports.configTowerDefenceInstanceByInstanceId = {
  ...
  GetConfig: (n, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["InstanceId", n])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InstanceId", n]), t) {
          ...
          return e && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
