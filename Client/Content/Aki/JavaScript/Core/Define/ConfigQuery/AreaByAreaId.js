...
exports.configAreaByAreaId = undefined;
...
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByAreaId.GetConfig");
const CONFIG_STAT_PREFIX = "configAreaByAreaId.GetConfig(";
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByAreaId.GetConfigList");
...
exports.configAreaByAreaId = {
  ...
  GetConfig: (o, n = true) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["AreaId", o]) > 0) {
        e = undefined;
        [t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["AreaId", o]);
        if (t) {
          const a = Area_1.Area.getRootAsArea(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          if (n) {
            t = `${KEY_PREFIX}#${o})`;
