...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTreasureBoxMarkByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTreasureBoxMarkByMarkId.GetConfig"),
...
exports.configTreasureBoxMarkByMarkId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (r) {
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", o])) {
        a = void 0;
        if ([r, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", o]), r) {
          const i = TreasureBoxMark_1.TreasureBoxMark.getRootAsTreasureBoxMark(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (r = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
