...
exports.configMotionByRoleId = undefined;
...
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMotionByRoleId.GetConfigList");
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        while (true) {
          ...
          var C = undefined;
          [t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]);
          if (!t) {
