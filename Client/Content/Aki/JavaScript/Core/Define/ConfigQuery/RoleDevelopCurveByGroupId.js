...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleDevelopCurveByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleDevelopCurveByGroupId.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
