...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterDetectionFilterAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterDetectionFilterAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = MonsterDetectionFilter_1.MonsterDetectionFilter.getRootAsMonsterDetectionFilter(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        i.push(n)
      }
