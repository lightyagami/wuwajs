...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPbDataPreloadByMapIdAndPbId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPbDataPreloadByMapIdAndPbId.GetConfig"),
  ...
  GetConfig: (o, a, n = !0) => {
    ...
    if (e) {
      if (n) {
        ...
        if (d) return t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
      }
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, a, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapId", o], ["PbDataId", a])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", o], ["PbDataId", a]), e) {
          const d = PbDataPreload_1.PbDataPreload.getRootAsPbDataPreload(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (e = KEY_PREFIX + `#${o}#${a})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, d)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
        }
      }
