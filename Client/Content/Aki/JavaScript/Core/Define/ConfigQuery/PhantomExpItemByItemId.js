...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomExpItemByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomExpItemByItemId.GetConfig"),
...
exports.configPhantomExpItemByItemId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", o])) {
        m = void 0;
        if ([e, m] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", o]), e) {
          const i = PhantomExpItem_1.PhantomExpItem.getRootAsPhantomExpItem(new byte_buffer_1.ByteBuffer(new Uint8Array(m.buffer)));
