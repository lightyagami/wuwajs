...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResSynergyTypeAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResSynergyTypeAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = RogueResSynergyType_1.RogueResSynergyType.getRootAsRogueResSynergyType(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
