...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFuncMenuWheelByFuncId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFuncMenuWheelByFuncId.GetConfig"),
...
exports.configFuncMenuWheelByFuncId = {
  ...
  GetConfig: (n, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["FuncId", n])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FuncId", n]), t) {
          const C = FuncMenuWheel_1.FuncMenuWheel.getRootAsFuncMenuWheel(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return e && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
