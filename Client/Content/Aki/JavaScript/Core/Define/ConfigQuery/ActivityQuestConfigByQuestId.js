...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActivityQuestConfigByQuestId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configActivityQuestConfigByQuestId.GetConfig"),
...
exports.configActivityQuestConfigByQuestId = {
  ...
  GetConfig: (t, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["QuestId", t])) {
        e = void 0;
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["QuestId", t]), n) {
          ...
          return i && (n = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
