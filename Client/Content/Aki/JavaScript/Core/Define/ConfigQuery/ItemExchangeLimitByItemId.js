...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeLimitByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeLimitByItemId.GetConfig"),
  ...
  GetConfig: (t, n = !0) => {
    ...
    if (i) {
      if (n) {
        ...
        if (m) return e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
      }
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", t])) {
        o = void 0;
        if ([i, o] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", t]), i) {
          ...
          return n && (i = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, m)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), m
        }
      }
