...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityLimitTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityLimitTaskByTaskId.GetConfig"),
...
exports.configFishingActivityLimitTaskByTaskId = {
  ...
  GetConfig: (i, t = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", i])) {
        a = void 0;
        if ([o, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", i]), o) {
          ...
          return t && (o = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
