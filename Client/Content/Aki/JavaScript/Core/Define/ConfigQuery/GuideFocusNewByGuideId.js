...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGuideFocusNewByGuideId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGuideFocusNewByGuideId.GetConfig"),
...
exports.configGuideFocusNewByGuideId = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GuideId", o])) {
        t = void 0;
        if ([n, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GuideId", o]), n) {
          const d = GuideFocusNew_1.GuideFocusNew.getRootAsGuideFocusNew(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return e && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, d)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
        }
      }
