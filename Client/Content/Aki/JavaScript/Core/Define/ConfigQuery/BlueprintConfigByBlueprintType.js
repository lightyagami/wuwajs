...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBlueprintConfigByBlueprintType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBlueprintConfigByBlueprintType.GetConfig"),
...
exports.configBlueprintConfigByBlueprintType = {
  ...
  GetConfig: (n, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["BlueprintType", n])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["BlueprintType", n]), t) {
          const C = BlueprintConfig_1.BlueprintConfig.getRootAsBlueprintConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return i && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
