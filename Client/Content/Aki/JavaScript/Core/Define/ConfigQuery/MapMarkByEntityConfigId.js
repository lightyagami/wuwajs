...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByEntityConfigId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkByEntityConfigId.GetConfig"),
...
exports.configMapMarkByEntityConfigId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["EntityConfigId", o])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["EntityConfigId", o]), t) {
          const C = MapMark_1.MapMark.getRootAsMapMark(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
