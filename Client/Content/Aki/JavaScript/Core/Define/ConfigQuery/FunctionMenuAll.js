...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFunctionMenuAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFunctionMenuAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = FunctionMenu_1.FunctionMenu.getRootAsFunctionMenu(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
