...
exports.configMoraleFlagTypeById = undefined;
...
const COMMAND = "select BinData from `MoraleFlagType` where Id=?";
const KEY_PREFIX = "MoraleFlagTypeById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleFlagTypeById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleFlagTypeById.GetConfig");
const CONFIG_STAT_PREFIX = "configMoraleFlagTypeById.GetConfig(";
