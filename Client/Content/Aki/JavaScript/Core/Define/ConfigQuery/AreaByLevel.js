...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByLevel.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByLevel.GetConfigList"),
  ...
  GetConfigList: (o, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const r = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Level", o])) break;
          var a = void 0;
          if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = Area_1.Area.getRootAsArea(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          r.push(a)
        }
        return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
