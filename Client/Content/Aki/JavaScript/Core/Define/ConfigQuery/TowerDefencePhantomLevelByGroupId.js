...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomLevelByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefencePhantomLevelByGroupId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configTowerDefencePhantomLevelByGroupId.GetConfigList(";
  ...
  GetConfigList: (o, e = !0) => {
    ...
    if (t) {
      if (e) {
        ...
        if (f) return n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return e && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, f, f.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
