...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestDataById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestDataById.GetConfig"),
...
exports.configQuestDataById = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["QuestId", t])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["QuestId", t]), e) {
