...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCatchSignalDifficultyById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCatchSignalDifficultyById.GetConfig"),
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        f = void 0;
        if ([o, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), o) {
          ...
          return n && (o = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
