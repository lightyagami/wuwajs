...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityGroupAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityGroupAll.GetConfigList");
  ...
  GetConfigList: (i = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = FishingActivityGroup_1.FishingActivityGroup.getRootAsFishingActivityGroup(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        e.push(n)
      }
      return i && (t = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(t, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
    }
