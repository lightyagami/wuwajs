...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponConfByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponConfByItemId.GetConfig"),
...
exports.configWeaponConfByItemId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", o])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", o]), t) {
          const C = WeaponConf_1.WeaponConf.getRootAsWeaponConf(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
