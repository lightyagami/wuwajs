...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configChatExpressionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configChatExpressionById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const C = ChatExpression_1.ChatExpression.getRootAsChatExpression(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
