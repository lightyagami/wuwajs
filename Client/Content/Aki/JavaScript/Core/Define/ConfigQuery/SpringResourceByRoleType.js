...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSpringResourceByRoleType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSpringResourceByRoleType.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var r = void 0;
          if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleType", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = SpringResource_1.SpringResource.getRootAsSpringResource(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          g.push(r)
        }
        return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
