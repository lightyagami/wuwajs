...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomLevelByGroupIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomLevelByGroupIdAndLevel.GetConfig"),
...
exports.configPhantomLevelByGroupIdAndLevel = {
  ...
  GetConfig: (o, n, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GroupId", o], ["Level", n])) {
        a = void 0;
        if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o], ["Level", n]), i) {
          const C = PhantomLevel_1.PhantomLevel.getRootAsPhantomLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return e && (i = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
