...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterSizeIdById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterSizeIdById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const C = MonsterSizeId_1.MonsterSizeId.getRootAsMonsterSizeId(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
