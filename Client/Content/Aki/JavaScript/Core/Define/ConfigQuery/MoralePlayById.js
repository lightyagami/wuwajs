...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configMoralePlayById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  MoralePlay_1 = require("../Config/MoralePlay"),
  DB = "db_moraleplay.db",
  FILE = "c.插旗玩法.xlsx",
  TABLE = "MoralePlay",
  COMMAND = "select BinData from `MoralePlay` where Id=?",
  KEY_PREFIX = "MoralePlayById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoralePlayById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMoralePlayById.GetConfig"),
  CONFIG_STAT_PREFIX = "configMoralePlayById.GetConfig(";
