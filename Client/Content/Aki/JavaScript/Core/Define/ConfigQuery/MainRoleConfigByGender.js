...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMainRoleConfigByGender.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMainRoleConfigByGender.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const f = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Gender", o])) break;
          var C = void 0;
          if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Gender", o]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
