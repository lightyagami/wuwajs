...
exports.configModelConfigPreloadById = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configModelConfigPreloadById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configModelConfigPreloadById.GetConfig");
  ...
  GetConfig: (o, n = true) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["Id", o]) > 0) {
        ...
        if (i) {
          const C = ModelConfigPreload_1.ModelConfigPreload.getRootAsModelConfigPreload(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          if (n) {
            i = `${KEY_PREFIX}#${o})`;
