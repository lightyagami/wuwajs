...
exports.configLinkDataById = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const LinkData_1 = require("../Config/LinkData");
const DB = "db_link.db";
const FILE = "l.Link功能.xlsx";
const TABLE = "LinkData";
const COMMAND = "select BinData from `LinkData` where Id=?";
const KEY_PREFIX = "LinkDataById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLinkDataById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLinkDataById.GetConfig");
const CONFIG_STAT_PREFIX = "configLinkDataById.GetConfig(";
