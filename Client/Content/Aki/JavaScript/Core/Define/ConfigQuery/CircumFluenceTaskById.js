...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCircumFluenceTaskById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCircumFluenceTaskById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), e) {
          const C = CircumFluenceTask_1.CircumFluenceTask.getRootAsCircumFluenceTask(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return o && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
