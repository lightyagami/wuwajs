...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResCharacterById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResCharacterById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const a = RogueResCharacter_1.RogueResCharacter.getRootAsRogueResCharacter(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
