...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyByActivityId.GetConfig"),
...
exports.configDangoMonopolyByActivityId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", o])) {
        e = void 0;
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), i) {
          const g = DangoMonopoly_1.DangoMonopoly.getRootAsDangoMonopoly(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return n && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
