...
exports.configFlowTextLang = undefined;
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFlowTextLang.Init");
const getLocalTextStat = Stats_1.Stat.CreateNoFlameGraph("configFlowTextLang.GetLocalText");
      ...
      if (m) {
        ...
        if (m.Success) {
          ...
          if (StringUtils_1.StringUtils.IsEmpty(a) && t !== CommonDefine_1.CHS) {
            C = exports.configFlowTextLang.GetLocalText(o, CommonDefine_1.CHS);
