...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDoubleRewardActivityById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDoubleRewardActivityById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const a = DoubleRewardActivity_1.DoubleRewardActivity.getRootAsDoubleRewardActivity(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
