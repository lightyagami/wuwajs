...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCustomMarkByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCustomMarkByMarkId.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", o])) {
        C = void 0;
        if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", o]), i) {
