...
exports.configPhantomBattleTaskByActivityId = undefined;
...
const COMMAND = "select BinData from `PhantomBattleTask` where ActivityId=?";
const KEY_PREFIX = "PhantomBattleTaskByActivityId";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleTaskByActivityId.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleTaskByActivityId.GetConfigList");
const CONFIG_LIST_STAT_PREFIX = "configPhantomBattleTaskByActivityId.GetConfigList(";
