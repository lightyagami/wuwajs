...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntityOwnerDataByGuid.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntityOwnerDataByGuid.GetConfig"),
...
exports.configEntityOwnerDataByGuid = {
  ...
  GetConfig: (n, t = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Guid", n])) {
        e = void 0;
        if ([o, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Guid", n]), o) {
          const a = EntityOwnerData_1.EntityOwnerData.getRootAsEntityOwnerData(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return t && (o = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
