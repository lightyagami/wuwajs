...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configConditionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configConditionById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const e = Condition_1.Condition.getRootAsCondition(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
