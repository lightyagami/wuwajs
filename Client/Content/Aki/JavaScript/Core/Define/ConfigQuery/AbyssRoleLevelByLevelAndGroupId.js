...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRoleLevelByLevelAndGroupId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRoleLevelByLevelAndGroupId.GetConfig"),
...
exports.configAbyssRoleLevelByLevelAndGroupId = {
  ...
  GetConfig: (o, e, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", o], ["GroupId", e])) {
        l = void 0;
        if ([t, l] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", o], ["GroupId", e]), t) {
          const C = AbyssRoleLevel_1.AbyssRoleLevel.getRootAsAbyssRoleLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(l.buffer)));
          return n && (t = KEY_PREFIX + `#${o}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
