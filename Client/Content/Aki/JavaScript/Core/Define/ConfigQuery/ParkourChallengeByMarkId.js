...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configParkourChallengeByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configParkourChallengeByMarkId.GetConfig"),
...
exports.configParkourChallengeByMarkId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", o])) {
        r = void 0;
        if ([a, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", o]), a) {
          ...
          return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
