...
exports.configRogueResCollectionByIdKey = undefined;
...
const KEY_PREFIX = "RogueResCollectionByIdKey";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResCollectionByIdKey.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResCollectionByIdKey.GetConfig");
const CONFIG_STAT_PREFIX = "configRogueResCollectionByIdKey.GetConfig(";
