...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkRelativeSubTypeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMapMarkRelativeSubTypeById.GetConfig"),
