...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFarmGoldMapMarkByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFarmGoldMapMarkByActivityId.GetConfig"),
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", o])) {
        a = void 0;
        if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", o]), n) {
          const r = FarmGoldMapMark_1.FarmGoldMapMark.getRootAsFarmGoldMapMark(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return i && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
