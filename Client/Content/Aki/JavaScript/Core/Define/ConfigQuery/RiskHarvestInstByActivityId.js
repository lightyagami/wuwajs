...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstByActivityId.GetConfigList"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        ...
        for (;;) {
          ...
          var s = void 0;
          if ([n, s] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", t]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          s = RiskHarvestInst_1.RiskHarvestInst.getRootAsRiskHarvestInst(new byte_buffer_1.ByteBuffer(new Uint8Array(s.buffer)));
          a.push(s)
        }
        return i && (e = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
