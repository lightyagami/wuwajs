...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCircumFluenceTaskByTaskType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCircumFluenceTaskByTaskType.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["TaskType", o])) break;
          var C = void 0;
          if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskType", o]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = CircumFluenceTask_1.CircumFluenceTask.getRootAsCircumFluenceTask(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          a.push(C)
        }
        return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
