...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFlowStateByStateKey.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFlowStateByStateKey.GetConfig"),
...
exports.configFlowStateByStateKey = {
  ...
  GetConfig: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["StateKey", t])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["StateKey", t]), n) {
          const a = FlowState_1.FlowState.getRootAsFlowState(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return o && (n = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
