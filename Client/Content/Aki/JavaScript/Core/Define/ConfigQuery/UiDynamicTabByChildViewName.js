...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configUiDynamicTabByChildViewName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configUiDynamicTabByChildViewName.GetConfig"),
...
exports.configUiDynamicTabByChildViewName = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ChildViewName", i])) {
        a = void 0;
        if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ChildViewName", i]), e) {
          const t = UiDynamicTab_1.UiDynamicTab.getRootAsUiDynamicTab(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
