...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyTaskByGroup.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyTaskByGroup.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["TaskGroupId", o])) break;
          var e = void 0;
          if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskGroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = DangoMonopolyTask_1.DangoMonopolyTask.getRootAsDangoMonopolyTask(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          g.push(e)
        }
