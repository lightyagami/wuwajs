...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstByInstanceID.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRiskHarvestInstByInstanceID.GetConfig"),
...
exports.configRiskHarvestInstByInstanceID = {
  ...
  GetConfig: (n, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["InstanceID", n])) {
        e = void 0;
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InstanceID", n]), i) {
          const a = RiskHarvestInst_1.RiskHarvestInst.getRootAsRiskHarvestInst(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return t && (i = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
