...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingActivityByActivityId.GetConfig"),
...
exports.configFishingActivityByActivityId = {
  ...
  GetConfig: (i, t = !0) => {
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", i])) {
        e = void 0;
        if ([o, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), o) {
