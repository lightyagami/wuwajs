...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCombinationAxisByAxisName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCombinationAxisByAxisName.GetConfig"),
...
exports.configCombinationAxisByAxisName = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["AxisName", o])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["AxisName", o]), t) {
