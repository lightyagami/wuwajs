...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingIllustratedRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingIllustratedRewardById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), t) {
          const a = FishingIllustratedReward_1.FishingIllustratedReward.getRootAsFishingIllustratedReward(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return n && (t = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
