...
exports.configTrapDefenseRewardByActivityId = undefined;
...
const COMMAND = "select BinData from `TrapDefenseReward` where ActivityId=?";
const KEY_PREFIX = "TrapDefenseRewardByActivityId";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrapDefenseRewardByActivityId.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTrapDefenseRewardByActivityId.GetConfigList");
const CONFIG_LIST_STAT_PREFIX = "configTrapDefenseRewardByActivityId.GetConfigList(";
exports.configTrapDefenseRewardByActivityId = {
  Init: () => {
    initStat?.Start();
...
//# sourceMappingURL=TrapDefenseRewardByActivityId.js.map