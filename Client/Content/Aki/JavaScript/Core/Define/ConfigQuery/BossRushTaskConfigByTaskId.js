...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskConfigByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBossRushTaskConfigByTaskId.GetConfig"),
...
exports.configBossRushTaskConfigByTaskId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    var i = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      s = (i?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (s) {
      if (n) {
        var t = KEY_PREFIX + `#${o})`;
      ...
      if (s = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", o])) {
        t = void 0;
        if ([s, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", o]), s) {
          ...
          return n && (s = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(s, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
