...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyGridByGroup.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configDangoMonopolyGridByGroup.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["GridGroupId", o])) break;
          var e = void 0;
          if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GridGroupId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = DangoMonopolyGrid_1.DangoMonopolyGrid.getRootAsDangoMonopolyGrid(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          g.push(e)
        }
        return n && (r = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
