...
exports.configMonsterHandBookAll = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterHandBookAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMonsterHandBookAll.GetConfigList");
  ...
  GetConfigList: (o = true) => {
    ...
    if (n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        i = MonsterHandBook_1.MonsterHandBook.getRootAsMonsterHandBook(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i);
      }
      if (o) {
        t = KEY_PREFIX + ")";
