...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeekQualityConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeekQualityConfigById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const g = RogueWeekQualityConfig_1.RogueWeekQualityConfig.getRootAsRogueWeekQualityConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return e && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
