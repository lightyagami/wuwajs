...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleEntryById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  PhantomBattleEntry_1 = require("../Config/PhantomBattleEntry"),
  DB = "db_phantombattle.db",
  FILE = "s.声骸大作战战斗.xlsx",
  TABLE = "PhantomBattleEntry",
  COMMAND = "select BinData from `PhantomBattleEntry` where Id=?",
  KEY_PREFIX = "PhantomBattleEntryById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleEntryById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleEntryById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleEntryById.GetConfig(";
