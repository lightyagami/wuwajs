...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementGroupByCategory.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAchievementGroupByCategory.GetConfigList"),
  ...
  GetConfigList: (o, e = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const r = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Category", o])) break;
          var C = void 0;
          if ([n, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Category", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
