...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleCardById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleCard` where Id=?",
  KEY_PREFIX = "PhantomBattleCardById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleCardById.GetConfig(";
