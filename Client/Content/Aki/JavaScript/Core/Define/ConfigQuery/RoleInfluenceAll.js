...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleInfluenceAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleInfluenceAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = RoleInfluence_1.RoleInfluence.getRootAsRoleInfluence(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
