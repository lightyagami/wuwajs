...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMemoryCollectByTopicID.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoMemoryCollectByTopicID.GetConfigList"),
  ...
  GetConfigList: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const r = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["TopicID", o])) break;
          var C = void 0;
          if ([n, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TopicID", o]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = PhotoMemoryCollect_1.PhotoMemoryCollect.getRootAsPhotoMemoryCollect(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          r.push(C)
        }
        return t && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
