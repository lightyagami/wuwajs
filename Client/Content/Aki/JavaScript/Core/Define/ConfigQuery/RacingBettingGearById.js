...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBettingGearById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBettingGearById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const g = RacingBettingGear_1.RacingBettingGear.getRootAsRacingBettingGear(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return i && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
