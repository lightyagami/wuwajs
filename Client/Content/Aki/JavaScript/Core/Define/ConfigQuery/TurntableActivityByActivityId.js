...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableActivityByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableActivityByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configTurntableActivityByActivityId.GetConfigList(";
  ...
  GetConfigList: (t, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        ...
        return i && (e = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
