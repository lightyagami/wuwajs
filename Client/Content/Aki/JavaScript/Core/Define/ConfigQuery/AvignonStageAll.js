...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAvignonStageAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAvignonStageAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = AvignonStage_1.AvignonStage.getRootAsAvignonStage(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
