...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `WeaponPropertyGrowth` where CurveId = ? AND Level = ? AND BreachLevel = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponPropertyGrowthByCurveIdLevelAndBreachLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponPropertyGrowthByCurveIdLevelAndBreachLevel.GetConfig"),
  CONFIG_STAT_PREFIX = "configWeaponPropertyGrowthByCurveIdLevelAndBreachLevel.GetConfig(";
exports.configWeaponPropertyGrowthByCurveIdLevelAndBreachLevel = {
  ...
  GetConfig: (o, e, n, r = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 3, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["CurveId", o], ["Level", e], ["BreachLevel", n])) {
        C = void 0;
        if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CurveId", o], ["Level", e], ["BreachLevel", n]), i) {
          ...
          return r && (i = KEY_PREFIX + `#${o}#${e}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
