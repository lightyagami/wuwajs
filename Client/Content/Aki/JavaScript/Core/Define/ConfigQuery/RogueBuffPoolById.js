...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueBuffPoolById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueBuffPoolById.GetConfig"),
...
exports.configRogueBuffPoolById = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    var e = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      f = (e?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (f) {
      if (n) {
        var i = KEY_PREFIX + `#${o})`;
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        i = void 0;
        if ([f, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), f) {
          const t = RogueBuffPool_1.RogueBuffPool.getRootAsRogueBuffPool(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (f = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
