...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomHandBookAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomHandBookAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = PhantomHandBook_1.PhantomHandBook.getRootAsPhantomHandBook(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        a.push(i)
      }
