...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `LevelEntityConfig` where MapId=? and EntityId=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLevelEntityConfigByMapIdAndEntityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLevelEntityConfigByMapIdAndEntityId.GetConfig"),
...
exports.configLevelEntityConfigByMapIdAndEntityId = {
  ...
  GetConfig: (n, t, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, t, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapId", n], ["EntityId", t])) {
        C = void 0;
        if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", n], ["EntityId", t]), e) {
          ...
          return o && (e = KEY_PREFIX + `#${n}#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
