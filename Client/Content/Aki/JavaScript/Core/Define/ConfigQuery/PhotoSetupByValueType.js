...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoSetupByValueType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhotoSetupByValueType.GetConfig"),
...
exports.configPhotoSetupByValueType = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ValueType", o])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ValueType", o]), n) {
          const C = PhotoSetup_1.PhotoSetup.getRootAsPhotoSetup(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return t && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
