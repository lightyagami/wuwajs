...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configActivityLinkageById.GetConfig"),
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([o, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), o) {
          ...
          return n && (o = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
