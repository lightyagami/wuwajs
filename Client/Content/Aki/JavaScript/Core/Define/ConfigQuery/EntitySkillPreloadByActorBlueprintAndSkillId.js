...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `EntitySkillPreload` where ActorBlueprint=? AND SkillId=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByActorBlueprintAndSkillId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntitySkillPreloadByActorBlueprintAndSkillId.GetConfig"),
  CONFIG_STAT_PREFIX = "configEntitySkillPreloadByActorBlueprintAndSkillId.GetConfig(";
exports.configEntitySkillPreloadByActorBlueprintAndSkillId = {
  ...
  GetConfig: (o, i, t = !0) => {
    ...
    if (l) {
      ...
      if (l = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActorBlueprint", o], ["SkillId", i])) {
        e = void 0;
        if ([l, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActorBlueprint", o], ["SkillId", i]), l) {
          ...
          return t && (l = KEY_PREFIX + `#${o}#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(l, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
