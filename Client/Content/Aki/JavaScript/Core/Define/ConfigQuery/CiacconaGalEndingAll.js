...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCiacconaGalEndingAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCiacconaGalEndingAll.GetConfigList");
exports.configCiacconaGalEndingAll = {
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return n && (i = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(i, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
    }
