...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomItemByMonsterId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomItemByMonsterId.GetConfigList"),
  ...
  GetConfigList: (o, t = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["MonsterId", o])) break;
          var m = void 0;
          if ([i, m] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MonsterId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
