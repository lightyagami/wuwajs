...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResEventPlotByPlotId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResEventPlotByPlotId.GetConfig"),
...
exports.configRogueResEventPlotByPlotId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PlotId", o])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PlotId", o]), n) {
          ...
          return t && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
