...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDebugCommandConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDebugCommandConfigById.GetConfig"),
...
exports.configDebugCommandConfigById = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (C) {
      ...
      if (C = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        e = void 0;
        if ([C, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), C) {
          ...
          return n && (C = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(C, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
