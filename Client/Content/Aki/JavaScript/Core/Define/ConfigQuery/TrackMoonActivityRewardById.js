...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonActivityRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTrackMoonActivityRewardById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const a = TrackMoonActivityReward_1.TrackMoonActivityReward.getRootAsTrackMoonActivityReward(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return i && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
