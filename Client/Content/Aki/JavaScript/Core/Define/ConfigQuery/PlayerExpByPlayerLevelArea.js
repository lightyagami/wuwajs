...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.经验.xlsx",
  TABLE = "PlayerExp",
  COMMAND = "select BinData from `PlayerExp` where PlayerLevel >= ? AND PlayerLevel < ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerExpByPlayerLevelArea.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerExpByPlayerLevelArea.GetConfigList"),
  ...
  GetConfigList: (e, o, n = !0) => {
    ...
    if (t) {
      if (n) {
        ...
        if (l) return i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair)) {
        const l = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["PlayerLevel", e], ["PlayerLevel", o])) break;
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PlayerLevel", e], ["PlayerLevel", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = PlayerExp_1.PlayerExp.getRootAsPlayerExp(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          l.push(r)
        }
        return n && (a = KEY_PREFIX + `#${e}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, l, l.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), l
      }
