...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAxisMappingByAxisType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAxisMappingByAxisType.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair)) {
        ...
        for (;;) {
          ...
          var g = void 0;
          if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["AxisType", i]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          g = AxisMapping_1.AxisMapping.getRootAsAxisMapping(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          a.push(g)
        }
        return n && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
