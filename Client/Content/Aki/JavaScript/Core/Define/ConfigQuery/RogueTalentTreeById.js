...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueTalentTreeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueTalentTreeById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const g = RogueTalentTree_1.RogueTalentTree.getRootAsRogueTalentTree(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
