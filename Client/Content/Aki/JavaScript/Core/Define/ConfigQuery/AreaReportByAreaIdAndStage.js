...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAreaReportByAreaIdAndStage.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAreaReportByAreaIdAndStage.GetConfig"),
...
exports.configAreaReportByAreaIdAndStage = {
  ...
  GetConfig: (o, e, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["AreaId", o], ["Stage", e])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["AreaId", o], ["Stage", e]), a) {
          const r = AreaReport_1.AreaReport.getRootAsAreaReport(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (a = KEY_PREFIX + `#${o}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
