...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingGridItemShapeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingGridItemShapeById.GetConfig"),
...
exports.configFishingGridItemShapeById = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), e) {
          ...
          return n && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
