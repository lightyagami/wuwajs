...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAiStateMachineConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAiStateMachineConfigById.GetConfig"),
...
exports.configAiStateMachineConfigById = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        e = void 0;
