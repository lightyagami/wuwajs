...
const ActivityFilterAll_1 = require("./ActivityFilterAll");
const ActivityFilterById_1 = require("./ActivityFilterById");
const ActivityGamePlayPlotById_1 = require("./ActivityGamePlayPlotById");
...
const ActivityPermanentFilterAll_1 = require("./ActivityPermanentFilterAll");
const ActivityPermanentFilterById_1 = require("./ActivityPermanentFilterById");
...
const ActivityTimeShowById_1 = require("./ActivityTimeShowById");
const ActivityTitleTagsById_1 = require("./ActivityTitleTagsById");
...
const AdvertisingPageInfoAll_1 = require("./AdvertisingPageInfoAll");
const AdvertisingPageInfoByActivityId_1 = require("./AdvertisingPageInfoByActivityId");
const AdvertisingPageInfoById_1 = require("./AdvertisingPageInfoById");
const AdvertisingTabActivityAll_1 = require("./AdvertisingTabActivityAll");
const AdvertisingTabActivityById_1 = require("./AdvertisingTabActivityById");
const AdvertisingTabCharacterAll_1 = require("./AdvertisingTabCharacterAll");
const AdvertisingTabCharacterById_1 = require("./AdvertisingTabCharacterById");
const AdvertisingTabCostumeAll_1 = require("./AdvertisingTabCostumeAll");
const AdvertisingTabCostumeById_1 = require("./AdvertisingTabCostumeById");
const AdvertisingTabEnemyAll_1 = require("./AdvertisingTabEnemyAll");
const AdvertisingTabEnemyById_1 = require("./AdvertisingTabEnemyById");
const AdvertisingTabInfoAll_1 = require("./AdvertisingTabInfoAll");
const AdvertisingTabInfoById_1 = require("./AdvertisingTabInfoById");
const AdvertisingTabRegionAll_1 = require("./AdvertisingTabRegionAll");
const AdvertisingTabRegionById_1 = require("./AdvertisingTabRegionById");
const AdvertisingTabStoryAll_1 = require("./AdvertisingTabStoryAll");
const AdvertisingTabStoryById_1 = require("./AdvertisingTabStoryById");
const AdvertisingTabSystemAll_1 = require("./AdvertisingTabSystemAll");
const AdvertisingTabSystemById_1 = require("./AdvertisingTabSystemById");
const AdvertisingUrlConfigById_1 = require("./AdvertisingUrlConfigById");
...
const AnimalStandbyMontageByBp_1 = require("./AnimalStandbyMontageByBp");
const AnsPerformById_1 = require("./AnsPerformById");
const AreaAll_1 = require("./AreaAll");
...
const AreaMapGroupAll_1 = require("./AreaMapGroupAll");
const AreaMapGroupById_1 = require("./AreaMapGroupById");
...
const AreaTerminalAll_1 = require("./AreaTerminalAll");
const AreaTerminalByCountry_1 = require("./AreaTerminalByCountry");
const AreaTerminalById_1 = require("./AreaTerminalById");
const AreaTerminalGroupById_1 = require("./AreaTerminalGroupById");
const ArtemisByActivityId_1 = require("./ArtemisByActivityId");
const ArtemisByDay_1 = require("./ArtemisByDay");
const ArtemisChatById_1 = require("./ArtemisChatById");
const ArtemisQteById_1 = require("./ArtemisQteById");
const AtmosphereLevelAll_1 = require("./AtmosphereLevelAll");
const AtmosphereLevelByActivityId_1 = require("./AtmosphereLevelByActivityId");
const AtmosphereLevelByActivityIdAndLevel_1 = require("./AtmosphereLevelByActivityIdAndLevel");
const AtmosphereLevelById_1 = require("./AtmosphereLevelById");
const AudioById_1 = require("./AudioById");
const AutoPilotCirclesById_1 = require("./AutoPilotCirclesById");
...
const BehaviorCommonButtonAll_1 = require("./BehaviorCommonButtonAll");
const BehaviorCommonButtonById_1 = require("./BehaviorCommonButtonById");
const BirthDayByItemId_1 = require("./BirthDayByItemId");
const BirthDayByMsgId_1 = require("./BirthDayByMsgId");
const BirthDayByYear_1 = require("./BirthDayByYear");
const BirthDayTextByDateAndType_1 = require("./BirthDayTextByDateAndType");
...
const BookItemById_1 = require("./BookItemById");
...
const BrochureByActivityIdAndType_1 = require("./BrochureByActivityIdAndType");
const BrochureById_1 = require("./BrochureById");
...
const CalabashDevelopRewardByInteractAreaId_1 = require("./CalabashDevelopRewardByInteractAreaId");
...
const CalabashMeshById_1 = require("./CalabashMeshById");
const CalabashMeshByMeshId_1 = require("./CalabashMeshByMeshId");
const CalabashSkinAll_1 = require("./CalabashSkinAll");
const CalabashSkinById_1 = require("./CalabashSkinById");
...
const ChatBgAll_1 = require("./ChatBgAll");
const ChatBgById_1 = require("./ChatBgById");
const ChatDialogAll_1 = require("./ChatDialogAll");
const ChatDialogById_1 = require("./ChatDialogById");
...
const ChatPartnerById_1 = require("./ChatPartnerById");
...
const CommonTouchUiEditByPanelResId_1 = require("./CommonTouchUiEditByPanelResId");
const CommonTouchUiEditGroupById_1 = require("./CommonTouchUiEditGroupById");
...
const ConnectBlockWhiteAll_1 = require("./ConnectBlockWhiteAll");
...
const DamageTextAreaAll_1 = require("./DamageTextAreaAll");
const DamageTextAreaById_1 = require("./DamageTextAreaById");
...
const DetectionTitlePanelById_1 = require("./DetectionTitlePanelById");
const DeviceInfoAll_1 = require("./DeviceInfoAll");
...
const DownLoadSubPackageAll_1 = require("./DownLoadSubPackageAll");
const DownLoadSubPackageById_1 = require("./DownLoadSubPackageById");
const DownLoadSubPackageByVersion_1 = require("./DownLoadSubPackageByVersion");
const DownLoadTabAll_1 = require("./DownLoadTabAll");
const DownLoadTabById_1 = require("./DownLoadTabById");
const DownLoadVersionByType_1 = require("./DownLoadVersionByType");
const DownLoadVersionByVersion_1 = require("./DownLoadVersionByVersion");
const DragonPoolAll_1 = require("./DragonPoolAll");
const DragonPoolByCoreId_1 = require("./DragonPoolByCoreId");
...
const DrinksBatchingAll_1 = require("./DrinksBatchingAll");
const DrinksBatchingById_1 = require("./DrinksBatchingById");
const DrinksDialogById_1 = require("./DrinksDialogById");
const DrinksDrinkBaseAll_1 = require("./DrinksDrinkBaseAll");
const DrinksDrinkBaseById_1 = require("./DrinksDrinkBaseById");
const DrinksDrinkMixAll_1 = require("./DrinksDrinkMixAll");
const DrinksDrinkMixById_1 = require("./DrinksDrinkMixById");
const DrinksFlavorRangeByGroupId_1 = require("./DrinksFlavorRangeByGroupId");
const DrinksFlavorRangeById_1 = require("./DrinksFlavorRangeById");
const DrinksFlavorTypeById_1 = require("./DrinksFlavorTypeById");
const DrinksOrnamentAll_1 = require("./DrinksOrnamentAll");
const DrinksOrnamentById_1 = require("./DrinksOrnamentById");
const DrinksParamById_1 = require("./DrinksParamById");
const DrinksRequireListById_1 = require("./DrinksRequireListById");
const DrinksRequireListByRoleId_1 = require("./DrinksRequireListByRoleId");
const DrinksRoleInviteAll_1 = require("./DrinksRoleInviteAll");
const DrinksRoleInviteById_1 = require("./DrinksRoleInviteById");
const DrinksRoleLikeDrinkById_1 = require("./DrinksRoleLikeDrinkById");
const DrinksStepConfigById_1 = require("./DrinksStepConfigById");
...
const EffectSaveByEffectId_1 = require("./EffectSaveByEffectId");
const EffectSaveByEffectPath_1 = require("./EffectSaveByEffectPath");
...
const EncircleChallengeById_1 = require("./EncircleChallengeById");
const EncircleChallengeGroupByActivityId_1 = require("./EncircleChallengeGroupByActivityId");
const EncircleChallengeGroupByDay_1 = require("./EncircleChallengeGroupByDay");
const EncircleChallengeGroupById_1 = require("./EncircleChallengeGroupById");
const EncircleMapByMapId_1 = require("./EncircleMapByMapId");
const EncircleMapItemById_1 = require("./EncircleMapItemById");
...
const ExhibitPhantomByBodyType_1 = require("./ExhibitPhantomByBodyType");
const ExhibitPhantomById_1 = require("./ExhibitPhantomById");
const ExhibitWeaponTransformById_1 = require("./ExhibitWeaponTransformById");
...
const ExploreRouletteTypeAll_1 = require("./ExploreRouletteTypeAll");
const ExploreRouletteTypeById_1 = require("./ExploreRouletteTypeById");
...
const FightPhotoOptionAll_1 = require("./FightPhotoOptionAll");
const FightPhotoOptionById_1 = require("./FightPhotoOptionById");
const FilterById_1 = require("./FilterById");
const FilterRuleById_1 = require("./FilterRuleById");
const FilterSeniorSettingAll_1 = require("./FilterSeniorSettingAll");
const FilterSeniorSettingById_1 = require("./FilterSeniorSettingById");
...
const FindSunSpiritById_1 = require("./FindSunSpiritById");
...
const FuncMenuReplaceId_1 = require("./FuncMenuReplaceId");
...
const FurnitureAll_1 = require("./FurnitureAll");
const FurnitureByActivityId_1 = require("./FurnitureByActivityId");
const FurnitureById_1 = require("./FurnitureById");
const FurnitureBySourceTypeAndGetWayId_1 = require("./FurnitureBySourceTypeAndGetWayId");
const FurnitureByTagId_1 = require("./FurnitureByTagId");
const FurnitureDiyTagAll_1 = require("./FurnitureDiyTagAll");
const FurnitureDiyTagById_1 = require("./FurnitureDiyTagById");
const FurnitureFilterConfigAll_1 = require("./FurnitureFilterConfigAll");
const FurnitureFilterConfigById_1 = require("./FurnitureFilterConfigById");
const FurniturePresetConfigByAreaId_1 = require("./FurniturePresetConfigByAreaId");
const FurnitureQualityConfigById_1 = require("./FurnitureQualityConfigById");
...
const GachaRoleDevelopInsByDungeonDetection_1 = require("./GachaRoleDevelopInsByDungeonDetection");
const GachaRoleDevelopInsById_1 = require("./GachaRoleDevelopInsById");
const GachaRoleDevelopInsByRoleId_1 = require("./GachaRoleDevelopInsByRoleId");
...
const GeographyHandBookByTabType_1 = require("./GeographyHandBookByTabType");
const GeographyHandBookByTabTypeAndType_1 = require("./GeographyHandBookByTabTypeAndType");
const GeographyHandBookByType_1 = require("./GeographyHandBookByType");
const GeographyTabTypeAll_1 = require("./GeographyTabTypeAll");
const GeographyTabTypeById_1 = require("./GeographyTabTypeById");
...
const GivebackScoreRewardAll_1 = require("./GivebackScoreRewardAll");
const GivebackScoreRewardById_1 = require("./GivebackScoreRewardById");
const GivebackTaskAll_1 = require("./GivebackTaskAll");
const GivebackTaskByTaskId_1 = require("./GivebackTaskByTaskId");
...
const GongduolaPassengerVoiceConfigByRoleIdAndVehicleTriggerType_1 = require("./GongduolaPassengerVoiceConfigByRoleIdAndVehicleTriggerType");
const GuessJokerAIPlotConfigAll_1 = require("./GuessJokerAIPlotConfigAll");
const GuessJokerAIPlotConfigById_1 = require("./GuessJokerAIPlotConfigById");
const GuessJokerAiConfigAll_1 = require("./GuessJokerAiConfigAll");
const GuessJokerAiConfigById_1 = require("./GuessJokerAiConfigById");
const GuessJokerAiConfigByNpcId_1 = require("./GuessJokerAiConfigByNpcId");
const GuessJokerLevelAll_1 = require("./GuessJokerLevelAll");
const GuessJokerLevelById_1 = require("./GuessJokerLevelById");
const GuessJokerParamByKey_1 = require("./GuessJokerParamByKey");
const GuessJokerPlotConfigById_1 = require("./GuessJokerPlotConfigById");
...
const H5JumpActivityById_1 = require("./H5JumpActivityById");
...
const HiddenQuestWhiteByQuestId_1 = require("./HiddenQuestWhiteByQuestId");
const HomeBtnStyleById_1 = require("./HomeBtnStyleById");
const HonamiSteadyConsumeByCostGroup_1 = require("./HonamiSteadyConsumeByCostGroup");
const HonamiStoryActivityAll_1 = require("./HonamiStoryActivityAll");
const HonamiStoryActivityByActivityId_1 = require("./HonamiStoryActivityByActivityId");
const HonamiStoryAreaByActivityId_1 = require("./HonamiStoryAreaByActivityId");
const HonamiStoryAreaById_1 = require("./HonamiStoryAreaById");
const HonamiStoryAreaTaskByActivityId_1 = require("./HonamiStoryAreaTaskByActivityId");
const HonamiStoryAreaTaskById_1 = require("./HonamiStoryAreaTaskById");
const HonamiStoryBackPackById_1 = require("./HonamiStoryBackPackById");
const HonamiStoryBuffTempById_1 = require("./HonamiStoryBuffTempById");
const HonamiStoryBuffTempLibraryById_1 = require("./HonamiStoryBuffTempLibraryById");
const HonamiStoryDangerLevelById_1 = require("./HonamiStoryDangerLevelById");
const HonamiStoryEffectById_1 = require("./HonamiStoryEffectById");
const HonamiStoryEquipById_1 = require("./HonamiStoryEquipById");
const HonamiStoryItemById_1 = require("./HonamiStoryItemById");
const HonamiStoryItemCollectionByActivityId_1 = require("./HonamiStoryItemCollectionByActivityId");
const HonamiStoryItemCollectionByItemId_1 = require("./HonamiStoryItemCollectionByItemId");
const HonamiStoryItemQualityAll_1 = require("./HonamiStoryItemQualityAll");
const HonamiStoryItemQualityById_1 = require("./HonamiStoryItemQualityById");
const HonamiStoryLifeSupportByActivityId_1 = require("./HonamiStoryLifeSupportByActivityId");
const HonamiStoryLifeSupportById_1 = require("./HonamiStoryLifeSupportById");
const HonamiStoryLimitTaskByActivityId_1 = require("./HonamiStoryLimitTaskByActivityId");
const HonamiStoryLimitTaskById_1 = require("./HonamiStoryLimitTaskById");
const HonamiStoryLoadingPerformByBTId_1 = require("./HonamiStoryLoadingPerformByBTId");
const HonamiStoryLoadingPerformByBTIdAndTiming_1 = require("./HonamiStoryLoadingPerformByBTIdAndTiming");
const HonamiStoryLoadingPerformById_1 = require("./HonamiStoryLoadingPerformById");
const HonamiStoryLoadingPerformByTiming_1 = require("./HonamiStoryLoadingPerformByTiming");
const HonamiStoryMapMarkAll_1 = require("./HonamiStoryMapMarkAll");
const HonamiStoryMapMarkById_1 = require("./HonamiStoryMapMarkById");
const HonamiStoryMarkWhiteListAll_1 = require("./HonamiStoryMarkWhiteListAll");
const HonamiStoryMarkWhiteListById_1 = require("./HonamiStoryMarkWhiteListById");
const HonamiStoryMascotByActivityId_1 = require("./HonamiStoryMascotByActivityId");
const HonamiStoryMascotById_1 = require("./HonamiStoryMascotById");
const HonamiStoryOutDialogByActivityId_1 = require("./HonamiStoryOutDialogByActivityId");
const HonamiStoryOutDialogByActivityIdAndType_1 = require("./HonamiStoryOutDialogByActivityIdAndType");
const HonamiStoryOutDialogById_1 = require("./HonamiStoryOutDialogById");
const HonamiStoryPluginBoxItemByActivityId_1 = require("./HonamiStoryPluginBoxItemByActivityId");
const HonamiStoryPluginBoxItemById_1 = require("./HonamiStoryPluginBoxItemById");
const HonamiStoryPluginSlotById_1 = require("./HonamiStoryPluginSlotById");
const HonamiStoryPluginSubTypeById_1 = require("./HonamiStoryPluginSubTypeById");
const HonamiStoryPluginTagById_1 = require("./HonamiStoryPluginTagById");
const HonamiStoryPollutionByActivityId_1 = require("./HonamiStoryPollutionByActivityId");
const HonamiStoryPollutionStageById_1 = require("./HonamiStoryPollutionStageById");
const HonamiStoryPropById_1 = require("./HonamiStoryPropById");
const HonamiStoryPropLibraryById_1 = require("./HonamiStoryPropLibraryById");
const HonamiStoryResidentTaskByActivityId_1 = require("./HonamiStoryResidentTaskByActivityId");
const HonamiStoryResidentTaskById_1 = require("./HonamiStoryResidentTaskById");
const HonamiStoryScanMachineAll_1 = require("./HonamiStoryScanMachineAll");
const HonamiStoryScanMachineById_1 = require("./HonamiStoryScanMachineById");
const HonamiStoryScoreRewardByActivityId_1 = require("./HonamiStoryScoreRewardByActivityId");
const HonamiStoryScoreRewardById_1 = require("./HonamiStoryScoreRewardById");
const HonamiStoryTalentByActivityId_1 = require("./HonamiStoryTalentByActivityId");
const HonamiStoryTalentById_1 = require("./HonamiStoryTalentById");
const HonamiStoryWeaponByActivityId_1 = require("./HonamiStoryWeaponByActivityId");
const HonamiStoryWeaponById_1 = require("./HonamiStoryWeaponById");
const HonamiStoryWeaponSuitById_1 = require("./HonamiStoryWeaponSuitById");
const HonamiStoryWeaponSuitByWeaponPluginType_1 = require("./HonamiStoryWeaponSuitByWeaponPluginType");
...
const ImmersiveMouseAll_1 = require("./ImmersiveMouseAll");
const ImmersiveMouseByViewName_1 = require("./ImmersiveMouseByViewName");
...
const InfrActivityTaskAll_1 = require("./InfrActivityTaskAll");
const InfrActivityTaskByTaskId_1 = require("./InfrActivityTaskByTaskId");
const InfrArchiveItemAll_1 = require("./InfrArchiveItemAll");
const InfrArchiveItemById_1 = require("./InfrArchiveItemById");
const InfrArchiveItemQualityById_1 = require("./InfrArchiveItemQualityById");
const InfrArchiveTaskAll_1 = require("./InfrArchiveTaskAll");
const InfrArchiveTaskByTaskId_1 = require("./InfrArchiveTaskByTaskId");
const InfrAutoPilotCircleAll_1 = require("./InfrAutoPilotCircleAll");
const InfrAutoPilotCircleByAutoPilotCirclePathId_1 = require("./InfrAutoPilotCircleByAutoPilotCirclePathId");
const InfrAutoPilotCircleByMapId_1 = require("./InfrAutoPilotCircleByMapId");
const InfrItemQualityById_1 = require("./InfrItemQualityById");
const InfrLevelAll_1 = require("./InfrLevelAll");
const InfrLevelByLevel_1 = require("./InfrLevelByLevel");
const InfrPasserAll_1 = require("./InfrPasserAll");
const InfrPasserById_1 = require("./InfrPasserById");
const InfrPhoneMessageAll_1 = require("./InfrPhoneMessageAll");
const InfrPhoneMessageById_1 = require("./InfrPhoneMessageById");
const InfrPhoneTaskAll_1 = require("./InfrPhoneTaskAll");
const InfrPhoneTaskByTaskId_1 = require("./InfrPhoneTaskByTaskId");
const InfrRoadBuildAll_1 = require("./InfrRoadBuildAll");
const InfrRoadBuildById_1 = require("./InfrRoadBuildById");
const InfrRoadBuildByMarkId_1 = require("./InfrRoadBuildByMarkId");
const InstEntityTeleporterById_1 = require("./InstEntityTeleporterById");
...
const InstanceRandomPlotAll_1 = require("./InstanceRandomPlotAll");
...
const JokerDeckAll_1 = require("./JokerDeckAll");
const JokerDeckById_1 = require("./JokerDeckById");
const JokerSkillById_1 = require("./JokerSkillById");
...
const KeyExclusiveTypeById_1 = require("./KeyExclusiveTypeById");
...
const KujiActivityByActivityId_1 = require("./KujiActivityByActivityId");
const KujiAwardsGroupAll_1 = require("./KujiAwardsGroupAll");
const KujiAwardsGroupById_1 = require("./KujiAwardsGroupById");
const KujiAwardsGroupByKujiId_1 = require("./KujiAwardsGroupByKujiId");
const KujiQuestAll_1 = require("./KujiQuestAll");
const KujiQuestById_1 = require("./KujiQuestById");
const KujiQuestByKujiId_1 = require("./KujiQuestByKujiId");
...
const LevelEntityForCSharpConfigByMapIdAndEntityId_1 = require("./LevelEntityForCSharpConfigByMapIdAndEntityId");
...
const LinkPreloadById_1 = require("./LinkPreloadById");
...
const LongShanUiConfigById_1 = require("./LongShanUiConfigById");
...
const MapBlockInfoAll_1 = require("./MapBlockInfoAll");
const MapBlockInfoById_1 = require("./MapBlockInfoById");
const MapBlockInfoByMapId_1 = require("./MapBlockInfoByMapId");
...
const MapPeriodicActivityAll_1 = require("./MapPeriodicActivityAll");
const MapPeriodicActivityById_1 = require("./MapPeriodicActivityById");
const MapRangeAll_1 = require("./MapRangeAll");
const MapRangeByMapId_1 = require("./MapRangeByMapId");
const MapRoadWaysByMapId_1 = require("./MapRoadWaysByMapId");
...
const MotorAttrAll_1 = require("./MotorAttrAll");
const MotorAttrById_1 = require("./MotorAttrById");
const MotorComponentGroupById_1 = require("./MotorComponentGroupById");
const MotorDecorationsById_1 = require("./MotorDecorationsById");
const MotorDecorationsPartById_1 = require("./MotorDecorationsPartById");
const MotorDevelopActivityByActivityId_1 = require("./MotorDevelopActivityByActivityId");
const MotorDevelopTaskByTaskId_1 = require("./MotorDevelopTaskByTaskId");
const MotorEffectById_1 = require("./MotorEffectById");
const MotorFightActivityByActivityId_1 = require("./MotorFightActivityByActivityId");
const MotorFightActivityById_1 = require("./MotorFightActivityById");
const MotorFightAttrAll_1 = require("./MotorFightAttrAll");
const MotorFightAttrShowAll_1 = require("./MotorFightAttrShowAll");
const MotorFightAttrShowById_1 = require("./MotorFightAttrShowById");
const MotorFightBossRefreshById_1 = require("./MotorFightBossRefreshById");
const MotorFightBuffEffectById_1 = require("./MotorFightBuffEffectById");
const MotorFightBuffGateById_1 = require("./MotorFightBuffGateById");
const MotorFightBuffGateRefreshById_1 = require("./MotorFightBuffGateRefreshById");
const MotorFightItemByActivityId_1 = require("./MotorFightItemByActivityId");
const MotorFightItemById_1 = require("./MotorFightItemById");
const MotorFightItemTypeAll_1 = require("./MotorFightItemTypeAll");
const MotorFightItemTypeById_1 = require("./MotorFightItemTypeById");
const MotorFightLevelByActivityId_1 = require("./MotorFightLevelByActivityId");
const MotorFightLevelById_1 = require("./MotorFightLevelById");
const MotorFightLevelTypeById_1 = require("./MotorFightLevelTypeById");
const MotorFightMainLevelByInstId_1 = require("./MotorFightMainLevelByInstId");
const MotorFightMainLevelByLevelId_1 = require("./MotorFightMainLevelByLevelId");
const MotorFightMonsterRefreshById_1 = require("./MotorFightMonsterRefreshById");
const MotorFightQualityById_1 = require("./MotorFightQualityById");
const MotorFightRankAll_1 = require("./MotorFightRankAll");
const MotorFightRankById_1 = require("./MotorFightRankById");
const MotorFightRoleByActivityId_1 = require("./MotorFightRoleByActivityId");
const MotorFightRoleById_1 = require("./MotorFightRoleById");
const MotorFightSubLevelBySubLevelId_1 = require("./MotorFightSubLevelBySubLevelId");
const MotorFightTalentByActivityId_1 = require("./MotorFightTalentByActivityId");
const MotorFightTalentById_1 = require("./MotorFightTalentById");
const MotorFightTaskByActivityId_1 = require("./MotorFightTaskByActivityId");
const MotorFightTaskById_1 = require("./MotorFightTaskById");
const MotorFightTaskTabByActivityId_1 = require("./MotorFightTaskTabByActivityId");
const MotorFightTaskTabById_1 = require("./MotorFightTaskTabById");
const MotorFightWaveByWaveId_1 = require("./MotorFightWaveByWaveId");
const MotorFightWaveGroupById_1 = require("./MotorFightWaveGroupById");
const MotorFrameById_1 = require("./MotorFrameById");
const MotorFramePartById_1 = require("./MotorFramePartById");
const MotorGeneralPreviewById_1 = require("./MotorGeneralPreviewById");
const MotorGiftQualityByQualityId_1 = require("./MotorGiftQualityByQualityId");
const MotorLevelHintAll_1 = require("./MotorLevelHintAll");
const MotorLevelHintById_1 = require("./MotorLevelHintById");
const MotorLinkageIpAll_1 = require("./MotorLinkageIpAll");
const MotorLinkageIpById_1 = require("./MotorLinkageIpById");
const MotorLinkageQuestAll_1 = require("./MotorLinkageQuestAll");
const MotorLinkageQuestByIp_1 = require("./MotorLinkageQuestByIp");
const MotorLinkageQuestByQuestId_1 = require("./MotorLinkageQuestByQuestId");
const MotorLoadProjectAll_1 = require("./MotorLoadProjectAll");
const MotorLoadProjectById_1 = require("./MotorLoadProjectById");
const MotorLvlAll_1 = require("./MotorLvlAll");
const MotorLvlByLevel_1 = require("./MotorLvlByLevel");
const MotorMonsterById_1 = require("./MotorMonsterById");
const MotorParkourAll_1 = require("./MotorParkourAll");
const MotorParkourByActivityId_1 = require("./MotorParkourByActivityId");
const MotorParkourById_1 = require("./MotorParkourById");
const MotorParkourByInstId_1 = require("./MotorParkourByInstId");
const MotorParkourNPCById_1 = require("./MotorParkourNPCById");
const MotorParkourRankById_1 = require("./MotorParkourRankById");
const MotorParkourRecordAll_1 = require("./MotorParkourRecordAll");
const MotorParkourRecordById_1 = require("./MotorParkourRecordById");
const MotorParkourRewardById_1 = require("./MotorParkourRewardById");
const MotorQualityByQualityId_1 = require("./MotorQualityByQualityId");
const MotorRoleCategoryAll_1 = require("./MotorRoleCategoryAll");
const MotorRoleCategoryById_1 = require("./MotorRoleCategoryById");
const MotorSkinById_1 = require("./MotorSkinById");
const MotorSkinShowById_1 = require("./MotorSkinShowById");
const MotorStickerById_1 = require("./MotorStickerById");
const MotorStickerPartById_1 = require("./MotorStickerPartById");
const MotorTaskById_1 = require("./MotorTaskById");
const MotorTaskByTreeType_1 = require("./MotorTaskByTreeType");
const MotorTechById_1 = require("./MotorTechById");
const MotorTechByTreeType_1 = require("./MotorTechByTreeType");
const MotorTechLvById_1 = require("./MotorTechLvById");
const MotorTechTagById_1 = require("./MotorTechTagById");
const MotorTechTreeAll_1 = require("./MotorTechTreeAll");
const MotorTechTreeById_1 = require("./MotorTechTreeById");
const MotorcycleChallengeAll_1 = require("./MotorcycleChallengeAll");
const MotorcycleChallengeById_1 = require("./MotorcycleChallengeById");
...
const MultiPlatformGuideStepById_1 = require("./MultiPlatformGuideStepById");
const MultiTextLang_1 = require("./MultiTextLang");
const MusicBeatTypeByBeatType_1 = require("./MusicBeatTypeByBeatType");
const MusicSubTitleBySubtitleGroupTag_1 = require("./MusicSubTitleBySubtitleGroupTag");
...
const NewPlayerSupportTaskAll_1 = require("./NewPlayerSupportTaskAll");
const NewPlayerSupportTaskById_1 = require("./NewPlayerSupportTaskById");
const NewTowerBuffById_1 = require("./NewTowerBuffById");
const NewTowerLevelByCycleId_1 = require("./NewTowerLevelByCycleId");
const NewTowerLevelById_1 = require("./NewTowerLevelById");
const NewTowerParamByCycleId_1 = require("./NewTowerParamByCycleId");
const NewTowerRoleAll_1 = require("./NewTowerRoleAll");
const NewTowerRoleById_1 = require("./NewTowerRoleById");
const NewTowerScoreRewardById_1 = require("./NewTowerScoreRewardById");
const NewTowerScoreRewardByLevelId_1 = require("./NewTowerScoreRewardByLevelId");
const NewTowerTagById_1 = require("./NewTowerTagById");
const NewTowerWaveById_1 = require("./NewTowerWaveById");
const NewTowerWaveByLevel_1 = require("./NewTowerWaveByLevel");
...
const NodeUnlockDefaultById_1 = require("./NodeUnlockDefaultById");
...
const NpcGroupPerformConfigById_1 = require("./NpcGroupPerformConfigById");
const NpcGroupPerformConfigByRoleIdAndNpcPerformMark_1 = require("./NpcGroupPerformConfigByRoleIdAndNpcPerformMark");
const NpcGroupPerformConfigByRoleIdAndNpcPerformType_1 = require("./NpcGroupPerformConfigByRoleIdAndNpcPerformType");
...
const ObservatoryAll_1 = require("./ObservatoryAll");
const ObservatoryByAreaId_1 = require("./ObservatoryByAreaId");
const ObservatoryById_1 = require("./ObservatoryById");
...
const PerformanceLimitByViewName_1 = require("./PerformanceLimitByViewName");
...
const PhantomBattleCardEffectById_1 = require("./PhantomBattleCardEffectById");
...
const PhantomBattleCardRoleByActivityId_1 = require("./PhantomBattleCardRoleByActivityId");
...
const PhantomBattleChallengeByMapId_1 = require("./PhantomBattleChallengeByMapId");
const PhantomBattleChallengeByMarkId_1 = require("./PhantomBattleChallengeByMarkId");
...
const PhantomBattleMapParamAll_1 = require("./PhantomBattleMapParamAll");
const PhantomBattleMapParamById_1 = require("./PhantomBattleMapParamById");
const PhantomBattleMapParamByMapId_1 = require("./PhantomBattleMapParamByMapId");
const PhantomBattleMapParamByMapIdNew_1 = require("./PhantomBattleMapParamByMapIdNew");
...
const PhantomDirectRefiningAll_1 = require("./PhantomDirectRefiningAll");
const PhantomDirectRefiningById_1 = require("./PhantomDirectRefiningById");
...
const PhantomItemByParentMonsterId_1 = require("./PhantomItemByParentMonsterId");
...
const PhantomVicePolishConfigAll_1 = require("./PhantomVicePolishConfigAll");
const PhantomVicePolishConfigByPropCount_1 = require("./PhantomVicePolishConfigByPropCount");
...
const PhoneMessageAttachmentById_1 = require("./PhoneMessageAttachmentById");
...
const PhotoFightActivityAll_1 = require("./PhotoFightActivityAll");
const PhotoFightActivityById_1 = require("./PhotoFightActivityById");
const PhotoFightActivityByInstId_1 = require("./PhotoFightActivityByInstId");
const PhotoFightActivityGroupAll_1 = require("./PhotoFightActivityGroupAll");
const PhotoFightActivityGroupByActivityId_1 = require("./PhotoFightActivityGroupByActivityId");
const PhotoFightRewardAll_1 = require("./PhotoFightRewardAll");
const PhotoFightRewardByActivityId_1 = require("./PhotoFightRewardByActivityId");
const PhotoFightRewardTabAll_1 = require("./PhotoFightRewardTabAll");
const PhotoFightRewardTabByActivityId_1 = require("./PhotoFightRewardTabByActivityId");
...
const PhotoMontageByRoleIdAndSort_1 = require("./PhotoMontageByRoleIdAndSort");
const PhotoMontageBySkinIdAndMainAnimInstanceType_1 = require("./PhotoMontageBySkinIdAndMainAnimInstanceType");
...
const PlayStationStaticActivityAll_1 = require("./PlayStationStaticActivityAll");
const PlayerExpAll_1 = require("./PlayerExpAll");
...
const PlotReferenceById_1 = require("./PlotReferenceById");
...
const PreHeatTaskActivityById_1 = require("./PreHeatTaskActivityById");
...
const PrefabForCSharpConfigById_1 = require("./PrefabForCSharpConfigById");
...
const PsFeedbackAll_1 = require("./PsFeedbackAll");
...
const QuestRefMapBlockConfigAll_1 = require("./QuestRefMapBlockConfigAll");
const QuestRefMapBlockConfigByQuestId_1 = require("./QuestRefMapBlockConfigByQuestId");
const QuestRefVideoConfigAll_1 = require("./QuestRefVideoConfigAll");
const QuestResourceWhiteAll_1 = require("./QuestResourceWhiteAll");
...
const QuestTreeChapterAll_1 = require("./QuestTreeChapterAll");
const QuestTreeChapterById_1 = require("./QuestTreeChapterById");
const QuestTreeCustomJumpConfigAll_1 = require("./QuestTreeCustomJumpConfigAll");
const QuestTreeCustomJumpConfigByQuestIdAndType_1 = require("./QuestTreeCustomJumpConfigByQuestIdAndType");
const QuestTreeNodeByChapterId_1 = require("./QuestTreeNodeByChapterId");
const QuestTreeNodeById_1 = require("./QuestTreeNodeById");
const QuestTreeNodeUnlockById_1 = require("./QuestTreeNodeUnlockById");
...
const RandomPlotById_1 = require("./RandomPlotById");
const RandomPlotTriggerByTriggerGroupId_1 = require("./RandomPlotTriggerByTriggerGroupId");
const RecommendPackAll_1 = require("./RecommendPackAll");
...
const RegressDisposableRewardById_1 = require("./RegressDisposableRewardById");
...
const RegressRecommendAll_1 = require("./RegressRecommendAll");
const RegressRecommendByActivityGroup_1 = require("./RegressRecommendByActivityGroup");
const RegressRecommendById_1 = require("./RegressRecommendById");
const RegressRecommendByType_1 = require("./RegressRecommendByType");
...
const RegressTrialRoleAll_1 = require("./RegressTrialRoleAll");
const RegressTrialRoleByActivityId_1 = require("./RegressTrialRoleByActivityId");
const RegressTrialRoleById_1 = require("./RegressTrialRoleById");
...
const RoadBookAreaByActivityId_1 = require("./RoadBookAreaByActivityId");
const RoadBookAreaById_1 = require("./RoadBookAreaById");
const RoadBookConfigByActivityId_1 = require("./RoadBookConfigByActivityId");
const RoadBookLevelExpByActivityId_1 = require("./RoadBookLevelExpByActivityId");
const RoadBookLevelExpById_1 = require("./RoadBookLevelExpById");
const RoadBookPhantomGainByActivityId_1 = require("./RoadBookPhantomGainByActivityId");
const RoadBookPhantomGainById_1 = require("./RoadBookPhantomGainById");
const RoadBookTaskByActivityId_1 = require("./RoadBookTaskByActivityId");
const RoadBookTaskByTaskId_1 = require("./RoadBookTaskByTaskId");
const RoadZoneConfigAll_1 = require("./RoadZoneConfigAll");
const RoadZoneConfigByMapId_1 = require("./RoadZoneConfigByMapId");
...
const RogueWeeklyBFAll_1 = require("./RogueWeeklyBFAll");
const RogueWeeklyBFById_1 = require("./RogueWeeklyBFById");
...
const RoleBeHitMapAll_1 = require("./RoleBeHitMapAll");
const RoleBeHitMapById_1 = require("./RoleBeHitMapById");
const RoleBirthdayAll_1 = require("./RoleBirthdayAll");
const RoleBirthdayById_1 = require("./RoleBirthdayById");
const RoleBodyById_1 = require("./RoleBodyById");
...
const RoleDevCulProjectConfigAll_1 = require("./RoleDevCulProjectConfigAll");
const RoleDevCulProjectConfigById_1 = require("./RoleDevCulProjectConfigById");
const RoleDevCultivateProjectAll_1 = require("./RoleDevCultivateProjectAll");
const RoleDevCultivateProjectByProjectProjectId_1 = require("./RoleDevCultivateProjectByProjectProjectId");
const RoleDevItemJumpGroupAll_1 = require("./RoleDevItemJumpGroupAll");
const RoleDevItemJumpGroupByItemId_1 = require("./RoleDevItemJumpGroupByItemId");
const RoleDevLevelLimitAll_1 = require("./RoleDevLevelLimitAll");
const RoleDevLevelLimitByProjectNum_1 = require("./RoleDevLevelLimitByProjectNum");
const RoleDevPhantomJumpGroupAll_1 = require("./RoleDevPhantomJumpGroupAll");
const RoleDevPhantomJumpGroupByPhantomId_1 = require("./RoleDevPhantomJumpGroupByPhantomId");
const RoleDevProjectAll_1 = require("./RoleDevProjectAll");
const RoleDevProjectByRoleId_1 = require("./RoleDevProjectByRoleId");
const RoleDevProsRoleItemAll_1 = require("./RoleDevProsRoleItemAll");
const RoleDevProsRoleItemByItemGroupId_1 = require("./RoleDevProsRoleItemByItemGroupId");
const RoleDevTypeManageAll_1 = require("./RoleDevTypeManageAll");
const RoleDevTypeManageByItemType_1 = require("./RoleDevTypeManageByItemType");
const RoleDevWeaponItemAll_1 = require("./RoleDevWeaponItemAll");
const RoleDevWeaponItemByWeaponType_1 = require("./RoleDevWeaponItemByWeaponType");
const RoleDevWeaponJumpGroupAll_1 = require("./RoleDevWeaponJumpGroupAll");
const RoleDevWeaponJumpGroupByWeaponId_1 = require("./RoleDevWeaponJumpGroupByWeaponId");
...
const RoleSkillFightTrickById_1 = require("./RoleSkillFightTrickById");
const RoleSkillFightTrickByRoleId_1 = require("./RoleSkillFightTrickByRoleId");
const RoleSkillInputById_1 = require("./RoleSkillInputById");
const RoleSkinAll_1 = require("./RoleSkinAll");
const RoleSkinByGroupId_1 = require("./RoleSkinByGroupId");
...
const ShortMessageByAll_1 = require("./ShortMessageByAll");
const ShortMessageById_1 = require("./ShortMessageById");
...
const SkillBranchAll_1 = require("./SkillBranchAll");
const SkillBranchById_1 = require("./SkillBranchById");
...
const SkillVehicleButtonByTemplateId_1 = require("./SkillVehicleButtonByTemplateId");
const SkinRewardActivityRewardByActivityId_1 = require("./SkinRewardActivityRewardByActivityId");
...
const SpringFestivalAll_1 = require("./SpringFestivalAll");
const SpringFestivalByActivityId_1 = require("./SpringFestivalByActivityId");
const SpringFestivalAreaByActivityId_1 = require("./SpringFestivalAreaByActivityId");
const SpringFestivalAreaByAll_1 = require("./SpringFestivalAreaByAll");
const SpringFestivalAreaByFloor_1 = require("./SpringFestivalAreaByFloor");
const SpringFestivalAreaById_1 = require("./SpringFestivalAreaById");
const SpringFestivalAreaCameraById_1 = require("./SpringFestivalAreaCameraById");
const SpringFestivalMainTaskAll_1 = require("./SpringFestivalMainTaskAll");
const SpringFestivalMainTaskById_1 = require("./SpringFestivalMainTaskById");
const SpringFestivalMainTaskByQuestId_1 = require("./SpringFestivalMainTaskByQuestId");
const SpringFestivalRewardByActivityId_1 = require("./SpringFestivalRewardByActivityId");
const SpringFestivalRewardById_1 = require("./SpringFestivalRewardById");
const SpringFestivalRewardTabByActivityId_1 = require("./SpringFestivalRewardTabByActivityId");
const SpringFestivalRewardTabById_1 = require("./SpringFestivalRewardTabById");
const SpringFestivalScoreRewardByActivityId_1 = require("./SpringFestivalScoreRewardByActivityId");
const SpringFestivalScoreRewardById_1 = require("./SpringFestivalScoreRewardById");
const SpringFestivalSkipEntryByActivityId_1 = require("./SpringFestivalSkipEntryByActivityId");
const SpringFestivalSkipEntryById_1 = require("./SpringFestivalSkipEntryById");
const SpringFestivalSubTaskAll_1 = require("./SpringFestivalSubTaskAll");
const SpringFestivalSubTaskById_1 = require("./SpringFestivalSubTaskById");
const SpringFestivalSubTaskByQuestId_1 = require("./SpringFestivalSubTaskByQuestId");
const SpringFestivalUnlockById_1 = require("./SpringFestivalUnlockById");
...
const SurvivorsActivityConfigByActivityId_1 = require("./SurvivorsActivityConfigByActivityId");
const SurvivorsActivityConfigById_1 = require("./SurvivorsActivityConfigById");
const SurvivorsComboById_1 = require("./SurvivorsComboById");
const SurvivorsDeathrattleById_1 = require("./SurvivorsDeathrattleById");
const SurvivorsItemByActivityId_1 = require("./SurvivorsItemByActivityId");
const SurvivorsItemById_1 = require("./SurvivorsItemById");
const SurvivorsLevelByActivityId_1 = require("./SurvivorsLevelByActivityId");
const SurvivorsLevelById_1 = require("./SurvivorsLevelById");
const SurvivorsMonsterTypeById_1 = require("./SurvivorsMonsterTypeById");
const SurvivorsMonsterTypeByTemplateId_1 = require("./SurvivorsMonsterTypeByTemplateId");
const SurvivorsPropertyById_1 = require("./SurvivorsPropertyById");
const SurvivorsQualityById_1 = require("./SurvivorsQualityById");
const SurvivorsRoleByActivityId_1 = require("./SurvivorsRoleByActivityId");
const SurvivorsRoleById_1 = require("./SurvivorsRoleById");
const SurvivorsRoleEvolveById_1 = require("./SurvivorsRoleEvolveById");
const SurvivorsRoleLvById_1 = require("./SurvivorsRoleLvById");
const SurvivorsRoleLvByRoleId_1 = require("./SurvivorsRoleLvByRoleId");
const SurvivorsScoreRewardByActivity_1 = require("./SurvivorsScoreRewardByActivity");
const SurvivorsScoreRewardById_1 = require("./SurvivorsScoreRewardById");
const SurvivorsTalentEffectById_1 = require("./SurvivorsTalentEffectById");
const SurvivorsTalentTreeByActivityId_1 = require("./SurvivorsTalentTreeByActivityId");
const SurvivorsTalentTreeById_1 = require("./SurvivorsTalentTreeById");
const SurvivorsTaskByActivityId_1 = require("./SurvivorsTaskByActivityId");
const SurvivorsTaskById_1 = require("./SurvivorsTaskById");
const SurvivorsTemplateAll_1 = require("./SurvivorsTemplateAll");
const SurvivorsTemplateById_1 = require("./SurvivorsTemplateById");
const SurvivorsWaveById_1 = require("./SurvivorsWaveById");
const SurvivorsWaveByLevel_1 = require("./SurvivorsWaveByLevel");
const SurvivorsWeaponByActivityId_1 = require("./SurvivorsWeaponByActivityId");
const SurvivorsWeaponById_1 = require("./SurvivorsWeaponById");
const SurvivorsWeaponEvolveById_1 = require("./SurvivorsWeaponEvolveById");
const SurvivorsWeaponLvById_1 = require("./SurvivorsWeaponLvById");
const SurvivorsWeaponLvByWeaponId_1 = require("./SurvivorsWeaponLvByWeaponId");
...
const SynthesisFormulaByItemId_1 = require("./SynthesisFormulaByItemId");
...
const TeleportInterceptByEntityConfigId_1 = require("./TeleportInterceptByEntityConfigId");
...
const TotalTopUpRewardAll_1 = require("./TotalTopUpRewardAll");
const TotalTopUpRewardById_1 = require("./TotalTopUpRewardById");
const TotalTopUpRoleViewConfigByItemId_1 = require("./TotalTopUpRoleViewConfigByItemId");
const TotalTopUpViewConfigByActivityId_1 = require("./TotalTopUpViewConfigByActivityId");
...
const TransitionPopupById_1 = require("./TransitionPopupById");
...
const TrialMotorById_1 = require("./TrialMotorById");
...
const TrialRoleInfoByType_1 = require("./TrialRoleInfoByType");
...
const VehicleRidingRolesById_1 = require("./VehicleRidingRolesById");
const VehicleTeamById_1 = require("./VehicleTeamById");
const VideoCaptionByCgName_1 = require("./VideoCaptionByCgName");
const VideoDataByBelongBranch_1 = require("./VideoDataByBelongBranch");
...
const WeatherSwitchAll_1 = require("./WeatherSwitchAll");
const WeatherSwitchById_1 = require("./WeatherSwitchById");
const WeekCardAll_1 = require("./WeekCardAll");
const WeekCardById_1 = require("./WeekCardById");
const WeekCardByPayGiftId_1 = require("./WeekCardByPayGiftId");
...
class ConfigStatement {
  static Init() {
    ...
    ActivityFilterAll_1.configActivityFilterAll.Init();
    ActivityFilterById_1.configActivityFilterById.Init();
    ActivityGamePlayPlotById_1.configActivityGamePlayPlotById.Init();
    ...
    ActivityPermanentFilterAll_1.configActivityPermanentFilterAll.Init();
    ActivityPermanentFilterById_1.configActivityPermanentFilterById.Init();
    ...
    ActivityTimeShowById_1.configActivityTimeShowById.Init();
    ActivityTitleTagsById_1.configActivityTitleTagsById.Init();
    ...
    AdvertisingPageInfoAll_1.configAdvertisingPageInfoAll.Init();
    AdvertisingPageInfoByActivityId_1.configAdvertisingPageInfoByActivityId.Init();
    AdvertisingPageInfoById_1.configAdvertisingPageInfoById.Init();
    AdvertisingTabActivityAll_1.configAdvertisingTabActivityAll.Init();
    AdvertisingTabActivityById_1.configAdvertisingTabActivityById.Init();
    AdvertisingTabCharacterAll_1.configAdvertisingTabCharacterAll.Init();
    AdvertisingTabCharacterById_1.configAdvertisingTabCharacterById.Init();
    AdvertisingTabCostumeAll_1.configAdvertisingTabCostumeAll.Init();
    AdvertisingTabCostumeById_1.configAdvertisingTabCostumeById.Init();
    AdvertisingTabEnemyAll_1.configAdvertisingTabEnemyAll.Init();
    AdvertisingTabEnemyById_1.configAdvertisingTabEnemyById.Init();
    AdvertisingTabInfoAll_1.configAdvertisingTabInfoAll.Init();
    AdvertisingTabInfoById_1.configAdvertisingTabInfoById.Init();
    AdvertisingTabRegionAll_1.configAdvertisingTabRegionAll.Init();
    AdvertisingTabRegionById_1.configAdvertisingTabRegionById.Init();
    AdvertisingTabStoryAll_1.configAdvertisingTabStoryAll.Init();
    AdvertisingTabStoryById_1.configAdvertisingTabStoryById.Init();
    AdvertisingTabSystemAll_1.configAdvertisingTabSystemAll.Init();
    AdvertisingTabSystemById_1.configAdvertisingTabSystemById.Init();
    AdvertisingUrlConfigById_1.configAdvertisingUrlConfigById.Init();
    ...
    AnimalStandbyMontageByBp_1.configAnimalStandbyMontageByBp.Init();
    AnsPerformById_1.configAnsPerformById.Init();
    AreaAll_1.configAreaAll.Init();
    ...
    AreaMapGroupAll_1.configAreaMapGroupAll.Init();
    AreaMapGroupById_1.configAreaMapGroupById.Init();
    ...
    AreaTerminalAll_1.configAreaTerminalAll.Init();
    AreaTerminalByCountry_1.configAreaTerminalByCountry.Init();
    AreaTerminalById_1.configAreaTerminalById.Init();
    AreaTerminalGroupById_1.configAreaTerminalGroupById.Init();
    ArtemisByActivityId_1.configArtemisByActivityId.Init();
    ArtemisByDay_1.configArtemisByDay.Init();
    ArtemisChatById_1.configArtemisChatById.Init();
    ArtemisQteById_1.configArtemisQteById.Init();
    AtmosphereLevelAll_1.configAtmosphereLevelAll.Init();
    AtmosphereLevelByActivityId_1.configAtmosphereLevelByActivityId.Init();
    AtmosphereLevelByActivityIdAndLevel_1.configAtmosphereLevelByActivityIdAndLevel.Init();
    AtmosphereLevelById_1.configAtmosphereLevelById.Init();
    AudioById_1.configAudioById.Init();
    AutoPilotCirclesById_1.configAutoPilotCirclesById.Init();
    ...
    BehaviorCommonButtonAll_1.configBehaviorCommonButtonAll.Init();
    BehaviorCommonButtonById_1.configBehaviorCommonButtonById.Init();
    BirthDayByItemId_1.configBirthDayByItemId.Init();
    BirthDayByMsgId_1.configBirthDayByMsgId.Init();
    BirthDayByYear_1.configBirthDayByYear.Init();
    BirthDayTextByDateAndType_1.configBirthDayTextByDateAndType.Init();
    ...
    BookItemById_1.configBookItemById.Init();
    ...
    BrochureByActivityIdAndType_1.configBrochureByActivityIdAndType.Init();
    BrochureById_1.configBrochureById.Init();
    ...
    CalabashDevelopRewardByInteractAreaId_1.configCalabashDevelopRewardByInteractAreaId.Init();
    ...
    CalabashMeshById_1.configCalabashMeshById.Init();
    CalabashMeshByMeshId_1.configCalabashMeshByMeshId.Init();
    CalabashSkinAll_1.configCalabashSkinAll.Init();
    CalabashSkinById_1.configCalabashSkinById.Init();
    ...
    ChatBgAll_1.configChatBgAll.Init();
    ChatBgById_1.configChatBgById.Init();
    ChatDialogAll_1.configChatDialogAll.Init();
    ChatDialogById_1.configChatDialogById.Init();
    ...
    ChatPartnerById_1.configChatPartnerById.Init();
    ...
    CommonTouchUiEditByPanelResId_1.configCommonTouchUiEditByPanelResId.Init();
    CommonTouchUiEditGroupById_1.configCommonTouchUiEditGroupById.Init();
    ...
    ConnectBlockWhiteAll_1.configConnectBlockWhiteAll.Init();
    ...
    DamageTextAreaAll_1.configDamageTextAreaAll.Init();
    DamageTextAreaById_1.configDamageTextAreaById.Init();
    ...
    DetectionTitlePanelById_1.configDetectionTitlePanelById.Init();
    DeviceInfoAll_1.configDeviceInfoAll.Init();
    ...
    DownLoadSubPackageAll_1.configDownLoadSubPackageAll.Init();
    DownLoadSubPackageById_1.configDownLoadSubPackageById.Init();
    DownLoadSubPackageByVersion_1.configDownLoadSubPackageByVersion.Init();
    DownLoadTabAll_1.configDownLoadTabAll.Init();
    DownLoadTabById_1.configDownLoadTabById.Init();
    DownLoadVersionByType_1.configDownLoadVersionByType.Init();
    DownLoadVersionByVersion_1.configDownLoadVersionByVersion.Init();
    DragonPoolAll_1.configDragonPoolAll.Init();
    DragonPoolByCoreId_1.configDragonPoolByCoreId.Init();
    ...
    DrinksBatchingAll_1.configDrinksBatchingAll.Init();
    DrinksBatchingById_1.configDrinksBatchingById.Init();
    DrinksDialogById_1.configDrinksDialogById.Init();
    DrinksDrinkBaseAll_1.configDrinksDrinkBaseAll.Init();
    DrinksDrinkBaseById_1.configDrinksDrinkBaseById.Init();
    DrinksDrinkMixAll_1.configDrinksDrinkMixAll.Init();
    DrinksDrinkMixById_1.configDrinksDrinkMixById.Init();
    DrinksFlavorRangeByGroupId_1.configDrinksFlavorRangeByGroupId.Init();
    DrinksFlavorRangeById_1.configDrinksFlavorRangeById.Init();
    DrinksFlavorTypeById_1.configDrinksFlavorTypeById.Init();
    DrinksOrnamentAll_1.configDrinksOrnamentAll.Init();
    DrinksOrnamentById_1.configDrinksOrnamentById.Init();
    DrinksParamById_1.configDrinksParamById.Init();
    DrinksRequireListById_1.configDrinksRequireListById.Init();
    DrinksRequireListByRoleId_1.configDrinksRequireListByRoleId.Init();
    DrinksRoleInviteAll_1.configDrinksRoleInviteAll.Init();
    DrinksRoleInviteById_1.configDrinksRoleInviteById.Init();
    DrinksRoleLikeDrinkById_1.configDrinksRoleLikeDrinkById.Init();
    DrinksStepConfigById_1.configDrinksStepConfigById.Init();
    ...
    EffectSaveByEffectId_1.configEffectSaveByEffectId.Init();
    EffectSaveByEffectPath_1.configEffectSaveByEffectPath.Init();
    ...
    EncircleChallengeById_1.configEncircleChallengeById.Init();
    EncircleChallengeGroupByActivityId_1.configEncircleChallengeGroupByActivityId.Init();
    EncircleChallengeGroupByDay_1.configEncircleChallengeGroupByDay.Init();
    EncircleChallengeGroupById_1.configEncircleChallengeGroupById.Init();
    EncircleMapByMapId_1.configEncircleMapByMapId.Init();
    EncircleMapItemById_1.configEncircleMapItemById.Init();
    ...
    ExhibitPhantomByBodyType_1.configExhibitPhantomByBodyType.Init();
    ExhibitPhantomById_1.configExhibitPhantomById.Init();
    ExhibitWeaponTransformById_1.configExhibitWeaponTransformById.Init();
    ...
    ExploreRouletteTypeAll_1.configExploreRouletteTypeAll.Init();
    ExploreRouletteTypeById_1.configExploreRouletteTypeById.Init();
    ...
    FightPhotoOptionAll_1.configFightPhotoOptionAll.Init();
    FightPhotoOptionById_1.configFightPhotoOptionById.Init();
    FilterById_1.configFilterById.Init();
    FilterRuleById_1.configFilterRuleById.Init();
    FilterSeniorSettingAll_1.configFilterSeniorSettingAll.Init();
    FilterSeniorSettingById_1.configFilterSeniorSettingById.Init();
    ...
    FindSunSpiritById_1.configFindSunSpiritById.Init();
    ...
    FuncMenuReplaceId_1.configFuncMenuReplaceId.Init();
    ...
    FurnitureAll_1.configFurnitureAll.Init();
    FurnitureByActivityId_1.configFurnitureByActivityId.Init();
    FurnitureById_1.configFurnitureById.Init();
    FurnitureBySourceTypeAndGetWayId_1.configFurnitureBySourceTypeAndGetWayId.Init();
    FurnitureByTagId_1.configFurnitureByTagId.Init();
    FurnitureDiyTagAll_1.configFurnitureDiyTagAll.Init();
    FurnitureDiyTagById_1.configFurnitureDiyTagById.Init();
    FurnitureFilterConfigAll_1.configFurnitureFilterConfigAll.Init();
    FurnitureFilterConfigById_1.configFurnitureFilterConfigById.Init();
    FurniturePresetConfigByAreaId_1.configFurniturePresetConfigByAreaId.Init();
    FurnitureQualityConfigById_1.configFurnitureQualityConfigById.Init();
    ...
    GachaRoleDevelopInsByDungeonDetection_1.configGachaRoleDevelopInsByDungeonDetection.Init();
    GachaRoleDevelopInsById_1.configGachaRoleDevelopInsById.Init();
    GachaRoleDevelopInsByRoleId_1.configGachaRoleDevelopInsByRoleId.Init();
    ...
    GeographyHandBookByTabType_1.configGeographyHandBookByTabType.Init();
    GeographyHandBookByTabTypeAndType_1.configGeographyHandBookByTabTypeAndType.Init();
    GeographyHandBookByType_1.configGeographyHandBookByType.Init();
    GeographyTabTypeAll_1.configGeographyTabTypeAll.Init();
    GeographyTabTypeById_1.configGeographyTabTypeById.Init();
    ...
    GivebackScoreRewardAll_1.configGivebackScoreRewardAll.Init();
    GivebackScoreRewardById_1.configGivebackScoreRewardById.Init();
    GivebackTaskAll_1.configGivebackTaskAll.Init();
    GivebackTaskByTaskId_1.configGivebackTaskByTaskId.Init();
    ...
    GongduolaPassengerVoiceConfigByRoleIdAndVehicleTriggerType_1.configGongduolaPassengerVoiceConfigByRoleIdAndVehicleTriggerType.Init();
    GuessJokerAIPlotConfigAll_1.configGuessJokerAIPlotConfigAll.Init();
    GuessJokerAIPlotConfigById_1.configGuessJokerAIPlotConfigById.Init();
    GuessJokerAiConfigAll_1.configGuessJokerAiConfigAll.Init();
    GuessJokerAiConfigById_1.configGuessJokerAiConfigById.Init();
    GuessJokerAiConfigByNpcId_1.configGuessJokerAiConfigByNpcId.Init();
    GuessJokerLevelAll_1.configGuessJokerLevelAll.Init();
    GuessJokerLevelById_1.configGuessJokerLevelById.Init();
    GuessJokerParamByKey_1.configGuessJokerParamByKey.Init();
    GuessJokerPlotConfigById_1.configGuessJokerPlotConfigById.Init();
    ...
    H5JumpActivityById_1.configH5JumpActivityById.Init();
    ...
    HiddenQuestWhiteByQuestId_1.configHiddenQuestWhiteByQuestId.Init();
    HomeBtnStyleById_1.configHomeBtnStyleById.Init();
    HonamiSteadyConsumeByCostGroup_1.configHonamiSteadyConsumeByCostGroup.Init();
    HonamiStoryActivityAll_1.configHonamiStoryActivityAll.Init();
    HonamiStoryActivityByActivityId_1.configHonamiStoryActivityByActivityId.Init();
    HonamiStoryAreaByActivityId_1.configHonamiStoryAreaByActivityId.Init();
    HonamiStoryAreaById_1.configHonamiStoryAreaById.Init();
    HonamiStoryAreaTaskByActivityId_1.configHonamiStoryAreaTaskByActivityId.Init();
    HonamiStoryAreaTaskById_1.configHonamiStoryAreaTaskById.Init();
    HonamiStoryBackPackById_1.configHonamiStoryBackPackById.Init();
    HonamiStoryBuffTempById_1.configHonamiStoryBuffTempById.Init();
    HonamiStoryBuffTempLibraryById_1.configHonamiStoryBuffTempLibraryById.Init();
    HonamiStoryDangerLevelById_1.configHonamiStoryDangerLevelById.Init();
    HonamiStoryEffectById_1.configHonamiStoryEffectById.Init();
    HonamiStoryEquipById_1.configHonamiStoryEquipById.Init();
    HonamiStoryItemById_1.configHonamiStoryItemById.Init();
    HonamiStoryItemCollectionByActivityId_1.configHonamiStoryItemCollectionByActivityId.Init();
    HonamiStoryItemCollectionByItemId_1.configHonamiStoryItemCollectionByItemId.Init();
    HonamiStoryItemQualityAll_1.configHonamiStoryItemQualityAll.Init();
    HonamiStoryItemQualityById_1.configHonamiStoryItemQualityById.Init();
    HonamiStoryLifeSupportByActivityId_1.configHonamiStoryLifeSupportByActivityId.Init();
    HonamiStoryLifeSupportById_1.configHonamiStoryLifeSupportById.Init();
    HonamiStoryLimitTaskByActivityId_1.configHonamiStoryLimitTaskByActivityId.Init();
    HonamiStoryLimitTaskById_1.configHonamiStoryLimitTaskById.Init();
    HonamiStoryLoadingPerformByBTId_1.configHonamiStoryLoadingPerformByBTId.Init();
    HonamiStoryLoadingPerformByBTIdAndTiming_1.configHonamiStoryLoadingPerformByBTIdAndTiming.Init();
    HonamiStoryLoadingPerformById_1.configHonamiStoryLoadingPerformById.Init();
    HonamiStoryLoadingPerformByTiming_1.configHonamiStoryLoadingPerformByTiming.Init();
    HonamiStoryMapMarkAll_1.configHonamiStoryMapMarkAll.Init();
    HonamiStoryMapMarkById_1.configHonamiStoryMapMarkById.Init();
    HonamiStoryMarkWhiteListAll_1.configHonamiStoryMarkWhiteListAll.Init();
    HonamiStoryMarkWhiteListById_1.configHonamiStoryMarkWhiteListById.Init();
    HonamiStoryMascotByActivityId_1.configHonamiStoryMascotByActivityId.Init();
    HonamiStoryMascotById_1.configHonamiStoryMascotById.Init();
    HonamiStoryOutDialogByActivityId_1.configHonamiStoryOutDialogByActivityId.Init();
    HonamiStoryOutDialogByActivityIdAndType_1.configHonamiStoryOutDialogByActivityIdAndType.Init();
    HonamiStoryOutDialogById_1.configHonamiStoryOutDialogById.Init();
    HonamiStoryPluginBoxItemByActivityId_1.configHonamiStoryPluginBoxItemByActivityId.Init();
    HonamiStoryPluginBoxItemById_1.configHonamiStoryPluginBoxItemById.Init();
    HonamiStoryPluginSlotById_1.configHonamiStoryPluginSlotById.Init();
    HonamiStoryPluginSubTypeById_1.configHonamiStoryPluginSubTypeById.Init();
    HonamiStoryPluginTagById_1.configHonamiStoryPluginTagById.Init();
    HonamiStoryPollutionByActivityId_1.configHonamiStoryPollutionByActivityId.Init();
    HonamiStoryPollutionStageById_1.configHonamiStoryPollutionStageById.Init();
    HonamiStoryPropById_1.configHonamiStoryPropById.Init();
    HonamiStoryPropLibraryById_1.configHonamiStoryPropLibraryById.Init();
    HonamiStoryResidentTaskByActivityId_1.configHonamiStoryResidentTaskByActivityId.Init();
    HonamiStoryResidentTaskById_1.configHonamiStoryResidentTaskById.Init();
    HonamiStoryScanMachineAll_1.configHonamiStoryScanMachineAll.Init();
    HonamiStoryScanMachineById_1.configHonamiStoryScanMachineById.Init();
    HonamiStoryScoreRewardByActivityId_1.configHonamiStoryScoreRewardByActivityId.Init();
    HonamiStoryScoreRewardById_1.configHonamiStoryScoreRewardById.Init();
    HonamiStoryTalentByActivityId_1.configHonamiStoryTalentByActivityId.Init();
    HonamiStoryTalentById_1.configHonamiStoryTalentById.Init();
    HonamiStoryWeaponByActivityId_1.configHonamiStoryWeaponByActivityId.Init();
    HonamiStoryWeaponById_1.configHonamiStoryWeaponById.Init();
    HonamiStoryWeaponSuitById_1.configHonamiStoryWeaponSuitById.Init();
    HonamiStoryWeaponSuitByWeaponPluginType_1.configHonamiStoryWeaponSuitByWeaponPluginType.Init();
    ...
    ImmersiveMouseAll_1.configImmersiveMouseAll.Init();
    ImmersiveMouseByViewName_1.configImmersiveMouseByViewName.Init();
    ...
    InfrActivityTaskAll_1.configInfrActivityTaskAll.Init();
    InfrActivityTaskByTaskId_1.configInfrActivityTaskByTaskId.Init();
    InfrArchiveItemAll_1.configInfrArchiveItemAll.Init();
    InfrArchiveItemById_1.configInfrArchiveItemById.Init();
    InfrArchiveItemQualityById_1.configInfrArchiveItemQualityById.Init();
    InfrArchiveTaskAll_1.configInfrArchiveTaskAll.Init();
    InfrArchiveTaskByTaskId_1.configInfrArchiveTaskByTaskId.Init();
    InfrAutoPilotCircleAll_1.configInfrAutoPilotCircleAll.Init();
    InfrAutoPilotCircleByAutoPilotCirclePathId_1.configInfrAutoPilotCircleByAutoPilotCirclePathId.Init();
    InfrAutoPilotCircleByMapId_1.configInfrAutoPilotCircleByMapId.Init();
    InfrItemQualityById_1.configInfrItemQualityById.Init();
    InfrLevelAll_1.configInfrLevelAll.Init();
    InfrLevelByLevel_1.configInfrLevelByLevel.Init();
    InfrPasserAll_1.configInfrPasserAll.Init();
    InfrPasserById_1.configInfrPasserById.Init();
    InfrPhoneMessageAll_1.configInfrPhoneMessageAll.Init();
    InfrPhoneMessageById_1.configInfrPhoneMessageById.Init();
    InfrPhoneTaskAll_1.configInfrPhoneTaskAll.Init();
    InfrPhoneTaskByTaskId_1.configInfrPhoneTaskByTaskId.Init();
    InfrRoadBuildAll_1.configInfrRoadBuildAll.Init();
    InfrRoadBuildById_1.configInfrRoadBuildById.Init();
    InfrRoadBuildByMarkId_1.configInfrRoadBuildByMarkId.Init();
    InstEntityTeleporterById_1.configInstEntityTeleporterById.Init();
    ...
    InstanceRandomPlotAll_1.configInstanceRandomPlotAll.Init();
    ...
    JokerDeckAll_1.configJokerDeckAll.Init();
    JokerDeckById_1.configJokerDeckById.Init();
    JokerSkillById_1.configJokerSkillById.Init();
    ...
    KeyExclusiveTypeById_1.configKeyExclusiveTypeById.Init();
    ...
    KujiActivityByActivityId_1.configKujiActivityByActivityId.Init();
    KujiAwardsGroupAll_1.configKujiAwardsGroupAll.Init();
    KujiAwardsGroupById_1.configKujiAwardsGroupById.Init();
    KujiAwardsGroupByKujiId_1.configKujiAwardsGroupByKujiId.Init();
    KujiQuestAll_1.configKujiQuestAll.Init();
    KujiQuestById_1.configKujiQuestById.Init();
    KujiQuestByKujiId_1.configKujiQuestByKujiId.Init();
    ...
    LevelEntityForCSharpConfigByMapIdAndEntityId_1.configLevelEntityForCSharpConfigByMapIdAndEntityId.Init();
    ...
    LinkPreloadById_1.configLinkPreloadById.Init();
    ...
    LongShanUiConfigById_1.configLongShanUiConfigById.Init();
    ...
    MapBlockInfoAll_1.configMapBlockInfoAll.Init();
    MapBlockInfoById_1.configMapBlockInfoById.Init();
    MapBlockInfoByMapId_1.configMapBlockInfoByMapId.Init();
    ...
    MapPeriodicActivityAll_1.configMapPeriodicActivityAll.Init();
    MapPeriodicActivityById_1.configMapPeriodicActivityById.Init();
    MapRangeAll_1.configMapRangeAll.Init();
    MapRangeByMapId_1.configMapRangeByMapId.Init();
    MapRoadWaysByMapId_1.configMapRoadWaysByMapId.Init();
    ...
    MotorAttrAll_1.configMotorAttrAll.Init();
    MotorAttrById_1.configMotorAttrById.Init();
    MotorComponentGroupById_1.configMotorComponentGroupById.Init();
    MotorDecorationsById_1.configMotorDecorationsById.Init();
    MotorDecorationsPartById_1.configMotorDecorationsPartById.Init();
    MotorDevelopActivityByActivityId_1.configMotorDevelopActivityByActivityId.Init();
    MotorDevelopTaskByTaskId_1.configMotorDevelopTaskByTaskId.Init();
    MotorEffectById_1.configMotorEffectById.Init();
    MotorFightActivityByActivityId_1.configMotorFightActivityByActivityId.Init();
    MotorFightActivityById_1.configMotorFightActivityById.Init();
    MotorFightAttrAll_1.configMotorFightAttrAll.Init();
    MotorFightAttrShowAll_1.configMotorFightAttrShowAll.Init();
    MotorFightAttrShowById_1.configMotorFightAttrShowById.Init();
    MotorFightBossRefreshById_1.configMotorFightBossRefreshById.Init();
    MotorFightBuffEffectById_1.configMotorFightBuffEffectById.Init();
    MotorFightBuffGateById_1.configMotorFightBuffGateById.Init();
    MotorFightBuffGateRefreshById_1.configMotorFightBuffGateRefreshById.Init();
    MotorFightItemByActivityId_1.configMotorFightItemByActivityId.Init();
    MotorFightItemById_1.configMotorFightItemById.Init();
    MotorFightItemTypeAll_1.configMotorFightItemTypeAll.Init();
    MotorFightItemTypeById_1.configMotorFightItemTypeById.Init();
    MotorFightLevelByActivityId_1.configMotorFightLevelByActivityId.Init();
    MotorFightLevelById_1.configMotorFightLevelById.Init();
    MotorFightLevelTypeById_1.configMotorFightLevelTypeById.Init();
    MotorFightMainLevelByInstId_1.configMotorFightMainLevelByInstId.Init();
    MotorFightMainLevelByLevelId_1.configMotorFightMainLevelByLevelId.Init();
    MotorFightMonsterRefreshById_1.configMotorFightMonsterRefreshById.Init();
    MotorFightQualityById_1.configMotorFightQualityById.Init();
    MotorFightRankAll_1.configMotorFightRankAll.Init();
    MotorFightRankById_1.configMotorFightRankById.Init();
    MotorFightRoleByActivityId_1.configMotorFightRoleByActivityId.Init();
    MotorFightRoleById_1.configMotorFightRoleById.Init();
    MotorFightSubLevelBySubLevelId_1.configMotorFightSubLevelBySubLevelId.Init();
    MotorFightTalentByActivityId_1.configMotorFightTalentByActivityId.Init();
    MotorFightTalentById_1.configMotorFightTalentById.Init();
    MotorFightTaskByActivityId_1.configMotorFightTaskByActivityId.Init();
    MotorFightTaskById_1.configMotorFightTaskById.Init();
    MotorFightTaskTabByActivityId_1.configMotorFightTaskTabByActivityId.Init();
    MotorFightTaskTabById_1.configMotorFightTaskTabById.Init();
    MotorFightWaveByWaveId_1.configMotorFightWaveByWaveId.Init();
    MotorFightWaveGroupById_1.configMotorFightWaveGroupById.Init();
    MotorFrameById_1.configMotorFrameById.Init();
    MotorFramePartById_1.configMotorFramePartById.Init();
    MotorGeneralPreviewById_1.configMotorGeneralPreviewById.Init();
    MotorGiftQualityByQualityId_1.configMotorGiftQualityByQualityId.Init();
    MotorLevelHintAll_1.configMotorLevelHintAll.Init();
    MotorLevelHintById_1.configMotorLevelHintById.Init();
    MotorLinkageIpAll_1.configMotorLinkageIpAll.Init();
    MotorLinkageIpById_1.configMotorLinkageIpById.Init();
    MotorLinkageQuestAll_1.configMotorLinkageQuestAll.Init();
    MotorLinkageQuestByIp_1.configMotorLinkageQuestByIp.Init();
    MotorLinkageQuestByQuestId_1.configMotorLinkageQuestByQuestId.Init();
    MotorLoadProjectAll_1.configMotorLoadProjectAll.Init();
    MotorLoadProjectById_1.configMotorLoadProjectById.Init();
    MotorLvlAll_1.configMotorLvlAll.Init();
    MotorLvlByLevel_1.configMotorLvlByLevel.Init();
    MotorMonsterById_1.configMotorMonsterById.Init();
    MotorParkourAll_1.configMotorParkourAll.Init();
    MotorParkourByActivityId_1.configMotorParkourByActivityId.Init();
    MotorParkourById_1.configMotorParkourById.Init();
    MotorParkourByInstId_1.configMotorParkourByInstId.Init();
    MotorParkourNPCById_1.configMotorParkourNPCById.Init();
    MotorParkourRankById_1.configMotorParkourRankById.Init();
    MotorParkourRecordAll_1.configMotorParkourRecordAll.Init();
    MotorParkourRecordById_1.configMotorParkourRecordById.Init();
    MotorParkourRewardById_1.configMotorParkourRewardById.Init();
    MotorQualityByQualityId_1.configMotorQualityByQualityId.Init();
    MotorRoleCategoryAll_1.configMotorRoleCategoryAll.Init();
    MotorRoleCategoryById_1.configMotorRoleCategoryById.Init();
    MotorSkinById_1.configMotorSkinById.Init();
    MotorSkinShowById_1.configMotorSkinShowById.Init();
    MotorStickerById_1.configMotorStickerById.Init();
    MotorStickerPartById_1.configMotorStickerPartById.Init();
    MotorTaskById_1.configMotorTaskById.Init();
    MotorTaskByTreeType_1.configMotorTaskByTreeType.Init();
    MotorTechById_1.configMotorTechById.Init();
    MotorTechByTreeType_1.configMotorTechByTreeType.Init();
    MotorTechLvById_1.configMotorTechLvById.Init();
    MotorTechTagById_1.configMotorTechTagById.Init();
    MotorTechTreeAll_1.configMotorTechTreeAll.Init();
    MotorTechTreeById_1.configMotorTechTreeById.Init();
    MotorcycleChallengeAll_1.configMotorcycleChallengeAll.Init();
    MotorcycleChallengeById_1.configMotorcycleChallengeById.Init();
    ...
    MultiPlatformGuideStepById_1.configMultiPlatformGuideStepById.Init();
    MultiTextLang_1.configMultiTextLang.Init();
    MusicBeatTypeByBeatType_1.configMusicBeatTypeByBeatType.Init();
    MusicSubTitleBySubtitleGroupTag_1.configMusicSubTitleBySubtitleGroupTag.Init();
    NewOccupationConfigAll_1.configNewOccupationConfigAll.Init();
    NewOccupationConfigById_1.configNewOccupationConfigById.Init();
    NewPlayerSupportTaskAll_1.configNewPlayerSupportTaskAll.Init();
    NewPlayerSupportTaskById_1.configNewPlayerSupportTaskById.Init();
    NewTowerBuffById_1.configNewTowerBuffById.Init();
    NewTowerLevelByCycleId_1.configNewTowerLevelByCycleId.Init();
    NewTowerLevelById_1.configNewTowerLevelById.Init();
    NewTowerParamByCycleId_1.configNewTowerParamByCycleId.Init();
    NewTowerRoleAll_1.configNewTowerRoleAll.Init();
    NewTowerRoleById_1.configNewTowerRoleById.Init();
    NewTowerScoreRewardById_1.configNewTowerScoreRewardById.Init();
    NewTowerScoreRewardByLevelId_1.configNewTowerScoreRewardByLevelId.Init();
    NewTowerTagById_1.configNewTowerTagById.Init();
    NewTowerWaveById_1.configNewTowerWaveById.Init();
    NewTowerWaveByLevel_1.configNewTowerWaveByLevel.Init();
    ...
    NodeUnlockDefaultById_1.configNodeUnlockDefaultById.Init();
    ...
    NpcGroupPerformConfigById_1.configNpcGroupPerformConfigById.Init();
    NpcGroupPerformConfigByRoleIdAndNpcPerformMark_1.configNpcGroupPerformConfigByRoleIdAndNpcPerformMark.Init();
    NpcGroupPerformConfigByRoleIdAndNpcPerformType_1.configNpcGroupPerformConfigByRoleIdAndNpcPerformType.Init();
    ...
    ObservatoryAll_1.configObservatoryAll.Init();
    ObservatoryByAreaId_1.configObservatoryByAreaId.Init();
    ObservatoryById_1.configObservatoryById.Init();
    ...
    PerformanceLimitByViewName_1.configPerformanceLimitByViewName.Init();
    ...
    PhantomBattleCardEffectById_1.configPhantomBattleCardEffectById.Init();
    ...
    PhantomBattleCardRoleByActivityId_1.configPhantomBattleCardRoleByActivityId.Init();
    ...
    PhantomBattleChallengeByMapId_1.configPhantomBattleChallengeByMapId.Init();
    PhantomBattleChallengeByMarkId_1.configPhantomBattleChallengeByMarkId.Init();
    ...
    PhantomBattleMapParamAll_1.configPhantomBattleMapParamAll.Init();
    PhantomBattleMapParamById_1.configPhantomBattleMapParamById.Init();
    PhantomBattleMapParamByMapId_1.configPhantomBattleMapParamByMapId.Init();
    PhantomBattleMapParamByMapIdNew_1.configPhantomBattleMapParamByMapIdNew.Init();
    ...
    PhantomDirectRefiningAll_1.configPhantomDirectRefiningAll.Init();
    PhantomDirectRefiningById_1.configPhantomDirectRefiningById.Init();
    ...
    PhantomItemByParentMonsterId_1.configPhantomItemByParentMonsterId.Init();
    ...
    PhantomVicePolishConfigAll_1.configPhantomVicePolishConfigAll.Init();
    PhantomVicePolishConfigByPropCount_1.configPhantomVicePolishConfigByPropCount.Init();
    ...
    PhoneMessageAttachmentById_1.configPhoneMessageAttachmentById.Init();
    ...
    PhotoFightActivityAll_1.configPhotoFightActivityAll.Init();
    PhotoFightActivityById_1.configPhotoFightActivityById.Init();
    PhotoFightActivityByInstId_1.configPhotoFightActivityByInstId.Init();
    PhotoFightActivityGroupAll_1.configPhotoFightActivityGroupAll.Init();
    PhotoFightActivityGroupByActivityId_1.configPhotoFightActivityGroupByActivityId.Init();
    PhotoFightRewardAll_1.configPhotoFightRewardAll.Init();
    PhotoFightRewardByActivityId_1.configPhotoFightRewardByActivityId.Init();
    PhotoFightRewardTabAll_1.configPhotoFightRewardTabAll.Init();
    PhotoFightRewardTabByActivityId_1.configPhotoFightRewardTabByActivityId.Init();
    ...
    PhotoMontageByRoleIdAndSort_1.configPhotoMontageByRoleIdAndSort.Init();
    PhotoMontageBySkinIdAndMainAnimInstanceType_1.configPhotoMontageBySkinIdAndMainAnimInstanceType.Init();
    ...
    PlayStationStaticActivityAll_1.configPlayStationStaticActivityAll.Init();
    PlayerExpAll_1.configPlayerExpAll.Init();
    ...
    PrefabForCSharpConfigById_1.configPrefabForCSharpConfigById.Init();
    ...
    PsFeedbackAll_1.configPsFeedbackAll.Init();
    ...
    QuestRefMapBlockConfigAll_1.configQuestRefMapBlockConfigAll.Init();
    QuestRefMapBlockConfigByQuestId_1.configQuestRefMapBlockConfigByQuestId.Init();
    QuestRefVideoConfigAll_1.configQuestRefVideoConfigAll.Init();
    QuestResourceWhiteAll_1.configQuestResourceWhiteAll.Init();
    ...
    QuestTreeChapterAll_1.configQuestTreeChapterAll.Init();
    QuestTreeChapterById_1.configQuestTreeChapterById.Init();
    QuestTreeCustomJumpConfigAll_1.configQuestTreeCustomJumpConfigAll.Init();
    QuestTreeCustomJumpConfigByQuestIdAndType_1.configQuestTreeCustomJumpConfigByQuestIdAndType.Init();
    QuestTreeNodeByChapterId_1.configQuestTreeNodeByChapterId.Init();
    QuestTreeNodeById_1.configQuestTreeNodeById.Init();
    QuestTreeNodeUnlockById_1.configQuestTreeNodeUnlockById.Init();
    ...
    RandomPlotById_1.configRandomPlotById.Init();
    RandomPlotTriggerByTriggerGroupId_1.configRandomPlotTriggerByTriggerGroupId.Init();
    RecommendPackAll_1.configRecommendPackAll.Init();
    ...
    RegressDisposableRewardById_1.configRegressDisposableRewardById.Init();
    ...
    RegressRecommendAll_1.configRegressRecommendAll.Init();
    RegressRecommendByActivityGroup_1.configRegressRecommendByActivityGroup.Init();
    RegressRecommendById_1.configRegressRecommendById.Init();
    RegressRecommendByType_1.configRegressRecommendByType.Init();
    ...
    RegressTrialRoleAll_1.configRegressTrialRoleAll.Init();
    RegressTrialRoleByActivityId_1.configRegressTrialRoleByActivityId.Init();
    RegressTrialRoleById_1.configRegressTrialRoleById.Init();
    ...
    RoadBookAreaByActivityId_1.configRoadBookAreaByActivityId.Init();
    RoadBookAreaById_1.configRoadBookAreaById.Init();
    RoadBookConfigByActivityId_1.configRoadBookConfigByActivityId.Init();
    RoadBookLevelExpByActivityId_1.configRoadBookLevelExpByActivityId.Init();
    RoadBookLevelExpById_1.configRoadBookLevelExpById.Init();
    RoadBookPhantomGainByActivityId_1.configRoadBookPhantomGainByActivityId.Init();
    RoadBookPhantomGainById_1.configRoadBookPhantomGainById.Init();
    RoadBookTaskByActivityId_1.configRoadBookTaskByActivityId.Init();
    RoadBookTaskByTaskId_1.configRoadBookTaskByTaskId.Init();
    RoadZoneConfigAll_1.configRoadZoneConfigAll.Init();
    RoadZoneConfigByMapId_1.configRoadZoneConfigByMapId.Init();
    ...
    RogueWeeklyBFAll_1.configRogueWeeklyBFAll.Init();
    RogueWeeklyBFById_1.configRogueWeeklyBFById.Init();
    ...
    RoleBeHitMapAll_1.configRoleBeHitMapAll.Init();
    RoleBeHitMapById_1.configRoleBeHitMapById.Init();
    RoleBirthdayAll_1.configRoleBirthdayAll.Init();
    RoleBirthdayById_1.configRoleBirthdayById.Init();
    RoleBodyById_1.configRoleBodyById.Init();
    ...
    RoleDevCulProjectConfigAll_1.configRoleDevCulProjectConfigAll.Init();
    RoleDevCulProjectConfigById_1.configRoleDevCulProjectConfigById.Init();
    RoleDevCultivateProjectAll_1.configRoleDevCultivateProjectAll.Init();
    RoleDevCultivateProjectByProjectProjectId_1.configRoleDevCultivateProjectByProjectProjectId.Init();
    RoleDevItemJumpGroupAll_1.configRoleDevItemJumpGroupAll.Init();
    RoleDevItemJumpGroupByItemId_1.configRoleDevItemJumpGroupByItemId.Init();
    RoleDevLevelLimitAll_1.configRoleDevLevelLimitAll.Init();
    RoleDevLevelLimitByProjectNum_1.configRoleDevLevelLimitByProjectNum.Init();
    RoleDevPhantomJumpGroupAll_1.configRoleDevPhantomJumpGroupAll.Init();
    RoleDevPhantomJumpGroupByPhantomId_1.configRoleDevPhantomJumpGroupByPhantomId.Init();
    RoleDevProjectAll_1.configRoleDevProjectAll.Init();
    RoleDevProjectByRoleId_1.configRoleDevProjectByRoleId.Init();
    RoleDevProsRoleItemAll_1.configRoleDevProsRoleItemAll.Init();
    RoleDevProsRoleItemByItemGroupId_1.configRoleDevProsRoleItemByItemGroupId.Init();
    RoleDevTypeManageAll_1.configRoleDevTypeManageAll.Init();
    RoleDevTypeManageByItemType_1.configRoleDevTypeManageByItemType.Init();
    RoleDevWeaponItemAll_1.configRoleDevWeaponItemAll.Init();
    RoleDevWeaponItemByWeaponType_1.configRoleDevWeaponItemByWeaponType.Init();
    RoleDevWeaponJumpGroupAll_1.configRoleDevWeaponJumpGroupAll.Init();
    RoleDevWeaponJumpGroupByWeaponId_1.configRoleDevWeaponJumpGroupByWeaponId.Init();
    ...
    RoleSkillFightTrickById_1.configRoleSkillFightTrickById.Init();
    RoleSkillFightTrickByRoleId_1.configRoleSkillFightTrickByRoleId.Init();
    RoleSkillInputById_1.configRoleSkillInputById.Init();
    RoleSkinAll_1.configRoleSkinAll.Init();
    RoleSkinByGroupId_1.configRoleSkinByGroupId.Init();
    ...
    ShortMessageByAll_1.configShortMessageByAll.Init();
    ShortMessageById_1.configShortMessageById.Init();
    ...
    SkillBranchAll_1.configSkillBranchAll.Init();
    SkillBranchById_1.configSkillBranchById.Init();
    ...
    SkillVehicleButtonByTemplateId_1.configSkillVehicleButtonByTemplateId.Init();
    SkinRewardActivityRewardByActivityId_1.configSkinRewardActivityRewardByActivityId.Init();
    ...
    SpringFestivalAll_1.configSpringFestivalAll.Init();
    SpringFestivalByActivityId_1.configSpringFestivalByActivityId.Init();
    SpringFestivalAreaByActivityId_1.configSpringFestivalAreaByActivityId.Init();
    SpringFestivalAreaByAll_1.configSpringFestivalAreaByAll.Init();
    SpringFestivalAreaByFloor_1.configSpringFestivalAreaByFloor.Init();
    SpringFestivalAreaById_1.configSpringFestivalAreaById.Init();
    SpringFestivalAreaCameraById_1.configSpringFestivalAreaCameraById.Init();
    SpringFestivalMainTaskAll_1.configSpringFestivalMainTaskAll.Init();
    SpringFestivalMainTaskById_1.configSpringFestivalMainTaskById.Init();
    SpringFestivalMainTaskByQuestId_1.configSpringFestivalMainTaskByQuestId.Init();
    SpringFestivalRewardByActivityId_1.configSpringFestivalRewardByActivityId.Init();
    SpringFestivalRewardById_1.configSpringFestivalRewardById.Init();
    SpringFestivalRewardTabByActivityId_1.configSpringFestivalRewardTabByActivityId.Init();
    SpringFestivalRewardTabById_1.configSpringFestivalRewardTabById.Init();
    SpringFestivalScoreRewardByActivityId_1.configSpringFestivalScoreRewardByActivityId.Init();
    SpringFestivalScoreRewardById_1.configSpringFestivalScoreRewardById.Init();
    SpringFestivalSkipEntryByActivityId_1.configSpringFestivalSkipEntryByActivityId.Init();
    SpringFestivalSkipEntryById_1.configSpringFestivalSkipEntryById.Init();
    SpringFestivalSubTaskAll_1.configSpringFestivalSubTaskAll.Init();
    SpringFestivalSubTaskById_1.configSpringFestivalSubTaskById.Init();
    SpringFestivalSubTaskByQuestId_1.configSpringFestivalSubTaskByQuestId.Init();
    SpringFestivalUnlockById_1.configSpringFestivalUnlockById.Init();
    ...
    SurvivorsActivityConfigByActivityId_1.configSurvivorsActivityConfigByActivityId.Init();
    SurvivorsActivityConfigById_1.configSurvivorsActivityConfigById.Init();
    SurvivorsComboById_1.configSurvivorsComboById.Init();
    SurvivorsDeathrattleById_1.configSurvivorsDeathrattleById.Init();
    SurvivorsItemByActivityId_1.configSurvivorsItemByActivityId.Init();
    SurvivorsItemById_1.configSurvivorsItemById.Init();
    SurvivorsLevelByActivityId_1.configSurvivorsLevelByActivityId.Init();
    SurvivorsLevelById_1.configSurvivorsLevelById.Init();
    SurvivorsMonsterTypeById_1.configSurvivorsMonsterTypeById.Init();
    SurvivorsMonsterTypeByTemplateId_1.configSurvivorsMonsterTypeByTemplateId.Init();
    SurvivorsPropertyById_1.configSurvivorsPropertyById.Init();
    SurvivorsQualityById_1.configSurvivorsQualityById.Init();
    SurvivorsRoleByActivityId_1.configSurvivorsRoleByActivityId.Init();
    SurvivorsRoleById_1.configSurvivorsRoleById.Init();
    SurvivorsRoleEvolveById_1.configSurvivorsRoleEvolveById.Init();
    SurvivorsRoleLvById_1.configSurvivorsRoleLvById.Init();
    SurvivorsRoleLvByRoleId_1.configSurvivorsRoleLvByRoleId.Init();
    SurvivorsScoreRewardByActivity_1.configSurvivorsScoreRewardByActivity.Init();
    SurvivorsScoreRewardById_1.configSurvivorsScoreRewardById.Init();
    SurvivorsTalentEffectById_1.configSurvivorsTalentEffectById.Init();
    SurvivorsTalentTreeByActivityId_1.configSurvivorsTalentTreeByActivityId.Init();
    SurvivorsTalentTreeById_1.configSurvivorsTalentTreeById.Init();
    SurvivorsTaskByActivityId_1.configSurvivorsTaskByActivityId.Init();
    SurvivorsTaskById_1.configSurvivorsTaskById.Init();
    SurvivorsTemplateAll_1.configSurvivorsTemplateAll.Init();
    SurvivorsTemplateById_1.configSurvivorsTemplateById.Init();
    SurvivorsWaveById_1.configSurvivorsWaveById.Init();
    SurvivorsWaveByLevel_1.configSurvivorsWaveByLevel.Init();
    SurvivorsWeaponByActivityId_1.configSurvivorsWeaponByActivityId.Init();
    SurvivorsWeaponById_1.configSurvivorsWeaponById.Init();
    SurvivorsWeaponEvolveById_1.configSurvivorsWeaponEvolveById.Init();
    SurvivorsWeaponLvById_1.configSurvivorsWeaponLvById.Init();
    SurvivorsWeaponLvByWeaponId_1.configSurvivorsWeaponLvByWeaponId.Init();
    ...
    SynthesisFormulaByItemId_1.configSynthesisFormulaByItemId.Init();
    ...
    TeleportInterceptByEntityConfigId_1.configTeleportInterceptByEntityConfigId.Init();
    ...
    TotalTopUpRewardAll_1.configTotalTopUpRewardAll.Init();
    TotalTopUpRewardById_1.configTotalTopUpRewardById.Init();
    TotalTopUpRoleViewConfigByItemId_1.configTotalTopUpRoleViewConfigByItemId.Init();
    TotalTopUpViewConfigByActivityId_1.configTotalTopUpViewConfigByActivityId.Init();
    ...
    TransitionPopupById_1.configTransitionPopupById.Init();
    ...
    TrialMotorById_1.configTrialMotorById.Init();
    ...
    TrialRoleInfoByType_1.configTrialRoleInfoByType.Init();
    ...
    VehicleRidingRolesById_1.configVehicleRidingRolesById.Init();
    VehicleTeamById_1.configVehicleTeamById.Init();
    VideoCaptionByCgName_1.configVideoCaptionByCgName.Init();
    VideoDataByBelongBranch_1.configVideoDataByBelongBranch.Init();
    ...
    WeatherSwitchAll_1.configWeatherSwitchAll.Init();
    WeatherSwitchById_1.configWeatherSwitchById.Init();
    WeekCardAll_1.configWeekCardAll.Init();
    WeekCardById_1.configWeekCardById.Init();
    WeekCardByPayGiftId_1.configWeekCardByPayGiftId.Init();
