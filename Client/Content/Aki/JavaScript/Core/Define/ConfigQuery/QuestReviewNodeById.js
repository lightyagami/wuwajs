...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configQuestReviewNodeById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `QuestReviewNode` where Id=?",
  KEY_PREFIX = "QuestReviewNodeById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewNodeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewNodeById.GetConfig"),
  CONFIG_STAT_PREFIX = "configQuestReviewNodeById.GetConfig(";
