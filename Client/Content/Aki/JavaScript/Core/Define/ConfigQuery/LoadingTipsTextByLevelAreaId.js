...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLoadingTipsTextByLevelAreaId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configLoadingTipsTextByLevelAreaId.GetConfigList"),
  ...
  GetConfigList: (o, i = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["LevelAreaId", o])) break;
          var a = void 0;
          if ([e, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["LevelAreaId", o]), !e) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = LoadingTipsText_1.LoadingTipsText.getRootAsLoadingTipsText(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          g.push(a)
        }
        return i && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
