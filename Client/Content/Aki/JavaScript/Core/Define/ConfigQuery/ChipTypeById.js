...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configChipTypeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configChipTypeById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const C = ChipType_1.ChipType.getRootAsChipType(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
