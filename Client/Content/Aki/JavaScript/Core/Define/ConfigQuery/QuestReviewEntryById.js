...
exports.configQuestReviewEntryById = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const QuestReviewEntry_1 = require("../Config/QuestReviewEntry");
const DB = "db_questreview.db";
const FILE = "j.剧情历程.xlsx";
const TABLE = "QuestReviewEntry";
const COMMAND = "select BinData from `QuestReviewEntry` where Id=?";
const KEY_PREFIX = "QuestReviewEntryById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewEntryById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewEntryById.GetConfig");
const CONFIG_STAT_PREFIX = "configQuestReviewEntryById.GetConfig(";
