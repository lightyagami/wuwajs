...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssInstByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssInstByActivityId.GetConfigList"),
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        ...
        return o && (s = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(s, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
