...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGuideTipsByGuideId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGuideTipsByGuideId.GetConfig"),
  ...
  GetConfig: (i, o = !0) => {
    ...
    if (e) {
      if (o) {
        ...
        if (d) return n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
      }
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GuideId", i])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GuideId", i]), e) {
          const d = GuideTips_1.GuideTips.getRootAsGuideTips(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return o && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, d)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), d
        }
      }
