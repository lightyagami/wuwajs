...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInstanceDungeonEntranceByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInstanceDungeonEntranceByMarkId.GetConfig"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", n])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", n]), t) {
          ...
          return o && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
