...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBettingGearBySeasonId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBettingGearBySeasonId.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SeasonId", n]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          a = RacingBettingGear_1.RacingBettingGear.getRootAsRacingBettingGear(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          g.push(a)
        }
        return o && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
