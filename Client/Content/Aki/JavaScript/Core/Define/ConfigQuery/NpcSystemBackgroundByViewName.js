...
exports.configNpcSystemBackgroundByViewName = undefined;
...
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configNpcSystemBackgroundByViewName.GetConfig");
  ...
  GetConfig: (o, n = true) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.Step(handleId, true, ...logPair, ["ViewName", o]) > 0) {
        i = undefined;
        [t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ViewName", o]);
        if (t) {
