...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDailyAdventureActivityByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDailyAdventureActivityByActivityId.GetConfig"),
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", i])) {
        ...
        if ([o, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), o) {
          ...
          return t && (o = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
