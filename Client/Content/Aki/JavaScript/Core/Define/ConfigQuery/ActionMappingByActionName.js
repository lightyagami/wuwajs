...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configActionMappingByActionName.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configActionMappingByActionName.GetConfig"),
...
exports.configActionMappingByActionName = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActionName", n])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActionName", n]), t) {
