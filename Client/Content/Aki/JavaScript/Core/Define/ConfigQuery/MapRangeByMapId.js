...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapRangeByMapId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMapRangeByMapId.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["MapId", o])) break;
          var e = void 0;
          if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = MapRange_1.MapRange.getRootAsMapRange(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          g.push(e)
        }
