...
exports.configMapRangeByMapId = undefined;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer");
const Stats_1 = require("../../Common/Stats");
const ConfigCommon_1 = require("../../Config/ConfigCommon");
const MapRange_1 = require("../Config/MapRange");
const DB = "db_map.db";
const FILE = "d.地图参数.xlsx";
const TABLE = "MapRange";
const COMMAND = "select BinData from `MapRange` where MapId=?";
const KEY_PREFIX = "MapRangeByMapId";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMapRangeByMapId.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configMapRangeByMapId.GetConfigList");
const CONFIG_LIST_STAT_PREFIX = "configMapRangeByMapId.GetConfigList(";
