...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeTaskReByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeTaskReByTaskId.GetConfig"),
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (t) {
      if (e) {
        ...
        if (i) return a?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", o])) {
        n = void 0;
        if ([t, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", o]), t) {
          ...
          return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), a?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
