...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configHotKeyTextByTextId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configHotKeyTextByTextId.GetConfig"),
...
exports.configHotKeyTextByTextId = {
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TextId", o])) {
        i = void 0;
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TextId", o]), n) {
