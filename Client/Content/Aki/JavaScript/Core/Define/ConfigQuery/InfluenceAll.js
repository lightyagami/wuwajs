...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInfluenceAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configInfluenceAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = Influence_1.Influence.getRootAsInfluence(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
