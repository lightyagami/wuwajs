...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResTeamLvRuleAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResTeamLvRuleAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = RogueResTeamLvRule_1.RogueResTeamLvRule.getRootAsRogueResTeamLvRule(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
