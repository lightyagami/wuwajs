...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGenderTextByMaleText.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configGenderTextByMaleText.GetConfig"),
...
exports.configGenderTextByMaleText = {
  ...
  GetConfig: (e, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MaleText", e])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MaleText", e]), t) {
