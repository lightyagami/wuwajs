...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPackageCapacityByPackageId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPackageCapacityByPackageId.GetConfig"),
...
exports.configPackageCapacityByPackageId = {
  ...
  GetConfig: (a, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, a, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PackageId", a])) {
        t = void 0;
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PackageId", a]), i) {
          const e = PackageCapacity_1.PackageCapacity.getRootAsPackageCapacity(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return o && (i = KEY_PREFIX + `#${a})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
