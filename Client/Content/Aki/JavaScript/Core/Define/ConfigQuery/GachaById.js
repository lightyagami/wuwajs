...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configGachaById.Init"),
  ...
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configGachaById.GetConfigList"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const C = Gacha_1.Gacha.getRootAsGacha(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = Gacha_1.Gacha.getRootAsGacha(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          g.push(C)
        }
        return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
      ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair)
    }
