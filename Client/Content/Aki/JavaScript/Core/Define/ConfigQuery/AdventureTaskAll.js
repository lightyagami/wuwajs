...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAdventureTaskAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAdventureTaskAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = AdventureTask_1.AdventureTask.getRootAsAdventureTask(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
