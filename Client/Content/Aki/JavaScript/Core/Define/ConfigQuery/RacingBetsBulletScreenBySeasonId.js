...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBetsBulletScreenBySeasonId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRacingBetsBulletScreenBySeasonId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configRacingBetsBulletScreenBySeasonId.GetConfigList(";
  ...
  GetConfigList: (n, e = !0) => {
    ...
    if (t) {
      if (e) {
        ...
        if (g) return o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair)) {
        const g = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["SeasonId", n])) break;
          var a = void 0;
          if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SeasonId", n]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return e && (i = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, g, g.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
