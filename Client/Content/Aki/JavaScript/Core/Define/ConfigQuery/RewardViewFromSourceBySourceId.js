...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRewardViewFromSourceBySourceId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRewardViewFromSourceBySourceId.GetConfig"),
...
exports.configRewardViewFromSourceBySourceId = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    var r = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      i = (r?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (i) {
      if (e) {
        var n = KEY_PREFIX + `#${o})`;
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["RewardSourceId", o])) {
        n = void 0;
        if ([i, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RewardSourceId", o]), i) {
          ...
          return e && (i = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), r?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
