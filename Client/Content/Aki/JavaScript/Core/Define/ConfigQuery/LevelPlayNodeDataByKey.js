...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLevelPlayNodeDataByKey.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLevelPlayNodeDataByKey.GetConfig"),
...
exports.configLevelPlayNodeDataByKey = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Key", e])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Key", e]), t) {
          ...
          return o && (t = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
