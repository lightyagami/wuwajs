...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDevicePlatformByPidAndVid.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDevicePlatformByPidAndVid.GetConfig"),
...
exports.configDevicePlatformByPidAndVid = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PidAndVid", o])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PidAndVid", o]), e) {
