...
exports.configCiacconaGalChapterById = undefined;
...
const COMMAND = "select BinData from `CiacconaGalChapter` where Id=?";
const KEY_PREFIX = "CiacconaGalChapterById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCiacconaGalChapterById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCiacconaGalChapterById.GetConfig");
const CONFIG_STAT_PREFIX = "configCiacconaGalChapterById.GetConfig(";
