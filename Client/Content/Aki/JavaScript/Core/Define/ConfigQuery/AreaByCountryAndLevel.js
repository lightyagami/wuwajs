...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByCountryAndLevel.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAreaByCountryAndLevel.GetConfigList"),
  ...
  GetConfigList: (o, n, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["CountryId", o], ["Level", n])) break;
          var r = void 0;
          if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CountryId", o], ["Level", n]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = Area_1.Area.getRootAsArea(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          a.push(r)
        }
        return e && (C = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(C, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
