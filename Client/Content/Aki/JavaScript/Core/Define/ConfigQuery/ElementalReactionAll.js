...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configElementalReactionAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configElementalReactionAll.GetConfigList");
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = ElementalReaction_1.ElementalReaction.getRootAsElementalReaction(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
