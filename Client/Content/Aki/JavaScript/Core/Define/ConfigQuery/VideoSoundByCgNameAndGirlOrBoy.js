...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configVideoSoundByCgNameAndGirlOrBoy.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configVideoSoundByCgNameAndGirlOrBoy.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configVideoSoundByCgNameAndGirlOrBoy.GetConfigList(";
  ...
  GetConfigList: (o, i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, i, ...logPair)) {
        const r = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["CgName", o], ["GirlOrBoy", i])) break;
          var g = void 0;
          if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CgName", o], ["GirlOrBoy", i]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          g = VideoSound_1.VideoSound.getRootAsVideoSound(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          r.push(g)
        }
        return n && (C = KEY_PREFIX + `#${o}#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(C, r, r.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
      }
