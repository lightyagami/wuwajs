...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDirectTrainActivityById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDirectTrainActivityById.GetConfig"),
    ...
    if (o) {
      ...
      if (o = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([o, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), o) {
          ...
          return t && (o = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(o, r)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), r
        }
      }
