...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configKeySettingByTypeId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configKeySettingByTypeId.GetConfigList"),
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["TypeId", t])) break;
          var g = void 0;
          if ([i, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TypeId", t]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
