...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configOpenAndCloseViewHotKeyByActionName.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configOpenAndCloseViewHotKeyByActionName.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configOpenAndCloseViewHotKeyByActionName.GetConfigList(";
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair)) {
        const a = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["ActionName", o])) break;
          var C = void 0;
          if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActionName", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return n && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
