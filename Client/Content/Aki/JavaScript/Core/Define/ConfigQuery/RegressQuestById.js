...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRegressQuestById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRegressQuestById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const g = RegressQuest_1.RegressQuest.getRootAsRegressQuest(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return e && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
