...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeContentAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configItemExchangeContentAll.GetConfigList");
exports.configItemExchangeContentAll = {
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), t = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return n && (o = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(o, i, i.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
    }
