...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `EntityGravityConfig` where MapId=? And EntityId=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configEntityGravityConfigByMapIdAndEntityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configEntityGravityConfigByMapIdAndEntityId.GetConfig"),
...
exports.configEntityGravityConfigByMapIdAndEntityId = {
  ...
  GetConfig: (t, n, i = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapId", t], ["EntityId", n])) {
        C = void 0;
        if ([a, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", t], ["EntityId", n]), a) {
          ...
          return i && (a = KEY_PREFIX + `#${t}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
