...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAxisRevertByRevertType.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAxisRevertByRevertType.GetConfigList"),
  ...
  GetConfigList: (e, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["RevertType", e])) break;
          var r = void 0;
          if ([i, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RevertType", e]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = AxisRevert_1.AxisRevert.getRootAsAxisRevert(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          C.push(r)
        }
        return o && (n = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
