...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRoleExpItemAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRoleExpItemAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), t = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = RoleExpItem_1.RoleExpItem.getRootAsRoleExpItem(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
