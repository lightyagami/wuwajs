...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingQteConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingQteConfigById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), t) {
          const g = FishingQteConfig_1.FishingQteConfig.getRootAsFishingQteConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
