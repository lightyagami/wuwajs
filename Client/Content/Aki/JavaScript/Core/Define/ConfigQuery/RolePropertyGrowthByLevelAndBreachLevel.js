...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `RolePropertyGrowth` where Level = ? AND BreachLevel = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRolePropertyGrowthByLevelAndBreachLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRolePropertyGrowthByLevelAndBreachLevel.GetConfig"),
  CONFIG_STAT_PREFIX = "configRolePropertyGrowthByLevelAndBreachLevel.GetConfig(";
exports.configRolePropertyGrowthByLevelAndBreachLevel = {
  ...
  GetConfig: (o, e, t = !0) => {
    ...
    var n = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o}#${e})`),
      r = (n?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (r) {
      if (t) {
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Level", o], ["BreachLevel", e])) {
        i = void 0;
        if ([r, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Level", o], ["BreachLevel", e]), r) {
          ...
          return t && (r = KEY_PREFIX + `#${o}#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
