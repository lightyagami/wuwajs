...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillButtonTextAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSkillButtonTextAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = SkillButtonText_1.SkillButtonText.getRootAsSkillButtonText(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
