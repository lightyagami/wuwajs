...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configStateMachinePreloadByFsmKey.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configStateMachinePreloadByFsmKey.GetConfig"),
...
exports.configStateMachinePreloadByFsmKey = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["FsmKey", e])) {
        a = void 0;
        if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FsmKey", e]), n) {
          ...
          return o && (n = KEY_PREFIX + `#${e})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
