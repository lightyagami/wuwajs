...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleBadgeAll = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleBadge`",
  KEY_PREFIX = "PhantomBattleBadgeAll",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleBadgeAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleBadgeAll.GetConfigList");
