...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `FogTextureConfig` where Block=? And MapId=? And GravityFlip=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFogTextureConfigByBlockAndMapIdAndGravity.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFogTextureConfigByBlockAndMapIdAndGravity.GetConfig"),
  CONFIG_STAT_PREFIX = "configFogTextureConfigByBlockAndMapIdAndGravity.GetConfig(";
exports.configFogTextureConfigByBlockAndMapIdAndGravity = {
  ...
  GetConfig: (o, n, i, t = !0) => {
    ...
    var e = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o}#${n}#${i})`),
      g = (e?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (g) {
      if (t) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 3, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Block", o], ["MapId", n], ["GravityFlip", i])) {
        C = void 0;
        if ([g, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Block", o], ["MapId", n], ["GravityFlip", i]), g) {
          ...
          return t && (g = KEY_PREFIX + `#${o}#${n}#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(g, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
