...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPayShopTabByShopId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPayShopTabByShopId.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var e = void 0;
          if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ShopId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          e = PayShopTab_1.PayShopTab.getRootAsPayShopTab(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          C.push(e)
        }
        return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
