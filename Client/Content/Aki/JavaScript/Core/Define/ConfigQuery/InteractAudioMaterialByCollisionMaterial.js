...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `InteractAudioMaterial` where CollisionMaterial=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInteractAudioMaterialByCollisionMaterial.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInteractAudioMaterialByCollisionMaterial.GetConfig"),
  CONFIG_STAT_PREFIX = "configInteractAudioMaterialByCollisionMaterial.GetConfig(";
exports.configInteractAudioMaterialByCollisionMaterial = {
  ...
  GetConfig: (o, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["CollisionMaterial", o])) {
        a = void 0;
        if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CollisionMaterial", o]), n) {
          ...
          return i && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
