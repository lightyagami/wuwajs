...
exports.configOccupyScoreAll = undefined;
...
const COMMAND = "select BinData from `OccupyScore`";
const KEY_PREFIX = "OccupyScoreAll";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configOccupyScoreAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configOccupyScoreAll.GetConfigList");
