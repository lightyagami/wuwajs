...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffPoolAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffPoolAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), e = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        t = RogueWeeklyBuffPool_1.RogueWeeklyBuffPool.getRootAsRogueWeeklyBuffPool(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
        i.push(t)
      }
