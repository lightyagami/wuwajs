...
exports.configPhotographHandBookAll = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhotographHandBookAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPhotographHandBookAll.GetConfigList");
  ...
  GetConfigList: (o = true) => {
    ...
    if (n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        i = PhotographHandBook_1.PhotographHandBook.getRootAsPhotographHandBook(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        a.push(i);
      }
      if (o) {
        t = KEY_PREFIX + ")";
