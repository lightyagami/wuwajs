...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSettleFlagAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSettleFlagAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        i = SettleFlag_1.SettleFlag.getRootAsSettleFlag(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i)
      }
