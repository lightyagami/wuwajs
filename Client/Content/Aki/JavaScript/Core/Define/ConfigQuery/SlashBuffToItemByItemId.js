...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemByItemId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSlashBuffToItemByItemId.GetConfig"),
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ItemId", o])) {
        f = void 0;
        if ([e, f] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ItemId", o]), e) {
