...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponResonByResonIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configWeaponResonByResonIdAndLevel.GetConfig"),
...
exports.configWeaponResonByResonIdAndLevel = {
  ...
  GetConfig: (o, n, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ResonId", o], ["Level", n])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ResonId", o], ["Level", n]), t) {
          const C = WeaponReson_1.WeaponReson.getRootAsWeaponReson(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return e && (t = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
