...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configInfluenceById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configInfluenceById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), i) {
          const f = Influence_1.Influence.getRootAsInfluence(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
