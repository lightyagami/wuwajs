...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleWeekExpById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleWeekExp` where Id=?",
  KEY_PREFIX = "PhantomBattleWeekExpById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleWeekExpById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleWeekExpById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleWeekExpById.GetConfig(";
