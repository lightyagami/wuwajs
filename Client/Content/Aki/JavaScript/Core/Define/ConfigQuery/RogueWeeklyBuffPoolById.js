...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffPoolById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueWeeklyBuffPoolById.GetConfig"),
    ...
    if (f) {
      ...
      if (f = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([f, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), f) {
          ...
          return e && (f = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(f, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
