...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTreasureBoxDetectorMarkByMarkId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTreasureBoxDetectorMarkByMarkId.GetConfig"),
...
exports.configTreasureBoxDetectorMarkByMarkId = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    var r = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o})`),
      t = (r?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (t) {
      if (e) {
        var n = KEY_PREFIX + `#${o})`;
        const a = ConfigCommon_1.ConfigCommon.GetConfig(n);
        if (a) return r?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MarkId", o])) {
        n = void 0;
        if ([t, n] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MarkId", o]), t) {
          ...
          return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), r?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
