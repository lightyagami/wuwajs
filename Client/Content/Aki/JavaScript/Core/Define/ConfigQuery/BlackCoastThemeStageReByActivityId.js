...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeStageReByActivityId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBlackCoastThemeStageReByActivityId.GetConfigList"),
  CONFIG_LIST_STAT_PREFIX = "configBlackCoastThemeStageReByActivityId.GetConfigList(";
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        ...
        for (;;) {
          ...
          var a = void 0;
          if ([i, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", t]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
        ...
        return o && (n = KEY_PREFIX + `#${t})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
