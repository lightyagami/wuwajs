...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerActivityByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerActivityByActivityId.GetConfig"),
...
exports.configBabelTowerActivityByActivityId = {
  ...
  GetConfig: (i, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", i])) {
        e = void 0;
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), n) {
          const a = BabelTowerActivity_1.BabelTowerActivity.getRootAsBabelTowerActivity(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return t && (n = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
