...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillButtonByRoleId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSkillButtonByRoleId.GetConfigList"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var l = void 0;
          if ([i, l] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          l = SkillButton_1.SkillButton.getRootAsSkillButton(new byte_buffer_1.ByteBuffer(new Uint8Array(l.buffer)));
          C.push(l)
        }
