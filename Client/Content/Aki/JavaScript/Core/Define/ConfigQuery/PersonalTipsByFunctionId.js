...
exports.configPersonalTipsByFunctionId = undefined;
...
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPersonalTipsByFunctionId.GetConfigList");
  ...
  GetConfigList: (o, n = true) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const r = new Array();
        while (true) {
          if (ConfigCommon_1.ConfigCommon.Step(handleId, false, ...logPair, ["FunctionId", o]) !== 1) {
            break;
          }
          var a = undefined;
          [t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["FunctionId", o]);
          if (!t) {
