...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configClueContentById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configClueContentById.GetConfig"),
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        C = void 0;
        if ([e, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), e) {
          const i = ClueContent_1.ClueContent.getRootAsClueContent(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          return o && (e = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, i)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), i
        }
      }
