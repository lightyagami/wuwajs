...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configQuestReviewTreeById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  Stats_1 = require("../../Common/Stats"),
  ConfigCommon_1 = require("../../Config/ConfigCommon"),
  QuestReviewTree_1 = require("../Config/QuestReviewTree"),
  DB = "db_questreview.db",
  FILE = "j.剧情历程.xlsx",
  TABLE = "QuestReviewTree",
  COMMAND = "select BinData from `QuestReviewTree` where Id=?",
  KEY_PREFIX = "QuestReviewTreeById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewTreeById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configQuestReviewTreeById.GetConfig"),
  CONFIG_STAT_PREFIX = "configQuestReviewTreeById.GetConfig(";
