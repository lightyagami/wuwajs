...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRefineRecommendByCost.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRefineRecommendByCost.GetConfigList"),
  ...
  GetConfigList: (o, n = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const C = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["Cost", o])) break;
          var m = void 0;
          if ([i, m] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Cost", o]), !i) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
