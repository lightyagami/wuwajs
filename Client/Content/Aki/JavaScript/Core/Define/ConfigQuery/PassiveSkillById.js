...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPassiveSkillById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPassiveSkillById.GetConfig"),
...
exports.configPassiveSkillById = {
  ...
  GetConfig: (i, o = !0) => {
    "bigint" == typeof i && (i = (0, ConfigCommon_1.toNumberTemp)(i)), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigStat?.Start();
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindFloat64(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), e) {
          ...
          return o && (e = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
