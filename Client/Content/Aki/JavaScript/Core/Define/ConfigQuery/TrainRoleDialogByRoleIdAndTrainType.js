...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `TrainRoleDialog` where RoleId=? AND TrainType=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTrainRoleDialogByRoleIdAndTrainType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTrainRoleDialogByRoleIdAndTrainType.GetConfig"),
  ...
  GetConfig: (o, n, i = !0) => {
    ...
    if (a) {
      if (i) {
        ...
        if (g) return e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
      }
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["RoleId", o], ["TrainType", n])) {
        t = void 0;
        if ([a, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["RoleId", o], ["TrainType", n]), a) {
          const g = TrainRoleDialog_1.TrainRoleDialog.getRootAsTrainRoleDialog(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return i && (a = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, g)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), g
        }
      }
