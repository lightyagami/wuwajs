...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableAwardsById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTurntableAwardsById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([i, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), i) {
          const a = TurntableAwards_1.TurntableAwards.getRootAsTurntableAwards(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
          return o && (i = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(i, a)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
        }
      }
