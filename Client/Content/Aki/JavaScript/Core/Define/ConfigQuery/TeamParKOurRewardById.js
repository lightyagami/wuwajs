...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTeamParKOurRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTeamParKOurRewardById.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), a) {
