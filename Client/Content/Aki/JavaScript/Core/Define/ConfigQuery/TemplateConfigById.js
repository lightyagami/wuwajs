...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTemplateConfigById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTemplateConfigById.GetConfig"),
