...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExecutionConfById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExecutionConfById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const C = ExecutionConf_1.ExecutionConf.getRootAsExecutionConf(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
