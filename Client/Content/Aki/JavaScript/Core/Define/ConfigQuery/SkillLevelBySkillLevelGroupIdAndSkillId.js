...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "j.技能.xlsx",
  TABLE = "SkillLevel",
  COMMAND = "select BinData from `SkillLevel` where SkillLevelGroupId = ? AND SkillId = ?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillLevelBySkillLevelGroupIdAndSkillId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configSkillLevelBySkillLevelGroupIdAndSkillId.GetConfig"),
  CONFIG_STAT_PREFIX = "configSkillLevelBySkillLevelGroupIdAndSkillId.GetConfig(";
exports.configSkillLevelBySkillLevelGroupIdAndSkillId = {
  ...
  GetConfig: (o, l, i = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, l, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["SkillLevelGroupId", o], ["SkillId", l])) {
        t = void 0;
        if ([n, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["SkillLevelGroupId", o], ["SkillId", l]), n) {
          const C = SkillLevel_1.SkillLevel.getRootAsSkillLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return i && (n = KEY_PREFIX + `#${o}#${l})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
