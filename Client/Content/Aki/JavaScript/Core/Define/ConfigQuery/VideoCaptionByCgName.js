...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configVideoCaptionByCgName.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configVideoCaptionByCgName.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindString(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var C = void 0;
          if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["CgName", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = VideoCaption_1.VideoCaption.getRootAsVideoCaption(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          a.push(C)
        }
        return i && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, a, a.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), a
      }
