...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCustomerServiceAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCustomerServiceAll.GetConfigList"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        for (;;) {
          ...
          var r = void 0;
          if ([t, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PackageType", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          r = CustomerService_1.CustomerService.getRootAsCustomerService(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          C.push(r)
        }
        return e && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, C, C.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
      }
