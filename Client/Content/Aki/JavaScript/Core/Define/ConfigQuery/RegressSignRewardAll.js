...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRegressSignRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configRegressSignRewardAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = RegressSignReward_1.RegressSignReward.getRootAsRegressSignReward(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        t.push(e)
      }
