...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFilterSortGroupById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFilterSortGroupById.GetConfig"),
  ...
  GetConfig: (o, t = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        r = void 0;
        if ([n, r] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const e = FilterSortGroup_1.FilterSortGroup.getRootAsFilterSortGroup(new byte_buffer_1.ByteBuffer(new Uint8Array(r.buffer)));
          return t && (n = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(n, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
