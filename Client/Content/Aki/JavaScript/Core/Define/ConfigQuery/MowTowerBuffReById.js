...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMowTowerBuffReById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMowTowerBuffReById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const f = MowTowerBuffRe_1.MowTowerBuffRe.getRootAsMowTowerBuffRe(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
