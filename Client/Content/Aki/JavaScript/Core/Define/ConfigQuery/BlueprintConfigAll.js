...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBlueprintConfigAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configBlueprintConfigAll.GetConfigList");
exports.configBlueprintConfigAll = {
  ...
  GetConfigList: (n = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), i = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      return n && (o = KEY_PREFIX + ")", ConfigCommon_1.ConfigCommon.SaveConfig(o, e, e.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
    }
