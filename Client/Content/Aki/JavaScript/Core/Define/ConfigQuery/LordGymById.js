...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLordGymById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLordGymById.GetConfig"),
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
          const C = LordGym_1.LordGym.getRootAsLordGym(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
