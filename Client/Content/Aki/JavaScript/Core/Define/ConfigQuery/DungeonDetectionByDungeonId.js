...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDungeonDetectionByDungeonId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDungeonDetectionByDungeonId.GetConfig"),
...
exports.configDungeonDetectionByDungeonId = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["DungeonId", n])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["DungeonId", n]), t) {
