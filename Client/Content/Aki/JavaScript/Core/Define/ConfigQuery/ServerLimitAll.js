...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configServerLimitAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configServerLimitAll.GetConfigList");
  ...
  GetConfigList: (i = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = ServerLimit_1.ServerLimit.getRootAsServerLimit(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        e.push(n)
      }
