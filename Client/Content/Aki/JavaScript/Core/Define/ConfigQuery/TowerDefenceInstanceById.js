...
exports.configTowerDefenceInstanceById = undefined;
...
const COMMAND = "select BinData from `TowerDefenceInstance` where Id = ?";
const KEY_PREFIX = "TowerDefenceInstanceById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceById.GetConfig");
const CONFIG_STAT_PREFIX = "configTowerDefenceInstanceById.GetConfig(";
