...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTowerDefenceInstanceById.GetConfig"),
  ...
  GetConfig: (n, e = !0) => {
    ...
    if (t) {
      if (e) {
        ...
        if (f) return o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", n])) {
        ...
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", n]), t) {
          const f = TowerDefenceInstance_1.TowerDefenceInstance.getRootAsTowerDefenceInstance(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return e && (t = KEY_PREFIX + `#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, f)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
        }
      }
