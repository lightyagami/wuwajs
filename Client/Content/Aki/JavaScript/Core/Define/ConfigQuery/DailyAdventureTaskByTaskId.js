...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configDailyAdventureTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configDailyAdventureTaskByTaskId.GetConfig"),
...
exports.configDailyAdventureTaskByTaskId = {
  ...
  GetConfig: (n, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", n])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", n]), t) {
