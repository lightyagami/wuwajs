...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAkiMapSourceByMapId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configAkiMapSourceByMapId.GetConfig"),
...
exports.configAkiMapSourceByMapId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["MapId", o])) {
        t = void 0;
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["MapId", o]), e) {
