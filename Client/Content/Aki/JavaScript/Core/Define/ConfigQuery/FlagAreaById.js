...
exports.configFlagAreaById = undefined;
...
const COMMAND = "select BinData from `FlagArea` where Id=?";
const KEY_PREFIX = "FlagAreaById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFlagAreaById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFlagAreaById.GetConfig");
const CONFIG_STAT_PREFIX = "configFlagAreaById.GetConfig(";
