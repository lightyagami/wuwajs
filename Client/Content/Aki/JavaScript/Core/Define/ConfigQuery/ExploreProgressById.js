...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExploreProgressById.GetConfig"),
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (r) {
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        t = void 0;
        if ([r, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), r) {
