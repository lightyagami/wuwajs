...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configTimePointRewardConfigByActivityId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configTimePointRewardConfigByActivityId.GetConfig"),
  ...
  GetConfig: (i, o = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ActivityId", i])) {
        e = void 0;
        if ([t, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ActivityId", i]), t) {
