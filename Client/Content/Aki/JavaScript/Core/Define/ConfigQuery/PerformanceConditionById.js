...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPerformanceConditionById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPerformanceConditionById.GetConfig"),
    ...
    if (e) {
      ...
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([e, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), e) {
          const C = PerformanceCondition_1.PerformanceCondition.getRootAsPerformanceCondition(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return n && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
