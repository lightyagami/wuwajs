...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `BuildingUpGradeCurve` where GroupId=? AND Level=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBuildingUpGradeCurveByGroupIdAndLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBuildingUpGradeCurveByGroupIdAndLevel.GetConfig"),
...
exports.configBuildingUpGradeCurveByGroupIdAndLevel = {
  ...
  GetConfig: (o, n, e = !0) => {
    ...
    var i = Stats_1.Stat.CreateNoFlameGraph(CONFIG_STAT_PREFIX + `#${o}#${n})`),
      r = (i?.Start(), ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair));
    if (r) {
      if (e) {
      ...
      if (r = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, n, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GroupId", o], ["Level", n])) {
        t = void 0;
        if ([r, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", o], ["Level", n]), r) {
          ...
          return e && (r = KEY_PREFIX + `#${o}#${n})`, ConfigCommon_1.ConfigCommon.SaveConfig(r, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
