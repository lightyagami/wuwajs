...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSettleRewardAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSettleRewardAll.GetConfigList");
  ...
  GetConfigList: (t = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), o = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        n = SettleReward_1.SettleReward.getRootAsSettleReward(new byte_buffer_1.ByteBuffer(new Uint8Array(n.buffer)));
        i.push(n)
      }
