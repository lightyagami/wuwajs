...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResEventBgmById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configRogueResEventBgmById.GetConfig"),
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), t) {
