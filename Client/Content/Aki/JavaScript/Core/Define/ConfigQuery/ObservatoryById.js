...
exports.configObservatoryById = undefined;
...
const COMMAND = "select BinData from `Observatory` where Id=?";
const KEY_PREFIX = "ObservatoryById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configObservatoryById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configObservatoryById.GetConfig");
const CONFIG_STAT_PREFIX = "configObservatoryById.GetConfig(";
exports.configObservatoryById = {
  Init: () => {
    initStat?.Start();
...
//# sourceMappingURL=ObservatoryById.js.map