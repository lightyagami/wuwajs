...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerExpByPlayerLevel.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPlayerExpByPlayerLevel.GetConfig"),
...
exports.configPlayerExpByPlayerLevel = {
  ...
  GetConfig: (e, o = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, e, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["PlayerLevel", e])) {
        t = void 0;
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PlayerLevel", e]), i) {
