...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configKillMonstersScoresByInstanceID.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configKillMonstersScoresByInstanceID.GetConfig"),
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (e) {
      if (n) {
        ...
        if (s) return t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
      }
      if (e = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["InstanceID", o])) {
        i = void 0;
        if ([e, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["InstanceID", o]), e) {
          ...
          return n && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, s)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), t?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
        }
      }
