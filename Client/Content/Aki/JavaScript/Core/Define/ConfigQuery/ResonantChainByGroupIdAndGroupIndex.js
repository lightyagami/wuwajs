...
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  FILE = "g.共鸣链.xlsx",
  TABLE = "ResonantChain",
  COMMAND = "select BinData from `ResonantChain` where GroupId=? AND GroupIndex=?",
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configResonantChainByGroupIdAndGroupIndex.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configResonantChainByGroupIdAndGroupIndex.GetConfig"),
...
exports.configResonantChainByGroupIdAndGroupIndex = {
  ...
  GetConfig: (n, o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, n, ...logPair) && ConfigCommon_1.ConfigCommon.BindInt(handleId, 2, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["GroupId", n], ["GroupIndex", o])) {
        a = void 0;
        if ([t, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["GroupId", n], ["GroupIndex", o]), t) {
          const C = ResonantChain_1.ResonantChain.getRootAsResonantChain(new byte_buffer_1.ByteBuffer(new Uint8Array(a.buffer)));
          return i && (t = KEY_PREFIX + `#${n}#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
