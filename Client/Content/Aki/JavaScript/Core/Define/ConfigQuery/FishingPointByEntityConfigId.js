...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingPointByEntityConfigId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingPointByEntityConfigId.GetConfig"),
...
exports.configFishingPointByEntityConfigId = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["EntityConfigId", i])) {
        g = void 0;
        if ([t, g] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["EntityConfigId", i]), t) {
          const C = FishingPoint_1.FishingPoint.getRootAsFishingPoint(new byte_buffer_1.ByteBuffer(new Uint8Array(g.buffer)));
          return n && (t = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, C)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), C
        }
      }
