...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configPhantomBattleCardRoleById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `PhantomBattleCardRole` where Id=?",
  KEY_PREFIX = "PhantomBattleCardRoleById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardRoleById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configPhantomBattleCardRoleById.GetConfig"),
  CONFIG_STAT_PREFIX = "configPhantomBattleCardRoleById.GetConfig(";
