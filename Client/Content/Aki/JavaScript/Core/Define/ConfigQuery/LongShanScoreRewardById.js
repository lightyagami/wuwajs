...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.configLongShanScoreRewardById = void 0;
const byte_buffer_1 = require("../../../RunTimeLibs/FlatBuffers/byte-buffer"),
  ...
  COMMAND = "select BinData from `LongShanScoreReward` where Id=?",
  KEY_PREFIX = "LongShanScoreRewardById",
  logPair = [
    ["数据库", DB],
    ["文件", FILE],
    ["表名", TABLE],
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanScoreRewardById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configLongShanScoreRewardById.GetConfig"),
  CONFIG_STAT_PREFIX = "configLongShanScoreRewardById.GetConfig(";
exports.configLongShanScoreRewardById = {
  Init: () => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const a = LongShanScoreReward_1.LongShanScoreReward.getRootAsLongShanScoreReward(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
...
//# sourceMappingURL=LongShanScoreRewardById.js.map