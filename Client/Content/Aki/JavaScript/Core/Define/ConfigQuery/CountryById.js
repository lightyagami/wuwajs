...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCountryById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configCountryById.GetConfig"),
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([i, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), i) {
          const e = Country_1.Country.getRootAsCountry(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
