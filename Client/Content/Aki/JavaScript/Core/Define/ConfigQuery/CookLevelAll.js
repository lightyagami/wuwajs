...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configCookLevelAll.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configCookLevelAll.GetConfigList");
  ...
  GetConfigList: (o = !0) => {
    ...
    if (ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Start(), getConfigListStat?.Start(), n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      for (;;) {
        ...
        e = CookLevel_1.CookLevel.getRootAsCookLevel(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
        i.push(e)
      }
