...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTagById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFishingTagById.GetConfig"),
...
exports.configFishingTagById = {
  ...
  GetConfig: (i, n = !0) => {
    ...
    if (g) {
      ...
      if (g = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, i, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", i])) {
        t = void 0;
        if ([g, t] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", i]), g) {
          const e = FishingTag_1.FishingTag.getRootAsFishingTag(new byte_buffer_1.ByteBuffer(new Uint8Array(t.buffer)));
          return n && (g = KEY_PREFIX + `#${i})`, ConfigCommon_1.ConfigCommon.SaveConfig(g, e)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), o?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), e
        }
      }
