...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configExploreTypeByType.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configExploreTypeByType.GetConfig"),
...
exports.configExploreTypeByType = {
  ...
  GetConfig: (o, e = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["ExploreType", o])) {
        i = void 0;
        if ([t, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ExploreType", o]), t) {
