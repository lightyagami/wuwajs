...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configShopFixedByShopId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configShopFixedByShopId.GetConfigList"),
  ...
  GetConfigList: (o, i = !0) => {
    ...
    if (t) {
      ...
      if (t = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        const f = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["ShopId", o])) break;
          var C = void 0;
          if ([t, C] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["ShopId", o]), !t) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
          C = ShopFixed_1.ShopFixed.getRootAsShopFixed(new byte_buffer_1.ByteBuffer(new Uint8Array(C.buffer)));
          f.push(C)
        }
        return i && (e = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(e, f, f.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), f
      }
