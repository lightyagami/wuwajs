...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configFarmGoldActivityById.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configFarmGoldActivityById.GetConfig"),
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["Id", o])) {
        ...
        if ([n, e] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["Id", o]), n) {
          const a = FarmGoldActivity_1.FarmGoldActivity.getRootAsFarmGoldActivity(new byte_buffer_1.ByteBuffer(new Uint8Array(e.buffer)));
