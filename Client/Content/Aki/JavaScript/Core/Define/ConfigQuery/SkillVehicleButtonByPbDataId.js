...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configSkillVehicleButtonByPbDataId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configSkillVehicleButtonByPbDataId.GetConfigList"),
  ...
  GetConfigList: (t, o = !0) => {
    ...
    if (n) {
      ...
      if (n = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, t, ...logPair)) {
        const l = new Array;
        for (;;) {
          if (1 !== ConfigCommon_1.ConfigCommon.Step(handleId, !1, ...logPair, ["PbDataId", t])) break;
          var a = void 0;
          if ([n, a] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["PbDataId", t]), !n) return ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), i?.Stop(), getConfigListStat?.Stop(), void ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop();
