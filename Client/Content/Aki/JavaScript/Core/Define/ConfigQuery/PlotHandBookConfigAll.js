...
exports.configPlotHandBookConfigAll = undefined;
...
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configPlotHandBookConfigAll.Init");
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configPlotHandBookConfigAll.GetConfigList");
  ...
  GetConfigList: (o = true) => {
    ...
    if (n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        i = PlotHandBookConfig_1.PlotHandBookConfig.getRootAsPlotHandBookConfig(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i);
      }
      if (o) {
        t = KEY_PREFIX + ")";
