...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRoleLevelByGroupId.Init"),
  getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configAbyssRoleLevelByGroupId.GetConfigList"),
  ...
  GetConfigList: (o, e = !0) => {
    ...
    if (i) {
      ...
      if (i = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair)) {
        ...
        return e && (t = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(t, s, s.length)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), n?.Stop(), getConfigListStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), s
      }
