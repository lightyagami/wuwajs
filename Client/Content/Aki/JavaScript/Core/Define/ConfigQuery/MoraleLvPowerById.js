...
exports.configMoraleLvPowerById = undefined;
...
const COMMAND = "select BinData from `MoraleLvPower` where Id=?";
const KEY_PREFIX = "MoraleLvPowerById";
const logPair = [["数据库", DB], ["文件", FILE], ["表名", TABLE], ["语句", COMMAND]];
let handleId = 0;
const initStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLvPowerById.Init");
const getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configMoraleLvPowerById.GetConfig");
const CONFIG_STAT_PREFIX = "configMoraleLvPowerById.GetConfig(";
