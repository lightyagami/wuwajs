...
exports.configFogBlockAll = undefined;
...
const getConfigListStat = Stats_1.Stat.CreateNoFlameGraph("configFogBlockAll.GetConfigList");
  ...
  GetConfigList: (o = true) => {
    ...
    if (n = ConfigCommon_1.ConfigCommon.CheckStatement(handleId, ...logPair)) {
      ...
      while (true) {
        ...
        i = FogBlock_1.FogBlock.getRootAsFogBlock(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
        e.push(i);
      }
      if (o) {
        t = KEY_PREFIX + ")";
