...
const initStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerTaskByTaskId.Init"),
  getConfigStat = Stats_1.Stat.CreateNoFlameGraph("configBabelTowerTaskByTaskId.GetConfig"),
...
exports.configBabelTowerTaskByTaskId = {
  ...
  GetConfig: (o, n = !0) => {
    ...
    if (a) {
      ...
      if (a = ConfigCommon_1.ConfigCommon.BindInt(handleId, 1, o, ...logPair) && 0 < ConfigCommon_1.ConfigCommon.Step(handleId, !0, ...logPair, ["TaskId", o])) {
        i = void 0;
        if ([a, i] = ConfigCommon_1.ConfigCommon.GetValue(handleId, 0, ...logPair, ["TaskId", o]), a) {
          const t = BabelTowerTask_1.BabelTowerTask.getRootAsBabelTowerTask(new byte_buffer_1.ByteBuffer(new Uint8Array(i.buffer)));
          return n && (a = KEY_PREFIX + `#${o})`, ConfigCommon_1.ConfigCommon.SaveConfig(a, t)), ConfigCommon_1.ConfigCommon.Reset(handleId, ...logPair), e?.Stop(), getConfigStat?.Stop(), ConfigCommon_1.ConfigCommon.AllConfigStatementStat.Stop(), t
        }
      }
