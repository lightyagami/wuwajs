...
class Pool {
  constructor(t, s, e = void 0) {
    this.f7 = t, this.a7 = s, this.h7 = e, this.p7 = new Array, this.v7 = new WeakSet, this.M7 = 0
  }
  get Size() {
  ...
  Get() {
    var t;
    if (!(this.p7.length <= 0)) return t = this.p7.pop(), this.M7 += 1, this.v7.add(t), t
  }
  Put(t) {
    if (t)
      if (this.v7.delete(t)) {
        ...
        this.h7?.(t)
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Pool", 1, "非池中对象", ["value", t]);
    else Log_1.Log.CheckError() && Log_1.Log.Error("Core", 1, "无效对象", ["value", t]);
    return !1
  }
  Clear() {
