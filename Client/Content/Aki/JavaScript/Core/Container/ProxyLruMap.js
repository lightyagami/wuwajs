...
class ProxyLruMap {
  ...
  Add(t, e, r, i = void 0) {
    this._7.has(t) ? Log_1.Log.CheckError() && Log_1.Log.Error("Core", 1, "池中已存在该种类", ["category", t]) : this._7.set(t, new ProxyLru_1.ProxyLru(e, r, i))
  }
  Remove(t) {
    var e = this.b7(t);
  ...
  b7(t) {
    var e = this._7.get(t);
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("Core", 1, "池中不存在该种类", ["category", t])
  }
}
