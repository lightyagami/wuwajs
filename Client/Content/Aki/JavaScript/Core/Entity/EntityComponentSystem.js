...
class EntityComponentSystem {
  ...
  static Create(t, e, n) {
    e.UsePool && !EntityComponentSystem.ComponentTemplates.has(t.name) && (o = new t, EntityComponentSystem.ComponentTemplates.set(t.name, o));
    var o = new t;
  ...
  static ClearComponent(t) {
    ...
    if (!e) return Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 29, "清理不存在的组件类型", ["Component", t.constructor.name]), !1;
    for (const n in t)
      if ("UnResetPropertySet" !== n && !t.UnResetPropertySet?.has(n))
        if (void 0 === e[n]) t[n] = void 0;
        else if (t[n] instanceof Object) {
      if (!EntityComponentSystem.HW(t[n])) return Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 29, "组件存在未定义清理方式的Object", ["Component", t.constructor.name], ["Object", n]), !1
    } else t[n] = e[n];
    return !0
  }
  static HW(t) {
...
}(exports.EntityComponentSystem = EntityComponentSystem).ComponentTemplates = new Map, EntityComponentSystem.PerformanceStateClearComponent = Stats_1.Stat.Create("PerformanceStateClearComponent");
