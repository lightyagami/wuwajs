...
class TickEntityManager {
  constructor() {
    this.jW = new Map, this.WW = new Array, this.KW = new Map, this.QW = !1, this.XW = new Array, this.$W = new Array
  }
  Add(t, i) {
  ...
  YW(t, i) {
    let e = this.jW.get(i);
    e || (e = new TickEntityGroup(i), this.jW.set(i, e), this.WW.splice(this.JW(i), 0, e)), e.Entities.set(t.Id, t)
  }
  JW(i) {
    var e = this.WW.length;
    if (e < BINARY_SEARCH_THREADHOLD) {
      for (let t = 0; t < e; ++t)
        if (this.WW[t].Priority < i) return t;
      return e
    }
  ...
  ForceTick(t) {
    ...
    for (const i of this.WW)
      for (const e of i.Entities.values()) e.Valid && e.IsInit && e.ForceTick(t);
  ...
  ForceAfterTick(t) {
    ...
    for (const i of this.WW)
      for (const e of i.Entities.values()) e.Valid && e.IsInit && e.ForceAfterTick(t);
  ...
  AfterTick(t) {
    if (!GameBudgetInterfaceController_1.GameBudgetInterfaceController.IsOpen) {
      ...
      for (const i of this.WW)
        for (const e of i.Entities.values()) e.Valid && e.IsInit && e.AfterTick(t);
...
TickEntityManager.ZW = Stats_1.Stat.Create("TickEntityManager.ForceTick"), TickEntityManager.gW = Stats_1.Stat.Create("TickEntityManager.Tick"), TickEntityManager.tK = Stats_1.Stat.Create("TickEntityManager.ForceAfterTick"), TickEntityManager.fW = Stats_1.Stat.Create("TickEntityManager.AfterTick");
class EntitySystem {
  constructor() {}
  static Initialize() {
  ...
  static Create(t, i = 0, e) {
    ...
    if (t.Create(e)) return t.TickComponentManager.NeedTick && this.iK.Add(t, i), t.TickComponentManager.NeedAfterTick && this.oK.Add(t, i), t;
    ObjectSystem_1.ObjectSystem.Destroy(t)
  }
  static CreateExternal(t, i, e = 0, s) {
    return !!ObjectSystem_1.ObjectSystem.CreateExternal(i) && (i.Create(s) ? (i.TickComponentManager.NeedTick && this.iK.Add(i, e), i.TickComponentManager.NeedAfterTick && this.oK.Add(i, e), !0) : (ObjectSystem_1.ObjectSystem.Destroy(i), !1))
  }
...
}(exports.EntitySystem = EntitySystem).iK = new TickEntityManager, EntitySystem.oK = new TickEntityManager, EntitySystem.$wa = void 0;
