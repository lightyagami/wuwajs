...
class AudioModel extends ModelBase_1.ModelBase {
  ...
  static GetSpectrumActor() {
    return AudioModel.Y6 || (AudioModel.Y6 = ActorSystem_1.ActorSystem.Get(UE.BP_Wwise_AudioSpectrum_C.StaticClass(), MathUtils_1.MathUtils.DefaultTransformDouble)), AudioModel.Y6
  }
  static DestroySpectrumActor() {
    AudioModel.Y6 && (ActorSystem_1.ActorSystem.Put("AudioModel.DestroySpectrumActor", AudioModel.Y6), AudioModel.Y6 = void 0)
  }
  OnInit() {
    return this.Q6 = new PriorityQueue_1.PriorityQueue(AudioBox.Compare), this.X6 = new PriorityQueue_1.PriorityQueue(AudioBox.Compare), !0
  }
  OnClear() {
