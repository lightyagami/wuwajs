...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.LanguageSystem = exports.languageCultureMap = exports.languageSpeechMapping = exports.LanguageDefine = void 0;
...
exports.LanguageDefine = LanguageDefine, exports.languageSpeechMapping = new Map([
  [0, 0],
  [1, 1],
  [2, 2],
  [3, 3],
...
const languageList = [new LanguageDefine(0, "zh-Hans", "zh"), new LanguageDefine(1, "en", "en"), new LanguageDefine(2, "ja", "ja"), new LanguageDefine(3, "ko", "ko"), new LanguageDefine(4, "ru", "en"), new LanguageDefine(5, "zh-Hant", "zh"), new LanguageDefine(6, "de", "en"), new LanguageDefine(7, "es", "en"), new LanguageDefine(8, "pt", "en"), new LanguageDefine(9, "id", "en"), new LanguageDefine(10, "fr", "en"), new LanguageDefine(11, "vi", "en"), new LanguageDefine(12, "th", "en")],
  languageTypeMap = (exports.languageCultureMap = new Map([
    ["zh-Hans", 11],
    ["en", 0],
    ["ja", 10],
    ["ko", 9],
...
for (const d of languageList) languageTypeMap.set(d.LanguageType, d), languageCodeMap.set(d.LanguageCode, d);
class LanguageSystem {
  ...
  static set PackageLanguage(e) {
    ...
    LanguageSystem.T8 = e, UE.LGUIFontData.SetAllFontCurrentCulture(exports.languageCultureMap.get(e)), Info_1.Info.IsPlayInEditor || UE.KismetInternationalizationLibrary.SetCurrentCulture(e, !0), e !== a && UE.UIText.OnTsLanguageChange(), PlatformSdkManagerNew_1.PlatformSdkManagerNew.IsSdkOn && PlatformSdkServer_1.PlatformSdkServer.SetLanguage(e), LauncherLanguageLib_1.LauncherLanguageLib.SetPackageLanguage(e)
  }
  static get PackageAudio() {
    return LanguageSystem.L8 ?? CommonDefine_1.CHS_AUDIO
  }
  static SetPackageAudio(a, e) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("GameSettings", 64, "开始设置音频语种，对应【SetCurrentAudioCultureAsync】", ["Code", a]), LanguageSystem.L8 = a;
    const n = e => {
      Log_1.Log.CheckInfo() && Log_1.Log.Info("Config", 30, "SetCurrentAudioCultureAsync", ["Success", e], ["Code", a]), (0, puerts_1.releaseManualReleaseDelegate)(n), e && AudioSystem_1.AudioSystem.SetState("language", a)
    };
    UE.AkGameplayStatics.SetCurrentAudioCultureAsync(a, (0, puerts_1.toManualReleaseDelegate)(n))
  }
  static D8(e) {
    return e.includes(CommonDefine_1.CHINESE_ISO639_1) ? CommonDefine_1.CHS : CommonDefine_1.ENGLISH_ISO639_1
  }
  static FirstTimeSetLanguage(e) {
    ...
    var g = this.D8(a),
      ...
      u = LanguageDefineByLanguageCode_1.configLanguageDefineByLanguageCode.GetConfig(t),
      u = !!u?.IsShow && u.IsShow,
      t = u ? t : this.D8(t),
      u = (u || Log_1.Log.CheckInfo() && Log_1.Log.Info("Config", 10, "当前语种表格配置不允许生效", ["targetLanguage", t], ["currentCulture", a]), Log_1.Log.CheckInfo() && Log_1.Log.Info("Config", 30, "第一次设置语言", ["设备默认语言", a], ["查找不到时匹配默认语言", g], ["最合适语言", t]), languageCodeMap.get(t));
    u ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Config", 30, "FirstTimeSetLanguage", ["Text", u.LanguageCode], ["Audio", u.AudioCode]), LanguageSystem.PackageLanguage = u.LanguageCode) : (Log_1.Log.CheckError() && Log_1.Log.Error("Config", 30, "设置系统找不到配置", ["语种识别码", t]), LanguageSystem.PackageLanguage = CommonDefine_1.ENGLISH_ISO639_1)
  }
