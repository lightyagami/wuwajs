...
class Time {
  ...
  static SyncTime(t, i, e, s) {
    Time.SetServerTimeStamp(t), Time.SetServerTimeOffset(t - Time.Now), Time.SetServerStopTimeOffset(s), Time.SetServerFlowTimeStamp(i), Time._P_ = e
  }
  ...
  static get IsAfterPrePhysicTick() {
    return this.Z01 === this.Frame
  }
  static AfterTickPriority1(t) {
    this.Z01 = this.B9
  }
  static Initialize() {
    this.B9 = 0, this.b9 = 0, this.q9 = 0, this.uP_ = 0, this.x9 = 0, Time.OriginTimeDilation = 1, this.R9 = 1, this.cP_ = 1
  }
  static Tick(t) {
    this.x9 = t, this.B9 += 1, this.b9 += t, this.q9 += t * this.R9, this.uP_ += t * this.R9 * this.cP_
  }
}(exports.Time = Time).w9 = .001, Time.B9 = 0, Time.b9 = 0, Time.q9 = 0, Time.uP_ = 0, Time.x9 = 0, Time.A9 = 0, Time.K$a = 0, Time.U9 = 0, Time.P9 = 0, Time._P_ = 0, Time.R9 = 1, Time.cP_ = 1, Time.OriginTimeDilation = 1, Time.LastPauseTimeFrame = 0, Time.LastResumeTimeFrame = 0, Time.Z01 = 0;
