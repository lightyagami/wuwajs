...
class GameplayTagUtils {
  static GetTagIdByName(a) {
    ...
    a = UE.GASBPLibrary.FnvHash(a), a = GameplayTagDefine_1.TagId2UglyTagIdMap.get(a) ?? a;
  ...
  static GetGameplayTagById(a) {
    let t = this.qJ.get(a);
    if (t || (t = UE.GASBPLibrary.GetGameplayTagFromTagHash(a), this.qJ.set(a, t)), t) return t;
    GameplayTagUtils.GJ.has(a) || (GameplayTagUtils.GJ.add(a), Log_1.Log.CheckError() && Log_1.Log.Error("Game", 36, "TagId对应的GameplayTag不存在，请检查GameplayTag设置", ["TagId", a]))
  }
  ...
  static Contains(a, t) {
    if (a)
      for (const e of a)
        if (GameplayTagUtils.IsChildTag(t, e)) return !0;
    return !1
  }
  ...
  static HasAll(a, t) {
    if (t)
      for (const e of t)
        if (!this.Contains(a, e)) return !1;
    return !0
  }
  static HasAny(a, t) {
    if (t)
      for (const e of t)
        if (this.Contains(a, e)) return !0;
    return !1
  }
...
}(exports.GameplayTagUtils = GameplayTagUtils).GJ = new Set, GameplayTagUtils.MJ = Stats_1.Stat.Create("GameplayTagUtils.FnvHash"), GameplayTagUtils.qJ = new Map;
