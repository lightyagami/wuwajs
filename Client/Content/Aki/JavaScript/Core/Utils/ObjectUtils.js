...
class ObjectUtils {
  ...
  static DeepCopyValue(e, a) {
    Object.keys(e).forEach(t => {
      e[t] instanceof Long ? void 0 !== a[t] && (a[t] = MathUtils_1.MathUtils.LongToBigInt(e[t])) : "object" == typeof e[t] ? ObjectUtils.DeepCopyValue(e[t], a[t]) : void 0 !== a[t] && (a[t] = e[t])
    })
  }
  ...
  static GetRandomArrayItem(e) {
    ...
    if (0 < a) {
      let t = 0;
      return 1 < a && (t = MathUtils_1.MathUtils.GetRandomRange(0, a), (t = Math.floor(t)) === a) && --t, e[t]
    }
  }
}
