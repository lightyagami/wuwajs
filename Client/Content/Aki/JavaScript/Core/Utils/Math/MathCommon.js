...
}(exports.MathCommon = MathCommon).ThreshPointOnPlane = .1, MathCommon.ThreshVectorNormalized = .01, MathCommon.ThreshPointAreSame = 2e-5, MathCommon.ThreshNormalsAreParallel = .999845, MathCommon.ThreshNormalsAreOrthogonal = .017455, MathCommon.SmallNumber = 1e-8, MathCommon.KindaSmallNumber = 1e-4, MathCommon.BigNumber = 34e37, MathCommon.Delta = 1e-5, MathCommon.MaxInt16 = 32767, MathCommon.RightAngle = 90, MathCommon.FlatAngle = 180, MathCommon.RoundAngle = 360, MathCommon.ProgressTotalValue = 100, MathCommon.DegToRad = Math.PI / MathCommon.FlatAngle, MathCommon.RadDividedBy2 = .5 * MathCommon.DegToRad, MathCommon.RadToDeg = MathCommon.FlatAngle / Math.PI;
