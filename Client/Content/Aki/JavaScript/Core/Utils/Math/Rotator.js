...
class Rotator {
  constructor(t, o, a) {
    this.iz = void 0, this.oz = void 0, this.Tuple = [t ?? 0, o ?? 0, a ?? 0]
  }
  ToString() {
  ...
  static Create(...t) {
    var o, a, r = new Rotator;
    return 1 === t.length && t[0] ? r.FromUeRotator(t[0]) : void 0 !== t[0] && "number" != typeof t[0] || (o = t[0], a = t[1], t = t[2], r.Set(o || 0, a || 0, t || 0)), r
  }
  ToUeRotator() {
    var t = this.Tuple;
    return void 0 === this.oz ? this.oz = new UE.Rotator(t[0], t[1], t[2]) : (this.oz.Pitch = t[0], this.oz.Yaw = t[1], this.oz.Roll = t[2]), this.oz
  }
  static NormalizeAxis(t) {
    let o = this.ClampAxis(t);
    return o > MathCommon_1.MathCommon.FlatAngle && (o -= MathCommon_1.MathCommon.RoundAngle), o
  }
  static ClampAxis(t) {
  ...
  Clamp(t) {
    var o = this.Tuple,
      a = t.Tuple;
    return a[0] = Rotator.ClampAxis(o[0]), a[1] = Rotator.ClampAxis(o[1]), a[2] = Rotator.ClampAxis(o[2]), t
  }
  Vector(t) {
    var o = this.Tuple,
      t = t.Tuple,
  ...
  Quaternion(t) {
    let o = t;
    o || (void 0 === this.iz && (this.iz = Quat_1.Quat.Create()), o = this.iz);
    var t = o.Tuple,
      ...
      m = +h * a * s - e * i * r,
      M = +h * a * r + e * i * s;
    return t[0] = +h * i * s - e * a * r, t[1] = n, t[2] = m, t[3] = M, o
  }
  IsNearlyZero() {
  ...
  Reset() {
    this.Pitch = 0, this.Yaw = 0, this.Roll = 0, this.oz && this.ToUeRotator()
  }
  ...
  static Lerp(t, o, a, r) {
    var h = r.Tuple,
      o = o.Tuple,
      t = t.Tuple;
    h[0] = o[0] - t[0], h[1] = o[1] - t[1], h[2] = o[2] - t[2], MathCommon_1.MathCommon.VectorNormalizeRotator(r), h[0] = h[0] * a, h[1] = h[1] * a, h[2] = h[2] * a, h[0] += t[0], h[1] += t[1], h[2] += t[2], MathCommon_1.MathCommon.VectorNormalizeRotator(r)
  }
  static AxisLerp(t, o, a) {
    o = (o = MathCommon_1.MathCommon.WrapAngle(o - t)) * a + t;
    return MathCommon_1.MathCommon.WrapAngle(o)
  }
}(exports.Rotator = Rotator).ZeroRotatorProxy = Rotator.Create(0, 0, 0), Rotator.ZeroRotator = Rotator.ZeroRotatorProxy.ToUeRotator();
