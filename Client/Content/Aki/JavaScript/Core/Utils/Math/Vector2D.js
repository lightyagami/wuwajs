...
class Vector2D {
  ...
  static Create(...t) {
    var r, e = new Vector2D;
    return 0 !== t.length && (1 === t.length && t[0] ? e.FromUeVector2D(t[0]) : void 0 !== t[0] && "number" != typeof t[0] || (r = t[0], t = t[1], e.Set(r, t))), e
  }
  ToUeVector2D(t = !1) {
    var r = this.Tuple;
    return this._z = Vector2D.uz.pop(), void 0 === this._z && (this._z = new UE.Vector2D), this._z.X = r[0], this._z.Y = r[1], t ? (r = this._z, Vector2D.uz.push(this._z), this._z = void 0, r) : this._z
  }
  Addition(t, r) {
    var e = this.Tuple,
      i = r.Tuple;
    return "number" == typeof t ? (i[0] = e[0] + t, i[1] = e[1] + t) : (t = t.Tuple, i[0] = e[0] + t[0], i[1] = e[1] + t[1]), r
  }
  AdditionEqual(t) {
    var r = this.Tuple;
    return "number" == typeof t ? (r[0] += t, r[1] += t) : (t = t.Tuple, r[0] += t[0], r[1] += t[1]), this
  }
  Subtraction(t, r) {
    var e = this.Tuple,
      i = r.Tuple;
  ...
  Division(t, r) {
    var e, i = this.Tuple,
      h = r.Tuple;
    return "number" == typeof t ? (h[0] = i[0] * (e = 1 / t), h[1] = i[1] * e) : (e = t.Tuple, h[0] = i[0] / e[0], h[1] = i[1] / e[1]), r
  }
  DivisionEqual(t) {
    var r, e = this.Tuple;
    return "number" == typeof t ? (e[0] *= r = 1 / t, e[1] *= r) : (r = t.Tuple, e[0] /= r[0], e[1] /= r[1]), this
  }
  UnaryNegation(t) {
    var r = this.Tuple,
      t = t.Tuple;
  ...
  GetSafeNormal(t, r = MathCommon_1.MathCommon.SmallNumber) {
    ...
    1 === e ? t.DeepCopy(this) : e < r ? t.Reset() : (r = 1 / Math.sqrt(e), this.Multiply(r, t))
  }
  DeepCopy(t) {
    this.Set(t.X, t.Y)
  }
  ...
  SphericalToUnitCartesian(t) {
    var r = this.Tuple,
      t = t.Tuple,
      e = Math.sin(r[0]);
    t[0] = Math.cos(r[1]) * e, t[1] = Math.sin(r[1]) * e, t[2] = Math.cos(r[0])
  }
  ...
  ToDirectionAndLength(t) {
    var r, e = this.Tuple,
      i = t.Tuple,
      h = this.Size();
    return h > MathCommon_1.MathCommon.SmallNumber ? (i[0] = e[0] * (r = 1 / h), i[1] = e[1] * r) : t.Reset(), h
  }
  Set(t, r) {
...
}(exports.Vector2D = Vector2D).uz = new Array(VECTOR2D_POOL_MAX_CAPACITY), Vector2D.ZeroVector = new UE.Vector2D(0, 0), Vector2D.UnitVector = new UE.Vector2D(1, 1), Vector2D.Unit45Deg = new UE.Vector2D(Math.SQRT1_2, Math.SQRT1_2);
