...
class Vector {
  constructor(t, r, h) {
    this.Tuple = [t ?? 0, r ?? 0, h ?? 0], this.hz = void 0, this.zvl = void 0
  }
  get X() {
    return this.Tuple[0]
  }
  ...
  ToUeVectorOld(t = !1) {
    var r = this.Tuple;
    return this.hz = Vector.lz.pop(), void 0 === this.hz && (this.hz = new UE.Vector), this.hz.Set(r[0], r[1], r[2]), t ? (r = this.hz, Vector.lz.push(this.hz), this.hz = void 0, r) : this.hz
  }
  ToUeVector(t = !1) {
    var r = this.Tuple;
    return this.zvl = Vector.Jvl.pop(), void 0 === this.zvl && (this.zvl = new UE.VectorDouble), this.zvl.Set(r[0], r[1], r[2]), t ? (r = this.zvl, Vector.Jvl.push(this.zvl), this.zvl = void 0, r) : this.zvl
  }
  ToString() {
  ...
  static Create(t, r, h) {
    var i = new Vector;
    return "number" == typeof t || void 0 === t ? i.Set(t || 0, r || 0, h || 0) : t && i.FromUeVector(t), i
  }
  DotProduct(t) {
    var r = this.Tuple,
      t = t.Tuple;
  ...
  DeepCopy(t) {
    var r = this.Tuple;
    r[0] = t.X, r[1] = t.Y, r[2] = t.Z, this.hz && this.ToUeVectorOld(), this.zvl && this.ToUeVector()
  }
  AdditionEqual(t) {
    var r = this.Tuple;
    return "number" == typeof t ? (r[0] += t, r[1] += t, r[2] += t) : (t = t.Tuple, r[0] += t[0], r[1] += t[1], r[2] += t[2]), this
  }
  SubtractionEqual(t) {
    var r = this.Tuple;
    return "number" == typeof t ? (r[0] -= t, r[1] -= t, r[2] -= t) : (t = t.Tuple, r[0] -= t[0], r[1] -= t[1], r[2] -= t[2]), this
  ...
  DivisionEqual(t) {
    var r, h = this.Tuple;
    return "number" == typeof t ? (h[0] *= r = 1 / t, h[1] *= r, h[2] *= r) : (r = t.Tuple, h[0] /= r[0], h[1] /= r[1], h[2] /= r[2]), this
  }
  Addition(t, r) {
    var h = this.Tuple,
      i = r.Tuple;
    return "number" == typeof t ? (i[0] = h[0] + t, i[1] = h[1] + t, i[2] = h[2] + t) : (t = t.Tuple, i[0] = h[0] + t[0], i[1] = h[1] + t[1], i[2] = h[2] + t[2]), r
  }
  Subtraction(t, r) {
    var h = this.Tuple,
      i = r.Tuple;
  ...
  Division(t, r) {
    var h, i = this.Tuple,
      a = r.Tuple;
    return "number" == typeof t ? (a[0] = i[0] * (h = 1 / t), a[1] = i[1] * h, a[2] = i[2] * h) : (h = t.Tuple, a[0] = i[0] / h[0], a[1] = i[1] / h[1], a[2] = i[2] / h[2]), r
  }
  Equality(t) {
    var r = this.Tuple,
      t = t.Tuple;
  ...
  Set(t, r, h) {
    var i = this.Tuple;
    i[0] = t, i[1] = r, i[2] = h, this.hz && this.ToUeVectorOld(), this.zvl && this.ToUeVector()
  }
  GetMax() {
    var t = this.Tuple;
  ...
  ComponentMin(t, r) {
    var h = this.Tuple,
      t = t.Tuple,
      r = r.Tuple;
    r[0] = Math.min(h[0], t[0]), r[1] = Math.min(h[1], t[1]), r[2] = Math.min(h[2], t[2])
  }
  ComponentMax(t, r) {
    var h = this.Tuple,
      t = t.Tuple,
      r = r.Tuple;
    r[0] = Math.max(h[0], t[0]), r[1] = Math.max(h[1], t[1]), r[2] = Math.max(h[2], t[2])
  }
  GetAbs(t) {
    var r = this.Tuple,
      t = t.Tuple;
  ...
  GetSafeNormal(t, r = MathCommon_1.MathCommon.SmallNumber) {
    ...
    1 === h ? t.DeepCopy(this) : h < r ? t.Reset() : (r = 1 / Math.sqrt(h), this.Multiply(r, t))
  }
  GetSafeNormal2D(t, r = MathCommon_1.MathCommon.SmallNumber) {
    var h = this.Tuple,
      i = t.Tuple,
      a = this.SizeSquared2D();
    1 === a ? t.DeepCopy(this) : a < r ? t.Reset() : (r = 1 / Math.sqrt(a), i[0] = h[0] * r, i[1] = h[1] * r), i[2] = 0
  }
  ToDirectionAndLength(t) {
    var r, h = this.Size();
    return h > MathCommon_1.MathCommon.SmallNumber ? (r = 1 / h, t.MultiplyEqual(this).MultiplyEqual(r)) : t.Reset(), h
  }
  GetSignVector(t) {
    var r = this.Tuple,
      t = t.Tuple;
    t[0] = MathCommon_1.MathCommon.FloatSelect(r[0], 1, -1), t[1] = MathCommon_1.MathCommon.FloatSelect(r[1], 1, -1), t[2] = MathCommon_1.MathCommon.FloatSelect(r[2], 1, -1)
  }
  Projection(t) {
    var r = this.Tuple,
      t = t.Tuple,
  ...
  GridSnap(t, r) {
    var h = this.Tuple,
      r = r.Tuple;
    r[0] = t ? Math.floor((h[0] + .5 * t) / t) * t : r[0], r[1] = t ? Math.floor((h[1] + .5 * t) / t) * t : r[0], r[2] = t ? Math.floor((h[2] + .5 * t) / t) * t : r[0]
  }
  BoundToCube(t, r) {
    var h = this.Tuple,
      r = r.Tuple;
    r[0] = MathCommon_1.MathCommon.Clamp(h[0], -t, t), r[1] = MathCommon_1.MathCommon.Clamp(h[1], -t, t), r[2] = MathCommon_1.MathCommon.Clamp(h[2], -t, t)
  }
  BoundToBox(t, r, h) {
    var i = this.Tuple,
      h = h.Tuple,
      t = t.Tuple,
      r = r.Tuple;
    h[0] = MathCommon_1.MathCommon.Clamp(i[0], t[0], r[0]), h[1] = MathCommon_1.MathCommon.Clamp(i[1], t[1], r[1]), h[2] = MathCommon_1.MathCommon.Clamp(i[2], t[2], r[2])
  }
  GetClampedToSize(t, r, h) {
    var i = this.Size();
    i > MathCommon_1.MathCommon.SmallNumber ? this.Division(i, h) : h.Reset(), i = MathCommon_1.MathCommon.Clamp(i, t, r), h.MultiplyEqual(i)
  }
  GetClampedToSize2D(t, r, h) {
    var i = this.Tuple,
      a = h.Tuple,
      o = this.Size2D();
    o > MathCommon_1.MathCommon.SmallNumber ? h.DivisionEqual(this).DivisionEqual(o) : h.Reset(), o = MathCommon_1.MathCommon.Clamp(o, t, r), a[0] = a[0] * o, a[1] = a[1] * o, a[2] = i[2]
  }
  GetClampedToMaxSize(t, r) {
    var h;
    t < MathCommon_1.MathCommon.KindaSmallNumber ? r.Reset() : (h = this.SizeSquared()) > Math.pow(t, 2) ? (t = t / Math.sqrt(h), this.Multiply(t, r)) : r.DeepCopy(this)
  }
  GetClampedToMaxSize2D(t, r) {
    var h, i = this.Tuple,
      a = r.Tuple;
    a[2] = i[2], t < MathCommon_1.MathCommon.KindaSmallNumber ? a[0] = a[1] = 0 : (h = this.SizeSquared2D()) > Math.pow(t, 2) ? (t = +t / Math.sqrt(h), a[0] = i[0] * t, a[1] = i[1] * t) : r.DeepCopy(this)
  }
  ...
  Reciprocal(t) {
    var r = this.Tuple,
      t = t.Tuple;
    t[0] = 0 !== r[0] ? 1 / r[0] : MathCommon_1.MathCommon.BigNumber, t[1] = 0 !== r[1] ? 1 / r[1] : MathCommon_1.MathCommon.BigNumber, t[2] = 0 !== r[2] ? 1 / r[2] : MathCommon_1.MathCommon.BigNumber
  }
  ...
  RotateAngleAxis(t, r, h) {
    var i = this.Tuple,
      ...
      V = i[1],
      i = i[2];
    h[0] = (a * o + t) * C + (a * n - r) * V + (a * M + u) * i, h[1] = (a * n + r) * C + (a * e + t) * V + (a * c - m) * i, h[2] = (a * M - u) * C + (a * c + m) * V + (a * s + t) * i
  }
  CosineAngle2D(t, r = MathCommon_1.MathCommon.KindaSmallNumber) {
    var h, i = this.Tuple[0],
      a = this.Tuple[1],
      o = t.Tuple[0],
      t = t.Tuple[1],
      e = i * i + a * a;
    return e <= r || (h = o * o + t * t) <= r ? 0 : (i * o + a * t) / Math.sqrt(e * h)
  }
  ProjectOnTo(t, r) {
  ...
  ToOrientationRotator(t) {
    t.Yaw = Math.atan2(this.Tuple[1], this.Tuple[0]) * MathCommon_1.MathCommon.RadToDeg, t.Pitch = Math.atan2(this.Tuple[2], this.Size2D()) * MathCommon_1.MathCommon.RadToDeg, t.Roll = 0
  }
  ToOrientationQuat(t) {
  ...
  FindBestAxisVectors(t, r) {
    var h = this.Tuple,
      ...
      o = Math.abs(h[1]),
      e = Math.abs(h[2]),
      a = (a < e && o < e ? (i[0] = 1, i[1] = i[2] = 0) : (i[0] = i[1] = 0, i[2] = 1), this.DotProduct(t)),
      o = i[0] - h[0] * a,
      e = i[1] - h[1] * a,
      h = i[2] - h[2] * a,
      a = o * o + e * e + h * h;
    1 == a ? (i[0] = o, i[1] = e, i[2] = h) : a < MathCommon_1.MathCommon.SmallNumber ? t.Reset() : (a = 1 / Math.sqrt(a), i[0] = o * a, i[1] = e * a, i[2] = h * a), t.CrossProduct(this, r)
  }
  UnwindEuler() {
    var t = this.Tuple;
    t[0] = MathCommon_1.MathCommon.UnwindDegrees(t[0]), t[1] = MathCommon_1.MathCommon.UnwindDegrees(t[1]), t[2] = MathCommon_1.MathCommon.UnwindDegrees(t[2])
  }
  ContainsNaN() {
    var t = this.Tuple;
  ...
  static CreateOrthonormalBasis(t, r, h) {
    var i = t.Tuple,
      ...
      i = (i[0] -= e * o[0], i[1] -= e * o[1], i[2] -= e * o[2], a[0] -= s * o[0], a[1] -= s * o[1], a[2] -= s * o[2], MathCommon_1.MathCommon.Delta * MathCommon_1.MathCommon.Delta);
    t.SizeSquared() < i && r.CrossProduct(h, t), r.SizeSquared() < i && t.CrossProduct(h, r), t.Normalize(), r.Normalize(), h.Normalize()
  }
  ...
  static RadiansToDegrees(t, r) {
    t = t.Tuple, r = r.Tuple;
    r[0] = t[0] * MathCommon_1.MathCommon.RadToDeg, r[1] = t[1] * MathCommon_1.MathCommon.RadToDeg, r[2] = t[2] * MathCommon_1.MathCommon.RadToDeg
  }
  static DegreesToRadians(t, r) {
    t = t.Tuple, r = r.Tuple;
    r[0] = t[0] * MathCommon_1.MathCommon.DegToRad, r[1] = t[1] * MathCommon_1.MathCommon.DegToRad, r[2] = t[2] * MathCommon_1.MathCommon.DegToRad
  }
  Reset() {
    var t = this.Tuple;
    t[0] = 0, t[1] = 0, t[2] = 0, this.hz && this.ToUeVectorOld(), this.zvl && this.ToUeVector()
  }
  DeepCopy2D(t) {
    var r = this.Tuple,
      t = t.Tuple;
    t[0] = r[0], t[1] = r[1], t[2] = 0, this.hz && this.ToUeVectorOld(), this.zvl && this.ToUeVector()
  }
  SineAngle2D(t, r = MathCommon_1.MathCommon.KindaSmallNumber) {
    ...
    let i = h[0],
      ...
      o = t[0],
      e = t[1];
    h = i * i + a * a, r < h && (t = 1 / Math.sqrt(h), i *= t, a *= t), h = o * o + e * e;
  ...
  static DirectLerp(t, r, h, i) {
    ...
    Quat_1.Quat.FindBetween(t, r, a), Quat_1.Quat.Slerp(Quat_1.Quat.IdentityProxy, a, h, a), a.RotateVector(t, i)
  }
  static DirectLerpWithAngle(t, r, h, i) {
    var a, o = Vector.DotProduct(t, r),
      o = Math.acos(o) * MathCommon_1.MathCommon.RadToDeg;
    o < h ? i.DeepCopy(r) : (a = Quat_1.Quat.Create(), Quat_1.Quat.FindBetween(t, r, a), Quat_1.Quat.Slerp(Quat_1.Quat.IdentityProxy, a, h / o, a), a.RotateVector(t, i))
  }
  static Lerp(t, r, h, i) {
    h = MathCommon_1.MathCommon.Clamp(h, 0, 1);
    r.Subtraction(t, this.dHo), this.dHo.MultiplyEqual(h), this.dHo.Addition(t, i)
  }
