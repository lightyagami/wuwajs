...
exports.dataTablePaths = new Map([
  ...
  [2, "/Game/Aki/Character/Monster/Common/Data/DT_AiWeaponSocket.DT_AiWeaponSocket"],
  ...
  [8, "/Game/Aki/Data/Interaction/CDT_InteractionConfigs.CDT_InteractionConfigs"],
  [9, "/Game/Aki/Data/Manipulate/Item/DT_Manipulate_Item.DT_Manipulate_Item"],
  [10, "/Game/Aki/Data/Manipulate/Precast/DT_Manipulate_Precast.DT_Manipulate_Precast"],
  ...
  [15, "/Game/Aki/Data/UiCameraAnimation/DT_UiCameraAnimationBlendSettings.DT_UiCameraAnimationBlendSettings"],
  [16, "/Game/Aki/Data/UiCameraAnimation/DT_UiCameraSetting.DT_UiCameraSetting"],
  [17, "/Game/Aki/Character/Vision/DT_Vision.DT_Vision"],
  [18, "/Game/Aki/Data/UiRoleCamera/DT_UiRoleCameraSettings.DT_UiRoleCameraSettings"],
  [19, "/Game/Aki/Data/UiRoleCamera/DT_UiRoleCameraOffsetSettings.DT_UiRoleCameraOffsetSettings"],
  ...
  [22, "/Game/Aki/Data/Camera/DT_FightSettlementCamera.DT_FightSettlementCamera"],
  [23, "/Game/Aki/Data/Fight/DT_InputCommandTransform.DT_InputCommandTransform"],
...
class DataTableUtil {
  static GetDataTableRow(a, e) {
    if (a && e) {
      ...
      if (cpp_1.FKuroDataTableFunctionLibrary.GetDataTableRowFromName(a, e, t)) return (0, puerts_1.$unref)(t)
    }
  }
  static GetDataTableRowFromName(a, e) {
    ...
    if (a && e) {
      var t = (0, puerts_1.$ref)(void 0);
      if (cpp_1.FKuroDataTableFunctionLibrary.GetDataTableRowFromName(a, e, t)) return (0, puerts_1.$unref)(t);
      Log_1.Log.CheckWarn() && Log_1.Log.Warn("DataTableUtil", 43, "获取预加载DT行配置失败", ["RowName", e])
    }
  }
  static xJ(a) {
    var e, t = DataTableUtil.wJ.get(a);
  ...
  static GetAllDataTableRowFromTableWithRowName(a) {
    ...
    if (a) {
      ...
      for (const r of t) {
        ...
        i ? e.push([r, i]) : Log_1.Log.CheckInfo() && Log_1.Log.Info("DataTableUtil", 36, "[GetAllDataTableRowFromTableWithRowName]GetRowValue Failed", ["Table", a?.GetName()], ["RowName", r])
      }
    }
    return e
  }
