...
class JsModelManager {
  static InitializeEnvironment() {
    ...
    t ? (cpp_1.FModelManager.InitializeEnvironment(t), this.HasInitialized = !0) : Log_1.Log.CheckInfo() && Log_1.Log.Info("Core", 36, "JsModelManager.InitializeEnvironment Fail!!!")
  }
  ...
  static get di_() {
    return this.mi_ || (this.mi_ = cpp_1.FModelManager.GetEntityModel()), this.mi_
  }
  static AddEntity(t) {
...
}(exports.JsModelManager = JsModelManager).HasInitialized = !1, JsModelManager.ui_ = void 0, JsModelManager.mi_ = void 0;
