...
exports.SwitcherManager = undefined;
...
class SwitcherManager {
  static Initialize() {
    this.AllSwitcher.set("特效生成Log", [() => EffectGlobal_1.EffectGlobal.EnableSpawnLog, e => {
      EffectGlobal_1.EffectGlobal.EnableSpawnLog = e;
    }]);
    this.AllSwitcher.set("打开TOD时间同步", [() => TimeOfDayController_1.TimeOfDayController.IsSyncToEngine, e => {
