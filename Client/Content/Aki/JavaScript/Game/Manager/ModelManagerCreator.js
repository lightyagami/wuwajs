...
const TDInputModel_1 = require("../KuroSimpleCombat/TDInput/TDInputModel");
const TDPlayerModel_1 = require("../KuroSimpleCombat/TDPlayer/TDPlayerModel");
...
class ModelManagerCreator {
  static Init() {
    ...
    ModelManager_1.ModelManager.TowerDefensePlayerModel = new TDPlayerModel_1.TowerDefensePlayerModel();
    ModelManager_1.ModelManager.Add(ModelManager_1.ModelManager.TowerDefensePlayerModel);
    ModelManager_1.ModelManager.TowerDefenseInputModel = new TDInputModel_1.TowerDefenseInputModel();
    ModelManager_1.ModelManager.Add(ModelManager_1.ModelManager.TowerDefenseInputModel);
  ...
  static Clear() {
    ...
    ModelManager_1.ModelManager.TowerDefensePlayerModel = undefined;
    ModelManager_1.ModelManager.TowerDefenseInputModel = undefined;
    ModelManager_1.ModelManager.GreatSwordChallengeModel = undefined;
    ModelManager_1.ModelManager.ActivityFunPlayModel = undefined;
    return !(ModelManager_1.ModelManager.AvoidanceModel = undefined);
  }
}
