...
class FragmentedCluesView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.uwn = void 0, this.cwn = void 0, this.mwn = void 0, this.eBo = 0, this.dwn = 0, this.Cwn = () => {
      this.gwn(), this.eBo--, this.eBo < 0 && (this.eBo = 0), this.Og()
    }, this.fwn = () => {
      this.gwn(), this.eBo++, this.eBo > this.dwn - 1 && (this.eBo = this.dwn - 1), this.Og()
  ...
  OnBeforeShow() {
    ...
    this.dwn = this.uwn.length, this.eBo = 0, this.uwn[this.eBo] = !0, this.Og()
  }
  Og() {
