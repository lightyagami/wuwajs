...
class ObtainFragmentView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Jwn = void 0, this.tWt = () => {
      var e = this.Jwn.GetTopicData();
      if (e.GetUnlockState()) {
        var i = ConfigManager_1.ConfigManager.FragmentMemoryConfig.GetFragmentMemoryPreNeedItemId();
        let e = 1;
        0 < (e = 0 < i ? ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(i) : e) ? this.CloseMe(() => {
          var e = new FragmentMemoryData_1.FragmentMemoryMainViewOpenData;
          e.FragmentMemoryTopicData = this.Jwn.GetTopicData(), e.CurrentSelectId = this.Jwn.GetId(), ModelManager_1.ModelManager.FragmentMemoryModel.MemoryFragmentMainViewTryPlayAnimation = "Start02", UiManager_1.UiManager.OpenView("MemoryFragmentMainView", e)
        }) : ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("Condition_13000069_Description")
      } else ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId(e.GetConditionDesc())
    }
  }
  OnRegisterComponent() {
  ...
  OnBeforeShow() {
    var e = this.ChildPopView.PopItem,
      e = (e && ((e = e).SetCaptionTitleVisible(!1), e.SetCaptionTitleIconVisible(!1)), this.OpenParam);
    this.Jwn = ModelManager_1.ModelManager.FragmentMemoryModel.GetCollectDataById(e), ModelManager_1.ModelManager.FragmentMemoryModel.CurrentUnlockCollectId = 0, this.Og()
  }
  Og() {
