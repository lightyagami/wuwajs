...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.FragmentMemoryMainViewOpenData = exports.FragmentMemoryTopicData = exports.FragmentMemoryCollectData = void 0;
...
class FragmentMemoryCollectData {
  ...
  Phrase(e) {
    this.xe = e.s5n, this.ige = e.o5n, this._be = Number(MathUtils_1.MathUtils.LongToBigInt(e.kBs)) / 1e3, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FragmentRewardRedDot, this.xe)
  }
  GetTimeText() {
...
class FragmentMemoryTopicData {
  ...
  Phrase(t) {
    ...
    for (const i of t.NBs) {
      var e = new FragmentMemoryCollectData,
        r = (e.Phrase(i), ConfigManager_1.ConfigManager.FragmentMemoryConfig.GetPhotoMemoryCollectById(i.s5n));
      e.PhraseFromConfig(r), e.BindSourceTopic(this), this.nwn.push(e)
    }
    var n;
    for (const t of ConfigManager_1.ConfigManager.FragmentMemoryConfig.GetPhotoMemoryCollectConfigListByTopicId(this.xe)) this.nwn.find(e => e.GetId() === t.Id) || ((n = new FragmentMemoryCollectData).PhraseFromConfig(t), n.BindSourceTopic(this), this.nwn.push(n));
    this.nwn.sort((e, t) => e.GetRank() - t.GetRank()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FragmentRewardTopicRedDot, this.xe)
  }
  GetFirstOpen() {
  ...
  GetRedDotState() {
    ...
    for (const e of this.nwn)
      if (e.GetIfCanGetReward()) return !0;
    return !1
  }
