...
exports.FragmentMemoryConfig = undefined;
...
class FragmentMemoryConfig extends ConfigBase_1.ConfigBase {
  ...
  GetPhotoMemoryCollectConfigListByTopicId(e) {
    return PhotoMemoryCollectByTopicID_1.configPhotoMemoryCollectByTopicID.GetConfigList(e);
  }
  ...
  GetTopicNotOpenTexturePath() {
    return CommonParamById_1.configCommonParamById.GetStringConfig("FragmentMemoryNotOpenTexture");
  }
  GetTopicNotOpenTextureLightPath() {
    return CommonParamById_1.configCommonParamById.GetStringConfig("FragmentMemoryNotOpenLightTexture");
  }
  GetFragmentMemoryPreNeedItemId() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("OpenFragmentNeedItem");
  }
}
