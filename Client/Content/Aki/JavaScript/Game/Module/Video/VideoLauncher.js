...
class VideoLauncher {
  static ShowVideoCg(e, i, o, r, a = !1) {
    e ? VideoLauncher.ShowVideoCgAsync(e, i, o, r, a) : i()
  }
  static async ShowVideoCgAsync(e, i, o, r, a) {
    ...
    if (n)
      if (this.pDe = {
          ...
          BackgroundColor: o,
          RemainViewWhenEnd: r
        }, Log_1.Log.CheckInfo() && Log_1.Log.Info("Video", 38, "打开视频播放界面", ["视频配置", e]), UiManager_1.UiManager.IsViewShow("VideoView")) EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.PlayVideo, this.pDe);
      else if (a) {
...
exports.VideoLauncher = VideoLauncher, (_a = VideoLauncher).PNo = void 0, VideoLauncher.pDe = void 0, VideoLauncher.Bto = () => {
  var e;
