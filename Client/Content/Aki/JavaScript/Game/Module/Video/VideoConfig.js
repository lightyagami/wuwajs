...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.VideoConfig = exports.VideoQteConfig = exports.VideoSubtitle = void 0;
...
class VideoSubtitle {
  constructor(e, o, i, r) {
    this.ShowMoment = e, this.Duration = o, this.CaptionText = i, this.CaptionId = r
  }
}
...
class VideoConfig extends ConfigBase_1.ConfigBase {
  ...
  GetVideoData(e) {
    ...
    return i || Log_1.Log.CheckError() && Log_1.Log.Error("Video", 38, "找不到cg视频配置！", ["名称", e]), i
  }
  GetVideoCaptions(e, o) {
    var i = VideoCaptionByCgName_1.configVideoCaptionByCgName.GetConfigList(e);
    if (!i || 0 === i.length) return Log_1.Log.CheckWarn() && Log_1.Log.Warn("Video", 38, "找不到cg字幕配置！", ["名称", e]), [];
    const r = [];
    switch (o) {
      case "en":
        i.forEach(e => {
          0 !== e.DurationEn && r.push(new VideoSubtitle(e.ShowMomentEn, e.DurationEn, e.CaptionText, e.CaptionId))
        });
        break;
      case "ja":
        i.forEach(e => {
          0 !== e.DurationJa && r.push(new VideoSubtitle(e.ShowMomentJa, e.DurationJa, e.CaptionText, e.CaptionId))
        });
        break;
      case "ko":
        i.forEach(e => {
          0 !== e.DurationKo && r.push(new VideoSubtitle(e.ShowMomentKo, e.DurationKo, e.CaptionText, e.CaptionId))
        })
    }
  ...
  GetVideoQte(e, o) {
    ...
    switch (o) {
      case "en":
        i.forEach(e => {
          0 !== e.ShowMomentEn && r.push(new VideoQteConfig(e.ShowMomentEn, e.QteId))
        });
        break;
      case "ja":
        i.forEach(e => {
          0 !== e.ShowMomentJa && r.push(new VideoQteConfig(e.ShowMomentJa, e.QteId))
        });
        break;
      case "ko":
        i.forEach(e => {
          0 !== e.ShowMomentKo && r.push(new VideoQteConfig(e.ShowMomentKo, e.QteId))
        })
    }
    return 0 < r.length ? r : i
  }
  ...
  GetVideoSounds(o) {
    ...
    if (!i || 0 === i.length) {
      ...
      2 === e && (e = 0), i = VideoSoundByCgNameAndGirlOrBoy_1.configVideoSoundByCgNameAndGirlOrBoy.GetConfigList(o, e)
    }
    return i && 0 !== i.length ? i : (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Video", 38, "找不到cg字幕配置！", ["名称", o]), [])
  }
}
