...
exports.GenericPromptConfig = undefined;
const UE = require("ue");
...
class GenericPromptConfig extends ConfigBase_1.ConfigBase {
  GetPromptTypeMainTextObj(e) {
    return new LguiUtil_1.TableTextArgNew(this.GetPromptTypeInfo(e).GeneralText);
  }
  GetPromptTypeMainTextColor(e) {
    e = this.GetPromptTypeInfo(e).TextColor;
    if (e) {
      return UE.Color.FromHex(e);
    }
  }
  GetPromptTypeExtraTextObj(e) {
    return new LguiUtil_1.TableTextArgNew(this.GetPromptTypeInfo(e).GeneralExtraText);
  }
  ...
  GetPromptInfo(e) {
    return GenericPromptByTipsId_1.configGenericPromptByTipsId.GetConfig(e.toString());
  }
  ...
  GetPromptMainTextObjByRawId(e) {
    return new LguiUtil_1.TableTextArgNew(this.GetPromptInfoByRawId(e).TipsText);
  }
  GetPromptTypeInfo(e) {
    return GenericPromptTypesByTypeId_1.configGenericPromptTypesByTypeId.GetConfig(e);
  }
  GetPriority(e) {
    var r;
    if (!e.PromptId || (r = this.GetPromptInfo(e.PromptId).Priority) === 0) {
      return this.GetPromptTypeInfo(e.TypeId).Priority;
    } else {
      return r;
    }
  }
