...
class ChapterBattleDeclarationTips extends GenericPromptFloatTipsBase_1.GenericPromptFloatTipsBase {
  ...
  OnRegisterComponent() {
    super.OnRegisterComponent(), this.ComponentRegisterInfos.push([2, UE.UITexture])
  }
  _Jt(e) {
    this.aJt = QuestChapterById_1.configQuestChapterById.GetConfig(e), this.aJt || Log_1.Log.CheckError() && Log_1.Log.Error("Quest", 65, "策划的章节Id配错了！！", ["错误的章节Id", e])
  }
  SetExtraText(...e) {
    e = e[0];
    this._Jt(e), this.aJt && this.SetTextureByPath(this.aJt.ChapterIcon, this.GetTexture(2))
  }
}
