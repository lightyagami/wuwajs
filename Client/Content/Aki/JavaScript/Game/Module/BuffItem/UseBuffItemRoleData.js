...
class UseBuffItemRoleData {
  constructor(t, e, r, i, s, o, u, a) {
    this.X0t = 0, this.RoleName = t, this.Position = e, this.RoleConfigId = r, this.RoleLevel = i, this.CurrentAttribute = s, this.MaxAttribute = o, this.UseItemConfigId = u, this.Entity = a
  }
  ...
  AddUseItemCount() {
    ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(this.UseItemConfigId) <= this.X0t || this.X0t++
  }
  ReduceUseItemCount() {
    this.X0t <= 1 || this.X0t--
  }
  ...
  GetUseItemMaxCount() {
    var t = ModelManager_1.ModelManager.InventoryModel,
      ...
      t = t.GetItemDataBaseByConfigId(this.UseItemConfigId)[0].GetUseCountLimit();
    ...
    if (0 === o)
      for (const g of t.RoutineExpirationEffects) {
        ...
        for (const I of s) {
          ...
          f ? (a = this.J0t(e, f.RelatedProperty), void 0 === (n = f.CureBaseValue[0]) ? Log_1.Log.CheckWarn() && Log_1.Log.Warn("BuffItem", 37, "计算Buff道具治疗生命数值时，结算表对应行的CureBaseValue为空", ["Buff配置", t]) : (f = f.RateLv[0]) ? (f = f / TEN_THOUSANDTH_RATIO, r += n + a * f) : r += n) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("BuffItem", 37, "计算Buff道具治疗生命数值时，找不到结算表对应配置", ["结算表Id", h], ["Buff配置", t])
        } else if (101 === o) {
