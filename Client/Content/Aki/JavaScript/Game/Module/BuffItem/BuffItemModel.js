...
class BuffItemModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.F0t = new Map, this.lnt = new Map, this.K4l = new Map, this.V0t = 0, this.H0t = void 0, this.j0t = void 0, this.W0t = 0, this.K0t = e => {
      this.GetBuffItemRemainCdTime(this.W0t) <= 0 && (this.j0t && this.j0t(), this.Q0t())
    }
  }
  OnInit() {
    return !0
  ...
  SetBuffItemCdTimeStamp(e, t, i) {
    ...
    s ? (s.SetEndCdTimeStamp(t), s.SetTotalCdTime(i)) : this.NewBuffItemData(e, t, i)
  }
  SetBuffItemCdEndCallback(e, t) {
    this.GetBuffItemData(e) && (this.W0t = e, this.j0t = t, this.H0t = TimerSystem_1.TimerSystem.Forever(this.K0t, TimeUtil_1.TimeUtil.InverseMillisecond))
  }
  Q0t() {
    TimerSystem_1.TimerSystem.Has(this.H0t) && TimerSystem_1.TimerSystem.Remove(this.H0t), this.W0t = 0, this.j0t = void 0, this.H0t = void 0
  }
  ...
  GetEquippedBuffsByRoleId(e, t = !1) {
    var i = new Array;
    for (const s of ConfigManager_1.ConfigManager.BuffItemConfig.GetBuffEquipItemByRoleId(e)) !this.IsEquippedBuffItem(s.ItemId) || t && !s.EnableInUI || i.push(...s.Buffs);
    return i
  }
  GetEquippedBuffItemConfigByRoleId(e) {
    var t = new Array;
    for (const i of ConfigManager_1.ConfigManager.BuffItemConfig.GetBuffEquipItemByRoleId(e)) this.IsEquippedBuffItem(i.ItemId) && t.push(i);
    return t
  }
}
