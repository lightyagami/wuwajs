...
class BuffTargetRoleItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    ...
    this.uft = (t, i, e) => {
      var s;
      if (i !== e && this.z0t) {
        s = this.z0t.Entity.GetComponent(184).GetCurrentValue(EAttributeId.l5n);
  ...
  c$e() {
    if (this.z0t) {
      this.z0t.Entity.GetComponent(184).AddListener(EAttributeId.Proto_Life, this.uft, "Life.BuffTargetRoleItem");
    }
  }
  m$e() {
    if (this.z0t) {
      this.z0t.Entity.GetComponent(184).RemoveListener(EAttributeId.Proto_Life, this.uft);
    }
  }
