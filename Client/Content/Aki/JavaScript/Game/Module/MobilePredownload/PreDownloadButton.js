...
class PreDownloadButtonItemA extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.YP = () => {
      ControllerHolder_1.ControllerHolder.PreDownloadController.OnPreDownloadBtnClick(!0)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e = !1) {
    e && (ModelManager_1.ModelManager.PreDownloadModel.IsPreDownloadAvailable() || ModelManager_1.ModelManager.PreDownloadModel.IsComplete()) ? (this.SetUiActive(!0), e = ModelManager_1.ModelManager.PreDownloadModel.IsComplete() ? "PreDownload_Complete_Btn_Text" : "PreDownload_Downloading_Btn_Text", LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e)) : this.SetUiActive(!1)
  }
  RefreshDot() {
...
class PreDownloadButtonItemB extends UiPanelBase_1.UiPanelBase {
  ...
  BindRedDot() {
    var e = this.GetItem(0),
      e = (RedDotController_1.RedDotController.BindRedDot("PreDownload", e), this.GetItem(1));
    RedDotController_1.RedDotController.BindRedDot("PreDownloadComplete", e)
  }
  UnBindRedDot() {
    var e = this.GetItem(0),
      e = (RedDotController_1.RedDotController.UnBindGivenUi("PreDownload", e), this.GetItem(1));
