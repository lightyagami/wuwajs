...
class MarkPriority2HierarchyIndexHelper {
  ...
  RemoveMarkItem(e, r) {
    ...
    this.d3o.filter(e => e.Priority === a).every(e => (0 < e.MaxHierarchyIndex && --e.MaxHierarchyIndex, !0))
  }
  ClearData() {
    this.d3o.length = 0
  }
}
exports.MarkPriority2HierarchyIndexHelper = MarkPriority2HierarchyIndexHelper, exports.onlinePlayerIconPathList = ["SP_MapFollowing1", "SP_MapFollowing2", "SP_MapFollowing3"], exports.onlinePlayerIconPathList2 = ["SP_IconMap_Mark_1P_UI", "SP_IconMap_Mark_2P_UI", "SP_IconMap_Mark_3P_UI"];
