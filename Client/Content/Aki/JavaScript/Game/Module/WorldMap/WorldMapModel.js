...
class WorldMapModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.LevelEventDisableFlag = !1, this.CustomMarkSize = 0, this.MapScale = -0, this.MapScaleMin = -0, this.MapScaleMax = -0, this.zNl = !0, this.JNl = !0, this.ghl = void 0, this.CurrentFocalMarkType = 0, this.CurrentFocalMarkId = 0, this.WorldMapId = void 0, this.WorldMapCurrentMultiMapId = void 0, this.LastBigSceneMiniMapInfo = void 0, this.IsBattleViewOpen = !1, this.WorldMapAxisInteractValidation = new WorldMapAxisInteractValidation_1.WorldMapAxisInteractValidation, this.NDl = new Map, this.FDl = new Map, this.sGl = 0, this.MapRangeInfo = void 0, this.NavigateMarkShowRangeInfo = void 0, this.EnableInstanceDungeonFilterMark = !1, this.jlc = new TrimLru_1.TrimLru(3e3), this.Ofc = void 0, this.PendingOpenWorldMapQuestId = void 0, this.HideQuickTransferConfirmBox = !1, this.p3o = void 0, this.GEr = !1
  }
  ...
  OnInit() {
    return this.CustomMarkSize = ConfigManager_1.ConfigManager.WorldMapConfig.GetCommonValue("custom_mark_size"), this.ResetMapScale(), this.WorldMapAxisInteractValidation.Init(), this.sGl = 1e3 * (CommonParamById_1.configCommonParamById.GetFloatConfig("SoundBoxSfxCoolTime") ?? 0), this.WorldMapId = void 0, this.LastBigSceneMiniMapInfo = void 0, this.JNl = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsShowFinishedPlayPointMark, !0), this.zNl = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsShowCustomMark, !0), !0
  }
  OnClear() {
    return this.WorldMapAxisInteractValidation.Clear(), this.NDl.clear(), this.FDl.clear(), MapLogger_1.MapLogger.Clear(), !0
  }
  OnLeaveLevel() {
    return !0
  }
  ResetMapScale() {
    ...
    e && (this.MapScaleMax = e.BigMapMaxScale / e.BigMapDefaultScale, this.MapScaleMin = e.BigMapMinScale / e.BigMapDefaultScale)
  }
  GetEntityPosition(e, r) {
    var t = r + "_" + e;
    let o = this.jlc.Get(t);
    var a = Vector_1.Vector.Create();
    return o ? a.FromUeVector(o) : (r = ConfigManager_1.ConfigManager.MapConfig.GetEntityConfigByMapIdAndEntityId(r, e)?.Transform[0], o = r ? Vector_1.Vector.Create(r.X, r.Y, r.Z) : Vector_1.Vector.Create(0, 0, 0), this.jlc.Put(t, o), a.FromUeVector(o)), a
  }
  GetEntityAreaId(e, r) {
  ...
  SetCompletedPlayPointMarkShow(e) {
    return this.JNl !== e && (this.JNl = e, LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsShowFinishedPlayPointMark, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ToggleShowCompletedPlayMark, e), !0)
  }
  SetCustomMarksShow(e) {
    return this.zNl !== e && (this.zNl = e, LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsShowCustomMark, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ToggleShowCustomMark, e), !0)
  }
  GetPlayerPosition() {
    var e;
    return ModelManager_1.ModelManager.MapModel.CurrentInWorld ? (e = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity?.Entity?.GetComponent(3)) ? Vector_1.Vector.Create(e.ActorLocationProxy) : Vector_1.Vector.Create() : MapUtil_1.MapUtil.GetLastBigScenePlayerPosition()
  }
  IsPlayerInInstanceDungeon() {
    ...
    return !(e === Protocol_1.Aki.Protocol.i4s.Proto_BigWorldInstance && 13 === r)
  }
  ...
  get CurrentWorldMapInstanceId() {
    return void 0 === this.WorldMapId || this.WorldMapId === ModelManager_1.ModelManager.MapModel.CurrentMapConfigId ? ModelManager_1.ModelManager.CreatureModel.GetInstanceId() : this.WorldMapId
  }
  GetCurrentLocateWorldMapInstanceId(e) {
    return void 0 === this.WorldMapId ? ModelManager_1.ModelManager.CreatureModel.GetInstanceId() : this.WorldMapId === ModelManager_1.ModelManager.MapModel.CurrentWorldMapConfigId ? e && (e = ModelManager_1.ModelManager.MapModel.GetDungeonEntranceConfig(ModelManager_1.ModelManager.GameModeModel.InstanceDungeon)) ? e.Id : ModelManager_1.ModelManager.CreatureModel.GetInstanceId() : this.WorldMapId
  }
  ...
  SetWorldMapSelectedGravity(e, r) {
    return this.WorldMapSelectGravity = this.GetFinalWorldMapGravity(e, r), this.WorldMapSelectGravity
  }
  GetFinalWorldMapGravity(e, r) {
    return this.IsGravityMap(e) ? void 0 !== r && 0 !== r ? r : ModelManager_1.ModelManager.MapModel.CurrentPlayerGravity : 1
  }
  IsGravityMap(e) {
