...
class TemporaryTeleportPanel extends WorldMapSecondaryUiLayoutB_1.WorldMapSecondaryUiLayoutB {
  constructor() {
    super(...arguments), this.u2o = void 0, this.OnMiddleCenterBtnClick = () => {
      MapController_1.MapController.RequestTeleportToTargetByTemporaryTeleport(this.u2o.TeleportId), this.Close()
    }, this.OnDelBtnClick = () => {
      this.Yuc()
    }, this.zuc = () => {
      ControllerHolder_1.ControllerHolder.MapExploreToolController.RemoveTemporaryTeleportRequest(this.u2o.TeleportId, this.u2o.MarkId), this.Close()
    }
  }
  GetResourceId() {
