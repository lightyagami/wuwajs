...
class WeeklyRogueEntrancePanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.RewardsView = void 0, this.tli = 0, this.u2o = void 0, this.U2o = void 0, this.IRe = void 0, this.OnInstanceRefresh = (e, i, t, r) => {
  ...
  x2o() {
    this.jqe(), this.h4i(), this.hea(), this.IRe && TimerSystem_1.TimerSystem.Remove(this.IRe), this.IRe = TimerSystem_1.TimerSystem.Forever(() => {
      this.h4i()
    }, 1e3)
  }
  h4i() {
    if (ModelManager_1.ModelManager.WeeklyRogueModel.ActivityData) {
      ...
      var i = this.GetRemainTime(),
        i = (e.SetRightText(i), StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_Rogue_Time") ?? "", ""));
      e.SetLeftText(i), e.SetHelpButtonVisible(!1)
    }
  }
  hea() {
    var e, i = ModelManager_1.ModelManager.WeeklyRogueModel?.ActivityData;
