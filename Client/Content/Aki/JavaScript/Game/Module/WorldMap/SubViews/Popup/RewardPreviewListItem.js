...
class RewardItem extends LoopScrollSmallItemGrid_1.LoopScrollSmallItemGrid {
  ...
  OnRefresh(e, t, r) {
    this.ConfigId = e[0];
    var i = e[1];
    if (1 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.ConfigId)) {
...
class RewardPreviewListItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ScrollViewDelegate = void 0, this.GridIndex = 0, this.DisplayIndex = 0, this.X2o = void 0, this.$2o = void 0, this.Y2o = () => new RewardItem
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, r) {
    ...
    var e = this.X2o[0],
      ...
      o = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "World_Level_Text", e), this.GetItem(1).SetUIActive(a), []),
      e = ModelManager_1.ModelManager.CalabashModel.GetCalabashLevel(),
      s = ConfigManager_1.ConfigManager.CalabashConfig?.GetCalabashConfigByLevel(e);
    for (const d of i.DropPreview) {
      ...
      n && n.ShowTypes.includes(ItemDefines_1.CALABASH_ITEM_SHOW_TYPE) && l <= 0 || o.push(d)
    }
