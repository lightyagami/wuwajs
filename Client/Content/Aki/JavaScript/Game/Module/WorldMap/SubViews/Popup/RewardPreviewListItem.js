...
exports.RewardPreviewListItem = exports.RewardItem = undefined;
const UE = require("ue");
...
class RewardItem extends LoopScrollSmallItemGrid_1.LoopScrollSmallItemGrid {
  ...
  OnRefresh(e, t, r) {
    ...
    if (ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.ConfigId) === 1) {
      var a = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(this.ConfigId);
      const o = {
        Data: e,
        Type: 2,
...
class RewardPreviewListItem extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(e, t, r) {
    ...
    var a = e === ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel;
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "World_Level_Text", e);
    this.GetItem(1).SetUIActive(a);
    var o = [];
    var e = ModelManager_1.ModelManager.CalabashModel.GetCalabashLevel();
    var s = ConfigManager_1.ConfigManager.CalabashConfig?.GetCalabashConfigByLevel(e);
    for (const d of i.DropPreview) {
      var n = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(d[0]);
      var l = s.QualityDropWeight.get(n.QualityId) ?? 0;
      if (!n || !n.ShowTypes.includes(ItemDefines_1.CALABASH_ITEM_SHOW_TYPE) || !(l <= 0)) {
        o.push(d);
      }
    }
    o.sort((e, t) => e[0] - t[0]);
    this.$2o?.RefreshByData(o);
  }
  Clear() {}
  OnSelected(e) {}
  OnDeselected(e) {}
