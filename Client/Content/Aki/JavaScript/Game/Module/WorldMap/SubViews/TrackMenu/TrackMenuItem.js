...
class TrackMenuItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.FNl = void 0, this.LevelSequencePlayer = void 0, this.OnClick = e => {
      1 === e && this.PlayReleaseSequence().then(() => {
        EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.TrackMenuClickItem, this.FNl)
      }, () => {})
    }
  }
  async Init(e, t) {
    e.SetUIActive(!0), await this.CreateThenShowByActorAsync(e.GetOwner()), this.FNl = t, this.MAi()
  }
  OnStart() {
  ...
  MAi() {
    this.SetSpriteByPath(this.FNl.Icon, this.GetSprite(1), !1), this.FNl.MarkItem ? this.FNl.MarkItem.SetTitleText(this.GetText(2)) : this.FNl.Title && this.GetText(2)?.SetText(this.FNl.Title)
  }
  async OnBeforeHideAsync() {
    return this.PlayDisappearSequence()
  }
  OnBeforeDestroy() {
    this.GetExtendToggle(0).OnStateChange.Clear(), this.LevelSequencePlayer && this.LevelSequencePlayer.Clear(), this.LevelSequencePlayer = void 0
  }
