...
class WorldMapNoteItemNew extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.DNl = void 0, this.eTt = () => {
  ...
  Refresh(t) {
    ...
    s = t.NoteStyle;
    this.GetItem(3).SetUIActive(0 === s), this.GetItem(6).SetUIActive(0 === s), this.GetItem(4).SetUIActive(1 === s), this.GetItem(5).SetUIActive(1 === s)
  }
}
