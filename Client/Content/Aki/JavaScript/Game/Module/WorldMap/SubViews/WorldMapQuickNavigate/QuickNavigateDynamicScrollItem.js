...
class QuickNavigateDynamicScrollItem extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    ...
    var e = this.GetItem(0).GetOwner(),
      e = (await this.AYa.CreateThenShowByActorAsync(e, void 0, !0), this.DYa = new QuickNavigateItemPanelB_1.QuickNavigateItemPanelB, this.GetItem(1).GetOwner());
    await this.DYa.CreateThenShowByActorAsync(e, void 0, !0)
  }
  GetUsingItem(e) {
    return 0 === e.ItemType ? this.cma(0) : 1 === e.ItemType ? this.cma(1) : void 0
  }
  cma(e) {
  ...
  Update(e, t) {
    var i = 0 === e.ItemType;
    this.AYa.SetActive(i), this.DYa.SetActive(!i), (i ? this.AYa : this.DYa).RefreshByData(e)
  }
  ClearItem() {
    this.Destroy()
  }
