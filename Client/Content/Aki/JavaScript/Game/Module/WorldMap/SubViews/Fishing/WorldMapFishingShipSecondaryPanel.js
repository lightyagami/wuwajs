...
class WorldMapFishingShipSecondaryPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  ...
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.LayoutContext.AreaText.SetUIActive(!1), this.LayoutContext.PanelListLayout.RootUIComp.SetUIActive(!1)
  }
  OnShowWorldMapSecondaryUi(e) {
    this.LayoutContext.MarkItem = e, WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateIconAndTitle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateDesc(this.LayoutContext), this.LayoutContext.ConfirmButtonItem.SetLocalTextNew("Fishing_FastOnBoat"), this.bn_(), this.UpdateQuickGotoActive(!1)
  }
  bn_() {
    var e = [this.An_()];
