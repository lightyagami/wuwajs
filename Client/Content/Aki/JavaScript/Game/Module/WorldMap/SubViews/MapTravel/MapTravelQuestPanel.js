...
class MapTravelQuestPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.u2o = void 0, this.RewardsView = void 0, this.Ieh = void 0, this.OnConfirmBtnClick = () => {
      this.HandleTrack()
    }
  }
  GetResourceId() {
  ...
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.GetVerticalLayout(7).RootUIComp.SetUIActive(!1), this.GetVerticalLayout(5).RootUIComp.SetUIActive(!1), this.GetText(36).SetUIActive(!1), this.GetItem(14).SetUIActive(!1)
  }
  OnShowWorldMapSecondaryUi(e) {
    this.u2o = e, this.LayoutContext.MarkItem = e, this.Ieh.SetUiActive(!1), this.ConfirmButton.SetActive(!1), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateConfirmButtonTextWithTrackStyle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateTrackButtonTextWithTrackStyle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateIconAndTitle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateDesc(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateAreaAndIconByConfigOrDynamicConfigMarkItem(this.LayoutContext), this.UpdateQuickGotoActive(!0), this.LYa()
  }
  LYa() {
    var e, a = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfigByMapMarkId(this.u2o.MarkId);
    a && (e = a.QuestId, e = 1 === (e = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e)) || 2 === e, this.GetItem(14).SetUIActive(e), this.GetItem(37).SetUIActive(e), e) && LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(38), a.MapDesc)
  }
}
