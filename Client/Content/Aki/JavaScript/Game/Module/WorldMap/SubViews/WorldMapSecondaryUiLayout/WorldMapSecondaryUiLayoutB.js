...
class WorldMapSecondaryUiLayoutB extends WorldMapSecondaryUi_1.WorldMapSecondaryUi {
  ...
  OnStart() {
    ...
    this.LeftConfirmBtn = new ButtonAndTextItem_1.ButtonAndTextItem(this.GetItem(7));
    this.LeftConfirmBtn.BindCallback(this.OnLeftConfirmBtnClick);
    this.RightConfirmBtn = new ButtonAndTextItem_1.ButtonAndTextItem(this.GetItem(8));
