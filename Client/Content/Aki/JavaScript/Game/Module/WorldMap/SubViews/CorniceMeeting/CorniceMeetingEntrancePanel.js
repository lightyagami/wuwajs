...
class CorniceMeetingEntrancePanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.c2o = void 0, this.OnConfirmBtnClick = () => {
      this.Close(() => {
  ...
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.GetItem(32).SetUIActive(!1), this.GetVerticalLayout(7).RootUIComp.SetUIActive(!1)
  }
  OnBeforeDestroy() {
    this.c2o.Clear(), super.OnBeforeDestroy()
  }
  OnShowWorldMapSecondaryUi(e) {
    this.LayoutContext.MarkItem = e, WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateIconAndTitle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateAreaTxtByConfigMarkItem(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateDesc(this.LayoutContext), this.l_i(), this.l3e()
  }
