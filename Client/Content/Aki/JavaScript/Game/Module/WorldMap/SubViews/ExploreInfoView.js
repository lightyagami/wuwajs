...
class ExploreProgressView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.D2o = void 0, this.R2o = (e, i, r) => {
  ...
  OnAfterShow() {
    var e = ModelManager_1.ModelManager.WorldMapModel.GetAreaExploreInfo(),
      ...
      i = (this.GetText(1).SetText(i), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "ExplorationDegree", e.ExplorePercent), ModelManager_1.ModelManager.WorldMapModel.GetAreaExploreInfo());
...
class ExploreProgressItem extends UiPanelBase_1.UiPanelBase {
  ...
  Update(e) {
    var i = ConfigManager_1.ConfigManager.WorldMapConfig.GetExploreProgressInfoById(e.ExploreProgressId),
      i = ConfigManager_1.ConfigManager.ExploreProgressConfig.GetExploreTypeByType(i.ExploreType);
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), i.Name);
    let r = 0;
    e.ExplorePercent && (r = e.ExplorePercent), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "ExplorationDegree", r);
