...
class GeneralPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.u2o = void 0, this.H2o = void 0, this.RewardsView = void 0, this.Ieh = void 0, this.OnCreateDifficultyItem = () => new DifficultyItem, this.OnConfirmBtnClick = () => {
  ...
  async OnBeforeStartAsync() {
    return this.RewardsView = new RewardItemBar_1.RewardItemBar, await this.RewardsView.CreateThenShowByActorAsync(this.GetItem(8).GetOwner()), this.Ieh = new PopupListItemPanel_1.PopupListItemPanel, await this.Ieh.CreateThenShowByActorAsync(this.GetItem(6).GetOwner()), super.OnBeforeStartAsync()
  }
  OnStart() {
    this.H2o = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(16), this.OnCreateDifficultyItem), this.H2o.SetActive(!1), super.OnStart()
  }
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.GetVerticalLayout(7).RootUIComp.SetUIActive(!1), this.Ieh.SetUiActive(!1), this.GetVerticalLayout(5).RootUIComp.SetUIActive(!1), this.GetItem(14).SetUIActive(!1), this.GetText(36).SetUIActive(!1), this.GetItem(25).SetUIActive(!1)
  }
  OnShowWorldMapSecondaryUi(e) {
    this.u2o = e, this.LayoutContext.MarkItem = e, WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateConfirmButtonTextWithFastMoveStyle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateTrackButtonTextWithTrackStyle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateIconAndTitle(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateDesc(this.LayoutContext), WorldMapSecondaryUiLayoutHelper_1.WorldMapSecondaryUiLayoutHelper.UpdateAreaAndIconByConfigOrDynamicConfigMarkItem(this.LayoutContext), this.UpdateTopRightIconActive(), this.Ieh.SetTxtRTxtColor("#ac8839"), this.UpdateEnableFastMoveLayout(), this.LYa()
  }
  LYa() {
  ...
  Zah() {
    var e = this.u2o.MarkConfig.RelativeId,
      e = ModelManager_1.ModelManager.MingSuModel.GetDarkCoastDeliveryDataByLevelPlayId(e),
      t = e.GetDarkCoastDeliveryGuardState(),
      e = (this.GetItem(14).SetUIActive(!0), this.H2o.SetActive(!0), this.H2o.RefreshByData([e]), 3 === t),
      t = 4 === t;
  ...
  ehh() {
    this.GetItem(14).SetUIActive(!0), this.GetVerticalLayout(5).RootUIComp.SetUIActive(!0), this.Ieh.SetUiActive(!0), this.Ieh.SetBtnHelpA2Active(!1), this.Ieh.SetIconActive(!1);
  ...
  mZa() {
    ...
    if (e) {
      ...
      this.RewardsView.RebuildRewardsByData(i), this.RewardsView.SetTitleNewTxt("ExploreNextLv_Text")
    } else this.RewardsView.RebuildRewardsByData([]), this.RewardsView.SetTitleNewTxt("ExploreLvFull_Text")
  }
  OnBeforeDestroy() {
...
class DifficultyItem extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(e, t, i) {
    var r = 4 === e.GetDarkCoastDeliveryGuardState() ? "T_MapDifficultyTick" : "T_MapDifficultyEmpty",
      r = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(r);
    this.SetTextureByPath(r, this.GetTexture(1)), this.GetText(0).SetUIActive(!0), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "DarkShoreBossFirst_Text"), this.GetItem(2).SetUIActive(!0), this.GetText(3).SetUIActive(!0), this.GetText(3).SetText(e.Config.RewardCount + "x")
  }
  Clear() {}
  OnSelected(e) {}
  OnDeselected(e) {}
