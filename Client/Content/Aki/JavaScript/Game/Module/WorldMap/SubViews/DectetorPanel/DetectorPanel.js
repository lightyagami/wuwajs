...
class DetectorPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.u2o = void 0, this.OnDelBtnClick = () => {
      ...
      MapExploreToolController_1.MapExploreToolController.RemoveTreasureBoxSlotRequest(r), this.Close()
    }
  }
  GetResourceId() {
  ...
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.GetItem(12).SetUIActive(!1), this.GetItem(2).SetUIActive(!1), this.GetVerticalLayout(7).RootUIComp.SetUIActive(!1), this.GetItem(6).SetUIActive(!1), this.GetVerticalLayout(5).RootUIComp.SetUIActive(!1), this.LayoutContext.DelButton.RootUIComp.SetUIActive(!0), this.LayoutContext.ConfirmButtonItem.SetUiActive(!1)
  }
