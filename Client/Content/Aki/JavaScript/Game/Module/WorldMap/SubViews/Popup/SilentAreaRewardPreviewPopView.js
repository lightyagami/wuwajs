...
class SilentAreaRewardPreviewPopView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.J2o = 0, this.T8e = void 0, this.z2o = () => new RewardPreviewListItem_1.RewardPreviewListItem
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.T8e = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(2), this.z2o), this.J2o = this.OpenParam, LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "SilentArea_rewardinfo")
  }
  OnBeforeShow() {
    this.Wni()
  }
  Wni() {
    var e = [];
    for (const w of ExchangeRewardById_1.configExchangeRewardById.GetConfig(this.J2o).RewardId) e.push(w);
    e.sort((e, i) => e[0] - i[0]);
    var i, r, t = [],
