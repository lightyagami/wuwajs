...
exports.SilentAreaRewardPreviewPopView = undefined;
const UE = require("ue");
...
class SilentAreaRewardPreviewPopView extends UiViewBase_1.UiViewBase {
  ...
  OnStart() {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "SilentArea_rewardinfo");
  }
  OnBeforeShow() {
    this.Wni();
  }
  Wni() {
    var e = [];
    for (const w of ExchangeRewardById_1.configExchangeRewardById.GetConfig(this.J2o).RewardId) {
      e.push(w);
    }
    e.sort((e, i) => e[0] - i[0]);
    var i;
