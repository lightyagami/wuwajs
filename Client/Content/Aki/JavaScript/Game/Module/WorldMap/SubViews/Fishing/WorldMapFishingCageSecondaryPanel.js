...
class WorldMapFishingCageSecondaryPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  ...
  Ln_() {
    return {
      Name: "",
      Desc: "",
      RelativeId: this.LayoutContext.MarkItem.MarkItemEntity.GetComponent(15).MapMarkConfig.RelativeId,
      TipItemType: 0
    }
  }
  An_() {
