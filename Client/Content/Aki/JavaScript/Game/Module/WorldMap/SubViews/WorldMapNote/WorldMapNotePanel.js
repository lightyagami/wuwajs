...
class WorldMapNotePanel extends WorldMapSecondaryUi_1.WorldMapSecondaryUi {
  ...
  OnStart() {
    this.zJa = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.zJa.SetCloseCallBack(this.Close), this.jNl = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), () => new WorldMapNoteItemNew_1.WorldMapNoteItemNew)
  }
