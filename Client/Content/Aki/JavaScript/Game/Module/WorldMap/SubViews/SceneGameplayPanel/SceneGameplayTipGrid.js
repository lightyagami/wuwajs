...
class SceneGameplayTipGrid extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.OnClickPreviewCall = void 0, this.uFo = void 0, this.a_i = !1, this.h_i = [], this.aFo = () => {
  ...
  Refresh(i, t, e = !1, s = !1, r = !1) {
    this.uFo = i, e ? this.cFo(t) : this.qEi(t), this.GetItem(4)?.SetUIActive(r), this.Yli(s)
  }
  ...
  Yli(e = !1) {
    ...
    if (this.a_i) {
      ...
      for (const l of this.uFo) {
        let i = this.h_i[t];
        i || ((i = new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid).Initialize(LguiUtil_1.LguiUtil.DuplicateActor(r, h)), this.h_i.push(i)), i.RefreshByConfigId(l[0], l[1], void 0, e), i.SetActive(!0), t++
      }
      s = this.uFo.size
    }
