...
class ParkourEntrancePanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.u2o = void 0, this.c2o = void 0, this.OnConfirmBtnClick = () => {
      this.HandleTrack()
    }
  }
  GetResourceId() {
  ...
  l3e() {
    var e = ModelManager_1.ModelManager.ActivityRunModel.GetChallengeDataByMarkId(this.u2o.MarkConfigId),
      r = ParkourChallengeByMarkId_1.configParkourChallengeByMarkId.GetConfig(this.u2o.MarkId),
      t = this.c2o.AddItemByKey(LINE_NUMBER_KEY),
      r = (t.SetLeftText(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("CurrentLine") ?? ""), StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("LineNumber") ?? "", r.Id.toString())),
      r = (t.SetRightText(r), t.SetHelpButtonVisible(!1), this.c2o.AddItemByKey(SCORE_KEY)),
      t = (r.SetHelpButtonVisible(!1), StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_ActiveRunMaxPoint_Text") ?? "", ""));
    r.SetLeftText(t), 0 === e.GetMiniTime() ? r.SetRightText(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_ActivityRunNoPoint_Text") ?? "") : r.SetRightText(e.GetMaxScore().toString())
  }
}
