...
class PunishReportPanel extends WorldMapSecondaryUiLayoutA_1.WorldMapSecondaryUiLayoutA {
  constructor() {
    super(...arguments), this.u2o = void 0, this.z7a = void 0, this.OnConfirmBtnClick = () => {
      this.HandleTeleport()
    }
  }
  GetResourceId() {
  ...
  OnStart() {
    this.z7a = new PunishReportTargetListPanel_1.PunishReportTargetListPanel, this.z7a.Initialize(this.GetVerticalLayout(16)), super.OnStart()
  }
  async OnBeforeShowWorldMapSecondaryUiAsync(r) {
    var e;
    28 === r.MarkType && (this.SetActive(!1), e = r.MarkConfig.RelativeDungeonId, r = r.MarkConfig.RelativeId, await ControllerHolder_1.ControllerHolder.LevelPlayReportController.CheckAndRequestLevelPlayVarAsync(e, r))
  }
  SetupWorldMapSecondaryUiLayout() {
    super.SetupWorldMapSecondaryUiLayout(), this.GetVerticalLayout(7).RootUIComp.SetUIActive(!1), this.GetItem(6).SetUIActive(!1), this.GetVerticalLayout(5).RootUIComp.SetUIActive(!1)
  }
