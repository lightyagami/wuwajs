...
class PopupRightItemA extends PopupTypeRightItem_1.PopupTypeRightItem {
  ...
  async OnBeforeStartAsync() {
    this.zJa = new PopupCaption_1.PopupCaption, this.zJa.OnCloseCall = this.OnClickCloseBtn, await this.zJa.CreateByActorAsync(this.GetItem(2).GetOwner()), this.AddChild(this.zJa)
  }
  SetTitleIcon(t) {
