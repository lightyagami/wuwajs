...
const MapComponent_1 = require("../../Map/Base/MapComponent"),
  ...
  worldMapSecondaryPanelCtorMap = new Map([
    [WorldMapDefine_1.ESecondaryPanel.CustomMarkPanel, CustomMarkPanel_1.CustomMarkPanel],
    ...
    [WorldMapDefine_1.ESecondaryPanel.ParkourPanel, ParkourEntrancePanel_1.ParkourEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.LordGymPanel, LordGymPanel_1.LordGymPanel],
    [WorldMapDefine_1.ESecondaryPanel.SceneGameplayPanel, SceneGameplayPanel_1.SceneGameplayPanel],
    [WorldMapDefine_1.ESecondaryPanel.TemporaryTeleportPanel, TemporaryTeleportPanel_1.TemporaryTeleportPanel],
    [WorldMapDefine_1.ESecondaryPanel.DetectorPanel, DetectorPanel_1.DetectorPanel],
    [WorldMapDefine_1.ESecondaryPanel.BoxPanel, BoxPanel_1.BoxPanel],
    [WorldMapDefine_1.ESecondaryPanel.EnrichmentAreaPanel, EnrichmentAreaPanel_1.EnrichmentAreaPanel],
    [WorldMapDefine_1.ESecondaryPanel.PunishReportPanel, PunishReportPanel_1.PunishReportPanel],
    [WorldMapDefine_1.ESecondaryPanel.TeleportPanel, TeleportPanel_1.TeleportPanel],
    [WorldMapDefine_1.ESecondaryPanel.InstanceDungeonEntrancePanel, InstanceDungeonEntrancePanel_1.InstanceDungeonEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.TowerEntrancePanel, TowerEntrancePanel_1.TowerEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.ShipTowerEntrancePanel, ShipTowerEntrancePanel_1.ShipTowerEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.RoguelikePanel, RoguelikeEntrancePanel_1.RoguelikeEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.WeeklyRoguePanel, WeeklyRogueEntrancePanel_1.WeeklyRogueEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.RogueResPanel, RogueResMapEntrancePanel_1.RogueResMapEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.CorniceMeetingPanel, CorniceMeetingEntrancePanel_1.CorniceMeetingEntrancePanel],
    [WorldMapDefine_1.ESecondaryPanel.QuickNavigatePanel, WorldMapQuickNavigatePanel_1.WorldMapQuickNavigatePanel],
    [WorldMapDefine_1.ESecondaryPanel.CaveHole, CaveHoleSecondaryPanel_1.CaveHoleSecondaryPanel],
    [WorldMapDefine_1.ESecondaryPanel.CommonGamePlayPanel, CommonGamePlayPanel_1.CommonGamePlayPanel],
    [WorldMapDefine_1.ESecondaryPanel.TrackMenuPanel, TrackMenuPanel_1.TrackMenuPanel],
    [WorldMapDefine_1.ESecondaryPanel.WorldMapNotePanel, WorldMapNotePanel_1.WorldMapNotePanel],
    [WorldMapDefine_1.ESecondaryPanel.MapMarkTogglePanel, MapMarkTogglePanel_1.MapMarkTogglePanel],
    [WorldMapDefine_1.ESecondaryPanel.MapTravelQuestPanel, MapTravelQuestPanel_1.MapTravelQuestPanel],
    [WorldMapDefine_1.ESecondaryPanel.FishingShip, WorldMapFishingShipSecondaryPanel_1.WorldMapFishingShipSecondaryPanel],
    [WorldMapDefine_1.ESecondaryPanel.FishingPoint, WorldMapFishingPointSecondaryPanel_1.WorldMapFishingPointSecondaryPanel],
    [WorldMapDefine_1.ESecondaryPanel.FishingCage, WorldMapFishingCageSecondaryPanel_1.WorldMapFishingCageSecondaryPanel],
    [WorldMapDefine_1.ESecondaryPanel.FishingDock, WorldMapFishingDockSecondaryPanel_1.WorldMapFishingDockSecondaryPanel]
  ]);
class WorldMapSecondaryUiComponent extends MapComponent_1.MapComponent {
  ...
  IsInternalSecondaryUiOpen() {
    for (var [, e] of this.vFo)
      if (e instanceof WorldMapSecondaryUi_1.WorldMapSecondaryUi && !e.IsUiCloseComplete) return !0;
    return !1
  }
  ...
  async EFo(e, n, ...a) {
    ...
    o ? o.MarkForOpen() : (e = worldMapSecondaryPanelCtorMap.get(e), o = new e, this.vFo.set(r, o), o.MarkForOpen(), await o.CreateByResourceIdAsync(o.GetResourceId(), n));
    e = o, r = this.NYa.Map;
