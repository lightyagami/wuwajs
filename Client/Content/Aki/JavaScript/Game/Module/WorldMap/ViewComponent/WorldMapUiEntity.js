...
class WorldMapUiEntity extends MapEntity_1.MapEntity {
  constructor() {
    super(...arguments), this.jYa = void 0, this.WYa = void 0, this.QYa = void 0, this.ClickedItem = void 0, this.du_ = new MapGamePlayRequestPreemptiveFrameQueue_1.MapGamePlayRequestPreemptiveFrameQueue(200), this.f8_ = new MapUpdateTaskPreemptiveFrameQueue_1.MapUpdateTaskPreemptiveFrameQueue(1500), this.n4o = (s, r, a) => {
      if (this.ClickedItem) this.MoveComponent.PushMap(this.ClickedItem, !1);
        ...
        a = 0 === s ? 1 : r / s;
        i ? (t = h.SubtractionEqual(i).MultiplyEqual(a).AdditionEqual(i), n && (e = n.SubtractionEqual(i).MultiplyEqual(a).AdditionEqual(i))) : (t = h.MultiplyEqual(a), n && (e = n.MultiplyEqual(a))), this.MoveComponent.SetMapPositionCauseByScaling(t, e, 2)
      }
    }, this.MarkEdgeSize = void 0, this.OnMarkItemTrackStateChanged = t => {
      ...
      this.WorldMapStreamingComponent.Update(), this.UpdateMarkItems(!0)
    }, this.g5l = () => {
  ...
  get IsInPlayerMap() {
    ...
    if (t) {
      t = t.AreaId, t = ConfigManager_1.ConfigManager.AreaConfig.GetLevelOneAreaId(t), t = ConfigManager_1.ConfigManager.AreaConfig.GetAreaInfo(t);
  ...
  Reset(t = !0) {
    var e;
    this.ScaleComponent.Initialize(), this.InitSelfPlayerMark(), this.SecondaryUiComponent.IsSecondaryUiOpening || (this.OpenParams && this.OpenParams.IsNotFocusTween && (e = this.Map.GetMarkItem(this.OpenParams.MarkType, this.OpenParams.MarkId)) && (this.OpenParams.StartScale = this.ScaleComponent.MapScale, this.OpenParams.StartWorldPosition = Vector2D_1.Vector2D.Create(-e.UiPosition.X * this.OpenParams.StartScale, -e.UiPosition.Y * this.OpenParams.StartScale)), this.OpenParams?.StartScale && this.ScaleComponent.SetMapScale(this.OpenParams.StartScale, 6, !1), this.OpenParams?.StartWorldPosition ? t && this.MoveComponent.SetMapPosition(this.OpenParams.StartWorldPosition, !1) : ModelManager_1.ModelManager.MapModel.CurrentInWorld ? this.IsInPlayerMap && (this.UpdateSelfPlayerMark(), t) && this.MoveComponent.FocusPlayer(this.PlayerComponent.PlayerUiPosition, !1, 1) : this.fdl(t)), this.WorldMapStreamingComponent.BindAll(this.Map.GetAllMapTileItems()), this.WorldMapStreamingComponent.Update(), this.OnPlayerMarkPositionChanged(), this.UpdateMarkItems(), this.SecondaryUiComponent.AllSecondaryPanelsUpdateMap()
  }
  RegisterComponents() {
    this.ViewPortSize = WorldMapUtil_1.WorldMapUtil.GetViewportSize(), this.AddComponent(1), this.AddComponent(2), this.AddComponent(3), this.AddComponent(5), this.AddComponent(6), this.AddComponent(7), this.AddComponent(8), this.AddComponent(9), this.AddComponent(4).ScaleChangeEvent = this.n4o, EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnMarkItemTrackStateChange, this.OnMarkItemTrackStateChanged), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.MarkForceVisibleChanged, this.kH_), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ScenePlayerLocationChanged, this.OnPlayerMarkPositionChanged), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnMapMarkTaskComplete, this.Fll), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldMapPositionChanged, this.a4o), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldMapUpdateMultiMap, this.g5l)
  }
  OnDispose() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnMarkItemTrackStateChange, this.OnMarkItemTrackStateChanged), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.MarkForceVisibleChanged, this.kH_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ScenePlayerLocationChanged, this.OnPlayerMarkPositionChanged), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnMapMarkTaskComplete, this.Fll), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldMapPositionChanged, this.a4o), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldMapUpdateMultiMap, this.g5l), this.du_.Dispose(), this.f8_.Dispose(), this.Map = void 0
  }
  OnTick() {
  ...
  s4o() {
    ...
    if (e) {
      let t = void 0;
      if (Info_1.Info.IsInKeyBoard() ? t = Vector2D_1.Vector2D.Create(e.GetCursorPosition()) : Info_1.Info.IsInTouch() && (t = this.InteractComponent.MultiTouchOriginCenter), t) {
        var i, e = UiLayer_1.UiLayer.UiRootItem.GetCanvasScaler();
        if (e) return e = e.ConvertPositionFromViewportToLGUICanvas(t.ToUeVector2D()), (i = WorldMapUtil_1.WorldMapUtil.GetViewportSizeByPool()).Set(e.X - i.X / 2, e.Y - i.Y / 2), i
      }
    }
  }
  InitSelfPlayerMark() {
    ...
    e.SetUIActive(t), t && e.SetAsLastHierarchy(), this.dBc()
  }
  dBc() {
    var t = ModelManager_1.ModelManager.WorldMapModel.IsGravityMap(this.MapId),
      e = this.Map.PlayerArrow;
    t && !this.IsInPlayerGravity ? (e.SetAlpha(.4), this.Map.SetPlayerGravityActive(!0, ModelManager_1.ModelManager.MapModel.CurrentPlayerGravity)) : (e.SetAlpha(1), this.Map.SetPlayerGravityActive(!1))
  }
  UpdateSelfPlayerMark() {
    ...
    var t = this.PlayerComponent.PlayerRotation,
      ...
      t = (this.Map.PlayerArrow.SetUIRelativeRotation(new UE.Rotator(0, t, 0)), this.MoveComponent.MapUiPosition),
      s = Vector2D_1.Vector2D.Create(),
      [e, i] = (e.Multiply(i, s).Addition(t, s), this.ClampToMarkEdge(s)),
      r = this.Map.PlayerOutOfBoundIndicator;
    i ? (this.PlayerComponent.PlayerOutOfBound = !0, this.Map.SelfPlayerNode.SetAnchorOffset(e.SubtractionEqual(t).DivisionEqual(this.ScaleComponent.MapScale).ToUeVector2D(!0)), e = Math.atan2(s.Y, s.X) * RAD_2_DEG - DEG_PI_4, r.SetUIRelativeRotation(new UE.Rotator(0, e, 0))) : (this.PlayerComponent.PlayerOutOfBound = !1, this.Map.SelfPlayerNode.SetAnchorOffset(this.PlayerComponent.PlayerUiPosition.ToUeVector2D())), r.SetUIActive(i)
  }
  fdl(t = !0) {
    this.UpdateSelfPlayerMark(), t && (t = MapUtil_1.MapUtil.GetLastBigScenePlayerUiPosition(), this.MoveComponent.FocusPlayer(t, !1, 1))
  }
  ClampToMarkEdge(t) {
    var e, i = this.MarkEdgeSize;
    return Math.abs(t.X) < i.X && Math.abs(t.Y) < i.Y ? [t, !1] : (e = Vector2D_1.Vector2D.Create(), Math.abs(t.X / t.Y) > i.X / i.Y ? t.Multiply(i.X / Math.abs(t.X), e) : t.Multiply(i.Y / Math.abs(t.Y), e), [e, !0])
  }
  pdl(t) {
    return !(!t.PermanentUpdate && !this.WorldMapStreamingComponent.HandleStreamingUpdate(t))
  }
  g8_(t, e = !1) {
    if (t.PermanentUpdate || this.ScaleComponent.IsScaleDirty) this.UpdateSingleMarkItem(t, !0);
    else {
      const i = {
