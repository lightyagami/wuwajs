...
class WorldMapStreamingComponent extends MapComponent_1.MapComponent {
  constructor() {
    super(...arguments), this.Z__ = new Set, this.e1_ = new Map, this.t1_ = Vector2D_1.Vector2D.Create()
  }
  get ComponentType() {
    return 8
  }
  ...
  HandleStreamingUpdate(t) {
    var e = this.IsInStreamingRange(t),
      n = this.e1_.get(t);
    return void 0 !== e && e === n || (this.e1_.set(t, e), (t.IsVisible = e) ? t.OnLoad() : t.OnUnload()), e
  }
  IsInStreamingRange(t) {
    var e, n, r, o;
    return !t.IsStreaming || (n = this.NYa.MoveComponent, e = this.NYa.OutOfViewPortSize, n = n.MapUiPosition, o = t.GetUiPosition(), r = ModelManager_1.ModelManager.WorldMapModel.MapScale, this.t1_.Set(o.X * r + n.X, o.Y * r + n.Y), o = t.GetPreloadThreshold(), Math.abs(this.t1_.X) <= e.X + o.X && Math.abs(this.t1_.Y) <= e.Y + o.Y)
  }
}
