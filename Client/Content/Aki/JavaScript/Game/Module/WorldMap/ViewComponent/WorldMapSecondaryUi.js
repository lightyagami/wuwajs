...
class WorldMapSecondaryUi extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.UiBgItem = void 0, this.a3o = void 0, this.jHa = 0, this.Map = void 0, this.h3o = void 0, this.K3t = e => {
      "Close" === e && this.Gh_()
    }, this.Close = (e, t = !0) => {
      this.h3o = e, this.jHa = 1, t ? this.SPe.PlayLevelSequenceByName("Close") : this.Gh_()
    }
  }
  get IsUiOpen() {
    return 0 === this.jHa
  ...
  get SPe() {
    var e;
    return this.a3o || (e = this.UiBgItem?.GetRootItem() ?? this.GetRootItem(), this.a3o = new LevelSequencePlayer_1.LevelSequencePlayer(e), this.a3o.BindSequenceCloseEvent(this.K3t)), this.a3o
  }
  OnBeforeCreate() {
  ...
  CheckAndShowCrossMapTips(e) {
    e.IsTracked || MapHelper_1.MapHelper.CheckAndShowCrossMapTips(e.MarkId, e.MarkType, e.TrackAreaId, e.WorldPosition)
  }
}
