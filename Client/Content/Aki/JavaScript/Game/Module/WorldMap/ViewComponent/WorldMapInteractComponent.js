...
class WorldMapInteractComponent extends MapComponent_1.MapComponent {
  constructor() {
    super(...arguments), this.SFo = !1, this.yFo = !1, this.IFo = -0, this.TFo = !1, this.LFo = !1, this.DFo = !1, this.RFo = "", this.UFo = Vector2D_1.Vector2D.Create(), this.AFo = void 0, this.PFo = void 0, this.xFo = -0, this.wFo = void 0, this.Ngo = t => {
      this.SFo = !1, t && !this.IsMultiFingerControl && this.bFo(t.pointerPosition) && (t = this.qFo(t.pointerPosition.X, t.pointerPosition.Y), this.AFo.DeepCopy(t), this.xFo = Time_1.Time.NowSeconds, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapPointerDown))
    }, this.vKe = t => {
      var e;
      !t || this.IsMultiFingerControl || 1 < this.wFo.size ? (this.SFo = !1, this.PFo.Reset()) : (this.SFo = !0, t = this.qFo(t.pointerPosition.X, t.pointerPosition.Y), 0 === (e = Vector2D_1.Vector2D.Create(t.X, t.Y).SubtractionEqual(this.AFo)).X && 0 === e.Y || (this.PFo.DeepCopy(e), this.AFo.DeepCopy(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapPointerDrag, this.PFo)))
    }, this.GFo = t => {
      var e = Time_1.Time.NowSeconds;
      this.IsMultiFingerControl || e - this.IFo < MULTI_TOUCH_DELAY_TIME ? Log_1.Log.CheckInfo() && Log_1.Log.Info("Map", 18, "正在进行双指缩放") : this.bFo(t.pointerPosition) ? this.SFo ? (this.SFo = !1, this.NFo()) : EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapPointerUp, t) : this.SFo = !1
    }, this.Eqt = (t, e) => {
      var i = e.TouchType,
        s = Number(t);
      switch (i) {
      ...
      t ? (this.LFo = !0, this.DFo = !1, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapJoystickMoveForward, -this.BFo.GamePadMoveSpeed * t)) : this.LFo = !1
    }, this.FFo = t => {
      t ? (this.TFo = !0, this.DFo = !1, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapJoystickMoveRight, -this.BFo.GamePadMoveSpeed * t)) : this.TFo = !1
    }, this.VFo = (t, e) => {
      0 === e ? this.RFo === t && (this.RFo = "") : (this.RFo = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapHandleTriggerAxisInput, SCALE_STEP * e, 2))
    }
  }
  get ComponentType() {
    return 2
  ...
  OnAdd() {
    ...
    ObjectUtils_1.ObjectUtils.IsValid(t) && (this.wFo = new Map, t.OnPointerDownCallBack.Bind(this.Ngo), t.OnPointerDragCallBack.Bind(this.vKe), t.OnPointerUpCallBack.Bind(this.GFo), t.OnPointerScrollCallBack.Bind(this.OFo), this.PFo = Vector2D_1.Vector2D.Create(), this.AFo = Vector2D_1.Vector2D.Create())
  }
  OnEnable() {
    this.dde()
  }
  ...
  CheckTouch() {
    ...
    if (this.IsMultiFingerControl = void 0 !== t && void 0 !== e, this.IsMultiFingerControl) {
      var {
        State: t,
        ChangeRate: i
  ...
  NFo() {
    if (0 !== this.PFo.X || 0 !== this.PFo.Y) {
      ...
      var e = WorldMapUtil_1.WorldMapUtil.GetViewportSizeByPool(),
        e = (e.IsNearlyZero() || (t = MathCommon_1.MathCommon.Clamp(t, 0, e.Size())), this.PFo.Normalize(0));
      e && (e = Vector2D_1.Vector2D.Create(), this.PFo.Multiply(t, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapDragInertia, e)), this.PFo.Reset()
    }
  }
  Mgt(t, e, i) {
    t ? LguiEventSystemManager_1.LguiEventSystemManager.IsPressComponentIsValid(e) && this.wFo.set(e, i) : this.wFo.delete(e), this.UFo.Reset(), this.wFo.forEach(t => {
  ...
  qFo(t, e) {
    ...
    return t.FromUeVector2D(UiLayer_1.UiLayer.UiRootItem.GetCanvasScaler().ConvertPositionFromViewportToLGUICanvas(t.ToUeVector2D(!0))), t.X = MathCommon_1.MathCommon.Clamp(t.X, 0, this.PYe.X), t.Y = MathCommon_1.MathCommon.Clamp(t.Y, 0, this.PYe.Y), t
  }
}
