...
class WorldMapConfig extends ConfigBase_1.ConfigBase {
  constructor() {
    super(...arguments), this.KYa = new Map, this.z0l = new Map, this.wbc = new Map, this.uu1 = new Map
  }
  OnInit() {
    var e = AkiMapAll_1.configAkiMapAll.GetConfigList(),
      e = (e ? e.forEach(e => {
        this.KYa.set(e.MapId, e)
      }) : Log_1.Log.CheckError() && Log_1.Log.Error("Map", 63, "[地图系统]->不存在地图配置，请联系策划检查akiMap配置!"), InstanceDungeonAll_1.configInstanceDungeonAll.GetConfigList());
  ...
  GetTeleportEntityConfigId(e) {
    ...
    return r ? r.TeleportEntityConfigId : (Log_1.Log.CheckError() && Log_1.Log.Error("Map", 18, "传送表找不到配置", ["Id", e]), 0)
  }
  GetAkiMapConfig(e, r = !0) {
    var o = this.KYa.get(e);
    return !o && r && Log_1.Log.CheckError() && Log_1.Log.Error("Map", 18, "AkiMap表找不到配置", ["MapId", e]), o
  }
  GetAkiMapSourceConfig(e) {
    var r = AkiMapSourceByMapId_1.configAkiMapSourceByMapId.GetConfig(e);
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Map", 39, "AkiMapSource表找不到配置", ["MapId", e]), r
  }
  GetAudioConfig(e) {
    var r = AudioById_1.configAudioById.GetConfig(e);
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Map", 18, "Audio表找不到配置", ["Id", e]), r
  }
  GetDailyTaskMarkItem(e) {
    var r = MapNoteById_1.configMapNoteById.GetConfig(1).MarkIdMap.get(e);
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Map", 49, "d.地图便签表DailyMarkId列找不到对应配置", ["国家Id:", e]), r
  }
  GetExploreProgressInfoById(e) {
    var r = ExploreProgressById_1.configExploreProgressById.GetConfig(e);
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Map", 49, `t.探索度配置表
            找不到对应配置`, ["Id", e]), r
  }
    ...
    if (PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (e)
        for (const t of e) {
          ...
          this.wbc.set(t.MapId, r), r.set(t.EntityId, t)
        }
    } else {
      this.uu1.clear();
      e = UE.KismetSystemLibrary.ConvertToAbsolutePath(UE.BlueprintPathsLibrary.ProjectDir()), e = UE.KismetSystemLibrary.ConvertToAbsolutePath("" + e + IGlobal_1.globalConfigTemp.GravityAbnormalEntityListPath);
      if (UE.BlueprintPathsLibrary.FileExists(e)) {
        var o = (0, puerts_1.$ref)(""),
          o = (UE.KuroStaticLibrary.LoadFileToString(o, e), o = (0, puerts_1.$unref)(o), JSON.parse(o));
        for (const n of o.AllConfig)
          for (const a of n.EntityDirectionConfig) {
            var i = this.uu1.get(n.LevelId) ?? new Map;
            this.uu1.set(n.LevelId, i), i.set(a.EntityId, a)
          }
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Editor", 63, "文件不存在", ["Path", e])
    }
  }
  ...
  GetEditorEntityGravityConfig(e, r) {
    return this.uu1.get(e)?.get(r)
  }
  GetEntityGravityDirection(e, r) {
    if (PublicUtil_1.PublicUtil.UseDbConfig()) {
      var o = this.GetEntityGravityConfig(e, r);
      if (o && 3 <= o.GravityDirection.length) return MapUtil_1.MapUtil.IsStandardGravity(o.GravityDirection[2]) ? 1 : 2
    } else {
      o = this.GetEditorEntityGravityConfig(e, r);
      if (o && void 0 !== o.GravityDirection?.Z) return MapUtil_1.MapUtil.IsStandardGravity(o.GravityDirection?.Z) ? 1 : 2
    }
    return 0
  }
