...
class WorldMapSubMapItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.MultiMapConfigId = 0, this.OnToggleStateChange = e => {
      1 === e && (ModelManager_1.ModelManager.WorldMapModel.WorldMapCurrentMultiMapId = this.MultiMapConfigId, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapSelectMultiMap, this.MultiMapConfigId), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WorldMapSubMapChanged, this.GridIndex))
    }
  }
  Refresh(e, t, i) {
    this.MultiMapConfigId = e.Id, this.GridIndex = i, this.GetExtendToggle(3)?.SetToggleState(t ? 1 : 0, !1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e.FloorName);
    i = ModelManager_1.ModelManager.AreaModel.GetCurrentAreaId(), t = ConfigManager_1.ConfigManager.MapConfig?.GetSubMapConfigByAreaId(i);
