...
class SkillButtonUiModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.SkillPriorityButtonConfigMap = new Map, this.BehaviorIconPathMap = new Map, this._Io = new Map, this.uIo = void 0, this.SkillButtonFormationData = void 0, this.Gxa = void 0, this.m3_ = void 0, this.DefaultSkillButtonIndexData = void 0, this.OtherSkillButtonIndexData = void 0, this.CurSkillButtonIndexData = void 0, this.SkillButtonRotationRate = 0, this.Feh = void 0, this.mIo = void 0, this.gU = !1
  }
  get GamepadData() {
    return this.Feh || this.gU && !Info_1.Info.IsInTouch() && (this.Feh = new SkillButtonUiGamepadData_1.SkillButtonUiGamepadData, this.Feh.Init()), this.Feh
  }
  OnInit() {
    this.SkillButtonRotationRate = CommonParamById_1.configCommonParamById.GetFloatConfig("SkillButtonRotationRate"), this.SkillButtonFormationData = new SkillButtonFormationData_1.SkillButtonFormationData, this.SkillButtonFormationData.Init(), this.SkillPriorityButtonConfigMap.clear();
    for (const s of ConfigManager_1.ConfigManager.SkillButtonConfig.GetAllSkillPriorityButtonConfig()) this.SkillPriorityButtonConfigMap.set(s.ButtonType, s);
    this.BehaviorIconPathMap.clear();
    for (var [t, i] of behaviorIconResMap) {
      var e = [];
      for (const a of i) e.push(ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(a));
      this.BehaviorIconPathMap.set(t, e)
    }
    Info_1.Info.IsInTouch() || (this.Feh = new SkillButtonUiGamepadData_1.SkillButtonUiGamepadData, this.Feh.Init());
    var n = 2 === Info_1.Info.OperationType,
      o = ConfigManager_1.ConfigManager.SkillButtonConfig.GetSkillIndexConfig(0);
    return this.DefaultSkillButtonIndexData = new SkillButtonIndexData_1.SkillButtonIndexData, this.DefaultSkillButtonIndexData.UpdateSkillButtonIndexConfig(o, n), this.OtherSkillButtonIndexData = new SkillButtonIndexData_1.SkillButtonIndexData, this.CurSkillButtonIndexData = this.DefaultSkillButtonIndexData, this.gU = !0
  }
  OnClear() {
    return this.SkillButtonFormationData?.Clear(), this.SkillButtonFormationData = void 0, this.ClearAllSkillButtonEntityData(), this.ClearSkillButtonFollowerEntityData(), this.ClearSkillButtonVehicleEntityData(), this.Feh?.Clear(), this.Feh = void 0, this.gU = !1, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSkillButtonDataClear), !0
  }
  OnLeaveLevel() {
    return !0
  }
  ...
  CheckAndRemoveInvalidEntityData() {
    for (const t of this._Io.values()) t.EntityHandle && !t.EntityHandle.Valid && (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 17, "技能按钮数据有非法的实体, 执行清理", ["EntityHandleId", t.EntityHandle?.Id]), this.OnRemoveEntity(t.EntityHandle))
  }
  CreateAllSkillButtonEntityData() {
    var t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity;
    for (const i of ModelManager_1.ModelManager.SceneTeamModel.GetTeamEntities()) i === t ? this.uIo = this.CreateSkillButtonEntityData(i, !0) : this.CreateSkillButtonEntityData(i, !1)
  }
  CreateSkillButtonEntityData(t, i) {
    var e = t.Entity.Id;
    let n = this._Io.get(e);
    return n ? n.IsCurEntity !== i && n.OnChangeRole(i) : ((n = new SkillButtonEntityData_1.SkillButtonEntityData).Init(t, i), this._Io.set(e, n)), n
  }
  ...
  CreateSkillButtonFollowerEntityData(t) {
    var i = ModelManager_1.ModelManager.BattleUiModel?.FormationData?.GetFollowerEnable() ?? !1;
    if (this.Gxa) {
      if (this.Gxa.EntityHandle === t) return void(this.Gxa.IsEnable !== i && this.Gxa.SetEnable(i));
      this.Gxa.Clear(), this.Gxa = void 0
    }
    this.Gxa = new SkillButtonFollowerEntityData_1.SkillButtonFollowerEntityData, this.Gxa.Init(t, i)
  }
  ClearSkillButtonFollowerEntityData() {
    this.Gxa && (this.Gxa.IsEnable && this.Gxa.SetEnable(!1), this.Gxa.Clear(), this.Gxa = void 0)
  }
  CreateSkillButtonVehicleEntityData(t) {
    this.ClearSkillButtonVehicleEntityData(), this.m3_ = new SkillButtonVehicleEntityData_1.SkillButtonVehicleEntityData, this.m3_.Init(t)
  }
  ...
  OnRemoveEntity(t) {
    ...
    i && (this._Io.delete(t.Id), i.Clear(), i === this.uIo) && (this.uIo = void 0), this.uIo === i && (this.uIo = void 0), this.Gxa?.EntityHandle === t && this.ClearSkillButtonFollowerEntityData()
  }
  RefreshSkillButtonData(i, t, e) {
    if (0 === e && (this.ClearAllSkillButtonEntityData(), this.CreateAllSkillButtonEntityData()), 1 === e) {
      let t = !1;
      for (const o of this._Io.values()) i === o.EntityHandle ? (o.OnChangeRole(!0), this.uIo = o, t = !0) : o.OnChangeRole(!1);
      t || (this.uIo = this.CreateSkillButtonEntityData(i, !0))
    }
    var n = this.uIo.SkillButtonIndexConfig;
    n && (0 === n.Id ? this.CurSkillButtonIndexData = this.DefaultSkillButtonIndexData : (this.OtherSkillButtonIndexData.UpdateSkillButtonIndexConfig(n, t), this.CurSkillButtonIndexData = this.OtherSkillButtonIndexData)), this.CurSkillButtonIndexData.RefreshSkillButtonIndex(i), this.Feh?.RefreshSkillButtonData(e), this.uIo.RefreshSkillButtonData(e)
  }
  RefreshSkillButtonExplorePhantomSkillId(t) {
    for (const i of this._Io.values()) i.RefreshSkillButtonExplorePhantomSkillId(t);
  ...
  RefreshSkillButtonIndexByTag(t, i, e, n) {
    t.Id === this.CurSkillButtonIndexData?.ButtonIndexConfigId && (n && this.CurSkillButtonIndexData.IsNormalButtonTypeList && !this.CurSkillButtonIndexData.ButtonIndexTagIdSet.has(e) ? this.CurSkillButtonIndexData.RefreshSkillButtonIndexByTag(i, e) : this.CurSkillButtonIndexData.RefreshSkillButtonIndex(i))
  }
  RefreshSkillButtonIndexOnOperationTypeChanged() {
    var t = 2 === Info_1.Info.OperationType;
    this.CurSkillButtonIndexData.UpdateSkillButtonIndexConfig(this.CurSkillButtonIndexData.ButtonIndexConfig, t), this.DefaultSkillButtonIndexData !== this.uIo && this.DefaultSkillButtonIndexData.UpdateSkillButtonIndexConfig(this.DefaultSkillButtonIndexData.ButtonIndexConfig, t)
  }
  ...
  OnSkillCdChanged(t) {
    for (const e of t.EntityIds)
      ...
      if (i)
        for (const s of t.SkillCdInfoMap.keys()) i.RefreshSkillCd(s)
    }
  }
  OnAimStateChanged() {
  ...
  OnInputEnableChanged(t, i) {
    ...
    this.Gxa?.RefreshEnableByInputEvent(t, i), this.m3_?.RefreshEnableByInputEvent(t, i)
  }
  OnInputVisibleChanged(t, i) {
    for (const e of this._Io.values()) e.RefreshVisibleByInputEvent(t, i);
    this.Gxa?.RefreshVisibleByInputEvent(t, i), this.m3_?.RefreshVisibleByInputEvent(t, i)
  }
  RefreshEnableByButtonType(t) {
    for (const i of this._Io.values()) i.RefreshEnableByButtonType(t);
    this.Gxa?.RefreshEnableByButtonType(t), this.m3_?.RefreshEnableByButtonType(t)
  }
  RefreshVisibleByButtonType(t) {
    for (const i of this._Io.values()) i.RefreshVisibleByButtonType(t);
    this.Gxa?.RefreshVisibleByButtonType(t), this.m3_?.RefreshVisibleByButtonType(t)
  }
  ...
  dIo() {
    if (!this.mIo) {
      ...
      if (t)
        for (const i of t) this.mIo.set(i.Id, i.Name)
    }
  }
