...
class ExploreAreaMissionData {
  constructor(s) {
    this.AreaId = 0, this.QuestId = 0, this.QuestNameId = void 0, this.QuestStatus = void 0, this.QuestType = void 0, this.AreaId = s.Area, this.QuestId = s.Id;
    var s = ModelManager_1.ModelManager.QuestNewModel,
      t = s.GetQuestConfig(this.QuestId);
    this.QuestStatus = s.GetQuestState(this.QuestId), this.QuestNameId = t?.TidName, this.QuestType = t?.Type
  }
  IsQuestVisible() {
