...
class ExploreAreaData {
  constructor() {
    this.AreaId = 0, this.CountryId = 0, this.StateId = 0, this.MapId = 0, this.VVt = 0, this.mOl = 1, this.MaxExploreProgress = 100, this.HVt = new Map, this.jVt = [], this.x7l = new Map, this.WVt = "", this.KVt = 0, this.dOl = [], this.COl = new Map, this.gOl = !1, this.pOl = !1, this.v8l = {
  ...
  fOl(t) {
    if (this.VVt !== t) {
      ...
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnAreaExploreProgressUpdate, this.AreaId), e && (ModelManager_1.ModelManager.ExploreProgressModel.SureHasAreaRewardBox(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RedDotUpdateMapAreaBoxReward))
    }
  }
  Initialize(e) {
    this.AreaId = e.AreaId, this.WVt = e.Title, this.KVt = e.SortIndex, this.CountryId = e.CountryId, this.StateId = e.StateId, this.MapId = e.MapConfigId, this.vOl();
  ...
  vOl() {
    ConfigManager_1.ConfigManager.ExploreProgressConfig.GetAreaStageAwardConfigByAreaId(this.AreaId)?.forEach(e => {
      ...
      t = ModelManager_1.ModelManager.ExploreProgressModel.IsAreaStageRewardIdAchieved(e.Id), t = {
        Id: e.Id,
  ...
  AddExploreAreaItemData(e) {
    var t, r = e.ExploreType;
    this.HVt.has(r) || ((t = new ExploreAreaItemData_1.ExploreAreaItemData).Initialize(e), this.HVt.set(r, t), this.jVt.push(t))
  }
  ...
  SortExploreAreaItemDataList(e) {
    e.sort((e, t) => {
      return e.SortIndex !== t.SortIndex ? e.SortIndex - t.SortIndex : e.ConfigId - t.ConfigId
    })
  }
  w7l() {
    this.x7l.clear(), this.jVt.forEach(t => {
  ...
  IsShowRecommendPlayPoint() {
    for (const e of this.jVt)
      if (e.IsShowRecommendPlayPoint) return !0;
    return !1
  }
  GetRecommendExploreItemDataList(e = !0) {
    var t = [];
    for (const r of this.jVt)
      if (r.IsShowRecommendPlayPoint && (t.push(r), e) && t.length >= ExploreProgressDefine_1.MAX_RECOMMEND_PLAY_POINT_SHOW_NUM) break;
    return t
  }
  GetShowRecommendExploreItemDataList() {
    ...
    const i = this.GetLocalAreaExplorePlayStateMap(),
      a = (e.forEach(a => {
        ...
        o ? a.PlayProgressDataList.forEach((e, t) => {
          var t = o.PlayPointStateList[t],
            r = 1 === e.PlayPointState;
          0 === t && r && (e.LastPlayPointState = t), i.delete(a.ExploreType)
        }) : a.IsNewRecommendPlay = !0, r.push(a)
      }), i.forEach((e, t) => {
        t = this.HVt.get(t);
        t && t.IsFinishedPlayPoint && r.push(t)
      }), this.SortExploreAreaItemDataList(r), []);
    var t = [];
    for (const o of r) o.IsFinishedPlayPoint ? a.push(o) : o.IsNewRecommendPlay ? t.push(o) : (t.forEach((e, t) => {
  ...
  UpdatePlayPointData(o) {
    this.P7l(o).forEach((e, t) => {
      ...
      a.ClearPlayPointData(), e.forEach(e => {
        var t = o[e],
          e = Number(e),
          r = this.qx_(e, t, a);
        a.AddPlayPointData({
    ...
    }), this.gOl = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.AreaPlayPointUpdate, this.AreaId)
  }
  qx_(e, t, r) {
    var a = ExploreProgressDefine_1.serverPlayState2Client[t.xI_];
    return 2 !== a && !(t.Bb_ <= 0) && 1 === (r = r.GetMapMarkByPlayId(e))?.HistoryState ? (Log_1.Log.CheckDebug() && Log_1.Log.Debug("ExploreProgress", 69, "玩法状态转换成已完成", ["PlayId", e], ["MarkId", r?.MarkId], ["MarkName", ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(r?.MarkTitle ?? "")], ["ToState", a], ["ProtoData", t]), 2) : a
  }
  P7l(e) {
    const a = new Map;
    return Object.entries(e).forEach(([e, t]) => {
      var r = this.x7l.get(t.Vb_);
      r ? (a.has(r) || a.set(r, []), a.get(r).push(e)) : Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 69, "没有找到探索项子类型映射到的探索类型", ["playId", e], ["playData", t])
    }), a
  }
  ...
  GetStoryList() {
    ...
    return e?.forEach(e => {
      ...
      t.IsOpen && (t.StoryContent = e.Content, t.StoryTitle = e.StageTitle), t.LockedDesc = e.LockText, t.IsNewOpen = t.IsOpen && e.Unlock > a, o.push(t)
    }), o
  }
  GetStoryProgress(e = !1) {
    var t = ConfigManager_1.ConfigManager.AreaConfig.GetStoryList(this.AreaId);
    if (!t) return Log_1.Log.CheckDebug() && Log_1.Log.Debug("ExploreProgress", 69, "区域故事进度获取失败", ["areaId", this.AreaId]), 0;
    var e = e ? 100 : 1,
      r = this.GetProgress(),
  ...
  HasNewStoryUnlocked() {
    return !!ConfigManager_1.ConfigManager.AreaConfig.GetStoryList(this.AreaId) && this.GetLocalAreaStoryProgress() < this.GetStoryProgress(!0) && (this.pOl = !0)
  }
  ...
  M8l(e) {
    var t;
    this.v8l[e] && ((t = LocalStorage_1.LocalStorage.GetGlobal(e) ?? new Map).set(this.AreaId, this.y8l()), LocalStorage_1.LocalStorage.SetGlobal(e, t), this.v8l[e] = !1)
  }
  GetStoryViewTitle() {
  ...
  SaveLocalAreaExplorePlayState() {
    var e;
    this.R7l || this.IsShowRecommendPlayPoint() && ((e = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.AreaExplorePlayState) ?? new Map).set(this.AreaId, this.U7l()), LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.AreaExplorePlayState, e), this.R7l = !0)
  }
  ...
  U7l() {
    const r = new Map;
    return this.GetRecommendExploreItemDataList().forEach(e => {
      var t = {
  ...
  GetLocalFinishRecommendExploreItems() {
    if (this.IsShowRecommendPlayPoint()) return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 69, "当前区域还存在未完成的推荐探索项显示"), [];
