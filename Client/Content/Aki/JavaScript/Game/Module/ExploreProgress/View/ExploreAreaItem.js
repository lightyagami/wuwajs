...
class ExploreAreaItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.q6e = void 0, this.LPt = void 0, this.OnExtendToggleStateChanged = i => {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [4, this.OnExtendToggleStateChanged]
    ]
  }
  OnStart() {
  ...
  OnBeforeDestroy() {
    this.q6e = void 0, this.LPt = void 0, this.GetExtendToggle(4).CanExecuteChange.Unbind()
  }
  Refresh(i) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), i.NameId), this.GetText(2).SetText(Math.floor(i.Progress).toString() + "%"), this.GetItem(3).SetUIActive(!1), this.GetSprite(0).SetUIActive(t), this.SetSelected(s === e, !0)
  }
  BindCanExecuteChange(i) {
    this.LPt = i
  }
  SetSelected(i, e) {
    i ? this.GetExtendToggle(4).SetToggleState(1, e) : this.GetExtendToggle(4).SetToggleState(0, e)
  }
  BindOnSelected(i) {
    this.q6e = i
  }
