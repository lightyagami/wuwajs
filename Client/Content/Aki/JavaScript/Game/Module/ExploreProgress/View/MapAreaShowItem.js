...
exports.MapAreaShowItem = undefined;
const UE = require("ue");
...
class MapAreaShowItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    ...
    this.kOl = e => {
      ...
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapAreaShowClickArea, this.xOl.AreaId);
    };
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIItem], [3, UE.UIText], [2, UE.UIText], [4, UE.UIItem]];
  ...
  Refresh(e, t, r) {
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("Map", 69, this.constructor.name, ["AreaId", e.AreaId], ["AreaName", ConfigManager_1.ConfigManager.TextConfig?.GetMultiTextByKey(e.GetNameId())], ["GIndex", r]);
    }
