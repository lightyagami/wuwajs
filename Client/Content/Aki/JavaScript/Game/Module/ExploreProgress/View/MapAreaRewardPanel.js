...
class MapAreaRewardPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.bOl = void 0, this.H3e = void 0, this.t2t = void 0, this.qte = 0, this.i2t = 0, this.o2t = 0, this.r2t = !1, this.n2t = -0, this.s2t = [], this.qOl = new Map, this.h2t = 0, this.l2t = 0, this._2t = 0, this.u2t = 0, this.S2t = void 0, this.d2t = () => {
      var t = this.GetSprite(2),
        i = this.GetItem(1),
        s = this.GetItem(5),
        h = this.GetSprite(6);
      return LguiUtil_1.LguiUtil.CopyItem(h, s), LguiUtil_1.LguiUtil.CopyItem(t, i), new MapAreaRewardItem_1.MapAreaRewardItem(this.bOl.GetRewardCallback, this.BOl)
    }, this.BOl = t => {
      this.S2t.Refresh(t)
    }
  }
  ...
  ChangeParamData(i) {
    ...
    this.H3e.RefreshByData(i.RewardDataList), this.GetSprite(2).SetUIActive(!1), this.GetSprite(6).SetUIActive(!1), 0 === i.RewardDataList.length ? this.RootItem?.SetUIActive(!1) : (this._2t = REWARD_WIDTH, this.u2t = (this.l2t - this._2t * (i.RewardDataList.length - 1)) / i.RewardDataList.length, this.C2t(this.qte / i.MaxValue))
  }
  OnTickRefresh(t) {
    this.r2t && (this.n2t += t * TimeUtil_1.TimeUtil.Millisecond, t = MathUtils_1.MathUtils.Clamp(this.n2t / PROGRESS_ANIMATE_TIME, 0, 1), this.qte = MathUtils_1.MathUtils.Lerp(this.o2t, this.i2t, t), t = MathUtils_1.MathUtils.Clamp(this.qte / this.bOl.MaxValue, 0, 1), this.f2t(this.qte), this.C2t(t), this.qte === this.i2t) && this.p2t()
  }
  RefreshProgressBarDynamic(i) {
    i <= this.qte || (this.r2t && this.p2t(), this.s2t = [], this.bOl.RewardDataList.forEach(t => {
