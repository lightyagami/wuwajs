...
class MapAreaShowView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.OOl = void 0, this.Ivt = void 0, this.NOl = 0, this.ZZt = void 0, this.L6e = void 0, this.AreaScroll = void 0, this.FOl = void 0, this.VOl = void 0, this.HOl = 0, this.DNl = void 0, this.R6e = () => {
      return new MapAreaShowCountryItem_1.MapAreaShowCountryItem
    }, this.pqe = e => {
      this.L6e = Time_1.Time.Now, this.NOl = e, Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 69, "触发选择", ["index", this.NOl]), this.jOl()
    }, this.WOl = e => {
      e = this.OOl[e];
      return new CommonTabData_1.CommonTabData(e.Icon, new CommonTabTitleData_1.CommonTabTitleData(e.TitleId, e))
    }, this.lyt = () => {
      this.CloseMe()
    }, this.Bpt = () => !!Info_1.Info.IsInGamepad() || !this.L6e || Time_1.Time.Now - this.L6e >= this.ZZt, this.QOl = () => {
      var e, t;
      let i = !1;
      for ([e, t] of this.FOl.GetTabItemMap()) t.UpdateView(this.VOl[e]), this.VOl[e].IsNoneState || (i = !0);
  ...
  async OnBeforeStartAsync() {
    this.OOl = ModelManager_1.ModelManager.ExploreProgressModel.GetExploreCountryDataList(), await this.InitCommonOneTab()
  }
  OnStart() {
  ...
  OnBeforeShow() {
    ...
    let t = 0;
    if (this.DNl) {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 69, "params", ["国家id", this.DNl.CountryId], ["区域ID", this.DNl.AreaId]);
  ...
  async InitCommonOneTab() {
    ...
    var e = new CommonTabComponentData_1.CommonTabComponentData(this.R6e, this.pqe, this.WOl),
      e = (this.Ivt = new TabComponentWithCaptionItem_1.TabComponentWithCaptionItem(this.GetItem(0), e, this.lyt), this.Ivt.SetCanChange(this.Bpt), this.OOl.length),
      e = this.Ivt.CreateTabItemDataByLength(e);
    await this.Ivt.RefreshTabItemAsync(e)
  }
  jOl() {
    this.FOl || (this.FOl = new TabComponent_1.TabComponent(this.GetItem(3), this.fqe, this.KOl, this.GetItem(5)));
  ...
  RefreshLoopScrollView() {
    var e = this.GetLoopScrollViewComponent(1),
      e = (this.AreaScroll || (this.AreaScroll = new LoopScrollView_1.LoopScrollView(e, this.GetItem(2).GetOwner(), this.KPn, !0)), this.VOl[this.HOl].ExploreAreaDataList);
