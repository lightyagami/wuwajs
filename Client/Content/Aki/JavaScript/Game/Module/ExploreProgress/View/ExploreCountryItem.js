...
class ExploreCountryItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.q6e = void 0, this.LPt = void 0, this.OnExtendToggleStateChanged = e => {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [3, this.OnExtendToggleStateChanged]
    ]
  }
  OnStart() {
  ...
  OnBeforeDestroy() {
    this.q6e = void 0, this.LPt = void 0, this.GetExtendToggle(3).CanExecuteChange.Unbind()
  }
  Refresh(e) {
    this.Pe = e;
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.NameId), this.GetSprite(1).SetUIActive(e.IsLock), this.GetItem(2).SetUIActive(!1), this.GetSprite(4).SetUIActive(i), this.SetSelected(t === e.CountryId)
  }
  SetSelected(e) {
    e ? this.GetExtendToggle(3).SetToggleState(1, !1) : this.GetExtendToggle(3).SetToggleState(0, !1)
  }
