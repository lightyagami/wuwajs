...
class MapExploreStoryView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.DNl = void 0, this.zJa = void 0, this.xqe = void 0, this.RNl = void 0, this.xnl = -1, this.U8l = [], this.hNl = () => {
      this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  OnBeforeShow() {
    ...
    this.GetText(4)?.SetText(t + "%"), this.RNl?.Refresh(i.GetIconPercentDataAreaStory())
  }
  OnAfterPlayStartSequence() {
    if (0 <= this.xnl)
      for (let i = this.xnl; i < this.U8l.length; i++) this.U8l[i].IsNewOpen && this.xqe.GetScrollItemByIndex(i)?.PlayNewOpenAnim()
  }
  OnBeforeDestroy() {
    this.DNl?.AreaData.SaveLocalAreaStoryProgress(), this.DNl?.AreaData.SaveLocalIconPercentAreaStory(), this.zJa = void 0, this.xqe = void 0, this.RNl = void 0
  }
}
