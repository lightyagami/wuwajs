...
class MapExploreDetailView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.YOl = void 0, this.zOl = [], this.JOl = 0, this.ZOl = void 0, this.ExploreScroll = void 0, this.zJa = void 0, this.eNl = void 0, this.tNl = void 0, this.wOl = () => {
      ExploreProgressController_1.ExploreProgressController.ReceiveAreaStageRewardAsyncRequest(this.YOl.GetStageRewardDataList().filter(t => 1 === t.State).map(t => t.Id))
    }, this.T8l = () => {
      var t = this.b8l(),
        t = (this.ExploreScroll?.ScrollToGridIndex(t), this.ExploreScroll?.DeselectCurrentGridProxy(!1), this.ExploreScroll?.SelectGridProxy(t), this.ExploreScroll?.UnsafeGetGridProxy(t));
      t && UiNavigationNewController_1.UiNavigationNewController.SetNavigationFocusForView(t.GetBtnRootItem(), !0)
    }, this.iNl = () => {
      ...
      this.eNl && UiManager_1.UiManager.OpenView("ExploreMissionView", this.eNl.AreaId, this.Zjl)
    }, this.aNl = () => {
      ...
      UiManager_1.UiManager.IsViewShow("WorldMapView") ? this.eNl?.TrackPlayPoint() : ModelManager_1.ModelManager.ExploreProgressModel.SetTrackExploreAreaItemData(this.eNl), this.CloseMe()
    }, this.hNl = () => {
      this.CloseMe()
    }, this._Nl = () => {
      ...
      this.IsDestroyOrDestroying || (UiManager_1.UiManager.CloseView("MapAreaShowView"), this.YOl?.AreaId !== t && this.dNl(t) && this.IsShow && this.CNl())
    }, this.gNl = t => {
      this.ZOl?.UpdateRewardIds(t)
    }, this.pNl = t => {
      this.YOl?.AreaId === t && this.ZOl?.RefreshProgressBarDynamic(this.YOl.GetProgress())
    }, this.fNl = t => {
      this.eNl = t, this.vNl()
    }, this.SNl = t => {
  ...
  async OnBeforeStartAsync() {
    var t = this.OpenParam,
      i = t.AreaId;
    this.dNl(i) && (this.ZOl = new MapAreaRewardPanel_1.MapAreaRewardPanel, await this.ZOl.CreateThenShowByActorAsync(this.GetItem(7).GetOwner()), this.ZOl.InitCommonRewardPopup(this.RootItem), this.zJa = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.zJa.SetCloseCallBack(this.hNl), this.tNl = new MapExplorePlayProgressPanel_1.MapExplorePlayProgressPanel, await this.tNl.Init(this.GetItem(16)), t?.ExploreType && (this.eNl = this.YOl.GetExploreAreaItemData(t.ExploreType)), this.InitExploreScroll())
  }
  OnStart() {
  ...
  INl() {
    this.ExploreScroll?.RefreshByData(this.YOl.GetAllExploreAreaItemData(), !1, this.T8l, !0)
  }
  b8l() {
    var t = this.YOl.GetAllExploreAreaItemData();
    let i = 0;
    return -1 === (i = this.eNl ? t.findIndex(t => t.ExploreType === this.eNl.ExploreType) : i) && (i = 0, this.eNl = t[i]), i
  }
  uNl(t) {
    var i = this.zOl.length,
      t = this.JOl + t;
    (t = MathUtils_1.MathUtils.Clamp(t, 0, i - 1)) !== this.JOl && (this.JOl = t, this.YOl = this.zOl[t], this.CNl())
  }
  CNl() {
    if (!this.YOl) return !1;
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("ExploreProgress", 69, "UpdateAreaData", ["AreaId", this.YOl.AreaId], ["AreaName", ConfigManager_1.ConfigManager.TextConfig?.GetMultiTextByKey(this.YOl.GetNameId())]), this.GetButton(1)?.RootUIComp.SetUIActive(0 < this.JOl), this.GetButton(2)?.RootUIComp.SetUIActive(this.JOl < this.zOl.length - 1), this.YOl.CheckUpdatePlayPointData(), this.TNl(), this.ENl(), this.INl();
    var t = this.YOl.GetProgress();
    return this.GetSprite(26)?.SetFillAmount(t / 100), this.LNl(), this.yNl(), !0
  }
  TNl() {
  ...
  dNl(t) {
    ...
    return i ? (this.YOl = i, this.zOl.length <= 0 && (this.zOl = ModelManager_1.ModelManager.ExploreProgressModel.GetAllAreaDataListSortCountryState(), this.zOl.forEach(t => {
      t.ClearFlagUpdatePlayPointData()
    })), this.JOl = this.zOl.findIndex(t => t.AreaId === this.YOl.AreaId), !0) : (ScrollingTipsController_1.ScrollingTipsController.ShowTipsByText("Area Id Cannot Be Found: " + t), !1)
  }
  OnTick(t) {
    this.ZOl?.OnTickRefresh(t)
  }
  x8l(t, i = !0) {
    t && t !== this.eNl.ExploreType && (t = this.YOl.GetExploreAreaItemData(t)) && (this.eNl = t, i) && this.T8l()
  }
  R8l(t, i) {
    this.dNl(t) && (this.x8l(i, !1), this.CNl())
  }
  vNl() {
    var t, i = !!this.eNl?.IsUnlocked();
    this.GetItem(21)?.SetUIActive(i), this.GetItem(22)?.SetUIActive(!i), i ? (this.SetTextureByPath(this.eNl.DescBg, this.GetTexture(11)), this.GetText(12)?.ShowTextNew(this.eNl.DescId), i = this.eNl.IsCompleted(), t = this.eNl.HasPhantomSkill(), this.GetItem(24)?.SetUIActive(i), this.GetItem(13)?.SetUIActive(!i && t), this.UNl(), t = this.eNl.IsShowTrackBtn && !i, this.GetButton(18)?.RootUIComp.SetUIActive(t), i = this.GetText(14), (t = this.eNl.GetIsPhantomSkillUnlock() ? this.eNl.GetUnlockTextId() : this.eNl.GetLockTextId()) && i.ShowTextNew(t), i.SetUIActive(!!t), i = 6 === this.eNl.ExploreType, this.GetButton(10).RootUIComp.SetUIActive(i)) : (t = this.eNl?.GetLockDetailId()) && this.GetText(23)?.ShowTextNew(t)
  }
  UNl() {
    var t = this.eNl.IsShowProgressBar;
    this.GetItem(19)?.SetUIActive(t), t && (this.tNl?.UpdateData(this.eNl.GetPlayProgressDataIgnoreHiddenList()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnUpdateExploreProgressBar))
  }
  LNl() {
    for (const t of this.zOl)
      if (t.AreaId !== this.YOl.AreaId && t.HasCanTakeStageReward()) return void this.GetItem(9)?.SetUIActive(!0);
