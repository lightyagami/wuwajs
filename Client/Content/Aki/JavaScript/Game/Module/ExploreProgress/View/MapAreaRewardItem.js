...
class MapAreaRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e, t) {
    super(), this.wOl = e, this.BOl = t, this.$Tt = void 0, this.DailyActiveState = void 0, this.SPe = void 0, this.zkt = () => {
  ...
  OnBeforeDestroy() {}
  Refresh(e, t, i) {
    this.$Tt = e, this.SetRewardGoalValue(e.Goal), this.DailyActiveState !== e.State ? this.RefreshRewardState(e.State, void 0 === this.DailyActiveState) : 3 === this.DailyActiveState && this.GetUiNiagara(7).SetUIActive(!1);
    var e = 2 !== e.State,
      s = this.GetText(0);
  ...
  RefreshRewardState(t, e) {
    ...
    this.GetUiNiagara(6).SetAlpha(1 === t ? 1 : 0), 1 === t && e && this.SPe.PlayLevelSequenceByName("Activate");
    e = 2 === t ? DailyActivityDefine_1.REWARD_BACKGROUND_COLOR_UNFINISHED : DailyActivityDefine_1.REWARD_BACKGROUND_COLOR_FINISHED, e = UE.Color.FromHex(e);
