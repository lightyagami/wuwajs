...
class MapAreaShowTabItem extends CommonTabItemBase_1.CommonTabItemBase {
  ...
  UpdateView(e) {
    this.GetText(1).ShowTextNew(e.StateNameKey), this.RootItem.SetUIActive(!e.IsNoneState), this.UpdateTabRedDot(e)
  }
  UpdateTabRedDot(e) {
    e.IsNoneState || (e = e.HasCanTakeStageReward(), this.GetItem(2)?.SetUIActive(e))
  }
}
