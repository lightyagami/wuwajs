...
class ExploreCountryData {
  constructor() {
    this.CountryId = 0, this.Icon = "", this.TitleId = "", this.QVt = new Map, this.XVt = [], this.TOl = new Map
  }
  Initialize(t) {
  ...
  AddExploreAreaData(t) {
    var e = t.AreaId,
      ...
      t = (a.Initialize(t), this.QVt.set(e, a), this.XVt.push(a), ConfigManager_1.ConfigManager.ExploreProgressConfig.GetExploreProgressConfigListByArea(e));
    for (const s of t) a.AddExploreAreaItemData(s);
    a.AddExploreAreaItemDataFinish();
    e = a.StateId;
    let r = void 0;
    return this.TOl.has(e) ? r = this.TOl.get(e) : (r = new ExploreStateData_1.ExploreStateData, this.TOl.set(e, r), r.Initialize(e, this.CountryId)), r.PushAreaData(a), a
  }
