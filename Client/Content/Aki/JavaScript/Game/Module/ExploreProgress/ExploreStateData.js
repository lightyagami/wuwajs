...
class ExploreStateData {
  constructor() {
    this.StateId = 0, this.CountryId = 0, this.StateNameKey = "TowerDefence_lock", this.IsNoneState = !0, this.ExploreAreaDataList = []
  }
  Initialize(e, t) {
    this.CountryId = t, (this.StateId = e) !== ExploreProgressDefine_1.NONE_STATE_ID && (this.IsNoneState = !1, t = ConfigManager_1.ConfigManager.ExploreProgressConfig.GetStateConfigByStateId(e), this.StateNameKey = t.StateName)
  }
  PushAreaData(e) {
