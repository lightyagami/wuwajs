...
class WaitEntityTaskController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.AddEntity, WaitEntityTaskController.GUe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RemoveEntity, WaitEntityTaskController.zpe), !0
  }
  static OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.AddEntity, WaitEntityTaskController.GUe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RemoveEntity, WaitEntityTaskController.zpe), !0
  }
  static AddTask(e) {
...
}(exports.WaitEntityTaskController = WaitEntityTaskController).BOe = 0, WaitEntityTaskController.GUe = (e, t, n) => {
