...
class CookLevelView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.NGt = void 0, this.OGt = void 0, this.lGe = void 0, this.$be = void 0, this.kGt = (e, t, i) => {
      var r = new StarItem;
      return r.CreateThenShowByActor(t.GetOwner()), r.SetState(e), {
        Key: i,
        Value: r
      }
    }, this.FGt = () => {
      ...
      this.HGt(), this.P5e(), this.nOe(), this.pmt(), this.jGt(), this.WGt(), this.M3e(), this.KGt(), this.QGt(), this.sqe()
    }, this.eTt = () => {
      ...
      ModelManager_1.ModelManager.CookModel.SelectedCookerLevel += 1, this.bl()
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  OnBeforeDestroy() {
    this.DisableRedDot(), this.NGt && (this.NGt.ClearChildren(), this.NGt = void 0), this.$be.ClearChildren()
  }
  async OnBeforeStartAsync() {
    this.lGe = new ConfirmItem, await this.lGe.Initialize(this.GetItem(4)), this.lGe.BindOnClickedCallback(this.eTt)
  }
  OnStart() {
    this.NGt = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(7), this.FGt), this.OGt = new Array, LguiUtil_1.LguiUtil.SetLocalText(this.GetText(12), "CookUpgradeButtonText"), this.$be = new GenericLayoutNew_1.GenericLayoutNew(this.GetHorizontalLayout(11), this.kGt), ModelManager_1.ModelManager.CookModel.CurrentCookViewType = 4, ModelManager_1.ModelManager.CookModel.SelectedCookerLevel = ModelManager_1.ModelManager.CookModel.GetCookerInfo().CookingLevel, this.bl(), this.YGt()
  }
  OnBeforeShow() {
  ...
  Cl() {
    ModelManager_1.ModelManager.CookModel.SelectedCookerLevel = ModelManager_1.ModelManager.CookModel.GetCookerInfo().CookingLevel, this.bl()
  }
  HGt() {
  ...
  nOe() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookLevelByLevel(ModelManager_1.ModelManager.CookModel.SelectedCookerLevel),
      e = ConfigManager_1.ConfigManager.CookConfig.GetLocalText(e.AttributesDescription);
    this.GetText(1).SetText(e)
  }
  pmt() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookerMaxLevel(),
      t = new Array(e);
    for (let e = 0; e < ModelManager_1.ModelManager.CookModel.SelectedCookerLevel; e++) t[e] = !0;
    this.$be.RebuildLayoutByDataNew(t)
  }
  jGt() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookerInfo().TotalProficiencys;
    let t = "";
    t = ModelManager_1.ModelManager.CookModel.SelectedCookerLevel === ModelManager_1.ModelManager.CookModel.GetCookerMaxLevel() ? "MAX" : e + "/" + ModelManager_1.ModelManager.CookModel.GetSumExpByLevel(ModelManager_1.ModelManager.CookModel.SelectedCookerLevel), this.GetText(2).SetText(t)
  }
  WGt() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookerInfo().TotalProficiencys,
      t = ModelManager_1.ModelManager.CookModel.GetSumExpByLevel(ModelManager_1.ModelManager.CookModel.SelectedCookerLevel),
      ...
      if (e)
        for (const r of e.DropPreview) {
          var t = ModelManager_1.ModelManager.CookModel.SelectedCookerLevel,
            i = ModelManager_1.ModelManager.CookModel.GetCookerInfo().CookingLevel;
          this.OGt.push({
            RewardId: r[0],
            Count: r[1],
            IsGet: t < i
  ...
  QGt() {
    this.GetButton(5).GetOwner().GetComponentByClass(UE.UIItem.StaticClass()).SetUIActive(1 !== ModelManager_1.ModelManager.CookModel.SelectedCookerLevel), this.GetButton(6).GetOwner().GetComponentByClass(UE.UIItem.StaticClass()).SetUIActive(ModelManager_1.ModelManager.CookModel.SelectedCookerLevel !== ModelManager_1.ModelManager.CookModel.GetCookerMaxLevel())
  }
  sqe() {
...
class ConfirmItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(), this.JGt = void 0, this.Mke = () => {
      this.JGt && (this.GetButton(0).GetSelfInteractive() ? this.JGt() : ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("CookUpgrade"))
    }
  }
  async Initialize(e) {
  ...
  SetEnable() {
    ...
    e <= t || e <= i || i < t ? r.GetUIItem().SetUIActive(!1) : (r.GetUIItem().SetUIActive(!0), e = ModelManager_1.ModelManager.CookModel.GetCookerInfo().TotalProficiencys, i = ModelManager_1.ModelManager.CookModel.GetSumExpByLevel(ModelManager_1.ModelManager.CookModel.SelectedCookerLevel), this.GetButton(0).SetSelfInteractive(i <= e), this.GetItem(2).SetUIActive(i <= e))
  }
  GetRedDot() {
