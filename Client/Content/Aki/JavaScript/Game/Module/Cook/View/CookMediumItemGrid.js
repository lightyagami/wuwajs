...
class CookMediumItemGrid extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  ...
  OnRefresh(e, o, r) {
    ...
    if (1 === t) {
      ...
      i.IsDisable = e.IsUnLock && !l, i.BottomTextId = s.Name, i.ItemConfigId = n, i.StarLevel = s.QualityId
    }
    if (0 === t) {
      l = ConfigManager_1.ConfigManager.CookConfig.GetCookFormulaById(o), n = l.FoodItemId, s = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(n);
      if (!s) return;
      t = e, n = CookController_1.CookController.CheckCanCook(o) && e.IsUnLock;
      i.IsDisable = e.IsUnLock && !n, i.BottomTextId = s.Name, i.ItemConfigId = l.FoodItemId, i.StarLevel = s.QualityId, i.IsTimeFlagVisible = 0 < t.ExistEndTime
    }
    this.Apply(i)
  }
}
