...
class CookPopView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.zGt = void 0, this.ZGt = void 0, this.E9 = 0, this.InitCookPopItem = (e, t, i) => {
      t = new CookPopItem(t);
      return t.Update(e), {
        Key: i,
        Value: t
      ...
      CookController_1.CookController.SendFixToolRequest(CookController_1.CookController.GetCurrentFixId(), CookController_1.CookController.GetCurrentEntityId()), this.eNt()
    }, this.tNt = () => {
      this.eNt()
    }, this.iNt = () => {
  ...
  OnStart() {
    ...
    var e = this.OpenParam,
      e = (this.E9 = e.CookRewardPopType, this.zGt = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(1), this.InitCookPopItem), this.GetItem(2).SetUIActive(0 === this.E9 || 3 === this.E9), this.GetItem(4).SetUIActive(0 === this.E9), 1 === this.E9 && CookController_1.CookController.CheckCanShowExpItem());
    this.GetItem(7).SetUIActive(e), 1 === this.E9 && (this.ZGt = new ExpItem(this.GetItem(7))), this.GetButton(8).GetOwner().GetUIItem().SetUIActive(0 !== this.E9)
  }
  OnAddEventListener() {
  ...
  OnBeforeDestroy() {
    this.zGt && (this.zGt.ClearChildren(), this.zGt = void 0), this.ZGt && (this.ZGt.Destroy(), this.ZGt = void 0)
  }
  OnAfterShow() {
  ...
  oNt() {
    ...
    } else this.zGt.RefreshByData(ModelManager_1.ModelManager.CookModel.GetCookItemList())
  }
  rNt() {
    if (0 === this.E9) {
      var i = ConfigManager_1.ConfigManager.CookConfig.GetCookFixToolById(CookController_1.CookController.GetCurrentFixId()),
        s = ConfigManager_1.ConfigManager.CookConfig.GetLocalText(i.Description);
      let e = 0,
        t = "";
    ...
    } else LguiUtil_1.LguiUtil.SetLocalText(this.GetText(3), "MaciningStudyFail")
  }
  sNt() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookerInfo(),
      t = ModelManager_1.ModelManager.CookModel.GetSumExpByLevel(ModelManager_1.ModelManager.CookModel.GetCookerInfo().CookingLevel);
    this.ZGt.SetExpSprite(e.TotalProficiencys, t), this.ZGt.SetAddText(e.AddExp), this.ZGt.SetLastText(e.TotalProficiencys), this.ZGt.SetSumText(t)
  }
  nNt() {
    ...
    e.SetInteractable(t), this.GetButton(9).GetOwner().GetUIItem().SetUIActive(!t)
  }
  eNt() {
    0 === this.E9 ? UiManager_1.UiManager.CloseView("CookPopFixView") : UiManager_1.UiManager.CloseView("CookPopView")
  }
}
exports.CookPopView = CookPopView;
class CookPopItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.fGt = void 0, this.eTt = () => {
