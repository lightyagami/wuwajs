...
class CookSuccessView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.zGt = void 0, this.E9 = 0, this.eOt = void 0, this.Mke = () => {
      this.m2e()
    }, this.m2e = () => {
      this.CloseMe()
    }, this.JGe = (e, i, t) => {
      i = new CommonItemSimpleGrid_1.CommonItemSimpleGrid(i.GetOwner());
      return i.RefreshItem(e[0].ItemId, e[1]), {
        Key: t,
        Value: i
      }
    }
  ...
  OnStart() {
    ...
    this.E9 = e.CookRewardPopType, this.zGt = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(3), this.JGe), this.GetButton(5).GetRootComponent().SetUIActive(!1), this.eOt = new ExpSliderItem(this.GetItem(4))
  }
  OnAddEventListener() {
...
class ExpSliderItem extends UiPanelBase_1.UiPanelBase {
  ...
  Update() {
    var e = ModelManager_1.ModelManager.CookModel.GetCookerInfo(),
      i = ModelManager_1.ModelManager.CookModel.GetSumExpByLevel(ModelManager_1.ModelManager.CookModel.GetCookerInfo().CookingLevel),
      t = 1 < (t = MathUtils_1.MathUtils.GetFloatPointFloor(e.TotalProficiencys / i, 3)) ? 1 : t;
    this.GetSprite(0).SetFillAmount(t), this.GetText(1).SetText(e.AddExp.toString()), this.GetText(2).SetText(e.AddExp.toString()), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "CookProgressText", e.TotalProficiencys, i)
  }
}
