...
class CookConfig extends ConfigBase_1.ConfigBase {
  ...
  GetCookFormulaByFormulaItemId(o) {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "烹饪配方获取失败，请检查烹饪配方配置表是否正确", ["FormulaItemId=", o]), e
  }
  GetCookFormula() {
  ...
  GetCookFormulaById(o) {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "烹饪配方获取失败，请检查烹饪配方配置表是否正确", ["Id=", o]), e
  }
  GetCookProcessedById(o) {
    var e = CookProcessedById_1.configCookProcessedById.GetConfig(o);
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "食材加工获取失败，请检查食材加工配置表是否正确", ["Id=", o]), e
  }
  GetCookProcessed() {
    var o = CookProcessedAll_1.configCookProcessedAll.GetConfigList();
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "食材加工列表获取失败，请检查食材加工配置表是否正确"), o
  }
  ...
  GetCookLevel() {
    ...
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "获取厨师证书相关配置失败"), o
  }
  GetCookLevelByLevel(o) {
    var e = CookLevelById_1.configCookLevelById.GetConfig(o);
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "获取目标等级厨师证书相关配置失败", ["Id=", o]), e
  }
  GetCookFixToolById(o) {
    var e = CookFixToolById_1.configCookFixToolById.GetConfig(o);
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Cook", 49, "食材修理工具获取失败，请检查食材修理工具配置表是否正确", ["Id=", o]), e
  }
}
