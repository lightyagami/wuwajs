...
class CookController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(21011);
    Net_1.Net.UnRegister(17576);
  }
  ...
  static async SendCookingDataRequestAsync() {
    ...
    var e = await Net_1.Net.CallAsync(16150, e);
    if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
      ...
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 18969, undefined, true, false);
  ...
  static SendCookFormulaRequest(t) {
    ...
    e.LVn = t;
    Net_1.Net.Call(27629, Protocol_1.Aki.Protocol.gZn.create(e), e => {
      var o;
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 17430);
      }
    });
  }
  static SendCookFoodRequest(e, o, t) {
    ...
    Net_1.Net.Call(21492, Protocol_1.Aki.Protocol.vZn.create(r), e => {
      var o;
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 16466);
  ...
  static SendFoodProcessRequest(e, o, t) {
    ...
    r.DVn = t;
    r.AVn = ModelManager_1.ModelManager.CookModel.CurrentInteractCreatureDataLongId;
    Net_1.Net.Call(19524, Protocol_1.Aki.Protocol.MZn.create(r), e => {
      var o;
      var t;
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 15226);
      }
    });
  }
  static SendCertificateLevelRewardRequest() {
    var e = new Protocol_1.Aki.Protocol.EZn();
    Net_1.Net.Call(16847, Protocol_1.Aki.Protocol.EZn.create(e), e => {
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 27071);
      }
    });
  }
  static SendFixToolRequest(o, e) {
    ...
    t.xVn = o;
    t.F4n = e;
    Net_1.Net.Call(23899, Protocol_1.Aki.Protocol.mZn.create(t), e => {
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 15179);
      }
    });
  }
