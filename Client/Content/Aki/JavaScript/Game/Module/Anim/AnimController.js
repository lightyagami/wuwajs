...
class AnimController extends ControllerBase_1.ControllerBase {
  ...
  static UpdateAnimInfoCacheBones(t) {
    var e;
    var n;
    var t = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    if (t?.Valid && (e = t.MainAnimInstance.LogicParams, n = t.AnimLogicParamsSetter, t = t.GetNeedCacheBones(), n.CacheBones !== t)) {
      n.CacheBones = t;
      e.bCacheBones = t;
    }
  }
...
(exports.AnimController = AnimController).UpdateAnimInfo = t => {
  ...
  AnimController.UpdateAnimInfoCacheBones(t);
};
