...
class TsPhotographer extends UE.Actor {
  ...
  Initialize() {
    ...
    ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.BP_FightCameraConfig_C, t => {
      var t = t.基础,
        ...
        h = t.Get(41);
      this.StartHideDistance = Math.max(i, h) + HIDE_DISTANCE_OFFSET, this.CompleteHideDistance = Math.min(i, h) + HIDE_DISTANCE_OFFSET, this.CompleteHidePitch = t.Get(43), this.StartDitherValue = t.Get(44), this.IsLoadingConfigCompleted = !0
  ...
  ActivateCamera(t) {
    t.K2_AttachToComponent(this.CameraArm, FNameUtil_1.FNameUtil.NONE, 2, 2, 2, !1), this.CameraActor = t, this.SetFov(PhotographDefine_1.DEFAULT_FOV)
  }
  DeactivateCamera() {
    this.CameraActor?.IsValid() && this.CameraActor.K2_DetachFromActor(1, 1, 1), this.CameraActor = void 0
  }
  SetCameraTransform(t) {
    var t = t.GetTranslation(),
      i = this.CameraActor.D_K2_GetActorLocation();
    this.RelativeVectorCache.X = t.X - i.X, this.RelativeVectorCache.Y = t.Y - i.Y, this.RelativeVectorCache.Z = t.Z - i.Z, this.K2_AddActorWorldOffset(this.RelativeVectorCache, !1, void 0, !1)
  }
  MoveUp(t) {
    var i;
    Math.abs(this.CurCameraUpAndDownDistance + t) < this.CameraUpAndDownMaxDistance && (i = GravityUtils_1.GravityUtils.GetVectorInGravity(Vector_1.Vector.UpVectorProxy, this.GravityQuat, this.TmpVector), this.CurCameraUpAndDownDistance += t, i = i.Multiply(t, this.TmpVector), GravityUtils_1.GravityUtils.GetVectorInNormal(i, this.InverseGravityQuat, this.TmpVector2), this.CameraArm.SocketOffset = this.CameraArm.SocketOffset.op_Addition(this.TmpVector2.ToUeVectorOld()))
  }
  MoveRight(t) {
    var i;
    Math.abs(this.CurCameraLeftAndRightDistance + t) < this.CameraLeftAndRightMaxDistance && (i = GravityUtils_1.GravityUtils.GetVectorInGravity(Vector_1.Vector.RightVectorProxy, this.GravityQuat, this.TmpVector), this.CurCameraLeftAndRightDistance += t, i = i.Multiply(t, this.TmpVector), GravityUtils_1.GravityUtils.GetVectorInNormal(i, this.InverseGravityQuat, this.TmpVector2), this.CameraArm.SocketOffset = this.CameraArm.SocketOffset.op_Addition(this.TmpVector2.ToUeVectorOld()))
  }
  AddCameraArmPitchInput(t) {
    var i;
    0 === t || (i = this.CameraArm.GetTargetRotation().Pitch, 0 < t && i <= this.SourceMinPitch) || t < 0 && i >= this.SourceMaxPitch || (this.PitchInput = t)
  }
