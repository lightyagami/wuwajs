...
class FightPhotoOptionPanel extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[10, this.I7d]];
  }
  async OnBeforeStartAsync() {
    this.Zyd = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(2), this.Bqe);
    ...
    this.Zyd.BindScrollValueChange(e => {
      if (e) {
  ...
  T7d(e) {
    var i;
    var t;
    if (this.M7d.length === 0) {
      i = CommonParamById_1.configCommonParamById.GetIntConfig("FightPhotoHideMonsterDistance");
      ModelManager_1.ModelManager.CreatureModel.GetEntitiesInRange(i, 96, this.M7d);
    }
    for (const o of this.M7d) {
