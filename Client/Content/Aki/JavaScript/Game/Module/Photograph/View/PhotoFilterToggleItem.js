...
class PhotoFilterToggleItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.PKi = !0, this.y1_ = void 0, this.S1_ = void 0, this.SPe = void 0, this.UFe = () => {
      this.PKi = !this.PKi, ModelManager_1.ModelManager.PhotographModel.SetFilterToggleState(this.PKi), this.BKi()
    }
  }
  OnRegisterComponent() {
  ...
  OnBeforeShow() {
    this.PKi = ModelManager_1.ModelManager.PhotographModel.GetFilterToggleState(), this.BKi(!1)
  }
  OnBeforeDestroy() {
  ...
  EUt(e, i = !0) {
    e = e ? "ClickL" : "ClickR";
    this.SPe?.PlayLevelSequenceByName(e), i || this.SPe?.StopSequenceByKey(e, !1, !0)
  }
  BKi(e = !0) {
    this.EUt(this.PKi, !1), this.y1_ && this.y1_(this.PKi, e), this.PKi || this.S1_ && this.S1_()
  }
}
