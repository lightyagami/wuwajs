...
class PhotographModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.OWi = void 0, this.PlayMontageEntity = void 0, this.MontageId = 0, this.FilterId = 0, this.kWi = new Map, this.j2_ = new Map, this.H2_ = new Map, this.FWi = new UE.TransformDouble, this.RightValue = 0, this.UpValue = 0, this.VWi = 0, this.HWi = void 0, this.IsOpenPhotograph = !1, this.SavePath = "", this.IsSaveButtonVisible = !1, this.IsFilterToggleOpen = !0
  }
  OnInit() {
    return this.SavePath = CommonParamById_1.configCommonParamById.GetStringConfig("ScreenShotSavePath"), !0
  }
  OnClear() {
  ...
  SpawnPhotographerStructure(t, e, r) {
    ...
    return this.OWi = t.PushStructure(UiCameraPhotographerStructure_1.UiCameraPhotographerStructure), this.OWi.SetActorTransform(this.FWi), t.GetUiCameraComponent(UiCameraPostEffectComponent_1.UiCameraPostEffectComponent).SetCameraFocalDistance(PhotographDefine_1.DEFAULT_MANUAL_FOCUS_DISTANCE), this.OWi
  }
  DestroyUiCamera() {
    UiCameraManager_1.UiCameraManager.Destroy(PhotographDefine_1.PHOTOGRAPH_CAMERA_BLEND_OUT), this.OWi = void 0
  }
  ...
  InitFilterPostProcessVolume() {
    var e = UE.NewArray(UE.Actor),
      t = (0, puerts_1.$ref)(e);
    if (UE.GameplayStatics.GetAllActorsOfClassWithTag(GlobalData_1.GlobalData.World, UE.PostProcessVolume.StaticClass(), FNameUtil_1.FNameUtil.GetDynamicFName("Filter"), t), e = (0, puerts_1.$unref)(t))
      for (let t = 0; t < e.Num(); t++) {
        var r, i = e.Get(t);
        i.BlendWeight = 0, i.Tags.Num() < 2 || (r = i.Tags.Get(1).toString(), this.j2_.set(r, i))
      }
  }
  ...
  GetFilterStrengthByFilterId(t) {
    t = this.H2_.get(t);
    return void 0 === t ? PhotographDefine_1.FILTER_DEFAULT_STRENGTH / PhotographDefine_1.FILTER_MAX_STREGNTH : t
  }
