...
class PhotographController extends UiControllerBase_1.UiControllerBase {
  ...
  static TryOpenPhotograph(t) {
    return !!this.$ha(t) && (this.c7t(t), true);
  }
  ...
  static NMa() {
    ...
    if (o) {
      for (const n of o) {
        if (n instanceof EntityPhotoBehaviorNode_1.EntityPhotoBehaviorNode && (t = n) && t.TakePlace && this.BMa(t.TakePlace.RangeEntity, t, 0)) {
          e = true;
    ...
    if (i) {
      for (const s of i) {
        if (s instanceof EntityPhotoBehaviorNode_1.EntityPhotoBehaviorNode && (t = s) && t.TakePlace && this.BMa(t.TakePlace.RangeEntity, t, 1)) {
          e = true;
          a.push(t.TakePlace.RangeEntity);
        }
      }
  ...
  static ScreenShot(t) {
    ...
    var n = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.PhotoAndShareShowPlayerName, true);
    var s = o.GetPhotographOption(3);
  ...
  static RWi(t, e) {
    ...
    if (o?.Valid && o.Entity?.Valid) {
      o = o.Entity.GetComponent(205).ListenForTagAddOrRemove(t, e);
      this.AWi.push(o);
    }
  }
  static URe(t) {
  ...
  static PlayPhotoMontage(e, o) {
    ...
    if (i) {
      ...
      if (o === 110702 && r === 81011107) {
        t = "/Game/Aki/Character/Role/FemaleMS/Kmola/R2T1KamolaMd20011/CommonAnim/AM_Stand1_Action02.AM_Stand1_Action02";
      }
      const a = i.IsLoop;
      r = ModelManager_1.ModelManager.PhotographModel;
      this.PWi(r.PlayMontageEntity);
      r.PlayMontageEntity = e;
      r.MontageId = o;
      ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.AnimMontage, o => {
        if (e.Valid) {
          const i = e.Entity;
          ...
          if (t.IsSitDown) {
            ...
            this.RWi(-2104691392, (t, e) => {
              if (!e) {
                e = i.GetComponent(177).MainAnimInstance;
                if (a) {
            ...
            t = i.GetComponent(177).MainAnimInstance;
            if (a) {
  ...
  static PWi(t) {
    if (ModelManager_1.ModelManager.PhotographModel.GetPhotographerStructure() && t?.Valid) {
      t.Entity.GetComponent(177).MainAnimInstance?.Montage_Stop(0);
  ...
  static ResetPhotoMontage() {
    ...
    if (t && (t = EntitySystem_1.EntitySystem.Get(t))?.Valid && this.GetRoleMainAnimInstanceType() === 0) {
      t.GetComponent(177).MainAnimInstance.设置头部转向状态(1);
    }
  }
  ...
  static SetNpcFocusPhotograph(t) {
    if (this.PhotoTargets && !(this.PhotoTargets.length <= 0)) {
      for (const o of this.PhotoTargets) {
        var e = o;
        if (e && (e = ModelManager_1.ModelManager.CreatureModel.GetEntityIdByPbDataId(e), (e = EntitySystem_1.EntitySystem.Get(e))?.Valid) && (e = e.GetComponent(187))) {
      ...
      for (const n of r) {
        ...
        for (const s of a) {
          if (!this.CheckInUi(s) || !this.CheckLineTrace(s.ToUeVectorOld(), r)) {
            this.GWi(e, 1, n.EntityId, false);
            t = false;
            if (!this.Ihl(n.EntityId)) {
              o--;
            }
            break;
          }
    ...
    if (o) {
      for (let t = 0; t < this.mWi.HitResult.Actors.Num(); t++) {
        ...
        if (r && !(r instanceof TsPhotographer_1.default) && !(r instanceof UE.AkReverbVolume) && !(r instanceof UE.NinjaLive_C)) {
          ...
          if (!n || !this.WMa(n.PbDataId, e, false)) {
            if (!this.GetIsLineTraceBlock()) {
              if (Log_1.Log.CheckWarn()) {
  ...
  static GetRoleMainAnimInstanceType() {
    ...
    if (t?.Valid && (t = t.Entity.GetComponent(177)?.MainAnimInstance, UE.KuroStaticLibrary.IsObjectClassByName(t, CharacterNameDefines_1.CharacterNameDefines.ABP_BASEROLE))) {
      return 0;
    } else {
      return 1;
    }
...
PhotographController.pcu = false;
...
PhotographController.Kue = (t, e) => {
  if (!e) {
    if ((e = ModelManager_1.ModelManager.PhotographModel.PlayMontageEntity)?.Valid) {
      e.Entity.GetComponent(177).MainAnimInstance.Montage_Play(t);
    }
  }
