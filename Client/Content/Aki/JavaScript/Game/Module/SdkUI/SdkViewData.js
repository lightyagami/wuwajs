...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.SdkPayProductInformationViewData = exports.SdkLoadPopUpViewData = exports.SdkPayTipData = exports.SdkLoginViewLayoutData = exports.SdkLoginViewData = exports.SdkPopUpViewData = exports.SdkEnterTipsViewData = exports.SdkProtocolData = exports.SdkMailViewData = void 0;
...
class SdkLoginViewData {
  constructor() {
    this.DescTextId = "", this.EnterCallback = () => {}, this.CancelCallback = () => {}, this.LayoutData = []
  }
  static Create(t, a, s, o) {
    var r = new SdkLoginViewData;
    return r.DescTextId = t, r.EnterCallback = a, r.CancelCallback = s, r.LayoutData = o, r
  }
}
...
class SdkPayTipData {
  constructor() {
    this.PayStateSpritePath = "", this.PayResultTextId = "", this.PayContentTextId = "", this.CountDownTime = 0, this.CountDownTextId = ""
  }
  static Create(t, a, s, o, r) {
    var i = new SdkPayTipData;
    return i.PayStateSpritePath = t, i.PayResultTextId = a, i.PayContentTextId = s, i.CountDownTime = o, i.CountDownTextId = r, i
  }
}
...
class SdkPayProductInformationViewData {
  constructor() {
    this.ProductName = "", this.ContentName = "", this.ProductId = "", this.OnClickConfirmBtn = () => {}
  }
  static Create(t, a, s, o) {
    var r = new SdkPayProductInformationViewData;
    return r.ProductName = t ?? "", r.ContentName = a ?? "", r.ProductId = s ?? "", r.OnClickConfirmBtn = o, r
  }
}
