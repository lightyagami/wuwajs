...
class SdkTipsPopUpView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnStart() {
    ...
    1 === (this.Pe = e).ViewType ? this.UiViewSequence.AddSequenceFinishEvent("Start", () => {
      TimerSystem_1.TimerSystem.Delay(() => {
        this.bWe = !0
      }, LOGINCLOSETIME)
    }) : this.UiViewSequence.AddSequenceFinishEvent("Start", () => {
      this.UiViewSequence.PlaySequence("Loop")
    }), this.GetItem(2)?.SetUIActive(1 === e.ViewType), this.GetItem(0)?.SetUIActive(0 === e.ViewType), this.T2e(e)
  }
  OnBeforeShow() {
  ...
  OnTick(e) {
    this.bWe && this.IsShow && (this.bWe = !1, this.CloseMe()), 0 === this.Pe?.ViewType && (this.Uqe += e / CommonDefine_1.MILLIONSECOND_PER_SECOND, this.Uqe >= AUTOCLOSETIME) && this.CloseMe()
  }
  T2e(e) {
