...
class SdkPayProductInformationView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.C0t = void 0, this.Awe = () => {
      this.CloseMe(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SdkPayEnd, 0)
    }, this.L3e = () => {
      PlatformSdkManagerNew_1.PlatformSdkManagerNew.GetPlatformSdk()?.HidePlayStationStoreIcon(), this.C0t && this.C0t.OnClickConfirmBtn(this.C0t.ProductId), this.CloseMe()
    }
  }
  OnRegisterComponent() {
