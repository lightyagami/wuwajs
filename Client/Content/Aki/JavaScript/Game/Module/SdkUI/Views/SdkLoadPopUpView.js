...
class SdkLoadPopUpView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.TDe = void 0, this.qnl = 0
  }
  OnStart() {
  ...
  Gnl() {
    ...
    e && 0 < e && (this.qnl = e, this.R6t(), this.TDe = TimerSystem_1.TimerSystem.Forever(() => {
      this.qnl--, this.qnl < 0 && (this.CloseMe(), Log_1.Log.CheckWarn()) && Log_1.Log.Warn("KuroSdk", 27, "SDK:读取中弹窗触发自动关闭", ["reason", this.Pe.OpenReason])
    }, TIMERGAP))
  }
  OnBeforeShow() {
