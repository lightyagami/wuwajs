...
class MailTotalDropDownItem extends MailDropDownItem_1.MailDropDownItem {
  GetFilteredMailList() {
    ...
    return Log_1.Log.CheckInfo() && Log_1.Log.Info("Mail", 27, "邮件界面：获取全部邮件", ["length", e?.length]), e
  }
  GetTitleText() {
    return this.GetFilteredMailList().length + "/" + ModelManager_1.ModelManager.MailModel.GetMailCapacity()
  }
  OnShowDropDownItemBase(e) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.Name), this.SetMailCount(this.GetTitleText())
  }
}
