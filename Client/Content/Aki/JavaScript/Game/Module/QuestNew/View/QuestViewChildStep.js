...
class QuestViewChildStep extends StepWithStatusItem_1.StepWithStatusItem {
  OnRegisterComponent() {
    super.OnRegisterComponent(), this.ComponentRegisterInfos.push([5, ue_1.UISprite])
  }
  OnStart() {
    super.OnStart()
  }
  UpdateStepInfo() {
    super.UpdateStepInfo(), this.GetSprite(5)?.SetUIActive(!this.IsDescribeTextVisible || !this.StatusNodeVisible)
  }
