...
class QuestUtil {
  static SetTrackDistanceText(e, r) {
    ...
    if (!t) return !1;
    let i = 0;
    i = r instanceof Vector_1.Vector ? Vector_1.Vector.Dist(r, t) * MapDefine_1.FLOAT_0_01 : ue_1.Vector.Dist(r, t.ToUeVectorOld()) * MapDefine_1.FLOAT_0_01, i = Math.round(i);
    var r = r.Z - t.Z,
      t = i.toString();
    LguiUtil_1.LguiUtil.SetLocalText(e, "Meter", t);
    let a = e.GetText();
    return 300 < r ? (t = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_YellowArrowUp"), a += `<texture=${t}/>`) : r < -300 && (t = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_YellowArrowDown"), a += `<texture=${t}/>`), e.SetText(a), !0
  }
