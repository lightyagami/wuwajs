...
exports.CreateCharacterController = undefined;
...
class CreateCharacterController extends UiControllerBase_1.UiControllerBase {
  static TriggerInputName() {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CreateRoleShowInputName);
  }
  static AddBurstEyeRenderingMaterial(e) {
    var n = ConfigManager_1.ConfigManager.CreateCharacterConfig.GetInitialRoles()[e ? LoginDefine_1.ELoginSex.Boy : LoginDefine_1.ELoginSex.Girl];
    var e = e ? "RoleMaleBurstEyeMaterialController" : "RoleFemaleBurstEyeMaterialController";
    var n = UiLoginSceneManager_1.UiLoginSceneManager.SetRoleRenderingMaterial(n, e);
    UiLoginSceneManager_1.UiLoginSceneManager.SetBurstEyeMaterialId(n);
  }
  static RemoveBurstEyeRenderingMaterial(e) {
    var e = ConfigManager_1.ConfigManager.CreateCharacterConfig.GetInitialRoles()[e ? LoginDefine_1.ELoginSex.Boy : LoginDefine_1.ELoginSex.Girl];
