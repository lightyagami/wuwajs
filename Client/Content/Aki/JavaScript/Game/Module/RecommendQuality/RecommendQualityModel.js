...
class RecommendQualityModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.QualityRangeMap = void 0, this.nml = void 0, this.sml = 0, this.aml = !1, this.IsNeedApply = !1, this.NeedApplyQuality = 2
  }
  OnInit() {
    var e;
    return CloudGameManager_1.CloudGameManager.IsCloudGame ? (this.aml = !0, void 0 !== (e = GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetRecommendQualityLv()) && (this.SaveApply(e), !0)) : Platform_1.Platform.IsPs5Platform() ? this.aml = !0 : (this.aml = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsFinishRecommendQuality, !1), this.aml || (this.InitQualityRangeMap(), this.InitQualityList()), !0)
  }
  OnClear() {
    return !0
  }
  ...
  InitQualityList() {
    ...
    if (e) {
      ...
      const r = GameSettingsManager_1.GameSettingsManager.ValidApplyConfigMap.get(GameSettingsDefine_1.EFunction.IMAGEQUALITY),
        n = r?.OptionsName ?? [],
        o = GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetRecommendQualityLv();
      e.forEach((e, t) => {
  ...
  FinishRecommendQualityShow() {
    LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsFinishRecommendQuality, !0)
  }
  CheckOpenRecommendQuality() {
    this.aml ? UiManager_1.UiManager.CloseView("CreateCharacterView") : UiManager_1.UiManager.OpenView("RecommendQualityView")
  }
}
