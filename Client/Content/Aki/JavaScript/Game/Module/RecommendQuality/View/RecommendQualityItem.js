...
exports.RecommendQualityItem = undefined;
const UE = require("ue");
...
class RecommendQualityItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIExtendToggle], [1, UE.UITexture], [2, UE.UIText], [3, UE.UISprite]];
    this.BtnBindInfo = [[0, this.lml]];
  }
  Refresh(e) {
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("Login", 69, "RecommendQualityItem Refresh", ["quality", e.Quality], ["name", e.Name], ["isRecommend", e.IsRecommend]);
    }
