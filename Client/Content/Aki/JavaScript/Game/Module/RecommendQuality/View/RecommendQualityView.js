...
exports.RecommendQualityView = undefined;
const UE = require("ue");
...
const RecommendQualityItem_1 = require("./RecommendQualityItem");
class RecommendQualityView extends UiViewBase_1.UiViewBase {
    ...
    this.hml = () => {
      ...
      if (this.HDo) {
        ...
        if (Log_1.Log.CheckDebug()) {
          Log_1.Log.Debug("Login", 69, "BtnSureClick", ["index", e], ["quality", i.Quality], ["isRecommend", i.IsRecommend]);
        }
  ...
  async OnBeforeStartAsync() {
    this.HDo = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.sGe);
