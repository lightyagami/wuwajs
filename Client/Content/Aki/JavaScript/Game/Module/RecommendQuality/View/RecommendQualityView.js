...
class RecommendQualityView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.jio = void 0, this.HDo = void 0, this.hml = () => {
      var e, i;
      this.HDo && (e = this.HDo.GetSelectedGridIndex(), i = this.HDo.GetDatas()[e], Log_1.Log.CheckDebug() && Log_1.Log.Debug("Login", 69, "BtnSureClick", ["index", e], ["quality", i.Quality], ["isRecommend", i.IsRecommend]), this.jio?.SaveApply(i.Quality), this.CloseMe())
  ...
  async OnBeforeStartAsync() {
    this.HDo = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.sGe), await this.HDo.RefreshByDataAsync(this.jio.GetQualityList());
