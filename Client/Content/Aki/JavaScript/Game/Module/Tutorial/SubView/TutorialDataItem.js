...
class TutorialDataItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RRo = void 0, this.URo = void 0, this.N8e = t => {
  ...
  kxt() {
    this.GetItem(0).SetUIActive(!0), this.GetExtendToggle(2).RootUIComp.SetUIActive(!1);
    var t = this.GetText(1);
    this.RRo.Text ? t.SetText(this.RRo.Text) : LguiUtil_1.LguiUtil.SetLocalTextNew(t, this.RRo.TextId)
  }
  ARo() {
    this.GetItem(0).SetUIActive(!1);
    var t = this.GetExtendToggle(2),
      i = (t.RootUIComp.SetUIActive(!0), this.GetText(4));
    this.RRo.Text ? i.SetText(this.RRo.Text) : LguiUtil_1.LguiUtil.SetLocalTextNew(i, this.RRo.TextId), this.RefreshRed(), t.SetToggleState(0, !1), this.RRo.Selected && this.OnSelected(!0)
  }
  RefreshRed() {
    this.RRo.IsTypeTitle || this.GetItem(3).SetUIActive(this.RRo.SavedData.HasRedDot)
  }
  OnSelected(t) {
