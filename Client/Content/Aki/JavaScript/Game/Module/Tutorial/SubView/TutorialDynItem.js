...
class TutorialDynItem extends UiPanelBase_1.UiPanelBase {
  ...
  GetItemSize(e) {
    return void 0 === this.eqe && (this.eqe = Vector2D_1.Vector2D.Create()), e.IsTypeTitle ? (e = this.GetItem(0), this.eqe.Set(e.GetWidth(), e.GetHeight())) : (e = this.GetRootItem(), this.eqe.Set(e.GetWidth(), e.GetHeight())), this.eqe.ToUeVector2D(!0)
  }
  ClearItem() {}
}
