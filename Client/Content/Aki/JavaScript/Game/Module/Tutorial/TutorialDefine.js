...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.TutorialSaveData = exports.TutorialItemData = exports.TutorialUtils = exports.ETutorialType = void 0;
const CommonParamById_1 = require("../../../Core/Define/ConfigCommon/CommonParamById"),
  MultiTextLang_1 = require("../../../Core/Define/ConfigQuery/MultiTextLang"),
  ConfigManager_1 = require("../../Manager/ConfigManager");
var ETutorialType;
! function(t) {
  t[t.All = 0] = "All", t[t.QteReaction = 1] = "QteReaction", t[t.Enemy = 2] = "Enemy", t[t.System = 3] = "System", t[t.Adventure = 4] = "Adventure", t[t.BuffOnEnemy = 5] = "BuffOnEnemy"
...
class TutorialUtils {
  ...
  static GetTutorialTypeIconPath(t) {
    if (this.wRo.has(t)) return t = TutorialUtils.wRo.get(t), ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(t)
  }
  static GetTutorialTypeTxt(t) {
    if (this.BRo.has(t)) return TutorialUtils.BRo.get(t)
  }
}(exports.TutorialUtils = TutorialUtils).FixedDropDropShowPlanId = 1, TutorialUtils.wRo = new Map([
...
class TutorialItemData {
  constructor() {
    this.IsTypeTitle = !1, this.TextId = void 0, this.Text = void 0, this.SavedData = void 0, this.Selected = !1, this.OwnerType = void 0
  }
}
exports.TutorialItemData = TutorialItemData;
class TutorialSaveData {
  constructor() {
    this.TimeStamp = 0, this.TutorialId = 0, this.HasRedDot = !1, this.vKl = void 0
  }
  get IsExcludedFromWiki() {
    var t;
    return void 0 === this.vKl && void 0 !== (t = ConfigManager_1.ConfigManager.GuideConfig.GetGuideTutorial(this.TutorialId)?.ExcludeFromWiki) && (this.vKl = t), this.vKl ?? !1
  }
  get TutorialData() {
