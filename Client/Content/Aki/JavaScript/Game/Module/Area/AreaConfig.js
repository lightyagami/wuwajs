  ...
  GetLevelOneAreaId(o) {
    ...
    if (n > ExploreProgressDefine_1.AREA_LEVEL) {
      ...
      for (; n > ExploreProgressDefine_1.AREA_LEVEL && 0 < r;) {
        ...
        if (!A) break;
        if ((e = A.Father) === o) {
          Log_1.Log.CheckError() && Log_1.Log.Error("Area", 63, "区域配置->获取所属一级区域出现闭环，请联系策划检查配置", ["parentAreaId", e], ["areaId", o], ["level", n], ["ret", t]);
          break
        }
        n = A.Level, t = A.Level === ExploreProgressDefine_1.AREA_LEVEL ? A.AreaId : 0, --r
      }
      r <= 0 && Log_1.Log.CheckError() && Log_1.Log.Error("Area", 63, "区域配置->获取所属一级区域次数超过上限，请联系策划检查配置", ["parentAreaId", e], ["areaId", o], ["level", n], ["ret", t]), n > ExploreProgressDefine_1.AREA_LEVEL && Log_1.Log.CheckError() && Log_1.Log.Error("Area", 63, "区域配置->获取所属一级区域,查找失败>请联系策划检查配置", ["areaId", o], ["level", n], ["ret", t])
    }
    return t
  }
  GetStoryList(e) {
