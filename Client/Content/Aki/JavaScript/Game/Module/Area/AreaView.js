...
class AreaView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.bWe = !1, this.qWe = () => {
      this.GetText(0) && ModelManager_1.ModelManager.AreaModel.AreaHintName && this.GetText(0).SetText(ModelManager_1.ModelManager.AreaModel.AreaHintName)
    }, this.GWe = () => {
