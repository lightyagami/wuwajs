...
class PayItemController extends UiControllerBase_1.UiControllerBase {
  ...
  static _Fa(o) {
    ...
    Net_1.Net.Call(26819, e, e => {
      var r;
      var t;
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16416);
      } else {
  ...
  static async SendPayItemInfoRequestAsync() {
    ...
    e.K7n = ModelManager_1.ModelManager.PayItemModel.Version;
    var e = await Net_1.Net.CallAsync(26729, e);
