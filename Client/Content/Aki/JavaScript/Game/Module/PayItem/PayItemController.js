...
class PayItemController extends UiControllerBase_1.UiControllerBase {
  static OnRegisterNetEvent() {
    ...
    Net_1.Net.Register(25469, PayItemController.QOi);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(25469);
    Net_1.Net.UnRegister(19121);
  }
  static OnAddEvents() {
  ...
  static _Fa(o) {
    ...
    Net_1.Net.Call(16748, e, e => {
      var r;
      var t;
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16892);
      } else {
  ...
  static async SendPayItemInfoRequestAsync() {
    ...
    e.K7n = ModelManager_1.ModelManager.PayItemModel.Version;
    var e = await Net_1.Net.CallAsync(18590, e);
    return !!e && !(e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19823), !e.K7n) && !!e.OUs && !(ModelManager_1.ModelManager.PayItemModel.Version = e.K7n, ModelManager_1.ModelManager.PayItemModel.InitDataListByServer(e.OUs), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshPayShopInstanceRedDot, 100), 0);
  }
