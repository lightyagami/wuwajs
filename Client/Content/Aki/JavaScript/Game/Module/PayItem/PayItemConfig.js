...
const CommonParamById_1 = require("../../../Core/Define/ConfigCommon/CommonParamById"),
  ...
  PayGiftAll_1 = require("../../../Core/Define/ConfigQuery/PayGiftAll"),
...
class PayItemConfig extends ConfigBase_1.ConfigBase {
  ...
  GetPayShowCurrency() {
    return ControllerHolder_1.ControllerHolder.KuroSdkController.GetIfGlobalSdk() ? this.GetGlobalCurrencyChar() : this.GetMainlandCurrencyChar()
  }
  GetPayShow(e) {
    var r, a = ModelManager_1.ModelManager.KuroSdkModel?.GetQueryProductShowPrice(e.toString());
