...
exports.RoguelikeChooseData = undefined;
const RogueGainEntry_1 = require("./RogueGainEntry");
class RoguelikeChooseData {
  constructor(t) {
    this.CostCurrency = [];
    this.CallBack = undefined;
    this.Index = t.c5n ?? undefined;
    this.RoguelikeGainDataType = t.h5n ?? undefined;
    this.MaxTime = t.X2s;
    this.UseTime = t.Y2s;
    this.EventId = t.J2s;
    this.Layer = t.AHn;
    ...
    for (const s of t.z2s) {
      this.RogueGainEntryList.push(new RogueGainEntry_1.RogueGainEntry(s, this.Index));
    }
