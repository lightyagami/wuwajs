...
exports.PhantomSelectItem = undefined;
const UE = require("ue");
...
class PhantomSelectItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(t = true) {
    ...
    this.PhantomAttrLayout = undefined;
  ...
  Update(t) {
    if (t.RoguelikeGainDataType === Protocol_1.Aki.Protocol.a8s.hxs) {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UITexture], [1, UE.UIText], [2, UE.UIText], [3, UE.UIVerticalLayout], [4, UE.UIItem], [5, UE.UIExtendToggle], [6, UE.UITexture], [7, UE.UITexture], [8, UE.UIItem], [9, UE.UIItem]];
    this.BtnBindInfo = [[5, this.Mho]];
  }
  OnStart() {
    this.PhantomAttrLayout = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(3), this.Eho);
  ...
  F7i() {
    ...
    if (t && (this.GetText(1).ShowTextNew(t.PokemonName), this.SetTextureByPath(t.PokemonIcon, this.GetTexture(0)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), t.PokemonSkillDesc), this.GetText(2).SetUIActive(ModelManager_1.ModelManager.RoguelikeModel.GetDescModel() === 1), t = ConfigManager_1.ConfigManager.RoguelikeConfig.GetRogueQualityConfigByQualityId(t.Quality))) {
        ...
        this.PhantomAttrLayout.BindLateUpdate(() => {
          if (e === 0) {
            ...
            this.PhantomAttrLayout.GetLayoutItemList().forEach(t => {
              if (this.NewUnlockAttrSet.has(t.AffixEntry.Id)) {
                t.PlayComplete();
                i = true;
              }
              if (!i) {
                e += t.GetRootItem().Height + h.GetSpacing();
              }
