...
class RogueInfoSpecialView extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Aho = void 0, this.UiViewSequence = void 0, this.Pho = () => new RoguelikeSelectSpecialItem_1.RoguelikeSelectSpecialItem(this.xho), this.xho = (e, i) => {
      e.SetSelect(!1), UiManager_1.UiManager.OpenView("RoguelikeSpecialDetailView", [i, void 0])
    }
  }
  OnRegisterComponent() {
