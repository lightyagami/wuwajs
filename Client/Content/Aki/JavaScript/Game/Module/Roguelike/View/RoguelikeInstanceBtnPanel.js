...
class RoguelikeInstanceBtnPanel extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    var e;
    ModelManager_1.ModelManager.RoguelikeModel.CheckRogueIsOpen() && void 0 !== (e = ActivityRogueController_1.ActivityRogueController.GetCurrentActivityData()?.SeasonData) && await RoguelikeController_1.RoguelikeController.RoguelikeTalentInfoRequest(e.UHn)
  }
  OnStart() {
    this.Refresh()
  }
  ...
  BindRedDot() {
    RedDotController_1.RedDotController.BindRedDot("RogueSkillUnlock", this.GetItem(5)), RedDotController_1.RedDotController.BindRedDot("RoguelikeShop", this.GetItem(6))
  }
  UnBindRedDot() {
    RedDotController_1.RedDotController.UnBindGivenUi("RogueSkillUnlock", this.GetItem(5)), RedDotController_1.RedDotController.UnBindGivenUi("RoguelikeShop", this.GetItem(6))
  }
  Refresh() {
    var e = ActivityRogueController_1.ActivityRogueController.GetCurrentActivityData()?.SeasonData,
      t = (e && (o = ModelManager_1.ModelManager.RoguelikeModel.GetParamConfigBySeasonId()?.WeekTokenMaxCount ?? 1, t = e.yqs / o, this.GetSprite(4)?.SetFillAmount(t), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), "Roguelike_ActivityMain_Score", e.yqs, o)), MathUtils_1.MathUtils.LongToBigInt(ModelManager_1.ModelManager.RoguelikeModel?.TempCountdown ?? 0)),
      e = Number(t) - TimeUtil_1.TimeUtil.GetServerTime(),
      o = TimeUtil_1.TimeUtil.CalculateRemainingTime(e);
    o && LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), o.TextId, o.TimeValue)
  }
}
