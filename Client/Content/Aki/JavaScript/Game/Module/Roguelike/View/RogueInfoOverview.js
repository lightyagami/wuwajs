...
class RogueInfoOverview extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.PhantomItem = void 0, this.RoleItem = void 0, this.AttributeItemList = [], this.UiViewSequence = void 0, this.Rho = () => {
      var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems();
      e.length <= 0 ? Log_1.Log.CheckError() && Log_1.Log.Error("Roguelike", 34, "肉鸽界面打开属性面板，找不到主控的角色") : (e = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e[0].GetConfigId), UiManager_1.UiManager.OpenView("RogueAttributeDetailView", e.GetShowAttrList()))
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.RoleItem = new RoleSelectItem_1.RoleSelectItem, await this.RoleItem.CreateThenShowByActorAsync(this.GetItem(1).GetOwner()), this.PhantomItem = new PhantomSelectItem_1.PhantomSelectItem(!1), await this.PhantomItem.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  OnStart() {
    ...
    var e = ConfigManager_1.ConfigManager.RoguelikeConfig.GetRoguePhantomConfig(ModelManager_1.ModelManager.RoguelikeModel.RogueInfo.PhantomEntry.ConfigId),
      e = (this.PhantomItem?.GetRootItem().SetUIActive(void 0 !== e), this.PhantomItem?.SetToggleRaycastTarget(!1), this.RoleItem?.Update(ModelManager_1.ModelManager.RoguelikeModel.RogueInfo.RoleEntry), ConfigManager_1.ConfigManager.RoguelikeConfig.GetRogueCharacterConfig(ModelManager_1.ModelManager.RoguelikeModel.RogueInfo.RoleEntry.ConfigId));
  ...
  UpdateAttribute() {
    var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems();
    if (e.length <= 0) Log_1.Log.CheckError() && Log_1.Log.Error("Roguelike", 8, "肉鸽属性展示面板, 找不到主控角色实体!");
    else {
      var t = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e[0].GetConfigId),
        i = CommonParamById_1.configCommonParamById.GetIntArrayConfig("RoleAttributeDisplay6");
