...
class TopPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.n6t = void 0, this.CloseCallback = void 0, this.jso = () => {
      this.CloseCallback?.()
    }, this.Blo = e => {
  ...
  OnStart() {
    this.n6t = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.n6t.SetCloseBtnActive(!1), this.n6t.SetHelpBtnActive(!1)
  }
  OnBeforeShow() {
    this.RefreshTabBtn()
  }
  RefreshTabBtn() {
    var e = 0 === ModelManager_1.ModelManager.RoguelikeModel.GetDescModel() ? 1 : 0;
  ...
  RefreshSelectTipsText(e, t = !1, ...i) {
    t ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(6), e, ...i) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), e, ...i)
  }
  EmptySelectTipsText() {
