...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueCharacterRoomItem = exports.RogueCharacterRoomSelectView = void 0;
const UE = require("ue"),
...
class RogueCharacterRoomSelectView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Era = void 0, this.Sui = void 0, this.yra = -1, this.Ira = () => {
      var e = this.OpenParam;
      ControllerHolder_1.ControllerHolder.RoguelikeController.RoguelikeRoleRoomSelectRequest(this.yra, e.Index).then(() => {
        this.CloseMe()
      })
    }, this.Tra = (e, t, i) => {
      t ? (this.Sui?.DeselectCurrentGridProxy(), this.Sui?.SelectGridProxy(e), this.yra = i) : this.Sui?.DeselectCurrentGridProxy(), this.GetButton(3).SetSelfInteractive(t)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.Era = new TopPanel_1.TopPanel, await this.Era.CreateThenShowByActorAsync(this.GetItem(0).GetOwner()), this.Era.CloseCallback = () => {
      this.CloseMe()
    ...
    var e = this.OpenParam;
    await this.Sui.RefreshByDataAsync(e.RoomIdList), this.GetButton(3).SetSelfInteractive(!1)
  }
}
...
class RogueCharacterRoomItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.ClickCallback = void 0, this.RoomId = -1, this.Sui = void 0, this.Fao = () => {
      return new CommonSelectItem_1.CommonElementItem
    }, this.cFe = () => {
      this.ClickCallback && this.ClickCallback(this.GridIndex, this.IsSelectRoom(), this.RoomId)
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  Refresh(e, t, i) {
    ...
    if (e) {
      ...
      if (r) {
        ...
        }), i && this.Sui?.RefreshByData(i), this.SetTextureByPath(e.Icon, this.GetTexture(0)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.Name), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e.Desc)
      }
    }
  }
}
