...
exports.RoguelikeSpecialDetailView = undefined;
const UE = require("ue");
...
class RoguelikeSpecialDetailView extends UiViewBase_1.UiViewBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UITexture], [1, UE.UITexture], [2, UE.UIText], [3, UE.UIHorizontalLayout], [4, UE.UIText], [5, UE.UIText], [6, UE.UIText], [7, UE.UIButtonComponent], [8, UE.UINiagara], [9, UE.UINiagara]];
  ...
  Hqe(e) {
    ...
    if (i !== undefined) {
      ...
      s.SetUIActive(false);
      this.SetTextureByPath(i.Icon, s, undefined, () => {
        s.SetUIActive(true);
      });
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), i.Name);
      var t = ModelManager_1.ModelManager.RoguelikeModel?.GetDescModel() === 0 ? i.BriefDescribe : i.Describe;
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), t);
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(6), i.StoryDescribe);
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), "RogueSpecialRemainTime", e.RestCount);
      this.GetText(4).SetUIActive(e.RestCount !== 0);
      var t = i.Category === 1 ? "FFFFFF" : "FFC3CC";
