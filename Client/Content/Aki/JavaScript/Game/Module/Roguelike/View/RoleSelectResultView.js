...
class RoleSelectResultView extends RogueSelectResultBaseView_1.RogueSelectResultBaseView {
  constructor() {
    super(...arguments), this.jao = void 0, this.Plo = void 0, this.UiPoolActorPrivate = void 0, this.xlo = () => {
      ...
      var e = this.jao.NewRogueGainEntry,
        ...
        i = new Set;
      if (e)
        for (const s of e.AffixEntryList) t?.AffixEntryList?.find(e => e.Id === s.Id) || i.has(s.Id) || i.add(s.Id);
      i.size <= 0 || (e = this.Plo.GetLayoutItemByIndex(0)) && e.SetSecondColorForAttrItem(i)
    }
  }
  async OnCreateAsync() {
  ...
  OnStart() {
    super.OnStart(), this.UiPoolActorPrivate.UiItem.SetUIParent(this.GetHorizontalLayout(3).GetRootComponent()), this.jao = this.OpenParam, this.Plo = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.xlo)
  }
  OnBeforeDestroy() {
    this.UiPoolActorPrivate && UiActorPool_1.UiActorPool.RecycleAsync(this.UiPoolActorPrivate, RoguelikeDefine_1.ROLE_SELECT_ITEM)
  }
  OnCloseBtnClick() {
