...
class PhantomSelectResultView extends RogueSelectResultBaseView_1.RogueSelectResultBaseView {
  constructor() {
    super(...arguments), this.jao = void 0, this.yho = void 0, this.Iho = void 0, this.Tho = () => {
  ...
  OnStart() {
    super.OnStart(), this.jao = this.OpenParam, this.Iho.UiItem.SetUIParent(this.GetHorizontalLayout(3).GetRootComponent()), this.yho = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.Tho)
  }
  OnBeforeDestroy() {
    this.Iho && UiActorPool_1.UiActorPool.RecycleAsync(this.Iho, RoguelikeDefine_1.PHANTOM_SELECT_ITEM)
  }
  OnBeforeShow() {
    this.Refresh()
  }
  ...
  RefreshTitleText() {
    void 0 === this.jao.OldRogueGainEntry ? this.GetText(4).ShowTextNew(RoguelikeDefine_1.ROGUELIKEVIEW_25_TEXT) : this.GetText(4).ShowTextNew(RoguelikeDefine_1.ROGUELIKEVIEW_19_TEXT)
  }
}
