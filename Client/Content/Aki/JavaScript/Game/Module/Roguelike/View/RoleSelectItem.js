...
class RoleAttrItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  RefreshPanel() {
    ...
    t && (0 === ModelManager_1.ModelManager.RoguelikeModel?.GetDescModel() ? this.GetText(0).ShowTextNew(t.AffixDescSimple) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), t.AffixDesc, ...t.AffixDescParam))
  }
}
exports.RoleAttrItem = RoleAttrItem;
class RoleSelectItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.mho = void 0, this.Rlo = void 0, this.Ulo = void 0, this.Cho = () => {}, this.Alo = () => {
  ...
  Ake() {
    ...
    if (e) {
      var i = Math.min(5, this.mho.AffixEntryList.length + 1),
        ...
        i = ConfigManager_1.ConfigManager.RoguelikeConfig?.GetRogueQualityConfigByQualityId(i),
        i = (r && (r = UE.Color.FromHex(r.DropColor), this.GetTexture(0).SetColor(r), this.GetTexture(2).SetColor(r), this.GetSprite(3).SetColor(r)), i && (r = new UE.LinearColor(UE.Color.FromHex(i.RoleNiagaraColor)), this.GetUiNiagara(9).SetNiagaraVarLinearColor("Color", r)), ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e.RoleId));
      if (i) {
        this.GetText(4).ShowTextNew(i.Name);
        let t = i.FormationRoleCard;
        r = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e.RoleId).GetRoleSkinId(); - 1 !== r && (i = ConfigManager_1.ConfigManager.SkinConfig.GetRoleSkinConfig(r), t = i.FormationRoleCard), this.SetTextureByPath(t, this.GetTexture(1))
      }
    }
  }
  Sho() {
    this.Rlo.RefreshByDataAsync(this.mho.AffixEntryList ?? []).then(() => {
      if (this.Ulo) {
        let o = void 0;
        for (const t of this.Rlo.GetLayoutItemList()) this.Ulo?.has(t.AffixEntry.Id) && (t.SetSecondColor(), t.RefreshPanel(), o = t);
        if (void 0 !== o) {
          ...
          a.OnLateUpdate.Bind(t => {
            if (2 === ++s) {
              ...
              t = i < e ? r - i * Math.trunc(e / i) - e % i - 10 : r - i, t = Math.max(t, 0), a.ContentUIItem.SetAnchorOffsetY(t), a.OnLateUpdate.Unbind()
            }
          })
        }
      }
