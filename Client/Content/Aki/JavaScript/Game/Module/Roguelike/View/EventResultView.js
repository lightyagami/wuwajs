...
class EventResultViewOneByOne extends RogueSelectResultBaseView_1.RogueSelectResultBaseView {
  constructor() {
    super(...arguments), this.oho = void 0, this.Kei = 0, this.Wao = void 0, this.CommonSelectItemLayout = void 0, this.CloseBtn = () => {
      this.Kei + 1 >= this.oho.RogueGainEntryArray.length ? this.CloseMe(this.oho?.Callback) : (this.PlaySequence("Start"), this.Kei += 1, this.Refresh())
  ...
  async OnBeforeStartAsync() {
    ...
    this.Wao = await UiActorPool_1.UiActorPool.GetAsync(e), this.CommonSelectItemLayout = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.CreateCommonSelectItem, this.Wao?.UiItem.GetOwner())
  }
  OnStart() {
  ...
  OnBeforeDestroy() {
    this.CommonSelectItemLayout?.ClearChildren(), this.Wao && UiActorPool_1.UiActorPool.RecycleAsync(this.Wao, RoguelikeDefine_1.COMMON_SELECT_ITEM)
  }
  Refresh() {
...
class EventResultViewAll extends RogueSelectResultBaseView_1.RogueSelectResultBaseView {
  constructor() {
    super(...arguments), this.oho = void 0, this.Wao = void 0, this.CommonSelectItemLayout = void 0, this.CloseBtn = () => {
