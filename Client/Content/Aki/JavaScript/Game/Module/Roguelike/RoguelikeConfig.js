...
exports.RoguelikeConfig = undefined;
...
const RogueRoomPoolById_1 = require("../../../Core/Define/ConfigQuery/RogueRoomPoolById");
const RogueRoomShowConfigById_1 = require("../../../Core/Define/ConfigQuery/RogueRoomShowConfigById");
...
class RoguelikeConfig extends ConfigBase_1.ConfigBase {
  ...
  GetRoguePhantomConfig(e) {
    if (e !== 0) {
      return RoguePokemonById_1.configRoguePokemonById.GetConfig(e);
    }
  }
  ...
  GetRogueSeasonReward(e) {
    return RogueSeasonRewardBySeasonId_1.configRogueSeasonRewardBySeasonId.GetConfigList(e);
  }
  ...
  GetRoguelikeSpecialConfig(e) {
    return RougeMiraclecreationById_1.configRougeMiraclecreationById.GetConfig(e);
  }
  GetRoguePopularEntrieArg(e, o) {
    return RoguePopularEntrieArgBySeasonIdAndInstId_1.configRoguePopularEntrieArgBySeasonIdAndInstId.GetConfig(e, o);
  }
