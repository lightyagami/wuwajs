...
class HomeBtnModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    EventSystem_1.EventSystem.AddWithTarget(this, EventDefine_1.EEventName.BtnStateUpdate, this.Njd);
    return true;
  }
  ...
  GetShowHomeBtn(e) {
    var t;
    return !!this.dQc && ((t = this._Rd.get(e.Info.Name)) !== undefined ? t : (t = ConfigManager_1.ConfigManager.UiViewConfig.GetUiShowConfig(e.Info.Name)) ? t.HomeBtnShowType === 1 : (Log_1.Log.CheckError() && Log_1.Log.Error("HomeBtn", 87, "未找到UI界面配置", ["ViewName:", e.Info.Name]), false));
  }
  ...
  GetNeedFindComponent(e) {
    return !this.x3d.has(e);
  }
  OnClear() {
    EventSystem_1.EventSystem.RemoveWithTarget(this, EventDefine_1.EEventName.BtnStateUpdate, this.Njd);
    this._Rd.clear();
    this.x3d.clear();
    return true;
  }
