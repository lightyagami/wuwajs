...
class UiSceneRoleActorManager {
  static CreateUiSceneRoleActor(e) {
    this.DKe++;
    var t = ActorSystem_1.ActorSystem.Get(UE.TsUiSceneRoleActor_C.StaticClass(), new UE.TransformDouble, void 0);
...
}(exports.UiSceneRoleActorManager = UiSceneRoleActorManager).DKe = 0, UiSceneRoleActorManager.Dxo = new Map;
