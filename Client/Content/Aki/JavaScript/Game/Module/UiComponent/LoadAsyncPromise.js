...
class LoadAsyncPromise {
  constructor(e, s, t = 100) {
    this.YPo = ResourceSystem_1.ResourceSystem.InvalidId, this.JPo = new CustomPromise_1.CustomPromise, this.zPo(e, s, t)
  }
  get CustomPromise() {
    return this.JPo
  }
  ...
  CancelAsyncLoad() {
    this.HandleId !== ResourceSystem_1.ResourceSystem.InvalidId && ResourceSystem_1.ResourceSystem.CancelAsyncLoad(this.HandleId)
  }
}
