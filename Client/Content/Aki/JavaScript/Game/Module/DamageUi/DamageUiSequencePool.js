...
class DamageUiSequencePool {
  static Preload(e, t, a) {
    ...
    0 < (i = i || DamageUiSequencePool.z2t(e, t)).Size || DamageUiSequencePool.PreloadAdd(i, e, a)
  }
  static z2t(e, t) {
  ...
  static Z2t(e) {
    var t;
    if (!StringUtils_1.StringUtils.IsEmpty(e)) return (t = new DamageSequenceHandle_1.DamageSequenceHandle).Initialize(e), t
  }
  static Clear() {
    for (const e of this.eFt.values()) e.Clear()
  }
}(exports.DamageUiSequencePool = DamageUiSequencePool).SequenceActorRef = (0, puerts_1.$ref)(void 0), DamageUiSequencePool.eFt = new Map, DamageUiSequencePool.h7 = e => {
  e.Destroy()
};
