...
class PhonographNewMusicView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.GenericLayout = void 0, this.OnCreateItem = () => new PhonographNewMusicItem_1.PhonographNewMusicItem, this.OnBtnMask = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    this.GenericLayout = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), this.OnCreateItem), await this.GenericLayout.RefreshByDataAsync(e, !0)
  }
}
