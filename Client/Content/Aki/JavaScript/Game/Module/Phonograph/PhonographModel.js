...
class PhonographModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentPlayMusicId = 0, this.CurrentSelectMusicId = 0, this.CurrentPlayActorEntityId = 0, this.CurrentPlayMusicTime = 0, this.CurrentPlayMusicTotalTime = 0, this.UnlockMusicIds = [], this.NewMusicIds = [], this.RecordMusicIdMap = new Map, this.Gn_ = new Map
  }
  set RecordMusicId(e) {
  ...
  ClearPlayInfo() {
    this.CurrentPlayMusicId = 0, this.CurrentPlayActorEntityId = 0, this.CurrentPlayMusicTime = 0, this.CurrentPlayMusicTotalTime = 0
  }
}
