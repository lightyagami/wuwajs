...
class UiCameraAnimationManager {
  ...
  static SetDynamicDisablePushCamera(a, e) {
    e ? this.SAl.has(a) || this.SAl.add(a) : this.SAl.has(a) && this.SAl.delete(a)
  }
  ...
  static _Po(a) {
    let e = this.lPo.Peek();
    for (var t = a.UniqueId; e && e.UniqueId !== t;) this.lPo.Pop(), e = this.lPo.Peek();
  ...
  static ActivateCameraHandle(a, e = !0, t = !0) {
    this.CurrentCameraHandle ? this.CurrentCameraHandle.Deactivate() : this.CurrentCameraHandle = this.CPo(), this.CurrentCameraHandle.Activate(a, e, t)
  }
  static fPo(e, t = !0, i = !0) {
    this.IsPlayingAnimation() ? this.pPo.WaitCameraAnimationFinished().then(a => {
  ...
  static PushCameraHandleByOpenView(e, t, i = !0) {
    if (UiCameraAnimationManager.CanPushCameraHandle(e)) {
      ...
      if (!r || r.ViewName !== e && r.UniqueId !== t) {
        if (t) {
          var n = this.mPo(t);
          if (n) return void(Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "此界面已经入栈,直接返回", ["PushHandleData", n.ToString()]))
        }
        n = UiCameraHandleData_1.UiCameraHandleData.NewByView(e, t);
        let a = void 0;
        var o = r?.ViewName;
        o && (a = this.GetBlendName(o, e)), this.PushCameraHandle(n, i, !0, a, !0)
      } else Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "此界面已经在栈顶", ["PushHandleData", r?.ToString()], ["viewId", t])
    }
  }
  static PushCameraHandleByHandleName(a, e = !0, t = !0, i = UiCameraAnimationDefine_1.DEFAULT_BLEND_NAME, r = !1, n = void 0, o) {
    var s;
    if (!StringUtils_1.StringUtils.IsBlank(a)) return o = UiCameraHandleData_1.UiCameraHandleData.NewByHandleName(a, o), (s = this.GetLastHandleData()) ? (s = s.ViewName, Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "手动播放镜头动画，将镜头数据的ViewName设置为栈顶的数据", ["HandleName", a], ["ViewName", s]), o.ViewName = s) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("CameraAnimation", 58, "手动播放镜头动画时，当前没有播放任何Ui镜头状态", ["HandleName", a]), this.PushCameraHandle(o, e, t, i, r, n), o;
    Log_1.Log.CheckError() && Log_1.Log.Error("CameraAnimation", 58, "镜头动画的HandleName为空，镜头动画异常")
  }
  static PushCameraHandle(a, e = !0, t = !0, i, r = !1, n = void 0) {
    var o = UiCameraAnimationManager.GetLastHandleData();
    Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------入栈", ["PushHandleData", a.ToString()], ["LastTopHandleData", o?.ToString()]), r && this.vPo(a) ? Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------新的镜头状态和旧的镜头状态一致，不会再次播放推入镜头状态表现", ["CurrentHandleData", this.CurrentCameraHandle?.GetHandleData().ToString()], ["NewHandleData", a.ToString()]) : (this.hPo(a), this.StopUiCameraAnimation(), this.MPo(a, o, e, t, i, n))
  }
  static PopCameraHandleByCloseView(a, e, t, i = !0) {
    UiCameraAnimationManager.CanPushCameraHandle(a) && (i ? (i = this.GetBlendName(a, e), e = this.mPo(t), this.PopCameraHandle(e, i)) : (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "仅删除镜头状态，不做任何表现", ["closeViewName", a], ["closeViewId", t]), this.cPo(t)))
  }
  static PopCameraHandle(a, e) {
    var t, i;
    a ? (t = this.GetLastHandleData(), i = this._Po(a), Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------出栈", ["popHandleData", a.ToString()], ["TopHandleData", i?.ToString()], ["blendName", e]), this.n__(i), this.StopUiCameraAnimation(), this.MPo(i, t, void 0 !== e, !0, e)) : this.ClearDisplay()
  }
  static n__(a) {
    var e, t;
    a && (e = a.ViewName, StringUtils_1.StringUtils.IsEmpty(e) || (t = (e = UiCameraAnimationManager.GetCameraMappingData(e))?.GetUiCameraMappingConfig(), e && 0 !== t?.BodyTargetType && (a.HandleName = e.GetSourceHandleName(), a.Refresh())))
  }
  static vPo(a) {
    var e;
  ...
  static MPo(a, e, t = !0, i = !0, r, n = void 0) {
    var o;
    return this.UiCamera = UiCameraManager_1.UiCameraManager.Get(), this.UiCameraPostEffectComponent = this.UiCamera.GetUiCameraComponent(UiCameraPostEffectComponent_1.UiCameraPostEffectComponent), this.UiCameraSequenceComponent = this.UiCamera.GetUiCameraComponent(UiCameraSequenceComponent_1.UiCameraSequenceComponent), this.EPo && (this.EPo.StopSequence(), this.EPo = void 0, this.UiCamera.Exit()), a ? (a.Refresh(), this.SPo(a), StringUtils_1.StringUtils.IsEmpty(r) ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------入栈是BlendName为空，直接激活镜头状态", ["PushHandleData", a.ToString()], ["blendName", r]), this.fPo(a, t, i), 3) : e ? t ? !(o = ConfigManager_1.ConfigManager.UiCameraAnimationConfig.GetUiCameraAnimationBlendData(r)) || o.Time <= 0 ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "没有混合配置或播放界面摄像机动画时间<=0，直接激活镜头", ["blendName", r]), this.ActivateCameraHandle(a, !1, !1), 3) : (UiCameraAnimationManager.AsyncPlayCameraAnimation(e, a, r).then(a => {
      this.j3t(a, n)
    }, () => {}), 1) : (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------不需要播放镜头动画，直接激活镜头状态", ["LastHandleData", e.ToString()], ["PushHandleData", a.ToString()]), this.ActivateCameraHandle(a, !1, !1), 3) : (this.fPo(a, t, i), 3)) : ((o = this.GetCurrentCameraHandle()) ? (this.EPo = o).Revert(!0, () => {
      this.ClearDisplay()
    }) : this.ClearDisplay(), 2)
  }
  static SPo(a) {
    this.UiCameraSpringStructure?.IsValid() || a.IsEmptyState || (this.UiCameraSpringStructure = this.UiCamera.PushStructure(UiCameraSpringStructure_1.UiCameraSpringStructure))
  }
  static j3t(a, e = void 0) {
    var t = a.FromHandleData,
      i = a.ToHandleData;
    0 === a.FinishType ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------入栈动画结束", ["LastHandleData", t.ToString()], ["PushHandleData", i.ToString()], ["FinishType", a.FinishType]), this.ActivateCameraHandle(i, !1, !1)) : Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "镜头状态数据------入栈动画被停止", ["LastHandleData", t.ToString()], ["PushHandleData", i.ToString()], ["FinishType", a.FinishType]), e && e(a), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnPlayCameraAnimationFinish, a)
  }
  ...
  static ReactivateCameraHandle(a = !1, e = !1) {
    var t, i;
    this.CurrentCameraHandle && !this.CurrentCameraHandle.GetIsPendingRevert() && (t = this.CurrentCameraHandle.GetHandleData()) && (i = t.ViewName, StringUtils_1.StringUtils.IsEmpty(i) || (i = UiCameraAnimationManager.GetCameraMappingData(i)) && (t.HandleName = i.GetSourceHandleName(), t.Refresh()), Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "重新激活镜头状态", ["handleData", t.ToString()]), this.CurrentCameraHandle.Activate(t, a, e))
  }
  ...
  static ClearDisplay() {
    this.StopUiCameraAnimation(), this.yPo(), UiCameraManager_1.UiCameraManager.Destroy();
    for (const a of this.lPo) a.Reset();
    this.lPo.Clear(), this.CurrentCameraHandle?.Reset(), this.UiCamera = void 0, this.UiCameraSpringStructure = void 0, this.UiCameraPostEffectComponent = void 0, this.CurrentCameraHandle = void 0, this.EPo = void 0, this.IPo.clear(), this.TPo.clear()
  }
  static GenerateHandleDataUniqueId() {
    return this.LPo++
  }
  static async AsyncPlayCameraAnimation(a, e, t) {
    return this.pPo ? this.pPo.StopUiCameraAnimation() : this.pPo = new UiCameraAnimation_1.UiCameraAnimation, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnPlayCameraAnimationStart, a, e, t), this.pPo.AsyncPlayUiCameraAnimation(a, e, t)
  }
  ...
  static PlayBackCurrent(a = UiCameraAnimationDefine_1.DEFAULT_BLEND_NAME) {
    ...
    var t;
    e && (!(t = ConfigManager_1.ConfigManager.UiCameraAnimationConfig.GetUiCameraAnimationBlendData(a)) || t.Time <= 0 ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "没有混合配置或播放界面摄像机动画时间<=0，直接激活镜头", ["blendName", a]), this.ActivateCameraHandle(e, !1, !1)) : this.AsyncPlayCameraAnimation(e, e, a).then(a => {
  ...
  static Tick(a) {
    this.pPo && this.pPo.Tick(a), this.CurrentCameraHandle && this.CurrentCameraHandle.Tick(a)
  }
  static BroadUiCameraSequenceEvent(a) {
    UiCameraManager_1.UiCameraManager.Get().GetUiCameraComponent(UiCameraSequenceComponent_1.UiCameraSequenceComponent).ExecuteUiCameraSequenceEvent(a), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnExecuteUiCameraSequenceEvent, a)
  }
  static IsActivate() {
  ...
  static E61() {
    ...
    if (a) {
      a = a.GetConfigId, a = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(a);
      if (a) return a.RoleBody
    }
  }
  static I61() {
    ...
    if (a) {
      ...
      if (e) {
        ...
        if (e) return e.RoleBody
      }
      e = a.Model?.CheckGetComponent(13), a = e.RoleConfigId, e = e.RoleSkinId, a = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(a);
      if (a) return e < 0 ? a.RoleBody : ModelManager_1.ModelManager.RoleSkinModel.GetRoleSkinData(e).GetRoleBody()
    }
  }
  static T61() {
    var a = ModelManager_1.ModelManager.InteractionModel.CurrentInteractEntityId,
      a = EntitySystem_1.EntitySystem.Get(a);
    if (a?.Valid) switch (a.GetComponent(0).GetModelConfig().体型类型) {
      case 0:
        return;
      case 6:
        return "FemaleM";
  ...
  static GetTargetActorSkeletalMesh(a, e = 0) {
    switch (a) {
      case 2:
        ...
        return t ? t.GetComponentByClass(UE.SkeletalMeshComponent.StaticClass()) : void 0;
      case 1:
  ...
  static yPo() {
    this.EnablePlayerActor(), this.EnableCustomCreatureActor(), Global_1.Global.BaseCharacter?.SetDitherEffect(1, 2)
  }
  static DisablePlayerActor() {
    var a, e, t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity;
    t?.Valid ? (t = t.Entity)?.Valid ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头隐藏玩家Actor"), (a = t.GetComponent(1)) && (e = t.Id, this.IPo.has(e) ? Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "已经隐藏过对应的玩家Actor", ["entityId", e], ["PlayerActorDisableHandleIdMap", this.IPo]) : (e = a.DisableActor("Ui镜头Sequence中隐藏角色"), this.IPo.set(t.Id, e)))) : Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头隐藏玩家Actor-失败，因为找不到当前玩家Entity") : Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头隐藏玩家Actor-失败，因为找不到当前玩家EntityHandle")
  }
  static IsDisablePlayer() {
    return this.IsActivate() && 0 < this.IPo.size
  }
  static EnablePlayerActor() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头在清理表现时显示玩家Actor", ["DisableHandleId", this.IPo]);
    for (var [a, e] of this.IPo) {
      var t = EntitySystem_1.EntitySystem.Get(a);
      if (!t?.Valid) return void(Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头在清理表现时显示玩家Actor-失败，因为找不到当前玩家Entity", ["EntityId", a]));
      t = t.GetComponent(1);
      t ? t.EnableActor(e) : Log_1.Log.CheckInfo() && Log_1.Log.Info("CameraAnimation", 58, "Ui镜头在清理表现时显示玩家Actor-失败，因为当前玩家实体找不到BaseActorComponent", ["EntityId", a])
    }
    this.IPo.clear()
  }
      ...
      if (i) {
        ...
        if (!(e > i.length || 0 === e)) {
          ...
          if (r?.Valid) {
            ...
            if (n) {
              Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "隐藏伴生物", ["customServerEntityIds", i], ["customEntity", r.Id]);
              let a = this.TPo.get(t);
              a || (a = new Map, this.TPo.set(t, a)), a.has(e) || (i = n.DisableActor("Ui镜头Sequence中隐藏角色伴生物"), a.set(e, i))
            }
          }
        }
      }
  ...
  static EnableCustomCreatureActor() {
    for (var [a, e] of this.TPo) {
      ...
      if (!a) return;
      var t, i, r = a.CustomServerEntityIds;
      for ([t, i] of e) {
        var n = r[t - 1],
        ...
        if (!o) return;
        Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "显示伴生物", ["customServerEntityIds", r], ["customEntity", n.Id]), o.EnableActor(i)
      }
    }
    this.TPo.clear()
  }
