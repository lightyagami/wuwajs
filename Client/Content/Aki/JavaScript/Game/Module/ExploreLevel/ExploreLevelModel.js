...
class ExploreLevelModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.uVt = new Map, this.ExploreScoreItemTexturePath = ""
  }
  OnInit() {
    for (const s of ConfigManager_1.ConfigManager.InfluenceConfig.GetCountryList()) this.AddCountryExploreLevelData(s.Id);
    ...
    return this.ExploreScoreItemTexturePath = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_IconA_currency_5_UI"), !0
  }
  OnClear() {
  ...
  SetCountryExploreScoreReceived(e, r, o) {
    ...
    t && (t = t.CountryId, t = this.GetCountryExploreLevelData(t)) && t.SetExploreScoreDataReceived(e, r, o)
  }
}
