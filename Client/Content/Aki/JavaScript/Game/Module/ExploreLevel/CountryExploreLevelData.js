...
class CountryExploreLevelData {
  constructor() {
    this.z5t = 0, this.Z5t = 0, this.eVt = 0, this.tVt = new Map, this.iVt = [], this.oVt = [], this.rVt = new Map, this.nVt = [], this.sVt = 0
  }
  Initialize(e, t) {
    this.z5t = e, this.sVt = 0;
    for (const a of t) {
      var r = new CountryExploreLevelRewardData_1.CountryExploreLevelRewardData,
        o = (r.Initialize(a), a.ExploreLevel);
      this.tVt.set(o, r), this.iVt.push(r), a.Show && this.oVt.push(r), this.sVt < o && (this.sVt = o)
    }
  }
    ...
    for (const a of this.rVt.values())
      for (var [t, r] of a) {
        var o = r.LastProgress,
          o = a.get(o);
        o && !o.GetIsReceived() || (r.CanReceive() || r.GetIsReceived() || t > r.GetAreaProgress()) && e.push(r)
      }
    return e
  }
  ...
  CanLevelUp() {
    ...
    return !(0 === e || this.eVt >= t.GetMaxExploreScore()) && this.eVt + e >= t.GetMaxExploreScore()
  }
}
