...
const Log_1 = require("../../../Core/Common/Log"),
  ...
  PhantomArenaController_1 = require("../PhantomArena/PhantomArenaController"),
  ...
  BeginnerCarnivalController_1 = require("./ActivityContent/BeginnerCarnival/BeginnerCarnivalController"),
  ...
  ActivityMoraleController_1 = require("./ActivityContent/Morale/ActivityMoraleController"),
...
class ActivityManager {
  ...
  static Clear() {
    this.N4e.forEach((t, o) => {
      t.Clear()
    }), this.N4e.clear(), ActivityControllerHolder_1.ActivityControllerHolder.Clear()
  }
