...
class ActivityInstanceEntranceData {
  ...
  static Create(t, e, i, r, n, s, a) {
    ...
    return h.Wwl = t, h.Qwl = e, h.Kwl = i, h.$wl = r, h.rOl = s, h.Xwl = n, h.Ywl = a, h
  }
}
...
class ActivityEntrancePointData {
  constructor() {
    this.Jwl = 0, this.Zwl = 0, this.l4e = void 0, this.eBl = 0, this.$Tt = void 0, this.tBl = void 0, this.oOl = void 0
  }
  GetCurrentPoint() {
    return this.Jwl
  }
  ...
  static Create(t, e, i, r, n, s, a) {
    ...
    return h.Jwl = t, h.l4e = i, h.eBl = r, h.Zwl = e, h.$Tt = n, h.oOl = s, h.tBl = a, h
  }
}
...
class ActivityEntranceSelectItemData {
  ...
  GetCurrentSelectData() {
    let t = void 0;
    for (const e of this.sBl) e.MainData ? e.MainData.GetSelectState() && (t = e) : e.SubData && e.SubData.GetSelectState() && (t = e);
  ...
  aBl() {
    ...
    for (let t = 0; t < this.nBl.length; t++) {
      var e = new ActivityEntranceItemData,
        i = (e.MainData = this.nBl[t], this.sBl.push(e), this.nBl[t].GetSubDataList());
      if (i)
...
class ActivityEntranceItemData {
  ...
  HaveChildData() {
    var t;
    return !!this.MainData && !!(t = this.MainData.GetSubDataList()) && 0 < t.length
  }
  GetInstanceConfig() {
    var t = this.GetInstanceDungeonId();
    if (0 !== t) return ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(t)
  }
  ...
  GetInstanceName() {
    ...
    return t && "" !== t ? MultiTextLang_1.configMultiTextLang.GetLocalTextNew(t) : ""
  }
  GetSelectCallBack() {
    var t = this.MainData || this.SubData;
...
class ActivityEntranceSelectItemBaseData {
  constructor() {
    this.lkn = !1, this.lBl = 0, this.hBl = 0, this.iBl = void 0, this.rBl = void 0, this._Bl = void 0, this.uBl = void 0, this.cBl = void 0, this.mBl = void 0, this.dBl = void 0, this.CBl = void 0, this.gBl = void 0, this.pBl = void 0, this.U3l = void 0, this.rMt = void 0, this.fBl = []
  }
  GetSelectState() {
    return this.lkn
  }
  ...
  static Create(t, e, i, r, n, s, a, h, c, o, v, u, D, l, G) {
    ...
    return d.lkn = !1, d.lBl = t, d.hBl = e, d.iBl = r, d.rBl = n, d._Bl = s, d.uBl = a, d.mBl = h, d.cBl = c, d.dBl = o, d.gBl = G, d.pBl = u, d.CBl = v, d.U3l = D, d.rMt = l, d.fBl = i, d
  }
}
...
class ActivityEntranceDropDownContentData {
  constructor() {
    this.lBl = 0, this.MBl = void 0, this.yBl = void 0, this.CBl = void 0, this.EBl = void 0
  }
  GetDataIndex() {
    return this.lBl
  }
...
class ActivityEntranceMonsterPreviewData {
  constructor() {
    this.nOl = void 0, this.sOl = void 0, this.mBl = void 0, this.aOl = void 0
  }
  GetMonsterTips(t) {
