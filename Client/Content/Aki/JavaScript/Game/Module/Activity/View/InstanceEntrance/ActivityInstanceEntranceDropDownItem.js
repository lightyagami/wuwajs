...
exports.ActivityInstanceEntranceDropDownItem = undefined;
const UE = require("ue");
...
class ActivityInstanceEntranceDropDownItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments);
    this.c_i = undefined;
    this.EntranceData = undefined;
    this.g_i = e => e;
    this.d_i = (e, t) => new DropDownItem(e);
    this.C_i = e => new DropDownTitle(e);
    this.f_i = (e, t) => {
      this.EntranceData.GetActivityEntranceDropDownData()?.SetDefaultIndex(t.GetDataIndex());
  ...
  RefreshView(e, t) {
    ...
    t = this.EntranceData.GetActivityEntranceSelectItemData().GetCurrentSelectData().GetDefaultDifficultIndex();
