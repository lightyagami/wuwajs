...
class ActivityInstanceEntranceScoreItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.C0t = void 0, this.hih = () => {
  ...
  RefreshView(t) {
    this.C0t && this.C0t.GetRedDotName() && RedDotController_1.RedDotController.UnBindGivenUi(this.C0t.GetRedDotName(), this.GetItem(2), this.C0t.GetRedDotId()), this.C0t = t, this.C0t && this.C0t.GetRedDotName() && RedDotController_1.RedDotController.BindRedDot(this.C0t.GetRedDotName(), this.GetItem(2), void 0, this.C0t.GetRedDotId());
    t = t.GetRewardData();
