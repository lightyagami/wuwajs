...
class ActivityPageSelectContent extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Pe = void 0, this.uFe = void 0, this.kel = void 0, this.U5e = !1, this.cJs = t => {
      this.Pe?.Id && this.Pe.Id === t && (this.P5e(), this.u3e(), this.Kbe(), this.sM1())
    }, this.jbe = t => {
      this.kel?.(this.Pe, t)
    }, this.A5e = () => this.uFe?.(this.Pe.Id, 1 === this.GetExtendToggle(0).GetToggleState()) ?? !0
  }
  OnRegisterComponent() {
  ...
  Refresh(t, e, i) {
    try {
      this.Pe = t, this.K8e(t), this.Oqe(e), this.P5e(), this.u3e(), this.Kbe(), this.sM1()
    } catch (t) {
      ModelManager_1.ModelManager.ActivityModel.OpenActivityErrorConfirmBox(this.Pe?.Id ?? 0, this.Pe?.Type ?? 0), t instanceof Error ? Log_1.Log.CheckError() && Log_1.Log.ErrorWithStack("Activity", 37, "[Activity] 活动页签状态异常", t, ["id", this.Pe?.Id ?? 0], ["error", t.message]) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[Activity] 活动页签状态异常", ["id", this.Pe?.Id ?? 0])
    }
  }
  P5e() {
  ...
  Kbe() {
    ...
    if (i.SetUIActive(!1), e && 0 !== e.length) {
      let t = 0;
      2 <= e.length && (s = ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerGender(), t = 0 === s ? 0 : 1), this.SetTextureByPath(e[t], i, void 0, () => {
        i.SetUIActive(!0)
      });
  ...
  K8e(t) {
    this.Ovt(), RedDotController_1.RedDotController.BindRedDot("CommonActivityPage", this.GetItem(2), void 0, t.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, t.Id), this.U5e = !0
  }
  Ovt() {
    this.U5e && (RedDotController_1.RedDotController.UnBindGivenUi("CommonActivityPage", this.GetItem(2), this.Pe.Id), this.U5e = !1)
  }
  GetKey(t, e) {
    return t.Id
  }
