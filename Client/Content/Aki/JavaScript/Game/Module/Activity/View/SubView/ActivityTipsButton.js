...
class ActivityTipsButton extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(), this.jel = void 0, this.Gke = void 0, this.Wel = () => {
      this.jel && ControllerHolder_1.ControllerHolder.HelpController.OpenHelpById(this.jel)
    }, this.ije = () => {
      this.Gke?.()
    }, this.jel = CommonParamById_1.configCommonParamById.GetIntConfig("PermanentActivityHelpId"), this.Gke = this.Wel
  }
  OnRegisterComponent() {
