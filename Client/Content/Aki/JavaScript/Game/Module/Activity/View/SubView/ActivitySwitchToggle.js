...
class ActivitySwitchToggle extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.H5e = void 0, this.Nel = new Map, this.Fel = 0, this.j5e = void 0, this.W5e = void 0, this.K5e = 0, this.Bke = t => {
      this.j5e && this.j5e(this.K5e, t)
    }, this.A5e = () => !this.W5e || this.W5e(this.K5e, this.H5e.GetToggleState()), this.BNe = t => {
      var e, i = this.Nel.get(t);
      void 0 !== i && (e = this.Vel(t), this.Nel.set(t, e), i && !e ? this.Hel(!1) : !i && e && this.Hel(!0))
    }, this.K5e = t
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.H5e = this.GetExtendToggle(0), this.H5e.CanExecuteChange.Bind(this.A5e), this.GetItem(2).SetUIActive(!1)
  }
  OnBeforeShow() {
    this.KBl(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.BNe)
  }
  OnBeforeHide() {
  ...
  Hel(t) {
    var e = this.Fel;
    t ? this.Fel++ : this.Fel--, (e && !this.Fel || !e && this.Fel) && this.SetRedDotState(0 < this.Fel)
  }
  SetRedDotState(t) {
