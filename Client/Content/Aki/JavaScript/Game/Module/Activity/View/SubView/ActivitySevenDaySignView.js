...
class ActivitySevenDaySignView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.x5e = void 0, this.w5e = void 0, this.k3e = e => {
      this.F3e(e) ? ActivitySevenDaySignController_1.ActivitySevenDaySignController.GetRewardByDay(this.w5e.Id, e) : e === this.w5e.GetImportantItemIndex() && this.B5e()
    }, this.B5e = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let i = 0; i < SIGN_DAY_COUNT; i++) {
      ...
      0 <= r && r === i ? (e = new ActivitySevenDaySignDefine_1.ImportantRewardItem).BigIconPath = this.w5e?.GetBigRewardIcon(this.w5e.Id) ?? "" : e = new ActivitySevenDaySignDefine_1.NormalRewardItem, this.x5e.push(e), e.SkipDestroyActor = !0, e.OnClickToGet = this.k3e, t.push(e.CreateThenShowByActorAsync(n.GetOwner()))
    }
    await Promise.all(t)
  }
  OnBeforeShow() {
  ...
  OnRefreshView() {
    this.GetText(0).SetText(this.w5e.GetTitle()), this.GetText(2).SetText(this.b5e()), this.jqe()
  }
  jqe() {
    this.OnTimer(1);
    ...
    this.GetButton(3)?.RootUIComp.SetUIActive(e), this.GetButton(3)?.RootUIComp.SetRaycastTarget(e)
  }
  F3e(e) {
