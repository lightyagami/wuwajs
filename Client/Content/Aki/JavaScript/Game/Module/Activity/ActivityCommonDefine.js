...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.ActivityConditionGroupData = exports.ActivityTaskData = exports.taskStateToRewardStateResolver = exports.taskStateResolver = exports.activityViewStateSequence = exports.timeTypeStateResolver = exports.REDDOT_TOLERANCE = exports.ACTIVITYFIRSTUNLOCKFLAG = void 0;
const Protocol_1 = require("../../../Core/Define/Net/Protocol"),
  UiPopViewData_1 = require("../../Ui/Define/UiPopViewData");
exports.ACTIVITYFIRSTUNLOCKFLAG = -100, exports.REDDOT_TOLERANCE = .1, exports.timeTypeStateResolver = {
...
class ActivityTaskData {
  ...
  Refresh(t, o) {
    ...
    var s = this.Status;
    this.Status = exports.taskStateResolver[t.H6n], o?.(s !== this.Status, s, this.Status)
  }
}
