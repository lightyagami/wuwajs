...
class ActivityBeginnerBookData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.AllBeginnerTargetList = [], this.UnLockBeginnerMap = new Map, this.FinishBeginnerMap = new Map
  }
  PhraseEx(t) {
  ...
  GetEnableJump(t) {
    return 0 === ConfigManager_1.ConfigManager.ActivityBeginnerBookConfig?.GetActivityBeginnerConfig(t).ConditionId || (this.UnLockBeginnerMap.get(t) ?? !1)
  }
  GetFinishState(t) {
