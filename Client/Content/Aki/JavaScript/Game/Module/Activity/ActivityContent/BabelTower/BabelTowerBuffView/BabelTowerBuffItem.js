...
class BabelTowerBuffItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Pe = void 0, this.tqe = void 0, this.OnToggleClick = void 0, this.LZ_ = () => {
  ...
  async OnBeforeStartAsync() {
    this.tqe = new BabelTowerBuffStarItem_1.BabelTowerStarItem, await this.tqe.CreateThenShowByResourceIdAsync("UiItem_ItemAStar", this.GetItem(4))
  }
  Refresh(e, t, r) {
    this.Pe = e;
    ...
    let s = void 0,
      o = void 0,
      a = void 0;
    a = (this.Pe.IsDeTerm ? (i = BabelTowerDeTermById_1.configBabelTowerDeTermById.GetConfig(this.Pe.Id), s = i.NameText, o = i.Texture, i) : (t = BabelTowerBuffById_1.configBabelTowerBuffById.GetConfig(this.Pe.Id), s = t.NameText, o = t.Texture, t)).Star, LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), s), this.SetTextureByPath(o, this.GetTexture(1));
    e.ShowStar ? (this.tqe.SetActive(!0), this.tqe.SetText(a.toString())) : this.tqe.SetActive(!1);
