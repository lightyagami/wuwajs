...
class RewardShopGridItem extends PayShopItem_1.PayShopItem {
  constructor() {
    super(...arguments), this.b2a = (e, o) => {
      ModelManager_1.ModelManager.MoonChasingRewardModel.ReadShopItemUnlockFlag(o) && this.SetNewFlagState(!1)
    }
  }
  OnStart() {
  ...
  Refresh(e, o, a) {
    e instanceof PayShopGoods_1.PayShopGoods && (super.Refresh(e, o, a), o = ModelManager_1.ModelManager.MoonChasingRewardModel.CheckShopItemRedDotState(e), this.SetNewFlagState(o))
  }
}
