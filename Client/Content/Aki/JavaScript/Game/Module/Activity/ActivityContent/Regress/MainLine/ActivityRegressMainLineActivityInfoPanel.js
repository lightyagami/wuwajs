...
class ActivityRegressMainLineActivityInfoPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Lo = void 0, this.Pda = void 0, this.xda = void 0, this.bda = void 0, this.Bda = void 0, this.Nda = () => {
      ...
      void 0 !== i ? ActivityRegressHelper_1.ActivityRegressHelper.ReportRecallLog1024(1, i) : (i = ModelManager_1.ModelManager.ActivityRegressModel.GetFirstUnFinishMainQuestId(), ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("RecallActivity_Role_Precondition")), UiManager_1.UiManager.OpenView("QuestView", i)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var i = this.GetItem(0),
      t = (this.Pda = new ActivityTitleTypeA_1.ActivityTitleTypeA, this.GetItem(1)),
      e = (this.xda = new ActivityDescriptionTypeB_1.ActivityDescriptionTypeB, this.GetItem(2)),
      s = (this.bda = new ActivityRewardList_1.ActivityRewardList, this.GetItem(3));
    this.Bda = new ActivityFunctionalTypeA_1.ActivityFunctionalTypeA(void 0), await Promise.all([this.Pda.CreateThenShowByActorAsync(i.GetOwner()), this.xda.CreateThenShowByActorAsync(t.GetOwner()), this.bda.CreateThenShowByActorAsync(e.GetOwner()), this.Bda.CreateThenShowByActorAsync(s.GetOwner())])
  }
  OnStart() {
    ...
    this.Bda.FunctionButton.SetText(i), this.bda.InitGridLayout(this.bda.InitCommonGridItem), this.Pda.SetTimeTextVisible(!1)
  }
  RefreshByData(i) {
  ...
  Pqe() {
    ...
    this.Pda.SetSubTitleVisible(e), e && this.Pda.SetSubTitleByTextId(i), this.xda.SetContentByTextId(t)
  }
  jqe() {
  ...
  Vda() {
    ...
    this.Bda.FunctionButton.SetUiActive(!i), this.Bda.PanelActivate.SetUiActive(i), i ? this.Bda.PanelActivate.SetTextByTextId("RecallActivity_Finish") : this.Bda.FunctionButton.SetLocalTextNew("RecallActivity_Go")
  }
}
