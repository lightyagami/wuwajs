...
class BossRushController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(22195, this.vSn);
    Net_1.Net.Register(19566, this.pSn);
    Net_1.Net.Register(26717, this.IB_);
    Net_1.Net.Register(28374, this.EB_);
    Net_1.Net.Register(16545, this.MB_);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(22195);
    Net_1.Net.UnRegister(19566);
    Net_1.Net.UnRegister(26717);
    Net_1.Net.UnRegister(28374);
  ...
  static RequestBossRushTaskReward(e) {
    ...
    t.gps = e;
    Net_1.Net.Call(26547, t, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19180);
      }
    });
  }
  ...
  static RequestSettlement() {
    Net_1.Net.Call(16741, new Protocol_1.Aki.Protocol.ffs(), e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29302);
      }
    });
  }
  static RequestGetBossRushReward(t, e, o) {
    ...
    r.N6n = e;
    r.k6n = o;
    Net_1.Net.Call(25125, r, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16967);
      }
  ...
  static RequestGetBossRushLevelReward(t, e, o, r) {
    ...
    n.ell = e;
    n.c5n = r;
    Net_1.Net.Call(26641, n, e => {
      if (e.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.fMs, 16967);
      }
  ...
  static async RefreshBossRushBuffInGame() {
    ...
    var e = await Net_1.Net.CallAsync(24903, e);
    if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26863);
      return false;
    } else {
  ...
  static async RequestBossRushChooseBuffInGame(e) {
    ...
    t.c5n = e;
    var e = await Net_1.Net.CallAsync(18994, t);
    return e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs || (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23147), false);
  }
}
