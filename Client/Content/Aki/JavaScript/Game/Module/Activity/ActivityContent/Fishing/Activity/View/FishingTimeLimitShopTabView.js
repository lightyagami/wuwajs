...
class FishingTimeLimitShopTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.LoopScrollView = void 0, this.ActivityDataBase = void 0, this.t3i = (e, i, t) => {
      ...
      }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 37, "[FishingActivity] PayShop:DockyardBuyTabView 商品VersionCode不同步,打开弹窗")
    }, this.sGe = () => {
  ...
  OnStart() {
    this.ActivityDataBase = this.ExtraParams, this.ActivityDataBase && (this.LoopScrollView = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(0), this.GetItem(1).GetOwner(), this.sGe))
  }
  AddEventListener() {
