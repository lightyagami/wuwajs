...
class ActivityBeginnerBookController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnCreateActivityData(e) {
    return this.sNe = e.s5n, new ActivityBeginnerBookData_1.ActivityBeginnerBookData
  }
  async NewJourneyRequest() {
    ...
    var e = Protocol_1.Aki.Protocol.Uhs.create(),
      e = (e.B6n = i.AllBeginnerTargetList, await Net_1.Net.CallAsync(18599, e));
    for (const r of e.eBs) i.UnLockBeginnerMap.set(r.Jbs, r.zbs), i.FinishBeginnerMap.set(r.Jbs, r.Zbs);
    i.AllBeginnerTargetList.sort((e, r) => {
      var t = i.FinishBeginnerMap.get(e) ? 1 : 0,
        o = i.FinishBeginnerMap.get(r) ? 1 : 0;
      return t == o ? (e = ConfigManager_1.ConfigManager.ActivityBeginnerBookConfig?.GetActivityBeginnerConfig(e), r = ConfigManager_1.ConfigManager.ActivityBeginnerBookConfig?.GetActivityBeginnerConfig(r), e.Sort - r.Sort) : t - o
    })
  }
  OnInit() {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Activity", 5, "初始化鸣域新程"), !0
  }
  OnClear() {
    return !0
  }
