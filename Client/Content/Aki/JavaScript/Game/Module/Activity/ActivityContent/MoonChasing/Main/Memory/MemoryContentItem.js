...
class MemoryContentItemA extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, s) {
    ...
    this.SetSpriteByPath(t.IconPath, r, !1), this.GetText(1).ShowTextNew(t.Title), this.GetText(0).SetText(t.Content)
  }
}
...
class MemoryContentItemB extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, s) {
    ...
    i = this.GetTexture(5), r = t.IsDelegate && t.HasData, i.SetUIActive(t.IsDelegate), r && this.SetTextureByPath(t.IconPath, i), this.GetText(1).ShowTextNew(t.Title), r = this.GetText(0), r.SetUIActive(!0), r.ShowTextNew(t.Content), i = this.GetText(4);
