...
class SolarSpeedModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.UVa = void 0, this.xVa = void 0, this.PVa = void 0
  }
  OnInit() {
    return this.UVa = new SolarSpeedConfigContext_1.SolarSpeedConfigContext(this), this.xVa = new SolarSpeedProtocolContext_1.SolarSpeedProtocolContext(this), this.PVa = new SolarSpeedUiContext_1.SolarSpeedUiContext, !0
  }
  OnClear() {
  ...
  get CurrentCompletedCount() {
    ...
    for (var [t] of this.UVa.CurrentRewardCache) {
      ...
      void 0 !== t && t > Proto_ActivityTaskState.Proto_ActivityTaskRunning && ++e
    }
    return e
  }
  get DefaultLevelIdInRewardView() {
    return this.PVa.CurrentChosenTabInRewardView = 1, this.PVa.CurrentChosenTabInRewardView
  }
  ...
  GetIconPathInInstanceSeriesItemByInstanceId(e) {
    ...
    if (void 0 !== e) return e = this.xVa.GetRankingById(e), this.GetMedalPathByRank(e)
  }
  ...
  GetHistoryRankByInstanceId(e) {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("SolarSpeed", 64, "不能通过instanceId找到levelId，策划检查配置", ["instanceId", e])
  }
  ...
  GetMedalPathByRank(e) {
    if (!(e < 1 || e > SolarSpeedDefine_1.medalTexPathMap.length)) return SolarSpeedDefine_1.medalTexPathMap[e - 1];
    Log_1.Log.CheckWarn() && Log_1.Log.Warn("SolarSpeed", 64, "rank值超出奖牌资源索引范围", ["rank", e])
  }
  GetInstanceSubtitleTextIdByInstanceId(e) {
    e = this.UVa.GetLevelIdByInstanceId(e);
    if (void 0 !== e) return this.IsUnlockById(e) ? 0 === this.xVa.GetRankingById(e) ? SolarSpeedDefine_1.SOLAR_SPEED_NO_RECORD_TEXT_ID : SolarSpeedDefine_1.SOLAR_SPEED_MOST_RECORD_TEXT_ID : SolarSpeedDefine_1.SOLAR_SPEED_UNLOCK_AFTER_DAYS
  }
  GetInstanceSubtitleArgsByInstanceId(e) {
    var e = this.UVa.GetLevelIdByInstanceId(e);
    if (void 0 !== e) return this.IsUnlockById(e) ? 0 === this.xVa.GetRankingById(e) ? void 0 : [this.xVa.GetScoreById(e).toString()] : void 0 === (e = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat3(this.xVa.GetStartTime(e) - TimeUtil_1.TimeUtil.GetServerTime()).CountDownText) ? void 0 : [e]
  }
  GetInstanceUnlockTextIdByInstanceId(e) {
    var t = this.UVa.GetLevelIdByInstanceId(e);
    if (void 0 !== t) return this.IsUnlockById(t) ? ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetUnlockConditionGroupHintText(e) : SolarSpeedDefine_1.SOLAR_SPEED_UNLOCK_AFTER_DAYS
  }
  GetInstanceUnlockArgsByInstanceId(e) {
    var e = this.UVa.GetLevelIdByInstanceId(e);
    return void 0 === e || this.IsUnlockById(e) || void 0 === (e = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat3(this.xVa.GetStartTime(e) - TimeUtil_1.TimeUtil.GetServerTime()).CountDownText) ? void 0 : [e]
  }
  ...
  SyncInstanceClicked(t) {
    ...
    if (void 0 !== t && this.IsUnlockById(t)) {
      ...
      (e = void 0 === e ? new Map : e).has(t) || (e.set(t, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SolarSpeedInstanceClicked, e))
    }
  }
  ...
  L3_(e) {
    for (const t of this.UVa.SortedSettleCfgCache) switch (t.Id) {
      case 1:
  ...
  D6_(e) {
    ...
    if (void 0 !== e)
      for (const t of e)
        if (this.xVa.GetTaskStateById(t) === Proto_ActivityTaskState.Proto_ActivityTaskFinish) return !0;
    return !1
  }
  B6_() {
    ...
    for ([, e] of this.xVa.PlayerSettleMsgCache) {
      var i = e.W5n,
        ...
        o = {
          ...
          TitleTextId: l?.Title ?? "",
          IconData: {
            IconPath: void 0 === n ? "" : ModelManager_1.ModelManager.PersonalModel.GetPlayerHeadData(n.HeadId, !1).GetRoleHeadIconCircle()
          }
        };
      r.push(o)
    }
    return r.sort((e, t) => e.Rank - t.Rank), 1 < r.length && (t = r[0], r[0] = r[1], r[1] = t), {
      RoleDataList: r,
