...
class DockyardCageViewModel extends DockyardWareHouseViewModelBase_1.DockyardWareHouseViewModelBase {
  constructor() {
    super(...arguments), this.BackpackPanelModel = new DockyardCageBackpackPanelModel_1.DockyardCageBackpackPanelModel, this.ListPanelModel = new DockyardCageListPanelModel_1.DockyardCageListPanelModel, this.RequestCabinType = Protocol_1.Aki.Protocol.IXl.sb_, this.ConfigId = 0
  }
  get RequestId() {
    return this.ConfigId
  }
  OnInit() {
    this.ViewTitle = "Fishing_CageText3", this.BackpackPanelModel.Init(this.ConfigId), this.ListPanelModel.Init(this.ConfigId)
  }
  GetItemBlockData(e) {
