...
class ActivityRegressTaskMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.cda = void 0, this.uSc = void 0, this.Vl1 = new Map, this.sma = void 0, this.TDa = e => {
      var i = this.Vl1.get(this.uSc);
      i && 0 === this.uSc && e === ActivityRegressDefine_1.RECALL_SCORE_ITEM_ID && i.Update()
    }, this.TTi = () => {
      this.Vl1.get(this.uSc)?.Update()
    }, this.yqe = e => {
      e = ActivityRegressTaskDefine_1.taskSubViewTabDataMap.get(e), e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e.IconName);
  ...
  async OnBeforeStartAsync() {
    ...
    await this.sso(), this.cda.SelectToggleByIndex(e, !0), this.cda.SetPnlListUiActive(!0)
  }
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnCommonItemCountAnyChange, this.TDa), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RecallActivityInfoUpdate, this.TTi)
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnCommonItemCountAnyChange, this.TDa), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RecallActivityInfoUpdate, this.TTi)
  }
  OnBeforeShow() {
    this.mGe(), this.TTi(), this.sma = TimerSystem_1.RealTimeTimerSystem.Forever(this.kOe, TimeUtil_1.TimeUtil.InverseMillisecond)
  }
  OnAfterHide() {
    this.jm()
  }
  ...
  async Tfa() {
    ...
    for (let e = 0; e < t; ++e) {
      var s = new CommonTabItemBase_1.CommonTabItemData,
        a = (s.Index = e, s.Data = this.cda.GetTabComponentData(e), i.push(s), ActivityRegressTaskDefine_1.taskSubViewTabDataMap.get(e));
      s.RedDotName = a.RedDotName
    }
    await this.cda.RefreshTabItemByDataAsync(i)
  }
  async mda(e) {
    e !== this.uSc && (void 0 !== this.uSc && await this.pda(this.uSc), await this.gda(e), this.uSc = e, this.qEi())
  }
  qEi() {
    var e = ActivityRegressTaskDefine_1.taskSubViewTabDataMap.get(this.uSc),
      i = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e.IconName);
  ...
  async vda(e) {
    ...
    switch (e) {
      ...
      case 2:
        ...
        break;
      default:
        Log_1.Log.CheckError() && Log_1.Log.Error("ActivityRecall", 63, "回流活动->未定义的子任务界面类型!", ["viewType", e])
    }
    return i
  }
  async gda(e) {
    var i;
    this.Vl1.has(e) || (i = await this.vda(e)) && this.Vl1.set(e, i), await this.Vl1.get(e).ShowAsync()
  }
  async pda(e) {
    await this.Vl1.get(e)?.HideAsync()
  }
  Cda() {
    for (var [, e] of this.Vl1) e.CloseMeAsync();
    this.Vl1.clear()
  }
  mGe() {
    var e = ModelManager_1.ModelManager.ActivityRegressModel.ActivityData,
      [e, i] = ModelManager_1.ModelManager.ActivityModel.GetTimeVisibleAndRemainTime(e);
