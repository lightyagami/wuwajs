...
class FishingRoleTechItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.OnClickToggleBack = void 0, this.Node = void 0, this.kqe = () => {
  ...
  Refresh(e, t, i) {
    ...
    if (r) {
      this.Node && RedDotController_1.RedDotController.UnBindGivenUi("FishingRoleTechNode", this.GetItem(8)), this.Node = e, this.GetScrollScrollbar(9).SetValue(0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingTechNodeRedDotRefresh, this.Node?.ConfigId), RedDotController_1.RedDotController.BindRedDot("FishingRoleTechNode", this.GetItem(8), void 0, this.Node.ConfigId), this.SetTextureByPath(r.Icon, this.GetTexture(5)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), r.Name);
      var e = ModelManager_1.ModelManager.FishingModel.GetTechNodeCurrentLevel(e.ConfigId),
        s = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(7), "PrefabTextItem_3692737534_Text", e), r.Effect.length);
      if (s <= e) {
        this.GetItem(4).SetUIActive(!0), this.GetItem(2).SetUIActive(!1);
        const a = r.Effect[s - 1],
          g = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(a);
        void LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), g.Desc, ...g.ShowParams)
      } else {
        ...
        const a = r.Effect[e],
          g = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(a);
        if (0 === e) LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), g.Desc, ...g.ShowParams);
        else {
          var s = r.Effect[e - 1],
            o = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(s),
            n = [],
  ...
  SelectToggle() {
    this.OnClickToggleBack?.(this.Node, this.GetExtendToggle(6)), this.GetExtendToggle(6).SetToggleState(1, !1)
  }
}
