...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.BossRushData = exports.BossRushLevelRewardData = exports.BossRushLevelDetailInfo = void 0;
...
class BossRushLevelDetailInfo {
  constructor() {
    this.LOe = 0, this.xe = 0, this.AAe = 0, this.SSn = 0, this.ySn = [], this.ISn = [], this.xAn = [], this.tll = [], this.ill = [], this.TSn = [], this.jFe = !1
  }
  Phrase(t, e, s) {
    this.LOe = t, this.SetId(e.r6n), this.SetScore(e.SMs), this.SetUnLockTime(e.Mps), this.jFe = e.Sps, this.ySn = [], this.ISn = [], this.xAn = [], this.tll = [], this.ill = [];
    for (const _ of e.yMs) {
      var i = new BossRushModel_1.BossRushBuffInfo;
      i.BuffId = _.b6n, i.Slot = _.q6n, i.ChangeAble = _.G6n !== Protocol_1.Aki.Protocol.Iks.Proto_BuffLocked && _.G6n !== Protocol_1.Aki.Protocol.Iks.Proto_BuffInactive, i.State = _.G6n, this.ySn.push(i)
    }
    ...
    for (const d of e.Zal) {
      ...
      o.BuffId = d, o.Slot = a++, o.ChangeAble = !0, o.State = Protocol_1.Aki.Protocol.Iks.Proto_BuffSelected, this.tll.push(o)
    }
    for (let t = a; t <= 2; t++) {
      var h = new BossRushModel_1.BossRushBuffInfo;
      h.BuffId = 0, h.Slot = a++, h.ChangeAble = this.GetConfig().ScoreBuffCount >= t, h.State = this.GetConfig().ScoreBuffCount >= t ? Protocol_1.Aki.Protocol.Iks.Proto_BuffEmpty : Protocol_1.Aki.Protocol.Iks.Proto_BuffInactive, this.tll.push(h)
    }
  ...
  GetMonsterName() {
    var t = this.GetConfig().BossInfo,
      t = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterInfoConfig(t);
    return t ? t.Name : ""
  }
  GetLevelDesc() {
  ...
  GetUnlockTimeText() {
    var t, e;
    return TimeUtil_1.TimeUtil.GetServerTime() < this.SSn ? (t = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat3(this.GetUnLockTime() - TimeUtil_1.TimeUtil.GetServerTime()), e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("BossRushUnLockTime"), StringUtils_1.StringUtils.Format(e, t.CountDownText)) : MultiTextLang_1.configMultiTextLang.GetLocalTextNew("BossRushUnlockCondition")
  }
  GetUnLockTime() {
    return this.SSn
  }
  ...
  GetMaxBuffCount() {
    return 0 === ModelManager_1.ModelManager.BossRushModel.CurrentSelectBuffTabName ? this.GetConfig().BuffCount : this.GetConfig().ScoreBuffCount
  }
  ...
  ConvertToTeamInfo() {
    ...
    return t.SetCurrentTeamMembers(e), t.LevelInfo = this, t.InitLevelBuff(this.ySn, this.ISn, this.xAn, this.tll, this.ill), t.InitPrepareSelectBuff(), t.InitPrepareSelectScoreBuff(), t.ActivityId = this.LOe, t
  }
}
...
class BossRushData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.LSn = [], this.rll = new Map, this.sOn = new Map, this.TB_ = new Map, this.DSn = [], this.RSn = !1, this.USn = !1, this.s1a = !1, this.ASn = [], this.PSn = [], this.$8i = void 0, this.bB_ = new Map, this.xSn = (t, e) => {
      var s = this.wSn(t),
        i = this.wSn(e);
  ...
  PhraseEx(t) {
    this.PSn = t.Xps.MMs, this.PhraseLevelInfo(this.PSn, t.Xps.vMs), this.CheckIfNewBossRushOpen(), this.PhraseRewardInfo(t.Xps.pMs), this.RefreshTaskData(t.Xps.E$s), this.$8i = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BossRushDataUpdate), UiManager_1.UiManager.IsViewOpen("ActivityRewardPopUpView") && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRewardPopUpView, this.GetRewardViewData()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BossRefreshBossRushRewardRedDot, this.Id)
  }
  ...
  GetFinishTaskCount() {
    let t = 0;
    for (const e of this.sOn.values()) 0 !== e.Status && 2 !== e.Status || t++;
    return t
  }
  GetAllTaskCount() {
  ...
  PhraseLevelInfo(t, e) {
    ...
    this.LSn = this.LSn.reverse(), this.$8i && (this.$8i.Xps.vMs = e, this.$8i.Xps.MMs = t)
  }
  ...
  oll(t) {
    for (const e of this.LSn)
      if (e.Id === t && 1 === e.RewardState) return !0;
    return !1
  }
  ...
  CheckIfNewBossRushOpen() {
    var t = ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, this.Id, 0, 0),
      e = this.GSn(),
      t = (this.RSn = t < e, ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, this.Id, UNLOCKLOCALKEY, 0));
    this.USn = t < e, this.a1a(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  a1a() {
    this.s1a = !1;
    var t = ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, this.Id, UNLOCKBUFFKEY, 0),
      e = this.h1a();
    t < e && 0 < e && (t = this.GetBossRushLevelDetailInfo()[e - 1]) && t.GetConfig() && (this.s1a = 0 < t.GetConfig().UnlockBuff.length)
  }
  h1a() {
    let e = 0;
  ...
  GSn() {
    let t = 0;
    for (const e of this.GetBossRushLevelDetailInfo()) e.GetUnLockState() && t++;
    return t
  }
  CacheNewBuffUnlock() {
    this.s1a = !1;
    var t = this.h1a();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, this.Id, UNLOCKBUFFKEY, 0, t), this.a1a()
  }
  CacheNewUnlock() {
    this.USn = !1;
    var t = this.GSn();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, this.Id, UNLOCKLOCALKEY, 0, t), this.CheckIfNewBossRushOpen()
  }
  CacheCurrentOpenBossNum() {
    var t = this.GSn();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, this.Id, 0, 0, t), this.CheckIfNewBossRushOpen()
  }
  EntranceRedDot() {
  ...
  BSn(t) {
    var e = ConfigManager_1.ConfigManager.BossRushConfig.GetBossRushScoreConfigById(t.N6n),
      s = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("BossRushFullScoreTips"), e.Score.toString());
    return {
      Id: t.N6n,
      NameText: s,
  ...
  I2e(t) {
    var e, s, i = [];
    for ([e, s] of ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreview(t)) i.push([{
      ItemId: e,
      IncId: 0
    }, s]);
    return i
  ...
  LB_(t) {
    var e = t.Status,
      s = t.Current,
      i = t.Target,
      r = ConfigManager_1.ConfigManager.BossRushConfig.GetBossRushTaskConfig(t.Id);
    return {
      Id: t.Id,
