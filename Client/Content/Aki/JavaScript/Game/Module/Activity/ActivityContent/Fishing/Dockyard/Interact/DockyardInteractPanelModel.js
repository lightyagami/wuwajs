...
class DockyardInteractPanelModel {
  constructor() {
    this.ConfigId = 0, this.Panel = void 0, this.IsOutOfRange = !0, this.IsAllMatch = !1, this.IsOverlapAnother = !1, this.y$l = [], this.PosDataList = [], this.v$l = new Map, this.LastCanTickState = !1, this.ViewModel = void 0, this.BackpackPanelModel = void 0, this.ShowItemMap = new Map, this.MatchPos = {
      RowIndex: -1,
      ColIndex: -1
    }, this.DragClick = (t, i) => {
      this.mRo(t.IncId) && (this.LastCanTickState = !0, this.Panel.InitAppropriatePos(t), this.ShowItemMap.delete(t.IncId), this.Panel.DisableInteractItemBlock(t, i), i = ModelManager_1.ModelManager.FishingModel.GetDataByInteract(this.ConfigId, t.IncId), this.BackpackPanelModel.WareHouseItemDragBegin(i))
    }, this.DragBegin = (t, i) => {
      this.mRo(t.IncId) && (this.LastCanTickState = !0, this.Panel.InitAppropriatePos(t), this.ShowItemMap.delete(t.IncId), this.ViewModel?.HandleDragBegin(), this.Panel.DisableInteractItemBlock(t, i), i = ModelManager_1.ModelManager.FishingModel.GetDataByInteract(this.ConfigId, t.IncId), this.BackpackPanelModel.WareHouseItemDragBegin(i))
    }
  }
  ...
  ChangeShowItemData() {
    ...
    this.ShowItemMap.set(i.IncId, t), this.Panel.EnableInteractItemBlock(i), e && (this.BackpackPanelModel.Panel.ReplaceSelectItemBlock(e.Data), this.ShowItemMap.delete(e.Data.IncId))
  }
  ShowScrollingTips() {
  ...
  Br_(t, i) {
    for (const e of this.ShowItemMap.values())
      if (e.Data.ItemId === t && e.Pos.ColIndex === this.MatchPos.ColIndex && e.Pos.RowIndex === this.MatchPos.RowIndex && i === e.Rotate) return e
  }
  mRo(t) {
