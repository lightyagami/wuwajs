...
class ActivityDangoMonopolyConfig extends ConfigBase_1.ConfigBase {
  constructor() {
    super(...arguments), this.ST1 = void 0, this.pR1 = !1
  }
  OnInit() {
    return !0
  }
  ...
  GetIsOpenHintShow() {
    return void 0 === this.ST1 && (this.ST1 = CommonParamById_1.configCommonParamById.GetBoolConfig("DangoMonopolyIsOpenHintShow") ?? !1), this.ST1
  }
  SetPushHintState(o) {
    this.pR1 = o
  }
  GetIsPushHintShow() {
    return !!this.pR1 && !!this.GetIsOpenHintShow()
  }
  GetDangoMoveInTime() {
