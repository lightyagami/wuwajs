...
class ScratchTicketCellItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.inl = void 0, this.rMt = void 0, this.UiLevelSequence = void 0, this.sft = void 0, this.Hvl = () => {
  ...
  async OnBeforeStartAsync() {
    this.sft = new SmallItemGrid_1.SmallItemGrid, await this.sft.CreateThenShowByResourceIdAsync("UiItem_ItemBaseB", this.GetItem(2)), this.sft.BindOnExtendToggleClicked(this.u6e), this.sft.BindOnCanExecuteChange(this.c6e)
  }
  OnBeforeShow() {
    this.UiLevelSequence.AddSequenceFinishEvent("RevaelA", this.Hvl)
  }
  Refresh(e, t, i) {
    this.Hqe(e), this.GetItem(2).SetUIActive(!1), this.GetItem(3).SetUIActive(!1), this.GetSprite(1).SetUIActive(!1)
  }
  RefreshByResultData(e, t) {
    this.inl = e, 6 !== t.SequenceType && 7 !== t.SequenceType && this.Hqe(this.inl), this.lwr(t.SequenceType)
  }
  Hqe(e) {
    var e = (this.inl = e).GetItemData();
    void 0 === e ? (this.GetItem(2).SetUIActive(!1), this.GetItem(3).SetUIActive(!1), this.GetSprite(1).SetUIActive(!1)) : (this.GetItem(2).SetUIActive(!0), this.GetItem(3).SetUIActive(!0), this.GetSprite(1).SetUIActive(!0), e = {
      Data: e,
      Type: 4,
