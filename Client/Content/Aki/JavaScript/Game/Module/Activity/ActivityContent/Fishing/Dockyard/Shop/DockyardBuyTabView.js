...
class DockyardBuyTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.LoopScrollView = void 0, this.t3i = (e, r, i) => {
      ...
      }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Dockyard", 10, "PayShop:DockyardBuyTabView 商品VersionCode不同步,打开弹窗")
    }, this.sGe = () => {
  ...
  async OnShowAsyncImplementImplement() {
    var e = ModelManager_1.ModelManager.DockyardModel.GetShopDataList(),
      e = (await this.LoopScrollView.RefreshByDataAsync(e, !1, !0), ModelManager_1.ModelManager.DockyardModel.ShopId);
