...
class ScratchTicketActivityView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.gLt = void 0, this.nnl = void 0, this.snl = void 0, this.anl = void 0, this.lnl = void 0, this.o8a = void 0, this.Lol = void 0, this.DFe = () => {
      var t;
      this.Lol.GetIfFirstOpen() && ControllerHolder_1.ControllerHolder.ActivityController.RequestReadActivity(this.Lol), this.Lol.GetPreGuideQuestFinishState() ? (t = this.Lol.GetScratchCardActivityConfig(), SkipTaskManager_1.SkipTaskManager.RunByConfigId(t.JumpId)) : UiManager_1.UiManager.OpenView("QuestView", this.Lol.GetUnFinishPreGuideQuestId())
    }, this.hnl = () => new ScratchTicketProgressItem_1.ScratchTicketProgressItem, this.n8a = () => new ScratchTicketConditionItem_1.ScratchTicketConditionItem
  }
  OnSetData() {
