...
class BossRushBuffSelectInGameItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ClickCallBack = void 0, this.Vao = e => {
  ...
  OnStart() {
    this.GetHorizontalLayout(3).RootUIComp.SetUIActive(!1), this.GetItem(6).SetUIActive(!1), this.GetSprite(7).SetUIActive(!1), this.GetItem(8).SetUIActive(!1), this.GetItem(9).SetUIActive(!1), this.GetItem(10).SetUIActive(!1)
  }
  RefreshItem(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), e.Description, ...t), this.SetTextureByPath(e.Texture, this.GetTexture(1))
  }
  SetToggleUnCheck() {
