      ...
      if (t && t.length !== 0) {
        ...
        if (e) {
          ...
          if (e && e.length !== 0) {
            ...
            this.hhd.length = t.length;
            for (let e = 0; e < this.hhd.length; e++) {
              this.hhd[e] = ModelManager_1.ModelManager.LordGymModel.GetLordGymIsFinish(t[e]);
            }
            this.$be ||= new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.zbe);
            this.$be.RefreshByData(this.hhd);
          }
        }
      }
    }
