...
class CharacterValueItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnStart() {
    this.OriginalProgressWidth = this.GetSprite(1).Width, this.GetSprite(2).SetFillAmount(0)
  }
  Refresh(e) {
    this.GetText(0).SetText(e.CurrentValue.toString()), this.RefreshProgress(e.CurrentValue, e.MaxValue), this.RefreshSprite(e.Id)
  }
