...
class DockyardTrawlListPanelModel extends DockyardItemListPanelModel_1.DockyardItemListPanelModel {
  ...
  OnInit() {
    this.ComponentData.TitleText = "Fishing_CageText5", this.ComponentData.HelpBtnId = FishingDefine_1.TRAWL_LIST_HELPID, this.MaxCount = ModelManager_1.ModelManager.DockyardModel.TrawlSize
  }
  GetShowItemList() {
