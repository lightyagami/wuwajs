...
class MoonCelebrationAwardSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    ...
    this.ejd = () => {
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.J9d);
    };
    this.tjd = () => {
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.Z9d);
    };
    this.wNe = e => {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[0, this.L11], [4, this.ejd], [6, this.tjd]];
  }
  OnSetData() {
