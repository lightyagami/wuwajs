...
class DockyardCageListPanelModel extends DockyardItemListPanelModel_1.DockyardItemListPanelModel {
  ...
  OnInit() {
    this.ComponentData.TitleText = "Fishing_CageText3", this.ComponentData.HelpBtnId = FishingDefine_1.CAGE_LIST_HELPID;
    var e = ModelManager_1.ModelManager.FishingModel.GetCageDataByConfigId(this.Mne),
      e = (this.$Xt = e ? e.Data.zT_ : 0, this.ComponentData.GetCountText = () => this.ShowItemList.length + "/" + this.$Xt, this.GetShowItemList());
    e.length < this.$Xt && (e = (ModelManager_1.ModelManager.FishingModel.GetShipCageNextHarvestTimeStamp(this.Mne) - TimeUtil_1.TimeUtil.GetServerTimeStamp()) / TimeUtil_1.TimeUtil.InverseMillisecond, e = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat4(e).CountDownText, this.ComponentData.TimeText = e)
  }
  Init(e) {
    this.Mne = e
  }
