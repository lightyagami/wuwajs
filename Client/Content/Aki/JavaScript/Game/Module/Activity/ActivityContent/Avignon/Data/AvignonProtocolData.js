...
class AvignonProtocolData extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(t) {
    ...
    if (t) {
      ...
      for (const r of t.hfc) this.UnlockStage(r)
    }
  }
  UpdateTask(t) {
    var e;
    t && 0 !== t.s5n && (e = this.OSc(t.s5n), this.ROe.get(e)?.UpdateTask(t))
  }
  UnlockStage(t) {
    t = this.ROe.get(t);
    t && t.UnlockStage()
  ...
  GetCurrentLockQuestId() {
    for (var [, t] of this.ROe)
      if (!t.IsUnlock) return ConfigManager_1.ConfigManager.AvignonConfig.GetStageConfigById(t.StageId).QuestionId
  }
  OSc(t) {
