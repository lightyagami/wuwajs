...
class MowingTowerRewardView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lqe = void 0, this.mll = void 0, this.dll = void 0, this.H3e = void 0, this.bLl = void 0, this.SPe = void 0, this.JLl = () => {
      ...
      this.H3e?.RefreshByData(this.bLl.GetRewardByLevelId(this.dll?.GetLevelId()), () => {
        ...
        if (e)
          for (const t of e) t.SetRedDotActive(this.bLl.HaveLevelRewardCanTake(t.GetLevelId() ?? 0))
      }, !0)
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.lqe.SetCloseCallBack(() => {
      this.CloseMe()
    }), this.lqe.SetTitleByTextIdAndArgNew("MowingTowerRewardViewTitle"), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RefreshMowingTowerReward, this.Z3e), this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.mll = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), this.JLl), this.H3e = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(3), this.ZLl);
...
class MowingTowerRewardTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.m_i = void 0, this.ClickCallBack = void 0, this.kqe = () => {
  ...
  Refresh(e, t, i) {
    this.m_i = e, 0 === i ? (this.ClickCallBack?.(this), this.GetExtendToggle(0).SetToggleState(1)) : this.SetToggleUnCheck();
    i = e.GetConfig();
    i && (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), i.RewardName), this.SetTextureByPath(i.RewardTexture, this.GetTexture(2)))
  }
  SetToggleUnCheck() {
...
class MowingTowerRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.$Tt = void 0, this.s4e = void 0, this.W2e = () => {
