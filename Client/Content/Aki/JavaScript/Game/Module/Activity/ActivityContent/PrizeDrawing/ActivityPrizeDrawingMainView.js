...
class PrizeDrawingMainView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnStart() {
    ...
    this.SPe.BindSequenceCloseEvent(this.Fwm);
  }
  Og() {
    this.KGt();
    this.Nqe();
  ...
  OnAddEventListener() {
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnPrizeDrawingQuestUpdated, this.Zwm);
  ...
  OnRemoveEventListener() {
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnPrizeDrawingQuestUpdated, this.Zwm);
