...
class FishingDockQuestItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.SO_ = void 0, this.Ud_ = () => {
  ...
  RefreshItem() {
    ...
    if (this.GetItem(4).SetUIActive(e), ModelManager_1.ModelManager.FishingQuestModel.CurrentTraceEntrust) {
      ...
      if (M)
        if (0 === M.EntrustType || 1 === M.EntrustType) {
          ...
          LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), M.Name), this.SO_?.RefreshByData(g)
        } else 2 === M.EntrustType && this.GetVerticalLayout(2).RootUIComp.SetUIActive(!1)
    } else LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "Fishing_NotTraceEntrust"), this.GetVerticalLayout(2).RootUIComp.SetUIActive(!1)
  }
}
