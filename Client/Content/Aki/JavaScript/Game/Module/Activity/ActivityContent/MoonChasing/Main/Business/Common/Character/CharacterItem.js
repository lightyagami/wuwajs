...
class CharacterItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.NameItem = void 0, this.ValueItem = void 0, this.Id = 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.NameItem = new CharacterNameItem_1.CharacterNameItem, this.ValueItem = new CharacterValueItem_1.CharacterValueItem, await Promise.all([this.NameItem.CreateThenShowByActorAsync(this.GetItem(0).GetOwner()), this.ValueItem.CreateThenShowByActorAsync(this.GetItem(1).GetOwner())])
  }
  Refresh(e) {
