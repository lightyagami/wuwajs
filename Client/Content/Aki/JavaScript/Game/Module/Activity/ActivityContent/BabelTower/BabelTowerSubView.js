...
class BabelTowerSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.LNe = void 0, this.DNe = void 0, this.UNe = void 0, this.ANe = void 0, this.DFe = () => {
      var e;
      this.ActivityBaseData.GetPreGuideQuestFinishState() ? UiManager_1.UiManager.OpenView("BabelTowerMainView") : (e = this.ActivityBaseData.GetUnFinishPreGuideQuestId(), UiManager_1.UiManager.OpenView("QuestView", e))
    }, this.Ud_ = () => {
      var e;
      this.ActivityBaseData.GetPreGuideQuestFinishState() ? UiManager_1.UiManager.OpenView("BabelTowerQuestView") : (e = this.ActivityBaseData.GetUnFinishPreGuideQuestId(), UiManager_1.UiManager.OpenView("QuestView", e))
    }, this.zDo = () => {
      var e;
      this.ActivityBaseData.GetPreGuideQuestFinishState() ? BabelTowerController_1.BabelTowerController.GetBabelTowerData().CheckIfInOpenTime() ? ((e = new PayShopViewData_1.PayShopViewData).PayShopId = 213, e.ShowShopIdList = [213], ControllerHolder_1.ControllerHolder.PayShopController.OpenPayShopView(e)) : ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("BabelTowerIsNotOpen") : (e = this.ActivityBaseData.GetUnFinishPreGuideQuestId(), UiManager_1.UiManager.OpenView("QuestView", e))
    }
  }
  OnRegisterComponent() {
  ...
  OnRefreshView() {
    this.ActivityBaseData.LocalConfig && (this.Pqe(), this.mGe(), this.jqe(), this._Oe(), this.gbc(), this.LLc())
  }
  Pqe() {
  ...
  _Oe() {
    ...
    this.ANe.SetPanelConditionVisible(!e), e || this.ANe.SetPerformanceConditionLock(this.ActivityBaseData.ConditionGroupId, this.ActivityBaseData.Id), this.ANe.FunctionButton.SetUiActive(e)
  }
  gbc() {
