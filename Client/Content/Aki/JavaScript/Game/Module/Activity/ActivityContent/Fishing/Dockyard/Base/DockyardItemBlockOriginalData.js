...
class DockyardItemBlockOriginalData {
  constructor(t) {
    this.SXl = void 0, this.PosDoublyList = [], this.ValidDoublyList = [], this.PosDataList = [], this.ValidStartPos = {
      RowIndex: -1,
      ColIndex: -1
    }, this.SXl = t;
    var t = ConfigManager_1.ConfigManager.FishingConfig.GetFishingItemConfig(this.SXl.L8n),
      i = ConfigManager_1.ConfigManager.FishingConfig.GetFishingShapeConfig(t.Shap).FillState;
    let s = -1,
      n = -1,
      a = -1,
      o = -1;
    for (let r = 0, t = i.length; r < t; r++) {
      ...
      for (let t = 0, e = i[r].ArrayInt.length; t < e; t++) {
        ...
        this.PosDoublyList[r].push(h), this.PosDataList.push({
          RowIndex: r,
          ColIndex: t
        }), 1 === h && (s = -1 === s ? r : Math.min(s, r), n = -1 === n ? r : Math.max(n, r), a = -1 === a ? t : Math.min(a, t), o = -1 === o ? t : Math.max(o, t))
      }
    }
    this.ValidStartPos = {
      RowIndex: s,
    ...
    for (let e = 0; e < n - s + 1; e++) {
      ...
      for (let t = 0; t < o - a + 1; t++) this.ValidDoublyList[e].push(this.PosDoublyList[e + s][t + a])
    }
  }
  get IncId() {
    return this.SXl.b9n
