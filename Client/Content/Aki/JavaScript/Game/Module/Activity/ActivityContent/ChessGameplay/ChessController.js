...
class ChessController extends ControllerBase_1.ControllerBase {
  static async InitChessGameAsync(e, o, r, a = 0) {
    ...
    WaitEntityTask_1.WaitEntityTask.Create("InitChessGame", t, () => {
      s.SetResult()
    }), await s.Promise, ModelManager_1.ModelManager.ChessModel.UpdateChessMode(a);
    for (const i of e) ModelManager_1.ModelManager.ChessModel.AddChessboardPoint(i.Id, i.Location, i.Rotation, i.SortIndex);
    for (const l of o) {
      var n = ModelManager_1.ModelManager.CreatureModel.GetEntity(l.CreatureDataId);
      n?.IsInit && (ModelManager_1.ModelManager.ChessModel.AddChessItem(l.Id, n), ChessController.TeleportItemToPoint(l.Id, l.InitPointId))
    }
    ModelManager_1.ModelManager.ChessModel.UpdateTerminalPoint(r)
  }
  static async MoveItemToPointAsync(e, o) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Chess", 48, "ChessItemMove Begin", ["ItemId", e], ["TargetPointId", o]);
    var r, a = ModelManager_1.ModelManager.ChessModel.GetChessItem(e),
      t = ModelManager_1.ModelManager.ChessModel.GetChessboardPoint(o);
    a && t && (a.GetCurrentPoint()?.ItemLeave(a), r = t.GetMoveLocationAndRotator(), await a.MoveAsync(r[0], r[1]), t.ItemEnter(a), ChessController.eOc()), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Chess", 48, "ChessItemMove End", ["ItemId", e], ["TargetPointId", o])
  }
  ...
  static TeleportItemToPoint(e, o) {
    var r, e = ModelManager_1.ModelManager.ChessModel.GetChessItem(e),
      o = ModelManager_1.ModelManager.ChessModel.GetChessboardPoint(o);
    e && o && (e.GetCurrentPoint()?.ItemLeave(e), r = o.GetMoveLocationAndRotator(), e.Teleport(r[0], r[1]), o.ItemEnter(e), ChessController.eOc())
  }
  static ChangeItemToMaxPriorityInPoint(e) {
    e = ModelManager_1.ModelManager.ChessModel.GetChessItem(e);
    e?.GetCurrentPoint()?.ChangeItemToMaxPriority(e), ChessController.eOc()
  }
  static eOc() {
  ...
  static GetRankingItemIdList() {
    ...
    if (!e) return Log_1.Log.CheckError() && Log_1.Log.Error("Chess", 48, "未设置终点，无法比较优先级"), ModelManager_1.ModelManager.ChessModel.GetChessItemIdList();
    ...
    e = ModelManager_1.ModelManager.ChessModel.GetChessItemIdList((e, o) => {
      ...
      return r !== a ? a - r : (a = e.GetCurrentPoint(), r = o.GetCurrentPoint(), a && r ? a.GetId() === r.GetId() ? a.ComparePriority(e, o) : (e = t - a.GetSortIndex(), o = t - r.GetSortIndex(), 0 == e ? 1 : 0 == o ? -1 : 0 < e * o ? e - o : o - e) : (Log_1.Log.CheckError() && Log_1.Log.Error("Chess", 48, "棋子所在点位不存在"), 0))
    });
