...
class MowingRiskConfigContext {
  constructor() {
    this.LVa = void 0, this.AVa = void 0, this.DVa = new Map, this.Aja = new Map, this.RVa = (e, r) => e.BuffType === r.BuffType ? e.Id - r.Id : e.BuffType - r.BuffType
  }
  Init() {
    ...
    if (void 0 !== e)
      for (const n of e) {
        ...
        o.push({
          ...
          Partial: 1,
          Overall: 1
        }), this.DVa.set(n.Id, s), this.Aja.set(n.Id, o)
      }
  }
  Dispose() {}
  GetBuffHexColorById(e) {
    e = RiskHarvestBuffGroupById_1.configRiskHarvestBuffGroupById.GetConfig(e);
    return void 0 === e ? "FFFFFFFF" : type2QualityData.get(e.BuffType)?.HexColor ?? "FFFFFFFF"
  }
  ...
  GetBuffQualityInfoById(e) {
    ...
    if (void 0 !== e) {
      ...
      if (void 0 !== e) return ConfigManager_1.ConfigManager.CommonConfig?.GetItemQualityById(e.CfgQualityInfoId)
    }
  }
  ...
  GetBuffIntroduceBackgroundPath(e) {
    ...
    return void 0 === e || void 0 === (e = type2QualityData.get(e.BuffType)) ? "" : (e = e.BackgroundResource, ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e))
  }
  ...
  GetProgressLevel(e, r) {
    e = this.Aja.get(e);
    return void 0 === e ? 0 : r >= e.length ? e.at(-1)?.SuperLevel ?? 0 : e[r].SuperLevel
  }
  ...
  IsSuperBuffAvailable(e, r, t) {
    if (this.IsSuperBuffByBuffId(r)) {
      ...
      if (void 0 !== e)
        for (const i of e)
          if (i.BuffId === r && t >= i.Threshold) return !0
    }
    return !1
  }
  get BasicBuffConfigs() {
    if (void 0 === this.LVa) {
      var e = [];
      for (const r of RiskHarvestBuffGroupAll_1.configRiskHarvestBuffGroupAll.GetConfigList()) r.BuffType < 3 && e.push(r);
  ...
  get SuperBuffConfigs() {
    if (void 0 === this.AVa) {
      var e = [];
      for (const r of RiskHarvestBuffGroupAll_1.configRiskHarvestBuffGroupAll.GetConfigList()) 3 === r.BuffType && e.push(r);
