...
class ActivityRogueController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnOpenView(e) {
    2 === this.vFe(e.Id) && ActivityRogueController.ActivityFunctionExecute(e.Id)
  }
  vFe(e) {
  ...
  OnCreateActivityData(e) {
    return ActivityRogueController.ActivityId = e.s5n, new ActivityRogueData_1.ActivityRougeData
  }
  OnInit() {
    return ActivityRogueController.MFe(), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Activity", 37, "初始化肉鸽活动"), !0
  }
  OnClear() {
  ...
  static ActivityFunctionExecute(e) {
    ...
    if (e) {
      ...
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Activity", 37, "肉鸽活动功能触发", ["Type", e.FunctionType], ["Params", r])
    }
  }
  static EFe(e) {
...
}(exports.ActivityRogueController = ActivityRogueController).ActivityId = 0, ActivityRogueController.OpenViewFuncMap = new Map, ActivityRogueController.yFe = e => {
  var t = e ? Number(e[0]) : void 0;
  if (void 0 !== t && !ModelManager_1.ModelManager.MapModel.IsConfigMarkIdUnlock(t)) return void ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("FunctionDisable");
  t = {
