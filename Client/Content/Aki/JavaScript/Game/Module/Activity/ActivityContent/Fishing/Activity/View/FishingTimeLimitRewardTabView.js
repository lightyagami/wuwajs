...
class FishingTimeLimitRewardTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.B7t = void 0, this.qoh = void 0, this.fcl = void 0, this.hfl = void 0, this.boh = void 0, this.Cua = -1, this.fqe = () => new FishingRewardTargetTabItem_1.FishingRewardTargetTabItem, this.Wwn = e => {
      this.Cua !== e && -1 !== this.Cua && this.B7t.GetLayoutItemByIndex(this.Cua)?.SetToggleState(!1, !1), this.Cua = e, this.Ooh(this.Cua, !0)
    }, this._x_ = () => new FishingRewardTaskItem_1.FishingRewardTaskItem, this.cx_ = () => {
      ...
      0 < e.length && ActivityFishingController_1.ActivityFishingController.FishingActivityMilestoneRewardRequest(e)
    }
  }
  OnRegisterComponent() {
  ...
  RemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.FishingTimeLimitRewardListRefresh, this.cx_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.FishingTimeLimitRewardProgressRefresh, this.dx_)
  }
  cOn(i) {
    var t = [];
    for (let e = 0; e < i.length; e++) {
      var s = new ActivityFishingDefine_1.FishingRewardTargetTabData;
      s.NameTextId = i[e].GroupName, s.Index = e, s.ClickedCallback = this.Wwn, s.RefreshRedDot = e => this.boh.GetTimeLimitTasksRedDotStateByGroupId(e), t.push(s)
    }
    return t
  }
  Ooh(e, i) {
  ...
  fx_(e) {
    ...
    for (const n of e) {
      ...
      s.TaskId = n.Id, s.Status = n.Status, s.Current = n.Current, s.Target = n.Target, s.JumpId = t.JumpId, s.TitleTextId = t.TaskName, s.RewardList = ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreviewItemList(t.DropId), s.ReceiveDelegate = this.ux_, i.push(s)
    }
    return i
  }
}
