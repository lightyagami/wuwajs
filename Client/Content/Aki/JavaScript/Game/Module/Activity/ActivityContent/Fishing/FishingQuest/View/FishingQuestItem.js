...
class FishingQuestItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.OnClickTaskCallBack = void 0, this.qoh = void 0, this.Hc_ = -1, this.P2i = [], this.sGe = () => {
  ...
  Refresh(e, i, t) {
    ...
    this.SetSpriteByPath(r.TitleSprite, this.GetSprite(3), !1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), r.TitleName), this.P2i = ModelManager_1.ModelManager.FishingQuestModel.GetEntrustsByPoolType(e), this.P2i.sort((e, i) => {
  ...
  RefreshChildItemStateAbout() {
    ...
    if (e)
      for (const i of e) i.RefreshItem()
  }
}
