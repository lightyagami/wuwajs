...
class BabelTowerTeamRoleItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, r, t) {
    var s;
    0 === e ? this.GetTexture(2).SetUIActive(!1) : (this.GetTexture(2).SetUIActive(!0), s = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e), this.SetRoleIcon(s.RoleHeadIconCircle, this.GetTexture(2), e))
  }
}
