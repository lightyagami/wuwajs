...
class ActivityNoviceJourneyData extends ActivityData_1.ActivityBaseData {
  ...
  AddReceivedData(e) {
    this.B2e.add(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.NoticeJourneyReceive, e)
  }
  CheckRewardReceived(e) {
    return this.B2e.has(e)
  }
  GetRewardStateByLevel(e) {
    return ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerLevel() < e ? 1 : this.CheckRewardReceived(e) ? 3 : 2
  }
}
