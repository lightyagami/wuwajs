...
exports.ActivityRegressTabGroupPanel = undefined;
const TabComponent_1 = require("../../../../Common/TabComponent/TabComponent");
const ActivityRegressTabSwitchItemPanel_1 = require("./ActivityRegressTabSwitchItemPanel");
class ActivityRegressTabGroupPanel {
  ...
  Init() {
    this._He = new TabComponent_1.TabComponent(this.TabLayout.GetRootComponent(), this.fqe, this.pqe, this.TabItem);
  }
  RefreshByData(t, s) {
    if ((this.Gda = t).length > 0) {
      this.CHe(s);
    }
  }
  CHe(t) {
