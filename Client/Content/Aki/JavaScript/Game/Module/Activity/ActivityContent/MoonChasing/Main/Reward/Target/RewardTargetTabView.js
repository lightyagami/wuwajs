...
class RewardTargetTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.TabLayout = void 0, this.Cua = -1, this.LoopScroll = void 0, this.ypt = [], this.nxa = !0, this.dOn = e => {
      ModelManager_1.ModelManager.MoonChasingRewardModel.GetTaskDataById(e) && (this.TabLayout.GetLayoutItemByIndex(this.Cua).RefreshRedDot(), this.Eua(this.Cua))
    }, this.COn = () => new TaskItem_1.TaskItem, this.fqe = () => new RewardTargetTabItem_1.RewardTargetTabItem, this.Wwn = e => {
      this.Cua !== e && -1 !== this.Cua && this.TabLayout.GetLayoutItemByIndex(this.Cua)?.SetToggleState(!1, !1), this.Cua = e, this.Eua(this.Cua)
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.nxa = this.ExtraParams ?? !0, this.TabLayout = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.fqe), this.LoopScroll = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(2), this.GetItem(3).GetOwner(), this.COn)
  }
  cOn(t) {
    var i = [];
    for (let e = 0; e < t.length; e++) {
      var r = new MoonChasingRewardDefine_1.RewardTabData;
      r.NameTextId = t[e].Name, r.Index = e, r.ClickedCallback = this.Wwn, r.RefreshRedDot = e => ModelManager_1.ModelManager.MoonChasingRewardModel.GetTaskDataRedDotStateByTabId(e), i.push(r)
    }
    return i
  }
  async OnBeforeShowAsyncImplement() {
    var e = ModelManager_1.ModelManager.MoonChasingRewardModel.GetRewardTargetTabList();
    await this.TabLayout.RefreshByDataAsync(this.cOn(e)), this.TabLayout.GetLayoutItemByIndex(0).SetToggleState(!0, !0)
  }
  OnBeforeShow() {
  ...
  Eua(e) {
    ...
    if (this.nxa) this.ypt = e;
      ...
      for (const i of e) {
        var t = i.DeepCopy(i);
        t.JumpId = 0, t.DoingTextId = "Moonfiesta_TargetDone", this.ypt.push(t)
      }
