...
class BossRushRewardView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.mll = void 0, this.dll = void 0, this.H3e = void 0, this.pyn = void 0, this.SPe = void 0, this.Cll = () => {
      ...
      if (i)
        for (const r of i) r.RefreshRedDot()
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.mll = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(0), this.Cll), this.H3e = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(2), this.pll);
...
class BossRushRewardTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.PB_ = void 0, this.ClickCallBack = void 0, this.kqe = () => {
  ...
  Refresh(e, t, i) {
    this.PB_ = e, 0 === i ? (this.ClickCallBack?.(this), this.GetExtendToggle(0).SetToggleState(1)) : this.SetToggleUnCheck();
    i = e;
    i && (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), i.TabTitle), this.SetTextureByPath(i.Texture, this.GetTexture(2)), this.RefreshRedDot())
  }
  RefreshRedDot() {
...
class BossRushRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, i) {
    ...
    e.NameTextArgs && (this.GetText(1).SetText(e.NameTextArgs[0] + "/" + e.NameTextArgs[1]), this.GetText(0).SetText(e.NameText ?? "")), this.GetButton(4).RootUIComp.SetUIActive(1 === e.RewardState), this.GetItem(5)?.SetUIActive(0 === e.RewardState), this.GetItem(6)?.SetUIActive(2 === e.RewardState), this.s4e?.RefreshByData(e.RewardList ?? [])
  }
}
