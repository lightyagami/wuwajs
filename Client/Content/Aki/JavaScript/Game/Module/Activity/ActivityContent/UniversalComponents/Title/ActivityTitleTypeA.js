...
class ActivityTitleTypeA extends UiPanelBase_1.UiPanelBase {
  ...
  SetTimeTextByText(e) {
    ...
    t ? t.SetText(e) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[活动][DEBUG] SetTimeTextByText.Text不存在")
  }
  SetTimeTextVisible(e) {
    var t = this.GetText(1);
    t ? t.SetUIActive(e) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[活动][DEBUG] SetTimeTextVisible.Text不存在")
  }
