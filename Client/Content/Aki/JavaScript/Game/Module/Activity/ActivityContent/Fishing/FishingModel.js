...
class FishingModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.FishingReputationItemId = 0, this.FishingShipFixItem = 0, this.FishingShipFixCost = 0, this.NormalTechNodeMap = new Map, this.RoleTechNodeMap = new Map, this.AQ_ = void 0, this.FishingSlotCountTech = 0, this.FishingBagRedPercentage = 0, this.rzl = new Map, this.ozl = new Map, this.Nn_ = new Map, this.Vn_ = new Map, this.jn_ = new Map, this.C8_ = 0, this.Hn_ = new Map, this.nzl = new Map, this.gO_ = new Set([11, 10]), this.EffectType2TechIdsMap = new Map, this.Ux_ = 0, this.uh_ = new FishingShipData_1.FishingShipData, this.LocalSailingTime = 0, this.FishingItemHandBookDataMap = new Map, this.FishingItemHandBookRewardMap = new Map, this.FishingItemHandBookUnlockTraceList = [], this.RoleTalkIds = void 0, this.UnlockPort = [], this.CurrentShipSkin = 0, this.UnlockShipSkin = []
  }
  SetFishingLevelUpInfo(e) {
    void 0 === this.AQ_ ? this.AQ_ = e : this.AQ_.CurrentLevel = e.CurrentLevel
  }
  ...
  OnInit() {
    ...
    return this.FishingShipFixItem = e[0], this.FishingShipFixCost = CommonParamById_1.configCommonParamById.GetIntConfig("FishingShipFixCostCount"), this.C8_ = CommonParamById_1.configCommonParamById.GetIntConfig("FishingMaxBaitCount") ?? 0, this.FishingSlotCountTech = CommonParamById_1.configCommonParamById.GetIntConfig("FishingSlotCountTech") ?? 0, this.FishingBagRedPercentage = CommonParamById_1.configCommonParamById.GetIntConfig("FishingBagRedPercentage") ?? 0, this.Va_(), !0
  }
  Va_() {
  ...
  GetFishingReputationLevelByItemCount(e) {
    let t = 1;
    for (const i of ConfigManager_1.ConfigManager.FishingConfig.GetAllFishingReputation()) e >= i.Exp && t <= i.Level && (t = i.Level);
    return t
  }
  GetConfigMaxFishingReputationLevel() {
    let e = 0;
    for (const t of ConfigManager_1.ConfigManager.FishingConfig.GetAllFishingReputation()) e <= t.Level && (e = t.Level);
    return e
  }
  szl(e, t) {
  ...
  AddCageDataFromServer(e, t) {
    var i = this.rzl.get(e) ?? new Map;
    i.set(t.s5n, new DockyardCageData_1.DockyardCageData(t)), this.rzl.set(e, i)
  }
  GetDataByCage(e, t) {
  ...
  WZl(e, t, i) {
    ...
    a || ((a = new FishingPointData_1.FishingPointData).SceneId = e, t.add(n), this.Nn_.set(n, a), this.jn_.set(i.s5n, n)), a.Refresh(i), this.Qn_(n, a)
  }
  ...
  Qn_(e, t) {
    ...
    e?.Valid && e.Entity.GetComponent(273)?.RefreshFishingPoint(t)
  }
  ...
  SetTempFishingPointData(e, t) {
    ...
    n || ((n = new FishingPointData_1.TempFishingPointData).SceneId = e, this.Hn_.set(i, n)), n.Refresh(t)
  }
    ...
    for (const n of e) {
      ...
      for (const a of ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechById(t).Effect) {
        ...
        if (i && this.gO_.has(i.Type)) {
          ...
          e || (e = new Set, this.EffectType2TechIdsMap.set(i.Type, e)), e.add(t)
        }
      }
      this.nzl.set(t, n), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingTechNodeRedDotRefresh, n.b5n)
    }
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingRoleTechRefresh, 4), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingRoleTechRefresh, 5)
  }
  UpdateFishingTechData(e) {
    this.nzl.set(e.b5n, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingTechNodeRefresh, e.b5n)
  }
  GetFishingTechUnlock(e) {
    var t = this.nzl.get(e);
    return !(0 < ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechById(e).UnlockCondition && !t?.CMs) && 0 < (t?.F6n ?? 0)
  }
  GetFishingTechUnlockByEffectType(e) {
    var t = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechList(),
      e = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectByType(e);
    if (!(e.length <= 0)) {
      var i = e[0].Id;
      for (const n of t)
  ...
  GetFishingCurrentLevelTechEffectByEffectType(e) {
    ...
    if (!(e.length <= 0)) {
      var i, n = e[0].Id;
      for (const a of t)
        if (a.Effect.includes(n)) return (i = this.nzl.get(a.Id)?.F6n ?? 0) <= 0 ? 0 : a.Effect[i - 1]
    }
    return 0
  }
  ...
  GetTechNodeCanLevelUp(e) {
    ...
    var n, a, e = t.Effect[i.F6n];
    for ([n, a] of ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(e).Consume)
      if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(n) < a) return !1;
    return !0
  }
  GetRoleTechNodeCanLevelUp(e) {
    for (var [t, i] of this.nzl) {
      ...
      if (n.Type === e && !(i.F6n >= n.Effect.length) && this.GetNodePreNodeUnlock(t)) {
        var a, r, t = n.Effect[i.F6n];
        for ([a, r] of ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(t).Consume)
          if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(a) >= r) return !0
      }
    }
    return !1
  }
  RefreshTechCanLevelUp() {
    for (var [e, t] of this.nzl) {
      ...
      if (!(t.F6n >= i.Effect.length) && this.GetNodePreNodeUnlock(e)) {
        var n, a, i = i.Effect[t.F6n];
        for ([n, a] of ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(i).Consume) ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(n) >= a && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingTechNodeRedDotRefresh, e)
      }
    }
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingRoleTechRefresh, 4), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingRoleTechRefresh, 5)
  }
  ...
  GetFirstNode() {
    ...
    if (e) return e[0];
    Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 5, "捕鱼活动获取首科技节点失败，请检查科技树配置")
  }
  GetLastNode() {
    var e = this.NormalTechNodeMap.get(FishingDefine_1.FISHING_TECH_LAST_NODE_AREA);
    if (e) return e[0];
    Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 5, "捕鱼活动获取尾科技节点失败，请检查科技树配置")
  }
  GetFirstUnlockNode() {
    let e = void 0;
  ...
  GetNodePreNodeUnlock(e) {
    var t = ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechById(e);
    return t.PreNode ? this.GetFishingTechUnlock(t.PreNode) : !(0 < ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechById(e).UnlockCondition) || (this.nzl.get(e)?.CMs ?? !1)
  }
  ...
  set DockId(e) {
    this.Ux_ = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingRefreshDockId, this.Ux_)
  }
  GetShipData() {
    return this.uh_
  }
  ...
  GetShipCageCapacityInfoTuple(e) {
    ...
    return void 0 === t ? (Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 63, "[捕鱼系统]->获取笼子容量错误，未找到对应实体的笼子数据。", ["configId", e]), [0, 0]) : [(e = t.Data).bMs.length, e.zT_]
  }
  GetShipCageNextHarvestTimeStamp(e) {
    var t = this.GetCageDataByConfigId(e);
    return void 0 === t ? (Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 63, "[捕鱼系统]->获取笼子容量错误，未找到对应实体的笼子数据。", ["configId", e]), 0) : MathUtils_1.MathUtils.LongToNumber(t.Data.ZT_)
  }
  GetFishingPointCapacityInfoTuple(e) {
    var t = this.GetFishingPointDataByPbEntityId(e);
    return void 0 === t ? (Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 63, "[捕鱼系统]->获取捕鱼点容量错误，未找到对应捕鱼点数据。", ["entityId", e]), [0, 0]) : [t.CurrentCount, t.MaxCount]
  }
  GetFishingPointAppearTimeLocalKey(e) {
    var t = ConfigManager_1.ConfigManager.FishingConfig.GetFishingPointConfigByEntityId(e).ShowItem,
      i = ConfigManager_1.ConfigManager.FishingConfig.GetFishingItemConfig(t).Time;
    return 1 === i ? "Fishing_WholeDay" : 2 === i ? "Fishing_OnlyDay" : 3 === i ? "Fishing_OnlyNight" : (Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 63, "[捕鱼系统]->获取鱼点的出没时间文本Key错误。", ["entityId", e], ["展示道具", t], ["出没时间", i]), "")
  }
  ...
  SetHandBookData(e) {
    var t;
    for (const n of e.FT_) n.s5n <= 0 || (t = {
      Id: n.s5n,
      MaxSize: n.VT_,
      MinSize: n.jT_
    ...
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingRefreshHandBookRewardView), ModelManager_1.ModelManager.FishingModel.FishingItemHandBookUnlockTraceList = e.WA_
  }
  ...
  GetFishingItemIdList() {
    var e = [];
    for (const t of ConfigManager_1.ConfigManager.FishingConfig.GetAllFishingItemConfig()) t.IllustratedNum <= 0 || e.push(t.Id);
    return e
  }
  GetFishingItemList() {
    var e, t = [];
    for (const i of ConfigManager_1.ConfigManager.FishingConfig.GetAllFishingItemConfig()) i.IllustratedNum <= 0 || (e = {
      Id: i.Id,
      Type: i.Category,
      Area: i.Area,
      Tech: i.Tech,
  ...
  get AllFishingItemCount() {
    let e = 0;
    for (const t of ConfigManager_1.ConfigManager.FishingConfig.GetAllFishingItemConfig()) 0 < t.IllustratedNum && e++;
    return e
  }
  ...
  GetSizeIsGoldSize(e) {
    ...
    return n.SizeWeight.length < FishingDefine_1.FISHING_SIZE_TYPE || (e = this.FishingItemHandBookDataMap.get(e)) && (t = n.SizeWeight[0], e.MinSize <= t.ArrayInt[1] && i.push(0), t = n.SizeWeight[2], e.MaxSize >= t.ArrayInt[0]) && i.push(2), i
  }
  ...
  RefreshHandBookDataReward(e) {
    ...
    this.FishingItemHandBookRewardMap.set(e.s5n, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingRefreshHandBookRewardView)
  }
