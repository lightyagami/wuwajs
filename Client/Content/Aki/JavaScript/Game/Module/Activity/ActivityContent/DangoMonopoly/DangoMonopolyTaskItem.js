...
class DangoMonopolyTaskItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.fGt = void 0, this.ClickCallBack = void 0, this.qsi = void 0, this.hoc = () => {
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.fGt.RewardItemId)
    }, this.FVc = () => {
      this.ClickCallBack?.(this.fGt)
    }, this.IOe = () => {
      UiManager_1.UiManager.CloseView("DangoMonopolyTaskView"), this.fGt.JumpSource()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.qsi = new SmallItemGrid_1.SmallItemGrid, this.qsi.Initialize(this.GetItem(0).GetOwner()), this.qsi.BindOnExtendToggleClicked(this.hoc), this.qsi.BindOnCanExecuteChange(() => !1), this.GetText(7).ShowTextNew(DangoMonopolyDefine_1.dangoMonopolyTextKey.GoTo), this.GetText(8).ShowTextNew(DangoMonopolyDefine_1.dangoMonopolyTextKey.CanReceive), this.GetText(5).ShowTextNew(DangoMonopolyDefine_1.dangoMonopolyTextKey.InProgress)
  }
  OnStart() {
    this.GetText(5).ShowTextNew(DangoMonopolyDefine_1.dangoMonopolyTextKey.InProgress)
  }
  Refresh(t) {
    this.fGt = t, Log_1.Log.CheckDebug() && Log_1.Log.Debug("DangoMonopoly", 69, this.constructor.name, ["", this.fGt]), this.GetText(1).ShowTextNew(this.fGt.TaskDesc), this.NVc(), this.K2o(), this.Usi()
  }
  NVc() {
    var t = this.GetText(2),
      o = 0 < this.fGt.TotalProgress;
    t.SetUIActive(o), o && (o = `(${this.fGt.Progress}/${this.fGt.TotalProgress})`, t.SetText(o))
  }
  K2o() {
  ...
  Usi() {
    var t = this.GetText(5),
      ...
      s = this.GetItem(9),
      r = !!this.fGt.Source;
    switch (o.SetUIActive(!1), t.SetUIActive(!1), i.RootUIComp.SetUIActive(!1), e.RootUIComp.SetUIActive(!1), s.SetUIActive(!1), this.fGt.TaskState) {
