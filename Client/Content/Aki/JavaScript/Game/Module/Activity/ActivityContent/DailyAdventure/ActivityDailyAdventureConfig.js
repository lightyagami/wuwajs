...
exports.ActivityDailyAdventureConfig = undefined;
...
class ActivityDailyAdventureConfig extends ConfigBase_1.ConfigBase {
  GetActivityDailyAdventureConfig(e) {
    return DailyAdventureActivityByActivityId_1.configDailyAdventureActivityByActivityId.GetConfig(e);
  }
  GetDailyAdventureTaskConfig(e) {
    return DailyAdventureTaskByTaskId_1.configDailyAdventureTaskByTaskId.GetConfig(e);
  }
