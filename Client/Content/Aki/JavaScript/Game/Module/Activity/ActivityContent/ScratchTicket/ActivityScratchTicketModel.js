...
class ActivityScratchTicketModel extends ModelBase_1.ModelBase {
  ...
  OnScratchCardCountInfoNotify(e) {
    void 0 !== this.Lol && (this.Lol.UpdateAllRoundState(), this.Lol.RefreshConditionData(e.IM_), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnScratchTicketConditionRefresh))
  }
  OnScratchCardRewardResponse(e, t, i, s) {
    var r;
    void 0 !== this.Lol && void 0 !== (r = this.Lol.GetRoundDataById(t)) && (e = r.GetRewardResultList(e, i.vjn), this.Lol.UpdateCellReward(t, i), r = r.GetRewardDataList(i._vs), s(i.vjn, t, e, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Lol.Id))
  }
}
