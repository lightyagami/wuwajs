...
exports.ActivityMowingSubView = undefined;
const UE = require("ue");
...
class ActivityMowingSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    ...
    this.U2e = () => {
      var i;
      if (this.D2e.GetPreGuideQuestFinishState()) {
        i = {
        ...
        UiManager_1.UiManager.OpenView("QuestView", this.D2e.GetUnFinishPreGuideQuestId());
      }
    };
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIText], [2, UE.UIItem], [3, UE.UIText], [4, UE.UIItem], [5, UE.UIScrollViewWithScrollbarComponent], [6, UE.UIItem], [7, UE.UIItem], [8, UE.UIButtonComponent], [9, UE.UIButtonComponent], [10, UE.UIText], [11, UE.UIItem], [12, UE.UIItem], [13, UE.UIText], [14, UE.UIText]];
  }
  ...
  P2e() {
    ...
    var e = this.D2e.GetPreGuideQuestFinishState();
    if (i && e) {
      i = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("ActivityMowing_Newlevelunlock");
  ...
  BNe() {
    ...
    this.ANe.SetRewardRedDotVisible(i);
    var i = this.D2e.IsNewInstanceOpen();
    var e = this.D2e.GetPreGuideQuestFinishState();
