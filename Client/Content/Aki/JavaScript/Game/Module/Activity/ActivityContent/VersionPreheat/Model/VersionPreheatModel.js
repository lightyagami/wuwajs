...
class VersionPreheatModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentUsingVersionPreheatId = void 0, this.I_l = void 0, this.FCl = void 0, this.VCl = void 0, this.HCl = void 0, this.T_l = void 0, this.UVa = void 0
  }
  OnInit() {
    return this.T_l = new VersionPreheatActivityContext_1.VersionPreheatActivityContext, this.UVa = new VersionPreheatConfigContext_1.VersionPreheatConfigContext, !0
  }
  OnClear() {
  ...
  get HasNewQuest() {
    ...
    for (const e of this.UVa.AllQuestCfg) {
      ...
      if (void 0 !== t && (0 !== this.GetQuestStateById(e.Id) && !this.IsQuestClickedById(e.Id))) return !0
    }
    return !1
  }
  ...
  R_l(t) {
    ...
    if (0 < e && (void 0 === this.T_l.QuestCache.get(e) || !ActivityVersionPreheatController_1.ActivityVersionPreheatController.Instance.IsQuestFinishedById(e))) return 0;
    return ActivityVersionPreheatController_1.ActivityVersionPreheatController.Instance.IsQuestFinishedById(t.Id) ? 3 : t.Rewarded ? 2 : 1
  }
  IsQuestClickedById(t) {
    return void 0 === this.I_l && (this.I_l = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatToQuestClicked)), this.I_l?.get(t) ?? !1
  }
  SetQuestClickedById(t) {
    void 0 === this.I_l && (this.I_l = new Map), this.I_l.set(t, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatToQuestClicked, this.I_l), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.T_l.Id)
  }
  IsQuestPlayedById(t) {
    return void 0 === this.VCl && (this.VCl = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatToQuestPlayed)), this.VCl?.get(t) ?? !1
  }
  SetQuestPlayedById(t) {
    void 0 === this.VCl && (this.VCl = new Map), this.VCl.set(t, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatToQuestPlayed, this.VCl)
  }
  IsBonusClicked() {
    return void 0 === this.FCl && (this.FCl = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatBonusClicked)), this.FCl ?? !1
  }
  SetBonusClicked() {
    void 0 === this.FCl && (this.FCl = !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatBonusClicked, this.FCl), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.T_l.Id)
  }
  IsBonusPlayed() {
    return void 0 === this.HCl && (this.HCl = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatBonusPlayed)), this.HCl ?? !1
  }
  SetBonusPlayed() {
    void 0 === this.HCl && (this.HCl = !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VersionPreheatBonusPlayed, this.HCl)
  }
  x_l(t) {
    var e = this.UVa,
  ...
  w_l(t, e) {
    if (!(e < 2)) return e = 1 === ModelManager_1.ModelManager.PlayerInfoModel?.GetPlayerGender() ? VersionPreheatDefine_1.HERO_ROLE_ID : VersionPreheatDefine_1.HEROINE_ROLE_ID, {
