...
class DockyardModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.xXl = new Map, this.AXl = new Map, this.RXl = new DockyardBackpackOriginalData_1.DockyardBackpackOriginalData, this.IsPrintLog = !0, this.IsNeedShowExitConfirmBox = !0, this.FishingCabinShape = 0
  }
  get IsTrawlOpen() {
  ...
  get TrawlSize() {
    ...
    return 0 < e ? ConfigManager_1.ConfigManager.FishingConfig.GetFishingTechEffectById(e).Params[0] : 0
  }
  ...
  AddListItemReadFlag(e) {
    ModelManager_1.ModelManager.NewFlagModel?.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.DockyardListItemRead, e), ModelManager_1.ModelManager.NewFlagModel?.SaveNewFlagConfig(LocalStorageDefine_1.ELocalStoragePlayerKey.DockyardListItemRead)
  }
  ...
  SetDockyardData(e) {
    this.UXl(e.$T_), this.RXl.SetBackpackDataListFromServer(e.HT_), this.RXl.SetQuicklySellData(e.WT_, e.XT_), this.SetTrawlDataListFromServer(e.QT_), this.wXl(e.KT_), this.RXl.RefreshPosData()
  }
  UpdateDockyardData(e) {
    this.SetDockyardData(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Dockyard", 10, "船舱数据刷新")
  }
  GetItemBlockData(e) {
