...
class RoleGrowingTaskView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.ActivityBaseData = void 0, this.CurrentIndex = 0, this.CaptionItem = void 0, this.PageDotLayout = void 0, this.TaskScroll = void 0, this.WOe = () => {
      ...
      t.sort(this.ActivityBaseData.TaskSort), this.TaskScroll.RefreshByData(t, void 0, !0)
    }, this.VOe = () => new LongShanTaskItem_1.LongShanTaskItem, this.HOe = () => new PageDot_1.PageDot, this.KOe = () => {
      this.RefreshView(this.CurrentIndex - 1)
    }, this.QOe = () => {
      var e = this.ActivityBaseData.StageIds[this.CurrentIndex + 1];
      this.ActivityBaseData.GetStageInfoById(e) ? this.RefreshView(this.CurrentIndex + 1) : ActivityLongShanController_1.ActivityLongShanController.ShowUnlockTip(e)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    this.CurrentIndex = e.indexOf(this.OpenParam), this.PageDotLayout = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(7), this.HOe), await this.PageDotLayout.RefreshByDataAsync(e), this.TaskScroll = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(4), this.VOe)
  }
  OnBeforeShow() {
