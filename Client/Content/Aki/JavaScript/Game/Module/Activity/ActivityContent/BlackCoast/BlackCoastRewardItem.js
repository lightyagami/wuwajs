...
class BlackCoastRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, s) {
    ...
    this.SetRewardGoalValue(t.Goal), this.RefreshRewardState(i, void 0 === this._7s)
  }
  ...
  RefreshRewardState(e, t) {
    ...
    if (s.SetUIActive(!1), s.Deactivate(), t || this._7s !== e) {
      ...
      this.GetItem(8).SetUIActive(0 === e), this.GetUiNiagara(6).SetAlpha(0 === e ? 1 : 0), 2 !== e || t || (s.SetUIActive(!0), s.ActivateSystem(!0)), this._7s = e
    }
  }
  Zkt(t) {
    var e = [];
