...
class ActivityRoleGiveController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnCreateActivityData(e) {
    return ActivityRoleGiveController.CurrentActivityId = e.s5n, new ActivityRoleGiveData_1.ActivityRoleGiveData
  }
  ...
  static TrackMoonActivityRewardRequest() {
    ...
    e.w6n = ActivityRoleGiveController.CurrentActivityId, Log_1.Log.CheckInfo() && Log_1.Log.Info("MoonChasing", 34, "TrackMoonActivityRewardRequest", ["ActivityId:", ActivityRoleGiveController.CurrentActivityId]), Net_1.Net.Call(17226, e, e => {
      e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28964) : (e = ActivityRoleGiveController.GetCurrentActivityData()) && (e.IsGetReward = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, ActivityRoleGiveController.CurrentActivityId), Log_1.Log.CheckInfo()) && Log_1.Log.Info("MoonChasing", 34, "TrackMoonActivityRewardResponse", ["ActivityId:", ActivityRoleGiveController.CurrentActivityId])
    })
  }
