...
class BabelTowerQuestTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.vua = 0, this.OnClickToggleCallBack = void 0, this.kqe = () => {
  ...
  Refresh(e, t, r) {
    ...
    this.GetItem(2).SetUIActive(e.GetQuestTabRedDot(this.vua)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "BabelTowerTaskType_" + this.vua)
  }
  SelectToggle() {
    this.GetExtendToggle(0).SetToggleState(1, !1), this.OnClickToggleCallBack?.(this.GetExtendToggle(0), this.vua)
  }
}
