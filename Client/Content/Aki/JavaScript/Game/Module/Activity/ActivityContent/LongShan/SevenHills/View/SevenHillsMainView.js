...
class SevenHillsMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.S2t = undefined;
    this.pz1 = () => {
      var e = new SevenHillsRewardBoxItem_1.SevenHillsRewardBoxItem();
      e.ActivityData = this.ActivityBaseData;
      return e;
    };
    this.vz1 = () => {
      var e = new SevenHillsStageItem_1.SevenHillsStageItem();
      e.ActivityData = this.ActivityBaseData;
      e.OnClickStageItem = this.OnClickStageItem;
      return e;
    };
    this.m7s = e => {
      this.S2t.Refresh(e);
    ...
    this.Wja = e => {
      if (this.ActivityBaseData && this.ActivityBaseData.Id === e) {
        this.Cz1.RefreshByData(this.ActivityBaseData.GetAllScoreRewardData());
      }
    };
    this.OnClickStageItem = e => {
      UiManager_1.UiManager.OpenView("SevenHillsStageTaskView", [this.ActivityBaseData, e]);
    };
    this.$An = e => {
  ...
  async OnBeforeStartAsync() {
    ...
    this.Cz1 = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(1), this.pz1);
    await this.Cz1.RefreshByDataAsync(this.ActivityBaseData.GetAllScoreRewardData());
    this.Vja = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(5), this.vz1);
