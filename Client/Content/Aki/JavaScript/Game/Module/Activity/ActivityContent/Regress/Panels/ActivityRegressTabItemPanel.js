...
class ActivityRegressTabItemPanel extends CommonTabItemBase_1.CommonTabItemBase {
  constructor() {
    super(...arguments), this.RedDotName = void 0, this.Bke = t => {
  ...
  OnStart() {
    super.OnStart(), this.GetExtendToggle(1).SetToggleState(0), this.GetItem(2).SetUIActive(!1), this.GetSprite(0).SetUIActive(!0)
  }
  OnRefresh(t, e, i) {
    t.Data && (this.UpdateTabIcon(t.Data.GetIcon() ?? ""), this.UpdateTitle(t.Data.GetTitleData()?.TextId ?? ""), this.UnBindRedDot(), t.RedDotName) && this.BindRedDot(t.RedDotName, t.RedDotUid)
  }
  OnSelected(t) {
    this.SelectedCallBack(this.GridIndex)
  }
  OnUpdateTabIcon(t) {
    "" === t ? Log_1.Log.CheckDebug() && Log_1.Log.Debug("ActivityRecall", 63, "回流活动->ActivityRecallTabItemPanel刷新标签图标,传入路径为空", ["iconPath: ", t]) : this.SetSpriteByPath(t, this.GetSprite(0), !1, void 0, this.RefreshTransition)
  }
  UpdateTitle(t) {
  ...
  BindRedDot(t, e = 0) {
    this.RedDotName = t, this.RedDotName && RedDotController_1.RedDotController.BindRedDot(t, this.GetItem(2), void 0, e)
  }
  UnBindRedDot() {
