...
class ChessboardPoint {
  constructor() {
    this.xe = 0, this.aei = 0, this.Location = Vector_1.Vector.Create(), this.Rotator = Rotator_1.Rotator.Create()
  }
  Init(t, o, r, e) {
    this.xe = t, this.aei = e, this.Location.DeepCopy(o), this.Rotator.DeepCopy(r)
  }
  GetId() {
    return this.xe
  }
