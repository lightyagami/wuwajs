  ...
  OnRefresh(r, e, i) {
    ...
    if (o) {
      ...
      var t = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(n),
        t = (e = t < r.ItemNeedNum ? StringUtils_1.StringUtils.Format(FishingDefine_1.FISHING_TECH_MATERIAL_NOT_ENOUGHT, t.toString()) : StringUtils_1.StringUtils.Format(FishingDefine_1.FISHING_TECH_MATERIAL_WHITE_ENOUGHT, t.toString()), {
          Type: 4
        });
      t.Type = 4, t.Data = r, t.ItemConfigId = n, t.StarLevel = o.QualityId, t.BottomText = e + "/" + r.ItemNeedNum, t.IsOmitBottomText = !1, this.Apply(t)
    }
  }
