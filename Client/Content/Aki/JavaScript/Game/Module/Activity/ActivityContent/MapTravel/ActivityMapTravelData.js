...
class ActivityMapTravelData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.TravelLevelData = new Map, this.TravelLevel = 0, this.tVl = 0, this.iVl = 0, this.rVl = 0, this.AreaDataMap = new Map, this.AreaTaskMap = new Map, this.TaskFinalRewardData = void 0, this.PhantomQuestIds = new Set, this.SortPhantomQuestItem = (t, e) => {
      var r = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(t),
        a = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(e);
      return r.Sort === a.Sort ? t - e : r.Sort - a.Sort
    }, this.PhantomDataMap = new Map, this.SoarChallengeRewardDataMap = new Map, this.SoarChallengePlayDataMap = new Map, this.CheckSoarItemRedDot = t => {
      for (const e of t)
  ...
  OnInit(t) {
    ...
    t = t.KS_;
    t && (this.TravelLevel = t.fE_, this.tVl = t.fE_, this.rVl = this.GetCurrentExp(), this.iVl = this.GetExpItemCount())
  }
  PhraseEx(t) {
    t = t.KS_;
  ...
  GetExDataRedPointShowState() {
    return !!this.CanTravelLevelUp() || !!this.GetTaskRedDotState(!0) || !!this.GetAllSoarItemRedDot()
  }
  SaveFirstCheckRedDotState(t, e = 0) {
    return 1 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, t, e, 0) || (ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, t, e, 0, 1), this.RefreshActivityRedDotState(), !1)
  }
  GetTypeProgress(t) {
    let [e, r] = [0, 1];
    switch (t) {
      ...
      case 3:
        ...
        break;
      case 4:
        for (const i of this.SoarChallengeRewardDataMap.values()) 2 === i.Status && e++;
  ...
  nVl() {
    this.AreaDataMap.clear(), this.TaskFinalRewardData = new ActivityMapTravelDefine_1.FinalTravelTaskData;
    var t = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllTravelTaskConfig(this.Id),
      t = (this.TaskFinalRewardData.Target = t.length, ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllAreaConfig(this.Id));
    for (const r of t) {
  ...
  GetAllAreaData() {
    return Array.from(this.AreaDataMap.values()).sort((t, e) => {
      var r = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAreaConfig(t.AreaId),
        a = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAreaConfig(e.AreaId);
  ...
  RefreshTravelTaskData(a) {
    ...
    var e;
    t || (t = new ActivityCommonDefine_1.ActivityTaskData, e = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetTravelTaskConfig(a.s5n), this.AreaDataMap.get(e.AreaId).TravelTaskIdSet.add(a.s5n), this.AreaTaskMap.set(a.s5n, t)), t.Refresh(a, (t, e, r) => {
      t && 2 === r && this.TaskFinalRewardData.FinishedIdSet.add(a.s5n)
    })
  }
  SetTravelTaskDataDone(t) {
    this.AreaTaskMap.get(t).Status = 2, this.TaskFinalRewardData.FinishedIdSet.add(t)
  }
  IsAreaTaskFinish(t) {
  ...
  GetAreaNewUnlockState(t) {
    ...
    return !(!e || a || !r) && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 5, t, 0)
  }
  ...
  GetTaskRedDotState(t = !1) {
    if (this.TaskFinalRewardData && this.TaskFinalRewardData.CanReceive()) return !0;
  ...
  sVl() {
    for (const t of ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllQuestConfig(this.Id)) this.AreaDataMap.get(t.AreaId).PhantomTaskIdSet.add(t.Id), this.PhantomQuestIds.add(t.Id)
  }
  GetPhantomQuestCount() {
    var t = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllQuestConfig(this.Id);
    let e = 0;
    for (const r of t) 3 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(r.QuestId) && e++;
    return [e, t.length]
  }
  GetAllPhantomQuestNewState() {
    for (const t of ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllQuestConfig(this.Id))
      if (this.GetPhantomQuestNewState(t.Id) || this.GetPhantomQuestNewUnlockState(t.Id) || this.GetPhantomQuestDoneCheckState(t.Id)) return !0;
    return !1
  }
  GetPhantomQuestNewState(t) {
    ...
    return (1 === e || 2 === e) && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 2, t, 0)
  }
  GetPhantomQuestDoneCheckState(t) {
    var e = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(t).QuestId;
    return 3 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e) && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 3, t, 0)
  }
  GetPhantomQuestNewUnlockState(t) {
    var e = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(t).QuestId;
    return 0 !== ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e) && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 6, t, 0)
  }
  aVl() {
    this.PhantomDataMap.clear();
    for (const t of ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllPhantomConfig(this.Id)) this.PhantomDataMap.set(t.Id, !1)
  }
  UnlockPhantom(t) {
  ...
  GetAllPhantomNewUnlockState() {
    for (var [t, e] of this.PhantomDataMap.entries())
      if (e && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 4, t, 0)) return !0;
    return !1
  }
  GetPhantomNewUnlockState(t) {
    return 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 4, t, 0)
  }
  hVl() {
    ...
    for (const a of ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetAllSoarChallengeConfig()) {
      ...
      r.Id = a.Id, r.Target = a.NeedScore, this.SoarChallengeRewardDataMap.set(a.Id, r);
      let t = this.SoarChallengePlayDataMap.get(a.LevelPlayId);
      t || ((t = new ActivityMapTravelDefine_1.SoarChallengePlayData).TabIndex = e, t.PlayId = a.LevelPlayId, t.NameTextId = a.Name, t.CheckRedDot = this.CheckSoarItemRedDot, t.CheckFinished = this.CheckSoarItemFinished, t.JumpId = a.JumpId, this.SoarChallengePlayDataMap.set(a.LevelPlayId, t), e++), t.RewardIds.push(a.Id)
    }
  }
  RefreshSoarChallengePlayData(t) {
    ...
    if (e) {
      ...
      for (const a of e.RewardIds) {
        ...
        r.Current = e.HighestPoint, t.yE_.includes(a) ? r.Status = 2 : r.Current >= r.Target ? r.Status = 0 : r.Status = 1
      }
    }
  }
  ...
  RefreshSoarChallengeUnlockState(t) {
    var e = this.SoarChallengePlayDataMap.get(t),
      r = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetSoarChallengeConfig(e.RewardIds[0]);
    e.IsNew = !1, this.TravelLevel < r.UnlockTravelLevel || (0 !== r.UnlockQuestId ? (r = ModelManager_1.ModelManager.QuestNewModel.CheckQuestFinished(r.UnlockQuestId), e.IsUnlock = r) : e.IsUnlock = !0, e.IsNew = this.GetSoarItemNewUnlockState(t))
  }
  ...
  RefreshAndGetAllSoarItemNewUnlock() {
    let t = !1;
    for (const e of this.SoarChallengePlayDataMap.keys()) this.RefreshSoarChallengeUnlockState(e), !t && this.GetSoarItemNewUnlockState(e) && (t = !0);
    return t
  }
  GetSoarItemNewUnlockState(t) {
    t = this.SoarChallengePlayDataMap.get(t);
    return !(!t.IsUnlock || 0 !== ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 7, t.PlayId, 0))
  }
}
