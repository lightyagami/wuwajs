...
class HandbookRewardData {
  constructor() {
    this.Id = 0, this.Goal = 0, this.Achieved = !1, this.DropId = 0, this.cbe = []
  }
  GetPreviewReward() {
    if (0 === this.cbe.length) {
      var t = [];
      if (0 === this.DropId) return t;
      var r, e, a = ConfigManager_1.ConfigManager.RewardConfig.GetDropPackage(this.DropId)?.DropPreview;
      if (!a) return t;
      for ([r, e] of a) {
        var i = [{
          IncId: 0,
