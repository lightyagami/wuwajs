...
exports.BossRushBuffSelectInGameView = undefined;
const UE = require("ue");
const ModelManager_1 = require("../../../../Manager/ModelManager");
const UiViewBase_1 = require("../../../../Ui/Base/UiViewBase");
const RoguelikeDefine_1 = require("../../../Roguelike/Define/RoguelikeDefine");
const BossRushBuffSelectInGameItem_1 = require("./BossRushBuffSelectInGameItem");
...
class BossRushBuffSelectInGameView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.sOt = () => {
      ...
      if (this.tyn) {
        ...
        BossRushController_1.BossRushController.RequestBossRushChooseBuffInGame(e);
        this.CloseMeAsync();
      }
    };
    this.zal = e => {
      this.tyn?.SetToggleUnCheck();
      this.tyn = e;
      this.M3e();
    };
  }
  ...
  async OnBeforeStartAsync() {
    ...
    var s = [];
    var t = ModelManager_1.ModelManager.BossRushModel.ChoseBuffInGameHandleList.length;
    for (let e = 0; e < t; e++) {
      var i = new BossRushBuffSelectInGameItem_1.BossRushBuffSelectInGameItem();
      i.SetClickCallBack(this.zal);
      this.Yal.push(i);
      s.push(i.CreateThenShowByResourceIdAsync(RoguelikeDefine_1.COMMON_SELECT_ITEM, this.GetItem(0)));
    }
    this.Xva = this.GetItem(0).GetOwner().GetComponentByClass(UE.UIInturnAnimController.StaticClass());
    await Promise.all(s);
  }
  OnStart() {
  ...
  M3e() {
    this.GetButton(1).SetSelfInteractive(this.tyn !== undefined);
  }
}
