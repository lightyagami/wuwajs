...
class BossRushBuffSelectInGameView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Yal = [], this.tyn = void 0, this.Xva = void 0, this.sOt = () => {
      var e;
      this.tyn && (e = this.Yal.indexOf(this.tyn), BossRushController_1.BossRushController.RequestBossRushChooseBuffInGame(e), this.CloseMeAsync())
    }, this.zal = e => {
  ...
  async OnBeforeStartAsync() {
    ...
    var s = [],
      t = ModelManager_1.ModelManager.BossRushModel.ChoseBuffInGameHandleList.length;
    for (let e = 0; e < t; e++) {
      var i = new BossRushBuffSelectInGameItem_1.BossRushBuffSelectInGameItem;
      i.SetClickCallBack(this.zal), this.Yal.push(i), s.push(i.CreateThenShowByResourceIdAsync(RoguelikeDefine_1.COMMON_SELECT_ITEM, this.GetItem(0)))
    }
    this.Xva = this.GetItem(0).GetOwner().GetComponentByClass(UE.UIInturnAnimController.StaticClass()), await Promise.all(s)
  }
  OnStart() {
