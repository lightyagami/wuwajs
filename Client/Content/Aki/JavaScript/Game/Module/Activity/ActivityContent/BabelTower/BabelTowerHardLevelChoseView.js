...
class BabelTowerHardLevelChoseView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.lqe = void 0, this.rfc = [], this.vVt = void 0, this.u6c = void 0, this.AMo = () => {
      var e;
      ...
      BabelTowerController_1.BabelTowerController.SaveNewLevelClickData(e, 1), UiManager_1.UiManager.OpenView("BabelTowerDeTermSelectView", e)
    }, this.sGe = () => {
      ...
      for (let e = 0; e < this.rfc.length; e++)
        if (this.rfc[e].ELl === t) {
          ...
          this.vVt?.BindLateUpdate(() => {
            r && (ControllerHolder_1.ControllerHolder.UiNavigationNewController.SetNavigationFocusForView(r.GetRootItem(), !0), this.u6c !== r ? (this.u6c?.StopLoopSequence(), r.PlayLoopSequence()) : this.u6c.IsPlayingSequence() || r.PlayLoopSequence(), this.u6c = r), this.vVt?.UnBindLateUpdate()
          })
        }
    } else this.Og();
  ...
  Og() {
    var e, t = BabelTowerController_1.BabelTowerController.GetBabelTowerData();
    this.rfc = [];
    for ([, e] of t.HardLevelDataMap) this.rfc.push(e);
    this.vVt?.RefreshByData(this.rfc), this.GetArtText(1).SetText(t.GetHardLevelStarText()), this.GetLoopScrollViewComponent(8).Content.GetComponentByClass(UE.UIInturnAnimController.StaticClass())?.Play()
  }
  OnBeforeHide() {
