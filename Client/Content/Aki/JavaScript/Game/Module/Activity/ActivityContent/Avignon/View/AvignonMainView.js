...
class AvignonActivityMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.AvignonProtocolData = void 0, this.lqe = void 0, this.AMo = () => {
      this.CloseMe()
    }, this.qSc = () => {
  ...
  async OnBeforeStartAsync() {
    this.AvignonProtocolData = this.OpenParam, this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.lqe.SetTitle(this.AvignonProtocolData.GetTitle()), this.lqe.SetHelpBtnActive(!1), this.lqe.SetCloseCallBack(this.AMo);
