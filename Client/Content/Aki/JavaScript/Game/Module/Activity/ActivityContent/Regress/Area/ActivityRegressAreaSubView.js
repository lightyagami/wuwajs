...
class ActivityRegressAreaSubView extends ActivityRegressMainSubViewBase_1.ActivityRegressMainSubViewBase {
  constructor() {
    super(...arguments), this.Cl1 = void 0, this.pl1 = void 0, this.Gda = void 0, this.Wwn = e => {
      e = this.Gda[e].Config;
      this.pl1.RefreshByData(e), this.InvokePassRecallBaseCallBack(e, 1), this.SequencePlayer.PlaySequence("Start")
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    this.pl1 = new ActivityRegressAreaActivityInfoPanel_1.ActivityRegressAreaActivityInfoPanel, await this.pl1.CreateThenShowByActorAsync(e)
  }
  OnStart() {
    super.OnStart();
    var e = this.GetHorizontalLayout(0),
      i = this.GetItem(5);
    this.Cl1 = new ActivityRegressTabGroupPanel_1.ActivityRegressTabGroupPanel(e, i, this.Wwn), this.Cl1.Init(), this.GetItem(3).SetUIActive(!1)
  }
  OnBeforeDestroy() {
    this.Cl1.Destroy(), this.Cl1 = void 0
  }
  OnUpdate(e) {
    var i = ModelManager_1.ModelManager.ActivityRegressModel.GetLastestRegressBaseConfigList(2);
    this.Gda = [], i.forEach(e => {
      var i = new ActivityRegressDefine_1.ActivityRegressTabSwitchItemCommonData;
      i.RecallEntryType = 2, i.Config = e, i.Title = e.Title, this.Gda.push(i)
    }), this.GetItem(7).SetUIActive(1 < this.Gda.length), this.Cl1.RefreshByData(this.Gda, e)
  }
}
