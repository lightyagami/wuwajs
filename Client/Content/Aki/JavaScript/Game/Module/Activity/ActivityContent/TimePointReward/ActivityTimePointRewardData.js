...
class TimePointRewardData {
  constructor() {
    this.Id = 0, this.RewardTime = 0, this.HasClaimed = !1, this.HasUnlock = !1
  }
  get RewardState() {
...
class ActivityTimePointRewardData extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(t) {
    ...
    if (e) {
      for (const i of e.nBs) {
        ...
        e.Id = i.s5n, e.RewardTime = Number(MathUtils_1.MathUtils.LongToBigInt(i.bYs)), e.HasClaimed = i.mLs, e.HasUnlock = i.Txs, this.nJs.set(i.s5n, e)
      }
  ...
  SetRewardToGotState(t) {
    ...
    if (e) {
      e.HasClaimed = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id);
      for (const e of this.nJs.values())
        if (2 !== e.RewardState) return;
