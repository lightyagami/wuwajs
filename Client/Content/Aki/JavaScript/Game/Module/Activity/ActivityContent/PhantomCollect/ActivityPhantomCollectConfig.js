...
exports.ActivityPhantomCollectConfig = undefined;
...
class ActivityPhantomCollectConfig extends ConfigBase_1.ConfigBase {
  GetPhantomCollectConfig(e) {
    return PhantomCollectActivityById_1.configPhantomCollectActivityById.GetConfig(e);
  }
  GetPhantomCollectTaskDesc(e) {
    return PhantomCollectTaskDescById_1.configPhantomCollectTaskDescById.GetConfig(e);
  }
}
