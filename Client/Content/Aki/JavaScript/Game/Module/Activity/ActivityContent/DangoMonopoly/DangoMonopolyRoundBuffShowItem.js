...
class DangoMonopolyRoundBuffShowItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(o) {
    this.fGt = o, Log_1.Log.CheckDebug() && Log_1.Log.Debug("DangoMonopoly", 69, "DangoRoundBuffShowItem", ["", this.fGt]), this.SetTextureByPath(this.fGt.DangoIcon, this.GetTexture(1)), this.GetText(2).ShowTextNew(this.fGt.DangoName), this.GetText(3).ShowTextNew(this.fGt.PropertyDesc)
  }
}
