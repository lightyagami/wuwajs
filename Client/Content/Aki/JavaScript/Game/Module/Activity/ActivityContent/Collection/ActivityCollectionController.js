...
class ActivityCollectionController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.DSe = (e, t) => {
      var o, i, r, n = ActivityCollectionController.vNe();
      n && (r = n.QuestStateMap.get(e)) && ([o] = n.GetCurrentProgress(), i = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e), [r] = (r.QuestState = i, n.QuestStateMap.set(e, r), ModelManager_1.ModelManager.ActivityModel.SaveActivityData(n.Id, e, 0, 0, 2 === i ? 1 : 0), n.GetCurrentProgress()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, ActivityCollectionController.CurrentActivityId), r !== o) && ActivityController_1.ActivityController.OpenActivityById(ActivityCollectionController.CurrentActivityId)
    }
  }
  ...
  static RequestCollectionQuestReward(e) {
    ...
    t.V6n = e, Net_1.Net.Call(28098, t, e => {
      e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19742)
    })
  }
