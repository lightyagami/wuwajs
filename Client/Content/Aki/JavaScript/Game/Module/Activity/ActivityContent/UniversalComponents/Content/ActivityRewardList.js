...
class ActivityRewardList extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.s4e = void 0, this.a4e = void 0, this.InitCommonGridItem = () => {
  ...
  InitGridLayout(e) {
    this.a4e = e, void 0 === this.s4e && (this.s4e = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(2), this.a4e))
  }
  SetTitleByTextId(e) {
