...
class MapTravelTabDynamicScrollItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.ActivityBaseData = t, this.JZ = void 0, this.fuo = void 0, this.Data = void 0, this.SelectedCallBack = void 0, this.IsSelectedOn = void 0
  }
  async Init(t) {
  ...
  Update(t, i) {
    this.Data = t, this.fuo.SetUiActive(!t.IsUnlock), this.JZ.SetUiActive(t.IsUnlock), (t.IsUnlock ? this.JZ : this.fuo).RefreshByData(t, i), this.IsSelectedOn?.(t, i) ? this.SetSelected(!0, !1) : this.SetSelected(!1, !1)
  }
  SetSelected(t, i) {
    this.fuo.SetToggleState(t, !!i && !this.Data.IsUnlock), this.JZ.SetToggleState(t, !!i && this.Data.IsUnlock)
  }
...
class MapTravelTabItemBase extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.ActivityBaseData = t, this.Data = void 0, this.Index = 0, this.SelectedCallBack = void 0, this.AVl = () => {
...
class MapTravelTabItem extends MapTravelTabItemBase {
  RefreshByData(t, i) {
    ...
    var i = ConfigManager_1.ConfigManager.AreaConfig.GetAreaInfo(t.AreaId),
      i = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), i.Title), this.ActivityBaseData.IsAreaTaskFinish(t.AreaId)),
      s = this.ActivityBaseData.GetAreaRewardState(t.AreaId);
    this.GetItem(2).SetUIActive(i), this.GetItem(3).SetUIActive(!t.IsUnlock), this.GetItem(4).SetUIActive(s)
  }
}
