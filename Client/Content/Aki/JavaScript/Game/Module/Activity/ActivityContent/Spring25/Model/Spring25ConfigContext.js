...
class Spring25ConfigContext {
  constructor(e) {
    this.i5l = void 0, this.GGl = void 0, this.kGl = void 0, this.i5l = e
  }
  get OGl() {
    if (void 0 === this.GGl) {
      this.GGl = new Map;
  ...
  Dispose() {
    this.kGl?.clear(), this.kGl = void 0, this.GGl?.clear(), this.GGl = void 0
  }
  FGl(e) {
  ...
  StartChatCfgByGender(e) {
    return 1 === e ? SpringChatById_1.configSpringChatById.GetConfig(Spring25Define_1.START_MALE_CHAT_CONFIG_ID) : SpringChatById_1.configSpringChatById.GetConfig(Spring25Define_1.START_FEMALE_CHAT_CONFIG_ID)
  }
  GetChatConfigBySignId(i, t) {
    ...
    if (void 0 !== i) {
      ...
      if (!(i.length < 2)) {
        let e = 0;
        return e = 1 === t ? i[0] : i[1], SpringChatById_1.configSpringChatById.GetConfig(e)
      }
    }
  }
