...
class DockyardPanelUtil {
  static RotateItemGridData(r, e) {
    ...
    return e === Protocol_1.Aki.Protocol.mR_.Proto_DirectionUp ? [i, Protocol_1.Aki.Protocol.mR_.Proto_No] : [i, e + 1]
  }
  ...
  static DeepCopyItemRangePos(e, t) {
    e.RowStartIndex = t.RowStartIndex, e.RowEndIndex = t.RowEndIndex, e.ColStartIndex = t.ColStartIndex, e.ColEndIndex = t.ColEndIndex
  }
  static CalculateOriginalPivot(e, t) {
    var r = Vector2D_1.Vector2D.Create();
    return e === t || Math.abs(e - t) % 2 == 0 ? r.Set(.5, .5) : t % 2 == 1 ? r.Set((t / 2 - .5) / t, .5) : r.Set(.5, (e / 2 - .5) / e), r
  }
  static CreateFishingItemInfo(e, t, r) {
    var o = Protocol_1.Aki.Protocol.CR_.create(),
      e = (o.b9n = e.IncId, o.L8n = e.ItemId, o.ATs = e.Quality, o.M8n = e.Size, o.MBs = e.Price, o.MXl = e.Cup, o.EXl = t, Protocol_1.Aki.Protocol.gR_.create());
    return e.iPs = r.ColIndex, e.rPs = r.RowIndex, o.l8n = e, o
  }
  static GetTexturePathByCup(e) {
    return 0 === e ? ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(FishingDefine_1.SILVER_CUP_ICON) : 1 === e ? "" : ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(FishingDefine_1.GOLD_CUP_ICON)
  }
}
