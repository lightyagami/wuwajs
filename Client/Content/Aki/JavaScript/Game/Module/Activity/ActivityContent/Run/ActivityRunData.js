...
class ActivityRun extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(i) {
    this.kFe = new Array, i.Gps.mps.forEach(t => {
  ...
  GetExDataRedPointShowState() {
    ...
    for (let t = 0; t < e; t++)
      if (this.kFe[t].GetRedPoint()) return !0;
    return !1
  }
...
class ActivityRunData extends ActivityData_1.ActivityExData {
  constructor() {
    super(...arguments), this.FFe = 0, this.VFe = new Array, this.xte = 0, this.pne = 0, this.HFe = 0, this.Cce = -0, this.jFe = !1, this.WFe = -0, this.KFe = -0, this.QFe = void 0
  }
  get Id() {
    return this.FFe
  }
  ...
  GetScoreIndex(e) {
    ...
    for (let t = 0; t < i; t++)
      if (e === this.QFe.get(t)?.[0]) return t;
    return 0
  }
  GetScoreIndexCannotGetReward(t) {
    var e, i = Array.from(this.QFe.keys());
    let r = 0;
    return this.QFe.get(t) && (e = this.QFe.get(t), r = e[0]), this.xte >= r ? this.VFe.includes(i[t]) ? 2 : 1 : 0
  }
  XFe() {
  ...
  SetChallengeLocalRedPointState(t) {
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.ActivityId, this.FFe, 0, 0, t ? 1 : 0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshRunActivityRedDot, this.FFe), this.RefreshActivityRedPoint()
  }
  GetChallengeNewLocalRedPoint() {
    return 1 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.ActivityId, 1, this.FFe, 0, 0)
  }
  GetIsShow() {
  ...
  OnGetScoreReward(t) {
    this.VFe.includes(t) || (this.VFe.push(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshRunActivityRedDot, this.FFe), this.RefreshActivityRedPoint())
  }
  CheckIfInShowTime() {
    var t;
  ...
  OnChallengeEnd(t) {
    this.HFe = t.SMs, this.Cce = t.n5n, this.HFe > this.xte && (this.xte = this.HFe), (this.Cce < this.pne || 0 === this.pne) && (this.pne = this.Cce), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshRunActivityRedDot, this.FFe), this.RefreshActivityRedPoint()
  }
  Phrase(t) {
    t instanceof Protocol_1.Aki.Protocol.$5s ? (this.FFe = t.e8n, this.VFe = [], t.rBs.forEach(t => {
      this.VFe.push(t)
    }), this.xte = t.tBs, this.pne = t.iBs) : t instanceof Protocol_1.Aki.Protocol.cks && (this.FFe = t.e8n, this.WFe = Number(MathUtils_1.MathUtils.LongToBigInt(t.cps)), this.KFe = Number(MathUtils_1.MathUtils.LongToBigInt(t.dps))), this.QFe || (this.QFe = ConfigManager_1.ConfigManager.ActivityRunConfig.GetActivityRunScoreMap(this.FFe)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshRunActivityRedDot, this.FFe), this.RefreshActivityRedPoint()
  }
}
