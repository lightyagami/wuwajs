...
const Log_1 = require("../../../../../Core/Common/Log"),
  ...
  DAILY_TIME_FLAG = (exports.rewardStateResolver = {
...
class ActivityDailyAdventureData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.ProgressPoint = 0, this.QNe = new Map, this.XNe = new Map
  }
  SetProgressPoint(t) {
    this.ProgressPoint = t;
    for (const e of this.QNe.values()) e.RefreshState(2 === e.RewardState, this.ProgressPoint)
  }
  PhraseEx(t) {
    ...
    if (e) {
      ...
      var i = t.jps;
      if (i) {
        this.ProgressPoint = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(ActivityDailyAdventureDefine_1.DAILY_ADVENTURE_PT_CONFIGID), this.XNe.clear();
        for (const n of i._Ms) {
          var r = new ActivityDailyAdventureDefine_1.DailyAdventureTaskData;
          r.TaskId = n.s5n, r.CurrentProgress = n.lMs, r.TargetProgress = n.j6n, r.TaskState = exports.rewardStateResolver[n.H6n], this.XNe.set(n.s5n, r), Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 37, "[日常探险活动] 任务信息打印", ["TaskId", n.s5n], ["State", r.TaskState])
        }
    ...
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[日常探险活动] 活动数据未找到", ["ActivityId", this.Id])
  }
  $Ne(t) {
    this.QNe.clear();
    for (const r of t) {
      var e = ConfigManager_1.ConfigManager.ActivityDailyAdventureConfig.GetDailyAdventurePointConfig(r),
        i = (e || Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[日常探险活动] 积分奖励数据不存在", ["Id", r]), new ActivityDailyAdventureDefine_1.DailyAdventureRewardData);
  ...
  SetTaskInfo(t, e, i) {
    t = this.XNe.get(t);
    t && (void 0 !== e && (t.TaskState = e), void 0 !== i) && (t.CurrentProgress = i)
  }
  GetDefaultMapMarkId() {
  ...
  IsTaskHasReward() {
    for (const t of this.XNe.values())
      if (0 === t.TaskState) return !0;
    return !1
  }
  IsPointHasReward() {
    for (const t of this.QNe.values())
      if (0 === t.RewardState) return !0;
    return !1
  }
  IsDailyTips() {
  ...
  ReadDailyTips() {
    ...
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, DAILY_TIME_FLAG, 0, 0, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  YNe() {
    let t = !0;
