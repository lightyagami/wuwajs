...
class DockyardBackpackData {
  constructor(a) {
    this.v$l = new Map, this.y$l = [], this.S$l = new Map, this.M$l = void 0, this.E$l = [], this.I$l(a), this.T$l(), this.b$l()
  }
  I$l(a) {
    a && 0 < (a = ModelManager_1.ModelManager.DockyardModel.GetQuicklySellId()) && (this.M$l = new DockyardQuicklySellData_1.DockyardQuicklySellData(a))
  }
  T$l() {
    ...
    for (let e = 0; e < FishingDefine_1.BACKPACK_ROW_COUNT; e++) {
      ...
      for (let a = 0; a < FishingDefine_1.BACKPACK_COL_COUNT; a++) {
        ...
        r?.SetIsQuicklySell(s), 1 === t.FillState[e].ArrayInt[a] ? r?.SetGridType(1) : r?.SetGridType(0), this.E$l.push(i), this.y$l[e].push(i), this.v$l.set(i, r)
      }
    }
  }
  _X_() {
    for (let e = 0; e < FishingDefine_1.BACKPACK_ROW_COUNT; e++)
      for (let a = 0; a < FishingDefine_1.BACKPACK_COL_COUNT; a++) this.v$l.get(this.y$l[e][a])?.SetItemBlockId(FishingDefine_1.UNVALID_ITEM_BLOCK_ID)
  }
  b$l() {
    this.S$l.clear();
  ...
  L$l(t) {
    ...
    for (let e = i.RowStartIndex; e <= i.RowEndIndex; e++)
      for (let a = i.ColStartIndex; a <= i.ColEndIndex; a++) e < 0 || e >= FishingDefine_1.BACKPACK_ROW_COUNT || a < 0 || a >= FishingDefine_1.BACKPACK_COL_COUNT || this.v$l.get(this.y$l[e][a])?.SetItemBlockId(t.Data.IncId)
  }
  TO_() {
  ...
  RefreshQuicklySellOpen(a) {
    a ? (a = ModelManager_1.ModelManager.DockyardModel.GetQuicklySellId(), this.M$l = new DockyardQuicklySellData_1.DockyardQuicklySellData(a), this.TO_()) : this.bO_()
  }
  GetBackpackDataList() {
    return this.E$l
  }
