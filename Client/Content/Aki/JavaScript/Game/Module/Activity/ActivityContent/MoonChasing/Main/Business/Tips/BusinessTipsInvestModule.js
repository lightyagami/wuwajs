...
class BusinessTipsInvestModule extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.NumberSelect = void 0, this.roa = void 0, this.QGe = e => {
      var r = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetInvestData(e);
      this.GetText(0).SetText(r.SuccessProbability.toString()), this.GetText(1).SetText(r.Ratio.toString()), this.roa.SetText(e.toString())
    }, this.Jke = () => {
      var e = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetInvestData(0),
        r = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetResultData();
      ...
      var e = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetResultData(),
        ...
        a = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetInvestData(r),
        n = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetInvestData(0);
  ...
  OnStart() {
    var e = ConfigManager_1.ConfigManager.BusinessConfig.GetCoinItemId(),
      e = (this.SetItemIcon(this.GetTexture(5), e), this.roa = this.GetText(6), ModelManager_1.ModelManager.MoonChasingBusinessModel.GetResultData()),
      e = ConfigManager_1.ConfigManager.BusinessConfig.GetDelegationConfig(e.EntrustId),
      r = ModelManager_1.ModelManager.MoonChasingModel.GetCoinValue(),
      e = r > e.InvestLimit ? e.InvestLimit : r,
      r = (this.NumberSelect = new NumberSelectComponent_1.NumberSelectComponent(this.GetItem(2)), this.NumberSelect.SetLimitMaxValueForce(e), {
        MaxNumber: e,
