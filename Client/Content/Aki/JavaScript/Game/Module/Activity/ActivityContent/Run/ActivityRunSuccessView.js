...
class ActivityRunSuccessView extends UiViewBase_1.UiViewBase {
  ...
  async ZFe() {
    ...
    e.SetBtnText("Leave"), e.SetFloatText("InstanceDungeonLeftTimeToAutoLeave", LEAVETIME.toString()), i.SetBtnText("ChallengeAgain")
  }
  async i3e(e, i, t) {
  ...
  t3e() {
    this.GetItem(12).SetUIActive(!0), this.GetItem(13).SetUIActive(!0), this.GetText(14).SetUIActive(!1);
    var e = this.GetTexture(2),
      e = (e.SetColor(UE.Color.FromHex(SUCCESS_OUTLINE_COLOR)), this.SetTextureByPath(TARGET_ICON_PATH, e), this.GetText(1));
    e.SetColor(UE.Color.FromHex("FFFFFFFF")), e.ShowTextNew("GenericPromptTypes_3_GeneralText")
  }
  l3e() {
