...
class AvignonModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.BSc = void 0
  }
  OnInit() {
    return this.BSc = new AvignonProtocolData_1.AvignonProtocolData, !0
  }
  AvignonInfoUpdate(e) {
    for (const n of this.wja()) {
      var t = n;
      e.T$s && t.UpdateTask(e.T$s), e.hfc && t.UnlockStage(e.hfc)
    }
  ...
  ReadRedDot() {
    ...
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(e, AVIGNON_RED_DOT_CACHE_KEY, 0, 0, 1), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, e)
  }
  SaveNewStageFlag(e) {
    var t;
    this.GetAvignonStageInfo(e)?.HasNewStageFlag() && (t = this.GetAvignonActivityId(), ModelManager_1.ModelManager.ActivityModel.SaveActivityData(t, e, 0, 0, 1), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, t))
  }
  CheckRedDot() {
    var e = this.GetAvignonActivityId();
    if (0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(e, 0, AVIGNON_RED_DOT_CACHE_KEY, 0, 0)) return !0;
