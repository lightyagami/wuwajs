...
class ActivityMapExploreData extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(t) {
    ...
    if (e) {
      ...
      this.IsFirstUnlockState(0) && this.CanPreOpen() && this.SetFirstUnlockState(1), this.UpdateTaskState(e.E$s)
    }
  }
  UpdateTaskState(t) {
    if (t) {
      for (const o of this.TaskList) {
        ...
        e && (o.IsComplete = e === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskTaken, o.IsCanGet = e === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskFinish, o.IsRunning = !o.IsComplete && !o.IsCanGet)
      }
      this.aoc(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ActivityMapExploreStateUpdate)
    }
  }
  aoc() {
