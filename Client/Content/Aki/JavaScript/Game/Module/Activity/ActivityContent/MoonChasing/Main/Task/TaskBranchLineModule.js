...
class BranchLineItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Pe = void 0, this.TAn = () => {
      var e = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(this.Pe.TaskId);
      0 === e ? this.jpa(this.Pe.JumpBuildingId) : 1 === e ? ControllerHolder_1.ControllerHolder.QuestNewController.TryTrackAndOpenWorldMap(this.Pe.TaskId) : 2 === e && UiManager_1.UiManager.OpenView("QuestView", this.Pe.TaskId), ModelManager_1.ModelManager.MoonChasingModel.ReadQuestIdUnlockFlag(this.Pe.TaskId) && this.BNe()
    }
  }
  OnRegisterComponent() {
  ...
  jpa(e) {
    if (3 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(this.Pe.TaskId)) ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("MoonChasingTaskJumpToBuildingFinish");
    else if (e <= 0) {
      ...
      r.SetTextArgs(i), r.FunctionMap.set(2, () => {
  ...
  _Oe() {
    var e = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(this.Pe.TaskId);
    this.GetItem(2).SetUIActive(0 === e), 0 === e ? this.GetTexture(5).SetColor(UE.Color.FromHex("#8C836DFF")) : this.GetTexture(5).SetColor(UE.Color.FromHex("#FFFFFFFF")), this.GetItem(1).SetUIActive(3 === e)
  }
  Aqe() {
  ...
  BNe() {
    var e;
    this.Pe && (e = ModelManager_1.ModelManager.MoonChasingModel.CheckQuestIdRedDotState(this.Pe.TaskId), this.GetItem(4).SetUIActive(e))
  }
  Refresh(e, i, r) {
...
class TaskBranchLineModule extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.qUt = void 0, this.Jva = 0, this.tue = [], this.Lbt = !0, this.DAn = () => new BranchLineItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  async OnBeforeStartAsync() {
    ...
    this.tue = [...e], await this.qUt.RefreshByDataAsync(this.tue.sort((e, i) => {
      var r = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e.TaskId),
        t = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(i.TaskId);
      return 2 === r && 2 !== t ? -1 : 2 !== r && 2 === t ? 1 : 0 === r && 0 !== t ? -1 : 0 !== r && 0 === t ? 1 : e.TaskId - i.TaskId
    }))
  }
  OnBeforeShow() {
    this.qUt.BindLateUpdate(e => {
      this.Lbt ? this.Lbt = !1 : (0 !== this.Jva && this.qUt.ScrollToLeft(this.Jva), this.qUt.UnBindLateUpdate())
    })
  }
  SetSelectTaskId(e) {
    this.Jva = e
    ...
    if (void 0 !== this.qUt) {
      ...
      if (1 < e.length) {
        ...
        for ([r, t] of ConfigManager_1.ConfigManager.TaskConfig.GetAllBranchLineTask().entries())
          if (1 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(t.TaskId)) {
            e = r;
            break
          } if (e < 0) return;
