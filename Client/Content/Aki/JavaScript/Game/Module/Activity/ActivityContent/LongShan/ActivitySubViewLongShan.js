...
class ActivitySubViewLongShan extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.ActivityBaseData = void 0, this.CommonInfoPanel = void 0, this.StageItems = void 0, this.bNn = !1, this.UOe = () => {
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SetActivityViewState, !1, 0)
    }, this.AOe = () => {
      this.StageItems?.forEach(t => {
        t.RefreshState()
      }), this.GetButton(3).RootUIComp.SetUIActive(0 <= this.ActivityBaseData.StageIds.findIndex(t => void 0 === this.ActivityBaseData.GetStageInfoById(t))), this.BNe()
    }, this.POe = () => {
      ...
      ActivityLongShanController_1.ActivityLongShanController.GetActivityData().GetStageInfoById(t) ? (this.bNn = !0, UiManager_1.UiManager.OpenView("LongShanView", t)) : ActivityLongShanController_1.ActivityLongShanController.ShowUnlockTip(t)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.CommonInfoPanel = new ActivitySubViewGeneralInfo_1.ActivitySubViewGeneralInfo, this.CommonInfoPanel.SetData(this.ActivityBaseData), this.AddChild(this.CommonInfoPanel);
    ...
    for (const e of this.ActivityBaseData.StageIds) {
      ...
      i.OnClickStageDetail = this.wOe, this.AddChild(i), t.push(i.OnlyCreateByActorAsync(this.GetItem(4 + this.StageItems.length).GetOwner())), this.StageItems.push(i)
    }
    await Promise.all(t)
  }
  OnAddEventListener() {
  ...
  OnBeforeShow() {
    this.CommonInfoPanel?.SetBtnText("LongShanStage_Join"), this.CommonInfoPanel?.SetClickFunc(this.UOe), this.BNe()
  }
  async OnBeforeHideSelfAsync() {
    this.bNn && await this.LevelSequencePlayer.PlaySequenceAsync("TransOut", new CustomPromise_1.CustomPromise, !0)
  }
  OnTimer(t) {
    this.FNe()
  }
  OnRefreshView() {
    this.FNe(), this.CommonInfoPanel?.OnRefreshView(), this.AOe(), this.bNn && (this.LevelSequencePlayer.PlayLevelSequenceByName("TransIn", !0), this.bNn = !1)
  }
  OnCommonViewStateChange(t) {
    this.PlaySubViewSequence(t ? "SwitchOut" : "SwitchIn", !0)
  }
  OnSequenceStart(t) {
    "Start" === t || "SwitchOut" === t ? this.vBn(!1) : "SwitchIn" === t && (this.vBn(!0), this.StageItems) && UiNavigationNewController_1.UiNavigationNewController.SetNavigationFocusForView(this.StageItems[0].GetLongShanButton(), !0)
  }
  vBn(t) {
