...
class DockyardShopPlotPanel extends UiPanelBase_1.UiPanelBase {
  ...
  Xh_() {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.Title), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.Content)
  }
  Yh_(e) {
    var i, t = ModelManager_1.ModelManager.CreatureModel.GetEntityIdByPbDataId(this.EntityId),
      t = ModelManager_1.ModelManager.CreatureModel.GetEntityById(t);
    t && (i = t?.Entity?.GetComponent(186), t = t?.Entity?.GetComponent(44), i?.PlayPerformMontage(2, {
  ...
  zh_() {
    ...
    e - this.$h_ < COOLDOWN_TIME || (this.$h_ = e, e = ConfigManager_1.ConfigManager.FishingConfig.GetFishingNpcPerform(this.Kh_), this.Yh_(e.MontagePath), this.XZi(e.AudioEvent))
  }
  bl() {
    this.Xh_(), this.zh_()
  }
