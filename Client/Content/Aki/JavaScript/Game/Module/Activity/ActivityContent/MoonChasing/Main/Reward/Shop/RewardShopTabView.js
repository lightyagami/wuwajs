...
class RewardShopTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.LoopScrollView = void 0, this.t3i = (e, i, r) => {
      ...
      }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Shop", 10, "PayShop:RewardShopTabView 商品VersionCode不同步,打开弹窗")
    }, this.sGe = () => {
  ...
  async OnShowAsyncImplementImplement() {
    ...
    await this.LoopScrollView.RefreshByDataAsync(e, !1, !0), ModelManager_1.ModelManager.MoonChasingRewardModel.ReadShopItemCheckFlag(e)
  }
  OnBeforeShow() {
