...
class DangoMonopolyRoundShowView extends DangoMonopolyViewBase_1.DangoMonopolyViewBase {
  constructor() {
    super(...arguments), this.OpenParam = void 0, this.et1 = () => {
  ...
  OnStart() {
    this.GetText(0).SetText(this.OpenParam?.TipsText ?? ""), TimerSystem_1.TimerSystem.Delay(this.et1, this.OpenParam.ShowTime)
  }
  OnAfterPlayStartSequence() {
    this.Rk1()
  }
  async Rk1() {
    await this.OpenPromise?.Promise, await TimerSystem_1.TimerSystem.Wait(TimerSystem_1.MIN_TIME), this.CloseMe()
  }
  OnBeforeDestroy() {
