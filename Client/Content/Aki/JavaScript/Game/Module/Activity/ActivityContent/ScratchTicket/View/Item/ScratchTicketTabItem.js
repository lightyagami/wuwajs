...
class ScratchTicketTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.rnl = void 0, this.yQa = void 0, this.UiLevelSequence = void 0, this.onl = () => {
  ...
  OnBeforeCreateImplement() {
    this.UiLevelSequence = new UiViewSequence_1.UiBehaviorLevelSequence(this), this.AddUiBehavior(this.UiLevelSequence), this.GetExtendToggle(0).CanExecuteChange.Bind(() => 0 === this.GetExtendToggle(0).GetToggleState())
  }
  Refresh(t, e, i) {
    this.rnl = t, this.SetSpriteByPath(t.Config.TogRoundIcon, this.GetSprite(1), !1, void 0);
    t = t.GetRoundState();
