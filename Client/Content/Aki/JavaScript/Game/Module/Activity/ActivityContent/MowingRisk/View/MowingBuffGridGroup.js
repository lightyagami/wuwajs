...
class MowingBuffGridGroup extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Tei = void 0, this.l9a = () => new MowingBuffGridItem
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.Tei = new GenericLayout_1.GenericLayout(this.GetGridLayout(1), this.l9a, void 0)
  }
  OnBeforeDestroy() {
    this.Tei.UnBindLateUpdate()
  }
  async RefreshAsync(e, t, i) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.GroupNameTextId), await this.Tei.RefreshByDataAsync(e.BuffItemList)
  }
...
class MowingBuffGridItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this._9a = void 0, this.BZa = void 0, this.Ouo = void 0, this.eTt = () => {
      ModelManager_1.ModelManager.MowingRiskModel.CurrentChosenOverviewBuffId = this._9a.BuffId, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MowingBasicBuffGridItemClick)
  ...
  async OnBeforeStartAsync() {
    ...
    await Promise.all([i, s]), e.SetUiActive(!1), t.SetUiActive(!1), this.BZa = e, this.Ouo = t, this.GetText(2)?.SetUIActive(!1)
  }
  OnStart() {
  ...
  PlayUnlockEffect() {
    var e = ModelManager_1.ModelManager.MowingRiskModel,
      e = (e.RecordBuffId(this._9a.BuffId), e.GetBuffTypeByBuffId(this._9a.BuffId));
    let t = void 0;
    switch (e) {
      case 1:
        t = 7;
...
class MowingBuffLevelPanel extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    this.GetSprite(0)?.SetUIActive(!1), this.GetSprite(5)?.SetUIActive(!1), this.GetItem(3)?.SetUIActive(!1)
  }
  RefreshByLevelContent(e) {
    var t = this.GetItem(1);
    void 0 === e ? t?.SetUIActive(!1) : (t?.SetUIActive(!0), this.GetText(2)?.SetText(e))
  }
}
