...
class FarmGoldSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.jwl = void 0, this.Q6a = void 0, this.lRo = () => {
      this.R2e()
    }, this.R2e = () => {
      ...
      0 < i ? UiManager_1.UiManager.OpenView("QuestView", i) : (i = {
  ...
  async OnBeforeStartAsync() {
    this.Q6a = new ActivitySubViewGeneralInfo_1.ActivitySubViewGeneralInfo, this.Q6a.SetData(this.ActivityBaseData), this.Q6a.SetClickFunc(this.DFe), this.Q6a.SetRewardButtonFunction(this.R2e), await this.Q6a.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  OnStart() {
    this.jwl = this.ActivityBaseData
  }
  OnBeforeShow() {
    0 < this.ActivityBaseData.GetUnFinishPreGuideQuestId() ? this.Q6a.SetBtnText("FarmGoldEnterText") : this.Q6a.SetBtnText("PrefabTextItem_2701983798_Text"), this.Zl_(), RedDotController_1.RedDotController.BindRedDot("FarmGoldReward", this.GetItem(2), void 0, this.ActivityBaseData?.Id)
  }
  OnRefreshView() {
    this.BNe()
  }
