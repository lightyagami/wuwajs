...
class ConsumeItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ETt = 0, this.eTt = () => {
  ...
  Refresh(e) {
    ...
    this.GetText(1)?.SetText(t.toString()), this.SetItemIcon(this.GetTexture(0), e)
  }
}
class DockyardStatePanel extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    await Promise.all([this.InitConsumeItem(FishingDefine_1.FISHING_ENTRUST_ITEMID, this.GetItem(0)), this.InitConsumeItem(FishingDefine_1.BOMB_ITEMID, this.GetItem(1)), this.InitConsumeItem(FishingDefine_1.BAIT_ITEMID, this.GetItem(2))]), this.InitSkillText(), this.InitSpeedText()
  }
}
