...
class DangoMonopolyResultRoundItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.fGt = void 0, this.ClickCallBack = void 0, this.kqe = t => {
  ...
  Refresh(t, s) {
    this.fGt = t, this.GetText(1)?.SetText(this.fGt.GetPosition().toString()), this.GetSelfToggle()?.SetToggleState(s ? 1 : 0)
  }
  OnSelected() {
