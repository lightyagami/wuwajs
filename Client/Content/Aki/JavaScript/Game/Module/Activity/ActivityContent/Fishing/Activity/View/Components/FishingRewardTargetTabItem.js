...
class FishingRewardTargetTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.pua = void 0, this.vua = -1, this.Mua = () => {
  ...
  Refresh(t, s, e) {
    this.pua = t, this.vua = t.Index, t.NameTextId && this.GetText(0)?.ShowTextNew(t.NameTextId), this.RefreshRedDot()
  }
}
