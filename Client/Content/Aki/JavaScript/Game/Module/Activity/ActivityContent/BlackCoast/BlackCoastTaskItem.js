...
class BlackCoastTaskItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(i, t, e) {
    ...
    var s = 2 === i.Status,
      r = 0 === i.Status,
      o = 1 === i.Status;
    this.GetButton(1).RootUIComp.SetUIActive(r), this.GetItem(3).SetUIActive(s), this.GetItem(2).SetUIActive(o && 0 === i.JumpId), this.GetButton(0).RootUIComp.SetUIActive(o && 0 < i.JumpId), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), i.TitleTextId), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), "BlackCoastTheme_TaskProgress", i.Current, i.Target)
  }
}
