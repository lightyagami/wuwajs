...
class CumulativeShopController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(20212, CumulativeShopController.ConsumptiveTaskInfoNotify);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(20212);
  }
  static ConsumptiveRewardRequest(e) {
    var t = Protocol_1.Aki.Protocol.Fm1.create();
    t.w6n = this.ActivityId;
    t.gps = e;
    Net_1.Net.Call(26689, t, t => {
      if (t) {
        if (t.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.Q4n, 22484);
        }
