...
class ActivityRegressMainCaptionListPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.TabTitle = void 0, this.Nbt = void 0, this.Ivt = void 0, this.xqe = void 0, this.pqe = t => {
      var i = this.Nbt.GetCommonData(t);
      i && (this.TabTitle.UpdateIcon(i.GetSmallIcon()), this.TabTitle.UpdateTitle(i.GetTitleData())), this.Nbt.ToggleCallBack(t)
    }, this.R6e = (t, i) => {
  ...
  async OnBeforeStartAsync() {
    ...
    this.TabTitle = new ActivityRegressMainTabTitlePanel_1.ActivityRegressMainTabTitlePanel, await this.TabTitle.CreateThenShowByActorAsync(t)
  }
  BindTabTitleCallBack(t) {
    this.TabTitle.OnBackBtnCallBack = t
  }
  OnStart() {
    this.xqe = this.GetScrollViewWithScrollbar(1), this.Ivt = new TabComponent_1.TabComponent(this.xqe.ContentUIItem, this.R6e, this.pqe, void 0)
  }
  OnBeforeDestroy() {
