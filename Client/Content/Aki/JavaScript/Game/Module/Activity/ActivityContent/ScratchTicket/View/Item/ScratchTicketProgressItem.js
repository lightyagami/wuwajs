...
class ScratchTicketProgressItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, s, r) {
    var e = t.GetRoundState(),
      ...
      i = (i.SetChangeColor(1 !== e, i.changeColor), this.GetItem(2).SetUIActive(0 === e), this.GetItem(3).SetUIActive(2 === e), this.GetSprite(4)),
      o = this.GetSprite(5);
    i.SetUIActive(1 === e), this.SetSpriteByPath(t.Config.YellowRoundIcon, i, !1, void 0), o.SetUIActive(1 !== e), this.SetSpriteByPath(t.Config.BlackRoundIcon, o, !1, void 0)
  }
}
