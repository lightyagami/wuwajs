...
class ActivityRegressSignPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.LNe = void 0, this.oma = [], this.sma = void 0, this.$pt = void 0, this.kOe = e => {
      this.mGe()
    }, this.u6e = e => {
  ...
  async OnBeforeStartAsync() {
    ...
    var e = this.GetItem(0),
      i = [this.GetItem(1), this.GetItem(2), this.GetItem(3), this.GetItem(4), this.GetItem(5), this.GetItem(6), this.GetItem(7)];
    await Promise.all([this.LNe.CreateThenShowByActorAsync(e.GetOwner()), i.map(async e => {
      ...
      i.RegisterItemClickCallBack(this.u6e), await i.CreateThenShowByActorAsync(e.GetOwner()), this.oma.push(i)
    })]), this.sma = TimerSystem_1.RealTimeTimerSystem.Forever(this.kOe, TimeUtil_1.TimeUtil.InverseMillisecond), this.$pt = new UiSequencePlayer_1.UiSequencePlayer(this.GetRootItem())
  }
  OnBeforeShow() {
  ...
  OnBeforeDestroy() {
    this.jm(), ModelManager_1.ModelManager.ActivityRegressModel.ClearSignRewardConfig()
  }
  RefreshView() {
    ModelManager_1.ModelManager.ActivityRegressModel.SetupSignRewardConfig(), this.mGe(), this.ama()
  }
  mGe() {
