...
class MowingBuffNewBuffTipsView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.rcr = void 0, this._9a = void 0, this.lRe = void 0
  }
  RefreshMainTypeIconTexture() {
    this.GetTexture(0)?.SetUIActive(!1)
  }
  RefreshItemNameText() {
    this.GetText(1)?.SetColor(this.lRe), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), this._9a.NameTextId)
  }
  ...
  RefreshQualityNiagara() {
    ...
    ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.NiagaraSystem, e => {
      var i;
      e && UiManager_1.UiManager.IsViewOpen("NewItemTipsView") && this.RootItem && ((i = this.GetUiNiagara(5)).SetNiagaraSystem(e), !this._9a.IsGolden) && this.lRe && (i.ColorParameter.Get("Color").Constant = UE.LinearColor.FromSRGBColor(this.lRe))
    })
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    void 0 === this.OpenParam ? this.CloseMe() : (this._9a = this.OpenParam, this.lRe = UE.Color.FromHex(this._9a.NameHexColor), this.RefreshMainTypeIconTexture(), this.RefreshItemNameText(), this.RefreshItemIconTexture(), this.RefreshItemDescribeText(), this.RefreshQualityTexture(), this.RefreshQualityNiagara())
  }
  async OnBeforeStartAsync() {
    return this.rcr = new UiSequencePlayer_1.UiSequencePlayer(this.RootItem), Promise.resolve()
  }
  OnAfterShow() {
    this.n$a()
  }
  ...
  async n$a() {
    await this.rcr.LitePlayAsync(this._9a.IsGolden ? "Golden" : "Start01"), this.CloseMe()
  }
}
