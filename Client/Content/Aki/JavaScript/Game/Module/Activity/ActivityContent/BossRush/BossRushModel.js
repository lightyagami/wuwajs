...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.BossRushModel = exports.BossRushTeamInfo = exports.BossRushBuffInfo = exports.BossRushRoleInfo = void 0;
...
class BossRushBuffInfo {
  constructor() {
    this.BuffId = 0, this.Slot = 0, this.ChangeAble = !0, this.State = Protocol_1.Aki.Protocol.Iks.Proto_BuffEmpty
  }
}
exports.BossRushBuffInfo = BossRushBuffInfo;
class BossRushTeamInfo {
  constructor() {
    this.ActivityId = 0, this.uyn = void 0, this.tyn = [], this.cyn = [], this.myn = [], this._ll = [], this.ull = [], this.cll = [], this.dyn = [], this.LevelInfo = void 0
  }
  ...
  InitLevelBuff(e, t, s, r, o) {
    ...
    for (const n of e) {
      ...
      e.BuffId = n.BuffId, e.Slot = n.Slot, e.ChangeAble = n.ChangeAble, e.State = n.State, this.tyn.push(e)
    }
    ...
    for (const u of r) {
      const e = new BossRushBuffInfo;
      e.BuffId = u.BuffId, e.Slot = u.Slot, e.ChangeAble = u.ChangeAble, e.State = u.State, this._ll.push(e)
    }
  ...
  GetOptionBuff() {
    var e = [];
    if (0 === ModelManager_1.ModelManager.BossRushModel.CurrentSelectBuffTabName)
      for (const t of this.cyn)(0 < t.BuffId && t.State === Protocol_1.Aki.Protocol.Iks.Proto_BuffLocked || t.Slot < 0) && -1 === e.findIndex(e => e.BuffId === t.BuffId) && e.push(t);
    else
      for (const s of this.ull) - 1 === e.findIndex(e => e.BuffId === s.BuffId) && e.push(s);
    return e
  }
  ...
  GetIfLevelTooLow() {
    ...
    for (const r of this.dyn) {
      var s = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(r),
        s = (s && (e += s.GetLevelData().GetLevel(), t++), ModelManager_1.ModelManager.RoleModel.GetRoleDataById(r));
...
class BossRushModel extends ModelBase_1.ModelBase {
  ...
  CheckInBossRush() {
    return 20 === ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(ModelManager_1.ModelManager.CreatureModel.GetInstanceId())?.InstSubType && ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()
  }
}
