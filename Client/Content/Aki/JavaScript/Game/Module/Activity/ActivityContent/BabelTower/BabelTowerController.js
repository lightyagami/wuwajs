...
class BabelTowerController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.Gec = e => {
      var t = BabelTowerController.GetBabelTowerData();
      for (const r of e.QX_)(ConfigManager_1.ConfigManager.BabelTowerConfig.GetBabelTowerLevelConfig(r.ELl).IsDifficult ? t.HardLevelDataMap : t.NormalLevelDataMap).set(r.ELl, r), t.RoleLockData.set(r.ELl, r.FX_);
      ...
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BabelTowerRefreshQuestState), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, t.Id)
    }, this.Hec = e => {
      var t = BabelTowerController.GetBabelTowerData();
      ...
      if (a) {
        ...
        if (l && T) i = {
          ...
          if (l) {
            ...
            var s = [],
              r = ModelManager_1.ModelManager.TrainingDegreeModel.GetTrainingDataList();
            if (r)
              for (const e of r) {
                var _ = {
                  TrainingData: e
          ...
          o = [], l = (o.push({
            ...
            OnClickedCallback: e => {
              ...
              }, UiManager_1.UiManager.OpenView("BabelTowerHardLevelChoseView", t)) : (t = {
                IfReturnToBabelTowerMainView: !0,
                IfLeaveInstanceDungeonWhenMainViewClose: !0
          ...
          l && (o.push({
            ...
            OnClickedCallback: () => {
              ...
              if (t && 1 === t) {
                ...
                v.IsDifficult ? UiManager_1.UiManager.OpenView("BabelTowerHardLevelInfoView", t) : UiManager_1.UiManager.OpenView("BabelTowerLevelInfoView", t)
              } else BabelTowerController.ReChallengeBabelTower()
            }
          }), e.StateToggle = {
            DescriptionTextId: "Text_ChangeFormation_Text"
          }), e.ButtonInfoList = o, ItemRewardController_1.ItemRewardController.OpenExploreRewardViewNew(e)
        }
      }
    }, this.p_c = e => {
  ...
  OnCreateActivityData(e) {
    return BabelTowerController.ActivityId = e.s5n, new BabelTowerData_1.BabelTowerData
  }
  OnGetIsOpeningActivityRelativeView() {
    return !1
  }
  OnRegisterNetEvent() {
    Net_1.Net.Register(15299, this.Gec), Net_1.Net.Register(26507, this.Nec), Net_1.Net.Register(26480, this.Vec), Net_1.Net.Register(24209, this.jec), Net_1.Net.Register(22769, this.Hec), Net_1.Net.Register(29750, this.$ec), Net_1.Net.Register(28467, this.p_c), Net_1.Net.Register(21486, this.mbc)
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(15299), Net_1.Net.UnRegister(26507), Net_1.Net.UnRegister(26480), Net_1.Net.UnRegister(24209), Net_1.Net.UnRegister(22769), Net_1.Net.UnRegister(29750), Net_1.Net.UnRegister(28467), Net_1.Net.UnRegister(21486)
  }
  OnAddEvents() {}
  OnRemoveEvents() {}
  static async SelectBabelActivityDeTermRequest(e, t) {
    var r = Protocol_1.Aki.Protocol.BX_.create(),
      e = (r.eY_ = e, r.GX_ = t, await Net_1.Net.CallAsync(20546, r));
  ...
  static BabelTowerTaskRewardRequest(e) {
    ...
    t.gps = e, Net_1.Net.Call(15120, t, e => {
      e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 22673)
    })
  }
  static BabelTowerDailyTaskRewardRequest(e) {
    var t = Protocol_1.Aki.Protocol.LX_.create();
    t.gps = e, Net_1.Net.Call(29558, t, e => {
      e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23721)
    })
  }
  static ResetBabelTowerLevelRequest(e) {
    var t = Protocol_1.Aki.Protocol.RX_.create();
    t.eY_ = e, Net_1.Net.Call(29376, t, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 25620) : ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId("BabelTowerResetLevelTips"))
    })
  }
  static BabelTowerSettlementRequest() {
    var e = Protocol_1.Aki.Protocol.xX_.create();
    Net_1.Net.Call(29320, e, e => {
      e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26255)
    })
  }
  ...
  static BabelTowerStartRequest(e, t, r, o) {
    ...
    ModelManager_1.ModelManager.InstanceDungeonModel.InstanceEnterContentText.iY_ = r, ControllerHolder_1.ControllerHolder.InstanceDungeonController.PrewarTeamFightRequest(e, t, 0, 0).then(e => {
      e && (ModelManager_1.ModelManager.BabelTowerModel.CurrentSelectLevel = 0)
    })
  }
  ...
  static SaveNewLevelData(e) {
    ...
    t.set(e, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.BabelTowerNewLevel, t)
  }
