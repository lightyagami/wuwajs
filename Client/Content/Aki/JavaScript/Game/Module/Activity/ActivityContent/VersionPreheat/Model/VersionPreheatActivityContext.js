...
class VersionPreheatActivityContext extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("VersionPreheat", 64, "解析活动数据", ["ActivityData", t]);
    t = t.$S_;
    if (void 0 !== t) {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("VersionPreheat", 64, "解析活动数据:[具体]", ["ActivityInfo", t]), this.E_l.clear();
