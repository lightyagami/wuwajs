...
class SolarSpeedConfigContext extends ActivityData_1.ActivityBaseData {
  constructor(e) {
    super(), this.i5l = void 0, this.p3_ = void 0, this.v3_ = void 0, this.y3_ = void 0, this.S3_ = void 0, this.i5l = e
  }
  get CurrentCfgCache() {
  ...
  M3_() {
    ...
    for (const e of TeamParKOurCfgAll_1.configTeamParKOurCfgAll.GetConfigList()) e.ActivityId === this.i5l.CurrentActivityId && (this.p3_.set(e.Id, e), this.y3_.set(e.InstId, e.Id))
  }
  E3_() {
    this.v3_ = new Map;
    for (const e of TeamParKOurRewardAll_1.configTeamParKOurRewardAll.GetConfigList()) e.ActivityId === this.i5l.CurrentActivityId && this.v3_.set(e.Id, e)
  }
  Dispose() {
  ...
  GetTitleTextIdById(e) {
    ...
    if (void 0 !== e) return InstanceDungeonById_1.configInstanceDungeonById.GetConfig(e)?.MapName
  }
  GetRomePathById(e) {
    e = this.CurrentCfgCache.get(e)?.InstId;
    if (void 0 !== e) return InstanceDungeonById_1.configInstanceDungeonById.GetConfig(e)?.DifficultyIcon
  }
  GetTaskListById(e) {
    return e === SolarSpeedDefine_1.SOLAR_SPEED_BONUS_LEVEL_ID ? SolarSpeedDefine_1.bonusRewardList : this.CurrentCfgCache.get(e)?.TaskList ?? []
  }
