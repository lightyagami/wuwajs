...
class FightPhotoFocusView extends UiViewBase_1.UiViewBase {
  ...
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnNeedShowFightPhotoFocus, this.mOd);
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnNeedShowFightPhotoFocus, this.mOd);
  }
  OnBeforeShow() {
