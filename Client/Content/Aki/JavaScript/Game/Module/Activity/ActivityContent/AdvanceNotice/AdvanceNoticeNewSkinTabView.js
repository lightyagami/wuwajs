...
exports.AdvanceNoticeNewSkinTabView = undefined;
const UE = require("ue");
const ConfigManager_1 = require("../../../../Manager/ConfigManager");
const LguiUtil_1 = require("../../../Util/LguiUtil");
const AdvanceNoticeTabViewBase_1 = require("./AdvanceNoticeTabViewBase");
class AdvanceNoticeNewSkinTabView extends AdvanceNoticeTabViewBase_1.AdvanceNoticeTabViewBase {
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UITexture], [1, UE.UIText], [2, UE.UIText], [3, UE.UIText]];
  }
  RefreshView() {
    var e = this.ViewModel.CurrentSubTabId;
    var e = ConfigManager_1.ConfigManager.AdvanceNoticeConfig.GetAdvertisingTabCostumeById(e);
...
exports.AdvanceNoticeNewSkinTabView = AdvanceNoticeNewSkinTabView;
//# sourceMappingURL=AdvanceNoticeNewSkinTabView.js.map