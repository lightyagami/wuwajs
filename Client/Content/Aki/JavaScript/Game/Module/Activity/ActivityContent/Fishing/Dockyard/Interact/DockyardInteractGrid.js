...
class DockyardInteractGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(i) {
    super(), this.DXl = void 0, this.i0o = void 0, this.R$l = void 0, this.P$l = 0, this.U$l = () => {
  ...
  Refresh(i) {
    this.DXl = this.R$l.GetInteractGridData(i), this.ShowType = this.DXl.IsFinish ? 6 : 1
  }
  RefreshBgSprite(i) {
    i ? this.DXl.IsFinish ? this.ShowType = 4 : this.ShowType = 6 : this.ShowType = 3
  }
  ResetPreviewBg() {
