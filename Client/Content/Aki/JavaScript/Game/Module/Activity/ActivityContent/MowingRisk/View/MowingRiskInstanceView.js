...
class MowingRiskInstanceView extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.G9a = void 0, this.k9a = () => {
  ...
  async OnBeforeStartAsync() {
    await this.F9a(), RedDotController_1.RedDotController.BindRedDot("RedDotMowingRiskBuffAll", this.GetItem(5)), RedDotController_1.RedDotController.BindRedDot("RedDotMowingRiskReward", this.GetItem(7))
  }
  OnBeforeDestroy() {
    RedDotController_1.RedDotController.UnBindGivenUi("RedDotMowingRiskBuffAll", this.GetItem(5)), RedDotController_1.RedDotController.UnBindGivenUi("RedDotMowingRiskReward", this.GetItem(7))
  }
  OnStart() {
    this.V9a(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MowingRiskOnRefreshRewardRedDot)
  }
  async RefreshExternalAsync() {
    var e = ModelManager_1.ModelManager.MowingRiskModel,
      ...
      i = (await this.G9a.RefreshExternalByDataAsync(i), e.BuildInstanceRecommendDataByInstanceId(e.CurrentInstanceId));
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), i.TextId, i.TextArgs), this.GetText(8)?.SetText(e.BuildInstanceTotalScore())
  }
  RefreshOnTick() {
    var e = ModelManager_1.ModelManager.MowingRiskModel,
  ...
  async F9a() {
    ...
    await e.CreateThenShowByActorAsync(this.GetItem(0).GetOwner()), this.G9a = e
  }
  V9a() {
