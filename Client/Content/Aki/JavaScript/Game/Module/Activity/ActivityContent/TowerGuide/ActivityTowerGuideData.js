...
class ActivityTowerGuideData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.TowerDifficultIdList = [1, 2], this.i4e = new Map, this.o4e = new Map, this.TrialRoleId = 0, this.MapMarkId = 0
  }
  PhraseEx(e) {
  ...
  RefreshRewardState(e) {
    var t = this.r4e(e);
    this.i4e.set(e, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  r4e(e) {
    return this.IsUnLock() ? ModelManager_1.ModelManager.TowerModel.GetDifficultyIsClear(e) ? void 0 !== (e = this.o4e.get(e)) && e ? 3 : 2 : 1 : 0
  }
  GetTowerProgress(e) {
