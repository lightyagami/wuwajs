...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.MowingTowerModel = exports.MowingTowerTeamInfo = exports.MowingTowerBuffInfo = exports.MowingTowerRoleInfo = void 0;
...
class MowingTowerTeamInfo {
  constructor() {
    this.ActivityId = 0, this.uyn = void 0, this.tyn = [], this.cyn = [], this.myn = [], this.YLl = [], this.zLl = [], this.LevelInfo = void 0
  }
  ...
  InitLevelBuff(e, t) {
    ...
    for (const r of e) {
      ...
      e.BuffId = r.BuffId, e.Slot = r.Slot, e.ChangeAble = r.ChangeAble, this.tyn.push(e)
    }
  ...
  GetOptionBuff() {
    var e = [];
    for (const t of this.cyn)(0 < t.BuffId || t.Slot < 0) && -1 === e.findIndex(e => e.BuffId === t.BuffId) && e.push(t);
    return e
  }
  ...
  SetIndexTeamMembers(e, t, r) {
    0 === e ? this.SetIndexFirstTeamMembers(t, r) : 1 === e && this.SetIndexLowTeamMembers(t, r)
  }
  ...
  ReSortTeamMembers(e) {
    0 === e ? this.ReSortFirstTeamMembers() : 1 === e && this.ReSortLowTeamMembers()
  }
  ...
  GetIfLevelTooLow() {
    ...
    for (const i of this.YLl) {
      var r = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(i),
        r = (r && (e += r.GetLevelData().GetLevel(), t++), ModelManager_1.ModelManager.RoleModel.GetRoleDataById(i));
    ...
    for (const n of this.zLl) {
      var o = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(n),
        o = (o && (e += o.GetLevelData().GetLevel(), t++), ModelManager_1.ModelManager.RoleModel.GetRoleDataById(n));
...
class MowingTowerModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentSelectLevelDetailData = void 0, this.CurrentTeamInfo = void 0, this.PlayBackAnimation = !1, this.CurrentSelectActivityId = 0, this.CurrentOptionArea = -1, this.OtherHalfAreaRoleList = [], this.AddLevel = [-1, -1]
  }
