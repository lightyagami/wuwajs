...
class ActivityPhantomCollectController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(26276, this.OnPhantomCollectUpdateNotify);
  }
  ...
  static async PhantomCollectRewardReceiveRequest(t) {
    ...
    var e = await Net_1.Net.CallAsync(28827, e);
    if (e) {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28827);
      } else {
