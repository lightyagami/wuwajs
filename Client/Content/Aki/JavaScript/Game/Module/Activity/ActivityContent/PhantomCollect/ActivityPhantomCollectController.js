...
class ActivityPhantomCollectController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.OnPhantomCollectUpdateNotify = t => {
      ActivityPhantomCollectController.ActivityId = t.w6n;
      var e = ActivityPhantomCollectController.GetCurrentActivityDataById();
      e ? t.oMs ? (e.UpadatePhantomCollectReward(t.oMs), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnPhantomCollectUpdate, t.oMs.h5n), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, ActivityPhantomCollectController.ActivityId)) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 34, "声骇收集活动数据更新错误:", ["ActivityId:", t.w6n]) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 34, "声骇收集活动数据更新错误，没有活动数据:", ["ActivityId:", t.w6n])
    }
  }
  OnRegisterNetEvent() {
  ...
  OnCreateActivityData(t) {
    return ActivityPhantomCollectController.ActivityId = t.s5n, new ActivityPhantomCollectData_1.ActivityPhantomCollectData
  }
  OnOpenView(t) {}
  ...
  static async PhantomCollectRewardReceiveRequest(t) {
    var e = new Protocol_1.Aki.Protocol.k$n,
      e = (e.h5n = t, e.w6n = ActivityPhantomCollectController.ActivityId, await Net_1.Net.CallAsync(29618, e));
    if (e)
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29618);
      else {
        e = ActivityPhantomCollectController.GetCurrentActivityDataById();
        if (e) {
          e = e.GetPhantomCollectRewardById(t);
          if (e) return e.Y4n = Protocol_1.Aki.Protocol.zps.ovs, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, ActivityPhantomCollectController.ActivityId), e
        }
      }
  }
