...
class HandbookRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this._7s = void 0, this.Pe = void 0, this.zkt = () => {
      switch (this._7s) {
        case 0:
          this.Zkt(!1);
          break;
  ...
  OnStart() {
    this.GetUiNiagara(6).SetAlpha(0), this.GetUiNiagara(6).SetUIActive(!0), this.GetUiNiagara(7).SetUIActive(!1)
  }
  Refresh(e, t, r) {
    var s, e = ModelManager_1.ModelManager.MoonChasingModel.GetHandbookRewardDataById(e);
    e && (this.Pe = e, s = ModelManager_1.ModelManager.MoonChasingModel.GetHandbookUnlockCount(), s = e.GetState(s), this.SetRewardGoalValue(s, e.Goal), this.RefreshRewardState(s, void 0 === this._7s))
  }
  ...
  RefreshRewardState(t, e) {
    ...
    if (r.SetUIActive(!1), r.Deactivate(), e || this._7s !== t) {
      ...
      var i = 0 === t ? REWARD_BACKGROUND_COLOR_UNFINISHED : REWARD_BACKGROUND_COLOR_FINISHED,
        i = UE.Color.FromHex(i);
      this.GetSprite(5).SetColor(i), this.GetUiNiagara(6).SetAlpha(1 === t ? 1 : 0), 2 !== t || e || (r.SetUIActive(!0), r.ActivateSystem(!0)), this._7s = t
    }
  }
  e2t() {
