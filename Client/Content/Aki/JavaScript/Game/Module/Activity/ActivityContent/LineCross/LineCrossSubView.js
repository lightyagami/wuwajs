...
exports.LineCrossSubView = undefined;
const UE = require("ue");
...
class LineCrossSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    ...
    this.DFe = e => {
      ...
      if (i > 0) {
        ...
        i = {
          MarkId: ConfigManager_1.ConfigManager.LineCrossConfig.GetLineCrossActivityById(this.ActivityBaseData.Id).MarkId,
          MarkType: 0,
          OpenFogId: 0
        };
  ...
  OnBeforeShow() {
    if (this.ActivityBaseData.GetUnFinishPreGuideQuestId() > 0) {
      this.Q6a.SetBtnText("LineCrossQuestUnFinish");
    } else {
      this.Q6a.SetBtnText("LineCrossQuestFinish");
    }
...
exports.LineCrossSubView = LineCrossSubView;
//# sourceMappingURL=LineCrossSubView.js.map