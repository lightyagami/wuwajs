...
class BusinessHelperViewController {
  constructor() {
    this.Yzt = void 0, this.R1a = !1, this.SelectedRoleId = 0, this.RefreshInteractivePanel = () => {
      this.R1a && this.Yzt.RefreshInteractivePanel()
    }, this.BackToLastState = () => {
      this.R1a ? this.SkipToHelpPanel() : this.Yzt.CloseMe()
    }, this.OpenHelpView = () => {
      this.R1a ? HelpController_1.HelpController.OpenHelpById(INTERACTIVE_HELPID) : HelpController_1.HelpController.OpenHelpById(HELP_HELPID)
    }
  }
  RegisterView(i) {
    this.Yzt = i
  ...
  SkipToBuildingPreview() {
    ...
    void 0 !== i && (i.OpenParam.SkipTarget = 2, UiManager_1.UiManager.NormalResetToView("MoonChasingMainView"))
  }
}
