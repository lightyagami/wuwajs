...
const UE = require("ue"),
  ...
  FINISHED_ITEM_ALPHA = .6,
  NORMAL_ITEM_ALPHA = 1;
class FishingRewardTaskItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.sOn = void 0, this.bOe = void 0, this.JGe = () => new ActivitySmallItemGrid_1.ActivitySmallItemGrid, this.IOe = () => {
  ...
  Refresh(i, t, e) {
    ...
    this.bOe.RefreshByData(h), this.GetButton(0).RootUIComp.SetUIActive(s), this.GetItem(3).SetUIActive(r), this.GetText(2).SetUIActive(a && 0 === i.JumpId), this.GetButton(1).RootUIComp.SetUIActive(a && 0 !== i.JumpId);
    s = r ? FINISHED_ITEM_ALPHA : NORMAL_ITEM_ALPHA;
    this.GetItem(7).SetAlpha(s), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), i.TitleTextId), this.GetText(5)?.SetText(i.Current + "/" + i.Target)
  }
}
