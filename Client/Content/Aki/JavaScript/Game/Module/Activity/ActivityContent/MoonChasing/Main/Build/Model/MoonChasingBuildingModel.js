...
class MoonChasingBuildingModel extends ModelBase_1.ModelBase {
  ...
  SetBuildingData(e) {
    ...
    t.IsUnlock = e.K6n, t.Level = e.F6n, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MoonChasingRefreshBuildingRedDot)
  }
  ...
  UnlockBuildingData(e, t, i) {
    e = this.JOe.get(e);
    e.IsUnlock = !0, e.Level = 1, this.InitPopularityData(t, i, !1), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.TrackMoonHandbookUpdate)
  }
  GetBuildingDataSize() {
  ...
  InitPopularityData(e, t, i) {
    var n = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetPopularityConfigByValue(t),
      a = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetPlayerRoleId(),
      o = 1 === ModelManager_1.ModelManager.PlayerInfoModel?.GetPlayerGender(),
      i = i ? "Moonfiesta_Title4" : "Moonfiesta_Title3",
      a = new MoonChasingPopularityUpData_1.MoonChasingPopularityUpData(a, e, t, o ? n.NpcDialog : n.NpcDialogGirl, i);
  ...
  CheckPlotInfoValid(t) {
    var e, i, n;
    return void 0 !== ConfigManager_1.ConfigManager.BuildingConfig.GetBuildingAll().find(e => e.FlowListName === t.FlowListName && e.FlowId === t.FlowId && e.StateId === t.StateId) || (e = CommonParamById_1.configCommonParamById.GetStringConfig("MoonChasingBuildLastFlowName"), i = CommonParamById_1.configCommonParamById.GetIntConfig("MoonChasingBuildLastFlowIdF"), n = CommonParamById_1.configCommonParamById.GetIntConfig("MoonChasingBuildLastFlowIdC"), e === t.FlowListName && i === t.FlowId && n === t.StateId)
  }
