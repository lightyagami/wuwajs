...
class FishingHandBookDesItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, i, e) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), t.DesText), this.GetText(1).SetText(t.DataText), this.GetItem(2).SetUIActive(t.IsGolden ?? !1), this.GetItem(3).SetUIActive(t.IsSliver ?? !1)
  }
}
