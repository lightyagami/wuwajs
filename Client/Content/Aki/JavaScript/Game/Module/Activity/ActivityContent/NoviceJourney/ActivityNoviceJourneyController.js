...
class ActivityNoviceJourneyController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(26215, this.w2e);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(26215);
  }
  OnOpenView(e) {}
  ...
  RequestReward(t) {
    ...
    e.F6n = t;
    Net_1.Net.Call(19535, e, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26800);
      } else {
