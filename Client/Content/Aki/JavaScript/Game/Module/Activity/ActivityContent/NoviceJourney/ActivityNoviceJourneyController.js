...
class ActivityNoviceJourneyController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.sNe = 0, this.x2e = () => {
      0 !== this.sNe && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.sNe)
    }, this.w2e = e => {
  ...
  OnCreateActivityData(e) {
    return this.sNe = e.s5n, new ActivityNoviceJourneyData_1.ActivityNoviceJourneyData
  }
  ...
  RequestReward(t) {
    ...
    e.F6n = t, Net_1.Net.Call(23701, e, e => {
      e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26125) : (ModelManager_1.ModelManager.ActivityModel.GetActivityById(this.sNe).AddReceivedData(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.sNe))
    })
  }
}
