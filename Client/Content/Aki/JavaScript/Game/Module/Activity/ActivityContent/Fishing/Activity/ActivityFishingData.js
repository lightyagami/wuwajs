...
class ActivityFishingData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.tcl = 0, this.icl = 0, this.ix_ = new Map, this.rx_ = new Map, this.lVl = (e, t) => {
      var i, r;
      return e.Status === t.Status ? (i = ConfigManager_1.ConfigManager.FishingConfig.GetFishingActivityLimitTask(e.Id), r = ConfigManager_1.ConfigManager.FishingConfig.GetFishingActivityLimitTask(t.Id), i.SortId === r.SortId ? e.Id - t.Id : i.SortId - r.SortId) : e.Status - t.Status
    }, this.ox_ = new Map, this.nx_ = 0, this.MilestoneRewardMaxCount = 0
  }
  OnInit(e) {
    this.sx_()
  }
  PhraseEx(e) {
    e = e.YS_;
    e && (this.tcl = MathUtils_1.MathUtils.LongToNumber(e._M_), this.icl = MathUtils_1.MathUtils.LongToNumber(e.cM_), this.RefreshLimitTimeTaskDataList(e.$M_, !1), this.MilestoneRewardItemAccumulate = e.QM_, this.RefreshMilestoneReward(e.WM_, !1))
  }
  GetActivityConfig() {
    return ConfigManager_1.ConfigManager.FishingConfig.GetFishingActivityConfig(this.Id)
  }
  GetExDataRedPointShowState() {
    return this.IsUnLock() ? !!this.GetTimeLimitRedDotState() || !!this.GetHandBookRedDotState() : this.GetPreOpenFirstCheckRedDotState()
  }
  ...
  GetPreOpenFirstCheckRedDotState() {
    ...
    return !(!e || !t) && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 0, 0, 0)
  }
  SaveFirstCheckRedDotState(e, t = 0) {
    return 1 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, e, t, 0) || (ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, e, t, 0, 1), this.RefreshActivityRedDotState(), !1)
  }
  ...
  RefreshLimitTimeTaskDataList(e, t) {
    ...
    t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingTimeLimitRewardListRefresh)
  }
  ax_(t) {
    ...
    if (!i) {
      ...
      if (!r) return void(Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 37, "[FishingActivity] 限时奖励无配置", ["TaskId", t.s5n]));
      let e = this.rx_.get(r.GroupId);
      e || (e = new Set, this.rx_.set(r.GroupId, e)), e.add(t.s5n), this.ix_.set(t.s5n, i)
    }
    i.Refresh(t)
  }
  SetTimeLimitTaskDone(e) {
    this.ix_.get(e).Status = 2, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingTimeLimitRewardProgressRefresh)
  }
  ...
  set MilestoneRewardItemAccumulate(e) {
    this.nx_ = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingTimeLimitRewardProgressRefresh)
  }
  ...
  RefreshMilestoneReward(e, t) {
    for (const s of Object.keys(e)) {
      var i = Number.parseInt(s),
        r = e[s],
        n = this.ox_.get(i);
      n ? n.State = r : Log_1.Log.CheckError() && Log_1.Log.Error("Fishing", 37, "[FishingActivity] 里程碑奖励无配置", ["Id", i])
    }
    t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingTimeLimitRewardProgressRefresh)
  }
  ...
  GetShopDataList() {
    ...
    return ModelManager_1.ModelManager.PayShopModel.ReadShopItemCheckFlag(209) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FishingTimeLimitShopRefresh), this.RefreshActivityRedDotState()), e
  }
