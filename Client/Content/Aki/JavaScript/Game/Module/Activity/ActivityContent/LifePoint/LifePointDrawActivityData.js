...
class LifePointDrawActivityData extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(e) {
    ...
    ConfigManager_1.ConfigManager.LifePointDrawConfig.GetLifePointEntranceById(this.Id).GroupList.forEach(e => {
  ...
  GetGroupUnlockTime(e) {
    let t = 0;
    for (const i of ConfigManager_1.ConfigManager.LifePointDrawConfig.GetLifePointGroupByGroupId(e).ChallengeList) {
