...
class FightPhotoController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    ...
    this.EPd = e => {
      this.SPd.UpdateLevelData(e.GLd, false);
    };
    this.JDe = () => {
      var e;
    ...
    this.nye = () => {
      if (this.SPd && this.SPd.IsNeedShowFightPhotoMainView) {
        this.tHu();
      }
    ...
    this.g3e = e => {
      var t;
      if (this.SPd && e.has(this.SPd.Id) && this.CheckInFightPhotoDungeon()) {
        e = () => {
  ...
  async EnterFightPhotoDungeonDirectly(e, t, o, i) {
    ...
    ModelManager_1.ModelManager.InstanceDungeonModel.InstanceEnterContentText.NLd = e;
  ...
  LeaveInstanceDungeon() {
    if (this.CheckInFightPhotoDungeon()) {
      ...
      if (this.SPd && !this.SPd.CheckIfClose()) {
        this.SPd.IsNeedShowFightPhotoMainView = true;
      }
  ...
  tHu() {
    var e = new SplashScreenTask_1.SplashScreenTask(0, 1, () => {
      UiManager_1.UiManager.OpenView("FightPhotoMainView", this.SPd);
    });
