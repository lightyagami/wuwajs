...
class ActivityMoonChasingController extends ActivityControllerBase_1.ActivityControllerBase {
  OnGetIsOpeningActivityRelativeView() {
    for (const t of ModelManager_1.ModelManager.ActivityModel.GetActivitiesByType(Protocol_1.Aki.Protocol.uks.Proto_TrackMoonActivity)) {
      var o = t;
      let e = [];
      for (const i of e = 0 === o.ActivityFlowState ? ["MoonChasingMainView", "RewardMainView", "MoonChasingHandbookView", "BusinessMainView", "BusinessHelperView", "MoonChasingTaskView"] : ["MoonChasingMemoryView", "MoonChasingMemoryDetailView", "RewardMainView", "MoonChasingHandbookView"])
  ...
  OnCreateActivityData(e) {
    return ActivityMoonChasingController.a7a || (ActivityMoonChasingController.h7a(), ActivityMoonChasingController.a7a = !0), new ActivityMoonChasingData_1.ActivityMoonChasingData
  }
  OnActivityFirstUnlock(e) {
    0 === e.ActivityFlowState && UiManager_1.UiManager.OpenView("ActivityUnlockTipMoonChasingView")
  }
  ...
  static TrackMoonActivityTargetRewardRequest(o, t) {
    ...
    e.s5n = t, e.w6n = o, Net_1.Net.Call(17485, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16626) : (e = ModelManager_1.ModelManager.ActivityModel.GetActivityById(o)) && e.SetRewardState(t, 2))
    })
  }
...
}(exports.ActivityMoonChasingController = ActivityMoonChasingController).a7a = !1;
