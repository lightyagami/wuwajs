...
exports.MapTravelSubViewButton = undefined;
const UE = require("ue");
...
class MapTravelSubViewButton extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIText], [2, UE.UIText], [4, UE.UIItem], [6, UE.UIItem], [7, UE.UIItem], [8, UE.UIItem]];
