...
class ActivityBlackCoastController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.Pja = t => {
      for (const e of ActivityBlackCoastController.wja()) e.StageUpdate(t.gMs)
    }
  }
  OnRegisterNetEvent() {
  ...
  static RequestDataProgressReward(t, e) {
    ...
    r.w6n = t, r.Bja = e, Net_1.Net.Call(27320, r, t => {
      if (t)
        if (t.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs) ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.fMs, 28726);
        else
          for (const e of this.wja()) e.SetProgressRewardDataGot(t.rM_)
    })
  }
  static RequestTaskReward(r, o) {
    var t = new Protocol_1.Aki.Protocol.sf_;
    t.gps = o, Net_1.Net.Call(22209, t, t => {
      if (t)
        if (t.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs) ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.fMs, 20255);
        else
          for (const e of this.wja()) e.SetTaskRewardGot(r, o)
    })
  }
}
exports.ActivityBlackCoastController = ActivityBlackCoastController, (_a = ActivityBlackCoastController).qdi = (t, e) => {
  var r = _a.wja();
  if (0 !== r.length)
    for (const o of r) o.GetProgressItemId === t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, o.Id)
};
