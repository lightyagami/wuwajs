...
class InviteNewbieActivityItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.gV_ = void 0, this.LNe = void 0, this.DNe = void 0, this.UNe = void 0, this.ANe = void 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    this.ANe = new ActivityFunctionalTypeA_1.ActivityFunctionalTypeA(this.gV_), await Promise.all([this.LNe.CreateThenShowByActorAsync(i.GetOwner()), this.DNe.CreateThenShowByActorAsync(t.GetOwner()), this.UNe.CreateThenShowByActorAsync(e.GetOwner()), this.ANe.CreateThenShowByActorAsync(s.GetOwner())])
  }
  OnStart() {
    var i = this.gV_.LocalConfig,
      i = (this.LNe.SetTitleByText(this.gV_.GetTitle()), this.LNe.SetSubTitleVisible(!StringUtils_1.StringUtils.IsEmpty(i?.DescTheme)), i?.DescTheme && this.LNe.SetSubTitleByTextId(i.DescTheme), this.DNe.SetContentVisible(!StringUtils_1.StringUtils.IsEmpty(i?.Desc)), i?.Desc && this.DNe.SetContentByTextId(i.Desc), this.gV_.GetPreviewReward());
    this.UNe.InitGridLayout(this.UNe.InitCommonGridItem), this.UNe.RefreshItemLayout(i), this.UNe.SetTitleByTextId(InviteNewbieDefine_1.REWARD_TITLE_TEXT_ID_IN_SUBVIEW), this.ANe.FunctionButton.SetFunction(ActivityControllerHolder_1.ActivityControllerHolder.ActivityInviteNewbieController.HandleOnEnterClick), this.ANe.FunctionButton.SetLocalTextNew(InviteNewbieDefine_1.ENTER_BUTTON_TITLE_TEXT_ID_IN_SUBVIEW)
  }
  OnBeforeShow() {
