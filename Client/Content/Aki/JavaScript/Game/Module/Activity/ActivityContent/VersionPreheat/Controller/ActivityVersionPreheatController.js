...
class ActivityVersionPreheatController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.OCl = void 0, this.HandleQuestDetailClickInReward = e => {
      ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e) < Protocol_1.Aki.Protocol.hTs.a3_ && UiManager_1.UiManager.OpenView("QuestView", e)
    }, this.HandleVoteClickAsync = async (e, r) => {
      this.OCl = new CustomPromise_1.CustomPromise, await TimerSystem_1.TimerSystem.Wait(VersionPreheatDefine_1.VOTE_CLICK_DELAY), await this.RequestPreheatSignRewardRequest(e, r), await this.OCl.Promise, this.OCl = void 0, await this.OpenTargetViewAsyncById(e, !1)
    }, this.NCl = () => {
      this.OCl?.SetResult()
    }
  }
  ...
  async RequestPreheatSignRewardRequest(e, r) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("VersionPreheat", 64, "RequestPreheatSignRewardRequest:" + e);
    var t = Proto_PreheatSignRewardRequest.create(),
      r = (t.M_l = e, t.S_l = r, await Net_1.Net.CallAsync(25980, t));
    void 0 !== r && (r.fMs !== Proto_ErrorCode.KRs ? (Log_1.Log.CheckError() && Log_1.Log.Error("VersionPreheat", 64, "预热作答失败：RequestPreheatSignRewardRequest---" + r.fMs), ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(r.fMs, 24982)) : void 0 === r.UM_ ? Log_1.Log.CheckError() && Log_1.Log.Error("VersionPreheat", 64, "预热作答response中没有SurveyInfo", ["TVersionPreheatId", e]) : (Log_1.Log.CheckDebug() && Log_1.Log.Debug("VersionPreheat", 64, "RequestPreheatSignRewardResponse", ["response", r]), (t = ModelManager_1.ModelManager.VersionPreheatModel).SyncPreheatSignSurveyInfo(e, r.UM_), t.SyncPreheatRewardedState(e))), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.VersionPreheatRewardResponse, e)
  }
  async RequestPreheatSignSurveyInfoRequest(e) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("VersionPreheat", 64, "RequestPreheatSignSurveyInfoRequest:" + e);
    var r = Proto_PreheatSignSurveyInfoRequest.create(),
      r = (r.M_l = e, await Net_1.Net.CallAsync(20266, r));
    void 0 !== r && (r.fMs !== Proto_ErrorCode.KRs ? (Log_1.Log.CheckError() && Log_1.Log.Error("VersionPreheat", 64, "预热作答失败：RequestPreheatSignRewardRequest---" + r.fMs), ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(r.fMs, 24982)) : void 0 === r.UM_ ? Log_1.Log.CheckError() && Log_1.Log.Error("VersionPreheat", 64, "预热问卷数据response中没有SurveyInfo", ["TVersionPreheatId", e]) : ModelManager_1.ModelManager.VersionPreheatModel.SyncPreheatSignSurveyInfo(e, r.UM_))
  }
  SendDetailClickLogData(e) {
    ...
    r.i_activity_id = t.Id, r.i_activity_type = t.Type, r.i_time_left = Math.round(o), r.i_type = e ?? 0, LogReportController_1.LogReportController.LogReport(r)
  }
  async OpenTargetViewAsyncById(e, r) {
    var t, o = ModelManager_1.ModelManager.VersionPreheatModel;
    let i = void 0;
    return void 0 === e ? (t = o.BuildBonusDetailData(), void 0 !== (i = await UiManager_1.UiManager.OpenViewAsync("VersionPreheatQuestDetailView", t))) : (r && this.Cml(e) ? (t = o.BuildVoteDataById(e), i = await UiManager_1.UiManager.OpenViewAsync("VersionPreheatVoteView", t)) : 1 <= o.GetQuestStateById(e) && (r = o.BuildQuestDetailDataById(e), i = await UiManager_1.UiManager.OpenViewAsync("VersionPreheatQuestDetailView", r)), void 0 !== i)
  }
  OpenShareView(e, r, t) {
    e = {
      ScreenShot: !1,
  ...
  IsQuestAvailableButNotFinishedById(e) {
    e = ModelManager_1.ModelManager.VersionPreheatModel.GetQuestIdById(e), e = ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e);
    return 1 === e || 2 === e
  }
  Cml(e) {
    e = ModelManager_1.ModelManager.VersionPreheatModel.GetQuestIdById(e);
