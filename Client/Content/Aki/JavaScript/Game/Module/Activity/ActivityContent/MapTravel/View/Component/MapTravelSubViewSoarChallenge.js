...
class MapTravelSubViewSoarChallenge extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.ActivityBaseData = e, this.LayoutList = void 0, this.TabLayout = void 0, this.LevelSequencePlayer = void 0, this.fVl = -1, this.Hwn = (e, i, t) => {
      var s = new SoarChallengeTabDynamicScrollItem_1.SoarChallengeTabDynamicScrollItem;
      return s.BindSelectedCallBack(this.pVl), s.BindIsSelectedOn(this.vIl), s
    }, this.sGe = () => {
      return new SoarChallengeItem(this.ActivityBaseData)
    }, this.vVl = () => {
      var e = this.ActivityBaseData.GetAllSoarTabData()[this.fVl];
      this.TabLayout.GetScrollItemFromIndex(this.fVl).Update(e, this.fVl), this.Dke(e)
    }, this.pVl = e => {
      0 <= this.fVl && e.TabIndex !== this.fVl && this.XN(this.fVl, !1, !1), this.fVl = e.TabIndex, e.IsUnlock && !this.ActivityBaseData.SaveFirstCheckRedDotState(7, e.PlayId) && this.TabLayout.GetScrollItemFromIndex(this.fVl)?.SetItemNewVisible(!1), this.Dke(e)
    }, this.vIl = e => this.fVl === e.TabIndex, this.yVl = () => {
      var e = this.ActivityBaseData.GetAllSoarTabData()[this.fVl];
  ...
  async OnBeforeStartAsync() {
    var e = [];
    this.LayoutList = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(2), this.sGe), this.TabLayout = new DynScrollView_1.DynamicScrollView(this.GetUIDynScrollViewComponent(0), this.GetItem(1), new MapTravelTabDynamicItem_1.SoarTabDynamicItem, this.Hwn), e.push(this.TabLayout.Init()), this.LevelSequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), await Promise.all(e)
  }
  OnBeforeShow() {
  ...
  Dke(e) {
    ...
    this.LayoutList.RefreshByData(t, void 0, !0), this.GetItem(4).SetUIActive(!i), i || LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), this.ActivityBaseData.GetSoarPlayLockTips(e.PlayId)), this.GetButton(6).RootUIComp.SetUIActive(i)
  }
  ...
  async PlayCloseSequence() {
    await this.LevelSequencePlayer.PlaySequenceAsync("Close", new CustomPromise_1.CustomPromise, !0), this.XN(this.fVl, !1, !1), this.fVl = -1
  }
}
...
class SoarChallengeItem extends MapTravelTaskItem_1.TaskItemBase {
  constructor() {
    super(...arguments), this.TaskData = void 0, this.OnClickedRewardButton = () => {
  ...
  Refresh(e) {
    ...
    var i = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetSoarChallengeConfig(this.TaskData.Id),
      t = 2 === e.Status;
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), i.ScoreText), this.GetText(1).SetText(e.Current + "/" + e.Target), this.SVl(i.Reward), this.RewardButtonItem.SetUiActive(0 === e.Status), this.GetItem(6).SetUIActive(1 === e.Status), this.GetItem(5).SetUIActive(t)
  }
  SVl(e) {
    var i = [];
