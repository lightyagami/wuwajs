...
class ActivityLinkageTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.pua = void 0, this.OnToggleCallBack = void 0, this.RefreshRedDot = () => {
      var e = !this.pua?.IsReceive;
      this.GetItem(3)?.SetUIActive(e)
    }, this.kqe = () => {
      this.OnToggleCallBack && this.OnToggleCallBack(this.GridIndex, this.pua)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, i) {
    ...
    e && (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e.TabName), this.SetTextureByPath(e.SmallImage, this.GetTexture(1)), this.RefreshRedDot())
  }
  OnBeforeHide() {
