...
class ActivityMapTravelController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.DSe = (e, t) => {
      ...
      r && r.PhantomQuestIds.has(e) && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, r.Id)
    }, this.uFl = e => {
      var t = ActivityMapTravelController.GetMapTravelData();
      t && (e.T$s && t.RefreshTravelTaskData(e.T$s), e.EE_ && (t.RefreshSoarChallengePlayData(e.EE_), ModelManager_1.ModelManager.GeneralLogicTreeModel.HistorySoarScore = e.EE_.vE_), e.ME_ && t.UnlockAreaData(e.ME_), e.SE_ && t.UnlockPhantom(e.SE_), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, t.Id))
    }
  }
  OnRegisterNetEvent() {
  ...
  OnAddEvents() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnQuestStateChange, this.DSe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnCommonItemCountAnyChange, ActivityMapTravelController.qdi)
  }
  OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnQuestStateChange, this.DSe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnCommonItemCountAnyChange, ActivityMapTravelController.qdi)
  }
  ...
  static RequestMapTravelLevelUp(t) {
    ...
    Net_1.Net.Call(20967, e, e => {
      e ? e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21087), t?.(!1)) : (e = ActivityMapTravelController.GetMapTravelData()) ? (e.TravelLevel++, t?.(!0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, e.Id), ActivityMapTravelController.eVl(e)) : t?.(!1) : t?.(!1)
    })
  }
  static RequestTakeTravelTaskReward(t) {
    var e = Protocol_1.Aki.Protocol.x0_.create();
    e.gps = t, Net_1.Net.Call(21884, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26534) : (e = ActivityMapTravelController.GetMapTravelData()) && (e.SetTravelTaskDataDone(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, e.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapTravelTaskRefresh)))
    })
  }
  static RequestTakeTaskFinalReward() {
    var e = Protocol_1.Aki.Protocol.Up_.create();
    Net_1.Net.Call(24756, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28220) : (e = ActivityMapTravelController.GetMapTravelData()) && (e.TaskFinalRewardData.IsReceived = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, e.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapTravelTaskRefresh)))
    })
  }
  static RequestTakeSoarChallengeReward(t) {
    var e = Protocol_1.Aki.Protocol.D0_.create();
    e.gps = t, Net_1.Net.Call(16137, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23592) : (e = ActivityMapTravelController.GetMapTravelData()) && (e.SetSoarChallengeRewardDone(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, e.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapTravelSoarRefresh)))
    })
  }
  static eVl(e) {
    UiManager_1.UiManager.IsViewOpen("TravelLevelTipsView") || UiManager_1.UiManager.OpenView("TravelLevelTipsView", e)
  }
  ...
  static OpenSoarStrengthView(e) {
    var t = ControllerHolder_1.ControllerHolder.FormationAttributeController.GetBaseMax(10),
      r = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(FLY_STRENGTH_MAX_ATTRIBUTE_INDEX),
      r = {
        Name: r.Name,
        IconPath: r.Icon,
        ShowArrow: !0,
  ...
  var r = ActivityMapTravelController.GetMapTravelData();
  r && r.GetActivityConfig().ExpItemId === e && (r.CanTravelLevelUp() && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, r.Id), ActivityMapTravelController.eVl(r))
};
