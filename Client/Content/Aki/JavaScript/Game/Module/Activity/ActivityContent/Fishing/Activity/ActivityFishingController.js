...
class ActivityFishingController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnAddEvents() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.FishingRefreshHandBookRewardView, ActivityFishingController.PWa), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.UnLockGoods, ActivityFishingController.y9_)
  }
  OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.FishingRefreshHandBookRewardView, ActivityFishingController.PWa), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.UnLockGoods, ActivityFishingController.y9_)
  }
  OnRegisterNetEvent() {
    Net_1.Net.Register(25742, ActivityFishingController.ZP_), Net_1.Net.Register(22541, ActivityFishingController.ex_), Net_1.Net.Register(28418, ActivityFishingController.tx_)
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(25742), Net_1.Net.UnRegister(22541), Net_1.Net.UnRegister(28418)
  }
  ...
  static FishingActivityLimitRewardRequest(t) {
    ...
    e.gps = t, Net_1.Net.Call(23424, e, t => {
      t && t.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.Q4n, 24928)
    })
  }
  static FishingActivityMilestoneRewardRequest(t) {
    var e = new Protocol_1.Aki.Protocol.Oy_,
      i = this.GetCurrentActivityData();
    i && (e.w6n = i.Id, e.KM_ = t, Net_1.Net.Call(27900, e, t => {
      t && t.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.Q4n, 26042)
    }))
  }
}
exports.ActivityFishingController = ActivityFishingController, (_a = ActivityFishingController).ZP_ = t => {
  var e = _a.GetCurrentActivityData();
  e && (e.RefreshLimitTimeTaskDataList(t.E$s, !0), e.RefreshActivityRedDotState())
