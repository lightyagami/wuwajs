...
class FishingHandBookRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Jkt = 0, this.bOe = void 0, this.YVe = () => {
  ...
  OnStart() {
    this.GetItem(2).SetUIActive(!1), this.bOe = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(6), this.YVe)
  }
  Refresh(e, i, r) {
    this.Jkt = e;
    var e = ModelManager_1.ModelManager.FishingModel.FishingItemHandBookRewardMap.get(this.Jkt),
      ...
      t = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), e.Desc), ConfigManager_1.ConfigManager.AdventureModuleConfig.GetDropShowInfo(e.DropId)),
      s = new Array;
