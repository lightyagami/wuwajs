...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.infiniteMowingTowerColor = exports.lockMowingTowerColor = exports.normalMowingTowerColor = exports.bgInfiniteMowingTowerColor = exports.bgLockMowingTowerColor = exports.bgNormalMowingTowerColor = exports.MowingTowerData = exports.MowingTowerLevelRewardData = exports.MowingTowerLevelDetailInfo = void 0;
const UE = require("ue"),
...
class MowingTowerLevelDetailInfo {
  constructor() {
    this.LOe = 0, this.xe = 0, this.ULl = 0, this.DLl = 0, this.SSn = 0, this.ySn = [], this.xAn = [], this.ALl = [], this.xLl = [], this.jFe = !1
  }
  Phrase(e, t) {
    if (this.LOe = e, this.SetId(t.ELl), this.SetFirstScore(t.DM_), this.SetLowerScore(t.BM_), this.SetUnLockTime(Number(t.yzs)), this.jFe = t.K6n, this.ySn = [], this.xAn = [], 0 === t.Dks.length) {
  ...
  GetUnlockTimeText() {
    var e, t;
    return TimeUtil_1.TimeUtil.GetServerTime() < this.SSn ? (e = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat3(this.GetUnLockTime() - TimeUtil_1.TimeUtil.GetServerTime()), t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("MowingTowerUnLockTime"), StringUtils_1.StringUtils.Format(t, e.CountDownText)) : MultiTextLang_1.configMultiTextLang.GetLocalTextNew("MowingTowerUnlockCondition")
  }
  GetUnLockTime() {
    return this.SSn
  }
  ...
  ConvertToTeamInfo() {
    ...
    return e.SetCurrentTeamMembers(t, r), e.LevelInfo = this, e.InitLevelBuff(this.ySn, this.xAn), e.InitPrepareSelectBuff(), e.ActivityId = this.LOe, e
  }
}
...
class MowingTowerData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.rll = new Map, this.PLl = !1, this.USn = !1, this.MUl = new Map, this.$8i = void 0
  }
  PhraseEx(e) {
    this.MUl.clear(), this.rll.clear(), this.PhraseLevelInfo(e.WS_.wLl), this.CheckIfNewMowingTowerOpen(), this.PhraseRewardInfo(e.WS_.wLl), this.$8i = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshMowingTowerData), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshMowingTowerRewardRedDot, this.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  RebuildData() {
  ...
  PhraseLevelInfo(t) {
    for (const r of t) {
      ...
      (e = e || new MowingTowerLevelDetailInfo).Phrase(this.Id, r), this.MUl.set(r.ELl, e);
  ...
  oll(e) {
    ...
    if (t)
      for (const r of t)
        if (r.Id === e && 1 === r.RewardState) return !0;
    return !1
  }
  CheckIfNewMowingTowerOpen() {
    var e = ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, this.Id, 0, 0),
      t = this.GSn(),
      e = (this.PLl = e < t, ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, this.Id, UNLOCKLOCALKEY, 0));
    this.USn = e < t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  ...
  GSn() {
    let e = 0;
    for (const t of this.GetMowingTowerLevelDetailInfo()) t.GetUnLockState() && e++;
    return e
  }
  CacheNewUnlock() {
    this.USn = !1;
    var e = this.GSn();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, this.Id, UNLOCKLOCALKEY, 0, e), this.CheckIfNewMowingTowerOpen()
  }
  CacheCurrentOpenBossNum() {
    var e = this.GSn();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, this.Id, 0, 0, e), this.CheckIfNewMowingTowerOpen()
  }
  EntranceRedDot() {
  ...
  I2e(e) {
    var t, r, i = [];
    for ([t, r] of ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreview(e)) i.push([{
      ItemId: t,
      IncId: 0
    }, r]);
    return i
...
exports.MowingTowerData = MowingTowerData, exports.bgNormalMowingTowerColor = UE.Color.FromHex("ab9559"), exports.bgLockMowingTowerColor = UE.Color.FromHex("757575"), exports.bgInfiniteMowingTowerColor = UE.Color.FromHex("e8713f"), exports.normalMowingTowerColor = UE.Color.FromHex("cfc48a"), exports.lockMowingTowerColor = UE.Color.FromHex("757575"), exports.infiniteMowingTowerColor = UE.Color.FromHex("f1ac61");
