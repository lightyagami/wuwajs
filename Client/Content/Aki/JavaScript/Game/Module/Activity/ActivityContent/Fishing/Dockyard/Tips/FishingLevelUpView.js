...
class FishingLevelUpView extends UiViewBase_1.UiViewBase {
  ...
  Og(i, e, s) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "Fishing_LevelUpTip", i), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), "Fishing_LevelUpTip", e), this.GetItem(3).SetUIActive(s)
  }
}
