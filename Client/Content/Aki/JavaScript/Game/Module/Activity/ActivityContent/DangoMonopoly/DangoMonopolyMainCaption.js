...
class DangoMonopolyMainCaption extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ucr = void 0, this.OnCloseCallback = void 0, this.OnHelpCallback = void 0, this.Jvt = () => {
  ...
  async SetCurrencyItemList(t) {
    this.ucr || (this.ucr = new CommonCurrencyItemListComponent_1.CommonCurrencyItemListComponent(this.GetCostContent())), await this.ucr.SetCurrencyItemList(t)
  }
  GetCurrencyItemList() {
