...
class ActivityMapExploreController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnCreateActivityData(e) {
    return this.Data = new ActivityMapExploreData_1.ActivityMapExploreData, this.Data
  }
  OnRegisterNetEvent() {
    Net_1.Net.Register(18377, e => {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 69, "stc", ["", e]), this.Data.UpdateTaskState(e.E$s), this.rqc()
    })
  }
  ...
  async RequestGetReward(e) {
    var t = new Protocol_1.Aki.Protocol.atc,
      e = (t.gps = e, Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 69, "atc", ["", t]), await Net_1.Net.CallAsync(19061, t));
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 69, "htc", ["", e]), e?.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19061)
  }
  rqc() {
    this.Data?.Id && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Data.Id)
  }
}
