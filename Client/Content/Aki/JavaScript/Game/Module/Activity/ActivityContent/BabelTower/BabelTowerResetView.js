...
exports.BabelTowerResetView = undefined;
const UE = require("ue");
...
class BabelTowerResetView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.L3e = () => {
      BabelTowerController_1.BabelTowerController.ResetBabelTowerLevelRequest(this.yq);
      this.CloseMe();
    };
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIButtonComponent], [2, UE.UIButtonComponent]];
    this.BtnBindInfo = [[1, this.uHe], [2, this.L3e]];
  }
  async OnBeforeStartAsync() {
    ...
    var r = BabelTowerController_1.BabelTowerController.GetBabelTowerData().HardLevelDataMap.get(this.yq);
    if (r) {
      e.SetUiActive(true);
      e.Refresh(r, false, 0);
    }
