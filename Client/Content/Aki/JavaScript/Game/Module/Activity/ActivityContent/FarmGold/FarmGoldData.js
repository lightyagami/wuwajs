...
class FarmGoldLevelData {
  constructor() {
    this.LOe = 0, this.kwl = 0, this.ae = 0, this.IsOpen = !1, this.Owl = 0, this.Nwl = !1, this.Fwl = 0
  }
  GetInstId() {
    return this.kwl
  }
  ...
  GetIsOpen() {
    ...
    let e = !0;
    return 0 < t && (t = ModelManager_1.ModelManager.ActivityModel.GetActivityById(this.LOe).GetLevelInfoByInstId(t)) && (e = t.GetIfPassLevel()), TimeUtil_1.TimeUtil.GetServerTime() >= this.ae && e
  }
  GetIfPassLevel() {
  ...
  GetNewOpenState() {
    return 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.LOe, 0, this.LOe, UNLOCKLOCALKEY, this.kwl) && this.GetIsOpen()
  }
  GetUnlockTimeText() {
    var t, e;
    return TimeUtil_1.TimeUtil.GetServerTime() < this.ae ? (t = TimeUtil_1.TimeUtil.GetRemainTimeDataFormat3(this.ae - TimeUtil_1.TimeUtil.GetServerTime()), e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("FarmGoldUnLockTime"), StringUtils_1.StringUtils.Format(e, t.CountDownText)) : MultiTextLang_1.configMultiTextLang.GetLocalTextNew("FarmGoldUnlockCondition")
  }
  SaveOpenState() {
    this.GetIsOpen() && (ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.LOe, this.LOe, UNLOCKLOCALKEY, this.kwl, 1), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.LOe))
  }
  GetNameText() {
  ...
  Phrase(t, e) {
    this.LOe = t, this.kwl = e.r6n, this.ae = e.Mps, this.IsOpen = e.Sps, this.Owl = e.Eps, this.Nwl = e.Gwl
  }
}
exports.FarmGoldLevelData = FarmGoldLevelData;
class FarmGoldData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.Vwl = new Array, this.DSn = [], this.Hwl = new Array, this.LSn = [], this.$8i = void 0, this.SNe = (t, e) => {
      var i = this.wSn(e),
        r = this.wSn(t);
  ...
  PhraseEx(t) {
    this.$8i = t, this.Vwl = t.bwl.qwl, this.PhraseLevelData(t.bwl.uE_), this.PhraseRewardInfo()
  }
  AddFinishPointId(t) {
  ...
  BSn(t, e, i) {
    var r = ConfigManager_1.ConfigManager.FarmGoldConfig.GetScoreConfigById(t),
      n = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("FarmGoldFullScoreTips"), r.Score.toString()),
