...
class Spring25SharePanel extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    ...
    this.GetText(2)?.SetUIActive(!1), this.GetText(1)?.SetUIActive(!1), this.GetText(3)?.SetUIActive(!1), this.GetItem(4)?.SetUIActive(!1), this.SetTextureByPath(e.PhotoPath, this.GetTexture(0))
  }
}
