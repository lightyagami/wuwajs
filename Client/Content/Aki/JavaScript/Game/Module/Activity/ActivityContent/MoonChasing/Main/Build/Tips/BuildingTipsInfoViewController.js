...
class BuildingTipsInfoViewController {
  constructor() {
    this.Yzt = void 0, this.jio = void 0, this.SwitchPrev = () => {
      this.qDn(!0), this.Yzt.UiViewSequence.StopPrevSequence(!1, !0), this.Yzt.UiViewSequence.PlaySequence("Switch"), this.Refresh()
    }, this.SwitchNext = () => {
      this.qDn(!1), this.Yzt.UiViewSequence.StopPrevSequence(!1, !0), this.Yzt.UiViewSequence.PlaySequence("Switch"), this.Refresh()
    }, this.JumpToMap = () => {
      ...
      i.IsCanLevelUp ? i.IsBuild ? (this.Yzt.UiViewSequence.HideSequenceName = "HideView02", ControllerHolder_1.ControllerHolder.MoonChasingController.BuildingLevelUpRequest(this.jio.BuildingId)) : (this.Yzt.UiViewSequence.HideSequenceName = "HideView01", ControllerHolder_1.ControllerHolder.MoonChasingController.BuildingUnLockRequest(this.jio.BuildingId)) : ((i = new ConfirmBoxDefine_1.ConfirmBoxDataNew(205)).FunctionMap.set(2, () => {
  ...
  qDn(i) {
    ...
    this.jio.BuildingId = i ? 0 < this.jio.BuildingId - 1 ? this.jio.BuildingId - 1 : r : this.jio.BuildingId + 1 <= r ? this.jio.BuildingId + 1 : 1
  }
  RegisterView(i) {
    this.Yzt = i, this.jio = i.OpenParam
  }
  async Refresh() {
    this.Yzt.RefreshText(this.jio.BuildingId), await this.Yzt.RefreshAttribute(this.jio.BuildingId), this.Yzt.RefreshRoleItem(this.jio.BuildingId), this.Yzt.RefreshBottom(this.jio.BuildingId), this.Yzt.RefreshTexture(this.jio.BuildingId)
  }
}
