...
class DockyardInteractView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.jXl = void 0, this.lqe = void 0, this.HXl = void 0, this.WXl = void 0, this.HLn = void 0
  }
  OnRegisterComponent() {
  ...
  async KXl() {
    this.jXl = new DockyardInteractPanel_1.DockyardInteractPanel(this.HLn.InteractPanelModel), await this.jXl.CreateThenShowByActorAsync(this.GetItem(1).GetOwner())
  }
  async $Xl() {
    this.HXl = new DockyardBackpackPanel_1.DockyardBackpackPanel(this.HLn.BackpackPanelModel), await this.HXl.CreateThenShowByActorAsync(this.GetItem(2).GetOwner())
  }
  async XXl() {
    this.WXl = new DockyardTipsPanel_1.DockyardTipsPanel, await this.WXl.CreateThenShowByActorAsync(this.GetItem(3).GetOwner())
  }
  async OnBeforeStartAsync() {
    await Promise.all([this.zDn(), this.KXl(), this.$Xl(), this.XXl()]), this.HLn.BackpackPanelModel.IsInSelectState = !1
  }
  OnBeforeDestroy() {
