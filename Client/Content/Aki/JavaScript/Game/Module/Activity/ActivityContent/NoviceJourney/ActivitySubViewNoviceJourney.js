...
class ActivitySubViewNoviceJourney extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.eGe = void 0, this.mNe = void 0, this.dNe = !0, this.CNe = void 0, this.sGe = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    this.eGe = new GenericLayout_1.GenericLayout(this.GetLayoutBase(2), this.sGe, this.GetItem(3).GetOwner()), await this.eGe.RefreshByDataAsync(e)
  }
  OnAddEventListener() {
  ...
  OnStart() {
    this.mNe = this.GetText(1), this.dNe = 0 !== this.CNe.EndShowTime, this.mNe.SetUIActive(0 !== this.CNe.EndShowTime);
    var e = ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerLevel();
    this.GetText(0).SetText(e.toString()), this.GetText(4).SetText(this.CNe.GetTitle())
  }
  OnBeforeShow() {
    this.fNe()
  }
