...
class RoleGrowingMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.ActivityBaseData = void 0, this.lqe = void 0, this.bCl = [], this.AOe = () => {
      this.bCl.forEach(e => {
        e.Refresh(this.ActivityBaseData)
      })
    }, this.wOe = e => {
      this.ActivityBaseData.GetStageInfoById(e) ? UiManager_1.UiManager.OpenView("RoleGrowingTaskView", e) : ActivityLongShanController_1.ActivityLongShanController.ShowUnlockTip(e)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let e = 0; e < this.ActivityBaseData.StageIds.length; e++) {
      ...
      i.OnClickStageDetail = this.wOe, t.push(i.CreateByActorAsync(this.GetItem(1 + e).GetOwner())), this.AddChild(i), this.bCl.push(i)
    }
    await Promise.all(t)
  }
  OnBeforeShow() {
    ControllerHolder_1.ControllerHolder.ActivityController.CheckIsActivityClose(void 0, this.ActivityBaseData.Id), this.AOe()
  }
  OnAddEventListener() {
