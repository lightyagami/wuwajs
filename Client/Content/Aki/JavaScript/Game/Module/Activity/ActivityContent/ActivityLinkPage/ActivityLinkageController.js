...
class ActivityLinkageController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnCreateActivityData(e) {
    return ActivityLinkageController.LOe = e.s5n, new ActivityLinkageData_1.ActivityLinkageData
  }
  ...
  static RequestReward(t) {
    var e = new Protocol_1.Aki.Protocol.en1;
    e.w6n = this.LOe, e.on1 = t, Net_1.Net.Call(29266, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21053) : (e = this.GetActivityLinkageData()) && e.ReceiveReward(t))
    })
  }
