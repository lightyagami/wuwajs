...
class DangoMonopolyBuffActiveGetPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.GridData = void 0, this.OnClickCallback = void 0, this.OnClickBtnConfirm = () => {
  ...
  UpdateData() {
    var t = this.GridData.GetDangoData(),
      ...
      t = t?.DangoSay ?? "";
    this.GetText(1)?.ShowTextNew(s), this.GetText(5)?.ShowTextNew(e?.Desc ?? ""), this.GetItem(4)?.SetUIActive(!1), this.GetButton(0)?.RootUIComp.SetUIActive(!1), this.UpdateDangoSay(t)
  }
  SetDialogVisible(t) {
