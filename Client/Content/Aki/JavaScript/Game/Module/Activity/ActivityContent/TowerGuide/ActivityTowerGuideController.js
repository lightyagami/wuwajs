...
class ActivityTowerGuideController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  static RequestTowerReward(e) {
    ...
    t.i8n = e, Net_1.Net.Call(21406, t, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28363) : ActivityTowerGuideController.RequestTowerRewardInfo())
    })
  }
  static RequestTowerRewardInfo() {
    var e = new Protocol_1.Aki.Protocol.C0s;
    Net_1.Net.Call(24479, e, e => {
      if (e) {
        var t = ActivityTowerGuideController.t4e();
        if (t)
          for (const r of e.i8n) t.SetRewardClaimed(r, !0)
      }
    })
  }
