...
class BabelTowerModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.v_c = void 0, this.ItemCountMax = 0, this.DeTermSelectInfo = new Map, this.DeTermSelectIndex = 0, this.LevelChoseHandle = 0, this.CurrentSelectLevel = 0
  }
  get CurrentChallengeInstData() {
    return this.v_c
  }
  OnInit() {
    return this.ItemCountMax = CommonParamById_1.configCommonParamById.GetIntConfig("BabelTowerItemCountMax") ?? 0, !0
  }
  UpdateCurrentChallengeInstDataByNotify(e) {
    this.v_c || (this.v_c = new BabelTowerDefine_1.BabelTowerInstanceData);
    var r = e.NX_;
    this.v_c.LevelId = e.gG_, this.v_c.CurStarNum = e.Whc, this.v_c.UseReviveCount = e.zX_, this.v_c.RoleCd = r, this.v_c.BuffSelection = e.Dks, this.v_c.DeTermIdList = e.GX_, 0 < r && ModelManager_1.ModelManager.SceneTeamModel.UpdateChangeRoleCooldown(r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnBabelActivityInstInfoUpdate)
  }
  GetIfLevelTooLow(e, r) {
    ...
    for (const l of r) {
      var a = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(l),
        a = (a && (t += a.GetLevelData().GetLevel(), o++), ModelManager_1.ModelManager.RoleModel.GetRoleDataById(l));
    ...
    for (const s of r) {
      var i = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(s),
        i = (i && (t += i.GetLevelData().GetLevel(), o++), ModelManager_1.ModelManager.RoleModel.GetRoleDataById(s));
  ...
  CheckInBattleBabelTower() {
    var e;
    return !(!ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance() || (e = ModelManager_1.ModelManager.CreatureModel.GetInstanceId(), !(e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e))) || 30 !== e.InstSubType)
  }
  CheckCanRevive() {
    var e, r = this.CurrentChallengeInstData;
