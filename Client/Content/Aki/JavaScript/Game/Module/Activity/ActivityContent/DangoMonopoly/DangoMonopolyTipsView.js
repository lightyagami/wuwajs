...
class DangoMonopolyTipsView extends UiViewBase_1.UiViewBase {
  ...
  async ShowData() {
    var e;
    this.OpenParam?.TipsTextList.length ? (e = this.OpenParam.TipsTextList.shift(), this.GetText(1)?.SetText(e.Text), this.UpdateIcon(e.Icon), this.OpenParam.ShowTime && (await TimerSystem_1.TimerSystem.Wait(this.OpenParam.ShowTime), this.IsDestroyOrDestroying) || await this.ShowData()) : this.CloseMe()
  }
  UpdateIcon(e) {
