...
class DangoMonopolyDiceBuffPanel extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.Sequence = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem)
  }
  UpdateShowType(e) {
    this.SetActive(!0);
  ...
  async PlaySequence(e) {
    await this.Promise?.Promise, this.Promise = new CustomPromise_1.CustomPromise, await this.Sequence?.PlaySequenceAsync(e, this.Promise), this.Promise = void 0
  }
}
