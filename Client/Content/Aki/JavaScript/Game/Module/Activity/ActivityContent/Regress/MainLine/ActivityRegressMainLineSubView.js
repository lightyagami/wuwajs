...
class ActivityRegressMainLineSubView extends ActivityRegressMainSubViewBase_1.ActivityRegressMainSubViewBase {
  constructor() {
    super(...arguments), this.Oda = void 0, this.$da = void 0, this.Gda = void 0, this.Wwn = e => {
      e = this.Gda[e].Config;
      this.$da.RefreshByData(e), this.InvokePassRecallBaseCallBack(e, 0), this.SequencePlayer.PlaySequence("Start")
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    this.$da = new ActivityRegressMainLineActivityInfoPanel_1.ActivityRegressMainLineActivityInfoPanel, await this.$da.CreateThenShowByActorAsync(e)
  }
  OnStart() {
    super.OnStart();
    var e = this.GetHorizontalLayout(0),
      i = this.GetItem(5);
    this.Oda = new ActivityRegressTabGroupPanel_1.ActivityRegressTabGroupPanel(e, i, this.Wwn), this.Oda.Init(), this.GetItem(3).SetUIActive(!1)
  }
  OnBeforeDestroy() {
  ...
  OnUpdate(e) {
    ...
    for (const s of i) {
      ...
      t.RecallEntryType = 1, t.Config = s, t.Title = s.Title, this.Gda.push(t)
    }
    this.GetItem(7).SetUIActive(1 < this.Gda.length), this.Oda.RefreshByData(this.Gda, e)
  }
}
