...
class FishingTechCostItem extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshCost(i, s, n = !0) {
    ...
    if (r) {
      ...
      let e = "";
      e = n ? r < s ? StringUtils_1.StringUtils.Format(FishingDefine_1.FISHING_TECH_MATERIAL_NOT_ENOUGHT, s.toString()) : StringUtils_1.StringUtils.Format(FishingDefine_1.FISHING_TECH_MATERIAL_ENOUGHT, s.toString()) : "" + s, this.GetText(1).SetText("" + e)
    }
  }
}
