...
class ActivityDoubleRewardData extends ActivityData_1.ActivityBaseData {
  ...
  GetExDataRedPointShowState() {
    var e = this.ARn();
    return 1 !== ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, e, 0, 0)
  }
  ARn() {
    var e = new Date;
    return e.getHours() < TimeUtil_1.TimeUtil.CrossDayHour && e.setDate(e.getDate() - 1), e.setHours(TimeUtil_1.TimeUtil.CrossDayHour, 0, 0, 0), e.getTime()
  }
  ...
  get AdventureGuideUpList() {
    if (!this.EOe) switch (this.SubType) {
      case 1:
        this.EOe = [19];
        break;
      case 2:
  ...
  GetNumTxtAndParam() {
    return [0 < this.LeftUpCount ? "Reward_doubling_time" : "Reward_doubling_end", this.LeftUpCount, this.yOe]
  }
  GetFullTipNumTxtAndParam() {
    return [0 < this.LeftUpCount ? "Reward_doubling_tips" : "Reward_doubling_end_tips", this.LeftUpCount, this.yOe]
  }
  GetFullTip() {
