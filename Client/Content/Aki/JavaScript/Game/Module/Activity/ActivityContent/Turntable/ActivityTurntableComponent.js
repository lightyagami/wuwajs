...
class ActivityTurntableComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.sOe = [], this.LevelSequencePlayer = void 0, this.KAn = void 0, this.uCo = 0, this.QAn = 0, this.XAn = new UE.Rotator, this.Activate = !0, this.V2n = 0, this.$An = t => {
      t === TURNTABLE_ROTATE_PARAM && this.Activate && this.YAn(this.QAn)
    }, this.JAn = (t, e) => {
      this.uCo += t;
      t = Math.min(this.uCo / this.V2n, 1);
      this.XAn.Pitch = 0, this.XAn.Roll = 0, this.XAn.Yaw = t * e, this.GetItem(8).SetUIRelativeRotation(this.XAn), this.uCo >= this.V2n && this.zAn()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var t = [];
    for (const e of [this.sOe.length = 0, 1, 2, 3, 4, 5, 6, 7]) t.push(this.rOe(this.GetItem(e).GetOwner()));
    await Promise.all(t), this.LevelSequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.V2n = CommonParamById_1.configCommonParamById.GetIntConfig("TurntableActivitytRotateLoopTime") ?? ROTATE_LOOP_ANIMATION_TIME
  }
  async rOe(t) {
  ...
  async Refresh(e) {
    if (e.length !== TURNTABLE_GRID_SIZE) Log_1.Log.CheckWarn() && Log_1.Log.Warn("Activity", 37, "[转盘活动] 转盘奖励数量配置不正确", ["Count", e.length]);
    else {
      var i = [];
  ...
  async ZAn(t, e) {
    ...
    t = () => {
      this.GetItem(8).SetUIRelativeRotation(new UE.Rotator(0, 0, 0)), this.iPn(i), e?.()
    };
    if (s && void 0 !== UiManager_1.UiManager.OpenViewAsync("ActivityTurntableRewardView", t)) return;
    t()
  }
  ePn(e) {
    let i = -1,
    ...
    for (let t = 0; t < this.sOe.length; t++)
      if (this.sOe[t].RewardId === e) {
        ...
        break
      } return i < 0 ? [-1, s, r] : [ROTATE_DEFAULT_ANGLE + ROTATE_GRID_ANGLE * i, s, r]
  }
  YAn(e) {
    0 !== e && (this.iPn(-e), this.uCo = 0, this.KAn = TimerSystem_1.TimerSystem.Forever(t => {
      this.JAn(t, e)
  ...
  zAn() {
    TimerSystem_1.TimerSystem.Has(this.KAn) && (TimerSystem_1.TimerSystem.Remove(this.KAn), this.KAn = void 0, this.uCo = 0)
  }
  async tPn(t, e) {
...
class ActivityTurntableGrid extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RewardId = 0, this.IsGoldenQuality = !1, this.IsSpecial = !1, this.ETt = 0, this.DWs = () => {
  ...
  async Refresh(t) {
    ...
    var s = () => {
      ...
      r = (this.ETt = t.RewardItem[0].ItemId, this.SetItemIcon(this.GetTexture(0), this.ETt, void 0, s), ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(t.RewardItem[0].ItemId)),
      r = r?.QualityId ?? 0,
      r = (this.IsGoldenQuality = 5 === r, "SP_TurntableQuality" + r),
      r = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(r);
    this.SetSpriteByPath(r, this.GetSprite(1), !1, void 0, s), this.GetText(2).SetText(t.RewardItem[1].toString()), this.SetRewardClaimed(t.IsClaimed), await i.Promise
  }
  SetRewardClaimed(t) {
    this.GetTexture(0).SetUIActive(!t), this.GetItem(3).SetUIActive(t), this.GetItem(4).SetUIActive(!t)
  }
  Rotate(t) {
