...
exports.ActivityRegressHelper = undefined;
...
class ActivityRegressHelper {
  ...
  static RefreshItemGridByData(e, r) {
    var t = r.ItemInfo;
    var i = r.ItemCount;
    var o = r.RewardState === 0;
    var a = r.RewardState === 1;
    var r = r.RewardState === 2;
  ...
  static aga(e, r, t = 0) {
    ...
    var o = new LogReportDefine_1.ActivityRecallLogData();
    o.event_id = e;
  ...
  static ReportRegressLog1060() {
    ActivityRegressHelper.RI1("1060");
  }
  static ReportRegressLog1061(e) {
    ActivityRegressHelper.RI1("1061", e);
  }
  static RI1(e, r = 0) {
    var t = new LogReportDefine_1.ActivityRegressLogData();
    t.event_id = e;
    t.i_activity_id = ModelManager_1.ModelManager.ActivityRegressModel.ActivityId;
  ...
  static GetMinExploreAreaInfo() {
    ...
    if (e !== undefined && !(e.size <= 0)) {
      ...
      if (!(t.length <= 0)) {
        ...
        for (const s of t) {
          var o = s.AreaId;
          var o = ConfigManager_1.ConfigManager.AreaConfig.GetAreaInfo(o);
          if (o !== undefined && o.DeliveryMarkId !== 0) {
            var a = o.DeliveryMarkId;
            var a = ConfigManager_1.ConfigManager.MapConfig.GetConfigMark(a);
