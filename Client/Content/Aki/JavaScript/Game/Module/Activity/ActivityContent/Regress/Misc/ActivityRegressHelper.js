...
class ActivityRegressHelper {
  static RefreshItemGrid(e, r, t, [i, o, a]) {
    var s = r.Id;
    switch (ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(s)) {
      case 1:
  ...
  static aga(e, r, t = 0) {
    ...
    o.event_id = e, o.i_activity_id = i.Id, o.i_activity_type = i.Type, o.i_time_left = i.GetActivityOpenTimeLeft(), o.i_type = r, o.i_quest_id = t, o.i_grade_id = ModelManager_1.ModelManager.ActivityRegressModel.Grade, LogReportController_1.LogReportController.LogReport(o)
  }
  static ReportRegressLog1060() {
    ActivityRegressHelper.iI1("1060")
  }
  static ReportRegressLog1061(e) {
    ActivityRegressHelper.iI1("1061", e)
  }
  static iI1(e, r = 0) {
    var t = new LogReportDefine_1.ActivityRegressLogData;
    t.event_id = e, t.i_activity_id = ModelManager_1.ModelManager.ActivityRegressModel.ActivityId, t.i_grade_id = ModelManager_1.ModelManager.ActivityRegressModel.Grade, t.i_question_id = r, LogReportController_1.LogReportController.LogReport(t)
  }
