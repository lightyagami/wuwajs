...
exports.VersionPreheatButton = exports.VersionPreheatQuestDetailRoleItem = exports.VersionPreheatQuestDetailView = undefined;
const UE = require("ue");
...
class VersionPreheatQuestDetailView extends UiViewBase_1.UiViewBase {
  ...
  async OnBeforeStartAsync() {
    ...
    this.j_l = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(19), this.a4e);
  ...
  OnBeforeShow() {
    ...
    if (this.KUa) {
      this.KUa = false;
    } else if ((t = ModelManager_1.ModelManager.VersionPreheatModel).CurrentUsingVersionPreheatId !== undefined) {
      t = t.BuildQuestDetailDataById(t.CurrentUsingVersionPreheatId);
      this.QCl(t);
    }
  }
  OnBeforeDestroy() {
    ModelManager_1.ModelManager.VersionPreheatModel.CurrentUsingVersionPreheatId = undefined;
  }
  J_l(t) {
    this.SetTextureByPath(t.QuestPhotoPath, this.GetTexture(15));
    this.Z_l(t.Index);
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), t.QuestContentTextId);
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), t.QuestTitleTextId);
    this.GetTexture(1)?.SetUIActive(t.QuestCrestIndex === 0);
    this.GetTexture(2)?.SetUIActive(t.QuestCrestIndex === 1);
  ...
  eul(t) {
    if (t === undefined) {
      ...
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(13), t.LeftThemeTextId);
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(14), t.RightThemeTextId);
  ...
  tul(t) {
    if (t === undefined) {
      ...
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(23), t.NpcContentTextId);
      if ((t = t.SelfChatData) === undefined) {
        this.GetItem(24)?.SetUIActive(false);
      } else {
        this.GetItem(24)?.SetUIActive(true);
        this.H_l.RefreshExternal(t.NpcIconPath);
        if (t.NpcContentTextId === undefined) {
          this.GetItem(26)?.SetUIActive(false);
        } else {
          this.GetItem(26)?.SetUIActive(true);
          LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(28), t.NpcContentTextId);
        }
  ...
  iul(t) {
    if (t === undefined) {
      ...
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(18), t.QuestContentTextId);
      this.KCl(t);
...
class VersionPreheatButton extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments);
    this.ClickRewardFunc = undefined;
    this.ClickRewardPassData = undefined;
    this.p9a = () => {
      if (this.ClickRewardFunc !== undefined && this.ClickRewardPassData !== undefined) {
  ...
  OnStart() {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "Text_RoleQuestGoto_Text");
  }
}
