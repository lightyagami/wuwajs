...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.ActivityTurntableDailyItem = exports.ActivityTurntableDailyPanel = exports.ActivityTurntableToggleItem = exports.ActivityTurntableToggleGroupItem = exports.ActivityTurntableQuestItem = void 0;
const UE = require("ue"),
...
class ActivityTurntableQuestItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.FRe = 0, this.LOe = 0, this.gOe = void 0, this.uLn = () => {
      this.FRe && (UiManager_1.UiManager.OpenView("QuestView", this.FRe), this.t2n()?.ReadCurrentUnlockQuest())
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    await t.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()), this.gOe = t
  }
  Refresh(t, i, e, s) {
    this.gOe.Refresh({
      Item: i,
      HasClaimed: t
    }), this.GetButton(3).RootUIComp.SetUIActive(!t), this.FRe = e, this.LOe = s
  }
  SetTitle(t, ...i) {
  ...
  t2n() {
    if (this.LOe) return ModelManager_1.ModelManager.ActivityModel.GetActivityById(this.LOe)
  }
}
...
class ActivityTurntableToggleGroupItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.cLn = void 0, this.mLn = void 0, this.zji = void 0, this.CanToggleExecuteChange = void 0, this.ToggleCallBack = void 0
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UIItem],
  ...
  async OnBeforeStartAsync() {
    var t = this.GetItem(0),
      t = (this.cLn = new ActivityTurntableToggleItem, await this.cLn.CreateThenShowByActorAsync(t.GetOwner()), this.cLn.ToggleCallBack = this.ToggleCallBack, this.cLn.CanToggleExecuteChange = this.CanToggleExecuteChange, this.GetItem(1));
    this.mLn = new ActivityTurntableToggleItem, await this.mLn.CreateThenShowByActorAsync(t.GetOwner()), this.mLn.ToggleCallBack = this.ToggleCallBack, this.mLn.CanToggleExecuteChange = this.CanToggleExecuteChange
  }
  OnStart() {
  ...
  SetToggleDisable(t) {
    ...
    this.zji = t ? this.mLn : this.cLn, void 0 !== i && this.zji.SetToggleState(1 === i), this.GetItem(0)?.SetUIActive(!t), this.GetItem(1)?.SetUIActive(t)
  }
  Refresh(t) {
...
class ActivityTurntableToggleItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RoundId = 0, this.Toggle = void 0, this.CanToggleExecuteChange = void 0, this.ToggleCallBack = void 0, this.uFe = () => !this.CanToggleExecuteChange || this.CanToggleExecuteChange(this.RoundId), this.cFe = () => {
      this.ToggleCallBack && this.ToggleCallBack(this.RoundId, 1 === this.Toggle.GetToggleState())
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  dLn() {
    var t = this.RoundId + 1,
      ...
      i = (this.SetSpriteByPath(i, this.GetSprite(2), !1), "SP_TurntableNormal_Index0" + t),
...
class ActivityTurntableDailyPanel extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.ActivityBaseData = t, this.tLl = void 0, this.iLl = () => new ActivityTurntableDailyItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
