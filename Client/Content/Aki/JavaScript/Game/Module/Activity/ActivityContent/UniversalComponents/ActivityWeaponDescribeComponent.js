...
class ActivityWeaponDescribeComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Gke = void 0, this.$be = void 0, this.Zul = () => {
      this.Gke?.()
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.$be = new SimpleGenericLayout_1.SimpleGenericLayout(this.GetHorizontalLayout(2)), this.GetTexture(3)?.SetUIActive(!1), this.GetSprite(5)?.SetUIActive(!0), this.SetLookButtonVisible(!1)
  }
  Refresh(e, i = !1) {
    e = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponConfigByItemId(e);
    e && (this.GetText(0).ShowTextNew(e.WeaponName), this.GetItem(1).SetUIActive(i), this.vWt(e.WeaponType), this.n4e(e.QualityId))
  }
  n4e(e) {
