...
exports.ActivityTimePointRewardConfig = undefined;
...
class ActivityTimePointRewardConfig extends ConfigBase_1.ConfigBase {
  GetTimePointRewardById(i) {
    return TimePointRewardActivityById_1.configTimePointRewardActivityById.GetConfig(i);
  }
  GetConfigByActivityId(i) {
    return TimePointRewardConfigByActivityId_1.configTimePointRewardConfigByActivityId.GetConfig(i);
  }
}
