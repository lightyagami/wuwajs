...
class MowingRiskProtocolContext extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.QVa = new Map, this.KVa = void 0, this.$Va = new Map, this.I6_ = new MowingRiskInBattleRecordData_1.MowingRiskInBattleRecordData, this.XVa = new Set, this.zVa = new Set, this.JVa = 0
  }
  Dispose() {}
  PhraseEx(t) {
    t = t.NS_;
  ...
  L1h(t) {
    for (const e of t) this.JVa -= this.QVa.get(e.s5n)?.SMs ?? 0, this.QVa.set(e.s5n, e), this.JVa += e.SMs
  }
  D1h(t) {
    this.JVa = 0;
  ...
  get ArtifactInfo() {
    return void 0 === this.KVa && Log_1.Log.CheckError() && Log_1.Log.Error("MowingRisk", 64, "尚未获得割草局内buff数据"), this.KVa
  }
  get ArtifactId() {
  ...
  GetInstanceUnlockTimestampById(t) {
    ...
    return void 0 === t ? Number.MAX_VALUE : MathUtils_1.MathUtils.LongToNumber(t)
  }
  IsInstancePassUnlockTimeById(t) {
    return TimeUtil_1.TimeUtil.GetServerTimeStamp() >= this.GetInstanceUnlockTimestampById(t)
  }
  ResetCacheInBattle() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("MowingRisk", 64, "ResetCacheInBattle"), this.KVa = void 0, this.$Va.clear(), this.I6_.Clear()
  }
  HasScoreRewarded(t) {
