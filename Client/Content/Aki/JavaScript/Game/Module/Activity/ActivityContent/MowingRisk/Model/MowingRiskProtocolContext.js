...
exports.MowingRiskProtocolContext = undefined;
const ActivityData_1 = require("../../../ActivityData");
const Log_1 = require("../../../../../../Core/Common/Log");
const MathUtils_1 = require("../../../../../../Core/Utils/MathUtils");
const TimeUtil_1 = require("../../../../../Common/TimeUtil");
const ModelManager_1 = require("../../../../../Manager/ModelManager");
const MowingRiskInBattleRecordData_1 = require("./MowingRiskInBattleRecordData");
class MowingRiskProtocolContext extends ActivityData_1.ActivityBaseData {
  constructor() {
    ...
    this.KVa = undefined;
    this.$Va = new Map();
    this.I6_ = new MowingRiskInBattleRecordData_1.MowingRiskInBattleRecordData();
    this.XVa = new Set();
    this.zVa = new Set();
    this.JVa = 0;
  }
  ...
  t9a(t) {
    if (t !== undefined) {
      this.KVa = t;
      this.$Va.clear();
      for (const e of t.tE_) {
        this.$Va.set(e.s5n, e.m9n);
      }
    }
  }
  ZVa(t) {
  ...
  get ArtifactInfo() {
    if (this.KVa === undefined && Log_1.Log.CheckError()) {
  ...
  IsInstanceUnlockedById(t) {
    return this.QVa.get(t)?.K6n ?? false;
  }
  IsInstancePlayedById(t) {
    return this.QVa.get(t)?.eE_ ?? false;
  }
  GetInstanceUnlockTimestampById(t) {
    ...
    if (t === undefined) {
      ...
      return MathUtils_1.MathUtils.LongToNumber(t);
    }
  }
