...
class ActivityShipTowerData extends ActivityData_1.ActivityBaseData {
  GetExDataRedPointShowState() {
    ...
    return !(e <= 0) && ((LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.ShipTowerSeason) ?? 0) < e || ModelManager_1.ModelManager.ShipTowerModel.IsCanReceiveAward())
  }
}
