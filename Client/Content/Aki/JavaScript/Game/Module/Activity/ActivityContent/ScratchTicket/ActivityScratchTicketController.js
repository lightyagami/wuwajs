...
class ActivityScratchTicketController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(21604, ActivityScratchTicketController.Iol);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(21604);
  }
  OnAddEvents() {
  ...
  static SendScratchCardRewardRequest(t, r, i) {
    ...
    e.Tol = t;
    e.c5n = r;
    Net_1.Net.Call(16279, e, e => {
      if (e) {
        if (e.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.fMs, 29820);
        } else {
  ...
  static async SendScratchCardActivityInfoRequest() {
    ...
    return t !== undefined && ((e = Protocol_1.Aki.Protocol.mg_.create()).w6n = t.Id, !!(e = await Net_1.Net.CallAsync(17795, e))) && (e.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.fMs, 29820), false) : e.YVn !== undefined && (t.InitData(e.YVn), true));
  }
