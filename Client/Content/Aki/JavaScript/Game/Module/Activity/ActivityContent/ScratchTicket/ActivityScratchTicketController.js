...
class ActivityScratchTicketController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnCreateActivityData(e) {
    ...
    return ModelManager_1.ModelManager.ActivityScratchTicketModel.SetScratchTicketData(t), t
  }
  ...
  static async OpenScratchTicketMainView() {
    ...
    return void 0 === e ? (Log_1.Log.CheckError() && Log_1.Log.Error("ScratchTicket", 58, "scratchTicketData为空，无法打开"), !1) : void 0 !== await UiManager_1.UiManager.OpenViewAsync("ScratchTicketMainView", e)
  }
  OnRegisterNetEvent() {
  ...
  static SendScratchCardRewardRequest(t, r, i) {
    ...
    e.Tol = t, e.c5n = r, Net_1.Net.Call(17135, e, e => {
      e && (e.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.fMs, 20092) : ModelManager_1.ModelManager.ActivityScratchTicketModel.OnScratchCardRewardResponse(r, t, e, i))
    })
  }
  static async SendScratchCardActivityInfoRequest() {
    var e, t = ModelManager_1.ModelManager.ActivityScratchTicketModel.GetScratchTicketData();
    return void 0 !== t && ((e = Protocol_1.Aki.Protocol.mg_.create()).w6n = t.Id, !!(e = await Net_1.Net.CallAsync(21851, e))) && (e.fMs !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.fMs, 20092), !1) : void 0 !== e.YVn && (t.InitData(e.YVn), !0))
  }
  static ShowScratchTicketRewardTip(e) {
    var t, r, i;
    e.length < 1 || void 0 !== (i = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(e[0].ConfigId)) && (t = i.IconSmall + "/", r = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.Name), i = ConfigManager_1.ConfigManager.InventoryConfig.GetItemQualityConfig(i.QualityId), ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("ScratchCardRewardTips", t, i.TextColor, r, e[0].Count.toString()))
  }
  ...
  void 0 !== r && e === r.GetCostItemId() && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, r.Id)
};
