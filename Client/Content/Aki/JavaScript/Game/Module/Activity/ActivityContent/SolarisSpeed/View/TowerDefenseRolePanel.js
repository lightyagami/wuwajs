...
class TowerDefenseRolePanel extends SolarSpeedRolePanelBase_1.SolarSpeedRolePanelBase {
  ...
  async Anc() {
    this.DescContent = new TowerDefenseRoleDescContent, await this.DescContent.CreateThenShowByResourceIdAsync("UiItem_RaceResulInfo", this.GetItem(11))
  }
...
class TowerDefenseRoleDescContent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Scroll = void 0, this.fke = () => new TowerDefenseRoleDescItem
  }
  OnRegisterComponent() {
  ...
  Refresh(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), s.Title), this.Pnc(e.DescDataList)
  }
}
class TowerDefenseRoleDescItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), s.BaseTitle), s.IsTotalRatio ? this.GetText(2)?.SetText(e.Count.toString() + "%") : this.GetText(2)?.SetText(e.Count.toString())
  }
}
