...
class ActivitySevenDaySignData extends ActivityData_1.ActivityBaseData {
  ...
  PhraseEx(t) {
    this.B3e = t.Ops.pps, Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 37, "[ActivitySevenDaySign][Phrase]签到活动签到状态打印", ["ActivityId", this.Id], ["SignStateList", this.B3e]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ActivityViewRefreshCurrent, this.Id)
  }
  ...
  UpdateActivityData(t) {
    this.B3e[t.c5n] = t.zps, Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 37, "[ActivitySevenDaySign][UpdateData]签到活动签到状态改变", ["ActivityId", this.Id], ["SignIndex", t.c5n], ["SignState", t.zps], ["SignStateList", this.B3e])
  }
