...
class Spring25EnvelopeView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.JGl = () => {
      ActivitySpring25Controller_1.ActivitySpring25Controller.Instance.HandleResetCurrentSignId(), this.CloseMe()
    }, this.zGl = () => {
      ActivitySpring25Controller_1.ActivitySpring25Controller.Instance.HandleResetCurrentSignId(), this.CloseMe()
    }
  }
  ...
  OnStart() {
    ...
    LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(0), i.InfoTextId), LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(3), i.TitleTextId)
  }
}
