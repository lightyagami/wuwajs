...
class ActivityPhantomCollectData extends ActivityData_1.ActivityBaseData {
  ...
  GetExDataRedPointShowState() {
    let e = !1;
    return this.PhantomCollectRewardList?.forEach(t => {
  ...
  GetCollectPhantomCount() {
    ...
    let e = 0;
    return t.forEach(t => {
      ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomIsUnlock(t) && e++
    }), e
  }
  UpadatePhantomCollectReward(e) {
    var t;
    void 0 !== this.PhantomCollectRewardList && -1 !== (t = this.PhantomCollectRewardList.findIndex(t => t.h5n === e.h5n)) && (this.PhantomCollectRewardList[t] = e)
  }
}
