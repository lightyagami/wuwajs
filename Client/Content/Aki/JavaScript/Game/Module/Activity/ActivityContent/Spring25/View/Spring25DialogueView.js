...
class Spring25DialogueView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lGe = void 0, this.L8e = void 0, this.YGl = void 0, this.zGl = () => {
      ActivitySpring25Controller_1.ActivitySpring25Controller.Instance.HandleConfirmClickInDialogueView()
    }, this.eFl = e => {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Spring25", 64, "对话事件触发", ["passData", e]);
      var i = this.OpenParam,
        e = Spring25Define_1.spring25DialogIndex.get(e);
      void 0 === e || e >= i.ChatDataList.length || (0 === (i = i.ChatDataList[e]).Position ? (this.L8e.RefreshText(i.ContentTextId), this.L8e) : (this.YGl.RefreshText(i.ContentTextId), this.YGl)).RefreshAnim(i.SpineAnimName)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    e.IsOpening && (this.UiViewSequence.StartSequenceName = "Start02"), this.lGe = new ButtonItem_1.ButtonItem(this.GetItem(0)), this.lGe.SetFunction(this.zGl), this.lGe.SetLocalTextNew(Spring25Define_1.BUTTON_TEXT_ID_IN_DIALOG), this.L8e = new RoleItem, await this.L8e.CreateThenShowByActorAsync(this.GetItem(1).GetOwner()), this.YGl = new RoleItem, await this.YGl.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()), await Promise.all([this.L8e.RefreshExternalByDataAsync(e.LeftSpineData), this.YGl.RefreshExternalByDataAsync(e.RightSpineData)])
  }
  OnAddEventListener() {
...
class RoleItem extends UiPanelBase_1.UiPanelBase {
  ...
  async RefreshExternalByDataAsync(e) {
    void 0 !== e.AtlasPath && void 0 !== e.SkeletonDataPath && (await this.SetSpineAssetByPath(e.AtlasPath, e.SkeletonDataPath, this.GetSpine(0)), this.GetSpine(0).SetAnimation(0, "idle", !0), this.GetText(2)?.SetText(""))
  }
  RefreshText(e) {
