...
exports.MoonChasingModel = undefined;
...
class MoonChasingModel extends ModelBase_1.ModelBase {
  constructor() {
    ...
    this.HasEnteredMainViewFlag = false;
    this.E7s = new Map();
    this.HandbookRewardIdList = [];
    this.y7s = (e, t) => e.Goal - t.Goal;
    this.I7s = (e, t) => e.Sort === t.Sort ? e.Type - t.Type : e.Sort - t.Sort;
    this.vfa = undefined;
    this.Pwa = undefined;
  }
  OnInit() {
    ...
    for (const _ of ConfigManager_1.ConfigManager.MoonChasingMemoryConfig.GetAllMemoryInfo()) {
      ...
      switch (o.Type) {
        ...
        case 5:
          ...
          break;
        case 6:
          var a = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetUnlockHelpEditTeamDataList(false);
          o.Content = a.length.toString();
          break;
        case 7:
          {
            var a = t.X7s;
            var r = a?.s5n !== undefined && a.s5n !== 0;
            let e = 0;
            if (r) {
              n = ConfigManager_1.ConfigManager.BusinessConfig.GetDelegationConfig(a.s5n);
              o.Content = n.Title;
              e = a.D8n;
              n = ConfigManager_1.ConfigManager.BusinessConfig.GetEntrustTypeById(n.EntrustType);
              o.IconPath = n.Icon;
            } else {
        ...
        case 8:
          {
            var r = t.J7s;
            var i = r?.s5n !== undefined && r.s5n !== 0;
            let e = 0;
            if (i) {
              s = ConfigManager_1.ConfigManager.BusinessConfig.GetEntrustRoleById(r.s5n);
              o.Content = s.Name;
              e = r.D8n;
              o.IconPath = s.Icon;
            } else {
        ...
        case 9:
          {
            var i = t.Y7s;
            var l = i?.s5n !== undefined && i.s5n !== 0;
            let e = 0;
            if (l) {
              g = ConfigManager_1.ConfigManager.BusinessConfig.GetEntrustRoleById(i.s5n);
              o.Content = g.Name;
              e = i.D8n;
              o.IconPath = g.Icon;
            } else {
  ...
  GetFirstUnlockData() {
    ...
    if (e !== 0) {
      return [0, e];
    } else if ((e = ModelManager_1.ModelManager.MoonChasingBuildingModel.GetFirstUnLockBuildingData()) !== undefined) {
      return [1, e.Id];
    } else {
      return undefined;
    }
  ...
  get pfa() {
    var e;
    if (this.vfa === undefined) {
      e = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingDelegation, 0);
      this.vfa = e;
    }
    return this.vfa;
  }
  set pfa(e) {
    if (this.vfa !== e) {
      LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingDelegation, e);
      this.vfa = e;
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MoonChasingRefreshDelegationRedDot);
    }
  }
  ...
  CheckRoleUnlockRedDotState() {
    for (const e of ModelManager_1.ModelManager.MoonChasingBusinessModel.GetHelpEditTeamDataList()) {
      if (this.CheckRoleIdRedDotState(e.Id)) {
        return true;
      }
    }
    return false;
  ...
  ReadRoleIdUnlockFlag(e) {
    ModelManager_1.ModelManager.NewFlagModel.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingRoleUnlock, e);
    this.SaveRoleRedDot();
  }
  SaveRoleIdUnlockFlag(e) {
    ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingRoleUnlock, e);
    this.SaveRoleRedDot();
  }
  SaveRoleRedDot() {
    ModelManager_1.ModelManager.NewFlagModel.SaveNewFlagConfig(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingRoleUnlock);
  ...
  CheckMainlineRedDot() {
    for (const e of ConfigManager_1.ConfigManager.TaskConfig.GetAllMainLineTask()) {
      if (this.CheckQuestIdRedDotState(e.TaskId)) {
        return true;
      }
    }
    return false;
  ...
  CheckQuestIdRedDotState(e) {
    ...
    return t !== 0 && t !== 3 && !ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingQuestUnlock, e);
  }
  ReadQuestIdUnlockFlag(e) {
    return !!this.CheckQuestIdRedDotState(e) && (ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingQuestUnlock, e), this.SaveQuestRedDot(), true);
  }
  SaveQuestRedDot() {
    ModelManager_1.ModelManager.NewFlagModel.SaveNewFlagConfig(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingQuestUnlock);
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MoonChasingRefreshQuestRedDot);
  }
  get wwa() {
    var e;
    if (this.Pwa === undefined) {
      e = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingMemoryChecked, false);
      this.Pwa = e ?? false;
    }
    return this.Pwa;
  }
  set wwa(e) {
    if (this.Pwa !== e) {
      LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MoonChasingMemoryChecked, e);
      this.Pwa = e;
