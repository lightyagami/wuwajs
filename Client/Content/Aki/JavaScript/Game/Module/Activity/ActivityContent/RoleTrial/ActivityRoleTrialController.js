...
class ActivityRoleTrialController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.Y2e = e => {
      var t;
      e && (t = ActivityRoleTrialController.J2e()) && t.IsRolePreviewOn() && (e = t.TrialToIdMap.get(e)) && (t.CurrentRoleId = e)
    }, this.nye = () => {
      var e = ActivityRoleTrialController.J2e();
      e && e.IsRoleInstanceOn() && !ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance() && ActivityController_1.ActivityController.OpenActivityById(ActivityRoleTrialController.CurrentActivityId)
    }, this.z2e = e => {
      e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26075), e = {
      ...
      }, ItemRewardController_1.ItemRewardController.OpenExploreRewardView(ItemRewardDefine_1.ROLE_TRIAL_ERROR_RESULT, !1, void 0, void 0, void 0, [e]))
    }
  }
  OnRegisterNetEvent() {
  ...
  OnAddEvents() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RoleSystemChangeRole, this.Y2e), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldDoneAndCloseLoading, this.nye)
  }
  OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RoleSystemChangeRole, this.Y2e), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDoneAndCloseLoading, this.nye)
  }
  static J2e() {
  ...
  static RequestRoleInstanceReward(t) {
    ...
    e.Q6n = t, Net_1.Net.Call(19752, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 24138), e = this.J2e()) && (e.SetRewardStateByRoleId(t, 2), Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 37, "[角色试用活动]试用副本奖励领取成功", ["RoleId", t]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, ActivityRoleTrialController.CurrentActivityId))
    })
  }
  static async EnterRoleTrialDungeonDirectly(e, t, r) {
    ...
    return ModelManager_1.ModelManager.InstanceDungeonModel.InstanceEnterContentText.jah = t, InstanceDungeonController_1.InstanceDungeonController.PrewarTeamFightRequest(e, [], 0, 0)
  }
