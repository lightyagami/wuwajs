...
class LordGymActivityData extends ActivityData_1.ActivityBaseData {
  ...
  ReadRedDot() {
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, LORD_GYM_RED_DOT_CACHE_KEY, 0, 0, 1), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id)
  }
  CheckRedDot() {
    return 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, LORD_GYM_RED_DOT_CACHE_KEY, 0, 0)
  }
