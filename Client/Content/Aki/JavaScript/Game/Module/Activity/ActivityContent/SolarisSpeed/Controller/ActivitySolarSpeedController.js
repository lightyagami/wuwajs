...
class ActivitySolarSpeedController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(29764, this.g3_);
    Net_1.Net.Register(25337, this.C3_);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(29764);
    Net_1.Net.UnRegister(25337);
  }
  OnAddEvents() {
