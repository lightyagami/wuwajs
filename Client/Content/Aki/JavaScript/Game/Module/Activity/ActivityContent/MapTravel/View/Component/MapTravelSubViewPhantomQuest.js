...
class MapTravelSubViewQuest extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.ActivityBaseData = e, this.LevelSequencePlayer = void 0, this.AreaLayoutList = void 0, this.NeedDestroySelf = !0, this.sGe = () => {
  ...
  OnStart() {
    this.LevelSequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.AreaLayoutList = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(0), this.sGe)
  }
  async Refresh() {
    var t = this.ActivityBaseData.GetAllAreaData().filter(e => 0 < e.PhantomTaskIdSet.size);
    let [i, r] = [-1, -1];
    for (let e = 0; e < t.length; e++)
      for (const s of Array.from(t[e].PhantomTaskIdSet)) {
        if (this.ActivityBaseData.GetPhantomQuestDoneCheckState(s)) {
          i = e;
          break
        } - 1 === r && this.ActivityBaseData.GetPhantomQuestNewUnlockState(s) && (r = e)
      }
...
class AreaLayout extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e) {
    super(), this.ActivityBaseData = e, this.QuestLayout = void 0, this.sGe = () => {
  ...
  Refresh(e) {
    ...
    for (const o of t) {
      var s = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(o),
        ...
        s = ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreviewItemList(s.QuestReward)[0][1];
      3 === a && (i += s), r += s
    }
    this.QuestLayout.RefreshByData(t, void 0, !0), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), "TravelPhantomQuest_Progress", i, r)
  }
}
class QuestCardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e) {
    super(), this.ActivityBaseData = e, this.PhantomTaskId = 0, this.LevelSequencePlayer = void 0, this.UFe = () => {
      var e = 0 < this.mVl(),
        t = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(this.PhantomTaskId);
      e ? (this.ActivityBaseData.SaveFirstCheckRedDotState(2, this.PhantomTaskId), this.CVl(), ModelManager_1.ModelManager.MapModel.CreateTempMapMark(t.MapMarkId), e = {
        MarkId: t.MapMarkId,
        MarkType: 30
      }, ControllerHolder_1.ControllerHolder.WorldMapController.OpenView(1, !1, e)) : ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId(t.UnlockTips)
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  Refresh(e) {
    ...
    var e = ConfigManager_1.ConfigManager.ActivityMapTravelConfig.GetQuestConfig(e),
      ...
      i = 0 < t,
      t = 3 === t;
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), i ? e.Name : e.LockName), this.GetTexture(1).SetUIActive(i), i && this.SetTextureShowUntilLoaded(e.Texture, this.GetTexture(1)), this.GetItem(2).SetUIActive(t), this.CVl(), this.vjl()
  }
  CVl() {
