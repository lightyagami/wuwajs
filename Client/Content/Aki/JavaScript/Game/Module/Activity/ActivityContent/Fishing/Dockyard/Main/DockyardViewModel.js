...
class DockyardViewModel extends DockyardViewModelBase_1.DockyardViewModelBase {
  constructor() {
    super(...arguments), this.BackpackPanelModel = new DockyardTrawlBackpackPanelModel_1.DockyardTrawlBackpackPanelModel, this.ListPanelModel = new DockyardTrawlListPanelModel_1.DockyardTrawlListPanelModel
  }
}
