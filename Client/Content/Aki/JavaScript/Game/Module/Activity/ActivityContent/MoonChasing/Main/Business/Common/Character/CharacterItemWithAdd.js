...
class CharacterItemWithAdd extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.CharacterItem = void 0, this.Data = void 0, this.SequencePlayer = void 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.SequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.CharacterItem = new CharacterItem_1.CharacterItem, await this.CharacterItem.CreateThenShowByActorAsync(this.GetItem(0).GetOwner()), this.GetText(1)?.SetText("")
  }
  RefreshAddText() {
    0 < this.Data.ValueInterval ? this.GetText(1)?.SetText("+" + this.Data.ValueInterval) : this.GetText(1)?.SetText("")
  }
  Refresh(t, e, s) {
    this.Data = t, this.CharacterItem.Refresh(t), this.GetItem(2)?.SetUIActive(0 !== s)
  }
  RefreshProgress(t) {
  ...
  PlayStartAction() {
    this.CharacterItem.SetLightProgressWidth(), this.SequencePlayer.PlayLevelSequenceByName("Action01")
  }
  PlayAddAction() {
