...
class Spring25Model extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    return this.UVa = new Spring25ConfigContext_1.Spring25ConfigContext(this), this.xVa = new Spring25ProtocolContext_1.Spring25ProtocolContext(this), this.PVa = new Spring25UiContext_1.Spring25UiContext(this), !0
  }
  OnClear() {
  ...
  get BottomStateInInfoView() {
    return this.IsSkinRewarded ? 3 : this.UVa.TaskCount === this.xVa.FinishTaskCount ? void 0 === LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.Spring25FirstTimeTaskAllDone) ? 1 : 2 : 0
  }
  get SharePhotoPath() {
    var t = SettleRewardByActivityId_1.configSettleRewardByActivityId.GetConfig(this.CurrentActivityId);
    return (1 === ModelManager_1.ModelManager.PlayerInfoModel?.GetPlayerGender() ? t?.MalePhotoPath : t?.FemalePhotoPath) ?? ""
  }
  get NeedStartDialog() {
    return LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.Spring25FirstEnter, !0) && 0 === this.xVa.InvitedCount
  }
  ...
  SetLetterClickedBySignId(t, e) {
    ...
    (i = void 0 === i ? new Map : i).set(t, e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.Spring25FirstLetterClick, i)
  }
  SyncSpringSignDrawRoleResponse(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Spring25", 64, "同步邀请角色数据", ["response", t]);
    var e, i, t = t.WL_,
    ...
    for ([e, i] of r.TaskCache) {
      ...
      i.H6n === Proto_ActivityTaskState.Proto_ActivityTaskRunning && r.InvitedCount >= o && (i.H6n = Proto_ActivityTaskState.Proto_ActivityTaskFinish)
    }
  ...
  BuildActivitySubViewData() {
    return {
      ...
      IsMale: 1 === ModelManager_1.ModelManager.PlayerInfoModel?.GetPlayerGender(),
  ...
  BuildMainViewData(t = !1) {
    ...
    for ([e] of r.SignCfgMap) {
      ...
      void 0 !== s && (i.set(s, a.IsRoleInvitedById(e)), o.CurrentSignId !== e || t || (n = s))
    }
    return {
  ...
  BuildDialogueViewData() {
    var t, e = this.PVa.CurrentSignId;
    if (void 0 !== e) return t = this.I3l(e), e = this.Z2l(e), {
      IsOpening: !1,
      LeftSpineData: t[0],
      RightSpineData: t[1],
      ChatDataList: e
  ...
  BuildLetterListViewData() {
    ...
    var i = this.PVa.CurrentLetterSignId,
      i = (void 0 !== i && (t = this.UVa.GetLetterContentTextIdBySignId(i), e = this.UVa.GetLetterTitleTextIdBySignId(i)), {
  ...
  BuildEnvelopeViewData() {
    ...
    return {
      TitleTextId: void 0 === t ? void 0 : this.UVa.GetLetterTitleTextIdBySignId(t),
      InfoTextId: void 0 === t ? void 0 : this.UVa.GetLetterContentTextIdBySignId(t)
    }
  }
  VGl() {
    var t, e = [],
    ...
    for ([, t] of i.TaskCfgMap) {
      var a = t.Id,
        ...
        a = {
          ...
          RightTextId: o === Proto_ActivityTaskState.Proto_ActivityTaskRunning ? "Text_NotFinished_Text" : void 0
        };
      e.push(a)
    }
    return e.sort((t, e) => t.State === e.State ? t.TaskId - e.TaskId : t.State === Proto_ActivityTaskState.Proto_ActivityTaskFinish || e.State !== Proto_ActivityTaskState.Proto_ActivityTaskFinish && t.State === Proto_ActivityTaskState.Proto_ActivityTaskRunning ? -1 : 1), e
  }
  HGl() {
    var t, e = [];
    let i = -1;
    ...
    return -1 !== i && LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.Spring25FirstDoneTaskIndex, -1) < i && ((t = e[i]).IsBlink = !0, e[i] = t), e
  }
  jGl() {
    var t = this.UVa,
      e = this.PVa,
