...
class ActivityBeginnerTargetItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.aNe = [-1, ""], this.hNe = !1, this.lNe = -1, this.DataId = -1, this._Ne = void 0, this.uNe = () => {
      var e;
      if (this.hNe) switch (this.aNe[0] - 1) {
        case 0:
        ...
        case 1:
          ...
          r ? (r = {
            ...
            MarkId: r.MarkId,
            OpenFogId: 0
          }, WorldMapController_1.WorldMapController.OpenView(1, !1, r)) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 5, "配置了错误的鸣域新程", ["Type: ", this.aNe[0]], ["Parma: ", this.aNe[1]]);
          break;
        case 2:
          "RoleRootView" === this.aNe[1] ? RoleController_1.RoleController.OpenRoleMainView(0) : UiManager_1.UiManager.OpenView(this.aNe[1]);
          break;
        case 3:
          r = this.aNe[1];
        ...
        case 7:
          ...
          break;
        default:
          Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 5, "配置了错误的鸣域新程", ["Type: ", this.aNe[0]], ["type: ", this.aNe[1]])
      } else e = ConfigManager_1.ConfigManager.ConditionConfig.GetConditionGroupConfig(this.lNe).HintText, ScrollingTipsController_1.ScrollingTipsController.ShowTipsById(e)
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this._Ne = new SmallItemGrid_1.SmallItemGrid, this._Ne.Initialize(this.GetItem(2).GetOwner())
  }
  Refresh(e, r, i) {
    this.DataId = e;
    e = ConfigManager_1.ConfigManager.ActivityBeginnerBookConfig?.GetActivityBeginnerConfig(e);
    if (this.cNe(e), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), e.SourceTitle), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(6), e.SourceDesc), this.lNe = e.ConditionId, !(e.JumpTo.size <= 0))
  ...
  cNe(r) {
    switch (r.SourceType) {
      case 1:
        ...
        this._Ne?.Apply(e), this._Ne?.BindOnExtendToggleClicked(() => {
          var e = new WeaponTrialData_1.WeaponTrialData,
            e = (e.SetTrialId(r.SourceId), {
              WeaponDataList: [e],
              SelectedIndex: 0
            });
  ...
  SetFinish(e) {
    this.GetItem(0)?.SetUIActive(!e), this.GetItem(1)?.SetUIActive(e), this.GetItem(3)?.SetUIActive(e), this.GetButton(4)?.RootUIComp.SetUIActive(!e)
  }
}
