...
class ActivitySpring25Controller extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  async J2l() {
    ...
    var r = await Net_1.Net.CallAsync(22415, r);
    if (r !== undefined) {
      if (r.Q4n !== Proto_ErrorCode.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(r.Q4n, 28225);
      } else {
  ...
  async gWl() {
    ...
    var e = await Net_1.Net.CallAsync(21175, e);
    if (e !== undefined && e.Q4n !== Proto_ErrorCode.KRs) {
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 27995);
    }
  }
