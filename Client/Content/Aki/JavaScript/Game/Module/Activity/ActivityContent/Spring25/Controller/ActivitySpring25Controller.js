...
class ActivitySpring25Controller extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.OCl = void 0, this.NCl = () => {
      this.OCl?.SetResult()
    }
  }
  OnOpenView(e) {}
  ...
  HandleLetterClickInMainView() {
    var e = ModelManager_1.ModelManager.Spring25Model;
    e.IsLetterListViewAvailable ? (e.InitLetterSignIdForLetterListView(), UiManager_1.UiManager.OpenView("Spring25LetterListView", e.BuildLetterListViewData())) : ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId(Spring25Define_1.NO_LETTER_TIPS_TEXT_ID)
  }
  ...
  HandleOpenOpeningDialogViewInMainView() {
    LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.Spring25FirstEnter, !1);
  ...
  HandleConfirmClickInDialogueView() {
    var e = ModelManager_1.ModelManager.Spring25Model;
    UiManager_1.UiManager.CloseView("Spring25DialogueView"), e.NeedOpenEnvelopeView && UiManager_1.UiManager.OpenView("Spring25EnvelopeView", e.BuildEnvelopeViewData())
  }
  HandleOpenSkinPreview() {
    ...
    e && ControllerHolder_1.ControllerHolder.SkinController.OpenBuyRoleSkinPreviewDetailViewByRoleSkinData([e])
  }
  ...
  async HandleTryOpenShareViewAsync() {
    var e = ModelManager_1.ModelManager.Spring25Model;
    e.IsAllInvited && void 0 === this.OCl && (this.OCl = new CustomPromise_1.CustomPromise, await this.gWl(), await this.OCl.Promise, this.OCl = void 0, e = {
      ScreenShot: !1,
