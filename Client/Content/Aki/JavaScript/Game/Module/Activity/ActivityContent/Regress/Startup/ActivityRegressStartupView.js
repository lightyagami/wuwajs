...
class ActivityRegressStartupView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Lle = void 0, this.xMo = () => {
  ...
  OnBeforeShow() {
    ModelManager_1.ModelManager.ActivityRegressModel.AlreadyStartView = !0, ModelManager_1.ModelManager.ActivityRegressModel.RecordActivityRecallSplashFirstShow(), SplashScreenController_1.SplashScreenController.FinishCurTask(4), this.Lle.Start()
  }
  OnBeforeDestroy() {
    this.Lle.ShutDown()
  }
  GotoActivityViewAndCloseSelf() {
    ModelManager_1.ModelManager.ActivityRegressModel.SetFirstShowChecked(), this.CloseMe();
