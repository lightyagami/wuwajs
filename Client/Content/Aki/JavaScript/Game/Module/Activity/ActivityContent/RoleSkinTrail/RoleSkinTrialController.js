...
class RoleSkinTrialController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments), this.p7l = e => {
      e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23797), e = {
      ...
      }, ItemRewardController_1.ItemRewardController.OpenExploreRewardView(ItemRewardDefine_1.ROLE_SKIN_TRIAL_ERROR_RESULT, !1, void 0, void 0, void 0, [e]))
    }
  }
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(23797, this.p7l)
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(23797)
  }
  ...
  static RequestRoleSkinTrailInstanceReward(r, n) {
    ...
    e.v7l = n, Net_1.Net.Call(16387, e, e => {
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21634), e = ModelManager_1.ModelManager.ActivityModel.GetActivityById(r)) && (e.FinishRewardById(n), Log_1.Log.CheckInfo() && Log_1.Log.Info("Activity", 27, "[角色皮肤试用活动]试用副本奖励领取成功", ["id", n]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, r))
    })
  }
  static EnterRoleTrialDungeonDirectly(e, r, n) {
    ...
    ModelManager_1.ModelManager.InstanceDungeonModel.InstanceEnterContentText.y7l = r, InstanceDungeonController_1.InstanceDungeonController.PrewarTeamFightRequest(e, [], 0, 0)
  }
  static RequestRoleSkinTrialUiEndPush() {
    var e = Protocol_1.Aki.Protocol.Wp_.create();
    Net_1.Net.Send(23705, e)
  }
