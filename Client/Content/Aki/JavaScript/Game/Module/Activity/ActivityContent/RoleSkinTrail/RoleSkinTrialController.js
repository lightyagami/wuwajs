...
class RoleSkinTrialController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    ...
    this.p7l = e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 18614);
        e = {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(18614, this.p7l);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(18614);
  }
  ...
  static RequestRoleSkinTrailInstanceReward(r, n) {
    ...
    e.v7l = n;
    Net_1.Net.Call(15203, e, e => {
      if (e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 17138), e = ModelManager_1.ModelManager.ActivityModel.GetActivityById(r))) {
