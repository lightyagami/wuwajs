...
class RoleSkinTrialController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    ...
    this.p7l = e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29412);
        e = {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(29412, this.p7l);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(29412);
  }
  ...
  static RequestRoleSkinTrailInstanceReward(r, n) {
    ...
    Net_1.Net.Call(17667, e, e => {
      if (e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16303), e = ModelManager_1.ModelManager.ActivityModel.GetActivityById(r))) {
