...
class RoleSkinTrialController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    ...
    this.p7l = e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23797);
        e = {
  ...
  static RequestRoleSkinTrailInstanceReward(r, n) {
    ...
    e.v7l = n;
    Net_1.Net.Call(16387, e, e => {
      if (e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21634), e = ModelManager_1.ModelManager.ActivityModel.GetActivityById(r))) {
