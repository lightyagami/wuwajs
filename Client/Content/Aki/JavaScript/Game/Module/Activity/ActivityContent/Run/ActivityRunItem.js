...
class ActivityRunItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ScrollViewDelegate = void 0, this.GridIndex = 0, this.DisplayIndex = 0, this.bOe = void 0, this.HFe = 0, this.r3e = e => {
      e === this.HFe && this.n3e()
    }, this.JGe = () => {
  ...
  OnStart() {
    ...
    this.bOe = new GenericScrollViewNew_1.GenericScrollViewNew(e, () => this.JGe()), this.AddEventListener()
  }
  AddEventListener() {
  ...
  n3e() {
    ...
    this.GetText(2).SetUIActive(!1), this.GetButton(4).RootUIComp.SetUIActive(!1), this.GetItem(5).SetUIActive(!1), this.GetSprite(3).SetUIActive(!1), 0 === e ? this.GetText(2).SetUIActive(!0) : 1 === e ? (this.GetItem(5).SetUIActive(!0), this.GetButton(4).RootUIComp.SetUIActive(!0)) : 2 === e && this.GetSprite(3).SetUIActive(!0)
  }
  OnBeforeDestroy() {
