...
class ActivityRoleTrialData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.RoleIdList = [], this.RoleTrialIdList = [], this.TrialToIdMap = new Map, this.Z2e = new Map, this.CurrentRoleId = 0, this.eFe = 0
  }
  SetRoleTrialState(t) {
    this.eFe = t
  }
  ...
  PhraseEx(t) {
    this.CheckIfInShowTime() && (ActivityRoleTrialController_1.ActivityRoleTrialController.CurrentActivityId = t.s5n), this.RoleIdList.length = 0, this.RoleTrialIdList.length = 0;
    t = t.Vps;
    if (t)
      for (const o of t.Rps) {
        var e = exports.stateResolver[o.Lps],
          r = ConfigManager_1.ConfigManager.ActivityRoleTrialConfig.GetRoleTrialInfoConfigByRoleId(o.Q6n);
        this.RoleTrialIdList.push(r.TrialRoleId), this.RoleIdList.push(o.Q6n), this.TrialToIdMap.set(r.TrialRoleId, o.Q6n), this.Z2e.set(o.Q6n, e)
      }
  }
  ...
  GetRewardDataByRoleId(t) {
    ...
    if (e && e.RewardItem) {
      var r, o, i = this.GetRewardStateByRoleId(t),
        a = [];
