...
class ActivityRegressController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  RequestClaimScoreReward(r) {
    ...
    t.BVn = r;
    t.w6n = e;
    Net_1.Net.Call(18454, t, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26031);
        } else {
  ...
  Wl1(e, r) {
    ...
    i.k6n = r;
    i.gps = e;
    Net_1.Net.Call(15135, i, e => {
      if (e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 20070);
      }
    });
  }
  async RequestGachaInfo() {
    ...
    var e = await Net_1.Net.CallAsync(25663, e);
    if (e) {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
  ...
  RequestQuestionOpen(e) {
    ...
    e.SI1 = r.Id;
    Net_1.Net.Call(17448, e, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 24770);
        }
