...
class RewardInstanceController {
  ...
  async InitMainView() {
    this.uOn.InitTabViewComponent(), await Promise.all([this.uOn.InitTabComponent(), this.uOn.InitCaption(), this.uOn.InitGrandItem()])
  }
  RefreshTabList() {
    this.TabDataList = ModelManager_1.ModelManager.MoonChasingModel.GetRewardTabList(), this.uOn.SetTabState(0, !0, !0)
  }
