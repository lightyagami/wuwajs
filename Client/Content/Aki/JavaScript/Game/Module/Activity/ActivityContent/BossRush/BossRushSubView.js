...
class BossRushSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.pyn = void 0, this.LNe = void 0, this.DNe = void 0, this.UNe = void 0, this.ANe = void 0, this.xB_ = () => {
      ModelManager_1.ModelManager.BossRushModel.OnlyOpenRewardView = !0, BossRushController_1.BossRushController.OpenBossRushView(this.ActivityBaseData.Id)
    }, this.lDn = () => {
      this.BNe()
    }, this.DFe = () => {
      var e;
  ...
  OnRefreshView() {
    this.ActivityBaseData.LocalConfig && (this.Pqe(), this.mGe(), this.jqe(), this.VNe(), this.BNe(), this._Oe(), this.Eyn(), this.Qbe())
  }
  Qbe() {
  ...
  K8e() {
    RedDotController_1.RedDotController.BindRedDot("BossRushReward", this.GetItem(6), void 0, this.pyn.Id)
  }
  _Dn() {
  ...
  Pqe() {
    ...
    this.LNe.SetSubTitleVisible(t), t && this.LNe.SetSubTitleByTextId(i), this.DNe.SetContentByTextId(e)
  }
  jqe() {
    var e = this.ActivityBaseData.GetPreviewReward();
    this.UNe.SetTitleByTextId("BossRushCollectReward"), this.UNe.RefreshItemLayout(e)
  }
  OnTimer(e) {
