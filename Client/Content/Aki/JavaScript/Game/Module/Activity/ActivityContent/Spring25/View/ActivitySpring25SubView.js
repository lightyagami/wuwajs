...
class ActivitySpring25SubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.LNe = void 0, this.DNe = void 0, this.UNe = void 0, this.ANe = void 0, this.kZs = () => {
      ActivitySpring25Controller_1.ActivitySpring25Controller.Instance.HandleConfirmClickInActivitySubView()
    }, this.gkl = () => {
      var i = ModelManager_1.ModelManager.Spring25Model.BuildActivitySubViewData();
      this.GetText(5)?.SetText(i.Current), LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(6), i.TotalTextId, i.TotalTextArg)
    }
  }
  OnRegisterComponent() {
