...
exports.ActivitySpring25SubView = undefined;
const UE = require("ue");
...
class ActivitySpring25SubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    ...
    this.gkl = () => {
      ...
      LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(6), i.TotalTextId, i.TotalTextArg);
    };
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIItem], [2, UE.UIItem], [3, UE.UIItem], [4, UE.UIText], [5, UE.UIText], [6, UE.UIText], [7, UE.UITexture], [8, UE.UITexture]];
  }
  ...
  OnStart() {
    ...
    LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(6), t.TotalTextId, t.TotalTextArg);
    this.GetTexture(8)?.SetUIActive(t.IsMale);
    this.GetTexture(7)?.SetUIActive(!t.IsMale);
  }
  OnBeforeShow() {
    super.OnBeforeShow();
    this.ANe.FunctionButton.BindRedDot("Spring25Enter");
  }
  OnAfterHide() {
    super.OnAfterHide();
