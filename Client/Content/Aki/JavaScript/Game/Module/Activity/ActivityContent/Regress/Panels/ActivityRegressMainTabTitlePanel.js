...
class ActivityRegressMainTabTitlePanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.OnBackBtnCallBack = void 0, this.B6e = () => {
  ...
  UpdateIcon(i) {
    StringUtils_1.StringUtils.IsEmpty(i) || this.SetSpriteByPath(i, this.GetSprite(0), !1)
  }
  UpdateTitle(i) {
    var e = this.GetText(1);
    i ? (e.SetUIActive(!0), LguiUtil_1.LguiUtil.SetLocalTextNew(e, i.TextId, ...i.Args)) : e.SetUIActive(!1)
  }
}
