...
exports.FarmGoldController = undefined;
...
const ActivityInstanceEntranceData_1 = require("../../View/InstanceEntrance/ActivityInstanceEntranceData");
const FarmGoldData_1 = require("./FarmGoldData");
const FarmGoldSubView_1 = require("./FarmGoldSubView");
class FarmGoldController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    super(...arguments);
    this.fSn = () => {
      if (ModelManager_1.ModelManager.InstanceDungeonEntranceModel.IsFarmGoldInstanceDungeon()) {
    ...
    this.Pwl = e => {
      ...
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.FarmGoldRefreshRewardRedDot, e.w6n);
    ...
    this.xwl = e => {
      ...
      if (t) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29047);
      }
      var n = {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(22521, this.Pwl);
    Net_1.Net.Register(29047, this.xwl);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(22521);
    Net_1.Net.UnRegister(29047);
  }
  static RequestExitDungeon() {
    var e = new Protocol_1.Aki.Protocol.u0_();
    Net_1.Net.Call(17766, e, e => {
      if (!e) {
  ...
  static RequestFarmGoldPoint(t, n) {
    ...
    Net_1.Net.Call(22704, e, e => {
      if (e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23569);
  ...
  static RequestFarmGoldLevelPlay(t, n) {
    ...
    e.w6n = t;
    e.r6n = n;
    Net_1.Net.Call(28124, e, e => {
      if (e && e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29614);
      } else if (e && e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs) {
  ...
  static Bwl() {
    ...
    var t = new Protocol_1.Aki.Protocol.fks();
    t.s5n = 100805001;
    t.h5n = 33;
    t.bwl = new Protocol_1.Aki.Protocol.bwl();
    t.bwl.qwl = [];
    var n = ConfigManager_1.ConfigManager.FarmGoldConfig.GetAllFarmGoldActivity();
    for (const o of n) {
  ...
  static wwl(n) {
    ...
    var e = ActivityInstanceEntranceData_1.ActivityEntrancePointData.Create(e, 0, "FarmGoldReward", n.Id, n.GetRewardViewData(), () => n.GetScoreDesc(), () => {
    ...
    var t = ActivityInstanceEntranceData_1.ActivityEntranceDescInfoData.Create(e => n.GetLevelNameTextByIndex(e), e => n.GetLevelDescTextByIndex(e), e => n.GetLevelRecommendElementByIndex(e));
    var r = ConfigManager_1.ConfigManager.FarmGoldConfig.GetFarmGoldEntranceName();
    var o = ConfigManager_1.ConfigManager.FarmGoldConfig.GetFarmGoldEntranceSpritePath();
    var a = ConfigManager_1.ConfigManager.FarmGoldConfig.GetFarmGoldEntranceHelpId();
    var r = ActivityInstanceEntranceData_1.ActivityEntranceCaptionItemData.Create(r, o, a);
    var i = new Array();
    var _ = n.GetAllLevelData().length;
    for (let e = 0; e < _; e++) {
      var l = ActivityInstanceEntranceData_1.ActivityEntranceSelectItemBaseData.Create(e, e, undefined, e => n.GetLevelNameTextByIndex(e), e => n.GetLevelDescTextByIndex(e), e => n.GetLevelSubTitleTextByIndex(e), e => n.GetLevelLockStateByIndex(e), e => n.GetLevelInstanceDungeonIdByIndex(e), e => n.GetLevelUnlockTextByIndex(e), e => n.GetLevelFinishStateByIndex(e), e => n.GetLevelRecommendLevelByIndex(e), e => n.GetLevelDifficultIndexByIndex(e), e => n.GetLevelBgByIndex(e), e => {
    ...
    const s = ConfigManager_1.ConfigManager.FarmGoldConfig.GetFarmGoldAllDifficult();
    var v = s.length;
    var d = new Array();
    for (let e = 0; e < v; e++) {
      var m = ActivityInstanceEntranceData_1.ActivityEntranceDropDownContentData.Create(e, e => {
        ...
        t = s[t].Id;
        e = e.GetActivityEntranceSelectItemData().GetCurrentSelectData().GetInstanceDungeonId();
    ...
    o = ActivityInstanceEntranceData_1.ActivityEntranceDropDownData.Create(d, a.GetSelectDifficultIndex());
    a = ActivityInstanceEntranceData_1.ActivityEntranceMonsterPreviewData.Create(e => {
    ...
    return ActivityInstanceEntranceData_1.ActivityInstanceEntranceData.Create(e, t, c, r, o, a, () => {
      ...
      if (e &&= n.GetLevelDataByIndex(e.GetSelectDataIndex())) {
        this.DUc(e);
      }
    });
  }
  static DUc(e) {
    ...
    var t = e.GetInstId();
    if (ModelManager_1.ModelManager.InstanceDungeonEntranceModel.IsDungeonArchiveActivate(t) && ModelManager_1.ModelManager.InstanceDungeonEntranceModel.HasDungeonArchive(t)) {
      (t = new ConfirmBoxDefine_1.ConfirmBoxDataNew(281)).IsEscViewTriggerCallBack = false;
      t.FunctionMap.set(2, () => {
  ...
  static UUc(e) {
    ...
    FarmGoldData_1.FarmGoldData.CurrentSelectEntranceId = e.GetInstanceEntranceId();
  ...
  static CheckInFarmGold() {
    return ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(ModelManager_1.ModelManager.CreatureModel.GetInstanceId())?.InstSubType === 25 && ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance();
  }
}
