...
class CharacterNameItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    ...
    e.UseScoreName ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), t.ScoreName) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), t.Name), this.GetSprite(1).SetColor(UE.Color.FromHex(t.Color))
  }
  SetGoodItemActive(e) {
