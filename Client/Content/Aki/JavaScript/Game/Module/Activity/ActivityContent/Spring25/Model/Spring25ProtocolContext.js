...
class Spring25ProtocolContext extends ActivityData_1.ActivityBaseData {
  constructor(t) {
    super(), this.i5l = void 0, this.IsSkinRewarded = !1, this.CanInvite = !1, this.QGl = new Map, this.KGl = new Set, this.i5l = t
  }
  Dispose() {
    this.CanInvite = !1, this.QGl.clear(), this.KGl.clear()
  }
  PhraseEx(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Spring25", 64, "解析春节活动数据", ["ActivityData", t]);
    t = t.QS_;
  ...
  get FinishTaskCount() {
    let t = 0;
    for (var [, e] of this.QGl) e.H6n > Proto_ActivityTaskState.Proto_ActivityTaskRunning && ++t;
    return t
  }
  get InvitedCount() {
  ...
  ZVa(t) {
    ...
    this.IsSkinRewarded = t.AM_, Log_1.Log.CheckDebug() && Log_1.Log.Debug("Spring25", 64, "解析春节活动数据的结果", ["TaskCacheInternal", this.QGl], ["InvitedRoleSetInternal", this.KGl], ["IsSkinRewarded", this.IsSkinRewarded], ["CanInvite", this.CanInvite])
  }
  SyncTaskStateByTaskId(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Spring25", 64, "同步邀请角色奖励", ["rewarded id", t]);
    t = this.TaskCache.get(t);
    void 0 !== t && (t.lMs++, t.H6n = Proto_ActivityTaskState.Proto_ActivityTaskTaken)
  }
  SyncSkinReward() {
