...
class ActivityCorniceMeetingMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lqe = void 0, this.m3e = void 0, this.F6a = void 0, this.H3e = void 0, this.GOe = void 0, this.LHa = [], this.V6a = () => {
      var e = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData();
      e.GetIsShow(e.CurrentSelectLevelPlayId) && (e = e.GetLevelEntryData(e.CurrentSelectLevelPlayId)) && (e = {
        MarkId: e.GetMarkId(),
        MarkType: 24,
        OpenFogId: 0
      ...
      var t;
      e.has(ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.ActivityId) && (e = () => {
        this.CloseMe()
      }, (t = new ConfirmBoxDefine_1.ConfirmBoxDataNew(115)).FunctionMap.set(1, e), t.FunctionMap.set(0, e), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(t))
    }, this.H6a = e => {
      var t = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData();
      t.CurrentSelectLevelPlayId = e, this.m3e = t.GetLevelEntryData(e), this.j6a(), this.S3e(), this.W6a(), this.y3e(), this.PlaySequenceAsync("Switch", !0)
    }, this.f3e = () => {
      ...
      this.y3e();
      var e, t = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData();
      t && ((t = t.GetIsShow(t.CurrentSelectLevelPlayId)) && this.R3e !== t && (e = this.F6a.GetSelectedGridIndex(), this.F6a.RefreshGridProxy(e), this.W6a(), this.S3e()), this.R3e = t)
    }
  }
  OnRegisterComponent() {
  ...
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnClickActivityCorniceMeetingTab, this.H6a), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnActivityClose, this.g3e), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RefreshCorniceMeetingRedDot, this.VKi)
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnClickActivityCorniceMeetingTab, this.H6a), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnActivityClose, this.g3e), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RefreshCorniceMeetingRedDot, this.VKi)
  }
  OnBeforeShow() {
  ...
  U3e() {
    var e = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData();
    this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.lqe.SetCloseCallBack(this.Awe), this.lqe.SetHelpCallBack(this.D3e), this.lqe.SetTitle(e.GetTitle())
  }
  y3e() {
    var e = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData();
    e.GetIsShow(e.CurrentSelectLevelPlayId) || (e = e.GetLevelEntryData(e.CurrentSelectLevelPlayId), e = this.x3e(e.UnlockTime / 1e3, "ActiveToOpenTime"), this.GetText(8).SetText(e))
  }
  x3e(e, t) {
  ...
  Eua() {
    ...
    this.F6a.BindOnScrollValueChanged(e => {
      ...
      for (let e = 0; e < this.LHa.length; e++) {
        var r = this.LHa[e];
        r && (r = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData().GetLevelEntryData(r.LevelPlayId)) && (r.GetRedDot() && e < this.F6a.GetDisplayGridStartIndex() && (t = !0), r.GetRedDot()) && e > this.F6a.GetDisplayGridEndIndex() && (i = !0)
      }
  ...
  S3e() {
    ...
    this.GetVerticalLayout(4)?.RootUIComp.SetUIActive(e), this.GetItem(3).SetUIActive(!e), this.GetButton(7)?.RootUIComp.SetUIActive(e)
  }
  W6a() {
    var e, t, i = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData(),
      i = i.GetLevelEntryData(i.CurrentSelectLevelPlayId),
      r = TimeUtil_1.TimeUtil.GetTimeString(i.RemainTime);
    0 === i?.MaxScore ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), "ActivityCorniceMeetingScoreNoRecord") : (e = i.MaxScore, t = i?.GetMaxScoreConfig() ?? 0, LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), "Text_ItemCost_Text", (t < e ? t : e).toString(), t)), this.GetItem(9).SetUIActive(i.IsAllFinished()), this.GetText(6).SetText(r), this.GetItem(12).SetUIActive(i.IsUnlock())
  }
}
