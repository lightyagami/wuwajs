...
class ViewStateData {
  constructor(i, t, e) {
    this.ViewState = i, this.ExitFunc = t, this.EnterFunc = e, this.Params = []
  }
}
class ViewStateManager {
  constructor() {
    this.zOe = new Stack_1.Stack, this.ZOe = 0, this.kh = new Map, this.ZOe = 0, this.zOe.Push(this.ZOe)
  }
  ...
  BackToLastState() {
    var i = this.zOe.Pop(),
      i = this.kh.get(i),
      i = (i && i.ExitFunc?.(), this.ZOe = this.zOe.Peek(), this.kh.get(this.ZOe));
...
class BusinessViewController {
  constructor() {
    this.Yzt = void 0, this.jio = void 0, this.tke = new ViewStateManager, this.SkipToBuild = () => {
      var i = UiManager_1.UiManager.GetViewByName("MoonChasingMainView")?.OpenParam;
      i.SkipTarget = 2, i.BuildingBackToBusiness = !0, UiManager_1.UiManager.NormalResetToView("MoonChasingMainView")
    }, this.SkipToHelper = () => {
      ...
      1 === i.JumpType ? this.Vpa(i.JumpParam) : 2 === i.JumpType ? this.Hpa(i.JumpParam) : 3 === i.JumpType ? this.jpa(i.JumpParam) : ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("Moonfiesta_EntrustLock")
    }, this.BackToLastState = () => {
      0 === this.tke.CurrentState ? this.Yzt.CloseMe() : this.tke.BackToLastState()
    }, this.OpenHelpView = () => {
      1 === this.tke.CurrentState ? HelpController_1.HelpController.OpenHelpById(DELEGATE_HELPID) : HelpController_1.HelpController.OpenHelpById(MAINVIEW_HELPID)
    }
  }
  lke() {
    this.tke.RegisterViewState(0, void 0, this.Yzt.SkipToMainView), this.tke.RegisterViewState(1, void 0, this.Yzt.SkipToDelegationDetails)
  }
  RegisterView(i) {
  ...
  Show() {
    0 !== this.jio.SkipTarget ? this.tke.SwitchToState(this.jio.SkipTarget) : this.Yzt.Refresh();
    var i = 0 === this.tke.CurrentState;
  ...
  Vpa(i) {
    ...
    t.SetTextArgs(e), t.FunctionMap.set(2, () => {
