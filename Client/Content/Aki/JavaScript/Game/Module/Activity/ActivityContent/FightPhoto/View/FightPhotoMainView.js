...
class FightPhotoMainView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnStart() {
    ...
    this.IPd = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(15), this.wPd);
  ...
  OnTick(t) {
    ...
    if (this.W9d) {
      if (this.W9d.IsUnLock) {
        ...
        i = ModelManager_1.ModelManager.ActivityModel.GetRemainTimeText(this.W9d.UnlockTime, i) ?? "";
  ...
  RPd(t) {
    ...
    this.IPd.RefreshByData(t.TaskTargetText, () => {
      for (const t of this.IPd.GetLayoutItemList()) {
