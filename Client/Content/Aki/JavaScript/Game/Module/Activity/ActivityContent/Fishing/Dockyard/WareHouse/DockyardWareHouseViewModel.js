...
class DockyardWareHouseViewModel extends DockyardWareHouseViewModelBase_1.DockyardWareHouseViewModelBase {
  constructor() {
    super(...arguments), this.BackpackPanelModel = new DockyardWareHouseBackpackPanelModel_1.DockyardWareHouseBackpackPanelModel, this.ListPanelModel = new DockyardWareHouseListPanelModel_1.DockyardWareHouseListPanelModel, this.InGameplayFlow = !1, this.RequestCabinType = Protocol_1.Aki.Protocol.IXl.Proto_TempCabin, this.OnCloseClick = () => {
      this.InGameplayFlow ? this.View?.CloseMe() : ControllerHolder_1.ControllerHolder.FishingController.ShowConfirmBoxAndRequestFishingExit(e => {
        e && this.View?.CloseMe()
      })
    }
  }
  ...
  async BeforeStartAsync() {
    this.InGameplayFlow ? await this.View?.CreateQteSkipPanel() : await this.View?.CreateQuestPanel(!0)
  }
  GetItemBlockData(e) {
