...
class AvignonStageInfo {
  constructor(e, t) {
    this.StageId = e, this.Index = t, this.TaskMap = new Map, this.kja = !1, this.jOe = (e, t) => e.Status !== t.Status ? e.Status - t.Status : e.TaskId - t.TaskId, this.Nja = e => {
    ...
    if (e)
      for (const n of e) {
        ...
        r.JumpId = n.JumpId, r.TitleTextId = n.TaskName, r.RewardList = ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreviewItemList(n.TaskReward), r.ReceiveDelegate = this.Nja, this.TaskMap.set(n.TaskId, r)
      }
  }
  get StageState() {
    if (!this.kja) return 0;
    for (const e of this.TaskMap.values())
      if (!e.IsTaken) return 1;
    return 2
  }
  UnlockStage() {
    this.kja = !0
  ...
  HasNewStageFlag() {
    var e;
    return 1 === this.StageState && (e = ModelManager_1.ModelManager.AvignonModel.GetAvignonActivityId(), !ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(e, 0, this.StageId, 0, 0))
  }
  GetRewardState() {
  ...
  UpdateTask(e) {
    var t, r, n = this.TaskMap.get(e.s5n);
    n ? (t = n.IsFinished, n.Current = e.lMs, n.Target = e.j6n, n.Status = ActivityCommonDefine_1.taskStateResolver[e.H6n], r = n.IsFinished, !t && r && this.Fja(n.TaskId)) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Activity", 71, "[AvignonActivity] 活动Task不存在", ["StageId", this.StageId], ["TaskId", e.s5n])
  }
  SetTaskRewardGot(e) {
  ...
  Fja(e) {
    ...
    0 < e.JumpId && 8 === (e = ConfigManager_1.ConfigManager.SkipInterfaceConfig.GetAccessPathConfig(e.JumpId)).SkipName && (e = Number(e.Val1), ModelManager_1.ModelManager.MapModel.RemoveMapMarksByConfigId(7, e))
  }
}
