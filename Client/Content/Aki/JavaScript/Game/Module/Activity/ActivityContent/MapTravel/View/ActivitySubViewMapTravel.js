...
class ActivitySubViewMapTravel extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.ActivityBaseData = void 0, this.GeneralActivityInfo = void 0, this.ExpComponent = void 0, this.eje = () => {
  ...
  _Vl() {
    this.ExpComponent.SetProgress(this.ActivityBaseData.GetCurrentExp(), this.ActivityBaseData.GetCurrentTargetExp(), this.ActivityBaseData.TravelLevel === this.ActivityBaseData.MaxTravelLevel), this.ExpComponent.SetLevel(this.ActivityBaseData.TravelLevel)
  }
  ZGe() {
...
class MapTravelExpComponent extends UiPanelBase_1.UiPanelBase {
  ...
  SetProgress(e, i, t) {
    t ? (this.GetSprite(1).SetFillAmount(1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), "MapTravelLevelMax_Text")) : (this.GetSprite(1).SetFillAmount(MathUtils_1.MathUtils.Clamp(e / i, 0, 1)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), "MapTravelExp_Text", e, i))
  }
  SetLevel(e) {
