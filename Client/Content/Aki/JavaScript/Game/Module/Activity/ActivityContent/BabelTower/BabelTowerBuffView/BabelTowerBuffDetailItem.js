...
class BabelTowerBuffDetailItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.muc = void 0, this.Pe = void 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.muc = new BabelTowerBuffStarAndDescItem_1.BabelTowerBuffStarAndDescItem, await this.muc.CreateThenShowByResourceIdAsync("UiItem_TipsBuff", this.GetItem(4))
  }
  Update(e) {
  ...
  Refresh() {
    if (this.Pe) {
      let e = void 0,
        ...
        r = void 0,
        t = void 0;
      t = (this.Pe.IsDeTerm ? (a = BabelTowerDeTermById_1.configBabelTowerDeTermById.GetConfig(this.Pe.Id), e = a.NameText, i = a.Texture, r = a.DesText, a) : (a = BabelTowerBuffById_1.configBabelTowerBuffById.GetConfig(this.Pe.Id), e = a.NameText, i = a.Texture, r = a.DesText, a)).Star, LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e), this.muc.Refresh(t.toString(), this.Pe.ShowStar ?? !1, r), this.SetTextureByPath(i, this.GetTexture(2));
      var a = ModelManager_1.ModelManager.BabelTowerModel.CoverStarNumToQualityId(t),
        s = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_TipsQualityTypeLevel" + a),
        s = (this.SetTextureByPath(s, this.GetTexture(1)), ConfigManager_1.ConfigManager.InventoryConfig.GetItemQualityConfig(a).QualityColor),
