...
exports.RoleSkinTrialData = exports.RoleSkinTrailContentData = undefined;
...
class RoleSkinTrailContentData {
  ...
  GetRewardData() {
    var t = ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialInfoByRoleId(this.RoleId);
    if (t && t.DropId) {
      var e;
      var r;
      var n = [];
      for ([e, r] of ConfigManager_1.ConfigManager.RewardConfig.GetDropPackage(t.DropId).DropPreview) {
        var i = {
          Item: [{
            IncId: 0,
            ItemId: e
  ...
  GetRoleSkinTrialUiConfig() {
    return ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialUiConfigById(this.GetRoleSkinTrialInfo().UiConfigId);
  }
  Phrase(t) {
    this.Id = t.v7l;
    this.RoleId = ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialInfoById(this.Id).RoleId;
...
class RoleSkinTrialData extends ActivityData_1.ActivityBaseData {
  ...
  FinishRewardById(t) {
    ...
    if (t) {
      t.ChallengeState = Protocol_1.Aki.Protocol.Lps.a3_;
    }
  }
  ...
  GetConfig() {
    return ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialActivityByActivityId(this.Id);
  }
  ...
  GetInstanceIdById(t) {
    return ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialInfoById(t)?.InstanceId;
  }
  GetRoleList() {
  ...
  GetRewardStateById(t) {
    t = this.GetRoleSkinTrailContentDataById(t);
    if (t) {
      return t.ChallengeState;
    } else {
      return Protocol_1.Aki.Protocol.Lps.Proto_Running;
    }
  }
  GetRewardDataById(t) {
    t = this.GetRoleSkinTrailContentDataById(t);
    if (t) {
      return t.GetRewardData();
    }
  }
  ...
  GetRoleSkinTrialUiConfigById(t) {
    t = this.GetRoleSkinTrailContentDataById(t);
    if (t) {
      return t.GetRoleSkinTrialUiConfig();
    }
  }
  GetAccessIdById(t) {
    t = this.GetRoleSkinTrailContentDataById(t);
    if (t) {
      return t.GetAccessId();
    } else {
      return 0;
    }
  }
