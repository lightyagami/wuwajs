...
class RoleSkinTrailContentData {
  constructor() {
    this.RoleId = 0, this.Id = 0, this.ChallengeState = Protocol_1.Aki.Protocol.Lps.Proto_Running
  }
  GetRewardData() {
  ...
  Phrase(t) {
    this.Id = t.v7l, this.RoleId = ConfigManager_1.ConfigManager.RoleSkinTrialConfig.GetRoleSkinTrialInfoById(this.Id).RoleId, this.ChallengeState = t.Lps
  }
}
...
class RoleSkinTrialData extends ActivityData_1.ActivityBaseData {
  ...
  GetExDataRedPointShowState() {
    for (const t of this.S7l)
      if (t.ChallengeState === Protocol_1.Aki.Protocol.Lps.Proto_WaitTakeReward) return !0;
    return !1
  }
}
