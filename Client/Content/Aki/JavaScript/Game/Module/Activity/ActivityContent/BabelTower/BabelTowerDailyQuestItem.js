...
class BabelTowerDailyQuestItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.BOe = 0, this.Wec = void 0, this.Qec = void 0, this.jWt = () => {
      ...
      e && (ModelManager_1.ModelManager.BabelTowerModel.LevelChoseHandle = e.JumpToLevelId, UiManager_1.UiManager.IsViewHide("BabelTowerHardLevelChoseView") ? UiManager_1.UiManager.NormalResetToView("BabelTowerHardLevelChoseView", () => {
        UiManager_1.UiManager.CloseView("BabelTowerQuestView")
      }) : UiManager_1.UiManager.NormalResetToView("BabelTowerMainView", () => {
        UiManager_1.UiManager.OpenView("BabelTowerHardLevelChoseView", void 0, () => {
          UiManager_1.UiManager.CloseView("BabelTowerQuestView")
        })
      }))
    }
  ...
  OnStart() {
    this.GetText(4).SetUIActive(!1), this.Wec = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(1), this.jWt), this.Qec = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(6), this.xDo)
  }
  Refresh(e, r, i) {
    this.BOe = e;
    ...
    if (o) {
      ...
      var t = 0 < o.DropId ? ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreviewItemList(o.DropId) : [];
      ...
      var t = BabelTowerController_1.BabelTowerController.GetBabelTowerData().DailyQuest.get(e)?.H6n ?? Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskRunning,
        a = (this.GetButton(3).RootUIComp.SetUIActive(t === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskFinish), this.GetButton(5).RootUIComp.SetUIActive(t === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskRunning), this.GetItem(8).SetUIActive(t === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskTaken), []);
