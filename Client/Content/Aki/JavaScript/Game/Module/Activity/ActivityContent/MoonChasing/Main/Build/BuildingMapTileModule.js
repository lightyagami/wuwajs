...
class BuildingMapTileModule extends UiPanelBase_1.UiPanelBase {
  constructor(i, e) {
    super(), this.NeedLoadingFixRole = i, this.NeedLoadingShowRoleItem = e, this.lRn = new BuildingMapTileMgr_1.BuildingMapTileMgr, this.MapLayout = void 0, this._Rn = new Map, this.qKs = [], this.WIa = void 0, this.uRn = () => new TileItem(this.lRn)
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UILayoutBase],
  ...
  GetGuideUiItemAndUiItemForShowEx(e) {
    if (!(e.length < 2)) {
      let i = 0;
      i = "CanLevelUp" === e[1] ? ModelManager_1.ModelManager.MoonChasingBuildingModel.GetFirstCanLevelUpBuildingId() ?? 0 : parseInt(e[1]);
  ...
  async WCa() {
    var i = [];
    for (const e of this.MapLayout.GetLayoutItemList()) i.push(e.RefreshAsync());
    await Promise.all(i)
  }
  Sga() {
    var i = [];
    return i.push(this.GetItem(3)), i.push(this.GetItem(4)), i.push(this.GetItem(5)), i.push(this.GetItem(6)), i.push(this.GetItem(7)), i.push(this.GetItem(8)), i.push(this.GetItem(9)), i.push(this.GetItem(10)), i.push(this.GetItem(11)), i.push(this.GetItem(12)), i
  }
  async mRn() {
    var t = this.Sga(),
      s = [],
      a = ModelManager_1.ModelManager.MoonChasingBuildingModel.GetBuildingConfigListBySort();
    for (let i = 0, e = a.length; i < e; i++) {
      var r = t[i],
        o = a[i].Id,
        n = new BuildingItem_1.BuildingItem(o);
      this._Rn.set(o, n), s.push(n.CreateThenShowByResourceIdAsync("UiItem_BuildItem", r))
    }
    await Promise.all(s)
  }
  async uyi(i, e) {
    var t = new BuildingRoleItem_1.BuildingRoleItem;
    this.qKs.push(t), await t.CreateThenShowByResourceIdAsync("UiItem_RoleTalk", i), await t.RefreshSpine(e)
  }
  GKs(e, t) {
    var s = new Set,
      a = [];
    ...
    if (this.NeedLoadingFixRole) {
      ...
      if (i && 0 !== i.NpcCount) {
        ...
        var t = e.AttachChildren,
          s = t.Num(),
          a = [],
          r = ModelManager_1.ModelManager.MoonChasingBusinessModel.GetUnlockHelpEditTeamDataList(!0),
  ...
  async QIa() {
    ...
    i.SetUIActive(!1), this.NeedLoadingShowRoleItem && (this.WIa = new BuildingMapShowRoleModule_1.BuildingMapShowRoleModule, await this.WIa.CreateByActorAsync(i.GetOwner()), this.WIa.SetActive(!0))
  }
  ...
  SetAllBuildingExhibitionMode(i) {
    for (const e of this._Rn.values()) e.SetExhibitionMode(i), e.SetInteractive(!i)
  }
