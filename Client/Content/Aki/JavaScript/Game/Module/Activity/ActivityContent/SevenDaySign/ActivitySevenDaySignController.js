...
exports.ActivitySevenDaySignController = undefined;
...
class ActivitySevenDaySignController extends ActivityControllerBase_1.ActivityControllerBase {
  constructor() {
    ...
    this.w3e = e => {
      if (Log_1.Log.CheckInfo()) {
        Log_1.Log.Info("Activity", 37, "[ActivitySevenDaySign][OnNotify]收到签到状态通知", ["ActivityId", e.w6n], ["SignIndex", e.c5n], ["SignState", e.zps]);
      }
      ModelManager_1.ModelManager.ActivityModel.GetActivityById(e.w6n)?.UpdateActivityData(e);
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(20109, this.w3e);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(20109);
  }
  OnOpenView(e) {}
    ...
    switch (t.Type) {
      ...
      default:
        if (Log_1.Log.CheckError()) {
          Log_1.Log.Error("Activity", 37, "签到活动类型配置错误", ["Type", t.Type]);
        }
        return "";
    }
  }
  OnCreateSubPageComponent(e) {
    ...
    if (!t) {
      if (Log_1.Log.CheckError()) {
        Log_1.Log.Error("Activity", 37, "签到活动未查到对应配置", ["Id", e.Id]);
      }
  ...
  static GetRewardByDay(t, i) {
    ...
    e.w6n = t;
    e.c5n = i;
    Net_1.Net.Call(27614, e, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28577);
      } else {
