...
class ActorData {
  ...
  get Valid() {
    var t;
    return !!this.ValidInternal && (this.IsPlayer() ? ModelManager_1.ModelManager.SceneTeamModel?.GetCurrentEntity?.Valid ?? false : !!(t = EntitySystem_1.EntitySystem.Get(this.EntityId)) && t.Valid && t.IsInit);
  }
  set Valid(t) {
...
class PlotTemplate {
  constructor() {
    ...
    this.Z2d = new DelayActionManager();
    this.Uld = false;
    this.NP1 = new Map();
  }
  get IsInTemplate() {
  ...
  async VP1() {
    var t = ControllerHolder_1.ControllerHolder.FlowController.GetNameAction("ShowTalk");
    if (t.length !== 0) {
      var e = new Array();
      for (const o of t) {
        for (const s of o.Params.TalkItems) {
          if (s.ActorMontageArray) {
            for (const r of s.ActorMontageArray) {
              if (r?.MontageId) {
                var i = r.ActorIndex === this.dJi ? this.PJi(r.MontageId) : r.MontageId;
                let t = undefined;
                if ((t = r.IsAbpMontage ? ModelManager_1.ModelManager.PlotModel.GetAbpMontageConfig(i) : ModelManager_1.ModelManager.PlotModel.GetMontageConfig(i))?.ActionMontage) {
      ...
      if (!(t >= e.length)) {
        ...
        if (this._Ws(i)) {
          if (o = i.Entity.GetComponent(3)) {
            ...
            o.ClearInput();
            if ((s = i.Entity.GetComponent(43))?.Valid) {
              s.StopAllSkills("PlotTemplate.ControlActor");
            }
            o.SetActorVelocity(Vector_1.Vector.ZeroVectorProxy);
            if ((s = i.Entity.GetComponent(188))?.Valid) {
              this.Dwm(a, undefined);
            }
            if ((r = i.Entity.GetComponent(73))?.Valid && (a.OriginMoveSync = r.GetEnableMovementSync(), a.OriginMoveSync)) {
            ...
            if (t === this.dJi) {
              o.Entity.GetComponent(86).HideWeapon(-1, true, false, false, 0, "PlotTemplate.ControlActor");
              if (!this.EJi) {
              ...
              if ((r = i.Entity.GetComponent(199))?.Valid) {
                a.OriginEnableLookAt = r.OpenLookAt;
                r.SetLookAtPlayerEnabled(false);
                r.OnNpcInPlot(true);
                a.PositionLocked = r.GetIsUseFixLocation();
              }
              if ((r = i.Entity?.GetComponent(50))?.Valid && (a.OriginEnableAi = r.IsAiDriver && r.IsEnabled(), a.OriginEnableAi)) {
              ...
              if ((r = i?.Entity?.GetComponent(323)) && r.GetIfHanding()) {
                r.OnlyStopAiMove();
                a.HoldingHands = true;
              }
            }
    ...
    if (this.nx.IsBackground) {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        if (s.Valid) {
          ...
          if (this.Uld && o.SeqFacePath && t !== this.dJi) {
            i.push(this.Bld(s, o.SeqFacePath));
          }
        } else if (Log_1.Log.CheckWarn()) {
      ...
      if (n.Index !== ACTOR_EMPTY_INDEX && !(n.Index >= this.DJi.length)) {
        ...
        if (l.Valid) {
          if (!l.PositionLocked) {
            ...
            if (c) {
              var m;
              var d = ModelManager_1.ModelManager.CreatureModel.GetEntityById(l.EntityId);
              if (d) {
                HoldingHandsController_1.HoldingHandsController.ForceNoLerpNextUpdate(d);
              }
              if (this.fuc) {
                if (e && n.Offset) {
                  this.qJi(n.Offset);
                  ...
                  a.Set(r.X, r.Y, r.Z);
                  _.Yaw = (d.A + this.nJi + 180) % 360 - 180;
                  _.Roll = 0;
                  _.Pitch = 0;
                }
                d = a.Z;
                ...
                if (e && n.Offset) {
                  ...
                  this.rJi.TransformPosition(s, r);
                  a.Set(r.X, r.Y, r.Z);
                  d = Rotator_1.Rotator.Create(0, d.A, 0);
                  m = Rotator_1.Rotator.Create(0, 0, 0);
                  this.rJi.TransformRotation(d, m);
                  _.Roll = (m.Roll + 180) % 360 - 180;
                  _.Pitch = (m.Pitch + 180) % 360 - 180;
                  _.Yaw = (m.Yaw + 180) % 360 - 180;
                }
                d = Vector_1.Vector.Create(a);
                m = Vector_1.Vector.Create(a);
                this.kJi(m, c);
                m.Subtraction(d, h);
                d = _.RotateVectorDouble(new UE.VectorDouble(0, 0, c.Actor.CapsuleComponent.GetScaledCapsuleHalfHeight()));
                a.X += d.X;
                a.Y += d.Y;
                a.Z += d.Z;
              }
              var d = this.FJi(l.Pos, a.X, a.Y, a.Z, _.Yaw);
              l.Pos.X = a.X;
              l.Pos.Y = a.Y;
              l.Pos.Z = a.Z;
              l.Pos.A = _.Yaw;
              ...
              if (!this.nx.IsBackground) {
                ...
                if (d) {
                  ...
                  if (l.IsPlayer()) {
                    if (this.VJi(c.ActorLocationProxy, l.Pos)) {
  ...
  WJi() {
    for (const t of this.DJi) {
      if (t.Valid && t.Visible) {
        EntitySystem_1.EntitySystem.Get(t.EntityId)?.GetComponent(188)?.StartForceDisableAnimOptimization(0);
      }
    }
  }
    ...
    for (let t = 0; t < this.DJi.length; t++) {
      ...
      if (o.Valid) {
        ...
        if (r) {
          ...
          var a = s.GetComponent(188);
          var _ = a?.MainAnimInstance;
          if (ObjectUtils_1.ObjectUtils.IsValid(_)) {
            this.Dwm(o, undefined);
          }
          var _ = s.GetComponent(73);
          ...
          if (t === this.dJi) {
            ...
            if ((_ = s?.GetComponent(50))?.Valid && o.OriginEnableAi) {
              _.EnableAi("Plot Control Ai");
            }
            if ((_ = s.GetComponent(199))?.Valid) {
            ...
            if ((_ = s?.GetComponent(323)) && _.GetIsBeHoldingHands()) {
              _.OnlyStartAiMove();
            }
  ...
  async KJi(e, i = false) {
    if (!ModelManager_1.ModelManager.AutoRunModel.IsInLogicTreeGmMode() && (e.IsPlayer() || !e.PositionLocked)) {
      ...
      var h = new UE.Rotator(0, 0, 0);
      let t = false;
      if (i && e.IsPosReset) {
        h.Yaw = e.OriginPos.A;
        h.Roll = e.OriginPos.Roll;
        h.Pitch = e.OriginPos.Pitch;
        _.Set(e.OriginPos.X, e.OriginPos.Y, e.OriginPos.Z);
        t = true;
      } else if (this.nx.IsBackground) {
        h.Yaw = e.Pos.A;
        h.Roll = e.Pos.Roll;
        h.Pitch = e.Pos.Pitch;
        _.Set(e.Pos.X, e.Pos.Y, e.Pos.Z);
        t = true;
      }
      if (t) {
        ...
        if (this.EJi) {
          ...
          await TeleportController_1.TeleportController.TeleportToPositionNoLoading(_.ToUeVector(), h, "模板演出结束设置位置", false);
        } else {
          o.SetActorRotation(h, "模板演出结束设置位置", false);
          o.SetInputRotator(h);
          o.FixBornLocation("模板演出结束设置位置", true, _, false);
          if (i?.GetComponent(323)?.GetIfHanding()) {
  ...
  async HandleTemplateShowTalk(t) {
    ...
    if (this.IsInTemplate) {
      ...
      if (!this.nx.IsBackground) {
        ...
        this.tOd(t.ActorFaceExpressionArray);
      }
    }
  }
  J2_(e) {
  ...
  Z2_(t) {
    if (t) {
      if (this.Y2_) {
        ...
        this.Y2_ = e.Promise;
        ControllerHolder_1.ControllerHolder.PlotController.NextPriority2(() => {
  ...
  XJi(t, e, i) {
    ...
    for (const h of this.DJi) {
      if (!!h.Valid && !h.Visible && !h.LookLocked) {
        if (EntitySystem_1.EntitySystem.Get(h.EntityId)?.GetComponent(188)?.Valid) {
          this.Dwm(h, undefined);
        }
      }
    }
    for (const n of this.mJi) {
      if (n.Index !== ACTOR_EMPTY_INDEX) {
        ...
        var a;
        var _;
        if (l.Valid && (_ = EntitySystem_1.EntitySystem.Get(l.EntityId)?.GetComponent(188))?.Valid) {
          a = l.LookLocked;
          if ((!r.has(n.Index) || !this.Iia(_, r.get(n.Index), l, o)) && !a) {
            if (this.cJi === "_CU" && n === this.mJi[this.uJi]) {
              this.Dwm(l, undefined);
  ...
  wJi(t, e, i, o, s = 0, r) {
    ...
    switch (e.Type) {
      ...
      case 2:
        ...
        if (n?.IsInit) {
          const c = n.Entity.GetComponent(3) ?? n.Entity.GetComponent(214);
          _ = h.Lock ?? false;
          a = () => {
            this.Dwm(i, c);
          };
  ...
  $Ji(t) {
    ...
    for (const a of this.DJi) {
      ...
      EntitySystem_1.EntitySystem.Get(a.EntityId)?.GetComponent(188)?.MainAnimInstance?.StopSlotAnimation(0, SequenceDefine_1.ABP_Mouth_Slot_Name);
    }
    var e = new Set();
    if (t) {
      var i = [...t];
  ...
  ij_(t, e) {
    ...
    if (t.IsPlayer()) {
      i.GetComponent(47).MontageManager.PlayMontage(e);
    } else {
      i.GetComponent(49).PlayPerformMontage(1, e);
    }
  }
  rj_(t, e) {
    var i = EntitySystem_1.EntitySystem.Get(t.EntityId);
    if (t.IsPlayer()) {
      i.GetComponent(47).MontageManager.StopMontage(e);
    } else {
      i.GetComponent(49).StopPerformMontage(1, e);
    }
  }
  PJi(t) {
  ...
  tzi(t) {
    var e = EntitySystem_1.EntitySystem.Get(t.EntityId)?.GetComponent(188)?.MainAnimInstance;
  ...
  izi(t) {
    var e;
    var i = EntitySystem_1.EntitySystem.Get(t.EntityId)?.GetComponent(188)?.MainAnimInstance;
    if (ObjectUtils_1.ObjectUtils.IsValid(i)) {
  ...
  rzi(t, e, i = 1) {
    var o;
    if (ObjectUtils_1.ObjectUtils.IsValid(e) && this.IsInTemplate && (o = EntitySystem_1.EntitySystem.Get(t.EntityId)?.GetComponent(188)?.MainAnimInstance, ObjectUtils_1.ObjectUtils.IsValid(o))) {
    ...
    if (this.IsInTemplate && !!i.PlayVoice && !!i.WhoId && (!i || i.Type === "Talk") && !StringUtils_1.StringUtils.IsEmpty(i.TidTalk) && !i.NoMouthAnim) {
      ...
      if (t.Style?.Type !== "InnerVoice") {
        ...
        if (o?.Valid && o?.Visible) {
          const s = EntitySystem_1.EntitySystem.Get(o.EntityId)?.GetComponent(188)?.MainAnimInstance;
          if (s) {
  ...
  szi(t, e) {
    ...
    if (s?.Valid) {
      if (t.IsPlayer()) {
        ...
        o.GetComponent(188).MontageManager.StopMontage({
          Method: 0,
          BlendOutTime: 0.5
        });
        s.SetInputRotator(t);
      } else {
        o.GetComponent(49).PerformTurn(1, {
          TargetLocation: e
        });
      }
    }
  ...
  OnFinishShowTalk() {
    if (this.IsInTemplate) {
      for (const e of this.DJi) {
        ...
        var t = EntitySystem_1.EntitySystem.Get(e.EntityId)?.GetComponent(188)?.MainAnimInstance;
        if (!ObjectUtils_1.ObjectUtils.IsValid(t)) {
          return;
        }
  ...
  eOd(t) {
    ...
    var t = EntitySystem_1.EntitySystem.Get(t.EntityId)?.GetComponent(188);
      ...
      for (const e of t) {
        ...
        if (i.Valid) {
          if (e.FaceExpression.Type === IAction_1.EActorFaceExpressionType.Play) {
            ...
            this.Z2d.AddActionProxy(i.PbDataId, e.FaceExpression.DelayTime, () => {
              if (i.IsPlayer()) {
                this.iOd(i, o);
              } else {
          ...
          } else if (e.FaceExpression.Type === IAction_1.EActorFaceExpressionType.Stop && (this.Z2d.AddActionProxy(i.PbDataId, e.FaceExpression.DelayTime, () => {
            if (i.IsPlayer()) {
              this.eOd(i);
            } else {
              i.FaceChangeManager?.ResetFacialExpressionOuter();
  ...
  Dwm(t, e) {
    var t = EntitySystem_1.EntitySystem.Get(t.EntityId);
    var i = t?.GetComponent(188);
    var t = t?.GetComponent(199);
    if (i) {
      if (t) {
        t.SightTarget(e, 5);
        if (e instanceof Vector_1.Vector) {
          i.SetSightLimit([-90, 90], [-90, 90]);
        } else {
          i.ResetSightLimit();
        }
      } else if (e instanceof Vector_1.Vector) {
        i.SetSightLimit([-90, 90], [-90, 90]);
        i.SetSightTargetPoint(e);
      } else {
        i.ResetSightLimit();
        i.SetSightTargetItem(e);
      }
    }
  }
}
