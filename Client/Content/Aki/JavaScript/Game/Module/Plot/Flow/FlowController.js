...
const UiManager_1 = require("../../../Ui/UiManager"),
  ...
  assistantMap = (exports.LOCAL_FLOWINCID = -1, {
    [0]: void 0,
    1: void 0,
    2: void 0,
    3: void 0
...
class FlowController extends ControllerWithAssistantBase_1.ControllerWithAssistantBase {
  ...
  static RegisterAssistant() {
    this.AddAssistant(0, new FlowServerNotifyCenter_1.FlowServerNotifyCenter), this.AddAssistant(1, new FlowActionCenter_1.FlowActionCenter), this.AddAssistant(2, new FlowActionRunner_1.FlowActionRunner), this.AddAssistant(3, new FlowLaunchCenter_1.FlowLaunchCenter)
  }
  static cYt(t) {
  ...
  static OpenPlotReviewView() {
    ...
    return t && 0 !== t.length ? (t = this.CreatePlotReviewViewData(), UiManager_1.UiManager.OpenView("PlotReviewView", t), !0) : (ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("PlotView_001"), !1)
  }
