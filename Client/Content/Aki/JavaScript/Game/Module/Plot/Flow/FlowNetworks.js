...
class FlowNetworks {
  static Register() {
    Net_1.Net.Register(19164, this.m$i);
    Net_1.Net.Register(18144, this.d$i);
    Net_1.Net.Register(16595, this.C$i);
  }
  static UnRegister() {
    Net_1.Net.UnRegister(19164);
    Net_1.Net.UnRegister(18144);
  ...
  static RequestGmFinish() {
    ...
    o.VVn = 0;
    o.P8n = "@skipflow";
    Net_1.Net.Call(29900, Protocol_1.Aki.Protocol.Gzn.create(o), o => {});
  }
  static RequestAction(o, t, e) {
    var r = Protocol_1.Aki.Protocol.trs.create();
    r._Hn = o;
    r.uHn = t;
    Net_1.Net.Call(17181, r, o => {
      if (e) {
        e();
      }
      FlowNetworks.g$i(o.Cvs, 15116);
    });
  }
