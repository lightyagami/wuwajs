  ...
  OnExecute() {
    ...
    switch (e.Type) {
      case IAction_1.EChangeEntityState.Directly:
        a = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e.State), o = [e.EntityId];
        break;
      case IAction_1.EChangeEntityState.BatchDirectly:
        a = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e.State), o = e.EntityIds;
        break;
      case IAction_1.EChangeEntityState.Loop:
        ControllerHolder_1.ControllerHolder.FlowController.LogError("不支持的切换实体状态")
    }
    void 0 !== a ? WaitEntityTask_1.WaitEntityTask.CreateWithPbDataId("FlowActionChangeEntityState.OnExecute", o, e => {
      for (const t of o) ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(t)?.IsInit && LevelGeneralCommons_1.LevelGeneralCommons.PrechangeStateTag(t, a, "ShowInPlotSequence");
