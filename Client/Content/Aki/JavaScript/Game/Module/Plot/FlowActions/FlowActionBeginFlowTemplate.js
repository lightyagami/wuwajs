...
class FlowActionBeginFlowTemplate extends FlowActionBase_1.FlowActionBase {
  OnExecute() {
    "LevelC" !== ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel || ModelManager_1.ModelManager.PlotModel.IsInTemplate() ? this.FinishExecute(!0) : ModelManager_1.ModelManager.PlotModel.StartPlotTemplate(this.ActionInfo.Params, this.Context, () => {
