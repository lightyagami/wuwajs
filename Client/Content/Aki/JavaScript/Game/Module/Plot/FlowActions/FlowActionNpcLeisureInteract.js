    ...
    if (e) {
      switch (e.Option.Type) {
        ...
        case IAction_1.ENpcLeisureInteract.SwingGetUp:
          ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.Option.TargetNpcId)?.Entity?.GetComponent(306)?.ExitLoopSwing();
          break;
        case IAction_1.ENpcLeisureInteract.Swing:
          ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.Option.TargetNpcId)?.Entity?.GetComponent(306)?.StartSwing(e.Option.SwingDa, e.Option.EntityId, e.Option.SkipSitDown);
      }
