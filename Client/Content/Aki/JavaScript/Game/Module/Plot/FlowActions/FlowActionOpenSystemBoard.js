...
class FlowActionOpenSystemBoard extends FlowActionLevelAsyncAction_1.FlowActionLevelAsyncAction {
  OnExecute() {
    ModelManager_1.ModelManager.SequenceModel.IsPlaying && ControllerHolder_1.ControllerHolder.FlowController.EnableSkip(!1), super.OnExecute()
  }
  OnBackgroundExecute() {
    this.FinishExecute(!0)
  }
  OnActionFinish(e) {
    ModelManager_1.ModelManager.SequenceModel.IsPlaying && ControllerHolder_1.ControllerHolder.FlowController.EnableSkip(!0), this.FinishExecute(!0)
  }
}
