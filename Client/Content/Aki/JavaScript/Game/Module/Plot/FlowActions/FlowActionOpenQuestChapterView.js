...
class FlowActionOpenQuestChapterView extends FlowActionBase_1.FlowActionBase {
  ...
  OnExecute() {
    ...
    if (t) {
      ...
      e ? GeneralLogicTreeUtil_1.GeneralLogicTreeUtil.OpenQuestChapterView(t, e, this.$Ge) : Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 18, "非任务系统不可使用章节提示事件")
    }
  }
}
