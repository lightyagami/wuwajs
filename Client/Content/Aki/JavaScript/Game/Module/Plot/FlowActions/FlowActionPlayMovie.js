...
class FlowActionPlayMovie extends FlowActionBase_1.FlowActionBase {
  OnExecute() {
    var e = this.ActionInfo.Params,
      o = "PlayMovie" === ControllerHolder_1.ControllerHolder.FlowController.GetNextAction()?.Name;
    VideoLauncher_1.VideoLauncher.ShowVideoCg(e.VideoName, () => {
      ControllerHolder_1.ControllerHolder.FlowController.EnableSkip(!1), this.FinishExecute(!0)
    }, e.BackgroundFade, o, !0)
  }
  OnInterruptExecute() {
