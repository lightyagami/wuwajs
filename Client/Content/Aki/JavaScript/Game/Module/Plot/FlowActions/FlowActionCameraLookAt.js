...
class FlowActionCameraLookAt extends FlowActionLevelAsyncAction_1.FlowActionLevelAsyncAction {
  ...
  OnInterruptExecute() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Camera", 57, "[CameraLookAt] FlowActionCameraLookAt");
    var e = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity.GetComponent(62),
      o = this.ActionInfo.Params;
    CameraController_1.CameraController.FightCamera.LogicComponent.ExitCameraGuide(), o.BanInput && (InputController_1.InputController.AddInputHandler(e), CameraController_1.CameraController.SetInputEnable(Global_1.Global.BaseCharacter, !0)), super.OnInterruptExecute()
  }
}
