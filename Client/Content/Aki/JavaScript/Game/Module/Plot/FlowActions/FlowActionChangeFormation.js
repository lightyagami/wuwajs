...
class FlowActionChangeFormation extends FlowActionServerAction_1.FlowActionServerAction {
  OnExecute() {
    ModelManager_1.ModelManager.PlotModel.IsInSequencePlot() && ModelManager_1.ModelManager.SequenceModel.IsPlaying ? (PlotController_1.PlotController.ChangeFormation(), this.RequestServerAction(!1)) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Plot", 26, "禁止在非Seq剧情中使用切编队"), this.FinishExecute(!0)
  }
  OnBackgroundExecute() {
