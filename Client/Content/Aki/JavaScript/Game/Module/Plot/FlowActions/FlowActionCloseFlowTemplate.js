...
class FlowActionCloseFlowTemplate extends FlowActionBase_1.FlowActionBase {
  OnExecute() {
    "LevelC" !== ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel ? this.FinishExecute(!0, !0) : ModelManager_1.ModelManager.PlotModel.EndPlotTemplate(this.ActionInfo.Params, () => {
