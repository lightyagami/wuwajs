...
class FlowActionChangeInteractOptionText extends FlowActionBase_1.FlowActionBase {
  OnExecute() {
    var e, t = ModelManager_1.ModelManager.InteractionModel.CurrentInteractEntityId;
    t && (t = EntitySystem_1.EntitySystem.Get(t)) && (t = t.GetComponent(197)) && (t = t.GetInteractController()) && (t = t.CurrentInteractOption) && (e = this.ActionInfo.Params, t.TidContent = e.TidContent)
  }
}
