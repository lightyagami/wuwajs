...
class ChatView extends UiTickViewBase_1.UiTickViewBase {
  ...
  async OnBeforeStartAsync() {
    this.SBd = new ChatContentDynamicItem_1.ChatContentDynamicItem();
    this.yBd = new DynScrollView_1.DynamicScrollView(this.GetUIDynScrollViewComponent(11), this.GetItem(26), this.SBd, this.NPn);
    await this.yBd.Init();
  }
  OnStart() {
  ...
  async vXa(t) {
    ...
    if (!(e = i && t.PsAccountId && i.get(t.PsAccountId) ? true : e)) {
      ...
      TimerSystem_1.GameplayTimerSystem.Delay(() => {
        this.yBd?.ScrollToItemIndex(this.MBd.length - 1);
  ...
  YSt(t) {
    ...
    this.MBd = t;
    this.yBd?.RefreshByData(r, true, true);
  }
  fyt() {
