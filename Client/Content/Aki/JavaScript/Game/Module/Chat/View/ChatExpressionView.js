...
class ChatExpressionView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lHe = void 0, this.lSt = new Map, this._St = void 0, this.cHe = () => {
      var e = new ChatExpressionItem_1.ChatExpressionItem;
      return e.BindOnClicked(this.uSt), e
    }, this.cSt = e => {
      this.mSt(e)
    }, this.uSt = e => {
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSelectExpression, e), UiManager_1.UiManager.CloseView("ChatExpressionView")
    }, this.dSt = () => {
  ...
  OnStart() {
    var e = this.GetItem(1),
      i = this.GetItem(0),
      t = i.GetOwner();
    this.lHe = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(3), t, this.cHe), i.SetUIActive(!1), e.SetUIActive(!1), this.bl()
  }
  OnBeforeDestroy() {
  ...
  mSt(e) {
    ...
    var i = this.fSt(e),
      i = (i.SetState(1), this._St = i, ConfigManager_1.ConfigManager.ChatConfig.GetAllExpressionConfigByGroupId(e));
  ...
  gSt(e) {
    ...
    i.Refresh(e), i.SetState(0), i.BindOnClicked(this.cSt), i.SetActive(!0), this.lSt.set(e.Id, i)
  }
  fSt(e) {
