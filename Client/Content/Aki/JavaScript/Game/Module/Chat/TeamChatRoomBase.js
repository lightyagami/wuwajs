  ...
  AddHistoryChatContent(t) {
    ...
    for (const n of t) {
      var i = n.SenderPlayerId,
        ...
        C = n.UtcTime;
      let t = 0,
        e = (t = "number" == typeof C ? C : C ? Number(MathUtils_1.MathUtils.LongToBigInt(n.UtcTime)) : TimeUtil_1.TimeUtil.GetServerTime(), 0);
      a && (e = a.TimeStamp);
      var C = n.SenderPlayerName,
        m = n.SenderIcon,
        i = new ChatContentData_1.ChatContentData("", i, s, r, h, !0, t, e, this.ChatRoomType, C, m);
      a = i, o.push(i)
    }
