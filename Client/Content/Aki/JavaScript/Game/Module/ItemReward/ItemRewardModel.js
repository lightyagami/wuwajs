...
class ItemRewardModel extends ModelBase_1.ModelBase {
  ...
  RefreshRewardData(e, t) {
    ...
    return this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(e), this.q0i.SetItemList(t), this.q0i
  }
  RefreshExploreLevelRewardData(e, t, i, s) {
    ...
    return this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(e), this.q0i.SetItemList(s), this.q0i
  }
  RefreshCommonRewardDataFromConfig(e, t, i, s) {
    ...
    if (e) return t = {
      ...
      OnCloseCallback: s
    }, this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(t), this.q0i.SetItemList(i), this.q0i
  }
  RefreshCompositeRewardDataFromConfig(e, t = !0, i, s) {
    ...
    if (e) return t = {
      ...
      IsItemVisible: e.IsItemVisible
    }, this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(t), this.q0i.SetItemList(i), s && this.q0i.SetProgressQueue(s), this.q0i
  }
  RefreshExploreRewardDataFromConfig(e, t = !0, i, s, r, a, o, h, n, l, d, I, u, m, w, C) {
    ...
    if (e) return t = {
      ...
      IsRewardMultiLine: m
    }, this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(t), this.q0i.SetItemList(i), s && this.q0i.SetExploreRecordInfo(s), r && this.q0i.SetExploreBarDataList(r), a && this.q0i.SetButtonInfoList(a), o && this.q0i.SetTargetReached(o), h && this.q0i.SetStateToggle(h), I && this.q0i.SetExploreFriendDataList(I), u && this.q0i.SetScoreReached(u), w && this.q0i.SetAccumulatedScoreData(w), this.q0i
  }
  RefreshExploreRewardDataFromConfigNew(e) {
    ...
    }, this.q0i || this.NewRewardData(), this.q0i.SetRewardInfo(t), this.q0i.SetItemList(e.RewardItemDataList), e.ExploreRecordInfo && this.q0i.SetExploreRecordInfo(e.ExploreRecordInfo), e.ExploreBarDataList && this.q0i.SetExploreBarDataList(e.ExploreBarDataList), e.ButtonInfoList && this.q0i.SetButtonInfoList(e.ButtonInfoList), e.TargetReached && this.q0i.SetTargetReached(e.TargetReached), e.StateToggle && this.q0i.SetStateToggle(e.StateToggle), e.ExploreFriendDataList && this.q0i.SetExploreFriendDataList(e.ExploreFriendDataList), e.ScoreReachedData && this.q0i.SetScoreReached(e.ScoreReachedData), e.AccumulatedScoreData && this.q0i.SetAccumulatedScoreData(e.AccumulatedScoreData), e.BabelTowerSuccessData && this.q0i.SetBabelTowerSuccessData(e.BabelTowerSuccessData), e.DangoAbyssSuccessData && this.q0i.SetDangoAbyssSuccessData(e.DangoAbyssSuccessData), this.q0i
  }
  SetItemList(e) {
    this.q0i || this.NewRewardData(), !e || e.length < 1 || (this.q0i.SetItemList(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRefreshRewardViewItemList, e))
  }
  AddItemList(e) {
    this.q0i || this.NewRewardData(), !e || e.length < 1 || (this.q0i.AddItemList(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRefreshRewardViewItemList, e))
  }
  SetProgressQueue(e) {
    this.q0i || this.NewRewardData(), this.q0i.SetProgressQueue(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRefreshRewardProgressBar)
  }
  ...
  SetButtonList(e) {
    this.q0i || this.NewRewardData(), !e || e.length < 1 || (this.q0i.SetButtonInfoList(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRefreshRewardButton))
  }
  NewRewardData() {
    var e;
