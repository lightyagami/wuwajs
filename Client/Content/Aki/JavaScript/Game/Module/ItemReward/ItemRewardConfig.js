...
exports.ItemRewardConfig = undefined;
...
class ItemRewardConfig extends ConfigBase_1.ConfigBase {
  GetRewardViewFromSourceConfig(e) {
    return RewardViewFromSourceBySourceId_1.configRewardViewFromSourceBySourceId.GetConfig(e);
  }
  GetCommonRewardViewDisplayConfig(e) {
    return CommonRewardViewDisplayById_1.configCommonRewardViewDisplayById.GetConfig(e);
  }
  GetCompositeRewardViewDisplayConfig(e) {
    return CompositeRewardDisplayById_1.configCompositeRewardDisplayById.GetConfig(e);
  }
  GetExploreRewardDisplayConfig(e) {
    return ExploreRewardDisplayById_1.configExploreRewardDisplayById.GetConfig(e);
  }
