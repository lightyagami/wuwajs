...
class RewardExploreOnlineChallengePlayerItem extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(i) {
    let r = 0;
    for (const e of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItemsByPlayer(i)) e.IsControl() && (r = e.GetConfigId);
    if (r) {
      ...
      if (a) {
        ...
        if (n) {
          ...
          a = this.GetSprite(1), i = StringUtils_1.StringUtils.Format(e, ModelManager_1.ModelManager.OnlineModel.GetCurrentTeamListById(i)?.PlayerNumber.toString() ?? "1"), i = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(i);
          i ? (a.SetUIActive(!0), this.SetSpriteByPath(i, a, !1)) : a.SetUIActive(!1)
