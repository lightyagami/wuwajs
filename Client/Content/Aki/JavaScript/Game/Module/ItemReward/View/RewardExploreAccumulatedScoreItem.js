...
exports.RewardExploreAccumulatedScoreItem = undefined;
const UE = require("ue");
...
class RewardExploreAccumulatedScoreItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIVerticalLayout], [1, UE.UIItem], [2, UE.UIVerticalLayout], [3, UE.UIItem], [4, UE.UIText], [5, UE.UIItem]];
  }
  OnStart() {
    this._D_ = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(0), this.uD_);
    this.cD_ = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(2), this.uD_);
  }
  Refresh(e) {
    var t = e.DetailScoreDataList;
    if (t) {
      this._D_?.RefreshByData(t);
    }
    if (t = e.TotalScoreDataList) {
      this.cD_?.RefreshByData(t);
    }
    var t = e.CurScore;
    var e = e.MaxScore;
    var i = e <= t;
    if (i) {
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), "riskofrain_UIScore", t, e);
    } else {
