...
class RewardExploreDangoAbyssSuccessItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.OFt = void 0, this.kGe = void 0, this.d2t = () => {
      return this.Pfi()
    }, this.wYt = e => {
  ...
  jqe(e) {
    e.sort((e, r) => {
      var t = e.GetDropItemType(),
        s = r.GetDropItemType();
      return t !== s ? s - t : (s = e.GetTypeSortIndex()) !== (t = r.GetTypeSortIndex()) ? t - s : (t = e.GetQualityId()) !== (s = r.GetQualityId()) ? s - t : e.ConfigId - r.ConfigId
    }), this.kGe.RefreshByData(e), this.GetItem(5).SetUIActive(0 < e.length)
  }
  Pfi() {
