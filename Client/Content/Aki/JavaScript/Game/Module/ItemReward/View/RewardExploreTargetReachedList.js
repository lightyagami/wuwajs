...
class RewardExploreTargetReachedList extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this._fi = void 0, this.ufi = void 0, this.Y0i = []
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.ufi = this.GetItem(0), this._fi = this.GetItem(1), this._fi.SetUIActive(!1)
  }
  OnBeforeDestroy() {
  ...
  Cfi(e) {
    ...
    t.Refresh(e), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 5, e?.DescriptionTextId), t.SetActive(!0), this.Y0i.push(t)
  }
  cfi() {
