...
const UE = require("ue"),
  ...
  playerItemSeqNames = [SEQ_NAME_PLAYER_01, SEQ_NAME_PLAYER_02, SEQ_NAME_PLAYER_03];
class RewardExploreOnlineChallengePlayer extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.c9_ = !1, this.u9_ = [], this.d9_ = [], this.m9_ = [], this.SPe = void 0, this.SWs = () => {
      this.FullRefresh()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), await this.g9_()
  }
  OnStart() {
  ...
  async SHe() {
    ...
    for (let e = 0; e < MAX_PLAYER_COUNT; e++) {
      ...
      this.u9_.push(i), t.push(i.CreateByActorAsync(this.GetItem(playerItemChildTypes[e]).GetOwner()))
    }
    await Promise.all(t)
  }
  bNe() {
    ...
    for (const t of e) 0 === ModelManager_1.ModelManager.OnlineModel.GetContinuingChallengeConfirmState(t.GetPlayerId()) && this.m9_.push(t.GetPlayerId())
  }
  Og() {
    this.C9_(), this.p9_()
  }
  C9_() {
    if (0 === this.m9_.length) this.SetUiActive(!1);
      ...
      for (let e = 0; e < MAX_PLAYER_COUNT; e++) e < this.m9_.length ? (this.u9_[t[e]].SetUiActive(!0), this.u9_[t[e]].Refresh(this.m9_[e])) : this.u9_[t[e]].SetUiActive(!1)
    }
  }
  p9_() {
    this.m9_.length <= this.d9_.length || (this.SPe?.PlayLevelSequenceByName(playerItemSeqNames[this.m9_.length - 1]), this.c9_) || (this.GetText(0).SetUIActive(!0), this.SPe?.PlayLevelSequenceByName(SEQ_NAME_TEX), this.c9_ = !0)
  }
}
