...
class RewardExploreScore extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ZHe = void 0, this.Lyn = void 0, this.VOe = () => {
  ...
  async OnBeforeStartAsync() {
    this.Lyn = new NewRecordItem, await this.Lyn.CreateByActorAsync(this.GetItem(1).GetOwner()), this.Lyn.SetActive(!0)
  }
  OnStart() {
    var e = this.GetScrollViewWithScrollbar(0);
    this.ZHe = new GenericLayout_1.GenericLayout(e.GetContent().GetComponentByClass(UE.UILayoutBase.StaticClass()), this.VOe)
  }
  OnBeforeDestroy() {}
  Refresh(e) {
