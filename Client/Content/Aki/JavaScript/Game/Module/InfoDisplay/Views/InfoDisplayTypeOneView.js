...
class InfoDisplayTypeOneView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.sai = void 0, this.Jvt = () => {
      this.CloseMe()
    }, this._ai = () => {
  ...
  OnStart() {
    ...
    var e = this.GetItem(8),
      e = (this.sai.Initialize(e.GetOwner()), this.sai.SetShowTextComponent(this.GetText(6)), ModelManager_1.ModelManager.InfoDisplayModel.CurrentInformationId());
    ...
    if (0 !== e.length) {
      ...
      if ("" !== e) {
        ...
        ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.Texture, (e, i) => {
          e.IsValid() && r.IsValid() && (r.SetAllStateTexture(e), this.GetTexture(10).SetTexture(e), this.GetTexture(10).SetSizeFromTexture())
        })
      }
    }
  }
