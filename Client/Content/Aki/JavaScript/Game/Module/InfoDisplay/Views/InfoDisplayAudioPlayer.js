...
class InfoDisplayAudioPlayer extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.sai = void 0, this.jsi = void 0, this.$si = () => {
      this.sai?.OnClickPlayAudioBtn()
    }
  }
  Initialize(i) {
    this.CreateThenShowByActor(i), this.sai = new InfoDisplayAudioPlayerImpl_1.InfoDisplayAudioPlayerImpl(this.RootActor, this.GetExtendToggle(0))
  }
  ...
  OnTick(i) {
    var e;
    this.sai.OnTick(i), this.sai.IsPlaying() && (i = InfoDisplayModel_1.InfoDisplayModel.ConvertToHourMinuteString(this.sai.GetCurrentRunningTimeInSecond()), e = InfoDisplayModel_1.InfoDisplayModel.ConvertToHourMinuteString(this.sai.GetMaxDurationInSecond()), this.jsi.SetText(i + "/" + e))
  }
  async Refresh(i) {
