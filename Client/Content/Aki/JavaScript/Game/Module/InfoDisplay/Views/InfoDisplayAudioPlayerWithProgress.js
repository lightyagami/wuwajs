...
class InfoDisplayAudioPlayerWithProgress extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.sai = void 0, this.xrc = void 0, this.Urc = void 0, this.Drc = 1, this.$si = () => {
  ...
  OnStart() {
    this.xrc = this.GetText(0), this.Urc = this.GetSlider(1), this.xrc.SetText("00:00/00:00"), this.Urc.SetValue(0)
  }
  OnBeforeDestroy() {
    this.sai?.Release()
  }
  ...
  async InitAudioPlayer(i) {
    this.sai = new InfoDisplayAudioPlayerImpl_1.InfoDisplayAudioPlayerImpl(this.GetRootActor(), this.GetExtendToggle(2)), await this.sai.SetAudioClipPathAndLoadAudio(i), this.Drc = this.sai.GetMaxDurationInSecond(), this.sai.Start()
  }
  SetOnAudioEnd(i) {
  ...
  Tick(i) {
    this.sai?.OnTick(i), this.sai?.IsPlaying() && (i = this.sai.GetCurrentRunningTimeInSecond(), this.Brc(i), this.krc(i))
  }
  Brc(i) {
