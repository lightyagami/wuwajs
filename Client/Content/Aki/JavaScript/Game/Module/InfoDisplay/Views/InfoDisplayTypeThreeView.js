...
class InfoDisplayTypeThreeView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnStart() {
    ...
    var e = this.GetItem(5),
      e = (this.sai.Initialize(e.GetOwner()), this.sai.SetShowTextComponent(this.GetText(3)), ModelManager_1.ModelManager.InfoDisplayModel.CurrentInformationId());
  ...
  mai(e) {
    "" !== ConfigManager_1.ConfigManager.InfoDisplayModuleConfig.GetInfoDisplayAudio(e) ? (this.GetItem(5).SetUIActive(!0), this.GetItem(7).SetUIActive(!0)) : (this.GetItem(5).SetUIActive(!1), this.GetItem(7).SetUIActive(!1))
  }
  l7e(e) {
    var i = ConfigManager_1.ConfigManager.InfoDisplayModuleConfig.GetInfoDisplayTitle(e),
      i = (this.GetText(0).SetText(i), ConfigManager_1.ConfigManager.InfoDisplayModuleConfig.GetInfoDisplayDesc(e));
