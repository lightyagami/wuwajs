...
class InfoDisplayTypeTwoView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.dai = 0, this.Iye = void 0, this.ovt = void 0, this.jbe = e => {
      this.Cai(e)
    }, this.gai = 3, this.Uye = (e, t, i) => {
  ...
  l7e(e) {
    var t = ConfigManager_1.ConfigManager.InfoDisplayModuleConfig.GetInfoDisplayTitle(e),
      t = (this.GetText(6).SetText(t), ConfigManager_1.ConfigManager.InfoDisplayModuleConfig.GetInfoDisplayDesc(e));
    this.GetText(5).SetText(t)
  }
  pai(e) {
    void 0 !== this.ovt ? this.ovt.AttachToNextItem(e) : void 0 !== this.Iye && this.Iye.AttachToNextItem(e)
  }
  Cai(e) {
    void 0 !== this.ovt ? this.ovt?.ScrollToItem(e) : void 0 !== this.Iye && this.Iye?.ScrollToItem(e), this.Mai()
  }
  Mai() {
    let e = 0;
    void 0 !== this.ovt ? e = this.ovt.GetCurrentSelectIndex() : void 0 !== this.Iye && (e = this.Iye.GetCurrentSelectIndex());
    var t = e + 1 + "/" + this.dai;
    this.GetText(2).SetText(t)
  }
  OnBeforeDestroy() {
    var e = ModelManager_1.ModelManager.InfoDisplayModel.CurrentInformationId();
    InfoDisplayController_1.InfoDisplayController.RequestReadDisplayInfo(e), this.Iye?.Clear(), this.ovt?.Clear()
  }
