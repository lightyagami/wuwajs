...
class SceneTeamController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    ...
    Net_1.Net.Register(22087, SceneTeamController.Apo);
    Net_1.Net.Register(19976, SceneTeamController.Ppo);
    Net_1.Net.Register(18298, SceneTeamController.xpo);
    Net_1.Net.Register(27279, SceneTeamController.r$s);
    Net_1.Net.Register(17309, SceneTeamController.Phl);
    Net_1.Net.Register(22798, SceneTeamController.K6u);
    return true;
  }
  static OnClear() {
    ...
    Net_1.Net.UnRegister(22087);
    Net_1.Net.UnRegister(19976);
    Net_1.Net.UnRegister(18298);
    Net_1.Net.UnRegister(27279);
    Net_1.Net.UnRegister(17309);
  ...
  static DisableAllRoleWithoutControl(e = undefined, o = undefined, t = false) {
    for (const n of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems(true)) {
      ...
      var r;
      if (!n.IsControl()) {
        if ((r = n.EntityHandle?.Entity) && (a = r.GetComponent(101)) && a.GetTeamState() === 1) {
      ...
      if (t = g.EntityHandle?.Entity) {
        if ((v = SceneTeamController.Bpo()) !== Protocol_1.Aki.Protocol.f6s.Proto_SignleWorld || GlobalData_1.GlobalData.Networking()) {
          if (g.CanControl()) {
            ...
            c.$Hn = v;
            if (ModelManager_1.ModelManager.GameModeModel.IsMulti && (g = o?.EntityHandle?.Entity?.GetComponent(101)?.GetTeamState() === 1, c.O3u = g, _.GetCurrentTeamItem?.GetCreatureDataId() === e) && t.GetComponent(101)?.NeedSyncTransform() && (v = t.GetComponent(3))) {
            ...
            CombatMessage_1.CombatNet.Call(23961, t, c, e => {
              var o;
            ...
            if (n && _.GetCurrentTeamItem?.GetCreatureDataId() === e) {
              t.GetComponent(222)?.AddBuff(CharacterBuffIds_1.buffId.GoBattleInvincible, {
                InstigatorId: e,
                PreMessageId: i,
                Reason: "角色上场短暂无敌"
              });
          ...
          S = o?.EntityHandle?.Entity?.GetComponent(106)?.IsInQte ?? false;
  ...
  static SendSwitchRole(e) {
    ...
    if (r) {
      ...
      a.$Hn = o;
      CombatMessage_1.CombatNet.Call(23961, r, a, () => {}, undefined, t);
    }
  }
  static Bpo() {
  ...
  static RoleGoDownPush(e) {
    ...
    CombatMessage_1.CombatNet.Send(23797, e, o);
  }
  ...
  static RevertPhantomTeam() {
    ...
    if (ModelManager_1.ModelManager.SceneTeamModel.CurrentGroupType !== 2) {
      ...
      if (e?.Valid) {
        e.Entity?.GetComponent(185)?.RemoveAllDurationBuffs("声骸还原清理持续型buff");
      }
    }
  }
  static TryUseMultiQte(e) {
    var o = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentTeamItem;
    var t = o.EntityHandle.Entity.GetComponent(106);
    if (t.IsQteReady(e)) {
      e.Entity.GetComponent(106).UseExitSkill(o.EntityHandle);
      t.ExecuteMultiQte(e);
      return true;
    } else {
      if (!e.Entity.GetComponent(217).HasTag(166024319)) {
...
SceneTeamController.K6u = e => {
  ...
  if (o?.Valid) {
    ...
    o.Entity.GetComponent(101).SimulateGoDown(true);
  } else if (Log_1.Log.CheckInfo()) {
  ...
  if (Net_1.Net.IsServerConnected()) {
    ...
    if (e && o) {
      if ((t = t.CurrentGroupType) && t !== -1) {
        ...
        CombatMessage_1.CombatNet.Send(23214, o, a);
      } else if (Log_1.Log.CheckInfo()) {
