...
class MapComponentContainer {
  ...
  YW(e, t) {
    var o = t.ComponentId;
    return this.gYa.has(o) ? (MapLogger_1.MapLogger.WarnOnce(o, 63, "[世界地图]MapComponentContainer.AddInternal->添加组件失败，重复组件Id", ["componentId", o]), !1) : (this.gYa.set(o, t), this.fYa.has(e) || this.fYa.set(e, []), this.fYa.get(e).push(t), t.Add(), t.Enable = !0)
  }
  GetComponent(e) {
  ...
  RemoveById(e) {
    var t, o = this.gYa.get(e);
    void 0 !== o && (this.gYa.delete(e), e = o.ComponentType, t = (e = this.GetAll(e)).indexOf(o), e.splice(t, 1), o.Enable = !1, o.Remove())
  }
  RemoveAll() {
