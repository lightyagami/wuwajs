...
class MapComponent {
  constructor(t) {
    this.Parent = t, this.PropertyMap = new PropertyMap_1.PropertyMap, this.mYa = 0
  }
  static GenComponentId() {
    return MapComponent._Xe = MapComponent._Xe + 1, MapComponent._Xe
  }
  get ComponentId() {
    return 0 === this.mYa && (this.mYa = MapComponent.GenComponentId()), this.mYa
  }
  set ComponentId(t) {
    this.mYa = t
  }
  ...
  set Enable(t) {
    this.PropertyMap.set("Enable", t), this.PropertyMap.isDirty("Enable") && (t ? (this.dYa && (this.dYa = !1, this.OnStart()), this.OnEnable()) : this.OnDisable())
  }
  get dYa() {
