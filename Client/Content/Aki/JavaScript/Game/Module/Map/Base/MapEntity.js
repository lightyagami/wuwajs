...
exports.MapEntity = undefined;
const PropertyMap_1 = require("../Container/PropertyMap");
const MapComponentContainer_1 = require("./MapComponentContainer");
class MapEntity {
  constructor() {
    this.MapComponentContainer = new MapComponentContainer_1.MapComponentContainer();
