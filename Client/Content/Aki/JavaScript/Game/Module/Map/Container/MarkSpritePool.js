...
class MarkSpritePool {
  ...
  static Ref(t, i, s) {
    let e = this.wW_.get(t),
      o = (void 0 === e && (e = new Set, this.wW_.set(t, e)), e.add(i), this.LW_.get(i));
    void 0 !== o ? ++o.Ref : (o = {
      SpritePath: i,
      RecycleTimeStamp: 0,
      Obj: s,
  ...
  static UnRef(t) {
    ...
    if (void 0 !== i) {
      for (const e of i) {
        ...
        void 0 !== s && (--s.Ref, s.Ref <= 0) && (s.RecycleTimeStamp = Time_1.Time.ServerTimeStamp, this.LW_.delete(e))
      }
      this.wW_.delete(t)
    }
  }
  static Tick() {
    ...
    for (const i of this.LW_.values()) {
      ...
      (i.Ref <= 0 && t > MAX_SPRITE_HANDLE_CACHE_TIME || !i.Obj?.IsValid()) && this.RW_.push(i.SpritePath)
    }
...
}(exports.MarkSpritePool = MarkSpritePool).wW_ = new Map, MarkSpritePool.LW_ = new Map, MarkSpritePool.RW_ = [];
