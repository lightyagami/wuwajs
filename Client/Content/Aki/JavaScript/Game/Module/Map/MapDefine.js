...
class ConfigMarkCreateInfo extends(exports.MarkCreateInfo = MarkCreateInfo) {
  constructor(t, e) {
    super(0), this.MarkConfig = t, void(this.MarkId = 0) === e && (this.MarkId = t.MarkId)
  }
}
exports.ConfigMarkCreateInfo = ConfigMarkCreateInfo;
class DynamicMarkCreateInfo extends MarkCreateInfo {
  constructor(t) {
    super(1), this.CreateParams = void 0, this.CreateParams = t, void 0 === this.CreateParams.MapAndDungeonInfo && (this.CreateParams.MapAndDungeonInfo = {
      MapConfigId: exports.BIG_WORLD_MAP_ID
    });
    let e = this.CreateParams.MapAndDungeonInfo?.MapConfigId;
    0 === e && (e = exports.BIG_WORLD_MAP_ID), this.CreateParams.MapAndDungeonInfo.MapConfigId = e ?? ConfigManager_1.ConfigManager.MapConfig.SearchMapConfigByType(this.CreateParams.MarkConfigId, t.MarkType)?.MapId;
  ...
  get MapGravity() {
    ...
    return 9 !== this.MarkType && 15 !== this.MarkType && 17 !== this.MarkType && ModelManager_1.ModelManager.WorldMapModel.IsGravityMap(this.MapId) ? 1 : 0
  }
}
class QuestMarkCreateInfo extends(exports.DynamicMarkCreateInfo = DynamicMarkCreateInfo) {
  ...
  constructor(t) {
    void 0 !== t.MapAndDungeonInfo && (t.MapAndDungeonInfo.MapConfigId = t.MapAndDungeonInfo.DungeonId), super(t)
  }
}
exports.QuestMarkCreateInfo = QuestMarkCreateInfo;
class PlayerMarkCreateInfo extends MarkCreateInfo {
  constructor(t, e, r, s, o = 1) {
    super(2), this.PlayerId = t, this.PlayerIndex = e, this.Position = r, this.MapId = s, this.Gravity = o
  }
}
exports.PlayerMarkCreateInfo = PlayerMarkCreateInfo, exports.FISHING_SHIP_MARK_ID = 8;
