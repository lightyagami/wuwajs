...
class MapMarkPreemptiveFrameQueue extends SimplePreemptiveFrameQueue_1.SimplePreemptiveFrameQueue {
  ...
  CancelMapTaskByType(e) {
    e = this.glh.get(e);
    if (e)
      for (var [, t] of e) this.CancelTask(t), this.flh(t)
  }
  OnTaskComplete(e) {
    super.OnTaskComplete(e);
    this.flh(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnMapMarkTaskComplete, e.MarkType, e.MarkId)
  }
}
