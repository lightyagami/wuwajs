...
class MarkGamePlayComponent extends MapComponent_1.MapComponent {
  constructor() {
    super(...arguments), this.MarkId = 0, this.MarkType = 0, this.MapId = 0, this.Gravity = 0
  }
  get ComponentType() {
    return 10
  }
  ...
  get InGravityLayer() {
    return 0 === this.Gravity || this.Gravity === ModelManager_1.ModelManager.WorldMapModel.WorldMapGravity
  }
