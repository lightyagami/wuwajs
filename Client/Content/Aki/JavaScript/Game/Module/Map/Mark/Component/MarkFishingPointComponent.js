...
class MarkFishingPointComponent extends MapComponent_1.MapComponent {
  ...
  OnUpdate() {
    var n = this.ParentEntity.GetComponent(11),
      e = CommonParamById_1.configCommonParamById.GetIntConfig("FishingWherfRange") ?? 1;
    n.RangeSize = e, n.RangeSetAsFirstChild = !0, this.ParentEntity.GetComponent(12).SetChildViewVisibility(2, !1)
  }
}
