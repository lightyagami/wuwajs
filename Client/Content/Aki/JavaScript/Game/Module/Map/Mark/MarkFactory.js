...
class MarkFactory {
  ...
  static pn_(t, r) {
    ...
    if (r)
      for (const a of r) t.AddComponent(a)
  }
  ...
  static Om1(t) {
    ...
    return r.GamePlay.MarkId = t.MarkId, r.GamePlay.MarkType = t.MarkType, r.GamePlay.Gravity = t.Gravity, r.GamePlay.MapId = t.MapId, r
  }
}
exports.MarkFactory = MarkFactory, (_a = MarkFactory).vn_ = t => {
  var r = _a.Om1(t);
  return r.AddComponent(15).MapMarkConfig = t.Config, r.AddComponent(18).EntityId = t.EntityId, r
}, MarkFactory.qm1 = t => {
  var r = _a.Om1(t);
