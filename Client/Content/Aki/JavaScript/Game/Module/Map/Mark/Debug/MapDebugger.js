...
class MapDebugger {
  static I4c(e, a) {
    ...
    let $ = "";
    if (t) {
      if (void 0 !== a.MarkItemEntity.GetComponent(14)) $ = ModelManager_1.ModelManager.LevelPlayReportModel.GetLevelPlayHideReason(a.MarkItemEntity.GetComponent(15).MapMarkConfig.RelativeDungeonId, a.MarkItemEntity.GetComponent(15).MapMarkConfig.RelativeId);
      else {
        const r = a.MarkItemEntity.GetComponent(18).EntityId ?? 0;
  ...
  static PrintMarkItemDumpInfo(e, a) {
    MapLogger_1.MapLogger.Error(63, "地图调试信息->当前标记ItemDump信息", ["标记信息", MapDebugger.I4c(e, a)])
  }
