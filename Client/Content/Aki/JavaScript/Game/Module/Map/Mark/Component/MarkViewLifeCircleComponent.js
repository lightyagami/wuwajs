...
class MarkViewLifeCircleComponent extends MapComponent_1.MapComponent {
  constructor() {
    super(...arguments), this.ChildViewVisibleStateMap = new PropertyMap_1.PropertyMap
  }
  get ComponentType() {
    return 12
  }
  ...
  SetAllChildViewStateDirty() {
    this.ChildViewVisibleStateMap.forEach((e, t) => {
      0 !== t && this.ChildViewVisibleStateMap.setDirty(t)
    })
  }
  OnRemove() {
  ...
  get VerticalPointerType() {
    return this.PropertyMap.tryGet(1, 0, !1)
  }
