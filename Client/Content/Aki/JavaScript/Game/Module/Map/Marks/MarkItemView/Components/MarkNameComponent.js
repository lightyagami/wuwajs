...
class MarkNameComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  oCo() {
    void 0 !== this.OPt && this.SetName(this.OPt.FormatStr, this.OPt.Name, this.OPt.Progress, this.OPt.FontSize)
  }
  SetName(e, t, i, s) {
    var r = this.GetText(0);
    r && (s && r.SetFontSize(s), s = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e), e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(t), r.SetText(StringUtils_1.StringUtils.Format(s, e, i)))
  }
}
