...
class MarkBlueRangeImageComponent extends MarkRangeImageComponent_1.MarkRangeImageComponent {
  ...
  OnStart() {
    this.RootItem.SetAnchorOffset(Vector2D_1.Vector2D.ZeroVector), this.RootItem.SetUIItemScale(Vector_1.Vector.OneVector), this.RangeSprite?.SetUIActive(!1), this.RangeImage?.SetUIActive(!0)
  }
}
