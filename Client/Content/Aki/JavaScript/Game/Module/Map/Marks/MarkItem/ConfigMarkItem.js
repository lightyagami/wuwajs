...
class ConfigMarkItem extends MarkItem_1.MarkItem {
  constructor(t, e, i, s, r, n = 1) {
    super(i, s, r, n), this.MarkConfig = void 0, this.InnerMarkId = 0, this.IsServerSaveShowState = !1, this.ConditionShouldShow = !0, this.OnSubMapChanged = t => {
      var e = this.LocateInGround();
      let i = !1;
      i = e && 0 === t ? 0 === t : this.GetMultiMapId() === ModelManager_1.ModelManager.WorldMapModel.WorldMapCurrentMultiMapId, this.IsSelectThisFloor !== i && (this.IsSelectThisFloor = i, this.UpdateViewIcon())
    }, this.InnerMarkId = t, this.ShowPriority = e.ShowPriority, this.MarkConfig = e, this.IconPath = this.MarkConfig.LockMarkPic
  }
  get IsFogUnlock() {
  ...
  LocateInGround() {
    return 0 === this.MarkConfig.MultiMapFloorId && 0 < this.GetConnectMultiMapIds().length
  }
  ConnectGround() {
    if (this.IsMultiMap()) {
      var t = this.MarkConfig.MultiMapFloorId;
      if (0 !== t)
        if (0 === ConfigManager_1.ConfigManager.MapConfig.GetSubMapConfigById(t)?.Floor) return !0;
      for (const e of this.GetConnectMultiMapIds())
        if (0 === ConfigManager_1.ConfigManager.MapConfig.GetSubMapConfigById(e)?.Floor) return !0;
      return !1
    }
    return !0
  }
  GetMultiMapId() {
    return 0 === this.MarkConfig.MultiMapFloorId && 0 < this.GetConnectMultiMapIds().length ? this.GetConnectMultiMapIds()[0] : this.MarkConfig.MultiMapFloorId
  }
  ...
  OnDestroy() {
    2 === this.MapType && EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldMapSubMapChangedFromUpdate, this.OnSubMapChanged)
  }
  InitPosition() {
    this.SetTrackData(ModelManager_1.ModelManager.MapModel.GetConfigMarkTrackTarget(this.MarkId)), this.UpdateVisibleRelativeState()
  }
  InitIcon() {
    this.MarkConfig.RelativeSubType <= 0 || (this.IconPath = this.MarkConfig.LockMarkPic)
  }
  IsRelativeFunctionOpen() {
    var t;
    return this.MarkConfig.RelativeSubType <= 0 || !((t = ConfigManager_1.ConfigManager.MapConfig?.GetMapMarkFuncTypeConfigById(this.MarkConfig.RelativeSubType)) && 0 < t.FunctionId) || ModelManager_1.ModelManager.FunctionModel.IsOpen(t.FunctionId)
  }
  GetMarkItemViewType() {
    return 3
  }
  ...
  GetAreaText() {
    if ("number" == typeof this.TrackTarget) return ModelManager_1.ModelManager.MapModel.GetMarkAreaText(this.MapId, this.TrackTarget)
  }
  GDi(t) {
  ...
  InitShowCondition() {
    ...
    t < 0 ? this.IsServerSaveShowState = !0 : 0 === t ? this.ConditionShouldShow = !0 : (this.IsServerSaveShowState = !1, this.ConditionShouldShow = ModelManager_1.ModelManager.MapModel.IsMarkUnlockedByServer(this.MarkId))
  }
  CheckCanShowView() {
    var t;
    return this.CanConditionShowView() ? (t = this.GetCurrentMapShowScale(), t = this.GDi(t) || this.IsTracked, 2 !== this.MapType || (this.IsCanShowViewIntermediately !== (t = t || this.IsIgnoreScaleShow) && (this.NeedPlayShowOrHideSeq = t ? "ShowView" : "HideView"), t)) : this.IsTracked
  }
  R3l() {
    return !this.GamePlayIsFinish() || 1 === this.MarkConfig?.FinishIsShow || !!ModelManager_1.ModelManager.WorldMapModel.CompletedPlayPointMarkIsShow
  }
  GamePlayIsFinish() {
  ...
  IsMoraleFlag() {
    return 6 === this.MarkConfig.RelativeSubType
  }
  UpdateViewIcon() {
    var t;
