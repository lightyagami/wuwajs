...
class TemporaryTeleportMarkItem extends ServerMarkItem_1.ServerMarkItem {
  constructor(e, t, r, i) {
    super(e, t, r, i), this.NDi = !1, this.Zbn = e => {
      this.uil()
    }
  }
  get TeleportId() {
  ...
  uil() {
    ...
    this.IsSelectThisFloor = this.GetIsSelectThisFloor(), e !== this.IsSelectThisFloor && this._il()
  }
  ...
  OnInitialize() {
    ...
    this.SetTrackData(e.TrackTarget), this.SetConfigId(this.ConfigId), this.UpdateVisibleRelativeState(), 2 === this.MapType && EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldMapSubMapChangedFromUpdate, this.Zbn), this.uil()
  }
  OnDestroy() {
    super.OnDestroy(), 2 === this.MapType && EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldMapSubMapChangedFromUpdate, this.Zbn)
  }
  GetMarkItemViewType() {
    return 25
  }
