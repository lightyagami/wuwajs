...
class MarkSelectComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  async _1a(e) {
    return this.mRi !== e && (this.mRi = e, this.mRi ? (this.RootItem.SetUIActive(this.mRi), await this.SPe.PlaySequenceAsync("xuanzhong", new CustomPromise_1.CustomPromise)) : (await this.SPe.PlaySequenceAsync("Close", new CustomPromise_1.CustomPromise), this.RootItem.SetUIActive(this.mRi))), !0
  }
}
