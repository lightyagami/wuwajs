...
class TemporaryTeleportMarkItemView extends ServerMarkItemView_1.ServerMarkItemView {
  ...
  OnSelectedStateChange(e) {
    this.Holder.IsServerDisable && ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("Map_TeleportMark_Disable_Tips")
  }
  OnSafeUpdate(e, r, t) {
  ...
  UpdateIcon() {
    this.MarkItemChildIconHandle.Update(), this.MarkItemChildIconHandle.ApplyModified()
  }
}
