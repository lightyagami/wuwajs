...
class MarkRangeImageComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  OnStart() {
    this.RootItem.SetAnchorOffset(Vector2D_1.Vector2D.ZeroVector), this.RootItem.SetUIItemScale(Vector_1.Vector.OneVector), this.RangeSprite.SetUIActive(!0), this.RangeImage.SetUIActive(!1)
  }
  get RangeImage() {
