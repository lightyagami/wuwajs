...
class CorniceMeetingMarkItem extends SceneGameplayMarkItem_1.SceneGameplayMarkItem {
  CheckCanShowView() {
    var e, t = ConfigManager_1.ConfigManager.ActivityCorniceMeetingConfig.GetCorniceMeetingChallengeByMarkId(this.MarkId);
    return void 0 !== t && void 0 !== (e = ActivityCorniceMeetingController_1.ActivityCorniceMeetingController.GetCurrentActivityData()) && e.GetIsShow(t.Id)
  }
}
