...
class MarkGravityReverseIconComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  ehi() {
    var e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(1 === this.Gravity ? "SP_OverviewDown" : "SP_OverviewUp");
    this.SetSpriteByPath(e, this.GetSprite(0), !1, void 0, () => {
      this.GetSprite(0).SetUIActive(!0)
    })
  }
  set Gravity(e) {
    this.ffc = e, this.GetSprite(0) && this.ehi()
  }
  get Gravity() {
    return this.ffc
  }
