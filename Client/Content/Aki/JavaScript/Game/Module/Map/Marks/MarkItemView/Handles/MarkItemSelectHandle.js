...
class MarkItemSelectHandle extends MarkItemComponentHandle_1.MarkItemComponentHandle {
  async LoadComponentAsync() {
    return void 0 === this.ComponentInternal && (this.ComponentInternal = new MarkSelectComponent_1.MarkSelectComponent, await this.ComponentInternal.CreateByPoolResourceIdAsync("UiItem_MarkChoose_Prefab", this.Context.MarkComponentContainer)), this.ComponentInternal
  }
  ...
  OnApplyModified() {
    ...
    n.IsChildViewStateDirty(5) && (e = this.GetOrCreateComponent(), this.IsComponentValid(e)) && (t = n.IsChildViewVisible(5), n.SetChildViewVisibleClean(5), e.SetActive(t))
  }
}
