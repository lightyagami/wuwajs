...
class CustomMarkItem extends ServerMarkItem_1.ServerMarkItem {
  ...
  OnInitialize() {
    ...
    var e = this.ServerMarkInfo,
      r = (e.TrackTarget instanceof Vector_1.Vector ? (r = Vector_1.Vector.Create(e.TrackTarget.X, -e.TrackTarget.Y, e.TrackTarget.Z), r = MapUtil_1.MapUtil.UiPosition2WorldPosition(r, r), this.SetTrackData(r)) : e.TrackTarget instanceof Vector2D_1.Vector2D ? (r = Vector_1.Vector.Create(e.TrackTarget.X, e.TrackTarget.Y, 0), e = MapUtil_1.MapUtil.UiPosition2WorldPosition(r, r), this.SetTrackData(new Vector2D_1.Vector2D(e.X, e.Y))) : Log_1.Log.CheckError() && Log_1.Log.Error("Map", 49, "未定义的类型"), this.MarkItemEntity.ViewLifeCircle.EnableVerticalPointer = !1, this.SetConfigId(this.ConfigId), CustomMarkByMarkId_1.configCustomMarkByMarkId.GetConfig(this.ConfigId));
    this.ShowPriority = r ? r.ShowPriority : 0, this.UpdateVisibleRelativeState()
  }
  CreateView() {
  ...
  CheckCanShowView() {
    return 1 === this.MapType ? ModelManager_1.ModelManager.WorldMapModel.CustomMarksIsShow : ModelManager_1.ModelManager.WorldMapModel.CustomMarksIsShow && super.CheckCanShowView()
  }
  GetInteractiveFlag() {
