...
class PunishReportMarkItem extends ConfigMarkItem_1.ConfigMarkItem {
  constructor(e, t, r, i, n, s = 1) {
    super(e, t, r, i, n, s), this.nlh = void 0, this.bir = () => {
  ...
  OnInitialize() {
    super.OnInitialize(), this.yn_(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnReceivePlayerVar, this.bir)
  }
  OnDestroy() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnReceivePlayerVar, this.bir), super.OnDestroy()
  }
  GetPunishMarkState() {
  ...
  GetPunishReportTarget() {
    ...
    if (void 0 === r) MapLogger_1.MapLogger.ErrorOnce(t, 63, "[地图系统]->讨伐报告标记获取配置失败", ["levelPlayId", t]);
    else {
      for (const s of [ModelManager_1.ModelManager.WorldModel.GetWorldStateGeneric(r.Cond1Key), ModelManager_1.ModelManager.WorldModel.GetWorldStateGeneric(r.Cond2ey), ModelManager_1.ModelManager.WorldModel.GetWorldStateGeneric(r.Cond3Key)]) s ? e.States.push(1) : e.States.push(0);
      var t = r.CondDescription1,
        i = r.CondDescription2,
        n = r.CondDescription3,
        t = (e.ConditionTxtIds.push(t), e.ConditionTxtIds.push(i), e.ConditionTxtIds.push(n), ModelManager_1.ModelManager.WorldModel.GetWorldStateGeneric(r.GetBoxKey) ?? 0);
      e.GetBoxNum = t
    }
    return e
  }
