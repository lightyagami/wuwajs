...
class FishingPointMarkItem extends ServerMarkItem_1.ServerMarkItem {
  ...
  GetTitleText() {
    var e = this.EntityConfigId,
      e = ModelManager_1.ModelManager.FishingModel.GetFishingPointNameLocalKey(e),
  ...
  OnInitialize() {
    ...
    var e = this.ServerMarkInfo,
      i = (this.SetTrackData(e.TrackTarget), this.MarkItemEntity.GetComponent(16));
    i.FishingPointEntityId = e.TrackTarget, i.Update(), this.SetConfigId(e.MarkConfigId), this.UpdateVisibleRelativeState()
  }
  SetConfigId(e) {
  ...
  OnSetConfigId(e) {
    ...
    this.gNa = e, this.MarkItemEntity.GetComponent(15).MapMarkConfig = e, this.OnAfterSetConfigId({
  ...
  UpdateIconPath() {
    if (0 === this.ServerMarkInfo.FishPointDetectSourceType) {
      ...
      switch (ConfigManager_1.ConfigManager.FishingConfig.GetFishingItemConfig(e).Type) {
        case 1:
          return void(this.IconPath = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_IconMap_Activity_Navigation_4_UI"));
        case 2:
          return void(this.IconPath = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_IconMap_Activity_Navigation_6_UI"))
      }
