...
class MarkItemGravityReverseIconHandle extends MarkItemComponentHandle_1.MarkItemComponentHandle {
  async LoadComponentAsync() {
    return void 0 === this.ComponentInternal && (this.ComponentInternal = new MarkGravityReverseIconComponent_1.MarkGravityReverseIconComponent, await this.ComponentInternal.CreateByPoolResourceIdAsync("UiItem_MarkReverse", this.Context.MarkComponentContainer)), this.ComponentInternal
  }
  ...
  OnApplyModified() {
    ...
    n.IsChildViewStateDirty(9) && (e = this.GetOrCreateComponent(), this.IsComponentValid(e)) && (t = n.IsChildViewVisible(9), n.SetChildViewVisibleClean(9), e.Gravity = this.Context.MarkItemEntity.GamePlay.Gravity, e.SetActive(t))
  }
}
