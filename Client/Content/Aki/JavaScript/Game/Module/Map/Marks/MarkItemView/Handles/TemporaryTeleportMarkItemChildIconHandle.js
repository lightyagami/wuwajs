...
class TemporaryTeleportMarkItemChildIconHandle extends MarkItemChildIconHandle_1.MarkItemChildIconHandle {
  OnUpdate() {
    var e;
    super.OnUpdate(), this.Context.MarkItemEntity.ViewLifeCircle.IsChildViewVisible(7) || (e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(WorldMapDefine_1.TEMPORARY_TELEPORT_NORMAL_ICON_PATH), this.Context.MarkItemEntity.Resource.ChildIconPath = e, this.SetVisible(!0))
  }
}
