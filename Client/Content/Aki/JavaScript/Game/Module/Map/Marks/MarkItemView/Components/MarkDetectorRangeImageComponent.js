...
class MarkDetectorRangeImageComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  OnStart() {
    this.RootItem.SetAnchorOffset(Vector2D_1.Vector2D.ZeroVector), this.RootItem.SetUIItemScale(Vector_1.Vector.OneVector)
  }
  OnBeforeShow() {
  ...
  SetRangeScale(e, t, r) {
    this.KRi.Set(e, t, r), this.IsShowOrShowing && this.GetRootItem().D_SetRelativeScale3D(this.KRi)
  }
}
