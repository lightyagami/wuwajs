...
class LandscapeMarkView extends MarkItemView_1.MarkItemView {
  ...
  async fRi() {
    ...
    e && (e = await this.LoadPrefabAsync(e.EffectResourcePath, this.RootItem), this.gRi = e.GetComponentByClass(UE.UIItem.StaticClass()))
  }
  OnBeforeDestroy() {
    this.gRi && UE.LGUIBPLibrary.DestroyActorWithHierarchy(this.gRi.GetOwner(), !0), super.OnBeforeDestroy()
  }
}
