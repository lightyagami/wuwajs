...
class MingSuNpcMarkItem extends ConfigMarkItem_1.ConfigMarkItem {
  ...
  GamePlayIsFinish() {
    var e = this.MarkConfig,
      r = e.RelativeType;
    if (1 === r && 5 === this.MarkConfig.RelativeSubType) return r = e.RelativeId, 4 === ModelManager_1.ModelManager.MingSuModel.GetDarkCoastDeliveryDataByLevelPlayId(r).GetDarkCoastDeliveryGuardState();
    return !1
  }
}
