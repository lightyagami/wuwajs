...
class FixedSceneGamePlayMarkItemView extends ConfigMarkItemView_1.ConfigMarkItemView {
  ...
  OnSafeUpdate(e, r, a) {
    var t = this.Holder,
      i = t.IconPath,
      s = ModelManager_1.ModelManager.LevelPlayModel.GetLevelPlayInfo(t.MarkConfig.RelativeId);
    !s || s.IsClose ? t.IconPath = t.MarkConfig.LockMarkPic : t.IconPath = t.MarkConfig.UnlockMarkPic, i !== t.IconPath && this.OnIconPathChanged(t.IconPath)
  }
}
