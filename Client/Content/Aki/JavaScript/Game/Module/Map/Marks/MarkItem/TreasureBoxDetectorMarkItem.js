...
class TreasureBoxDetectorMarkItem extends ServerMarkItem_1.ServerMarkItem {
  ...
  OnInitialize() {
    ...
    this.SetTrackData(e.TrackTarget), this.SetConfigId(this.ConfigId), this.MarkItemEntity.ViewLifeCircle.EnableVerticalPointer = !1, this.UpdateVisibleRelativeState()
  }
  GetMarkItemViewType() {
    return 26
  }
  CreateView() {
    return new TreasureBoxDetectorMarkItemView_1.TreasureBoxDetectorMarkItemView(this)
  }
  SetConfigId(e) {
    this.ServerMarkInfo.MarkConfigId = e, this.OnSetConfigId(e)
  }
  OnSetConfigId(e) {
    e = ConfigManager_1.ConfigManager.MapConfig.GetTreasureBoxDetectorMarkConfig(e);
    this.MarkItemEntity.GetOrAddComponent(15).TreasureBoxDetectorMarkConfig = e, this.OnAfterSetConfigId(e)
  }
  SetIsNew(e) {
    this.NDi = e
  }
  GetTitleText() {
    var e = ConfigManager_1.ConfigManager.MapConfig.GetTreasureBoxDetectorMarkConfig(this.ConfigId);
