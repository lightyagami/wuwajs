...
class EntityMarkItem extends ConfigMarkItem_1.ConfigMarkItem {
  ...
  InitPosition() {
    this.TrackTarget || this.SetTrackData(ModelManager_1.ModelManager.MapModel.GetConfigMarkTrackTarget(this.MarkId)), this.UpdateVisibleRelativeState()
  }
  CheckCanShowView() {
    return ("number" != typeof this.TrackTarget || !!ModelManager_1.ModelManager.CreatureModel.CheckEntityVisible(this.TrackTarget)) && super.CheckCanShowView()
  }
}
