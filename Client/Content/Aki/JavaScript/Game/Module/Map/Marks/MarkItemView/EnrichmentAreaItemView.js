...
class EnrichmentAreaItemView extends ServerMarkItemView_1.ServerMarkItemView {
  ...
  OnInitialize() {
    super.OnInitialize(), this.Holder.MarkItemEntity.ViewLifeCircle.EnableVerticalPointer = !1;
    var e = this.Holder.CheckCanShowView();
    this.MarkItemRangeHandle.SetVisible(e)
  }
  OnReset() {
    super.OnReset(), this.Holder.MarkItemEntity.ViewLifeCircle.EnableVerticalPointer = !1;
    var e = this.Holder.CheckCanShowView();
    this.MarkItemRangeHandle.SetVisible(e)
  }
  RegisterEvents() {
  ...
  OnAfterShow() {
    super.OnAfterShow(), this.UpdateMultiMapFloorSelectedState(), this.OnIconPathChanged(this.Holder.IconPath)
  }
  OnIconPathChanged(e) {
    var t = this.Holder.CheckCanShowIcon(),
      n = this.GetSprite(1);
    t ? this.LoadIcon(n, e) : n.SetUIActive(t), this.MarkItemChildIconHandle.Update()
  }
  UpdateMultiMapFloorSelectedState() {
    var e = this.Holder,
      t = this.Holder.IsSelectThisFloor;
    this.Holder.IsSelectThisFloor = e.GetIsSelectThisFloor(), t !== this.Holder.IsSelectThisFloor && this.OnIconPathChanged(e.IconPath)
  }
  CreateRangeHandle(e) {
