  ...
  SetNameText() {
    ...
    if (t) {
      ...
      let e = LEVEL_TREE_SIZE,
        r = "",
        i = "SmallAreaName";
      t.Level === ExploreProgressDefine_1.AREA_LEVEL && (t = o?.GetProgress()?.toString() ?? "0", r = o?.IsReachMaxProgress ? StringUtils_1.StringUtils.Format("<color=#ffd12f>{0}%</color>", t) : StringUtils_1.StringUtils.Format("{0}%", t), e = LEVEL_TWO_SIZE, i = "BigAreaName"), this.MarkItemNameHandle.SetName({
        FormatStr: i,
        Name: s,
        Progress: r,
        FontSize: e
      }), this.MarkItemNameHandle.SetVisible(!0)
    } else Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 63, "缺少区域配置", ["标记id", this.Holder.MarkId.toString()]), this.MarkItemNameHandle.SetVisible(!1)
  }
  GetInteractiveFlag() {
    return !1
  }
