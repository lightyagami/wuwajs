...
class TeleportMarkItemChildIconHandle extends MarkItemChildIconHandle_1.MarkItemChildIconHandle {
  OnUpdate() {
    ...
    e.IsDungeonEntrance ? (this.SetVisible(!e.IsFogUnlock), e.IsFogUnlock || (this.Context.MarkItemEntity.Resource.ChildIconPath = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(WorldMapDefine_1.SUB_ICON_PATH))) : super.OnUpdate()
  }
}
