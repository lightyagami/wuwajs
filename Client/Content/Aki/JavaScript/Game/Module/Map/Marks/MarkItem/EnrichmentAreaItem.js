...
class EnrichmentAreaItem extends ServerMarkItem_1.ServerMarkItem {
  constructor(e, r, t, i) {
    super(e, r, t, i), this.gNa = void 0, this.iw1 = void 0
  }
  get MarkConfig() {
    return this.gNa
  }
  ...
  get EnrichmentAreaConf() {
    return void 0 === this.iw1 && (this.iw1 = ConfigManager_1.ConfigManager.MapConfig.GetEnrichmentAreaConfigByEnrichmentId(this.EntityConfigId)), this.iw1
  }
  get MarkType() {
    return 22
  }
  ...
  OnInitialize() {
    super.OnInitialize();
    var e, r = this.ServerMarkInfo;
    if (this.SetTrackData(r.TrackTarget), ModelManager_1.ModelManager.MapModel.CacheEnrichmentAreaEntityId !== r.EntityConfigId) {
      var t = this.EnrichmentAreaConf.EntityIds;
      if (t) {
        var i = [];
        for (const o of t) {
          var a = MapUtil_1.MapUtil.GetEntityPositionByConfig(o, this.MapId);
          a.Equality(Vector_1.Vector.ZeroVectorProxy) ? Log_1.Log.CheckWarn() && Log_1.Log.Warn("Map", 63, "[地图系统]_富集区标记->采集物实体坐标异常，请检查配置", ["富集区Id", r.EntityConfigId], ["采集物Id", o]) : (a = MapUtil_1.MapUtil.WorldPosition2UiPosition(a), i.push(Vector2D_1.Vector2D.Create(a.X, a.Y)))
        }
    ...
    n && (t = MapUtil_1.MapUtil.UiPosition2WorldPosition(Vector_1.Vector.Create(n.X, n.Y, 0)), e = CommonParamById_1.configCommonParamById.GetFloatConfig("RichZoneExtraRadius"), this.MarkItemEntity.GetComponent(11).RangeSize = n.R + e, this.SetTrackData(t));
  ...
  OnSetConfigId(e) {
    ...
    this.gNa = e, this.OnAfterSetConfigId({
  ...
  CheckCanShowIcon() {
    var e = this.MapType;
    return 1 === this.MarkConfig.MapShow && 1 !== e || 2 === this.MarkConfig.MapShow && 1 === e ? this.IsTracking() : super.CheckCanShowView()
  }
  SetTitleText(e) {
    var r = this.MarkConfig.MarkTitle,
      t = ConfigManager_1.ConfigManager.MapConfig.GetLocalText(this.GetEnrichmentItemNameId());
