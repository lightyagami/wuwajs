...
class ServerMarkItem extends MarkItem_1.MarkItem {
  constructor(e, t, r, i) {
    super(t, r, i, e.TrackSource ?? 1), this.MinShowScale = 0, this.MaxShowScale = 0, this.ServerMarkInfo = void 0, this.MultiMapIdInternal = void 0, this.ServerMarkInfo = e, MapDefine_1.serverMarkIgnoreReadConfigSet.has(e.MarkType) ? this.ShowPriority = 0 : (t = ConfigManager_1.ConfigManager.MapConfig.GetConfigMark(e.MarkConfigId), this.ShowPriority = t ? t.ShowPriority : 0)
  }
  get MarkId() {
  ...
  get TrackPosition() {
    return this.ServerMarkInfo.TrackTarget instanceof Vector_1.Vector || this.ServerMarkInfo.TrackTarget instanceof Vector2D_1.Vector2D ? this.ServerMarkInfo.TrackTarget : Vector_1.Vector.ZeroVectorProxy
  }
  get EntityConfigId() {
  ...
  get TrackAreaId() {
    return void 0 === this.EntityConfigId || 0 === this.EntityConfigId ? 0 : ModelManager_1.ModelManager.WorldMapModel.GetEntityAreaId(this.EntityConfigId, this.MapId)
  }
  GetMultiMapId() {
    return void 0 === this.EntityConfigId || 0 === this.EntityConfigId ? 0 : this.GetMultiMapIdSub()
  }
  GetMultiMapIdSub() {
  ...
  CheckInShowRange(e) {
    return 2 !== this.MapType || !!this.IsIgnoreScaleShow || this.MinShowScale === this.MaxShowScale || this.MinShowScale < e && this.MaxShowScale > e
  }
  OnAfterSetConfigId(e) {
    e && (e.ShowRange && (this.MinShowScale = e.ShowRange[0] ?? 0, this.MaxShowScale = e.ShowRange[1] ?? 0), this.IconPath = e.MarkPic, this.InnerView?.OnIconPathChanged(this.IconPath), e.ShowPriority && (this.ShowPriority = e.ShowPriority), this.ConfigScale = e.Scale ?? 1, this.CornerScale = e.CornerScale ?? 1)
  }
  CheckCanShowView() {
    var e = this.GetCurrentMapShowScale(),
      e = this.CheckInShowRange(e) || this.IsTracked;
    return this.IsCanShowViewIntermediately !== e && (this.NeedPlayShowOrHideSeq = e ? "ShowView" : "HideView"), e
  }
}
