...
class TeleportMarkItem extends ConfigMarkItem_1.ConfigMarkItem {
  ...
  get IsFogUnlock() {
    return 6 === this.MarkConfig.ObjectType && !this.IsLocked || super.IsFogUnlock
  }
  GetMarkItemViewType() {
    return 24
  }
  ...
  get IconPath() {
    return this.IsLocked ? this.MarkConfig.LockMarkPic : this.MarkConfig.UnlockMarkPic
  }
  set IconPath(e) {}
  get IsActivity() {
  ...
  get IsDungeonEntrance() {
    return 2 === this.MarkConfig.RelativeType || ConfigManager_1.ConfigManager.InstanceDungeonEntranceConfig.CheckMarkIdLinkDungeonEntrance(this.MarkConfigId)
  }
  get IsTowerEntrance() {
  ...
  GetSecondaryUiType() {
    return this.IsActivity ? super.GetSecondaryUiType() : this.IsDungeonEntrance ? this.IsTowerEntrance ? WorldMapDefine_1.ESecondaryPanel.TowerEntrancePanel : this.IsRoguelike ? WorldMapDefine_1.ESecondaryPanel.RoguelikePanel : this.IsWeeklyRogue ? WorldMapDefine_1.ESecondaryPanel.WeeklyRoguePanel : this.IsRogueRes ? WorldMapDefine_1.ESecondaryPanel.RogueResPanel : this.IsShipTowerEntrance ? WorldMapDefine_1.ESecondaryPanel.ShipTowerEntrancePanel : WorldMapDefine_1.ESecondaryPanel.InstanceDungeonEntrancePanel : WorldMapDefine_1.ESecondaryPanel.TeleportPanel
  }
}
