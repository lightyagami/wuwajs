...
class MarkVerticalPointerComponent extends MarkPanelBase_1.MarkPanelBase {
  ...
  ShowUp() {
    this.RootItem?.SetUIActive(!0), this.RootItem?.SetUIRelativeRotation(new UE.Rotator(0, 0, 0))
  }
  ShowDown() {
    this.RootItem?.SetUIActive(!0), this.RootItem?.SetUIRelativeRotation(new UE.Rotator(0, 0, 180))
  }
  HideSelf() {
