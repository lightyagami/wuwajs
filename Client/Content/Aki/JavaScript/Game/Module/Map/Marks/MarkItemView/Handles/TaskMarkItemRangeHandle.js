...
class TaskMarkItemRangeHandle extends MarkItemRangeHandle_1.MarkItemRangeHandle {
  async LoadComponentAsync() {
    return void 0 === this.ComponentInternal && (this.ComponentInternal = new MarkRangeImageComponent_1.MarkRangeImageComponent, await this.ComponentInternal.CreateByPoolResourceIdAsync("UiItem_MarkArea_Prefab", this.Context.MarkParentItem)), this.ComponentInternal
  }
