...
exports.LevelPlayReportMarkItem = undefined;
const ModelManager_1 = require("../../../../Manager/ModelManager");
const LevelPlayReportMarkItemView_1 = require("../MarkItemView/LevelPlayReportMarkItemView");
...
class LevelPlayReportMarkItem extends ConfigMarkItem_1.ConfigMarkItem {
  ...
  CanGetReward() {
    ...
    return ModelManager_1.ModelManager.LevelPlayReportModel.HaveLevelPlayReportRewardCanGet(this.MarkConfig.RelativeDungeonId, e);
  }
  GetPunishReportTarget() {
    var e = this.MarkConfig.RelativeId;
    return ModelManager_1.ModelManager.LevelPlayReportModel.GetLevelPlayReportTarget(this.MarkConfig.RelativeDungeonId, e);
  }
  InitIcon() {
    this.UpdateIconPath();
  }
