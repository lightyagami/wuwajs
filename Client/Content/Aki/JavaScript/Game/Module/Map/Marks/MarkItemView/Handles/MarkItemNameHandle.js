...
class MarkItemNameHandle extends MarkItemComponentHandle_1.MarkItemComponentHandle {
  ...
  async LoadComponentAsync() {
    return void 0 === this.ComponentInternal && (this.ComponentInternal = new MarkNameComponent_1.MarkNameComponent, await this.ComponentInternal.CreateByPoolResourceIdAsync("UiItem_MarkMapName_Prefab", this.Context.MarkComponentContainer)), this.ComponentInternal
  }
  ...
  OnApplyModified() {
    ...
    n.IsChildViewStateDirty(3) && (e = this.GetOrCreateComponent(), this.IsComponentValid(e)) && (t = n.IsChildViewVisible(3), n.SetChildViewVisibleClean(3), void 0 !== this.pDe && e.SetNameParam(this.pDe), e.SetActive(t))
  }
}
