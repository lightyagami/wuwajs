...
class MapLogger {
  ...
  static Debug(g, o, ...a) {
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("Map", g, o, ...a);
    }
  }
  static DebugOnce(g, o, a, ...e) {
    if (!MapLogger.T4c(g)) {
      MapLogger.Debug(o, a, ...e);
      MapLogger.Gpl(g);
    }
  }
  static Info(g, o, ...a) {
    if (Log_1.Log.CheckInfo()) {
      Log_1.Log.Info("Map", g, o, ...a);
    }
  }
  static InfoOnce(g, o, a, ...e) {
    if (!this.T4c(g)) {
      MapLogger.Info(o, a, ...e);
      MapLogger.Gpl(g);
    }
  }
  static Warn(g, o, ...a) {
    if (Log_1.Log.CheckWarn()) {
      Log_1.Log.Warn("Map", g, o, ...a);
    }
  }
  static WarnOnce(g, o, a, ...e) {
    if (!this.T4c(g)) {
      MapLogger.Warn(o, a, ...e);
      MapLogger.Gpl(g);
    }
  }
  static Error(g, o, ...a) {
    if (Log_1.Log.CheckError()) {
      Log_1.Log.Error("Map", g, o, ...a);
    }
  }
  static ErrorOnce(g, o, a, ...e) {
    if (!this.T4c(g)) {
      MapLogger.Error(o, a, ...e);
      MapLogger.Gpl(g);
    }
  }
  static T4c(g, o = 1) {
