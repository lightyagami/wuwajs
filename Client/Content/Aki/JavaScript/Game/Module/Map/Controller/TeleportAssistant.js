...
class TeleportAssistant extends ControllerAssistantBase_1.ControllerAssistantBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(18648, this.dDi);
  }
  ...
  async RequestTeleportData() {
    ...
    var e = await Net_1.Net.CallAsync(25373, e);
    if (e) {
      if (e.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.G9n, 25548);
      } else {
