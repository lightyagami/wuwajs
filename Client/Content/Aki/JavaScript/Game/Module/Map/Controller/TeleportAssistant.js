...
class TeleportAssistant extends ControllerAssistantBase_1.ControllerAssistantBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(20100, this.dDi);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(20100);
  }
  OnAddEvents() {
  ...
  async RequestTeleportData() {
    ...
    var e = await Net_1.Net.CallAsync(24065, e);
    if (e) {
      if (e.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.G9n, 26550);
      } else {
