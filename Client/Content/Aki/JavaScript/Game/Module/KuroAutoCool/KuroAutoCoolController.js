...
class KuroAutoCoolController extends ControllerBase_1.ControllerBase {
  ...
  static ApplyNiagaraQuality(e) {
    ...
    UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.DisableDistortion " + (0 < e && t ? 0 : 1)), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "fx.Niagara.QualityLevel " + (0 < e ? 1 : 0))
  }
  static ApplyMobileResolution(e) {
    ...
    GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetDefaultScreenResolution().Y < 750 && e < 70 && (t = Math.min(1.5 * t, 100)), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.ScreenPercentage " + t)
  }
  ...
  static RestoreImageQualityAndFrameRate() {
    ...
    var t = this.GetCurrentValue(GameSettingsDefine_1.EFunction.MOBILERESOLUTION),
      ...
      s = this.GetCurrentValue(GameSettingsDefine_1.EFunction.SHADOWQUALITY),
      a = this.GetCurrentValue(GameSettingsDefine_1.EFunction.NPCDENSITY);
    this.RKo && Log_1.Log.CheckInfo() && Log_1.Log.Info("Render", 68, "自动降温恢复前", ["CurrentFps", e]), 55 <= e && e < 60 ? (this.SetMaxFrameRate(60), e = 60, i && i > this.nMl && this.ApplyNiagaraQuality(i), t && t > this.sMl && this.ApplyMobileResolution(t)) : 50 <= e && e < 55 ? (this.SetMaxFrameRate(55), e = 55, r && r > this.aMl && GameSettingsUtils_1.GameSettingsUtils.ApplyVolumeLight(r), o && o > this.lMl && GameSettingsUtils_1.GameSettingsUtils.ApplyImageDetail(o)) : 45 <= e && e < 50 ? (this.SetMaxFrameRate(50), e = 50, a && a > this.hMl && GameSettingsUtils_1.GameSettingsUtils.ApplyNpcDensity(a)) : 40 <= e && e < 45 && (this.SetMaxFrameRate(45), e = 45, s) && s > this._Ml && GameSettingsUtils_1.GameSettingsUtils.ApplyShadowQuality(s), this.RKo && Log_1.Log.CheckInfo() && Log_1.Log.Info("Render", 68, "自动降温恢复后", ["CurrentFps", e], ["Resolution", t], ["Niagara", i], ["ImageDetail", o], ["VolumeLight", r], ["NpcDensity", a], ["Shadow", s])
  }
  static ltl() {
    var e = UE.KuroRenderingRuntimeBPPluginBPLibrary.GetCpuTemperature();
    this.RKo && Log_1.Log.CheckInfo() && Log_1.Log.Info("Render", 68, "当前CPU温度", ["CpuTemperature", e]), this.$Xr = 0, this.cZa && e < this.a_l ? this.RestoreImageQualityAndFrameRate() : e >= this.a_l && this.ReduceImageQualityAndFrameRate()
  }
  static OnInit() {
    return this.TemperatureDelegate = (0, puerts_1.toManualReleaseDelegate)(this.htl), !(this.cZa = !1)
  }
  static OnClear() {
  ...
  static OnTick(e) {
    var t;
    0 < UE.KuroRenderingRuntimeBPPluginBPLibrary.GetCVarFloat("r.Kuro.AutoCoolEnable") && (t = 0 < UE.KuroRenderingRuntimeBPPluginBPLibrary.GetCVarFloat("r.Kuro.AutoCoolUIEnable"), Platform_1.Platform.IsMobilePlatform()) && t && (this.$Xr += e, this.$Xr > this.uZa) && (KuroPerformanceController_1.KuroPerformanceController.IsEnable ? UE.KuroPerformanceBPLibrary.GetCurrentTemperatureData(this.TemperatureDelegate) : this.ltl(), this.$Xr = 0)
  }
}
exports.KuroAutoCoolController = KuroAutoCoolController, (_a = KuroAutoCoolController).uZa = 1e4, KuroAutoCoolController.RKo = !0, KuroAutoCoolController.a_l = 65, KuroAutoCoolController.$Xr = 0, KuroAutoCoolController.cZa = !1, KuroAutoCoolController.sMl = 1, KuroAutoCoolController.nMl = 1, KuroAutoCoolController.lMl = 1, KuroAutoCoolController.aMl = 0, KuroAutoCoolController.hMl = 1, KuroAutoCoolController._Ml = 1, KuroAutoCoolController.TemperatureDelegate = void 0, KuroAutoCoolController.htl = (e, t, i) => {
  _a.RKo && Log_1.Log.CheckInfo() && Log_1.Log.Info("Render", 68, "KuroAutoCoolController.temperature", ["bResult", e], ["currentTemperature", t], ["tempBudget", i]), !e || i <= 5 ? _a.ReduceImageQualityAndFrameRate() : _a.cZa && _a.RestoreImageQualityAndFrameRate()
};
