...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RacingBetsFinalMatchInfo = exports.RacingBetsFourDangoMatchInfo = exports.RacingBetsSixDangoMatchInfo = void 0;
const UE = require("ue"),
...
class RacingBetsSixDangoMatchInfo extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.tFe = void 0, this.ajc = [2, 3, 4, 5, 6, 7], this.ifa = () => {
  ...
  SetData(e) {
    ...
    var h = this.ajc.length;
    for (let t = s.length; t < h; ++t) s.push({
      GroupMatchId: e,
      DangoId: 0,
      IsMatchFinished: !1,
      IsPromote: !1,
  ...
  RefreshLine(e) {
    for (let t = 0; t < this.ajc.length; ++t) {
      var s = e[t],
        i = this.ajc[t];
...
class RacingBetsFourDangoMatchInfo extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.tFe = void 0, this.ajc = [2, 3, 4, 5], this.ifa = () => {
      return new RacingBetsDangoItemWithName
    }
  }
  OnRegisterComponent() {
...
class RacingBetsFinalMatchInfo extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.WB1 = void 0, this.QB1 = void 0, this.kG1 = 2, this.KB1 = [5, 6], this.XB1 = [11, 12], this.ifa = () => {
      return new RacingBetsDangoItemWithName
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.WB1 = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(7), this.ifa), this.QB1 = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(13), this.ifa)
  }
  SetData(e) {
    ...
    if (s) {
      ...
      let t = 0;
      r && (t = s.GetPromoteDangoList()[0], c = (ConfigManager_1.ConfigManager.DangoConfig?.GetDangoById(t))?.Icon ?? "", this.SetTextureShowUntilLoaded(c, o));
      var h = [];
      ...
      var c = h.length;
      c <= this.kG1 ? i.push(...h) : (o = Math.floor(c / this.kG1), i.push(...h.slice(0, o)), a.push(...h.slice(o, c)))
    }
    var g = this.KB1.length,
      u = this.XB1.length;
    for (let t = i.length; t < g; ++t) i.push({
      GroupMatchId: e,
      DangoId: 0,
      IsMatchFinished: !1,
      IsPromote: !1,
    ...
    for (let t = a.length; t < u; ++t) a.push({
      GroupMatchId: e,
      DangoId: 0,
      IsMatchFinished: !1,
      IsPromote: !1,
    ...
    this.RefreshRoleLayout(i, this.WB1), this.RefreshRoleLayout(a, this.QB1), this.RefreshLine(i, this.KB1), this.RefreshLine(a, this.XB1), this.GetItem(0).SetUIActive(r), this.GetSprite(2).SetUIActive(!r), this.GetTexture(4).SetUIActive(r), this.GetTexture(10).SetUIActive(r)
  }
...
class RacingBetsDangoItemWithName extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  RefreshItem(e) {
    var t = e.DangoId,
      s = 0 !== t,
      i = (this.GetSprite(2).SetUIActive(!s), this.GetText(1).SetUIActive(s && e.IsBasicGroupMatch), e.IsMatchFinished && !e.IsPromote);
    if (this.GetItem(7).SetUIActive(s && i), this.GetItem(6).SetUIActive(s && !i), s) {
      i = ConfigManager_1.ConfigManager.DangoConfig.GetDangoById(t);
      if (i) {
        var s = this.GetTexture(0),
          a = this.GetTexture(5),
          s = (this.SetTextureShowUntilLoaded(i.IconDamage, s), this.SetTextureShowUntilLoaded(i.IconDamage, a), this.GetTexture(3)),
        ...
        (t = s && (i = s.GetLegMatchState(), s.ParentGroupMatchData.Id === e.GroupMatchId) && 4 !== i && 0 !== i ? !0 : t) ? this.SequencePlayer.PlayLevelSequenceByName("Hold"): this.SequencePlayer.PlayLevelSequenceByName("Reset")
      } else Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 78, "RacingBetsDangoItemWithName RefreshItem dangoConfig is null ", ["dangoId", t])
