...
class RacingBetsDangoSkillView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.aNc = void 0, this.lyt = () => {
      this.CloseMe()
  ...
  async OnBeforeStartAsync() {
    ...
    void 0 !== e && (this.aNc = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), this.hNc), await this.aNc.RefreshByDataAsync(e))
  }
}
