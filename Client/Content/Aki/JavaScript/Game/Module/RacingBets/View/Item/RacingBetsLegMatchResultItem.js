...
class RacingBetsLegMatchResultItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    this.GetText(0).SetText(e.Rank.toString()), this.GetItem(3).SetUIActive(2 === e.LegMatchType && e.HasAdvanced);
    var t = DangoManager_1.DangoManager.GetDangoData(e.DangoId),
      t = (this.GetText(2).ShowTextNew(t.NameKey), this.SetTextureShowUntilLoaded(t.Icon, this.GetTexture(1)), e.IsChampion ? "Dango_MainPage_Champion" : "Dango_MainPage_Advanced");
