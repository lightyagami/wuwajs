...
class RacingBetsButtonItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.l4e = void 0, this.c8a = 0, this.UJa = new Set, this.Gke = void 0, this.ije = () => {
      this.Gke?.();
  ...
  BindRedDot(t, e = 0) {
    ...
    i && (this.l4e = t, this.c8a = e, this.l4e) && RedDotController_1.RedDotController.BindRedDot(t, i, void 0, e)
  }
  UnBindGivenUid(t) {
    this.l4e && (RedDotController_1.RedDotController.UnBindGivenUi(this.l4e, this.GetItem(1), t), this.l4e = void 0, this.c8a = 0)
  }
  UnBindRedDot() {
    this.l4e && (RedDotController_1.RedDotController.UnBindRedDot(this.l4e), this.l4e = void 0, this.c8a = 0)
  }
}
