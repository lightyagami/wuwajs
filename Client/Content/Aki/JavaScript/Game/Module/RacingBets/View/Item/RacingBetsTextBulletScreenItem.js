...
class RacingBetsTextBulletScreenItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t) {
    this.Pe = t, this.GetText(2).ShowTextNew(t.Name), 2 === t.Type ? (this.GetTexture(1).SetUIActive(!0), t = DangoManager_1.DangoManager.GetDangoData(t.DangoId), this.SetTextureShowUntilLoaded(t.DangoConfig.IconSmall, this.GetTexture(1)), this.GetSprite(3).SetUIActive(!1)) : (this.GetTexture(1).SetUIActive(!1), this.GetSprite(3).SetUIActive(!0))
  }
