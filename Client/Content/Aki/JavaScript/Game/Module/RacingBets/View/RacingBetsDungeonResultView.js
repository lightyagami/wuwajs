...
class RacingBetsDungeonResultView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.PTc = void 0, this.uat = void 0, this.xTc = () => new RacingBetsLegMatchResultItem_1.RacingBetsLegMatchResultItem, this.lyt = e => {
      this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var [e, t] = this.OpenParam, t = (this.uat = t, this.PTc = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), this.xTc), e.GetLegMatchResultList());
    this.GetText(0).ShowTextNew(e.Name), await this.PTc.RefreshByDataAsync(t)
  }
  OnStart() {
