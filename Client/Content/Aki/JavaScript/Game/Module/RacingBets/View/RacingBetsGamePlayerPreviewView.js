...
class RacingBetsGamePlayPreviewView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Ckc = [], this.iT1 = void 0, this.lyt = () => {
  ...
  async OnBeforeStartAsync() {
    this.Ckc = ModelManager_1.ModelManager.RacingBetsModel.GetDungeonDangoList(), this.iT1 = new RacingBetsDangoRankPanel_1.RacingBetsDangoRankPanel, await this.iT1.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()), await this.iT1.InitAsync(this.Ckc)
  }
  PushCameraHandle(e, a, i) {
    UiCameraAnimationController_1.UiCameraAnimationController.PushCameraHandle(e, a, !0)
  }
