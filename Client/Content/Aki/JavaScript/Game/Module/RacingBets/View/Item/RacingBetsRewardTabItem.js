...
class RacingBetsRewardTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.bTc = void 0, this.ClickToggleCallBack = void 0, this.sp1 = ["Dango_RewardPage_RewardType_1", "Dango_CurrencyPage_DailyTask", "Dango_RewardPage_RewardType_2"], this.onl = () => {
      this.ClickToggleCallBack && this.ClickToggleCallBack(this.bTc)
    }, this.LTc = () => 1 !== this.GetExtendToggle(0).ToggleState
  }
  OnRegisterComponent() {
  ...
  Refresh(t, e, s) {
    this.bTc = t, this.RefreshItem()
  }
  RefreshItem() {
    this.bTc && (this.GetText(1).ShowTextNew(this.sp1[this.bTc.Id - 1]), this.BNe())
  }
  BNe() {
