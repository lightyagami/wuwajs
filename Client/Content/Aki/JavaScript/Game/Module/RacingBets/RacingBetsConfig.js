...
class RacingBetsConfig extends ConfigBase_1.ConfigBase {
  GetRacingBetsSeasonConfig(e) {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsSeason表无效id", ["SeasonId", e])
  }
  GetRacingBetsGroupMatch(e) {
    var n = RacingBetsGroupMatchById_1.configRacingBetsGroupMatchById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsGroupMatch表无效MatchId", ["MatchId", e])
  }
  GetRacingBetsLegMatches(e) {
    var n = RacingBetsLegMatchesById_1.configRacingBetsLegMatchesById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsLegMatches表无效Id", ["id", e])
  }
  GetRacingBetsRewardList(e) {
    var n = RacingBetsRewardBySeasonId_1.configRacingBetsRewardBySeasonId.GetConfigList(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsReward表无效seasonId", ["seasonId", e])
  }
  GetRacingBetsReward(e) {
    var n = RacingBetsRewardById_1.configRacingBetsRewardById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsReward表无效id", ["id", e])
  }
  GetRacingBetsBulletScreen(e) {
    var n = RacingBetsBulletScreenById_1.configRacingBetsBulletScreenById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsBulletScreen表无效bulletScreenId", ["bulletScreenId", e])
  }
  GetRacingBetsBulletScreenList(e) {
    ...
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetsBulletScreen表无效seasonId", ["seasonId", e])
  }
  GetRacingBettingGearList(e) {
    var n = RacingBettingGearBySeasonId_1.configRacingBettingGearBySeasonId.GetConfigList(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBettingGear表无效seasonId", ["seasonId", e])
  }
  GetRacingBetConversionRateList(e) {
    ...
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetConversionRate表无效seasonId", ["seasonId", e])
  }
  GetRacingBetMapPointList(e) {
    var n = RacingBetMapPointBySeasonId_1.configRacingBetMapPointBySeasonId.GetConfigList(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetMapPoint表无效seasonId", ["seasonId", e])
  }
  GetRacingBetRankOpenTime(e) {
    var n = RacingBetRankOpenTimeById_1.configRacingBetRankOpenTimeById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "RacingBetRankOpenTime表无效legMatchId", ["legMatchId", e])
  }
  GetRacingBetsDangoBroadcast(e) {
    var n = DangoBroadcastById_1.configDangoBroadcastById.GetConfig(e);
    if (void 0 !== n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 58, "DangoBroadcast表无效dangoId", ["dangoId", e])
  }
  GetRacingBetConversionRate(e) {
    var n = RacingBetConversionRateById_1.configRacingBetConversionRateById.GetConfig(e);
    return void 0 === n ? (Log_1.Log.CheckError() && Log_1.Log.Error("RacingBets", 78, "RacingBetConversionRate表无效rank", ["rank", e]), 0) : n.ConversionRate
  }
}
