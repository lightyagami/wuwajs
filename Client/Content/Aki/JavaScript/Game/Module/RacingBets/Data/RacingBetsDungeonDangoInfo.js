...
class RacingBetsDungeonDangoInfo {
  constructor(t) {
    this.DangoId = 0, this.DiceId = 0, this.EntityId = 0, this.BpId = 0, this.CurPoint = 0, this.High = 0, this.Rank = 0, this.LastRank = 0, this.DangoId = t.Kz_, this.CurPoint = t.iMs, this.DiceId = t.pJ_, this.High = t.vJ_, this.EntityId = MathUtils_1.MathUtils.LongToNumber(t.F4n), this.BpId = t.rAc
  }
  RealPoint() {
  ...
  GetDiceIcon(t) {
    ...
    return i ? 1 === t ? i.DicePointOneIcon : 2 === t ? i.DicePointTwoIcon : i.DicePointThreeIcon : StringUtils_1.EMPTY_STRING
  }
  IsHalfPass() {
