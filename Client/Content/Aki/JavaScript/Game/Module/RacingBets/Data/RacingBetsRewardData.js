...
exports.RacingBetsRewardData = undefined;
...
class RacingBetsRewardData {
  constructor(t) {
    ...
    this._Tc = 0;
    this.Id = t;
    this.RewardConfig = ConfigManager_1.ConfigManager.RacingBetsConfig.GetRacingBetsReward(t);
  }
  Refresh(t) {
    this.hTc = t.H6n;
    this.lTc = t.cqs;
  ...
  GetProgressText() {
    if (this.hTc === Protocol_1.Aki.Protocol.$J_.Proto_Undone) {
      return this.lTc + "/" + this._Tc;
    } else {
