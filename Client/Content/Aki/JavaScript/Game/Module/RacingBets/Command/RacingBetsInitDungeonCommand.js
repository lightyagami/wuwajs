...
class RacingBetsInitDungeonCommand extends RacingBetsCommandBase_1.RacingBetsCommandBase {
  constructor() {
    super(...arguments), this.mkc = [], this.fkc = [], this.CommandType = 50
  }
  Init(o, e) {
  ...
  async OnExecute() {
    ...
    ControllerHolder_1.ControllerHolder.DangoGlobalController.InitGlobalConfig(RacingBetsDefine_1.DANGO_GLOBAL_CONFIG_PATH, () => {
      e.SetResult()
    }), await e.Promise, await ChessController_1.ChessController.InitChessGameAsync(this.fkc, this.mkc, this.fkc[this.fkc.length - 1].Id), this.s3c(this.mkc)
  }
  s3c(e) {
    for (const t of e) {
      var o = ModelManager_1.ModelManager.CreatureModel.GetEntity(t.CreatureDataId);
      o && CreatureController_1.CreatureController.SetEntityEnable(o.Entity, !0, "RacingBetsInitDungeonCommand active dango")
    }
  }
  LogInfo() {
