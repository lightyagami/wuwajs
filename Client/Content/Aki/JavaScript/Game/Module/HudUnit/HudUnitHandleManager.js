...
const AimHandle_1 = require("./HudUnitHandle/AimHandle"),
  ...
  LuPaAimHandle_1 = require("./HudUnitHandle/LuPaAimHandle"),
...
class HudUnitHandleManager {
  static Init() {
    HudUnitManager_1.HudUnitManager.HudUnitHandleClassArray = [LockCursorHandle_1.LockCursorHandle, StrengthHandle_1.StrengthHandle, AimHandle_1.AimHandle, MonsterCursorHandle_1.MonsterCursorHandle, ManipulateCursorHandle_1.ManipulateCursorHandle, ManipulateAimHandle_1.ManipulateAimHandle, LockExecutionHandle_1.LockExecutionHandle, CameraAimHandle_1.CameraAimHandle, LockPredictedHandle_1.LockPredictedHandle, RoleSideEnergyHandle_1.RoleSideEnergyHandle], HudUnitManager_1.HudUnitManager.HudUnitHandleClassMap = new Map([
