...
class AutoMovingItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.xii = void 0, this.rdt = -1, this.Lti = !1, this.TweenAnimPlayer = new BattleUiTweenAnimPlayer_1.BattleUiTweenAnimPlayer
  }
  OnRegisterComponent() {
  ...
  SetVisible(e) {
    this.Lti !== e && ((this.Lti = e) ? (this.SetActive(!0), this.StopTweenAnim(2), this.PlayTweenAnim(3)) : this.Wti())
  }
  Wti() {
    this.StopTweenAnim(3), this.PlayTweenAnim(2), this.Gii(), this.xii = TimerSystem_1.TimerSystem.Delay(() => {
  ...
  SetPercent(e) {
    e !== this.rdt && (this.GetSprite(0).SetFillAmount(e), 1 === e ? (this.SetChangeColor(!0), this.PlayTweenAnim(1)) : 1 === this.rdt && this.SetChangeColor(!1), this.rdt = e)
  }
  SetChangeColor(e) {
  ...
  PlayTweenAnim(e) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("HudUnit", 17, "[自动奔跑]PlayTweenAnim", ["type", e]), this.TweenAnimPlayer.PlayTweenAnim(e)
  }
  StopTweenAnim(e) {
