...
class StrengthItemBase extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.IsAfterStart = !1, this.RoleData = void 0, this.UiVisibleChanged = void 0, this.TagTaskList = [], this.TweenAnimPlayer = new BattleUiTweenAnimPlayer_1.BattleUiTweenAnimPlayer
  }
  Init(t, e, s) {
    this.RoleData = e, this.UiVisibleChanged = s, this.InitAsync(t).catch(() => {})
  }
  async InitAsync(t) {
  ...
  OnStart() {
    this.IsAfterStart = !0, this.OnAddEvents(), this.OnAddEntityEvents(), this.OnRefreshRoleData()
  }
  OnBeforeShow() {
  ...
  OnBeforeDestroy() {
    this.OnRemoveEvents(), this.RefreshRoleData(void 0), this.IsAfterStart = !1, super.OnBeforeDestroy()
  }
  RefreshRoleData(t) {
    this.RoleData !== t && (this.ClearTagTask(), this.OnRemoveEntityEvents(), this.RoleData = t, this.IsAfterStart) && (this.OnAddEntityEvents(), this.OnRefreshRoleData())
  }
  Tick(t) {}
  GetUiVisible() {
