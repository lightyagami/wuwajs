...
class TreasureCompassUnit extends HudUnitBase_1.HudUnitBase {
  constructor() {
    super(...arguments), this.aHl = void 0, this.kRe = Vector_1.Vector.Create(), this.cie = Rotator_1.Rotator.Create(), this.hHl = [], this.Lrt = !0, this.SPe = void 0
  }
  OnRegisterComponent() {
  ...
  SetActive(t) {
    t !== this.Lrt && ((this.Lrt = t) ? (super.SetActive(!0), this.SPe?.StopCurrentSequence(), this.SPe?.PlaySequencePurely("Start", !1)) : (this.SPe?.StopCurrentSequence(), this.SPe?.PlaySequenceAsync("Close", new CustomPromise_1.CustomPromise).then(() => {
...
class TreasureCompassArrow extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.eii = void 0, this.RWl = void 0, this.cHl = Vector_1.Vector.Create(), this.wWl = !1, this.Lrt = !0, this.SPe = void 0
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UIItem],
  ...
  OnStart() {
    super.OnStart(), this.Lrt = !1, this.RootItem?.SetUIActive(!1), this.eii = this.GetItem(0), this.eii?.SetUIActive(!0), this.RWl = this.GetItem(1), this.RWl?.SetUIActive(!1), this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem)
  }
  Clean() {
    this.SPe?.Clear(), this.SPe = void 0
  }
  SetVisible(t) {
    t !== this.Lrt && ((this.Lrt = t) ? (this.RootItem?.SetUIActive(!0), this.SPe?.StopCurrentSequence(), this.SPe?.PlaySequencePurely("Start", !1)) : (this.SPe?.StopCurrentSequence(), this.SPe?.PlaySequenceAsync("Close", new CustomPromise_1.CustomPromise).then(() => {
  ...
  SetArrowScale(t) {
    this.cHl.X = t, this.cHl.Y = t, this.eii?.SetUIItemScale(this.cHl.ToUeVectorOld())
  }
  SetHighLight(t) {
    t !== this.wWl && (this.wWl = t, this.eii?.SetUIActive(!t), this.RWl?.SetUIActive(t), this.SPe?.StopCurrentSequence(), this.SPe?.PlaySequencePurely("Start", !1))
  }
}
