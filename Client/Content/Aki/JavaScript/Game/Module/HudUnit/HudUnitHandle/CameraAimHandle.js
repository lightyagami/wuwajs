...
class CameraAimHandle extends HudUnitHandleBase_1.HudUnitHandleBase {
  constructor() {
    super(...arguments), this.voi = void 0, this.Moi = void 0, this.Eoi = (t, e, i) => {
      if (t && 0 === e) {
        if (this.Moi !== i && (this.Moi = i), !this.voi) return void this.Soi();
        if (this.voi.ResourceId !== this.Moi) return this.yoi(), void this.Soi()
      }
  ...
  Soi() {
    this.Moi && 0 !== this.Moi.length && (this.voi = this.NewHudUnitWithReturn(CameraAimUnit_1.CameraAimUnit, this.Moi, !0, () => {
