...
class TreasureCompassHandle extends HudUnitHandleBase_1.HudUnitHandleBase {
  constructor() {
    super(...arguments), this.uHl = void 0, this.dHl = !1, this.A2n = 0, this.mHl = e => {
      (this.dHl = e) || this.uHl?.SetActive(!1)
    }
  }
  OnInitialize() {
    super.OnInitialize(), this.dHl = ModelManager_1.ModelManager.TreasureHuntModel.IsCompassActive(), this.A2n = 0, this.CHl()
  }
  OnDestroyed() {
    this.uHl && (this.DestroyHudUnit(this.uHl), this.uHl = void 0), ControllerHolder_1.ControllerHolder.TreasureHuntController.ClearNearbyTrack()
  }
  OnAddEvents() {
  ...
  CHl() {
    this.uHl = this.NewHudUnitWithReturn(TreasureCompassUnit_1.TreasureCompassUnit, "UiItem_ShipRing", !1, () => {
      this.uHl?.InitHide()
    }, !0)
  }
  OnTick(e) {
