...
class VisionEquipmentDropDownItem extends DropDownItemBase_1.DropDownItemBase {
  ...
  OnShowDropDownItemBase(t) {
    ...
    let i = !1;
    e && 0 < e.length && (i = !!e.find(e => e.GetRecommendFetterGroupId() === t)), this.GetItem(4).SetUIActive(i), this.bxt = new VisionFetterSuitItem_1.VisionFetterSuitItem(this.GetItem(2)), this.bxt.Init();
    e = t;
    let o = [],
      r = "";
    r = 0 < t ? (o = ModelManager_1.ModelManager.PhantomBattleModel.GetVisionSortUseDataList(t, 0), n = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupById(t), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(n.FetterGroupName) ?? "") : (o = ModelManager_1.ModelManager.PhantomBattleModel.GetVisionSortUseDataList(0, 0), MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_FilterTextAllVisionFetter_Text") ?? ""), this.GetText(3).SetText(o.length.toString()), this.GetText(1).SetText(r);
    var n = e ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupById(e) : void 0;
