...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.VisionAssembleScrollItem = exports.VisionAssembleScrollItemData = void 0;
const UE = require("ue"),
...
class VisionAssembleScrollItemData {
  constructor() {
    this.GroupIndex = 0, this.ClickCallback = () => {}, this.CurrentSelectState = !1, this.VisionEquipGroupData = void 0, this.CheckIfCanSelect = () => !0
  }
}
...
class VisionAssembleScrollItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.sl_ = [], this.$8i = void 0, this.al_ = void 0, this.A5e = () => !this.$8i.CurrentSelectState && this.$8i.CheckIfCanSelect(), this.kqe = () => {
  ...
  async sGe() {
    if (void 0 !== this.al_) await this.al_.Promise;
      ...
      for (let s = 0; s < 5; s++) {
        ...
        this.sl_.push(i), t.push(i.CreateByActorAsync(this.GetItem(2 + s).GetOwner()))
      }
  ...
  async hl_(s) {
    ...
    if (s) {
      var t = s.GetVisionUniqueIdList(),
        i = t.length;
      for (let s = 0; s < i; s++) ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(t[s]) && this.sl_[s].Update(t[s])
    }
  }
  uz_() {
    var s = this.GetExtendToggle(9),
      t = (s.SetToggleStateForce(0, !1), s.StateSwitchAnimations.Get(1));
    void 0 !== t && (t = t.Animation.LevelSequence, s.GetOwner().SequenceJumpToEnd(t))
  }
}
