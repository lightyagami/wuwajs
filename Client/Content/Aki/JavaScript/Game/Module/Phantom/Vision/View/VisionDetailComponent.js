...
class VisionDetailComponent extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.H8i = !1, this.dFe = 0, this.i6 = 0, this.j8i = void 0, this.wqe = void 0, this.W8i = void 0, this.K8i = void 0, this.OnClickMainItem = () => {}, this.wqe = t
  }
  async Init() {
  ...
  async OnBeforeStartAsync() {
    this.K8i = new VisionDetailInfoComponent_1.VisionDetailInfoComponent(this.GetItem(1)), await this.K8i.Init()
  }
  OnStart() {
    this.W8i = new VisionDetailUnderComponent_1.VisionDetailUnderComponent(this.GetItem(0)), this.K8i.SetClickCallBack(this.OnClickMainItem)
  }
  GetTxtItemByIndex(t) {
  ...
  Update(t, e, i, s = !1) {
    this.j8i = t, this.dFe = e, this.i6 = i, this.H8i = s, this.Q8i(), this.W8i.Update(t)
  }
  Q8i() {
    var t = this.H8i ? 1 : 0,
    ...
    let i = -1;
    this.H8i || (i = ModelManager_1.ModelManager.PhantomBattleModel.CurrentEquipmentSelectIndex);
    ...
    r && r?.GetIncrId() === this.j8i.GetUniqueId() || (o = !0), VisionDetailDescComponent_1.VisionDetailDesc.ConvertVisionSkillDescToDescData(this.j8i.GetNormalSkillConfig(), this.j8i.GetPhantomLevel(), 0 === i || -1 === i, o, this.j8i.GetQuality()).forEach(t => {
      e.AddDescData(t)
    }), VisionDetailDescComponent_1.VisionDetailDesc.ConvertVisionFetterDataToDetailDescData(s, n, () => {
      ...
      e.AddDescData(t)
    }), this.H8i && e.DescData?.forEach(t => {
      t.AnimationState = !1, t.CompareState = this.H8i
    }), n && VisionDetailDescComponent_1.VisionDetailDesc.CreateSameMonsterTips().forEach(t => {
      e.AddDescData(t)
    }), this.K8i.Refresh(e, this.H8i, t), this.K8i.SetActive(!0)
  }
