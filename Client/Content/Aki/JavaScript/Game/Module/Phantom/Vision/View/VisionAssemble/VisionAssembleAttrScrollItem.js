...
class VisionAssembleAttrScrollItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, r) {
    this.WNe(r);
    var r = e.CompareMode,
      i = (this.GetItem(0).SetUIActive(r), ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.AttrId));
    if (r) {
      this.SetTextureByPath(i.Icon, this.GetTexture(2)), this.GetText(3).ShowTextNew(i.Name);
      const a = AttributeModel_1.TipsDataTool.GetPropRatioValue(e.CompareValue, e.IfPercentage),
        o = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.AttrId, a, e.IfPercentage);
      this.GetText(4).SetText(o.toString());
      var r = e.CompareValue === e.CurrentValue,
        s = e.CompareValue < e.CurrentValue;
      this.GetItem(9).SetUIActive(s && !r), this.GetItem(10).SetUIActive(!s && !r)
    } else this.GetItem(9).SetUIActive(!1), this.GetItem(10).SetUIActive(!1);
    this.SetTextureByPath(i.Icon, this.GetTexture(6)), this.GetText(7).ShowTextNew(i.Name);
