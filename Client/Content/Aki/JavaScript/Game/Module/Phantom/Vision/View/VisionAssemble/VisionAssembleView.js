...
class VisionAssembleView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Z6i = 36, this.ll_ = new Array, this.ko_ = 0, this.lqe = void 0, this._l_ = void 0, this.cl_ = void 0, this.ul_ = void 0, this.vpt = void 0, this.i7i = new Array, this.Z9i = 0, this.h8e = void 0, this.nvt = void 0, this.dl_ = void 0, this.p9t = void 0, this.Yja = EMPTYSELECTINDEX, this.ml_ = !1, this.f4_ = void 0, this.g4_ = void 0, this.dY_ = void 0, this.WCo = () => {
      this.Cl_(), this.gl_(), this.pl_(), this.fl_(), this.vl_(), this.yl_(), this.bqe(!0)
    }, this.CU_ = () => {
      this.a7i(), this.mY_(), this.fY_();
      var t = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupList().length;
      this.Yja = t - 1, this.bqe(), this.Ml_(), this.El_(), this.pl_(), this.fl_(), this.vl_(), this.Ul_()
    }, this.pU_ = () => {
      var t = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupList().length;
      this.Yja = 0 < t ? 0 : STATICINDEX, this.vU_()
    }, this.yU_ = () => {
      var t = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupList().length;
      this.Yja = 0 < t ? 0 : STATICINDEX, this.vU_(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionAssembleNavigationRefresh, !1)
    }, this.SU_ = () => {
    ...
    }, this.c8e = t => new VisionEquipmentDropDownTitleItem_1.VisionEquipmentDropDownTitleItem(t), this.Il_ = () => {
      this.ml_ = !this.ml_;
      var t = !!this.ml_;
      this.Ml_(t), this.fl_(), this.gl_(), ModelManager_1.ModelManager.UiNavigationModel.TrySetCursorActive(!1), this.ml_ ? (this.Cl_(), this.PlaySequence("Start_B", () => {
        EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionAssembleNavigationRefresh, !0)
      }, !0)) : (this.Cl_(), this.PlaySequence("Close_B", () => {
        EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionAssembleNavigationRefresh, !0)
      }, !0)), this.gY_()
    }, this.Tl_ = () => {
      this.Yja === STATICINDEX ? this.Yja = EMPTYSELECTINDEX : this.Yja = STATICINDEX, this.bl_(), this.fl_(), this.pl_(), this.Ml_(), this.Ul_()
    }, this.sOt = () => {
      var t = this.RNr();
      2 === t ? (this.Ll_(), this.fY_()) : 1 === t ? this.Al_() : 3 === t && ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId("VisionAssembleHasUseTips")
    }, this.xl_ = () => {
      var t = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("VisionAssembleCurrentIndex"), (this.Yja + 1).toString()),
        e = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupDataByIndex(this.Yja)?.GetName();
      ...
      var t;
      ModelManager_1.ModelManager.VisionEquipGroupModel.GetLocalTipsState() ? ControllerHolder_1.ControllerHolder.VisionEquipGroupController.RequestPutVisionGroupToTop(this.Yja) : ((t = new ConfirmBoxDefine_1.ConfirmBoxDataNew(242)).HasToggle = !0, t.ToggleText = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("VisionAssembleTopNeverTips"), t.SetToggleFunction(this.RMt), t.FunctionMap.set(2, () => {
      ...
      this.ll_ = t;
      t = this.Bl_();
      0 === t.length ? this.Yja = STATICINDEX : this.Yja = t[0].GetIndex(), this.bl_(!1), this.mP_(), this.fY_()
    }, this.AMo = () => {
      this.CloseMe()
    }, this.Qq_ = () => !0, this.wl_ = t => {
      t = t.GetIndex();
      t === this.Yja ? (this.Yja = EMPTYSELECTINDEX, this.ml_ = !1) : this.Yja = t, this.bl_(), this.Ul_(), this.Cl_()
    }
  }
  OnRegisterComponent() {
  ...
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnVisionGroupDataAdd, this.CU_), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnVisionGroupDataDelete, this.pU_), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnVisionGroupDataToTop, this.yU_), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnVisionGroupDataChangeName, this.SU_), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.PhantomEquip, this.WCo)
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnVisionGroupDataAdd, this.CU_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnVisionGroupDataDelete, this.pU_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnVisionGroupDataToTop, this.yU_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnVisionGroupDataChangeName, this.SU_), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.PhantomEquip, this.WCo)
  }
  async OnBeforeStartAsync() {
    this.ko_ = this.OpenParam, this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.lqe.SetCloseCallBack(this.AMo), this._l_ = new VisionAssembleStaticItem, await this._l_.CreateByActorAsync(this.GetItem(1).GetOwner()), this._l_.BindClickCallBack(this.Tl_), this._l_.SetActive(!0), this.cl_ = new VisionAssembleTopItem, await this.cl_.CreateByActorAsync(this.GetItem(9).GetOwner()), this.cl_.BindClickReNameCallBack(this.xl_), this.ul_ = new VisionAssembleTopItem, await this.ul_.CreateByActorAsync(this.GetItem(8).GetOwner()), this.ul_.SetReBtnActive(!1), this.nvt = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(10), this.sGe), this.p9t = new ButtonItem_1.ButtonItem(this.GetItem(15)), this.p9t.SetFunction(this.sOt), this.dl_ = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(2), this.GetItem(3).GetOwner(), this.Pl_), this.vpt = new FilterEntrance_1.FilterEntrance(this.GetItem(5), this.Qvt), await this.aHi();
    var e = this.GetItem(19)?.GetOwner()?.K2_GetComponentsByClass(UE.UIInturnAnimController.StaticClass());
    if (e)
      for (let t = 0; t < e.Num(); t++) {
        var i = e.Get(t);
        "Start_R" === i.AnimName && (this.f4_ = i, this.f4_.PlayFromIndex = 1), "Start_L" === i.AnimName && (this.g4_ = i, this.g4_.PlayFromIndex = 1)
      }
  }
  async aHi() {
    this.h8e = new CommonDropDown_1.CommonDropDown(this.GetItem(6), this.m8e, this.c8e), await this.h8e.Init();
    var t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupArray();
    this.i7i.push(0), t.forEach(t => {
      this.i7i.push(t.Id)
    }), this.h8e.SetOnSelectCall(this.C8e), this.h8e.SetShowType(1), this.h8e.InitScroll(this.i7i, this.g8e, this.Z9i)
  }
  vU_() {
    this.bqe(), this.Ml_(), this.El_(), this.pl_(), this.fl_(), this.vl_(), this.a7i()
  }
  gY_(t = !1) {
    var e;
    this.Yja !== STATICINDEX && this.dY_?.length && (e = this.dY_.findIndex(t => t.CurrentSelectState), this.dl_?.ScrollToGridIndex(0 <= e ? e : 0, t))
  }
  fY_() {
  ...
  mY_() {
    let t = !1;
    return 0 !== this.Z9i && (this.h8e.SetSelectedIndex(0), t = !0), t = this.vpt.TryClearData() ? !0 : t
  }
  Al_() {
    var t, e;
    let i = !0;
  ...
  Ll_() {
    ...
    e ? ((t = new ConfirmBoxDefine_1.ConfirmBoxDataNew(244)).FunctionMap.set(2, () => {
      ControllerHolder_1.ControllerHolder.VisionEquipGroupController.RequestApplyVisionGroup(this.Yja, this.ko_)
    }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(t)) : ControllerHolder_1.ControllerHolder.VisionEquipGroupController.RequestApplyVisionGroup(this.Yja, this.ko_)
  }
  a7i() {
  ...
  OnBeforeShow() {
    this.a7i(), this.Yja = STATICINDEX, this.bqe(!1, !0), this.Dl_(), this.yl_(), this.Cl_(), this.Ml_(!1, () => {
      for (const t of this.nvt?.GetScrollItemList()) t.SetRightItemAlpha(0);
      this.f4_?.Play()
    }), this.El_(), this.gl_(), this.pl_(), this.fl_(), this.vl_(), this.Ul_(), this.mP_(), this.iq_()
  }
  Dl_() {
  ...
  Bl_() {
    ...
    for (let i = 0; i < t; i++) {
      var h = s[i];
      let t = !1,
        e = (0 < n && !ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionFetterDataByIncIdList(h.GetVisionUniqueIdList()).find(t => t.FetterGroupId === n) || (t = !0), !o);
      0 < this.ll_.length ? e = this.ll_.includes(h.GetIndex()) : o || (e = !0), t && e && r.push(h)
    }
    return r
  }
  bqe(t = !1, e = !1) {
    var i = this.Q7_() || 0 < this.Z9i,
      s = this.Bl_(),
      r = s.length,
      n = (ModelManager_1.ModelManager.VisionEquipGroupModel.FilterDataLength = r, ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomEquipGroupCountMax()),
      o = new Array,
      n = i ? s.length : n;
    for (let t = 0; t < n; t++) {
      var h = new VisionAssembleScrollItem_1.VisionAssembleScrollItemData,
        a = t < r ? s[t] : void 0;
      h.GroupIndex = t, h.ClickCallback = this.wl_, h.CurrentSelectState = a?.GetIndex() === this.Yja, h.VisionEquipGroupData = a, h.CheckIfCanSelect = this.Qq_, o.push(h)
    }
    this.dY_ = o, this.dl_?.RefreshByData(o, t, () => {
  ...
  bl_(t = !0) {
    this.bqe(t), this.gl_(), this.vl_(), this.pl_(), this.fl_(), this.Ul_(), this.Ml_(!1, () => {
      for (const t of this.nvt?.GetScrollItemList()) t.SetRightItemAlpha(0);
      this.f4_?.Play()
    })
  }
  ...
  ql_(e) {
    ...
    if (this.p9t.SetActive(t), t) {
      let t = "";
      t = 2 === e || 3 === e ? "VisionAssembleUse" : "VisionAssembleSave", this.p9t?.SetShowText(t)
    }
  }
  RNr() {
    ...
    var e = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupDataByIndex(this.Yja).GetVisionUniqueIdList(),
      i = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(this.ko_).GetPhantomData().GetIncrIdList();
    let s = !0;
  ...
  mP_() {
    var t = this.Q7_() && 0 === this.Bl_().length || 0 < this.Z9i && 0 === this.Bl_().length;
    this.GetItem(18).SetUIActive(t)
  }
  Ml_(e = !1, i = void 0) {
    if (this.Yja === EMPTYSELECTINDEX) this.GetScrollViewWithScrollbar(10).RootUIComp.SetUIActive(!1), this.GetItem(14).SetUIActive(!0);
    else {
      var t = this.fP_();
      this.GetScrollViewWithScrollbar(10).RootUIComp.SetUIActive(!t), this.GetItem(14).SetUIActive(t);
  ...
  El_() {
    var t = ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionEquipGroupList().length,
      e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomEquipGroupCountMax();
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(7), "VisionAssembleHasSave", t, e)
  }
  iq_() {
    this.PlaySequence("Start_InfR", void 0, !0), this.f4_?.OnFinish.Bind(() => {
      this.f4_?.SetItemDefaultAlphaZero(!1)
    }), this.f4_?.Play("Start_R")
  }
  vl_() {
    var t = this.cl_?.GetActive();
    this.cl_?.Refresh(this.Fl_()), !0 !== t && (this.cl_?.SetActive(!0), this.Ml_(), this.PlaySequence("Start_InfR", void 0, !0))
  }
  Ul_() {
  ...
  Gl_() {
    ...
    e.Name = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("VisionAssembleCurrentEquip"), e.Index = -1;
    let i = 0;
    ...
    var t = t.GetPhantomData().GetIncrIdList(),
      t = this.CP_(ModelManager_1.ModelManager.VisionEquipGroupModel.GetVisionFetterDataByIncIdList(Array.from(t))),
      n = new Array;
    for (const h of t) {
      var o = new VisionAssembleSuitItem_1.VisionAssembleSuitItemData;
      o.Phrase(h), n.push(o)
...
class VisionAssembleStaticItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.sl_ = [], this.Nji = void 0, this.kqe = () => {
      this.Nji?.()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let t = 0; t < 5; t++) {
      ...
      this.sl_.push(i), e.push(i.CreateByActorAsync(this.GetItem(1 + t).GetOwner()))
    }
    await Promise.all(e);
    for (const t of this.sl_) t.SetActive(!0)
  }
  RefreshSelectState(t, e) {
    e ? (this.GetExtendToggle(0).SetToggleState(2), this.GetExtendToggle(0).SetSelfInteractive(!1)) : (this.GetExtendToggle(0).SetToggleState(t ? 1 : 0), this.GetExtendToggle(0).SetSelfInteractive(!0))
  }
  Refresh(t) {
...
class VisionAssembleTopItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.eGe = void 0, this.Nl_ = void 0, this.Vl_ = !0, this.xl_ = () => {
      this.Nl_?.()
    }, this.sGe = () => {
  ...
  OnStart() {
    this.eGe = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.sGe), ModelManager_1.ModelManager.VisionEquipGroupModel.SaveVisionGroupFirstOpenState(!1)
  }
  SetReBtnActive(t) {
    this.Vl_ = t
  }
  ...
  Refresh(e) {
    if (e) {
      this.GetButton(5).RootUIComp.SetUIActive(this.Vl_ && 0 <= e.Index), this.SetActive(!0), this.GetText(0).SetText(e.Name);
      let t = 0 <= e.Index ? (e.Index + 1).toString() : ""; - 1 === e.Index ? t = "" : t.length < 2 && (t = "0" + t), this.GetText(1).SetText(t);
      var i = ModelManager_1.ModelManager.PhantomBattleModel.GetMaxCost();
      this.GetText(2).SetText(e.Cost + "/" + i), this.eGe?.RefreshByData(e.SuitList)
