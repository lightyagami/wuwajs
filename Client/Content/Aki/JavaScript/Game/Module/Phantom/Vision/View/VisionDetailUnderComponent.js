...
class VisionDetailUnderComponent extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.M9i = void 0, this.E9i = void 0, this.S9i = void 0, this.iNe = void 0, this.tNe = void 0, this.y9i = () => {
      this.iNe?.()
    }, this.I9i = () => {
      this.tNe?.()
  ...
  OnStart() {
    this.E9i = new ButtonItem_1.ButtonItem(this.GetItem(0)), this.E9i.SetFunction(this.y9i), this.S9i = new ButtonItem_1.ButtonItem(this.GetItem(1)), this.S9i.SetFunction(this.I9i), this.M9i = new EquipRoleAttribute(this.GetItem(2))
  }
  ...
  Update(e) {
    this.M9i.SetActive(ControllerHolder_1.ControllerHolder.PhantomBattleController.CheckIsEquip(e.GetUniqueId())), this.M9i.Update(e)
  }
}
  ...
  Update(i) {
    if (ControllerHolder_1.ControllerHolder.PhantomBattleController.CheckIsEquip(i.GetUniqueId())) {
      var o = ControllerHolder_1.ControllerHolder.PhantomBattleController.GetEquipRole(i.GetUniqueId()),
        i = (ModelManager_1.ModelManager.RoleSkinModel?.GetRoleSkinDataByRoleId(o)).GetRoleSkinConfig(),
        r = ConfigManager_1.ConfigManager.ComponentConfig.GetRoleSkinConfigParam("RoleIcon1");
      ...
      for (let e = 0; e < n; e++)
        if (s[e].Id === o) {
          t = !0;
          break
        } t && (e = ModelManager_1.ModelManager.FunctionModel.GetPlayerName()), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "VisionEquipping", e)
    }
  }
}
