...
class VisionMainAttributeComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Layout = void 0, this.sGe = () => new VisionIdentifyAttributeItem_1.VisionIdentifyAttributeItem
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.Layout = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(0), this.sGe), this.SetActive(!0), this.GetItem(1).SetUIActive(!1)
  }
  Update(e) {
