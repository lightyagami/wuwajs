...
class VisionLevelUpSettingPopView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.c1l = 0, this.tBt = 0, this.m1l = () => {
      this.SetPutInMode(0)
    }, this.d1l = () => {
      this.SetPutInMode(1)
    }, this.C1l = () => {
  ...
  OnStart() {
    ...
    this.c1l = i.GetVisionLevelUpMaterialPutInMode(), this.tBt = i.GetVisionLevelUpMaterialUseType(), this.Refresh()
  }
  Refresh() {
  ...
  RefreshPutInModeToggle() {
    let i = void 0,
      t = void 0;
    t = 0 === this.c1l ? (i = 1, 0) : (i = 0, 1), this.GetExtendToggle(0)?.SetToggleState(i), this.GetExtendToggle(1)?.SetToggleState(t)
  }
  RefreshUseTypeToggle() {
    let i = void 0,
      t = void 0;
    t = 0 === this.tBt ? (i = 1, 0) : (i = 0, 1), this.GetExtendToggle(2)?.SetToggleState(i), this.GetExtendToggle(3)?.SetToggleState(t)
  }
  SetPutInMode(i) {
  ...
  SaveSetting() {
    var i = ModelManager_1.ModelManager.PhantomBattleModel;
    i.SetVisionLevelUpMaterialPutInMode(this.c1l), i.SetVisionLevelUpMaterialUseType(this.tBt)
  }
}
