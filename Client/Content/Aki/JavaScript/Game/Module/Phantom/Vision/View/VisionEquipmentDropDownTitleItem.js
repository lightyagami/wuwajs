...
exports.VisionEquipmentDropDownTitleItem = undefined;
const UE = require("ue");
...
class VisionEquipmentDropDownTitleItem extends TitleItemBase_1.TitleItemBase {
  ...
  ShowTemp(e, t) {
    ...
    var i = e;
    let r = "";
    r = e > 0 ? (e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupById(e), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.FetterGroupName) ?? "") : MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_FilterTextAllVisionFetter_Text") ?? "";
