...
class VisionEquipmentDragItem extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    this.bxt = new VisionFetterSuitItem_1.VisionFetterSuitItem(this.GetItem(3)), await this.bxt.Init(), this.bxt.SetActive(!1)
  }
  OnStart() {}
  GetDragComponent() {
  ...
  UpdateItem(e) {
    var t = e.GetQuality(),
      ...
      i = (this.bxt.Update(i), this.SetSpriteByPath(t, this.GetSprite(0), !1), ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(e.GetConfigId(!0)));
