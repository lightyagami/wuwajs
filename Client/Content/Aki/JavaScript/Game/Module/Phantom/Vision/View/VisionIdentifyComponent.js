...
class LevelUpIdentifyComponent extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.Layout = void 0, this.IHi = void 0, this.THi = void 0, this.LHi = void 0, this.sGe = () => new VisionIdentifyItem_1.VisionIdentifyItem, this.IHi = e
  }
  async Init(e) {
  ...
  OnStart() {
    this.Layout = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(0), this.sGe), this.GetItem(1).SetUIActive(!1)
  }
  async PlayUpdateAnimation(e) {
    await this.LHi?.Promise;
    let t = 0;
    const i = [],
      s = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionIdentifyAnimationTime();
    e.forEach(e => {
