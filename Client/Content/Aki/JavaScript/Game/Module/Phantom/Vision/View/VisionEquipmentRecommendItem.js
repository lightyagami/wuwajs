...
class VisionEquipmentRecommendItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Oo_ = new Array, this.Go_ = new Array, this.Fo_ = new Array, this.No_ = new Array, this.Vo_ = void 0, this.jo_ = void 0, this.O5t = 0, this.ko_ = 0, this.Ho_ = void 0, this.jl_ = () => {
      ...
      if (1 === s.Type) {
        ...
        for (let t = 0; t < this.Oo_.length; t++)
          if (this.Oo_[t].AttrId === s.AttrId && this.Oo_[t].AddType === s.AddType) {
            e = !0, i = t;
            break
          } e ? this.Oo_.splice(i, 1) : ((t = new VisionRecommendModel_1.VisionSelectRecommendData).AttrId = s.AttrId, t.AddType = s.AddType, this.Oo_.push(t))
      } else {
        let e = !1,
          i = -1;
        ...
        e ? this.Go_.splice(i, 1) : ((t = new VisionRecommendModel_1.VisionSelectRecommendData).AttrId = s.AttrId, t.AddType = s.AddType, this.Go_.push(t))
      }
      this.Wo_()
    }
  }
  ...
  async OnCreateAsync() {
    this.Vo_ = new RecommendAttrItem, await this.Vo_.CreateByActorAsync(this.GetItem(2).GetOwner()), this.Vo_.SetActive(!0), this.jo_ = new RecommendAttrItem, await this.jo_.CreateByActorAsync(this.GetItem(3).GetOwner()), this.jo_.SetActive(!0)
  }
  ...
  Pd_(t) {
    0 === t ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "PrefabTextItem_PhantomRecommendTarget_Text", MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_FilterTextAll_Text")) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "PrefabTextItem_PhantomRecommendTarget_Text", "COST" + t)
  }
  Wo_() {
    var t = ModelManager_1.ModelManager.VisionRecommendModel.GetRoleCostAttrRecommendInfo(this.ko_, this.O5t);
    if (ModelManager_1.ModelManager.VisionRecommendModel.CurrentSelectMainAttrArray = this.Oo_, ModelManager_1.ModelManager.VisionRecommendModel.CurrentSelectSubAttrArray = this.Go_, t) {
      var e = t.GetMainAttrRecommendInfo();
      this.Fo_ = new Array;
      for (const r of e) {
        var i = new RecommendItemData;
        i.AttrId = r.GetAttrId(), i.AddType = r.GetAddType(), i.CurrentSelectArray = this.Oo_, i.UsageText = r.GetUsageText(), i.Type = 1, i.OnSelectCallBack = this.Qo_, this.Fo_.push(i)
      }
      ...
      for (const n of e) {
        ...
        s.AttrId = n.GetAttrId(), s.AddType = n.GetAddType(), s.CurrentSelectArray = this.Go_, s.UsageText = n.GetUsageText(), s.Type = 2, s.OnSelectCallBack = this.Qo_, this.No_.push(s)
      }
  ...
  OnBeforeDestroy() {
    ModelManager_1.ModelManager.VisionRecommendModel.CurrentSelectMainAttrArray = [], ModelManager_1.ModelManager.VisionRecommendModel.CurrentSelectSubAttrArray = []
  }
}
exports.VisionEquipmentRecommendItem = VisionEquipmentRecommendItem;
class RecommendItemData {
  constructor() {
    this.AttrId = 0, this.AddType = 0, this.CurrentSelectArray = new Array, this.UsageText = "", this.Type = 0, this.OnSelectCallBack = void 0
  }
}
class RecommendAttrItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.eGe = void 0, this.sGe = () => {
...
class AttrContent extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.$8i = void 0, this.OnClickTogOption = () => {
      void 0 !== this.$8i && void 0 !== this.$8i.OnSelectCallBack && this.$8i.OnSelectCallBack(this.$8i)
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [0, this.OnClickTogOption]
    ]
  }
  Refresh(t, e, i) {
    this.$8i = t;
    var s = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(t.AttrId),
      r = (this.SetTextureByPath(s.Icon, this.GetTexture(1)), 2 === this.$8i.AddType),
