...
class PhantomRoleEquipmentData {
  ...
  Phrase(t) {
    t instanceof Protocol_1.Aki.Protocol.z6s ? (this.dFe = t.Q6n, this.NVi = t.eHn) : t instanceof Protocol_1.Aki.Protocol.Z6s && (this.OVi = t)
  }
  GetRoleId() {
    return this.dFe
  }
  ...
  GetPropDetailAttributeList() {
    ...
    return t.forEach(r => {
      ...
      n || (t = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(r), i.push(new AttrListScrollData_1.AttrListScrollData(r, 0, 0, t.Priority, !1, 1)))
    }), i
  }
  GetPropShowAttributeList() {
    var r = new Array;
    const e = new Map,
      o = (this.OVi?.bws.forEach(t => {
        e.set(t.Z4n, t.e5n)
      }), new Map);
    ...
    for (let t = 0; t < n; t++) {
      ...
      r.push(new AttrListScrollData_1.AttrListScrollData(i[t], e.get(i[t]), o.get(i[t]) ?? 0, a.Priority, !1, 1))
    }
    return r
  }
  CheckHasEmpty() {
