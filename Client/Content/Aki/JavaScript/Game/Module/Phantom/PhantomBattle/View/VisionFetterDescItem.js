...
class VisionFetterDescItem extends UiPanelBase_1.UiPanelBase {
  ...
  P5e(e, t) {
    e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomFetterById(e), e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Name);
    this.GetText(0).SetText(e ?? ""), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "VisionFetterDetailViewName", e, t.toString())
  }
  Dke(e) {
