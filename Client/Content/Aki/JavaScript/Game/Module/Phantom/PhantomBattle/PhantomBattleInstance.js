...
class PhantomBattleInstance {
  constructor(t) {
    this.xe = 0, this.HOi = void 0, this.i6i = void 0, this.PhantomId = t.MonsterId, this.PhantomItem = t, this.PhantomSkill = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSkillList(t.SkillId)
  }
  set PhantomId(t) {
    this.xe = t
  }
