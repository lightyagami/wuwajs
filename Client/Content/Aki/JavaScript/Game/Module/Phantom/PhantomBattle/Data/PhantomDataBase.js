...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PhantomDataBase = exports.VisionSubPropData = exports.VisionSubPropViewData = exports.VisionSlotData = exports.VisionFetterData = void 0;
...
class VisionFetterData {
  constructor() {
    this.FetterGroupId = 0, this.FetterId = 0, this.NeedActiveNum = 0, this.ActiveFetterGroupNum = 0, this.ActiveState = !1, this.NewAdd = !1
  }
}
...
class VisionSubPropViewData {
  constructor() {
    this.Data = void 0, this.SourceView = "", this.IfPreCache = !1, this.CurrentVisionData = void 0, this.NeedHighLight = !1
  }
}
exports.VisionSubPropViewData = VisionSubPropViewData;
class VisionSubPropData {
  constructor(t, e) {
    this.wVi = 0, this.Pe = void 0, this.SlotState = 0, this.PhantomSubProp = void 0, this.wVi = t, this.Pe = e
  }
  GetSubPropName() {
  ...
  GetLevelUpViewName() {
    var t;
    return 0 === this.SlotState ? (t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("LevelUpAndIdentify") ?? "", StringUtils_1.StringUtils.Format(t, this.GetUnlockLevel().toString())) : 1 === this.SlotState ? MultiTextLang_1.configMultiTextLang.GetLocalTextNew("WaitForIdentify") ?? "" : 3 === this.SlotState ? this.GetSubPropName() : 2 === this.SlotState ? (t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("LevelUpAndIdentify") ?? "", StringUtils_1.StringUtils.Format(t, this.GetUnlockLevel().toString())) : 5 === this.SlotState || 4 === this.SlotState ? MultiTextLang_1.configMultiTextLang.GetLocalTextNew("CurrentIdentifyUnlockText") ?? "" : ""
  }
  GetAttributeValueString() {
    var t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(this.PhantomSubProp.Yws),
      ...
      r = AttributeModel_1.TipsDataTool.GetPropRatioValue(this.PhantomSubProp.e5n, e);
    return ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(t.PropId, r, e)
  }
  GetUnlockLevel() {
    var t = this.Pe.GetQuality(),
      t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSlotUnlockLevel(t);
...
class PhantomDataBase {
  constructor() {
    this.PhantomMainProp = [], this.PhantomSubProp = [], this.PhantomLevel = 0, this.PhantomExp = 0, this.ItemId = 0, this.FuncValue = 0, this.SuspendSlot = void 0, this.BVi = 0, this.FetterGroupId = 0, this.bVi = 0, this.X8_ = void 0
  }
  SetPhantomLevel(t) {
    this.PhantomLevel = t
  }
  ...
  GetVisionIfCanRecovery() {
    return 0 === this.GetPhantomLevel() && 0 === this.GetExp() && !this.GetIsLock()
  }
  GetVisionIfCanRefine() {
    return 0 === this.GetPhantomLevel() && 0 === this.GetExp() && !this.GetIsLock() && this.GetQuality() >= CalabashDefine_1.VISION_REFINE_FILTER_QUALITY
  }
  IsMax() {
  ...
  GetFullExp() {
    ...
    let e = 0;
    for (let t = 1; t <= this.GetPhantomLevel(); t++) e += ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomLevelExpByGroupIdAndLevel(this.d8a().PhantomItem.LevelUpGroupId, t);
  ...
  UpdateData(t) {
    this.BVi = t.b9n ?? 0, this.FuncValue = t.Vws ?? 0, this.PhantomLevel = t.$ws ?? 0, this.PhantomExp = t.Hws ?? 0, this.PhantomMainProp = t.jws ?? [], this.PhantomSubProp = t.Wws ?? [], this.FetterGroupId = t.Kws ?? 0, this.bVi = t.Z7n ?? 0
  }
  SetMainProp(t) {
  ...
  GetSuspendAttributeData() {
    ...
    return t.forEach(t => {
      var e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(t.Yws),
        r = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(t.Yws),
        i = e.AddType === CommonComponentDefine_1.RATIO,
        t = AttributeModel_1.TipsDataTool.GetPropRatioValue(t.e5n, i);
      n.push(new AttrListScrollData_1.AttrListScrollData(e.PropId, 0, t, r.Priority, i, 1))
    }), n
  }
  GetSlotIndexAttributeData(t, e) {
    var r, i, n, a;
    if (this.GetSlotIndexDataEx(t)) return t = this.GetSlotIndexDataEx(t), r = new Array, i = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(t.Yws), n = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(t.Yws), a = i.AddType === CommonComponentDefine_1.RATIO, t = AttributeModel_1.TipsDataTool.GetPropRatioValue(t.e5n, a), r.push(new AttrListScrollData_1.AttrListScrollData(i.PropId, 0, t, n.Priority, a, e)), r
  }
  IsFunctionValue(t) {
  ...
  qVi(t, e) {
    var r, i, n = ModelManager_1.ModelManager.PhantomBattleModel.GetBattleDataById(e).GetIncrIdList();
    return -1 === t || (r = ModelManager_1.ModelManager.PhantomBattleModel.GetBattleDataById(e).GetIndexPhantomId(t)) === (i = this.GetIncrId()) ? n : (n = Array.from(ModelManager_1.ModelManager.PhantomBattleModel.GetBattleDataById(e).GetIncrIdList()), 0 === r ? (this.GetEquipRoleId() === e && (n[this.GetEquipRoleIndex()] = 0), n[t] = i) : r !== i && (this.GetEquipRoleId() === e && (n[this.GetEquipRoleIndex()] = n[t]), n[t] = i), n)
  }
  static CalculateFetterByPhantomBattleData(e) {
    ...
    for (let t = 0; t < r; t++) {
      var a = e[t];
      if (a) {
        var o, s = a.GetFetterGroupId();
        let t = n.get(s);
        (t = t || new Array).includes(a.GetMonsterId()) || (o = i.get(s) ?? 0, i.set(s, o + 1), t.push(a.GetMonsterId())), n.set(s, t)
      }
    }
    return i
  }
  ...
  GetPreviewShowFetterList(t, e) {
    ...
    if (!(this.FetterGroupId <= 0)) {
      ...
      var n = i.length,
        o = new Array;
      for (let t = 0; t < n; t++) {
        var s = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(i[t]);
        s && o.push(s)
      }
      ...
      r.forEach((e, t) => {
        var r = new VisionFetterData,
          i = (r.FetterGroupId = this.FetterGroupId, r.FetterId = e, r.NeedActiveNum = t, r.ActiveFetterGroupNum = u.get(this.FetterGroupId) ?? 0, r.ActiveState = u.get(this.FetterGroupId) >= t, u.get(this.FetterGroupId) >= t);
        let n = !1;
        for (let t = 0; t < l; t++)
  ...
  GetShowFetterList(t, e) {
    const r = new Array;
    return -1 !== t && (this.GetAddFetterList(t, e).forEach(t => {
      ...
      var e;
      this.GVi(r, t) || ((e = new VisionAttributeItemTwo_1.VisionAttributeVariantTwoData).FetterId = t, e.State = 0, r.push(e))
    }), r
  }
  GVi(e, r) {
    for (let t = e.length - 1; 0 <= t; t--)
      if (e[t].FetterId === r) return !0;
    return !1
  }
  ...
  GetNewSubPropSuccessData(e) {
    var e = e.length,
      ...
      n = new Array;
    for (let t = e; t < r; t++) i[t].AddValue = i[t].BaseValue, i[t].BaseValue = 0, n.push(i[t]);
    const a = new Array;
    return n.forEach(t => {
  ...
  GetSubPropIdentifyPreviewData(t, e) {
    ...
    let i = 0;
    var n = r.length;
    for (let t = 0; t < n; t++) 1 === r[t].SlotState && 0 < e - i && (r[t].SlotState = 5, i++);
    return r
  }
  GetLevelSubPropPreviewData(t, e) {
    var r = this.GetLevelSubPropData(t),
      ...
      n = i.length;
    for (let t = 0; t < n; t++) 0 !== i[t].SlotState && 0 === r[t].SlotState && (i[t].SlotState = 2);
    return i
  }
  GetEquipmentViewPreviewData() {
    var e = this.GetLevelSubPropData(this.GetPhantomLevel()),
      ...
      i = new Array;
    let n = 0;
    for (let t = 0; t < r; t++) 3 === e[t].SlotState && i.push(e[t]), 1 === e[t].SlotState && 0 === n && (i.push(e[t]), n += 1);
    return i
  }
  ...
  GetIfHaveEnoughIdentifyGold(t) {
    var t = this.GetIdentifyCostItemValue() * t,
      e = ModelManager_1.ModelManager.InventoryModel.GetItemDataBaseByConfigId(this.GetIdentifyCostItemId());
    let r = 0;
    return 0 <= (r = 0 < e.length ? e[0].GetCount() : r) - t
  }
  GetIfHaveEnoughIdentifyConsumeItem(t) {
    var t = this.GetCurrentIdentifyCostValue() * t,
      e = ModelManager_1.ModelManager.InventoryModel.GetItemDataBaseByConfigId(this.GetCurrentIdentifyCostId());
    let r = 0;
    return 0 <= (r = 0 < e.length ? e[0].GetCount() : r) - t
  }
  ...
  GetCurrentCanIdentifyCount() {
    ...
    return this.GetCurrentIdentifyCost().forEach((t, e) => {
  ...
  GetLevelSubPropData(e) {
    var r = this.GetMaxSubPropCount(),
      i = new Array;
    for (let t = 0; t < r; t++) {
      var n, a = new VisionSubPropData(t, this);
      e >= this.GetSubPropUnlockLevel(t) ? (n = this.GetSlotIndexDataEx(t)) ? (a.SlotState = 3, a.PhantomSubProp = n) : a.SlotState = 1 : a.SlotState = 0, i.push(a)
    }
    return i
  }
  ...
  GetSubPropUnlockLevel(t) {
    var e = this.GetQuality(),
      e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSlotUnlockLevel(e);
  ...
  GetIdentifyBackRadio() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("PhantomIdentifyReturnRatio") / 1e3
  }
  ...
  GetLevelSlotData(e) {
    ...
    if (!(1 <= r && e < this.GetSlotUnlockLevel(0)))
      for (let t = 0; t < r; t++) {
        ...
        e >= this.GetSlotUnlockLevel(t) ? this.GetSlotIndexDataEx(t) ? n.SlotState = 3 : n.SlotState = 1 : n.SlotState = 0, i.push(n)
      }
    return i
  }
  GetCurrentSlotData() {
  ...
  GetPreviewSlotData(e) {
    var r, i = this.GetCurrentSlotData(),
      n = this.GetLevelSlotData(e),
      a = n.length;
    for (let t = 0; t < a; t++) 0 === i.length ? (r = this.GetSlotUnlockLevel(t), n[t].SlotState = r <= e ? 2 : 0) : i.length > t && i[t].SlotState !== n[t].SlotState && (n[t].SlotState = 2);
    return n
  }
  GetCurrentSkillId() {
  ...
  GetNormalSkillDesc() {
    var t = this.GetPhantomInstanceWithSkinId(),
      t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSkillBySkillId(t.PhantomItem.SkillId);
    if (t) return {
  ...
  GetPhantomInstanceWithSkinId() {
    var t = this.SkinId;
    return t ? ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomInstanceByItemId(t) : this.d8a()
  }
  d8a() {
  ...
  GetLevelUpPreviewData(t) {
    ...
    const o = new Map;
    return this.PhantomMainProp.forEach(t => {
      o.set(t.Yws, t.e5n)
    }), t.forEach((t, e) => {
      var r = o.has(e) ? o.get(e) : 0,
        e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyItemId(e),
        i = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.PropId),
      ...
      a.push(new AttrListScrollData_1.AttrListScrollData(e.PropId, r, t, i.Priority, n, 1))
    }), a
  }
  GetPhantomMainProp() {
  ...
  GetMainPropValueMapInTargetLevel(t) {
    ...
    for (const n of this.GetPhantomMainProp()) {
      var r = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyItemId(n.Yws),
        i = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomGrowthValueByGrowthIdAndLevel(r.GrowthId, t),
        r = AttributeModel_1.TipsDataTool.GetAttributeValue(r.StandardProperty, i, !1);
  ...
  GetConfig() {
    return this.X8_ || (this.X8_ = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemById(this.ItemId)), this.X8_
  }
  GetSkinConfig() {
    var t = this.SkinId;
    return t ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemById(t) : this.GetConfig()
  }
  GetMonsterConfig() {
  ...
  GetMainPropShowAttributeList(e, r = !1) {
    ...
    for (let t = 0; t < o; t++) {
      var s = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyItemId(a[t]),
        h = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(s.PropId),
        u = AttributeModel_1.TipsDataTool.GetPropRatioValue(n.get(a[t]), s.AddType === CommonComponentDefine_1.RATIO);
      i.push(new AttrListScrollData_1.AttrListScrollData(s.PropId, u, r ? s.AddType : 0, h.Priority, s.AddType === CommonComponentDefine_1.RATIO, e))
    }
    return i
  }
  GetSubPropShowAttributeList(n) {
    const a = new Array;
    return this.PhantomSubProp.forEach(t => {
      var e = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(t.Yws),
        r = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(t.Yws),
        i = r.AddType === CommonComponentDefine_1.RATIO,
        t = AttributeModel_1.TipsDataTool.GetPropRatioValue(t.e5n, i);
      a.push(new AttrListScrollData_1.AttrListScrollData(r.PropId, t, 0, e.Priority, r.AddType === CommonComponentDefine_1.RATIO, n))
    }), a
  }
  CheckIfHaveSelectRecommendMainAttr() {
    ...
    for (const r of t)
      for (const i of this.PhantomMainProp) {
        var e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyItemId(i.Yws);
  ...
  CheckIfHaveSelectRecommendSubAttr() {
    for (const r of ModelManager_1.ModelManager.VisionRecommendModel.CurrentSelectSubAttrArray) {
      ...
      for (const i of this.PhantomSubProp) {
        var e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(i.Yws);
  ...
  GetPropShowAttributeList(e) {
    var r = new Array;
    const i = new Map,
      n = (this.PhantomMainProp.forEach(t => {
        i.set(t.Yws, t.e5n)
      }), new Map);
    ...
    for (let t = 0; t < o; t++) {
      ...
      r.push(new AttrListScrollData_1.AttrListScrollData(a[t], i.get(a[t]), n.get(a[t]) ?? 0, s.Priority, !1, e))
    }
    return r
  }
