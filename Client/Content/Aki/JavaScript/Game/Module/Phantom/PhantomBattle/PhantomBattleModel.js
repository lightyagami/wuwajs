...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.VisionUnlockQualityData = exports.RecommendData = exports.PhantomSortStruct = exports.PhantomBattleModel = exports.LevelUpPastVisionData = void 0;
const UE = require("ue"),
...
class LevelUpPastVisionData {
  constructor() {
    this.Level = 0, this.UniqueId = 0, this.AttrListScrollData = void 0, this.SlotData = void 0
  }
}
exports.LevelUpPastVisionData = LevelUpPastVisionData;
class PhantomBattleModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.o6i = new Map, this.r6i = new Map, this.n6i = new Map, this.s6i = new Map, this.a6i = new Map, this.h6i = new Array, this.l6i = !1, this._6i = void 0, this.CurrentSelectData = void 0, this.CurrentEquipmentSelectIndex = 0, this.CurrentSelectUniqueId = 0, this.u6i = void 0, this.c6i = new UE.Vector, this.m6i = new UE.Vector, this.d6i = new UE.Rotator, this.C6i = new Map, this.g6i = [], this.f6i = void 0, this.p6i = !1, this.v6i = 999, this.M6i = 0, this.E6i = [], this.S6i = new Map, this.y6i = new Map, this.I6i = void 0, this.T6i = void 0, this.L6i = void 0, this.D6i = void 0, this._1l = 0, this.u1l = 0, this.nye = () => {
      this._1l = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionLevelUpMaterialPutInMode) ?? 0, this.u1l = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionLevelUpMaterialUseType) ?? 0
    }, this.R6i = () => {
    ...
    }, this.U6i = void 0, this.CurrentSelectFetterGroupId = 0, this.A6i = void 0, this.N6i = (t, e) => {
      var r, a;
      return t.GetType() !== e.GetType() ? t.GetType() - e.GetType() : t.GetQuality() !== e.GetQuality() ? t.GetQuality() - e.GetQuality() : (r = this.GetPhantomBattleData(t.GetUniqueId()), a = this.GetPhantomBattleData(t.GetUniqueId()), r && a && r.GetPhantomLevel() !== a.GetPhantomLevel() ? r.GetPhantomLevel() - a.GetPhantomLevel() : e.GetUniqueId() - t.GetUniqueId())
    }, this.O6i = new Array, this.VH_ = 0
  }
  ...
  OnInit() {
    for (const a of ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemList()) {
      var e, r = 0 !== a.ParentMonsterId ? a.ParentMonsterId : a.MonsterId;
      let t = this.S6i.get(r);
      t = t || [], 0 !== a.ParentMonsterId ? (t.push(a.ItemId), this.S6i.set(r, t)) : 1 === a.PhantomType && 2 === a.QualityId && ((e = []).push(a.ItemId), t = e.concat(t), this.S6i.set(r, t)), 0 !== a.ParentMonsterId && this.y6i.set(a.MonsterId, a.ParentMonsterId)
    }
    return EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldDone, this.nye), !0
  }
  OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDone, this.nye), !0
  }
  async GetDragCurve() {
    return this.u6i || (this.u6i = new CustomPromise_1.CustomPromise, ResourceSystem_1.ResourceSystem.LoadAsync(ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionDragCurve(), UE.CurveFloat, t => {
      this.u6i.SetResult(t)
    })), await this.u6i.Promise, this.u6i.Promise
  }
  SetDefaultSkin(t, e) {
    for (var [, r] of this.a6i) t === r.GetConfig()?.MonsterId && r.SetSkinId(e)
  }
  SetUnlockSkinList(t) {
    this.E6i = t
  }
  ...
  GetMonsterSkinListHasNew(t) {
    ...
    if (t) {
      t = 0 !== t.ParentMonsterId ? t.ParentMonsterId : t.MonsterId, t = this.S6i.get(t);
      if (t)
        for (const e of t)
          if (ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionSkin, e)) return !0
    }
    return !1
  }
  ...
  GetPhantomInstanceByItemId(t) {
    ...
    var r;
    return e || (r = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemById(t), e = new PhantomBattleInstance_1.PhantomBattleInstance(r), this.s6i.set(t, e)), e
  }
  CreatePhantomLevelCacheData(t) {
    var e = new LevelUpPastVisionData;
    return e.Level = this.GetPhantomBattleData(t).GetPhantomLevel(), e.AttrListScrollData = this.GetPhantomBattleData(t).GetMainPropShowAttributeList(1), e.SlotData = this.GetPhantomBattleData(t).GetCurrentSlotData(), e.UniqueId = t, e
  }
  ...
  GetLevelUpSuccessData(t) {
    var e = ModelManager_1.ModelManager.PhantomBattleModel.GetCachePhantomLevelUpData(),
      r = ModelManager_1.ModelManager.PhantomBattleModel.CheckPhantomIfLevelMax(t),
      t = ControllerHolder_1.ControllerHolder.PhantomBattleController.GetPhantomItemDataByUniqueId(t),
      a = this.k6i(e, t);
    const i = new Array;
    a.forEach(t => {
      i.push(RoleLevelUpSuccessController_1.RoleLevelUpSuccessController.ConvertsAttrListScrollDataToAttributeInfo(t))
    });
    ...
    if (a !== n)
      for (let t = a; t < n; t++) {
        ...
        o.CurText = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_PhantomUnlock_Text"), o.IconPath = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionLevelUpTexture(), i.push(o)
      }
    return {
      LevelInfo: {
  ...
  PhantomLevelUpReceiveItem(t) {
    ...
    this.g6i = e, this.p6i = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.PhantomLevelUpReceiveItem, e)
  }
  GetVisionLevelUpTag() {
    return this.p6i
  }
  ...
  GetVisionSortUseDataList(t = 0, e = 0) {
    ...
    for (const s of ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleDataMap().values()) {
      var i, n, o = s.GetUniqueId();
      0 < t && s.GetFetterGroupId() !== t || 0 < e && s.GetCost() !== e || s.CheckIfHaveSelectRecommendSubAttr() && s.CheckIfHaveSelectRecommendMainAttr() && (i = a.GetPhantomItemData(o), n = s.GetConfig(), o = {
        IsPhantomData: !0,
        Id: s.GetUniqueId(),
        Quality: n.QualityId,
  ...
  GetUnEquipVisionArray() {
    return this.l6i && (this.h6i = [], this.l6i = !1, this.GetPhantomBattleDataMap().forEach((t, e) => {
  ...
  UpdateRoleEquipmentData(r) {
    ...
    t.GetIncrIdList().forEach(t => {
      ...
      0 < e && this.GetBattleDataById(e).RemoveIncrIdLocal(t), this.n6i.set(t, r.Q6n)
    }), this.l6i = !0, t.Phrase(r)
  }
  ...
  DeleteBattleData(t) {
    ...
    e && (e.GetIncrIdList().forEach(t => {
      this.n6i.delete(t)
    }), this.l6i = !0, this.r6i.delete(t))
  }
  GetBattleDataById(t) {
    let e = this.r6i.get(t);
    return e = e || new PhantomRoleEquipmentData_1.PhantomRoleEquipmentData, this.r6i.set(t, e), e
  }
  ...
  CheckPhantomIsMain(t) {
    var e;
    return t < 0 ? this.GetPhantomDataBase(t).GetIfMain() : !!this.CheckPhantomIsEquip(t) && (e = this.n6i.get(t), this.GetBattleDataById(e).CheckPhantomIsMain(t))
  }
  CheckPhantomIsSub(t) {
    var e;
  ...
  GetIfHasMonsterInInventory(t) {
    ...
    let e = !1;
    for (const r of t)
      if (0 < ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(r)) {
        e = !0;
        break
      } return e
  }
  ...
  GetRolePhantomEquipState(t, e, r) {
    return this.CheckPhantomIsEquip(r) ? this.GetBattleDataById(t).GetPhantomOperationState(e, r) : 1
  }
  ...
  GetFetterListByRoleId(t) {
    ...
    var e = new Array;
    for (const r of t) e.push(ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomFetterById(r));
    return e
  }
  UpdateFetterList(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Phantom", 27, "刷新当前羁绊列表", ["roleId", t]);
  ...
  F6i(t, e) {
    const r = new Map;
    t.forEach(t => {
      var e, t = this.GetPhantomDataBase(t);
      t && (e = (r.get(t.GetFetterGroupId()) ?? 0) + 1, r.set(t.GetFetterGroupId(), e))
  ...
  GetPreviewFetterAdd(t, e, r) {
    var a = this.GetBattleDataById(r).GetIncrIdList(),
      i = new Array,
      n = a.length;
    for (let t = 0; t < n; t++) this.GetPhantomBattleData(a[t]) && t !== e && i.push(a[t]);
    var o = new Array,
  ...
  GetTargetCanActiveFettersList(t) {
    ...
    const i = new Array;
    return t && e.set(t.GetFetterGroupId(), 999), e.forEach((r, t) => {
  ...
  GetRoleFetterData(t) {
    ...
    for (let t = 0; t < r; t++) {
      ...
      s && ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupFetterDataById(s.GetFetterGroupId()).forEach((t, e) => {
        var r = new PhantomDataBase_1.VisionFetterData;
        r.FetterId = t, r.FetterGroupId = s.GetFetterGroupId(), r.ActiveFetterGroupNum = o.get(s.GetFetterGroupId()) ?? 0, r.ActiveState = o.get(s.GetFetterGroupId()) >= e, a.push(r)
      })
    }
    return a
  }
  ...
  j6i(t) {
    ...
    if (t && 0 < t.length) return this.c6i.X = t[0], this.c6i.Y = t[1], this.c6i.Z = t[2], this.c6i
  }
  H6i(t) {
    t = this.GetPhantomInstanceByItemId(t).GetModelLocation();
    if (t && 0 < t.length) return this.m6i.X = t[0], this.m6i.Y = t[1], this.m6i.Z = t[2], this.m6i
  }
  V6i(t) {
    t = this.GetPhantomInstanceByItemId(t).GetModelRotator();
    if (t && 0 < t.length) return this.d6i.Roll = t[0], this.d6i.Pitch = t[1], this.d6i.Yaw = t[2], this.d6i
  }
  GetStandAnim(t) {
  ...
  GetPhantomLevelUpItemSortList(t) {
    var e = [],
      r = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomExpItemList();
    if (r)
      for (const i of r) {
  ...
  CheckPhantomIfNewQuality(t) {
    var e, r, a = this.GetPhantomDataBase(t);
    let i = !1;
    for ([e, r] of this.a6i)
  ...
  GetEquipRoleName(t) {
    ...
    return 0 < t ? (t = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(t), ConfigManager_1.ConfigManager.RoleConfig.GetRoleName(t.Name)) : ""
  }
  GetRoleCurrentPhantomCost(t) {
    ...
    } else this.GetBattleDataById(t).GetIncrIdList().forEach(t => {
      t = this.GetPhantomBattleData(t);
      t && (r += t.GetCost())
    });
    return r
  ...
  GetMonsterFindCountByMonsterIdArray(t) {
    let e = 0;
    for (const r of t) ModelManager_1.ModelManager.HandBookModel.GetHandBookInfo(1, r) && e++;
    return e
  }
  GetFetterGroupMonsterMap() {
    return this._6i || (this._6i = new Map, ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupArray().forEach(t => {
    ...
    return e.forEach(e => {
      ...
      for (let t = 0; t < a; t++)
        if (r[t].Id === e) {
          i.push(r[t]), n = !0;
          break
        } n || i.push(new AttrListScrollData_1.AttrListScrollData(e, 0, 0, t.Priority, !1, 1))
    }), i
  }
  GetTrialRoleAttrList(t) {
    var e, r, a = new Array,
      i = ModelManager_1.ModelManager.RoleModel.GetRoleRobotData(t),
      n = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexList(),
      o = new Map;
    const s = [];
    ...
    for (const h of n) h.IsShow && (e = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(h.Id), r = void 0 !== (r = o.get(h.Id)) ? r : 0, a.push(new AttrListScrollData_1.AttrListScrollData(h.Id, 0, r, e.Priority, !1, 1)));
    return a.sort(this.SortAttrList), a
  }
  W6i(t, r, e) {
    var a, i = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e);
    for (const n of t) {
      let t = 0,
        e = n.AttributeId;
      n.AttributeId > AttributeDefine_1.GREEN_ATTRIBUTE_INTERNAL && (e -= AttributeDefine_1.GREEN_ATTRIBUTE_INTERNAL), t = n.IsRatio ? (i.GetBaseAttributeValueById(e) ?? 0) * (n.AttributeValue / AttributeDefine_1.TEN_THOUSANDTH_RATIO) : n.AttributeValue, r.has(e) ? (a = r.get(e), r.set(e, a + t)) : r.set(e, t)
    }
  }
  ...
  GetFettersObtainDataList(t) {
    ...
    for (const i of t) {
      ...
      if (r && 0 !== r.length) {
        let t = 0;
        for (const n of r)
          if (0 < (t = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(n))) break;
        var r = this.GetPhantomInstanceByItemId(r[0]),
          a = ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashDevelopRewardByMonsterId(i),
          a = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterIcon(a.MonsterInfoId),
          r = {
            Id: i,
        ...
        e.push(r)
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "该怪物没有对应道具，请检查幻象道具表是否正确", ["monsterId", i])
    }
    return e
  }
  SetPhantomRecommendData(t) {
    this.A6i = new RecommendData, this.A6i.RoleId = t.Q6n, this.A6i.MonsterIdList = t.wBs, this.A6i.MainPropId = t.xBs, this.A6i.FetterGroupId = t.Kws
  }
  ...
  CheckIfHasPhantomSatisfiedLevelCondition(t, e) {
    let r = [];
    if (0 !== (r = 0 !== t ? ModelManager_1.ModelManager.InventoryModel.GetPhantomItemDataListByPhantomItemId(t) : ModelManager_1.ModelManager.InventoryModel.GetPhantomItemDataList()).length)
      for (const i of r) {
  ...
  CheckIfHasPhantomLevelMax() {
    for (const t of this.GetPhantomBattleDataMap().values())
      if (this.GetPhantomMaxLevel(t.GetUniqueId()) === t.GetPhantomLevel()) return !0;
    return !1
  }
  ...
  static FilterShowAttribute(t) {
    const e = new Array,
      r = CommonParamById_1.configCommonParamById.GetIntArrayConfig("VisionMainViewShowAttribute");
    return t.forEach(t => {
    ...
    if (a.forEach(t => {
      ...
      for (const s of ModelManager_1.ModelManager.InventoryModel.GetItemDataBaseByMainType(3)) {
        if (9 === s.GetType()) {
          ...
          if (this.n6i.has(s.GetUniqueId()) && 0 !== this.n6i.get(s.GetUniqueId())) continue
        }
        n.push(s)
      }
    return n
  ...
  SaveIfSimpleState(t, e) {
    ...
    (r = r || new Map).set(t, e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.IsSimpleDetail, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ChangeVisionSimplyState)
  }
  SaveVisionSkillState(t, e) {
    ...
    (r = r || new Map).set(t, e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionSpecialSkillShowMap, r)
  }
  ...
  CheckVisionLevelUpSettingRedDot() {
    return !(LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionLevelUpSettingRedDot) ?? !1)
  }
  ...
  CacheNewSkinData(t) {
    var e = new VisionUnlockQualityData,
      t = (e.SkinId = t, e.MonsterItemId = t, ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemById(t).QualityId);
    e.UnlockQuality = t, ModelManager_1.ModelManager.PhantomBattleModel.QualityUnlockTipsList.push(e)
  }
  CacheNewQualityData(t) {
    t.BBs.forEach(t => {
      var e = new VisionUnlockQualityData,
        r = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemById(t).QualityId;
      e.MonsterItemId = t, e.UnlockQuality = r, ModelManager_1.ModelManager.PhantomBattleModel.QualityUnlockTipsList.push(e)
    })
  }
  GetMainAttributeKey(t) {
    return this.GetSortMainAttributeMap().has(t) ? this.GetSortMainAttributeMap().get(t) : this.GetSortMainPercentageAttributeMap().has(t) ? this.GetSortMainPercentageAttributeMap().get(t) : 0
  }
  GetSortMainAttributeMap() {
    return this.I6i || (this.I6i = new Map, this.I6i.set(8, 10007), this.I6i.set(6, 10002), this.I6i.set(10, 10010), this.I6i.set(12, 8), this.I6i.set(13, 9), this.I6i.set(14, 35), this.I6i.set(15, 21), this.I6i.set(16, 22), this.I6i.set(17, 23), this.I6i.set(18, 24), this.I6i.set(19, 25), this.I6i.set(20, 26), this.I6i.set(21, 27), this.I6i.set(22, 11)), this.I6i
  }
  GetSortMainPercentageAttributeMap() {
    return this.T6i || (this.T6i = new Map, this.T6i.set(9, 10007), this.T6i.set(7, 10002), this.T6i.set(11, 10010)), this.T6i
  }
  GetSubAttributeKey(t) {
    return this.GetSortSubAttributeMap().has(t) ? this.GetSortSubAttributeMap().get(t) : this.GetSortSubPercentageAttributeMap().has(t) ? this.GetSortSubPercentageAttributeMap().get(t) : 0
  }
  GetSortSubAttributeMap() {
    return this.L6i || (this.L6i = new Map, this.L6i.set(25, 2), this.L6i.set(23, 1), this.L6i.set(27, 3), this.L6i.set(29, 11), this.L6i.set(30, 12), this.L6i.set(36, 11), this.L6i.set(37, 12), this.L6i.set(38, 13), this.L6i.set(39, 13), this.L6i.set(47, 7), this.L6i.set(48, 8), this.L6i.set(49, 9), this.L6i.set(50, 10)), this.L6i
  }
  GetSortSubPercentageAttributeMap() {
    return this.D6i || (this.D6i = new Map, this.D6i.set(26, 5), this.D6i.set(24, 4), this.D6i.set(28, 6)), this.D6i
  }
  GmClearData() {
    this.O6i.length = 0
  }
  RecordVisionRecoveryRedDot(t) {
    LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionRecoveryBatchTip, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionRecoveryStorage)
  }
  GetVisionRecoveryBatchRedDot() {
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionRecoveryBatchTip) ?? !0;
  ...
  GetVisionRecoverySortPhantomItemList(t) {
    var t = ModelManager_1.ModelManager.InventoryModel.GetPhantomItemDataListByAddCountItemInfo(t),
      e = new Set;
    return e.add(3), e.add(4), ModelManager_1.ModelManager.SortModel.SortDataByData(t, 4, e, !1), t
  }
  RecordVisionRefineRedDot(t) {
    LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionRefineTip, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionRefineStorage)
  }
  GetVisionRefineRedDot() {
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionRefineTip) ?? !0;
  ...
  IsVisionRefineMaterialEnough(t) {
    ...
    for ([e, r] of this.GetVisionRefineMaterialCost(t)) {
      var a = r;
      if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(e) < a) return !1
    }
    return !0
  }
  ...
  GetPhantomMainPropItemRefineAvailableIdList(t) {
    var e = this.GetPhantomMainRandGroupId(t),
      e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyByRandGroupId(e);
    if (!e) return Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 75, "获取幻象主属性池失败, 请检查配置表", ["id", t]), [];
    var r = [];
    for (const i of e) {
      var a = i.PropGroup;
      r.push(a[0])
  ...
  SetVisionLevelUpMaterialPutInMode(t) {
    this._1l !== t && (this._1l = t, LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionLevelUpMaterialPutInMode, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionLevelUpMaterialPutInModeChange))
  }
  GetVisionLevelUpMaterialUseType() {
    return this.u1l
  }
  SetVisionLevelUpMaterialUseType(t) {
    this.u1l !== t && (this.u1l = t, LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.VisionLevelUpMaterialUseType, t))
  }
...
class RecommendData {
  constructor() {
    this.RoleId = 0, this.MonsterIdList = new Array, this.FetterGroupId = 0, this.MainPropId = 0
  }
}
