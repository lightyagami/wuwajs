...
class VisionEquipGroupController extends UiControllerBase_1.UiControllerBase {
  ...
  static async RequestVisionEquipGroupInfo() {
    ...
    var e = await Net_1.Net.CallAsync(21452, e);
  ...
  static RequestDeleteVisionEquipGroup(e) {
    ...
    o.c5n = e;
    Net_1.Net.Call(25827, Protocol_1.Aki.Protocol.Ov_.create(o), e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 29724);
      } else {
        ModelManager_1.ModelManager.VisionEquipGroupModel.RefreshVisionEquipGroupData(e.Zb_);
  ...
  static RequestPutVisionGroupToTop(e) {
    ...
    if (e === 0) {
      ...
      Net_1.Net.Call(18463, Protocol_1.Aki.Protocol.Fv_.create(o), e => {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19135);
        } else {
          ModelManager_1.ModelManager.VisionEquipGroupModel.RefreshVisionEquipGroupData(e.Zb_);
          EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVisionGroupDataToTop);
        }
  ...
  static RequestApplyVisionGroup(o, r) {
    if (ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity.GetComponent(205).HasTag(-1720844833)) {
      ...
      if (e = t && t.Entity.Active ? true : e) {
        ...
        t.Q6n = r;
        Net_1.Net.Call(23273, Protocol_1.Aki.Protocol.xy_.create(t), e => {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21869);
          } else {
...
VisionEquipGroupController.RequestAddVisionEquipGroup = async (e, o) => {
  ...
  r.Q6n = e;
  r.H8n = o;
  var e = await Net_1.Net.CallAsync(21022, r);
  if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
    ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19548);
  } else {
    ModelManager_1.ModelManager.VisionEquipGroupModel.RefreshVisionEquipGroupData(e.Zb_);
...
VisionEquipGroupController.RequestChangeVisionGroupName = async (e, o) => {
  ...
  r.c5n = e;
  r.H8n = o;
  var e = await Net_1.Net.CallAsync(19457, r);
  if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
    ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19135);
  } else {
    ModelManager_1.ModelManager.VisionEquipGroupModel.RefreshVisionEquipGroupData(e.Zb_);
