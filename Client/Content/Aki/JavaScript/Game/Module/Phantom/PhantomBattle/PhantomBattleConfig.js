...
class PhantomBattleConfig extends ConfigBase_1.ConfigBase {
  ...
  GetPhantomItemList() {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象道具配置列表失败, 请检查配置表"), e
  }
  GetPhantomItemById(e) {
    var t = PhantomItemByItemId_1.configPhantomItemByItemId.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象道具配置失败, 请检查配置表", ["id", e]), t
  }
  ...
  GetPhantomSkillList(e) {
    ...
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象技能配置列表失败, 请检查配置表", ["SkillId", e]), t
  }
  ...
  GetPhantomSkillDescStringBySkillIdAndQuality(e, t = 2) {
    t = this.GetPhantomSkillDescExBySkillIdAndQuality(e, t), e = PhantomSkillById_1.configPhantomSkillById.GetConfig(e).DescriptionEx, e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e);
    return StringUtils_1.StringUtils.Format(e, ...t)
  }
  GetPhantomSkillBySkillId(e) {
    var t = PhantomSkillByPhantomSkillId_1.configPhantomSkillByPhantomSkillId.GetConfigList(e);
    return 0 === t?.length && Log_1.Log.CheckInfo() && Log_1.Log.Info("Phantom", 27, "获取幻象技能配置失败, 请检查配置表, 也可能是探索技能", ["SkillId", e]), t[0]
  }
  ...
  GetPhantomRareConfigAll() {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 75, "获取幻象洗炼材料配置失败, 请检查配置表"), e
  }
  GetPhantomQualityByItemQuality(e) {
    var t = PhantomQualityByQuality_1.configPhantomQualityByQuality.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象品质配置失败, 请检查配置表", ["id", e]), t
  }
  GetPhantomMainPropertyById(e) {
    var t = PhantomMainPropertyById_1.configPhantomMainPropertyById.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象主属性配置失败, 请检查配置表", ["id", e]), t
  }
  GetPhantomMainPropertyByRandGroupId(e) {
    ...
    if (t) return t;
    Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 75, "获取幻象主属性方案组失败, 请检查配表", ["id", e])
  }
  ...
  GetPhantomSubPropertyById(e) {
    ...
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象属性配置失败, 请检查配置表", ["id", e]), t
  }
  GetPhantomFetterList() {
    var e = PhantomFetterAll_1.configPhantomFetterAll.GetConfigList();
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象羁绊配置列表失败, 请检查配置表"), e
  }
  ...
  GetPhantomFetterById(e) {
    ...
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象羁绊配置失败, 请检查配置表", ["Id", e]), t
  }
  GetPhantomLevelExpByGroupIdAndLevel(e, t) {
    ...
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象升级消耗配置失败, 请检查配置表", ["groupId", e], ["level", t]), r.Exp
  }
  GetPhantomLevelListByGroupId(e) {
    var t = PhantomLevelByGroupId_1.configPhantomLevelByGroupId.GetConfigList(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象升级消耗配置列表失败, 请检查配置表", ["groupId", e]), t
  }
  GetItemInfoById(e) {
    var t = ItemInfoById_1.configItemInfoById.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取道具配置失败, 请检查配置表", ["itemId", e]), t
  }
  GetPhantomExpItemById(e) {
    var t = PhantomExpItemByItemId_1.configPhantomExpItemByItemId.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象经验道具配置失败, 请检查配置表", ["itemId", e]), t
  }
  ...
  GetPhantomGrowthValueByGrowthIdAndLevel(e, t) {
    ...
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取幻象成长曲线值配置失败, 请检查配置表", ["growthId", e], ["level", t]), r.Value
  }
  ...
  GetPhantomLevelUpCostRatio() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("PhantomLevelUpCoinCost") / 1e3
  }
  GetTrailPhantomPropItemById(e) {
    var t = TrialPhantomPropItemById_1.configTrialPhantomPropItemById.GetConfig(e);
    return t || Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 27, "获取configTrialPhantomPropItemById, 请检查配置表", ["id", e]), t.Prop
  }
  ...
  GetFetterGroupSourceMonster(t) {
    ...
    const r = new Array;
    return e.forEach(e => {
      1 === e.PhantomType && !e.ParentMonsterId && e.FetterGroup.includes(t) && r.push(e.MonsterId)
    }), r
  }
  ...
  GetPhantomQualityBgSprite(e) {
    return void 0 === e || 0 === e ? CommonParamById_1.configCommonParamById.GetStringConfig("VisionQualityDefaultSprite") : this.GetPhantomQualityByItemQuality(e).QualitySprite
  }
  ...
  GetVisionScrollerOffsetX() {
    return Info_1.Info.IsInTouch() ? CommonParamById_1.configCommonParamById.GetFloatConfig("VisionScrollerOffsetX") : 0
  }
  GetVisionScrollerOffsetY() {
    return Info_1.Info.IsInTouch() ? CommonParamById_1.configCommonParamById.GetFloatConfig("VisionScrollerOffsetY") : 0
  }
  ...
  GetVisionDestroyCostSpriteByCost(e) {
    return e === COST1 ? this.GetVisionDestroyCost1() : e === COST3 ? this.GetVisionDestroyCost3() : this.GetVisionDestroyCost4()
  }
