...
class PhantomBattleFettersObtainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.X6i = void 0, this.$6i = void 0, this.Y6i = (e, t, i) => {
      t = new PhantomBattleItemView_1.PhantomFettersObtainItem(t);
      return t.Init(), t.Update(e), t.BindOnItemButtonClickedCallback(this.J6i), {
        Key: i,
        Value: t
      }
    }, this.J6i = e => {
      ...
      var e;
      ModelManager_1.ModelManager.PhantomBattleModel.CurrentSelectedFetter = this.X6i, this.CloseMe(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.VisionFilterMonster), UiManager_1.UiManager.IsViewShow("VisionEquipmentView") || (e = ModelManager_1.ModelManager.RoleModel.GetBattleTeamFirstRoleId(), UiManager_1.UiManager.IsViewShow("PhantomBattleFettersView") ? UiManager_1.UiManager.CloseAndOpenView("PhantomBattleFettersView", "VisionEquipmentView", e) : UiManager_1.UiManager.OpenView("VisionEquipmentView", e))
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    ...
    this.$6i = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(0), this.Y6i), this.ShowFettersObtainView(e)
  }
