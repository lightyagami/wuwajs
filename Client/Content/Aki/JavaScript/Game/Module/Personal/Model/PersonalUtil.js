...
class PersonalUtil {
      ...
      if (n) {
        ...
        if (n) {
          ...
          ResourceSystem_1.ResourceSystem.LoadAsync(n.SequencePath, UE.LevelSequence, e => {
            UE.KuroSequenceRuntimeFunctionLibrary.HandleSeqTexStreaming(e, !0), r = e, u.SetResult(!0)
          }, 102), await u.Promise;
          var n = ActorSystem_1.ActorSystem.Spawn(UE.LevelSequenceActor.StaticClass(), new UE.TransformDouble, void 0),
            a = (n.SetSequence(r), UE.KuroSequenceRuntimeFunctionLibrary.SetSequenceInUiScene(r, !0), a.set(e, n), new UE.MovieSceneSequencePlaybackSettings),
            i = (a.bRestoreState = !0, a.bPauseAtEnd = !0, n.PlaybackSettings = a, UE.NewArray(UE.SkeletalMesh));
          const U = new CustomPromise_1.CustomPromise;
          var t = n.GetBindingByTagInTemplate(GachaScanView_1.SCENE_ROLE_TAG, !0);
          for (let e = 0; e < t.Num(); e++) {
            ...
            if (s) {
              ...
              s instanceof UE.BP_BaseRole_Seq_V2_C && s.SetTickableWhenPaused(!0)
            }
          }
          i.Num() <= 0 || (a = UiModelResourcesManager_1.UiModelResourcesManager.LoadMeshesComponentsBundleStreaming(i, void 0, () => {
            U.SetResult()
          }), o.set(e, a), await U.Promise)
        }
      }
    }
  }
  static PlayRoleGachaSequence(e) {
    ...
    if (n) {
      ...
      if (i.TransformOrigin = t, 0 < n.BindPoint?.length) i.TransformOriginActor = UE.KuroCollectActorComponent.GetActorWithTag(FNameUtil_1.FNameUtil.GetDynamicFName(n.BindPoint), 1);
      else {
      ...
      n = ConfigManager_1.ConfigManager.GachaConfig.GetRoleInfoById(o), r = (a.UpdateGachaShowItem(o, n.QualityId), e.SequencePlayer), i = r.GetStartTime().Time;
      r.SetPlaybackPosition(new UE.MovieSceneSequencePlaybackParams(i, 0, "", 0, 1)), r.PlayTo(new UE.MovieSceneSequencePlaybackParams(i, 0, "A", 2, 0))
    }
  }
}
