...
class PersonalPlayerTitleComponent extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshScrollView() {
    ...
    this.xqe.RefreshByData(e);
    let t = 0;
    t = (t = this.k6d !== -1 && this.p5i.CurPlayerTitleId <= 0 ? e.findIndex(e => e.PlayerTitleId === this.k6d) : t) < 0 ? 0 : t;
    this.xqe.SelectGridProxy(t);
    this.xqe.ScrollToGridIndex(t);
    this.k6d = this.p5i.CurPlayerTitleId;
    ControllerHolder_1.ControllerHolder.UiNavigationNewController.SetNavigationFocusForView(this.xqe.GetGridByDisplayIndex(t), true);
  }
