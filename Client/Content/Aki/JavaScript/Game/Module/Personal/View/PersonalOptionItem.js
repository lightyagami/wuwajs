...
class PersonalOptionItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e) {
    super(), this.LVi = 0, this.Tbt = void 0, this.jbe = e => {
      this.Tbt = PersonalOptionController_1.PersonalOptionController.GetOptionFunc(this.LVi), this.Tbt()
  ...
  Refresh(e, r, o) {
    ...
    if (e) {
      ...
      }), e.RedDotName !== StringUtils_1.EMPTY_STRING && RedDotController_1.RedDotController.BindRedDot(e.RedDotName, this.GetItem(3))
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "个性化弹窗配置找不到,id为", ["config!.Id", e.Id])
  }
  OnBeforeDestroy() {
    var e = PersonalTipsById_1.configPersonalTipsById.GetConfig(this.LVi);
    e ? e.RedDotName !== StringUtils_1.EMPTY_STRING && RedDotController_1.RedDotController.UnBindGivenUi(e.RedDotName, this.GetItem(3)) : Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "个性化弹窗配置找不到,id为", ["config!.Id", e.Id])
  }
}
