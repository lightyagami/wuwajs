...
class PersonalCardItem extends PersonalCardBaseItem_1.PersonalCardBaseItem {
  OnRegisterComponent() {
    super.OnRegisterComponent(), this.ComponentRegisterInfos.push([3, UE.UIItem], [4, UE.UIItem])
  }
  Refresh(e, r, s) {
    super.Refresh(e, r, s);
    var r = this.GetItem(3),
      s = this.GetItem(4),
      o = PersonalController_1.PersonalController.CheckCardIsUsing(this.CardConfig.Id);
