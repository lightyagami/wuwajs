...
class PersonalBirthItem extends AutoAttachExhibitionItem_1.AutoAttachExhibitionItemAbstract {
  constructor() {
    super(...arguments), this.Dates = void 0, this.kG = new UE.Vector(0), this.wst = void 0, this.q6e = void 0
  }
  OnRegisterComponent() {
  ...
  RefreshItem() {
    this.wst = this.Dates[this.GetShowItemIndex()], this.GetText(0).SetText(String(this.wst))
  }
  SetData(t) {
    this.Dates = t
  }
  OnMoveItem(t) {
    ...
    this.kG.X = 1, this.kG.Y = 1, this.kG.Z = 1, this.RootItem.SetUIItemScale(this.kG), this.GetText(0).SetAlpha(i)
  }
  BindOnSelected(t) {
    this.q6e = t
  }
