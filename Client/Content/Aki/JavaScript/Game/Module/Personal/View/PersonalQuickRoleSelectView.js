...
class PersonalQuickRoleSelectView extends QuickRoleSelectView_1.QuickRoleSelectView {
  constructor() {
    super(...arguments), this.O1l = () => {
      var e = new PersonalQuickRoleSelectGrid_1.PersonalQuickRoleSelectGrid;
      return e.BindOnExtendToggleStateChanged(this.ToggleFunction), e.BindOnCanExecuteChange(this.CanExecuteChange), e
  ...
  OnStart() {
    this.Data = this.OpenParam, this.RoleScrollView = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(1), this.GetItem(10).GetOwner(), this.O1l), this.LoadingSequencePlayer = new UiSequencePlayer_1.UiSequencePlayer(this.GetItem(13))
  }
}
