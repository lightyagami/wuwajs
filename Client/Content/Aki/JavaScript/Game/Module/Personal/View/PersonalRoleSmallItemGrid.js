...
class PersonalRoleSmallItemGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.v3l = void 0, this.AVi = void 0, this.PVi = e => {
  ...
  Refresh(e, t, s) {
    ...
    r.SetUIActive(!1), this.SetTextureShowUntilLoaded(e.GetRoleCardHeadIcon(), r, () => {
      r.SetUIActive(!0)
    }), this.GetTexture(0).SetIsGray(e.Lock), this.GetItem(3).SetUIActive(e.Id === i);
    e = t ? 1 : 0;
