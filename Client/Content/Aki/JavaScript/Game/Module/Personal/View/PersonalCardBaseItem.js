...
class PersonalCardBaseItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.CardData = void 0, this.CardConfig = void 0, this.NeedShowRedDot = !0, this.OnToggleCallBack = void 0, this.kqe = () => {
      this.OnToggleCallBack && this.OnToggleCallBack(this.GridIndex, this.CardData)
    }, this.$5i = e => {
  ...
  Refresh(e, t, s) {
    this.CardData = e, this.GridIndex = s, this.CardConfig = ConfigManager_1.ConfigManager.InventoryConfig.GetCardItemConfig(e.CardId), this.BNe(e), this.SetToggleState(t), this.SetTextureByPath(this.CardConfig.CardPath, this.GetTexture(0))
  }
  BNe(e) {
