...
class PersonalPlayerTitlePreviewComponent extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    this.vGd = new PlayerTitleItem_1.PlayerTitleItem();
    this.yGd = new PlayerTitleItem_1.PlayerTitleItem();
    this.SGd = new PlayerTitleItem_1.PlayerTitleItem();
    await this.vGd.CreateThenShowByActorAsync(this.GetItem(8).GetOwner());
    await this.yGd.CreateThenShowByActorAsync(this.GetItem(10).GetOwner());
    await this.SGd.CreateThenShowByActorAsync(this.GetItem(11).GetOwner());
  }
  OnStart() {
  ...
  Gac(e) {
    this.vGd?.Refresh(e.Id, ModelManager_1.ModelManager.PersonalModel.GetPlayerTitleStarLevel(e.Id), ModelManager_1.ModelManager.PersonalModel.GetSex());
    this.yGd?.Refresh(e.Id, ModelManager_1.ModelManager.PersonalModel.GetPlayerTitleStarLevel(e.Id), ModelManager_1.ModelManager.PersonalModel.GetSex());
    this.SGd?.Refresh(e.Id, ModelManager_1.ModelManager.PersonalModel.GetPlayerTitleStarLevel(e.Id), ModelManager_1.ModelManager.PersonalModel.GetSex());
  }
}
