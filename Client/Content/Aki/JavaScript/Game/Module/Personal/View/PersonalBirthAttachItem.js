...
class PersonalBirthAttachItem extends AutoAttachItem_1.AutoAttachItem {
  constructor() {
    super(...arguments), this.kG = new UE.Vector(0), this.wst = 0, this.q6e = void 0
  }
  OnRegisterComponent() {
  ...
  OnMoveItem() {
    ...
    this.kG.X = 1, this.kG.Y = 1, this.kG.Z = 1, this.RootItem.SetUIItemScale(this.kG), this.GetText(0).SetAlpha(t)
  }
  BindOnSelected(t) {
    this.q6e = t
  }
