...
class MoraleModel extends ModelBase_1.ModelBase {
  ...
  GetBattleIsShowBuff() {
    return !!FormationDataController_1.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(209)?.HasBuff(this.GamePlayFinishTeamBuffId);
  }
