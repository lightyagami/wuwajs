...
class MoraleAreaData {
  ...
  IsAreaBuffActive() {
    return !!ModelManager_1.ModelManager.SceneTeamModel?.GetCurrentEntity?.Entity?.GetComponent(213)?.HasBuff(this.Config.BuffId) || !!ControllerHolder_1.ControllerHolder.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(203)?.HasBuff(this.Config.BuffId);
  }
