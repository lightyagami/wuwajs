...
class MoraleAreaData {
  ...
  IsAreaBuffActive() {
    return !!ModelManager_1.ModelManager.SceneTeamModel?.GetCurrentEntity?.Entity?.GetComponent(220)?.HasBuff(this.Config.BuffId) || !!ControllerHolder_1.ControllerHolder.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(209)?.HasBuff(this.Config.BuffId);
  }
