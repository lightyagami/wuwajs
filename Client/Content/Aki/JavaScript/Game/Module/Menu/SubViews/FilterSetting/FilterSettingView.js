...
class FilterSettingView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[9, this.jtu], [10, this.Htu], [13, this.qK_], [12, this.OK_], [15, this.Kcu], [21, this.kNd], [22, this.qNd], [26, this.BNd]];
  }
  OnBeforeCreate() {
  ...
  async OnBeforeStartAsync() {
    ...
    if (this.VmCache !== undefined) {
      ...
      this.UNd = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(24), this.xNd);
      i = [...FilterSeniorSettingAll_1.configFilterSeniorSettingAll.GetConfigList()].sort((i, t) => i.SortId - t.SortId);
      await this.UNd.RefreshByDataAsync(i, true);
    }
  }
  OnBeforeDestroy() {
    this.cpu?.Clear();
    ...
    if (this.VmCache !== undefined) {
      ...
      if (this.VmCache.IsDirty) {
        ...
        if (this.VmCache.IsPropertyDirty(FilterSettingViewModel_1.FilterSettingViewModel.Flags.IsSeniorParamRefresh)) {
          this.UNd?.RefreshWithoutDataSync();
        }
