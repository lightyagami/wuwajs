...
class FilterCameraComponent {
  ...
  js1() {
    if (Global_1.Global.BaseCharacter) {
      ModelManager_1.ModelManager.CreatureModel.GetEntityById(Global_1.Global.BaseCharacter.EntityId)?.Entity?.GetComponent(67)?.InterruptAutoMoving("打开眼保护界面");
    }
  }
  c$e() {
  ...
  RWi(e, t) {
    ...
    if (i?.Valid && i.Entity?.Valid) {
      i = i.Entity.GetComponent(217).ListenForTagAddOrRemove(e, t);
      this.AWi.push(i);
    }
  }
  $ha() {
