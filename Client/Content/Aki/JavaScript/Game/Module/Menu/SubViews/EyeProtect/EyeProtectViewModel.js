...
class EyeProtectViewModel {
  constructor() {
    ...
    this.sNd = [GameSettingsDefine_1.EFunction.EyeProtectionTemp, GameSettingsDefine_1.EFunction.EyeProtectionStrength, GameSettingsDefine_1.EFunction.EyeProtectionBrightness, GameSettingsDefine_1.EFunction.EyeProtectionTexture];
