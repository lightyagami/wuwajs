...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.BasicGraphicSettingData = exports.BasicGraphicSettingSliderData = void 0;
const UE = require("ue"),
...
class BasicGraphicSettingSliderData {
  constructor(t) {
    this.MinValueInternal = 0, this.MaxValueInternal = 0, this.CurValueInternal = 0, this.DefaultValueInternal = 0, this.TitleInternal = "", this.FunctionId = void 0, this.MetaData = void 0, this.OnChangeValue = t => {}, this.OnApplyValue = () => {
...
class BasicGraphicSettingData {
  ...
  static GetBasicGraphicSettingSliderDataList() {
    ...
    for (const a of this.ncc) {
      ...
      e && (e = new MenuData_1.MenuData(e)) && (e = this.occ(e)) && t.push(e)
    }
    return t
  }
...
class BasicGraphicSettingSliderBrightnessData extends BasicGraphicSettingSliderData {
  constructor(t) {
    super(t), this.eBi = 0, this.OnChangeValue = t => {
      let e = 2.2;
      t <= 0 && (e = MathUtils_1.MathUtils.Lerp(1.5, 2.2, (t + this.eBi) / this.eBi)), 0 < t && (e = MathUtils_1.MathUtils.Lerp(2.2, 3.5, t / this.eBi)), UE.KismetMaterialLibrary.SetScalarParameterValue(GlobalData_1.GlobalData.World, RenderDataManager_1.RenderDataManager.Get().GetUiShowColorSettingMaterialParameterCollection(), RenderConfig_1.RenderConfig.UIShowBrightness, e), this.CurValueInternal = t
    }, this.OnApplyValue = () => {
      var t = MathUtils_1.MathUtils.Lerp(-1, 1, (this.CurValueInternal + this.eBi) / (2 * this.eBi));
...
class BasicGraphicSettingSliderSaturationData extends BasicGraphicSettingSliderData {
  constructor() {
    super(...arguments), this.OnChangeValue = t => {
      let e = 1;
      t <= 50 && (e = MathUtils_1.MathUtils.Lerp(0, 1, 2 * t / 100)), 50 < t && (e = MathUtils_1.MathUtils.Lerp(1, 2, 2 * (t - 50) / 100)), UE.KismetMaterialLibrary.SetScalarParameterValue(GlobalData_1.GlobalData.World, RenderDataManager_1.RenderDataManager.Get().GetUiShowColorSettingMaterialParameterCollection(), RenderConfig_1.RenderConfig.UIShowSaturation, e), this.CurValueInternal = t
    }
  }
}
