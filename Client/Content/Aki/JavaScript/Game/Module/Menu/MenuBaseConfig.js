...
class MenuBaseConfig extends ConfigBase_1.ConfigBase {
  GetMenuBaseConfig() {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("Menu", 64, "没有基础配置文件，请检查配置表是否缺失")
  }
  GetMainConfig() {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("Menu", 64, "没有对应的主类型基础配置，请检查配置表是否缺失")
  }
  ...
  GetMenuConfigListByFunctionId(e) {
    return MenuConfigByFunctionId_1.configMenuConfigByFunctionId.GetConfigList(e)
  }
  GetAllKeyTypeConfig() {
    return KeyTypeAll_1.configKeyTypeAll.GetConfigList()
  }
  GetKeySettingConfigListByTypeIdAndInputControllerType(e, n) {
    return KeySettingByTypeIdAndInputControllerType_1.configKeySettingByTypeIdAndInputControllerType.GetConfigList(e, n)
  }
