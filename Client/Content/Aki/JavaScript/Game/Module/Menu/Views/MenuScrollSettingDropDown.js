...
class MenuScrollSettingDropDown extends MenuScrollSettingBaseItem_1.MenuScrollSettingBaseItem {
  constructor() {
    super(...arguments), this.hbi = void 0, this.lbi = void 0, this.g8e = t => this.lbi.GetDataTextId(t, this.Data)
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.hbi = new CommonDropDown_1.CommonDropDown(this.GetItem(1), t => new OneTextDropDownItem_1.OneTextDropDownItem(t), t => new OneTextTitleItem_1.OneTextTitleItem(t)), await this.hbi.Init(), this.hbi.SetOnSelectCall((t, e) => {
  ...
  sxi() {
    var t, e;
    this.Data && this.Data.HasDetailText() && (t = this.GetText(3), e = this.Data.GetDetailTextId(), LguiUtil_1.LguiUtil.SetLocalTextNew(t, e))
  }
  cHa() {
