...
class MenuScrollSettingTitleItem extends MenuScrollSettingBaseItem_1.MenuScrollSettingBaseItem {
  ...
  OnStart() {
    void 0 === this.$pt && (this.$pt = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem))
  }
  OnBeforeDestroy() {
  ...
  mGe() {
    this.SetSpriteByPath(this.Data.SubImage, this.GetSprite(0), !1), this.GetText(1).ShowTextNew(this.Data.SubName ?? "")
  }
