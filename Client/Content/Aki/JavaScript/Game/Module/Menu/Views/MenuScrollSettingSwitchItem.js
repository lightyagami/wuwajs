...
class MenuScrollSettingSwitchItem extends MenuScrollSettingBaseItem_1.MenuScrollSettingBaseItem {
  ...
  OnStart() {
    this.GetButton(3).SetCanClickWhenDisable(!0), this.GetButton(2).SetCanClickWhenDisable(!0), this.ybi()
  }
  OnClear() {
    this.Data && (this.Data = void 0), this.GetButton(2).OnClickCallBack.Unbind(), this.GetButton(3).OnClickCallBack.Unbind()
  }
  Update(t) {
  ...
  ybi() {
    this.GetButton(2).OnClickCallBack.Bind(this.pbi), this.GetButton(3).OnClickCallBack.Bind(this.Mbi)
  }
  ...
  Sbi(t) {
    ...
    this.Sac() && (e = MenuDefine_1.CUSTOM_TEXT_ID), this.GetText(1).ShowTextNew(e), this.GetSprite(7).SetUIActive(this.Data.IsRecommendIndex(t))
  }
  RefreshInteractionGroup(t, e = !0) {
    e ? (this.GetButton(3).SetSelfInteractive(this.Sac() || t !== this.Data.OptionsNameList.length - 1), this.GetButton(2).SetSelfInteractive(this.Sac() || 0 !== t)) : (this.GetButton(3).SetSelfInteractive(!1), this.GetButton(2).SetSelfInteractive(!1))
  }
  vbi(t) {
    var e = this.vah();
    let i = Math.floor(e + t);
    this.Sac() && (i = 0 < t ? 0 : this.Data.OptionsNameList.length - 1), this.FireSaveMenuChange(this.Data.OptionsValueList[i])
  }
  Sac() {
  ...
  vah() {
    ...
    let i = e.indexOf(t);
    return i < 0 && (t = this.Data.OptionsDefault, (e = e.indexOf(t)) < 0 && Log_1.Log.CheckError() && Log_1.Log.Error("Menu", 64, "默认值不存在于可选值列表中，请策划策划策划检查配置", ["functionId", this.Data.FunctionId], ["Default Value", t]), i = e), i
  }
  ...
  sxi() {
    var t, e;
    this.Data && this.Data.HasDetailText() && (t = this.GetText(5), e = this.Data.GetDetailTextId(), LguiUtil_1.LguiUtil.SetLocalTextNew(t, e))
  }
  cHa() {
