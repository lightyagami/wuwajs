...
class MenuScrollSettingBaseItem extends UiPanelBase_1.UiPanelBase {
  ...
  GetItemClickLimit(e) {
    return !e.GetSelfInteractive() && (this.Data && this.Data.BtnDisableTips ? ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId(this.Data.BtnDisableTips) : ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("NotModify"), true);
  }
  ExecuteUpdate(e, t) {
    this.Data = e;
    this.Update(e, t);
