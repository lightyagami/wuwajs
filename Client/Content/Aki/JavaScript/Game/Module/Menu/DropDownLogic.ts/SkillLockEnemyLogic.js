...
class SkillLockEnemyLogic extends DropDownLogicBase_1.DropDownLogicBase {
  GetDropDownDataList() {
    var r = [],
      e = ConfigManager_1.ConfigManager.MenuBaseConfig.GetMenuConfigByFunctionId(GameSettingsDefine_1.EFunction.SkillLockEnemyMode);
    if (e) {
      var n = e.OptionsName;
  ...
  TriggerSelectChange(e, r) {
    var n = MenuController_1.MenuController.GetTargetConfig(r.FunctionId),
      e = e.Index;
    n !== e && (GameSettingsManager_1.GameSettingsManager.HandleValueChange(r.FunctionId, e, 1), ModelManager_1.ModelManager.MenuModel.IsEdited = !0)
  }
  GetDefaultIndex(e) {
