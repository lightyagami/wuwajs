...
class LanguageLogic extends DropDownLogicBase_1.DropDownLogicBase {
  ...
  GetDropDownDataList() {
    ...
    for (const t of MenuTool_1.MenuTool.GetLanguageDefineData()) {
      var a = t.LanguageType,
        o = ConfigManager_1.ConfigManager.LanguageConfig.GetLanguageDefineById(a);
      o ? a !== e && !o.IsShow || (r.push(t), n.set(a, o.SortId)) : Log_1.Log.CheckError() && Log_1.Log.Error("TextLanguageSearch", 37, "设置系统语言定义不存在,请检查s.设置系统 LanguageDefine", ["语言类型Id", a])
    }
    r.sort((e, r) => {
  ...
  TriggerSelectChange(e, r) {
    MenuController_1.MenuController.GetTargetConfig(r.FunctionId) !== e.LanguageType && (GameSettingsManager_1.GameSettingsManager.HandleValueChange(r.FunctionId, e.LanguageType, 1), ModelManager_1.ModelManager.MenuModel.IsEdited = !0, Log_1.Log.CheckInfo()) && Log_1.Log.Info("TextLanguageSearch", 10, "设置语言", ["选择语言", GameSettingsManager_1.GameSettingsManager.GetLanguageCodeById(e.LanguageType)], ["实际语言", LanguageSystem_1.LanguageSystem.PackageLanguage])
  }
  GetDefaultIndex(e) {
