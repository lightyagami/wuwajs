...
class ChangeActionRowView extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.uPi = void 0, this.IsRevert = !1, this.q6e = void 0, this.Jgt = t => {
  ...
  Refresh(t, e, i) {
    ...
    var t = this.uPi.BothActionName,
      ...
      n = [],
      h = [],
      s = (s.GetKeyNameList(n), t.GetKeyNameList(h), n[this.uPi.GetKeyIndex(e)]),
      t = h[this.uPi.GetKeyIndex(e)],
      n = this.uPi.GetSettingName(),
      h = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), n), i ? [t, s] : [s, t]),
  ...
  SetSelected(t) {
    t ? this.GetExtendToggle(0)?.SetToggleState(1) : this.GetExtendToggle(0)?.SetToggleState(0)
  }
}
