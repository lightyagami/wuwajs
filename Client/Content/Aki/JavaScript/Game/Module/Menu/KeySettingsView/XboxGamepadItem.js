...
exports.XboxGamepadItem = undefined;
const UE = require("ue");
const GamepadItemBase_1 = require("./GamepadItemBase");
class XboxGamepadItem extends GamepadItemBase_1.GamepadItemBase {
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UISprite], [1, UE.UISprite], [2, UE.UISprite], [3, UE.UISprite], [4, UE.UISprite], [5, UE.UISprite], [6, UE.UISprite], [7, UE.UISprite], [8, UE.UISprite], [9, UE.UISprite], [10, UE.UISprite], [11, UE.UISprite], [12, UE.UISprite], [13, UE.UISprite], [15, UE.UISprite], [14, UE.UISprite]];
  }
  OnStart() {
