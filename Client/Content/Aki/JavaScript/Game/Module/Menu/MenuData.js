...
class MenuData {
  constructor(e) {
    this.rSl = e, this.aHa = !1, this.gac = new Map
  }
  get ConfigId() {
    return this.rSl.Id
  }
  ...
  get SliderRangeDisplay() {
    return 0 < this.rSl.SliderRangeDisplay?.length ? this.rSl.SliderRangeDisplay : this.rSl.SliderRange
  }
  get SliderDefault() {
  ...
  GetEnable() {
    if (this.FunctionId === GameSettingsDefine_1.EFunction.MobileGamepadMode) return 1 === GameSettingsManager_1.GameSettingsManager.GetCurrentValue(GameSettingsDefine_1.EFunction.MobileGamepadMode);
  ...
  IsRecommendIndex(e) {
    var t;
    return this.FunctionId === GameSettingsDefine_1.EFunction.IMAGEQUALITY && !ModelManager_1.ModelManager.MenuModel.IsImageQualityCustom && void 0 !== (t = GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetRecommendQualityLv()) && this.OptionsValueList.indexOf(t) === e
  }
}
