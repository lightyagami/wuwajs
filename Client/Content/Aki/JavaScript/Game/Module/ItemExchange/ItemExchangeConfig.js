...
class ItemExchangeConfig extends ConfigBase_1.ConfigBase {
  GetExChangeConfigList(e) {
    var t = [];
    for (const n of ItemExchangeContentAll_1.configItemExchangeContentAll.GetConfigList()) n.ItemId === e && t.push(n);
    return t?.sort((e, t) => e.Times - t.Times), t
  }
  GetFirstExChangeConfigList(e) {
    return ItemExchangeContentByItemId_1.configItemExchangeContentByItemId.GetConfig(e)
  }
  GetItemExchangeLimit(e) {
    return ItemExchangeLimitByItemId_1.configItemExchangeLimitByItemId.GetConfig(e)
  }
}
