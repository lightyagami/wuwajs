...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.ItemExchangeModel = exports.ExchangeSimulation = exports.ExchangeInfo = void 0;
...
class ItemExchangeModel extends ModelBase_1.ModelBase {
  ...
  GetExchangeInfo(e) {
    return this.Dgi.get(e) || Log_1.Log.CheckError() && Log_1.Log.Error("ItemExchange", 8, "前后端版本可能不一致, 当前兑换的道具并没有后端配置!", ["itemId", e]), this.Dgi.get(e)
  }
  GetExChangeTime(e) {
  ...
  CalculateConsume(i, e = 0, s = 0, h = !1) {
    ...
    if (c && !(c.length <= 0)) {
      ...
      for (; t <= x;) {
        ...
        m && (m = m.Times - M.Times, e = Math.min(e, m)), (e = 0 < s && e + a > s ? s - a : e) + a > l && (e = l - a);
        m = M.Consume.values().next()?.value;
        if (!h && o + e * m > r && (e = Math.floor((r - o) / m)), o += e * m, a += e, (n += e * M.GainCount) >= g || 0 < s && a >= s || a >= l || o >= r) break;
        t++
      }
      e = new ExchangeSimulation;
      return e.ExChangeTime = a, e.ExChangeCount = n, e.ConsumeCount = o, e
    }
  }
  Rgi(e) {
  ...
  GetCurExchangeInfo(e, t = 0) {
    var r = new ExchangeInfo,
      a = ConfigManager_1.ConfigManager.ItemExchangeConfig.GetExChangeConfigList(e);
    if (a) {
      var n = this.GetExChangeTime(e) + t + 1;
      for (const i of a) {
        if (n < i.Times) break;
        for (var [, o] of i.Consume) r.ConsumeCount = o, r.GainCount = i.GainCount
      }
    }
    return r
  }
  CheckIsMaxExChangeTime(e, t = 0) {
    ...
    return 0 < e.yxs && e.u9n + t >= e.yxs || 0 < e.Exs && e._9n + t >= e.Exs
  }
