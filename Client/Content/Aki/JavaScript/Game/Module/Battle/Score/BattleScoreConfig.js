...
exports.BattleScoreConfig = undefined;
...
class BattleScoreConfig extends ConfigBase_1.ConfigBase {
  ...
  GetBattleScoreLevelConfig(e) {
    return BattleScoreLevelConfById_1.configBattleScoreLevelConfById.GetConfig(e);
  }
  GetBattleScoreActionConfigByGroupId(e) {
    return BattleScoreLevelConfByGroupId_1.configBattleScoreLevelConfByGroupId.GetConfigList(e);
  }
}
