...
BattleLinkController.mRd = (e, t) => {
  ...
  if (e) {
    ...
    if (!_a.cRd.includes(e)) {
      if ((i = ConfigManager_1.ConfigManager.BattleLinkConfig.GetLinkParam(1))?.ChangeGenderMap.has(e)) {
        if ((a = ConfigManager_1.ConfigManager.RoleConfig.GetMainRoleById(e)) && a.Gender !== ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerGender() && (a = i.ChangeGenderMap.get(e))) {
          _a.cRd.splice(0, 0, a);
        }
      } else {
        _a.cRd.splice(0, 0, e);
