...
class BattleInputModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    this.Waa.length = 0;
    for (let t = this.EQe.length = 0; t < 16; t++) this.Waa.push(0), this.EQe.push(0);
    return !0
  }
  GetInputEnable(t) {
    return 0 === this.Waa[t]
  ...
  SetInputEnable(t, e, n) {
    var i = this.Waa[t],
      e = (!e && 0 === i && InputController_1.InputController.IsKeyDown(t) && (InputController_1.InputController.InputAction(t, 2), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Battle", 17, "禁用输入时，该输入已按下，立即执行放开操作", ["action", t]), VisibleStateUtil_1.VisibleStateUtil.SetVisible(i, e, n));
