...
class PlatformController extends ControllerBase_1.ControllerBase {
  ...
  static _Ea() {
    Info_1.Info.IsPcPlatform() || ModelManager_1.ModelManager.PlatformModel?.RefreshPlatformByDevice("InitDeviceInfo")
  }
  static ControlScreenSaver(e) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Platform", 27, "控制屏幕", ["state", e]), UE.KismetSystemLibrary.ControlScreensaver(e)
  }
  static SendClientBasicInfo() {
    var e = new Protocol_1.Aki.Protocol.fYn,
      r = PlatformController.PackageClientBasicInfo();
    e.Z9n = r, Net_1.Net.Call(18698, e, () => {}), r && Log_1.Log.CheckInfo() && Log_1.Log.Info("Platform", 27, "客户端上报一些设备基础信息", ["CPU", r.rHn], ["DeviceId", r.oHn], ["Model", r.nHn], ["NetStatus", r.sHn], ["Platform", r.f7n])
  }
  static PackageClientBasicInfo() {
    var e = new Protocol_1.Aki.Protocol.Z9n,
      r = (e.sHn = ModelManager_1.ModelManager.PlatformModel.GetNetStatus(), e.f7n = cpp_1.KuroApplication.IniPlatformName(), ModelManager_1.ModelManager.KuroSdkModel.GetBasicInfo()),
      r = (e.rHn = r?.CPUModelName ?? "", e.oHn = r?.DeviceId ?? "", e.nHn = r?.ModelName ?? "", e.aHn = UE.ThinkingAnalytics.GetDeviceId(), e.r9n = LanguageSystem_1.LanguageSystem.GetLanguageDefineByCode(LanguageSystem_1.LanguageSystem.PackageLanguage).LanguageType, e.kll = ControllerHolder_1.ControllerHolder.KuroSdkController.GetPackageId() ?? "", CloudGameManager_1.CloudGameManager.IsCloudGame && (e.Yu_ = CloudGameManagerLauncher_1.CloudGameManagerLauncher.ServerTag), UE.KuroStaticLibrary.GetMacAddress());
    return StringUtils_1.StringUtils.IsEmpty(r) || (e.hHn = r), e
  }
}(exports.PlatformController = PlatformController).nXi = (e, r) => {
  0 === r || Info_1.Info.IsInKeyBoard() || CloudGameManager_1.CloudGameManager.IsCloudGame || Info_1.Info.SwitchInputControllerType(1, "MouseAxisInput")
};
