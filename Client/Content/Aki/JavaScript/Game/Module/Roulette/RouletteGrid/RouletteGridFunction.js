...
class RouletteGridFunction extends RouletteGridBase_1.RouletteGridBase {
  async Init() {
    ...
    if (this.IsDataValid()) {
      ...
      this.Data.Name = t.FuncName, t.FuncMenuIconPath.includes("Atlas") ? (this.IsIconTexture = !1, await this.LoadSpriteIcon(t.FuncMenuIconPath)) : (this.IsIconTexture = !0, await this.LoadTextureIcon(t.FuncMenuIconPath)), this.Data.ShowRedDot && void 0 !== t.UnlockCondition && (t = ModelManager_1.ModelManager.FunctionModel.GetFunctionItemRedDotName(t.UnlockCondition)) && (e = !0, this.BindRedDot(t))
    }
    e || this.SetRedDotVisible(!1)
  }
  OnSelect(e) {
    e && this.IsDataValid() && RouletteController_1.RouletteController.FunctionOpenRequest(this.Data.Id)
  }
}
