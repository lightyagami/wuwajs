...
class RouletteAssemblyTips extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.Axt = void 0, this.hfo = void 0, this.lfo = void 0, this.XOe = () => {
  ...
  async OnBeforeStartAsync() {
    var t = this.GetItem(10),
      t = (this.hfo = new RouletteTipsItemPanel, await this.hfo.CreateByActorAsync(t.GetOwner()), this.GetItem(11));
    this.lfo = new RouletteTipsItemPanel, await this.lfo.CreateByActorAsync(t.GetOwner())
  }
  OnStart() {
  ...
  OnBeforeDestroy() {
    this.Axt && (this.Axt.Destroy(), this.Axt = void 0), this.hfo && (this.hfo.Destroy(), this.hfo = void 0), this.lfo && (this.lfo.Destroy(), this.lfo = void 0)
  }
  Refresh(t) {
    this.Pe = t, this.mGe(), this._fo(), this.WNe(), this.ufo(), this.Kbe(), this.cfo(), this.mfo(), this.dfo(), this.Cfo()
  }
  mGe() {
  ...
  WNe() {
    var t = this.GetTexture(0),
      e = ConfigManager_1.ConfigManager.InventoryConfig.GetItemQualityConfig(this.Pe.BgQuality);
    this.SetTextureByPath(e.RouletteTipsQualityTexPath, t)
  }
  ufo() {
    var t = "" !== this.Pe.TextMain && void 0 !== this.Pe.TextMain,
      t = (this.GetText(5).SetUIActive(t), t && this.GetText(5).ShowTextNew(this.Pe.TextMain), "" !== this.Pe.TextSub && void 0 !== this.Pe.TextSub);
    this.GetItem(6).SetUIActive(t), t && this.GetText(7).ShowTextNew(this.Pe.TextSub)
  }
  Kbe() {
    const t = this.GetTexture(2),
      e = (t.SetUIActive(!1), this.GetSprite(1));
    e.SetUIActive(!1), 2 === this.Pe.GridType ? this.SetItemIcon(t, this.Pe.GridId, void 0, () => {
      t.SetUIActive(!0)
    }) : "" !== this.Pe.IconPath && (this.Pe.IsIconTexture ? this.SetTextureByPath(this.Pe.IconPath, t, void 0, () => {
      t.SetUIActive(!0)
  ...
  mfo() {
    ...
    this.GetItem(12).SetUIActive(0 !== e), 0 !== e && (t = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_CollectProgress_Text"), t.toString(), e.toString()), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(13), "Explore_Count", t))
  }
  dfo() {
...
class RouletteTipsItemPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.s4e = void 0, this.W2e = () => {
...
class CommonItemSmallItemGridWrap extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, i) {
    this.GridItem.RefreshByConfigId(t.ItemId), this.GridItem.SetLockVisible(t.NeedLock);
    var s = void 0 !== t.Text;
    this.GridItem.SetBottomTextVisible(s), s && this.GridItem.SetBottomText(t.Text)
  }
  OnStart() {
