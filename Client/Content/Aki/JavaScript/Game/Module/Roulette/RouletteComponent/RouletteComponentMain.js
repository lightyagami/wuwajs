...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RouletteComponentMainFunction = exports.RouletteComponentMainExplore = exports.RouletteComponentMain = void 0;
...
class RouletteComponentMain extends RouletteComponent_1.RouletteComponentBase {
  ...
  OnStart() {
    var e;
    super.OnStart(), Info_1.Info.IsInGamepad() && (e = ModelManager_1.ModelManager.RouletteModel.GetRouletteSelectConfig(), this.hIa = 1 === e)
  }
  GamepadReturnEmptyGrid() {
    var e, t, o;
    this.CurrentEquipGridIndex !== this.CurrentGridIndex && (e = this.RouletteGridList[this.CurrentEquipGridIndex], 0 === (o = (t = this.RouletteGridList[this.CurrentGridIndex]).Data).State ? (RouletteGridForbiddenSettings_1.RouletteGridForbiddenSettings.TipsForbiddenState(o.GridType, o.Id), this.CurrentGridIndex = -1) : 0 === o.Id && 2 !== o.GridType || (e?.SetGridEquipped(!1), t?.SetGridEquipped(!0), this.CurrentEquipGridIndex = this.CurrentGridIndex, this.OnEmitCurrentGridSelectOn(), this.CloseRouletteMain())), this.IsEmptyChoose = !0
  }
  ...
  GetGridId(e, t) {
    return ModelManager_1.ModelManager.RouletteModel.GetRouletteGridId(e, t, !0)
  }
  SetCurrentToggleState(e) {
    this.GetCurrentGrid()?.SetGridToggleState(e), e && AudioSystem_1.AudioSystem.PostEvent("play_ui_float_spl_roulette")
  }
  RefreshCurrentShowName() {
    var e = Info_1.Info.IsInTouch(),
      t = this.GetCurrentGrid()?.Data?.Name;
    t ? (this.SetNameVisible(!0), this.RefreshName(t)) : (this.SetNameVisible(e), e && this.RefreshName(RouletteDefine_1.ROULETTE_TEXT_EMPTY))
  }
  RefreshTips() {
    var e = Info_1.Info.IsInTouch(),
...
class RouletteComponentMainExplore extends(exports.RouletteComponentMain = RouletteComponentMain) {
  ...
  JudgeGridStateByData(e, t) {
    var o = void 0 !== e && 0 !== e,
      i = 2 === t,
      t = RouletteGridForbiddenSettings_1.RouletteGridForbiddenSettings.CheckGridSpecialState(1, t, e);
  ...
  GetRefreshTips(e) {
    let t = void 0;
    return Info_1.Info.IsInTouch() ? t = e ? "Text_ProbeToolFunctionNotice3_Text" : "Text_ExploreToolsSwitchMobile_Text" : Info_1.Info.IsInKeyBoard() ? t = e ? void 0 : "Text_ExploreToolsSwitchPC_Text" : Info_1.Info.IsInGamepad() && (e = 1 !== this.GetCurrentGrid()?.Data.State, e = void 0 !== this.CurrentGridIndex && -1 !== this.CurrentGridIndex && !e, t = e ? "Text_ExploreToolsSwitchPC_Text" : void 0), this.SetTipsActive(void 0 !== t), t
  }
}
