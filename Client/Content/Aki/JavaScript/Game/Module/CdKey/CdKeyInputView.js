...
class CdKeyInputView extends CommonInputViewBase_1.CommonInputViewBase {
  ...
  ExecuteInputConfirm(e) {
    this.InputData.ConfirmFunc?.(e).then(e => {
      var r;
      e === Protocol_1.Aki.Protocol.Q4n.KRs ? (r = new ConfirmBoxDefine_1.ConfirmBoxDataNew(148), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(r), this.CloseMe()) : (r = ConfigManager_1.ConfigManager.ErrorCodeConfig.GetTextByErrorId(e), this.CdKeyErrorText = r ?? this.CdKeyErrorText, this.RefreshTips(6))
    }, () => {})
  }
