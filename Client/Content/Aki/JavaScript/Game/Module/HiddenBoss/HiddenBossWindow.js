...
class HiddenBossWindow extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.nt_ = () => {
      ...
      if (void 0 === o) Log_1.Log.CheckError() && Log_1.Log.Error("LevelPlayReport", 63, "[讨伐报告]隐藏boss解锁弹窗找不到对应的标记配置", ["弹窗Id", e.UiId], ["标记Id", i.MarkId]);
      else {
        this.CloseMe();
        const e = {
          MarkId: r,
  ...
  OnStart() {
    var e = this.OpenParam,
      e = ConfigManager_1.ConfigManager.LevelPlayReportConfig.GetHiddenBossWindowConfig(e.UiId),
