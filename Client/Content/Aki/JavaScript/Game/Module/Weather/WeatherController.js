...
class WeatherController extends ControllerBase_1.ControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(16982, WeatherController.Qko);
  }
  ...
  static RequestChangeWeather(e) {
    ...
    t.pjn = e;
    Net_1.Net.Call(28350, t, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 15986);
      }
    });
  }
