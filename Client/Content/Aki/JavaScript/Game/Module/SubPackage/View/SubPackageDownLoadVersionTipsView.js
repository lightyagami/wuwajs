...
class SubPackageDownLoadVersionTipsView extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshItem(e, i) {
    ...
    if (e) {
      ...
      this.FKm.X = i.X + BG_ITEM_OFFSETX;
      this.FKm.Z = i.Z + BG_ITEM_OFFSETZ;
      this.GetItem(1).D_K2_SetWorldLocation(this.FKm, false, undefined, false);
    }
  }
}
