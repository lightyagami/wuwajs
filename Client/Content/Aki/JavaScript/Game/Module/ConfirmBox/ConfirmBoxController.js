...
class ConfirmBoxController extends UiControllerBase_1.UiControllerBase {
  static ShowConfirmBoxNew(o) {
    ...
    return 0 < o.FunctionMap.size && (o.IsMultipleView = !0), !!e && (UiManager_1.UiManager.OpenView(e, o, o.FinishOpenFunction), !0)
  }
  ...
  static CloseConfirmBoxView() {
    for (const o of ConfirmBoxController.mqt.values()) UiManager_1.UiManager.CloseView(o)
  }
  static ShowNetWorkConfirmBoxView(o, e = void 0) {
    o.NotAddChildToTopStackView = !0, UiManager_1.UiManager.OpenView("NetWorkConfirmBoxView", o, e)
  }
  ...
  static ShowFirstCurrencyConfirm() {
    ...
    e.SetTextArgs(o), e.FunctionMap.set(2, () => {
  ...
  static ShowExitGameConfirmBox() {
    var o;
    ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() ? ControllerHolder_1.ControllerHolder.KuroSdkController.PostKuroSdkEvent(5) : ((o = new ConfirmBoxDefine_1.ConfirmBoxDataNew(51)).FunctionMap.set(2, () => {
      GlobalData_1.GlobalData.IsPlayInEditor ? UE.KismetSystemLibrary.QuitGame(GlobalData_1.GlobalData.World, void 0, 0, !1) : cpp_1.KuroApplication.ExitWithReason(!1, "ExitGameConfirmBox")
  ...
  static ShowReturnLoginConfirmBox() {
    ...
    o.IsEscViewTriggerCallBack = !1, o.FunctionMap.set(2, () => {
