...
class ConfirmBoxButton extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Timer = void 0, this.DelayTime = 0, this.ClickFunction = void 0, this.ije = () => {
      this.CloseView()
    }
  }
  OnRegisterComponent() {
  ...
  SetTimer(i, e, t) {
    t || this.SetBtnCanClick(t), this.DelayTime = e, this.gqt(i), this.Timer = TimerSystem_1.TimerSystem.Forever(() => {
      --this.DelayTime, this.gqt(i), this.DelayTime <= 0 && (t ? this.CloseView() : this.SetBtnCanClick(!0))
    }, ConfirmBoxDefine_1.BUTTON_DELAYTIME)
  }
  gqt(i) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), i, 0 < this.DelayTime ? this.DelayTime : "")
  }
  SetClickFunction(i) {
    this.ClickFunction = i
  }
  OnBeforeDestroy() {
    this.Timer && (TimerSystem_1.TimerSystem.Remove(this.Timer), this.Timer = void 0)
  }
}
