...
class EditMobileBattleView extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.Kot = new Map, this.CreateThenShowByResourceIdAsync("UiView_FightEdit", e)
  }
  ...
  async jgt() {
    var t = ModelManager_1.ModelManager.BattleUiSetModel.GetPanelDataMap(),
      a = this.RootActor.GetComponentByClass(UE.LGUIComponentsRegistry.StaticClass()).Components,
      i = [];
    for (let e = 0; e < a.Num(); e++) {
      var r, s, n = a.Get(e);
      n && n.GetUIItem().IsUIActiveSelf() && (r = t.get(e)) && (r = {
        PanelData: r,
        BattleViewBaseActor: this.RootActor
      }, n = (s = new EditMobileBattleViewPanel_1.EditMobileBattleViewPanel).CreateThenShowByActorAsync(n, r), i.push(n), this.Kot.set(e, s))
    }
    await Promise.all(i)
  }
  ResetAllPanelItem() {
  ...
  IsAnyItemOverlap(e) {
    for (const t of this.Kot.values())
      if (t.IsAnyItemOverlap(e)) return !0;
    return !1
  }
}
