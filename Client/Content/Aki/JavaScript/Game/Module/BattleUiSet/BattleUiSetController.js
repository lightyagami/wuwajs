...
class BattleUiSetController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(21495, BattleUiSetController.lgt);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(21495);
  }
  static MobileButtonSettingUpdateRequest(e) {
    ...
    Net_1.Net.Call(15276, Protocol_1.Aki.Protocol.Bms.create(t), this._gt);
  }
}
...
BattleUiSetController._gt = e => {
  ...
  if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
    ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26958);
