...
class TrapDefenseMainViewProxy extends GameMainViewProxy_1.GameMainViewProxy {
  ...
  async OnBeforeStartAsync() {
    await Promise.all([this.V6u(), this.b6u(), this.j6u(), this.H6u(), this.$6u(), this.c7u(), this.Q6u(), this.Sju(), this.rXc(), this.oXc(), this.Xud()]);
  }
  OnStart() {
  ...
  OnAddEventListener() {
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TowerDefenseRecycleRaycastNotify, this.tPd);
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TrapDefenseOnSlotUpdate, this.n3d);
  }
  OnRemoveEventListener() {
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TowerDefenseRecycleRaycastNotify, this.tPd);
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TrapDefenseOnSlotUpdate, this.n3d);
  }
  OnBeforeShow(e) {
    if (e) {
