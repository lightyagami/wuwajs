...
class LordGymLordEntranceItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.jSi = 0, this.OnToggleClick = void 0, this.CanExecuteChangeCallBack = void 0, this.$be = void 0, this.zbe = () => new LordGymLordStarItem_1.LordGymLordStarItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [2, UE.UITexture],
      [3, UE.UIExtendToggle]
    ], this.OnToggleClick && (this.BtnBindInfo = [
      [3, () => {
  ...
  OnStart() {
    this.CanExecuteChangeCallBack && this.GetExtendToggle(3)?.CanExecuteChange.Bind(() => this.CanExecuteChangeCallBack?.(this.GridIndex) ?? !0), this.$be = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(1), this.zbe)
  }
  Refresh(e, r, t) {
    this.jSi = e;
        ...
        if (e) {
          ...
          if (e && 0 !== e.length) {
            var e = MonsterInfoById_1.configMonsterInfoById.GetConfig(e[0]),
              s = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.Name), this.SetTextureByPath(e.BigIcon, this.GetTexture(2)), new Array(i.length));
            for (let e = 0; e < s.length; e++) s[e] = ModelManager_1.ModelManager.LordGymModel.GetLordGymIsFinish(i[e]);
