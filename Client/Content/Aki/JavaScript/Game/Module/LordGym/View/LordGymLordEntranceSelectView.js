...
class LordGymLordEntranceSelectView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lqe = void 0, this.sql = void 0, this.Wxl = 0, this.Qxl = 0, this.Kxl = void 0, this.p9t = void 0, this.AMo = () => {
      this.CloseMe()
    }, this.dpt = () => {
      ...
      return e.OnToggleClick = this.Xxl, e.CanExecuteChangeCallBack = this.Yxl, e
    }, this.Xxl = e => {
      this.Yxl(e) && this.SelectLordEntranceByIndex(e)
    }, this.Yxl = e => e !== this.sql.GetGenericLayout().GetSelectedGridIndex(), this.zxl = () => {
  ...
  SelectLordEntranceByIndex(e) {
    this.sql?.GetGenericLayout()?.SelectGridProxy(e), this.Qxl = this.Kxl[e], this.rPl()
  }
  rPl() {
