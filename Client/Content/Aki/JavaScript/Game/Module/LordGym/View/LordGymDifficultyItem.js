...
class LordGymDifficultyItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.syi = -1, this.OnToggleClick = void 0, this.CanExecuteChangeCallBack = void 0
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.CanExecuteChangeCallBack && this.GetExtendToggle(0)?.CanExecuteChange.Bind(() => this.CanExecuteChangeCallBack?.(this.GridIndex) ?? !0)
  }
  Refresh(t, i, e) {
    this.syi = t;
    var t = !ModelManager_1.ModelManager.LordGymModel.GetLordGymIsUnLock(this.syi) || !ModelManager_1.ModelManager.LordGymModel.GetLastGymFinish(this.syi),
      t = (this.GetItem(2).SetUIActive(t), ConfigManager_1.ConfigManager.LordGymConfig.GetLordGymConfig(this.syi)),
      r = ModelManager_1.ModelManager.LordGymModel.GetLordGymIsFinish(this.syi),
      r = (this.GetItem(3).SetUIActive(r), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t.GymTitle), i ? 1 : 0);
