...
class LordGymDifficultySelectView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lqe = void 0, this.Gxl = 0, this.jSi = 0, this.WSi = void 0, this.kxl = void 0, this.bOe = void 0, this.Oxl = 0, this.AMo = () => {
      this.CloseMe()
    }, this.dpt = () => {
      ...
      return e.OnToggleClick = this.Fxl, e.CanExecuteChangeCallBack = this.Vxl, e
    }, this.rOe = () => {
      return new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid
    }, this.Hxl = () => {
      var e;
      LordGymController_1.LordGymController.IsInEntranceEntity() ? (e = this.kxl.GetSelectedGridIndex(), e = this.WSi[e], LordGymController_1.LordGymController.LordGymBeginRequest(e).then(e => {
    ...
    }, this.Vxl = e => e !== this.kxl.GetSelectedGridIndex(), this.Fxl = e => {
  ...
  SelectLordDifficultyByIndex(e) {
    this.kxl?.SelectGridProxy(e), this.Oxl = this.WSi[e], this.RefreshDetail()
  }
  RefreshDetail() {
    var e = ConfigManager_1.ConfigManager.LordGymConfig.GetLordGymConfig(this.Oxl),
      i = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), "Text_InstanceDungeonRecommendLevel_Text", e.MonsterLevel.toString()), e.RewardId),
      i = ConfigManager_1.ConfigManager.ExchangeRewardConfig.GetExchangeRewardPreviewRewardList(i);
    ...
    }), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), e.PlayDescription), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), e.NewGymTitle);
    var i = ModelManager_1.ModelManager.LordGymModel.LordGymRecord.get(this.Oxl),
      i = (void 0 !== i ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(8), "BestPassTime", TimeUtil_1.TimeUtil.GetTimeString(i.Qxs)) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(8), "NoPassRecord"), !ModelManager_1.ModelManager.LordGymModel.GetLordGymIsUnLock(this.Oxl)),
      r = ModelManager_1.ModelManager.LordGymModel.GetLastGymFinish(this.Oxl),
      o = e.MonsterLevel > ModelManager_1.ModelManager.EditFormationModel.GetFormationAverageLevel();
    this.GetItem(12).SetUIActive(i || !r), this.GetItem(9).SetUIActive(o && !i && r), this.GetButton(10).RootUIComp.SetUIActive(!(i || !r)), i ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(13), e.LockDescription) : r ? o && LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(13), "LordGymLowLevel") : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(13), "LordGymLockTips"), t ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(11), "Text_ButtonTextChallengeOneMore_Text") : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(11), "Text_StartBattle_Text")
  }
}
