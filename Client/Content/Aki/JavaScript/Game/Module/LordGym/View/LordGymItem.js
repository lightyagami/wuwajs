...
class LordGymItem extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(e, i, t) {
    this.RefreshByLordId(e);
    this.hyi.SetToggleState(i ? 1 : 0, false);
  }
  Clear() {}
  OnSelected(e) {
  ...
  RefreshByLordId(e) {
    this.syi = e;
    this.GetItem(3).SetUIActive(!ModelManager_1.ModelManager.LordGymModel.GetLordGymIsUnLock(this.syi) || !ModelManager_1.ModelManager.LordGymModel.GetLastGymFinish(this.syi));
    e = ConfigManager_1.ConfigManager.LordGymConfig.GetLordGymConfig(this.syi);
    this.GetItem(4).SetUIActive(!ModelManager_1.ModelManager.ExchangeRewardModel.GetRewardIfCanExchange(e.RewardId));
    this.SetSpriteByPath(e.IconPath, this.GetSprite(2), false);
