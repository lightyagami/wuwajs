...
class LordMonsterItem extends UiPanelBase_1.UiPanelBase {
  ...
  SetMonsterInfo(e, t) {
    var i = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterIcon(e),
      i = (this.SetTextureByPath(i, this.GetTexture(2)), ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterName(e));
    this.GetText(0).SetText(i), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "Text_InstanceDungeonRecommendLevel_Text", t)
  }
}
