...
class LordGymController extends ControllerBase_1.ControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(25080, this.PSi), Net_1.Net.Register(16399, this.xSi)
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(25080), Net_1.Net.UnRegister(16399)
  }
  static OnAddEvents() {
  ...
  static async LordGymInfoRequest() {
    var e = Protocol_1.Aki.Protocol.Ass.create({}),
      e = await Net_1.Net.CallAsync(22969, e);
    if (0 < e.jxs?.length && (ModelManager_1.ModelManager.LordGymModel.UnLockLordGym = e.jxs, ModelManager_1.ModelManager.LordGymModel.UnLockLordGym.sort((e, r) => e - r)), e.Wxs?.length && (ModelManager_1.ModelManager.LordGymModel.ReadLoadGymIds = e.Wxs), 0 < e.Kxs?.length)
      for (const r of e.Kxs) ModelManager_1.ModelManager.LordGymModel.LordGymRecord.set(r.y7n, r)
  }
  static async LordGymBeginRequest(e) {
    var r = Protocol_1.Aki.Protocol.wss.create(),
      r = (r.y7n = e, await Net_1.Net.CallAsync(20019, r));
    return !!r && (r.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(r.Q4n, 20019), !1) : (ModelManager_1.ModelManager.LordGymModel.CurrentChallengeLordGymId = e, ModelManager_1.ModelManager.LordGymModel.GetLordGymHasRead(e) || LordGymController.ReadLordGym(e), !0))
  }
  static async OpenLordGymEntrance(e, r = 0) {
    return await this.LordGymInfoRequest(), ModelManager_1.ModelManager.LordGymModel.EntranceEntityId = r, void 0 !== await UiManager_1.UiManager.OpenViewAsync("LordGymEntranceView", e)
  }
  static async OpenLordGymLordEntranceSelectView(e, r = 0) {
    return ModelManager_1.ModelManager.LordGymModel.EntranceEntityId = r, ModelManager_1.ModelManager.LordGymModel.EntranceSetId = e, void 0 !== await UiManager_1.UiManager.OpenViewAsync("LordGymLordEntranceSelectView", e)
  }
  static OpenGymUnlockTipView(e) {
    UiManager_1.UiManager.OpenView("LordGymUnlockTipView", e), ModelManager_1.ModelManager.LordGymModel.FirstUnLockLordGym = []
  }
  static async ReadLordGym(e) {
    ModelManager_1.ModelManager.LordGymModel.ReadLordGym(e);
    var r = Protocol_1.Aki.Protocol.bss.create();
    r.y7n = e, await Net_1.Net.CallAsync(18645, r)
  }
  static IsInEntranceEntity() {
    var e = ModelManager_1.ModelManager.LordGymModel.EntranceEntityId;
    return !e || !(e = ModelManager_1.ModelManager.CreatureModel.GetEntityById(e))?.IsInit || (e.Entity?.GetComponent(119)?.IsInInteractRange ?? !1)
  }
  static CreateLordModelByEntranceId(e) {
    ...
    UiModelUtil_1.UiModelUtil.SetTransformByTag(r.Model, "MonsterCase"), this.LoadLordModelByEntranceId(e)
  }
  static LoadLordModelByEntranceId(e) {
    if (UiSceneManager_1.UiSceneManager.GetLordSkeletalHandle()) {
      ...
      if (r !== e) {
        ...
        r = [M];
        StringUtils_1.StringUtils.IsBlank(c) || r.push(c), StringUtils_1.StringUtils.IsBlank(g) || r.push(g);
        s?.LoadModelByModelId(e, !0, () => {
          ...
          let r = e.CacheLocation,
            ...
            n = e.CacheTransform;
          var a = i.Location,
            a = (r ? r.Set(a[0], a[1], a[2]) : (r = new UE.Vector(a[0], a[1], a[2]), e.CacheLocation = r), i.Rotator),
            a = (t ? (t.Pitch = a[0], t.Yaw = a[1], t.Roll = a[2]) : (t = new UE.Rotator(a[0], a[1], a[2]), e.CacheRotator = t), i.Zoom),
            a = (o ? o.Set(a[0], a[1], a[2]) : (o = new UE.Vector(a[0], a[1], a[2]), e.CacheScale = o), n ? (n.SetLocation(r), n.SetRotation(t.Quaternion()), n.SetScale3D(o)) : (n = new UE.Transform(t, r, o), e.CacheTransform = n), _.SetAllMeshComponentRelativeTransform(n, !1, void 0, !1), s?.GetLoadedResource(M)),
            e = (a || Log_1.Log.CheckError() && Log_1.Log.Error("UiCommon", 43, "[LordGym] 道馆界面待机动画预加载失败"), d.PlayAnimation(a, !0), l.CheckGetComponent(5));
          StringUtils_1.StringUtils.IsBlank(c) || (a = s.GetLoadedResource(c)) && e?.AddRenderingMaterialByData(a), StringUtils_1.StringUtils.IsBlank(g) || (a = s.GetLoadedResource(g)) && e?.AddRenderingMaterialByData(a)
        }, r)
      }
    }
  }
}
exports.LordGymController = LordGymController, (_a = LordGymController).$5e = () => {
  ModelManager_1.ModelManager.LordGymModel?.InitNewLordGymEntranceIdRecord(), _a.LordGymInfoRequest()
  ...
  if (t.LordGymRecord.set(o, r.Jxs), r.Mws) {
    ...
    for (const d of r.zxs) {
      var a = new RewardItemData_1.RewardItemData(d.L8n, d.m9n, 0 !== d.Xxs ? d.Xxs : void 0);
      n.push(a)
    }
    let e = void 0;
    ...
    e = t.IsNew ? (o = {
      ...
      OnClickedCallback: () => {
        ...
        0 < e && UiManager_1.UiManager.OpenView("LordGymLordEntranceSelectView", e)
      }
    }]) : [{
  ...
  } else t = r.E7_, ConfigManager_1.ConfigManager.LordGymConfig.GetLordGymConfig(t).IsNew && !e && (o = {
    LordId: t
