...
class PlotBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  Constructor() {}
  static IsInSequence() {
    return ModelManager_1.ModelManager.PlotModel.IsInPlot && ("LevelA" === ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel || "LevelB" === ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel)
  }
  ...
  static StartPlotTs(e) {
    ModelManager_1.ModelManager.PlotModel.IsInPlot && "LevelD" !== ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel ? Log_1.Log.CheckInfo() && Log_1.Log.Info("Plot", 17, "当前正在播放其他剧情，不允许打断") : ControllerHolder_1.ControllerHolder.FlowController.StartFlowByRes(e)
  }
  static IsInPerformingPlot() {
    return !!ModelManager_1.ModelManager.PlotModel && (ModelManager_1.ModelManager.PlotModel.IsInInteraction || ModelManager_1.ModelManager.PlotModel.IsInPlot && "LevelD" !== ModelManager_1.ModelManager.PlotModel.PlotConfig.PlotLevel)
  }
  ...
  static ExecuteEntitySequenceEvents(e, r) {
    ...
    t?.IsInit ? t.Entity?.GetComponent(164)?.ExecuteEvent(e) : Log_1.Log.CheckError() && Log_1.Log.Error("LevelPlay", 26, "场景引用Sequence帧事件找不到实体", ["key", e], ["id", r])
  }
