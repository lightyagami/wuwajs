...
const cardSlotDefaultSortFunc = (t, e) => t.CardType !== e.CardType ? t.CardType === 3 ? -1 : e.CardType === 3 ? 1 : t.CardType - e.CardType : t.Cost !== e.Cost ? e.Cost - t.Cost : t.Element !== e.Element ? t.Element === 0 ? 1 : e.Element === 0 ? -1 : t.Element - e.Element : t.CardId - e.CardId;
...
exports.addCardFailedResultToTipTextId = {
  ...
  6: "PhantomBattle_1074",
  3: "PhantomBattle_1141",
  4: "PhantomBattle_1142",
...
exports.HELP_ID_COLLECT_NEW = 477;
...
exports.DECK_ID_EMPTY_TEMP = -100;
exports.SPECIAL_TASK_TABTYPE = 0;
class PhantomArenaReportCardInfo {
  constructor(t) {
    this.Cost = t;
    this.CardIdList = [];
  }
}
exports.PhantomArenaReportCardInfo = PhantomArenaReportCardInfo;
exports.phantomBattleSettleReasonToTextId = {
  [0]: "PhantomBattle_1145",
  1: "PhantomBattle_1146",
  2: "PhantomBattle_1147"
};
exports.difficultNumTextures = {
  [1]: "T_ComRomeText_01",
  2: "T_ComRomeText_02",
  3: "T_ComRomeText_03",
  4: "T_ComRomeText_04",
...
exports.MYSTERY_NPC_HEAD = "MysteryNpcHead"; //# sourceMappingURL=PhantomArenaDefine.js.map