...
exports.CardOutlookPreviewItem = undefined;
...
class CardOutlookPreviewItem extends CommonBaseCardItem_1.CommonBaseCardItem {
  ...
  Refresh(e) {
    ...
    var a = !ModelManager_1.ModelManager.PhantomArenaModel.CheckCardSpineConfigValid(e);
    var r = o.InitAttack;
    var r = {
      CardId: e,
      Cost: o.Cost,
      ...
      OutlookUnlocked: true,
      CanToggleExecuteChange: () => false
    };
    this.GetComponent(0)?.Refresh(r);
    var o = {
