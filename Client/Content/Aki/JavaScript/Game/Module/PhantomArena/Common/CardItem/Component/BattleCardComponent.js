...
class BattleCardSpineItem extends UiPanelBase_1.UiPanelBase {
  ...
  async RAr(t) {
    var e;
    var t = ConfigManager_1.ConfigManager.PhantomArenaConfig.GetPhantomBattleCardConfig(t);
    var i = t.SpineAtlas;
    var t = t.SpineSkeleton;
    if (!StringUtils_1.StringUtils.IsBlank(i) && !StringUtils_1.StringUtils.IsBlank(t)) {
      e = this.GetSpine(0);
      await this.SetSpineAssetByPath(i, t, e);
  ...
  PlaySpineAnim(t, e) {
    ...
    if (i.IsValid() && (i = i.SetAnimation(0, t, e), t === "start")) {
