...
exports.OpponentHandCardItem = undefined;
const UE = require("ue");
const CustomPromise_1 = require("../../../../../Core/Common/CustomPromise");
const TimerSystem_1 = require("../../../../../Core/Timer/TimerSystem");
const UiPanelBase_1 = require("../../../../Ui/Base/UiPanelBase");
const UiSequencePlayer_1 = require("../../../../Ui/Base/UiSequencePlayer");
const PhantomArenaCardTweenLogic_1 = require("../Card/PhantomArenaCardTweenLogic");
class OpponentHandCardItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments);
    this.TweenLogic = undefined;
    this.CardSequence = undefined;
  ...
  OnStart() {
    this.CardSequence = new UiSequencePlayer_1.UiSequencePlayer(this.RootItem);
    this.TweenLogic = new PhantomArenaCardTweenLogic_1.PhantomArenaCardTweenLogic();
    this.TweenLogic.Init(this.GetItem(0));
  ...
  async PlayStartTimeLocationTween(e, t) {
    ...
    this.TweenLogic.PlayLocationByItem(e, this.GetRootItem(), t);
    this.PlaySequence("Rotation");
    await i.Promise;
  }
  async PlayEndTimeLocationTween(e, t) {
    ...
    this.TweenLogic.PlayLocationByItem(this.GetRootItem(), e, t);
    this.PlaySequence("Rotation", true);
    await i.Promise;
  ...
  async PlayAddCardTween(e) {
    ...
    this.TweenLogic.PlayLocationByItem(e, this.GetRootItem(), i);
    this.PlaySequence("Rotation");
    await t.Promise;
  }
  async PlayBackToLibraryTween(e) {
    ...
    this.TweenLogic.PlayLocationByItem(this.GetRootItem(), e, i);
    await t.Promise;
    await this.DestroyAsync();
  }
  ...
  PlaySequence(e, t = false) {
    ...
    this.CardSequence.PlaySequencePurely(e, false, t);
  }
  ...
  async PlayRemoveSequence() {
    this.GetItem(0).SetAlpha(0);
    var e = new CustomPromise_1.CustomPromise();
    await this.CardSequence.PlaySequenceAsync("MoveOut", e);
    await this.DestroyAsync();
  }
