...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PhantomArenaBattleDamageView = void 0;
const UE = require("ue"),
...
class PhantomArenaBattleDamageView extends UiViewBase_1.UiViewBase {
  ...
  OnStart() {
    ...
    this.GetArtText(0)?.SetText(e.toString()), this.GetArtText(1)?.SetText(e.toString()), this.GetArtText(2)?.SetText(e.toString())
  }
}
