...
exports.PhantomArenaBattleGuideRecycleCardFromHand = undefined;
...
class PhantomArenaBattleGuideRecycleCardFromHand extends PhantomArenaBattleGuideDataBase_1.PhantomArenaBattleGuideDataBase {
  CheckCanExecute(e) {
    if (e === PhantomArenaBattleGuideDefine_1.GUIDE_INVALID_VALUE && Log_1.Log.CheckError()) {
      Log_1.Log.Error("PhantomArena", 10, "PhantomArenaBattleGuideRecycleCardFromHand invalid value", ["battleIndex", e]);
    }
