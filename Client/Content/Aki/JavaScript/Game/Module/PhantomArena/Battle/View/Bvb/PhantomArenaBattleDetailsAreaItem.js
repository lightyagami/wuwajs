...
exports.PhantomArenaBattleDetailsAreaItem = undefined;
const UE = require("ue");
...
class PhantomArenaBattleDetailsAreaItem extends UiPanelBase_1.UiPanelBase {
  ...
  async tU1() {
    ...
    await this.Layout.RefreshByDataAsync(this.EntityIdList);
  }
  async iU1() {
    this.RoleItem = new PhantomArenaBattleDetailsIconItem_1.PhantomArenaBattleDetailsRoleItem();
    this.RoleItem.RegisterViewProxy(this.Proxy);
  ...
  async OnBeforeStartAsync() {
    ...
    this.DetailsTipsItem.SetBtnMaskCallback(this.Tku);
  }
  RegisterProxy(t) {
    this.Proxy = t;
  }
  ...
  StartAccumulate(t, e, i) {
    ...
    var a = this.RoleItem.GetHeadLocation();
    this.SkillItem?.OnAccumulateEvent(a.X, a.Z, i);
    for (const h of s) {
      h.OnAccumulateEvent(a.X, a.Z, t, e);
    }
