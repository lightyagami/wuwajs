...
exports.PhantomArenaNewDeckBuilderTabView = undefined;
const UE = require("ue");
...
class PhantomArenaNewDeckBuilderTabView extends PhantomArenaChildViewBase_1.PhantomArenaChildViewBase {
  constructor() {
    super(...arguments);
      ...
      if (this.DeckInfo && (i = this.AllPageCardDataList.find(t => t.CardId === e))) {
        if (i.IsLocked) {
          ...
          if ((t = this.DeckInfo.AddCard(t)) === 0) {
            ...
            } else if (s.CardType === 3) {
              this.DeckSlotsPanel.RefreshFieldCardSlot(h);
            } else {
    ...
    this.oKm = t => {
      t = t.GetData();
      if (t) {
        PhantomArenaController_1.PhantomArenaController.OpenDeckBuilderCardInfoViewWithoutOutlookTab(t.CardId);
      }
    };
    this.i61 = t => false;
    this.XQm = t => false;
    ...
    this.RXm = (t, e) => {
      var i;
      if (e === -1 || ((i = this.GetItem(16)).bIsUIActive || (this.T7i(), i.SetUIActive(true)), this.GetSprite(17)?.SetFillAmount(e), e >= 1)) {
        this.bXm(t);
      }
    };
    this.wXm = () => {
    ...
    this.rmf = t => {
      if (this.imf) {
        ...
        this.imf.RefreshCard(t, this.DeckInfo);
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UILoopScrollViewComponent], [1, UE.UIItem], [2, UE.UILayoutBase], [3, UE.UIItem], [4, UE.UIItem], [5, UE.UIItem], [6, UE.UIText], [7, UE.UIButtonComponent], [8, UE.UIButtonComponent], [9, UE.UIButtonComponent], [10, UE.UIButtonComponent], [11, UE.UIItem], [12, UE.UIButtonComponent], [13, UE.UIButtonComponent], [14, UE.UIText], [15, UE.UIItem], [16, UE.UIItem], [17, UE.UISprite], [18, UE.UIItem]];
    this.BtnBindInfo = [[7, this.s61], [8, this.a61], [9, this.RK1], [10, this.A81], [12, this.TK1], [13, this.h61]];
  }
  async OnBeforeStartAsync() {
    ...
    await Promise.all([this.NV1.RefreshByDataAsync(this.TabDataList), this.CardFilterEntrance.CreateThenShowByActorAsync(this.GetItem(4).GetOwner()), this.DeckSlotsPanel.CreateThenShowByActorAsync(this.GetItem(11).GetOwner()), this.imf.CreateByResourceIdAsync("NewPnlCardTips", this.GetItem(18))]);
  ...
  async OnBeforeShowAsyncImplement() {
    ...
    this.ViewModel.SetViewHelpId?.(481);
  ...
  LK1(t = true) {
    t = {
      ...
      OnFieldCardItemEffectBtnClick: this.oKm,
  ...
  T7i() {
    ...
    var e = t.X + e;
    var t = t.Y + i;
    this.GetItem(16).SetLGUISpaceAbsolutePosition(new UE.Vector(e, t, 0));
  }
  f61() {
...
exports.PhantomArenaNewDeckBuilderTabView = PhantomArenaNewDeckBuilderTabView;
//# sourceMappingURL=PhantomArenaNewDeckBuilderTabView.js.map