...
class ShipTogetherView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Flo = void 0, this.ebl = void 0, this.I2i = () => {
      var e = new ShipTogetherRoleItem_1.ShipTogetherRoleItem;
      return e.BindOnClickToggleCallBack(this.tbl), e
    }, this.tbl = (e, t) => {
      this.ebl !== e && this.ebl?.SetToggleState(0), this.ebl = e, ModelManager_1.ModelManager.ShipTogetherModel.CurrentSelectTogetherRoleId = t
    }, this.L3e = () => {
      -1 !== ModelManager_1.ModelManager.ShipTogetherModel.CurrentSelectTogetherRoleId ? EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnChangeRideSharingPassenger, ModelManager_1.ModelManager.ShipTogetherModel.CurrentSelectTogetherRoleId, 1) : EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRemoveRideSharingPassenger, -1, -1), this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.Flo = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(0), this.GetItem(1).GetOwner(), this.I2i), ModelManager_1.ModelManager.ShipTogetherModel.CurrentSelectTogetherRoleId = ModelManager_1.ModelManager.ShipTogetherModel.ShipTogetherRoleId
  }
  OnBeforeShow() {
    ...
    var t = [];
    for (const i of e) ModelManager_1.ModelManager.RoleModel.IsMainRole(i.GetRoleId()) || t.push(i);
    t.sort((e, t) => {
      var i = o.includes(e.GetRoleId()),
        r = o.includes(t.GetRoleId());
