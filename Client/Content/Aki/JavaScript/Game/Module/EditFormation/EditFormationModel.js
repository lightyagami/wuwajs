...
class EditFormationModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.s5t = new Map, this.a5t = void 0, this.h5t = new Map
  }
  ...
  ChangeEditedMainRole() {
    ...
    for (const e of this.h5t.values())
      for (const i of e) {
        var r, o = i.RoleId;
        t.IsMainRole(o) && (r = t.GetNewMainRoleId(o)) && o !== r && (i.RoleId = r)
      }
  }
  InitEditingFormationMap() {
    ...
    for (const r of this.s5t.values()) {
      var t = r.FormationId;
      for (const o of r.GetRoleDataMap().values()) this.SetEditingRoleId(t, o.Position, o.ConfigId)
    }
  }
  IsRoleDead(t) {
    ...
    return r ? r.IsDead() : !(r = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(t)) || r.GetAttributeData().GetAttrValueById(HEALTH_ID) <= 0
  }
  SetEditingRoleId(t, r, o = 0, e = !0) {
    ...
    if (!i) {
      ...
      for (let t = 1; t <= EditFormationDefine_1.EDITE_FORAMTION_MAX_NUM; t++) i.push(new EditingRoleData(t))
    }
    var a = [];
    for (const s of i) {
  ...
  GetEditingRoleId(t, r) {
    ...
    if (t)
      for (const o of t)
        if (o.Position === r) return o.RoleId;
    return 0
  }
  GetEditingRolePosition(t, r) {
    ...
    if (t)
      for (const o of t)
        if (o.RoleId === r) return o.Position;
    return -1
  }
  ...
  ApplyCurrentFormationData(t) {
    t = this.s5t.get(t);
    t && (Log_1.Log.CheckInfo() && Log_1.Log.Info("Formation", 48, "设置当前编队数据 [ApplyCurrentFormationData]", ["data", t]), this.a5t = t)
  }
  IsMyPosition(t) {
    var r;
  ...
  GetFormationAverageLevel() {
    ...
    for (const e of ModelManager_1.ModelManager.SceneTeamModel.GetTeamEntities()) {
      var o = e.Entity?.GetComponent(173);
      o && (t += o.GetCurrentValue(CharacterAttributeTypes_1.EAttributeId.Proto_Lv), r++)
    }
    return r ? t / r : 0
  }
}
