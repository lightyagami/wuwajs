...
class EditFormationRoleData {
  constructor(t, i, s, e, o) {
    this.Position = 0, this.ConfigId = 0, this.RoleSkinId = 0, this.PlayerId = 0, this.Level = 0, this.Position = t, this.ConfigId = i, this.RoleSkinId = s, this.PlayerId = o, this.Level = e
  }
}
class EditFormationData {
  constructor(t) {
    this.FormationId = 0, this.n5t = 0, this.Wke = [], this.pXe = new Map, this.FormationId = t
  }
  ...
  SetCurrentRole(t) {
    for (const i of this.pXe.values()) i.ConfigId === t && (this.n5t = i.Position)
  }
  GetRoleDataMap() {
    return this.pXe
  }
