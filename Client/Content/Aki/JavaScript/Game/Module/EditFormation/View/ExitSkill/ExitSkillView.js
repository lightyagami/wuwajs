...
class ExitSkillView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.P5t = void 0, this.x5t = !1, this.I5t = () => {
      UiManager_1.UiManager.CloseView("ExitSkillView")
    }, this.w5t = i => {
      ModelManager_1.ModelManager.RoleModel.IsShowMultiSkillDesc = i, this.x5t = i, this.B5t(this.x5t);
      const e = this.Pe?.GetItems();
      void 0 !== e && this.P5t.forEach((i, t) => {
      ...
      for (let i = 0; i < this.P5t.length; i++) {
        var e = this.P5t[i],
          s = t[i],
          r = s?.GetRoleData;
        s && r ? ((s = new ExitSkillItem_1.ExitSkillItemData).RoleId = r.ConfigId, s.OnlineIndex = r.OnlineIndex, s.PlayerId = r.PlayerId, e.Refresh(s, this.x5t)) : e.Refresh(void 0, !1)
      }
    }
  }
  OnRegisterComponent() {
  ...
  OnBeforeDestroy() {
    this.Pe = void 0, this.P5t?.splice(0, this.P5t.length), this.P5t = void 0
  }
  OnAddEventListener() {
  ...
  OnStart() {
    ...
    var t = [this.GetItem(2), this.GetItem(3), this.GetItem(4)],
      ...
      i = (this.GetItem(9).SetUIActive(i), this.x5t = ModelManager_1.ModelManager.RoleModel.IsShowMultiSkillDesc && i, this.x5t ? 1 : 0),
      e = (this.GetExtendToggle(8).SetToggleState(i), this.B5t(this.x5t), this.Pe?.GetItems());
    for (let i = 0; i < t.length; i++) {
      var s = new ExitSkillItem_1.ExitSkillItem(t[i]);
      this.P5t.push(s), e && i < e.length ? s.Refresh(e[i], this.x5t) : s.Refresh(void 0, !1)
    }
  }
  B5t(i) {
