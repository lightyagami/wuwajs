...
class ActivityPermanentRogueModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.SelectSkillId = 0, this.N6c = new Map, this.fw1 = new Map, this.ns1 = new Map, this.l_1 = new Map, this.ss1 = 0, this.SortTaskData = (e, t) => e.Status === t.Status ? e.Id - t.Id : this.nB1(e.Status) - this.nB1(t.Status)
  }
  OnInit() {
    return !0
  }
  ...
  InitCurrency(e) {
    ...
    for (const o of Object.keys(e)) {
      var t = Number(o),
        r = e[o];
      this.N6c.set(t, e[o]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnPlayerCurrencyChange, t), Log_1.Log.CheckDebug() && Log_1.Log.Debug("RogueBattle", 37, "[MapRogue] 常驻肉鸽货币初始化", ["ItemId", t], ["ItemId", r])
    }
    this.fw1.clear();
    for (const n of RogueResThemeAll_1.configRogueResThemeAll.GetConfigList()) this.fw1.set(n.SkillItem, n.Id)
  }
  UpdateCurrency(e, t) {
    for (const i of Object.keys(e)) {
      var r = Number(i),
        o = e[i],
        n = this.N6c.get(r),
        a = (this.fw1.has(r) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.PermanentRogueSkillCurrencyRedDotUpdate, this.fw1.get(r)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.PermanentRogueSeasonRedDotUpdate, this.fw1.get(r))), void 0 !== n ? this.N6c.set(r, n + o) : this.N6c.set(r, o), ModelManager_1.ModelManager.MapRogueModel.GameInfo);
      a && (a.InBattle ? 0 < o && ControllerHolder_1.ControllerHolder.ItemHintController.AddRoguelikeItemList(r, o) : t && ConfigManager_1.ConfigManager.MapRogueConfig.GetGlobalParamConfig().ShowCurrencyChangeEventType.includes(t) && ModelManager_1.ModelManager.MapRogueModel.GameInfo?.PushGetItemData(r, o)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnPlayerCurrencyChange, r), Log_1.Log.CheckDebug() && Log_1.Log.Debug("RogueBattle", 37, "[MapRogue] 常驻肉鸽货币变更", ["ItemId", r], ["ItemId", n ?? 0 + o])
    }
  }
  GetCurrency(e) {
  ...
  GetCurrentSelectedInst(e) {
    return (LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResDungeonSelected) ?? void 0)?.get(e) ?? 0
  }
  SetCurrentSelectedInst(e) {
    var t, r = RogueResDungeonConfigById_1.configRogueResDungeonConfigById.GetConfig(e);
    r && ((t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResDungeonSelected) ?? new Map).set(r.SeasonId, e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResDungeonSelected, t))
  }
  GetTokenCount(e) {
    ...
    r[1] = t.size;
    for (const n of t) r[0] += o.get(n) !== Protocol_1.Aki.Protocol.zps.Z6n ? 1 : 0;
    return r
  }
  GetEventCount(e, t) {
    ...
    o[1] = t.size;
    for (const a of t) o[0] += n.get(a) !== Protocol_1.Aki.Protocol.zps.Z6n ? 1 : 0;
    return o
  }
  GetTypeIllustratedCountInfo() {
    ...
    for (const r of this.GetActivityData().GetAllIllustratedState()) {
      ...
      t ? (t = t.Type, e.get(t) || e.set(t, [0, 0]), e.get(t)[1]++, e.get(t)[0] += r[1] === Protocol_1.Aki.Protocol.zps.Z6n ? 0 : 1) : Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 77, "未找到肉鸽图鉴配置", ["collectId", r[0]])
    }
    return e
  }
  GetTokenTipsData(e) {
    var t;
    return this.l_1.get(e) ? this.l_1.get(e) : ((t = new Protocol_1.Aki.Protocol.MIc).lIc = new Protocol_1.Aki.Protocol.lIc, t.lIc.dws = !1, t.lIc.v9n = e, this.l_1.set(e, t), t)
  }
  ...
  GetTaskCount() {
    ...
    for (const o of RogueResTaskThemeById_1.configRogueResTaskThemeById.GetConfig(t.GetTaskThemeId()).TabNames) {
      var r = t.GetTaskListByType(o[0]);
      e[1] += r.length;
      for (const n of r) e[0] += t.GetTaskById(n).Status === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskRunning ? 0 : 1
    }
    return e
  }
  ...
  CheckAllTaskRedDot() {
    return this.GetCacheTaskOpen() <= TimeUtil_1.TimeUtil.GetServerTime() || this.GetActivityData().IsTaskReward()
  }
  CheckTaskRedDot(e) {
    for (const t of this.GetTaskListById(e))
      if (this.GetTaskById(t).Status === Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskFinish) return !0;
    return !1
  }
  nB1(e) {
    switch (e) {
  ...
  GetCacheTaskOpen() {
    var e = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResTaskOpen) ?? void 0;
    return e || -1
  }
  SetCacheTaskOpen() {
  ...
  GetCacheDungeonNewest(e) {
    return (LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResDungeonNewest) ?? void 0)?.get(e) ?? void 0
  }
  SetCacheDungeonNewest(e) {
    ...
    t.set(e, r), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResDungeonNewest, t)
  }
  ...
  GetLatestDungeon(e) {
    ...
    for (const r of RogueResThemeById_1.configRogueResThemeById.GetConfig(e).Insts)
      if (ModelManager_1.ModelManager.InstanceDungeonEntranceModel.CheckInstanceUnlock(r) && (t = r, !ModelManager_1.ModelManager.ExchangeRewardModel?.IsFinishInstance(r))) return r;
    return t
  }
  GetInstDungeonState(e) {
    var t = this.GetInstDungeonEndingReachedCount(e),
      r = this.ns1.get(e)?.size ?? 0;
    return 0 === r ? (Log_1.Log.CheckError() && Log_1.Log.Error("RogueBattle", 77, "副本未配置结局数据！", ["instId", e]), 0) : t === r ? 2 : ModelManager_1.ModelManager.InstanceDungeonEntranceModel.CheckInstanceUnlock(e) ? 1 : 0
  }
  GetInstDungeonEndingTotalCount(e) {
    return this.ns1.get(e).size
  }
  GetInstDungeonEndingReachedCount(e) {
    if (!this.ns1.get(e))
      for (const a of RogueResEndAll_1.configRogueResEndAll.GetConfigList()) {
        var t = a.InstId;
        this.ns1.get(t) || this.ns1.set(t, new Set), this.ns1.get(t)?.add(a.Id)
      }
    let r = 0;
    var o = this.GetActivityData(),
      n = RogueResDungeonConfigById_1.configRogueResDungeonConfigById.GetConfig(e).SeasonId;
    if (!this.ns1.get(e)) return Log_1.Log.CheckError() && Log_1.Log.Error("RogueBattle", 77, "未找到副本相关结局", ["InstId", e]), 0;
    for (const i of this.ns1.get(e)) r += o.GetEndingReachedById(n, i) ? 1 : 0;
    return r
  }
  ...
  GetNextCanUnlockSkillId(e) {
    ...
    var r = this.GetActivityData().GetSeasonDataById(e).Mqs,
      e = RogueResThemeById_1.configRogueResThemeById.GetConfig(e),
      o = this.GetCurrency(e.SkillItem);
    for (const a of Object.keys(r)) {
      var n = r[a];
      if (0 === n)
        if (t = Number(a), RogueResTalentTreeById_1.configRogueResTalentTreeById.GetConfig(Number(a)).Consule[0] <= o) return t;
      0 === t && (t = Number(a))
    }
    return t
  }
  GetCacheSkillTreeOpen(e) {
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResSkillTreeOpen) ?? void 0;
    return !!t && t.has(e)
  }
  SetCacheSkillTreeOpen(e) {
    ...
    t.add(e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResSkillTreeOpen, t)
  }
    ...
    if (e) {
      ...
      if (t) {
        ...
        for (const a of Object.keys(o)) {
          var n = o[a];
          if (0 === n)
            if (RogueResTalentTreeById_1.configRogueResTalentTreeById.GetConfig(Number(a)).Consule[n] <= r) return !0
        }
      }
    }
    return !1
  ...
  UpdateSkillTreeUnlockState(e) {
    this.GetActivityData().UpgradeSkill(e, 0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RogueResTalentLevelUp, e)
  }
  GetShopCount(e) {
  ...
  CheckShopRedDot(e) {
    ...
    if (!t) return !1;
    var r = [];
    for (const n of ModelManager_1.ModelManager.PayShopModel.GetPayShopTabData(t.ShopId)) {
      var o = n.GetGoodsData();
      o.GetIfCanBuy() && r.push(o.Id)
    }
    return r.sort((e, t) => e - t), !this.GetCacheShopOpen(e, r.toString())
  }
  RefreshShopRedDot(e) {
    var t = RogueResThemeById_1.configRogueResThemeById.GetConfig(e),
      r = [];
    ...
    r.sort((e, t) => e - t), this.SetCacheShopOpen(e, r.toString()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.PermanentRogueSeasonRedDotUpdate, e)
  }
  ...
  GetCacheShopOpen(e, t) {
    var r = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResShopRefresh) ?? void 0;
    return !!r && (r.get(e) ?? "") === t
  }
  SetCacheShopOpen(e, t) {
    ...
    r.set(e, t), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResShopRefresh, r)
  }
  ...
  GetEndingAwardViewData(e) {
    ...
    return e.sort((e, t) => {
      var r, o;
      return e.RewardState === t.RewardState ? (r = RogueResEndAwardById_1.configRogueResEndAwardById.GetConfig(e.Id), o = RogueResEndAwardById_1.configRogueResEndAwardById.GetConfig(t.Id), r.Index - o.Index) : n(e.RewardState) - n(t.RewardState)
    }), {
      DataPageList: [{
        DataList: e,
  ...
  GetEndingAwardCount(e) {
    var e = this.GetEndingAwardList(e),
      t = [0, e?.length ?? 0];
    if (e)
      for (const r of e) t[0] += 0 === r.RewardState ? 0 : 1;
    return t
  }
  ...
  GetEndingListBySeasonId(e) {
    var t = [];
    for (const r of RogueResEndAll_1.configRogueResEndAll.GetConfigList()) r.SeasonId === e && t.push(r.Id);
    return t
  }
  GetEndingIsUnlock(e) {
  ...
  GetCacheEndingOpen(e) {
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResEndingOpen) ?? void 0;
    return !!t && t.has(e)
  }
  SetCacheEndingOpen(e) {
    ...
    t.add(e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResEndingOpen, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RogueResEndingRedDotUpdate)
  }
  GetTrailRole(e, t) {
    e = this.GetActivityData().GetSeasonDataById(e);
    return 0 === t ? e?.WBc ?? [] : e?.QBc ?? []
  }
  ...
  GetCacheTrailOpen(e) {
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResTrialOpen) ?? void 0;
    return t ? t.get(e) : -1
  }
  SetCacheTrailOpen(e) {
    ...
    t.set(e, r), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RogueResTrialOpen, t)
  }
  CheckTrialRedDot(e) {
