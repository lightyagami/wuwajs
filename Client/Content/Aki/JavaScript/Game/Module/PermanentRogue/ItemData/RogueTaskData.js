...
class RogueTaskData {
  constructor(e) {
    this.Id = e, this.Status = Protocol_1.Aki.Protocol.I$s.Proto_ActivityTaskRunning, this.Current = 0, this.Target = 1
  }
  IsFinished() {
  ...
  GetRewardList() {
    var e, o, t = RogueResTaskById_1.configRogueResTaskById.GetConfig(this.Id),
      r = [];
    for ([e, o] of ConfigManager_1.ConfigManager.RewardConfig.GetDropPackage(t.Award).DropPreview) r.push([{
      ItemId: e,
      IncId: 0
    }, o]);
    return r
