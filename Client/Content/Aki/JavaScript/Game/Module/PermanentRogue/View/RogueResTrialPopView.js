...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueResTrialView = exports.RogueResTrialTabItem = exports.RogueResTrialRoleItem = void 0;
const UE = require("ue"),
...
class RogueResTrialTabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.SeasonId = 0, this.eGe = void 0, this.HB_ = () => new RogueResTrialRoleItem
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, i) {
    ...
    this.GetText(1).SetColor(r), 1 === e ? (this.GetItem(6)?.SetUIActive(!0), this.GetText(5).SetColor(r), this.GetText(5)?.SetUIActive(!0), r = ModelManager_1.ModelManager.ActivityPermanentRogueModel.GetTrailRemainTime(this.SeasonId), this.GetText(5)?.SetText(r)) : (this.GetItem(6)?.SetUIActive(!1), this.GetText(5)?.SetUIActive(!1)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), tabText.get(e))
  }
}
...
class RogueResTrialView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.kd1 = 0, this.xqe = void 0, this._yn = () => {
      var e = new RogueResTrialTabItem;
      return e.SeasonId = this.kd1, e
    }, this.YP = () => {
  ...
  OnStart() {
    this.kd1 = this.OpenParam, this.xqe = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(1), this._yn)
  }
  OnBeforeShow() {
    this.RefreshTab()
  }
