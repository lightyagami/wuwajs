...
class RogueTaskRoleItem extends UiPanelBase_1.UiPanelBase {
  constructor(e, s) {
    super(), this.RoleId = 0, this.IsLock = !0, this.LevelSequencePlayer = void 0, this.RoleId = e, this.IsLock = s
  }
  OnRegisterComponent() {
  ...
  SetCharUnlock() {
    this.IsLock && (this.IsLock = !1, this.LevelSequencePlayer?.PlayLevelSequenceByName("Unlock"))
  }
}
