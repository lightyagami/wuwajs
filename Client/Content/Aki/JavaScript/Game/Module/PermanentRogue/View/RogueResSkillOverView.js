...
exports.RogueResSkillOverView = exports.RogueResSkillDesc = undefined;
const UE = require("ue");
...
class RogueResSkillOverView extends UiViewBase_1.UiViewBase {
  ...
  async InitDescItem() {
    ...
    i.sort((e, i) => {
      e = RogueResTalentTreeById_1.configRogueResTalentTreeById.GetConfig(e[0]);
      i = RogueResTalentTreeById_1.configRogueResTalentTreeById.GetConfig(i[0]);
      return e.Id - i.Id;
    }).forEach(e => {
      var i;
      var s;
      if (e[1] >= 1) {
        ...
        t += 1;
        s.Index = t;
        s.Data = RogueResTalentTreeById_1.configRogueResTalentTreeById.GetConfig(e[0]);
        this.SkillDescItemList.push(s);
        r.push(s.CreateThenShowByActorAsync(i.GetOwner()));
      }
    });
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "Roguelike_SkillNumOverView_Title", t, i.length);
