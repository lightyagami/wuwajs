...
exports.RogueButtonItemCollection = exports.RogueButtonItemA = undefined;
const UE = require("ue");
...
class RogueButtonItemA extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIText], [2, UE.UIText], [3, UE.UIItem], [4, UE.UIText]];
...
class RogueButtonItemCollection extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIText], [2, UE.UIText], [3, UE.UIItem], [4, UE.UIItem], [5, UE.UIItem]];
    this.BtnBindInfo = [[0, this.eTt]];
  }
  BindRedDot(t, e) {
    this.l4e = t;
