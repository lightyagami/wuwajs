...
class RogueIllustratedEventView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.TabComponent = void 0, this.TabViewComponent = void 0, this.L6e = void 0, this.TabDataList = [], this.IsNormalEvent = !0, this.l8c = 0, this.TIc = () => {
      this.CloseMe()
      ...
      this.TabViewComponent.ToggleCallBack(t, i, e, this.IsNormalEvent), this.l8c = t.Config ? t.Config.Id : 0
    }, this.yqe = e => {
  ...
  InitTabComponent() {
    this.TabComponent = new TabComponentWithCaptionItem_1.TabComponentWithCaptionItem(this.GetItem(0), new CommonTabComponentData_1.CommonTabComponentData(this.R6e, this.pqe, this.yqe), this.TIc), this.L6e = void 0, this.TabComponent.SetCanChange(this.CanToggleChange), this.TabComponent.SetHelpButtonShowState(!1), this.TabViewComponent = new TabViewComponent_1.TabViewComponent(this.GetItem(1))
  }
  async RIc() {
    var e = this.c8c(),
  ...
  ICi(t) {
    ...
    for (let e = 0; e < i; e++) {
      var a = t[e];
      a && (o[e].RedDotName = this.IsNormalEvent ? "RogueResIllustratedNormalTab" : "RogueResIllustratedMapTab", o[e].RedDotUid = a.Config?.Id ?? 0)
    }
    return o
  }
  c8c() {
    var t = new Array,
      e = ConfigManager_1.ConfigManager.DynamicTabConfig.GetViewTabList("RogueEventIllustratedView");
    if (0 !== e.length) {
      var e = e[0],
        i = new RogueResOutDefine_1.RogueIllustratedTabData,
        o = (i.TabType = this.IsNormalEvent ? 1 : 2, i.Icon = e.Icon, i.TabName = this.IsNormalEvent ? "UiDynamicTab_114_TabName_Normal" : "UiDynamicTab_114_TabName_Map", i.Index = e.TabIndex, i.Config = void 0, t.push(i), RogueResThemeAll_1.configRogueResThemeAll.GetConfigList());
      if (o)
        for (let e = 0; e < o.length; e++) {
          var a = new RogueResOutDefine_1.RogueIllustratedTabData;
          a.TabType = this.IsNormalEvent ? 1 : 2, a.Icon = o[e].Icon, a.TabName = o[e].Name, a.Config = o[e], a.Index = e + 2, t.push(a)
        }
    }
    return t
  }
