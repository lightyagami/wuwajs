...
class RogueTaskItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.bOe = void 0, this.sOn = void 0, this.JGe = () => new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid, this.qOe = () => {
  ...
  Refresh(e, t, i) {
    this.sOn = e, this.bOe.RefreshByData(e.GetRewardList()), this.GetButton(1).RootUIComp.SetUIActive(e.IsFinished() && !e.IsTaken()), this.GetItem(3).SetUIActive(e.IsTaken()), this.GetText(2).SetUIActive(!e.IsTaken() && !e.IsFinished()), this.GetButton(0).RootUIComp.SetUIActive(!1);
    var r = RogueResTaskById_1.configRogueResTaskById.GetConfig(e.Id);
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), r.Text), 0 < e.Target ? (this.GetText(5)?.SetUIActive(!0), this.GetText(5)?.SetText(e.Current + "/" + e.Target)) : this.GetText(5)?.SetUIActive(!1)
  }
}
