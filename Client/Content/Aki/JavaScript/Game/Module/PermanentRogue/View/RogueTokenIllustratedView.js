...
class RogueTokenIllustratedView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.TabComponent = void 0, this.TabViewComponent = void 0, this.L6e = void 0, this.TabDataList = [], this.l8c = 0, this.TIc = () => {
      this.CloseMe()
    }, this.yqe = e => {
      ...
      this.TabViewComponent.ToggleCallBack(t, o, e, i), this.l8c = t.Config ? t.Config.Id : 0
    }, this.wIc = e => {
  ...
  OnStart() {
    this.GetItem(2)?.SetUIActive(!1), this.InitTabComponent(), this.InitExtendToggle()
  }
  OnBeforeShow() {
    this.RIc()
  }
  ...
  InitTabComponent() {
    ...
    this.TabComponent = new TabComponentWithCaptionItem_1.TabComponentWithCaptionItem(this.GetItem(0), e, this.TIc), this.L6e = void 0, this.TabComponent.SetHelpButtonShowState(!1), this.TabComponent.SetCanChange(this.CanToggleChange), this.TabViewComponent = new TabViewComponent_1.TabViewComponent(this.GetItem(1))
  }
  InitExtendToggle() {
  ...
  ICi(t) {
    ...
    for (let e = 0; e < o; e++) {
      var n = t[e];
      n && (i[e].RedDotName = "RogueResIllustratedTokenTab", i[e].RedDotUid = n.Config ? n.Config.Id : 0)
    }
    return i
  }
  _8c() {
    var e = ConfigManager_1.ConfigManager.DynamicTabConfig.GetViewTabList("RogueTokenIllustratedView");
    return 0 === e.length ? (Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 77, "Missing Rogue Illustrated View Config, Use Default"), "RogueIllustratedTokenTabView") : e[0].ChildViewName
  }
  c8c() {
    var t = new Array,
      e = ConfigManager_1.ConfigManager.DynamicTabConfig.GetViewTabList("RogueTokenIllustratedView");
    if (0 !== e.length) {
      var e = e[0],
        o = new RogueResOutDefine_1.RogueIllustratedTabData,
        i = (o.TabType = 0, o.Icon = e.Icon, o.TabName = e.TabName, o.Index = e.TabIndex, o.Config = void 0, t.push(o), RogueResThemeAll_1.configRogueResThemeAll.GetConfigList());
      if (i)
        for (let e = 0; e < i.length; e++) {
          var n = new RogueResOutDefine_1.RogueIllustratedTabData;
          n.TabType = 0, n.Icon = i[e].Icon, n.TabName = i[e].Name, n.Config = i[e], n.Index = e + 2, t.push(n)
        }
    }
    return t
  }
