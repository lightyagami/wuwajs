...
class LevelPlayReportModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.gLl = new Map, this.pLl = new Map, this.fLl = new Map, this.cWl = new Map, this.Ox_ = new Map, this.mp1 = new Map
  }
  ...
  UpdateLevelPlayStateMsg(e, t) {
    for (const v of e) {
      ...
      for (const M of v.Uxs) {
        var a = this.vLl(r, M);
        this.cWl.delete(a), this.Ox_.delete(a), this.mp1.delete(a)
      }
    }
    for (const p of t) {
      var i = p.qb_,
      ...
      for (const u of new Set(Array.from(Object.keys(i).concat(Object.keys(s)).concat(Object.keys(o))))) {
        var n = Number(u),
          l = !!o[n] ? 5 : i[n],
          h = this.vLl(p.r6n, n);
        void 0 !== l && this.cWl.set(h, l), void 0 !== s[n] && this.Ox_.set(h, s[n]), void 0 !== o[n] ? this.mp1.set(h, o[n]) : this.mp1.delete(h)
      }
    }
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.LevelPlayStateDetailUpdate)
  }
  GetLevelPlayHideReason(e, t) {
    e = this.vLl(e, t), t = this.mp1.get(e);
    if (void 0 !== t) return ModelManager_1.ModelManager.MapModel.ParseHideReason(t)
  }
  ...
  IsCommonLevelPlayComplete(e, t) {
    var r = this.vLl(e, t);
    return 3 === (this.cWl.get(r) ?? 0) || !((this.Ox_.get(r) ?? 0) <= 0) && 1 === ConfigManager_1.ConfigManager.MapConfig.GetMapMarkByRelativeId(t, e)?.HistoryState
  }
  ...
  IsCommonLevelPlayDiscover(e, t) {
    return !!this.IsCommonLevelPlayComplete(e, t) || (e = this.vLl(e, t), 0 < (this.cWl.get(e) ?? 0))
  }
  ...
  UpdateDetailReportMsg(e, t, r) {
    var a = this.vLl(e, t);
    this.fLl.set(a, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.LevelPlayReportDetailUpdate, e, t)
  }
  GetVar(e, t, r) {
  ...
  IsLevelPlayReportComplete(e, t) {
    let r = 1;
    for (const a of ConfigManager_1.ConfigManager.LevelPlayReportConfig.GetLevelPlayReportConfig(t)?.Vars ?? []) this.GetVar(e, t, a) || (r = 0);
    return 1 === r
  }
  ...
  GetLevelPlayReportTarget(e, t) {
    ...
    for (const o of ConfigManager_1.ConfigManager.LevelPlayReportConfig.GetLevelPlayReportConfig(t)?.Vars ?? []) this.GetVar(e, t, o) ? r.States.push(1) : r.States.push(0);
    var a = ConfigManager_1.ConfigManager.WorldMapConfig.GetPunishReportConfig(t),
      ...
      i = (r.ConditionTxtIds.push(i), r.ConditionTxtIds.push(s), r.ConditionTxtIds.push(a), this.GetSimpleReportMsg(e, t));
