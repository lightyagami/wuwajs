...
class JoinTeamView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Vfi = void 0, this.Hfi = !1, this.jfi = () => {
      ...
      JoinTeamController_1.JoinTeamController.CloseJoinTeamView(), e && RoleController_1.RoleController.OpenRoleMainView(0, e.GetRoleId())
    }, this.Vgt = () => {
  ...
  OnStart(e = !1) {
    this.Hfi = e, this.GetTexture(1)?.SetUIActive(!1), this.GetButton(4)?.RootUIComp.SetUIActive(!e), this.Kfi(), this.Ore()
  }
  OnBeforeDestroy() {
  ...
  Kfi() {
    var e, i, t, r, s = ModelManager_1.ModelManager.JoinTeamModel.GetRoleDescriptionId();
    s && (e = (r = ConfigManager_1.ConfigManager.JoinTeamConfig).GetRoleNameId(s), i = r.GetRoleTexturePath(s), t = r.GetRoleElementId(s), r = r.GetRoleDescriptionId(s), this.Qfi(t), this.Xfi(i), this.$fi(e), this.Yfi(r), this.GetUiNiagara(2).ActivateSystem(!0), this.Jfi())
  }
  Qfi(e) {
