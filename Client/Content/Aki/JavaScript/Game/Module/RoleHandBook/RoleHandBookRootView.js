...
class RoleHandBookRootView extends RoleRootView_1.RoleRootView {
  ...
  OnHandleLoadScene() {
    ...
    this.RoleRootUiCameraHandleData = UiCameraAnimationManager_1.UiCameraAnimationManager.PushCameraHandleByHandleName(e, !1, !1)
  }
  OnHandleReleaseScene() {
    UiCameraAnimationManager_1.UiCameraAnimationManager.PopCameraHandle(this.RoleRootUiCameraHandleData)
  }
  OnBeforeCreate() {
    this.qlo = this.OpenParam, this.Glo = "RoleHandBookSelectionView" !== this.qlo
  }
  InitRoleIdList() {
  ...
  OnStart() {
    this.InitTabComponent(), this.GetButton(1).GetRootComponent().SetUIActive(!1), this.GetItem(3).SetUIActive(!1), this.Glo && this.UpdateSelectRoleInstance(), this.TabComponent.SelectToggleByIndex(0, !0), this.LoadFloorEffect()
  }
  LoadFloorEffect() {
