...
class RoleHandBookPreviewView extends RolePreviewDescribeTabView_1.RolePreviewDescribeTabView {
  SetCharacterVoiceInfo() {
    ...
    this.CharacterVoiceTitleText.SetUIActive(!0), this.CharacterVoiceNameText.SetUIActive(!0), LguiUtil_1.LguiUtil.SetLocalText(this.CharacterVoiceTitleText, "CharacterVoice"), this.CharacterVoiceNameText.ShowTextNew(e.CharacterVoice)
  }
  SetAttributeInfo() {
    ...
    this.AttributeIconTexture.SetUIActive(!0), this.AttributeText.SetUIActive(!0), this.SetTextureByPath(e.Icon, this.AttributeIconTexture), this.AttributeText.ShowTextNew(e.Name)
  }
}
