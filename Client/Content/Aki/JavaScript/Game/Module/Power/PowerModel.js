...
class PowerModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.VXs = new Map, this.CurrentNeedPower = 0, this.PowerItemKeyArray = new Array(ItemDefines_1.EItemId.Power, ItemDefines_1.EItemId.OverPower), this.HXs = new Map, this.roo = void 0, this.v_l = !0, this.InnerConfirmBoxData = void 0
  }
  get PowerItemInfoList() {
    if (void 0 === this.roo) {
      ...
      for (const h of r) {
        ...
        o.ItemName = h.Name, o.IsHideWhenZero = Boolean(e.get(o.ItemId)), this.roo.push(o)
      }
    ...
    for (const I of this.roo) {
      var n, i = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(I.ItemId),
        i = (I.StackValue = i || 0, this.Eoo(I.ShopId)),
        s = (-1 === i.findIndex((e, r, t) => !e.IsSoldOut() && e.Price.has(I.ItemId)) && (n = i[i.length - 1], I.RenewValue = I.ItemId === ItemDefines_1.EItemId.OverPower ? 0 : n.StackSize ?? 0, I.CostValue = n.GetPrice(I.ItemId), I.GoodsId = n.Id, I.RemainCount = I.ItemId === ItemDefines_1.EItemId.OverPower ? I.StackValue : 0), n = i.findIndex((e, r, t) => e.IsUnlocked() && !e.IsSoldOut() && e.Price.has(I.ItemId)), i[n]);
      s && (I.RenewValue = I.ItemId === ItemDefines_1.EItemId.OverPower ? 0 : s.StackSize ?? 0, I.CostValue = s.GetPrice(I.ItemId), I.GoodsId = s.Id, s = s.BuyLimit < 0 ? s.BuyLimit : i.length - n, I.RemainCount = s)
    }
    return this.roo
  }
  GetPowerItemInfos(e) {
    for (const r of this.PowerItemInfoList)
      if (r.ItemId === e) return r
  }
  ...
  OnInit() {
    return this.VXs.set(10800, ItemDefines_1.EItemId.Power), this.VXs.set(ItemDefines_1.EItemId.OverPower, ItemDefines_1.EItemId.OverPower), this.v_l = !0
  }
  OnClear() {
    return !(this.v_l = !1)
  }
  ...
  UpdatePowerData(e) {
    if (e) {
      Log_1.Log.CheckInfo() && Log_1.Log.Info("PowerModule", 27, "当前体力数据", ["data", e]);
  ...
  GetPowerDataById(e) {
    ...
    return t || (t = new(e === ItemDefines_1.EItemId.OverPower ? PowerData_1.OverPowerData : PowerData_1.PowerData), this.HXs.set(r, t)), t
  }
  ...
  Eoo(e) {
    ...
    return e && 0 !== e.length ? (e.sort((e, r) => e.Id - r.Id), e) : (Log_1.Log.CheckError() && Log_1.Log.Error("PowerModule", 49, "体力系统获取商店数据失败"), [])
  }
  IsPowerEnough(e) {
