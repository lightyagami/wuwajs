...
class PowerCurrencyItem extends CommonCurrencyItem_1.CommonCurrencyItem {
  constructor() {
    super(...arguments), this.JXs = 0, this.zXs = e => {
      var t, r, n;
      this.JXs === e && (t = (e = ModelManager_1.ModelManager.PowerModel.GetPowerDataById(e)).GetCurrentPower(), r = e.GetPowerLimit(), n = e.GetPowerCurrencyShowTextId(), this.SetCountTextNew(n, t, r), n = e.IfNeedShowMax() && r <= t, this.RefreshMaxItem(n))
    }
  }
  OnStart() {
