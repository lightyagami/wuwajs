...
class InfluenceReputationController extends UiControllerBase_1.UiControllerBase {
  ...
  static RequestInfluenceReward(e) {
    ...
    t.y9n = e, Net_1.Net.Call(26479, t, e => {
      e.Cvs !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 21298) : ModelManager_1.ModelManager.InfluenceReputationModel.UpdateInfluenceRewardIndex(e.y9n, e.I9n) && (InfluenceReputationController.Wni(e.gws), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ReceiveReputationReward))
    })
  }
  static Wni(e) {
    var t = [];
...
}, InfluenceReputationController.iVe = e => ModelManager_1.ModelManager.FunctionModel.IsOpen(10029);
