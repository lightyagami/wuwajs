...
class InfluenceReputationController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(18821, InfluenceReputationController.jni);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(18821);
  }
  static RequestInfluenceReward(e) {
    var t = Protocol_1.Aki.Protocol.wos.create();
    t.y9n = e;
    Net_1.Net.Call(25754, t, e => {
      if (e.Cvs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 18380);
