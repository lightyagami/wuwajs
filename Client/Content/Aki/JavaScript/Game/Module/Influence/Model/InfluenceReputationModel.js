...
class InfluenceReputationModel extends ModelBase_1.ModelBase {
  ...
  SetInfluenceInfoList(e) {
    for (const t of e) {
      ...
      n ? (n.SetRelation(t.Cws), n.SetReceiveReward(t.I9n)) : this.Xni.set(t.y9n, new InfluenceInstance_1.InfluenceInstance(t.y9n, t.I9n, t.Cws)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RedDotInfluence, t.y9n)
    }
  }
  UpdateInfluenceRewardIndex(e, n) {
    var t = this.Xni.get(e);
    return t ? (t.SetReceiveReward(n), !0) : (Log_1.Log.CheckError() && Log_1.Log.Error("InfluenceReputation", 10, "奖励获取有问题,当前客户端没有该势力数据", ["Id", e]), !1)
  }
  ...
  GetCanReceiveReward(e) {
    if (e !== InfluenceReputationDefine_1.RAMDOM_INFLUENCE_ID) {
      var n = ConfigManager_1.ConfigManager.InfluenceConfig.GetInfluenceConfig(e),
        e = ModelManager_1.ModelManager.InfluenceReputationModel.GetInfluenceInstance(e);
      if (e) return n.ReputationReward.length === e.RewardIndex + 1 ? {
        IsAllReceived: !0,
  ...
  FilterUnLockInfluence(t, r) {
    ...
    for (let e = 0, n = t.length; e < n; ++e) {
      var a, i, u = t[e];
      u !== InfluenceReputationDefine_1.RAMDOM_INFLUENCE_ID && this.Xni.has(u) && (a = ConfigManager_1.ConfigManager.InfluenceConfig.GetInfluenceTitle(u), i = new RegExp(r, "i"), a.search(i) < 0 || o.push(u))
    }
    return o
  }
  FilterUnLockInfluenceList(e, n) {
    ...
    for (const o of e) o !== InfluenceReputationDefine_1.RAMDOM_COUNTRY_ID && (t = ConfigManager_1.ConfigManager.InfluenceConfig.GetCountryConfig(o), t = this.FilterUnLockInfluence(t.Influences, n), r.InfluenceList.push([o, t]), r.HasResult = r.HasResult || 0 < t.length);
    return r
  }
  ...
  HasRedDotExcludeCurrentCountry(e) {
    for (const n of this.$ni)
      if (n !== e)
        if (this.HasRedDotInCurrentCountry(n)) return !0;
    return !1
  }
