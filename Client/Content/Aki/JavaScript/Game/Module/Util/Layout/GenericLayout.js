...
class GenericLayout {
  constructor(t, i, s = void 0, e = !1, r = !0) {
    this.eGe = void 0, this.uGo = void 0, this.cGo = void 0, this.AnimControllerComponent = void 0, this.mGo = [], this.dGo = [], this.CGo = [], this.gGo = new Map, this.fGo = void 0, this.gWt = new Queue_1.Queue, this.pjt = !1, this.IsRefreshAsync = !1, this.IsGridShowWhenCreate = !0, this.pGo = () => {
      this.UnBindLateUpdate()
    }, this.IsRefreshAsync = e, this.IsGridShowWhenCreate = r, this.eGe = t, this.eGe.GetOwner().OnDestroyed.Add(this.pGo), this.fGo = s || t.RootUIComp.GetAttachUIChild(0)?.GetOwner(), this.fGo && (this.fGo.GetUIItem().SetUIActive(!1), this.uGo = new ScrollViewDelegate_1.ScrollViewDelegate(i), this.cGo = new InTurnGridAppearAnimation_1.InTurnGridAppearAnimation(this), this.cGo.RegisterAnimController())
  }
  get Rjt() {
    return this.pjt
  }
  ...
  Jft() {
    var t;
    this.pjt = !1, this.gWt.Empty || (t = this.gWt.Pop(), this.RefreshByData(t.Data, t.CallBack, t.PlayGridAnim))
  }
  GetRootUiItem() {
  ...
  ClearChildren() {
    ...
    this.mGo.length = 0, this.dGo.length = 0, this.CGo.length = 0, this.gGo.clear()
  }
  async LoadGrid(i, s = !0) {
    var e = [];
    for (let t = this.mGo.length; t < i; t++) {
      var r = this.V2e();
      e.push(this.uGo.CreateGridProxyAsync(t, r.GetOwner(), s)), this.mGo.push(r)
    }
    await Promise.all(e)
  }
  async RefreshByDataDirectly(t) {
    ...
    for (let t = this.dGo.length; t < i; t++) {
      var s = this.mGo[t];
      s.SetUIActive(!0), this.dGo.push(s), this.CGo.push(this.uGo.GetGridProxy(t))
    }
    return this.IsRefreshAsync ? await this.F6_() : this.N6_(), !0
  }
  RefreshByData(t, i, s = !1) {
    var e;
    this.Rjt ? (e = new OperationParam(t, i, s), this.gWt.Push(e)) : (this.Ujt(), this.RefreshByDataAsync(t, s).finally(() => {
      i?.(), this.Jft()
    }))
  }
  async RefreshByDataAsync(t, i = !1, s = t.length) {
    await this.MGo(t, s), i && this.cGo && this.cGo.PlayGridAnim(this.GetDisplayGridNum())
  }
  ...
  async MGo(t, i) {
    var s = i,
      e = (this.uGo.SetData(t), this.uGo.ClearSelectInfo(), this.gGo.clear(), this.dGo.length);
    if (s <= e) {
      for (let t = s; t < e; t++) this.mGo[t].SetUIActive(!1);
      this.dGo.length = s, this.CGo.length = s, this.IsRefreshAsync ? await this.F6_() : this.N6_()
    } else if (this.mGo.length >= s) {
      for (let t = e; t < s; t++) {
        var r = this.mGo[t];
        r.SetUIActive(!0), this.dGo.push(r), this.CGo.push(this.uGo.GetGridProxy(t))
      }
      ...
      for (let t = e; t < h; t++) {
        var a = this.mGo[t];
        a.SetUIActive(!0), this.dGo.push(a), this.CGo.push(this.uGo.GetGridProxy(t))
      }
      this.IsRefreshAsync ? await this.F6_() : this.N6_(), await this.LoadGrid(s, this.IsGridShowWhenCreate);
      var n = this.IsRefreshAsync ? [] : void 0;
      for (let t = h; t < this.mGo.length; t++) {
        var o = this.mGo[t];
        o.SetUIActive(!0), this.dGo.push(o), this.CGo.push(this.uGo.GetGridProxy(t)), this.IsRefreshAsync ? n.push(this.j6_(t)) : this.V6_(t)
      }
  ...
  SelectGridProxyByKey(t, i = !1) {
    t = this.GetGridIndexByKey(t);
    void 0 !== t && this.SelectGridProxy(t, i)
  }
  ...
  GetUiAnimController() {
    return this.AnimControllerComponent || (this.AnimControllerComponent = this.eGe?.GetOwner().GetComponentByClass(UE.UIInturnAnimController.StaticClass())), this.AnimControllerComponent
  }
  PlayGridAnim() {
    this.cGo && this.cGo.PlayGridAnim(this.GetDisplayGridNum())
  }
}
