...
class SimpleGenericLayout {
  constructor(t) {
    this.Layout = void 0, this.BGo = void 0, this.x5e = [], this.bGo = 0;
    t = (this.Layout = t).RootUIComp.GetAttachUIChild(0);
    t && t.IsValid() ? (this.BGo = t, this.x5e.push(this.BGo)) : Log_1.Log.CheckError() && Log_1.Log.Error("UiCommon", 43, "Layout下不存在有效的子节点")
  }
  RebuildLayout(t) {
    this.BGo && this.BGo.IsValid() || Log_1.Log.CheckError() && Log_1.Log.Error("UiCommon", 43, "Layout下不存在有效的子节点"), this.bGo = t;
    ...
    for (let t = this.bGo; t < this.x5e.length; t++) this.x5e[t].SetUIActive(!1)
  }
  GetDisplayCount() {
    return this.bGo
  }
