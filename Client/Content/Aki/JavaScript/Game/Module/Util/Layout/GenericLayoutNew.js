...
class GenericLayoutNew {
  constructor(t, i, e = void 0) {
    this.cGo = void 0, this.Kqo = void 0, this.xqe = void 0, this.SGo = [], this.yGo = [], this.bxo = void 0, this.AQ = new Map, this.x5e = new Array, this.Qqo = void 0, this.IGo = 0, this.vK = !1, this.TGo = void 0, this.P7t = !0, this.LGo = !0, this.Kqo = t, this.Qqo = i, this.DGo(e), this.cGo = new InTurnGridAppearAnimation_1.InTurnGridAppearAnimation(this), this.cGo.RegisterAnimController()
  }
  get TempOriginalItem() {
    return this.bxo
  }
  RGo() {
    for (const t of this.AQ.values()) t instanceof UiComponentsAction_1.UiComponentsAction && t?.Destroy();
    this.AQ.clear(), this.x5e = []
  }
  DGo(i) {
    if (!this.bxo) {
      let t = void 0;
      (t = void 0 === i ? this.GetItemByIndex(0) : i).SetUIActive(!1), t.SetUIParent(this.UGo()), this.bxo = t, this.TGo = t.displayName
    }
  }
  SetScrollView(t) {
  ...
  wGo() {
    this.bxo && (this.bxo.SetUIActive(!0), this.bxo.SetUIParent(this.GetRootUiItem()), this.bxo = void 0)
  }
  ht() {
    for (let t = 0, i = this.yGo.length; t < i; ++t) this.yGo[t].GetOwner().K2_DestroyActor();
    for (let t = 0, i = this.SGo.length; t < i; ++t) this.SGo[t].GetOwner().K2_DestroyActor();
  ...
  ClearChildren() {
    this.vK || (this.vK = !0, this.Kqo.OnLateUpdate.Unbind(), this.RGo(), this.ht(), this.wGo())
  }
  SetActive(t) {
  ...
  GetUiAnimController() {
    return this.LGo ? this.Kqo?.GetOwner().GetComponentByClass(UE.UIInturnAnimController.StaticClass()) : (this.xqe?.GetContent())?.GetComponentByClass(UE.UIInturnAnimController.StaticClass())
  }
}
