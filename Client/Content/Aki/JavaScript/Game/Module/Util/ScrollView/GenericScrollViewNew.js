...
class GenericScrollViewNew {
  constructor(t, e, i = void 0, r = !1) {
    this.cNo = void 0, this.Sui = void 0, this.cNo = t, this.Sui = new GenericLayout_1.GenericLayout(this.cNo.GetContent().GetComponentByClass(UE.UILayoutBase.StaticClass()), e, i, r), this.Sui.AnimControllerComponent = t?.GetOwner().GetComponentByClass(UE.UIInturnAnimController.StaticClass())
  }
  get IsExpand() {
  ...
  IsItemInViewport(t, e) {
    var i = (0, puerts_1.$ref)(3),
      r = (0, puerts_1.$ref)(3);
    return this.cNo.GetOutOfBottomBoundsType(t, i, r, e), this.cNo.Vertical ? (0, puerts_1.$unref)(i) : (0, puerts_1.$unref)(r)
  }
}
