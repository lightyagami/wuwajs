...
exports.GenericScrollView = undefined;
...
class GenericScrollView {
  constructor(t, e, i = undefined) {
    ...
    this.Sui = undefined;
    this.cNo = t;
    this.Sui = new GenericLayoutNew_1.GenericLayoutNew(this.cNo.GetContent().GetComponentByClass(UE.UILayoutBase.StaticClass()), e, i);
