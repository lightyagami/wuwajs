...
class GenericScrollView {
  constructor(t, e, i = void 0) {
    this.cNo = void 0, this.Sui = void 0, this.cNo = t, this.Sui = new GenericLayoutNew_1.GenericLayoutNew(this.cNo.GetContent().GetComponentByClass(UE.UILayoutBase.StaticClass()), e, i), this.Sui.SetScrollView(t)
  }
  get TempOriginalItem() {
    return this.Sui?.TempOriginalItem
  }
  get IsExpand() {
    return this.cNo.Horizontal ? this.cNo.RootUIComp.Width < this.cNo.ContentUIItem.Width : this.cNo.RootUIComp.Height < this.cNo.ContentUIItem.Height
  }
  get ContentItem() {
  ...
  ScrollToLeft(t) {
    ...
    this.cNo.ScrollToLeft((0, puerts_1.$ref)(new UE.Vector2D(this.cNo.ContentUIItem.RelativeLocation)), t.GetRootItem())
  }
  ScrollToRight(t) {
    t = this.Sui.GetLayoutItemByKey(t);
    this.cNo.ScrollToRight((0, puerts_1.$ref)(new UE.Vector2D(this.cNo.ContentUIItem.RelativeLocation)), t.GetRootItem())
  }
  ScrollToTop(t) {
    t = this.Sui.GetLayoutItemByKey(t);
    this.cNo.ScrollToTop((0, puerts_1.$ref)(new UE.Vector2D(this.cNo.ContentUIItem.RelativeLocation)), t.GetRootItem())
  }
  ScrollToBottom(t) {
    t = this.Sui.GetLayoutItemByKey(t);
    this.cNo.ScrollToBottom((0, puerts_1.$ref)(new UE.Vector2D(this.cNo.ContentUIItem.RelativeLocation)), t.GetRootItem())
  }
  SetActive(t) {
