...
class UiComponentUtil {
  static SetStarActiveNew(o, e, t = void 0, i = !0) {
    ...
    for (let t = 0; t < r; ++t) {
      var u = o[t];
      u.SetActive(t + 1 <= n), t + 1 > n || (u.SetImgStarOnActive(t < e), i ? (u.SetImgStarNextActive(t === e), t === e && (l = u), u.SetImgStarOffActive(t > e)) : (u.SetImgStarNextActive(!1), u.SetImgStarOffActive(t >= e), t === e - 1 && (l = u)))
    }
    return l
  }
  static SetMoneyState(t, o, e, i) {
    ...
    e = e <= i;
    return o.SetText(i.toString()), o.SetChangeColor(e, o.changeColor), t.useChangeColor = !e, e
  }
  static BindAudioEvent(e) {
    e instanceof UE.UIButtonComponent ? e.OnPostAudioStateEvent.Bind((t, o) => {
      AudioController_1.AudioController.PostSelectableAudioEvent(o, e.GetOwner())
    }) : e instanceof UE.UIExtendToggle && e.OnPostAudioStateEvent.Bind((t, o) => {
      AudioController_1.AudioController.PostSelectableAudioEvent(o, e.GetOwner())
    })
  }
