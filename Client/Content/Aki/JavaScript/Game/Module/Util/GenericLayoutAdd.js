...
class GenericLayoutAdd {
  constructor(t, e) {
    this.Kqo = void 0, this.Qqo = void 0, this.Xqo = new Map, this.$qo = [], this.AQ = new Map, this.Kqo = t, this.Qqo = e, this.Yqo()
  }
  Yqo() {
    if (this.Kqo) {
  ...
  AddItemToLayout(r, o = 0) {
    ...
    if (s) {
      ...
      s.SetUIActive(!1)
    } else Log_1.Log.CheckError() && Log_1.Log.Error("ModuleUtil", 10, "查找不到对应HierarchyIndex的UIItem")
  }
  ...
  ClearChildren() {
    ...
    this.AQ.clear();
    for (const i of this.$qo) ActorSystem_1.ActorSystem.Put("GenericLayoutAdd.ClearChildren", i.GetOwner());
    this.$qo.length = 0
  }
}
