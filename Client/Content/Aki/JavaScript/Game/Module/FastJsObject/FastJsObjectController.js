...
class FastJsObjectController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return Cpp.FKuroFastJsObjectCommon.RegisterFastJsObjectCommonInfo("Tuple", "X", "Y", "Z", "Pitch", "Yaw", "Roll"), Cpp.FFastMoveReplaySample.RegisterMoveReplaySampleInfo("KVn", "Proto_ControllerPitch", "rSs"), !0
  }
}
