...
class FunctionOpenView extends UiViewBase_1.UiViewBase {
  ...
  OnStart() {
    ModelManager_1.ModelManager.PlotModel.IsInHighLevelPlot() && this.RootItem.SetUIActive(!1);
    var e = ModelManager_1.ModelManager.FunctionModel.PopNewOpenFunctionList();
    this.nOe(e)
  }
  OnAfterShow() {
  ...
  nOe(e) {
    ...
    this.SetTextureByPath(e.Icon, i), this.GetText(1).ShowTextNew(e.Title), this.GetText(2).ShowTextNew(e.Desc)
  }
  OnBeforeShow() {
