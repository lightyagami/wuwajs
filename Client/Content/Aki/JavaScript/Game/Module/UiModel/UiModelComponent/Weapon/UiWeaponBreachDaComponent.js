...
var __decorate = this && this.__decorate || function(e, t, i, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, i, n);
    ...
    for (var a = e.length - 1; 0 <= a; a--)(o = e[a]) && (s = (r < 3 ? o(s) : 3 < r ? o(t, i, s) : o(t, i)) || s);
...
let UiWeaponBreachDaComponent = class UiWeaponBreachDaComponent extends UiModelComponentBase_1.UiModelComponentBase {
  constructor() {
    super(...arguments), this.ywr = void 0, this.n$t = void 0, this.UBr = void 0, this.KY = () => {
  ...
  OnInit() {
    this.ywr = this.Owner.CheckGetComponent(0), this.n$t = this.Owner.CheckGetComponent(1), this.UBr = this.Owner.CheckGetComponent(22)
  }
  OnStart() {
  ...
  RefreshWeaponBreachDa(i, e) {
    ModelManager_1.ModelManager.WeaponModel.BlueprintWeaponBreachLevel = i, ModelManager_1.ModelManager.WeaponModel.BlueprintWeaponEquippedRoleId = e;
    const n = this.ywr.ModelConfigId;
    e = ModelUtil_1.ModelUtil.GetModelConfig(n)?.DA?.AssetPathName.toString();
    e && !StringUtils_1.StringUtils.IsBlank(e) && ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.Object, e => {
      var t;
      e && n === this.ywr.ModelConfigId && (t = this.n$t?.MainMeshComponent, e instanceof UE.PD_WeaponLevelMaterialDatas_C) && UE.BP_CharacterRenderingFunctionLibrary_C.ApplyWeaponLevelMaterial(t, e, i, t)
    })
  }
};
UiWeaponBreachDaComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(23)], UiWeaponBreachDaComponent), exports.UiWeaponBreachDaComponent = UiWeaponBreachDaComponent;
