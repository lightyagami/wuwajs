...
var __decorate = this && this.__decorate || function(e, o, t, n) {
  var i, s = arguments.length,
    d = s < 3 ? o : null === n ? n = Object.getOwnPropertyDescriptor(o, t) : n;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) d = Reflect.decorate(e, o, t, n);
  else
    for (var r = e.length - 1; 0 <= r; r--)(i = e[r]) && (d = (s < 3 ? i(d) : 3 < s ? i(o, t, d) : i(o, t)) || d);
...
let UiAbyssDangoLoadComponent = class UiAbyssDangoLoadComponent extends UiModelLoadComponent_1.UiModelLoadComponent {
  ...
  LoadModelByDangoId(e, o, t, n) {
    this.Rpc.DangoId = e, this.UiModelDataComponent.ModelConfigId = o, this.LoadFinishCallBack = n, this.LoadModel(t, void 0, 1)
  }
};
UiAbyssDangoLoadComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(28)], UiAbyssDangoLoadComponent), exports.UiAbyssDangoLoadComponent = UiAbyssDangoLoadComponent;
