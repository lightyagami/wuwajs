...
const UE = require("ue"),
  ...
  SELECT_MATERIAL_PATH = "/Game/Aki/Character/NPC/Tuanzi/HYtuanzi_jinxi/Model/MI_Tuanzi_Stroke_90001.MI_Tuanzi_Stroke_90001";
let UiDangoMaterialChangeComponent = class UiDangoMaterialChangeComponent extends UiModelComponentBase_1.UiModelComponentBase {
  constructor() {
    super(...arguments), this.UiModelActorComponent = void 0, this.MDc = void 0, this.EDc = new Map, this.IDc = [new UE.FName("OL_Hair"), new UE.FName("OL_Face"), new UE.FName("OL_Item")], this.Fwr = () => {
      this.TDc()
    }
  }
  OnInit() {
    this.UiModelActorComponent = this.Owner.CheckGetComponent(1), ResourceSystem_1.ResourceSystem.LoadAsync(SELECT_MATERIAL_PATH, ue_1.MaterialInstance, e => {
      e && e.IsValid() && (this.MDc = e)
    })
  }
  OnStart() {
  ...
  TDc() {
    ...
    for (const i of this.IDc) {
      var t, n = e.GetMaterialIndex(i);
      n < 0 || (t = e.GetMaterial(n)) && this.EDc.set(n, t)
    }
  }
  ReplaceSelectMaterial(e) {
    var t = this.UiModelActorComponent.CharRenderingComponent;
    e ? t.SetMaterialReplaceV2(this.MDc, 0, 3, 17) : t.RemoveExternalMaterialReplaceV2(0, 3, 17)
  }
};
UiDangoMaterialChangeComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(30)], UiDangoMaterialChangeComponent), exports.UiDangoMaterialChangeComponent = UiDangoMaterialChangeComponent;
