...
var __decorate = this && this.__decorate || function(e, t, i, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, t, i, o);
    ...
    for (var n = e.length - 1; 0 <= n; n--)(f = e[n]) && (r = (s < 3 ? f(r) : 3 < s ? f(t, i, r) : f(t, i)) || r);
...
let UiModelBuffComponent = class UiModelBuffComponent extends UiModelComponentBase_1.UiModelComponentBase {
  ...
  PlayEffectByCueConfig(e) {
    var t = this.CacheEffectContext,
      i = (t.Reset(), t.EffectPath = e.Path, t.AttachTargetComponent = this.n$t.MainMeshComponent, t.LocationRule = e.LocRule, t.RotationRule = e.RotaRule, t.ScaleRule = e.SclRule, e.Location),
      i = (this.CacheLocation.Set(i.X, i.Y, i.Z), this.CacheTransform.SetLocation(this.CacheLocation), e.Rotation),
      i = (this.CacheRotator.Set(i.X, i.Y, i.Z), this.CacheTransform.SetRotation(this.CacheRotator.Quaternion()), e.Scale);
    return this.CacheScale.Set(i.X, i.Y, i.Z), this.CacheTransform.SetScale3D(this.CacheScale), t.Transform = this.CacheTransform.ToUeTransform(), t.SocketName = FNameUtil_1.FNameUtil.GetDynamicFName(e.Socket) ?? FNameUtil_1.FNameUtil.EMPTY, this.D_r.PlayEffectByContext(t)
  }
  RemoveBuffByBuffId(e) {
    e = this.BuffToEffectsMap.get(e);
    if (e)
      for (const t of e) this.D_r.StopEffect(t)
  }
  RemoveAllBuffId() {
...
UiModelBuffComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(11)], UiModelBuffComponent), exports.UiModelBuffComponent = UiModelBuffComponent;
