...
var __decorate = this && this.__decorate || function(e, t, n, i) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, t, n, i);
    ...
    for (var h = e.length - 1; 0 <= h; h--)(o = e[h]) && (r = (s < 3 ? o(r) : 3 < s ? o(t, n, r) : o(t, n)) || r);
...
let UiModelTagComponent = class UiModelTagComponent extends UiModelComponentBase_1.UiModelComponentBase {
  constructor() {
    super(...arguments), this.Xte = new UiTagComponent_1.UiTagComponent, this.Jwr = void 0, this.OnAnsBegin = e => {
  ...
  OnStart() {
    this.Jwr?.RegisterAnsTrigger("UiTagAnsContext", this.OnAnsBegin, this.OnAnsEnd), this.Xte.AddListener(348713373, this.hBr), this.Xte.AddListener(-1371920538, this.lBr)
  }
  OnEnd() {
    this.Xte.RemoveListener(348713373, this.hBr), this.Xte.RemoveListener(-1371920538, this.lBr)
  }
  OnClear() {
...
UiModelTagComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(7)], UiModelTagComponent), exports.UiModelTagComponent = UiModelTagComponent;
