...
let UiRoleEyeHighLightComponent = class UiRoleEyeHighLightComponent extends UiModelComponentBase_1.UiModelComponentBase {
  constructor() {
    super(...arguments), this.n$t = void 0, this.OnRoleMeshLoadComplete = () => {
  ...
  cBr(e, t, i) {
    for (const s of t) {
      var n, o = e.GetMaterialIndex(s);
      o < 0 || (n = e.GetMaterial(o), e.CreateDynamicMaterialInstance(o, n)?.SetScalarParameterValue(i, 0))
    }
  }
};
UiRoleEyeHighLightComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(19)], UiRoleEyeHighLightComponent), exports.UiRoleEyeHighLightComponent = UiRoleEyeHighLightComponent;
