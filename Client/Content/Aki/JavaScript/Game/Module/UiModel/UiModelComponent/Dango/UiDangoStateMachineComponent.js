...
var __decorate = this && this.__decorate || function(e, t, i, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) h = Reflect.decorate(e, t, i, n);
    ...
    for (var a = e.length - 1; 0 <= a; a--)(o = e[a]) && (h = (s < 3 ? o(h) : 3 < s ? o(t, i, h) : o(t, i)) || h);
...
let UiDangoStateMachineComponent = class UiDangoStateMachineComponent extends UiModelComponentBase_1.UiModelComponentBase {
  constructor() {
    super(...arguments), this.k01 = 0, this.uS1 = 0, this.JD1 = 0, this.ywr = void 0, this.n$t = void 0, this.OnDangoMeshLoadComplete = () => {
      this.m8()
    }
  }
  OnInit() {
  ...
  SetState(e, t = 0, i = 0) {
    this.k01 = e, this.uS1 = t, this.JD1 = i, this.m8()
  }
  m8() {
    if (2 === this.ywr.GetModelLoadState()) {
      ...
      switch (this.k01) {
        case 1:
          e?.StartActionPerform(this.uS1);
          break;
        case 2:
          e?.StartJumpWithParams(this.uS1, this.JD1)
      }
    }
  }
  GetDangoBp() {
...
UiDangoStateMachineComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(27)], UiDangoStateMachineComponent), exports.UiDangoStateMachineComponent = UiDangoStateMachineComponent;
