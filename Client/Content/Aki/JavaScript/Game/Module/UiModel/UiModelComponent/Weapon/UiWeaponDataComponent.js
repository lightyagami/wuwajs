...
var __decorate = this && this.__decorate || function(e, o, t, n) {
  var a, i = arguments.length,
    p = i < 3 ? o : null === n ? n = Object.getOwnPropertyDescriptor(o, t) : n;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) p = Reflect.decorate(e, o, t, n);
  else
    for (var r = e.length - 1; 0 <= r; r--)(a = e[r]) && (p = (i < 3 ? a(p) : 3 < i ? a(o, t, p) : a(o, t)) || p);
...
UiWeaponDataComponent = __decorate([(0, UiModelComponentDefine_1.RegisterUiModelComponent)(22)], UiWeaponDataComponent), exports.UiWeaponDataComponent = UiWeaponDataComponent;
