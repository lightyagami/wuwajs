...
class GachaShareTenPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.bWt = void 0, this.HWt = () => new GachaShareResultItem_1.GachaShareResultItem
  }
  async OnBeforeStartAsync() {
    ...
    e.sort((e, a) => {
      var r = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(e.e9n.L8n)?.QualityId ?? 0,
        t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(a.e9n.L8n)?.QualityId ?? 0;
      return r === t ? (e = n(ConfigManager_1.ConfigManager.GachaConfig.GetItemIdType(e.e9n.L8n)), n(ConfigManager_1.ConfigManager.GachaConfig.GetItemIdType(a.e9n.L8n)) - e) : t - r
