...
class GachaResultView extends GachaSceneView_1.GachaSceneView {
  constructor() {
    super(...arguments), this.wWt = !1, this.BWt = void 0, this.bWt = void 0, this.qWt = void 0, this.GWt = void 0, this.NWt = void 0, this.OWt = () => {
      if (ChannelController_1.ChannelController.CouldShare()) {
        ...
        if (1 === a.length) {
          ...
          e = 2 === ConfigManager_1.ConfigManager.GachaConfig.GetItemIdType(a[0].e9n.L8n) ? 4 : 3
        } else e = 5;
        ...
        Log_1.Log.CheckInfo() && Log_1.Log.Info("Gacha", 27, "刷新分享按钮", ["showShareReward", t]), this.GetItem(7).SetUIActive(t), t && (t = [...a.ShareReward][0], this.NWt?.SetItemInfo(t[0], t[1]))
      }
    }, this.kWt = () => {
      UiManager_1.UiManager.IsViewHide("GachaScanView") || UiManager_1.UiManager.IsViewHide("DrawMainView") ? Log_1.Log.CheckInfo() && Log_1.Log.Info("Gacha", 34, "点击过快，之前界面仍未关闭") : EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CloseGachaSceneView)
    }, this.FWt = () => {
      ChannelController_1.ChannelController.ShareGacha(ModelManager_1.ModelManager.GachaModel.CurGachaResult)
    }, this.VWt = (e, a) => {
      var e = e[0].ItemId,
        a = a[0].ItemId,
        t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(e)?.QualityId,
        r = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(a)?.QualityId;
      return t === r ? e - a : r - t
    }, this.HWt = () => new GachaResultItemNew_1.GachaResultItemNew, this.jWt = () => new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var e, a = ModelManager_1.ModelManager.GachaModel.CurGachaResult;
    a && 0 !== a.length && (this.qWt = new GenericLayout_1.GenericLayout(this.GetGridLayout(1), this.jWt), this.GWt = new GenericLayout_1.GenericLayout(this.GetGridLayout(3), this.jWt), this.NWt = new ShareRewardInfo_1.ShareRewardInfo, e = [this.NWt.OnlyCreateByActorAsync(this.GetItem(8).GetOwner())], 1 === a.length ? e.push(this.WWt(a[0])) : e.push(this.HandleMultiGacha(a)), await Promise.all(e), this.AddChild(this.NWt), this.GetButton(6)?.RootUIComp.SetUIActive(!1), this.GetItem(7)?.SetUIActive(!1))
  }
  OnBeforeShow() {
    BlackScreenController_1.BlackScreenController.RemoveBlackScreen("Close", "GachaSkip"), this.OWt()
  }
  OnAfterShow() {
  ...
  KWt(e) {
    e && 0 < e.length && !this.wWt ? (this.GetItem(0).SetUIActive(!0), this.qWt.RefreshByData(e)) : this.GetItem(0).SetUIActive(!1)
  }
  QWt(e) {
    e && 0 < e.length && !this.wWt ? (this.GetItem(2).SetUIActive(!0), this.GWt.RefreshByData(e)) : this.GetItem(2).SetUIActive(!1)
  }
  async HandleMultiGacha(e) {
    var a = new GachaMultipleResultItem_1.GachaMultipleResultItem,
      a = (await a.CreateThenShowByResourceIdAsync("UiItem_MultiGacha", this.GetItem(5)), a.GetGachaResultItemLayout()),
      t = (this.bWt = new GenericLayout_1.GenericLayout(a, this.HWt), new Map),
      r = new Map;
    for (const o of e) {
    ...
    a.sort((e, a) => {
      var t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(e.e9n.L8n)?.QualityId ?? 0,
        r = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(a.e9n.L8n)?.QualityId ?? 0;
      return t === r ? (e = n(ConfigManager_1.ConfigManager.GachaConfig.GetItemIdType(e.e9n.L8n)), n(ConfigManager_1.ConfigManager.GachaConfig.GetItemIdType(a.e9n.L8n)) - e) : r - t
  ...
  async WWt(e) {
    var a = await LguiUtil_1.LguiUtil.LoadPrefabByResourceIdAsync("UiItem_SingleGacha", this.GetItem(5)),
      a = (this.BWt = new GachaResultItemNew_1.GachaResultItemNew, await this.BWt.CreateThenShowByActorAsync(a), this.BWt.Update(e), new Map),
      t = new Map,
