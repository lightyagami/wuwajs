...
class GachaController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(28312, GachaController.OnGachaResultNotify);
    Net_1.Net.Register(23013, GachaController.OnGachaNewNotify);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(28312);
  ...
  static async GachaRequest(e, a) {
    ...
    var n;
    var r = await Net_1.Net.CallAsync(18613, r);
    if (r) {
      if (r.Q4n === Protocol_1.Aki.Protocol.Q4n.Proto_ErrGachaIsNotInOpenTime) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(r.Q4n, 24744);
      } else {
  ...
  static async GachaPoolDetailRequestAsync(e) {
    ...
    a.o9n = e;
    var e = await Net_1.Net.CallAsync(23806, a);
    if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 27301);
    }
    return e;
  }
  ...
  static GachaUsePoolRequest(a, r) {
    ...
    e.t9n = a;
    e.o9n = r;
    Net_1.Net.Call(20224, e, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 22764);
