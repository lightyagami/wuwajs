...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.GachaPoolDropItem = exports.GachaPoolDetailGrid = exports.GachaPoolDetailView = void 0;
const UE = require("ue"),
...
class GachaPoolDetailGrid extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    this.GetText(0).SetText(this.Data.TitleDescKey), this.GetText(3).SetText(this.Data.TitleTextKey);
    var i = [];
    for (const e of this.Data.ItemList) {
      var t = LguiUtil_1.LguiUtil.CopyItem(this.GetItem(2), this.GetItem(1)),
        a = new GachaPoolDropItem;
      a.Data = e, i.push(a.CreateByActorAsync(t.GetOwner())), this.AddChild(a)
    }
...
class GachaPoolDropItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    var i, t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.Data.L8n),
      a = this.Data.Sb_ ? "GachaDropItemUp" : "GachaPoolDropItemNormal";
    1 === t ? (i = ConfigManager_1.ConfigManager.GachaConfig.GetRoleInfoById(this.Data.L8n), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), a, MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.Name))) : 2 === t && (i = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponConfigByItemId(this.Data.L8n), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), a, MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.WeaponName)))
  }
}
