...
class GachaConfig extends ConfigBase_1.ConfigBase {
  ...
  GetTextIdByType(e) {
    ...
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Gacha", 8, "无法找到此奖品的文本Id", ["awardType", e]), TextById_1.configTextById.GetConfig(a).Text
  }
  ...
  GetRoleInfoById(e) {
    ...
    if (1 === a.GetItemDataTypeByConfigId(e)) return ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e);
  ...
  GetGachaViewType(e) {
    ...
    if (a) return a.Type;
    Log_1.Log.CheckError() && Log_1.Log.Error("Gacha", 43, "奖池界面信息配置为空", ["gachaPoolId", e])
  }
  GetGachaViewInfo(e) {
    var a = GachaViewInfoById_1.configGachaViewInfoById.GetConfig(e);
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Gacha", 43, "奖池界面信息配置为空", ["gachaPoolId", e]), a
  }
  GetGachaTextureInfo(e) {
    var a = GachaTextureInfoById_1.configGachaTextureInfoById.GetConfig(e);
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Gacha", 43, "抽卡贴图信息表没有配置", ["itemId", e]), a
  }
