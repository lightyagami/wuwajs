...
class ErrorCodeConfig extends ConfigBase_1.ConfigBase {
  ...
  GetConfigByCode(r) {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("ErrorCode", 8, "没有错误码配置", ["code", r]), e
  }
  GetTextByErrorId(r) {
    r = this.GetConfigByCode(r);
    return r ? StringUtils_1.StringUtils.IsEmpty(r.Text) ? ConfigManager_1.ConfigManager.TextConfig.GetTextById("UnknownErrorCodeText") : MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r.Text) ?? "" : ""
  }
  GetTextKeyByErrorId(r) {
    r = this.GetConfigByCode(r);
    return r ? StringUtils_1.StringUtils.IsEmpty(r.Text) ? ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("UnknownErrorCodeText") : r.Text : ""
  }
  IsTipsOnly(r) {
