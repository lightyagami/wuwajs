...
class TowerDetailModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentSelectDetailId = 0, this.TowerTitle = "", this.SwitchButtonIndex = 0, this.SwitchData = new Array, this.IQ = new Map, this.VLo = new Map
  }
  AddSwitchData(e, t) {
    var s = new TowerDetailData_1.TowerSwitchData;
    s.Index = e, s.Name = t, this.IQ.set(s, new Array), this.VLo.set(s, new Array), this.SwitchData.push(s)
  }
  AddBuff(t, e, s, r) {
    const a = new TowerDetailData_1.TowerDetailBuffData;
    a.Buffs = e, a.Title = s, a.Priority = r, this.SwitchData.forEach(e => {
  ...
  AddMonster(t, e, s, r) {
    ...
    a.Title = s, a.MonsterInfos = e, a.Priority = r, this.SwitchData.forEach(e => {
  ...
  Reset() {
    this.IQ = new Map, this.VLo = new Map, this.SwitchData = new Array
  }
}
