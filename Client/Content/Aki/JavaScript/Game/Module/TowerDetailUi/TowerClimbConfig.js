...
exports.TowerClimbConfig = undefined;
...
class TowerClimbConfig extends ConfigBase_1.ConfigBase {
  GetAreaFloorNumber(e, r, o) {
    let t = 0;
    for (const f of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) {
      if (f.Difficulty === r && f.AreaNum === o) {
        t++;
      }
    }
    return t;
  ...
  GetDifficultyFloorNumber(e, r) {
    let o = 0;
    for (const t of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) {
      if (t.Difficulty === r) {
        o++;
      }
    }
  ...
  GetNextFloorInArea(e) {
    ...
    for (const o of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r.Season)) {
      if (o.Difficulty === r.Difficulty && o.AreaNum === r.AreaNum && o.Floor > r.Floor) {
        return o.Id;
      }
    }
    return 0;
  ...
  GetLastFloorInArea(e) {
    ...
    let o = 0;
    for (const t of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r.Season)) {
      if (t.Difficulty === r.Difficulty && t.AreaNum === r.AreaNum && t.Floor < r.Floor) {
        o = t.Id;
      }
    }
    return o;
