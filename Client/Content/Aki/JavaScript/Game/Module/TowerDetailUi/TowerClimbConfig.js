...
class TowerClimbConfig extends ConfigBase_1.ConfigBase {
  GetAreaFloorNumber(e, r, o) {
    let t = 0;
    for (const f of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) f.Difficulty === r && f.AreaNum === o && t++;
    return t
  }
  GetDifficultyFloorNumber(e, r) {
    let o = 0;
    for (const t of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) t.Difficulty === r && o++;
    return o
  }
  GetDifficultyLastFloor(e, r) {
    let o = -1,
      t = -1,
      f = -1;
    for (const i of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) i.Difficulty === r && (o < i.AreaNum && (o = i.AreaNum, t = -1), t < i.Floor) && (f = i.Id);
    return f
  }
  GetDifficultyAllFloor(e, r) {
    var o = [];
    for (const t of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) t.Difficulty === r && o.push(t.Id);
    return o
  }
  GetDifficultyAllAreaFirstFloor(e, r) {
    let o = -1;
    var t = [];
    for (const f of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) f.Difficulty === r && o !== f.AreaNum && (t.push(f.Id), o = f.AreaNum);
    return t
  }
  GetDifficultyAreaAllFloor(e, r, o) {
    var t = [];
    for (const f of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r === TowerData_1.VARIATION_RISK_DIFFICULTY ? e : 0)) r === f.Difficulty && o === f.AreaNum && t.push(f.Id);
    return t
  }
  ...
  GetNextFloorInArea(e) {
    ...
    for (const o of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r.Season))
      if (o.Difficulty === r.Difficulty && o.AreaNum === r.AreaNum && o.Floor > r.Floor) return o.Id;
    return 0
  }
  GetLastFloorInArea(e) {
    ...
    let o = 0;
    for (const t of TowerConfigBySeason_1.configTowerConfigBySeason.GetConfigList(r.Season)) t.Difficulty === r.Difficulty && t.AreaNum === r.AreaNum && t.Floor < r.Floor && (o = t.Id);
    return o
  }
  GetTowerInfo(e) {
  ...
  GetNewTowerDifficultTitle(e) {
    switch (e) {
      case TowerData_1.LOW_RISK_DIFFICULTY:
        return MultiTextLang_1.configMultiTextLang.GetLocalTextNew("NewTower_Diffcult_1") ?? "";
      case TowerData_1.HIGH_RISK_DIFFICULTY:
        return MultiTextLang_1.configMultiTextLang.GetLocalTextNew("NewTower_Diffcult_2") ?? "";
      case TowerData_1.VARIATION_RISK_DIFFICULTY:
        return MultiTextLang_1.configMultiTextLang.GetLocalTextNew("NewTower_Diffcult_3") ?? "";
      case TowerData_1.OVERLOCK_RISK_DIFFICULTY:
        return MultiTextLang_1.configMultiTextLang.GetLocalTextNew("NewTower_Diffcult_4") ?? "";
      default:
        return MultiTextLang_1.configMultiTextLang.GetLocalTextNew("NewTower_Diffcult_1") ?? ""
    }
  }
