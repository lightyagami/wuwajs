...
class TowerDetailInformationMonsterItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.MonsterLayout = void 0, this.EDo = void 0, this.j1i = (e, t, i) => {
      t = new TowerDetailInformationMonsterSubItem_1.TowerDetailInformationMonsterSubItem(t);
      return t.Update(e.MonsterId, e.ShowLevel), {
        Key: i,
        Value: t
      }
  ...
  OnStart() {
    this.GetItem(1).SetUIParent(this.GetGridLayout(2).GetRootComponent()), this.MonsterLayout = new GenericLayoutNew_1.GenericLayoutNew(this.GetGridLayout(2), this.j1i)
  }
  Update(e, t) {
    this.EDo = e, this.Og()
  }
