...
class TowerBuffShowItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Og() {
    var e = ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerBuffDesc(this.sDo),
      e = (this.GetText(1).SetText(e), ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerBuffIcon(this.sDo));
    this.SetTextureByPath(e, this.GetTexture(0)), this.GetTexture(0)?.SetUIActive(!0)
  }
}
