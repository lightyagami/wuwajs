...
class TowerApplyFloorDataView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.eDo = () => {
      this.CloseMe()
    }, this.sOt = () => {
      TowerController_1.TowerController.TowerApplyFloorDataRequest(!0), this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  SHe() {
    ...
    if (r) {
      var o = ModelManager_1.ModelManager.TowerModel.GetFloorData(r.TowerId),
        t = this.GetItem(8),
        i = this.GetItem(5);
      for (let e = 0; e < r.Star; e++) LguiUtil_1.LguiUtil.DuplicateActor(t.GetOwner(), i);
      var a = this.GetItem(3);
      for (let e = 0; e < o.Star; e++) LguiUtil_1.LguiUtil.DuplicateActor(t.GetOwner(), a);
      t.SetUIActive(!1);
      ...
      l.SetUIActive(!1);
      let e = "";
      r.Difficulties === TowerData_1.LOW_RISK_DIFFICULTY ? e = "Text_LowRiskAreaFloor_Text" : r.Difficulties === TowerData_1.HIGH_RISK_DIFFICULTY ? e = "Text_HighRiskAreaFloor_Text" : r.Difficulties === TowerData_1.VARIATION_RISK_DIFFICULTY ? e = "Text_VariationAreaFloor_Text" : r.Difficulties === TowerData_1.OVERLOCK_RISK_DIFFICULTY && (e = "Text_OverLockAreaFloor_Text");
    ...
    } else Log_1.Log.CheckError() && Log_1.Log.Error("CycleTower", 5, "打开爬塔成绩确认框时失败，未能获取到新挑战数据")
  }
  OnBeforeDestroy() {
