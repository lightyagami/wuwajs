...
class TowerRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(), this.QSi = !1, this.hRo = 0, this.bOe = void 0, this.jWt = () => {
      ...
      TowerController_1.TowerController.TowerRewardRequest(e, this.hRo, t), this.GetItem(3).SetUIActive(!0), this.GetItem(5).SetUIActive(!1)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e) {
    ...
    var r = this._Ro(e.RewardId),
      r = (this.bOe.RefreshByData(r, () => {
        for (const e of this.bOe.GetScrollItemList()) e.SetReceivedVisible(this.QSi)
      }), ModelManager_1.ModelManager.TowerModel.GetDifficultyMaxStars(ModelManager_1.ModelManager.TowerModel.CurrentSelectDifficulties));
    this.GetText(1).SetText("" + e.Target), this.GetItem(3).SetUIActive(this.QSi), this.GetItem(4).SetUIActive(r < e.Target), this.GetItem(5).SetUIActive(r >= e.Target && !this.QSi)
  }
  _Ro(e) {
    var r, t, i = [];
