...
class TowerDetailItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(), this.IDo = void 0, this.TDo = -1, this.kqe = () => {
  ...
  Refresh(e, t, i) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "Text_TowerOnlyFloor_Text", r.Floor), e === ModelManager_1.ModelManager.TowerModel.CurrentSelectFloor ? this.SetToggleState(1) : this.SetToggleState(0)
  }
  BindOnClickToggle(e) {
    this.IDo = e
  }
