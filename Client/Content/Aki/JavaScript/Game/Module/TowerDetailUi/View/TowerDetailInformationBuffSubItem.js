...
class TowerDetailInformationBuffSubItem extends UiPanelBase_1.UiPanelBase {
  ...
  Og() {
    ...
    "" !== t && void 0 !== t || (StringUtils_1.StringUtils.IsEmpty(t) ? this.GetTexture(0).SetUIActive(!1) : (this.SetTextureByPath(t, this.GetTexture(0)), this.GetTexture(0).SetUIActive(!0)))
  }
}
