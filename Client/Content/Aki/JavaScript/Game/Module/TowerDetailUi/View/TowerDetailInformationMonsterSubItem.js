...
class TowerDetailInformationMonsterSubItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.SDo = 0, this.yDo = 0, this.CreateThenShowByActor(e.GetOwner())
  }
  OnRegisterComponent() {
  ...
  Og() {
    var e = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterName(this.SDo),
      ...
      e = (this.GetText(1).SetText(e), ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterIcon(this.SDo));
