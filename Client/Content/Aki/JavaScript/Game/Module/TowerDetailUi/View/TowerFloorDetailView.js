...
class TowerFloorDetailView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.RDo = void 0, this.UDo = void 0, this.ADo = void 0, this.H1i = void 0, this.PDo = () => {
      var e = new TowerDetailItem_1.TowerDetailItem;
      return e.BindOnClickToggle(e => {
        this.Og(e)
      }), e
    }, this.xDo = () => {
  ...
  OnStart() {
    var e = ModelManager_1.ModelManager.TowerModel.CurrentSelectDifficulties,
      r = (this.RDo = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.PDo), this.UDo = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), this.xDo), this.ADo = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(2), this.wDo), this.H1i = new GenericLayout_1.GenericLayout(this.GetGridLayout(3), this.n8i), ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerInfo(ModelManager_1.ModelManager.TowerModel.CurrentSelectFloor)),
      e = ModelManager_1.ModelManager.TowerModel.GetDifficultyAreaAllFloor(e, r.AreaNum);
    this.RDo.RefreshByData(e)
  }
  OnBeforeDestroy() {
    this.RDo.ClearChildren(), this.RDo = void 0, this.UDo.ClearChildren(), this.UDo = void 0, this.ADo.ClearChildren(), this.ADo = void 0, this.H1i.ClearChildren(), this.H1i = void 0
  }
  Og(e) {
