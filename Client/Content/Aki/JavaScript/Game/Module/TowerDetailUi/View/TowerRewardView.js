...
class TowerRewardView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.T8e = void 0, this.sbi = () => {
  ...
  OnStart() {
    this.T8e = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(0), this.sbi), this.Og()
  }
  OnBeforeDestroy() {
    this.T8e = void 0
  }
  ...
  Og() {
    ...
    }), this.T8e.RefreshByData(r), this.GetText(1).SetText(ModelManager_1.ModelManager.TowerModel.GetDifficultyMaxStars(e) + "/" + ModelManager_1.ModelManager.TowerModel.GetDifficultyAllStars(e)))
  }
}
