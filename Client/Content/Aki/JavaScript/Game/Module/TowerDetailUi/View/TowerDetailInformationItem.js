...
class TowerDetailInformationItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.fDo = void 0, this.ppt = void 0, this.CreateThenShowByActor(e.GetOwner())
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.fDo = new TowerDetailInformationBuffItem_1.TowerDetailInformationBuffItem(this.GetItem(1)), this.ppt = new TowerDetailInformationMonsterItem_1.TowerDetailInformationMonsterItem(this.GetItem(2))
  }
  pDo() {
    this.GetItem(1).SetUIActive(!1), this.GetItem(2).SetUIActive(!1)
  }
  Update(e) {
    this.pDo(), 0 === e.Type ? (this.GetItem(1).SetUIActive(!0), this.fDo.Update(e.TowerDetailBuffData)) : (this.GetItem(2).SetUIActive(!0), this.ppt.Update(e.MonsterData, e.Type)), this.vDo(e), this.MDo(e.Type)
  }
  OnBeforeDestroy() {
