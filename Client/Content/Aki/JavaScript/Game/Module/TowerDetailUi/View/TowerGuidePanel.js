...
class TowerGuidePanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(), this.UDo = void 0, this.xDo = () => {
  ...
  OnStart() {
    ...
    this.SetTextureByPath(e, this.GetTexture(3)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "TowerGuideDes")
  }
  OnBeforeShow() {
    var e = ModelManager_1.ModelManager.TowerModel.CurrentTowerId;
    e && (e = ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerInfo(e)) && this.UDo.RefreshByData(e.ShowBuffs)
  }
}
