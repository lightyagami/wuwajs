...
class TowerMonsterItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(), this.Mli = void 0, this.jli = () => {
  ...
  Refresh(e, t, r) {
    var i = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterIcon(e),
      i = (this.SetTextureByPath(i, this.GetTexture(2)), ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterInfoConfig(e).ElementIdArray),
      i = (this.Mli?.RefreshByData(i), ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterName(e)),
      e = (this.GetText(0).SetText(i), ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerInfo(ModelManager_1.ModelManager.TowerModel.CurrentSelectFloor)),
      i = e.InstanceId,
      e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetRecommendLevel(i, ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel);
