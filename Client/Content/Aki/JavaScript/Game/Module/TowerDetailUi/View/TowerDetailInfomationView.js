...
class TowerDetailView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.aDo = void 0, this.hDo = void 0, this.NHe = 0, this.lDo = (e, t, i) => {
    ...
    }, this.SortFunc = (e, t) => e.Priority - t.Priority, this._Do = () => {
      this.NHe = ModelManager_1.ModelManager.TowerDetailModel.CurrentSelectDetailId, this.uDo(), this.cDo()
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.aDo = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(2), this.lDo), this.hDo = new GenericLayoutNew_1.GenericLayoutNew(this.GetHorizontalLayout(4), this.PCo)
  }
  OnAddEventListener() {
  ...
  OnAfterShow() {
    this.NHe = ModelManager_1.ModelManager.TowerDetailModel.CurrentSelectDetailId, this.Og()
  }
  Og() {
  ...
  cDo() {
    ...
    ModelManager_1.ModelManager.TowerDetailModel.GetBuffs(t).forEach(e => {
      ...
      t.Type = 0, t.TowerDetailBuffData = e, t.Title = e.Title, t.Priority = e.Priority, i.push(t)
    }), ModelManager_1.ModelManager.TowerDetailModel.GetMonsters(t).forEach(e => {
      var t = new TowerDetailData_1.TowerInformationData;
      t.Type = 1, t.MonsterData = e, t.Title = e.Title, t.Priority = e.Priority, i.push(t)
    }), i.sort(this.SortFunc), this.aDo.RefreshByData(i)
  }
  mDo() {
