...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.TowerModel = exports.TOWER_LOOP_ACTIVITY_ID = exports.LOCK_COLOR = exports.NORMOL_COLOR = exports.FINISH_COLOR = exports.FLOOR_STAR = void 0;
...
exports.FLOOR_STAR = 3, exports.FINISH_COLOR = "#FFD12F", exports.NORMOL_COLOR = "#ECE5D8", exports.LOCK_COLOR = "#ADADAD", exports.TOWER_LOOP_ACTIVITY_ID = 100300002;
class TowerModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.TowerBeginTime = void 0, this.TowerEndTime = void 0, this.CurrentSeason = -1, this.DataSeason = 0, this.CurrentSelectDifficulties = -1, this.CurrentTowerId = -1, this.CurrentTowerFormation = void 0, this.NeedChangeFormation = !1, this.CurrentNotConfirmedFloor = void 0, this.NeedOpenConfirmViewTowerId = -1, this.NeedOpenConfirmView = !1, this.CurrentSelectFloor = -1, this.RoleDifficultyFormationMap = new Map, this.RecommendFormation = void 0, this.CurrentTowerLock = !1, this.DefaultFloor = -1, this.HLo = 0, this.TowerGuideDelayTime = 0, this.TowerSettlementDelayTime = 0, this.jLo = new Map, this.WLo = void 0, this.KLo = -1, this.QLo = new Map, this.XLo = new Map, this.$Lo = void 0, this.NeedOpenReviveView = !1, this.MaxUnlockDifficulty = 0, this.IsWaitTowerStart = !1, this.IsWaitTowerSettlement = !1
  }
  OnInit() {
    return this.HLo = CommonParamById_1.configCommonParamById.GetIntConfig("TowerRoleTotalCost"), this.TowerGuideDelayTime = CommonParamById_1.configCommonParamById.GetIntConfig("TowerGuideDelayTime"), this.TowerSettlementDelayTime = CommonParamById_1.configCommonParamById.GetIntConfig("TowerSettleDelayTime"), this.FGt(), !0
  }
  OnLeaveLevel() {
    return this.CurrentSelectFloor = -1, !0
  }
  FGt() {
    this.YLo(TowerData_1.LOW_RISK_DIFFICULTY, void 0), this.YLo(TowerData_1.HIGH_RISK_DIFFICULTY, void 0), this.YLo(TowerData_1.VARIATION_RISK_DIFFICULTY, void 0), this.YLo(TowerData_1.OVERLOCK_RISK_DIFFICULTY, void 0)
  }
  RefreshTowerInfo(t) {
    this.TowerBeginTime = t.cps, this.TowerEndTime = t.dps, this.MaxUnlockDifficulty = t.wGs, this.CurrentSeason !== t.EGs && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, exports.TOWER_LOOP_ACTIVITY_ID), this.CurrentSeason = t.EGs, this.DataSeason = t.yGs, this.RefreshTowerInfoByDifficulty(t.IGs)
  }
  RefreshTowerInfoByFloor(t) {
    for (const e of t) this.JLo(e)
  }
  RefreshTowerInfoByDifficulty(t) {
    for (const e of t) this.YLo(e.ljn, e.I9n), this.zLo(e.TGs), this.XLo.set(e.ljn, e.LGs)
  }
  DeleteVariationTowerInfo() {
    for (var [t, e] of this.jLo) e.Difficulties === TowerData_1.VARIATION_RISK_DIFFICULTY && this.jLo.delete(t);
    this.YLo(TowerData_1.VARIATION_RISK_DIFFICULTY, void 0), this.XLo.set(TowerData_1.VARIATION_RISK_DIFFICULTY, 0);
    for (var [, r] of this.RoleDifficultyFormationMap) r.set(TowerData_1.VARIATION_RISK_DIFFICULTY, 0)
  }
  GetFloorStars(t) {
  ...
  GetAreaStars(t, e, r = !1) {
    let i = 0;
    if (r)
      for (var [, o] of this.WLo) o.Difficulties === t && o.Area === e && (i += o.Star);
    else
      for (var [, a] of this.jLo) a.Difficulties === t && a.Area === e && (i += a.Star);
    return i
  }
  ...
  YLo(t, e) {
    ...
    if (r)
      for (const n of r) n.IsReceived = e?.includes(n.Index);
    else {
  ...
  zLo(t) {
    for (const e of t)
      for (const r of e.DGs) this.JLo(r)
  }
  JLo(t) {
    let e = this.jLo.get(t.hjn);
    if (e) {
      e.Star = t.rxs, e.StarIndex = t.AGs;
      for (const r of e.Formation) this.ReduceRoleFormationCost(r.Q6n, e.Difficulties, e.Cost);
      e.Formation = t.ajn
    } else e = new TowerData_1.TowerFloorInfo(t.hjn, t.rxs, t.ajn, t.AGs), this.jLo.set(t.hjn, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnTowerRecordUpdate, t.hjn, e.Difficulties);
    for (const i of e.Formation) this.ZLo(i.Q6n, e.Difficulties, e.Cost)
  }
  ZLo(t, e, r) {
    let i = this.RoleDifficultyFormationMap.get(t);
    var o;
    i ? (o = i.get(e)) ? (o += r, i.set(e, o)) : i.set(e, r) : (i = new Map).set(e, r), this.RoleDifficultyFormationMap.set(t, i)
  }
  ReduceRoleFormationCost(t, e, r) {
    var i, t = this.RoleDifficultyFormationMap.get(t);
  ...
  GetMaxDifficulty() {
    return this.GetDifficultyIsClear(TowerData_1.LOW_RISK_DIFFICULTY) ? this.GetDifficultyIsClear(TowerData_1.HIGH_RISK_DIFFICULTY) ? 1 !== this.GetDifficultyRewardProgress(TowerData_1.VARIATION_RISK_DIFFICULTY) || 1 === this.GetDifficultyRewardProgress(TowerData_1.OVERLOCK_RISK_DIFFICULTY) ? TowerData_1.VARIATION_RISK_DIFFICULTY : TowerData_1.OVERLOCK_RISK_DIFFICULTY : TowerData_1.HIGH_RISK_DIFFICULTY : TowerData_1.LOW_RISK_DIFFICULTY
  }
  ...
  GetCurrentFloorName() {
    var t = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("TowerAreaFloor"),
      ...
      e = ConfigManager_1.ConfigManager.TowerClimbConfig.GetTowerInfo(this.CurrentTowerId),
  ...
  GetFloorFormation(t) {
    var e = [],
      t = this.jLo.get(t);
    if (t && t.Formation)
      for (const r of t.Formation) e.push(r.Q6n);
    return e
  }
  SaveNeedOpenConfirmView() {
    this.NeedOpenConfirmViewTowerId = this.CurrentTowerId, this.NeedOpenConfirmView = !0
  }
  ClearNotConfirmedData() {
    this.NeedOpenConfirmViewTowerId = -1, this.NeedOpenConfirmView = !1, this.CurrentNotConfirmedFloor = void 0
  }
  OpenReviewView() {
    this.NeedOpenReviveView && (this.NeedOpenReviveView = !1, 0 < this.GetDifficultyMaxStars(TowerData_1.VARIATION_RISK_DIFFICULTY, !0) && UiManager_1.UiManager.OpenView("TowerReviewView"), this.DataSeason = this.CurrentSeason)
  }
  SaveHandleData() {
    this.WLo = new Map(this.jLo), this.$Lo = new Map(this.XLo), this.KLo = this.CurrentSeason
  }
  ClearHandleData() {
    this.WLo?.clear(), this.WLo = void 0, this.$Lo?.clear(), this.$Lo = void 0, this.KLo = -1
  }
  CheckInTower() {
  ...
  GetSeasonCountDownData() {
    ...
    var e = (t = t <= 1 ? 1 : t) >= CommonDefine_1.SECOND_PER_DAY ? 3 : t >= CommonDefine_1.SECOND_PER_HOUR ? 2 : 1,
      r = t >= CommonDefine_1.SECOND_PER_DAY ? 2 : t >= CommonDefine_1.SECOND_PER_HOUR ? 1 : 0;
  ...
  CanGetReward() {
    ...
    if (t) {
      ...
      for (const r of t)
        if (e >= r.Target && !r.IsReceived) return !0
    }
    return !1
  }
  CanGetRewardByDifficulties(t) {
    ...
    if (e) {
      ...
      for (const i of e)
        if (r >= i.Target && !i.IsReceived) return !0
    }
    return !1
  }
  ...
  GetOverLockHasShow() {
    return LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerOverLockArea) ?? !1
  }
  SetOverLockHasShow() {
    LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerOverLockArea, !0)
  }
}
