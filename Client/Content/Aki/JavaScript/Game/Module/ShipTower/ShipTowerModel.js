...
class ShipTowerModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Z7_ = !1, this.Zn_ = [], this.es_ = new Map, this.DebugParallaxSub = !1, this.ts_ = [], this.is_ = new Map, this.rs_ = new Map, this.os_ = [], this.ns_ = new Map, this.xG_ = new Map, this.cA_ = 0, this.UG_ = 0, this.DG_ = !1, this.BG_ = !1, this.uA_ = [], this.dA_ = new Set, this.mA_ = 0, this.RecordList = [], this.rq_ = 0, this.oq_ = 0, this.ChallengeStageData = void 0, this.ChallengeBuffIdList = [], this.ReviewList = [], this.ReviewProgressList = [], this.kG_ = [], this.ShowBuffIdList = [], this.qV_ = void 0, this.QH_ = void 0, this.KH_ = void 0, this.CurSelectBuffData = void 0, this.PlayerGetBuffSet = new Set, this.IsShowLeftTeamPanel = !1, this.IsOpenedSeasonUpdate = !1, this.AddNormalStackChildView = (e, t) => {
      e && UiModel_1.UiModel.NormalStack.Peek()?.AddChildViewById(t)
    }, this.CheckCanOpen = () => {
      var e, t;
      return ModelManager_1.ModelManager.OnlineModel.GetIsTeamModel() ? (ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId("ErrorCode_600064_Text"), !1) : ((e = this.IsOpen()) || (t = ConfigManager_1.ConfigManager.FunctionConfig.GetFunctionCondition(10081)?.OpenConditionId) && (t = ConfigManager_1.ConfigManager.ConditionConfig.GetConditionGroupConfig(t))?.HintText && ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsByTextId(t.HintText), e)
    }, this.XH_ = () => {
      this.LeaveBattle() || this.CloseMainView()
    }, this.LeaveBattle = () => !!this.CheckInBattleShipTower() && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ResetToBattleView), ModelManager_1.ModelManager.TowerModel.CurrentTowerId = -1, ControllerHolder_1.ControllerHolder.InstanceDungeonEntranceController.LeaveInstanceDungeon(), !0)
  }
  get CurSeason() {
    return this.cA_
  }
  ...
  OnInit() {
    return UiManager_1.UiManager.AddOpenViewCheckFunction("ShipTowerView", this.CheckCanOpen, "ShipTowerModel.CheckCanOpen"), !0
  }
  OnClear() {
    return UiManager_1.UiManager.RemoveOpenViewCheckFunction("ShipTowerView", this.CheckCanOpen), this.Zn_.length = 0, this.es_.clear(), this.ts_.length = 0, this.is_.clear(), !0
  }
  OnLeaveLevel() {
    return !0
  }
  ...
  AddPlayerGetBuff(e) {
    this.PlayerGetBuffSet.add(e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.ShipTowerGetBuffSet, this.PlayerGetBuffSet), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerBuffNewUpdate)
  }
  l5_() {
  ...
  CheckOldSeasonBuffQualityList() {
    this.ts_.forEach(e => {
      var t;
      e.BuffList.some(e => this.d5_(e)) && (t = e.BuffList.filter(e => !this.d5_(e)), e.BuffList.unshift(...t), e.BuffList.splice(t.length), 0 === e.BuffList.length) && this.is_.delete(e.Quality)
    })
  }
  d5_(e) {
  ...
  c5_(e) {
    var t;
    this.rs_.has(e.Id) || ((t = new ShipTowerBuffData_1.ShipTowerBuffData).Init(e), this.rs_.set(e.Id, t), this.is_.has(t.Quality) ? this.is_.get(t.Quality).BuffList.push(t) : (e = {
      Quality: t.Quality,
  ...
  u5_() {
    this.ts_.length = 0, this.ts_.push(...Array.from(this.is_.values())), this.ts_.sort((e, t) => t.Quality - e.Quality)
  }
  async CheckInitProto() {
    this.qG_() && await ControllerHolder_1.ControllerHolder.ShipTowerController.SlashAndTowerInfoRequest()
  }
  qG_() {
    return !(!this.IsOpen() || this.TowerStageDataList[0]?.IsHaveProtoData && !this.TimeIsOver())
  }
  fA_() {
    this.uA_.length = 0, this.uA_.push(this.CreateAreaDataById(ShipTowerDefine_1.SHIP_TOWER_ZERO_SEASON))
  }
  CreateDefaultStageDataList() {
    this.TowerStageDataList.length || [0, 1].forEach(e => {
  ...
  as_(e) {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("ShipTower", 69, "CreateStageDataById", ["id", e])
  }
  ss_(e) {
    ...
    return t.Init(e), t.SetOrderIndex(this.Zn_.length + 1), this.Zn_.push(t), this.es_.set(e.Id, t), t
  }
  GetStageDataById(e) {
  ...
  GetTeamTabList() {
    return this.os_.length || (this.os_.push({
      TabType: 0,
  ...
  ls_(e, t, i = !0) {
    return !e || e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && (Log_1.Log.CheckInfo() && Log_1.Log.Info("ShipTower", 69, "CheckErrorCode", ["ErrorCode", e.Q4n], ["MsgId", t]), i && ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, t), !0)
  }
  UpdateSeasonNotify(e) {
    this.JH_()
  }
  UpdateResultNotify(e) {
    var t, i, r, s, a = this.GetStageDataById(e.ELl);
    a ? this.CheckIsNeedShowConfirmSeasonUpdate() || (a.ProtoTeamEditFromResult(e), t = a.NewChallengeScore, i = a.IsNewRecord(t), s = ShipTowerDefine_1.shipTowerTextKey.MonsterScore, r = ShipTowerDefine_1.shipTowerTextKey.TimeScore, s = [{
  ...
  OV_(e, t) {
    ...
    return e.IsNeedSureScore ? (r[0] = void 0, r[1].OnClickedCallback = e.SureResultFromInstance.bind(e)) : (e.IsEndLess ? (r[1].ButtonTextId = ShipTowerDefine_1.shipTowerTextKey.Retry, r[1].OnClickedCallback = e.GotoDescFromInstance.bind(e)) : e.CheckPass(t) ? (t = this.GetNextChallengeStageData(e), i = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(t.TitleKey), r[1].ButtonTextId = ShipTowerDefine_1.shipTowerTextKey.Continue, r[1].DescriptionTextId = ShipTowerDefine_1.shipTowerTextKey.GoOnTower, r[1].DescriptionArgs = [i, t.OrderIndex], r[1].OnClickedCallback = e.GotoNextDescFromInstance.bind(e, t)) : (r[1].ButtonTextId = ShipTowerDefine_1.shipTowerTextKey.Retry, r[1].DescriptionTextId = ShipTowerDefine_1.shipTowerTextKey.NotFinished, r[1].OnClickedCallback = e.GotoDescFromInstance.bind(e)), e.SaveLastData()), r
  }
  UpdateLevelPlayNotify(e) {
    e.BL_.forEach(e => {
      var t = this.GetStageDataById(e.s5n);
      t?.ProtoNotifyUpdateData(e), t?.IsEndLess && !this.IsOldSeason(t.BelongToSeason) && t.IsTeamSetRoleFinish() && (this.DG_ = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerEndlessRecordUpdate))
    }), this.CA_()
  }
  SlashAndTowerInfoResponse(e) {
    this.ls_(e, 16849, !1) || (this.Zn_.length = 0, e?.BL_.forEach(e => {
      this.as_(e.s5n)
    }), this.cA_ = this.Zn_[this.Zn_.length - 1]?.BelongToSeason ?? 1, this.UG_ = MathUtils_1.MathUtils.LongToNumber(e.dG_), this.DG_ = !!e.fG_, this.BG_ = !!e.mG_, this.CheckOldSeasonBuffQualityList(), this._5_(this.CurSeason), e?.BL_.forEach(e => {
      this.GetStageDataById(e.s5n)?.ProtoUpdateData(e)
    }), this.dA_.clear(), e?.kL_.forEach(e => {
      this.dA_.add(e)
    }), this.Pac(e?.Mac ?? []), this.ClearAreaList(), this.GetAreaList())
  }
  SlashAndTowerScoreRewardResponse(e) {
    this.ls_(e, 23571) || (e.cOl.forEach(e => {
      this.dA_.add(e)
    }), this.CA_(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerRewardReceive, this.mA_))
  }
  EndLessHistoryResponse(e) {
    this.ls_(e, 19548) || (this.RecordList.length = 0, this.nq_(ShipTowerDefine_1.shipTowerTextKey.CurrentRecord, e.qL_), this.nq_(ShipTowerDefine_1.shipTowerTextKey.HistoryRecord, e.OL_))
  }
  nq_(e, t) {
    if (t && 0 !== t?.s5n) {
      ...
      e(ShipTowerDefine_1.shipTowerTextKey.TeamName1, t.LL_), e(ShipTowerDefine_1.shipTowerTextKey.TeamName2, t.wL_), this.RecordList.push(s)
    }
  }
  SlashAndTowerSaveRecordResponse(e, t) {
    this.ls_(t, 28508) || (this.GetStageDataById(e)?.CoverChallenge(), this.CA_(), this.SetChallengeStageDataNull(), ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId(ShipTowerDefine_1.shipTowerTextKey.CoverChallenge), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerSureCoverChallenge, e))
  }
  SlashAndTowerResetResponse(e, t) {
    this.ls_(t, 16258) || (this.GetStageDataById(e)?.ResetStage(), this.CA_(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerSureResetStage, e), ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId(ShipTowerDefine_1.shipTowerTextKey.ResetStage))
  }
  SlashAndTowerRecommendResponse(e, t) {
    this.ls_(t, 22559) || this.GetStageDataById(e)?.ProtoUpdateTeamRecommendList(t)
  }
  SlashAndTowerReviewResponse(e) {
    this.ls_(e, 16655) || (this.ReviewList.length = 0, e?.CG_.forEach(e => {
      var t = e.gG_,
        e = e.SMs;
    ...
    }), this.ReviewProgressList.length = 0, this.ReviewProgressList.push(e._fc), this.ReviewProgressList.push(e.lfc))
  }
  GetPlayerTeamList() {
    var t = [];
  ...
  GetAreaList() {
    var e;
    return 2 <= this.uA_.length || (e = Math.max(this.CurSeason, 1), this.uA_.push(this.CreateAreaDataById(e)), this.uA_.push(this.CreateAreaDataById(e, !0)), this.CA_()), this.uA_
  }
  CreateAreaDataById(e, t = !1) {
    var i = this.GetRewardListByAreaId(e, t);
    let r = ShipTowerDefine_1.shipTowerTextKey.AreaNameShallow;
    return e !== ShipTowerDefine_1.SHIP_TOWER_ZERO_SEASON && (r = t ? ShipTowerDefine_1.shipTowerTextKey.AreaNameDead : ShipTowerDefine_1.shipTowerTextKey.AreaNameDeep), {
      Id: e,
  ...
  GetRewardListByAreaId(e, t = !1) {
    const r = [];
    return ConfigManager_1.ConfigManager.ShipTowerConfig.GetChallengeRewardCfgBySeason(e)?.forEach(e => {
  ...
  ClearAreaList() {
    for (let e = this.uA_.length - 1; 0 <= e; e--) this.uA_[e].Id !== ShipTowerDefine_1.SHIP_TOWER_ZERO_SEASON && this.uA_.splice(e, 1)
  }
  CA_() {
    this.rq_ = 0, this.oq_ = 0, this.uA_.forEach(e => {
      const s = e.Id,
        a = e.IsEndless,
      ...
      e.RewardList.forEach(e => {
        ...
        e.IsReceive = !t && i >= e.TotalScore, e.IsProgress = !t && i < e.TotalScore, e.IsCompleted = t, e.IsCompleted || (r = !1), e.IsReceive && (o = !0, this.rq_++), this.oq_++
      }), e.IsFinish = r, e.IsRedPoint = o, e.RewardList?.sort((e, t) => e.IsReceive !== t.IsReceive ? e.IsReceive ? -1 : 1 : e.IsProgress !== t.IsProgress ? e.IsProgress ? -1 : 1 : e.Id - t.Id)
    }), this.uA_.sort((e, t) => e.IsFinish !== t.IsFinish ? e.IsFinish ? 1 : -1 : e.Index - t.Index), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RedDotUpdateShipTowerReward), ActivityShipTowerController_1.ActivityShipTowerController.RefreshActivityRedDot()
  }
  async ReceiveAward(e, t) {
    this.mA_ = e, await ControllerHolder_1.ControllerHolder.ShipTowerController.SlashAndTowerScoreRewardRequest(e, t)
  }
  GetRewardProgressText(e = !0) {
    let t = 0,
      i = 0;
    const r = this.IsPassZeroSeason();
    return this.uA_.filter(e => {
      e = e.Id === ShipTowerDefine_1.SHIP_TOWER_ZERO_SEASON;
      return r ? !e : e
    }).forEach(e => {
      t += e.RewardList.filter(e => e.IsCompleted).length, i += e.RewardList.length
    }), e ? `<color=#fadf85>${t}</color>/` + i : t + "/" + i
  }
  GetRemainTime() {
    return this.CurSeasonEndTime <= 0 ? 0 : this.CurSeasonEndTime - TimeUtil_1.TimeUtil.GetServerTime()
  }
  TimeIsOver() {
  ...
  CheckInBattleShipTower() {
    var e;
    return !(!ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance() || (e = ModelManager_1.ModelManager.CreatureModel.GetInstanceId(), !(e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e))) || 27 !== e.InstSubType)
  }
  StartChallenge(e) {
    var t = (this.ChallengeStageData = e).TeamDataList.map(e => e.BuffDataEdit?.Id ?? 0);
    this.Pac(t), ControllerHolder_1.ControllerHolder.ShipTowerController.RequestChallenge(e)
  }
  Pac(e) {
  ...
  AgainChallenge() {
    var e;
    this.CheckIsNeedShowConfirmSeasonUpdate() || this.sq_() && !ModelManager_1.ModelManager.SceneTeamModel.IsAllDid() && (e = ModelManager_1.ModelManager.CreatureModel.GetInstanceId(), e = this.ChallengeStageData?.TeamDataList[1].InstId === e, ControllerHolder_1.ControllerHolder.ShipTowerController.RequestChallenge(this.ChallengeStageData, e, !0))
  }
  OpenViewMainFromFight() {
    var e;
    this.sq_() && (e = this.ChallengeStageData.Id, this.OpenViewMain({
      StageId: e,
      IsFromInstanceDungeon: !0
    }))
  }
  ...
  ClearChallengeStageData() {
    this.ChallengeStageData && (this.ChallengeStageData.UpdateToEdit(), this.SetChallengeStageDataNull())
  }
  ...
  async CheckIsNeedShowSeasonReview() {
    if (!this.QH_ || this.QH_.IsFulfilled()) {
      if (this.TimeIsOver() && await this.CheckInitProto(), !this.BG_) return !1;
      await ControllerHolder_1.ControllerHolder.ShipTowerController.SlashAndTowerReviewRequest(), this.QH_ = new CustomPromise_1.CustomPromise, this.OpenViewReview({
  ...
  btc() {
    ...
    e.length && (e.forEach(e => {
      e.ResetStage(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShipTowerStageUpdate, e.Id)
    }), this.CA_())
  }
  ...
  GetStageGradeResIdByStageId(e, t) {
    ...
    return i ? i.GetStageGradeResIdByScore(t) : (i = ConfigManager_1.ConfigManager.ShipTowerConfig.GetStageCfgById(e)) ? this.GetStageGradeResIdByScore(t, i.TargetScore, i.ScoreStage) : void 0
  }
  ...
  GetStageNameById(e) {
    ...
    return (i = t ? t.Title : i) ? ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(i, i) : ""
  }
  GetInTheBattleBuffInfo() {
    ...
    var e = e?.TeamDataList.findIndex(e => e.InstId === t) ?? 0,
      ...
      e = (ConfigManager_1.ConfigManager.ShipTowerConfig?.GetBuffCfgById(e))?.ItemId ?? this.rs_.values().next().value.ItemId,
    ...
    return {
      ...
      DescInfoList: [{
        DescKey: s,
        DescUseChangeColor: !0
      }],
      DescTitleKey: ShipTowerDefine_1.shipTowerTextKey.BattleBuffSkillTitle
    }
  }
  AddShowBuffId(e, t = !0) {
    this.kG_.push(e), t && (this.ShowBuffIdList.push(e), UiManager_1.UiManager.IsViewOpen("ShipTowerShowBuffView") || UiManager_1.UiManager.OpenView("ShipTowerShowBuffView"))
  }
  async CheckShowGetBuff() {
    if (!this.KH_ || this.KH_.IsFulfilled()) {
      if (this.kG_.length <= 0) return !1;
      this.KH_ = new CustomPromise_1.CustomPromise, UiManager_1.UiManager.OpenView("ShipTowerGetBuffView", {
  ...
  YH_() {
    const i = [],
      r = new Map;
    return this.kG_.forEach(e => {
      var t, e = this.GetBuffDataByBuffId(e);
      e && (r.has(e.ItemId) ? r.get(e.ItemId)[1]++ : (t = [{
        ItemId: e.ItemId,
        IncId: 0
      }, 0], i.push(t), r.set(e.ItemId, t)))
    }), i
  }
  async OpenWelcomeView() {
    this.qV_ && !this.qV_.IsFulfilled() || (this.qV_ = new CustomPromise_1.CustomPromise, UiManager_1.UiManager.OpenView("ShipTowerWelcomeView", {
      Promise: this.qV_
  ...
  GetSeasonCountDownData() {
    ...
    var t = (e = e <= 1 ? 1 : e) >= CommonDefine_1.SECOND_PER_DAY ? 3 : e >= CommonDefine_1.SECOND_PER_HOUR ? 2 : 1,
      i = e >= CommonDefine_1.SECOND_PER_DAY ? 2 : e >= CommonDefine_1.SECOND_PER_HOUR ? 1 : 0;
    return TimeUtil_1.TimeUtil.GetCountDownDataFormat2(e, t, i)
  }
  GetStageAreaName(e) {
    const t = void 0 === e ? this.GetCurrentStage() : this.GetStageDataById(e) ?? this.Zn_[0],
      i = this.Zn_.findIndex(e => e.Id === t?.Id);
    e = ConfigManager_1.ConfigManager.ShipTowerConfig.GetAllShowStageCfg().find(e => e.OutIndex >= i);
    return e ? ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(e.Name, e.Name) : ""
  }
  ...
  JH_(e) {
    var t, i;
    this.IsOpenedSeasonUpdate || (this.IsOpenedSeasonUpdate = !0, (t = new ConfirmBoxDefine_1.ConfirmBoxDataNew(256)).FunctionMap.set(1, i = () => {
      (e ?? this.XH_)?.(), this.IsOpenedSeasonUpdate = !1
    }), t.FunctionMap.set(2, i), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(t))
  }
  OpenConfirmBackWorld() {
    var e = new ConfirmBoxDefine_1.ConfirmBoxDataNew(254);
    e.FunctionMap.set(2, this.LeaveBattle), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e)
  }
  IsExistFirstGetBuff() {
