...
class ShipTowerTeamData {
  constructor() {
    this.InstId = 0, this.Index = 0, this.RoleList = [], this.BuffData = void 0, this.BuffDataEdit = void 0, this.StageId = 0, this.CurrentScore = 0, this.NewChallengeScore = 0, this.TeamInstName = "", this.AreaName = "", this.TeamName = ""
  }
  Init(e, t, i) {
    this.InstId = e, this.Index = t, this.StageId = i, this.TeamInstName = this.GetInstanceDungeonCfg()?.MapName ?? "MapName";
    e = 0 === t ? ShipTowerDefine_1.shipTowerTextKey.TeamName1 : ShipTowerDefine_1.shipTowerTextKey.TeamName2, this.TeamName = e, i = 0 === t ? ShipTowerDefine_1.shipTowerTextKey.TeamAreaNameUp : ShipTowerDefine_1.shipTowerTextKey.TeamAreaNameDown;
    this.AreaName = i;
  ...
  UpdateRoleListByFormationData(i) {
    ModelManager_1.ModelManager.RoleSelectModel.ClearData(), this.RoleList.forEach((e, t) => {
      t = i.GetRoleIdList[t] ?? 0;
      this.pA_(e, t), this.yA_(e)
    })
  }
  UpdateRoleListToRoleSelectModel() {
    ModelManager_1.ModelManager.RoleSelectModel.ClearData(), this.RoleList.forEach(e => {
      this.yA_(e)
    })
  }
  yA_(e, t = !0) {
    var i = this.GetRoleIndexInAllTeam(e.PositionIndex + 1);
    e.RoleIdEdit ? (e = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e.RoleIdEdit)) && (ModelManager_1.ModelManager.RoleSelectModel.RoleIndexMap.set(i, e), t) && ModelManager_1.ModelManager.RoleSelectModel.SelectedRoleSet.add(e.GetDataId()) : ModelManager_1.ModelManager.RoleSelectModel.RoleIndexMap.delete(i)
  }
  ...
  UpdateOtherTeamRoleRepeat(e) {
    ...
    let i = !1;
    return this.RoleList.forEach(e => {
      e.RoleIdEdit && t.includes(e.RoleIdEdit) && (this.pA_(e, 0), i = !0)
    }), i
  }
  RemoveRoleIdEdit(t) {
    t && this.RoleList.forEach(e => {
  ...
  ProtoSetRole(e, t) {
    ...
    i ? (this.SA_(i, e), this.pA_(i, e)) : Log_1.Log.CheckDebug() && Log_1.Log.Debug("ShipTower", 69, "ProtoSetRole", ["index", t])
  }
  ProtoSetBuff(e = 0) {
  ...
  ResetStage() {
    ...
    }), this.MA_(void 0), this.vA_(void 0), this.UpdateCurrentScore(0)
  }
  CoverChallenge() {
    this.RoleList.forEach(e => {
      this.SA_(e, e.RoleIdEdit)
    }), this.MA_(this.BuffDataEdit), this.UpdateCurrentScore(this.NewChallengeScore)
  }
  SA_(e, t = 0) {
    e.RoleId = t
  }
  pA_(e, t = 0, i = !1) {
    (e.RoleIdEdit = t) <= 0 ? e.RoleIdEdit = 0 : i ? e.RoleIdEdit = ModelManager_1.ModelManager.ShipTowerModel.IsCanUseRole(t) ? t : 0 : ModelManager_1.ModelManager.RoleModel?.IsMainRole(t) && (e.RoleIdEdit = ModelManager_1.ModelManager.RoleModel.GetCurSelectMainRoleId() ?? t)
  }
  MA_(e) {
    this.BuffData = e
  }
  ...
  GetInfoAttr() {
    var e = this.GetInstanceDungeonCfg(),
      ...
      e = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(e.DungeonDesc, e.DungeonDesc);
    return {
  ...
  GetInfoWord() {
    ...
    e?.BuffId?.forEach(e => {
      ...
      t && (e = this.OG_(e, t), t = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(t.Desc, t.Desc), i.push({
        Desc: t,
        ...e
      }))
    }), i.length || (e = ShipTowerDefine_1.shipTowerTextKey.WordNull, e = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(e, e), i.push({
      Desc: e
    }));
  ...
  UpdateMainRoleToEdit() {
    this.RoleList.forEach(e => {
      0 < e.RoleIdEdit && ModelManager_1.ModelManager.RoleModel?.IsMainRole(e.RoleIdEdit) && this.pA_(e, e.RoleIdEdit)
    })
  }
}
