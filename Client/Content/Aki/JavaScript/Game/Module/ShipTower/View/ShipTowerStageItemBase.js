...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.ShipTowerStageItemEndless = exports.ShipTowerStageItemRefresh = exports.ShipTowerStageItemOneTime = exports.ShipTowerStageItemBase = void 0;
const UE = require("ue"),
  UiPanelBase_1 = require("../../../Ui/Base/UiPanelBase"),
  ShipTowerStageItem_1 = require("./ShipTowerStageItem");
class ShipTowerStageItemBase extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.StageItem = void 0, this.ItemData = void 0, this.OnClickBtnEnter = () => {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [1, this.OnClickBtnEnter]
    ]
  }
  async OnBeforeStartAsync() {
    var e = this.GetItem(0);
    this.StageItem = new ShipTowerStageItem_1.ShipTowerStageItem, await this.StageItem.Init(e, this.ItemData)
  }
  UpdateData() {
