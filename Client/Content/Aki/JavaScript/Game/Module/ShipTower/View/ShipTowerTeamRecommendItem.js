...
class ShipTowerTeamRecommendItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.fGt = void 0, this.PD_ = void 0, this.xD_ = void 0, this.ClickCallBack = void 0, this.i7_ = void 0, this.UD_ = () => {
      this.ClickCallBack?.(this.fGt)
    }, this.DD_ = () => {
      var e = new ShipTowerMediumItem_1.ShipTowerMediumItem;
      return e.RefreshCallBack = e.RefreshRecommend.bind(e), e.GetStageIdCallback = this.BW_, e
  ...
  Refresh(e, t, i) {
    var r = [...(this.fGt = e).RoleIdList1, {
      ...
      r = (this.PD_?.RefreshByData(r), this.xD_?.RefreshByData(s), this.GetText(0)?.SetText(e.Name), this.GetText(1)?.SetText(e.UseRate + "%"), !!this.fGt.StageData?.IsCanApplyTeamRecommend(this.fGt));
    this.i7_.SetEnableClick(r), Log_1.Log.CheckDebug() && Log_1.Log.Debug("ShipTower", 69, "ShipTowerTeamRecommendItem", ["Refresh", this.fGt.Name])
  }
}
