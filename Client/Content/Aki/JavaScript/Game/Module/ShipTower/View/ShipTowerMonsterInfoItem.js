...
class ShipTowerMonsterInfoItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.bD_ = void 0, this.Bqe = () => {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.bD_ = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.Bqe)
  }
  Refresh(e) {
    LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "LevelText", e.Level), this.GetText(0).ShowTextNew(e.Title), this.SetTextureByPath(e.MonsterIcon, this.GetTexture(2)), this.bD_?.RefreshByData(e.ElementList)
  }
}
