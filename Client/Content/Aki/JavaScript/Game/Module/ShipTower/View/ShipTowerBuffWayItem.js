...
class ShipTowerBuffWayItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.fGt = void 0, this.Is_ = () => {
      this.fGt?.Function()
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(t) {
    this.fGt = t, this.GetText(1).SetText(this.fGt.Text), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Map", 69, this.constructor.name, ["Refresh", this.fGt])
  }
}
