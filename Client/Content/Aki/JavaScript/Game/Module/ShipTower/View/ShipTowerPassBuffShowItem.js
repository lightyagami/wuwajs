...
class ShipTowerPassBuffShowItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    ...
    var e = ConfigManager_1.ConfigManager.ItemConfig.GetConfig(this.fGt[0].ItemId),
      r = ConfigManager_1.ConfigManager.ItemConfig.GetQualityConfig(e.QualityId),
      s = this.GetText(1);
    s?.ShowTextNew(e.Name), s?.SetColor(UE.Color.FromHex(r.DropColor)), this.GetText(2)?.ShowTextNew(e.AttributesDescription), this.SetTextureByPath(e.Icon, this.GetTexture(0)), Log_1.Log.CheckDebug() && Log_1.Log.Debug("ShipTower", 69, "ShipTowerPassBuffShowItem", ["Refresh", this.fGt])
  }
}
