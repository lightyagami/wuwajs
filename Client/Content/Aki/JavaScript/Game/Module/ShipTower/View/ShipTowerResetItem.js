...
class ShipTowerResetItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.fDo = void 0, this.i8_ = void 0, this.Os_ = () => {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.fDo = new SmallItemGrid_1.SmallItemGrid, this.fDo.Initialize(this.GetItem(0).GetOwner()), this.fDo.BindOnExtendToggleClicked(this.Os_), this.fDo.BindOnCanExecuteChange(() => !1);
  ...
  UpdateData(e) {
    var i = (this.i8_ = e).BuffData?.ItemId ?? 1,
      ...
      t = (this.GetItem(4).SetUIActive(!i), this.GetText(5).SetUIActive(i), this.GetText(1));
    t.ShowTextNew(e.BuffData?.ItemNameKey ?? ""), t.SetColor(e.BuffData?.GetQualityColor()), i || (t = e.BuffData?.CanUseCount ?? 0, this.GetText(2).SetText(t.toString()), this.GetText(3).SetText((t + 1).toString()))
  }
}
