...
class ShipTowerMonsterListItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.LD_ = void 0, this.Bqe = () => {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.LD_ = new GenericLayout_1.GenericLayout(this.GetGridLayout(1), this.Bqe)
  }
  UpdateData(e) {
    this.GetText(0).SetText(e.Title), this.LD_?.RefreshByData(e.MonsterInfoList)
  }
}
