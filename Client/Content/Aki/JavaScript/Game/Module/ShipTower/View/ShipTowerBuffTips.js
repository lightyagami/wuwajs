...
class ShipTowerBuffTips extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.s4e = void 0, this.vs_ = () => {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.s4e = new GenericLayout_1.GenericLayout(this.GetGridLayout(9), this.vs_)
  }
  OnRegisterComponent() {
  ...
  UpdateData(e) {
    ...
    var e = ItemTipsUtilTool_1.ItemTipsComponentUtilTool.GetTipsDataById(this.Pe.ItemId),
      ...
      i = (this.GetText(2).ShowTextNew(e.Title), this.GetText(3).ShowTextNew(i.BgDescription), this.SetTextureByPath(i.IconMiddle, this.GetTexture(4)), !!e.GetWayData?.length);
    this.GetGridLayout(9).RootUIComp.SetUIActive(i), i && this.s4e?.RefreshByDataAsync(e.GetWayData)
  }
}
