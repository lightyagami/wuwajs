...
class ShipTowerReviewView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.OpenParam = void 0, this.RD_ = void 0, this.AD_ = () => {
  ...
  async OnBeforeStartAsync() {
    this.Es_(), await super.OnBeforeStartAsync(), this.RD_ = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(0), this.GetItem(2).GetOwner(), this.AD_, !0)
  }
  OnBeforeShow() {
    this.UpdateData()
  }
  ...
  UpdateData() {
    var e = ModelManager_1.ModelManager.ShipTowerModel.ReviewList,
      e = (this.RD_?.RefreshByData(e), ModelManager_1.ModelManager.ShipTowerModel.ReviewProgressList),
