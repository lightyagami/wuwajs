...
class ShipTowerGetBuffView extends UiViewBase_1.UiViewBase {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.Es_(), this.H3e = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(0), () => new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid)
  }
  OnBeforeShow() {
