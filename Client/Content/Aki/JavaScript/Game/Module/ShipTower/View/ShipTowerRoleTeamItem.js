...
class ShipTowerRoleTeamItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Vlo = [], this.fGt = void 0, this.OnClickCallback = void 0, this.StageData = void 0, this.ya_ = e => {
      this.qA_()?.SetToggleStateForce(1), this.ScrollViewDelegate?.SelectGridProxy(this.GridIndex, this.DisplayIndex, !1)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let e = 2; e <= 4; e++) {
      ...
      t.Initialize(this.GetItem(e).GetOwner()), t.SetToggleInteractive(!1), this.Vlo.push(t)
    }
  ...
  Refresh(o) {
    this.fGt = o;
    let h = !0;
    if (this.Vlo.forEach((e, t) => {
        var i, r, s = o.GetRoleIdList[t];
        s ? (i = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(s), r = ModelManager_1.ModelManager.ShipTowerModel.GetAllTeamRoleData(s), s = {
          Type: 2,
          ItemConfigId: s,
        ...
        }, e.Apply(s), r || (h = !1)) : (h = !1, e.Apply({
          Type: 5
        }))
      }), this.GetText(1).SetText(o.FormationId.toString()), h) {
