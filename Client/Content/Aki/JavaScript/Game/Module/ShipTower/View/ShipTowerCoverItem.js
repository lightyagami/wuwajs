...
class ShipTowerCoverItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.fGt = void 0, this.Ts_ = !1, this.bs_ = void 0, this.Ls_ = void 0, this.As_ = void 0, this.xs_ = void 0, this.Rs_ = void 0, this.ConfirmCallback = void 0, this.Qho = () => {
      this.ConfirmCallback?.(this.fGt, this.Ts_)
    }, this.uyi = () => new ShipTowerCoverRoleItem_1.ShipTowerCoverRoleItem, this.Os_ = e => {}
  }
  async Init(e) {
  ...
  UpdateData(e, i = !1) {
    ...
    var i = this.Ts_ ? e.NewChallengeScore : e.CurrentScore,
      ...
      e = ModelManager_1.ModelManager.ShipTowerModel.GetStageGradeResIdByStageId(e.Id, i);
    h.SetUIActive(!!e), e && (i = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e), this.SetTextureByPath(i, h))
  }
}
