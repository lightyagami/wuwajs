...
class ShipTowerTeamPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Ivt = void 0, this.I6e = 0, this.vNt = void 0, this.Flo = void 0, this.Ea_ = void 0, this.Vlo = [], this.Ia_ = void 0, this.Ns_ = void 0, this.os_ = void 0, this.RoleSelectCallBack = void 0, this.TeamSelectCallBack = void 0, this.e7_ = void 0, this.EmptyStateItem = void 0, this.RoleListUpdateCallback = void 0, this.fqe = () => {
      return new ShipTowerTeamTabItem_1.ShipTowerTeamTabItem
    }, this.KOl = e => {
      if (!this.IsStartOrStarting) switch (this.I6e = e, Log_1.Log.CheckInfo() && Log_1.Log.Info("ShipTower", 69, "二级页签点击回调: " + this.I6e), this.I6e) {
        case 0:
          this.Hlo();
          break;
        case 1:
      ...
      this.Vlo = e, this.Flo?.RefreshByData(this.Vlo), this.EmptyStateItem?.SetUIActive(this.Vlo.length <= 0), this.RoleListUpdateCallback?.()
    }, this.cHe = () => {
      var e = new ShipTowerRoleGrid_1.ShipTowerRoleGrid;
      return e.BindOnExtendToggleStateChanged(this.ToggleFunction), e.BindOnCanExecuteChange(this.CanExecuteChangeFunction), e
    }, this.ba_ = () => {
      var e = new ShipTowerRoleTeamItem_1.ShipTowerRoleTeamItem;
      return e.OnClickCallback = this.TeamSelectCallBack, e.StageData = this.Ns_, e
      ...
      this.RoleSelectCallBack?.(r), this.Flo.GetScrollItemByIndex(s)?.Refresh(r, e, s), Log_1.Log.CheckDebug() && Log_1.Log.Debug("ShipTower", 69, "ToggleFunction", ["", this.Ns_.Id])
    }, this.CanExecuteChangeFunction = (e, i, t) => {
      return !!ModelManager_1.ModelManager.ShipTowerModel.IsOtherTeamRoleData(e.GetDataId()) || 0 !== t || !this.t7_() || (ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("EditBattleTeamRoleFull"), !1)
    }
  }
  async Init(e, i) {
  ...
  UpdateRoleListByMainRoleChange() {
    ...
    this.vNt?.UpdateData(38, e), this.Ia_ && (this.Ia_ = ModelManager_1.ModelManager.ShipTowerModel.GetPlayerTeamList())
  }
  Hlo() {
    this.GetScrollViewWithScrollbar(2).RootUIComp.SetUIActive(!0), this.GetScrollViewWithScrollbar(1).RootUIComp.SetUIActive(!1), this.vNt?.SetActive(!0), this.UpdateRoleListFilter()
  }
  ...
  Ta_() {
    this.GetScrollViewWithScrollbar(2).RootUIComp.SetUIActive(!1), this.GetScrollViewWithScrollbar(1).RootUIComp.SetUIActive(!0), this.vNt?.SetActive(!1), this.Ia_ = this.Ia_ ?? ModelManager_1.ModelManager.ShipTowerModel.GetPlayerTeamList(), this.Ea_?.SelectGridProxy(-1), this.OnlyUpdateTeamList()
  }
  OnlyUpdateTeamList() {
  ...
  t7_() {
    for (let e = 1; e <= EditFormationDefine_1.EDITE_FORAMTION_MAX_NUM; e++) {
      ...
      if (!ModelManager_1.ModelManager.RoleSelectModel.RoleIndexMap.has(i)) return !1
    }
    return !0
  }
  GetRoleIdList() {
