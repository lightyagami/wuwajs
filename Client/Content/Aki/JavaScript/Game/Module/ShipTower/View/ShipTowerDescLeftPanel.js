...
class ShipTowerDescLeftPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Ns_ = void 0, this.Ps_ = void 0, this.H3e = void 0, this.t8_ = () => {
  ...
  async OnBeforeStartAsync() {
    await super.OnBeforeStartAsync(), this.Ps_ = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(6), () => new ShipTowerScoreInfoItem_1.ShipTowerScoreInfoItem);
  ...
  Slo(e) {
    ...
    var e = ShipTowerDefine_1.shipTowerTextKey.ScorePoint,
      i = this.GetText(4),
      i = (LguiUtil_1.LguiUtil.SetLocalTextNew(i, e, this.Ns_.CurrentScore.toString()), this.GetText(5).ShowTextNew(this.Ns_.DescKey), this.oCo(), this.Ps_?.RefreshByData(this.Ns_.GetTargetScoreInfoList()), this.Ns_.GetPassUnlockBuffList());
    this.GetItem(10)?.SetUIActive(!!i.length), i.length && this.H3e?.RefreshByData(i)
  }
  Hgi() {
    var e = this.Ns_.IsEndLess;
    this.GetTexture(2).SetUIActive(e), this.GetTexture(0).SetUIActive(!e), e || this.GetText(1).SetText(this.Ns_.OrderIndex.toString())
  }
  oCo() {}
}
