...
class ShipTowerReviewItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    ...
    var e = ShipTowerDefine_1.shipTowerTextKey.ScorePointNoColor,
      i = this.GetText(1),
      i = (LguiUtil_1.LguiUtil.SetLocalTextNew(i, e, this.fGt.Score.toString()), void 0 !== this.fGt.Grade),
      e = this.GetTexture(2);
    e?.SetUIActive(i), i && (i = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(this.fGt.Grade), this.SetTextureByPath(i, e)), Log_1.Log.CheckDebug() && Log_1.Log.Debug("ShipTower", 69, "ShipTowerReviewItem", ["Refresh", this.fGt])
  }
}
