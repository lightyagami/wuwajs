...
class ShipTowerPassBuffShowView extends UiViewBase_1.UiViewBase {
  ...
  async OnBeforeStartAsync() {
    this.Es_(), await super.OnBeforeStartAsync(), this.RA_ = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(0), () => new ShipTowerPassBuffShowItem_1.ShipTowerPassBuffShowItem)
  }
  OnBeforeShow() {
