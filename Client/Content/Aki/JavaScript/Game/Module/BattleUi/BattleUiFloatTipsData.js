...
class BattleUiFloatTip {
  constructor() {
    this.Type = 0, this.TextKey = void 0, this.EndTime = 0, this.CountdownEndTime = 0
  }
}
...
class BattleUiFloatTipsData {
  ...
  PlayNormalFloatTip(t, e) {
    ...
    i.Type = 0, i.TextKey = t, i.EndTime = Time_1.Time.WorldTimeSeconds + e, this.AddNewFloatTip(i)
  }
  PlayCountdownFloatTip(t, e, i) {
    var a = new BattleUiFloatTip;
    a.Type = 1, a.TextKey = t, a.EndTime = Time_1.Time.WorldTimeSeconds + e, a.CountdownEndTime = Time_1.Time.WorldTimeSeconds + i, this.AddNewFloatTip(a)
  }
  AddNewFloatTip(t) {
    this.CurTip && this.nXe.push(this.CurTip), this.CurTip = t, UiManager_1.UiManager.IsViewOpen("BattleFloatTipsView") ? EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BattleUiFloatTipUpdate) : UiManager_1.UiManager.OpenView("BattleFloatTipsView")
  }
  CheckIsExpired(t) {
