...
class BattleUiConfig extends ConfigBase_1.ConfigBase {
  GetHardnessPercentList() {
    var e = CommonParamById_1.configCommonParamById.GetIntArrayConfig("HardnessPercentStage1"),
      r = CommonParamById_1.configCommonParamById.GetIntArrayConfig("HardnessPercentStage2"),
      a = CommonParamById_1.configCommonParamById.GetIntArrayConfig("HardnessPercentStage3");
  ...
  GetThreadColor(e, r) {
    if (0 === r || 2 === r) return ModelManager_1.ModelManager.BattleUiModel.ThreatLevelColor3;
