...
class BattleUiEnvironmentKeyData {
  ...
  Init() {
    ...
    for (let e = 1; e < 10; e++) this.WQe.push(!1)
  }
  ...
  QQe() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "环境特性快捷键类型改变", ["type", this.jQe]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BattleUiEnvironmentKeyChanged)
  }
  OnLeaveLevel() {
    this.jQe = 0;
    for (let e = 1; e < 10; e++) this.WQe[e] = !1
  }
  Clear() {}
}(exports.BattleUiEnvironmentKeyData = BattleUiEnvironmentKeyData).KQe = [void 0, "HotKeyText_SilentAreaTips_Name", "HotKeyText_EnvironmentBuffTips_Name", "HotKeyText_SilentAreaTips_Name", "HotKeyText_RogueInfoTips_Name", "HotKeyText_VisionLevelTips_Name", "HotKeyText_TowerTokenTips_Name", "HotKeyText_RogueInfoTips_Name", "HotKeyText_MoraleTokenTips_Name", "HotKeyText_MoraleAreaSum_Name"];
