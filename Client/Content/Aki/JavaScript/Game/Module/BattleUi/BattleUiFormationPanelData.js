...
const Log_1 = require("../../../Core/Common/Log"),
  ...
  actionNames = [InputMappingsDefine_1.actionMappings.切换角色1, InputMappingsDefine_1.actionMappings.切换角色2, InputMappingsDefine_1.actionMappings.切换角色3, InputMappingsDefine_1.actionMappings.切换角色4];
class FormationItemData {
  constructor() {
    this.PlayerId = 0, this.RoleId = 0, this.RoleSkinId = 0, this.CreatureDataId = 0
  }
}
exports.FormationItemData = FormationItemData;
class BattleUiFormationPanelData {
  constructor() {
    this.HIt = void 0, this.Nk_ = new Map, this.PositionItemMap = new Map
  }
  Init() {}
  Clear() {
  ...
  UpdateFormationPanelData() {
    ...
    var e = ModelManager_1.ModelManager.PlayerInfoModel.GetId() ?? 0,
      t = !ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance();
    for (const p of ModelManager_1.ModelManager.GameModeModel.IsMulti ? ModelManager_1.ModelManager.OnlineModel.GetAllWorldTeamPlayer() : [e]) {
      var a = p === e,
        r = ModelManager_1.ModelManager.SceneTeamModel.GetTeamPlayerData(p);
      if (r) {
        ...
        if (r)
          if (a)
            for (const M of r) {
              var o = M.RoleId,
                n = ModelManager_1.ModelManager.RoleSkinModel.GetRoleSkinIdByRoleId(o);
              this.PAl(p, o, n, M.CreatureDataId)
            } else {
              var i = ModelManager_1.ModelManager.OnlineModel.GetWorldTeamPlayerFightInfo(p);
              for (const u of r) {
                var s = u.RoleId,
                  l = i?.GetRoleInfoByConfigId(s);
                let e = 0;
                if (l) e = l?.RoleSkinId ?? 0;
                else {
                  l = u.CreatureDataId;
                  if (!l) return;
        ...
        if (r)
          for (const d of r) this.PAl(p, d.RoleId, d.RoleSkinId)
      }
    }
  }
  PAl(e, t, a, r = void 0) {
    ...
    n.PlayerId = e, n.RoleId = t, n.RoleSkinId = a, void 0 !== r && (n.CreatureDataId = r), this.PositionItemMap.set(o, n)
  }
  GetItemData(e) {
  ...
  SetInputType(e) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Battle", 48, "切换编队ActionInputHandler", ["type", e]), this.HIt = this.Nk_.get(e)
  }
