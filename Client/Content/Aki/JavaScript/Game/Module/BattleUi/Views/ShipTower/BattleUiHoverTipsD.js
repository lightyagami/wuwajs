...
exports.BattleUiHoverTipsD = undefined;
const UE = require("ue");
...
class BattleUiHoverTipsD extends BattleChildView_1.BattleChildView {
  ...
  UpdateInfo(t) {
    this.LAe = t;
    if (this.Hmt && (this.xKt?.Refresh(this.LAe), this.LAe.DescTitleKey)) {
...
class BattleUiInfoItem extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    ...
    this.DOt = t;
    this.AZs = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(2), this.Bqe);
  }
  Refresh(t) {
...
class BattleUiDescInfoItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, i) {
    ...
    if (t.IsShowState && (r = !!t.IsUnlock, s = UE.Color.FromHex(r ? "adfb5aff" : "adadadff"), h?.SetColor(s), this.GetSprite(0).SetUIActive(r), this.GetSprite(3).SetUIActive(!r), t.StateTitleKey)) {
