...
class TopPanelWavePlateTip extends BattleVisibleChildView_1.BattleVisibleChildView {
  ...
  OnBeforeCreate() {
    this.kgl = new UiViewSequence_1.UiBehaviorLevelSequence(this), this.AddUiBehavior(this.kgl)
  }
  Initialize(e) {
