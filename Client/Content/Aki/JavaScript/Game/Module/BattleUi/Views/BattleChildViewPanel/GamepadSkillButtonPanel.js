...
class GamepadSkillButtonPanel extends BattleChildViewPanel_1.BattleChildViewPanel {
  constructor() {
    super(...arguments), this.Let = Stats_1.Stat.Create("[GamepadSkillButton]RefreshAllBattleSkillItem"), this.nza = Stats_1.Stat.Create("[GamepadSkillButton]OnInputCombineButton"), this.hZe = void 0, this.NWa = void 0, this.lZe = [], this.Mah = void 0, this.Eah = void 0, this.VWa = void 0, this.HWa = !1, this._Ze = void 0, this.uZe = t => {
      this.cZe()
    }, this.mZe = () => {
      this.dZe()
    }, this.CZe = () => {
      ...
      var i;
      this.Visible && ((i = this.fZe(t))?.GetSkillButtonData() && i.RefreshEnable(), (i = this.Iah(t))?.GetSkillButtonData()) && i.RefreshEnable()
    }, this.pZe = t => {
      var e = this.fZe(t);
      e ? (e.RefreshVisible(), e.RefreshKey(), (e = this.Iah(t))?.GetSkillButtonData() && (e.RefreshVisible(), e.RefreshKey())) : (this._Ze.RefreshButtonData(), this.cZe())
    }, this.vZe = t => {
      var e = this.fZe(t),
        e = (e?.GetSkillButtonData() && e.RefreshDynamicEffect(), this.Iah(t));
      e?.GetSkillButtonData() && e.RefreshDynamicEffect()
    }, this.EZe = t => {
      var e, i = ModelManager_1.ModelManager.SkillButtonUiModel.GetSkillButtonDataByButton(t);
      i && ((e = this.fZe(t)) && e.Refresh(i), (e = this.Iah(t))?.SrcBehaviorButtonData ? e.RefreshByBehaviorButtonData(e.SrcBehaviorButtonData) : e?.BehaviorButtonData && e.RefreshByBehaviorButtonData(e.BehaviorButtonData))
    }, this.yZe = t => {
      var e = this.fZe(t),
      ...
      101 === t && (this._Ze.RefreshButtonData(), this._Ze.RefreshAimButtonVisible(), this.cZe())
    }, this.zze = () => {
      for (const t of this.lZe) t.RefreshTimeDilation()
    }, this.XBo = () => {
      Info_1.Info.IsInGamepad() ? (this.SetVisible(5, !0), this.cZe()) : (this.SetVisible(5, !1), this._Ze?.ClearInputAxis())
    }, this.RZe = t => {
      this.nza.Start(), this.cZe(), this.UZe(), this.AZe(t), this.Tah(), this.nza.Stop()
    }, this.HKa = () => {
      this.jKa()
    }, this.Lah = () => {
      var t, e = this._Ze.SwitchInteractData.State;
      2 === e ? ((t = this.fZe(104)) && t.BehaviorButtonData && t.RefreshByBehaviorButtonData(t.BehaviorButtonData), this.Xlh()) : 0 === e ? ((t = this.fZe(104)) && t.SrcBehaviorButtonData && t.RefreshByBehaviorButtonData(t.SrcBehaviorButtonData), this.Xlh()) : 1 === e && this.fZe(104)?.PlaySwitchCd()
    }, this.bMe = (i, t) => {
      ...
      Info_1.Info.IsInGamepad() && this._Ze.CacheInputAxis(InputEnums_1.EInputAxis.MoveForward, e)
    }, this.BZe = (t, e) => {
      Info_1.Info.IsInGamepad() && this._Ze.CacheInputAxis(InputEnums_1.EInputAxis.MoveRight, e)
    }, this.bZe = t => {
  ...
  async InitializeAsync() {
    await this.GZe(), await this.jWa(), await this.yah(), await this.NewAllBattleSkillItems(), this.WWa(), this.NZe(), this.cZe(), this.UZe(), this.Tah(), this.qZe(), this.nit(), this.jKa()
  }
  Reset() {
    this.lZe.length = 0, this.Eah?.Clear(), this.Eah = void 0, this.VWa?.Clear(), this.VWa = void 0, this._Ze?.ClearInputAxis(), super.Reset()
  }
  OnAfterShow() {
  ...
  QWa() {
    var t = this.HWa;
    this.HWa = !1;
    for (let t = 0; t < LEFT_KEY_NUM; t++) this.lZe[t + LEFT_KEY_START_INDEX].IsVisible() ? (this.NWa.SetArrowVisible(t, !0), this.HWa = !0) : this.NWa.SetArrowVisible(t, !1);
    this.NWa?.SetBgVisible(this.HWa), t !== this.HWa && this.VWa && (this.VWa.StopCurrentSequence(), this.VWa.PlaySequencePurely(this.HWa ? "Show" : "Hide"))
  }
  kZe() {
    var e = ModelManager_1.ModelManager.SkillButtonUiModel,
      i = this._Ze.CurButtonTypeList;
    for (let t = SUB_KEY_START_INDEX; t < SUB_KEY_END_INDEX; t++) {
      var s, n = i[t],
        h = this.lZe[t];
      n ? (s = e.GetSkillButtonDataByButton(n)) ? s.GetSkillId() ? h.Refresh(s) : h.Deactivate() : (s = this._Ze.GetBehaviorButtonDataByButtonType(n), h.RefreshByBehaviorButtonData(s)) : h.Deactivate()
    }
  }
  dZe() {
  ...
  async GZe() {
    ...
    t && (this.hZe = new BattleSkillCombineItem_1.BattleSkillCombineItem, await this.hZe.CreateByActorAsync(t))
  }
  async jWa() {
    var t = this.GetItem(15)?.GetOwner();
    t && (this.NWa = new BattleSkillDpadItem_1.BattleSkillDpadItem, await this.NWa.CreateThenShowByActorAsync(t))
  }
  async yah() {
    var t = this.GetItem(20)?.GetOwner();
    t && (this.Mah = new BattleSkillRouletteItem_1.BattleSkillRouletteItem, await this.Mah.CreateThenShowByActorAsync(t))
  }
  async FZe(t, e) {
  ...
  Iah(t) {
    if (7 === t && this._Ze?.SwitchInteractData.IsSwitchInteractOpen) return this.fZe(104)
  }
  UZe() {
  ...
  AZe(t) {
    if (t) {
      for (let t = 0; t < MAIN_HALF_NUM; t++) 0 !== this._Ze.MainSkillCombineButtonTypeList[t] && this.lZe[t].PlayPressCombineButtonSeq();
      for (let t = LEFT_KEY_START_INDEX; t < SUB_KEY_START_INDEX; t++) this._Ze.DpadSkillCombineButtonTypeList[t] !== this._Ze.DpadSkillButtonTypeList[t] && this.lZe[t].PlayPressCombineButtonSeq();
      this.Eah.StopTweenAnim(21), this.Eah.PlayTweenAnim(22)
    } else {
      for (let t = 0; t < MAIN_HALF_NUM; t++) this.lZe[t].PlayReleaseCombineButtonSeq();
      this.Eah.StopTweenAnim(22), this.Eah.PlayTweenAnim(21)
    }
  }
  jKa() {
    ModelManager_1.ModelManager.BattleUiModel?.ChatScrollViewVisible ? this.GetItem(10)?.SetAnchorOffsetX(593) : this.GetItem(10)?.SetAnchorOffsetX(393)
  }
  Xlh() {
    var t, e = this.fZe(7);
    e?.IsSecondButton && (t = ModelManager_1.ModelManager.SkillButtonUiModel?.GetSkillButtonDataByButton(7), this.Ylh(e, t))
  }
  qZe() {
  ...
  nit() {
    this.Eah = new BattleUiTweenAnimPlayer_1.BattleUiTweenAnimPlayer, this.Eah.InitTweenAnim(21, this.GetItem(21)), this.Eah.InitTweenAnim(22, this.GetItem(22)), this.VWa = new LevelSequencePlayer_1.LevelSequencePlayer(this.GetItem(10))
  }
}
