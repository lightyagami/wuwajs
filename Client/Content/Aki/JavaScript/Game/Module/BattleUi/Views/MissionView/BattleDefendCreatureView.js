...
class BattleDefendCreatureView extends BattleEntityChildView_1.BattleEntityChildView {
  constructor() {
    super(...arguments), this.Kut = (e, t, i) => {
      var r, n;
      this.IsValid() && (r = (n = this.GetEntity().GetComponent(173)).GetCurrentValue(EAttributeId.Proto_Life), n = n.GetCurrentValue(EAttributeId.l5n), this.Qut(0 < n ? r / n : 0))
    }
  }
  OnRegisterComponent() {
  ...
  Initialize(e) {
    super.Initialize(e), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(0), "InstanceDungeonDefendCreatureTips"), this.GetText(2).SetUIActive(!1), this.GetItem(5).SetUIActive(!1), this.Qut(1)
  }
  Reset() {
    super.Reset()
  }
