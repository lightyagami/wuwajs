...
class FullScreenNiagaraItem extends BattleChildView_1.BattleChildView {
  ...
  Reset() {
    this.Lht?.SetNiagaraSystem(void 0), this.Tht = void 0, this.Lht = void 0, super.Reset()
  }
  async LoadNiagara(e) {
    ...
    return ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.NiagaraSystem, e => {
      e && this.RootItem && (this.Lht = this.GetUiNiagara(0), this.Lht) ? (this.Lht.SetNiagaraSystem(void 0), this.Lht.SetNiagaraSystem(e), t.SetResult(!0)) : t.SetResult(!1)
    }), await t.Promise, !0
  }
  ...
  SetVisible(e) {
    ...
    e ? t.ActivateSystem(!0) : (this.Lht.SetNiagaraSystem(void 0), this.Lht.DeactivateSystem()), this.SetActive(e)
  }
}
