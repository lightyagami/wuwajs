...
class SilentAreaInfoItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.BO_ = IQuest_1.EInformationViewType.LevelPlay, this.kmt = []
  }
  OnRegisterComponent() {
  ...
  Fmt(e) {
    ...
    let i = "";
    i = this.BO_ === IQuest_1.EInformationViewType.LevelPlay ? PublicUtil_1.PublicUtil.GetConfigTextByKey(e) : MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e), t?.SetText(i)
  }
  Vmt(i) {
    for (let t = 0; t < i.length; t++) {
      var s, r = i[t];
      let e = void 0;
      t < this.kmt.length ? ((e = this.kmt[t]).SetCurrentShowType(this.BO_), e.UpdateItem(r)) : (s = LguiUtil_1.LguiUtil.CopyItem(this.GetItem(1), this.GetItem(2)), (e = new SilentAreaInfoSubItem_1.SilentAreaInfoSubItem).SetCurrentShowType(this.BO_), e.Initialize(s.GetOwner(), r), this.kmt.push(e))
    }
