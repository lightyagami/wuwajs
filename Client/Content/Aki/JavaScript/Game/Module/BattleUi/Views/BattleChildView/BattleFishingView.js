...
class BattleFishingView extends BattleVisibleChildView_1.BattleVisibleChildView {
  ...
  async EW_(i, e) {
    ...
    await t.CreateThenShowByActorAsync(this.GetItem(i).GetOwner(), e), this.Het.push(t)
  }
  SetDriveFishingShipVisible(i) {
    this.SetVisible(7, i)
  }
  GetGuideUiItemAndUiItemForShowEx(i) {
    if (2 === i.length) return i = Number(i[1]), !(Number.isNaN(i) || i < 0 || i >= this.BtnBindInfo.length) && (i = this.GetButton(i)?.GetRootComponent()) ? [i, i] : void 0
  }
}
