...
class SpecialEnergyBarZheZhiEffectItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    super.OnStart(), this.GetUiNiagara(3).SetUIActive(!1), this.GetUiNiagara(4).SetUIActive(!1), this.Est(5), this.Est(6)
  }
  SetNiagaraParam(t, e) {
    this.GetUiNiagara(2).SetNiagaraVarFloat(t, e)
  }
  SetVisible(t) {
    this.yne !== t && ((this.yne = t) ? (this.Gnt(6), this.GetUiNiagara(4).SetUIActive(!1), this.bnt(5)) : (this.Gnt(5), this.GetUiNiagara(3).SetUIActive(!1), this.bnt(6)))
  }
  OnBeforeHide() {
    this.Hnt = void 0
  }
