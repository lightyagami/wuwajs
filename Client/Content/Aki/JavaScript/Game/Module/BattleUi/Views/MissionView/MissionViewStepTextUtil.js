...
class MissionViewStepTextUtil {
  static GetStepTextByConfig(e, t) {
    switch (t.ShowSource) {
      case 0:
        return GeneralLogicTreeController_1.GeneralLogicTreeController.GetTitleText(e, t.TidTitle, t.QuestScheduleType, t.UsePreStateText ?? !1);
      case 1:
        return MissionViewStepTextUtil.QU_(t);
      case 2:
        return MissionViewStepTextUtil.iF1(t)
    }
    return ""
  }
  static QU_(e) {
    var t = PublicUtil_1.PublicUtil.GetConfigTextByKey(e.TidTitle),
      r = ModelManager_1.ModelManager.DockyardModel.GetItemCountByItemId(e.ProgressTargetId),
      e = MissionViewStepTextUtil.GetEntrustProgressTotalCount(e.ProgressTargetId),
      r = r < e ? r : e;
  ...
  static GetEntrustProgressTotalCount(e) {
    ...
    return !t || 2 === (t = ConfigManager_1.ConfigManager.FishingConfig.GetFishingEntrust(t)).EntrustType ? 0 : t.EntrustTarget.get(e) ?? 0
  }
  ...
  static CheckTextEqual(t, r) {
    if (t !== r) {
      if (!t || !r) return !1;
      if (!MissionViewStepTextUtil.CheckStepTextSame(t.MainStepText, r.MainStepText)) return !1;
      if (t.SubStepTexts !== r.SubStepTexts) {
        ...
        for (let e = 0; e < t.SubStepTexts.length; e++) {
          ...
          if (!MissionViewStepTextUtil.CheckStepTextSame(i, r.SubStepTexts[e])) return !1
        }
      }
    }
    return !0
