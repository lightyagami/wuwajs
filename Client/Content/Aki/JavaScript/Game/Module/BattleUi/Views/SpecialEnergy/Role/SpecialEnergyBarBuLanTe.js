...
class SpecialEnergyBarBuLanTe extends SpecialEnergyBarBase_1.SpecialEnergyBarBase {
  constructor() {
    super(...arguments), this.Rdt = void 0, this.Ddt = new SpecialEnergyBaIconHandle_1.SpecialEnergyBaIconHandle, this.tqt = [], this.CN = !1, this.DP_ = !1, this.TGe = 0
  }
  OnRegisterComponent() {
  ...
  async BP_(t) {
    ...
    this.tqt.push(e), await e.CreateThenShowByActorAsync(this.GetItem(3 + t).GetOwner())
  }
  OnStart() {
    this.InitTweenAnim(6), this.InitTweenAnim(7), this.InitTweenAnim(8), this.InitTweenAnim(9), this.InitTweenAnim(10), this.InitTweenAnim(11), this.PlayTweenAnim(11), this.Ddt.Init([this.GetTexture(2)]), this.kP_(!0), this.qP_(!0), this.OP_(!0)
  }
  OnBarPercentChanged() {
  ...
  kP_(t = !1) {
    ...
    this.DP_ === e && !t || (this.DP_ = e, this.DP_ ? (this.StopTweenAnim(7), this.PlayTweenAnim(6)) : t ? (this.StopTweenAnim(6), this.GetTexture(2)?.SetUIActive(!0), this.GetTexture(2)?.SetAlpha(1)) : (this.StopTweenAnim(6), this.PlayTweenAnim(7)))
  }
  qP_(t = !1) {
    var e = this.PercentMachine.GetCurPercent(),
      i = (this.GetSprite(1)?.SetFillAmount(e), e <= 0);
    if (this.CN !== i || t) {
      (this.CN = i) ? this.Ddt.SetIcon(this.Config?.IconPath): this.Ddt.SetIcon(this.Config?.EnableIconPath);
