...
class FormationLevelUpItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.LevelHandle = void 0, this.CreateThenShowByResourceIdAsync("UiItem_FormationLevelUpItem", e)
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.LevelHandle && this.GetText(0).SetText(this.LevelHandle), this.LevelHandle = void 0
  }
  SetLevelText(e) {
