...
class QuestUpdateTipsController extends MissionPanelControllerBase_1.MissionPanelControllerBase {
  constructor(s, t, e, i) {
    super(), this.$pt = s, this.jZe = t, this.DU_ = e, this.JU_ = i, this.ControllerType = 1, this.oxn = 0, this.rct = void 0, this.QG_ = void 0, this.KG_ = void 0, this.XG_ = void 0, this.YG_ = void 0, this.zG_ = void 0, this.JG_ = !1, this.yct = s => {
      switch (s) {
        case "MissionIn":
          1 === this.oxn ? this.KG_?.IsPending() && this.KG_.SetResult(!0) : 3 === this.oxn && this.zG_?.IsPending() && this.zG_.SetResult(!0);
          break;
        case "MissionOut":
          1 === this.oxn ? this.QG_?.IsPending() && this.QG_.SetResult(!0) : 3 === this.oxn && this.YG_?.IsPending() && this.YG_.SetResult(!0)
      }
    }, this.fqn = () => {
      switch (Log_1.Log.CheckInfo() && Log_1.Log.Info("Log", 18, "MissionPanel:Press Track"), this.oxn) {
        case 1:
          this.$pt.StopCurrentSequence(!0, !0);
          break;
        case 2:
          TimerSystem_1.TimerSystem.Has(this.rct) && TimerSystem_1.TimerSystem.Remove(this.rct), this.XG_?.SetResult(!0)
      }
      this.JG_ = !0
  ...
  e2_(s) {
    ...
    return (s = s && ConfigManager_1.ConfigManager.QuestNewConfig.GetQuestUpdateShowTime(s.Type)) ? 1e3 * s : TimerSystem_1.MIN_TIME
  }
  axn(s) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Log", 18, "MissionPanel:QuestUpdateTipsEnd - AllOver", ["processId", s.Info.QuestId]), this.jZe.OnAfterPlayHideSequence(), this.oxn = 0, this.JG_ = !1
  }
}
