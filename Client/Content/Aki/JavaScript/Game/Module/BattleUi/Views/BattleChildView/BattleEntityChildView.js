...
class BattleEntityChildView extends BattleChildView_1.BattleChildView {
  constructor() {
    super(...arguments), this.Jh = void 0, this.GYe = new Map, this.NYe = [], this.i$e = [], this.OYe = []
  }
  Reset() {
    this.Deactivate(this.Jh), super.Reset()
  }
  Reactivate(t) {
    ObjectSystem_1.ObjectSystem.IsValid(t) && (this.IsValid() ? this.GetEntityId() !== t.Id && (this.Deactivate(this.GetEntity()), this.Activate(t)) : this.Activate(t))
  }
  Activate(t) {
    ObjectSystem_1.ObjectSystem.IsValid(t) && (this.Jh = t, this.OnActivate(), this.AddEntityEvents(t))
  }
  Deactivate(t) {
    ObjectSystem_1.ObjectSystem.IsValid(t) && (ObjectSystem_1.ObjectSystem.IsValid(this.Jh) ? this.GetEntityId() !== t.Id ? Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 17, "在休眠时，休眠实体不是当前实体") : (this.RemoveEntityEvents(t), this.OnDeactivate(), this.Jh = void 0) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 17, "在休眠时，当前实体不存在，请先调用Activate"))
  }
  OnActivate() {}
  OnDeactivate() {}
  AddEntityEvents(t) {}
  ...
  kYe(t) {
    ...
    if (e)
      for (var [i, s] of this.GYe) e.RemoveListener(i, s)
  }
  ListenForTagCountChanged(e, i, s) {
    e = e.GetComponent(205);
    if (e) {
      let t = void 0;
      "number" == typeof i ? t = i : "string" == typeof i && (t = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(i));
