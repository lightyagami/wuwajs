...
class HeadStateData {
  ...
  Initialize(t) {
    ...
    this.Xte = t.GetComponent(217);
    this.l1t = t.GetComponent(80);
    this._1t = t.GetComponent(159);
    this.CreatureDataComponent = t.GetComponent(0);
    this.c1t = this.Entity.GetComponent(21);
    this.m1t = this.Entity.GetComponent(185);
    this.d1t = this.Entity.GetComponent(140);
