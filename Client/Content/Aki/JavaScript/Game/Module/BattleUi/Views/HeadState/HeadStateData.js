...
class HeadStateData {
  constructor() {
    this.CommonParam = void 0, this.Jh = void 0, this.E0 = 0, this.OC = void 0, this.h1t = void 0, this.ActorComponent = void 0, this.Xte = void 0, this.$te = void 0, this.l1t = void 0, this._1t = void 0, this.u1t = void 0, this.c1t = void 0, this.m1t = void 0, this.d1t = void 0, this.C1t = !1, this.tfe = void 0, this.g1t = void 0, this.f1t = 0, this.p1t = 0, this.v1t = void 0, this.M1t = void 0, this.E1t = void 0, this.Lz = Vector_1.Vector.Create(), this.S1t = Vector_1.Vector.Create(), this._ka = Vector_1.Vector.Create(), this.uka = Vector_1.Vector.Create(), this.y1t = Vector_1.Vector.Create(), this.I1t = void 0, this.T1t = void 0, this.L1t = void 0, this.D1t = void 0, this.R1t = void 0, this.U1t = void 0, this.A1t = void 0, this.P1t = void 0, this.x1t = void 0, this.w1t = void 0, this.txl = void 0, this.bk_ = void 0, this.B1t = void 0, this.b1t = void 0, this.q1t = void 0, this.G1t = void 0, this.N1t = void 0, this.O1t = void 0, this.HasHideTag = !1, this.HasDeadTag = !1, this.HasFightTag = !1, this.HasFallDownTag = !1, this.Camp = 1, this.k1t = "", this.DistanceSquared = 0, this.OriginalHp = 0, this.u$e = t => {
      this.I1t && this.I1t(t)
    }, this.zrt = (t, i) => {
  ...
  GetHpAndShieldPercent() {
    var [t, i] = this.GetHpAndMaxHp(), s = this.GetShield();
    let h = s <= i ? s / i : 1;
    return [t / i, h]
  }
  GetWorldLocation() {
    var t;
    return this.C1t ? this.uka.FromUeVector(this.tfe.D_GetSocketLocation(this.g1t)) : (t = this.ActorComponent.ActorLocationProxy, this.uka.FromUeVector(t)), this.CommonParam.DrawHeadStateSocket && UE.KismetSystemLibrary.D_DrawDebugSphere(GlobalData_1.GlobalData.World, this.S1t.ToUeVector(), 4, 8, ColorUtils_1.ColorUtils.LinearYellow, 0, 3), this.uka.Equals(this._ka, UPDATE_TOLERATION) || (this._ka.FromUeVector(this.uka), this.S1t.FromUeVector(this._ka), this.Lz.FromUeVector(this.ActorComponent.ActorGravityDirectProxy), this.Lz.MultiplyEqual(-this.f1t), this.S1t.AdditionEqual(this.Lz), 0 !== this.p1t && (CameraController_1.CameraController.CameraLocation.Subtraction(this.S1t, this.y1t), this.y1t.Normalize(), this.y1t.MultiplyEqual(this.p1t), this.S1t.Addition(this.y1t, this.S1t))), this.S1t
  }
  RefreshDistance() {
  ...
  GetHardnessColor() {
    if (this.u1t) {
      ...
      if (t) return t = t.PropertyId, t = ConfigManager_1.ConfigManager.BattleUiConfig.GetPropertyType(t), ModelManager_1.ModelManager.BattleUiModel.GetPropertyColor(t)
    }
  }
  GetHpColor() {
    return this.k1t
  ...
  GetMoraleLevel() {
    return this.u1t ? this.u1t.GetAttributeComponent()?.MoraleLevel ?? 0 : 0
  }
}
