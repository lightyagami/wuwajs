...
class HeadStateData {
  ...
  Initialize(t) {
    ...
    this.Xte = t.GetComponent(215);
    this.l1t = t.GetComponent(78);
    this._1t = t.GetComponent(157);
    this.CreatureDataComponent = t.GetComponent(0);
    this.c1t = this.Entity.GetComponent(21);
    this.m1t = this.Entity.GetComponent(183);
    this.d1t = this.Entity.GetComponent(138);
