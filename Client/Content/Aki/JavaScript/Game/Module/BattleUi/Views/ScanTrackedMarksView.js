...
class ScanTrackedMarksView extends BattleChildView_1.BattleChildView {
  constructor() {
    super(...arguments), this.wmt = new Map, this.Bmt = new Set, this.bmt = (s, e) => {
          ...
          for (const _ of e.ScanInfos) {
            ...
            if (0 !== _.IconPath.length) {
              ResourceSystem_1.ResourceSystem.LoadAsync(_.IconPath, UE.LGUISpriteData_BaseObject, e => {
                var t, i;
                e && e.IsValid() && n && this.Bmt.has(s) && (t = Vector_1.Vector.Create(_.Offset), i = r.GetComponent(1), GravityUtils_1.GravityUtils.RotatedVectorByActorInitGravity(i, t), this.qmt(s, e, 0, "", void 0, n, Vector_1.Vector.Create(t), c, a, o))
              });
              break
            }
          }
  ...
  qmt(e, t, i, s, r, n, a, o, _, c) {
    this.wmt.has(e) || (t = new ScanTrackedMarks_1.ScanTrackedMarks(this.RootItem, t, i, s, r, n, a, o, _, c), this.wmt.set(e, t))
  }
  yWe() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ScanTrackedStart, this.bmt), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ScanTrackedEnd, this.Gmt)
  }
  Nmt() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ScanTrackedStart, this.bmt), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ScanTrackedEnd, this.Gmt)
  }
  DestroyOverride() {
    return !0
  }
