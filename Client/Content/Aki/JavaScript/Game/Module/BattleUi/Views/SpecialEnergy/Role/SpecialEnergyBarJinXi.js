...
class SpecialEnergyBarMorphJinXi extends SpecialEnergyBarMorph_1.SpecialEnergyBarMorph {
  ...
  OnBeforeShow() {
    super.OnBeforeShow(), this.NiagaraList[0] && this.BarItem.ReplaceFullEffect(this.NiagaraList[0])
  }
  OnStart() {
    super.OnStart();
    var r = this.Config.SlotNum - 1;
    for (let e = 0; e < r; e++) this.BarItem.SetGraduateItemOffset(e, this.Config.ExtraFloatParams[e + 1])
  }
