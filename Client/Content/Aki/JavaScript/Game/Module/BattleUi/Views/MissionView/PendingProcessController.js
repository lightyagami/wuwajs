...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PendingProcessController = exports.StepConditionIndexChangeProcess = exports.ShowQuestUpdateTipsProcess = exports.MissionItemViewRefreshProcess = exports.MissionItemViewEndTrackProcess = exports.MissionItemViewStartTrackProcess = exports.PendingProcess = void 0;
...
class PendingProcess {
  constructor(e, s) {
    this.ProcessType = e, this.IsSkipAnim = s, this.ProcessId = 0, this.ProcessId = ++PendingProcess.Id
  }
...
class StepConditionIndexChangeProcess extends PendingProcess {
  constructor(e, s, t) {
    super(4, !1), this.ViewId = e, this.StepId = s, this.CurConditionTextIndex = t
  }
}
...
class PendingProcessController extends MissionPanelControllerBase_1.MissionPanelControllerBase {
  constructor(e, s, t, i, n, r) {
    super(), this.CheckDeleteSameTreeHandle = e, this.MissionItemViewStartTrackHandle = s, this.MissionItemViewEndTrackHandle = t, this.MissionItemViewRefreshHandle = i, this.ShowQuestUpdateTipsHandle = n, this.StepConditionIndexChange = r, this.ControllerType = 0, this.KZe = [], this.Qfc = new Queue_1.Queue, this.QZe = void 0, this.aO_ = 0, this.Gd_ = e => {
      e ? ModelManager_1.ModelManager.FishingQuestModel.StartShowTrackText(ModelManager_1.ModelManager.FishingQuestModel.CurrentTraceEntrust, 5) : this.YU_(this.aO_, 5)
    }, this.toc = e => {
      this.YU_(this.aO_, 6), e && ModelManager_1.ModelManager.FishingQuestModel.StartShowTrackText(e, 6)
      ...
      if (ModelManager_1.ModelManager.FishingModel.GetShipData().IsShipDriving()) {
        ...
        var t = "Disabled" !== ModelManager_1.ModelManager.AutoRunModel.GetAutoRunMode();
        this.aO_ === e.Id ? this.YZe(new MissionItemViewRefreshProcess(e, t)) : this.YZe(new MissionItemViewStartTrackProcess(e, s, t)), this.aO_ = e.Id
      }
    }, this.YU_ = (e, s) => {
      let t = "Disabled" !== ModelManager_1.ModelManager.AutoRunModel.GetAutoRunMode();
      switch (s) {
        case 5:
          break;
        case 6:
      ...
      this.CheckDeleteSameTreeHandle() && this.$Ze(e.Id), this.YZe(new MissionItemViewStartTrackProcess(e, s, t))
    }, this.JZe = (e, s, t) => {
      this.CheckDeleteSameTreeHandle() && this.$Ze(e), this.YZe(new MissionItemViewEndTrackProcess(e, s, t))
    }, this.zZe = (e, s) => {
  ...
  KOn(e) {
    this.QZe ? this.Qfc.Push(e) : this.KZe.unshift(e)
  }
  async ProcessCacheList() {
    if (0 !== this.KZe.length && !this.QZe) {
      ...
      for (e && this.KZe[0].ProcessId === this.QZe.ProcessId && this.KZe.shift(), 3 === this.QZe.ProcessType && this.KOn(new MissionItemViewRefreshProcess(this.QZe.Info.MissionViewShowData, this.QZe.Info.IsSkipAnim)); !this.Qfc.Empty;) this.KZe.unshift(this.Qfc.Pop());
      this.QZe = void 0
    }
  }
  GetCurrentProcess() {
