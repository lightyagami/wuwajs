...
class SpecialEnergyBarContainer extends BattleVisibleChildView_1.BattleVisibleChildView {
  constructor() {
    super(...arguments), this.Mdt = void 0, this.E0 = 0, this.Edt = void 0, this.Sdt = new Map, this.kpe = () => {
      this.ydt(), this.Idt()
    }
  }
  Initialize(e) {
    super.Initialize(e), this.InitChildType(25), this.Mdt = e, this.E0 = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity?.Id ?? 0, this.ydt(), this.Idt(), this.Ore()
  }
  OnBeforeDestroy() {
    this.Edt = void 0;
  ...
  OnChangeRole(e) {
    var i;
    this.E0 = e?.EntityHandle?.Id ?? 0, Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "开始切换特殊能量条", ["entityId", this.E0]), this.E0 && (ModelManager_1.ModelManager.BattleUiModel.SpecialEnergyBarData.IsSpecialEnergyBarEditorModeOpen && (i = this.Sdt.get(this.E0)) && (i.Destroy(), this.Sdt.delete(this.E0)), this.Tdt(e)), this.Idt()
  }
  OnRemoveEntity(e) {
    var i = this.Sdt.get(e);
    i && (i.Destroy(), this.Sdt.delete(e), this.Edt === i) && (this.Edt = void 0)
  }
  Ore() {
  ...
  ydt() {
    for (const i of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems(!0)) {
      var e = i.EntityHandle?.Id;
      e && (e = ModelManager_1.ModelManager.BattleUiModel.GetRoleData(e)) && this.Tdt(e)
    }
  }
  async Tdt(i) {
  ...
  Idt() {
    for (var [e, i] of this.Sdt) e === this.E0 ? (i.SetVisible(!0), this.Edt = i) : i.SetVisible(!1)
  }
}
