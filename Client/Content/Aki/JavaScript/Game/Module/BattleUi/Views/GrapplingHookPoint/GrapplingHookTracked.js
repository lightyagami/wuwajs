...
class GrapplingHookTracked extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.tlt = !1, this.hwe = new UE.Rotator, this.Due = void 0, this.ilt = () => {
      this.Due && BattleUiControl_1.BattleUiControl.FocusToTargetLocation(this.Due)
  ...
  Refresh(t, e) {
    var s;
    this.tlt && (s = this.GetItem(0), this.hwe.Pitch = 0, this.hwe.Yaw = Math.atan2(t.Y, t.X) * RAD_2_DEG - 90, this.hwe.Roll = 0, s.SetUIRelativeRotation(this.hwe), this.RootItem.SetAnchorOffset(t), this.Due = e)
  }
