...
class SpecialEnergyBaIconHandle {
  constructor() {
    this.B1l = void 0, this.OOi = void 0, this.Cdt = ResourceSystem_1.ResourceSystem.InvalidId, this.gdt = !1, this.fdt = void 0
  }
  Init(s, e = void 0) {
  ...
  SetIcon(s) {
    ...
    s && (this.Cdt = ResourceSystem_1.ResourceSystem.LoadAsync(s, UE.Texture2D, s => {
  ...
  PlayEndAnim(s) {
    if (this.gdt !== s)
      if (this.gdt = s, this.Est(), s)
        for (const e of this.fdt) e.Play();
      else {
  ...
  OnBeforeDestroy() {
    this.PlayEndAnim(!1), this.Cdt !== ResourceSystem_1.ResourceSystem.InvalidId && (ResourceSystem_1.ResourceSystem.CancelAsyncLoad(this.Cdt), this.Cdt = ResourceSystem_1.ResourceSystem.InvalidId)
  }
}
