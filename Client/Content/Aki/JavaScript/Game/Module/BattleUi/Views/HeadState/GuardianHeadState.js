...
class GuardianHeadState extends HeadStateViewBase_1.HeadStateViewBase {
  ...
  RefreshHp(e = !1) {
    var [t, s] = this.GetHpAndMaxHp(), t = t / s;
  ...
  ast(e) {
    var t = this.GetSprite(1),
      t = (t.SetFillAmount(e), t.IsUIActiveSelf() || t.SetUIActive(!0), this.GetSprite(2));
    t.SetStretchLeft(this.pnt * this.CurrentBarPercent - 2), t.SetStretchRight(this.pnt * (1 - e) - 2)
  }
  Hlt() {
