...
class CommonHeadState extends HeadStateViewBase_1.HeadStateViewBase {
  constructor() {
    super(...arguments), this.mkn = new BuffItemContainer_1.BuffItemContainer, this.pnt = 0, this.OnAddOrRemoveBuff = (t, e, i, s) => {
      this.HeadStateData.GetEntityId() === t && (i ? this.mkn.AddBuffByCue(e, s, !0) : this.mkn.RemoveBuffByCue(e, s, !0))
  ...
  ActiveBattleHeadState(t) {
    super.ActiveBattleHeadState(t), this.RefreshHpAndShield(), this.Olt(), this.klt(), this.Flt(), this.Vlt(), this.tst(), this.Hlt()
  }
  OnStart() {
    this.pnt = this.GetSprite(2).GetParentAsUIItem().GetWidth(), this.mkn.Init(this.GetItem(5), void 0, !0)
  }
  OnBeforeShow() {
  ...
  klt() {
    ...
    this.GetItem(4).SetUIActive(t), this.MoraleLevelItem?.SetUiActive(t)
  }
  Flt() {
  ...
  RefreshHpAndShield(t = !1) {
    ...
    this.Cst(e), this.gst(i), t ? this.PlayBarAnimation(e) : this.StopBarLerpAnimation()
  }
  ...
  Olt() {
    var t, e, i;
    this.HeadStateData && (t = this.GetLevel(), e = this.GetText(3), i = ConfigManager_1.ConfigManager.BattleUiConfig.GetThreadColor(t, this.HeadStateData.Camp), e.SetColor(UE.Color.FromHex(i)), LguiUtil_1.LguiUtil.SetLocalText(e, "LevelShow", t))
  }
