...
class BattleChildView extends UiPanelBase_1.UiPanelBase {
  async NewByResourceId(e, t, i = !1, s) {
    this.OpenParam = s, await this.CreateThenShowByResourceIdAsync(t, e, i), this.Initialize(this.OpenParam), await this.InitializeAsync(this.OpenParam)
  }
  async NewByRootActorAsync(e, t) {
    this.OpenParam = t, await this.CreateByActorAsync(e, t), this.Initialize(this.OpenParam), await this.InitializeAsync(this.OpenParam)
  }
  Initialize(e) {}
