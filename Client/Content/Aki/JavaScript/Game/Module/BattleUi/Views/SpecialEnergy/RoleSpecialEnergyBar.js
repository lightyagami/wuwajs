...
const ModelManager_1 = require("../../../../Manager/ModelManager"),
  ...
  SpecialEnergyBarKaTiXiYa_1 = require("./Role/SpecialEnergyBarKaTiXiYa"),
  ...
  SpecialEnergyBarLuPa_1 = require("./Role/SpecialEnergyBarLuPa"),
  ...
  SpecialEnergyBarMorphPlayUse_1 = require("./SpecialEnergyBarMorphPlayUse"),
  ...
  udt(e) {
    if (e?.EntityHandle?.Valid) {
      ...
      if (e) {
        ...
        if (0 !== e) return ModelManager_1.ModelManager.BattleUiModel.SpecialEnergyBarData.GetSpecialEnergyBarInfo(e)
      }
    }
  }
  async cdt(e, a, r, i) {
    ...
    l.InitData(a, i), this.hdt.set(r, l), await l.InitByPathAsync(e, i.PrefabPath)
  }
  _dt(a = !1) {
    if (this.hdt.size <= 1) this.hdt.get(0)?.SetVisible(!0, 1);
    else {
      var r, i, n = this.Wst?.GameplayTagComponent;
      let e = 0;
