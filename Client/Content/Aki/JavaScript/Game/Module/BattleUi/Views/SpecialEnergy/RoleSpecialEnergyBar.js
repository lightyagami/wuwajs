...
exports.RoleSpecialEnergyBar = undefined;
const ModelManager_1 = require("../../../../Manager/ModelManager");
const SpecialEnergyBarAiMiSi_1 = require("./Role/SpecialEnergyBarAiMiSi");
...
const SpecialEnergyBarKaTiXiYa_1 = require("./Role/SpecialEnergyBarKaTiXiYa");
const SpecialEnergyBarKeLaiTa_1 = require("./Role/SpecialEnergyBarKeLaiTa");
const SpecialEnergyBarKeLaiTaUltra_1 = require("./Role/SpecialEnergyBarKeLaiTaUltra");
const SpecialEnergyBarLinNai_1 = require("./Role/SpecialEnergyBarLinNai");
const SpecialEnergyBarLuhes_1 = require("./Role/SpecialEnergyBarLuhes");
...
const SpecialEnergyBarMoNing_1 = require("./Role/SpecialEnergyBarMoNing");
...
const SpecialEnergyBarXiangLiYao_1 = require("./Role/SpecialEnergyBarXiangLiYao");
const SpecialEnergyBarYouNuo_1 = require("./Role/SpecialEnergyBarYouNuo");
const SpecialEnergyBarZanni_1 = require("./Role/SpecialEnergyBarZanni");
const SpecialEnergyBarZheZhi_1 = require("./Role/SpecialEnergyBarZheZhi");
...
const SpecialEnergyBarMorphPlayUse_1 = require("./SpecialEnergyBarMorphPlayUse");
...
class RoleSpecialEnergyBar {
  ...
  async InitAsync(e, a) {
    ...
    if (r) {
      var i = [];
      i.push(this.cdt(e, a, 0, r));
      if (r.TagEnergyBarIdMap) {
        for (var [n, l] of r.TagEnergyBarIdMap) {
          this.mdt(n, this.lne);
          l = ModelManager_1.ModelManager.BattleUiModel.SpecialEnergyBarData.GetSpecialEnergyBarInfo(l);
          if (l) {
            i.push(this.cdt(e, a, n, l));
          }
        }
      }
      this._dt();
  ...
  udt(e) {
    if (e?.EntityHandle?.Valid) {
      ...
      if (e) {
        ...
        if (e !== 0) {
          return ModelManager_1.ModelManager.BattleUiModel.SpecialEnergyBarData.GetSpecialEnergyBarInfo(e);
        }
      }
    }
  }
  ...
  _dt(a = false) {
    if (this.hdt.size <= 1) {
      this.hdt.get(0)?.SetVisible(true, 1);
    } else {
      var r;
      var i;
      ...
      for ([r, i] of this.hdt) {
        ...
        i.SetVisible(l, 1);
        if (a) {
          i.OnChangeVisibleByTagChange(l);
        }
      }
    }
  }
  mdt(e, a) {
    ...
    if (r) {
      r = r.ListenForTagAddOrRemove(e, a);
      this.ldt.push(r);
    }
  }
  FYe() {
