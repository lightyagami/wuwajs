...
const UE = require("ue"),
  ...
  actionNameList = [InputMappingsDefine_1.actionMappings.向前移动, InputMappingsDefine_1.actionMappings.向后移动];
class MoveSkillPanel extends BattleVisibleChildView_1.BattleVisibleChildView {
  constructor() {
    super(...arguments), this.det = [], this.bMe = (i, t) => {
      0 === t && (i === InputMappingsDefine_1.actionMappings.向前移动 ? this.det[0].OnInputAction() : i === InputMappingsDefine_1.actionMappings.向后移动 && this.det[1].OnInputAction())
    }
  }
  CreateDynamic(i) {
  ...
  Cet() {
    this.det[0].RefreshByMoveType(InputEnums_1.EInputAxis.MoveForward, 1), this.det[1].RefreshByMoveType(InputEnums_1.EInputAxis.MoveForward, -1), this.det[0].RefreshKeyByActionName(InputMappingsDefine_1.actionMappings.向前移动), this.det[1].RefreshKeyByActionName(InputMappingsDefine_1.actionMappings.向后移动), this.det[0].RefreshSkillIconByResId("SP_IconVision01A"), this.det[1].RefreshSkillIconByResId("SP_IconVision01B")
  }
  Tick(i) {
