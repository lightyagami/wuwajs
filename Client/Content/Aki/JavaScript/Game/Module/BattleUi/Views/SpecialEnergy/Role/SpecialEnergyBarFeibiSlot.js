...
class SpecialEnergyBarFeibiSlot extends SpecialEnergyBarSlot_1.SpecialEnergyBarSlot {
  ...
  OnStart() {
    if (this.Config?.EffectColor) {
      ...
      for (const E of this.SlotItemList) E.SetBarColor(e), E.SetChangeEffectColor(t)
    }
    super.OnStart()
  }
  RefreshBarPercent(t = !1) {
    ...
    for (let e = 0; e < this.SlotItemList.length; e++) {
      ...
      r.UpdatePercentWithFullEffect(s, i, t), this.rdt[e] > i && !t && (r.SetChangeEffectOffsetX(CHANGE_EFFECT_OFFSET_X + CHANGE_EFFECT_WIDTH * i), r.PlayChangeEffectWithPercent(this.rdt[e] - i)), this.rdt[e] = i
    }
