...
class XiaKongQteSkillItem extends BattleSkillItem_1.BattleSkillItem {
  ...
  Fwc(e) {
    if (!Info_1.Info.IsInTouch()) return 1 === e ? InputMappingsDefine_1.actionMappings.向右移动 : 2 === e ? InputMappingsDefine_1.actionMappings.向左移动 : 4 === e ? InputMappingsDefine_1.actionMappings.大招 : void 0
  }
  Nwc(e) {
    2 === Info_1.Info.OperationType && this.KeyActionName !== e && (this.KeyItem && (this.KeyItem.RefreshByActionOrAxis({
      ActionOrAxisName: e
    }), this.KeyItem.SetActive(!0)), this.KeyActionName = e)
  }
  ...
  SetSkillIconName(e) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.SkillNameText, e), this.SkillNameText.SetUIActive(!0)
  }
  RefreshSkillName() {}
}
