...
class BattleUiTweenAnimPlayer {
  ...
  InitTweenAnim(e, t) {
    var i = [],
      s = t.GetOwner().K2_GetComponentsByClass(UE.LGUIPlayTweenComponent.StaticClass()),
      n = s.Num();
    for (let e = 0; e < n; e++) i.push(s.Get(e));
    this.TweenAnimMap || (this.TweenAnimMap = new Map), this.TweenAnimMap.set(e, i)
  }
  PlayTweenAnim(e) {
    e = this.TweenAnimMap.get(e);
    if (e)
      for (const t of e) t.Play()
  }
  StopTweenAnim(e) {
    e = this.TweenAnimMap.get(e);
    if (e)
