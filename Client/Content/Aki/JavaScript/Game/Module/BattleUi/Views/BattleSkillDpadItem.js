...
class BattleSkillDpadItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    this.x5e.push(this.GetItem(1)), this.x5e.push(this.GetItem(2)), this.x5e.push(this.GetItem(3)), this.x5e.push(this.GetItem(4))
  }
  SetVisible(t) {
    t ? this.IsShowOrShowing || this.Show() : this.IsShowOrShowing && this.Hide()
  }
  SetArrowVisible(t, e) {
