...
class SpecialEnergyBarKeLaiTaUltra extends SpecialEnergyBarBase_1.SpecialEnergyBarBase {
  constructor() {
    super(...arguments), this.qdt = 0, this.S4l = [], this.M4l = [], this.bst = void 0, this.p2a = 0, this.Yjl = !1, this.E4l = t => {
      this.dbl(t)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var t = [];
    t.push(this.LoadEffects()), t.push(this.InitKeyItem(this.GetItem(0))), await Promise.all(t)
  }
  OnStart() {
    for (let t = 0; t < NUM; t++) this.S4l.push(this.GetItem(1 + t)), this.M4l.push(this.GetItem(5 + t)), this.InitTweenAnim(11 + t);
  ...
  dbl(t = -1, s = !1) {
    let i = t;
    if (i < 0 && (i = this.TagComponent?.GetTagCount(numTagId) ?? 0), (i = NUM - i) !== this.qdt || s) {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "【能量条】柯莱塔大招进度更新", ["num", i]);
      t = i >= NUM;
      if (s)
        for (let t = 0; t < NUM; t++) {
          var e = t < i;
          ...
          for (let t = this.qdt; t < i; t++) this.PlayTweenAnim(11 + t);
  ...
  Tick(t) {
    super.Tick(t), this.bst && this.BuffComponent?.GetBuffByHandle(this.p2a) || this.tst(), this.bst && this.zjl(this.bst.GetRemainDuration() < this.Config.ExtraFloatParams[0])
  }
  tst() {
  ...
  zjl(t) {
    t !== this.Yjl && ((this.Yjl = t) ? this.PlayTweenAnim(15) : (this.StopTweenAnim(15), this.GetItem(16)?.SetAlpha(1)))
  }
}
