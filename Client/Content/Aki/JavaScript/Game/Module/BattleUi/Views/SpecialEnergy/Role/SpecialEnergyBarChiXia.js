...
class SpecialEnergyBarChiXia extends SpecialEnergyBarPointGraduate_1.SpecialEnergyBarPointGraduate {
  constructor() {
    super(...arguments), this.lne = (t, e) => {
      if (e) {
        ...
        let t = 0 < s ? e / s : 0;
        0 <= t ? (this.SetGraduateItemOffset(0, t), this.GraduateItemList[0].SetUIActive(!0)) : this.GraduateItemList[0].SetUIActive(!1)
  ...
  AddEvents() {
    super.AddEvents(), this.ListenForTagAddOrRemoveChanged(1280168885, this.lne)
  }
  RemoveEvents() {
    super.RemoveEvents()
  }
  ...
  RefreshBarPercent(t = !1) {
    var e = this.PercentMachine.GetCurPercent(),
      e = (this.PointItem.UpdatePercent(e), this.KeyItem?.RefreshKeyEnable(e >= this.Config.DisableKeyOnPercent, t), this.AttributeComponent.GetCurrentValue(this.Config.AttributeId));
