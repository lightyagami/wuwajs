...
class BattleSkillCombineItem extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    ...
    this.Qtt = new CommonKeyItem_1.CommonKeyItem, await this.Qtt.CreateThenShowByActorAsync(e.GetOwner()), this.Qtt.RefreshAction(InputMappingsDefine_1.actionMappings.组合主键)
  }
  OnStart() {}
  SetVisible(e) {
    e ? this.IsShowOrShowing || this.Show() : this.IsShowOrShowing && this.Hide()
  }
  Refresh() {
