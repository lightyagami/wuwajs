...
class SpecialEnergyBarZheZhi extends SpecialEnergyBarSlot_1.SpecialEnergyBarSlot {
  ...
  OnInitData() {
    ...
    if (e) {
      ...
      for (let e = 0; e < SUMMON_NUM && !(e > t.length - 1); e++) {
        ...
        r?.IsInit ? this.wca.push(r) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 17, "折枝能量条读取伴生物实体时异常", ["creatureDataId", t[e]])
      }
    }
  }
  AddEvents() {
    ...
    for (const t of this.wca) {
      var e = t.Entity?.GetComponent(205);
      e && (e = e.ListenForTagAddOrRemove(-1285044114, this.bca)) && this.TagTaskList.push(e)
    }
  }
  qca() {
    this.Bca = 0;
    for (const e of this.wca)(e.Entity?.GetComponent(205))?.HasTag(-1285044114) && this.Bca++;
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "【能量条】折枝飞鹤数量更新", ["", this.Bca])
  }
  OnStart() {
    for (let e = 0; e < this.SlotItemList.length; e++) this.SlotItemList[e].SetEffectItemNiagaraParam("Color_Offset", extraEnergyEffectParams[e]);
  ...
  RefreshBarPercent(e = !1) {
    ...
    for (let e = 0; e < this.SlotItemList.length; e++) {
      ...
      e < this.Bca ? (a.UpdatePercent(0, !1, !0), a.SetEffectItemVisible(!0)) : (a.UpdatePercent(t * this.SlotNum - (e - this.Bca), r, !0), a.SetEffectItemVisible(!1))
    }
