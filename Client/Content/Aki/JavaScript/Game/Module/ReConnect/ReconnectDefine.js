...
exports.ellipsis = exports.reconnectMapName = exports.EBackLoginViewReason = exports.ELogoutReason = exports.EReconnectProcessStep = undefined;
const UE = require("ue");
var EReconnectProcessStep;
var ELogoutReason;
var EBackLoginViewReason;
(function (e) {
  ...
  e[e.Max = 9] = "Max";
})(EReconnectProcessStep = exports.EReconnectProcessStep ||= {});
(function (e) {
...
})(EBackLoginViewReason = exports.EBackLoginViewReason ||= {});
exports.reconnectMapName = new UE.FName("/Game/Aki/Map/Launch/Bootstrap");
exports.ellipsis = ["", ".", "..", "..."]; //# sourceMappingURL=ReconnectDefine.js.map