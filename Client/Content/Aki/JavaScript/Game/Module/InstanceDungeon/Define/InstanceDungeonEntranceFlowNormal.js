...
class InstanceDungeonEntranceFlowNormal extends InstanceDungeonEntranceFlowBase_1.InstanceDungeonEntranceFlowBase {
  OnCreate() {
    this.AddStep(() => {
      ...
      let n = void 0;
      n = new(9e3 === e ? SolarSpeedInstanceDungeonViewModel_1.SolarSpeedInstanceDungeonViewModel : BaseInstanceDungeonViewModel_1.BaseInstanceDungeonViewModel), UiManager_1.UiManager.OpenView("InstanceDungeonEntranceView", n)
    }), this.AddStep(() => {
