...
class InstanceDungeonEntranceFlowTowerDefense extends InstanceDungeonEntranceFlowBase_1.InstanceDungeonEntranceFlowBase {
  OnCreate() {
    this.AddStep(() => {
      ...
      EditBattleTeamController_1.EditBattleTeamController.PlayerOpenEditBattleTeamView(ModelManager_1.ModelManager.InstanceDungeonEntranceModel.InstanceId), TowerDefenceController_1.TowerDefenseController.SetPhantomViewOpened(!1)
    }), this.AddStep(() => {
      TowerDefenceController_1.TowerDefenseController.EnterTowerDefense().then(e => {
        EditBattleTeamController_1.EditBattleTeamController.CloseEditBattleTeamView(), e ? (this.Reset(), TowerDefenceController_1.TowerDefenseController.SetIsUiFlowOpen(!1)) : this.RevertStep()
      })
    })
  }
  OnEditBattleViewCloseCall() {
    TowerDefenceController_1.TowerDefenseController.SetIsUiFlowOpen(!1)
  }
}
