...
class InstanceDungeonEntranceFlowRoguelike extends InstanceDungeonEntranceFlowBase_1.InstanceDungeonEntranceFlowBase {
  OnCreate() {
    this.AddStep(() => {
      ...
      RoguelikeController_1.RoguelikeController.RoguelikeStartRequest(!1, ModelManager_1.ModelManager.InstanceDungeonEntranceModel.InstanceId, ModelManager_1.ModelManager.RoguelikeModel.EditFormationRoleList)
    })
  }
}
