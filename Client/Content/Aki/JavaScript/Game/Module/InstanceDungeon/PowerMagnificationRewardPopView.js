...
exports.PowerMagnificationRewardPopView = undefined;
const UE = require("ue");
...
const PowerRewardButtonItem_1 = require("./PowerRewardButtonItem");
const POWER_MAGIFICATION_REWARD_HELPID = 128;
class PowerMagnificationRewardPopView extends UiViewBase_1.UiViewBase {
  ...
  async OnBeforeStartAsync() {
    ...
    if (this.Pe) {
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "Magnification_Title");
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "Magnification_Desc");
      this.gal = new PowerRewardButtonItem_1.PowerRewardButtonItem();
      this.pal = new PowerRewardButtonItem_1.PowerRewardButtonItem();
      await Promise.all([this.fal(), this.gal.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()), this.pal.CreateThenShowByActorAsync(this.GetItem(3).GetOwner())]);
  ...
  OnBeforeDestroy() {
    if (this.Pe?.NeedResetLevelPlayModelRewardFlag) {
