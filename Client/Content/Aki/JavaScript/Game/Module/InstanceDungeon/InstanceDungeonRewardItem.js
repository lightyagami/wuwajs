...
class InstanceDungeonRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.eGe = void 0, this.W1i = -1, this.YVe = () => {
  ...
  Refresh(e, t, r) {
    ...
    this.eGe.RefreshByData(n), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "InstanceRewardDes", e[0]), this.W1i = e[0]
  }
  SetCurrentItem(e) {
