...
class InstanceDungeonModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.NUe = 0, this.FUc = !1, this.R1i = void 0, this.U1i = new Map, this.A1i = new Array, this.P1i = new Map, this.x1i = void 0, this.w1i = new Map, this.InstanceFinishSuccess = 0, this.InstanceRewardHaveTake = !1, this.B1i = void 0, this.b1i = void 0, this.q1i = void 0, this.CurrentInstanceIsFinish = !1, this.HidePowerLackConfirmBox = !1, this.InstanceEnterContentText = new Protocol_1.Aki.Protocol.$ah, this.TrialRoleDungeonWhiteList = [], this.Zb1 = new Set
  }
  OnLeaveLevel() {
    return this.B1i?.SetTrack(!1), this.InstanceFinishSuccess = 0, this.InstanceRewardHaveTake = !1, this.ClearInstanceDungeonInfo(), !0
  }
  GetInstanceId() {
    return this.NUe
  }
  ...
  GetMatchTeamName(t) {
    for (const e of this.R1i.TRs)
      if (e.W5n === t) return e.JMs;
    Log_1.Log.CheckError() && Log_1.Log.Error("InstanceDungeon", 5, "获取匹配副本队伍队员信息失败", ["队员Id", t])
  }
  GetMatchTeamOnlineId(t) {
    for (const e of this.R1i.TRs)
      if (e.W5n === t) return e.Qxa;
    Log_1.Log.CheckError() && Log_1.Log.Error("InstanceDungeon", 5, "获取匹配副本队伍队员信息失败", ["队员Id", t])
  }
  GetMatchTeamRoleCfgId(t) {
    ...
    for (const r of this.R1i.TRs)
      if (r.W5n === t)
        for (const a of r.J6n) e.push(a.Q6n);
    return e
  }
  IsMatchTeamHost() {
  ...
  IsAllPlayerInMatchTeam() {
    ...
    let e = !0;
    for (const a of ModelManager_1.ModelManager.OnlineModel.GetAllWorldTeamPlayer()) t.includes(a) || (e = !1);
    return e
  }
  InitMatchingTeamConfirmReadyState(t) {
    for (const e of t) {
      this.U1i.set(e.W5n, e.ybs), this.P1i.set(e.W5n, e.D9n);
      for (const r of this.A1i) r.GetPlayerId() === e.W5n && r.SetIsReady(e.D9n)
    }
  }
    ...
    if (t) {
      for (const r of t.TRs)
        for (const a of r.J6n) {
          ...
          e.SetPlayerId(r.W5n), e.SetIsReady(this.GetPrewarPlayerReadyState(r.W5n)), e.SetLife(1), e.SetMaxLife(1), this.Kzs(e, a), this.A1i.push(e)
        }
      this.N1i()
    }
  }
  AddPrewarFormationDataByPlayerInfo(t, e = !0) {
    ...
    for (const a of t.J6n) {
      ...
      r.SetPlayerId(t.W5n), r.SetIsReady(this.GetPrewarPlayerReadyState(t.W5n)), r.SetLife(1), r.SetMaxLife(1), this.Kzs(r, a), this.A1i.push(r)
    }
    this.N1i()
  }
  N1i() {
    ...
    let e = 1,
      r = 1;
    for (const a of this.A1i) a.GetPlayerId() === t && (a.SetIndex(e++), a.SetOnlineNumber(r));
    r++;
    for (const n of this.A1i) n.GetPlayerId() !== t && (n.SetIndex(e++), n.SetOnlineNumber(r++));
    this.A1i.sort((t, e) => t.GetIndex() - e.GetIndex())
  }
  SetMatchTeamInfoPlayerRole(t, e) {
    for (const n of this.R1i.TRs) {
      var r, a;
      n.W5n === t && (r = n.J6n.length, a = e.length, n.J6n = e, r === a && this.O1i(n), r < a && (this.k1i(t), this.AddPrewarFormationDataByPlayerInfo(n, !1)), a < r) && this.F1i(n)
    }
  ...
  RemovePrewarFormationDataByPlayer(e) {
    let r = !1;
    for (let t = this.A1i.length - 1; 0 <= t; --t) this.A1i[t].GetPlayerId() === e && (r = !0, this.A1i.splice(t, 1), this.RemovePrewarPlayerReadyState(e), this.RemoveMatchingTeamConfirmState(e));
  ...
  k1i(e) {
    for (let t = this.A1i.length - 1; 0 <= t; --t) this.A1i[t].GetPlayerId() === e && this.A1i.splice(t, 1)
  }
  IsInPrewarFormation(t) {
    for (const e of this.A1i)
      if (e.GetPlayerId() === t) return !0;
    return !1
  }
  ClearPrewarData() {
    this.A1i.length = 0
  ...
  CheckPrewarFormationAverageLowLevel(t) {
    ...
    var e = this.FormationAverageRoleLevel,
      [r, a] = ModelManager_1.ModelManager.ActivityModel.CheckActivityLevelBelongToType(t);
    return r ? e < ModelManager_1.ModelManager.ActivityModel.GetActivityLevelRecommendLevel(t, ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel, a) : e < ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetRecommendLevel(t, ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel)
  }
  GetInstanceBeInviteDataList() {
    return this.x1i
  }
  AddInstanceBeInviteData(t) {
    t && (this.x1i ? this.RemoveInstanceBeInviteData(t.GetPlayerId()) : this.x1i = new Array, this.x1i.push(t))
  }
  ...
  CreateInstanceInfo(t) {
    return this.B1i = new InstanceDungeonInfo_1.InstanceDungeonInfo(t), this.B1i.InitConfig(), this.B1i
  }
  ClearInstanceDungeonInfo() {
    var t;
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("InstanceDungeon", 27, "尝试清除副本行为树"), this.B1i && (t = this.B1i, this.B1i = void 0, t.Destroy())
  }
  GetInstanceDungeonInfo() {
    return this.B1i
  }
  ResetData() {
    this.ClearPrewarData(), this.ClearPrewarPlayerReadyState(), this.ClearMatchingTeamConfirmState(), this.R1i = void 0
  }
  ...
  ConstructCurrentDungeonAreaName() {
    this.q1i = void 0, ModelManager_1.ModelManager.TowerModel.CheckInTower() && this.SetInstanceDungeonName(ModelManager_1.ModelManager.TowerModel.GetCurrentFloorName())
  }
  ...
  GetCurrentDungeonExitConfirmData() {
    ...
    return 0 !== t.ParseRuleType || 1 !== r && 2 !== r && 16 !== r || (ModelManager_1.ModelManager.InstanceDungeonEntranceModel.IsDungeonSupportArchive(e) ? (t.UnfinishedBoxId || (t.UnfinishedBoxId = 284), t.UnfinishedTelBoxId || (t.UnfinishedTelBoxId = 284)) : (t.UnfinishedBoxId || (t.UnfinishedBoxId = 285), t.UnfinishedTelBoxId || (t.UnfinishedTelBoxId = 285)), t.FinishBoxId || (t.FinishBoxId = 290), t.FinishTelBoxId) || (t.FinishTelBoxId = 290), t
  }
  GetCurrentDungeonExitConfirmId() {
    var t = this.GetCurrentDungeonExitConfirmData();
    return ModelManager_1.ModelManager.InstanceDungeonModel.InstanceFinishSuccess ? t.FinishBoxId : t.UnfinishedBoxId
  }
  GetCurrentDungeonTelExitConfirmId() {
    var t = this.GetCurrentDungeonExitConfirmData();
    return ModelManager_1.ModelManager.InstanceDungeonModel.InstanceFinishSuccess ? t.FinishTelBoxId : t.UnfinishedTelBoxId
  }
  ClearInstanceIdsWithSaveData() {
    this.Zb1.clear()
  }
  AddInstanceIdsWithSaveData(...t) {
    for (const e of t) this.Zb1.add(e)
  }
  GetIfInstanceHasSaveData(t) {
    return this.Zb1.has(t)
  }
}
