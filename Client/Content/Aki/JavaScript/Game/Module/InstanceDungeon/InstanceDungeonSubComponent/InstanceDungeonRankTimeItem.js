...
class InstanceDungeonRankTimeItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ItemModel = this.OpenParam, this.ComponentRegisterInfos = [
      [0, UE.UIButtonComponent],
      [1, UE.UIText]
    ], this.BtnBindInfo = [
      [0, this.ItemModel.ButtonClick]
    ]
  }
  Refresh() {
    var e = this.ItemModel.GetContent();
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.TextKey, ...e.Params), this.GetButton(0).RootUIComp.SetUIActive(!0)
  }
}
