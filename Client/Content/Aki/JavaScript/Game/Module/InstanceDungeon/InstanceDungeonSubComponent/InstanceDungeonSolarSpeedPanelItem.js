...
class InstanceDungeonSolarSpeedPanelItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(1), "BossRushCollectReward"), this.Uth?.HaveRefresh && this.RefreshItem()
  }
  async OnBeforeStartAsync() {
    return EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.SolarSpeedRewarded, this.O6_), Promise.resolve()
  }
  OnBeforeDestroy() {
  ...
  RefreshItem() {
    ...
    this.InAsyncLoading() ? this.Uth = {
      HaveRefresh: !0
    } : (e = ModelManager_1.ModelManager.SolarSpeedModel, this.GetItem(2).SetUIActive(e.HasRewardRedDot), LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(3), "parkour_award_2_1", e.CurrentCompletedCount, e.TotalRewardCount))
  }
}
