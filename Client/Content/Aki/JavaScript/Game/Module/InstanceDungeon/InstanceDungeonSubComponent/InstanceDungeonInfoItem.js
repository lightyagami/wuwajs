...
class InstanceDungeonInfoItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.NUe = 0, this.Qth = void 0, this.Kth = void 0, this.jzs = void 0, this.$th = void 0, this.Xth = void 0, this.gli = void 0, this.Yth = void 0, this.zth = void 0, this.Jth = void 0, this.Zth = void 0, this.ygl = void 0, this.eD_ = void 0, this.tD_ = void 0, this.iD_ = void 0, this.j3_ = void 0, this.H3_ = void 0, this.$3_ = void 0, this.W3_ = void 0, this.knc = void 0, this.ct_ = [], this.R$l = void 0, this.rD_ = () => new InstanceDungeonBottomTipItem_1.InstanceDungeonBottomTipItem, this.vMl = () => {
  ...
  InitButton(t, e, n) {
    this.zth.OnClickBtnSoloCallBack = t, this.zth.OnClickBtnMultipleCallBack = e, this.zth.OnClickBtnTeamCallBack = n
  }
  async RefreshItem(t) {
    this.NUe = t;
    var e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(t);
    if (e) {
      ControllerHolder_1.ControllerHolder.InstanceDungeonEntranceController.CheckRightTitleAvailableByInstanceId(t) && this.Qth.RefreshItem(e.MapName, e.DungeonDesc, e.RecommendElement), this.zth.RefreshItem(e.OnlineType), this.Egl(e), this.eih(e.MonsterTips, 0 < e.MonsterPreview.length), this.tih(e.InstSubType), this.oD_(e.InstSubType), this.qnc(t), this.iih(e.InstSubType), this.rih(), this.nD_(e.InstSubType), this.UpdateInstanceDungeonLockItemAndCostItem(), this.oih(e.InstSubType), this.Q3_(t), this.K3_(t), this.X3_(t), this.Y3_(t);
      for (const n of this.ct_) await n();
      this.ct_ = []
    }
  }
  eih(t, e) {
    "" !== t || e ? this.Kth ? (this.Kth?.SetActive(!0), this.Kth?.RefreshItem(t, e)) : (this.Kth = new InstanceDungeonBuffItem_1.InstanceDungeonBuffItem, this.ct_.push(async () => this.Kth.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_Buff", this.GetItem(0)).then(() => {
  ...
  tih(t) {
    if (21 === t) {
      ...
      this.jzs ? (this.jzs.SetActive(!0), this.jzs.RefreshItem(e)) : (this.jzs = new InstanceDungeonEntranceTowerDefenceItem_1.InstanceDungeonEntranceTowerDefenceItem, this.ct_.push(async () => this.jzs.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_Reward", this.GetItem(0)).then(() => {
        this.jzs.RefreshItem(e)
      })))
    } else this.jzs?.SetActive(!1)
  }
  oD_(t) {
    22 === t || !this.eD_ ? this.eD_ ? this.eD_.SetUIActive(!0) : this.ct_.push(async () => {
      var t = await LguiUtil_1.LguiUtil.LoadPrefabByResourceIdAsync("UiItem_InstanceDungeon_Rline", this.GetItem(1));
      this.eD_ = t.GetComponentByClass(ue_1.UIItem.StaticClass()), this.eD_.SetUIActive(!0)
  ...
  nih() {
    ...
    if (!t || t <= 0) this.Xth?.SetUiActive(!1);
      ...
      this.Xth ? (this.Xth.SetActive(!0), this.Xth.RefreshItem(e[0])) : (this.Xth = new InstanceDungeonCostItem_1.InstanceDungeonCostItem, this.ct_.push(async () => this.Xth.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_Cost", this.GetItem(1)).then(() => {
        this.Xth.RefreshItem(e[0])
      })))
    }
  }
  rih() {
    ModelManager_1.ModelManager.InstanceDungeonEntranceModel.GetInstanceDungeonReward(this.NUe)[0].length <= 0 ? this.gli?.SetActive(!1) : this.gli ? (this.gli.SetActive(!0), this.gli.RefreshItem(this.NUe)) : (this.gli = new InstanceDungeonEntranceRewardItem_1.InstanceDungeonEntranceRewardItem, this.ct_.push(async () => this.gli.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_Reward", this.GetItem(1)).then(() => {
  ...
  nD_(t) {
    let e = void 0;
    var n, i;
    22 === t && (e = [], n = (t = ModelManager_1.ModelManager.MowingRiskModel).GetRiskHarvestInstConfigByInstanceId(this.NUe), i = {
      TextId: "riskofrain_total_num",
      TextArgs: [t.GetMaxScoreByInstanceId(this.NUe).toString()]
    }, e.push(i), n.Accumulate || (i = {
      TextId: "riskofrain_ratio_num",
      TextArgs: [t.GetMonsterRatioByInstanceId(this.NUe).toString()]
    }, e.push(i))), e && 0 !== e.length ? (this.GetVerticalLayout(4).RootUIComp.SetUIActive(!0), this.ct_.push(async () => this.sD_().then(async () => {
      this.aD_(), await this.iD_?.RefreshByDataAsync(e ?? [])
    }))) : this.GetVerticalLayout(4).RootUIComp.SetUIActive(!1)
  }
  async sD_() {
    this.tD_ || (this.tD_ = new InstanceDungeonBottomTipItem_1.InstanceDungeonBottomTipItem, await this.tD_.CreateByResourceIdAsync("UiItem_InstanceDungeon_Rtips", this.GetVerticalLayout(4).RootUIComp))
  }
  aD_() {
    var t;
    this.iD_ || (t = this.GetVerticalLayout(4), this.iD_ = new GenericLayout_1.GenericLayout(t, this.rD_))
  }
  oih(t) {
    var t = 19 === t,
      e = ModelManager_1.ModelManager.InstanceDungeonEntranceModel.CheckInstanceUnlock(this.NUe);
    t && e ? this.Yth ? (this.Yth.SetActive(!0), this.Yth.RefreshItem(this.NUe)) : (this.Yth = new InstanceDungeonMowingDropDownItem_1.InstanceDungeonMowingDropDownItem, this.ct_.push(async () => (this.Yth.SkipDestroyActor = !0, this.Yth.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_DropItem", this.GetItem(1)).then(() => {
  ...
  UpdateInstanceDungeonLockItemAndCostItem() {
    var t = 1 === ModelManager_1.ModelManager.InstanceDungeonEntranceModel.GetMatchingState(),
      e = (this.Xth?.SetActive(!1), this.R$l.CheckInstanceUnlock(this.NUe));
    e ? (this.nih(), this.zth.SetActive(!t), this.Zth.SetActive(!1), this.Jth?.SetActive(t)) : ((e = this.R$l.GetUnlockConditionTextId(this.NUe)) && this.Zth.RefreshItem(e), this.zth.SetActive(!1), this.Zth.SetActive(!0), this.Jth?.SetActive(!1))
  }
  Egl(t) {
    var t = 15 === t.InstSubType,
      e = ModelManager_1.ModelManager.RoguelikeModel.HasBlackFlowerExchanged(this.NUe);
    t && e ? this.ygl ? this.ygl.SetActive(!0) : (this.ygl = new RoguelikeBlackFlowerItem_1.RoguelikeBlackFlowerInstanceItem, this.ct_.push(async () => this.ygl.CreateThenShowByResourceIdAsync("UiItem_CheckpointsRReward", this.GetItem(3)).then(() => {
  ...
  K3_(t) {
    ...
    e ? this.j3_ ? (this.j3_.SetUiActive(!0), this.j3_.RefreshItem(e())) : (this.j3_ = new InstanceDungeonPicItem_1.InstanceDungeonPicItem, this.ct_.push(async () => this.j3_?.CreateThenShowByResourceIdAsync("UiItem_CheckpointsRPic", this.GetItem(0)).then(() => {
  ...
  X3_(t) {
    ...
    e ? this.H3_ ? (this.H3_.SetUiActive(!0), this.H3_.RefreshItem(e())) : (this.H3_ = new InstanceDungeonDescWidelyItem_1.InstanceDungeonDescWidelyItem, this.ct_.push(async () => this.H3_?.CreateThenShowByResourceIdAsync("UiItem_CheckpointsRText", this.GetItem(0)).then(() => {
  ...
  Q3_(t) {
    ...
    e ? this.$3_ ? (this.$3_.SetUiActive(!0), this.$3_.RefreshItem(e())) : (this.$3_ = new InstanceDungeonTitleWidelyItem_1.InstanceDungeonTitleWidelyItem, this.ct_.push(async () => this.$3_?.CreateThenShowByResourceIdAsync("UiItem_CheckpointsRTitleA", this.GetItem(0)).then(() => {
  ...
  Y3_(t) {
    ...
    e ? this.W3_ ? (this.W3_.SetUiActive(!0), this.W3_.RefreshItem(e())) : (this.W3_ = new InstanceDungeonScoreListItem_1.InstanceDungeonScoreListItem, this.ct_.push(async () => {
  ...
  qnc(t) {
    this.R$l.RankItemModel ? (this.R$l.RankItemModel.RefreshInstance(t), this.knc ? (this.knc.SetUiActive(!0), this.knc.Refresh()) : (this.knc = new InstanceDungeonRankTimeItem_1.InstanceDungeonRankTimeItem, this.knc.OpenParam = this.R$l.RankItemModel, this.ct_.push(async () => {
      await this.knc?.CreateThenShowByResourceIdAsync("UiItem_CheckpointsRInfoTitle", this.GetItem(1)).then(() => {
        this.knc?.SetUiActive(!0), this.knc?.Refresh()
      })
    }))) : this.knc?.SetUiActive(!1)
  }
  SetLockText(t) {
