...
class InstanceDungeonBuffItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Uth = void 0, this.Gli = () => {
  ...
  OnStart() {
    this.Uth && this.RefreshItem(this.Uth.BuffText, this.Uth.ShowMonsterPreview)
  }
  RefreshItem(e, s) {
    this.InAsyncLoading() ? this.Uth = {
      BuffText: e,
      ShowMonsterPreview: s
    } : (this.GetButton(1).RootUIComp.SetUIActive(s), e ? (this.GetText(0).SetUIActive(!0), this.GetText(0).ShowTextNew(e)) : this.GetText(0).SetUIActive(!1))
  }
}
