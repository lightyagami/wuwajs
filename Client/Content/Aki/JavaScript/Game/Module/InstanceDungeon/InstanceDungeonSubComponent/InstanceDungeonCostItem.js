...
class InstanceDungeonCostItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Uth = void 0, this.Nli = () => {
  ...
  OnStart() {
    this.GetItem(3)?.SetUIActive(!1), this.GetButton(2)?.RootUIComp.SetUIActive(!1), this.Uth && this.RefreshItem(this.Uth.Item)
  }
  RefreshItem(e) {
    this.InAsyncLoading() ? this.Uth = {
      Item: e
    } : (this.GetText(1)?.SetText("x" + e[1]), this.SetItemIcon(this.GetTexture(0), e[0]?.ItemId))
  }
}
