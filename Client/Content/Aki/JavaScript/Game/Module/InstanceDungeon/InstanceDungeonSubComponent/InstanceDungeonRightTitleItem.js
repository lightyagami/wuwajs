...
class InstanceDungeonRightTitleItem extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshItem(e, t, n) {
    this.SetActive(!0), this.GetText(0).ShowTextNew(e), this.GetText(1).ShowTextNew(t), this.UpdateInstanceDungeonRecommendElementItem(n)
  }
  RefreshName(e) {
  ...
  UpdateInstanceDungeonRecommendElementItem(e) {
    !e || e.length <= 0 ? this.sih?.SetActive(!1) : this.sih ? (this.sih?.SetActive(!0), this.sih?.RefreshItem(e)) : (this.sih = new InstanceDungeonRecommendElementItem_1.InstanceDungeonRecommendElementItem, this.sih.CreateThenShowByResourceIdAsync("UiItem_InstanceDungeon_RecommendElement", this.GetItem(2)).then(() => {
