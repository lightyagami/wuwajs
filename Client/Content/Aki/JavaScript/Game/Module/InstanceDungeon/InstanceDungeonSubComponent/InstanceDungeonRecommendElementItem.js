...
class InstanceDungeonRecommendElementItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Uth = void 0, this.Mli = void 0, this.jli = () => {
      return new TowerElementItem_1.TowerElementItem
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, ue_1.UIHorizontalLayout]
    ]
  }
  OnStart() {
    this.Mli = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.jli), this.Uth && this.RefreshItem(this.Uth.Element)
  }
  RefreshItem(e) {
