...
exports.InstanceDungeonScoreListItem = undefined;
const UE = require("ue");
const UiPanelBase_1 = require("../../../Ui/Base/UiPanelBase");
const LguiUtil_1 = require("../../Util/LguiUtil");
class InstanceDungeonScoreListItem extends UiPanelBase_1.UiPanelBase {
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIText], [2, UE.UIText], [3, UE.UIText], [4, UE.UIText], [5, UE.UIText], [8, UE.UIText], [6, UE.UIItem], [7, UE.UITexture]];
  }
  RefreshItem(e) {
    var i = e === undefined || e.MedalPathId === undefined;
    this.GetItem(0)?.SetUIActive(!i);
    this.GetItem(6)?.SetUIActive(i);
    this.GetText(5)?.SetUIActive(false);
    if (!i) {
      LguiUtil_1.LguiUtil.TrySetLocalTextNew(this.GetText(1), e.TitleTextId1);
