...
class InstanceDungeonEntranceModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.qhi = 0, this.Ghi = 0, this.Nhi = 0, this.Ohi = 0, this.khi = void 0, this.Fhi = new Array, this.Vhi = 0, this.Hhi = new Map, this.qUc = new Map, this.GUc = new Set, this.jhi = new Map, this.Whi = new Array, this.Khi = 0, this.Qhi = 0, this.Xhi = void 0, this.OnStopTimer = void 0, this.OnStopHandle = void 0, this.$hi = 0, this.Yhi = !1, this.E0 = 0
  }
  OnLeaveLevel() {
    var e = this.GetMatchingId();
    return 0 !== e && 1 === this.GetMatchingState() && (ControllerHolder_1.ControllerHolder.InstanceDungeonEntranceController.HandleTipsExitMatchId = e), this.CancelMatchingTimer(), !0
  }
  get EntranceId() {
    return this.qhi
  }
  ...
  set SelectInstanceId(e) {
    this.Nhi = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSelectInstance)
  }
  get LastInstanceId() {
    return this.Ohi
  }
  ...
  GetDungeonArchiveExpireLocalTips(e) {
    ...
    return t === Protocol_1.Aki.Protocol.tUc.Proto_OverdueTime ? "instance_Record_Clear1" : t === Protocol_1.Aki.Protocol.tUc.Proto_OverdueVersion ? "instance_Record_Clear2" : t === Protocol_1.Aki.Protocol.tUc.Proto_OverdueChangeSex ? "instance_Record_Clear3" : (Log_1.Log.CheckWarn() && Log_1.Log.Warn("InstanceDungeon", 63, "副本入口->获取副本存档文本提示失败，出现了未处理的存档类型", ["dungeonId", e], ["archiveType", t]), "")
  }
  HasDungeonArchive(e) {
    return this.GetDungeonArchiveType(e) === Protocol_1.Aki.Protocol.tUc.Proto_NormalArchive
  }
  IsDungeonSupportArchive(e) {
    return !(e <= 0) && 0 < (ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e)?.SaveDays ?? 0)
  }
  ...
  GetInstanceData(e) {
    var t;
    if (e) return this.jhi.get(e) || (t = new InstanceDungeonData_1.InstanceDungeonData(e), this.jhi.set(e, t), t)
  }
  SetInstanceData(t) {
    var n = t.s5n;
    if (n) {
      let e = this.jhi.get(n);
      e || (e = new InstanceDungeonData_1.InstanceDungeonData(n), this.jhi.set(n, e)), e.ChallengedTimes = t.vws
    }
  }
  get MatchingTime() {
    return this.Qhi
  ...
  CancelMatchingTimer() {
    void 0 !== this.MatchingTimer && TimerSystem_1.TimerSystem.Remove(this.MatchingTimer), this.OnStopHandle && this.OnStopHandle(), this.OnStopTimer = void 0, this.OnStopHandle = void 0, this.MatchingTimer = void 0, this.SetMatchingState(0), this.SetMatchingId(0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnMatchingChange)
  }
  GetMatchingState() {
    return this.Khi
  }
  ...
  InitInstanceDataList(e) {
    if (e)
      for (const t of e) this.SetInstanceData(t)
  }
  GetInstancePowerCost(e) {
    return !(e <= 0) && !((e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e).RewardId) <= 0) && (e = ConfigManager_1.ConfigManager.LevelPlayConfig.GetExchangeRewardInfo(e)) && e.Cost ? e.Cost.get(5) : 0
  }
  get EditBattleTeamMatching() {
    return this.Yhi
  }
  SetEditBattleTeamMatching(e) {
    this.Yhi = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MatchTeamFlagChange, e)
  }
  SyncSettleRewardItemList(e) {
    ...
    for (const n of Object.keys(e)) {
      var t = e[n]?.O9n;
      if (t)
        for (const r of t) this.Whi.push([{
          IncId: 0,
          ItemId: r.L8n
        }, r.m9n])
    }
  ...
  GetSortedByTitleEntranceInstanceIdList(e) {
    ...
    if (t) {
      var n, r = new Map;
      for (const i of t) n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(i).Title, r.set(i, n);
      return r
    }
  }
  CheckInstanceFinished(e) {
    var t, e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e).EnterControlId;
  ...
  CheckInstanceUnlock(e) {
    var t, n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetUnlockCondition(e);
    if (n) switch (n[0]) {
      case 1:
      ...
      case 3:
        return 3 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(n[1]) ? !0 : !!(t = ModelManager_1.ModelManager.QuestNewModel.GetQuest(n[1]))?.IsProgressing && (t.GetNode(n[2])?.IsSuccess ?? !1);
      case 4:
        return ModelManager_1.ModelManager.ExchangeRewardModel?.IsFinishInstance(n[1]) ?? !1;
      case 5:
  ...
  GetInstanceDungeonReward(e) {
    var t = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetInstanceRewardId(e),
      n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetInstanceFirstRewardId(e),
      r = n && 0 < n,
      i = t && 0 < t,
      e = ModelManager_1.ModelManager.ExchangeRewardModel.IsFinishInstance(e),
      n = ConfigManager_1.ConfigManager.ExchangeRewardConfig.GetExchangeRewardPreviewRewardList(n) ?? [],
      t = ConfigManager_1.ConfigManager.ExchangeRewardConfig.GetExchangeRewardPreviewRewardList(t) ?? [];
    return r && i ? e ? [t, !1] : [n.concat(t), !1] : i ? [t, !1] : [n, e]
  }
  IsMowingInstanceDungeon() {
    var e = ModelManager_1.ModelManager.CreatureModel.GetInstanceId();
    return 19 === ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e)?.InstSubType
  }
  IsFarmGoldInstanceDungeon() {
    var e = ModelManager_1.ModelManager.CreatureModel.GetInstanceId();
    return 25 === ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e)?.InstSubType
  }
  ...
  GetUnlockTextIdById(e) {
    ...
    if (void 0 !== t) return t === SolarSpeedDefine_1.SOLAR_SPEED_INSTANCE_ENTRANCE_ID ? ModelManager_1.ModelManager.SolarSpeedModel.GetInstanceUnlockTextIdByInstanceId(e) : ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetUnlockConditionGroupHintText(e)
  }
  GetUnlockArgsById(e) {
    var t = ConfigManager_1.ConfigManager.InstanceDungeonEntranceConfig?.GetEntranceIdByInstanceId(e);
    return void 0 !== t && t === SolarSpeedDefine_1.SOLAR_SPEED_INSTANCE_ENTRANCE_ID ? ModelManager_1.ModelManager.SolarSpeedModel.GetInstanceUnlockArgsByInstanceId(e) : void 0
  }
}
