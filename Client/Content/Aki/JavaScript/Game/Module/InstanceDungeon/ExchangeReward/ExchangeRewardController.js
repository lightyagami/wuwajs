...
class ExchangeRewardController extends ControllerBase_1.ControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(18667, ExchangeRewardController.wai);
    Net_1.Net.Register(15291, ExchangeRewardController.Bai);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(18667);
    Net_1.Net.UnRegister(15291);
  }
}
...
ExchangeRewardController.RequestExchangeData = async () => {
  ...
  var e = await Net_1.Net.CallAsync(26870, e);
