...
class ExchangeRewardController extends ControllerBase_1.ControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(23237, ExchangeRewardController.wai);
    Net_1.Net.Register(16923, ExchangeRewardController.Bai);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(23237);
    Net_1.Net.UnRegister(16923);
  }
}
...
ExchangeRewardController.RequestExchangeData = async () => {
  ...
  var e = await Net_1.Net.CallAsync(16904, e);
