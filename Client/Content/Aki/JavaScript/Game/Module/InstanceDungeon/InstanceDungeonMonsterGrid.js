...
class InstanceDungeonMonsterGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(), this.CurrentInstanceId = 0, this.V1i = 0, this.Mli = void 0, this.jli = () => {
  ...
  Refresh(e, r, t) {
    this.V1i = e;
    var i, n = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterName(this.V1i);
