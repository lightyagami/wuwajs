...
class InstanceDungeonRewardView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.K1i = void 0, this.sGe = () => {
  ...
  OnBeforeShow() {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "InstanceRewardTitle"), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "InstanceRewardSubTitle");
    ...
    let t = 0,
      a = 0;
    for (const [s, e] of r) i.push([s, e]), t < s && n >= s && (t = s, a = i.length - 1);
