...
class InstanceDungeonViewModelBase {
  constructor() {
    this.View = void 0, this.EntranceId = 0, this.InstanceIdList = [], this.InstanceByTitleMap = new Map, this.aH_ = void 0, this.RankItemModel = void 0, this.EntranceId = ModelManager_1.ModelManager.InstanceDungeonEntranceModel.EntranceId, this.Onc(), this.Jfc()
  }
  Onc() {
  ...
  GetInstanceByTitleMap() {
    var t, n, e = ModelManager_1.ModelManager.InstanceDungeonEntranceModel.GetSortedByTitleEntranceInstanceIdList(this.EntranceId),
      r = new Map;
    for ([t, n] of e) {
      let e = r.get(n);
  ...
  OnGetDefaultSelectData() {
    if (this.InstanceByTitleMap && this.aH_?.DefaultSelectDataGetter) return this.aH_.DefaultSelectDataGetter(this.InstanceByTitleMap)
  }
