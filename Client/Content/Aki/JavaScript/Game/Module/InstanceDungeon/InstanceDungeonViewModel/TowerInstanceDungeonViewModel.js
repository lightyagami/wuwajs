...
class TowerInstanceDungeonViewModel extends InstanceDungeonViewModelBase_1.InstanceDungeonViewModelBase {
  constructor() {
    super(...arguments), this.RankItemModel = new TowerDefenseRankTimeModel_1.TowerDefenseRankTimeModel
  }
  GetInstanceByTitleMap() {
    var n, r, e = ModelManager_1.ModelManager.TowerDefenseModel.GetSortedByTitleEntranceInstanceIdList(),
      o = new Map;
    for ([n, r] of e) {
      let e = o.get(r);
  ...
  OnSortInstanceArray(e) {
    e.sort((e, n) => {
      e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetTowerDefenseInstanceByInstance(e), n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetTowerDefenseInstanceByInstance(n);
      return e && n ? e.Difficulty - n.Difficulty : 0
    })
  }
  OnGetInstanceItemTextureBg(e) {
    return ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetTowerDefenseInstanceByInstance(e).IsDifficult ? "T_TogHoldDeathmatch" : "T_TogListNor"
  }
  OnGetUnlockConditionTextId(e) {
    var n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetUnlockCondition(e),
      n = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetTowerDefenseConfigById(n[2]);
    return ModelManager_1.ModelManager.TowerDefenseModel.PhantomMessageCache.IsStageUnLocked(n.InstanceId) ? new LguiUtil_1.TableTextArgNew("OnlineGymnasium_LevelRst") : (n = TowerDefenceController_1.TowerDefenseController.BuildInstanceCountDownTextParam(e)) ? new LguiUtil_1.TableTextArgNew("OnlineGymnasium_LevelRst", n) : void 0
  }
