...
class InstanceDungeonMonsterView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.yyn = 0, this.Mli = void 0, this.H1i = void 0, this.j1i = () => {
  ...
  OnStart() {
    this.yyn = this.OpenParam, this.GetText(0).ShowTextNew(ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(this.yyn).MonsterTips), this.H1i = new GenericLayout_1.GenericLayout(this.GetGridLayout(1), this.j1i), this.Mli = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.jli)
  }
  OnBeforeShow() {
    var e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(this.yyn);
    this.H1i.RefreshByData(e.MonsterPreview), 0 < e.RecommendElement?.length ? (this.GetItem(2)?.SetUIActive(!0), this.Mli.RefreshByData(e.RecommendElement)) : this.GetItem(2)?.SetUIActive(!1)
  }
  OnBeforeDestroy() {
