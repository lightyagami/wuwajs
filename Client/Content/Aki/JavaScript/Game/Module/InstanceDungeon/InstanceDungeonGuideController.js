...
class InstanceDungeonGuideController extends ControllerBase_1.ControllerBase {
  ...
  static StartReplayGuide() {
    ModelManager_1.ModelManager.GuideModel.ClearAllGroup(), InstanceDungeonGuideController.a1i()
  }
  static a1i() {
    var e = ModelManager_1.ModelManager.InstanceDungeonGuideModel.GetCurrentInstanceDungeonGuideType(),
      n = ModelManager_1.ModelManager.InstanceDungeonGuideModel.GetCurrentInstanceDungeonGuideValue();
    switch (e) {
      case 0:
        break;
      case 1:
      ...
      case 2:
        ...
        break;
      case 3:
        UiManager_1.UiManager.IsViewShow("GuideTutorialTipsView") || GuideController_1.GuideController.TryStartGuide(n);
        break;
      case 4:
  ...
  static GetHaveGuide() {
    return 0 !== ModelManager_1.ModelManager.InstanceDungeonGuideModel.GetCurrentInstanceDungeonGuideType()
  }
}
exports.InstanceDungeonGuideController = InstanceDungeonGuideController, (_a = InstanceDungeonGuideController).nye = () => {
  ModelManager_1.ModelManager.InstanceDungeonGuideModel.RefreshCurrentDungeonGuide(), ModelManager_1.ModelManager.InstanceDungeonGuideModel.GetHaveGuide() && _a.StartReplayGuide()
};
