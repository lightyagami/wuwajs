...
class ItemPriorHintItem extends ItemHintItem_1.ItemHintItem {
  ...
  async AsyncLoadUiResource() {
    ...
    const s = UE.Color.FromHex(e.TextColor),
      o = (ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.NiagaraSystem, e => {
        var t;
        i.SetResult(void 0), e && UiManager_1.UiManager.IsViewOpen("ItemHintView") && this.RootItem && ((t = this.GetUiNiagara(6)).SetNiagaraSystem(e), r || (t.ColorParameter.Get("Color").Constant = UE.LinearColor.FromSRGBColor(s)))
      }), this.SetSpriteByPath(e.AcquireQualitySpritePath, this.GetSprite(5), !1), new CustomPromise_1.CustomPromise);
