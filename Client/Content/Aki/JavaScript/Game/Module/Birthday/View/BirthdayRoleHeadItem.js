...
class BirthdayRoleHeadItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.dFe = 0, this.OnToggleClickCallBack = void 0, this.N8e = () => {
      this.OnToggleClickCallBack && this.OnToggleClickCallBack(this.GridIndex, this.dFe)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, i) {
    ...
    var e = RoleSkinById_1.configRoleSkinById.GetConfig(r),
      e = (e && (e = e.RoleHeadIconCircle, this.SetTextureByPath(e, this.GetTexture(1))), this.SetToggleState(t), ModelManager_1.ModelManager.BirthdayModel.IsRoleSelected(this.dFe));
