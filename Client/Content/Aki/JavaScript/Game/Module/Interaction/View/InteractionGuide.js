...
class InteractionGuide extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalText(i, e), LguiUtil_1.LguiUtil.ReplaceWildCard(i), this.SetActive(!0)
  }
  RefreshTextWidth() {
    var e = this.GetText(1);
    e?.IsValid() && e.GetWidth() > InteractionDefine_1.INTERACT_GUIDE_MAX_TEXT_WIDTH && (e.SetWidth(InteractionDefine_1.INTERACT_GUIDE_MAX_TEXT_WIDTH), e.SetOverflowType(1))
  }
}
