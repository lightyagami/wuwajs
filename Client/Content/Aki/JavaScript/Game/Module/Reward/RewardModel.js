...
class RewardModel extends ModelBase_1.ModelBase {
  ...
  koe() {
    this.vao = UE.NewObject(UE.TraceSphereElement.StaticClass()), this.vao.WorldContextObject = GlobalData_1.GlobalData.World, this.vao.bIsSingle = !0, this.vao.bIgnoreSelf = !0, this.vao.AddObjectTypeQuery(QueryTypeDefine_1.KuroObjectTypeQuery.WorldStatic), this.Mao = UE.NewObject(UE.TraceLineElement.StaticClass()), this.Mao.WorldContextObject = GlobalData_1.GlobalData.World, this.Mao.bIsSingle = !0, this.Mao.bIgnoreSelf = !0, this.Mao.SetTraceTypeQuery(QueryTypeDefine_1.KuroTraceTypeQuery.Water)
  }
  CheckGroundHit(e, t, i) {
    this.vao || this.koe(), TraceElementCommon_1.TraceElementCommon.SetStartLocation(this.vao, e), this.vao.SetEndLocation(e.X, e.Y, e.Z + i), this.vao.Radius = t;
    let r = !1;
  ...
  CheckWaterHit(e, t, i, r) {
    this.Mao || this.koe(), TraceElementCommon_1.TraceElementCommon.SetStartLocation(this.Mao, e), this.Mao.SetEndLocation(t.X, t.Y, t.Z - i);
    let s = !1;
