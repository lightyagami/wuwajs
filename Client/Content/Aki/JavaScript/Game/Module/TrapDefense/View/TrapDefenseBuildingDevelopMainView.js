...
class TrapDefenseBuildingDevelopMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.ITt = () => {
      ...
      if (i && !this.IsInDungeon) {
        ...
        this.Fhd?.RefreshTemp(i, t.toString());
      }
    };
    this.k0d = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    if (!this.IsInDungeon) {
      ...
      await this.Fhd.CreateThenShowByResourceIdAsync("UIItem_CommonCurrencyItem", this.TabComponent.GetCostContent());
  ...
  OnAddEventListener() {
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TrapDefenseBuildingPreviewSelectUpdate, this.K2d);
  ...
  OnRemoveEventListener() {
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TrapDefenseBuildingPreviewSelectUpdate, this.K2d);
