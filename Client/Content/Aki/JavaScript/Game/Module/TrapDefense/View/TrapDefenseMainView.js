...
class TrapDefenseMainView extends UiTickViewBase_1.UiTickViewBase {
  ...
  async OnBeforeStartAsync() {
    ...
    this.a$c = new TrapDefenseEntryBtnItem_1.TrapDefenseEntryBtnItem(1);
    this.h$c = new TrapDefenseEntryBtnItem_1.TrapDefenseEntryBtnItem(2);
    this._$c = new TrapDefenseEntrySideBtnItem_1.TrapDefenseEntrySideBtnItem();
    this._$c.SetFunction(this.f$c);
    this.u$c = new TrapDefenseEntrySideBtnItem_1.TrapDefenseEntrySideBtnItem();
    this.u$c.SetFunction(this.g$c);
    this.c$c = new TrapDefenseEntrySideBtnItem_1.TrapDefenseEntrySideBtnItem();
    this.c$c.SetFunction(this.C$c);
    this.d$c = new TrapDefenseEntrySideBtnItem_1.TrapDefenseEntrySideBtnItem();
    this.d$c.SetFunction(this.p$c);
    var e = [];
    e.push(this.Qyi.CreateThenShowByActorAsync(this.GetItem(0).GetOwner()));
    e.push(this.a$c.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()));
    e.push(this.h$c.CreateThenShowByActorAsync(this.GetItem(3).GetOwner()));
    e.push(this._$c.CreateThenShowByActorAsync(this.GetItem(5).GetOwner()));
    e.push(this.u$c.CreateThenShowByActorAsync(this.GetItem(6).GetOwner()));
    e.push(this.c$c.CreateThenShowByActorAsync(this.GetItem(7).GetOwner()));
    e.push(this.d$c.CreateThenShowByActorAsync(this.GetItem(8).GetOwner()));
    await Promise.all(e);
    this._$c.BindRedDot("TrapDefenseLimitReward");
    this.u$c.BindRedDot("TrapDefenseFixedReward");
    this.c$c.BindRedDot("TrapDefenseTalentTree");
    this.d$c.BindRedDot("TrapDefenseDevelopBranchAll");
  }
  OnBeforeShow() {
    this.Og();
  }
  ...
  OnBeforeDestroy() {
    this.u$c?.UnBindRedDot();
    this._$c?.UnBindRedDot();
    this.c$c?.UnBindRedDot();
    this.d$c?.UnBindRedDot();
  }
  OnTick(e) {
    this.h$c?.RefreshUnlockTimer();
  ...
  Og() {
    ...
    this._$c.SetProgressText(e + "/" + t);
    this._$c.SetUiActive(ModelManager_1.ModelManager.TrapDefenseModel.RewardData.IsOpenLimitReward());
    var [e, t] = ModelManager_1.ModelManager.TrapDefenseModel.RewardData.GetFixedRewardTotalProgress();
    this.u$c.SetProgressText(e + "/" + t);
    this.a$c.RefreshByMode();
    this.h$c.RefreshByMode();
  }
}
