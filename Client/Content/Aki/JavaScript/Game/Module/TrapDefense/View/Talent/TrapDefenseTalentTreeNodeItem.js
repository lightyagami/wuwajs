...
class TrapDefenseTalentTreeNodeItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    ModelManager_1.ModelManager.TrapDefenseModel.ViewModelTalentTree.AddDelegateOnNodeSelect(this.Ghd);
    this.Hea = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem);
  }
  OnBeforeDestroy() {
    ModelManager_1.ModelManager.TrapDefenseModel.ViewModelTalentTree.RemoveDelegateOnNodeSelect(this.Ghd);
  }
  Refresh(e) {
    this.Pe = e;
