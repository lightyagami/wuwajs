...
class TrapDefenseResultView extends UiViewBase_1.UiViewBase {
  ...
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnActivitySequenceEmitEvent, this.bgd);
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TrapDefenseOnSystemInfoNotify, this.fQd);
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TrapDefenseBdBuffAllUpdate, this.fQd);
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnActivitySequenceEmitEvent, this.bgd);
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TrapDefenseOnSystemInfoNotify, this.fQd);
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TrapDefenseBdBuffAllUpdate, this.fQd);
  }
  ...
  OnBeforeShow() {
    ...
    e.push({
      Type: 0,
      Value: this.ResultData.pRd
    });
    e.push({
      Type: 2,
      Value: this.ResultData.CRd,
  ...
  hzc() {
    ...
    var t = {
      ...
      History: (this.NeedShowViewAnim ? this.ResultData.Hmd : this.ResultData.jmd).length,
      Total: this.ResultData.Hmd.length
    };
    e.push(t);
    if (this.ResultData.Pdd > 0) {
      t = {
        Type: 1,
        Value: this.ResultData.Pdd
      };
      e.push(t);
    }
