...
class TrapDefenseShopView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.DZc = e => {
      var t;
      var i = ModelManager_1.ModelManager.TrapDefenseModel.ViewModelShop.SelectedGoods ?? this.Ood;
      if (i) {
        ...
        this.GetText(14).SetColor(t ? this.Lbd : UE.Color.FromHex("9D2437FF"));
    ...
    this.BZc = () => {
      ...
      ModelManager_1.ModelManager.TrapDefenseModel.ViewModelShop.SelectGoods(t ? e : this.Ood);
  ...
  async OnBeforeStartAsync() {
    ...
    this.Lbd = this.GetText(14).GetColor();
    var e = [];
  ...
  async kZc() {
    ...
    this.Ood = (e.GoodsList.length > 0 ? e : t).GoodsList[0];
