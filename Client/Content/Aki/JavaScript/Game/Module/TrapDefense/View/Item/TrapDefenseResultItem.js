...
class TrapDefenseResultResultItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    ...
    this.Pe = undefined;
    this.FA_ = [];
    this.Wfd = () => new TrapDefenseResultStarItem();
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIText], [1, UE.UIText], [2, UE.UITexture], [3, UE.UIHorizontalLayout], [4, UE.UIItem], [5, UE.UIItem]];
  }
  OnStart() {
    this.eGe = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.Wfd);
  }
  Refresh(t, e, s) {
    this.Pe = t;
      ...
      if (this.FA_.length === 0) {
        for (let e = 1; e <= t.Value; e++) {
          var i = {
            ...
            HasPlayed: false,
            PlayDelay: e <= t.Total && e > t.History ? this.Tgd(e - t.History, t.Total - t.History) : 0
          };
          this.FA_.push(i);
        }
      }
  ...
  x_t(e) {
    ...
    switch (e) {
      case 5:
        ...
        break;
      case 4:
        this.nld(true, i, false);
        break;
      default:
        this.nld(true, i, true);
    }
  }
  old(e, t) {
