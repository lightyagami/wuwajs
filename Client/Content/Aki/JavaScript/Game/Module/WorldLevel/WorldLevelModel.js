...
class WorldLevelModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.h2o = 0, this.l2o = 0, this.LastChangeWorldLevelTimeStamp = 0, this._2o = 0, this.WorldLevelChangeTarget = 0
  }
  ...
  set CurWorldLevel(e) {
    this.l2o !== e && (this.l2o = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CurWorldLevelChange))
  }
  ...
  set OriginWorldLevel(e) {
    var t = e > this.h2o;
    this.h2o = e, t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OriginWorldLevelUp)
  }
  get Sex() {
    return this._2o
  }
