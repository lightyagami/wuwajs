...
class RechargeModel extends ModelBase_1.ModelBase {
  ...
  GetPayIdAmount(e) {
    ...
    return r ? r.Amount : (Log_1.Log.CheckInfo() && Log_1.Log.Info("Shop", 27, "获取PayId的服务器价格失败", ["id", e]), "0")
  }
  zso(e) {
    var r, t = parseFloat(e);
    return !isNaN(t) && (-1 === (r = (e = t.toString()).indexOf(".")) || -1 !== r && e.length - r - 1 == 1) ? t.toFixed(2) : e
  }
  GetPayIdProductId(e) {
    var r = this.Jso.get(e);
    return r ? r.ProductId : (Log_1.Log.CheckInfo() && Log_1.Log.Info("Shop", 27, "获取PayId的商品名称价格失败", ["id", e]), "")
  }
}
