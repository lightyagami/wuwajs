...
class LiuLiDaoLingView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.det = [], this.f1c = i => {
      for (let e = 0; e < this.det.length; e++) e !== i && this.det[e].Press(!1)
    }, this.bMe = (e, i) => {
  ...
  Cet() {
    this.det[0].RefreshByMoveType(0, InputEnums_1.EInputAxis.MoveRight, -1, this.f1c), this.det[1].RefreshByMoveType(1, InputEnums_1.EInputAxis.MoveRight, 1, this.f1c), this.det[2].RefreshByMoveType(2, InputEnums_1.EInputAxis.MoveForward, 1, this.f1c), this.det[3].RefreshByMoveType(3, InputEnums_1.EInputAxis.MoveForward, -1, this.f1c)
  }
  OnAddEventListener() {
    ControllerHolder_1.ControllerHolder.InputDistributeController.BindActions([InputMappingsDefine_1.actionMappings.Ui方向上, InputMappingsDefine_1.actionMappings.Ui方向下, InputMappingsDefine_1.actionMappings.Ui方向左, InputMappingsDefine_1.actionMappings.Ui方向右], this.bMe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.InputControllerMainTypeChange, this.Etl)
  }
  OnRemoveEventListener() {
    this.Zhc(), ControllerHolder_1.ControllerHolder.InputDistributeController.UnBindActions([InputMappingsDefine_1.actionMappings.Ui方向上, InputMappingsDefine_1.actionMappings.Ui方向下, InputMappingsDefine_1.actionMappings.Ui方向左, InputMappingsDefine_1.actionMappings.Ui方向右], this.bMe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.InputControllerMainTypeChange, this.Etl)
  }
  OnBeforeDestroy() {
