...
const EventDefine_1 = require("../../Common/Event/EventDefine"),
  ...
  RoleMorphGuYingXiongKaiHandle_1 = require("./handle/RoleMorphGuYingXiongKaiHandle"),
...
class RoleMorphController extends UiControllerBase_1.UiControllerBase {
  ...
  [5021, RoleMorphGuYingXiongKaiHandle_1.RoleMorphGuYingXiongKaiHandle]
]), RoleMorphController.klo = void 0, RoleMorphController.xie = () => {
  RoleMorphController.EndMorph();
  var e = ModelManager_1.ModelManager.BattleUiModel.GetCurRoleData();
  e && (e = e.RoleConfig?.Id) && (e = RoleMorphController.A6.get(e)) && (RoleMorphController.klo = new e, RoleMorphController.klo.BeginMorph())
};
