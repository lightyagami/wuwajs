...
class RoleMorphLiuLiDaoLingHandle extends RoleMorphHandleBase_1.RoleMorphHandleBase {
  BeginMorph() {
    ModelManager_1.ModelManager.BattleUiModel.ChildViewData?.SetChildrenVisible(7, [18, 9, 10], !1)
  }
  EndMorph() {
    UiManager_1.UiManager.IsViewOpen("LiuLiDaoLingView") && UiManager_1.UiManager.CloseView("LiuLiDaoLingView"), ModelManager_1.ModelManager.BattleUiModel.ChildViewData?.SetChildrenVisible(7, [18, 9, 10], !0)
  }
}
