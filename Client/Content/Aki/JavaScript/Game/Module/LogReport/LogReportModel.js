...
class LogReportModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    return this.Jba.set("1012", new LogReportDefine_1.ExploreToolAssemblyLogData("1001")), this.Jba.set("1013", new LogReportDefine_1.ExploreToolAssemblyLogData("1003")), this.Jba.set("1014", new LogReportDefine_1.ExploreToolAssemblyLogData("1004")), this.Jba.set("1025", new LogReportDefine_1.ExploreToolAssemblyLogData("1013")), !0
  }
  ...
  static RecordOperateTime(e = !1, t = "", o = 0) {
    ...
    e > RECORD_HANG_UP_OFFSET && (this.Vvi += e, (t = new LogReportDefine_1.HangUpTimeLogData).f_hang_up_time = e.toString(), LogReportController_1.LogReportController.LogReport(t)), this.Hvi = r
  }
