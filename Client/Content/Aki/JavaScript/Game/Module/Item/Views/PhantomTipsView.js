...
class PhantomTipsView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.rgi = !1, this.poh = void 0, this.voh = void 0, this.bxt = void 0, this.Moh = () => {
      this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.poh = new PhantomTipsAttributeItem_1.PhantomTipsAttributeItem, await this.poh.CreateThenShowByActorAsync(this.GetItem(5).GetOwner()), this.voh = new PhantomTipsAttributeItem_1.PhantomTipsAttributeItem, await this.voh.CreateThenShowByActorAsync(this.GetItem(6).GetOwner());
    var i = this.GetItem(4);
    this.bxt = new VisionFetterSuitItem_1.VisionFetterSuitItem(i), await this.bxt.CreateThenShowByActorAsync(i.GetOwner())
  }
  OnStart() {
    var i, e = this.OpenParam;
    void 0 === e ? (Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 58, "PhantomTipsView无效输入"), this.CloseMe()) : void 0 === (i = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomDataBase(e)) ? (Log_1.Log.CheckError() && Log_1.Log.Error("Phantom", 58, "PhantomTipsView无效uniqueId", ["uniqueId", e]), this.CloseMe()) : (this.Hqe(i), e = this.rgi ? "Golden" : "Start01", this.UiViewSequence.StartSequenceName = e, this.UiViewSequence.AddSequenceFinishEvent(e, this.Moh))
  }
  Hqe(i) {
    var e = ConfigManager_1.ConfigManager.ItemConfig.GetQualityConfig(i.GetQuality()),
      t = UE.Color.FromHex(e.TextColor),
      s = this.GetText(0),
      s = (LguiUtil_1.LguiUtil.SetLocalTextNew(s, i.GetMonsterName()), s.SetColor(t), this.GetText(1).SetText(i.GetCost().toString()), this.SetItemIcon(this.GetTexture(2), i.GetConfigId(!0)), this.SetTextureByPath(e.AcquireNewItemQualityTexPath, this.GetTexture(3)), this.rgi = 5 === e?.Id, ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupById(i.GetFetterGroupId()));
  ...
  Soh(i) {
    ...
    ResourceSystem_1.ResourceSystem.LoadAsync(i, UE.NiagaraSystem, i => {
      var e;
      i && UiManager_1.UiManager.IsViewOpen("PhantomTipsView") && this.RootItem && ((e = this.GetUiNiagara(7)).SetNiagaraSystem(i), this.rgi || (e.ColorParameter.Get("Color").Constant = UE.LinearColor.FromSRGBColor(t)))
    })
  }
  OnBeforeDestroy() {
