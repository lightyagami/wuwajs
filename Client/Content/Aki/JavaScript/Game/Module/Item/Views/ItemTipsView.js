...
class ItemTipsView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.IncId = 0, this.ConfigId = 0, this.ExtraParam = void 0, this.UiTipsType = "ItemTipsComponent", this.TipsProxy = void 0, this.DoCloseMe = () => {
      this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var e = this.OpenParam,
      i = (this.IncId = e?.ItemUid, this.ConfigId = e.ItemId, this.ExtraParam = e.ExtraParam, ItemTipsUtilTool_1.ItemTipsComponentUtilTool.GetTipsDataByPram(e));
    if (i) switch (this.UiTipsType = ItemTipsUtilTool_1.ItemTipsComponentUtilTool.GetTipsUiType(i.ItemType), this.UiTipsType) {
  ...
  async DDl(e) {
    var i = new ItemTipsComponent_1.ItemTipsComponent,
      e = (await i.CreateByResourceIdAsync("UiItem_TipsScreenTips", this.GetItem(1)), (this.TipsProxy = i).Refresh(e), void 0 === this.IncId && i.SetTipsComponentLockButton(!1), ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(this.ConfigId).ItemType);
    0 === e && i.SetTipsNumShow(!1)
  }
  async ADl(e) {
    var i = new PowerTipsItem_1.PowerTipsItem;
    await i.CreateByResourceIdAsync("UiItem_ItemTips1", this.GetItem(1)), (this.TipsProxy = i).SetBackBackCallBack(this.DoCloseMe), i.Refresh(e)
  }
  async xDl(e) {
    var i = new PersonalCardPreviewComponent_1.PersonalCardPreviewComponent;
    await i.CreateByResourceIdAsync("UiView_CardPreview", this.GetItem(1)), (this.TipsProxy = i).Refresh(e)
  }
  OnBeforeShow() {
