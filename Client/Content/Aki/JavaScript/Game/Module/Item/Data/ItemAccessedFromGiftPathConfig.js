  ...
  GetGiftItemGroupById(e) {
    ...
    if (r)
      for (const I of r.GiftItemGroup) {
        var o, i = ItemInfoById_1.configItemInfoById.GetConfig(I);
        i && 11 === i.ItemType && i.Parameters.has(ItemDefines_1.EItemFunctionType.ManualOpenGift) ? (i = i.Parameters.get(ItemDefines_1.EItemFunctionType.ManualOpenGift), (o = ConfigManager_1.ConfigManager.GiftPackageConfig?.GetGiftPackageConfig(i)) && o.Content.has(e) ? t.push(I) : Log_1.Log.CheckError() && Log_1.Log.Error("SkipInterface", 77, "[SkipInterface]礼包内不存在对应道具 ", ["itemID: ", e], ["giftItemID: ", I], ["giftID", i])) : Log_1.Log.CheckError() && Log_1.Log.Error("SkipInterface", 77, "[SkipInterface]道具存在异常 ", ["giftItemID: ", I])
      } else Log_1.Log.CheckError() && Log_1.Log.Error("SkipInterface", 77, "[SkipInterface]道具ID不存在，找不到ItemAccessedPath配置", ["itemID: ", e]);
    return t
  }
}
