...
class PhantomTipsAttributeItem extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshUi(e) {
    var a = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.Id),
      a = (this.GetText(1).ShowTextNew(a.Name), this.SetTextureShowUntilLoaded(a.Icon, this.GetTexture(0)), ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.Id, e.BaseValue, e.IsRatio));
