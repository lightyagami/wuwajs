  ...
  static SetMarkItemTrack(r) {
    if (r instanceof TaskMarkItem_1.TaskMarkItem)
      if (0 !== r.NodeId) {
        ...
        ModelManager_1.ModelManager.QuestNewModel.IsTrackingQuest(a) || QuestController_1.QuestNewController.RequestTrackQuest(r.TreeConfigId, !0, 1, 0)
      } else {
        a = ModelManager_1.ModelManager.MapModel.GetCurTrackMark();
        let e = !1;
        (e = !!a && a.MarkId === r.MarkId) || MapController_1.MapController.RequestTrackMapMark({
          MarkType: 12,
          MarkId: r.MarkId,
          Track: !0
        })
      }
    else r.IsTracked || MapController_1.MapController.RequestTrackMapMark({
      MarkType: r.MarkType,
      MarkId: r.MarkId,
      Track: !0
    })
