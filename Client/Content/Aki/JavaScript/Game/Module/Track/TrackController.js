  ...
  if (r) {
    ...
    if (t?.Valid && "Compass" !== t.TrackConfigType) {
      var n = r.GetComponent(1).CreatureData.GetPbEntityInitData(),
        o = (0, IComponent_1.getComponent)(n.ComponentsData, "InteractComponent"),
        e = r.GetComponent(196);
      if (!e || !e.HasTag(1196894179)) {
        let e = 3;
        o && (e = o.Range / 100), TrackController.StartTrack({
          TrackSource: 3,
          Id: r.Id,
          IconPath: t?.IconPath ?? "",
          TrackHideDis: e,
