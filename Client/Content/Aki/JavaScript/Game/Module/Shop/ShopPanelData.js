...
class ShopPanelData {
  constructor() {
    this.ItemId = 0, this.CurrencyId = 0, this.SingleBuyCount = 0, this.SingleBuyPrice = 0, this.BoughtCount = 0, this.BuyLimit = 0, this.IsLock = !1, this.LockText = void 0, this.InSellTime = !1, this.BuySuccessFunction = void 0
  }
  IsSoldOut() {
