...
class ShopConfig extends ConfigBase_1.ConfigBase {
  ...
  GetShopInfoConfig(e) {
    ...
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Shop", 18, "查表ShopInfo错误", ["Id", e]), o
  }
  GetFixedShopList(e) {
    var o = ShopFixedByShopId_1.configShopFixedByShopId.GetConfigList(e);
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Shop", 18, "表ShopFixed配置找不到", ["ShopId", e]), o
  }
  GetShopFixedInfoByItemId(e, o) {
    var r = ShopFixedByShopIdAndId_1.configShopFixedByShopIdAndId.GetConfig(e, o);
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Shop", 18, "表ShopFixed配置找不到", ["ShopId", e], ["Id", o]), r
  }
}
