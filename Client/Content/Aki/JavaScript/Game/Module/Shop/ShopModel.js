...
class ShopModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.OpenItemInfo = void 0, this.cMo = void 0, this.Qre = "", this.InteractTarget = 0, this.CurrentInteractCreatureDataLongId = void 0
  }
  get VersionId() {
    return this.Qre
  }
  ...
  UpdateShopData(e) {
    ...
    t ? (t.UpdateRefreshTime(e.Lxs), t.UpdateShopItemList(e.eGs)) : (t = new ShopDefine_1.Shop(e), this.cMo.set(e.tjn, t)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ShopUpdate, e.tjn)
  }
  UpdateItemData(e) {
  ...
  GetShopItemList(e) {
    ...
    if (t) {
      for (var [, r] of t.GetItemList()) {
        ...
        n && (n = new ShopItemFullInfo_1.ShopItemFullInfo(n, r, e), o.push(n))
      }
