...
class ShopItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIText], [2, UE.UITexture], [3, UE.UISprite], [4, UE.UISprite], [5, UE.UIText], [6, UE.UITexture], [7, UE.UIText], [8, UE.UIText], [9, UE.UIText], [10, UE.UIText], [11, UE.UIItem], [12, UE.UIItem], [13, UE.UIItem], [14, UE.UIText], [15, UE.UIText]];
  ...
  UpdateItem(t) {
    ...
    if (t) {
      ...
      LguiUtil_1.LguiUtil.SetLocalText(this.GetText(5), "ShowCount", t.StackSize);
      ...
      if (!t.IsAffordable()) {
        this.GetText(7).SetColor(coinNotEnoughColor);
      }
  ...
  UpdateLockState() {
    ...
    if (this.ItemInfo.BuyLimit !== -1) {
      ...
      LguiUtil_1.LguiUtil.SetLocalText(this.GetText(9), "ShopItemLimitCount", this.ItemInfo.BuyLimit - this.ItemInfo.BoughtCount, this.ItemInfo.BuyLimit);
    }
    if (this.ItemInfo.IsUnlocked()) {
      if (this.ItemInfo.IsSoldOut()) {
        ...
        LguiUtil_1.LguiUtil.SetLocalText(this.GetText(15), "ShopItemSoldOut");
      } else if (this.ItemInfo.IsOutOfDate()) {
        LguiUtil_1.LguiUtil.SetLocalText(this.GetText(15), "ShopItemTimeout");
        this.GetText(15).SetColor(red);
        this.GetText(15).SetUIActive(true);
      }
    } else {
      this.GetText(15).SetUIActive(false);
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(14), this.ItemInfo.LockInfo);
    }
  }
  UpdateLimitTime() {
    var t;
    var i;
    if (this.ItemInfo.EndTime !== 0) {
      i = this.ItemInfo.EndTime - TimeUtil_1.TimeUtil.GetServerTimeStamp();
      if ((t = Math.trunc(i / SECONDS_PER_DAY)) > 0) {
        LguiUtil_1.LguiUtil.SetLocalText(this.GetText(10), "ShopItemLimitTime1", t);
      } else if (t === 0) {
        t = Math.trunc(i / 3600);
        i = Math.trunc(i / 60) % 60;
        LguiUtil_1.LguiUtil.SetLocalText(this.GetText(10), "ShopItemLimitTime2", t, i);
      }
    }
