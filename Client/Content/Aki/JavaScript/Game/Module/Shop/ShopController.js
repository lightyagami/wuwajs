...
class ShopController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(21521, e => {
      Log_1.Log.CheckInfo() && Log_1.Log.Info("Shop", 18, "Receive ShopInfoNotify"), ModelManager_1.ModelManager.ShopModel.VersionId = e.ejn, ModelManager_1.ModelManager.ShopModel.UpdateShopListData(e.tGs)
    }), Net_1.Net.Register(23373, e => {
      Log_1.Log.CheckInfo() && Log_1.Log.Info("Shop", 18, "Receive ShopUnlockNotify", ["unlockList", e.ABs]), this.OnShopUnlockNotify(e)
    }), Net_1.Net.Register(17237, this.OnShopInfoUpdateNotify)
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(21521), Net_1.Net.UnRegister(23373), Net_1.Net.UnRegister(17237)
  }
  static OpenShop(e, o) {
    if (ModelManager_1.ModelManager.ShopModel.IsOpen(e)) {
      if (!UiManager_1.UiManager.IsViewShow("ShopView")) return UiManager_1.UiManager.OpenView("ShopView", e, o), !0
    } else GlobalData_1.GlobalData.World && (o = ConfigManager_1.ConfigManager.ShopConfig.GetShopName(ModelManager_1.ModelManager.ShopModel.GetShopConfig(e).ShopName)) && ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("ShopNotOpenTip", o);
    return !1
  }
