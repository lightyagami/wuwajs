...
class MainRoleController extends UiControllerBase_1.UiControllerBase {
    ...
    Net_1.Net.Call(24053, r, e => {
      if (e) {
        if (e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs) {
          ...
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16348);
        }
      }
    });
  }
  static SendRoleElementChangeRequest(e) {
    ...
    r.wHn = e;
    Net_1.Net.Call(29178, r, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 28490);
        } else {
          EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRoleChangeEnd);
          this.U1o();
        }
  ...
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(26703);
    Net_1.Net.UnRegister(29763);
  }
}
