...
class RoleSkillInputView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Dmo = void 0, this.lqe = void 0, this.pFe = () => {
  ...
  OnStart() {
    ...
    this.Dmo.RefreshUi(e.GetRoleId(), e.IsTrialRole(), !0), this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(0)), this.lqe.SetCloseCallBack(this.pFe)
  }
}
