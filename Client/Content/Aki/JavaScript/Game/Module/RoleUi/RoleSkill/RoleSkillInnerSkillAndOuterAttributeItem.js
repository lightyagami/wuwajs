...
class RoleSkillInnerSkillAndOuterAttributeItem extends RoleSkillChainItem_1.RoleSkillChainItem {
  ...
  OnStart() {
    ...
    e.CreateThenShowByActor(this.GetItem(0).GetOwner()), this.SkillNodeItemList.push(e);
    for (const r of [1, 2]) {
      var l = this.GetItem(r),
        t = new RoleSkillOuterAttributeSkillItem_1.RoleSkillOuterAttributeSkillItem;
