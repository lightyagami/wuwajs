...
class RoleSkillTreeInfoItem extends UiPanelBase_1.UiPanelBase {
        ...
        for (var [i, e] of t) {
          if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(i) < e) {
            ...
            UiManager_1.UiManager.OpenView("SynthesisTipsInfoView", i, (t, i) => {
              if (t && this.yzi !== undefined) {
                this.yzi.AddChildViewById(i);
              }
            });
            return;
          }
  ...
  Update(t) {
    ...
    let i = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(this.GWd.RoleId);
    i = i || ModelManager_1.ModelManager.RoleModel.GetRoleDataById(this.GWd.RoleId);
  ...
  ndo() {
    ...
    var t = ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillTreeNode(this.GWd.SkillNodeId);
  ...
  udo() {
    ...
    var t = ModelManager_1.ModelManager.RoleModel.GetRoleSkillTreeNodeLevel(this.GWd.RoleId, this.GWd.SkillNodeId);
  ...
  Pke(i = 1) {
    i = ConfigManager_1.ConfigManager.RoleSkillConfig.GetRoleSkillTreeConsume(this.GWd.SkillNodeId, i);
    if (i && i.size !== 0) {
  ...
  Kmo(t, i) {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRoleSkillInputPanelVisible, i);
    if (this.kmo === 2) {
      if (i) {
        this.gdo();
      } else {
  ...
  RefreshRoleBackgroundMusicSwitchItem() {
    var t = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(this.GWd.RoleId);
  ...
  g9f() {
    var t;
    var i = this.GWd.SkillNodeId;
    if (ModelManager_1.ModelManager.RoleModel.IsSkillNodeHasBranch(i)) {
      this.f9f = true;
      t = this.GWd.RoleId;
      t = ModelManager_1.ModelManager.RoleModel.GetSkillNodeCurrentBranchId(t, i);
      i = ConfigManager_1.ConfigManager.RoleConfig.GetSkillBranchConfigById(t);
      t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.Name);
      i = ConfigManager_1.ConfigManager.RoleConfig.GetSkillBranchActivatedDescKey();
      LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(36), i, t);
    } else {
      this.f9f = false;
    }
  }
  C9f(t) {
    this.GetItem(35).SetUIActive(this.q$f && this.f9f && t);
  }
  SetSkillBranchEnable(t) {
    this.q$f = t;
  }
  SetParentView(t) {
    this.yzi = t;
