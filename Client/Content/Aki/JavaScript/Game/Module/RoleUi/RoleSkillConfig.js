...
class RoleSkillConfig extends ConfigBase_1.ConfigBase {
  GetSkillConfigById(e) {
    ...
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 10, "当前选中的技能配置为空", ["id", e]), l
  }
  GetSkillLevelConfigByGroupIdAndLevel(e, l) {
    ...
    return void 0 === i && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 10, "技能配置为空", ["skillLevelGroupId", e], ["level", l]), i
  }
  ...
  GetSkillTypeNameLocalText(e) {
    ...
    if (e) return MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.TypeName)
  }
  GetSkillList(e) {
  ...
  GetSkillTreeNode(e) {
    ...
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "技能树配置为空，Id = ", ["nodeId", e]), l
  }
  ...
  GetSkillTreeNodeByGroupIdAndIndex(e, l) {
    ...
    return void 0 === i && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "技能树配置为空，NodeGroup = " + e + ", NodeIndex = " + l), i
  }
  ...
  GetSkillConditionById(e) {
    ...
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "技能条件配置为空，Id = ", ["skillConditionId", e]), l
  }
  GetRoleSkillTreeConsume(e, l) {
    ...
    if (e) {
      ...
      if (e) {
        ...
        if (i && 0 !== i) return this.GetSkillLevelConfigByGroupIdAndLevel(i, l)?.Consume
      }
    }
  }
  GetRoleSkillDescriptionConfigById(e) {
    var l = SkillDescriptionById_1.configSkillDescriptionById.GetConfig(e);
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "技能描述配置为空，Id = ", ["id", e]), l
  }
  GetAllRoleSkillDescConfigByGroupId(e) {
    ...
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 37, "技能描述配置为空", ["GroupId", e]), l
  }
  GetSkillInputConfigById(e) {
    var l = SkillInputById_1.configSkillInputById.GetConfig(e);
    return void 0 === l && Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "技能出招表配置为空，Id = ", ["skillInputId", e]), l
  }
