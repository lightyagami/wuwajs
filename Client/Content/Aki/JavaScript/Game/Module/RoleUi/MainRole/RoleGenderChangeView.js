...
class RoleGenderChangeView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Ylo = () => {
      ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("GenderTransferSuccess"), this.CloseMe()
    }, this.OnClickCancel = () => {
      this.CloseMe()
    }, this.OnClickConfirm = () => {
      var e;
  ...
  OnStart() {
    ...
    if (e) {
      var r = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e),
        ...
        t = r.ElementId,
        o = o === LoginDefine_1.ELoginSex.Boy ? LoginDefine_1.ELoginSex.Girl : LoginDefine_1.ELoginSex.Boy,
      ...
      i && (this.SetRoleIcon(r.RoleHeadIconBig, this.GetTexture(0), e), this.SetRoleIcon(i.RoleHeadIconBig, this.GetTexture(1), n), o = ModelManager_1.ModelManager.MainRoleModel.CanChangeSex(), this.GetInteractionGroup(7)?.SetInteractable(o), r = CommonParamById_1.configCommonParamById.GetIntConfig("ChangeSexCd"), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(4), "GenderTransfer", Math.round(r / TimeUtil_1.TimeUtil.Hour)), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(5), "Cancel"), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(6), "Confirm"))
    }
  }
  OnAddEventListener() {
