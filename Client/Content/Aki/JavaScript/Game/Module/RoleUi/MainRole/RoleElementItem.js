...
class RoleElementItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.d1o = void 0, this.C1o = void 0, this.OnToggleCallback = void 0, this.CanToggleChange = void 0
  }
  OnRegisterComponent() {
  ...
  Update(t) {
    ...
    this.GetText(2).ShowTextNew(e.Name), this.SetElementIcon("", this.GetTexture(1), t), this.SetTextureByPath(e.ElementChangeTexture, this.GetTexture(0)), this.RefreshState()
  }
  Refresh(t, e, i) {
