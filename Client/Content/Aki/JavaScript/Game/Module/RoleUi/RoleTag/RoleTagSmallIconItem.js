...
class RoleTagSmallIconItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, o, r) {
    ...
    void 0 === t ? Log_1.Log.CheckError() && Log_1.Log.Error("Role", 58, "RoleTagSmallIconItem无效tagId", ["TagId", e]) : (e = this.GetSprite(0), this.SetActive(!1), this.SetSpriteByPath(t.TagIcon, e, !1, void 0, () => {
      this.SetActive(!0)
    }))
  }
}
