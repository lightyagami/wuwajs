...
exports.RoleSkillEffectItem = undefined;
const UE = require("ue");
...
class RoleSkillEffectItem extends UiPanelBase_1.UiPanelBase {
  ...
  UpdateItem(e, t) {
    ...
    var r = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.AttributeName);
  ...
  GetAttrValueStr(e, t) {
    let i = "";
    if (e.Description) {
      i = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Description), ...t.Desc);
    } else {
