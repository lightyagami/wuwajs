...
class RoleSkillEffectItem extends UiPanelBase_1.UiPanelBase {
  ...
  UpdateItem(e, t) {
    var i = ConfigManager_1.ConfigManager.RoleSkillConfig.GetRoleSkillDescriptionConfigById(e.Id),
      r = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(i.AttributeName);
    this.GetText(0).SetText(r), this.GetText(1).SetText(this.GetAttrValueStr(i, e)), this.GetText(2).SetText(this.GetAttrValueStr(i, t))
  }
  GetAttrValueStr(e, t) {
    let i = "";
    if (e.Description) i = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Description), ...t.Desc);
    else {
