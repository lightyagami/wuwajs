...
class RoleRobotData extends RoleDataBase_1.RoleDataBase {
  ...
  s_o() {
    var a = ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(this.Id),
      ...
      r = this.GetRoleId(),
      o = ModelManager_1.ModelManager.RoleModel.ClientCheckRoleIsUpgradeLightMainRole(r);
    for (const g of e.GetSkillList()) {
      var i = this.__o(g.Id),
        i = i < a.UnlockSkillLevel ? i : a.UnlockSkillLevel,
        n = ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillTreeNodeByGroupIdAndSkillId(t, g.Id);
      (n || o) && (3 === n?.NodeType ? e.SetSkillLevel(g.Id, 0) : e.SetSkillLevel(g.Id, i), e.SetSkillReferenceMapBySkillId(g.Id))
    }
    var s = [];
    for (const h of a.UnlockSkillNodeList) {
      var l = ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillTreeNodeByGroupIdAndIndex(t, h),
        _ = l?.NodeType;
      4 !== _ && 3 !== _ || s.push(new SkillNodeDataInfo_1.SkillNodeDataInfo(l.Id, !0, l.SkillId))
    }
    0 < s.length && e.SetSkillNodeStateData(s)
  }
  __o(a) {
    a = ConfigCommon_1.ConfigCommon.ToList(ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillLevelConfigList(a)), a.sort((a, e) => a.Id - e.Id), a = a[a.length - 1];
    return a.SkillId
  }
  a_o() {
    var a = ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(this.Id);
  ...
  h_o() {
    var a = ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(this.Id);
    this.r_o = new WeaponTrialData_1.WeaponTrialData, this.r_o.SetTrialId(a.TrailWeapon), this.r_o.SetRoleId(this.Id)
  }
  l_o() {
    var t = this.GetPhantomData(),
      r = (t.SetIsTrial(!0), ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(this.Id));
    for (let a = 0, e = r.PhantomEquipList.length; a < e; ++a) {
      var o = r.PhantomEquipList[a],
        i = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetTrialPhantomPropConfig(o.Item2),
        n = new PhantomTrialBattleData_1.PhantomTrialBattleData;
      n.SetIncId(PhantomTrialBattleData_1.PhantomTrialBattleData.GenerateLocalUniqueId(this.GetRoleId(), a)), n.SetConfigId(o.Item1), n.SetPhantomLevel(i.Level), n.SetSlotIndex(a), n.SetFetterGroupId(i.FetterGroupId);
      for (const g of i.MainProps) {
        var s = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetTrailPhantomPropItemById(g),
          l = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomGrowthValueByGrowthIdAndLevel(i.MainPropGrowth, i.Level),
      ...
      t.SetDataMap(a, n), ModelManager_1.ModelManager.PhantomBattleModel.SetRobotPhantomData(n.GetIncrId(), n)
    }
  }
  Cbl() {
    var a = ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(this.Id);
