...
class RoleLevelData extends RoleModuleDataBase_1.RoleModuleDataBase {
  constructor() {
    super(...arguments), this.Level = 0, this.BreachLevel = 0, this.Exp = 0
  }
  SetLevel(e) {
    this.Level = e
  }
  ...
  GetExpPercentage() {
    var e;
    return this.GetRoleIsMaxLevel() ? 1 : (e = ConfigManager_1.ConfigManager.RoleConfig.GetRoleLevelConsume(this.GetRoleConfig().LevelConsumeId, this.Level + 1)) ? this.Exp / e.ExpCount : 0
  }
  IsEnoughBreachConsume() {
    ...
    if (e) {
      if (!ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(e.ConditionId.toString(), void 0, !1)) return !1;
      for (const r of e.BreachConsume)
        if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(r[0]) < r[1]) return !1;
      return !0
    }
    return !1
  }
