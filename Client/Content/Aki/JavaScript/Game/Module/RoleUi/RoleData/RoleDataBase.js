...
class RoleDataBase {
  ...
  GetShowAttrList() {
    ...
    if (e) {
      ...
      var r = t ? t.EntityHandle.Entity.GetComponent(184) : undefined;
      for (const i of e) {
        if (i.IsShow) {
          let e = 0;
          let t = 0;
  ...
  GetShowAttributeValueById(e) {
    ...
    var a = a ? a.EntityHandle?.Entity?.GetComponent(184) : undefined;
    let r = 0;
    if (a) {
  ...
  GetBaseAttributeValueById(e) {
    ...
    var t = t ? t.EntityHandle.Entity.GetComponent(184) : undefined;
    let a = 0;
