...
class RoleDataBase {
  constructor(e) {
    this.RoleModelConfig = void 0, this.t_o = new Map, this.i_o = [RoleLevelData_1.RoleLevelData, RoleAttributeData_1.RoleAttributeData, RoleSkillData_1.RoleSkillData, RoleResonanceData_1.RoleResonanceData, RolePhantomData_1.RolePhantomData, RoleAudioData_1.RoleAudioData, RoleFavorData_1.RoleFavorData], this.BIl = -1, this.SortAttrList = (e, t) => {
      var a = 0 !== e.Priority,
        r = 0 !== t.Priority;
      return a && r ? e.Priority - t.Priority : a ? -1 : r ? 1 : e.Id - t.Id
    }, this.Id = e, this.Name = ConfigManager_1.ConfigManager.RoleConfig.GetRoleName(this.GetRoleConfig().Name), this.o_o()
  }
  o_o() {
  ...
  GetRoleSkillTreeConfig() {
    ...
    if (e) return ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillTreeNodeListByGroupId(e.SkillTreeGroupId)
  }
  GetDataId() {
    return this.Id
  }
  GetShowAttrList() {
    ...
    if (e) {
      var t = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItem(this.Id, {
        ...
        r = t ? t.EntityHandle.Entity.GetComponent(173) : void 0;
      for (const i of e)
        if (i.IsShow) {
          let e = 0,
            t = 0;
          ...
          var o = new AttrListScrollData_1.AttrListScrollData(i.Id, e, t, i.Priority, !1, 0);
          a.push(o)
        } t = this.y3l();
  ...
  y3l() {
    var e, t, a = FormationPropertyById_1.configFormationPropertyById.GetConfig(10);
    return ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(a.Condition.toString(), void 0) ? (e = new Array, t = ModelManager_1.ModelManager.FormationAttributeModel.GetData(10), a = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(a.PropertyIndex), t && (t = new AttrListScrollData_1.AttrListScrollData(a.Id, t.Max / 100, 0, a.Priority, !1, 0), e.push(t)), e) : []
  }
  GetShowAttributeValueById(e) {
    var t, a = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItem(this.Id, {
        ParamType: 0,
        OnlyMyRole: !0
      }),
      a = a ? a.EntityHandle?.Entity?.GetComponent(173) : void 0;
    let r = 0;
    return a ? 0 === (r = a.GetCurrentValue(e)) && Log_1.Log.CheckWarn() && Log_1.Log.Warn("Character", 43, "角色界面获取实体属性值为0", ["id", e]) : (t = (a = this.GetAttributeData()).GetRoleBaseAttr(e), a = a.GetRoleAddAttr(e), 0 === (r = t + a) && Log_1.Log.CheckWarn() && Log_1.Log.Warn("Character", 43, "角色界面从服务器获取的属性值为0", ["id", e], ["baseAttr", t], ["addAttr", a])), r
  }
  GetBaseAttributeValueById(e) {
    var t = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItem(this.Id, {
      ...
      t = t ? t.EntityHandle.Entity.GetComponent(173) : void 0;
    let a = 0;
