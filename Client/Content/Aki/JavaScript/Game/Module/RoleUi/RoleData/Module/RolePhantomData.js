...
class RolePhantomData extends RoleModuleDataBase_1.RoleModuleDataBase {
  constructor() {
    super(...arguments), this.PhantomMap = new Map, this.Hfi = !1, this.NQ = new Map, this.Y1o = new Array
  }
  RefreshPhantom(t, a) {
  ...
  GetPhantomFettersData() {
    const s = new Array;
    return this.GetPhantomFetterMap().forEach((t, r) => {
      t.forEach((t, a) => {
        var e = new PhantomDataBase_1.VisionFetterData;
        e.FetterGroupId = r, e.FetterId = a, e.NeedActiveNum = t, e.ActiveFetterGroupNum = t, e.ActiveState = !0, s.push(e)
      })
    }), s
  }
  GetPhantomFetterMap() {
  ...
  GetPhantomFettersList() {
    var t = this.J1o();
    return this.Y1o = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterResultBySuitMap(t), this.Y1o
  }
  J1o() {
