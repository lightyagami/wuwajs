...
class RolePreviewAttributeTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.RoleViewAgent = void 0, this.RoleInstance = void 0, this.nvt = void 0, this.Kco = e => {
      this.PlayMontageStartWithReLoop(), this.VC(e)
    }, this.iCo = (e, t, i) => {
      var r = new RoleLevelUpSuccessAttributeView_1.RoleAttributeItem;
      return r.SetRootActor(t.GetOwner(), !0), r.Refresh(e), {
        Key: i,
        Value: r
      }
    }
  ...
  OnStart() {
    this.RoleViewAgent = this.ExtraParams, void 0 === this.RoleViewAgent ? Log_1.Log.CheckError() && Log_1.Log.Error("Role", 58, "RoleViewAgent为空", ["界面名称", "RolePreviewAttributeTabView"]) : this.nvt = new GenericLayoutNew_1.GenericLayoutNew(this.GetVerticalLayout(3), this.iCo)
  }
  AddEventListener() {
  ...
  OnBeforeDestroy() {
    this.RoleInstance = void 0, this.nvt?.ClearChildren(), this.nvt = void 0
  }
  PlayMontageStart() {
  ...
  VC(e) {
    this.RoleInstance = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e), this.oCo(), this.rCo(), this.nCo(), this.sCo()
  }
  rCo() {
    var e = this.RoleInstance.GetElementInfo(),
      e = (this.SetElementIcon(e.Icon, this.GetTexture(1), this.RoleInstance.GetRoleConfig().ElementId), ConfigManager_1.ConfigManager.ElementInfoConfig.GetElementInfoLocalName(e.Name));
  ...
  nCo() {
    var e = ConfigManager_1.ConfigManager.RoleFavorConfig.GetFavorRoleInfoConfig(this.RoleInstance.GetRoleId()),
      ...
      i = [],
      t = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponTypeName(t.WeaponType),
      e = (i.push({
        Name: "Text_Weapon_Text",
        CurText: t
      }), e && (t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Sex), i.push({
        Name: "PrefabTextItem_3159729083_Text",
        CurText: t
      }), t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Country), i.push({
        Name: "PrefabTextItem_3969856612_Text",
        CurText: t
      }), t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Influence), i.push({
        Name: "PrefabTextItem_152395022_Text",
        CurText: t
      })), RoleFavorUtil_1.RoleFavorUtil.GetCurLanguageCvName(this.RoleInstance.GetRoleId())),
