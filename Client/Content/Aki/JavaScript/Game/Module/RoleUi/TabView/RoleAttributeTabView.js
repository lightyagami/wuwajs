...
class RoleAttributeTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.Ndo = 0, this.Odo = void 0, this.kdo = void 0, this.RoleViewAgent = void 0, this.RoleInstance = void 0, this.AttributeItemList = [], this.RoleSystemUiParams = void 0, this.$be = void 0, this.Klo = void 0, this.DetailClick = () => {
      this.Fdo()
    }, this.LevelUpClick = () => {
      ...
      ModelManager_1.ModelManager.GameModeModel.IsMulti ? ControllerHolder_1.ControllerHolder.ScrollingTipsController.ShowTipsById("InstanceDungeonShieldViewCantOpen") : (LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.DirectTrainMakeRoleChange, !0), this.GetItem(23)?.SetUIActive(!1), UiManager_1.UiManager.OpenView("RoleElementView", this.RoleViewAgent))
    }, this.RoleTagClick = () => {
      ...
      SkinController_1.SkinController.SkipToSkinView(e, "RoleSkinTabView", !1)
    }, this.TeachClick = () => {
      if (ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()) ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("RoleGuideNotice01");
        ...
        0 === r ? ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("RoleGuideNotice02", t) : ControllerHolder_1.ControllerHolder.InstanceDungeonController.IsForbidDungeon(r) ? ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("PhantomFormationEnterInstanceTip") : ((e = new ConfirmBoxDefine_1.ConfirmBoxDataNew(94)).SetTextArgs(t), e.FunctionMap.set(2, () => {
          ...
          if (0 < (e?.length ?? 0)) {
            var t = new Array;
            for (const i of e) t.push(ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleIdConfigByGroupId(i));
            e = {
              Q6n: o
            };
            ModelManager_1.ModelManager.InstanceDungeonModel.InstanceEnterContentText.Hah = e, InstanceDungeonController_1.InstanceDungeonController.PrewarTeamFightRequest(r, t, 0, 0)
          } else Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "未配置出战人物")
        }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e))
      }
    }, this.dVi = void 0, this.vke = () => {
      return new StarItem_1.StarItem
    }, this.qdo = () => new RoleTagSmallIconItem_1.RoleTagSmallIconItem, this.Vdo = e => {
      this.RoleInstance = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleSkinRedDotRefresh, e), this.PlayMontageStartWithReLoop(), this.Hdo(), this.jdo()
    }, this.Wdo = () => {
      this.Hdo()
    }, this.Kdo = () => {
  ...
  Uho() {
    ...
    for (let e = 0; e < n; ++e) {
      ...
      a.CreateThenShowByActor(r.GetOwner()), a.UpdateParam(s, !1), 2 < n && e % 2 == 0 ? a.SetBgActive(!0) : a.SetBgActive(!1), this.AttributeItemList.push(a)
    }
  }
  AddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RoleInfoUpdate, this.Wdo), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RoleSystemChangeRole, this.Vdo), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RoleLevelUp, this.Wdo), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ActiveRole, this.Kdo), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RoleRefreshName, this.Qdo)
  }
  RemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RoleInfoUpdate, this.Wdo), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RoleSystemChangeRole, this.Vdo), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RoleLevelUp, this.Wdo), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ActiveRole, this.Kdo), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RoleRefreshName, this.Qdo)
  }
  jdo() {
    var e, t, i;
    this.Odo.BindRedDot("RoleAttributeTabLevelUp", this.RoleInstance.GetDataId()), this.kdo.BindRedDot("RoleAttributeTabBreakUp", this.RoleInstance.GetDataId()), RedDotController_1.RedDotController.BindRedDot("RoleSkin", this.GetItem(22), void 0, this.RoleInstance.GetDataId()), this.RoleSystemUiParams.TeachBtn && (e = this.RoleInstance.IsTrialRole(), t = ModelManager_1.ModelManager.FunctionModel.IsShow(10043), i = ModelManager_1.ModelManager.FunctionModel.IsOpen(10043), t) && i ? this.GetButton(14).GetRootComponent().SetUIActive(!e) : this.GetButton(14).GetRootComponent().SetUIActive(!1)
  }
  PlayModelEffect() {
  ...
  $do() {
    ...
    var e = this.RoleInstance.GetLevelData(),
      t = (1 === this.Ndo || 0 === this.Ndo ? this.GetText(2).SetText("") : LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "RoleExp", e.GetExp(), e.GetCurrentMaxExp()), 1 === this.Ndo || 0 === this.Ndo ? 1 : e.GetExpPercentage()),
  ...
  Ydo() {
    ...
    void 0 !== (i = i?.replace("%s", "[" + t + "]")) && this.GetText(4).SetText(i);
    ...
    e = 0 === this.Ndo ? e.GetRoleMaxLevel() : e.GetLevel(), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(7), "CommonLevel", e), e = this.RoleInstance.GetElementInfo(), this.SetElementIcon(e.Icon, this.GetTexture(9), this.RoleInstance.GetRoleConfig().ElementId, "RoleRootView"), e = ConfigManager_1.ConfigManager.ElementInfoConfig.GetElementInfoLocalName(e.Name);
  ...
  Hdo() {
    this.$do(), this.UpdateButtonState(), this.Ydo(), this.Xdo(), this.UpdateAttribute(), this.zdo(), this.Zdo(), this.Jdo(), this.bIl()
  }
  Zdo() {
    var e = this.RoleViewAgent.GetCurSelectRoleId(),
      ...
      t = t.IsTrialRole(),
      i = ConfigManager_1.ConfigManager.RoleConfig.GetRoleElementTransferFunctionId(),
      ...
      e = e && i && !o && !t;
    this.GetButton(16).RootUIComp.SetUIActive(e), this.GetItem(23)?.SetUIActive(e && !LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.DirectTrainMakeRoleChange))
  }
  bIl() {
  ...
  UpdateButtonState() {
    if (this.RoleInstance.IsTrialRole()) this.Odo.SetActive(!1), this.kdo.SetActive(!1);
    else {
      let e = "RoleMaxLevelPreview";
      this.Odo.SetActive(0 !== this.Ndo && 3 !== this.Ndo), 0 !== this.Ndo && (1 === this.Ndo ? e = "RoleReachMaxLevel" : 3 === this.Ndo ? e = "RoleBreakup" : 2 === this.Ndo && (e = "RoleLevelUp"), t = ConfigManager_1.ConfigManager.TextConfig.GetTextById(e), this.Odo.SetText(t), this.Odo.SetEnableClick(1 !== this.Ndo)), this.kdo.SetActive(0 !== this.Ndo && 3 === this.Ndo);
  ...
  SetRoleLevelUpState() {
    var e = this.RoleInstance.GetLevelData();
    e.GetRoleIsMaxLevel() ? this.Ndo = 1 : e.GetRoleNeedBreakUp() ? this.Ndo = 3 : this.Ndo = 2
  }
  PlayMontageStart() {
  ...
  OnBeforeShow() {
    this.RoleInstance = this.RoleViewAgent.GetCurSelectRoleData(), this.Hdo(), this.jdo(), this.Odo.BindRedDot("RoleAttributeTabLevelUp", this.RoleInstance.GetDataId())
  }
  OnAfterShow() {
    this.PlayMontageStart()
  }
  OnBeforeHide() {
    this.Odo.UnBindRedDot(), RedDotController_1.RedDotController.UnBindGivenUi("RoleSkin")
  }
  OnBeforeDestroy() {
