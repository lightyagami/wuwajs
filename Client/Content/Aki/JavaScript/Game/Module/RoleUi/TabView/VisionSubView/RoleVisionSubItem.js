...
exports.RoleVisionSubItem = undefined;
const UE = require("ue");
...
class RoleVisionSubItem extends RoleVisionCommonItem_1.RoleVisionCommonItem {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIExtendToggle], [1, UE.UISprite], [2, UE.UIDraggableComponent], [3, UE.UITexture], [4, UE.UIText], [5, UE.UISprite], [6, UE.UIItem], [7, UE.UIText], [8, UE.UIItem]];
