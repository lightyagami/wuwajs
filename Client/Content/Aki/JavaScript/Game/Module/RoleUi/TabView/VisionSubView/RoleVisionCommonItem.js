...
class RoleVisionCommonItem extends UiPanelBase_1.UiPanelBase {
  constructor(t, e, i, s = !1) {
    super(), this.AnimationState = !1, this.CurrentIndex = void 0, this.CurrentData = void 0, this.RoleData = void 0, this.ShowType = 0, this.wqe = void 0, this.NeedRedDot = !1, this.OnDragItemDragBegin = () => {
      this.OnDragBegin()
    }, this.OnDragItemDragEnd = () => {
      this.OnDragEnd()
    }, this.OnClickVision = () => {}, this.OnUnOverlay = () => {
    ...
    }, this.CurrentIndex = e, this.wqe = t, this.RoleData = i, this.NeedRedDot = s
  }
  async Init() {
  ...
  SetAniLightState(t) {}
  UpdateItem(t, e) {
    this.CurrentData = t, this.RoleData = e || this.RoleData, this.xCo(t), this.Kbe(t), this.BGt(t), this.OnUpdateItem(t)
  }
  Kbe(t) {
    this.GetVisionTextureComponent().SetUIActive(void 0 !== t), t && (t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(t.GetConfigId(!0)), this.SetTextureByPath(t.IconMiddle, this.GetVisionTextureComponent(), "VisionEquipmentView"))
  }
  BGt(t) {
  ...
  SetToggleState(t, e = !1, i = !1) {
    this.GetSelectToggle().ToggleState !== t && this.GetSelectToggle().SetToggleStateForce(t, e, i)
  }
