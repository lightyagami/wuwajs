...
class RoleVisionIdentifyAttribute extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.AttributeScroller = void 0, this.sGe = () => new VisionIdentifyItem_1.VisionIdentifyItem
  }
  OnRegisterComponent() {
  ...
  Refresh(e, a, i) {
    ...
    e.forEach(e => {
      ...
      if (i.Data = e, i.SourceView = "VisionEquipmentView", i.CurrentVisionData = a, e.PhantomSubProp) {
        var t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSubPropertyById(e.PhantomSubProp.Yws);
        if (n)
          for (let e = 0; e < o; e++) t.AddType === r[e].GetAddType() && t.PropId === r[e].GetAttrId() && (i.NeedHighLight = !0)
      }
      s.push(i)
