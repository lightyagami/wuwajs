...
class RoleVisionInfoPanel extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.d1o = void 0, this.u9i = void 0, this.m9i = void 0, this.FCo = void 0, this.wqe = void 0, this.wCo = !1, this.VCo = () => {
      ...
      i.FunctionMap.set(1, () => {
        ...
        ControllerHolder_1.ControllerHolder.PhantomBattleController.SendPhantomAutoPutRequest(e.GetRoleId(), t), ControllerHolder_1.ControllerHolder.ConfirmBoxController.CloseConfirmBoxView(), UiManager_1.UiManager.CloseView("VisionRecommendView")
      }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(i)
    }, this.HCo = () => {
      var e = this.d1o.GetCurSelectRoleId();
      UiManager_1.UiManager.OpenView("VisionRecommendView", e)
    }, this.D3e = () => {
      var e, t = this.d1o.GetCurSelectRoleData();
      t && (e = [], e = ModelManager_1.ModelManager.PhantomBattleModel.GetExtraAttrList(t.GetDataId()), UiManager_1.UiManager.OpenView("RoleAttributeDetailView", e))
    }, this.sOt = () => {
      this.FCo?.()
    }, this.WCo = () => {
      this.Hqe()
  ...
  async OnBeforeStartAsync() {
    this.m9i = new VisionDetailDescComponent_1.VisionDetailDescComponent(this.GetItem(2)), await this.m9i.Init()
  }
  OnStart() {
    this.m9i.SetActive(!0), this.u9i = new RoleVisionAttribute_1.RoleVisionAttribute(this.GetItem(0)), this.u9i.Init(), this.AddEventListener()
  }
  K8e() {
    var e;
    this.wCo || (this.wCo = !0, e = this.d1o.GetCurSelectRoleId(), RedDotController_1.RedDotController.BindRedDot("VisionOneKeyEquip", this.GetItem(6), void 0, e))
  }
  Ovt() {
    this.wCo && (this.wCo = !1, RedDotController_1.RedDotController.UnBindGivenUi("VisionOneKeyEquip", this.GetItem(6)))
  }
  GetTxtItemByIndex(e) {
  ...
  Hqe() {
    this.fvt(), this.KCo(), this.QCo(), this.RefreshButtonShowState(), this.Ovt(), this.K8e()
  }
  fvt() {
    let i;
    ...
    e.forEach(t => {
      ...
      for (let e = 0; e < n; e++)
        if (i[e].Id === t) {
          o.push(i[e]), r = !0;
          break
        } r || o.push(new AttrListScrollData_1.AttrListScrollData(t, 0, 0, e.Priority, !1, 1))
  ...
  KCo() {
    ...
    const i = new Array;
    t ? VisionDetailDescComponent_1.VisionDetailDesc.ConvertVisionSkillDescToDescData(t.GetNormalSkillConfig(), t.GetPhantomLevel(), !0, !1, t.GetQuality()).forEach(e => {
      i.push(e)
    }) : VisionDetailDescComponent_1.VisionDetailDesc.CreateEmptySkillDescData().forEach(e => {
      i.push(e)
    });
    t = e.GetPhantomData().GetPhantomFettersData();
    0 === t.length ? VisionDetailDescComponent_1.VisionDetailDesc.CreateEmptyFetterDescData().forEach(e => {
      i.push(e)
    }) : VisionDetailDescComponent_1.VisionDetailDesc.ConvertVisionFetterDataToDetailDescData(t, !1).forEach(e => {
      i.push(e)
    }), i.forEach(e => {
  ...
  QCo() {
    var e = this.d1o.GetCurSelectRoleData();
    if (e.IsTrialRole()) this.RefreshOneKeyButtonState(!1), this.GetButton(4).RootUIComp.SetUIActive(!1);
    else {
