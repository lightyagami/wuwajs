...
class RoleVisionDescScroller extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.ZHe = void 0, this.Y6i = (e, s, t) => {
...
class RoleVisionFetterDescScrollerItem extends UiPanelBase_1.UiPanelBase {
  ...
  Update(e) {
    this.GetText(0).ShowTextNew(e.Name), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.EffectDescription, ...e.EffectDescriptionParam)
  }
}
