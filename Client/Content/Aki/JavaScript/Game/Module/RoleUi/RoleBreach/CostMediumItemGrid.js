...
class CostMediumItemGrid extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  OnRefresh(t, e, o) {
    ...
    if (i) {
      ...
      if (t.OnlyTextFlag) m.Type = 4, m.Data = t, m.ItemConfigId = r, m.StarLevel = i.QualityId, m.BottomText = t.Count.toString();
      else {
        ...
        d = [d, s];
        m.Data = t, m.ItemConfigId = r, m.StarLevel = i.QualityId, m.BottomTextId = e, m.BottomTextParameter = d
      }
