...
class CostItemGridComponent extends UiPanelBase_1.UiPanelBase {
  constructor(t, e, i, s = void 0) {
    super(), this.A1o = e, this.P1o = i, this.BelongView = s, this.ScrollView = void 0, this.ypt = void 0, this.x1o = 0, this.w1o = 0, this.p4e = void 0, this.B1o = !1, this.sGe = (t, e, i) => {
      var s = new CostMediumItemGrid_1.CostMediumItemGrid;
      return s.Initialize(e.GetOwner()), s.Refresh(t, !1, i), s.BindOnCanExecuteChange(() => !1), s.BindOnExtendToggleRelease(this.Jgt), {
        Key: i,
        Value: s
      }
    }, this.Jgt = t => {
      t = t.Data;
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(t.ItemId), ModelManager_1.ModelManager.ComposeModel.ComposeSelectItem = t
  ...
  OnStart() {
    ...
    this.ScrollView = new GenericScrollView_1.GenericScrollView(t, this.sGe), this.GetButton(17)?.RootUIComp?.SetUIActive(void 0 !== this.P1o)
  }
  Update(t, e, i) {
