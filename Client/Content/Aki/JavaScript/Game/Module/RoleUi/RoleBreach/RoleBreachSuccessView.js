...
class RoleBreachSuccessView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.dFe = 0, this.SuccessStarItem = void 0, this.StarLayout = void 0, this.StarList = [], this.MaskClick = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    this.GetText(2).SetText(i.toString()), this.GetText(3).SetText(e.toString()), this.StarLayout = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.vke), await this.UpdateStar(t, r)
  }
  OnHandleLoadScene() {
    UiSceneManager_1.UiSceneManager.ShowRoleSystemRoleActor();
    var e = UiSceneManager_1.UiSceneManager.GetRoleSystemRoleActor();
    e && (e.Model?.CheckGetComponent(1))?.SetTransformByTag("RoleCase"), RoleController_1.RoleController.PlayRoleMontage(3, !0)
  }
  ...
  async UpdateStar(e, t) {
    ...
    if (!(r < 0)) {
      ...
      await this.StarLayout.RefreshByDataAsync(i), this.SuccessStarItem = this.StarLayout.GetLayoutItemByIndex(r)
    }
  }
}
