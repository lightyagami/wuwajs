...
class CostItemGrid extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnStart() {
    ...
    this.ebt.SetToggleClickEvent((t, e) => {
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.ebt.GetConfigId()), this.ebt.GetClickToggle().SetToggleState(0, !1)
    }), this.ebt.GetAddButton().RootUIComp.SetUIActive(!1), this.ebt.GetReduceButton().RootUIComp.SetUIActive(!1), this.ebt.RefreshItemShowState(!0)
  }
