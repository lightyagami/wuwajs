...
class RoleModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.dco = new Map, this.Cco = new Map, this.gco = new Set, this.P9l = new Set, this.fco = new Map, this.pco = !1, this.vco = void 0, this.Mco = !1, this.RoleTrialIdList = new Set, this.DefaultSortFunc = (e, t) => {
      var r = e.GetLevelData(),
        o = t.GetLevelData();
      return r.GetLevel() !== o.GetLevel() ? o.GetLevel() - r.GetLevel() : e.GetRoleConfig().QualityId !== t.GetRoleConfig().QualityId ? t.GetRoleConfig().QualityId - e.GetRoleConfig().QualityId : e.GetRoleConfig().Priority !== t.GetRoleConfig().Priority ? t.GetRoleConfig().Priority - e.GetRoleConfig().Priority : -1
    }, this.Eco = void 0, this.Sco = void 0, this.yco = void 0, this.Ico = [], this.zyn = !1, this.xie = (e, t) => {
      t && (t.Entity?.GetComponent(193)).RemoveTagAddOrRemoveListener(1733479717, this.Zyn), e && ((t = e.Entity?.GetComponent(193)).AddTagAddOrRemoveListener(1733479717, this.Zyn), this.zyn !== t.HasTag(1733479717)) && (this.zyn = !this.zyn, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnEnterOrExitUltraSkill, this.zyn))
    }, this.Zyn = (e, t) => {
      1733479717 === e && (this.zyn = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnEnterOrExitUltraSkill, t))
    }
  }
  set IsInRoleTrial(e) {
  ...
  OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnChangeRole, this.xie), ModelManager_1.ModelManager.NewFlagModel.SaveNewFlagConfig(LocalStorageDefine_1.ELocalStoragePlayerKey.RoleDataItem), this.IsInRoleTrial = !1, this.dco.clear(), this.Cco.clear(), !0
  }
  ...
  RoleChange(e, t) {
    this.dco.delete(e), this.UpdateRoleInfo(t), this.UpdateMainRoleMap(t.Q6n), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleSystemDeleteRole, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleSystemChangeRole, t.Q6n)
  }
  UpdateRoleInfo(e) {
    let t = this.dco.get(e.Q6n);
    t || (t = new RoleInstance_1.RoleInstance(e.Q6n), this.dco.set(e.Q6n, t)), this.IsMainRole(e.Q6n) && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshMenuSetting, GameSettingsDefine_1.EFunction.GENDERSETTING), t.RefreshRoleInfo(e)
  }
  UpdateMainRoleMap(e) {
  ...
  RoleLevelUp(e, t, r) {
    var o = this.GetRoleInstanceById(e),
      n = o.GetLevelData(),
      i = n.GetLevel();
    o && (n.SetLevel(r), n.SetExp(t)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleInfoUpdate), i < r && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleLevelUp, e, t, r)
  }
  ...
  RoleBreakUp(e, t) {
    ...
    r && r.GetLevelData().SetBreachLevel(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleInfoUpdate), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleBreakUp, e, t)
  }
  RoleSkillLevelUp(e, t) {
    var r = this.GetRoleInstanceById(e);
    r && r.RefreshSkillInfo(t.Z4n, t.e5n), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleSkillLevelUp, e, t)
  }
  RoleNameUpdate(e, t) {
    e = this.GetRoleInstanceById(e);
    e && (e.SetRoleName(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RoleRefreshName))
  }
  ...
  get IsShowSkillResume() {
    return LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.ShowSkillResume) ?? !1
  }
  ...
  GetRoleListWithoutMainRole() {
    ...
    for (const o of e) {
      var r = this.dco.get(o);
      1 !== r.GetRoleConfig().RoleType || this.IsMainRole(o) || t.push(r)
    }
    return t
  }
  GetRoleMap() {
  ...
  rVi(e) {
    e.sort((t, r) => {
      ...
      var e = void 0 !== i[o],
        l = void 0 !== i[n];
      return e != l ? (l ? 1 : 0) - (e ? 1 : 0) : e ? o - n : (l = this.GetRoleDataById(t), e = this.GetRoleDataById(r), this.DefaultSortFunc(l, e))
    })
  }
  GetRoleDataById(e, t = !0) {
    let r = void 0;
    return t ? (e > RoleDefine_1.ROBOT_DATA_MIN_ID ? r = this.GetRoleRobotData(e) : !(r = this.dco.get(e)) && this.IsMainRole(e) && (t = this.GetNewMainRoleId(e), r = this.dco.get(t)), r) : new RoleOnlineInstanceData_1.RoleOnlineInstanceData(e)
  }
  GetNewMainRoleId(e) {
  ...
  GetRoleRobotData(e) {
    ...
    return t || (t = new RoleRobotData_1.RoleRobotData(e), this.Cco.set(e, t)), t
  }
  HasAnyTrialRole() {
  ...
  GetRoleName(e, t = void 0) {
    ...
    return r ? r.GetName(t) : (r = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r.Name))
  }
  Lco(e, t, r) {
    let o = 0;
  ...
  GetRoleBreachState(e) {
    e = this.GetRoleInstanceById(e).GetLevelData(), e = e.GetBreachConfig(e.GetBreachLevel() + 1);
    if (!e) return 3;
    if (!ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(e.ConditionId.toString(), void 0, !0)) return 4;
    for (const t of e.BreachConsume)
      if (t[0] === ItemDefines_1.EItemId.Gold) {
        if (ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerMoney(ItemDefines_1.EItemId.Gold) < t[1]) return 1
      } else if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(t[0]) < t[1]) return 0;
    return 2
  }
  GetBreachItemList() {
    ...
    if (t) {
      var r = new Map;
      let e = void 0;
      for (const o of t) o.Z4n === ItemDefines_1.EItemId.Gold ? e = o.e5n : r.set(o.Z4n, o.e5n);
      return {
        needGold: e,
        costItemList: r
      }
  ...
  GetRoleIdList() {
    var e = Array.from(this.dco.keys()),
      t = (this.rVi(e), []);
    for (const r of e) 1 === this.dco.get(r).GetRoleConfig().RoleType && t.push(r);
    return t
  }
  GetOfficialRoleList() {
    var e = [];
    for (const t of this.dco.values()) 1 !== t.GetRoleConfig().RoleType || t.IsTrialRole() || e.push(t);
    return e
  }
  GetRoleTabList() {
    ...
    for (let e = 0; e < r; e++) {
      var n = t[e];
      ModelManager_1.ModelManager.FunctionModel.IsOpen(n.FunctionId) && o.push(n)
    }
    return o
  }
  GetNormalRoleTabList() {
    return this.GetRoleTabList().filter(e => "RoleAttributeTabView" === e.ChildViewName || "RoleWeaponTabView" === e.ChildViewName || "RolePhantomTabView" === e.ChildViewName || "RoleSkillTabView" === e.ChildViewName || "RoleResonanceTabNewView" === e.ChildViewName || "RoleFavorTabView" === e.ChildViewName)
  }
  GetTrialRoleTabList() {
    return this.GetRoleTabList().filter(e => "RoleAttributeTabView" === e.ChildViewName || "RoleWeaponTabView" === e.ChildViewName || "RolePhantomTabView" === e.ChildViewName || "RoleSkillTabView" === e.ChildViewName || "RoleResonanceTabNewView" === e.ChildViewName)
  }
  GetPreviewRoleTabList() {
    return this.GetRoleTabList().filter(e => "RolePreviewAttributeTabView" === e.ChildViewName || "RoleSkillTabView" === e.ChildViewName || "RoleResonanceTabNewView" === e.ChildViewName)
  }
  ...
  RedDotRoleSystemRoleListCondition(e) {
    ...
    return (t = r ? r.includes(e) : t) ? !!this.RedDotResonanceTabCondition(e) || !!ModelManager_1.ModelManager.VisionRecommendModel.CheckVisionOneKeyEquipRedDot(e) : this.RedDotResonanceTabCondition(e)
  }
  ...
  RedDotResonanceTabCondition(e) {
    ...
    var t = this.GetRoleResonanceGroupIndex(e),
      ...
      e = ResonantChainByGroupId_1.configResonantChainByGroupId.GetConfigList(e);
    if (t < 0 || t >= e.length) return !1;
    for (const r of e[t].ActivateConsume)
      if (ModelManager_1.ModelManager.InventoryModel.GetCommonItemCount(r[0]) < r[1]) return !1;
    return !0
  }
  RedDotCondition() {
  ...
  RedDotRoleSkinCondition() {
    for (const e of this.GetAllRoleList())
      if (ModelManager_1.ModelManager.RoleSkinModel.HasRoleSkinRedDotByRoleId(e.GetDataId())) return !0;
    return !1
  }
  RedDotResonanceTabHoleCondition(e, t) {
    ...
    let r = !0;
    return e.ActivateConsume.forEach((e, t) => {
      ModelManager_1.ModelManager.InventoryModel.GetCommonItemCount(t) < e && (r = !1)
    }), r
  }
  ...
  GetRoleResonanceConfigList(e) {
    e = e.GetDataId(), e = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e).ResonantChainGroupId;
    return ConfigManager_1.ConfigManager.RoleResonanceConfig.GetRoleResonanceList(e)
  }
  get RoleLevelResponseData() {
    return this.Eco || (this.Eco = new RoleLevelResponseData_1.RoleLevelResponseData), this.Eco
  }
  UpdateLevelViewResponseData(e) {
    this.RoleLevelResponseData.UpdateRoleLevelUpViewResponse(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SelectLevelUpItemCount)
  }
  get RoleBreachResponseData() {
    return this.Sco || (this.Sco = new RoleBreachResponseData_1.RoleBreachResponseData), this.Sco
  }
  ...
  get RoleSkillResponseData() {
    return this.yco || (this.yco = new RoleSkillResponseData_1.RoleSkillResponseData), this.yco
  }
  ...
  GetNextRoleSkillViewDataLocal(e, t) {
    var e = this.GetRoleDataById(e).GetSkillData().GetSkillLevel(t),
      r = ConfigManager_1.ConfigManager.RoleSkillConfig.GetSkillConfigById(t).MaxSkillLevel;
    return this.GetRoleSkillEffect(t, e < r ? e + 1 : r)
  }
  GetRoleSkillEffect(e, t) {
    var r = new RoleDefine_1.SkillEffect,
      e = ConfigCommon_1.ConfigCommon.ToList(ConfigManager_1.ConfigManager.RoleSkillConfig.GetAllRoleSkillDescConfigByGroupId(e)),
      o = (e.sort((e, t) => e.Order - t.Order), []);
    for (const i of e) {
      var n = new RoleDefine_1.OneSkillEffect;
      n.Id = i.Id, n.Desc = [];
      for (const a of i.SkillDetailNum) a.ArrayString.length <= 0 || t > a.ArrayString.length || n.Desc.push(a.ArrayString[t - 1]);
      o.push(n)
    }
    return r.Level = t, r.EffectDescList = o, r
  }
  UpdateRoleSkillViewData(e, t, r) {
    this.RoleSkillResponseData.UpdateRoleSkillViewResponse(e, t, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.UpdateRoleSkillView)
  }
  ...
  UpdateRoleFavorCondition(e) {
    for (var [t, r] of e) ModelManager_1.ModelManager.RoleFavorConditionModel.UpdateRoleFavorCondtion(t, r)
  }
  UpdateRoleFavorDataSingle(e) {
    var t, r, o, n, i = e.Q6n,
      i = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(i);
    i && (i = i.GetFavorData()) && (t = e.F6n, r = e.U8n, o = e.KPs, n = e.QPs, e = e.XPs, i.SetFavorLevel(t), i.SetFavorExp(r), i.UpdateRoleFavorData(0, o), i.UpdateRoleFavorData(1, n), i.UpdateRoleFavorData(3, e))
  }
  ...
  UpdateRoleFavorLevelAndExp(e) {
    var t = e.Q6n,
      t = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(t).GetFavorData();
  ...
  UpdateRoleSkinInfo(e, t) {
    ...
    void 0 === r ? Log_1.Log.CheckError() && Log_1.Log.Error("Role", 58, "UpdateRoleSkinInfo 无效roleId", ["roleId", e]) : r.SetRoleSkinId(t)
  }
  GetRoleSystemRoleList() {
    if (!ModelManager_1.ModelManager.DangoAbyssModel.CheckIfInSmallWorldInstance() && !ModelManager_1.ModelManager.GameModeModel.IsMulti) {
      ...
      if (ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance() && 0 < e.length && e.length === o) return e;
      if (0 < e.length) {
  ...
  GetRoleListHighestLevel() {
    ...
    for (var [, r] of this.Cco) ModelManager_1.ModelManager.SceneTeamModel.GetTeamItem(r.GetDataId(), {
      ParamType: 0
  ...
  D9l() {
    for (const e of CommonParamById_1.configCommonParamById.GetIntArrayConfig("LightMainRoleIdList")) this.P9l.add(e)
  }
  GetCurSelectMainRoleId() {
    for (const e of this.Tco().values())
      if (this.dco.get(e)) return e
  }
  ...
  GetRoleLevelUpExp(e, t) {
    e = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e), e = ConfigManager_1.ConfigManager.RoleConfig.GetRoleLevelConsume(e.LevelConsumeId, t);
  ...
  GetRoleSkillTreeNodeLevel(e, t) {
    ...
    return r = r || this.GetRoleDataById(e), this.GetRoleSkillTreeNodeLevelByConfig(r, t)
  }
  ...
  GetSkillAttributeDescriptionByOneSkillEffect(t) {
    ...
    let r = "";
    if (e.Description) r = StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Description), ...t.Desc);
    else {
  ...
  GetResonantItemRoleMap() {
    if (!this.vco) {
      var e;
      this.vco = new Map;
      for (const r of ConfigManager_1.ConfigManager.RoleConfig.GetRoleList()) r.ResonantChainGroupId <= 0 || (e = ConfigManager_1.ConfigManager.RoleResonanceConfig.GetRoleResonanceList(r.ResonantChainGroupId)) && e.forEach(e => {
        for (const t of e.ActivateConsume) {
          let e = this.vco.get(t[0]);
          (e = e || new Array).includes(r.Id) || e.push(r.Id), this.vco.set(t[0], e)
        }
      })
    }
    return this.vco
  ...
  GetResonantItemRoleId(e) {
    return ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(e)?.ShowTypes.includes(30) && (e = this.GetResonantItemRoleMap().get(e)) && 0 < e.length ? e : void 0
  }
  ...
  GetRoleLeftResonantCount(e) {
    ...
    return e ? (e = this.GetRoleResonanceGroupIndex(e) ?? 0, ConfigManager_1.ConfigManager.RoleResonanceConfig.GetResonanceMaxLevel() - e) : 0
  }
  GetRoleLeftResonantCountWithInventoryItem(e) {
    var t, e = this.GetRoleInstanceById(e);
    if (!e) return 0;
    let r = 0;
    for ([t] of e.GetRoleConfig().SpilloverItem) r += ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(t);
  ...
  GetRoleTagByRoleInfo(e) {
    var t;
    return this.ClientCheckRoleIsUpgradeLightMainRole(e.Id) ? (t = CommonParamById_1.configCommonParamById.GetIntArrayConfig("MainRoleReplaceTagList"), Array.from(t)) : e.Tag
  }
  ClientCheckRoleIsUpgradeLightMainRole(e) {
    return !!this.IsLightMainRole(e) && (e = CommonParamById_1.configCommonParamById.GetIntConfig("MainRoleTagReplaceCondition"), ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(e.toString(), void 0, !1))
  }
}
