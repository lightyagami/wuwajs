...
class RoleFavorConfig extends ConfigBase_1.ConfigBase {
  ...
  GetFavorRoleInfoConfig(o) {
    ...
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "角色档案配置表获取配置失败,RoleId = ", ["roleId", o])
  }
  GetFavorGoodsConfig(o) {
    var e = FavorGoodsByRoleId_1.configFavorGoodsByRoleId.GetConfigList(o);
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "好感度物品配置表获取配置失败,RoleId = ", ["roleId", o])
  }
  GetFavorStoryConfig(o) {
    var e = FavorStoryByRoleId_1.configFavorStoryByRoleId.GetConfigList(o);
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "好感度故事配置表获取配置失败,RoleId =  Order By Sort", ["roleId", o])
  }
  GetFavorWordConfig(o, e) {
    var r = FavorWordByRoleIdAndType_1.configFavorWordByRoleIdAndType.GetConfigList(o, e);
    if (r) return r;
    Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, `好感度语音配置表获取配置失败,RoleId = ${o} Type = ` + e)
  }
  GetFavorTabCameraConfig(o) {
    var e = FavorTabCameraById_1.configFavorTabCameraById.GetConfig(o);
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("Role", 43, "好感度切页镜头配置获取失败,Id = ", ["favorTabType", o])
  }
}
