...
class RoleFavorLockComponent extends UiPanelBase_1.UiPanelBase {
  constructor(e, t) {
    super(), this.Sui = void 0, this.huo = [], this.luo = t, e && this.CreateThenShowByActor(e.GetOwner())
  }
  OnRegisterComponent() {
  ...
  cuo() {
    this.Sui = new GenericLayoutNew_1.GenericLayoutNew(this.GetVerticalLayout(0), exports.initLockItem, this.GetItem(5)), this.huo = this.muo(), this.Sui.RebuildLayoutByDataNew(this.huo)
  }
  Ubt() {
    var e = this.duo();
  ...
  uuo() {
    var e = this.GetItem(4),
      t = this.GetItem(3);
    2 === this.luo.FavorTabType && 1 === this.luo.TypeParam ? (e.SetUIActive(!0), t.SetUIActive(!0), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "FavorUnlockNewIdleAction")) : (e.SetUIActive(!1), t.SetUIActive(!1))
  }
  duo() {
    let e = "";
  ...
  Cuo(i, e) {
    var o = [],
      ...
      e = ConfigManager_1.ConfigManager.ConditionConfig.GetConditionGroupConfig(e);
    if (e) {
      var s = e.GroupId,
        n = s.length;
      for (let t = 0; t < n; t++) {
        var l = s[t],
          h = ConfigManager_1.ConfigManager.ConditionConfig.GetConditionConfig(l);
        let e = !1;
        e = 2 === a ? ModelManager_1.ModelManager.MotionModel.IsCondtionFinish(r, i, l) : ModelManager_1.ModelManager.RoleFavorConditionModel.IsCondtionFinish(r, a, i, l);
