...
class RoleFavorClassifyItem extends UiPanelBase_1.UiPanelBase {
  constructor(e, t) {
    super(), this.ContentGenericLayout = void 0, this.u_o = [], this.c_o = () => {
      this.u_o = this.m_o()
    }, this.d_o = e, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    ...
    LguiUtil_1.LguiUtil.SetLocalText(e, this.d_o.TitleTableId), this.c_o(), this.ContentGenericLayout = new GenericLayoutNew_1.GenericLayoutNew(this.GetVerticalLayout(0), exports.initContentItem), this.ContentGenericLayout.RebuildLayoutByDataNew(this.u_o)
  }
  OnBeforeDestroy() {
  ...
  g_o(e) {
    var t = this.d_o.RoleId,
      i = ConfigManager_1.ConfigManager.RoleFavorConfig.GetFavorRoleInfoConfig(t);
