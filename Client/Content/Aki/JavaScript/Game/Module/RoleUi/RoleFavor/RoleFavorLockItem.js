...
class RoleFavorLockItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    var e, s;
    this.huo && (e = this.huo.Desc, s = this.huo.IsLock, this.GetText(3).SetText(e), this.GetText(2).SetText(e), this.GetItem(1).SetUIActive(s), this.GetItem(0).SetUIActive(!s))
  }
  OnBeforeDestroy() {
    this.huo = void 0
  }
