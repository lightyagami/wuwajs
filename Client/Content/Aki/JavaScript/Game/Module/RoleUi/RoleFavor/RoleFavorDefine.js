...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RoleFavorHintData = exports.RoleFavorLockItemData = exports.RoleFavorDescComponentData = exports.ContentItemData = exports.ClassifyItemData = void 0;
class ClassifyItemData {
  constructor(t, s, o, a) {
    this.TitleTableId = t, this.FavorTabType = s, this.RoleId = o, this.TypeParam = a
  }
}
exports.ClassifyItemData = ClassifyItemData;
class ContentItemData {
  constructor(t, s, o, a) {
    this.FavorTabType = t, this.RoleId = s, this.TypeParam = a, this.Config = o
  }
}
