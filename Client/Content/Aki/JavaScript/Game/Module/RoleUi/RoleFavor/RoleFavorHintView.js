...
class RoleFavorHintView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.b_o = [], this.q_o = void 0, this.G_o = 0, this.N_o = e => {
      var t, i = this.O_o(e),
        r = i.length;
      for (let e = 0; e < r; e++) {
        var s = i[e];
      ...
      this.q_o.ClearChildren(), this.q_o.RebuildLayoutByDataNew(this.b_o), this.G_o = this.b_o.length;
      for ([, t] of this.q_o.GetLayoutItemMap()) t.SetSequenceFinishCallBack(this.x_o)
    }, this.x_o = () => {
      this.G_o = this.G_o - 1, 0 === this.G_o && UiManager_1.UiManager.CloseView("RoleFavorHintView")
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.b_o = this.OpenParam, this.b_o = this.O_o(this.b_o), this.q_o = new GenericLayoutNew_1.GenericLayoutNew(this.GetVerticalLayout(1), exports.initFavorExpItem), this.q_o.RebuildLayoutByDataNew(this.b_o), this.G_o = this.b_o.length;
    for (var [, e] of this.q_o.GetLayoutItemMap()) e.SetSequenceFinishCallBack(this.x_o)
  }
  OnAddEventListener() {
        ...
        for (let e = 0; e < _; e++) {
          ...
          for (let e = 0; e < v; e++) {
            ...
            if (u.RoleConfig.Id === h) {
              0 === i ? (i = u.Exp, t = !0, s = u) : t = u.Exp === i, a.add(e);
              break
            }
          }
          t || (r = !1)
  ...
  OnBeforeDestroy() {
    this.b_o = [], this.q_o && (this.q_o.ClearChildren(), this.q_o = void 0), this.G_o = 0
  }
}
