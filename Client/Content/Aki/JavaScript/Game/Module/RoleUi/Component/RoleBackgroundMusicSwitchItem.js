...
class RoleBackgroundMusicSwitchItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    ...
    e.OnPointUpCallBack.Bind(this.fKc);
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnRoleBackgroundMusicEnabledChanged, this.gKc);
  }
  OnBeforeDestroy() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnRoleBackgroundMusicEnabledChanged, this.gKc);
  }
  RefreshByRoleData(e) {
    this.RoleData = e;
    this.Refresh();
