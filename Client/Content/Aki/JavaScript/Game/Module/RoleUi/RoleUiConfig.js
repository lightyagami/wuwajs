...
const CommonParamById_1 = require("../../../Core/Define/ConfigCommon/CommonParamById"),
  ...
  RoleMorphByRoleId_1 = require("../../../Core/Define/ConfigQuery/RoleMorphByRoleId"),
...
class RoleConfig extends ConfigBase_1.ConfigBase {
  ...
  GetRoleConfig(e) {
    if (0 !== e) return e = this.GetBaseRoleId(e), RoleInfoById_1.configRoleInfoById.GetConfig(e)
  }
  GetRoleMorphConfig(e, o, r) {
    e = RoleMorphByRoleId_1.configRoleMorphByRoleId.GetConfigList(e);
    if (e && !(e.length <= 0)) return e.find(e => e.Morph === r && e.SkinId === o)
  }
  GetRoleMorphConfigList(e, o) {
    e = RoleMorphByRoleId_1.configRoleMorphByRoleId.GetConfigList(e);
    if (e && !(e.length <= 0)) return e.filter(e => e.SkinId === o)
  }
  GetAutoRoleConfig(e) {
  ...
  GetRoleTrialGroupId(r) {
    ...
    if (r && !(r.length <= 0)) {
      var n, l = ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel;
      let e = void 0,
        o = l - r[0].WorldLevel;
      for (const i of r) {
    ...
    if (r && !(r.length <= 0)) {
      ...
      for (const t of r) {
        ...
        if (!(0 <= i && n !== i)) {
          ...
          t.WorldLevel > l || (i = l - t.WorldLevel) <= o && (o = i, e = t)
        }
      }
      return e
    }
  ...
  GetAllRoleTagList() {
    ...
    return e.forEach(e => {
      r.push(e)
    }), r.sort((e, o) => e.SortId - o.SortId), r.forEach(e => {
      o.push(e.Id)
    }), o
  }
  GetAllRoleTagConfig() {
