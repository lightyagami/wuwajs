...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.CostContentItemContext = exports.RoleBreakPreviewContext = exports.RoleBreakPreviewViewModel = void 0;
...
class RoleBreakPreviewViewModel {
  constructor() {
    this.OLn = void 0, this.kLn = void 0, this.FLn = void 0, this.VLn = -1, this.CreateLevelLayoutGrid = () => new RoleBreakPreviewView_1.LevelLayoutGrid(this), this.aPn = t => {
      var e = t.Data;
      ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(e.ItemId), t.MediumItemGrid.SetSelected(!0, !0)
  ...
  set ChosenLevel(t) {
    ...
    let s = t;
    s < 1 ? s = 1 : s > e && (s = e), this.VLn = s, this.OLn.ChosenLevel = s, this.kLn.ChosenLevel = s
  }
  BindView(t) {
  ...
  BuildItemLayoutData(t) {
    var e, s, i = this.CachedRoleInstance.GetLevelData(),
      o = i.GetBreachLevel() >= t,
      h = [];
    for ([e, s] of i.GetBreachConfig(t).BreachConsume) e !== ItemDefines_1.EItemId.Gold && h.push({
      ItemId: e,
      Count: s,
      IncId: 0,
...
class RoleBreakPreviewContext {
  constructor(t, e) {
    this.HLn = void 0, this.jLn = void 0, this.WLn = -1, this.KLn = [], this.QLn = void 0, this.VLn = -1, this.HLn = t, this.jLn = e
  }
  Dispose() {}
  get LevelContent() {
    return this.WLn
  ...
  set ChosenLevel(t) {
    ...
    t <= s ? (this.jLn.RefreshLevelContentItem(!1), this.jLn.RefreshHasBrokenTip(!0)) : (this.jLn.RefreshLevelContentItem(!0), this.jLn.RefreshHasBrokenTip(!1), this.LevelContent = e), this.jLn.RefreshLeftButton(1 !== t), this.jLn.RefreshRightButton(t !== i), this.LevelLayout = this.HLn.BuildLevelLayoutData(t), this.ItemLayout = this.HLn.BuildItemLayoutData(t)
  }
}
exports.RoleBreakPreviewContext = RoleBreakPreviewContext;
class CostContentItemContext {
  constructor(t, e) {
    this.HLn = void 0, this.XLn = void 0, this.$Ln = 0, this.YLn = ItemDefines_1.EItemId.Gold, this.VLn = -1, this.HLn = t, this.XLn = e
  }
  Dispose() {}
  get CostNumber() {
    return this.$Ln
  ...
  set ChosenLevel(t) {
    ...
    t ? (this.CostNumber = t.CostNum, this.MoneyIcon = t.CostType, this.XLn.Show()) : this.XLn.Hide()
  }
}
