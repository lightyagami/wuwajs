...
class RoleLevelUpSuccessEffectView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.Xuo = void 0, this.nqe = () => {
  ...
  OnBeforeCreate() {
    void 0 === this.OpenParam ? Log_1.Log.CheckError() && Log_1.Log.Error("Role", 37, "RoleLevelUpSuccessEffectView 打开失败,未传入界面数据") : (this.Pe = this.OpenParam, this.Dbt())
  }
  OnStart() {
  ...
  Dbt() {
    ...
    e && (e = ConfigManager_1.ConfigManager.AudioConfig.GetAudioPath(e).Path, this.SetAudioEvent(e))
  }
  uuo() {
  ...
  Yuo() {
    var e;
    this.Xuo && (void 0 !== (e = this.Pe.TextList) ? this.Xuo.ReloadData(e) : this.GetLoopScrollViewComponent(0).RootUIComp.SetUIActive(!1))
  }
}
