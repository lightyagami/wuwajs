...
class RoleLevelResponseData {
  ...
  CalculateItemList(e, t) {
    for (const i of this.wuo.O9n)
      if (i.Z4n === e) return this.xuo = e, i.e5n = t ? i.e5n + 1 : i.e5n - 1, !0;
    if (!t) return !1;
    this.xuo = e;
...
class RoleLevelUpViewResponseData {
  constructor() {
    this.F6n = 1, this.jHn = void 0, this.U8n = 0, this.HHn = 0, this.NHn = void 0, this.kHn = void 0, this.VHn = void 0, this.O9n = void 0
  }
}
