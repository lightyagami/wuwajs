...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.CostContentItem = exports.LevelLayoutGrid = exports.RoleBreakPreviewView = void 0;
const UE = require("ue"),
...
class RoleBreakPreviewView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.xLn = void 0, this.wLn = void 0, this.BLn = void 0, this.bLn = void 0, this.qLn = () => {
  ...
  async OnBeforeStartAsync() {
    this.bLn = this.OpenParam, this.BLn = new CostContentItem(this.bLn), await this.BLn.CreateByActorAsync(this.GetItem(5).GetOwner())
  }
  OnStart() {
    this.xLn = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.bLn.CreateLevelLayoutGrid), this.wLn = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(3), this.bLn.CreateItemLayoutGrid), this.bLn.BindView(this), this.bLn.HandleViewOnStart()
  }
  OnBeforeDestroy() {
    this.bLn.Dispose(), this.bLn = void 0, this.xLn = void 0, this.wLn = void 0, this.BLn = void 0
  }
...
class LevelLayoutGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(t) {
    super(), this.bLn = void 0, this.kqe = () => {
  ...
  Refresh(t, e, s) {
    ...
    this.GetItem(0).SetUIActive(!i), this.GetText(1).SetText(i ? "" : h), this.GetItem(2).SetUIActive(i), this.GetText(3).SetText(i ? h : ""), this.GetItem(4).SetUIActive(0 !== s), this.GetExtendToggle(5).SetToggleState(t.IsChosen ? 1 : 0)
  }
  OnBeforeDestroy() {
