...
class RoleLevelUpSuccessController extends UiControllerBase_1.UiControllerBase {
  ...
  static ConvertsAttrListScrollDataToAttributeInfo(e) {
    var r = {},
      a = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.Id);
    return r.Name = a.Name, r.IconPath = a.Icon, r.ShowArrow = !0, r.PreText = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.Id, e.BaseValue, e.IsRatio), r.CurText = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.Id, e.AddValue, e.IsRatio), r
  }
}
