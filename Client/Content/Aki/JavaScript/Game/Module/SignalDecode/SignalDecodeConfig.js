...
class SignalDecodeConfig extends ConfigBase_1.ConfigBase {
  GetGameplayConfig(e) {
    ...
    return i || Log_1.Log.CheckError() && Log_1.Log.Error("GeneralLogicTree", 18, "无法找到捕捉信号的配置", ["id", e]), i
  }
  GetDifficultyConfig(e) {
    var i = CatchSignalDifficultyById_1.configCatchSignalDifficultyById.GetConfig(e);
    return i || Log_1.Log.CheckError() && Log_1.Log.Error("GeneralLogicTree", 18, "无法找到捕捉信号难度的配置", ["id", e]), i
  }
}
