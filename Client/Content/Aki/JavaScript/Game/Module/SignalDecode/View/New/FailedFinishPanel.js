...
exports.FailedFinishPanel = undefined;
const UE = require("ue");
...
class FailedFinishPanel extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[0, this.AMo], [1, this.PMo]];
  }
  OnStart() {
    ...
    if (ModelManager_1.ModelManager.SignalDecodeModel.CurrentGameplayType === 3) {
      LguiUtil_1.LguiUtil.SetLocalText(this.GetText(3), "SignalMusicFailTips2");
      LguiUtil_1.LguiUtil.SetLocalText(this.GetText(4), "SignalMusicFailTips");
    }
  }
  Open() {
