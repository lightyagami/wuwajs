...
class SignalItemBase extends UiComponentsAction_1.UiComponentsAction {
  constructor(t, s, i, e) {
    super(), this.Type = 0, this.GameplayType = 2, this.Width = 0, this.DecisionShowSize = 36, this.CurrentRelativeX = 0, this.StartDecisionSize = 0, this.EndDecisionSize = 0, this.IsCatchBtnDown = !1, this.RelativeXWhenCatchDown = 0, this.RelativeXWhenCatchUp = 0, this.RootHalfWidth = 0, this.Type = t, this.RootHalfWidth = s, this.StartDecisionSize = i, this.EndDecisionSize = e
  }
  Reset() {
  ...
  OnCatchBtnDown() {
    this.IsCatchBtnDown = !0, this.RelativeXWhenCatchDown = this.CurrentRelativeX
  }
  OnCatchBtnUp() {
    this.IsCatchBtnDown = !1, this.RelativeXWhenCatchUp = this.CurrentRelativeX
  }
  OnReset() {}
  OnUpdate() {
    var t;
