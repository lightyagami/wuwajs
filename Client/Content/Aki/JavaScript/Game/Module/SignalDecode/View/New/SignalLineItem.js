...
class SignalLineItem extends SignalItemBase_1.SignalItemBase {
  ...
  Init(t, i) {
    this.SetRootActor(t.GetOwner(), !0), this.Width = this.RootItem.Width, this.RootItem.SetAnchorOffsetX(i)
  }
  OnRegisterComponent() {
  ...
  OnReset() {
    this.DEo.SetUIActive(!0), this.REo.SetFillAmount(0), this.REo.SetUIActive(!0)
  }
  ...
  OnUpdate() {
    var t, i;
    return !!super.OnUpdate() && (i = -this.DecisionShowSize / 2, t = this.REo.GetFillAmount(), this.CurrentRelativeX < i ? 0 !== t && this.REo.SetFillAmount(0) : t !== (i = this.GetProgress()) && this.REo.SetFillAmount(i), !0)
  }
  GetProgress() {
