...
exports.SignalDecodeModel = undefined;
...
class SignalDecodeModel extends ModelBase_1.ModelBase {
  ...
  GameplayStart(e) {
    ...
    if (e && (this.CurrentGameplayType = e.Type, this.CurrentMorseCode = e.MorseCode, this.CurrentDifficulty = e.Difficulty, e = ConfigManager_1.ConfigManager.SignalDecodeConfig.GetDifficultyConfig(e.Difficulty))) {
      this.TargetCompletion = e.TargetCompletion;
      this.Speed = e.SpeedRate * 100;
