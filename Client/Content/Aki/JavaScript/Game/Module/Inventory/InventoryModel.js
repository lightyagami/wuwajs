...
class InventoryModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Hci = 0, this.jci = void 0, this.Wci = 0, this.Kci = void 0, this.Qci = void 0, this.Xci = new Map, this.dWt = new Map, this.$ci = new Map, this.Yci = new Map, this.Jci = new Map, this.Zci = void 0, this.emi = new Set, this.tmi = new Map, this.IsConfirmDestruction = !1
  }
  OnInit() {
  ...
  OnClear() {
    ...
    for (const e of this.tmi.values()) TimerSystem_1.RealTimeTimerSystem.Remove(e);
    return this.tmi.clear(), !0
  }
  RefreshItemRedDotSet() {
    var t = ModelManager_1.ModelManager.NewFlagModel,
      r = t.GetNewFlagSet(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot);
    if (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Inventory", 37, "[InventoryRedDot]当前本地保存的常规道具红点", ["commonItemRedDotSet", r]), r && 0 < r.size) {
      let e = !1;
      for (const o of r) this.GetCommonItemCount(o) <= 0 && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Inventory", 37, "[InventoryRedDot]消除常规道具红点", ["configId", o]), t.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot, o), e = !0);
    ...
    if (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Inventory", 37, "[InventoryRedDot]当前本地保存的属性道具红点", ["attributeItemRedDotSet", r]), r) {
      let e = !1;
      for (const n of r) {
        var a = this.GetAttributeItemData(n);
        a ? a?.GetCount() <= 0 && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Inventory", 37, "[InventoryRedDot]消除属性道具红点", ["uniqueId", n]), t.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryAttributeItemRedDot, n), e = !0) : (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Inventory", 37, "[InventoryRedDot]消除属性道具红点", ["uniqueId", n]), t.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryAttributeItemRedDot, n), e = !0)
      }
  ...
  nmi(e) {
    ...
    r || (r = new ItemMainTypeMapping_1.ItemMainTypeMapping(t), this.Jci.set(t, r)), r.Add(e)
  }
  smi(e) {
    var t = e.GetMainType(),
      t = this.Jci.get(t);
  ...
  NewCommonItemData(e, t, r = 0, a) {
    ...
    (o = o || new Map).get(r) || (o.set(r, t), this.Xci.set(e, o), this.imi(t), this.nmi(t), this.hmi(t))
  }
  RemoveCommonItemData(e, t = 0) {
    var r, a = this.Xci.get(e);
    a && (r = a.get(t)) && (a.delete(t), 0 === a.size && this.Xci.delete(e), this.omi(r), this.smi(r))
  }
  RemoveCommonItemDataAndSaveNewList(e) {
    for (const t of e) this.RemoveCommonItemData(t.ItemId, t.IncId), this.RemoveNewCommonItem(t.ItemId, t.IncId), this.RemoveRedDotCommonItem(t.ItemId, t.IncId);
    this.SaveNewCommonItemConfigIdList(), this.SaveNewAttributeItemUniqueIdList(), this.SaveRedDotCommonItemConfigIdList(), this.SaveRedDotAttributeItemUniqueIdList()
  }
  hmi(e) {
    if (0 < e.GetEndTime())
      if (e.IsOverTime()) ControllerHolder_1.ControllerHolder.InventoryController.InvalidItemRemoveRequest();
      else {
        const t = e.GetEndTime() + TimerSystem_1.MIN_TIME;
        this.emi.has(t) || (e = StringUtils_1.StringUtils.Format(CD_TIME_REASON, e.GetConfigId().toString(), e.GetUniqueId().toString()), (e = TimerSystem_1.RealTimeTimerSystem.EmitOnTime(() => {
          this.lmi(t)
        }, t, void 0, e)) && (this.emi.add(t), this.tmi.set(t, e)))
      }
  }
  lmi(e) {
    ControllerHolder_1.ControllerHolder.InventoryController.InvalidItemRemoveRequest();
    var t = this.tmi.get(e);
    t && (TimerSystem_1.RealTimeTimerSystem.Remove(t), this.tmi.delete(e)), this.emi.delete(e)
  }
  ...
  GetAllCommonItemDataByConfigId(e) {
    var t = [],
      e = this.Xci.get(e);
    if (e)
      for (const r of Array.from(e.values())) r.IsValid() && t.push(r);
    return t
  }
  ...
  GetAllPhantomItemDataByConfigId(e) {
    var t = [];
    for (const r of this.GetAllPhantomItemDataIterator()) r.GetConfigId() === e && t.push(r);
    return t
  }
  GetAllWeaponItemDataByConfigId(e) {
    var t = [];
    for (const r of this.GetWeaponItemDataList()) r.GetConfigId() === e && t.push(r);
    return t
  }
  GetAllWeaponItemDataByQualityAndType(e, t) {
    var r = [];
    for (const a of this.GetWeaponItemDataList()) 0 !== e && a.GetQuality() !== e || 0 !== t && a.GetConfig().WeaponType !== t || r.push(a);
    return r
  }
  ...
  NewWeaponItemData(e, t, r) {
    this.dWt.get(t) || (e = new WeaponItemData_1.WeaponItemData(e, t, r, 2), this.dWt.set(t, e), this.imi(e), this.nmi(e))
  }
  ...
  RemoveWeaponItemDataAndSaveNewList(e) {
    for (const t of e) this.RemoveWeaponItemData(t), this.RemoveNewAttributeItem(t), this.RemoveRedDotAttributeItem(t);
    this.SaveNewAttributeItemUniqueIdList(), this.SaveRedDotAttributeItemUniqueIdList()
  }
  GetWeaponItemData(e) {
    return this.dWt.get(e)
  }
  NewPhantomItemData(e, t, r) {
    this.$ci.get(t) || (e = new PhantomItemData_1.PhantomItemData(e, t, r, 3), this.$ci.set(t, e), this.imi(e), this.nmi(e))
  }
  ...
  RemovePhantomItemDataAndSaveNewList(e) {
    for (const t of e) this.RemovePhantomItemData(t), this.RemoveNewAttributeItem(t), this.RemoveRedDotAttributeItem(t);
    this.SaveNewAttributeItemUniqueIdList(), this.SaveRedDotAttributeItemUniqueIdList()
  }
  ...
  ClearAllItemData() {
    this.ClearCommonItemData(), this.ClearWeaponItemData(), this.ClearPhantomItemData(), this.Yci.clear(), this.Jci.clear()
  }
  ...
  GetWeaponItemDataList() {
    var e = [];
    for (const t of this._mi()) ModelManager_1.ModelManager.WeaponModel.IsWeaponUsedByUncommonRole(t.GetUniqueId()) || e.push(t);
    return e
  }
  ...
  GetUnEquipPhantomItemDataList() {
    ...
    const t = [];
    return e.forEach(e => {
      ControllerHolder_1.ControllerHolder.PhantomBattleController.CheckIsEquip(e.GetUniqueId()) || t.push(e)
    }), t
  }
  ...
  GetCommonItemByShowType(e) {
    var t = [];
    for (const r of this.Xci.values())
      for (const a of r.values()) a.GetShowTypeList().includes(e) && a.IsValid() && t.push(a);
    return t
  }
  GetWeaponItemByItemType(e) {
    var t = [];
    for (const r of this.GetWeaponItemDataList()) r.GetType() === e && t.push(r);
    return t
  }
  ...
  GetItemDataBase(e) {
    var t = e.IncId;
    return 0 < t ? [this.GetAttributeItemData(t)] : this.GetItemDataBaseByConfigId(e.ItemId)
  }
  ...
  GetItemDataBaseByMainType(e) {
    var t = new Set,
      e = this.Jci.get(e);
    if (e)
      for (const r of e.GetSet()) r.IsValid() && t.add(r);
    return t
  }
  GetInventoryItemGridCountByMainType(e) {
    var t;
    let r = 0;
    for (const a of this.GetItemDataBaseByMainType(e)) 0 !== a.GetType() && (a instanceof CommonItemData_1.CommonItemData ? (t = a.GetMaxStackCount()) <= 0 || (r += Math.ceil(a.GetCount() / t)) : r += 1);
    return r
  }
  GetItemDataBaseByItemType(e) {
    var t = new Set,
      e = this.Yci.get(e);
    if (e)
      for (const r of e) r.IsValid() && t.add(r);
    return t
  }
  _mi() {
  ...
  GetItemCountByConfigId(e, t = 0) {
    if (e in ItemDefines_1.EItemId) return ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerMoney(e);
    switch (ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(e)) {
      case 2:
        return this.umi(e);
      case 3:
  ...
  cmi(e) {
    let t = 0;
    for (const r of this.GetAllPhantomItemDataIterator()) r.GetConfigId() === e && t++;
    return t
  }
  Cr_(e) {
  ...
  RemoveNewCommonItem(e, t = 0) {
    return 0 !== t ? this.RemoveNewAttributeItem(t) : ModelManager_1.ModelManager.NewFlagModel.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItem, e)
  }
  ...
  IsNewCommonItem(e, t = 0) {
    return 0 !== t ? this.IsNewAttributeItem(t) : ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItem, e)
  }
  ...
  TryAddRedDotCommonItem(e, t = 0) {
    var r;
    return !ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot, e) && !!(r = this.GetCommonItemData(e, t)) && 0 !== r.GetRedDotDisableRule() && (0 !== t ? ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryAttributeItemRedDot, t) : ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot, e), !0)
  }
  ...
  HasRedDot() {
    var e = ModelManager_1.ModelManager.NewFlagModel,
      t = e.GetNewFlagSet(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot);
    let r = 0,
      a = (t && (r = t.size), 0);
  ...
  IsCommonItemHasRedDot(e, t = 0) {
    return 0 !== t ? this.IsAttributeItemHasRedDot(t) : ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot, e)
  }
  ...
  RemoveRedDotCommonItem(e, t = 0) {
    return 0 !== t ? this.RemoveRedDotAttributeItem(t) : !!ModelManager_1.ModelManager.NewFlagModel.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryCommonItemRedDot, e) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRemoveItemRedDot), !0)
  }
  RemoveRedDotAttributeItem(e) {
    return !!ModelManager_1.ModelManager.NewFlagModel.RemoveNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.InventoryAttributeItemRedDot, e) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRemoveItemRedDot), !0)
  }
  ...
  CheckIsCoinEnough(e, t) {
    for (const r of t)
      if (r.ItemId === e) return ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(e) >= r.Count;
    return !0
  }
}
