...
class InventoryGiftController extends UiControllerBase_1.UiControllerBase {
  static SendItemGiftUseRequest(t, e, r) {
    ...
    var r = ModelManager_1.ModelManager.InventoryModel.GetCommonItemData(t),
      i = r.GetConfig();
    i.Parameters.get(ItemDefines_1.EItemFunctionType.ManualOpenGift) || i.Parameters.get(ItemDefines_1.EItemFunctionType.AutoOpenGift);
    const a = r.GetCount() - e;
    Net_1.Net.Call(24997, n, e => {
      var r;
      e && (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs ? ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 23280) : (UiManager_1.UiManager.IsViewShow("InventoryGiftView") && UiManager_1.UiManager.CloseView("InventoryGiftView"), (e = ModelManager_1.ModelManager.InventoryModel.GetAcquireData()) && (r = [{
        ItemId: t,
        IncId: 0
      }, a], e.SetRemainItemCount(a), e.SetMaxAmount(a), e.SetItemData([r]), this.ShowAcquireView(e))))
    })
  }
  static SendGiftPackPreviewRequest(o, _, l) {
    var e = new Protocol_1.Aki.Protocol.bg_;
    e.Igl = _.Id, Net_1.Net.Call(22749, e, e => {
      if (e) {
        var r, t, n = [];
  ...
  static ShowAcquireView(e) {
    ModelManager_1.ModelManager.InventoryModel.SetAcquireData(e), UiManager_1.UiManager.IsViewShow("AcquireView") ? EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshAcquireView, e) : UiManager_1.UiManager.OpenView("AcquireView", e)
  }
  static ShowRewardViewWithCountAndId(e, r) {
    ...
    n.push([{
      IncId: 0,
      ItemId: e
    }, r]), t.SetItemData(n), InventoryGiftController.ShowAcquireView(t)
  }
  static ShowRewardViewWithList(e) {
    var r = new AcquireData_1.AcquireData;
    r.SetAcquireViewType(1), r.SetItemData(e), InventoryGiftController.ShowAcquireView(r)
  }
  static CloseAcquireView() {
    UiManager_1.UiManager.IsViewShow("AcquireView") && UiManager_1.UiManager.CloseView("AcquireView")
  }
  ...
  var e = r.s5n,
    e = ConfigManager_1.ConfigManager.GiftPackageConfig.GetGiftPackageConfig(e);
  if (1 !== e.ShowType && 0 === e.ShowType) {
    ...
    e.SetAcquireViewType(1), e.SetItemData(n), InventoryGiftController.ShowAcquireView(e)
  }
};
