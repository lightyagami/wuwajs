...
class ItemUseLogic {
  static Imi(e, r = 1, o = 0) {
    ...
    if (!n) return !1;
    if (n.GetConfigId > RoleDefine_1.ROBOT_DATA_MIN_ID) ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("NoneRole");
    else {
      ...
      Math.ceil(n.GetCurrentValue(CharacterAttributeTypes_1.EAttributeId.l5n)) <= t ? (n = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("HpFull"), ScrollingTipsController_1.ScrollingTipsController.ShowTipsByText(n)) : BuffItemControl_1.BuffItemControl.RequestUseBuffItem(e, r, o)
    }
    return !0
  }
}
exports.ItemUseLogic = ItemUseLogic, (_a = ItemUseLogic).TryUseParameterItem = (e, r = 1) => {
  var o = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(e);
  return !!o && (0 === o.Parameters.size ? (Log_1.Log.CheckError() && Log_1.Log.Error("Inventory", 37, "使用道具失败,使用参数为空", ["ItemId", e]), !1) : (ControllerHolder_1.ControllerHolder.InventoryController.RequestItemUse(e, r), !0))
  ...
  if (ConfigManager_1.ConfigManager.BuffItemConfig.IsBuffItem(e)) {
    if (ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()) {
      ...
      if (t && 0 === t.CanUseItem) return ScrollingTipsController_1.ScrollingTipsController.ShowTipsByText(MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Dungeon_BanItem")), !0
    }
    return 0 < ModelManager_1.ModelManager.BuffItemModel.GetBuffItemRemainCdTime(e) ? (ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("UseBuffCdText"), !0) : ConfigManager_1.ConfigManager.BuffItemConfig.IsTeamBuffItem(e) ? (BuffItemControl_1.BuffItemControl.RequestUseBuffItem(e, 1, -1), !0) : (BuffItemControl_1.BuffItemControl.InitializeAllUseBuffItemRoleFromPlayerFormationInstance(e), ModelManager_1.ModelManager.BuffItemModel.GetAllUseBuffItemRole().size <= 0 ? (ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("NoneRole"), !0) : o ? _a.Imi(e, r, n) : (UiManager_1.UiManager.OpenView("UseBuffItemView", e), !0))
  }
  return !1
}, ItemUseLogic.TryUsePowerItem = (e, r = 1) => 10800 === e && (PowerController_1.PowerController.TryExchangePowerItem(e, r), !0), ItemUseLogic.TryUseMonthCardItem = (e, r = 0) => {
  var o, n, t = ConfigManager_1.ConfigManager.ItemConfig.GetConfig(e);
  ...
  let t = n.Parameters.get(ItemDefines_1.EItemFunctionType.ManualOpenGift),
    i = !1;
  t || (t = n.Parameters.get(ItemDefines_1.EItemFunctionType.AutoOpenGift), i = !0);
  ...
  if (!i)
    if (a.Type === GiftType_1.GiftType.Fixed || a.Type === GiftType_1.GiftType.Random || a.Type === GiftType_1.GiftType.RandomPhantom || a.Type === GiftType_1.GiftType.CaptureMonster) {
      ...
      if (f.push(o), 1 < l) {
        ...
        g.SetAcquireViewType(0), g.SetAmount(1), g.SetMaxAmount(l), g.SetRemainItemCount(l), g.SetItemData(f), g.SetNameText(_), g.SetRightButtonFunction(() => {
          ItemUseLogic.Tmi(e, g.GetAmount())
        }), InventoryGiftController_1.InventoryGiftController.ShowAcquireView(g)
      } else InventoryGiftController_1.InventoryGiftController.SendItemGiftUseRequest(e, 1, void 0)
    } else InventoryGiftController_1.InventoryGiftController.SendGiftPackPreviewRequest(e, a, void 0);
  return !0
}, ItemUseLogic.TryUseGiftItemWithSelectedItem = (e, r, o = 0) => {
  var n = ModelManager_1.ModelManager.InventoryModel.GetCommonItemData(e);
  return !!n && 11 === n.GetType() && !!(n = ConfigManager_1.ConfigManager.ItemConfig.GetConfig(e).Parameters.get(ItemDefines_1.EItemFunctionType.ManualOpenGift)) && (n = ConfigManager_1.ConfigManager.GiftPackageConfig.GetGiftPackageConfig(n)).Type === GiftType_1.GiftType.Optional && (InventoryGiftController_1.InventoryGiftController.SendGiftPackPreviewRequest(e, n, r), !0)
}, ItemUseLogic.TryUseShipTowerItem = e => {
  e = ModelManager_1.ModelManager.InventoryModel.GetCommonItemData(e);
  return !!e && 60005 === e.GetType() && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OpenActivityViewShipTower), !0)
}, ItemUseLogic.TryUsePayShopCouponItem = e => {
  var e = ModelManager_1.ModelManager.InventoryModel.GetCommonItemData(e);
  return !!e && 60008 === e.GetType() && ((e = new PayShopViewData_1.PayShopViewData).PayShopId = 6, ControllerHolder_1.ControllerHolder.PayShopController.OpenPayShopView(e), !0)
}, ItemUseLogic.Tmi = (e, r) => {
  0 < r ? InventoryGiftController_1.InventoryGiftController.SendItemGiftUseRequest(e, r, void 0) : ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("NotEnoughItem")
}, ItemUseLogic.TryUseBirthdayItem = e => {
  var r = ModelManager_1.ModelManager.InventoryModel.GetCommonItemData(e);
  return !!r && 60007 === r.GetType() && (BirthdayController_1.BirthdayController.UseBirthdayItem(e), !0)
};
