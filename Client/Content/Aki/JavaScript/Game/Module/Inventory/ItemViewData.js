...
class ItemViewData {
  ...
  RemoveNewItem() {
    var e = ModelManager_1.ModelManager.InventoryModel,
      ...
      r = this.GetConfigId(),
      i = this.GetUniqueId();
    0 === t ? e.RemoveNewCommonItem(r, i) : e.RemoveNewAttributeItem(i), this.Dmi(!1)
  }
  RemoveRedDotItem() {
    var e = ModelManager_1.ModelManager.InventoryModel,
      t = this.GetItemDataType(),
      r = this.GetConfigId(),
      i = this.GetUniqueId();
    0 === t ? e.RemoveRedDotCommonItem(r, i) : e.RemoveRedDotAttributeItem(i), this.SetHasRedDot(!1)
  }
  IsBuffItem() {
  ...
  GetAttributeLevel() {
    var e, t = this.GetItemDataType(),
      r = this.GetUniqueId();
    return 3 === t ? (e = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(r)) ? e.GetPhantomLevel() : 0 : 2 === t ? ModelManager_1.ModelManager.WeaponModel.GetWeaponLevelById(r) : 0
  }
    ...
    switch (this.GetItemDataType()) {
      ...
      case 2:
        var e = this.GetItemDataBase(),
          t = e.GetUniqueId(),
          t = t ? ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(t) : void 0,
          r = e.GetIsLock(),
          i = !!t && 0 !== t.GetRoleId(),
        ...
        return e && !r && !i && !t;
      case 3:
        e = this.GetItemDataBase(), r = e.GetUniqueId(), i = e.GetIsLock(), t = ControllerHolder_1.ControllerHolder.PhantomBattleController.GetEquipRole(r), r = !!t && 0 !== t;
