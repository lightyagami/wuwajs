...
class ItemView extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(), this.rdi = void 0, this.SPe = void 0, this.ndi = void 0, this.sui = e => {
  ...
  RefreshItemViewByItemData(e) {
    var e = (this.rdi = e).GetItemViewInfo(),
      ...
      s = e.IsNewItem,
      e = e.ItemDataType;
    switch (this.OCi(), this.kCi(t), this.FCi(i), this.SetIsNewItem(s), this.RefreshCdTimeDisplay(), e) {
      case 0:
        var r = this.rdi.GetCount();
        this.VCi(r);
        break;
      case 2:
        r = this.rdi.GetItemDataBase().GetUniqueId(), r = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(r).GetLevel();
        this.HCi(r);
        break;
      case 3:
        r = this.rdi.GetItemDataBase().GetUniqueId(), r = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(r).GetPhantomLevel();
        this.HCi(r);
        break;
      default:
        r = this.rdi.GetCount();
  ...
  VCi(e) {
    ...
    t && (t.SetText(e.toString()), t.SetUIActive(!0), e = this.GetText(3)) && e.SetUIActive(!1)
  }
  HCi(e) {
    var t = this.GetText(3);
    t && (LguiUtil_1.LguiUtil.SetLocalText(t, "LevelShow", e), t.SetUIActive(!0), e = this.GetText(4)) && e.SetUIActive(!1)
  }
  ...
  jCi(e) {
    ...
    t.bIsUIActive !== e && (t.SetUIActive(e), e) && this.SPe.PlayLevelSequenceByName("EnterCd")
  }
  RefreshCdTimeDisplay() {
    var e = this.rdi.GetConfigId(),
      t = ModelManager_1.ModelManager.BuffItemModel,
      i = t.GetBuffItemRemainCdTime(e);
    i <= 0 ? this.jCi(!1) : (t = t.GetBuffItemTotalCdTime(e), this.WCi(i, t), this.jCi(!0))
  }
  WCi(e, t) {
    var e = Math.ceil(e),
      i = this.GetSprite(17),
