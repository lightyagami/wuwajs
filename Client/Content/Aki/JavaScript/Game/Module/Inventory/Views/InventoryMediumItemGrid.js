  ...
  OnRefresh(e, t, i) {
    ...
    switch (o) {
      case 0:
        ...
        r.SelectOnNum ? (d = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("Text_ItemRecycleChosen_text"), d = StringUtils_1.StringUtils.Format(d, r.SelectOnNum.toString(), e.GetCount().toString()), a.BottomText = d) : a.BottomText = e.GetCount().toString(), a.IsTimeFlagVisible = n.IsLimitTimeItem(), a.BuffIconType = n.GetConfig().ItemBuffType, a.IsOmitBottomText = !1;
        break;
      case 2:
        var d = this.rdi.GetItemDataBase().GetUniqueId(),
          n = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(d);
        a.BottomTextId = "Text_LevelShow_Text", a.BottomTextParameter = [n.GetLevel()], a.Level = n.GetResonanceLevel(), a.RoleHeadInfo = {
          RoleConfigId: n.GetRoleId()
        };
        break;
      case 3:
        var _, d = this.rdi.GetItemDataBase().GetUniqueId(),
          n = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(d),
          h = n.GetCurrentSlotData();
        if (a.Level = n.GetCost(), a.IsLevelTextUseChangeColor = !0, a.BottomText = "+" + n.GetPhantomLevel().toString(), a.IsOmitBottomText = !0, 0 < h.length) {
        ...
        ControllerHolder_1.ControllerHolder.PhantomBattleController.CheckIsEquip(d) && (h = n.GetUniqueId(), d = ControllerHolder_1.ControllerHolder.PhantomBattleController.GetEquipRole(h), _ = ModelManager_1.ModelManager.PhantomBattleModel.CheckPhantomIsMain(h), a.VisionRoleHeadInfo = {
          RoleConfigId: d,
          VisionUniqueId: h
        }, a.IsMainVisionVisible = _), a.VisionFetterGroupId = n.GetFetterGroupId();
        break;
      default:
        a.BottomText = e.GetCount().toString()
    }
    this.Apply(a), this.SetCheckTickPerformance(r.IsSelectOn, RED_TICK_HEX, RED_TICK_ALPHA, TICK_COLOR_HEX), this.SetSelected(t)
  }
  OnSelected(e) {
    this.SetSelected(!0)
  }
