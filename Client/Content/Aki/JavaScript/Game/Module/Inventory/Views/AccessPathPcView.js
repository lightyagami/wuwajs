...
class AccessPathPcView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.xmi = [], this.wmi = () => {}, this.Bmi = () => {
  ...
  Gmi(t) {
    var e = this.GetSprite(3),
      ...
      v = this.GetSprite(17),
      M = this.GetItem(18);
    e.SetUIActive(t), s.SetUIActive(!t), i.SetUIActive(t), r.SetUIActive(!t), h.SetUIActive(t), a.SetUIActive(!t), o.SetUIActive(t), c.SetUIActive(!t), n.SetUIActive(t), U.SetUIActive(!t), E.SetUIActive(t), u.SetUIActive(!t), _.SetUIActive(t), P.SetUIActive(!t), v.SetUIActive(t), M.SetUIActive(!t)
  }
}
