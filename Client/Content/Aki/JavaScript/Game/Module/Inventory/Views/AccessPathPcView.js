...
exports.AccessPathPcView = undefined;
const UE = require("ue");
...
class AccessPathPcView extends UiViewBase_1.UiViewBase {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[1, this.wmi], [2, this.Bmi]];
  }
  OnStart() {
    this.bmi();
    this.qmi();
  ...
  RemoveEvents() {}
  qmi() {
    var t = ModelManager_1.ModelManager.InventoryModel.GetSelectedItemData().GetItemDataBase().GetItemAccess();
  ...
  Gmi(t) {
    ...
    var h = this.GetSprite(7);
    var a = this.GetItem(8);
    var o = this.GetSprite(9);
    var c = this.GetItem(10);
    var n = this.GetSprite(11);
    var U = this.GetItem(12);
    var E = this.GetSprite(13);
    var u = this.GetItem(14);
    var _ = this.GetSprite(15);
    var P = this.GetItem(16);
    var v = this.GetSprite(17);
    var M = this.GetItem(18);
    e.SetUIActive(t);
    s.SetUIActive(!t);
    i.SetUIActive(t);
    r.SetUIActive(!t);
