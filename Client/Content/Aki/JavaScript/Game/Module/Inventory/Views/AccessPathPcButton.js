...
class AccessPathPcButton extends UiPanelBase_1.UiPanelBase {
  constructor(e, t) {
    super(), this.Pmi = t, this.CreateThenShowByResourceIdAsync("UiItem_PcAccessPathButton_Prefab", e, !1)
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    var e, t = ConfigManager_1.ConfigManager.InventoryConfig.GetAccessPathConfig(this.Pmi);
