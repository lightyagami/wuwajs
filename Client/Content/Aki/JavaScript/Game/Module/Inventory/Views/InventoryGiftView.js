...
class InventoryGiftView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.vVt = void 0, this.x5e = [], this.zmi = [], this.Zmi = void 0, this.edi = void 0, this.ZAt = void 0, this.tdi = void 0, this.ts = void 0, this.HGe = void 0, this.WGe = void 0, this.ClickClose = () => {
      ...
      return i.Initialize(), i.SetOnToggleStateChangeFunction(this.OnToggleStateChangeFunction), i.SetOnReduceFunction(this.OnReduceFunction), i.SetIsSelectOn(this.OnIsSelectOnFunction), i
    }, this.idi = i => {
      return this.x5e[i]
    }, this.OnToggleStateChangeFunction = (i, t, e, s) => {
      var r = this.Zmi.GiftPackage.AvailableNum;
      if (e) {
        if (this.zmi.length === r) return i.SetToggleState(0, !1), void t.RootUIComp.SetUIActive(!1);
        this.zmi.push(s)
      } else {
      ...
      i = this.zmi.indexOf(i); - 1 !== i && (this.zmi.splice(i, 1), this.RefreshSelectCountInfo())
    }, this.OnIsSelectOnFunction = i => this.zmi.includes(i), this.RefreshSelectCountInfo = () => {
      var i = this.Zmi.GiftPackage.AvailableNum,
        t = this.zmi.length,
        t = (LguiUtil_1.LguiUtil.SetLocalText(this.ts, "SelectRewardFromPool", i, t, i), t === i);
      this.odi(t)
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.Zmi = this.OpenParam, this.x5e = this.Zmi.ItemList, this.vVt = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(3), this.GetItem(4).GetOwner(), this.sGe), this.vVt.ReloadProxyData(this.idi, this.x5e.length, !1), this.ZAt = this.GetButton(1), this.tdi = this.GetButton(2), this.edi = this.ZAt.GetOwner().GetComponentByClass(UE.UIInteractionGroup.StaticClass()), this.ts = this.GetText(5), this.HGe = this.GetText(0);
    var i = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfigData(this.Zmi.ConfigId),
      i = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.HGe, i.Name), this.WGe = new NumberSelectComponent_1.NumberSelectComponent(this.GetItem(7)), {
    ...
    if (this.WGe.Init(i), this.Zmi.InitializedSelectedId)
      for (let i = 0; i < this.x5e.length; i++) {
        ...
        if (t.ItemId === this.Zmi.InitializedSelectedId) {
          this.zmi.push(t), this.vVt.ScrollToGridIndex(i, !1), this.vVt.SelectGridProxy(i, !0);
          break
        }
      }
    this.RefreshSelectCountInfo()
  ...
  OnAfterShow() {
    var i, t;
    this.Zmi ? (i = this.Zmi.GiftPackage.AvailableNum, t = this.zmi.length, this.odi(t === i)) : this.odi(!1)
  }
  OnAfterHide() {
    UiBlurLogic_1.UiBlurLogic.ResumeTopUiRenderAfterBlur()
  }
  OnBeforeDestroy() {
    this.vVt = void 0, this.x5e = [], this.zmi = [], this.Zmi = void 0, this.edi = void 0, this.ZAt = void 0, this.tdi = void 0, this.ts = void 0, this.HGe = void 0, this.WGe?.Destroy(), this.WGe = void 0
  }
  odi(i) {
