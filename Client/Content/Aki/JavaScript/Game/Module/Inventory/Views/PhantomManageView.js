...
class PhantomManageView extends UiViewBase_1.UiViewBase {
  ...
  OnBeforeShow() {
    this.Urd = this.OpenParam ?? 0;
    var t = this.Urd > 0 ? ModelManager_1.ModelManager.InventoryModel.GetPhantomItemData(this.Urd) : undefined;
    this.r_u = t ? this.Urd : 0;
