...
class MingSuModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.wbi = new Map, this.Bbi = void 0, this.bbi = 0, this.UpgradeFlow = void 0, this.CurrentPreviewLevel = 0, this.qAr = 0, this.CurrentInteractCreatureDataLongId = void 0, this.qbi = 0
  }
  OnInit() {
  ...
  DoUpdateDragonPoolInfoMap(e) {
    this.RefreshDragonPoolActiveStatus(e.k7n, e.WSs), this.RefreshDragonPoolLevel(e.k7n, e.F6n), this.RefreshDragonPoolHadCoreCount(e.k7n, e.KSs)
  }
  InitMingSuMap() {
    ...
    if (e)
      for (const t of e) {
        var r = this.SQa(t.Id);
        this.wbi.set(t.Id, r)
      } else Log_1.Log.CheckDebug() && Log_1.Log.Debug("MingSuTi", 58, "龙池配置读取失败", ["dragonPoolConfigList", e])
  }
  SQa(e) {
  ...
  CheckUp(e) {
    ...
    return 0 !== e && (n = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(n.Name), this.Gbi({
  ...
  Gbi(e) {
    var r = [];
    r.push(e.CoreName, e.UseCoreCount.toString()), this.Bbi = new ConfirmBoxDefine_1.ConfirmBoxDataNew(9), this.Bbi.SetTextArgs(...r)
  }
  GetUpData() {
    return this.Bbi
  }
