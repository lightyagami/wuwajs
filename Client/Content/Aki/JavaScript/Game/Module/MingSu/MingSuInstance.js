...
class MingSuInstance {
  constructor(t) {
    this.DragonPoolId = 0, this.DragonPoolState = 0, this.DragonPoolLevel = 0, this.HadCoreCount = 0, this.DropItemList = void 0, this.DragonPoolConfig = void 0, this.DragonPoolId = t, this.DragonPoolConfig = DragonPoolById_1.configDragonPoolById.GetConfig(this.DragonPoolId), this.DragonPoolState = 0, this.DragonPoolLevel = 0, this.HadCoreCount = 0
  }
