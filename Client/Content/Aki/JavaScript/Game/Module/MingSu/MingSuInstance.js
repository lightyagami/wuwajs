...
exports.MingSuInstance = undefined;
...
class MingSuInstance {
  constructor(t) {
    ...
    this.HadCoreCount = 0;
    this.DropItemList = undefined;
    this.DragonPoolConfig = undefined;
    this.DragonPoolId = t;
    this.DragonPoolConfig = DragonPoolById_1.configDragonPoolById.GetConfig(this.DragonPoolId);
    this.DragonPoolState = 0;
    this.DragonPoolLevel = 0;
    this.HadCoreCount = 0;
  }
