...
class DarkCoastDeliveryLevelData {
  constructor(t, e, s) {
    this.Id = 0, this.Config = void 0, this.THs = 0, this.Goal = 0, this.gQa = !1, this.fQa = !1, this.DKi = !1, this.pQa = !1, this.vQa = void 0, this.Config = t, this.Id = t.Id, this.Goal = e, this.THs = s
  }
  MQa() {
    var t, e;
    this.vQa = [];
    for ([t, e] of ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreview(this.THs)) this.vQa.push([{
      ItemId: t,
      IncId: 0
    }, e])
  }
