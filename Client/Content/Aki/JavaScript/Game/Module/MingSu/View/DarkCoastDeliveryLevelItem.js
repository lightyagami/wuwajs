...
class DarkCoastDeliveryLevelItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.LevelData = void 0, this.UiLevelSequence = void 0, this.yQa = void 0, this.UOt = !0, this.OnClickToggleCallback = () => {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      ...
      [4, this.OnClickToggleCallback]
    ]
  }
  OnBeforeCreateImplement() {
    this.UiLevelSequence = new UiViewSequence_1.UiBehaviorLevelSequence(this), this.AddUiBehavior(this.UiLevelSequence), this.GetExtendToggle(4).CanExecuteChange.Bind(() => 0 === this.GetExtendToggle(4).GetToggleState()), this.GetItem(5).SetUIActive(!1)
  }
  OnStart() {
    this.RefreshUi()
  }
  ...
  RefreshUi() {
    ...
    this.SetTextureShowUntilLoaded(e.Icon, this.GetTexture(0)), this.SetSpriteByPath(e.LevelIcon, this.GetSprite(1), !1), this.SetSpriteByPath(e.LevelSelectIcon, this.GetSprite(2), !1), this.GetItem(3).SetUIActive(3 === i)
  }
  PlaySequence(e) {
  ...
  JumpUnCheckedToCheckedAnim() {
    ...
    void 0 !== i && (i = i.Animation.LevelSequence, e.GetOwner().SequenceJumpToEnd(i))
  }
