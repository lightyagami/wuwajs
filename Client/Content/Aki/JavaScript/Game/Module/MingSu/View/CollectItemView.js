...
exports.CollectItemView = undefined;
const UE = require("ue");
...
class CollectItemView extends CollectItemViewBase_1.CollectItemViewBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIButtonComponent], [2, UE.UISprite], [3, UE.UIText], [4, UE.UIText], [5, UE.UIItem], [6, UE.UIText], [7, UE.UIButtonComponent], [8, UE.UIText], [9, UE.UIItem], [10, UE.UIText], [11, UE.UIButtonComponent], [12, UE.UIButtonComponent]];
  ...
  K0i() {
    ...
    var n = i.GetTargetDragonPoolActiveById(this.PoolConfigId);
    if (this.CurrentShowLevel === s + 1 || this.CurrentShowLevel === s && this.CurrentShowLevel === h) {
      ...
      let t = 0;
      var n = (t = n === 2 ? h : i.GetTargetDragonPoolCoreCountById(this.PoolConfigId)) / h;
      this.GAr.SetFillAmount(n);
      o.SetText(t + "/" + h);
    } else if (this.CurrentShowLevel <= s) {
      this.aPi = 0;
      n = i.GetTargetDragonPoolLevelNeedCoreById(this.PoolConfigId, this.CurrentShowLevel - 1);
      o.SetText(n + "/" + n);
