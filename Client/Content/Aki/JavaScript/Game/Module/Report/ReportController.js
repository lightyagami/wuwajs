...
class ReportController extends UiControllerBase_1.UiControllerBase {
  static ReportPlayerRequest(e, r, o, t = undefined) {
    ...
    l.LHn = r;
    Net_1.Net.Call(28888, Protocol_1.Aki.Protocol.nYn.create(l), this.ReportPlayerResponse);
  }
...
(exports.ReportController = ReportController).ReportPlayerResponse = e => {
  if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
    ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 27504);
  } else {
