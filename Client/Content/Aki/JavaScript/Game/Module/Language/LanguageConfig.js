...
exports.LanguageConfig = undefined;
...
class LanguageConfig extends ConfigBase_1.ConfigBase {
  GetLanguageDefineByLanguageCode(e) {
    return LanguageDefineByLanguageCode_1.configLanguageDefineByLanguageCode.GetConfig(e);
  }
  GetLanguageDefineById(e) {
    return LanguageDefineByLanguageType_1.configLanguageDefineByLanguageType.GetConfig(e);
  }
}
