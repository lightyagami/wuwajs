...
class TowerDefenseModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.fZs = new Map, this.IsUiFlowOpen = !1, this.IsPhantomViewOpened = !1, this.Uka = void 0, this.pZs = [], this.PhantomMessageCache = new ParsedTowerDefenseMsg, this.CurrentSelfPhantomIdInUiTemp = TowerDefenceDefine_1.DEFAULT_ID, this.SelfReviveTargetTimestampForUi = void 0, this.PhantomOwnerDataList = [], this.RoleCfgId2PhantomIdMapCache = new Map, this.DelayedEndNotify = void 0, this.TimerCacheInBattle = new Map, this.RankData = new TowerDefenseRankGlobalData_1.TowerDefenseRankGlobalData, this.vZs = (e, t) => e.Id - t.Id, this.Vil = (e, t) => e.RewardState === t.RewardState ? e.Id - t.Id : 1 === e.RewardState ? -1 : 1 === t.RewardState ? 1 : 0 === e.RewardState ? -1 : 0 === t.RewardState ? 1 : 0
  }
  get IsEnterInActivityClicked() {
    if (void 0 === this.Uka) {
      ...
      void 0 === e && (LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerDefenseEntered, !1), e = !1), this.Uka = e
    }
    return this.Uka
  }
  set IsEnterInActivityClicked(e) {
    this.Uka !== e && (this.Uka = e, LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerDefenseEntered, e))
  }
  ...
  OnInit() {
    return this.ICa(), this.ResetCurrentPhantomIdInUiTempToFirstAvailable(), this.ResetPhantomOwnerDataList(), !0
  }
  OnLeaveLevel() {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("TowerDefense", 64, "标记真正的离开场景时机，用于还原数据"), this.PhantomMessageCache.OwnPhantomInBattleDataCache.clear(), !0
  }
  ICa() {
    for (const n of TowerDefencePhantomAll_1.configTowerDefencePhantomAll.GetConfigList()) {
      var e = [],
        t = TowerDefencePhantomLevelByGroupId_1.configTowerDefencePhantomLevelByGroupId.GetConfigList(n.SkillGroup);
      if (void 0 !== t) {
        for (const o of t) {
          var r = {
            Name: o.Title,
  ...
  GetCurrentPhantomIdInBattle() {
    ...
    return r ? (r.PhantomId <= 0 && Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "塔防战斗中获取声骸ID失败：未赋值声骸", ["PlayerID", t], ["RoleCfgID", e], ["Owner Data", r]), r.PhantomId) : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "塔防战斗中获取声骸ID失败：未获取OwnerData", ["PlayerID", t], ["RoleCfgID", e], ["Owner Data", r]), TowerDefenceDefine_1.DEFAULT_ID)
  }
  SZs(e) {
    var t = this.fZs.get(e);
    return t ? t.SkillDataList : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "未能获得塔防声骸技能配置", ["TowerDefensePhantomId", e]), [])
  }
  ...
  GetCurrentPhantomExpPairInBattle() {
    ...
    if (t) {
      ...
      if (!n) return Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "战斗中声骸ID，协议与配置不匹配，以协议ID找不到配置数据", ["协议声骸ID", t.s5n]), r;
      var o = t.F6n;
      let e = 0;
      1 <= o && 1 < n.MaxLevel && (e = (n.MaxLevel === t.F6n ? n.SkillDataList[o - 2] : n.SkillDataList[o - 1]).ExpThreshold ?? 0), r.Exp = n.MaxLevel === t.F6n ? e : t.U8n, r.Threshold = e
    } else {
      o = this.fZs.get(e);
      if (!o) return r;
  ...
  GetOrCreateParsedTowerDefenseMsg() {
    return this.PhantomMessageCache || (this.PhantomMessageCache = new ParsedTowerDefenseMsg), this.PhantomMessageCache
  }
  ...
  GetPreviewRewardCount() {
    let e = 0,
      t = 0;
    for (const r of TowerDefenceRewardAll_1.configTowerDefenceRewardAll.GetConfigList()) r.ActivityId === this.PhantomMessageCache.Id && (2 === this.PhantomMessageCache.GetScoreRewardStateById(r.Id) && e++, t++);
    for (const n of this.PhantomMessageCache.StageListCache) 2 === this.PhantomMessageCache.GetPassRewardStateById(n.Id) && e++, t++;
    return [e, t]
  }
  GetPreviewRewardData() {
    ...
    for (const T of TowerDefenceRewardAll_1.configTowerDefenceRewardAll.GetConfigList())
      if (T.ActivityId === this.PhantomMessageCache.Id) {
        var t, r, n = [];
        for ([t, r] of DropPackageById_1.configDropPackageById.GetConfig(T.RewardId).DropPreview) n.push([{
          ItemId: t,
          IncId: 0
        }, r]);
    ...
    for (const I of this.PhantomMessageCache.StageListCache) {
      var s, f, c = [],
        h = TowerDefenceInstanceById_1.configTowerDefenceInstanceById.GetConfig(I.Id),
        D = h.InstanceId,
        ...
        d = h.RewardId;
      for ([s, f] of DropPackageById_1.configDropPackageById.GetConfig(d).DropPreview) c.push([{
        ItemId: s,
        IncId: 0
      }, f]);
      d = this.PhantomMessageCache.GetPassRewardStateById(I.Id), D = {
        Id: D,
        NameText: "",
    ...
    var _ = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("TowerDefenceFullPoint"),
      _ = _ ? StringUtils_1.StringUtils.Format(_, this.PhantomMessageCache.TotalScore.toString()) : "",
      w = [],
      _ = (0 < i.length && w.push({
  ...
  ResetPhantomOwnerDataList() {
    for (let e = this.PhantomOwnerDataList.length = 0; e < EditFormationDefine_1.EDITE_FORAMTION_MAX_NUM; e++) this.PhantomOwnerDataList.push({
  ...
  ResetPhantomOwnerDataByIndex(e) {
    this.PhantomOwnerDataList[e].PlayerId = ModelManager_1.ModelManager.PlayerInfoModel.GetId(), this.PhantomOwnerDataList[e].IsSelf = !0, this.PhantomOwnerDataList[e].RoleCfgId = TowerDefenceDefine_1.DEFAULT_ID, this.PhantomOwnerDataList[e].RoleSkinId = TowerDefenceDefine_1.DEFAULT_ID, this.PhantomOwnerDataList[e].PhantomId = TowerDefenceDefine_1.DEFAULT_ID
  }
  ResetAllCache() {
    this.CurrentSelfPhantomIdInUiTemp = TowerDefenceDefine_1.DEFAULT_ID;
    for (let e = 0; e < this.PhantomOwnerDataList.length; e++) this.ResetPhantomOwnerDataByIndex(e);
  ...
  TryAddTimerInBattle(e, t, r) {
    var n;
    void 0 !== e && (this.TimerCacheInBattle.has(t) || this.TimerCacheInBattle.set(t, new Map), (n = this.TimerCacheInBattle.get(t)).has(r) && (n.get(r).Remove(), Log_1.Log.CheckError()) && Log_1.Log.Error("TowerDefense", 64, "同一玩家的同一角色已经有timer用于复活倒计时，其将被停止，用新timer取代", ["playerId", t], ["roleId", r]), n.set(r, e))
  }
  TryRemoveTimerInBattle(e, t) {
    ...
    if (void 0 !== r)
      if (void 0 === t) {
        ...
        const n = r.get(t);
        void 0 !== n && (n.Remove(), r.delete(t), 0 === r.size) && this.TimerCacheInBattle.delete(e)
      }
  }
  CheckHasReward() {
  ...
  CheckHasScoreReward() {
    ...
    for (const r of e)
      if (r.ActivityId === this.PhantomMessageCache.Id && t.TotalScore >= r.Score && !t.ScoreRewardCache.has(r.Id)) return !0;
    return !1
  }
  CheckHasPassReward() {
  ...
  fUc(e) {
    ...
    return t ? t.get(e) ?? !1 : (t = new Map, LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerDefenseNewLevel, t), !1)
  }
  ...
  SetLevelHasClickByInstanceId(t) {
    ...
    for (const n of this.PhantomMessageCache.StageListCache) {
      ...
      if (r && r === t) {
        if (!ModelManager_1.ModelManager.InstanceDungeonEntranceModel.CheckInstanceUnlock(t)) return;
        e = !0;
        break
      }
    }
    if (e) {
      ...
      (e = e || new Map).set(t, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.TowerDefenseNewLevel, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.PhantomMessageCache.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnChallengeInstanceRedDot, t)
    }
  }
  HasNotClickNewLevel() {
  ...
  CheckCurrentActivityShowDifferent() {
    ...
    return e ? e.ShowDifferent : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 10, "塔防活动配置数据为空", ["ActivityId", this.PhantomMessageCache.Id]), !1)
  }
  CheckPhantomIsOccupied(e) {
    for (const t of this.PhantomOwnerDataList)
      if (t.PhantomId !== TowerDefenceDefine_1.DEFAULT_ID && t.PhantomId === e) return !0;
    return !1
  }
  GetOwnerData(e, t) {
    for (const r of this.PhantomOwnerDataList)
  ...
  GetCurrentActivityConfig() {
    ...
    if (e) return e;
    Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 10, "塔防活动配置数据为空", ["ActivityId", this.PhantomMessageCache.Id])
  }
  ...
  GetInstanceUnlockState(e, t) {
    ...
    if (0 !== e) {
      ...
      if (!ModelManager_1.ModelManager.TowerDefenseModel.PhantomMessageCache.IsPassedInstance(t.InstanceId)) return !1
    }
    return !0
  }
}
...
class ParsedTowerDefenseMsg extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.ScoreRewardCache = new Map, this.StageListCache = [], this.StageMapCache = new Map, this.OwnPhantomInBattleDataCache = new Map, this.OwnPhantomInBattleNewLevelUpFlagCache = new Map, this.TotalScore = 0
  }
  OnInit(e) {
  ...
  PhraseEx(e) {
    var t = e.pzs;
    t ? this.ParseTowerDefenseActivityData(t) : Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "塔防数据为空，请确认活动协议类型是否正确", ["ActivityId", e.s5n], ["ActivityType", e.h5n])
  }
  ...
  ParseTowerDefenseActivityData(e) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("TowerDefense", 64, "解析塔防活动数据", ["data", e]), this.ScoreRewardCache.clear(), this.TotalScore = 0;
  ...
  ParseTowerDefenseInstanceDataList(e, t = !0) {
    if (Log_1.Log.CheckDebug() && Log_1.Log.Debug("TowerDefense", 64, "解析塔防关卡数据", ["dataList", e], ["是否全量更新", t]), t) {
      this.TotalScore = 0, this.StageListCache.length = 0, this.StageMapCache.clear();
      for (const i of e) {
        ...
        }, this.StageListCache.push(r), this.StageMapCache.set(i.s5n, r)) : Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "塔防副本协议数据与配置不匹配，协议ID：" + i.s5n)
      }
    } else {
      for (const a of e)
        if (!this.StageMapCache.has(a.s5n)) return void(Log_1.Log.CheckInfo() && Log_1.Log.Info("TowerDefense", 64, "塔防关卡协议存量更新时，出现未缓存的数据，本条协议不更新", ["协议数据", e]));
      for (const s of e) {
        var n = TowerDefenceInstanceById_1.configTowerDefenceInstanceById.GetConfig(s.s5n),
          o = this.StageMapCache.get(s.s5n);
        o.Meta = s, o.Id = s.s5n, o.UnlockTime = MathUtils_1.MathUtils.LongToNumber(s.yzs), o.Passed = s.Ezs, o.PassTime = s.Qxs, o.Rewarded = s.mLs, o.Record = s.tBs, o.RecordOverThreshold = s.tBs >= n.RewardScore
      }
    }
  }
  ParseTowerDefenseOwnPhantomDataList(e) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("TowerDefense", 64, "解析塔防声骸数据", ["infoList", e]);
    for (const r of e) {
      var t = this.OwnPhantomInBattleDataCache.get(r.s5n);
      t && r.F6n > t.F6n && this.OwnPhantomInBattleNewLevelUpFlagCache.set(r.s5n, !0), this.OwnPhantomInBattleDataCache.set(r.s5n, r)
    }
  }
  ...
  GetPassRewardStateById(e) {
    ...
    return void 0 === t ? 0 : (e = this.StageMapCache.get(e), t.IsDifficult ? e.Passed ? e.Rewarded ? 2 : 1 : 0 : e.RecordOverThreshold ? e.Rewarded ? 2 : 1 : 0)
  }
  ...
  IsStageUnlockedByTowerDefenseInstanceId(e) {
    ...
    return r ? r.UnlockTime < t : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "塔防关卡协议数据丢失", ["TowerDefenseInstanceId", e], ["关卡协议缓存", this.StageMapCache]), !1)
  }
  IsPassedInstance(e) {
    var e = TowerDefenceInstanceByInstanceId_1.configTowerDefenceInstanceByInstanceId.GetConfig(e),
      t = this.StageMapCache.get(e.Id);
    return t ? t.Passed : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "是否通关数据查询,塔防关卡协议数据丢失", ["TowerDefenseInstanceId", e.Id], ["关卡协议缓存", this.StageMapCache]), !1)
  }
  GetPassTimeByInstanceId(e) {
    var e = TowerDefenceInstanceByInstanceId_1.configTowerDefenceInstanceByInstanceId.GetConfig(e),
      t = this.StageMapCache.get(e.Id);
    return t ? t.PassTime : (Log_1.Log.CheckError() && Log_1.Log.Error("TowerDefense", 64, "获取通关时间数据,塔防关卡协议数据丢失", ["TowerDefenseInstanceId", e.Id], ["关卡协议缓存", this.StageMapCache]), 0)
  }
