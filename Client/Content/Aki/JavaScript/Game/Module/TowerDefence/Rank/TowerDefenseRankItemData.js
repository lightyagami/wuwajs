...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.TowerDefenseRankItemData = exports.TowerDefenseRankRoleData = void 0;
...
class TowerDefenseRankRoleData {
  constructor() {
    this.IsEmpty = !0, this.RoleSkinId = 0, this.RoleLevel = 0, this.PhantomId = 0, this.IsOnline = !1, this.Pos = 0
  }
}
exports.TowerDefenseRankRoleData = TowerDefenseRankRoleData;
class TowerDefenseRankItemData {
  constructor(t, e, s) {
    this.IsSelfInData = !1, this.ServerData = void 0, this.IsOnline = !1, this.IsDifficult = !1, this.IsInRank = !0, this.IsSelf = !1, this.Rank = 0, this.RoleDataList = [], this.vsc = new Map, this.IsOnline = t, this.IsDifficult = e, this.ServerData = s, this.ysc(), this.Ssc(), this.IsSelfInData = this.Msc()
  }
  get IsEmpty() {
    return 0 === this.ServerData.fnc.length
  }
  get PassScore() {
    ...
    if (this.IsOnline) {
      for (let t = 0, e = this.ServerData.fnc.length; t < e; t++)
        for (const r of this.ServerData.fnc[t].Y7n) {
          ...
          s.RoleSkinId = r.eI_, s.RoleLevel = r.Ebs, s.PhantomId = r.oxs, s.IsOnline = !0, s.IsEmpty = !1, s.Pos = t, this.RoleDataList.push(s)
        }
      for (let t = this.RoleDataList.length; t < MAX_COUNT; t++) {
        var e = new TowerDefenseRankRoleData;
        this.RoleDataList.push(e)
      }
    } else if (0 < this.ServerData.fnc.length) {
      for (const a of this.ServerData.fnc[0].Y7n) {
        var t = new TowerDefenseRankRoleData;
        t.RoleSkinId = a.eI_, t.RoleLevel = a.Ebs, t.PhantomId = a.oxs, t.IsOnline = !1, t.IsEmpty = !1, this.RoleDataList.push(t)
      }
      for (let t = this.RoleDataList.length; t < MAX_COUNT; t++) {
  ...
  Ssc() {
    for (const t of this.ServerData.fnc) this.vsc.set(t.W5n, t.H8n)
  }
  Msc() {
  ...
  RefreshPlayerName(t) {
    ...
    this.vsc.has(e) && (t = t ? "" : ModelManager_1.ModelManager.PlayerInfoModel.GetAccountName(), this.vsc.set(e, t))
  }
  get TopThreeNumColor() {
    return this.IsFirst ? FIRSTPLAYER_COLOR : this.IsSecond ? SECONDPLAYER_COLOR : this.IsThird ? THIRDPLAYER_COLOR : "FFFFFFFF"
  }
  get RankBg() {
