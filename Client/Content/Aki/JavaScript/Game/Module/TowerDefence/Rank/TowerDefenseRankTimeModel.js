...
class TowerDefenseRankTimeModel extends RankTimeItemModel_1.RankTimeItemModelBase {
  OnButtonClick() {
    ...
    e.InstanceId = this.InstanceId, UiManager_1.UiManager.OpenView("TowerDefenseRankView", e)
  }
  OnGetContent() {
    var e;
    return ModelManager_1.ModelManager.TowerDefenseModel.PhantomMessageCache.IsPassedInstance(this.InstanceId) ? (e = ModelManager_1.ModelManager.TowerDefenseModel.RankData.GetBestScoreText(this.InstanceId), new LguiUtil_1.TableTextArgNew("ChallengeOL_Bestrecord", e)) : new LguiUtil_1.TableTextArgNew("ChallengeOL_Norecord")
  }
}
