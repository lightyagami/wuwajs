...
class TowerDefenseInBattleTips extends UiTickViewBase_1.UiTickViewBase {
  ...
  async OnBeforeStartAsync() {
    this.DOt = new SmallItemGrid_1.SmallItemGrid, await this.DOt.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  OnStart() {
    this.bl()
  }
  ...
  bl() {
    ...
    var e = TowerDefenceController_1.TowerDefenseController.BuildPhantomIconInBattleData(),
      e = (this.DOt.Apply(e), TowerDefenceController_1.TowerDefenseController.BuildPhantomTipsInBattleData());
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e.TitleTextId), e.DescArgs ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), e.DescTextId, ...e.DescArgs) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), e.DescTextId)
  }
  OnAfterPlayStartSequence() {
    this.ZMa().finally(() => {
      TowerDefenceController_1.TowerDefenseController.ResetCurrentPhantomLevelUpFlag(this.ioa), this.CloseMe()
    })
  }
  async ZMa() {
