...
class TowerDefenseSubView extends ActivitySubViewBase_1.ActivitySubViewBase {
  constructor() {
    super(...arguments), this.LNe = void 0, this.DNe = void 0, this.UNe = void 0, this.ANe = void 0, this.Dsc = void 0, this.kZs = () => {
      var e;
      ModelManager_1.ModelManager.TowerDefenseModel.IsEnterInActivityClicked = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.ActivityBaseData.Id), this.ActivityBaseData.GetPreGuideQuestFinishState() ? 0 !== (e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetTowerDefenseConfigByActivityId(this.ActivityBaseData.Id)).EntranceId ? ControllerHolder_1.ControllerHolder.InstanceDungeonEntranceController.EnterEntrance(e.EntranceId) : (e = {
        MarkId: TowerDefenceController_1.TowerDefenseController.GetMarkIdByActivityId(this.ActivityBaseData.Id),
        MarkType: 0,
        OpenFogId: 0
      }, WorldMapController_1.WorldMapController.OpenView(2, !1, e)) : (e = this.ActivityBaseData.GetUnFinishPreGuideQuestId(), UiManager_1.UiManager.OpenView("QuestView", e))
    }, this.ZPa = () => {
  ...
  async OnBeforeStartAsync() {
    var e = this.GetItem(0),
      ...
      n = (this.ANe = new ActivityFunctionalTypeA_1.ActivityFunctionalTypeA(this.ActivityBaseData), this.GetItem(5));
    this.Dsc = new ActivityButtonItem_1.ActivityButtonItem, await Promise.all([this.LNe.CreateThenShowByActorAsync(e.GetOwner()), this.DNe.CreateThenShowByActorAsync(t.GetOwner()), this.UNe.CreateThenShowByActorAsync(i.GetOwner()), this.ANe.CreateThenShowByActorAsync(r.GetOwner()), this.Dsc.CreateThenShowByActorAsync(n.GetOwner()), this.Bsc()]), this.ANe.FunctionButton.SetFunction(this.kZs), this.Dsc.SetFunction(TowerDefenceController_1.TowerDefenseController.HandleOnClickReward)
  }
  OnRefreshView() {
    this.ActivityBaseData.LocalConfig && (this.Pqe(), this.mGe(), this.FNe(), this.jqe(), this.VNe(), this.Eyn(), this.ZPa(), this.ewa())
  }
  OnTimer(e) {
    this.FNe(), this.VNe()
  }
  Eyn() {
    var e;
    TowerDefenceController_1.TowerDefenseController.GetIsFirstOpen() && ((e = new DifficultUnlockTipView_1.DifficultUnlockTipsData).Text = "BossRushUnlockTips", UiManager_1.UiManager.OpenView("DifficultUnlockTipView", e))
  }
  mGe() {
  ...
  Pqe() {
    ...
    this.DNe.SetContentVisible(i), i && this.DNe.SetContentByTextId(t), this.DNe.SetContentByTextId(e)
  }
  jqe() {
    var e = TowerDefenceController_1.TowerDefenseController.GetActivityPreviewReward();
    this.UNe.SetTitleByTextId("FragmentMemoryCollectReward"), this.UNe.InitGridLayout(this.UNe.InitCommonGridItem), this.UNe.RefreshItemLayout(e)
  }
  VNe() {
    var e, t;
    TowerDefenceController_1.TowerDefenseController.CheckActivityUnlockByMulti() ? (e = TowerDefenceController_1.TowerDefenseController.CheckActivityUnlockByCondition(), this.ANe.SetPanelConditionVisible(!e), this.ANe.FunctionButton.SetUiActive(e), e ? (t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("BossRushEnterText"), this.ANe.FunctionButton.SetText(t)) : this.ANe.SetPerformanceConditionLock(this.ActivityBaseData.ConditionGroupId, this.ActivityBaseData.Id), t = ModelManager_1.ModelManager.TowerDefenseModel.GetPreviewRewardCount(), this.Dsc.SetText(t[0] + "/" + t[1]), this.Dsc.SetUiActive(e)) : (this.ANe.SetPanelConditionVisible(!0), this.ANe.SetLockTextByTextId("TowerDefence_Cantplay"), this.Dsc.SetUiActive(!1), this.ANe.FunctionButton.SetUiActive(!1))
  }
  ewa() {
