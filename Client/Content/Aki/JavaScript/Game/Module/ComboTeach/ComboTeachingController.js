...
class ComboTeachingController extends UiControllerBase_1.UiControllerBase {
  ...
  static GetSuccessChecker(e, n) {
    switch (e) {
      ...
      case 7:
        return new CheckCondtions_1.CheckBuffNotHaveCondition(n, !0);
      case 8:
        return new CheckCondtions_1.CheckTagNotHaveCondition(n, !0);
      case 9:
        return new CheckCondtions_1.CheckBulletHitCondition(n, !0);
      case 10:
        return new CheckCondtions_1.CheckKeyInputCondition(n, !0);
      case 11:
        return new CheckCondtions_1.CheckKeyHoldingCondition(n, !0)
    }
    return Log_1.Log.CheckError() && Log_1.Log.Error("ComboTeaching", 34, "角色出招教学，成功条件检查未实现", ["type", e]), new CheckCondtions_1.BaseCheckCondition(n, !0)
  }
  static GetFailChecker(e, n) {
    switch (e) {
      ...
      case 7:
        return new CheckCondtions_1.CheckKeyInputCondition(n, !1);
      case 8:
        return new CheckCondtions_1.CheckKeyHoldingCondition(n, !1)
    }
    return Log_1.Log.CheckError() && Log_1.Log.Error("ComboTeaching", 34, "角色出招教学，失败条件检查未实现", ["type", e]), new CheckCondtions_1.BaseCheckCondition(n, !1)
  }
}(exports.ComboTeachingController = ComboTeachingController).OnOpenComboTeachingView = e => {
  ModelManager_1.ModelManager.ComboTeachingModel.RecoveryComboId = e, UiManager_1.UiManager.OpenView("ComboTeachingView", e)
}, ComboTeachingController.CheckOpenComboTeachingView = () => ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance();
