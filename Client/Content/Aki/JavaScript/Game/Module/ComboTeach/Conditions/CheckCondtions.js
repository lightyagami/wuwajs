...
class CheckEnergyCondition extends BaseCheckCondition {
  ...
  CheckSuccess(t) {
    var e;
    var i;
    return !!this.SuccessParamsArray && (e = this.SuccessParamsArray[0], i = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint(), (i = EntitySystem_1.EntitySystem.Get(i).GetComponent(174).GetCurrentValue(CharacterAttributeTypes_1.energyAttrIds[Number(e[0])])) >= Number(e[1])) && i <= Number(e[2]);
  }
  CheckFail(t) {
    var e;
    return !!this.ParamsArray && (e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint(), (e = EntitySystem_1.EntitySystem.Get(e).GetComponent(174).GetCurrentValue(CharacterAttributeTypes_1.energyAttrIds[Number(this.ParamsArray[0])])) >= Number(this.ParamsArray[1])) && e <= Number(this.ParamsArray[2]);
  }
}
...
class CheckIsJumpCondition extends BaseCheckCondition {
  ...
  Check(t) {
    ...
    return EntitySystem_1.EntitySystem.Get(e)?.GetComponent(179)?.IsJump ?? false;
  }
}
...
class CheckBuffAddCondition extends BaseCheckCondition {
  ...
  Check(t) {
    if (this.SuccessParamsArray) {
      var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
      var i = EntitySystem_1.EntitySystem.Get(e)?.GetComponent(175);
      if (i) {
        for (const s of this.SuccessParamsArray) {
...
class CheckTagAddCondition extends BaseCheckCondition {
  ...
  Check(t) {
    if (this.SuccessParamsArray) {
      var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
      var i = EntitySystem_1.EntitySystem.Get(e)?.GetComponent(206);
      if (i) {
...
class CheckBuffNotHaveCondition extends BaseCheckCondition {
  ...
  CheckFail(t) {
    var e;
    return !!this.ParamsArray && (e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint(), !EntitySystem_1.EntitySystem.Get(e)?.GetComponent(175)?.GetBuffTotalStackById(Number(this.ParamsArray[0])));
  }
  CheckSuccess(t) {
    if (this.SuccessParamsArray) {
      var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
...
class CheckTagNotHaveCondition extends BaseCheckCondition {
  ...
  CheckFail(t) {
    var e;
    return !!this.ParamsArray && (e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint(), !EntitySystem_1.EntitySystem.Get(e)?.GetComponent(206)?.HasTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(this.ParamsArray[0])));
  }
  CheckSuccess(t) {
    if (this.SuccessParamsArray) {
      var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
...
class CheckNotInSkillCondition extends BaseCheckCondition {
  ...
  Check(t) {
    var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
    return !EntitySystem_1.EntitySystem.Get(e)?.GetComponent(206)?.HasTag(-1371021686);
  }
}
...
class CheckIsInJumpCondition extends BaseCheckCondition {
  ...
  Check(t) {
    var e = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
    var e = EntitySystem_1.EntitySystem.Get(e)?.GetComponent(206);
