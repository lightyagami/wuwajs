...
class ComboTeachingView extends UiTickViewBase_1.UiTickViewBase {
  ...
  OnTick(e) {
    ...
    if (Global_1.Global.BaseCharacter && (t = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint(), (EntitySystem_1.EntitySystem.Get(t)?.GetComponent(178)).IsJump) && ModelManager_1.ModelManager.ComboTeachingModel.BeforeJumpTime === 0) {
