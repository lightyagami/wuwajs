...
exports.RogueBattleSummaryView = undefined;
const UE = require("ue");
...
class RogueBattleSummaryView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.pqe = e => {
      ...
      this.RE1(i === "RogueBattleSummaryTeamTabView");
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIItem], [2, UE.UIItem], [3, UE.UIItem], [4, UE.UIExtendToggle], [5, UE.UIItem], [6, UE.UIItem]];
  }
  ...
  OnHandleLoadScene() {
    ...
    if (this.rmo === "RogueBattleSummaryTeamTabView") {
