...
class RogueBattleEnvironmentBuffView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.vT1 = void 0, this.yT1 = void 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.vT1 = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(0), () => new RogueBattleEnvironmentBuffItem_1.RogueBattleEnvironmentBuffItemWithTexture), this.yT1 = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(1), () => new RogueBattleEnvironmentBuffItem_1.RogueBattleEnvironmentBuffItemWithSprite), await this.RefreshView()
  }
  async RefreshView() {
    ...
    if (t) {
      ...
      await Promise.all([this.vT1.RefreshByDataAsync(i), this.yT1.RefreshByDataAsync(a)])
    }
  }
}
