...
class RogueBattleMapHelpView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Tk1 = void 0
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.Tk1 = new GenericLayout_1.GenericLayout(this.GetGridLayout(0), () => new RogueBattleEnvironmentBuffItem_1.RogueBattleEnvironmentBuffItemWithTexture);
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t.MainHelpRuleDesc), await this.Tk1.RefreshByDataAsync(r)
  }
}
