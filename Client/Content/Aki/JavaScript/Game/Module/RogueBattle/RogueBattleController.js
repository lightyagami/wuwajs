...
class RogueBattleController extends UiControllerBase_1.UiControllerBase {
  static OnRegisterNetEvent() {
    Net_1.Net.Register(21922, RogueBattleController.OnRogueRoomInfoNotify);
    Net_1.Net.Register(16772, RogueBattleController.OnRogueResInstOptionsUpdateNotify);
    Net_1.Net.Register(26156, RogueBattleController.OnRogueResGainDataUpdateNotify);
    Net_1.Net.Register(22419, RogueBattleController.OnRogueResElementUpdateNotify);
    Net_1.Net.Register(29444, RogueBattleController.OnRogueResRoleBondUpdateNotify);
    Net_1.Net.Register(22233, RogueBattleController.OnRogueResFormationUpdateNotify);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(21922);
    Net_1.Net.UnRegister(16772);
    Net_1.Net.UnRegister(26156);
    Net_1.Net.UnRegister(22419);
    Net_1.Net.UnRegister(29444);
  ...
  static async GotoNextRoomRequest() {
    ...
    var e = await Net_1.Net.CallAsync(21748, e);
    if (e) {
  ...
  static async SwitchFormationRequest(e) {
    ...
    o.c5n = e;
    var e = await Net_1.Net.CallAsync(26385, o);
    if (e?.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && e?.Q4n !== Protocol_1.Aki.Protocol.Q4n.Proto_ErrUpdateFightRoleRepeated) {
      ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 26385);
    }
  }
  static async ChangeFormationAllListRequest(e, o) {
    ...
    t.c5n = e;
    var o = await Net_1.Net.CallAsync(25638, t);
    if (o) {
      if (o.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && o.Q4n !== Protocol_1.Aki.Protocol.Q4n.Proto_ErrUpdateFightRoleRepeated) {
        ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(o.Q4n, 25638);
      } else {
  ...
  static async ChangeFormationRequest(e, o, t) {
    ...
    if (a) {
      ...
      r.c5n = e;
      if (o = await Net_1.Net.CallAsync(25638, r)) {
        if (o.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs && o.Q4n !== Protocol_1.Aki.Protocol.Q4n.Proto_ErrUpdateFightRoleRepeated) {
          ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(o.Q4n, 25638);
        } else {
          ModelManager_1.ModelManager.RogueBattleModel.UpdateFormationData(e, o.do1);
  ...
  static async SelectTokenRequest(e) {
    ...
    o.VB1 = e;
    var e = await Net_1.Net.CallAsync(23029, o);
    if (e) {
      if (e.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.G9n, 23029);
      }
