...
class RogueBattleTokenElementWithCount extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  async OnBeforeStartAsync() {
    return this.ElementItem = new RogueBattleTokenElement_1.RogueBattleTokenElement, this.ElementItem.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  Refresh(e, t, r) {
    this.ElementItem?.Refresh(e.ElementId, t, r), this.GetText(1).SetText(e.Count.toString()), this.GetText(1).SetChangeColor(e.IsPreview)
  }
}
