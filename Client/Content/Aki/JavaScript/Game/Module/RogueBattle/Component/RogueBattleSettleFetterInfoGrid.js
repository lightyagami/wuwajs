...
class RogueBattleSettleFetterInfoGrid extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, r) {
    ...
    void 0 !== i && (this.SetTextureShowUntilLoaded(i.Icon, this.GetTexture(1)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), "RogueRes_FightFormation_RoleLevel", e.F6n.toString()))
  }
}
