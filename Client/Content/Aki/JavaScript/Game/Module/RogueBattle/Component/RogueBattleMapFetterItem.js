...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueBattleMapFetterInfoItem = exports.RogueBattleMapFetterInfoDescItem = void 0;
const UE = require("ue"),
...
class RogueBattleMapFetterInfoDescItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, r) {
    e.Param ? (o = e.Param.split("#"), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.TextId, ...o)) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.TextId);
...
class RogueBattleMapFetterInfoItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Gxt = void 0, this.Bqe = () => new RogueBattleMapFetterInfoDescItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UISprite],
  ...
  Refresh(e, t, r) {
    var o, i, s, a = ConfigManager_1.ConfigManager.RogueBattleConfig.GetRogueResBond(e.ConfigId),
      n = (this.GetText(1)?.SetText("Lv." + e.Level), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), "RogueRes_Overall_Synergy_6", a.StarMap.get(e.Level)), []);
    let u = 0;
    for (const l of a.BattleEffect) l[0] === e.Level && (o = {
    ...
    u = 0;
    for (const c of a.ExploreEffect) c[0] === e.Level && (i = {
      TextId: a.ExploreEffectDesc[u],
      Param: a.ExploreEffectDescParam[u],
      IsReached: e.IsReached,
      EffectType: 1
    }, n.push(i)), u++;
    for (const f of a.LinkEffect) f[0] === e.Level && (s = {
      TextId: a.LinkEffectDesc.get(f[0]),
      Param: a.LinkEffectDescParam.get(f[0]),
      IsReached: e.IsReached,
      EffectType: 2
    }, n.push(s));
    this.Gxt.RefreshByData(n), this.GetSprite(0).SetColor(UE.Color.FromHex(bgColor.get(e.IsReached))), this.GetText(2).SetColor(UE.Color.FromHex(txtColor.get(e.IsReached)))
  }
  GetGuideUiItemAndUiItemForShowEx(e) {
    var t, r;
    if (e && !(e.length < 3)) return "Star" === (r = e[2]) ? (t = this.GetGuideUiItem("0")) ? [t, t] : void 0 : "Item" === r && !(e.length < 4) && (t = Number(e[3]), r = this.Gxt?.GetItemByIndex(t - 1)) ? [r, r] : void 0
  }
}
