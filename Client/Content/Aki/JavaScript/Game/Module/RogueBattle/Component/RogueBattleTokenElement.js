...
class RogueBattleTokenElement extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, r, t) {
    var s, e = ConfigManager_1.ConfigManager.CommonConfig.GetElementConfig(e);
    e && (s = UE.Color.FromHex(e.ElementColor), this.GetSprite(0).SetColor(s), this.SetTextureByPath(e.Icon5, this.GetTexture(1)))
  }
}
