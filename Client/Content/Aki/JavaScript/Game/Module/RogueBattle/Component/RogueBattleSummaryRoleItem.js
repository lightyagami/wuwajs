...
class RogueBattleSummaryRoleItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Spt = void 0, this.AttributeItemList = [], this.I2i = () => {
      ...
      var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems()[0],
        e = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e.GetConfigId);
  ...
  OnStart() {
    this.Spt = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(5), this.I2i), this.Uho()
  }
  OnBeforeShow() {
    this.UpdateAttribute(), this.bb1()
  }
  OnBeforeHide() {}
  OnBeforeDestroy() {
    this.Spt = void 0;
  ...
  bb1() {
    ...
    ModelManager_1.ModelManager.RogueBattleModel.SummaryRoleList = r, this.Spt?.RefreshByData(t)
  }
  Uho() {
    ...
    for (let e = 0; e < o; ++e) {
      ...
      l.CreateThenShowByActor(a.GetOwner()), l.UpdateParam(s, !1), 2 < o && e % 2 == 0 ? l.SetBgActive(!0) : l.SetBgActive(!1), this.AttributeItemList.push(l)
    }
  }
  UpdateAttribute() {
    var t = CommonParamById_1.configCommonParamById.GetIntArrayConfig("RoleAttributeDisplay6"),
