...
class RogueBattleElementPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.TipPanel = void 0, this.ElementLayout = void 0, this.u5c = e => {
      switch (e) {
        case 1:
  ...
  async OnBeforeStartAsync() {
    this.TipPanel = new RogueBattleElementTipPanel_1.RogueBattleElementTipPanel, this.ElementLayout = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(2), this.jli);
    ...
    this.GetText(1).SetText("" + t), await Promise.all([this.ElementLayout.RefreshByDataAsync(e), this.TipPanel.CreateByActorAsync(this.GetItem(4).GetOwner())])
  }
