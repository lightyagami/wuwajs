...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueBattleTokenDetailGridBottom = exports.RogueBattleShopDiscount = exports.RogueBattleDiscountTagComponent = exports.RogueBattleGridElementComponent = void 0;
const UE = require("ue"),
...
class RogueBattleDiscountTagComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    var t;
    e._Ic && (t = e._Ic.kN_, e = e._Ic.qN_, e = Math.floor(e / t * 100), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), "RogueInfoViewShopDiscount", (100 - e).toString()))
  }
}
...
class RogueBattleShopDiscount extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    e._Ic && (e._Ic.qN_ !== e._Ic.kN_ ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "RogueInfoViewShopPriceWithDiscount", e._Ic.qN_, e._Ic.kN_) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), "RogueInfoViewShopPrice", e._Ic.kN_), 0 !== e._Ic.L8n) && (e = ConfigManager_1.ConfigManager.RoguelikeConfig?.GetRogueCurrencyConfig(e._Ic.L8n), this.SetTextureByPath(e?.IconSmall ?? "", this.GetTexture(0)))
  }
}
...
class RogueBattleTokenDetailGridBottom extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnActivate() {
    this.Zao = new RogueBattleTokenElement_1.RogueBattleTokenElement, this.Zao.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  OnRefresh(e) {
    e = RogueBattleUtils_1.RogueBattleUtils.GetTokenSortElementInfo(e);
    e.length <= 0 || (this.Zao.Refresh(e[0].ElementId, !1, 0), this.GetText(1).SetText(e[0].Count.toString()))
  }
}
