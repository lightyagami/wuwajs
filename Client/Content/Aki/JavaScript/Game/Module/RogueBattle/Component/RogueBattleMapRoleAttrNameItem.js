...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueBattleMapRoleAttributeNameItem = exports.RougeBattleAttributeStarItem = void 0;
const UE = require("ue"),
...
class RogueBattleMapRoleAttributeNameItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.$be = void 0, this.Fao = () => new RougeBattleAttributeStarItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UIText],
  ...
  Refresh(e) {
    ...
    if (t) {
      ...
      var r = t.GetElementInfo(),
        a = ConfigManager_1.ConfigManager.ElementInfoConfig.GetElementInfoLocalName(r.Name),
        a = (this.GetText(3).SetText(a), this.SetElementIcon(r.Icon, this.GetTexture(2), t.GetRoleConfig().ElementId), ModelManager_1.ModelManager.RogueBattleModel.IsRoleGot(e));
      if (this.GetText(1)?.SetUIActive(a), this.GetHorizontalLayout(4)?.RootUIComp.SetUIActive(a), a) {
        var r = ModelManager_1.ModelManager.RogueBattleModel.GetIncIdByRoleId(e),
          ...
          i = (this.GetText(1).SetText("Lv." + a), ModelManager_1.ModelManager.MapRogueModel.GetRogueRoleMaxStar()),
          o = t.F6n,
          s = new Array(i);
        for (let e = 0; e < i; e++) s[e] = e < o;
        this.$be?.RefreshByData(s)
      }
    } else Log_1.Log.CheckError() && Log_1.Log.Error("RogueBattle", 77, "没有角色数据", ["roleId", e])
  }
}
