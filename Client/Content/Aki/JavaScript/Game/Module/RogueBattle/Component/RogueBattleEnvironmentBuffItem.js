...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueBattleEnvironmentBuffItemWithSprite = exports.RogueBattleEnvironmentBuffItemWithTexture = void 0;
const UE = require("ue"),
...
class RogueBattleEnvironmentBuffItemWithTexture extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, i) {
    this.SetTextureByPath(t.Icon, this.GetTexture(0)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t.TextId, ...t.Param)
  }
}
...
class RogueBattleEnvironmentBuffItemWithSprite extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, i) {
    this.SetSpriteByPath(t.Icon, this.GetSprite(0), !1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t.TextId, ...t.Param)
  }
}
