...
class RogueBattleSettleInfoRoleGrid extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  OnRefresh(e, o, t) {
    var i = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e.mIc.Um1);
    i ? (i = {
      Type: 2,
      ItemConfigId: e.mIc.Um1,
      SkinId: i.GetRoleSkinId(),
      ElementId: i.GetElementInfo().Id,
      Data: e,
      IsTrialRoleVisible: i.IsTrialRole()
    }, this.Apply(i), i = this.RefreshComponent(RogueBattleSettleInfoRoleGridLevelComponent, !0, e), this.SetComponentVisible(i, !0)) : Log_1.Log.CheckError() && Log_1.Log.Error("RogueBattle", 34, "刷新角色信息失败，角色配置不存在", ["ConfigId:", e.mIc.Um1])
  }
}
...
class RogueBattleSettleInfoRoleGridLevelComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    this.GetText(0)?.SetText(""), this.GetText(3)?.SetText(e.mIc.F6n.toString())
  }
}
