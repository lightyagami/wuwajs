...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.RogueBattleMapRoleAttributeFettersItem = exports.RougeBattleAttributeFetterItem = void 0;
const UE = require("ue"),
...
class RougeBattleAttributeFetterItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.KM1 = 0, this.kqe = () => {
      ModelManager_1.ModelManager.RogueBattleModel.CurrentMapSummaryBond = this.KM1, ModelManager_1.ModelManager.RogueBattleModel.IsMapSummaryBondJumping = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RogueResMapSummaryTeamToBondUpdate), this.GetExtendToggle(2)?.SetToggleState(0)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, r) {
    this.KM1 = e.ConfigId, this.GetText(1)?.SetText("Lv." + e.Level);
...
class RogueBattleMapRoleAttributeFettersItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.GC1 = void 0, this.Fao = () => new RougeBattleAttributeFetterItem
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UIText],
  ...
  OnStart() {
    this.GC1 = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(1), this.Fao)
  }
  OnBeforeDestroy() {
    this.GC1 = void 0
  }
