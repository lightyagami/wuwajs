...
exports.RogueBattleRoleAffixDetailToggle = undefined;
const UE = require("ue");
...
class RogueBattleRoleAffixDetailToggle extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, i) {
    ...
    if (e) {
      this.SetSpriteByPath(e.AffixIcon, this.GetSprite(0), false);
      this.GetExtendToggle(1)?.SetToggleState(t ? 1 : 0, false);
