...
class RogueBattleRoleAffixDetailToggle extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Id = 0, this.OnSelectCallback = void 0, this.BBl = () => {
  ...
  Refresh(e, t, i) {
    ...
    e && (this.SetSpriteByPath(e.AffixIcon, this.GetSprite(0), !1), this.GetExtendToggle(1)?.SetToggleState(t ? 1 : 0, !1), this.GetExtendToggle(1).OnStateChange.Clear(), this.GetExtendToggle(1).OnStateChange.Add(this.BBl))
  }
  OnSelected(e) {
