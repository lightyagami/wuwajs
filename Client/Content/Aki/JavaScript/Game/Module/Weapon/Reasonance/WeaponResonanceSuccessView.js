...
class WeaponResonanceSuccessView extends UiViewBase_1.UiViewBase {
  ...
  OnBeforeShow() {
    var e = this.OpenParam,
      i = e.WeaponIncId,
      e = e.LastLevel,
      i = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(i).GetResonanceLevel();
    LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "WeaponResonanceLevelText", e), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "WeaponResonanceLevelText", i)
  }
}
