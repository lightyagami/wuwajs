...
class WeaponConfig extends ConfigBase_1.ConfigBase {
  constructor() {
    super(...arguments), this.Cko = new Map, this.gko = new Map, this.fko = new Map, this.pko = new Map
  }
  ...
  GetWeaponPropertyGrowthConfig(e, n, o) {
    ...
    return r || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 10, "武器基础配置表格查找武器成长数值失败 WeaponPropertyGrowth", ["曲线id", e], ["等级", n], ["突破等级", o]), r
  }
  GetWeaponResonanceConfig(e, n) {
    var o = WeaponResonByResonIdAndLevel_1.configWeaponResonByResonIdAndLevel.GetConfig(e, n);
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 37, "武器基础配置表格查找武器共鸣配置[WeaponReson]失败,请查看对应表格", ["共鸣组id", e], ["共鸣等级", n]), o
  }
  ...
  GetWeaponTypeName(e) {
    ...
    if (e) return MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e.Comment)
  }
  GetWeaponIconPath(e) {
  ...
  GetWeaponLevelUpCostRatio() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("WeaponLevelUpCoinCost") / 1e3
  }
  GetWeaponExpCoefficient() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("WeaponStrengthenExpCost") / 1e3
  }
  ...
  OnClear() {
    return this.Cko.clear(), this.gko.clear(), this.fko.clear(), this.pko.clear(), !0
  }
}
