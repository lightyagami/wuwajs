...
class WeaponModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Lko = new Map, this.Dko = new Map, this.Rko = 0, this.BlueprintWeaponBreachLevel = 0, this.BlueprintWeaponEquippedRoleId = 0, this.Uko = (e, t) => t.QualityId - e.QualityId
  }
  AddWeaponData(e) {
    var e = this.CreateWeaponInstance(e),
      t = e.GetIncId(),
      n = (this.Lko.set(t, e), e.HasRole());
    n && (n = e.GetRoleId(), this.Dko.set(n, t), Log_1.Log.CheckInfo()) && Log_1.Log.Info("Role", 43, "武器设置", ["roleId", n], ["incId", t])
  }
  RemoveWeaponData(e) {
    var t = this.Lko.get(e);
    t && (t.HasRole() && (t = t.GetRoleId(), this.Dko.delete(t)), this.Lko.delete(e))
  }
  ...
  GetWeaponDataByRoleDataId(e, t = !0) {
    ...
    return t.IsTrialRole() || t.IsOnlineRole() ? t.GetWeaponData() : void 0 !== (t = this.GetWeaponInstanceByRoleId(e)) ? t : void(Log_1.Log.CheckError() && Log_1.Log.Error("Role", 58, "获取不到武器数据", ["roleDataId", e]))
  }
  GetWeaponIdByRoleDataId(e) {
    var t = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e);
    return t ? t.IsTrialRole() ? t.GetWeaponData().GetItemId() : void 0 !== (t = this.GetWeaponInstanceByRoleId(e)) ? t.GetItemId() : void(Log_1.Log.CheckError() && Log_1.Log.Error("Role", 58, "获取不到武器数据", ["roleDataId", e])) : ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e).InitWeaponItemId
  }
  ...
  WeaponLevelUpResponse(e) {
    this.SetWeaponLevelData(e.w5n, e.gjn, e.Cjn), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WeaponLevelUp), this.wOo(e._vs)
  }
  wOo(e) {
    var t = [];
  ...
  ChangeWeaponEquip(e, t) {
    var n = this.Lko.get(e),
      o = n.GetRoleId();
    0 < o && (this.Dko.set(o, 0), Log_1.Log.CheckInfo()) && Log_1.Log.Info("Role", 43, "武器设置", ["lastRoleId", o], ["incId", 0]), n.SetRoleId(t), 0 < t && (this.Dko.set(t, e), Log_1.Log.CheckInfo()) && Log_1.Log.Info("Role", 43, "武器设置", ["roleId", t], ["incId", e])
  }
  ...
  GetWeaponListFromReplace(e) {
    var t = [];
    for (const n of ModelManager_1.ModelManager.InventoryModel.GetWeaponItemDataList()) this.GetWeaponDataByIncId(n.GetUniqueId()).GetWeaponConfig().WeaponType === e && t.push(n);
    return t
  }
  GetResonanceMaterialList(e) {
    var t = ModelManager_1.ModelManager.InventoryModel,
      ...
      o = n.GetItemId(),
      r = [];
    for (const a of t.GetItemDataBaseByMainType(2)) a.GetConfigId() !== o || a.GetUniqueId() === e || this.GetWeaponDataByIncId(a.GetUniqueId()).HasRole() || r.push(a);
  ...
  GetCanChangeMaterialList(e) {
    var t = new Map,
      n = ConfigCommon_1.ConfigCommon.ToList(ConfigManager_1.ConfigManager.ItemConfig.GetConfigListByItemType(4));
    n.sort(this.Uko);
    let o = e;
    for (const i of n) {
      var r, a = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponExpItemConfig(i.Id);
      o >= a.BasicExp && (r = Math.floor(o / a.BasicExp), t.set(i.Id, r), o %= a.BasicExp)
    }
    return t
  }
  GetResonanceNeedMoney(t, n, o) {
    let r = 0;
    for (let e = n; e < o; e++) r += ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponResonanceConfig(t, e).GoldConsume;
    return r
  }
  ...
  GetWeaponConfigDescParams(e, t) {
    var n, o = [];
    for (const r of e.DescParams) r && (n = t >= r.ArrayString.length ? r.ArrayString.length : t, n = r.ArrayString[n - 1], o.push(n));
    return o
  }
  ...
  GetWeaponItemExp(e, t) {
    return e && 0 < e ? this.GetWeaponDataByIncId(e).GetMaterialExp() : ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponExpItemConfig(t).BasicExp
  }
  GetWeaponItemExpCost(e, t) {
    return e && 0 < e ? this.GetWeaponDataByIncId(e).GetMaterialCost() : ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponExpItemConfig(t).Cost
  }
  ...
  GetWeaponExpItemList(e) {
    var t = [];
    for (const n of ModelManager_1.ModelManager.InventoryModel.GetItemDataBaseByMainType(2)) this.CanItemUseAsExpItem(n) && e !== n.GetUniqueId() && t.push(n);
    return t
  }
  ...
  GetWeaponExpItemListWithSort(e) {
    var t = new Set;
    return t.add(2), t.add(10), t.add(8), ModelManager_1.ModelManager.SortModel.SortDataByData(e, 2, t, !0), e
  }
  ...
  GetWeaponBreachState(e) {
    var t, n, e = this.GetWeaponDataByIncId(e),
      o = e.GetBreachConfig();
    if (!ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(o.ConditionId.toString(), void 0, !0)) return 3;
    for ([t, n] of e.GetBreachConsume())
      if (ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(t) < n) return 0;
    e = o.GoldConsume;
    return ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(ItemDefines_1.EItemId.Gold) < e ? 1 : 2
  }
  RedDotWeaponBreachCondition(e) {
    e = this.GetWeaponInstanceByRoleId(e);
    return !(void 0 === e || !e.CanGoBreach()) && 2 === this.GetWeaponBreachState(e.GetIncId())
  }
}
