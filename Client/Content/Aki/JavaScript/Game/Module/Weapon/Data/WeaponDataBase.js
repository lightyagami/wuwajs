...
class WeaponDataBase {
  ...
  GetBreachConfig() {
    var e, n = this.GetWeaponConfig();
    if (n) return e = this.GetBreachLevel(), ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponBreach(n.BreachId, e)
  }
  GetBreachConfigList() {
    var e = this.GetWeaponConfig();
    if (e) return ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponBreachList(e.BreachId)
  }
  GetResonanceConfig() {
    var e, n = this.GetWeaponConfig();
    if (n) return e = this.GetResonanceLevel(), ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponResonanceConfig(n.ResonId, e)
  }
  CanGoBreach() {
    var e, n = this.GetLevel();
  ...
  GetLevelLimitMaxExp() {
    var e = this.GetBreachLevel(),
      e = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponBreach(this.GetWeaponConfig().BreachId, e);
    return this.GetMaxExp(e.LevelLimit - 1)
  }
  GetLevelExp(e) {
    let n = 0;
    return e <= 0 ? 0 : (e = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponLevelConfig(this.GetWeaponConfig().LevelId, e), n = e ? e.Exp : n)
  }
  GetCurrentMaxLevel() {
    var e, n = this.GetWeaponConfig();
    return n ? (e = this.GetBreachLevel(), ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponBreach(n.BreachId, e).LevelLimit) : 0
  }
  GetLastLevelMaxExp() {
