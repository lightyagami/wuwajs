...
class WeaponTrialData extends WeaponDataBase_1.WeaponDataBase {
  constructor() {
    super(...arguments), this.TrialId = 0, this.TrialConfig = void 0, this.FullLevelWeaponData = void 0, this.RoleId = 0, this.BreachLevel = 0
  }
  SetTrialId(e, t = !0) {
    this.TrialId = e, this.TrialConfig = ConfigManager_1.ConfigManager.WeaponConfig.GetTrialWeaponConfig(this.TrialId), this.InitWeaponBreachLevel(), t ? this.InitFullLevelWeaponData() : this.FullLevelWeaponData = void 0
  }
  ...
  InitFullLevelWeaponData() {
    ...
    e <= 0 || ((e = ConfigManager_1.ConfigManager.WeaponConfig.GetTrialWeaponConfig(e)) ? (this.FullLevelWeaponData = new WeaponTrialData, this.FullLevelWeaponData.SetTrialId(e.Id, !1)) : this.FullLevelWeaponData = void 0)
  }
  GetItemId() {
    return this.TrialConfig.WeaponId
  }
  GetSkinId() {
    return 0 < this.TrialConfig.WeaponSkinId ? this.TrialConfig.WeaponSkinId : WeaponSkinDefine_1.WEAPON_SKIN_DEFAULT_ID
  }
  GetLevel() {
