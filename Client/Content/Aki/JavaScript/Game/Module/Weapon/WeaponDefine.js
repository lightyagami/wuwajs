...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.WeaponSkeletalObserverHandles = exports.ResonanceConditionData = exports.LevelUpConditionData = exports.BreachConditionData = exports.ConsumeData = exports.MaterialData = exports.WEAPON_EQUIPTYPE = exports.WEAPON_CURVE_RATION = void 0;
...
class LevelUpConditionData {
  constructor() {
    this.HasHighQuality = !1, this.HasBeStrength = !1, this.HasResonance = !1
  }
  CheckAllCondition() {
  ...
  GetConditionTextList() {
    var t, e = [];
    return this.HasHighQuality && (t = ConfigManager_1.ConfigManager.TextConfig.GetTextById("WeaponHighQuality"), e.push(t)), this.HasBeStrength && (t = ConfigManager_1.ConfigManager.TextConfig.GetTextById("WeaponHasLevelUp"), e.push(t)), this.HasResonance && (t = ConfigManager_1.ConfigManager.TextConfig.GetTextById("WeaponHasResonance"), e.push(t)), e
  }
}
