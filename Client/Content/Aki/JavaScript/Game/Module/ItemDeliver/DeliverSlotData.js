...
class DeliverSlotData {
  constructor() {
    this.sgi = [], this.agi = new Set, this.hgi = 0, this.HandInType = "ItemIds", this.lgi = 0, this.HPt = 0
  }
  Initialize(t, e, s) {
    this.sgi = t, this.agi = new Set(t), this.hgi = e, this.HandInType = s, this.lgi = 0, this.HPt = 0
  }
  SetItem(t, e) {
