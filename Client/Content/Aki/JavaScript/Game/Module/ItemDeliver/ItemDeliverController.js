...
class ItemDeliverController extends UiControllerBase_1.UiControllerBase {
  static HandInItemRequest(e, r, t) {
    var o, a;
    6 !== e.Type ? t && t(!1) : (o = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetBehaviorTreeOwnerId(e.TreeIncId), (a = Protocol_1.Aki.Protocol.nJn.create()).d9n = o, a.C9n = MathUtils_1.MathUtils.BigIntToLong(e.TreeIncId), a.b5n = e.NodeId, a.k9n = r, Net_1.Net.Call(28169, a, e => {
      e ? e.BEs !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 18789), t && t(!1)) : t && t(!0) : t && t(!1)
    }))
  }
  static ItemUseRequest(e, r, t, o) {
    if (1 !== e.Type) o && o(!1);
      ...
      a.m9n = 1, a.L8n = r, a.m9n = t, Net_1.Net.Call(22120, a, e => {
        e ? e.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs ? (ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.G9n, 29496), o && o(!1)) : (o && o(!0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnDeliveryProps, a.L8n)) : o && o(!1)
      })
    }
  }
  static async OpenItemDeliverView(e) {
    return !!UiManager_1.UiManager.IsViewOpen("ItemDeliverView") || (ModelManager_1.ModelManager.ItemDeliverModel.SetItemDeliverData(e), void 0 !== await UiManager_1.UiManager.OpenViewAsync("ItemDeliverView", e))
  }
  static async OpenItemDeliverViewByHandInItem(e, r, t, o, a) {
    ...
    for (const g of e) {
      ...
      if ("ItemIds" === l) {
        ...
        1 === _.length && (_ = _[0], s = i.GetItemCountByConfigId(_), M?.SetItem(_, Math.min(v, s)))
      } else if ("ItemType" === l) {
        var M = g.ItemIds,
          f = [],
  ...
  static OpenItemDeliverViewByHandInGroup(r, e, t, o, a) {
    if (r && !UiManager_1.UiManager.IsViewOpen("ItemDeliverView")) {
      ...
      for (let e = 0; e < r.Slot; e++)
        if ("ItemIds" === l) {
          var v, M, f = n.AddSlotData(s, _, l);
          1 === s.length && (v = s[0], M = i.GetItemCountByConfigId(v), f?.SetItem(v, Math.min(_, M)))
        } else if ("ItemType" === l) {
        var m = [],
