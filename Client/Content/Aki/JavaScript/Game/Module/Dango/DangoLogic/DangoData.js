...
class DangoData {
  ...
  GetSkillEffectConfig() {
    ...
    if (t) {
      return ConfigManager_1.ConfigManager.DangoConfig?.GetDangoSkillEffectById(t.SkillEffect);
    }
  }
  GetDangoActiveSkillDesc() {
    var t = this.GetSkillConfig();
    var i = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(t.Name);
    var t = ConfigManager_1.ConfigManager.TextConfig.GetMultiTextByKey(t.ActivateDesc);
