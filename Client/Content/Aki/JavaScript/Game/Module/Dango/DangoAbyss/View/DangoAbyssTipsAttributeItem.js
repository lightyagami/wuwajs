...
class DangoAbyssTipsAttributeItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, r) {
    var i = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.Id),
      i = (this.GetText(1).ShowTextNew(i.Name), this.SetTextureShowUntilLoaded(i.Icon, this.GetTexture(0)), AttributeModel_1.TipsDataTool.GetPropRatioValue(e.BaseValue, e.IsRatio)),
      i = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.Id, i, e.IsRatio);
