...
class DangoAbyssTagItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.GetValueByTips = !1
  }
  OnRegisterComponent() {
  ...
  Refresh(e, r, t) {
    var i = ConfigManager_1.ConfigManager.DangoAbyssConfig.GetDangoPluginPropDescById(e.TagId),
      ...
      i = (this.GetSprite(0).SetColor(i), ModelManager_1.ModelManager.DangoAbyssModel.GetFormatAttributeValueByTagId(e.Value, e.TagId, this.GetValueByTips));
