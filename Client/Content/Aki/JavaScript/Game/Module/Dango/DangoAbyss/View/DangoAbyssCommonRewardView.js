...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.DangoAbyssCommonRewardView = exports.DangoAbyssRewardViewData = void 0;
const UE = require("ue"),
...
class DangoAbyssCommonRewardView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.hT = 1, this.$8i = void 0, this.LoopScrollView = void 0, this.bc1 = void 0, this.Rc1 = void 0, this.Lc1 = [], this.AMo = () => {
      this.CloseMe()
    }, this.Z3e = () => {
      this.Lc1.forEach(t => {
        t.RefreshRedDot()
  ...
  async OnBeforeStartAsync() {
    this.bc1 = new TabItem, this.Rc1 = new TabItem, await this.bc1.CreateByActorAsync(this.GetItem(1).GetOwner()), await this.Rc1.CreateByActorAsync(this.GetItem(2).GetOwner()), this.Lc1.push(this.bc1), this.Lc1.push(this.Rc1)
  }
  OnStart() {
    this.$8i = this.OpenParam;
    var i = this.$8i.Data.GetRewardTypeTabList(2);
    0 < i.length && (this.hT = i[0]);
    for (let t = 0; t < i.length; t++) this.Lc1[t].SetActive(!0);
  ...
  AB_() {
    ...
    t.forEach(t => {
      var i = new TabData;
      i.TabId = t, i.CurrentSelectTabId = this.hT, i.ClickCallBack = this.l6c, i.ActivityData = this.$8i.Data, e.push(i)
    });
    for (let t = 0; t < i; t++) this.Lc1[t].Refresh(e[t], !1, t)
  }
  OnBeforeShow() {
    this.hT = 0 < this.$8i.Data.GetRewardTypeTabList(2).length ? this.$8i.Data.GetRewardTypeTabList(2)[0] : 1, this.Z3e(), this.AB_()
  }
}
exports.DangoAbyssCommonRewardView = DangoAbyssCommonRewardView;
class TabData {
  constructor() {
    this.ActivityData = void 0, this.CurrentSelectTabId = 0, this.TabId = 0, this.ClickCallBack = void 0
  }
}
class TabItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.$8i = void 0, this.kqe = () => {
  ...
  Refresh(t, i, e) {
    ...
    var s = ConfigManager_1.ConfigManager.DangoAbyssConfig.GetAbyssRewardTabById(t.TabId),
      s = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), s.Name), t.TabId === t.CurrentSelectTabId),
      t = s ? 1 : 0;
    this.GetExtendToggle(2).SetToggleState(t), this.RefreshRedDot()
  }
  RefreshRedDot() {
    var t;
    this.$8i && (t = this.$8i.ActivityData.GetTaskActivityRewardDataList(2, this.$8i.TabId).some(t => 1 === t.RewardState), this.GetItem(3).SetUIActive(t))
  }
}
