...
class AbyssButtonItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.l4e = void 0, this.ButtonCallBack = void 0, this.IUn = () => {
      this.ButtonCallBack?.()
    }
  }
  OnRegisterComponent() {
  ...
  BindRedDot(t, e = 0) {
    ...
    s && (this.UnBindRedDot(), this.l4e = t, this.l4e) && RedDotController_1.RedDotController.BindRedDot(t, s, void 0, e)
  }
  UnBindRedDot() {
    var t;
    this.l4e && (t = this.GetItem(2), RedDotController_1.RedDotController.UnBindGivenUi(this.l4e, t), this.l4e = void 0)
  }
}
