...
const UE = require("ue"),
  ...
  AbyssInstByInstId_1 = require("../../../../Core/Define/ConfigQuery/AbyssInstByInstId"),
...
class DangoAbyssConfig extends ConfigBase_1.ConfigBase {
  ...
  GetAbyssQualityByPluginItemId(e) {
    ...
    if (e) return e = e.QualityId, AbyssQualityById_1.configAbyssQualityById.GetConfig(e)
  }
  GetWorldInstanceId() {
  ...
  GetBadDangoTransform() {
    return new UE.Transform(this.zu1(), this.Ju1(), this.Zu1())
  }
  zu1() {
    var e = CommonParamById_1.configCommonParamById.GetFloatArrayConfig("BadDangoRotator"),
      r = new UE.Rotator;
    return 3 === e.length && (r.Roll = e[0], r.Pitch = e[1], r.Yaw = e[2]), r
  }
  Zu1() {
  ...
  GetItemBgDesc(e) {
    var e = this.GetDangoItemById(e),
      r = e.BgDescription;
    return "" === r ? "" : (e = 0 < e.LevelDescStrArray.length ? e.LevelDescStrArray[0].ArrayString : [], StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r), ...e))
  }
}
