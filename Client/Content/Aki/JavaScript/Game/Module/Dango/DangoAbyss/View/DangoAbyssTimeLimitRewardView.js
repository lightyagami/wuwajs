...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.DangoAbyssTimeLimitRewardView = exports.DangoAbyssTimeLimitViewData = void 0;
const UE = require("ue"),
...
class DangoAbyssTimeLimitRewardView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.hT = 1, this.$8i = void 0, this.LoopScrollView = void 0, this.TDe = void 0, this.YDo = () => {
  ...
  OnStart() {
    ...
    0 < e.length && (this.hT = e[0]), this.LoopScrollView = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(4), this.GetItem(5).GetOwner(), this.I2i), this.TDe = TimerSystem_1.TimerSystem.Forever(() => {
      this.sSt()
    }, 1e3)
  }
  sSt() {
    var e;
    this.$8i.Data.CheckInLimitTime() ? (e = this.$8i.Data.GetRemainTimeText(), this.GetText(1).SetText(e), this.GetText(1).SetUIActive(!0)) : this.GetText(1).SetUIActive(!1)
  }
  nt1() {
