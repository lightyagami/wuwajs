...
class DangoAbyssRoleAttributeItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e) {
    var r = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.Id),
      r = (this.SetTextureByPath(r.Icon, this.GetTexture(4)), this.GetText(0).ShowTextNew(r.Name), this.GetItem(2).SetUIActive(!1), this.GetText(3).SetUIActive(!1), ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.Id, e.BaseValue + e.AddValue, e.IsRatio));
