...
class AutoAttachItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.CurrentShowItemIndex = 0, this.DKe = 0, this.RKe = 0, this.SelectState = !1, this.UKe = !1, this.AKe = !1, this.SourceView = void 0, this.CurrentMoveDirection = void 0, this.AllData = void 0, this.DragState = !1, t && this.CreateThenShowByActor(t)
  }
  SetData(t) {
    this.AllData = t
  }
  ...
  SetSourceView(t) {
    this.SourceView = t, this.CurrentMoveDirection = this.SourceView.GetCurrentMoveDirection()
  }
  SetItemIndex(t) {
    this.DKe = t
  }
  ...
  InitItem() {
    this.RKe = this.SourceView.GetDataLength(), this.DKe < this.RKe ? this.CurrentShowItemIndex = this.DKe : this.CurrentShowItemIndex = this.DKe - this.SourceView.GetShowItemNum(), this.PKe()
  }
  PKe() {
    if (this.xKe(), this.SourceView) {
      ...
      let t = 0;
      t = this.SourceView.GetIfCircle() || 0 === this.CurrentMoveDirection ? (this.DKe - i) * (s + h) : (i - this.DKe) * (s + h), this.MoveItem(t)
    }
  }
  xKe() {
  ...
  MoveItem(t) {
    var i = this.CurrentShowItemIndex,
      t = this.wKe(t);
    this.CurrentShowItemIndex = t[1], 0 === this.CurrentMoveDirection ? this.RootItem.SetAnchorOffsetX(t[0]) : this.RootItem.SetAnchorOffsetY(t[0]), this.SourceView.GetIfCircle() || this.UKe || (t = 0 <= this.CurrentShowItemIndex && this.CurrentShowItemIndex < this.RKe || this.AKe, this.RootItem.SetUIActive(t)), i !== this.CurrentShowItemIndex && this.RefreshItem(), this.OnMoveItem()
  }
  ...
  bKe(t) {
    ...
    if (this.qKe(i)) {
      if (!this.GKe(i))
        for (; !this.GKe(i);) i += (h + e) * Math.ceil(r + 1), 0 === this.CurrentMoveDirection ? s += r + 1 : s -= r + 1
    } else
      for (; !this.qKe(i);) i -= (h + e) * Math.ceil(r + 1), 0 === this.CurrentMoveDirection ? s -= r + 1 : s += r + 1;
    return [i, s]
  }
  ...
  GetCurrentPosition() {
    return 0 === this.CurrentMoveDirection ? this.RootItem.GetAnchorOffsetX() : this.RootItem.GetAnchorOffsetY()
  }
  RefreshItem() {
    var t = this.AllData[this.CurrentShowItemIndex];
    this.UKe || void 0 !== t ? this.OnRefreshItem(t) : this.AKe && this.OnRefreshItem(void 0)
  }
  qKe(t) {
