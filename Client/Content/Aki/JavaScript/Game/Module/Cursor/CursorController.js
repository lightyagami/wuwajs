...
class CursorController extends UiControllerBase_1.UiControllerBase {
  ...
  static InitMouseByMousePos() {
    var o, r = UE.KuroStaticLibrary.GetSlateApplicationCursorPos();
    Log_1.Log.CheckInfo() && Log_1.Log.Info("UiCommon", 27, "InitMouseByMousePos", ["viewPortMousePosition.X", r.X], ["viewPortMousePosition.Y", r.Y]), (0 < r.X || 0 < r.Y) && (Log_1.Log.CheckInfo() && Log_1.Log.Info("UiCommon", 27, "Mouse在屏幕内"), o = UE.KuroStaticLibrary.GetGameViewPort(), UE.KuroStaticLibrary.DoGameViewPortMouseEnter(o, r.X, r.Y))
  }
  static SetWindowCursorStyle() {
    if (Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiCommon", 27, "SetWindowCursorStyle"), Info_1.Info.IsInKeyBoard()) {
      let o = "";
      ...
      var r = FNameUtil_1.FNameUtil.GetDynamicFName(o + "/CursorNor"),
        ...
        r = (UE.WidgetBlueprintLibrary.SetHardwareCursor(s, 1, r, l), UE.WidgetBlueprintLibrary.SetHardwareCursor(s, 16, e, l), UE.WidgetBlueprintLibrary.SetHardwareCursor(s, 15, t, l), `${UE.BlueprintPathsLibrary.ProjectContentDir()}/${o}/CursorNor.png`);
