...
class DreamLinkData extends ActivityData_1.ActivityBaseData {
  constructor() {
    super(...arguments), this.RoleInstanceList = [], this.RunTaskMap = new Map, this.MaxEnergy = 0, this.tcl = 0, this.icl = 0, this.TSl = [], this.Utl = new Map, this.rcl = new Map, this.ocl = new Map, this.ncl = new Map, this.scl = new Map, this.acl = new Map, this.DungeonProgressRecord = 0, this.SNe = (e, t) => {
  ...
  GetExDataRedPointShowState() {
    if (!this.IsDreamLinkFunctionUnlock(0)) return this.GetQuestRedDotState() || this.CheckHasLimitTimeReward() || this.CheckHasEnergyReward();
  ...
  ucl(e) {
    if (e) {
      this.MaxEnergy = e.oM_, this.RoleInstanceList = e.nM_, this.tcl = Number(MathUtils_1.MathUtils.LongToBigInt(e._M_)), this.icl = Number(MathUtils_1.MathUtils.LongToBigInt(e.cM_)), this.DungeonProgressRecord = e.dM_, this.ccl(e.pps), this.mcl(e.aM_), this.RefreshAllLimitTimeReward(e.hM_), this.TSl = e.mM_;
      for (const i of e.sM_) this.Poh(i);
      for (const r of Object.keys(e.lM_)) {
        var t = e.lM_[r];
        this.dcl(Number(r), t)
      }
      for (const n of e.uM_) this.dcl(n.r6n, void 0, n.K6n, n.CM_, Number(MathUtils_1.MathUtils.LongToBigInt(n.yzs))), this.Tml(n.r6n);
  ...
  RefreshRewardPerformance() {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.DreamLinkRewardRefresh), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id), UiManager_1.UiManager.IsViewOpen("ActivityRewardPopUpView") && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRewardPopUpView, this.GetBossRewardData())
  }
  RefreshLimitRewardPerformance() {
    this.IsLimitTimeRewardOn() && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshCommonActivityRedDot, this.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.DreamLinkLimitRewardRefresh))
  }
  GetLastUnFinishInst() {
    let t = 6;
  ...
  GetCurrentCatProgress() {
    ...
    return this.RoleInstanceList.forEach(e => {
  ...
  GetInstStage() {
    return this.GetFinishInstCount() >= DreamLinkDefine_1.CHANGE_STATE_FINISH_COUNT ? 1 : 0
  }
  GetDungeonToggleItemParams() {
    return this.GetFinishInstCount() >= DreamLinkDefine_1.CHANGE_STATE_FINISH_COUNT ? {
  ...
  CheckDungeonRedDotStateByInstId(e) {
    var t = ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 2, e, 0),
      ...
      e = e.K6n && !e.CM_;
    return (0 === t || TimeUtil_1.TimeUtil.GetServerTime() - t > CommonDefine_1.SECOND_PER_HOUR * CommonDefine_1.HOUR_PER_DAY * 3) && e
  }
  SaveDungeonRedDotStateByInstId(e) {
    var t = TimeUtil_1.TimeUtil.GetServerTime();
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, 2, e, 0, t), this.RefreshActivityRedDotState()
  }
  ...
  GetQuestRedDotState() {
    ...
    return 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 6, e, 0)
  }
  SaveQuestRedDotState() {
    var e;
    this.GetPreGuideQuestFinishState() || (e = this.GetUnFinishPreGuideQuestId(), ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, 6, e, 0, 1), this.RefreshActivityRedDotState())
  }
  SaveFirstCheckRedDotState(e, t = 0) {
    ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, e, t, 0, 1), this.RefreshActivityRedDotState()
  }
  _cl() {
    this.acl.clear();
    for (const i of this.GetActivityConfig().BossInstanceList) {
      var e = ConfigManager_1.ConfigManager.DreamLinkConfig.GetRogueBossInstanceConfig(i),
        t = e.InstanceId,
        e = new DreamLinkDefine_1.DreamLinkBossInstanceData(i, t, e.ConditionGroupId);
      this.acl.set(t, e)
    }
  }
  dcl(e, t, i, r, n) {
    e = this.acl.get(e);
    e && (void 0 !== t && (e.Score = t), void 0 !== i && (e.IsUnlock = i), void 0 !== r && (e.IsFinished = r), void 0 !== n) && (e.UnlockTime = n)
  }
  Tml(t) {
  ...
  FixBossRoleId(t) {
    ...
    for (let e = 0; e < i.length; e++) {
      var r = i[e];
      ModelManager_1.ModelManager.RoleModel.IsMainRole(r) && r !== ModelManager_1.ModelManager.RoleModel.GetCurSelectMainRoleId() && this.SetBossRoleId(t, e, 0)
    }
  }
  GetBossRoleId(e, t) {
  ...
  SetBossRoleId(e, t, i) {
    this.acl.get(e).SetBossRoleIdByIndex(t, i), ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, e, t, 0, i)
  }
  GetAllBossRoleId(e) {
  ...
  CheckAllBossInstRedDotState() {
    for (const e of this.acl.values())
      if (e.IsUnlock)
        if (0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 3, e.InstId, 0)) return !0;
    return !1
  }
  GetBossInstRedDotState(e) {
    return !!this.acl.get(e).IsUnlock && 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 3, e, 0)
  }
  SaveBossInstRedDotState(e) {
    this.acl.get(e).IsUnlock && (ModelManager_1.ModelManager.ActivityModel.SaveActivityData(this.Id, 3, e, 0, 1), this.RefreshActivityRedDotState())
  }
  SetRunTaskDone(e) {
  ...
  CheckHasRunRedDot() {
    for (const e of this.RunTaskMap.values()) switch (e.Status) {
      case 1:
        if (0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 1, e.Id, 0)) return !0;
        break;
      case 2:
        return !0
    }
  ...
  GetRunRedDotState(e) {
    ...
    switch (t.Status) {
      case 1:
        return 0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 1, t.Id, 0);
      case 2:
        return !0
    }
    return !1
  ...
  woh(e) {
    var t, i = ConfigManager_1.ConfigManager.DreamLinkConfig.GetWorldRunConfig(e);
    if (i) return (t = new DreamLinkDefine_1.DreamLinkRunTaskData(e)).ConditionGroupId = i.ConditionGroupId, t.TitleTextId = i.Title, t.RewardList = ConfigManager_1.ConfigManager.RewardConfig.GetDropPackagePreviewItemList(i.RewardId), t.MarkId = i.MarkId, this.RunTaskMap.set(e, t), t;
    Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 37, "[DreamLink] RunTask Config Error", ["Id", e])
  }
  Poh(e) {
    let t = this.RunTaskMap.get(e.c5n);
    if (t || (t = this.woh(e.c5n))) switch (t.PlayTime = e.dM_, t.UnlockTime = Number(MathUtils_1.MathUtils.LongToBigInt(e.yzs)), e.DS_) {
  ...
  hcl() {
    ...
    for (const r of this.GetActivityConfig().BossRewards) {
      var t = new DreamLinkDefine_1.DreamLinkRewardData(r),
        i = (t.Status = 1, ConfigManager_1.ConfigManager.DreamLinkConfig.GetBossRewardConfig(r));
      let e = this.ncl.get(i.InstanceType);
      e || (e = [], this.ncl.set(i.InstanceType, e)), e.push(t), this.ocl.set(r, t)
    }
  }
  mcl(t) {
    var i = this.GetActivityConfig();
  ...
  Ccl(e) {
    ...
    switch (e.Status) {
      case 1:
        ...
        break;
      case 0:
        i = 1, r = "Text_DaMaoZhan_Gain", s = !0, n = () => {
    ...
    return StringUtils_1.StringUtils.IsEmpty(r) || (r = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r) ?? ""), {
      Id: e.Id,
      NameText: "",
      NameTextId: t.Title,
  ...
  CheckHasBossReward() {
    if (0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 7, 0, 0)) return !0;
  ...
  RefreshAllLimitTimeReward(e) {
    for (const t of e) this.RefreshLimitTimeRewardData(t.v9n, DreamLinkDefine_1.signStateResolver[t.zps], t.tvs, t.fM_)
  }
  RefreshLimitTimeRewardData(t, e, i, r) {
    ...
    void 0 !== i && (n.Current = i), void 0 !== r && (n.Target = r), n.Status = e
  }
  GetLimitTimeEndTime() {
    return this.icl
  }
  ...
  CheckHasLimitTimeReward() {
    if (this.IsLimitTimeRewardOn()) {
      if (0 === ModelManager_1.ModelManager.ActivityModel.GetActivityCacheData(this.Id, 0, 4, 0, 0)) return !0;
