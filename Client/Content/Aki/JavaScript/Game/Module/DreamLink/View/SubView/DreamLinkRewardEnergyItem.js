...
class DreamLinkRewardEnergyItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, r, i) {
    this.Data = e;
    var t, s, n = ConfigManager_1.ConfigManager.DreamLinkConfig.GetEnergyRewardConfig(e.Id);
    n && (t = 1 === e.Status, s = 2 === e.Status, e = 0 === e.Status, this.jqe(n.DropId, s), this.GetText(3).SetText(n.NeedEnergy.toString()), this.GetText(7).SetUIActive(t), this.GetItem(2).SetUIActive(s), this.GetButton(1).RootUIComp.SetUIActive(e))
  }
  jqe(e, r) {
    var i = [];
