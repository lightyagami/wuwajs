...
class DreamLinkRoleSelectPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RoleItemList = [], this.Lth = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let e = 0; e < 3; e++) {
      ...
      r.Index = e, r.RefreshHandle = this.Lth, this.RoleItemList.push(r), i.push(r.CreateThenShowByActorAsync(this.GetItem(0 + e).GetOwner()))
    }
    await Promise.all(i)
  }
  RefreshInstId(e) {
...
class DreamLinkRoleItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.ActivityBaseData = e, this.Index = 0, this.InstId = 0, this.RefreshHandle = void 0, this.Ath = () => {
      ...
      if (t) {
        ...
        if (t) {
          var i, r = [],
            s = ConfigManager_1.ConfigManager.DreamLinkConfig?.GetRoleConfigList() ?? [];
          for (const n of t.TrialRole) {
            var a = ConfigManager_1.ConfigManager.RoleConfig?.GetTrialRoleConfigByGroupId(n),
              a = ModelManager_1.ModelManager.RoleModel?.GetRoleDataById(a.Id);
            a && r.push(a)
          }
          let e = !1;
          for (const o of s) !o.IsShowInTeamView || !(i = ModelManager_1.ModelManager.RoleModel?.GetRoleInstanceById(o.Id)) || ModelManager_1.ModelManager.RoleModel?.IsMainRole(o.Id) && e || (ModelManager_1.ModelManager.RoleModel?.IsMainRole(o.Id) && (e = !0), r.push(i));
          r.sort((e, t) => e.IsTrialRole() ? 1 : -1);
          t = new TeamRoleSelectView_1.TeamRoleSelectViewData(5, this.RoleId, r, t => {
            if (this.RoleId === t) this.ActivityBaseData.SetBossRoleId(this.InstId, this.Index, 0);
            else {
              var i = this.RoleId,
          ...
          t.FormationRoleList = this.ActivityBaseData.GetAllBossRoleId(this.InstId), t.IsNeedRevive = this.E4t, t.GetConfirmButtonTextCallBack = this.Q4t, t.GetConfirmButtonEnableCallBack = this.v4t, t.CanJoinTeam = this.v4t, t.BackCallBack = this.y5t, RoleController_1.RoleController.OpenTeamRoleSelectView(t)
        }
      }
    }, this.y5t = () => {
      var t = this.ActivityBaseData.GetAllBossRoleId(this.InstId);
      for (let e = 0; e < t.length; e++)(ModelManager_1.ModelManager.RoleModel?.GetRoleDataById(t[e]))?.IsTrialRole() || ModelManager_1.ModelManager.RoleModel?.GetRoleInstanceById(t[e]) || (this.ActivityBaseData.SetBossRoleId(this.InstId, e, 0), this.RefreshHandle?.())
    }, this.E4t = e => {
      ...
      if (t !== this.RoleId) {
        ...
        if (ModelManager_1.ModelManager.EditFormationModel.IsRoleDead(t) && !i?.IsTrialRole()) return !1;
        if (void 0 === e.find(e => e.Id === t && e.IsShowInTeamView) && !i?.IsTrialRole()) return !1;
        for (let e = 0; e < 3; e++) {
      ...
      if (e) return 0 === this.RoleId ? "JoinText" : this.RoleId === e ? "GoDownText" : "ChangeText"
    }
  }
  get RoleId() {
  ...
  Refresh() {
    var e = this.RoleId,
      t = 0 === e;
    this.GetTexture(1).SetUIActive(!t), this.GetItem(3).SetUIActive(!t), this.GetItem(2).SetUIActive(t), t || (t = ModelManager_1.ModelManager.RoleModel?.GetRoleDataById(e)) && (t.IsTrialRole() ? (t = ConfigManager_1.ConfigManager.RoleConfig?.GetTrialRoleConfig(e)) && (t = ConfigManager_1.ConfigManager.RoleConfig?.GetRoleConfig(t.ParentId)) && this.SetTextureByPath(t.RoleHeadIcon, this.GetTexture(1)) : (t = ConfigManager_1.ConfigManager.RoleConfig?.GetRoleConfig(e)) && this.SetTextureByPath(t.RoleHeadIcon, this.GetTexture(1)))
  }
}
