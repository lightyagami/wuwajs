...
class DreamLinkWorldRunTaskItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Data = void 0, this.bOe = void 0, this.j0l = void 0, this._fe = !1, this.W2e = () => {
      return new ActivitySmallItemGrid_1.ActivitySmallItemGrid
    }, this.IOe = () => {
      DreamLinkController_1.DreamLinkController.GetCurrentActivityData()?.SaveFirstCheckRedDotState(1, this.Data.Id), this.BNe(), this.Data.JumpDelegate()
    }, this.qOe = () => {
  ...
  OnStart() {
    this.bOe = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(6), this.W2e), this.GetItem(2).SetUIActive(!1), this.j0l = new ButtonItem_1.ButtonItem(this.GetItem(0)), this.j0l.SetFunction(this.IOe)
  }
  Refresh(t, i, e) {
    this.Data = t, LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), t.TitleTextId), this.bOe.RefreshByData(t.GetRewardData());
    var r = 0 === t.Status,
      s = 1 === t.Status,
      h = 3 === t.Status,
      o = 2 === t.Status;
    this.GetItem(4).SetUIActive(r), r && this.GetText(5).SetText(t.GetLockTxt()), this.GetItem(8).SetUIActive(h || o), (h || o) && this.GetText(9).SetText(TimeUtil_1.TimeUtil.GetTimeString(Math.max(t.PlayTime, 0))), s ? this.j0l.SetLocalTextNew("WorldRun_Button_State1") : h && this.j0l.SetLocalTextNew("WorldRun_Button_State2"), this._fe = t.IsTimeLock(), this.j0l.SetActive(s || h), this.GetButton(1).RootUIComp.SetUIActive(o), this.BNe()
  }
  RefreshLockText() {
    this.Data && 0 === this.Data.Status && this._fe && this.GetText(5).SetText(this.Data.GetLockTxt())
  }
  BNe() {
