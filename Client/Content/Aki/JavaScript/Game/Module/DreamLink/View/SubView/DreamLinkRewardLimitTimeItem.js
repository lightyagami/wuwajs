...
class DreamLinkRewardLimitTimeItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Data = void 0, this.RewardScrollView = void 0, this.W2e = () => {
  ...
  OnStart() {
    this.RewardScrollView = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(6), this.W2e), this.GetButton(0).RootUIComp.SetUIActive(!1), this.GetItem(4).SetUIActive(!1)
  }
  Refresh(i, e, t) {
    this.Data = i;
    var r, s, n, a = ConfigManager_1.ConfigManager.DreamLinkConfig.GetLimitTimeRewardConfig(i.Id);
    a && (n = 1 === i.Status, r = 2 === i.Status, s = 0 === i.Status, this.jqe(a.TargetReward, r), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(3), a.TargetName), this.GetText(7).SetUIActive(n), this.GetItem(2).SetUIActive(r), this.GetButton(1).RootUIComp.SetUIActive(s), a = i.Current, n = i.Target, this.GetText(8).SetText(Math.min(a, n) + "/" + n))
  }
  jqe(i, e) {
    var t = [];
