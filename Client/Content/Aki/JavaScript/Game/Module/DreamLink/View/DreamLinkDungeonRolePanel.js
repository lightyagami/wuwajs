...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.DreamLinkRoleInstanceItem = exports.DreamLinkRoleInstancePanel = void 0;
const UE = require("ue"),
...
class DreamLinkRoleInstancePanel extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    ...
    for (let e = 0; e < 3; e++) {
      ...
      this.eeh.push(i), i.Index = e, i.RefreshHandler = e => {
  ...
  Refresh(t, i) {
    for (let e = 0; e < this.eeh.length; e++) e < t.length && this.eeh[e].Refresh(t[e], e === i)
  }
  ...
  SetSelectItem(t) {
    for (let e = 0; e < this.eeh.length; e++) e !== t && this.eeh[e].SetToggleState(!1)
  }
}
...
class DreamLinkRoleInstanceItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.Pe = void 0, this.RefreshHandler = e => {}, this.Index = 0, this.Bke = e => {
      1 === e && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSelectRoleDreamDungeon, this.Pe.r6n), this.RefreshHandler(this.Index)
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  OnStart() {
    this.GetExtendToggle(0).OnStateChange.Add(e => {
      1 === e && (e = DreamLinkController_1.DreamLinkController.GetCurrentActivityData()) && (e.SaveDungeonRedDotStateByInstId(this.Pe.r6n), this.GetItem(4).SetUIActive(!1))
    })
  }
  Refresh(e, t) {
    this.Pe = e;
    ...
    var s = this.GetExtendToggle(0),
      s = (s.CanExecuteChange.Unbind(), s.SetToggleState(0, !1), s.SetToggleState(t ? 1 : 0, !0), s.CanExecuteChange.Bind(() => {
        var e;
        return !!this.Pe?.K6n || ((e = RogueWhiteCatInstById_1.configRogueWhiteCatInstById.GetConfig(i.GetRoleInstDataIndex(this.Pe.r6n) + 1)) && (e = ConfigManager_1.ConfigManager.ConditionConfig?.GetConditionGroupConfig(e.ConditionGroupId), StringUtils_1.StringUtils.IsBlank(e.HintText) || ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId(e.HintText)), !1)
      }), t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSelectRoleDreamDungeon, this.Pe.r6n), i?.GetDungeonToggleItemParams()),
      t = ConfigManager_1.ConfigManager.DreamLinkConfig?.GetDreamLinkRoleDungeonConfig(e.r6n),
      n = ConfigManager_1.ConfigManager.RoleConfig?.GetRoleConfig(t.RoleId),
      s = (this.SetTextureByPath(n.RoleHeadIconCircle, this.GetTexture(2)), this.SetSpriteByPath(t.IndexTexturePath, this.GetSprite(7), !1), s && (this.SetTextureByPath(s.TextureBgPath, this.GetTexture(8)), this.SetTextureByPath(s.TextureLightPath, this.GetTexture(9)), n = UE.Color.FromHex(s.EffectColor), t = new UE.LinearColor(n), this.GetUiNiagara(6).SetNiagaraVarLinearColor("Color", t)), this.GetTexture(2)),
      n = this.GetSprite(1),
      t = (e.K6n ? (s.SetIsGray(!1), s.SetColor(UE.Color.FromHex("#ffffff")), s.SetUIActive(!0), n.SetUIActive(!1)) : (s.SetIsGray(!0), s.SetColor(UE.Color.FromHex("8F7FD999")), s.SetUIActive(!1), n.SetUIActive(!0)), 0 === i.GetInstStage());
    t ? this.GetTexture(2).SetChangeColor(e.CM_, UE.Color.FromHex("738ec6ff")) : this.GetTexture(2).SetChangeColor(e.CM_, UE.Color.FromHex("9A7F8EFF")), this.GetItem(3).SetUIActive(!e.K6n), this.GetItem(5).SetUIActive(e.CM_), this.GetItem(4).SetUIActive(i.CheckDungeonRedDotStateByInstId(e.r6n))
  }
  SetToggleState(e) {
