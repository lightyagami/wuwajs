...
class DreamLinkRewardViewEnergy extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.boh = void 0, this.Otl = void 0, this.qoh = void 0, this.VOe = () => {
  ...
  async OnBeforeStartAsync() {
    var e = [];
    this.Otl = new PopupCaptionItem_1.PopupCaptionItem, e.push(this.Otl.CreateThenShowByActorAsync(this.GetItem(1).GetOwner())), this.Otl.SetCloseCallBack(() => {
      this.CloseMe()
    }), this.qoh = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(0), this.VOe), await Promise.all(e)
  }
  OnStart() {
