...
class DreamLinkController extends ActivityControllerBase_1.ActivityControllerBase {
  ...
  OnRegisterNetEvent() {
    Net_1.Net.Register(20929, this.ZZa);
    Net_1.Net.Register(23738, this.ecl);
    Net_1.Net.Register(24109, this.V0l);
    Net_1.Net.Register(21153, this.OEl);
  }
  OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(20929);
    Net_1.Net.UnRegister(23738);
    Net_1.Net.UnRegister(24109);
    Net_1.Net.UnRegister(21153);
  }
  ...
  static RoguelikeSetDungeonProgressRequest(r) {
    ...
    Net_1.Net.Call(20875, e, e => {
      if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 20875);
      } else {
  ...
  static RoguelikeRoleInstStartRequest(e) {
    ...
    if (RoleController_1.RoleController.IsInRoleTrial()) {
      ...
      t.w6n = r.Id;
      Net_1.Net.Call(21436, t, e => {
        if (e) {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 21436);
          }
  ...
  static RunTaskRewardRequest(r) {
    ...
    if (t) {
      ...
      e.w6n = t.Id;
      Net_1.Net.Call(15167, e, e => {
        if (e) {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 15167);
          } else {
            t.SetRunTaskDone(r);
  ...
  static MultiEnergyRewardRequest(r) {
    ...
    if (t) {
      ...
      e.w6n = t.Id;
      Net_1.Net.Call(25772, e, e => {
        if (e) {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 25772);
          } else {
            r.forEach(e => {
  ...
  static LimitTimeRewardRequest(r) {
    ...
    if (t) {
      ...
      Net_1.Net.Call(24061, e, e => {
        if (e) {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 24061);
          } else {
  ...
  static BossRewardRequest(r) {
    ...
    if (t) {
      ...
      e.w6n = t.Id;
      Net_1.Net.Call(27188, e, e => {
        if (e) {
          if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
            ErrorCodeController_1.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 27188);
          } else {
