...
class FunctionItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.FunctionId = 0, this.l4e = void 0, this.ije = () => {
      this.FunctionId && FunctionController_1.FunctionController.OpenFunctionRelateView(this.FunctionId)
  ...
  UpdateItem(e) {
    ...
    var t = ConfigManager_1.ConfigManager.FunctionConfig.GetFunctionConfig(e),
      e = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), t.FunctionName), ModelManager_1.ModelManager.FunctionModel.IsOpen(e));
  ...
  K8e() {
    var e;
    this.FunctionId && (this.l4e = ModelManager_1.ModelManager.FunctionModel.GetFunctionItemRedDotName(this.FunctionId), e = this.GetItem(4), this.l4e ? RedDotController_1.RedDotController.BindRedDot(this.l4e, e) : e.SetUIActive(!1))
  }
  Ovt() {
    var e;
    this.l4e && (e = this.GetItem(4), RedDotController_1.RedDotController.UnBindGivenUi(this.l4e, e), this.l4e = void 0)
  }
  OnBeforeDestroy() {
    this.Ovt();
