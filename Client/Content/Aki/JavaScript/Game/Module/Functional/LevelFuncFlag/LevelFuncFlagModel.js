...
class LevelFuncFlagModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    for (var [e, n] of LevelFuncFlagDefine_1.levelFuncFlagDefaultVal) this.BRe.set(e, n);
    for (var [t, r] of this.BRe) EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnLevelFuncFlagSet, t, r);
    return !0
  }
  OnClear() {
  ...
  SetFuncFlagEnable(e, n) {
    this.BRe.get(e) !== n && (this.BRe.set(e, n), Log_1.Log.CheckInfo() && Log_1.Log.Info("Functional", 39, "关卡功能标记更新", ["funcFlagId", e], ["enable", n]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnLevelFuncFlagChanged, e, n))
  }
