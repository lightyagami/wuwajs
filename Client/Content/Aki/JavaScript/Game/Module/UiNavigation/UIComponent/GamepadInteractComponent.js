...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.GamepadWheelComponent = exports.GamepadCheckComponent = exports.GamepadMoveRightComponent = exports.GamepadMoveForwardComponent = void 0;
...
class GamepadInteractComponentBase extends HotKeyComponent_1.HotKeyComponent {
  OnRefreshSelfHotKeyState(e) {
    e.HasGamepadControlMouse() ? (e = e.MainPanel?.GamepadMouseItem?.IsUIActiveInHierarchy() ?? !1, this.SetVisibleMode(2, e)) : this.SetVisibleMode(2, !1)
  }
}
...
class GamepadCheckComponent extends GamepadInteractComponentBase {
  OnPress(e) {
    UiNavigationNewController_1.UiNavigationNewController.SimulationPointerTrigger(!0)
  }
  OnRelease(e) {
    UiNavigationNewController_1.UiNavigationNewController.SimulationPointerTrigger(!1)
  }
}
exports.GamepadCheckComponent = GamepadCheckComponent;
const WHEEL_SPEED_SCALE = .4;
class GamepadWheelComponent extends GamepadInteractComponentBase {
  ...
  OnInputAxis(e, t) {
    ...
    this.BQ_ === t && 0 == t || (this.BQ_ = t, LguiEventSystemManager_1.LguiEventSystemManager.InputWheelAxisByGamepad(t))
  }
}
