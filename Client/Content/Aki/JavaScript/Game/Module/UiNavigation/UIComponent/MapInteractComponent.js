...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.MapFocusPlayerComponent = exports.MapCheckComponent = exports.MapZoomComponent = exports.MapMoveRightComponent = exports.MapMoveForwardComponent = void 0;
...
class MapInteractComponentBase extends HotKeyComponent_1.HotKeyComponent {
  OnRefreshSelfHotKeyState(e) {
    var t, n = this.GetBindButtonTag();
    n && (e = e.GetFocusListener()) && (t = e.GetNavigationGroup(), !StringUtils_1.StringUtils.IsEmpty(t.GroupName)) && e.TagArray?.Contains(n) ? this.SetVisibleMode(2, !0) : this.SetVisibleMode(2, !1)
  }
}
class MapMoveForwardComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnRefreshSelfHotKeyState(e) {
    ...
    e && (e = e.GetNavigationGroup(), StringUtils_1.StringUtils.IsEmpty(e.GroupName) || "GroupCursor" !== e.GroupName) ? this.SetVisibleMode(2, !1) : this.SetVisibleMode(2, !0)
  }
  OnInputAxis(e, t) {
    var n = ModelManager_1.ModelManager.WorldMapModel.WorldMapAxisInteractValidation;
    n.InputAxis(e, t), n.IsInValid || EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.NavigationTriggerMapForward, t)
  }
}
...
class MapMoveRightComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnInputAxis(e, t) {
    var n = ModelManager_1.ModelManager.WorldMapModel.WorldMapAxisInteractValidation;
    n.InputAxis(e, t), n.IsInValid || EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.NavigationTriggerMapRight, t)
  }
}
