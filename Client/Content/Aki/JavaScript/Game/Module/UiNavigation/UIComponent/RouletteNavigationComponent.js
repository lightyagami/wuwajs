...
class RouletteNavigationComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnPress() {
    this.Nxo = UiNavigationNewController_1.UiNavigationNewController.GetCurrentNavigationFocusListener(), this.Rqo = UiNavigationNewController_1.UiNavigationNewController.Interact(!0)
  }
  OnRelease(e) {
    ...
    this.Nxo === o && this.Rqo && t && UiNavigationNewController_1.UiNavigationNewController.JumpNavigationGroup(5)
  }
  OnRefreshSelfHotKeyState(e) {
    e = e.GetFocusListener();
    void 0 !== e && "Group1" === e.GroupName ? this.SetVisibleMode(2, !0) : this.SetVisibleMode(2, !1)
  }
}
