...
class WorldMapShowOnlyComponent extends HotKeyComponent_1.HotKeyComponent {
  OnRefreshSelfHotKeyState(n) {
    ActivityMowingRiskController_1.ActivityMowingRiskController.Instance.CheckInInstanceDungeon() || InstanceDungeonEntranceController_1.InstanceDungeonEntranceController.CheckInstanceShieldView("WorldMapView") ? this.SetVisibleMode(2, !1) : this.SetVisibleMode(2, !0)
  }
