...
class ShipTowerSwitchRightTeamComponent extends HotKeyComponent_1.HotKeyComponent {
  OnPress(e) {
    var r = this.oZ_();
    r && ControllerHolder_1.ControllerHolder.UiNavigationNewController.InteractClickByListener(r)
  }
  oZ_() {
  ...
  OnRefreshSelfHotKeyState(e) {
    ...
    StringUtils_1.StringUtils.IsEmpty(r) || (r = ModelManager_1.ModelManager.ShipTowerModel.IsShowLeftTeamPanel, this.SetVisibleMode(2, r))
  }
}
