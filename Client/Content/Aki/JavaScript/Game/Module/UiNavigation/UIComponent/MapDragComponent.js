...
class MapDragForwardComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnInputAxis(e, t) {
    0 !== t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapDragMoveForward, t)
  }
}
...
class MapDragRightComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnInputAxis(e, t) {
    0 !== t && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.MapDragMoveRight, t)
  }
}
