...
class RewardTakeComponent extends HotKeyComponent_1.HotKeyComponent {
  ...
  OnPress(e) {
    var t;
    this.Nxo && (t = this.Nxo.GetBehaviorComponent().RootUIComp, UiNavigationNewController_1.UiNavigationNewController.SimulateClickItem(t))
  }
    ...
    if (t) {
      ...
      if (o <= 0) this.SetVisibleMode(2, !1);
        ...
        if (this.N5_ <= 0) {
          ...
          var r, i, e = e.GetActiveListenerListByTag(t);
