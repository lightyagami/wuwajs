...
class BagTagNavigationNextComponent extends NavigationGroupComponent_1.NavigationGroupNextComponent {
  OnRefreshSelfHotKeyState(e) {
    ...
    if (i) {
      ...
      let t = void 0;
      t = o ? i.GroupNameMap.Get(o) : i.NextGroupName, !StringUtils_1.StringUtils.IsEmpty(t) && (o = e.GetNavigationGroupByName(i.NextGroupName)) ? (e = o.DefaultListener, this.SetVisibleMode(2, e?.IsScrollOrLayoutActive() ?? !1)) : this.SetVisibleMode(2, !1)
