...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PlotNextPageComponent = exports.PlotZoomComponent = exports.PlotMoveRightComponent = exports.PlotMoveForwardComponent = void 0;
...
class PlotInteractComponentBase extends HotKeyComponent_1.HotKeyComponent {
  constructor() {
    super(...arguments), this.Nxo = void 0, this.i8a = e => {
  ...
  OnRefreshSelfHotKeyState(e) {
    ...
    StringUtils_1.StringUtils.IsEmpty(t) || (e = e.GetActiveListenerByTag(t), this.Nxo = e, t = this.Nxo?.IsListenerActive() ?? !1, e = ModelManager_1.ModelManager.PlotModel.CanControlView && this.CheckAxisCanInput() && this.t_h(), this.SetVisibleMode(2, t && e))
  }
  t_h() {
...
class PlotNextPageComponent extends HotKeyComponent_1.HotKeyComponent {
  constructor() {
    super(...arguments), this.Nxo = void 0, this.Y5a = e => {
  ...
  OnRefreshSelfHotKeyState(e) {
    var t = this.GetBindButtonTag();
    StringUtils_1.StringUtils.IsEmpty(t) || (e = e.GetActiveListenerByTag(t), this.Nxo = e, t = this.Nxo?.IsListenerActive() ?? !1, e = ModelManager_1.ModelManager.PlotModel?.CanClick ?? !1, this.SetVisibleMode(2, t && e))
  }
}
