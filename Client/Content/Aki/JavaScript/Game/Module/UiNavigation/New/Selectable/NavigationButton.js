...
class NavigationButton extends NavigationSelectableBase_1.NavigationSelectableBase {
  constructor() {
    super(...arguments), this.lBo = void 0, this.ije = () => {
      this.OnButtonClick()
    }
  }
  OnInit() {
  ...
  _Bo() {
    var t, i;
    this.NeedAddButtonClick() && (t = this.Selectable, i = (0, puerts_1.toManualReleaseDelegate)(this.ije), this.lBo = t.RegisterClickEvent(i))
  }
  uBo() {
    this.lBo && (this.Selectable.UnregisterClickEvent(this.lBo), (0, puerts_1.releaseManualReleaseDelegate)(this.ije), this.lBo = void 0)
  }
  OnButtonClick() {}
  NeedAddButtonClick() {
  ...
  OnHandlePointerSelect(t) {
    this.Listener.ScrollView && this.Listener.ScrollView.ScrollToSelectableComponent(this.Selectable);
