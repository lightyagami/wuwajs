...
class SpecialPanelHandleBase {
  constructor(t) {
    this.DefaultNavigationListener = [], this.hBo = new Set, this.Npo = new Map, this.E9 = "Default", this.E9 = t
  }
  SetNavigationGroupDefaultListener(t) {
    var e = this.GetNavigationGroup(t.GroupName);
    e ? e.DefaultListener || (e.DefaultListener = t) : Log_1.Log.CheckError() && Log_1.Log.Error("UiNavigation", 10, "找不到导航组信息", ["导航组名字", t.GroupName], ["导航监听对象", t.RootUIComp.displayName])
  }
  ...
  ReplaceDefaultNavigationListener(t, e) {
    this.DefaultNavigationListener.length <= e ? this.DefaultNavigationListener.push(t) : this.DefaultNavigationListener[e] = t, this.SetNavigationGroupDefaultListener(t)
  }
  ...
  ResetGroupConfigMemory() {
    for (const t of this.Npo.values()) t.SelectableMemory && (t.LastSelectListener = void 0)
  }
