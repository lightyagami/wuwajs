...
class NavigationVisionReplaceSortTabToggle extends NavigationToggle_1.NavigationToggle {
  OnToggleClick() {
    var o = this.PanelHandle,
      e = UiNavigationNewController_1.UiNavigationNewController.GetCurrentNavigationFocusListener();
    e && o && e.GroupName === o.ChangeListenerList[0].GroupName && (o.IsFindChangeListenerList = !0, UiNavigationNewController_1.UiNavigationNewController.MarkViewHandleRefreshNavigationDirty())
  }
}
