...
class NavigationRoleResonanceLockToggle extends NavigationToggle_1.NavigationToggle {
  OnStart() {
    var i = this.Selectable,
      t = this.PanelHandle;
    t.AddLockNavigationListener(this.Listener), StringUtils_1.StringUtils.IsBlank(t.GroupName) || (i.bToggleOnSelect = !0, t.SetDefaultNavigationListener(this.Listener), UiNavigationNewController_1.UiNavigationNewController.MarkViewHandleRefreshNavigationDirty())
  }
  OnToggleClick() {
