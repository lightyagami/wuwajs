...
class NavigationRoleSkillTreeToggle extends NavigationToggle_1.NavigationToggle {
  constructor() {
    super(...arguments), this.EBo = !1, this.SBo = () => {
      var e = this.Selectable;
      1 === e.GetToggleState() && (this.EBo = !0), e.bToggleOnSelect = !1
    }
  }
  OnInit() {
    super.OnInit(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.SelectRoleTabOutside, this.SBo)
  }
  OnClear() {
    super.OnClear(), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.SelectRoleTabOutside, this.SBo)
  }
  OnToggleClick() {
    var e = this.PanelHandle;
    StringUtils_1.StringUtils.IsBlank(e.GroupName) && e.SetToggleSelectByGroupName(this.Listener.GroupName)
  }
