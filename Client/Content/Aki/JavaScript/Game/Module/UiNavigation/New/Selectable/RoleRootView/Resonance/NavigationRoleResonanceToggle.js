...
class NavigationRoleResonanceToggle extends NavigationToggle_1.NavigationToggle {
  OnStart() {
    var i = this.Selectable,
      t = this.PanelHandle;
    t.AddUnLockNavigationListener(this.Listener), StringUtils_1.StringUtils.IsBlank(t.GroupName) || (i.bToggleOnSelect = !0, t.SetDefaultNavigationListener(this.Listener), UiNavigationNewController_1.UiNavigationNewController.MarkViewHandleRefreshNavigationDirty())
  }
  OnToggleClick() {
    var i = this.PanelHandle;
    i.SetDefaultNavigationListener(this.Listener), StringUtils_1.StringUtils.IsBlank(i.GroupName) && i.SetToggleSelectByGroupName(this.Listener.GroupName)
  }
}
