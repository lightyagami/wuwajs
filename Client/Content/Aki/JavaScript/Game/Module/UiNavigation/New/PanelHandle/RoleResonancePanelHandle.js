...
class RoleResonancePanelHandle extends SpecialPanelHandleBase_1.SpecialPanelHandleBase {
  constructor() {
    super(...arguments), this.GroupName = "", this.sBo = void 0, this.Goh = [], this.koh = !1, this.Noh = [], this.Foh = !1
  }
  get Voh() {
    return this.koh && (this.koh = !1, this.Goh.sort((t, e) => {
      t = t.IsValid() ? t.RootUIComp.flattenHierarchyIndex : 0, e = e.IsValid() ? e.RootUIComp.flattenHierarchyIndex : 0;
      return t === e || t < e ? -1 : 1
    })), this.Goh
  }
  get Hoh() {
    return this.Foh && (this.Foh = !1, this.Noh.sort((t, e) => {
      t = t.IsValid() ? t.RootUIComp.flattenHierarchyIndex : 0, e = e.IsValid() ? e.RootUIComp.flattenHierarchyIndex : 0;
      return t === e || t < e ? -1 : 1
    })), this.Noh
  }
  ...
  SetToggleSelectByGroupName(t) {
    ...
    if (i) {
      this.GroupName = t;
      for (let t = 0, e = i.ListenerList.length; t < e; ++t) i.ListenerList[t].GetBehaviorComponent().bToggleOnSelect = !0
    }
  }
  ResetToggleSelect() {
    ...
    if (i) {
      this.GroupName = "";
      for (let t = 0, e = i.ListenerList.length; t < e; ++t) i.ListenerList[t].GetBehaviorComponent().bToggleOnSelect = !1
    }
  }
