...
class UiNavigationModeModule {
  constructor(i) {
    this.Nxo = void 0, this.PBo = MathUtils_1.MathUtils.SmallNumber, this.Nxo = i, this.PBo = i.NavigateTolerance
  }
  xBo(i, t, e) {
  ...
  wBo(i, t) {
    return Math.abs(i - t) < MathUtils_1.MathUtils.KindaSmallNumber && (UiNavigationModeModule.BBo.X < 0 || 0 < UiNavigationModeModule.BBo.Z) || t - i >= MathUtils_1.MathUtils.KindaSmallNumber
  }
  kRc(i, t) {
  ...
  bBo(e, i, a, o) {
    ...
    for (let i = 0, t = e.length; i < t; ++i) {
      ...
      if (g.GetNavigationComponent().CheckFindOpposite(this.Nxo) && !this.kRc(g, a)) {
        ...
        var c = U.Size(),
          f = (N.DeepCopy(U), N.Normalize(), Vector_1.Vector.DotProduct(UiNavigationModeModule.BBo, N));
        if (!MathUtils_1.MathUtils.IsNearlyEqual(f, 0, MathUtils_1.MathUtils.KindaSmallNumber)) {
          var p, R, m = o ? Math.abs(U.Z) : Math.abs(U.X);
          if (0 < f) {
            var E = MathUtils_1.MathUtils.IsNearlyEqual(f, 1, this.PBo),
              C = MathUtils_1.MathUtils.IsNearlyEqual(s, 1, this.PBo);
            let i = !1,
              t = !1;
            switch (a) {
              case 1:
              ...
              case 0:
              case 4:
                (t = this.xBo(U, o, g)) && M ? MathUtils_1.MathUtils.IsNearlyEqual(m, n, 1) ? this.wBo(c, h) && (i = !0) : m < n && (i = !0) : this.wBo(c, h) && (i = !0);
                break;
              case 2:
                E ? (!C || c < h) && (i = !0) : !C && c < h && (i = !0);
                break;
              case 3:
                E && (!C || f > s) && (i = !0)
            }
            i && (s = f, h = c, v = g, n = m, M = t)
          } else {
            let i = !1;
            4 === a ? MathUtils_1.MathUtils.IsNearlyEqual(m, u, 1) ? c < l && (i = !0) : m > u && (i = !0) : (R = MathUtils_1.MathUtils.IsNearlyEqual(f, -1, MathUtils_1.MathUtils.KindaSmallNumber), p = MathUtils_1.MathUtils.IsNearlyEqual(d, -1, MathUtils_1.MathUtils.KindaSmallNumber), R ? (!p || c > l) && (i = !0) : !p && (!(R = MathUtils_1.MathUtils.IsNearlyEqual(f, d)) && f < d || R && c > l) && (i = !0)), i && (d = f, u = m, l = c, _ = g)
          }
        }
      }
    }
    return MathUtils_1.MathUtils.IsNearlyEqual(s, 0) ? !this.Nxo.HasDynamicScrollView() && 1 === i && this.nvc(_) ? _?.GetSelectableComponent() : void 0 : v?.GetSelectableComponent()
  }
  nvc(i) {
    var t, e, a;
  ...
  GBo(i, t, e) {
    ...
    var o;
    return a || (o = this.Nxo.GetNavigationGroup().GetOppositeListenerListByListener(this.Nxo), a = this.bBo(o, i, t, e)), !a && this.Nxo.HasDynamicScrollView() && this.nNn(this.Nxo, e), a
  }
  nNn(i, t) {
    i = i.ScrollView;
    i.Vertical === t && (t ? (t = UiNavigationModeModule.BBo.Z < 0, i.ScrollItemIndex(!t)) : (t = 0 < UiNavigationModeModule.BBo.X, i.ScrollItemIndex(!t)), ModelManager_1.ModelManager.UiNavigationModel?.RepeatMove())
  }
  NBo() {
  ...
  kBo(i) {
    if (Math.abs(UiNavigationModeModule.BBo.X) >= Math.abs(UiNavigationModeModule.BBo.Z)) switch (i.HorizontalWrapMode) {
      case 2:
        return 0 < UiNavigationModeModule.BBo.X ? this.NBo() : this.OBo();
      case 0:
      case 1:
        return UiNavigationModeModule.BBo.Set(Math.sign(UiNavigationModeModule.BBo.X), 0, 0), this.GBo(i.HorizontalWrapMode, i.HorizontalPriorityMode, !1);
      default:
        return
    } else switch (i.VerticalWrapMode) {
      case 2:
        return UiNavigationModeModule.BBo.Z < 0 ? this.NBo() : this.OBo();
      case 0:
      case 1:
        return UiNavigationModeModule.BBo.Set(0, 0, Math.sign(UiNavigationModeModule.BBo.Z)), this.GBo(i.VerticalWrapMode, i.VerticalPriorityMode, !0);
      default:
        return
    }
  }
  FBo(i) {
    return 3 === i ? this.Nxo.NavigationMode.TopActor : 4 === i ? this.Nxo.NavigationMode.DownActor : 1 === i ? this.Nxo.NavigationMode.LeftActor : 2 === i ? this.Nxo.NavigationMode.RightActor : void 0
  }
  VBo(i) {
    return 3 === i ? this.Nxo.NavigationMode.TopMode : 4 === i ? this.Nxo.NavigationMode.DownMode : 1 === i ? this.Nxo.NavigationMode.LeftMode : 2 === i ? this.Nxo.NavigationMode.RightMode : void 0
  }
  HBo(i) {
    var t;
    3 === i && (t = this.Nxo.GetRootComponent().D_GetRightVector(), UiNavigationModeModule.BBo.Set(t.X, t.Y, t.Z)), 4 === i && (t = this.Nxo.GetRootComponent().D_GetRightVector(), UiNavigationModeModule.BBo.Set(-t.X, -t.Y, -t.Z)), 1 === i && (t = this.Nxo.GetRootComponent().D_GetForwardVector(), UiNavigationModeModule.BBo.Set(-t.X, -t.Y, -t.Z)), 2 === i && (t = this.Nxo.GetRootComponent().D_GetForwardVector(), UiNavigationModeModule.BBo.Set(t.X, t.Y, t.Z))
  }
  jBo() {
    var i = this.Nxo.RootUIComp;
    if (i) {
      var t = i.GetRenderCanvas();
      if (void 0 !== t && void 0 !== t.GetRootCanvas()) return i.IsScreenSpaceOverlayUI() ? (t = i.GetRootCanvas().GetOwner().RootComponent, this.WBo(t)) : this.WBo(void 0)
    }
  }
  WBo(i) {
    ...
    var r = UE.LGUIBPLibrary.GetComponentsInChildren(i.GetOwner(), UE.TsUiNavigationBehaviorListener_C.StaticClass(), !1);
    for (let i = 0, t = r.Num(); i < t; ++i) {
      var s, h, n = r.Get(i);
      n.GroupName === this.Nxo.GroupName && n.IsCanFocus() && ((s = this.qBo(n)).Subtraction(e, s), (h = Vector_1.Vector.DotProduct(UiNavigationModeModule.BBo, s)) <= .1 || (h = h / s.SizeSquared()) > a && (a = h, o = n.GetSelectableComponent()))
    }
    return o
  }
  qBo(i) {
    ...
    return Transform_1.Transform.Create(i.GetRootSceneComponent().D_K2_GetComponentToWorld()).TransformPosition(t, t), t
  }
  FindActorByDirection(i, t = !0) {
    var e, a = this.VBo(i);
    return 2 === a ? (e = this.Nxo.RootUIComp, t && !e.IsUIActiveInHierarchy() ? void(Log_1.Log.CheckError() && Log_1.Log.Error("UiNavigation", 10, "当前选中的导航监听组件按钮不可视", ["DisplayName", e.displayName])) : (t = this.FBo(i).GetComponentByClass(UE.TsUiNavigationBehaviorListener_C.StaticClass())) && !t.IsCanFocus() ? t.ModeModule?.FindActorByDirection(i, !1) : t.GetBehaviorComponent().GetRootSceneComponent()) : 1 === a ? (this.HBo(i), this.jBo()?.GetRootSceneComponent()) : void 0
  }
