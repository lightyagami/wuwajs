...
class NavigationVisionAssembleToggle extends NavigationToggle_1.NavigationToggle {
  OnFindLoopScrollViewNavigationComponent(o, e) {
    var t = this.Listener.LoopScrollViewGridIndex,
      ...
      r = 0 < o.X;
    return -1 === t ? 0 === i ? void 0 : r ? this.r4_() : this.o4_() : r || 0 !== t ? r && t === i - 1 ? this.PanelHandle.IsInCompare ? this.r4_() : this.n4_() : super.OnFindLoopScrollViewNavigationComponent(o, e) : this.PanelHandle.IsInCompare ? this.o4_() : this.n4_()
  }
  n4_() {
  ...
  o4_() {
    ...
    for (const e of this.Listener.GetNavigationGroup().ActiveListenerList)
      ...
      if (t.LoopScrollViewGridIndex === o - 1) return t.GetSelectableComponent()
  }
}
