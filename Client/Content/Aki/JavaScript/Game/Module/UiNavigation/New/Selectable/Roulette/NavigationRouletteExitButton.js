...
class NavigationRouletteExitButton extends NavigationButton_1.NavigationButton {
  InteractClickPrevGroup() {
    "Group1" === UiNavigationNewController_1.UiNavigationNewController.GetCurrentNavigationFocusListener()?.GroupName && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRouletteItemUnlock)
  }
}
