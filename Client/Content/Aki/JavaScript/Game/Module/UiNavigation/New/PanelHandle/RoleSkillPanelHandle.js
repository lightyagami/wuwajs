...
class RoleSkillPanelHandle extends SpecialPanelHandleBase_1.SpecialPanelHandleBase {
  ...
  SetToggleSelectByGroupName(e) {
    ...
    if (a) {
      this.GroupName = e;
      for (let e = 0, l = a.ListenerList.length; e < l; ++e) a.ListenerList[e].GetBehaviorComponent().bToggleOnSelect = !0
    }
  }
  ResetToggleSelect() {
    ...
    if (a) {
      this.GroupName = "";
      for (let e = 0, l = a.ListenerList.length; e < l; ++e) a.ListenerList[e].GetBehaviorComponent().bToggleOnSelect = !1
    }
  }
  SetSkillTreeToggleCursorActive(a) {
    var t = this.GetNavigationGroup(this.GroupName);
    if (t) {
      for (let e = 0, l = t.ListenerList.length; e < l; ++e) t.ListenerList[e].Cursor.Switch = a;
