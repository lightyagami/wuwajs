...
class TsUiNavigationPanelConfig extends UE.LGUIBehaviour {
  ...
  CanOverrideFindNavigation(i, t, s) {
    return !!this.PanelHandle && this.PanelHandle.CanOverrideFindNavigation(i, t, s);
  }
  HandleOverrideFindNavigation(i, t, s) {
    if (this.PanelHandle) {
      return this.PanelHandle.HandleOverrideFindNavigation(i, t, s);
    }
  }
  HandleAfterFindOpposite(i, t, s, e) {
    if (this.PanelHandle) {
      return this.PanelHandle.HandleAfterFindOpposite(i, t, s, e);
    }
  }
  AddHotKeyItem(i) {
