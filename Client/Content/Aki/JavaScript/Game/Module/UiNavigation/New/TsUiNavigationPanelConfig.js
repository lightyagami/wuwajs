...
class TsUiNavigationPanelConfig extends UE.LGUIBehaviour {
  constructor() {
    super(...arguments), this.ViewName = "", this.Independent = !0, this.IsChildPanel = !1, this.DefaultNavigationActor = void 0, this.DynamicListenerConfigMap = new UE.TMap, this.NormalGroup = void 0, this.BookmarkGroup = void 0, this.ScrollBarGroup = void 0, this.AllowNavigateInKeyBoard = !1, this.FirstFindFromSubPanelWhenFindNone = !1, this.InteractiveTag = "", this.TsScrollBarGroup = void 0, this.ViewHandle = void 0, this.IsInActive = !1, this.PanelHandle = void 0, this.ViewHandleCacheFunctionList = [], this.IncId = 0, this.HotKeyItemSet = void 0, this.CacheHotKeyStateMap = void 0, this.GamepadMouseActor = void 0, this.GamepadMouseItemInternal = void 0
  }
  Constructor() {
    this.TsScrollBarGroup = void 0, this.ViewHandle = void 0, this.IsInActive = !1, this.PanelHandle = void 0, this.ViewHandleCacheFunctionList = [], this.IncId = 0, this.HotKeyItemSet = void 0, this.CacheHotKeyStateMap = void 0, this.GamepadMouseItemInternal = void 0
  }
  AwakeBP() {
    GlobalData_1.GlobalData.GameInstance && (this.InitDefaultParam(), this.InitPanelHandle())
  }
  StartBP() {
    GlobalData_1.GlobalData.GameInstance && this.NavigationViewCreate()
  }
  OnEnableBP() {
    GlobalData_1.GlobalData.GameInstance && (this.IsInActive = !0, this.HandleAddPanel(), this.HandleUIActivePanel(), this.HandleChildUIActivePanel())
  }
  OnDisableBP() {
    GlobalData_1.GlobalData.GameInstance && (this.IsInActive = !1, this.HandleAddPanel(), this.HandleUIActivePanel(), this.HandleChildUIActivePanel())
  }
  HandleUIActivePanel() {
    this.Independent && this.HandleViewHandleFunction(() => {
  ...
  HandleChildUIActivePanel() {
    this.IsChildPanel && this.Independent && this.ViewHandle?.SetIsUsable(this.IsInActive)
  }
  OnDestroyBP() {
    GlobalData_1.GlobalData.GameInstance && (this.PanelHandle.Clear(), this.NavigationViewDestroy(), this.ViewHandle = void 0)
  }
  InitDefaultParam() {
    this.HotKeyItemSet = new Set
  }
  NavigationViewCreate() {
    this.IncId = ++UiNavigationUtil_1.UiNavigationUtil.IncId, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.NavigationViewCreate, this.IncId, this.GetOwner())
  }
  ...
  GetGroupMap() {
    ...
    return this.ScrollBarGroup && (this.ScrollBarGroup.GroupType = 2, this.TsScrollBarGroup = new NavigationGroup_1.NavigationGroup(this.ScrollBarGroup), s.set(this.ScrollBarGroup.GroupName, this.TsScrollBarGroup)), s
  }
  InitPanelHandle() {
    this.PanelHandle = NavigationPanelHandleCreator_1.NavigationPanelHandleCreator.GetPanelHandle(this.InteractiveTag), this.PanelHandle.Init(), this.PanelHandle.SetGroupMap(this.GetGroupMap()), this.PanelHandle.SetDefaultNavigationListenerList(this.DefaultNavigationActor)
  }
  HandleViewHandleFunction(i) {
    this.ViewHandle ? i() : (this.ViewHandleCacheFunctionList || (this.ViewHandleCacheFunctionList = []), this.ViewHandleCacheFunctionList.push(i))
  }
      ...
      if (this.RootUIComp.IsUIActiveInHierarchy()) {
        for (const e of this.PanelHandle.GetSuitableNavigationListenerList(i)) {
          ...
          if (e.IsScrollOrLayoutActor()) {
            ...
            if (!s) continue;
            i = s
          } else e.GetNavigationGroup()?.SuitableListenerByNoDynamic && (s = this.PanelHandle.GetSuitableListenerWithoutLayout(e)) && (i = s);
          if (i.IsCanFocus()) {
  ...
  FindNavigationInNoneState() {
    this.ViewHandle && this.ViewHandle.IsNonNavigation() && (this.ViewHandle.MarkResetCurrentPanelDirty(), this.ViewHandle.MarkRefreshNavigationDirty())
  }
  IsAllowNavigate() {
  ...
  HandleAsyncHotKeyState(i) {
    for (var [t, s] of this.GetOrCreateCacheHotKeyStateMap())
      for (const e of i.GetHotKeyComponentArray()) e.SetVisibleMode(t, s), e.RefreshSelfHotKeyState(this.ViewHandle), e.RefreshSelfHotKeyText(this.ViewHandle)
  }
  GetOrCreateCacheHotKeyStateMap() {
    return this.CacheHotKeyStateMap || (this.CacheHotKeyStateMap = new Map), this.CacheHotKeyStateMap
  }
  DeleteKeyItem(i) {
  ...
  RefreshHotKeyComponents() {
    if (this.HotKeyItemSet)
      for (const i of this.HotKeyItemSet)
        for (const t of i.GetHotKeyComponentArray()) t.RefreshSelfHotKeyState(this.ViewHandle), t.RefreshSelfHotKeyText(this.ViewHandle)
  }
  RefreshHotKeyTextId() {
    if (this.HotKeyItemSet)
      for (const i of this.HotKeyItemSet)
        for (const t of i.GetHotKeyComponentArray()) t.RefreshSelfHotKeyText(this.ViewHandle)
  }
  ...
  get GamepadMouseItem() {
    return this.GamepadMouseItemInternal || (this.GamepadMouseItemInternal = this.GamepadMouseActor?.GetComponentByClass(UE.UIItem.StaticClass())), this.GamepadMouseItemInternal
  }
}
exports.TsUiNavigationPanelConfig = TsUiNavigationPanelConfig, exports.default = TsUiNavigationPanelConfig;
