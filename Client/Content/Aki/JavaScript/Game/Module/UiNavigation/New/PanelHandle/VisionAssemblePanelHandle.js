...
class VisionAssemblePanelHandle extends SpecialPanelHandleBase_1.SpecialPanelHandleBase {
  constructor() {
    super(...arguments), this.u6_ = void 0, this.IsInCompare = !1, this.wbo = e => {
      UiNavigationNewController_1.UiNavigationNewController.MarkViewHandleRefreshNavigationDirty(), e && ModelManager_1.ModelManager.UiNavigationModel.MarkMoveInstantly()
    }
  }
  OnInit() {
  ...
  OnGetSuitableNavigationListenerList(e) {
    ...
    if (!this.u6_) {
      this.u6_ = [];
      for (const n of this.DefaultNavigationListener) n.IsScrollOrLayoutActor() && this.u6_.push(n)
    }
    return this.u6_
  }
}
