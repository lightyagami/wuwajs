...
class UiNavigationJoystickInput {
  ...
  static S9d(i) {
    if (this.M9d && (UiNavigationLogic_1.UiNavigationLogic.ExecuteInputNavigation(this.dd_, this.E9d), this.M9d = false, this.E9d === 1)) {
      this.dd_ = "";
    }
  }
  static ud_(i) {
...
UiNavigationJoystickInput.E9d = undefined;
UiNavigationJoystickInput.cd_ = false;
UiNavigationJoystickInput.M9d = false;
