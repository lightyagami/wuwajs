...
class HotKeyItemFactory {
    ...
    switch (n) {
      ...
      default:
        if (Log_1.Log.CheckError()) {
          Log_1.Log.Error("UiNavigation", 10, "导航快捷键的参数配置错误!", ["Mode", n], ["index", o]);
        }
        return;
    }
  }
  static async Bqe(e, n, o) {
    n = new n();
    await n.CreateThenShowByActorAsync(e, o);
    return n;
  }
  static async CreateHotKeyComponent(e, n, o) {
    ...
    if (t) {
      ...
      if (a) {
        (a = this.Pqo(a, n)).SetHotKeyFunctionType(t.Type);
      ...
      Log_1.Log.Warn("UiNavigation", 10, "导航组中单个配置找不到", ["hotKeyMapId", n]);
    }
  }
  static Pqo(e, n) {
    return new e(n);
