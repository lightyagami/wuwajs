...
class HotKeyItemFactory {
  static async CreateHotKeyItem(e, o, n) {
    switch (o) {
      ...
      case "MultipleHotKey":
        return HotKeyItemFactory.Bqe(e, MultipleHotKeyItem_1.MultipleHotKeyItem, n);
      default:
        if (Log_1.Log.CheckError()) {
          Log_1.Log.Error("UiNavigation", 10, "导航快捷键的参数配置错误!", ["Mode", o], ["index", n]);
        }
        return;
    }
  }
  static async Bqe(e, o, n) {
    o = new o();
    await o.CreateThenShowByActorAsync(e, n);
    return o;
  }
  static async CreateHotKeyComponent(e, o, n) {
    var t = ConfigManager_1.ConfigManager.UiNavigationConfig.GetHotKeyMapConfig(o);
    if (t) {
      ...
      Log_1.Log.Warn("UiNavigation", 10, "导航组中单个配置找不到", ["hotKeyMapId", o]);
    }
  }
  static Pqo(e, o) {
    return new e(o);
