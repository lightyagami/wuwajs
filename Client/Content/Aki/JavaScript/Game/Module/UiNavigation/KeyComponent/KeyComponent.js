...
class KeyBaseComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this._wo = !1, this.uwo = void 0, this.cwo = void 0, this.HEe = "", this.mwo = !1, this.MSo = ""
  }
  async OnBeforeStartAsync() {
    this.mwo && (this.cwo = new PcAndGamepadProgressBar_1.PcAndGamepadProgressBar, await this.cwo.Init(this.GetSquareItem(), this.GetCircleItem())), this.HEe && await this.dwo(this.HEe), this.But(this.mwo)
  }
  SetKeyName(e) {
    this.HEe = e
  }
  ...
  RefreshNameText(e) {
    !StringUtils_1.StringUtils.IsEmpty(e) && e !== HotKeyViewDefine_1.SPECIAL_TEXT && (e = ConfigManager_1.ConfigManager.UiNavigationConfig.GetHotKeyText(e)) ? (this.SetNameTextById(e), this.SetNameTextVisible(!0)) : this.SetNameTextVisible(!1)
  }
  Cwo(e) {
    this.dwo(e)
  }
    ...
    if (t && !StringUtils_1.StringUtils.IsEmpty(e)) {
      ...
      if (i) {
        ...
        if (!StringUtils_1.StringUtils.IsEmpty(i) && i !== this.MSo) {
          "0" === (this.MSo = i) && Log_1.Log.CheckError() && Log_1.Log.Error("UiNavigationHotKey", 10, "读取到图片路径为0的情况", ["keyName", e]);
          const s = new CustomPromise_1.CustomPromise;
          this.gwo(!1), this.SetTextureByPath(i, t, void 0, () => {
            t.SetSizeFromTexture(), s.SetResult()
          }), await s.Promise, this.gwo(!0)
        }
      }
    }
  }
  ...
  SetNameTextById(e) {
    var t;
    this._wo || (t = this.GetNameText()) && LguiUtil_1.LguiUtil.SetLocalTextNew(t, e)
  }
  SetNameText(e) {
