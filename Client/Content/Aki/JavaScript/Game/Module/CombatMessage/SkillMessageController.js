...
class SkillMessageController extends ControllerBase_1.ControllerBase {
  ...
  static OnInit() {
    Net_1.Net.Register(18777, SkillMessageController.sCc);
    return true;
  }
  static OnClear() {
    Net_1.Net.UnRegister(18777);
  ...
  static UseSkillRequest(o, e, t) {
    ...
    CombatMessage_1.CombatNet.Call(27778, o, n, e => {
      if (!o.IsEnd) {
  ...
  static EndSkillRequest(e, o, t) {
    ...
    if (e) {
      ...
      CombatMessage_1.CombatNet.Send(23398, e, l);
      return true;
    } else {
  ...
  static MontageRequest(o, e, t, l, r, a = 1, s = "", i = 0, _ = undefined, c = undefined) {
    ...
    e.dVn = t;
    e.pVn = l;
    CombatMessage_1.CombatNet.Call(18768, o, e, e => {
      if (!o.IsEnd) {
        switch (e.Q4n) {
  ...
  static AnimNotifyRequest(e, o, t, l, r = undefined, a = undefined) {
    ...
    s.lVn = t;
    s.r5n = o;
    CombatMessage_1.CombatNet.Send(23122, e, Protocol_1.Aki.Protocol.Pe_.create(s), r, a);
  }
  static PassiveSkillAddRequest(e, o, t = undefined) {
    ...
    CombatMessage_1.CombatNet.Send(19543, e, Protocol_1.Aki.Protocol.Be_.create(l), t, o);
    return o;
  }
  static PassiveSkillRemoveRequest(e, o, t = undefined, l = undefined) {
    ...
    CombatMessage_1.CombatNet.Send(24488, e, Protocol_1.Aki.Protocol.je_.create(r), t, l);
  }
  static aCc(e, o) {}
}
...
__decorate([CombatMessage_1.CombatNet.Listen("DFn", true)], SkillMessageController, "UseSkillNotify", null);
__decorate([CombatMessage_1.CombatNet.Listen("LFn", true)], SkillMessageController, "SkillNotify", null);
__decorate([CombatMessage_1.CombatNet.Listen("AFn", true)], SkillMessageController, "EndSkillNotify", null);
