...
class HandBookPhantomItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.jei = void 0, this.kZt = void 0, this.GZt = void 0, this.OZt = e => {
  ...
  OnStart() {
    this.jei = new HandBookCommonItem_1.HandBookCommonItem, this.jei.Initialize(this.GetItem(0).GetOwner());
    var e = this.kZt.Config,
      o = new HandBookDefine_1.HandBookCommonItemData,
      i = ModelManager_1.ModelManager.HandBookModel.GetHandBookInfo(1, e.MonsterId),
      t = void 0 === i,
      i = void 0 !== i && !i.IsRead,
      i = (o.Icon = e.Icon, o.IsLock = t, o.IsNew = i, this.jei.Refresh(o, !1, 0), this.jei.BindOnExtendToggleClicked(this.OZt), this.jei.SetNewFlagVisible(!1), this.GetText(1));
    this.GetText(3).SetUIActive(!1), t ? (o = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("Unknown"), i.ShowTextNew(o)) : i.ShowTextNew(e.MonsterName)
  }
