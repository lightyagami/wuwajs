...
class HandBookQuestItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.VZt = void 0, this.Nxn = [], this.gei = [], this.WZt = () => {
  ...
  Refresh(e, t, i) {
    var o = e,
      e = o.Id,
      e = ConfigManager_1.ConfigManager.HandBookConfig.GetPlotHandBookConfigByType(e),
      r = (this.Nxn = ConfigCommon_1.ConfigCommon.ToList(e), this.Nxn.sort((e, t) => e.Id - t.Id), this.GetText(0).ShowTextNew(o.TypeDescription), this.gei = [], this.Nxn.length);
    for (let e = 0; e < r; e++) {
      var s = this.Nxn[e],
        n = new HandBookDefine_1.HandBookCommonItemData,
        a = ModelManager_1.ModelManager.HandBookModel.GetHandBookInfo(o.Type, s.Id),
        h = void 0 === a;
      h || (a = void 0 !== a && !a.IsRead, n.ConfigId = s.Id, n.Config = s, n.IsLock = h, n.IsNew = a, this.gei.push(n))
    }
  ...
  OnBeforeDestroy() {
    this.VZt && (this.VZt.ClearChildren(), this.VZt = void 0), this.Nxn = [], this.gei = []
  }
}
