...
class HandBookRoleMediumItemGird extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  ...
  OnSelected(e) {
    this.SetSelected(!0), this.SetNewVisible(!1), this.Data instanceof RoleDataBase_1.RoleDataBase && this.Data.GetRoleId() < RoleDefine_1.ROBOT_DATA_MIN_ID && this.Data.TryRemoveNewFlag()
  }
  OnDeselected(e) {
