...
class HandBookQuestPlotItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.PlotNodeItem = void 0, this.kxn = void 0, this.jBn = void 0
  }
  async Init(t) {
    await super.CreateByActorAsync(t.GetOwner(), void 0, !0), await this.WZt()
  }
  async WZt() {
    this.PlotNodeItem = new PlotNodeItem, this.AddChild(this.PlotNodeItem), this.GetItem(0).SetUIActive(!1), await this.PlotNodeItem.CreateByActorAsync(this.GetItem(1).GetOwner()), this.PlotNodeItem.BindClickCallback(this.kxn)
  }
  OnRegisterComponent() {
  ...
  Update(t, e) {
    this.PlotNodeItem.SetUiActive(!0), this.PlotNodeItem.Update(t.TidText, this.WBn(t.TidText))
  }
  GetNodeToggle() {
...
class PlotNodeItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.kxn = void 0, this.$Ve = void 0, this.os = "", this.OnClickExtendToggle = t => {
  ...
  Update(t, e) {
    ...
    this.GetText(1)?.SetText(t), this.$Ve?.SetToggleStateForce(e ? 1 : 0, !1, !1)
  }
  GetTidText() {
    return this.os
  }
