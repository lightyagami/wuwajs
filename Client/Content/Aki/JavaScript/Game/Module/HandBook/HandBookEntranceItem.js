...
class HandBookEntranceItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e) {
    super(), this.Bei = void 0, this.Lxt = () => {
      switch (this.Bei.Id) {
        case 0:
        ...
        case 11:
          ...
          break;
        default:
          Log_1.Log.CheckError() && Log_1.Log.Error("HandBook", 5, "没有找到图鉴入口类型，请检查", ["this.HandBookEntrance.Id", this.Bei.Id])
      }
  ...
  OnStart() {}
  Refresh(e, a, r) {
    this.Bei = e, this.GetText(0).ShowTextNew(this.Bei.Name), this.SetTextureByPath(e.Texture, this.GetTexture(1)), this.RefreshRedDot(), this.RefreshCollectProgress()
  }
  RefreshRedDot() {
  ...
  RefreshCollectProgress() {
    ...
    LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "CollectProgress", e[0], e[1]), this.GetText(2)?.SetUIActive(!1)
  }
}
