...
class PlotHandBookItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(e = void 0) {
    super(), this.VZt = void 0, this.Cei = [], this.gei = [], this.WZt = (e, t, i) => {
  ...
  Refresh(e, t, i) {
    var r = e.Id,
      r = ConfigManager_1.ConfigManager.HandBookConfig.GetPlotHandBookConfigByType(r),
      o = (this.Cei = r, this.GetText(0).ShowTextNew(e.TypeDescription), this.gei = [], this.Cei.length);
    for (let e = 0; e < o; e++) {
      var s = this.Cei[e],
    ...
    this.VZt = new GenericLayoutNew_1.GenericLayoutNew(this.GetGridLayout(1), this.WZt), this.VZt.RebuildLayoutByDataNew(this.gei)
  }
  GetChildItemList() {
