...
class HandBookConfig extends ConfigBase_1.ConfigBase {
  ...
  GetAnimalHandBookConfigByMeshId(o) {
    if (!this.Rei) {
      this.Rei = new Map;
      for (const e of AnimalHandBookAll_1.configAnimalHandBookAll.GetConfigList()) this.Rei.set(e.MeshId, e.Id)
    }
    if (this.Rei.get(o)) return AnimalHandBookByMeshId_1.configAnimalHandBookByMeshId.GetConfig(o)
  }
