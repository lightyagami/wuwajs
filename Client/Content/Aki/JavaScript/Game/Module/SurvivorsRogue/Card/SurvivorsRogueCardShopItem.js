...
class SurvivorsRogueCardShopItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[1, this.Rwd]];
  }
  async OnBeforeStartAsync() {
    var t = [];
    this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem);
    this.o6d = new LevelSequencePlayer_1.LevelSequencePlayer(this.GetItem(8));
    ...
    this.Twd = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(3), this.wwd);
    await Promise.all(t);
  ...
  async RefreshAsync(t, e, i) {
    ...
    switch (r.R5n) {
      case "kTd":
        ...
        o = this.Lwd(h.DTd.wJs, Array.from(a.EvolveIds.values()), h.DTd.F6n, n.Level);
      ...
      case "qTd":
        ...
        o = this.Lwd(a.xTd.wJs, Array.from(h.EvolveIds.values()), a.xTd.F6n, n.Level);
        await this.CardItem.Apply(v);
        break;
      case "UTd":
  ...
  Pwd(e, i = false) {
    ...
    if (this.Pe.O2s) {
      ...
      let t = false;
      for (const h of this.bwd) {
        var s = e ? 2 : 0;
        var r = this.Twd.GetLayoutItemByKey(h);
        r?.RefreshState(s);
      ...
      var o = this.bwd.at(-1);
      if (o !== undefined && (o = this.Twd.GetItemByKey(o))) {
  ...
  n6d(t) {
    if (t !== this.U0n) {
      this.U0n = t;
      this.o6d.StopPlayingSequence(false, true);
      this.GetItem(5).SetUIActive(true);
      this.o6d.PlayLevelSequenceByName(t ? SEQ_LIGHT : SEQ_CLOSE);
    }
  }
  HasImportantNode() {
    for (const t of this.bwd) {
      if (this.Twd.GetLayoutItemByKey(t)?.Data.IsImportant) {
        return true;
      }
    }
    return false;
