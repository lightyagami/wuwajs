...
class SurvivorsRogueCommandQueue {
  ...
  get ForegroundCommand() {
    return this.abd.get(this.ForegroundCommandIncId);
  }
  InitCommands(o) {
    this.sg.length = 0;
    this.abd.clear();
  ...
  AddCommand(o) {
    ...
    if (s && (s.Update(o), r = s.IncId === this.ForegroundCommandIncId, s.SetForegroundStatus(r), this.sg.push(s), this.abd.set(o.w5n, s), Log_1.Log.CheckInfo())) {
      Log_1.Log.Info("SurvivorsRogue", 37, "[SurvivorsRogue] 新增指令", ["Index", this.sg.length - 1], ["IncId", s.IncId], ["Data", s.ToString()]);
    }
  }
  UpdateCommand(o) {
    var r = this.abd.get(o.w5n);
    if (r && (r.Update(o), Log_1.Log.CheckDebug())) {
      Log_1.Log.Debug("SurvivorsRogue", 37, "[SurvivorsRogue] 更新指令", ["IncId", r.IncId], ["Data", r.ToString()]);
    }
  }
  RemoveCommand(r) {
    var o = this.abd.get(r);
    if (o && (o.Delete(), (o = this.sg.findIndex(o => o.IncId === r)) !== -1 && this.sg.splice(o, 1), this.abd.delete(r), Log_1.Log.CheckInfo())) {
