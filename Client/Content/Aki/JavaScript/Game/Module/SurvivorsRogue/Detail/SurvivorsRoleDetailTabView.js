...
class SurvivorsRoleDetailTabView extends UiPanelBase_1.UiPanelBase {
  constructor() {
    ...
    this._Od = undefined;
    this.kuo = undefined;
    this.uOd = () => new SurvivorsAttributeItem_1.SurvivorsAttributeItem();
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this._Od = new RoleCardItem();
    await this._Od.CreateThenShowByActorAsync(this.GetItem(0).GetOwner());
    this.kuo = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(5), this.GetItem(6).GetOwner(), this.uOd);
  }
  OnStart() {
