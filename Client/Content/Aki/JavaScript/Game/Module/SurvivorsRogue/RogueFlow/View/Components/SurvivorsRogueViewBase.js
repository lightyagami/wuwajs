...
class SurvivorsRogueViewBase extends UiPanelBase_1.UiPanelBase {
  ...
  async OnBeforeStartAsync() {
    ...
    this.bAd = new SurvivorsRogueResidentWaveTipsPanel_1.SurvivorsRogueResidentWaveTipsPanel();
    e.push(this.bAd.CreateThenShowByActorAsync(this.GetItem(2).GetOwner()));
