...
class SurvivorsRogueSettleBaseView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.$An = e => {
      if (e === "InturnAni") {
        this.bDd.GetUiAnimController()?.Play();
  ...
  async OnBeforeStartAsync() {
    this.bDd = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(15), this.RDd);
  ...
  wDd(e, t) {
    ...
    for (const s of e) {
      var r = s;
      if (r.R5n === "sEd") {
        r = new SurvivorsRogueGainData_1.SurvivorsWeaponGainData(s.w5n, s.v9n, r.sEd);
        i.push(r);
      }
    }
  ...
  async RefreshAsync() {
    ...
    if (e) {
      for (const n of e.EEd) {
        var t = n;
        if (t.R5n === "nEd") {
          this.TSn.Refresh(t.v9n, t.nEd.F6n);
        }
      }
      var i;
      var r;
      ...
      if (o) {
        ...
        this.k4d.Init(0, e.qLd, e => {
          this.GetText(14).SetText(Math.round(e).toString());
        });
        r = this.wDd(e.EEd, e.GLd);
        await this.bDd.RefreshByDataAsync(r);
      }
    }
  }
}
