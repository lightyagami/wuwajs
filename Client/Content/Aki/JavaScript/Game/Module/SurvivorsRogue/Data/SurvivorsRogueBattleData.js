...
class SurvivorsRogueBattleData {
  ...
  InitBattleSkillData() {
    this.fXc.set(InputMappingsDefine_1.actionMappings.技能1, this.TAd(ACTIVE_SKILL_ID, InputMappingsDefine_1.actionMappings.技能1));
    this.fXc.set(InputMappingsDefine_1.actionMappings.闪避, this.TAd(DODGE_SKILL_ID, InputMappingsDefine_1.actionMappings.闪避));
  }
  TAd(e, t) {
