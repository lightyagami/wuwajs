...
class SurvivorsRogueGainData {
  ...
  AddGain(t) {
    ...
    switch (e.R5n) {
      case "DTd":
        var o = new SurvivorsRoleGainData(t.w5n, t.v9n, e.DTd);
        this.EAd.set(t.w5n, o);
        this.MAd.set(t.w5n, o);
        ...
        break;
      case "xTd":
        o = new SurvivorsWeaponGainData(t.w5n, t.v9n, e.xTd);
        ...
        break;
      case "UTd":
        o = new SurvivorsItemGainData(t.w5n, t.v9n, e.UTd);
        this.TAd.set(t.w5n, o);
        this.MAd.set(t.w5n, o);
        if (o && Log_1.Log.CheckInfo()) {
  ...
  RemoveGain(t) {
    if (this.MAd.get(t) && (this.EAd.delete(t), this.WeaponGainMap.delete(t), this.TAd.delete(t), this.MAd.delete(t), Log_1.Log.CheckInfo())) {
      Log_1.Log.Info("SurvivorsRogue", 37, "[SurvivorsRogue] 删除增益", ["IncId", t]);
    }
  }
  GetRoleGainData() {
    return this.EAd.values().next().value;
  }
  GetItemGainList() {
    return Array.from(this.TAd.values());
  }
  GetWeaponGainList() {
  ...
  GetWeaponGainListWithBondInfo(t = this.GetWeaponGainList()) {
    ...
    for (const n of t) {
      if (!a.has(n.IncId)) {
        r = (o = (o = n.Data.NTd) > 0 ? e.get(o) : undefined) !== undefined && !a.has(o.IncId);
        i = {
          WeaponData: n,
          BondPosition: r ? 1 : 0
        };
