...
class SurvivorsTalentUnlockView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments);
    this.s4e = undefined;
    this.B1d = () => new SurvivorsTalentTreeMediumItemGrid_1.SurvivorsTalentTreeMediumItemGrid();
    this.Jvt = () => {
      this.CloseMe();
    };
  }
  ...
  async OnBeforeStartAsync() {
    this.s4e = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(2), this.B1d);
    var e;
    var i;
