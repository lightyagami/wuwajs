...
class SurvivorsTeamEditView extends UiViewBase_1.UiViewBase {
  ...
  async OnBeforeStartAsync() {
    ...
    var e = [];
    this.zOd = new SurvivorsRoleTabDetail_1.SurvivorsRoleTabDetail();
    e.push(this.zOd.CreateThenShowByActorAsync(this.GetItem(3).GetOwner()));
    this.JOd = new ActivityFunctionalTypeA_1.FunctionalPanelConditionLock();
    e.push(this.JOd.CreateThenShowByActorAsync(this.GetItem(11).GetOwner()));
    ...
    e.push(this.Bkd());
    await Promise.all(e);
    this.JOd.SetButtonVisible(false);
  ...
  ANo() {
    this.XOd = ModelManager_1.ModelManager.SurvivorsRogueModel.SelectLevelInfo;
    var e = ModelManager_1.ModelManager.SurvivorsRogueModel.ActivityData;
    if (e !== undefined) {
      var i = ConfigManager_1.ConfigManager.SurvivorsRogueConfig.GetSurvivorsLevel(this.XOd.LevelId);
  ...
  Og() {
    this.GetItem(5)?.SetUIActive(this.YOd.IsUnLock);
    this.GetButton(6)?.RootUIComp.SetUIActive(this.YOd.IsUnLock);
    this.JOd.SetUiActive(!this.YOd.IsUnLock);
    if (!this.YOd.IsUnLock) {
      e = LevelGeneralCommons_1.LevelGeneralCommons.GetConditionGroupHintText(this.YOd.UnlockConditionId);
      this.JOd.SetTextByTextId(e);
    }
