...
class SurvivorsRogueRewardView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    ...
    this.HEu = e => {
      if (this.nGd !== e.Type && this.nGd !== -1) {
        this.B7t.GetLayoutItemByKey(this.nGd)?.SetToggleState(false, false);
      }
      this.B7t.SelectGridProxy(e.Index);
      this.nGd = e.Type;
      this.Ooh();
    };
    this.sGd = e => this.ActivityDataBase.GetTypeRedDotState(e.Type);
    this.VOe = () => {
    ...
    this.W9u = () => {
      var e = this.ActivityDataBase.GetAvailableGetTaskRewardIdsByType(this.nGd);
      if (e.length > 0) {
  ...
  async OnBeforeStartAsync() {
    ...
    e.push(this.B7t.RefreshByDataAsync(this.aGd()));
    await Promise.all(e);
  ...
  Ooh() {
    var e = this.ActivityDataBase.GetRewardTaskDataListByTypeId(this.nGd);
