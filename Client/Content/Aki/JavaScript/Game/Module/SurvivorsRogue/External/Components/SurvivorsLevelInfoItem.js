...
class SurvivorsLevelInfoItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  _2d(e) {
    ...
    this.RYd = ModelManager_1.ModelManager.SurvivorsRogueModel.ActivityData.GetLevelTimeUnlockState(this.LevelInfo.LevelId);
  ...
  wke(e = true) {
    ...
    if (i) {
      ...
      i = LevelGeneralCommons_1.LevelGeneralCommons.GetConditionGroupHintText(this.LevelInfo.Info.tUd) ?? "";
