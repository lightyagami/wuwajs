...
class NewFlagModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.DGi = new Map, this.RGi = new Array, this.xta = new Map, this.LoadNewFlagConfig = () => {
  ...
  OnAddEvents() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnGetPlayerBasicInfo, this.LoadNewFlagConfig), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.LogOut, this.ClearNewFlag)
  }
  OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnGetPlayerBasicInfo, this.LoadNewFlagConfig), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.LogOut, this.ClearNewFlag)
  }
  SaveNewFlagConfig(e) {
    var t = this.DGi.get(e);
    if (!t) return Log_1.Log.CheckDebug() && Log_1.Log.Debug("NewFlag", 37, "该系统当前没有需要保存的New标签", ["System", e]), !1;
    if (!this.xta.get(e)) return !1;
    this.RGi.length = t.size;
    let o = 0;
    for (const a of t) this.RGi[o++] = a;
    return this.xta.set(e, !1), LocalStorage_1.LocalStorage.SetPlayer(e, this.RGi)
  }
  AddNewFlag(e, t) {
    var o = this.DGi.get(e);
    return o ? (o.add(t), this.xta.set(e, !0), !0) : (Log_1.Log.CheckDebug() && Log_1.Log.Debug("NewFlag", 37, "该系统当前没有Set缓存,无法添加, 请检查是否初始化", ["System", e]), !1)
  }
  RemoveNewFlag(e, t) {
    var o = this.DGi.get(e);
    return o ? (o = o.delete(t), t = this.xta.get(e), this.xta.set(e, o || t), o) : (Log_1.Log.CheckDebug() && Log_1.Log.Debug("NewFlag", 37, "该系统当前没有Set缓存,无法删除, 请检查是否初始化", ["System", e]), !1)
  }
  HasNewFlag(e, t) {
    e = this.DGi.get(e);
    return !!e && e.has(t)
