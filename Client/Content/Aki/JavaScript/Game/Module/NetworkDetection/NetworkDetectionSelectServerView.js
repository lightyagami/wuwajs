...
class NetworkDetectionSelectServerView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.xqe = void 0, this.LSi = (e, t, r) => {
      ...
      ModelManager_1.ModelManager.NetworkDetectionModel.CurrentSelectServerData = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnConfirmNetworkDetectionItem), this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var e = new NetworkDetectionSelectServerDynItem_1.NetworkDetectionSelectServerDynItem,
      e = (this.xqe = new DynScrollView_1.DynamicScrollView(this.GetUIDynScrollViewComponent(2), this.GetItem(3), e, this.LSi), await this.xqe.Init(), ModelManager_1.ModelManager.NetworkDetectionModel.CurrentUiSelectSeverData = ModelManager_1.ModelManager.NetworkDetectionModel.CurrentSelectServerData, ModelManager_1.ModelManager.LoginServerModel.GetLoginServersByClientRegion());
  ...
  async USi(e) {
    const t = this.ASi(e);
    await this.xqe?.ScrollToItemIndex(t), TimerSystem_1.TimerSystem.Next(() => {
      var e = this.xqe?.GetGrid(t);
      ControllerHolder_1.ControllerHolder.UiNavigationNewController.SetNavigationFocusForView(e, !0)
    })
  }
  ASi(t) {
    let r = 0;
