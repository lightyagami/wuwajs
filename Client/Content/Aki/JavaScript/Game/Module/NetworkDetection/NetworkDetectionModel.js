...
class NetworkDetectionModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentSelectServerData = void 0, this.CurrentUiSelectSeverData = void 0, this.xic = 0
  }
  ...
  GetFinalErrorCodeString(e) {
    var t = [];
    for (const r of e) void 0 !== r.ErrorCodeText && "" !== r.ErrorCodeText && t.push(r.ErrorCodeText);
    return t.join("\n")
  }
}
