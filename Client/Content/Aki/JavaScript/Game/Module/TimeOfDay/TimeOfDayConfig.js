...
class TimeOfDayConfig extends ConfigBase_1.ConfigBase {
  ...
  GetDayStateByGameTimeMinute(t) {
    if (0 === this.iTo.length && !this.InitDayStateTimeSpanList()) return Log_1.Log.CheckError() && Log_1.Log.Error("TimeOfDay", 16, "时间区间配置错误"), 0;
    let r = 0;
    return this.iTo.every((e, i) => !TimeOfDayModel_1.TodDayTime.CheckInMinuteSpan(t, e) || (r = i, !1)), 4 <= r ? (Log_1.Log.CheckError() && Log_1.Log.Error("TimeOfDay", 16, "时间区间配置超出范围"), 0) : r
  }
  GetBanGamePlayTags() {
