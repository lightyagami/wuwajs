...
class TodDayTime {
  ...
  static get dBi() {
    return this.DTo || (this.DTo = ConfigManager_1.ConfigManager.TimeOfDayConfig.GetRate()), this.DTo
  }
  get Second() {
    return this.LTo
  }
  ...
  static ConvertFromRealTimeSecond(e) {
    return TodDayTime.dBi ? e * TodDayTime.dBi / TimeOfDayDefine_1.TOD_RATE_RATIO : (Log_1.Log.CheckError() && Log_1.Log.Error("TimeOfDay", 16, "获取时间流速比错误"), 0)
  }
...
class TimeOfDayModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.RTo = new TodDayTime, this.UTo = 0, this.ATo = 1, this.PTo = 1, this.FreezeTimeScale = !1, this.PlayerAccount = void 0, this.CurrentSelectTimeItemSt = void 0, this.xTo = 0, this.wTo = 0, this.BTo = 0, this.M41 = !1, this.TimeRunLockStateClient = !1, this.TimeRunLockStateServer = !1, this.TimeSyncLockStateClient = !1, this.TimeSyncLockStateServer = !1
  }
  get GameTime() {
    return this.RTo
  }
  get TimeRunLockState() {
    return this.M41 ? this.TimeRunLockStateClient : this.TimeRunLockStateServer
  }
  get TimeSynLockState() {
    return this.M41 ? this.TimeSyncLockStateClient : this.TimeSyncLockStateServer
  }
  GetPassSceneTime() {
    return this.BTo
  }
  ...
  CheckCanCacheRecord() {
    return 0 === this.UTo || !(Time_1.Time.Now - this.UTo < TimeOfDayDefine_1.TOD_SAVE_CD_MINUTE * TimeOfDayDefine_1.TOD_SECOND_PER_MINUTE * TimeOfDayDefine_1.TOD_MILLIONSECOND_PER_SECOND)
  }
  IsCurrentTimePassedNormally() {
    return 0 === this.xTo ? this.GameTime.Second >= TimeOfDayDefine_1.TOD_SECOND_PER_DAY - TimeOfDayDefine_1.TOD_SAVE_CD_SECONDS : this.GameTime.Second < TimeOfDayDefine_1.TOD_SAVE_CD_SECONDS ? this.xTo >= TimeOfDayDefine_1.TOD_SECOND_PER_DAY - TimeOfDayDefine_1.TOD_SAVE_CD_SECONDS + this.GameTime.Second || this.xTo <= this.GameTime.Second : 0 < this.GameTime.Second - this.xTo && this.GameTime.Second - this.xTo < TimeOfDayDefine_1.TOD_SAVE_CD_SECONDS
  }
  GetTimeOfDayShowData() {
    var t = new Array,
      i = ConfigManager_1.ConfigManager.TimeOfDayConfig.GetTimePresets();
    let r = 0;
    var n, a = this.GameTime.Second,
      s = ConfigManager_1.ConfigManager.TimeOfDayConfig.GetDayTimeChangePresets();
    for (let e = 0; e < s.length; e++)
      for (var [o] of i) 0 === s[e].ChangeDayNum && a > o || ((n = new TimeOfDaySecondItem_1.TimeOfDaySecondItemSt).Id = r, n.ChangeDayIndex = e, n.SetTime = o, n.ShowName = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(s[e].Title), t.push(n), r++);
    return t
  }
  SetCurrentDay(e) {
    this.wTo !== e && Log_1.Log.CheckDebug() && Log_1.Log.Debug("TimeOfDay", 27, "日期调整"), this.wTo = e
  }
  GetCurrentDay() {
    return this.wTo
  }
  SetUseClientLockState(e) {
    this.M41 = e, Log_1.Log.CheckInfo() && Log_1.Log.Info("TimeOfDay", 26, "使用客户端时间锁定状态", ["enable", e])
  }
}
