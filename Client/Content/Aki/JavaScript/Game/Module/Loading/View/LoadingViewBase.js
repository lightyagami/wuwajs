...
class LoadingViewBase extends UiTickViewBase_1.UiTickViewBase {
  ...
  GetGenderImage(e) {
    ...
    var e = ConfigManager_1.ConfigManager.LoadingConfig.GetBroadcastImageConfig(e);
    if (e) {
      if (i === 0) {
        return e.ImageF;
      } else {
  ...
  PPc() {
    ...
    let e = this.GetGenderImage(this.ShowData.GetImageId());
    ...
    if ((e = ModelManager_1.ModelManager.LoadingModel.LoadingTexturePathOverride ? ModelManager_1.ModelManager.LoadingModel.LoadingTexturePathOverride : e) !== undefined) {
  ...
  kvi(e) {
    if (!this.wvi) {
      ...
      while (i.ReachHandleQueue.Size) {
        var r = i.ReachHandleQueue.Front;
        if (r[0] > a) {
          break;
        }
