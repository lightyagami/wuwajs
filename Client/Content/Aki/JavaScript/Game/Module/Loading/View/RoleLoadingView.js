...
class RoleLoadingView extends LoadingViewBase_1.LoadingViewBase {
  ...
  Ovi() {
    ...
    e && (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e?.Description), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), e?.CharacterName), this.SetTextureByPath(e.IllustrationAsset, this.GetTexture(3), this.Info.Name), ModelManager_1.ModelManager.LoadingModel?.ClearRoleLoadingInfo())
  }
