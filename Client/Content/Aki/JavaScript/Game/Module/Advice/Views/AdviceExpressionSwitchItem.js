...
exports.AdviceExpressionSwitchItem = undefined;
const UE = require("ue");
...
class AdviceExpressionSwitchItem extends CommonTabItemBase_1.CommonTabItemBase {
  constructor() {
    ...
    this.hHe = e => {
      if (e === 1) {
        this.SelectedCallBack(this.aHe);
      }
    };
  }
  OnRegisterComponent() {
  ...
  UpdateView(e) {
    this.aHe = e;
    e = ConfigManager_1.ConfigManager.ChatConfig.GetExpressionGroupConfig(e).GroupTexturePath;
