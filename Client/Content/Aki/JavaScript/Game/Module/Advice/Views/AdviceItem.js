...
class AdviceItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.b9e = void 0, this.bHe = e => {
  ...
  wHe() {
    var e, t = 0 < this.b9e.GetAdviceExpressionId();
    t && (e = ConfigManager_1.ConfigManager.ChatConfig.GetExpressionConfig(this.b9e.GetAdviceExpressionId()), this.SetTextureByPath(e.ExpressionTexturePath, this.GetTexture(4))), this.GetSprite(5).SetUIActive(!t), this.GetTexture(4).SetUIActive(t)
  }
  THe() {
