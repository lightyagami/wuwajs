...
class AdviceCreateChangeBtnItem extends UiPanelBase_1.UiPanelBase {
  ...
  Q7e() {
    var e = ModelManager_1.ModelManager.AdviceModel,
      i = (e.CurrentChangeWordType = 0, e.CurrentSentenceWordMap.get(this.Xy));
  ...
  X7e(e) {
    0 === e ? LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "ChangeOneLineWord") : 0 === this.Xy ? LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "ChangeFirstLineWord") : LguiUtil_1.LguiUtil.SetLocalText(this.GetText(1), "ChangeLastLineWord")
  }
}
