...
class AdviceSentenceSelectItemContent extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.sje = 0, this.aje = () => {
      this.Og(), this.nHe()
    }, this.Lke = () => ModelManager_1.ModelManager.AdviceModel.PreSelectSortWordId !== this.sje, this.ije = () => {
      ModelManager_1.ModelManager.AdviceModel.CurrentPreSentenceWordMap.get(ModelManager_1.ModelManager.AdviceModel.CurrentSentenceSelectIndex) !== this.sje && (ModelManager_1.ModelManager.AdviceModel.CurrentPreSentenceWordMap.set(ModelManager_1.ModelManager.AdviceModel.CurrentSentenceSelectIndex, this.sje), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnClickAdviceSortWord))
  ...
  nHe() {
    var e = this.GetExtendToggle(0).ToggleState,
      t = ModelManager_1.ModelManager.AdviceModel.CurrentPreSentenceWordMap.get(ModelManager_1.ModelManager.AdviceModel.CurrentSentenceSelectIndex),
      t = this.sje === t ? 1 : 0;
