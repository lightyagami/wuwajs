...
class AdviceExpressionItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.U9e = 0, this.oHe = () => {
      this.rHe(), this.nHe()
    }, this.sHe = () => {
      ModelManager_1.ModelManager.AdviceModel.PreSelectExpressionId = this.U9e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnClickAdviceExpression)
    }
  }
  OnRegisterComponent() {
  ...
  Refresh(e, t, s) {
    ...
    var r = e.ExpressionTexturePath,
      r = (ResourceSystem_1.ResourceSystem.LoadAsync(r, UE.Texture, (e, t) => {
  ...
  nHe() {
    var e = this.GetExtendToggle(0).ToggleState,
      t = ModelManager_1.ModelManager.AdviceModel.PreSelectExpressionId === this.U9e ? 1 : 0;
