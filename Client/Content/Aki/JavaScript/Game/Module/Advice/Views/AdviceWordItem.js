...
exports.AdviceWordItem = undefined;
const UE = require("ue");
...
class AdviceWordItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    ...
    this.ije = () => {
      if (ModelManager_1.ModelManager.AdviceModel.PreSelectSortWordId !== this.sje) {
        ModelManager_1.ModelManager.AdviceModel.PreSelectSortWordId = this.sje;
  ...
  nHe() {
    ...
    var t = this.sje === ModelManager_1.ModelManager.AdviceModel.PreSelectSortWordId ? 1 : 0;
    if (e !== t) {
