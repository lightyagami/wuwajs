...
class AdviceWordTypeItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.rje = 0, this.QHe = () => {
      this.Og()
    }, this.Lke = () => ModelManager_1.ModelManager.AdviceModel.PreSelectSortTypeId !== this.rje, this.ije = () => {
      ModelManager_1.ModelManager.AdviceModel.PreSelectSortTypeId !== this.rje && (ModelManager_1.ModelManager.AdviceModel.PreSelectSortTypeId = this.rje, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnClickAdviceSort))
  ...
  Og() {
    var e = this.GetExtendToggle(0).ToggleState,
      t = ModelManager_1.ModelManager.AdviceModel.PreSelectSortTypeId !== this.rje ? 0 : 1;
