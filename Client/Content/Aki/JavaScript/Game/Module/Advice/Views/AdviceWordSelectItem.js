...
class AdviceWordSelectItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.sje = 0, this.E9 = 0, this.vje = () => {
      this.Og()
    }, this.jbe = () => {
      ModelManager_1.ModelManager.AdviceModel.CurrentPreSelectWordId = this.sje, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnClickAdviceWord)
  ...
  nHe() {
    ...
    this.sje === ModelManager_1.ModelManager.AdviceModel.CurrentPreSelectWordId ? 1 !== e && this.GetExtendToggle(0).SetToggleStateForce(1, !1) : 0 !== e && this.GetExtendToggle(0).SetToggleStateForce(0, !1)
  }
  T2e() {
    if (0 === this.E9) {
