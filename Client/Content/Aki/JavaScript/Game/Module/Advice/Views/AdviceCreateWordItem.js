...
class AdviceCreateWordItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.Xy = 0, this.J7e = new Array, this.z7e = void 0, this.Z7e = void 0, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.eHe(), this.tHe(), this.iHe(), this.GetItem(1).SetUIActive(!1), this.GetText(0).SetUIActive(!1)
  }
  eHe() {
    for (let t = 0; t < 2; t++) {
  ...
  Z9e() {
    ...
    }), this.z7e.GetRootItem().SetUIParent(e), this.Z7e.GetRootItem().SetUIParent(e), this.z7e.GetRootItem().SetUIActive(!1), this.Z7e.GetRootItem().SetUIActive(!1)
  }
  Y7e() {
    var t = ModelManager_1.ModelManager.AdviceModel.CurrentSentenceWordMap.get(this.Xy);
    if (!(t <= 0)) {
      0 < this.Xy && (this.z7e.GetRootItem().SetUIParent(this.RootItem), this.z7e.GetRootItem().SetUIActive(!0), this.z7e.RefreshView());
      var e = ConfigManager_1.ConfigManager.AdviceConfig.GetAdviceSentenceText(t).split("{}");
      for (let t = 0; t < e.length; t++) this.J7e[t].SetText(e[t]), this.J7e[t].SetUIParent(this.RootItem), t + 1 < e.length && (this.Z7e.GetRootItem().SetUIParent(this.RootItem), this.Z7e.GetRootItem().SetUIActive(!0), this.Z7e.RefreshView()), this.J7e[t].SetUIActive(!0)
    }
  }
}
