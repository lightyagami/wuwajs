    ...
    if (this.Q9e()) {
      if (ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()) {
        ...
        if (AdviceController_1.AdviceController.CheckIfStandAndInValidActor()) {
          return !(e = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity.GetComponent(217)).HasTag(1996802261) && (!!e.HasTag(248240472) || !(Log_1.Log.CheckDebug() && Log_1.Log.Debug("Advice", 27, "行为状态.动作状态.站立Tag"), 1));
        } else {
          if (Log_1.Log.CheckDebug()) {
  ...
  GetCreatePreConditionFailText() {
    ...
    if (ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()) {
      ...
      if (ModelManager_1.ModelManager.CreatureModel.IsMyWorld()) {
        if (AdviceController_1.AdviceController.CheckIfStandAndInValidActor()) {
          if ((e = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity.GetComponent(217)).HasTag(1996802261)) {
