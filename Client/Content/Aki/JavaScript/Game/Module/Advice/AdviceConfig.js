...
class AdviceConfig extends ConfigBase_1.ConfigBase {
  ...
  GetAdviceSpecialParamsContent(e) {
    ...
    if (e) return MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e?.Content)
  }
  ...
  GetAdviceViewCloseDistance() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("CloseAdviceViewEntityDistance") ?? 0
  }
  ...
  GetAdviceDefaultModelConfigId() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("AdviceInteractDefaultModel") ?? 0
  }
  GetAdviceHighNum() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("AdviceHighNum") ?? 0
  }
  GetAdviceLikeShowMax() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("AdviceShowMax") ?? 0
  }
  GetAdviceDefaultModelConfig() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("AdviceShowModel") ?? 0
  }
  GetAdviceCannotPutDistance() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("AdviceCannotPutDistance") ?? 0
  }
  GetAdviceModelMat() {
    return CommonParamById_1.configCommonParamById.GetStringConfig("AdviceModelMat") ?? ""
  }
  GetAdviceCannotPutArea() {
    return CommonParamById_1.configCommonParamById.GetIntArrayConfig("AdviceIgnoreArea") ?? void 0
  }
  GetAdviceCreateText(e) {
    let i = "";
    var r;
    return i = 0 === e ? (r = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_1"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r)) : 1 === e ? (r = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_2"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r)) : (e = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_3"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e))
  }
  GetAdviceTemplateText() {
    var e = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_Template");
