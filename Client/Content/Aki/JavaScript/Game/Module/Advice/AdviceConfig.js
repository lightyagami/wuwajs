...
exports.AdviceConfig = undefined;
...
class AdviceConfig extends ConfigBase_1.ConfigBase {
  ...
  GetAdviceCannotPutArea() {
    return CommonParamById_1.configCommonParamById.GetIntArrayConfig("AdviceIgnoreArea") ?? undefined;
  }
  GetAdviceCreateText(e) {
    let i = "";
    var r;
    return i = e === 0 ? (r = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_1"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r)) : e === 1 ? (r = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_2"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r)) : (e = ConfigManager_1.ConfigManager.TextConfig.GetTextContentIdById("AdviceCreate_3"), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(e));
  }
