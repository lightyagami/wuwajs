...
class AchievementModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.CurrentSelectCategory = void 0, this.CurrentSelectGroup = void 0, this.CurrentSelectAchievementId = 0, this.AchievementSearchState = !1, this.CurrentSearchText = "", this.CurrentFinishAchievementArray = new Array, this.CurrentCacheSearchData = void 0, this.Mbe = new Map, this.Ebe = new Map, this.Sbe = new Array, this.ybe = new Map, this.Ibe = new Map, this.Tbe = new Map, this.Lbe = new Array, this.Dbe = new Array, this.Eth = 0, this.Ith = 0, this.Rbe = (e, t) => t.GetFinishTime() - e.GetFinishTime()
  }
  Ube(e) {
    const t = new Array;
  ...
  Pbe() {
    this.Sbe = new Array, ConfigManager_1.ConfigManager.AchievementConfig.GetAllAchievementCategory().forEach(e => {
  ...
  Gbe(e) {
    var t, i = new AchievementData_1.AchievementData(e);
    i.IfSingleAchievement() || 0 < (t = i.GetNextLink()) && this.GetAchievementData(t).SetLastLink(e), this.Ibe.set(e, i)
  }
  Nbe(e) {
  ...
  PhraseBaseData(e) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Achievement", 27, "Achievement PhraseBaseData response"), this.Lbe = new Array, this.Dbe = new Array, this.Ibe.clear(), this.Ebe.clear(), e.hvs.forEach(e => {
      this.GetAchievementGroupData(e.svs.s5n).Phrase(e.svs), e.avs.forEach(e => {
        var t = this.GetAchievementData(e.s5n);
        t.Phrase(e), 1 === t.GetFinishState() ? this.xbe(t) : 2 === t.GetFinishState() && this.wbe(t)
      })
    }), this.Eth = e.oS_, this.Ith = e.nS_, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnAchievementDataNotify), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshAchievementRedPoint)
  }
  PhraseUpdateData(e) {
  ...
  GetGroupAchievements(e, t = !0) {
    ...
    var r = new Array;
    for (let e = 0; e < i.length; e++) i[e].GetShowState() ? r.push(i[e]) : Log_1.Log.CheckDebug() && Log_1.Log.Debug("Achievement", 27, "GetGroupAchievements not Show", ["id", i[e].GetId()], ["MaxProgress", i[e].GetMaxProgress()]);
    return r
  }
  ...
  GetAchievementCategoryGroups(e, t = !0) {
    ...
    }), r.sort((e, t) => e.GetSort() - t.GetSort()), r
  }
  GetAchievementData(t) {
    if (!this.Ibe.get(t)) try {
      this.Gbe(t)
    } catch (e) {
      e instanceof Error ? Log_1.Log.CheckError() && Log_1.Log.ErrorWithStack("Achievement", 58, "成就初始化异常", e, ["id", t]) : Log_1.Log.CheckError() && Log_1.Log.Error("Achievement", 58, "成就初始化异常", ["error", e])
    }
  ...
  GetRecentFinishedAchievementList() {
    var t, i, r = new Array;
    this.bbe();
    for (let e = 0; e < this.Lbe.length && r.length < RECENT_FINISHED_LIST_LENGTH; e++) r.includes(this.Lbe[e].GetId()) || this.Lbe[e].GetShowState() && (t = this.GetAchievementGroupData(this.Lbe[e].GetGroupId()), t = ConfigManager_1.ConfigManager.AchievementConfig.GetCategoryFunctionType(t.GetCategory()), showFunctionList.includes(t)) && r.push(this.Lbe[e].GetId());
    if (r.length < RECENT_FINISHED_LIST_LENGTH) {
      this.qbe();
      for (let e = 0; e < this.Dbe.length && r.length < RECENT_FINISHED_LIST_LENGTH; e++) r.includes(this.Dbe[e].GetId()) || this.Dbe[e].GetShowState() && (i = this.GetAchievementGroupData(this.Dbe[e].GetGroupId()), i = ConfigManager_1.ConfigManager.AchievementConfig.GetCategoryFunctionType(i.GetCategory()), showFunctionList.includes(i)) && r.push(this.Dbe[e].GetId())
    }
    return r
  }
  ...
  GetCategoryRedPointState(e) {
    return this.GetAchievementCategoryGroups(e, !1).some(e => e.SmallItemRedPoint())
  }
  ...
  Obe(e, t) {
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      const s = new Array;
      n.forEach(e => {
        e.GetTitle() && e.GetDesc() || Log_1.Log.CheckDebug() && Log_1.Log.Debug("Achievement", 27, "成就分类找不到名称", ["id", e.GetId()], ["title", e.GetTitle()], ["desc", e.GetDesc()]), (e.GetTitle()?.includes(t) || e.GetDesc()?.includes(t)) && s.push(e)
  ...
  GetSearchResultData(e) {
    const r = new Array;
    for (const t of e.keys()) e.get(t).forEach((e, t) => {
      var i = new AchievementData_1.AchievementSearchData;
      i.AchievementSearchGroupData = new AchievementData_1.AchievementSearchGroupData, i.AchievementSearchGroupData.AchievementGroupData = t, i.AchievementSearchGroupData.AchievementDataLength = e.length, r.push(i), e.forEach(e => {
  ...
  IsHideAchievementGroup(e) {
    e = this.GetAchievementGroupData(e)?.GetCategory(), e = ConfigManager_1.ConfigManager.AchievementConfig.GetCategoryFunctionType(e);
