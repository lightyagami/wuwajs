...
exports.AchievementCategoryItem = undefined;
const UE = require("ue");
...
class AchievementCategoryItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    ...
    this.jbe = () => {
      ...
      if (e.length > 0) {
        ModelManager_1.ModelManager.AchievementModel.CurrentSelectGroup = e[0];
        AchievementController_1.AchievementController.OpenAchievementDetailView(this.kbe.GetId(), e[0].GetId());
      } else {
        if (Log_1.Log.CheckDebug()) {
          Log_1.Log.Debug("Achievement", 27, "分类下没有成就组");
        }
        ModelManager_1.ModelManager.AchievementModel.CurrentSelectGroup = undefined;
        AchievementController_1.AchievementController.OpenAchievementDetailView(this.kbe.GetId(), undefined);
      }
    };
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UITexture], [2, UE.UIText], [3, UE.UIText], [4, UE.UIItem]];
  ...
  Kbe() {
    if (!StringUtils_1.StringUtils.IsEmpty(this.kbe.GetTexture())) {
