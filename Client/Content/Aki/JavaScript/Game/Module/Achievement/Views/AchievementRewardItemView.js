...
exports.AchievementRewardItemView = undefined;
const UE = require("ue");
...
class AchievementRewardItemView extends UiTickViewBase_1.UiTickViewBase {
  ...
  aGe() {
    ...
    if (!ModelManager_1.ModelManager.ItemHintModel.IsAchievementItemRewardListEmpty) {
      this.tGe = ModelManager_1.ModelManager.ItemHintModel.ShiftAchievementItemRewardListFirst();
  ...
  SetResetTime() {
    ...
    if (e < TimerSystem_1.MIN_TIME) {
      if (Log_1.Log.CheckError()) {
        Log_1.Log.Error("ItemHint", 5, "AchievementRewardItemView ShowTime 小于100", ["DropGroupId", this.iGe.Id], ["ShowTime", e]);
      }
    } else {
      this.oGe = e;
    }
