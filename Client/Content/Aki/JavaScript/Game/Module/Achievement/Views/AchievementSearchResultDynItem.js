...
class AchievementSearchResultDynItem extends UiPanelBase_1.UiPanelBase {
  ...
  OnStart() {
    ...
    this.MGe.Set(e.GetWidth(), e.GetHeight()), this.EGe = Vector2D_1.Vector2D.Create(), e = this.GetItem(1), this.EGe.Set(e.GetWidth(), e.GetHeight())
  }
  GetItemSize(e) {
    return e.AchievementSearchGroupData ? this.MGe.ToUeVector2D(!0) : e.AchievementData ? this.EGe.ToUeVector2D(!0) : (new Vector2D_1.Vector2D).ToUeVector2D()
  }
  ClearItem() {}
}
