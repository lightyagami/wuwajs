...
exports.AchievementFinishView = undefined;
const UE = require("ue");
const TickSystem_1 = require("../../../../Core/Tick/TickSystem");
const StringUtils_1 = require("../../../../Core/Utils/StringUtils");
const ModelManager_1 = require("../../../Manager/ModelManager");
const UiViewBase_1 = require("../../../Ui/Base/UiViewBase");
const CLOSE_TIMER_DOWN = 4000;
class AchievementFinishView extends UiViewBase_1.UiViewBase {
  ...
  OnBeforeShow() {
    ...
    this.iqe = ModelManager_1.ModelManager.AchievementModel.GetAchievementData(e);
    this.Aqe();
    this.Pqe();
    this.jm();
    this.Rqe = TickSystem_1.TickSystem.Add(this.J_, "Achievement", 0, true, undefined, true).Id;
  }
  Aqe() {
    var e = this.iqe.GetGroupId();
    var e = ModelManager_1.ModelManager.AchievementModel.GetAchievementGroupData(e);
