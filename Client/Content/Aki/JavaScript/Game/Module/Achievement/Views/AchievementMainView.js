...
class AchievementMainView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Wqe = void 0, this.Kqe = void 0, this.lqe = void 0, this.xqe = void 0, this.Qqe = void 0, this.Xqe = () => {
  ...
  OnStart() {
    this.Kqe = this.GetText(0), this.Wqe = this.GetText(1), this.lqe = new PopupCaptionItem_1.PopupCaptionItem(this.GetItem(2)), this.lqe.SetCloseCallBack(this.Awe), this.Qqe = new LoopScrollView_1.LoopScrollView(this.GetLoopScrollViewComponent(3), this.GetItem(5).GetOwner(), this.Jqe);
  ...
  OnBeforeDestroy() {
    this.lqe && (this.lqe.Destroy(), this.lqe = void 0), this.Qqe && (this.Qqe.ClearGridProxies(), this.Qqe = void 0), this.Wqe && (this.Wqe = void 0), this.Kqe && (this.Kqe = void 0)
  }
  aqe() {
  ...
  $qe() {
    ...
    }), this.Qqe.RefreshByData(r), this.Qqe.SetTargetRootComponentActive(i), this.GetItem(6).SetUIActive(!i)
  }
  zqe() {
