...
class AchievementSearchContentItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.tqe = void 0, this.iqe = void 0, this.hGe = void 0, this.oqe = void 0, this.lGe = void 0, this.wqe = void 0, this.rqe = e => {
      ModelManager_1.ModelManager.AchievementModel.AchievementSearchState || e === this.iqe?.GetId() && (this.iqe?.IfSingleAchievement() || !this.iqe?.IfSingleAchievement() && 0 === this.iqe.GetNextLink()) && (this.Pqe(), this.Nqe(), this.aqe(), this._Ge(), this.jqe(), this.uGe(), this.cGe())
    }, this.nqe = () => {
  ...
  OnStart() {
    this.hGe = new AchievementProgressItem_1.AchievementProgressItem(this.GetItem(6)), this.hGe.SetActive(!0), this.oqe = new AchievementGridItem_1.AchievementGridItem, this.oqe.Initialize(this.GetItem(1).GetOwner()), this.lGe = new AchievementProgressConfirmItem_1.AchievementProgressConfirmItem(this.GetItem(0)), this.lGe.SetClickCallback(this.nqe), this.AddEventListener()
  }
  AddEventListener() {
  ...
  Update(e) {
    this.iqe = e.AchievementData, this.mGe(), this.Pqe(), this.Nqe(), this.aqe(), this._Ge(), this.jqe(), this.uGe(), this.cGe()
  }
  mGe() {
    ModelManager_1.ModelManager.AchievementModel.AchievementSearchState ? this.GetText(2).SetText(this.iqe.GetReplaceTitle(ModelManager_1.ModelManager.AchievementModel.CurrentSearchText)) : this.GetText(2).SetText(this.iqe.GetTitle())
  }
  Pqe() {
    ModelManager_1.ModelManager.AchievementModel.AchievementSearchState ? this.GetText(4).SetText(this.iqe.GetReplaceDesc(ModelManager_1.ModelManager.AchievementModel.CurrentSearchText)) : this.GetText(4).SetText(this.iqe.GetDesc())
  }
  Nqe() {
  ...
  OnBeforeDestroy() {
    this.tqe && (this.tqe.Destroy(), this.tqe = void 0), this.RemoveEventListener()
  }
