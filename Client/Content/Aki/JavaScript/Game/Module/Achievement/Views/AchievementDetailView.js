...
exports.AchievementDetailView = undefined;
const UE = require("ue");
...
class AchievementDetailView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.pqe = e => {
      ...
      var t = ModelManager_1.ModelManager.AchievementModel.GetAchievementCategoryGroups(e.GetId());
      if (!(t.length <= 0)) {
    ...
    this.Mbe = e => {
      ...
      ModelManager_1.ModelManager.AchievementModel.RefreshSearchResult();
      ModelManager_1.ModelManager.AchievementModel.AchievementSearchState = !StringUtils_1.StringUtils.IsEmpty(e);
      this.Mqe();
      this.Sqe();
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnGetAchievementSearchTextChange);
    };
    this.Tqe = () => {
      var e = ModelManager_1.ModelManager.AchievementModel.AchievementSearchState;
      ModelManager_1.ModelManager.AchievementModel.AchievementSearchState = false;
      ModelManager_1.ModelManager.AchievementModel.CurrentSearchText = StringUtils_1.EMPTY_STRING;
      if (e !== ModelManager_1.ModelManager.AchievementModel.AchievementSearchState) {
        this.Mqe();
        this.Eqe();
      }
      this.Sqe();
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIDynScrollViewComponent], [2, UE.UIItem], [3, UE.UIItem], [4, UE.UIItem], [5, UE.UIItem], [6, UE.UIItem], [7, UE.UIItem], [8, UE.UIItem], [9, UE.UIItem], [10, UE.UIText]];
  }
  async OnBeforeStartAsync() {
    this.mqe = new AchievementGroupSmallDynItem_1.AchievementGroupSmallDynItem();
    this.gqe = new DynScrollView_1.DynamicScrollView(this.GetUIDynScrollViewComponent(1), this.GetItem(6), this.mqe, this.Lqe);
    await this.gqe.Init();
    this.uqe = new AchievementGroupDataItem_1.AchievementGroupDataItem(this.GetItem(4));
    await this.uqe.Init();
    this._qe = new AchievementSearchItem_1.AchievementSearchItem(this.GetItem(5));
    await this._qe.Init();
    this.Cqe = ModelManager_1.ModelManager.AchievementModel.GetAchievementCategoryArray();
    var e = new CommonTabComponentData_1.CommonTabComponentData(this.fqe, this.pqe, this.yqe);
    this.lqe = new TabComponentWithCaptionItem_1.TabComponentWithCaptionItem(this.GetItem(0), e, this.Awe);
    await this.Dqe();
  }
  async Dqe() {
    var t = this.Cqe;
    var i = this.lqe.CreateTabItemDataByLength(t.length);
    for (let e = 0; e < t.length; e++) {
      i[e].RedDotName = "AchievementCategory";
      i[e].RedDotUid = t[e].GetId();
    }
    await this.lqe.RefreshTabItemAsync(i, false);
  }
  OnBeforeShow() {
    var e = ModelManager_1.ModelManager.AchievementModel.CurrentSelectCategory;
    if (e !== undefined && !((e = ModelManager_1.ModelManager.AchievementModel.GetAchievementCategoryIndex(e)) < 0)) {
  ...
  OnStart() {
    ...
    this.dqe = new CommonSearchComponent_1.CommonSearchComponent(this.GetItem(7), this.Mbe, this.Tqe);
  }
  OnAddEventListener() {
  ...
  Sqe() {
    var e = ModelManager_1.ModelManager.AchievementModel.AchievementSearchState;
    var t = ModelManager_1.ModelManager.AchievementModel.GetSearchResultIfNull();
  ...
  Mqe() {
    ...
    if (e) {
      e = ModelManager_1.ModelManager.AchievementModel.GetSearchResultIfNull();
      this.GetItem(8)?.SetUIActive(!e);
      this.GetItem(9)?.SetUIActive(e);
      this._qe.Update();
    } else {
      if (ModelManager_1.ModelManager.AchievementModel.CurrentSelectGroup) {
