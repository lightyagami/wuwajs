...
class AchievementCompleteTipsView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.Xbe = void 0, this.$be = void 0, this.Ybe = 4e3, this.Jbe = () => {
  ...
  OnStart() {
    ...
    void 0 !== i && (this.$be = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(2), this.zbe), e = i.GetGroupId(), e = ModelManager_1.ModelManager.AchievementModel.GetAchievementGroupData(e), StringUtils_1.StringUtils.IsEmpty(e.GetTexture()) || this.SetTextureByPath(e.GetTexture(), this.GetTexture(0)), this.GetText(1).SetText(i.GetTitle()), this.Zbe(i), this.Xbe = TimerSystem_1.TimerSystem.Delay(this.Jbe, this.Ybe))
  }
  Zbe(e) {
    var i = [],
      t = e.GetMaxStar(),
