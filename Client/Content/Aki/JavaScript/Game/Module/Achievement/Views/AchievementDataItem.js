...
exports.AchievementDataItem = undefined;
const UE = require("ue");
...
class AchievementDataItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[1, UE.UIItem], [2, UE.UIButtonComponent], [3, UE.UIText], [4, UE.UIItem], [5, UE.UIText], [6, UE.UIText], [7, UE.UIText], [8, UE.UIItem], [9, UE.UIItem]];
    this.BtnBindInfo = [[2, this.nqe]];
  }
  OnStart() {
    if (this.oqe === undefined) {
  ...
  RefreshUi(e) {
    ...
    if (e === undefined) {
      ...
      if (ModelManager_1.ModelManager.AchievementModel.AchievementSearchState) {
        n = ModelManager_1.ModelManager.AchievementModel.CurrentSearchText;
        o.SetText(e.GetReplaceTitle(n));
        r.SetText(e.GetReplaceDesc(n));
      } else {
        o.SetText(e.GetTitle());
        r.SetText(e.GetDesc());
      }
      LguiUtil_1.LguiUtil.SetLocalText(this.GetText(7), "CollectProgress", t, i);
      ...
      if (s === 0) {
        ...
        h?.SetUIActive(true);
        n = TimeUtil_1.TimeUtil.DateFormat4(new Date(e.GetFinishTime() * TimeUtil_1.TimeUtil.InverseMillisecond));
        h?.SetText(n);
      }
      if ((o = e.GetRewards()).length > 0) {
        this.sqe(o[0]);
      }
      this.aqe();
    }
