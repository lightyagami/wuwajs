...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.AchievementSearchGroupData = exports.AchievementSearchData = exports.AchievementGroupData = exports.AchievementCategoryData = exports.AchievementData = void 0;
...
class AchievementData {
  constructor(t) {
    this.xe = t, this._be = void 0, this.gbe = 0, this.ube = -1, this.cbe = new Array, this.mbe = !1, this.dbe = void 0, this.Cbe = void 0, this.nba = -1, this.gbe = ConfigManager_1.ConfigManager.AchievementConfig.GetAchievementNextLink(this.xe)
  }
  SetLastLink(t) {
    this.ube = t
  }
  Phrase(t) {
    this._be = t.rvs, this.mbe = t.ovs, this.dbe = t.nvs.tvs, this.Cbe = t.nvs.ivs, this.nba = ConfigManager_1.ConfigManager.AchievementConfig.GetThirdPartyTrophyId(this.xe), this.sba()
  }
  sba() {
    var t = this.GetThirdPartyTrophyId();
    0 !== this.GetFinishState() && -1 !== t && PlatformSdkManagerNew_1.PlatformSdkManagerNew.GetPlatformSdk()?.UnlockSdkTrophy(t)
  }
  GetId() {
    return this.xe
  }
  ...
  GetShowState() {
    ...
    if (-1 !== this.ube && 2 !== ModelManager_1.ModelManager.AchievementModel.GetAchievementData(this.ube).GetFinishState()) return !1;
  ...
  GetReplaceDesc(t) {
    ...
    var r = new StringBuilder_1.StringBuilder,
      i = CommonParamById_1.configCommonParamById.GetStringConfig("TutorialSearchColor"),
      i = (r.Append("<color="), r.Append(i?.toLowerCase() + ">"), r.Append(t), r.Append("</color>"), "" + t);
  ...
  GetMaxStar() {
    ...
    for (; t?.gbe;) t = ModelManager_1.ModelManager.AchievementModel.GetAchievementData(t?.gbe);
    const e = ConfigManager_1.ConfigManager.AchievementConfig.GetAchievementLevel(t.GetId());
    return e
  }
  GetFinishedStar() {
    var t, e;
    return this.GetShowState() ? (t = ConfigManager_1.ConfigManager.AchievementConfig.GetAchievementLevel(this.xe), this.IfSingleAchievement() ? 2 === this.GetFinishState() || 1 === this.GetFinishState() ? t : 0 : (e = this.fbe(), 2 === this.GetFinishState() || 1 === this.GetFinishState() ? t + e : 0 === this.GetFinishState() ? e : (0 <= t - 1 ? t - 1 : 0) + e)) : 0
  }
  fbe() {
    let t = 0,
      e = this.ube;
    for (; - 1 !== e;) {
      ...
      t += ConfigManager_1.ConfigManager.AchievementConfig.GetAchievementLevel(e), e = r.ube
    }
    return t
  }
  GetAchievementShowStar() {
    var t;
    return this.GetShowState() ? (t = ConfigManager_1.ConfigManager.AchievementConfig.GetAchievementLevel(this.xe), this.IfSingleAchievement() || 2 === this.GetFinishState() || 1 === this.GetFinishState() ? t : 0 <= t - 1 ? t - 1 : 0) : 0
  }
  ...
  GetFinishSort() {
    return 2 === this.GetFinishState() ? 0 : 1 === this.GetFinishState() ? 2 : 1
  }
  GetFinishTime() {
    return this._be
  }
...
class AchievementCategoryData {
  ...
  GetAchievementCategoryProgress() {
    ...
    for (const i of ModelManager_1.ModelManager.AchievementModel.GetAchievementCategoryGroups(this.xe))
      for (const a of ModelManager_1.ModelManager.AchievementModel.GetGroupAchievements(i.GetId(), !1)) {
        var r = a.GetFinishState();
        a.GetHiddenState() && 0 === r || void 0 === a.GetMaxProgress() || (t++, 0 !== r && e++)
      }
...
class AchievementGroupData {
  constructor(t) {
    this.xe = t, this.mbe = !1, this._be = 0, this.cbe = new Array, this.pbe = !1, this.vbe = !1
  }
  Phrase(t) {
  ...
  RedPoint() {
    return 1 === this.GetFinishState() && !(!this.GetShowState() || this.GetRewards().length <= 0)
  }
  GetCurrentProgress() {
...
class AchievementSearchData {
  constructor() {
    this.AchievementCategoryData = void 0, this.AchievementSearchGroupData = void 0, this.AchievementData = void 0
  }
}
