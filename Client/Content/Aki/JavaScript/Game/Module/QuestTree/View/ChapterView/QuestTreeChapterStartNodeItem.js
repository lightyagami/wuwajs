...
class QuestTreeChapterStartNodeItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    ...
    this.J_ = e => {
      ...
      if (i) {
        t.SetAdditionalHeight(this.Rjd - i.GetAdditionalHeight());
      }
    };
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.Rjd = this.GetUiSizeControlByOther(5).GetAdditionalHeight();
    this.ATd = new GenericLayout_1.GenericLayout(this.GetVerticalLayout(4), () => QuestTreeNodeItemFactory_1.QuestTreeNodeItemFactory.Instance.CreateLogicalNodeItem(4));
    this.DTd();
