...
class QuestTreeNodeDetailView extends UiViewBase_1.UiViewBase {
  ...
  async CPd() {
    ...
    var i = e?.IsSuspend() && e.GetSuspendType() === 2;
    this.GetItem(19).SetUIActive(this.Pe.State === 4);
    this.GetItem(20).SetUIActive(this.Pe.State === 1 && !i);
    this.GetItem(15).SetUIActive(this.Pe.IsTracking && !i);
    this.dPd.SetActive((this.Pe.State === 2 || this.Pe.State === 3) && !this.Pe.IsTracking && !i);
