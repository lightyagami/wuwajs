...
class RoleSkinData {
  constructor(e) {
    this.ItemId = void 0, this.qIl = void 0, this.Rjt = !0, this.ItemId = e, this.qIl = ConfigManager_1.ConfigManager.SkinConfig.GetRoleSkinConfig(this.ItemId)
  }
  GetItemConfig() {
  ...
  GetIfHaveRole() {
    return void 0 !== ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(this.GetRoleId())
  }
  IsWearWeaponSkin() {
    var e;
  ...
  GetSuitWeaponSkinConfig() {
    ...
    if (!(e <= 0)) return ConfigManager_1.ConfigManager.SkinConfig.GetWeaponSkinConfig(this.GetSuitWeaponSkinId())
  }
