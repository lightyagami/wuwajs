...
exports.SkinObtainItem = undefined;
const UE = require("ue");
const SkipTaskManager_1 = require("../../SkipInterface/SkipTaskManager");
const GridProxyAbstract_1 = require("../../Util/Grid/GridProxyAbstract");
const LguiUtil_1 = require("../../Util/LguiUtil");
class SkinObtainItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments);
    this.Pe = undefined;
    this.eTt = () => {
...
exports.SkinObtainItem = SkinObtainItem;
//# sourceMappingURL=SkinObtainItem.js.map