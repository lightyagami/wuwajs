...
class RoleSkinModel extends ModelBase_1.ModelBase {
  ...
  GetRoleOriginalSkinData(e, o = !0) {
    ...
    if (void 0 !== e) return o = e.GetRoleConfig().SkinId, this.GetRoleSkinData(o)
  }
  ...
  GetSkinTabList() {
    ...
    for (let e = 0; e < r; e++) {
      var n = o[e];
      ModelManager_1.ModelManager.FunctionModel.IsOpen(n.FunctionId) && a.push(n)
    }
    return a
  }
  ...
  HasRoleSkinRedDotByRoleId(e) {
    for (const r of this.GetRoleSkinDataList(e)) {
      ...
      if (void 0 !== o && !o.IsLocked() && ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.RoleSkinRedDot, r.GetItemId())) return !0
    }
    return !1
  }
  RecordSuitWeaponFirstWear(e, o) {
    ...
    r.set(e, o), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SuitWeaponFirstWearRecord, r)
  }
}
