...
class SkinRootView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.TabViewComponent = void 0, this.TabComponent = void 0, this.TabDataList = [], this.yil = void 0, this.L6e = 0, this.Nlo = 0, this.c8l = !1, this.R6e = e => new SkinTabItem_1.SkinTabItem, this.pqe = e => {
      this.L6e = Time_1.Time.Now;
      var t = this.TabDataList[e],
        i = t.ChildViewName,
        e = this.TabComponent.GetTabItemByIndex(e);
      this.TabViewComponent.ToggleCallBack(t, i, e, this.yil), this.TabComponent.SetHelpButtonShowState("RoleSkinTabView" === i), this.yil.CurSelectTabViewName = i, this.RefreshGamePadKeyTip()
    }, this.yqe = e => {
      ...
      "RoleWeaponTabView" !== this.TabViewComponent.GetCurrentTabViewName() && HelpController_1.HelpController.OpenHelpById(146)
    }
  }
  OnRegisterComponent() {
    this.yil = this.OpenParam, this.yil.RegisterView(this), this.ComponentRegisterInfos = [
      [0, UE.UIItem],
      [1, UE.UIItem],
  ...
  async OnBeforeStartAsync() {
    ...
    this.TabComponent = new TabComponentWithCaptionItem_1.TabComponentWithCaptionItem(this.GetItem(0), e, this.yil.CloseView), this.TabComponent.SetHelpButtonCallBack(this.pcr), this.TabComponent.SetCanChange(this.CanToggleChange), this.TabViewComponent = new TabViewComponent_1.TabViewComponent(this.GetItem(1)), await this.d8l()
  }
  OnHandleLoadScene() {
    var e;
  ...
  async d8l() {
    var e;
    AudioSystem_1.AudioSystem.SetState(RoleDefine_1.ROLE_MUTE_NATURE_AUDIO_GROUP, "mute"), this.yil.NeedLoadRole ? !this.c8l && (this.c8l = !0, this.yil.TsUiSceneRoleActor = UiSceneManager_1.UiSceneManager.InitRoleSystemRoleActor(11), e = ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(this.yil.RoleId), await RoleController_1.RoleController.RefreshUiSceneRoleActorAsync(this.yil.TsUiSceneRoleActor, this.yil.RoleId, e.GetRoleSkinId()), UiSceneManager_1.UiSceneManager.GetActorByTag("RoleCase")) && this.yil.TsUiSceneRoleActor.Model.CheckGetComponent(1)?.SetTransformByTag("RoleCase") : this.yil.TsUiSceneRoleActor = UiSceneManager_1.UiSceneManager.GetRoleSystemRoleActor()
  }
  OnHandleReleaseScene() {
    this.yil.NeedLoadRole && EffectSystem_1.EffectSystem.IsValid(this.Nlo) && EffectSystem_1.EffectSystem.StopEffectById(this.Nlo, "[RoleRootView.HandleReleaseScene]", !1)
  }
  OnBeforeShow() {
    this.UpdateDynamicTabComponent(), this.RefreshGamePadKeyTip()
  }
  ...
  OnBeforeHide() {
    this.TabViewComponent.HideCurrentTabView(), this.LastHide && this.yil.BeforeDestroy()
  }
  OnBeforeDestroy() {
    AudioSystem_1.AudioSystem.SetState(RoleDefine_1.ROLE_MUTE_NATURE_AUDIO_GROUP, "none"), this.m8l()
  }
  m8l() {
    this.c8l && (this.c8l = !1, UiSceneManager_1.UiSceneManager.DestroyRoleSystemRoleActor(this.yil.TsUiSceneRoleActor), this.yil.TsUiSceneRoleActor = void 0)
  }
  HideView() {
  ...
  RefreshGamePadKeyTip() {
    var e;
    this.GetItem(3)?.SetUIActive(!1), this.GetItem(4)?.SetUIActive(!1), "RoleSkinTabView" === this.yil.CurSelectTabViewName ? this.GetItem(3)?.SetUIActive(!0) : "FlySkinTabView" === this.yil.CurSelectTabViewName && (e = !this.TabComponent.IsUiActiveInHierarchy(), this.GetItem(4)?.SetUIActive(e))
  }
  GetDragItem() {
