...
class CalabashSkinController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    ...
    Net_1.Net.Register(28505, e => {
      ModelManager_1.ModelManager.CalabashSkinModel.NotifyCurrentEquippedSkinId(e.Z7n);
    });
    Net_1.Net.Register(22675, e => {
      var r = MathUtils_1.MathUtils.LongToNumber(e.F4n);
      var t = e.BLd?.ULd ?? 0;
      if (Log_1.Log.CheckInfo()) {
        Log_1.Log.Info("CalabashSkin", 10, "服务器下发葫芦皮肤", ["CalabashSkinId", e.BLd?.ULd], ["ServerEntityId", r]);
      }
  ...
  static OnUnRegisterNetEvent() {
    ...
    Net_1.Net.UnRegister(28505);
    Net_1.Net.UnRegister(22675);
  }
  static UDd() {
    var e = Protocol_1.Aki.Protocol.CLd.create();
    Net_1.Net.Call(21325, e, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19628);
        } else {
          ModelManager_1.ModelManager.CalabashSkinModel.NotifyCalabashSkinData(e.kLd, e.OLd);
          ControllerHolder_1.ControllerHolder.InventoryController.InitCalabashSkinItemData(e.OLd);
        }
      }
    });
  }
  static async RequestCalabashSkinTakeOn(e) {
    ...
    var t = Protocol_1.Aki.Protocol.fLd.create();
    t.Z7n = e;
    Net_1.Net.Call(22183, t, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 18292);
          r.SetResult(false);
        } else {
          ModelManager_1.ModelManager.CalabashSkinModel.NotifyCurrentEquippedSkinId(e.Z7n);
          r.SetResult(true);
