...
class FlySkinChildTabItem extends UiPanelBase_1.UiPanelBase {
  ...
  Update(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e), this.Ovt(), this.K8e()
  }
  K8e() {
    var e = this.GetItem(2);
    RedDotController_1.RedDotController.BindRedDot("FlySkinChildTab", e, void 0, this.h3c)
  }
  Ovt() {
    var e = this.GetItem(2);
