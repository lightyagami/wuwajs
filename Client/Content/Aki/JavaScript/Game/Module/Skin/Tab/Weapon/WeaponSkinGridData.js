...
exports.WeaponSkinData = undefined;
...
class WeaponSkinData {
  ...
  get Name() {
    if (this.IsEmptyData) {
      return ConfigManager_1.ConfigManager.SkinConfig.GetDefaultWeaponSkinName();
    } else {
      return ConfigManager_1.ConfigManager.SkinConfig.GetWeaponSkinConfig(this.SkinId).Name;
    }
  }
  get Description() {
    if (this.IsEmptyData) {
      return ConfigManager_1.ConfigManager.SkinConfig.GetDefaultWeaponSkinDescription();
    } else {
      return ConfigManager_1.ConfigManager.SkinConfig.GetWeaponSkinConfig(this.SkinId).BgDescription;
    }
  }
  get IsNew() {
