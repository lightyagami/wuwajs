...
class FlySkinController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(28353, this.Bkc);
    Net_1.Net.Register(19139, this.kkc);
    Net_1.Net.Register(15817, this.mGc);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(28353);
    Net_1.Net.UnRegister(19139);
    Net_1.Net.UnRegister(15817);
  }
      ...
      Net_1.Net.Call(22826, e, e => {
        if (e) {
          if (e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs) {
            ...
            ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 20505);
          }
        }
      });
    }
      ...
      Net_1.Net.Call(29696, t, e => {
        if (e) {
          if (e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs) {
            ...
            ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 16331);
          }
        }
      });
    }
      ...
      Net_1.Net.Call(15315, e, e => {
        if (e) {
          if (e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs) {
            ...
            ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 20275);
          }
        }
      });
    }
