...
class GameplayEnterView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.TimerId = void 0, this.iZe = () => {
      this.Tpi()
    }
  }
  OnRegisterComponent() {
  ...
  Tpi() {
    ...
    i && (e = ConfigManager_1.ConfigManager.TextConfig.GetTextById(i.InfoId ?? ""), i = PublicUtil_1.PublicUtil.GetConfigTextByKey(i.TitleId ?? ""), this.GetText(0).SetText(e ?? ""), this.GetText(1).SetText(i))
  }
