...
class SceneGameplayItemRewardView extends CommonResultView_1.CommonResultView {
  ...
  OnAddEventListener() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.PlotNetworkStart, this.evi), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.PlotNetworkEnd, this.tvi)
  }
  OnRemoveEventListener() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.PlotNetworkStart, this.evi), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.PlotNetworkEnd, this.tvi)
  }
  OnStart() {
  ...
  Yli() {
    var e = ModelManager_1.ModelManager.ItemHintModel.ShiftItemRewardListFirst(),
      e = ItemHintController_1.ItemHintController.CombineAllShowItems(e.ItemReward, !0),
