...
class LevelPlayConfig extends ConfigBase_1.ConfigBase {
  GetExchangeRewardInfo(e) {
    ...
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("SceneGameplay", 18, "找不到兑换奖励表配置", ["配置表路径", "Source/Config/Raw/Tables/d.兑换奖励配置"], ["Id", e]), a
  }
  GetLevelPlayConfig(e) {
    var a = LevelPlayDataById_1.configLevelPlayDataById.GetConfig(e, !1);
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("SceneGameplay", 18, "找不到任务配置", ["玩法Id", e]), a
  }
  GetLevelPlayNodeConfig(e, a) {
    var o = LevelPlayNodeDataByKey_1.configLevelPlayNodeDataByKey.GetConfig(e + "_" + a, !1);
    return o || Log_1.Log.CheckError() && Log_1.Log.Error("Quest", 18, "找不到玩法节点配置", ["玩法Id", e], ["节点Id", a]), o
  }
}
