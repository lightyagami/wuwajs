...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.OnlineModel = exports.onlineDisabledSourceTipsId = exports.onlineContinuingChallengeIcon = void 0;
...
class OnlineModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.ZGi = void 0, this.eNi = void 0, this.tNi = void 0, this.WorldTeamPlayerFightInfo = [], this.iNi = Protocol_1.Aki.Protocol.Y8s.Proto_ConfirmJoin, this.oNi = void 0, this.rNi = 0, this.nNi = 0, this.sNi = 0, this.aNi = 0, this.hNi = void 0, this.lNi = 3, this._Ni = !1, this.uNi = !1, this.cNi = void 0, this.mNi = new Map, this.dNi = -1, this.CNi = -1, this.gNi = !0, this.fNi = new Map, this.CachePlayerData = void 0, this.HallViewIsShowSearching = !1, this.Ofa = (e, t) => {
      var i = ModelManager_1.ModelManager.WorldLevelModel.OriginWorldLevel;
      return e.PlayerOriginWorldLevel > i && t.PlayerOriginWorldLevel > i || e.PlayerOriginWorldLevel <= i && t.PlayerOriginWorldLevel <= i ? t.PlayerLastOfflineTime - e.PlayerLastOfflineTime : e.PlayerOriginWorldLevel - t.PlayerOriginWorldLevel
    }, this.$Ga = new Map, this.OtherScenePlayerDataList = [], this.fh1 = !0
  }
  OnInit() {
    return this.ZGi = new Array, this.eNi = new Array, this.tNi = new Array, this.oNi = new Map, this.hNi = new Map, this.rNi = -1, this.aNi = -1, this.nNi = CommonParamById_1.configCommonParamById.GetIntConfig("apply_valid_time"), this.sNi = CommonParamById_1.configCommonParamById.GetIntConfig("world_level_enter_diff"), this.cNi = new Map, !0
  }
  OnClear() {
    return this.ZGi && (this.ZGi.length = 0), this.ZGi = void 0, this.eNi && (this.eNi.length = 0), this.eNi = void 0, this.tNi && (this.tNi.length = 0), this.tNi = void 0, this.oNi && this.oNi.clear(), this.oNi = void 0, this.hNi && this.hNi.clear(), this.hNi = void 0, this.rNi = void 0, this.nNi = void 0, this.sNi = void 0, this.cNi?.clear(), this.cNi = void 0, this.mNi && this.mNi.clear(), this.fNi && this.fNi.clear(), this.dNi = -1, this.CNi = -1, this.gNi = !0
  }
  OnLeaveLevel() {
    return this.mNi && this.mNi.clear(), this.dNi = -1, this.CNi = -1, this.gNi = !0, this.$Ga.clear(), !0
  }
  OnChangeMode() {
  ...
  SetPermissionsSetting(e) {
    this.iNi = e, ModelManager_1.ModelManager.GameModeModel?.IsMulti && this.GetIsMyTeam() && (e = this.GetGameJoinTypeToPlayStationJoinType(), PlatformSdkManagerNew_1.PlatformSdkManagerNew.GetPlatformSdk()?.SetPlayerSessionJoinAbleUserType(e))
  }
  ...
  DeleteCurrentApplyListById(t) {
    if (this.oNi.delete(t), this.oNi.size < 1) this.rNi = -1;
      ...
      let e = this.nNi;
      for (const [t, i] of this.oNi) i.ApplyTimeLeftTime <= e && (e = i.ApplyTimeLeftTime, this.rNi = t)
    }
  }
  ...
  GetCanJoinFormFriend() {
    var e = ModelManager_1.ModelManager.WorldLevelModel.CurWorldLevel,
      t = new Array;
    for (const i of this.eNi) this.CanJoinOtherWorld(e, i.WorldLevel) && t.push(i);
    return t
  }
  ...
  DisableOnline(t, e, i = 0, r = 0) {
    if (e) {
      let e = !1;
      for (var [s] of this.cNi) s.TreeId === i && s.NodeId === r && s.Type === t && (this.cNi?.set(s, t), e = !0);
      e || this.cNi?.set({
        Type: t,
        TreeId: i,
        NodeId: r
      ...
      for (var [n] of this.cNi) n.TreeId === i && n.NodeId === r && n.Type === t && this.cNi?.delete(n);
  ...
  DeleteWorldTeamPlayerFightInfo(e) {
    for (const t of this.WorldTeamPlayerFightInfo) t.PlayerId === e && this.WorldTeamPlayerFightInfo.splice(this.WorldTeamPlayerFightInfo.indexOf(t), 1)
  }
    ...
    for (const r of e) {
      ...
      if (t)
        for (const s of r.kVn)
          if (-1 === s.GVn) {
            var i = new Array;
            for (const n of s.dUs) i.push(new OnlineHallData_1.WorldTeamRoleInfo(n.Q6n, n.eI_, n.F6n));
            t.RoleInfos = i
          }
    }
  }
  ...
  SetRoleActivated(t, i) {
    ...
    if (i) {
      ...
      (e = i ? ModelManager_1.ModelManager.CreatureModel.GetEntity(i.GetCreatureDataId())?.Entity : e)?.Valid && (r || (r = new Set, this.$Ga.set(t, r)), r.has(e.Id) || (e.DisableByKey(0, !0), r.add(e.Id)))
    }
  }
  ...
  DeleteOtherScenePlayerDataList(e) {
    for (const t of this.OtherScenePlayerDataList) t.PlayerId === e && this.OtherScenePlayerDataList.splice(this.OtherScenePlayerDataList.indexOf(t), 1)
  }
  PushOtherScenePlayerDataList(e) {
    this.OtherScenePlayerDataList.push(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ScenePlayerChanged)
  }
  ...
  SetPlayerGravityIsNormal(e) {
    e && (0 !== e.X || 0 !== e.Y || -1 !== e.Z) ? this.fh1 = !1 : this.fh1 = !0, this.DisableOnline(3, !this.fh1)
  }
}
