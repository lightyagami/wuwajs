...
class OnlineChallengePlayerStateItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, r) {
    ...
    e ? (this.GetText(1).SetText(e.Name), (e = ModelManager_1.ModelManager.PersonalModel.GetPlayerHeadData(e.HeadId, !1)) && this.SetTextureByPath(e.GetRoleHeadIconCircle(), this.GetTexture(0)), e = ModelManager_1.ModelManager.OnlineModel.GetContinuingChallengeConfirmState(this.j8), this.SetTeamPlayerSprite(this.j8, e)) : Log_1.Log.CheckError() && Log_1.Log.Error("MultiPlayerTeam", 5, "获取队友联机时，失败", ["PlayerId", this.j8])
  }
  SetTeamPlayerSprite(e, t) {
    if (this.j8 === e) switch (t) {
      case 0:
