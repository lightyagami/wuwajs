...
exports.OnlineMultipleApplyView = undefined;
const UE = require("ue");
...
class OnlineMultipleApplyView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments);
    this.bNi = undefined;
    this.oOi = () => new OnlineMultipleApplyItem_1.OnlineMultipleApplyItem();
    this.rOi = () => {
  ...
  OnBeforeDestroy() {
    if (this.bNi) {
      this.bNi.ClearGridProxies();
    }
    if (ModelManager_1.ModelManager.OnlineModel.GetCurrentApplyList().length > 0) {
