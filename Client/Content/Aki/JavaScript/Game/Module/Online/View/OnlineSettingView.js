...
class OnlineSettingView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.hOi = Protocol_1.Aki.Protocol.Y8s.Proto_ConfirmJoin, this.lOi = void 0, this.Bpt = e => this.hOi !== e, this._Oi = () => {
      OnlineController_1.OnlineController.WorldEnterPermissionsRequest(this.hOi), this.CloseMe()
    }, this.uOi = e => {
      this.hOi = e;
      for (var [t, i] of this.lOi) t === this.hOi ? i.SetSelected(!0) : i.SetSelected(!1)
    }
  }
  OnRegisterComponent() {
  ...
  OnBeforeShow() {
    this.hOi = ModelManager_1.ModelManager.OnlineModel.CurrentPermissionsSetting, this.cOi()
  }
  OnBeforeDestroy() {
  ...
  cOi() {
    ...
    for ([e, t] of this.lOi) e === this.hOi ? t.SetSelected(!0) : t.SetSelected(!1)
  }
  mOi(e, t) {
    e = new OnlineHallSettingButton_1.OnlineHallSettingButton(e, t);
    e.BindOnSettingButtonClickedCallback(this.uOi), e.BindCanToggleExecuteChange(this.Bpt), this.lOi.set(t, e)
  }
}
