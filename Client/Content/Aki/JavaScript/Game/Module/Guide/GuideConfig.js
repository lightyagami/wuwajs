...
class GuideConfig extends ConfigBase_1.ConfigBase {
  ...
  GetGuideTutorialPageIds(e) {
    ...
    return 0 < r && ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(r.toString(), void 0) ? e.ReplacePageId : e.PageId
  }
  GetGuideTutorial(e) {
  ...
  GetOrderedStepIdsOfGroup(e, r) {
    ...
    return void 0 !== u && e?.Step.forEach(e => {
      "T" === this.GetStep(e).Controller[u] && i.push(e)
    }), i
  }
  GetLimitRepeatStepSetOfGroup(e) {
    const r = new Set;
    return this.GetGroup(e)?.LimitRepeat.forEach(e => {
      r.add(e)
    }), r
  }
...
}(exports.GuideConfig = GuideConfig).GmMuteTutorial = !1, GuideConfig.TabTag = "tab", GuideConfig.SlotTag = "slot";
