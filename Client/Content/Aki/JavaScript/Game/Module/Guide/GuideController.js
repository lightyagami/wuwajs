...
class GuideController extends UiControllerBase_1.UiControllerBase {
  static OnRegisterNetEvent() {
    Net_1.Net.Register(19160, this.vJt);
  }
  ...
  static OnAddEvents() {
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnCameraSequenceSetUiVisible, this.ndd);
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.NotifyGuideBreakFocus, this.F7g);
  }
  static OnRemoveEvents() {
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnCameraSequenceSetUiVisible, this.ndd);
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.NotifyGuideBreakFocus, this.F7g);
    this.yJt();
  }
...
GuideController.SJt = e => {
  if (!GuideController.TryStartGuide(e[0])) {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnGuideTriggerEvent, "");
  }
};
...
GuideController.IJt = (t, o) => {
  ...
  e.S9n = t;
  Net_1.Net.Call(15132, e, e => {
    if (e?.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
      ModelManager_1.ModelManager.GuideModel.SwitchGroupState(t, 0);
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 19870, e.lvs);
    } else if (!o) {
...
GuideController.ndd = e => {
  ModelManager_1.ModelManager.GuideModel.ShouldBlockGuideBecauseUiNotRender = !e;
};
GuideController.F7g = () => {
  if (Log_1.Log.CheckDebug()) {
    Log_1.Log.Debug("Guide", 95, "外部Notify中断当前引导的聚焦引导");
  }
  ModelManager_1.ModelManager.GuideModel.BreakTypeViewStep(4);
};
