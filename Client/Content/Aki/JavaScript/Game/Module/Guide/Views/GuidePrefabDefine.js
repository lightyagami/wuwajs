...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.setPrefabText = exports.predefPrefabSetting = exports.NEW_TAG = void 0;
const UE = require("ue"),
  ...
  for (let e = 0; e < t.length;) {
    ...
    if (0 < n.length) {
      ...
      if (u) {
        ...
        for (let e = 0; e < c.length; e++) r.Append("<snidx="), r.Append(a), r.Append("/>"), a++
      }
    }
  }
...
exports.NEW_TAG = "New:", exports.predefPrefabSetting = new Map([
  ["FightConcertoStateGuide", {
    GetPrefabPathFunc: () => {
      const r = [];
      return ModelManager_1.ModelManager.SceneTeamModel.GetTeamEntities(!0).forEach((e, t) => {
        r.push("/Game/Aki/UI/UIResources/UiFight/Prefabs/FightConcertoState.FightConcertoState")
      }), r
    },
    Callback: (o, e) => {
      ModelManager_1.ModelManager.SceneTeamModel.GetTeamEntities(!0).forEach((e, t) => {
        if (t < o.length) {
          const r = new ConcertoResponseItem_1.ConcertoResponseItem;
          r.CreateByActorAsync(o[t]).then(() => {
            r.Refresh(ModelManager_1.ModelManager.BattleUiModel.GetRoleData(e.Id)), o[t].GetComponentByClass(UE.UIItem.StaticClass()).SetUIActive(!0)
          })
        }
      })
    }
