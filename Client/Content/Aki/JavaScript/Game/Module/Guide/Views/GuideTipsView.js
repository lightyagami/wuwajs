...
class GuideTipsView extends GuideBaseView_1.GuideBaseView {
  constructor() {
    ...
    this.fZt = e => {
      ...
      if (e && !UiManager_1.UiManager.IsViewShow("GmView") && this.wSd() && this.GuideStepInfo.Config.TimeScale < 1 && (e = Global_1.Global.CharacterController)) {
  ...
  OnGuideBaseViewTick(e) {
    var i = this.wSd() && ModelManager_1.ModelManager.BattleUiModel.ChildViewData.GetChildVisible(26) && !this.HasConflictView();
