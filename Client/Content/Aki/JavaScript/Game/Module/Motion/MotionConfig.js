...
exports.MotionConfig = undefined;
...
const MotionBySkinId_1 = require("../../../Core/Define/ConfigQuery/MotionBySkinId");
...
class MotionConfig extends ConfigBase_1.ConfigBase {
  ...
  GetRoleMotionByType(o, e) {
    return MotionByRoleIdAndType_1.configMotionByRoleIdAndType.GetConfigList(o, e);
  }
  GetMotionTitle(o) {
