...
class MotionController extends ControllerBase_1.ControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(29397, MotionController.hqi);
    Net_1.Net.Register(17163, MotionController.lqi);
    Net_1.Net.Register(17467, MotionController._qi);
    Net_1.Net.Register(17133, MotionController.uqi);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(29397);
    Net_1.Net.UnRegister(17163);
    Net_1.Net.UnRegister(17467);
    Net_1.Net.UnRegister(17133);
  }
}
(exports.MotionController = MotionController).RequestUnlockMotion = (e, o) => {
  ...
  t.Q6n = e;
  t.F7n = o;
  Net_1.Net.Call(23305, t, e => {
    if (e.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
      ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.G9n, 22508);
    } else {
