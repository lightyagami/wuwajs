...
class UiCameraSpringStructure extends UiCameraStructure_1.UiCameraStructure {
  ...
  OnSpawnStructureActor() {
    var t = GlobalData_1.GlobalData.World,
      r = new UE.Transform(new UE.Quat(0), new UE.Vector(0), new UE.Vector(1, 1, 1)),
      t = UE.GameplayStatics.BeginDeferredActorSpawnFromClass(t, UE.BP_UiCameraAnimation_C.StaticClass(), r);
    return t.SetTickableWhenPaused(!0), UE.GameplayStatics.FinishSpawningActor(t, r), this.zUo = t, this.zUo.SpringArm?.SetTickableWhenPaused(!0), this.zUo.Camera?.SetTickableWhenPaused(!0), t
  }
  ...
  OnInitialize() {}
  OnDestroy() {
    ActorSystem_1.ActorSystem.Put("UiCameraSpringStructure.OnDestroy", this.zUo), this.zUo = void 0
  }
  OnActivate() {
