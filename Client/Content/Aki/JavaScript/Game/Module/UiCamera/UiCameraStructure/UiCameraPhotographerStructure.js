...
class UiCameraPhotographerStructure extends UiCameraStructure_1.UiCameraStructure {
  ...
  OnSpawnStructureActor() {
    ...
    return this.$Uo = ActorSystem_1.ActorSystem.Get(UE.TsPhotographer_C.StaticClass(), t, void 0), this.$Uo.SetTickableWhenPaused(!0), this.$Uo.SetActorTickEnabled(!0), this.$Uo.Initialize(), this.$Uo.CameraArm.SetTickableWhenPaused(!0), this.$Uo
  }
  ...
  OnActivate() {
    var t = this.JUo(),
      ...
      r = (r.SetIsDitherEffectEnable(!1), e.SetDitherEffect(1, 1), e.Mesh.D_GetSocketLocation(PhotographDefine_1.SPAWN_SOCKET_NAME)),
      e = t.D_GetTransform();
    this.$Uo.SetPlayerSourceLocation(r), this.$Uo.SetCameraInitializeTransform(e), this.$Uo.ActivateCamera(this.CameraActor)
  }
  OnDeactivate() {
    this.$Uo.DeactivateCamera()
  }
  YUo() {
    this.$Uo?.IsValid() && (this.$Uo.DeactivateCamera(), ActorSystem_1.ActorSystem.Put("UiCameraPhotographerStructure.DestroyPhotographer", this.$Uo)), this.$Uo = void 0
  }
  DWi() {
