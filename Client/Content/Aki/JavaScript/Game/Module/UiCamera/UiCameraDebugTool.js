...
class UiCameraDebugTool {
  constructor() {
    this.e__ = void 0, this.t__ = !1, this.i__ = !1, this.r__ = UE.NewMap(UE.BuiltinString, UE.BuiltinString), this.o__ = () => {
      UiCameraAnimationManager_1.UiCameraAnimationManager.GetLastHandleData()?.Refresh(), UiCameraAnimationManager_1.UiCameraAnimationManager.ReactivateCameraHandle(!1, !1)
    }
  }
  Init() {
  ...
  UpdateDebugCameraProps() {
    ...
    this.r__.Set("CurrentHandleName", e?.GetHandleName() ?? ""), this.r__.Set("DtSync", this.GetDtSyncEnabled() ? "true" : "false"), this.r__.Set("ArmLengthSync", this.GetArmLengthSyncEnabled() ? "true" : "false")
  }
  GetDebugCameraProps() {
    return this.r__
  }
