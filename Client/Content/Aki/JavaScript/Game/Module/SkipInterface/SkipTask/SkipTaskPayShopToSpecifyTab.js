...
class SkipTaskPayShopToSpecifyTab extends SkipTask_1.SkipTask {
  OnRun(e, a, r) {
    var o;
    this.Finish(), UiManager_1.UiManager.IsViewShow("PayShopRootView") ? ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("IsInView") : ((o = new PayShopViewData_1.PayShopViewData).PayShopId = Number(e), o.SwitchId = Number(a), ControllerHolder_1.ControllerHolder.PayShopController.OpenPayShopView(o))
  }
}
