...
class SkipToExploreAreaDetailView extends SkipTask_1.SkipTask {
  OnRun(e, r) {
    ...
    o <= 0 ? Log_1.Log.CheckDebug() && Log_1.Log.Debug("SkipInterface", 69, "SkipToExploreAreaDetailView 区域Id错误", ["配置区域id", e], ["一级区域id", o]) : (e = r ? Number(r) : void 0, WorldMapController_1.WorldMapController.SkipToExploreAreaDetailView(o, e)), this.Finish()
  }
}
