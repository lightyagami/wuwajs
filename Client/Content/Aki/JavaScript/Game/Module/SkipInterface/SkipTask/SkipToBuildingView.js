...
class SkipToBuildingView extends SkipToMoonChasingBase_1.SkipToMoonChasingBase {
  OnRun(i, n) {
    var e;
    this.CheckMainViewOpen() ? (((e = UiManager_1.UiManager.GetViewByName("MoonChasingMainView")) ? e.OpenParam : new MoonChasingMainViewModel_1.MoonChasingMainViewModel).SkipTarget = 2, UiManager_1.UiManager.IsViewOpen("RewardMainView") && (n !== StringUtils_1.ZERO_STRING && MoonChasingController_1.MoonChasingController.OpenBuildingTipsInfoView(parseInt(n)), UiManager_1.UiManager.CloseView("RewardMainView"))) : this.SkipToMap(parseInt(i))
  }
}
