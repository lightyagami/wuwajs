...
class SkipToMapTempMark extends SkipTask_1.SkipTask {
  OnRun(e) {
    ...
    void 0 === r ? Log_1.Log.CheckError() && Log_1.Log.Error("SkipInterface", 63, "跳转失败，静态标记配置不存在", ["mapMarkId", e]) : (ModelManager_1.ModelManager.MapModel.CreateTempMapMark(e), e = {
      MarkId: e,
      MarkType: r.ObjectType
    }, WorldMapController_1.WorldMapController.OpenView(2, !1, e)), this.Finish()
  }
}
