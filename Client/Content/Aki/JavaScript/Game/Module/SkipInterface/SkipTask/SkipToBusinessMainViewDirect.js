...
class SkipToBusinessMainViewDirect extends SkipToMoonChasingBase_1.SkipToMoonChasingBase {
  OnRun(i) {
    this.CheckMainViewOpen() ? (UiManager_1.UiManager.IsViewShow("ItemTipsView") && UiManager_1.UiManager.CloseView("ItemTipsView"), UiManager_1.UiManager.IsViewOpen("BusinessMainView") || MoonChasingController_1.MoonChasingController.OpenBusinessMainView()) : this.SkipToMap(parseInt(i))
  }
}
