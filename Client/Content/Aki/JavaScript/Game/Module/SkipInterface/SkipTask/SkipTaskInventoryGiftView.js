...
class SkipToInventoryGiftView extends SkipTask_1.SkipTask {
  OnRun(e, r, i, o) {
    if (UiManager_1.UiManager.IsViewShow("InventoryGiftView")) ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("IsInView");
    else {
      if (ItemAccessedPathById_1.configItemAccessedPathById.GetConfig(o)) {
        ...
        for (const n of ConfigManager_1.ConfigManager.ItemAccessedFromGiftPathConfig.GetGiftItemGroupById(o)) {
          ...
          if (0 < a && ControllerHolder_1.ControllerHolder.InventoryController.TryUseGiftItemWithSelectedItem(n, o, 1)) {
            e = !0, UiManager_1.UiManager.IsViewShow("ItemTipsView") && UiManager_1.UiManager.CloseView("ItemTipsView");
            break
          }
        }
        e || this.wec()
