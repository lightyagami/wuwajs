...
class SkipToBusinessMainView extends SkipToMoonChasingBase_1.SkipToMoonChasingBase {
  OnRun(i) {
    var e;
    this.CheckMainViewOpen() ? (((e = UiManager_1.UiManager.GetViewByName("MoonChasingMainView")) ? e.OpenParam : new MoonChasingMainViewModel_1.MoonChasingMainViewModel).SkipTarget = 1, UiManager_1.UiManager.IsViewOpen("RewardMainView") && UiManager_1.UiManager.CloseView("RewardMainView")) : this.SkipToMap(parseInt(i))
  }
}
