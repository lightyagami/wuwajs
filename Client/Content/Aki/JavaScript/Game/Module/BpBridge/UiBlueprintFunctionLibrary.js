...
class UiBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetAllFormationRole() {
    ...
    for (const r of ModelManager_1.ModelManager.SceneTeamModel.GetTeamEntities(!0)) {
  ...
  static OpenBattleView() {
    ...
    UiManager_1.UiManager.IsInited ? e() : UiManager_1.UiManager.Initialize().finally(e)
  }
  ...
  static CloseShop() {
    UiManager_1.UiManager.IsViewShow("ShopView") && UiManager_1.UiManager.CloseView("ShopView")
  }
  ...
  static GetRoleBaseAttrList(e) {
    ...
    return e.GetBaseAttrList().forEach((e, t) => {
      r.Add(t, e)
    }), r
  }
  static GetRoleAddAttrList(e) {
    e = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e).GetAttributeData();
    const r = UE.NewMap(UE.BuiltinInt, UE.BuiltinFloat);
    return e.GetAddAttrList().forEach((e, t) => {
      r.Add(t, e)
    }), r
  }
  ...
  static OpenGmView() {
    ModelManager_1.ModelManager.SundryModel.CanOpenGmView && (UiManager_1.UiManager.IsViewShow("GmView") ? UiManager_1.UiManager.CloseView("GmView") : UiManager_1.UiManager.OpenView("GmView"))
  }
  static BackLoginView() {
    UiManager_1.UiManager.IsViewShow("LoginView") || UiManager_1.UiManager.IsViewShow("CreateCharacterView") || ControllerHolder_1.ControllerHolder.ReConnectController.Logout(ReconnectDefine_1.ELogoutReason.GmBackLoginView)
  }
  static SetDamageViewVisible(e) {
    Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 17, "蓝图设置伤害飘字可见性（该接口已废弃）")
  }
  static SetHeadStateVisible(e) {
    Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 17, "蓝图设置头顶状态条可见性（该接口已废弃）")
  }
  static SetBossStateVisible(e) {
    Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 17, "蓝图设置Boss状态条可见性（该接口已废弃）")
  }
  ...
  static SetTempLocation(e) {
    var t, r, i, n;
    GlobalData_1.GlobalData.IsPlayInEditor ? (i = (r = t = void 0, puerts_1.$ref)(void 0), n = (0, puerts_1.$ref)(void 0), UE.EditorLevelLibrary.GetLevelViewportCameraInfo(i, n), t = (0, puerts_1.$unref)(i), r = (0, puerts_1.$unref)(n), UiBlueprintFunctionLibrary.TempLocation = Vector_1.Vector.Create(t), UiBlueprintFunctionLibrary.TempRotator = Rotator_1.Rotator.Create(r)) : UiBlueprintFunctionLibrary.TempLocation = Vector_1.Vector.Create(e)
  }
  ...
  static TestSceneLogin(t) {
    if (ModelManager_1.ModelManager.LoginModel.IsLoginStatus(LoginDefine_1.ELoginStatus.Init)) {
      ...
      if (PublicUtil_1.PublicUtil.IsUseTempData() || (e = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.LevelsConfigPath)), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 8, "levelConfig路径读取", ["levelsConfigPath", e]), UE.BlueprintPathsLibrary.FileExists(e)) {
        ...
        if (UE.KuroStaticLibrary.LoadFileToString(r, e)) {
          ...
          if (r) {
            ...
            StringUtils_1.StringUtils.IsEmpty(e) && (e = LoginModel_1.DEFAULT_SERVER_IP), ModelManager_1.ModelManager.LoginModel.SetServerIp(e, 0), ModelManager_1.ModelManager.LoginModel.SetAccount(UiBlueprintFunctionLibrary.TestSceneLoadAccount()), ModelManager_1.ModelManager.LoginModel.SetPlayerSex(UiBlueprintFunctionLibrary.TestSceneLoadGender() ? LoginDefine_1.ELoginSex.Boy : LoginDefine_1.ELoginSex.Girl), ModelManager_1.ModelManager.LoginModel.SetPlayerName("关卡测试");
            var i = UiBlueprintFunctionLibrary.TestLoadSceneData()?.DungeonId ?? 0,
              i = (ModelManager_1.ModelManager.LoginModel.SetSingleMapId(0 < i ? i : r.Id), ModelManager_1.ModelManager.LoginModel.SetMultiMapId(9), ModelManager_1.ModelManager.LoginModel.BornMode = UiBlueprintFunctionLibrary.TestSceneLoadNetMode() ? 0 : 1, new Protocol_1.Aki.Protocol.Gks),
              i = (i.X = UiBlueprintFunctionLibrary.TempLocation.X, i.Y = UiBlueprintFunctionLibrary.TempLocation.Y, i.Z = UiBlueprintFunctionLibrary.TempLocation.Z, ModelManager_1.ModelManager.LoginModel.BornLocation = i, GlobalData_1.GlobalData.IsRunWithEditorStartConfig() || ((r = Global_1.Global.CharacterController).ClearInputBinding(), r.InitInputHandle(), r.ReceiveSetupInputComponent()), ModelManager_1.ModelManager.GameModeModel.IsSilentLogin = !0, ModelManager_1.ModelManager.LoginModel.GetSingleMapId()),
              r = (ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(i)?.InstType === Protocol_1.Aki.Protocol.i4s.Proto_NormalInstance && UiBlueprintFunctionLibrary.TestLoadSceneData().IsDisableTeleportDungeon && ModelManager_1.ModelManager.SundryModel.BlockTpDungeonCount++, () => {
                ModelManager_1.ModelManager.LoginModel.SetLoginStatus(LoginDefine_1.ELoginStatus.Init), LoginController_1.LoginController.GetHttp(!0), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.LoginStatusChange, UiBlueprintFunctionLibrary.CheckReLogin), UiBlueprintFunctionLibrary.TimerId = TimerSystem_1.TimerSystem.Forever(UiBlueprintFunctionLibrary.CheckWorldDone, TimeUtil_1.TimeUtil.InverseMillisecond)
              });
            UiManager_1.UiManager.IsInited ? r() : UiManager_1.UiManager.Initialize().finally(r)
          } else Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "没有地图对应的配置, 请检查配置文件", ["levelsConfigPath", e])
        } else Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "读取关卡配置失败", ["path", e])
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "读取关卡配置失败", ["path", e])
    }
  }
  ...
  static TestSceneLoadBornMode() {
    return UiBlueprintFunctionLibrary.TestLoadSceneData().IsBornAtCamera ? 0 : 1
  }
  ...
  static TestSceneLoadBornLocation() {
    var e = UiBlueprintFunctionLibrary.TestLoadSceneData(),
      t = new UE.Vector;
    return t.X = e.Location.X ?? 0, t.Y = e.Location.Y ?? 0, t.Z = e.Location.Z ?? 0, t
  }
  ...
  static TestLoadSceneData() {
    var e, t, r = UiBlueprintFunctionLibrary.GetLocalGameDataPath();
    return UE.BlueprintPathsLibrary.FileExists(r) ? (t = (e = "", puerts_1.$ref)(""), UE.KuroStaticLibrary.LoadFileToString(t, r) ? (e = (0, puerts_1.$unref)(t), void 0 === (t = Json_1.Json.Parse(e)) ? (Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "读取本地文件配置失败, 反序列化失败"), this.TestSaveSceneData()) : t) : (Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "读取本地文件配置失败", ["path", r]), this.TestSaveSceneData())) : this.TestSaveSceneData()
  }
  static TestSaveSceneData(e = void 0) {
    let t = void 0;
    e ? t = e : ((t = new Object).IsBornAtCamera = !1, t.Account = `${PublicUtil_1.PublicUtil.GetLocalHost()}[${TimeUtil_1.TimeUtil.DateFormat(new Date)}]`, t.IsNetMode = !1, t.IsMale = !1, t.UseTemp = !1);
    var r, e = Json_1.Json.Stringify(t);
    return void 0 === e ? Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 8, "localGameData反序列化失败") : (r = UiBlueprintFunctionLibrary.GetLocalGameDataPath(), UE.KuroStaticLibrary.SaveStringToFile(e, r)), t
  }
  ...
  static GetTopViewName() {
    ...
    var t;
    return void 0 !== UiModel_1.UiModel.GetTopView(UiLayerType_1.ELayerType.Normal) && (t = UiModel_1.UiModel.GetTopView(UiLayerType_1.ELayerType.Normal).Info.Name, t = UiViewStorage_1.UiViewStorage.GetUiTsInfo(t).ResourceId, e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourceConfig(t).Path), void 0 !== UiModel_1.UiModel.GetTopView(UiLayerType_1.ELayerType.Pop) && (t = UiModel_1.UiModel.GetTopView(UiLayerType_1.ELayerType.Pop).Info.Name, t = UiViewStorage_1.UiViewStorage.GetUiTsInfo(t).ResourceId, e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourceConfig(t).Path), e
  }
  static SetUiStartSequenceFrame(e) {
    UiSceneManager_1.UiSceneManager.SetUiStartSequenceFrame(e)
  }
  static SetUiEndSequenceFrame(e) {
    UiSceneManager_1.UiSceneManager.SetUiEndSequenceFrame(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.UiRoleSequenceEndKeyFrame)
  }
...
}(exports.UiBlueprintFunctionLibrary = UiBlueprintFunctionLibrary).TimerId = void 0, UiBlueprintFunctionLibrary.CheckReLogin = () => {
  ModelManager_1.ModelManager.LoginModel.IsLoginStatus(LoginDefine_1.ELoginStatus.Init) && TimerSystem_1.TimerSystem.Delay(() => {
    ModelManager_1.ModelManager.LoginModel.CleanLoginFailCount(LoginDefine_1.ECleanFailCountWay.TestLogin), LoginController_1.LoginController.GetHttp(!0)
  }, TimeUtil_1.TimeUtil.InverseMillisecond)
}, UiBlueprintFunctionLibrary.CheckWorldDone = () => {
  ModelManager_1.ModelManager.GameModeModel.WorldDone && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SetGmIsOpen, !0), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.LoginStatusChange, UiBlueprintFunctionLibrary.CheckReLogin), TimerSystem_1.TimerSystem.Remove(UiBlueprintFunctionLibrary.TimerId), UiBlueprintFunctionLibrary.TimerId = void 0)
