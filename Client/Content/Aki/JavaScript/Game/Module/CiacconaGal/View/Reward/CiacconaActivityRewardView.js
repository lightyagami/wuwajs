...
class CiacconaActivityRewardView extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.dqc = void 0, this.xqe = void 0, this.CNe = void 0, this.Bqe = () => new CiacconaActivityRewardItem_1.CiacconaActivityRewardItem, this.AOe = () => {
      this.bl()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.CNe = this.OpenParam, this.dqc = new PopupCaptionItem_1.PopupCaptionItem, this.dqc.SetCloseCallBack(() => {
      this.CloseMe()
    ...
    this.dqc.SetTitleByTextIdAndArgNew(e), this.mVc()
  }
  OnStart() {
    this.xqe = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(3), this.Bqe), this.bl(), this.xqe?.PlayTurnAnimation(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnCiacconaRewardDataUpdate, this.AOe)
  }
  OnBeforeDestroy() {
  ...
  bl() {
    var e = ModelManager_1.ModelManager.CiacconaGalModel.GetAllRewardDataByActivityId(this.CNe.Id),
      [e, i] = (this.xqe?.RefreshByData(e), ModelManager_1.ModelManager.CiacconaGalModel.GetProgressRewardProgress());
    this.GetText(1).SetText(e + "/" + i), this.GetSprite(2).fillAmount = e / (i ?? 1)
  }
  mVc() {
