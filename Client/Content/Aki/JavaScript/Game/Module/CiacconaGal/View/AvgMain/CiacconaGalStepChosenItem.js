...
class CiacconaGalStepChosenItem extends UiPanelBase_1.UiPanelBase {
  ...
  Refresh(e) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.Content), this.SetTextureByPath(ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath("T_PlotReasoningIcon03"), this.GetTexture(1))
  }
}
