...
class CiacconaGalRewardButtonItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.e0t = void 0, this.dVc = !1, this.TDe = void 0, this.eTt = () => {}, this.J_ = () => {
      this.mVc(), ModelManager_1.ModelManager.CiacconaGalModel.ActivityData?.IsInRewardTime || (TimerSystem_1.TimerSystem.Remove(this.TDe), this.TDe = void 0, this.SetActive(!1))
    }, this.QUc = () => {
      this.eTt()
    }
  }
  ...
  async OnBeforeStartAsync() {
    this.e0t = new ButtonSpriteItem_1.ButtonSpriteItem, this.e0t.SetFunction(this.QUc), await this.e0t.CreateThenShowByActorAsync(this.GetItem(0).GetOwner())
  }
  OnStart() {
    this.dVc && (this.mVc(), this.TDe = TimerSystem_1.TimerSystem.Forever(this.J_, TimeUtil_1.TimeUtil.InverseMillisecond))
  }
  OnBeforeDestroy() {
