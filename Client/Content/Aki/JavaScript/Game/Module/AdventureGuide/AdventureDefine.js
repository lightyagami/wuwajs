...
class DetectionRecord {
  constructor(e, t, s) {
    this.Mat = void 0, this.IsLock = !1, this.RefreshTime = 0, this.IsTargeting = !1, this.IsLock = t, this.RefreshTime = s, this.Mat = e
  }
  get Conf() {
    return this.Mat
  }
...
class SoundAreaDetectionRecord {
  constructor(e, t, s) {
    this.Type = void 0, this.DungeonDetectionRecord = void 0, this.SilentAreaDetectionRecord = void 0, this.Type = e, this.DungeonDetectionRecord = t, this.SilentAreaDetectionRecord = s
  }
  get Conf() {
    switch (this.Type) {
      case 0:
...
exports.SoundAreaDetectionRecord = SoundAreaDetectionRecord, exports.Monster062DetectConfID = 10010053, exports.BigWorldID = 8;
class QuestRewardViewParam {
  constructor() {
    this.IsShowExpItem = !1, this.RewardList = void 0, this.AreaId = 0, this.BeforeContributionLevel = 0, this.BeforeContributionValue = 0
  }
}
exports.QuestRewardViewParam = QuestRewardViewParam, exports.matTypeDes = {
  [0]: "AdventureMatType_All",
  1: "AdventureMatType_Weapon",
  2: "AdventureMatType_Character",
  3: "AdventureMatType_Experience"
}, exports.EDEFAULTCATEGORY = 16, exports.WORLD_LEVEL_MIN = 1, exports.WORLD_LEVEL_MAX = 8;
