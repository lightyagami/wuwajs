...
class AdventureGuideConfig extends ConfigBase_1.ConfigBase {
  ...
  OnInit() {
    ...
    if (e)
      for (const n of e) this.KQl.has(n.DetectionId) || this.KQl.set(n.DetectionId, []), this.KQl.get(n.DetectionId).push(n);
    return !0
  }
  GetPreOpenDetectionConfListByDetectionId(e, n) {
    var e = this.KQl.get(e),
      r = [];
    if (e)
      for (const t of e) t.SoundAreaType === n && r.push(t);
    return r
  }
  GetPreOpenDetectionConfList(e, n, r) {
    e = this.GetPreOpenDetectionConfListByDetectionId(e, n);
    return 0 === e.length && 0 !== r && (n = this.GetPreOpenDetectionConfById(r)) && e.push(n), e
  }
