...
class NewSoundTypeItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.q8e = 4, this.md_ = void 0, this.G8e = void 0, this.W5e = void 0, this.H5e = void 0, this.D4l = !1, this.A5e = () => !this.W5e || this.W5e(this.q8e), this.N8e = t => {
  ...
  OnStart() {
    this.H5e = this.GetExtendToggle(3), this.H5e?.CanExecuteChange.Bind(this.A5e)
  }
  BindOnToggleFunc(i) {
    this.G8e = (t, e) => {
      i(t, e), this.GetRedDotState() && (ModelManager_1.ModelManager.AdventureGuideModel.RecordAllDetectionBySecondary(this.q8e), this.RefreshRedDotState(), this.md_) && ("NewSoundAreaView" === this.md_ ? EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RedDotNewSoundAreaTabUpdate) : "DisposableChallengeView" === this.md_ && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RedDotAdventureChallengeTabUpdate))
    }
  }
  ...
  Refresh(t, e, i) {
    ...
    LguiUtil_1.LguiUtil.TrySetLocalTextNew(s, t.SubText), this.SetSpriteByPath(t.Icon, this.GetSprite(0), !1), this.H5e.SetToggleState(0, !1), this.RefreshDoubleIcon(), this.RefreshRedDotState()
  }
  RefreshDoubleIcon() {
    var t = ActivityDoubleRewardController_1.ActivityDoubleRewardController.GetAdventureUpActivity(this.q8e),
      e = ModelManager_1.ModelManager.ActivityRegressModel.IsHasDoubleDrop(this.q8e),
      t = void 0 !== t || e;
    this.GetItem(4).SetUIActive(t)
  }
  RefreshRedDotState() {
    this.D4l = ModelManager_1.ModelManager.AdventureGuideModel.CheckRedDotSecondary(this.q8e), this.GetItem(5)?.SetUIActive(this.D4l)
  }
  GetRedDotState() {
    return this.D4l
  }
  ...
  SetSelectToggle(t = 1) {
    this.GetExtendToggle(3).SetToggleStateForce(t, !1, !0), this.G8e(this.q8e, this.H5e)
  }
  GetSelfToggle() {
