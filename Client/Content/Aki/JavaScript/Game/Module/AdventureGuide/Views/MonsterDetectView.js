...
class MonsterDetectView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this.O6e = void 0, this.k6e = void 0, this.H3e = void 0, this.F6e = 0, this.V6e = void 0, this.H6e = void 0, this.j6e = void 0, this.W6e = -1, this.K6e = void 0, this.Q6e = void 0, this.X6e = !0, this.L6e = 0, this.$6e = void 0, this.SPe = void 0, this.Anl = !1, this.xnl = 0, this.YVe = () => {
      return new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid
    }, this.Y6e = () => {
      this.J6e()
    }, this.RefreshByDetectingId = (e, i) => {
      this.H6e && this.H6e !== i && this.H6e.SetToggleState(0), this.SPe?.StopCurrentSequence(!1, !0), this.SPe?.PlayLevelSequenceByName("Switch"), ModelManager_1.ModelManager.AdventureGuideModel.CurrentMonsterId = e, this.H6e = i, this.F6e = e;
      var i = ModelManager_1.ModelManager.AdventureGuideModel.GetMonsterDetectData(e),
        t = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterInfoConfig(i.Conf.MonsterInfoId).Name,
        r = {
          Data: [{
            IncId: 0,
        ...
        r = (this.$6e?.Apply(r), this.$6e?.SetToggleInteractive(!1), MultiTextLang_1.configMultiTextLang.GetLocalTextNew(TextById_1.configTextById.GetConfig(AdventureGuideController_1.DETECT).Text)),
        r = (this.j6e.SetText(r), i.IsLock ? (LguiUtil_1.LguiUtil.SetLocalText(this.GetText(4), AdventureGuideController_1.UNKNOWNTEXT), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), i.Conf.AttributesDescriptionLock)) : (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), t), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(5), i.Conf.AttributesDescriptionUnlock), this.J6e()), ConfigManager_1.ConfigManager.AdventureModuleConfig.GetSecondaryGuideDataConf(i.Conf.DangerType)),
        ...
        r = CommonParamById_1.configCommonParamById.GetIntArrayConfig("CanUpAbsorbTypeDescription2List"),
        e = t.includes(i.Conf.DangerType) && r.includes(i.Conf.TypeDescription2);
      this.GetText(15)?.SetUIActive(e), this.GetButton(16)?.RootUIComp.SetUIActive(e)
    }, this.Z6e = e => {
      var i = new Array;
  ...
  OnStart() {
    ...
    }), this.O6e.SetAnimFinishDelegate(this.Pnl), this.$6e = new CommonItemSmallItemGrid_1.CommonItemSmallItemGrid, this.$6e.Initialize(this.GetItem(14).GetOwner()), this.k6e = new Array, this.H3e = new GenericScrollViewNew_1.GenericScrollViewNew(this.GetScrollViewWithScrollbar(8), this.YVe), this.V6e = new FilterSortEntrance_1.FilterSortEntrance(this.GetItem(0), this.Z6e), this.j6e = this.GetText(10), this.j6e.OnSelfLanguageChange.Bind(this.Y6e), this.Q6e = this.GetButton(1), this.F6e = ModelManager_1.ModelManager.AdventureGuideModel.GetCurDetectingMonsterConfId(), this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem);
    var e = ModelManager_1.ModelManager.CalabashModel.GetLeftIntensifyCaptureGuarantee();
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(15), "UpAbsorptionTimeWithTagText", e), this.Bnl()
  }
  Bnl() {
    var e = this.ExtraParams,
      e = "MonsterDetectView" === e.OpenTabViewName ? Number(e.OpenParam) : void 0;
    void 0 !== e && 0 < e && (this.Anl = !0)
  }
  wnl() {
    var e;
    this.Anl && (this.Anl = !1, e = this.O6e.UnsafeGetGridProxy(this.xnl)) && UiNavigationNewController_1.UiNavigationNewController.SetNavigationFocusForView(e.GetToggleItem())
  }
  OnBeforeShow() {
    var e = this.ExtraParams,
      e = "MonsterDetectView" === e.OpenTabViewName ? Number(e.OpenParam) : void 0;
    let i = void 0;
    void 0 !== e && (0 < e ? i = Number(e) : this.K6e = -Number(e)), this.W6e = i, ModelManager_1.ModelManager.AdventureGuideModel.CurrentMonsterId = i, Log_1.Log.CheckDebug() && Log_1.Log.Debug("AdventureGuide", 27, "当前拾音辑录默认选择怪物", ["id", i]), this.V6e.UpdateData(16, Array.from(ModelManager_1.ModelManager.AdventureGuideModel.GetAllDetectMonsters().values())), this.SPe?.StopCurrentSequence(), this.SPe?.PlayLevelSequenceByName("Start"), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.AdventureHelpBtn, MONSTER_HELP)
  }
  OnBeforeDestroy() {
    this.H3e = void 0, this.O6e && (this.O6e.ClearGridProxies(), this.O6e = void 0), this.j6e.OnSelfLanguageChange.Unbind(), this.SPe?.Clear(), this.SPe = void 0
  }
  e8e(e) {
    this.k6e.length = 0;
    for (const i of e) this.k6e.push(i), -1 !== this.W6e && this.W6e === i.Conf.Id && (this.W6e = -1);
    ModelManager_1.ModelManager.AdventureGuideModel.CurrentMonsterId || (e = this.o8e(), ModelManager_1.ModelManager.AdventureGuideModel.CurrentMonsterId = e);
    this.O6e.RefreshByData(this.k6e, !1, () => {
  ...
  J6e() {
    var e, i, t = this.GetCurrentId();
    t && (t = ModelManager_1.ModelManager.AdventureGuideModel.GetMonsterDetectData(t)) && (this.GetItem(13).SetUIActive(t.IsLock), e = this.GetText(12), t.IsLock ? (i = t.Conf.LockCon) && (i = ConditionGroupById_1.configConditionGroupById.GetConfig(i), LguiUtil_1.LguiUtil.SetLocalTextNew(e, i.HintText)) : (this.Q6e.RootUIComp.SetUIActive(!0), t.IsLock || this.X6e || (this.Q6e.SetSelfInteractive(!0), this.X6e = !0)))
  }
  Tick(e) {
    this.J6e()
  }
  ...
  JumpToTarget(e) {
    ...
    for (const r of this.k6e) {
      if (e === r.Conf.Id) {
        this.O6e.DeselectCurrentGridProxy(), this.O6e.ScrollToGridIndex(i, !0), this.O6e.SelectGridProxy(i), t = !0;
        break
      }
      i++
    }
    this.xnl = i, t || Log_1.Log.CheckDebug() && Log_1.Log.Debug("AdventureGuide", 27, "找不到拾音辑录跳转Target", ["target", e])
  }
}
