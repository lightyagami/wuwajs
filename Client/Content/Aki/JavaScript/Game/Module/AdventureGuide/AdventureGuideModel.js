...
class AdventureGuideModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.P4l = !1, this.EVe = new Map, this.U4l = new Map, this.eql = new Map, this.CurrentGuideTabName = void 0, this.SVe = new Map, this.yVe = 0, this.IVe = 0, this.TVe = 0, this.LVe = 0, this.DVe = 0, this.RVe = 0, this.UVe = void 0, this.AVe = 0, this.PVe = 0, this.xVe = 0, this.wVe = 0, this.BVe = 0, this.bVe = 0, this.qVe = !1, this.CurrentMonsterId = 0, this.CurrentSilentId = 0, this.DetectionRedDotRecord = void 0, this.GVe = new Map, this.NVe = new Map, this.OVe = new Map, this.AllMonsterDetectionRecord = new Map, this.AllDungeonDetectionRecord = new Map, this.AllSilentAreaDetectionRecord = new Map, this.kVe = 0, this.FVe = 0, this.CurrentShowLevel = 1, this.VVe = new Map, this.TypeUnLockMap = new Map, this.GuideTypeUnLockMap = new Map, this.HVe = void 0, this.jVe = new Array, this.tql = new Set([0, 1])
  }
  get HasInitData() {
    return this.P4l
  }
  UpdateSilentFirstAwards(e, t = !1) {
    t ? this.EVe.set(e, Protocol_1.Aki.Protocol.wks.ovs) : this.EVe.set(e, Protocol_1.Aki.Protocol.wks.CM_), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SilentRewardReceived, e)
  }
  OnLeaveLevel() {
    return !0
  }
  ...
  CheckCanGetFirstAwardByTypeId(e) {
    for (const r of this.EVe) {
      ...
      if (t.Conf.Secondary === e && r[1] === Protocol_1.Aki.Protocol.wks.CM_) return !0
    }
    return !1
  }
  GetAdventureGuideTabList() {
    ...
    for (let e = 0; e < r; e++) {
      var s = t[e];
      o && "AdventureTargetView" === s.ChildViewName ? n = e : this.GetIsTabViewHaveData(s.ChildViewName) && ModelManager_1.ModelManager.FunctionModel.IsOpen(s.FunctionId) && i.push(s)
    }
  ...
  SetTaskById(e, t, r) {
    ...
    i ? (i.Status = t, i.Progress = r) : Log_1.Log.CheckError() && Log_1.Log.Error("AdventureGuide", 5, "开拓任务id不存在", ["Id", e])
  }
  ...
  GetChapterProgress(e) {
    ...
    for (const r of e) r.Status >= Protocol_1.Aki.Protocol.Aks.Proto_Received && t.Received++;
    return t
  }
  GetLevelOfLevelPlay(e) {
    ...
    if (e.ReferenceAllEntity)
      for (const n of e.ReferenceAllEntity) {
        var r, i = ModelManager_1.ModelManager.CreatureModel.GetEntityData(n);
        void 0 === i ? Log_1.Log.CheckWarn() && Log_1.Log.Warn("AdventureGuide", 9, "玩法关联实体丢失", ["entity ", n]) : (r = ModelManager_1.ModelManager.CreatureModel.GetEntityTemplate(i.BlueprintType), i = (0, IEntity_1.decompressEntityData)(i, r), (r = (0, IComponent_1.getComponent)(i.ComponentsData, "AttributeComponent")).Level > t && (t = r.Level))
      }
    return t
  }
  GetCostOfLevelPlay(e) {
    var e = ModelManager_1.ModelManager.LevelPlayModel.GetLevelPlayConfig(e);
    return void 0 === e || "None" === (e = e.LevelPlayRewardConfig).Type || "Variable" === e.Type ? 0 : ConfigManager_1.ConfigManager.LevelPlayConfig.GetExchangeRewardInfo(e.RewardId).Cost.get(ENERGYCOST_ID)
  }
  GetPlayLevelPosition(e) {
    e = ModelManager_1.ModelManager.LevelPlayModel.GetLevelPlayConfig(e), e = ModelManager_1.ModelManager.CreatureModel.GetEntityData(e.LevelPlayEntityId);
  ...
  GetDungeonRecordsForRedDot(e, t) {
    var r = new Array,
      e = this.VVe.get(e);
    if (e)
      for (const i of e) t && i.DungeonDetectionRecord.Conf.MatType !== t || this.IsDetectionPreOpen(i) || i.IsLock || r.push(i);
    return r
  }
  GetCanShowDungeonRecordsByType(e, t, r = !0) {
    var i = new Array,
      n = this.VVe.get(e);
    if (!n) return [!1, i];
    for (const o of n) t && o.DungeonDetectionRecord.Conf.MatType !== t || !this.IsDetectionPreOpen(o) && o.IsLock || i.push(o);
    return r && (6 === e || 62 === e ? i.sort((e, t) => {
      var r = e.Conf.SubDungeonId,
        i = t.Conf.SubDungeonId,
        r = ModelManager_1.ModelManager.ExchangeRewardModel.IsFinishInstance(r) ? 1 : 0,
        i = ModelManager_1.ModelManager.ExchangeRewardModel.IsFinishInstance(i) ? 1 : 0;
      return r != i ? r - i : (r = e.Conf.SortId) !== (i = t.Conf.SortId) ? i - r : e.Conf.Id - t.Conf.Id
    }) : i.sort((e, t) => {
      var r = this.IsDetectionPreOpen(e) ? 1 : 0,
        i = this.IsDetectionPreOpen(t) ? 1 : 0;
      return r != i ? i - r : (i = this.IsDetectionNewContentOpen(e) ? 1 : 0) != (r = this.IsDetectionNewContentOpen(t) ? 1 : 0) ? r - i : (r = e.Conf.SortId) !== (i = t.Conf.SortId) ? i - r : e.Conf.Id - t.Conf.Id
    })), [void 0 !== i[0].DungeonDetectionRecord && 0 !== i[0].DungeonDetectionRecord.Conf.DetectionTabType, i]
  }
  ...
  SetCurDetectingMonsterConfId(e) {
    0 !== this.yVe && (this.AllMonsterDetectionRecord.get(this.yVe).IsTargeting = !1);
  ...
  SetCurDetectingDungeonConfId(e) {
    0 !== this.IVe && (this.AllDungeonDetectionRecord.get(this.IVe).IsTargeting = !1);
  ...
  SetCurDetectingSilentAreaConfId(e) {
    var t = this.AllSilentAreaDetectionRecord.get(this.TVe),
      t = (0 !== this.TVe && t && (t.IsTargeting = !1), this.AllSilentAreaDetectionRecord.get(e));
  ...
  InitDetectionData() {
    var e;
    for (const i of ConfigManager_1.ConfigManager.AdventureModuleConfig.GetAllMonsterDetection()) this.AllMonsterDetectionRecord.set(i.Id, new AdventureDefine_1.MonsterDetectionRecord(i, 0 !== i.LockCon, 0));
    for (const n of ConfigManager_1.ConfigManager.AdventureModuleConfig.GetAllDungeonDetection()) {
      var t = new AdventureDefine_1.DungeonDetectionRecord(n, 0 !== n.LockCon, 0);
    ...
    for (const o of ConfigManager_1.ConfigManager.AdventureModuleConfig.GetAllSilentAreaDetection()) {
      var r = new AdventureDefine_1.SilentAreaDetectionRecord(o, 0 !== o.LockCon, 0);
    ...
    for ([e] of this.VVe)(ConfigManager_1.ConfigManager.AdventureModuleConfig?.GetSecondaryGuideDataConf(e))?.ConditionGroupId || this.TypeUnLockMap.set(e, !0);
  ...
  UpdateByAdventureManualResponse(e) {
    if (e.Cvs !== Protocol_1.Aki.Protocol.Q4n.KRs) ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 17290);
    else {
      this.P4l = !0, this.kVe = e.NMs.wMs, this.FVe = e.NMs.xMs;
      for (const i of e.NMs.UMs) this.WVe(i);
      for (const n of e.FMs) this.KVe(n);
      if (this.HandleMonsterDetectLockStatus(e.$Ms), this.FullUpdateDetectionPreOpenData(1, e.wE_), this.FullUpdateDetectionPreOpenData(0, e.LE_), this.UpdateDetectionServerConfig(0, e.bE_), this.UpdateDetectionServerConfig(1, e.TE_), this.EVe.clear(), 0 !== e.jMs.size)
        for (const o of Object.keys(e.jMs)) {
          var t = e.jMs[o],
            r = Number(o);
          this.EVe.set(r, t), t === Protocol_1.Aki.Protocol.wks.CM_ && ControllerHolder_1.ControllerHolder.AdventureGuideController.EmitRedDotFirstAwardEvent(r)
        }
    }
  }
  ...
  HandleMonsterDetectLockStatus(e) {
    ...
    t && ControllerHolder_1.ControllerHolder.AdventureGuideController.UpdateAdventureNewSoundAreaTabRedDot(), r && ControllerHolder_1.ControllerHolder.AdventureGuideController.UpdateAdventureNewChallengeTabRedDot()
  }
  WVe(t) {
    ...
    if (r) {
      ...
      void 0 !== i ? (i.Progress = t.PMs, i.Status = t.Y4n) : e.push(new AdventureDefine_1.AdventureTaskRecord(r, t.Y4n))
    } else Log_1.Log.CheckError() && Log_1.Log.Error("AdventureGuide", 5, "找不到id为的开拓任务", ["task.Proto_Id", t.s5n])
  }
  KVe(t) {
    switch (t.h5n) {
      case Protocol_1.Aki.Protocol.r8n.Proto_NormalMonster:
        var r = this.AllMonsterDetectionRecord.get(t.o8n);
        void 0 !== r ? r.RefreshTime > t.qMs && (r.RefreshTime = t.qMs) : (r = ConfigManager_1.ConfigManager.AdventureModuleConfig.GetMonsterDetectionConfById(t.o8n), this.AllMonsterDetectionRecord.set(t.o8n, new AdventureDefine_1.MonsterDetectionRecord(r, 0 === r.LockCon, t.qMs)));
        break;
      case Protocol_1.Aki.Protocol.r8n.Proto_Dungeon:
        ...
        if (void 0 !== r) r.RefreshTime > t.qMs && (r.RefreshTime = t.qMs);
          ...
          var r = ConfigManager_1.ConfigManager.AdventureModuleConfig.GetDungeonDetectionConfById(t.o8n),
            i = new AdventureDefine_1.DungeonDetectionRecord(r, 0 === r.LockCon, t.qMs);
      ...
      case Protocol_1.Aki.Protocol.r8n.Proto_SilentArea:
        ...
        if (void 0 !== i) i.RefreshTime > t.qMs && (i.RefreshTime = t.qMs);
          ...
          r = ConfigManager_1.ConfigManager.AdventureModuleConfig.GetSilentAreaDetectionConfById(t.o8n), i = new AdventureDefine_1.SilentAreaDetectionRecord(r, 0 === r.LockCon, t.qMs);
          this.AllSilentAreaDetectionRecord.set(t.o8n, i), this.UpdateDetectSilentAreas(i);
  ...
  SortChapterTasks(e) {
    ...
    return t.sort((e, t) => {
      var r = e.Status < Protocol_1.Aki.Protocol.Aks.Proto_Received ? e.Status : -e.Status,
        i = t.Status < Protocol_1.Aki.Protocol.Aks.Proto_Received ? t.Status : -t.Status;
      return r !== i ? i - r : e.AdventureTaskBase.Id - t.AdventureTaskBase.Id
    }), this.SVe.set(e, t), t
  }
  ...
  InitAdventureTaskConfig() {
    for (const r of ConfigManager_1.ConfigManager.AdventureModuleConfig.GetAllAdventureTaskConfig()) {
      var t = r.ChapterId;
      let e = void 0;
      void 0 === this.SVe.get(t) ? (e = new Array, this.SVe.set(t, e)) : e = this.SVe.get(t), e.push(new AdventureDefine_1.AdventureTaskRecord(r, Protocol_1.Aki.Protocol.Aks.Proto_UnFinish))
    }
  }
  GetMaxLevelOfBlueprintType(e) {
    var t = ModelManager_1.ModelManager.CreatureModel.GetAllEntityIdOfBlueprintType(e);
    let r = 0;
    0 === t.length && Log_1.Log.CheckWarn() && Log_1.Log.Warn("AdventureGuide", 9, "未找到实体配置", ["type ", e]);
    for (const n of t) {
      var i = ModelManager_1.ModelManager.CreatureModel.GetEntityData(n);
      void 0 !== i?.ComponentsData && (i = (0, IComponent_1.getComponent)(i.ComponentsData, "AttributeComponent")).Level > r && (r = i.Level)
    }
    return r
  }
  GetSilentAreaLevel(e) {
    e = ModelManager_1.ModelManager.CreatureModel.GetEntityData(e);
    if (void 0 !== e?.ComponentsData) return (0, IComponent_1.getComponent)(e.ComponentsData, "AttributeComponent").Level
  }
  UpdatePendingMonsterList(e, t) {
    if (0 !== e.length) {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("AdventureGuide", 5, "更新怪物探测信息", ["怪物id", e[0].s5n], ["探测id", e[0].o8n], ["RefreshTime", e[0].qMs]), t !== this.GetCurDetectingMonsterConfId() && (this.GVe.clear(), this.wVe = t);
      for (const i of e) {
  ...
  UpdatePendingDungeonList(e, t) {
    t !== this.GetCurDetectingDungeonConfId() && (this.NVe.clear(), this.BVe = t);
    for (const i of e) {
      var r;
      i.BMs ? (r = ConfigManager_1.ConfigManager.InstanceDungeonEntranceConfig.GetConfig(i.s5n), (r = ModelManager_1.ModelManager.CreatureModel.GetEntityData(r.TeleportEntityConfigId, i.w7n)) && (r = {
        Id: i.s5n,
        RefreshTime: i.qMs,
        MapId: i.w7n,
      ...
      }, this.NVe.set(i.s5n, r))) : this.NVe.delete(i.s5n)
    }
  }
  UpdatePendingSilentAreaList(e, t) {
    t !== this.GetCurDetectingSilentAreaConfId() && (this.OVe.clear(), this.bVe = t);
    for (const i of e) {
      var r;
      i.BMs ? void 0 !== (r = ModelManager_1.ModelManager.LevelPlayModel.GetLevelPlayConfig(i.s5n)) && (r = ModelManager_1.ModelManager.CreatureModel.GetEntityData(r.LevelPlayEntityId, i.w7n).Transform.Pos, r = {
        Id: i.s5n,
        RefreshTime: i.qMs,
        MapId: i.w7n,
        PositionX: r.X,
        PositionY: r.Y,
        PositionZ: r.Z
      }, this.OVe.set(i.s5n, r)) : this.OVe.delete(i.s5n)
    }
  }
  ...
  CleanCurTrackingMonster() {
    ...
    e && (e.IsTargeting = !1), this.SetCurDetectingMonsterConfId(0), this.SetCurDetectingMonsterMarkId(0), this.SetDetectingMonsterId(0)
  }
  CleanCurTrackingDungeon() {
    var e = this.GetSoundAreaDetectData(this.IVe);
    e && (e.IsTargeting = !1), this.SetCurDetectingDungeonConfId(0), this.SetDetectingDungeonMarkId(0), this.SetDetectingDungeonId(0)
  }
  CleanCurTrackingSilentArea() {
    var e = this.GetSilentAreaDetectData(this.TVe);
    e && (e.IsTargeting = !1), this.SetCurDetectingSilentAreaConfId(0), this.SetDetectingSilentAreaMarkId(0), this.SetDetectingSilentAreaId(0)
  }
  GetAllCulledMonsters() {
    var e;
    return this.HVe || (e = MonsterDetectionFilterAll_1.configMonsterDetectionFilterAll.GetConfigList(), this.HVe = e ? new Set(e.map(e => e.EntityConfigId)) : new Set), this.HVe
  }
  ...
  GetAllCanShowDungeonTypeList(e, t = !0) {
    let r = void 0;
    var i, n, e = e || this.CurrentGuideTabName,
      o = (r = "NewSoundAreaView" === e ? 3 : 2, new Array);
    for ([i, n] of this.VVe) {
      var s = n[0];
      0 === s.Type && s.DungeonDetectionRecord.Conf.GuideId !== r || 1 === s.Type && s.SilentAreaDetectionRecord.Conf.GuideId !== r || this.CheckTargetDungeonTypeCanShow(i) && o.push(i)
    }
    return t ? o.sort((e, t) => ConfigManager_1.ConfigManager.AdventureModuleConfig.GetSecondaryGuideDataConf(e).SortNumber - ConfigManager_1.ConfigManager.AdventureModuleConfig.GetSecondaryGuideDataConf(t).SortNumber) : o
  }
  GetIsTabViewHaveData(e) {
    let t = void 0;
    if ("NewSoundAreaView" === e ? t = 3 : "DisposableChallengeView" === e && (t = 2), !t) return !0;
    for (var [r, i] of this.VVe) {
      i = i[0];
      if (!(0 === i.Type && i.DungeonDetectionRecord.Conf.GuideId !== t || 1 === i.Type && i.SilentAreaDetectionRecord.Conf.GuideId !== t) && this.CheckTargetDungeonTypeCanShow(r)) return !0
    }
    return !1
  }
  ...
  InitAllDetectSilentAreasList() {
    ...
    for (const o of e.values()) o.sort(AdventureGuideController_1.silentAreasSortFunc);
    for (const s of Array.from(e.keys()).sort((e, t) => t - e)) {
      var r = e.get(s);
      if (0 !== r.length) {
        var i = r[0].Conf.DangerType;
        for (const a of r) this.jVe.push({
          IsShow: !1,
          DangerType: i,
  ...
  GetShowSilentAreasList(e, t, r) {
    if (void 0 !== t) {
      ...
      if (n)
        for (const s of this.jVe) this.XVe(e, s, n.Conf.Secondary)
    } else
      for (const a of this.jVe) this.XVe(e, a, void 0)
  }
  XVe(e, t, r) {
    e.push(t)
  }
  CheckShowDoubleRewardRedDot() {
    var e;
    return !!ActivityDoubleRewardController_1.ActivityDoubleRewardController.HasAnyDoubleRewardActivityShowing() && (!(e = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.RedDotAdventureNewSoundAreaTabLastUpdateTime)) || e < TimeUtil_1.TimeUtil.GetCurrentCrossDayStamp())
  }
  ...
  CheckRedDotChallengeTab() {
    for (const e of this.GetAllCanShowDungeonTypeList("DisposableChallengeView", !1))
      if (this.CheckRedDotSecondary(e)) return !0;
    return !1
  }
  ...
  CheckRedDotDetectionItemByRecord(e) {
    var t = e.Conf;
    return !(!t || !t.LockCon || e.IsLock || !0 === this.DetectionRedDotRecord?.get(t.Id) || this.IsDetectionFinished(e))
  }
  IsDetectionFinished(e) {
    var t = e.Conf.Secondary;
    return 61 === t ? ModelManager_1.ModelManager.LordGymModel.GetGymEntranceAllFinish(e.Conf.AdditionalId) : (6 === t || 62 === t) && (t = e.Conf.SubDungeonId, ModelManager_1.ModelManager.ExchangeRewardModel.IsFinishInstance(t))
  }
  RecordAllDetectionBySecondary(e) {
    for (const t of this.GetDungeonRecordsForRedDot(e, void 0)) this.CheckRedDotDetectionItemByRecord(t) && this.RecordDetection(t)
  }
  RecordDetection(e) {
    e = e.Conf.Id;
    this.DetectionRedDotRecord && !this.DetectionRedDotRecord.has(e) && (this.DetectionRedDotRecord.set(e, !0), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.DetectionRedDotRecord, this.DetectionRedDotRecord))
  }
  ...
  IsDetectionPreOpen(e) {
    ...
    let i = !0;
    0 < r && (i = !ControllerHolder_1.ControllerHolder.LevelGeneralController.CheckCondition(r.toString(), void 0));
    var r = this.U4l.get(e.Type)?.get(t.Id);
    let n = !1;
    return r && (e = MathUtils_1.MathUtils.LongToNumber(r.AE_), t = MathUtils_1.MathUtils.LongToNumber(r.PE_), e <= (r = TimeUtil_1.TimeUtil.GetServerTimeStamp())) && r <= t && (n = !0), i && n
  }
  IsDetectionNewContentOpen(e) {
    var t, e = this.eql.get(e.Type)?.get(e.Conf.Id);
    let r = !1;
    return r = e && (t = MathUtils_1.MathUtils.LongToNumber(e.xE_), e = MathUtils_1.MathUtils.LongToNumber(e.UE_), t <= (t = TimeUtil_1.TimeUtil.GetServerTimeStamp())) && t <= e ? !0 : r
  }
  GetPreOpenDetectionConf(e, t, r) {
    var e = ConfigManager_1.ConfigManager.AdventureModuleConfig.GetPreOpenDetectionConfList(e, t, r),
      i = this.U4l.get(t);
    for (const n of e)
      if (i?.get(n.Id)) return n
  }
}
