...
class MailBindModel extends ModelBase_1.ModelBase {
  ...
  UpdateByProtoMailBindInfo(e) {
    this.nil = e.$b_, this.sil = e.Wb_, this.tEt = MathUtils_1.MathUtils.LongToNumber(e.Qb_) / 1e3
  }
  GetIsBind() {
    return this.nil
  }
  ...
  GetRemainTimeText(e) {
    ...
    return 0 === i[0] ? ConfigManager_1.ConfigManager.TextConfig.GetTextById("NotEnoughOneHour") : (t = MultiTextLang_1.configMultiTextLang.GetLocalTextNew("ActivityRemainingTime"), e = TimeUtil_1.TimeUtil.GetCountDownDataFormat2(e, i[0], i[1]).CountDownText ?? "", StringUtils_1.StringUtils.Format(t, e))
  }
  GetTimeTypeData(e) {
    return e > CommonDefine_1.SECOND_PER_DAY ? [3, 2] : e > CommonDefine_1.SECOND_PER_HOUR ? [2, 2] : [0, 0]
  }
  CheckMailBindRedDot() {
    var e;
