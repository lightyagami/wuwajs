...
class MailBindController extends UiControllerBase_1.UiControllerBase {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(23625, MailBindController.oil);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(23625);
  }
  ...
  static MailBindRewardRequest() {
    ...
    Net_1.Net.Call(19505, e, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 20661);
        } else {
