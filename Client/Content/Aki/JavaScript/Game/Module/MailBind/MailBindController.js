...
exports.MailBindController = undefined;
...
class MailBindController extends UiControllerBase_1.UiControllerBase {
    ...
    Net_1.Net.Call(29607, e, e => {
      if (e) {
        if (e.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Q4n, 27660);
        } else {
  ...
  static RecordMailBindNextShowRedDotTime() {
    ...
    var t = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MailBindNextShowRedDotTime);
    if (!t || !(e < t)) {
      (t = new Date(e)).setHours(4, 0, 0, 0);
      e = (e = t.getDay()) < 1 ? 1 - e : 7 - (e - 1);
      t = t.getTime() + e * CommonDefine_1.SECOND_PER_DAY * CommonDefine_1.MILLIONSECOND_PER_SECOND;
      LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.MailBindNextShowRedDotTime, t);
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshMailBindRedDot);
    }
  }
  static RecordMailBindClick() {
    var e = new LogReportDefine_1.MailBindClickEvent();
    e.i_language = LanguageSystem_1.LanguageSystem.GetLanguageDefineByCode(LanguageSystem_1.LanguageSystem.PackageLanguage).LanguageType;
    e.i_if_binded = ModelManager_1.ModelManager.MailBindModel.GetIsBind() ? 1 : 0;
...
(exports.MailBindController = MailBindController).oil = e => {
  ...
  if (e) {
    ModelManager_1.ModelManager.MailBindModel.UpdateByProtoMailBindInfo(e);
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnMailBindInfoNotify);
  }
};
...
MailBindController._Mo = () => {
  if (!ModelManager_1.ModelManager.MailBindModel?.GetIsBind()) {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshMailBindRedDot);
  }
