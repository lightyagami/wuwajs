...
class ScreenShotManager {
  ...
  static PrepareTakeScreenshot(t, e, r, s, a, o) {
    this.ResetScreenShot();
    e = Vector2D_1.Vector2D.Create(e, r), r = Vector2D_1.Vector2D.Create(s, a), s = GlobalData_1.GlobalData.World;
    return this.nvo = UE.KuroGameScreenshotBPLibrary.PrepareTakeScreenshot(s, t, e.ToUeVector2D(), r.ToUeVector2D(), 0, 0, o), this.nvo
  }
  ...
  static async TakeScreenShotToTextureAsync(t, e, r, s) {
    ...
    return t.OnTakeScreenshotCapturedDelegate.Add((t, e, r) => {
      t = UE.LGUIBPLibrary.CreateTexture2DFromColors(t, e, r);
      a.SetResult(t)
    }), t?.TakeScreenshot(), await a.Promise
  }
