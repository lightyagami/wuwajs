...
class AttributeView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.NWe = void 0, this.OWe = (e, t, i) => {
  ...
  OnStart() {
    ...
    this.NWe = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(0), this.OWe), this.NWe.RefreshByData(e)
  }
  OnBeforeDestroy() {
