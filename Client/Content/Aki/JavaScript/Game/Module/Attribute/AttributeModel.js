...
class AttributeModel extends ModelBase_1.ModelBase {
  GetFormatAttributeValueString(e, t, r = !1) {
    var o = t;
    return ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e).IsPercent ? MathUtils_1.MathUtils.GetFloatPointFloorString(o / 100, 1) + "%" : r ? MathUtils_1.MathUtils.GetFloatPointFloorString(100 * o, 1) + "%" : Math.floor(t).toString()
  }
  GetFormatAttributeValueByAddType(e, t) {
    return 1 === t ? "" + TipsDataTool.GetPropRatioValue(e, !1).toString() : 2 === t ? TipsDataTool.GetPropRatioValue(e, !0).toString() + "%" : 3 === t ? e.toString() + "s" : e.toString()
  }
}
