...
class FormationDataModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.PlayerAggroSet = new Set, this.OnLandPositionQueue = new Queue_1.Queue(CACHE_ON_LAND_SIZE), this.KeyboardLockEnemyMode = 0, this.GamepadLockEnemyMode = 0
  }
  OnInit() {
    return !0
  }
  ...
  RefreshOnLandPosition() {
    ...
    if (t) {
      ...
      if (r === CharacterUnifiedStateTypes_1.ECharPositionState.Ground && e !== CharacterUnifiedStateTypes_1.ECharPositionSubState.WaterSurface && e !== CharacterUnifiedStateTypes_1.ECharPositionSubState.WalkOnAir) {
        r = t.GetComponent(1), e = r?.Owner;
        if (e && !e.bHidden) {
          t = r.ActorLocationProxy;
          if (t) {
            let e = void 0;
            (e = (e = this.OnLandPositionQueue.Size >= CACHE_ON_LAND_SIZE ? this.OnLandPositionQueue.Pop() : e) || Vector_1.Vector.Create())?.DeepCopy(t), this.OnLandPositionQueue.Push(e)
          }
        }
      }
    }
