...
class FormationAttributeController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    ...
    Net_1.Net.Register(17741, FormationAttributeController.FormationAttrNotify);
  ...
  static OnFormationAttrChanged(t) {
    ...
    if (i && (e = Protocol_1.Aki.Protocol.t1s.create(), r = Protocol_1.Aki.Protocol.q4s.create(), e.M6n = [r], e.S6n = i.Timestamp, r.E6n = t, r.y6n = i.Value, r.I6n = i.Max, r.T6n = i.BaseMax, r.L6n = i.Speed, Net_1.Net.Call(23459, e, () => {}), Log_1.Log.CheckDebug())) {
  ...
  static QBe(r) {
    ...
    if (!t) {
      t = () => {
        var t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity?.Entity?.CheckGetComponent(217);
