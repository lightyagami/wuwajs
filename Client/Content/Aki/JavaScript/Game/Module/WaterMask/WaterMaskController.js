...
exports.WaterMaskView = WaterMaskView, (_a = WaterMaskView).SOo = void 0, WaterMaskView.yOo = 300, WaterMaskView.IOo = 300, WaterMaskView.TOo = 30, WaterMaskView.LOo = .09, WaterMaskView.vFt = 40, WaterMaskView.vOo = () => {
  ...
  var e = UiLayer_1.UiLayer.GetLayerRootUiItem(UiLayerType_1.ELayerType.WaterMask),
    t = (_a.SOo = UE.KuroActorManager.D_SpawnActor(Info_1.Info.World, UE.UIContainerActor.StaticClass(), MathUtils_1.MathUtils.DefaultTransformDouble, void 0), _a.SOo.RootComponent),
  ...
  for (let a = 0; a < s; a++)
    for (let e = 0; e < o; e++) {
      var E = UE.KuroActorManager.D_SpawnActor(Info_1.Info.World, UE.UITextActor.StaticClass(), MathUtils_1.MathUtils.DefaultTransformDouble, void 0),
        U = E.RootComponent,
