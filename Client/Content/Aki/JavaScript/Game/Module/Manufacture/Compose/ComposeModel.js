...
class ComposeModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.ExchangeItemBaseMap = new Map, this.Xqt = -1, this.CurrentInteractCreatureDataLongId = void 0, this.nTi = 0, this.LastExp = 0, this.ComposeEnterFlow = void 0, this.ComposeSuccessFlow = void 0, this.ComposeFailFlow = void 0, this.sTi = 3, this.aTi = [], this.Tjl = [], this.hTi = void 0, this.lTi = void 0, this.uTi = 0, this.cTi = void 0, this.mTi = void 0, this.dTi = void 0, this.CTi = 0, this.gTi = void 0, this.fTi = (t, e) => t.IsBuff === e.IsBuff ? t.RoleId - e.RoleId : t.IsBuff ? -1 : 1, this.ComposeSelectItem = void 0
  }
  ...
  GetRefreshLimitTime() {
    var t;
    if (0 !== this.Xqt) return t = TimeUtil_1.TimeUtil.GetServerTime(), TimeUtil_1.TimeUtil.GetRemainTimeDataFormat(this.Xqt - t).CountDownText
  }
  GetRefreshLimitTimeValue() {
    var t;
    return this.Xqt <= 0 ? 1 : (t = TimeUtil_1.TimeUtil.GetServerTime(), TimeUtil_1.TimeUtil.GetRemainTimeDataFormat(this.Xqt - t).RemainingTime)
  }
  OnInit() {
    return this.ComposeEnterFlow = {
  ...
  OnClear() {
    return this.ComposeEnterFlow = void 0, this.ComposeSuccessFlow = void 0, this.ComposeFailFlow = void 0, this.ClearComposeRoleItemDataList(), !0
  }
  ...
  CreateComposeDataList(t) {
    this.CreateReagentProductionDataList(t), this.CreateStructureDataList(t), this.UpdatePurificationDataList(t), this.CreateExchangeDataList()
  }
  UpdateComposeDataList(t) {
    this.UpdateReagentProductionDataList(t), this.UpdateStructureDataList(t), this.UpdatePurificationDataList(t)
  }
  UpdateComposeByServerConfig(t) {
    for (const r of t) {
      var e = MathUtils_1.MathUtils.LongToNumber(r.CPs) * TimeUtil_1.TimeUtil.Millisecond,
        o = MathUtils_1.MathUtils.LongToNumber(r.gPs) * TimeUtil_1.TimeUtil.Millisecond,
        i = this.aTi.findIndex(t => t.ConfigId === r.s5n); - 1 !== i && (0 == e && 0 == o || TimeUtil_1.TimeUtil.IsInTimeSpan(e, o) ? (this.aTi[i].ExistStartTime = e, this.aTi[i].ExistEndTime = o) : this.aTi.splice(i, 1))
    }
  }
  ...
  CreateReagentProductionDataList(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Compose", 49, "初始化药剂制造相关数据列表"), this.aTi || (this.aTi = new Array), this.aTi.length = 0;
    var e, o = ConfigManager_1.ConfigManager.ComposeConfig.GetComposeListByType(1) ?? [],
      i = new Map;
    for (const a of o) {
    ...
    for (const s of t) 1 === ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(s.s5n).FormulaType && i.has(s.s5n) && ((e = i.get(s.s5n)).ConfigId = s.s5n, e.ComposeCount = s.m9n ?? 0, e.IsNew = ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.ComposeLevelKey, s.s5n), e.LastRoleId = s.cPs ?? 0, e.ExistStartTime = MathUtils_1.MathUtils.LongToNumber(s.CPs) * TimeUtil_1.TimeUtil.Millisecond, e.ExistEndTime = MathUtils_1.MathUtils.LongToNumber(s.gPs) * TimeUtil_1.TimeUtil.Millisecond, e.MadeCountInLimitTime = s.lGs, e.TotalMakeCountInLimitTime = s.dPs, e.IsUnlock = 1)
  }
  UpdateReagentProductionDataList(t) {
    if (!(this.aTi.length <= 0)) {
      let e = !1;
      for (const a of t) {
        var o, i = ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(a.s5n);
        if (1 === i.FormulaType) {
          let t = !1;
          for (const s of this.aTi)
            if (a.s5n === s.ConfigId) {
              var r = 1 === s.IsUnlock;
              s.ComposeCount = a.m9n ?? 0, s.MadeCountInLimitTime = a.lGs ?? 0, s.IsUnlock = 1, t = !0, r || (e = !0);
              break
            } t || (i = ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(a.s5n), o = ConfigManager_1.ConfigManager.ItemConfig.GetConfig(i.ItemId), o = {
            MainType: 1,
            SubType: 0,
            UniqueId: 0,
            ConfigId: a.s5n,
            ...
            SortId: i.SortId
          }, e = !0, ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.ComposeLevelKey, a.s5n), this.aTi.push(o))
        }
      }
      e && ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("FormulaLearned")
    }
  }
  UnlockReagentProductionData(t) {
    ...
    if (1 === e.FormulaType) {
      let t = 0;
      for (; t < this.aTi.length && (35 !== this.aTi[t].SubType || this.aTi[t].ConfigId !== e.FormulaItemId); t++);
      this.aTi.splice(t, 1)
    }
  }
  ...
  GetReagentProductionDataById(t) {
    for (const e of this.aTi)
      if (t === e.ConfigId) return e
  }
  GetReagentProductionRoleId(t) {
    t = this.GetReagentProductionDataById(t);
    return t?.LastRoleId ? t.LastRoleId : ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerRoleId()
  }
  CreateExchangeDataList() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Compose", 5, "初始化置换道具列表"), this.Tjl || (this.Tjl = new Array), this.Tjl.length = 0;
  ...
  CheckBaseItemData(t, e = 255) {
    var o = !0;
    return (o &&= !(0 < (1 & e)) || this.CheckUnlock(t)) && (!(0 < (2 & e)) || this.CheckLimitCount(t)) && (!(0 < (4 & e)) || this.CheckCoinEnough(t.ConfigId)) && (!(0 < (8 & e)) || this.CheckComposeMaterialEnough(t.ConfigId)) && (!(0 < (16 & e)) || this.CheckExchangeMaterialEnough(t.ConfigId))
  }
  CheckCoinEnough(t) {
    var e = ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(t);
    return e ? ModelManager_1.ModelManager.InventoryModel.CheckIsCoinEnough(ComposeController_1.ComposeController.ComposeCoinId, e.ConsumeItems) : (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Compose", 74, "合成配方不存在, 跳过CheckCoinEnough检查", ["id=", t]), !0)
  }
  CheckLimitCount(t) {
  ...
  CheckComposeMaterialEnough(t) {
    ...
    if (e)
      ...
      } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("Compose", 74, "合成配方不存在, 跳过CheckComposeMaterialEnough检查", ["id=", t]);
    return !0
  }
  CheckExchangeMaterialEnough(t) {
    var e = this.GetExchangeDataById(t);
    if (!e) return Log_1.Log.CheckWarn() && Log_1.Log.Warn("Compose", 74, "置换数据不存在, 跳过CheckExchangeMaterialEnough检查", ["id=", t]), !0;
  ...
  CreateStructureDataList(t) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Compose", 49, "初始化构造数据相关数据列表"), this.hTi || (this.hTi = new Array), this.hTi.length = 0;
    var e, o = ConfigManager_1.ConfigManager.ComposeConfig.GetComposeListByType(2) ?? [],
      i = new Map;
    for (const s of o) s.FormulaItemId <= 0 || (e = ConfigManager_1.ConfigManager.ItemConfig?.GetConfig(s.ItemId), e = {
      MainType: 2,
      SubType: 37,
      ConfigId: s.Id,
      StructureCount: 0,
      ...
      SortId: s.SortId
    }, i.set(e.ConfigId, e), this.hTi.push(e));
    for (const n of t) {
      ...
      if (2 === r.FormulaType) {
        ...
        let t = void 0;
        i.has(n.s5n) ? ((t = i.get(n.s5n)).StructureCount = n.m9n, t.IsNew = ModelManager_1.ModelManager.NewFlagModel.HasNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.ComposeLevelKey, n.s5n), t.LastRoleId = n.cPs, t.ExistStartTime = MathUtils_1.MathUtils.LongToNumber(n.CPs) * TimeUtil_1.TimeUtil.Millisecond, t.ExistEndTime = MathUtils_1.MathUtils.LongToNumber(n.gPs) * TimeUtil_1.TimeUtil.Millisecond, t.MadeCountInLimitTime = n.lGs, t.TotalMakeCountInLimitTime = n.dPs, t.IsUnlock = 1) : (t = {
          MainType: 2,
          SubType: 0,
          ConfigId: n.s5n,
  ...
  UpdateStructureDataList(t) {
    if (this.hTi && !(this.hTi.length <= 0))
      for (const r of t) {
        var o, i = ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(r.s5n);
        if (2 === i.FormulaType) {
          let t = !1,
            e = !1;
          for (const a of this.hTi)
            if (r.s5n === a.ConfigId) {
              a.StructureCount = r.m9n ?? 0, a.MadeCountInLimitTime = r.lGs ?? 0, t = !0, e = !a.IsUnlock, a.IsUnlock = 1;
              break
            }! e && t || (ModelManager_1.ModelManager.NewFlagModel.AddNewFlag(LocalStorageDefine_1.ELocalStoragePlayerKey.ComposeLevelKey, r.s5n), ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("FormulaLearned")), t || (o = ConfigManager_1.ConfigManager.ItemConfig.GetConfig(i.ItemId), o = {
            MainType: 2,
            SubType: 0,
            ConfigId: r.s5n,
  ...
  UnlockStructureData(t) {
    ...
    if (2 === e.FormulaType) {
      let t = 0;
      for (; t < this.hTi.length && (37 !== this.hTi[t].SubType || this.hTi[t].ConfigId !== e.FormulaItemId); t++);
      this.hTi.splice(t, 1)
    }
  }
  ...
  GetStructureRoleId(t) {
    ...
    return t && t.LastRoleId ? t.LastRoleId : ModelManager_1.ModelManager.PlayerInfoModel.GetPlayerRoleId()
  }
  CreatePurificationDataList() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Compose", 49, "初始化纯化数据相关数据列表"), this.lTi || (this.lTi = new Array);
      ...
      for (const o of t) {
        ...
        if (3 === e.FormulaType)
          for (const i of this.lTi)
            if (o.s5n === i.ConfigId) {
              i.IsUnlock = 1, i.LastRoleId = o.cPs ?? 0, i.ExistStartTime = MathUtils_1.MathUtils.LongToNumber(o.CPs) * TimeUtil_1.TimeUtil.Millisecond, i.ExistEndTime = MathUtils_1.MathUtils.LongToNumber(o.gPs) * TimeUtil_1.TimeUtil.Millisecond, i.MadeCountInLimitTime = o.lGs, i.TotalMakeCountInLimitTime = o.dPs;
              break
            }
      }
  }
  ...
  CreateComposeLevelInfo(t) {
    ...
    for (const e of ConfigManager_1.ConfigManager.ComposeConfig.GetComposeLevel()) this.cTi.set(e.Id, e)
  }
  UpdateComposeInfo(t) {
    let e = 0;
    this.mTi && (this.LastExp = this.mTi.TotalProficiency, e = t.hGs - this.mTi.TotalProficiency), this.mTi = {
      ComposeLevel: t.F6n,
  ...
  GetDropIdByLevel(t) {
    t += 1;
    return this.GetComposeMaxLevel() < t ? -1 : this.GetComposeLevelByLevel(t).DropIds
  }
  GetComposeMaterialList(t) {
    var e = new Array;
    for (const o of ConfigManager_1.ConfigManager.ComposeConfig.GetSynthesisFormulaById(t).ConsumeItems) e.push({
      L8n: o.ItemId,
      UVn: o.Count,
      K6n: !0
    });
  ...
  UpdateComposeItemList(t) {
    ...
    for (const e of t) this.dTi.push({
      ItemId: e.L8n,
      ItemNum: e.UVn
    })
  }
  ...
  UpdateHelpRoleItemDataList() {
    ...
    for (const t of ModelManager_1.ModelManager.RoleModel.GetRoleList()) this.gTi.push({
      RoleId: t.GetRoleId(),
  ...
  GetHelpRoleItemDataList(t) {
    ...
    for (const e of this.gTi) e.ItemId = t, e.IsBuff = ComposeController_1.ComposeController.CheckIsBuff(e.RoleId, t);
  ...
  GetSameGroupItem(t) {
    var e = [],
      ...
      t = t.MainType;
    if (3 === t)
      for (const i of this.lTi) i.GroupId === o && e.push(i);
    else if (4 === t)
      for (const r of this.Tjl) r.GroupId === o && e.push(r);
