...
class ComposeCircleItem extends AutoAttachItem_1.AutoAttachItem {
  constructor() {
    super(...arguments), this.ButtonFunction = void 0, this.CheckToggleCanClick = void 0, this.$8i = void 0, this.ItemCurve = void 0, this.Xpt = () => {
      this.ButtonFunction?.(this.$8i, this.$8i.MainType, !0), this.GetExtendToggle(1)?.SetToggleStateForce(1, !1)
