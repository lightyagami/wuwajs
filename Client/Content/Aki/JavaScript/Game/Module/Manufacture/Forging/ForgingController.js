...
class ForgingController extends UiControllerBase_1.UiControllerBase {
  ...
  static SendForgeInfoRequest() {
    ...
    if (ForgingController.iLi) {
      ...
      Net_1.Net.Call(22207, Protocol_1.Aki.Protocol.srs.create(e), e => {
        if (Log_1.Log.CheckDebug()) {
        ...
        if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
          ...
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 15002, undefined, true, false);
  ...
  static async SendForgeInfoRequestAsync() {
    ...
    var e = await Net_1.Net.CallAsync(22207, e);
    if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
      ModelManager_1.ModelManager.ForgingModel.SaveLimitRefreshTime(e.APs);
      ForgingController.tLi(e);
    } else {
  ...
  static SendForgeItemRequest(e, r, o) {
    ...
    Net_1.Net.Call(19931, Protocol_1.Aki.Protocol.hrs.create(t), e => {
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 18519);
      }
    });
  }
  static SendForgeFormulaUnlockRequest(o) {
    ...
    e.s5n = o;
    Net_1.Net.Call(20051, Protocol_1.Aki.Protocol.urs.create(e), e => {
      var r;
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 25997);
      }
    });
  }
