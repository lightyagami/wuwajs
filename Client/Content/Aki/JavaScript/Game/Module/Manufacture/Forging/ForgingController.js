...
class ForgingController extends UiControllerBase_1.UiControllerBase {
  ...
  static SendForgeInfoRequest() {
    ...
    if (ForgingController.iLi) {
      ...
      Net_1.Net.Call(19950, Protocol_1.Aki.Protocol.srs.create(e), e => {
        if (Log_1.Log.CheckDebug()) {
        ...
        if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
          ...
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 17192, undefined, true, false);
  ...
  static async SendForgeInfoRequestAsync() {
    ...
    var e = await Net_1.Net.CallAsync(19950, e);
    if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
      ModelManager_1.ModelManager.ForgingModel.SaveLimitRefreshTime(e.APs);
      ForgingController.tLi(e);
    } else {
  ...
  static SendForgeItemRequest(e, r, o) {
    ...
    Net_1.Net.Call(22316, Protocol_1.Aki.Protocol.hrs.create(t), e => {
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 20857);
      }
    });
  }
  static SendForgeFormulaUnlockRequest(o) {
    ...
    e.s5n = o;
    Net_1.Net.Call(27703, Protocol_1.Aki.Protocol.urs.create(e), e => {
      var r;
      if (Log_1.Log.CheckDebug()) {
      ...
      if (e.Cvs === Protocol_1.Aki.Protocol.Q4n.KRs) {
        ...
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.Cvs, 20622);
      }
    });
  }
