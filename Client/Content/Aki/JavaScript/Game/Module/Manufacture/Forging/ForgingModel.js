...
class ForgingModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Xqt = -1, this.CurrentInteractCreatureDataLongId = void 0, this.nLi = 0, this.ForgingEnterFlow = void 0, this.ForgingSuccessFlow = void 0, this.ForgingFailFlow = void 0, this.sLi = void 0, this.XQs = new Map, this.aLi = void 0, this.hLi = 0, this.lLi = void 0, this.fTi = (t, e) => t.IsBuff === e.IsBuff ? t.RoleId - e.RoleId : t.IsBuff ? -1 : 1
  }
  ...
  OnClear() {
    return this.ForgingEnterFlow = void 0, this.ForgingSuccessFlow = void 0, !(this.ForgingFailFlow = void 0)
  }
  ...
  CreateForgingDataList() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Forging", 49, "初始化锻造数据相关数据列表"), this.sLi || (this.sLi = new Array), this.sLi.length = 0;
    for (const o of ConfigManager_1.ConfigManager.ForgingConfig.GetForgeList()) {
      var t = o.Id,
        ...
        i = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponConfigByItemId(e.ItemId),
        i = {
          MainType: 0,
          ItemId: t,
          IsUnlock: 0,
      ...
      this.sLi.push(i), this.XQs.set(t, i), i.IsForging = this.CheckCanForging(t) ? 1 : 0
    }
  }
  YQs(e) {
  ...
  UpdateForgingDataList(t) {
    for (const o of t) {
      ...
      i && (i.LastRoleId = o.cPs ?? 0, i.ExistStartTime = MathUtils_1.MathUtils.LongToNumber(o.CPs) * TimeUtil_1.TimeUtil.Millisecond, i.ExistEndTime = MathUtils_1.MathUtils.LongToNumber(o.gPs) * TimeUtil_1.TimeUtil.Millisecond, i.MadeCountInLimitTime = o.TUs, i.TotalMakeCountInLimitTime = o.dPs, i.IsUnlock = 1, i.IsForging = this.CheckCanForging(e) ? 1 : 0)
    }
  }
  UpdateForgingByServerConfig(t) {
    for (const n of t) {
      var e = MathUtils_1.MathUtils.LongToNumber(n.CPs) * TimeUtil_1.TimeUtil.Millisecond,
        i = MathUtils_1.MathUtils.LongToNumber(n.gPs) * TimeUtil_1.TimeUtil.Millisecond,
        o = n.s5n,
        r = this.GetForgingDataById(o);
      r && (0 == e && 0 == i || TimeUtil_1.TimeUtil.IsInTimeSpan(e, i) ? (r.ExistStartTime = e, r.ExistEndTime = i) : this.YQs(o))
    }
  }
  GetForgingDataList() {
    return this.sLi
  ...
  GetForgingMaterialList(t) {
    var e = new Array;
    for (const i of ConfigManager_1.ConfigManager.ForgingConfig.GetForgeFormulaById(t).ConsumeItems) e.push({
      L8n: i.ItemId,
      UVn: i.Count,
      K6n: !0
    });
  ...
  UpdateForgingItemList(t) {
    ...
    for (const e of t) this.aLi.push({
      ItemId: e.L8n,
      ItemNum: e.UVn
    })
  }
  ...
  UpdateHelpRoleItemDataList() {
    ...
    for (const t of ModelManager_1.ModelManager.RoleModel.GetRoleList()) this.lLi.push({
      RoleId: t.GetRoleId(),
  ...
  GetHelpRoleItemDataList(t) {
    ...
    for (const e of this.lLi) e.ItemId = t, e.IsBuff = ForgingController_1.ForgingController.CheckIsBuff(e.RoleId, t);
