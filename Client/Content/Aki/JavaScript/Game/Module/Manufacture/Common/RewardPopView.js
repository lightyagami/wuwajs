...
class RewardPopView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.KIi = void 0, this.ZGt = void 0, this.E9 = 0, this.InitCommonPopItem = (e, t, i) => {
  ...
  OnStart() {
    var e = this.OpenParam,
      e = (this.E9 = e.RewardPopType, this.KIi = new GenericScrollView_1.GenericScrollView(this.GetScrollViewWithScrollbar(1), this.InitCommonPopItem), this.GetItem(2).SetUIActive(0 === this.E9 || 3 === this.E9), this.GetItem(4).SetUIActive(0 === this.E9), 1 === this.E9 || CommonManager_1.CommonManager.CheckCanShowExpItem());
    this.GetItem(7).SetUIActive(e), e && (this.ZGt = new ExpItem(this.GetItem(7))), this.GetButton(8).GetOwner().GetUIItem().SetUIActive(0 !== this.E9)
  }
  OnAddEventListener() {
  ...
  OnBeforeDestroy() {
    this.KIi && (this.KIi.ClearChildren(), this.KIi = void 0), this.ZGt && (this.ZGt.Destroy(), this.ZGt = void 0)
  }
  OnAfterShow() {
  ...
  oNt() {
    ...
    } else this.KIi.RefreshByData(CommonManager_1.CommonManager.GetCommonItemList())
  }
  rNt() {
    if (0 === this.E9) {
  ...
  sNt() {
    ...
    this.ZGt.SetExpSprite(t, e), this.ZGt.SetAddText(CommonManager_1.CommonManager.GetCurrentRewardAddExp()), this.ZGt.SetLastText(t), this.ZGt.SetSumText(e)
  }
  nNt() {
