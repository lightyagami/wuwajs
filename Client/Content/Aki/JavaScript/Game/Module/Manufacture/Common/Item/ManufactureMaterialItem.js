...
class ManufactureMaterialItem extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  ...
  OnRefresh(e, t, i) {
    if ((this.fGt = e).IsEmpty) {
      ...
      e.K6n && (r.ItemConfigId = e.L8n), this.Apply(r), this.SetIsPhantomLock(!e.K6n), this.SetSelected(!1)
    }
  }
  bIi() {
    if (!this.fGt) return "";
    if (this.fGt.K6n) {
      var t = this.fGt.UVn * this.BIi,
        i = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(this.fGt.L8n);
      let e = "";
