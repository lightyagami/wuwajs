...
class HelpRoleView extends UiNavigationView_1.UiNavigationView {
  constructor() {
    super(...arguments), this.hNt = void 0, this.lNt = void 0, this.ETt = 0, this._Nt = 0, this.cHe = () => {
      ...
      CommonManager_1.CommonManager.SetCurrentRoleId(this._Nt), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CloseHelpRole)
    }
  }
  OnRegisterComponent() {
  ...
  ShowView(e) {
    this.SetActive(!0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SwitchViewType, 0), this.ETt = e, this._Nt = CommonManager_1.CommonManager.GetCurrentRoleId(), this.xIi()
  }
  wIi() {
    let e = 0;
