...
exports.DailyActivityRewardPanel = undefined;
const UE = require("ue");
...
class DailyActivityRewardPanel extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    ...
    this.d2t = () => {
      ...
      return new DailyActivityRewardItem_1.DailyActivityRewardItem();
    };
  ...
  Init() {
    ...
    var i = t.DailyActivityGoalMap;
    this.qte = t.ActivityValue;
    this.BY = t.ActivityMaxValue;
    var s = [];
    this.h2t = 0;
  ...
  sqe(t) {
    ...
    if (!(t < 0)) {
      this.H3e.GetLayoutItemList()[t].RefreshSelf();
    }
  }
  f2t(t) {
    var i;
  ...
  OnTickRefresh(t) {
    if (this.r2t && (this.n2t += t * TimeUtil_1.TimeUtil.Millisecond, t = MathUtils_1.MathUtils.Clamp(this.n2t / PROGRESS_ANIMATE_TIME, 0, 1), this.qte = MathUtils_1.MathUtils.Lerp(this.o2t, this.i2t, t), t = MathUtils_1.MathUtils.Clamp(this.qte / this.BY, 0, 1), this.f2t(this.qte), this.C2t(t), this.qte === this.i2t)) {
      this.p2t();
    }
  }
  C2t(t) {
  ...
  RefreshProgressBarDynamic(s) {
    ...
    if (!(s <= this.qte)) {
      ...
      this.s2t = [];
      t.forEach((t, i) => {
        if (this.qte < t.Goal && t.Goal <= s) {
          this.s2t.push([t.Goal, i]);
        }
      });
      this.v2t(s);
    }
