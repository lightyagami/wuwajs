...
class DailyActivityRewardItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.Jkt = 0, this.DailyActiveState = void 0, this.SPe = void 0, this.zkt = () => {
  ...
  OnStart() {
    this.GetUiNiagara(6).SetAlpha(0), this.GetUiNiagara(7).SetUIActive(!1), this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem)
  }
  OnBeforeDestroy() {}
  Refresh(e, t, i) {
    this.Jkt = e;
    e = ModelManager_1.ModelManager.DailyActivityModel.DailyActivityGoalMap.get(this.Jkt);
    e && (this.SetRewardGoalValue(e.Goal), this.DailyActiveState !== e.State ? this.RefreshRewardState(e.State, void 0 === this.DailyActiveState) : 3 === this.DailyActiveState && this.GetUiNiagara(7).SetUIActive(!1))
  }
  RefreshSelf() {
  ...
  RefreshRewardState(t, e) {
    ...
    var r = this.GetUiNiagara(7),
      r = (3 !== t || e ? (r.SetUIActive(!1), r.Deactivate()) : (r.SetUIActive(!0), r.ActivateSystem(!0)), 1 !== t || e || this.SPe.PlayLevelSequenceByName("Activate"), 2 === t ? DailyActivityDefine_1.REWARD_BACKGROUND_COLOR_UNFINISHED : DailyActivityDefine_1.REWARD_BACKGROUND_COLOR_FINISHED),
      e = UE.Color.FromHex(r);
    this.GetSprite(5).SetColor(e), this.GetText(0).useChangeColor = 2 !== t, this.DailyActiveState = t
  }
  e2t() {
  ...
  Zkt(e) {
    ...
    ModelManager_1.ModelManager.DailyActivityModel.RewardData = r, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshActivityRewardPopUp)
  }
}
