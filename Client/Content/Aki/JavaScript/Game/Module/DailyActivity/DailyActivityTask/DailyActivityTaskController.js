...
class DailyActiveTaskController extends UiControllerBase_1.UiControllerBase {
    ...
    switch (e) {
      ...
      case 4: {
        let e = "DailyActivityTabView",
          r = void 0;
        a && 1 <= a.length && (e = a[0], 2 <= a.length) && (r = a.slice(1)), DailyActiveTaskController.Vkt(e, r);
        break
      }
      case 5: {
        let e = "DailyActivityTabView";
      ...
      case 6: {
        let e = 0;
        a && 1 <= a.length && (e = Number(a[0])), DailyActiveTaskController.Hkt(e);
        break
      }
      case 7: {
        let e = -1;
        a && 1 <= a.length && (e = Number(a[0])), DailyActiveTaskController.jkt(e);
        break
      }
    }
  }
  static Fkt() {
    if (ModelManager_1.ModelManager.FunctionModel.IsOpen(10023005)) {
      ...
      var [r] = (o = new Map([...o.entries()].sort((e, r) => e[0] - r[0]))).values(), a = ModelManager_1.ModelManager.MapModel.GetAllDynamicMarks().get(12);
      if (a) {
        let e = void 0;
    ...
    } else ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("FunctionDisable")
  }
  static dOe(e) {
    let r = void 0;
    var a = ModelManager_1.ModelManager.AreaModel.GetAreaCountryId() ?? 1;
    if ((0 === e.length ? r = void 0 : 1 === e.length ? r = e[0] : e.length < a ? (r = e[0], Log_1.Log.CheckWarn() && Log_1.Log.Warn("AdventureGuide", 37, "[活跃度系统] 地图跳转Id错误,MarkId数量未对应国家Id", ["当前国家Id", a], ["MarkId数量", e.length])) : r = e[a - 1], void 0 !== r) && !ModelManager_1.ModelManager.MapModel.IsConfigMarkIdUnlock(r)) return void ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("FunctionDisable");
    e = {
      MarkId: r,
      MarkType: 0,
      OpenFogId: 0
  ...
  static jkt(e) {
    void 0 === e || e < 0 ? UiManager_1.UiManager.OpenView("QuestView") : (e = ModelManager_1.ModelManager.QuestNewModel.GetFirstShowQuestByType(e), UiManager_1.UiManager.OpenView("QuestView", e?.Id ?? void 0))
  }
  static Hkt(e) {
    e && (e = ConfigManager_1.ConfigManager.AreaConfig.GetAreaInfo(e)) && (e = {
