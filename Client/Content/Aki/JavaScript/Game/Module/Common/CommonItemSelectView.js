...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.CommonItemSelectView = exports.CommonItemSelectViewOpenViewData = void 0;
const UE = require("ue"),
...
class CommonItemSelectViewOpenViewData extends UiPopViewData_1.UiPopViewData {
  constructor() {
    super(...arguments), this.ItemDataBaseList = void 0, this.SelectedDataList = void 0, this.SelectableComponentData = void 0, this.ExpData = void 0, this.SelectableComponentType = 0, this.UseWayId = 0, this.InitSortToggleState = !1
  }
}
...
class CommonItemSelectView extends UiPanelBase_1.UiPanelBase {
  ...
  UpdateSelectableComponent(e, t, i, o, s = void 0) {
    this.jTt || (this.jTt = new(0 === e ? SelectableComponent_1.SelectableComponent : VisionRecoverySelectableComponent_1.VisionRecoverySelectableComponent), this.jTt.InitLoopScroller(this.GetLoopScrollViewComponent(0), this.GetItem(1), o)), this.SetMaxSize(o.MaxSelectedGridNum), this.WTt(t), this.jTt.UpdateComponent(t, i, s)
  }
