...
class TipsWeaponItem extends UiPanelBase_1.UiPanelBase {
  ...
  UpdateItem(e, i, t) {
    ...
    var a = ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponResonanceConfig(e.ResonId, i),
      t = (this.GetText(8).SetText(t), a && LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), a.Name), ModelManager_1.ModelManager.WeaponModel.GetWeaponConfigDescParams(e, i)),
      a = (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(7), e.Desc, ...t), ConfigManager_1.ConfigManager.WeaponConfig.GetWeaponBreach(e.BreachId, 0));
    LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), "ShopWeaponLevelText", 1, a.LevelLimit), UiComponentUtil_1.UiComponentUtil.SetStarActiveNew(this.tqt, 0, void 0, !1)
  }
}
