...
class MediumItemGridCostComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnActivate() {
    this.Mwt = UE.Color.FromHex(TowerData_1.HIGH_COLOR), this.Ewt = UE.Color.FromHex(TowerData_1.LOW_COLOR)
  }
  OnRefresh(e) {
    ...
    t.SetColor(e ? this.Mwt : this.Ewt), this.GetItem(1).SetColor(e ? this.Mwt : this.Ewt), this.SetActive(!0)
  }
}
