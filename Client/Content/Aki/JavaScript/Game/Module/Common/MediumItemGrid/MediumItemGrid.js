...
const UE = require("ue"),
  ...
  MediumItemGridUnRecommendComponent_1 = require("./MediumItemGridComponent/MediumItemGridUnRecommendComponent"),
...
class MediumItemGrid extends ItemGridBase_1.ItemGridBase {
  constructor() {
    super(...arguments), this.rwt = 0, this.nwt = 0, this.swt = void 0, this.awt = void 0, this.hwt = void 0, this.lwt = e => {
  ...
  UnBindComponentEvents() {
    this.UnBindReduceButtonCallback(), this.UnBindEmptySlotButtonCallback(), this.UnBindReduceLongPress()
  }
  Apply(e) {
    this.ClearVisibleComponent(), this.ClearComponentList(), 1 === e.Type && this._wt(e), 5 === e.Type && this.xV_(e), 4 === e.Type && this.uwt(e), 3 === e.Type && this.cwt(e), 2 === e.Type && this.mwt(e), this.RefreshComponentVisible(), this.RefreshComponentHierarchyIndex()
  }
  _wt(e) {
    this.Data = e.Data, this.SetEmptySlotVisible(!0), this.UTt(void 0), this.dwt(void 0), this.Cwt(!1), this.SetBottomTextVisible(!1), this.SetExtendToggleEnable(!0), this.ApplyEmptyDisplay(e)
  }
  xV_(e) {
    this.Data = e.Data, this.UTt(void 0), this.dwt(void 0), this.Cwt(!1), this.SetBottomTextVisible(!1), this.SetExtendToggleEnable(!0), this.SetBottomTextVisible(!1), this.SetOnlyEmptyVisible(!0, e)
  }
  uwt(e) {
    var i = e.StarLevel,
      t = e.IsNewVisible,
      ...
      y = e.ComposeIconTag,
      T = e.ChangeAble,
      q = 3 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(e.ItemConfigId);
    this.SetStartLevel(i), this.SetBuffSprite(o), this.SetRedDotVisible(m), this.SetLevelAndLock(r, n, s, q, d), this.SetCoolDown(u, h), this.SetIsProhibit(p), this.SetReduceButton(I), this.SetGreenSelected(C), this.SetCheckTickVisible(a), this.SetTimeFlagVisible(M), this.SetReceivedFlagVisible(G), this.SetRoleHead(l), this.SetSortIndex(_), this.SetIsDisable(S), this.SetIsMainVision(g), this.SetNewVisible(!m && t), this.SetVisionFetterGroup(v), this.SetVisionRoleHead(c), this.SetComposeIcon(y), this.SetComposeChangeAble(T), this.SetDangoRoleHead(R), this.ApplyPropBaseDisplay(e)
  }
  cwt(e) {
    var i = e.StarLevel,
      ...
      I = e.FetterGroupId,
      C = e.VisionRoleHeadInfo;
    this.SetStartLevel(i), this.SetRedDotVisible(u), this.SetIsMainVision(t), this.SetRoleHead(o), this.SetLevelAndLock(h, n, p, !0, d), this.SetIsPhantomLock(r), this.SetDevelopRewardInfo(s), this.SetNewVisible(m), this.SetVisionFetterGroup(I), this.SetVisionRoleHead(C), this.ApplyPhantomBaseDisplay(e)
  }
  mwt(e) {
    this.SetElement(e.ElementId), this.SetSortIndex(e.Index, e.HighlightIndex), this.SetTeamIcon(e.IsInTeam), this.SetRecommendVisible(e.IsRecommendVisible), this.SetUnRecommendVisible(e.IsUnRecommendVisible), this.SetIsDisable(e.IsDisable), this.SetTrialRoleVisible(e.IsTrialRoleVisible), this.SetLevelAndLock(e.Level, e.IsShowLock, e.IsLevelTextUseChangeColor), this.SetNewVisible(e.IsNewVisible), this.fwt(e.IsShowCost, e.ItemConfigId), this.SetHalfAreaInfo(e.HalfAreaInfo), this.SetWeeklyRogueTag(e.IsShowWeeklyRogueTag), this.ApplyCharacterBaseDisplay(e)
  }
  SetWeeklyRogueTag(e) {
  ...
  SetDangoRoleHead(e) {
    var i = this.RefreshComponent(MediumItemGridDangoRoleHeadComponent_1.MediumItemGridDangoRoleHeadComponent, void 0 !== e && 0 < e.DangoConfigId, e);
    i && this.SetComponentVisible(i, void 0 !== e && 0 < e.DangoConfigId)
  }
  SetDangoPluginIcon(e) {
    this.RefreshComponent(MediumItemGridDangoPluginIconComponent_1.MediumItemGridDangoPluginIconComponent, !0, e)
  }
  SetBuffSprite(e) {
    this.RefreshComponent(MediumItemGridBuffIconComponent_1.MediumItemGridBuffIconComponent, void 0 !== e && 0 !== e, e)
  }
  SetIsPhantomLock(e) {
  ...
  SetLevelAndLock(e, i, t, o, m) {
    ...
    this.RefreshComponent(MediumItemGridLevelAndLockComponent_1.MediumItemGridLevelAndLockComponent, void 0 !== e || i, t)
  }
  SetRedDotVisible(e) {
  ...
  SetStartLevel(e) {}
  SetRoleHead(e) {
    this.RefreshComponent(MediumItemGridRoleHeadComponent_1.MediumItemGridRoleHeadComponent, void 0 !== e && 0 < e.RoleConfigId, e)
  }
  SetVisionRoleHead(e) {
    this.RefreshComponent(MediumItemGridVisionRoleHeadComponent_1.MediumItemGridVisionRoleHeadComponent, void 0 !== e && 0 < e.RoleConfigId, e)
  }
  SetComposeIcon(e) {
    this.RefreshComponent(MediumItemGridComposeTag_1.MediumItemGridComposeTag, void 0 !== e, e)
  }
  ...
  SetVisionSlotState(e) {
    this.RefreshComponent(MediumItemGridVisionSlotComponent_1.MediumItemGridVisionSlotComponent, void 0 !== e && 0 < e.length, e)
  }
  SetDevelopRewardInfo(e) {
    this.RefreshComponent(MediumItemGridDevelopRewardComponent_1.MediumItemGridDevelopRewardComponent, void 0 !== e, e)
  }
  SetIsMainVision(e) {
  ...
  SetCoolDown(e, i) {
    ...
    this.RefreshComponent(MediumItemGridCoolDownComponent_1.MediumItemGridCoolDownComponent, void 0 !== e && 0 < e, i)
  }
  SetIsProhibit(e) {
  ...
  SetReduceButton(e) {
    var i = e?.IsVisible,
      e = this.RefreshComponent(MediumItemGridReduceButtonComponent_1.MediumItemGridReduceButtonComponent, i, e);
    e && (i ? (e.BindReduceButtonCallback(this.OnClickedReduceButton), e.BindLongPressCallback(this.lwt)) : (e.UnBindReduceButtonCallback(), e.UnBindLongPressCallback()))
  }
  SetSortIndex(e, i = !1) {
    i ? this.RefreshComponent(MediumItemGridSortHighlightIndexComponent_1.MediumItemGridSortHighlightIndexComponent, void 0 !== e, e) : this.RefreshComponent(MediumItemGridSortIndexComponent_1.MediumItemGridSortIndexComponent, void 0 !== e, e)
  }
  SetTeamIcon(e) {
    this.RefreshComponent(MediumItemGridTeamIconComponent_1.MediumItemGridTeamIconComponent, void 0 !== e, e)
  }
  ...
  SetEmptySlotVisible(e) {
    ...
    i && (e ? i.BindEmptySlotButtonCallback(this.OnClickedEmptySlotButton) : i.UnBindEmptySlotButtonCallback())
  }
  SetOnlyEmptyVisible(e, i) {
    e = this.RefreshComponent(MediumItemGridEmptyComponent_1.MediumItemGridEmptyComponent, e, e);
    e && (e.OnClickedCallback = i.OnClickedCallback, e.SetClickable(!!i.IsClickable))
  }
  Cwt(e) {
    this.GetSprite(3).SetUIActive(e)
  }
  SetElement(e) {
    this.RefreshComponent(MediumItemGridElementComponent_1.MediumItemGridElementComponent, void 0 !== e, e)
  }
  ...
  SetVisionFetterGroup(e) {
    this.RefreshComponent(MediumItemGridVisionFetterComponent_1.MediumItemGridVisionFetterComponent, void 0 !== e && 0 < e, e)
  }
  IsDisable() {
  ...
  SetIconSprite(e) {
    this.RefreshComponent(MediumItemGridSpriteIconComponent_1.MediumItemGridSpriteIconComponent, void 0 !== e && "" !== e, e)
  }
  ApplyEmptyDisplay(e) {
    var i = e.BottomTextId,
      t = e.BottomText,
      e = e.BottomTextParameter,
      o = !StringUtils_1.StringUtils.IsEmpty(i) || !StringUtils_1.StringUtils.IsEmpty(t);
    this.SetBottomTextVisible(o), o && (this.SetBottomTextId(i, e), this.SetBottomText(t))
  }
  ApplyPropBaseDisplay(e) {
    var i = e.ItemConfigId,
      ...
      r = ConfigManager_1.ConfigManager.InventoryConfig?.GetItemDataTypeByConfigId(e.ItemConfigId),
      d = (e.IsIconHide ? d?.SetUIActive(!1) : e.IconPath ? (this.SetTextureByPath(e.IconPath, d), d?.SetUIActive(!0)) : 13 === r ? this.E41(i) : this.UTt(i), this.SetIconSprite(n), e.QualityId ? this.SetQualityIconById(this.GetSprite(0), e.QualityId, void 0, e.QualityType) : this.dwt(i), !StringUtils_1.StringUtils.IsEmpty(t) || !StringUtils_1.StringUtils.IsEmpty(o));
    this.SetBottomTextVisible(d), d && (this.SetBottomTextId(t, m), this.SetBottomText(o)), this.SetExtendToggleEnable(!0), this.Cwt(!0)
  }
  ApplyPhantomBaseDisplay(e) {
    var i = e.ItemConfigId,
      ...
      n = (this.Data = e.Data, n ? this.pwt(n) : this.UTt(i), void 0 !== d ? this.vwt(d) : e.QualityId ? this.SetQualityIconById(this.GetSprite(0), e.QualityId, void 0, e.QualityType) : this.dwt(i), !StringUtils_1.StringUtils.IsEmpty(t) || !StringUtils_1.StringUtils.IsEmpty(o));
    this.SetBottomTextVisible(n), n && (this.SetBottomTextId(t, m), this.SetBottomText(o)), this.SetExtendToggleEnable(!0), this.Cwt(!0)
  }
  ApplyCharacterBaseDisplay(e) {
    ...
    var t = e.BottomTextId,
      ...
      d = (i > TRIAL_ROLE_ID && (d = ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(i), i = d.ParentId), ConfigManager_1.ConfigManager.SkinConfig.GetRoleSkinConfig(n)),
      d = d.RoleHeadIconLarge,
      d = (this.SetRoleSkinIcon(d, e, n), this.dwt(i), e?.SetUIActive(!0), !StringUtils_1.StringUtils.IsEmpty(t) || !StringUtils_1.StringUtils.IsEmpty(o));
    this.SetBottomTextVisible(d), d && (this.SetBottomTextId(t, m), this.SetBottomText(o)), this.SetExtendToggleEnable(!0), this.Cwt(!0)
  }
  UTt(e) {
    var i = this.GetTexture(1);
    void 0 === e ? i.SetUIActive(!1) : (this.rwt !== e && (this.rwt = e, this.SetItemIcon(i, e)), i.SetUIActive(!0))
  }
  E41(e) {
  ...
  pwt(e) {
    var i = this.GetTexture(1);
    void 0 === e ? i.SetUIActive(!1) : (e = ConfigManager_1.ConfigManager.MonsterInfoConfig.GetMonsterIcon(e), this.SetTextureByPath(e, i), i.SetUIActive(!0))
  }
  dwt(e) {
    var i = this.GetSprite(0);
    void 0 === e ? i.SetUIActive(!1) : (this.nwt !== e && (this.nwt = e, this.yO1(e)), i.SetUIActive(!0))
  }
  yO1(e) {
    var i = this.GetSprite(0);
    13 === ConfigManager_1.ConfigManager.InventoryConfig?.GetItemDataTypeByConfigId(e) ? this.SO1(e) : this.SetItemQualityIcon(i, e, void 0, "MediumItemGridQualitySpritePath")
  }
  SO1(e) {
    var i = this.GetSprite(0),
      e = ConfigManager_1.ConfigManager.DangoAbyssConfig.GetAbyssQualityByPluginItemId(e);
    this.SetSpriteByPath(e.MediumItemGridQualitySpritePath, i, !0)
  }
  vwt(e) {
    var i = this.GetSprite(0);
    void 0 === e || (e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e), StringUtils_1.StringUtils.IsEmpty(e)) ? i.SetUIActive(!1) : (this.SetSpriteByPath(e, i, !0), i.SetUIActive(!0))
  }
  ...
  SetBottomTextId(e, i) {
    ...
    StringUtils_1.StringUtils.IsEmpty(e) || (i ? LguiUtil_1.LguiUtil.SetLocalTextNew(t, e, ...i) : LguiUtil_1.LguiUtil.SetLocalTextNew(t, e))
  }
  SetBottomText(e) {
    var i = this.GetText(2);
