...
class MediumItemGridComposeTag extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    this.GetItem(2).SetUIActive(e.IsRefreshItem), this.GetItem(1).SetUIActive(e.IsLimitTimeItem), this.RefreshBuffIcon(e.BuffItem), this.SetActive(e.IsRefreshItem || e.IsLimitTimeItem || 0 !== e.BuffItem)
  }
  RefreshBuffIcon(s) {
