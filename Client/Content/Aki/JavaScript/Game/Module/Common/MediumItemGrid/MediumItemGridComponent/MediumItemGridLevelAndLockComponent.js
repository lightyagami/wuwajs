...
class MediumItemGridLevelAndLockComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    var t;
    e ? (this.SetLevel(e.Level, e.IsUseVision), this.SetLock(e.IsLockVisible), this.SetDeprecate(e.IsDeprecate), (t = this.GetText(2)).SetChangeColor(e.IsLevelUseChangeColor, t.changeColor), this.SetActive(!0)) : this.SetActive(!1)
  }
  SetLock(e) {
  ...
  Twt(e) {
    ...
    void 0 === e ? t.IsUIActiveSelf() && t.SetUIActive(!1) : (this.GetText(2).SetText(e.toString()), t.IsUIActiveSelf() || t.SetUIActive(!0))
  }
  Lwt(e) {
    var t = this.GetItem(3);
    void 0 === e ? t.IsUIActiveSelf() && t.SetUIActive(!1) : (this.GetText(4).SetText(e.toString()), t.IsUIActiveSelf() || t.SetUIActive(!0))
  }
  GetResourceId() {
