...
class MediumItemGridElementComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    var t, n, i;
    void 0 === e || !(t = ConfigManager_1.ConfigManager.CommonConfig.GetElementConfig(e)) || "" === (n = t.Icon5) || 0 === n.length ? this.SetActive(!1) : (i = this.GetTexture(0), this.SetElementIcon(n, i, e), i.SetColor(UE.Color.FromHex(t.ElementColor)), this.SetActive(!0))
  }
}
