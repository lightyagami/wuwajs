...
class MediumItemGridVisionRoleHeadComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
    ...
    if (i) {
      ...
      if (i) {
        ...
        var i = i.GetRoleSkinId(),
          t = ConfigManager_1.ConfigManager.SkinConfig.GetRoleSkinConfig(i)?.Card;
        t ? (r.SetUIActive(!1), this.SetRoleSkinIcon(t, r, i, void 0, () => {
          r.SetUIActive(!0)
  ...
  qwt(i) {
    ...
    if (ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(i)) {
      ...
      let e = "";
      e = i ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadSprBgB() : ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadSprBgA(), this.SetSpriteByPath(e, this.GetSprite(2), !1)
    }
  ...
  Gwt(i) {
    ...
    if (ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(i)) {
      i = ModelManager_1.ModelManager.PhantomBattleModel.CheckPhantomIsMain(i);
      let e = "";
      e = i ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadLightBgB() : ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadLightBgA(), this.SetSpriteByPath(e, this.GetSprite(1), !1)
    }
