...
class MediumItemGridDangoPluginIconComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  ...
  OnRefresh(e) {
    ...
    i && "" !== e ? (o = i.SlotType, n = this.GetTexture(1), o = DangoAbyssDefine_1.iconSizeBySlotType.get(o), n.SetWidth(o), n.SetHeight(o), this.SetTextureByPath(e, this.GetTexture(0)), this.SetTextureByPath(i.IconMiddle, n), this.SetActive(!0)) : this.SetActive(!1)
  }
}
