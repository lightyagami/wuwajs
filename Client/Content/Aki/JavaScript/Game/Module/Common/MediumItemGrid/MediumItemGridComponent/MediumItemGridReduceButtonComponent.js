...
class MediumItemGridReduceButtonComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  constructor() {
    super(...arguments), this.oft = void 0, this.Dwt = void 0, this.Rwt = void 0, this.Uwt = void 0, this.Awt = t => {
      this.Rwt && this.Rwt(t)
    }, this.Pwt = () => {
      this.oft && this.oft()
    }
  ...
  OnDeactivate() {
    var t = this.GetButton(0);
    t.OnPointDownCallBack.Unbind(), t.OnPointUpCallBack.Unbind(), this.Dwt?.Clear(), this.Dwt = void 0, this.Uwt = void 0, this.oft = void 0
  }
  OnRefresh(t) {
    var e = t.IsVisible,
      t = t.LongPressConfigId;
    this.Uwt = t, this.SetActive(e), void 0 === this.Uwt || this.Dwt.IsActivate() || this.Dwt.Activate(this.Uwt)
  }
