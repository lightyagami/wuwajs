...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.MediumItemGridDevelopRewardComponent = exports.DevelopRewardItem = void 0;
const UE = require("ue"),
...
class MediumItemGridDevelopRewardComponent extends MediumItemGridComponent_1.MediumItemGridComponent {
  constructor() {
    super(...arguments), this.eGe = void 0, this.Swt = 0, this.ywt = 0, this.sGe = (e, t, i) => {
      const s = new DevelopRewardItem;
      return s.CreateByActorAsync(t.GetOwner()).then(() => {
  ...
  OnRefresh(e) {
    e && e.IsUnlock ? (this.Swt = e.DevelopRewardLevel, this.ywt = e.UnlockLevel, this.eGe.RebuildLayoutByDataNew(void 0, this.Swt), this.SetActive(!0)) : this.SetActive(!1)
  }
}
