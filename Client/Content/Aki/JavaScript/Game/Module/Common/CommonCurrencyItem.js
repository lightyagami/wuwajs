...
class CommonCurrencyItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.ItemId = 0, this.SkipAutoAddEvent = !1, this._Y_ = void 0, this.STt = void 0, this.cX_ = void 0, this.ije = () => {
      this.STt?.(), this._Y_?.(this.ItemId)
    }, this.yTt = () => {
      this.cX_ && !this.cX_(this.ItemId) || ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.ItemId)
    }, this.ITt = () => {
      ...
      t === ConfigManager_1.ConfigManager.GachaConfig.PrimaryCurrency() ? ControllerHolder_1.ControllerHolder.PayShopController.OpenPayShopViewToRecharge() : t === ConfigManager_1.ConfigManager.GachaConfig.SecondCurrency() && ControllerHolder_1.ControllerHolder.ItemExchangeController.OpenExchangeViewByItemId(t)
    }
  }
  set ButtonFunction(t) {
    t !== this._Y_ && Log_1.Log.CheckDebug() && Log_1.Log.Debug("WeeklyRogue", 34, "Test"), this._Y_ = t
  }
  OnRegisterComponent() {
  ...
  RefreshCountText(t) {
    var e = this.GetText(1),
      t = t ?? ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(this.ItemId);
  ...
  RefreshAddButtonActive() {
    var t = ConfigManager_1.ConfigManager.GachaConfig.PrimaryCurrency(),
      ...
      i = this.GetButton(2);
    this.ItemId !== t && this.ItemId !== e ? i.RootUIComp.SetUIActive(!1) : i.RootUIComp.SetUIActive(!0)
  }
}
