...
class SelectablePropItem extends SelectablePropItemBase_1.SelectablePropItemBase {
  constructor() {
    super(...arguments), this.ShowItemTipsFunction = void 0, this.AddFunction = void 0, this.ReduceFunction = void 0, this.GetSelectedNumber = void 0, this.GetSelectedSpriteActive = void 0, this.GetGraySpriteActive = void 0, this.PromptFunction = void 0, this.CheckEnableFunction = void 0, this.HideSelectNumberStateFunction = void 0, this.sKe = 0, this.wBt = !1, this.BBt = !1, this.e8 = 0, this.rut = 0, this.H5e = void 0, this.bBt = !1, this.qBt = !1, this.GBt = !0, this.Mne = 1, this.Lo = void 0, this.IsSelectableProp = !0, this.NBt = t => {
      this.wBt = !0
    }, this.OBt = t => {
      this.CheckEnableFunction && !this.CheckEnableFunction(this.PropData, this.GridIndex) || this.bBt || this.kBt(), this.bBt = !1, this.wBt = !1
    }, this.FBt = t => {
      ...
      this.CheckEnableFunction && !this.CheckEnableFunction(this.PropData, this.GridIndex) ? (this.bBt = !1, this.wBt = !1) : (this.qBt || this.jBt(), this.qBt = !1, this.BBt = !1)
    }, this.r6 = t => {
      this.LDe(t)
    }
  }
  ...
  OnStart() {
    this.GetControlItem()?.SetUIActive(!1), this.H5e = this.GetSelectableToggle(), this.H5e.OnPointDownCallBack.Bind(this.NBt), this.H5e.OnPointUpCallBack.Bind(this.OBt), this.H5e.OnPointEnterCallBack.Bind(this.FBt), this.H5e.CanExecuteChange.Bind(this.Lke);
    var t = this.GetReduceButton();
    t.RootUIComp.SetUIActive(this.GBt), t.OnPointDownCallBack.Bind(this.VBt), t.OnPointUpCallBack.Bind(this.HBt), this.Lo = ConfigManager_1.ConfigManager.CommonConfig.GetLongPressConfig(this.Mne), this.sKe = TickSystem_1.TickSystem.Add(this.r6, "SelectablePropItem", 0, !0).Id
  }
  LDe(t) {
    this.wBt || this.BBt ? LguiEventSystemManager_1.LguiEventSystemManager.GetPointerEventData(0).isDragging ? (this.bBt = this.wBt, this.qBt = this.BBt, this.rut = 0, this.e8 = 0) : (this.rut += t, this.rut < this.Lo.PressTime[0] || (this.e8 += t, t = this.dTt(), this.e8 < t) || (this.e8 -= t, this.oTt(!1))) : (this.rut < this.Lo.PressTime[0] && 0 < this.rut && this.oTt(!0), this.rut = 0, this.e8 = 0)
  }
  dTt() {
  ...
  oTt(t) {
    this.wBt && (this.bBt = !0, this.wBt = this.kBt()), this.BBt && (this.qBt = !0, this.BBt = this.jBt())
  }
  WBt() {
    var t;
    this.HideSelectNumberStateFunction ? this.SetControllerState(this.HideSelectNumberStateFunction(this.PropData, this.GridIndex)) : 0 < (t = this.GetSelectedNumber?.(this.PropData) ?? 0) ? (this.SetControllerState(!0), this.GetSelectNumberText() && LguiUtil_1.LguiUtil.SetLocalText(this.GetSelectNumberText(), "RoleExp", t, this.PropData.Count)) : this.SetControllerState(!1)
  }
  ...
  OnBeforeDestroy() {
    var t = this.GetSelectableToggle(),
      t = (t?.OnPointDownCallBack.Unbind(), t?.OnPointUpCallBack.Unbind(), t?.CanExecuteChange.Unbind(), this.GetReduceButton());
    t?.OnPointDownCallBack.Unbind(), t?.OnPointUpCallBack.Unbind(), this.sKe !== TickSystem_1.TickSystem.InvalidId && (TickSystem_1.TickSystem.Remove(this.sKe), this.sKe = TickSystem_1.TickSystem.InvalidId)
  }
  OnRefresh(t, i) {
    this.WBt(), this.Oqe();
    var s = this.GetSelectedSpriteActive?.(this.PropData, this.GridIndex) ?? !1,
      s = (this.GetSelectItem()?.SetUIActive(s), this.GetGraySpriteActive?.(this.PropData, this.GridIndex) ?? !1);
