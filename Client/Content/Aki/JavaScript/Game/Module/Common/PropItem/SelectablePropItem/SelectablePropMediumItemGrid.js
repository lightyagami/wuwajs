...
class SelectablePropMediumItemGrid extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  constructor() {
    super(...arguments), this.SelectablePropData = void 0, this.zBt = void 0, this.ZBt = () => {
  ...
  OnSelected(e) {
    e && (e = {
      IsVisible: !0,
      LongPressConfigId: 1
    }, this.SetSelected(!0, !0), this.SetReduceButton(e))
  }
  OnDeselected(e) {
  ...
  OnBeforeDestroy() {
    this.GetItemGridExtendToggle().FocusListenerDelegate.Unbind(), this.zBt = void 0
  }
  OnRefresh(e, t, i) {
    this.SelectablePropData = e, this.SetSelected(0 < e.SelectedCount, !0), this.zBt && this.zBt(this)
  }
  RefreshUi(e) {
    ...
    if (n = 0 < i ? t.GetAttributeItemData(i) : t.GetCommonItemData(s)) {
      ...
      switch (r) {
        case 0:
          d.BuffIconType = o.ItemBuffType, d.IsOmitBottomText = !1, 0 < a ? (d.BottomTextId = "Text_ItemEnoughText_Text", d.BottomTextParameter = [a, h]) : d.BottomText = h.toString();
          break;
        case 2:
          var l = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(i),
            u = l.GetResonanceLevel();
          d.Level = u, d.BottomTextId = "Text_LevelShow_Text", d.BottomTextParameter = [l.GetLevel()];
          break;
        case 3:
          u = ModelManager_1.ModelManager.PhantomBattleModel.GetPhantomBattleData(i);
          d.Level = u.GetCost(), d.IsLevelTextUseChangeColor = !0, d.BottomTextId = "VisionLevel", d.BottomTextParameter = [u.GetPhantomLevel()], d.VisionFetterGroupId = u.GetFetterGroupId(), d.IsOmitBottomText = !0;
          break;
        default:
          0 < a ? (d.BottomTextId = "Text_ItemEnoughText_Text", d.BottomTextParameter = [a, h]) : d.BottomText = h.toString()
      }
      this.Apply(d)
    }
  }
  RefreshCostCount() {
    if (this.SelectablePropData) {
      ...
      switch (e) {
        case 0:
          0 < t ? this.SetBottomTextId("Text_ItemEnoughText_Text", [t, i]) : this.SetBottomText(this.SelectablePropData.Count.toString());
          break;
        case 2:
        case 3:
          break;
