...
class RoleFilter extends CommonFilter_1.CommonFilter {
  constructor() {
    super(...arguments), this.GetElementConfigId = e => {
  ...
  OnInitFilterMap() {
    this.FilterMap.set(1, this.GetElementConfigId), this.FilterMap.set(2, this.GetWeaponType), this.FilterMap.set(27, this.GetRoleTagIdList)
  }
}
class EditFormationRoleFilter extends(exports.RoleFilter = RoleFilter) {
  constructor() {
    super(...arguments), this.K8_ = e => {
      e = e.GetDataId();
