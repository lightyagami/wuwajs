...
class VisionDestroyFilterLogic {
  ...
  var a, i, o, r = Array.from(r.keys()),
    t = ModelManager_1.ModelManager.PhantomBattleModel?.GetPhantomDataBase(e.GetUniqueId());
  let n = !1;
  for (const s of r) {
    let e = 0;
    if (0 < (e = s >= SUBATTRIBUTEID ? (a = t?.GetSubPropArray(), o = ConfigManager_1.ConfigManager.PhantomBattleConfig?.GetVisionSubPercentageAttributeSortArray().includes(s), i = ModelManager_1.ModelManager.PhantomBattleModel.GetSubAttributeKey(s), VisionDestroyFilterLogic.oDt(a, i, o)) : (a = t?.GetMainPropArray(), i = ConfigManager_1.ConfigManager.PhantomBattleConfig?.GetVisionMainPercentageAttributeSortArray().includes(s), o = ModelManager_1.ModelManager.PhantomBattleModel.GetMainAttributeKey(s), VisionDestroyFilterLogic.oDt(a, o, i)))) {
      n = !0;
      break
    }
  }
  ...
  return (ModelManager_1.ModelManager.PhantomBattleModel?.GetPhantomDataBase(e.GetUniqueId()))?.GetIsDeprecated() ? CalabashDefine_1.VISION_RECOVERT_FILTER_DEPERCATE : CalabashDefine_1.VISION_RECOVERT_FILTER_UNDEPERCATE
};
