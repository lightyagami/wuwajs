...
class DangoAbyssPluginFilter extends CommonFilter_1.CommonFilter {
  constructor() {
    super(...arguments), this.GetDangoAbyssPluginQuality = t => {
      return t.GetQuality()
  ...
  OnInitFilterMap() {
    this.FilterMap.set(35, this.GetDangoAbyssPluginQuality), this.FilterMap.set(36, this.GetDangoAbyssPluginProp), this.FilterMap.set(37, this.GetDangoAbyssPluginTag), this.FilterMap.set(38, this.GetDangoAbyssPluginEquipState), this.FilterMap.set(39, this.GetDangoAbyssPluginLockState), this.FilterMap.set(40, this.GetDangoAbyssPluginDeprecateState)
  }
}
