...
class FilterSortEntrance extends UiPanelBase_1.UiPanelBase {
  constructor(e, t) {
    super(), this.UpdateList = t, this.vpt = void 0, this.Mpt = void 0, this.CreateThenShowByActor(e.GetOwner())
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.vpt = new FilterEntrance_1.FilterEntrance(this.GetItem(0), this.UpdateList), this.Mpt = new SortEntrance_1.SortEntrance(this.GetItem(1), this.UpdateList)
  }
  UpdateData(e, t, ...r) {
  ...
  ClearData(e) {
    var t = ConfigManager_1.ConfigManager.FilterConfig.GetFilterId(e),
      t = (t && ModelManager_1.ModelManager.FilterModel.ClearData(t), ConfigManager_1.ConfigManager.SortConfig.GetSortId(e));
