...
class FilterItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.Pe = void 0, this.j5e = void 0, this.gDt = t => {
  ...
  Ost() {
    var t, i, e = this.Pe.GetIconPath(),
      s = this.GetItem(1);
    StringUtils_1.StringUtils.IsBlank(e) ? s.SetUIActive(!1) : (s.SetUIActive(!0), s = e.includes("Atlas"), (t = this.GetTexture(2)).SetUIActive(!s), (i = this.GetSprite(3)).SetUIActive(s), s ? (this.SetSpriteByPath(e, i, !1), i.SetChangeColor(this.Pe.NeedChangeColor, i.changeColor)) : (this.SetTextureByPath(e, t), t.SetChangeColor(this.Pe.NeedChangeColor, t.changeColor)))
  }
  SetToggleFunction(t) {
    this.j5e = t
  }
...
class FilterGroup extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.pDt = 0, this.vDt = 2, this.MDt = void 0, this.j5e = void 0, this.EDt = void 0, this.Mne = 0, this.Layout = void 0, this.CurrentSelectedDataMap = void 0, this.SDt = void 0, this.yDt = e => {
      if (1 === e)
        for (const i of this.Layout.GetLayoutItemMap().keys()) {
          var t = i;
          this.MDt.set(t.FilterId, t.Content), this.EDt?.(e, t.FilterId, t.Content)
        } else 0 === e && (this.MDt.forEach((t, i) => {
          this.EDt?.(e, i, t)
      ...
      return i.ShowTemp(t, s), {
        Key: t,
        Value: i
      }
    }, this.TDt = (t, i, e) => {
      1 === t ? this.MDt.set(i, e) : this.MDt.delete(i), this.RefreshSelectAllToggleState(), this.j5e?.(t, i, e)
    }, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  DDt() {
    ...
    if (t)
      for (var [i, e] of t) this.MDt.set(i, e)
  }
  ...
  RefreshSelectAllToggleState() {
    var t;
    ConfigManager_1.ConfigManager.FilterConfig.GetFilterConfig(this.Mne).IsSupportSelectAll && (t = ConfigManager_1.ConfigManager.FilterConfig.GetFilterRuleConfig(this.pDt), t = this.MDt.size === t.IdList.length ? 1 : 0, this.GetExtendToggle(2).SetToggleState(t, !1))
  }
  ...
  ShowTemp(t, i) {
    this.pDt = t, this.Mne = i, this.SDt = ModelManager_1.ModelManager.FilterModel.GetFilterItemDataList(this.pDt, this.Mne), this.LDt(), this.InitFilterSetData(), this.RDt(), this.ADt(), this.RefreshSelectAllToggleState(), this.UDt()
  }
  RefreshGroupItem() {
    var t, i;
