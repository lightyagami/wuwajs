...
class FilterModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.nDt = new Map, this.sDt = new FilterLogic_1.FilterLogic
  }
  ...
  UpdateFilterData(e, t) {
    this.GetFilterResultData(e).SetRuleData(t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFilterDataUpdate, e)
  }
}
