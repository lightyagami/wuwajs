...
class FishingItemFilter extends CommonFilter_1.CommonFilter {
  constructor() {
    super(...arguments), this.GetFishingItemTech = t => {
      return t.Tech
  ...
  OnInitFilterMap() {
    this.FilterMap.set(31, this.GetFishingItemTech), this.FilterMap.set(32, this.GetFishingItemTime), this.FilterMap.set(33, this.GetFishingItemArea), this.FilterMap.set(34, this.GetFishingItemType)
  }
}
