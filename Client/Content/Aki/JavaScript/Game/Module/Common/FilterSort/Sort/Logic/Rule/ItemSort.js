...
class ItemSort extends CommonSort_1.CommonSort {
  constructor() {
    ...
    this.nRt = (t, s, e) => {
      ...
      let r = 0;
      let i = 0;
      if (t instanceof CommonItemData_1.CommonItemData) {
        r = t.IsLimitTimeItem() ? 1 : 0;
      }
      return (i = s instanceof CommonItemData_1.CommonItemData ? s.IsLimitTimeItem() ? 1 : 0 : i) - r;
    };
  }
  OnInitSortMap() {
