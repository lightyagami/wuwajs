...
class ItemSort extends CommonSort_1.CommonSort {
  constructor() {
    super(...arguments), this.HDt = (t, s, e) => {
      ...
      let r = 0,
        i = 0;
      return t instanceof CommonItemData_1.CommonItemData && (r = t.IsLimitTimeItem() ? 1 : 0), (i = s instanceof CommonItemData_1.CommonItemData ? s.IsLimitTimeItem() ? 1 : 0 : i) - r
    }
  }
  OnInitSortMap() {
    this.SortMap.set(1, this.jDt), this.SortMap.set(4, this.QDt), this.SortMap.set(2, this.oRt), this.SortMap.set(3, this.KDt), this.SortMap.set(5, this.WDt), this.SortMap.set(6, this.rRt), this.SortMap.set(7, this.HDt), this.SortMap.set(8, this.nRt)
  }
}
