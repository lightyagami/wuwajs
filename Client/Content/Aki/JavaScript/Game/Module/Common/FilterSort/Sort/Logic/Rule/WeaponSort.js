...
class WeaponSort extends CommonSort_1.CommonSort {
  constructor() {
    ...
    this.oRt = (t, e, r) => {
      ...
      var e = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(e.GetUniqueId());
      var i = t ? t.GetLevel() : 0;
      var s = e ? e.GetLevel() : 0;
      if (i !== s) {
        return (s - i) * (r ? -1 : 1);
      } else if ((s = t ? t.GetResonanceLevel() : 0) !== (i = e ? e.GetResonanceLevel() : 0)) {
        return (i - s) * (r ? -1 : 1);
      } else {
        return undefined;
      }
    ...
    this.lUt = (t, e, r) => {
      t = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(t.GetUniqueId());
    ...
    this.KRt = (t, e, r) => {
      if (t.GetIsLock() !== e.GetIsLock()) {
        return ((t.GetIsLock() ? 1 : 0) - (e.GetIsLock() ? 1 : 0)) * -1;
      }
    };
    this.sRt = (t, e, r) => {
  ...
  cUt(t) {
    ...
    if (t) {
      if ((e = t.GetType()) === 4) {
        ...
        if (ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByIncId(t.GetUniqueId())?.HasWeaponCultivated()) {
          return 3;
        } else {
          return 1;
        }
