...
class FilterTypeFunctionLibrary {
  static XLt(r, a) {
    var n = new Array;
    for (const i of r) {
      var e, t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemByMonsterId(i);
      t && 0 !== t.length && ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomRareConfig(t[0].Rarity).Rare === a && (e = ConfigManager_1.ConfigManager.CalabashConfig.GetMonsterNameByMonsterId(i), t = t[0].SkillId, t = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSkillBySkillId(t).BattleViewIcon, e = new FilterData_1.FilterItemData(i, e, t), n.push(e))
    }
    return n
  }
}
exports.FilterTypeFunctionLibrary = FilterTypeFunctionLibrary, (_a = FilterTypeFunctionLibrary).GetElementFilterData = r => {
  var a = new Array;
  ...
  var a, n = new Array;
  for (const e of ConfigManager_1.ConfigManager.MappingConfig.GetWeaponConfList()) r.includes(e.Value) && (a = ConfigManager_1.ConfigManager.MappingConfig.GetWeaponConfComment(e.Comment), n.push(new FilterData_1.FilterItemData(e.Value, a, e.Icon)));
  return n
  ...
  for (const t of r) {
    var n = ConfigManager_1.ConfigManager.CalabashConfig.GetMonsterNameByMonsterId(t),
      e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomItemByMonsterId(t)[0].SkillId,
      e = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomSkillBySkillId(e).BattleViewIcon,
  ...
  for (const t of r) {
    var n = 1 === t ? "PhantomFettersEquip" : "PhantomFettersUnEquip",
      n = ConfigManager_1.ConfigManager.TextConfig.GetTextById(n),
      e = 1 === t ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFilterEquipTexture() : ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFilterNoEquipTexture(),
      n = new FilterData_1.FilterItemData(t, n, e);
    a.push(n)
  }
  return a
  ...
  for (const t of r) {
    var n = 1 === t ? "PhantomFettersHas" : "PhantomFettersUnHas",
      n = ConfigManager_1.ConfigManager.TextConfig.GetTextById(n),
      e = 1 === t ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFilterOwnTexture() : ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFilterNotOwnTexture(),
      n = new FilterData_1.FilterItemData(t, n, e);
    a.push(n)
  }
  return a
}, FilterTypeFunctionLibrary.GetPhantomRarityZeroFilterData = r => _a.XLt(r, 0), FilterTypeFunctionLibrary.GetPhantomRarityOneFilterData = r => _a.XLt(r, 1), FilterTypeFunctionLibrary.GetPhantomRarityTwoFilterData = r => _a.XLt(r, 2), FilterTypeFunctionLibrary.GetPhantomRarityThreeFilterData = r => _a.XLt(r, 3), FilterTypeFunctionLibrary.GetItemQualityFilterData = r => {
  var a = new Array;
  for (const t of r) {
  ...
  for (const t of r) {
    var n = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomRareConfig(t).Cost,
      ...
      n = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionDestroyCostSpriteByCost(n),
  ...
  for (const t of r) {
    var n = ConfigManager_1.ConfigManager.PhantomBattleConfig.GetFetterGroupById(t),
      e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(n.FetterGroupName);
  ...
  for (const t of r) {
    var n = ConfigManager_1.ConfigManager.SortConfig.GetSortRuleAttributeId(t, 4),
      n = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexIcon(n),
  ...
  for (const t of r) {
    var n = t === CalabashDefine_1.VISION_RECOVERT_FILTER_DEPERCATE ? "EchoAbandoned" : "NotAbandoned",
      ...
      e = t === CalabashDefine_1.VISION_RECOVERT_FILTER_DEPERCATE ? ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionRecoveryDesperateIcon() : ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionRecoveryUnDesperateIcon(),
      n = new FilterData_1.FilterItemData(t, n, e);
    a.push(n)
  }
  return a
  ...
  for (const o of r) {
    var n = ConfigManager_1.ConfigManager.SortConfig.GetSortRuleAttributeId(o, 15),
      ...
      t = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(n).Icon,
