...
class SortView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.KUt = void 0, this.QUt = void 0, this.C0t = void 0, this.Z9e = () => {
      this.KUt.Reset(), this.QUt.Reset()
    }, this.xDt = () => {
      var t = ModelManager_1.ModelManager.SortModel.GetSortResultData(this.C0t.ConfigId);
      t.SetSelectBaseSort(this.KUt.GetTempSelect()), t.SetSelectAttributeSort(this.QUt.GetTempSelectMap()), this.C0t.ConfirmFunction?.(), this.CloseMe()
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.KUt = new BaseSortGroup_1.BaseSortGroup(this.GetItem(2)), this.QUt = new AttributeSortGroup_1.AttributeSortGroup(this.GetItem(3)), this.C0t = this.OpenParam, this.AUt()
  }
  OnBeforeDestroy() {
