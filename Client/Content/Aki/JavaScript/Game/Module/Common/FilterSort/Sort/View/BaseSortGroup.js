...
class SortItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.pDt = 0, this.vUt = 1, this.he = "", this.j5e = void 0, this.MUt = void 0, this.gDt = t => {
      1 === t && this.j5e?.(this.pDt, this.he)
    }, this.Lke = () => !this.MUt || this.MUt(this.pDt), this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
  ...
  ShowSortItem(t, i, e) {
    this.pDt = t, this.vUt = i, this.qWe(), this.UTt(), this.SetToggleStateForce(e)
  }
}
class BaseSortGroup extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.eGe = void 0, this.PUt = void 0, this.Mne = 0, this.vUt = 1, this.IUt = (t, i, e) => {
      i = new SortItem(i);
      return i.SetToggleFunction(this.TUt), i.SetCanExecuteChange(this.Lke), i.ShowSortItem(t, this.vUt, this.PUt[0] === t), {
        Key: t,
        Value: i
      }
    }, this.TUt = (t, i) => {
      this.xUt(), this.PUt = [t, i]
    }, this.Lke = t => this.PUt[0] !== t, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
      [0, UE.UILayoutBase],
  ...
  Reset() {
    var t, i, e = ConfigManager_1.ConfigManager.SortConfig.GetSortConfig(this.Mne).BaseSortList[0],
