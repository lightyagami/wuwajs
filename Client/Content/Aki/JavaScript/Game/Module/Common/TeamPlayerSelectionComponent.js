...
class TeamPlayerSelectionComponent extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.dFe = void 0, this.$bt = void 0, this.IsSet = !1, this.CreateThenShowByActor(e.GetOwner())
  }
  OnRegisterComponent() {
  ...
  RefreshItem() {
    var e = this.GetTexture(0),
      i = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(this.dFe).RoleHeadIconBig,
      i = (this.SetTextureByPath(i, e), this.GetSprite(1)),
      e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(`SP_Online${this.$bt}PIcon`);
