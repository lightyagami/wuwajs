...
class MiniRoleHeadItem extends UiPanelBase_1.UiPanelBase {
  constructor(e, i) {
    super(), this.CreateThenShowByResourceIdAsync("UiItem_MiniRoleHead_Prefab", e, !1), this.kwt = i
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    var e, i = this.GetTexture(0);
    i && (e = RoleInfoById_1.configRoleInfoById.GetConfig(this.kwt)) && "" !== (e = e.RoleHeadIconBig) && 0 !== e.length && this.SetRoleIcon(e, i, this.kwt)
  }
}
