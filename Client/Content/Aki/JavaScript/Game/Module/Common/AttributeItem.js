...
class AttributeItem extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.NextItem = void 0, this.qte = "", this.xe = 0, this.zIt = !1
  }
  OnRegisterComponent() {
  ...
  SetNextValue(t) {
    t = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(this.xe, t, this.zIt);
    this.qte && this.qte === t ? this.SetNextItemActive(!1) : this.GetText(3)?.SetText(t)
  }
  SetNextItemActive(t) {
  ...
  Refresh(t, e, i) {
    this.UpdateParam(t.Id, t.IsRatio), this.SetCurrentValue(t.CurValue), this.SetNextItemActive(t.ShowNext), t.NextValue && this.SetNextValue(t.NextValue), t.UseAnotherName && this.RefreshNameByAnotherName(), this.SetBgActive(t.BgActive)
  }
}
