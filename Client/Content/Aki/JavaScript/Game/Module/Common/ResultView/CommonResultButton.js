...
class CommonResultButton extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.IRe = void 0, this.rbt = 0, this.nbt = void 0, this.sbt = void 0, this.ije = () => {
  ...
  SetTipsItem(t, i) {
    ...
    this.GetText(4).SetText(i), this.SetItemIcon(this.GetTexture(3), t), this.GetItem(5).SetUIActive(!0)
  }
  SetTipsItemTextColor(t) {
    this.GetText(4).SetColor(t)
  }
  SetFloatText(t, ...i) {
    this.GetText(2).SetUIActive(!0), LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), t, i)
  }
  GetBtnFloatText() {
    return this.GetText(2).SetUIActive(!0), this.GetText(2)
  }
  SetFloatTextWithTimer(t, i, e) {
    this.ClearBtnTimer(), i || this.SetBtnCanClick(i), this.rbt = t, this.IRe = TimerSystem_1.TimerSystem.Loop(() => {
      this.rbt <= 0 ? i ? this.ije() : this.SetBtnCanClick(!0) : LguiUtil_1.LguiUtil.SetLocalText(this.GetText(2), e, this.rbt--)
    }, CommonDefine_1.MILLIONSECOND_PER_SECOND, t + 1), this.GetText(2).SetUIActive(!0)
  }
  ClearBtnTimer() {
