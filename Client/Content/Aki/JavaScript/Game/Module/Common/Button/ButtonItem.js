...
class ButtonItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.Pe = 0, this.l4e = void 0, this.Gke = void 0, this.ije = () => {
  ...
  BindRedDot(t, e = 0) {
    ...
    i && (this.UnBindRedDot(), this.l4e = t, this.l4e) && RedDotController_1.RedDotController.BindRedDot(t, i, void 0, e)
  }
  BindGivenUid(t, e) {
    var i = this.GetItem(2);
    i && (this.l4e = t, this.l4e) && RedDotController_1.RedDotController.BindRedDot(t, i, void 0, e)
  }
  UnBindGivenUid(t) {
    this.l4e && RedDotController_1.RedDotController.UnBindGivenUi(this.l4e, this.GetItem(2), t)
  }
  UnBindRedDot() {
