...
class ButtonStateController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    this.Vtm = new Map([[0, ModelManager_1.ModelManager.HomeBtnModel]]);
  ...
  static OnClear() {
    ...
    this.R6t();
    this.Vtm?.clear();
    return !(this.Vtm = undefined);
  }
  static R6t() {
    if (this.jtm !== undefined) {
      TimerSystem_1.GameplayTimerSystem.Remove(this.jtm);
      this.jtm = undefined;
    }
  }
  static P3e() {
    this.R6t();
    this.jtm = TimerSystem_1.GameplayTimerSystem.Forever(this.Htm, CHECKGAP, undefined, undefined, undefined, false);
  }
  static RequestBtnState() {
    ...
    if (this.Vtm) {
      ...
      (e = new Protocol_1.Aki.Protocol.Gem()).Itm = [...this.Vtm.keys()];
...
(_a = ButtonStateController).jtm = undefined;
ButtonStateController.Vtm = undefined;
ButtonStateController.xkt = () => {
  _a.RequestBtnState();
  _a.P3e();
};
ButtonStateController.Htm = () => {
  _a.RequestBtnState();
