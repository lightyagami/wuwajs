...
class ButtonAndSpriteItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.G6e = void 0, this.RefreshAllTransitionSprite = () => {
      var e, t = this.GetUiSpriteTransition(2);
  ...
  RefreshSprite(e) {
    ...
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 43, "realPath:  ", ["realPath", e]), this.SetSpriteByPath(e, this.GetSprite(1), !1, void 0, this.RefreshAllTransitionSprite)
  }
  RefreshEnable(e) {
