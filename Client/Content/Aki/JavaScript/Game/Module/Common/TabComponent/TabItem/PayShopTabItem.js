...
class PayShopTabItem extends CommonTabItem_1.CommonTabItem {
  ...
  OnRegisterComponent() {
    super.OnRegisterComponent(), this.ComponentRegisterInfos.push([5, UE.UIText])
  }
  ...
  Refresh(e, t, i) {
    super.Refresh(e, t, i), this.GetTabToggle().RootUIComp.SetUIActive(!1), this.GetTabToggle().RootUIComp.SetUIActive(!0)
  }
  BindRedDot(e, t = 0) {
