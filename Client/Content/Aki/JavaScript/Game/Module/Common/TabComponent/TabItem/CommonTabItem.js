...
class CommonTabItem extends CommonTabItemBase_1.CommonTabItemBase {
  constructor() {
    super(...arguments), this.kbt = void 0, this.RedDotName = void 0, this.Bke = t => {
  ...
  OnRefresh(t, e, i) {
    this.UpdateTabIcon(t.Data?.GetIcon() ?? ""), this.UnBindRedDot(), t.RedDotName && this.BindRedDot(t.RedDotName, t.RedDotUid)
  }
  OnSelected(t) {
    this.SelectedCallBack(this.GridIndex)
  }
  OnUpdateTabIcon(t) {
    "" !== t && this.SetSpriteByPath(t, this.GetSprite(0), !1, void 0, this.RefreshTransition)
  }
  ...
  UnBindGivenUid(t = 0) {
    this.RedDotName && (RedDotController_1.RedDotController.UnBindGivenUi(this.RedDotName, this.GetItem(2), t), this.RedDotName = void 0)
  }
  SetRedDotState(t) {
