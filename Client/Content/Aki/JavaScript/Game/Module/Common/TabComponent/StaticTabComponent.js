...
class StaticTabComponent extends UiPanelBase_1.UiPanelBase {
  constructor(t, i) {
    super(), this.ProxyCreate = t, this.ToggleCallBack = i, this.eGe = void 0, this.NOe = CommonDefine_1.INVALID_VALUE, this.MUt = void 0, this.C5e = (t, i) => {
      t = this.ProxyCreate(t, i);
      return t.GridIndex = i, t.InitTabItem(), t.SetSelectedCallBack(this.gDt), t.SetCanExecuteChange(this.Lke), {
        Key: i,
        Value: t
      }
    }, this.gDt = t => {
  ...
  OnBeforeDestroy() {
    this.eGe && (this.eGe.forEach(t => {
      t.Value.Destroy()
    }), this.eGe = [])
  }
  bbt() {
    var t;
    this.NOe !== CommonDefine_1.INVALID_VALUE && (t = this.eGe[this.NOe]) && t.Value.SetForceSwitch(0)
  }
