...
exports.SmallItemGridCurrentEquipmentComponent = undefined;
const UE = require("ue");
...
class SmallItemGridCurrentEquipmentComponent extends SmallItemGridVisibleComponent_1.SmallItemGridVisibleComponent {
  ...
  OnStart() {
    ...
    var e = UE.Color.FromHex(TOP_COLOR);
...
exports.SmallItemGridCurrentEquipmentComponent = SmallItemGridCurrentEquipmentComponent;
