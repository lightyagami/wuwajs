...
class SmallItemGridElementComponent extends SmallItemGridComponent_1.SmallItemGridComponent {
  ...
  OnRefresh(e) {
    var t, n, r;
    void 0 === e || !(t = ConfigManager_1.ConfigManager.CommonConfig.GetElementConfig(e)) || "" === (n = t.Icon5) || 0 === n.length ? this.SetActive(!1) : (r = this.GetTexture(0), this.SetElementIcon(n, r, e), r.SetColor(UE.Color.FromHex(t.ElementColor)), this.SetActive(!0))
  }
}
