...
class SmallItemTopRightTagComponent extends SmallItemGridComponent_1.SmallItemGridComponent {
  ...
  OnRefresh(t) {
    var e = t.TopRightTextId,
      ...
      l = !r || !o;
    this.SetActive(l), l && (l = this.GetText(1), e && !r ? (r = t.TopRightTextParameter, LguiUtil_1.LguiUtil.SetLocalTextNew(l, e, r)) : i && !o && l.SetText(i), (e = t.TopRightTextBgColor) && this.GetSprite(0).SetColor(UE.Color.FromHex(e)), r = t.TopRightTextColor) && this.GetText(1).SetColor(UE.Color.FromHex(r))
  }
  GetResourceId() {
