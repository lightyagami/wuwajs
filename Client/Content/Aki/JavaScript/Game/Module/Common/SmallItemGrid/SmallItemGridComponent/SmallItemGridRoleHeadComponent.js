...
class SmallItemGridRoleHeadComponent extends SmallItemGridComponent_1.SmallItemGridComponent {
  ...
  OnRefresh(e) {
    if (e) {
      ...
      t ? (i.SetUIActive(!1), this.SetRoleSkinIcon(t, i, e, void 0, () => {
        i.SetUIActive(!0)
      }), this.SetActive(!0)) : this.SetActive(!1)
    } else this.SetActive(!1)
  }
  qwt() {
    var e = this.GetSprite(2),
      t = (e.SetUIActive(!0), ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadSprBgA());
    this.SetSpriteByPath(t, e, !1)
  }
  Gwt() {
    var e = this.GetSprite(1),
      t = (e.SetUIActive(!0), ConfigManager_1.ConfigManager.PhantomBattleConfig.GetVisionHeadLightBgA());
    this.SetSpriteByPath(t, e, !1)
  }
}
