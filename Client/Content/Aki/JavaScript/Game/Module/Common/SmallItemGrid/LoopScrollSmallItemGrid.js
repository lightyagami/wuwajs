...
class LoopScrollSmallItemGrid extends SmallItemGrid_1.SmallItemGrid {
  constructor() {
    super(...arguments), this.ScrollViewDelegate = void 0, this.GridIndex = 0, this.DisplayIndex = 0, this.pbt = void 0
  }
  Refresh(e, t, i) {
  ...
  OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnShowGridAnimation, this.pbt), this.pbt = void 0
  }
  OnShowGridAnimation(e, t) {
    e === this.GridIndex && this.IsSelected && (this.SetSelected(!1), this.SetSelected(!0))
  }
  GetKey(e, t) {
