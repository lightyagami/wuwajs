...
class SmallItemGridDangoPluginIconComponent extends SmallItemGridComponent_1.SmallItemGridComponent {
  ...
  OnRefresh(e) {
    ...
    r && "" !== e ? (o = r.SlotType, n = this.GetTexture(1), o = DangoAbyssDefine_1.iconSizeBySlotType.get(o), n.SetWidth(o), n.SetHeight(o), this.SetTextureByPath(e, this.GetTexture(0)), this.SetTextureByPath(r.IconMiddle, n), this.SetActive(!0)) : this.SetActive(!1)
  }
}
