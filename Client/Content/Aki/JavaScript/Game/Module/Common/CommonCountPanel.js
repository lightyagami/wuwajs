...
class CommonItemCountPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.fTt = "", this.pTt = void 0, this.vTt = void 0, this.SPe = void 0, this.Tct = t => {
  ...
  set t6(t) {
    this.fTt = t, this.GetText(0).SetText(this.fTt), this.GetInteractionGroup(4).SetInteractable(0 < this.fTt.length)
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    ...
    for (let t = 0; t <= KEYCOUNT; t++) this.pTt[t].OnClickCallBack.Bind(() => {
      this.t6.length < MAX_DIGIT ? this.t6 += t : this.t6 = MAX_NUMBER
    });
    this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.SPe.BindSequenceCloseEvent(this.Tct)
  }
  OnBeforeDestroy() {
  ...
  UpdateView(t) {
    this.t6 = t.toString(), this.RootItem.SetUIActive(!0), this.RootItem.SetAsLastHierarchy()
  }
  SetTitleText(t) {
    this.GetText(15).SetText(t)
  }
  PlayStartSequence(t) {
    this.SetActive(!0), this.SPe.PlayLevelSequenceByName("Start"), this.UpdateView(t)
  }
  PlayCloseSequence() {
