...
class CommonConditionFilterItem extends UiPanelBase_1.UiPanelBase {
  constructor(t, e) {
    super(), this.QualityInfo = e, this.ToggleFunction = void 0, this.Bke = t => {
      this.ToggleFunction && this.ToggleFunction(this.QualityInfo.Id, this.QualityInfo.ConsumeFilterText)
