...
class ItemInteractionPanelMainTypeItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.MainTypeId = 0, this.SPt = void 0, this.Jgt = () => {
  ...
  OnStart() {
    ...
    e && (this.SetSpriteByPath(e.Icon, this.GetSprite(0), !1), this.SetActive(!0))
  }
  OnBeforeDestroy() {
    this.SPt = void 0
  }
  SetSelected(e) {
    e ? this.GetExtendToggle(1).SetToggleState(1) : this.GetExtendToggle(1).SetToggleState(0)
  }
  SetRedDotVisible(e) {
