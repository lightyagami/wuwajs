...
class ItemInteractionMediumItemGrid extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  ...
  OnRefresh(e, t, i) {
    var s = (this.WPt = e).ItemConfigId,
      o = (this.hPt = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(s), e.GetCurrentCount()),
      r = e.NeedCount,
      s = {
        Data: e,
        Type: 4,
    ...
    0 < o ? (s.BottomTextId = "ItemCountSelected", s.BottomTextParameter = [o, this.hPt], s.ReduceButtonInfo = {
      IsVisible: !0,
      LongPressConfigId: 1
    }) : this.hPt < r ? (s.BottomTextId = "ItemCountNotEnough", s.BottomTextParameter = [this.hPt]) : s.BottomText = this.hPt.toString(), this.Apply(s), this.SetSelected(e.IsSelected)
  }
  OnSelected(e) {
