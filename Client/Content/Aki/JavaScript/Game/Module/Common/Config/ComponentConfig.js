...
class ComponentConfig extends ConfigBase_1.ConfigBase {
  GetItemConfigParam(e) {
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetItemConfigParam]查找配置数据失败，数据为空", ["标签", e])
  }
  GetQualityConfigParam(e) {
    var o = QualityIconTagById_1.configQualityIconTagById.GetConfig(e);
    if (o) return o.ConfigParam;
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetQualityConfigParam]查找配置数据失败，数据为空", ["标签", e])
  }
  GetRoleConfigParam(e) {
    var o = RoleIconTagById_1.configRoleIconTagById.GetConfig(e);
    if (o) return o.ConfigParam;
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetRoleConfigParam]查找配置数据失败，数据为空", ["标签", e])
  }
  ...
  GetElementConfigParam(e) {
    ...
    if (o) return o.ConfigParam;
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetElementIconTag]查找配置数据失败，数据为空", ["标签", e])
  }
  GetMonsterConfigParam(e) {
    var o = MonsterIconTagById_1.configMonsterIconTagById.GetConfig(e);
    if (!o || o) return o.ConfigParam;
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetMonsterConfigParam]查找配置数据失败，数据为空", ["标签", e])
  }
  GetDungeonEntranceConfigParam(e) {
    var o = EntranceIconTagById_1.configEntranceIconTagById.GetConfig(e);
    if (!o || o) return o.ConfigParam;
    Log_1.Log.CheckError() && Log_1.Log.Error("LguiUtil", 10, "[ComponentConfig.GetDungeonConfigParam]查找配置数据失败，数据为空", ["标签", e])
  }
}
