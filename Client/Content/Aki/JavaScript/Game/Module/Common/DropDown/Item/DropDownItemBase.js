...
class DropDownItemBase extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.Xy = 0, this.j5e = void 0, this.SLt = void 0, this.PLt = () => {
      this.j5e?.(this.Xy)
    }, this.gke = () => this.SLt?.(this.Xy) ?? !1, this.CreateThenShowByActor(t.GetOwner())
  }
  OnStartImplement() {
    var t = this.GetDropDownToggle();
    t.OnStateChange.Clear(), t.CanExecuteChange.Unbind(), t.OnStateChange.Add(this.PLt), t.CanExecuteChange.Bind(this.gke)
  }
