...
class CommonInputViewBase extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.InputData = void 0, this.PAt = void 0, this.j3 = CommonDefine_1.INVALID_VALUE, this.xAt = void 0, this.ConfirmButton = void 0, this.InputText = void 0, this.wAt = void 0, this.BAt = t => {
      ...
      void 0 !== this.InputData.NeedCheckBlank && this.InputData.NeedCheckBlank && 0 < t.length && StringUtils_1.StringUtils.CheckIsOnlyBlank(t) ? this.RefreshTips(5) : i > this.GetMaxLimit() ? (this.RefreshTips(2), this.j3 = 0) : 0 === i && this.InputData.IsCheckNone ? (this.RefreshTips(1), this.j3 = 0) : i < this.GetMinLimit() ? (this.RefreshTips(3), this.j3 = 0) : this.ExtraConfirmCheck(i, t) && this.ExecuteInputConfirm(t)
    }, this.GAt = () => {
  ...
  ExecuteInputConfirm(t) {
    this.InputData.ConfirmFunc?.(t).then(t => {
      t === Protocol_1.Aki.Protocol.Q4n.Proto_ContainsDirtyWord ? this.RefreshTips(4) : this.CloseMe()
    }, () => {
  ...
  SetClearOrPaste() {
    this.wAt && ("" === this.InputText.GetText() ? (this.wAt.RefreshSprite("SP_Paste"), this.wAt.BindCallback(this.QAt)) : (this.wAt.RefreshSprite("SP_Clear"), this.wAt.BindCallback(this.KAt)))
  }
  OnAddEventListener() {
  ...
  YAt() {
    var t = !Platform_1.Platform.IsPs5Platform(),
      t = (t && (this.wAt = new ButtonAndSpriteItem_1.ButtonAndSpriteItem(this.GetItem(7))), this.GetItem(7).SetUIActive(t && this.InputData.NeedFunctionButton), this.ConfirmButton = this.GetButton(4), this.InputText = this.GetInputText(5), this.InputText.bAllowMultiLine = this.IsAllowMultiLine(), this.InputText.OnTextChange.Bind(this.OnTextChange), this.InputText.SetText(this.InputData.InputText, !0), this.GetText(6).SetText(this.InputData.DefaultText), this.SetClearOrPaste(), this.SetTipsVisible(!1), this.InputData.BottomTipsText),
      t = (void 0 !== t && "" !== t ? (this.SetBottomTipsShowState(!0), this.GetText(8).SetText(t)) : this.SetBottomTipsShowState(!1), this.InputData.BottomTipsColor);
