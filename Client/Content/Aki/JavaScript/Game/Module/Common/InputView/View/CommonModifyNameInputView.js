...
class CommonModifyNameInputView extends CommonInputViewBase_1.CommonInputViewBase {
  constructor() {
    super(...arguments), this.Pha = () => {
      this.Hqe()
    }
  }
  OnAddEventListener() {
    super.OnAddEventListener(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnModifyNameStateChange, this.Pha)
  }
  OnRemoveEventListener() {
    super.OnRemoveEventListener(), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnModifyNameStateChange, this.Pha)
  }
  GetMaxLimit() {
  ...
  Hqe() {
    var e = ModelManager_1.ModelManager.PersonalModel.GetPersonalModifyNameState(),
      e = (this.SetBottomTipsShowState(!0), 0 === e || 2 === e ? this.SetBottomTipsTextAndColor("PersonalProfile_ChangeNameLimit", UE.Color.FromHex("6E6A62FF")) : 1 === e && this.SetBottomTipsTextAndColor("PersonalProfile_ChangeNameProcess", UE.Color.FromHex("C25757FF")), 0 === e),
  ...
  ExecuteInputConfirm(e) {
    this.InputData.ConfirmFunc?.(e).then(e => {
      e === Protocol_1.Aki.Protocol.Q4n.Proto_ContainsDirtyWord && this.RefreshTips(4)
    }, () => {
