...
class CommonItemGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(t = void 0) {
    super(), this.qTt = 0, this.GTt = void 0, this.NTt = t => {
  ...
  OnStart() {
    this.SHe(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.CloseItemTips, this.OTt)
  }
  OnBeforeDestroy() {
  ...
  FTt() {
    this.SetItemIcon(this.GetTexture(3), this.qTt, this.GTt), this.SetItemQualityIcon(this.GetSprite(4), this.qTt, this.GTt)
  }
  Refresh(t, i, e) {
    var s = t[0],
      t = t[1];
  ...
  VTt(t = 0) {
    t ? (LguiUtil_1.LguiUtil.SetLocalText(this.GetText(10), "ShowCount", t), this.GetItem(12).SetUIActive(!0)) : this.GetItem(12).SetUIActive(!1)
  }
  SetRoleHead(t) {
    var i = this.GetTexture(6),
      e = this.GetSprite(7);
    StringUtils_1.StringUtils.IsEmpty(t) ? (i.SetUIActive(!1), e.SetUIActive(!1)) : (i.SetUIActive(!0), e.SetUIActive(!0), this.SetTextureByPath(t, i))
  }
  kTt(t = 0) {
    t ? (this.GetText(8).SetText(t.toFixed(0)), this.GetItem(9).SetUIActive(!0)) : this.GetItem(9).SetUIActive(!1)
  }
  SetMask(t) {
  ...
  async HTt() {
    const t = new CustomPromise_1.CustomPromise,
      i = (this.GetTexture(3).SetUIActive(!1), this.SetItemIcon(this.GetTexture(3), this.qTt, this.GTt, () => {
        t.SetResult(void 0), this.GetTexture(3)?.SetUIActive(!0)
      }), await t.Promise, new CustomPromise_1.CustomPromise);
