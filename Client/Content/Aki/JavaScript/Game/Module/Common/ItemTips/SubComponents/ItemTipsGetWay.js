...
class TipsGetWayPanel extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.yxt = void 0, this.Ixt = void 0, this.Txt = (t, e, s) => {
      return {
        Key: s,
  ...
  Refresh(t) {
    ...
    }), this.yxt = t, this.Ixt.RebuildLayoutByDataNew(this.yxt), this.SetActive(0 !== this.yxt.length)
  }
}
exports.TipsGetWayPanel = TipsGetWayPanel;
class TipsGetWayItem extends UiPanelBase_1.UiPanelBase {
  constructor(t, e) {
    super(), this.Gke = void 0, this.Lxt = () => {
      this.Gke && this.Gke()
    }, this.Pe = e, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  OnStart() {
    switch (this.Gke = this.Pe.Function, this.Pe.Type) {
      case 2:
        this.GetButton(0).RootUIComp.SetUIActive(!0), this.GetButton(1).RootUIComp.SetUIActive(!1), this.GetText(2).ShowTextNew(this.Pe.Text);
        break;
      case 1:
        this.GetButton(0).RootUIComp.SetUIActive(!1), this.GetButton(1).RootUIComp.SetUIActive(!0), this.GetText(3).ShowTextNew(this.Pe.Text)
    }
  }
  OnBeforeDestroy() {
