...
class ItemTipsLockState extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.HelpBtnCallback = void 0, this.PanelData = void 0, this.mji = () => {
  ...
  UpdateData(t) {
    ...
    var i = t?.TipsTextKey ?? "GenericPrompt_Short_TipsText",
      e = this.GetText(1);
    LguiUtil_1.LguiUtil.SetLocalTextNew(e, i, t?.TipsTextParams), this.GetButton(2).RootUIComp.SetUIActive(!!t?.IsShowHelpButton), this.SetActive(!0)
  }
}
