...
class TipsLockButton extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this._Xe = 0, this.Kvt = void 0, this.gke = () => !this.Kvt || this.Kvt(this._Xe), this.L3a = e => {
      e === this._Xe && this.Hqe(e)
    }, this.Uxt = () => {
      var e = ModelManager_1.ModelManager.InventoryModel.GetAttributeItemData(this._Xe);
      void 0 !== e && ControllerHolder_1.ControllerHolder.InventoryController.ItemLockRequest(this._Xe, !e.GetIsLock())
    }, this.A3a = () => {
      var e = ModelManager_1.ModelManager.InventoryModel.GetAttributeItemData(this._Xe);
      void 0 !== e && InventoryController_1.InventoryController.ItemDeprecateRequest(this._Xe, !e.GetIsDeprecated())
  ...
  Hqe(e) {
    var t, e = ModelManager_1.ModelManager.InventoryModel.GetAttributeItemData(e);
    void 0 !== e && (this.GetExtendToggle(0).RootUIComp.SetUIActive(e.CanLock()), this.GetExtendToggle(1).RootUIComp.SetUIActive(e.CanDeprecate()), t = e.GetIsLock() ? 0 : 1, this.GetExtendToggle(0).SetToggleStateForce(t, !1), t = e.GetIsDeprecated() ? 1 : 0, this.GetExtendToggle(1).SetToggleStateForce(t, !1))
  }
