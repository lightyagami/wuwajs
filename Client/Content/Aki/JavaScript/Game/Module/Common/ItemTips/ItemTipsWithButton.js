...
class ItemTipsWithButtonComponent extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.GXs = void 0, this.Mxt = void 0, this.au_ = void 0, this.Dxt = void 0, this.W2e = () => {
  ...
  async OnBeforeStartAsync() {
    this.GXs = new ItemTipsComponent_1.ItemTipsComponentContentComponent, await this.GXs.CreateByActorAsync(this.GetItem(0).GetOwner()), this.Dxt = new ItemTipsLockState_1.ItemTipsLockState, await this.Dxt.Init(this.GetItem(3)), this.Dxt.SetActive(!1)
  }
  OnStart() {
    this.Mxt = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(1), this.W2e)
  }
  OnBeforeDestroy() {
  ...
  RefreshButton(t) {
    ...
    for (const s of t) {
      ...
      i.OnClickCallback = s.Function, i.ButtonText = s.Text, i.RedDotName = s.RedDotName, i.Index = s.Index, e.push(i)
    }
  ...
  async SetButtonTextByIndex(t, e, i) {
    this.au_ && await this.au_.Promise, this.Mxt.GetLayoutItemMap().get(t)?.SetLocalText(e, i)
  }
  async SetButtonEnableByIndex(t, e) {
    this.au_ && await this.au_.Promise, this.Mxt.GetLayoutItemMap().get(t)?.SetEnableClick(e)
  }
  SetButtonPanelVisible(t) {
    this.GetHorizontalLayout(1).RootUIComp.SetUIActive(t)
  }
  async SetButtonRedDotVisible(t, e) {
    this.au_ && await this.au_.Promise, this.Mxt.GetLayoutItemMap().get(t)?.SetRedDotVisible(e)
  }
  SetVisible(t) {
    this.SetActive(t)
  }
