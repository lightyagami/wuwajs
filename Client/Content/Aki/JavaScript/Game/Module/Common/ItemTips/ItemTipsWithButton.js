...
exports.ItemTipsWithButtonComponent = undefined;
const UE = require("ue");
const CustomPromise_1 = require("../../../../Core/Common/CustomPromise");
const UiPanelBase_1 = require("../../../Ui/Base/UiPanelBase");
const GenericLayout_1 = require("../../Util/Layout/GenericLayout");
const LayoutButtonItem_1 = require("../Button/LayoutButtonItem");
const ItemTipsComponent_1 = require("./ItemTipsComponent");
const ItemTipsLockState_1 = require("./SubComponents/ItemTipsLockState");
class ItemTipsWithButtonComponent extends UiPanelBase_1.UiPanelBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIHorizontalLayout], [2, UE.UIItem], [3, UE.UIItem]];
  }
