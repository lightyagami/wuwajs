...
class CommonRewardPopup extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.KTt = void 0, this.QTt = void 0, this.vot = new Map, this.Cxo = void 0, this.rOe = () => {
...
class RewardPanelItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, i) {
    this.$Tt = e, this._Ne.RefreshByConfigId(this.$Tt.Id, this.$Tt.Num), this._Ne.SetReceivedVisible(this.$Tt.Received)
  }
  OnBeforeDestroy() {
    this.$Tt = void 0
  }
