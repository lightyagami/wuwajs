...
class ItemGrid extends ItemGridAbstract_1.ItemGridAbstract {
  constructor() {
    super(...arguments), this.iPt = void 0, this.oPt = void 0, this.rPt = "", this.nPt = 0, this.sPt = () => {
      var t;
      this.iPt || this.oPt ? (t = this.GetClickToggle().ToggleState, this.iPt?.(this.GetItemId(), this.GetItemConfig()), this.oPt?.(t)) : ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.GetItemId())
    }, this.IsItemGrid = !0
  }
  OnRegisterComponent() {
  ...
  RefreshTextDownByTextId(t, e, ...i) {
    this.GetItem(3).SetUIActive(t), t && LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e, ...i)
  }
  ...
  BindRedPointWithKeyAndId(t, e) {
    this.aPt(), this.rPt = t, this.nPt = e, RedDotController_1.RedDotController.BindRedDot(t, this.GetItem(6), void 0, e)
  }
  aPt() {
    StringUtils_1.StringUtils.IsEmpty(this.rPt) || RedDotController_1.RedDotController.UnBindGivenUi(this.rPt, this.GetItem(6), this.nPt)
  }
  RefreshCdPanel(t, e, i) {
    this.GetItem(7).SetUIActive(t), t && (this.GetSprite(8).SetFillAmount(e), this.GetText(9).SetText(i))
  }
  RefreshDarkSprite(t) {
