...
class CommonItemSimpleGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor(t = void 0) {
    super(), this.qTt = 0, this.tPt = "ShowCount", this.GTt = void 0, this.NTt = t => {
  ...
  ResetToggleClick() {
    this.GetExtendToggle(4).OnStateChange.Clear(), this.GetExtendToggle(4).OnStateChange.Add(this.Bke)
  }
  FTt() {
  ...
  SetCount(t = 0) {
    t ? (LguiUtil_1.LguiUtil.SetLocalText(this.GetCountText(), this.tPt, t), this.GetCountItem().SetUIActive(!0)) : this.GetCountItem().SetUIActive(!1)
  }
  GetCountText() {
  ...
  async HTt() {
    const t = new CustomPromise_1.CustomPromise,
      e = (this.SetItemIcon(this.GetTexture(1), this.qTt, void 0, () => {
        t.SetResult(void 0)
      }), await t.Promise, new CustomPromise_1.CustomPromise);
    this.SetItemQualityIcon(this.GetSprite(0), this.qTt, void 0, "BackgroundSprite", () => {
      e.SetResult(void 0)
    }), await e.Promise
  }
}
