...
class CommonItemSmallItemGrid extends LoopScrollSmallItemGrid_1.LoopScrollSmallItemGrid {
  constructor() {
    super(...arguments), this.ConfigId = 0, this.thl = !0, this.ShowReceivedCallBack = void 0
  }
  OnRefresh(e, t, i) {
    this.Refresh(e)
  }
  Refresh(e) {
    var t = e[0],
      i = e[1],
      t = (this.ConfigId = t.ItemId, ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.ConfigId));
    if (1 === t) {
  ...
  RefreshByConfigId(e, t, i, o = !1) {
    if (this.ConfigId = e, 1 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.ConfigId)) {
  ...
  OnExtendToggleClicked() {
    this.thl && ControllerHolder_1.ControllerHolder.ItemController.OpenItemTipsByItemId(this.ConfigId)
  }
}
