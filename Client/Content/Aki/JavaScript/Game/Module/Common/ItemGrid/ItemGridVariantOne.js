...
exports.ItemGridVariantOne = undefined;
const UE = require("ue");
...
class ItemGridVariantOne extends ItemGridAbstract_1.ItemGridAbstract {
  constructor() {
    ...
    this.StarLayoutItem = undefined;
    this.IsItemGridVariantOne = true;
    this.IsItemGrid = true;
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIItem], [1, UE.UIItem], [2, UE.UIVerticalLayout], [3, UE.UISprite], [4, UE.UISprite], [5, UE.UIItem], [6, UE.UIText]];
  }
  OnStart() {
    this.StarLayoutItem = new StarLayoutItem(this.GetItem(1));
    this.ItemGrid = new ItemGrid_1.ItemGrid(this.GetItem(0).GetOwner(), this);
    this.RefreshStar(undefined);
    this.RefreshRecoverSprite(false);
    this.RefreshRightDownLockSprite(false);
    this.RefreshUpgradePanel(false, undefined);
  }
...
class StarLayoutItem extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshStar(e) {
    ...
    if (t > 0) {
      this.StarLayout.RebuildLayoutByDataNew(e);
    }
  }
  OnBeforeDestroy() {
