...
class ItemGridVariantOne extends ItemGridAbstract_1.ItemGridAbstract {
  constructor() {
    super(...arguments), this.ItemGrid = void 0, this.StarLayoutItem = void 0, this.IsItemGridVariantOne = !0, this.IsItemGrid = !0
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.StarLayoutItem = new StarLayoutItem(this.GetItem(1)), this.ItemGrid = new ItemGrid_1.ItemGrid(this.GetItem(0).GetOwner(), this), this.RefreshStar(void 0), this.RefreshRecoverSprite(!1), this.RefreshRightDownLockSprite(!1), this.RefreshUpgradePanel(!1, void 0)
  }
...
class StarLayoutItem extends UiPanelBase_1.UiPanelBase {
  constructor(e) {
    super(), this.StarLayout = void 0, this.vke = (e, t, s) => {
      return {
        Key: s,
        Value: new StarItem(t)
      }
  ...
  OnStart() {
    this.StarLayout = new GenericLayoutNew_1.GenericLayoutNew(this.GetVerticalLayout(0), this.vke, this.GetItem(1))
  }
  RefreshStar(e) {
    var t = e?.length ?? 0;
    this.GetVerticalLayout(0).RootUIComp.SetUIActive(0 < t), 0 < t && this.StarLayout.RebuildLayoutByDataNew(e)
  }
  OnBeforeDestroy() {
