...
class WeeklyRogueSelectTokenView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.lV_ = void 0, this.lqe = void 0, this.tV_ = () => {
      var e = new WeeklyRogueTokenItem_1.WeeklyRogueTokenItem;
      return e.OnSelectedChange = this.ELt, e
    }, this.ELt = e => {
      void 0 === e ? (this.lV_?.DeselectCurrentGridProxy(), this.GetButton(1).SetSelfInteractive(!1)) : (this.lV_?.SelectGridProxy(e), this.GetButton(1).SetSelfInteractive(!0))
    }, this.ilo = () => {
      WeeklyRogueController_1.WeeklyRogueController.Instance?.SelectOptionRequest(), this.CloseMe()
    }, this.tlo = () => {
      this.CloseMe()
    }, this.Mlo = () => {
  ...
  async OnBeforeStartAsync() {
    ...
    var e = this.OpenParam,
      e = (this.lqe = new PopupCaptionItem_1.PopupCaptionItem, await Promise.all([this.lqe.CreateThenShowByActorAsync(this.GetItem(6).GetOwner()), this.lV_.RefreshByDataAsync(e.UN_)]), await this.lqe.SetCurrencyItemList([RoguelikeDefine_1.INSIDE_CURRENCY_ID]), this.GetButton(1).SetSelfInteractive(!1), 0 === ModelManager_1.ModelManager.WeeklyRogueModel.DescMode ? 1 : 0);
