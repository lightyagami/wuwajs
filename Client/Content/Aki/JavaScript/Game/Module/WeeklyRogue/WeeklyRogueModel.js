...
class WeeklyRogueModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.BuffList = [], this.OptionMap = new Map, this.CurrentLayer = 0, this.MaxLayer = 0, this.CurrentBindId = 0, this.CurrentRoomTypeId = "", this.CurrentRoomId = 0, this.CurrentRoomType = 0, this.DescMode = 0, this.SelectEntry = void 0, this.CurrentActivityId = 0, this.lec = new StateRef_1.StateRef("game_rogue_room_type", "none")
  }
  get CycleId() {
    return 0 === this.CurrentActivityId ? 0 : this.ActivityData.CycleId
  }
  ...
  ChangeDescMode() {
    this.DescMode = 0 === this.DescMode ? 1 : 0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.WeeklyRogueDescModeChange)
  }
  GetCurrentOption() {
  ...
  CheckIsInWeeklyRogue() {
    return 29 === ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(ModelManager_1.ModelManager.CreatureModel.GetInstanceId())?.InstSubType && ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance()
  }
  IsWeeklyRogueOpen() {
    var e = ModelManager_1.ModelManager.EditBattleTeamModel.GetInstanceDungeonId;
    return !!e && !!(e = ConfigManager_1.ConfigManager.InstanceDungeonConfig.GetConfig(e)) && 29 === e.InstSubType
  }
  ...
  GetScoreRewardData() {
    ...
    var e = {
      ...
      e = (this.ActivityData.AwardsInfoList?.forEach(e => {
