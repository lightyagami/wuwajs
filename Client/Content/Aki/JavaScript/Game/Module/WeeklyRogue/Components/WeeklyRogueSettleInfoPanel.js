...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.WeeklyRogueSettleInfoPanelItem = exports.WeeklyRogueSettleInfoPanel = void 0;
const UE = require("ue"),
...
class WeeklyRogueSettleInfoPanelItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(e, t, s) {
    LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.Title), this.GetText(2).SetText(e.Content), this.GetItem(3)?.SetUIActive(e.IsDoubleItem)
  }
}
