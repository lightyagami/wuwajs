...
class WeeklyRogueTeamInfoPanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RoleListLayout = void 0, this.AttributeItemList = [], this.uyi = () => {
      ...
      t.length <= 0 ? Log_1.Log.CheckError() && Log_1.Log.Error("WeeklyRogue", 34, "肉鸽属性展示面板, 找不到主控角色实体!") : (t = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(t[e].GetConfigId), RoleController_1.RoleController.OnSelectedRoleChange(t.GetRoleConfig().Id, t.GetRoleSkinId()), this.RoleListLayout?.SelectGridProxy(e, !1), this.UpdateAttribute())
    }, this.nlo = () => {
      var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems();
      e.length <= 0 ? Log_1.Log.CheckError() && Log_1.Log.Error("WeeklyRogue", 34, "肉鸽属性展示面板, 找不到主控角色实体!") : (e = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(e[this.RoleListLayout.GetSelectedGridIndex()].GetConfigId), UiManager_1.UiManager.OpenView("RogueAttributeDetailView", e.GetShowAttrList()))
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    ...
    var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems().map(e => e.GetConfigId),
      e = (await this.RoleListLayout.RefreshByDataAsync(e), await this.Uho(), this.RoleListLayout.SelectGridProxy(0, !0), ModelManager_1.ModelManager.WeeklyRogueModel?.ActivityData.GetCycleConfig());
    e && 0 !== e.BuffPR && LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), e.BuffDesc, ...e.BuffDescParam)
  }
  async Uho() {
  ...
  UpdateAttribute() {
    var e = ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems();
    if (e.length <= 0) Log_1.Log.CheckError() && Log_1.Log.Error("WeeklyRogue", 34, "肉鸽属性展示面板, 找不到主控角色实体!");
    else {
