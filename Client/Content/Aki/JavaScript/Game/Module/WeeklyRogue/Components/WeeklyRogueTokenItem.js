...
class WeeklyRogueTokenItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnSelected(e) {
    this.GetExtendToggle(5).SetToggleState(1), ModelManager_1.ModelManager.WeeklyRogueModel.SelectEntry = this.Pe
  }
  OnDeselected(e) {
    this.GetExtendToggle(5).SetToggleState(0), ModelManager_1.ModelManager.WeeklyRogueModel.SelectEntry = void 0
  }
  UpdateByConfigId(e) {
    this.Mne = e;
    var i, t = ConfigManager_1.ConfigManager.WeeklyRogueConfig.GetRogueWeeklyBuffPool(e);
    t ? (this.GetItem(6).SetUIActive(!1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), t.BuffName), 0 === ModelManager_1.ModelManager.WeeklyRogueModel?.DescMode ? LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), t.BuffDescSimple) : LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(4), t.BuffDesc, ...t.BuffDescParam), this.SetTextureByPath(t.BuffIcon, this.GetTexture(1)), (i = ConfigManager_1.ConfigManager.WeeklyRogueConfig?.GetRogueWeeklyQualityConfig(t.Quality)) && this.SetTextureByPath(i.TokenBg, this.GetTexture(0)), this.GetSprite(7).SetColor(UE.Color.FromHex(i.TokenColor)), this.GetItem(8).SetUIActive(6 === t.Quality), this.GetItem(9).SetUIActive(5 === t.Quality)) : Log_1.Log.CheckError() && Log_1.Log.Error("WeeklyRogue", 34, "刷新周常肉鸽信物格子失败，找不到对应的配置", ["ConfigId", e])
  }
}
