...
class AntiCheatModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    ...
    return this.Qre = LocalStorage_1.LocalStorage.GetDeviceSaved(LocalStorageDefine_1.ELocalStorageDeviceKey.PatchVersion, e), this.qje = UE.KismetSystemLibrary.GetGameBundleId(), !0
  }
