...
class AntiCheatController extends UiControllerBase_1.UiControllerBase {
  ...
  static xje() {
    var e;
    Info_1.Info.IsIosPlatform() && (e = AntiCheatModel_1.AntiCheatModel.GetBundleData(), LogReportController_1.LogReportController.LogReport(e))
  }
}
exports.AntiCheatController = AntiCheatController, (_a = AntiCheatController).Bje = 0, AntiCheatController.bje = 0, AntiCheatController.yxl = !1, AntiCheatController.Aje = () => {
  ...
  var e = TimeUtil_1.TimeUtil.GetServerTimeStamp(),
    t = (.001 * (e - AntiCheatController.bje) >= HEARTBEAT_REPORT_INTERVAL && (ModelManager_1.ModelManager.AntiCheatModel.HasHeartbeatException() && (void 0 !== (t = ModelManager_1.ModelManager.AntiCheatModel.GetHeartbeatData()) ? LogReportController_1.LogReportController.LogReport(t) : !_a.yxl && ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() && void 0 !== (t = ModelManager_1.ModelManager.LoginModel.GetSdkLoginConfig()?.Uid) && (Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 21, "Data undefined", ["id", t]), _a.yxl = !0), ModelManager_1.ModelManager.AntiCheatModel.ResetHeartbeatException()), AntiCheatController.bje = e), e - AntiCheatController.Bje),
    r = Heartbeat_1.Heartbeat.GetHeartbeatInterval(),
    r = HEARTBEAT_EXCEPTION_FACTOR * r;
  0 < AntiCheatController.Bje && t <= r && (ModelManager_1.ModelManager.AntiCheatModel.HitHeartbeatException(), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Net", 21, "心跳过快"), AntiCheatController.Bje = e
};
