...
exports.MotorcycleDiyPresetStickerItem = undefined;
const UE = require("ue");
const ConfigManager_1 = require("../../../../Manager/ConfigManager");
const GridProxyAbstract_1 = require("../../../Util/Grid/GridProxyAbstract");
class MotorcycleDiyPresetStickerItem extends GridProxyAbstract_1.GridProxyAbstract {
  OnRegisterComponent() {
  ...
  Refresh(e, r, t) {
    ...
    if (e.ItemId <= 0) {
      ...
      this.SetTextureByPath(a.StickerIconPath, s);
    }
  }
}
exports.MotorcycleDiyPresetStickerItem = MotorcycleDiyPresetStickerItem;
//# sourceMappingURL=MotorcycleDiyPresetStickerItem.js.map