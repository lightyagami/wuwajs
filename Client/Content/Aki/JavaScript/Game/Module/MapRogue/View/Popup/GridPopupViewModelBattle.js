...
class GridPopupViewModelBattle extends GridPopupViewModelBase_1.GridPopupViewModelBase {
  constructor() {
    super(...arguments), this.RecommendTip = void 0, this.Button = void 0, this.InfoList = void 0, this.EventCost = void 0, this.RewardList = void 0, this.HasBtnDetail = !1
  }
  async Init() {
    this.GridData.IsExplore || (this.RecommendTip = await this.View.InitRecommendTip()), this.Button = await this.View.InitComponentButton(), this.InfoList = await this.View.InitInfoList(), this.RewardList = await this.View.InitRewardList(), this.EventCost = await this.View.InitEventCost()
  }
  GetSubTxtInfo() {
  ...
  RefreshBottom() {
    this.InfoList.Refresh(this.GridData), this.RewardList.Refresh(this.GridData)
  }
  RefreshTop() {
  ...
  GetGuideUiItemAndUiItemForShowEx(t) {
    var i;
    if (0 !== t.length) return "EventCost" === t[0] ? this.EventCost?.GetGuideUiItemAndUiItemForShowEx(t) : "goto" === t[0] ? (i = this.Button?.GetRootItem()) ? [i, i] : void 0 : "InfoList" === t[0] && (i = this.InfoList?.GetRootItem()) ? [i, i] : void 0
  }
}
