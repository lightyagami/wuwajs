...
class GridEventCompEnding extends UiPanelBase_1.UiPanelBase {
  constructor(e, i = 4) {
    super(), this.StepId = e, this.StepType = i, this.CanInteractCallback = void 0
  }
  OnRegisterComponent() {
  ...
  Refresh() {
    ...
    e && (LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.TitleKey), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(0), e.TextKey), this.CanInteractCallback?.(this.StepId, this.StepType))
  }
}
