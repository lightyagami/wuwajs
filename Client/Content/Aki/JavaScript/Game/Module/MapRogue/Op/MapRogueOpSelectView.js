...
class MapRogueOpSelectView extends MapRogueOp_1.MapRogueOp {
  constructor() {
    super(...arguments), this.CloseViewFunc = void 0, this.UpdateViewFunc = void 0, this.StepSize = 1, this.MaxSelectCount = 0, this.CurrentSelectCount = 0, this.CanGiveUp = !1, this.Ujt = !1
  }
  get IsMax() {
  ...
  OnUpdate() {
    ...
    this.MaxSelectCount = e.Jr1, this.CurrentSelectCount = e.Zr1, this.CanGiveUp = e.lkc, this.UpdateViewFunc?.(), this.Ujt = !1
  }
  GetGainDataList() {
