...
class MapRogueOpGotoLevelPlay extends MapRogueOp_1.MapRogueOp {
      ...
      var e = new AsyncTask_1.AsyncTask("RogueBattleSubLevelNotify", async () => {
        ...
        ControllerHolder_1.ControllerHolder.SubLevelController.ChangeSubLevel(o, r, 0, e, t, e => {
          if (e) {
            ...
            this.OpExecuteClientId = Protocol_1.Aki.Protocol.c$c.Proto_LoadLevelPlayFail;
            this.Execute(l);
          }
        });
        a.push(i.Promise);
        ...
        await Promise.all(a);
        this.OpExecuteClientId = Protocol_1.Aki.Protocol.c$c.Proto_LoadLevelPlaySucc;
        this.Execute(l);
  ...
  OnStartExecute(e) {
    if (this.Data.Yr1.l$c && e.IsSkipBattle) {
      this.OpExecuteClientId = Protocol_1.Aki.Protocol.c$c.Proto_SkipBattle;
      this.ExecuteOp();
  ...
  OnExecute(e) {
    this.OnRogueSubLevelNotify(this.Data.Yr1.DBc, e);
  }
  OnFinish(e) {}
}
