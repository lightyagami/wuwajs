...
class SeamlessTravelScreenEffect {
  ...
  Epu(r) {
    if (this.tat?.length) {
      ResourceSystem_1.ResourceSystem.LoadAsync(this.tat, UE.EffectScreenPlayData_C, (e, t) => {
        ...
        if (e) {
          this.eat = e;
          this.Ipu = ScreenEffectSystem_1.ScreenEffectSystem.GetInstance();
  ...
  Destroy() {
    if (!this.nx?.FinishParams?.NotStopScreenEffect) {
      if (this.Ipu?.IsValid() && this.eat?.IsValid()) {
        this.Ipu.DestroyScreenEffect(this.eat);
      }
    }
    this.Ipu = undefined;
    this.eat = undefined;
  ...
  AppearEffect(e) {
    if (this.IsInit && this.Ipu?.IsValid() && this.eat?.IsValid()) {
  ...
  DisappearEffect(e) {
    if (this.IsInit && this.Ipu?.IsValid() && this.eat?.IsValid()) {
      if (this.nx?.FinishParams?.NotStopScreenEffect) {
        this.Ipu.SetEffectExtraState(this.eat, this.nx.FinishParams.ScreenEffectExtraState);
      } else {
  ...
  GetSeamlessTravelActors(e) {
    var t;
    if (this.Ipu?.IsValid() && (e.push(this.Ipu), t = (0, puerts_1.$ref)(undefined), this.Ipu?.GetScreenEffectGeneralRoot(t), (t = (0, puerts_1.$unref)(t)).IsValid())) {
      e.push(t);
    }
    return e;
  }
