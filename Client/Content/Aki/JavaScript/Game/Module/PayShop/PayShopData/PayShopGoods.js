...
const CommonDefine_1 = require("../../../../Core/Define/CommonDefine"),
  ...
  CouponById_1 = require("../../../../Core/Define/ConfigQuery/CouponById"),
...
class PayShopGoods {
  constructor(t) {
    this.Pe = void 0, this.EFi = !1, this.PayShopId = 1, this.XOi = void 0, this.SFi = 0, this.PayShopId = t
  }
  SetGoodsData(t) {
    this.Pe = t, this.EFi = this.InSellTime(), this.XOi = new PayShopItemBase_1.PayShopItemBaseSt, this.XOi.PhraseFromPayItemData(this)
  }
  SetPayGiftId(t) {
    this.SFi = t
  }
  ...
  GetConditionTextId() {
    ...
    return 0 !== t ? LevelGeneralCommons_1.LevelGeneralCommons.GetConditionGroupHintText(t) ?? "" : ""
  }
  GetDiscountLabel() {
  ...
  GetPriceData() {
    var t = this.GetAvailableCouponDiscount(),
      e = Math.max(this.Pe.GetNowPrice() - t, 0);
  ...
  GetRemainingData() {
    var t;
    if (this.Pe.HasBuyLimit()) return t = this.Pe.GetRemainingCount(), {
  ...
  GetDiscountNew() {
    ...
    return t ? t.PromotionShow / 100 : this.Pe.GetDiscountNew()
  }
  HasDiscount() {
    var t = this.GetGetPayGiftData();
    return t ? 0 !== t.PromotionShow : this.Pe.HasDiscount()
  }
  IsPermanentDiscount() {
  ...
  GetDiscountTimeData() {
    var t, e = this.Pe.GetPromotionText();
    return StringUtils_1.StringUtils.IsEmpty(e) ? (t = Number(this.Pe.EndPromotionTime), PayShopGoods.GetEndTimeShowText(t)) : e
  }
  ...
  NeedUpdate() {
    return this.InSellTime() && !this.EFi ? this.EFi = !0 : !!this.Pe.HasBuyLimit() && 0 !== this.Pe.UpdateTime && Number(this.Pe.UpdateTime) <= TimeUtil_1.TimeUtil.GetServerTime() && this.InSellTime()
  }
  static GetEndTimeShowText(t) {
    var e = TimeUtil_1.TimeUtil.GetServerTime(),
      t = Math.max(t - e, 0),
      e = PayShopGoods.GetTimeTypeData(t);
    return 0 === e[0] ? ConfigManager_1.ConfigManager.TextConfig.GetTextById("NotEnoughOneHour") : TimeUtil_1.TimeUtil.GetCountDownDataFormat2(t, e[0], e[1]).CountDownText
  }
  ...
  GetEndTimeRemainData() {
    var t, e = this.Pe.GetSellTimeText();
    return StringUtils_1.StringUtils.IsEmpty(e) ? (t = Number(this.Pe.EndTime), PayShopGoods.GetEndTimeShowText(t)) : e
  }
  GetDownTipsText() {
    if (this.CheckIfMonthCardItem()) return ConfigManager_1.ConfigManager.TextConfig.GetTextById("MonthlyCardMax");
    if (this.IsLimitGoods() && this.IsSoldOut()) return ConfigManager_1.ConfigManager.TextConfig.GetTextById("SoldOut");
    if (!this.IfCanBuy()) {
      var t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(this.GetGoodsData().ItemId);
      if (this.GetGoodsData().GetItemConfig().ShowTypes.includes(30) || 1 === t) return ConfigManager_1.ConfigManager.TextConfig.GetTextById("Text_Shop_Role_Text");
      t = this.GetConditionTextId();
      if (!StringUtils_1.StringUtils.IsEmpty(t)) return MultiTextLang_1.configMultiTextLang.GetLocalTextNew(t)
    }
    return ""
  }
  ...
  GetExtraLimitText() {
    ...
    if (!this.IfCanBuy()) {
      ...
      if (this.GetGoodsData().GetItemConfig().ShowTypes.includes(30) || 1 === t) {
        let t = 0;
        return t = this.GetGoodsData().GetItemConfig().ShowTypes.includes(30) ? ModelManager_1.ModelManager.RoleModel.GetResonantItemRoleId(this.GetGoodsData().ItemId)[0] : this.GetGoodsData().ItemId, void 0 === ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(t) ? "DontHaveRole" : "RoleBrenchItemMax"
      }
  ...
  GetIfNeedShowDownTipsText() {
    if (this.CheckIfMonthCardItem()) {
      ...
      if (CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardMaxDays") < t) return !0
    }
  ...
  GetSpriteTextBgColor() {
    if (this.CheckIfMonthCardItem()) {
      var t = ModelManager_1.ModelManager.MonthCardModel.GetRemainDays();
      if (CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardMaxDays") < t) return "3E3E3BFF"
    }
  ...
  GetTextTipsColor() {
    if (this.CheckIfMonthCardItem()) {
      var t = ModelManager_1.ModelManager.MonthCardModel.GetRemainDays();
      if (CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardMaxDays") < t) return "F9F9F9FF"
    }
  ...
  GetCountDownData() {
    let t = void 0,
      e = 0,
      i = 0;
    return t || this.IsLimitGoods() && this.GetGoodsData().IsWeeklyRefresh() && 0 === this.GetRemainingData().Count && this.GetGoodsData().IfMayReSell() && (t = this.GetUpdateTimeRemainData(), e = 2, i = this.GetTimeRemainData(this.Pe.UpdateTime)?.RemainingTime), t || (this.HasDiscount() && 0 < (i = this.GetTimeRemainData(this.Pe.EndPromotionTime).RemainingTime) && (t = this.GetDiscountTimeData(), e = 1), t) || (t = this.GetEndTimeRemainData(), e = 3, i = this.GetTimeRemainData(this.Pe.EndTime)?.RemainingTime), [e, t, i]
  }
  GetResellText() {
    let t = "";
    return this.IsLimitGoods() && this.GetGoodsData().IsWeeklyRefresh() && (0 !== this.GetRemainingData().Count || this.GetGoodsData().IfMayReSell() ? 0 === this.GetRemainingData().Count && this.GetGoodsData().IfMayReSell() && (t = "ReSell") : t = "DistanceToDown"), t
  }
  ...
  GetBuyLimitText() {
    if (this.IsLimitGoods()) {
      let t = "";
      var e;
      return "LimitBuy" === (t = 0 === this.Pe.UpdateType ? "LimitBuy" : 1 === this.Pe.UpdateType ? "DailyLeftTime" : 2 === this.Pe.UpdateType ? "WeekLeftTime" : 3 === this.Pe.UpdateType ? "MonthLeftTime" : "LimitBuy") ? (e = this.Pe.BuyLimit - this.Pe.BoughtCount, StringUtils_1.StringUtils.Format(ConfigManager_1.ConfigManager.TextConfig.GetTextById(t), e.toString(), this.Pe.BuyLimit.toString())) : StringUtils_1.StringUtils.Format(ConfigManager_1.ConfigManager.TextConfig.GetTextById(t), (this.Pe.BuyLimit - this.Pe.BoughtCount).toString())
    }
    return ""
  }
  GetExchangeViewShopTipsText() {
    if (this.CheckIfMonthCardItem()) return ModelManager_1.ModelManager.MonthCardModel.GetRemainDayText();
    if (this.IsLimitGoods()) {
      let t = "",
        e = (t = 0 === this.Pe.UpdateType ? "LimitBuy_B" : 1 === this.Pe.UpdateType ? "DayLimitBuy_B" : 2 === this.Pe.UpdateType ? "WeekLimitBuy_B" : 3 === this.Pe.UpdateType ? "MonthLimitBuy_B" : "LimitBuy_B", "");
      var i = this.Pe.BuyLimit - this.Pe.BoughtCount;
      return e = 0 < this.GetGoodsData().GetRemainingCount() ? StringUtils_1.StringUtils.Format(ConfigManager_1.ConfigManager.TextConfig.GetTextById("BuyTextEnough"), i.toString(), this.Pe.BuyLimit.toString()) : StringUtils_1.StringUtils.Format(ConfigManager_1.ConfigManager.TextConfig.GetTextById("BuyTextNotEnough"), i.toString(), this.Pe.BuyLimit.toString()), StringUtils_1.StringUtils.Format(ConfigManager_1.ConfigManager.TextConfig.GetTextById(t), e)
    }
    return ""
  }
  GetShopTipsText() {
  ...
  IfCanBuy() {
    if (this.CheckIfMonthCardItem()) {
      ...
      if (!(t = t || e.Parameters.get(ItemDefines_1.EItemFunctionType.AutoOpenMonthCard))) return !0;
      if (!ModelManager_1.ModelManager.MonthCardModel.CheckMonthCardIfCanBuy()) return !1
    }
    ...
    if (e && e.ShowTypes?.includes(30)) {
      ...
      if (e && 0 < e.length) return e = e[0], !!ModelManager_1.ModelManager.RoleModel.GetRoleInstanceById(e) && 0 < ModelManager_1.ModelManager.RoleModel.GetRoleLeftResonantCountWithInventoryItem(e)
    }
  ...
  IsSoldOut() {
    ...
    if (0 < t && !ModelManager_1.ModelManager.RoleSkinModel.GetRoleSkinData(t).IsLocked()) return !0;
    return !1
  }
  GetGoodsId() {
    return this.Pe.Id
  ...
  HZa() {
    return !(this.IsLocked() || !this.IfCanBuy() || this.IsSoldOut() || !this.CheckGoodIfShow() || this.IsDirect()) && 0 === this.GetPriceData().NowPrice
  }
  jZa() {
    return !(!this.IfCanBuy() || this.IsSoldOut() || !this.CheckGoodIfShow()) && this.Pe.GetIfNeedRemind()
  }
  CheckGoodIfShow() {
    return !(!this.IsShowInShop() || !this.InSellTime() || !this.GetGoodsData().Show || this.GetGoodsData().HasBuyLimit() && 0 === this.GetGoodsData().GetRemainingCount() && !this.GetGoodsData().IsWeeklyRefresh() && !this.GetGoodsData().IfShowAfterSoldOut() || this.GetGoodsData().HasBuyLimit() && 0 === this.GetGoodsData().GetRemainingCount() && this.GetGoodsData().IsWeeklyRefresh() && this.GetGoodsData().UpdateTime >= this.GetGoodsData().EndTime && !this.IsPermanentSell())
  }
  SaveRemindState(t) {
    0 === this.Pe.SaveRemindState(t) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshPayShopEntranceRedDot), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshPayShopInstanceRedDot, this.PayShopId), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RefreshPayShopTabRedDot, this.GetTabId()))
  }
  CheckIfGiftPackage() {
    ...
    if (e && e.Parameters) {
      ...
      return (t = t || e.Parameters.get(ItemDefines_1.EItemFunctionType.AutoOpenGift)) ? !0 : !1
    }
    return !1
  }
  GetPackageRewardId() {
    ...
    if (e && e.Parameters) {
      let t = e.Parameters.get(ItemDefines_1.EItemFunctionType.ManualOpenGift);
      return (t = t || e.Parameters.get(ItemDefines_1.EItemFunctionType.AutoOpenGift)) ? t : 0
    }
    return 0
  }
  GetRewardRoleSkinId() {
    ...
    if (t && t.Parameters) {
      ...
      for (const i of t.Content) {
        var e = i[0];
        if (11 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(e)) return e
      }
    }
    return 0
  }
  GetRewardFlySkinId() {
    ...
    if (t && t.Parameters) {
      ...
      for (const i of t.Content) {
        var e = i[0];
        if (14 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(e)) return e
      }
    }
    return 0
  }
  ...
  CheckIfFlySkinGoods() {
    var t = this.GetGoodsData().ItemId,
      t = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(t);
    if (t && t.Parameters) {
      if (!this.CheckIfGiftPackage()) return !1;
      t = ConfigManager_1.ConfigManager.GiftPackageConfig.GetGiftPackageConfig(this.GetPackageRewardId());
      if (!t) return !1;
      for (const i of t.Content) {
        var e = i[0];
        if (14 === ConfigManager_1.ConfigManager.InventoryConfig.GetItemDataTypeByConfigId(e)) return !0
      }
    }
    return !1
  }
  ...
  GetAvailableCouponDiscount() {
    ...
    return t && (t = t.GetConfigId(), t = CouponById_1.configCouponById.GetConfig(t)) ? t.Param : 0
  }
  HasCloudGameInfo() {
    return 0 < this.Pe.CloudGameTime
  }
  GetCloudGameDesc() {
    return this.HasCloudGameInfo() ? StringUtils_1.StringUtils.Format(MultiTextLang_1.configMultiTextLang.GetLocalTextNew(this.Pe.CloudGameDesc), this.Pe.CloudGameTime.toString()) : StringUtils_1.EMPTY_STRING
  }
  GetCloudGameIcon() {
