...
exports.GiftPackageMonthlyCardItem = undefined;
const UE = require("ue");
...
class GiftPackageMonthlyCardItem extends UiPanelBase_1.UiPanelBase {
  ...
  InitDailyRewardItem() {
    ...
    var a = CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardDailyItemCount");
  ...
  BV_() {
    ...
    var a = e.HasCloudGameInfo();
    var t = this.GetText(3);
    t.SetUIActive(a);
    if (a) {
      t.SetText(e.GetCloudGameDesc());
    }
  }
}
