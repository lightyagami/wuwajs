...
class GiftPackageMonthlyCardItem extends UiPanelBase_1.UiPanelBase {
  constructor(e, a) {
    super(), this.u4i = void 0, this.eFi = void 0, this.c4i = e, this.CreateThenShowByResourceIdAsync("UiItem_GiftPackageMonthlyCard", a)
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.u4i = new GiftPackageItem_1.GiftPackageItem, this.u4i.Initialize(this.GetItem(0)), this.u4i.SetBelongViewName("GiftPackageDetailsView"), this.eFi = new GiftPackageItem_1.GiftPackageItem, this.eFi.Initialize(this.GetItem(1)), this.u4i.SetBelongViewName("GiftPackageDetailsView"), this.InitDailyRewardItem(), this.Refresh(), this.BV_()
  }
  InitDailyRewardItem() {
    var e = CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardDailyItemId"),
      a = CommonParamById_1.configCommonParamById.GetIntConfig("MonthCardDailyItemCount");
  ...
  Refresh() {
    var e;
    this.InAsyncLoading() || (e = ConfigManager_1.ConfigManager.MonthCardConfig.GetConfig(this.c4i), this.u4i.UpdateItem(e.ItemId, e.Count))
  }
  BV_() {
