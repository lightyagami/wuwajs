...
class BattlePassModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.IsRequiringViewData = !1, this.Lki = !1, this.IncreasedLevelToShow = 0, this.Dki = void 0, this.Rki = 0, this.Uki = !0, this.Pta = void 0, this.Aki = 0, this.Pki = 0, this.xki = GIFT_ID, this.wki = 0, this.Bki = 0, this.RewardDataList = [], this.BattlePassId = 0, this.UQ = 0, this.StageLevelList = [], this.bki = 0, this.qki = 0, this.Gki = 0, this.Nki = Protocol_1.Aki.Protocol.PNs.Proto_NoPaid, this.Oki = 0, this.kki = 0, this.Fki = 0, this.Vki = 0, this.BattlePassTaskMap = new Map, this.dc1 = void 0
  }
  GetInTimeRange() {
    return this.Lki
  }
  ...
  set HadEnter(t) {
    this.Uki !== t && (this.Uki = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BattlePassHadEnterUpdate))
  }
  GetWeaponDataList() {
    if (!this.Dki) {
      this.Dki = [];
  ...
  GetRewardData(t) {
    ...
    if (e) return e;
    Log_1.Log.CheckWarn() && Log_1.Log.Warn("Temp", 10, "战令奖励数据 没有这个等级的", ["level", t])
  }
  set PayButtonRedDotState(t) {
    this.Pta !== t && (this.Pta = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.BattlePassHadEnterUpdate), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.BattlePassPayButton, this.Pta))
  }
  get PayButtonRedDotState() {
    return void 0 === this.Pta && (this.Pta = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.BattlePassPayButton, !0) ?? !0), this.Pta
  }
  GetMaxLevel() {
    return this.UQ
  }
  ...
  InitBattlePassConfigData() {
    var t = this.BattlePassId,
      e = (this.RewardDataList.length = 0, ConfigManager_1.ConfigManager.BattlePassConfig.GetBattlePassData(t)),
      t = (this.UQ = e.LevelLimit, ConfigManager_1.ConfigManager.BattlePassConfig.GetAllRewardData(t));
    for (const l of t)
      if (!(l.Level > this.UQ)) {
        var a, r, i, s, o = new BattlePassRewardGridItem_1.BattlePassRewardData(l.Level);
        for ([a, r] of l.FreeReward) {
          var n = new BattlePassRewardGridItem_1.BattlePassRewardItem(a, r);
          this.BattlePassLevel >= l.Level && (n.ItemType = 1), o.FreeRewardItem.push(n)
        }
        for ([i, s] of l.PayReward) {
          var h = new BattlePassRewardGridItem_1.BattlePassRewardItem(i, s);
          this.BattlePassLevel >= l.Level && this.Nki !== Protocol_1.Aki.Protocol.PNs.Proto_NoPaid && (h.ItemType = 1), o.PayRewardItem.push(h)
        }
        l.IsMilestone && this.StageLevelList.push(l.Level), this.RewardDataList.push(o)
      } this.Fki = e.WeekExpLimit, this.Vki = e.LevelUpExp, this.Hki()
  }
  Hki() {
    this.Pki = this.Vki * (this.UQ - this.bki) - this.LevelExp, this.Aki = this.Fki - this.WeekExp
  }
  jki(t) {
    let e = 0,
      a = 0;
  ...
  TryRequestTaskList(t) {
    var [e, a] = this.jki(t), e = e - Math.max(0, a - this.Aki);
    this.IsLevelMax() || e > this.Pki ? (ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("BattlePassExpMax"), BattlePassController_1.BattlePassController.RequestBattlePassTaskTake(t)) : a > this.Aki ? ((e = new ConfirmBoxDefine_1.ConfirmBoxDataNew(this.IsWeekMax() ? 91 : 178)).FunctionMap.set(2, () => {
      ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByCode("BattlePassWeeklyExpMax"), BattlePassController_1.BattlePassController.RequestBattlePassTaskTake(t)
    }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(e)) : BattlePassController_1.BattlePassController.RequestBattlePassTaskTake(t)
  }
  ...
  Wki(t, e = !1) {
    ...
    if (t) {
      for (const a of t.FreeRewardItem) 0 !== a.ItemType && !e || (a.ItemType = 1);
      if (this.PayType !== Protocol_1.Aki.Protocol.PNs.Proto_NoPaid)
        for (const r of t.PayRewardItem) 0 !== r.ItemType && !e || (r.ItemType = 1)
    }
  }
  TakeReward(t, e, a) {
    var r = this.GetRewardData(e);
    let i = void 0;
    (i = t === Protocol_1.Aki.Protocol.ANs.Proto_Free ? r.GetFreeRewardItem(a) : r.GetPayRewardItem(a)) ? i.ItemType = 2: Log_1.Log.CheckError() && Log_1.Log.Error("Temp", 64, "【TakeReward】战令奖励数据 没有这个奖励的配置", ["battlePassType", t], ["level", e], ["itemId from server", a])
  }
  OnResponseTakeReward(t, e, a, r) {
    this.TakeReward(t, e, a), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GetBattlePassRewardEvent, r)
  }
  ...
  Qki(t) {
    this.kki = Number(MathUtils_1.MathUtils.LongToBigInt(t)), this.Rki = this.kki - 3600 * CommonParamById_1.configCommonParamById.GetIntConfig("BattlePassSettleBugTime")
  }
  SetDayEndTime(t) {
  ...
  GetTargetLevelRewardList(e, t) {
    ...
    t.sort((t, e) => {
      var a = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(t[0].ItemId).QualityId,
        r = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(e[0].ItemId).QualityId;
  ...
  GetTaskList(t, e) {
    ...
    e.sort((t, e) => 3 === t.TaskState || 2 === e.TaskState ? -1 : 2 === t.TaskState || 3 === e.TaskState ? 1 : 0)
  }
  GetTaskTypeList() {
    return [1, 2, 0]
  }
  ...
  CheckHasRewardWaitTake() {
    for (const t of this.RewardDataList) {
      for (const e of t.FreeRewardItem)
        if (1 === e.ItemType) return !0;
      for (const a of t.PayRewardItem)
        if (1 === a.ItemType) return !0
    }
    return !1
  }
  ...
  AddTaskDataFromProtocol(t) {
    var e, a, r = CommonParamById_1.configCommonParamById.GetIntConfig("BattlePassExp"),
      i = this.BattlePassTaskMap,
      s = new BattlePassTaskLoopItem_1.BattlePassTaskData,
      o = (s.TaskId = t.s5n, ConfigManager_1.ConfigManager.BattlePassConfig.GetBattlePassTask(t.s5n));
    ...
    s.CurrentProgress = t.lMs ?? 0, s.TargetProgress = t.j6n ?? 0, s.UpdateType = o.UpdateType, s.SkipId = 0 === o.JumpId ? void 0 : o.JumpId, t.dMs ? t.mMs ? s.TaskState = 2 : s.TaskState = 3 : s.TaskState = 1, i.set(t.s5n, s)
  }
  SetDataFromBattlePassResponse(t) {
    var e = t.iEs;
    this.Lki = e.YSs ?? !1, this.Lki ? (this.HadEnter = e.tEs, this.BattlePassId = e.s5n, this.PayType = e.zSs, this.BattlePassLevel = e.F6n, this.LevelExp = e.U8n, this.WeekExp = e.JSs, this.Qki(e.dps), this.Kki(e.cps), this.InitBattlePassConfigData(), this.UpdateBattlePassRewardDataFromResponse(t.iEs.ZSs ?? void 0), !e.tEs && e.YSs && (this.PayButtonRedDotState = !0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ReceiveBattlePassDataEvent)) : this.PayButtonRedDotState = !1
  }
  ...
  UpdateExpDataFromBattlePassExpUpdateNotify(t, e, a) {
    this.UpdateRewardDataWithTargetLevel(t), t > this.BattlePassLevel && (this.IncreasedLevelToShow = t - this.BattlePassLevel, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnBattlePassLevelUpEvent)), this.BattlePassLevel = t, this.LevelExp = e, this.WeekExp = a, this.Hki(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ReceiveBattlePassDataEvent)
  }
  ...
  UpdateRewardDataFormFreeToPay() {
    for (let t = 1; t <= this.bki; t++) {
      ...
      if (e)
        for (const a of e.PayRewardItem) a.ItemType = 1
    }
  }
  ...
  GetHighBattlePassOriginalPrice() {
    var t = this.GetPrimaryBattlePassGoodsId(),
      e = CommonParamById_1.configCommonParamById.GetIntConfig("AdvancedWithoutActive"),
      t = ConfigManager_1.ConfigManager.PayShopConfig.GetPayShopDirectGoods(t).PayId,
      t = ConfigManager_1.ConfigManager.PayItemConfig.GetPayConf(t).Amount,
      e = ConfigManager_1.ConfigManager.PayShopConfig.GetPayShopDirectGoods(e).PayId,
    ...
    return r.Append(ConfigManager_1.ConfigManager.PayItemConfig.GetPayShowCurrency()), r.Append(t + a), e
  }
  GetBattlePassItemConfirmId(t) {
    return ModelManager_1.ModelManager.FunctionModel.IsOpen(10040) ? this.GetInTimeRange() ? t === this.PrimaryItemId ? ModelManager_1.ModelManager.BattlePassModel.PayType !== Protocol_1.Aki.Protocol.PNs.Proto_NoPaid ? 151 : ModelManager_1.ModelManager.BattlePassModel.InBattlePassInWarningTime() ? 152 : 153 : ModelManager_1.ModelManager.BattlePassModel.PayType === Protocol_1.Aki.Protocol.PNs.Proto_Advanced ? 155 : ModelManager_1.ModelManager.BattlePassModel.PayType === Protocol_1.Aki.Protocol.PNs.Proto_Paid ? 154 : ModelManager_1.ModelManager.BattlePassModel.InBattlePassInWarningTime() ? 159 : 156 : 150 : 149
  }
  get RemindLevel() {
    return this.dc1
  }
    ...
    if (!(this.PayType > Protocol_1.Aki.Protocol.PNs.Proto_NoPaid))
      if (void 0 === t) {
        for (const e of ConfigManager_1.ConfigManager.BattlePassConfig.GetAllRewardData(this.BattlePassId))
          if (e.IsRemind && this.GetRewardData(e.Level).IsThisType(1)) return void(this.dc1 = this.BattlePassLevel)
      ...
      for (const a of ConfigManager_1.ConfigManager.BattlePassConfig.GetAllRewardData(this.BattlePassId))
        if (a.Level === t) return void(this.dc1 = a.IsRemind ? this.BattlePassLevel : void 0);
    this.dc1 = void 0
  }
  GetExtraRewardItems() {
    if (void 0 === this.dc1) return [];
    var t, e, a = new Map,
      r = [];
    for (const o of ConfigManager_1.ConfigManager.BattlePassConfig.GetAllRewardData(this.BattlePassId))
      if (o.Level <= this.dc1)
        for (var [i, s] of o.PayReward) a.has(i) ? a.set(i, a.get(i) + s) : a.set(i, s);
    ...
    return r.sort((t, e) => {
      var a = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(t.ConfigId).QualityId,
        r = ConfigManager_1.ConfigManager.InventoryConfig.GetItemConfig(e.ConfigId).QualityId;
