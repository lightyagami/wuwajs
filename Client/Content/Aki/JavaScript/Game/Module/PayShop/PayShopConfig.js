...
class PayShopConfig extends ConfigBase_1.ConfigBase {
  ...
  GetPayShopConfig(o) {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 10, "查询商城数据失败,查看商业化商城表格PayShop", ["商城ID", o]), e
  }
  GetPayShopTabConfig(o, e) {
    var a = PayShopTabByShopIdAndTabId_1.configPayShopTabByShopIdAndTabId.GetConfig(o, e);
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 10, "查询商城数据失败,查看商业化商城表格PayShopTab", ["商城ID", o], ["页签ID", e]), a
  }
  ...
  GetPayShopDirectGoods(o) {
    ...
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 10, "查询直购商品ID数据失败,查看商业化商城表格PayShopDirectGoods", ["直购商品ID", o]), e
  }
  GetPayShopCondition(o) {
    var e = PayShopConditionById_1.configPayShopConditionById.GetConfig(o);
    return e || Log_1.Log.CheckError() && Log_1.Log.Error("Config", 10, "查询商品条件ID数据失败,查看商业化商城表格PayShopCondition", ["商品条件ID", o]), e
  }
