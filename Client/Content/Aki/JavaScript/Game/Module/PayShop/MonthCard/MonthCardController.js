...
class MonthCardController extends UiControllerBase_1.UiControllerBase {
  ...
  static async RequestMonthCardData() {
    ...
    var e = await Net_1.Net.CallAsync(23638, e);
    if (e) {
  ...
  static OnRegisterNetEvent() {
    Net_1.Net.Register(20551, MonthCardController.Q2i);
    Net_1.Net.Register(19634, MonthCardController.X2i);
  }
  static OnUnRegisterNetEvent() {
    Net_1.Net.UnRegister(20551);
