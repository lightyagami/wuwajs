...
class PayShopSwitchItem extends CommonTabItemBase_1.CommonTabItemBase {
  constructor() {
    super(...arguments), this.l4e = void 0, this.bD = 0, this.hHe = e => {
  ...
  Refresh(e, t, i) {
    this.CurrentData = e, this.OnRefresh(e, t, i), this.GetTabToggle().RootUIComp.SetUIActive(!1), this.GetTabToggle().RootUIComp.SetUIActive(!0)
  }
  OnStart() {
  ...
  BindRedDot(e, t = 0) {
    ...
    this.l4e = e, this.bD = t, RedDotController_1.RedDotController.BindRedDot(e, i, void 0, t)
  }
  UnBindRedDot() {
    this.l4e && (RedDotController_1.RedDotController.UnBindGivenUi(this.l4e, this.GetItem(2), this.bD), this.l4e = void 0, this.bD = 0)
  }
}
