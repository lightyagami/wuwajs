...
class RoleShopSkinTabView extends UiTabViewBase_1.UiTabViewBase {
  constructor() {
    super(...arguments), this._3i = 0, this.bD = 0, this.eGe = void 0, this.oWi = () => new SkinItemContent
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this._3i = this.ExtraParams, this.bD = this.OpenParam, this.eGe = new GenericLayout_1.GenericLayout(this.GetHorizontalLayout(0), this.oWi)
  }
  OnBeforeShow() {
    this.v4e()
  }
...
class SkinItemContent extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.YSl = void 0, this.NOe = 0, this.zSl = () => {
      ...
      t.SetIndex(this.NOe), t.SetPreviewTitle("RoleSkinShopTitle_Text"), UiManager_1.UiManager.OpenView("SkinBuyDetailView", t)
    }
  }
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [
  ...
  Refresh(t, e, i) {
    ...
    this.YSl = t, this.NOe = i, this.Zke(s), this.ZSl(s), this.eyl(s), this.tyl(s), this.iyl(s), this.ryl(s), this.oyl(s), this.nyl(s), this.syl(s), this.FEl(s), this.VEl(s), this.HEl(s), this.JSl(s), this.nbl(s), this.f7l(s), this.AQ1(s)
  }
  f7l(t) {
  ...
  ZSl(t) {
    ...
    "" === t ? this.GetTexture(2)?.SetUIActive(!1) : (this.GetTexture(2)?.SetUIActive(!0), this.SetTextureByPath(t, this.GetTexture(2)))
  }
  ryl(t) {
  ...
  JSl(t) {
    t ? (t = 0 < t.GetRoleSkinData().GetSuitWeaponSkinId() ? "T_ShopRoleItemBg1" : "T_ShopRoleItemBg", t = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(t), this.SetTextureByPath(t, this.GetTexture(14))) : this.GetTexture(14).SetUIActive(!1)
  }
  nbl(t) {
    t ? (t = 0 < t.GetRoleSkinData().GetSuitWeaponSkinId() ? "T_ShopRoleItemTopBg1" : "T_ShopRoleItemTopBg", t = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(t), this.SetTextureByPath(t, this.GetTexture(15))) : this.GetTexture(15).SetUIActive(!1)
  }
  AQ1(t) {
    var e;
    !t || void 0 === (e = t.GetCurrentGoodsData().GetAvailableCouponItem()) ? this.GetItem(18).SetUIActive(!1) : (this.GetItem(18).SetUIActive(!0), t = t.GetCurrentGoodsData().GetAvailableCouponDiscount(), this.GetText(19).SetText("-" + t), this.SetTextureByPath(e.GetConfig().IconSmall, this.GetTexture(20)))
  }
}
