...
class TeamRoleSkillData {
  constructor() {
    this.SkillIcon = "", this.SkillType = 0, this.SkillTypeText = "", this.SkillName = "", this.SkillTagList = void 0, this.ShowSkillToggle = !0, this.SkillDesc = "", this.SkillDescNum = [], this.MultiSkillDesc = "", this.MultiSkillDescNum = [], this.SkillResume = "", this.SkillResumeNum = []
  }
}
