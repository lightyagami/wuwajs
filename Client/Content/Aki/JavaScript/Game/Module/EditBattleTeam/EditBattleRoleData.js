...
class EditBattleRoleData {
  constructor() {
    this.ConfigId = 0, this.SkinId = 0, this.OnlineIndex = void 0, this.PlayerName = void 0, this.Level = 0, this.IsSelf = !1, this.IsReady = !1, this.PlayerId = 0, this.ThirdPartyOnlineId = void 0
  }
  Init(t, e, i, a, r, s, o, h) {
    this.PlayerId = t, this.ConfigId = e, this.SkinId = i, this.OnlineIndex = a, this.PlayerName = r, this.Level = s, this.IsSelf = o, this.IsReady = h
  }
  GetName() {
