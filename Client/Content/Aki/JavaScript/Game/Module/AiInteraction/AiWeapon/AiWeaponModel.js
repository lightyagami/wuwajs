...
class AiWeaponModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Eje = void 0, this.Sje = new Map, this.c6_ = !1
  }
  OnInit() {
    return this.Eje = new AiWeaponNet_1.AiWeaponNet, this.Eje.RegisterNet(), !(this.c6_ = !1)
  }
  OnClear() {
  ...
  GetWeaponConfigByConfigId(e, t) {
    ...
    return o || Log_1.Log.CheckWarn() && Log_1.Log.Warn("Character", 57, "Ai改变武器失败,原因Config配置错误", ["Char", t.ModelId], ["Item config id", e]), o
  }
  HasWeaponConfig(e, t) {
    e = e.GetComponent(0).GetPbEntityInitData(), e = (0, IComponent_1.getComponent)(e.ComponentsData, "WeaponComponent");
    if (!e) return !1;
    var o, i, t = t.GetComponent(0).GetPbModelConfig();
    if (!this.c6_) {
      this.c6_ = !0;
