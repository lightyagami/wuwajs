...
class AiWeaponNet {
  ...
  yje(e) {
    ...
    t && (t = t.Entity.GetComponent(81)) && (0 !== e.nRs ? (t.RegisterCharacterDropWeaponEvent(e.nRs), t.ChangeWeaponByWeaponByConfigId(e.nRs)) : t.ClearWeaponForAi())
  }
  ...
  SendHoldWeaponPush(e, t) {
    ...
    return r.F4n = this.Ije(e), r.d8n = this.Ije(t), Net_1.Net.Send(24977, r), !0
  }
  SendDiscardWeaponPush(e) {
    ...
    var r = new Protocol_1.Aki.Protocol.Zcs,
      ...
      e = e.Entity.GetComponent(61);
    let i = void 0;
    e.GetHitData() ? i = Vector_1.Vector.Create(e.GetHitData().HitPosition) : (i = Vector_1.Vector.Create(a.ActorLocation)).Z -= 50;
    e = Vector_1.Vector.Create(a.ActorLocation), e.SubtractionEqual(i), e.X *= 100, e.Y *= 100, e.Z *= 5, e.X = this.CalculateWeight(e.X), e.Y = this.CalculateWeight(e.Y), e.Z = Math.abs(this.CalculateWeight(e.Z)), a = a.Actor.Mesh.D_GetSocketLocation(t.DropSocket), t = Rotator_1.Rotator.Create();
    return e.Rotation(t), o.P5n = a, o.g8n = new Protocol_1.Aki.Protocol.D2s, o.g8n.Roll = t.Roll, o.g8n.Pitch = t.Pitch, o.g8n.Yaw = t.Yaw, o.f8n = new Protocol_1.Aki.Protocol.Gks, o.f8n.X = e.X, o.f8n.Y = e.Y, o.f8n.Z = e.Z, r.C8n = o, Net_1.Net.Call(16491, r, e => {}), !0
  }
  Ije(e) {
