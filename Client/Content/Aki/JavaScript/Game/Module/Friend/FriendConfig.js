...
class FriendConfig extends ConfigBase_1.ConfigBase {
  constructor() {
    super(...arguments), this.D6t = (e, r) => {
      e = PersonalTipsById_1.configPersonalTipsById.GetConfig(e), r = PersonalTipsById_1.configPersonalTipsById.GetConfig(r);
  ...
  GetProcessViewFunctionList() {
    var e = PersonalTipsByFunctionId_1.configPersonalTipsByFunctionId.GetConfigList(1);
    const r = new Array;
    return e.forEach(e => {
      r.push(e.Id)
    }), r.sort(this.D6t), r
  ...
  GetDefaultBackgroundCardId() {
    return CommonParamById_1.configCommonParamById.GetIntConfig("default_background_card")
  }
}
