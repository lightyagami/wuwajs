...
class CalabashConfig extends ConfigBase_1.ConfigBase {
  GetCalabashConfigByLevel(e) {
    ...
    if (a) return a;
    Log_1.Log.CheckError() && Log_1.Log.Error("Calabash", 10, "获取鸣域终端配置失败，请检查配置表", ["level", e])
  }
  ...
  GetCalabashDevelopRewardByMonsterId(e) {
    ...
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Calabash", 10, "获取鸣域终端养成奖励配置失败, 请检查配置表", ["MonsterId", e]), a
  }
  GetMonsterNameByMonsterId(e) {
    e = this.GetCalabashDevelopRewardByMonsterId(e).MonsterInfoId, e = MonsterInfoById_1.configMonsterInfoById.GetConfig(e);
  ...
  GetCalabashConditionById(e) {
    ...
    return a || Log_1.Log.CheckError() && Log_1.Log.Error("Calabash", 10, "获取鸣域终端养成条件配置失败, 请检查配置表", ["id", e]), a
  }
  ...
  GetCalabashConditionRewardExp(e) {
    var a, e = e?.RewardExp;
    return !e || 0 === (a = CommonParamById_1.configCommonParamById.GetIntConfig("CalabashExpItemId") ?? 0) ? 0 : e.get(a) ?? 0
  }
  GetCalabashMaxLevel() {
    let e = 0;
