...
class CalabashDevelopRewardData {
  constructor(e, t) {
    this.DevelopReward = e, this.SkillName = t, this.Jft = !1, this.zft = 0, this.Zft = new Map
  }
  set UnlockData(e) {
    this.Jft = e
  }
...
class CalabashModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.OnlyShowBattleFettersTab = !1, this.OnlyMonsterCostShowMaxLevel = void 0, this.OnlyShowPhantomFetterGroupIdList = void 0, this.Me = void 0, this.ept = void 0, this.tpt = void 0, this.ipt = void 0, this.HideVisionRecoveryConfirmBox = !1, this.opt = new Array
  }
  rpt() {
    this.CalabashInstance = new CalabashInstance_1.CalabashInstance, this.npt(), this.InitMonsterIdRecord()
  }
  npt() {
  ...
  UpdateCalabashDevelopRewardData() {
    for (const t of this.GetUnlockCalabashDevelopRewards()) {
      ...
      e.UnlockData = !0, e.SetUnlockConditionMap(t[1]), e.RewardNumData = t[1].length
    }
  ...
  InitMonsterIdRecord() {
    this.ipt = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.CalabashCollect) ?? [], this.tpt = new Set;
    for (const e of this.ipt) this.tpt.add(e)
  }
  SetCalabashLevel(e) {
    this.CalabashInstance.CalabashCurrentLevel = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CalabashLevelUpdate)
  }
  GetCalabashLevel() {
  ...
  GetCalabashDevelopRewardExpByMonsterId(e) {
    ...
    if (a)
      for (const n of a.DevelopReward.DevelopCondition) {
        var r = ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashConditionById(n);
        a.GetUnlockConditionMap().get(r.Id) && (t += ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashConditionRewardExp(r))
      }
    return t
  }
  ...
  SetCalabashLevelsReward(e) {
    this.CalabashInstance.SetRewardedLevelsSet(e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GetCalabashReward)
  }
  GetCurrentExpByLevel(e) {
    return e < this.CalabashInstance.CalabashCurrentLevel ? ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashConfigByLevel(e).LevelUpExp : e === this.CalabashInstance.CalabashCurrentLevel ? this.CalabashInstance.CalabashCurrentExp : 0
  }
  GetMaxExpByLevel(e) {
    return ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashConfigByLevel(e).LevelUpExp
  }
  GetReceiveRewardStateByLevel(e) {
    return 0 === e ? 0 : this.CalabashInstance.IsRewardedByLevel(e) ? 3 : e > this.CalabashInstance.CalabashCurrentLevel ? 1 : 2
  }
  IsLimitToLevelUp(e) {
  ...
  RecordMonsterId(e) {
    return !this.tpt?.has(e) && (this.tpt?.add(e), this.ipt?.push(e), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.CalabashCollect, this.ipt), !0)
  }
  CheckMonsterIdInRecord(e) {
    return this.tpt.has(e)
  }
  CheckSimpleStateSave() {
    void 0 === LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.CalabashCollectIsSimpleDetail) && this.SaveIfSimpleState(!0)
  }
  GetIfSimpleState() {
  ...
  SaveIfSimpleState(e) {
    ...
    void 0 !== t && t === e || (LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.CalabashCollectIsSimpleDetail, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ChangeCalabashCollectSimplyState))
  }
  GetViewTabList() {
    var e = ConfigManager_1.ConfigManager.DynamicTabConfig.GetViewTabList("CalabashRootView");
    if (this.OnlyShowBattleFettersTab) return e.filter(e => "PhantomBattleFettersTabView" === e.ChildViewName);
    const t = [];
    return e.forEach(e => {
  ...
  GetPhantomFetterGroupList() {
    if (!this.OnlyShowBattleFettersTab) return ConfigCommon_1.ConfigCommon.ToList(ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomFetterGroupList());
    var e = [];
  ...
  GetVisionRefineRecommendAttributes(e, t) {
    ...
    if (a) {
      for (const r of a)
        if (r.FetterArray.includes(t)) return r.PropertyArray
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Calabash", 75, "获取洗炼推荐配置失败, 请检查配置表", ["cost", e]);
    return []
  }
  ClearOnlyShowData() {
    this.OnlyShowBattleFettersTab = !1, this.OnlyMonsterCostShowMaxLevel = void 0
  }
}
