...
class CalabashInstance {
  constructor() {
    this.Wft = 0, this.UQ = 10, this.Kft = 0, this.Qft = 0, this.Xft = new Map, this.$ft = new Map, this.Yft = new Set
  }
  SetBaseInfo(e) {
    this.CalabashCurrentLevel = e.F6n, this.CalabashCurrentExp = e.U8n, this.CalabashMaxLevel = ConfigManager_1.ConfigManager.CalabashConfig.GetCalabashMaxLevel(), this.IdentifyGuaranteeCount = e.vLs, this.SetUnlockCalabashDevelopRewards(e.fLs)
  }
  SetConfigInfo(e) {
