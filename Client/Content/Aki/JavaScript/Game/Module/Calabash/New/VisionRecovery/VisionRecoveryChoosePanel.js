...
class VisionRecoveryChoosePanel extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.UiViewSequence = void 0, this.Fvt = void 0, this.Vvt = void 0, this.Mpt = void 0, this.vpt = void 0, this.Hvt = void 0, this.jvt = void 0, this.d3a = void 0, this.OnClickMask = () => {
      this.GetItem(3).SetUIActive(!1), this.GetButton(2).RootUIComp.SetUIActive(!1)
      ...
      this.Fvt.UpdateByDataList(e), this.Vvt.SetActive(!1), this.jvt && this.jvt(e)
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.Vvt = new ItemTipsComponent_1.ItemTipsComponentContentComponent, await this.Vvt.CreateByActorAsync(this.GetItem(3).GetOwner())
  }
  OnStart() {
  ...
  ShowTipsComponent(e) {
    this.Vvt.Refresh(e), this.GetItem(3).SetUIActive(!0), this.GetButton(2).RootUIComp.SetUIActive(!0)
  }
  OnBeforeHide() {
