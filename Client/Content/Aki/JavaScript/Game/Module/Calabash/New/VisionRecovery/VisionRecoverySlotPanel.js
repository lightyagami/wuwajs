...
class VisionRecoverySlotPanel extends UiPanelBase_1.UiPanelBase {
  constructor(e, i = !0) {
    super(), this.hMt = new Array(CalabashDefine_1.VISION_RECOVERY_SLOT_MAX_NUM), this.lMt = new Array(CalabashDefine_1.VISION_RECOVERY_SLOT_MAX_NUM), this._Mt = void 0, this.nMt = !1, this._Mt = e, this.nMt = i
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    var e = new Array;
    e.push(this.uMt(0)), e.push(this.uMt(1)), e.push(this.uMt(2)), e.push(this.uMt(3)), e.push(this.uMt(4)), await Promise.all(e)
  }
  async uMt(e) {
    var i = this.GetItem(e),
      s = new VisionRecoverySlotItem_1.VisionRecoverySlotItem(this._Mt, this.nMt);
