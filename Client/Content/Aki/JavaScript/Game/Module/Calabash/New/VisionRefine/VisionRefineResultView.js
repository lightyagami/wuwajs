...
class VisionRefineResultView extends UiViewBase_1.UiViewBase {
  constructor() {
    ...
    this.zvt = (e, o) => {
      if (o !== undefined) {
        ItemController_1.ItemController.OpenItemTipsByItemUid(o.GetUniqueId(), o.GetConfigId());
      }
    };
  }
  OnRegisterComponent() {
  ...
  OnAfterShow() {
    ...
    if (e === undefined) {
      ...
      ControllerHolder_1.ControllerHolder.InventoryController.ItemLockRequest(this.fGt.GetUniqueId(), !e.GetIsLock());
    }
  }
}
