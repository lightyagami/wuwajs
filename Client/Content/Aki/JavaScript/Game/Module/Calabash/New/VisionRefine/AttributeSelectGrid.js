...
class AttributeSelectGrid extends GridProxyAbstract_1.GridProxyAbstract {
  constructor() {
    super(...arguments), this.v1c = void 0, this.OnClickToggleCallBack = void 0, this.kqe = () => {
  ...
  OnStart() {
    this.GetItem(3).SetUIActive(!1), this.GetExtendToggle(1).CanExecuteChange.Unbind(), this.GetExtendToggle(1).SetToggleState(2), this.GetExtendToggle(1).CanExecuteChange.Bind(this.Lke)
  }
  Refresh(t, i, s) {
    this.v1c = t;
    var e = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(t.PropIndexId),
      ...
      e = (this.SetTextureShowUntilLoaded(e.Icon, r), r.SetChangeColor(!0, r.changeColor), this.GetItem(3).SetUIActive(t.IsRecommend), i ? 1 : 0);
