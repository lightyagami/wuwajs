...
class VisionRefineMaterialItem extends LoopScrollMediumItemGrid_1.LoopScrollMediumItemGrid {
  OnRefresh(e, r, o) {
    var i = e.Count,
      t = ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(e.ItemId);
    let n = StringUtils_1.EMPTY_STRING;
    i <= 0 ? n = t.toString() : t < i ? n = StringUtils_1.StringUtils.Format(CommonDefine_1.MATERIAL_NOT_ENOUGHT_TEXT_PATTERN, t.toString(), i.toString()) : i <= t && (n = StringUtils_1.StringUtils.Format(CommonDefine_1.MATERIAL_ENOUGHT_TEXT_PATTERN, t.toString(), i.toString()));
    t = {
      Data: e,
      Type: 4,
