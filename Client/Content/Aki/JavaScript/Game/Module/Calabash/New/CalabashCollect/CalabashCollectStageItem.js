...
class CalabashCollectStageItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  Refresh(t, e, s) {
    var r = this.GetText(0),
      r = (r.ShowTextNew(t.Info), r.SetChangeColor(t.IsUnlock, r.changeColor), this.GetText(1));
    r.SetText(t.Num.toString()), r.SetChangeColor(t.IsUnlock, r.changeColor), this.GetItem(2).SetUIActive(t.IsUnlock), this.GetItem(3).SetUIActive(!t.IsUnlock)
  }
}
