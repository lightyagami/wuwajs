...
class AttributeSelectItem extends UiPanelBase_1.UiPanelBase {
  ...
  RefreshByData(e) {
    ...
    var t = ConfigManager_1.ConfigManager.PropertyIndexConfig.GetPropertyIndexInfo(e.PropIndexId),
      t = (this.GetText(1).ShowTextNew(t.Name), this.SetTextureShowUntilLoaded(t.Icon, this.GetTexture(0)), ConfigManager_1.ConfigManager.PhantomBattleConfig.GetPhantomMainPropertyItemId(e.PropItemId)),
      i = t.AddType === CommonComponentDefine_1.RATIO,
      t = AttributeModel_1.TipsDataTool.GetPropRatioValue(t.StandardProperty, i),
      e = ModelManager_1.ModelManager.AttributeModel.GetFormatAttributeValueString(e.PropIndexId, t, i);
    this.GetText(2).SetText(e)
  }
  RefreshUi(e) {
    e ? this.RefreshByData(e) : (this.GetItem(3).SetUIActive(!0), this.GetItem(4).SetUIActive(!1))
  }
}
