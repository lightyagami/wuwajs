...
class HonamiStoryGamepadInteractController {
  ...
  OnPickUp(t) {
    ...
    if (!!i && ((e = i.GetBackpackType()) === 0 || e === 2 || e === 1)) {
      this.aEm = this.GetBackpackWidth(i.GetBackpackType());
      this.hEm = this._Em(t, this.aEm);
    }
    this.Tgd.Clear();
  ...
  OnMove(t) {
    ...
    if (e) {
      if (this.Tgd.TargetOperateBackpack !== e) {
        ...
        this.Tgd.TargetOperateBackpack?.OnHoverGamepad(t, this.hEm, this.Tgd);
      } else {
        this.Tgd.TargetOperateBackpack.OnHoverGamepad(t, this.hEm, this.Tgd);
      }
    } else {
