...
class HonamiStoryBackpackView extends UiViewBase_1.UiViewBase {
  ...
  tfm(i, t) {
    ...
    if (!!i && !!i.GetData() && !a && !e && !s) {
      ...
      if (this.Tkm && Info_1.Info.IsInGamepad()) {
