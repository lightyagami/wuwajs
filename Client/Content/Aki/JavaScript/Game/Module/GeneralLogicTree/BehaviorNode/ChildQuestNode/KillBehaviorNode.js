...
class KillBehaviorNode extends ChildQuestNodeBase_1.ChildQuestNodeBase {
  ...
  OnUpdateProgress(e) {
    return !!e.mEs && (this.xXt = e.mEs, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GeneralLogicTreeEntityKilled, this.NodeId, this.xXt.SEs), !0)
  }
  GetProgress() {
    return this.IsSuccess ? this.GetProgressMax() : this.xXt?.SEs?.length.toString() ?? "0"
  }
  GetProgressMax() {
