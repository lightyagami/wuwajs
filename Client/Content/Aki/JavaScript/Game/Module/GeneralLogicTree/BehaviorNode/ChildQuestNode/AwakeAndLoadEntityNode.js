...
class AwakeAndLoadEntityNode extends TickBehaviorNode_1.TickBehaviorNode {
  ...
  OnCreate(e) {
    return !!super.OnCreate(e) && (e = e.Condition).Type === IQuest_1.EChildQuest.AwakeAndLoadEntity && (this.fLe = e.EntityIds, this.IntervalTime = 1000, this.J8d = e.IsWaitForShow ?? false, true);
  }
  OnTick() {
    if (this.GAc === 0) {
        ...
        for (const i of this.fLe) {
          if (ModelManager_1.ModelManager.CreatureModel.GetEntityData(i)) {
            ...
            if (e) {
              ...
              if (this.J8d && t && !t.GetIsSceneInteractionLoadCompleted()) {
                return;
              }
