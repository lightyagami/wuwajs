...
class TakePicturesWithTimeScaleChildQuestNode extends TickBehaviorNode_1.TickBehaviorNode {
  ...
  OnTick(e) {
    if (ControllerHolder_1.ControllerHolder.PhotographController.CheckIfInFightPhotographCamera()) {
      ...
      } else if ((this.EMm || this.i6d) && (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnNeedShowFightPhotoFocus, false), this.r6d(false), this.i6d = false, this.EMm = false, this.TipType === 2)) {
