...
class QuestFailedBehaviorNode extends BehaviorNodeBase_1.BehaviorNodeBase {
  constructor(e) {
        ...
        Net_1.Net.Call(17686, t, e => {
          switch (e.BEs) {
            ...
            case Protocol_1.Aki.Protocol.Q4n.Proto_ErrBehaviorTreeNotFound:
              break;
            default:
              ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 17822);
          }
        });
      }
    };
    ...
    this.b$t = () => {
      ...
      Net_1.Net.Call(16492, e, e => {
        if (e.BEs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 16083);
        }
      });
    };
  ...
  G$t() {
    ...
    if (this.BtType !== Protocol_1.Aki.Protocol.hps.Proto_BtTypeInvalid) {
      ...
      Net_1.Net.Call(26295, e, e => {
        if (e.BEs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 27543);
        }
      });
    }
  }
  ...
  B$t(e) {
    var t = Global_1.Global.BaseCharacter.GetEntityNoBlueprint().GetComponent(185);
    if (t?.Valid) {
      if (e) {
