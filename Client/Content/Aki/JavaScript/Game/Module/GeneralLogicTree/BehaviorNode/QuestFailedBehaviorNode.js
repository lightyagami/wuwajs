...
class QuestFailedBehaviorNode extends BehaviorNodeBase_1.BehaviorNodeBase {
  constructor(e) {
        ...
        Net_1.Net.Call(25263, t, e => {
          switch (e.BEs) {
            ...
            case Protocol_1.Aki.Protocol.Q4n.Proto_ErrBehaviorTreeNotFound:
              break;
            default:
              ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 16724);
          }
        });
      }
    };
    ...
    this.b$t = () => {
      ...
      Net_1.Net.Call(22938, e, e => {
        if (e.BEs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 19837);
        }
      });
    };
  ...
  G$t() {
    ...
    if (this.BtType !== Protocol_1.Aki.Protocol.hps.Proto_BtTypeInvalid) {
      ...
      Net_1.Net.Call(29404, e, e => {
        if (e.BEs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(e.BEs, 29601);
        }
      });
    }
  }
