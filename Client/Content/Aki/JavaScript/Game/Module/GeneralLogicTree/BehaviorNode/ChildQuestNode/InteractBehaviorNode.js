...
class InteractBehaviorNode extends ChildQuestNodeBase_1.ChildQuestNodeBase {
  constructor() {
    super(...arguments), this.fKs = [], this.xXt = void 0, this.PXt = [], this.VA_ = !1
  }
  get AlwaysFalseChildNode() {
    return this.VA_
  }
  get OccupationInfo() {
    if (this.VA_ && this.fKs.length) return this.Blackboard?.GetSpecRefOccupiedEntityText(this.fKs)
  }
  ...
  OnCreate(e) {
    ...
    var t = e,
      t = (this.VA_ = GeneralLogicTreeConfigUtil_1.GeneralLogicTreeConfigUtil.IsAlwaysFalseChildNode(this.TreeIncId, t.ParentNodeId), e.Condition);
    ...
    for (const i of t.AddOptions) {
      ...
      r && (r = (0, IComponent_1.getComponent)(r.ComponentsData, "BaseInfoComponent")) && r.Occupation && this.fKs.push(r.Occupation)
    }
    return !0
  }
  OnStart() {
    if (!this.VA_ || !this.fKs.length)
      for (const e of this.fKs) this.Blackboard.AddRefOccupationId(this.NodeId, e)
  }
  OnEnd() {
    if (!this.VA_)
      for (const e of this.fKs) this.Blackboard.RemoveRefOccupationId(this.NodeId, e)
  }
  OnUpdateProgress(e) {
    return !!e.vEs && (this.xXt = e.vEs.TEs, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GeneralLogicTreeEntityInteractFinished, this.NodeId, this.xXt), !0)
  }
  GetProgress() {
