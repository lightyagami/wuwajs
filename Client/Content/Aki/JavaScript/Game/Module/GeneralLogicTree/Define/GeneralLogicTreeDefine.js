...
class TreeTrackTextExpressionInfo {
  ...
  SetMainTitle(o) {
    this.MainTitle = o ? new MissionViewDefine_1.BehaviorTreeStepTextInfo(o.TidTitle, o.QuestScheduleType) : void 0
  }
  AddSubTitle(o) {
    this.SubTitles.push(new MissionViewDefine_1.BehaviorTreeStepTextInfo(o.TidTitle, o.QuestScheduleType, o.ShowConditions, o.ConditionText))
  }
  ClearSubTitle() {
    this.SubTitles = []
  }
  ...
  IsSubTitle(t) {
    return !(!this.SubTitles || 0 === this.SubTitles.length) && void 0 !== this.SubTitles.find(o => {
...
class FlySettlementViewParams {
  constructor(o, t, e, s, r, i) {
    this.Score = o, this.RankS = t, this.RankA = e, this.RankB = s, this.BestRecordScore = r, this.IncId = i
  }
}
