...
class BehaviorTreeTimerCenter {
  constructor(e, i) {
    this.$mt = BigInt(0), this.Yre = void 0, this.SJ = void 0, this.$mt = e, this.Yre = i, this.SJ = new Map
  }
  Dispose() {
  ...
  UpdateTimerInfo(e) {
    var i, r, t;
    e && (i = e.c9n, !e.dps || 0 === (r = MathUtils_1.MathUtils.LongToNumber(e.dps)) ? this.dQt(i) : (t = MathUtils_1.MathUtils.LongToNumber(e.QE_), this.CQt(i, r, t, e.b5n)))
  }
  CQt(r, e, i, t) {
    let s = void 0;
    switch (r) {
      ...
      case "BehaviorTreeTimer5":
        if (!(s = this.GetTimer(r))) {
          ...
          let e = 0,
            i = "";
          "QuestFailed" === a?.NodeType ? (e = a.TimerUiConfig?.UiType ?? 0, i = a.TimerUiConfig?.TidTitle ? PublicUtil_1.PublicUtil.GetConfigTextByKey(a.TimerUiConfig?.TidTitle) ?? this.Yre.TreeConfigId + "-" + t : this.Yre.TreeConfigId + "-" + t) : "ChildQuest" === a?.NodeType && a.ChildQuestType === IQuest_1.EChildQuest.Timer && (a = a.TimerUiConfig, e = a?.UiType ?? 0, i = a?.TidTitle ? PublicUtil_1.PublicUtil.GetConfigTextByKey(a?.TidTitle) ?? this.Yre.TreeConfigId + "-" + t : this.Yre.TreeConfigId + "-" + t), s = new CountDownTimer_1.CountDownTimer(this.$mt, r, e, i, TICK_INTETVAL_TIME), this.SJ.set(r, s)
        }
        break;
      case "WaitTime":
        (s = this.GetTimer(r)) || (s = new NoUiTimer_1.NoUiTimer(this.$mt, r, !0, TICK_INTETVAL_TIME), this.SJ.set(r, s));
        break;
      case "GameStartCountDown":
        (s = this.GetTimer(r)) || (s = new LevelPlayPrepareTimer_1.LevelPlayPrepareTimer(this.$mt, r, !1), this.SJ.set(r, s));
        break;
      case GeneralLogicTreeDefine_1.OUTRANGEFAILED_TIMERTYPE:
        ...
        void 0 !== s && a <= 10 || (s = this.GetTimer(r)) || (s = new FailRangeTimer_1.FailRangeTimer(this.$mt, r, FAILEDRANGE_INTERTVAL), this.SJ.set(r, s));
        break;
