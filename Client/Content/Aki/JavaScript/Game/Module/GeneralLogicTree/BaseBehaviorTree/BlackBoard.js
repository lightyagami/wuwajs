...
class Blackboard extends BehaviorTreeTagComponent_1.BehaviorTreeTagContainer {
  constructor() {
    super(...arguments), this.gQt = 0, this.fQt = 0, this.MarkType = 12, this.TrackSource = 0, this.MapMarkResident = !1, this.UseInnerTrackIconId = !1, this.OnlineType = "", this.ZU_ = 0, this.CurrentDungeonId = 0, this.ChangeCurrentDungeonIdNodeId = 0, this.IsTracking = !1, this.IsSleeping = !1, this.BtType = Protocol_1.Aki.Protocol.hps.Proto_BtTypeInvalid, this.TreeIncId = BigInt(0), this.TreeConfigId = 0, this.GDa = [], this.ODa = new Map, this.kDa = new Set, this.fZ = new Map, this.pQt = new Map, this.vQt = new Map, this.gKs = new Map, this.UiTrackTextInfo = new GeneralLogicTreeDefine_1.TreeTrackTextExpressionInfo, this.SilentAreaShowInfo = [], this.RollbackPoint = 0, this.NoExpression = !1, this.TrackViewModel = "All", this.GetNodeConfig = e => {
      var t = GeneralLogicTreeUtil_1.GeneralLogicTreeUtil.GetNodeConfig(this.BtType, this.TreeConfigId, e);
      return t || Log_1.Log.CheckError() && Log_1.Log.Error("GeneralLogicTree", 18, "找不到节点配置", ["行为树类型", GeneralLogicTreeDefine_1.btTypeLogString[this.BtType]], ["行为树Id", this.TreeConfigId], ["节点Id", e]), t
    }
  }
  get TaskMarkTableId() {
    return !this.UseInnerTrackIconId && this.BtType !== Protocol_1.Aki.Protocol.hps.Proto_BtTypeQuest && this.IsChallengeUi() ? GeneralLogicTreeDefine_1.CHALLENGELEVELPLAY_TRACKICONID : this.fQt
  }
  get DungeonId() {
  ...
  Init(e, t, i, r, s, o, n, h) {
    switch (this.BtType = e, this.TreeIncId = t, this.TreeConfigId = i, this.gQt = r, this.CurrentDungeonId = r, this.OnlineType = o, this.ZU_ = n, this.NoExpression = h, this.fQt = s, this.BtType) {
  ...
  Dispose() {
    this.EQt(), this.vQt.clear(), this.gKs.clear(), this.GDa.splice(0, this.GDa.length), this.ODa.clear(), this.kDa.clear()
  }
  AddNode(e, t) {
    this.fZ.set(e, t)
  }
  ...
  UpdateNodeInStatusGroup(e, t, i) {
    t !== i && (t = this.GetGroupIdByStatus(t), (t = this.GetNodesByGroupId(t)) && t.delete(e.NodeId), this.AddNodeToStatusGroup(e, i))
  }
  GetAllNodes() {
    return this.fZ
  }
  ...
  GetCurrentActiveChildQuestNode(t = !0) {
    var i = this.GetNodesByGroupId(1);
    if (i) {
      let e = void 0;
      for (var [, r] of i) "ChildQuest" !== r.NodeType || r.ContainTag(1) && t || (e = r);
      return e
    }
  }
  ...
  GetCurrentCommunicateId() {
    ...
    if ("ChildQuest" === e.NodeType && e.ChildQuestType === IQuest_1.EChildQuest.ReceiveTelecom) return e?.CommunicateId
  }
  IsChallengeUi() {
  ...
  CreateShowData(e = !0) {
    var t = this.BtType === Protocol_1.Aki.Protocol.hps.Proto_BtTypeQuest ? ModelManager_1.ModelManager.QuestNewModel.GetQuest(this.TreeConfigId)?.NameKey : void 0;
    if (!e) return MissionViewDefine_1.BehaviorTreeViewShowData.Create(this.BtType, this.TreeIncId, this.TreeConfigId, this.IsChallengeUi(), this.TaskMarkTableId, this.ZU_, t, this.UiTrackTextInfo.MainTitle, this.UiTrackTextInfo.SubTitles);
    let i = void 0;
    var r, s, e = this.UiTrackTextInfo.MainTitle;
    e && !this.pCc(e) && (r = PublicUtil_1.PublicUtil.GetConfigTextByKey(e.TidTitle), StringUtils_1.StringUtils.IsBlank(r) || (i = e));
    let o = void 0;
    if (0 < this.UiTrackTextInfo.SubTitles.length) {
      o = [];
      for (const n of this.UiTrackTextInfo.SubTitles) !n || this.pCc(n) || (s = PublicUtil_1.PublicUtil.GetConfigTextByKey(n.TidTitle), StringUtils_1.StringUtils.IsBlank(s)) || o.push(n);
  ...
  AddTag(e, t) {
    super.AddTag(e, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GeneralLogicTreeAddTag, e)
  }
  RemoveTag(e, t) {
    super.RemoveTag(e, t), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GeneralLogicTreeRemoveTag, e)
  }
  AddSilentShowInfo(i, e) {
    var t = this.SilentAreaShowInfo.findIndex((e, t) => e.SourceOfAdd === i);
    t < 0 ? this.SilentAreaShowInfo.push(new GeneralLogicTreeDefine_1.SilentAreaShowInfo(i, e)) : this.SilentAreaShowInfo[t].ShowInfo = e
  }
  ...
  RemoveRefOccupationId(t, e) {
    var i, r = this.gKs.get(e);
    !r || (i = r.findIndex(e => e === t)) < 0 || (r.splice(i, 1), 0 === r.length && this.gKs.delete(e))
  }
  HasRefOccupiedEntity() {
    if (this.BtType !== Protocol_1.Aki.Protocol.hps.Proto_BtTypeInst)
      for (var [e] of this.gKs) {
        ...
        if (t)
          if (ModelManager_1.ModelManager.GeneralLogicTreeModel.GetOccupationTreeId(e) !== this.TreeIncId) return !0
      }
    return !1
  }
    ...
    if (this.HasRefOccupiedEntity())
      for (var [e] of this.gKs) {
        var t = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetOccupationQuestName(e),
          i = ConfigManager_1.ConfigManager.TextConfig.GetTextById("QuestResourcesIsOccupied"),
          r = UE.NewArray(UE.BuiltinString),
          e = ConfigManager_1.ConfigManager.QuestNewConfig.GetOccupationResourceName(e);
  ...
  HasSpecRefOccupiedEntity(e) {
    for (const i of e) {
      ...
      if (t)
        if (ModelManager_1.ModelManager.GeneralLogicTreeModel.GetOccupationTreeId(i) !== this.TreeIncId) return !0
    }
    return !1
  }
    ...
    if (this.HasSpecRefOccupiedEntity(e))
      for (const o of e) {
        var t = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetOccupationQuestName(o),
          i = ConfigManager_1.ConfigManager.TextConfig.GetTextById("QuestResourcesIsOccupiedInfo"),
          r = UE.NewArray(UE.BuiltinString),
          s = ConfigManager_1.ConfigManager.QuestNewConfig.GetOccupationResourceName(o);
  ...
  AddGuaranteeActionInfo(t, i, r, e) {
    if (!this.NDa(r, e)) {
      ...
      e || (e = new Set, this.ODa.set(i, e)), e.add(this.GDa.length - 1), Log_1.Log.CheckInfo() && Log_1.Log.Info("GeneralLogicTree", 18, "GeneralLogicTree:添加保底行为：" + r.Name, ["触发行为", t], ["ActionInfo", r], ["treeConfigId", this.TreeConfigId])
    }
  }
  NDa(t, i) {
    return 0 !== i && this.GDa.some(e => 1 === i ? e.Name === t.Name : e.Name === t.Name && (0, IUtil_1.deepEquals)(e, t))
  }
  PopGuaranteeActionInfo(t, i) {
    for (let e = this.GDa.length - 1; 0 <= e; e--) {
      ...
      if (r.Name === i.Name && (0, IUtil_1.deepEquals)(r, i)) {
        ...
        return Log_1.Log.CheckInfo() && Log_1.Log.Info("GeneralLogicTree", 18, "GeneralLogicTree:移除保底行为：" + i.Name, ["触发行为", t], ["ActionInfo", i], ["treeConfigId", this.TreeConfigId]), r
      }
    }
  }
  ClearGuaranteeActions(e) {
    if (e) {
      ...
      if (t)
        for (let e = this.GDa.length - 1; 0 <= e; e--) t.has(e) && (this.GDa.splice(e, 1), t.delete(e))
