...
class GeneralLogicTreeConfigUtil {
  static InitConfig(e, t) {
    ...
    for (let e = 0; e < r.Num(); e++) {
      var i, s, a = r.Get(e);
      ue_1.BlueprintPathsLibrary.FileExists(a) && (s = (i = "", puerts_1.$ref)(""), ue_1.KuroStaticLibrary.LoadFileToString(s, a), i = (0, puerts_1.$unref)(s)) && t(i)
    }
  }
  ...
  static IsAlwaysFalseChildNode(e, t) {
    var r;
    return !!t && !!(r = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetBehaviorTree(e)) && !!(r = r.GetNodeConfig(t)) && ("AlwaysFalse" === r.Type || this.IsAlwaysFalseChildNode(e, r?.ParentNodeId))
  }
}
