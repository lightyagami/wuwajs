...
class PunishReportSettlementSuccessItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.SPe = void 0, this.Lqi = new CustomPromise_1.CustomPromise, this.yct = e => {
  ...
  async ShowTip() {
    await this.ShowAsync(), this.SPe.PlayLevelSequenceByName("Start"), await this.Lqi.Promise
  }
}
