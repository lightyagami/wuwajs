...
class GeneralLogicTreeUtil {
  ...
  static GetEntityConfigTransform(e) {
    let r = void 0;
    var t, o, e = ModelManager_1.ModelManager.CreatureModel.GetEntityData(e);
    return e && (t = Rotator_1.Rotator.Create(e.Transform?.Rot?.Y ?? 0, e.Transform?.Rot?.Z ?? 0, e.Transform?.Rot?.X ?? 0), o = Vector_1.Vector.Create(e.Transform?.Pos.X ?? 0, e.Transform?.Pos.Y ?? 0, e.Transform?.Pos.Z ?? 0), e = Vector_1.Vector.Create(e.Transform?.Scale?.X ?? 1, e.Transform?.Scale?.Y ?? 1, e.Transform?.Scale?.Z ?? 1), r = Transform_1.Transform.Create(t.Quaternion(), o, e)), r
  }
  ...
  static OpenQuestChapterView(e, r, t) {
    var o;
    e && ((o = ModelManager_1.ModelManager.QuestNewModel.GetShowQuestChapterIdFromConfig(r)) || Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 18, "任务没有配章节ID，章节内容显示不对找策划同学补上章节Id，目前章节提示需要读取“r.任务章节”的ID来显示内容", ["出问题的任务Id", r]), r = ModelManager_1.ModelManager.QuestNewModel.GetShowQuestConditionFromConfig(r), GeneralLogicTreeUtil.OpenChapterViewV2(e.ChapterState, o, !1, r), KuroSdkReport_1.KuroSdkReport.OnChapterStart(o, e.ChapterState))
  }
  static OpenChapterViewV2(e, r, t = !1, o) {
    ...
    if ("UiView_TaskTips_Prefab" === a?.PrefabName) {
      ...
      if (!i) return void(Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 18, "配置了客户端还未支持的状态", ["ChapterState", e]))
    } else if ("UiView_BattleDeclarationRed" === a?.PrefabName) n = new LguiUtil_1.TableTextArgNew(a.ChapterNum), i = 24;
    else if ("UiView_BattleDeclarationWhite" === a?.PrefabName) n = new LguiUtil_1.TableTextArgNew(a.ChapterNum), i = 25;
    else if ("UiView_TasktipsA_Prefab" === a?.PrefabName) switch (i = 26, s.ChapterState = e) {
      case 2:
        o && l.push(o);
        break;
      case 1:
    ...
    s.ResumeTimeDilation = t, ControllerHolder_1.ControllerHolder.GenericPromptController.ShowPromptByItsType(i, n, void 0, [], l, void 0, void 0, s, void 0, t), KuroSdkReport_1.KuroSdkReport.OnChapterStart(r, e)
  }
}
