...
class GeneralLogicTreeController extends ControllerWithAssistantBase_1.ControllerWithAssistantBase {
  ...
  static RegisterAssistant() {
    this.AddAssistant(0, new ServerNotifyAssistant_1.ServerNotifyAssistant), this.AddAssistant(1, new RequestToServerAssistant_1.RequestToServerAssistant), this.AddAssistant(2, new TreeExpressAssistant_1.TreeExpressAssistant), this.AddAssistant(3, new GuaranteeAssistant_1.GuaranteeAssistant)
  }
  static cYt(e) {
    if (this.Assistants) return this.Assistants.get(e)
  }
  static OnAddEvents() {
    super.OnAddEvents(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldDone, GeneralLogicTreeController.EUe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ChangeModeFinish, GeneralLogicTreeController.EUe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ActiveBattleView, GeneralLogicTreeController.bZe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.BehaviorTreeStartActionSession, GeneralLogicTreeController.mYt), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TearDownGeneralLogicTree, GeneralLogicTreeController.LH1), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.GeneralLogicTreeSuspend, GeneralLogicTreeController.jro)
  }
  static OnRemoveEvents() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDone, GeneralLogicTreeController.EUe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ChangeModeFinish, GeneralLogicTreeController.EUe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ActiveBattleView, GeneralLogicTreeController.bZe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.BehaviorTreeStartActionSession, GeneralLogicTreeController.mYt), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TearDownGeneralLogicTree, GeneralLogicTreeController.LH1), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.GeneralLogicTreeSuspend, GeneralLogicTreeController.jro), super.OnRemoveEvents()
  }
...
}(exports.GeneralLogicTreeController = GeneralLogicTreeController).uYt = void 0, GeneralLogicTreeController.EUe = () => {
  var e = () => {
    GeneralLogicTreeController.uYt = void 0;
    var e = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetAllBehaviorTrees();
    if (e && 0 < e.size)
      for (var [, t] of e) t.SetSleep(!1);
    ModelManager_1.ModelManager.GeneralLogicTreeModel.IsWakeUp = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.GeneralLogicTreeWakeUp)
  };
  UiManager_1.UiManager.IsViewShow("BattleView") ? e() : (GeneralLogicTreeController.uYt = new CustomPromise_1.CustomPromise, GeneralLogicTreeController.uYt.Promise.then(e))
  ...
  o && (t = MathUtils_1.MathUtils.LongToBigInt(o.w5n), (r = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetBehaviorTree(t)) ? r.DoAction(s.fvs, o.b5n, e.W5n, e.w5n, e.K5n, e.mvs, e.sS_) : Log_1.Log.CheckError() && Log_1.Log.Error("GeneralLogicTree", 18, "服务器通知执行行为时：对应的数据不存在，联系程序检查Bug", ["treeType", o.hps], ["treeId", t], ["actionIncId", e.w5n]))
}, GeneralLogicTreeController.LH1 = e => {
  var t = ModelManager_1.ModelManager.GeneralLogicTreeModel.RemoveBehaviorTree(e);
  t?.IsPendingDestroy && ModelManager_1.ModelManager.GeneralLogicTreeModel.AddToPendingDestroy(e, t)
}, GeneralLogicTreeController.jro = e => {
  e = ModelManager_1.ModelManager.GeneralLogicTreeModel.GetBehaviorTree(e);
  if (e) {
    for (const t of e.GetBlackBoard().GetCurrentExecuteActions()) LevelGeneralController_1.LevelGeneralController.StopActionsExecute(t);
