...
class ControllerWithAssistantBase extends ControllerBase_1.ControllerBase {
  ...
  static W$t() {
    if (this.Assistants)
      for (var [, t] of this.Assistants) t.OnAddEvents()
  }
  static K$t() {
    if (this.Assistants)
      for (var [, t] of this.Assistants) t.OnRemoveEvents()
  }
  static AddAssistant(t, s) {
    s && (s.Init(), this.Assistants.set(t, s))
  }
}(exports.ControllerWithAssistantBase = ControllerWithAssistantBase).Assistants = void 0;
