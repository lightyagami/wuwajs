...
class HelpController extends UiControllerBase_1.UiControllerBase {
  static OnInit() {
    return UE.UIExtendButtonComponent.SetDelegateForHelpClick((0, puerts_1.toManualReleaseDelegate)(HelpController._ti)), !0
  }
  static OpenHelpById(e) {
    var r = ConfigManager_1.ConfigManager.HelpConfig.GetHelpContentInfoByGroupId(e);
    if (void 0 !== r && 0 !== r.length) switch (this.HelpGroupId = e, r[0].Type) {
      case 0:
        UiManager_1.UiManager.OpenView("HelpView", this.HelpGroupId, this.uti);
        break;
      case 1:
...
exports.HelpController = HelpController, (_a = HelpController).HelpGroupId = void 0, HelpController._ti = e => {
