...
class HelpView extends UiViewBase_1.UiViewBase {
  ...
  AU() {
    var e = this.OpenParam,
      t = ConfigManager_1.ConfigManager.HelpConfig.GetHelpContentInfoByGroupId(e);
    if (0 < t.length) {
      this.GetText(0).ShowTextNew(t[0].Title);
      var s, a = t.length,
        n = (this.cti.forEach(e => {
          e.SetActive(!1)
        }), this.GetItem(2)),
        h = this.GetItem(1);
      let r = 0;
      for (let i = 0; i < a; i++) {
        let e = void 0;
        r > this.cti.length - 1 ? (s = LguiUtil_1.LguiUtil.CopyItem(n, h), e = new Paragraph_1.Paragraph(s.GetOwner()), this.cti.push(e)) : e = this.cti[r], e.Refresh(t[i]), e.SetActive(!0), r++
      }
    }
  }
}
