...
exports.HelpGuideView = undefined;
const UE = require("ue");
...
class HelpGuideView extends UiViewBase_1.UiViewBase {
  ...
  mti() {
    this.oPe.SetUiActive(true);
    this.iPe.PlayAnime(true);
    this.oPe.PlayAnime(false);
  }
  async OnBeforeStartAsync() {
    this.HelpGroupId = this.OpenParam;
    this.ZAe = ConfigManager_1.ConfigManager.HelpConfig.GetHelpContentInfoByGroupId(this.HelpGroupId);
    var i;
    var t = this.ZAe.length > 1;
