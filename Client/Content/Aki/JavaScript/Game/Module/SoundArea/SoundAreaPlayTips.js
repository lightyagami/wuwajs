...
class SoundAreaPlayTips extends UiTickViewBase_1.UiTickViewBase {
  constructor() {
    super(...arguments), this.tEt = 0, this.TIo = e => {
      this.SetBuffInfo(e)
    }
  }
  OnRegisterComponent() {
  ...
  SetBuffInfo(e) {
    ...
    e?.ShowTitle ? (this.GetItem(3).SetUIActive(!0), this.GetItem(4).SetUIActive(!1), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(1), e.BuffTitle)) : (this.GetItem(3).SetUIActive(!1), this.GetItem(4).SetUIActive(!0)), LguiUtil_1.LguiUtil.SetLocalTextNew(this.GetText(2), e.BuffDescription), e?.Time && (this.tEt = TimeUtil_1.TimeUtil.GetServerTimeStamp() + e.Time * TimeUtil_1.TimeUtil.InverseMillisecond), e?.MaxCount && ModelManager_1.ModelManager.SoundAreaPlayTipsModel.AddShowInfoIdCount(e.Id)
  }
  OnTick(e) {
    0 < this.tEt && TimeUtil_1.TimeUtil.GetServerTimeStamp() > this.tEt && (this.CloseMe(), this.tEt = 0)
  }
