...
class SoundAreaPlayTipsModel extends ModelBase_1.ModelBase {
  ...
  AddShowInfoIdCount(e) {
    var o, r, a = this.NO_(e);
    0 === a ? (r = (o = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SilentTips) ?? new Map).get(e) ?? 0, o.set(e, r += 1), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SilentTips, o)) : 1 === a && (r = this.FO_.get(e) ?? 0, this.FO_.set(e, r += 1))
  }
  GetInfoIdShowCount(e) {
    var o = SoundAreaPlayInfoById_1.configSoundAreaPlayInfoById.GetConfig(e),
      r = this.NO_(e);
    if (o?.MaxCount) {
      if (0 === r) return (LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SilentTips) ?? new Map).get(e) ?? 0;
