...
class LoginDebugPlayerNameView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.NEi = void 0, this.OEi = e => {
      this.GetButton(3).SetSelfInteractive(0 < e.length)
    }, this.uHe = () => {
      this.CloseMe()
    }, this.L3e = () => {
      var e = this.GetInputText(0).GetText();
      StringUtils_1.StringUtils.GetStringRealCount(e) > PersonalDefine_1.MAX_NAME_LENGTH ? this.kEi() : (ModelManager_1.ModelManager.LoginModel.SetPlayerName(e), this.CloseMe(), this.NEi && this.NEi())
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    this.GetText(1).SetUIActive(!1), this.GetInputText(0).OnTextChange.Bind(this.OEi), this.GetButton(3).SetSelfInteractive(!1)
  }
  kEi() {
