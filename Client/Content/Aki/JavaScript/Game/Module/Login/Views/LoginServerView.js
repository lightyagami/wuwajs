...
class LoginServerView extends UiViewBase_1.UiViewBase {
  constructor() {
    super(...arguments), this.xqe = void 0, this.TSi = void 0, this.LSi = (e, t, i) => {
      return new LoginServerItem_1.LoginServerItem
    }, this.DSi = () => {
      this.CloseMe()
    }, this.RSi = () => {
      var e = ModelManager_1.ModelManager.LoginServerModel.CurrentUiSelectSeverData;
      ModelManager_1.ModelManager.LoginServerModel.CurrentSelectServerData = e, ModelManager_1.ModelManager.LoginModel.SetServerName(e.name), ModelManager_1.ModelManager.LoginModel.SetServerIp(e.ip, 3), ModelManager_1.ModelManager.LoginModel.SetServerId(e.id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnConfirmServerItem), this.CloseMe()
    }, this.aSi = () => {
      if (this.xqe)
        for (let e = 0; e < this.xqe.GetScrollItemCount(); e++)(this.xqe?.GetScrollItemFromIndex(e))?.UpdatePlayerInfo()
    }
  }
  OnRegisterComponent() {
  ...
  async OnBeforeStartAsync() {
    this.TSi = new LoginServerDynItem_1.LoginServerDynItem, this.xqe = new DynScrollView_1.DynamicScrollView(this.GetUIDynScrollViewComponent(2), this.GetItem(3), this.TSi, this.LSi), await this.xqe.Init()
  }
  OnStart() {
