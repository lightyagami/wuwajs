...
class AsyncUtil {
  static InitializeEnvironment() {
    if (!this.Sq_) {
      if (JsModelManager_1.JsModelManager.InitializeEnvironment(), AiConfig_1.AiConfig.AsyncAiPerception = !0, AiConfig_1.AiConfig.CppAsyncAiPerception = !0, AiConfig_1.AiConfig.CppAsyncAiPerception) {
        var e = UE.NewArray(UE.BuiltinName);
        for (const t of EntityHelper_1.globalEntityTypeQueryName) e.Add(new UE.FName(t));
  ...
  static DestroyEnvironment() {
    this.Sq_ && (cpp_1.FKuroAIPerceptionUtils.Clear(), JsModelManager_1.JsModelManager.DestroyEnvironment(), this.Sq_ = !1)
  }
