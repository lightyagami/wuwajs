...
class ConditionConfig extends ConfigBase_1.ConfigBase {
  GetConditionGroupConfig(o) {
    ...
    if (n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("InstanceDungeon", 16, "获取条件组配置错误", ["conditionGroupId", o])
  }
  GetConditionConfig(o) {
    var n = ConditionById_1.configConditionById.GetConfig(o);
    if (n) return n;
    Log_1.Log.CheckError() && Log_1.Log.Error("InstanceDungeon", 16, "获取条件配置错误", ["conditionId", o])
  }
