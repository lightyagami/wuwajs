...
class AiModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.ActiveAiTeams = new Map, this.ActiveAiControllers = new Map, this.AiScoreManager = new ScoreUpdateManager_1.ScoreUpdateManager, this.HatredGroups = new Map, this.a6_ = new Map, this.Lte = 0
  }
  AddAiScore(e) {
  ...
  GetAiTeam(e = 1) {
    ...
    return t || ((t = new AiTeam_1.AiTeam).TeamId = ++this.Lte, t.Init(e), this.ActiveAiTeams.set(e, t)), t
  }
  AddActiveAiController(i) {
    ...
    if (!this.ActiveAiControllers.has(s) && (this.ActiveAiControllers.set(s, i), i.HatredGroupId)) {
      ...
      let e = this.HatredGroups.get(s),
        t = (e || (e = new Map, this.HatredGroups.set(s, e)), e.get(i.HatredGroupId));
      t || (t = new Set, e.set(i.HatredGroupId, t)), t.add(i)
    }
  }
  RemoveActiveAiController(e) {
    var t;
    this.ActiveAiControllers.delete(e.CharAiDesignComp.Entity.Id) && e.HatredGroupId && (t = this.a6_.get(e)) && (this.HatredGroups.get(t)?.get(e.HatredGroupId)?.delete(e), this.a6_.delete(e))
  }
}
