...
class AiController {
  ...
  ActivateCooldownTrigger(t) {
    ...
    if (ModelManager_1.ModelManager.GameModeModel.IsMulti) {
      ...
      CombatMessage_1.CombatNet.Send(18745, this.CharAiDesignComp.Entity, o);
    }
  ...
  SetCoolDownTime(t, i, o, e = "") {
    ...
    if (s && i < s) {
      ...
      if (ModelManager_1.ModelManager.GameModeModel.IsMulti && o) {
        ...
        CombatMessage_1.CombatNet.Send(18745, this.CharAiDesignComp.Entity, e);
      }
    }
  }
