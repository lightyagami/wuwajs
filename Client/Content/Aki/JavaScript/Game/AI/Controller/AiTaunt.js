...
class AiTaunt {
  ...
  Tick() {
    if (this.Dre && this.Dre !== -1) {
      ...
      if (!(t = s?.Active && ((i = s.GetComponent(186))?.Valid && !i.IsInGame && (t = false), (i = s.GetComponent(217))?.Valid || (t = false), !i.HasTag(1008164187)) ? t : false)) {
        if (Log_1.Log.CheckInfo()) {
  ...
  ClearCurrentTauntAndGe() {
    this.Bte.CharAiDesignComp.Entity.GetComponent(185)?.RemoveBuffByHandle(this.Rre);
    this.Are();
  }
  BindEvent() {
