...
class AiTaunt {
  ...
  Tick() {
    if (this.Dre && this.Dre !== -1) {
      ...
      if (!(t = s?.Active && ((i = s.GetComponent(176))?.Valid && !i.IsInGame && (t = false), (i = s.GetComponent(206))?.Valid || (t = false), !i.HasTag(1008164187)) ? t : false)) {
        if (Log_1.Log.CheckInfo()) {
  ...
  ClearCurrentTauntAndGe() {
    this.Bte.CharAiDesignComp.Entity.GetComponent(175)?.RemoveBuffByHandle(this.Rre);
    this.Are();
  }
  BindEvent() {
