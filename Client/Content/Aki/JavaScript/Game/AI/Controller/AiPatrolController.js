...
class AiPatrolController {
  ...
  ResetBaseInfoByMainPoint(e, r, o) {
    ...
    if (this.Xie.length !== 0 && !(this.Xie.length <= s)) {
      ...
      if (i?.IsMain && (this.ChangeMoveSpeed(e, r, i.MoveSpeed), (s = this.Hte).SkeletalMesh?.SetVisibility(!i.IsHide), o = s.Entity.GetComponent(205))) {
        e = -841499802;
        if (i.IsHide) {
          if (!o.HasTag(e)) {
            o.AddTag(e);
