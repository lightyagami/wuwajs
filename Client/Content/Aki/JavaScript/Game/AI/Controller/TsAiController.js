...
const puerts_1 = require("puerts"),
  ...
  allyLinkColor = new UE.LinearColor(.6, 1, .6, 1),
...
class TsAiController extends UE.KuroAIController {
  ...
  DrawPerception(t, e) {
    ...
    if (o) {
      ...
      for (const A of o.Allies) o.ShareAllyLink.has(A) || (i = ControllerHolder_1.ControllerHolder.CharacterController.GetCharacterActorComponentById(A)) && this.DrawArrow(t, i.ActorLocationProxy, allyLinkColor);
      for (const d of o.AllEnemies) e?.Valid && d === e.Id || (r = ControllerHolder_1.ControllerHolder.CharacterController.GetCharacterActorComponentById(d)) && this.DrawArrow(t, r.ActorLocationProxy, enemyLinkColor);
    ...
    var l = this.AiController.CharActorComp,
      h = (TsAiController.TmpVector.FromUeVector(l.GetInitLocation()), TsAiController.TmpVector),
      a = (GravityUtils_1.GravityUtils.AddZnInGravityForActor(l, h, -l.HalfHeight), this.AiController.AiHateList.AiHate),
      l = l.FloorLocation;
    UE.KismetSystemLibrary.D_DrawDebugSphere(this, l.ToUeVector(), a.DisengageDistanceRange.Min, DEFAULT_SEGMENTS, minHateAreaColor), UE.KismetSystemLibrary.D_DrawDebugSphere(this, l.ToUeVector(), a.DisengageDistanceRange.Max, DEFAULT_SEGMENTS, maxHateAreaColor), UE.KismetSystemLibrary.D_DrawDebugSphere(this, h.ToUeVector(), a.DisengageBornDistance.Min, DEFAULT_SEGMENTS, minHateInitAreaColor), UE.KismetSystemLibrary.D_DrawDebugSphere(this, h.ToUeVector(), a.DisengageBornDistance.Max, DEFAULT_SEGMENTS, maxHateInitAreaColor)
  }
  OnStart() {}
  "获取控制权时"() {}
  "状态切换时"(t, e, i) {}
  AddComplicatedEventBinder(t, e) {
    this.AiController ? this.AiController.AiConditionEvents.AddConditionEvent(t, e) : Log_1.Log.CheckError() && Log_1.Log.Error("Test", 6, "Error Call AddComplicatedEventBinder", ["AIC", this.GetName()])
  }
  AddSceneItemDestroyEventBinder(t, e) {
    this.AiController ? this.AiController.AiPerceptionEvents.AddSceneItemDestroyEvent(t, e) : Log_1.Log.CheckError() && Log_1.Log.Error("Test", 6, "Error Call AddSceneItemDestroyEventBinder", ["AIC", this.GetName()])
  }
  AddLevelVarBoolEventBinder(t, e) {
    this.AiController ? this.AiController.AiLevelVarEvents.AddLevelVarEvent(t, e) : Log_1.Log.CheckError() && Log_1.Log.Error("Test", 31, "Error Call AddLevelVarBoolEventBinder", ["AIC", this.GetName()])
  }
  ...
  ActivateSkillGroup(t, e) {
    this.AiController?.AiSkill && this.AiController.AiSkill.ActivateSkillGroup(t, e)
  }
  AddSkillCd(t, e) {
    this.AiController?.AiSkill && this.AiController.AiSkill.AddSkillCd(t, e)
  }
  AicApplyBuff(t) {
    this.CharBuffComp?.Valid && this.CharBuffComp.AddBuffFromAi(this.AiController.AiCombatMessageId, Number(t), {
  ...
  AicApplyBuffToTarget(t, e) {
    ...
    t && this.CharBuffComp?.Valid && t.AddBuffFromAi(this.AiController.AiCombatMessageId, Number(e), {
      InstigatorId: this.CharBuffComp.CreatureDataId,
      Reason: "AIC蓝图添加buff(AicApplyBuffToTarget)"
    })
  }
  AicRemoveBuff(t) {
    this.CharBuffComp?.Valid && this.CharBuffComp.RemoveBuff(Number(t), -1, "AIC蓝图移除buff（AIC Remove Buff）")
  }
  AicAddTag(t) {
    this.CharTagComp?.Valid && this.CharTagComp.AddTag(t?.TagId)
  }
  AicRemoveTag(t) {
    this.CharTagComp?.Valid && this.CharTagComp.RemoveTag(t?.TagId), this.CharBuffComp?.Valid && this.CharBuffComp.RemoveBuffByTag(t?.TagId, "AIC蓝图移除buff")
  }
  SetBattleWanderTime(t, e) {
    this.AiController.AiWanderInfos?.AiBattleWanderGroups ? this.AiController.AiWanderInfos.SetOverrideBattleWanderTime(t, e) : Log_1.Log.CheckError() && Log_1.Log.Error("AI", 6, "没有配置战斗游荡，不能设置战斗游荡时长", ["AiBaseConfigId", this.AiController.AiBase.Id])
  }
  SetBattleWanderIndex(t) {
    this.AiController.AiWanderInfos?.AiBattleWanderGroups ? t < 0 || this.AiController.AiWanderInfos.AiBattleWanderGroups.length <= t ? Log_1.Log.CheckError() && Log_1.Log.Error("AI", 6, "设置战斗游荡组不合法", ["AiBaseConfigId", this.AiController.AiBase.Id], ["TargetIndex", t]) : this.AiController.AiWanderInfos.CurrentBattleWanderIndex = t : Log_1.Log.CheckError() && Log_1.Log.Error("AI", 6, "没有配置战斗游荡，不能设置战斗游荡组", ["AiBaseConfigId", this.AiController.AiBase.Id])
  }
  AddBattleWanderEndTime(t) {
    this.AiController.AiWanderInfos?.AiBattleWanderGroups ? this.AiController.AiWanderInfos.BattleWanderAddTime += t : Log_1.Log.CheckError() && Log_1.Log.Error("AI", 6, "没有配置战斗游荡，不能增加游荡结束时间", ["AiBaseConfigId", this.AiController.AiBase.Id])
  }
  ...
  SetAiHateConfig(t) {
    TsAiController.StatSetAiHateConfig.Start(), this.AiController.AiHateList.AiHate = t ? ConfigManager_1.ConfigManager.AiConfig.LoadAiHate(Number(t)) : ConfigManager_1.ConfigManager.AiConfig.LoadAiHateByController(this.AiController, void 0), TsAiController.StatSetAiHateConfig.Stop()
  }
  ChangeHatred(t, e, i) {
  ...
  LogReport(t) {
    Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 8, "埋点废弃,请删除相关配置")
  }
  "逻辑主控"() {
...
部位血量: ${this.CharBuffComp?.Entity?.GetComponent(69)?.GetDebugText()}
集群Id：${this.AiController.GetTeamLevelId()}
阵营: ${this.GetEntity()?.GetComponent(0)?.GetEntityCamp()}
`
  }
  ReceiveDestroyed() {
    ObjectUtils_1.ObjectUtils.IsValid(this) && (this.Clear(), super.ReceiveDestroyed())
  }
  Clear() {
    this.CharAiDesignComp = void 0, this.CharBuffComp = void 0, this.CharTagComp = void 0, this.AiController = void 0, this.BehaviorTree = void 0, this.CharStateMachineComp = void 0
  }
  DrawArrow(t, e, i) {
    e.Subtraction(t, TsAiController.TmpVector);
    e = TsAiController.TmpVector.Size();
    TsAiController.TmpVector.MultiplyEqual((e - ARROW_LENGTH_SUB) / e), TsAiController.TmpVector.AdditionEqual(t), UE.KismetSystemLibrary.D_DrawDebugArrow(this, t.ToUeVector(), TsAiController.TmpVector.ToUeVector(), DRAW_ARROW_SIZE, i, 0, DRAW_LINE_THICKNESS)
  }
}
TsAiController.TmpVector = Vector_1.Vector.Create(), TsAiController.TmpVector2 = Vector_1.Vector.Create(), TsAiController.TmpVector3 = Vector_1.Vector.Create(), TsAiController.StatSetAiHateConfig = Stats_1.Stat.Create("SetAiHateConfig"), exports.default = TsAiController;
