...
class AiAlertClass {
  ...
  Clear() {
    this.qte = 0, this.Vte = !1, this.kte = !1, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RemoveAlterMark, this.Bte.CharActorComp.Entity.Id);
    var t = this.Hte.Entity;
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RemoveStalkAlertMark, t?.Id), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RemoveEavesdropMark, t?.Id), EventSystem_1.EventSystem.RemoveWithTarget(this.Hte.Entity, EventDefine_1.EEventName.SmartObjectAiAlterNotify, this.ExtraModifyAlterValue)
  }
  Tick(t) {
    if (ModelManager_1.ModelManager.GameModeModel?.IsTeleport) this.qte = 0, this.Vte = !1, this.kte = !1;
    else if (this.bte)
      if (this.qte === exports.MAX_ALERT) {
        if (!this.Bte.AiHateList.GetCurrentTarget()) {
          ...
          for (const n of this.Bte.AiPerception.Enemies) {
            ...
            e?.Valid && e.RemoveBuff(CharacterBuffIds_1.buffId.StealthIgnoreHateBuff, -1, "AiAlterClass MaxValue")
          }
        }
      } else {
        ...
        for (const _ of this.Bte.AiPerception.Enemies) {
          ...
          if (h.GetComponent(0).GetEntityType() !== Protocol_1.Aki.Protocol.kks.Proto_Player) this.Vte = !1;
          else {
            ...
            if (0 < this.Nte && h > this.Nte) this.Vte = !1;
              ...
              t < e || (this.Lz.DotProduct(i) < this.Gte * h && (t *= this.bte.BackwardRate), t < e) || (e = t)
            }
          }
        }
        if (e) {
          if (this.qte += t * e * MathUtils_1.MathUtils.MillisecondToSecond, this.qte >= exports.MAX_ALERT) {
            ...
            for (const a of this.Bte.AiPerception.Enemies) {
              ...
              r?.Valid && r.RemoveBuff(CharacterBuffIds_1.buffId.StealthIgnoreHateBuff, -1, "AiAlterClass MaxValue")
            }
            this.CallbackEvent && this.CallbackEvent.Callback.Broadcast(!0)
          }
        } else this.qte = Math.max(0, this.qte - t * this.bte.BaseDecrease * MathUtils_1.MathUtils.MillisecondToSecond);
        this.jte()
      }
    else this.Vte = !1
  }
