...
class AiTeam {
  constructor() {
    ...
    this.AiTeamLevel = undefined;
    this.AiTeamAreas = undefined;
    this.AiTeamAttacks = undefined;
    this.AreaCharTypeToPriority = new Array();
    this.xse = new Map();
    this.xie = (e, t) => {
      var i;
      if (t && (i = this.xse.get(t))) {
        this.xse.delete(t);
        this.xse.set(e, i);
        i.Target = e;
      }
  ...
  AddMember(e) {
    this.TeamMemberToGroup.set(e, undefined);
  }
  RemoveMember(e) {
    if (this.TeamMemberToGroup.delete(e)) {
      for (var [, t] of this.xse) {
        t.Remove(e);
      }
    }
  }
  Tick() {
    this.wse();
    for (var [, e] of this.xse) {
      e.ScheduleGroup();
    }
  }
  wse() {
    for (var [, e] of this.xse) {
      e.CheckTargetAndRemove();
    }
    for (var [t] of this.TeamMemberToGroup) {
      ...
      if (i?.Valid) {
        ...
        if (r) {
          if (r.CreatureData.GetEntityType() !== Protocol_1.Aki.Protocol.kks.Proto_Player) {
            ControllerHolder_1.ControllerHolder.BlackboardController.SetBooleanValueByEntity(t.CharAiDesignComp.Entity.Id, "TeamAttacker", true);
            this.TeamMemberToGroup.set(t, undefined);
          } else {
