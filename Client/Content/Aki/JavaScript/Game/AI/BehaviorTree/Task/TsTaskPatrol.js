...
class TsTaskPatrol extends TsTaskAbortImmediatelyBase_1.default {
  ...
  ReceiveExecuteAI(t, i) {
    ...
    if (e) {
      ...
      if (this.PatrolConfig && (this.Entity = e.CharAiDesignComp.Entity, this.MoveComp = this.Entity.GetComponent(45), this.StateComp = this.Entity.GetComponent(102), this.ActorComp = e.CharActorComp, this.PatrolConfig.ContainZ && e.CharActorComp?.Actor.KuroSetMovementMode({
        Mode: 5,
