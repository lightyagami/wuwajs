...
class TsTaskAddPlayBubble extends TsTaskAbortImmediatelyBase_1.default {
  constructor() {
    super(...arguments), this.FlowListName = "", this.FlowId = 0, this.StateId = 0, this.PbDataIds = void 0, this.EnterRadius = CharacterFlowComponent_1.DEFAULT_BUBBLE_ENTER_RANGE, this.LeaveRadius = CharacterFlowComponent_1.DEFAULT_BUBBLE_LEAVE_RANGE, this.IsInitTsVariables = !1, this.TsFlowListName = "", this.TsFlowId = 0, this.TsStateId = 0, this.TsPbDataIds = new Array, this.TsEnterRadius = 0, this.TsLeaveRadius = 0
  }
  Constructor() {
    super.Constructor(), this.IsInitTsVariables = !1, this.TsFlowListName = "", this.TsFlowId = 0, this.TsStateId = 0, this.TsPbDataIds = new Array, this.TsEnterRadius = 0, this.TsLeaveRadius = 0
  }
  InitTsVariables() {
    if (!this.IsInitTsVariables || GlobalData_1.GlobalData.IsPlayInEditor) {
      this.IsInitTsVariables = !0, this.TsFlowListName = this.FlowListName, this.TsFlowId = this.FlowId, this.TsStateId = this.StateId, this.TsEnterRadius = this.EnterRadius, this.TsLeaveRadius = this.LeaveRadius, this.TsPbDataIds.length = 0;
      ...
      if (this.TsPbDataIds.length)
        if (this.TsFlowListName) {
          ...
          if (o) {
            ...
            t ? (o = this.CreateCharacterFlowData(), ControllerHolder_1.ControllerHolder.DynamicFlowController.AddDynamicFlow(o)) : Log_1.Log.CheckError() && Log_1.Log.Error("LevelAi", 50, "禁止添加非自身参与的多人冒泡", ["PbDataId", s], ["FlowName", this.TsFlowListName], ["FlowId", this.TsFlowId], ["StateId", this.TsStateId])
          } else Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 50, "[TsTaskPlayBubble]无效的ActorComp", ["Type", t.GetClass().GetName()])
        } else Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 50, "[TsTaskPlayBubble]无效的FlowListName", ["Type", t.GetClass().GetName()])
