...
class TsTaskFollowTarget extends TsTaskAbortImmediatelyBase_1.default {
  ...
  ReceiveTickAI(t, i, s) {
    ...
    if (e) {
      this.DelayDie(t);
      if ((e = e.CharActorComp).Entity.CheckGetComponent(206).HasTag(-1371021686)) {
  ...
  GetPath(t, i) {
    ...
    if (s) {
      ...
      if (h !== 0) {
        ...
        if (r > this.TsNavigationRadius * this.TsNavigationRadius || e.Entity.CheckGetComponent(206).HasTag(498191540)) {
          ...
          if (r <= this.TsRadius * this.TsRadius) {
            ...
            e.Entity.CheckGetComponent(176).SetMoveState(CharacterUnifiedStateTypes_1.ECharMoveState.Stand);
            this.OnClear();
            return;
          }
          ...
          e.Entity.CheckGetComponent(176).SetMoveState(CharacterUnifiedStateTypes_1.ECharMoveState.Walk);
        ...
        if (r <= this.TsRadius * this.TsRadius && e.Entity.CheckGetComponent(206).HasTag(248240472)) {
  ...
  DelayDie(t) {
    ...
    for (const r of this.TsTags) {
      var h = this.Source.Entity.CheckGetComponent(206).HasTag(r?.TagId);
