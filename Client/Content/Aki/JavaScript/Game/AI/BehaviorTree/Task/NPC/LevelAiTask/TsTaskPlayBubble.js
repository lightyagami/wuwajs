...
class TsTaskPlayBubble extends TsTaskAbortImmediatelyBase_1.default {
  constructor() {
    super(...arguments), this.FlowListName = "", this.FlowId = 0, this.StateId = 0, this.IsInitTsVariables = !1, this.TsFlowListName = "", this.TsFlowId = 0, this.TsStateId = 0
  }
  Constructor() {
    super.Constructor(), this.IsInitTsVariables = !1, this.TsFlowListName = "", this.TsFlowId = 0, this.TsStateId = 0
  }
  InitTsVariables() {
    this.IsInitTsVariables && !GlobalData_1.GlobalData.IsPlayInEditor || (this.IsInitTsVariables = !0, this.TsFlowListName = this.FlowListName, this.TsFlowId = this.FlowId, this.TsStateId = this.StateId)
  }
  ReceiveExecuteAI(e, o) {
    if (this.InitTsVariables(), e instanceof TsAiController_1.default)
      if (this.TsFlowListName) {
        ...
        } else Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 50, "[TsTaskPlayBubble]无效的ActorComp", ["Type", e.GetClass().GetName()])
      } else Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 50, "[TsTaskPlayBubble]无效的FlowListName", ["Type", e.GetClass().GetName()]);
