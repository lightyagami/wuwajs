...
class TsDecoratorLevelPlayStateCheck extends UE.BTDecorator_BlueprintBase {
  constructor() {
    super(...arguments), this.CheckType = 0, this.LevelPlayId = 0, this.StateId = 0, this.IsInitTsVariables = !1, this.TsCheckType = 0, this.TsLevelPlayId = 0, this.TsStateId = ICondition_1.ELevelPlayState.Close
  }
  Constructor() {
    this.IsInitTsVariables = !1, this.TsCheckType = 0, this.TsLevelPlayId = 0
  }
  InitTsVariables() {
    this.IsInitTsVariables && !GlobalData_1.GlobalData.IsPlayInEditor || (this.IsInitTsVariables = !0, this.TsCheckType = this.CheckType, this.TsLevelPlayId = this.LevelPlayId, this.TsStateId = this.StateId)
  }
