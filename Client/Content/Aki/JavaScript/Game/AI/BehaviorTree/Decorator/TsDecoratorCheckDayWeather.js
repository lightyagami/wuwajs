...
class TsDecoratorCheckDayWeather extends UE.BTDecorator_BlueprintBase {
  constructor() {
    super(...arguments), this.CheckDayState = 0, this.CheckWeatherState = 0, this.ConditionType = 0
  }
  Constructor() {}
  PerformConditionCheckAI(e, r) {
    var t = ModelManager_1.ModelManager.WeatherModel?.GetCurrentWeatherType();
    let o = !1,
      s = (o = 0 === this.CheckDayState ? ControllerHolder_1.ControllerHolder.TimeOfDayController.CheckInMinuteSpan(DAY_MINITE_START, DAY_MINITE_END) : !ControllerHolder_1.ControllerHolder.TimeOfDayController.CheckInMinuteSpan(DAY_MINITE_START, DAY_MINITE_END), !1);
