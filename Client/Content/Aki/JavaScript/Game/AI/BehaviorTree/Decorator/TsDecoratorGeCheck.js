...
class TsDecoratorGeCheck extends UE.BTDecorator_BlueprintBase {
  constructor() {
    super(...arguments), this.BlackboardKeyTarget = "", this.Checks = void 0, this.Logic = 0, this.IsInitTsVariables = !1, this.TsBlackboardKeyTarget = "", this.TsChecks = void 0, this.TsLogic = void 0
  }
  Constructor() {
    this.IsInitTsVariables = !1, this.TsBlackboardKeyTarget = "", this.TsChecks = void 0, this.TsLogic = void 0
  }
  InitTsVariables() {
    if (!this.IsInitTsVariables || GlobalData_1.GlobalData.IsPlayInEditor) {
      this.IsInitTsVariables = !0, this.TsBlackboardKeyTarget = this.BlackboardKeyTarget, this.TsChecks = new Map;
  ...
  PerformConditionCheckAI(r, t) {
    ...
    if (!e) return Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 6, "错误的Controller类型", ["Type", r.GetClass().GetName()]), !1;
    ...
    var o = i.Entity.CheckGetComponent(174);
    if (!o) return !1;
    if (1 === this.TsLogic) {
