...
class TsDecoratorHasWeapon extends UE.BTDecorator_BlueprintBase {
  ...
  PerformConditionCheckAI(e, o) {
    ...
    return r ? r.CharActorComp.Entity.GetComponent(81).HasWeapon : (Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 6, "错误的Controller类型", ["Type", e.GetClass().GetName()]), !1)
  }
}
