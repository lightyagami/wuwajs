...
class TsDecoratorVarCompare extends UE.BTDecorator_BlueprintBase {
  constructor() {
    super(...arguments), this.CheckType = 0, this.SourceVarContext = void 0, this.TargetVarContext = void 0, this.IsInitTsVariables = !1, this.TsCheckType = 0, this.TsSourceVarContext = void 0, this.TsTargetVarContext = void 0, this.Entity = void 0
  }
  Constructor() {
    this.IsInitTsVariables = !1, this.TsCheckType = 0, this.TsSourceVarContext = void 0, this.TsTargetVarContext = void 0, this.Entity = void 0
  }
  InitTsVariables() {
    this.IsInitTsVariables && !GlobalData_1.GlobalData.IsPlayInEditor || (this.IsInitTsVariables = !0, this.TsCheckType = this.CheckType, this.TsSourceVarContext = this.SourceVarContext, this.TsTargetVarContext = this.TargetVarContext)
  }
  PerformConditionCheckAI(e, r) {
    var t = e.AiController;
    if (!t) return Log_1.Log.CheckError() && Log_1.Log.Error("BehaviorTree", 6, "错误的Controller类型", ["Type", e.GetClass().GetName()]), !1;
    if (this.InitTsVariables(), this.Entity = t.CharActorComp?.Entity, !this.TsSourceVarContext || !this.TsTargetVarContext) return !1;
    if ("" === this.TsSourceVarContext.Type || "" === this.TsTargetVarContext.Type) return !1;
    if (this.TsSourceVarContext.Type !== this.TsTargetVarContext.Type) return !1;
  ...
  ParseSelfValue(e) {
    return e.IsClientVariable ? this.GetClientValue(this.Entity, e) : (e = this.Entity?.GetComponent(0)?.GetEntityVar(e.Key), this.ParseValue(e))
  }
  ParseOtherValue(e) {
    var r = e.Key,
      t = e.RefId;
    switch (e.VarRefType) {
      case "Entity":
        ...
        if (s) return e.IsClientVariable ? this.GetClientValue(s.Entity, e) : (s = s.Entity?.GetComponent(0), this.ParseValue(s?.GetEntityVar(r)));
        break;
      case "Quest":
