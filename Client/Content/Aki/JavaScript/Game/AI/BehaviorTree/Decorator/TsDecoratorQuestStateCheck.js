...
class TsDecoratorQuestStateCheck extends UE.BTDecorator_BlueprintBase {
  constructor() {
    super(...arguments), this.QuestId = 0, this.CheckStateId = 0, this.CheckType = 0, this.IsInitTsVariables = !1, this.TsQuestId = 0, this.TsCheckStateId = 0, this.TsCheckType = 0
  }
  Constructor() {
    this.IsInitTsVariables = !1, this.TsQuestId = 0, this.TsCheckStateId = 0, this.TsCheckType = 0
  }
  InitTsVariables() {
    this.IsInitTsVariables && !GlobalData_1.GlobalData.IsPlayInEditor || (this.IsInitTsVariables = !0, this.TsQuestId = this.QuestId, this.TsCheckStateId = this.CheckStateId, this.TsCheckType = this.CheckType)
  }
