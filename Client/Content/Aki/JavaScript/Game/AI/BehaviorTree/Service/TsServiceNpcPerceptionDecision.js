  ...
  ReceiveTickAI(o, r, e) {
    if (o instanceof TsAiController_1.default) {
      ...
      let r = 0,
        e = 0;
      if (i && 0 < i.size)
        for (const n of i) switch (WorldFunctionLibrary_1.default.GetEntityTypeByEntity(n)) {
