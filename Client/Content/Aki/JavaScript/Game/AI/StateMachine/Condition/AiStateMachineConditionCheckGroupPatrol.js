...
class AiStateMachineConditionCheckGroupPatrol extends AiStateMachineCondition_1.AiStateMachineCondition {
  ...
  RegisterEvents() {
    return !!super.RegisterEvents() && !!this.Node.Entity && !EventSystem_1.EventSystem.Has(EventDefine_1.EEventName.OnGeneratedMonsterPatrolGroup, this.Cwu) && !(EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnGeneratedMonsterPatrolGroup, this.Cwu), 0);
  }
  UnregisterEvents() {
    return !!super.UnregisterEvents() && !!this.Node.Entity && !!EventSystem_1.EventSystem.Has(EventDefine_1.EEventName.OnGeneratedMonsterPatrolGroup, this.Cwu) && (EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnGeneratedMonsterPatrolGroup, this.Cwu), true);
  }
  OnInit(e) {
    this.RegisterEvents();
    return true;
