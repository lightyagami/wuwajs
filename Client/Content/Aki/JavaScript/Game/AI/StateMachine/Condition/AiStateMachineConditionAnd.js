    ...
    if (0 < e) {
      ...
      for (let t = 0; t < e; t++) {
        var n = i.CondAnd.Conditions[t],
          ...
          o = ModelManager_1.ModelManager.AiStateMachineModel.AiStateMachineFactory.CreateCondition(this.Transition, o, n);
        this.HasTaskFinishCondition ||= o.HasTaskFinishCondition, this.Conditions.push(o)
      }
    }
    return !0
  }
