...
class AiStateMachineConditionCheckInstState extends AiStateMachineCondition_1.AiStateMachineCondition {
  ...
  OnInit(t) {
    return this.TagId = t.CondInstStateChange.TagId, this.TagName = GameplayTagUtils_1.GameplayTagUtils.GetNameByTagId(this.TagId), this.vJ = this.Node.TagComponent.ListenForTagAddOrRemove(this.TagId, this.lne), this.ResultSelf = this.Node.TagComponent.HasTag(this.TagId), !0
  }
  OnClear() {
