...
class AiStateMachineActionStopMontage extends AiStateMachineAction_1.AiStateMachineAction {
  ...
  DoAction() {
    this.Node.SkillComponent?.CurrentSkill || this.Node.Owner.CheckAnyMontageTaskRunning(this.Node.RootNode) || this.Node.TagComponent?.HasTag(191377386) || this.Node.TagComponent?.HasTag(1008164187) || this.Node.TagComponent?.HasTag(-648310348) || this.Node.AnimationComponent.MainAnimInstance?.Montage_Stop(this.rxr)
  }
  ToString(t, i = 0) {
