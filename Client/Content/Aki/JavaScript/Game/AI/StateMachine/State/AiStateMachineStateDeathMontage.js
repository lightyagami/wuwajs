...
class AiStateMachineStateDeathMontage extends AiStateMachineState_1.AiStateMachineState {
  constructor() {
    super(...arguments), this.DeathType = 0, this.MontageName = "", this.Handle = -1
  }
  OnActivate() {
    var t = this.Node.DeathComponent;
    if (t) switch (this.DeathType) {
      case 1:
  ...
  OnDeactivate() {
    this.Node.DeathComponent?.ResetDeathMontage(this.Handle), this.Handle = -1
  }
  OnInit(t) {
    return this.DeathType = t.BindDeathMontage.DeathType, this.MontageName = t.BindDeathMontage.MontageName, !0
  }
  ToString(t, e = 0) {
