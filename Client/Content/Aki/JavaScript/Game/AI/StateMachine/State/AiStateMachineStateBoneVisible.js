...
class AiStateMachineStateBoneVisible extends AiStateMachineState_1.AiStateMachineState {
  ...
  OnInit(t) {
    return this.Sne = new UE.FName(t.BindBoneVisible.BoneName), this.yne = t.BindBoneVisible.Visible, !0
  }
  OnActivate() {
    this.Node.AnimationComponent.HideBone(this.Sne, !this.yne, !1)
  }
  OnDeactivate() {
    this.Node.TagComponent.HasTag(1008164187) || this.Node.AnimationComponent.HideBone(this.Sne, this.yne, !1)
  }
  ToString(t, e = 0) {
