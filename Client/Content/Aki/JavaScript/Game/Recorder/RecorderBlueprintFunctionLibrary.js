...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.BpFxEffectRecorderObject = exports.EFFECT_CREATE_ADVANCE = exports.RECORDER_MAX_EFFECT_SPEED = exports.RECORDER_MAX_SPEED = exports.RECORD_INTERVAL = void 0;
...
exports.RECORD_INTERVAL = .016667, exports.RECORDER_MAX_SPEED = 3e3, exports.RECORDER_MAX_EFFECT_SPEED = 1e5, exports.EFFECT_CREATE_ADVANCE = .1;
...
class CameraRecorderObject {
  constructor(r, e, t) {
    this.OC = r, this.Recorder = void 0, Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Start Camera Recorder", ["Actor", r.GetName()], ["Time", t]), this.Recorder = UE.NewObject(UE.KuroCameraRecorder.StaticClass()), this.Recorder.SetRecordActor(r, exports.RECORD_INTERVAL, exports.RECORDER_MAX_SPEED), this.Recorder.StartRecorder(e, t)
  }
  TickRecorder(r) {
    this.Recorder.TickRecorder(r)
  }
  StopRecorder() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Stop Camera Recorder", ["Actor", this.OC?.GetName()], ["Time", RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()]), this.Recorder.StopRecorder()
  }
}
class CharacterRecorderObject {
  constructor(r, e, t, i) {
    var n;
    this.Tae = r, this.ae = t, this.E0 = 0, this.Recorder = void 0, this.far = new Map, this.par = (r, e, t) => {
      this.far.set(t, new MaterialControllerParam(r, e, RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()))
    }, this.var = r => {
      var e, t = this.far.get(r);
      t && (RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint() < t.StartTime && Log_1.Log.CheckError() && Log_1.Log.Error("Test", 6, `Remove MaterialController: ${r} at ` + RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()), (e = this.Recorder.AddNotify(UE.TsAnimNotifyStateAddMaterialController_C.StaticClass(), FNameUtil_1.FNameUtil.EMPTY, t.StartTime, RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint() - t.StartTime)) && (e.ControllerData = t.Data, e.UserData = t.UserData), this.far.delete(r))
  ...
  static get NotUseCloneType() {
    return this.gAr || (this.gAr = new Set([Protocol_1.Aki.Protocol.kks.Proto_Player])), this.gAr
  }
  TickRecorder(r) {
    this.Recorder.TickRecorder(r)
  }
  StopRecorder() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Stop Character Recorder", ["Actor", this.Tae?.GetName()], ["EntityId", this.Tae?.CharacterActorComponent?.Entity.Id], ["Time", RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()]);
    var r, e = this.Recorder.AddNotify(UE.TsAnimNotifyStateAddCharRendering_C.StaticClass(), FNameUtil_1.FNameUtil.EMPTY, this.ae, RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint() - this.ae);
    e && (e.RenderType = this.Tae.RenderType), EntitySystem_1.EntitySystem.Get(this.E0) && (EventSystem_1.EventSystem.RemoveWithTarget(this.Tae.CharRenderingComponent, EventDefine_1.EEventName.OnAddMaterialController, this.par), EventSystem_1.EventSystem.RemoveWithTarget(this.Tae.CharRenderingComponent, EventDefine_1.EEventName.OnRemoveMaterialController, this.var));
...
class SceneItemRecorderObject {
  constructor(r, t, i) {
    this.Ear = r, this.Sar = new Array, Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Start SceneItem Recorder", ["Name", r.Owner.GetName()], ["Path", SceneInteractionManager_1.SceneInteractionManager.Get().GetSceneInteractionLevelName(r.GetSceneInteractionLevelHandleId())], ["EntityId", r.Entity.Id], ["Time", i]);
    var e = r.Owner;
    const n = UE.NewObject(UE.KuroMeshRecorder.StaticClass());
    this.Sar.push(n), n.SetRecordActor(e, exports.RECORD_INTERVAL, exports.RECORDER_MAX_EFFECT_SPEED), n.StartRecorder(t, i);
    ...
    if (o) {
      ...
      for (let r = 0, e = o.Num(); r < e; r++) {
        var u = o.Get(r);
        if (c.has(u)) Log_1.Log.CheckWarn() && Log_1.Log.Warn("Test", 6, "Recorder Repetitive SceneItemActor", ["Actor", u.GetName()]);
        else if (Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "  SceneItem Child", ["Name", u.GetName()]), c.add(u), !(!u.RootComponent || u instanceof UE.Brush || u instanceof UE.LevelSequenceActor)) {
          const n = UE.NewObject(UE.KuroMeshRecorder.StaticClass());
          this.Sar.push(n), n.SetRecordActor(u, exports.RECORD_INTERVAL, exports.RECORDER_MAX_SPEED), n.StartRecorder(t, i)
        }
      }
    }
  }
  ...
  StopRecorder() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Stop SceneItem Recorder", ["LevelName", SceneInteractionManager_1.SceneInteractionManager.Get().GetSceneInteractionLevelName(this.Ear.GetSceneInteractionLevelHandleId())], ["EntityId", this.Ear?.Entity?.Id], ["Time", RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()]);
    for (const r of this.Sar) r.StopRecorder()
  }
}
class EffectRecorderObject {
  constructor(r, e, t, i) {
    this.OC = r, this.m$o = e, this.yar = -1, this.Iar = -1, this.Playing = !1, this.iy = void 0, this.n8 = "", this.klh = void 0, this.Cce = 0, Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Start Effect Recorder", ["Actor", r.GetName()], ["Time", i]), this.Cce = i, this.iy = UE.NewObject(UE.KuroEffectRecorder.StaticClass()), this.iy.SetEffectClass(UE.TsRecordEffect_C.StaticClass(), EffectSystem_1.EffectSystem.GetEffectModel(e).GetName()), this.iy.SetRecordActor(r, exports.RECORD_INTERVAL, exports.RECORDER_MAX_SPEED), this.iy.StartRecorder(t, i);
    var n, t = this.iy.GetShadow();
    this.n8 = UE.KismetSystemLibrary.GetPathName(EffectSystem_1.EffectSystem.GetEffectModel(e)), this.iy.RecordStringValue(r, new UE.FName("EffectModelDataPath"), i - exports.EFFECT_CREATE_ADVANCE, this.n8), EffectSystem_1.EffectSystem.IsHandleFreeze(e) && (t.LifeTimeType = 3, this.klh || (n = EffectSystem_1.EffectSystem.GetSeekToTargetTime(this.m$o), this.klh = new RecordCurveObject_1.RecordFloatCurveObject(r, "ManualProcessTime", i, n)), this.iy.AddAutoFloatPropertyTrack(t, new UE.FName("ManualProcessTime"), i)), t.EffectModelDataPath = this.n8, t.EffectModelData = EffectSystem_1.EffectSystem.GetEffectModel(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Record Effect", ["EffectModel", EffectSystem_1.EffectSystem.GetEffectModel(e)?.GetName()], ["Path", t.EffectModelDataPath])
  }
  TickRecorder(r) {
    let e = !1;
    var t, i = EffectSystem_1.EffectSystem.GetLastPlayTime(this.m$o),
      n = EffectSystem_1.EffectSystem.GetLastStopTime(this.m$o);
    EffectSystem_1.EffectSystem.IsHandleFreeze(this.m$o) && -1 < (t = EffectSystem_1.EffectSystem.GetSeekToTargetTime(this.m$o)) && (this.klh ? this.klh.RecordTick(r, t) : this.klh = new RecordCurveObject_1.RecordFloatCurveObject(this.OC, "ManualProcessTime", this.Cce, t)), 0 < i && i !== this.yar && (this.yar = i, e = !0, this.Playing = !0), 0 < n && n !== this.Iar && (this.Iar = n, e = !0, this.Playing = !1), e && (this.yar > this.Iar ? this.iy.PlayCommand() : this.iy.StopCommand()), this.iy.TickRecorder(r) && (this.Cce += r)
  }
  StopRecorder() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Stop Effect Recorder"), this.klh && (this.klh.RecordStop(this.Cce, this.iy, 1), this.klh = void 0), this.yar > this.Iar && this.iy.StopCommand(), this.iy.RecordStringValue(this.OC, new UE.FName("EffectModelDataPath"), RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint(), this.n8), this.iy.StopRecorder()
  }
}
class BpFxEffectRecorderObject {
  constructor(r, e, t) {
    this.OC = r, this.ae = t, this.Recorder = void 0, Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Start TsBpFxEffect Recorder", ["Actor", r.GetName()], ["Time", t]), this.Recorder = UE.NewObject(UE.KuroTrackRecorder.StaticClass()), this.Recorder.SetRecordActor(r, exports.RECORD_INTERVAL, exports.RECORDER_MAX_SPEED), this.Recorder.StartRecorder(e, t), (this.OC.Recorder = this).OC.RecorderShadow = this.Shadow, this.Shadow.IsRecorderActor = !0, this.OC.OnRecordStart()
  }
  get Shadow() {
  ...
  StopRecorder(r) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Stop TsBpFxEffect Recorder", ["Actor", this.OC.GetName()], ["Time", RecorderBlueprintFunctionLibrary.RecordingTimeNoBlueprint()]), this.OC.OnRecordStop(), this.Recorder.AddStaticBoolPropertyTrack(this.OC, new UE.FName("IsRecorderActor"), !0, this.ae, r), this.Recorder.StopRecorder(), this.OC.ClearRecorder()
  }
}
...
class RecorderBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static TickRecord(r) {
    if (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Test", 6, "TickRecord"), RecorderBlueprintFunctionLibrary.Recording && (RecorderBlueprintFunctionLibrary.CenterActor || Global_1.Global.BaseCharacter)) {
      ...
      for ([, e] of RecorderBlueprintFunctionLibrary.CharacterRecorders) e.TickRecorder(c);
      for ([, t] of RecorderBlueprintFunctionLibrary.SceneItemRecorders) t.TickRecorder(c);
      for ([, i] of RecorderBlueprintFunctionLibrary.EffectRecorders) i.TickRecorder(c);
      for ([, n] of RecorderBlueprintFunctionLibrary.BpFxEffectRecorders) n.TickRecorder(c);
      for ([, o] of RecorderBlueprintFunctionLibrary.GameplayCueRecorders) o.TickRecorder(c);
      RecorderBlueprintFunctionLibrary.StartRecordersWhenUpdate(), RecorderBlueprintFunctionLibrary.Stat3.Stop()
    }
  }
  static StopRecord() {
    if (RecorderBlueprintFunctionLibrary.Recording) {
      RecorderBlueprintFunctionLibrary.FightCameraRecorder?.StopRecorder(), RecorderBlueprintFunctionLibrary.SequenceCameraRecorder?.StopRecorder(), RecorderBlueprintFunctionLibrary.WidgetCameraRecorder?.StopRecorder();
      for (var [, r] of RecorderBlueprintFunctionLibrary.CharacterRecorders) r.StopRecorder();
      RecorderBlueprintFunctionLibrary.CharacterRecorders.clear();
      for (var [, e] of RecorderBlueprintFunctionLibrary.SceneItemRecorders) e.StopRecorder();
      RecorderBlueprintFunctionLibrary.SceneItemRecorders.clear();
      for (var [, t] of RecorderBlueprintFunctionLibrary.EffectRecorders) t.StopRecorder();
      RecorderBlueprintFunctionLibrary.EffectRecorders.clear();
      for (var [, i] of RecorderBlueprintFunctionLibrary.BpFxEffectRecorders) i.StopRecorder(RecorderBlueprintFunctionLibrary.RecordingTimeInternal);
      RecorderBlueprintFunctionLibrary.BpFxEffectRecorders.clear();
      for (var [, n] of RecorderBlueprintFunctionLibrary.GameplayCueRecorders) n.StopRecorder(RecorderBlueprintFunctionLibrary.RecordingTimeInternal);
      RecorderBlueprintFunctionLibrary.GameplayCueRecorders.clear(), RecorderBlueprintFunctionLibrary.Recording = !1, RecorderBlueprintFunctionLibrary.RecordingTimeInternal = 0, EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.CreateEntity, RecorderBlueprintFunctionLibrary.OnCreateEntity), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.PlayCameraLevelSequence, RecorderBlueprintFunctionLibrary.OnPlayCameraLevelSequence)
    }
  }
  static IsPlaying() {
  ...
  static GetPlayingLevelSequence(r) {
    if (!RecorderBlueprintFunctionLibrary.LevelSequencePlayer?.IsValid()) {
      var e = (0, puerts_1.$ref)(void 0),
        t = (UE.GameplayStatics.GetAllActorsOfClass(r, UE.LevelSequenceActor.StaticClass(), e), (0, puerts_1.$unref)(e));
  ...
  static CreateNewDataAssetNoBlueprint(r, e) {
    ...
    return UE.KuroAnimEdLibrary.CreateNewDataAsset(RecorderBlueprintFunctionLibrary.OutPath + r, e, t, void 0), (0, puerts_1.$unref)(t)
  }
  static SaveObject(r) {
  ...
  static StopRecordersWhenUpdate() {
    let r = !1;
    for (var [e, t] of RecorderBlueprintFunctionLibrary.CharacterRecorders) EntitySystem_1.EntitySystem.Get(e) || (t.StopRecorder(), RecorderBlueprintFunctionLibrary.CharacterRecorders.delete(e), r = !0);
    for (var [i, n] of RecorderBlueprintFunctionLibrary.SceneItemRecorders) EntitySystem_1.EntitySystem.Get(i) || (n.StopRecorder(), RecorderBlueprintFunctionLibrary.SceneItemRecorders.delete(i), r = !0);
    for (var [o, c] of RecorderBlueprintFunctionLibrary.EffectRecorders) EffectSystem_1.EffectSystem.IsValid(o) || (c.StopRecorder(), RecorderBlueprintFunctionLibrary.EffectRecorders.delete(o));
    return r
  }
  static StartRecordersWhenUpdate() {
    ...
    RecorderBlueprintFunctionLibrary.Stat1.Stop(), RecorderBlueprintFunctionLibrary.Stat2.Start(), RecorderBlueprintFunctionLibrary.StartEffectRecorders(r) && (e = !0), RecorderBlueprintFunctionLibrary.Stat2.Stop(), e
  }
  static StartEntityRecorders(r) {
    let e = !1;
    var t, i, n, o;
    if (RecorderBlueprintFunctionLibrary.EnableCharacterRecord)
      for (const c of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) c.Valid && c.Entity && (t = c.Entity).Active && !RecorderBlueprintFunctionLibrary.CharacterRecorders.has(c.Entity.Id) && (i = t.GetComponent(0)) && RecorderBlueprintFunctionLibrary.CharacterTypes.has(i.GetEntityType()) && (i = t.GetComponent(3)) && i.Actor && (Vector_1.Vector.DistSquared(i.ActorLocationProxy, r) > RecorderBlueprintFunctionLibrary.RecordDistSquared || (i = new CharacterRecorderObject(i.Actor, RecorderBlueprintFunctionLibrary.OutputSequence, RecorderBlueprintFunctionLibrary.RecordingTimeInternal, RecorderBlueprintFunctionLibrary.OutPath), RecorderBlueprintFunctionLibrary.CharacterRecorders.set(t.Id, i), e = !0));
    if (RecorderBlueprintFunctionLibrary.EnableSceneItemRecord)
      for (const u of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) u.Valid && u.Entity && (n = u.Entity).Active && !RecorderBlueprintFunctionLibrary.SceneItemRecorders.has(u.Entity.Id) && (o = n.GetComponent(0)) && RecorderBlueprintFunctionLibrary.SceneItemTypes.has(o.GetEntityType()) && (!(o = n.GetComponent(202)).GetIsSceneInteractionLoadCompleted() || Vector_1.Vector.DistSquared(o.ActorLocationProxy, r) > RecorderBlueprintFunctionLibrary.RecordDistSquared || (o = new SceneItemRecorderObject(o, RecorderBlueprintFunctionLibrary.OutputSequence, RecorderBlueprintFunctionLibrary.RecordingTimeInternal), RecorderBlueprintFunctionLibrary.SceneItemRecorders.set(n.Id, o), e = !0));
    return e
  }
  static StartEffectRecorders(r) {
    return RecorderBlueprintFunctionLibrary.EffectLocation || (RecorderBlueprintFunctionLibrary.EffectLocation = Vector_1.Vector.Create()), RecorderBlueprintFunctionLibrary.EnableEffectRecord && EffectSystem_1.EffectSystem.SetEffectStartRecording(RecorderBlueprintFunctionLibrary.EffectLocation, r, RecorderBlueprintFunctionLibrary.RecordDistSquared, this.OnEffectRecorded), !1
  }
  ...
  static StopRecordTsBpFxEffect(r) {
    ...
    e && (e.StopRecorder(RecorderBlueprintFunctionLibrary.RecordingTimeInternal), RecorderBlueprintFunctionLibrary.BpFxEffectRecorders.delete(r))
  }
  static StartRecordGameplayCueHook(e, t) {
    if (RecorderBlueprintFunctionLibrary.EnableEffectRecord) {
      ...
      var i, n;
      return r ? r : (i = this.FindCenterLocation(), (n = RecorderBlueprintFunctionLibrary.EffectLocation).FromUeVector(e.D_K2_GetActorLocation()), Vector_1.Vector.DistSquared(i, n) > RecorderBlueprintFunctionLibrary.RecordDistSquared ? void(Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "Record GameplayCue TooFar", ["Name", e.GetName()], ["actorLocation", n], ["centerLocation", i])) : ((r = new(t instanceof GameplayCueHookCommonItem_1.GameplayCueHookCommonItem ? GameplayCueRecorder_1.GameplayCueRecorderHook : GameplayCueRecorder_1.GameplayCueRecorderBeam)(e, t, RecorderBlueprintFunctionLibrary.OutputSequence, RecorderBlueprintFunctionLibrary.RecordingTimeInternal)).Start(), RecorderBlueprintFunctionLibrary.GameplayCueRecorders.set(t, r), r))
    }
  }
  static StopRecordGameplayCueHook(r) {
    var e = RecorderBlueprintFunctionLibrary.GameplayCueRecorders.get(r);
    e && (e.StopRecorder(RecorderBlueprintFunctionLibrary.RecordingTimeInternal), RecorderBlueprintFunctionLibrary.GameplayCueRecorders.delete(r))
  }
