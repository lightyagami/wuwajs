...
class TsAnimNotifyStateAddMaterialController extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.ControllerData = void 0, this.UserData = void 0, this.Handles = void 0
  }
  Constructor() {
    this.Handles = void 0
  }
  ...
  K2_NotifyEnd(t, e) {
    var r, i = t.GetOwner().GetComponentByClass(UE.CharRenderingComponent_C.StaticClass());
    return i instanceof CharRenderingComponent_1.default && !!this.Handles && void 0 !== (r = this.Handles.get(t)) && (this.Handles.delete(t), i.RemoveMaterialControllerData(r), !0)
  }
}
