...
class TsBpFxEffect extends UE.Actor {
  constructor() {
    super(...arguments), this.IsRecorderActor = !1, this.RecordTime = 0, this.RecorderShadow = void 0, this.Recorder = void 0
  }
  Constructor() {
  ...
  OnRecordStop() {}
  OnPlay() {
    RecorderBlueprintFunctionLibrary_1.default.Recording && !this.Recorder && (this.Recorder = RecorderBlueprintFunctionLibrary_1.default.StartRecordTsBpFxEffect(this))
  }
  OnStop() {
    RecorderBlueprintFunctionLibrary_1.default.Recording && this.RecorderShadow && RecorderBlueprintFunctionLibrary_1.default.StopRecordTsBpFxEffect(this)
  }
  ClearRecorder() {
