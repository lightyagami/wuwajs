...
class TestModuleBridge {
  ...
  static async TryGetTestModuleExports() {
    ...
    try {
      ...
      e instanceof Error ? Log_1.Log.CheckInfo() && Log_1.Log.Info("Game", 62, "找不到Test模块入口", ["error", e.stack || e.message]) : Log_1.Log.CheckInfo() && Log_1.Log.Info("Game", 62, "找不到Test模块入口", ["error", e])
    }
  }
