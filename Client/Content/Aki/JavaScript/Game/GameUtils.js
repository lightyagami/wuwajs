...
}(exports.GameUtils = GameUtils).u_i = new ImmutableArray_1.ImmutableArray, GameUtils.eza = new ImmutableMap_1.ImmutableMap, GameUtils.IsOptimizeDbString = !0, GameUtils.Ppl = () => 0, GameUtils.xpl = {
  length: 0
};
