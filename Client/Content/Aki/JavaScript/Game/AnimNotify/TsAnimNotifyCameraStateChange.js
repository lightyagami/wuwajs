...
class TsAnimNotifyCameraStateChange extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, r) {
    e = e.GetOwner();
    return (!this.是否为单客户端 || e instanceof TsBaseCharacter_1.default && e === Global_1.Global.BaseCharacter) && (ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.IsFollowing = this.是否跟随), !0
  }
  GetNotifyName() {
    return "摄像机状态改变"
  }
