...
class TsAnimNotifyTriggerGuide extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, r) {
    ...
    return ControllerHolder_1.ControllerHolder.LevelGeneralController.ExecuteActionsNew(t, LevelGeneralContextDefine_1.EntityContext.Create()), Log_1.Log.CheckInfo() && Log_1.Log.Info("Guide", 64, "由蒙太奇触发的引导", ["EventGroupId", this.EventGroupId], ["GuideGroupId", o]), !0
  }
  GetNotifyName() {
    return "执行行为组事件"
  }
