...
class TsAnimNotifyDestroySpecBullet extends UE.KuroAnimNotify {
  constructor() {
    super(...arguments), this.bulletName = void 0, this.是否召唤子子弹 = !1, this.角色拥有标签执行判定 = void 0
  }
  Constructor() {}
  K2_Notify(e, r) {
    e = e.GetOwner();
    if (e instanceof TsBaseCharacter_1.default) {
      ...
      for (let e = o.length - 1; 0 <= e; e--) ControllerHolder_1.ControllerHolder.BulletController.DestroyBullet(o[e], this.是否召唤子子弹)
    }
    return !0
  }
  GetNotifyName() {
