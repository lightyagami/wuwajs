...
class TsAnimNotifyChangeSkillPriority extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, r) {
    var e = e.GetOwner();
    return e instanceof TsBaseCharacter_1.default && (e = (e?.CharacterActorComponent?.Entity)?.GetComponent(40)) && !e.IsSkillMontageInvalid(r.GetName()) && e.SetSkillPriority(e.GetSkillIdWithGroupId(BaseSkillComponent_1.SKILL_GROUP_MAIN), this.Priority), !0
  }
  GetNotifyName() {
    return "修改技能优先级"
  }
