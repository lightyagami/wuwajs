...
class TsAnimNotifyReSkillByTagCount extends TsAnimNotifyReSkillEvent_1.default {
  constructor() {
    super(...arguments), this.层数Tag = void 0, this.子弹数组Tag条件 = void 0, this.子弹数据名Tag条件 = void 0
  }
  Constructor() {
    super.Constructor()
  }
