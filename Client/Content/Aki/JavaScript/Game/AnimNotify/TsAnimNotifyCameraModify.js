...
class TsAnimNotifyCameraModify extends UE.KuroAnimNotify {
  constructor() {
    super(...arguments), this.Tag = void 0, this.持续时间 = -0, this.淡入时间 = -0, this.淡出时间 = -0, this.打断淡出时间 = -0, this.相机修改配置 = void 0, this.生效客户端类型 = 0, this.CameraAttachSocket = "CameraPosition", this.条件 = void 0
  }
  Constructor() {}
  K2_Notify(t, r) {
    t = t.GetOwner();
    ...
    if (!i?.Valid) return !1;
    let a = void 0;
    if (r instanceof UE.AnimMontage && (a = r), CameraUtility_1.CameraUtility.CheckApplyCameraModifyCondition(e, this.相机修改配置, this.生效客户端类型, this.条件)) {
      let r = void 0;
      0 !== this.生效客户端类型 && 1 !== this.生效客户端类型 && 6 !== this.生效客户端类型 && (r = t, this.相机修改配置.IsLockInput = !0, this.相机修改配置.OverrideCameraInput = !0), i.ApplyCameraModify(this.Tag, this.持续时间, this.淡入时间, this.淡出时间, this.相机修改配置, a, this.打断淡出时间, void 0, void 0, r, this.CameraAttachSocket, t)
    }
    return !0
  }
  GetNotifyName() {
