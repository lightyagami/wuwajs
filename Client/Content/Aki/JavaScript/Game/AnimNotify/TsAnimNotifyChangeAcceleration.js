...
class TsAnimNotifyChangeAcceleration extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, t) {
    var e = e.GetOwner();
    return e instanceof TsBaseCharacter_1.default && (e = e.CharacterActorComponent.Entity?.GetComponent(178)) && (e.AccelerationLerpTime = this.Time, e.AccelerationChangeMoveState = this.MoveState), !0
  }
  GetNotifyName() {
    return "修改角色位移最大加速度"
  }
