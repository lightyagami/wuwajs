...
class TsAnimNotifyFishingSkill extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, r) {
    e = e.GetOwner();
    return e instanceof TsBaseVehicle_1.default && !!(e.VehicleActorComponent?.Entity)?.Valid && (ControllerHolder_1.ControllerHolder.FishingController.BeginFishingSkill(this.SkillType), !0)
  }
  GetNotifyName() {
    return "捕鱼技能"
  }
