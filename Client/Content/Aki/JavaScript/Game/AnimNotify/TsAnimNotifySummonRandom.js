...
class TsAnimNotifySummonRandom extends UE.KuroAnimNotify {
  ...
  K2_Notify(r, e) {
    ...
    var o;
    var r = r.GetOwner();
    return !!r && !!(r instanceof TsBaseCharacter_1.default) && !!r?.CharacterActorComponent?.IsAutonomousProxy && !!(r = r?.CharacterActorComponent?.Entity)?.Valid && !!(o = r.GetComponent(43)) && !!o.CurrentSkill && !!this.Action && !(o = {
      Entity: r,
      SkillComponent: o,
