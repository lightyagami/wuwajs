...
class TsAnimNotifySummonRandom extends UE.KuroAnimNotify {
  constructor() {
    super(...arguments), this.SummonIndex = 0, this.Action = void 0, this.SkillId = 0, this.IsVisible = !0
  }
  Constructor() {}
  K2_Notify(r, e) {
    var t, o, r = r.GetOwner();
    return !(!(r && r instanceof TsBaseCharacter_1.default) || !(r = r?.CharacterActorComponent?.Entity)?.Valid || !((o = r.GetComponent(40)) && o.CurrentSkill && this.Action) || (o = {
      Entity: r,
      SkillComponent: o,
