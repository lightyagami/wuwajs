...
class TsAnimNotifyBattleQte extends UE.KuroAnimNotify {
  ...
  K2_Notify(e, r) {
    ...
    return (!this.存在Tag时才触发 || this.存在Tag时才触发.TagName === StringUtils_1.NONE_STRING || !!t?.GetComponent(217)?.HasTag(this.存在Tag时才触发.TagId)) && !(e = ModelManager_1.ModelManager.CharacterModel?.GetHandleByEntity(t), t = t?.GetComponent(222)?.CreateAnimNotifyContent(r.GetName(), this.exportIndex), e && t && ControllerHolder_1.ControllerHolder.BattleQteController.StartBattleQte(this.BattleQteId, t, e, 0), 0);
  }
  GetNotifyName() {
    return "战斗QTE";
  }
