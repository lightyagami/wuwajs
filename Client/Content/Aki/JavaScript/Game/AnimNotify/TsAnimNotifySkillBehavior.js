...
class TsAnimNotifySkillBehavior extends UE.KuroAnimNotify {
  ...
  K2_Notify(i, r) {
    ...
    for (let i = 0; i < this.技能行为.Num(); i++) {
      ...
      if (SkillBehaviorCondition_1.SkillBehaviorCondition.SatisfyGroup(a.SkillBehaviorConditionGroup, a.SkillBehaviorConditionFormula, l) && (SkillBehaviorAction_1.SkillBehaviorAction.BeginGroup(a.SkillBehaviorActionGroup, l), !a.SkillBehaviorContinue)) break
    }
    return !0
  }
  GetNotifyName() {
