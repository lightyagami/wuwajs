...
const RedDotActivityRegressAdventure_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressAdventure");
const RedDotActivityRegressBp_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressBp");
const RedDotActivityRegressBpReward_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressBpReward");
const RedDotActivityRegressBpTask_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressBpTask");
...
const RedDotActivityRegressDisposableReward_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressDisposableReward");
...
const RedDotActivityRegressRecommend_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressRecommend");
const RedDotActivityRegressShopDiscount_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressShopDiscount");
const RedDotActivityRegressTrialRole_1 = require("./RedDots/Activity/Recall/RedDotActivityRegressTrialRole");
...
const RedDotInfrArchive_1 = require("./RedDots/Infrastructure/RedDotInfrArchive");
const RedDotInfrastructure_1 = require("./RedDots/Infrastructure/RedDotInfrastructure");
const RedDotInfrLimitedTask_1 = require("./RedDots/Infrastructure/RedDotInfrLimitedTask");
const RedDotInfrShop_1 = require("./RedDots/Infrastructure/RedDotInfrShop");
...
const RedDotMotorcycleDevelop_1 = require("./RedDots/MotorcycleDevelop/RedDotMotorcycleDevelop");
const RedDotMotorcycleDiyTab_1 = require("./RedDots/MotorcycleDevelop/RedDotMotorcycleDiyTab");
const RedDotMotorcycleLevelTab_1 = require("./RedDots/MotorcycleDevelop/RedDotMotorcycleLevelTab");
const RedDotMotorcycleTaskTab_1 = require("./RedDots/MotorcycleDevelop/RedDotMotorcycleTaskTab");
...
const RedDotNewPlayerSupportAdventure_1 = require("./RedDots/NewPlayerSupport/RedDotNewPlayerSupportAdventure");
const RedDotNewPlayerSupportTrialRoleEntrance_1 = require("./RedDots/NewPlayerSupport/RedDotNewPlayerSupportTrialRoleEntrance");
const RedDotTrialRoleGroup_1 = require("./RedDots/NewPlayerSupport/RedDotTrialRoleGroup");
...
const RedDotPhantomInteractEditEntry_1 = require("./RedDots/PhantomInteract/RedDotPhantomInteractEditEntry");
const RedDotPhantomInteractRouletteGrid_1 = require("./RedDots/PhantomInteract/RedDotPhantomInteractRouletteGrid");
const RedDotPhantomInteractUnlock_1 = require("./RedDots/PhantomInteract/RedDotPhantomInteractUnlock");
const RedDotPhoneMsgChatItem_1 = require("./RedDots/PhoneMsg/RedDotPhoneMsgChatItem");
const RedDotPhoneMsgChatPartner_1 = require("./RedDots/PhoneMsg/RedDotPhoneMsgChatPartner");
const RedDotPhoneMsgChatPartnerGiftIcon_1 = require("./RedDots/PhoneMsg/RedDotPhoneMsgChatPartnerGiftIcon");
const RedDotPhoneMsgEntrance_1 = require("./RedDots/PhoneMsg/RedDotPhoneMsgEntrance");
...
const RedDotWeatherCentral_1 = require("./RedDots/WeatherCentral/RedDotWeatherCentral");
...
class RedDotModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    ...
    this.qp("ActivityRegressDisposableReward", new RedDotActivityRegressDisposableReward_1.RedDotActivityRegressDisposableReward());
    this.qp("ActivityRegressRecommend", new RedDotActivityRegressRecommend_1.RedDotActivityRegressRecommend());
    this.qp("ActivityRegressAdventure", new RedDotActivityRegressAdventure_1.RedDotActivityRegressAdventure());
    ...
    this.qp("ActivityRegressTrialRole", new RedDotActivityRegressTrialRole_1.RedDotActivityRegressTrialRole());
    this.qp("ActivityRegressBp", new RedDotActivityRegressBp_1.RedDotActivityRegressBp());
    this.qp("ActivityRegressBpTask", new RedDotActivityRegressBpTask_1.RedDotActivityRegressBpTask());
    this.qp("ActivityRegressBpReward", new RedDotActivityRegressBpReward_1.RedDotActivityRegressBpReward());
    ...
    this.qp("ActivityDirectTrainProEntry", new RedDotDirectTrain_1.RedDotDirectTrainProEntry());
    ...
    this.qp("FunctionPhoneMsg", new RedDotPhoneMsgEntrance_1.RedDotPhoneMsgEntrance());
    this.qp("FunctionWeatherCentral", new RedDotWeatherCentral_1.RedDotWeatherCentral());
    this.qp("FunctionMotorDevelop", new RedDotMotorcycleDevelop_1.RedDotMotorcycleDevelop());
    this.qp("InfrShop", new RedDotInfrShop_1.RedDotInfrShop());
    this.qp("InfrLimitedTask", new RedDotInfrLimitedTask_1.RedDotInfrLimitedTask());
    this.qp("InfrArchive", new RedDotInfrArchive_1.RedDotInfrArchive());
    this.qp("Infrastructure", new RedDotInfrastructure_1.RedDotInfrastructure());
    this.qp("RedDotTrialRoleGroup", new RedDotTrialRoleGroup_1.RedDotTrialRoleGroup());
    this.qp("RedDotNewPlayerSupportTrialRoleEntrance", new RedDotNewPlayerSupportTrialRoleEntrance_1.RedDotNewPlayerSupportTrialRoleEntrance());
    this.qp("RedDotNewPlayerSupportAdventure", new RedDotNewPlayerSupportAdventure_1.RedDotNewPlayerSupportAdventure());
    this.qp("PhoneMsgChatItemRedDot", new RedDotPhoneMsgChatItem_1.RedDotPhoneMsgChatItem());
    this.qp("PhoneMsgChatPartnerRedDot", new RedDotPhoneMsgChatPartner_1.RedDotPhoneMsgChatPartner());
    this.qp("PhoneMsgChatPartnerRedDotGiftIcon", new RedDotPhoneMsgChatPartnerGiftIcon_1.RedDotPhoneMsgChatPartnerGiftIcon());
    this.qp("RedDotPhantomInteractUnlock", new RedDotPhantomInteractUnlock_1.RedDotPhantomInteractUnlock());
    this.qp("RedDotPhantomInteractEditEntry", new RedDotPhantomInteractEditEntry_1.RedDotPhantomInteractEditEntry());
    this.qp("RedDotPhantomInteractRouletteGrid", new RedDotPhantomInteractRouletteGrid_1.RedDotPhantomInteractRouletteGrid());
