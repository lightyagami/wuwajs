...
exports.RedDotActivityRegressConstantTask = undefined;
...
class RedDotActivityRegressConstantTask extends RedDotBase_1.RedDotBase {
  ...
  OnCheck(e) {
    return ModelManager_1.ModelManager.ActivityRegressModel.ActivityData?.HasReachableConstantTask() || ModelManager_1.ModelManager.ActivityRegressModel.ActivityData?.CheckRegressScoreRewardReached();
  }
}
