...
exports.RedDotSpring25Enter = exports.RedDotSpring25Invite = exports.RedDotSpring25Reward = exports.RedDotSpring25AllLetter = undefined;
const EventDefine_1 = require("../../../Common/Event/EventDefine");
const ModelManager_1 = require("../../../Manager/ModelManager");
const RedDotBase_1 = require("../../RedDotBase");
class RedDotSpring25AllLetter extends RedDotBase_1.RedDotBase {
  OnGetEvents() {
    return [EventDefine_1.EEventName.Spring25InviteDone, EventDefine_1.EEventName.Spring25ActivityParseDone, EventDefine_1.EEventName.Spring25CloseLetterList];
  }
  OnCheck() {
...
class RedDotSpring25Reward extends RedDotBase_1.RedDotBase {
  OnGetEvents() {
    return [EventDefine_1.EEventName.Spring25DrawRewardDone, EventDefine_1.EEventName.Spring25SkinRewardDone, EventDefine_1.EEventName.Spring25InviteDone, EventDefine_1.EEventName.Spring25ActivityParseDone];
  }
  OnCheck() {
...
class RedDotSpring25Invite extends RedDotBase_1.RedDotBase {
  OnGetEvents() {
    return [EventDefine_1.EEventName.Spring25InviteDone, EventDefine_1.EEventName.Spring25ActivityParseDone];
  }
  OnCheck() {
