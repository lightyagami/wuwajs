...
class RedDotChatRoom extends RedDotBase_1.RedDotBase {
  OnCheck(e) {
    let t = void 0;
    return !!(t = 2 === e ? ModelManager_1.ModelManager.ChatModel.GetTeamChatRoom() : 3 === e ? ModelManager_1.ModelManager.ChatModel.GetWorldChatRoom() : ModelManager_1.ModelManager.ChatModel.GetPrivateChatRoom(e)) && t.GetIsShowRedDot()
  }
  OnGetEvents() {
