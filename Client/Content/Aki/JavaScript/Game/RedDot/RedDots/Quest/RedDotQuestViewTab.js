      ...
      if (r)
        for (const o of r)
          if (o.CanShowInUiPanel())
            if (ModelManager_1.ModelManager.QuestNewModel.CheckQuestRedDotDataState(o.Id) ?? !1) return Log_1.Log.CheckInfo() && Log_1.Log.Info("Quest", 18, "RedDotQuestViewTab：任务红点显示", ["mainTypeId", e], ["questId", o.Id]), !0
    }
    return !1
  }
  IsMultiple() {
