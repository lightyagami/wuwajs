...
class RedDotBattleViewQuestBtn extends RedDotBase_1.RedDotBase {
  ...
  OnCheck() {
    var e, t = ModelManager_1.ModelManager.QuestNewModel.GetAllRedDotData();
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Quest", 18, "开始检测主界面任务红点", ["红点数据量", t?.size]);
    for ([e] of t) {
      var r = ModelManager_1.ModelManager.QuestNewModel.GetQuest(e);
      if (r && r.CanShowInUiPanel()) return Log_1.Log.CheckInfo() && Log_1.Log.Info("Quest", 18, "主界面任务红点", ["红点任务", r.Id]), !0
    }
    return !1
  }
