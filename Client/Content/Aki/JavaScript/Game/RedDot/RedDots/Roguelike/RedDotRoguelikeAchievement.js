...
class RedDotRoguelikeAchievement extends RedDotBase_1.RedDotBase {
  ...
  OnCheck() {
    return ActivityRogueController_1.ActivityRogueController.RefreshActivityRedDot(), ModelManager_1.ModelManager.RoguelikeModel.GetRoguelikeAchievementRedDot()
  }
}
