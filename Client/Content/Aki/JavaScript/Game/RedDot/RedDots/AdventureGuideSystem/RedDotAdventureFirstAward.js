...
exports.RedDotAdventureFirstAward = undefined;
...
class RedDotAdventureFirstAward extends RedDotBase_1.RedDotBase {
  ...
  OnCheck(e) {
    return !!ModelManager_1.ModelManager.FunctionModel.IsOpen(10023) && ControllerHolder_1.ControllerHolder.AdventureGuideController.CheckCanGetFirstAward();
  }
}
