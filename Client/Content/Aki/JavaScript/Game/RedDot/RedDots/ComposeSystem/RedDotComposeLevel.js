...
exports.RedDotComposeLevel = undefined;
...
class RedDotComposeLevel extends RedDotBase_1.RedDotBase {
  OnGetEvents() {
    return [EventDefine_1.EEventName.UpdateComposeInfo, EventDefine_1.EEventName.GetComposeData, EventDefine_1.EEventName.ComposeSuccess, EventDefine_1.EEventName.UpgradeComposeLevel];
  }
  OnCheck() {
