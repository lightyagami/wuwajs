...
class RedDotMoonChasingBranchTab extends RedDotBase_1.RedDotBase {
  ...
  OnCheck() {
    return ActivityMoonChasingController_1.ActivityMoonChasingController.RefreshActivityRedDot(), ModelManager_1.ModelManager.MoonChasingModel.CheckBranchRedDot()
  }
}
