...
class OrbitalCamera extends Entity_1.Entity {
  ...
  OnCreate() {
    return !!this.AddComponent(SequenceCameraDisplayComponent_1.SequenceCameraDisplayComponent) && !!this.AddComponent(OrbitalCameraPlayerComponent_1.OrbitalCameraPlayerComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
    return this.ele = this.GetComponent(9), this.yme = this.GetComponent(6), !0
  }
  OnClear() {
