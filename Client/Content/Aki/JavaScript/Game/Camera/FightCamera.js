...
class FightCamera extends Entity_1.Entity {
  ...
  OnCreate() {
    return !!this.AddComponent(FightCameraLogicComponent_1.FightCameraLogicComponent) && !!this.AddComponent(FightCameraDisplayComponent_1.FightCameraDisplayComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
    return this.Zhe = this.GetComponent(5), this.ele = this.GetComponent(4), !0
  }
  OnClear() {
    return this.Zhe = void 0, !(this.ele = void 0)
  }
  Tick(t) {
    StatDefine_1.BATTLESTAT_ENABLED && StatDefine_1.battleStat.FightCameraTick?.Start(), super.Tick(t), StatDefine_1.BATTLESTAT_ENABLED && StatDefine_1.battleStat.FightCameraTick?.Stop()
  }
}
