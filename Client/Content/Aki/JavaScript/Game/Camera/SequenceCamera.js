...
class SequenceCamera extends Entity_1.Entity {
  ...
  OnCreate() {
    return !!this.AddComponent(SequenceCameraDisplayComponent_1.SequenceCameraDisplayComponent) && !!this.AddComponent(SequenceCameraPlayerComponent_1.SequenceCameraPlayerComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
    return this.ele = this.GetComponent(9), this.yme = this.GetComponent(10), !0
  }
  OnClear() {
