...
class CameraAdjustController extends CameraControllerBase_1.CameraControllerBase {
  constructor() {
    super(...arguments), this.CheckLowAdjustPitchMin = 0, this.CheckLowAdjustPitchMax = 0, this.CheckTallAdjustPitchMin = 0, this.CheckTallAdjustPitchMax = 0, this.CheckAdjustNearerRange = 0, this.CheckAdjustNearerYawAngleMin = 0, this.CheckAdjustNearerYawAngleMax = 0, this.CheckAdjustFartherYawAngleMin = 0, this.CheckAdjustFartherYawAngleMax = 0, this.CheckInScreenMinX = 0, this.CheckInScreenMaxX = 0, this.CheckInScreenMinY = 0, this.CheckInScreenMaxY = 0, this.DefaultAdjustFadeTime = -0, this.DefaultAdjustFadeCurve = void 0, this.tle = !1, this.ile = !1, this.ole = 0, this.rle = 0, this.nle = !1, this.sle = 0, this.ale = 0, this.hle = -0, this.lle = Vector_1.Vector.Create()
  }
  Name() {
    return "AdjustController"
  }
  OnInit() {
    this.SetConfigMap(1, "CheckLowAdjustPitchMin"), this.SetConfigMap(2, "CheckLowAdjustPitchMax"), this.SetConfigMap(3, "CheckTallAdjustPitchMin"), this.SetConfigMap(4, "CheckTallAdjustPitchMax"), this.SetConfigMap(5, "CheckAdjustNearerRange"), this.SetConfigMap(6, "CheckAdjustNearerYawAngleMin"), this.SetConfigMap(7, "CheckAdjustNearerYawAngleMax"), this.SetConfigMap(8, "CheckAdjustFartherYawAngleMin"), this.SetConfigMap(9, "CheckAdjustFartherYawAngleMax"), this.SetConfigMap(10, "CheckInScreenMinX"), this.SetConfigMap(11, "CheckInScreenMaxX"), this.SetConfigMap(12, "CheckInScreenMinY"), this.SetConfigMap(13, "CheckInScreenMaxY"), this.SetConfigMap(14, "DefaultAdjustFadeTime"), this.SetCurveConfigMap(14, "DefaultAdjustFadeCurve")
  }
  OnDisable() {
    this.tle && this._le()
  }
