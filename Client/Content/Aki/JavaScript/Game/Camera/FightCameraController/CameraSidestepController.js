...
class CameraSidestepController extends CameraControllerBase_1.CameraControllerBase {
  ...
  UpdateInternal(t) {
    if (!!ModelManager_1.ModelManager.CameraModel.IsEnableSidestepCamera && !!this.Camera.Character && !ModelManager_1.ModelManager.DeadEyeModeModel.IsInDeadEyeMode && !(this.Uce(t), this.Lce <= 0)) {
      this.Ace(t);
      this.Pce(t);
      this.xce(t);
    }
