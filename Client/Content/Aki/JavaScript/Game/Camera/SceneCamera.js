...
class SceneCamera extends Entity_1.Entity {
  ...
  OnCreate() {
    return !!this.AddComponent(SceneCameraDisplayComponent_1.SceneCameraDisplayComponent) && !!this.AddComponent(SceneCameraPlayerComponent_1.SceneCameraPlayerComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
    return this.ele = this.GetComponent(7), this.yme = this.GetComponent(8), !0
  }
  OnClear() {
