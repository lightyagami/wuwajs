...
class CameraUtility {
  static GetSocketLocation(t, a, e, r = undefined) {
    ...
    if (this.khe(s)) {
      if ((t = i).Mesh && a?.toString()) {
        ...
        s.Entity.GetComponent(177).GetCameraPosition(e);
        return;
      }
    }
    if (s.Valid) {
  ...
  static GetCameraDefaultFocusRotator() {
    ...
    if (e?.Valid && e?.Character?.IsValid() && e?.Character?.CharacterActorComponent) {
      if (!(t = e.Character.CharacterActorComponent.Entity.GetComponent(205))?.Valid || t.HasTag(-648310348)) {
        this.cie.Reset();
  ...
  static CharacterMovementBaseIsMoving() {
    ...
    return !!t && t.Mobility === 2 && (!t.GetComponentVelocity().IsNearlyZero(MathUtils_1.MathUtils.KindaSmallNumber) || !!(t = ModelManager_1.ModelManager.SceneInteractionModel.GetEntityByBaseItem(t.GetOwner())?.Entity.GetComponent(139)) && !!t.IsMovingOrTeleporting());
  }
