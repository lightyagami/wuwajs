...
class WidgetCamera extends Entity_1.Entity {
  ...
  OnCreate() {
    return !!this.AddComponent(WidgetCameraBlendComponent_1.WidgetCameraBlendComponent) && !!this.AddComponent(WidgetCameraDisplayComponent_1.WidgetCameraDisplayComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
    return this.ade = this.GetComponent(11), this.ele = this.GetComponent(12), !0
  }
  OnClear() {
