...
class CameraBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static get TmpVector() {
    return this.TmpVectorInternal || (this.TmpVectorInternal = Vector_1.Vector.Create()), this.TmpVectorInternal
  }
  static get TmpQuat() {
    return this.TmpQuatInternal || (this.TmpQuatInternal = Quat_1.Quat.Create()), this.TmpQuatInternal
  }
  static OnPossess(r) {
  ...
  static EnterCameraMode(r, e, t, a) {
    ControllerHolder_1.ControllerHolder.CameraController.EnterCameraMode(r, e, t, a)
  }
  static ExitCameraMode(r, e, t, a) {
    ControllerHolder_1.ControllerHolder.CameraController.ExitCameraMode(r, e, t, a)
  }
  ...
  static ApplyCameraModify(r, e, t, a, o, i, l, n, c, C, u, s, _) {
    CameraUtility_1.CameraUtility.CheckApplyCameraModifyCondition(ModelManager_1.ModelManager.CreatureModel.GetEntityById(u), i, s, (0, puerts_1.$unref)(_)) && ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.ApplyCameraModify(r, e, t, a, i, l, o, n, c, void 0, C)
  }
  static ApplyCameraGuide(r, e, t, a, o, i, l, n, c) {
    CameraBlueprintFunctionLibrary.CacheLookAtVector || (CameraBlueprintFunctionLibrary.CacheLookAtVector = Vector_1.Vector.Create()), CameraBlueprintFunctionLibrary.CacheLookAtVector1 || (CameraBlueprintFunctionLibrary.CacheLookAtVector1 = Vector_1.Vector.Create()), CameraBlueprintFunctionLibrary.CacheLookAtVector.FromUeVector(r);
    let C = void 0;
    i.IsNearlyZero(MathUtils_1.MathUtils.KindaSmallNumber) || (CameraBlueprintFunctionLibrary.CacheLookAtVector1.FromUeVector(i), C = CameraBlueprintFunctionLibrary.CacheLookAtVector1), ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.ApplyCameraGuide(CameraBlueprintFunctionLibrary.CacheLookAtVector, e, t, a, o, C, 0 === l ? void 0 : l, n, c)
  }
  static ExitCameraGuide() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Camera", 57, "[CameraLookAt] ExitCameraGuide"), ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.ExitCameraGuide()
  }
  static EnterCameraExplore(r, e, t, a, o, i, l) {
    e = UE.KismetMathLibrary.Conv_VectorToVectorDouble(e), t = UE.KismetMathLibrary.Conv_VectorToVectorDouble(t);
    ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.EnterCameraExplore(r, e, t, a, o, i, l)
  }
  ...
  static SetWidgetCameraBlendParams(r, e, t, a, o, i, l, n, c, C, u) {
    l = UE.KismetMathLibrary.Conv_VectorToVectorDouble(l);
    ControllerHolder_1.ControllerHolder.CameraController.WidgetCamera.BlendComponent.SetBlendParams(r, e, t, a, o, i, l, n, c, C, u)
  }
  static PlayCameraOrbital(r, e, t, a, o) {
    ControllerHolder_1.ControllerHolder.CameraController.OrbitalCamera.PlayerComponent.PlayCameraOrbital(r, e, t, a, o)
  }
  ...
  static ReloadCameraConfig() {
    ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.LoadConfig(), ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.CameraConfigController.LoadConfig()
  }
  ...
  static IsRoleOnCameraRight() {
    ...
    return e.CameraRotation.Quaternion(CameraBlueprintFunctionLibrary.TmpQuat), CameraBlueprintFunctionLibrary.TmpQuat.RotateVector(Vector_1.Vector.RightVectorProxy, CameraBlueprintFunctionLibrary.TmpVector), 0 < r.ActorLocationProxy.DotProduct(CameraBlueprintFunctionLibrary.TmpVector) - e.CameraLocation.DotProduct(CameraBlueprintFunctionLibrary.TmpVector)
  }
  ...
  static SetXRayState(r) {
    ...
    e && (e.IsPlayerXRayEnable = r, Log_1.Log.CheckInfo()) && Log_1.Log.Info("Camera", 57, "CameraBlueprintFunctionLibrary SetXRayState", ["isEnable", r])
  }
  static SetCameraGravityMode(r, e) {
    var t = ModelManager_1.ModelManager?.CameraModel?.FightCamera?.LogicComponent;
    t?.Valid && (CameraBlueprintFunctionLibrary.TmpVector.DeepCopy(e ?? Vector_1.Vector.DownVectorProxy), t.SetCameraGravityMode(r, CameraBlueprintFunctionLibrary.TmpVector))
  }
  ...
  static GetCameraGravityDirect() {
    var r = ModelManager_1.ModelManager?.CameraModel?.FightCamera?.LogicComponent;
    return r?.Valid ? r.GravityDirect.ToUeVector() : Vector_1.Vector.DownVectorDouble
  }
  ...
  static GetCameraRotationInGravity() {
    var r = ModelManager_1.ModelManager?.CameraModel?.FightCamera?.LogicComponent;
    return r?.Valid ? r.CameraRotationInGravity.ToUeRotator() : Rotator_1.Rotator.ZeroRotator
  }
  static GetPlayerLocationInGravity() {
    var r = ModelManager_1.ModelManager?.CameraModel?.FightCamera?.LogicComponent;
    return r?.Valid ? r.PlayerLocationInGravity.ToUeVector() : Vector_1.Vector.ZeroVectorDouble
  }
  static GetPlayerRotatorInGravity() {
    var r = ModelManager_1.ModelManager?.CameraModel?.FightCamera?.LogicComponent;
    return r?.Valid ? r.PlayerRotatorInGravity.ToUeRotator() : Rotator_1.Rotator.ZeroRotator
  }
}
CameraBlueprintFunctionLibrary.CacheLookAtVector = void 0, CameraBlueprintFunctionLibrary.CacheLookAtVector1 = void 0, CameraBlueprintFunctionLibrary.TmpVectorInternal = void 0, CameraBlueprintFunctionLibrary.TmpQuatInternal = void 0, exports.default = CameraBlueprintFunctionLibrary;
