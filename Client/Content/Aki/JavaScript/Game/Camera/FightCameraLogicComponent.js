"use strict";
var FightCameraLogicComponent_1, __decorate = this && this.__decorate || function(t, i, s, h) {
  var e, a = arguments.length,
    r = a < 3 ? i : null === h ? h = Object.getOwnPropertyDescriptor(i, s) : h;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, i, s, h);
  else
    for (var o = t.length - 1; 0 <= o; o--)(e = t[o]) && (r = (a < 3 ? e(r) : 3 < a ? e(i, s, r) : e(i, s)) || r);
  return 3 < a && r && Object.defineProperty(i, s, r), r
};
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.FightCameraLogicComponent = exports.VirtualCamera = exports.CLEAN_TARGET_SPEED_THRESHOLD = void 0;
const puerts_1 = require("puerts"),
  ...
  CONFIG_PATH = "/Game/Aki/Data/Camera/DA_FightcameraConfig.DA_FightCameraConfig",
  MOBILE_CONFIG_PATH = "/Game/Aki/Data/Camera/DA_FightCameraConfig_Mobile.DA_FightCameraConfig_Mobile",
  CAMERA_LOCATION_NEARLY_DISTANCE = 1,
  LOOK_AT_FORWARD_DISTANCE = 1e3,
  RESET_FOCUS_ROTATION_TIME = .2,
  MAX_TARGET_HAS_BLOCK_TIME = 1e3,
  SHOW_TARGET_VALID_TIME = 100,
  BREAK_BLEND_OUT_TIME = .2,
  LANDSCAPE_LOD_SCALE_FOV = 80,
  CAMER_TARGET_BUFFER_TIME = .25,
  MAX_DIAGNOSTIC_OUTPUT_TIME = 5,
  VALID_DISGNOSTIC_DISTANCE_SQR = 900,
  vehicleWaterFall = 401464757,
  MAX_NAN_OUTPUT_TIME = 5,
  POINT_SIZE = 20,
  LINELEHGTH = 2e3,
  LINE_SIZE = 5,
  CIRCLE_SEGMENT = 48,
...
let FightCameraLogicComponent = FightCameraLogicComponent_1 = class FightCameraLogicComponent extends EntityComponent_1.EntityComponent {
  ...
  GetArmLengthWithSettingAndZoom(t, i = !0) {
    ...
    return i ? MathUtils_1.MathUtils.Clamp(s, t.MinArmLength, t.MaxArmLength) : s
  }
  ...
  SetConfigs(t, i, s, h) {
    if (this.CameraArmLocationSocketName = h, t) {
      ...
      for (var [r, o] of this.$) void 0 === this[o] && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 57, "CameraDefault缺少配置", ["tagName", s], ["key", r], ["value", o]), this.f1e(o, 1));
      (0 <= this.ArmCenterForwardEdgeMin || 0 <= this.ArmCenterRightEdgeMin || 0 <= this.ArmCenterUpEdgeMin || this.ArmCenterForwardEdgeMax <= 0 || this.ArmCenterRightEdgeMax <= 0 || this.ArmCenterUpEdgeMax <= 0) && Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 57, "CameraDefault配置上下界有误", ["tagName", s], ["ForwardMin", this.ArmCenterForwardEdgeMin], ["RightMin", this.ArmCenterRightEdgeMin], ["UpMin", this.ArmCenterUpEdgeMin], ["ForwardMax", this.ArmCenterForwardEdgeMax], ["RightMax", this.ArmCenterRightEdgeMax], ["UpMax", this.ArmCenterUpEdgeMax])
    }
    if (i) {
      for (var [n, l] of i) {
        n = this.C1e.get(n);
  ...
  ApplyDepthOfField(t, i, s, h) {
    ...
    e && (void 0 !== t && (e.bOverride_DepthOfFieldFstop = !0, e.DepthOfFieldFstop = t), void 0 !== i ? (e.bOverride_DepthOfFieldFocalDistance = !0, e.DepthOfFieldFocalDistance = i) : (e.bOverride_DepthOfFieldFocalDistance = !0, this.LPr = !0), void 0 !== s && (e.bOverride_DepthOfFieldDepthBlurAmount = !0, e.DepthOfFieldDepthBlurAmount = s), void 0 !== h) && (e.bOverride_DepthOfFieldDepthBlurRadius = !0, e.DepthOfFieldDepthBlurRadius = h)
  }
  ApplyRadialBlur(t, i, s, h, e, a) {
    var r = this.CameraActor?.CameraComponent?.PostProcessSettings;
    r && (void 0 !== t ? (r.bOverride_KuroRadialBlurIntensity = !0, r.KuroRadialBlurIntensity = t) : r.bOverride_KuroRadialBlurIntensity = !1, void 0 !== i ? (r.bOverride_KuroRadialBlurCenter = !0, r.KuroRadialBlurCenter = i) : r.bOverride_KuroRadialBlurCenter = !1, void 0 !== s ? (r.bOverride_KuroRadialBlurRadius = !0, r.KuroRadialBlurRadius = s) : r.bOverride_KuroRadialBlurRadius = !1, void 0 !== h ? (r.bOverride_KuroRadialBlurHardness = !0, r.KuroRadialBlurHardness = h) : r.bOverride_KuroRadialBlurHardness = !1, void 0 !== e ? (r.bOverride_KuroRadialBlurPassNumber = !0, r.KuroRadialBlurPassNumber = e) : r.bOverride_KuroRadialBlurPassNumber = !1, void 0 !== a ? (r.bOverride_KuroRadialBlurSampleNumber = !0, r.KuroRadialBlurSampleNumber = a) : r.bOverride_KuroRadialBlurSampleNumber = !1)
  }
  ExitDepthOfField() {
    var t = this.CameraActor?.CameraComponent?.PostProcessSettings;
    t && (t.bOverride_DepthOfFieldFstop = !1, t.bOverride_DepthOfFieldFocalDistance = !1, t.bOverride_DepthOfFieldDepthBlurAmount = !1, t.bOverride_DepthOfFieldDepthBlurRadius = !1), this.LPr = !1
  }
  ExitRadialBlur() {
    var t = this.CameraActor?.CameraComponent?.PostProcessSettings;
    t && (t.bOverride_KuroRadialBlurIntensity = !1, t.bOverride_KuroRadialBlurCenter = !1, t.bOverride_KuroRadialBlurRadius = !1, t.bOverride_KuroRadialBlurHardness = !1, t.bOverride_KuroRadialBlurPassNumber = !1, t.bOverride_KuroRadialBlurSampleNumber = !1)
  }
  ...
  EnterSequenceDialogue(t, i = !1, s = void 0, h = void 0) {
    this.cPr && this.CameraDialogueController.EnterSequenceDialogue(t, i, s, h)
  }
  ...
  SetRotation(t) {
    !t || t.ContainsNaN() ? Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 57, "rotation is invalid: ", ["rotation", t]) : (this.DesiredCamera.ArmRotation.DeepCopy(t), this.CurrentCamera.ArmRotation.DeepCopy(t), this.SetRotationInternal(t), this.CurrentCamera.ArmRotation.Quaternion().RotateVector(Vector_1.Vector.ForwardVectorProxy, this.CameraForward))
  }
  SetPawn(t) {
    t instanceof TsBaseCharacter_1.default ? this.SetCharacter(t) : t?.IsValid() || this.SetCharacter(void 0)
  }
  SetCharacter(t) {
    ModelManager_1.ModelManager.CameraModel?.FirstPersonEnabled && this.Character !== t && (this.Character?.CharRenderingComponent?.SetDitherApplyAll(), t?.CharRenderingComponent?.SetDitherApplyHeadsOnly()), this.CharacterEntityHandle?.Valid && (EventSystem_1.EventSystem.RemoveWithTarget(this.CharacterEntityHandle.Entity, EventDefine_1.EEventName.CharOnUnifiedMoveStateChanged, this.hUe), EventSystem_1.EventSystem.RemoveWithTarget(this.CharacterEntityHandle.Entity, EventDefine_1.EEventName.CharGravityDirectChanged, this.Udc)), this.mPr?.Valid && this.mPr.RemoveTagAddOrRemoveListener(vehicleWaterFall, this.UWi), (this.Character = t) ? (this.cPr = this.Character?.IsValid() ?? !1, this.CharacterEntityHandle = ModelManager_1.ModelManager.CreatureModel.GetEntityById(this.Character.EntityId), this.CharacterInputComponent = this.CharacterEntityHandle?.Entity?.GetComponent(62), this.CharacterController = this.CharacterInputComponent?.CharacterController, this.mPr = this.CharacterEntityHandle?.Entity?.GetComponent(205), this.CharacterDriveVehicleComponent = this.CharacterEntityHandle?.Entity?.GetComponent(229), this.Character.SetDitherEffect(1, 1), this.CameraCollision.SetCharacter(t), this.CameraRotationZone.SetCharacter(this.CharacterEntityHandle), t = this.CharacterEntityHandle.Entity.GetComponent(0).GetRoleConfig(), this.SPr = t.CameraFloatHeight, (this.ContainsTag(1674960297) || this.GetUsingGoBattle()) && this.ResetArmLocation(!0, this.CameraLocationFadeTime), this.Ddc(), EventSystem_1.EventSystem.AddWithTarget(this.CharacterEntityHandle.Entity, EventDefine_1.EEventName.CharOnUnifiedMoveStateChanged, this.hUe), EventSystem_1.EventSystem.AddWithTarget(this.CharacterEntityHandle.Entity, EventDefine_1.EEventName.CharGravityDirectChanged, this.Udc), this.mPr?.Valid && this.mPr.AddTagAddOrRemoveListener(vehicleWaterFall, this.UWi)) : (this.cPr = !1, this.CharacterEntityHandle = void 0, this.CharacterInputComponent = void 0, this.mPr = void 0, this.CharacterDriveVehicleComponent = void 0, this.CharacterController = void 0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CameraCharacterChanged, this.CharacterEntityHandle)
  }
  SetFollowShooter(t) {
    this.FollowShooterEntityHandle = t, this.FollowShooterEntityHandle ? (this.gDn = this.FollowShooterEntityHandle?.Valid ?? !1, this.FollowShooterTagComponentInternal = this.FollowShooterEntityHandle?.Entity?.GetComponent(205)) : (this.gDn = !1, this.FollowShooterTagComponentInternal = void 0)
  }
  bPr(t) {
    CameraUtility_1.CameraUtility.GetSocketLocation(void 0, this.TargetSocketName, t, this.TargetEntity)
  }
  ResetArmLengthAndRotation(t) {
    this.cPr && (this.DesiredCamera.ArmLength = this.ArmLength, this.SetRotation(CameraUtility_1.CameraUtility.GetCameraDefaultFocusUeRotator().op_Addition(t)))
  }
  ResetInitialCameraRotation() {
    CameraUtility_1.CameraUtility.SetPitchInGravity(this.CameraRotation, this.InitialCameraPitch, this.CameraRotation), this.SetRotation(this.CameraRotation.ToUeRotator())
  }
  GetCharacter() {
    return this.Character
  }
  CopyVirtualCamera(t, i, s = !1) {
    t.ArmLength = i.ArmLength, t.MinArmLength = i.MinArmLength, t.MaxArmLength = i.MaxArmLength, t.ArmLength < MathUtils_1.MathUtils.SmallNumber && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 6, "ArmLength is Zero"), t.ArmLength = 1), t.MinArmLength < MathUtils_1.MathUtils.SmallNumber && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 6, "MinArmLength is Zero"), t.MinArmLength = 1), t.MaxArmLength < MathUtils_1.MathUtils.SmallNumber && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 6, "MaxArmLength is Zero"), t.MaxArmLength = 1), s && this.Character && this.TPn(i.YawLimitMin, i.YawLimitMax) ? (s = Math.abs(MathUtils_1.MathUtils.WrapAngle(i.ArmRotation.Yaw - this.PlayerRotatorInGravity.Yaw)), t.YawLimitMin = -Math.abs(s), t.YawLimitMax = Math.abs(s)) : (t.YawLimitMin = i.YawLimitMin, t.YawLimitMax = i.YawLimitMax), t.PitchLimitMin = CameraUtility_1.CameraUtility.GetValidPitchAngle(i.PitchLimitMin, !0), t.PitchLimitMax = CameraUtility_1.CameraUtility.GetValidPitchAngle(i.PitchLimitMax, !1), t.LookDownOffsetZ = i.LookDownOffsetZ, t.LookUpOffsetZ = i.LookUpOffsetZ, t.WorldYawMin = i.WorldYawMin, t.WorldYawMax = i.WorldYawMax, t.CameraOffsetFloatUpMin = i.CameraOffsetFloatUpMin, t.CameraOffsetFloatUpMax = i.CameraOffsetFloatUpMax, t.ArmOffset.DeepCopy(i.ArmOffset), t.CameraOffset.DeepCopy(i.CameraOffset), t.ArmLocation.DeepCopy(i.ArmLocation), t.ArmRotation.DeepCopy(i.ArmRotation), t.Fov = i.Fov, t.Fov < MathUtils_1.MathUtils.SmallNumber && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 6, "Fov is Zero"), t.Fov = 1), t.ZoomModifier = i.ZoomModifier, t.ZoomModifier < MathUtils_1.MathUtils.SmallNumber && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 57, "ZoomModifier is Zero"), t.ZoomModifier = 1)
  }
  StartFade(t, i, s, h, e, a, r) {
    this.CurrentCamera.ArmRotation.Pitch = MathUtils_1.MathUtils.StandardizingPitch(this.CurrentCamera.ArmRotation.Pitch), this.CopyVirtualCamera(this.LastCamera, this.CurrentCamera, !0), this.EUo = s, this.pPr = h, this.vPr = e, this.MPr = a, this.Fading = !0, this.pUo = t, this.vUo = 0, this.MUo = i, this.IsUniqueFade = r, this.yP_ = this.SP_, 0 < this.pUo && !this.MUo && (Log_1.Log.CheckError() && Log_1.Log.Error("Camera", 6, "No Fade Curve."), this.MUo = CurveUtils_1.CurveUtils.CreateCurve(0))
  }
  ResetArmLocation(t, i = 0) {
    t && (this.gPr = !0, this.fPr = i, this.ArmLocationFadeElapseTime = 0)
  }
  SetArmLocation(t) {
    this.IsModifiedArmLocation || (this.DesiredCamera.ArmLocation.DeepCopy(t), this.IsModifiedArmLocation = !0)
  }
  OnStart() {
    this.LoadConfig(), this.CameraCollision.InitTraceElements(), this.CurrentCollisionSize = 0, this.pTn = -1, this.SetCameraGravityMode(2), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.BeforeTeleportComplete, this.cFl), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.TeleportComplete, this.Ilt), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldDone, this.nye), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnSequenceCameraStatus, this.BPr), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.CharPossessed, this.PPr), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.CharUnpossessed, this.xPr), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnPlayerFollowerCreate, this.mDn), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnPlayerFollowerDestroy, this.dDn);
    for (const t of this.EPr) t.OnStart();
    return !0
  }
  OnEnd() {
    this.CameraCollision.Clear(), this.CameraRotationZone.Clear(), this.SettlementCamera.Clear(), this.CameraConfig = void 0, this.ele = void 0, EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.BeforeTeleportComplete, this.cFl), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TeleportComplete, this.Ilt), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDone, this.nye), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnSequenceCameraStatus, this.BPr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.CharPossessed, this.PPr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.CharUnpossessed, this.xPr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnPlayerFollowerCreate, this.mDn), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnPlayerFollowerDestroy, this.dDn);
  ...
  OnAfterTick(t) {
    this.ZJ1(), this.eZ1(), this.cPr = this.Character?.IsValid() ?? !1, this.CameraActor?.IsValid() && this.cPr && (0 !== ModelManager_1.ModelManager.CameraModel.CameraMode ? (ControllerHolder_1.ControllerHolder.PhotographController.IsOpenPhotograph() || this.Character.SetDitherEffect(1, 1), this.CameraCollision?.ResetAllNpcDither()) : (t = t * MathUtils_1.MathUtils.MillisecondToSecond, this.qPr(), this.Bdc(), this.RefreshPlayerLocation(t), this.kdc(), FightCameraLogicComponent_1.Uza.Start(), this.GPr(), this.rl1(t), this.ol1(t), this.nl1(t), FightCameraLogicComponent_1.Uza.Stop(), this.OPr() && (this.DesiredCamera.ArmLength = MathUtils_1.MathUtils.Clamp(this.DesiredCamera.ArmLength, this.DesiredCamera.MinArmLength, this.DesiredCamera.MaxArmLength)), this.kPr(t), this.DUo(), this.LUo(t), this.FPr(t), this.RUo(t), this.VPr(t), FightCameraLogicComponent_1.Oza.Start(), this.vTn = this.CameraActor.CameraComponent.FieldOfView, this.CameraActor.CameraComponent.FieldOfView = this.CurrentCamera.Fov, this.HPr(), this.jPr(), this.MTn(), FightCameraLogicComponent_1.Oza.Stop(), this.CharacterController?.SetControlRotation(this.CurrentCamera.ArmRotation.ToUeRotator()), this.$Zh(), this.tZ1()))
  }
  rl1(t) {
    for (const i of this.tl1) i.Update(t)
  }
  nl1(t) {
    for (const i of this.il1) i.Update(t)
  }
  OPr() {
  ...
  GPr() {
    this.IsModifiedArmLocation = !1, this.IsModifiedArmLength = !1, this.IsModifiedArmOffset = !1, this.IsModifiedZoomModifier = !1, this.IsModifiedArmRotationYaw = !1, this.IsModifiedArmRotationPitch = !1, this.IsModifiedArmRotationRoll = !1, this.IsModifiedCameraOffset = !1, this.IsModifiedFov = !1
  }
  XPr(t, i, s, h, e, a, r, o) {
    var n = t - i,
      r = Math.abs(n) / ((r - a) / 2),
      a = MathUtils_1.MathUtils.Lerp(h, e, o.GetCurrentValue(r)) * s;
    return n < 0 ? MathUtils_1.MathUtils.Clamp(t + a, t, i) : MathUtils_1.MathUtils.Clamp(t - a, i, t)
  }
  $Pr(t, i, s, h, e, a, r, o) {
    var n = t - i;
    if (n < 0) {
  ...
  S1h(t, i, s, h, e, a, r, o) {
    var n = t - i,
      h = MathUtils_1.MathUtils.Lerp(h, e, o.GetCurrentValue(Math.abs(n) / Math.abs(a))) * s;
    return this.CameraRotationZone.IsHasPitchHorizontalMovement() ? this.CameraRotationZone.IsPitchRollback() ? 0 < n ? t - MathUtils_1.MathUtils.Clamp(h, 0, n) : t + MathUtils_1.MathUtils.Clamp(h, 0, -n) : t : this.CameraRotationZone.IsHasPitchUpMovement() ? MathUtils_1.MathUtils.Clamp(t - h, i + a, i + r) : MathUtils_1.MathUtils.Clamp(t + h, i + a, i + r)
  }
  a1l(t, i, s, h, e, a, r, o, n, l) {
    ...
    a = this.PlayerRotatorInGravity.Yaw, C = CameraUtility_1.CameraUtility.GetYawInGravity(this.CameraRotation), C = MathUtils_1.MathUtils.WrapAngle(C - a);
    if (_.Y < 0) {
      if (C < 0) return t;
  ...
  FPr(i) {
    ...
    var i = this.CurrentCamera.YawLimitMin,
      ...
      e = (h - i) % 360;
    if (MathUtils_1.MathUtils.IsNearlyZero(e) || MathUtils_1.MathUtils.IsNearlyEqual(e, 360)) this.IsInNormalGravityMode() ? this.DesiredCamera.ArmRotation.Yaw = MathUtils_1.MathUtils.Clamp(MathUtils_1.MathUtils.WrapAngle(this.DesiredCamera.ArmRotation.Yaw), this.CurrentCamera.WorldYawMin, this.CurrentCamera.WorldYawMax) : (e = CameraUtility_1.CameraUtility.GetYawInGravity(this.DesiredCamera.ArmRotation), e = MathUtils_1.MathUtils.Clamp(e, this.CurrentCamera.WorldYawMin, this.CurrentCamera.WorldYawMax), CameraUtility_1.CameraUtility.SetYawInGravity(this.DesiredCamera.ArmRotation, e, this.DesiredCamera.ArmRotation));
    else {
      e = this.PlayerRotatorInGravity.Yaw, i = MathUtils_1.MathUtils.WrapAngle(e + i), e = MathUtils_1.MathUtils.WrapAngle(e + h), h = CameraUtility_1.CameraUtility.GetYawInGravity(this.DesiredCamera.ArmRotation);
      let t = 0;
      if (i < e && (e < h || h < i)) t = MathUtils_1.MathUtils.WrapAngle(.5 * (i + e)), s = MathUtils_1.MathUtils.WrapAngle(h < t ? i : e);
      else {
        if (!(e < i && e < h && h < i)) return;
        t = MathUtils_1.MathUtils.WrapAngle(.5 * (e + i)), s = MathUtils_1.MathUtils.WrapAngle(h > t ? i : e)
      }
  ...
  zPr(t, i) {
    ...
    if (i) this.bPr(this.TargetLocation);
      ...
      if (i?.Valid) {
        ...
        if (!this.dPr?.HasAnyTag(CharacterLockOnComponent_1.lockOnEnhancedTags) && t.SpeedUpCleanTarget()) return !0
      }
      i = this.CharacterEntityHandle.Entity.GetComponent(62);
      if (i?.Valid && this.CameraFocusController.ShouldSoftUnlock()) return !0;
      if (this.bPr(this.TargetLocation), this.IsTargetLocationValid && t.TraceDetectBlock(h.ActorLocationProxy, this.TargetLocation, s.Owner))
        if (this.CPr) {
  ...
  H7a() {
    let t = void 0;
    var i;
    t = this.IsInNormalGravityMode() ? Vector_1.Vector.UpVectorProxy : this.GravityUp, this.k7a.Equals(t) && this.N7a.Equals(this.CameraForward) || (this.k7a.DeepCopy(t), this.N7a.DeepCopy(this.CameraForward), this.TempVector.DeepCopy(this.CameraForward), (i = this.TempVector.DotProduct(t)) > 1 - MathUtils_1.MathUtils.KindaSmallNumber ? (this.CameraRotation.Quaternion(this.TempQuat), this.TempQuat.RotateVector(Vector_1.Vector.DownVectorProxy, this.TempVector)) : -i > 1 - MathUtils_1.MathUtils.KindaSmallNumber && (this.CameraRotation.Quaternion(this.TempQuat), this.TempQuat.RotateVector(Vector_1.Vector.UpVectorProxy, this.TempVector)), MathUtils_1.MathUtils.LookRotationUpFirst(this.TempVector, t, this.F7a), this.F7a.Inverse(this.V7a))
  }
  SetInputEnable(t, i) {
    this.CameraInputController.SetInputEnable(t, i)
  }
  Bdc() {
    this.f6c() || this.PlayerRotator.FromUeRotator(this.Character.CharacterActorComponent.ActorRotationProxy), CameraUtility_1.CameraUtility.GetRotatorInGravity(this.PlayerRotator, this.PlayerRotatorInGravity)
  }
  RefreshPlayerLocation(t) {
    this.Q6_(t) || (this.j$e(this.PlayerLocation), this.ContainsTag(-648310348) && (t = this.CharacterEntityHandle?.Entity.GetComponent(0)) && (t = ModelManager_1.ModelManager.CreatureModel.GetEntityId(t.GetSummonerId()), t = EntitySystem_1.EntitySystem.GetComponent(t, 1)) && this.CameraCollision.TraceCheckPlayerLocation(t.ActorLocationProxy, this.PlayerLocation, this.PlayerLocation))
  }
  kdc() {
    CameraUtility_1.CameraUtility.GetVectorInGravity(this.PlayerLocation, this.PlayerLocationInGravity)
  }
  j$e(t) {
    FNameUtil_1.FNameUtil.IsEmpty(this.CameraArmLocationSocketName) ? (this.CharacterEntityHandle?.Entity.GetComponent(177).GetCameraPosition(t), this.Character?.Mesh && (this.TempVector.FromUeVector(this.Character.Mesh.D_GetSocketLocation(CharacterNameDefines_1.CharacterNameDefines.ROOT)), t.AdditionEqual(this.TempVector), this.TempVector.FromUeVector(this.Character.Mesh.D_K2_GetComponentLocation()), t.SubtractionEqual(this.TempVector))) : CameraUtility_1.CameraUtility.GetSocketLocation(void 0, this.CameraArmLocationSocketName, t, this.CharacterEntityHandle)
  }
  GetCameraTargetRotator(t) {
    this.CharacterDriveVehicleComponent?.IsOnVehicle && this.VehicleActorComponent?.Valid ? t.DeepCopy(this.VehicleActorComponent.ActorRotationProxy) : t.DeepCopy(this.PlayerRotator)
  }
  CheckPositionInScreen(t, i, s, h, e) {
    var a = Global_1.Global.CharacterController;
    return !!UE.GameplayStatics.D_ProjectWorldToScreen(a, t.ToUeVector(), this.fii, !1) && (a = (0, puerts_1.$unref)(this.fii), this.GetScreenPositionIsInRange(a, i, s, h, e))
  }
  ...
  AdjustPitch(t) {
    var i = this.Character.CharacterActorComponent,
      t = (this.TempVector.DeepCopy(t), GravityUtils_1.GravityUtils.ConvertToPlanarVectorForActor(i, this.TempVector)),
  ...
  GetUsingGoBattle() {
    return !!this.cPr && this.CharacterEntityHandle.Entity.GetComponent(93).GoBattleSkill
  }
  TargetContainsTag(t) {
  ...
  SetRotationInternal(t) {
    this.CameraRotation.DeepCopy(t), this.IsInNormalGravityMode() ? this.CameraRotationInGravity.DeepCopy(this.CameraRotation) : GravityUtils_1.GravityUtils.GetRotatorInGravity(this.CameraRotation, this.GravityInverseQuat, this.CameraRotationInGravity), this.cPr && this.CharacterController?.SetControlRotation(this.CameraRotation.ToUeRotator())
  }
  SetIsDitherEffectEnable(t) {
    this.IPr = t
  }
  HPr() {
    if (this.cPr && this.Character.CharacterActorComponent?.Active && 1 !== ModelManager_1.ModelManager.CameraModel.CameraMode && !this.mPr?.HasTag(-2100129479) && this.IPr) {
      this.j$e(this.PlayerLocationForDither);
      var s = Vector_1.Vector.DistSquared(this.PlayerLocationForDither, this.CameraLocation);
      let t = 1;
      s < this.yPn && (t = MathUtils_1.MathUtils.RangeClamp(Math.sqrt(s), this.StartHideDistance, this.CompleteHideDistance, this.StartDitherValue, .01));
      s = this.GetCameraPitchInGravity();
      let i = 1;
      s > this.StartHidePitch && (i = MathUtils_1.MathUtils.RangeClamp(s, this.StartHidePitch, this.CompleteHidePitch, this.StartDitherValue, .01));
      s = Math.min(t, i);
  ...
  ResetFocus() {
    ...
    t.ActorForwardProxy.Multiply(LOOK_AT_FORWARD_DISTANCE, this.DPr), this.DPr.AdditionEqual(t.ActorLocationProxy), this.PlayCameraRotatorWithCurve(t.ActorLocationProxy, this.DPr, this.RPr, RESET_FOCUS_ROTATION_TIME)
  }
  ResetCameraInput() {
    this.CameraInputController.ResetCameraInput()
  }
  EnterSpecialGameplayCamera(t) {
    return this.CameraSpecialGameplayController.EnterSpecialGameplayController(t), this.CameraSpecialGameplayController.CameraActor
  }
  ...
  RestoreCameraFromAdjust(t, i = void 0) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Camera", 45, "Adjust相机恢复"), this.CameraConfigController.DisableHookConfig(t), RenderUtil_1.RenderUtil.EnableVelocityScreenSizeCull(), this.ExitCameraSpline(), this.ExitDepthOfField(), ControllerHolder_1.ControllerHolder.CameraController.SequenceCamera.PlayerComponent.SetPlayCameraSequenceEnabled(!0), ControllerHolder_1.ControllerHolder.CameraController.SceneCamera.PlayerComponent.ExitFixSceneSubCamera(i), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SetCameraAimVisible, !1, 0), ModelManager_1.ModelManager.InteractionModel.RecoverInteractFromLock(), ControllerHolder_1.ControllerHolder.CameraController.SetFirstPersonEnable(!1)
  }
  GetCameraPitchInGravity() {
    return this.IsInNormalGravityMode() ? MathUtils_1.MathUtils.WrapAngle(this.CameraRotation.Pitch) : Math.asin(this.CameraForward.DotProduct(this.GravityUp)) * MathUtils_1.MathUtils.RadToDeg
  }
  ClearRollInGravity(t) {
    this.IsInNormalGravityMode() ? t.Roll = 0 : (t.Quaternion(this.TempQuat), this.TempQuat.RotateVector(Vector_1.Vector.ForwardVectorProxy, this.TempVector), MathUtils_1.MathUtils.LookRotationForwardFirst(this.TempVector, this.GravityUp, this.TempQuat), this.TempQuat.Rotator(t))
  }
  ZJ1() {
    var t, i;
    !this.KJ1 || (t = this.CameraLocation, i = this.PlayerLocation, (t = Vector_1.Vector.DistSquared(t, i) * MathUtils_1.MathUtils.KindaSmallNumber) <= VALID_DISGNOSTIC_DISTANCE_SQR) || (i = Math.floor(Math.log10(t)), this.XJ1.has(i) && this.XJ1.get(i) >= MAX_DIAGNOSTIC_OUTPUT_TIME) ? this.YJ1 = !1 : (this.zJ1 = i, this.JJ1 = t, this.YJ1 = !0)
  }
  eZ1() {
    var t, i, s, h, e, a;
    this.YJ1 && (t = this.CameraLocation, i = this.PlayerLocation, s = this.Character.CharacterActorComponent.ActorLocationProxy, h = ModelManager_1.ModelManager.GameModeModel.LoadingPhase, e = GlobalData_1.GlobalData.World?.GetName(), a = this.zJ1, this.XJ1.has(a) ? this.XJ1.set(a, this.XJ1.get(a) + 1) : this.XJ1.set(a, 1), Log_1.Log.CheckInfo()) && Log_1.Log.Info("Camera", 57, "[DiagnosticCameraDistanceBeforeTick]", ["exp", a], ["count", this.XJ1.get(a)], ["isValidDistance", !1], ["distanceSquared(m)", this.JJ1.toFixed(2)], ["realPlayerLocation", s.ToString()], ["playerLocation", i.ToString()], ["cameraLocation", t.ToString()], ["gravityDirect", this.GravityDirect.ToString()], ["loadingPhase", h], ["worldName", e], ["cameraMode", ModelManager_1.ModelManager.CameraModel.CameraMode], ["maxArmLength", this.MaxArmLength], ["modify", this.CameraModifyController.ModifyMontage?.GetName()])
  }
  tZ1() {
    var t, i, s, h, e, a, r;
    this.YJ1 && (t = this.CameraLocation, i = this.PlayerLocation, s = this.Character.CharacterActorComponent.ActorLocationProxy, h = ModelManager_1.ModelManager.GameModeModel.LoadingPhase, e = GlobalData_1.GlobalData.World?.GetName(), a = this.zJ1, r = Vector_1.Vector.DistSquared(t, i) * MathUtils_1.MathUtils.KindaSmallNumber, Log_1.Log.CheckInfo()) && Log_1.Log.Info("Camera", 57, "[DiagnosticCameraDistanceAfterTick ]", ["exp", a], ["count", this.XJ1.get(a)], ["isValidDistance ", r <= VALID_DISGNOSTIC_DISTANCE_SQR], ["distanceSquared(m)", this.JJ1.toFixed(2)], ["realPlayerLocation", s.ToString()], ["playerLocation", i.ToString()], ["cameraLocation", t.ToString()], ["gravityDirect", this.GravityDirect.ToString()], ["loadingPhase", h], ["worldName", e], ["cameraMode", ModelManager_1.ModelManager.CameraModel.CameraMode], ["maxArmLength", this.MaxArmLength], ["modify", this.CameraModifyController.ModifyMontage?.GetName()])
  }
  f6c() {
  ...
  Q6_(t) {
    if (!(this.CharacterDriveVehicleComponent?.Valid && this.CharacterDriveVehicleComponent?.IsOnVehicle && this.VehicleActorComponent?.Valid && this.GongduolaPerformComponent?.Valid)) return !1;
    if (!this.W6_) {
      if (this.ContainsTag(vehicleWaterFall) && this.GongduolaPerformComponent.IsWaterfallDynamicGravity) {
        const i = this.TempVector4;
        return this.VehicleActorComponent.ActorQuatProxy.RotateVector(this.PlayerVehicleDeltaLocation, i), this.VehicleAnimationComponent.GetCameraPosition(this.PlayerLocation), this.PlayerLocation.AdditionEqual(i), !0
      }
      return !1
    }
    const i = this.TempVector4;
    ...
    var s = this.TempVector2,
      h = this.TempVector3,
      t = (this.ContainsTag(vehicleWaterFall) && this.GongduolaPerformComponent.IsWaterfallDynamicGravity ? (this.j$e(s), this.VehicleAnimationComponent.GetCameraPosition(h), h.AdditionEqual(i)) : (this.VehicleAnimationComponent.GetCameraPosition(s), s.AdditionEqual(i), this.j$e(h)), this.$6_ += t, MathUtils_1.MathUtils.Clamp(this.$6_ / this.H6_, 0, 1));
    return this.W6_ = t < 1, Vector_1.Vector.Lerp(s, h, t, this.PlayerLocation), !0
  }
  $Zh() {
    var t, i;
    !(this.CharacterEntityHandle?.Entity?.GetComponent(175)?.MoveState === CharacterUnifiedStateTypes_1.ECharMoveState.Soar) || this.CharacterEntityHandle?.Entity?.GetComponent(193)?.HasTag(-53663352) || (this.QZh || (this.QZh = ResourceSystem_1.ResourceSystem.GetLoadedAsset(CharacterGlideComponent_1.SOAR_CAMERA_SHAKE_CURVE_PATH, UE.CurveFloat)), t = this.Character?.CharacterActorComponent?.ActorVelocityProxy.Size() ?? 0, (t = this.QZh.GetFloatValue(t)) <= 0) ? this.KZh && (Global_1.Global.CharacterCameraManager.StopCameraShake(this.KZh), this.KZh = void 0) : this.KZh ? this.KZh.ShakeScale = t : (i = ResourceSystem_1.ResourceSystem.GetLoadedAsset(CharacterGlideComponent_1.SOAR_CAMERA_SHAKE_PATH, UE.Class), this.KZh = Global_1.Global.CharacterCameraManager.StartCameraShake(i, t))
  }
  OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnEnterVehicle, this.M6l), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnLeaveVehicle, this.E6l), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnAfterAttachVehicle, this.Os1), this.CharacterEntityHandle?.Valid && EventSystem_1.EventSystem.RemoveWithTarget(this.CharacterEntityHandle.Entity, EventDefine_1.EEventName.CharOnUnifiedMoveStateChanged, this.hUe), this.mPr?.Valid && this.mPr.RemoveTagAddOrRemoveListener(vehicleWaterFall, this.UWi), !0
  }
};
FightCameraLogicComponent.Rza = Stats_1.Stat.Create("UpdatePlayerStat"), FightCameraLogicComponent.Uza = Stats_1.Stat.Create("UpdateControllerStat"), FightCameraLogicComponent.xza = Stats_1.Stat.Create("ClampArmLengthStat"), FightCameraLogicComponent.Pza = Stats_1.Stat.Create("UpdateArmLocationStat"), FightCameraLogicComponent.MP_ = Stats_1.Stat.Create("UpdateArmLengthStat"), FightCameraLogicComponent.wza = Stats_1.Stat.Create("UpdatePitchStat"), FightCameraLogicComponent.Bza = Stats_1.Stat.Create("UpdateYawStat"), FightCameraLogicComponent.bza = Stats_1.Stat.Create("UpdateFadingStat"), FightCameraLogicComponent.qza = Stats_1.Stat.Create("UpdateActorTransStat"), FightCameraLogicComponent.Oza = Stats_1.Stat.Create("CameraPostStat"), FightCameraLogicComponent.Gza = new Map, FightCameraLogicComponent = FightCameraLogicComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(5)], FightCameraLogicComponent), exports.FightCameraLogicComponent = FightCameraLogicComponent;
