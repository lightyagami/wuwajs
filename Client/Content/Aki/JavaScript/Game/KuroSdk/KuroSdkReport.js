...
class KuroSdkReport {
  ...
  static mSe() {
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnQuestStateChange, this.DSe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnLogicTreeChildQuestNodeStatusChange, this.RSe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnPayItemSuccess, this.USe)
  }
  static OnPlayerLevelChange(e) {
    var t;
    SdkReportLevel.IfNeedReport(e) && ((t = new SdkReportLevel(void 0)).Level = e, this.Report(t))
  }
  static OnPlotFinish(e) {
    var t;
    SdkReportStartFlow.IfNeedReport(e.FlowId, e.FlowStateId) && ((t = new SdkReportStartFlow(void 0)).FlowId = e.FlowId, this.Report(t))
  }
  static OnSdkPay() {
  ...
  static OnPayShopDirectBuy(e) {
    var t;
    SdkReportDirectBuy.IfNeedReport(e) && ((t = new SdkReportDirectBuy(void 0)).PayItemId = e, this.Report(t))
  }
      ...
      if (e) {
        ...
        if (2 === E || 4 === E) {
          ...
          for (const R of r) {
            ...
            if (o && 5 <= o.QualityId) {
              if (2 === E) return o = new SdkReportFirstUpFiveStarHero(void 0), this.Report(o), e.set(HIGHGACHAPOOLREPORTSTATEKEY, 1), void LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SdkReportStateMap, e);
              if (4 === E) return o = new SdkReportFirstNormalFiveStarHero(void 0), this.Report(o), e.set(NORMALGACHAPOOLREPORTSTATEKEY, 1), void LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SdkReportStateMap, e)
            }
          }
        }
      }
  ...
  static OnRougeFinish() {
    let e = LocalStorage_1.LocalStorage.GetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SdkReportStateMap);
    var t;
    e && 1 === e.get(ROUGEFINISHSTATEKEY) || (e = e || new Map, t = new SdkReportGetRougeLevel60(void 0), this.Report(t), e.set(ROUGEFINISHSTATEKEY, 1), LocalStorage_1.LocalStorage.SetPlayer(LocalStorageDefine_1.ELocalStoragePlayerKey.SdkReportStateMap, e))
  }
}
exports.KuroSdkReport = KuroSdkReport, (_a = KuroSdkReport).USe = e => {
  var t;
  SdkReportRecharge.IfNeedReport(e.PayItemId) && ((t = new SdkReportRecharge(void 0)).PayItemId = e.PayItemId, _a.Report(t))
}, KuroSdkReport.DSe = (e, t) => {
  var r;
  SdkReportQuestFinish.IfNeedReport(e) && ((r = new SdkReportQuestFinish(void 0)).QuestId = e, _a.Report(r)), SdkReportChapter.IfNeedReport(e, 0) && t === Protocol_1.Aki.Protocol.hTs.a3_ && ((r = new SdkReportChapter(void 0)).TreeConfigId = e, _a.Report(r))
}, KuroSdkReport.RSe = (e, t, r) => {
  var E;
  6 === e.Type && (E = e.TreeConfigId, e = e.NodeId, SdkReportBattleTech.IfNeedReport(E, e)) && r === Protocol_1.Aki.Protocol.FNs.Proto_CQNS_Finished && ((r = new SdkReportBattleTech(void 0)).TreeConfigId = E, r.NodeId = e, _a.Report(r))
};
...
class SdkReportCreateRole extends SdkReportData_1.SdkReportData {
  ...
  GetEventDataJson() {
    return this.IfGlobalSdk ? (this.EventData = new Map, this.EventData.set("eventId", CREATEROLEEVENTID)) : (this.EventData = new Map, this.EventData.set("param1", CREATEROLEEVENTID)), super.GetEventDataJson()
  }
}
...
class SdkReportBattleTech extends SdkReportData_1.SdkReportData {
  ...
  GetEventDataJson() {
    return this.EventData = new Map, this.EventData.set("eventId", BATTLEEVENTID), this.EventData.set("TreeId", this.TreeConfigId.toString()), this.EventData.set("StepId", this.NodeId.toString()), super.GetEventDataJson()
  }
...
class SdkReportQuestFinish extends SdkReportData_1.SdkReportData {
  ...
  static IfNeedReport(e) {
    if (e === CAPTUREPHANTOMMISSION && 3 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(e)) return !0;
    return !1
  }
  GetEventName() {
  ...
  GetEventDataJson() {
    return this.QuestId === CAPTUREPHANTOMMISSION && (this.EventData = new Map, this.EventData.set("eventId", QUESTEVENTID), this.EventData.set("QuestId", this.QuestId.toString())), super.GetEventDataJson()
  }
...
class SdkReportStartFlow extends SdkReportData_1.SdkReportData {
  ...
  GetEventDataJson() {
    return this.EventData = new Map, this.EventData.set("eventId", FLOWEVENTID), this.EventData.set("FlowId", this.FlowId.toString()), super.GetEventDataJson()
  }
}
...
class SdkReportDirectBuy extends SdkReportData_1.SdkReportData {
  ...
  [PayShopDefine_1.BATTLE_PASS_PRIMARY_TO_HIGH_ID, "BattlePass_Primary_To_HIGH"]
]);
...
class SdkReportLevel extends SdkReportData_1.SdkReportData {
  ...
  GetEventName() {
    return this.IfGlobalSdk ? StringUtils_1.StringUtils.Format("Level_{0}", this.Level.toString()) : SdkReportLevel.PSe.get(this.Level) || ""
  }
}(exports.SdkReportLevel = SdkReportLevel).xSe = new Array(REPORTLEVEL8, REPORTLEVEL10, REPORTLEVEL12, REPORTLEVEL15, REPORTLEVEL20, REPORTLEVEL25, REPORTLEVEL30, REPORTLEVEL35, REPORTLEVEL40, REPORTLEVEL45), SdkReportLevel.PSe = new Map([
