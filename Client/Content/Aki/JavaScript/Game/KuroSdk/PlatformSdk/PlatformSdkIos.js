...
class PlatformSdkIos extends PlatformSdkBase_1.PlatformSdkBase {
  constructor() {
    super(...arguments), this.wSe = new Map, this.CustomerServiceResultCallBack = e => {
  ...
  OnInit() {
    this.CurrentDid = ue_1.KuroSDKManager.GetBasicInfo().DeviceId, ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() && UE.KuroLauncherLibrary.IsFirstIntoLauncher() && ue_1.KuroSDKManager.PostSplashScreenEndSuccess(), cpp_1.FCrashSightProxy.SetCustomData("SdkDeviceId", this.CurrentDid), cpp_1.FCrashSightProxy.SetCustomData("Sdkidfv", this.YSe()), cpp_1.FCrashSightProxy.SetCustomData("SdkJyId", this.GetJyDid()), cpp_1.FCrashSightProxy.SetCustomData("SdkChannelId", this.GetChannelId())
  }
  BindSpecialEvent() {
  ...
  OpenCustomerService(e) {
    var r = ModelManager_1.ModelManager.LoginModel,
      ...
      e = (o.islogin = r.IsSdkLoggedIn() ? 1 : 0, o.from = e, o.RoleId = this.GetCustomServerRoleId(), o.RoleName = t.GetAccountName(), o.ServerId = r.GetServerId(), o.ServerName = r.GetServerName(), o.RoleLevel = t.GetPlayerLevel(), Json_1.Json.Stringify(o));
  ...
  OnGetSharePlatform(e) {
    ...
    if (0 === r.KRMAINLAND_SDK_EVENT_KEY_RESULT) {
      ...
      r?.forEach(e => {
        ...
        r.IconUrl = e.iconUrl, r.PlatformId = e.platform.toString(), t.push(r)
  ...
  OnShareResult(e, r, t) {
    ...
    Log_1.Log.CheckInfo() && Log_1.Log.Info("KuroSdk", 27, "OnShareResult", ["code", e], ["platform", r], ["finalMsg", o], ["shareResult", n]), n?.KRMAINLAND_SDK_EVENT_KEY_RESULT ? EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnShareResult, !0) : EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnShareResult, !1)
  }
  YSe() {
  ...
  SdkLogout() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("KuroSdk", 27, "游戏注销"), ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() && ue_1.KuroSDKManager.KuroSDKEvent(5, "")
  }
  OpenExternalUrl(e) {
