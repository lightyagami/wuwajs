...
exports.PlatformSdkAndroidGlobal = undefined;
...
class PlatformSdkAndroidGlobal extends PlatformSdkBase_1.PlatformSdkBase {
  ...
  OnQueryProduct(e) {
    var e = e.split("|");
    const o = new Array();
    if (e?.length > 1 && e[0] === "success" && ((e = Json_1.Json.Parse(e[1]))?.forEach(e => {
