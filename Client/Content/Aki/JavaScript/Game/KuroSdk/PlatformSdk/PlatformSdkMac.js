...
class PlatformSdkMac extends PlatformSdkBase_1.PlatformSdkBase {
  ...
  OnInit() {
    this.CurrentDid = ue_1.KuroSDKManager.GetBasicInfo().DeviceId, ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() && UE.KuroLauncherLibrary.IsFirstIntoLauncher() && ue_1.KuroSDKManager.PostSplashScreenEndSuccess(), cpp_1.FCrashSightProxy.SetCustomData("SdkDeviceId", this.CurrentDid), cpp_1.FCrashSightProxy.SetCustomData("SdkChannelId", this.GetChannelId())
  }
  BindSpecialEvent() {
    ue_1.KuroSDKManager.Get().CustomerServiceResultDelegate.Clear(), ue_1.KuroSDKManager.Get().CustomerServiceResultDelegate.Add(this.CustomerServiceResultCallBack)
  }
  OpenCustomerService(e) {
    var r = ModelManager_1.ModelManager.LoginModel,
      o = new KuroSdkData_1.OpenCustomerServiceParamMac,
      r = (o.islogin = r.IsSdkLoggedIn() ? 1 : 0, o.from = e, Json_1.Json.Stringify(o));
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("KuroSdk", 27, "MacCustomerService", ["json", r]), ue_1.KuroSDKManager.OpenCustomerService(r)
  }
  GetChannelId() {
  ...
  SetFont() {
    ...
    Log_1.Log.CheckInfo() && Log_1.Log.Info("KuroSdk", 27, "Mac SetFont", ["fontPath", e]), ue_1.KuroSDKManager.SetFont(e)
  }
  BSe(e) {
    if (0 === this.wSe.size) {
