...
class FbMatchPlayerRole {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.cZh = !1, this.uZh = !1
  }
  static Create(t) {
  ...
  get MatchPhantomSkill() {
    return this.cZh || (this.cZh = !0, this.uZh = this.FbDataInternal.matchPhantomSkill()), this.uZh
  }
}
