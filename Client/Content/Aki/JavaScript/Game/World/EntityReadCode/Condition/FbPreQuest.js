...
class FbPreQuest {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this._ch = !1, this.cch = void 0, this.tZh = !1, this.iZh = 0
  }
  static Create(t) {
  ...
  get PreQuestId() {
    return this.tZh || (this.tZh = !0, this.iZh = this.FbDataInternal.preQuestId()), this.iZh
  }
}
