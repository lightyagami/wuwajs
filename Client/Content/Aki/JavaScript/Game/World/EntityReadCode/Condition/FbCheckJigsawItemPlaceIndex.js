...
class FbCheckJigsawItemPlaceIndex {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.gAh = !1, this.fAh = 0, this.pAh = !1, this.vAh = 0, this.tJh = !1, this.iJh = void 0, this._ch = !1, this.cch = void 0
  }
  static Create(t) {
  ...
  get PlaceIndex() {
    return this.tJh || (this.tJh = !0, this.iJh = FbPieceIndex_1.FbPieceIndex.Create(this.FbDataInternal.placeIndex())), this.iJh
  }
  get Compare() {
