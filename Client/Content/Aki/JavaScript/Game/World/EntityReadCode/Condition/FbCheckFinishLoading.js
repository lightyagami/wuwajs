...
class FbCheckFinishLoading {
  constructor(e) {
    this.FbDataInternal = e, this.u_h = !1, this.f8o = void 0, this.BJh = !1, this.qJh = void 0
  }
  static Create(e) {
  ...
  get CheckTarget() {
    var e, i;
    return !this.BJh && (this.BJh = !0, e = this.FbDataInternal.checkTargetType(), i = UnionCheckTargetTypeConfigHelper_1.UnionCheckTargetTypeConfigHelper.GetUnionCheckTargetTypeConfigObject(e)) && (this.qJh = UnionCheckTargetTypeConfigHelper_1.UnionCheckTargetTypeConfigHelper.ReadUnionCheckTargetTypeConfig(e, this.FbDataInternal.checkTarget(i))), this.qJh
  }
}
