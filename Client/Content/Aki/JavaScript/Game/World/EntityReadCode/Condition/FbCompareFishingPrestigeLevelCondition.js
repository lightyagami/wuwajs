...
class FbCompareFishingPrestigeLevelCondition {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this._ch = !1, this.cch = void 0, this.LKl = !1, this.AKl = 0
  }
  static Create(t) {
  ...
  get PrestigeLevel() {
    return this.LKl || (this.LKl = !0, this.AKl = this.FbDataInternal.prestigeLevel()), this.AKl
  }
}
