...
class FbCheckCalabashDevelopRewardCondition {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.Xzh = !1, this.Yzh = 0, this.zzh = !1, this.Jzh = void 0
  }
  static Create(t) {
  ...
  get MonsterId() {
    return this.Xzh || (this.Xzh = !0, this.Yzh = this.FbDataInternal.monsterId()), this.Yzh
  }
  get Develop() {
    return this.zzh || (this.zzh = !0, this.Jzh = this.FbDataInternal.develop()), this.Jzh
  }
}
