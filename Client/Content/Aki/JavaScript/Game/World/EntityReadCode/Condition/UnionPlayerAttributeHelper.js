...
class UnionPlayerAttributeHelper {
  static GetUnionPlayerAttributeObject(t) {
    if (t === fb_condition_1.UnionPlayerAttribute.HealthAttribute) return new fb_condition_1.HealthAttribute
  }
  static ReadUnionPlayerAttribute(t, e) {
    return void 0 !== e && t === fb_condition_1.UnionPlayerAttribute.HealthAttribute ? FbHealthAttribute_1.FbHealthAttribute.Create(e) : void 0
  }
}
