...
class FbCheckCollectAnimalParts {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.XJh = !1, this.YJh = 0, this.wJh = !1, this.PJh = void 0, this.zJh = !1, this.JJh = void 0
  }
  static Create(t) {
  ...
  get TargetAnimal() {
    return this.XJh || (this.XJh = !0, this.YJh = this.FbDataInternal.targetAnimal()), this.YJh
  }
  get CheckType() {
