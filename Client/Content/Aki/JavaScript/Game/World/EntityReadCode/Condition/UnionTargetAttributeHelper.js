...
class UnionTargetAttributeHelper {
  static GetUnionTargetAttributeObject(t) {
    if (t === fb_condition_1.UnionTargetAttribute.PlayerAttribute) return new fb_condition_1.PlayerAttribute
  }
  static ReadUnionTargetAttribute(t, e) {
    return void 0 !== e && t === fb_condition_1.UnionTargetAttribute.PlayerAttribute ? FbPlayerAttribute_1.FbPlayerAttribute.Create(e) : void 0
  }
}
