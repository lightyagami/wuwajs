...
class UnionCheckTargetTypeConfigHelper {
  static GetUnionCheckTargetTypeConfigObject(e) {
    if (e === fb_condition_1.UnionCheckTargetTypeConfig.AllPlayerType) return new fb_condition_1.AllPlayerType
  }
  static ReadUnionCheckTargetTypeConfig(e, i) {
    return void 0 !== i && e === fb_condition_1.UnionCheckTargetTypeConfig.AllPlayerType ? FbAllPlayerType_1.FbAllPlayerType.Create(i) : void 0
  }
}
