...
class FbCheckTargetAttributeCondition {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.s_h = !1, this.Hye = void 0, this.czh = !1, this.uzh = void 0
  }
  static Create(t) {
  ...
  get Option() {
    var t, e;
    return !this.s_h && (this.s_h = !0, t = this.FbDataInternal.optionType(), e = UnionTargetAttributeHelper_1.UnionTargetAttributeHelper.GetUnionTargetAttributeObject(t)) && (this.Hye = UnionTargetAttributeHelper_1.UnionTargetAttributeHelper.ReadUnionTargetAttribute(t, this.FbDataInternal.option(e))), this.Hye
  }
