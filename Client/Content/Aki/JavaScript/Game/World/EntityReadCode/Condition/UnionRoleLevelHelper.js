...
class UnionRoleLevelHelper {
  static GetUnionRoleLevelObject(e) {
    if (e === fb_condition_1.UnionRoleLevel.SpecifyRoleLevel) return new fb_condition_1.SpecifyRoleLevel
  }
  static ReadUnionRoleLevel(e, o) {
    return void 0 !== o && e === fb_condition_1.UnionRoleLevel.SpecifyRoleLevel ? FbSpecifyRoleLevel_1.FbSpecifyRoleLevel.Create(o) : void 0
  }
}
