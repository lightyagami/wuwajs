...
exports.UnionCheckFormationRoleInfoHelper = undefined;
const fb_condition_1 = require("../../../../Game/World/EntityFb/fb-condition");
const FbFeatureCollectionLevel_1 = require("./FbFeatureCollectionLevel");
const FbHasEquippedVision_1 = require("./FbHasEquippedVision");
const FbHasUpgradableVision_1 = require("./FbHasUpgradableVision");
const FbRoleLevel_1 = require("./FbRoleLevel");
const FbWeaponLevel_1 = require("./FbWeaponLevel");
