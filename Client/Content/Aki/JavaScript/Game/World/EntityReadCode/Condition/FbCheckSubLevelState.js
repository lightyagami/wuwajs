...
class FbCheckSubLevelState {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.q8_ = !1, this.O8_ = void 0, this.G8_ = !1, this.F8_ = void 0
  }
  static Create(t) {
  ...
  get ConditionCount() {
    return this.q8_ || (this.q8_ = !0, this.O8_ = this.FbDataInternal.conditionCount()), this.O8_
  }
  get CheckList() {
    if (!this.G8_) {
