...
class FbCheckEntityPosition {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.a_h = !1, this.I9o = 0, this.M_h = !1, this.E_h = void 0, this.kzh = !1, this.Gzh = !1
  }
  static Create(t) {
  ...
  get Range() {
    var t, i;
    return !this.M_h && (this.M_h = !0, t = this.FbDataInternal.rangeType(), i = UnionRangeHelper_1.UnionRangeHelper.GetUnionRangeObject(t)) && (this.E_h = UnionRangeHelper_1.UnionRangeHelper.ReadUnionRange(t, this.FbDataInternal.range(i))), this.E_h
  }
  get IsOnRange() {
