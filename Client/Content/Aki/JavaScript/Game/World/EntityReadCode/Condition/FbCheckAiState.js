...
class FbCheckAiState {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this._ch = !1, this.cch = void 0, this.fzh = !1, this.pzh = void 0
  }
  static Create(t) {
  ...
  get StateType() {
    return this.fzh || (this.fzh = !0, this.pzh = this.FbDataInternal.stateType()), this.pzh
  }
}
