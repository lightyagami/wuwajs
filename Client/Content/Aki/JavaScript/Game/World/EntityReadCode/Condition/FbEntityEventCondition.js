...
class FbEntityEventCondition {
  constructor(t) {
    this.FbDataInternal = t, this.a_h = !1, this.I9o = 0, this.Bch = !1, this.Cbo = void 0, this.azh = !1, this.hzh = !1, this.$ph = !1, this.Xph = !1
  }
  static Create(t) {
  ...
  get IsDead() {
    return this.azh || (this.azh = !0, this.hzh = this.FbDataInternal.isDead()), this.hzh
  }
  get IsLocked() {
