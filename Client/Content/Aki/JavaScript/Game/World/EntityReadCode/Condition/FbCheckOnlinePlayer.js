...
class FbCheckOnlinePlayer {
  constructor(e) {
    this.FbDataInternal = e, this.u_h = !1, this.f8o = void 0, this.czh = !1, this.uzh = void 0
  }
  static Create(e) {
  ...
  get OnlinePlayerConditionTargetOption() {
    var e, i;
    return !this.czh && (this.czh = !0, e = this.FbDataInternal.onlinePlayerConditionTargetOptionType(), i = UnionOnlinePlayerConditionTargetHelper_1.UnionOnlinePlayerConditionTargetHelper.GetUnionOnlinePlayerConditionTargetObject(e)) && (this.uzh = UnionOnlinePlayerConditionTargetHelper_1.UnionOnlinePlayerConditionTargetHelper.ReadUnionOnlinePlayerConditionTarget(e, this.FbDataInternal.onlinePlayerConditionTargetOption(i))), this.uzh
  }
}
