...
class FbPlayerAttribute {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.s_h = !1, this.Hye = void 0, this.rJh = !1, this.oJh = void 0
  }
  static Create(t) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) {
          var e = this.FbDataInternal.attributeTypesType(t),
            r = UnionPlayerAttributeHelper_1.UnionPlayerAttributeHelper.GetUnionPlayerAttributeObject(e);
          r && void 0 !== (e = UnionPlayerAttributeHelper_1.UnionPlayerAttributeHelper.ReadUnionPlayerAttribute(e, this.FbDataInternal.attributeTypes(t, r))) && this.oJh.push(e)
        }
    }
    return this.oJh
  }
