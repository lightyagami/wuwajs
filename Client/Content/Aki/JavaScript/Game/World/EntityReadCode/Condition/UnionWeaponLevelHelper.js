...
class UnionWeaponLevelHelper {
  static GetUnionWeaponLevelObject(e) {
    if (e === fb_condition_1.UnionWeaponLevel.SpecifyRoleWeaponLevel) return new fb_condition_1.SpecifyRoleWeaponLevel
  }
  static ReadUnionWeaponLevel(e, o) {
    return void 0 !== o && e === fb_condition_1.UnionWeaponLevel.SpecifyRoleWeaponLevel ? FbSpecifyRoleWeaponLevel_1.FbSpecifyRoleWeaponLevel.Create(o) : void 0
  }
}
