...
class FbCheckEntityGravityDirection {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.ldh = !1, this.NHo = void 0, this.yUh = !1, this.SUh = void 0
  }
  static Create(t) {
  ...
  get Target() {
    var t, i;
    return !this.ldh && (this.ldh = !0, t = this.FbDataInternal.targetType(), i = UnionCheckTargetHelper_1.UnionCheckTargetHelper.GetUnionCheckTargetObject(t)) && (this.NHo = UnionCheckTargetHelper_1.UnionCheckTargetHelper.ReadUnionCheckTarget(t, this.FbDataInternal.target(i))), this.NHo
  }
