...
class FbCheckFishingCageFillingRatio {
  constructor(i) {
    this.FbDataInternal = i, this.u_h = !1, this.f8o = void 0, this._ch = !1, this.cch = void 0, this.jP_ = !1, this.HP_ = 0
  }
  static Create(i) {
  ...
  get Ratio() {
    return this.jP_ || (this.jP_ = !0, this.HP_ = this.FbDataInternal.ratio()), this.HP_
  }
}
