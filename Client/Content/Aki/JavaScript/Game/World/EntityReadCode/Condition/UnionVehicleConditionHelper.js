...
exports.UnionVehicleConditionHelper = undefined;
const fb_condition_1 = require("../../../../Game/World/EntityFb/fb-condition");
const FbCheckIsPlayerUsingVehicle_1 = require("./FbCheckIsPlayerUsingVehicle");
const FbCheckIsUsingVehicle_1 = require("./FbCheckIsUsingVehicle");
class UnionVehicleConditionHelper {
  ...
  static ReadUnionVehicleCondition(e, i) {
    if (i !== undefined) {
      switch (e) {
        case fb_condition_1.UnionVehicleCondition.CheckIsPlayerUsingVehicle:
          return FbCheckIsPlayerUsingVehicle_1.FbCheckIsPlayerUsingVehicle.Create(i);
        case fb_condition_1.UnionVehicleCondition.CheckIsUsingVehicle:
