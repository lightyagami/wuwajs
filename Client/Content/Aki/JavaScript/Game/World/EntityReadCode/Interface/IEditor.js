...
var EActionDisabledType;
var ETreeNodeDisabledType;
var EMaximumDisplayCountInSelector;
...
var EAreaConflictSelector;
var EEntityAssignPriority;
...
exports.WORLD_PARTITION_MAP_SIZE = exports.WORLD_PARTITION_BOUNDS_SIZE * 48;
exports.GRID_SIZE = 85000;
exports.MAX_MAP_SIZE = Math.ceil(exports.WORLD_PARTITION_MAP_SIZE / exports.GRID_SIZE) * exports.GRID_SIZE;
exports.EDITOR_SAVE_CONFIG_PATH = "Saved/Editor/JsonConfig/EditorSaveConfig.json";
...
(function (e) {
  ...
  e.SizeCell = "SizeCell";
  e.WpCell = "WpCell";
})(EEntityActorLoadMode = exports.EEntityActorLoadMode ||= {});
...
})(EActorDeleteMode = exports.EActorDeleteMode ||= {});
...
})(EActionDisabledType = exports.EActionDisabledType ||= {});
(function (e) {
  e.LocalDisabled = "LocalDisabled";
  e.HideDisabled = "HideDisabled";
})(ETreeNodeDisabledType = exports.ETreeNodeDisabledType ||= {});
(function (e) {
  e[e.Moderate = 8] = "Moderate";
  e[e.Abundant = 10] = "Abundant";
  e[e.Plentiful = 12] = "Plentiful";
})(EMaximumDisplayCountInSelector = exports.EMaximumDisplayCountInSelector ||= {});
...
(function (e) {
  e.SortByCount = "SortByCount";
  e.SortByTime = "SortByTime";
})(ERecentSelectRecordMode = exports.ERecentSelectRecordMode ||= {});
(function (e) {
  e.Custom = "Custom";
  e.Archive = "Archive";
})(EEditorLoginAccountType = exports.EEditorLoginAccountType ||= {});
(function (e) {
  e.PIE = "PIE";
  e.Attach = "Attach";
  e.Package = "Package";
...
(function (e) {
  e.Package = "Package";
  e.Local = "Local";
})(EPackageServerType = exports.EPackageServerType ||= {});
(function (e) {
  e.Keyword = "Keyword";
  e.TidText = "TidText";
  e.EntityId = "EntityId";
  e.Action = "Action";
  e.VarRef = "VarRef";
})(EEditorSearchMode = exports.EEditorSearchMode ||= {});
(function (e) {
  e.Quest = "Quest";
  e.LevelPlay = "LevelPlay";
})(ESyncBlockContext = exports.ESyncBlockContext ||= {});
(function (e) {
  e.Quest = "任务";
  e.LevelPlay = "玩法";
  e.Shape = "自定义形状";
})(EAreaConflictSelector = exports.EAreaConflictSelector ||= {});
(function (e) {
  e.EntityActor = "Actor 优先";
  e.EntityEditor = "实体编辑器优先";
})(EEntityAssignPriority = exports.EEntityAssignPriority ||= {}); //# sourceMappingURL=IEditor.js.map