...
function createDiff(e, r, t) {
  ...
  let o = 0;
  var n, i, f, u, c = {};
  for (const l in e) t?.(l) || void 0 === r[l] && (n = e[l], c[l] = clearIgnoreField(n, t), o++);
  for (const a in r) t?.(a) || (i = e[a], f = r[a], void 0 !== i ? (u = typeof i) == typeof f && "object" == u ? (u = createDiff(i, f, t), void 0 !== (c[a] = u) && o++) : i !== f && (c[a] = clearIgnoreField(i, t), o++) : (c[a] = null, o++));
  return 0 !== o ? c : void 0
}
...
function applyDiff(e, r, t) {
  ...
  if (null !== e) {
    ...
    for (const l in r) t?.(l) || (n = e[l], i = r[l], void 0 === n ? u[l] = i : null !== n && (f = typeof n, u[l] = f == typeof i && "object" == f ? applyDiff(n, i, t) : n));
    return u
  }
}
...
function diffChars(n, i) {
  ...
  e: for (; a <= f + u; a++)
    for (let o = -a; o <= a; o += 2) {
      ...
      0 < a && (o === -a || o !== a && c[o - 1].X < c[o + 1].X ? (s = c[o + 1], e = s.X, d.Head = mergeOp(1, 1, s.Head)) : (s = c[o - 1], e = s.X + 1, d.Head = mergeOp(2, 1, s.Head)), r = e - o);
      let t = 0;
