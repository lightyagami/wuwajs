...
exports.UnionTriggerShapeHelper = undefined;
const fb_shape_1 = require("../../../../Game/World/EntityFb/fb-shape");
const FbActorCollisionTriggerShape_1 = require("./FbActorCollisionTriggerShape");
const FbActorRefVolume_1 = require("./FbActorRefVolume");
const FbBoxTriggerShape_1 = require("./FbBoxTriggerShape");
const FbCombinationTriggerShape_1 = require("./FbCombinationTriggerShape");
const FbConeTriggerShape_1 = require("./FbConeTriggerShape");
const FbCylinderTriggerShape_1 = require("./FbCylinderTriggerShape");
const FbHollowCylinderTriggerShape_1 = require("./FbHollowCylinderTriggerShape");
const FbHollowSphereTriggerShape_1 = require("./FbHollowSphereTriggerShape");
const FbSphereTriggerShape_1 = require("./FbSphereTriggerShape");
const FbVolumeTriggerShape_1 = require("./FbVolumeTriggerShape");
class UnionTriggerShapeHelper {
  ...
  static ReadUnionTriggerShape(e, r) {
    if (r !== undefined) {
      switch (e) {
        case fb_shape_1.UnionTriggerShape.ActorCollisionTriggerShape:
          return FbActorCollisionTriggerShape_1.FbActorCollisionTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.ActorRefVolume:
          return FbActorRefVolume_1.FbActorRefVolume.Create(r);
        case fb_shape_1.UnionTriggerShape.BoxTriggerShape:
          return FbBoxTriggerShape_1.FbBoxTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.CombinationTriggerShape:
          return FbCombinationTriggerShape_1.FbCombinationTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.ConeTriggerShape:
          return FbConeTriggerShape_1.FbConeTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.CylinderTriggerShape:
          return FbCylinderTriggerShape_1.FbCylinderTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.HollowCylinderTriggerShape:
          return FbHollowCylinderTriggerShape_1.FbHollowCylinderTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.HollowSphereTriggerShape:
          return FbHollowSphereTriggerShape_1.FbHollowSphereTriggerShape.Create(r);
        case fb_shape_1.UnionTriggerShape.SphereTriggerShape:
