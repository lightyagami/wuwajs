...
exports.UnionGravityDirectionHelper = undefined;
const fb_common_1 = require("../../../../Game/World/EntityFb/fb-common");
const FbGravityDirectionByEntityGravity_1 = require("./FbGravityDirectionByEntityGravity");
const FbGravityDirectionSelfRotation_1 = require("./FbGravityDirectionSelfRotation");
const FbGravityDirectionVectorInfo_1 = require("./FbGravityDirectionVectorInfo");
const FbGravityDirectionWorldAxis_1 = require("./FbGravityDirectionWorldAxis");
class UnionGravityDirectionHelper {
  ...
  static ReadUnionGravityDirection(t, i) {
    if (i !== undefined) {
      switch (t) {
        case fb_common_1.UnionGravityDirection.GravityDirectionByEntityGravity:
          return FbGravityDirectionByEntityGravity_1.FbGravityDirectionByEntityGravity.Create(i);
        case fb_common_1.UnionGravityDirection.GravityDirectionSelfRotation:
          return FbGravityDirectionSelfRotation_1.FbGravityDirectionSelfRotation.Create(i);
        case fb_common_1.UnionGravityDirection.GravityDirectionVectorInfo:
          return FbGravityDirectionVectorInfo_1.FbGravityDirectionVectorInfo.Create(i);
        case fb_common_1.UnionGravityDirection.GravityDirectionWorldAxis:
          return FbGravityDirectionWorldAxis_1.FbGravityDirectionWorldAxis.Create(i);
        default:
          return;
      }
    }
