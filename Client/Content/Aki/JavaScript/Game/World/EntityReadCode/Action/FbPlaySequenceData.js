...
class FbPlaySequenceData {
  constructor(t) {
    this.FbDataInternal = t, this.Hdh = !1, this.Xdr = void 0, this.Pdh = !1, this.Udh = !1, this.tmh = !1, this.imh = !1, this.rmh = !1, this.omh = !1, this.nmh = !1, this.smh = void 0, this.amh = !1, this.hmh = !1
  }
  static Create(t) {
  ...
  get KeepCamera() {
    return this.tmh || (this.tmh = !0, this.imh = this.FbDataInternal.keepCamera()), this.imh
  }
  get PreLoadRenderAssets() {
    return this.rmh || (this.rmh = !0, this.omh = this.FbDataInternal.preLoadRenderAssets()), this.omh
  }
  get FrameEvents() {
    if (!this.nmh) {
