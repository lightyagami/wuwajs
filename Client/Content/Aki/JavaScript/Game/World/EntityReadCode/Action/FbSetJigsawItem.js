...
class FbSetJigsawItem {
  ...
  get Config() {
    var e, t;
    return !this.bSh && (this.bSh = !0, e = this.FbDataInternal.configType(), t = UnionSetJigsawItemHelper_1.UnionSetJigsawItemHelper.GetUnionSetJigsawItemObject(e)) && (this.TAe = UnionSetJigsawItemHelper_1.UnionSetJigsawItemHelper.ReadUnionSetJigsawItem(e, this.FbDataInternal.config(t))), this.TAe
  }
}
