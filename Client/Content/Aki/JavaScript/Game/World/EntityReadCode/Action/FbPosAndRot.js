...
class FbPosAndRot {
  constructor(t) {
    this.FbDataInternal = t, this.Luh = !1, this.Auh = 0, this.xuh = !1, this.Ruh = 0, this.wuh = !1, this.Puh = 0, this.Uuh = !1, this.Duh = 0, this.L7_ = !1, this.w7_ = 0, this.R7_ = !1, this.A7_ = 0
  }
  static Create(t) {
  ...
  get Roll() {
    return this.L7_ || (this.L7_ = !0, this.w7_ = this.FbDataInternal.roll()), this.w7_
  }
  get Pitch() {
    return this.R7_ || (this.R7_ = !0, this.A7_ = this.FbDataInternal.pitch()), this.A7_
  }
}
