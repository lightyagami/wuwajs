...
class FbBeginFlowTemplate {
  constructor(t) {
    this.FbDataInternal = t, this.ogh = !1, this.ngh = !1, this.GMh = !1, this.OMh = void 0, this.FMh = !1, this.NMh = void 0, this.VMh = !1, this.jMh = !1, this.Omh = !1, this.Fmh = !1
  }
  static Create(t) {
  ...
  get MontageIds() {
    if (!this.FMh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.NMh.push(this.FbDataInternal.montageIds(t))
    }
    return this.NMh
  }
  get UseFreeCamera() {
    return this.VMh || (this.VMh = !0, this.jMh = this.FbDataInternal.useFreeCamera()), this.jMh
  }
