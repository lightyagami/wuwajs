...
class FbUnLockCookSystemItem {
  ...
  get UnlockOption() {
    var t, o;
    return !this.eyh && (this.eyh = !0, t = this.FbDataInternal.unlockOptionType(), o = UnionUnlockCookSystemOptionHelper_1.UnionUnlockCookSystemOptionHelper.GetUnionUnlockCookSystemOptionObject(t)) && (this.tyh = UnionUnlockCookSystemOptionHelper_1.UnionUnlockCookSystemOptionHelper.ReadUnionUnlockCookSystemOption(t, this.FbDataInternal.unlockOption(o))), this.tyh
  }
}
