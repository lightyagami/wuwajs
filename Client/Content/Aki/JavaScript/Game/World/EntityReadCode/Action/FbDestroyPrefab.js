...
class FbDestroyPrefab {
  ...
  get VarName() {
    var e, r;
    return !this.qph && (this.qph = !0, e = this.FbDataInternal.varNameType(), r = UnionVarRefHelper_1.UnionVarRefHelper.GetUnionVarRefObject(e)) && (this.kph = UnionVarRefHelper_1.UnionVarRefHelper.ReadUnionVarRef(e, this.FbDataInternal.varName(r))), this.kph
  }
}
