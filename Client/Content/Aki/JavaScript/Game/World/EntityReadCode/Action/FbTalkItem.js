...
class FbTalkItem {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.tgh = !1, this.FFe = 0, this.igh = !1, this.rgh = 0, this.vCh = !1, this.yCh = void 0, this.x_h = !1, this.FGi = void 0, this.ogh = !1, this.ngh = !1, this.sgh = !1, this.agh = void 0, this.Dmh = !1, this.Bmh = 0, this.CCh = !1, this.gCh = 0, this.hgh = !1, this.lgh = void 0, this.vmh = !1, this.ymh = 0, this._gh = !1, this.cgh = void 0, this.L_h = !1, this.A_h = void 0, this.ugh = !1, this.dgh = void 0, this.mgh = !1, this.Cgh = void 0, this.ggh = !1, this.fgh = void 0, this.pgh = !1, this.vgh = void 0, this.Qk_ = !1, this.Kk_ = void 0, this.ygh = !1, this.Sgh = void 0, this.Mgh = !1, this.Egh = void 0, this.Igh = !1, this.Tgh = void 0, this.bgh = !1, this.Lgh = void 0, this.Agh = !1, this.xgh = void 0, this.Rgh = !1, this.wgh = void 0, this.Pgh = !1, this.Ugh = !1
  }
  static Create(t) {
  ...
  get PlotLineId() {
    return this.igh || (this.igh = !0, this.rgh = this.FbDataInternal.plotLineId()), this.rgh
  }
  get PlotLineKey() {
  ...
  get _editFlag() {
    return this.sgh || (this.sgh = !0, this.agh = this.FbDataInternal.editFlag()), this.agh
  }
  get WhoId() {
    return this.Dmh || (this.Dmh = !0, this.Bmh = this.FbDataInternal.whoId()), this.Bmh
  }
  get TextId() {
    return this.CCh || (this.CCh = !0, this.gCh = this.FbDataInternal.textId()), this.gCh
  }
  get TidTalk() {
    return this.hgh || (this.hgh = !0, this.lgh = this.FbDataInternal.tidTalk()), this.lgh
  }
  get WaitTime() {
    return this.vmh || (this.vmh = !0, this.ymh = this.FbDataInternal.waitTime()), this.ymh
  }
  get CaptionParams() {
    return this._gh || (this._gh = !0, this.cgh = FbCaptionParam_1.FbCaptionParam.Create(this.FbDataInternal.captionParams())), this.cgh
  }
  get Actions() {
    if (!this.L_h) {
  ...
  get Montage() {
    return this.mgh || (this.mgh = !0, this.Cgh = FbPlayMontage_1.FbPlayMontage.Create(this.FbDataInternal.montage())), this.Cgh
  }
  get CameraData() {
    return this.ggh || (this.ggh = !0, this.fgh = FbCameraData_1.FbCameraData.Create(this.FbDataInternal.cameraData())), this.fgh
  }
  get FlowTemplate() {
    return this.pgh || (this.pgh = !0, this.vgh = FbSetFlowTemplate_1.FbSetFlowTemplate.Create(this.FbDataInternal.flowTemplate())), this.vgh
  }
  ...
  get TalkAkEvent() {
    var t, i;
    return !this.bgh && (this.bgh = !0, t = this.FbDataInternal.talkAkEventType(), i = UnionPostAkEventHelper_1.UnionPostAkEventHelper.GetUnionPostAkEventObject(t)) && (this.Lgh = UnionPostAkEventHelper_1.UnionPostAkEventHelper.ReadUnionPostAkEvent(t, this.FbDataInternal.talkAkEvent(i))), this.Lgh
  }
  get UniversalTone() {
    return this.Agh || (this.Agh = !0, this.xgh = FbUniversalTone_1.FbUniversalTone.Create(this.FbDataInternal.universalTone())), this.xgh
  }
  get BackgroundConfig() {
    var t, i;
    return !this.Rgh && (this.Rgh = !0, t = this.FbDataInternal.backgroundConfigType(), i = UnionTalkBackgroundHelper_1.UnionTalkBackgroundHelper.GetUnionTalkBackgroundObject(t)) && (this.wgh = UnionTalkBackgroundHelper_1.UnionTalkBackgroundHelper.ReadUnionTalkBackground(t, this.FbDataInternal.backgroundConfig(i))), this.wgh
  }
  get PlayVoice() {
    return this.Pgh || (this.Pgh = !0, this.Ugh = this.FbDataInternal.playVoice()), this.Ugh
  }
}
