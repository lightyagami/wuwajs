...
class FbEntityLookAt {
  constructor(t) {
    this.FbDataInternal = t, this.a_h = !1, this.I9o = 0, this.uch = !1, this.dch = void 0, this.Ddh = !1, this.Bdh = !1
  }
  static Create(t) {
  ...
  get CameraMove() {
    return this.Ddh || (this.Ddh = !0, this.Bdh = this.FbDataInternal.cameraMove()), this.Bdh
  }
}
