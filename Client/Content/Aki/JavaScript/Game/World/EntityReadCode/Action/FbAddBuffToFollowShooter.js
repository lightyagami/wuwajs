...
class FbAddBuffToFollowShooter {
  constructor(t) {
    this.FbDataInternal = t, this.Vph = !1, this.jph = void 0, this.XO_ = !1, this.YO_ = 0
  }
  static Create(t) {
  ...
  get BuffIds() {
    if (!this.Vph) {
      ...
      if (o)
        for (let t = 0; t < o; ++t) this.jph.push(Number(this.FbDataInternal.buffIds(t) ?? 0))
    }
    return this.jph
  }
  get FollowShooterId() {
    return this.XO_ || (this.XO_ = !0, this.YO_ = this.FbDataInternal.followShooterId()), this.YO_
  }
}
