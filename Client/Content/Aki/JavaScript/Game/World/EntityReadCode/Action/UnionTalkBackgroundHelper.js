...
exports.UnionTalkBackgroundHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbTalkBackgroundClean_1 = require("./FbTalkBackgroundClean");
const FbTalkBackgroundIcon_1 = require("./FbTalkBackgroundIcon");
const FbTalkBackgroundImage_1 = require("./FbTalkBackgroundImage");
const FbTalkBackgroundImageByMcGender_1 = require("./FbTalkBackgroundImageByMcGender");
const FbTalkBackgroundSpineImage_1 = require("./FbTalkBackgroundSpineImage");
  ...
  static ReadUnionTalkBackground(a, e) {
    if (e !== undefined) {
      switch (a) {
        ...
        case fb_action_1.UnionTalkBackground.TalkBackgroundImageByMcGender:
          return FbTalkBackgroundImageByMcGender_1.FbTalkBackgroundImageByMcGender.Create(e);
        case fb_action_1.UnionTalkBackground.TalkBackgroundSpineImage:
          return FbTalkBackgroundSpineImage_1.FbTalkBackgroundSpineImage.Create(e);
        default:
          return;
      }
    }
