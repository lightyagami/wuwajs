...
class UnionNpcLeisureInteractOpHelper {
  static GetUnionNpcLeisureInteractOpObject(e) {
    if (e === fb_action_1.UnionNpcLeisureInteractOp.NpcSitDown) return new fb_action_1.NpcSitDown
  }
  static ReadUnionNpcLeisureInteractOp(e, t) {
    return void 0 !== t && e === fb_action_1.UnionNpcLeisureInteractOp.NpcSitDown ? FbNpcSitDown_1.FbNpcSitDown.Create(t) : void 0
  }
}
