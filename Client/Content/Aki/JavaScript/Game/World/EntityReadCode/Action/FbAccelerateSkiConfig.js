...
class FbAccelerateSkiConfig {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.ldh = !1, this.NHo = void 0, this.I_h = !1, this.y6o = 0, this.Vbh = !1, this.jbh = 0, this.KEh = !1, this.$Eh = 0, this.Hbh = !1, this.Wbh = 0
  }
  static Create(t) {
  ...
  get LimitSpeed() {
    return this.Vbh || (this.Vbh = !0, this.jbh = this.FbDataInternal.limitSpeed()), this.jbh
  }
  get Acceleration() {
    return this.KEh || (this.KEh = !0, this.$Eh = this.FbDataInternal.acceleration()), this.$Eh
  }
  get InstantSpeed() {
    return this.Hbh || (this.Hbh = !0, this.Wbh = this.FbDataInternal.instantSpeed()), this.Wbh
  }
}
