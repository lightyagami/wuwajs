...
exports.UnionChangeEntityStateHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbChangeEntityStateBatchDirectly_1 = require("./FbChangeEntityStateBatchDirectly");
const FbChangeEntityStateDirectly_1 = require("./FbChangeEntityStateDirectly");
const FbChangeEntityStateLoop_1 = require("./FbChangeEntityStateLoop");
class UnionChangeEntityStateHelper {
  ...
  static ReadUnionChangeEntityState(t, e) {
    if (e !== undefined) {
      switch (t) {
        case fb_action_1.UnionChangeEntityState.ChangeEntityStateBatchDirectly:
          return FbChangeEntityStateBatchDirectly_1.FbChangeEntityStateBatchDirectly.Create(e);
        case fb_action_1.UnionChangeEntityState.ChangeEntityStateDirectly:
          return FbChangeEntityStateDirectly_1.FbChangeEntityStateDirectly.Create(e);
        case fb_action_1.UnionChangeEntityState.ChangeEntityStateLoop:
