...
class FbSetSportsState {
  ...
  get Config() {
    var t, e;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), e = UnionSportStateHelper_1.UnionSportStateHelper.GetUnionSportStateObject(t)) && (this.TAe = UnionSportStateHelper_1.UnionSportStateHelper.ReadUnionSportState(t, this.FbDataInternal.config(e))), this.TAe
  }
}
