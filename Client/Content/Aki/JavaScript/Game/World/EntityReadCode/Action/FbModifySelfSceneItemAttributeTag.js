...
class FbModifySelfSceneItemAttributeTag {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.pLh = !1, this.vLh = !1, this.gLh = !1, this.fLh = void 0
  }
  static Create(t) {
  ...
  get PerformanceTag() {
    if (!this.gLh) {
      ...
      if (e)
        for (let t = 0; t < e; ++t) this.fLh.push(this.FbDataInternal.performanceTag(t))
    }
    return this.fLh
  }
}
