...
class FbFireBulletTrackPosition {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.p0h = !1, this.nXs = 0, this.v0h = !1, this.y0h = void 0, this.S0h = !1, this.M0h = 0
  }
  static Create(t) {
  ...
  get Launcher() {
    var t, i;
    return !this.v0h && (this.v0h = !0, t = this.FbDataInternal.launcherType(), i = UnionTargetEntityHelper_1.UnionTargetEntityHelper.GetUnionTargetEntityObject(t)) && (this.y0h = UnionTargetEntityHelper_1.UnionTargetEntityHelper.ReadUnionTargetEntity(t, this.FbDataInternal.launcher(i))), this.y0h
  }
