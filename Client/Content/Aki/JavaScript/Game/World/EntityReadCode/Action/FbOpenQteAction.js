...
class FbOpenQteAction {
  ...
  get Config() {
    var e, t;
    return !this.bSh && (this.bSh = !0, e = this.FbDataInternal.configType(), t = UnionOpenQteConfigHelper_1.UnionOpenQteConfigHelper.GetUnionOpenQteConfigObject(e)) && (this.TAe = UnionOpenQteConfigHelper_1.UnionOpenQteConfigHelper.ReadUnionOpenQteConfig(e, this.FbDataInternal.config(t))), this.TAe
  }
}
