...
class FbChangeActorMaterialData {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.DLh = !1, this.BLh = void 0, this.PLh = !1, this.ULh = void 0
  }
  static Create(t) {
  ...
  get MaterialData() {
    return this.DLh || (this.DLh = !0, this.BLh = this.FbDataInternal.materialData()), this.BLh
  }
  get ActorRefs() {
    if (!this.PLh) {
