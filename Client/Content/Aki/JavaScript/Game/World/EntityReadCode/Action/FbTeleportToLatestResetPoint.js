...
class FbTeleportToLatestResetPoint {
  ...
  get Option() {
    var t, e;
    return !this.s_h && (this.s_h = !0, t = this.FbDataInternal.optionType(), e = UnionTeleportToLatestResetPointOptionHelper_1.UnionTeleportToLatestResetPointOptionHelper.GetUnionTeleportToLatestResetPointOptionObject(t)) && (this.Hye = UnionTeleportToLatestResetPointOptionHelper_1.UnionTeleportToLatestResetPointOptionHelper.ReadUnionTeleportToLatestResetPointOption(t, this.FbDataInternal.option(e))), this.Hye
  }
}
