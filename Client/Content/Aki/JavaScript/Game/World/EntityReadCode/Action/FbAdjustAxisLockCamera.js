...
class FbAdjustAxisLockCamera {
  ...
  get AxisRotate() {
    return this.iTh || (this.iTh = !0, this.rTh = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.axisRotate())), this.rTh
  }
  get ScreenConfig() {
    return this.oTh || (this.oTh = !0, this.nTh = FbAxisLockScreenConfig_1.FbAxisLockScreenConfig.Create(this.FbDataInternal.screenConfig())), this.nTh
  }
}
