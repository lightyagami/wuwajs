...
class FbOpenSystemBoardWithReturn {
  ...
  get SystemType() {
    var e, t;
    return !this.udh && (this.udh = !0, e = this.FbDataInternal.systemTypeType(), t = UnionOpenSystemBoardWithReturnHelper_1.UnionOpenSystemBoardWithReturnHelper.GetUnionOpenSystemBoardWithReturnObject(e)) && (this.ddh = UnionOpenSystemBoardWithReturnHelper_1.UnionOpenSystemBoardWithReturnHelper.ReadUnionOpenSystemBoardWithReturn(e, this.FbDataInternal.systemType(t))), this.ddh
  }
}
