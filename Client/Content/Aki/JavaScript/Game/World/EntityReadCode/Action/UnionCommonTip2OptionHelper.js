...
class UnionCommonTip2OptionHelper {
  static GetUnionCommonTip2OptionObject(o) {
    if (o === fb_action_1.UnionCommonTip2Option.CommonTip2PrepareCountdown) return new fb_action_1.CommonTip2PrepareCountdown
  }
  static ReadUnionCommonTip2Option(o, n) {
    return void 0 !== n && o === fb_action_1.UnionCommonTip2Option.CommonTip2PrepareCountdown ? FbCommonTip2PrepareCountdown_1.FbCommonTip2PrepareCountdown.Create(n) : void 0
  }
}
