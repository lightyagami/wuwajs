...
class FbAddTrialCharacter {
  constructor(t) {
    this.FbDataInternal = t, this.USh = !1, this.DSh = 0, this.NSh = !1, this.VSh = void 0, this.wSh = !1, this.PSh = void 0, this._Eh = !1, this.cEh = !1, this.uEh = !1, this.dEh = !1, this.mEh = !1, this.CEh = !1, this.gEh = !1, this.fEh = void 0, this.pEh = !1, this.vEh = !1, this.Zch = !1, this.euh = void 0
  }
  static Create(t) {
  ...
  get CharacterGroup() {
    if (!this.NSh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.VSh.push(this.FbDataInternal.characterGroup(t))
    }
    return this.VSh
  }
  ...
  get AutoChange() {
    return this._Eh || (this._Eh = !0, this.cEh = this.FbDataInternal.autoChange()), this.cEh
  }
  get CreateTempTeam() {
    return this.uEh || (this.uEh = !0, this.dEh = this.FbDataInternal.createTempTeam()), this.dEh
  }
  get CreateAiCharacter() {
    return this.mEh || (this.mEh = !0, this.CEh = this.FbDataInternal.createAiCharacter()), this.CEh
  }
  get ActiveRange() {
    return this.gEh || (this.gEh = !0, this.fEh = FbActiveRange_1.FbActiveRange.Create(this.FbDataInternal.activeRange())), this.fEh
  }
  get EnableMapAndTeleport() {
    return this.pEh || (this.pEh = !0, this.vEh = this.FbDataInternal.enableMapAndTeleport()), this.vEh
  }
  get DungeonList() {
    if (!this.Zch) {
