...
class FbLimitPlayerOperation {
  ...
  get Type() {
    var i, t;
    return !this.u_h && (this.u_h = !0, i = this.FbDataInternal.typeType(), t = UnionLimitPlayOperationHelper_1.UnionLimitPlayOperationHelper.GetUnionLimitPlayOperationObject(i)) && (this.f8o = UnionLimitPlayOperationHelper_1.UnionLimitPlayOperationHelper.ReadUnionLimitPlayOperation(i, this.FbDataInternal.type(t))), this.f8o
  }
}
