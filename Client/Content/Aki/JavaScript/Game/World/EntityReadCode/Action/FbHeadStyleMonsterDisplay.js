...
class FbHeadStyleMonsterDisplay {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.Pmh = !1, this.Umh = 0
  }
  static Create(t) {
  ...
  get MonsterDisplayId() {
    return this.Pmh || (this.Pmh = !0, this.Umh = this.FbDataInternal.monsterDisplayId()), this.Umh
  }
}
