...
class FbEnterOrbitalCamera {
  ...
  get Option() {
    var t, r;
    return !this.s_h && (this.s_h = !0, t = this.FbDataInternal.optionType(), r = UnionEnterOrbitalCameraOptionHelper_1.UnionEnterOrbitalCameraOptionHelper.GetUnionEnterOrbitalCameraOptionObject(t)) && (this.Hye = UnionEnterOrbitalCameraOptionHelper_1.UnionEnterOrbitalCameraOptionHelper.ReadUnionEnterOrbitalCameraOption(t, this.FbDataInternal.option(r))), this.Hye
  }
}
