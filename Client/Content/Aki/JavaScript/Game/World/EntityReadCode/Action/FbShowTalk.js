...
class FbShowTalk {
  constructor(t) {
    this.FbDataInternal = t, this.Pdh = !1, this.Udh = !1, this.NCh = !1, this.VCh = void 0, this.jCh = !1, this.HCh = void 0, this.WCh = !1, this.QCh = void 0, this.KCh = !1, this.$Ch = void 0, this.XCh = !1, this.YCh = void 0, this.zCh = !1, this.JCh = void 0, this.ZCh = !1, this.egh = void 0, this.amh = !1, this.hmh = !1
  }
  static Create(t) {
    if (t) return new FbShowTalk(t)
  }
  get ResetCamera() {
    return this.Pdh || (this.Pdh = !0, this.Udh = this.FbDataInternal.resetCamera()), this.Udh
  }
  get TalkItems() {
    if (!this.NCh) {
  ...
  get TalkOutline() {
    return this.jCh || (this.jCh = !0, this.HCh = FbShowTalkOutline_1.FbShowTalkOutline.Create(this.FbDataInternal.talkOutline())), this.HCh
  }
  get SequenceDataAsset() {
    return this.WCh || (this.WCh = !0, this.QCh = this.FbDataInternal.sequenceDataAsset()), this.QCh
  }
  get TalkFrameEvents() {
    if (!this.KCh) {
  ...
  get SequenceNames() {
    if (!this.zCh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.JCh.push(this.FbDataInternal.sequenceNames(t))
    }
    return this.JCh
  }
  ...
  get SaveFinalPos() {
    return this.amh || (this.amh = !0, this.hmh = this.FbDataInternal.saveFinalPos()), this.hmh
  }
}
