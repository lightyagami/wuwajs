...
class FbFlowActorIndexData {
  constructor(t) {
    this.FbDataInternal = t, this.Afh = !1, this.V_i = 0, this.Kdh = !1, this.$dh = void 0
  }
  static Create(t) {
  ...
  get Offset() {
    return this.Kdh || (this.Kdh = !0, this.$dh = FbPosAndRot_1.FbPosAndRot.Create(this.FbDataInternal.offset())), this.$dh
  }
}
