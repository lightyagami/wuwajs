...
exports.UnionHideRangeConfigHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbHideWorldEntityAndLevelPlay_1 = require("./FbHideWorldEntityAndLevelPlay");
const FbHideWorldMonsterAndMonsterTreasure_1 = require("./FbHideWorldMonsterAndMonsterTreasure");
class UnionHideRangeConfigHelper {
  ...
  static ReadUnionHideRangeConfig(e, n) {
    if (n !== undefined) {
      switch (e) {
        case fb_action_1.UnionHideRangeConfig.HideWorldEntityAndLevelPlay:
          return FbHideWorldEntityAndLevelPlay_1.FbHideWorldEntityAndLevelPlay.Create(n);
        case fb_action_1.UnionHideRangeConfig.HideWorldMonsterAndMonsterTreasure:
          return FbHideWorldMonsterAndMonsterTreasure_1.FbHideWorldMonsterAndMonsterTreasure.Create(n);
        default:
          return;
      }
    }
