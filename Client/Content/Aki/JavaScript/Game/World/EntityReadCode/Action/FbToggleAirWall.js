...
class FbToggleAirWall {
  constructor(t) {
    this.FbDataInternal = t, this.s_h = !1, this.Hye = void 0, this.PLh = !1, this.ULh = void 0
  }
  static Create(t) {
  ...
  get Option() {
    var t, e;
    return !this.s_h && (this.s_h = !0, t = this.FbDataInternal.optionType(), e = UnionToggleAirWallHelper_1.UnionToggleAirWallHelper.GetUnionToggleAirWallObject(t)) && (this.Hye = UnionToggleAirWallHelper_1.UnionToggleAirWallHelper.ReadUnionToggleAirWall(t, this.FbDataInternal.option(e))), this.Hye
  }
  get ActorRefs() {
    if (!this.PLh) {
