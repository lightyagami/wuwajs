...
class FbEnableActor {
  constructor(t) {
    this.FbDataInternal = t, this.bLh = !1, this.LLh = void 0, this.ALh = !1, this.xLh = void 0, this.Jch = !1, this.l7 = !1, this.RLh = !1, this.wLh = !1
  }
  static Create(t) {
    if (t) return new FbEnableActor(t)
  }
  get ActorType() {
    return this.bLh || (this.bLh = !0, this.LLh = this.FbDataInternal.actorType()), this.LLh
  }
  get Targets() {
    if (!this.ALh) {
  ...
  get SyncChildActor() {
    return this.RLh || (this.RLh = !0, this.wLh = this.FbDataInternal.syncChildActor()), this.wLh
  }
}
