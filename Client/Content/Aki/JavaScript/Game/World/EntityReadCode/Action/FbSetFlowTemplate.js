...
class FbSetFlowTemplate {
  constructor(t) {
    this.FbDataInternal = t, this.ogh = !1, this.ngh = !1, this.sfh = !1, this.afh = void 0, this.hfh = !1, this.lfh = void 0, this.Jgh = !1, this.Zgh = void 0, this._fh = !1, this.cfh = void 0, this.ufh = !1, this.dfh = void 0, this.mfh = !1, this.Cfh = void 0, this.gfh = !1, this.ffh = void 0, this.pfh = !1, this.vfh = void 0, this.Gfh = !1, this.Ofh = 0
  }
  static Create(t) {
  ...
  get TemplateMode() {
    return this.sfh || (this.sfh = !0, this.afh = FbFlowTemplateMode_1.FbFlowTemplateMode.Create(this.FbDataInternal.templateMode())), this.afh
  }
  get TargetPos() {
    return this.hfh || (this.hfh = !0, this.lfh = FbPosAndRot_1.FbPosAndRot.Create(this.FbDataInternal.targetPos())), this.lfh
  }
  get CameraAnim() {
  ...
  get CameraPosAndRot() {
    return this.mfh || (this.mfh = !0, this.Cfh = FbCameraPosAndRot_1.FbCameraPosAndRot.Create(this.FbDataInternal.cameraPosAndRot())), this.Cfh
  }
  get CameraSetting() {
    return this.gfh || (this.gfh = !0, this.ffh = FbCameraSetting_1.FbCameraSetting.Create(this.FbDataInternal.cameraSetting())), this.ffh
  }
  get ActorIndexArray() {
    if (!this.pfh) {
