...
class FbLifePoint {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.fIh = !1, this.pIh = void 0, this.vIh = !1, this.yIh = 0, this.SIh = !1, this.MIh = void 0, this.EIh = !1, this.IIh = void 0
  }
  static Create(t) {
  ...
  get ColorBoard() {
    return this.fIh || (this.fIh = !0, this.pIh = FbLifePointColorBoard_1.FbLifePointColorBoard.Create(this.FbDataInternal.colorBoard())), this.pIh
  }
  get StepLimit() {
    return this.vIh || (this.vIh = !0, this.yIh = this.FbDataInternal.stepLimit()), this.yIh
  }
  get TidDesc() {
    return this.SIh || (this.SIh = !0, this.MIh = this.FbDataInternal.tidDesc()), this.MIh
  }
