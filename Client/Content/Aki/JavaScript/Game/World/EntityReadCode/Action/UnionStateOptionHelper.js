...
exports.UnionStateOptionHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbNotifyMonsterPerception_1 = require("./FbNotifyMonsterPerception");
const FbNotifyMonsterPlayStandbyTags_1 = require("./FbNotifyMonsterPlayStandbyTags");
const FbSetBattleTag_1 = require("./FbSetBattleTag");
class UnionStateOptionHelper {
  ...
  static ReadUnionStateOption(t, e) {
    if (e !== undefined) {
      switch (t) {
        case fb_action_1.UnionStateOption.NotifyMonsterPerception:
          return FbNotifyMonsterPerception_1.FbNotifyMonsterPerception.Create(e);
        case fb_action_1.UnionStateOption.NotifyMonsterPlayStandbyTags:
          return FbNotifyMonsterPlayStandbyTags_1.FbNotifyMonsterPlayStandbyTags.Create(e);
        case fb_action_1.UnionStateOption.SetBattleTag:
