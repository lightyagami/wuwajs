...
class FbTeleportToAndEnterVehicle {
  ...
  get ToVehicle() {
    var e, t;
    return !this.s5_ && (this.s5_ = !0, e = this.FbDataInternal.toVehicleType(), t = UnionTeleportToAndEnterVehicleTypeHelper_1.UnionTeleportToAndEnterVehicleTypeHelper.GetUnionTeleportToAndEnterVehicleTypeObject(e)) && (this.a5_ = UnionTeleportToAndEnterVehicleTypeHelper_1.UnionTeleportToAndEnterVehicleTypeHelper.ReadUnionTeleportToAndEnterVehicleType(e, this.FbDataInternal.toVehicle(t))), this.a5_
  }
}
