...
class FbSetAlertUiVisible {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.Yph = !1, this.zph = 0, this.tMh = !1, this.ASo = !1
  }
  static Create(t) {
  ...
  get IsVisible() {
    return this.tMh || (this.tMh = !0, this.ASo = this.FbDataInternal.isVisible()), this.ASo
  }
}
