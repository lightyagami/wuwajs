...
class FbNpcSitDown {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.Rfh = !1, this.wfh = void 0, this.ISh = !1, this.TSh = 0, this.I_h = !1, this.y6o = 0
  }
  static Create(t) {
  ...
  get MontageId() {
    return this.Rfh || (this.Rfh = !0, this.wfh = FbMontageId_1.FbMontageId.Create(this.FbDataInternal.montageId())), this.wfh
  }
  get PosEntityId() {
