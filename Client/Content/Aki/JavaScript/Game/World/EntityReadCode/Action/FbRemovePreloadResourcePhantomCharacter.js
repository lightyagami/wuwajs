...
class FbRemovePreloadResourcePhantomCharacter {
  constructor(e) {
    this.FbDataInternal = e, this.u_h = !1, this.f8o = void 0, this.tgh = !1, this.FFe = 0, this.OSh = !1, this.FSh = void 0
  }
  static Create(e) {
  ...
  get DelayReMove() {
    var e, t;
    return !this.OSh && (this.OSh = !0, e = this.FbDataInternal.delayReMoveType(), t = UnionDelayRemoveConfigHelper_1.UnionDelayRemoveConfigHelper.GetUnionDelayRemoveConfigObject(e)) && (this.FSh = UnionDelayRemoveConfigHelper_1.UnionDelayRemoveConfigHelper.ReadUnionDelayRemoveConfig(e, this.FbDataInternal.delayReMove(t))), this.FSh
  }
}
