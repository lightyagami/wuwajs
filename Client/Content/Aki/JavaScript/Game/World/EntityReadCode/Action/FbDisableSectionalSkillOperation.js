...
class FbDisableSectionalSkillOperation {
  constructor(i) {
    this.FbDataInternal = i, this.u_h = !1, this.f8o = void 0, this.Dyh = !1, this.Byh = void 0, this.Jyh = !1, this.Zyh = void 0, this.Q5l = !1, this.K5l = !1
  }
  static Create(i) {
  ...
  get DisableExploreSkill() {
    return this.Jyh || (this.Jyh = !0, this.Zyh = FbDisableExploreSkill_1.FbDisableExploreSkill.Create(this.FbDataInternal.disableExploreSkill())), this.Zyh
  }
  get DisableSkillWheel() {
    return this.Q5l || (this.Q5l = !0, this.K5l = this.FbDataInternal.disableSkillWheel()), this.K5l
  }
}
