...
class FbModifyTargetSceneItemAttributeTag {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.pLh = !1, this.vLh = !1, this.gLh = !1, this.fLh = void 0, this.V1h = !1, this.j1h = void 0
  }
  static Create(t) {
  ...
  get IsAddTag() {
    return this.pLh || (this.pLh = !0, this.vLh = this.FbDataInternal.isAddTag()), this.vLh
  }
  get PerformanceTag() {
    if (!this.gLh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.fLh.push(this.FbDataInternal.performanceTag(t))
    }
    return this.fLh
  }
  get EntityIds() {
