...
class FbAddBuffToEntity {
  constructor(t) {
    this.FbDataInternal = t, this.a_h = !1, this.I9o = 0, this.V1h = !1, this.j1h = void 0, this.Vph = !1, this.jph = void 0, this.Hph = !1, this.Wph = void 0
  }
  static Create(t) {
  ...
  get BuffIds() {
    if (!this.Vph) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.jph.push(Number(this.FbDataInternal.buffIds(t) ?? 0))
    }
    return this.jph
  }
  get PersistOnOfflineBuffIds() {
    if (!this.Hph) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.Wph.push(Number(this.FbDataInternal.persistOnOfflineBuffIds(t) ?? 0))
    }
    return this.Wph
  }
}
