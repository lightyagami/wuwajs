...
class FbSetWuYinQuState {
  constructor(t) {
    this.FbDataInternal = t, this.Jph = !1, this.Zph = void 0, this.Bch = !1, this.Cbo = void 0
  }
  static Create(t) {
    if (t) return new FbSetWuYinQuState(t)
  }
  get WuYinQuName() {
    return this.Jph || (this.Jph = !0, this.Zph = this.FbDataInternal.wuYinQuName()), this.Zph
  }
  get State() {
