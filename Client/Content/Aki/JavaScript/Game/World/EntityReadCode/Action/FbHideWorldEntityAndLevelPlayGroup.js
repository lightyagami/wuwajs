...
class FbHideWorldEntityAndLevelPlayGroup {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.hxh = !1, this.lxh = void 0, this.oxh = !1, this.nxh = void 0, this._xh = !1, this.cxh = void 0, this.uxh = !1, this.dxh = void 0, this.P9_ = !1, this.x9_ = void 0
  }
  static Create(t) {
  ...
  get HideRangeEntities() {
    if (!this.hxh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.lxh.push(this.FbDataInternal.hideRangeEntities(t))
    }
    return this.lxh
  }
  get ExcludeEntities() {
  ...
  get ExcludeLevelPlays() {
    if (!this._xh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.cxh.push(this.FbDataInternal.excludeLevelPlays(t))
    }
    return this.cxh
  }
  get AppendEntities() {
    if (!this.uxh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.dxh.push(this.FbDataInternal.appendEntities(t))
    }
    return this.dxh
  }
  get AppendLevelPlays() {
    if (!this.P9_) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.x9_.push(this.FbDataInternal.appendLevelPlays(t))
    }
    return this.x9_
  }
}
