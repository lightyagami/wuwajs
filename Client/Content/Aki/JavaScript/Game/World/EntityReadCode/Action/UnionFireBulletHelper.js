...
exports.UnionFireBulletHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbFireBulletForwardFront_1 = require("./FbFireBulletForwardFront");
const FbFireBulletTrackPosition_1 = require("./FbFireBulletTrackPosition");
const FbFireBulletTrackTarget_1 = require("./FbFireBulletTrackTarget");
  ...
  static ReadUnionFireBullet(e, r) {
    if (r !== undefined) {
      switch (e) {
        ...
        case fb_action_1.UnionFireBullet.FireBulletTrackPosition:
          return FbFireBulletTrackPosition_1.FbFireBulletTrackPosition.Create(r);
        case fb_action_1.UnionFireBullet.FireBulletTrackTarget:
