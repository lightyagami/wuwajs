...
class FbEnableLevelPlay {
  constructor(e) {
    this.FbDataInternal = e, this.Gvh = !1, this.Ovh = void 0, this.AQl = !1, this.xQl = void 0
  }
  static Create(e) {
  ...
  get TargetPlayer() {
    return this.AQl || (this.AQl = !0, this.xQl = this.FbDataInternal.targetPlayer()), this.xQl
  }
}
