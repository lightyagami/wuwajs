...
class FbModifyActorMaterial {
  constructor(t) {
    this.FbDataInternal = t, this.PLh = !1, this.ULh = void 0, this.bSh = !1, this.TAe = void 0
  }
  static Create(t) {
  ...
  get Config() {
    var t, r;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), r = UnionModifyActorMaterialTypeHelper_1.UnionModifyActorMaterialTypeHelper.GetUnionModifyActorMaterialTypeObject(t)) && (this.TAe = UnionModifyActorMaterialTypeHelper_1.UnionModifyActorMaterialTypeHelper.ReadUnionModifyActorMaterialType(t, this.FbDataInternal.config(r))), this.TAe
  }
}
