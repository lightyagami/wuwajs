...
class FbSetBattleTagConfig {
  constructor(t) {
    this.FbDataInternal = t, this.a_h = !1, this.I9o = 0, this.Fvh = !1, this.Nvh = 0, this.Gfh = !1, this.Ofh = 0
  }
  static Create(t) {
  ...
  get TagConfigId() {
    return this.Fvh || (this.Fvh = !0, this.Nvh = this.FbDataInternal.tagConfigId()), this.Nvh
  }
  get DelayTime() {
