...
class FbInterludeActions {
  constructor(t) {
    this.FbDataInternal = t, this.uvh = !1, this.dvh = void 0, this.mvh = !1, this.Cvh = void 0, this.gvh = !1, this.fvh = !1, this.pvh = !1, this.vvh = !1
  }
  static Create(t) {
  ...
  get DestroyEntityIds() {
    if (!this.mvh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.Cvh.push(this.FbDataInternal.destroyEntityIds(t))
    }
    return this.Cvh
  }
  get IsFadeIn() {
    return this.gvh || (this.gvh = !0, this.fvh = this.FbDataInternal.isFadeIn()), this.fvh
  }
  get IsFadeOut() {
    return this.pvh || (this.pvh = !0, this.vvh = this.FbDataInternal.isFadeOut()), this.vvh
  }
}
