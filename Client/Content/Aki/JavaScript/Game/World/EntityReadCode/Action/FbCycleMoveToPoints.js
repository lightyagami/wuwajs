...
class FbCycleMoveToPoints {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.NEh = !1, this.VEh = void 0, this.Dfh = !1, this.Bfh = !1, this.jEh = !1, this.HEh = 0, this.WEh = !1, this.QEh = void 0
  }
  static Create(t) {
  ...
  get StopTime() {
    return this.jEh || (this.jEh = !0, this.HEh = this.FbDataInternal.stopTime()), this.HEh
  }
  get MoveMotion() {
    var t, i;
