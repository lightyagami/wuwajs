...
class FbEntityVarContext {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.tgh = !1, this.FFe = 0, this.qxh = !1, this.kxh = void 0
  }
  static Create(t) {
  ...
  get MatchType() {
    return this.qxh || (this.qxh = !0, this.kxh = this.FbDataInternal.matchType()), this.kxh
  }
}
