...
class FbChangeEntityStateLoop {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.a_h = !1, this.I9o = 0, this.Fch = !1, this.Nch = void 0
  }
  static Create(t) {
  ...
  get Circulation() {
    return this.Fch || (this.Fch = !0, this.Nch = this.FbDataInternal.circulation()), this.Nch
  }
}
