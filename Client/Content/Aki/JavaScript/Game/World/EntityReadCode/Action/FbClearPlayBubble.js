...
class FbClearPlayBubble {
  constructor(t) {
    this.FbDataInternal = t, this.V1h = !1, this.j1h = void 0, this.Mmh = !1, this.Emh = !1
  }
  static Create(t) {
  ...
  get OnlyClearRedDot() {
    return this.Mmh || (this.Mmh = !0, this.Emh = this.FbDataInternal.onlyClearRedDot()), this.Emh
  }
}
