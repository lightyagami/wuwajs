...
class FbAddBuffToPlayer {
  constructor(t) {
    this.FbDataInternal = t, this.Vph = !1, this.jph = void 0, this.Qph = !1, this.Kph = void 0
  }
  static Create(t) {
  ...
  get BuffIds() {
    if (!this.Vph) {
      ...
      if (s)
        for (let t = 0; t < s; ++t) this.jph.push(Number(this.FbDataInternal.buffIds(t) ?? 0))
    }
    return this.jph
  }
  get PersistOnDestroyBuffIds() {
    if (!this.Qph) {
      ...
      if (s)
        for (let t = 0; t < s; ++t) this.Kph.push(Number(this.FbDataInternal.persistOnDestroyBuffIds(t) ?? 0))
    }
    return this.Kph
  }
}
