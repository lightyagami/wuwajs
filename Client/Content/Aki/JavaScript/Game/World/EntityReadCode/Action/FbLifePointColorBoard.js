...
class FbLifePointColorBoard {
  constructor(t) {
    this.FbDataInternal = t, this.bSh = !1, this.TAe = void 0, this.TIh = !1, this.bIh = void 0, this.LIh = !1, this.AIh = void 0
  }
  static Create(t) {
  ...
  get Colors() {
    if (!this.TIh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.bIh.push(this.FbDataInternal.colors(t))
    }
    return this.bIh
  }
  get TargetColor() {
    return this.LIh || (this.LIh = !0, this.AIh = this.FbDataInternal.targetColor()), this.AIh
  }
}
