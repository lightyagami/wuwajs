...
exports.UnionPerformerAiMoveToConfigHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbPerformerAiMoveToEntity_1 = require("./FbPerformerAiMoveToEntity");
const FbPerformerAiMoveToPlayer_1 = require("./FbPerformerAiMoveToPlayer");
const FbPerformerAiMoveToPosition_1 = require("./FbPerformerAiMoveToPosition");
class UnionPerformerAiMoveToConfigHelper {
  ...
  static ReadUnionPerformerAiMoveToConfig(e, r) {
    if (r !== undefined) {
      switch (e) {
        case fb_action_1.UnionPerformerAiMoveToConfig.PerformerAiMoveToEntity:
          return FbPerformerAiMoveToEntity_1.FbPerformerAiMoveToEntity.Create(r);
        case fb_action_1.UnionPerformerAiMoveToConfig.PerformerAiMoveToPlayer:
          return FbPerformerAiMoveToPlayer_1.FbPerformerAiMoveToPlayer.Create(r);
        case fb_action_1.UnionPerformerAiMoveToConfig.PerformerAiMoveToPosition:
          return FbPerformerAiMoveToPosition_1.FbPerformerAiMoveToPosition.Create(r);
        default:
          return;
      }
    }
