...
class FbICenterTextTypeWriter {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.OCh = !1, this.FCh = 0
  }
  static Create(t) {
  ...
  get TextCountPerSecond() {
    return this.OCh || (this.OCh = !0, this.FCh = this.FbDataInternal.textCountPerSecond()), this.FCh
  }
}
