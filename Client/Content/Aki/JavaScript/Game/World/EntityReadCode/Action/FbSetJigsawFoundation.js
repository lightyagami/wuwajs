...
class FbSetJigsawFoundation {
  ...
  get Config() {
    var t, i;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), i = UnionSetJigsawFoundationHelper_1.UnionSetJigsawFoundationHelper.GetUnionSetJigsawFoundationObject(t)) && (this.TAe = UnionSetJigsawFoundationHelper_1.UnionSetJigsawFoundationHelper.ReadUnionSetJigsawFoundation(t, this.FbDataInternal.config(i))), this.TAe
  }
}
