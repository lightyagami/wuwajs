...
class FbClientTpRelativeEntityPos {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.svh = !1, this.avh = 0, this.hvh = !1, this.lvh = 0
  }
  static Create(t) {
  ...
  get SourcePosEntityId() {
    return this.svh || (this.svh = !0, this.avh = this.FbDataInternal.sourcePosEntityId()), this.avh
  }
  get TargetPosEntityId() {
    return this.hvh || (this.hvh = !0, this.lvh = this.FbDataInternal.targetPosEntityId()), this.lvh
  }
}
