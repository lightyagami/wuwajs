...
class FbTeleportTransitionWithCenterText {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.evh = !1, this.tvh = void 0
  }
  static Create(t) {
  ...
  get CenterTextFlow() {
    return this.evh || (this.evh = !0, this.tvh = FbPlayFlow_1.FbPlayFlow.Create(this.FbDataInternal.centerTextFlow())), this.tvh
  }
}
