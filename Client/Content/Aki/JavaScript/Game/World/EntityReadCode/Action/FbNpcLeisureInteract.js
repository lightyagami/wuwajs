...
class FbNpcLeisureInteract {
  ...
  get Option() {
    var e, t;
    return !this.s_h && (this.s_h = !0, e = this.FbDataInternal.optionType(), t = UnionNpcLeisureInteractOpHelper_1.UnionNpcLeisureInteractOpHelper.GetUnionNpcLeisureInteractOpObject(e)) && (this.Hye = UnionNpcLeisureInteractOpHelper_1.UnionNpcLeisureInteractOpHelper.ReadUnionNpcLeisureInteractOp(e, this.FbDataInternal.option(t))), this.Hye
  }
}
