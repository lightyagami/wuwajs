...
class UnionSummonEntityTypeHelper {
  static GetUnionSummonEntityTypeObject(e) {
    if (e === fb_action_1.UnionSummonEntityType.SummonVehicle) return new fb_action_1.SummonVehicle
  }
  static ReadUnionSummonEntityType(e, t) {
    return void 0 !== t && e === fb_action_1.UnionSummonEntityType.SummonVehicle ? FbSummonVehicle_1.FbSummonVehicle.Create(t) : void 0
  }
}
