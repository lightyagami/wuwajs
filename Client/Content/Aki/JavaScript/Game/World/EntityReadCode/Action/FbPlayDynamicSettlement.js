...
class FbPlayDynamicSettlement {
  ...
  get DynamicSettlementConfig() {
    var e, t;
    return !this.kAh && (this.kAh = !0, e = this.FbDataInternal.dynamicSettlementConfigType(), t = UnionDynamicSettlementConfigHelper_1.UnionDynamicSettlementConfigHelper.GetUnionDynamicSettlementConfigObject(e)) && (this.GAh = UnionDynamicSettlementConfigHelper_1.UnionDynamicSettlementConfigHelper.ReadUnionDynamicSettlementConfig(e, this.FbDataInternal.dynamicSettlementConfig(t))), this.GAh
  }
}
