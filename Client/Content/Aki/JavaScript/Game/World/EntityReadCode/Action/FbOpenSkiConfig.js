...
class FbOpenSkiConfig {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.ldh = !1, this.NHo = void 0, this.Qbh = !1, this.Kbh = void 0
  }
  static Create(t) {
  ...
  get SkiConfig() {
    return this.Qbh || (this.Qbh = !0, this.Kbh = this.FbDataInternal.skiConfig()), this.Kbh
  }
}
