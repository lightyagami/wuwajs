...
class FbAdjustFixedCamera {
  ...
  get CenterPos() {
    return this.yTh || (this.yTh = !0, this.STh = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.centerPos())), this.STh
  }
  get CenterRot() {
    return this.MTh || (this.MTh = !0, this.ETh = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.centerRot())), this.ETh
  }
  get BlendIn() {
    return this.ITh || (this.ITh = !0, this.TTh = FbBlendFunction_1.FbBlendFunction.Create(this.FbDataInternal.blendIn())), this.TTh
  }
  get BlendOut() {
    return this.bTh || (this.bTh = !0, this.LTh = FbBlendFunction_1.FbBlendFunction.Create(this.FbDataInternal.blendOut())), this.LTh
  }
}
