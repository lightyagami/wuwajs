...
class FbRecordDungeonEvent {
  ...
  get EventConfig() {
    var e, n;
    return !this.BEh && (this.BEh = !0, e = this.FbDataInternal.eventConfigType(), n = UnionDungeonEventTypeHelper_1.UnionDungeonEventTypeHelper.GetUnionDungeonEventTypeObject(e)) && (this.qEh = UnionDungeonEventTypeHelper_1.UnionDungeonEventTypeHelper.ReadUnionDungeonEventType(e, this.FbDataInternal.eventConfig(n))), this.qEh
  }
}
