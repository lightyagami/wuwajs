...
class FbSwitchPermission {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.qH_ = !1, this.OH_ = !1, this.GH_ = !1, this.FH_ = void 0
  }
  static Create(t) {
  ...
  get IsAllowClientSwitch() {
    return this.qH_ || (this.qH_ = !0, this.OH_ = this.FbDataInternal.isAllowClientSwitch()), this.OH_
  }
  get Levels() {
    if (!this.GH_) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.FH_.push(this.FbDataInternal.levels(t))
    }
    return this.FH_
  }
}
