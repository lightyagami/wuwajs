...
class FbHideSpecifyEntityGroup {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.V1h = !1, this.j1h = void 0, this.R9_ = !1, this.A9_ = !1
  }
  static Create(t) {
  ...
  get ForceClean() {
    return this.R9_ || (this.R9_ = !0, this.A9_ = this.FbDataInternal.forceClean()), this.A9_
  }
}
