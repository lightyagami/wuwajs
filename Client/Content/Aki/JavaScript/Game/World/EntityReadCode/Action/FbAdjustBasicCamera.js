...
exports.FbAdjustBasicCamera = undefined;
...
class FbAdjustBasicCamera {
  ...
  static Create(t) {
    if (t) {
      return new FbAdjustBasicCamera(t);
    }
  }
  get Type() {
    if (!this.u_h) {
  ...
  get OverlayArmLength() {
    if (!this._Th) {
      this._Th = true;
      this.cTh = this.FbDataInternal.overlayArmLength();
    }
    return this.cTh;
  }
  get SightUi() {
    if (!this.uTh) {
      this.uTh = true;
      this.dTh = this.FbDataInternal.sightUi();
    }
    return this.dTh;
  }
  get IsSynchronous() {
    if (!this.mTh) {
      this.mTh = true;
      this.CTh = this.FbDataInternal.isSynchronous();
    }
    return this.CTh;
  }
}
