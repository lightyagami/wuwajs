...
class FbAdjustBasicCamera {
  ...
  get OverlayArmLength() {
    return this._Th || (this._Th = !0, this.cTh = this.FbDataInternal.overlayArmLength()), this.cTh
  }
  get SightUi() {
    return this.uTh || (this.uTh = !0, this.dTh = this.FbDataInternal.sightUi()), this.dTh
  }
  get IsSynchronous() {
    return this.mTh || (this.mTh = !0, this.CTh = this.FbDataInternal.isSynchronous()), this.CTh
  }
}
