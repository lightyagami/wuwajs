...
exports.UnionActorLookAtDataHelper = undefined;
const fb_action_1 = require("../../../../Game/World/EntityFb/fb-action");
const FbActorLookAtEmptyData_1 = require("./FbActorLookAtEmptyData");
const FbActorLookAtEntityData_1 = require("./FbActorLookAtEntityData");
const FbActorLookAtOtherActor_1 = require("./FbActorLookAtOtherActor");
const FbActorLookAtPlayerData_1 = require("./FbActorLookAtPlayerData");
const FbActorLookAtPositionData_1 = require("./FbActorLookAtPositionData");
const FbActorLookAtTalkerData_1 = require("./FbActorLookAtTalkerData");
const FbActorLookAtUnLock_1 = require("./FbActorLookAtUnLock");
  ...
  static ReadUnionActorLookAtData(t, o) {
    if (o !== undefined) {
      switch (t) {
        ...
        case fb_action_1.UnionActorLookAtData.ActorLookAtPositionData:
          return FbActorLookAtPositionData_1.FbActorLookAtPositionData.Create(o);
        case fb_action_1.UnionActorLookAtData.ActorLookAtTalkerData:
