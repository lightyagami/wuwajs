...
class FbSkiConfig {
  ...
  get Config() {
    var i, t;
    return !this.bSh && (this.bSh = !0, i = this.FbDataInternal.configType(), t = UnionSkiConfigHelper_1.UnionSkiConfigHelper.GetUnionSkiConfigObject(i)) && (this.TAe = UnionSkiConfigHelper_1.UnionSkiConfigHelper.ReadUnionSkiConfig(i, this.FbDataInternal.config(t))), this.TAe
  }
}
