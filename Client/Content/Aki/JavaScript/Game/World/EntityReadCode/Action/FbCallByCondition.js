...
class FbCallByCondition {
  constructor(t) {
    this.FbDataInternal = t, this.ich = !1, this.rch = void 0, this.och = !1, this.nch = void 0, this.sch = !1, this.ach = void 0
  }
  static Create(t) {
    if (t) return new FbCallByCondition(t)
  }
  get Conditions() {
    return this.ich || (this.ich = !0, this.rch = FbConditions_1.FbConditions.Create(this.FbDataInternal.conditions())), this.rch
  }
  get TrueActions() {
    if (!this.och) {
