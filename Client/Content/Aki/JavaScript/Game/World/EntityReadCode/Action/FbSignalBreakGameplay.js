...
class FbSignalBreakGameplay {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.GTh = !1, this.OTh = void 0
  }
  static Create(t) {
  ...
  get SignalBreakId() {
    return this.GTh || (this.GTh = !0, this.OTh = this.FbDataInternal.signalBreakId()), this.OTh
  }
}
