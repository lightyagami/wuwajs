...
class FbSimpleMove {
  constructor(t) {
    this.FbDataInternal = t, this.i_h = !1, this.r_h = 0, this.Mph = !1, this.Eph = 0, this.uch = !1, this.dch = void 0
  }
  static Create(t) {
  ...
  get UseTime() {
    return this.Mph || (this.Mph = !0, this.Eph = this.FbDataInternal.useTime()), this.Eph
  }
  get Pos() {
