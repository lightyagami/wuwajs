...
class UnionAwakePosOptionHelper {
  static GetUnionAwakePosOptionObject(e) {
    if (e === fb_action_1.UnionAwakePosOption.AwakeWithTransformVar) return new fb_action_1.AwakeWithTransformVar
  }
  static ReadUnionAwakePosOption(e, o) {
    return void 0 !== o && e === fb_action_1.UnionAwakePosOption.AwakeWithTransformVar ? FbAwakeWithTransformVar_1.FbAwakeWithTransformVar.Create(o) : void 0
  }
}
