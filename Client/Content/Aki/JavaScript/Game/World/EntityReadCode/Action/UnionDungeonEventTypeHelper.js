...
class UnionDungeonEventTypeHelper {
  static GetUnionDungeonEventTypeObject(e) {
    if (e === fb_action_1.UnionDungeonEventType.RecordTimeStampType) return new fb_action_1.RecordTimeStampType
  }
  static ReadUnionDungeonEventType(e, n) {
    return void 0 !== n && e === fb_action_1.UnionDungeonEventType.RecordTimeStampType ? FbRecordTimeStampType_1.FbRecordTimeStampType.Create(n) : void 0
  }
}
