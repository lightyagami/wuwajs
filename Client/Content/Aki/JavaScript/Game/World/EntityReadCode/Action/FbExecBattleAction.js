...
class FbExecBattleAction {
  ...
  get BattleOption() {
    var t, e;
    return !this.qvh && (this.qvh = !0, t = this.FbDataInternal.battleOptionType(), e = UnionExecBattleOptionHelper_1.UnionExecBattleOptionHelper.GetUnionExecBattleOptionObject(t)) && (this.kvh = UnionExecBattleOptionHelper_1.UnionExecBattleOptionHelper.ReadUnionExecBattleOption(t, this.FbDataInternal.battleOption(e))), this.kvh
  }
}
