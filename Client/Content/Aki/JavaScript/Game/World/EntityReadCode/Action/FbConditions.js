...
class FbConditions {
  constructor(t) {
    this.FbDataInternal = t, this.hch = !1, this.lch = void 0, this.ich = !1, this.rch = void 0
  }
  static Create(t) {
    if (t) return new FbConditions(t)
  }
  get LogicOpType() {
    return this.hch || (this.hch = !0, this.lch = this.FbDataInternal.logicOpType()), this.lch
  }
  get Conditions() {
    if (!this.ich) {
