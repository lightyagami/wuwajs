...
class FbShowTalkOutline {
  constructor(t) {
    this.FbDataInternal = t, this.CCh = !1, this.gCh = 0, this.lph = !1, this._ph = void 0, this.vCh = !1, this.yCh = void 0
  }
  static Create(t) {
  ...
  get TidOutline() {
    return this.lph || (this.lph = !0, this._ph = this.FbDataInternal.tidOutline()), this._ph
  }
  get PlotLineKey() {
