...
exports.UnionParamsPresetHelper = undefined;
const fb_var_1 = require("../../../../Game/World/EntityFb/fb-var");
const FbDecalParams_1 = require("./FbDecalParams");
const FbRushWarningEffectParams_1 = require("./FbRushWarningEffectParams");
  ...
  static ReadUnionParamsPreset(e, r) {
    if (r !== undefined) {
      switch (e) {
        ...
        case fb_var_1.UnionParamsPreset.RushWarningEffectParams:
          return FbRushWarningEffectParams_1.FbRushWarningEffectParams.Create(r);
        default:
          return;
      }
    }
