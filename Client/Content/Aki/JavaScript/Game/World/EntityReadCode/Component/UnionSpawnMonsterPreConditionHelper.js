...
class UnionSpawnMonsterPreConditionHelper {
  static GetUnionSpawnMonsterPreConditionObject(e) {
    if (e === fb_component_1.UnionSpawnMonsterPreCondition.SpawnMonsterPreDependOnPreceding) return new fb_component_1.SpawnMonsterPreDependOnPreceding
  }
  static ReadUnionSpawnMonsterPreCondition(e, n) {
    return void 0 !== n && e === fb_component_1.UnionSpawnMonsterPreCondition.SpawnMonsterPreDependOnPreceding ? FbSpawnMonsterPreDependOnPreceding_1.FbSpawnMonsterPreDependOnPreceding.Create(n) : void 0
  }
}
