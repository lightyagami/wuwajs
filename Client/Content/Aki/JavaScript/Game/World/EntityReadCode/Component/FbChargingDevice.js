...
class FbChargingDevice {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.nWh = !1, this.Fke = 0, this.sWh = !1, this.aWh = 0, this.hWh = !1, this.lWh = 0, this._Wh = !1, this.cWh = 0, this.AWh = !1, this.xWh = 0
  }
  static Create(t) {
  ...
  get HitExtraValue() {
    return this.AWh || (this.AWh = !0, this.xWh = this.FbDataInternal.hitExtraValue()), this.xWh
  }
}
