...
class FbInteractGearComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.x6h = !1, this.R6h = 0, this.w6h = !1, this.P6h = 0
  }
  static Create(t) {
  ...
  get NormalPrepareTime() {
    return this.x6h || (this.x6h = !0, this.R6h = this.FbDataInternal.normalPrepareTime()), this.R6h
  }
  get ActivePrepareTime() {
    return this.w6h || (this.w6h = !0, this.P6h = this.FbDataInternal.activePrepareTime()), this.P6h
  }
}
