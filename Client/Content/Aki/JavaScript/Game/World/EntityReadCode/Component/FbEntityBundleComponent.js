...
class FbEntityBundleComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.j9l = !1, this.H9l = 0, this.W9l = !1, this.Q9l = void 0
  }
  static Create(t) {
  ...
  get BundleId() {
    return this.j9l || (this.j9l = !0, this.H9l = this.FbDataInternal.bundleId()), this.H9l
  }
  get ChildInfos() {
    if (!this.W9l) {
