...
class FbSearchTargetCfg {
  constructor(t) {
    this.FbDataInternal = t, this._2h = !1, this.c2h = void 0, this.u2h = !1, this.d2h = void 0, this.Kn_ = !1, this.$n_ = !1
  }
  static Create(t) {
  ...
  get IgnoreDistanceWeight() {
    return this.Kn_ || (this.Kn_ = !0, this.$n_ = this.FbDataInternal.ignoreDistanceWeight()), this.$n_
  }
}
