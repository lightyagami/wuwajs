...
class FbBuffConsumerComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.I5h = !1, this.T5h = 0, this.p0h = !1, this.nXs = 0, this.A5h = !1, this.x5h = 0
  }
  static Create(t) {
  ...
  get ProducerEntityId() {
    return this.A5h || (this.A5h = !0, this.x5h = this.FbDataInternal.producerEntityId()), this.x5h
  }
}
