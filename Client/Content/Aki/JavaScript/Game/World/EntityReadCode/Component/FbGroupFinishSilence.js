...
class FbGroupFinishSilence {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.$Oh = !1, this.XOh = void 0
  }
  static Create(t) {
  ...
  get SwitchSpecifiedStatus() {
    return this.$Oh || (this.$Oh = !0, this.XOh = FbEntityState_1.FbEntityState.Create(this.FbDataInternal.switchSpecifiedStatus())), this.XOh
  }
}
