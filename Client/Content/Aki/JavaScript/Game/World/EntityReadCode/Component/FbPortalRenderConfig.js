...
class FbPortalRenderConfig {
  constructor(e) {
    this.FbDataInternal = e, this.GKh = !1, this.OKh = void 0, this.FKh = !1, this.NKh = void 0, this.VKh = !1, this.jKh = void 0
  }
  static Create(e) {
  ...
  get ViewDistance() {
    var e, t;
    return !this.GKh && (this.GKh = !0, e = this.FbDataInternal.viewDistanceType(), t = UnionPortalViewDistanceConfigHelper_1.UnionPortalViewDistanceConfigHelper.GetUnionPortalViewDistanceConfigObject(e)) && (this.OKh = UnionPortalViewDistanceConfigHelper_1.UnionPortalViewDistanceConfigHelper.ReadUnionPortalViewDistanceConfig(e, this.FbDataInternal.viewDistance(t))), this.OKh
  }
