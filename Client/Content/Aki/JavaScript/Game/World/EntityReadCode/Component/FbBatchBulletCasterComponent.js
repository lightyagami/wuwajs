...
class FbBatchBulletCasterComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.hXh = !1, this.lXh = void 0, this.QY_ = !1, this.KY_ = void 0, this._Xh = !1, this.cXh = void 0, this.uXh = !1, this.dXh = void 0
  }
  static Create(t) {
  ...
  get WarningEffect() {
    return this.hXh || (this.hXh = !0, this.lXh = this.FbDataInternal.warningEffect()), this.lXh
  }
  get MovementType() {
    return this.QY_ || (this.QY_ = !0, this.KY_ = this.FbDataInternal.movementType()), this.KY_
  }
  get BulletList() {
    if (!this._Xh) {
