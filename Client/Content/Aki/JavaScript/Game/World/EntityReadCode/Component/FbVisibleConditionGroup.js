      ...
      if (o)
        for (let i = 0; i < o; ++i) {
          var t = this.FbDataInternal.conditionsType(i),
            e = UnionVisibleConditionHelper_1.UnionVisibleConditionHelper.GetUnionVisibleConditionObject(t);
          e && void 0 !== (t = UnionVisibleConditionHelper_1.UnionVisibleConditionHelper.ReadUnionVisibleCondition(t, this.FbDataInternal.conditions(i, e))) && this.rch.push(t)
        }
    }
    return this.rch
  }
