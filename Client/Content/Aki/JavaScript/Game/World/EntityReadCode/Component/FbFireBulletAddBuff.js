...
class FbFireBulletAddBuff {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.p0h = !1, this.nXs = 0, this.b5h = !1, this.L5h = void 0
  }
  static Create(t) {
  ...
  get BulletOffset() {
    return this.b5h || (this.b5h = !0, this.L5h = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.bulletOffset())), this.L5h
  }
}
