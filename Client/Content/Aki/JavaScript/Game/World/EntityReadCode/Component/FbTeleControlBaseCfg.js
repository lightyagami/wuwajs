...
class FbTeleControlBaseCfg {
  constructor(t) {
    this.FbDataInternal = t, this.o2h = !1, this.n2h = void 0, this.s2h = !1, this.a2h = !1, this.h2h = !1, this.l2h = !1
  }
  static Create(t) {
  ...
  get CanRotate() {
    return this.s2h || (this.s2h = !0, this.a2h = this.FbDataInternal.canRotate()), this.a2h
  }
  get InitialGravity() {
    return this.h2h || (this.h2h = !0, this.l2h = this.FbDataInternal.initialGravity()), this.l2h
  }
}
