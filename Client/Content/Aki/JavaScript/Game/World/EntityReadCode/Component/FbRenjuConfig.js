...
class FbRenjuConfig {
  constructor(t) {
    this.FbDataInternal = t, this.bNh = !1, this.LNh = void 0, this.FOh = !1, this.NOh = void 0, this.ANh = !1, this.xNh = 0, this.V1h = !1, this.j1h = void 0, this.L_h = !1, this.A_h = void 0
  }
  static Create(t) {
    if (t) return new FbRenjuConfig(t)
  }
  get Controller() {
    return this.bNh || (this.bNh = !0, this.LNh = this.FbDataInternal.controller()), this.LNh
  }
  get Order() {
    return this.FOh || (this.FOh = !0, this.NOh = this.FbDataInternal.order()), this.NOh
  }
  get RenjuCount() {
    return this.ANh || (this.ANh = !0, this.xNh = this.FbDataInternal.renjuCount()), this.xNh
  }
  get EntityIds() {
    if (!this.V1h) {
