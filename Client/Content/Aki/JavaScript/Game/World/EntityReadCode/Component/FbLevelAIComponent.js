...
class FbLevelAIComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Dxh = !1, this.Bxh = void 0, this.JRh = !1, this.ZRh = void 0
  }
  static Create(t) {
  ...
  get BtTreeAsset() {
    return this.JRh || (this.JRh = !0, this.ZRh = this.FbDataInternal.btTreeAsset()), this.ZRh
  }
}
