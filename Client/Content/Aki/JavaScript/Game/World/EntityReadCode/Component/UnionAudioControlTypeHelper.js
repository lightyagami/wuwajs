...
class UnionAudioControlTypeHelper {
  static GetUnionAudioControlTypeObject(o) {
    if (o === fb_component_1.UnionAudioControlType.GramophoneAudioControl) return new fb_component_1.GramophoneAudioControl
  }
  static ReadUnionAudioControlType(o, e) {
    return void 0 !== e && o === fb_component_1.UnionAudioControlType.GramophoneAudioControl ? FbGramophoneAudioControl_1.FbGramophoneAudioControl.Create(e) : void 0
  }
}
