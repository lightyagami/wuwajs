...
class FbPhotoTargetComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.B7h = !1, this.q7h = void 0, this.k7h = !1, this.G7h = void 0, this.O7h = !1, this.F7h = void 0
  }
  static Create(t) {
  ...
  get TargetCapturePromptUi() {
    var t, e;
    return !this.k7h && (this.k7h = !0, t = this.FbDataInternal.targetCapturePromptUiType(), e = UnionPhotoTargetCaptureUiHelper_1.UnionPhotoTargetCaptureUiHelper.GetUnionPhotoTargetCaptureUiObject(t)) && (this.G7h = UnionPhotoTargetCaptureUiHelper_1.UnionPhotoTargetCaptureUiHelper.ReadUnionPhotoTargetCaptureUi(t, this.FbDataInternal.targetCapturePromptUi(e))), this.G7h
  }
  get RayCastIgnoreEntities() {
    if (!this.O7h) {
      ...
      if (e)
        for (let t = 0; t < e; ++t) this.F7h.push(this.FbDataInternal.rayCastIgnoreEntities(t))
    }
    return this.F7h
  }
}
