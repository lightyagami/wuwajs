...
class FbItemFoundation2 {
  ...
  get Config() {
    var t, i;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), i = UnionItemFoundationHelper_1.UnionItemFoundationHelper.GetUnionItemFoundationObject(t)) && (this.TAe = UnionItemFoundationHelper_1.UnionItemFoundationHelper.ReadUnionItemFoundation(t, this.FbDataInternal.config(i))), this.TAe
  }
}
