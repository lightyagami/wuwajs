...
class FbCategoryMatchingConfig {
  constructor(t) {
    this.FbDataInternal = t, this.f_h = !1, this.X6o = void 0, this._Fh = !1, this.cFh = void 0, this.uFh = !1, this.dFh = void 0, this.mFh = !1, this.CFh = void 0
  }
  static Create(t) {
  ...
  get Animation() {
    return this._Fh || (this._Fh = !0, this.cFh = FbCategoryMatchingAnimation_1.FbCategoryMatchingAnimation.Create(this.FbDataInternal.animation())), this.cFh
  }
  get Callback() {
  ...
  get ItemLockingConfig() {
    return this.mFh || (this.mFh = !0, this.CFh = FbItemLockingConfig_1.FbItemLockingConfig.Create(this.FbDataInternal.itemLockingConfig())), this.CFh
  }
}
