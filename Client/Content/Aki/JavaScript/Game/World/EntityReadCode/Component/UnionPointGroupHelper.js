...
class UnionPointGroupHelper {
  static GetUnionPointGroupObject(o) {
    if (o === fb_component_1.UnionPointGroup.PointGroupByLayer) return new fb_component_1.PointGroupByLayer
  }
  static ReadUnionPointGroup(o, e) {
    return void 0 !== e && o === fb_component_1.UnionPointGroup.PointGroupByLayer ? FbPointGroupByLayer_1.FbPointGroupByLayer.Create(e) : void 0
  }
}
