...
class FbSceneItemMovementComponent {
  constructor(e) {
    this.FbDataInternal = e, this.q_h = !1, this.k_h = !1, this.qRh = !1, this.kRh = void 0
  }
  static Create(e) {
  ...
  get Patrol() {
    var e, t;
    return !this.qRh && (this.qRh = !0, e = this.FbDataInternal.patrolType(), t = UnionMovementModeHelper_1.UnionMovementModeHelper.GetUnionMovementModeObject(e)) && (this.kRh = UnionMovementModeHelper_1.UnionMovementModeHelper.ReadUnionMovementMode(e, this.FbDataInternal.patrol(t))), this.kRh
  }
}
