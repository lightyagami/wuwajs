...
class FbTurntableControlComponent {
  ...
  get Config() {
    var t, e;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), e = UnionTurntableControllerHelper_1.UnionTurntableControllerHelper.GetUnionTurntableControllerObject(t)) && (this.TAe = UnionTurntableControllerHelper_1.UnionTurntableControllerHelper.ReadUnionTurntableController(t, this.FbDataInternal.config(e))), this.TAe
  }
}
