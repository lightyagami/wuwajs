...
class FbFollowTrackComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.M_h = !1, this.E_h = 0, this.kuh = !1, this.Guh = 0, this.Q6h = !1, this.K6h = void 0
  }
  static Create(t) {
  ...
  get EndType() {
    var t, i;
    return !this.Q6h && (this.Q6h = !0, t = this.FbDataInternal.endTypeType(), i = UnionFollowTrackEndOptionHelper_1.UnionFollowTrackEndOptionHelper.GetUnionFollowTrackEndOptionObject(t)) && (this.K6h = UnionFollowTrackEndOptionHelper_1.UnionFollowTrackEndOptionHelper.ReadUnionFollowTrackEndOption(t, this.FbDataInternal.endType(i))), this.K6h
  }
}
