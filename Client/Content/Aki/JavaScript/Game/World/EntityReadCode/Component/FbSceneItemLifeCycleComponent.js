...
class FbSceneItemLifeCycleComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.J6h = !1, this.Z6h = void 0, this.ejh = !1, this.tjh = void 0
  }
  static Create(t) {
  ...
  get CreateStageConfig() {
    return this.J6h || (this.J6h = !0, this.Z6h = FbCreateStageConfig_1.FbCreateStageConfig.Create(this.FbDataInternal.createStageConfig())), this.Z6h
  }
  get DestroyStageConfig() {
    return this.ejh || (this.ejh = !0, this.tjh = FbDestroyStageConfig_1.FbDestroyStageConfig.Create(this.FbDataInternal.destroyStageConfig())), this.tjh
  }
}
