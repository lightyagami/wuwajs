...
class FbSceneBulletComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.ejl = !1, this.tjl = !1, this.a7h = !1, this.h7h = void 0
  }
  static Create(t) {
  ...
  get DisableGenerateByRange() {
    return this.ejl || (this.ejl = !0, this.tjl = this.FbDataInternal.disableGenerateByRange()), this.tjl
  }
  get BulletGroups() {
    if (!this.a7h) {
