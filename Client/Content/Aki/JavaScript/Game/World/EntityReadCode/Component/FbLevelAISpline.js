...
class FbLevelAISpline {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.a_h = !1, this.I9o = 0, this.u9h = !1, this.d9h = void 0, this.m9h = !1, this.C9h = !1, this.g9h = !1, this.f9h = !1, this.NEh = !1, this.VEh = void 0
  }
  static Create(t) {
  ...
  get CycleOption() {
    var t, i;
    return !this.u9h && (this.u9h = !0, t = this.FbDataInternal.cycleOptionType(), i = UnionLevelAiCycleOptionHelper_1.UnionLevelAiCycleOptionHelper.GetUnionLevelAiCycleOptionObject(t)) && (this.d9h = UnionLevelAiCycleOptionHelper_1.UnionLevelAiCycleOptionHelper.ReadUnionLevelAiCycleOption(t, this.FbDataInternal.cycleOption(i))), this.d9h
  }
  get UsePathFinding() {
    return this.m9h || (this.m9h = !0, this.C9h = this.FbDataInternal.usePathFinding()), this.C9h
  }
  get IsPassEveryKeyPoint() {
    return this.g9h || (this.g9h = !0, this.f9h = this.FbDataInternal.isPassEveryKeyPoint()), this.f9h
  }
  get Points() {
    if (!this.NEh) {
