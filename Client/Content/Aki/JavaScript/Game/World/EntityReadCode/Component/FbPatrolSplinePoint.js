...
class FbPatrolSplinePoint {
  constructor(t) {
    this.FbDataInternal = t, this.dph = !1, this.Cqn = void 0, this.VHh = !1, this.jHh = void 0, this.HHh = !1, this.WHh = void 0, this.QHh = !1, this.KHh = void 0, this.$Hh = !1, this.XHh = void 0, this.Nuh = !1, this.Vuh = void 0, this.p9h = !1, this.v9h = void 0, this.YHh = !1, this.zHh = 0, this.JHh = !1, this.ZHh = !1, this.gch = !1, this.fch = 0, this.e7h = !1, this.t7h = !1, this.L_h = !1, this.A_h = void 0
  }
  static Create(t) {
  ...
  get CharPositionState() {
    return this.p9h || (this.p9h = !0, this.v9h = this.FbDataInternal.charPositionState()), this.v9h
  }
  get MoveSpeed() {
    return this.YHh || (this.YHh = !0, this.zHh = this.FbDataInternal.moveSpeed()), this.zHh
  }
  get IgnorePoint() {
    return this.JHh || (this.JHh = !0, this.ZHh = this.FbDataInternal.ignorePoint()), this.ZHh
  }
  get StayTime() {
    return this.gch || (this.gch = !0, this.fch = this.FbDataInternal.stayTime()), this.fch
  }
  get IsHide() {
    return this.e7h || (this.e7h = !0, this.t7h = this.FbDataInternal.isHide()), this.t7h
  }
  get Actions() {
    if (!this.L_h) {
