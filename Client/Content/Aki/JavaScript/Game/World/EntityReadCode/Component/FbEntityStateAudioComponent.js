...
class FbEntityStateAudioComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.D8h = !1, this.B8h = void 0, this.q8h = !1, this.k8h = void 0, this.bSh = !1, this.TAe = void 0
  }
  static Create(t) {
  ...
  get AkEventType() {
    var t, i;
    return !this.D8h && (this.D8h = !0, t = this.FbDataInternal.akEventTypeType(), i = UnionAkEventTypeHelper_1.UnionAkEventTypeHelper.GetUnionAkEventTypeObject(t)) && (this.B8h = UnionAkEventTypeHelper_1.UnionAkEventTypeHelper.ReadUnionAkEventType(t, this.FbDataInternal.akEventType(i))), this.B8h
  }
  get AudioRangeType() {
