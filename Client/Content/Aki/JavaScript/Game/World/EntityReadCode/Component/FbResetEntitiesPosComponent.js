...
class FbResetEntitiesPosComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.M_h = !1, this.E_h = void 0, this.V1h = !1, this.j1h = void 0
  }
  static Create(t) {
  ...
  get Range() {
    var t, e;
    return !this.M_h && (this.M_h = !0, t = this.FbDataInternal.rangeType(), e = UnionTriggerShapeHelper_1.UnionTriggerShapeHelper.GetUnionTriggerShapeObject(t)) && (this.E_h = UnionTriggerShapeHelper_1.UnionTriggerShapeHelper.ReadUnionTriggerShape(t, this.FbDataInternal.range(e))), this.E_h
  }
  get EntityIds() {
    if (!this.V1h) {
