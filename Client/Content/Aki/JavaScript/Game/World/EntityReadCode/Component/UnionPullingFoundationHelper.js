...
class UnionPullingFoundationHelper {
  static GetUnionPullingFoundationObject(n) {
    if (n === fb_component_1.UnionPullingFoundation.PullingCategoryMatchingFoundation) return new fb_component_1.PullingCategoryMatchingFoundation
  }
  static ReadUnionPullingFoundation(n, o) {
    return void 0 !== o && n === fb_component_1.UnionPullingFoundation.PullingCategoryMatchingFoundation ? FbPullingCategoryMatchingFoundation_1.FbPullingCategoryMatchingFoundation.Create(o) : void 0
  }
}
