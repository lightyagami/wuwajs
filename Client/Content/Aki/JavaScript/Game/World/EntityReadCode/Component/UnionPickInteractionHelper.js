...
class UnionPickInteractionHelper {
  static GetUnionPickInteractionObject(n) {
    if (n === fb_component_1.UnionPickInteraction.ChessmanPickInteraction) return new fb_component_1.ChessmanPickInteraction
  }
  static ReadUnionPickInteraction(n, e) {
    return void 0 !== e && n === fb_component_1.UnionPickInteraction.ChessmanPickInteraction ? FbChessmanPickInteraction_1.FbChessmanPickInteraction.Create(e) : void 0
  }
}
