...
class FbVehicleAudioConfig {
  constructor(t) {
    this.FbDataInternal = t, this.d7l = !1, this.m7l = 0, this.C7l = !1, this.g7l = 0, this.Hq_ = !1, this.$q_ = void 0
  }
  static Create(t) {
  ...
  get AudioEvent() {
    return this.Hq_ || (this.Hq_ = !0, this.$q_ = this.FbDataInternal.audioEvent()), this.$q_
  }
}
