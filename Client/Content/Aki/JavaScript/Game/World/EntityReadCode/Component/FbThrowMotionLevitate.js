...
class FbThrowMotionLevitate {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.x2h = !1, this.R2h = 0, this.w2h = !1, this.P2h = void 0, this.Q2h = !1, this.K2h = 0, this.$2h = !1, this.X2h = 0, this.O2h = !1, this.F2h = void 0
  }
  static Create(t) {
  ...
  get MoveTime() {
    return this.Q2h || (this.Q2h = !0, this.K2h = this.FbDataInternal.moveTime()), this.K2h
  }
  get RayRadius() {
    return this.$2h || (this.$2h = !0, this.X2h = this.FbDataInternal.rayRadius()), this.X2h
  }
