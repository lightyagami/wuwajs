...
exports.UnionJigsawCompleteConditionHelper = undefined;
const fb_component_1 = require("../../../../Game/World/EntityFb/fb-component");
const FbActivateAllCorrectPiece_1 = require("./FbActivateAllCorrectPiece");
const FbActivateSpecifiedPiece_1 = require("./FbActivateSpecifiedPiece");
const FbActiveRenjuPiece_1 = require("./FbActiveRenjuPiece");
const FbPutInTheSpecifiedPiece_1 = require("./FbPutInTheSpecifiedPiece");
class UnionJigsawCompleteConditionHelper {
  ...
  static ReadUnionJigsawCompleteCondition(e, t) {
    if (t !== undefined) {
      switch (e) {
        case fb_component_1.UnionJigsawCompleteCondition.ActivateAllCorrectPiece:
          return FbActivateAllCorrectPiece_1.FbActivateAllCorrectPiece.Create(t);
        case fb_component_1.UnionJigsawCompleteCondition.ActivateSpecifiedPiece:
