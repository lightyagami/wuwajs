...
class UnionReboundOptionHelper {
  static GetUnionReboundOptionObject(o) {
    if (o === fb_component_1.UnionReboundOption.ForwardFrontRebound) return new fb_component_1.ForwardFrontRebound
  }
  static ReadUnionReboundOption(o, n) {
    return void 0 !== n && o === fb_component_1.UnionReboundOption.ForwardFrontRebound ? FbForwardFrontRebound_1.FbForwardFrontRebound.Create(n) : void 0
  }
}
