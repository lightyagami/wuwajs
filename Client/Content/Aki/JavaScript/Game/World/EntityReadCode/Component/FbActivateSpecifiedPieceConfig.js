...
class FbActivateSpecifiedPieceConfig {
  constructor(i) {
    this.FbDataInternal = i, this.MNh = !1, this.ENh = void 0, this.pFh = !1, this.vFh = void 0
  }
  static Create(i) {
    if (i) return new FbActivateSpecifiedPieceConfig(i)
  }
  get Jigsaw() {
    return this.MNh || (this.MNh = !0, this.ENh = FbJigsawConfig_1.FbJigsawConfig.Create(this.FbDataInternal.jigsaw())), this.ENh
  }
  get SelfState() {
