...
class UnionMovementModeHelper {
  static GetUnionMovementModeObject(e) {
    if (e === fb_component_1.UnionMovementMode.SplineMove) return new fb_component_1.SplineMove
  }
  static ReadUnionMovementMode(e, o) {
    return void 0 !== o && e === fb_component_1.UnionMovementMode.SplineMove ? FbSplineMove_1.FbSplineMove.Create(o) : void 0
  }
}
