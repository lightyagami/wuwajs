...
class FbEntityMatch {
  constructor(t) {
    this.FbDataInternal = t, this.Wkh = !1, this.Qkh = !1, this.Kkh = !1, this.$kh = !1, this.Xkh = !1, this.Ykh = void 0, this.Dxh = !1, this.Bxh = void 0, this.zkh = !1, this.Jkh = void 0
  }
  static Create(t) {
    if (t) return new FbEntityMatch(t)
  }
  get AllCharacter() {
    return this.Wkh || (this.Wkh = !0, this.Qkh = this.FbDataInternal.allCharacter()), this.Qkh
  }
  get OnlyPlayer() {
    return this.Kkh || (this.Kkh = !0, this.$kh = this.FbDataInternal.onlyPlayer()), this.$kh
  }
  get Categories() {
    if (!this.Xkh) {
  ...
  get PerformanceStates() {
    if (!this.zkh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.Jkh.push(this.FbDataInternal.performanceStates(t))
    }
    return this.Jkh
  }
}
