...
class FbNoRenderPortalComponent {
  ...
  get Config() {
    var e, t;
    return !this.bSh && (this.bSh = !0, e = this.FbDataInternal.configType(), t = UnionNoRenderPortalConfigHelper_1.UnionNoRenderPortalConfigHelper.GetUnionNoRenderPortalConfigObject(e)) && (this.TAe = UnionNoRenderPortalConfigHelper_1.UnionNoRenderPortalConfigHelper.ReadUnionNoRenderPortalConfig(e, this.FbDataInternal.config(t))), this.TAe
  }
}
