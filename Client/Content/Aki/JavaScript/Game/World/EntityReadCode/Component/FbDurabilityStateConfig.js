...
class FbDurabilityStateConfig {
  constructor(t) {
    this.FbDataInternal = t, this.y3h = !1, this.S3h = !1, this.M3h = !1, this.E3h = void 0
  }
  static Create(t) {
    if (t) return new FbDurabilityStateConfig(t)
  }
  get NonDestructable() {
    return this.y3h || (this.y3h = !0, this.S3h = this.FbDataInternal.nonDestructable()), this.S3h
  }
