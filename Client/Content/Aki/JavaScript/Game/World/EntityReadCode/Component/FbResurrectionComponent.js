...
class FbResurrectionComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.VVh = !1, this.jVh = void 0, this.y5h = !1, this.S5h = void 0, this.m0h = !1, this.C0h = void 0, this.yPh = !1, this.SPh = void 0
  }
  static Create(t) {
  ...
  get TriggerShape() {
    var t, i;
    return !this.y5h && (this.y5h = !0, t = this.FbDataInternal.triggerShapeType(), i = UnionTriggerShapeHelper_1.UnionTriggerShapeHelper.GetUnionTriggerShapeObject(t)) && (this.S5h = UnionTriggerShapeHelper_1.UnionTriggerShapeHelper.ReadUnionTriggerShape(t, this.FbDataInternal.triggerShape(i))), this.S5h
  }
  get ReviveId() {
    return this.m0h || (this.m0h = !0, this.C0h = this.FbDataInternal.reviveId()), this.C0h
  }
  get GravityConfig() {
