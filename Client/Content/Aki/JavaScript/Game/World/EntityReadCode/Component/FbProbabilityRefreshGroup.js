...
class FbProbabilityRefreshGroup {
  constructor(t) {
    this.FbDataInternal = t, this.cBh = !1, this.uBh = void 0, this.dBh = !1, this.mBh = void 0
  }
  static Create(t) {
    if (t) return new FbProbabilityRefreshGroup(t)
  }
  get CheckOccupation() {
    return this.cBh || (this.cBh = !0, this.uBh = this.FbDataInternal.checkOccupation()), this.uBh
  }
  get RefreshItems() {
    if (!this.dBh) {
