...
class FbSpawnMonsterComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Oqh = !1, this.Fqh = void 0, this.Nqh = !1, this.Vqh = void 0, this.jqh = !1, this.Hqh = !1, this.Wqh = !1, this.Qqh = void 0
  }
  static Create(t) {
  ...
  get ActiveType() {
    var t, n;
    return !this.Oqh && (this.Oqh = !0, t = this.FbDataInternal.activeTypeType(), n = UnionSpawnMonsterStartConditionHelper_1.UnionSpawnMonsterStartConditionHelper.GetUnionSpawnMonsterStartConditionObject(t)) && (this.Fqh = UnionSpawnMonsterStartConditionHelper_1.UnionSpawnMonsterStartConditionHelper.ReadUnionSpawnMonsterStartCondition(t, this.FbDataInternal.activeType(n))), this.Fqh
  }
  ...
  get IssharedHatred() {
    return this.jqh || (this.jqh = !0, this.Hqh = this.FbDataInternal.issharedHatred()), this.Hqh
  }
  get SpawnMonsterConstraintType() {
    var t, n;
    return !this.Wqh && (this.Wqh = !0, t = this.FbDataInternal.spawnMonsterConstraintTypeType(), n = UnionSpawnMonsterConstraintHelper_1.UnionSpawnMonsterConstraintHelper.GetUnionSpawnMonsterConstraintObject(t)) && (this.Qqh = UnionSpawnMonsterConstraintHelper_1.UnionSpawnMonsterConstraintHelper.ReadUnionSpawnMonsterConstraint(t, this.FbDataInternal.spawnMonsterConstraintType(n))), this.Qqh
  }
}
