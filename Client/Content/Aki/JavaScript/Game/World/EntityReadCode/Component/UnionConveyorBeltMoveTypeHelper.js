...
class UnionConveyorBeltMoveTypeHelper {
  static GetUnionConveyorBeltMoveTypeObject(e) {
    if (e === fb_component_1.UnionConveyorBeltMoveType.FixSpeed) return new fb_component_1.FixSpeed
  }
  static ReadUnionConveyorBeltMoveType(e, o) {
    return void 0 !== o && e === fb_component_1.UnionConveyorBeltMoveType.FixSpeed ? FbFixSpeed_1.FbFixSpeed.Create(o) : void 0
  }
}
