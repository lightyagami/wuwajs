...
class UnionSpawnMonsterConstraintHelper {
  static GetUnionSpawnMonsterConstraintObject(n) {
    if (n === fb_component_1.UnionSpawnMonsterConstraint.SpawnMonsterConstraintAnnularSector) return new fb_component_1.SpawnMonsterConstraintAnnularSector
  }
  static ReadUnionSpawnMonsterConstraint(n, t) {
    return void 0 !== t && n === fb_component_1.UnionSpawnMonsterConstraint.SpawnMonsterConstraintAnnularSector ? FbSpawnMonsterConstraintAnnularSector_1.FbSpawnMonsterConstraintAnnularSector.Create(t) : void 0
  }
}
