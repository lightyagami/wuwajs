...
class FbNpcPerformState {
  constructor(t) {
    this.FbDataInternal = t, this.wAh = !1, this.PAh = void 0, this.Gvh = !1, this.Ovh = void 0
  }
  static Create(t) {
    if (t) return new FbNpcPerformState(t)
  }
  get InitState() {
    return this.wAh || (this.wAh = !0, this.PAh = FbInitNpcPerformState_1.FbInitNpcPerformState.Create(this.FbDataInternal.initState())), this.PAh
  }
  get Configs() {
    if (!this.Gvh) {
