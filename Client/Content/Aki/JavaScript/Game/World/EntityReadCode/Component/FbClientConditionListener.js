...
class FbClientConditionListener {
  constructor(t) {
    this.FbDataInternal = t, this.f_h = !1, this.X6o = void 0, this.L_h = !1, this.A_h = void 0, this.XYh = !1, this.YYh = void 0
  }
  static Create(t) {
  ...
  get SendSelfEvent() {
    return this.XYh || (this.XYh = !0, this.YYh = this.FbDataInternal.sendSelfEvent()), this.YYh
  }
}
