...
class FbSpawnMonsterConfig {
  constructor(t) {
    this.FbDataInternal = t, this.tgh = !1, this.FFe = 0, this.Gfh = !1, this.Ofh = 0, this.Kqh = !1, this.$qh = void 0, this.Xqh = !1, this.Yqh = void 0, this.Hgh = !1, this.Wgh = void 0
  }
  static Create(t) {
  ...
  get TargetsToAwake() {
    if (!this.Kqh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.$qh.push(this.FbDataInternal.targetsToAwake(t))
    }
    return this.$qh
  }
  get CompleteCondition() {
    var t, i;
    return !this.Xqh && (this.Xqh = !0, t = this.FbDataInternal.completeConditionType(), i = UnionSpawnMonsterCompleteConditionHelper_1.UnionSpawnMonsterCompleteConditionHelper.GetUnionSpawnMonsterCompleteConditionObject(t)) && (this.Yqh = UnionSpawnMonsterCompleteConditionHelper_1.UnionSpawnMonsterCompleteConditionHelper.ReadUnionSpawnMonsterCompleteCondition(t, this.FbDataInternal.completeCondition(i))), this.Yqh
  }
  get PreCondition() {
    var t, i;
    return !this.Hgh && (this.Hgh = !0, t = this.FbDataInternal.preConditionType(), i = UnionSpawnMonsterPreConditionHelper_1.UnionSpawnMonsterPreConditionHelper.GetUnionSpawnMonsterPreConditionObject(t)) && (this.Wgh = UnionSpawnMonsterPreConditionHelper_1.UnionSpawnMonsterPreConditionHelper.ReadUnionSpawnMonsterPreCondition(t, this.FbDataInternal.preCondition(i))), this.Wgh
  }
}
