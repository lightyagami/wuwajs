...
class FbCategoryMatchingAnimation {
  constructor(t) {
    this.FbDataInternal = t, this.bFh = !1, this.LFh = void 0, this.AFh = !1, this.xFh = void 0, this.RFh = !1, this.wFh = void 0, this.PFh = !1, this.UFh = void 0, this.DFh = !1, this.BFh = void 0
  }
  static Create(t) {
  ...
  get MatchSequence() {
    return this.PFh || (this.PFh = !0, this.UFh = this.FbDataInternal.matchSequence()), this.UFh
  }
  get MatchSequenceOffset() {
    return this.DFh || (this.DFh = !0, this.BFh = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.matchSequenceOffset())), this.BFh
  }
}
