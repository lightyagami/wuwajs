...
class FbLevelPrefab {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.$Qh = !1, this.XQh = void 0, this.YQh = !1, this.zQh = void 0, this.zP_ = !1, this.JP_ = 0, this.JQh = !1, this.ZQh = void 0, this.eKh = !1, this.tKh = void 0
  }
  static Create(t) {
  ...
  get PrefabPath() {
    return this.YQh || (this.YQh = !0, this.zQh = this.FbDataInternal.prefabPath()), this.zQh
  }
  get NameOffsetZ() {
    return this.zP_ || (this.zP_ = !0, this.JP_ = this.FbDataInternal.nameOffsetZ()), this.JP_
  }
  get PrefabStateList() {
    if (!this.JQh) {
