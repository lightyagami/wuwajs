...
class FbJigsawItemMatchedConfig {
  constructor(t) {
    this.FbDataInternal = t, this.qNh = !1, this.kNh = void 0, this.GNh = !1, this.ONh = void 0, this.L_h = !1, this.A_h = void 0, this.FNh = !1, this.NNh = void 0, this.VNh = !1, this.jNh = void 0
  }
  static Create(t) {
    if (t) return new FbJigsawItemMatchedConfig(t)
  }
  get TargetIndex() {
    return this.qNh || (this.qNh = !0, this.kNh = FbPieceIndex_1.FbPieceIndex.Create(this.FbDataInternal.targetIndex())), this.kNh
  }
  get JigsawItemIds() {
    if (!this.GNh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.ONh.push(this.FbDataInternal.jigsawItemIds(t))
    }
    return this.ONh
  }
  get Actions() {
