...
class FbEntityPackageComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Gjh = !1, this.Ojh = !1, this.Fjh = !1, this.Njh = void 0
  }
  static Create(t) {
  ...
  get BindTemplate() {
    return this.Gjh || (this.Gjh = !0, this.Ojh = this.FbDataInternal.bindTemplate()), this.Ojh
  }
  get PackageData() {
    return this.Fjh || (this.Fjh = !0, this.Njh = FbEntityPackageData_1.FbEntityPackageData.Create(this.FbDataInternal.packageData())), this.Njh
  }
}
