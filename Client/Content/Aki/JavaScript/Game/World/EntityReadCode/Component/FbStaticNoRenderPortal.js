...
class FbStaticNoRenderPortal {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.DKh = !1, this.BKh = void 0, this.HKh = !1, this.WKh = 0, this.$Kh = !1, this.XKh = void 0, this.YKh = !1, this.zKh = void 0, this.f_h = !1, this.X6o = void 0, this.yd_ = !1, this.Sd_ = void 0, this.yPh = !1, this.SPh = void 0
  }
  static Create(t) {
  ...
  get LinkPortalEntityId() {
    return this.HKh || (this.HKh = !0, this.WKh = this.FbDataInternal.linkPortalEntityId()), this.WKh
  }
  get TeleportSceneEffect() {
    return this.$Kh || (this.$Kh = !0, this.XKh = FbTeleportSceneEffect_1.FbTeleportSceneEffect.Create(this.FbDataInternal.teleportSceneEffect())), this.XKh
  }
  get TeleportLoadingEffect() {
    var t, i;
    return !this.YKh && (this.YKh = !0, t = this.FbDataInternal.teleportLoadingEffectType(), i = UnionTeleportTransitionOptionHelper_1.UnionTeleportTransitionOptionHelper.GetUnionTeleportTransitionOptionObject(t)) && (this.zKh = UnionTeleportTransitionOptionHelper_1.UnionTeleportTransitionOptionHelper.ReadUnionTeleportTransitionOption(t, this.FbDataInternal.teleportLoadingEffect(i))), this.zKh
  }
  get Condition() {
  ...
  get TeleportToSelfPos() {
    return this.yd_ || (this.yd_ = !0, this.Sd_ = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.teleportToSelfPos())), this.Sd_
  }
  get GravityConfig() {
