...
class FbFlowComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.wAh = !1, this.PAh = void 0
  }
  static Create(t) {
  ...
  get InitState() {
    return this.wAh || (this.wAh = !0, this.PAh = FbPlayFlow_1.FbPlayFlow.Create(this.FbDataInternal.initState())), this.PAh
  }
}
