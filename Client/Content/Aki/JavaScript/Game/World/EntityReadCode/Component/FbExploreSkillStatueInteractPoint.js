...
class FbExploreSkillStatueInteractPoint {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.FWh = !1, this.NWh = 0, this.HWh = !1, this.WWh = void 0
  }
  static Create(t) {
  ...
  get PullTime() {
    return this.FWh || (this.FWh = !0, this.NWh = this.FbDataInternal.pullTime()), this.NWh
  }
  get HangingPointList() {
    if (!this.HWh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.WWh.push(this.FbDataInternal.hangingPointList(t))
    }
    return this.WWh
  }
}
