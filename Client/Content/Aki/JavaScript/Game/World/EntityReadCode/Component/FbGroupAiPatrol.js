...
class FbGroupAiPatrol {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.YXh = !1, this.zXh = 0, this.kuh = !1, this.Guh = 0
  }
  static Create(t) {
  ...
  get Leader() {
    return this.YXh || (this.YXh = !0, this.zXh = this.FbDataInternal.leader()), this.zXh
  }
  get SplineEntityId() {
