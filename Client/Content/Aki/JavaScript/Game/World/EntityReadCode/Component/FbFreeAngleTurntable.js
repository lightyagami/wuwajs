...
class FbFreeAngleTurntable {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.B2h = !1, this.q2h = 0, this.l7h = !1, this._7h = void 0, this.f7h = !1, this.p7h = 0
  }
  static Create(t) {
  ...
  get IntervalAngle() {
    return this.f7h || (this.f7h = !0, this.p7h = this.FbDataInternal.intervalAngle()), this.p7h
  }
}
