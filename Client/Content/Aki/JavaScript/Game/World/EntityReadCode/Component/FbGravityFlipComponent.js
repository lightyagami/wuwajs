...
class FbGravityFlipComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.bSh = !1, this.TAe = void 0, this._Q_ = !1, this.cQ_ = void 0
  }
  static Create(t) {
  ...
  get DefaultGravity() {
    return this._Q_ || (this._Q_ = !0, this.cQ_ = this.FbDataInternal.defaultGravity()), this.cQ_
  }
}
