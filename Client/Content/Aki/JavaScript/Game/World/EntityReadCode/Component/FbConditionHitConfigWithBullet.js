...
class FbConditionHitConfigWithBullet {
  constructor(t) {
    this.FbDataInternal = t, this.ich = !1, this.rch = void 0, this.Bch = !1, this.Cbo = void 0, this.ZQ_ = !1, this.eK_ = void 0
  }
  static Create(t) {
  ...
  get HitBullets() {
    var t, i;
    return !this.ZQ_ && (this.ZQ_ = !0, t = this.FbDataInternal.hitBulletsType(), i = UnionHitBulletTypeHelper_1.UnionHitBulletTypeHelper.GetUnionHitBulletTypeObject(t)) && (this.eK_ = UnionHitBulletTypeHelper_1.UnionHitBulletTypeHelper.ReadUnionHitBulletType(t, this.FbDataInternal.hitBullets(i))), this.eK_
  }
}
