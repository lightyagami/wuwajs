...
class UnionInteractAdditionalInfoHelper {
  static GetUnionInteractAdditionalInfoObject(n) {
    if (n === fb_component_1.UnionInteractAdditionalInfo.FishingPointAdditionalInfo) return new fb_component_1.FishingPointAdditionalInfo
  }
  static ReadUnionInteractAdditionalInfo(n, o) {
    return void 0 !== o && n === fb_component_1.UnionInteractAdditionalInfo.FishingPointAdditionalInfo ? FbFishingPointAdditionalInfo_1.FbFishingPointAdditionalInfo.Create(o) : void 0
  }
}
