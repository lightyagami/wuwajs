...
class FbAdsorptionMatchingAnimation {
  constructor(t) {
    this.FbDataInternal = t, this.bFh = !1, this.LFh = void 0, this.AFh = !1, this.xFh = void 0, this.RFh = !1, this.wFh = void 0, this.JFh = !1, this.ZFh = void 0
  }
  static Create(t) {
  ...
  get MoveCurve() {
    return this.JFh || (this.JFh = !0, this.ZFh = this.FbDataInternal.moveCurve()), this.ZFh
  }
}
