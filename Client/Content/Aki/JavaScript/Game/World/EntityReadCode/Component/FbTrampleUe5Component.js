...
class FbTrampleUe5Component {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.ckh = !1, this.ukh = !1, this.dkh = !1, this.mkh = void 0, this.Ckh = !1, this.gkh = void 0
  }
  static Create(t) {
  ...
  get IsDisposable() {
    return this.ckh || (this.ckh = !0, this.ukh = this.FbDataInternal.isDisposable()), this.ukh
  }
  get TriggerActions() {
    if (!this.dkh) {
