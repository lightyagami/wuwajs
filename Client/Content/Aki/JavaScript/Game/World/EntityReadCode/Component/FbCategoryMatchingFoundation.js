...
class FbCategoryMatchingFoundation {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.sFh = !1, this.aFh = 0, this.hFh = !1, this.lFh = void 0
  }
  static Create(t) {
  ...
  get InitMatchEntity() {
    return this.sFh || (this.sFh = !0, this.aFh = this.FbDataInternal.initMatchEntity()), this.aFh
  }
  get MatchingConfigs() {
    if (!this.hFh) {
