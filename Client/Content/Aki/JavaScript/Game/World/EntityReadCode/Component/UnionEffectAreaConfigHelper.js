...
class UnionEffectAreaConfigHelper {
  static GetUnionEffectAreaConfigObject(e) {
    if (e === fb_component_1.UnionEffectAreaConfig.BuffArea) return new fb_component_1.BuffArea
  }
  static ReadUnionEffectAreaConfig(e, n) {
    return void 0 !== n && e === fb_component_1.UnionEffectAreaConfig.BuffArea ? FbBuffArea_1.FbBuffArea.Create(n) : void 0
  }
}
