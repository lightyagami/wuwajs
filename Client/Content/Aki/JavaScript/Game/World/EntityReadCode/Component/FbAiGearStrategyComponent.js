...
class FbAiGearStrategyComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.G$h = !1, this.O$h = void 0
  }
  static Create(t) {
  ...
  get StrategyType() {
    var t, e;
    return !this.G$h && (this.G$h = !0, t = this.FbDataInternal.strategyTypeType(), e = UnionAiGearStrategyHelper_1.UnionAiGearStrategyHelper.GetUnionAiGearStrategyObject(t)) && (this.O$h = UnionAiGearStrategyHelper_1.UnionAiGearStrategyHelper.ReadUnionAiGearStrategy(t, this.FbDataInternal.strategyType(e))), this.O$h
  }
}
