...
class FbChessmanPickInteraction {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.V$h = !1, this.j$h = void 0, this.H$h = !1, this.W$h = void 0, this.Q$h = !1, this.K$h = 0, this.$$h = !1, this.X$h = void 0
  }
  static Create(t) {
  ...
  get TargetChessboard() {
    return this.Q$h || (this.Q$h = !0, this.K$h = this.FbDataInternal.targetChessboard()), this.K$h
  }
  get AvailablePosEffect() {
    return this.$$h || (this.$$h = !0, this.X$h = this.FbDataInternal.availablePosEffect()), this.X$h
  }
}
