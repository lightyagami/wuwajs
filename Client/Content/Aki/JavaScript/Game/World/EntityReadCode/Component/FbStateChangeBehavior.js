...
class FbStateChangeBehavior {
  constructor(t) {
    this.FbDataInternal = t, this.Bch = !1, this.Cbo = void 0, this.QUh = !1, this.KUh = void 0, this.$Uh = !1, this.XUh = void 0, this.YUh = !1, this.zUh = void 0
  }
  static Create(t) {
  ...
  get DelayChangeState() {
    return this.$Uh || (this.$Uh = !0, this.XUh = FbDelayChangeState_1.FbDelayChangeState.Create(this.FbDataInternal.delayChangeState())), this.XUh
  }
  get ConditionAction() {
    if (!this.YUh) {
