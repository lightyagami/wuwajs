...
class FbSpeedEffectConfig {
  constructor(t) {
    this.FbDataInternal = t, this.d7l = !1, this.m7l = 0, this.C7l = !1, this.g7l = 0, this.Vq_ = !1, this.jq_ = void 0
  }
  static Create(t) {
  ...
  get GameplayCueIds() {
    if (!this.Vq_) {
      ...
      if (e)
        for (let t = 0; t < e; ++t) this.jq_.push(Number(this.FbDataInternal.gameplayCueIds(t) ?? 0))
    }
    return this.jq_
  }
}
