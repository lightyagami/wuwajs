...
class UnionGroupAiOptionHelper {
  static GetUnionGroupAiOptionObject(o) {
    if (o === fb_component_1.UnionGroupAiOption.GroupAiPatrol) return new fb_component_1.GroupAiPatrol
  }
  static ReadUnionGroupAiOption(o, t) {
    return void 0 !== t && o === fb_component_1.UnionGroupAiOption.GroupAiPatrol ? FbGroupAiPatrol_1.FbGroupAiPatrol.Create(t) : void 0
  }
}
