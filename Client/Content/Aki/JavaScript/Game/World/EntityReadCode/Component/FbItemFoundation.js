...
class FbItemFoundation {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.YOh = !1, this.zOh = void 0, this.JOh = !1, this.ZOh = void 0, this.eFh = !1, this.tFh = void 0, this.iFh = !1, this.rFh = !1, this.bEh = !1, this.LEh = !1, this.oFh = !1, this.nFh = void 0
  }
  static Create(t) {
  ...
  get AdsorptionPoint() {
    return this.YOh || (this.YOh = !0, this.zOh = FbAdsortTransform_1.FbAdsortTransform.Create(this.FbDataInternal.adsorptionPoint())), this.zOh
  }
  get AdsorptionMatch() {
    return this.JOh || (this.JOh = !0, this.ZOh = FbEntityMatch_1.FbEntityMatch.Create(this.FbDataInternal.adsorptionMatch())), this.ZOh
  }
  get ActiveMatch() {
    return this.eFh || (this.eFh = !0, this.tFh = FbEntityMatch_1.FbEntityMatch.Create(this.FbDataInternal.activeMatch())), this.tFh
  }
  get IsSilent() {
