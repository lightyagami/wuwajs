...
class FbLevelQteComponent {
  constructor(e) {
    this.FbDataInternal = e, this.q_h = !1, this.k_h = !1, this.NYh = !1, this.VYh = void 0
  }
  static Create(e) {
  ...
  get QteConfig() {
    var e, t;
    return !this.NYh && (this.NYh = !0, e = this.FbDataInternal.qteConfigType(), t = UnionQteTypeHelper_1.UnionQteTypeHelper.GetUnionQteTypeObject(e)) && (this.VYh = UnionQteTypeHelper_1.UnionQteTypeHelper.ReadUnionQteType(e, this.FbDataInternal.qteConfig(t))), this.VYh
  }
}
