...
class FbCategoryMatchingConfigBase {
  constructor(t) {
    this.FbDataInternal = t, this.f_h = !1, this.X6o = void 0, this._Fh = !1, this.cFh = void 0, this.uFh = !1, this.dFh = void 0
  }
  static Create(t) {
  ...
  get Animation() {
    return this._Fh || (this._Fh = !0, this.cFh = FbCategoryMatchingAnimationBase_1.FbCategoryMatchingAnimationBase.Create(this.FbDataInternal.animation())), this.cFh
  }
  get Callback() {
    return this.uFh || (this.uFh = !0, this.dFh = FbCategoryMatchingSucceedBase_1.FbCategoryMatchingSucceedBase.Create(this.FbDataInternal.callback())), this.dFh
  }
}
