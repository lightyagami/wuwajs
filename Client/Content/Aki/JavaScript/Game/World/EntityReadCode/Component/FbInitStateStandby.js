...
class FbInitStateStandby {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.bvh = !1, this.Lvh = void 0, this.ich = !1, this.rch = void 0, this.YRh = !1, this.zRh = void 0
  }
  static Create(t) {
  ...
  get StandbyTags() {
    if (!this.bvh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.Lvh.push(this.FbDataInternal.standbyTags(t))
    }
    return this.Lvh
  }
  get Conditions() {
  ...
  get Wander() {
    return this.YRh || (this.YRh = !0, this.zRh = this.FbDataInternal.wander()), this.zRh
  }
}
