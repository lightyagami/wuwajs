...
class FbVisionCaptureComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.uVh = !1, this.dVh = 0, this.mVh = !1, this.CVh = 0
  }
  static Create(t) {
  ...
  get VisionCaptureId() {
    return this.uVh || (this.uVh = !0, this.dVh = this.FbDataInternal.visionCaptureId()), this.dVh
  }
  get VisionCaptureProb() {
    return this.mVh || (this.mVh = !0, this.CVh = this.FbDataInternal.visionCaptureProb()), this.CVh
  }
}
