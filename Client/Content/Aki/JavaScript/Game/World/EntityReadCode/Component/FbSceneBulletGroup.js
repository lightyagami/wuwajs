...
class FbSceneBulletGroup {
  constructor(t) {
    this.FbDataInternal = t, this._vh = !1, this.cvh = void 0, this.p0h = !1, this.nXs = 0, this.M_h = !1, this.E_h = void 0, this.Kdh = !1, this.$dh = void 0
  }
  static Create(t) {
  ...
  get Range() {
    return this.M_h || (this.M_h = !0, this.E_h = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.range())), this.E_h
  }
  get Offset() {
