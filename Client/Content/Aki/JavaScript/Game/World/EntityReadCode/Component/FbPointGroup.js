...
class FbPointGroup {
  constructor(t) {
    this.FbDataInternal = t, this.G9h = !1, this.O9h = void 0, this.NEh = !1, this.VEh = void 0
  }
  static Create(t) {
  ...
  get GroupConfig() {
    var t, r;
    return !this.G9h && (this.G9h = !0, t = this.FbDataInternal.groupConfigType(), r = UnionPointGroupHelper_1.UnionPointGroupHelper.GetUnionPointGroupObject(t)) && (this.O9h = UnionPointGroupHelper_1.UnionPointGroupHelper.ReadUnionPointGroup(t, this.FbDataInternal.groupConfig(r))), this.O9h
  }
  get Points() {
    if (!this.NEh) {
