...
class FbStateRotationConfig {
  constructor(t) {
    this.FbDataInternal = t, this.Bch = !1, this.Cbo = void 0, this.Dfh = !1, this.Bfh = !1, this.aqh = !1, this.hqh = void 0, this.lqh = !1, this._qh = void 0, this.cqh = !1, this.uqh = void 0, this.cQl = !1, this.uQl = !1
  }
  static Create(t) {
  ...
  get RotatePoint() {
    return this.aqh || (this.aqh = !0, this.hqh = this.FbDataInternal.rotatePoint()), this.hqh
  }
  get RotationConfig() {
    if (!this.lqh) {
  ...
  get KeepLastRotation() {
    return this.cQl || (this.cQl = !0, this.uQl = this.FbDataInternal.keepLastRotation()), this.uQl
  }
}
