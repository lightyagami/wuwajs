...
class FbGravityFlipTeleportConfig {
  constructor(i) {
    this.FbDataInternal = i, this.yUh = !1, this.SUh = void 0, this.HVh = !1, this.WVh = void 0
  }
  static Create(i) {
  ...
  get GravityDirection() {
    var i, t;
    return !this.yUh && (this.yUh = !0, i = this.FbDataInternal.gravityDirectionType(), t = UnionGravityDirectionHelper_1.UnionGravityDirectionHelper.GetUnionGravityDirectionObject(i)) && (this.SUh = UnionGravityDirectionHelper_1.UnionGravityDirectionHelper.ReadUnionGravityDirection(i, this.FbDataInternal.gravityDirection(t))), this.SUh
  }
  get SafeLocation() {
