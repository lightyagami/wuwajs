...
class FbConditionBubbleData {
  constructor(t) {
    this.FbDataInternal = t, this.f_h = !1, this.X6o = void 0, this.F_h = !1, this.N_h = void 0
  }
  static Create(t) {
  ...
  get Flow() {
    return this.F_h || (this.F_h = !0, this.N_h = FbBubbleData_1.FbBubbleData.Create(this.FbDataInternal.flow())), this.N_h
  }
}
