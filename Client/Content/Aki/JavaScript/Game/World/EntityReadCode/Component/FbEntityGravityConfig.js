...
class FbEntityGravityConfig {
  constructor(t) {
    this.FbDataInternal = t, this.yUh = !1, this.SUh = void 0, this.MUh = !1, this.EUh = !1, this.IUh = !1, this.TUh = !1
  }
  static Create(t) {
  ...
  get SpecifyGravityLoad() {
    return this.MUh || (this.MUh = !0, this.EUh = this.FbDataInternal.specifyGravityLoad()), this.EUh
  }
  get SpecifyGravityLock() {
    return this.IUh || (this.IUh = !0, this.TUh = this.FbDataInternal.specifyGravityLock()), this.TUh
  }
}
