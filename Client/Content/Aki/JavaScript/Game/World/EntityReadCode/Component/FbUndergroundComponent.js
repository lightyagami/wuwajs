...
class FbUndergroundComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Ekh = !1, this.Ikh = 0, this.Tkh = !1, this.bkh = !1, this.Lkh = !1, this.Akh = void 0, this.xkh = !1, this.Rkh = void 0
  }
  static Create(t) {
  ...
  get TestState() {
    return this.Ekh || (this.Ekh = !0, this.Ikh = this.FbDataInternal.testState()), this.Ikh
  }
  get IsRestartPlayer() {
    return this.Tkh || (this.Tkh = !0, this.bkh = this.FbDataInternal.isRestartPlayer()), this.bkh
  }
  get DestroyTag() {
    if (!this.Lkh) {
      ...
      if (s)
        for (let t = 0; t < s; ++t) this.Akh.push(this.FbDataInternal.destroyTag(t))
    }
    return this.Akh
  }
  get StateInfo() {
