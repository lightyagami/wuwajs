...
class FbHackManagementComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Hd_ = !1, this.Wd_ = 0, this.O7_ = !1, this.G7_ = 0
  }
  static Create(t) {
  ...
  get MaxHackingCount() {
    return this.Hd_ || (this.Hd_ = !0, this.Wd_ = this.FbDataInternal.maxHackingCount()), this.Wd_
  }
  get ValidDistance() {
    return this.O7_ || (this.O7_ = !0, this.G7_ = this.FbDataInternal.validDistance()), this.G7_
  }
}
