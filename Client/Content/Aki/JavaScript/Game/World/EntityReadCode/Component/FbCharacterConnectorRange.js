...
class FbCharacterConnectorRange {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.hQh = !1, this.lQh = void 0, this.ljh = !1, this._jh = 0, this.cjh = !1, this.ujh = 0, this.M$h = !1, this.E$h = void 0, this._$h = !1, this.c$h = void 0, this.u$h = !1, this.d$h = void 0
  }
  static Create(t) {
  ...
  get TagConditions() {
    if (!this.M$h) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.E$h.push(this.FbDataInternal.tagConditions(t))
    }
    return this.E$h
  }
  get MatchConditions() {
