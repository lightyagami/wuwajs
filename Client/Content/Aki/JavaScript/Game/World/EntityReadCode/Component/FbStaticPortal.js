...
class FbStaticPortal {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.DKh = !1, this.BKh = void 0, this.qKh = !1, this.kKh = void 0, this.HKh = !1, this.WKh = 0, this.QKh = !1, this.KKh = !1
  }
  static Create(t) {
  ...
  get IsStreamSource() {
    return this.QKh || (this.QKh = !0, this.KKh = this.FbDataInternal.isStreamSource()), this.KKh
  }
}
