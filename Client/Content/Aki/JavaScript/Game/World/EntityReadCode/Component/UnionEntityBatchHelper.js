...
class UnionEntityBatchHelper {
  static GetUnionEntityBatchObject(t) {
    if (t === fb_component_1.UnionEntityBatch.EntityListBatch) return new fb_component_1.EntityListBatch
  }
  static ReadUnionEntityBatch(t, n) {
    return void 0 !== n && t === fb_component_1.UnionEntityBatch.EntityListBatch ? FbEntityListBatch_1.FbEntityListBatch.Create(n) : void 0
  }
}
