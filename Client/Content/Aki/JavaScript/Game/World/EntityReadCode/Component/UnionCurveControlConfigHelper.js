...
class UnionCurveControlConfigHelper {
  static GetUnionCurveControlConfigObject(o) {
    if (o === fb_component_1.UnionCurveControlConfig.ChargeSlashControl) return new fb_component_1.ChargeSlashControl
  }
  static ReadUnionCurveControlConfig(o, e) {
    return void 0 !== e && o === fb_component_1.UnionCurveControlConfig.ChargeSlashControl ? FbChargeSlashControl_1.FbChargeSlashControl.Create(e) : void 0
  }
}
