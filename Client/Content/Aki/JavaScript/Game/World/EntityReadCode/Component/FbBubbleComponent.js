...
class FbBubbleComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.ajh = !1, this.hjh = void 0, this.ljh = !1, this._jh = 0, this.cjh = !1, this.ujh = 0, this.djh = !1, this.mjh = void 0, this.tph = !1, this.iph = 0
  }
  static Create(t) {
  ...
  get NpcIds() {
    if (!this.ajh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.hjh.push(this.FbDataInternal.npcIds(t))
    }
    return this.hjh
  }
  get EnterRange() {
