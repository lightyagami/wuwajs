      ...
      if (e)
        for (let t = 0; t < e; ++t) {
          var o = this.FbDataInternal.conditionsType(t),
            i = UnionTeleControlDestroyConditionHelper_1.UnionTeleControlDestroyConditionHelper.GetUnionTeleControlDestroyConditionObject(o);
          i && void 0 !== (o = UnionTeleControlDestroyConditionHelper_1.UnionTeleControlDestroyConditionHelper.ReadUnionTeleControlDestroyCondition(o, this.FbDataInternal.conditions(t, i))) && this.rch.push(o)
        }
    }
    return this.rch
  }
