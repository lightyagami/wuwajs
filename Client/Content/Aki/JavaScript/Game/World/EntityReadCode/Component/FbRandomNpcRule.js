...
class FbRandomNpcRule {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this.aBh = !1, this.hBh = void 0, this.lBh = !1, this._Bh = void 0
  }
  static Create(t) {
  ...
  get ProbabilityRefreshGroup() {
    return this.lBh || (this.lBh = !0, this._Bh = FbProbabilityRefreshGroup_1.FbProbabilityRefreshGroup.Create(this.FbDataInternal.probabilityRefreshGroup())), this._Bh
  }
}
