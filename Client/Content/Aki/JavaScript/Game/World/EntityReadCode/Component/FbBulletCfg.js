      ...
      if (e)
        for (let t = 0; t < e; ++t) {
          var i = this.FbDataInternal.createConditionsType(t),
            r = UnionBulletCreateConditionHelper_1.UnionBulletCreateConditionHelper.GetUnionBulletCreateConditionObject(i);
          r && void 0 !== (i = UnionBulletCreateConditionHelper_1.UnionBulletCreateConditionHelper.ReadUnionBulletCreateCondition(i, this.FbDataInternal.createConditions(t, r))) && this.f2h.push(i)
        }
    }
    return this.f2h
  }
