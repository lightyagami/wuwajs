...
class UnionColorChangeStrategyOfSplineEffectHelper {
  static GetUnionColorChangeStrategyOfSplineEffectObject(e) {
    if (e === fb_component_1.UnionColorChangeStrategyOfSplineEffect.ColorChangeStrategyOfRGB) return new fb_component_1.ColorChangeStrategyOfRGB
  }
  static ReadUnionColorChangeStrategyOfSplineEffect(e, t) {
    return void 0 !== t && e === fb_component_1.UnionColorChangeStrategyOfSplineEffect.ColorChangeStrategyOfRGB ? FbColorChangeStrategyOfRGB_1.FbColorChangeStrategyOfRGB.Create(t) : void 0
  }
}
