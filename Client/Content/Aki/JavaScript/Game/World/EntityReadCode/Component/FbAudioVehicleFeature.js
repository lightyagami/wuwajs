...
class FbAudioVehicleFeature {
  constructor(i) {
    this.FbDataInternal = i, this.u_h = !1, this.f8o = void 0, this.Oq_ = !1, this.Gq_ = void 0
  }
  static Create(i) {
  ...
  get AudioConfigs() {
    return this.Oq_ || (this.Oq_ = !0, this.Gq_ = FbVehicleAudioConfig_1.FbVehicleAudioConfig.Create(this.FbDataInternal.audioConfigs())), this.Gq_
  }
}
