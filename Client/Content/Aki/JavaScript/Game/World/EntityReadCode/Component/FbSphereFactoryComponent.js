...
class FbSphereFactoryComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.Sqh = !1, this.Mqh = void 0, this.Eqh = !1, this.Iqh = void 0
  }
  static Create(t) {
  ...
  get SphereLocation() {
    return this.Sqh || (this.Sqh = !0, this.Mqh = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.sphereLocation())), this.Mqh
  }
  get SphereGuid() {
    return this.Eqh || (this.Eqh = !0, this.Iqh = this.FbDataInternal.sphereGuid()), this.Iqh
  }
}
