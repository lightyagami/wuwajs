...
class FbHeadInfoChangeData {
  constructor(t) {
    this.FbDataInternal = t, this.ich = !1, this.rch = void 0, this.bwh = !1, this.Lwh = void 0, this.d_h = !1, this.m_h = void 0, this.jZ_ = !1, this.HZ_ = void 0
  }
  static Create(t) {
  ...
  get TidSecondaryName() {
    return this.jZ_ || (this.jZ_ = !0, this.HZ_ = this.FbDataInternal.tidSecondaryName()), this.HZ_
  }
}
