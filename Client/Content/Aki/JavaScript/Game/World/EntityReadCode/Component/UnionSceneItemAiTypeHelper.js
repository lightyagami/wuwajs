...
class UnionSceneItemAiTypeHelper {
  static GetUnionSceneItemAiTypeObject(e) {
    if (e === fb_component_1.UnionSceneItemAiType.SceneItemPatrol) return new fb_component_1.SceneItemPatrol
  }
  static ReadUnionSceneItemAiType(e, t) {
    return void 0 !== t && e === fb_component_1.UnionSceneItemAiType.SceneItemPatrol ? FbSceneItemPatrol_1.FbSceneItemPatrol.Create(t) : void 0
  }
}
