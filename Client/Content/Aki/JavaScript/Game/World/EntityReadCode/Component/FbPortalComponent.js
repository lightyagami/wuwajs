...
class FbPortalComponent {
  ...
  get Config() {
    var t, i;
    return !this.bSh && (this.bSh = !0, t = this.FbDataInternal.configType(), i = UnionPortalConfigHelper_1.UnionPortalConfigHelper.GetUnionPortalConfigObject(t)) && (this.TAe = UnionPortalConfigHelper_1.UnionPortalConfigHelper.ReadUnionPortalConfig(t, this.FbDataInternal.config(i))), this.TAe
  }
}
