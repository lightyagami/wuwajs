...
class FbEnrichmentAreaComponent {
  constructor(t) {
    this.FbDataInternal = t, this.q_h = !1, this.k_h = !1, this.GXh = !1, this.OXh = void 0, this.FXh = !1, this.NXh = void 0
  }
  static Create(t) {
  ...
  get RefEntityIds() {
    if (!this.GXh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.OXh.push(this.FbDataInternal.refEntityIds(t))
    }
    return this.OXh
  }
  get FogIds() {
    if (!this.FXh) {
      ...
      if (i)
        for (let t = 0; t < i; ++t) this.NXh.push(this.FbDataInternal.fogIds(t))
    }
    return this.NXh
  }
}
