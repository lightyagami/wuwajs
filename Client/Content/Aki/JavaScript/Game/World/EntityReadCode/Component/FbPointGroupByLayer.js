...
class FbPointGroupByLayer {
  constructor(t) {
    this.FbDataInternal = t, this.u_h = !1, this.f8o = void 0, this._9h = !1, this.c9h = void 0, this.F9h = !1, this.N9h = void 0
  }
  static Create(t) {
  ...
  get Space() {
    return this._9h || (this._9h = !0, this.c9h = FbVectorInfo_1.FbVectorInfo.Create(this.FbDataInternal.space())), this.c9h
  }
  get Layers() {
    if (!this.F9h) {
