...
class WorldFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetControlVisionEntityId(t) {
    ...
    if (e) {
      ...
      if (e) return e.Id
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 28, "无法找到拥有者实体", ["ownerEntityId", t]);
    return 0
  }
  static GetVisionEntityId(t) {
    ...
    if (e) {
      ...
      if (e) return e.Id
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "无法找到幻象拥有者实体", ["ownerEntityId", t]);
    return 0
  }
  static SetVisionEnable(t, e) {
    var r = EntitySystem_1.EntitySystem.Get(t);
    r ? PhantomUtil_1.PhantomUtil.SetVisionEnable(r, e, "WorldFunctionLibrary.SetVisionEnable") : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "无法找到幻象拥有者实体", ["ownerEntityId", t])
  }
  ...
  static GetSummonRandomEntity(t, e) {
    ...
    return (t = t && t.GetComponent(0)) ? t.GetSummonRadomEntityId(e) : 0
  }
  static GetServerIdByEntityId(t) {
    var t = EntitySystem_1.EntitySystem.Get(t);
    return t ? (t = t.GetComponent(0)?.GetCreatureDataId(), BigInt(t ?? 0)) : 0n
  }
  ...
  static IsNeedPostEffect(t) {
    if (t && t instanceof TsBaseCharacter_1.default) {
      var t = EntitySystem_1.EntitySystem.Get(t.GetEntityIdNoBlueprint()),
        e = t?.GetComponent(0);
      if (e) {
        if (e.GetEntityType() === Protocol_1.Aki.Protocol.kks.Proto_Player && !t.GetComponent(3).IsAutonomousProxy) return !1;
        e = ModelManager_1.ModelManager.CreatureModel.GetEntityId(e.GetSummonerId()), e = EntitySystem_1.EntitySystem.Get(e)?.GetComponent(0);
        if (e && e.GetEntityType() === Protocol_1.Aki.Protocol.kks.Proto_Player && !t.GetComponent(3).IsAutonomousProxy) return !1
      }
    }
    return !0
  }
  ...
  static GetEntityTypeByActor(t) {
    return t?.IsValid() && UE.KuroStaticLibrary.IsImplementInterface(t.GetClass(), UE.BPI_CreatureInterface_C.StaticClass()) && (t = t, (t = EntitySystem_1.EntitySystem.Get(t.GetEntityId()))?.Valid) && (t = t.GetComponent(0))?.Valid ? t.GetEntityType().valueOf() : -1
  }
  static GetMonsterType(t) {
    return t?.IsValid() && UE.KuroStaticLibrary.IsImplementInterface(t.GetClass(), UE.BPI_CreatureInterface_C.StaticClass()) && (t = t, (t = EntitySystem_1.EntitySystem.Get(t.GetEntityId()))?.Valid) && (t = t.GetComponent(0))?.Valid && (t = t.GetBaseInfo()) ? t.Category.MonsterMatchType : -1
  }
  static GetConfigIdByActor(t) {
    return t?.IsValid() && UE.KuroStaticLibrary.IsImplementInterface(t.GetClass(), UE.BPI_CreatureInterface_C.StaticClass()) && (t = t, (t = EntitySystem_1.EntitySystem.Get(t.GetEntityId()))?.Valid) && (t = t.GetComponent(0))?.Valid ? t.GetPbDataId() : -1
  }
  ...
  static GetEntityDestructible(t) {
    var e = EntitySystem_1.EntitySystem.Get(t);
    return e ? void 0 !== e.GetComponent(102) : (Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 39, "无法找到实体", ["entityId", t]), !1)
  }
  static AddPrivateTags(t, e) {
    var e = (0, puerts_1.$unref)(e),
      r = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray(e, r), ControllerHolder_1.ControllerHolder.CreatureController.AddPublicTags(t, r)
  }
  static RemovePrivateTags(t, e) {
    var e = (0, puerts_1.$unref)(e),
      r = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray(e, r), ControllerHolder_1.ControllerHolder.CreatureController.RemovePublicTags(t, r)
  }
  ...
  static SetIntValueByEntityWithCharacter(t, e, r) {
    t && BlackboardController_1.BlackboardController.SetIntValueByEntity(t.GetEntityIdNoBlueprint(), e, r)
  }
  static GetIntValuesByEntity(t, e) {
    t = BlackboardController_1.BlackboardController.GetIntValuesByEntity(t, e);
    return t ? (e = UE.NewArray(UE.BuiltinInt), WorldGlobal_1.WorldGlobal.ToUeInt32Array(t, e), e) : UE.NewArray(UE.BuiltinInt)
  }
  static SetIntValuesByEntity(t, e, r) {
    var o = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray((0, puerts_1.$unref)(r), o), BlackboardController_1.BlackboardController.SetIntValuesByEntity(t, e, o)
  }
  ...
  static GetLongValuesByEntity(t, e) {
    ...
    return t ? (e = UE.NewArray(UE.BuiltinInt64), WorldGlobal_1.WorldGlobal.ToUeInt64Array(t, e), e) : UE.NewArray(UE.BuiltinInt64)
  }
  static SetLongValuesByEntity(t, e, r) {
    var o = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray((0, puerts_1.$unref)(r), o), BlackboardController_1.BlackboardController.SetLongValuesByEntity(t, e, o)
  }
  ...
  static GetFloatValuesByEntity(t, e) {
    ...
    return t ? (e = UE.NewArray(UE.BuiltinFloat), WorldGlobal_1.WorldGlobal.ToUeFloatArray(t, e), e) : UE.NewArray(UE.BuiltinFloat)
  }
  static SetFloatValuesByEntity(t, e, r) {
    var o = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray((0, puerts_1.$unref)(r), o), BlackboardController_1.BlackboardController.SetFloatValuesByEntity(t, e, o)
  }
  ...
  static GetStringValuesByEntity(t, e) {
    t = BlackboardController_1.BlackboardController.GetStringValuesByEntity(t, e), t || UE.NewArray(UE.BuiltinString), e = UE.NewArray(UE.BuiltinString);
    return WorldGlobal_1.WorldGlobal.ToUeStringArray(t, e), e
  }
  static SetStringValuesByEntity(t, e, r) {
    var o = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray((0, puerts_1.$unref)(r), o), BlackboardController_1.BlackboardController.SetStringValuesByEntity(t, e, o)
  }
  ...
  static GetVectorValueByEntity(t, e) {
    var r = new UE.VectorDouble,
      t = BlackboardController_1.BlackboardController.GetVectorValueByEntity(t, e);
  ...
  static GetVectorValuesByEntity(t, e) {
    var r = UE.NewArray(UE.VectorDouble),
      t = BlackboardController_1.BlackboardController.GetVectorValuesByEntity(t, e);
    if (t)
      for (const a of t) {
  ...
  static GetRotatorValuesByEntity(t, e) {
    var r = UE.NewArray(UE.Rotator),
      t = BlackboardController_1.BlackboardController.GetRotatorValuesByEntity(t, e);
    if (t)
      for (const a of t) {
  ...
  static GetEntityIdsByEntity(t, e) {
    t = BlackboardController_1.BlackboardController.GetEntityIdsByEntity(t, e), e = UE.NewArray(UE.BuiltinInt);
    return WorldGlobal_1.WorldGlobal.ToUeInt32Array(t, e), e
  }
  static SetEntityIdsByEntity(t, e, r) {
    var o = new Array;
    WorldGlobal_1.WorldGlobal.ToTsArray((0, puerts_1.$unref)(r), o), BlackboardController_1.BlackboardController.SetEntityIdsByEntity(t, e, o)
  }
  ...
  static GetDynamicEntity(t) {
    ...
    if (t?.Valid) return ControllerHolder_1.ControllerHolder.CharacterController.GetActor(t)
  }
  ...
  static GetRoleElementId(t) {
    var t = EntitySystem_1.EntitySystem.Get(t);
    return t?.Valid && (t = t.GetComponent(0).GetRoleConfig()) ? t.ElementId : 0
  }
  static GetRoleId(t) {
    var t = EntitySystem_1.EntitySystem.Get(t);
  ...
  static GetRoleIdIgnoreTrial(t) {
    var t = EntitySystem_1.EntitySystem.Get(t);
    return t?.Valid && (t = t.GetComponent(0))?.Valid ? (t = t.GetRoleId()) > RoleDefine_1.ROBOT_DATA_MIN_ID ? ConfigManager_1.ConfigManager.RoleConfig.GetTrialRoleConfig(t).ParentId : t : 0
  }
  ...
  static JumpToMarkLevelSequence(t, e) {
    UE.KismetSystemLibrary.IsValid(t) && UE.KismetSystemLibrary.IsValid(t.Player) && t.Player.JumpToMarkedFrame(e)
  }
  ...
  static ChangeBattleState(t, e, r) {
    UE.KismetSystemLibrary.IsValid(t) && UE.KismetSystemLibrary.IsValid(t.Player) && RenderModuleController_1.RenderModuleController.SetBattleState(e, r)
  }
  ...
  static PlayWuYinLevelSequence(t, e, r) {
    0 === ModelManager_1.ModelManager.WuYinAreaModel.GetWuYinLevelSequenceState(r) && (r = new UE.FrameNumber(t), t = new UE.FrameTime(r, 0), r = new UE.MovieSceneSequencePlaybackParams(t, 0, "", 0, 0), e.Player.SetPlaybackPosition(r))
  }
  ...
  static TestSpawnTemplateEntityPush(t, e, r, o, a) {
    ...
    n.s5n = MathUtils_1.MathUtils.NumberToLong(Number(t)), n.F6n = r, n.v9n = e, n.l8n = WorldGlobal_1.WorldGlobal.ToTsVector(o.GetLocation()), n._8n = WorldGlobal_1.WorldGlobal.ToTsRotator(o.GetRotation().Rotator()), n.mKn = a, Net_1.Net.Send(15253, n)
  }
  static GetTestSpawnTemplateEntityString() {
    ...
    let e = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfig.TemplateConfigPath),
      r = (PublicUtil_1.PublicUtil.IsUseTempData() || (e = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.TemplateConfigPath)), (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfig.BlueprintConfigPath));
    if (PublicUtil_1.PublicUtil.IsUseTempData() || (r = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.BlueprintConfigPath)), UE.BlueprintPathsLibrary.FileExists(e) && UE.BlueprintPathsLibrary.FileExists(r)) {
      var o = new Map,
        a = (0, puerts_1.$ref)(""),
        a = (UE.KuroStaticLibrary.LoadFileToString(a, e), a = (0, puerts_1.$unref)(a), JSON.parse(a));
      for (const i of a.Templates) o.set(i.BlueprintType, i.Id);
      var n, l, a = (0, puerts_1.$ref)(""),
        a = (UE.KuroStaticLibrary.LoadFileToString(a, r), a = (0, puerts_1.$unref)(a), JSON.parse(a));
      for ([n, l] of Object.entries(a.BlueprintConfig)) t.Add(l.Name + "|" + o.get(n))
    } else
      for (const s of TemplateConfigAll_1.configTemplateConfigAll.GetConfigList()) t.Add(s.Name + "|" + s.Id);
    return t
  }
  ...
  static ChangeSubLevel(t, e, r, o, a) {
    var t = (0, puerts_1.$unref)(t),
      ...
      n = new Array,
      l = new Array,
      t = (WorldGlobal_1.WorldGlobal.ToTsArray(t, n), WorldGlobal_1.WorldGlobal.ToTsArray(e, l), Vector_1.Vector.Create(o));
  ...
  static SetEntityLocation(t, e, r = !0, o = !1) {
    ...
    t && (o ? t.SetActorLocation(e, "SetEntityLocation", r) : ((o = Vector_1.Vector.Create(e)).SubtractionEqual(t.ActorLocationProxy), t.AddActorWorldOffset(o.ToUeVector(), "SetEntityLocation", r)))
  }
  ...
  static SetEntityLocationAndRotation(t, e, r, o = !1) {
    t = EntitySystem_1.EntitySystem.Get(t);
    t && t.GetComponent(1)?.SetActorLocationAndRotation(e, r, "SetEntityLocationAndRotation", o)
  }
  ...
  static GetActorsByPbDataIdArray(t) {
    var e, r = (0, puerts_1.$unref)(t),
      o = UE.NewArray(UE.Actor);
    for (const a of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) a?.IsInit && (e = a.Entity.GetComponent(0).GetPbDataId()) && r.Contains(e) && (e = a.Entity.GetComponent(1)) && o.Add(e.Owner);
    return o
  }
  ...
  static GetFormationControlledRoles() {
    var t, e = UE.NewArray(UE.Actor);
    for (const r of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems()) r.IsControl() && (t = r.EntityHandle)?.Valid && (t = ControllerHolder_1.ControllerHolder.CharacterController.GetActor(t)) && e.Add(t);
    return e
  }
  ...
  static SetTimeDilation(t) {
    UE.GameplayStatics.SetGlobalTimeDilation(GlobalData_1.GlobalData.GameInstance, t);
    var e = Protocol_1.Aki.Protocol.GCs.create();
    e.dKn = t, Net_1.Net.Send(16566, e)
  }
  static GetTimeDilation() {
    return GlobalData_1.GlobalData.GameInstance ? UE.GameplayStatics.GetGlobalTimeDilation(GlobalData_1.GlobalData.GameInstance) : 1
  }
  static GetEntitiesInRange(t, e) {
    ...
    for (const n of r) {
      ...
      CampUtils_1.CampUtils.GetCampRelationship(a, 0) === e && o.push(n.Entity.Id)
    }
  ...
  static AttachToActor(t, e, r, o, a, n, l, i, s, c, _) {
    return t?.IsValid() ? (t = `[蓝图:${t.GetName()}] ` + a, ControllerHolder_1.ControllerHolder.AttachToActorController.AttachToActor(e, r, o, t, n, l, i, s, c, _)) : (Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "callObject无效, AttachToActor失败。", ["Reason", a]), !1)
  }
  static AttachToComponent(t, e, r, o, a, n, l, i, s, c, _) {
    return t?.IsValid() ? (t = `[蓝图:${t.GetName()}] ` + a, ControllerHolder_1.ControllerHolder.AttachToActorController.AttachToComponent(e, r, o, t, n, l, i, s, c, _)) : (Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "callObject无效, AttachToActor失败。", ["Reason", a]), !1)
  }
  static DetachActor(t, e, r, o, a, n, l) {
    return t?.IsValid() ? (t = `[蓝图:${t.GetName()}] ` + o, ControllerHolder_1.ControllerHolder.AttachToActorController.DetachActor(e, r, t, a, n, l)) : (Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "callObject无效, DetachActor失败。", ["Reason", o]), !1)
  }
  static GetPlayerFollower() {
    var t = ModelManager_1.ModelManager.CreatureModel.GetPlayerId(),
      t = ControllerHolder_1.ControllerHolder.FormationDataController.GetPlayerEntity(t)?.GetComponent(224)?.GetFollower()?.Id;
    return t || 0
  }
  static IsPlayerFollowerEnable() {
    var t = ModelManager_1.ModelManager.CreatureModel.GetPlayerId();
    return ControllerHolder_1.ControllerHolder.FormationDataController.GetPlayerEntity(t)?.GetComponent(224)?.IsFollowerEnable() ?? !1
  }
...
}(exports.WorldFunctionLibrary = WorldFunctionLibrary).IsChangeFootStep = !1, WorldFunctionLibrary.ChangeFootStepMaterialId = 0, exports.default = WorldFunctionLibrary;
