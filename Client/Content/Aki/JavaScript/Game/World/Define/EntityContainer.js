...
class EntityContainer {
  constructor() {
    this.EntityMap = new CustomMap_1.CustomMap, this.EntityIdMap = new Map, this.PbDataIdMap = new Map
  }
  AddEntity(t, e) {
    return !this.EntityMap.Contains(t) && (this.EntityMap.Set(t, e), this.EntityIdMap.set(e.Id, t), !0)
  }
  RemoveEntity(t) {
    var e = this.EntityMap.Get(t);
    return !!e && (this.EntityMap.Remove(t), this.EntityIdMap.delete(e.Id), e.ConfigType === Protocol_1.Aki.Protocol.rLs.F6n && this.PbDataIdMap.delete(e.PbDataId), !0)
  }
  GetEntity(t) {
  ...
  CheckSetPrefabEntity(t) {
    ...
    t.GetEntityConfigType() === Protocol_1.Aki.Protocol.rLs.F6n && this.PbDataIdMap.set(t.GetPbDataId(), t.GetCreatureDataId())
  }
