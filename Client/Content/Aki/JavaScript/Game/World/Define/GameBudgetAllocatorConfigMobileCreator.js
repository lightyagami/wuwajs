...
class GameBudgetAllocatorConfigMobileCreator {
  ...
  CreateSimpleNpcEntityConfig() {
    return {
      ...
      Normal_Render: undefined,
      Normal_NotRendered: new GameBudgetAllocatorConfig_1.TsGameBudgetAllocatorTickIntervalDetailConfig(0, 1, 60, 300, 20),
      Normal_Fighting: undefined,
      Fighting_Rendered: undefined,
      Fighting_NotRendered: undefined,
      Fighting_Fighting: undefined,
  ...
  CreateFarBlueprintActorConfig() {
    return {
      Default: new GameBudgetAllocatorConfig_1.TsGameBudgetAllocatorTickIntervalDetailConfig(0, 0, 20, 8000, 1000, 0.3, 0.01),
      Normal_Render: new GameBudgetAllocatorConfig_1.TsGameBudgetAllocatorTickIntervalDetailConfig(0, 0, 20, 8000, 1000, 0.3, 0.01),
  ...
  CreateSuperFarBlueprintActorConfig() {
    return {
      Default: new GameBudgetAllocatorConfig_1.TsGameBudgetAllocatorTickIntervalDetailConfig(0, 0, 20, 50000, 30000, 0.3, 0.01),
      Normal_Render: new GameBudgetAllocatorConfig_1.TsGameBudgetAllocatorTickIntervalDetailConfig(0, 0, 20, 50000, 30000, 0.3, 0.01),
