...
class AttachActorItem {
  constructor() {
    this.Id = 0, this.EntityId = 0, this.Reason = void 0, this.Actor = void 0, this.Name = void 0, this.ParentActorName = void 0, this.DetachType = void 0
  }
}
exports.AttachActorItem = AttachActorItem;
class AttachActorEntry {
  constructor() {
    this.lbn = 0, this._bn = new Map, this.WXe = new CustomMap_1.CustomMap
  }
  AddAttachActorItem(t, s, r, e, i, h) {
    if (this._bn.has(r)) return !1;
    this._bn.set(r, ++this.lbn);
    var o = new AttachActorItem;
    return o.Id = t, o.EntityId = s, o.Reason = i, o.Actor = r, o.Name = r.GetName(), o.ParentActorName = e.GetName(), o.DetachType = h, GlobalData_1.GlobalData.IsPlayInEditor && r.Tags.Add(FNameUtil_1.FNameUtil.GetDynamicFName("AttachId: " + t)), this.WXe.Set(this.lbn, o), !0
  }
