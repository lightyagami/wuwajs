...
class SneakController extends ControllerBase_1.ControllerBase {
  static StartSneaking() {
    this.wpr = !0, this.B$t(!0), this.G$t(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SneakStart)
  }
  static EndSneaking() {
    this.wpr = !1, this.B$t(!1), this.O$t(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SneakEnd)
  }
  ...
  static O$t() {
    EventSystem_1.EventSystem.Has(EventDefine_1.EEventName.OnBattleStateChanged, this.Zpe) && EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnBattleStateChanged, this.Zpe)
  }
  static B$t(e) {
...
exports.SneakController = SneakController, (_a = SneakController).wpr = !1, SneakController.R$t = !1, SneakController.Zpe = e => {
  _a.B$t(!e), e !== _a.R$t && (_a.R$t = e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnSneakFoundChange, _a.R$t, 0))
};
