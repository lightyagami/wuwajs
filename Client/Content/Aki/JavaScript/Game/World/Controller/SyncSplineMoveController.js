...
class SyncSplineMoveController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    Net_1.Net.Register(19078, this.OnMoveSplineStatusNotify);
    return true;
  }
  static OnClear() {
    Net_1.Net.UnRegister(19078);
    return true;
  }
