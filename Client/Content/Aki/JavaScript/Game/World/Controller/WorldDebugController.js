...
class WorldDebugController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return UE.KuroStaticLibrary.IsEditor(GlobalData_1.GlobalData.World) && ModelManager_1.ModelManager.WorldDebugModel.EnableDebug && (EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.AddEntity, WorldDebugController.GUe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.RemoveEntity, WorldDebugController.zpe)), !0
  }
  static OnClear() {
    return UE.KuroStaticLibrary.IsEditor(GlobalData_1.GlobalData.World) && ModelManager_1.ModelManager.WorldDebugModel.EnableDebug && (EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.AddEntity, WorldDebugController.GUe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.RemoveEntity, WorldDebugController.zpe)), !0
  }
  static Xpr() {
    var e = ModelManager_1.ModelManager.WorldDebugModel.AoiNpcSet.size,
      ...
      t = e + o,
      l = 0 < (l = t - WorldDebugModel_1.FIGHTING_AOI_NPC_MONSTER_MAX_COUNT) ? l : 0,
    ...
    if (!(ModelManager_1.ModelManager.WorldDebugModel.AoiTotalSet.size <= WorldDebugModel_1.FIGHTING_TOTAL_MAX_COUINT && 0 == n)) {
...
` + r;
  ...
  var t;
  r && (t = r.Entity.GetComponent(0), ModelManager_1.ModelManager.WorldDebugModel.AddEntity(t.GetEntityType(), r), WorldDebugController.Xpr())
}, WorldDebugController.zpe = (e, r) => {
  var o;
  r && (o = r.Entity.GetComponent(0), ModelManager_1.ModelManager.WorldDebugModel.RemoveEntity(o.GetEntityType(), r))
};
