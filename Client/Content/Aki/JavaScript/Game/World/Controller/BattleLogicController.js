...
var __decorate = this && this.__decorate || function(t, e, o, a) {
  var r, i = arguments.length,
    l = i < 3 ? e : null === a ? a = Object.getOwnPropertyDescriptor(e, o) : a;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) l = Reflect.decorate(t, e, o, a);
  else
    for (var n = t.length - 1; 0 <= n; n--)(r = t[n]) && (l = (i < 3 ? r(l) : 3 < i ? r(e, o, l) : r(e, o)) || l);
...
class BattleLogicController extends ControllerBase_1.ControllerBase {
  static ExecuteEntityLivingStatus(o, t, e) {
    ...
    if (a) {
      ...
      switch (t.JEs) {
        case Protocol_1.Aki.Protocol.JEs.Proto_Dead: {
          ...
          let e = !1;
          t.aRs.forEach(t => {
            t.hRs && t.W5n === ModelManager_1.ModelManager.PlayerInfoModel.GetId() && (this.u0r.Start(), o.GetComponent(180)?.DetachFromHost(!0, !1, !1), o.Disable("[BattleLogicController.BattleLogicController] 被收服的Entity先隐藏"), this.u0r.Stop(), e = !0, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.CharOnRoleDead, o.Id), EventSystem_1.EventSystem.EmitWithTarget(o, EventDefine_1.EEventName.CharOnRoleDeadTargetSelf))
          }), e || (this.c0r.Start(), o.GetComponent(15)?.ExecuteDeath(r), this.c0r.Stop());
          break
        }
    ...
    } else Log_1.Log.CheckError() && Log_1.Log.Error("World", 19, "[CreatureController.EntityLivingStatusNotify] EntityLivingStatusNotify失败, Entity无效或不存在。", ["CreatureDataId", t.s5n])
  }
  static OnEntityLivingStatusNotify(t) {
    ...
    e?.Valid && e.Entity ? this.ExecuteEntityLivingStatus(e.Entity, t) : Log_1.Log.CheckError() && Log_1.Log.Error("World", 19, "[CreatureController.EntityLivingStatusNotify] EntityLivingStatusNotify失败, Entity无效或不存在。", ["CreatureDataId", t.s5n])
  }
  static d0r(t) {
    t?.Valid && (t.IsInit ? t?.Entity?.GetComponent(191)?.ExecuteRevive() : (t.Entity?.GetComponent(0))?.SetLivingStatus(Protocol_1.Aki.Protocol.JEs.Proto_Alive))
  }
  static _0r(t) {
