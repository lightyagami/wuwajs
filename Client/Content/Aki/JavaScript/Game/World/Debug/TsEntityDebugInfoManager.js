...
class TsEntityDebugInfoManager extends UE.Object {
  Constructor() {}
  static GetInstance() {
    return this.Instance && this.Instance.IsValid() || (this.Instance = UE.NewObject(UE.TsEntityDebugInfoManager_C.StaticClass())), this.Instance
  }
...
exports.TsEntityDebugInfoManager = TsEntityDebugInfoManager, exports.default = TsEntityDebugInfoManager;
