...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.CreatureModel = exports.globalEntityTypePerceptionType = exports.ENABLE_KAWAII_MASK = exports.DISABLE_KAWAII_MASK = void 0;
const puerts_1 = require("puerts"),
  ...
  LevelEntityConfigByMapId_1 = require("../../../Core/Define/ConfigQuery/LevelEntityConfigByMapId"),
  ...
  zero = 0n,
  ONE_HUNDRED = 100;
exports.DISABLE_KAWAII_MASK = 1, exports.ENABLE_KAWAII_MASK = ~exports.DISABLE_KAWAII_MASK, exports.globalEntityTypePerceptionType = [1, 2, 2, 2, 2, 4, 1];
class CreatureModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.EnableEntityLog = !0, this.UseFbEntityConfig = !1, this._Mr = 0, this.uMr = void 0, this.qrl = void 0, this.Ypr = void 0, this.NUe = 0, this.ScenePlayerDataMap = new Map, this.cMr = zero, this.hPr = new EntityContainer_1.EntityContainer, this.mMr = new Map, this.dMr = new Map, this.NCa = new Map, this.CMr = !1, this.RemoveCreaturePendingSet = new Set, this.Lvl = void 0, this.fMr = void 0, this.pMr = void 0, this.vMr = void 0, this.MMr = void 0, this.EMr = void 0, this.SMr = void 0, this.DelayRemoveContainer = new EntityContainer_1.EntityContainer, this.lPr = new EntityContainer_1.EntityContainer, this.uYs = new CreatureDensityContainer_1.CreatureDensityContainer, this.TMr = new Set, this.LMr = !1, this.DMr = void 0, this.RMr = new Map, this.UMr = void 0, this.ActorMovableHandleMap = new Map, this.DisableLock = new Set, this.LeavingLevel = !1, this.ifl = 0, this.AMr = () => {
      for (const t of this.GetAllEntities()) this.dMr.has(t.Id) || SeamlessTravelController_1.SeamlessTravelController.WasRoleEntityInSeamlessTraveling(t.Entity) || this.dMr.set(t.Id, t.Entity.Disable("[CharacterModel.OnLoadMap] Loading"));
      this.CMr = !0
    }, this.nye = () => {
      this.CMr = !1;
      ...
      if (t) {
        for (const i of this.GetAllEntities()) {
          var e;
          Global_1.Global.BaseCharacter?.IsValid() && Global_1.Global.BaseCharacter.EntityId === i.Id || i.Entity.GetComponent(0).GetEntityType() === Protocol_1.Aki.Protocol.kks.Proto_SceneItem || this.dMr.has(i.Id) || this.NCa.has(i.Id) || (i.IsInit ? ((e = i.Entity.GetComponent(111)) && (e = e.DisableTickWithLog("CreatureModel.OnTeleportStart"), this.NCa.set(i.Id, e)), (e = i.Entity.GetComponent(113)) && (e.TeleportLock = !0)) : this.dMr.set(i.Id, i.Entity.Disable("CreatureModel.OnTeleportStart")))
        }
        this.CMr = !0
      }
    }, this.Ilt = () => {
      if (this.CMr) {
        ...
        for (var [i, r] of this.NCa) {
          ...
          i?.Valid && (i.Entity.GetComponent(111).EnableTickWithLog(r, "CreatureModel.OnTeleportComplete"), r = i.Entity.GetComponent(113)) && (r.OnEntityBudgetTickEnableChange(!0), r.TeleportLock = !1)
        }
  ...
  OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.AfterLoadMap, this.AMr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDone, this.nye), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TeleportStart, this.bpr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.TeleportComplete, this.Ilt), !0
  }
  AddEntity(t, e) {
  ...
  AddLoadingEntity(t) {
    t?.Valid ? this.CMr && !this.dMr.has(t.Id) && this.dMr.set(t.Id, t.Entity.Disable("[CreatureModel.AddEntity] LoadingWorld")) : Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "实体句柄无效。")
  }
  RemoveEntity(t, e) {
    var i = this.hPr.RemoveEntity(t),
      e = (this.EnableEntityLog && Log_1.Log.CheckInfo() && Log_1.Log.Info("Entity", 3, "[实体生命周期:删除实体] 删除实体成功", ["CreatureDataId", t], ["Reason", e], ["Result", i]), this.uYs.GetItem(t));
  ...
  GetEntitiesWithTag(t, e) {
    e.length = 0;
    for (const i of this.GetAllEntities()) i.Entity.GetComponent(0).ContainsTag(t) && e.push(i)
  }
  GetEntitiesWithPbDataId(t, e) {
    e.length = 0;
    for (const i of this.GetAllEntities()) i.Entity.GetComponent(0).GetPbDataId() === t && e.push(i)
  }
  GetEntitiesWithOwnerId(t, e) {
    e.length = 0;
    for (const i of this.GetAllEntities()) i.Entity.GetComponent(0).GetOwnerId() === t && e.push(i)
  }
  GetEntity(t) {
  ...
  GetCreaturePbDataId(t) {
    t = EntitySystem_1.EntitySystem.Get(t);
    return t ? t.GetComponent(0).GetPbDataId() : 0
  }
  GetEntityId(t) {
  ...
  GetServerEntityId(t) {
    ...
    if (t) return t = t.GetComponent(0), MathUtils_1.MathUtils.NumberToLong(t.GetCreatureDataId())
  }
  OnLeaveLevel() {
    for (var [, t] of this.ScenePlayerDataMap) t.Clear();
    return this.ScenePlayerDataMap.clear(), this.RemoveCreaturePendingSet.clear(), this.DelayRemoveContainer.Clear(), this.lPr.Clear(), this.TMr.clear(), this.RMr.clear(), this.hPr.Clear(), this.uYs.Clear(), this.Lvl = void 0, this.fMr = void 0, !(this.pMr = void 0)
  }
  GetWorldOwner() {
    return this._Mr
  }
  ...
  SetInstanceId(t) {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInstanceChange, this.NUe, t), this.NUe = t
  }
  GetPlayerId() {
  ...
  AddRemoveCreaturePending(t) {
    return !this.RemoveCreaturePendingSet.has(t) && (this.RemoveCreaturePendingSet.add(t), !0)
  }
  ...
  AddEntityDataConfig(i) {
    if (!PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (PublicUtil_1.PublicUtil.IsUseTempData() || (e = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.LevelsDataDir + `/${i}/Level.json`)), UE.BlueprintPathsLibrary.FileExists(e)) {
        if (UE.KuroStaticLibrary.LoadFileToString(r, e), !(t = (0, puerts_1.$unref)(r))) return !1;
        t = t.trim();
        var n = Info_1.Info.IsBuildDevelopmentOrDebug,
          r = JSON.parse(t),
          o = new Map;
        this.Lvl || (this.Lvl = new Map);
        for (const a of r.EntityDatas) a.EdWpPath = void 0, n || (a.Name = ""), o.set(a.Id, a);
        this.Lvl.set(i, o)
      } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("World", 3, "不存在EntityConfigData配置文件。", ["Path", e])
    }
    return !0
  }
  InitDynamicEntityDataConfig() {
    ...
    if (PublicUtil_1.PublicUtil.IsUseTempData() || (e = (0, PublicUtil_1.getConfigPath)("" + IGlobal_1.globalConfigTemp.EntityDataConfigPath)), !UE.BlueprintPathsLibrary.FileExists(e)) return !1;
    if (UE.KuroStaticLibrary.LoadFileToString(t, e), !(t = (0, puerts_1.$unref)(t))) return !1;
    var i = Info_1.Info.IsBuildDevelopmentOrDebug,
      t = JSON.parse(t);
    this.fMr = new Map;
    for (const r of t.EntityDatas) r.EdWpPath = void 0, i || (r.Name = ""), this.fMr.set(r.Id, r);
    return !0
  }
  xMr() {
    if (!PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (PublicUtil_1.PublicUtil.IsUseTempData() || (t = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.BlueprintConfigPath)), UE.BlueprintPathsLibrary.FileExists(t)) {
        UE.KuroStaticLibrary.LoadFileToString(e, t);
        var i, r, e = (0, puerts_1.$unref)(e),
          e = JSON.parse(e);
  ...
  InitEntityTemplateMap(e = !1) {
    if (e || !PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (PublicUtil_1.PublicUtil.IsUseTempData() || (t = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.TemplateConfigPath)), UE.BlueprintPathsLibrary.FileExists(t)) {
        UE.KuroStaticLibrary.LoadFileToString(e, t);
        e = (0, puerts_1.$unref)(e);
        for (const i of JSON.parse(e).Templates) this.MMr.set(i.Id, i), this.SMr.set(i.BlueprintType, i.Id)
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.InitEntityTemplateMap] 不存在Template.json文件。", ["Path", t])
    }
  }
  BMr(e = !1) {
    if (e || !PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (PublicUtil_1.PublicUtil.IsUseTempData() || (t = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.PrefabConfigPath)), UE.BlueprintPathsLibrary.FileExists(t)) {
        UE.KuroStaticLibrary.LoadFileToString(e, t);
        e = (0, puerts_1.$unref)(e);
        for (const r of JSON.parse(e).Prefabs)
          if (r.Entities?.length) {
            ...
            for (const n of r.Entities) {
              ...
              i ? (i = (0, IEntity_1.decompressEntityData)(n.EntityData, i), t.set(n.EntityData.Id, i)) : Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.InitEntityPrefabMap] 不存在对应的Template。", ["PrefabId", r.PrefabId], ["Id", n.EntityData.Id], ["BlueprintType", n.EntityData.BlueprintType])
            }
          }
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.InitEntityPrefabMap] 不存在Prefab.json文件。", ["Path", t])
    }
  }
  bMr() {
    this.pMr = new Map;
    let t = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfig.EntityOwnerConfigPath);
    if (PublicUtil_1.PublicUtil.IsUseTempData() || (t = (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfigTemp.EntityOwnerConfigPath)), UE.BlueprintPathsLibrary.FileExists(t)) {
      var e = (0, puerts_1.$ref)(""),
        e = (UE.KuroStaticLibrary.LoadFileToString(e, t), e = (0, puerts_1.$unref)(e), JSON.parse(e));
      for (const i of e) {
        let t = this.pMr.get(i.LevelId);
        t || (t = new Map, this.pMr.set(i.LevelId, t)), t.set(i.EntityId, i)
      }
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.InitEntityTemplateMap] 不存在EntityOwner.json文件。", ["Path", t])
  }
  GetEntityData(e, t) {
    if (void 0 === e) Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.GetEntityData] pbDataId为undefined，外部调用的地方要保证这个参数不能为undefined");
    else {
      var i = t ?? ModelManager_1.ModelManager.GameModeModel.MapId;
      if (!PublicUtil_1.PublicUtil.UseDbConfig()) {
        let t = this.Lvl?.get(i);
        return t ? t?.get(e) : (this.AddEntityDataConfig(i), (t = this.Lvl?.get(i))?.get(e))
      }
      var r = LevelEntityConfigByMapIdAndEntityId_1.configLevelEntityConfigByMapIdAndEntityId.GetConfig(i, e);
      if (r) {
        var n = {};
        if (n.Id = r.EntityId, n.BlueprintType = r.BlueprintType, n.InSleep = r.InSleep, n.AreaId = r.AreaId, n.IsScaleEnabled = r.IsScaleEnabled, n.Transform = {}, Info_1.Info.IsBuildDevelopmentOrDebug && (n.Name = r.Name), n.Transform.Pos = {
          ...
          if (!UE.KuroStaticLibrary.LoadFileToArray(i, o)) return void(Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "加载文件失败", ["MapId", t], ["PbDataId", e], ["File", i]));
          t = UE.KuroStaticLibrary.ArrayToBuffer(o), e = new Uint8Array(t), i = new flatbuffers.ByteBuffer(e);
          n.ComponentsData = ComponentReadHelper_1.ComponentReadHelper.ReadComponents(i), n.BufferArray = o
  ...
  GetAllEntityIdOfMapIdAndEntityType(t, e) {
    if (!PublicUtil_1.PublicUtil.UseDbConfig()) {
      ...
      if (i)
        for (const s of i.keys()) {
          var r = i.get(s),
            n = BlueprintConfigByBlueprintType_1.configBlueprintConfigByBlueprintType.GetConfig(r.BlueprintType);
          n && n.EntityType === e && o.push(r.Id)
        }
      return o
    }
    ...
    for (const l of t) {
      ...
      a && a.EntityType === e && o.push(l.EntityId)
    }
    return o
  }
  ...
  GetEntityTemplate(e) {
    ...
    let t = void 0;
    if (t = ("string" == typeof e ? TemplateConfigByBlueprintType_1.configTemplateConfigByBlueprintType : TemplateConfigById_1.configTemplateConfigById).GetConfig(e)) return (e = {}).Id = t.Id, e.BlueprintType = t.BlueprintType, e.Name = t.Name, e.ComponentsData = JSON.parse(t.ComponentsData), e
  }
  GetEntityPrefab(t, e) {
    if (!PublicUtil_1.PublicUtil.UseDbConfig()) return this.EMr || this.BMr(), this.EMr.get(t)?.get(e);
    ...
    if (r) {
      ...
      for (const o of JSON.parse(r.Entities)) {
        ...
        n ? (n = (0, IEntity_1.decompressEntityData)(o.EntityData, n), i.set(o.EntityData.Id, n)) : Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "[CreatureModel.GetEntityPrefab] 不存在对应的Template。", ["PrefabId", t], ["Id", o.EntityData.Id], ["BlueprintType", o.EntityData.BlueprintType])
      }
      return i.get(e)
    }
  }
  GetCompleteEntityData(t, e) {
    ...
    if (t) return e = this.GetEntityTemplate(t.BlueprintType), (0, IEntity_1.decompressEntityData)(t, e)
  }
  GetEntityOwner(t, e) {
    if (PublicUtil_1.PublicUtil.UseDbConfig()) {
  ...
  GetActorRefData() {
    ...
    this.UMr = new Map;
    let t = "";
    if (t = PublicUtil_1.PublicUtil.UseDbConfig() ? UE.BlueprintPathsLibrary.ProjectContentDir() + "Aki/Config/Json/ActorRefConfig.json" : (0, PublicUtil_1.getConfigPath)(IGlobal_1.globalConfig.ActorRefConfigPath), UE.BlueprintPathsLibrary.FileExists(t)) {
      var e = (0, puerts_1.$ref)(""),
        e = (UE.KuroStaticLibrary.LoadFileToString(e, t), (e = (0, puerts_1.$unref)(e)) || Log_1.Log.CheckError() && Log_1.Log.Error("SceneItem", 7, "配置文件为空", ["filePath", t]), Json_1.Json.Parse(e));
      for (const n of e.LevelRefList) {
        ...
        for (const o of n.StreamingGroups) {
          ...
          let t = e.get(r);
          t = t || [];
          for (const a of o.RefData) a.Platform && !Platform_1.Platform.CheckAssetPlatformInclude(a.Platform.toString()) || t.push(a);
          e.set(r, t)
        }
        this.UMr.set(i, e)
      }
    ...
    Log_1.Log.CheckError() && Log_1.Log.Error("SceneItem", 7, "检查配置文件是否存在", ["filePath", t])
  }
  ...
  GetEntityActorByChildActor(t) {
    let e = t;
    for (; e && !UE.KuroStaticLibrary.IsImplementInterface(e.GetClass(), UE.BPI_CreatureInterface_C.StaticClass());) e = e.GetAttachParentActor();
    if (e) {
      t = e;
  ...
  AddOwnerEntityInfo(e) {
    ...
    if (i) {
      ...
      for (const n of i) {
        ...
        if (t) {
          if (t[0] !== r) {
            Log_1.Log.CheckError() && Log_1.Log.Error("World", 50, "子实体具有与记录不同的父实体", ["CreatureId", e], ["ChildPbDataId", n], ["OwnerPbDataId", t[0]], ["RefCount", t[1]]);
            continue
          }
          t[1]++
        } else t = [r, 1], this.mMr.set(n, t);
        Log_1.Log.CheckDebug() && Log_1.Log.Debug("World", 50, "添加实体Owner信息", ["CreatureId", e], ["ChildPbDataId", n], ["OwnerPbDataId", t[0]], ["RefCount", t[1]])
      }
    }
  }
  RemoveOwnerEntityInfo(t) {
    ...
    if (e)
      for (const r of e) {
        ...
        i && (0 == --i[1] && this.mMr.delete(r), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("World", 50, "移除实体Owner信息", ["CreatureId", t], ["ChildPbDataId", r], ["OwnerPbDataId", i[0]], ["RefCount", i[1]])
      }
  }
  ...
  IsAllowedOnThisPlatform(t, e) {
    ...
    return !(e && e.ComponentsData && (e = (0, IComponent_1.getComponent)(e.ComponentsData, "EntityVisibleComponent")) && 1 === e.TargetPlatform && Info_1.Info.IsMobilePlatform() && (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Entity", 35, "当前平台拦截该实体", ["CreatureDataId", t], ["TargetPlatform", e.TargetPlatform], ["CurPlatform", Info_1.Info.PlatformType]), 1))
  }
  SetKawaiiMask(t) {
    t ? this.ifl &= exports.ENABLE_KAWAII_MASK : this.ifl |= exports.DISABLE_KAWAII_MASK
  }
  _r_(t) {
    switch (t) {
      case 1:
