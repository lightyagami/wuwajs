...
class WorldDebugModel extends ModelBase_1.ModelBase {
  ...
  AddSummonEntity(t) {
    if (t) {
      this.AoiSummonSet.add(t);
      this.AoiTotalSet.add(t);
    }
  }
  AddVisionEntity(t) {
    if (t) {
      this.AoiVisionSet.add(t);
      this.AoiTotalSet.add(t);
    }
  }
  AddMonsterEntity(t) {
    if (t) {
      this.AoiMonsterSet.add(t);
      this.AoiTotalSet.add(t);
    }
  }
  AddNpcEntity(t) {
    if (t) {
      this.AoiNpcSet.add(t);
      this.AoiTotalSet.add(t);
    }
  }
  AddRoleEntity(t) {
    if (t) {
      this.AoiRoleSet.add(t);
      this.AoiTotalSet.add(t);
    }
  }
  RemoveSummonEntity(t) {
    if (t) {
      this.AoiSummonSet.delete(t);
      this.AoiTotalSet.delete(t);
    }
  }
  AddEntity(t, e) {
    if (e) {
  ...
  RemoveEntity(t, e) {
    if (e) {
      switch (t) {
        case Protocol_1.Aki.Protocol.kks.Proto_Player:
          this.AoiRoleSet.delete(e);
          this.AoiTotalSet.delete(e);
          break;
        case Protocol_1.Aki.Protocol.kks.Proto_Monster:
          this.AoiMonsterSet.delete(e);
          this.AoiTotalSet.delete(e);
          break;
        case Protocol_1.Aki.Protocol.kks.Proto_Npc:
          this.AoiNpcSet.delete(e);
          this.AoiTotalSet.delete(e);
          break;
        case Protocol_1.Aki.Protocol.kks.Proto_Vision:
          this.AoiVisionSet.delete(e);
          this.AoiTotalSet.delete(e);
      }
    }
  }
  OnLeaveLevel() {
    if (UE.KuroStaticLibrary.IsEditor(GlobalData_1.GlobalData.World) && this.EnableDebug) {
