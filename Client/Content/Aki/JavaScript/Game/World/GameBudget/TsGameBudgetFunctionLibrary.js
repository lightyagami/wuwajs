...
class TsGameBudgetFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static RegisterGameBudget(t, r) {
    if ("ScheduledTick" in t) {
      ...
      r.RegisterTick(e) && TsGameBudgetFunctionLibrary.TsGameBudgetObjectMap.set(t, r)
    }
  }
  static UnregisterGameBudget(e) {
    var t;
    TsGameBudgetFunctionLibrary.TsGameBudgetObjectMap.has(e) && ((t = TsGameBudgetFunctionLibrary.TsGameBudgetObjectMap.get(e)) && t.UnregisterTick(), TsGameBudgetFunctionLibrary.TsGameBudgetObjectMap.delete(e))
  }
}
TsGameBudgetFunctionLibrary.TsGameBudgetObjectMap = new Map, exports.default = TsGameBudgetFunctionLibrary;
