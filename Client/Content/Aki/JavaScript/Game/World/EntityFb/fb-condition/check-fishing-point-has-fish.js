...
class CheckFishingPointHasFish {
  ...
  static getSizePrefixedRootAsCheckFishingPointHasFish(i, s) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CheckFishingPointHasFish).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createCheckFishingPointHasFish(i, s, t) {
    return CheckFishingPointHasFish.startCheckFishingPointHasFish(i), CheckFishingPointHasFish.addType(i, s), CheckFishingPointHasFish.addHasFish(i, t), CheckFishingPointHasFish.endCheckFishingPointHasFish(i)
  }
}
