...
class CheckOnlinePlayer {
  ...
  static getSizePrefixedRootAsCheckOnlinePlayer(e, n) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new CheckOnlinePlayer).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckOnlinePlayer(e, n, t, i) {
    return CheckOnlinePlayer.startCheckOnlinePlayer(e), CheckOnlinePlayer.addType(e, n), CheckOnlinePlayer.addOnlinePlayerConditionTargetOptionType(e, t), CheckOnlinePlayer.addOnlinePlayerConditionTargetOption(e, i), CheckOnlinePlayer.endCheckOnlinePlayer(e)
  }
}
