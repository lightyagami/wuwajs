...
class SelfEntity {
  ...
  static getSizePrefixedRootAsSelfEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SelfEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSelfEntity(t, e) {
    return SelfEntity.startSelfEntity(t), SelfEntity.addType(t, e), SelfEntity.endSelfEntity(t)
  }
}
