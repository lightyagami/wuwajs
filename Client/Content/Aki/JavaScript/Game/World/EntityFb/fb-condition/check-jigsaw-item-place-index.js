...
class CheckJigsawItemPlaceIndex {
  ...
  static getRootAsCheckJigsawItemPlaceIndex(t, e) {
    return (e || new CheckJigsawItemPlaceIndex).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCheckJigsawItemPlaceIndex(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckJigsawItemPlaceIndex).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  placeIndex(t) {
    ...
    return e ? (t || new piece_index_js_1.PieceIndex).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  compare(t) {
