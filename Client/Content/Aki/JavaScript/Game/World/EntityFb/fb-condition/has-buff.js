...
class HasBuff {
  ...
  static getSizePrefixedRootAsHasBuff(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HasBuff).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHasBuff(t, i, s, e, n, a) {
    return HasBuff.startHasBuff(t), HasBuff.addType(t, i), HasBuff.addBuffId(t, s), HasBuff.addCompare(t, e), HasBuff.addOnlinePlayerConditionTargetOptionType(t, n), HasBuff.addOnlinePlayerConditionTargetOption(t, a), HasBuff.endHasBuff(t)
  }
}
