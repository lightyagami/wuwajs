...
class FeatureCollectionLevel {
  ...
  static getSizePrefixedRootAsFeatureCollectionLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FeatureCollectionLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createFeatureCollectionLevel(e, t, i, l, r) {
    return FeatureCollectionLevel.startFeatureCollectionLevel(e), FeatureCollectionLevel.addType(e, t), FeatureCollectionLevel.addId(e, i), FeatureCollectionLevel.addCompare(e, l), FeatureCollectionLevel.addLevel(e, r), FeatureCollectionLevel.endFeatureCollectionLevel(e)
  }
}
