...
class ESkillReady {
  ...
  static getSizePrefixedRootAsESkillReady(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ESkillReady).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createESkillReady(t, e) {
    return ESkillReady.startESkillReady(t), ESkillReady.addType(t, e), ESkillReady.endESkillReady(t)
  }
}
