...
class ListenEntityThroughPortal {
  ...
  static getSizePrefixedRootAsListenEntityThroughPortal(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ListenEntityThroughPortal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createListenEntityThroughPortal(t, i, r, e, s) {
    return ListenEntityThroughPortal.startListenEntityThroughPortal(t), ListenEntityThroughPortal.addType(t, i), ListenEntityThroughPortal.addCheckTargetType(t, r), ListenEntityThroughPortal.addCheckTarget(t, e), ListenEntityThroughPortal.addPortalEntityId(t, s), ListenEntityThroughPortal.endListenEntityThroughPortal(t)
  }
}
