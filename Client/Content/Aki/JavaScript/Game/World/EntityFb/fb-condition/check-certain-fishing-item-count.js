...
class CheckCertainFishingItemCount {
  ...
  static getSizePrefixedRootAsCheckCertainFishingItemCount(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckCertainFishingItemCount).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckCertainFishingItemCount(t, i, e, n, s) {
    return CheckCertainFishingItemCount.startCheckCertainFishingItemCount(t), CheckCertainFishingItemCount.addType(t, i), CheckCertainFishingItemCount.addId(t, e), CheckCertainFishingItemCount.addCompare(t, n), CheckCertainFishingItemCount.addCount(t, s), CheckCertainFishingItemCount.endCheckCertainFishingItemCount(t)
  }
}
