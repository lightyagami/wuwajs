...
class CheckGameplayTagCondition {
  ...
  static getSizePrefixedRootAsCheckGameplayTagCondition(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CheckGameplayTagCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckGameplayTagCondition(t, a, i, e, n, o) {
    return CheckGameplayTagCondition.startCheckGameplayTagCondition(t), CheckGameplayTagCondition.addType(t, a), CheckGameplayTagCondition.addTargetType(t, i), CheckGameplayTagCondition.addTarget(t, e), CheckGameplayTagCondition.addGameplayTag(t, n), CheckGameplayTagCondition.addCompare(t, o), CheckGameplayTagCondition.endCheckGameplayTagCondition(t)
  }
}
