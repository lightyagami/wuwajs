...
class CheckDataLayerCondition {
  ...
  static getSizePrefixedRootAsCheckDataLayerCondition(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CheckDataLayerCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckDataLayerCondition(t, a, e, i) {
    return CheckDataLayerCondition.startCheckDataLayerCondition(t), CheckDataLayerCondition.addType(t, a), CheckDataLayerCondition.addDataLayerId(t, e), CheckDataLayerCondition.addIsLoad(t, i), CheckDataLayerCondition.endCheckDataLayerCondition(t)
  }
}
