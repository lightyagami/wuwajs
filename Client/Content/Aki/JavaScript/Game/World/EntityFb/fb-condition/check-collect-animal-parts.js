...
class CheckCollectAnimalParts {
  ...
  static getSizePrefixedRootAsCheckCollectAnimalParts(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CheckCollectAnimalParts).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckCollectAnimalParts(t, s, e, i, r) {
    return CheckCollectAnimalParts.startCheckCollectAnimalParts(t), CheckCollectAnimalParts.addType(t, s), CheckCollectAnimalParts.addTargetAnimal(t, e), CheckCollectAnimalParts.addCheckType(t, i), CheckCollectAnimalParts.addSlots(t, r), CheckCollectAnimalParts.endCheckCollectAnimalParts(t)
  }
}
