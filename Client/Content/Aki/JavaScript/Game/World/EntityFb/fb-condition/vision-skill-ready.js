...
class VisionSkillReady {
  ...
  static getSizePrefixedRootAsVisionSkillReady(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VisionSkillReady).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createVisionSkillReady(i, t) {
    return VisionSkillReady.startVisionSkillReady(i), VisionSkillReady.addType(i, t), VisionSkillReady.endVisionSkillReady(i)
  }
}
