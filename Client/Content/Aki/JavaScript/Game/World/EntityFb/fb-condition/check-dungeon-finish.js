...
class CheckDungeonFinish {
  ...
  static getSizePrefixedRootAsCheckDungeonFinish(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckDungeonFinish).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckDungeonFinish(e, i, n) {
    return CheckDungeonFinish.startCheckDungeonFinish(e), CheckDungeonFinish.addType(e, i), CheckDungeonFinish.addDungeonId(e, n), CheckDungeonFinish.endCheckDungeonFinish(e)
  }
}
