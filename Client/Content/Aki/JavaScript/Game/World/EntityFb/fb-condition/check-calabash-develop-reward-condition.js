...
class CheckCalabashDevelopRewardCondition {
  ...
  static getSizePrefixedRootAsCheckCalabashDevelopRewardCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckCalabashDevelopRewardCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckCalabashDevelopRewardCondition(e, t, a, i) {
    return CheckCalabashDevelopRewardCondition.startCheckCalabashDevelopRewardCondition(e), CheckCalabashDevelopRewardCondition.addType(e, t), CheckCalabashDevelopRewardCondition.addMonsterId(e, a), CheckCalabashDevelopRewardCondition.addDevelop(e, i), CheckCalabashDevelopRewardCondition.endCheckCalabashDevelopRewardCondition(e)
  }
}
