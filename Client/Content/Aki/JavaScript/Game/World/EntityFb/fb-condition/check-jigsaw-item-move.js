...
class CheckJigsawItemMove {
  ...
  static getSizePrefixedRootAsCheckJigsawItemMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckJigsawItemMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckJigsawItemMove(t, e, s, i) {
    return CheckJigsawItemMove.startCheckJigsawItemMove(t), CheckJigsawItemMove.addType(t, e), CheckJigsawItemMove.addItemEntityId(t, s), CheckJigsawItemMove.addCompare(t, i), CheckJigsawItemMove.endCheckJigsawItemMove(t)
  }
}
