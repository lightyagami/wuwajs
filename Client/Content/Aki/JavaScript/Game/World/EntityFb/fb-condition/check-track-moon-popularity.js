...
class CheckTrackMoonPopularity {
  ...
  static getSizePrefixedRootAsCheckTrackMoonPopularity(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new CheckTrackMoonPopularity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckTrackMoonPopularity(t, r, o, a) {
    return CheckTrackMoonPopularity.startCheckTrackMoonPopularity(t), CheckTrackMoonPopularity.addType(t, r), CheckTrackMoonPopularity.addCompare(t, o), CheckTrackMoonPopularity.addPopularity(t, a), CheckTrackMoonPopularity.endCheckTrackMoonPopularity(t)
  }
}
