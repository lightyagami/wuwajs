...
class EntityGroupCondition {
  ...
  static getSizePrefixedRootAsEntityGroupCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityGroupCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  count() {
  ...
  conditions(t, i) {
    ...
    return n ? (i || new entity_event_condition_js_1.EntityEventCondition).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  conditionsLength() {
  ...
  static createEntityGroupCondition(t, i, n, o) {
    return EntityGroupCondition.startEntityGroupCondition(t), EntityGroupCondition.addCount(t, i), EntityGroupCondition.addCompare(t, n), EntityGroupCondition.addConditions(t, o), EntityGroupCondition.endEntityGroupCondition(t)
  }
}
