...
class CompareLiftCondition {
  ...
  static getSizePrefixedRootAsCompareLiftCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompareLiftCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompareLiftCondition(t, i, o, e, r, s) {
    return CompareLiftCondition.startCompareLiftCondition(t), CompareLiftCondition.addType(t, i), CompareLiftCondition.addIsSelf(t, o), CompareLiftCondition.addEntityId(t, e), CompareLiftCondition.addCompare(t, r), CompareLiftCondition.addLocation(t, s), CompareLiftCondition.endCompareLiftCondition(t)
  }
}
