...
class SpecifyRoleLevel {
  ...
  static getSizePrefixedRootAsSpecifyRoleLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SpecifyRoleLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSpecifyRoleLevel(e, t, i, s, l) {
    return SpecifyRoleLevel.startSpecifyRoleLevel(e), SpecifyRoleLevel.addType(e, t), SpecifyRoleLevel.addIndex(e, i), SpecifyRoleLevel.addCompare(e, s), SpecifyRoleLevel.addLevel(e, l), SpecifyRoleLevel.endSpecifyRoleLevel(e)
  }
}
