...
class CheckAlertAreaEnabled {
  ...
  static getSizePrefixedRootAsCheckAlertAreaEnabled(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckAlertAreaEnabled).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckAlertAreaEnabled(e, t, r) {
    return CheckAlertAreaEnabled.startCheckAlertAreaEnabled(e), CheckAlertAreaEnabled.addType(e, t), CheckAlertAreaEnabled.addAreaId(e, r), CheckAlertAreaEnabled.endCheckAlertAreaEnabled(e)
  }
}
