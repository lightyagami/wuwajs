...
class CompareLevelPlayRewardStateCondition {
  ...
  static getSizePrefixedRootAsCompareLevelPlayRewardStateCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareLevelPlayRewardStateCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareLevelPlayRewardStateCondition(e, t, a) {
    return CompareLevelPlayRewardStateCondition.startCompareLevelPlayRewardStateCondition(e), CompareLevelPlayRewardStateCondition.addType(e, t), CompareLevelPlayRewardStateCondition.addCompare(e, a), CompareLevelPlayRewardStateCondition.endCompareLevelPlayRewardStateCondition(e)
  }
}
