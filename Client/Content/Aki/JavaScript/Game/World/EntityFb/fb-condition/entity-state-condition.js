...
class EntityStateCondition {
  ...
  static getSizePrefixedRootAsEntityStateCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityStateCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createEntityStateCondition(t, i, n) {
    return EntityStateCondition.startEntityStateCondition(t), EntityStateCondition.addEntityId(t, i), EntityStateCondition.addState(t, n), EntityStateCondition.endEntityStateCondition(t)
  }
}
