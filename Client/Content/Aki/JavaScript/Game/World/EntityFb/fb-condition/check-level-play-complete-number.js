...
class CheckLevelPlayCompleteNumber {
  ...
  static getSizePrefixedRootAsCheckLevelPlayCompleteNumber(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckLevelPlayCompleteNumber).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckLevelPlayCompleteNumber(e, t, r, l, s) {
    return CheckLevelPlayCompleteNumber.startCheckLevelPlayCompleteNumber(e), CheckLevelPlayCompleteNumber.addType(e, t), CheckLevelPlayCompleteNumber.addLevelId(e, r), CheckLevelPlayCompleteNumber.addCompare(e, l), CheckLevelPlayCompleteNumber.addNumber(e, s), CheckLevelPlayCompleteNumber.endCheckLevelPlayCompleteNumber(e)
  }
}
