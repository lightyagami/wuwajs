...
class CheckPlayerStateRestrictionCondition {
  ...
  static getSizePrefixedRootAsCheckPlayerStateRestrictionCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckPlayerStateRestrictionCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
