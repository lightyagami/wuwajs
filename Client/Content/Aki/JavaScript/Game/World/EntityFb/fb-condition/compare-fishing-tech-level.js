...
class CompareFishingTechLevel {
  ...
  static getSizePrefixedRootAsCompareFishingTechLevel(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompareFishingTechLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareFishingTechLevel(e, i, t, s, h) {
    return CompareFishingTechLevel.startCompareFishingTechLevel(e), CompareFishingTechLevel.addType(e, i), CompareFishingTechLevel.addTechId(e, t), CompareFishingTechLevel.addCompare(e, s), CompareFishingTechLevel.addTechLevel(e, h), CompareFishingTechLevel.endCompareFishingTechLevel(e)
  }
}
