...
class CheckRogueAbilitySelectCondition {
  ...
  static getSizePrefixedRootAsCheckRogueAbilitySelectCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckRogueAbilitySelectCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckRogueAbilitySelectCondition(t, e, i, o) {
    return CheckRogueAbilitySelectCondition.startCheckRogueAbilitySelectCondition(t), CheckRogueAbilitySelectCondition.addType(t, e), CheckRogueAbilitySelectCondition.addBoardId(t, i), CheckRogueAbilitySelectCondition.addIsReceived(t, o), CheckRogueAbilitySelectCondition.endCheckRogueAbilitySelectCondition(t)
  }
}
