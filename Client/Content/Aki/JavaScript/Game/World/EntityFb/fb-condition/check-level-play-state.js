...
class CheckLevelPlayState {
  ...
  static getSizePrefixedRootAsCheckLevelPlayState(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckLevelPlayState).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckLevelPlayState(e, t, a, s, i) {
    return CheckLevelPlayState.startCheckLevelPlayState(e), CheckLevelPlayState.addType(e, t), CheckLevelPlayState.addLevelId(e, a), CheckLevelPlayState.addCompare(e, s), CheckLevelPlayState.addState(e, i), CheckLevelPlayState.endCheckLevelPlayState(e)
  }
}
