...
class CheckItems {
  ...
  static getSizePrefixedRootAsCheckItems(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckItems).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  items(t, e) {
    ...
    return s ? (e || new item_config_js_1.ItemConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  itemsLength() {
  ...
  static createCheckItems(t, e, s, i) {
    return CheckItems.startCheckItems(t), CheckItems.addType(t, e), CheckItems.addCompare(t, s), CheckItems.addItems(t, i), CheckItems.endCheckItems(t)
  }
}
