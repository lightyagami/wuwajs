...
class CheckEntityDistanceCondition {
  ...
  static getSizePrefixedRootAsCheckEntityDistanceCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckEntityDistanceCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  targetAType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_target_entity_js_1.UnionTargetEntity.NONE
  }
  targetA(t) {
  ...
  static createCheckEntityDistanceCondition(t, i, n, e, s, a, r, o) {
    return CheckEntityDistanceCondition.startCheckEntityDistanceCondition(t), CheckEntityDistanceCondition.addType(t, i), CheckEntityDistanceCondition.addTargetAType(t, n), CheckEntityDistanceCondition.addTargetA(t, e), CheckEntityDistanceCondition.addTargetBType(t, s), CheckEntityDistanceCondition.addTargetB(t, a), CheckEntityDistanceCondition.addCompare(t, r), CheckEntityDistanceCondition.addDistance(t, o), CheckEntityDistanceCondition.endCheckEntityDistanceCondition(t)
  }
}
