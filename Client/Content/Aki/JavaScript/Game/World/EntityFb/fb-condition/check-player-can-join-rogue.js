...
class CheckPlayerCanJoinRogue {
  ...
  static getSizePrefixedRootAsCheckPlayerCanJoinRogue(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckPlayerCanJoinRogue).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckPlayerCanJoinRogue(e, t, i, a) {
    return CheckPlayerCanJoinRogue.startCheckPlayerCanJoinRogue(e), CheckPlayerCanJoinRogue.addType(e, t), CheckPlayerCanJoinRogue.addCanJoin(e, i), CheckPlayerCanJoinRogue.addRogueType(e, a), CheckPlayerCanJoinRogue.endCheckPlayerCanJoinRogue(e)
  }
}
