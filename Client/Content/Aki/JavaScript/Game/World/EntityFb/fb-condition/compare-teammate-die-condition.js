...
class CompareTeammateDieCondition {
  ...
  static getSizePrefixedRootAsCompareTeammateDieCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareTeammateDieCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareTeammateDieCondition(e, t, i, a) {
    return CompareTeammateDieCondition.startCompareTeammateDieCondition(e), CompareTeammateDieCondition.addType(e, t), CompareTeammateDieCondition.addCompare(e, i), CompareTeammateDieCondition.addDieCount(e, a), CompareTeammateDieCondition.endCompareTeammateDieCondition(e)
  }
}
