...
class HasUpgradableVision {
  ...
  static getSizePrefixedRootAsHasUpgradableVision(s, i) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HasUpgradableVision).__init(s.readInt32(s.position()) + s.position(), s)
  }
  type(s) {
  ...
  static createHasUpgradableVision(s, i, a) {
    return HasUpgradableVision.startHasUpgradableVision(s), HasUpgradableVision.addType(s, i), HasUpgradableVision.addOption(s, a), HasUpgradableVision.endHasUpgradableVision(s)
  }
}
