...
class CheckPlayerCanJoinActivityCondition {
  ...
  static getSizePrefixedRootAsCheckPlayerCanJoinActivityCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckPlayerCanJoinActivityCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  configType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_check_player_can_join_activity_js_1.UnionCheckPlayerCanJoinActivity.NONE
  }
  config(i) {
  ...
  static createCheckPlayerCanJoinActivityCondition(i, t, n, e) {
    return CheckPlayerCanJoinActivityCondition.startCheckPlayerCanJoinActivityCondition(i), CheckPlayerCanJoinActivityCondition.addType(i, t), CheckPlayerCanJoinActivityCondition.addConfigType(i, n), CheckPlayerCanJoinActivityCondition.addConfig(i, e), CheckPlayerCanJoinActivityCondition.endCheckPlayerCanJoinActivityCondition(i)
  }
}
