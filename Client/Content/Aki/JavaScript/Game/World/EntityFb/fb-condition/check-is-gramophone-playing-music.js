...
class CheckIsGramophonePlayingMusic {
  ...
  static getSizePrefixedRootAsCheckIsGramophonePlayingMusic(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckIsGramophonePlayingMusic).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  checkCondition(t) {
    ...
    return i ? (t || new gramophone_check_condition_js_1.GramophoneCheckCondition).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
