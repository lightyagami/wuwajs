...
class OnlinePlayerConditionTargetHost {
  ...
  static getSizePrefixedRootAsOnlinePlayerConditionTargetHost(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OnlinePlayerConditionTargetHost).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOnlinePlayerConditionTargetHost(t, e) {
    return OnlinePlayerConditionTargetHost.startOnlinePlayerConditionTargetHost(t), OnlinePlayerConditionTargetHost.addType(t, e), OnlinePlayerConditionTargetHost.endOnlinePlayerConditionTargetHost(t)
  }
}
