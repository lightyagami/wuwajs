...
class CheckHookLockPointCondition {
  ...
  static getSizePrefixedRootAsCheckHookLockPointCondition(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new CheckHookLockPointCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckHookLockPointCondition(t, o, i) {
    return CheckHookLockPointCondition.startCheckHookLockPointCondition(t), CheckHookLockPointCondition.addType(t, o), CheckHookLockPointCondition.addEntityIds(t, i), CheckHookLockPointCondition.endCheckHookLockPointCondition(t)
  }
}
