...
class CompareFishingPrestigeLevelCondition {
  ...
  static getSizePrefixedRootAsCompareFishingPrestigeLevelCondition(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompareFishingPrestigeLevelCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareFishingPrestigeLevelCondition(e, i, t, s) {
    return CompareFishingPrestigeLevelCondition.startCompareFishingPrestigeLevelCondition(e), CompareFishingPrestigeLevelCondition.addType(e, i), CompareFishingPrestigeLevelCondition.addCompare(e, t), CompareFishingPrestigeLevelCondition.addPrestigeLevel(e, s), CompareFishingPrestigeLevelCondition.endCompareFishingPrestigeLevelCondition(e)
  }
}
