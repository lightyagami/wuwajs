...
class ConditionGroup {
  ...
  static getSizePrefixedRootAsConditionGroup(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ConditionGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createConditionGroup(t, i, s, o, r) {
    return ConditionGroup.startConditionGroup(t), ConditionGroup.addType(t, i), ConditionGroup.addConditionsExtType(t, s), ConditionGroup.addConditionsType(t, o), ConditionGroup.addConditions(t, r), ConditionGroup.endConditionGroup(t)
  }
}
