...
class HealthAttribute {
  ...
  static getSizePrefixedRootAsHealthAttribute(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HealthAttribute).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHealthAttribute(t, e, i, r) {
    return HealthAttribute.startHealthAttribute(t), HealthAttribute.addType(t, e), HealthAttribute.addCompare(t, i), HealthAttribute.addValue(t, r), HealthAttribute.endHealthAttribute(t)
  }
}
