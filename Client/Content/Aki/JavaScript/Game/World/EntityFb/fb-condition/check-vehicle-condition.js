...
class CheckVehicleCondition {
  ...
  static getSizePrefixedRootAsCheckVehicleCondition(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckVehicleCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  conditionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_vehicle_condition_js_1.UnionVehicleCondition.NONE
  }
  condition(i) {
  ...
  static createCheckVehicleCondition(i, e, t, n) {
    return CheckVehicleCondition.startCheckVehicleCondition(i), CheckVehicleCondition.addType(i, e), CheckVehicleCondition.addConditionType(i, t), CheckVehicleCondition.addCondition(i, n), CheckVehicleCondition.endCheckVehicleCondition(i)
  }
}
