...
class CheckTreasureBeenClaimedCondition {
  ...
  static getSizePrefixedRootAsCheckTreasureBeenClaimedCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckTreasureBeenClaimedCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckTreasureBeenClaimedCondition(e, t, i) {
    return CheckTreasureBeenClaimedCondition.startCheckTreasureBeenClaimedCondition(e), CheckTreasureBeenClaimedCondition.addType(e, t), CheckTreasureBeenClaimedCondition.addEntityId(e, i), CheckTreasureBeenClaimedCondition.endCheckTreasureBeenClaimedCondition(e)
  }
}
