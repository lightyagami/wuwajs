...
class PreChildQuest {
  ...
  static getSizePrefixedRootAsPreChildQuest(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PreChildQuest).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  preChildQuest(t) {
    ...
    return e ? (t || new child_quest_condition_js_1.ChildQuestCondition).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
