...
class HasEquippedVision {
  ...
  static getSizePrefixedRootAsHasEquippedVision(i, s) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new HasEquippedVision).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createHasEquippedVision(i, s, t) {
    return HasEquippedVision.startHasEquippedVision(i), HasEquippedVision.addType(i, s), HasEquippedVision.addOption(i, t), HasEquippedVision.endHasEquippedVision(i)
  }
}
