...
class CheckChessWinner {
  ...
  static getSizePrefixedRootAsCheckChessWinner(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CheckChessWinner).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckChessWinner(e, s, t, i) {
    return CheckChessWinner.startCheckChessWinner(e), CheckChessWinner.addType(e, s), CheckChessWinner.addChessboardId(e, t), CheckChessWinner.addWinner(e, i), CheckChessWinner.endCheckChessWinner(e)
  }
}
