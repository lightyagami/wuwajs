...
class SpecifyRoleWeaponLevel {
  ...
  static getSizePrefixedRootAsSpecifyRoleWeaponLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SpecifyRoleWeaponLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSpecifyRoleWeaponLevel(e, t, i, s, o) {
    return SpecifyRoleWeaponLevel.startSpecifyRoleWeaponLevel(e), SpecifyRoleWeaponLevel.addType(e, t), SpecifyRoleWeaponLevel.addIndex(e, i), SpecifyRoleWeaponLevel.addCompare(e, s), SpecifyRoleWeaponLevel.addLevel(e, o), SpecifyRoleWeaponLevel.endSpecifyRoleWeaponLevel(e)
  }
}
