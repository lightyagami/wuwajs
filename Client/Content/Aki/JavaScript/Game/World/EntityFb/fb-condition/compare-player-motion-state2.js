...
class ComparePlayerMotionState2 {
  ...
  static getSizePrefixedRootAsComparePlayerMotionState2(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ComparePlayerMotionState2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createComparePlayerMotionState2(t, e, o, i, a, r) {
    return ComparePlayerMotionState2.startComparePlayerMotionState2(t), ComparePlayerMotionState2.addType(t, e), ComparePlayerMotionState2.addMotionState(t, o), ComparePlayerMotionState2.addCompare(t, i), ComparePlayerMotionState2.addOnlinePlayerConditionTargetOptionType(t, a), ComparePlayerMotionState2.addOnlinePlayerConditionTargetOption(t, r), ComparePlayerMotionState2.endComparePlayerMotionState2(t)
  }
}
