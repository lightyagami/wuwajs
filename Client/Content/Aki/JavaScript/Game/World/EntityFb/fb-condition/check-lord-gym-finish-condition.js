...
class CheckLordGymFinishCondition {
  ...
  static getSizePrefixedRootAsCheckLordGymFinishCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckLordGymFinishCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createCheckLordGymFinishCondition(i, t, o) {
    return CheckLordGymFinishCondition.startCheckLordGymFinishCondition(i), CheckLordGymFinishCondition.addType(i, t), CheckLordGymFinishCondition.addLordGymId(i, o), CheckLordGymFinishCondition.endCheckLordGymFinishCondition(i)
  }
}
