...
class CheckEntityPosition {
  ...
  static getSizePrefixedRootAsCheckEntityPosition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckEntityPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckEntityPosition(t, i, s, n, e, o) {
    return CheckEntityPosition.startCheckEntityPosition(t), CheckEntityPosition.addType(t, i), CheckEntityPosition.addEntityId(t, s), CheckEntityPosition.addRangeType(t, n), CheckEntityPosition.addRange(t, e), CheckEntityPosition.addIsOnRange(t, o), CheckEntityPosition.endCheckEntityPosition(t)
  }
}
