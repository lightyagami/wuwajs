...
class CheckJigsawInfoCondition {
  ...
  static getSizePrefixedRootAsCheckJigsawInfoCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckJigsawInfoCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  jigsawConditionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_check_jigsaw_info_js_1.UnionCheckJigsawInfo.NONE
  }
  jigsawCondition(i) {
  ...
  static createCheckJigsawInfoCondition(i, t, n, o) {
    return CheckJigsawInfoCondition.startCheckJigsawInfoCondition(i), CheckJigsawInfoCondition.addType(i, t), CheckJigsawInfoCondition.addJigsawConditionType(i, n), CheckJigsawInfoCondition.addJigsawCondition(i, o), CheckJigsawInfoCondition.endCheckJigsawInfoCondition(i)
  }
}
