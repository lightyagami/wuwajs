...
class CheckEntitiesExist {
  ...
  static getSizePrefixedRootAsCheckEntitiesExist(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckEntitiesExist).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckEntitiesExist(t, i, s, e) {
    return CheckEntitiesExist.startCheckEntitiesExist(t), CheckEntitiesExist.addType(t, i), CheckEntitiesExist.addEntityIds(t, s), CheckEntitiesExist.addIsExist(t, e), CheckEntitiesExist.endCheckEntitiesExist(t)
  }
}
