...
class TimePeriod {
  ...
  static getSizePrefixedRootAsTimePeriod(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TimePeriod).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createTimePeriod(i, e, t, r) {
    return TimePeriod.startTimePeriod(i), TimePeriod.addType(i, e), TimePeriod.addCompare(i, t), TimePeriod.addTimePeriod(i, r), TimePeriod.endTimePeriod(i)
  }
}
