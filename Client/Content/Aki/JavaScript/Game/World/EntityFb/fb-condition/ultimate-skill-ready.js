...
class UltimateSkillReady {
  ...
  static getSizePrefixedRootAsUltimateSkillReady(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UltimateSkillReady).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUltimateSkillReady(t, e) {
    return UltimateSkillReady.startUltimateSkillReady(t), UltimateSkillReady.addType(t, e), UltimateSkillReady.endUltimateSkillReady(t)
  }
}
