...
class CountDangoOverTargetLevel {
  ...
  static getSizePrefixedRootAsCountDangoOverTargetLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CountDangoOverTargetLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCountDangoOverTargetLevel(e, t, r, a) {
    return CountDangoOverTargetLevel.startCountDangoOverTargetLevel(e), CountDangoOverTargetLevel.addType(e, t), CountDangoOverTargetLevel.addTargetNumber(e, r), CountDangoOverTargetLevel.addTargetLevel(e, a), CountDangoOverTargetLevel.endCountDangoOverTargetLevel(e)
  }
}
