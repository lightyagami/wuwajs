...
class CompareEntityStateCondition {
  ...
  static getSizePrefixedRootAsCompareEntityStateCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompareEntityStateCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompareEntityStateCondition(t, i, e, n, o) {
    return CompareEntityStateCondition.startCompareEntityStateCondition(t), CompareEntityStateCondition.addType(t, i), CompareEntityStateCondition.addEntityId(t, e), CompareEntityStateCondition.addCompare(t, n), CompareEntityStateCondition.addState(t, o), CompareEntityStateCondition.endCompareEntityStateCondition(t)
  }
}
