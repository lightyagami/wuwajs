...
class CheckSystemFunction {
  ...
  static getSizePrefixedRootAsCheckSystemFunction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckSystemFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckSystemFunction(t, e, s, i) {
    return CheckSystemFunction.startCheckSystemFunction(t), CheckSystemFunction.addType(t, e), CheckSystemFunction.addSystemId(t, s), CheckSystemFunction.addCompare(t, i), CheckSystemFunction.endCheckSystemFunction(t)
  }
}
