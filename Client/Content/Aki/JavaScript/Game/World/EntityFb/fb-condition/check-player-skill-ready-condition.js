...
class CheckPlayerSkillReadyCondition {
  ...
  static getSizePrefixedRootAsCheckPlayerSkillReadyCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckPlayerSkillReadyCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  skillOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_skill_ready_option_js_1.UnionSkillReadyOption.NONE
  }
  skillOption(i) {
  ...
  static createCheckPlayerSkillReadyCondition(i, t, e, l) {
    return CheckPlayerSkillReadyCondition.startCheckPlayerSkillReadyCondition(i), CheckPlayerSkillReadyCondition.addType(i, t), CheckPlayerSkillReadyCondition.addSkillOptionType(i, e), CheckPlayerSkillReadyCondition.addSkillOption(i, l), CheckPlayerSkillReadyCondition.endCheckPlayerSkillReadyCondition(i)
  }
}
