...
class CompareVarCondition {
  ...
  static getSizePrefixedRootAsCompareVarCondition(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareVarCondition).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type(r) {
  ...
  var1Type() {
    ...
    return r ? this.bb.readUint8(this.bb_pos + r) : union_var_ref_js_1.UnionVarRef.NONE
  }
  var1(r) {
  ...
  static createCompareVarCondition(r, t, i, a, o, e, n) {
    return CompareVarCondition.startCompareVarCondition(r), CompareVarCondition.addType(r, t), CompareVarCondition.addVar1Type(r, i), CompareVarCondition.addVar1(r, a), CompareVarCondition.addCompare(r, o), CompareVarCondition.addVar2Type(r, e), CompareVarCondition.addVar2(r, n), CompareVarCondition.endCompareVarCondition(r)
  }
}
