...
class CheckChildQuestStatus {
  ...
  static getSizePrefixedRootAsCheckChildQuestStatus(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CheckChildQuestStatus).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckChildQuestStatus(t, s, e, i) {
    return CheckChildQuestStatus.startCheckChildQuestStatus(t), CheckChildQuestStatus.addType(t, s), CheckChildQuestStatus.addNodeId(t, e), CheckChildQuestStatus.addStatus(t, i), CheckChildQuestStatus.endCheckChildQuestStatus(t)
  }
}
