...
class HourToHourCondition {
  ...
  static getSizePrefixedRootAsHourToHourCondition(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new HourToHourCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  start(t) {
    ...
    return o ? (t || new hour_js_1.Hour).__init(this.bb.__indirect(this.bb_pos + o), this.bb) : void 0
  }
  end(t) {
