...
class ListenEntitySelfEventCondition {
  ...
  static getSizePrefixedRootAsListenEntitySelfEventCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ListenEntitySelfEventCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createListenEntitySelfEventCondition(t, i, n, e) {
    return ListenEntitySelfEventCondition.startListenEntitySelfEventCondition(t), ListenEntitySelfEventCondition.addType(t, i), ListenEntitySelfEventCondition.addEventKey(t, n), ListenEntitySelfEventCondition.addResetAfterConditionMet(t, e), ListenEntitySelfEventCondition.endListenEntitySelfEventCondition(t)
  }
}
