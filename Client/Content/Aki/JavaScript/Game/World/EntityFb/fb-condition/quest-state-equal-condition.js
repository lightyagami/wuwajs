...
class QuestStateEqualCondition {
  ...
  static getSizePrefixedRootAsQuestStateEqualCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new QuestStateEqualCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createQuestStateEqualCondition(t, e, i, s, a) {
    return QuestStateEqualCondition.startQuestStateEqualCondition(t), QuestStateEqualCondition.addType(t, e), QuestStateEqualCondition.addQuestId(t, i), QuestStateEqualCondition.addState(t, s), QuestStateEqualCondition.addCompare(t, a), QuestStateEqualCondition.endQuestStateEqualCondition(t)
  }
}
