...
class CompareDungeonId {
  ...
  static getSizePrefixedRootAsCompareDungeonId(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareDungeonId).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareDungeonId(e, t, r, n) {
    return CompareDungeonId.startCompareDungeonId(e), CompareDungeonId.addType(e, t), CompareDungeonId.addDungeonId(e, r), CompareDungeonId.addCompare(e, n), CompareDungeonId.endCompareDungeonId(e)
  }
}
