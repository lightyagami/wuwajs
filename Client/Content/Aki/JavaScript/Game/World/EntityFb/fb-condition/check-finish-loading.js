...
class CheckFinishLoading {
  ...
  static getSizePrefixedRootAsCheckFinishLoading(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckFinishLoading).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  checkTargetType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_check_target_type_config_js_1.UnionCheckTargetTypeConfig.NONE
  }
  checkTarget(i) {
  ...
  static createCheckFinishLoading(i, t, e, s) {
    return CheckFinishLoading.startCheckFinishLoading(i), CheckFinishLoading.addType(i, t), CheckFinishLoading.addCheckTargetType(i, e), CheckFinishLoading.addCheckTarget(i, s), CheckFinishLoading.endCheckFinishLoading(i)
  }
}
