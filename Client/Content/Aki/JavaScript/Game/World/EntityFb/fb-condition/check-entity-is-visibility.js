...
class CheckEntityIsVisibility {
  ...
  static getSizePrefixedRootAsCheckEntityIsVisibility(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckEntityIsVisibility).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createCheckEntityIsVisibility(i, t, s, e) {
    return CheckEntityIsVisibility.startCheckEntityIsVisibility(i), CheckEntityIsVisibility.addType(i, t), CheckEntityIsVisibility.addEntityId(i, s), CheckEntityIsVisibility.addIsVisible(i, e), CheckEntityIsVisibility.endCheckEntityIsVisibility(i)
  }
}
