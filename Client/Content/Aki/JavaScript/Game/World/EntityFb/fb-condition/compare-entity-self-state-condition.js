...
class CompareEntitySelfStateCondition {
  ...
  static getSizePrefixedRootAsCompareEntitySelfStateCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CompareEntitySelfStateCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompareEntitySelfStateCondition(t, e, i, o) {
    return CompareEntitySelfStateCondition.startCompareEntitySelfStateCondition(t), CompareEntitySelfStateCondition.addType(t, e), CompareEntitySelfStateCondition.addState(t, i), CompareEntitySelfStateCondition.addCompare(t, o), CompareEntitySelfStateCondition.endCompareEntitySelfStateCondition(t)
  }
}
