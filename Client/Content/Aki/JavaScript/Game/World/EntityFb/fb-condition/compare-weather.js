...
class CompareWeather {
  ...
  static getSizePrefixedRootAsCompareWeather(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareWeather).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareWeather(e, t, r, a, s) {
    return CompareWeather.startCompareWeather(e), CompareWeather.addType(e, t), CompareWeather.addCompare(e, r), CompareWeather.addWeather(e, a), CompareWeather.addWeatherId(e, s), CompareWeather.endCompareWeather(e)
  }
}
