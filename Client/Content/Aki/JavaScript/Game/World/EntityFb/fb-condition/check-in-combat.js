...
class CheckInCombat {
  ...
  static getSizePrefixedRootAsCheckInCombat(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckInCombat).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckInCombat(t, e, n, i, o) {
    return CheckInCombat.startCheckInCombat(t), CheckInCombat.addType(t, e), CheckInCombat.addInCombat(t, n), CheckInCombat.addOnlinePlayerConditionTargetOptionType(t, i), CheckInCombat.addOnlinePlayerConditionTargetOption(t, o), CheckInCombat.endCheckInCombat(t)
  }
}
