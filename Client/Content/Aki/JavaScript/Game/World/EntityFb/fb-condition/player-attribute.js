...
class PlayerAttribute {
  ...
  static getSizePrefixedRootAsPlayerAttribute(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayerAttribute).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  attributeTypes(t, e) {
    ...
    return r ? this.bb.__union(e, this.bb.__vector(this.bb_pos + r) + 4 * t) : void 0
  }
  ...
  static createPlayerAttribute(t, e, r, i, s) {
    return PlayerAttribute.startPlayerAttribute(t), PlayerAttribute.addType(t, e), PlayerAttribute.addOption(t, r), PlayerAttribute.addAttributeTypesType(t, i), PlayerAttribute.addAttributeTypes(t, s), PlayerAttribute.endPlayerAttribute(t)
  }
}
