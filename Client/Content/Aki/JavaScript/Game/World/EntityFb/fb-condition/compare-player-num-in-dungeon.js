...
class ComparePlayerNumInDungeon {
  ...
  static getSizePrefixedRootAsComparePlayerNumInDungeon(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ComparePlayerNumInDungeon).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createComparePlayerNumInDungeon(e, r, a, t, n) {
    return ComparePlayerNumInDungeon.startComparePlayerNumInDungeon(e), ComparePlayerNumInDungeon.addType(e, r), ComparePlayerNumInDungeon.addCompareType(e, a), ComparePlayerNumInDungeon.addCompareValueType(e, t), ComparePlayerNumInDungeon.addCompareValue(e, n), ComparePlayerNumInDungeon.endComparePlayerNumInDungeon(e)
  }
}
