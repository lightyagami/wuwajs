...
class CheckFormationRoleInfoCondition {
  ...
  static getSizePrefixedRootAsCheckFormationRoleInfoCondition(o, t) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckFormationRoleInfoCondition).__init(o.readInt32(o.position()) + o.position(), o)
  }
  type(o) {
  ...
  optionType() {
    ...
    return o ? this.bb.readUint8(this.bb_pos + o) : union_check_formation_role_info_js_1.UnionCheckFormationRoleInfo.NONE
  }
  option(o) {
  ...
  static createCheckFormationRoleInfoCondition(o, t, i, n) {
    return CheckFormationRoleInfoCondition.startCheckFormationRoleInfoCondition(o), CheckFormationRoleInfoCondition.addType(o, t), CheckFormationRoleInfoCondition.addOptionType(o, i), CheckFormationRoleInfoCondition.addOption(o, n), CheckFormationRoleInfoCondition.endCheckFormationRoleInfoCondition(o)
  }
}
