...
class CustomJsonCondition {
  ...
  static getSizePrefixedRootAsCustomJsonCondition(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new CustomJsonCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCustomJsonCondition(t, o, s, i) {
    return CustomJsonCondition.startCustomJsonCondition(t), CustomJsonCondition.addType(t, o), CustomJsonCondition.addName(t, s), CustomJsonCondition.addJsonString(t, i), CustomJsonCondition.endCustomJsonCondition(t)
  }
}
