...
class CheckSubLevelState {
  ...
  static getSizePrefixedRootAsCheckSubLevelState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckSubLevelState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  checkList(t, e) {
    ...
    return s ? (e || new check_sub_level_state_config_js_1.CheckSubLevelStateConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  checkListLength() {
  ...
  static createCheckSubLevelState(t, e, s, i) {
    return CheckSubLevelState.startCheckSubLevelState(t), CheckSubLevelState.addType(t, e), CheckSubLevelState.addConditionCount(t, s), CheckSubLevelState.addCheckList(t, i), CheckSubLevelState.endCheckSubLevelState(t)
  }
}
