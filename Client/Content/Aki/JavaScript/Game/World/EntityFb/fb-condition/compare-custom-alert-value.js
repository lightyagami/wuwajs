...
class CompareCustomAlertValue {
  ...
  static getSizePrefixedRootAsCompareCustomAlertValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CompareCustomAlertValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCompareCustomAlertValue(t, e, r) {
    return CompareCustomAlertValue.startCompareCustomAlertValue(t), CompareCustomAlertValue.addType(t, e), CompareCustomAlertValue.addCompareValue(t, r), CompareCustomAlertValue.endCompareCustomAlertValue(t)
  }
}
