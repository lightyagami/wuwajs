...
class CheckNodeStatus {
  ...
  static getSizePrefixedRootAsCheckNodeStatus(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckNodeStatus).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckNodeStatus(t, e, s, a) {
    return CheckNodeStatus.startCheckNodeStatus(t), CheckNodeStatus.addType(t, e), CheckNodeStatus.addNodeId(t, s), CheckNodeStatus.addStatus(t, a), CheckNodeStatus.endCheckNodeStatus(t)
  }
}
