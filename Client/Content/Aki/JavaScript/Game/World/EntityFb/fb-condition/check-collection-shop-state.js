...
class CheckCollectionShopState {
  ...
  static getSizePrefixedRootAsCheckCollectionShopState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckCollectionShopState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckCollectionShopState(t, e, o) {
    return CheckCollectionShopState.startCheckCollectionShopState(t), CheckCollectionShopState.addType(t, e), CheckCollectionShopState.addShopType(t, o), CheckCollectionShopState.endCheckCollectionShopState(t)
  }
}
