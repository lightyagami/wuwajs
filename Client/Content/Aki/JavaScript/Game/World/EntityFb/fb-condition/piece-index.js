...
class PieceIndex {
  ...
  static getSizePrefixedRootAsPieceIndex(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PieceIndex).__init(e.readInt32(e.position()) + e.position(), e)
  }
  rowIndex() {
  ...
  static createPieceIndex(e, t, i) {
    return PieceIndex.startPieceIndex(e), PieceIndex.addRowIndex(e, t), PieceIndex.addColumnIndex(e, i), PieceIndex.endPieceIndex(e)
  }
}
