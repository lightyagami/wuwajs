...
class CheckEntityLockedCondition {
  ...
  static getSizePrefixedRootAsCheckEntityLockedCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckEntityLockedCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckEntityLockedCondition(t, i, e, n) {
    return CheckEntityLockedCondition.startCheckEntityLockedCondition(t), CheckEntityLockedCondition.addType(t, i), CheckEntityLockedCondition.addEntities(t, e), CheckEntityLockedCondition.addIsLocked(t, n), CheckEntityLockedCondition.endCheckEntityLockedCondition(t)
  }
}
