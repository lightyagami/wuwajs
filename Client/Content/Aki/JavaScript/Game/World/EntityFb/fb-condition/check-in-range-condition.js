...
class CheckInRangeCondition {
  ...
  static getRootAsCheckInRangeCondition(t, n) {
    return (n || new CheckInRangeCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCheckInRangeCondition(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new CheckInRangeCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static addOnlinePlayerConditionTargetOptionType(t, n) {
    t.addFieldInt8(3, n, union_online_player_condition_target_js_1.UnionOnlinePlayerConditionTarget.NONE)
  }
