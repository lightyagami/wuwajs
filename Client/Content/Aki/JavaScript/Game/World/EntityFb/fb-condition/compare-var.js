...
class CompareVar {
  ...
  static getSizePrefixedRootAsCompareVar(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareVar).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type(r) {
  ...
  static createCompareVar(r, t, a, e, s, i, o) {
    return CompareVar.startCompareVar(r), CompareVar.addType(r, t), CompareVar.addCompare(r, a), CompareVar.addVar1Type(r, e), CompareVar.addVar1(r, s), CompareVar.addVar2Type(r, i), CompareVar.addVar2(r, o), CompareVar.endCompareVar(r)
  }
}
