...
class CheckSubLevelStateConfig {
  ...
  static getSizePrefixedRootAsCheckSubLevelStateConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckSubLevelStateConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  subLevelName(e) {
  ...
  static createCheckSubLevelStateConfig(e, t, i) {
    return CheckSubLevelStateConfig.startCheckSubLevelStateConfig(e), CheckSubLevelStateConfig.addSubLevelName(e, t), CheckSubLevelStateConfig.addSubLevelState(e, i), CheckSubLevelStateConfig.endCheckSubLevelStateConfig(e)
  }
}
