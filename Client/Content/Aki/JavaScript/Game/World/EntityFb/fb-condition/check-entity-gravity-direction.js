...
exports.CheckEntityGravityDirection = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const union_gravity_direction_js_1 = require("../fb-common/union-gravity-direction.js");
const union_check_target_js_1 = require("../fb-condition/union-check-target.js");
class CheckEntityGravityDirection {
  ...
  targetType() {
    ...
    if (t) {
      ...
      return union_check_target_js_1.UnionCheckTarget.NONE;
    }
  }
  target(t) {
  ...
  static createCheckEntityGravityDirection(t, i, r, e, n, c) {
    ...
    return CheckEntityGravityDirection.endCheckEntityGravityDirection(t);
  }
}
