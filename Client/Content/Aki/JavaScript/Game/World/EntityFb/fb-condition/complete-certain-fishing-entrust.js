...
class CompleteCertainFishingEntrust {
  ...
  static getSizePrefixedRootAsCompleteCertainFishingEntrust(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompleteCertainFishingEntrust).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompleteCertainFishingEntrust(t, i, e, s) {
    return CompleteCertainFishingEntrust.startCompleteCertainFishingEntrust(t), CompleteCertainFishingEntrust.addType(t, i), CompleteCertainFishingEntrust.addId(t, e), CompleteCertainFishingEntrust.addCount(t, s), CompleteCertainFishingEntrust.endCompleteCertainFishingEntrust(t)
  }
}
