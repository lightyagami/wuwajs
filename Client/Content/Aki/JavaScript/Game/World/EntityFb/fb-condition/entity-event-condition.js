...
class EntityEventCondition {
  ...
  static getSizePrefixedRootAsEntityEventCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityEventCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createEntityEventCondition(t, i, n, e, s) {
    return EntityEventCondition.startEntityEventCondition(t), EntityEventCondition.addEntityId(t, i), EntityEventCondition.addState(t, n), EntityEventCondition.addIsDead(t, e), EntityEventCondition.addIsLocked(t, s), EntityEventCondition.endEntityEventCondition(t)
  }
}
