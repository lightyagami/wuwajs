...
class CheckIsPlayerUsingVehicle {
  ...
  static getSizePrefixedRootAsCheckIsPlayerUsingVehicle(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckIsPlayerUsingVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  onlinePlayerConditionTargetOptionType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_online_player_condition_target_js_1.UnionOnlinePlayerConditionTarget.NONE
  }
  ...
  static createCheckIsPlayerUsingVehicle(e, i, t, s, n, r) {
    return CheckIsPlayerUsingVehicle.startCheckIsPlayerUsingVehicle(e), CheckIsPlayerUsingVehicle.addType(e, i), CheckIsPlayerUsingVehicle.addVehicleType(e, t), CheckIsPlayerUsingVehicle.addCheckType(e, s), CheckIsPlayerUsingVehicle.addOnlinePlayerConditionTargetOptionType(e, n), CheckIsPlayerUsingVehicle.addOnlinePlayerConditionTargetOption(e, r), CheckIsPlayerUsingVehicle.endCheckIsPlayerUsingVehicle(e)
  }
}
