...
class CheckMoonBuildingState {
  ...
  static getSizePrefixedRootAsCheckMoonBuildingState(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckMoonBuildingState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckMoonBuildingState(t, i, e, n) {
    return CheckMoonBuildingState.startCheckMoonBuildingState(t), CheckMoonBuildingState.addType(t, i), CheckMoonBuildingState.addBuildingId(t, e), CheckMoonBuildingState.addIsBuilt(t, n), CheckMoonBuildingState.endCheckMoonBuildingState(t)
  }
}
