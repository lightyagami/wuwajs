...
class CheckFishingCageFillingRatio {
  ...
  static getSizePrefixedRootAsCheckFishingCageFillingRatio(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CheckFishingCageFillingRatio).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createCheckFishingCageFillingRatio(i, t, e, s) {
    return CheckFishingCageFillingRatio.startCheckFishingCageFillingRatio(i), CheckFishingCageFillingRatio.addType(i, t), CheckFishingCageFillingRatio.addCompare(i, e), CheckFishingCageFillingRatio.addRatio(i, s), CheckFishingCageFillingRatio.endCheckFishingCageFillingRatio(i)
  }
}
