...
class PreQuest {
  ...
  static getSizePrefixedRootAsPreQuest(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PreQuest).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPreQuest(t, e, s, r) {
    return PreQuest.startPreQuest(t), PreQuest.addType(t, e), PreQuest.addCompare(t, s), PreQuest.addPreQuestId(t, r), PreQuest.endPreQuest(t)
  }
}
