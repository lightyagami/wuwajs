...
class CheckEntityHasSceneItemAttributeTag {
  ...
  static getSizePrefixedRootAsCheckEntityHasSceneItemAttributeTag(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckEntityHasSceneItemAttributeTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
