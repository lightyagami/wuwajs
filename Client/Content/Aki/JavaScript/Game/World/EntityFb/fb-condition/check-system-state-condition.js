...
class CheckSystemStateCondition {
  ...
  static getSizePrefixedRootAsCheckSystemStateCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckSystemStateCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_check_system_state_js_1.UnionCheckSystemState.NONE
  }
  config(t) {
  ...
  static createCheckSystemStateCondition(t, e, i, s) {
    return CheckSystemStateCondition.startCheckSystemStateCondition(t), CheckSystemStateCondition.addType(t, e), CheckSystemStateCondition.addConfigType(t, i), CheckSystemStateCondition.addConfig(t, s), CheckSystemStateCondition.endCheckSystemStateCondition(t)
  }
}
