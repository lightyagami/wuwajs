...
class AllPlayerType {
  ...
  static getSizePrefixedRootAsAllPlayerType(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AllPlayerType).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createAllPlayerType(e, t) {
    return AllPlayerType.startAllPlayerType(e), AllPlayerType.addType(e, t), AllPlayerType.endAllPlayerType(e)
  }
}
