...
class CompareTimePeriod {
  ...
  static getSizePrefixedRootAsCompareTimePeriod(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompareTimePeriod).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareTimePeriod(e, i, r, t) {
    return CompareTimePeriod.startCompareTimePeriod(e), CompareTimePeriod.addType(e, i), CompareTimePeriod.addCompare(e, r), CompareTimePeriod.addTimePeriod(e, t), CompareTimePeriod.endCompareTimePeriod(e)
  }
}
