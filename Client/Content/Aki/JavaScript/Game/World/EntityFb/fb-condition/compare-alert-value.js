...
class CompareAlertValue {
  ...
  static getSizePrefixedRootAsCompareAlertValue(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareAlertValue).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  compareValueType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_compared_alert_value_js_1.UnionComparedAlertValue.NONE
  }
  compareValue(e) {
  ...
  static createCompareAlertValue(e, t, r, a, s, i) {
    return CompareAlertValue.startCompareAlertValue(e), CompareAlertValue.addType(e, t), CompareAlertValue.addAreaId(e, r), CompareAlertValue.addCompareType(e, a), CompareAlertValue.addCompareValueType(e, s), CompareAlertValue.addCompareValue(e, i), CompareAlertValue.endCompareAlertValue(e)
  }
}
