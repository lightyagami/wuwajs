...
class GramophoneCheckCondition {
  ...
  static getSizePrefixedRootAsGramophoneCheckCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GramophoneCheckCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  checkType() {
  ...
  static createGramophoneCheckCondition(t, i, e) {
    return GramophoneCheckCondition.startGramophoneCheckCondition(t), GramophoneCheckCondition.addCheckType(t, i), GramophoneCheckCondition.addPlayList(t, e), GramophoneCheckCondition.endGramophoneCheckCondition(t)
  }
}
