...
class CompareCalabashLevelCondition {
  ...
  static getSizePrefixedRootAsCompareCalabashLevelCondition(a, e) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CompareCalabashLevelCondition).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createCompareCalabashLevelCondition(a, e, t, i) {
    return CompareCalabashLevelCondition.startCompareCalabashLevelCondition(a), CompareCalabashLevelCondition.addType(a, e), CompareCalabashLevelCondition.addCompare(a, t), CompareCalabashLevelCondition.addCalabashLevel(a, i), CompareCalabashLevelCondition.endCompareCalabashLevelCondition(a)
  }
}
