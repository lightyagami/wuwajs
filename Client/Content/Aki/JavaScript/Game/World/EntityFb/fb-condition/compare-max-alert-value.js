...
class CompareMaxAlertValue {
  ...
  static getSizePrefixedRootAsCompareMaxAlertValue(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareMaxAlertValue).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createCompareMaxAlertValue(e, t) {
    return CompareMaxAlertValue.startCompareMaxAlertValue(e), CompareMaxAlertValue.addType(e, t), CompareMaxAlertValue.endCompareMaxAlertValue(e)
  }
}
