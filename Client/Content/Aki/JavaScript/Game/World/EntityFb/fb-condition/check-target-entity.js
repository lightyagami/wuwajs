...
class CheckTargetEntity {
  ...
  static getSizePrefixedRootAsCheckTargetEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckTargetEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckTargetEntity(t, e, i, r) {
    return CheckTargetEntity.startCheckTargetEntity(t), CheckTargetEntity.addType(t, e), CheckTargetEntity.addTargetEntityType(t, i), CheckTargetEntity.addTargetEntity(t, r), CheckTargetEntity.endCheckTargetEntity(t)
  }
}
