...
class CheckPlayerGender {
  ...
  static getSizePrefixedRootAsCheckPlayerGender(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new CheckPlayerGender).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckPlayerGender(e, r, t) {
    return CheckPlayerGender.startCheckPlayerGender(e), CheckPlayerGender.addType(e, r), CheckPlayerGender.addGender(e, t), CheckPlayerGender.endCheckPlayerGender(e)
  }
}
