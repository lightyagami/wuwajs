...
class WeaponLevel {
  ...
  static getSizePrefixedRootAsWeaponLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new WeaponLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  optionType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_weapon_level_js_1.UnionWeaponLevel.NONE
  }
  option(e) {
  ...
  static createWeaponLevel(e, t, i, n) {
    return WeaponLevel.startWeaponLevel(e), WeaponLevel.addType(e, t), WeaponLevel.addOptionType(e, i), WeaponLevel.addOption(e, n), WeaponLevel.endWeaponLevel(e)
  }
}
