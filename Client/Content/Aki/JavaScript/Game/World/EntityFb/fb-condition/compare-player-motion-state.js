...
class ComparePlayerMotionState {
  ...
  static getSizePrefixedRootAsComparePlayerMotionState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ComparePlayerMotionState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createComparePlayerMotionState(t, e, o, i, a, r) {
    return ComparePlayerMotionState.startComparePlayerMotionState(t), ComparePlayerMotionState.addType(t, e), ComparePlayerMotionState.addMotionState(t, o), ComparePlayerMotionState.addCompare(t, i), ComparePlayerMotionState.addOnlinePlayerConditionTargetOptionType(t, a), ComparePlayerMotionState.addOnlinePlayerConditionTargetOption(t, r), ComparePlayerMotionState.endComparePlayerMotionState(t)
  }
}
