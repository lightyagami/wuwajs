...
class CheckTeleControlState {
  ...
  static getSizePrefixedRootAsCheckTeleControlState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckTeleControlState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckTeleControlState(t, e, r, s, o) {
    return CheckTeleControlState.startCheckTeleControlState(t), CheckTeleControlState.addType(t, e), CheckTeleControlState.addEntityId(t, r), CheckTeleControlState.addCompareType(t, s), CheckTeleControlState.addState(t, o), CheckTeleControlState.endCheckTeleControlState(t)
  }
}
