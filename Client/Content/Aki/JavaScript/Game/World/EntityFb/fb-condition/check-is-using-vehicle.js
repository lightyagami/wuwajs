...
class CheckIsUsingVehicle {
  ...
  static getRootAsCheckIsUsingVehicle(e, s) {
    return (s || new CheckIsUsingVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsCheckIsUsingVehicle(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CheckIsUsingVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCheckIsUsingVehicle(e, s, i, t, h) {
    return CheckIsUsingVehicle.startCheckIsUsingVehicle(e), CheckIsUsingVehicle.addType(e, s), CheckIsUsingVehicle.addTargetVehicle(e, i), CheckIsUsingVehicle.addSeat(e, t), CheckIsUsingVehicle.addCheckIsBeingUsed(e, h), CheckIsUsingVehicle.endCheckIsUsingVehicle(e)
  }
}
