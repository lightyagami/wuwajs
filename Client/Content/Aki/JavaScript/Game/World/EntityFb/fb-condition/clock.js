...
class Clock {
  ...
  static getSizePrefixedRootAsClock(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new Clock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createClock(t, s, i, r, e) {
    return Clock.startClock(t), Clock.addType(t, s), Clock.addCompare(t, i), Clock.addStart(t, r), Clock.addEnd(t, e), Clock.endClock(t)
  }
}
exports.Clock = Clock;
