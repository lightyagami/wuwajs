...
class CheckCurrentRole {
  ...
  static getSizePrefixedRootAsCheckCurrentRole(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckCurrentRole).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckCurrentRole(t, e, r, i, n, o) {
    return CheckCurrentRole.startCheckCurrentRole(t), CheckCurrentRole.addType(t, e), CheckCurrentRole.addRoleId(t, r), CheckCurrentRole.addCompare(t, i), CheckCurrentRole.addOnlinePlayerConditionTargetOptionType(t, n), CheckCurrentRole.addOnlinePlayerConditionTargetOption(t, o), CheckCurrentRole.endCheckCurrentRole(t)
  }
}
