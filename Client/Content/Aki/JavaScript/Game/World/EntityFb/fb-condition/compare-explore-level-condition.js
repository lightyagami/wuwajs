...
class CompareExploreLevelCondition {
  ...
  static getSizePrefixedRootAsCompareExploreLevelCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CompareExploreLevelCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCompareExploreLevelCondition(e, t, o, i) {
    return CompareExploreLevelCondition.startCompareExploreLevelCondition(e), CompareExploreLevelCondition.addType(e, t), CompareExploreLevelCondition.addCompare(e, o), CompareExploreLevelCondition.addLevel(e, i), CompareExploreLevelCondition.endCompareExploreLevelCondition(e)
  }
}
