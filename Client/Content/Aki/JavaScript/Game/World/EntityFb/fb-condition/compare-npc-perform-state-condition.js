...
class CompareNpcPerformStateCondition {
  ...
  static getSizePrefixedRootAsCompareNpcPerformStateCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CompareNpcPerformStateCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompareNpcPerformStateCondition(t, e, r, o, i) {
    return CompareNpcPerformStateCondition.startCompareNpcPerformStateCondition(t), CompareNpcPerformStateCondition.addType(t, e), CompareNpcPerformStateCondition.addEntityId(t, r), CompareNpcPerformStateCondition.addCompare(t, o), CompareNpcPerformStateCondition.addState(t, i), CompareNpcPerformStateCondition.endCompareNpcPerformStateCondition(t)
  }
}
