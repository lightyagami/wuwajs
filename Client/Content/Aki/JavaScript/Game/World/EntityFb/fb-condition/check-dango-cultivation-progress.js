...
class CheckDangoCultivationProgress {
  ...
  static getSizePrefixedRootAsCheckDangoCultivationProgress(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckDangoCultivationProgress).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  checkTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_check_dango_cultivation_progress_config_js_1.UnionCheckDangoCultivationProgressConfig.NONE
  }
  checkType(t) {
  ...
  static createCheckDangoCultivationProgress(t, i, e, s) {
    return CheckDangoCultivationProgress.startCheckDangoCultivationProgress(t), CheckDangoCultivationProgress.addType(t, i), CheckDangoCultivationProgress.addCheckTypeType(t, e), CheckDangoCultivationProgress.addCheckType(t, s), CheckDangoCultivationProgress.endCheckDangoCultivationProgress(t)
  }
}
