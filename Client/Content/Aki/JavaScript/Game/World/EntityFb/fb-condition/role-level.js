...
class RoleLevel {
  ...
  static getSizePrefixedRootAsRoleLevel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RoleLevel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  optionType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_role_level_js_1.UnionRoleLevel.NONE
  }
  option(e) {
  ...
  static createRoleLevel(e, t, i, l) {
    return RoleLevel.startRoleLevel(e), RoleLevel.addType(e, t), RoleLevel.addOptionType(e, i), RoleLevel.addOption(e, l), RoleLevel.endRoleLevel(e)
  }
}
