...
class CheckTargetAttributeCondition {
  ...
  static getSizePrefixedRootAsCheckTargetAttributeCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CheckTargetAttributeCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  optionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_target_attribute_js_1.UnionTargetAttribute.NONE
  }
  option(t) {
  ...
  onlinePlayerConditionTargetOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_online_player_condition_target_js_1.UnionOnlinePlayerConditionTarget.NONE
  }
  ...
  static createCheckTargetAttributeCondition(t, i, e, n, r, o) {
    return CheckTargetAttributeCondition.startCheckTargetAttributeCondition(t), CheckTargetAttributeCondition.addType(t, i), CheckTargetAttributeCondition.addOptionType(t, e), CheckTargetAttributeCondition.addOption(t, n), CheckTargetAttributeCondition.addOnlinePlayerConditionTargetOptionType(t, r), CheckTargetAttributeCondition.addOnlinePlayerConditionTargetOption(t, o), CheckTargetAttributeCondition.endCheckTargetAttributeCondition(t)
  }
}
