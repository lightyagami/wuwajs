...
class CheckClientEvent {
  ...
  static getSizePrefixedRootAsCheckClientEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckClientEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCheckClientEvent(t, e, i) {
    return CheckClientEvent.startCheckClientEvent(t), CheckClientEvent.addType(t, e), CheckClientEvent.addEventName(t, i), CheckClientEvent.endCheckClientEvent(t)
  }
}
