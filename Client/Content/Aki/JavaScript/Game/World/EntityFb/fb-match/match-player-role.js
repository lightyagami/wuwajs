...
class MatchPlayerRole {
  ...
  static getSizePrefixedRootAsMatchPlayerRole(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MatchPlayerRole).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createMatchPlayerRole(t, e, a) {
    return MatchPlayerRole.startMatchPlayerRole(t), MatchPlayerRole.addType(t, e), MatchPlayerRole.addMatchPhantomSkill(t, a), MatchPlayerRole.endMatchPlayerRole(t)
  }
}
