...
class MatchPhantomRole {
  ...
  static getSizePrefixedRootAsMatchPhantomRole(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MatchPhantomRole).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createMatchPhantomRole(t, e, a) {
    return MatchPhantomRole.startMatchPhantomRole(t), MatchPhantomRole.addType(t, e), MatchPhantomRole.addId(t, a), MatchPhantomRole.endMatchPhantomRole(t)
  }
}
