...
class VectorInfo {
  ...
  static getSizePrefixedRootAsVectorInfo(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new VectorInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  x() {
  ...
  static createVectorInfo(t, r, e, s) {
    return VectorInfo.startVectorInfo(t), VectorInfo.addX(t, r), VectorInfo.addY(t, e), VectorInfo.addZ(t, s), VectorInfo.endVectorInfo(t)
  }
}
