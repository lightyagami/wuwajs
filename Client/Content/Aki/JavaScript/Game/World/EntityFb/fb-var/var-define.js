...
class VarDefine {
  ...
  static getSizePrefixedRootAsVarDefine(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VarDefine).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  valueType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_var_config_js_1.UnionVarConfig.NONE
  }
  value(t) {
  ...
  static createVarDefine(t, e, i, s, r, a, n, f) {
    return VarDefine.startVarDefine(t), VarDefine.addName(t, e), VarDefine.addType(t, i), VarDefine.addValueType(t, s), VarDefine.addValue(t, r), VarDefine.addAccess(t, a), VarDefine.addIsIgnoreOnRollBack(t, n), VarDefine.addIsClient(t, f), VarDefine.endVarDefine(t)
  }
}
