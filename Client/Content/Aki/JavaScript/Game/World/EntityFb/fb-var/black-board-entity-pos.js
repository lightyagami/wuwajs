...
class BlackBoardEntityPos {
  ...
  static getRootAsBlackBoardEntityPos(t, s) {
    return (s || new BlackBoardEntityPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsBlackBoardEntityPos(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new BlackBoardEntityPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBlackBoardEntityPos(t, s, i, a) {
    return BlackBoardEntityPos.startBlackBoardEntityPos(t), BlackBoardEntityPos.addType(t, s), BlackBoardEntityPos.addKey(t, i), BlackBoardEntityPos.addEntityId(t, a), BlackBoardEntityPos.endBlackBoardEntityPos(t)
  }
}
