...
class GlobalVarRef {
  ...
  static getSizePrefixedRootAsGlobalVarRef(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GlobalVarRef).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGlobalVarRef(t, e, r, a) {
    return GlobalVarRef.startGlobalVarRef(t), GlobalVarRef.addType(t, e), GlobalVarRef.addSource(t, r), GlobalVarRef.addKeyword(t, a), GlobalVarRef.endGlobalVarRef(t)
  }
}
