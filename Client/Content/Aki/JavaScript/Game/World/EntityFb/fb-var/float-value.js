...
class FloatValue {
  ...
  static getSizePrefixedRootAsFloatValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FloatValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  v() {
  ...
  static createFloatValue(t, e) {
    return FloatValue.startFloatValue(t), FloatValue.addV(t, e), FloatValue.endFloatValue(t)
  }
}
