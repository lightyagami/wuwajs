...
class BlackBoardInt {
  ...
  static getRootAsBlackBoardInt(t, a) {
    return (a || new BlackBoardInt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsBlackBoardInt(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BlackBoardInt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBlackBoardInt(t, a, r, s) {
    return BlackBoardInt.startBlackBoardInt(t), BlackBoardInt.addType(t, a), BlackBoardInt.addKey(t, r), BlackBoardInt.addValue(t, s), BlackBoardInt.endBlackBoardInt(t)
  }
}
