...
class ConstVarRef {
  ...
  static getSizePrefixedRootAsConstVarRef(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ConstVarRef).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createConstVarRef(t, s, e, r, i) {
    return ConstVarRef.startConstVarRef(t), ConstVarRef.addType(t, s), ConstVarRef.addSource(t, e), ConstVarRef.addValueType(t, r), ConstVarRef.addValue(t, i), ConstVarRef.endConstVarRef(t)
  }
}
