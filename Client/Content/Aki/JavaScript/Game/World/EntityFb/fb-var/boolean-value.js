...
class BooleanValue {
  ...
  static getSizePrefixedRootAsBooleanValue(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new BooleanValue).__init(e.readInt32(e.position()) + e.position(), e)
  }
  v() {
  ...
  static createBooleanValue(e, t) {
    return BooleanValue.startBooleanValue(e), BooleanValue.addV(e, t), BooleanValue.endBooleanValue(e)
  }
}
