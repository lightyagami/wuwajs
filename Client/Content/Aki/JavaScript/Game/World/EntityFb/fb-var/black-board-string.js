...
class BlackBoardString {
  ...
  static getSizePrefixedRootAsBlackBoardString(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new BlackBoardString).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBlackBoardString(t, r, a, i) {
    return BlackBoardString.startBlackBoardString(t), BlackBoardString.addType(t, r), BlackBoardString.addKey(t, a), BlackBoardString.addValue(t, i), BlackBoardString.endBlackBoardString(t)
  }
}
