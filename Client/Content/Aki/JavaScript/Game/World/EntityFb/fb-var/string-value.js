...
class StringValue {
  ...
  static getSizePrefixedRootAsStringValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StringValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  v(t) {
  ...
  static createStringValue(t, e) {
    return StringValue.startStringValue(t), StringValue.addV(t, e), StringValue.endStringValue(t)
  }
}
