...
exports.unionListToUnionVarConfig = exports.unionToUnionVarConfig = exports.UnionVarConfig = undefined;
const boolean_value_js_1 = require("../fb-var/boolean-value.js");
const entity_value_js_1 = require("../fb-var/entity-value.js");
const float_value_js_1 = require("../fb-var/float-value.js");
const int_value_js_1 = require("../fb-var/int-value.js");
const prefab_value_js_1 = require("../fb-var/prefab-value.js");
const quest_state_value_js_1 = require("../fb-var/quest-state-value.js");
const quest_value_js_1 = require("../fb-var/quest-value.js");
const string_value_js_1 = require("../fb-var/string-value.js");
const transform_value_js_1 = require("../fb-var/transform-value.js");
var UnionVarConfig;
...
})(UnionVarConfig = exports.UnionVarConfig ||= {});
exports.unionToUnionVarConfig = unionToUnionVarConfig;
exports.unionListToUnionVarConfig = unionListToUnionVarConfig; //# sourceMappingURL=union-var-config.js.map