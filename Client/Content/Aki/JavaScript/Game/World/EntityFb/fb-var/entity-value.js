...
class EntityValue {
  ...
  static getSizePrefixedRootAsEntityValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  v() {
  ...
  static createEntityValue(t, e) {
    return EntityValue.startEntityValue(t), EntityValue.addV(t, e), EntityValue.endEntityValue(t)
  }
}
