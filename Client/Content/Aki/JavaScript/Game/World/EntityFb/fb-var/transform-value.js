...
class TransformValue {
  ...
  static getSizePrefixedRootAsTransformValue(r, s) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new TransformValue).__init(r.readInt32(r.position()) + r.position(), r)
  }
  v(r) {
    var s = this.bb.__offset(this.bb_pos, 4);
    return s ? (r || new pos_and_rot_js_1.PosAndRot).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  ...
  static createTransformValue(r, s) {
    return TransformValue.startTransformValue(r), TransformValue.addV(r, s), TransformValue.endTransformValue(r)
  }
}
