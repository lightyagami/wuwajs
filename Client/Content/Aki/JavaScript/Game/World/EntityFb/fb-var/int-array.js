...
class IntArray {
  ...
  static getSizePrefixedRootAsIntArray(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new IntArray).__init(t.readInt32(t.position()) + t.position(), t)
  }
  values(t) {
  ...
  static createIntArray(t, r) {
    return IntArray.startIntArray(t), IntArray.addValues(t, r), IntArray.endIntArray(t)
  }
}
