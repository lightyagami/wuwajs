...
class BlackBoardEntityId {
  ...
  static getSizePrefixedRootAsBlackBoardEntityId(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new BlackBoardEntityId).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBlackBoardEntityId(t, i, a, r) {
    return BlackBoardEntityId.startBlackBoardEntityId(t), BlackBoardEntityId.addType(t, i), BlackBoardEntityId.addKey(t, a), BlackBoardEntityId.addEntityId(t, r), BlackBoardEntityId.endBlackBoardEntityId(t)
  }
}
