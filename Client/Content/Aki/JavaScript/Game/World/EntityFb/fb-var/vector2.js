...
class Vector2 {
  ...
  static getSizePrefixedRootAsVector2(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new Vector2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  x() {
  ...
  static createVector2(t, e, r) {
    return Vector2.startVector2(t), Vector2.addX(t, e), Vector2.addY(t, r), Vector2.endVector2(t)
  }
}
