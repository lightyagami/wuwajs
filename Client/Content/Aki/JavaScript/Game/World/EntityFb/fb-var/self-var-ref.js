...
class SelfVarRef {
  ...
  static getSizePrefixedRootAsSelfVarRef(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SelfVarRef).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSelfVarRef(e, t, r, s) {
    return SelfVarRef.startSelfVarRef(e), SelfVarRef.addType(e, t), SelfVarRef.addSource(e, r), SelfVarRef.addName(e, s), SelfVarRef.endSelfVarRef(e)
  }
}
