...
class QuestValue {
  ...
  static getSizePrefixedRootAsQuestValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new QuestValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  v() {
  ...
  static createQuestValue(t, e) {
    return QuestValue.startQuestValue(t), QuestValue.addV(t, e), QuestValue.endQuestValue(t)
  }
}
