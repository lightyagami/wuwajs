...
class RushWarningEffectParams {
  ...
  static getSizePrefixedRootAsRushWarningEffectParams(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new RushWarningEffectParams).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRushWarningEffectParams(t, s, a, r, i) {
    return RushWarningEffectParams.startRushWarningEffectParams(t), RushWarningEffectParams.addType(t, s), RushWarningEffectParams.addLength(t, a), RushWarningEffectParams.addWidth(t, r), RushWarningEffectParams.addTime(t, i), RushWarningEffectParams.endRushWarningEffectParams(t)
  }
}
