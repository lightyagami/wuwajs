...
class BlackBoardBoolean {
  ...
  static getSizePrefixedRootAsBlackBoardBoolean(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new BlackBoardBoolean).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createBlackBoardBoolean(a, t, o, e) {
    return BlackBoardBoolean.startBlackBoardBoolean(a), BlackBoardBoolean.addType(a, t), BlackBoardBoolean.addKey(a, o), BlackBoardBoolean.addValue(a, e), BlackBoardBoolean.endBlackBoardBoolean(a)
  }
}
