...
class OtherVarRef {
  ...
  static getSizePrefixedRootAsOtherVarRef(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OtherVarRef).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOtherVarRef(t, e, r, s, i, a) {
    return OtherVarRef.startOtherVarRef(t), OtherVarRef.addType(t, e), OtherVarRef.addSource(t, r), OtherVarRef.addRefType(t, s), OtherVarRef.addRefId(t, i), OtherVarRef.addName(t, a), OtherVarRef.endOtherVarRef(t)
  }
}
