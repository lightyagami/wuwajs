...
class BlackBoardFloat {
  ...
  static getSizePrefixedRootAsBlackBoardFloat(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BlackBoardFloat).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBlackBoardFloat(t, a, r, o) {
    return BlackBoardFloat.startBlackBoardFloat(t), BlackBoardFloat.addType(t, a), BlackBoardFloat.addKey(t, r), BlackBoardFloat.addValue(t, o), BlackBoardFloat.endBlackBoardFloat(t)
  }
}
