...
class ActorRef {
  ...
  static getSizePrefixedRootAsActorRef(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorRef).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorName(t) {
  ...
  static createActorRef(t, r, e, s) {
    return ActorRef.startActorRef(t), ActorRef.addActorName(t, r), ActorRef.addPathName(t, e), ActorRef.addPlatform(t, s), ActorRef.endActorRef(t)
  }
}
