...
class Manipulate {
  ...
  static getSizePrefixedRootAsManipulate(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new Manipulate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createManipulate(t, e, a) {
    return Manipulate.startManipulate(t), Manipulate.addType(t, e), Manipulate.addTargetEntityId(t, a), Manipulate.endManipulate(t)
  }
}
