...
class TeleportToAndEnterVehicle {
  ...
  static getSizePrefixedRootAsTeleportToAndEnterVehicle(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TeleportToAndEnterVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  toVehicleType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_teleport_to_and_enter_vehicle_type_js_1.UnionTeleportToAndEnterVehicleType.NONE
  }
  toVehicle(e) {
  ...
  static createTeleportToAndEnterVehicle(e, t, r) {
    return TeleportToAndEnterVehicle.startTeleportToAndEnterVehicle(e), TeleportToAndEnterVehicle.addToVehicleType(e, t), TeleportToAndEnterVehicle.addToVehicle(e, r), TeleportToAndEnterVehicle.endTeleportToAndEnterVehicle(e)
  }
}
