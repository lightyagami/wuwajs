...
class ClaimLevelPlayReward {
  ...
  static getSizePrefixedRootAsClaimLevelPlayReward(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ClaimLevelPlayReward).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createClaimLevelPlayReward(e) {
    return ClaimLevelPlayReward.startClaimLevelPlayReward(e), ClaimLevelPlayReward.endClaimLevelPlayReward(e)
  }
}
