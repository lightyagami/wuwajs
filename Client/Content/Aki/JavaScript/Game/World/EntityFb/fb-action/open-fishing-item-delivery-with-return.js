...
class OpenFishingItemDeliveryWithReturn {
  ...
  static getSizePrefixedRootAsOpenFishingItemDeliveryWithReturn(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OpenFishingItemDeliveryWithReturn).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  returnVarType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_var_ref_js_1.UnionVarRef.NONE
  }
  returnVar(e) {
  ...
  static createOpenFishingItemDeliveryWithReturn(e, t, i, r, n) {
    return OpenFishingItemDeliveryWithReturn.startOpenFishingItemDeliveryWithReturn(e), OpenFishingItemDeliveryWithReturn.addType(e, t), OpenFishingItemDeliveryWithReturn.addPresetId(e, i), OpenFishingItemDeliveryWithReturn.addReturnVarType(e, r), OpenFishingItemDeliveryWithReturn.addReturnVar(e, n), OpenFishingItemDeliveryWithReturn.endOpenFishingItemDeliveryWithReturn(e)
  }
}
