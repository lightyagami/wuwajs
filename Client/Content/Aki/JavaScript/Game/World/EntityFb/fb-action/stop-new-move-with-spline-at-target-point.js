...
class StopNewMoveWithSplineAtTargetPoint {
  ...
  static getRootAsStopNewMoveWithSplineAtTargetPoint(t, e) {
    return (e || new StopNewMoveWithSplineAtTargetPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsStopNewMoveWithSplineAtTargetPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopNewMoveWithSplineAtTargetPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStopNewMoveWithSplineAtTargetPoint(t, e, i) {
    return StopNewMoveWithSplineAtTargetPoint.startStopNewMoveWithSplineAtTargetPoint(t), StopNewMoveWithSplineAtTargetPoint.addType(t, e), StopNewMoveWithSplineAtTargetPoint.addPointId(t, i), StopNewMoveWithSplineAtTargetPoint.endStopNewMoveWithSplineAtTargetPoint(t)
  }
}
