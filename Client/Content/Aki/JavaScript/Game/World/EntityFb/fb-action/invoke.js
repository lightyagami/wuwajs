...
class Invoke {
  ...
  static getSizePrefixedRootAsInvoke(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new Invoke).__init(t.readInt32(t.position()) + t.position(), t)
  }
  who() {
  ...
  actionInfo(t) {
    ...
    return i ? (t || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
