...
class HideMapMark {
  ...
  static getSizePrefixedRootAsHideMapMark(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new HideMapMark).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHideMapMark(t, a, e) {
    return HideMapMark.startHideMapMark(t), HideMapMark.addType(t, a), HideMapMark.addMarkId(t, e), HideMapMark.endHideMapMark(t)
  }
}
