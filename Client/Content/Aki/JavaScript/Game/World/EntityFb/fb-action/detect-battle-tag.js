...
class DetectBattleTag {
  ...
  static getSizePrefixedRootAsDetectBattleTag(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DetectBattleTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  tagOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_detect_battle_tag_type_js_1.UnionDetectBattleTagType.NONE
  }
  tagOption(t) {
  ...
  static createDetectBattleTag(t, e, a, i, s, r) {
    return DetectBattleTag.startDetectBattleTag(t), DetectBattleTag.addType(t, e), DetectBattleTag.addEntityId(t, a), DetectBattleTag.addTagOptionType(t, i), DetectBattleTag.addTagOption(t, s), DetectBattleTag.addMaxWaitTime(t, r), DetectBattleTag.endDetectBattleTag(t)
  }
}
