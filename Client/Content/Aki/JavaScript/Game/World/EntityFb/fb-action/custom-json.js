...
class CustomJson {
  ...
  static getSizePrefixedRootAsCustomJson(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CustomJson).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  static createCustomJson(t, s, o) {
    return CustomJson.startCustomJson(t), CustomJson.addName(t, s), CustomJson.addJsonString(t, o), CustomJson.endCustomJson(t)
  }
}
