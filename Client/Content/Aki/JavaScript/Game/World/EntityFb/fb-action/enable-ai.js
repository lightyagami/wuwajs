...
class EnableAI {
  ...
  static getSizePrefixedRootAsEnableAI(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new EnableAI).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createEnableAI(t, s, e) {
    return EnableAI.startEnableAI(t), EnableAI.addEntityIds(t, s), EnableAI.addIsEnable(t, e), EnableAI.endEnableAI(t)
  }
}
