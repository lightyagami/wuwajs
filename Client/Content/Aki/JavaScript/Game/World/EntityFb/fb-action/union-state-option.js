...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionStateOption = exports.unionToUnionStateOption = exports.UnionStateOption = void 0;
...
function unionToUnionStateOption(t, e) {
  switch (UnionStateOption[t]) {
    ...
    case "NotifyMonsterPlayStandbyTags":
      return e(new notify_monster_play_standby_tags_js_1.NotifyMonsterPlayStandbyTags);
    case "SetBattleTag":
...
function unionListToUnionStateOption(t, e, n) {
  switch (UnionStateOption[t]) {
    ...
    case "NotifyMonsterPlayStandbyTags":
      return e(n, new notify_monster_play_standby_tags_js_1.NotifyMonsterPlayStandbyTags);
    case "SetBattleTag":
  ...
  t[t.NONE = 0] = "NONE", t[t.NotifyMonsterPerception = 1] = "NotifyMonsterPerception", t[t.NotifyMonsterPlayStandbyTags = 2] = "NotifyMonsterPlayStandbyTags", t[t.SetBattleTag = 3] = "SetBattleTag"
}(UnionStateOption = exports.UnionStateOption || (exports.UnionStateOption = {})), exports.unionToUnionStateOption = unionToUnionStateOption, exports.unionListToUnionStateOption = unionListToUnionStateOption;
