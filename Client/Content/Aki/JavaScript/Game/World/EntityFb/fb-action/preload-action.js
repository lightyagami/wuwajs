...
class PreloadAction {
  ...
  static getSizePrefixedRootAsPreloadAction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PreloadAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  preloadObjectTypeType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_preload_object_type_config_js_1.UnionPreloadObjectTypeConfig.NONE
  }
  preloadObjectType(t) {
  ...
  static createPreloadAction(t, e, o) {
    return PreloadAction.startPreloadAction(t), PreloadAction.addPreloadObjectTypeType(t, e), PreloadAction.addPreloadObjectType(t, o), PreloadAction.endPreloadAction(t)
  }
}
