...
class OpenAirWall {
  ...
  static getSizePrefixedRootAsOpenAirWall(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OpenAirWall).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOpenAirWall(t, i, e, r, s, a, l, n) {
    return OpenAirWall.startOpenAirWall(t), OpenAirWall.addType(t, i), OpenAirWall.addHitEffectData(t, e), OpenAirWall.addHitCd(t, r), OpenAirWall.addAirWallEffectData(t, s), OpenAirWall.addAirWallEffectHeight(t, a), OpenAirWall.addAirWallEffectThickness(t, l), OpenAirWall.addCollisionPreset(t, n), OpenAirWall.endOpenAirWall(t)
  }
}
