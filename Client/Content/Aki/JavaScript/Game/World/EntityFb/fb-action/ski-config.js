...
class SkiConfig {
  ...
  static getSizePrefixedRootAsSkiConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SkiConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  configType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_ski_config_js_1.UnionSkiConfig.NONE
  }
  config(i) {
  ...
  static createSkiConfig(i, t, s, n) {
    return SkiConfig.startSkiConfig(i), SkiConfig.addType(i, t), SkiConfig.addConfigType(i, s), SkiConfig.addConfig(i, n), SkiConfig.endSkiConfig(i)
  }
}
