...
class DestroyEntity {
  ...
  static getSizePrefixedRootAsDestroyEntity(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new DestroyEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createDestroyEntity(t, s, i) {
    return DestroyEntity.startDestroyEntity(t), DestroyEntity.addEntityIds(t, s), DestroyEntity.addDelayDestroy(t, i), DestroyEntity.endDestroyEntity(t)
  }
}
