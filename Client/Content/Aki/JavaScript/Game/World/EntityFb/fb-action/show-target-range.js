...
class ShowTargetRange {
  ...
  static getSizePrefixedRootAsShowTargetRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ShowTargetRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  rangeEntities(t) {
  ...
  static createShowTargetRange(t, e, r) {
    return ShowTargetRange.startShowTargetRange(t), ShowTargetRange.addRangeEntities(t, e), ShowTargetRange.addDelayShow(t, r), ShowTargetRange.endShowTargetRange(t)
  }
}
