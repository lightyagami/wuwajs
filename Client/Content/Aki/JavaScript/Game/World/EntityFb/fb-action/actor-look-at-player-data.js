...
class ActorLookAtPlayerData {
  ...
  static getRootAsActorLookAtPlayerData(t, a) {
    return (a || new ActorLookAtPlayerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsActorLookAtPlayerData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ActorLookAtPlayerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtPlayerData(t, a, r) {
    return ActorLookAtPlayerData.startActorLookAtPlayerData(t), ActorLookAtPlayerData.addType(t, a), ActorLookAtPlayerData.addLock(t, r), ActorLookAtPlayerData.endActorLookAtPlayerData(t)
  }
}
