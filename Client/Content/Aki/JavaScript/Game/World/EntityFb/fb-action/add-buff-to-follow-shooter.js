...
class AddBuffToFollowShooter {
  ...
  static getSizePrefixedRootAsAddBuffToFollowShooter(o, t) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AddBuffToFollowShooter).__init(o.readInt32(o.position()) + o.position(), o)
  }
  buffIds(o) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readInt64(this.bb.__vector(this.bb_pos + t) + 8 * o) : BigInt(0)
  }
  buffIdsLength() {
  ...
  static createAddBuffToFollowShooter(o, t, r) {
    return AddBuffToFollowShooter.startAddBuffToFollowShooter(o), AddBuffToFollowShooter.addBuffIds(o, t), AddBuffToFollowShooter.addFollowShooterId(o, r), AddBuffToFollowShooter.endAddBuffToFollowShooter(o)
  }
}
