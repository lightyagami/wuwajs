...
class PlayEffect {
  ...
  static getSizePrefixedRootAsPlayEffect(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PlayEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  path(t) {
  ...
  pos2Type() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_pos2_js_1.UnionPos2.NONE
  }
  pos2(t) {
  ...
  static createPlayEffect(t, s, e, i) {
    return PlayEffect.startPlayEffect(t), PlayEffect.addPath(t, s), PlayEffect.addPos2Type(t, e), PlayEffect.addPos2(t, i), PlayEffect.endPlayEffect(t)
  }
}
