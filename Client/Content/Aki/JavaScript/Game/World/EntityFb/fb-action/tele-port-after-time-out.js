...
class TelePortAfterTimeOut {
  ...
  static getSizePrefixedRootAsTelePortAfterTimeOut(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TelePortAfterTimeOut).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createTelePortAfterTimeOut(t, e, r) {
    return TelePortAfterTimeOut.startTelePortAfterTimeOut(t), TelePortAfterTimeOut.addType(t, e), TelePortAfterTimeOut.addTimeOut(t, r), TelePortAfterTimeOut.endTelePortAfterTimeOut(t)
  }
}
