...
class SitOnGround {
  ...
  static getSizePrefixedRootAsSitOnGround(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new SitOnGround).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSitOnGround(t, r) {
    return SitOnGround.startSitOnGround(t), SitOnGround.addType(t, r), SitOnGround.endSitOnGround(t)
  }
}
