...
class ShowMapMark {
  ...
  static getRootAsShowMapMark(t, a) {
    return (a || new ShowMapMark).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsShowMapMark(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ShowMapMark).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createShowMapMark(t, a, r, s) {
    return ShowMapMark.startShowMapMark(t), ShowMapMark.addType(t, a), ShowMapMark.addMarkId(t, r), ShowMapMark.addIsFocusOnFirstShow(t, s), ShowMapMark.endShowMapMark(t)
  }
}
