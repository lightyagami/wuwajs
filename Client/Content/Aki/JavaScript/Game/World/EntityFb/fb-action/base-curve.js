...
class BaseCurve {
  ...
  static getSizePrefixedRootAsBaseCurve(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new BaseCurve).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createBaseCurve(e, t, s) {
    return BaseCurve.startBaseCurve(e), BaseCurve.addType(e, t), BaseCurve.addN(e, s), BaseCurve.endBaseCurve(e)
  }
}
