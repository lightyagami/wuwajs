...
class ServerForceEnableLevelPlay {
  ...
  static getSizePrefixedRootAsServerForceEnableLevelPlay(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ServerForceEnableLevelPlay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  configs(e, r) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? (r || new enable_level_play_config_js_1.EnableLevelPlayConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + t) + 4 * e), this.bb) : void 0
  }
  configsLength() {
  ...
  static createServerForceEnableLevelPlay(e, r) {
    return ServerForceEnableLevelPlay.startServerForceEnableLevelPlay(e), ServerForceEnableLevelPlay.addConfigs(e, r), ServerForceEnableLevelPlay.endServerForceEnableLevelPlay(e)
  }
}
