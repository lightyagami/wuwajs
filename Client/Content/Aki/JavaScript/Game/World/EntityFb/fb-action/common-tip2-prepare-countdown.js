...
class CommonTip2PrepareCountdown {
  ...
  static getSizePrefixedRootAsCommonTip2PrepareCountdown(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new CommonTip2PrepareCountdown).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCommonTip2PrepareCountdown(t, o, n, r, e) {
    return CommonTip2PrepareCountdown.startCommonTip2PrepareCountdown(t), CommonTip2PrepareCountdown.addType(t, o), CommonTip2PrepareCountdown.addCountDownNum(t, n), CommonTip2PrepareCountdown.addTidCountDownTxt(t, r), CommonTip2PrepareCountdown.addIsBlockPlayer(t, e), CommonTip2PrepareCountdown.endCommonTip2PrepareCountdown(t)
  }
}
