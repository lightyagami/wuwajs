...
class PerformerAiMoveTo {
  ...
  static getSizePrefixedRootAsPerformerAiMoveTo(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new PerformerAiMoveTo).__init(e.readInt32(e.position()) + e.position(), e)
  }
  configType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_performer_ai_move_to_config_js_1.UnionPerformerAiMoveToConfig.NONE
  }
  config(e) {
  ...
  static createPerformerAiMoveTo(e, r, o, t) {
    return PerformerAiMoveTo.startPerformerAiMoveTo(e), PerformerAiMoveTo.addConfigType(e, r), PerformerAiMoveTo.addConfig(e, o), PerformerAiMoveTo.addStopDistance(e, t), PerformerAiMoveTo.endPerformerAiMoveTo(e)
  }
}
