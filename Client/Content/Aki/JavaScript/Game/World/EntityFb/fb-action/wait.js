...
class Wait {
  ...
  static getSizePrefixedRootAsWait(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new Wait).__init(t.readInt32(t.position()) + t.position(), t)
  }
  min() {
  ...
  static createWait(t, i, s, a) {
    return Wait.startWait(t), Wait.addMin(t, i), Wait.addTime(t, s), Wait.addBanInput(t, a), Wait.endWait(t)
  }
}
exports.Wait = Wait;
