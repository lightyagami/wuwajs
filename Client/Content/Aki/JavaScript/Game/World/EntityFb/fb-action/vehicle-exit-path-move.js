...
class VehicleExitPathMove {
  ...
  static getSizePrefixedRootAsVehicleExitPathMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VehicleExitPathMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createVehicleExitPathMove(t, e) {
    return VehicleExitPathMove.startVehicleExitPathMove(t), VehicleExitPathMove.addType(t, e), VehicleExitPathMove.endVehicleExitPathMove(t)
  }
}
