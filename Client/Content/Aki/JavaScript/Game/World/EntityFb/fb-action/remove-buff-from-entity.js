...
class RemoveBuffFromEntity {
  ...
  static getSizePrefixedRootAsRemoveBuffFromEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RemoveBuffFromEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createRemoveBuffFromEntity(t, e, i, s) {
    return RemoveBuffFromEntity.startRemoveBuffFromEntity(t), RemoveBuffFromEntity.addEntityId(t, e), RemoveBuffFromEntity.addEntityIds(t, i), RemoveBuffFromEntity.addBuffIds(t, s), RemoveBuffFromEntity.endRemoveBuffFromEntity(t)
  }
}
