...
class CatapultParam {
  ...
  static getSizePrefixedRootAsCatapultParam(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CatapultParam).__init(t.readInt32(t.position()) + t.position(), t)
  }
  p1(t) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (t || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
  p2(t) {
