...
class TalkOptionQteFailedDelayExec {
  ...
  static getSizePrefixedRootAsTalkOptionQteFailedDelayExec(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TalkOptionQteFailedDelayExec).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createTalkOptionQteFailedDelayExec(e, t) {
    return TalkOptionQteFailedDelayExec.startTalkOptionQteFailedDelayExec(e), TalkOptionQteFailedDelayExec.addType(e, t), TalkOptionQteFailedDelayExec.endTalkOptionQteFailedDelayExec(e)
  }
}
