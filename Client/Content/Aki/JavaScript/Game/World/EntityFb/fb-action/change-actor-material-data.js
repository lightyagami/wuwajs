...
class ChangeActorMaterialData {
  ...
  static getSizePrefixedRootAsChangeActorMaterialData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ChangeActorMaterialData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  actorRefs(t, a) {
    ...
    return r ? (a || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  actorRefsLength() {
  ...
  static createChangeActorMaterialData(t, a, r, e) {
    return ChangeActorMaterialData.startChangeActorMaterialData(t), ChangeActorMaterialData.addType(t, a), ChangeActorMaterialData.addMaterialData(t, r), ChangeActorMaterialData.addActorRefs(t, e), ChangeActorMaterialData.endChangeActorMaterialData(t)
  }
}
