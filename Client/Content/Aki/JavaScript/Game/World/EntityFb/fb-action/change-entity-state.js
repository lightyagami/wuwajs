...
class ChangeEntityState {
  ...
  static getSizePrefixedRootAsChangeEntityState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeEntityState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChangeEntityState(t, e, i) {
    return ChangeEntityState.startChangeEntityState(t), ChangeEntityState.addType(t, e), ChangeEntityState.addEntityId(t, i), ChangeEntityState.endChangeEntityState(t)
  }
}
