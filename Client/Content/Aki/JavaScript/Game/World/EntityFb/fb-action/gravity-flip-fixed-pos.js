...
class GravityFlipFixedPos {
  ...
  static getSizePrefixedRootAsGravityFlipFixedPos(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GravityFlipFixedPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createGravityFlipFixedPos(t, i, s) {
    return GravityFlipFixedPos.startGravityFlipFixedPos(t), GravityFlipFixedPos.addType(t, i), GravityFlipFixedPos.addGravityAndPosEntityId(t, s), GravityFlipFixedPos.endGravityFlipFixedPos(t)
  }
}
