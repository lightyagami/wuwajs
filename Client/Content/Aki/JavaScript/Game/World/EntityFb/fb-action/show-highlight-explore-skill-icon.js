...
class ShowHighlightExploreSkillIcon {
  ...
  static getSizePrefixedRootAsShowHighlightExploreSkillIcon(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ShowHighlightExploreSkillIcon).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createShowHighlightExploreSkillIcon(i, t, l, h, o) {
    return ShowHighlightExploreSkillIcon.startShowHighlightExploreSkillIcon(i), ShowHighlightExploreSkillIcon.addType(i, t), ShowHighlightExploreSkillIcon.addSkillType(i, l), ShowHighlightExploreSkillIcon.addDuration(i, h), ShowHighlightExploreSkillIcon.addIsSwitchBack(i, o), ShowHighlightExploreSkillIcon.endShowHighlightExploreSkillIcon(i)
  }
}
