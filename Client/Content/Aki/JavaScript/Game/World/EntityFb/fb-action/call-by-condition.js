...
class CallByCondition {
  ...
  static getSizePrefixedRootAsCallByCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CallByCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  conditions(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new conditions_js_1.Conditions).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  trueActions(t, i) {
  ...
  static createCallByCondition(t, i, s, n) {
    return CallByCondition.startCallByCondition(t), CallByCondition.addConditions(t, i), CallByCondition.addTrueActions(t, s), CallByCondition.addFalseActions(t, n), CallByCondition.endCallByCondition(t)
  }
}
