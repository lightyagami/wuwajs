...
class ModifyAlertValue {
  ...
  static getSizePrefixedRootAsModifyAlertValue(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ModifyAlertValue).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  setTypeType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_set_alert_value_type_js_1.UnionSetAlertValueType.NONE
  }
  setType(e) {
  ...
  changeSpeedType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_alert_value_change_speed_js_1.UnionAlertValueChangeSpeed.NONE
  }
  changeSpeed(e) {
  ...
  static createModifyAlertValue(e, t, i, a, s, r, l) {
    return ModifyAlertValue.startModifyAlertValue(e), ModifyAlertValue.addType(e, t), ModifyAlertValue.addAreaId(e, i), ModifyAlertValue.addSetTypeType(e, a), ModifyAlertValue.addSetType(e, s), ModifyAlertValue.addChangeSpeedType(e, r), ModifyAlertValue.addChangeSpeed(e, l), ModifyAlertValue.endModifyAlertValue(e)
  }
}
