...
class HideSpecifyEntityGroup {
  ...
  static getRootAsHideSpecifyEntityGroup(t, i) {
    return (i || new HideSpecifyEntityGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsHideSpecifyEntityGroup(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HideSpecifyEntityGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHideSpecifyEntityGroup(t, i, e, r) {
    return HideSpecifyEntityGroup.startHideSpecifyEntityGroup(t), HideSpecifyEntityGroup.addType(t, i), HideSpecifyEntityGroup.addEntityIds(t, e), HideSpecifyEntityGroup.addForceClean(t, r), HideSpecifyEntityGroup.endHideSpecifyEntityGroup(t)
  }
}
