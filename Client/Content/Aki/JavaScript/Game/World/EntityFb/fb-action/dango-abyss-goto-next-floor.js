...
class DangoAbyssGotoNextFloor {
  ...
  static getSizePrefixedRootAsDangoAbyssGotoNextFloor(o, t) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DangoAbyssGotoNextFloor).__init(o.readInt32(o.position()) + o.position(), o)
  }
  ...
  static createDangoAbyssGotoNextFloor(o) {
    return DangoAbyssGotoNextFloor.startDangoAbyssGotoNextFloor(o), DangoAbyssGotoNextFloor.endDangoAbyssGotoNextFloor(o)
  }
}
