...
class ChangeInteractOptionText {
  ...
  static getSizePrefixedRootAsChangeInteractOptionText(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeInteractOptionText).__init(t.readInt32(t.position()) + t.position(), t)
  }
  tidContent(t) {
  ...
  static createChangeInteractOptionText(t, e) {
    return ChangeInteractOptionText.startChangeInteractOptionText(t), ChangeInteractOptionText.addTidContent(t, e), ChangeInteractOptionText.endChangeInteractOptionText(t)
  }
}
