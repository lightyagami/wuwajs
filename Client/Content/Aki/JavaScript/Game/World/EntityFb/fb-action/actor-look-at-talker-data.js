...
class ActorLookAtTalkerData {
  ...
  static getRootAsActorLookAtTalkerData(t, a) {
    return (a || new ActorLookAtTalkerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsActorLookAtTalkerData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ActorLookAtTalkerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtTalkerData(t, a, r) {
    return ActorLookAtTalkerData.startActorLookAtTalkerData(t), ActorLookAtTalkerData.addType(t, a), ActorLookAtTalkerData.addLock(t, r), ActorLookAtTalkerData.endActorLookAtTalkerData(t)
  }
}
