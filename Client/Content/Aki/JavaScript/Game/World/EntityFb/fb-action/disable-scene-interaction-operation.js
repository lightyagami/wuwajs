...
class DisableSceneInteractionOperation {
  ...
  static getSizePrefixedRootAsDisableSceneInteractionOperation(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableSceneInteractionOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createDisableSceneInteractionOperation(e, t) {
    return DisableSceneInteractionOperation.startDisableSceneInteractionOperation(e), DisableSceneInteractionOperation.addType(e, t), DisableSceneInteractionOperation.endDisableSceneInteractionOperation(e)
  }
}
