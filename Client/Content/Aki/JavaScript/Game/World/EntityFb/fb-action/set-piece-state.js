...
class SetPieceState {
  ...
  static getSizePrefixedRootAsSetPieceState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetPieceState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  pieceState(t, e) {
    ...
    return i ? (e || new jigsaw_piece_js_1.JigsawPiece).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  pieceStateLength() {
  ...
  static createSetPieceState(t, e, i, s) {
    return SetPieceState.startSetPieceState(t), SetPieceState.addType(t, e), SetPieceState.addEntityId(t, i), SetPieceState.addPieceState(t, s), SetPieceState.endSetPieceState(t)
  }
}
