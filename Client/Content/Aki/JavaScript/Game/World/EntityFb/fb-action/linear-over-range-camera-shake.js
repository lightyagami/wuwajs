...
class LinearOverRangeCameraShake {
  ...
  static getSizePrefixedRootAsLinearOverRangeCameraShake(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new LinearOverRangeCameraShake).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createLinearOverRangeCameraShake(e, a, r, t, i) {
    return LinearOverRangeCameraShake.startLinearOverRangeCameraShake(e), LinearOverRangeCameraShake.addType(e, a), LinearOverRangeCameraShake.addCenterEntityId(e, r), LinearOverRangeCameraShake.addMinRange(e, t), LinearOverRangeCameraShake.addMaxRange(e, i), LinearOverRangeCameraShake.endLinearOverRangeCameraShake(e)
  }
}
