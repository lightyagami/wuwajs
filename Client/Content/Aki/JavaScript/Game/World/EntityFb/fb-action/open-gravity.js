...
class OpenGravity {
  ...
  static getSizePrefixedRootAsOpenGravity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OpenGravity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOpenGravity(t, i, e, r) {
    return OpenGravity.startOpenGravity(t), OpenGravity.addType(t, i), OpenGravity.addEntityId(t, e), OpenGravity.addPositionEntityId(t, r), OpenGravity.endOpenGravity(t)
  }
}
