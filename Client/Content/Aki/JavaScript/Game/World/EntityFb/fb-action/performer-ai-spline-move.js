...
class PerformerAiSplineMove {
  ...
  static getSizePrefixedRootAsPerformerAiSplineMove(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new PerformerAiSplineMove).__init(e.readInt32(e.position()) + e.position(), e)
  }
  splineEntityId() {
  ...
  static createPerformerAiSplineMove(e, r) {
    return PerformerAiSplineMove.startPerformerAiSplineMove(e), PerformerAiSplineMove.addSplineEntityId(e, r), PerformerAiSplineMove.endPerformerAiSplineMove(e)
  }
}
