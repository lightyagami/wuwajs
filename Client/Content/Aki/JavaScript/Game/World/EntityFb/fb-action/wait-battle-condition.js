...
class WaitBattleCondition {
  ...
  static getSizePrefixedRootAsWaitBattleCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new WaitBattleCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_detect_battle_condition_type_js_1.UnionDetectBattleConditionType.NONE
  }
  stateOption(t) {
  ...
  static createWaitBattleCondition(t, i, e) {
    return WaitBattleCondition.startWaitBattleCondition(t), WaitBattleCondition.addStateOptionType(t, i), WaitBattleCondition.addStateOption(t, e), WaitBattleCondition.endWaitBattleCondition(t)
  }
}
