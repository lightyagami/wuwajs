...
class AudioState {
  ...
  static getSizePrefixedRootAsAudioState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AudioState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  group(t) {
  ...
  static createAudioState(t, e, i) {
    return AudioState.startAudioState(t), AudioState.addGroup(t, e), AudioState.addState(t, i), AudioState.endAudioState(t)
  }
}
