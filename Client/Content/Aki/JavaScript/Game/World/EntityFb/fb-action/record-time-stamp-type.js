...
class RecordTimeStampType {
  ...
  static getSizePrefixedRootAsRecordTimeStampType(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RecordTimeStampType).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createRecordTimeStampType(e, t, i) {
    return RecordTimeStampType.startRecordTimeStampType(e), RecordTimeStampType.addType(e, t), RecordTimeStampType.addTimeStampType(e, i), RecordTimeStampType.endRecordTimeStampType(e)
  }
}
