...
class TriggerCameraShake {
  ...
  static getSizePrefixedRootAsTriggerCameraShake(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new TriggerCameraShake).__init(e.readInt32(e.position()) + e.position(), e)
  }
  cameraShakeConfigType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_camera_shake_config_js_1.UnionCameraShakeConfig.NONE
  }
  cameraShakeConfig(e) {
  ...
  static createTriggerCameraShake(e, a, r, i) {
    return TriggerCameraShake.startTriggerCameraShake(e), TriggerCameraShake.addCameraShakeConfigType(e, a), TriggerCameraShake.addCameraShakeConfig(e, r), TriggerCameraShake.addCameraShakeBp(e, i), TriggerCameraShake.endTriggerCameraShake(e)
  }
}
