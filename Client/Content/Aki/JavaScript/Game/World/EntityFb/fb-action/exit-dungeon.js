...
class ExitDungeon {
  ...
  static getSizePrefixedRootAsExitDungeon(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExitDungeon).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createExitDungeon(t, e) {
    return ExitDungeon.startExitDungeon(t), ExitDungeon.addIsNeedSecondaryConfirmation(t, e), ExitDungeon.endExitDungeon(t)
  }
}
