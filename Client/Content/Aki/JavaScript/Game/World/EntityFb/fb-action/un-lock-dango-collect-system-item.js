...
class UnLockDangoCollectSystemItem {
  ...
  static getSizePrefixedRootAsUnLockDangoCollectSystemItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UnLockDangoCollectSystemItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUnLockDangoCollectSystemItem(t, e, o) {
    return UnLockDangoCollectSystemItem.startUnLockDangoCollectSystemItem(t), UnLockDangoCollectSystemItem.addType(t, e), UnLockDangoCollectSystemItem.addId(t, o), UnLockDangoCollectSystemItem.endUnLockDangoCollectSystemItem(t)
  }
}
