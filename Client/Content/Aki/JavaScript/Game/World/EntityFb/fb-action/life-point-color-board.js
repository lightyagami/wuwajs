...
class LifePointColorBoard {
  ...
  static getSizePrefixedRootAsLifePointColorBoard(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new LifePointColorBoard).__init(t.readInt32(t.position()) + t.position(), t)
  }
  config(t, o) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (o || new color_piece_js_1.ColorPiece).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  configLength() {
  ...
  colors(t, o) {
    ...
    return r ? this.bb.__string(this.bb.__vector(this.bb_pos + r) + 4 * t, o) : void 0
  }
  colorsLength() {
  ...
  static createLifePointColorBoard(t, o, r, i) {
    return LifePointColorBoard.startLifePointColorBoard(t), LifePointColorBoard.addConfig(t, o), LifePointColorBoard.addColors(t, r), LifePointColorBoard.addTargetColor(t, i), LifePointColorBoard.endLifePointColorBoard(t)
  }
}
