...
class ICenterTextShowAll {
  ...
  static getSizePrefixedRootAsICenterTextShowAll(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ICenterTextShowAll).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createICenterTextShowAll(t, e) {
    return ICenterTextShowAll.startICenterTextShowAll(t), ICenterTextShowAll.addType(t, e), ICenterTextShowAll.endICenterTextShowAll(t)
  }
}
