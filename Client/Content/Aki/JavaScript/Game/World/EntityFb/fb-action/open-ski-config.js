...
class OpenSkiConfig {
  ...
  static getSizePrefixedRootAsOpenSkiConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OpenSkiConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOpenSkiConfig(t, i, e, n, s) {
    return OpenSkiConfig.startOpenSkiConfig(t), OpenSkiConfig.addType(t, i), OpenSkiConfig.addTargetType(t, e), OpenSkiConfig.addTarget(t, n), OpenSkiConfig.addSkiConfig(t, s), OpenSkiConfig.endOpenSkiConfig(t)
  }
}
