...
class CharacterLookAt {
  ...
  static getSizePrefixedRootAsCharacterLookAt(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new CharacterLookAt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  charEntityId() {
  ...
  targetType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_character_look_at_data_js_1.UnionCharacterLookAtData.NONE
  }
  target(t) {
  ...
  static createCharacterLookAt(t, r, a, e) {
    return CharacterLookAt.startCharacterLookAt(t), CharacterLookAt.addCharEntityId(t, r), CharacterLookAt.addTargetType(t, a), CharacterLookAt.addTarget(t, e), CharacterLookAt.endCharacterLookAt(t)
  }
}
