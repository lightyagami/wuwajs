...
class PlayCommonEffect {
  ...
  static getSizePrefixedRootAsPlayCommonEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayCommonEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  pos2Type() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_effect_pos2_js_1.UnionEffectPos2.NONE
  }
  pos2(t) {
  ...
  static createPlayCommonEffect(t, e, s, o, f) {
    return PlayCommonEffect.startPlayCommonEffect(t), PlayCommonEffect.addType(t, e), PlayCommonEffect.addPath(t, s), PlayCommonEffect.addPos2Type(t, o), PlayCommonEffect.addPos2(t, f), PlayCommonEffect.endPlayCommonEffect(t)
  }
}
