...
class FireBulletForwardFront {
  ...
  static getSizePrefixedRootAsFireBulletForwardFront(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new FireBulletForwardFront).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFireBulletForwardFront(t, r, e, i, s) {
    return FireBulletForwardFront.startFireBulletForwardFront(t), FireBulletForwardFront.addType(t, r), FireBulletForwardFront.addBulletId(t, e), FireBulletForwardFront.addLauncherType(t, i), FireBulletForwardFront.addLauncher(t, s), FireBulletForwardFront.endFireBulletForwardFront(t)
  }
}
