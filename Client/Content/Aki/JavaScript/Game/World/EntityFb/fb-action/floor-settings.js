...
class FloorSettings {
  ...
  static getSizePrefixedRootAsFloorSettings(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new FloorSettings).__init(t.readInt32(t.position()) + t.position(), t)
  }
  meshPath(t) {
  ...
  scale(t) {
    ...
    return s ? (t || new vector2_js_1.Vector2).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  showTime() {
