...
class SetPlayerMoveControl {
  ...
  static getSizePrefixedRootAsSetPlayerMoveControl(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetPlayerMoveControl).__init(t.readInt32(t.position()) + t.position(), t)
  }
  left() {
  ...
  static createSetPlayerMoveControl(t, e, r, o, s) {
    return SetPlayerMoveControl.startSetPlayerMoveControl(t), SetPlayerMoveControl.addLeft(t, e), SetPlayerMoveControl.addRight(t, r), SetPlayerMoveControl.addForward(t, o), SetPlayerMoveControl.addBack(t, s), SetPlayerMoveControl.endSetPlayerMoveControl(t)
  }
}
