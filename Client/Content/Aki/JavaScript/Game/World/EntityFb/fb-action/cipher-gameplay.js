...
class CipherGameplay {
  ...
  static getSizePrefixedRootAsCipherGameplay(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CipherGameplay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCipherGameplay(e, t, i) {
    return CipherGameplay.startCipherGameplay(e), CipherGameplay.addType(e, t), CipherGameplay.addCipherId(e, i), CipherGameplay.endCipherGameplay(e)
  }
}
