...
class SyncVarToActorState {
  ...
  static getSizePrefixedRootAsSyncVarToActorState(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new SyncVarToActorState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  varName(t) {
  ...
  static createSyncVarToActorState(t, r, a) {
    return SyncVarToActorState.startSyncVarToActorState(t), SyncVarToActorState.addVarName(t, r), SyncVarToActorState.addStateKey(t, a), SyncVarToActorState.endSyncVarToActorState(t)
  }
}
