...
class NotifyMonsterPerception {
  ...
  static getSizePrefixedRootAsNotifyMonsterPerception(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NotifyMonsterPerception).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  perceptionBehaviorOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_battle_state_perception_behavior_js_1.UnionBattleStatePerceptionBehavior.NONE
  }
  ...
  static createNotifyMonsterPerception(t, e, i, r, s) {
    return NotifyMonsterPerception.startNotifyMonsterPerception(t), NotifyMonsterPerception.addType(t, e), NotifyMonsterPerception.addEntityIds(t, i), NotifyMonsterPerception.addPerceptionBehaviorOptionType(t, r), NotifyMonsterPerception.addPerceptionBehaviorOption(t, s), NotifyMonsterPerception.endNotifyMonsterPerception(t)
  }
}
