...
class HideWorldMonsterAndMonsterTreasure {
  ...
  static getSizePrefixedRootAsHideWorldMonsterAndMonsterTreasure(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new HideWorldMonsterAndMonsterTreasure).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createHideWorldMonsterAndMonsterTreasure(e, r) {
    return HideWorldMonsterAndMonsterTreasure.startHideWorldMonsterAndMonsterTreasure(e), HideWorldMonsterAndMonsterTreasure.addType(e, r), HideWorldMonsterAndMonsterTreasure.endHideWorldMonsterAndMonsterTreasure(e)
  }
}
