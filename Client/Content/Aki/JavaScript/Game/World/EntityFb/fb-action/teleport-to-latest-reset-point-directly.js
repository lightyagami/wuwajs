...
class TeleportToLatestResetPointDirectly {
  ...
  static getSizePrefixedRootAsTeleportToLatestResetPointDirectly(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportToLatestResetPointDirectly).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportToLatestResetPointDirectly(t, e) {
    return TeleportToLatestResetPointDirectly.startTeleportToLatestResetPointDirectly(t), TeleportToLatestResetPointDirectly.addType(t, e), TeleportToLatestResetPointDirectly.endTeleportToLatestResetPointDirectly(t)
  }
}
