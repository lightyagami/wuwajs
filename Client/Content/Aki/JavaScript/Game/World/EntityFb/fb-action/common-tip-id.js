...
class CommonTipId {
  ...
  static getSizePrefixedRootAsCommonTipId(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CommonTipId).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCommonTipId(t, i, o) {
    return CommonTipId.startCommonTipId(t), CommonTipId.addType(t, i), CommonTipId.addId(t, o), CommonTipId.endCommonTipId(t)
  }
}
