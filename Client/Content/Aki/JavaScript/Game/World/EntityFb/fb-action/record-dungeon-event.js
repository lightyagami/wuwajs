...
class RecordDungeonEvent {
  ...
  static getSizePrefixedRootAsRecordDungeonEvent(e, n) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new RecordDungeonEvent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  eventConfigType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_dungeon_event_type_js_1.UnionDungeonEventType.NONE
  }
  eventConfig(e) {
  ...
  static createRecordDungeonEvent(e, n, t) {
    return RecordDungeonEvent.startRecordDungeonEvent(e), RecordDungeonEvent.addEventConfigType(e, n), RecordDungeonEvent.addEventConfig(e, t), RecordDungeonEvent.endRecordDungeonEvent(e)
  }
}
