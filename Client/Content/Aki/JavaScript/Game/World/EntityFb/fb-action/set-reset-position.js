...
class SetResetPosition {
  ...
  static getSizePrefixedRootAsSetResetPosition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetResetPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetResetPosition(t, e, s, i) {
    return SetResetPosition.startSetResetPosition(t), SetResetPosition.addType(t, e), SetResetPosition.addEntityId(t, s), SetResetPosition.addPositionEntityId(t, i), SetResetPosition.endSetResetPosition(t)
  }
}
