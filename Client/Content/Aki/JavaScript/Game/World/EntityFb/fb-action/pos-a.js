...
class PosA {
  ...
  static getSizePrefixedRootAsPosA(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PosA).__init(t.readInt32(t.position()) + t.position(), t)
  }
  x() {
  ...
  static createPosA(t, s, i, r, e) {
    return PosA.startPosA(t), PosA.addX(t, s), PosA.addY(t, i), PosA.addZ(t, r), PosA.addA(t, e), PosA.endPosA(t)
  }
}
exports.PosA = PosA;
