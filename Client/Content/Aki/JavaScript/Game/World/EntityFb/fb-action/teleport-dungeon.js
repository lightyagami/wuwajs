...
class TeleportDungeon {
  ...
  static getSizePrefixedRootAsTeleportDungeon(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportDungeon).__init(t.readInt32(t.position()) + t.position(), t)
  }
  dungeonId() {
  ...
  keepMovementStates(t, e) {
    ...
    return n ? this.bb.__string(this.bb.__vector(this.bb_pos + n) + 4 * t, e) : void 0
  }
  ...
  static createTeleportDungeon(t, e, n, i, o, r, s, a, u, h) {
    return TeleportDungeon.startTeleportDungeon(t), TeleportDungeon.addDungeonId(t, e), TeleportDungeon.addIsRegroup(t, n), TeleportDungeon.addLocationEntityId(t, i), TeleportDungeon.addTransitionOptionType(t, o), TeleportDungeon.addTransitionOption(t, r), TeleportDungeon.addIsNeedSecondaryConfirmation(t, s), TeleportDungeon.addUseLocationEntityGravity(t, a), TeleportDungeon.addContinueSave(t, u), TeleportDungeon.addKeepMovementStates(t, h), TeleportDungeon.endTeleportDungeon(t)
  }
}
