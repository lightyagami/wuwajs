...
class OptionLockTip {
  ...
  static getSizePrefixedRootAsOptionLockTip(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OptionLockTip).__init(t.readInt32(t.position()) + t.position(), t)
  }
  tidAppendText(t) {
  ...
  static createOptionLockTip(t, i, s, e, o) {
    return OptionLockTip.startOptionLockTip(t), OptionLockTip.addTidAppendText(t, i), OptionLockTip.addTidHintText(t, s), OptionLockTip.addAppendTextId(t, e), OptionLockTip.addHintTextId(t, o), OptionLockTip.endOptionLockTip(t)
  }
}
