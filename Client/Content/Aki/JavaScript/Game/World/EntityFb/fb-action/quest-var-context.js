...
class QuestVarContext {
  ...
  static getSizePrefixedRootAsQuestVarContext(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new QuestVarContext).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createQuestVarContext(t, e, s) {
    return QuestVarContext.startQuestVarContext(t), QuestVarContext.addType(t, e), QuestVarContext.addId(t, s), QuestVarContext.endQuestVarContext(t)
  }
}
