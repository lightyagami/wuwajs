...
class SetFlowTemplate {
  ...
  static getSizePrefixedRootAsSetFlowTemplate(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  folded() {
  ...
  templateMode(t) {
    ...
    return e ? (t || new flow_template_mode_js_1.FlowTemplateMode).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  targetPos(t) {
    var e = this.bb.__offset(this.bb_pos, 8);
    return e ? (t || new pos_and_rot_js_1.PosAndRot).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  cameraAnim(t) {
    var e = this.bb.__offset(this.bb_pos, 10);
    return e ? (t || new set_camera_anim_js_1.SetCameraAnim).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  cameraOffset(t) {
  ...
  cameraPosAndRot(t) {
    ...
    return e ? (t || new camera_pos_and_rot_js_1.CameraPosAndRot).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  cameraSetting(t) {
    var e = this.bb.__offset(this.bb_pos, 18);
    return e ? (t || new camera_setting_js_1.CameraSetting).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  actorIndexArray(t, e) {
    var a = this.bb.__offset(this.bb_pos, 20);
    return a ? (e || new flow_actor_index_data_js_1.FlowActorIndexData).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * t), this.bb) : void 0
  }
