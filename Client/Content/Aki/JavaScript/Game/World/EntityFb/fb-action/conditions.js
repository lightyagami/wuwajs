...
class Conditions {
  ...
  static getSizePrefixedRootAsConditions(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new Conditions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  logicOpType(t) {
  ...
  conditions(t, i) {
    ...
    return s ? (i || new condition_js_1.Condition).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  conditionsLength() {
  ...
  static createConditions(t, i, s) {
    return Conditions.startConditions(t), Conditions.addLogicOpType(t, i), Conditions.addConditions(t, s), Conditions.endConditions(t)
  }
}
