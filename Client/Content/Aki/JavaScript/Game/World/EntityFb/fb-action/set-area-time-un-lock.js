...
class SetAreaTimeUnLock {
  ...
  static getSizePrefixedRootAsSetAreaTimeUnLock(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetAreaTimeUnLock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createSetAreaTimeUnLock(t, e, r) {
    return SetAreaTimeUnLock.startSetAreaTimeUnLock(t), SetAreaTimeUnLock.addType(t, e), SetAreaTimeUnLock.addAreaIds(t, r), SetAreaTimeUnLock.endSetAreaTimeUnLock(t)
  }
}
