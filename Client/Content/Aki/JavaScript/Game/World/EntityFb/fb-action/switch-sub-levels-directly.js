...
class SwitchSubLevelsDirectly {
  ...
  static getSizePrefixedRootAsSwitchSubLevelsDirectly(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SwitchSubLevelsDirectly).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSwitchSubLevelsDirectly(t, e, i, s, r) {
    return SwitchSubLevelsDirectly.startSwitchSubLevelsDirectly(t), SwitchSubLevelsDirectly.addType(t, e), SwitchSubLevelsDirectly.addLoadLevels(t, i), SwitchSubLevelsDirectly.addUnloadLevels(t, s), SwitchSubLevelsDirectly.addTeleportEntityId(t, r), SwitchSubLevelsDirectly.endSwitchSubLevelsDirectly(t)
  }
}
