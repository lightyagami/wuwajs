...
class VehicleEnteringNpcTarget {
  ...
  static getSizePrefixedRootAsVehicleEnteringNpcTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleEnteringNpcTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createVehicleEnteringNpcTarget(e, t, i, r) {
    return VehicleEnteringNpcTarget.startVehicleEnteringNpcTarget(e), VehicleEnteringNpcTarget.addType(e, t), VehicleEnteringNpcTarget.addTargetVehicle(e, i), VehicleEnteringNpcTarget.addTargetNpc(e, r), VehicleEnteringNpcTarget.endVehicleEnteringNpcTarget(e)
  }
}
