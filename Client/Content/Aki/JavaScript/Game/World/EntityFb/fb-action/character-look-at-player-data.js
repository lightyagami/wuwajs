...
class CharacterLookAtPlayerData {
  ...
  static getSizePrefixedRootAsCharacterLookAtPlayerData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CharacterLookAtPlayerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCharacterLookAtPlayerData(t, a) {
    return CharacterLookAtPlayerData.startCharacterLookAtPlayerData(t), CharacterLookAtPlayerData.addType(t, a), CharacterLookAtPlayerData.endCharacterLookAtPlayerData(t)
  }
}
