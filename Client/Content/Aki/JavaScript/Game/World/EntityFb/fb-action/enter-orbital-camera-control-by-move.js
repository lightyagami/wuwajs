...
class EnterOrbitalCameraControlByMove {
  ...
  static getSizePrefixedRootAsEnterOrbitalCameraControlByMove(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EnterOrbitalCameraControlByMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEnterOrbitalCameraControlByMove(t, r, e, a, i, n, o) {
    return EnterOrbitalCameraControlByMove.startEnterOrbitalCameraControlByMove(t), EnterOrbitalCameraControlByMove.addType(t, r), EnterOrbitalCameraControlByMove.addLevelSequence(t, e), EnterOrbitalCameraControlByMove.addBlendInTime(t, a), EnterOrbitalCameraControlByMove.addBlendOutTime(t, i), EnterOrbitalCameraControlByMove.addBegEntity(t, n), EnterOrbitalCameraControlByMove.addEndEntity(t, o), EnterOrbitalCameraControlByMove.endEnterOrbitalCameraControlByMove(t)
  }
}
