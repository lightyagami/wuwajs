...
class SetEntityClientVisible {
  ...
  static getSizePrefixedRootAsSetEntityClientVisible(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetEntityClientVisible).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createSetEntityClientVisible(t, i, e) {
    return SetEntityClientVisible.startSetEntityClientVisible(t), SetEntityClientVisible.addEntityIds(t, i), SetEntityClientVisible.addVisible(t, e), SetEntityClientVisible.endSetEntityClientVisible(t)
  }
}
