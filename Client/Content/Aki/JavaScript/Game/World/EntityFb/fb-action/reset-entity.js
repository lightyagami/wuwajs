...
class ResetEntity {
  ...
  static getSizePrefixedRootAsResetEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ResetEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  resetEntityConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_reset_entity_config_js_1.UnionResetEntityConfig.NONE
  }
  resetEntityConfig(t) {
  ...
  static createResetEntity(t, e, i) {
    return ResetEntity.startResetEntity(t), ResetEntity.addResetEntityConfigType(t, e), ResetEntity.addResetEntityConfig(t, i), ResetEntity.endResetEntity(t)
  }
}
