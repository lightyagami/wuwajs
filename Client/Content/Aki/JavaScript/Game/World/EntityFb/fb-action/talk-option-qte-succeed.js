...
class TalkOptionQteSucceed {
  ...
  static getSizePrefixedRootAsTalkOptionQteSucceed(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TalkOptionQteSucceed).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTalkOptionQteSucceed(t, e) {
    return TalkOptionQteSucceed.startTalkOptionQteSucceed(t), TalkOptionQteSucceed.addType(t, e), TalkOptionQteSucceed.endTalkOptionQteSucceed(t)
  }
}
