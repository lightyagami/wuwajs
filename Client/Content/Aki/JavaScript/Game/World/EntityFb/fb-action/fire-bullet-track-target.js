...
class FireBulletTrackTarget {
  ...
  static getRootAsFireBulletTrackTarget(t, e) {
    return (e || new FireBulletTrackTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsFireBulletTrackTarget(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FireBulletTrackTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFireBulletTrackTarget(t, e, r, i, a, s, u) {
    return FireBulletTrackTarget.startFireBulletTrackTarget(t), FireBulletTrackTarget.addType(t, e), FireBulletTrackTarget.addBulletId(t, r), FireBulletTrackTarget.addLauncherType(t, i), FireBulletTrackTarget.addLauncher(t, a), FireBulletTrackTarget.addTargetType(t, s), FireBulletTrackTarget.addTarget(t, u), FireBulletTrackTarget.endFireBulletTrackTarget(t)
  }
}
