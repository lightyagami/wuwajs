...
class SetPlayerOperationRestriction {
  ...
  static getSizePrefixedRootAsSetPlayerOperationRestriction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetPlayerOperationRestriction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetPlayerOperationRestriction(t, e) {
    return SetPlayerOperationRestriction.startSetPlayerOperationRestriction(t), SetPlayerOperationRestriction.addType(t, e), SetPlayerOperationRestriction.endSetPlayerOperationRestriction(t)
  }
}
