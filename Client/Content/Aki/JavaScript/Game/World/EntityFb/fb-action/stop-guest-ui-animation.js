...
class StopGuestUiAnimation {
  ...
  static getSizePrefixedRootAsStopGuestUiAnimation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new StopGuestUiAnimation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  stopGuestUiAnimationType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_stop_guest_ui_animation_type_js_1.UnionStopGuestUiAnimationType.NONE
  }
  ...
  static createStopGuestUiAnimation(t, i, s, n) {
    return StopGuestUiAnimation.startStopGuestUiAnimation(t), StopGuestUiAnimation.addType(t, i), StopGuestUiAnimation.addStopGuestUiAnimationType(t, s), StopGuestUiAnimation.addStopGuestUiAnimation(t, n), StopGuestUiAnimation.endStopGuestUiAnimation(t)
  }
}
