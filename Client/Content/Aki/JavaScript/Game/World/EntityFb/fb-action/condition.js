...
class Condition {
  ...
  static getSizePrefixedRootAsCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new Condition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  var1Type() {
  ...
  static createCondition(t, i, n, s, r, o) {
    return Condition.startCondition(t), Condition.addVar1Type(t, i), Condition.addVar1(t, n), Condition.addVar2Type(t, s), Condition.addVar2(t, r), Condition.addCompare(t, o), Condition.endCondition(t)
  }
}
