...
class ChangeNpcPerformState {
  ...
  static getSizePrefixedRootAsChangeNpcPerformState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeNpcPerformState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createChangeNpcPerformState(t, e, r) {
    return ChangeNpcPerformState.startChangeNpcPerformState(t), ChangeNpcPerformState.addEntityId(t, e), ChangeNpcPerformState.addState(t, r), ChangeNpcPerformState.endChangeNpcPerformState(t)
  }
}
