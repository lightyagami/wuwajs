...
class EnableHostility {
  ...
  static getSizePrefixedRootAsEnableHostility(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EnableHostility).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isEnable() {
  ...
  static createEnableHostility(t, i, s) {
    return EnableHostility.startEnableHostility(t), EnableHostility.addIsEnable(t, i), EnableHostility.addEntityIds(t, s), EnableHostility.endEnableHostility(t)
  }
}
