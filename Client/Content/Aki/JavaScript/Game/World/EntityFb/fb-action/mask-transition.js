...
class MaskTransition {
  ...
  static getSizePrefixedRootAsMaskTransition(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new MaskTransition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  fadeIn(t) {
    ...
    return s ? (t || new ease_data_js_1.EaseData).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  fadeOut(t) {
