...
class RemoveGuestCharacter {
  ...
  static getSizePrefixedRootAsRemoveGuestCharacter(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RemoveGuestCharacter).__init(e.readInt32(e.position()) + e.position(), e)
  }
  guestCharacterId() {
  ...
  static createRemoveGuestCharacter(e, t) {
    return RemoveGuestCharacter.startRemoveGuestCharacter(e), RemoveGuestCharacter.addGuestCharacterId(e, t), RemoveGuestCharacter.endRemoveGuestCharacter(e)
  }
}
