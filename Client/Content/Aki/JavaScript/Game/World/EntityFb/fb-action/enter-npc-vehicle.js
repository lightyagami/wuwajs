...
class EnterNpcVehicle {
  ...
  static getSizePrefixedRootAsEnterNpcVehicle(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnterNpcVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  target() {
  ...
  static createEnterNpcVehicle(e, t, r) {
    return EnterNpcVehicle.startEnterNpcVehicle(e), EnterNpcVehicle.addTarget(e, t), EnterNpcVehicle.addSeat(e, r), EnterNpcVehicle.endEnterNpcVehicle(e)
  }
}
