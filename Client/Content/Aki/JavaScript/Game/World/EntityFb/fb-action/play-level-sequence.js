...
class PlayLevelSequence {
  ...
  static getSizePrefixedRootAsPlayLevelSequence(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PlayLevelSequence).__init(e.readInt32(e.position()) + e.position(), e)
  }
  levelSequencePath(e) {
  ...
  introType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_level_sequence_transition_js_1.UnionLevelSequenceTransition.NONE
  }
  intro(e) {
  ...
  rateEase(e) {
    ...
    return t ? (e || new ease_data_js_1.EaseData).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
