...
class NumberVar {
  ...
  static getSizePrefixedRootAsNumberVar(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new NumberVar).__init(r.readInt32(r.position()) + r.position(), r)
  }
  name(r) {
  ...
  static createNumberVar(r, t, e) {
    return NumberVar.startNumberVar(r), NumberVar.addName(r, t), NumberVar.addValue(r, e), NumberVar.endNumberVar(r)
  }
}
