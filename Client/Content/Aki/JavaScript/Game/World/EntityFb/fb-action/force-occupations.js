...
class ForceOccupations {
  ...
  static getSizePrefixedRootAsForceOccupations(t, c) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (c || new ForceOccupations).__init(t.readInt32(t.position()) + t.position(), t)
  }
  occupationType(t) {
  ...
  occupations(t, c) {
    ...
    return s ? this.bb.__string(this.bb.__vector(this.bb_pos + s) + 4 * t, c) : void 0
  }
  occupationsLength() {
  ...
  static createForceOccupations(t, c, s) {
    return ForceOccupations.startForceOccupations(t), ForceOccupations.addOccupationType(t, c), ForceOccupations.addOccupations(t, s), ForceOccupations.endForceOccupations(t)
  }
}
