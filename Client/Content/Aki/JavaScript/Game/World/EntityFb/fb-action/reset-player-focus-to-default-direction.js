...
class ResetPlayerFocusToDefaultDirection {
  ...
  static getSizePrefixedRootAsResetPlayerFocusToDefaultDirection(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetPlayerFocusToDefaultDirection).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createResetPlayerFocusToDefaultDirection(e, t) {
    return ResetPlayerFocusToDefaultDirection.startResetPlayerFocusToDefaultDirection(e), ResetPlayerFocusToDefaultDirection.addType(e, t), ResetPlayerFocusToDefaultDirection.endResetPlayerFocusToDefaultDirection(e)
  }
}
