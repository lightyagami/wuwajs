...
class ClientSetPlayerPos {
  ...
  static getSizePrefixedRootAsClientSetPlayerPos(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ClientSetPlayerPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  telePortConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_client_teleport_config_js_1.UnionClientTeleportConfig.NONE
  }
  telePortConfig(t) {
  ...
  static createClientSetPlayerPos(t, e, i) {
    return ClientSetPlayerPos.startClientSetPlayerPos(t), ClientSetPlayerPos.addTelePortConfigType(t, e), ClientSetPlayerPos.addTelePortConfig(t, i), ClientSetPlayerPos.endClientSetPlayerPos(t)
  }
}
