...
class DisableAllPlayerOperation {
  ...
  static getSizePrefixedRootAsDisableAllPlayerOperation(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableAllPlayerOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createDisableAllPlayerOperation(e, t, l) {
    return DisableAllPlayerOperation.startDisableAllPlayerOperation(e), DisableAllPlayerOperation.addType(e, t), DisableAllPlayerOperation.addDisplayMode(e, l), DisableAllPlayerOperation.endDisableAllPlayerOperation(e)
  }
}
