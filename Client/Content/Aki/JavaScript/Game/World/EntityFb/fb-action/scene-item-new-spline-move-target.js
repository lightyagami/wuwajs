...
class SceneItemNewSplineMoveTarget {
  ...
  static getSizePrefixedRootAsSceneItemNewSplineMoveTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneItemNewSplineMoveTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSceneItemNewSplineMoveTarget(e, t, i, r) {
    return SceneItemNewSplineMoveTarget.startSceneItemNewSplineMoveTarget(e), SceneItemNewSplineMoveTarget.addType(e, t), SceneItemNewSplineMoveTarget.addEntityId(e, i), SceneItemNewSplineMoveTarget.addIsLookDir(e, r), SceneItemNewSplineMoveTarget.endSceneItemNewSplineMoveTarget(e)
  }
}
