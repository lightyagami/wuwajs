...
class ShowCenterText {
  ...
  static getSizePrefixedRootAsShowCenterText(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ShowCenterText).__init(t.readInt32(t.position()) + t.position(), t)
  }
  textId() {
  ...
  textStyle(t) {
    ...
    return e ? (t || new text_style_js_1.TextStyle).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  bgImageId(t) {
