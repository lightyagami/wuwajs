...
class AdjustBasicCamera {
  ...
  static getRootAsAdjustBasicCamera(t, i) {
    return (i || new AdjustBasicCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdjustBasicCamera(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AdjustBasicCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
