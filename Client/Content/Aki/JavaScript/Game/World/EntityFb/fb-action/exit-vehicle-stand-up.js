...
class ExitVehicleStandUp {
  ...
  static getSizePrefixedRootAsExitVehicleStandUp(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExitVehicleStandUp).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createExitVehicleStandUp(t, e) {
    return ExitVehicleStandUp.startExitVehicleStandUp(t), ExitVehicleStandUp.addType(t, e), ExitVehicleStandUp.endExitVehicleStandUp(t)
  }
}
