...
class TalkBackgroundIcon {
  ...
  static getSizePrefixedRootAsTalkBackgroundIcon(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new TalkBackgroundIcon).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTalkBackgroundIcon(t, a, r) {
    return TalkBackgroundIcon.startTalkBackgroundIcon(t), TalkBackgroundIcon.addType(t, a), TalkBackgroundIcon.addImageAsset(t, r), TalkBackgroundIcon.endTalkBackgroundIcon(t)
  }
}
