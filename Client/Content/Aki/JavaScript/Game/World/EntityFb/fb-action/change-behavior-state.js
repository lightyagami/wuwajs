...
class ChangeBehaviorState {
  ...
  static getSizePrefixedRootAsChangeBehaviorState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeBehaviorState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateId() {
  ...
  static createChangeBehaviorState(t, e, a) {
    return ChangeBehaviorState.startChangeBehaviorState(t), ChangeBehaviorState.addStateId(t, e), ChangeBehaviorState.addIsInstant(t, a), ChangeBehaviorState.endChangeBehaviorState(t)
  }
}
