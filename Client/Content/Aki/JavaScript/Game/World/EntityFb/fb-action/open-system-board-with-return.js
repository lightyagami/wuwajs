...
class OpenSystemBoardWithReturn {
  ...
  static getSizePrefixedRootAsOpenSystemBoardWithReturn(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OpenSystemBoardWithReturn).__init(t.readInt32(t.position()) + t.position(), t)
  }
  systemTypeType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_open_system_board_with_return_js_1.UnionOpenSystemBoardWithReturn.NONE
  }
  systemType(t) {
  ...
  static createOpenSystemBoardWithReturn(t, e, r) {
    return OpenSystemBoardWithReturn.startOpenSystemBoardWithReturn(t), OpenSystemBoardWithReturn.addSystemTypeType(t, e), OpenSystemBoardWithReturn.addSystemType(t, r), OpenSystemBoardWithReturn.endOpenSystemBoardWithReturn(t)
  }
}
