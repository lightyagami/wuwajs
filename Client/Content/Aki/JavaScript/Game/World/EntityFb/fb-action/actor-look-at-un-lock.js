...
class ActorLookAtUnLock {
  ...
  static getSizePrefixedRootAsActorLookAtUnLock(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ActorLookAtUnLock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtUnLock(t, o) {
    return ActorLookAtUnLock.startActorLookAtUnLock(t), ActorLookAtUnLock.addType(t, o), ActorLookAtUnLock.endActorLookAtUnLock(t)
  }
}
