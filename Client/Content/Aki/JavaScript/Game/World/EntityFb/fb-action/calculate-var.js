...
class CalculateVar {
  ...
  static getSizePrefixedRootAsCalculateVar(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CalculateVar).__init(t.readInt32(t.position()) + t.position(), t)
  }
  var1Type() {
  ...
  static createCalculateVar(t, a, r, e, s, i, u, l) {
    return CalculateVar.startCalculateVar(t), CalculateVar.addVar1Type(t, a), CalculateVar.addVar1(t, r), CalculateVar.addOp(t, e), CalculateVar.addVar2Type(t, s), CalculateVar.addVar2(t, i), CalculateVar.addResultType(t, u), CalculateVar.addResult(t, l), CalculateVar.endCalculateVar(t)
  }
}
