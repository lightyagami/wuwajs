...
class EnableAoiNotify {
  ...
  static getSizePrefixedRootAsEnableAoiNotify(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EnableAoiNotify).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  static createEnableAoiNotify(t, i) {
    return EnableAoiNotify.startEnableAoiNotify(t), EnableAoiNotify.addState(t, i), EnableAoiNotify.endEnableAoiNotify(t)
  }
}
