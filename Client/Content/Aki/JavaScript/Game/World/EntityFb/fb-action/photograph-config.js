...
class PhotographConfig {
  ...
  static getSizePrefixedRootAsPhotographConfig(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new PhotographConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  photoTargets(t) {
  ...
  static createPhotographConfig(t, o) {
    return PhotographConfig.startPhotographConfig(t), PhotographConfig.addPhotoTargets(t, o), PhotographConfig.endPhotographConfig(t)
  }
}
