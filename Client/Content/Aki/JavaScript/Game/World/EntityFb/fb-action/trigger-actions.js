...
class TriggerActions {
  ...
  static getSizePrefixedRootAsTriggerActions(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TriggerActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actions(t, i) {
  ...
  static createTriggerActions(t, i) {
    return TriggerActions.startTriggerActions(t), TriggerActions.addActions(t, i), TriggerActions.endTriggerActions(t)
  }
}
