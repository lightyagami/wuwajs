...
class TeleportDungeonFunction {
  ...
  static getSizePrefixedRootAsTeleportDungeonFunction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportDungeonFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportDungeonFunction(t, e, n, i) {
    return TeleportDungeonFunction.startTeleportDungeonFunction(t), TeleportDungeonFunction.addType(t, e), TeleportDungeonFunction.addEnable(t, n), TeleportDungeonFunction.addDungeonList(t, i), TeleportDungeonFunction.endTeleportDungeonFunction(t)
  }
}
