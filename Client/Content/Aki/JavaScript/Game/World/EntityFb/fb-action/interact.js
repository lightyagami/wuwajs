...
class Interact {
  ...
  static getSizePrefixedRootAsInteract(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new Interact).__init(t.readInt32(t.position()) + t.position(), t)
  }
  who() {
  ...
  static createInteract(t, r, e) {
    return Interact.startInteract(t), Interact.addWho(t, r), Interact.addParam(t, e), Interact.endInteract(t)
  }
}
