...
class TalkOption {
  ...
  static getSizePrefixedRootAsTalkOption(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TalkOption).__init(t.readInt32(t.position()) + t.position(), t)
  }
  tidTalkOption(t) {
  ...
  preConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_talk_option_pre_condition_js_1.UnionTalkOptionPreCondition.NONE
  }
  preCondition(t) {
  ...
  optionLockTip(t) {
    ...
    return i ? (t || new option_lock_tip_js_1.OptionLockTip).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  typeParamsType() {
    var t = this.bb.__offset(this.bb_pos, 30);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_talk_option_param_js_1.UnionTalkOptionParam.NONE
  }
  typeParams(t) {
