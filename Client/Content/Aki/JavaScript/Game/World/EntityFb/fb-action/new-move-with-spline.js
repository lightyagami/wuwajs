...
class NewMoveWithSpline {
  ...
  static getRootAsNewMoveWithSpline(t, e) {
    return (e || new NewMoveWithSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsNewMoveWithSpline(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NewMoveWithSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  moveTargetType() {
