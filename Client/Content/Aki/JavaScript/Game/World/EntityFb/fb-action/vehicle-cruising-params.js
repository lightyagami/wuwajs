...
class VehicleCruisingParams {
  ...
  static getSizePrefixedRootAsVehicleCruisingParams(i, r) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new VehicleCruisingParams).__init(i.readInt32(i.position()) + i.position(), i)
  }
  forwardSpeed() {
  ...
  static createVehicleCruisingParams(i, r, s, e) {
    return VehicleCruisingParams.startVehicleCruisingParams(i), VehicleCruisingParams.addForwardSpeed(i, r), VehicleCruisingParams.addForwardAcceleration(i, s), VehicleCruisingParams.addDisableSprint(i, e), VehicleCruisingParams.endVehicleCruisingParams(i)
  }
}
