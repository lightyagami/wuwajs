...
class ChangeRandomState {
  ...
  static getSizePrefixedRootAsChangeRandomState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeRandomState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateIds(t) {
  ...
  static createChangeRandomState(t, e) {
    return ChangeRandomState.startChangeRandomState(t), ChangeRandomState.addStateIds(t, e), ChangeRandomState.endChangeRandomState(t)
  }
}
