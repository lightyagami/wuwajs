...
class MoveToPoint {
  ...
  static getRootAsMoveToPoint(t, i) {
    return (i || new MoveToPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsMoveToPoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new MoveToPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static addMoveMotionType(t, i) {
    t.addFieldInt8(3, i, union_move_to_point_type_js_1.UnionMoveToPointType.NONE)
  }
