...
class CharacterGroupNew {
  ...
  static getSizePrefixedRootAsCharacterGroupNew(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CharacterGroupNew).__init(r.readInt32(r.position()) + r.position(), r)
  }
  characterId() {
  ...
  static createCharacterGroupNew(r, t, e) {
    return CharacterGroupNew.startCharacterGroupNew(r), CharacterGroupNew.addCharacterId(r, t), CharacterGroupNew.addIsAiCharacter(r, e), CharacterGroupNew.endCharacterGroupNew(r)
  }
}
