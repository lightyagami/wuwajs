...
class BeginFlowTemplate {
  ...
  static getSizePrefixedRootAsBeginFlowTemplate(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BeginFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  folded() {
  ...
  actors(t, e) {
    ...
    return i ? (e || new flow_actor_unit_js_1.FlowActorUnit).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  actorsLength() {
  ...
  static createBeginFlowTemplate(t, e, i, s, r, a) {
    return BeginFlowTemplate.startBeginFlowTemplate(t), BeginFlowTemplate.addFolded(t, e), BeginFlowTemplate.addActors(t, i), BeginFlowTemplate.addMontageIds(t, s), BeginFlowTemplate.addUseFreeCamera(t, r), BeginFlowTemplate.addIsSwitchMainRole(t, a), BeginFlowTemplate.endBeginFlowTemplate(t)
  }
}
