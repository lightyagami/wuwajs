...
class DestroyPrefab {
  ...
  static getSizePrefixedRootAsDestroyPrefab(r, e) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DestroyPrefab).__init(r.readInt32(r.position()) + r.position(), r)
  }
  varNameType() {
  ...
  static createDestroyPrefab(r, e, t) {
    return DestroyPrefab.startDestroyPrefab(r), DestroyPrefab.addVarNameType(r, e), DestroyPrefab.addVarName(r, t), DestroyPrefab.endDestroyPrefab(r)
  }
}
