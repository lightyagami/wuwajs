...
class PlayGuestCartethyia {
  ...
  static getSizePrefixedRootAsPlayGuestCartethyia(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayGuestCartethyia).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPlayGuestCartethyia(t, e) {
    return PlayGuestCartethyia.startPlayGuestCartethyia(t), PlayGuestCartethyia.addType(t, e), PlayGuestCartethyia.endPlayGuestCartethyia(t)
  }
}
