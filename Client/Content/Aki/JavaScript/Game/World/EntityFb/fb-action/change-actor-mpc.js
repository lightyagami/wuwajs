...
class ChangeActorMPC {
  ...
  static getSizePrefixedRootAsChangeActorMPC(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeActorMPC).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChangeActorMPC(t, e, r) {
    return ChangeActorMPC.startChangeActorMPC(t), ChangeActorMPC.addType(t, e), ChangeActorMPC.addMpcData(t, r), ChangeActorMPC.endChangeActorMPC(t)
  }
}
