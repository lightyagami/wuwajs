...
class AcceptFishingEntrust {
  ...
  static getSizePrefixedRootAsAcceptFishingEntrust(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AcceptFishingEntrust).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entrustId() {
  ...
  static createAcceptFishingEntrust(t, s, i) {
    return AcceptFishingEntrust.startAcceptFishingEntrust(t), AcceptFishingEntrust.addEntrustId(t, s), AcceptFishingEntrust.addIsAutoTracking(t, i), AcceptFishingEntrust.endAcceptFishingEntrust(t)
  }
}
