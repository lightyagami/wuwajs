...
class OpenQteAction {
  ...
  static getSizePrefixedRootAsOpenQteAction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OpenQteAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_open_qte_config_js_1.UnionOpenQteConfig.NONE
  }
  config(t) {
  ...
  static createOpenQteAction(t, e, n) {
    return OpenQteAction.startOpenQteAction(t), OpenQteAction.addConfigType(t, e), OpenQteAction.addConfig(t, n), OpenQteAction.endOpenQteAction(t)
  }
}
