...
class CloseSkiConfig {
  ...
  static getSizePrefixedRootAsCloseSkiConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CloseSkiConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCloseSkiConfig(t, i, e, s) {
    return CloseSkiConfig.startCloseSkiConfig(t), CloseSkiConfig.addType(t, i), CloseSkiConfig.addTargetType(t, e), CloseSkiConfig.addTarget(t, s), CloseSkiConfig.endCloseSkiConfig(t)
  }
}
