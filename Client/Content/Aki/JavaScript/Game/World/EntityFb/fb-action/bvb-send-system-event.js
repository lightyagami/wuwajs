...
class BvbSendSystemEvent {
  ...
  static getSizePrefixedRootAsBvbSendSystemEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BvbSendSystemEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  eventDataType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_bvb_event_data_js_1.UnionBvbEventData.NONE
  }
  eventData(t) {
  ...
  static createBvbSendSystemEvent(t, e, n) {
    return BvbSendSystemEvent.startBvbSendSystemEvent(t), BvbSendSystemEvent.addEventDataType(t, e), BvbSendSystemEvent.addEventData(t, n), BvbSendSystemEvent.endBvbSendSystemEvent(t)
  }
}
