...
class EaseData {
  ...
  static getSizePrefixedRootAsEaseData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new EaseData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createEaseData(t, a, s) {
    return EaseData.startEaseData(t), EaseData.addType(t, a), EaseData.addDuration(t, s), EaseData.endEaseData(t)
  }
}
