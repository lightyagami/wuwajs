...
class TeleportTransitionWithCenterText {
  ...
  static getRootAsTeleportTransitionWithCenterText(t, e) {
    return (e || new TeleportTransitionWithCenterText).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsTeleportTransitionWithCenterText(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportTransitionWithCenterText).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  centerTextFlow(t) {
    ...
    return e ? (t || new play_flow_js_1.PlayFlow).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
