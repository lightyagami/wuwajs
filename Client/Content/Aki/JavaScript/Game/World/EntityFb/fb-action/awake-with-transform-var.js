...
class AwakeWithTransformVar {
  ...
  static getSizePrefixedRootAsAwakeWithTransformVar(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AwakeWithTransformVar).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type(r) {
  ...
  static createAwakeWithTransformVar(r, t, a, s) {
    return AwakeWithTransformVar.startAwakeWithTransformVar(r), AwakeWithTransformVar.addType(r, t), AwakeWithTransformVar.addTransformVarType(r, a), AwakeWithTransformVar.addTransformVar(r, s), AwakeWithTransformVar.endAwakeWithTransformVar(r)
  }
}
