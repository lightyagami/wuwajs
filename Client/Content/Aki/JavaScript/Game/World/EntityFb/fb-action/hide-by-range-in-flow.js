...
class HideByRangeInFlow {
  ...
  static getRootAsHideByRangeInFlow(t, s) {
    return (s || new HideByRangeInFlow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsHideByRangeInFlow(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new HideByRangeInFlow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
