...
class BubbleData {
  ...
  static getSizePrefixedRootAsBubbleData(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BubbleData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  flowIndex(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new bubble_index_js_1.BubbleIndex).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  waitTime() {
  ...
  static createBubbleData(t, e, a) {
    return BubbleData.startBubbleData(t), BubbleData.addFlowIndex(t, e), BubbleData.addWaitTime(t, a), BubbleData.endBubbleData(t)
  }
}
