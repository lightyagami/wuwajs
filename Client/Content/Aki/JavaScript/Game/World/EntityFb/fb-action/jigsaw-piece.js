...
class JigsawPiece {
  ...
  static getSizePrefixedRootAsJigsawPiece(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new JigsawPiece).__init(i.readInt32(i.position()) + i.position(), i)
  }
  index(i) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (i || new piece_index_js_1.PieceIndex).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  active() {
  ...
  static createJigsawPiece(i, e, t, s, a) {
    return JigsawPiece.startJigsawPiece(i), JigsawPiece.addIndex(i, e), JigsawPiece.addActive(i, t), JigsawPiece.addIsCorrect(i, s), JigsawPiece.addInitState(i, a), JigsawPiece.endJigsawPiece(i)
  }
}
