...
class FixedTime {
  ...
  static getSizePrefixedRootAsFixedTime(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FixedTime).__init(e.readInt32(e.position()) + e.position(), e)
  }
  hour() {
  ...
  static createFixedTime(e, i, t) {
    return FixedTime.startFixedTime(e), FixedTime.addHour(e, i), FixedTime.addMinutes(e, t), FixedTime.endFixedTime(e)
  }
}
