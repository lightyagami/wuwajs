...
exports.unionListToUnionVarContext = exports.unionToUnionVarContext = exports.UnionVarContext = undefined;
const entity_template_context_js_1 = require("../fb-action/entity-template-context.js");
const entity_var_context_js_1 = require("../fb-action/entity-var-context.js");
const level_play_var_context_js_1 = require("../fb-action/level-play-var-context.js");
const quest_var_context_js_1 = require("../fb-action/quest-var-context.js");
var UnionVarContext;
...
})(UnionVarContext = exports.UnionVarContext ||= {});
exports.unionToUnionVarContext = unionToUnionVarContext;
exports.unionListToUnionVarContext = unionListToUnionVarContext; //# sourceMappingURL=union-var-context.js.map