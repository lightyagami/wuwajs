...
class SetAreaState {
  ...
  static getSizePrefixedRootAsSetAreaState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetAreaState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  areaId() {
  ...
  static createSetAreaState(t, e, a) {
    return SetAreaState.startSetAreaState(t), SetAreaState.addAreaId(t, e), SetAreaState.addState(t, a), SetAreaState.endSetAreaState(t)
  }
}
