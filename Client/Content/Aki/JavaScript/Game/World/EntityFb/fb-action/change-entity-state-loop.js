...
class ChangeEntityStateLoop {
  ...
  static getSizePrefixedRootAsChangeEntityStateLoop(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeEntityStateLoop).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChangeEntityStateLoop(t, e, i, a) {
    return ChangeEntityStateLoop.startChangeEntityStateLoop(t), ChangeEntityStateLoop.addType(t, e), ChangeEntityStateLoop.addEntityId(t, i), ChangeEntityStateLoop.addCirculation(t, a), ChangeEntityStateLoop.endChangeEntityStateLoop(t)
  }
}
