...
class SetBattleTag {
  ...
  static getSizePrefixedRootAsSetBattleTag(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetBattleTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  setTags(t, e) {
    ...
    return s ? (e || new set_entity_tag_js_1.SetEntityTag).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  setTagsLength() {
  ...
  static createSetBattleTag(t, e, s) {
    return SetBattleTag.startSetBattleTag(t), SetBattleTag.addType(t, e), SetBattleTag.addSetTags(t, s), SetBattleTag.endSetBattleTag(t)
  }
}
