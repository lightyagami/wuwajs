...
class ChangeActorTalker {
  ...
  static getSizePrefixedRootAsChangeActorTalker(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeActorTalker).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorIndex() {
  ...
  static createChangeActorTalker(t, e, r) {
    return ChangeActorTalker.startChangeActorTalker(t), ChangeActorTalker.addActorIndex(t, e), ChangeActorTalker.addTalker(t, r), ChangeActorTalker.endChangeActorTalker(t)
  }
}
