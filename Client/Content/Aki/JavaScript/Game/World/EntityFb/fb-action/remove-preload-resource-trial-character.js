...
class RemovePreloadResourceTrialCharacter {
  ...
  static getSizePrefixedRootAsRemovePreloadResourceTrialCharacter(r, e) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RemovePreloadResourceTrialCharacter).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type(r) {
  ...
  characterGroupArray() {
    var r = this.bb.__offset(this.bb_pos, 6);
    return r ? new Int32Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + r), this.bb.__vector_len(this.bb_pos + r)) : void 0
  }
  ...
  static createRemovePreloadResourceTrialCharacter(r, e, t) {
    return RemovePreloadResourceTrialCharacter.startRemovePreloadResourceTrialCharacter(r), RemovePreloadResourceTrialCharacter.addType(r, e), RemovePreloadResourceTrialCharacter.addCharacterGroup(r, t), RemovePreloadResourceTrialCharacter.endRemovePreloadResourceTrialCharacter(r)
  }
}
