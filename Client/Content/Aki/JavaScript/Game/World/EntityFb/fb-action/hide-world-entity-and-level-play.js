...
class HideWorldEntityAndLevelPlay {
  ...
  static getSizePrefixedRootAsHideWorldEntityAndLevelPlay(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HideWorldEntityAndLevelPlay).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHideWorldEntityAndLevelPlay(t, e, i) {
    return HideWorldEntityAndLevelPlay.startHideWorldEntityAndLevelPlay(t), HideWorldEntityAndLevelPlay.addType(t, e), HideWorldEntityAndLevelPlay.addExcludeEntities(t, i), HideWorldEntityAndLevelPlay.endHideWorldEntityAndLevelPlay(t)
  }
}
