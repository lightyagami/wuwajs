...
class LifePoint {
  ...
  static getSizePrefixedRootAsLifePoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LifePoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  colorBoard(t) {
    ...
    return i ? (t || new life_point_color_board_js_1.LifePointColorBoard).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  stepLimit() {
  ...
  maxStepRewardRule(t, i) {
    ...
    return e ? (i || new life_point_max_step_reward_rule_item_js_1.LifePointMaxStepRewardRuleItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
