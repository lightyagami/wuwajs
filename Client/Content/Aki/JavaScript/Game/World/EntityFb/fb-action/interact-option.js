...
class InteractOption {
  ...
  static getSizePrefixedRootAsInteractOption(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InteractOption).__init(t.readInt32(t.position()) + t.position(), t)
  }
  guid(t) {
  ...
  typeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_interact_option_js_1.UnionInteractOption.NONE
  }
  type(t) {
  ...
  duration(t) {
    ...
    return i ? (t || new duration_interact_js_1.DurationInteract).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  optionLockTip(t) {
