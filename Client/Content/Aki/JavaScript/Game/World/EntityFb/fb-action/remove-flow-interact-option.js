...
class RemoveFlowInteractOption {
  ...
  static getSizePrefixedRootAsRemoveFlowInteractOption(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RemoveFlowInteractOption).__init(t.readInt32(t.position()) + t.position(), t)
  }
  flow(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new flow_index_js_1.FlowIndex).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  entityId() {
  ...
  static createRemoveFlowInteractOption(t, e, o) {
    return RemoveFlowInteractOption.startRemoveFlowInteractOption(t), RemoveFlowInteractOption.addFlow(t, e), RemoveFlowInteractOption.addEntityId(t, o), RemoveFlowInteractOption.endRemoveFlowInteractOption(t)
  }
}
