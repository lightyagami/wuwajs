...
class RestorePhantomFormation {
  ...
  static getSizePrefixedRootAsRestorePhantomFormation(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new RestorePhantomFormation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  teleportEntityId() {
  ...
  static createRestorePhantomFormation(t, o, e) {
    return RestorePhantomFormation.startRestorePhantomFormation(t), RestorePhantomFormation.addTeleportEntityId(t, o), RestorePhantomFormation.addRetainPhantom(t, e), RestorePhantomFormation.endRestorePhantomFormation(t)
  }
}
