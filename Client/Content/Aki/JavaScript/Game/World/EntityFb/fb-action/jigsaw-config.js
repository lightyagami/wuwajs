...
class JigsawConfig {
  ...
  static getSizePrefixedRootAsJigsawConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new JigsawConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  row() {
  ...
  pieces(i, t) {
    ...
    return s ? (t || new jigsaw_piece_js_1.JigsawPiece).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * i), this.bb) : void 0
  }
  piecesLength() {
  ...
  static createJigsawConfig(i, t, s, e, a, r) {
    return JigsawConfig.startJigsawConfig(i), JigsawConfig.addRow(i, t), JigsawConfig.addColumn(i, s), JigsawConfig.addSize(i, e), JigsawConfig.addShape(i, a), JigsawConfig.addPieces(i, r), JigsawConfig.endJigsawConfig(i)
  }
}
