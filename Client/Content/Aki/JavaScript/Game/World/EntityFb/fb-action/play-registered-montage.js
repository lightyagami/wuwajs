...
class PlayRegisteredMontage {
  ...
  static getSizePrefixedRootAsPlayRegisteredMontage(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayRegisteredMontage).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createPlayRegisteredMontage(t, e, s, a, i, r, n, o, d) {
    return PlayRegisteredMontage.startPlayRegisteredMontage(t), PlayRegisteredMontage.addEntityId(t, e), PlayRegisteredMontage.addMontageId(t, s), PlayRegisteredMontage.addIsAbpMontage(t, a), PlayRegisteredMontage.addFaceExpressionId(t, i), PlayRegisteredMontage.addLoopDuration(t, r), PlayRegisteredMontage.addRepeatTimes(t, n), PlayRegisteredMontage.addKeepMontageWhenEnd(t, o), PlayRegisteredMontage.addKeepMontageAfterFlow(t, d), PlayRegisteredMontage.endPlayRegisteredMontage(t)
  }
}
