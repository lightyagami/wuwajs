...
class DurationInteract {
  ...
  static getSizePrefixedRootAsDurationInteract(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new DurationInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  duration() {
  ...
  static createDurationInteract(t, r) {
    return DurationInteract.startDurationInteract(t), DurationInteract.addDuration(t, r), DurationInteract.endDurationInteract(t)
  }
}
