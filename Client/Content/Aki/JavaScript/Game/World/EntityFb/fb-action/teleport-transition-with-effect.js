...
class TeleportTransitionWithEffect {
  ...
  static getSizePrefixedRootAsTeleportTransitionWithEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportTransitionWithEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportTransitionWithEffect(t, e, i) {
    return TeleportTransitionWithEffect.startTeleportTransitionWithEffect(t), TeleportTransitionWithEffect.addType(t, e), TeleportTransitionWithEffect.addEffectDaPath(t, i), TeleportTransitionWithEffect.endTeleportTransitionWithEffect(t)
  }
}
