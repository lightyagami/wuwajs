...
class TalkOptionQteFailed {
  ...
  static getSizePrefixedRootAsTalkOptionQteFailed(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TalkOptionQteFailed).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTalkOptionQteFailed(t, e) {
    return TalkOptionQteFailed.startTalkOptionQteFailed(t), TalkOptionQteFailed.addType(t, e), TalkOptionQteFailed.endTalkOptionQteFailed(t)
  }
}
