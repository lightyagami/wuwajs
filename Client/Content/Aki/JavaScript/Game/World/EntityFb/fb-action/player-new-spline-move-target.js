...
class PlayerNewSplineMoveTarget {
  ...
  static getSizePrefixedRootAsPlayerNewSplineMoveTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PlayerNewSplineMoveTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createPlayerNewSplineMoveTarget(e, t) {
    return PlayerNewSplineMoveTarget.startPlayerNewSplineMoveTarget(e), PlayerNewSplineMoveTarget.addType(e, t), PlayerNewSplineMoveTarget.endPlayerNewSplineMoveTarget(e)
  }
}
