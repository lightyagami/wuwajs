...
class DisableUiOperation {
  ...
  static getSizePrefixedRootAsDisableUiOperation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableUiOperation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createDisableUiOperation(i, t) {
    return DisableUiOperation.startDisableUiOperation(i), DisableUiOperation.addType(i, t), DisableUiOperation.endDisableUiOperation(i)
  }
}
