...
class TeleportToLatestResetPoint {
  ...
  static getSizePrefixedRootAsTeleportToLatestResetPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportToLatestResetPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_teleport_to_latest_reset_point_option_js_1.UnionTeleportToLatestResetPointOption.NONE
  }
  option(t) {
  ...
  static createTeleportToLatestResetPoint(t, e, o) {
    return TeleportToLatestResetPoint.startTeleportToLatestResetPoint(t), TeleportToLatestResetPoint.addOptionType(t, e), TeleportToLatestResetPoint.addOption(t, o), TeleportToLatestResetPoint.endTeleportToLatestResetPoint(t)
  }
}
