...
class DisableAlertAreaQuestCondition {
  ...
  static getSizePrefixedRootAsDisableAlertAreaQuestCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DisableAlertAreaQuestCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createDisableAlertAreaQuestCondition(t, e, i) {
    return DisableAlertAreaQuestCondition.startDisableAlertAreaQuestCondition(t), DisableAlertAreaQuestCondition.addType(t, e), DisableAlertAreaQuestCondition.addRelatedQuestId(t, i), DisableAlertAreaQuestCondition.endDisableAlertAreaQuestCondition(t)
  }
}
