...
class NotifyMonsterPlayStandbyTags {
  ...
  static getSizePrefixedRootAsNotifyMonsterPlayStandbyTags(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new NotifyMonsterPlayStandbyTags).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  standbyTags(t, s) {
    ...
    return a ? this.bb.__string(this.bb.__vector(this.bb_pos + a) + 4 * t, s) : void 0
  }
  standbyTagsLength() {
  ...
  static createNotifyMonsterPlayStandbyTags(t, s, a) {
    return NotifyMonsterPlayStandbyTags.startNotifyMonsterPlayStandbyTags(t), NotifyMonsterPlayStandbyTags.addType(t, s), NotifyMonsterPlayStandbyTags.addStandbyTags(t, a), NotifyMonsterPlayStandbyTags.endNotifyMonsterPlayStandbyTags(t)
  }
}
