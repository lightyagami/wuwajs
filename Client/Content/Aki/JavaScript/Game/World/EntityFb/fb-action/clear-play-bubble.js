...
class ClearPlayBubble {
  ...
  static getSizePrefixedRootAsClearPlayBubble(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ClearPlayBubble).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createClearPlayBubble(t, e, r) {
    return ClearPlayBubble.startClearPlayBubble(t), ClearPlayBubble.addEntityIds(t, e), ClearPlayBubble.addOnlyClearRedDot(t, r), ClearPlayBubble.endClearPlayBubble(t)
  }
}
