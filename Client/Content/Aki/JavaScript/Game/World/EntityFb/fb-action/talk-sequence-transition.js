...
class TalkSequenceTransition {
  ...
  static getSizePrefixedRootAsTalkSequenceTransition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TalkSequenceTransition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  optionText(e) {
  ...
  static createTalkSequenceTransition(e, t, i, n) {
    return TalkSequenceTransition.startTalkSequenceTransition(e), TalkSequenceTransition.addOptionText(e, t), TalkSequenceTransition.addOptionTextKey(e, i), TalkSequenceTransition.addNextSequenceIndex(e, n), TalkSequenceTransition.endTalkSequenceTransition(e)
  }
}
