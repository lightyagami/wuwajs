...
class HideWorldEntityAndLevelPlayGroup {
  ...
  static getSizePrefixedRootAsHideWorldEntityAndLevelPlayGroup(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HideWorldEntityAndLevelPlayGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHideWorldEntityAndLevelPlayGroup(t, e, i, s, r, n, a) {
    return HideWorldEntityAndLevelPlayGroup.startHideWorldEntityAndLevelPlayGroup(t), HideWorldEntityAndLevelPlayGroup.addType(t, e), HideWorldEntityAndLevelPlayGroup.addHideRangeEntities(t, i), HideWorldEntityAndLevelPlayGroup.addExcludeEntities(t, s), HideWorldEntityAndLevelPlayGroup.addExcludeLevelPlays(t, r), HideWorldEntityAndLevelPlayGroup.addAppendEntities(t, n), HideWorldEntityAndLevelPlayGroup.addAppendLevelPlays(t, a), HideWorldEntityAndLevelPlayGroup.endHideWorldEntityAndLevelPlayGroup(t)
  }
}
