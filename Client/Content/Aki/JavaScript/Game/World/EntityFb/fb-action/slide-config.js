...
class SlideConfig {
  ...
  static getSizePrefixedRootAsSlideConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SlideConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createSlideConfig(i, t, e) {
    return SlideConfig.startSlideConfig(i), SlideConfig.addType(i, t), SlideConfig.addSlideId(i, e), SlideConfig.endSlideConfig(i)
  }
}
