...
class EnableActor {
  ...
  static getSizePrefixedRootAsEnableActor(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EnableActor).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorType(t) {
  ...
  static createEnableActor(t, r, e, s, a) {
    return EnableActor.startEnableActor(t), EnableActor.addActorType(t, r), EnableActor.addTargets(t, e), EnableActor.addEnable(t, s), EnableActor.addSyncChildActor(t, a), EnableActor.endEnableActor(t)
  }
}
