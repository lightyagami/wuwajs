...
class DangoAbyssCreateRewardTreasureBox {
  ...
  static getSizePrefixedRootAsDangoAbyssCreateRewardTreasureBox(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new DangoAbyssCreateRewardTreasureBox).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createDangoAbyssCreateRewardTreasureBox(e) {
    return DangoAbyssCreateRewardTreasureBox.startDangoAbyssCreateRewardTreasureBox(e), DangoAbyssCreateRewardTreasureBox.endDangoAbyssCreateRewardTreasureBox(e)
  }
}
