...
class CommonTipEnterInRange {
  ...
  static getSizePrefixedRootAsCommonTipEnterInRange(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new CommonTipEnterInRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCommonTipEnterInRange(t, n, e) {
    return CommonTipEnterInRange.startCommonTipEnterInRange(t), CommonTipEnterInRange.addType(t, n), CommonTipEnterInRange.addTidText(t, e), CommonTipEnterInRange.endCommonTipEnterInRange(t)
  }
}
