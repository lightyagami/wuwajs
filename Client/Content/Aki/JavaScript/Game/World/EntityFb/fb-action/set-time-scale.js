...
class SetTimeScale {
  ...
  static getSizePrefixedRootAsSetTimeScale(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetTimeScale).__init(e.readInt32(e.position()) + e.position(), e)
  }
  configType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_set_time_scale_js_1.UnionSetTimeScale.NONE
  }
  config(e) {
  ...
  static createSetTimeScale(e, t, i) {
    return SetTimeScale.startSetTimeScale(e), SetTimeScale.addConfigType(e, t), SetTimeScale.addConfig(e, i), SetTimeScale.endSetTimeScale(e)
  }
}
