...
class StateInfo {
  ...
  static getSizePrefixedRootAsStateInfo(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new StateInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  plotPos(t) {
    ...
    return s ? (t || new pos_a_js_1.PosA).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  selectedIndexes(t) {
