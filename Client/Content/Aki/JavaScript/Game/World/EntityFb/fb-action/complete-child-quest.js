...
class CompleteChildQuest {
  ...
  static getRootAsCompleteChildQuest(t, e) {
    return (e || new CompleteChildQuest).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCompleteChildQuest(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CompleteChildQuest).__init(t.readInt32(t.position()) + t.position(), t)
  }
  questId() {
  ...
  static createCompleteChildQuest(t, e, s) {
    return CompleteChildQuest.startCompleteChildQuest(t), CompleteChildQuest.addQuestId(t, e), CompleteChildQuest.addNodeId(t, s), CompleteChildQuest.endCompleteChildQuest(t)
  }
}
