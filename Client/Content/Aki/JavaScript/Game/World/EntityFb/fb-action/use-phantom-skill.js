...
class UsePhantomSkill {
  ...
  static getSizePrefixedRootAsUsePhantomSkill(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new UsePhantomSkill).__init(t.readInt32(t.position()) + t.position(), t)
  }
  skillType(t) {
  ...
  blackboardPos(t) {
    ...
    return s ? (t || new skill_blackboard_vector_js_1.SkillBlackboardVector).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  blackboardRot(t) {
