...
class PerformerAiMoveToEntity {
  ...
  static getSizePrefixedRootAsPerformerAiMoveToEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PerformerAiMoveToEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPerformerAiMoveToEntity(t, e, r) {
    return PerformerAiMoveToEntity.startPerformerAiMoveToEntity(t), PerformerAiMoveToEntity.addType(t, e), PerformerAiMoveToEntity.addEntityId(t, r), PerformerAiMoveToEntity.endPerformerAiMoveToEntity(t)
  }
}
