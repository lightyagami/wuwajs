...
class SpawnEntity {
  ...
  static getSizePrefixedRootAsSpawnEntity(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new SpawnEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityDataId() {
  ...
  transform(t) {
    ...
    return s ? (t || new transform_js_1.Transform).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  saveType() {
