...
class ConstantCameraShake {
  ...
  static getSizePrefixedRootAsConstantCameraShake(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ConstantCameraShake).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createConstantCameraShake(t, a) {
    return ConstantCameraShake.startConstantCameraShake(t), ConstantCameraShake.addType(t, a), ConstantCameraShake.endConstantCameraShake(t)
  }
}
