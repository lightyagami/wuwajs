...
class ActorLookAtPositionData {
  ...
  static getRootAsActorLookAtPositionData(t, o) {
    return (o || new ActorLookAtPositionData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsActorLookAtPositionData(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ActorLookAtPositionData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  pos(t) {
    ...
    return o ? (t || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb_pos + o), this.bb) : void 0
  }
