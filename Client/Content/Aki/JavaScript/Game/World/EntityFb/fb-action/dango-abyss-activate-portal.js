...
class DangoAbyssActivatePortal {
  ...
  static getSizePrefixedRootAsDangoAbyssActivatePortal(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new DangoAbyssActivatePortal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createDangoAbyssActivatePortal(t) {
    return DangoAbyssActivatePortal.startDangoAbyssActivatePortal(t), DangoAbyssActivatePortal.endDangoAbyssActivatePortal(t)
  }
}
