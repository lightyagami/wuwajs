...
class MovieBackgroundFadeData {
  ...
  static getSizePrefixedRootAsMovieBackgroundFadeData(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MovieBackgroundFadeData).__init(a.readInt32(a.position()) + a.position(), a)
  }
  ...
  static createMovieBackgroundFadeData(a, t, e) {
    return MovieBackgroundFadeData.startMovieBackgroundFadeData(a), MovieBackgroundFadeData.addFadeInBackgroundType(a, t), MovieBackgroundFadeData.addFadeOutBackgroundType(a, e), MovieBackgroundFadeData.endMovieBackgroundFadeData(a)
  }
}
