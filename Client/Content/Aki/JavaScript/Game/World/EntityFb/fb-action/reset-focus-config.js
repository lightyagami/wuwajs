...
class ResetFocusConfig {
  ...
  static getSizePrefixedRootAsResetFocusConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetFocusConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  fadeInTime() {
  ...
  fadeInCurve(e) {
    ...
    return t ? (e || new base_curve_js_1.BaseCurve).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
