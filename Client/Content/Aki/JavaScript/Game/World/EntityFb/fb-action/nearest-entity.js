...
class NearestEntity {
  ...
  static getSizePrefixedRootAsNearestEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NearestEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createNearestEntity(t, e, s) {
    return NearestEntity.startNearestEntity(t), NearestEntity.addType(t, e), NearestEntity.addEntityIds(t, s), NearestEntity.endNearestEntity(t)
  }
}
