...
class HeadStyleMonsterDisplay {
  ...
  static getSizePrefixedRootAsHeadStyleMonsterDisplay(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HeadStyleMonsterDisplay).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createHeadStyleMonsterDisplay(t, e, s) {
    return HeadStyleMonsterDisplay.startHeadStyleMonsterDisplay(t), HeadStyleMonsterDisplay.addType(t, e), HeadStyleMonsterDisplay.addMonsterDisplayId(t, s), HeadStyleMonsterDisplay.endHeadStyleMonsterDisplay(t)
  }
}
