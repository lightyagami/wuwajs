...
class VehicleEntity {
  ...
  static getSizePrefixedRootAsVehicleEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VehicleEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  vehicleType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_target_vehicle_js_1.UnionTargetVehicle.NONE
  }
  vehicle(t) {
  ...
  static createVehicleEntity(t, e, i, s) {
    return VehicleEntity.startVehicleEntity(t), VehicleEntity.addType(t, e), VehicleEntity.addVehicleType(t, i), VehicleEntity.addVehicle(t, s), VehicleEntity.endVehicleEntity(t)
  }
}
