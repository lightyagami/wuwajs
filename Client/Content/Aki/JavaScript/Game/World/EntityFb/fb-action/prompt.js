...
class Prompt {
  ...
  static getSizePrefixedRootAsPrompt(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new Prompt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  generalTextId() {
  ...
  static createPrompt(t, r) {
    return Prompt.startPrompt(t), Prompt.addGeneralTextId(t, r), Prompt.endPrompt(t)
  }
}
