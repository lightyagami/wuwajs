...
class CameraTransition {
  ...
  static getSizePrefixedRootAsCameraTransition(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CameraTransition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCameraTransition(t, a, r) {
    return CameraTransition.startCameraTransition(t), CameraTransition.addType(t, a), CameraTransition.addDuration(t, r), CameraTransition.endCameraTransition(t)
  }
}
