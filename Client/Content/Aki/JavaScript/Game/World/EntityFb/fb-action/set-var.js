...
class SetVar {
  ...
  static getSizePrefixedRootAsSetVar(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new SetVar).__init(t.readInt32(t.position()) + t.position(), t)
  }
  varLeftType() {
  ...
  static createSetVar(t, r, e, a, s) {
    return SetVar.startSetVar(t), SetVar.addVarLeftType(t, r), SetVar.addVarLeft(t, e), SetVar.addVarRightType(t, a), SetVar.addVarRight(t, s), SetVar.endSetVar(t)
  }
}
