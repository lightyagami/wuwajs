...
class VehicleEnter {
  ...
  static getSizePrefixedRootAsVehicleEnter(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleEnter).__init(e.readInt32(e.position()) + e.position(), e)
  }
  enteringTargetType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_vehicle_entering_target_js_1.UnionVehicleEnteringTarget.NONE
  }
  enteringTarget(e) {
  ...
  static createVehicleEnter(e, t, i, r) {
    return VehicleEnter.startVehicleEnter(e), VehicleEnter.addEnteringTargetType(e, t), VehicleEnter.addEnteringTarget(e, i), VehicleEnter.addSeat(e, r), VehicleEnter.endVehicleEnter(e)
  }
}
