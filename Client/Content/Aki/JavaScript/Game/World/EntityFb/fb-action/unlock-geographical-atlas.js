...
class UnlockGeographicalAtlas {
  ...
  static getSizePrefixedRootAsUnlockGeographicalAtlas(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new UnlockGeographicalAtlas).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUnlockGeographicalAtlas(t, a, s) {
    return UnlockGeographicalAtlas.startUnlockGeographicalAtlas(t), UnlockGeographicalAtlas.addType(t, a), UnlockGeographicalAtlas.addId(t, s), UnlockGeographicalAtlas.endUnlockGeographicalAtlas(t)
  }
}
