...
class FlowInfo {
  ...
  static getSizePrefixedRootAsFlowInfo(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FlowInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  objType(t) {
  ...
  varContextType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_var_context_js_1.UnionVarContext.NONE
  }
  varContext(t) {
  ...
  states(t, e) {
    ...
    return s ? (e || new state_info_js_1.StateInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  statesLength() {
  ...
  static createFlowInfo(t, e, s, i, r, n, o, a, h, c, f, d) {
    return FlowInfo.startFlowInfo(t), FlowInfo.addObjType(t, e), FlowInfo.addChildren(t, s), FlowInfo.addReference(t, i), FlowInfo.addWeakReference(t, r), FlowInfo.addId(t, n), FlowInfo.addName(t, o), FlowInfo.addDungeonId(t, a), FlowInfo.addFolded(t, h), FlowInfo.addVarContextType(t, c), FlowInfo.addVarContext(t, f), FlowInfo.addStates(t, d), FlowInfo.endFlowInfo(t)
  }
}
