...
class UnlockSystemItem {
  ...
  static getSizePrefixedRootAsUnlockSystemItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UnlockSystemItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  systemOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_unlock_system_option_js_1.UnionUnlockSystemOption.NONE
  }
  systemOption(t) {
  ...
  static createUnlockSystemItem(t, e, s) {
    return UnlockSystemItem.startUnlockSystemItem(t), UnlockSystemItem.addSystemOptionType(t, e), UnlockSystemItem.addSystemOption(t, s), UnlockSystemItem.endUnlockSystemItem(t)
  }
}
