...
class VehicleExitPlayer {
  ...
  static getSizePrefixedRootAsVehicleExitPlayer(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleExitPlayer).__init(e.readInt32(e.position()) + e.position(), e)
  }
  destroyVehicle() {
  ...
  exitTypeType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_exit_vehicle_type_js_1.UnionExitVehicleType.NONE
  }
  exitType(e) {
  ...
  static createVehicleExitPlayer(e, t, i, r) {
    return VehicleExitPlayer.startVehicleExitPlayer(e), VehicleExitPlayer.addDestroyVehicle(e, t), VehicleExitPlayer.addExitTypeType(e, i), VehicleExitPlayer.addExitType(e, r), VehicleExitPlayer.endVehicleExitPlayer(e)
  }
}
