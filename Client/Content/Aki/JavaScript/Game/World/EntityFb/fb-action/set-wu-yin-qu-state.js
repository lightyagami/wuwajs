...
class SetWuYinQuState {
  ...
  static getSizePrefixedRootAsSetWuYinQuState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetWuYinQuState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  wuYinQuName(t) {
  ...
  static createSetWuYinQuState(t, e, u) {
    return SetWuYinQuState.startSetWuYinQuState(t), SetWuYinQuState.addWuYinQuName(t, e), SetWuYinQuState.addState(t, u), SetWuYinQuState.endSetWuYinQuState(t)
  }
}
