...
class SetMoveSpeed {
  ...
  static getSizePrefixedRootAsSetMoveSpeed(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetMoveSpeed).__init(e.readInt32(e.position()) + e.position(), e)
  }
  speed() {
  ...
  static createSetMoveSpeed(e, t) {
    return SetMoveSpeed.startSetMoveSpeed(e), SetMoveSpeed.addSpeed(e, t), SetMoveSpeed.endSetMoveSpeed(e)
  }
}
