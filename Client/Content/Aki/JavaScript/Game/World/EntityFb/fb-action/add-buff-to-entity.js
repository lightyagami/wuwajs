...
class AddBuffToEntity {
  ...
  static getSizePrefixedRootAsAddBuffToEntity(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AddBuffToEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  buffIds(t) {
    ...
    return s ? this.bb.readInt64(this.bb.__vector(this.bb_pos + s) + 8 * t) : BigInt(0)
  }
  buffIdsLength() {
  ...
  static createAddBuffToEntity(t, s, i, r, f) {
    return AddBuffToEntity.startAddBuffToEntity(t), AddBuffToEntity.addEntityId(t, s), AddBuffToEntity.addEntityIds(t, i), AddBuffToEntity.addBuffIds(t, r), AddBuffToEntity.addPersistOnOfflineBuffIds(t, f), AddBuffToEntity.endAddBuffToEntity(t)
  }
}
