...
class EnableTemporaryTeleport {
  ...
  static getRootAsEnableTemporaryTeleport(e, t) {
    return (t || new EnableTemporaryTeleport).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsEnableTemporaryTeleport(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableTemporaryTeleport).__init(e.readInt32(e.position()) + e.position(), e)
  }
  enable() {
  ...
  static createEnableTemporaryTeleport(e, t, r) {
    return EnableTemporaryTeleport.startEnableTemporaryTeleport(e), EnableTemporaryTeleport.addEnable(e, t), EnableTemporaryTeleport.addRangeEntity(e, r), EnableTemporaryTeleport.endEnableTemporaryTeleport(e)
  }
}
