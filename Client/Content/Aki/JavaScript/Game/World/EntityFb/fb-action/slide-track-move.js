...
class SlideTrackMove {
  ...
  static getSizePrefixedRootAsSlideTrackMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SlideTrackMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSlideTrackMove(t, e, i, r, s, a, c) {
    return SlideTrackMove.startSlideTrackMove(t), SlideTrackMove.addType(t, e), SlideTrackMove.addMaxOffsetDistance(t, i), SlideTrackMove.addIsOneWay(t, r), SlideTrackMove.addLayerVerticalLimit(t, s), SlideTrackMove.addDirectionAngleLimit(t, a), SlideTrackMove.addEdgeLimitCurveFactor(t, c), SlideTrackMove.endSlideTrackMove(t)
  }
}
