...
class PreloadSubLevels {
  ...
  static getSizePrefixedRootAsPreloadSubLevels(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PreloadSubLevels).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createPreloadSubLevels(e, t, s) {
    return PreloadSubLevels.startPreloadSubLevels(e), PreloadSubLevels.addType(e, t), PreloadSubLevels.addPreloadLevels(e, s), PreloadSubLevels.endPreloadSubLevels(e)
  }
}
