...
class ActorTurnToPlayerData {
  ...
  static getSizePrefixedRootAsActorTurnToPlayerData(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorTurnToPlayerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorTurnToPlayerData(t, r) {
    return ActorTurnToPlayerData.startActorTurnToPlayerData(t), ActorTurnToPlayerData.addType(t, r), ActorTurnToPlayerData.endActorTurnToPlayerData(t)
  }
}
