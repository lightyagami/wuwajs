...
exports.AdjustAxisLockCamera = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const axis_lock_screen_config_js_1 = require("../fb-action/axis-lock-screen-config.js");
...
class AdjustAxisLockCamera {
  ...
  screenConfig(t) {
    ...
    if (i) {
      return (t || new axis_lock_screen_config_js_1.AxisLockScreenConfig()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
