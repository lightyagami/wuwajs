...
class AdjustAxisLockCamera {
  ...
  static getRootAsAdjustAxisLockCamera(t, i) {
    return (i || new AdjustAxisLockCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdjustAxisLockCamera(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AdjustAxisLockCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  screenConfig(t) {
    ...
    return i ? (t || new axis_lock_screen_config_js_1.AxisLockScreenConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
