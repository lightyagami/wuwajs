...
class AddPlayBubble {
  ...
  static getRootAsAddPlayBubble(t, s) {
    return (s || new AddPlayBubble).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAddPlayBubble(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AddPlayBubble).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  flow(t) {
    ...
    return s ? (t || new bubble_index_js_1.BubbleIndex).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  waitTime() {
