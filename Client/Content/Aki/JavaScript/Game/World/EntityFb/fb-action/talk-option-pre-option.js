...
class TalkOptionPreOption {
  ...
  static getSizePrefixedRootAsTalkOptionPreOption(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TalkOptionPreOption).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTalkOptionPreOption(t, i, r) {
    return TalkOptionPreOption.startTalkOptionPreOption(t), TalkOptionPreOption.addType(t, i), TalkOptionPreOption.addPreOptions(t, r), TalkOptionPreOption.endTalkOptionPreOption(t)
  }
}
