...
class MontageAsset {
  ...
  static getSizePrefixedRootAsMontageAsset(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new MontageAsset).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createMontageAsset(t, s, e) {
    return MontageAsset.startMontageAsset(t), MontageAsset.addType(t, s), MontageAsset.addAsset(t, e), MontageAsset.endMontageAsset(t)
  }
}
