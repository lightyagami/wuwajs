...
class ActorLookAtOtherActor {
  ...
  static getSizePrefixedRootAsActorLookAtOtherActor(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorLookAtOtherActor).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtOtherActor(t, r, o, e) {
    return ActorLookAtOtherActor.startActorLookAtOtherActor(t), ActorLookAtOtherActor.addType(t, r), ActorLookAtOtherActor.addLock(t, o), ActorLookAtOtherActor.addActorIndex(t, e), ActorLookAtOtherActor.endActorLookAtOtherActor(t)
  }
}
