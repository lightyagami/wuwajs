...
class BubbleIndex {
  ...
  static getSizePrefixedRootAsBubbleIndex(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BubbleIndex).__init(t.readInt32(t.position()) + t.position(), t)
  }
  flowListName(t) {
  ...
  static createBubbleIndex(t, e, s, i) {
    return BubbleIndex.startBubbleIndex(t), BubbleIndex.addFlowListName(t, e), BubbleIndex.addFlowId(t, s), BubbleIndex.addStateId(t, i), BubbleIndex.endBubbleIndex(t)
  }
}
