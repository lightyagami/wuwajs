...
class SequenceFrameEvent {
  ...
  static getSizePrefixedRootAsSequenceFrameEvent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SequenceFrameEvent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  eventKey(e) {
  ...
  eventActions(e, t) {
    ...
    return n ? (t || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * e), this.bb) : void 0
  }
  eventActionsLength() {
  ...
  static createSequenceFrameEvent(e, t, n) {
    return SequenceFrameEvent.startSequenceFrameEvent(e), SequenceFrameEvent.addEventKey(e, t), SequenceFrameEvent.addEventActions(e, n), SequenceFrameEvent.endSequenceFrameEvent(e)
  }
}
