...
class FireBullet {
  ...
  static getSizePrefixedRootAsFireBullet(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FireBullet).__init(t.readInt32(t.position()) + t.position(), t)
  }
  typeType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_fire_bullet_js_1.UnionFireBullet.NONE
  }
  type(t) {
  ...
  static createFireBullet(t, e, i) {
    return FireBullet.startFireBullet(t), FireBullet.addTypeType(t, e), FireBullet.addType(t, i), FireBullet.endFireBullet(t)
  }
}
