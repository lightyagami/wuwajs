...
class DisableCameraOperation {
  ...
  static getSizePrefixedRootAsDisableCameraOperation(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new DisableCameraOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createDisableCameraOperation(e, a) {
    return DisableCameraOperation.startDisableCameraOperation(e), DisableCameraOperation.addType(e, a), DisableCameraOperation.endDisableCameraOperation(e)
  }
}
