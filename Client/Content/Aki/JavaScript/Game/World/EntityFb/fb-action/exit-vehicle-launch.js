...
class ExitVehicleLaunch {
  ...
  static getSizePrefixedRootAsExitVehicleLaunch(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExitVehicleLaunch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createExitVehicleLaunch(t, e) {
    return ExitVehicleLaunch.startExitVehicleLaunch(t), ExitVehicleLaunch.addType(t, e), ExitVehicleLaunch.endExitVehicleLaunch(t)
  }
}
