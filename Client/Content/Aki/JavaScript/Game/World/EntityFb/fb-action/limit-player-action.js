...
class LimitPlayerAction {
  ...
  static getSizePrefixedRootAsLimitPlayerAction(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LimitPlayerAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createLimitPlayerAction(t, i) {
    return LimitPlayerAction.startLimitPlayerAction(t), LimitPlayerAction.addType(t, i), LimitPlayerAction.endLimitPlayerAction(t)
  }
}
