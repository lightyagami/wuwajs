...
class HeadStyleWarning {
  ...
  static getSizePrefixedRootAsHeadStyleWarning(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HeadStyleWarning).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createHeadStyleWarning(t, e) {
    return HeadStyleWarning.startHeadStyleWarning(t), HeadStyleWarning.addType(t, e), HeadStyleWarning.endHeadStyleWarning(t)
  }
}
