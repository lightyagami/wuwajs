...
class SafePos {
  ...
  static getSizePrefixedRootAsSafePos(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SafePos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createSafePos(t, e) {
    return SafePos.startSafePos(t), SafePos.addType(t, e), SafePos.endSafePos(t)
  }
}
