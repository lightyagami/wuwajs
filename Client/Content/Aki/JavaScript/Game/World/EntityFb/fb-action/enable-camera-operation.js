...
class EnableCameraOperation {
  ...
  static getSizePrefixedRootAsEnableCameraOperation(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new EnableCameraOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnableCameraOperation(e, a) {
    return EnableCameraOperation.startEnableCameraOperation(e), EnableCameraOperation.addType(e, a), EnableCameraOperation.endEnableCameraOperation(e)
  }
}
