...
class SetNumberVar {
  ...
  static getSizePrefixedRootAsSetNumberVar(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetNumberVar).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  static createSetNumberVar(t, e, r, a) {
    return SetNumberVar.startSetNumberVar(t), SetNumberVar.addName(t, e), SetNumberVar.addValueType(t, r), SetNumberVar.addValue(t, a), SetNumberVar.endSetNumberVar(t)
  }
}
