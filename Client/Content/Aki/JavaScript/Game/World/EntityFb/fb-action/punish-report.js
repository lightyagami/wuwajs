...
class PunishReport {
  ...
  static getSizePrefixedRootAsPunishReport(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PunishReport).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createPunishReport(t, s, e, i) {
    return PunishReport.startPunishReport(t), PunishReport.addType(t, s), PunishReport.addMainText(t, e), PunishReport.addSubText(t, i), PunishReport.endPunishReport(t)
  }
}
