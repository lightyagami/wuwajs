...
class HideGroup {
  ...
  static getSizePrefixedRootAsHideGroup(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new HideGroup).__init(i.readInt32(i.position()) + i.position(), i)
  }
  groupKey(i) {
  ...
  hideConfigType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_hide_group_config_js_1.UnionHideGroupConfig.NONE
  }
  hideConfig(i) {
  ...
  static createHideGroup(i, t, e, r, s) {
    return HideGroup.startHideGroup(i), HideGroup.addGroupKey(i, t), HideGroup.addHideConfigType(i, e), HideGroup.addHideConfig(i, r), HideGroup.addIsHidePasserByNpc(i, s), HideGroup.endHideGroup(i)
  }
}
