...
class TextStyle {
  ...
  static getSizePrefixedRootAsTextStyle(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TextStyle).__init(t.readInt32(t.position()) + t.position(), t)
  }
  showAnimType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_center_text_show_anim_js_1.UnionCenterTextShowAnim.NONE
  }
  showAnim(t) {
  ...
  static createTextStyle(t, e, i, s, r, n) {
    return TextStyle.startTextStyle(t), TextStyle.addShowAnimType(t, e), TextStyle.addShowAnim(t, i), TextStyle.addFontSize(t, s), TextStyle.addTextAlign(t, r), TextStyle.addTextHorizontal(t, n), TextStyle.endTextStyle(t)
  }
}
