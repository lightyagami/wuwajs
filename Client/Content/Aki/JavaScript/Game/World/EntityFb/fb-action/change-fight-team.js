...
class ChangeFightTeam {
  ...
  static getSizePrefixedRootAsChangeFightTeam(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeFightTeam).__init(t.readInt32(t.position()) + t.position(), t)
  }
  teamIndex() {
  ...
  static createChangeFightTeam(t, e) {
    return ChangeFightTeam.startChangeFightTeam(t), ChangeFightTeam.addTeamIndex(t, e), ChangeFightTeam.endChangeFightTeam(t)
  }
}
