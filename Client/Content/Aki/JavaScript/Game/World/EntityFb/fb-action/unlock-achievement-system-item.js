...
class UnlockAchievementSystemItem {
  ...
  static getSizePrefixedRootAsUnlockAchievementSystemItem(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new UnlockAchievementSystemItem).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createUnlockAchievementSystemItem(e, t, s) {
    return UnlockAchievementSystemItem.startUnlockAchievementSystemItem(e), UnlockAchievementSystemItem.addType(e, t), UnlockAchievementSystemItem.addId(e, s), UnlockAchievementSystemItem.endUnlockAchievementSystemItem(e)
  }
}
