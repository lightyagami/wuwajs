...
class RandomVar {
  ...
  static getSizePrefixedRootAsRandomVar(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new RandomVar).__init(t.readInt32(t.position()) + t.position(), t)
  }
  leftVarType() {
  ...
  static createRandomVar(t, r, a, s, i, e, n) {
    return RandomVar.startRandomVar(t), RandomVar.addLeftVarType(t, r), RandomVar.addLeftVar(t, a), RandomVar.addRightVarType(t, s), RandomVar.addRightVar(t, i), RandomVar.addResultType(t, e), RandomVar.addResult(t, n), RandomVar.endRandomVar(t)
  }
}
