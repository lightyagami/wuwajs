...
class AddBuffToTriggeredEntity {
  ...
  static getSizePrefixedRootAsAddBuffToTriggeredEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AddBuffToTriggeredEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  buffIds(t) {
  ...
  static createAddBuffToTriggeredEntity(t, e) {
    return AddBuffToTriggeredEntity.startAddBuffToTriggeredEntity(t), AddBuffToTriggeredEntity.addBuffIds(t, e), AddBuffToTriggeredEntity.endAddBuffToTriggeredEntity(t)
  }
}
