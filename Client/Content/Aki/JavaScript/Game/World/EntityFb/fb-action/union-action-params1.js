...
exports.unionListToUnionActionParams1 = exports.unionToUnionActionParams1 = exports.UnionActionParams1 = undefined;
const exec_resurrection_js_1 = require("../fb-action/exec-resurrection.js");
const exec_risk_harvest_effect_js_1 = require("../fb-action/exec-risk-harvest-effect.js");
const hide_group_js_1 = require("../fb-action/hide-group.js");
const hide_specific_entities_js_1 = require("../fb-action/hide-specific-entities.js");
const hide_target_range_js_1 = require("../fb-action/hide-target-range.js");
const mowing_tower_goto_next_floor_js_1 = require("../fb-action/mowing-tower-goto-next-floor.js");
const open_system_board_with_return_js_1 = require("../fb-action/open-system-board-with-return.js");
const performer_ai_move_to_js_1 = require("../fb-action/performer-ai-move-to.js");
const performer_ai_spline_move_js_1 = require("../fb-action/performer-ai-spline-move.js");
const set_audio_state_js_1 = require("../fb-action/set-audio-state.js");
const setup_morale_system_js_1 = require("../fb-action/setup-morale-system.js");
const show_hided_group_js_1 = require("../fb-action/show-hided-group.js");
const show_specific_entities_js_1 = require("../fb-action/show-specific-entities.js");
const show_target_range_js_1 = require("../fb-action/show-target-range.js");
const slash_and_tower_goto_next_floor_js_1 = require("../fb-action/slash-and-tower-goto-next-floor.js");
const summon_entity_js_1 = require("../fb-action/summon-entity.js");
...
function unionToUnionActionParams1(e, r) {
  switch (UnionActionParams1[e]) {
    ...
    case "OpenSystemBoardWithReturn":
      return r(new open_system_board_with_return_js_1.OpenSystemBoardWithReturn());
    case "ExecRiskHarvestEffect":
      return r(new exec_risk_harvest_effect_js_1.ExecRiskHarvestEffect());
    case "MowingTowerGotoNextFloor":
      return r(new mowing_tower_goto_next_floor_js_1.MowingTowerGotoNextFloor());
    case "SlashAndTowerGotoNextFloor":
      return r(new slash_and_tower_goto_next_floor_js_1.SlashAndTowerGotoNextFloor());
    case "SummonEntity":
...
function unionListToUnionActionParams1(e, r, t) {
  switch (UnionActionParams1[e]) {
    ...
    case "OpenSystemBoardWithReturn":
      return r(t, new open_system_board_with_return_js_1.OpenSystemBoardWithReturn());
    case "ExecRiskHarvestEffect":
      return r(t, new exec_risk_harvest_effect_js_1.ExecRiskHarvestEffect());
    case "MowingTowerGotoNextFloor":
      return r(t, new mowing_tower_goto_next_floor_js_1.MowingTowerGotoNextFloor());
    case "SlashAndTowerGotoNextFloor":
      return r(t, new slash_and_tower_goto_next_floor_js_1.SlashAndTowerGotoNextFloor());
    case "SummonEntity":
...
})(UnionActionParams1 = exports.UnionActionParams1 ||= {});
exports.unionToUnionActionParams1 = unionToUnionActionParams1;
exports.unionListToUnionActionParams1 = unionListToUnionActionParams1; //# sourceMappingURL=union-action-params1.js.map