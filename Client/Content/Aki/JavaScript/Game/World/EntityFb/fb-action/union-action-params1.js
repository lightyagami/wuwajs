...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionActionParams1 = exports.unionToUnionActionParams1 = exports.UnionActionParams1 = void 0;
...
function unionListToUnionActionParams1(e, r, t) {
  ...
  e[e.NONE = 0] = "NONE", e[e.SetAudioState = 1] = "SetAudioState", e[e.PerformerAiSplineMove = 2] = "PerformerAiSplineMove", e[e.PerformerAiMoveTo = 3] = "PerformerAiMoveTo", e[e.HideTargetRange = 4] = "HideTargetRange", e[e.ShowTargetRange = 5] = "ShowTargetRange", e[e.HideSpecificEntities = 6] = "HideSpecificEntities", e[e.ShowSpecificEntities = 7] = "ShowSpecificEntities", e[e.HideGroup = 8] = "HideGroup", e[e.ShowHidedGroup = 9] = "ShowHidedGroup", e[e.ExecResurrection = 10] = "ExecResurrection", e[e.OpenSystemBoardWithReturn = 11] = "OpenSystemBoardWithReturn", e[e.ExecRiskHarvestEffect = 12] = "ExecRiskHarvestEffect", e[e.MowingTowerGotoNextFloor = 13] = "MowingTowerGotoNextFloor", e[e.SlashAndTowerGotoNextFloor = 14] = "SlashAndTowerGotoNextFloor", e[e.SummonEntity = 15] = "SummonEntity", e[e.SetupMoraleSystem = 16] = "SetupMoraleSystem"
}(UnionActionParams1 = exports.UnionActionParams1 || (exports.UnionActionParams1 = {})), exports.unionToUnionActionParams1 = unionToUnionActionParams1, exports.unionListToUnionActionParams1 = unionListToUnionActionParams1;
