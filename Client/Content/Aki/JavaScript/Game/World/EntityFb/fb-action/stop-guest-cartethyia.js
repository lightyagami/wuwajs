...
class StopGuestCartethyia {
  ...
  static getSizePrefixedRootAsStopGuestCartethyia(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopGuestCartethyia).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStopGuestCartethyia(t, e) {
    return StopGuestCartethyia.startStopGuestCartethyia(t), StopGuestCartethyia.addType(t, e), StopGuestCartethyia.endStopGuestCartethyia(t)
  }
}
