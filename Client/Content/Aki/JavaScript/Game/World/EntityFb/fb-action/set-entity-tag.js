...
class SetEntityTag {
  ...
  static getSizePrefixedRootAsSetEntityTag(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetEntityTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createSetEntityTag(t, i, e, s, a, r) {
    return SetEntityTag.startSetEntityTag(t), SetEntityTag.addEntityId(t, i), SetEntityTag.addGameplayTag(t, e), SetEntityTag.addSetType(t, s), SetEntityTag.addDelayTime(t, a), SetEntityTag.addBeforeHide(t, r), SetEntityTag.endSetEntityTag(t)
  }
}
