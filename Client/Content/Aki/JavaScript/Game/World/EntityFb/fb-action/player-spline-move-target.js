...
class PlayerSplineMoveTarget {
  ...
  static getSizePrefixedRootAsPlayerSplineMoveTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PlayerSplineMoveTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createPlayerSplineMoveTarget(e, t) {
    return PlayerSplineMoveTarget.startPlayerSplineMoveTarget(e), PlayerSplineMoveTarget.addType(e, t), PlayerSplineMoveTarget.endPlayerSplineMoveTarget(e)
  }
}
