...
class FishingRoulette {
  ...
  static getSizePrefixedRootAsFishingRoulette(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FishingRoulette).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFishingRoulette(t, e) {
    return FishingRoulette.startFishingRoulette(t), FishingRoulette.addType(t, e), FishingRoulette.endFishingRoulette(t)
  }
}
