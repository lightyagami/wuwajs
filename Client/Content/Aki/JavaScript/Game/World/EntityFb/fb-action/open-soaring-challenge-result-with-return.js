...
class OpenSoaringChallengeResultWithReturn {
  ...
  static getSizePrefixedRootAsOpenSoaringChallengeResultWithReturn(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OpenSoaringChallengeResultWithReturn).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOpenSoaringChallengeResultWithReturn(t, e, r, n, i, s, a, h, u) {
    return OpenSoaringChallengeResultWithReturn.startOpenSoaringChallengeResultWithReturn(t), OpenSoaringChallengeResultWithReturn.addType(t, e), OpenSoaringChallengeResultWithReturn.addScoreType(t, r), OpenSoaringChallengeResultWithReturn.addScore(t, n), OpenSoaringChallengeResultWithReturn.addRankS(t, i), OpenSoaringChallengeResultWithReturn.addRankA(t, s), OpenSoaringChallengeResultWithReturn.addRankB(t, a), OpenSoaringChallengeResultWithReturn.addReturnVarType(t, h), OpenSoaringChallengeResultWithReturn.addReturnVar(t, u), OpenSoaringChallengeResultWithReturn.endOpenSoaringChallengeResultWithReturn(t)
  }
}
