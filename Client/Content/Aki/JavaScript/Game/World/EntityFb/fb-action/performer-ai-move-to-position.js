...
class PerformerAiMoveToPosition {
  ...
  static getRootAsPerformerAiMoveToPosition(t, i) {
    return (i || new PerformerAiMoveToPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsPerformerAiMoveToPosition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PerformerAiMoveToPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
