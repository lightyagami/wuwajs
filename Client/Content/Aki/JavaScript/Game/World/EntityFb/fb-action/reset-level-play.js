...
class ResetLevelPlay {
  ...
  static getSizePrefixedRootAsResetLevelPlay(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetLevelPlay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createResetLevelPlay(e, t) {
    return ResetLevelPlay.startResetLevelPlay(e), ResetLevelPlay.addResetLevelPlayList(e, t), ResetLevelPlay.endResetLevelPlay(e)
  }
}
