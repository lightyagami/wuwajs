...
class SetBattleState {
  ...
  static getSizePrefixedRootAsSetBattleState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetBattleState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_state_option_js_1.UnionStateOption.NONE
  }
  stateOption(t) {
  ...
  static createSetBattleState(t, e, a) {
    return SetBattleState.startSetBattleState(t), SetBattleState.addStateOptionType(t, e), SetBattleState.addStateOption(t, a), SetBattleState.endSetBattleState(t)
  }
}
