...
class LifePointMaxStepRewardRuleItem {
  ...
  static getSizePrefixedRootAsLifePointMaxStepRewardRuleItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LifePointMaxStepRewardRuleItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  paintCount() {
  ...
  static createLifePointMaxStepRewardRuleItem(t, e, i) {
    return LifePointMaxStepRewardRuleItem.startLifePointMaxStepRewardRuleItem(t), LifePointMaxStepRewardRuleItem.addPaintCount(t, e), LifePointMaxStepRewardRuleItem.addAddStep(t, i), LifePointMaxStepRewardRuleItem.endLifePointMaxStepRewardRuleItem(t)
  }
}
