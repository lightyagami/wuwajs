...
class AdjustFixedCamera {
  ...
  static getRootAsAdjustFixedCamera(t, i) {
    return (i || new AdjustFixedCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdjustFixedCamera(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AdjustFixedCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  blendIn(t) {
    ...
    return i ? (t || new blend_function_js_1.BlendFunction).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  blendOut(t) {
