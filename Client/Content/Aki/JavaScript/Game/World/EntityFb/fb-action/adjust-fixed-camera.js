...
exports.AdjustFixedCamera = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const base_curve_js_1 = require("../fb-action/base-curve.js");
const blend_function_js_1 = require("../fb-action/blend-function.js");
...
class AdjustFixedCamera {
  ...
  blendIn(t) {
    ...
    if (i) {
      return (t || new blend_function_js_1.BlendFunction()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
