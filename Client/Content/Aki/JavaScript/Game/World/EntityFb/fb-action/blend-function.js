...
class BlendFunction {
  ...
  static getSizePrefixedRootAsBlendFunction(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new BlendFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createBlendFunction(t, n, e) {
    return BlendFunction.startBlendFunction(t), BlendFunction.addType(t, n), BlendFunction.addBlendExp(t, e), BlendFunction.endBlendFunction(t)
  }
}
