...
class ModifySceneItemAttributeTag {
  ...
  static getSizePrefixedRootAsModifySceneItemAttributeTag(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ModifySceneItemAttributeTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createModifySceneItemAttributeTag(t, e, i, r) {
    return ModifySceneItemAttributeTag.startModifySceneItemAttributeTag(t), ModifySceneItemAttributeTag.addType(t, e), ModifySceneItemAttributeTag.addIsAddTag(t, i), ModifySceneItemAttributeTag.addPerformanceTag(t, r), ModifySceneItemAttributeTag.endModifySceneItemAttributeTag(t)
  }
}
