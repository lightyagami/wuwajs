...
class SetRegionMpc {
  ...
  static getSizePrefixedRootAsSetRegionMpc(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetRegionMpc).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetRegionMpc(t, e, i) {
    return SetRegionMpc.startSetRegionMpc(t), SetRegionMpc.addType(t, e), SetRegionMpc.addRegionMpcId(t, i), SetRegionMpc.endSetRegionMpc(t)
  }
}
