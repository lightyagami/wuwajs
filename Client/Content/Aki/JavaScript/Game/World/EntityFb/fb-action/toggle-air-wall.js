...
class ToggleAirWall {
  ...
  static getSizePrefixedRootAsToggleAirWall(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ToggleAirWall).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_toggle_air_wall_js_1.UnionToggleAirWall.NONE
  }
  option(t) {
  ...
  static createToggleAirWall(t, r, e, i) {
    return ToggleAirWall.startToggleAirWall(t), ToggleAirWall.addOptionType(t, r), ToggleAirWall.addOption(t, e), ToggleAirWall.addActorRefs(t, i), ToggleAirWall.endToggleAirWall(t)
  }
}
