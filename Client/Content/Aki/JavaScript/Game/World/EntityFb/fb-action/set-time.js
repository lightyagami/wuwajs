...
class SetTime {
  ...
  static getSizePrefixedRootAsSetTime(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetTime).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetTime(t, e, i, r, s) {
    return SetTime.startSetTime(t), SetTime.addType(t, e), SetTime.addTime(t, i), SetTime.addVarForTimeType(t, r), SetTime.addVarForTime(t, s), SetTime.endSetTime(t)
  }
}
