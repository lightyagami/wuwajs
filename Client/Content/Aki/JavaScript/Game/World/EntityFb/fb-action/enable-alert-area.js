...
class EnableAlertArea {
  ...
  static getSizePrefixedRootAsEnableAlertArea(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnableAlertArea).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  autoDisableConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_disable_alert_condition_js_1.UnionDisableAlertCondition.NONE
  }
  ...
  static createEnableAlertArea(t, e, a, r, i, s) {
    return EnableAlertArea.startEnableAlertArea(t), EnableAlertArea.addType(t, e), EnableAlertArea.addAreaId(t, a), EnableAlertArea.addIsEnable(t, r), EnableAlertArea.addAutoDisableConditionType(t, i), EnableAlertArea.addAutoDisableCondition(t, s), EnableAlertArea.endEnableAlertArea(t)
  }
}
