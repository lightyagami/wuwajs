...
class RemovePreloadResourcePhantomCharacter {
  ...
  static getSizePrefixedRootAsRemovePreloadResourcePhantomCharacter(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new RemovePreloadResourcePhantomCharacter).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  delayReMoveType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_delay_remove_config_js_1.UnionDelayRemoveConfig.NONE
  }
  delayReMove(e) {
  ...
  static createRemovePreloadResourcePhantomCharacter(e, r, t, a, o) {
    return RemovePreloadResourcePhantomCharacter.startRemovePreloadResourcePhantomCharacter(e), RemovePreloadResourcePhantomCharacter.addType(e, r), RemovePreloadResourcePhantomCharacter.addId(e, t), RemovePreloadResourcePhantomCharacter.addDelayReMoveType(e, a), RemovePreloadResourcePhantomCharacter.addDelayReMove(e, o), RemovePreloadResourcePhantomCharacter.endRemovePreloadResourcePhantomCharacter(e)
  }
}
