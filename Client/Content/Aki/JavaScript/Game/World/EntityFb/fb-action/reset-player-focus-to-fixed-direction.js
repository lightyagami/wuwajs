...
class ResetPlayerFocusToFixedDirection {
  ...
  static getSizePrefixedRootAsResetPlayerFocusToFixedDirection(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetPlayerFocusToFixedDirection).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  direction(e) {
    ...
    return t ? (e || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
