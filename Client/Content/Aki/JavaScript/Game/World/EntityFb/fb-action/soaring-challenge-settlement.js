...
class SoaringChallengeSettlement {
  ...
  static getSizePrefixedRootAsSoaringChallengeSettlement(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SoaringChallengeSettlement).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSoaringChallengeSettlement(e, t) {
    return SoaringChallengeSettlement.startSoaringChallengeSettlement(e), SoaringChallengeSettlement.addType(e, t), SoaringChallengeSettlement.endSoaringChallengeSettlement(e)
  }
}
