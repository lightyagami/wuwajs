...
class UniformMotion {
  ...
  static getSizePrefixedRootAsUniformMotion(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new UniformMotion).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUniformMotion(t, i, o) {
    return UniformMotion.startUniformMotion(t), UniformMotion.addType(t, i), UniformMotion.addTime(t, o), UniformMotion.endUniformMotion(t)
  }
}
