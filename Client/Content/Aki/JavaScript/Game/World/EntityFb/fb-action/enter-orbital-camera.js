...
class EnterOrbitalCamera {
  ...
  static getSizePrefixedRootAsEnterOrbitalCamera(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EnterOrbitalCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_enter_orbital_camera_option_js_1.UnionEnterOrbitalCameraOption.NONE
  }
  option(t) {
  ...
  static createEnterOrbitalCamera(t, r, e) {
    return EnterOrbitalCamera.startEnterOrbitalCamera(t), EnterOrbitalCamera.addOptionType(t, r), EnterOrbitalCamera.addOption(t, e), EnterOrbitalCamera.endEnterOrbitalCamera(t)
  }
}
