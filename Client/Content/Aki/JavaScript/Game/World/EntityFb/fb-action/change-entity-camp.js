...
class ChangeEntityCamp {
  ...
  static getSizePrefixedRootAsChangeEntityCamp(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ChangeEntityCamp).__init(t.readInt32(t.position()) + t.position(), t)
  }
  targetEntity() {
  ...
  static createChangeEntityCamp(t, a, e) {
    return ChangeEntityCamp.startChangeEntityCamp(t), ChangeEntityCamp.addTargetEntity(t, a), ChangeEntityCamp.addCamp(t, e), ChangeEntityCamp.endChangeEntityCamp(t)
  }
}
