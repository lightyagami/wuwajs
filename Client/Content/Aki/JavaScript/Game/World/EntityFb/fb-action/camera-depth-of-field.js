...
class CameraDepthOfField {
  ...
  static getSizePrefixedRootAsCameraDepthOfField(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CameraDepthOfField).__init(t.readInt32(t.position()) + t.position(), t)
  }
  fstop() {
  ...
  static createCameraDepthOfField(t, e, a, i, r) {
    return CameraDepthOfField.startCameraDepthOfField(t), CameraDepthOfField.addFstop(t, e), CameraDepthOfField.addDistance(t, a), CameraDepthOfField.addBlurAmount(t, i), CameraDepthOfField.addBlurRadius(t, r), CameraDepthOfField.endCameraDepthOfField(t)
  }
}
