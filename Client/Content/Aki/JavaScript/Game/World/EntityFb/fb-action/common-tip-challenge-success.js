...
class CommonTipChallengeSuccess {
  ...
  static getSizePrefixedRootAsCommonTipChallengeSuccess(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CommonTipChallengeSuccess).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createCommonTipChallengeSuccess(e, s, t) {
    return CommonTipChallengeSuccess.startCommonTipChallengeSuccess(e), CommonTipChallengeSuccess.addType(e, s), CommonTipChallengeSuccess.addTidMainText(e, t), CommonTipChallengeSuccess.endCommonTipChallengeSuccess(e)
  }
}
