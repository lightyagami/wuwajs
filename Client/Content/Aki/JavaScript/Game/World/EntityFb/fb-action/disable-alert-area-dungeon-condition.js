...
class DisableAlertAreaDungeonCondition {
  ...
  static getSizePrefixedRootAsDisableAlertAreaDungeonCondition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableAlertAreaDungeonCondition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createDisableAlertAreaDungeonCondition(e, t, n) {
    return DisableAlertAreaDungeonCondition.startDisableAlertAreaDungeonCondition(e), DisableAlertAreaDungeonCondition.addType(e, t), DisableAlertAreaDungeonCondition.addRelatedDungeonId(e, n), DisableAlertAreaDungeonCondition.endDisableAlertAreaDungeonCondition(e)
  }
}
