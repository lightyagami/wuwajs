...
class HeadStyleWeakSignal {
  ...
  static getSizePrefixedRootAsHeadStyleWeakSignal(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new HeadStyleWeakSignal).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createHeadStyleWeakSignal(e, t) {
    return HeadStyleWeakSignal.startHeadStyleWeakSignal(e), HeadStyleWeakSignal.addType(e, t), HeadStyleWeakSignal.endHeadStyleWeakSignal(e)
  }
}
