...
class ClearFishingCabinInSaleItems {
  ...
  static getSizePrefixedRootAsClearFishingCabinInSaleItems(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ClearFishingCabinInSaleItems).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createClearFishingCabinInSaleItems(e) {
    return ClearFishingCabinInSaleItems.startClearFishingCabinInSaleItems(e), ClearFishingCabinInSaleItems.endClearFishingCabinInSaleItems(e)
  }
}
