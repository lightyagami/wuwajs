...
class AdjustPlayerCamera {
  ...
  static getSizePrefixedRootAsAdjustPlayerCamera(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new AdjustPlayerCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_adjust_player_camera_option_js_1.UnionAdjustPlayerCameraOption.NONE
  }
  option(t) {
  ...
  static createAdjustPlayerCamera(t, a, e) {
    return AdjustPlayerCamera.startAdjustPlayerCamera(t), AdjustPlayerCamera.addOptionType(t, a), AdjustPlayerCamera.addOption(t, e), AdjustPlayerCamera.endAdjustPlayerCamera(t)
  }
}
