...
class RemoveBuffFromPlayer {
  ...
  static getSizePrefixedRootAsRemoveBuffFromPlayer(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RemoveBuffFromPlayer).__init(e.readInt32(e.position()) + e.position(), e)
  }
  buffIds(e) {
  ...
  static createRemoveBuffFromPlayer(e, t) {
    return RemoveBuffFromPlayer.startRemoveBuffFromPlayer(e), RemoveBuffFromPlayer.addBuffIds(e, t), RemoveBuffFromPlayer.endRemoveBuffFromPlayer(e)
  }
}
