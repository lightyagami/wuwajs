...
class CommonTipFirstComplete {
  ...
  static getSizePrefixedRootAsCommonTipFirstComplete(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CommonTipFirstComplete).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCommonTipFirstComplete(t, e, i) {
    return CommonTipFirstComplete.startCommonTipFirstComplete(t), CommonTipFirstComplete.addType(t, e), CommonTipFirstComplete.addTidText(t, i), CommonTipFirstComplete.endCommonTipFirstComplete(t)
  }
}
