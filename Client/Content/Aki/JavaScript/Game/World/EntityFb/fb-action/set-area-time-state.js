...
class SetAreaTimeState {
  ...
  static getSizePrefixedRootAsSetAreaTimeState(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetAreaTimeState).__init(e.readInt32(e.position()) + e.position(), e)
  }
  setAreaTimeConfigType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_set_area_time_type_js_1.UnionSetAreaTimeType.NONE
  }
  setAreaTimeConfig(e) {
  ...
  static createSetAreaTimeState(e, t, i) {
    return SetAreaTimeState.startSetAreaTimeState(e), SetAreaTimeState.addSetAreaTimeConfigType(e, t), SetAreaTimeState.addSetAreaTimeConfig(e, i), SetAreaTimeState.endSetAreaTimeState(e)
  }
}
