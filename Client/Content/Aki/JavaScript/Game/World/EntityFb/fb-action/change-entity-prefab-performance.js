...
class ChangeEntityPrefabPerformance {
  ...
  static getRootAsChangeEntityPrefabPerformance(e, t) {
    return (t || new ChangeEntityPrefabPerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsChangeEntityPrefabPerformance(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ChangeEntityPrefabPerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createChangeEntityPrefabPerformance(e, t) {
    return ChangeEntityPrefabPerformance.startChangeEntityPrefabPerformance(e), ChangeEntityPrefabPerformance.addType(e, t), ChangeEntityPrefabPerformance.endChangeEntityPrefabPerformance(e)
  }
}
