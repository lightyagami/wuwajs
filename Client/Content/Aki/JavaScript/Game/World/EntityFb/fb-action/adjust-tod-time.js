...
class AdjustTodTime {
  ...
  static getSizePrefixedRootAsAdjustTodTime(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AdjustTodTime).__init(t.readInt32(t.position()) + t.position(), t)
  }
  hour() {
  ...
  static createAdjustTodTime(t, s, i, e) {
    return AdjustTodTime.startAdjustTodTime(t), AdjustTodTime.addHour(t, s), AdjustTodTime.addMin(t, i), AdjustTodTime.addShowUi(t, e), AdjustTodTime.endAdjustTodTime(t)
  }
}
