...
class GetItem {
  ...
  static getSizePrefixedRootAsGetItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GetItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  items(t, e) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (e || new item_data_js_1.ItemData).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  itemsLength() {
  ...
  uiConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_item_get_ui_config_js_1.UnionItemGetUiConfig.NONE
  }
  uiConfig(t) {
  ...
  static createGetItem(t, e, i, s, r) {
    return GetItem.startGetItem(t), GetItem.addItems(t, e), GetItem.addUiType(t, i), GetItem.addUiConfigType(t, s), GetItem.addUiConfig(t, r), GetItem.endGetItem(t)
  }
}
