...
class ChangeLiftTarget {
  ...
  static getSizePrefixedRootAsChangeLiftTarget(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeLiftTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isSelf() {
  ...
  static createChangeLiftTarget(t, e, i, a) {
    return ChangeLiftTarget.startChangeLiftTarget(t), ChangeLiftTarget.addIsSelf(t, e), ChangeLiftTarget.addEntityId(t, i), ChangeLiftTarget.addLocation(t, a), ChangeLiftTarget.endChangeLiftTarget(t)
  }
}
