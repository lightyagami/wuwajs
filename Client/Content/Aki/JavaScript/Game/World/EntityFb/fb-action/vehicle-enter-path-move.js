...
class VehicleEnterPathMove {
  ...
  static getSizePrefixedRootAsVehicleEnterPathMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VehicleEnterPathMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  controlParams(t) {
    ...
    return e ? (t || new vehicle_cruising_params_js_1.VehicleCruisingParams).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  patternType() {
