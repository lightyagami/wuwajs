...
class ChangeEntityStateDirectly {
  ...
  static getSizePrefixedRootAsChangeEntityStateDirectly(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeEntityStateDirectly).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChangeEntityStateDirectly(t, e, i, a, r) {
    return ChangeEntityStateDirectly.startChangeEntityStateDirectly(t), ChangeEntityStateDirectly.addType(t, e), ChangeEntityStateDirectly.addEntityId(t, i), ChangeEntityStateDirectly.addState(t, a), ChangeEntityStateDirectly.addDelayChange(t, r), ChangeEntityStateDirectly.endChangeEntityStateDirectly(t)
  }
}
