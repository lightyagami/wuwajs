...
class CloseFlowTemplate {
  ...
  static getRootAsCloseFlowTemplate(t, e) {
    return (e || new CloseFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCloseFlowTemplate(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CloseFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isResetPosition() {
  ...
  endState(t) {
    ...
    return e ? (t || new end_state_js_1.EndState).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
