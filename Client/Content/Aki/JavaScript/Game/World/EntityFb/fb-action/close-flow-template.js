...
exports.CloseFlowTemplate = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const end_state_js_1 = require("../fb-action/end-state.js");
class CloseFlowTemplate {
  ...
  endState(t) {
    ...
    if (e) {
      return (t || new end_state_js_1.EndState()).__init(this.bb.__indirect(this.bb_pos + e), this.bb);
    } else {
      return undefined;
    }
  }
