...
class VariableMotion {
  ...
  static getSizePrefixedRootAsVariableMotion(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new VariableMotion).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createVariableMotion(t, i, e, a) {
    return VariableMotion.startVariableMotion(t), VariableMotion.addType(t, i), VariableMotion.addAcceleration(t, e), VariableMotion.addMaxSpeed(t, a), VariableMotion.endVariableMotion(t)
  }
}
