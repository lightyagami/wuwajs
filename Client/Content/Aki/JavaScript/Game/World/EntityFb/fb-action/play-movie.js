...
class PlayMovie {
  ...
  static getSizePrefixedRootAsPlayMovie(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayMovie).__init(t.readInt32(t.position()) + t.position(), t)
  }
  videoName(t) {
  ...
  backgroundFade(t) {
    ...
    return e ? (t || new movie_background_fade_data_js_1.MovieBackgroundFadeData).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
