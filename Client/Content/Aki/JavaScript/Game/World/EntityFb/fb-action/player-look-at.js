...
class PlayerLookAt {
  ...
  static getSizePrefixedRootAsPlayerLookAt(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayerLookAt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  pos(t) {
  ...
  static createPlayerLookAt(t, e, r) {
    return PlayerLookAt.startPlayerLookAt(t), PlayerLookAt.addPos(t, e), PlayerLookAt.addCameraMove(t, r), PlayerLookAt.endPlayerLookAt(t)
  }
}
