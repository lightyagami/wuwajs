...
class ChangeTeamPosition {
  ...
  static getSizePrefixedRootAsChangeTeamPosition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeTeamPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  positionId() {
  ...
  static createChangeTeamPosition(t, e) {
    return ChangeTeamPosition.startChangeTeamPosition(t), ChangeTeamPosition.addPositionId(t, e), ChangeTeamPosition.endChangeTeamPosition(t)
  }
}
