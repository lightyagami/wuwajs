...
class TowerDungeonPrefabConfig {
  ...
  static getRootAsTowerDungeonPrefabConfig(e, r) {
    return (r || new TowerDungeonPrefabConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsTowerDungeonPrefabConfig(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new TowerDungeonPrefabConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createTowerDungeonPrefabConfig(e, r, t) {
    return TowerDungeonPrefabConfig.startTowerDungeonPrefabConfig(e), TowerDungeonPrefabConfig.addType(e, r), TowerDungeonPrefabConfig.addIndex(e, t), TowerDungeonPrefabConfig.endTowerDungeonPrefabConfig(e)
  }
}
