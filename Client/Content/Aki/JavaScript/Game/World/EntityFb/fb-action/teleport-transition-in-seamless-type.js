...
class TeleportTransitionInSeamlessType {
  ...
  static getSizePrefixedRootAsTeleportTransitionInSeamlessType(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportTransitionInSeamlessType).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  floorSettings(t) {
    ...
    return e ? (t || new floor_settings_js_1.FloorSettings).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  isTeleportInPlace() {
