...
class TalkOptionRogueRandomEvent {
  ...
  static getRootAsTalkOptionRogueRandomEvent(t, e) {
    return (e || new TalkOptionRogueRandomEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsTalkOptionRogueRandomEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TalkOptionRogueRandomEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTalkOptionRogueRandomEvent(t, e, o) {
    return TalkOptionRogueRandomEvent.startTalkOptionRogueRandomEvent(t), TalkOptionRogueRandomEvent.addType(t, e), TalkOptionRogueRandomEvent.addOptionId(t, o), TalkOptionRogueRandomEvent.endTalkOptionRogueRandomEvent(t)
  }
}
