...
class ReduceTime {
  ...
  static getSizePrefixedRootAsReduceTime(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ReduceTime).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createReduceTime(e, t, i, r, s) {
    return ReduceTime.startReduceTime(e), ReduceTime.addType(e, t), ReduceTime.addTime(e, i), ReduceTime.addVarForTimeType(e, r), ReduceTime.addVarForTime(e, s), ReduceTime.endReduceTime(e)
  }
}
