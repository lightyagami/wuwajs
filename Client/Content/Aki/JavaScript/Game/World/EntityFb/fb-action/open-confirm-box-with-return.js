...
class OpenConfirmBoxWithReturn {
  ...
  static getSizePrefixedRootAsOpenConfirmBoxWithReturn(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new OpenConfirmBoxWithReturn).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOpenConfirmBoxWithReturn(t, r, e, i, n) {
    return OpenConfirmBoxWithReturn.startOpenConfirmBoxWithReturn(t), OpenConfirmBoxWithReturn.addType(t, r), OpenConfirmBoxWithReturn.addId(t, e), OpenConfirmBoxWithReturn.addReturnVarType(t, i), OpenConfirmBoxWithReturn.addReturnVar(t, n), OpenConfirmBoxWithReturn.endOpenConfirmBoxWithReturn(t)
  }
}
