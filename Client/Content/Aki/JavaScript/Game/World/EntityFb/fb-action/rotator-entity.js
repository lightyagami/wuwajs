...
class RotatorEntity {
  ...
  static getSizePrefixedRootAsRotatorEntity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RotatorEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityType() {
  ...
  static createRotatorEntity(t, i, r) {
    return RotatorEntity.startRotatorEntity(t), RotatorEntity.addEntityType(t, i), RotatorEntity.addEntity(t, r), RotatorEntity.endRotatorEntity(t)
  }
}
