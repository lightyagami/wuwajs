...
class VehicleWaterfallClimbGravityConfig {
  ...
  static getSizePrefixedRootAsVehicleWaterfallClimbGravityConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleWaterfallClimbGravityConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  ...
  static createVehicleWaterfallClimbGravityConfig(i, t, e) {
    return VehicleWaterfallClimbGravityConfig.startVehicleWaterfallClimbGravityConfig(i), VehicleWaterfallClimbGravityConfig.addSafePositionEntityId(i, t), VehicleWaterfallClimbGravityConfig.addGravityDirection(i, e), VehicleWaterfallClimbGravityConfig.endVehicleWaterfallClimbGravityConfig(i)
  }
}
