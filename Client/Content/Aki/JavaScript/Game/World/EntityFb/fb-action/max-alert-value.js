...
class MaxAlertValue {
  ...
  static getSizePrefixedRootAsMaxAlertValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MaxAlertValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createMaxAlertValue(t, e) {
    return MaxAlertValue.startMaxAlertValue(t), MaxAlertValue.addType(t, e), MaxAlertValue.endMaxAlertValue(t)
  }
}
