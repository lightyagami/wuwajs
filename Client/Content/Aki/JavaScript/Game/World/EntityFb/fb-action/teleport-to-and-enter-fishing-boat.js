...
class TeleportToAndEnterFishingBoat {
  ...
  static getSizePrefixedRootAsTeleportToAndEnterFishingBoat(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportToAndEnterFishingBoat).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportToAndEnterFishingBoat(t, e) {
    return TeleportToAndEnterFishingBoat.startTeleportToAndEnterFishingBoat(t), TeleportToAndEnterFishingBoat.addType(t, e), TeleportToAndEnterFishingBoat.endTeleportToAndEnterFishingBoat(t)
  }
}
