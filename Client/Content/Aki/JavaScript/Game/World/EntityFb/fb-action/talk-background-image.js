...
class TalkBackgroundImage {
  ...
  static getSizePrefixedRootAsTalkBackgroundImage(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TalkBackgroundImage).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createTalkBackgroundImage(a, t, e) {
    return TalkBackgroundImage.startTalkBackgroundImage(a), TalkBackgroundImage.addType(a, t), TalkBackgroundImage.addImageAsset(a, e), TalkBackgroundImage.endTalkBackgroundImage(a)
  }
}
