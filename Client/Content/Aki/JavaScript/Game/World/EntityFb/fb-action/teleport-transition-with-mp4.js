...
class TeleportTransitionWithMp4 {
  ...
  static getSizePrefixedRootAsTeleportTransitionWithMp4(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TeleportTransitionWithMp4).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  backgroundColor(t) {
    ...
    return i ? (t || new mp4_background_color_js_1.Mp4BackgroundColor).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
