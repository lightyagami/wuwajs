...
class SetEntityVisible {
  ...
  static getSizePrefixedRootAsSetEntityVisible(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetEntityVisible).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createSetEntityVisible(t, i, s) {
    return SetEntityVisible.startSetEntityVisible(t), SetEntityVisible.addEntityIds(t, i), SetEntityVisible.addVisible(t, s), SetEntityVisible.endSetEntityVisible(t)
  }
}
