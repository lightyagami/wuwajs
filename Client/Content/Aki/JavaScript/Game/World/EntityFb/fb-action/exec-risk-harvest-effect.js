...
class ExecRiskHarvestEffect {
  ...
  static getSizePrefixedRootAsExecRiskHarvestEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExecRiskHarvestEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  static createExecRiskHarvestEffect(t, e) {
    return ExecRiskHarvestEffect.startExecRiskHarvestEffect(t), ExecRiskHarvestEffect.addId(t, e), ExecRiskHarvestEffect.endExecRiskHarvestEffect(t)
  }
}
