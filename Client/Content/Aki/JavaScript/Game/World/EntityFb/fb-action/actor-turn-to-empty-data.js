...
class ActorTurnToEmptyData {
  ...
  static getSizePrefixedRootAsActorTurnToEmptyData(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorTurnToEmptyData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorTurnToEmptyData(t, r) {
    return ActorTurnToEmptyData.startActorTurnToEmptyData(t), ActorTurnToEmptyData.addType(t, r), ActorTurnToEmptyData.endActorTurnToEmptyData(t)
  }
}
