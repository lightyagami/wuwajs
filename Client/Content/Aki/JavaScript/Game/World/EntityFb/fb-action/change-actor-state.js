...
class ChangeActorState {
  ...
  static getSizePrefixedRootAsChangeActorState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeActorState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  static createChangeActorState(t, e) {
    return ChangeActorState.startChangeActorState(t), ChangeActorState.addState(t, e), ChangeActorState.endChangeActorState(t)
  }
}
