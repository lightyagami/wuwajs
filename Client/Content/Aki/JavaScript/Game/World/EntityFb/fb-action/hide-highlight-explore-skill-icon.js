...
class HideHighlightExploreSkillIcon {
  ...
  static getSizePrefixedRootAsHideHighlightExploreSkillIcon(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new HideHighlightExploreSkillIcon).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createHideHighlightExploreSkillIcon(i, t) {
    return HideHighlightExploreSkillIcon.startHideHighlightExploreSkillIcon(i), HideHighlightExploreSkillIcon.addType(i, t), HideHighlightExploreSkillIcon.endHideHighlightExploreSkillIcon(i)
  }
}
