...
class FireBulletTrackPosition {
  ...
  static getSizePrefixedRootAsFireBulletTrackPosition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FireBulletTrackPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFireBulletTrackPosition(t, i, e, r, s, n) {
    return FireBulletTrackPosition.startFireBulletTrackPosition(t), FireBulletTrackPosition.addType(t, i), FireBulletTrackPosition.addBulletId(t, e), FireBulletTrackPosition.addLauncherType(t, r), FireBulletTrackPosition.addLauncher(t, s), FireBulletTrackPosition.addPositionEntityId(t, n), FireBulletTrackPosition.endFireBulletTrackPosition(t)
  }
}
