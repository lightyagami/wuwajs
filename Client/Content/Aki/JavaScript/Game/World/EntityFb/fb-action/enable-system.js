...
class EnableSystem {
  ...
  static getSizePrefixedRootAsEnableSystem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnableSystem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  systemType() {
  ...
  static createEnableSystem(t, e, s) {
    return EnableSystem.startEnableSystem(t), EnableSystem.addSystemType(t, e), EnableSystem.addIsEnable(t, s), EnableSystem.endEnableSystem(t)
  }
}
