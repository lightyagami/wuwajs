...
class EnableSceneInteractionOperation {
  ...
  static getSizePrefixedRootAsEnableSceneInteractionOperation(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableSceneInteractionOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnableSceneInteractionOperation(e, t) {
    return EnableSceneInteractionOperation.startEnableSceneInteractionOperation(e), EnableSceneInteractionOperation.addType(e, t), EnableSceneInteractionOperation.endEnableSceneInteractionOperation(e)
  }
}
