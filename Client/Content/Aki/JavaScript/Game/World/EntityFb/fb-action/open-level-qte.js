...
class OpenLevelQte {
  ...
  static getSizePrefixedRootAsOpenLevelQte(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OpenLevelQte).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createOpenLevelQte(e, t, i, s) {
    return OpenLevelQte.startOpenLevelQte(e), OpenLevelQte.addType(e, t), OpenLevelQte.addLevelQteEntityType(e, i), OpenLevelQte.addLevelQteEntity(e, s), OpenLevelQte.endOpenLevelQte(e)
  }
}
