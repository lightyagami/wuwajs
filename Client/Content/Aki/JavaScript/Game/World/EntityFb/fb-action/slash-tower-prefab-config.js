...
class SlashTowerPrefabConfig {
  ...
  static getSizePrefixedRootAsSlashTowerPrefabConfig(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new SlashTowerPrefabConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createSlashTowerPrefabConfig(e, r, t) {
    return SlashTowerPrefabConfig.startSlashTowerPrefabConfig(e), SlashTowerPrefabConfig.addType(e, r), SlashTowerPrefabConfig.addIndex(e, t), SlashTowerPrefabConfig.endSlashTowerPrefabConfig(e)
  }
}
