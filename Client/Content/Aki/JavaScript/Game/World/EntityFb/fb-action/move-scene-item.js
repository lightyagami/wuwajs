...
class MoveSceneItem {
  ...
  static getSizePrefixedRootAsMoveSceneItem(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MoveSceneItem).__init(e.readInt32(e.position()) + e.position(), e)
  }
  entityId() {
  ...
  moveConfigType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_move_scene_item_js_1.UnionMoveSceneItem.NONE
  }
  moveConfig(e) {
  ...
  static createMoveSceneItem(e, t, s, i, n, o) {
    return MoveSceneItem.startMoveSceneItem(e), MoveSceneItem.addEntityId(e, t), MoveSceneItem.addStopBeforeMove(e, s), MoveSceneItem.addMoveConfigType(e, i), MoveSceneItem.addMoveConfig(e, n), MoveSceneItem.addBypassClientResponse(e, o), MoveSceneItem.endMoveSceneItem(e)
  }
}
