...
class ShowTalkOutline {
  ...
  static getSizePrefixedRootAsShowTalkOutline(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ShowTalkOutline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  textId() {
  ...
  static createShowTalkOutline(t, i, e, s) {
    return ShowTalkOutline.startShowTalkOutline(t), ShowTalkOutline.addTextId(t, i), ShowTalkOutline.addTidOutline(t, e), ShowTalkOutline.addPlotLineKey(t, s), ShowTalkOutline.endShowTalkOutline(t)
  }
}
