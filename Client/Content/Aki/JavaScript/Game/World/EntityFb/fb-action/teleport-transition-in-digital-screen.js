...
class TeleportTransitionInDigitalScreen {
  ...
  static getSizePrefixedRootAsTeleportTransitionInDigitalScreen(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleportTransitionInDigitalScreen).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportTransitionInDigitalScreen(t, e, i) {
    return TeleportTransitionInDigitalScreen.startTeleportTransitionInDigitalScreen(t), TeleportTransitionInDigitalScreen.addType(t, e), TeleportTransitionInDigitalScreen.addConfigId(t, i), TeleportTransitionInDigitalScreen.endTeleportTransitionInDigitalScreen(t)
  }
}
