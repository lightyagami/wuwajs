...
class SetupMoraleSystem {
  ...
  static getSizePrefixedRootAsSetupMoraleSystem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetupMoraleSystem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  moralePlayId() {
  ...
  static createSetupMoraleSystem(t, e, s) {
    return SetupMoraleSystem.startSetupMoraleSystem(t), SetupMoraleSystem.addMoralePlayId(t, e), SetupMoraleSystem.addIsOn(t, s), SetupMoraleSystem.endSetupMoraleSystem(t)
  }
}
