...
class ColorPiece {
  ...
  static getSizePrefixedRootAsColorPiece(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ColorPiece).__init(e.readInt32(e.position()) + e.position(), e)
  }
  color(e) {
  ...
  static createColorPiece(e, t) {
    return ColorPiece.startColorPiece(e), ColorPiece.addColor(e, t), ColorPiece.endColorPiece(e)
  }
}
