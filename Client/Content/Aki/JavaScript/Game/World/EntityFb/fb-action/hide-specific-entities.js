...
class HideSpecificEntities {
  ...
  static getSizePrefixedRootAsHideSpecificEntities(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HideSpecificEntities).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createHideSpecificEntities(t, i) {
    return HideSpecificEntities.startHideSpecificEntities(t), HideSpecificEntities.addEntityIds(t, i), HideSpecificEntities.endHideSpecificEntities(t)
  }
}
