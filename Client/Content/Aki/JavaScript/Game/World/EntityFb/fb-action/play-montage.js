...
class PlayMontage {
  ...
  static getSizePrefixedRootAsPlayMontage(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PlayMontage).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  actionMontage(t) {
    ...
    return i ? (t || new action_montage_js_1.ActionMontage).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  expressionMontage(t) {
