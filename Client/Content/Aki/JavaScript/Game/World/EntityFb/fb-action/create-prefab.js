...
class CreatePrefab {
  ...
  static getSizePrefixedRootAsCreatePrefab(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CreatePrefab).__init(e.readInt32(e.position()) + e.position(), e)
  }
  posEntityId() {
  ...
  configType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_prefab_config_js_1.UnionPrefabConfig.NONE
  }
  config(e) {
  ...
  static createCreatePrefab(e, t, r, a, i, s) {
    return CreatePrefab.startCreatePrefab(e), CreatePrefab.addPosEntityId(e, t), CreatePrefab.addConfigType(e, r), CreatePrefab.addConfig(e, a), CreatePrefab.addVarNameType(e, i), CreatePrefab.addVarName(e, s), CreatePrefab.endCreatePrefab(e)
  }
}
