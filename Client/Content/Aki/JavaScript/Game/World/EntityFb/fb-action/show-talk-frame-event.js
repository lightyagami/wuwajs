...
class ShowTalkFrameEvent {
  ...
  static getSizePrefixedRootAsShowTalkFrameEvent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ShowTalkFrameEvent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  frameEvent(e) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? (e || new sequence_frame_event_js_1.SequenceFrameEvent).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  position(e) {
    var t = this.bb.__offset(this.bb_pos, 6);
    return t ? (e || new show_talk_frame_event_position_js_1.ShowTalkFrameEventPosition).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
