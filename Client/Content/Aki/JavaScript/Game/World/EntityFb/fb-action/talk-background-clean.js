...
class TalkBackgroundClean {
  ...
  static getSizePrefixedRootAsTalkBackgroundClean(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TalkBackgroundClean).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createTalkBackgroundClean(a, t) {
    return TalkBackgroundClean.startTalkBackgroundClean(a), TalkBackgroundClean.addType(a, t), TalkBackgroundClean.endTalkBackgroundClean(a)
  }
}
