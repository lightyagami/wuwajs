...
class CharacterLookAtEmptyData {
  ...
  static getSizePrefixedRootAsCharacterLookAtEmptyData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CharacterLookAtEmptyData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCharacterLookAtEmptyData(t, a) {
    return CharacterLookAtEmptyData.startCharacterLookAtEmptyData(t), CharacterLookAtEmptyData.addType(t, a), CharacterLookAtEmptyData.endCharacterLookAtEmptyData(t)
  }
}
