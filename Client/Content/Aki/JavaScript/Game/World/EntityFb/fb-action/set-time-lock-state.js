...
class SetTimeLockState {
  ...
  static getSizePrefixedRootAsSetTimeLockState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetTimeLockState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  lockState(t) {
  ...
  static createSetTimeLockState(t, e) {
    return SetTimeLockState.startSetTimeLockState(t), SetTimeLockState.addLockState(t, e), SetTimeLockState.endSetTimeLockState(t)
  }
}
