...
class RemoveTrialFollowShooter {
  ...
  static getSizePrefixedRootAsRemoveTrialFollowShooter(o, e) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RemoveTrialFollowShooter).__init(o.readInt32(o.position()) + o.position(), o)
  }
  id() {
  ...
  static createRemoveTrialFollowShooter(o, e) {
    return RemoveTrialFollowShooter.startRemoveTrialFollowShooter(o), RemoveTrialFollowShooter.addId(o, e), RemoveTrialFollowShooter.endRemoveTrialFollowShooter(o)
  }
}
