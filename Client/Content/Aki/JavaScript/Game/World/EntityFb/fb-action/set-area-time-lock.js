...
class SetAreaTimeLock {
  ...
  static getSizePrefixedRootAsSetAreaTimeLock(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetAreaTimeLock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  lockTime(t) {
    ...
    return e ? (t || new fixed_time_js_1.FixedTime).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
