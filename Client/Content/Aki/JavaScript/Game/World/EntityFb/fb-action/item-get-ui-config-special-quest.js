...
class ItemGetUiConfigSpecialQuest {
  ...
  static getSizePrefixedRootAsItemGetUiConfigSpecialQuest(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ItemGetUiConfigSpecialQuest).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createItemGetUiConfigSpecialQuest(t, e, i, s) {
    return ItemGetUiConfigSpecialQuest.startItemGetUiConfigSpecialQuest(t), ItemGetUiConfigSpecialQuest.addType(t, e), ItemGetUiConfigSpecialQuest.addTitle(t, i), ItemGetUiConfigSpecialQuest.addShowDetail(t, s), ItemGetUiConfigSpecialQuest.endItemGetUiConfigSpecialQuest(t)
  }
}
