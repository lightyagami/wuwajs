...
class AwakeEntity {
  ...
  static getSizePrefixedRootAsAwakeEntity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AwakeEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  positionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_awake_pos_option_js_1.UnionAwakePosOption.NONE
  }
  position(t) {
  ...
  static createAwakeEntity(t, i, s, e, n) {
    return AwakeEntity.startAwakeEntity(t), AwakeEntity.addPositionType(t, i), AwakeEntity.addPosition(t, s), AwakeEntity.addIsSnap(t, e), AwakeEntity.addEntityIds(t, n), AwakeEntity.endAwakeEntity(t)
  }
}
