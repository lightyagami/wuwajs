...
class StopNewMoveWithSpline {
  ...
  static getSizePrefixedRootAsStopNewMoveWithSpline(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopNewMoveWithSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stopTargetType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_new_spline_move_target_js_1.UnionNewSplineMoveTarget.NONE
  }
  stopTarget(t) {
  ...
  stopTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_stop_new_move_with_spline_type_js_1.UnionStopNewMoveWithSplineType.NONE
  }
  stopType(t) {
  ...
  static createStopNewMoveWithSpline(t, e, i, o, s) {
    return StopNewMoveWithSpline.startStopNewMoveWithSpline(t), StopNewMoveWithSpline.addStopTargetType(t, e), StopNewMoveWithSpline.addStopTarget(t, i), StopNewMoveWithSpline.addStopTypeType(t, o), StopNewMoveWithSpline.addStopType(t, s), StopNewMoveWithSpline.endStopNewMoveWithSpline(t)
  }
}
