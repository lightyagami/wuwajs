...
class CameraData {
  ...
  static getSizePrefixedRootAsCameraData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CameraData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  camera(t) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (t || new flow_template_mode_js_1.FlowTemplateMode).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
  cameraAnim(t) {
    var a = this.bb.__offset(this.bb_pos, 6);
    return a ? (t || new set_camera_anim_js_1.SetCameraAnim).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
