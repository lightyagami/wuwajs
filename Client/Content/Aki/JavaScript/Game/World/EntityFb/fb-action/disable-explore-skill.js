...
class DisableExploreSkill {
  ...
  static getSizePrefixedRootAsDisableExploreSkill(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DisableExploreSkill).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createDisableExploreSkill(t, e, i, l) {
    return DisableExploreSkill.startDisableExploreSkill(t), DisableExploreSkill.addPlaceTemporaryTeleport(t, e), DisableExploreSkill.addIsComplementary(t, i), DisableExploreSkill.addExploreSkillList(t, l), DisableExploreSkill.endDisableExploreSkill(t)
  }
}
