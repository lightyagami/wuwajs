...
class ActorTurnToTalkerData {
  ...
  static getSizePrefixedRootAsActorTurnToTalkerData(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorTurnToTalkerData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorTurnToTalkerData(t, r) {
    return ActorTurnToTalkerData.startActorTurnToTalkerData(t), ActorTurnToTalkerData.addType(t, r), ActorTurnToTalkerData.endActorTurnToTalkerData(t)
  }
}
