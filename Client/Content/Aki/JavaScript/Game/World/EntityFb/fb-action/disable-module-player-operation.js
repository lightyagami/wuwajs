...
class DisableModulePlayerOperation {
  ...
  static getSizePrefixedRootAsDisableModulePlayerOperation(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DisableModulePlayerOperation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  moveOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_move_operation_js_1.UnionMoveOperation.NONE
  }
  moveOption(i) {
  ...
  skillOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_skill_operation_js_1.UnionSkillOperation.NONE
  }
  skillOption(i) {
  ...
  cameraOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_camera_operation_js_1.UnionCameraOperation.NONE
  }
  cameraOption(i) {
  ...
  uiOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_ui_operation_js_1.UnionUiOperation.NONE
  }
  uiOption(i) {
  ...
  sceneInteractionOptionType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_scene_interaction_operation_js_1.UnionSceneInteractionOperation.NONE
  }
  ...
  static createDisableModulePlayerOperation(i, e, t, o, a, n, r, s, l, u, p, _) {
    return DisableModulePlayerOperation.startDisableModulePlayerOperation(i), DisableModulePlayerOperation.addType(i, e), DisableModulePlayerOperation.addMoveOptionType(i, t), DisableModulePlayerOperation.addMoveOption(i, o), DisableModulePlayerOperation.addSkillOptionType(i, a), DisableModulePlayerOperation.addSkillOption(i, n), DisableModulePlayerOperation.addCameraOptionType(i, r), DisableModulePlayerOperation.addCameraOption(i, s), DisableModulePlayerOperation.addUiOptionType(i, l), DisableModulePlayerOperation.addUiOption(i, u), DisableModulePlayerOperation.addSceneInteractionOptionType(i, p), DisableModulePlayerOperation.addSceneInteractionOption(i, _), DisableModulePlayerOperation.endDisableModulePlayerOperation(i)
  }
}
