...
class EndState {
  ...
  static getSizePrefixedRootAsEndState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EndState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createEndState(t, e) {
    return EndState.startEndState(t), EndState.addStayFlowMontageActors(t, e), EndState.endEndState(t)
  }
}
