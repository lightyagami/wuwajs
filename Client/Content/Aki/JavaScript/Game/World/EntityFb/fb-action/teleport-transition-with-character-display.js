...
class TeleportTransitionWithCharacterDisplay {
  ...
  static getSizePrefixedRootAsTeleportTransitionWithCharacterDisplay(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TeleportTransitionWithCharacterDisplay).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleportTransitionWithCharacterDisplay(t, i, r) {
    return TeleportTransitionWithCharacterDisplay.startTeleportTransitionWithCharacterDisplay(t), TeleportTransitionWithCharacterDisplay.addType(t, i), TeleportTransitionWithCharacterDisplay.addStyleId(t, r), TeleportTransitionWithCharacterDisplay.endTeleportTransitionWithCharacterDisplay(t)
  }
}
