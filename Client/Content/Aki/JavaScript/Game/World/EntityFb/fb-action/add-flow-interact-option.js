...
class AddFlowInteractOption {
  ...
  static getSizePrefixedRootAsAddFlowInteractOption(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AddFlowInteractOption).__init(t.readInt32(t.position()) + t.position(), t)
  }
  option(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new interact_option_js_1.InteractOption).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  entityId() {
  ...
  static createAddFlowInteractOption(t, i, e, n) {
    return AddFlowInteractOption.startAddFlowInteractOption(t), AddFlowInteractOption.addOption(t, i), AddFlowInteractOption.addEntityId(t, e), AddFlowInteractOption.addDelayRemoveByQuestEnd(t, n), AddFlowInteractOption.endAddFlowInteractOption(t)
  }
}
