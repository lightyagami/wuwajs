...
class ManualOccupations {
  ...
  static getSizePrefixedRootAsManualOccupations(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ManualOccupations).__init(t.readInt32(t.position()) + t.position(), t)
  }
  occupationType(t) {
  ...
  occupations(t, a) {
    ...
    return s ? this.bb.__string(this.bb.__vector(this.bb_pos + s) + 4 * t, a) : void 0
  }
  occupationsLength() {
  ...
  static createManualOccupations(t, a, s) {
    return ManualOccupations.startManualOccupations(t), ManualOccupations.addOccupationType(t, a), ManualOccupations.addOccupations(t, s), ManualOccupations.endManualOccupations(t)
  }
}
