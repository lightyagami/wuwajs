...
class SetSportsState {
  ...
  static getSizePrefixedRootAsSetSportsState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetSportsState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_sport_state_js_1.UnionSportState.NONE
  }
  config(t) {
  ...
  static createSetSportsState(t, e, s) {
    return SetSportsState.startSetSportsState(t), SetSportsState.addConfigType(t, e), SetSportsState.addConfig(t, s), SetSportsState.endSetSportsState(t)
  }
}
