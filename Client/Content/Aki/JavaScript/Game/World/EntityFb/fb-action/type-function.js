...
class TypeFunction {
  ...
  static getSizePrefixedRootAsTypeFunction(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TypeFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  static createTypeFunction(t, i, e) {
    return TypeFunction.startTypeFunction(t), TypeFunction.addName(t, i), TypeFunction.addActions(t, e), TypeFunction.endTypeFunction(t)
  }
}
