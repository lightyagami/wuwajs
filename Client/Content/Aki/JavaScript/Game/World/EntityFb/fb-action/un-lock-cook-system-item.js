...
class UnLockCookSystemItem {
  ...
  static getSizePrefixedRootAsUnLockCookSystemItem(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new UnLockCookSystemItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  unlockOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_unlock_cook_system_option_js_1.UnionUnlockCookSystemOption.NONE
  }
  unlockOption(t) {
  ...
  static createUnLockCookSystemItem(t, o, e, s) {
    return UnLockCookSystemItem.startUnLockCookSystemItem(t), UnLockCookSystemItem.addType(t, o), UnLockCookSystemItem.addUnlockOptionType(t, e), UnLockCookSystemItem.addUnlockOption(t, s), UnLockCookSystemItem.endUnLockCookSystemItem(t)
  }
}
