...
class AdjustFirstPersonCamera {
  ...
  static getRootAsAdjustFirstPersonCamera(t, i) {
    return (i || new AdjustFirstPersonCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdjustFirstPersonCamera(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AdjustFirstPersonCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
