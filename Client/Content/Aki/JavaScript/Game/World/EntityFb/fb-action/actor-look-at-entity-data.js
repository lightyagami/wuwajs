...
class ActorLookAtEntityData {
  ...
  static getSizePrefixedRootAsActorLookAtEntityData(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ActorLookAtEntityData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtEntityData(t, o, i, a) {
    return ActorLookAtEntityData.startActorLookAtEntityData(t), ActorLookAtEntityData.addType(t, o), ActorLookAtEntityData.addLock(t, i), ActorLookAtEntityData.addEntityId(t, a), ActorLookAtEntityData.endActorLookAtEntityData(t)
  }
}
