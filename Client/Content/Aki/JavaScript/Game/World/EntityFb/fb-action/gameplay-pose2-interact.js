...
class GameplayPose2Interact {
  ...
  static getSizePrefixedRootAsGameplayPose2Interact(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GameplayPose2Interact).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGameplayPose2Interact(t, e) {
    return GameplayPose2Interact.startGameplayPose2Interact(t), GameplayPose2Interact.addType(t, e), GameplayPose2Interact.endGameplayPose2Interact(t)
  }
}
