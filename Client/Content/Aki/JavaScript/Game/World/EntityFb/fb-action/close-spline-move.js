...
class CloseSplineMove {
  ...
  static getSizePrefixedRootAsCloseSplineMove(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CloseSplineMove).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCloseSplineMove(e, t, i, s, o) {
    return CloseSplineMove.startCloseSplineMove(e), CloseSplineMove.addType(e, t), CloseSplineMove.addTargetType(e, i), CloseSplineMove.addTarget(e, s), CloseSplineMove.addSplineEntityId(e, o), CloseSplineMove.endCloseSplineMove(e)
  }
}
