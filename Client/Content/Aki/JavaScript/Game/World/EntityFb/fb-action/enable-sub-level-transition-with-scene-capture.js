...
class EnableSubLevelTransitionWithSceneCapture {
  ...
  static getSizePrefixedRootAsEnableSubLevelTransitionWithSceneCapture(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableSubLevelTransitionWithSceneCapture).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnableSubLevelTransitionWithSceneCapture(e, t, i, n, r) {
    return EnableSubLevelTransitionWithSceneCapture.startEnableSubLevelTransitionWithSceneCapture(e), EnableSubLevelTransitionWithSceneCapture.addType(e, t), EnableSubLevelTransitionWithSceneCapture.addSceneCaptureEffect(e, i), EnableSubLevelTransitionWithSceneCapture.addScreenEffect(e, n), EnableSubLevelTransitionWithSceneCapture.addScreenEffectLoop(e, r), EnableSubLevelTransitionWithSceneCapture.endEnableSubLevelTransitionWithSceneCapture(e)
  }
}
