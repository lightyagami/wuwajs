...
class FlowActorUnit {
  ...
  static getRootAsFlowActorUnit(t, i) {
    return (i || new FlowActorUnit).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsFlowActorUnit(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FlowActorUnit).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  initialState(t) {
    ...
    return i ? (t || new actor_initial_state_js_1.ActorInitialState).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
