...
exports.FlowActorUnit = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const actor_initial_state_js_1 = require("../fb-action/actor-initial-state.js");
class FlowActorUnit {
  constructor() {
    this.bb = undefined;
    this.bb_pos = 0;
  ...
  initialState(t) {
    ...
    if (i) {
      return (t || new actor_initial_state_js_1.ActorInitialState()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
