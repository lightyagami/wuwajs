...
class ICenterTextTypeWriter {
  ...
  static getSizePrefixedRootAsICenterTextTypeWriter(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ICenterTextTypeWriter).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createICenterTextTypeWriter(e, t, r) {
    return ICenterTextTypeWriter.startICenterTextTypeWriter(e), ICenterTextTypeWriter.addType(e, t), ICenterTextTypeWriter.addTextCountPerSecond(e, r), ICenterTextTypeWriter.endICenterTextTypeWriter(e)
  }
}
