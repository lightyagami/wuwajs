...
class LimitPlayerOperation {
  ...
  static getSizePrefixedRootAsLimitPlayerOperation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LimitPlayerOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  typeType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_limit_play_operation_js_1.UnionLimitPlayOperation.NONE
  }
  type(t) {
  ...
  static createLimitPlayerOperation(t, i, e) {
    return LimitPlayerOperation.startLimitPlayerOperation(t), LimitPlayerOperation.addTypeType(t, i), LimitPlayerOperation.addType(t, e), LimitPlayerOperation.endLimitPlayerOperation(t)
  }
}
