...
class UnlockPhotoMemoryCollectSystemItem {
  ...
  static getSizePrefixedRootAsUnlockPhotoMemoryCollectSystemItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UnlockPhotoMemoryCollectSystemItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUnlockPhotoMemoryCollectSystemItem(t, e, o) {
    return UnlockPhotoMemoryCollectSystemItem.startUnlockPhotoMemoryCollectSystemItem(t), UnlockPhotoMemoryCollectSystemItem.addType(t, e), UnlockPhotoMemoryCollectSystemItem.addId(t, o), UnlockPhotoMemoryCollectSystemItem.endUnlockPhotoMemoryCollectSystemItem(t)
  }
}
