...
class FinishDungeon {
  ...
  static getSizePrefixedRootAsFinishDungeon(s, i) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FinishDungeon).__init(s.readInt32(s.position()) + s.position(), s)
  }
  isSuccess() {
  ...
  static createFinishDungeon(s, i) {
    return FinishDungeon.startFinishDungeon(s), FinishDungeon.addIsSuccess(s, i), FinishDungeon.endFinishDungeon(s)
  }
}
