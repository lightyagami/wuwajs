...
class HideTargetRange {
  ...
  static getSizePrefixedRootAsHideTargetRange(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new HideTargetRange).__init(e.readInt32(e.position()) + e.position(), e)
  }
  rangeEntity() {
  ...
  hideConfigType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_hide_range_config_js_1.UnionHideRangeConfig.NONE
  }
  hideConfig(e) {
  ...
  static createHideTargetRange(e, t, i, a, r, s) {
    return HideTargetRange.startHideTargetRange(e), HideTargetRange.addRangeEntity(e, t), HideTargetRange.addHideConfigType(e, i), HideTargetRange.addHideConfig(e, a), HideTargetRange.addIsHideSimpleNpc(e, r), HideTargetRange.addIsHidePasserByNpc(e, s), HideTargetRange.endHideTargetRange(e)
  }
}
