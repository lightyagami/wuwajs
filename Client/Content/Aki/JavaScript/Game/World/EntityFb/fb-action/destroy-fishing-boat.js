...
class DestroyFishingBoat {
  ...
  static getSizePrefixedRootAsDestroyFishingBoat(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new DestroyFishingBoat).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createDestroyFishingBoat(t) {
    return DestroyFishingBoat.startDestroyFishingBoat(t), DestroyFishingBoat.endDestroyFishingBoat(t)
  }
}
