...
class LeisureInteract {
  ...
  static getSizePrefixedRootAsLeisureInteract(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LeisureInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_leisure_interact_option_js_1.UnionLeisureInteractOption.NONE
  }
  option(t) {
  ...
  static createLeisureInteract(t, e, i, r) {
    return LeisureInteract.startLeisureInteract(t), LeisureInteract.addOptionType(t, e), LeisureInteract.addOption(t, i), LeisureInteract.addSceneEntity(t, r), LeisureInteract.endLeisureInteract(t)
  }
}
