...
class AccelerateSkiConfig {
  ...
  static getSizePrefixedRootAsAccelerateSkiConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AccelerateSkiConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createAccelerateSkiConfig(t, e, i, r, s, a, c, n) {
    return AccelerateSkiConfig.startAccelerateSkiConfig(t), AccelerateSkiConfig.addType(t, e), AccelerateSkiConfig.addTargetType(t, i), AccelerateSkiConfig.addTarget(t, r), AccelerateSkiConfig.addDuration(t, s), AccelerateSkiConfig.addLimitSpeed(t, a), AccelerateSkiConfig.addAcceleration(t, c), AccelerateSkiConfig.addInstantSpeed(t, n), AccelerateSkiConfig.endAccelerateSkiConfig(t)
  }
}
