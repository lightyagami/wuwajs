...
class MontageParam {
  ...
  static getSizePrefixedRootAsMontageParam(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new MontageParam).__init(t.readInt32(t.position()) + t.position(), t)
  }
  montageId(t) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (t || new montage_id_js_1.MontageId).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
  isLoop() {
  ...
  static createMontageParam(t, a, e, s, r) {
    return MontageParam.startMontageParam(t), MontageParam.addMontageId(t, a), MontageParam.addIsLoop(t, e), MontageParam.addKeepPose(t, s), MontageParam.addDelayTime(t, r), MontageParam.endMontageParam(t)
  }
}
