...
class ActorLookAtEmptyData {
  ...
  static getSizePrefixedRootAsActorLookAtEmptyData(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ActorLookAtEmptyData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorLookAtEmptyData(t, o, a) {
    return ActorLookAtEmptyData.startActorLookAtEmptyData(t), ActorLookAtEmptyData.addType(t, o), ActorLookAtEmptyData.addLock(t, a), ActorLookAtEmptyData.endActorLookAtEmptyData(t)
  }
}
