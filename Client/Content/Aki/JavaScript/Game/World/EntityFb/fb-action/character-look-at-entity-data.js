...
class CharacterLookAtEntityData {
  ...
  static getSizePrefixedRootAsCharacterLookAtEntityData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CharacterLookAtEntityData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCharacterLookAtEntityData(t, a, r) {
    return CharacterLookAtEntityData.startCharacterLookAtEntityData(t), CharacterLookAtEntityData.addType(t, a), CharacterLookAtEntityData.addEntityId(t, r), CharacterLookAtEntityData.endCharacterLookAtEntityData(t)
  }
}
