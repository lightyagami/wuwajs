...
class NpcFollowConfig {
  ...
  static getSizePrefixedRootAsNpcFollowConfig(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new NpcFollowConfig).__init(r.readInt32(r.position()) + r.position(), r)
  }
  performerWhenEnter(r) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? (r || new performer_range_boundary_action_trigger_js_1.PerformerRangeBoundaryActionTrigger).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  performerWhenExit(r) {
