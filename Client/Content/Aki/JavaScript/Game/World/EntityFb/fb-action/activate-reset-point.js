...
class ActivateResetPoint {
  ...
  static getSizePrefixedRootAsActivateResetPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActivateResetPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createActivateResetPoint(t) {
    return ActivateResetPoint.startActivateResetPoint(t), ActivateResetPoint.endActivateResetPoint(t)
  }
}
