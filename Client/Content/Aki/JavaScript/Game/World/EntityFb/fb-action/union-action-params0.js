...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionActionParams0 = exports.unionToUnionActionParams0 = exports.UnionActionParams0 = void 0;
...
function unionListToUnionActionParams0(e, t, r) {
  ...
  e[e.NONE = 0] = "NONE", e[e.Interact = 1] = "Interact", e[e.AcceptCurrentQuest = 2] = "AcceptCurrentQuest", e[e.AddFlowInteractOption = 3] = "AddFlowInteractOption", e[e.AdjustTodTime = 4] = "AdjustTodTime", e[e.AwakeEntity = 5] = "AwakeEntity", e[e.CalculateVar = 6] = "CalculateVar", e[e.RandomVar = 7] = "RandomVar", e[e.CallByCondition = 8] = "CallByCondition", e[e.CallFunction = 9] = "CallFunction", e[e.CameraLookAt = 10] = "CameraLookAt", e[e.StopCameraLookAt = 11] = "StopCameraLookAt", e[e.EnableHostility = 12] = "EnableHostility", e[e.ChangeActorState = 13] = "ChangeActorState", e[e.ChangeBehaviorState = 14] = "ChangeBehaviorState", e[e.ChangeEntityState = 15] = "ChangeEntityState", e[e.ChangeNpcPerformState = 16] = "ChangeNpcPerformState", e[e.ChangeInteractOptionText = 17] = "ChangeInteractOptionText", e[e.ChangeOtherState = 18] = "ChangeOtherState", e[e.ChangeRandomState = 19] = "ChangeRandomState", e[e.ChangeState = 20] = "ChangeState", e[e.Collect = 21] = "Collect", e[e.CompleteChildQuest = 22] = "CompleteChildQuest", e[e.Destroy = 23] = "Destroy", e[e.DestroyAllChild = 24] = "DestroyAllChild", e[e.DestroyEntity = 25] = "DestroyEntity", e[e.DestroySelf = 26] = "DestroySelf", e[e.DoCalculate = 27] = "DoCalculate", e[e.EnableFunction = 28] = "EnableFunction", e[e.FaceToPos = 29] = "FaceToPos", e[e.FinishDoInteract = 30] = "FinishDoInteract", e[e.FinishState = 31] = "FinishState", e[e.FinishTalk = 32] = "FinishTalk", e[e.GetItem = 33] = "GetItem", e[e.DestroyQuestItem = 34] = "DestroyQuestItem", e[e.GuideTrigger = 35] = "GuideTrigger", e[e.CompleteGuide = 36] = "CompleteGuide", e[e.Invoke = 37] = "Invoke", e[e.JumpTalk = 38] = "JumpTalk", e[e.Log = 39] = "Log", e[e.MoveToPosA = 40] = "MoveToPosA", e[e.MoveWithSpline = 41] = "MoveWithSpline", e[e.NewMoveWithSpline = 42] = "NewMoveWithSpline", e[e.StopNewMoveWithSpline = 43] = "StopNewMoveWithSpline", e[e.CharacterMoveToPoint = 44] = "CharacterMoveToPoint", e[e.OpenSystemBoard = 45] = "OpenSystemBoard", e[e.OpenSystemFunction = 46] = "OpenSystemFunction", e[e.PlayCustomSequence = 47] = "PlayCustomSequence", e[e.PlayerLookAt = 48] = "PlayerLookAt", e[e.EntityLookAt = 49] = "EntityLookAt", e[e.CharacterLookAt = 50] = "CharacterLookAt", e[e.EntityTurnTo = 51] = "EntityTurnTo", e[e.PlayFlow = 52] = "PlayFlow", e[e.PlayMovie = 53] = "PlayMovie", e[e.PlayEffect = 54] = "PlayEffect", e[e.PlayCommonEffect = 55] = "PlayCommonEffect", e[e.PlayMontage = 56] = "PlayMontage", e[e.PlaySequenceData = 57] = "PlaySequenceData", e[e.PlayerInput = 58] = "PlayerInput", e[e.Prompt = 59] = "Prompt", e[e.AddPlayBubble = 60] = "AddPlayBubble", e[e.PlayBubble = 61] = "PlayBubble", e[e.ClearPlayBubble = 62] = "ClearPlayBubble", e[e.EnableAI = 63] = "EnableAI", e[e.RemoveFlowInteractOption = 64] = "RemoveFlowInteractOption", e[e.SendNpcMail = 65] = "SendNpcMail", e[e.SetBehaviorIsPaused = 66] = "SetBehaviorIsPaused", e[e.SetCameraMode = 67] = "SetCameraMode", e[e.SetEntityVisible = 68] = "SetEntityVisible", e[e.SetEntityClientVisible = 69] = "SetEntityClientVisible", e[e.SetEntityClientVisibleSave = 70] = "SetEntityClientVisibleSave", e[e.SetHeadIconVisible = 71] = "SetHeadIconVisible", e[e.SetMoveSpeed = 72] = "SetMoveSpeed", e[e.SetNumberVar = 73] = "SetNumberVar", e[e.SetPlotMode = 74] = "SetPlotMode", e[e.SetPosA = 75] = "SetPosA", e[e.SetVar = 76] = "SetVar", e[e.ShowCenterText = 77] = "ShowCenterText", e[e.ShowMessage = 78] = "ShowMessage", e[e.ShowTalk = 79] = "ShowTalk", e[e.SimpleMove = 80] = "SimpleMove", e[e.SpawnChild = 81] = "SpawnChild", e[e.SpawnEntity = 82] = "SpawnEntity", e[e.SyncVarToActorState = 83] = "SyncVarToActorState", e[e.Wait = 84] = "Wait", e[e.AddBuffToEntity = 85] = "AddBuffToEntity", e[e.AddBuffToPlayer = 86] = "AddBuffToPlayer", e[e.AddBuffToFollowShooter = 87] = "AddBuffToFollowShooter", e[e.LockEntity = 88] = "LockEntity", e[e.UnlockEntity = 89] = "UnlockEntity", e[e.SetForceLock = 90] = "SetForceLock", e[e.SetAreaState = 91] = "SetAreaState", e[e.SetWuYinQuState = 92] = "SetWuYinQuState", e[e.RemoveBuffFromEntity = 93] = "RemoveBuffFromEntity", e[e.RemoveBuffFromPlayer = 94] = "RemoveBuffFromPlayer", e[e.SetPlayerMoveControl = 95] = "SetPlayerMoveControl", e[e.UnlockTeleportTrigger = 96] = "UnlockTeleportTrigger", e[e.ChangeTeamPosition = 97] = "ChangeTeamPosition", e[e.ClaimLevelPlayReward = 98] = "ClaimLevelPlayReward", e[e.SetReviveRegion = 99] = "SetReviveRegion", e[e.PromptQuestChapterUI = 100] = "PromptQuestChapterUI", e[e.FireBullet = 101] = "FireBullet", e[e.FireBulletEffect = 102] = "FireBulletEffect", e[e.SetPlayerPos = 103] = "SetPlayerPos", e[e.ClientSetPlayerPos = 104] = "ClientSetPlayerPos", e[e.ClientPreEnableSubLevels = 105] = "ClientPreEnableSubLevels", e[e.ChangeSelfEntityState = 106] = "ChangeSelfEntityState", e[e.InterludeActions = 107] = "InterludeActions", e[e.AddBuffToTriggeredEntity = 108] = "AddBuffToTriggeredEntity", e[e.RemoveBuffToTriggeredEntity = 109] = "RemoveBuffToTriggeredEntity", e[e.DetectTrigger = 110] = "DetectTrigger", e[e.ItemFoundationMatch = 111] = "ItemFoundationMatch", e[e.SetBattleState = 112] = "SetBattleState", e[e.ExecBattleAction = 113] = "ExecBattleAction", e[e.WaitBattleCondition = 114] = "WaitBattleCondition", e[e.UnlockSystemItem = 115] = "UnlockSystemItem", e[e.RunActions = 116] = "RunActions", e[e.CommonTip = 117] = "CommonTip", e[e.CommonTip2 = 118] = "CommonTip2", e[e.EnableNearbyTracking = 119] = "EnableNearbyTracking", e[e.EnableLevelPlay = 120] = "EnableLevelPlay", e[e.UnLimitPlayerOperation = 121] = "UnLimitPlayerOperation", e[e.LimitPlayerOperation = 122] = "LimitPlayerOperation", e[e.SetPlayerOperationRestriction = 123] = "SetPlayerOperationRestriction", e[e.LeisureInteract = 124] = "LeisureInteract", e[e.NpcLeisureInteract = 125] = "NpcLeisureInteract", e[e.ChangePhantom = 126] = "ChangePhantom", e[e.RestorePhantom = 127] = "RestorePhantom", e[e.TakePlotPhoto = 128] = "TakePlotPhoto", e[e.OpenQteAction = 129] = "OpenQteAction", e[e.PreloadAction = 130] = "PreloadAction", e[e.RemovePreloadResourceAction = 131] = "RemovePreloadResourceAction", e[e.ExecAlertSystemAction = 132] = "ExecAlertSystemAction", e[e.ChangeEntityCamp = 133] = "ChangeEntityCamp", e[e.RecordDungeonEvent = 134] = "RecordDungeonEvent", e[e.ResetLevelPlay = 135] = "ResetLevelPlay", e[e.GetRewardByInteract = 136] = "GetRewardByInteract", e[e.GuestOperateUiAnimation = 137] = "GuestOperateUiAnimation", e[e.VehicleEnter = 138] = "VehicleEnter", e[e.EnterNpcVehicle = 139] = "EnterNpcVehicle", e[e.VehicleExitPlayer = 140] = "VehicleExitPlayer", e[e.VehicleExitNpc = 141] = "VehicleExitNpc", e[e.TeleportVehicle = 142] = "TeleportVehicle", e[e.VehiclePlayPassengerVoice = 143] = "VehiclePlayPassengerVoice", e[e.VehicleWaterfallClimbing = 144] = "VehicleWaterfallClimbing", e[e.TeleportToAndEnterVehicle = 145] = "TeleportToAndEnterVehicle", e[e.VehicleMoveWithPathLine = 146] = "VehicleMoveWithPathLine", e[e.VehicleSprint = 147] = "VehicleSprint", e[e.SetAreaTimeState = 148] = "SetAreaTimeState", e[e.SlideRailStart = 149] = "SlideRailStart", e[e.BvbSendSystemEvent = 150] = "BvbSendSystemEvent", e[e.TeleportDungeon = 151] = "TeleportDungeon", e[e.SettlementDungeon = 152] = "SettlementDungeon", e[e.ClaimDungeonReward = 153] = "ClaimDungeonReward", e[e.ExitDungeon = 154] = "ExitDungeon", e[e.UnlockDungeonEntry = 155] = "UnlockDungeonEntry", e[e.FinishDungeon = 156] = "FinishDungeon", e[e.StartFlowTemplate = 157] = "StartFlowTemplate", e[e.BeginFlowTemplate = 158] = "BeginFlowTemplate", e[e.ChangeFlowTemplate = 159] = "ChangeFlowTemplate", e[e.SetFlowTemplate = 160] = "SetFlowTemplate", e[e.EndFlowTemplate = 161] = "EndFlowTemplate", e[e.CloseFlowTemplate = 162] = "CloseFlowTemplate", e[e.SendAiEvent = 163] = "SendAiEvent", e[e.FadeInScreen = 164] = "FadeInScreen", e[e.FadeOutScreen = 165] = "FadeOutScreen", e[e.ChangeFightTeam = 166] = "ChangeFightTeam", e[e.ManualOccupations = 167] = "ManualOccupations", e[e.AddTrialCharacter = 168] = "AddTrialCharacter", e[e.RemoveTrialCharacter = 169] = "RemoveTrialCharacter", e[e.AddGuestCharacter = 170] = "AddGuestCharacter", e[e.RemoveGuestCharacter = 171] = "RemoveGuestCharacter", e[e.AddTrialFollowShooter = 172] = "AddTrialFollowShooter", e[e.RemoveTrialFollowShooter = 173] = "RemoveTrialFollowShooter", e[e.DestroyQuest = 174] = "DestroyQuest", e[e.SetCameraAnim = 175] = "SetCameraAnim", e[e.RotatorEntity = 176] = "RotatorEntity", e[e.TraceSpline = 177] = "TraceSpline", e[e.ToggleScanSplineEffect = 178] = "ToggleScanSplineEffect", e[e.ChangeTimer = 179] = "ChangeTimer", e[e.ToggleTimerPauseState = 180] = "ToggleTimerPauseState", e[e.EnableSystem = 181] = "EnableSystem", e[e.PostAkEvent = 182] = "PostAkEvent", e[e.MoveSceneItem = 183] = "MoveSceneItem", e[e.StopSceneItemMove = 184] = "StopSceneItemMove", e[e.ChangeLiftTarget = 185] = "ChangeLiftTarget", e[e.HideByRangeInFlow = 186] = "HideByRangeInFlow", e[e.OpenSimpleGameplay = 187] = "OpenSimpleGameplay", e[e.ChangeActorTalker = 188] = "ChangeActorTalker", e[e.SwitchSubLevels = 189] = "SwitchSubLevels", e[e.SwitchDataLayers = 190] = "SwitchDataLayers", e[e.ActivateResetPoint = 191] = "ActivateResetPoint", e[e.TeleportToLatestResetPoint = 192] = "TeleportToLatestResetPoint", e[e.SetWeather = 193] = "SetWeather", e[e.SetTimeLockState = 194] = "SetTimeLockState", e[e.SetWeatherLockState = 195] = "SetWeatherLockState", e[e.AdjustPlayerCamera = 196] = "AdjustPlayerCamera", e[e.RestorePlayerCameraAdjustment = 197] = "RestorePlayerCameraAdjustment", e[e.ResetPlayerCameraFocus = 198] = "ResetPlayerCameraFocus", e[e.UsePhantomSkill = 199] = "UsePhantomSkill", e[e.ChangePhantomFormation = 200] = "ChangePhantomFormation", e[e.RestorePhantomFormation = 201] = "RestorePhantomFormation", e[e.EnterOrbitalCamera = 202] = "EnterOrbitalCamera", e[e.ExitOrbitalCamera = 203] = "ExitOrbitalCamera", e[e.EnableSplineMoveModel = 204] = "EnableSplineMoveModel", e[e.SetSportsState = 205] = "SetSportsState", e[e.PlayLevelSequence = 206] = "PlayLevelSequence", e[e.SetExploreState = 207] = "SetExploreState", e[e.RogueGotoNextFloor = 208] = "RogueGotoNextFloor", e[e.RogueSelectRoom = 209] = "RogueSelectRoom", e[e.RogueActivatePortal = 210] = "RogueActivatePortal", e[e.RogueReceiveReward = 211] = "RogueReceiveReward", e[e.EnableAoiNotify = 212] = "EnableAoiNotify", e[e.ChangeEntityPrefabPerformance = 213] = "ChangeEntityPrefabPerformance", e[e.ModifySceneItemAttributeTag = 214] = "ModifySceneItemAttributeTag", e[e.ToggleMapMarkState = 215] = "ToggleMapMarkState", e[e.FocusOnMapMark = 216] = "FocusOnMapMark", e[e.EnableTemporaryTeleport = 217] = "EnableTemporaryTeleport", e[e.SetTeleControl = 218] = "SetTeleControl", e[e.ActiveAntiGravitySafePoint = 219] = "ActiveAntiGravitySafePoint", e[e.ClearFishingCabinInSaleItems = 220] = "ClearFishingCabinInSaleItems", e[e.AcceptFishingEntrust = 221] = "AcceptFishingEntrust", e[e.DestroyFishingBoat = 222] = "DestroyFishingBoat", e[e.SetSpineAnimation = 223] = "SetSpineAnimation", e[e.DangoAbyssActivatePortal = 224] = "DangoAbyssActivatePortal", e[e.DangoAbyssGotoNextFloor = 225] = "DangoAbyssGotoNextFloor", e[e.DangoAbyssCreateRewardTreasureBox = 226] = "DangoAbyssCreateRewardTreasureBox", e[e.DangoAbyssReceiveReward = 227] = "DangoAbyssReceiveReward", e[e.SetTimeScale = 228] = "SetTimeScale", e[e.EnableActor = 229] = "EnableActor", e[e.ModifyActorMaterial = 230] = "ModifyActorMaterial", e[e.ToggleAirWall = 231] = "ToggleAirWall", e[e.TriggerCameraShake = 232] = "TriggerCameraShake", e[e.CreatePrefab = 233] = "CreatePrefab", e[e.DestroyPrefab = 234] = "DestroyPrefab", e[e.PlayRegisteredMontage = 235] = "PlayRegisteredMontage", e[e.RecoverDurability = 236] = "RecoverDurability", e[e.SetRegionConfig = 237] = "SetRegionConfig", e[e.SetJigsawItem = 238] = "SetJigsawItem", e[e.SetJigsawFoundation = 239] = "SetJigsawFoundation", e[e.ToggleHighlightExploreUi = 240] = "ToggleHighlightExploreUi", e[e.ResetEntity = 241] = "ResetEntity", e[e.PlayDynamicSettlement = 242] = "PlayDynamicSettlement", e[e.SetInteractionLockState = 243] = "SetInteractionLockState", e[e.FinishCondition = 244] = "FinishCondition", e[e.ClearEntityVisibleTag = 245] = "ClearEntityVisibleTag", e[e.SetEntityPos = 246] = "SetEntityPos", e[e.ResetEntityPos = 247] = "ResetEntityPos", e[e.ServerSetPlayerPos = 248] = "ServerSetPlayerPos", e[e.FixTeleControllerPos = 249] = "FixTeleControllerPos", e[e.CustomJson = 250] = "CustomJson", e[e.FixFoundationRelation = 251] = "FixFoundationRelation", e[e.FixShowTargetRange = 252] = "FixShowTargetRange", e[e.ForceOccupations = 253] = "ForceOccupations", e[e.ServerForceEnableLevelPlay = 254] = "ServerForceEnableLevelPlay", e[e.TeleportDungeonPos = 255] = "TeleportDungeonPos"
}(UnionActionParams0 = exports.UnionActionParams0 || (exports.UnionActionParams0 = {})), exports.unionToUnionActionParams0 = unionToUnionActionParams0, exports.unionListToUnionActionParams0 = unionListToUnionActionParams0;
