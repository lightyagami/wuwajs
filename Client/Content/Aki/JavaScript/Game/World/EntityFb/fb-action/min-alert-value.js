...
class MinAlertValue {
  ...
  static getSizePrefixedRootAsMinAlertValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MinAlertValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createMinAlertValue(t, e) {
    return MinAlertValue.startMinAlertValue(t), MinAlertValue.addType(t, e), MinAlertValue.endMinAlertValue(t)
  }
}
