...
class RacingTrackMove {
  ...
  static getSizePrefixedRootAsRacingTrackMove(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RacingTrackMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRacingTrackMove(t, i, a, e, r, s) {
    return RacingTrackMove.startRacingTrackMove(t), RacingTrackMove.addType(t, i), RacingTrackMove.addMaxOffsetDistance(t, a), RacingTrackMove.addIsOneWay(t, e), RacingTrackMove.addLayerVerticalLimit(t, r), RacingTrackMove.addDirectionAngleLimit(t, s), RacingTrackMove.endRacingTrackMove(t)
  }
}
