...
class PathLineMove {
  ...
  static getSizePrefixedRootAsPathLineMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PathLineMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPathLineMove(t, e, i, s, a) {
    return PathLineMove.startPathLineMove(t), PathLineMove.addType(t, e), PathLineMove.addMaxOffsetDistance(t, i), PathLineMove.addIsOneWay(t, s), PathLineMove.addLayerVerticalLimit(t, a), PathLineMove.endPathLineMove(t)
  }
}
