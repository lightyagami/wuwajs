...
exports.unionListToUnionActorTurnToData = exports.unionToUnionActorTurnToData = exports.UnionActorTurnToData = undefined;
const actor_turn_to_empty_data_js_1 = require("../fb-action/actor-turn-to-empty-data.js");
const actor_turn_to_entity_data_js_1 = require("../fb-action/actor-turn-to-entity-data.js");
const actor_turn_to_player_data_js_1 = require("../fb-action/actor-turn-to-player-data.js");
const actor_turn_to_position_data_js_1 = require("../fb-action/actor-turn-to-position-data.js");
const actor_turn_to_talker_data_js_1 = require("../fb-action/actor-turn-to-talker-data.js");
...
function unionListToUnionActorTurnToData(t, r, a) {
  switch (UnionActorTurnToData[t]) {
    ...
    case "ActorTurnToPositionData":
      return r(a, new actor_turn_to_position_data_js_1.ActorTurnToPositionData());
    case "ActorTurnToTalkerData":
...
})(UnionActorTurnToData = exports.UnionActorTurnToData ||= {});
exports.unionToUnionActorTurnToData = unionToUnionActorTurnToData;
exports.unionListToUnionActorTurnToData = unionListToUnionActorTurnToData; //# sourceMappingURL=union-actor-turn-to-data.js.map