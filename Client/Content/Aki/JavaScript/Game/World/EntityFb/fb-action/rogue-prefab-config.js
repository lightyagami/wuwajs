...
class RoguePrefabConfig {
  ...
  static getSizePrefixedRootAsRoguePrefabConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RoguePrefabConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createRoguePrefabConfig(e, t, i) {
    return RoguePrefabConfig.startRoguePrefabConfig(e), RoguePrefabConfig.addType(e, t), RoguePrefabConfig.addIndex(e, i), RoguePrefabConfig.endRoguePrefabConfig(e)
  }
}
