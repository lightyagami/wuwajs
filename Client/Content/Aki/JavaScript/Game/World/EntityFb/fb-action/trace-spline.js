...
class TraceSpline {
  ...
  static getSizePrefixedRootAsTraceSpline(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TraceSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effectPath(t) {
  ...
  static createTraceSpline(t, e, i, r) {
    return TraceSpline.startTraceSpline(t), TraceSpline.addEffectPath(t, e), TraceSpline.addDuration(t, i), TraceSpline.addSplineEntityId(t, r), TraceSpline.endTraceSpline(t)
  }
}
