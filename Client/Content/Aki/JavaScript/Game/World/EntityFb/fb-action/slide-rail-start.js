...
class SlideRailStart {
  ...
  static getSizePrefixedRootAsSlideRailStart(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SlideRailStart).__init(t.readInt32(t.position()) + t.position(), t)
  }
  railEntityId() {
  ...
  static createSlideRailStart(t, i) {
    return SlideRailStart.startSlideRailStart(t), SlideRailStart.addRailEntityId(t, i), SlideRailStart.endSlideRailStart(t)
  }
}
