...
class SetBattleTags {
  ...
  static getSizePrefixedRootAsSetBattleTags(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetBattleTags).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  configs(t, e) {
    ...
    return s ? (e || new set_battle_tag_config_js_1.SetBattleTagConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  configsLength() {
  ...
  static createSetBattleTags(t, e, s) {
    return SetBattleTags.startSetBattleTags(t), SetBattleTags.addType(t, e), SetBattleTags.addConfigs(t, s), SetBattleTags.endSetBattleTags(t)
  }
}
