...
class PreloadFlows {
  ...
  static getSizePrefixedRootAsPreloadFlows(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PreloadFlows).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  flowData(t) {
    ...
    return s ? (t || new play_flow_js_1.PlayFlow).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
