...
class ActorLookAt {
  ...
  static getSizePrefixedRootAsActorLookAt(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ActorLookAt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorIndex() {
  ...
  targetType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_actor_look_at_data_js_1.UnionActorLookAtData.NONE
  }
  target(t) {
  ...
  static createActorLookAt(t, o, r, s, a) {
    return ActorLookAt.startActorLookAt(t), ActorLookAt.addActorIndex(t, o), ActorLookAt.addTargetType(t, r), ActorLookAt.addTarget(t, s), ActorLookAt.addDelayTime(t, a), ActorLookAt.endActorLookAt(t)
  }
}
