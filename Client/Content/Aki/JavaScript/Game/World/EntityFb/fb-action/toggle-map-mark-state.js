...
class ToggleMapMarkState {
  ...
  static getRootAsToggleMapMarkState(t, e) {
    return (e || new ToggleMapMarkState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsToggleMapMarkState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ToggleMapMarkState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createToggleMapMarkState(t, e) {
    return ToggleMapMarkState.startToggleMapMarkState(t), ToggleMapMarkState.addType(t, e), ToggleMapMarkState.endToggleMapMarkState(t)
  }
}
