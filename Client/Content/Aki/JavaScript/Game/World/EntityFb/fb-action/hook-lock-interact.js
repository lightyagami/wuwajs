...
class HookLockInteract {
  ...
  static getSizePrefixedRootAsHookLockInteract(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new HookLockInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHookLockInteract(t, o, e) {
    return HookLockInteract.startHookLockInteract(t), HookLockInteract.addType(t, o), HookLockInteract.addEntityId(t, e), HookLockInteract.endHookLockInteract(t)
  }
}
