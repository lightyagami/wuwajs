...
class ActiveRange {
  ...
  static getSizePrefixedRootAsActiveRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActiveRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  checkPoint(t) {
  ...
  static createActiveRange(t, e, i, s) {
    return ActiveRange.startActiveRange(t), ActiveRange.addCheckPoint(t, e), ActiveRange.addCheckEnterRange(t, i), ActiveRange.addCheckLeaveRange(t, s), ActiveRange.endActiveRange(t)
  }
}
