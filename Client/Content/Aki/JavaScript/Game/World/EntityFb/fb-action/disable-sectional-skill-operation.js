...
class DisableSectionalSkillOperation {
  ...
  static getSizePrefixedRootAsDisableSectionalSkillOperation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableSectionalSkillOperation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  disableExploreSkill(i) {
    ...
    return t ? (i || new disable_explore_skill_js_1.DisableExploreSkill).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  disableSkillWheel() {
