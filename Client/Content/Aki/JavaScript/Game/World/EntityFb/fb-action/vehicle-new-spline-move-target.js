...
class VehicleNewSplineMoveTarget {
  ...
  static getSizePrefixedRootAsVehicleNewSplineMoveTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleNewSplineMoveTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  targetVehicleType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_target_vehicle_js_1.UnionTargetVehicle.NONE
  }
  targetVehicle(e) {
  ...
  static createVehicleNewSplineMoveTarget(e, t, i, r, s) {
    return VehicleNewSplineMoveTarget.startVehicleNewSplineMoveTarget(e), VehicleNewSplineMoveTarget.addType(e, t), VehicleNewSplineMoveTarget.addTargetVehicleType(e, i), VehicleNewSplineMoveTarget.addTargetVehicle(e, r), VehicleNewSplineMoveTarget.addIsLookDir(e, s), VehicleNewSplineMoveTarget.endVehicleNewSplineMoveTarget(e)
  }
}
