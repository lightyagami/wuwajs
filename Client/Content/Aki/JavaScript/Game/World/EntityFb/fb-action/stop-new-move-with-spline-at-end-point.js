...
class StopNewMoveWithSplineAtEndPoint {
  ...
  static getSizePrefixedRootAsStopNewMoveWithSplineAtEndPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopNewMoveWithSplineAtEndPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStopNewMoveWithSplineAtEndPoint(t, e) {
    return StopNewMoveWithSplineAtEndPoint.startStopNewMoveWithSplineAtEndPoint(t), StopNewMoveWithSplineAtEndPoint.addType(t, e), StopNewMoveWithSplineAtEndPoint.endStopNewMoveWithSplineAtEndPoint(t)
  }
}
