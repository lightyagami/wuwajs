...
class SetHeadIconVisible {
  ...
  static getSizePrefixedRootAsSetHeadIconVisible(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetHeadIconVisible).__init(e.readInt32(e.position()) + e.position(), e)
  }
  headStyleConfigType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_head_style_js_1.UnionHeadStyle.NONE
  }
  headStyleConfig(e) {
  ...
  static createSetHeadIconVisible(e, t, i, s) {
    return SetHeadIconVisible.startSetHeadIconVisible(e), SetHeadIconVisible.addHeadStyleConfigType(e, t), SetHeadIconVisible.addHeadStyleConfig(e, i), SetHeadIconVisible.addVisible(e, s), SetHeadIconVisible.endSetHeadIconVisible(e)
  }
}
