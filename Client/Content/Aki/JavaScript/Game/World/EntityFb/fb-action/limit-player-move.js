...
class LimitPlayerMove {
  ...
  static getSizePrefixedRootAsLimitPlayerMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LimitPlayerMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createLimitPlayerMove(t, e, i) {
    return LimitPlayerMove.startLimitPlayerMove(t), LimitPlayerMove.addType(t, e), LimitPlayerMove.addIsOnlyForward(t, i), LimitPlayerMove.endLimitPlayerMove(t)
  }
}
