...
class CallFunction {
  ...
  static getSizePrefixedRootAsCallFunction(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CallFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  static createCallFunction(t, i) {
    return CallFunction.startCallFunction(t), CallFunction.addName(t, i), CallFunction.endCallFunction(t)
  }
}
