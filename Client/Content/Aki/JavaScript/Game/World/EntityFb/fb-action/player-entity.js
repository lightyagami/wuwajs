...
class PlayerEntity {
  ...
  static getSizePrefixedRootAsPlayerEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayerEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPlayerEntity(t, e) {
    return PlayerEntity.startPlayerEntity(t), PlayerEntity.addType(t, e), PlayerEntity.endPlayerEntity(t)
  }
}
