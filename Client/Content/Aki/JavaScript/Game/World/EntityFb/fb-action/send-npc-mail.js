...
class SendNpcMail {
  ...
  static getSizePrefixedRootAsSendNpcMail(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SendNpcMail).__init(t.readInt32(t.position()) + t.position(), t)
  }
  mailId() {
  ...
  static createSendNpcMail(t, e) {
    return SendNpcMail.startSendNpcMail(t), SendNpcMail.addMailId(t, e), SendNpcMail.endSendNpcMail(t)
  }
}
