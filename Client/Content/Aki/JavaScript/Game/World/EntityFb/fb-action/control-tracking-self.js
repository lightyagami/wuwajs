...
class ControlTrackingSelf {
  ...
  static getSizePrefixedRootAsControlTrackingSelf(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ControlTrackingSelf).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createControlTrackingSelf(t, r) {
    return ControlTrackingSelf.startControlTrackingSelf(t), ControlTrackingSelf.addType(t, r), ControlTrackingSelf.endControlTrackingSelf(t)
  }
}
