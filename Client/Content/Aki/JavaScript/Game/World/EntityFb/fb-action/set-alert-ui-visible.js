...
class SetAlertUiVisible {
  ...
  static getSizePrefixedRootAsSetAlertUiVisible(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetAlertUiVisible).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetAlertUiVisible(t, i, e, s) {
    return SetAlertUiVisible.startSetAlertUiVisible(t), SetAlertUiVisible.addType(t, i), SetAlertUiVisible.addAreaId(t, e), SetAlertUiVisible.addIsVisible(t, s), SetAlertUiVisible.endSetAlertUiVisible(t)
  }
}
