...
class AddOrSubAlertValueChangeSpeed {
  ...
  static getSizePrefixedRootAsAddOrSubAlertValueChangeSpeed(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AddOrSubAlertValueChangeSpeed).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createAddOrSubAlertValueChangeSpeed(e, t, r) {
    return AddOrSubAlertValueChangeSpeed.startAddOrSubAlertValueChangeSpeed(e), AddOrSubAlertValueChangeSpeed.addType(e, t), AddOrSubAlertValueChangeSpeed.addDeltaValue(e, r), AddOrSubAlertValueChangeSpeed.endAddOrSubAlertValueChangeSpeed(e)
  }
}
