...
class GameplayPose3Interact {
  ...
  static getSizePrefixedRootAsGameplayPose3Interact(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GameplayPose3Interact).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGameplayPose3Interact(t, e) {
    return GameplayPose3Interact.startGameplayPose3Interact(t), GameplayPose3Interact.addType(t, e), GameplayPose3Interact.endGameplayPose3Interact(t)
  }
}
