...
class AddOrSubAlertValue {
  ...
  static getSizePrefixedRootAsAddOrSubAlertValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AddOrSubAlertValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createAddOrSubAlertValue(t, e, r) {
    return AddOrSubAlertValue.startAddOrSubAlertValue(t), AddOrSubAlertValue.addType(t, e), AddOrSubAlertValue.addDeltaValue(t, r), AddOrSubAlertValue.endAddOrSubAlertValue(t)
  }
}
