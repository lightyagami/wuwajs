...
class AddTrialCharacter {
  ...
  static getSizePrefixedRootAsAddTrialCharacter(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new AddTrialCharacter).__init(t.readInt32(t.position()) + t.position(), t)
  }
  characterId() {
  ...
  characterGroupNew(t, r) {
    ...
    return a ? (r || new character_group_new_js_1.CharacterGroupNew).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * t), this.bb) : void 0
  }
  ...
  activeRange(t) {
    ...
    return r ? (t || new active_range_js_1.ActiveRange).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
