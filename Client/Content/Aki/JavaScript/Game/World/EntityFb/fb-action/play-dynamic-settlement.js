...
class PlayDynamicSettlement {
  ...
  static getSizePrefixedRootAsPlayDynamicSettlement(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayDynamicSettlement).__init(t.readInt32(t.position()) + t.position(), t)
  }
  dynamicSettlementConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_dynamic_settlement_config_js_1.UnionDynamicSettlementConfig.NONE
  }
  ...
  static createPlayDynamicSettlement(t, e, n) {
    return PlayDynamicSettlement.startPlayDynamicSettlement(t), PlayDynamicSettlement.addDynamicSettlementConfigType(t, e), PlayDynamicSettlement.addDynamicSettlementConfig(t, n), PlayDynamicSettlement.endPlayDynamicSettlement(t)
  }
}
