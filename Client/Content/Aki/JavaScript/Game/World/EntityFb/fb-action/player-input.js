...
class PlayerInput {
  ...
  static getSizePrefixedRootAsPlayerInput(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayerInput).__init(t.readInt32(t.position()) + t.position(), t)
  }
  input() {
  ...
  static createPlayerInput(t, e) {
    return PlayerInput.startPlayerInput(t), PlayerInput.addInput(t, e), PlayerInput.endPlayerInput(t)
  }
}
