...
class EnableLevelPlay {
  ...
  static getRootAsEnableLevelPlay(e, t) {
    return (t || new EnableLevelPlay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsEnableLevelPlay(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableLevelPlay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  configs(e, t) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (t || new enable_level_play_config_js_1.EnableLevelPlayConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * e), this.bb) : void 0
  }
  configsLength() {
  ...
  static createEnableLevelPlay(e, t, a) {
    return EnableLevelPlay.startEnableLevelPlay(e), EnableLevelPlay.addConfigs(e, t), EnableLevelPlay.addTargetPlayer(e, a), EnableLevelPlay.endEnableLevelPlay(e)
  }
}
