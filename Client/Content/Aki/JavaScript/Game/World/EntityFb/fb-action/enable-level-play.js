...
exports.EnableLevelPlay = undefined;
...
class EnableLevelPlay {
  ...
  configs(e, t) {
    ...
    if (a) {
      return (t || new enable_level_play_config_js_1.EnableLevelPlayConfig()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + e * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createEnableLevelPlay(e, t, a) {
    ...
    return EnableLevelPlay.endEnableLevelPlay(e);
  }
}
