...
class StandControl2 {
  ...
  static getSizePrefixedRootAsStandControl2(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new StandControl2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStandControl2(t, r) {
    return StandControl2.startStandControl2(t), StandControl2.addType(t, r), StandControl2.endStandControl2(t)
  }
}
