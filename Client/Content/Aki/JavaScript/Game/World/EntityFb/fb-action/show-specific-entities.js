...
class ShowSpecificEntities {
  ...
  static getSizePrefixedRootAsShowSpecificEntities(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ShowSpecificEntities).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createShowSpecificEntities(t, i, e) {
    return ShowSpecificEntities.startShowSpecificEntities(t), ShowSpecificEntities.addEntityIds(t, i), ShowSpecificEntities.addDelayShow(t, e), ShowSpecificEntities.endShowSpecificEntities(t)
  }
}
