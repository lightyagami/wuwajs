...
class CommonTip2 {
  ...
  static getSizePrefixedRootAsCommonTip2(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CommonTip2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  tipOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_common_tip2_option_js_1.UnionCommonTip2Option.NONE
  }
  tipOption(t) {
  ...
  static createCommonTip2(t, i, o) {
    return CommonTip2.startCommonTip2(t), CommonTip2.addTipOptionType(t, i), CommonTip2.addTipOption(t, o), CommonTip2.endCommonTip2(t)
  }
}
