...
class RecordTalkSequenceTransition {
  ...
  static getRootAsRecordTalkSequenceTransition(e, t) {
    return (t || new RecordTalkSequenceTransition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsRecordTalkSequenceTransition(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RecordTalkSequenceTransition).__init(e.readInt32(e.position()) + e.position(), e)
  }
  key() {
  ...
  value(e, t) {
    ...
    return i ? (t || new talk_sequence_transition_js_1.TalkSequenceTransition).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  valueLength() {
  ...
  static createRecordTalkSequenceTransition(e, t, i) {
    return RecordTalkSequenceTransition.startRecordTalkSequenceTransition(e), RecordTalkSequenceTransition.addKey(e, t), RecordTalkSequenceTransition.addValue(e, i), RecordTalkSequenceTransition.endRecordTalkSequenceTransition(e)
  }
}
