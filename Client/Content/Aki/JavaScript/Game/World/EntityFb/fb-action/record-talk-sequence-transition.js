...
exports.RecordTalkSequenceTransition = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const talk_sequence_transition_js_1 = require("../fb-action/talk-sequence-transition.js");
class RecordTalkSequenceTransition {
  ...
  value(e, t) {
    ...
    if (i) {
      return (t || new talk_sequence_transition_js_1.TalkSequenceTransition()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + e * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createRecordTalkSequenceTransition(e, t, i) {
    ...
    return RecordTalkSequenceTransition.endRecordTalkSequenceTransition(e);
  }
}
