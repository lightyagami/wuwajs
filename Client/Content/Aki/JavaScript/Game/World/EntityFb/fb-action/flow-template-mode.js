...
class FlowTemplateMode {
  ...
  static getSizePrefixedRootAsFlowTemplateMode(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FlowTemplateMode).__init(e.readInt32(e.position()) + e.position(), e)
  }
  id() {
  ...
  static createFlowTemplateMode(e, t, o) {
    return FlowTemplateMode.startFlowTemplateMode(e), FlowTemplateMode.addId(e, t), FlowTemplateMode.addCameraId(e, o), FlowTemplateMode.endFlowTemplateMode(e)
  }
}
