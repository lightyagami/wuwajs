...
class EnableAlertUi {
  ...
  static getSizePrefixedRootAsEnableAlertUi(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnableAlertUi).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEnableAlertUi(t, e, i, r) {
    return EnableAlertUi.startEnableAlertUi(t), EnableAlertUi.addType(t, e), EnableAlertUi.addAreaId(t, i), EnableAlertUi.addIsEnable(t, r), EnableAlertUi.endEnableAlertUi(t)
  }
}
