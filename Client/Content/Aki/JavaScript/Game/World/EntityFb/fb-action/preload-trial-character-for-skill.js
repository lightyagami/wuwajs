...
class PreloadTrialCharacterForSkill {
  ...
  static getSizePrefixedRootAsPreloadTrialCharacterForSkill(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PreloadTrialCharacterForSkill).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type(r) {
  ...
  characterGroupNew(r, t) {
    ...
    return a ? (t || new character_group_new_js_1.CharacterGroupNew).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * r), this.bb) : void 0
  }
  ...
  static createPreloadTrialCharacterForSkill(r, t, a) {
    return PreloadTrialCharacterForSkill.startPreloadTrialCharacterForSkill(r), PreloadTrialCharacterForSkill.addType(r, t), PreloadTrialCharacterForSkill.addCharacterGroupNew(r, a), PreloadTrialCharacterForSkill.endPreloadTrialCharacterForSkill(r)
  }
}
