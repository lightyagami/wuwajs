...
class EnableMoveOperation {
  ...
  static getSizePrefixedRootAsEnableMoveOperation(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableMoveOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnableMoveOperation(e, t) {
    return EnableMoveOperation.startEnableMoveOperation(e), EnableMoveOperation.addType(e, t), EnableMoveOperation.endEnableMoveOperation(e)
  }
}
