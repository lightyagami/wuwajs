...
class PlaySequenceData {
  ...
  static getSizePrefixedRootAsPlaySequenceData(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PlaySequenceData).__init(e.readInt32(e.position()) + e.position(), e)
  }
  path(e) {
  ...
  frameEvents(e, t) {
    ...
    return a ? (t || new sequence_frame_event_js_1.SequenceFrameEvent).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * e), this.bb) : void 0
  }
  frameEventsLength() {
  ...
  static createPlaySequenceData(e, t, a, s, r, i, n) {
    return PlaySequenceData.startPlaySequenceData(e), PlaySequenceData.addPath(e, t), PlaySequenceData.addResetCamera(e, a), PlaySequenceData.addKeepCamera(e, s), PlaySequenceData.addPreLoadRenderAssets(e, r), PlaySequenceData.addFrameEvents(e, i), PlaySequenceData.addSaveFinalPos(e, n), PlaySequenceData.endPlaySequenceData(e)
  }
}
