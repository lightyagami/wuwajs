...
class TalkBackgroundSpineImage {
  ...
  static getSizePrefixedRootAsTalkBackgroundSpineImage(a, e) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TalkBackgroundSpineImage).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createTalkBackgroundSpineImage(a, e, t, i) {
    return TalkBackgroundSpineImage.startTalkBackgroundSpineImage(a), TalkBackgroundSpineImage.addType(a, e), TalkBackgroundSpineImage.addId(a, t), TalkBackgroundSpineImage.addIsLoop(a, i), TalkBackgroundSpineImage.endTalkBackgroundSpineImage(a)
  }
}
