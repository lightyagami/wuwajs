...
class DestroySelf {
  ...
  static getSizePrefixedRootAsDestroySelf(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DestroySelf).__init(t.readInt32(t.position()) + t.position(), t)
  }
  delayDestroy() {
  ...
  static createDestroySelf(t, e) {
    return DestroySelf.startDestroySelf(t), DestroySelf.addDelayDestroy(t, e), DestroySelf.endDestroySelf(t)
  }
}
