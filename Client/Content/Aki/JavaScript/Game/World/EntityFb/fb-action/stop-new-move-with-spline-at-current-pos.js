...
class StopNewMoveWithSplineAtCurrentPos {
  ...
  static getSizePrefixedRootAsStopNewMoveWithSplineAtCurrentPos(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopNewMoveWithSplineAtCurrentPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStopNewMoveWithSplineAtCurrentPos(t, e) {
    return StopNewMoveWithSplineAtCurrentPos.startStopNewMoveWithSplineAtCurrentPos(t), StopNewMoveWithSplineAtCurrentPos.addType(t, e), StopNewMoveWithSplineAtCurrentPos.endStopNewMoveWithSplineAtCurrentPos(t)
  }
}
