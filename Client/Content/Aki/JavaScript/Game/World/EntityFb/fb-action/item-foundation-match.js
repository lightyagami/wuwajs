...
class ItemFoundationMatch {
  ...
  static getSizePrefixedRootAsItemFoundationMatch(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ItemFoundationMatch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  matchEntityId() {
  ...
  static createItemFoundationMatch(t, e) {
    return ItemFoundationMatch.startItemFoundationMatch(t), ItemFoundationMatch.addMatchEntityId(t, e), ItemFoundationMatch.endItemFoundationMatch(t)
  }
}
