...
class SwitchPermission {
  ...
  static getSizePrefixedRootAsSwitchPermission(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SwitchPermission).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSwitchPermission(t, i, s, e) {
    return SwitchPermission.startSwitchPermission(t), SwitchPermission.addType(t, i), SwitchPermission.addIsAllowClientSwitch(t, s), SwitchPermission.addLevels(t, e), SwitchPermission.endSwitchPermission(t)
  }
}
