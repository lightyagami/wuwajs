...
class AppointedVehicle {
  ...
  static getSizePrefixedRootAsAppointedVehicle(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AppointedVehicle).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createAppointedVehicle(e, t, i) {
    return AppointedVehicle.startAppointedVehicle(e), AppointedVehicle.addType(e, t), AppointedVehicle.addVehicleId(e, i), AppointedVehicle.endAppointedVehicle(e)
  }
}
