...
class ActorTurnTo {
  ...
  static getSizePrefixedRootAsActorTurnTo(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorTurnTo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorIndex() {
  ...
  targetType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_actor_turn_to_data_js_1.UnionActorTurnToData.NONE
  }
  target(t) {
  ...
  static createActorTurnTo(t, r, o, s, i) {
    return ActorTurnTo.startActorTurnTo(t), ActorTurnTo.addActorIndex(t, r), ActorTurnTo.addTargetType(t, o), ActorTurnTo.addTarget(t, s), ActorTurnTo.addDelayTime(t, i), ActorTurnTo.endActorTurnTo(t)
  }
}
