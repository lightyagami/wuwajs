...
class PlayGuestUiAnimation {
  ...
  static getSizePrefixedRootAsPlayGuestUiAnimation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PlayGuestUiAnimation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  playGuestUiAnimationType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_play_guest_ui_animation_type_js_1.UnionPlayGuestUiAnimationType.NONE
  }
  ...
  static createPlayGuestUiAnimation(t, i, a, s) {
    return PlayGuestUiAnimation.startPlayGuestUiAnimation(t), PlayGuestUiAnimation.addType(t, i), PlayGuestUiAnimation.addPlayGuestUiAnimationType(t, a), PlayGuestUiAnimation.addPlayGuestUiAnimation(t, s), PlayGuestUiAnimation.endPlayGuestUiAnimation(t)
  }
}
