...
class ControlTrackingOther {
  ...
  static getSizePrefixedRootAsControlTrackingOther(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ControlTrackingOther).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createControlTrackingOther(t, r, i) {
    return ControlTrackingOther.startControlTrackingOther(t), ControlTrackingOther.addType(t, r), ControlTrackingOther.addEntities(t, i), ControlTrackingOther.endControlTrackingOther(t)
  }
}
