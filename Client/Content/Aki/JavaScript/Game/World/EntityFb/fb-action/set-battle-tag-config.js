...
class SetBattleTagConfig {
  ...
  static getRootAsSetBattleTagConfig(t, e) {
    return (e || new SetBattleTagConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSetBattleTagConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetBattleTagConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createSetBattleTagConfig(t, e, i, a) {
    return SetBattleTagConfig.startSetBattleTagConfig(t), SetBattleTagConfig.addEntityId(t, e), SetBattleTagConfig.addTagConfigId(t, i), SetBattleTagConfig.addDelayTime(t, a), SetBattleTagConfig.endSetBattleTagConfig(t)
  }
}
