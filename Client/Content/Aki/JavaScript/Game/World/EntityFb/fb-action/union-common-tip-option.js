...
exports.unionListToUnionCommonTipOption = exports.unionToUnionCommonTipOption = exports.UnionCommonTipOption = undefined;
const bad_bu_king_challenge_tip_js_1 = require("../fb-action/bad-bu-king-challenge-tip.js");
const black_cat_warning_js_1 = require("../fb-action/black-cat-warning.js");
const common_tip_challenge_condition_js_1 = require("../fb-action/common-tip-challenge-condition.js");
const common_tip_challenge_fail_js_1 = require("../fb-action/common-tip-challenge-fail.js");
const common_tip_challenge_success_js_1 = require("../fb-action/common-tip-challenge-success.js");
const common_tip_enter_in_range_js_1 = require("../fb-action/common-tip-enter-in-range.js");
const common_tip_first_complete_js_1 = require("../fb-action/common-tip-first-complete.js");
const common_tip_general_floating_tip_js_1 = require("../fb-action/common-tip-general-floating-tip.js");
const common_tip_id_js_1 = require("../fb-action/common-tip-id.js");
const common_tip_mission_complete_js_1 = require("../fb-action/common-tip-mission-complete.js");
const common_tip_prepare_countdown_js_1 = require("../fb-action/common-tip-prepare-countdown.js");
const common_tip_reach_challenge_js_1 = require("../fb-action/common-tip-reach-challenge.js");
const common_tip_trigger_delegation_js_1 = require("../fb-action/common-tip-trigger-delegation.js");
const dreamless_warning_js_1 = require("../fb-action/dreamless-warning.js");
const punish_report_js_1 = require("../fb-action/punish-report.js");
const remain_star_warning_js_1 = require("../fb-action/remain-star-warning.js");
const slash_and_tower_tip_js_1 = require("../fb-action/slash-and-tower-tip.js");
const white_cat_warning_js_1 = require("../fb-action/white-cat-warning.js");
...
function unionToUnionCommonTipOption(n, e) {
  switch (UnionCommonTipOption[n]) {
    ...
    case "CommonTipChallengeCondition":
      return e(new common_tip_challenge_condition_js_1.CommonTipChallengeCondition());
    ...
    case "CommonTipChallengeSuccess":
      return e(new common_tip_challenge_success_js_1.CommonTipChallengeSuccess());
    ...
    case "CommonTipGeneralFloatingTip":
      return e(new common_tip_general_floating_tip_js_1.CommonTipGeneralFloatingTip());
    case "CommonTipId":
    ...
    case "CommonTipPrepareCountdown":
      return e(new common_tip_prepare_countdown_js_1.CommonTipPrepareCountdown());
    ...
    case "CommonTipTriggerDelegation":
      return e(new common_tip_trigger_delegation_js_1.CommonTipTriggerDelegation());
...
function unionListToUnionCommonTipOption(n, e, o) {
  switch (UnionCommonTipOption[n]) {
    ...
    case "CommonTipChallengeCondition":
      return e(o, new common_tip_challenge_condition_js_1.CommonTipChallengeCondition());
    case "CommonTipChallengeFail":
      return e(o, new common_tip_challenge_fail_js_1.CommonTipChallengeFail());
    case "CommonTipChallengeSuccess":
      return e(o, new common_tip_challenge_success_js_1.CommonTipChallengeSuccess());
    case "CommonTipEnterInRange":
    ...
    case "CommonTipGeneralFloatingTip":
      return e(o, new common_tip_general_floating_tip_js_1.CommonTipGeneralFloatingTip());
    case "CommonTipId":
      return e(o, new common_tip_id_js_1.CommonTipId());
    case "CommonTipMissionComplete":
      return e(o, new common_tip_mission_complete_js_1.CommonTipMissionComplete());
    case "CommonTipPrepareCountdown":
      return e(o, new common_tip_prepare_countdown_js_1.CommonTipPrepareCountdown());
    case "CommonTipReachChallenge":
      return e(o, new common_tip_reach_challenge_js_1.CommonTipReachChallenge());
    case "CommonTipTriggerDelegation":
      return e(o, new common_tip_trigger_delegation_js_1.CommonTipTriggerDelegation());
    case "DreamlessWarning":
...
})(UnionCommonTipOption = exports.UnionCommonTipOption ||= {});
exports.unionToUnionCommonTipOption = unionToUnionCommonTipOption;
exports.unionListToUnionCommonTipOption = unionListToUnionCommonTipOption; //# sourceMappingURL=union-common-tip-option.js.map