...
class AddBuffToPlayer {
  ...
  static getSizePrefixedRootAsAddBuffToPlayer(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AddBuffToPlayer).__init(t.readInt32(t.position()) + t.position(), t)
  }
  buffIds(t) {
  ...
  static createAddBuffToPlayer(t, s, r) {
    return AddBuffToPlayer.startAddBuffToPlayer(t), AddBuffToPlayer.addBuffIds(t, s), AddBuffToPlayer.addPersistOnDestroyBuffIds(t, r), AddBuffToPlayer.endAddBuffToPlayer(t)
  }
}
