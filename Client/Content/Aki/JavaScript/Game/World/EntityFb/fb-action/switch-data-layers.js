...
class SwitchDataLayers {
  ...
  static getRootAsSwitchDataLayers(t, a) {
    return (a || new SwitchDataLayers).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSwitchDataLayers(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new SwitchDataLayers).__init(t.readInt32(t.position()) + t.position(), t)
  }
  loadDataLayers(t) {
  ...
  static createSwitchDataLayers(t, a, s) {
    return SwitchDataLayers.startSwitchDataLayers(t), SwitchDataLayers.addLoadDataLayers(t, a), SwitchDataLayers.addUnloadDataLayers(t, s), SwitchDataLayers.endSwitchDataLayers(t)
  }
}
