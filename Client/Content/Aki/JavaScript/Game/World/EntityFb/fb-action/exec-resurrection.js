...
class ExecResurrection {
  ...
  static getSizePrefixedRootAsExecResurrection(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ExecResurrection).__init(e.readInt32(e.position()) + e.position(), e)
  }
  reviveId() {
  ...
  static createExecResurrection(e, t) {
    return ExecResurrection.startExecResurrection(e), ExecResurrection.addReviveId(e, t), ExecResurrection.endExecResurrection(e)
  }
}
