...
class ToggleScanSplineEffect {
  ...
  static getSizePrefixedRootAsToggleScanSplineEffect(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ToggleScanSplineEffect).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createToggleScanSplineEffect(e, t) {
    return ToggleScanSplineEffect.startToggleScanSplineEffect(e), ToggleScanSplineEffect.addType(e, t), ToggleScanSplineEffect.endToggleScanSplineEffect(e)
  }
}
