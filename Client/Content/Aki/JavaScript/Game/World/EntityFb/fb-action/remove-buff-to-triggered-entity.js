...
class RemoveBuffToTriggeredEntity {
  ...
  static getSizePrefixedRootAsRemoveBuffToTriggeredEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RemoveBuffToTriggeredEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  buffIds(t) {
  ...
  static createRemoveBuffToTriggeredEntity(t, e) {
    return RemoveBuffToTriggeredEntity.startRemoveBuffToTriggeredEntity(t), RemoveBuffToTriggeredEntity.addBuffIds(t, e), RemoveBuffToTriggeredEntity.endRemoveBuffToTriggeredEntity(t)
  }
}
