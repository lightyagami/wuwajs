...
class BattleSettlement {
  ...
  static getSizePrefixedRootAsBattleSettlement(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BattleSettlement).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBattleSettlement(t, e, s) {
    return BattleSettlement.startBattleSettlement(t), BattleSettlement.addType(t, e), BattleSettlement.addGamePlayCue(t, s), BattleSettlement.endBattleSettlement(t)
  }
}
