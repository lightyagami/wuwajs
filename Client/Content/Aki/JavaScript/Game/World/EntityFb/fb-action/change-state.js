...
class ChangeState {
  ...
  static getSizePrefixedRootAsChangeState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateId() {
  ...
  static createChangeState(t, e) {
    return ChangeState.startChangeState(t), ChangeState.addStateId(t, e), ChangeState.endChangeState(t)
  }
}
