...
class CommonTip {
  ...
  static getSizePrefixedRootAsCommonTip(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CommonTip).__init(t.readInt32(t.position()) + t.position(), t)
  }
  tipOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_common_tip_option_js_1.UnionCommonTipOption.NONE
  }
  tipOption(t) {
  ...
  static createCommonTip(t, i, o, n) {
    return CommonTip.startCommonTip(t), CommonTip.addTipOptionType(t, i), CommonTip.addTipOption(t, o), CommonTip.addDuration(t, n), CommonTip.endCommonTip(t)
  }
}
