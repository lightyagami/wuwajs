...
class EntityVarContext {
  ...
  static getSizePrefixedRootAsEntityVarContext(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityVarContext).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createEntityVarContext(t, e, i, r) {
    return EntityVarContext.startEntityVarContext(t), EntityVarContext.addType(t, e), EntityVarContext.addId(t, i), EntityVarContext.addMatchType(t, r), EntityVarContext.endEntityVarContext(t)
  }
}
