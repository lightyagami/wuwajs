...
class GetRewardByInteract {
  ...
  static getSizePrefixedRootAsGetRewardByInteract(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GetRewardByInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createGetRewardByInteract(t) {
    return GetRewardByInteract.startGetRewardByInteract(t), GetRewardByInteract.endGetRewardByInteract(t)
  }
}
