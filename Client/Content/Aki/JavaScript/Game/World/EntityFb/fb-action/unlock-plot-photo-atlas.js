...
class UnlockPlotPhotoAtlas {
  ...
  static getSizePrefixedRootAsUnlockPlotPhotoAtlas(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new UnlockPlotPhotoAtlas).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUnlockPlotPhotoAtlas(t, o, s) {
    return UnlockPlotPhotoAtlas.startUnlockPlotPhotoAtlas(t), UnlockPlotPhotoAtlas.addType(t, o), UnlockPlotPhotoAtlas.addId(t, s), UnlockPlotPhotoAtlas.endUnlockPlotPhotoAtlas(t)
  }
}
