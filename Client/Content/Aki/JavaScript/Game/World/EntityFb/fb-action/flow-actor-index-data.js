...
class FlowActorIndexData {
  ...
  static getSizePrefixedRootAsFlowActorIndexData(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new FlowActorIndexData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  index() {
  ...
  offset(t) {
    ...
    return s ? (t || new pos_and_rot_js_1.PosAndRot).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
