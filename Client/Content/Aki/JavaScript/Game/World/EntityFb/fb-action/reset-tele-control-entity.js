...
class ResetTeleControlEntity {
  ...
  static getSizePrefixedRootAsResetTeleControlEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ResetTeleControlEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createResetTeleControlEntity(t, e, s) {
    return ResetTeleControlEntity.startResetTeleControlEntity(t), ResetTeleControlEntity.addType(t, e), ResetTeleControlEntity.addEntityIds(t, s), ResetTeleControlEntity.endResetTeleControlEntity(t)
  }
}
