...
class Collect {
  ...
  static getSizePrefixedRootAsCollect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new Collect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  targetEntity() {
  ...
  static createCollect(t, e) {
    return Collect.startCollect(t), Collect.addTargetEntity(t, e), Collect.endCollect(t)
  }
}
