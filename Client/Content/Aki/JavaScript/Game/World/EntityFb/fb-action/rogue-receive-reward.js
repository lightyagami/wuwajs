...
class RogueReceiveReward {
  ...
  static getSizePrefixedRootAsRogueReceiveReward(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RogueReceiveReward).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createRogueReceiveReward(e, t) {
    return RogueReceiveReward.startRogueReceiveReward(e), RogueReceiveReward.addRogueRewardReceiveType(e, t), RogueReceiveReward.endRogueReceiveReward(e)
  }
}
