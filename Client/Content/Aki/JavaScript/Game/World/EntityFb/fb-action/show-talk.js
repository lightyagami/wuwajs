...
class ShowTalk {
  ...
  static getSizePrefixedRootAsShowTalk(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ShowTalk).__init(t.readInt32(t.position()) + t.position(), t)
  }
  resetCamera() {
  ...
  talkItems(t, e) {
    ...
    return s ? (e || new talk_item_js_1.TalkItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  talkItemsLength() {
  ...
  talkOutline(t) {
    ...
    return e ? (t || new show_talk_outline_js_1.ShowTalkOutline).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  sequenceDataAsset(t) {
  ...
  talkFrameEvents(t, e) {
    ...
    return s ? (e || new show_talk_frame_event_js_1.ShowTalkFrameEvent).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  talkSequence(t, e) {
    ...
    return s ? (e || new int_array_js_1.IntArray).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  talkSequenceLength() {
  ...
  sequenceNames(t, e) {
    ...
    return s ? this.bb.__string(this.bb.__vector(this.bb_pos + s) + 4 * t, e) : void 0
  }
  sequenceNamesLength() {
  ...
  sequenceTransitions(t, e) {
    ...
    return s ? (e || new record_talk_sequence_transition_js_1.RecordTalkSequenceTransition).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
