...
class CommonTipGeneralFloatingTip {
  ...
  static getRootAsCommonTipGeneralFloatingTip(i, t) {
    return (t || new CommonTipGeneralFloatingTip).__init(i.readInt32(i.position()) + i.position(), i)
  }
  static getSizePrefixedRootAsCommonTipGeneralFloatingTip(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CommonTipGeneralFloatingTip).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type() {
  ...
  static createCommonTipGeneralFloatingTip(i, t, e) {
    return CommonTipGeneralFloatingTip.startCommonTipGeneralFloatingTip(i), CommonTipGeneralFloatingTip.addType(i, t), CommonTipGeneralFloatingTip.addTidMainText(i, e), CommonTipGeneralFloatingTip.endCommonTipGeneralFloatingTip(i)
  }
}
