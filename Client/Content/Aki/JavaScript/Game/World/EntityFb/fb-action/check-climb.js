...
class CheckClimb {
  ...
  static getSizePrefixedRootAsCheckClimb(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckClimb).__init(t.readInt32(t.position()) + t.position(), t)
  }
  direction(t) {
  ...
  static createCheckClimb(t, e, i) {
    return CheckClimb.startCheckClimb(t), CheckClimb.addDirection(t, e), CheckClimb.addDistance(t, i), CheckClimb.endCheckClimb(t)
  }
}
