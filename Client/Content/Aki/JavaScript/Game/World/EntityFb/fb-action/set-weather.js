...
class SetWeather {
  ...
  static getSizePrefixedRootAsSetWeather(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetWeather).__init(t.readInt32(t.position()) + t.position(), t)
  }
  weatherId() {
  ...
  static createSetWeather(t, e, r) {
    return SetWeather.startSetWeather(t), SetWeather.addWeatherId(t, e), SetWeather.addAreaIds(t, r), SetWeather.endSetWeather(t)
  }
}
