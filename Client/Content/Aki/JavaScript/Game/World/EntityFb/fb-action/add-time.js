...
class AddTime {
  ...
  static getSizePrefixedRootAsAddTime(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AddTime).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createAddTime(t, i, e, r, s) {
    return AddTime.startAddTime(t), AddTime.addType(t, i), AddTime.addTime(t, e), AddTime.addVarForTimeType(t, r), AddTime.addVarForTime(t, s), AddTime.endAddTime(t)
  }
}
