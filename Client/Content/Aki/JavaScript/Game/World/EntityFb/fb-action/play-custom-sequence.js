...
class PlayCustomSequence {
  ...
  static getSizePrefixedRootAsPlayCustomSequence(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayCustomSequence).__init(t.readInt32(t.position()) + t.position(), t)
  }
  customSeqId() {
  ...
  static createPlayCustomSequence(t, e, s, r) {
    return PlayCustomSequence.startPlayCustomSequence(t), PlayCustomSequence.addCustomSeqId(t, e), PlayCustomSequence.addWhoIds(t, s), PlayCustomSequence.addResetCamera(t, r), PlayCustomSequence.endPlayCustomSequence(t)
  }
}
