...
exports.unionListToUnionLimitPlayOperation = exports.unionToUnionLimitPlayOperation = exports.UnionLimitPlayOperation = undefined;
const limit_player_action_js_1 = require("../fb-action/limit-player-action.js");
const limit_player_block_all_js_1 = require("../fb-action/limit-player-block-all.js");
const limit_player_camera_js_1 = require("../fb-action/limit-player-camera.js");
const limit_player_mouse_js_1 = require("../fb-action/limit-player-mouse.js");
const limit_player_move_js_1 = require("../fb-action/limit-player-move.js");
const limit_player_move_new_js_1 = require("../fb-action/limit-player-move-new.js");
const limit_player_ui_js_1 = require("../fb-action/limit-player-ui.js");
...
})(UnionLimitPlayOperation = exports.UnionLimitPlayOperation ||= {});
exports.unionToUnionLimitPlayOperation = unionToUnionLimitPlayOperation;
exports.unionListToUnionLimitPlayOperation = unionListToUnionLimitPlayOperation; //# sourceMappingURL=union-limit-play-operation.js.map