...
class SetPlayerPos {
  ...
  static getSizePrefixedRootAsSetPlayerPos(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetPlayerPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  telePortConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_teleport_config_js_1.UnionTeleportConfig.NONE
  }
  telePortConfig(t) {
  ...
  teammateTeleportConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_teammate_teleport_config_js_1.UnionTeammateTeleportConfig.NONE
  }
  ...
  transitionOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_teleport_transition_option_js_1.UnionTeleportTransitionOption.NONE
  }
  transitionOption(t) {
  ...
  static createSetPlayerPos(t, e, i, o, s, r, n, a) {
    return SetPlayerPos.startSetPlayerPos(t), SetPlayerPos.addTelePortConfigType(t, e), SetPlayerPos.addTelePortConfig(t, i), SetPlayerPos.addTeammateTeleportConfigType(t, o), SetPlayerPos.addTeammateTeleportConfig(t, s), SetPlayerPos.addTransitionOptionType(t, r), SetPlayerPos.addTransitionOption(t, n), SetPlayerPos.addDisableAutoFadeInScreen(t, a), SetPlayerPos.endSetPlayerPos(t)
  }
}
