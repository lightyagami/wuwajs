...
class UniversalTone {
  ...
  static getSizePrefixedRootAsUniversalTone(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new UniversalTone).__init(e.readInt32(e.position()) + e.position(), e)
  }
  universalToneId() {
  ...
  static createUniversalTone(e, t, s) {
    return UniversalTone.startUniversalTone(e), UniversalTone.addUniversalToneId(e, t), UniversalTone.addTimberId(e, s), UniversalTone.endUniversalTone(e)
  }
}
