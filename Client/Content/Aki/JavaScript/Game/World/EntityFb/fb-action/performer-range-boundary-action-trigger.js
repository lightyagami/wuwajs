...
class PerformerRangeBoundaryActionTrigger {
  ...
  static getSizePrefixedRootAsPerformerRangeBoundaryActionTrigger(r, e) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PerformerRangeBoundaryActionTrigger).__init(r.readInt32(r.position()) + r.position(), r)
  }
  range() {
  ...
  actions(r, e) {
    ...
    return t ? (e || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + t) + 4 * r), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createPerformerRangeBoundaryActionTrigger(r, e, t) {
    return PerformerRangeBoundaryActionTrigger.startPerformerRangeBoundaryActionTrigger(r), PerformerRangeBoundaryActionTrigger.addRange(r, e), PerformerRangeBoundaryActionTrigger.addActions(r, t), PerformerRangeBoundaryActionTrigger.endPerformerRangeBoundaryActionTrigger(r)
  }
}
