...
class TargetEntity {
  ...
  static getSizePrefixedRootAsTargetEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TargetEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTargetEntity(t, e, i) {
    return TargetEntity.startTargetEntity(t), TargetEntity.addType(t, e), TargetEntity.addEntityId(t, i), TargetEntity.endTargetEntity(t)
  }
}
