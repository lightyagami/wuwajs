...
class LockEntity {
  ...
  static getSizePrefixedRootAsLockEntity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LockEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createLockEntity(t, i) {
    return LockEntity.startLockEntity(t), LockEntity.addEntityIds(t, i), LockEntity.endLockEntity(t)
  }
}
