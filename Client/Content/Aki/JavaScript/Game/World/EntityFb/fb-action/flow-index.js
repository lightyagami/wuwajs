...
class FlowIndex {
  ...
  static getSizePrefixedRootAsFlowIndex(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FlowIndex).__init(t.readInt32(t.position()) + t.position(), t)
  }
  flowListName(t) {
  ...
  static createFlowIndex(t, e, s) {
    return FlowIndex.startFlowIndex(t), FlowIndex.addFlowListName(t, e), FlowIndex.addFlowId(t, s), FlowIndex.endFlowIndex(t)
  }
}
