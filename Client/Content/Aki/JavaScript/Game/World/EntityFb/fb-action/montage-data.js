...
exports.MontageData = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const montage_param_js_1 = require("../fb-action/montage-param.js");
class MontageData {
  constructor() {
    this.bb = undefined;
    this.bb_pos = 0;
  ...
  overlayMontage(t) {
    ...
    if (a) {
      return (t || new montage_param_js_1.MontageParam()).__init(this.bb.__indirect(this.bb_pos + a), this.bb);
    } else {
      return undefined;
    }
  }
