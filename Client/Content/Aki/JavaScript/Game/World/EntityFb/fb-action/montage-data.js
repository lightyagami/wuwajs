...
class MontageData {
  ...
  static getRootAsMontageData(t, a) {
    return (a || new MontageData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsMontageData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new MontageData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorIndex() {
  ...
  overlayMontage(t) {
    ...
    return a ? (t || new montage_param_js_1.MontageParam).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
  faceExpressionId() {
