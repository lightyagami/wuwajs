...
class SetReviveRegion {
  ...
  static getSizePrefixedRootAsSetReviveRegion(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetReviveRegion).__init(e.readInt32(e.position()) + e.position(), e)
  }
  setReviveType(e) {
  ...
  static createSetReviveRegion(e, t, i) {
    return SetReviveRegion.startSetReviveRegion(e), SetReviveRegion.addSetReviveType(e, t), SetReviveRegion.addReviveId(e, i), SetReviveRegion.endSetReviveRegion(e)
  }
}
