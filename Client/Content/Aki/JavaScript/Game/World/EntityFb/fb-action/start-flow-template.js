...
class StartFlowTemplate {
  ...
  static getSizePrefixedRootAsStartFlowTemplate(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new StartFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  templateMode(t) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (t || new flow_template_mode_js_1.FlowTemplateMode).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
  targetPos(t) {
    var r = this.bb.__offset(this.bb_pos, 6);
    return r ? (t || new pos_a_js_1.PosA).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
  actorIdArray(t) {
