...
class SetSpineAnimation {
  ...
  static getSizePrefixedRootAsSetSpineAnimation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetSpineAnimation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  configType() {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? this.bb.readUint8(this.bb_pos + i) : union_set_spine_animation_js_1.UnionSetSpineAnimation.NONE
  }
  config(i) {
  ...
  static createSetSpineAnimation(i, t, n) {
    return SetSpineAnimation.startSetSpineAnimation(i), SetSpineAnimation.addConfigType(i, t), SetSpineAnimation.addConfig(i, n), SetSpineAnimation.endSetSpineAnimation(i)
  }
}
