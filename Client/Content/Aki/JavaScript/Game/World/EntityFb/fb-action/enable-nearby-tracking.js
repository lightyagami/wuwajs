...
class EnableNearbyTracking {
  ...
  static getSizePrefixedRootAsEnableNearbyTracking(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EnableNearbyTracking).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isEnable() {
  ...
  controlTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_control_tracking_type_js_1.UnionControlTrackingType.NONE
  }
  controlType(t) {
  ...
  static createEnableNearbyTracking(t, r, e, a) {
    return EnableNearbyTracking.startEnableNearbyTracking(t), EnableNearbyTracking.addIsEnable(t, r), EnableNearbyTracking.addControlTypeType(t, e), EnableNearbyTracking.addControlType(t, a), EnableNearbyTracking.endEnableNearbyTracking(t)
  }
}
