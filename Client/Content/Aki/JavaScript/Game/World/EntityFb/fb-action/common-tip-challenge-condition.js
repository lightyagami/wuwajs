...
class CommonTipChallengeCondition {
  ...
  static getSizePrefixedRootAsCommonTipChallengeCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CommonTipChallengeCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type() {
  ...
  static createCommonTipChallengeCondition(i, t, n, o) {
    return CommonTipChallengeCondition.startCommonTipChallengeCondition(i), CommonTipChallengeCondition.addType(i, t), CommonTipChallengeCondition.addTidMainText(i, n), CommonTipChallengeCondition.addTidSubText(i, o), CommonTipChallengeCondition.endCommonTipChallengeCondition(i)
  }
}
