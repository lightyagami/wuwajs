...
class PlayVoicePassengersConfig {
  ...
  static getSizePrefixedRootAsPlayVoicePassengersConfig(s, e) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PlayVoicePassengersConfig).__init(s.readInt32(s.position()) + s.position(), s)
  }
  passengers(s) {
  ...
  passengersArray() {
    var s = this.bb.__offset(this.bb_pos, 4);
    return s ? new Int32Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + s), this.bb.__vector_len(this.bb_pos + s)) : void 0
  }
  matchNone() {
  ...
  static createPlayVoicePassengersConfig(s, e, t) {
    return PlayVoicePassengersConfig.startPlayVoicePassengersConfig(s), PlayVoicePassengersConfig.addPassengers(s, e), PlayVoicePassengersConfig.addMatchNone(s, t), PlayVoicePassengersConfig.endPlayVoicePassengersConfig(s)
  }
}
