...
class EntityTurnTo {
  ...
  static getSizePrefixedRootAsEntityTurnTo(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EntityTurnTo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createEntityTurnTo(t, r, i, n) {
    return EntityTurnTo.startEntityTurnTo(t), EntityTurnTo.addEntityId(t, r), EntityTurnTo.addTargetType(t, i), EntityTurnTo.addTarget(t, n), EntityTurnTo.endEntityTurnTo(t)
  }
}
