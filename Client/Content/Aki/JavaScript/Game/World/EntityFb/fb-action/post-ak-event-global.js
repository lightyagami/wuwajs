...
class PostAkEventGlobal {
  ...
  static getSizePrefixedRootAsPostAkEventGlobal(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PostAkEventGlobal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPostAkEventGlobal(t, s, e) {
    return PostAkEventGlobal.startPostAkEventGlobal(t), PostAkEventGlobal.addType(t, s), PostAkEventGlobal.addAkEvent(t, e), PostAkEventGlobal.endPostAkEventGlobal(t)
  }
}
