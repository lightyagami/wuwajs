...
class HeadStyleNormal {
  ...
  static getSizePrefixedRootAsHeadStyleNormal(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HeadStyleNormal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createHeadStyleNormal(t, e, a) {
    return HeadStyleNormal.startHeadStyleNormal(t), HeadStyleNormal.addType(t, e), HeadStyleNormal.addWhoId(t, a), HeadStyleNormal.endHeadStyleNormal(t)
  }
}
