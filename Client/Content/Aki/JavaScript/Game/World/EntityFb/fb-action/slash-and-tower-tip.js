...
class SlashAndTowerTip {
  ...
  static getSizePrefixedRootAsSlashAndTowerTip(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new SlashAndTowerTip).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createSlashAndTowerTip(t, s, e) {
    return SlashAndTowerTip.startSlashAndTowerTip(t), SlashAndTowerTip.addType(t, s), SlashAndTowerTip.addWarningText(t, e), SlashAndTowerTip.endSlashAndTowerTip(t)
  }
}
