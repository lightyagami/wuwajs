...
class RemainStarWarning {
  ...
  static getSizePrefixedRootAsRemainStarWarning(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new RemainStarWarning).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createRemainStarWarning(t, a, i) {
    return RemainStarWarning.startRemainStarWarning(t), RemainStarWarning.addType(t, a), RemainStarWarning.addWarningText(t, i), RemainStarWarning.endRemainStarWarning(t)
  }
}
