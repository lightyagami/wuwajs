...
class TalkOptionQteSucceedDelayExec {
  ...
  static getSizePrefixedRootAsTalkOptionQteSucceedDelayExec(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TalkOptionQteSucceedDelayExec).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createTalkOptionQteSucceedDelayExec(e, t) {
    return TalkOptionQteSucceedDelayExec.startTalkOptionQteSucceedDelayExec(e), TalkOptionQteSucceedDelayExec.addType(e, t), TalkOptionQteSucceedDelayExec.endTalkOptionQteSucceedDelayExec(e)
  }
}
