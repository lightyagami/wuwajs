...
class ChangeSelfEntityState {
  ...
  static getSizePrefixedRootAsChangeSelfEntityState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeSelfEntityState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityState(t) {
  ...
  static createChangeSelfEntityState(t, e) {
    return ChangeSelfEntityState.startChangeSelfEntityState(t), ChangeSelfEntityState.addEntityState(t, e), ChangeSelfEntityState.endChangeSelfEntityState(t)
  }
}
