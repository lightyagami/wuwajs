...
exports.unionListToUnionHeadStyle = exports.unionToUnionHeadStyle = exports.UnionHeadStyle = undefined;
const head_style_monster_display_js_1 = require("../fb-action/head-style-monster-display.js");
const head_style_normal_js_1 = require("../fb-action/head-style-normal.js");
const head_style_voice_only_js_1 = require("../fb-action/head-style-voice-only.js");
const head_style_warning_js_1 = require("../fb-action/head-style-warning.js");
const head_style_weak_signal_js_1 = require("../fb-action/head-style-weak-signal.js");
var UnionHeadStyle;
...
function unionListToUnionHeadStyle(e, a, n) {
  switch (UnionHeadStyle[e]) {
    case "NONE":
      return;
    case "HeadStyleMonsterDisplay":
      return a(n, new head_style_monster_display_js_1.HeadStyleMonsterDisplay());
    case "HeadStyleNormal":
...
})(UnionHeadStyle = exports.UnionHeadStyle ||= {});
exports.unionToUnionHeadStyle = unionToUnionHeadStyle;
exports.unionListToUnionHeadStyle = unionListToUnionHeadStyle; //# sourceMappingURL=union-head-style.js.map