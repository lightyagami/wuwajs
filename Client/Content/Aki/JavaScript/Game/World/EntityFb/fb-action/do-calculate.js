...
class DoCalculate {
  ...
  static getSizePrefixedRootAsDoCalculate(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new DoCalculate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  var1Type() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_var_js_1.UnionVar.NONE
  }
  var1(t) {
  ...
  static createDoCalculate(t, a, s, i, e, r, u) {
    return DoCalculate.startDoCalculate(t), DoCalculate.addVar1Type(t, a), DoCalculate.addVar1(t, s), DoCalculate.addOp(t, i), DoCalculate.addVar2Type(t, e), DoCalculate.addVar2(t, r), DoCalculate.addResult(t, u), DoCalculate.endDoCalculate(t)
  }
}
