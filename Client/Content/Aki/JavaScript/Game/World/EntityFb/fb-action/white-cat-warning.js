...
class WhiteCatWarning {
  ...
  static getSizePrefixedRootAsWhiteCatWarning(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new WhiteCatWarning).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createWhiteCatWarning(t, i, e) {
    return WhiteCatWarning.startWhiteCatWarning(t), WhiteCatWarning.addType(t, i), WhiteCatWarning.addWarningText(t, e), WhiteCatWarning.endWhiteCatWarning(t)
  }
}
