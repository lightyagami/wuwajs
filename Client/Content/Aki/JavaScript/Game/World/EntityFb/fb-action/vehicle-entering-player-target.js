...
class VehicleEnteringPlayerTarget {
  ...
  static getSizePrefixedRootAsVehicleEnteringPlayerTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleEnteringPlayerTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createVehicleEnteringPlayerTarget(e, t, r) {
    return VehicleEnteringPlayerTarget.startVehicleEnteringPlayerTarget(e), VehicleEnteringPlayerTarget.addType(e, t), VehicleEnteringPlayerTarget.addTargetVehicle(e, r), VehicleEnteringPlayerTarget.endVehicleEnteringPlayerTarget(e)
  }
}
