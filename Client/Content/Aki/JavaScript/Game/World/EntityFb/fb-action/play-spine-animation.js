...
class PlaySpineAnimation {
  ...
  static getSizePrefixedRootAsPlaySpineAnimation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PlaySpineAnimation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createPlaySpineAnimation(i, t, n, a) {
    return PlaySpineAnimation.startPlaySpineAnimation(i), PlaySpineAnimation.addType(i, t), PlaySpineAnimation.addName(i, n), PlaySpineAnimation.addIsLoop(i, a), PlaySpineAnimation.endPlaySpineAnimation(i)
  }
}
