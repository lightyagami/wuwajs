...
class CloseAirWall {
  ...
  static getSizePrefixedRootAsCloseAirWall(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CloseAirWall).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCloseAirWall(t, e) {
    return CloseAirWall.startCloseAirWall(t), CloseAirWall.addType(t, e), CloseAirWall.endCloseAirWall(t)
  }
}
