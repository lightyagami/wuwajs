...
class SetGlobalTimeScale {
  ...
  static getSizePrefixedRootAsSetGlobalTimeScale(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetGlobalTimeScale).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  configType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_set_global_time_scale_js_1.UnionSetGlobalTimeScale.NONE
  }
  config(e) {
  ...
  static createSetGlobalTimeScale(e, t, i, l) {
    return SetGlobalTimeScale.startSetGlobalTimeScale(e), SetGlobalTimeScale.addType(e, t), SetGlobalTimeScale.addConfigType(e, i), SetGlobalTimeScale.addConfig(e, l), SetGlobalTimeScale.endSetGlobalTimeScale(e)
  }
}
