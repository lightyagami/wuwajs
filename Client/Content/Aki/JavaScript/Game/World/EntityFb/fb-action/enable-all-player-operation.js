...
class EnableAllPlayerOperation {
  ...
  static getSizePrefixedRootAsEnableAllPlayerOperation(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableAllPlayerOperation).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnableAllPlayerOperation(e, t) {
    return EnableAllPlayerOperation.startEnableAllPlayerOperation(e), EnableAllPlayerOperation.addType(e, t), EnableAllPlayerOperation.endEnableAllPlayerOperation(e)
  }
}
