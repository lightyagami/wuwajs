...
class ModifySelfSceneItemAttributeTag {
  ...
  static getSizePrefixedRootAsModifySelfSceneItemAttributeTag(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ModifySelfSceneItemAttributeTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createModifySelfSceneItemAttributeTag(t, e, i, r) {
    return ModifySelfSceneItemAttributeTag.startModifySelfSceneItemAttributeTag(t), ModifySelfSceneItemAttributeTag.addType(t, e), ModifySelfSceneItemAttributeTag.addIsAddTag(t, i), ModifySelfSceneItemAttributeTag.addPerformanceTag(t, r), ModifySelfSceneItemAttributeTag.endModifySelfSceneItemAttributeTag(t)
  }
}
