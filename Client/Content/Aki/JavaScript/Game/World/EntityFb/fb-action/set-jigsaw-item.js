...
class SetJigsawItem {
  ...
  static getSizePrefixedRootAsSetJigsawItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetJigsawItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_set_jigsaw_item_js_1.UnionSetJigsawItem.NONE
  }
  config(t) {
  ...
  static createSetJigsawItem(t, e, s) {
    return SetJigsawItem.startSetJigsawItem(t), SetJigsawItem.addConfigType(t, e), SetJigsawItem.addConfig(t, s), SetJigsawItem.endSetJigsawItem(t)
  }
}
