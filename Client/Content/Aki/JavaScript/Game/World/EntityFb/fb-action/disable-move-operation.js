...
class DisableMoveOperation {
  ...
  static getRootAsDisableMoveOperation(t, i) {
    return (i || new DisableMoveOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsDisableMoveOperation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DisableMoveOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDisableMoveOperation(t, i, e, s, a, r, o, n, h) {
    return DisableMoveOperation.startDisableMoveOperation(t), DisableMoveOperation.addType(t, i), DisableMoveOperation.addForward(t, e), DisableMoveOperation.addBack(t, s), DisableMoveOperation.addLeft(t, a), DisableMoveOperation.addRight(t, r), DisableMoveOperation.addForceWalk(t, o), DisableMoveOperation.addForceJog(t, n), DisableMoveOperation.addForbidSprint(t, h), DisableMoveOperation.endDisableMoveOperation(t)
  }
}
