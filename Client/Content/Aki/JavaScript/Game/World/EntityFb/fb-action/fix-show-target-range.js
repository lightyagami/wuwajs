...
class FixShowTargetRange {
  ...
  static getSizePrefixedRootAsFixShowTargetRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FixShowTargetRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  rangeEntities(t) {
  ...
  static createFixShowTargetRange(t, e, i) {
    return FixShowTargetRange.startFixShowTargetRange(t), FixShowTargetRange.addRangeEntities(t, e), FixShowTargetRange.addDelayShow(t, i), FixShowTargetRange.endFixShowTargetRange(t)
  }
}
