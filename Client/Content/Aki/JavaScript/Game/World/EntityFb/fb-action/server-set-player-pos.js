...
class ServerSetPlayerPos {
  ...
  static getSizePrefixedRootAsServerSetPlayerPos(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ServerSetPlayerPos).__init(e.readInt32(e.position()) + e.position(), e)
  }
  pos(e) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (e || new pos_a_js_1.PosA).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
  ...
  static createServerSetPlayerPos(e, r) {
    return ServerSetPlayerPos.startServerSetPlayerPos(e), ServerSetPlayerPos.addPos(e, r), ServerSetPlayerPos.endServerSetPlayerPos(e)
  }
}
