...
class CustomAlertValue {
  ...
  static getSizePrefixedRootAsCustomAlertValue(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CustomAlertValue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCustomAlertValue(t, e, s) {
    return CustomAlertValue.startCustomAlertValue(t), CustomAlertValue.addType(t, e), CustomAlertValue.addCustomValue(t, s), CustomAlertValue.endCustomAlertValue(t)
  }
}
