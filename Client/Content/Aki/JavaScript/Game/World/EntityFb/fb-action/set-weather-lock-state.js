...
class SetWeatherLockState {
  ...
  static getSizePrefixedRootAsSetWeatherLockState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetWeatherLockState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  lockState(t) {
  ...
  static createSetWeatherLockState(t, e, r) {
    return SetWeatherLockState.startSetWeatherLockState(t), SetWeatherLockState.addLockState(t, e), SetWeatherLockState.addAreaIds(t, r), SetWeatherLockState.endSetWeatherLockState(t)
  }
}
