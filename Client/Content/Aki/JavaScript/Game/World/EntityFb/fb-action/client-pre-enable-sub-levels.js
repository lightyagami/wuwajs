...
class ClientPreEnableSubLevels {
  ...
  static getSizePrefixedRootAsClientPreEnableSubLevels(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ClientPreEnableSubLevels).__init(e.readInt32(e.position()) + e.position(), e)
  }
  enableLevels(e, t) {
    var s = this.bb.__offset(this.bb_pos, 4);
    return s ? this.bb.__string(this.bb.__vector(this.bb_pos + s) + 4 * e, t) : void 0
  }
  enableLevelsLength() {
  ...
  transitionOptionType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_enable_sub_level_transition_js_1.UnionEnableSubLevelTransition.NONE
  }
  transitionOption(e) {
  ...
  static createClientPreEnableSubLevels(e, t, s, i, n) {
    return ClientPreEnableSubLevels.startClientPreEnableSubLevels(e), ClientPreEnableSubLevels.addEnableLevels(e, t), ClientPreEnableSubLevels.addDisableLevels(e, s), ClientPreEnableSubLevels.addTransitionOptionType(e, i), ClientPreEnableSubLevels.addTransitionOption(e, n), ClientPreEnableSubLevels.endClientPreEnableSubLevels(e)
  }
}
