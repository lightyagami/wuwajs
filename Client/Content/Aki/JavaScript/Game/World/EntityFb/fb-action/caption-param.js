...
class CaptionParam {
  ...
  static getSizePrefixedRootAsCaptionParam(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CaptionParam).__init(t.readInt32(t.position()) + t.position(), t)
  }
  startTime() {
  ...
  static createCaptionParam(t, a, i, r) {
    return CaptionParam.startCaptionParam(t), CaptionParam.addStartTime(t, a), CaptionParam.addTotalTime(t, i), CaptionParam.addIntervalTime(t, r), CaptionParam.endCaptionParam(t)
  }
}
