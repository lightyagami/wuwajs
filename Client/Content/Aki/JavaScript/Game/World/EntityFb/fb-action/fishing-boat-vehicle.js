...
class FishingBoatVehicle {
  ...
  static getSizePrefixedRootAsFishingBoatVehicle(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FishingBoatVehicle).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createFishingBoatVehicle(i, t) {
    return FishingBoatVehicle.startFishingBoatVehicle(i), FishingBoatVehicle.addType(i, t), FishingBoatVehicle.endFishingBoatVehicle(i)
  }
}
