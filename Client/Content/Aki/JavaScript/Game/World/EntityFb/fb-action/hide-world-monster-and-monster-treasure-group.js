...
class HideWorldMonsterAndMonsterTreasureGroup {
  ...
  static getSizePrefixedRootAsHideWorldMonsterAndMonsterTreasureGroup(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new HideWorldMonsterAndMonsterTreasureGroup).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  hideRangeEntitiesArray() {
    var e = this.bb.__offset(this.bb_pos, 6);
    return e ? new Int32Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + e), this.bb.__vector_len(this.bb_pos + e)) : void 0
  }
  ...
  static createHideWorldMonsterAndMonsterTreasureGroup(e, r, t) {
    return HideWorldMonsterAndMonsterTreasureGroup.startHideWorldMonsterAndMonsterTreasureGroup(e), HideWorldMonsterAndMonsterTreasureGroup.addType(e, r), HideWorldMonsterAndMonsterTreasureGroup.addHideRangeEntities(e, t), HideWorldMonsterAndMonsterTreasureGroup.endHideWorldMonsterAndMonsterTreasureGroup(e)
  }
}
