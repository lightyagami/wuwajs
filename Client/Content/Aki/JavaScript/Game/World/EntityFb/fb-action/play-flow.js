...
class PlayFlow {
  ...
  static getSizePrefixedRootAsPlayFlow(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PlayFlow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  flowListName(t) {
  ...
  static createPlayFlow(t, s, i, a, l) {
    return PlayFlow.startPlayFlow(t), PlayFlow.addFlowListName(t, s), PlayFlow.addFlowId(t, i), PlayFlow.addStateId(t, a), PlayFlow.addFlowGuid(t, l), PlayFlow.endPlayFlow(t)
  }
}
