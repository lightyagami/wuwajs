...
class UnlockCookSystemCookBook {
  ...
  static getSizePrefixedRootAsUnlockCookSystemCookBook(o, t) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new UnlockCookSystemCookBook).__init(o.readInt32(o.position()) + o.position(), o)
  }
  type(o) {
  ...
  static createUnlockCookSystemCookBook(o, t, k) {
    return UnlockCookSystemCookBook.startUnlockCookSystemCookBook(o), UnlockCookSystemCookBook.addType(o, t), UnlockCookSystemCookBook.addCookBookId(o, k), UnlockCookSystemCookBook.endUnlockCookSystemCookBook(o)
  }
}
