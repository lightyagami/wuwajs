...
class CycleMoveToPoints {
  ...
  static getSizePrefixedRootAsCycleMoveToPoints(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new CycleMoveToPoints).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, o) {
    ...
    return e ? (o || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  moveMotionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_move_to_point_type_js_1.UnionMoveToPointType.NONE
  }
  moveMotion(t) {
  ...
  static createCycleMoveToPoints(t, o, e, i, s, n, r) {
    return CycleMoveToPoints.startCycleMoveToPoints(t), CycleMoveToPoints.addType(t, o), CycleMoveToPoints.addPoints(t, e), CycleMoveToPoints.addIsLoop(t, i), CycleMoveToPoints.addStopTime(t, s), CycleMoveToPoints.addMoveMotionType(t, n), CycleMoveToPoints.addMoveMotion(t, r), CycleMoveToPoints.endCycleMoveToPoints(t)
  }
}
