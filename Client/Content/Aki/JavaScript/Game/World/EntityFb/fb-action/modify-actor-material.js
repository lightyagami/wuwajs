...
class ModifyActorMaterial {
  ...
  static getSizePrefixedRootAsModifyActorMaterial(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ModifyActorMaterial).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actorRefs(t, r) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (r || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  actorRefsLength() {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_modify_actor_material_type_js_1.UnionModifyActorMaterialType.NONE
  }
  config(t) {
  ...
  static createModifyActorMaterial(t, r, i, e) {
    return ModifyActorMaterial.startModifyActorMaterial(t), ModifyActorMaterial.addActorRefs(t, r), ModifyActorMaterial.addConfigType(t, i), ModifyActorMaterial.addConfig(t, e), ModifyActorMaterial.endModifyActorMaterial(t)
  }
}
