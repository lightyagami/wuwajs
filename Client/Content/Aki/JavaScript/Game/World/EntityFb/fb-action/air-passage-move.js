...
class AirPassageMove {
  ...
  static getSizePrefixedRootAsAirPassageMove(s, t) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AirPassageMove).__init(s.readInt32(s.position()) + s.position(), s)
  }
  type(s) {
  ...
  static createAirPassageMove(s, t, e, a, i) {
    return AirPassageMove.startAirPassageMove(s), AirPassageMove.addType(s, t), AirPassageMove.addMaxOffsetDistance(s, e), AirPassageMove.addIsOneWay(s, a), AirPassageMove.addLayerVerticalLimit(s, i), AirPassageMove.endAirPassageMove(s)
  }
}
