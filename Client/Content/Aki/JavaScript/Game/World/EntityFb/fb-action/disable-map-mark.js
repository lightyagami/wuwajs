...
class DisableMapMark {
  ...
  static getSizePrefixedRootAsDisableMapMark(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableMapMark).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createDisableMapMark(a, t, s) {
    return DisableMapMark.startDisableMapMark(a), DisableMapMark.addType(a, t), DisableMapMark.addMarkId(a, s), DisableMapMark.endDisableMapMark(a)
  }
}
