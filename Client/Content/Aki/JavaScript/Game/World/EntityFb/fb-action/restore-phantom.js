...
class RestorePhantom {
  ...
  static getSizePrefixedRootAsRestorePhantom(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RestorePhantom).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createRestorePhantom(t) {
    return RestorePhantom.startRestorePhantom(t), RestorePhantom.endRestorePhantom(t)
  }
}
