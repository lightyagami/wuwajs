...
class FocusOnMapMark {
  ...
  static getSizePrefixedRootAsFocusOnMapMark(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new FocusOnMapMark).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFocusOnMapMark(t, s) {
    return FocusOnMapMark.startFocusOnMapMark(t), FocusOnMapMark.addType(t, s), FocusOnMapMark.endFocusOnMapMark(t)
  }
}
