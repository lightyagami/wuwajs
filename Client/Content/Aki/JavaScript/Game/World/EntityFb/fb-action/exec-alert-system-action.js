...
class ExecAlertSystemAction {
  ...
  static getSizePrefixedRootAsExecAlertSystemAction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExecAlertSystemAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_alert_system_option_js_1.UnionAlertSystemOption.NONE
  }
  option(t) {
  ...
  static createExecAlertSystemAction(t, e, s) {
    return ExecAlertSystemAction.startExecAlertSystemAction(t), ExecAlertSystemAction.addOptionType(t, e), ExecAlertSystemAction.addOption(t, s), ExecAlertSystemAction.endExecAlertSystemAction(t)
  }
}
