...
class SundialPuzzleGameplay {
  ...
  static getSizePrefixedRootAsSundialPuzzleGameplay(e, a) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new SundialPuzzleGameplay).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSundialPuzzleGameplay(e, a) {
    return SundialPuzzleGameplay.startSundialPuzzleGameplay(e), SundialPuzzleGameplay.addType(e, a), SundialPuzzleGameplay.endSundialPuzzleGameplay(e)
  }
}
