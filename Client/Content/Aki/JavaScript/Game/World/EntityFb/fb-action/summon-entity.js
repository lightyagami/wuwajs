...
class SummonEntity {
  ...
  static getSizePrefixedRootAsSummonEntity(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new SummonEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  summonEntityConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_summon_entity_type_js_1.UnionSummonEntityType.NONE
  }
  ...
  static createSummonEntity(t, n, i) {
    return SummonEntity.startSummonEntity(t), SummonEntity.addSummonEntityConfigType(t, n), SummonEntity.addSummonEntityConfig(t, i), SummonEntity.endSummonEntity(t)
  }
}
