...
class OpenTraceSpline {
  ...
  static getSizePrefixedRootAsOpenTraceSpline(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OpenTraceSpline).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createOpenTraceSpline(e, t, i, r) {
    return OpenTraceSpline.startOpenTraceSpline(e), OpenTraceSpline.addType(e, t), OpenTraceSpline.addSplineEntityId(e, i), OpenTraceSpline.addDuration(e, r), OpenTraceSpline.endOpenTraceSpline(e)
  }
}
