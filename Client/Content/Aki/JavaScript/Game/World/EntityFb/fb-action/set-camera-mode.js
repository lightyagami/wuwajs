...
class SetCameraMode {
  ...
  static getSizePrefixedRootAsSetCameraMode(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SetCameraMode).__init(e.readInt32(e.position()) + e.position(), e)
  }
  mode(e) {
  ...
  static createSetCameraMode(e, t) {
    return SetCameraMode.startSetCameraMode(e), SetCameraMode.addMode(e, t), SetCameraMode.endSetCameraMode(e)
  }
}
