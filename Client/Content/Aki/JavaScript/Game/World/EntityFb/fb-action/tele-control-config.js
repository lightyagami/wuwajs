...
class TeleControlConfig {
  ...
  static getSizePrefixedRootAsTeleControlConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleControlConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTeleControlConfig(t, e, o) {
    return TeleControlConfig.startTeleControlConfig(t), TeleControlConfig.addType(t, e), TeleControlConfig.addTeleControlType(t, o), TeleControlConfig.endTeleControlConfig(t)
  }
}
