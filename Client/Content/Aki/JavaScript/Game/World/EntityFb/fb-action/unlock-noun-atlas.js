...
class UnlockNounAtlas {
  ...
  static getSizePrefixedRootAsUnlockNounAtlas(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new UnlockNounAtlas).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createUnlockNounAtlas(t, s, n) {
    return UnlockNounAtlas.startUnlockNounAtlas(t), UnlockNounAtlas.addType(t, s), UnlockNounAtlas.addId(t, n), UnlockNounAtlas.endUnlockNounAtlas(t)
  }
}
