...
class DelayRemoveAfterSkillFinish {
  ...
  static getSizePrefixedRootAsDelayRemoveAfterSkillFinish(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DelayRemoveAfterSkillFinish).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createDelayRemoveAfterSkillFinish(e, i) {
    return DelayRemoveAfterSkillFinish.startDelayRemoveAfterSkillFinish(e), DelayRemoveAfterSkillFinish.addType(e, i), DelayRemoveAfterSkillFinish.endDelayRemoveAfterSkillFinish(e)
  }
}
