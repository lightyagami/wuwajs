...
class SkillBlackboardVector {
  ...
  static getRootAsSkillBlackboardVector(t, r) {
    return (r || new SkillBlackboardVector).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSkillBlackboardVector(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new SkillBlackboardVector).__init(t.readInt32(t.position()) + t.position(), t)
  }
  key(t) {
