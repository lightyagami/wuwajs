...
class CommonTipTriggerDelegation {
  ...
  static getSizePrefixedRootAsCommonTipTriggerDelegation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CommonTipTriggerDelegation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type() {
  ...
  static createCommonTipTriggerDelegation(i, t, e, r) {
    return CommonTipTriggerDelegation.startCommonTipTriggerDelegation(i), CommonTipTriggerDelegation.addType(i, t), CommonTipTriggerDelegation.addTidMainText(i, e), CommonTipTriggerDelegation.addTidSubText(i, r), CommonTipTriggerDelegation.endCommonTipTriggerDelegation(i)
  }
}
