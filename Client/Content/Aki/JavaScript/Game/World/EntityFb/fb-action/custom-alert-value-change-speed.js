...
class CustomAlertValueChangeSpeed {
  ...
  static getSizePrefixedRootAsCustomAlertValueChangeSpeed(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CustomAlertValueChangeSpeed).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createCustomAlertValueChangeSpeed(e, t, s) {
    return CustomAlertValueChangeSpeed.startCustomAlertValueChangeSpeed(e), CustomAlertValueChangeSpeed.addType(e, t), CustomAlertValueChangeSpeed.addCustomValue(e, s), CustomAlertValueChangeSpeed.endCustomAlertValueChangeSpeed(e)
  }
}
