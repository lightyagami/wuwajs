...
class ICenterTextFadeOut {
  ...
  static getSizePrefixedRootAsICenterTextFadeOut(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ICenterTextFadeOut).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createICenterTextFadeOut(t, e, r, s) {
    return ICenterTextFadeOut.startICenterTextFadeOut(t), ICenterTextFadeOut.addType(t, e), ICenterTextFadeOut.addFadeInTime(t, r), ICenterTextFadeOut.addFadeOutTime(t, s), ICenterTextFadeOut.endICenterTextFadeOut(t)
  }
}
