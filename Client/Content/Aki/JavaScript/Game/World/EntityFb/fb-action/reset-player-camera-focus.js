...
class ResetPlayerCameraFocus {
  ...
  static getSizePrefixedRootAsResetPlayerCameraFocus(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetPlayerCameraFocus).__init(e.readInt32(e.position()) + e.position(), e)
  }
  resetTypeType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_reset_player_focus_type_js_1.UnionResetPlayerFocusType.NONE
  }
  resetType(e) {
  ...
  static createResetPlayerCameraFocus(e, t, s, r, a, i) {
    return ResetPlayerCameraFocus.startResetPlayerCameraFocus(e), ResetPlayerCameraFocus.addResetTypeType(e, t), ResetPlayerCameraFocus.addResetType(e, s), ResetPlayerCameraFocus.addFadeInTime(e, r), ResetPlayerCameraFocus.addCannotInterrupt(e, a), ResetPlayerCameraFocus.addDuration(e, i), ResetPlayerCameraFocus.endResetPlayerCameraFocus(e)
  }
}
