...
class EntityLookAt {
  ...
  static getRootAsEntityLookAt(t, i) {
    return (i || new EntityLookAt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEntityLookAt(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityLookAt).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
