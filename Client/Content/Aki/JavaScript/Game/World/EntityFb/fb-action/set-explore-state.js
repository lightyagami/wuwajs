...
class SetExploreState {
  ...
  static getSizePrefixedRootAsSetExploreState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetExploreState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_explore_state_js_1.UnionExploreState.NONE
  }
  config(t) {
  ...
  static createSetExploreState(t, e, r) {
    return SetExploreState.startSetExploreState(t), SetExploreState.addConfigType(t, e), SetExploreState.addConfig(t, r), SetExploreState.endSetExploreState(t)
  }
}
