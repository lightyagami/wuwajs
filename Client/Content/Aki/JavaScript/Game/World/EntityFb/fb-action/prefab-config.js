...
class PrefabConfig {
  ...
  static getSizePrefixedRootAsPrefabConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PrefabConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createPrefabConfig(t, e, r) {
    return PrefabConfig.startPrefabConfig(t), PrefabConfig.addType(t, e), PrefabConfig.addPrefabId(t, r), PrefabConfig.endPrefabConfig(t)
  }
}
