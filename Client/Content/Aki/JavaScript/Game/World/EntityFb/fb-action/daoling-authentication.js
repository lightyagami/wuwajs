...
class DaolingAuthentication {
  ...
  static getSizePrefixedRootAsDaolingAuthentication(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DaolingAuthentication).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDaolingAuthentication(t, i) {
    return DaolingAuthentication.startDaolingAuthentication(t), DaolingAuthentication.addType(t, i), DaolingAuthentication.endDaolingAuthentication(t)
  }
}
