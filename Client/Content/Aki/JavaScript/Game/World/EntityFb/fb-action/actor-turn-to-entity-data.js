...
class ActorTurnToEntityData {
  ...
  static getSizePrefixedRootAsActorTurnToEntityData(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorTurnToEntityData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createActorTurnToEntityData(t, r, a) {
    return ActorTurnToEntityData.startActorTurnToEntityData(t), ActorTurnToEntityData.addType(t, r), ActorTurnToEntityData.addEntityId(t, a), ActorTurnToEntityData.endActorTurnToEntityData(t)
  }
}
