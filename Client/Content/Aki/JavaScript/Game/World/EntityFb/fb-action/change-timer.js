...
class ChangeTimer {
  ...
  static getSizePrefixedRootAsChangeTimer(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ChangeTimer).__init(e.readInt32(e.position()) + e.position(), e)
  }
  timerType(e) {
  ...
  changeTypeType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_change_timer_js_1.UnionChangeTimer.NONE
  }
  changeType(e) {
  ...
  static createChangeTimer(e, t, i, r) {
    return ChangeTimer.startChangeTimer(e), ChangeTimer.addTimerType(e, t), ChangeTimer.addChangeTypeType(e, i), ChangeTimer.addChangeType(e, r), ChangeTimer.endChangeTimer(e)
  }
}
