...
class EnableSkillOperation {
  ...
  static getSizePrefixedRootAsEnableSkillOperation(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnableSkillOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEnableSkillOperation(t, e) {
    return EnableSkillOperation.startEnableSkillOperation(t), EnableSkillOperation.addType(t, e), EnableSkillOperation.endEnableSkillOperation(t)
  }
}
