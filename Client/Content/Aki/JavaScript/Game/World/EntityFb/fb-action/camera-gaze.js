...
class CameraGaze {
  ...
  static getSizePrefixedRootAsCameraGaze(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CameraGaze).__init(a.readInt32(a.position()) + a.position(), a)
  }
  fadeInTime() {
  ...
  static createCameraGaze(a, t, e, r, i, s, h) {
    return CameraGaze.startCameraGaze(a), CameraGaze.addFadeInTime(a, t), CameraGaze.addStayTime(a, e), CameraGaze.addFadeOutTime(a, r), CameraGaze.addLockCamera(a, i), CameraGaze.addLockPriority(a, s), CameraGaze.addGazeInHook(a, h), CameraGaze.endCameraGaze(a)
  }
}
