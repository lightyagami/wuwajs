...
class RunActions {
  ...
  static getRootAsRunActions(t, i) {
    return (i || new RunActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsRunActions(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RunActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actionList(t, i) {
  ...
  static createRunActions(t, i) {
    return RunActions.startRunActions(t), RunActions.addActionList(t, i), RunActions.endRunActions(t)
  }
}
