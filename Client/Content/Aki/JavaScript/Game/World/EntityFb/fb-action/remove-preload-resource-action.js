...
class RemovePreloadResourceAction {
  ...
  static getSizePrefixedRootAsRemovePreloadResourceAction(e, o) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new RemovePreloadResourceAction).__init(e.readInt32(e.position()) + e.position(), e)
  }
  removePreloadResourceObjectTypeType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_remove_preload_resource_config_js_1.UnionRemovePreloadResourceConfig.NONE
  }
  ...
  static createRemovePreloadResourceAction(e, o, r) {
    return RemovePreloadResourceAction.startRemovePreloadResourceAction(e), RemovePreloadResourceAction.addRemovePreloadResourceObjectTypeType(e, o), RemovePreloadResourceAction.addRemovePreloadResourceObjectType(e, r), RemovePreloadResourceAction.endRemovePreloadResourceAction(e)
  }
}
