...
class SetAudioState {
  ...
  static getSizePrefixedRootAsSetAudioState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetAudioState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  audioConfig(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new audio_state_js_1.AudioState).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  ...
  static createSetAudioState(t, e) {
    return SetAudioState.startSetAudioState(t), SetAudioState.addAudioConfig(t, e), SetAudioState.endSetAudioState(t)
  }
}
