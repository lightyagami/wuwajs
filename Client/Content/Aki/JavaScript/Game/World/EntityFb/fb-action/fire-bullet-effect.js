...
class FireBulletEffect {
  ...
  static getSizePrefixedRootAsFireBulletEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FireBulletEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  static createFireBulletEffect(t, e, i, r, s) {
    return FireBulletEffect.startFireBulletEffect(t), FireBulletEffect.addId(t, e), FireBulletEffect.addX(t, i), FireBulletEffect.addY(t, r), FireBulletEffect.addZ(t, s), FireBulletEffect.endFireBulletEffect(t)
  }
}
