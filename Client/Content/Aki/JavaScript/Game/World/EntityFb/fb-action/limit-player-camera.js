...
class LimitPlayerCamera {
  ...
  static getSizePrefixedRootAsLimitPlayerCamera(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LimitPlayerCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createLimitPlayerCamera(t, e) {
    return LimitPlayerCamera.startLimitPlayerCamera(t), LimitPlayerCamera.addType(t, e), LimitPlayerCamera.endLimitPlayerCamera(t)
  }
}
