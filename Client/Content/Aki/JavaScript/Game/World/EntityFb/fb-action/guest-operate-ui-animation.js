...
class GuestOperateUiAnimation {
  ...
  static getSizePrefixedRootAsGuestOperateUiAnimation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GuestOperateUiAnimation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  uiAnimationConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_guest_operate_ui_animation_js_1.UnionGuestOperateUiAnimation.NONE
  }
  uiAnimationConfig(t) {
  ...
  static createGuestOperateUiAnimation(t, i, e) {
    return GuestOperateUiAnimation.startGuestOperateUiAnimation(t), GuestOperateUiAnimation.addUiAnimationConfigType(t, i), GuestOperateUiAnimation.addUiAnimationConfig(t, e), GuestOperateUiAnimation.endGuestOperateUiAnimation(t)
  }
}
