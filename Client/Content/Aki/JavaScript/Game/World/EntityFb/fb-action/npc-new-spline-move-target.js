...
class NpcNewSplineMoveTarget {
  ...
  static getSizePrefixedRootAsNpcNewSplineMoveTarget(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new NpcNewSplineMoveTarget).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createNpcNewSplineMoveTarget(e, t, i) {
    return NpcNewSplineMoveTarget.startNpcNewSplineMoveTarget(e), NpcNewSplineMoveTarget.addType(e, t), NpcNewSplineMoveTarget.addNpcId(e, i), NpcNewSplineMoveTarget.endNpcNewSplineMoveTarget(e)
  }
}
