...
class RestorePlayerCameraAdjustment {
  ...
  static getSizePrefixedRootAsRestorePlayerCameraAdjustment(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RestorePlayerCameraAdjustment).__init(e.readInt32(e.position()) + e.position(), e)
  }
  resetFocus(e) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? (e || new reset_focus_config_js_1.ResetFocusConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  ...
  static createRestorePlayerCameraAdjustment(e, t) {
    return RestorePlayerCameraAdjustment.startRestorePlayerCameraAdjustment(e), RestorePlayerCameraAdjustment.addResetFocus(e, t), RestorePlayerCameraAdjustment.endRestorePlayerCameraAdjustment(e)
  }
}
