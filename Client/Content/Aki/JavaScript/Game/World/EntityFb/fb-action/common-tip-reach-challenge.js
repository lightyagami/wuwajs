...
class CommonTipReachChallenge {
  ...
  static getSizePrefixedRootAsCommonTipReachChallenge(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CommonTipReachChallenge).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createCommonTipReachChallenge(e, t, i) {
    return CommonTipReachChallenge.startCommonTipReachChallenge(e), CommonTipReachChallenge.addType(e, t), CommonTipReachChallenge.addTidMainText(e, i), CommonTipReachChallenge.endCommonTipReachChallenge(e)
  }
}
