...
class ShowTalkFrameEventPosition {
  ...
  static getSizePrefixedRootAsShowTalkFrameEventPosition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ShowTalkFrameEventPosition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  talkItemId() {
  ...
  static createShowTalkFrameEventPosition(t, e, i) {
    return ShowTalkFrameEventPosition.startShowTalkFrameEventPosition(t), ShowTalkFrameEventPosition.addTalkItemId(t, e), ShowTalkFrameEventPosition.addOffset(t, i), ShowTalkFrameEventPosition.endShowTalkFrameEventPosition(t)
  }
}
