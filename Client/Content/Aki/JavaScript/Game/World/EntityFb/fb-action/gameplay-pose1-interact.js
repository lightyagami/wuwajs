...
class GameplayPose1Interact {
  ...
  static getSizePrefixedRootAsGameplayPose1Interact(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GameplayPose1Interact).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGameplayPose1Interact(t, e) {
    return GameplayPose1Interact.startGameplayPose1Interact(t), GameplayPose1Interact.addType(t, e), GameplayPose1Interact.endGameplayPose1Interact(t)
  }
}
