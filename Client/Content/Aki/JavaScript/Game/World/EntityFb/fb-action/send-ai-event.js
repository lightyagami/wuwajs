...
class SendAiEvent {
  ...
  static getSizePrefixedRootAsSendAiEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SendAiEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createSendAiEvent(t, e, i) {
    return SendAiEvent.startSendAiEvent(t), SendAiEvent.addEntityId(t, e), SendAiEvent.addEventType(t, i), SendAiEvent.endSendAiEvent(t)
  }
}
