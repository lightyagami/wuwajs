...
class SetEntityClientVisibleSave {
  ...
  static getSizePrefixedRootAsSetEntityClientVisibleSave(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetEntityClientVisibleSave).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createSetEntityClientVisibleSave(t, i, e) {
    return SetEntityClientVisibleSave.startSetEntityClientVisibleSave(t), SetEntityClientVisibleSave.addEntityIds(t, i), SetEntityClientVisibleSave.addVisible(t, e), SetEntityClientVisibleSave.endSetEntityClientVisibleSave(t)
  }
}
