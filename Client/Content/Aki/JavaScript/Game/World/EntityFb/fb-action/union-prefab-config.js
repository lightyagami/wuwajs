...
exports.unionListToUnionPrefabConfig = exports.unionToUnionPrefabConfig = exports.UnionPrefabConfig = undefined;
const prefab_config_js_1 = require("../fb-action/prefab-config.js");
const random_prefab_config_js_1 = require("../fb-action/random-prefab-config.js");
const rogue_prefab_config_js_1 = require("../fb-action/rogue-prefab-config.js");
const slash_tower_prefab_config_js_1 = require("../fb-action/slash-tower-prefab-config.js");
const tower_dungeon_prefab_config_js_1 = require("../fb-action/tower-dungeon-prefab-config.js");
...
function unionListToUnionPrefabConfig(e, n, o) {
  switch (UnionPrefabConfig[e]) {
    ...
    case "TowerDungeonPrefabConfig":
      return n(o, new tower_dungeon_prefab_config_js_1.TowerDungeonPrefabConfig());
    default:
      return;
  }
}
...
})(UnionPrefabConfig = exports.UnionPrefabConfig ||= {});
exports.unionToUnionPrefabConfig = unionToUnionPrefabConfig;
exports.unionListToUnionPrefabConfig = unionListToUnionPrefabConfig; //# sourceMappingURL=union-prefab-config.js.map