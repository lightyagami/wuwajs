...
exports.unionListToUnionTalkBackground = exports.unionToUnionTalkBackground = exports.UnionTalkBackground = undefined;
const talk_background_clean_js_1 = require("../fb-action/talk-background-clean.js");
const talk_background_icon_js_1 = require("../fb-action/talk-background-icon.js");
const talk_background_image_js_1 = require("../fb-action/talk-background-image.js");
const talk_background_image_by_mc_gender_js_1 = require("../fb-action/talk-background-image-by-mc-gender.js");
const talk_background_spine_image_js_1 = require("../fb-action/talk-background-spine-image.js");
...
function unionToUnionTalkBackground(a, n) {
  switch (UnionTalkBackground[a]) {
    ...
    case "TalkBackgroundImageByMcGender":
      return n(new talk_background_image_by_mc_gender_js_1.TalkBackgroundImageByMcGender());
...
function unionListToUnionTalkBackground(a, n, e) {
  switch (UnionTalkBackground[a]) {
    ...
    case "TalkBackgroundImageByMcGender":
      return n(e, new talk_background_image_by_mc_gender_js_1.TalkBackgroundImageByMcGender());
    case "TalkBackgroundSpineImage":
      return n(e, new talk_background_spine_image_js_1.TalkBackgroundSpineImage());
    default:
      return;
  }
}
(function (a) {
  ...
  a[a.TalkBackgroundImageByMcGender = 4] = "TalkBackgroundImageByMcGender";
  a[a.TalkBackgroundSpineImage = 5] = "TalkBackgroundSpineImage";
})(UnionTalkBackground = exports.UnionTalkBackground ||= {});
exports.unionToUnionTalkBackground = unionToUnionTalkBackground;
exports.unionListToUnionTalkBackground = unionListToUnionTalkBackground; //# sourceMappingURL=union-talk-background.js.map