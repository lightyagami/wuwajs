...
class SignalBreakGameplay {
  ...
  static getSizePrefixedRootAsSignalBreakGameplay(a, e) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SignalBreakGameplay).__init(a.readInt32(a.position()) + a.position(), a)
  }
  type(a) {
  ...
  static createSignalBreakGameplay(a, e, t) {
    return SignalBreakGameplay.startSignalBreakGameplay(a), SignalBreakGameplay.addType(a, e), SignalBreakGameplay.addSignalBreakId(a, t), SignalBreakGameplay.endSignalBreakGameplay(a)
  }
}
