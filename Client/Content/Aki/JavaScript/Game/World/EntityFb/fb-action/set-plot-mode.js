...
class SetPlotMode {
  ...
  static getRootAsSetPlotMode(t, i) {
    return (i || new SetPlotMode).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSetPlotMode(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetPlotMode).__init(t.readInt32(t.position()) + t.position(), t)
  }
  mode(t) {
  ...
  fastFadeIn(t) {
    ...
    return i ? (t || new fade_in_screen_js_1.FadeInScreen).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  keepMainRolePose() {
