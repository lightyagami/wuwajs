...
class CompleteGuide {
  ...
  static getSizePrefixedRootAsCompleteGuide(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CompleteGuide).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCompleteGuide(t, i, e, s, r, o) {
    return CompleteGuide.startCompleteGuide(t), CompleteGuide.addType(t, i), CompleteGuide.addConditionsExtType(t, e), CompleteGuide.addConditionsType(t, s), CompleteGuide.addConditions(t, r), CompleteGuide.addGuideId(t, o), CompleteGuide.endCompleteGuide(t)
  }
}
