...
class ToggleHighlightExploreUi {
  ...
  static getSizePrefixedRootAsToggleHighlightExploreUi(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ToggleHighlightExploreUi).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createToggleHighlightExploreUi(i, t) {
    return ToggleHighlightExploreUi.startToggleHighlightExploreUi(i), ToggleHighlightExploreUi.addType(i, t), ToggleHighlightExploreUi.endToggleHighlightExploreUi(i)
  }
}
