...
class StopSceneItemMove {
  ...
  static getSizePrefixedRootAsStopSceneItemMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopSceneItemMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createStopSceneItemMove(t, e, s) {
    return StopSceneItemMove.startStopSceneItemMove(t), StopSceneItemMove.addEntityIds(t, e), StopSceneItemMove.addStopType(t, s), StopSceneItemMove.endStopSceneItemMove(t)
  }
}
