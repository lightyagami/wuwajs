...
class VehicleSprint {
  ...
  static getSizePrefixedRootAsVehicleSprint(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleSprint).__init(e.readInt32(e.position()) + e.position(), e)
  }
  targetVehicleType() {
  ...
  static createVehicleSprint(e, t, i) {
    return VehicleSprint.startVehicleSprint(e), VehicleSprint.addTargetVehicleType(e, t), VehicleSprint.addTargetVehicle(e, i), VehicleSprint.endVehicleSprint(e)
  }
}
