...
class OpenGlobalTimeScale {
  ...
  static getSizePrefixedRootAsOpenGlobalTimeScale(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OpenGlobalTimeScale).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createOpenGlobalTimeScale(e, t, a, i, l) {
    return OpenGlobalTimeScale.startOpenGlobalTimeScale(e), OpenGlobalTimeScale.addType(e, t), OpenGlobalTimeScale.addTimeScale(e, a), OpenGlobalTimeScale.addDuration(e, i), OpenGlobalTimeScale.addExceptPlayer(e, l), OpenGlobalTimeScale.endOpenGlobalTimeScale(e)
  }
}
