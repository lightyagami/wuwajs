...
class ActionMontage {
  ...
  static getSizePrefixedRootAsActionMontage(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActionMontage).__init(t.readInt32(t.position()) + t.position(), t)
  }
  montageType(t) {
  ...
  static createActionMontage(t, e, i) {
    return ActionMontage.startActionMontage(t), ActionMontage.addMontageType(t, e), ActionMontage.addPath(t, i), ActionMontage.endActionMontage(t)
  }
}
