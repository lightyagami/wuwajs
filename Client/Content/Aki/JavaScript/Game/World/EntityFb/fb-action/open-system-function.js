...
class OpenSystemFunction {
  ...
  static getSizePrefixedRootAsOpenSystemFunction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OpenSystemFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  functionId() {
  ...
  static createOpenSystemFunction(t, e) {
    return OpenSystemFunction.startOpenSystemFunction(t), OpenSystemFunction.addFunctionId(t, e), OpenSystemFunction.endOpenSystemFunction(t)
  }
}
