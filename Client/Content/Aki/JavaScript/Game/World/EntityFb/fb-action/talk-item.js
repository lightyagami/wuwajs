...
class TalkItem {
  ...
  static getSizePrefixedRootAsTalkItem(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TalkItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  captionParams(t) {
    ...
    return i ? (t || new caption_param_js_1.CaptionParam).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  actions(t, i) {
    var s = this.bb.__offset(this.bb_pos, 28);
    return s ? (i || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  options(t, i) {
    ...
    return s ? (i || new talk_option_js_1.TalkOption).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  optionsLength() {
  ...
  montage(t) {
    ...
    return i ? (t || new play_montage_js_1.PlayMontage).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  cameraData(t) {
    var i = this.bb.__offset(this.bb_pos, 34);
    return i ? (t || new camera_data_js_1.CameraData).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  flowTemplate(t) {
    var i = this.bb.__offset(this.bb_pos, 36);
    return i ? (t || new set_flow_template_js_1.SetFlowTemplate).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  flowTemplateList(t, i) {
    var s = this.bb.__offset(this.bb_pos, 38);
    return s ? (i || new set_flow_template_js_1.SetFlowTemplate).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  actorMontageArray(t, i) {
    ...
    return s ? (i || new montage_data_js_1.MontageData).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  actorLookAtArray(t, i) {
    ...
    return s ? (i || new actor_look_at_js_1.ActorLookAt).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  actorTurnToArray(t, i) {
    ...
    return s ? (i || new actor_turn_to_js_1.ActorTurnTo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  talkAkEventType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_post_ak_event_js_1.UnionPostAkEvent.NONE
  }
  talkAkEvent(t) {
  ...
  universalTone(t) {
    ...
    return i ? (t || new universal_tone_js_1.UniversalTone).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  backgroundConfigType() {
    var t = this.bb.__offset(this.bb_pos, 52);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_talk_background_js_1.UnionTalkBackground.NONE
  }
  backgroundConfig(t) {
