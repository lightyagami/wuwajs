...
class InteractActions {
  ...
  static getSizePrefixedRootAsInteractActions(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new InteractActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createInteractActions(t, s, i) {
    return InteractActions.startInteractActions(t), InteractActions.addType(t, s), InteractActions.addActions(t, i), InteractActions.endInteractActions(t)
  }
}
