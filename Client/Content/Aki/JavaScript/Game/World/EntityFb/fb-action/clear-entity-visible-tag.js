...
class ClearEntityVisibleTag {
  ...
  static getRootAsClearEntityVisibleTag(t, i) {
    return (i || new ClearEntityVisibleTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsClearEntityVisibleTag(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ClearEntityVisibleTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createClearEntityVisibleTag(t, i) {
    return ClearEntityVisibleTag.startClearEntityVisibleTag(t), ClearEntityVisibleTag.addEntityIds(t, i), ClearEntityVisibleTag.endClearEntityVisibleTag(t)
  }
}
