...
class EndFlowTemplate {
  ...
  static getRootAsEndFlowTemplate(t, e) {
    return (e || new EndFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEndFlowTemplate(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EndFlowTemplate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isResetPosition() {
  ...
  static createEndFlowTemplate(t, e) {
    return EndFlowTemplate.startEndFlowTemplate(t), EndFlowTemplate.addIsResetPosition(t, e), EndFlowTemplate.endEndFlowTemplate(t)
  }
}
