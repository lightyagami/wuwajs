...
class TeleportTransitionWithFadeInScreen {
  ...
  static getSizePrefixedRootAsTeleportTransitionWithFadeInScreen(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TeleportTransitionWithFadeInScreen).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createTeleportTransitionWithFadeInScreen(e, t, r) {
    return TeleportTransitionWithFadeInScreen.startTeleportTransitionWithFadeInScreen(e), TeleportTransitionWithFadeInScreen.addType(e, t), TeleportTransitionWithFadeInScreen.addScreenType(e, r), TeleportTransitionWithFadeInScreen.endTeleportTransitionWithFadeInScreen(e)
  }
}
