...
class BlackCatWarning {
  ...
  static getSizePrefixedRootAsBlackCatWarning(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BlackCatWarning).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createBlackCatWarning(t, a, i) {
    return BlackCatWarning.startBlackCatWarning(t), BlackCatWarning.addType(t, a), BlackCatWarning.addWarningText(t, i), BlackCatWarning.endBlackCatWarning(t)
  }
}
