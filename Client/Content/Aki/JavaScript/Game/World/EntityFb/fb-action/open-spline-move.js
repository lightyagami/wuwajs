...
class OpenSplineMove {
  ...
  static getSizePrefixedRootAsOpenSplineMove(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new OpenSplineMove).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  patternType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spline_move_pattern_js_1.UnionSplineMovePattern.NONE
  }
  pattern(t) {
  ...
  static createOpenSplineMove(t, e, i, n, s, r, p) {
    return OpenSplineMove.startOpenSplineMove(t), OpenSplineMove.addType(t, e), OpenSplineMove.addTargetType(t, i), OpenSplineMove.addTarget(t, n), OpenSplineMove.addSplineEntityId(t, s), OpenSplineMove.addPatternType(t, r), OpenSplineMove.addPattern(t, p), OpenSplineMove.endOpenSplineMove(t)
  }
}
