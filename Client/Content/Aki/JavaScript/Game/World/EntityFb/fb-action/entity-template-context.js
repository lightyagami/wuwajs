...
class EntityTemplateContext {
  ...
  static getSizePrefixedRootAsEntityTemplateContext(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityTemplateContext).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createEntityTemplateContext(t, e, i) {
    return EntityTemplateContext.startEntityTemplateContext(t), EntityTemplateContext.addType(t, e), EntityTemplateContext.addId(t, i), EntityTemplateContext.endEntityTemplateContext(t)
  }
}
