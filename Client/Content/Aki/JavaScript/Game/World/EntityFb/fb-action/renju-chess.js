...
class RenjuChess {
  ...
  static getSizePrefixedRootAsRenjuChess(s, e) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RenjuChess).__init(s.readInt32(s.position()) + s.position(), s)
  }
  type(s) {
  ...
  cameraConfigType() {
    ...
    return s ? this.bb.readUint8(this.bb_pos + s) : union_adjust_player_camera_option_js_1.UnionAdjustPlayerCameraOption.NONE
  }
  cameraConfig(s) {
  ...
  static createRenjuChess(s, e, t, i, r) {
    return RenjuChess.startRenjuChess(s), RenjuChess.addType(s, e), RenjuChess.addChessboard(s, t), RenjuChess.addCameraConfigType(s, i), RenjuChess.addCameraConfig(s, r), RenjuChess.endRenjuChess(s)
  }
}
