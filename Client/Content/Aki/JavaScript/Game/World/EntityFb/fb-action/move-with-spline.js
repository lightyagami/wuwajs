...
class MoveWithSpline {
  ...
  static getSizePrefixedRootAsMoveWithSpline(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new MoveWithSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  moveTargetType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spline_move_target_js_1.UnionSplineMoveTarget.NONE
  }
  moveTarget(t) {
  ...
  checkClimb(t) {
    ...
    return i ? (t || new check_climb_js_1.CheckClimb).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  moveState() {
  ...
  npcFollow(t) {
    ...
    return i ? (t || new npc_follow_config_js_1.NpcFollowConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  npcCollisionEnabled() {
