...
class CameraSetting {
  ...
  static getSizePrefixedRootAsCameraSetting(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CameraSetting).__init(t.readInt32(t.position()) + t.position(), t)
  }
  aperture() {
  ...
  static createCameraSetting(t, e, a, i, r) {
    return CameraSetting.startCameraSetting(t), CameraSetting.addAperture(t, e), CameraSetting.addFocalLength(t, a), CameraSetting.addFocusDistance(t, i), CameraSetting.addFocalRegion(t, r), CameraSetting.endCameraSetting(t)
  }
}
