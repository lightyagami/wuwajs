...
class FinishDoInteract {
  ...
  static getSizePrefixedRootAsFinishDoInteract(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FinishDoInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createFinishDoInteract(t) {
    return FinishDoInteract.startFinishDoInteract(t), FinishDoInteract.endFinishDoInteract(t)
  }
}
