...
class EnableUiOperation {
  ...
  static getSizePrefixedRootAsEnableUiOperation(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnableUiOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEnableUiOperation(t, e) {
    return EnableUiOperation.startEnableUiOperation(t), EnableUiOperation.addType(t, e), EnableUiOperation.endEnableUiOperation(t)
  }
}
