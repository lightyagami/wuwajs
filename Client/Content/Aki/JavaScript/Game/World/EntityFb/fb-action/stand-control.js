...
class StandControl {
  ...
  static getSizePrefixedRootAsStandControl(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new StandControl).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStandControl(t, r) {
    return StandControl.startStandControl(t), StandControl.addType(t, r), StandControl.endStandControl(t)
  }
}
