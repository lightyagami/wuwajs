...
class UnlockAtlasSystemItem {
  ...
  static getSizePrefixedRootAsUnlockAtlasSystemItem(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new UnlockAtlasSystemItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  unlockOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_unlock_atlas_system_option_js_1.UnionUnlockAtlasSystemOption.NONE
  }
  unlockOption(t) {
  ...
  static createUnlockAtlasSystemItem(t, s, e, n) {
    return UnlockAtlasSystemItem.startUnlockAtlasSystemItem(t), UnlockAtlasSystemItem.addType(t, s), UnlockAtlasSystemItem.addUnlockOptionType(t, e), UnlockAtlasSystemItem.addUnlockOption(t, n), UnlockAtlasSystemItem.endUnlockAtlasSystemItem(t)
  }
}
