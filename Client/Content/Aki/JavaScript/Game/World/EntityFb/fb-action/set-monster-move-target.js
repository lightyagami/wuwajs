...
class SetMonsterMoveTarget {
  ...
  static getSizePrefixedRootAsSetMonsterMoveTarget(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetMonsterMoveTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSetMonsterMoveTarget(t, e, r, s, i) {
    return SetMonsterMoveTarget.startSetMonsterMoveTarget(t), SetMonsterMoveTarget.addType(t, e), SetMonsterMoveTarget.addTargetEntityId(t, r), SetMonsterMoveTarget.addMoveEvent(t, s), SetMonsterMoveTarget.addMonsterEntityIds(t, i), SetMonsterMoveTarget.endSetMonsterMoveTarget(t)
  }
}
