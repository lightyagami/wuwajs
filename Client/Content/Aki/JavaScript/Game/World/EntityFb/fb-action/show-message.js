...
class ShowMessage {
  ...
  static getSizePrefixedRootAsShowMessage(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ShowMessage).__init(e.readInt32(e.position()) + e.position(), e)
  }
  content(e) {
  ...
  static createShowMessage(e, s) {
    return ShowMessage.startShowMessage(e), ShowMessage.addContent(e, s), ShowMessage.endShowMessage(e)
  }
}
