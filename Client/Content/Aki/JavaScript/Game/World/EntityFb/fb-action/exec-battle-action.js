...
class ExecBattleAction {
  ...
  static getSizePrefixedRootAsExecBattleAction(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExecBattleAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  battleOptionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_exec_battle_option_js_1.UnionExecBattleOption.NONE
  }
  battleOption(t) {
  ...
  static createExecBattleAction(t, e, i) {
    return ExecBattleAction.startExecBattleAction(t), ExecBattleAction.addBattleOptionType(t, e), ExecBattleAction.addBattleOption(t, i), ExecBattleAction.endExecBattleAction(t)
  }
}
