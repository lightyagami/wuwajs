...
class UnLimitPlayerOperation {
  ...
  static getSizePrefixedRootAsUnLimitPlayerOperation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new UnLimitPlayerOperation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createUnLimitPlayerOperation(t) {
    return UnLimitPlayerOperation.startUnLimitPlayerOperation(t), UnLimitPlayerOperation.endUnLimitPlayerOperation(t)
  }
}
