...
class LevelPlayVarContext {
  ...
  static getSizePrefixedRootAsLevelPlayVarContext(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LevelPlayVarContext).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createLevelPlayVarContext(t, e, a) {
    return LevelPlayVarContext.startLevelPlayVarContext(t), LevelPlayVarContext.addType(t, e), LevelPlayVarContext.addId(t, a), LevelPlayVarContext.endLevelPlayVarContext(t)
  }
}
