...
class CharacterLookAtUnlockData {
  ...
  static getRootAsCharacterLookAtUnlockData(t, a) {
    return (a || new CharacterLookAtUnlockData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCharacterLookAtUnlockData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new CharacterLookAtUnlockData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createCharacterLookAtUnlockData(t, a) {
    return CharacterLookAtUnlockData.startCharacterLookAtUnlockData(t), CharacterLookAtUnlockData.addType(t, a), CharacterLookAtUnlockData.endCharacterLookAtUnlockData(t)
  }
}
