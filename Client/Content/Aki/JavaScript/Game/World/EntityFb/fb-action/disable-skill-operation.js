...
class DisableSkillOperation {
  ...
  static getSizePrefixedRootAsDisableSkillOperation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DisableSkillOperation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createDisableSkillOperation(i, t, e, s) {
    return DisableSkillOperation.startDisableSkillOperation(i), DisableSkillOperation.addType(i, t), DisableSkillOperation.addDisplayMode(i, e), DisableSkillOperation.addDisableSkillWheel(i, s), DisableSkillOperation.endDisableSkillOperation(i)
  }
}
