...
class JigsawItemEntity {
  ...
  static getSizePrefixedRootAsJigsawItemEntity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new JigsawItemEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createJigsawItemEntity(t, i, s) {
    return JigsawItemEntity.startJigsawItemEntity(t), JigsawItemEntity.addType(t, i), JigsawItemEntity.addEntityIds(t, s), JigsawItemEntity.endJigsawItemEntity(t)
  }
}
