...
class EnableSectionalUi {
  ...
  static getSizePrefixedRootAsEnableSectionalUi(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EnableSectionalUi).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEnableSectionalUi(t, i, e, s, a, n, r, h, o) {
    return EnableSectionalUi.startEnableSectionalUi(t), EnableSectionalUi.addType(t, i), EnableSectionalUi.addShowMiniMap(t, e), EnableSectionalUi.addShowQuestTrack(t, s), EnableSectionalUi.addShowEsc(t, a), EnableSectionalUi.addShowSystem(t, n), EnableSectionalUi.addShowScreenEffect(t, r), EnableSectionalUi.addShowOther(t, h), EnableSectionalUi.addAlwaysShowUiSections(t, o), EnableSectionalUi.endEnableSectionalUi(t)
  }
}
