...
class MorseCode {
  ...
  static getSizePrefixedRootAsMorseCode(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MorseCode).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createMorseCode(e, t, s) {
    return MorseCode.startMorseCode(e), MorseCode.addType(e, t), MorseCode.addMorseCodeId(e, s), MorseCode.endMorseCode(e)
  }
}
