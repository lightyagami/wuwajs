...
exports.unionListToUnionAdjustPlayerCameraOption = exports.unionToUnionAdjustPlayerCameraOption = exports.UnionAdjustPlayerCameraOption = undefined;
const adjust_axis_lock_camera_js_1 = require("../fb-action/adjust-axis-lock-camera.js");
const adjust_basic_camera_js_1 = require("../fb-action/adjust-basic-camera.js");
const adjust_dialog_camera_js_1 = require("../fb-action/adjust-dialog-camera.js");
const adjust_first_person_camera_js_1 = require("../fb-action/adjust-first-person-camera.js");
const adjust_fixed_camera_js_1 = require("../fb-action/adjust-fixed-camera.js");
const adjust_horizontal_camera_js_1 = require("../fb-action/adjust-horizontal-camera.js");
...
function unionListToUnionAdjustPlayerCameraOption(a, e, r) {
  switch (UnionAdjustPlayerCameraOption[a]) {
    ...
    case "AdjustFirstPersonCamera":
      return e(r, new adjust_first_person_camera_js_1.AdjustFirstPersonCamera());
    case "AdjustFixedCamera":
...
})(UnionAdjustPlayerCameraOption = exports.UnionAdjustPlayerCameraOption ||= {});
exports.unionToUnionAdjustPlayerCameraOption = unionToUnionAdjustPlayerCameraOption;
exports.unionListToUnionAdjustPlayerCameraOption = unionListToUnionAdjustPlayerCameraOption; //# sourceMappingURL=union-adjust-player-camera-option.js.map