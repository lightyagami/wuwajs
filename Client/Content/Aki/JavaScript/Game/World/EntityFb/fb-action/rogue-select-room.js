...
class RogueSelectRoom {
  ...
  static getSizePrefixedRootAsRogueSelectRoom(e, o) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new RogueSelectRoom).__init(e.readInt32(e.position()) + e.position(), e)
  }
  configType() {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_rogue_select_room_js_1.UnionRogueSelectRoom.NONE
  }
  config(e) {
  ...
  static createRogueSelectRoom(e, o, t) {
    return RogueSelectRoom.startRogueSelectRoom(e), RogueSelectRoom.addConfigType(e, o), RogueSelectRoom.addConfig(e, t), RogueSelectRoom.endRogueSelectRoom(e)
  }
}
