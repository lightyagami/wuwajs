...
class SuperCatapult {
  ...
  static getSizePrefixedRootAsSuperCatapult(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new SuperCatapult).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  param(t) {
    ...
    return a ? (t || new catapult_param_js_1.CatapultParam).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
