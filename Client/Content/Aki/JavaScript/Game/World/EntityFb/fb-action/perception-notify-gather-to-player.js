...
class PerceptionNotifyGatherToPlayer {
  ...
  static getSizePrefixedRootAsPerceptionNotifyGatherToPlayer(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PerceptionNotifyGatherToPlayer).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPerceptionNotifyGatherToPlayer(t, e) {
    return PerceptionNotifyGatherToPlayer.startPerceptionNotifyGatherToPlayer(t), PerceptionNotifyGatherToPlayer.addType(t, e), PerceptionNotifyGatherToPlayer.endPerceptionNotifyGatherToPlayer(t)
  }
}
