...
class SignalDevice2 {
  ...
  static getSizePrefixedRootAsSignalDevice2(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SignalDevice2).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSignalDevice2(e, i, t) {
    return SignalDevice2.startSignalDevice2(e), SignalDevice2.addType(e, i), SignalDevice2.addConfig(e, t), SignalDevice2.endSignalDevice2(e)
  }
}
