...
exports.unionListToUnionActorLookAtData = exports.unionToUnionActorLookAtData = exports.UnionActorLookAtData = undefined;
const actor_look_at_empty_data_js_1 = require("../fb-action/actor-look-at-empty-data.js");
const actor_look_at_entity_data_js_1 = require("../fb-action/actor-look-at-entity-data.js");
const actor_look_at_other_actor_js_1 = require("../fb-action/actor-look-at-other-actor.js");
const actor_look_at_player_data_js_1 = require("../fb-action/actor-look-at-player-data.js");
const actor_look_at_position_data_js_1 = require("../fb-action/actor-look-at-position-data.js");
const actor_look_at_talker_data_js_1 = require("../fb-action/actor-look-at-talker-data.js");
const actor_look_at_un_lock_js_1 = require("../fb-action/actor-look-at-un-lock.js");
...
function unionListToUnionActorLookAtData(t, o, a) {
  switch (UnionActorLookAtData[t]) {
    ...
    case "ActorLookAtPositionData":
      return o(a, new actor_look_at_position_data_js_1.ActorLookAtPositionData());
    case "ActorLookAtTalkerData":
...
})(UnionActorLookAtData = exports.UnionActorLookAtData ||= {});
exports.unionToUnionActorLookAtData = unionToUnionActorLookAtData;
exports.unionListToUnionActorLookAtData = unionListToUnionActorLookAtData; //# sourceMappingURL=union-actor-look-at-data.js.map