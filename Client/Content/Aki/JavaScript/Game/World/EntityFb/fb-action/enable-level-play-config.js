...
class EnableLevelPlayConfig {
  ...
  static getRootAsEnableLevelPlayConfig(e, t) {
    return (t || new EnableLevelPlayConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsEnableLevelPlayConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnableLevelPlayConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  levelPlayId() {
  ...
  static createEnableLevelPlayConfig(e, t, l) {
    return EnableLevelPlayConfig.startEnableLevelPlayConfig(e), EnableLevelPlayConfig.addLevelPlayId(e, t), EnableLevelPlayConfig.addEnable(e, l), EnableLevelPlayConfig.endEnableLevelPlayConfig(e)
  }
}
