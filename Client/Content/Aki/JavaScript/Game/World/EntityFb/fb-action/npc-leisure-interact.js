...
class NpcLeisureInteract {
  ...
  static getSizePrefixedRootAsNpcLeisureInteract(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcLeisureInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  optionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_npc_leisure_interact_op_js_1.UnionNpcLeisureInteractOp.NONE
  }
  option(t) {
  ...
  static createNpcLeisureInteract(t, e, r) {
    return NpcLeisureInteract.startNpcLeisureInteract(t), NpcLeisureInteract.addOptionType(t, e), NpcLeisureInteract.addOption(t, r), NpcLeisureInteract.endNpcLeisureInteract(t)
  }
}
