...
class VehicleMoveWithPathLine {
  ...
  static getSizePrefixedRootAsVehicleMoveWithPathLine(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleMoveWithPathLine).__init(e.readInt32(e.position()) + e.position(), e)
  }
  targetVehicleType() {
  ...
  controlTypeType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_vehicle_control_type_js_1.UnionVehicleControlType.NONE
  }
  controlType(e) {
