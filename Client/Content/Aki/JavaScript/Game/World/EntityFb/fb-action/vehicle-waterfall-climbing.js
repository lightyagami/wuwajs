...
class VehicleWaterfallClimbing {
  ...
  static getSizePrefixedRootAsVehicleWaterfallClimbing(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleWaterfallClimbing).__init(i.readInt32(i.position()) + i.position(), i)
  }
  splineEntityId() {
  ...
  changeGravity(i) {
    ...
    return t ? (i || new vehicle_waterfall_climb_gravity_config_js_1.VehicleWaterfallClimbGravityConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
