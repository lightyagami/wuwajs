...
class SignalDevice {
  ...
  static getRootAsSignalDevice(e, i) {
    return (i || new SignalDevice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsSignalDevice(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SignalDevice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  config(e, i) {
    ...
    return t ? (i || new color_piece_js_1.ColorPiece).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + t) + 4 * e), this.bb) : void 0
  }
  configLength() {
  ...
  static createSignalDevice(e, i, t) {
    return SignalDevice.startSignalDevice(e), SignalDevice.addType(e, i), SignalDevice.addConfig(e, t), SignalDevice.endSignalDevice(e)
  }
}
