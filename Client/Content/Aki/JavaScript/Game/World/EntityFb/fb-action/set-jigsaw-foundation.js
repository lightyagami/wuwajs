...
class SetJigsawFoundation {
  ...
  static getSizePrefixedRootAsSetJigsawFoundation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SetJigsawFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_set_jigsaw_foundation_js_1.UnionSetJigsawFoundation.NONE
  }
  config(t) {
  ...
  static createSetJigsawFoundation(t, i, s) {
    return SetJigsawFoundation.startSetJigsawFoundation(t), SetJigsawFoundation.addConfigType(t, i), SetJigsawFoundation.addConfig(t, s), SetJigsawFoundation.endSetJigsawFoundation(t)
  }
}
