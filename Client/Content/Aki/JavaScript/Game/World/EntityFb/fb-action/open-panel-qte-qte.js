...
class OpenPanelQteQte {
  ...
  static getSizePrefixedRootAsOpenPanelQteQte(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OpenPanelQteQte).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createOpenPanelQteQte(e, t, n) {
    return OpenPanelQteQte.startOpenPanelQteQte(e), OpenPanelQteQte.addType(e, t), OpenPanelQteQte.addId(e, n), OpenPanelQteQte.endOpenPanelQteQte(e)
  }
}
