...
class ActionInfo {
  ...
  static getSizePrefixedRootAsActionInfo(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ActionInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  params0Type() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_action_params0_js_1.UnionActionParams0.NONE
  }
  params0(t) {
  ...
  params1Type() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_action_params1_js_1.UnionActionParams1.NONE
  }
  params1(t) {
  ...
  static createActionInfo(t, i, s, a, n, o, r, c, e, h, d, u, f, A) {
    return ActionInfo.startActionInfo(t), ActionInfo.addName(t, i), ActionInfo.addAsync(t, s), ActionInfo.addParamsExtActionPage(t, a), ActionInfo.addParamsExtType0(t, n), ActionInfo.addParams0Type(t, o), ActionInfo.addParams0(t, r), ActionInfo.addParamsExtType1(t, c), ActionInfo.addParams1Type(t, e), ActionInfo.addParams1(t, h), ActionInfo.addActionId(t, d), ActionInfo.addDisabled(t, u), ActionInfo.addActionGuid(t, f), ActionInfo.addTimeout(t, A), ActionInfo.endActionInfo(t)
  }
}
