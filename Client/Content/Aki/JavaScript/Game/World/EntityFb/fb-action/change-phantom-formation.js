...
class ChangePhantomFormation {
  ...
  static getSizePrefixedRootAsChangePhantomFormation(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new ChangePhantomFormation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  formationId() {
  ...
  appendBuffIds(t) {
    ...
    return a ? this.bb.readInt64(this.bb.__vector(this.bb_pos + a) + 8 * t) : BigInt(0)
  }
  appendBuffIdsLength() {
  ...
  static createChangePhantomFormation(t, a, n, e, i) {
    return ChangePhantomFormation.startChangePhantomFormation(t), ChangePhantomFormation.addFormationId(t, a), ChangePhantomFormation.addRetainRole(t, n), ChangePhantomFormation.addTeleportEntityId(t, e), ChangePhantomFormation.addAppendBuffIds(t, i), ChangePhantomFormation.endChangePhantomFormation(t)
  }
}
