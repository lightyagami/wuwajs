...
class DetectBattleMonsterOnGround {
  ...
  static getSizePrefixedRootAsDetectBattleMonsterOnGround(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DetectBattleMonsterOnGround).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDetectBattleMonsterOnGround(t, e) {
    return DetectBattleMonsterOnGround.startDetectBattleMonsterOnGround(t), DetectBattleMonsterOnGround.addType(t, e), DetectBattleMonsterOnGround.endDetectBattleMonsterOnGround(t)
  }
}
