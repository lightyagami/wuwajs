...
class SwitchSubLevels {
  ...
  static getSizePrefixedRootAsSwitchSubLevels(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SwitchSubLevels).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSwitchSubLevels(t, e) {
    return SwitchSubLevels.startSwitchSubLevels(t), SwitchSubLevels.addType(t, e), SwitchSubLevels.endSwitchSubLevels(t)
  }
}
