...
class CloseTraceSpline {
  ...
  static getSizePrefixedRootAsCloseTraceSpline(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CloseTraceSpline).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCloseTraceSpline(e, t, s) {
    return CloseTraceSpline.startCloseTraceSpline(e), CloseTraceSpline.addType(e, t), CloseTraceSpline.addSplineEntityId(e, s), CloseTraceSpline.endCloseTraceSpline(e)
  }
}
