...
class OpenSystemBoard {
  ...
  static getSizePrefixedRootAsOpenSystemBoard(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new OpenSystemBoard).__init(t.readInt32(t.position()) + t.position(), t)
  }
  systemType(t) {
  ...
  photographConfig(t) {
    ...
    return s ? (t || new photograph_config_js_1.PhotographConfig).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  gramophoneId() {
