...
exports.AdjustHorizontalCamera = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const base_curve_js_1 = require("../fb-action/base-curve.js");
const camera_depth_of_field_js_1 = require("../fb-action/camera-depth-of-field.js");
...
class AdjustHorizontalCamera {
  ...
  depthOfField(t) {
    ...
    if (i) {
      return (t || new camera_depth_of_field_js_1.CameraDepthOfField()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
