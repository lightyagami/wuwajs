...
class AdjustHorizontalCamera {
  ...
  static getRootAsAdjustHorizontalCamera(t, i) {
    return (i || new AdjustHorizontalCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdjustHorizontalCamera(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AdjustHorizontalCamera).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  fadeInCurve(t) {
    ...
    return i ? (t || new base_curve_js_1.BaseCurve).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  fadeOutTime() {
  ...
  depthOfField(t) {
    ...
    return i ? (t || new camera_depth_of_field_js_1.CameraDepthOfField).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
