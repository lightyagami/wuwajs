...
class PostAkEvent {
  ...
  static getSizePrefixedRootAsPostAkEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PostAkEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  eventConfigType() {
  ...
  static createPostAkEvent(t, e, s, n) {
    return PostAkEvent.startPostAkEvent(t), PostAkEvent.addEventConfigType(t, e), PostAkEvent.addEventConfig(t, s), PostAkEvent.addPersistWhenExitDungeon(t, n), PostAkEvent.endPostAkEvent(t)
  }
}
