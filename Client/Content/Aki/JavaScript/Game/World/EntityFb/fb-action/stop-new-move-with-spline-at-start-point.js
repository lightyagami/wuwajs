...
class StopNewMoveWithSplineAtStartPoint {
  ...
  static getSizePrefixedRootAsStopNewMoveWithSplineAtStartPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StopNewMoveWithSplineAtStartPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createStopNewMoveWithSplineAtStartPoint(t, e) {
    return StopNewMoveWithSplineAtStartPoint.startStopNewMoveWithSplineAtStartPoint(t), StopNewMoveWithSplineAtStartPoint.addType(t, e), StopNewMoveWithSplineAtStartPoint.endStopNewMoveWithSplineAtStartPoint(t)
  }
}
