...
class BrokenRock {
  ...
  static getSizePrefixedRootAsBrokenRock(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BrokenRock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBrokenRock(t, e, r) {
    return BrokenRock.startBrokenRock(t), BrokenRock.addType(t, e), BrokenRock.addId(t, r), BrokenRock.endBrokenRock(t)
  }
}
