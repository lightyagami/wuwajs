...
class PerceptionNotifyGatherToEntity {
  ...
  static getSizePrefixedRootAsPerceptionNotifyGatherToEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PerceptionNotifyGatherToEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPerceptionNotifyGatherToEntity(t, e, i) {
    return PerceptionNotifyGatherToEntity.startPerceptionNotifyGatherToEntity(t), PerceptionNotifyGatherToEntity.addType(t, e), PerceptionNotifyGatherToEntity.addEntityId(t, i), PerceptionNotifyGatherToEntity.endPerceptionNotifyGatherToEntity(t)
  }
}
