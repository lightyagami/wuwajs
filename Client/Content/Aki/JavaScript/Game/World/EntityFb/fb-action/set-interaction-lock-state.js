...
class SetInteractionLockState {
  ...
  static getSizePrefixedRootAsSetInteractionLockState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetInteractionLockState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isLock() {
  ...
  static createSetInteractionLockState(t, e) {
    return SetInteractionLockState.startSetInteractionLockState(t), SetInteractionLockState.addIsLock(t, e), SetInteractionLockState.endSetInteractionLockState(t)
  }
}
