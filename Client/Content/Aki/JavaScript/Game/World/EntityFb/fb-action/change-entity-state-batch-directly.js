...
class ChangeEntityStateBatchDirectly {
  ...
  static getSizePrefixedRootAsChangeEntityStateBatchDirectly(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChangeEntityStateBatchDirectly).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChangeEntityStateBatchDirectly(t, e, i, a, s, h) {
    return ChangeEntityStateBatchDirectly.startChangeEntityStateBatchDirectly(t), ChangeEntityStateBatchDirectly.addType(t, e), ChangeEntityStateBatchDirectly.addEntityId(t, i), ChangeEntityStateBatchDirectly.addEntityIds(t, a), ChangeEntityStateBatchDirectly.addState(t, s), ChangeEntityStateBatchDirectly.addDelayChange(t, h), ChangeEntityStateBatchDirectly.endChangeEntityStateBatchDirectly(t)
  }
}
