...
exports.VehiclePlayPassengerVoice = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const play_voice_passengers_config_js_1 = require("../fb-action/play-voice-passengers-config.js");
class VehiclePlayPassengerVoice {
  ...
  triggerPassengers(e) {
    ...
    if (s) {
      return (e || new play_voice_passengers_config_js_1.PlayVoicePassengersConfig()).__init(this.bb.__indirect(this.bb_pos + s), this.bb);
    } else {
      return undefined;
    }
  }
