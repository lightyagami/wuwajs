...
class VehiclePlayPassengerVoice {
  ...
  static getRootAsVehiclePlayPassengerVoice(e, s) {
    return (s || new VehiclePlayPassengerVoice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsVehiclePlayPassengerVoice(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new VehiclePlayPassengerVoice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  triggerType() {
  ...
  triggerPassengers(e) {
    ...
    return s ? (e || new play_voice_passengers_config_js_1.PlayVoicePassengersConfig).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
