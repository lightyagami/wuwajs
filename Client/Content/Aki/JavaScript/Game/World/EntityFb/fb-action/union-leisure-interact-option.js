...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionLeisureInteractOption = exports.unionToUnionLeisureInteractOption = exports.UnionLeisureInteractOption = void 0;
...
function unionListToUnionLeisureInteractOption(e, t, n) {
  ...
  e[e.NONE = 0] = "NONE", e[e.Bounce = 1] = "Bounce", e[e.Catapult = 2] = "Catapult", e[e.FailurePoseInteract = 3] = "FailurePoseInteract", e[e.GameplayPose1Interact = 4] = "GameplayPose1Interact", e[e.GameplayPose2Interact = 5] = "GameplayPose2Interact", e[e.GameplayPose3Interact = 6] = "GameplayPose3Interact", e[e.GetUp = 7] = "GetUp", e[e.Glide = 8] = "Glide", e[e.HookLockInteract = 9] = "HookLockInteract", e[e.KiteHookInteract = 10] = "KiteHookInteract", e[e.Manipulate = 11] = "Manipulate", e[e.SitDown = 12] = "SitDown", e[e.SitOnGround = 13] = "SitOnGround", e[e.Soar = 14] = "Soar", e[e.StandControl = 15] = "StandControl", e[e.StandControl2 = 16] = "StandControl2", e[e.SuperCatapult = 17] = "SuperCatapult"
}(UnionLeisureInteractOption = exports.UnionLeisureInteractOption || (exports.UnionLeisureInteractOption = {})), exports.unionToUnionLeisureInteractOption = unionToUnionLeisureInteractOption, exports.unionListToUnionLeisureInteractOption = unionListToUnionLeisureInteractOption;
