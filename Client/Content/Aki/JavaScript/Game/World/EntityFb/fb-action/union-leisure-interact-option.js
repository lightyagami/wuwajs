...
exports.unionListToUnionLeisureInteractOption = exports.unionToUnionLeisureInteractOption = exports.UnionLeisureInteractOption = undefined;
const bounce_js_1 = require("../fb-action/bounce.js");
const catapult_js_1 = require("../fb-action/catapult.js");
const failure_pose_interact_js_1 = require("../fb-action/failure-pose-interact.js");
const gameplay_pose1_interact_js_1 = require("../fb-action/gameplay-pose1-interact.js");
const gameplay_pose2_interact_js_1 = require("../fb-action/gameplay-pose2-interact.js");
const gameplay_pose3_interact_js_1 = require("../fb-action/gameplay-pose3-interact.js");
const get_up_js_1 = require("../fb-action/get-up.js");
const glide_js_1 = require("../fb-action/glide.js");
const hook_lock_interact_js_1 = require("../fb-action/hook-lock-interact.js");
const kite_hook_interact_js_1 = require("../fb-action/kite-hook-interact.js");
const manipulate_js_1 = require("../fb-action/manipulate.js");
const sit_down_js_1 = require("../fb-action/sit-down.js");
const sit_on_ground_js_1 = require("../fb-action/sit-on-ground.js");
const soar_js_1 = require("../fb-action/soar.js");
const stand_control_js_1 = require("../fb-action/stand-control.js");
const stand_control2_js_1 = require("../fb-action/stand-control2.js");
const super_catapult_js_1 = require("../fb-action/super-catapult.js");
...
})(UnionLeisureInteractOption = exports.UnionLeisureInteractOption ||= {});
exports.unionToUnionLeisureInteractOption = unionToUnionLeisureInteractOption;
exports.unionListToUnionLeisureInteractOption = unionListToUnionLeisureInteractOption; //# sourceMappingURL=union-leisure-interact-option.js.map