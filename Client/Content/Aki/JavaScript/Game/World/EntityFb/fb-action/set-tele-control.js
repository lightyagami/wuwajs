...
class SetTeleControl {
  ...
  static getSizePrefixedRootAsSetTeleControl(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SetTeleControl).__init(t.readInt32(t.position()) + t.position(), t)
  }
  configType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_set_tele_control_config_js_1.UnionSetTeleControlConfig.NONE
  }
  config(t) {
  ...
  static createSetTeleControl(t, e, o) {
    return SetTeleControl.startSetTeleControl(t), SetTeleControl.addConfigType(t, e), SetTeleControl.addConfig(t, o), SetTeleControl.endSetTeleControl(t)
  }
}
