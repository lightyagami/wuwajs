...
class ShowHidedGroup {
  ...
  static getSizePrefixedRootAsShowHidedGroup(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ShowHidedGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  groupKey(t) {
  ...
  static createShowHidedGroup(t, e, r) {
    return ShowHidedGroup.startShowHidedGroup(t), ShowHidedGroup.addGroupKey(t, e), ShowHidedGroup.addDelayShow(t, r), ShowHidedGroup.endShowHidedGroup(t)
  }
}
