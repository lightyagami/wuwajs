...
class RandomPrefabConfig {
  ...
  static getSizePrefixedRootAsRandomPrefabConfig(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new RandomPrefabConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createRandomPrefabConfig(t, a, e) {
    return RandomPrefabConfig.startRandomPrefabConfig(t), RandomPrefabConfig.addType(t, a), RandomPrefabConfig.addRandomPrefabId(t, e), RandomPrefabConfig.endRandomPrefabConfig(t)
  }
}
