...
class ClientTpRelativeEntityPos {
  ...
  static getSizePrefixedRootAsClientTpRelativeEntityPos(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ClientTpRelativeEntityPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createClientTpRelativeEntityPos(t, e, i, s) {
    return ClientTpRelativeEntityPos.startClientTpRelativeEntityPos(t), ClientTpRelativeEntityPos.addType(t, e), ClientTpRelativeEntityPos.addSourcePosEntityId(t, i), ClientTpRelativeEntityPos.addTargetPosEntityId(t, s), ClientTpRelativeEntityPos.endClientTpRelativeEntityPos(t)
  }
}
