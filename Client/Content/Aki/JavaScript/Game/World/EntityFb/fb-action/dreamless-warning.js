...
class DreamlessWarning {
  ...
  static getSizePrefixedRootAsDreamlessWarning(s, e) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DreamlessWarning).__init(s.readInt32(s.position()) + s.position(), s)
  }
  type() {
  ...
  static createDreamlessWarning(s, e, r) {
    return DreamlessWarning.startDreamlessWarning(s), DreamlessWarning.addType(s, e), DreamlessWarning.addWarningText(s, r), DreamlessWarning.endDreamlessWarning(s)
  }
}
