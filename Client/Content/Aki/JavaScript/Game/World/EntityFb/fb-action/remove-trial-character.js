...
class RemoveTrialCharacter {
  ...
  static getSizePrefixedRootAsRemoveTrialCharacter(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RemoveTrialCharacter).__init(r.readInt32(r.position()) + r.position(), r)
  }
  characterId() {
  ...
  static createRemoveTrialCharacter(r, t, e) {
    return RemoveTrialCharacter.startRemoveTrialCharacter(r), RemoveTrialCharacter.addCharacterId(r, t), RemoveTrialCharacter.addCharacterGroup(r, e), RemoveTrialCharacter.endRemoveTrialCharacter(r)
  }
}
