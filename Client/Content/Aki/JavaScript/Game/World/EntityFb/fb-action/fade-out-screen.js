...
class FadeOutScreen {
  ...
  static getSizePrefixedRootAsFadeOutScreen(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FadeOutScreen).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ease(e) {
  ...
  static createFadeOutScreen(e, t) {
    return FadeOutScreen.startFadeOutScreen(e), FadeOutScreen.addEase(e, t), FadeOutScreen.endFadeOutScreen(e)
  }
}
