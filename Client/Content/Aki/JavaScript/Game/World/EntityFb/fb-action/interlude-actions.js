...
class InterludeActions {
  ...
  static getRootAsInterludeActions(t, s) {
    return (s || new InterludeActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsInterludeActions(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new InterludeActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createInterludeActions(t, s, i, e, r) {
    return InterludeActions.startInterludeActions(t), InterludeActions.addInterludeActionList(t, s), InterludeActions.addDestroyEntityIds(t, i), InterludeActions.addIsFadeIn(t, e), InterludeActions.addIsFadeOut(t, r), InterludeActions.endInterludeActions(t)
  }
}
