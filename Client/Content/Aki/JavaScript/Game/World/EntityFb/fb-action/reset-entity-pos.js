...
class ResetEntityPos {
  ...
  static getSizePrefixedRootAsResetEntityPos(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ResetEntityPos).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  static createResetEntityPos(t, s) {
    return ResetEntityPos.startResetEntityPos(t), ResetEntityPos.addEntityId(t, s), ResetEntityPos.endResetEntityPos(t)
  }
}
