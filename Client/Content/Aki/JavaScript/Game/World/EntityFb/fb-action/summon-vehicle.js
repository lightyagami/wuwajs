...
class SummonVehicle {
  ...
  static getSizePrefixedRootAsSummonVehicle(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SummonVehicle).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSummonVehicle(t, e, i, s) {
    return SummonVehicle.startSummonVehicle(t), SummonVehicle.addType(t, e), SummonVehicle.addTemplateId(t, i), SummonVehicle.addPositionEntityId(t, s), SummonVehicle.endSummonVehicle(t)
  }
}
