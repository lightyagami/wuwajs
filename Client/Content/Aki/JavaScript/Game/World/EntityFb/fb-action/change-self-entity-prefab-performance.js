...
class ChangeSelfEntityPrefabPerformance {
  ...
  static getSizePrefixedRootAsChangeSelfEntityPrefabPerformance(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ChangeSelfEntityPrefabPerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createChangeSelfEntityPrefabPerformance(e, t, r) {
    return ChangeSelfEntityPrefabPerformance.startChangeSelfEntityPrefabPerformance(e), ChangeSelfEntityPrefabPerformance.addType(e, t), ChangeSelfEntityPrefabPerformance.addPerformanceTag(e, r), ChangeSelfEntityPrefabPerformance.endChangeSelfEntityPrefabPerformance(e)
  }
}
