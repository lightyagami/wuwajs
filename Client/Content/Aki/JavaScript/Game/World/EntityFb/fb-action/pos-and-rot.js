...
class PosAndRot {
  ...
  static getSizePrefixedRootAsPosAndRot(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PosAndRot).__init(t.readInt32(t.position()) + t.position(), t)
  }
  x() {
  ...
  static createPosAndRot(t, s, i, o, r, e, n) {
    return PosAndRot.startPosAndRot(t), PosAndRot.addX(t, s), PosAndRot.addY(t, i), PosAndRot.addZ(t, o), PosAndRot.addA(t, r), PosAndRot.addRoll(t, e), PosAndRot.addPitch(t, n), PosAndRot.endPosAndRot(t)
  }
}
