...
class GuideTrigger {
  ...
  static getSizePrefixedRootAsGuideTrigger(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GuideTrigger).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGuideTrigger(t, i, r, e, s, n) {
    return GuideTrigger.startGuideTrigger(t), GuideTrigger.addType(t, i), GuideTrigger.addConditionsExtType(t, r), GuideTrigger.addConditionsType(t, e), GuideTrigger.addConditions(t, s), GuideTrigger.addGuideId(t, n), GuideTrigger.endGuideTrigger(t)
  }
}
