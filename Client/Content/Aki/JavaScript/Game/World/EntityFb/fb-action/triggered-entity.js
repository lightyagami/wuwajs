...
class TriggeredEntity {
  ...
  static getSizePrefixedRootAsTriggeredEntity(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TriggeredEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createTriggeredEntity(t, e) {
    return TriggeredEntity.startTriggeredEntity(t), TriggeredEntity.addType(t, e), TriggeredEntity.endTriggeredEntity(t)
  }
}
