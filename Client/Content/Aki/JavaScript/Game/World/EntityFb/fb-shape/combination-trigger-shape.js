...
class CombinationTriggerShape {
  ...
  static getSizePrefixedRootAsCombinationTriggerShape(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CombinationTriggerShape).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCombinationTriggerShape(t, i, e, r) {
    return CombinationTriggerShape.startCombinationTriggerShape(t), CombinationTriggerShape.addType(t, i), CombinationTriggerShape.addCombinationShapesType(t, e), CombinationTriggerShape.addCombinationShapes(t, r), CombinationTriggerShape.endCombinationTriggerShape(t)
  }
}
