...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionTriggerShape = exports.unionToUnionTriggerShape = exports.UnionTriggerShape = void 0;
...
function unionToUnionTriggerShape(e, r) {
  switch (UnionTriggerShape[e]) {
    ...
    case "ActorCollisionTriggerShape":
      return r(new actor_collision_trigger_shape_js_1.ActorCollisionTriggerShape);
    case "ActorRefVolume":
    ...
    case "HollowCylinderTriggerShape":
      return r(new hollow_cylinder_trigger_shape_js_1.HollowCylinderTriggerShape);
...
function unionListToUnionTriggerShape(e, r, i) {
  switch (UnionTriggerShape[e]) {
    case "NONE":
      return;
    case "ActorCollisionTriggerShape":
      return r(i, new actor_collision_trigger_shape_js_1.ActorCollisionTriggerShape);
    case "ActorRefVolume":
    ...
    case "HollowCylinderTriggerShape":
      return r(i, new hollow_cylinder_trigger_shape_js_1.HollowCylinderTriggerShape);
    case "HollowSphereTriggerShape":
      return r(i, new hollow_sphere_trigger_shape_js_1.HollowSphereTriggerShape);
    case "SphereTriggerShape":
  ...
  e[e.NONE = 0] = "NONE", e[e.ActorCollisionTriggerShape = 1] = "ActorCollisionTriggerShape", e[e.ActorRefVolume = 2] = "ActorRefVolume", e[e.BoxTriggerShape = 3] = "BoxTriggerShape", e[e.CombinationTriggerShape = 4] = "CombinationTriggerShape", e[e.ConeTriggerShape = 5] = "ConeTriggerShape", e[e.CylinderTriggerShape = 6] = "CylinderTriggerShape", e[e.HollowCylinderTriggerShape = 7] = "HollowCylinderTriggerShape", e[e.HollowSphereTriggerShape = 8] = "HollowSphereTriggerShape", e[e.SphereTriggerShape = 9] = "SphereTriggerShape", e[e.VolumeTriggerShape = 10] = "VolumeTriggerShape"
}(UnionTriggerShape = exports.UnionTriggerShape || (exports.UnionTriggerShape = {})), exports.unionToUnionTriggerShape = unionToUnionTriggerShape, exports.unionListToUnionTriggerShape = unionListToUnionTriggerShape;
