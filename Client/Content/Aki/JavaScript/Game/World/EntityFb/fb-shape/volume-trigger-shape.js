...
class VolumeTriggerShape {
  ...
  static getSizePrefixedRootAsVolumeTriggerShape(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new VolumeTriggerShape).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createVolumeTriggerShape(e, r, t) {
    return VolumeTriggerShape.startVolumeTriggerShape(e), VolumeTriggerShape.addType(e, r), VolumeTriggerShape.addVolumeKey(e, t), VolumeTriggerShape.endVolumeTriggerShape(e)
  }
}
