...
class EnterLeaveRadius {
  ...
  static getSizePrefixedRootAsEnterLeaveRadius(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnterLeaveRadius).__init(e.readInt32(e.position()) + e.position(), e)
  }
  enterRadius() {
  ...
  static createEnterLeaveRadius(e, t, s) {
    return EnterLeaveRadius.startEnterLeaveRadius(e), EnterLeaveRadius.addEnterRadius(e, t), EnterLeaveRadius.addLeaveRadius(e, s), EnterLeaveRadius.endEnterLeaveRadius(e)
  }
}
