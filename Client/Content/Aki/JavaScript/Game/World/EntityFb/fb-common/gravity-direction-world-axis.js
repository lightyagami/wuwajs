...
class GravityDirectionWorldAxis {
  ...
  static getSizePrefixedRootAsGravityDirectionWorldAxis(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new GravityDirectionWorldAxis).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createGravityDirectionWorldAxis(i, t, r) {
    return GravityDirectionWorldAxis.startGravityDirectionWorldAxis(i), GravityDirectionWorldAxis.addType(i, t), GravityDirectionWorldAxis.addWorldAxis(i, r), GravityDirectionWorldAxis.endGravityDirectionWorldAxis(i)
  }
}
