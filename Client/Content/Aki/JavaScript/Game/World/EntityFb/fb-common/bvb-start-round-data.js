...
class BvbStartRoundData {
  ...
  static getSizePrefixedRootAsBvbStartRoundData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbStartRoundData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbStartRoundData(t, a) {
    return BvbStartRoundData.startBvbStartRoundData(t), BvbStartRoundData.addType(t, a), BvbStartRoundData.endBvbStartRoundData(t)
  }
}
