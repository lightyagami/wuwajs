...
class PhotoTargetCaptureUiEntityZero {
  ...
  static getRootAsPhotoTargetCaptureUiEntityZero(t, e) {
    return (e || new PhotoTargetCaptureUiEntityZero).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsPhotoTargetCaptureUiEntityZero(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PhotoTargetCaptureUiEntityZero).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPhotoTargetCaptureUiEntityZero(t, e) {
    return PhotoTargetCaptureUiEntityZero.startPhotoTargetCaptureUiEntityZero(t), PhotoTargetCaptureUiEntityZero.addType(t, e), PhotoTargetCaptureUiEntityZero.endPhotoTargetCaptureUiEntityZero(t)
  }
}
