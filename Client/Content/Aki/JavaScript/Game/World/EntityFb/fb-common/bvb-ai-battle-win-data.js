...
class BvbAiBattleWinData {
  ...
  static getSizePrefixedRootAsBvbAiBattleWinData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbAiBattleWinData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbAiBattleWinData(t, a) {
    return BvbAiBattleWinData.startBvbAiBattleWinData(t), BvbAiBattleWinData.addType(t, a), BvbAiBattleWinData.endBvbAiBattleWinData(t)
  }
}
