...
class InitNpcPerformState {
  ...
  static getSizePrefixedRootAsInitNpcPerformState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new InitNpcPerformState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createInitNpcPerformState(t, e, r) {
    return InitNpcPerformState.startInitNpcPerformState(t), InitNpcPerformState.addType(t, e), InitNpcPerformState.addState(t, r), InitNpcPerformState.endInitNpcPerformState(t)
  }
}
