...
exports.BvbAiGetBestRearrangeData = undefined;
...
class BvbAiGetBestRearrangeData {
  ...
  static createBvbAiGetBestRearrangeData(t, e, a, r, s, i) {
    ...
    BvbAiGetBestRearrangeData.addHandCardStoredType(t, a);
    BvbAiGetBestRearrangeData.addHandCardStored(t, r);
    BvbAiGetBestRearrangeData.addBoardPosStoredType(t, s);
    BvbAiGetBestRearrangeData.addBoardPosStored(t, i);
    return BvbAiGetBestRearrangeData.endBvbAiGetBestRearrangeData(t);
  }
}
