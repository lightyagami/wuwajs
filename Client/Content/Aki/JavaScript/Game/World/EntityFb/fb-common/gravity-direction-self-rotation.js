...
class GravityDirectionSelfRotation {
  ...
  static getSizePrefixedRootAsGravityDirectionSelfRotation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GravityDirectionSelfRotation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGravityDirectionSelfRotation(t, i) {
    return GravityDirectionSelfRotation.startGravityDirectionSelfRotation(t), GravityDirectionSelfRotation.addType(t, i), GravityDirectionSelfRotation.endGravityDirectionSelfRotation(t)
  }
}
