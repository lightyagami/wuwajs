...
class BvbBurnBuffTimeUpData {
  ...
  static getSizePrefixedRootAsBvbBurnBuffTimeUpData(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BvbBurnBuffTimeUpData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbBurnBuffTimeUpData(t, e) {
    return BvbBurnBuffTimeUpData.startBvbBurnBuffTimeUpData(t), BvbBurnBuffTimeUpData.addType(t, e), BvbBurnBuffTimeUpData.endBvbBurnBuffTimeUpData(t)
  }
}
