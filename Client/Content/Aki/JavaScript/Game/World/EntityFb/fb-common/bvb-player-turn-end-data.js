...
class BvbPlayerTurnEndData {
  ...
  static getSizePrefixedRootAsBvbPlayerTurnEndData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbPlayerTurnEndData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbPlayerTurnEndData(t, a) {
    return BvbPlayerTurnEndData.startBvbPlayerTurnEndData(t), BvbPlayerTurnEndData.addType(t, a), BvbPlayerTurnEndData.endBvbPlayerTurnEndData(t)
  }
}
