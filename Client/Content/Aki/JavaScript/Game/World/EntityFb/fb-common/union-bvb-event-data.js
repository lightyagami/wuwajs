...
exports.unionListToUnionBvbEventData = exports.unionToUnionBvbEventData = exports.UnionBvbEventData = undefined;
const bvb_ai_battle_win_data_js_1 = require("../fb-common/bvb-ai-battle-win-data.js");
const bvb_ai_change_data_js_1 = require("../fb-common/bvb-ai-change-data.js");
const bvb_ai_deploy_data_js_1 = require("../fb-common/bvb-ai-deploy-data.js");
const bvb_ai_discard_data_js_1 = require("../fb-common/bvb-ai-discard-data.js");
const bvb_ai_evolution_data_js_1 = require("../fb-common/bvb-ai-evolution-data.js");
const bvb_ai_get_best_deploy_data_js_1 = require("../fb-common/bvb-ai-get-best-deploy-data.js");
const bvb_ai_get_best_rearrange_data_js_1 = require("../fb-common/bvb-ai-get-best-rearrange-data.js");
const bvb_ai_get_best_swap_data_js_1 = require("../fb-common/bvb-ai-get-best-swap-data.js");
const bvb_ai_rearrange_data_js_1 = require("../fb-common/bvb-ai-rearrange-data.js");
const bvb_ai_recycle_data_js_1 = require("../fb-common/bvb-ai-recycle-data.js");
const bvb_ai_swap_data_js_1 = require("../fb-common/bvb-ai-swap-data.js");
const bvb_ai_turn_end_data_js_1 = require("../fb-common/bvb-ai-turn-end-data.js");
const bvb_burn_buff_time_up_data_js_1 = require("../fb-common/bvb-burn-buff-time-up-data.js");
const bvb_enable_hatred_data_js_1 = require("../fb-common/bvb-enable-hatred-data.js");
const bvb_player_battle_win_data_js_1 = require("../fb-common/bvb-player-battle-win-data.js");
const bvb_player_turn_end_data_js_1 = require("../fb-common/bvb-player-turn-end-data.js");
const bvb_player_turn_start_data_js_1 = require("../fb-common/bvb-player-turn-start-data.js");
const bvb_select_cards_end_data_js_1 = require("../fb-common/bvb-select-cards-end-data.js");
const bvb_start_ai_data_js_1 = require("../fb-common/bvb-start-ai-data.js");
const bvb_start_battle_data_js_1 = require("../fb-common/bvb-start-battle-data.js");
const bvb_start_round_data_js_1 = require("../fb-common/bvb-start-round-data.js");
const bvb_wait_for_game_begin_data_js_1 = require("../fb-common/bvb-wait-for-game-begin-data.js");
...
function unionToUnionBvbEventData(a, t) {
  switch (UnionBvbEventData[a]) {
    ...
    case "BvbAiGetBestRearrangeData":
      return t(new bvb_ai_get_best_rearrange_data_js_1.BvbAiGetBestRearrangeData());
    ...
    case "BvbEnableHatredData":
      return t(new bvb_enable_hatred_data_js_1.BvbEnableHatredData());
...
function unionListToUnionBvbEventData(a, t, e) {
  switch (UnionBvbEventData[a]) {
    ...
    case "BvbAiGetBestDeployData":
      return t(e, new bvb_ai_get_best_deploy_data_js_1.BvbAiGetBestDeployData());
    case "BvbAiGetBestRearrangeData":
      return t(e, new bvb_ai_get_best_rearrange_data_js_1.BvbAiGetBestRearrangeData());
    case "BvbAiGetBestSwapData":
    ...
    case "BvbEnableHatredData":
      return t(e, new bvb_enable_hatred_data_js_1.BvbEnableHatredData());
    case "BvbPlayerBattleWinData":
    ...
    case "BvbWaitForGameBeginData":
      return t(e, new bvb_wait_for_game_begin_data_js_1.BvbWaitForGameBeginData());
    default:
      return;
  }
}
(function (a) {
  ...
  a[a.BvbEnableHatredData = 14] = "BvbEnableHatredData";
  a[a.BvbPlayerBattleWinData = 15] = "BvbPlayerBattleWinData";
  a[a.BvbPlayerTurnEndData = 16] = "BvbPlayerTurnEndData";
  a[a.BvbPlayerTurnStartData = 17] = "BvbPlayerTurnStartData";
  a[a.BvbSelectCardsEndData = 18] = "BvbSelectCardsEndData";
  a[a.BvbStartAiData = 19] = "BvbStartAiData";
  a[a.BvbStartBattleData = 20] = "BvbStartBattleData";
  a[a.BvbStartRoundData = 21] = "BvbStartRoundData";
  a[a.BvbWaitForGameBeginData = 22] = "BvbWaitForGameBeginData";
})(UnionBvbEventData = exports.UnionBvbEventData ||= {});
exports.unionToUnionBvbEventData = unionToUnionBvbEventData;
exports.unionListToUnionBvbEventData = unionListToUnionBvbEventData; //# sourceMappingURL=union-bvb-event-data.js.map