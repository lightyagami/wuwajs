...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionBvbEventData = exports.unionToUnionBvbEventData = exports.UnionBvbEventData = void 0;
const bvb_ai_battle_win_data_js_1 = require("../fb-common/bvb-ai-battle-win-data.js"),
  ...
  bvb_enable_hatred_data_js_1 = require("../fb-common/bvb-enable-hatred-data.js"),
...
function unionListToUnionBvbEventData(a, t, e) {
  ...
  a[a.NONE = 0] = "NONE", a[a.BvbAiBattleWinData = 1] = "BvbAiBattleWinData", a[a.BvbAiChangeData = 2] = "BvbAiChangeData", a[a.BvbAiDeployData = 3] = "BvbAiDeployData", a[a.BvbAiDiscardData = 4] = "BvbAiDiscardData", a[a.BvbAiEvolutionData = 5] = "BvbAiEvolutionData", a[a.BvbAiGetBestDeployData = 6] = "BvbAiGetBestDeployData", a[a.BvbAiGetBestRearrangeData = 7] = "BvbAiGetBestRearrangeData", a[a.BvbAiGetBestSwapData = 8] = "BvbAiGetBestSwapData", a[a.BvbAiRearrangeData = 9] = "BvbAiRearrangeData", a[a.BvbAiRecycleData = 10] = "BvbAiRecycleData", a[a.BvbAiSwapData = 11] = "BvbAiSwapData", a[a.BvbAiTurnEndData = 12] = "BvbAiTurnEndData", a[a.BvbBurnBuffTimeUpData = 13] = "BvbBurnBuffTimeUpData", a[a.BvbEnableHatredData = 14] = "BvbEnableHatredData", a[a.BvbPlayerBattleWinData = 15] = "BvbPlayerBattleWinData", a[a.BvbPlayerTurnEndData = 16] = "BvbPlayerTurnEndData", a[a.BvbPlayerTurnStartData = 17] = "BvbPlayerTurnStartData", a[a.BvbSelectCardsEndData = 18] = "BvbSelectCardsEndData", a[a.BvbStartAiData = 19] = "BvbStartAiData", a[a.BvbStartBattleData = 20] = "BvbStartBattleData", a[a.BvbStartRoundData = 21] = "BvbStartRoundData", a[a.BvbWaitForGameBeginData = 22] = "BvbWaitForGameBeginData"
}(UnionBvbEventData = exports.UnionBvbEventData || (exports.UnionBvbEventData = {})), exports.unionToUnionBvbEventData = unionToUnionBvbEventData, exports.unionListToUnionBvbEventData = unionListToUnionBvbEventData;
