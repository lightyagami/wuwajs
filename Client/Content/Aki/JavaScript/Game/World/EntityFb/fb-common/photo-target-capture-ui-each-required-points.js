...
class PhotoTargetCaptureUiEachRequiredPoints {
  ...
  static getSizePrefixedRootAsPhotoTargetCaptureUiEachRequiredPoints(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PhotoTargetCaptureUiEachRequiredPoints).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPhotoTargetCaptureUiEachRequiredPoints(t, e) {
    return PhotoTargetCaptureUiEachRequiredPoints.startPhotoTargetCaptureUiEachRequiredPoints(t), PhotoTargetCaptureUiEachRequiredPoints.addType(t, e), PhotoTargetCaptureUiEachRequiredPoints.endPhotoTargetCaptureUiEachRequiredPoints(t)
  }
}
