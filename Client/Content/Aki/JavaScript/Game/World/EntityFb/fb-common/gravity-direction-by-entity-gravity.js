...
class GravityDirectionByEntityGravity {
  ...
  static getSizePrefixedRootAsGravityDirectionByEntityGravity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GravityDirectionByEntityGravity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGravityDirectionByEntityGravity(t, i, r) {
    return GravityDirectionByEntityGravity.startGravityDirectionByEntityGravity(t), GravityDirectionByEntityGravity.addType(t, i), GravityDirectionByEntityGravity.addEntityId(t, r), GravityDirectionByEntityGravity.endGravityDirectionByEntityGravity(t)
  }
}
