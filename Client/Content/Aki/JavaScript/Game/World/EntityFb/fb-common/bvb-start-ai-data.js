...
class BvbStartAiData {
  ...
  static getSizePrefixedRootAsBvbStartAiData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbStartAiData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbStartAiData(t, a) {
    return BvbStartAiData.startBvbStartAiData(t), BvbStartAiData.addType(t, a), BvbStartAiData.endBvbStartAiData(t)
  }
}
