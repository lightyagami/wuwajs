...
class BvbSelectCardsEndData {
  ...
  static getSizePrefixedRootAsBvbSelectCardsEndData(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BvbSelectCardsEndData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbSelectCardsEndData(t, e) {
    return BvbSelectCardsEndData.startBvbSelectCardsEndData(t), BvbSelectCardsEndData.addType(t, e), BvbSelectCardsEndData.endBvbSelectCardsEndData(t)
  }
}
