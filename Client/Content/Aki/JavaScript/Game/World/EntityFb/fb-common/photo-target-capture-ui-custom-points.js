...
class PhotoTargetCaptureUiCustomPoints {
  ...
  static getSizePrefixedRootAsPhotoTargetCaptureUiCustomPoints(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new PhotoTargetCaptureUiCustomPoints).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, o) {
    ...
    return s ? (o || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createPhotoTargetCaptureUiCustomPoints(t, o, s) {
    return PhotoTargetCaptureUiCustomPoints.startPhotoTargetCaptureUiCustomPoints(t), PhotoTargetCaptureUiCustomPoints.addType(t, o), PhotoTargetCaptureUiCustomPoints.addPoints(t, s), PhotoTargetCaptureUiCustomPoints.endPhotoTargetCaptureUiCustomPoints(t)
  }
}
