...
class PhotoTargetCaptureUiRequiredPointsCenter {
  ...
  static getSizePrefixedRootAsPhotoTargetCaptureUiRequiredPointsCenter(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PhotoTargetCaptureUiRequiredPointsCenter).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPhotoTargetCaptureUiRequiredPointsCenter(t, e) {
    return PhotoTargetCaptureUiRequiredPointsCenter.startPhotoTargetCaptureUiRequiredPointsCenter(t), PhotoTargetCaptureUiRequiredPointsCenter.addType(t, e), PhotoTargetCaptureUiRequiredPointsCenter.endPhotoTargetCaptureUiRequiredPointsCenter(t)
  }
}
