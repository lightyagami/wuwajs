...
class BvbWaitForGameBeginData {
  ...
  static getSizePrefixedRootAsBvbWaitForGameBeginData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbWaitForGameBeginData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbWaitForGameBeginData(t, a) {
    return BvbWaitForGameBeginData.startBvbWaitForGameBeginData(t), BvbWaitForGameBeginData.addType(t, a), BvbWaitForGameBeginData.endBvbWaitForGameBeginData(t)
  }
}
