...
class BvbStartBattleData {
  ...
  static getSizePrefixedRootAsBvbStartBattleData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbStartBattleData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbStartBattleData(t, a) {
    return BvbStartBattleData.startBvbStartBattleData(t), BvbStartBattleData.addType(t, a), BvbStartBattleData.endBvbStartBattleData(t)
  }
}
