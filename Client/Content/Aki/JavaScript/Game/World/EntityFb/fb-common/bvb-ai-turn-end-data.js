...
class BvbAiTurnEndData {
  ...
  static getSizePrefixedRootAsBvbAiTurnEndData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new BvbAiTurnEndData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBvbAiTurnEndData(t, a) {
    return BvbAiTurnEndData.startBvbAiTurnEndData(t), BvbAiTurnEndData.addType(t, a), BvbAiTurnEndData.endBvbAiTurnEndData(t)
  }
}
