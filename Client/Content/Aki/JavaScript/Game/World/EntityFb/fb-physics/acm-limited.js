...
class AcmLimited {
  ...
  static getSizePrefixedRootAsAcmLimited(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AcmLimited).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createAcmLimited(t, i, e) {
    return AcmLimited.startAcmLimited(t), AcmLimited.addType(t, i), AcmLimited.addLimitValue(t, e), AcmLimited.endAcmLimited(t)
  }
}
