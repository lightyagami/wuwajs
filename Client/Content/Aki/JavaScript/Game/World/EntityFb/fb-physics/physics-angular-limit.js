...
class PhysicsAngularLimit {
  ...
  static getSizePrefixedRootAsPhysicsAngularLimit(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PhysicsAngularLimit).__init(t.readInt32(t.position()) + t.position(), t)
  }
  swing1MotionType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_angular_constraint_motion_js_1.UnionAngularConstraintMotion.NONE
  }
  swing1Motion(t) {
