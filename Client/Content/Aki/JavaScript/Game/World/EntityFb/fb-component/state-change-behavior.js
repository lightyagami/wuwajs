...
class StateChangeBehavior {
  ...
  static getSizePrefixedRootAsStateChangeBehavior(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new StateChangeBehavior).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  delayChangeState(t) {
    ...
    return i ? (t || new delay_change_state_js_1.DelayChangeState).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  conditionAction(t, i) {
    var e = this.bb.__offset(this.bb_pos, 10);
    return e ? (i || new condition_action_js_1.ConditionAction).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
