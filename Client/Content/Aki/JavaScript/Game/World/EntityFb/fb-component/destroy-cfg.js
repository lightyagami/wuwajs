...
class DestroyCfg {
  ...
  static getSizePrefixedRootAsDestroyCfg(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new DestroyCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  conditionsType(t) {
  ...
  conditions(t, s) {
    ...
    return i ? this.bb.__union(s, this.bb.__vector(this.bb_pos + i) + 4 * t) : void 0
  }
  conditionsLength() {
  ...
  static createDestroyCfg(t, s, i) {
    return DestroyCfg.startDestroyCfg(t), DestroyCfg.addConditionsType(t, s), DestroyCfg.addConditions(t, i), DestroyCfg.endDestroyCfg(t)
  }
}
