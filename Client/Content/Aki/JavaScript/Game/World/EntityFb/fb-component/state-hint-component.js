...
class StateHintComponent {
  ...
  static getSizePrefixedRootAsStateHintComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StateHintComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createStateHintComponent(t, e, i) {
    return StateHintComponent.startStateHintComponent(t), StateHintComponent.addDisabled(t, e), StateHintComponent.addActiveConditions(t, i), StateHintComponent.endStateHintComponent(t)
  }
}
