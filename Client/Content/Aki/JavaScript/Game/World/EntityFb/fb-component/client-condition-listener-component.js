...
class ClientConditionListenerComponent {
  ...
  static getSizePrefixedRootAsClientConditionListenerComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ClientConditionListenerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  listeners(t, e) {
    ...
    return n ? (e || new client_condition_listener_js_1.ClientConditionListener).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  listenersLength() {
  ...
  static createClientConditionListenerComponent(t, e, n) {
    return ClientConditionListenerComponent.startClientConditionListenerComponent(t), ClientConditionListenerComponent.addDisabled(t, e), ClientConditionListenerComponent.addListeners(t, n), ClientConditionListenerComponent.endClientConditionListenerComponent(t)
  }
}
