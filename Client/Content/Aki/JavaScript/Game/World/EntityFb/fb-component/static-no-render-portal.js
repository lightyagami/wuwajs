...
class StaticNoRenderPortal {
  ...
  static getSizePrefixedRootAsStaticNoRenderPortal(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new StaticNoRenderPortal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  teleportSceneEffect(t) {
    ...
    return i ? (t || new teleport_scene_effect_js_1.TeleportSceneEffect).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  gravityConfig(t) {
    ...
    return i ? (t || new gravity_flip_teleport_config_js_1.GravityFlipTeleportConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
