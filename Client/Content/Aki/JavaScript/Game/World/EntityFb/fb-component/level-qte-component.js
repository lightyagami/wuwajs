...
class LevelQteComponent {
  ...
  static getSizePrefixedRootAsLevelQteComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new LevelQteComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  qteConfigType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_qte_type_js_1.UnionQteType.NONE
  }
  qteConfig(e) {
  ...
  static createLevelQteComponent(e, t, n, o) {
    return LevelQteComponent.startLevelQteComponent(e), LevelQteComponent.addDisabled(e, t), LevelQteComponent.addQteConfigType(e, n), LevelQteComponent.addQteConfig(e, o), LevelQteComponent.endLevelQteComponent(e)
  }
}
