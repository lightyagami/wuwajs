...
class FanInteractByFKey {
  ...
  static getSizePrefixedRootAsFanInteractByFKey(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FanInteractByFKey).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFanInteractByFKey(t, e, a) {
    return FanInteractByFKey.startFanInteractByFKey(t), FanInteractByFKey.addType(t, e), FanInteractByFKey.addTidInteractOptionText(t, a), FanInteractByFKey.endFanInteractByFKey(t)
  }
}
