...
class EntityListComponent {
  ...
  static getSizePrefixedRootAsEntityListComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityListComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createEntityListComponent(t, i) {
    return EntityListComponent.startEntityListComponent(t), EntityListComponent.addDisabled(t, i), EntityListComponent.endEntityListComponent(t)
  }
}
