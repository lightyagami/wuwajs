...
class FanInteractByHit {
  ...
  static getSizePrefixedRootAsFanInteractByHit(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FanInteractByHit).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFanInteractByHit(t, e) {
    return FanInteractByHit.startFanInteractByHit(t), FanInteractByHit.addType(t, e), FanInteractByHit.endFanInteractByHit(t)
  }
}
