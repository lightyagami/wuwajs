...
class RandomNpcRule {
  ...
  static getSizePrefixedRootAsRandomNpcRule(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RandomNpcRule).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  dateTimeList(t, e) {
    ...
    return i ? (e || new fixed_date_time_js_1.FixedDateTime).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  dateTimeListLength() {
  ...
  probabilityRefreshGroup(t) {
    ...
    return e ? (t || new probability_refresh_group_js_1.ProbabilityRefreshGroup).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
