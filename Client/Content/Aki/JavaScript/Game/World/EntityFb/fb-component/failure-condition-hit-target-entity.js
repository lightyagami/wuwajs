...
class FailureConditionHitTargetEntity {
  ...
  static getSizePrefixedRootAsFailureConditionHitTargetEntity(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FailureConditionHitTargetEntity).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFailureConditionHitTargetEntity(t, i, r) {
    return FailureConditionHitTargetEntity.startFailureConditionHitTargetEntity(t), FailureConditionHitTargetEntity.addType(t, i), FailureConditionHitTargetEntity.addEntityIds(t, r), FailureConditionHitTargetEntity.endFailureConditionHitTargetEntity(t)
  }
}
