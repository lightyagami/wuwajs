...
class ClientConditionListener {
  ...
  static getSizePrefixedRootAsClientConditionListener(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ClientConditionListener).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  actions(t, i) {
    ...
    return n ? (i || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createClientConditionListener(t, i, n, e) {
    return ClientConditionListener.startClientConditionListener(t), ClientConditionListener.addCondition(t, i), ClientConditionListener.addActions(t, n), ClientConditionListener.addSendSelfEvent(t, e), ClientConditionListener.endClientConditionListener(t)
  }
}
