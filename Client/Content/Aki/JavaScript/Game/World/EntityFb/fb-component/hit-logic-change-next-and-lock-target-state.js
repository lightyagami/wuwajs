...
class HitLogicChangeNextAndLockTargetState {
  ...
  static getSizePrefixedRootAsHitLogicChangeNextAndLockTargetState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitLogicChangeNextAndLockTargetState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitLogicChangeNextAndLockTargetState(t, e, a) {
    return HitLogicChangeNextAndLockTargetState.startHitLogicChangeNextAndLockTargetState(t), HitLogicChangeNextAndLockTargetState.addType(t, e), HitLogicChangeNextAndLockTargetState.addTargetState(t, a), HitLogicChangeNextAndLockTargetState.endHitLogicChangeNextAndLockTargetState(t)
  }
}
