...
class ActorStateComponent {
  ...
  static getSizePrefixedRootAsActorStateComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActorStateComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createActorStateComponent(t, e, o) {
    return ActorStateComponent.startActorStateComponent(t), ActorStateComponent.addDisabled(t, e), ActorStateComponent.addInitState(t, o), ActorStateComponent.endActorStateComponent(t)
  }
}
