...
class SpeedCurveMotion {
  ...
  static getSizePrefixedRootAsSpeedCurveMotion(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SpeedCurveMotion).__init(e.readInt32(e.position()) + e.position(), e)
  }
  speedCurve(e) {
  ...
  static createSpeedCurveMotion(e, t) {
    return SpeedCurveMotion.startSpeedCurveMotion(e), SpeedCurveMotion.addSpeedCurve(e, t), SpeedCurveMotion.endSpeedCurveMotion(e)
  }
}
