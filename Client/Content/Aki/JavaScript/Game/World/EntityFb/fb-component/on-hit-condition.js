...
class OnHitCondition {
  ...
  static getSizePrefixedRootAsOnHitCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OnHitCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createOnHitCondition(t, i, n) {
    return OnHitCondition.startOnHitCondition(t), OnHitCondition.addType(t, i), OnHitCondition.addBulletId(t, n), OnHitCondition.endOnHitCondition(t)
  }
}
