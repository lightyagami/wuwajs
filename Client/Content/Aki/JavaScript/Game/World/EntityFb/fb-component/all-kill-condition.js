...
class AllKillCondition {
  ...
  static getSizePrefixedRootAsAllKillCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AllKillCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type() {
  ...
  static createAllKillCondition(i, t) {
    return AllKillCondition.startAllKillCondition(i), AllKillCondition.addType(i, t), AllKillCondition.endAllKillCondition(i)
  }
}
