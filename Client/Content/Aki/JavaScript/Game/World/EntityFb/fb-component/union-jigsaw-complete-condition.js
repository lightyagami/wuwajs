...
exports.unionListToUnionJigsawCompleteCondition = exports.unionToUnionJigsawCompleteCondition = exports.UnionJigsawCompleteCondition = undefined;
const activate_all_correct_piece_js_1 = require("../fb-component/activate-all-correct-piece.js");
const activate_specified_piece_js_1 = require("../fb-component/activate-specified-piece.js");
const active_renju_piece_js_1 = require("../fb-component/active-renju-piece.js");
const put_in_the_specified_piece_js_1 = require("../fb-component/put-in-the-specified-piece.js");
...
function unionListToUnionJigsawCompleteCondition(e, i, t) {
  switch (UnionJigsawCompleteCondition[e]) {
    case "NONE":
      return;
    case "ActivateAllCorrectPiece":
      return i(t, new activate_all_correct_piece_js_1.ActivateAllCorrectPiece());
    case "ActivateSpecifiedPiece":
...
})(UnionJigsawCompleteCondition = exports.UnionJigsawCompleteCondition ||= {});
exports.unionToUnionJigsawCompleteCondition = unionToUnionJigsawCompleteCondition;
exports.unionListToUnionJigsawCompleteCondition = unionListToUnionJigsawCompleteCondition; //# sourceMappingURL=union-jigsaw-complete-condition.js.map