...
class GravityFlipTeleportConfig {
  ...
  static getSizePrefixedRootAsGravityFlipTeleportConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new GravityFlipTeleportConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  gravityDirectionType() {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? this.bb.readUint8(this.bb_pos + i) : union_gravity_direction_js_1.UnionGravityDirection.NONE
  }
  gravityDirection(i) {
  ...
  safeLocation(i) {
    ...
    return t ? (i || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
