...
class AngleWeight {
  ...
  static getSizePrefixedRootAsAngleWeight(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AngleWeight).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  angleWeight(t, e) {
    ...
    return i ? (e || new entity_angle_weight_js_1.EntityAngleWeight).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  angleWeightLength() {
  ...
  static createAngleWeight(t, e, i) {
    return AngleWeight.startAngleWeight(t), AngleWeight.addType(t, e), AngleWeight.addAngleWeight(t, i), AngleWeight.endAngleWeight(t)
  }
}
