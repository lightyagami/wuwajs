...
class IgnoreEntityIdsCollision {
  ...
  static getSizePrefixedRootAsIgnoreEntityIdsCollision(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new IgnoreEntityIdsCollision).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityIds(t) {
  ...
  static createIgnoreEntityIdsCollision(t, i) {
    return IgnoreEntityIdsCollision.startIgnoreEntityIdsCollision(t), IgnoreEntityIdsCollision.addEntityIds(t, i), IgnoreEntityIdsCollision.endIgnoreEntityIdsCollision(t)
  }
}
