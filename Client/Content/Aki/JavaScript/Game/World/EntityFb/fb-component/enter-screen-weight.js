...
class EnterScreenWeight {
  ...
  static getSizePrefixedRootAsEnterScreenWeight(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EnterScreenWeight).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEnterScreenWeight(e, t, r) {
    return EnterScreenWeight.startEnterScreenWeight(e), EnterScreenWeight.addType(e, t), EnterScreenWeight.addWeight(e, r), EnterScreenWeight.endEnterScreenWeight(e)
  }
}
