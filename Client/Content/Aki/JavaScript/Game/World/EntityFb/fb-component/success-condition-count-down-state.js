...
class SuccessConditionCountDownState {
  ...
  static getSizePrefixedRootAsSuccessConditionCountDownState(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new SuccessConditionCountDownState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSuccessConditionCountDownState(t, o) {
    return SuccessConditionCountDownState.startSuccessConditionCountDownState(t), SuccessConditionCountDownState.addType(t, o), SuccessConditionCountDownState.endSuccessConditionCountDownState(t)
  }
}
