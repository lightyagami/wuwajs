...
class CompassTracking {
  ...
  static getSizePrefixedRootAsCompassTracking(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CompassTracking).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  iconTrackingConfig(t) {
    ...
    return s ? (t || new icon_near_by_tracking_config_js_1.IconNearByTrackingConfig).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  vehicleTypes(t, s) {
