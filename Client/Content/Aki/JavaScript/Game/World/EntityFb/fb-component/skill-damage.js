...
class SkillDamage {
  ...
  static getSizePrefixedRootAsSkillDamage(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new SkillDamage).__init(t.readInt32(t.position()) + t.position(), t)
  }
  defaultValue() {
  ...
  static createSkillDamage(t, a, i, s, e, l, r, h, u) {
    return SkillDamage.startSkillDamage(t), SkillDamage.addDefaultValue(t, a), SkillDamage.addNormalAttack(t, i), SkillDamage.addAccumulatorAttack(t, s), SkillDamage.addSuperSkill(t, e), SkillDamage.addQteAttack(t, l), SkillDamage.addNormalSkill(t, r), SkillDamage.addFightVersion(t, h), SkillDamage.addExploreVersion(t, u), SkillDamage.endSkillDamage(t)
  }
}
