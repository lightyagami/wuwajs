...
class MidViewDistance {
  ...
  static getSizePrefixedRootAsMidViewDistance(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MidViewDistance).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createMidViewDistance(i, t) {
    return MidViewDistance.startMidViewDistance(i), MidViewDistance.addType(i, t), MidViewDistance.endMidViewDistance(i)
  }
}
