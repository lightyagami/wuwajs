...
class BatchBulletItem {
  ...
  static getSizePrefixedRootAsBatchBulletItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BatchBulletItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  time() {
  ...
  casterList(t, e) {
    ...
    return s ? (e || new batch_bullet_caster_js_1.BatchBulletCaster).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  casterListLength() {
  ...
  static createBatchBulletItem(t, e, s) {
    return BatchBulletItem.startBatchBulletItem(t), BatchBulletItem.addTime(t, e), BatchBulletItem.addCasterList(t, s), BatchBulletItem.endBatchBulletItem(t)
  }
}
