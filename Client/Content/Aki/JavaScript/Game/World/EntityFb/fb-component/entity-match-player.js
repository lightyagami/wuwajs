...
class EntityMatchPlayer {
  ...
  static getSizePrefixedRootAsEntityMatchPlayer(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityMatchPlayer).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEntityMatchPlayer(t, i, e, r, a) {
    return EntityMatchPlayer.startEntityMatchPlayer(t), EntityMatchPlayer.addType(t, i), EntityMatchPlayer.addMatchRoleOptionType(t, e), EntityMatchPlayer.addMatchRoleOption(t, r), EntityMatchPlayer.addChangeRoleTrigger(t, a), EntityMatchPlayer.endEntityMatchPlayer(t)
  }
}
