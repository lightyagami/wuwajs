...
class BulletCfg {
  ...
  static getSizePrefixedRootAsBulletCfg(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BulletCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createBulletCfg(t, e, i) {
    return BulletCfg.startBulletCfg(t), BulletCfg.addCreateConditionsType(t, e), BulletCfg.addCreateConditions(t, i), BulletCfg.endBulletCfg(t)
  }
}
