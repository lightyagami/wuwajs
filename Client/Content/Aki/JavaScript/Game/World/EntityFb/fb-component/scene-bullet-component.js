...
class SceneBulletComponent {
  ...
  static getSizePrefixedRootAsSceneBulletComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneBulletComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  bulletGroups(e, t) {
    ...
    return n ? (t || new scene_bullet_group_js_1.SceneBulletGroup).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * e), this.bb) : void 0
  }
  bulletGroupsLength() {
  ...
  static createSceneBulletComponent(e, t, n, s) {
    return SceneBulletComponent.startSceneBulletComponent(e), SceneBulletComponent.addDisabled(e, t), SceneBulletComponent.addDisableGenerateByRange(e, n), SceneBulletComponent.addBulletGroups(e, s), SceneBulletComponent.endSceneBulletComponent(e)
  }
}
