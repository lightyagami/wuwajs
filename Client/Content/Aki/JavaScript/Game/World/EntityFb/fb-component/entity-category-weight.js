...
class EntityCategoryWeight {
  ...
  static getSizePrefixedRootAsEntityCategoryWeight(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityCategoryWeight).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entitiyMatch(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new static_entitiy_match_js_1.StaticEntitiyMatch).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  weight() {
  ...
  static createEntityCategoryWeight(t, i, e) {
    return EntityCategoryWeight.startEntityCategoryWeight(t), EntityCategoryWeight.addEntitiyMatch(t, i), EntityCategoryWeight.addWeight(t, e), EntityCategoryWeight.endEntityCategoryWeight(t)
  }
}
