...
class MoveComponent {
  ...
  static getSizePrefixedRootAsMoveComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MoveComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createMoveComponent(t, e, o) {
    return MoveComponent.startMoveComponent(t), MoveComponent.addDisabled(t, e), MoveComponent.addInitSpeed(t, o), MoveComponent.endMoveComponent(t)
  }
}
