...
class HeadStateViewConfig {
  ...
  static getSizePrefixedRootAsHeadStateViewConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HeadStateViewConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  headStateViewType() {
  ...
  static createHeadStateViewConfig(t, e, i, a, s) {
    return HeadStateViewConfig.startHeadStateViewConfig(t), HeadStateViewConfig.addHeadStateViewType(t, e), HeadStateViewConfig.addZOffset(t, i), HeadStateViewConfig.addForwardOffset(t, a), HeadStateViewConfig.addHeadStateSocketName(t, s), HeadStateViewConfig.endHeadStateViewConfig(t)
  }
}
