...
class AiAlertNotifyComponent {
  ...
  static getSizePrefixedRootAsAiAlertNotifyComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AiAlertNotifyComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  extraAiAlert(t) {
    ...
    return i ? (t || new extra_ai_alert_js_1.ExtraAiAlert).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  excludeEntities(t) {
