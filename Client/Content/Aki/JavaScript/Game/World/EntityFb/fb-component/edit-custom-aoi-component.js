...
class EditCustomAoiComponent {
  ...
  static getRootAsEditCustomAoiComponent(t, i) {
    return (i || new EditCustomAoiComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEditCustomAoiComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EditCustomAoiComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createEditCustomAoiComponent(t, i, s) {
    return EditCustomAoiComponent.startEditCustomAoiComponent(t), EditCustomAoiComponent.addDisabled(t, i), EditCustomAoiComponent.addEntities(t, s), EditCustomAoiComponent.endEditCustomAoiComponent(t)
  }
}
