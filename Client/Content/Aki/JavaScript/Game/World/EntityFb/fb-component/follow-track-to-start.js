...
class FollowTrackToStart {
  ...
  static getSizePrefixedRootAsFollowTrackToStart(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new FollowTrackToStart).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createFollowTrackToStart(t, r) {
    return FollowTrackToStart.startFollowTrackToStart(t), FollowTrackToStart.addType(t, r), FollowTrackToStart.endFollowTrackToStart(t)
  }
}
