...
class NpcStandbyShowFinitely {
  ...
  static getSizePrefixedRootAsNpcStandbyShowFinitely(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcStandbyShowFinitely).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  montages(t, i) {
    ...
    return e ? (i || new npc_standby_show_finitely_info_js_1.NpcStandbyShowFinitelyInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  montagesLength() {
  ...
  static createNpcStandbyShowFinitely(t, i, e, n) {
    return NpcStandbyShowFinitely.startNpcStandbyShowFinitely(t), NpcStandbyShowFinitely.addType(t, i), NpcStandbyShowFinitely.addPlayMode(t, e), NpcStandbyShowFinitely.addMontages(t, n), NpcStandbyShowFinitely.endNpcStandbyShowFinitely(t)
  }
}
