...
class ColorChangeStrategyOfRGB {
  ...
  static getSizePrefixedRootAsColorChangeStrategyOfRGB(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ColorChangeStrategyOfRGB).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createColorChangeStrategyOfRGB(t, e, r, a, o) {
    return ColorChangeStrategyOfRGB.startColorChangeStrategyOfRGB(t), ColorChangeStrategyOfRGB.addType(t, e), ColorChangeStrategyOfRGB.addBlueState(t, r), ColorChangeStrategyOfRGB.addYellowState(t, a), ColorChangeStrategyOfRGB.addRedState(t, o), ColorChangeStrategyOfRGB.endColorChangeStrategyOfRGB(t)
  }
}
