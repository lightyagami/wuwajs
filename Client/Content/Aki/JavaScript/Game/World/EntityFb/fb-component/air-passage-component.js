...
class AirPassageComponent {
  ...
  static getSizePrefixedRootAsAirPassageComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AirPassageComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createAirPassageComponent(t, s) {
    return AirPassageComponent.startAirPassageComponent(t), AirPassageComponent.addDisabled(t, s), AirPassageComponent.endAirPassageComponent(t)
  }
}
