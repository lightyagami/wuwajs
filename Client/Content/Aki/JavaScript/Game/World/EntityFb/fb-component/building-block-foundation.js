...
class BuildingBlockFoundation {
  ...
  static getSizePrefixedRootAsBuildingBlockFoundation(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new BuildingBlockFoundation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createBuildingBlockFoundation(i, t) {
    return BuildingBlockFoundation.startBuildingBlockFoundation(i), BuildingBlockFoundation.addType(i, t), BuildingBlockFoundation.endBuildingBlockFoundation(i)
  }
}
