...
class HitLogicChangeCountDownState {
  ...
  static getSizePrefixedRootAsHitLogicChangeCountDownState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitLogicChangeCountDownState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitLogicChangeCountDownState(t, e) {
    return HitLogicChangeCountDownState.startHitLogicChangeCountDownState(t), HitLogicChangeCountDownState.addType(t, e), HitLogicChangeCountDownState.endHitLogicChangeCountDownState(t)
  }
}
