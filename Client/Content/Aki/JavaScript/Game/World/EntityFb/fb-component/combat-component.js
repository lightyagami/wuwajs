...
class CombatComponent {
  ...
  static getSizePrefixedRootAsCombatComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new CombatComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createCombatComponent(t, o) {
    return CombatComponent.startCombatComponent(t), CombatComponent.addDisabled(t, o), CombatComponent.endCombatComponent(t)
  }
}
