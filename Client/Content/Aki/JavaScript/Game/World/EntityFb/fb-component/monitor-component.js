...
class MonitorComponent {
  ...
  static getRootAsMonitorComponent(t, e) {
    return (e || new MonitorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsMonitorComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MonitorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  range(t) {
    ...
    return e ? (t || new cone_trigger_shape_js_1.ConeTriggerShape).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  availableStates(t, e) {
