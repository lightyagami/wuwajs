...
class BuffProducerComponent {
  ...
  static getSizePrefixedRootAsBuffProducerComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BuffProducerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  addBuffModeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_add_buff_mode_js_1.UnionAddBuffMode.NONE
  }
  addBuffMode(t) {
  ...
  static createBuffProducerComponent(t, e, o, r, u) {
    return BuffProducerComponent.startBuffProducerComponent(t), BuffProducerComponent.addDisabled(t, e), BuffProducerComponent.addAddBuffModeType(t, o), BuffProducerComponent.addAddBuffMode(t, r), BuffProducerComponent.addBuffId(t, u), BuffProducerComponent.endBuffProducerComponent(t)
  }
}
