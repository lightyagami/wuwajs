...
class LevelAISpline {
  ...
  static getSizePrefixedRootAsLevelAISpline(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new LevelAISpline).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  cycleOptionType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_level_ai_cycle_option_js_1.UnionLevelAiCycleOption.NONE
  }
  cycleOption(e) {
  ...
  points(e, t) {
    ...
    return i ? (t || new level_aispline_point_js_1.LevelAISplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createLevelAISpline(e, t, i, s, n, l, r, a) {
    return LevelAISpline.startLevelAISpline(e), LevelAISpline.addType(e, t), LevelAISpline.addEntityId(e, i), LevelAISpline.addCycleOptionType(e, s), LevelAISpline.addCycleOption(e, n), LevelAISpline.addUsePathFinding(e, l), LevelAISpline.addIsPassEveryKeyPoint(e, r), LevelAISpline.addPoints(e, a), LevelAISpline.endLevelAISpline(e)
  }
}
