...
class FixSpeed {
  ...
  static getSizePrefixedRootAsFixSpeed(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FixSpeed).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createFixSpeed(e, t, i) {
    return FixSpeed.startFixSpeed(e), FixSpeed.addType(e, t), FixSpeed.addSpeed(e, i), FixSpeed.endFixSpeed(e)
  }
}
