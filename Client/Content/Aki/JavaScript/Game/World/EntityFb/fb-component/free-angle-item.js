...
class FreeAngleItem {
  ...
  static getSizePrefixedRootAsFreeAngleItem(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FreeAngleItem).__init(e.readInt32(e.position()) + e.position(), e)
  }
  initAngle() {
  ...
  static createFreeAngleItem(e, t, r) {
    return FreeAngleItem.startFreeAngleItem(e), FreeAngleItem.addInitAngle(e, t), FreeAngleItem.addTargetAngle(e, r), FreeAngleItem.endFreeAngleItem(e)
  }
}
