...
class CollectComponent {
  ...
  static getRootAsCollectComponent(t, e) {
    return (e || new CollectComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCollectComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CollectComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createCollectComponent(t, e, o) {
    return CollectComponent.startCollectComponent(t), CollectComponent.addDisabled(t, e), CollectComponent.addIsDisableOneClickCollection(t, o), CollectComponent.endCollectComponent(t)
  }
}
