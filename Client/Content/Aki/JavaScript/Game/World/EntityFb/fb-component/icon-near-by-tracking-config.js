...
class IconNearByTrackingConfig {
  ...
  static getRootAsIconNearByTrackingConfig(t, i) {
    return (i || new IconNearByTrackingConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsIconNearByTrackingConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new IconNearByTrackingConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  showRange() {
