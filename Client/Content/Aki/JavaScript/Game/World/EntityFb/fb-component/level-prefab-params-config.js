...
class LevelPrefabParamsConfig {
  ...
  static getSizePrefixedRootAsLevelPrefabParamsConfig(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new LevelPrefabParamsConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  referenceActorKey(e) {
  ...
  paramsType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_params_preset_js_1.UnionParamsPreset.NONE
  }
  params(e) {
  ...
  static createLevelPrefabParamsConfig(e, r, a, s) {
    return LevelPrefabParamsConfig.startLevelPrefabParamsConfig(e), LevelPrefabParamsConfig.addReferenceActorKey(e, r), LevelPrefabParamsConfig.addParamsType(e, a), LevelPrefabParamsConfig.addParams(e, s), LevelPrefabParamsConfig.endLevelPrefabParamsConfig(e)
  }
}
