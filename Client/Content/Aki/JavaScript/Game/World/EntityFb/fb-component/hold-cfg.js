...
class HoldCfg {
  ...
  static getSizePrefixedRootAsHoldCfg(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HoldCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  trackTarget(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new holding_track_target_js_1.HoldingTrackTarget).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  ...
  static createHoldCfg(t, e) {
    return HoldCfg.startHoldCfg(t), HoldCfg.addTrackTarget(t, e), HoldCfg.endHoldCfg(t)
  }
}
