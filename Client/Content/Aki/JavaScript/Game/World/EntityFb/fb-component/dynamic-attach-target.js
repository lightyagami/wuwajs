...
class DynamicAttachTarget {
  ...
  static getSizePrefixedRootAsDynamicAttachTarget(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new DynamicAttachTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDynamicAttachTarget(t, a) {
    return DynamicAttachTarget.startDynamicAttachTarget(t), DynamicAttachTarget.addType(t, a), DynamicAttachTarget.endDynamicAttachTarget(t)
  }
}
