...
class VisibleConditionGroup {
  ...
  static getSizePrefixedRootAsVisibleConditionGroup(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VisibleConditionGroup).__init(i.readInt32(i.position()) + i.position(), i)
  }
  conditionsType(i) {
  ...
  conditionsTypeArray() {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? new Uint8Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + i), this.bb.__vector_len(this.bb_pos + i)) : void 0
  }
  conditions(i, t) {
    var s = this.bb.__offset(this.bb_pos, 6);
    return s ? this.bb.__union(t, this.bb.__vector(this.bb_pos + s) + 4 * i) : void 0
  }
  conditionsLength() {
  ...
  static createVisibleConditionGroup(i, t, s) {
    return VisibleConditionGroup.startVisibleConditionGroup(i), VisibleConditionGroup.addConditionsType(i, t), VisibleConditionGroup.addConditions(i, s), VisibleConditionGroup.endVisibleConditionGroup(i)
  }
}
