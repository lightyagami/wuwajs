...
class HitLogicChangeLockState {
  ...
  static getSizePrefixedRootAsHitLogicChangeLockState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitLogicChangeLockState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitLogicChangeLockState(t, e) {
    return HitLogicChangeLockState.startHitLogicChangeLockState(t), HitLogicChangeLockState.addType(t, e), HitLogicChangeLockState.endHitLogicChangeLockState(t)
  }
}
