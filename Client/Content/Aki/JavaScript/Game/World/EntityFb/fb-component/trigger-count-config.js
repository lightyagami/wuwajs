...
class TriggerCountConfig {
  ...
  static getSizePrefixedRootAsTriggerCountConfig(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new TriggerCountConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  triggerCount() {
  ...
  static createTriggerCountConfig(t, r, i) {
    return TriggerCountConfig.startTriggerCountConfig(t), TriggerCountConfig.addTriggerCount(t, r), TriggerCountConfig.addTriggerInterval(t, i), TriggerCountConfig.endTriggerCountConfig(t)
  }
}
