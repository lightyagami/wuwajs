...
class SpawnMonsterConstraintAnnularSector {
  ...
  static getSizePrefixedRootAsSpawnMonsterConstraintAnnularSector(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new SpawnMonsterConstraintAnnularSector).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSpawnMonsterConstraintAnnularSector(t, n, r, s, a) {
    return SpawnMonsterConstraintAnnularSector.startSpawnMonsterConstraintAnnularSector(t), SpawnMonsterConstraintAnnularSector.addType(t, n), SpawnMonsterConstraintAnnularSector.addInnerRadius(t, r), SpawnMonsterConstraintAnnularSector.addOuterRadius(t, s), SpawnMonsterConstraintAnnularSector.addAngle(t, a), SpawnMonsterConstraintAnnularSector.endSpawnMonsterConstraintAnnularSector(t)
  }
}
