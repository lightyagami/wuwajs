...
class BeamCastComponent {
  ...
  static getSizePrefixedRootAsBeamCastComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BeamCastComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  range(t) {
    ...
    return e ? (t || new cylinder_trigger_shape_js_1.CylinderTriggerShape).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  targetState(t) {
