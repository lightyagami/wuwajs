...
class NpcStandbyShowFinitelyInfo {
  ...
  static getSizePrefixedRootAsNpcStandbyShowFinitelyInfo(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcStandbyShowFinitelyInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  montage(t) {
  ...
  ignoreEntityCollision(t) {
    ...
    return i ? (t || new ignore_entity_ids_collision_js_1.IgnoreEntityIdsCollision).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
