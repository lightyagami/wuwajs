...
class HitBulletTypeOnlyDropAttack {
  ...
  static getSizePrefixedRootAsHitBulletTypeOnlyDropAttack(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitBulletTypeOnlyDropAttack).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitBulletTypeOnlyDropAttack(t, e) {
    return HitBulletTypeOnlyDropAttack.startHitBulletTypeOnlyDropAttack(t), HitBulletTypeOnlyDropAttack.addType(t, e), HitBulletTypeOnlyDropAttack.endHitBulletTypeOnlyDropAttack(t)
  }
}
