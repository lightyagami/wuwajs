...
class BossStateViewConfig {
  ...
  static getSizePrefixedRootAsBossStateViewConfig(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new BossStateViewConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  bossStateViewType() {
  ...
  static createBossStateViewConfig(t, s, i, e, o, a, n) {
    return BossStateViewConfig.startBossStateViewConfig(t), BossStateViewConfig.addBossStateViewType(t, s), BossStateViewConfig.addTidBossSubTitle(t, i), BossStateViewConfig.addBossStateInfoShowType(t, e), BossStateViewConfig.addTidLevelText(t, o), BossStateViewConfig.addOnlyShowInBattleState(t, a), BossStateViewConfig.addShowDistance(t, n), BossStateViewConfig.endBossStateViewConfig(t)
  }
}
