...
class ChargingDevice {
  ...
  static getSizePrefixedRootAsChargingDevice(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ChargingDevice).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createChargingDevice(t, e, i, r, s, a, h) {
    return ChargingDevice.startChargingDevice(t), ChargingDevice.addType(t, e), ChargingDevice.addMaxValue(t, i), ChargingDevice.addInitValue(t, r), ChargingDevice.addProgressPerformanceAttribute(t, s), ChargingDevice.addIncreaseSpeed(t, a), ChargingDevice.addHitExtraValue(t, h), ChargingDevice.endChargingDevice(t)
  }
}
