...
class BuffAreaStateConfig {
  ...
  static getSizePrefixedRootAsBuffAreaStateConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new BuffAreaStateConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  buffIds(t) {
    ...
    return i ? this.bb.readInt64(this.bb.__vector(this.bb_pos + i) + 8 * t) : BigInt(0)
  }
  buffIdsLength() {
