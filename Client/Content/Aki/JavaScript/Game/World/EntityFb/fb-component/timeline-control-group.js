...
class TimelineControlGroup {
  ...
  static getSizePrefixedRootAsTimelineControlGroup(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TimelineControlGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  controlConfigs(t, i) {
    ...
    return o ? this.bb.__union(i, this.bb.__vector(this.bb_pos + o) + 4 * t) : void 0
  }
  ...
  controlPointEvents(t, i) {
    ...
    return o ? (i || new control_point_event_config_js_1.ControlPointEventConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + 4 * t), this.bb) : void 0
  }
  ...
  static createTimelineControlGroup(t, i, o, r, n, e, s, l) {
    return TimelineControlGroup.startTimelineControlGroup(t), TimelineControlGroup.addCondition(t, i), TimelineControlGroup.addTidContent(t, o), TimelineControlGroup.addSegmentTime(t, r), TimelineControlGroup.addControlConfigsType(t, n), TimelineControlGroup.addControlConfigs(t, e), TimelineControlGroup.addControlPointEvents(t, s), TimelineControlGroup.addDescription(t, l), TimelineControlGroup.endTimelineControlGroup(t)
  }
}
