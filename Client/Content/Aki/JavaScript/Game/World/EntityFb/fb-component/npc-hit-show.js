...
class NpcHitShow {
  ...
  static getSizePrefixedRootAsNpcHitShow(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcHitShow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  hitMontage(t) {
  ...
  hitBubble(t) {
    ...
    return i ? (t || new bubble_index_js_1.BubbleIndex).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  bubbleRate() {
