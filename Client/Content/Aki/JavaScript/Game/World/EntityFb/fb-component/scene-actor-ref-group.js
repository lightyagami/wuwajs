...
class SceneActorRefGroup {
  ...
  static getSizePrefixedRootAsSceneActorRefGroup(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SceneActorRefGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityState(t) {
  ...
  static createSceneActorRefGroup(t, e, r) {
    return SceneActorRefGroup.startSceneActorRefGroup(t), SceneActorRefGroup.addEntityState(t, e), SceneActorRefGroup.addActions(t, r), SceneActorRefGroup.endSceneActorRefGroup(t)
  }
}
