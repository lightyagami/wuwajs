...
class TimePatrolSpline {
  ...
  static getSizePrefixedRootAsTimePatrolSpline(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TimePatrolSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, i) {
    ...
    return e ? (i || new time_patrol_spline_point_js_1.TimePatrolSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createTimePatrolSpline(t, i, e) {
    return TimePatrolSpline.startTimePatrolSpline(t), TimePatrolSpline.addType(t, i), TimePatrolSpline.addPoints(t, e), TimePatrolSpline.endTimePatrolSpline(t)
  }
}
