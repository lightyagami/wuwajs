...
class PointField {
  ...
  static getSizePrefixedRootAsPointField(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PointField).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPointField(t, i) {
    return PointField.startPointField(t), PointField.addType(t, i), PointField.endPointField(t)
  }
}
