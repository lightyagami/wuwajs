...
class DropComponent {
  ...
  static getRootAsDropComponent(t, o) {
    return (o || new DropComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsDropComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new DropComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createDropComponent(t, o) {
    return DropComponent.startDropComponent(t), DropComponent.addDisabled(t, o), DropComponent.endDropComponent(t)
  }
}
