...
class EventRotator {
  ...
  static getSizePrefixedRootAsEventRotator(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new EventRotator).__init(t.readInt32(t.position()) + t.position(), t)
  }
  startActions(t, s) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (s || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  startActionsLength() {
  ...
  static createEventRotator(t, s, r) {
    return EventRotator.startEventRotator(t), EventRotator.addStartActions(t, s), EventRotator.addEndActions(t, r), EventRotator.endEventRotator(t)
  }
}
