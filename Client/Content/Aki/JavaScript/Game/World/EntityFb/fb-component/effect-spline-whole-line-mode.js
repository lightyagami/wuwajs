...
class EffectSplineWholeLineMode {
  ...
  static getSizePrefixedRootAsEffectSplineWholeLineMode(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new EffectSplineWholeLineMode).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createEffectSplineWholeLineMode(e, t) {
    return EffectSplineWholeLineMode.startEffectSplineWholeLineMode(e), EffectSplineWholeLineMode.addType(e, t), EffectSplineWholeLineMode.endEffectSplineWholeLineMode(e)
  }
}
