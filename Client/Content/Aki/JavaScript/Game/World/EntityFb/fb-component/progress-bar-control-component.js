...
class ProgressBarControlComponent {
  ...
  static getSizePrefixedRootAsProgressBarControlComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ProgressBarControlComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  aimParts(t, i) {
    ...
    return r ? (i || new aim_part_js_1.AimPart).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  aimPartsLength() {
  ...
  controlType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_progress_bar_control_js_1.UnionProgressBarControl.NONE
  }
  control(t) {
