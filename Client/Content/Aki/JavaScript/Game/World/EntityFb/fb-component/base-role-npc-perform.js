...
class BaseRoleNpcPerform {
  ...
  static getSizePrefixedRootAsBaseRoleNpcPerform(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new BaseRoleNpcPerform).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createBaseRoleNpcPerform(e, r) {
    return BaseRoleNpcPerform.startBaseRoleNpcPerform(e), BaseRoleNpcPerform.addType(e, r), BaseRoleNpcPerform.endBaseRoleNpcPerform(e)
  }
}
