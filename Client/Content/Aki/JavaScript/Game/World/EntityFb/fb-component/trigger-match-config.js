...
class TriggerMatchConfig {
  ...
  static getSizePrefixedRootAsTriggerMatchConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TriggerMatchConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityMatchType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_entity_match_js_1.UnionEntityMatch.NONE
  }
  entityMatch(t) {
  ...
  static createTriggerMatchConfig(t, i, r, e) {
    return TriggerMatchConfig.startTriggerMatchConfig(t), TriggerMatchConfig.addEntityMatchType(t, i), TriggerMatchConfig.addEntityMatch(t, r), TriggerMatchConfig.addEntityMatchCount(t, e), TriggerMatchConfig.endTriggerMatchConfig(t)
  }
}
