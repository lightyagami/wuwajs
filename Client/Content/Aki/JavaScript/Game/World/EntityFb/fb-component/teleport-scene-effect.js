...
class TeleportSceneEffect {
  ...
  static getSizePrefixedRootAsTeleportSceneEffect(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TeleportSceneEffect).__init(e.readInt32(e.position()) + e.position(), e)
  }
  worldEffectPath(e) {
  ...
  static createTeleportSceneEffect(e, t, r) {
    return TeleportSceneEffect.startTeleportSceneEffect(e), TeleportSceneEffect.addWorldEffectPath(e, t), TeleportSceneEffect.addScreenEffectPath(e, r), TeleportSceneEffect.endTeleportSceneEffect(e)
  }
}
