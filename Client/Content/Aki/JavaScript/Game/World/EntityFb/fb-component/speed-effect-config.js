...
class SpeedEffectConfig {
  ...
  static getSizePrefixedRootAsSpeedEffectConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SpeedEffectConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  minVehicleSpeed() {
  ...
  gameplayCueIds(e) {
    ...
    return t ? this.bb.readInt64(this.bb.__vector(this.bb_pos + t) + 8 * e) : BigInt(0)
  }
  ...
  static createSpeedEffectConfig(e, t, i, s) {
    return SpeedEffectConfig.startSpeedEffectConfig(e), SpeedEffectConfig.addMinVehicleSpeed(e, t), SpeedEffectConfig.addMaxVehicleSpeed(e, i), SpeedEffectConfig.addGameplayCueIds(e, s), SpeedEffectConfig.endSpeedEffectConfig(e)
  }
}
