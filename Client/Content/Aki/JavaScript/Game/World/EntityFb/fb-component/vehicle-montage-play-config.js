...
class VehicleMontagePlayConfig {
  ...
  static getSizePrefixedRootAsVehicleMontagePlayConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new VehicleMontagePlayConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  ...
  static createVehicleMontagePlayConfig(e, t, i, a, n, o) {
    return VehicleMontagePlayConfig.startVehicleMontagePlayConfig(e), VehicleMontagePlayConfig.addMinMontageSpeedFactor(e, t), VehicleMontagePlayConfig.addMaxMontageSpeedFactor(e, i), VehicleMontagePlayConfig.addMinVehicleSpeed(e, a), VehicleMontagePlayConfig.addMaxVehicleSpeed(e, n), VehicleMontagePlayConfig.addTargetState(e, o), VehicleMontagePlayConfig.endVehicleMontagePlayConfig(e)
  }
}
