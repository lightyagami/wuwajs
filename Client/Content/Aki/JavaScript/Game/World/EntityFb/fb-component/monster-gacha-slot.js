...
class MonsterGachaSlot {
  ...
  static getSizePrefixedRootAsMonsterGachaSlot(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new MonsterGachaSlot).__init(t.readInt32(t.position()) + t.position(), t)
  }
  pos(t) {
    var s = this.bb.__offset(this.bb_pos, 4);
    return s ? (t || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  ...
  static createMonsterGachaSlot(t, s) {
    return MonsterGachaSlot.startMonsterGachaSlot(t), MonsterGachaSlot.addPos(t, s), MonsterGachaSlot.endMonsterGachaSlot(t)
  }
}
