...
class SkyboxDistanceTrigger {
  ...
  static getSizePrefixedRootAsSkyboxDistanceTrigger(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SkyboxDistanceTrigger).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createSkyboxDistanceTrigger(t, e, i) {
    return SkyboxDistanceTrigger.startSkyboxDistanceTrigger(t), SkyboxDistanceTrigger.addType(t, e), SkyboxDistanceTrigger.addDistance(t, i), SkyboxDistanceTrigger.endSkyboxDistanceTrigger(t)
  }
}
