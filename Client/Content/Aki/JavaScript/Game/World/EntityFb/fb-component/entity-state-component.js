...
class EntityStateComponent {
  ...
  static getSizePrefixedRootAsEntityStateComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityStateComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  stateChangeCondition(t) {
    ...
    return e ? (t || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  stateChangeBehaviors(t, e) {
    var i = this.bb.__offset(this.bb_pos, 12);
    return i ? (e || new state_change_behavior_js_1.StateChangeBehavior).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  lockConfig(t) {
    ...
    return e ? (t || new lock_config_js_1.LockConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  stateConfigs(t, e) {
    var i = this.bb.__offset(this.bb_pos, 18);
    return i ? (e || new state_config_js_1.StateConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  stateConfigsLength() {
  ...
  cycleStates(t, e) {
    ...
    return i ? this.bb.__string(this.bb.__vector(this.bb_pos + i) + 4 * t, e) : void 0
  }
  cycleStatesLength() {
