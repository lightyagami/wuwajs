...
class SplineComponent {
  ...
  static getSizePrefixedRootAsSplineComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new SplineComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  optionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spline_option_js_1.UnionSplineOption.NONE
  }
  option(t) {
  ...
  static createSplineComponent(t, n, e, i) {
    return SplineComponent.startSplineComponent(t), SplineComponent.addDisabled(t, n), SplineComponent.addOptionType(t, e), SplineComponent.addOption(t, i), SplineComponent.endSplineComponent(t)
  }
}
