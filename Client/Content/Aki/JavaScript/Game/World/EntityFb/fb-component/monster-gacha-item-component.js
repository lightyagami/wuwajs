...
class MonsterGachaItemComponent {
  ...
  static getRootAsMonsterGachaItemComponent(t, e) {
    return (e || new MonsterGachaItemComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsMonsterGachaItemComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MonsterGachaItemComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createMonsterGachaItemComponent(t, e, s, n, r) {
    return MonsterGachaItemComponent.startMonsterGachaItemComponent(t), MonsterGachaItemComponent.addDisabled(t, e), MonsterGachaItemComponent.addMaterialDataPath(t, s), MonsterGachaItemComponent.addMonsterType(t, n), MonsterGachaItemComponent.addMonsterEntityIds(t, r), MonsterGachaItemComponent.endMonsterGachaItemComponent(t)
  }
}
