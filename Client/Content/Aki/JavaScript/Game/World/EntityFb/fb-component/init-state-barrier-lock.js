...
class InitStateBarrierLock {
  ...
  static getSizePrefixedRootAsInitStateBarrierLock(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new InitStateBarrierLock).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createInitStateBarrierLock(t, r) {
    return InitStateBarrierLock.startInitStateBarrierLock(t), InitStateBarrierLock.addType(t, r), InitStateBarrierLock.endInitStateBarrierLock(t)
  }
}
