...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.unionListToUnionRefreshRule = exports.unionToUnionRefreshRule = exports.UnionRefreshRule = void 0;
...
function unionToUnionRefreshRule(e, r) {
  switch (UnionRefreshRule[e]) {
    ...
    case "FixedDateTimeRefreshRule":
      return r(new fixed_date_time_refresh_rule_js_1.FixedDateTimeRefreshRule);
    case "RandomNpcRule":
...
function unionListToUnionRefreshRule(e, r, n) {
  switch (UnionRefreshRule[e]) {
    ...
    case "FixedDateTimeRefreshRule":
      return r(n, new fixed_date_time_refresh_rule_js_1.FixedDateTimeRefreshRule);
    case "RandomNpcRule":
  ...
  e[e.NONE = 0] = "NONE", e[e.CdRefreshRule = 1] = "CdRefreshRule", e[e.FixedDateTimeRefreshRule = 2] = "FixedDateTimeRefreshRule", e[e.RandomNpcRule = 3] = "RandomNpcRule"
}(UnionRefreshRule = exports.UnionRefreshRule || (exports.UnionRefreshRule = {})), exports.unionToUnionRefreshRule = unionToUnionRefreshRule, exports.unionListToUnionRefreshRule = unionListToUnionRefreshRule;
