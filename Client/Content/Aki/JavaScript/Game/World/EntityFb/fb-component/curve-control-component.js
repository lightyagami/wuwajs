...
class CurveControlComponent {
  ...
  static getSizePrefixedRootAsCurveControlComponent(o, t) {
    return o.setPosition(o.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CurveControlComponent).__init(o.readInt32(o.position()) + o.position(), o)
  }
  disabled() {
  ...
  curveControlConfigType() {
    ...
    return o ? this.bb.readUint8(this.bb_pos + o) : union_curve_control_config_js_1.UnionCurveControlConfig.NONE
  }
  ...
  static createCurveControlComponent(o, t, n, r) {
    return CurveControlComponent.startCurveControlComponent(o), CurveControlComponent.addDisabled(o, t), CurveControlComponent.addCurveControlConfigType(o, n), CurveControlComponent.addCurveControlConfig(o, r), CurveControlComponent.endCurveControlComponent(o)
  }
}
