...
class ChessmanComponent {
  ...
  static getSizePrefixedRootAsChessmanComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ChessmanComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  startMovingActions(t, s) {
    ...
    return n ? (s || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  ...
  static createChessmanComponent(t, s, n, e) {
    return ChessmanComponent.startChessmanComponent(t), ChessmanComponent.addDisabled(t, s), ChessmanComponent.addStartMovingActions(t, n), ChessmanComponent.addEndMovingActions(t, e), ChessmanComponent.endChessmanComponent(t)
  }
}
