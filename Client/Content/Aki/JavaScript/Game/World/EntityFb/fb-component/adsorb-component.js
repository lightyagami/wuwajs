...
class AdsorbComponent {
  ...
  static getRootAsAdsorbComponent(t, s) {
    return (s || new AdsorbComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsAdsorbComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AdsorbComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  activeStateCondition(t) {
    ...
    return s ? (t || new entity_state_js_1.EntityState).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  adsorbLimitedTime() {
