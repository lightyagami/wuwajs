...
class LevelAIState {
  ...
  static getSizePrefixedRootAsLevelAIState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LevelAIState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateId() {
  ...
  behaviourType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_level_aibehaviour_js_1.UnionLevelAIBehaviour.NONE
  }
  behaviour(t) {
