...
class AllRefreshContent {
  ...
  static getSizePrefixedRootAsAllRefreshContent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AllRefreshContent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createAllRefreshContent(t, e, s) {
    return AllRefreshContent.startAllRefreshContent(t), AllRefreshContent.addType(t, e), AllRefreshContent.addEntityIds(t, s), AllRefreshContent.endAllRefreshContent(t)
  }
}
