...
class InteractAudioComponent {
  ...
  static getSizePrefixedRootAsInteractAudioComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new InteractAudioComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  interactEventConfig(t) {
    ...
    return e ? (t || new audio_event_config_js_1.AudioEventConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
