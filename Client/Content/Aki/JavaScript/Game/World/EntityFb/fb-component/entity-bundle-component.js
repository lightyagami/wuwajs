...
class EntityBundleComponent {
  ...
  static getSizePrefixedRootAsEntityBundleComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new EntityBundleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  childInfos(t, n) {
    ...
    return e ? (n || new entity_bundle_child_info_js_1.EntityBundleChildInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  childInfosLength() {
  ...
  static createEntityBundleComponent(t, n, e, i) {
    return EntityBundleComponent.startEntityBundleComponent(t), EntityBundleComponent.addDisabled(t, n), EntityBundleComponent.addBundleId(t, e), EntityBundleComponent.addChildInfos(t, i), EntityBundleComponent.endEntityBundleComponent(t)
  }
}
