...
class EntityTrackControl {
  ...
  static getSizePrefixedRootAsEntityTrackControl(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EntityTrackControl).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  controlPoints(t, r) {
    ...
    return i ? (r || new entity_track_control_point_js_1.EntityTrackControlPoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  controlPointsLength() {
  ...
  static createEntityTrackControl(t, r, i, o) {
    return EntityTrackControl.startEntityTrackControl(t), EntityTrackControl.addType(t, r), EntityTrackControl.addEntityId(t, i), EntityTrackControl.addControlPoints(t, o), EntityTrackControl.endEntityTrackControl(t)
  }
}
