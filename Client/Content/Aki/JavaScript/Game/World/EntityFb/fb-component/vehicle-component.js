...
class VehicleComponent {
  ...
  static getSizePrefixedRootAsVehicleComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VehicleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  teleportPlayersWhenDestroyed(t) {
    ...
    return e ? (t || new passenger_teleport_config_js_1.PassengerTeleportConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  ...
  vehicleFeatures(t, e) {
    ...
    return i ? this.bb.__union(e, this.bb.__vector(this.bb_pos + i) + 4 * t) : void 0
  }
  ...
  defaultPassengers(t, e) {
    ...
    return i ? (e || new vehicle_passenger_config_js_1.VehiclePassengerConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
