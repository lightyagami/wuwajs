...
class EntityGroupFailureArbitraryState {
  ...
  static getSizePrefixedRootAsEntityGroupFailureArbitraryState(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new EntityGroupFailureArbitraryState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEntityGroupFailureArbitraryState(t, r, i) {
    return EntityGroupFailureArbitraryState.startEntityGroupFailureArbitraryState(t), EntityGroupFailureArbitraryState.addType(t, r), EntityGroupFailureArbitraryState.addState(t, i), EntityGroupFailureArbitraryState.endEntityGroupFailureArbitraryState(t)
  }
}
