...
class EntityState {
  ...
  static getSizePrefixedRootAsEntityState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEntityState(t, e, i) {
    return EntityState.startEntityState(t), EntityState.addType(t, e), EntityState.addState(t, i), EntityState.endEntityState(t)
  }
}
