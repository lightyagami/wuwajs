...
class AttachTargetComponent {
  ...
  static getSizePrefixedRootAsAttachTargetComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AttachTargetComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  attachTargetType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_attach_target_js_1.UnionAttachTarget.NONE
  }
  attachTarget(t) {
  ...
  static createAttachTargetComponent(t, e, a, r, s, n) {
    return AttachTargetComponent.startAttachTargetComponent(t), AttachTargetComponent.addDisabled(t, e), AttachTargetComponent.addAttachTargetType(t, a), AttachTargetComponent.addAttachTarget(t, r), AttachTargetComponent.addPosRule(t, s), AttachTargetComponent.addRotRule(t, n), AttachTargetComponent.endAttachTargetComponent(t)
  }
}
