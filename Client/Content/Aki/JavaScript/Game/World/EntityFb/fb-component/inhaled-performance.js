...
class InhaledPerformance {
  ...
  static getSizePrefixedRootAsInhaledPerformance(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new InhaledPerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  inhaledTime() {
  ...
  static createInhaledPerformance(e, r) {
    return InhaledPerformance.startInhaledPerformance(e), InhaledPerformance.addInhaledTime(e, r), InhaledPerformance.endInhaledPerformance(e)
  }
}
