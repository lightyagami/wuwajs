...
class RandomEntityRefreshContent {
  ...
  static getSizePrefixedRootAsRandomEntityRefreshContent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RandomEntityRefreshContent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRandomEntityRefreshContent(t, e, n) {
    return RandomEntityRefreshContent.startRandomEntityRefreshContent(t), RandomEntityRefreshContent.addType(t, e), RandomEntityRefreshContent.addEntityIds(t, n), RandomEntityRefreshContent.endRandomEntityRefreshContent(t)
  }
}
