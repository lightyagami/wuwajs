...
class HitLogicChangeTargetState {
  ...
  static getSizePrefixedRootAsHitLogicChangeTargetState(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HitLogicChangeTargetState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  targetBulletHitConfigs(t, i) {
    ...
    return e ? (i || new condition_hit_config_with_bullet_js_1.ConditionHitConfigWithBullet).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  ...
  otherBulletsHitConfig(t, i) {
    ...
    return e ? (i || new condition_hit_config_js_1.ConditionHitConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  ...
  static createHitLogicChangeTargetState(t, i, e, r) {
    return HitLogicChangeTargetState.startHitLogicChangeTargetState(t), HitLogicChangeTargetState.addType(t, i), HitLogicChangeTargetState.addTargetBulletHitConfigs(t, e), HitLogicChangeTargetState.addOtherBulletsHitConfig(t, r), HitLogicChangeTargetState.endHitLogicChangeTargetState(t)
  }
}
