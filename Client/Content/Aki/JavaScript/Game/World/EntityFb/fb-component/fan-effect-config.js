...
class FanEffectConfig {
  ...
  static getSizePrefixedRootAsFanEffectConfig(t, f) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (f || new FanEffectConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effectPath(t) {
  ...
  static createFanEffectConfig(t, f, e, i) {
    return FanEffectConfig.startFanEffectConfig(t), FanEffectConfig.addEffectPath(t, f), FanEffectConfig.addDefaultEffectLength(t, e), FanEffectConfig.addHitEffectPath(t, i), FanEffectConfig.endFanEffectConfig(t)
  }
}
