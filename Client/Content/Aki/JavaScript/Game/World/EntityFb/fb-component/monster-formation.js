...
class MonsterFormation {
  ...
  static getSizePrefixedRootAsMonsterFormation(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new MonsterFormation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createMonsterFormation(t, o) {
    return MonsterFormation.startMonsterFormation(t), MonsterFormation.addFormationPosConfig(t, o), MonsterFormation.endMonsterFormation(t)
  }
}
