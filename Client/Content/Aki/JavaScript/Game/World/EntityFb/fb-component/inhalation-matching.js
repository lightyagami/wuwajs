...
class InhalationMatching {
  ...
  static getRootAsInhalationMatching(t, i) {
    return (i || new InhalationMatching).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsInhalationMatching(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InhalationMatching).__init(t.readInt32(t.position()) + t.position(), t)
  }
  inhalationStrength() {
