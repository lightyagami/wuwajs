...
class SceneItemAiPatrolByGameTime {
  ...
  static getSizePrefixedRootAsSceneItemAiPatrolByGameTime(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneItemAiPatrolByGameTime).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSceneItemAiPatrolByGameTime(e, t, i) {
    return SceneItemAiPatrolByGameTime.startSceneItemAiPatrolByGameTime(e), SceneItemAiPatrolByGameTime.addType(e, t), SceneItemAiPatrolByGameTime.addSpline(e, i), SceneItemAiPatrolByGameTime.endSceneItemAiPatrolByGameTime(e)
  }
}
