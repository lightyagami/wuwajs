...
class AiGearStrategyComponent {
  ...
  static getSizePrefixedRootAsAiGearStrategyComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AiGearStrategyComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  strategyTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_ai_gear_strategy_js_1.UnionAiGearStrategy.NONE
  }
  strategyType(t) {
  ...
  static createAiGearStrategyComponent(t, e, r, a) {
    return AiGearStrategyComponent.startAiGearStrategyComponent(t), AiGearStrategyComponent.addDisabled(t, e), AiGearStrategyComponent.addStrategyTypeType(t, r), AiGearStrategyComponent.addStrategyType(t, a), AiGearStrategyComponent.endAiGearStrategyComponent(t)
  }
}
