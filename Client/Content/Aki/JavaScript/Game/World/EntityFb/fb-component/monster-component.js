...
class MonsterComponent {
  ...
  static getSizePrefixedRootAsMonsterComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new MonsterComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  bossViewConfig(t) {
    ...
    return s ? (t || new boss_state_view_config_js_1.BossStateViewConfig).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  initGasTag(t, s) {
    var i = this.bb.__offset(this.bb_pos, 10);
    return i ? this.bb.__string(this.bb.__vector(this.bb_pos + i) + 4 * t, s) : void 0
  }
  initGasTagLength() {
  ...
  performConfig(t) {
    ...
    return s ? (t || new monster_perform_config_js_1.MonsterPerformConfig).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
