...
class SphereFactoryComponent {
  ...
  static getRootAsSphereFactoryComponent(t, e) {
    return (e || new SphereFactoryComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSphereFactoryComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SphereFactoryComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
