...
class PortalComponent {
  ...
  static getSizePrefixedRootAsPortalComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new PortalComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_portal_config_js_1.UnionPortalConfig.NONE
  }
  config(t) {
  ...
  static createPortalComponent(t, o, n, e) {
    return PortalComponent.startPortalComponent(t), PortalComponent.addDisabled(t, o), PortalComponent.addConfigType(t, n), PortalComponent.addConfig(t, e), PortalComponent.endPortalComponent(t)
  }
}
