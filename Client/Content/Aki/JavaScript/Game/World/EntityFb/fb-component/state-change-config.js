...
class StateChangeConfig {
  ...
  static getSizePrefixedRootAsStateChangeConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StateChangeConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  refreshState(t) {
  ...
  static createStateChangeConfig(t, e, a) {
    return StateChangeConfig.startStateChangeConfig(t), StateChangeConfig.addRefreshState(t, e), StateChangeConfig.addSubDestroyState(t, a), StateChangeConfig.endStateChangeConfig(t)
  }
}
