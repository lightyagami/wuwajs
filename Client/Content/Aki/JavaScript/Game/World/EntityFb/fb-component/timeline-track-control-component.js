...
class TimelineTrackControlComponent {
  ...
  static getSizePrefixedRootAsTimelineTrackControlComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new TimelineTrackControlComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  controlGroups(t, o) {
    ...
    return e ? (o || new timeline_control_group_js_1.TimelineControlGroup).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  controlGroupsLength() {
  ...
  static createTimelineTrackControlComponent(t, o, e) {
    return TimelineTrackControlComponent.startTimelineTrackControlComponent(t), TimelineTrackControlComponent.addDisabled(t, o), TimelineTrackControlComponent.addControlGroups(t, e), TimelineTrackControlComponent.endTimelineTrackControlComponent(t)
  }
}
