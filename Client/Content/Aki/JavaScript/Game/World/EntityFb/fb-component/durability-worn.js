...
class DurabilityWorn {
  ...
  static getSizePrefixedRootAsDurabilityWorn(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new DurabilityWorn).__init(t.readInt32(t.position()) + t.position(), t)
  }
  slightWear() {
  ...
  static createDurabilityWorn(t, r, i) {
    return DurabilityWorn.startDurabilityWorn(t), DurabilityWorn.addSlightWear(t, r), DurabilityWorn.addSevereWear(t, i), DurabilityWorn.endDurabilityWorn(t)
  }
}
