...
class AudioPointNearbyTracking {
  ...
  static getSizePrefixedRootAsAudioPointNearbyTracking(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AudioPointNearbyTracking).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createAudioPointNearbyTracking(i, t, r, a, e) {
    return AudioPointNearbyTracking.startAudioPointNearbyTracking(i), AudioPointNearbyTracking.addType(i, t), AudioPointNearbyTracking.addNearRadius(i, r), AudioPointNearbyTracking.addMiddleRadius(i, a), AudioPointNearbyTracking.addFarRadius(i, e), AudioPointNearbyTracking.endAudioPointNearbyTracking(i)
  }
}
