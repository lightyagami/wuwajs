...
class ActivateSpecifiedPieceConfig {
  ...
  static getSizePrefixedRootAsActivateSpecifiedPieceConfig(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActivateSpecifiedPieceConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  jigsaw(i) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (i || new jigsaw_config_js_1.JigsawConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  selfState(i) {
  ...
  static createActivateSpecifiedPieceConfig(i, e, t) {
    return ActivateSpecifiedPieceConfig.startActivateSpecifiedPieceConfig(i), ActivateSpecifiedPieceConfig.addJigsaw(i, e), ActivateSpecifiedPieceConfig.addSelfState(i, t), ActivateSpecifiedPieceConfig.endActivateSpecifiedPieceConfig(i)
  }
}
