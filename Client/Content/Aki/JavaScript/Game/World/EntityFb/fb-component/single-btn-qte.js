...
class SingleBtnQte {
  ...
  static getSizePrefixedRootAsSingleBtnQte(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SingleBtnQte).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  successCallback(t) {
    ...
    return e ? (t || new qte_callback_js_1.QteCallback).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  failureCallback(t) {
