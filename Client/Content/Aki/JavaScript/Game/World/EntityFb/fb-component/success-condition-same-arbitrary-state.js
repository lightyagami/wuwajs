...
class SuccessConditionSameArbitraryState {
  ...
  static getSizePrefixedRootAsSuccessConditionSameArbitraryState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SuccessConditionSameArbitraryState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSuccessConditionSameArbitraryState(t, e) {
    return SuccessConditionSameArbitraryState.startSuccessConditionSameArbitraryState(t), SuccessConditionSameArbitraryState.addType(t, e), SuccessConditionSameArbitraryState.endSuccessConditionSameArbitraryState(t)
  }
}
