...
class GuideLineCreatorComponent {
  ...
  static getSizePrefixedRootAsGuideLineCreatorComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GuideLineCreatorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  colorChangeOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_color_change_strategy_of_spline_effect_js_1.UnionColorChangeStrategyOfSplineEffect.NONE
  }
  colorChangeOption(t) {
  ...
  scanOption(t) {
    ...
    return e ? (t || new guide_line_creator_scan_option_js_1.GuideLineCreatorScanOption).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
