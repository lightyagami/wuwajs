...
class EntityBundleChildInfo {
  ...
  static getSizePrefixedRootAsEntityBundleChildInfo(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityBundleChildInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isDisable() {
  ...
  static createEntityBundleChildInfo(t, i, n, e) {
    return EntityBundleChildInfo.startEntityBundleChildInfo(t), EntityBundleChildInfo.addIsDisable(t, i), EntityBundleChildInfo.addChildId(t, n), EntityBundleChildInfo.addEntityId(t, e), EntityBundleChildInfo.endEntityBundleChildInfo(t)
  }
}
