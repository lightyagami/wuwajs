...
class PasserbyNpcSpawnComponent {
  ...
  static getSizePrefixedRootAsPasserbyNpcSpawnComponent(s, n) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new PasserbyNpcSpawnComponent).__init(s.readInt32(s.position()) + s.position(), s)
  }
  disabled() {
  ...
  moveConfigType() {
    ...
    return s ? this.bb.readUint8(this.bb_pos + s) : union_passerby_npc_move_js_1.UnionPasserbyNpcMove.NONE
  }
  moveConfig(s) {
  ...
  spawnConfigType() {
    ...
    return s ? this.bb.readUint8(this.bb_pos + s) : union_passerby_npc_spawn_js_1.UnionPasserbyNpcSpawn.NONE
  }
  spawnConfig(s) {
  ...
  sourceConfigType() {
    ...
    return s ? this.bb.readUint8(this.bb_pos + s) : union_passerby_npc_source_js_1.UnionPasserbyNpcSource.NONE
  }
  sourceConfig(s) {
  ...
  static createPasserbyNpcSpawnComponent(s, n, e, t, o, p, a, r) {
    return PasserbyNpcSpawnComponent.startPasserbyNpcSpawnComponent(s), PasserbyNpcSpawnComponent.addDisabled(s, n), PasserbyNpcSpawnComponent.addMoveConfigType(s, e), PasserbyNpcSpawnComponent.addMoveConfig(s, t), PasserbyNpcSpawnComponent.addSpawnConfigType(s, o), PasserbyNpcSpawnComponent.addSpawnConfig(s, p), PasserbyNpcSpawnComponent.addSourceConfigType(s, a), PasserbyNpcSpawnComponent.addSourceConfig(s, r), PasserbyNpcSpawnComponent.endPasserbyNpcSpawnComponent(s)
  }
}
