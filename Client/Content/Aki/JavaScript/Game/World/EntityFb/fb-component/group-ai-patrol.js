...
class GroupAiPatrol {
  ...
  static getSizePrefixedRootAsGroupAiPatrol(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new GroupAiPatrol).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createGroupAiPatrol(t, r, i, s) {
    return GroupAiPatrol.startGroupAiPatrol(t), GroupAiPatrol.addType(t, r), GroupAiPatrol.addLeader(t, i), GroupAiPatrol.addSplineEntityId(t, s), GroupAiPatrol.endGroupAiPatrol(t)
  }
}
