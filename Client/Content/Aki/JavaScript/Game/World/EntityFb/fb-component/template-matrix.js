...
class TemplateMatrix {
  ...
  static getSizePrefixedRootAsTemplateMatrix(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TemplateMatrix).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  matrixSize(t) {
    ...
    return e ? (t || new vector2_js_1.Vector2).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  templateMatrix(t, e) {
    var i = this.bb.__offset(this.bb_pos, 8);
    return i ? (e || new template_matrix_row_js_1.TemplateMatrixRow).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  groupDestroyListenConfigs(t, e) {
    ...
    return i ? (e || new group_destroy_listen_config_js_1.GroupDestroyListenConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  onNonGroupEntityDestroy(t, e) {
    ...
    return i ? (e || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
