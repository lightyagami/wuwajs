...
class FailureConditionArbitraryState {
  ...
  static getSizePrefixedRootAsFailureConditionArbitraryState(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FailureConditionArbitraryState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFailureConditionArbitraryState(t, i, r) {
    return FailureConditionArbitraryState.startFailureConditionArbitraryState(t), FailureConditionArbitraryState.addType(t, i), FailureConditionArbitraryState.addState(t, r), FailureConditionArbitraryState.endFailureConditionArbitraryState(t)
  }
}
