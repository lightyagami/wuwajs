...
class RenjuConfig {
  ...
  static getSizePrefixedRootAsRenjuConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RenjuConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  controller(t) {
  ...
  static createRenjuConfig(t, i, s, n, e, r) {
    return RenjuConfig.startRenjuConfig(t), RenjuConfig.addController(t, i), RenjuConfig.addOrder(t, s), RenjuConfig.addRenjuCount(t, n), RenjuConfig.addEntityIds(t, e), RenjuConfig.addActions(t, r), RenjuConfig.endRenjuConfig(t)
  }
}
