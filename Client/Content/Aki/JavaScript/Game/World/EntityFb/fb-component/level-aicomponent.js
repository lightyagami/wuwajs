...
class LevelAIComponent {
  ...
  static getSizePrefixedRootAsLevelAIComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LevelAIComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  states(t, e) {
    ...
    return s ? (e || new level_aistate_js_1.LevelAIState).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  statesLength() {
  ...
  static createLevelAIComponent(t, e, s, i) {
    return LevelAIComponent.startLevelAIComponent(t), LevelAIComponent.addDisabled(t, e), LevelAIComponent.addStates(t, s), LevelAIComponent.addBtTreeAsset(t, i), LevelAIComponent.endLevelAIComponent(t)
  }
}
