...
class DefaultAkEvent {
  ...
  static getSizePrefixedRootAsDefaultAkEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DefaultAkEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDefaultAkEvent(t, e) {
    return DefaultAkEvent.startDefaultAkEvent(t), DefaultAkEvent.addType(t, e), DefaultAkEvent.endDefaultAkEvent(t)
  }
}
