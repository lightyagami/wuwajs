...
class DurationCondition {
  ...
  static getSizePrefixedRootAsDurationCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DurationCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createDurationCondition(t, i, n, o) {
    return DurationCondition.startDurationCondition(t), DurationCondition.addType(t, i), DurationCondition.addDuration(t, n), DurationCondition.addRefill(t, o), DurationCondition.endDurationCondition(t)
  }
}
