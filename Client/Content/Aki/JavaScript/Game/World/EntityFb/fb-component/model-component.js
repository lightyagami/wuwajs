...
class ModelComponent {
  ...
  static getSizePrefixedRootAsModelComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ModelComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  modelTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_model_type_js_1.UnionModelType.NONE
  }
  modelType(t) {
  ...
  static createModelComponent(t, e, o, s, i, r, n) {
    return ModelComponent.startModelComponent(t), ModelComponent.addDisabled(t, e), ModelComponent.addModelTypeType(t, o), ModelComponent.addModelType(t, s), ModelComponent.addHalfHeight(t, i), ModelComponent.addTrackHeight(t, r), ModelComponent.addPerformanceTags(t, n), ModelComponent.endModelComponent(t)
  }
}
