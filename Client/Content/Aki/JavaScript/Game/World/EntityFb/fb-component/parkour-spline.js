...
class ParkourSpline {
  ...
  static getSizePrefixedRootAsParkourSpline(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ParkourSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, r) {
    ...
    return i ? (r || new parkour_spline_point_js_1.ParkourSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createParkourSpline(t, r, i, e, s, o, a, n, u) {
    return ParkourSpline.startParkourSpline(t), ParkourSpline.addType(t, r), ParkourSpline.addIsRequireToEnd(t, i), ParkourSpline.addCheckPointsRequire(t, e), ParkourSpline.addCheckPointResource(t, s), ParkourSpline.addCheckPointsDestroyRes(t, o), ParkourSpline.addStartResource(t, a), ParkourSpline.addEndResource(t, n), ParkourSpline.addPoints(t, u), ParkourSpline.endParkourSpline(t)
  }
}
