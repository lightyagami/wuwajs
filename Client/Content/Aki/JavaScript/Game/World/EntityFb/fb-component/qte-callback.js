...
class QteCallback {
  ...
  static getSizePrefixedRootAsQteCallback(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new QteCallback).__init(t.readInt32(t.position()) + t.position(), t)
  }
  actions(t, e) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (e || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createQteCallback(t, e, a) {
    return QteCallback.startQteCallback(t), QteCallback.addActions(t, e), QteCallback.addSendSelfEvent(t, a), QteCallback.endQteCallback(t)
  }
}
