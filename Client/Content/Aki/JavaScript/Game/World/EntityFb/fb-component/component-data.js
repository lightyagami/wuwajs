...
class ComponentData {
  ...
  static getSizePrefixedRootAsComponentData(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ComponentData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  components(t, e) {
    var n = this.bb.__offset(this.bb_pos, 4);
    return n ? (e || new component_item_js_1.ComponentItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  componentsLength() {
  ...
  static createComponentData(t, e) {
    return ComponentData.startComponentData(t), ComponentData.addComponents(t, e), ComponentData.endComponentData(t)
  }
}
