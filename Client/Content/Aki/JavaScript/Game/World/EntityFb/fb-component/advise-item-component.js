...
class AdviseItemComponent {
  ...
  static getSizePrefixedRootAsAdviseItemComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AdviseItemComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createAdviseItemComponent(t, e) {
    return AdviseItemComponent.startAdviseItemComponent(t), AdviseItemComponent.addDisabled(t, e), AdviseItemComponent.endAdviseItemComponent(t)
  }
}
