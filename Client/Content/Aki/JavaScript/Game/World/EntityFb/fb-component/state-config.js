...
class StateConfig {
  ...
  static getSizePrefixedRootAsStateConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new StateConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  static createStateConfig(t, e, i) {
    return StateConfig.startStateConfig(t), StateConfig.addState(t, e), StateConfig.addDuration(t, i), StateConfig.endStateConfig(t)
  }
}
