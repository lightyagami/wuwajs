...
class PickInteractComponent {
  ...
  static getSizePrefixedRootAsPickInteractComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PickInteractComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  pickInteractTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_pick_interaction_js_1.UnionPickInteraction.NONE
  }
  pickInteractType(t) {
  ...
  static createPickInteractComponent(t, e, n, i) {
    return PickInteractComponent.startPickInteractComponent(t), PickInteractComponent.addDisabled(t, e), PickInteractComponent.addPickInteractTypeType(t, n), PickInteractComponent.addPickInteractType(t, i), PickInteractComponent.endPickInteractComponent(t)
  }
}
