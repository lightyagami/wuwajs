...
class PointGroup {
  ...
  static getSizePrefixedRootAsPointGroup(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PointGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  groupConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_point_group_js_1.UnionPointGroup.NONE
  }
  groupConfig(t) {
  ...
  points(t, i) {
    ...
    return o ? (i || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createPointGroup(t, i, o, r) {
    return PointGroup.startPointGroup(t), PointGroup.addGroupConfigType(t, i), PointGroup.addGroupConfig(t, o), PointGroup.addPoints(t, r), PointGroup.endPointGroup(t)
  }
}
