...
class TargetGearComponent {
  ...
  static getSizePrefixedRootAsTargetGearComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TargetGearComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  cycleStates(t, i) {
    ...
    return e ? this.bb.__string(this.bb.__vector(this.bb_pos + e) + 4 * t, i) : void 0
  }
  cycleStatesLength() {
  ...
  hitLogicTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_hit_logic_type_js_1.UnionHitLogicType.NONE
  }
  hitLogicType(t) {
  ...
  patrol(t) {
    ...
    return i ? (t || new spline_move_js_1.SplineMove).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  hitCd() {
