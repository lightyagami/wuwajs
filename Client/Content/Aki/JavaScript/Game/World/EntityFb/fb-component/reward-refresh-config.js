...
class RewardRefreshConfig {
  ...
  static getSizePrefixedRootAsRewardRefreshConfig(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new RewardRefreshConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  refreshTypeType() {
  ...
  static createRewardRefreshConfig(e, r, s, t) {
    return RewardRefreshConfig.startRewardRefreshConfig(e), RewardRefreshConfig.addRefreshTypeType(e, r), RewardRefreshConfig.addRefreshType(e, s), RewardRefreshConfig.addMaxCount(e, t), RewardRefreshConfig.endRewardRefreshConfig(e)
  }
}
