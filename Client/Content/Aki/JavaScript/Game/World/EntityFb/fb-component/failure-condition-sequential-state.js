...
class FailureConditionSequentialState {
  ...
  static getSizePrefixedRootAsFailureConditionSequentialState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FailureConditionSequentialState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createFailureConditionSequentialState(t, e, i) {
    return FailureConditionSequentialState.startFailureConditionSequentialState(t), FailureConditionSequentialState.addType(t, e), FailureConditionSequentialState.addOrder(t, i), FailureConditionSequentialState.endFailureConditionSequentialState(t)
  }
}
