...
class ExploreSkillRagDollCrushingRock {
  ...
  static getSizePrefixedRootAsExploreSkillRagDollCrushingRock(l, r) {
    return l.setPosition(l.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ExploreSkillRagDollCrushingRock).__init(l.readInt32(l.position()) + l.position(), l)
  }
  type(l) {
  ...
  static createExploreSkillRagDollCrushingRock(l, r) {
    return ExploreSkillRagDollCrushingRock.startExploreSkillRagDollCrushingRock(l), ExploreSkillRagDollCrushingRock.addType(l, r), ExploreSkillRagDollCrushingRock.endExploreSkillRagDollCrushingRock(l)
  }
}
