...
class NpcRideInAutoGongduolaPerform {
  ...
  static getSizePrefixedRootAsNpcRideInAutoGongduolaPerform(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new NpcRideInAutoGongduolaPerform).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createNpcRideInAutoGongduolaPerform(t, o, e) {
    return NpcRideInAutoGongduolaPerform.startNpcRideInAutoGongduolaPerform(t), NpcRideInAutoGongduolaPerform.addType(t, o), NpcRideInAutoGongduolaPerform.addMontage(t, e), NpcRideInAutoGongduolaPerform.endNpcRideInAutoGongduolaPerform(t)
  }
}
