...
class NearbyTrackingComponent {
  ...
  static getSizePrefixedRootAsNearbyTrackingComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new NearbyTrackingComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  trackingTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_nearby_tracking_js_1.UnionNearbyTracking.NONE
  }
  trackingType(t) {
  ...
  static createNearbyTrackingComponent(t, n, e, i, r, a, s) {
    return NearbyTrackingComponent.startNearbyTrackingComponent(t), NearbyTrackingComponent.addDisabled(t, n), NearbyTrackingComponent.addIsEnable(t, e), NearbyTrackingComponent.addIsEnableWhileUnlock(t, i), NearbyTrackingComponent.addIsEnbaleWhileHoming(t, r), NearbyTrackingComponent.addTrackingTypeType(t, a), NearbyTrackingComponent.addTrackingType(t, s), NearbyTrackingComponent.endNearbyTrackingComponent(t)
  }
}
