...
class ActorAttachTarget {
  ...
  static getRootAsActorAttachTarget(t, r) {
    return (r || new ActorAttachTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsActorAttachTarget(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ActorAttachTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  actorRef(t) {
    ...
    return r ? (t || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
