...
class ExploreSkillInteractComponent {
  ...
  static getSizePrefixedRootAsExploreSkillInteractComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ExploreSkillInteractComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  optionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_explore_skill_interact_option_js_1.UnionExploreSkillInteractOption.NONE
  }
  option(t) {
  ...
  searchTargetCfgType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_explore_skill_search_target_cfg_js_1.UnionExploreSkillSearchTargetCfg.NONE
  }
  searchTargetCfg(t) {
  ...
  ignoresCollisionCfg(t) {
    ...
    return i ? (t || new ignores_collision_cfg_js_1.IgnoresCollisionCfg).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
