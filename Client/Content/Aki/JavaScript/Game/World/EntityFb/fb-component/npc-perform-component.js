...
exports.NpcPerformComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const npc_awake_show_js_1 = require("../fb-component/npc-awake-show.js");
const npc_bump_show_js_1 = require("../fb-component/npc-bump-show.js");
const npc_death_interact_js_1 = require("../fb-component/npc-death-interact.js");
const npc_hit_show_js_1 = require("../fb-component/npc-hit-show.js");
const npc_perform_on_interact_js_1 = require("../fb-component/npc-perform-on-interact.js");
const npc_perform_on_monster_closeby_js_1 = require("../fb-component/npc-perform-on-monster-closeby.js");
const npc_perform_state_js_1 = require("../fb-component/npc-perform-state.js");
const union_npc_standby_show_option_js_1 = require("../fb-component/union-npc-standby-show-option.js");
const union_npc_ui_interact_option_js_1 = require("../fb-component/union-npc-ui-interact-option.js");
const union_special_npc_perform_type_js_1 = require("../fb-component/union-special-npc-perform-type.js");
class NpcPerformComponent {
  ...
  static getRootAsNpcPerformComponent(t, i) {
    return (i || new NpcPerformComponent()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  ...
  specialNpcPerformConfigType() {
    ...
    if (t) {
      ...
      return union_special_npc_perform_type_js_1.UnionSpecialNpcPerformType.NONE;
    }
  }
  ...
  npcHitShow(t) {
    ...
    if (i) {
      return (t || new npc_hit_show_js_1.NpcHitShow()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  npcBumpShow(t) {
    ...
    if (i) {
      return (t || new npc_bump_show_js_1.NpcBumpShow()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  showOnAwake(t) {
    ...
    if (i) {
      return (t || new npc_awake_show_js_1.NpcAwakeShow()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  showOnStandbyType() {
    ...
    if (t) {
      ...
      return union_npc_standby_show_option_js_1.UnionNpcStandbyShowOption.NONE;
    }
  }
  showOnStandby(t) {
  ...
  showOnInteract(t) {
    ...
    if (i) {
      return (t || new npc_perform_on_interact_js_1.NpcPerformOnInteract()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  showOnUiInteractType() {
    ...
    if (t) {
      ...
      return union_npc_ui_interact_option_js_1.UnionNpcUiInteractOption.NONE;
    }
  }
  showOnUiInteract(t) {
  ...
  npcMonsterClosePerform(t) {
    ...
    if (i) {
      return (t || new npc_perform_on_monster_closeby_js_1.NpcPerformOnMonsterCloseby()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  npcPerformState(t) {
    ...
    if (i) {
      return (t || new npc_perform_state_js_1.NpcPerformState()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  deathInteract(t) {
    ...
    if (i) {
      return (t || new npc_death_interact_js_1.NpcDeathInteract()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static addSpecialNpcPerformConfigType(t, i) {
    t.addFieldInt8(1, i, union_special_npc_perform_type_js_1.UnionSpecialNpcPerformType.NONE);
  }
  ...
  static addShowOnAwake(t, i) {
    t.addFieldOffset(7, i, 0);
  }
  static addShowOnStandbyType(t, i) {
    t.addFieldInt8(8, i, union_npc_standby_show_option_js_1.UnionNpcStandbyShowOption.NONE);
  }
  ...
  static addShowOnUiInteractType(t, i) {
    t.addFieldInt8(11, i, union_npc_ui_interact_option_js_1.UnionNpcUiInteractOption.NONE);
  }
