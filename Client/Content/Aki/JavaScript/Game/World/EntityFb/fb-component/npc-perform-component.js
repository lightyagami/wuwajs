...
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers"),
  npc_awake_show_js_1 = require("../fb-component/npc-awake-show.js"),
...
class NpcPerformComponent {
  ...
  static getSizePrefixedRootAsNpcPerformComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcPerformComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  specialNpcPerformConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_special_npc_perform_type_js_1.UnionSpecialNpcPerformType.NONE
  }
  ...
  npcHitShow(t) {
    ...
    return i ? (t || new npc_hit_show_js_1.NpcHitShow).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  isShowStrike() {
  ...
  npcBumpShow(t) {
    ...
    return i ? (t || new npc_bump_show_js_1.NpcBumpShow).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  showOnAwake(t) {
    var i = this.bb.__offset(this.bb_pos, 18);
    return i ? (t || new npc_awake_show_js_1.NpcAwakeShow).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  showOnStandbyType() {
    var t = this.bb.__offset(this.bb_pos, 20);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_npc_standby_show_option_js_1.UnionNpcStandbyShowOption.NONE
  }
  showOnStandby(t) {
  ...
  showOnInteract(t) {
    ...
    return i ? (t || new npc_perform_on_interact_js_1.NpcPerformOnInteract).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  showOnUiInteractType() {
    var t = this.bb.__offset(this.bb_pos, 26);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_npc_ui_interact_option_js_1.UnionNpcUiInteractOption.NONE
  }
  showOnUiInteract(t) {
  ...
  showOnRideInVehicleTypeArray() {
    var t = this.bb.__offset(this.bb_pos, 30);
    return t ? new Uint8Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + t), this.bb.__vector_len(this.bb_pos + t)) : void 0
  }
  showOnRideInVehicle(t, i) {
    var e = this.bb.__offset(this.bb_pos, 32);
    return e ? this.bb.__union(i, this.bb.__vector(this.bb_pos + e) + 4 * t) : void 0
  }
  ...
  npcMonsterClosePerform(t) {
    ...
    return i ? (t || new npc_perform_on_monster_closeby_js_1.NpcPerformOnMonsterCloseby).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  npcPerformState(t) {
    var i = this.bb.__offset(this.bb_pos, 36);
    return i ? (t || new npc_perform_state_js_1.NpcPerformState).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  deathInteract(t) {
    var i = this.bb.__offset(this.bb_pos, 38);
    return i ? (t || new npc_death_interact_js_1.NpcDeathInteract).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  fixedPosition() {
