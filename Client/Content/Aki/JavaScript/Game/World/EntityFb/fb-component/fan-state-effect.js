...
class FanStateEffect {
  ...
  static getSizePrefixedRootAsFanStateEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FanStateEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityState(t) {
  ...
  effectConfig(t) {
    ...
    return e ? (t || new fan_effect_config_js_1.FanEffectConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
