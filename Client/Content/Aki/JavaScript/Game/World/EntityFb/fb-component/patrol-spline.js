...
class PatrolSpline {
  ...
  static getSizePrefixedRootAsPatrolSpline(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PatrolSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  cycleOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_patrol_cycle_option_js_1.UnionPatrolCycleOption.NONE
  }
  cycleOption(t) {
  ...
  points(t, i) {
    ...
    return s ? (i || new patrol_spline_point_js_1.PatrolSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  patrolRange(t) {
    ...
    return i ? (t || new patrol_range_js_1.PatrolRange).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
