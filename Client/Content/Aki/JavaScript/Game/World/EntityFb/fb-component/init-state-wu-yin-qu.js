...
class InitStateWuYinQu {
  ...
  static getSizePrefixedRootAsInitStateWuYinQu(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InitStateWuYinQu).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createInitStateWuYinQu(t, i) {
    return InitStateWuYinQu.startInitStateWuYinQu(t), InitStateWuYinQu.addType(t, i), InitStateWuYinQu.endInitStateWuYinQu(t)
  }
}
