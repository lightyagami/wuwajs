...
class EffectSplineEquidistantPointMode {
  ...
  static getSizePrefixedRootAsEffectSplineEquidistantPointMode(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EffectSplineEquidistantPointMode).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEffectSplineEquidistantPointMode(t, i, e) {
    return EffectSplineEquidistantPointMode.startEffectSplineEquidistantPointMode(t), EffectSplineEquidistantPointMode.addType(t, i), EffectSplineEquidistantPointMode.addSpace(t, e), EffectSplineEquidistantPointMode.endEffectSplineEquidistantPointMode(t)
  }
}
