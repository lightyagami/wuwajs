...
class BuffArea {
  ...
  static getSizePrefixedRootAsBuffArea(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BuffArea).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  buffConfigs(t, e) {
    ...
    return f ? (e || new buff_area_state_config_js_1.BuffAreaStateConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + f) + 4 * t), this.bb) : void 0
  }
  buffConfigsLength() {
  ...
  static createBuffArea(t, e, f) {
    return BuffArea.startBuffArea(t), BuffArea.addType(t, e), BuffArea.addBuffConfigs(t, f), BuffArea.endBuffArea(t)
  }
}
