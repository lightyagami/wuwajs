...
class PrefabStateConfig {
  ...
  static getSizePrefixedRootAsPrefabStateConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PrefabStateConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  levelTag() {
  ...
  static createPrefabStateConfig(t, e, a) {
    return PrefabStateConfig.startPrefabStateConfig(t), PrefabStateConfig.addLevelTag(t, e), PrefabStateConfig.addSceneInteractionState(t, a), PrefabStateConfig.endPrefabStateConfig(t)
  }
}
