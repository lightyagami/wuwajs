...
class FollowTrackComponent {
  ...
  static getSizePrefixedRootAsFollowTrackComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new FollowTrackComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  endTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_follow_track_end_option_js_1.UnionFollowTrackEndOption.NONE
  }
  endType(t) {
  ...
  static createFollowTrackComponent(t, o, n, e, r, i) {
    return FollowTrackComponent.startFollowTrackComponent(t), FollowTrackComponent.addDisabled(t, o), FollowTrackComponent.addRange(t, n), FollowTrackComponent.addSplineEntityId(t, e), FollowTrackComponent.addEndTypeType(t, r), FollowTrackComponent.addEndType(t, i), FollowTrackComponent.endFollowTrackComponent(t)
  }
}
