...
class CollectAnimalConfig {
  ...
  static getSizePrefixedRootAsCollectAnimalConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CollectAnimalConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  partsMap(t, i) {
    ...
    return e ? (i || new collect_animal_parts_config_js_1.CollectAnimalPartsConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  partsMapLength() {
  ...
  static createCollectAnimalConfig(t, i, e) {
    return CollectAnimalConfig.startCollectAnimalConfig(t), CollectAnimalConfig.addType(t, i), CollectAnimalConfig.addPartsMap(t, e), CollectAnimalConfig.endCollectAnimalConfig(t)
  }
}
