...
class BuffConsumerComponent {
  ...
  static getRootAsBuffConsumerComponent(t, e) {
    return (e || new BuffConsumerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsBuffConsumerComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BuffConsumerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createBuffConsumerComponent(t, e, n, s, o) {
    return BuffConsumerComponent.startBuffConsumerComponent(t), BuffConsumerComponent.addDisabled(t, e), BuffConsumerComponent.addBuffId(t, n), BuffConsumerComponent.addBulletId(t, s), BuffConsumerComponent.addProducerEntityId(t, o), BuffConsumerComponent.endBuffConsumerComponent(t)
  }
}
