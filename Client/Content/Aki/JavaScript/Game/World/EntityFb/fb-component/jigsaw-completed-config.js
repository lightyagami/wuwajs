...
class JigsawCompletedConfig {
  ...
  static getRootAsJigsawCompletedConfig(t, e) {
    return (e || new JigsawCompletedConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsJigsawCompletedConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new JigsawCompletedConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isSilentPiece() {
  ...
  static createJigsawCompletedConfig(t, e, i) {
    return JigsawCompletedConfig.startJigsawCompletedConfig(t), JigsawCompletedConfig.addIsSilentPiece(t, e), JigsawCompletedConfig.addIsSilentFoundation(t, i), JigsawCompletedConfig.endJigsawCompletedConfig(t)
  }
}
