...
class NpcPerformState {
  ...
  static getSizePrefixedRootAsNpcPerformState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcPerformState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  initState(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new init_npc_perform_state_js_1.InitNpcPerformState).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  configs(t, e) {
    var r = this.bb.__offset(this.bb_pos, 6);
    return r ? (e || new npc_perform_state_config_js_1.NpcPerformStateConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  configsLength() {
  ...
  static createNpcPerformState(t, e, r) {
    return NpcPerformState.startNpcPerformState(t), NpcPerformState.addInitState(t, e), NpcPerformState.addConfigs(t, r), NpcPerformState.endNpcPerformState(t)
  }
}
