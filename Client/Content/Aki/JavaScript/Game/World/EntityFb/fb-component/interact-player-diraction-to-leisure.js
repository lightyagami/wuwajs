...
class InteractPlayerDiractionToLeisure {
  ...
  static getSizePrefixedRootAsInteractPlayerDiractionToLeisure(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new InteractPlayerDiractionToLeisure).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createInteractPlayerDiractionToLeisure(t, e, r, i) {
    return InteractPlayerDiractionToLeisure.startInteractPlayerDiractionToLeisure(t), InteractPlayerDiractionToLeisure.addType(t, e), InteractPlayerDiractionToLeisure.addBegin(t, r), InteractPlayerDiractionToLeisure.addEnd(t, i), InteractPlayerDiractionToLeisure.endInteractPlayerDiractionToLeisure(t)
  }
}
