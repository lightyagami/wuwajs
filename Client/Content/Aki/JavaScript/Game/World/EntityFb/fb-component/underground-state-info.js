...
class UndergroundStateInfo {
  ...
  static getRootAsUndergroundStateInfo(t, e) {
    return (e || new UndergroundStateInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsUndergroundStateInfo(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UndergroundStateInfo).__init(t.readInt32(t.position()) + t.position(), t)
  }
  stateId() {
