...
class CustomAoizRadius {
  ...
  static getSizePrefixedRootAsCustomAoizRadius(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CustomAoizRadius).__init(t.readInt32(t.position()) + t.position(), t)
  }
  up() {
  ...
  static createCustomAoizRadius(t, s, i) {
    return CustomAoizRadius.startCustomAoizRadius(t), CustomAoizRadius.addUp(t, s), CustomAoizRadius.addDown(t, i), CustomAoizRadius.endCustomAoizRadius(t)
  }
}
