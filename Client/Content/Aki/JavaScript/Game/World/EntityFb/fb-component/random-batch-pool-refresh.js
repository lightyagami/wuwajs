...
class RandomBatchPoolRefresh {
  ...
  static getRootAsRandomBatchPoolRefresh(t, e) {
    return (e || new RandomBatchPoolRefresh).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsRandomBatchPoolRefresh(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RandomBatchPoolRefresh).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  entityBatches(t, e) {
    ...
    return s ? this.bb.__union(e, this.bb.__vector(this.bb_pos + s) + 4 * t) : void 0
  }
  entityBatchesLength() {
  ...
  static createRandomBatchPoolRefresh(t, e, s, h, a) {
    return RandomBatchPoolRefresh.startRandomBatchPoolRefresh(t), RandomBatchPoolRefresh.addType(t, e), RandomBatchPoolRefresh.addEntityBatchesType(t, s), RandomBatchPoolRefresh.addEntityBatches(t, h), RandomBatchPoolRefresh.addIsRestartAfterAllBatchesFinished(t, a), RandomBatchPoolRefresh.endRandomBatchPoolRefresh(t)
  }
}
