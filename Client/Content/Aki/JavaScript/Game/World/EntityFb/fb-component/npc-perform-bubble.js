...
class NpcPerformBubble {
  ...
  static getSizePrefixedRootAsNpcPerformBubble(e, r) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new NpcPerformBubble).__init(e.readInt32(e.position()) + e.position(), e)
  }
  bubble(e) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (e || new bubble_index_js_1.BubbleIndex).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
  rate() {
  ...
  static createNpcPerformBubble(e, r, t) {
    return NpcPerformBubble.startNpcPerformBubble(e), NpcPerformBubble.addBubble(e, r), NpcPerformBubble.addRate(e, t), NpcPerformBubble.endNpcPerformBubble(e)
  }
}
