...
class RangeAdsorptionFoundation {
  ...
  static getSizePrefixedRootAsRangeAdsorptionFoundation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RangeAdsorptionFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  condition(t) {
    ...
    return i ? (t || new category_matching_condition_js_1.CategoryMatchingCondition).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  animation(t) {
    var i = this.bb.__offset(this.bb_pos, 8);
    return i ? (t || new adsorption_matching_animation_js_1.AdsorptionMatchingAnimation).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  categoryAnimation(t) {
    var i = this.bb.__offset(this.bb_pos, 10);
    return i ? (t || new category_matching_animation_js_1.CategoryMatchingAnimation).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  callback(t) {
    var i = this.bb.__offset(this.bb_pos, 12);
    return i ? (t || new category_matching_succeed_js_1.CategoryMatchingSucceed).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
