...
class LifePointCenterComponent {
  ...
  static getSizePrefixedRootAsLifePointCenterComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LifePointCenterComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createLifePointCenterComponent(t, e) {
    return LifePointCenterComponent.startLifePointCenterComponent(t), LifePointCenterComponent.addDisabled(t, e), LifePointCenterComponent.endLifePointCenterComponent(t)
  }
}
