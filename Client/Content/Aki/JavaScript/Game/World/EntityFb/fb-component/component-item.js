...
class ComponentItem {
  ...
  static getSizePrefixedRootAsComponentItem(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ComponentItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  name(t) {
  ...
  componentType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_component_js_1.UnionComponent.NONE
  }
  component(t) {
  ...
  static createComponentItem(t, e, n, o, s) {
    return ComponentItem.startComponentItem(t), ComponentItem.addName(t, e), ComponentItem.addIsNull(t, n), ComponentItem.addComponentType(t, o), ComponentItem.addComponent(t, s), ComponentItem.endComponentItem(t)
  }
}
