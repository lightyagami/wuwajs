...
class CdRefreshRule {
  ...
  static getSizePrefixedRootAsCdRefreshRule(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new CdRefreshRule).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createCdRefreshRule(e, t, s) {
    return CdRefreshRule.startCdRefreshRule(e), CdRefreshRule.addType(e, t), CdRefreshRule.addCd(e, s), CdRefreshRule.endCdRefreshRule(e)
  }
}
