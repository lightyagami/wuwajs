...
class PasserbyNpcSplineMove {
  ...
  static getSizePrefixedRootAsPasserbyNpcSplineMove(e, s) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PasserbyNpcSplineMove).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  routes(e, s) {
    ...
    return t ? (s || new passerby_npc_spline_js_1.PasserbyNpcSpline).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + t) + 4 * e), this.bb) : void 0
  }
  routesLength() {
  ...
  static createPasserbyNpcSplineMove(e, s, t) {
    return PasserbyNpcSplineMove.startPasserbyNpcSplineMove(e), PasserbyNpcSplineMove.addType(e, s), PasserbyNpcSplineMove.addRoutes(e, t), PasserbyNpcSplineMove.endPasserbyNpcSplineMove(e)
  }
}
