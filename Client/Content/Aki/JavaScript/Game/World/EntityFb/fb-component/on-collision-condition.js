...
class OnCollisionCondition {
  ...
  static getSizePrefixedRootAsOnCollisionCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new OnCollisionCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  triggerCount(t) {
    ...
    return i ? (t || new trigger_count_config_js_1.TriggerCountConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
