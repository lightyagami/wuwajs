...
class SpawnMonsterPreDependOnPreceding {
  ...
  static getSizePrefixedRootAsSpawnMonsterPreDependOnPreceding(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SpawnMonsterPreDependOnPreceding).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createSpawnMonsterPreDependOnPreceding(e, t, r) {
    return SpawnMonsterPreDependOnPreceding.startSpawnMonsterPreDependOnPreceding(e), SpawnMonsterPreDependOnPreceding.addType(e, t), SpawnMonsterPreDependOnPreceding.addIds(e, r), SpawnMonsterPreDependOnPreceding.endSpawnMonsterPreDependOnPreceding(e)
  }
}
