...
class ActivateAllCorrectPiece {
  ...
  static getSizePrefixedRootAsActivateAllCorrectPiece(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ActivateAllCorrectPiece).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createActivateAllCorrectPiece(t, e) {
    return ActivateAllCorrectPiece.startActivateAllCorrectPiece(t), ActivateAllCorrectPiece.addType(t, e), ActivateAllCorrectPiece.endActivateAllCorrectPiece(t)
  }
}
