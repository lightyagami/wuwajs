...
class LevelPlayComponent {
  ...
  static getSizePrefixedRootAsLevelPlayComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new LevelPlayComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  static createLevelPlayComponent(e, t, l) {
    return LevelPlayComponent.startLevelPlayComponent(e), LevelPlayComponent.addDisabled(e, t), LevelPlayComponent.addLevelPlayId(e, l), LevelPlayComponent.endLevelPlayComponent(e)
  }
}
