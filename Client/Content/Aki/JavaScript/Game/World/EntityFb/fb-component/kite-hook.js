...
class KiteHook {
  ...
  static getRootAsKiteHook(t, i) {
    return (i || new KiteHook).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsKiteHook(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new KiteHook).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createKiteHook(t, i, o, s, e) {
    return KiteHook.startKiteHook(t), KiteHook.addType(t, i), KiteHook.addHookActions(t, o), KiteHook.addExitHookActions(t, s), KiteHook.addFinishActions(t, e), KiteHook.endKiteHook(t)
  }
}
