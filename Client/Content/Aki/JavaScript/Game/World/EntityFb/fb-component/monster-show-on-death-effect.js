...
class MonsterShowOnDeathEffect {
  ...
  static getSizePrefixedRootAsMonsterShowOnDeathEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new MonsterShowOnDeathEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createMonsterShowOnDeathEffect(t, e, s) {
    return MonsterShowOnDeathEffect.startMonsterShowOnDeathEffect(t), MonsterShowOnDeathEffect.addType(t, e), MonsterShowOnDeathEffect.addEffectId(t, s), MonsterShowOnDeathEffect.endMonsterShowOnDeathEffect(t)
  }
}
