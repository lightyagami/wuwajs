...
class PointGroupByLayer {
  ...
  static getSizePrefixedRootAsPointGroupByLayer(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new PointGroupByLayer).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  layers(t, r) {
    ...
    return e ? (r || new parkour_point_layer_config_js_1.ParkourPointLayerConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  layersLength() {
