...
class NoRenderPortalComponent {
  ...
  static getSizePrefixedRootAsNoRenderPortalComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new NoRenderPortalComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_no_render_portal_config_js_1.UnionNoRenderPortalConfig.NONE
  }
  config(t) {
  ...
  static createNoRenderPortalComponent(t, o, e, n) {
    return NoRenderPortalComponent.startNoRenderPortalComponent(t), NoRenderPortalComponent.addDisabled(t, o), NoRenderPortalComponent.addConfigType(t, e), NoRenderPortalComponent.addConfig(t, n), NoRenderPortalComponent.endNoRenderPortalComponent(t)
  }
}
