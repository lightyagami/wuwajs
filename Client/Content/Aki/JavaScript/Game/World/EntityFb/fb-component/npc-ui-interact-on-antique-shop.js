...
class NpcUiInteractOnAntiqueShop {
  ...
  static getRootAsNpcUiInteractOnAntiqueShop(t, i) {
    return (i || new NpcUiInteractOnAntiqueShop).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsNpcUiInteractOnAntiqueShop(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcUiInteractOnAntiqueShop).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  exitMontageType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_montage_config_js_1.UnionMontageConfig.NONE
  }
  exitMontage(t) {
