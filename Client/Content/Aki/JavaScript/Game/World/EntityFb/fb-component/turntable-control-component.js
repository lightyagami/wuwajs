...
class TurntableControlComponent {
  ...
  static getSizePrefixedRootAsTurntableControlComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new TurntableControlComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_turntable_controller_js_1.UnionTurntableController.NONE
  }
  config(t) {
  ...
  static createTurntableControlComponent(t, n, o, e) {
    return TurntableControlComponent.startTurntableControlComponent(t), TurntableControlComponent.addDisabled(t, n), TurntableControlComponent.addConfigType(t, o), TurntableControlComponent.addConfig(t, e), TurntableControlComponent.endTurntableControlComponent(t)
  }
}
