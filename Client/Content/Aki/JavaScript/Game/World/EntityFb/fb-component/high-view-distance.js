...
class HighViewDistance {
  ...
  static getSizePrefixedRootAsHighViewDistance(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new HighViewDistance).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createHighViewDistance(i, t) {
    return HighViewDistance.startHighViewDistance(i), HighViewDistance.addType(i, t), HighViewDistance.endHighViewDistance(i)
  }
}
