...
class RagDollJumpingPoint {
  ...
  static getSizePrefixedRootAsRagDollJumpingPoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RagDollJumpingPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRagDollJumpingPoint(t, i, o, s, n) {
    return RagDollJumpingPoint.startRagDollJumpingPoint(t), RagDollJumpingPoint.addType(t, i), RagDollJumpingPoint.addHookActions(t, o), RagDollJumpingPoint.addExitHookActions(t, s), RagDollJumpingPoint.addFinishActions(t, n), RagDollJumpingPoint.endRagDollJumpingPoint(t)
  }
}
