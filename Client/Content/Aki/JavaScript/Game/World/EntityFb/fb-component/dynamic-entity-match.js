...
class DynamicEntityMatch {
  ...
  static getSizePrefixedRootAsDynamicEntityMatch(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DynamicEntityMatch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  category(t) {
  ...
  state(t) {
    ...
    return i ? (t || new entity_state_js_1.EntityState).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  hasProperty(t, i) {
