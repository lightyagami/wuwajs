...
class EntityCustomAudioComponent {
  ...
  static getSizePrefixedRootAsEntityCustomAudioComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new EntityCustomAudioComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  akEventTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_ak_event_type_js_1.UnionAkEventType.NONE
  }
  akEventType(t) {
  ...
  audioControlTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_audio_control_type_js_1.UnionAudioControlType.NONE
  }
  audioControlType(t) {
  ...
  static createEntityCustomAudioComponent(t, o, i, n, e, s, u) {
    return EntityCustomAudioComponent.startEntityCustomAudioComponent(t), EntityCustomAudioComponent.addDisabled(t, o), EntityCustomAudioComponent.addAkEventTypeType(t, i), EntityCustomAudioComponent.addAkEventType(t, n), EntityCustomAudioComponent.addAudioRangeType(t, e), EntityCustomAudioComponent.addAudioControlTypeType(t, s), EntityCustomAudioComponent.addAudioControlType(t, u), EntityCustomAudioComponent.endEntityCustomAudioComponent(t)
  }
}
