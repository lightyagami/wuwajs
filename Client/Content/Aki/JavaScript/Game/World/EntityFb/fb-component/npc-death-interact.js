...
class NpcDeathInteract {
  ...
  static getSizePrefixedRootAsNpcDeathInteract(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcDeathInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  montage(t) {
  ...
  static createNpcDeathInteract(t, e, a) {
    return NpcDeathInteract.startNpcDeathInteract(t), NpcDeathInteract.addMontage(t, e), NpcDeathInteract.addMaterialDa(t, a), NpcDeathInteract.endNpcDeathInteract(t)
  }
}
