...
class TimedStrikeDevice {
  ...
  static getRootAsTimedStrikeDevice(e, t) {
    return (t || new TimedStrikeDevice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsTimedStrikeDevice(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TimedStrikeDevice).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createTimedStrikeDevice(e, t, i, r, s, a, c, d, h, u, n, v) {
    return TimedStrikeDevice.startTimedStrikeDevice(e), TimedStrikeDevice.addType(e, t), TimedStrikeDevice.addMaxValue(e, i), TimedStrikeDevice.addInitValue(e, r), TimedStrikeDevice.addProgressPerformanceAttribute(e, s), TimedStrikeDevice.addAddValue(e, a), TimedStrikeDevice.addTimeout(e, c), TimedStrikeDevice.addFallbackValue(e, d), TimedStrikeDevice.addFallbackInterval(e, h), TimedStrikeDevice.addZeroValuePerformanceAttribute(e, u), TimedStrikeDevice.addAscendPerformanceAttribute(e, n), TimedStrikeDevice.addDescendPerformanceAttribute(e, v), TimedStrikeDevice.endTimedStrikeDevice(e)
  }
}
