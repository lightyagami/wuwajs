...
class ContinuesVariableSpeedMovementSpline {
  ...
  static getSizePrefixedRootAsContinuesVariableSpeedMovementSpline(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ContinuesVariableSpeedMovementSpline).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  entireTimePathConfig(e) {
    ...
    return t ? (e || new time_path_config_js_1.TimePathConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  circleMode() {
  ...
  points(e, t) {
    ...
    return i ? (t || new continues_variable_speed_spline_point_js_1.ContinuesVariableSpeedSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  pointsLength() {
