...
class ItemChangeAdsorbateState {
  ...
  static getSizePrefixedRootAsItemChangeAdsorbateState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ItemChangeAdsorbateState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createItemChangeAdsorbateState(t) {
    return ItemChangeAdsorbateState.startItemChangeAdsorbateState(t), ItemChangeAdsorbateState.endItemChangeAdsorbateState(t)
  }
}
