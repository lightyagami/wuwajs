...
class RefreshGroupComponent {
  ...
  static getSizePrefixedRootAsRefreshGroupComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RefreshGroupComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  refreshContentType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_refresh_content_js_1.UnionRefreshContent.NONE
  }
  refreshContent(t) {
  ...
  refreshRuleType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_refresh_rule_js_1.UnionRefreshRule.NONE
  }
  refreshRule(t) {
  ...
  stateChangeConfig(t) {
    ...
    return e ? (t || new state_change_config_js_1.StateChangeConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
