...
class CharacterConnectorComponent {
  ...
  static getSizePrefixedRootAsCharacterConnectorComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CharacterConnectorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  logicTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_character_connector_logic_js_1.UnionCharacterConnectorLogic.NONE
  }
  logicType(t) {
  ...
  static createCharacterConnectorComponent(t, e, o, r) {
    return CharacterConnectorComponent.startCharacterConnectorComponent(t), CharacterConnectorComponent.addDisabled(t, e), CharacterConnectorComponent.addLogicTypeType(t, o), CharacterConnectorComponent.addLogicType(t, r), CharacterConnectorComponent.endCharacterConnectorComponent(t)
  }
}
