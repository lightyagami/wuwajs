...
class CalculateComponent {
  ...
  static getSizePrefixedRootAsCalculateComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CalculateComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  vars(t, e) {
    ...
    return s ? (e || new number_var_js_1.NumberVar).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  varsLength() {
  ...
  functions(t, e) {
    ...
    return s ? (e || new type_function_js_1.TypeFunction).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  functionsLength() {
  ...
  static createCalculateComponent(t, e, s, a) {
    return CalculateComponent.startCalculateComponent(t), CalculateComponent.addDisabled(t, e), CalculateComponent.addVars(t, s), CalculateComponent.addFunctions(t, a), CalculateComponent.endCalculateComponent(t)
  }
}
