...
class AirWallSpawnerComponent {
  ...
  static getSizePrefixedRootAsAirWallSpawnerComponent(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new AirWallSpawnerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  wallActorsRef(t, r) {
    ...
    return e ? (r || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  wallActorsRefLength() {
  ...
  static createAirWallSpawnerComponent(t, r, e, i, a, s, n, o, l, h) {
    return AirWallSpawnerComponent.startAirWallSpawnerComponent(t), AirWallSpawnerComponent.addDisabled(t, r), AirWallSpawnerComponent.addSplineEntity(t, e), AirWallSpawnerComponent.addWallName(t, i), AirWallSpawnerComponent.addThickness(t, a), AirWallSpawnerComponent.addHeight(t, s), AirWallSpawnerComponent.addBiasDirection(t, n), AirWallSpawnerComponent.addIsExtend(t, o), AirWallSpawnerComponent.addHasCover(t, l), AirWallSpawnerComponent.addWallActorsRef(t, h), AirWallSpawnerComponent.endAirWallSpawnerComponent(t)
  }
}
