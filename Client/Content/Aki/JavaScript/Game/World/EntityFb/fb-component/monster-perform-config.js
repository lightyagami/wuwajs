...
class MonsterPerformConfig {
  ...
  static getSizePrefixedRootAsMonsterPerformConfig(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new MonsterPerformConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  showOnDeathType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_monster_show_on_death_config_js_1.UnionMonsterShowOnDeathConfig.NONE
  }
  showOnDeath(t) {
  ...
  static createMonsterPerformConfig(t, o, r) {
    return MonsterPerformConfig.startMonsterPerformConfig(t), MonsterPerformConfig.addShowOnDeathType(t, o), MonsterPerformConfig.addShowOnDeath(t, r), MonsterPerformConfig.endMonsterPerformConfig(t)
  }
}
