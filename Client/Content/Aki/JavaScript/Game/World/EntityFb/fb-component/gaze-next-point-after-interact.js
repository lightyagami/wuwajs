...
class GazeNextPointAfterInteract {
  ...
  static getSizePrefixedRootAsGazeNextPointAfterInteract(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new GazeNextPointAfterInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  gazeCondition(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new gaze_condition_js_1.GazeCondition).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  gazePerformance(t) {
    var e = this.bb.__offset(this.bb_pos, 6);
    return e ? (t || new gaze_performance_js_1.GazePerformance).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
