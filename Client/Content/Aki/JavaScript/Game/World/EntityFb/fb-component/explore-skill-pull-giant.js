...
class ExploreSkillPullGiant {
  ...
  static getSizePrefixedRootAsExploreSkillPullGiant(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ExploreSkillPullGiant).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  actions(t, i) {
    ...
    return l ? (i || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + l) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createExploreSkillPullGiant(t, i, l, e) {
    return ExploreSkillPullGiant.startExploreSkillPullGiant(t), ExploreSkillPullGiant.addType(t, i), ExploreSkillPullGiant.addPullTime(t, l), ExploreSkillPullGiant.addActions(t, e), ExploreSkillPullGiant.endExploreSkillPullGiant(t)
  }
}
