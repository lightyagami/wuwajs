...
class EntityMatchDynamic {
  ...
  static getSizePrefixedRootAsEntityMatchDynamic(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityMatchDynamic).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  matchEntity(t, i) {
    ...
    return a ? (i || new dynamic_entity_match_js_1.DynamicEntityMatch).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + a) + 4 * t), this.bb) : void 0
  }
  matchEntityLength() {
  ...
  static createEntityMatchDynamic(t, i, a) {
    return EntityMatchDynamic.startEntityMatchDynamic(t), EntityMatchDynamic.addType(t, i), EntityMatchDynamic.addMatchEntity(t, a), EntityMatchDynamic.endEntityMatchDynamic(t)
  }
}
