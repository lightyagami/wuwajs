...
class GroupAiComponent {
  ...
  static getSizePrefixedRootAsGroupAiComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GroupAiComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  optionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_group_ai_option_js_1.UnionGroupAiOption.NONE
  }
  option(t) {
  ...
  static createGroupAiComponent(t, i, o, n, s) {
    return GroupAiComponent.startGroupAiComponent(t), GroupAiComponent.addDisabled(t, i), GroupAiComponent.addEntities(t, o), GroupAiComponent.addOptionType(t, n), GroupAiComponent.addOption(t, s), GroupAiComponent.endGroupAiComponent(t)
  }
}
