...
class PatrolAction {
  ...
  static getSizePrefixedRootAsPatrolAction(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PatrolAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  point() {
  ...
  static createPatrolAction(t, i, o) {
    return PatrolAction.startPatrolAction(t), PatrolAction.addPoint(t, i), PatrolAction.addActions(t, o), PatrolAction.endPatrolAction(t)
  }
}
