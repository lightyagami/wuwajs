...
class TriggerRangeStartCondition {
  ...
  static getSizePrefixedRootAsTriggerRangeStartCondition(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new TriggerRangeStartCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createTriggerRangeStartCondition(t, r, i) {
    return TriggerRangeStartCondition.startTriggerRangeStartCondition(t), TriggerRangeStartCondition.addType(t, r), TriggerRangeStartCondition.addRange(t, i), TriggerRangeStartCondition.endTriggerRangeStartCondition(t)
  }
}
