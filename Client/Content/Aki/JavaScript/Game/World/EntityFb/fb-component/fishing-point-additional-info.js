...
class FishingPointAdditionalInfo {
  ...
  static getSizePrefixedRootAsFishingPointAdditionalInfo(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FishingPointAdditionalInfo).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createFishingPointAdditionalInfo(i, t) {
    return FishingPointAdditionalInfo.startFishingPointAdditionalInfo(i), FishingPointAdditionalInfo.addType(i, t), FishingPointAdditionalInfo.endFishingPointAdditionalInfo(i)
  }
}
