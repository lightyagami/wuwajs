...
class EntityListBatch {
  ...
  static getSizePrefixedRootAsEntityListBatch(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityListBatch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEntityListBatch(t, i, s) {
    return EntityListBatch.startEntityListBatch(t), EntityListBatch.addType(t, i), EntityListBatch.addEntityIds(t, s), EntityListBatch.endEntityListBatch(t)
  }
}
