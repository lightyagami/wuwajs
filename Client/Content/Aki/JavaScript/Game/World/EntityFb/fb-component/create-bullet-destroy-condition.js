...
class CreateBulletDestroyCondition {
  ...
  static getSizePrefixedRootAsCreateBulletDestroyCondition(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CreateBulletDestroyCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCreateBulletDestroyCondition(t, e) {
    return CreateBulletDestroyCondition.startCreateBulletDestroyCondition(t), CreateBulletDestroyCondition.addType(t, e), CreateBulletDestroyCondition.endCreateBulletDestroyCondition(t)
  }
}
