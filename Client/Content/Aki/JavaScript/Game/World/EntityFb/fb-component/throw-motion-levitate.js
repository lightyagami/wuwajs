...
class ThrowMotionLevitate {
  ...
  static getSizePrefixedRootAsThrowMotionLevitate(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ThrowMotionLevitate).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  renderTrajectoryConfig(t) {
    ...
    return i ? (t || new render_trajectory_config_js_1.RenderTrajectoryConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
