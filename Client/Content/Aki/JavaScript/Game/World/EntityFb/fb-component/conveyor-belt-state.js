...
class ConveyorBeltState {
  ...
  static getSizePrefixedRootAsConveyorBeltState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ConveyorBeltState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityState(t) {
  ...
  fieldTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_conveyor_belt_field_type_js_1.UnionConveyorBeltFieldType.NONE
  }
  fieldType(t) {
  ...
  moveTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_conveyor_belt_move_type_js_1.UnionConveyorBeltMoveType.NONE
  }
  moveType(t) {
  ...
  static createConveyorBeltState(t, e, o, i, r, n) {
    return ConveyorBeltState.startConveyorBeltState(t), ConveyorBeltState.addEntityState(t, e), ConveyorBeltState.addFieldTypeType(t, o), ConveyorBeltState.addFieldType(t, i), ConveyorBeltState.addMoveTypeType(t, r), ConveyorBeltState.addMoveType(t, n), ConveyorBeltState.endConveyorBeltState(t)
  }
}
