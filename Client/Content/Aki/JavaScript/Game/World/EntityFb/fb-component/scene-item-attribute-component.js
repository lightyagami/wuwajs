...
class SceneItemAttributeComponent {
  ...
  static getSizePrefixedRootAsSceneItemAttributeComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SceneItemAttributeComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createSceneItemAttributeComponent(t, e, n) {
    return SceneItemAttributeComponent.startSceneItemAttributeComponent(t), SceneItemAttributeComponent.addDisabled(t, e), SceneItemAttributeComponent.addAttributeType(t, n), SceneItemAttributeComponent.endSceneItemAttributeComponent(t)
  }
}
