...
class BubbleComponent {
  ...
  static getSizePrefixedRootAsBubbleComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BubbleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  flows(t, e) {
    ...
    return s ? (e || new condition_bubble_data_js_1.ConditionBubbleData).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  flowsLength() {
  ...
  static createBubbleComponent(t, e, s, i, n, r, o) {
    return BubbleComponent.startBubbleComponent(t), BubbleComponent.addDisabled(t, e), BubbleComponent.addNpcIds(t, s), BubbleComponent.addEnterRange(t, i), BubbleComponent.addLeaveRange(t, n), BubbleComponent.addFlows(t, r), BubbleComponent.addTimberId(t, o), BubbleComponent.endBubbleComponent(t)
  }
}
