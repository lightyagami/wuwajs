...
class FailureStateTrigger {
  ...
  static getSizePrefixedRootAsFailureStateTrigger(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FailureStateTrigger).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  failureOperations(t) {
    ...
    return i ? (t || new operations_after_entity_group_failure_js_1.OperationsAfterEntityGroupFailure).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
