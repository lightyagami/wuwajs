...
class EntityBatchRefreshComponent {
  ...
  static getSizePrefixedRootAsEntityBatchRefreshComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityBatchRefreshComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  entityBatchRefreshType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_entity_batch_refresh_js_1.UnionEntityBatchRefresh.NONE
  }
