...
class ItemFoundation2 {
  ...
  static getSizePrefixedRootAsItemFoundation2(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ItemFoundation2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  configType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_item_foundation_js_1.UnionItemFoundation.NONE
  }
  config(t) {
  ...
  static createItemFoundation2(t, i, n, o) {
    return ItemFoundation2.startItemFoundation2(t), ItemFoundation2.addDisabled(t, i), ItemFoundation2.addConfigType(t, n), ItemFoundation2.addConfig(t, o), ItemFoundation2.endItemFoundation2(t)
  }
}
