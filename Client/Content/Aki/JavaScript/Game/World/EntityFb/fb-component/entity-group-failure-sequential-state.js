...
class EntityGroupFailureSequentialState {
  ...
  static getSizePrefixedRootAsEntityGroupFailureSequentialState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityGroupFailureSequentialState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  order(t, e) {
    ...
    return i ? (e || new entity_state_condition_js_1.EntityStateCondition).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  orderLength() {
  ...
  static createEntityGroupFailureSequentialState(t, e, i) {
    return EntityGroupFailureSequentialState.startEntityGroupFailureSequentialState(t), EntityGroupFailureSequentialState.addType(t, e), EntityGroupFailureSequentialState.addOrder(t, i), EntityGroupFailureSequentialState.endEntityGroupFailureSequentialState(t)
  }
}
