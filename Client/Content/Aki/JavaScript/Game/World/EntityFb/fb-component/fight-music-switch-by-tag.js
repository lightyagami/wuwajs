...
class FightMusicSwitchByTag {
  ...
  static getSizePrefixedRootAsFightMusicSwitchByTag(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FightMusicSwitchByTag).__init(t.readInt32(t.position()) + t.position(), t)
  }
  fightMusic(t) {
  ...
  static createFightMusicSwitchByTag(t, i, s) {
    return FightMusicSwitchByTag.startFightMusicSwitchByTag(t), FightMusicSwitchByTag.addFightMusic(t, i), FightMusicSwitchByTag.addActivateTag(t, s), FightMusicSwitchByTag.endFightMusicSwitchByTag(t)
  }
}
