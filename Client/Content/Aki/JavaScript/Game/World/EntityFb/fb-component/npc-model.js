...
class NpcModel {
  ...
  static getSizePrefixedRootAsNpcModel(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcModel).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  npcModelType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_npc_model_type_js_1.UnionNpcModelType.NONE
  }
  npcModel(t) {
  ...
  static createNpcModel(t, e, s, i, r, o, c, a, d, h, l) {
    return NpcModel.startNpcModel(t), NpcModel.addType(t, e), NpcModel.addBlueprintPath(t, s), NpcModel.addNpcModelType(t, i), NpcModel.addNpcModel(t, r), NpcModel.addAbp(t, o), NpcModel.addBattleSockets(t, c), NpcModel.addNormalSockets(t, a), NpcModel.addLookingUpAngle(t, d), NpcModel.addBodyType(t, h), NpcModel.addNameZaxisOffset(t, l), NpcModel.endNpcModel(t)
  }
}
