...
class TriggerUe5Component {
  ...
  static getSizePrefixedRootAsTriggerUe5Component(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TriggerUe5Component).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  triggerActions(t) {
    ...
    return e ? (t || new trigger_actions_js_1.TriggerActions).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
