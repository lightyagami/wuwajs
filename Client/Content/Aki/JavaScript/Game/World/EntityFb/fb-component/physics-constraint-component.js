...
class PhysicsConstraintComponent {
  ...
  static getSizePrefixedRootAsPhysicsConstraintComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PhysicsConstraintComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  attachTargetType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_physics_attach_target_js_1.UnionPhysicsAttachTarget.NONE
  }
  attachTarget(t) {
  ...
  angularLimit(t) {
    ...
    return s ? (t || new physics_angular_limit_js_1.PhysicsAngularLimit).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  dampingCoefficient() {
