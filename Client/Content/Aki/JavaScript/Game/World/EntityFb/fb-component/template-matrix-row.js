...
class TemplateMatrixRow {
  ...
  static getRootAsTemplateMatrixRow(t, e) {
    return (e || new TemplateMatrixRow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsTemplateMatrixRow(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TemplateMatrixRow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  items(t, e) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (e || new spawn_template_entity_config_js_1.SpawnTemplateEntityConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  itemsLength() {
  ...
  static createTemplateMatrixRow(t, e) {
    return TemplateMatrixRow.startTemplateMatrixRow(t), TemplateMatrixRow.addItems(t, e), TemplateMatrixRow.endTemplateMatrixRow(t)
  }
}
