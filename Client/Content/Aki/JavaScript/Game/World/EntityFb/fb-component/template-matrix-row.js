...
exports.TemplateMatrixRow = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const spawn_template_entity_config_js_1 = require("../fb-component/spawn-template-entity-config.js");
class TemplateMatrixRow {
  ...
  items(t, e) {
    ...
    if (i) {
      return (e || new spawn_template_entity_config_js_1.SpawnTemplateEntityConfig()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createTemplateMatrixRow(t, e) {
    ...
    return TemplateMatrixRow.endTemplateMatrixRow(t);
  }
}
