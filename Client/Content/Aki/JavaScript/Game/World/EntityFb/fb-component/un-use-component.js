...
class UnUseComponent {
  ...
  static getSizePrefixedRootAsUnUseComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UnUseComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createUnUseComponent(t, e) {
    return UnUseComponent.startUnUseComponent(t), UnUseComponent.addDisabled(t, e), UnUseComponent.endUnUseComponent(t)
  }
}
