...
class GroupDestroyListenConfig {
  ...
  static getSizePrefixedRootAsGroupDestroyListenConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GroupDestroyListenConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  groupType() {
  ...
  onTriggerActions(t, i) {
    ...
    return r ? (i || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  static createGroupDestroyListenConfig(t, i, r) {
    return GroupDestroyListenConfig.startGroupDestroyListenConfig(t), GroupDestroyListenConfig.addGroupType(t, i), GroupDestroyListenConfig.addOnTriggerActions(t, r), GroupDestroyListenConfig.endGroupDestroyListenConfig(t)
  }
}
