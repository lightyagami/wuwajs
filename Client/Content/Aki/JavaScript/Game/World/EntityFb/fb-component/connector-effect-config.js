...
class ConnectorEffectConfig {
  ...
  static getSizePrefixedRootAsConnectorEffectConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ConnectorEffectConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effectPath(t) {
  ...
  static createConnectorEffectConfig(t, e, n, o) {
    return ConnectorEffectConfig.startConnectorEffectConfig(t), ConnectorEffectConfig.addEffectPath(t, e), ConnectorEffectConfig.addStartPoint(t, n), ConnectorEffectConfig.addEndPoint(t, o), ConnectorEffectConfig.endConnectorEffectConfig(t)
  }
}
