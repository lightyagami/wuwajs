...
class AudioFade {
  ...
  static getSizePrefixedRootAsAudioFade(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AudioFade).__init(t.readInt32(t.position()) + t.position(), t)
  }
  fadeCurve() {
  ...
  static createAudioFade(t, e, i) {
    return AudioFade.startAudioFade(t), AudioFade.addFadeCurve(t, e), AudioFade.addFadeDuration(t, i), AudioFade.endAudioFade(t)
  }
}
