...
class TriggerComponent {
  ...
  static getSizePrefixedRootAsTriggerComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TriggerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  exitConfig(t) {
    ...
    return i ? (t || new trigger_exit_config_js_1.TriggerExitConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
