...
class NpcBumpShow {
  ...
  static getSizePrefixedRootAsNpcBumpShow(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcBumpShow).__init(t.readInt32(t.position()) + t.position(), t)
  }
  bumpBubble(t) {
    var e = this.bb.__offset(this.bb_pos, 4);
    return e ? (t || new npc_perform_bubble_js_1.NpcPerformBubble).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  ...
  static createNpcBumpShow(t, e) {
    return NpcBumpShow.startNpcBumpShow(t), NpcBumpShow.addBumpBubble(t, e), NpcBumpShow.endNpcBumpShow(t)
  }
}
