...
class WindSourceComponent {
  ...
  static getSizePrefixedRootAsWindSourceComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new WindSourceComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  windSourceType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_wind_source_js_1.UnionWindSource.NONE
  }
  windSource(t) {
  ...
  static createWindSourceComponent(t, e, n, o) {
    return WindSourceComponent.startWindSourceComponent(t), WindSourceComponent.addDisabled(t, e), WindSourceComponent.addWindSourceType(t, n), WindSourceComponent.addWindSource(t, o), WindSourceComponent.endWindSourceComponent(t)
  }
}
