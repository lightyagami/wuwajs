...
class CategoryMatchingSucceed {
  ...
  static getRootAsCategoryMatchingSucceed(t, e) {
    return (e || new CategoryMatchingSucceed).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCategoryMatchingSucceed(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CategoryMatchingSucceed).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isSilent() {
  ...
  changeItemState(t) {
    ...
    return e ? (t || new entity_state_js_1.EntityState).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  ...
  changeAdsorbateState(t) {
    ...
    return e ? (t || new item_change_adsorbate_state_js_1.ItemChangeAdsorbateState).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  dischargeSequence(t) {
