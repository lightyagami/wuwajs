...
exports.CategoryMatchingSucceed = undefined;
...
class CategoryMatchingSucceed {
  ...
  changeAdsorbateState(t) {
    ...
    if (e) {
      return (t || new item_change_adsorbate_state_js_1.ItemChangeAdsorbateState()).__init(this.bb.__indirect(this.bb_pos + e), this.bb);
    } else {
      return undefined;
    }
  }
