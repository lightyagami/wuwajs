...
class CharacterConnectorRange {
  ...
  static getSizePrefixedRootAsCharacterConnectorRange(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CharacterConnectorRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  effectConfig(t) {
    ...
    return i ? (t || new connector_effect_config_js_1.ConnectorEffectConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  enterRange() {
  ...
  matchConditions(t, i) {
    ...
    return e ? (i || new dynamic_entity_match_js_1.DynamicEntityMatch).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
