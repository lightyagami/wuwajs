...
class PasserbyNpcTemplateSource {
  ...
  static getSizePrefixedRootAsPasserbyNpcTemplateSource(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PasserbyNpcTemplateSource).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createPasserbyNpcTemplateSource(e, t, s) {
    return PasserbyNpcTemplateSource.startPasserbyNpcTemplateSource(e), PasserbyNpcTemplateSource.addType(e, t), PasserbyNpcTemplateSource.addTemplateIds(e, s), PasserbyNpcTemplateSource.endPasserbyNpcTemplateSource(e)
  }
}
