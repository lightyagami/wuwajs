...
class RandomInteract {
  ...
  static getSizePrefixedRootAsRandomInteract(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new RandomInteract).__init(t.readInt32(t.position()) + t.position(), t)
  }
  randomCount() {
  ...
  options(t, n) {
    ...
    return r ? (n || new random_interact_option_js_1.RandomInteractOption).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  optionsLength() {
  ...
  static createRandomInteract(t, n, r) {
    return RandomInteract.startRandomInteract(t), RandomInteract.addRandomCount(t, n), RandomInteract.addOptions(t, r), RandomInteract.endRandomInteract(t)
  }
}
