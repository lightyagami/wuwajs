...
class GravityFlipConfig {
  ...
  static getSizePrefixedRootAsGravityFlipConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GravityFlipConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createGravityFlipConfig(t, i, r) {
    return GravityFlipConfig.startGravityFlipConfig(t), GravityFlipConfig.addType(t, i), GravityFlipConfig.addLocationEntityId(t, r), GravityFlipConfig.endGravityFlipConfig(t)
  }
}
