...
class SuiGuangHook {
  ...
  static getRootAsSuiGuangHook(t, i) {
    return (i || new SuiGuangHook).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSuiGuangHook(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SuiGuangHook).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSuiGuangHook(t, i, o, s, n) {
    return SuiGuangHook.startSuiGuangHook(t), SuiGuangHook.addType(t, i), SuiGuangHook.addHookActions(t, o), SuiGuangHook.addExitHookActions(t, s), SuiGuangHook.addFinishActions(t, n), SuiGuangHook.endSuiGuangHook(t)
  }
}
