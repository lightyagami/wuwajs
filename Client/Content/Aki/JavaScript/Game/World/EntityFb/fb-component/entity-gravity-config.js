...
class EntityGravityConfig {
  ...
  static getSizePrefixedRootAsEntityGravityConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityGravityConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ...
  static createEntityGravityConfig(t, i, r, n, a) {
    return EntityGravityConfig.startEntityGravityConfig(t), EntityGravityConfig.addGravityDirectionType(t, i), EntityGravityConfig.addGravityDirection(t, r), EntityGravityConfig.addSpecifyGravityLoad(t, n), EntityGravityConfig.addSpecifyGravityLock(t, a), EntityGravityConfig.endEntityGravityConfig(t)
  }
}
