...
class OnThrowTriggerTimeCondition {
  ...
  static getSizePrefixedRootAsOnThrowTriggerTimeCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OnThrowTriggerTimeCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createOnThrowTriggerTimeCondition(i, t, r, e) {
    return OnThrowTriggerTimeCondition.startOnThrowTriggerTimeCondition(i), OnThrowTriggerTimeCondition.addType(i, t), OnThrowTriggerTimeCondition.addBulletId(i, r), OnThrowTriggerTimeCondition.addTriggerTime(i, e), OnThrowTriggerTimeCondition.endOnThrowTriggerTimeCondition(i)
  }
}
