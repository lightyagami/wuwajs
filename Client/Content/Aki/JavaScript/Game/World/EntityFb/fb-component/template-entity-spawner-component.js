...
class TemplateEntitySpawnerComponent {
  ...
  static getSizePrefixedRootAsTemplateEntitySpawnerComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new TemplateEntitySpawnerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  spawnConditions(t) {
    ...
    return n ? (t || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : void 0
  }
  clearConditions(t) {
  ...
  spawnConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spawn_config_js_1.UnionSpawnConfig.NONE
  }
  spawnConfig(t) {
