...
class GazePerformance {
  ...
  static getRootAsGazePerformance(e, t) {
    return (t || new GazePerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  static getSizePrefixedRootAsGazePerformance(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new GazePerformance).__init(e.readInt32(e.position()) + e.position(), e)
  }
  fadeInTime() {
  ...
  static createGazePerformance(e, t, r, a, s) {
    return GazePerformance.startGazePerformance(e), GazePerformance.addFadeInTime(e, t), GazePerformance.addStayTime(e, r), GazePerformance.addFadeOutTime(e, a), GazePerformance.addLockCamera(e, s), GazePerformance.endGazePerformance(e)
  }
}
