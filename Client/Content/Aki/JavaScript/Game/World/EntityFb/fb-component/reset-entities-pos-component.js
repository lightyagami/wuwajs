...
class ResetEntitiesPosComponent {
  ...
  static getSizePrefixedRootAsResetEntitiesPosComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ResetEntitiesPosComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  rangeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_trigger_shape_js_1.UnionTriggerShape.NONE
  }
  range(t) {
  ...
  static createResetEntitiesPosComponent(t, e, s, i, n) {
    return ResetEntitiesPosComponent.startResetEntitiesPosComponent(t), ResetEntitiesPosComponent.addDisabled(t, e), ResetEntitiesPosComponent.addRangeType(t, s), ResetEntitiesPosComponent.addRange(t, i), ResetEntitiesPosComponent.addEntityIds(t, n), ResetEntitiesPosComponent.endResetEntitiesPosComponent(t)
  }
}
