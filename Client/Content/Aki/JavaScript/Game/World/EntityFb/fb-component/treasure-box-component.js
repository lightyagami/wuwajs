...
class TreasureBoxComponent {
  ...
  static getSizePrefixedRootAsTreasureBoxComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TreasureBoxComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  static createTreasureBoxComponent(e, t, r) {
    return TreasureBoxComponent.startTreasureBoxComponent(e), TreasureBoxComponent.addDisabled(e, t), TreasureBoxComponent.addTypeId(e, r), TreasureBoxComponent.endTreasureBoxComponent(e)
  }
}
