...
class AiComponent {
  ...
  static getSizePrefixedRootAsAiComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AiComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  patrol(t) {
    ...
    return i ? (t || new patrol_js_1.Patrol).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  initStateType() {
    var t = this.bb.__offset(this.bb_pos, 10);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_init_state_js_1.UnionInitState.NONE
  }
  initState(t) {
