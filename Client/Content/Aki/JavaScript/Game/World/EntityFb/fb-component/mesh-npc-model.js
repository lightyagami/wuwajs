...
class MeshNpcModel {
  ...
  static getSizePrefixedRootAsMeshNpcModel(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MeshNpcModel).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createMeshNpcModel(e, t, s) {
    return MeshNpcModel.startMeshNpcModel(e), MeshNpcModel.addType(e, t), MeshNpcModel.addMesh(e, s), MeshNpcModel.endMeshNpcModel(e)
  }
}
