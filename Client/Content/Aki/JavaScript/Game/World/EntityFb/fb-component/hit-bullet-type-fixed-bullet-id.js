...
class HitBulletTypeFixedBulletId {
  ...
  static getSizePrefixedRootAsHitBulletTypeFixedBulletId(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitBulletTypeFixedBulletId).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitBulletTypeFixedBulletId(t, e, l, i) {
    return HitBulletTypeFixedBulletId.startHitBulletTypeFixedBulletId(t), HitBulletTypeFixedBulletId.addType(t, e), HitBulletTypeFixedBulletId.addBulletId(t, l), HitBulletTypeFixedBulletId.addPlayerAttack(t, i), HitBulletTypeFixedBulletId.endHitBulletTypeFixedBulletId(t)
  }
}
