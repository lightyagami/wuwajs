...
class EntityStateAudioComponent {
  ...
  static getSizePrefixedRootAsEntityStateAudioComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityStateAudioComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  config(t, e) {
    ...
    return i ? (e || new entity_state_audio_config_js_1.EntityStateAudioConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  configLength() {
  ...
  static createEntityStateAudioComponent(t, e, i, n, o, s) {
    return EntityStateAudioComponent.startEntityStateAudioComponent(t), EntityStateAudioComponent.addDisabled(t, e), EntityStateAudioComponent.addAkEventTypeType(t, i), EntityStateAudioComponent.addAkEventType(t, n), EntityStateAudioComponent.addAudioRangeType(t, o), EntityStateAudioComponent.addConfig(t, s), EntityStateAudioComponent.endEntityStateAudioComponent(t)
  }
}
