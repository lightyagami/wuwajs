...
class LowViewDistance {
  ...
  static getSizePrefixedRootAsLowViewDistance(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LowViewDistance).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createLowViewDistance(t, e) {
    return LowViewDistance.startLowViewDistance(t), LowViewDistance.addType(t, e), LowViewDistance.endLowViewDistance(t)
  }
}
