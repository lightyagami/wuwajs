...
class LevelPrefab {
  ...
  static getSizePrefixedRootAsLevelPrefab(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LevelPrefab).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  prefabStateList(t, e) {
    ...
    return r ? (e || new prefab_state_config_js_1.PrefabStateConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  effectStateList(t, e) {
    ...
    return r ? (e || new prefab_effect_config_js_1.PrefabEffectConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  static createLevelPrefab(t, e, r, s, i, a, f) {
    return LevelPrefab.startLevelPrefab(t), LevelPrefab.addType(t, e), LevelPrefab.addBlueprintPath(t, r), LevelPrefab.addPrefabPath(t, s), LevelPrefab.addNameOffsetZ(t, i), LevelPrefab.addPrefabStateList(t, a), LevelPrefab.addEffectStateList(t, f), LevelPrefab.endLevelPrefab(t)
  }
}
