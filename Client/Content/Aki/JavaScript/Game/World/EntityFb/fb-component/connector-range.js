...
class ConnectorRange {
  ...
  static getSizePrefixedRootAsConnectorRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ConnectorRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  effectConfig(t) {
    ...
    return e ? (t || new connector_effect_config_js_1.ConnectorEffectConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  activeState(t) {
  ...
  matchConditions(t, e) {
    ...
    return i ? (e || new dynamic_entity_match_js_1.DynamicEntityMatch).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
