...
class CategoryMatchingFoundation {
  ...
  static getSizePrefixedRootAsCategoryMatchingFoundation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CategoryMatchingFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  matchingConfigs(t, i) {
    ...
    return n ? (i || new category_matching_config_js_1.CategoryMatchingConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  ...
  static createCategoryMatchingFoundation(t, i, n, a) {
    return CategoryMatchingFoundation.startCategoryMatchingFoundation(t), CategoryMatchingFoundation.addType(t, i), CategoryMatchingFoundation.addInitMatchEntity(t, n), CategoryMatchingFoundation.addMatchingConfigs(t, a), CategoryMatchingFoundation.endCategoryMatchingFoundation(t)
  }
}
