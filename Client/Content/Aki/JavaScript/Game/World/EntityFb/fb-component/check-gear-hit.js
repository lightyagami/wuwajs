...
class CheckGearHit {
  ...
  static getSizePrefixedRootAsCheckGearHit(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CheckGearHit).__init(t.readInt32(t.position()) + t.position(), t)
  }
  hitIndex() {
  ...
  static createCheckGearHit(t, e, i, r) {
    return CheckGearHit.startCheckGearHit(t), CheckGearHit.addHitIndex(t, e), CheckGearHit.addAffectIndex(t, i), CheckGearHit.addAffectType(t, r), CheckGearHit.endCheckGearHit(t)
  }
}
