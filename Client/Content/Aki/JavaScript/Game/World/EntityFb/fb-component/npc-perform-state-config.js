...
class NpcPerformStateConfig {
  ...
  static getSizePrefixedRootAsNpcPerformStateConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new NpcPerformStateConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  static createNpcPerformStateConfig(t, e, r) {
    return NpcPerformStateConfig.startNpcPerformStateConfig(t), NpcPerformStateConfig.addState(t, e), NpcPerformStateConfig.addMaterialDa(t, r), NpcPerformStateConfig.endNpcPerformStateConfig(t)
  }
}
