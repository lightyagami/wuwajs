...
class EntityCategory {
  ...
  static getRootAsEntityCategory(t, i) {
    return (i || new EntityCategory).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEntityCategory(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityCategory).__init(t.readInt32(t.position()) + t.position(), t)
  }
  mainType(t) {
  ...
  static createEntityCategory(t, i, e, s, a, r, h, y, n, o, d, c, u, p, g, l, v, T, C) {
    return EntityCategory.startEntityCategory(t), EntityCategory.addMainType(t, i), EntityCategory.addEntityPlotBindingType(t, e), EntityCategory.addControlMatchType(t, s), EntityCategory.addMonsterMatchType(t, a), EntityCategory.addItemFoundation(t, r), EntityCategory.addHideInFlowType(t, h), EntityCategory.addExploratoryDegree(t, y), EntityCategory.addTraceMatchType(t, n), EntityCategory.addDestructibleType(t, o), EntityCategory.addCollectType(t, d), EntityCategory.addNpcType(t, c), EntityCategory.addAnimalType(t, u), EntityCategory.addBulletPenetrationType(t, p), EntityCategory.addMechanismType(t, g), EntityCategory.addInhaledItemType(t, l), EntityCategory.addPullStatueMatchType(t, v), EntityCategory.addVehicleType(t, T), EntityCategory.addFishingMechanismType(t, C), EntityCategory.endEntityCategory(t)
  }
}
