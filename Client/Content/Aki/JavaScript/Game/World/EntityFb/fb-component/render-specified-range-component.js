...
class RenderSpecifiedRangeComponent {
  ...
  static getSizePrefixedRootAsRenderSpecifiedRangeComponent(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RenderSpecifiedRangeComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  condition(e) {
    ...
    return i ? (e || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  renderConfigType() {
    var e = this.bb.__offset(this.bb_pos, 8);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_render_specified_range_config_js_1.UnionRenderSpecifiedRangeConfig.NONE
  }
  renderConfig(e) {
