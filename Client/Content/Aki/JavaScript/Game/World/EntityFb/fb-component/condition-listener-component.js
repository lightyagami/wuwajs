...
class ConditionListenerComponent {
  ...
  static getSizePrefixedRootAsConditionListenerComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ConditionListenerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  listeners(t, e) {
    ...
    return n ? (e || new condtion_listener_js_1.CondtionListener).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  listenersLength() {
  ...
  static createConditionListenerComponent(t, e, n) {
    return ConditionListenerComponent.startConditionListenerComponent(t), ConditionListenerComponent.addDisabled(t, e), ConditionListenerComponent.addListeners(t, n), ConditionListenerComponent.endConditionListenerComponent(t)
  }
}
