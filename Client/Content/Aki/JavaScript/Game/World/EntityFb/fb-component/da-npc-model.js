...
class DaNpcModel {
  ...
  static getSizePrefixedRootAsDaNpcModel(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DaNpcModel).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createDaNpcModel(t, e, s) {
    return DaNpcModel.startDaNpcModel(t), DaNpcModel.addType(t, e), DaNpcModel.addDa(t, s), DaNpcModel.endDaNpcModel(t)
  }
}
