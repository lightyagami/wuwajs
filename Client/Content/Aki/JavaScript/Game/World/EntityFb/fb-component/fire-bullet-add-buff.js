...
class FireBulletAddBuff {
  ...
  static getRootAsFireBulletAddBuff(t, e) {
    return (e || new FireBulletAddBuff).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsFireBulletAddBuff(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FireBulletAddBuff).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
