...
class FanComponent {
  ...
  static getSizePrefixedRootAsFanComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FanComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  interactTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_fan_interact_option_js_1.UnionFanInteractOption.NONE
  }
  interactType(t) {
  ...
  effectConfig(t) {
    ...
    return i ? (t || new fan_effect_config_js_1.FanEffectConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  effectByState(t, i) {
    var e = this.bb.__offset(this.bb_pos, 26);
    return e ? (i || new fan_state_effect_js_1.FanStateEffect).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  effectByStateLength() {
