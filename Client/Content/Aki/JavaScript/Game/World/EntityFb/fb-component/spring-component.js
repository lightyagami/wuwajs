...
exports.SpringComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const setting_spring_dir_js_1 = require("../fb-component/setting-spring-dir.js");
class SpringComponent {
  ...
  settingDir(t) {
    ...
    if (i) {
      return (t || new setting_spring_dir_js_1.SettingSpringDir()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
