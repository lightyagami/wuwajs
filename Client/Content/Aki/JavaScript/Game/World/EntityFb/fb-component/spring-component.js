...
class SpringComponent {
  ...
  static getRootAsSpringComponent(t, i) {
    return (i || new SpringComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSpringComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SpringComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  settingDir(t) {
    ...
    return i ? (t || new setting_spring_dir_js_1.SettingSpringDir).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  springPow() {
