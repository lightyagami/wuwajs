...
class RenderTrajectoryConfig {
  ...
  static getSizePrefixedRootAsRenderTrajectoryConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RenderTrajectoryConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  time() {
  ...
  static createRenderTrajectoryConfig(e, t, r) {
    return RenderTrajectoryConfig.startRenderTrajectoryConfig(e), RenderTrajectoryConfig.addTime(e, t), RenderTrajectoryConfig.addEffect(e, r), RenderTrajectoryConfig.endRenderTrajectoryConfig(e)
  }
}
