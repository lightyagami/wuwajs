...
exports.ProjectileMotion = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const speed_curve_motion_js_1 = require("../fb-component/speed-curve-motion.js");
class ProjectileMotion {
  ...
  matchSpeedCurve(t) {
    ...
    if (e) {
      return (t || new speed_curve_motion_js_1.SpeedCurveMotion()).__init(this.bb.__indirect(this.bb_pos + e), this.bb);
    } else {
      return undefined;
    }
  }
