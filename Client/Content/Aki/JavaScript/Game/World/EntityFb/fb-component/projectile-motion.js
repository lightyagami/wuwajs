...
class ProjectileMotion {
  ...
  static getRootAsProjectileMotion(t, e) {
    return (e || new ProjectileMotion).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsProjectileMotion(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ProjectileMotion).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  matchSpeedCurve(t) {
    ...
    return e ? (t || new speed_curve_motion_js_1.SpeedCurveMotion).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
