...
class OperationsAfterEntityGroupFailure {
  ...
  static getSizePrefixedRootAsOperationsAfterEntityGroupFailure(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new OperationsAfterEntityGroupFailure).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isResetState() {
  ...
  actions(t, r) {
    ...
    return i ? (r || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createOperationsAfterEntityGroupFailure(t, r, i) {
    return OperationsAfterEntityGroupFailure.startOperationsAfterEntityGroupFailure(t), OperationsAfterEntityGroupFailure.addIsResetState(t, r), OperationsAfterEntityGroupFailure.addActions(t, i), OperationsAfterEntityGroupFailure.endOperationsAfterEntityGroupFailure(t)
  }
}
