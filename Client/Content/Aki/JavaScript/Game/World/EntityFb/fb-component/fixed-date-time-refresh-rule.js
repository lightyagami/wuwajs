...
class FixedDateTimeRefreshRule {
  ...
  static getRootAsFixedDateTimeRefreshRule(t, e) {
    return (e || new FixedDateTimeRefreshRule).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsFixedDateTimeRefreshRule(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FixedDateTimeRefreshRule).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
