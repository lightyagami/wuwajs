...
class WalkingPatternComponent {
  ...
  static getSizePrefixedRootAsWalkingPatternComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new WalkingPatternComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createWalkingPatternComponent(t, n, e, i, r, a, s, o) {
    return WalkingPatternComponent.startWalkingPatternComponent(t), WalkingPatternComponent.addDisabled(t, n), WalkingPatternComponent.addSplineEntityId(t, e), WalkingPatternComponent.addEndEntityId(t, i), WalkingPatternComponent.addScoreVarType(t, r), WalkingPatternComponent.addScoreVar(t, a), WalkingPatternComponent.addSpineEffectExistDuration(t, s), WalkingPatternComponent.addReplaySpineEffect(t, o), WalkingPatternComponent.endWalkingPatternComponent(t)
  }
}
