...
class EntityAngleWeight {
  ...
  static getSizePrefixedRootAsEntityAngleWeight(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityAngleWeight).__init(t.readInt32(t.position()) + t.position(), t)
  }
  angle() {
  ...
  static createEntityAngleWeight(t, e, i) {
    return EntityAngleWeight.startEntityAngleWeight(t), EntityAngleWeight.addAngle(t, e), EntityAngleWeight.addWeight(t, i), EntityAngleWeight.endEntityAngleWeight(t)
  }
}
