...
class SceneItemLifeCycleComponent {
  ...
  static getSizePrefixedRootAsSceneItemLifeCycleComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneItemLifeCycleComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  createStageConfig(e) {
    ...
    return t ? (e || new create_stage_config_js_1.CreateStageConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  destroyStageConfig(e) {
    var t = this.bb.__offset(this.bb_pos, 8);
    return t ? (e || new destroy_stage_config_js_1.DestroyStageConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
