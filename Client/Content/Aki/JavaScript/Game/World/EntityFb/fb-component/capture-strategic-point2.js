...
class CaptureStrategicPoint2 {
  ...
  static getSizePrefixedRootAsCaptureStrategicPoint2(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CaptureStrategicPoint2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  enemyEntitiyMatch(t) {
    ...
    return e ? (t || new static_entitiy_match_js_1.StaticEntitiyMatch).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
