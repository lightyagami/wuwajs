...
class ThrowMotionTrackTarget {
  ...
  static getRootAsThrowMotionTrackTarget(t, r) {
    return (r || new ThrowMotionTrackTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsThrowMotionTrackTarget(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ThrowMotionTrackTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
