...
class PasserbyNpcSpline {
  ...
  static getSizePrefixedRootAsPasserbyNpcSpline(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PasserbyNpcSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  splineEntityId() {
  ...
  moveState(t) {
    ...
    return s ? (t || new passerby_npc_move_state_js_1.PasserbyNpcMoveState).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
