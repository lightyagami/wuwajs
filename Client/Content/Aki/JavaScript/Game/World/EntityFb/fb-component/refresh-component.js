...
class RefreshComponent {
  ...
  static getSizePrefixedRootAsRefreshComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RefreshComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  refreshRuleType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_refresh_rule_js_1.UnionRefreshRule.NONE
  }
  refreshRule(e) {
  ...
  static createRefreshComponent(e, t, s, r, n) {
    return RefreshComponent.startRefreshComponent(e), RefreshComponent.addDisabled(e, t), RefreshComponent.addRefreshRuleType(e, s), RefreshComponent.addRefreshRule(e, r), RefreshComponent.addIsDisableRefreshAfterDroppingReward(e, n), RefreshComponent.endRefreshComponent(e)
  }
}
