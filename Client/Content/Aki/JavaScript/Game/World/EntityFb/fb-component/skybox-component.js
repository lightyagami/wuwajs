...
class SkyboxComponent {
  ...
  static getSizePrefixedRootAsSkyboxComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SkyboxComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  triggerModeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_trigger_mode_js_1.UnionTriggerMode.NONE
  }
  triggerMode(t) {
