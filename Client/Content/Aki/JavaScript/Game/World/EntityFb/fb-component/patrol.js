...
class Patrol {
  ...
  static getRootAsPatrol(t, s) {
    return (s || new Patrol).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsPatrol(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new Patrol).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  actions(t, s) {
    ...
    return r ? (s || new patrol_action_js_1.PatrolAction).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createPatrol(t, s, r, i, a) {
    return Patrol.startPatrol(t), Patrol.addDisabled(t, s), Patrol.addSplineEntityId(t, r), Patrol.addIsCircle(t, i), Patrol.addActions(t, a), Patrol.endPatrol(t)
  }
}
