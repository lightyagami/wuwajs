...
exports.Patrol = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const patrol_action_js_1 = require("../fb-component/patrol-action.js");
class Patrol {
  constructor() {
    this.bb = undefined;
    this.bb_pos = 0;
  ...
  actions(t, s) {
    ...
    if (r) {
      return (s || new patrol_action_js_1.PatrolAction()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
