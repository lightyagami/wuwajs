...
class TeleControl2 {
  ...
  static getSizePrefixedRootAsTeleControl2(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleControl2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  baseCfg(t) {
    ...
    return e ? (t || new tele_control_base_cfg_js_1.TeleControlBaseCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  searchTargetCfg(t) {
    var e = this.bb.__offset(this.bb_pos, 8);
    return e ? (t || new search_target_cfg_js_1.SearchTargetCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  bulletCfg(t) {
    var e = this.bb.__offset(this.bb_pos, 10);
    return e ? (t || new bullet_cfg_js_1.BulletCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  destroyCfg(t) {
    var e = this.bb.__offset(this.bb_pos, 12);
    return e ? (t || new destroy_cfg_js_1.DestroyCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  holdCfg(t) {
    var e = this.bb.__offset(this.bb_pos, 14);
    return e ? (t || new hold_cfg_js_1.HoldCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  throwCfg(t) {
    var e = this.bb.__offset(this.bb_pos, 16);
    return e ? (t || new throw_cfg_js_1.ThrowCfg).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
