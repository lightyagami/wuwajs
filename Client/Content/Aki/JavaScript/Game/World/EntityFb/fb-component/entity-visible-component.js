...
exports.EntityVisibleComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const visible_condition_group_js_1 = require("../fb-component/visible-condition-group.js");
class EntityVisibleComponent {
  ...
  visibleConditions(t, i) {
    ...
    if (s) {
      return (i || new visible_condition_group_js_1.VisibleConditionGroup()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createEntityVisibleComponent(t, i, s, e, n, o, r, a) {
    ...
    return EntityVisibleComponent.endEntityVisibleComponent(t);
  }
}
