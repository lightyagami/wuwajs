...
class EntityVisibleComponent {
  ...
  static getRootAsEntityVisibleComponent(t, i) {
    return (i || new EntityVisibleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEntityVisibleComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityVisibleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  visibleConditions(t, i) {
    ...
    return s ? (i || new visible_condition_group_js_1.VisibleConditionGroup).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  static createEntityVisibleComponent(t, i, s, e, n, o, r, a) {
    return EntityVisibleComponent.startEntityVisibleComponent(t), EntityVisibleComponent.addDisabled(t, i), EntityVisibleComponent.addDelayChange(t, s), EntityVisibleComponent.addUseFadeEffect(t, e), EntityVisibleComponent.addUseCutEffect(t, n), EntityVisibleComponent.addUseHolographicEffect(t, o), EntityVisibleComponent.addVisibleConditions(t, r), EntityVisibleComponent.addCustomVisibleRange(t, a), EntityVisibleComponent.endEntityVisibleComponent(t)
  }
}
