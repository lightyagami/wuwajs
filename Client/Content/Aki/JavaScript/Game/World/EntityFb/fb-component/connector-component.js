...
class ConnectorComponent {
  ...
  static getSizePrefixedRootAsConnectorComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ConnectorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  logicTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_connector_logic_js_1.UnionConnectorLogic.NONE
  }
  logicType(t) {
  ...
  static createConnectorComponent(t, o, n, e) {
    return ConnectorComponent.startConnectorComponent(t), ConnectorComponent.addDisabled(t, o), ConnectorComponent.addLogicTypeType(t, n), ConnectorComponent.addLogicType(t, e), ConnectorComponent.endConnectorComponent(t)
  }
}
