...
class SequenceBatchRefresh {
  ...
  static getSizePrefixedRootAsSequenceBatchRefresh(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SequenceBatchRefresh).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSequenceBatchRefresh(t, e, s, h, r) {
    return SequenceBatchRefresh.startSequenceBatchRefresh(t), SequenceBatchRefresh.addType(t, e), SequenceBatchRefresh.addEntityBatchesType(t, s), SequenceBatchRefresh.addEntityBatches(t, h), SequenceBatchRefresh.addIsRestartAfterAllBatchesFinished(t, r), SequenceBatchRefresh.endSequenceBatchRefresh(t)
  }
}
