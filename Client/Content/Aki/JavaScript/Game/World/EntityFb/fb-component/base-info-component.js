...
class BaseInfoComponent {
  ...
  static getSizePrefixedRootAsBaseInfoComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new BaseInfoComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  category(t) {
    ...
    return i ? (t || new entity_category_js_1.EntityCategory).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  scanFunction(t) {
    var i = this.bb.__offset(this.bb_pos, 12);
    return i ? (t || new entity_scan_function_js_1.EntityScanFunction).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  headInfo() {
  ...
  customAoiZRadius(t) {
    ...
    return i ? (t || new custom_aoiz_radius_js_1.CustomAoizRadius).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  mapIcon() {
  ...
  headStateViewConfig(t) {
    ...
    return i ? (t || new head_state_view_config_js_1.HeadStateViewConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  entityPropertyId() {
  ...
  specifiedOnlineStandaloneParentUids(t, i) {
    ...
    return s ? this.bb.__string(this.bb.__vector(this.bb_pos + s) + 4 * t, i) : void 0
  }
  ...
  fixProcessor(t) {
    ...
    return i ? (t || new fix_processor_js_1.FixProcessor).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  gravityConfig(t) {
    ...
    return i ? (t || new entity_gravity_config_js_1.EntityGravityConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  headInfoChangeConfig(t, i) {
    var s = this.bb.__offset(this.bb_pos, 60);
    return s ? (i || new head_info_change_data_js_1.HeadInfoChangeData).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
