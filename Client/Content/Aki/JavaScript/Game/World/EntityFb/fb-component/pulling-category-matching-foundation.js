...
class PullingCategoryMatchingFoundation {
  ...
  static getSizePrefixedRootAsPullingCategoryMatchingFoundation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PullingCategoryMatchingFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  matchingConfigs(t, i) {
    ...
    return n ? (i || new category_matching_config_base_js_1.CategoryMatchingConfigBase).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  ...
  static createPullingCategoryMatchingFoundation(t, i, n, a) {
    return PullingCategoryMatchingFoundation.startPullingCategoryMatchingFoundation(t), PullingCategoryMatchingFoundation.addType(t, i), PullingCategoryMatchingFoundation.addInitMatchEntity(t, n), PullingCategoryMatchingFoundation.addMatchingConfigs(t, a), PullingCategoryMatchingFoundation.endPullingCategoryMatchingFoundation(t)
  }
}
