...
class HackManagementComponent {
  ...
  static getSizePrefixedRootAsHackManagementComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HackManagementComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createHackManagementComponent(t, e, n, a) {
    return HackManagementComponent.startHackManagementComponent(t), HackManagementComponent.addDisabled(t, e), HackManagementComponent.addMaxHackingCount(t, n), HackManagementComponent.addValidDistance(t, a), HackManagementComponent.endHackManagementComponent(t)
  }
}
