...
class DestroyStageConfig {
  ...
  static getSizePrefixedRootAsDestroyStageConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DestroyStageConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  performDuration() {
  ...
  static createDestroyStageConfig(t, e, i, s) {
    return DestroyStageConfig.startDestroyStageConfig(t), DestroyStageConfig.addPerformDuration(t, e), DestroyStageConfig.addBulletId(t, i), DestroyStageConfig.addActions(t, s), DestroyStageConfig.endDestroyStageConfig(t)
  }
}
