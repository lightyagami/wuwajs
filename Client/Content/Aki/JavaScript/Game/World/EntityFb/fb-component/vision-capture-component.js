...
class VisionCaptureComponent {
  ...
  static getSizePrefixedRootAsVisionCaptureComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new VisionCaptureComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createVisionCaptureComponent(t, i, e, s) {
    return VisionCaptureComponent.startVisionCaptureComponent(t), VisionCaptureComponent.addDisabled(t, i), VisionCaptureComponent.addVisionCaptureId(t, e), VisionCaptureComponent.addVisionCaptureProb(t, s), VisionCaptureComponent.endVisionCaptureComponent(t)
  }
}
