...
class FixedFill {
  ...
  static getSizePrefixedRootAsFixedFill(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FixedFill).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  centre(i) {
    ...
    return t ? (i || new piece_index_js_1.PieceIndex).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  config(i) {
    var t = this.bb.__offset(this.bb_pos, 10);
    return t ? (i || new jigsaw_config_js_1.JigsawConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
