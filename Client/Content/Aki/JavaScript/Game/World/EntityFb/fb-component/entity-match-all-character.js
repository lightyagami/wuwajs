...
class EntityMatchAllCharacter {
  ...
  static getSizePrefixedRootAsEntityMatchAllCharacter(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new EntityMatchAllCharacter).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createEntityMatchAllCharacter(t, a) {
    return EntityMatchAllCharacter.startEntityMatchAllCharacter(t), EntityMatchAllCharacter.addType(t, a), EntityMatchAllCharacter.endEntityMatchAllCharacter(t)
  }
}
