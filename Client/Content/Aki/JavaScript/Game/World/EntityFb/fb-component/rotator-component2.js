...
class RotatorComponent2 {
  ...
  static getSizePrefixedRootAsRotatorComponent2(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new RotatorComponent2).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  config(t, o) {
    ...
    return e ? (o || new state_rotation_config_js_1.StateRotationConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  configLength() {
  ...
  static createRotatorComponent2(t, o, e) {
    return RotatorComponent2.startRotatorComponent2(t), RotatorComponent2.addDisabled(t, o), RotatorComponent2.addConfig(t, e), RotatorComponent2.endRotatorComponent2(t)
  }
}
