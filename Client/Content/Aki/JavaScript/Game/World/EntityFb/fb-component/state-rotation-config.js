...
class StateRotationConfig {
  ...
  static getSizePrefixedRootAsStateRotationConfig(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new StateRotationConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  rotationConfig(t, o) {
    ...
    return i ? (o || new rotation_config_js_1.RotationConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  keyRotatorConfig(t, o) {
    ...
    return i ? (o || new key_rotator_config_js_1.KeyRotatorConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  static createStateRotationConfig(t, o, i, a, e, n, s) {
    return StateRotationConfig.startStateRotationConfig(t), StateRotationConfig.addState(t, o), StateRotationConfig.addIsLoop(t, i), StateRotationConfig.addRotatePoint(t, a), StateRotationConfig.addRotationConfig(t, e), StateRotationConfig.addKeyRotatorConfig(t, n), StateRotationConfig.addKeepLastRotation(t, s), StateRotationConfig.endStateRotationConfig(t)
  }
}
