...
class NpcUiInteractOnChengXiaoShanShop {
  ...
  static getRootAsNpcUiInteractOnChengXiaoShanShop(t, i) {
    return (i || new NpcUiInteractOnChengXiaoShanShop).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsNpcUiInteractOnChengXiaoShanShop(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new NpcUiInteractOnChengXiaoShanShop).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
