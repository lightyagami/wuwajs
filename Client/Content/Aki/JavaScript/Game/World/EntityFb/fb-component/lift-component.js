...
class LiftComponent {
  ...
  static getSizePrefixedRootAsLiftComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LiftComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  stayPositions(t, i) {
    ...
    return s ? (i || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  stayPositionsLength() {
  ...
  autoConfig(t) {
    ...
    return i ? (t || new auto_config_js_1.AutoConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  maxSpeed() {
