...
class CombinedVisibleGroupComponent {
  ...
  static getSizePrefixedRootAsCombinedVisibleGroupComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CombinedVisibleGroupComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
