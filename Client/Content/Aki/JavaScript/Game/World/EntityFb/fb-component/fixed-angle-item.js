...
class FixedAngleItem {
  ...
  static getSizePrefixedRootAsFixedAngleItem(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FixedAngleItem).__init(e.readInt32(e.position()) + e.position(), e)
  }
  initAngle() {
  ...
  static createFixedAngleItem(e, t, i, s) {
    return FixedAngleItem.startFixedAngleItem(e), FixedAngleItem.addInitAngle(e, t), FixedAngleItem.addTargetAngle(e, i), FixedAngleItem.addRotateAngle(e, s), FixedAngleItem.endFixedAngleItem(e)
  }
}
