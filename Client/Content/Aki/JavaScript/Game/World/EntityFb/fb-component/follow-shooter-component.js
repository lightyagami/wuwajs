...
class FollowShooterComponent {
  ...
  static getSizePrefixedRootAsFollowShooterComponent(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new FollowShooterComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  lockableCategories(t, o) {
    ...
    return e ? (o || new entity_category_js_1.EntityCategory).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  ...
  static createFollowShooterComponent(t, o, e, r) {
    return FollowShooterComponent.startFollowShooterComponent(t), FollowShooterComponent.addDisabled(t, o), FollowShooterComponent.addConfig(t, e), FollowShooterComponent.addLockableCategories(t, r), FollowShooterComponent.endFollowShooterComponent(t)
  }
}
