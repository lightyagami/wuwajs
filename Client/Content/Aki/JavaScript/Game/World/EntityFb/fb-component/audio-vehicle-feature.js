...
class AudioVehicleFeature {
  ...
  static getSizePrefixedRootAsAudioVehicleFeature(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AudioVehicleFeature).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  audioConfigs(e) {
    ...
    return t ? (e || new vehicle_audio_config_js_1.VehicleAudioConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
