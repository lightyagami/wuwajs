...
class CustomViewDistance {
  ...
  static getSizePrefixedRootAsCustomViewDistance(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new CustomViewDistance).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createCustomViewDistance(t, s, e) {
    return CustomViewDistance.startCustomViewDistance(t), CustomViewDistance.addType(t, s), CustomViewDistance.addDistance(t, e), CustomViewDistance.endCustomViewDistance(t)
  }
}
