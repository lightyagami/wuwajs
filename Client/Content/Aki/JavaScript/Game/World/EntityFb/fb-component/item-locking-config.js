...
class ItemLockingConfig {
  ...
  static getSizePrefixedRootAsItemLockingConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ItemLockingConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effectPath(t) {
  ...
  static createItemLockingConfig(t, i, e) {
    return ItemLockingConfig.startItemLockingConfig(t), ItemLockingConfig.addEffectPath(t, i), ItemLockingConfig.addTeleControlPerform(t, e), ItemLockingConfig.endItemLockingConfig(t)
  }
}
