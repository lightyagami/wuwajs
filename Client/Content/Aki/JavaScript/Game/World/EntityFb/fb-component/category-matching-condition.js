...
class CategoryMatchingCondition {
  ...
  static getSizePrefixedRootAsCategoryMatchingCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CategoryMatchingCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityMatch(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new dynamic_entity_match_js_1.DynamicEntityMatch).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  selfState(t) {
  ...
  static createCategoryMatchingCondition(t, i, n) {
    return CategoryMatchingCondition.startCategoryMatchingCondition(t), CategoryMatchingCondition.addEntityMatch(t, i), CategoryMatchingCondition.addSelfState(t, n), CategoryMatchingCondition.endCategoryMatchingCondition(t)
  }
}
