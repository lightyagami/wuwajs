...
class EntityMatch {
  ...
  static getSizePrefixedRootAsEntityMatch(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityMatch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  allCharacter() {
  ...
  categories(t, e) {
    ...
    return s ? (e || new entity_category_js_1.EntityCategory).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  categoriesLength() {
  ...
  states(t, e) {
    ...
    return s ? (e || new entity_state_js_1.EntityState).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  statesLength() {
  ...
  static createEntityMatch(t, e, s, i, r, a) {
    return EntityMatch.startEntityMatch(t), EntityMatch.addAllCharacter(t, e), EntityMatch.addOnlyPlayer(t, s), EntityMatch.addCategories(t, i), EntityMatch.addStates(t, r), EntityMatch.addPerformanceStates(t, a), EntityMatch.endEntityMatch(t)
  }
}
