...
class RagDollClimbingPoint {
  ...
  static getSizePrefixedRootAsRagDollClimbingPoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RagDollClimbingPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRagDollClimbingPoint(t, i, s, o, n, r) {
    return RagDollClimbingPoint.startRagDollClimbingPoint(t), RagDollClimbingPoint.addType(t, i), RagDollClimbingPoint.addHookActions(t, s), RagDollClimbingPoint.addExitHookActions(t, o), RagDollClimbingPoint.addFinishActions(t, n), RagDollClimbingPoint.addIsSummitPoint(t, r), RagDollClimbingPoint.endRagDollClimbingPoint(t)
  }
}
