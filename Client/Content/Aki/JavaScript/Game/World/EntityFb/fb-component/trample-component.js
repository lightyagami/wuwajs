...
exports.TrampleComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const action_info_js_1 = require("../fb-action/action-info.js");
const enter_leave_radius_js_1 = require("../fb-common/enter-leave-radius.js");
...
class TrampleComponent {
  ...
  showLandTipRadius(t) {
    ...
    if (i) {
      return (t || new enter_leave_radius_js_1.EnterLeaveRadius()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
