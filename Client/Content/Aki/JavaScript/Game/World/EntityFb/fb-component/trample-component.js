...
class TrampleComponent {
  ...
  static getRootAsTrampleComponent(t, i) {
    return (i || new TrampleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsTrampleComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TrampleComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  match(t) {
    ...
    return i ? (t || new entity_match_js_1.EntityMatch).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  matchRoleOption(t, i) {
    ...
    return s ? this.bb.__union(i, this.bb.__vector(this.bb_pos + s) + 4 * t) : void 0
  }
  ...
  showLandTipRadius(t) {
    ...
    return i ? (t || new enter_leave_radius_js_1.EnterLeaveRadius).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  stopTeleControlMove() {
