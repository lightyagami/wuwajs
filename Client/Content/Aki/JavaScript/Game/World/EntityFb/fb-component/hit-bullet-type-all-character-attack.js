...
class HitBulletTypeAllCharacterAttack {
  ...
  static getSizePrefixedRootAsHitBulletTypeAllCharacterAttack(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitBulletTypeAllCharacterAttack).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitBulletTypeAllCharacterAttack(t, e) {
    return HitBulletTypeAllCharacterAttack.startHitBulletTypeAllCharacterAttack(t), HitBulletTypeAllCharacterAttack.addType(t, e), HitBulletTypeAllCharacterAttack.endHitBulletTypeAllCharacterAttack(t)
  }
}
