...
class HookLockPoint {
  ...
  static getSizePrefixedRootAsHookLockPoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HookLockPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  range(t) {
    ...
    return i ? (t || new sphere_trigger_shape_js_1.SphereTriggerShape).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  cameraGaze(t) {
    ...
    return i ? (t || new camera_gaze_js_1.CameraGaze).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  gazeNextPointAfterInteract(t) {
    var i = this.bb.__offset(this.bb_pos, 18);
    return i ? (t || new gaze_next_point_after_interact_js_1.GazeNextPointAfterInteract).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  inheritSpeed() {
  ...
  hookInteractConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_hook_interact_config_js_1.UnionHookInteractConfig.NONE
  }
