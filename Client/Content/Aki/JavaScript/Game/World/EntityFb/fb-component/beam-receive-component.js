...
class BeamReceiveComponent {
  ...
  static getSizePrefixedRootAsBeamReceiveComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BeamReceiveComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createBeamReceiveComponent(t, e, i, s, o, n) {
    return BeamReceiveComponent.startBeamReceiveComponent(t), BeamReceiveComponent.addDisabled(t, e), BeamReceiveComponent.addDuration(t, i), BeamReceiveComponent.addBeginActions(t, s), BeamReceiveComponent.addCompleteActions(t, o), BeamReceiveComponent.addStopActions(t, n), BeamReceiveComponent.endBeamReceiveComponent(t)
  }
}
