...
class ChessmanPickInteraction {
  ...
  static getSizePrefixedRootAsChessmanPickInteraction(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ChessmanPickInteraction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  checkedActions(t, s) {
    ...
    return i ? (s || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  static createChessmanPickInteraction(t, s, i, e, n, c) {
    return ChessmanPickInteraction.startChessmanPickInteraction(t), ChessmanPickInteraction.addType(t, s), ChessmanPickInteraction.addCheckedActions(t, i), ChessmanPickInteraction.addUncheckedActions(t, e), ChessmanPickInteraction.addTargetChessboard(t, n), ChessmanPickInteraction.addAvailablePosEffect(t, c), ChessmanPickInteraction.endChessmanPickInteraction(t)
  }
}
