...
class SceneItemPatrol {
  ...
  static getSizePrefixedRootAsSceneItemPatrol(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SceneItemPatrol).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  patrolTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_scene_item_ai_patrol_type_js_1.UnionSceneItemAiPatrolType.NONE
  }
  patrolType(t) {
