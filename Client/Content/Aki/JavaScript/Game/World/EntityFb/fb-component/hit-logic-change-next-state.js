...
class HitLogicChangeNextState {
  ...
  static getSizePrefixedRootAsHitLogicChangeNextState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitLogicChangeNextState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitLogicChangeNextState(t, e) {
    return HitLogicChangeNextState.startHitLogicChangeNextState(t), HitLogicChangeNextState.addType(t, e), HitLogicChangeNextState.endHitLogicChangeNextState(t)
  }
}
