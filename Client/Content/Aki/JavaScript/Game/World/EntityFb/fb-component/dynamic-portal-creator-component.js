...
class DynamicPortalCreatorComponent {
  ...
  static getSizePrefixedRootAsDynamicPortalCreatorComponent(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new DynamicPortalCreatorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  modelType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_dynamic_portal_create_js_1.UnionDynamicPortalCreate.NONE
  }
  model(t) {
  ...
  static createDynamicPortalCreatorComponent(t, r, o, e) {
    return DynamicPortalCreatorComponent.startDynamicPortalCreatorComponent(t), DynamicPortalCreatorComponent.addDisabled(t, r), DynamicPortalCreatorComponent.addModelType(t, o), DynamicPortalCreatorComponent.addModel(t, e), DynamicPortalCreatorComponent.endDynamicPortalCreatorComponent(t)
  }
}
