...
class DynamicBulletConfig {
  ...
  static getSizePrefixedRootAsDynamicBulletConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DynamicBulletConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  bulletId() {
  ...
  static createDynamicBulletConfig(t, i, e, l) {
    return DynamicBulletConfig.startDynamicBulletConfig(t), DynamicBulletConfig.addBulletId(t, i), DynamicBulletConfig.addPortalModel(t, e), DynamicBulletConfig.addTemplateId(t, l), DynamicBulletConfig.endDynamicBulletConfig(t)
  }
}
