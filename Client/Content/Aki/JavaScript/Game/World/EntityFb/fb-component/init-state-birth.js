...
class InitStateBirth {
  ...
  static getSizePrefixedRootAsInitStateBirth(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InitStateBirth).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createInitStateBirth(t, i, e) {
    return InitStateBirth.startInitStateBirth(t), InitStateBirth.addType(t, i), InitStateBirth.addBirthTag(t, e), InitStateBirth.endInitStateBirth(t)
  }
}
