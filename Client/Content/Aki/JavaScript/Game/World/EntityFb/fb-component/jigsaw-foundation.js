...
class JigsawFoundation {
  ...
  static getSizePrefixedRootAsJigsawFoundation(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new JigsawFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  initMatchList(t, i) {
    ...
    return s ? (i || new jigsaw_piece_match_js_1.JigsawPieceMatch).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  initMatchListLength() {
  ...
  completeConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_jigsaw_complete_condition_js_1.UnionJigsawCompleteCondition.NONE
  }
  completeCondition(t) {
  ...
  completedConfig(t) {
    ...
    return i ? (t || new jigsaw_completed_config_js_1.JigsawCompletedConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  jigsawConfig(t) {
    var i = this.bb.__offset(this.bb_pos, 18);
    return i ? (t || new jigsaw_config_js_1.JigsawConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  matchedConfig(t, i) {
    var s = this.bb.__offset(this.bb_pos, 20);
    return s ? (i || new jigsaw_item_matched_config_js_1.JigsawItemMatchedConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  matchedConfigLength() {
