...
class PasserbyNpcFixIntervalSpawn {
  ...
  static getSizePrefixedRootAsPasserbyNpcFixIntervalSpawn(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new PasserbyNpcFixIntervalSpawn).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPasserbyNpcFixIntervalSpawn(t, s, a, e, r) {
    return PasserbyNpcFixIntervalSpawn.startPasserbyNpcFixIntervalSpawn(t), PasserbyNpcFixIntervalSpawn.addType(t, s), PasserbyNpcFixIntervalSpawn.addMaxSpawnCount(t, a), PasserbyNpcFixIntervalSpawn.addMinDistance(t, e), PasserbyNpcFixIntervalSpawn.addInterval(t, r), PasserbyNpcFixIntervalSpawn.endPasserbyNpcFixIntervalSpawn(t)
  }
}
