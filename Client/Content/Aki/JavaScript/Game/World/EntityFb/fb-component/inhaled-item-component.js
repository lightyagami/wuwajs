...
class InhaledItemComponent {
  ...
  static getSizePrefixedRootAsInhaledItemComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new InhaledItemComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  inhaledPerformance(e) {
    ...
    return t ? (e || new inhaled_performance_js_1.InhaledPerformance).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  inhaledPerResultType() {
    var e = this.bb.__offset(this.bb_pos, 12);
    return e ? this.bb.readUint8(this.bb_pos + e) : union_inhaled_per_result_type_js_1.UnionInhaledPerResultType.NONE
  }
  inhaledPerResult(e) {
