...
class InhaledDestroySelf {
  ...
  static getSizePrefixedRootAsInhaledDestroySelf(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new InhaledDestroySelf).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createInhaledDestroySelf(e, t) {
    return InhaledDestroySelf.startInhaledDestroySelf(e), InhaledDestroySelf.addType(e, t), InhaledDestroySelf.endInhaledDestroySelf(e)
  }
}
