...
class EntityPackageComponent {
  ...
  static getSizePrefixedRootAsEntityPackageComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityPackageComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  packageData(t) {
    ...
    return e ? (t || new entity_package_data_js_1.EntityPackageData).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
