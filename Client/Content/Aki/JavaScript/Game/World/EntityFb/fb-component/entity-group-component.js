...
class EntityGroupComponent {
  ...
  static getSizePrefixedRootAsEntityGroupComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityGroupComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  stateTriggers(t, i) {
    ...
    return s ? (i || new entity_state_trigger_js_1.EntityStateTrigger).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  stateTriggersLength() {
  ...
  finishState(t) {
    ...
    return i ? (t || new finish_state_trigger_js_1.FinishStateTrigger).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  failureState(t) {
    var i = this.bb.__offset(this.bb_pos, 12);
    return i ? (t || new failure_state_trigger_js_1.FailureStateTrigger).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
