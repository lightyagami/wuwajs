...
class RenderFlowerBridge {
  ...
  static getSizePrefixedRootAsRenderFlowerBridge(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RenderFlowerBridge).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  centerTargetType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_target_entity_js_1.UnionTargetEntity.NONE
  }
  centerTarget(e) {
  ...
  static createRenderFlowerBridge(e, t, r, i, s, d) {
    return RenderFlowerBridge.startRenderFlowerBridge(e), RenderFlowerBridge.addType(e, t), RenderFlowerBridge.addRadius(e, r), RenderFlowerBridge.addCenterTargetType(e, i), RenderFlowerBridge.addCenterTarget(e, s), RenderFlowerBridge.addAkEvent(e, d), RenderFlowerBridge.endRenderFlowerBridge(e)
  }
}
