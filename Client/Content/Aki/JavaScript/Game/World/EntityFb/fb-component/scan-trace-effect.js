...
class ScanTraceEffect {
  ...
  static getSizePrefixedRootAsScanTraceEffect(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ScanTraceEffect).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effect(t) {
  ...
  static createScanTraceEffect(t, e, c) {
    return ScanTraceEffect.startScanTraceEffect(t), ScanTraceEffect.addEffect(t, e), ScanTraceEffect.addTarget(t, c), ScanTraceEffect.endScanTraceEffect(t)
  }
}
