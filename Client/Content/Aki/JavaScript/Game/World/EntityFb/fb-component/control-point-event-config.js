...
exports.ControlPointEventConfig = undefined;
...
class ControlPointEventConfig {
  ...
  leftInEventActions(t, n) {
    ...
    if (i) {
      return (n || new action_info_js_1.ActionInfo()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createControlPointEventConfig(t, n, i, o, e, s) {
    ...
    return ControlPointEventConfig.endControlPointEventConfig(t);
  }
}
