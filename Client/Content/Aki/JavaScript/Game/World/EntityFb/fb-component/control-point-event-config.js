...
class ControlPointEventConfig {
  ...
  static getRootAsControlPointEventConfig(t, n) {
    return (n || new ControlPointEventConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsControlPointEventConfig(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new ControlPointEventConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  index() {
  ...
  leftInEventActions(t, n) {
    ...
    return i ? (n || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  ...
  static createControlPointEventConfig(t, n, i, o, e, s) {
    return ControlPointEventConfig.startControlPointEventConfig(t), ControlPointEventConfig.addIndex(t, n), ControlPointEventConfig.addLeftInEventActions(t, i), ControlPointEventConfig.addLeftOutEventActions(t, o), ControlPointEventConfig.addRightInEventActions(t, e), ControlPointEventConfig.addRightOutEventActions(t, s), ControlPointEventConfig.endControlPointEventConfig(t)
  }
}
