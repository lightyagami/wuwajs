...
class BattleVehicleFeature {
  ...
  static getSizePrefixedRootAsBattleVehicleFeature(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new BattleVehicleFeature).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createBattleVehicleFeature(e, t) {
    return BattleVehicleFeature.startBattleVehicleFeature(e), BattleVehicleFeature.addType(e, t), BattleVehicleFeature.endBattleVehicleFeature(e)
  }
}
