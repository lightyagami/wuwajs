...
class HitBulletTypePlayerAttack {
  ...
  static getSizePrefixedRootAsHitBulletTypePlayerAttack(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new HitBulletTypePlayerAttack).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createHitBulletTypePlayerAttack(t, e) {
    return HitBulletTypePlayerAttack.startHitBulletTypePlayerAttack(t), HitBulletTypePlayerAttack.addType(t, e), HitBulletTypePlayerAttack.endHitBulletTypePlayerAttack(t)
  }
}
