...
exports.ItemFoundation = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const adsort_transform_js_1 = require("../fb-component/adsort-transform.js");
const entity_match_js_1 = require("../fb-component/entity-match.js");
const item_change_adsorbate_state_js_1 = require("../fb-component/item-change-adsorbate-state.js");
class ItemFoundation {
  ...
  static getRootAsItemFoundation(t, s) {
    return (s || new ItemFoundation()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  ...
  adsorptionPoint(t) {
    ...
    if (s) {
      return (t || new adsort_transform_js_1.AdsortTransform()).__init(this.bb.__indirect(this.bb_pos + s), this.bb);
    } else {
      return undefined;
    }
  }
  adsorptionMatch(t) {
    ...
    if (s) {
      return (t || new entity_match_js_1.EntityMatch()).__init(this.bb.__indirect(this.bb_pos + s), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  changeAdsorbateState(t) {
    ...
    if (s) {
      return (t || new item_change_adsorbate_state_js_1.ItemChangeAdsorbateState()).__init(this.bb.__indirect(this.bb_pos + s), this.bb);
    } else {
      return undefined;
    }
  }
