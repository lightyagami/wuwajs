...
class ItemFoundation {
  ...
  static getSizePrefixedRootAsItemFoundation(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new ItemFoundation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  adsorptionPoint(t) {
    ...
    return s ? (t || new adsort_transform_js_1.AdsortTransform).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  adsorptionMatch(t) {
    var s = this.bb.__offset(this.bb_pos, 8);
    return s ? (t || new entity_match_js_1.EntityMatch).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
  activeMatch(t) {
  ...
  changeAdsorbateState(t) {
    ...
    return s ? (t || new item_change_adsorbate_state_js_1.ItemChangeAdsorbateState).__init(this.bb.__indirect(this.bb_pos + s), this.bb) : void 0
  }
