...
exports.unionListToUnionHookInteractConfig = exports.unionToUnionHookInteractConfig = exports.UnionHookInteractConfig = undefined;
const charge_slash_hook_js_1 = require("../fb-component/charge-slash-hook.js");
const fixed_point_hook_js_1 = require("../fb-component/fixed-point-hook.js");
const kite_hook_js_1 = require("../fb-component/kite-hook.js");
const movement_point_hook_js_1 = require("../fb-component/movement-point-hook.js");
const rag_doll_climbing_point_js_1 = require("../fb-component/rag-doll-climbing-point.js");
const rag_doll_jumping_point_js_1 = require("../fb-component/rag-doll-jumping-point.js");
const slash_hook_js_1 = require("../fb-component/slash-hook.js");
const sui_guang_hook_js_1 = require("../fb-component/sui-guang-hook.js");
...
})(UnionHookInteractConfig = exports.UnionHookInteractConfig ||= {});
exports.unionToUnionHookInteractConfig = unionToUnionHookInteractConfig;
exports.unionListToUnionHookInteractConfig = unionListToUnionHookInteractConfig; //# sourceMappingURL=union-hook-interact-config.js.map