...
class AttributeComponent {
  ...
  static getSizePrefixedRootAsAttributeComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AttributeComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  fightMusicsType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_fight_musics_switch_type_js_1.UnionFightMusicsSwitchType.NONE
  }
  fightMusics(t) {
  ...
  worldLevelBonusTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_world_level_bonus_js_1.UnionWorldLevelBonus.NONE
  }
  ...
  static createAttributeComponent(t, e, i, s, r, n, o, u, h, d, a, p, c, l, b, _) {
    return AttributeComponent.startAttributeComponent(t), AttributeComponent.addDisabled(t, e), AttributeComponent.addPropertyId(t, i), AttributeComponent.addMonsterPropExtraRateId(t, s), AttributeComponent.addMonsterPropGrowthId(t, r), AttributeComponent.addLevel(t, n), AttributeComponent.addMoraleLevel(t, o), AttributeComponent.addRageModeId(t, u), AttributeComponent.addHardnessModeId(t, h), AttributeComponent.addWorldLevelBonusId(t, d), AttributeComponent.addFightMusicsType(t, a), AttributeComponent.addFightMusics(t, p), AttributeComponent.addFightMusic(t, c), AttributeComponent.addAppendBuffIds(t, l), AttributeComponent.addWorldLevelBonusTypeType(t, b), AttributeComponent.addWorldLevelBonusType(t, _), AttributeComponent.endAttributeComponent(t)
  }
}
