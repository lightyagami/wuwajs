...
class DirectionFill {
  ...
  static getSizePrefixedRootAsDirectionFill(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DirectionFill).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createDirectionFill(i, t, r, s, e, l) {
    return DirectionFill.startDirectionFill(i), DirectionFill.addType(i, t), DirectionFill.addW(i, r), DirectionFill.addS(i, s), DirectionFill.addA(i, e), DirectionFill.addD(i, l), DirectionFill.endDirectionFill(i)
  }
}
