...
class DynamicPortalConfig {
  ...
  static getSizePrefixedRootAsDynamicPortalConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DynamicPortalConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  portalModel(t) {
  ...
  static createDynamicPortalConfig(t, i, a) {
    return DynamicPortalConfig.startDynamicPortalConfig(t), DynamicPortalConfig.addPortalModel(t, i), DynamicPortalConfig.addTemplateId(t, a), DynamicPortalConfig.endDynamicPortalConfig(t)
  }
}
