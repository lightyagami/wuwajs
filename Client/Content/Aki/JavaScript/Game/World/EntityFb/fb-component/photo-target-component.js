...
class PhotoTargetComponent {
  ...
  static getSizePrefixedRootAsPhotoTargetComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PhotoTargetComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  requiredPoints(t, e) {
    ...
    return r ? (e || new vector_info_js_1.VectorInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  targetCapturePromptUiType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_photo_target_capture_ui_js_1.UnionPhotoTargetCaptureUi.NONE
  }
  ...
  static createPhotoTargetComponent(t, e, r, o, i, s) {
    return PhotoTargetComponent.startPhotoTargetComponent(t), PhotoTargetComponent.addDisabled(t, e), PhotoTargetComponent.addRequiredPoints(t, r), PhotoTargetComponent.addTargetCapturePromptUiType(t, o), PhotoTargetComponent.addTargetCapturePromptUi(t, i), PhotoTargetComponent.addRayCastIgnoreEntities(t, s), PhotoTargetComponent.endPhotoTargetComponent(t)
  }
}
