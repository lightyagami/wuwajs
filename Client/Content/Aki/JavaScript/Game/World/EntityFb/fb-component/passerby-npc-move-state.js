...
class PasserbyNpcMoveState {
  ...
  static getSizePrefixedRootAsPasserbyNpcMoveState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PasserbyNpcMoveState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  moveState() {
  ...
  static createPasserbyNpcMoveState(t, e, s, a) {
    return PasserbyNpcMoveState.startPasserbyNpcMoveState(t), PasserbyNpcMoveState.addMoveState(t, e), PasserbyNpcMoveState.addCharPositionState(t, s), PasserbyNpcMoveState.addMoveSpeed(t, a), PasserbyNpcMoveState.endPasserbyNpcMoveState(t)
  }
}
