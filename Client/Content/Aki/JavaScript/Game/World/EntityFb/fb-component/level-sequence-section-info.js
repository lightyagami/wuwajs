...
class LevelSequenceSectionInfo {
  ...
  static getSizePrefixedRootAsLevelSequenceSectionInfo(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new LevelSequenceSectionInfo).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  actionList(e, t) {
    ...
    return i ? (t || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  actionListLength() {
  ...
  static createLevelSequenceSectionInfo(e, t, i, n, s, o) {
    return LevelSequenceSectionInfo.startLevelSequenceSectionInfo(e), LevelSequenceSectionInfo.addType(e, t), LevelSequenceSectionInfo.addKey(e, i), LevelSequenceSectionInfo.addFrameId(e, n), LevelSequenceSectionInfo.addState(e, s), LevelSequenceSectionInfo.addActionList(e, o), LevelSequenceSectionInfo.endLevelSequenceSectionInfo(e)
  }
}
