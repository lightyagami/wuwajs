...
class EntityStateAudioConfig {
  ...
  static getSizePrefixedRootAsEntityStateAudioConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityStateAudioConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  audioFade(t) {
    ...
    return i ? (t || new audio_fade_js_1.AudioFade).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
