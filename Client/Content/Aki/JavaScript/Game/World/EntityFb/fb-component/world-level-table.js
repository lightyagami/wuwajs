...
class WorldLevelTable {
  ...
  static getSizePrefixedRootAsWorldLevelTable(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new WorldLevelTable).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  static createWorldLevelTable(e, t, l) {
    return WorldLevelTable.startWorldLevelTable(e), WorldLevelTable.addType(e, t), WorldLevelTable.addWorldLevelBonusId(e, l), WorldLevelTable.endWorldLevelTable(e)
  }
}
