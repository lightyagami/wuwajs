...
class RenderBookPage {
  ...
  static getSizePrefixedRootAsRenderBookPage(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RenderBookPage).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createRenderBookPage(e, t, r, i, s, a) {
    return RenderBookPage.startRenderBookPage(e), RenderBookPage.addType(e, t), RenderBookPage.addRadius(e, r), RenderBookPage.addCenterTargetType(e, i), RenderBookPage.addCenterTarget(e, s), RenderBookPage.addAkEvent(e, a), RenderBookPage.endRenderBookPage(e)
  }
}
