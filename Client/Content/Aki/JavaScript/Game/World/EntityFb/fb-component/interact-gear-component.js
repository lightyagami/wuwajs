...
class InteractGearComponent {
  ...
  static getSizePrefixedRootAsInteractGearComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new InteractGearComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createInteractGearComponent(t, e, r, a) {
    return InteractGearComponent.startInteractGearComponent(t), InteractGearComponent.addDisabled(t, e), InteractGearComponent.addNormalPrepareTime(t, r), InteractGearComponent.addActivePrepareTime(t, a), InteractGearComponent.endInteractGearComponent(t)
  }
}
