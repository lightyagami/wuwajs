...
class SpawnMonsterComponent {
  ...
  static getSizePrefixedRootAsSpawnMonsterComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new SpawnMonsterComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  activeTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spawn_monster_start_condition_js_1.UnionSpawnMonsterStartCondition.NONE
  }
  activeType(t) {
  ...
  spawnMonsterConfigs(t, n) {
    ...
    return s ? (n || new spawn_monster_config_js_1.SpawnMonsterConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  spawnMonsterConstraintTypeType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spawn_monster_constraint_js_1.UnionSpawnMonsterConstraint.NONE
  }
