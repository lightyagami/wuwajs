...
class SuccessConditionSpecificTargetState {
  ...
  static getSizePrefixedRootAsSuccessConditionSpecificTargetState(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SuccessConditionSpecificTargetState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSuccessConditionSpecificTargetState(t, i, e) {
    return SuccessConditionSpecificTargetState.startSuccessConditionSpecificTargetState(t), SuccessConditionSpecificTargetState.addType(t, i), SuccessConditionSpecificTargetState.addConditions(t, e), SuccessConditionSpecificTargetState.endSuccessConditionSpecificTargetState(t)
  }
}
