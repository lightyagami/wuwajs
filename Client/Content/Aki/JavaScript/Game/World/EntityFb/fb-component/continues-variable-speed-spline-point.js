...
class ContinuesVariableSpeedSplinePoint {
  ...
  static getRootAsContinuesVariableSpeedSplinePoint(t, i) {
    return (i || new ContinuesVariableSpeedSplinePoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsContinuesVariableSpeedSplinePoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ContinuesVariableSpeedSplinePoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  position(t) {
  ...
  intervalTimePathConfig(t) {
    ...
    return i ? (t || new time_path_config_js_1.TimePathConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
