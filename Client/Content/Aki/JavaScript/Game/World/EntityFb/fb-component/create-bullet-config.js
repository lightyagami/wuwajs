...
class CreateBulletConfig {
  ...
  static getSizePrefixedRootAsCreateBulletConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CreateBulletConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  bulletId() {
  ...
  static createCreateBulletConfig(t, e, i) {
    return CreateBulletConfig.startCreateBulletConfig(t), CreateBulletConfig.addBulletId(t, e), CreateBulletConfig.addDelay(t, i), CreateBulletConfig.endCreateBulletConfig(t)
  }
}
