...
class MovementPerformConfig {
  ...
  static getSizePrefixedRootAsMovementPerformConfig(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MovementPerformConfig).__init(e.readInt32(e.position()) + e.position(), e)
  }
  vehicleMontagePlayConfigs(e, t) {
    var o = this.bb.__offset(this.bb_pos, 4);
    return o ? (t || new vehicle_montage_play_config_js_1.VehicleMontagePlayConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + 4 * e), this.bb) : void 0
  }
  ...
  playerSpeedEffectConfigs(e, t) {
    ...
    return o ? (t || new speed_effect_config_js_1.SpeedEffectConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + 4 * e), this.bb) : void 0
  }
  ...
  static createMovementPerformConfig(e, t, o) {
    return MovementPerformConfig.startMovementPerformConfig(e), MovementPerformConfig.addVehicleMontagePlayConfigs(e, t), MovementPerformConfig.addPlayerSpeedEffectConfigs(e, o), MovementPerformConfig.endMovementPerformConfig(e)
  }
}
