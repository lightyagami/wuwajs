...
class MonsterGachaBaseComponent {
  ...
  static getSizePrefixedRootAsMonsterGachaBaseComponent(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new MonsterGachaBaseComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  config(t, s) {
    ...
    return e ? (s || new monster_gacha_slot_js_1.MonsterGachaSlot).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  configLength() {
  ...
  formation(t, s) {
    ...
    return e ? (s || new monster_formation_js_1.MonsterFormation).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  formationLength() {
  ...
  static createMonsterGachaBaseComponent(t, s, e, r, n) {
    return MonsterGachaBaseComponent.startMonsterGachaBaseComponent(t), MonsterGachaBaseComponent.addDisabled(t, s), MonsterGachaBaseComponent.addMonsterEntityIds(t, e), MonsterGachaBaseComponent.addConfig(t, r), MonsterGachaBaseComponent.addFormation(t, n), MonsterGachaBaseComponent.endMonsterGachaBaseComponent(t)
  }
}
