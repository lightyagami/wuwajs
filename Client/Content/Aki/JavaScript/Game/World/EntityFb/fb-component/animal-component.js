...
class AnimalComponent {
  ...
  static getSizePrefixedRootAsAnimalComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AnimalComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  specialAnimalConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_special_animal_config_js_1.UnionSpecialAnimalConfig.NONE
  }
  ...
  static createAnimalComponent(t, i, n, a, e, s, o, l) {
    return AnimalComponent.startAnimalComponent(t), AnimalComponent.addDisabled(t, i), AnimalComponent.addIsStare(t, n), AnimalComponent.addAnimalAttackRange(t, a), AnimalComponent.addMoveRange(t, e), AnimalComponent.addCanKillSelf(t, s), AnimalComponent.addSpecialAnimalConfigType(t, o), AnimalComponent.addSpecialAnimalConfig(t, l), AnimalComponent.endAnimalComponent(t)
  }
}
