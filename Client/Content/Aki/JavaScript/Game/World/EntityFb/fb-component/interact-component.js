...
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers"),
  ...
  interact_point_icon_config_js_1 = require("../fb-component/interact-point-icon-config.js"),
...
class InteractComponent {
  ...
  static getSizePrefixedRootAsInteractComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InteractComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  sectorRange(t) {
    ...
    return i ? (t || new interact_sector_range_js_1.InteractSectorRange).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  sectorRangeFromPlayerToEntityType() {
    var t = this.bb.__offset(this.bb_pos, 16);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_interact_player_diraction_option_js_1.UnionInteractPlayerDiractionOption.NONE
  }
  ...
  options(t, i) {
    ...
    return r ? (i || new interact_option_js_1.InteractOption).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  optionsLength() {
  ...
  randomInteract(t) {
    ...
    return i ? (t || new random_interact_js_1.RandomInteract).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  preFlow(t) {
    ...
    return i ? (t || new play_flow_js_1.PlayFlow).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  tidContent(t) {
  ...
  matchRoleOption(t, i) {
    ...
    return r ? this.bb.__union(i, this.bb.__vector(this.bb_pos + r) + 4 * t) : void 0
  }
  ...
  interactAdditionalInfoType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_interact_additional_info_js_1.UnionInteractAdditionalInfo.NONE
  }
  ...
  pointIconConfig(t) {
    ...
    return i ? (t || new interact_point_icon_config_js_1.InteractPointIconConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
