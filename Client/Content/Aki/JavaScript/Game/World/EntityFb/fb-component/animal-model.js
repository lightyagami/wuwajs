...
class AnimalModel {
  ...
  static getSizePrefixedRootAsAnimalModel(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AnimalModel).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  animalModelType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_animal_model_type_js_1.UnionAnimalModelType.NONE
  }
  animalModel(t) {
  ...
  static createAnimalModel(t, i, e, a, l, s) {
    return AnimalModel.startAnimalModel(t), AnimalModel.addType(t, i), AnimalModel.addBlueprintPath(t, e), AnimalModel.addAnimalModelType(t, a), AnimalModel.addAnimalModel(t, l), AnimalModel.addAbp(t, s), AnimalModel.endAnimalModel(t)
  }
}
