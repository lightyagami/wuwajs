...
class ReboundComponent {
  ...
  static getSizePrefixedRootAsReboundComponent(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new ReboundComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  optionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_rebound_option_js_1.UnionReboundOption.NONE
  }
  option(t) {
  ...
  static createReboundComponent(t, n, o, e, i) {
    return ReboundComponent.startReboundComponent(t), ReboundComponent.addDisabled(t, n), ReboundComponent.addBulletId(t, o), ReboundComponent.addOptionType(t, e), ReboundComponent.addOption(t, i), ReboundComponent.endReboundComponent(t)
  }
}
