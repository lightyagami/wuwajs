...
class StaticEntitiyMatch {
  ...
  static getSizePrefixedRootAsStaticEntitiyMatch(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new StaticEntitiyMatch).__init(t.readInt32(t.position()) + t.position(), t)
  }
  category(t) {
  ...
  static createStaticEntitiyMatch(t, i, a) {
    return StaticEntitiyMatch.startStaticEntitiyMatch(t), StaticEntitiyMatch.addCategory(t, i), StaticEntitiyMatch.addCategoryType(t, a), StaticEntitiyMatch.endStaticEntitiyMatch(t)
  }
}
