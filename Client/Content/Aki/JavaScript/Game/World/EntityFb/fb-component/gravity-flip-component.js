...
class GravityFlipComponent {
  ...
  static getSizePrefixedRootAsGravityFlipComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new GravityFlipComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  config(t, i) {
    ...
    return r ? (i || new gravity_flip_config_js_1.GravityFlipConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  configLength() {
  ...
  static createGravityFlipComponent(t, i, r, e) {
    return GravityFlipComponent.startGravityFlipComponent(t), GravityFlipComponent.addDisabled(t, i), GravityFlipComponent.addConfig(t, r), GravityFlipComponent.addDefaultGravity(t, e), GravityFlipComponent.endGravityFlipComponent(t)
  }
}
