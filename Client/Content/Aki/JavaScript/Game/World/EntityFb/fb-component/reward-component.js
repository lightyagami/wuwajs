...
class RewardComponent {
  ...
  static getSizePrefixedRootAsRewardComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RewardComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  refreshConfig(t) {
    ...
    return e ? (t || new reward_refresh_config_js_1.RewardRefreshConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
