...
class DynamicPortalByBullet {
  ...
  static getSizePrefixedRootAsDynamicPortalByBullet(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DynamicPortalByBullet).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  portalA(t) {
    ...
    return i ? (t || new dynamic_portal_config_js_1.DynamicPortalConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  portalB(t) {
  ...
  renderConfig(t) {
    ...
    return i ? (t || new portal_render_config_js_1.PortalRenderConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  typeA(t) {
    var i = this.bb.__offset(this.bb_pos, 14);
    return i ? (t || new dynamic_bullet_config_js_1.DynamicBulletConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  typeB(t) {
