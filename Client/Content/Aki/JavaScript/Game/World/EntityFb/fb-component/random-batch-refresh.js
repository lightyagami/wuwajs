...
class RandomBatchRefresh {
  ...
  static getRootAsRandomBatchRefresh(t, e) {
    return (e || new RandomBatchRefresh).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsRandomBatchRefresh(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new RandomBatchRefresh).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createRandomBatchRefresh(t, e, s, h) {
    return RandomBatchRefresh.startRandomBatchRefresh(t), RandomBatchRefresh.addType(t, e), RandomBatchRefresh.addEntityBatchesType(t, s), RandomBatchRefresh.addEntityBatches(t, h), RandomBatchRefresh.endRandomBatchRefresh(t)
  }
}
