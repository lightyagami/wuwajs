...
class SequenceTrackControl {
  ...
  static getSizePrefixedRootAsSequenceTrackControl(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SequenceTrackControl).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  controlPoints(t, e) {
    ...
    return r ? (e || new sequence_track_control_point_js_1.SequenceTrackControlPoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  controlPointsLength() {
  ...
  static createSequenceTrackControl(t, e, r, o) {
    return SequenceTrackControl.startSequenceTrackControl(t), SequenceTrackControl.addType(t, e), SequenceTrackControl.addSequence(t, r), SequenceTrackControl.addControlPoints(t, o), SequenceTrackControl.endSequenceTrackControl(t)
  }
}
