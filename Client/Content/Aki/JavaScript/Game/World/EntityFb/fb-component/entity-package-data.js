...
class EntityPackageData {
  ...
  static getSizePrefixedRootAsEntityPackageData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new EntityPackageData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  packagedLevelId() {
  ...
  packageTree(t, a) {
    ...
    return e ? (a || new entity_package_node_js_1.EntityPackageNode).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  packageTreeLength() {
  ...
  static createEntityPackageData(t, a, e, i) {
    return EntityPackageData.startEntityPackageData(t), EntityPackageData.addPackagedLevelId(t, a), EntityPackageData.addPackageEntityId(t, e), EntityPackageData.addPackageTree(t, i), EntityPackageData.endEntityPackageData(t)
  }
}
