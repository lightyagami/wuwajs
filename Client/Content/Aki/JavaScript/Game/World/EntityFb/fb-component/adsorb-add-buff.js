...
class AdsorbAddBuff {
  ...
  static getSizePrefixedRootAsAdsorbAddBuff(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new AdsorbAddBuff).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createAdsorbAddBuff(t, s, d) {
    return AdsorbAddBuff.startAdsorbAddBuff(t), AdsorbAddBuff.addType(t, s), AdsorbAddBuff.addSpeed(t, d), AdsorbAddBuff.endAdsorbAddBuff(t)
  }
}
