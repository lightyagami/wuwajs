...
class ResetSelfPosComponent {
  ...
  static getSizePrefixedRootAsResetSelfPosComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ResetSelfPosComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  static createResetSelfPosComponent(e, t, s, o, i, r) {
    return ResetSelfPosComponent.startResetSelfPosComponent(e), ResetSelfPosComponent.addDisabled(e, t), ResetSelfPosComponent.addResetRadius(e, s), ResetSelfPosComponent.addIsDisableResetPosAfterThrow(e, o), ResetSelfPosComponent.addIsResetPosAfterThrow(e, i), ResetSelfPosComponent.addResetPosDelayTime(e, r), ResetSelfPosComponent.endResetSelfPosComponent(e)
  }
}
