...
class ActiveRenjuPiece {
  ...
  static getSizePrefixedRootAsActiveRenjuPiece(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ActiveRenjuPiece).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  renjuConfig(e, t) {
    ...
    return i ? (t || new renju_config_js_1.RenjuConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  renjuConfigLength() {
  ...
  exitMatchedConfig(e, t) {
    ...
    return i ? (t || new jigsaw_item_matched_config_js_1.JigsawItemMatchedConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  ...
  static createActiveRenjuPiece(e, t, i, s) {
    return ActiveRenjuPiece.startActiveRenjuPiece(e), ActiveRenjuPiece.addType(e, t), ActiveRenjuPiece.addRenjuConfig(e, i), ActiveRenjuPiece.addExitMatchedConfig(e, s), ActiveRenjuPiece.endActiveRenjuPiece(e)
  }
}
