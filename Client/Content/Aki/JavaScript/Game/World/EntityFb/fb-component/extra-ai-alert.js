...
class ExtraAiAlert {
  ...
  static getSizePrefixedRootAsExtraAiAlert(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ExtraAiAlert).__init(t.readInt32(t.position()) + t.position(), t)
  }
  moveAlert() {
  ...
  static createExtraAiAlert(t, r, e) {
    return ExtraAiAlert.startExtraAiAlert(t), ExtraAiAlert.addMoveAlert(t, r), ExtraAiAlert.addStopAlert(t, e), ExtraAiAlert.endExtraAiAlert(t)
  }
}
