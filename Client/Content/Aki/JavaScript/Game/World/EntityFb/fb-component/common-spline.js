...
class CommonSpline {
  ...
  static getSizePrefixedRootAsCommonSpline(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CommonSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, i) {
    ...
    return e ? (i || new common_spline_point_js_1.CommonSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createCommonSpline(t, i, e) {
    return CommonSpline.startCommonSpline(t), CommonSpline.addType(t, i), CommonSpline.addPoints(t, e), CommonSpline.endCommonSpline(t)
  }
}
