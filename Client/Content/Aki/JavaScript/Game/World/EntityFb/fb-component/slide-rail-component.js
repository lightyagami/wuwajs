...
class SlideRailComponent {
  ...
  static getSizePrefixedRootAsSlideRailComponent(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SlideRailComponent).__init(i.readInt32(i.position()) + i.position(), i)
  }
  disabled() {
  ...
  exchangeRailConfigs(i, t) {
    ...
    return e ? (t || new exchange_slide_rail_config_js_1.ExchangeSlideRailConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * i), this.bb) : void 0
  }
  ...
  static createSlideRailComponent(i, t, e, n, s) {
    return SlideRailComponent.startSlideRailComponent(i), SlideRailComponent.addDisabled(i, t), SlideRailComponent.addSlideSpeed(i, e), SlideRailComponent.addRailSplineEntityId(i, n), SlideRailComponent.addExchangeRailConfigs(i, s), SlideRailComponent.endSlideRailComponent(i)
  }
}
