...
class ParkourPointLayerConfig {
  ...
  static getSizePrefixedRootAsParkourPointLayerConfig(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ParkourPointLayerConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  width() {
  ...
  static createParkourPointLayerConfig(t, r, i) {
    return ParkourPointLayerConfig.startParkourPointLayerConfig(t), ParkourPointLayerConfig.addWidth(t, r), ParkourPointLayerConfig.addLength(t, i), ParkourPointLayerConfig.endParkourPointLayerConfig(t)
  }
}
