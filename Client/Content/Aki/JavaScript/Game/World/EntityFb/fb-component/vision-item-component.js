...
class VisionItemComponent {
  ...
  static getSizePrefixedRootAsVisionItemComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VisionItemComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createVisionItemComponent(t, e) {
    return VisionItemComponent.startVisionItemComponent(t), VisionItemComponent.addDisabled(t, e), VisionItemComponent.endVisionItemComponent(t)
  }
}
