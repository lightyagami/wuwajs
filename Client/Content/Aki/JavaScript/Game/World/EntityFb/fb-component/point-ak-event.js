...
class PointAkEvent {
  ...
  static getRootAsPointAkEvent(t, i) {
    return (i || new PointAkEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsPointAkEvent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new PointAkEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPointAkEvent(t, i, s, e, n) {
    return PointAkEvent.startPointAkEvent(t), PointAkEvent.addType(t, i), PointAkEvent.addPointIds(t, s), PointAkEvent.addUseListenerCone(t, e), PointAkEvent.addEnableOcclusion(t, n), PointAkEvent.endPointAkEvent(t)
  }
}
