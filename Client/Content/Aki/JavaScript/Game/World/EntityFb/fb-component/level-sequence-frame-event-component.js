...
class LevelSequenceFrameEventComponent {
  ...
  static getSizePrefixedRootAsLevelSequenceFrameEventComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new LevelSequenceFrameEventComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  forwardSections(e, t) {
    ...
    return n ? (t || new level_sequence_section_info_js_1.LevelSequenceSectionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * e), this.bb) : void 0
  }
  ...
  static createLevelSequenceFrameEventComponent(e, t, n, r) {
    return LevelSequenceFrameEventComponent.startLevelSequenceFrameEventComponent(e), LevelSequenceFrameEventComponent.addDisabled(e, t), LevelSequenceFrameEventComponent.addForwardSections(e, n), LevelSequenceFrameEventComponent.addBackWardSections(e, r), LevelSequenceFrameEventComponent.endLevelSequenceFrameEventComponent(e)
  }
}
