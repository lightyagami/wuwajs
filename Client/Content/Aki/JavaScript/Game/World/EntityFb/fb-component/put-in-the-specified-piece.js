...
class PutInTheSpecifiedPiece {
  ...
  static getSizePrefixedRootAsPutInTheSpecifiedPiece(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new PutInTheSpecifiedPiece).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  matchList(e, t) {
    ...
    return i ? (t || new jigsaw_piece_match_js_1.JigsawPieceMatch).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * e), this.bb) : void 0
  }
  matchListLength() {
  ...
  static createPutInTheSpecifiedPiece(e, t, i) {
    return PutInTheSpecifiedPiece.startPutInTheSpecifiedPiece(e), PutInTheSpecifiedPiece.addType(e, t), PutInTheSpecifiedPiece.addMatchList(e, i), PutInTheSpecifiedPiece.endPutInTheSpecifiedPiece(e)
  }
}
