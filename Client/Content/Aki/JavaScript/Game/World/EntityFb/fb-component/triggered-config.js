...
class TriggeredConfig {
  ...
  static getSizePrefixedRootAsTriggeredConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new TriggeredConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  condition(i) {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? (i || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
  maxTriggerTimes() {
  ...
  actions(i, t) {
    ...
    return r ? (t || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * i), this.bb) : void 0
  }
  actionsLength() {
  ...
  static createTriggeredConfig(i, t, r, e, s) {
    return TriggeredConfig.startTriggeredConfig(i), TriggeredConfig.addCondition(i, t), TriggeredConfig.addMaxTriggerTimes(i, r), TriggeredConfig.addActions(i, e), TriggeredConfig.addOnlineDisableTip(i, s), TriggeredConfig.endTriggeredConfig(i)
  }
}
