...
class VehicleAudioConfig {
  ...
  static getSizePrefixedRootAsVehicleAudioConfig(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new VehicleAudioConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  minVehicleSpeed() {
  ...
  static createVehicleAudioConfig(i, e, t, o) {
    return VehicleAudioConfig.startVehicleAudioConfig(i), VehicleAudioConfig.addMinVehicleSpeed(i, e), VehicleAudioConfig.addMaxVehicleSpeed(i, t), VehicleAudioConfig.addAudioEvent(i, o), VehicleAudioConfig.endVehicleAudioConfig(i)
  }
}
