...
class EnrichmentAreaComponent {
  ...
  static getSizePrefixedRootAsEnrichmentAreaComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EnrichmentAreaComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createEnrichmentAreaComponent(t, e, r, i) {
    return EnrichmentAreaComponent.startEnrichmentAreaComponent(t), EnrichmentAreaComponent.addDisabled(t, e), EnrichmentAreaComponent.addRefEntityIds(t, r), EnrichmentAreaComponent.addFogIds(t, i), EnrichmentAreaComponent.endEnrichmentAreaComponent(t)
  }
}
