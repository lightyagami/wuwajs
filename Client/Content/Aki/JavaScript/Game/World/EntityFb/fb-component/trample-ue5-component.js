...
class TrampleUe5Component {
  ...
  static getSizePrefixedRootAsTrampleUe5Component(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TrampleUe5Component).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  triggerActions(t, e) {
    ...
    return r ? (e || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  static createTrampleUe5Component(t, e, r, i, s) {
    return TrampleUe5Component.startTrampleUe5Component(t), TrampleUe5Component.addDisabled(t, e), TrampleUe5Component.addIsDisposable(t, r), TrampleUe5Component.addTriggerActions(t, i), TrampleUe5Component.addRecoveryActions(t, s), TrampleUe5Component.endTrampleUe5Component(t)
  }
}
