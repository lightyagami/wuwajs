...
exports.EntityScanFunction = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const scan_trace_effect_js_1 = require("../fb-component/scan-trace-effect.js");
class EntityScanFunction {
  ...
  traceEffect(t) {
    ...
    if (n) {
      return (t || new scan_trace_effect_js_1.ScanTraceEffect()).__init(this.bb.__indirect(this.bb_pos + n), this.bb);
    } else {
      return undefined;
    }
  }
