...
class EntityScanFunction {
  ...
  static getRootAsEntityScanFunction(t, n) {
    return (n || new EntityScanFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsEntityScanFunction(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new EntityScanFunction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  scanId() {
  ...
  traceEffect(t) {
    ...
    return n ? (t || new scan_trace_effect_js_1.ScanTraceEffect).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : void 0
  }
