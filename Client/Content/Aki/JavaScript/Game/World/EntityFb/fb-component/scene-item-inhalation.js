...
class SceneItemInhalation {
  ...
  static getSizePrefixedRootAsSceneItemInhalation(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SceneItemInhalation).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSceneItemInhalation(t, e) {
    return SceneItemInhalation.startSceneItemInhalation(t), SceneItemInhalation.addType(t, e), SceneItemInhalation.endSceneItemInhalation(t)
  }
}
