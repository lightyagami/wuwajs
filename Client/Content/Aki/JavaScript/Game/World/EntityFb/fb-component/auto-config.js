...
class AutoConfig {
  ...
  static getSizePrefixedRootAsAutoConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new AutoConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  isCircle() {
  ...
  static createAutoConfig(t, i, s) {
    return AutoConfig.startAutoConfig(t), AutoConfig.addIsCircle(t, i), AutoConfig.addInterval(t, s), AutoConfig.endAutoConfig(t)
  }
}
