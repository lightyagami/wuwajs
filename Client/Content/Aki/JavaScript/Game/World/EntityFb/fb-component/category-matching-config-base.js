...
class CategoryMatchingConfigBase {
  ...
  static getRootAsCategoryMatchingConfigBase(t, i) {
    return (i || new CategoryMatchingConfigBase).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsCategoryMatchingConfigBase(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CategoryMatchingConfigBase).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  animation(t) {
    ...
    return i ? (t || new category_matching_animation_base_js_1.CategoryMatchingAnimationBase).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  callback(t) {
    var i = this.bb.__offset(this.bb_pos, 8);
    return i ? (t || new category_matching_succeed_base_js_1.CategoryMatchingSucceedBase).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
