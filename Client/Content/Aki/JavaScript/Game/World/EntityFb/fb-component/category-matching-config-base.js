...
exports.CategoryMatchingConfigBase = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const category_matching_animation_base_js_1 = require("../fb-component/category-matching-animation-base.js");
const category_matching_condition_js_1 = require("../fb-component/category-matching-condition.js");
const category_matching_succeed_base_js_1 = require("../fb-component/category-matching-succeed-base.js");
class CategoryMatchingConfigBase {
  ...
  animation(t) {
    ...
    if (i) {
      return (t || new category_matching_animation_base_js_1.CategoryMatchingAnimationBase()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  callback(t) {
    ...
    if (i) {
      return (t || new category_matching_succeed_base_js_1.CategoryMatchingSucceedBase()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
