...
class ConditionAction {
  ...
  static getSizePrefixedRootAsConditionAction(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ConditionAction).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  static createConditionAction(t, i, o) {
    return ConditionAction.startConditionAction(t), ConditionAction.addCondition(t, i), ConditionAction.addAction(t, o), ConditionAction.endConditionAction(t)
  }
}
