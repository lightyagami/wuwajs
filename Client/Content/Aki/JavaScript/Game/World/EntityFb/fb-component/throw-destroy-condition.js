...
class ThrowDestroyCondition {
  ...
  static getSizePrefixedRootAsThrowDestroyCondition(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ThrowDestroyCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createThrowDestroyCondition(t, o, i) {
    return ThrowDestroyCondition.startThrowDestroyCondition(t), ThrowDestroyCondition.addType(t, o), ThrowDestroyCondition.addDelayTime(t, i), ThrowDestroyCondition.endThrowDestroyCondition(t)
  }
}
