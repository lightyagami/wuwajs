...
class WeaponDamage {
  ...
  static getRootAsWeaponDamage(a, t) {
    return (t || new WeaponDamage).__init(a.readInt32(a.position()) + a.position(), a)
  }
  static getSizePrefixedRootAsWeaponDamage(a, t) {
    return a.setPosition(a.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new WeaponDamage).__init(a.readInt32(a.position()) + a.position(), a)
  }
  defaultValue() {
  ...
  static createWeaponDamage(a, t, e, s, i, r, n) {
    return WeaponDamage.startWeaponDamage(a), WeaponDamage.addDefaultValue(a, t), WeaponDamage.addGreatSword(a, e), WeaponDamage.addDagger(a, s), WeaponDamage.addPistol(a, i), WeaponDamage.addPugilism(a, r), WeaponDamage.addRing(a, n), WeaponDamage.endWeaponDamage(a)
  }
}
