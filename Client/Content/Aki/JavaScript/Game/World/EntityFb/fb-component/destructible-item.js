...
class DestructibleItem {
  ...
  static getSizePrefixedRootAsDestructibleItem(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DestructibleItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  attackerHitTimeScaleRatio(t) {
    ...
    return i ? (t || new hit_time_scale_ratio_js_1.HitTimeScaleRatio).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  ...
  aimParts(t, i) {
    ...
    return e ? (i || new aim_part_js_1.AimPart).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  aimPartsLength() {
  ...
  durabilityWorn(t) {
    ...
    return i ? (t || new durability_worn_js_1.DurabilityWorn).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  durabilityStateConfig(t) {
    var i = this.bb.__offset(this.bb_pos, 22);
    return i ? (t || new durability_state_config_js_1.DurabilityStateConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  hitPoint(t) {
  ...
  destructionActions(t, i) {
    ...
    return e ? (i || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  ...
  skillDamage(t) {
    ...
    return i ? (t || new skill_damage_js_1.SkillDamage).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  elementDamage(t) {
    var i = this.bb.__offset(this.bb_pos, 30);
    return i ? (t || new element_damage_js_1.ElementDamage).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  weaponDamage(t) {
    var i = this.bb.__offset(this.bb_pos, 32);
    return i ? (t || new weapon_damage_js_1.WeaponDamage).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
