...
class TimePathConfig {
  ...
  static getSizePrefixedRootAsTimePathConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TimePathConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  totalTime() {
  ...
  static createTimePathConfig(t, i, e) {
    return TimePathConfig.startTimePathConfig(t), TimePathConfig.addTotalTime(t, i), TimePathConfig.addTimePathCurve(t, e), TimePathConfig.endTimePathConfig(t)
  }
}
