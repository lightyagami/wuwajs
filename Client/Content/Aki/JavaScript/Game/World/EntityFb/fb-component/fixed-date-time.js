...
class FixedDateTime {
  ...
  static getSizePrefixedRootAsFixedDateTime(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FixedDateTime).__init(e.readInt32(e.position()) + e.position(), e)
  }
  hours() {
  ...
  static createFixedDateTime(e, t, i, s) {
    return FixedDateTime.startFixedDateTime(e), FixedDateTime.addHours(e, t), FixedDateTime.addMinutes(e, i), FixedDateTime.addSeconds(e, s), FixedDateTime.endFixedDateTime(e)
  }
}
