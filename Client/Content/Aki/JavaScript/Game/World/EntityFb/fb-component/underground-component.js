...
class UndergroundComponent {
  ...
  static getSizePrefixedRootAsUndergroundComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new UndergroundComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  destroyTag(t, e) {
    ...
    return r ? this.bb.__string(this.bb.__vector(this.bb_pos + r) + 4 * t, e) : void 0
  }
  destroyTagLength() {
  ...
  stateInfo(t, e) {
    ...
    return r ? (e || new underground_state_info_js_1.UndergroundStateInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  stateInfoLength() {
  ...
  static createUndergroundComponent(t, e, r, n, s, o) {
    return UndergroundComponent.startUndergroundComponent(t), UndergroundComponent.addDisabled(t, e), UndergroundComponent.addTestState(t, r), UndergroundComponent.addIsRestartPlayer(t, n), UndergroundComponent.addDestroyTag(t, s), UndergroundComponent.addStateInfo(t, o), UndergroundComponent.endUndergroundComponent(t)
  }
}
