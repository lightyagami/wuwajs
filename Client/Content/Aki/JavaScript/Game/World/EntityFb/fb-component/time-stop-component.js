...
class TimeStopComponent {
  ...
  static getSizePrefixedRootAsTimeStopComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TimeStopComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  target(t) {
    ...
    return e ? (t || new time_stop_target_js_1.TimeStopTarget).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
