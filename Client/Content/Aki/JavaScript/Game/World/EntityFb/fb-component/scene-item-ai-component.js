...
class SceneItemAiComponent {
  ...
  static getSizePrefixedRootAsSceneItemAiComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneItemAiComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  aiConfigType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_scene_item_ai_type_js_1.UnionSceneItemAiType.NONE
  }
  aiConfig(e) {
  ...
  static createSceneItemAiComponent(e, t, n, i) {
    return SceneItemAiComponent.startSceneItemAiComponent(e), SceneItemAiComponent.addDisabled(e, t), SceneItemAiComponent.addAiConfigType(e, n), SceneItemAiComponent.addAiConfig(e, i), SceneItemAiComponent.endSceneItemAiComponent(e)
  }
}
