...
class PatrolCycleOncely {
  ...
  static getSizePrefixedRootAsPatrolCycleOncely(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PatrolCycleOncely).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPatrolCycleOncely(t, e) {
    return PatrolCycleOncely.startPatrolCycleOncely(t), PatrolCycleOncely.addType(t, e), PatrolCycleOncely.endPatrolCycleOncely(t)
  }
}
