...
class SpawnMonsterConfig {
  ...
  static getSizePrefixedRootAsSpawnMonsterConfig(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new SpawnMonsterConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  id() {
  ...
  completeConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spawn_monster_complete_condition_js_1.UnionSpawnMonsterCompleteCondition.NONE
  }
  completeCondition(t) {
  ...
  preConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_spawn_monster_pre_condition_js_1.UnionSpawnMonsterPreCondition.NONE
  }
  preCondition(t) {
  ...
  static createSpawnMonsterConfig(t, n, i, s, e, o, r, a) {
    return SpawnMonsterConfig.startSpawnMonsterConfig(t), SpawnMonsterConfig.addId(t, n), SpawnMonsterConfig.addDelayTime(t, i), SpawnMonsterConfig.addTargetsToAwake(t, s), SpawnMonsterConfig.addCompleteConditionType(t, e), SpawnMonsterConfig.addCompleteCondition(t, o), SpawnMonsterConfig.addPreConditionType(t, r), SpawnMonsterConfig.addPreCondition(t, a), SpawnMonsterConfig.endSpawnMonsterConfig(t)
  }
}
