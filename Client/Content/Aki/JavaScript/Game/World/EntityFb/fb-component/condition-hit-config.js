...
class ConditionHitConfig {
  ...
  static getSizePrefixedRootAsConditionHitConfig(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ConditionHitConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  conditions(i) {
  ...
  static createConditionHitConfig(i, t, o) {
    return ConditionHitConfig.startConditionHitConfig(i), ConditionHitConfig.addConditions(i, t), ConditionHitConfig.addState(i, o), ConditionHitConfig.endConditionHitConfig(i)
  }
}
