...
class SceneItemMovementComponent {
  ...
  static getSizePrefixedRootAsSceneItemMovementComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneItemMovementComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  patrolType() {
    ...
    return e ? this.bb.readUint8(this.bb_pos + e) : union_movement_mode_js_1.UnionMovementMode.NONE
  }
  patrol(e) {
  ...
  static createSceneItemMovementComponent(e, t, n, o) {
    return SceneItemMovementComponent.startSceneItemMovementComponent(e), SceneItemMovementComponent.addDisabled(e, t), SceneItemMovementComponent.addPatrolType(e, n), SceneItemMovementComponent.addPatrol(e, o), SceneItemMovementComponent.endSceneItemMovementComponent(e)
  }
}
