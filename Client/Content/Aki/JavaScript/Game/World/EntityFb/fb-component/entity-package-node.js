...
class EntityPackageNode {
  ...
  static getSizePrefixedRootAsEntityPackageNode(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EntityPackageNode).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entityId() {
  ...
  children(t, e) {
    ...
    return i ? (e || new EntityPackageNode).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  childrenLength() {
  ...
  static createEntityPackageNode(t, e, i) {
    return EntityPackageNode.startEntityPackageNode(t), EntityPackageNode.addEntityId(t, e), EntityPackageNode.addChildren(t, i), EntityPackageNode.endEntityPackageNode(t)
  }
}
