...
class ProbabilityRefreshGroup {
  ...
  static getSizePrefixedRootAsProbabilityRefreshGroup(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new ProbabilityRefreshGroup).__init(t.readInt32(t.position()) + t.position(), t)
  }
  checkOccupation(t) {
  ...
  refreshItems(t, r) {
    ...
    return e ? (r || new probability_refresh_item_js_1.ProbabilityRefreshItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  refreshItemsLength() {
  ...
  static createProbabilityRefreshGroup(t, r, e) {
    return ProbabilityRefreshGroup.startProbabilityRefreshGroup(t), ProbabilityRefreshGroup.addCheckOccupation(t, r), ProbabilityRefreshGroup.addRefreshItems(t, e), ProbabilityRefreshGroup.endProbabilityRefreshGroup(t)
  }
}
