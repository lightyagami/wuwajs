...
class RefreshSingleComponent {
  ...
  static getSizePrefixedRootAsRefreshSingleComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new RefreshSingleComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  static createRefreshSingleComponent(e, t, s, n, i) {
    return RefreshSingleComponent.startRefreshSingleComponent(e), RefreshSingleComponent.addDisabled(e, t), RefreshSingleComponent.addRefreshInterval(e, s), RefreshSingleComponent.addDelayRefresh(e, n), RefreshSingleComponent.addTemplateGuid(e, i), RefreshSingleComponent.endRefreshSingleComponent(e)
  }
}
