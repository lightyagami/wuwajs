...
class TargetGearGroupConfig {
  ...
  static getSizePrefixedRootAsTargetGearGroupConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new TargetGearGroupConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  entitys(t) {
  ...
  successConditionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_target_gear_group_success_condition_js_1.UnionTargetGearGroupSuccessCondition.NONE
  }
  successCondition(t) {
  ...
  checkGears(t, i) {
    ...
    return r ? (i || new check_gear_hit_js_1.CheckGearHit).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  checkGearsLength() {
  ...
  finishConfigType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_group_finish_config_js_1.UnionGroupFinishConfig.NONE
  }
  finishConfig(t) {
  ...
  static createTargetGearGroupConfig(t, i, r, s, e, n, o, a, h) {
    return TargetGearGroupConfig.startTargetGearGroupConfig(t), TargetGearGroupConfig.addEntitys(t, i), TargetGearGroupConfig.addSuccessConditionType(t, r), TargetGearGroupConfig.addSuccessCondition(t, s), TargetGearGroupConfig.addFailureConditionsType(t, e), TargetGearGroupConfig.addFailureConditions(t, n), TargetGearGroupConfig.addCheckGears(t, o), TargetGearGroupConfig.addFinishConfigType(t, a), TargetGearGroupConfig.addFinishConfig(t, h), TargetGearGroupConfig.endTargetGearGroupConfig(t)
  }
}
