...
class LevelPrefabPerformComponent {
  ...
  static getSizePrefixedRootAsLevelPrefabPerformComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new LevelPrefabPerformComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  towardEntity(t, e) {
    ...
    return r ? (e || new toward_entity_config_js_1.TowardEntityConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  towardEntityLength() {
  ...
  prefabParams(t) {
    ...
    return e ? (t || new level_prefab_params_config_js_1.LevelPrefabParamsConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
