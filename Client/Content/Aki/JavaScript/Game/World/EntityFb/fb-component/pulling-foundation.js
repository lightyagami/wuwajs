...
class PullingFoundation {
  ...
  static getSizePrefixedRootAsPullingFoundation(i, n) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new PullingFoundation).__init(i.readInt32(i.position()) + i.position(), i)
  }
  disabled() {
  ...
  configType() {
    ...
    return i ? this.bb.readUint8(this.bb_pos + i) : union_pulling_foundation_js_1.UnionPullingFoundation.NONE
  }
  config(i) {
  ...
  static createPullingFoundation(i, n, t, o) {
    return PullingFoundation.startPullingFoundation(i), PullingFoundation.addDisabled(i, n), PullingFoundation.addConfigType(i, t), PullingFoundation.addConfig(i, o), PullingFoundation.endPullingFoundation(i)
  }
}
