...
class BehaviorFlowComponent {
  ...
  static getSizePrefixedRootAsBehaviorFlowComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new BehaviorFlowComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  flowInfo(t) {
    ...
    return i ? (t || new flow_info_js_1.FlowInfo).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
