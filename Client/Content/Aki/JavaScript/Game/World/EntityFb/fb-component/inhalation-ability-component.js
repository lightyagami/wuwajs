...
class InhalationAbilityComponent {
  ...
  static getSizePrefixedRootAsInhalationAbilityComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InhalationAbilityComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  inhalationConfigs(t, i) {
    ...
    return n ? (i || new inhalation_config_js_1.InhalationConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + n) + 4 * t), this.bb) : void 0
  }
  ...
  static createInhalationAbilityComponent(t, i, n) {
    return InhalationAbilityComponent.startInhalationAbilityComponent(t), InhalationAbilityComponent.addDisabled(t, i), InhalationAbilityComponent.addInhalationConfigs(t, n), InhalationAbilityComponent.endInhalationAbilityComponent(t)
  }
}
