...
class PatrolCycleLooply {
  ...
  static getSizePrefixedRootAsPatrolCycleLooply(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new PatrolCycleLooply).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createPatrolCycleLooply(t, o, e) {
    return PatrolCycleLooply.startPatrolCycleLooply(t), PatrolCycleLooply.addType(t, o), PatrolCycleLooply.addIsCircle(t, e), PatrolCycleLooply.endPatrolCycleLooply(t)
  }
}
