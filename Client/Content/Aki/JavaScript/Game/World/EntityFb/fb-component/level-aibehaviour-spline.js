...
class LevelAIBehaviourSpline {
  ...
  static getSizePrefixedRootAsLevelAIBehaviourSpline(e, i) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new LevelAIBehaviourSpline).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createLevelAIBehaviourSpline(e, i, t) {
    return LevelAIBehaviourSpline.startLevelAIBehaviourSpline(e), LevelAIBehaviourSpline.addType(e, i), LevelAIBehaviourSpline.addSplineEntityId(e, t), LevelAIBehaviourSpline.endLevelAIBehaviourSpline(e)
  }
}
