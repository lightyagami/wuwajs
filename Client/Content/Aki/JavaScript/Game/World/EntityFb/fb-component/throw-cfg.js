...
class ThrowCfg {
  ...
  static getSizePrefixedRootAsThrowCfg(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new ThrowCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  motionConfigType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_throw_motion_js_1.UnionThrowMotion.NONE
  }
  motionConfig(t) {
  ...
  static createThrowCfg(t, o, r) {
    return ThrowCfg.startThrowCfg(t), ThrowCfg.addMotionConfigType(t, o), ThrowCfg.addMotionConfig(t, r), ThrowCfg.endThrowCfg(t)
  }
}
