...
class PatrolRange {
  ...
  static getRootAsPatrolRange(t, e) {
    return (e || new PatrolRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsPatrolRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PatrolRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  center(t) {
  ...
  static createPatrolRange(t, e, r) {
    return PatrolRange.startPatrolRange(t), PatrolRange.addCenter(t, e), PatrolRange.addRadius(t, r), PatrolRange.endPatrolRange(t)
  }
}
