...
class VarComponent {
  ...
  static getSizePrefixedRootAsVarComponent(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new VarComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  vars(t, r) {
    ...
    return e ? (r || new var_define_js_1.VarDefine).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  varsLength() {
  ...
  static createVarComponent(t, r, e) {
    return VarComponent.startVarComponent(t), VarComponent.addDisabled(t, r), VarComponent.addVars(t, e), VarComponent.endVarComponent(t)
  }
}
