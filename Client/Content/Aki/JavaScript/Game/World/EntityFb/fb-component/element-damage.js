...
class ElementDamage {
  ...
  static getSizePrefixedRootAsElementDamage(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ElementDamage).__init(t.readInt32(t.position()) + t.position(), t)
  }
  defaultValue() {
  ...
  static createElementDamage(t, e, a, s, i, r, h, n, m) {
    return ElementDamage.startElementDamage(t), ElementDamage.addDefaultValue(t, e), ElementDamage.addPhysics(t, a), ElementDamage.addIce(t, s), ElementDamage.addFire(t, i), ElementDamage.addThunder(t, r), ElementDamage.addWind(t, h), ElementDamage.addLight(t, n), ElementDamage.addDark(t, m), ElementDamage.endElementDamage(t)
  }
}
