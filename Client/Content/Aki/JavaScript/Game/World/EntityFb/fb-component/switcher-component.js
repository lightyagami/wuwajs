...
class SwitcherComponent {
  ...
  static getRootAsSwitcherComponent(t, i) {
    return (i || new SwitcherComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsSwitcherComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new SwitcherComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createSwitcherComponent(t, i, e, n, s, o) {
    return SwitcherComponent.startSwitcherComponent(t), SwitcherComponent.addDisabled(t, i), SwitcherComponent.addContent(t, e), SwitcherComponent.addIcon(t, n), SwitcherComponent.addOnActions(t, s), SwitcherComponent.addOffActions(t, o), SwitcherComponent.endSwitcherComponent(t)
  }
}
