...
class WindDirectionalStateGrade {
  ...
  static getSizePrefixedRootAsWindDirectionalStateGrade(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new WindDirectionalStateGrade).__init(t.readInt32(t.position()) + t.position(), t)
  }
  state(t) {
  ...
  static createWindDirectionalStateGrade(t, e, i, a) {
    return WindDirectionalStateGrade.startWindDirectionalStateGrade(t), WindDirectionalStateGrade.addState(t, e), WindDirectionalStateGrade.addSpeed(t, i), WindDirectionalStateGrade.addStrength(t, a), WindDirectionalStateGrade.endWindDirectionalStateGrade(t)
  }
}
