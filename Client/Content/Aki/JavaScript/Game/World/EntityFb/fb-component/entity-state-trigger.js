...
class EntityStateTrigger {
  ...
  static getSizePrefixedRootAsEntityStateTrigger(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityStateTrigger).__init(t.readInt32(t.position()) + t.position(), t)
  }
  groupCondition(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new entity_group_condition_js_1.EntityGroupCondition).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  successActions(t, i) {
