...
class LetGoDestroyCondition {
  ...
  static getSizePrefixedRootAsLetGoDestroyCondition(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new LetGoDestroyCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createLetGoDestroyCondition(t, o) {
    return LetGoDestroyCondition.startLetGoDestroyCondition(t), LetGoDestroyCondition.addType(t, o), LetGoDestroyCondition.endLetGoDestroyCondition(t)
  }
}
