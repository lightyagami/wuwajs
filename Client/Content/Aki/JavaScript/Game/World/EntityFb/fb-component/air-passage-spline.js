...
class AirPassageSpline {
  ...
  static getSizePrefixedRootAsAirPassageSpline(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new AirPassageSpline).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  points(i, t) {
    ...
    return s ? (t || new common_spline_point_js_1.CommonSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * i), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createAirPassageSpline(i, t, s, e, a, r, n, d, h, l, c, p, o) {
    return AirPassageSpline.startAirPassageSpline(i), AirPassageSpline.addType(i, t), AirPassageSpline.addMiddleLineEffect(i, s), AirPassageSpline.addTailCircleEffect(i, e), AirPassageSpline.addMiddleCircleEffect(i, a), AirPassageSpline.addMiddleCircleOverlyingEffect(i, r), AirPassageSpline.addMiddleCircleSpace(i, n), AirPassageSpline.addMiddleCircleRadius(i, d), AirPassageSpline.addMovableRadius(i, h), AirPassageSpline.addResistance(i, l), AirPassageSpline.addSpeedLimit(i, c), AirPassageSpline.addSprintSpeedLimit(i, p), AirPassageSpline.addPoints(i, o), AirPassageSpline.endAirPassageSpline(i)
  }
}
