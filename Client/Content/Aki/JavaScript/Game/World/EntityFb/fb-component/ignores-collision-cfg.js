...
class IgnoresCollisionCfg {
  ...
  static getSizePrefixedRootAsIgnoresCollisionCfg(t, s) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (s || new IgnoresCollisionCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  ignoreEntitys(t) {
  ...
  ignoreActors(t, s) {
    ...
    return r ? (s || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ignoreActorsLength() {
  ...
  static createIgnoresCollisionCfg(t, s, r) {
    return IgnoresCollisionCfg.startIgnoresCollisionCfg(t), IgnoresCollisionCfg.addIgnoreEntitys(t, s), IgnoresCollisionCfg.addIgnoreActors(t, r), IgnoresCollisionCfg.endIgnoresCollisionCfg(t)
  }
}
