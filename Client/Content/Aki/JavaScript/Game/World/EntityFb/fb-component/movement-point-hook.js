...
class MovementPointHook {
  ...
  static getSizePrefixedRootAsMovementPointHook(t, o) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (o || new MovementPointHook).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  hookActions(t, o) {
    ...
    return i ? (o || new action_info_js_1.ActionInfo).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  hookActionsLength() {
  ...
  static createMovementPointHook(t, o, i, s, e) {
    return MovementPointHook.startMovementPointHook(t), MovementPointHook.addType(t, o), MovementPointHook.addHookActions(t, i), MovementPointHook.addExitHookActions(t, s), MovementPointHook.addFinishActions(t, e), MovementPointHook.endMovementPointHook(t)
  }
}
