...
class BatchBulletCaster {
  ...
  static getSizePrefixedRootAsBatchBulletCaster(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BatchBulletCaster).__init(t.readInt32(t.position()) + t.position(), t)
  }
  bulletIndex() {
  ...
  static createBatchBulletCaster(t, e, s, a, i, r, l, h) {
    return BatchBulletCaster.startBatchBulletCaster(t), BatchBulletCaster.addBulletIndex(t, e), BatchBulletCaster.addBulletType(t, s), BatchBulletCaster.addDelayTime(t, a), BatchBulletCaster.addFlyTime(t, i), BatchBulletCaster.addFlyDistance(t, r), BatchBulletCaster.addWarningTime(t, l), BatchBulletCaster.addWarningWidth(t, h), BatchBulletCaster.endBatchBulletCaster(t)
  }
}
