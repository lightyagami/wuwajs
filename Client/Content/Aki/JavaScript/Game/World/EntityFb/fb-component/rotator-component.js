...
class RotatorComponent {
  ...
  static getSizePrefixedRootAsRotatorComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new RotatorComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  interactAction(t) {
    ...
    return i ? (t || new event_rotator_js_1.EventRotator).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  isLockZ() {
