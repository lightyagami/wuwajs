...
class BatchBulletCasterComponent {
  ...
  static getSizePrefixedRootAsBatchBulletCasterComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BatchBulletCasterComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  bulletList(t, e) {
    ...
    return s ? (e || new pos_rot_js_1.PosRot).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  bulletListLength() {
  ...
  batchList(t, e) {
    ...
    return s ? (e || new batch_bullet_item_js_1.BatchBulletItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  batchListLength() {
  ...
  static createBatchBulletCasterComponent(t, e, s, r, i, a) {
    return BatchBulletCasterComponent.startBatchBulletCasterComponent(t), BatchBulletCasterComponent.addDisabled(t, e), BatchBulletCasterComponent.addWarningEffect(t, s), BatchBulletCasterComponent.addMovementType(t, r), BatchBulletCasterComponent.addBulletList(t, i), BatchBulletCasterComponent.addBatchList(t, a), BatchBulletCasterComponent.endBatchBulletCasterComponent(t)
  }
}
