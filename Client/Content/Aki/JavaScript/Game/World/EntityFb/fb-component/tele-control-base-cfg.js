...
class TeleControlBaseCfg {
  ...
  static getSizePrefixedRootAsTeleControlBaseCfg(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new TeleControlBaseCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  commonConfig(t) {
  ...
  static createTeleControlBaseCfg(t, e, s, o) {
    return TeleControlBaseCfg.startTeleControlBaseCfg(t), TeleControlBaseCfg.addCommonConfig(t, e), TeleControlBaseCfg.addCanRotate(t, s), TeleControlBaseCfg.addInitialGravity(t, o), TeleControlBaseCfg.endTeleControlBaseCfg(t)
  }
}
