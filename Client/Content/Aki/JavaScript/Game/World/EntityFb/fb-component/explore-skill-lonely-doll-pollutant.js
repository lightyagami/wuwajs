...
class ExploreSkillLonelyDollPollutant {
  ...
  static getSizePrefixedRootAsExploreSkillLonelyDollPollutant(l, t) {
    return l.setPosition(l.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new ExploreSkillLonelyDollPollutant).__init(l.readInt32(l.position()) + l.position(), l)
  }
  type(l) {
  ...
  static createExploreSkillLonelyDollPollutant(l, t) {
    return ExploreSkillLonelyDollPollutant.startExploreSkillLonelyDollPollutant(l), ExploreSkillLonelyDollPollutant.addType(l, t), ExploreSkillLonelyDollPollutant.endExploreSkillLonelyDollPollutant(l)
  }
}
