...
class CondtionListener {
  ...
  static getSizePrefixedRootAsCondtionListener(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CondtionListener).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  static createCondtionListener(t, i, n) {
    return CondtionListener.startCondtionListener(t), CondtionListener.addCondition(t, i), CondtionListener.addActions(t, n), CondtionListener.endCondtionListener(t)
  }
}
