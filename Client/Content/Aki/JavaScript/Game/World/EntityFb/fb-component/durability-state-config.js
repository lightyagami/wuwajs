...
class DurabilityStateConfig {
  ...
  static getSizePrefixedRootAsDurabilityStateConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DurabilityStateConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  nonDestructable() {
  ...
  durabilityStates(t, i) {
    ...
    return e ? (i || new durability_state_js_1.DurabilityState).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  ...
  static createDurabilityStateConfig(t, i, e) {
    return DurabilityStateConfig.startDurabilityStateConfig(t), DurabilityStateConfig.addNonDestructable(t, i), DurabilityStateConfig.addDurabilityStates(t, e), DurabilityStateConfig.endDurabilityStateConfig(t)
  }
}
