...
class DynamicPortal {
  ...
  static getSizePrefixedRootAsDynamicPortal(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new DynamicPortal).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  renderConfig(t) {
    ...
    return r ? (t || new portal_render_config_js_1.PortalRenderConfig).__init(this.bb.__indirect(this.bb_pos + r), this.bb) : void 0
  }
