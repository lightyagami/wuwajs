...
class HoldingTrackTarget {
  ...
  static getSizePrefixedRootAsHoldingTrackTarget(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new HoldingTrackTarget).__init(t.readInt32(t.position()) + t.position(), t)
  }
  effectPath(t) {
  ...
  static createHoldingTrackTarget(t, r, e, a) {
    return HoldingTrackTarget.startHoldingTrackTarget(t), HoldingTrackTarget.addEffectPath(t, r), HoldingTrackTarget.addEffectLength(t, e), HoldingTrackTarget.addEntityId(t, a), HoldingTrackTarget.endHoldingTrackTarget(t)
  }
}
