...
class SearchTargetCfg {
  ...
  static getSizePrefixedRootAsSearchTargetCfg(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SearchTargetCfg).__init(t.readInt32(t.position()) + t.position(), t)
  }
  angleWeight(t, e) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (e || new entity_angle_weight_js_1.EntityAngleWeight).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  angleWeightLength() {
  ...
  lockConditions(t, e) {
    ...
    return r ? (e || new entity_category_weight_js_1.EntityCategoryWeight).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  static createSearchTargetCfg(t, e, r, i) {
    return SearchTargetCfg.startSearchTargetCfg(t), SearchTargetCfg.addAngleWeight(t, e), SearchTargetCfg.addLockConditions(t, r), SearchTargetCfg.addIgnoreDistanceWeight(t, i), SearchTargetCfg.endSearchTargetCfg(t)
  }
}
