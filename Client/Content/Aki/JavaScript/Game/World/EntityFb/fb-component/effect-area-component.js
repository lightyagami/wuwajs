...
const union_effect_area_config_js_1 = require("../fb-component/union-effect-area-config.js");
class EffectAreaComponent {
  ...
  configType() {
    ...
    if (t) {
      ...
      return union_effect_area_config_js_1.UnionEffectAreaConfig.NONE;
    }
  }
  config(t) {
  ...
  static createEffectAreaComponent(t, e, n, f) {
    ...
    return EffectAreaComponent.endEffectAreaComponent(t);
  }
}
