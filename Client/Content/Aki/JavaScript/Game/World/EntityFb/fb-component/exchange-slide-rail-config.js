...
class ExchangeSlideRailConfig {
  ...
  static getSizePrefixedRootAsExchangeSlideRailConfig(i, e) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ExchangeSlideRailConfig).__init(i.readInt32(i.position()) + i.position(), i)
  }
  maxExchangeDistance() {
  ...
  nextRails(i, e) {
    ...
    return t ? (e || new next_slide_rail_js_1.NextSlideRail).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + t) + 4 * i), this.bb) : void 0
  }
  nextRailsLength() {
  ...
  static createExchangeSlideRailConfig(i, e, t) {
    return ExchangeSlideRailConfig.startExchangeSlideRailConfig(i), ExchangeSlideRailConfig.addMaxExchangeDistance(i, e), ExchangeSlideRailConfig.addNextRails(i, t), ExchangeSlideRailConfig.endExchangeSlideRailConfig(i)
  }
}
