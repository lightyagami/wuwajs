...
class SkyboxGlobalTrigger {
  ...
  static getSizePrefixedRootAsSkyboxGlobalTrigger(r, t) {
    return r.setPosition(r.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SkyboxGlobalTrigger).__init(r.readInt32(r.position()) + r.position(), r)
  }
  type() {
  ...
  static createSkyboxGlobalTrigger(r, t) {
    return SkyboxGlobalTrigger.startSkyboxGlobalTrigger(r), SkyboxGlobalTrigger.addType(r, t), SkyboxGlobalTrigger.endSkyboxGlobalTrigger(r)
  }
}
