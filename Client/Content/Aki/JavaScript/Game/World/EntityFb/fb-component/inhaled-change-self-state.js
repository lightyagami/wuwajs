...
class InhaledChangeSelfState {
  ...
  static getSizePrefixedRootAsInhaledChangeSelfState(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new InhaledChangeSelfState).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  static createInhaledChangeSelfState(e, t, a) {
    return InhaledChangeSelfState.startInhaledChangeSelfState(e), InhaledChangeSelfState.addType(e, t), InhaledChangeSelfState.addChangeSelfState(e, a), InhaledChangeSelfState.endInhaledChangeSelfState(e)
  }
}
