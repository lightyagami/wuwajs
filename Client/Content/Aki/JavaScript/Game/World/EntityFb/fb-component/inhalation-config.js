...
exports.InhalationConfig = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const inhalation_matching_js_1 = require("../fb-component/inhalation-matching.js");
const union_inhalation_performance_js_1 = require("../fb-component/union-inhalation-performance.js");
class InhalationConfig {
  ...
  inhalationMatching(n) {
    ...
    if (i) {
      return (n || new inhalation_matching_js_1.InhalationMatching()).__init(this.bb.__indirect(this.bb_pos + i), this.bb);
    } else {
      return undefined;
    }
  }
  inhalationPerformanceType() {
    ...
    if (n) {
      return this.bb.readUint8(this.bb_pos + n);
    } else {
      return union_inhalation_performance_js_1.UnionInhalationPerformance.NONE;
    }
  }
  inhalationPerformance(n) {
    var i = this.bb.__offset(this.bb_pos, 8);
    if (i) {
      return this.bb.__union(n, this.bb_pos + i);
    } else {
      return undefined;
    }
  }
  ...
  static createInhalationConfig(n, i, t, a) {
    ...
    return InhalationConfig.endInhalationConfig(n);
  }
}
