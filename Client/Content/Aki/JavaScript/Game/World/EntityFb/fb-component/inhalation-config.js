...
class InhalationConfig {
  ...
  static getRootAsInhalationConfig(n, i) {
    return (i || new InhalationConfig).__init(n.readInt32(n.position()) + n.position(), n)
  }
  static getSizePrefixedRootAsInhalationConfig(n, i) {
    return n.setPosition(n.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InhalationConfig).__init(n.readInt32(n.position()) + n.position(), n)
  }
  inhalationMatching(n) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (n || new inhalation_matching_js_1.InhalationMatching).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  inhalationPerformanceType() {
    var n = this.bb.__offset(this.bb_pos, 6);
    return n ? this.bb.readUint8(this.bb_pos + n) : union_inhalation_performance_js_1.UnionInhalationPerformance.NONE
  }
  ...
  static addInhalationPerformanceType(n, i) {
    n.addFieldInt8(1, i, union_inhalation_performance_js_1.UnionInhalationPerformance.NONE)
  }
  ...
  static createInhalationConfig(n, i, t, a) {
    return InhalationConfig.startInhalationConfig(n), InhalationConfig.addInhalationMatching(n, i), InhalationConfig.addInhalationPerformanceType(n, t), InhalationConfig.addInhalationPerformance(n, a), InhalationConfig.endInhalationConfig(n)
  }
}
