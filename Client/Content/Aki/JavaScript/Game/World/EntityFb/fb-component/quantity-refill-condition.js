...
class QuantityRefillCondition {
  ...
  static getRootAsQuantityRefillCondition(t, i) {
    return (i || new QuantityRefillCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsQuantityRefillCondition(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new QuantityRefillCondition).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createQuantityRefillCondition(t, i, n, e) {
    return QuantityRefillCondition.startQuantityRefillCondition(t), QuantityRefillCondition.addType(t, i), QuantityRefillCondition.addQuantity(t, n), QuantityRefillCondition.addDelayRefill(t, e), QuantityRefillCondition.endQuantityRefillCondition(t)
  }
}
