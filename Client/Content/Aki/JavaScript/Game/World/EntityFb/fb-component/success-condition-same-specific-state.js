...
class SuccessConditionSameSpecificState {
  ...
  static getSizePrefixedRootAsSuccessConditionSameSpecificState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SuccessConditionSameSpecificState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createSuccessConditionSameSpecificState(t, e, i) {
    return SuccessConditionSameSpecificState.startSuccessConditionSameSpecificState(t), SuccessConditionSameSpecificState.addType(t, e), SuccessConditionSameSpecificState.addState(t, i), SuccessConditionSameSpecificState.endSuccessConditionSameSpecificState(t)
  }
}
