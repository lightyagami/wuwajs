...
class JigsawItemMatchedConfig {
  ...
  static getSizePrefixedRootAsJigsawItemMatchedConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new JigsawItemMatchedConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  targetIndex(t) {
    var i = this.bb.__offset(this.bb_pos, 4);
    return i ? (t || new piece_index_js_1.PieceIndex).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  jigsawItemIds(t) {
  ...
  conditionActions(t, i) {
    ...
    return s ? (i || new condition_action_js_1.ConditionAction).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  ...
  static createJigsawItemMatchedConfig(t, i, s, e, n, a) {
    return JigsawItemMatchedConfig.startJigsawItemMatchedConfig(t), JigsawItemMatchedConfig.addTargetIndex(t, i), JigsawItemMatchedConfig.addJigsawItemIds(t, s), JigsawItemMatchedConfig.addActions(t, e), JigsawItemMatchedConfig.addConditionActions(t, n), JigsawItemMatchedConfig.addUnmatchedActions(t, a), JigsawItemMatchedConfig.endJigsawItemMatchedConfig(t)
  }
}
