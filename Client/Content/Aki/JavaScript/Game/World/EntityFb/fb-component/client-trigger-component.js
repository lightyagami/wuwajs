...
class ClientTriggerComponent {
  ...
  static getSizePrefixedRootAsClientTriggerComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ClientTriggerComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  triggerMatch(t) {
    ...
    return i ? (t || new trigger_match_config_js_1.TriggerMatchConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  onTriggerEnter(t) {
    var i = this.bb.__offset(this.bb_pos, 8);
    return i ? (t || new triggered_config_js_1.TriggeredConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
  onTriggerExit(t) {
