...
class ButterflySpline {
  ...
  static getSizePrefixedRootAsButterflySpline(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ButterflySpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  points(t, e) {
    ...
    return i ? (e || new butterfly_spline_point_js_1.ButterflySplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createButterflySpline(t, e, i) {
    return ButterflySpline.startButterflySpline(t), ButterflySpline.addType(t, e), ButterflySpline.addPoints(t, i), ButterflySpline.endButterflySpline(t)
  }
}
