...
class CreateStageConfig {
  ...
  static getSizePrefixedRootAsCreateStageConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new CreateStageConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  performDuration() {
  ...
  bulletConfig(t) {
    ...
    return e ? (t || new create_bullet_config_js_1.CreateBulletConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  actions(t, e) {
