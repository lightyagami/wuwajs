...
class FixedAngleTurntable {
  ...
  static getSizePrefixedRootAsFixedAngleTurntable(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new FixedAngleTurntable).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  itemConfig(t, e) {
    ...
    return i ? (e || new fixed_angle_item_js_1.FixedAngleItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  itemConfigLength() {
  ...
  static createFixedAngleTurntable(t, e, i, r) {
    return FixedAngleTurntable.startFixedAngleTurntable(t), FixedAngleTurntable.addType(t, e), FixedAngleTurntable.addRotationSpeed(t, i), FixedAngleTurntable.addItemConfig(t, r), FixedAngleTurntable.endFixedAngleTurntable(t)
  }
}
