...
class InteractSectorRange {
  ...
  static getSizePrefixedRootAsInteractSectorRange(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new InteractSectorRange).__init(t.readInt32(t.position()) + t.position(), t)
  }
  begin() {
  ...
  static createInteractSectorRange(t, e, r) {
    return InteractSectorRange.startInteractSectorRange(t), InteractSectorRange.addBegin(t, e), InteractSectorRange.addEnd(t, r), InteractSectorRange.endInteractSectorRange(t)
  }
}
