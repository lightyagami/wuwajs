...
class ExploreSkillPullStatue {
  ...
  static getRootAsExploreSkillPullStatue(t, i) {
    return (i || new ExploreSkillPullStatue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsExploreSkillPullStatue(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ExploreSkillPullStatue).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
