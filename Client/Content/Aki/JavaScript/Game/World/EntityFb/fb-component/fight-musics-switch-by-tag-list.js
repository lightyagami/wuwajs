...
class FightMusicsSwitchByTagList {
  ...
  static getSizePrefixedRootAsFightMusicsSwitchByTagList(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new FightMusicsSwitchByTagList).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  element(t, i) {
    ...
    return s ? (i || new fight_music_switch_by_tag_js_1.FightMusicSwitchByTag).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  elementLength() {
  ...
  static createFightMusicsSwitchByTagList(t, i, s) {
    return FightMusicsSwitchByTagList.startFightMusicsSwitchByTagList(t), FightMusicsSwitchByTagList.addType(t, i), FightMusicsSwitchByTagList.addElement(t, s), FightMusicsSwitchByTagList.endFightMusicsSwitchByTagList(t)
  }
}
