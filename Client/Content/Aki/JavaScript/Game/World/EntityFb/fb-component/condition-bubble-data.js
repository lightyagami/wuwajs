...
class ConditionBubbleData {
  ...
  static getSizePrefixedRootAsConditionBubbleData(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ConditionBubbleData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  flow(t) {
    ...
    return i ? (t || new bubble_data_js_1.BubbleData).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
