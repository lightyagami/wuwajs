...
class EffectSpline {
  ...
  static getSizePrefixedRootAsEffectSpline(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new EffectSpline).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  createOptionType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_effect_spline_create_option_js_1.UnionEffectSplineCreateOption.NONE
  }
  createOption(t) {
  ...
  points(t, e) {
    ...
    return i ? (e || new common_spline_point_js_1.CommonSplinePoint).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + i) + 4 * t), this.bb) : void 0
  }
  pointsLength() {
  ...
  static createEffectSpline(t, e, i, s, n, r) {
    return EffectSpline.startEffectSpline(t), EffectSpline.addType(t, e), EffectSpline.addEffect(t, i), EffectSpline.addCreateOptionType(t, s), EffectSpline.addCreateOption(t, n), EffectSpline.addPoints(t, r), EffectSpline.endEffectSpline(t)
  }
}
