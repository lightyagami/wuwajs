...
class InitStateDigital {
  ...
  static getSizePrefixedRootAsInitStateDigital(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InitStateDigital).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createInitStateDigital(t, i) {
    return InitStateDigital.startInitStateDigital(t), InitStateDigital.addType(t, i), InitStateDigital.endInitStateDigital(t)
  }
}
