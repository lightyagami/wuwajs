...
class PortalRenderConfig {
  ...
  static getSizePrefixedRootAsPortalRenderConfig(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new PortalRenderConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  viewDistanceType() {
    var t = this.bb.__offset(this.bb_pos, 4);
    return t ? this.bb.readUint8(this.bb_pos + t) : union_portal_view_distance_config_js_1.UnionPortalViewDistanceConfig.NONE
  }
  viewDistance(t) {
  ...
  forceRenderActors(t, e) {
    ...
    return r ? (e || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  setRenderFlags(t, e) {
    ...
    return r ? (e || new render_flag_js_1.RenderFlag).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : void 0
  }
  ...
  static createPortalRenderConfig(t, e, r, i, s) {
    return PortalRenderConfig.startPortalRenderConfig(t), PortalRenderConfig.addViewDistanceType(t, e), PortalRenderConfig.addViewDistance(t, r), PortalRenderConfig.addForceRenderActors(t, i), PortalRenderConfig.addSetRenderFlags(t, s), PortalRenderConfig.endPortalRenderConfig(t)
  }
}
