...
class OnOpenGravityCollisionCondition {
  ...
  static getSizePrefixedRootAsOnOpenGravityCollisionCondition(i, t) {
    return i.setPosition(i.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new OnOpenGravityCollisionCondition).__init(i.readInt32(i.position()) + i.position(), i)
  }
  type(i) {
  ...
  static createOnOpenGravityCollisionCondition(i, t, n) {
    return OnOpenGravityCollisionCondition.startOnOpenGravityCollisionCondition(i), OnOpenGravityCollisionCondition.addType(i, t), OnOpenGravityCollisionCondition.addBulletId(i, n), OnOpenGravityCollisionCondition.endOnOpenGravityCollisionCondition(i)
  }
}
