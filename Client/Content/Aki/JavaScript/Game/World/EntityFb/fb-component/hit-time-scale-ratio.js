...
class HitTimeScaleRatio {
  ...
  static getSizePrefixedRootAsHitTimeScaleRatio(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new HitTimeScaleRatio).__init(t.readInt32(t.position()) + t.position(), t)
  }
  timeRatio() {
  ...
  static createHitTimeScaleRatio(t, i, e, a) {
    return HitTimeScaleRatio.startHitTimeScaleRatio(t), HitTimeScaleRatio.addTimeRatio(t, i), HitTimeScaleRatio.addMaxExtraTime(t, e), HitTimeScaleRatio.addValueRatio(t, a), HitTimeScaleRatio.endHitTimeScaleRatio(t)
  }
}
