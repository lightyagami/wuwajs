...
class JigsawItem {
  ...
  static getSizePrefixedRootAsJigsawItem(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new JigsawItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  fillCfgType() {
    ...
    return t ? this.bb.readUint8(this.bb_pos + t) : union_fill_config_js_1.UnionFillConfig.NONE
  }
  fillCfg(t) {
  ...
  static createJigsawItem(t, i, s, e) {
    return JigsawItem.startJigsawItem(t), JigsawItem.addDisabled(t, i), JigsawItem.addFillCfgType(t, s), JigsawItem.addFillCfg(t, e), JigsawItem.endJigsawItem(t)
  }
}
