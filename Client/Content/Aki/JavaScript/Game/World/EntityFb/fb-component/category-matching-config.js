...
class CategoryMatchingConfig {
  ...
  static getSizePrefixedRootAsCategoryMatchingConfig(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new CategoryMatchingConfig).__init(t.readInt32(t.position()) + t.position(), t)
  }
  condition(t) {
  ...
  itemLockingConfig(t) {
    ...
    return i ? (t || new item_locking_config_js_1.ItemLockingConfig).__init(this.bb.__indirect(this.bb_pos + i), this.bb) : void 0
  }
