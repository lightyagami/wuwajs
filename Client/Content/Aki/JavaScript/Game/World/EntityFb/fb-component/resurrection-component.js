...
class ResurrectionComponent {
  ...
  static getSizePrefixedRootAsResurrectionComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ResurrectionComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  teleportPos(t) {
    ...
    return e ? (t || new pos_a_js_1.PosA).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
  triggerShapeType() {
  ...
  gravityConfig(t) {
    ...
    return e ? (t || new gravity_flip_teleport_config_js_1.GravityFlipTeleportConfig).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : void 0
  }
