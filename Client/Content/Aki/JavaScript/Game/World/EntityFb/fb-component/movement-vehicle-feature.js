...
class MovementVehicleFeature {
  ...
  static getSizePrefixedRootAsMovementVehicleFeature(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new MovementVehicleFeature).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type() {
  ...
  movePerformConfig(e) {
    ...
    return t ? (e || new movement_perform_config_js_1.MovementPerformConfig).__init(this.bb.__indirect(this.bb_pos + t), this.bb) : void 0
  }
