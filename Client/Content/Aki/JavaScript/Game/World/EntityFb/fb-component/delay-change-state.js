...
class DelayChangeState {
  ...
  static getSizePrefixedRootAsDelayChangeState(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new DelayChangeState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  time() {
  ...
  static createDelayChangeState(t, e, a) {
    return DelayChangeState.startDelayChangeState(t), DelayChangeState.addTime(t, e), DelayChangeState.addNewState(t, a), DelayChangeState.endDelayChangeState(t)
  }
}
