...
class NpcUiInteractOnHandInItem {
  ...
  static getSizePrefixedRootAsNpcUiInteractOnHandInItem(t, n) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (n || new NpcUiInteractOnHandInItem).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  enterFlow(t) {
    ...
    return n ? (t || new play_flow_js_1.PlayFlow).__init(this.bb.__indirect(this.bb_pos + n), this.bb) : void 0
  }
  handInFailedFlow(t) {
