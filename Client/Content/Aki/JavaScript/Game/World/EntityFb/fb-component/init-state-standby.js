...
class InitStateStandby {
  ...
  static getRootAsInitStateStandby(t, i) {
    return (i || new InitStateStandby).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsInitStateStandby(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InitStateStandby).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  conditions(t, i) {
    ...
    return s ? (i || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + 4 * t), this.bb) : void 0
  }
  conditionsLength() {
  ...
  static createInitStateStandby(t, i, s, n, a) {
    return InitStateStandby.startInitStateStandby(t), InitStateStandby.addType(t, i), InitStateStandby.addStandbyTags(t, s), InitStateStandby.addConditions(t, n), InitStateStandby.addWander(t, a), InitStateStandby.endInitStateStandby(t)
  }
}
