...
exports.InitStateStandby = undefined;
...
class InitStateStandby {
  ...
  conditions(t, i) {
    ...
    if (s) {
      return (i || new condition_group_js_1.ConditionGroup()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + s) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createInitStateStandby(t, i, s, n, a) {
    ...
    return InitStateStandby.endInitStateStandby(t);
  }
}
