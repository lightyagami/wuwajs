...
class VisionComponent {
  ...
  static getSizePrefixedRootAsVisionComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new VisionComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createVisionComponent(t, i, n) {
    return VisionComponent.startVisionComponent(t), VisionComponent.addDisabled(t, i), VisionComponent.addVisionId(t, n), VisionComponent.endVisionComponent(t)
  }
}
