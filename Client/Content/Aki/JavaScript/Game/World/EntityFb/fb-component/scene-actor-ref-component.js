...
class SceneActorRefComponent {
  ...
  static getSizePrefixedRootAsSceneActorRefComponent(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new SceneActorRefComponent).__init(e.readInt32(e.position()) + e.position(), e)
  }
  disabled() {
  ...
  actorRefGroups(e, t) {
    ...
    return r ? (t || new scene_actor_ref_group_js_1.SceneActorRefGroup).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * e), this.bb) : void 0
  }
  ...
  volumesRef(e, t) {
    ...
    return r ? (t || new actor_ref_js_1.ActorRef).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * e), this.bb) : void 0
  }
  volumesRefLength() {
  ...
  static createSceneActorRefComponent(e, t, r, o) {
    return SceneActorRefComponent.startSceneActorRefComponent(e), SceneActorRefComponent.addDisabled(e, t), SceneActorRefComponent.addActorRefGroups(e, r), SceneActorRefComponent.addVolumesRef(e, o), SceneActorRefComponent.endSceneActorRefComponent(e)
  }
}
