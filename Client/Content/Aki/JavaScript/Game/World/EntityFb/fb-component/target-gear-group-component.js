...
class TargetGearGroupComponent {
  ...
  static getRootAsTargetGearGroupComponent(t, r) {
    return (r || new TargetGearGroupComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsTargetGearGroupComponent(t, r) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (r || new TargetGearGroupComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  groupConfigs(t, r) {
    ...
    return e ? (r || new target_gear_group_config_js_1.TargetGearGroupConfig).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  groupConfigsLength() {
  ...
  static createTargetGearGroupComponent(t, r, e, o) {
    return TargetGearGroupComponent.startTargetGearGroupComponent(t), TargetGearGroupComponent.addDisabled(t, r), TargetGearGroupComponent.addType(t, e), TargetGearGroupComponent.addGroupConfigs(t, o), TargetGearGroupComponent.endTargetGearGroupComponent(t)
  }
}
