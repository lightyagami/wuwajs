...
exports.TargetGearGroupComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const target_gear_group_config_js_1 = require("../fb-component/target-gear-group-config.js");
class TargetGearGroupComponent {
  ...
  groupConfigs(t, r) {
    ...
    if (e) {
      return (r || new target_gear_group_config_js_1.TargetGearGroupConfig()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createTargetGearGroupComponent(t, r, e, o) {
    ...
    return TargetGearGroupComponent.endTargetGearGroupComponent(t);
  }
}
