...
exports.ConveyorBeltComponent = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const conveyor_belt_state_js_1 = require("../fb-component/conveyor-belt-state.js");
class ConveyorBeltComponent {
  ...
  stateGroups(t, e) {
    ...
    if (o) {
      return (e || new conveyor_belt_state_js_1.ConveyorBeltState()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
  ...
  static createConveyorBeltComponent(t, e, o) {
    ...
    return ConveyorBeltComponent.endConveyorBeltComponent(t);
  }
}
