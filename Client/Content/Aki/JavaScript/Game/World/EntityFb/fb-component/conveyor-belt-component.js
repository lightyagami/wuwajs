...
class ConveyorBeltComponent {
  ...
  static getRootAsConveyorBeltComponent(t, e) {
    return (e || new ConveyorBeltComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsConveyorBeltComponent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new ConveyorBeltComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  stateGroups(t, e) {
    ...
    return o ? (e || new conveyor_belt_state_js_1.ConveyorBeltState).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + o) + 4 * t), this.bb) : void 0
  }
  stateGroupsLength() {
  ...
  static createConveyorBeltComponent(t, e, o) {
    return ConveyorBeltComponent.startConveyorBeltComponent(t), ConveyorBeltComponent.addDisabled(t, e), ConveyorBeltComponent.addStateGroups(t, o), ConveyorBeltComponent.endConveyorBeltComponent(t)
  }
}
