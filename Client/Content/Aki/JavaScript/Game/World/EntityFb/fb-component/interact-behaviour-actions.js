...
class InteractBehaviourActions {
  ...
  static getSizePrefixedRootAsInteractBehaviourActions(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new InteractBehaviourActions).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createInteractBehaviourActions(t, i, e) {
    return InteractBehaviourActions.startInteractBehaviourActions(t), InteractBehaviourActions.addType(t, i), InteractBehaviourActions.addActions(t, e), InteractBehaviourActions.endInteractBehaviourActions(t)
  }
}
