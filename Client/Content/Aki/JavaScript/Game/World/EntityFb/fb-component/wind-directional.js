...
exports.WindDirectional = undefined;
const flatbuffers = require("../../../../RunTimeLibs/FlatBuffers/flatbuffers");
const wind_directional_state_grade_js_1 = require("../fb-component/wind-directional-state-grade.js");
...
class WindDirectional {
  ...
  grades(t, i) {
    ...
    if (e) {
      return (i || new wind_directional_state_grade_js_1.WindDirectionalStateGrade()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + t * 4), this.bb);
    } else {
      return undefined;
    }
  }
