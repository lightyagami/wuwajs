...
class WindDirectional {
  ...
  static getRootAsWindDirectional(t, i) {
    return (i || new WindDirectional).__init(t.readInt32(t.position()) + t.position(), t)
  }
  static getSizePrefixedRootAsWindDirectional(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new WindDirectional).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  grades(t, i) {
    ...
    return e ? (i || new wind_directional_state_grade_js_1.WindDirectionalStateGrade).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + e) + 4 * t), this.bb) : void 0
  }
  gradesLength() {
