...
class DungeonEntryComponent {
  ...
  static getSizePrefixedRootAsDungeonEntryComponent(n, t) {
    return n.setPosition(n.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new DungeonEntryComponent).__init(n.readInt32(n.position()) + n.position(), n)
  }
  disabled() {
  ...
  static createDungeonEntryComponent(n, t) {
    return DungeonEntryComponent.startDungeonEntryComponent(n), DungeonEntryComponent.addDisabled(n, t), DungeonEntryComponent.endDungeonEntryComponent(n)
  }
}
