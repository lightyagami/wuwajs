...
class FreeAngleTurntable {
  ...
  static getSizePrefixedRootAsFreeAngleTurntable(e, t) {
    return e.setPosition(e.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FreeAngleTurntable).__init(e.readInt32(e.position()) + e.position(), e)
  }
  type(e) {
  ...
  itemConfig(e, t) {
    ...
    return r ? (t || new free_angle_item_js_1.FreeAngleItem).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * e), this.bb) : void 0
  }
  itemConfigLength() {
  ...
  static createFreeAngleTurntable(e, t, r, n, i) {
    return FreeAngleTurntable.startFreeAngleTurntable(e), FreeAngleTurntable.addType(e, t), FreeAngleTurntable.addRotationSpeed(e, r), FreeAngleTurntable.addItemConfig(e, n), FreeAngleTurntable.addIntervalAngle(e, i), FreeAngleTurntable.endFreeAngleTurntable(e)
  }
}
