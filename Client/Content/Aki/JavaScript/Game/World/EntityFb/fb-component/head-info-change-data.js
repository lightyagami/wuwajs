...
class HeadInfoChangeData {
  ...
  static getSizePrefixedRootAsHeadInfoChangeData(t, a) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (a || new HeadInfoChangeData).__init(t.readInt32(t.position()) + t.position(), t)
  }
  conditions(t) {
    var a = this.bb.__offset(this.bb_pos, 4);
    return a ? (t || new condition_group_js_1.ConditionGroup).__init(this.bb.__indirect(this.bb_pos + a), this.bb) : void 0
  }
  tidName(t) {
  ...
  static createHeadInfoChangeData(t, a, e, i, n) {
    return HeadInfoChangeData.startHeadInfoChangeData(t), HeadInfoChangeData.addConditions(t, a), HeadInfoChangeData.addTidName(t, e), HeadInfoChangeData.addIcon(t, i), HeadInfoChangeData.addTidSecondaryName(t, n), HeadInfoChangeData.endHeadInfoChangeData(t)
  }
}
