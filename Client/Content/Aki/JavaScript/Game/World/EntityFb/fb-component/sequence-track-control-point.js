...
class SequenceTrackControlPoint {
  ...
  static getSizePrefixedRootAsSequenceTrackControlPoint(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new SequenceTrackControlPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  mark(t) {
  ...
  static createSequenceTrackControlPoint(t, e) {
    return SequenceTrackControlPoint.startSequenceTrackControlPoint(t), SequenceTrackControlPoint.addMark(t, e), SequenceTrackControlPoint.endSequenceTrackControlPoint(t)
  }
}
