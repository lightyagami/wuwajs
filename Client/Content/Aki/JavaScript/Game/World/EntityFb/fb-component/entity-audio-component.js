...
class EntityAudioComponent {
  ...
  static getSizePrefixedRootAsEntityAudioComponent(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new EntityAudioComponent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  disabled() {
  ...
  static createEntityAudioComponent(t, i, n, e, o) {
    return EntityAudioComponent.startEntityAudioComponent(t), EntityAudioComponent.addDisabled(t, i), EntityAudioComponent.addAkEventTypeType(t, n), EntityAudioComponent.addAkEventType(t, e), EntityAudioComponent.addAudioRangeType(t, o), EntityAudioComponent.endEntityAudioComponent(t)
  }
}
