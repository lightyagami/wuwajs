...
class ExploreSkillCustom {
  ...
  static getSizePrefixedRootAsExploreSkillCustom(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ExploreSkillCustom).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createExploreSkillCustom(t, i, s, o) {
    return ExploreSkillCustom.startExploreSkillCustom(t), ExploreSkillCustom.addType(t, i), ExploreSkillCustom.addLockConfigId(t, s), ExploreSkillCustom.addActions(t, o), ExploreSkillCustom.endExploreSkillCustom(t)
  }
}
