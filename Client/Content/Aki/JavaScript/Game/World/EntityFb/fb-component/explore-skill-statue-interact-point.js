...
class ExploreSkillStatueInteractPoint {
  ...
  static getSizePrefixedRootAsExploreSkillStatueInteractPoint(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new ExploreSkillStatueInteractPoint).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createExploreSkillStatueInteractPoint(t, i, e, r) {
    return ExploreSkillStatueInteractPoint.startExploreSkillStatueInteractPoint(t), ExploreSkillStatueInteractPoint.addType(t, i), ExploreSkillStatueInteractPoint.addPullTime(t, e), ExploreSkillStatueInteractPoint.addHangingPointList(t, r), ExploreSkillStatueInteractPoint.endExploreSkillStatueInteractPoint(t)
  }
}
