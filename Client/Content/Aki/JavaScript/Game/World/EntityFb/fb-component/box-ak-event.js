...
class BoxAkEvent {
  ...
  static getSizePrefixedRootAsBoxAkEvent(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new BoxAkEvent).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type(t) {
  ...
  static createBoxAkEvent(t, e, i, s) {
    return BoxAkEvent.startBoxAkEvent(t), BoxAkEvent.addType(t, e), BoxAkEvent.addAudioType(t, i), BoxAkEvent.addPriority(t, s), BoxAkEvent.endBoxAkEvent(t)
  }
}
