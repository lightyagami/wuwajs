...
class AreaBouns {
  ...
  static getSizePrefixedRootAsAreaBouns(t, e) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (e || new AreaBouns).__init(t.readInt32(t.position()) + t.position(), t)
  }
  type() {
  ...
  static createAreaBouns(t, e) {
    return AreaBouns.startAreaBouns(t), AreaBouns.addType(t, e), AreaBouns.endAreaBouns(t)
  }
}
