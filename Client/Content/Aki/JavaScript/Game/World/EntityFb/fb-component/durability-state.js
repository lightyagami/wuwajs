...
class DurabilityState {
  ...
  static getSizePrefixedRootAsDurabilityState(t, i) {
    return t.setPosition(t.position() + flatbuffers.SIZE_PREFIX_LENGTH), (i || new DurabilityState).__init(t.readInt32(t.position()) + t.position(), t)
  }
  durability() {
  ...
  static createDurabilityState(t, i, a) {
    return DurabilityState.startDurabilityState(t), DurabilityState.addDurability(t, i), DurabilityState.addState(t, a), DurabilityState.endDurabilityState(t)
  }
}
