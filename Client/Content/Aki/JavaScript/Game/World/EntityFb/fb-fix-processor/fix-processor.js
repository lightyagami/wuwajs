...
class FixProcessor {
  ...
  static getSizePrefixedRootAsFixProcessor(s, t) {
    return s.setPosition(s.position() + flatbuffers.SIZE_PREFIX_LENGTH), (t || new FixProcessor).__init(s.readInt32(s.position()) + s.position(), s)
  }
  fixActions(s, t) {
    var r = this.bb.__offset(this.bb_pos, 4);
    return r ? (t || new fix_action_js_1.FixAction).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * s), this.bb) : void 0
  }
  fixActionsLength() {
  ...
  static createFixProcessor(s, t) {
    return FixProcessor.startFixProcessor(s), FixProcessor.addFixActions(s, t), FixProcessor.endFixProcessor(s)
  }
}
