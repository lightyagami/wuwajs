...
class CreateCharacterInputDistribute extends InputDistributeSetup_1.InputDistributeSetup {
  OnRefresh() {
    return !!UiManager_1.UiManager.IsViewShow("CreateCharacterView") && (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]在创角中，则设置输入分发tag为 UiInputRootTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.UiInputRootTag), !0)
  }
}
