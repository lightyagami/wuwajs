...
class BlockInputDistribute extends InputDistributeSetup_1.InputDistributeSetup {
  OnRefresh() {
    {
      var t;
      return this.Bc_() ? (ModelManager_1.ModelManager.SeamlessTravelModel?.IsSeamlessTravel ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 50, "[InputDistribute]无缝加载过渡场景中，使用无缝加载设置的输入分发tag"), this.SetInputDistributeTags(ModelManager_1.ModelManager.SeamlessTravelModel.SeamlessTravelInputDistributeTags)) : (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 50, "[InputDistribute]无缝加载过渡场景中，只允许角色轴向输入"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.FightInputRoot.AxisInputTag)), !0) : this.v$e() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]加载中设置输入分发tag为 MouseInputTag NavigationTag"), this.SetInputDistributeTags([InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.MouseInputTag, InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.NavigationTag]), !0) : this.Udr() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]断线中，则设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : this.oIa() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]Sdk打开界面，则设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : this.Adr() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 17, "[InputDistribute]战斗结算中设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : ModelManager_1.ModelManager.DeadReviveModel.BlockAllInput ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 48, "[InputDistribute]死亡界面打开中设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : this.EK1() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 45, "[InputDistribute]CG中，则设置输入分发tag为 UiInputRootTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.UiInputRootTag), !0) : this.Pdr() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 45, "[InputDistribute]黑幕中，则设置输入分发tag为 MouseInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.MouseInputTag), !0) : CameraController_1.CameraController.IsSequenceCameraInCinematic() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]玩家角色在播放处决中，大招中等镜头时，只允许角色技能输入，设置输入分发tag为 CharacterSkillInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.FightInputRoot.ActionInput.CharacterSkillInputTag), !0) : ModelManager_1.ModelManager.MapModel?.IsInUnopenedAreaPullback() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]角色进入未开放区域启动拉回，设置输入分发tag为 MouseInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.MouseInputTag), !0) : this.qc_() ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 50, "[InputDistribute]角色处于载具攀瀑状态，禁止所有输入"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : (t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity?.Entity?.GetComponent(205)) && t.HasTag(191377386) ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]角色落水中，则设置输入分发tag为 MouseInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.MouseInputTag), !0) : t?.HasTag(-1266260958) ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 50, "[InputDistribute]角色退出载具中，禁止交互和战斗输入"), this.SetInputDistributeTags([InputDistributeDefine_1.inputDistributeTagDefine.FightInputRoot.AxisInputTag, InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.NavigationTag]), !0) : ModelManager_1.ModelManager.MenuModel?.IsWaitForKeyInput ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]玩家设置按键中，则设置输入分发tag为 NavigationTag"), this.SetInputDistributeTags([InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.NavigationTag, InputDistributeDefine_1.inputDistributeTagDefine.UiInputRoot.MouseInputTag]), !0) : ModelManager_1.ModelManager.GeneralLogicTreeModel.DisableInput ? (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]行为配置禁用输入 设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0) : !!this.dgl() && (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 67, "[InputDistribute]播放Link分屏中 设置输入分发tag为 BlockAllInputTag"), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.BlockAllInputTag), !0)
    }
  }
  Bc_() {
