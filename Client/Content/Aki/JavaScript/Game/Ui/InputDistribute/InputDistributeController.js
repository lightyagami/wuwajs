...
class InputDistributeController extends ControllerBase_1.ControllerBase {
  ...
  static Ore() {
    for (const e of InputDistributeDefine_1.inputDistributeEvents) EventSystem_1.EventSystem.Add(e, this.Gmr);
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OpenView, this.FQe), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OpenViewBegined, this.Nmr), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OpenViewFail, this.Omr), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.CloseView, this.$Ge), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.WorldDone, this.nye), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.ResetModuleByResetToBattleView, this.OAo)
  }
  static kre() {
    for (const e of InputDistributeDefine_1.inputDistributeEvents) EventSystem_1.EventSystem.Remove(e, this.Gmr);
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OpenView, this.FQe), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OpenViewBegined, this.Nmr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OpenViewFail, this.Omr), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.CloseView, this.$Ge), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.WorldDone, this.nye), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.ResetModuleByResetToBattleView, this.OAo)
  }
  static kmr() {
    ModelManager_1.ModelManager.InputDistributeModel.ClearAllNotAllowFightInputViewNames(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnClearNotAllowFightInputViewName)
  }
  ...
  static InputAxis(e, t, n = !1) {
    Math.abs(t) <= InputDistributeDefine_1.AXIS_TOLERANCE ? ModelManager_1.ModelManager.InputDistributeModel?.InputAxis(e, 0, n) : ModelManager_1.ModelManager.InputDistributeModel?.InputAxis(e, t, n)
  }
  ...
  Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "当世界加载完成时，清理所有输入分发Tag"), InputDistributeController.kmr()
}, InputDistributeController.OAo = () => {
  Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]当回到主界面时，清理所有输入分发Tag"), InputDistributeController.kmr()
}, InputDistributeController.FQe = e => {
  ConfigManager_1.ConfigManager.InputDistributeConfig.IsViewAllowFightInput(e) || (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]当打开界面时, 记录不允许输入的界面", ["viewName", e]), ModelManager_1.ModelManager.InputDistributeModel.AddNotAllowFightInputViewName(e)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnAddNotAllowFightInputViewName)
}, InputDistributeController.$Ge = e => {
  ConfigManager_1.ConfigManager.InputDistributeConfig.IsViewAllowFightInput(e) || (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]当关闭界面时, 删除不允许输入的界面", ["viewName", e]), ModelManager_1.ModelManager.InputDistributeModel.RemoveNotAllowFightInputViewName(e)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRemoveNotAllowFightInputViewName)
}, InputDistributeController.Nmr = e => {
  ConfigManager_1.ConfigManager.InputDistributeConfig.IsViewAllowFightInput(e) || (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]当打开界面开始时, 将界面添加至“不允许战斗输入”Set中", ["viewName", e]), ModelManager_1.ModelManager.InputDistributeModel.AddNotAllowFightInputViewName(e)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnAddNotAllowFightInputViewName)
}, InputDistributeController.Omr = e => {
  ConfigManager_1.ConfigManager.InputDistributeConfig.IsViewAllowFightInput(e) || (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]当打开界面结束时, 清理“不允许战斗输入”Set", ["viewName", e]), ModelManager_1.ModelManager.InputDistributeModel.RemoveNotAllowFightInputViewName(e)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnRemoveNotAllowFightInputViewName)
};
