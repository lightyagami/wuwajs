...
class InputDistributeController extends ControllerBase_1.ControllerBase {
  ...
  static Ore() {
    ...
    EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.FloatQueueCloseView, this.Ywm);
  ...
  static kre() {
    ...
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.FloatQueueCloseView, this.Ywm);
...
InputDistributeController.Ywm = (e, t) => {
  if (!ConfigManager_1.ConfigManager.InputDistributeConfig.IsViewAllowFightInput(e)) {
    if (Log_1.Log.CheckInfo()) {
