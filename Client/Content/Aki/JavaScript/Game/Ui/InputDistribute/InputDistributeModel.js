...
const Info_1 = require("../../../Core/Common/Info"),
  ...
  EMIT_EVENT_AXIS_DELTA = .05;
class InputDistributeModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Ymr = [], this.Z6a = [], this.Jmr = new Set, this.zmr = [], this.Zmr = new Map, this.edr = new Map, this.tdr = new Map, this.idr = new Map, this.odr = new Map, this.rdr = new Map, this.ndr = new Set, this.sdr = void 0, this.hdr = void 0, this.e8a = new Map, this.ldr = 0
  }
  OnInit() {
    return this._dr(), this.udr(), this.cdr(), this.mdr(), this.ddr(), this.Cdr(), this.SetInputDistributeTag(InputDistributeDefine_1.inputDistributeTagDefine.FightInputRootTag), !0
  }
  OnClear() {
    this.ClearAllNotAllowFightInputViewNames(), this.Zmr.clear(), this.zmr.length = 0;
  ...
  InputAction(i, e) {
    var t = this.Mdr(i);
    if (!t) return Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "输入Action时，没有对应的ActionHandle", ["actionName", i]), !1;
    if (t.SetIsPress(e), InputDistributeDelay_1.delayInput.includes(i)) {
      let t = void 0;
      this.edr.has(i) ? t = this.edr.get(i) : (t = new InputDistributeDelay_1.InputDistributeDelay, this.edr.set(i, t)), t.CheckCondition(i, e) && t.StartDelay(ConfigManager_1.ConfigManager.LevelGamePlayConfig.InteractInputCacheTime, e)
    }
    if (this.HasActionLimitSet()) {
      if (!this.IsActionInLimitSet(i)) return !1
    } else {
      var n = t.GetInputDistributeTag();
      if (n && !this.IsTagMatchAnyCurrentInputTag(n)) return t.InputActionIgnoreLimit(e), !1;
      if (!this.nNa(i, n)) return !1
    }
    return t.InputAction(e), t.InputActionIgnoreLimit(e), e ? this.sdr = i : this.sdr && (this.sdr = void 0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInputChangeForCond), !0
  }
  nNa(t, i) {
    var i = this.Sdr(i);
  ...
  InputAxis(t, i, e = !1) {
    ...
    if (n) {
      if (this.HasActionLimitSet()) {
        if (!this.IsActionInLimitSet(t)) return void(Info_1.Info.AxisInputOptimize && (0 !== n.GetCacheAxisValue() || e) && n.InputAxis(0))
      } else {
        var s = n.GetInputDistributeTag();
        if (s && !this.IsTagMatchAnyCurrentInputTag(s)) return void(Info_1.Info.AxisInputOptimize && (0 !== n.GetCacheAxisValue() || e) && n.InputAxis(0));
        if (!this.sNa(t, s)) return void(Info_1.Info.AxisInputOptimize && (0 !== n.GetCacheAxisValue() || e) && n.InputAxis(0))
      }
      n.InputAxis(i), this.Idr(t, i), 0 < Math.abs(i) ? this.hdr = t : this.hdr && (this.hdr = void 0)
    }
  }
  Idr(t, i) {
    this.sdr !== t && (this.ldr = 0), Math.abs(i) && Math.abs(i - this.ldr) > EMIT_EVENT_AXIS_DELTA && (this.sdr = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInputChangeForCond), this.ldr = i)
  }
  GetCurrentAxisName() {
    return this.hdr
  }
  InputTouch(t, i) {
    var e, n = this.Tdr(t);
    n ? (e = n.GetInputDistributeTag()) && !this.IsTagMatchAnyCurrentInputTag(e) || n.InputTouch(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "输入Action时，没有对应的ActionHandle", ["touchId", t])
  }
  BindAction(t, i) {
    var e = this.Mdr(t);
    e ? e.BindAction(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "绑定Action回调时，没有对应的ActionHandle", ["actionName", t])
  }
  ExecuteDelayInputAction(t) {
    var i = this.Mdr(t);
    i && this.edr.has(t) && this.edr.get(t).IsInputActive(!1) && i.InputAction(!1)
  }
  BindActions(t, i) {
  ...
  UnBindAction(t, i) {
    var e = this.Mdr(t);
    e ? e.UnBindAction(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "取消绑定Action回调时，没有对应的ActionHandle", ["actionName", t])
  }
  UnBindActions(t, i) {
  ...
  BindActionIgnoreLimit(t, i) {
    var e = this.Mdr(t);
    e ? e.BindActionIgnoreLimit(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "绑定Action回调时，没有对应的ActionHandle", ["actionName", t])
  }
  UnBindActionIgnoreLimit(t, i) {
    var e = this.Mdr(t);
    e ? e.UnBindActionIgnoreLimit(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "取消绑定Action回调时，没有对应的ActionHandle", ["actionName", t])
  }
  gdr(t, i) {
  ...
  BindAxis(t, i) {
    var e = this.ydr(t);
    e ? e.BindAxis(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "绑定Axis回调时，没有对应的ActionHandle", ["axisName", t])
  }
  BindAxes(t, i) {
  ...
  UnBindAxis(t, i) {
    var e = this.ydr(t);
    e ? e.UnBindAxis(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "取消绑定Action回调时，没有对应的ActionHandle", ["axisName", t])
  }
  UnBindAxes(t, i) {
  ...
  BindTouch(t, i) {
    var e = this.Tdr(t);
    e ? e.BindTouch(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "绑定Touch回调时，没有对应的ActionHandle", ["axisName", t])
  }
  BindTouches(t, i) {
  ...
  UnBindTouch(t, i) {
    var e = this.Tdr(t);
    e ? e.UnBindTouch(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "取消绑定Touch回调时，没有对应的ActionHandle", ["axisName", t])
  }
  UnBindTouches(t, i) {
  ...
  BindKey(t, i) {
    var e = this.Ldr(t);
    e ? e.BindAction(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "绑定Key回调时，没有对应的KeyHandle", ["keyName", t])
  }
  UnBindKey(t, i) {
    var e = this.Ldr(t);
    e ? e.UnBindAction(i) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Input", 10, "取消绑定Key回调时，没有对应的KeyHandle", ["keyName", t])
  }
  InputKey(t, i) {
    var e, t = this.Ldr(t);
    !t || (e = t.GetInputDistributeTag()) && !this.IsTagMatchAnyCurrentInputTag(e) || t.InputKey(i)
  }
  ...
  IsAnyInputDistributeTagsMatchTag(t, i, e = !1) {
    for (const n of t)
      if (n.MatchTag(i, e)) return !0;
    return !1
  }
  IsTagMatchAnyInputDistributeTags(t, i, e = !1) {
    var n = this.Sdr(t);
    for (const s of i)
      if (n.MatchTag(s.TagName, e)) return !0;
    return !1
  }
  AddToLimitInputDistributeActions(t) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]设置输入分发限制Action", ["actionName", t]), this.Jmr.add(t)
  }
  ClearLimitInputDistributeActions() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]清除输入分发限制Action"), this.Jmr.clear()
  }
  HasActionLimitSet() {
  ...
  AddInputDistributeTag(t) {
    this.Rdr(t) && (Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]添加输入分发Tag", ["tagName", t]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInputDistributeTagChanged, this.Ymr), this.xMe())
  }
  Rdr(t) {
    t = this.Sdr(t);
  ...
  SetInputDistributeTag(t) {
    var i = this.Sdr(t);
    i && (this.Ymr = [i], Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]设置输入分发Tag", ["tagName", t]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInputDistributeTagChanged, this.Ymr), this.xMe())
  }
  SetInputDistributeTags(t) {
    this.ClearInputDistributeTag();
    for (const i of t) this.Rdr(i);
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Input", 10, "[InputDistribute]设置输入分发Tag", ["tagNames", t]), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnInputDistributeTagChanged, this.Ymr), this.xMe()
  }
  ...
  t8a(t, i, e) {
    for (const n of t) try {
      ...
      t instanceof Error ? Log_1.Log.CheckError() && Log_1.Log.ErrorWithStack("Input", 37, "[InputDistribute]Tag事件回调执行异常", t, ["tag", i], ["error", t.message]) : Log_1.Log.CheckError() && Log_1.Log.Error("Input", 37, "[InputDistribute]Tag事件回调执行异常", ["tag", i], ["error", t])
    }
  }
