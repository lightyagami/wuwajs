...
class UiPrefabLoadModule {
  ...
  async LoadPrefabAsync(e, r) {
    if (GlobalData_1.GlobalData.World) {
      ...
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiPrefabLoad", 10, "资源加载开始", ["路径", e]);
      var o = ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.PrefabAsset, (e, o) => {
          ...
          s.SetResult(e), Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiPrefabLoad", 10, "资源加载完成", ["路径", o])
        }, 102),
        e = (o !== ResourceSystem_1.ResourceSystem.InvalidId && this.ogr.set(o, e), await s.Promise);
      return this.ogr.delete(o), e
    }
  }
  Clear() {
    for (var [e, o] of this.ogr) ResourceSystem_1.ResourceSystem.CancelAsyncLoad(e), Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiPrefabLoad", 10, "资源加载取消", ["路径", o]);
    this.ogr.clear()
  }
}
