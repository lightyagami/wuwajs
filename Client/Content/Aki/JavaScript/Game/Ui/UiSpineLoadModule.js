...
class UiSpineAtlasLoadModule extends UiResourceLoadModule_1.UiResourceLoadModule {
  async LoadAtlasAssetAsync(e, o) {
    if (GlobalData_1.GlobalData.World && o && o.IsValid()) {
      ...
      e = ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.SpineAtlasAsset, (e, s) => {
        t.SetResult(), this.DeleteResourceHandle(o), o.IsValid() && (o.Atlas = e)
      });
...
class UiSpineSkeletonLoadModule extends UiResourceLoadModule_1.UiResourceLoadModule {
  async LoadAtlasAssetAsync(e, o) {
    if (GlobalData_1.GlobalData.World && o && o.IsValid()) {
      this.CancelResource(o);
      const t = new CustomPromise_1.CustomPromise;
      e = ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.SpineSkeletonDataAsset, (e, s) => {
        t.SetResult(), this.DeleteResourceHandle(o), o.IsValid() && (o.SkeletonData = e)
      });
      this.SetResourceId(o, e), await t.Promise
    }
  }
...
class UiSpineLoadModule {
  constructor() {
    this.BAr = new UiSpineAtlasLoadModule, this.bAr = new UiSpineSkeletonLoadModule
  }
