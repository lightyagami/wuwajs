...
class UiSequencePlayer {
  constructor(e) {
    this.rur = new Map, this.SPe = void 0, this.$xt = void 0, this.Yxt = void 0, this.K3t = t => {
      this.rur.set(t, 2), this.$xt?.forEach(e => {
        e(t)
      })
    }, this.nur = t => {
      this.rur.set(t, 1), this.Yxt?.forEach(e => {
        e(t)
      })
    }, this.a$a = void 0, this.hFl = void 0, this.SPe = new LevelSequencePlayer_1.LevelSequencePlayer(e), this.SPe.BindSequenceCloseEvent(this.K3t), this.SPe.BindSequenceStartEvent(this.nur)
  }
  sur(e) {
    this.rur.delete(e)
  }
  ...
  async PlaySequenceAsyncNoStopRunning(e, t, i = !1, s = !1, h = void 0) {
  ...
  async LitePlayAsync(e, t = !1, i = !1) {
    var s;
    return !this.a$a && (s = new CustomPromise_1.CustomPromise, !!this.SPe) && (this.a$a = e, this.hFl = s, this.SPe.PlaySequencePurely(e, t, i, s), e = await s.Promise, this.a$a = void 0, this.hFl = void 0, e)
  }
  async LiteReplayAsync(e, t = !1, i = !1) {
    var s;
    return void 0 !== this.a$a && void 0 !== this.hFl ? (this.SPe?.SequenceJumpToStartWhenPlaying(this.a$a), s = await this.hFl.Promise, this.a$a = void 0, this.hFl = void 0, s) : this.LitePlayAsync(e, t, i)
  }
  LiteStop() {
    this.SPe && this.a$a && this.hFl && this.SPe.StopSequenceByKey(this.a$a, !1, !1), this.a$a = void 0, this.hFl = void 0
  }
  LiteExit() {
    this.LiteStop(), this.Clear()
  }
  LiteJumpToEnd(e) {
    this.SPe && (this.LitePlayAsync(e, !0, !1), this.SPe.EndSequenceLastFrame(e), this.LiteStop())
  }
  async LiteWaitFor(e) {
    return void 0 !== this.SPe && void 0 !== (e = this.SPe.GetCurrentStopPromise(e)) && e.Promise
  }
}
