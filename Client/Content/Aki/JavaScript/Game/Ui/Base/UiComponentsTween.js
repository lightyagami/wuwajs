...
class UiComponentsTween {
  ...
  SetUiComponentsTweenData(t) {
    t && (this.B_r = new UiComponentsTweenData(t.GetTweenAlpha(), t.GetTweenSize(), t.GetTweenTime()))
  }
  PlayStartTween() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiCore", 10, "关卡序列:播放界面间的Tween"), this.CollectUnSafeItem(), this.q_r()
  }
  PlayCloseTween() {
    this.q_r(!0)
  }
