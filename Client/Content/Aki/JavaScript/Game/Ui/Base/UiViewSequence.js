...
class UiBehaviorLevelSequence {
  constructor(e) {
    this.rcr = void 0, this.ncr = "Start", this.scr = "Close", this.dva = "ShowView", this.mva = "HideView", this.acr = new Map, this.hcr = new Map, this.lcr = "", this.OQt = void 0, this.owt = e => {
  ...
  OnAfterUiStart() {
    this.rcr = new UiSequencePlayer_1.UiSequencePlayer(this.OQt.GetRootItem()), this.rcr.BindOnStartSequenceEvent(this.owt), this.rcr.BindOnEndSequenceEvent(this._cr)
  }
  IsInSequence() {
  ...
  SetSequenceName(e) {
    e && (this.ncr = e.StartSequenceName ?? "Start", this.scr = e.CloseSequenceName ?? "Close")
  }
  AddSequenceFinishEvent(e, t, i = !1) {
    let s = this.acr.get(e);
    s ? i && s.clear() : (s = new Set, this.acr.set(e, s)), s.has(t) ? Log_1.Log.CheckError() && Log_1.Log.Error("UiCore", 3, "SequenceFinishEvent重复添加。") : s.add(t)
  }
  ...
  AddSequenceStartEvent(e, t) {
    ...
    i || (i = new Set, this.hcr.set(e, i)), i.has(t) ? Log_1.Log.CheckError() && Log_1.Log.Error("UiCore", 27, "AddSequenceStartEvent重复添加。") : i.add(t)
  }
  ...
  PlaySequence(e, t = !1, i = void 0) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiCore", 27, "开始PlaySequence", ["Name", e]), this.lcr = e, this.rcr.PlaySequence(e, t, i)
  }
  get CurrentSequenceName() {
    return this.lcr
  }
  async PlaySequenceAsync(e, t, i = !1, s = !1, n = void 0) {
    this.lcr = e, await this.rcr?.PlaySequenceAsync(e, t, i, s, n)
  }
  async PlaySequenceAsyncNoStopRunning(e, t, i = !1, s = !1, n = void 0) {
    this.lcr = e, await this.rcr?.PlaySequenceAsyncNoStopRunning(e, t, i, s, n)
  }
  PlaySequencePurely(e, t = !1, i = !1) {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("UiCore", 27, "开始PurePlaySequence", ["Name", e]), this.lcr = e, this.rcr?.PlaySequencePurely(e, t, i)
  }
  PauseSequence() {
  ...
  OnBeforeDestroy() {
    this.rcr && (this.rcr.Clear(), this.rcr = void 0), this.acr.clear(), this.hcr.clear()
  }
}
