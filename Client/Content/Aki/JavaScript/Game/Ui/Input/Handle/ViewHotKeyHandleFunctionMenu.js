...
class ViewHotKeyHandleFunctionMenu extends ViewHotKeyHandle_1.ViewHotKeyHandle {
  SpecialConditionCheck() {
    return !(ControllerHolder_1.ControllerHolder.GameModeController.IsInInstance() || !ModelManager_1.ModelManager.BattleUiModel.ChildViewData.GetChildVisible(2)) || (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.InputDistribute, this.ActionName), !1)
  }
  CheckHasInputLimit() {
