...
class ImmersiveMouseModule {
  constructor() {
    ...
    this.LLm = [InputMappingsDefine_1.actionMappings.Ui左键点击, InputMappingsDefine_1.actionMappings.Ui右键点击];
  ...
  EnableImmersiveMode() {
    if (!this.KLd && this.PLm && (this.KLd = true, this.sKe = TickSystem_1.TickSystem.Add(this.Tick, "ImmersiveMouseModule", 0, true, undefined, true).Id, ControllerHolder_1.ControllerHolder.InputDistributeController.BindActions(this.LLm, this.Ndr), this.aJf = this.hJf(), Log_1.Log.CheckDebug())) {
      Log_1.Log.Debug("Input", 43, "[ImmersiveMouseModule] 开启鼠标沉浸模式 ");
    }
  }
  DisableImmersiveMode() {
    if (this.KLd && (this.KLd = false, this.Reset(), this.sKe !== TickSystem_1.TickSystem.InvalidId && (TickSystem_1.TickSystem.Remove(this.sKe), this.sKe = TickSystem_1.TickSystem.InvalidId), ControllerHolder_1.ControllerHolder.InputDistributeController.UnBindActions(this.LLm, this.Ndr), Log_1.Log.CheckDebug())) {
