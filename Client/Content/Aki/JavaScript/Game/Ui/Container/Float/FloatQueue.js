...
class FloatViewQueue {
  ...
  Delete(r, i) {
    for (let e = 0, t = this.vcr.length; e < t; ++e) {
      var s = this.vcr[e];
      if (!(s.ViewBase.Info.Name !== r || i && s.ViewBase.GetViewId() !== i)) return this.Mcr(s), UiManager_1.UiManager.RemoveView(s.ViewBase.GetViewId()), !0
    }
    return !1
  }
  Has(r) {
  ...
  Clear() {
    for (let e = this.vcr.length - 1; 0 <= e; --e) {
      ...
      t.Info.IsPermanent || (this.vcr.pop(), UiManager_1.UiManager.RemoveView(t.GetViewId()))
    }
  }
  get Size() {
