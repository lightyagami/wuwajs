...
class LguiEventSystemManager {
  ...
  static async Initialize() {
    var e;
    LguiEventSystemManager.ZCe || (LguiEventSystemManager.ZCe = !0, e = await LguiUtil_1.LguiUtil.LoadPrefabByResourceIdAsync("UiItem_LGUIEventSystem_Actor", void 0), LguiEventSystemManager.Odr = e, LguiUtil_1.LguiUtil.SetActorIsPermanent(LguiEventSystemManager.Odr, !0, !0)), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.LoadLguiEventSystemActor), LguiEventSystemManager.Odr.InitializeLguiEventSystemActor(), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.InitializeLguiEventSystemActor)
  }
  static Clear() {
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.DestroyLguiEventSystemActor), LguiEventSystemManager.Odr.ResetLguiEventSystemActor()
  }
