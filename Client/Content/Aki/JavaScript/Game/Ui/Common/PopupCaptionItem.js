...
class PopupCaptionItem extends UiPanelBase_1.UiPanelBase {
  constructor(t) {
    super(), this.ucr = void 0, this.S1a = void 0, this.NUc = void 0, this.OnClickCloseBtnCall = () => {}, this.OnClickHelpBtnCall = () => {}, this.Jvt = () => {
  ...
  async SetCurrencyItemList(t) {
    this.ucr || (this.ucr = new CommonCurrencyItemListComponent_1.CommonCurrencyItemListComponent(this.GetItem(4))), await this.ucr.SetCurrencyItemList(t)
  }
  GetCurrencyItemList() {
  ...
  async CreateToggleTab(t) {
    this.S1a = new PopupCaptionToggleItem_1.PopupCaptionToggleItem, await this.S1a.CreateByResourceIdAsync("TogTabCName", this.GetItem(5)), this.S1a.SetClickToggleCallback(t)
  }
  SetToggleName(t) {
  ...
  async CreateCaptionStateItem(t) {
    this.NUc = new PopupCaptionStateItem_1.PopupCaptionStateItem, await this.NUc.CreateByResourceIdAsync("PnlCaptionStateA", this.GetItem(5)), this.NUc.BindClick(t)
  }
