...
exports.PopupTypeSmallItem = undefined;
const UE = require("ue");
...
class PopupTypeSmallItem extends CommonPopViewBehaviourBase_1.CommonPopViewBase {
  ...
  OnRegisterComponent() {
    this.ComponentRegisterInfos = [[0, UE.UIButtonComponent], [1, UE.UIItem], [2, UE.UIButtonComponent], [3, UE.UIItem]];
    this.BtnBindInfo = [[0, this.OnClickMaskButton], [2, this.OnClickCloseBtn]];
  }
