...
exports.UiCommonConfig = undefined;
...
class UiCommonConfig extends ConfigBase_1.ConfigBase {
  GetNpcSystemBackgroundByViewName(e) {
    return NpcSystemBackgroundByViewName_1.configNpcSystemBackgroundByViewName.GetConfig(e);
  }
  GetInteractBackgroundByViewName(e) {
    return InteractBackGroundByViewName_1.configInteractBackGroundByViewName.GetConfig(e);
  }
}
