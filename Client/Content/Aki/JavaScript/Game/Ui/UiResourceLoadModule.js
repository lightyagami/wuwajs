...
class UiResourceHandle {
  constructor(e) {
    this.ResourceId = ResourceSystem_1.ResourceSystem.InvalidId, this.Object = e
  }
  CancelResource() {
    this.ResourceId !== ResourceSystem_1.ResourceSystem.InvalidId && ResourceSystem_1.ResourceSystem.CancelAsyncLoad(this.ResourceId)
  }
}
...
class UiResourceLoadModule {
  ...
  CancelResource(e) {
    ...
    s ? s.CancelResource() : (s = new UiResourceHandle(e), this.rgr.set(e, s))
  }
  SetResourceId(e, s) {
    e = this.rgr.get(e);
    e && (e.ResourceId = s)
