  ...
  static RegisterUiTsInfo(e) {
    for (const r of e) {
      ...
      try {
        ...
        e instanceof Error ? Log_1.Log.CheckError() && Log_1.Log.ErrorWithStack("UiCore", 16, "[RegisterUiTsInfo]流程执行异常 1", e, ["error", e.message], ["ViewName", o]) : Log_1.Log.CheckError() && Log_1.Log.Error("UiCore", 16, "[RegisterUiTsInfo]流程执行异常 2", ["ViewName", o], ["error", e]);
        continue
      }
    }
  }
