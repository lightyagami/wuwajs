...
exports.UiInteractChatData = undefined;
const Time_1 = require("../../../Core/Common/Time");
const MathUtils_1 = require("../../../Core/Utils/MathUtils");
const IQuest_1 = require("../../../UniverseEditor/Interface/IQuest");
const ModelManager_1 = require("../../Manager/ModelManager");
class UiInteractChatData {
  constructor() {
    this.APu = 0;
    this.tEt = 0;
    this.OldRound = 0;
  ...
  TriggerOpen() {
    ...
    this.OldRound = this.L$d();
    this.UseSkillId = this.P$d();
  }
  TriggerClose() {
    this.tEt = Time_1.Time.ServerTimeStamp;
    this.NewRound = this.L$d();
    this.IsStart = false;
  }
  Reset() {
    this.APu = 0;
...
exports.UiInteractChatData = UiInteractChatData;
//# sourceMappingURL=UiInteractChatData.js.map