...
class EffectRuntimeGhostEffectContext extends SkeletalMeshEffectContext_1.SkeletalMeshEffectContext {
  constructor() {
    super(...arguments), this.SpawnRate = -0, this.UseSpawnRate = !1, this.SpawnInterval = 0, this.GhostLifeTime = -0
  }
  ToKuroEffectContext(t) {
    super.ToKuroEffectContext(t), t instanceof cpp_1.FEffectRuntimeGhostEffectContext && (t.SpawnRate = this.SpawnRate, t.UseSpawnRate = this.UseSpawnRate, t.SpawnInterval = this.SpawnInterval, t.GhostLifeTime = this.GhostLifeTime)
  }
}
