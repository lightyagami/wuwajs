...
class GameSettingsUtils {
  ...
  static ApplyShadowQuality(e) {
    return UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "sg.ShadowQuality " + e), GameSettingsManager_1.GameSettingsManager.ReApply(GameSettingsDefine_1.EFunction.SCENEAO), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(808, e.toString()), !0
  }
  static ApplyDisplayMode(e) {
    var a = [1, 2],
      e = a[MathUtils_1.MathUtils.Clamp(e, 0, a.length - 1)],
      a = UE.GameUserSettings.GetGameUserSettings();
    return a.SetFullscreenMode(e), a.ApplySettings(!0), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SetDisplayMode), !0
  }
  ...
  static ApplyNvidiaSuperSamplingSharpness(e) {
    return !!GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsDlssGpuDevice() && (GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsNvidiaDlssPluginLoaded() && UE.DLSSLibrary.SetDLSSSharpness(e), !0)
  }
  static ApplyNvidiaReflex(e) {
    return !0
  }
  static ApplyFsrEnable(e) {
    return !GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsDlssGpuDevice() && !GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsMetalFxDevice() && (Info_1.Info.IsGamepadPlatform() ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAASamples 4"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.FidelityFX.FSR.PrimaryUpscale 1"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.ScreenPercentage 77"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MipMapLODBias -0.3765"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAACurrentFrameWeight 0.09")) : (Info_1.Info.IsPcPlatform() ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.NGX.DLSS.Enable 0"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAASamples 4"), 1 === e ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.FidelityFX.FSR.PrimaryUpscale 1"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.ScreenPercentage 77"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MipMapLODBias -0.3765"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAACurrentFrameWeight 0.09")) : (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.FidelityFX.FSR.PrimaryUpscale 0"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.ScreenPercentage 100"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MipMapLODBias 0.0"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAACurrentFrameWeight 0.25"))) : 1 === e ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.FidelityFX.FSR.PrimaryUpscale 1"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.ClampTolerant 0"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.SharpenLimitDepth 10")) : (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.FidelityFX.FSR.PrimaryUpscale 0"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.ClampTolerant 2"), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.SharpenLimitDepth -1")), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(813, e.toString())), !0)
  }
  static ApplyXessEnable(e) {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 40, "ApplyXessEnable", ["XessEnable", e]), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.XeSS.Enabled " + e), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(804, e.toString()), !0
  }
  static ApplyXessQuality(e) {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 40, "ApplyXessQuality", ["XessQuality", e]), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.XeSS.Enabled " + e), !0
  }
  static ApplyMetalFxEnable(e) {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 40, "ApplyMetalFxEnable", ["MetalFxEnable", e]), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MetalFxUpscale " + e), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.SharpenLimitDepth " + (1 === e ? 20 : -1)), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(818, e.toString()), !0
  }
  static ApplyBloomEnable(e) {
    return UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Kuro.KuroBloomEnable " + e), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(811, e.toString()), !0
  }
  static ApplyIrxEnable(e) {
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 40, "ApplyIrxEnable", ["IrxEnable", e]), 1 === e ? GameSettingsDeviceRender_1.GameSettingsDeviceRender.TurnOnIRX() : GameSettingsDeviceRender_1.GameSettingsDeviceRender.TurnOffIRX(), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(804, e.toString()), !0
  }
  static ApplySceneLightQuality(e) {
    var a;
    return Info_1.Info.IsMobilePlatform() ? GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsIosAndAndroidHighDevice() ? (a = [1, 2, 3, 4, 4], UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Kuro.GlobalLightQuality " + a[e])) : (a = [1, 2, 3, 3, 3], UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Kuro.GlobalLightQuality " + a[e])) : (a = [4, 4, 4, 4, 5], UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Kuro.GlobalLightQuality " + a[e])), !0
  }
  static ApplyVolumeFog(e) {
    return !!GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsEnableVolumeFog() && (Info_1.Info.IsPcOrGamepadPlatform() && (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.volumetricfog " + e), PerfSightController_1.PerfSightController.IsEnable) && UE.PerfSightHelper.PostEvent(809, e.toString()), !0)
  }
  static ApplyVolumeLight(e) {
    var a;
    return Info_1.Info.IsPcOrGamepadPlatform() && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.lightShaftQuality " + e), Info_1.Info.IsMobilePlatform() && (a = GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsIosAndAndroidHighDevice(), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MobileLightShaft " + (a ? e : 0))), !0
  }
  static ApplyMotionBlur(e) {
    return UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.MotionBlur.Amount " + e * (ModelManager_1.ModelManager?.CameraModel?.MotionBlurModifier ?? .2)), !0
  }
  static ApplyMobileResolution(e) {
    if (!Info_1.Info.IsMobilePlatform()) return !1;
    2 === Info_1.Info.PlatformType && (0 === e ? UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.SharpenLimitDepth 50") : UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.SharpenLimitDepth -1"), GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsAndroidPlatformScreenBetter() && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.Sharpness 0.5"), GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsAndroidPlatformScreenBad()) && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.TemporalAA.Sharpness 0.1"), 1 === GameSettingsDeviceRender_1.GameSettingsDeviceRender.InCacheSceneColorMode && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.CacheSceneColor.Start");
    ...
    var t = UE.KismetSystemLibrary.GetConsoleVariableFloatValue("r.MobileContentScaleFactor"),
      r = UE.KismetSystemLibrary.GetConsoleVariableFloatValue("r.SecondaryScreenPercentage.GameViewport");
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 16, "分辨率参数获取", ["r.MobileContentScaleFactor", t]);
    let i = 1;
    var l, n = GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetDefaultScreenResolution().Y;
    return GameSettingsDeviceRender_1.GameSettingsDeviceRender.IsAndroidHighResolutionDevice() && 0 < n ? ((l = GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetDefaultScreenResolution().X) < n && n < 1280 * t ? i = 1280 * t / n : n < l && n < 720 * t && (i = 720 * t / n), l = Math.min(r * i, 100), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.SecondaryScreenPercentage.GameViewport " + l), Log_1.Log.CheckInfo() && Log_1.Log.Info("Game", 40, "分辨率校正", ["deviceScaleCorrect", i], ["secondaryScreenPercentage", r], ["newSecondaryScreenPercentage", l])) : GameSettingsDeviceRender_1.GameSettingsDeviceRender.GetDefaultScreenResolution().Y < 750 && r < 70 && (a = Math.min(1.5 * a, 100)), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(803, e.toString()), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.ScreenPercentage " + a), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Game", 16, "分辨率参数设置", ["r.ScreenPercentage", a]), !0
  }
  ...
  static ApplyCameraShakeStrength(e) {
    ...
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("GameSettings", 64, "相机抖动强度真实值", ["setting value", e], ["strength", a]), ModelManager_1.ModelManager.CameraModel.SetCameraShakeModify(a)
  }
  static ApplyTextLanguage(e) {
    var a, e = GameSettingsManager_1.GameSettingsManager.GetLanguageCodeById(e);
    return !!e && (a = LanguageSystem_1.LanguageSystem.PackageLanguage, LanguageSystem_1.LanguageSystem.PackageLanguage = e, ControllerHolder_1.ControllerHolder.KuroSdkController.PostKuroSdkEvent(16), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.TextLanguageChange, a, e), !0)
  }
  static ApplyTextLanguageOnGameStart(e) {
    e = GameSettingsManager_1.GameSettingsManager.GetLanguageCodeById(e);
    return void 0 !== e && (LanguageSystem_1.LanguageSystem.PackageLanguage = e, !0)
  }
  static ApplyLanguageAudio(e) {
    e = GameSettingsManager_1.GameSettingsManager.GetAudioCodeById(e);
    return !!e && (LanguageSystem_1.LanguageSystem.SetPackageAudio(e, GlobalData_1.GlobalData.World), !0)
  }
  ...
  static ApplyAutoSwitchSkillButtonMode(e) {
    ModelManager_1.ModelManager.BattleUiModel.SetIsAutoSwitchSkillButtonMode(0 === e)
  }
  ...
  static RefreshViewRevertState(e) {
    let a = 0,
      t = 0;
    2 === e && (a = GameSettingsManager_1.GameSettingsManager.GetCurrentValue(GameSettingsDefine_1.EFunction.HorizontalViewRevert) ?? 0, t = GameSettingsManager_1.GameSettingsManager.GetCurrentValue(GameSettingsDefine_1.EFunction.VerticalViewRevert) ?? 0), this.ApplyHorizontalViewRevert(a), this.ApplyVerticalViewRevert(t)
  }
  static Zia(a, e) {
    for (const g of e) {
      var t = g.AxisName,
        ...
        if (l) {
          for (var [n, o] of i) {
            ...
            if (_) {
              let e = 0;
              _ = _.Scale;
              0 === o && (e = a ? 0 < _ ? -_ : _ : 0 < _ ? _ : -_), 1 === o && (e = a ? 0 < _ ? _ : -_ : 0 < _ ? -_ : _), r.set(n, e)
            }
          }
          if (r.size <= 0) return;
          t.SetKeys(r)
  ...
  static ApplyPushEnableState(e, a) {
    0 === e ? ControllerHolder_1.ControllerHolder.KuroPushController.TurnOffPush() : ControllerHolder_1.ControllerHolder.KuroPushController.TurnOnPush(1 === a)
  }
  static ApplyAutoAdjustImageQuality(e) {
    GameSettingsDeviceRender_1.GameSettingsDeviceRender.SetIsAutoAdjustImageQuality(1 === e), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(824, e.toString())
  }
  ...
  static ApplyUiPureMode(e) {
    return 1 === e ? (ControllerHolder_1.ControllerHolder.BattleUiControl.TryOpenPureMode(), !1) : ControllerHolder_1.ControllerHolder.BattleUiControl.TryClosePureMode()
  }
  static ApplyRayTracing(e) {
    0 < e && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "sg.RayTracingQuality " + e);
    var a = UE.BlueprintPathsLibrary.ProjectSavedDir() + "SaveGames/RTX.json";
    return UE.KuroStaticLibrary.FileExists(a) && UE.KuroStaticLibrary.DeleteFile(a), UE.KuroRenderingRuntimeBPPluginBPLibrary.SetRayTracingEnable(0 < e), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(821, e.toString()), !0
  }
  static ApplyRayTracedReflection(e) {
    return 0 < e ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Lumen.Reflections.Allow 1"), Log_1.Log.CheckInfo() && Log_1.Log.Info("GameSettings", 73, "光追反射开启")) : (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Lumen.Reflections.Allow 0"), Log_1.Log.CheckInfo() && Log_1.Log.Info("GameSettings", 73, "光追反射关闭")), PerfSightController_1.PerfSightController.IsEnable && UE.PerfSightHelper.PostEvent(822, e.toString()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.UpdateRayTraceReflection, 0 < e), !0
  }
  ...
  static ApplyRayTracedShadow(e) {
    return 0 < e ? (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.RayTracing.Shadows 1"), Log_1.Log.CheckInfo() && Log_1.Log.Info("GameSettings", 73, "光追阴影开启")) : (UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.RayTracing.Shadows 0"), Log_1.Log.CheckInfo() && Log_1.Log.Info("GameSettings", 73, "光追阴影关闭")), !0
  }
  static ApplySaturationClient(e) {
    let a = 1;
    return e <= 50 && (a = MathUtils_1.MathUtils.Lerp(0, 1, 2 * e / 100)), 50 < e && (a = MathUtils_1.MathUtils.Lerp(1, 2, 2 * (e - 50) / 100)), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Client.Saturation " + a), !0
  }
  static ApplyContrastClient(e) {
    let a = 1;
    return e <= 50 && (a = MathUtils_1.MathUtils.Lerp(.5, 1, 2 * e / 100)), 50 < e && (a = MathUtils_1.MathUtils.Lerp(1, 2, 2 * (e - 50) / 100)), UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Client.Contrast " + a), !0
  }
  static ApplySkinDamageMode(e) {
    CharacterSkinDamageComponent_1.CharacterSkinDamageComponent.EnableSkinDamage = 1 === e, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnResetSkinDamageMode)
  }
  static ApplyAFMEOption(e) {
    GameSettingsDeviceRender_1.GameSettingsDeviceRender.EnableAFME(e)
  }
  static ApplyAutoRun(e) {
    return void 0 !== ModelManager_1.ModelManager.BattleUiModel && void 0 !== ModelManager_1.ModelManager.BattleUiModel.FormationData && (ModelManager_1.ModelManager.BattleUiModel.FormationData.AutoMovingSettingEnable = 0 < e, !0)
  }
  static ApplyAutoSprint(e) {
    return void 0 !== ModelManager_1.ModelManager.BattleUiModel && void 0 !== ModelManager_1.ModelManager.BattleUiModel.FormationData && (ModelManager_1.ModelManager.BattleUiModel.FormationData.AutoSprintSettingEnable = 0 < e, !0)
  }
  static ApplyVulkan(e) {
    return UE.KuroRenderingRuntimeBPPluginBPLibrary.SetVulkanPromotion(0 < e), !0
  }
  static ApplyWaterInteract(e) {
    return ModelManager_1.ModelManager.SceneBattleInteractModel.Open = 0 < e, !0
  }
}
