...
class TsAnimNotifyStateMontageSpeedChange extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(e, t, r) {
    ...
    if (a instanceof TsBaseCharacter_1.default) {
      a.GetEntityNoBlueprint()?.GetComponent(178)?.MainAnimInstance?.Montage_SetPlayRate(undefined, this.MontagePlayRate);
    } else {
  ...
  K2_NotifyEnd(e, t) {
    ...
    if (r instanceof TsBaseCharacter_1.default) {
      r.GetEntityNoBlueprint()?.GetComponent(178)?.MainAnimInstance?.Montage_SetPlayRate(undefined, 1);
    } else {
