...
class TsAnimNotifyStateModifyTough extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(e, o, r) {
    ...
    if (e instanceof TsBaseCharacter_1.default) {
      ...
      try {
        ...
        return Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 19, "在修改被削韧倍率中配置了不合法的id", ["id", t], ["animationName", o?.GetName()]), !0
      }
      ...
      void 0 === i ? Log_1.Log.CheckError() && Log_1.Log.Error("Character", 19, "韧性系数计算表对应id非法", ["id", t], ["animationName", o?.GetName()]) : e && a && a?.Valid && (a.AddToughModifier("ToughRate", i.RatioNormal), a.AddToughModifier("ToughRateOnCounter", i.RatioSpecial), a.ActorComponent.IsAutonomousProxy) && CombatMessage_1.CombatNet.Send(28357, e, Protocol_1.Aki.Protocol.ve_.create({
  ...
  K2_NotifyEnd(t, e) {
    ...
    if (t instanceof TsBaseCharacter_1.default) {
      ...
      void 0 === o ? Log_1.Log.CheckError() && Log_1.Log.Error("Character", 19, "韧性系数计算表对应id非法", ["id", e]) : t?.Valid && (t.RemoveToughModifier("ToughRate", o.RatioNormal), t.RemoveToughModifier("ToughRateOnCounter", o.RatioSpecial))
    }
    return !0
  }
  GetNotifyName() {
