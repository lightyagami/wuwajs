...
class TsAnimNotifyStateResponseSignal extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(e, r, t) {
    ...
    var s;
    var e = e?.GetOwner();
    return e instanceof TsBaseCharacter_1.default && (a = (e = ModelManager_1.ModelManager.CreatureModel.GetEntityById(e.EntityId))?.Entity?.GetComponent(300), s = e?.Entity?.GetComponent(298), !!a && !!s && !(Log_1.Log.CheckDebug() && Log_1.Log.Debug("BasePerform", 50, "[InteractivePerform] 尝试响应交互表现", ["Source", e.PbDataId], ["Signal", this.Signal], ["Context", r?.GetName()]), a.AddResponseSignal(this.Signal), 0));
  }
  K2_NotifyEnd(e, r) {
    var t;
    var e = e?.GetOwner();
    return e instanceof TsBaseCharacter_1.default && (t = (e = ModelManager_1.ModelManager.CreatureModel.GetEntityById(e.EntityId))?.Entity?.GetComponent(300), e = e?.Entity?.GetComponent(298), !!t && !!e && !(t.RemoveResponseSignal(this.Signal), 0));
  }
  GetNotifyName() {
    return "响应交互动作";
  }
