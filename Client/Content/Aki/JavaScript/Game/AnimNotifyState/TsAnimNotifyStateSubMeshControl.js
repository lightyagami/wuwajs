...
class TsAnimNotifyStateSubMeshControl extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyEnd(t, s) {
    ...
    var t = t?.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(t = t.GetEntityNoBlueprint()?.GetComponent(235)) && (t.SetSubMeshOrder(this.MeshName, this.结束是否可见, this.结束材质, this.结束特效, this.结束延迟时间 * MathUtils_1.MathUtils.SecondToMillisecond), true);
  }
  GetNotifyName() {
    return "子Mesh可见性控制";
  }
