...
class TsAnimNotifyStateNextAtt extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    var t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && ((t = t.CharacterActorComponent?.Entity?.GetComponent(40))?.Valid && !t?.IsSkillMontageInvalid(e.GetName()) && (t.SetSkillAcceptInput(!0), t.CallAnimBreakPoint()), !0)
  }
  K2_NotifyEnd(t, e) {
    var r, t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && (r = t.CharacterActorComponent?.Entity?.GetComponent(40), t = t.CharacterActorComponent?.Entity?.GetComponent(174), !r?.IsSkillMontageInvalid(e.GetName())) && (r?.Valid && r.SetSkillAcceptInput(!1), t?.Valid && t.HasBuffAuthority() && t.RemoveBuff(CharacterBuffIds_1.buffId.GoDown, -1, "从TsAnimNotifyStateNextAtt移除Buff"), !0)
  }
  GetNotifyName() {
    return "下一个技能"
  }
