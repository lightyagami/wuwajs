...
class TsAnimNotifyStateAbsoluteTimeStop extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.副本计时停止 = !1, this.角色战斗机制停止 = !0, this.怪物战斗机制停止 = !0, this.是否冻结移动效果 = !0
  }
  Constructor() {}
  K2_NotifyBegin(e, r, t) {
    ...
    if (!CharacterUtils_1.CharacterUtils.CanCharacterMonsterOrSummonedDisplayEffect(o)) return !1;
    var a = o.Entity.GetComponent(0),
      s = o.Entity.GetComponent(3);
    if (!(!!a?.IsRole() || 4 === s?.CreatureData.GetBaseInfo()?.Category.MonsterMatchType)) return CombatLog_1.CombatLog.Error("Actor", o.Entity, "只有角色才能使用动画和子弹冻结功能"), !1;
    ControllerHolder_1.ControllerHolder.TimeController.AddLock(o, this.是否冻结移动效果);
    a = Protocol_1.Aki.Protocol.Qe_.create();
    return a.o5n = !0, a.n5n = t * TimeUtil_1.TimeUtil.InverseMillisecond, CombatMessage_1.CombatNet.Send(16854, e.CharacterActorComponent.Entity, a), !0
  }
  K2_NotifyEnd(e, r) {
    var t, e = e?.GetOwner();
    return e instanceof TsBaseCharacter_1.default && ((t = ModelManager_1.ModelManager.CharacterModel?.GetHandleByEntity(e.CharacterActorComponent?.Entity))?.Valid && ControllerHolder_1.ControllerHolder.TimeController.RemoveLock(t), (t = Protocol_1.Aki.Protocol.Qe_.create()).o5n = !1, t.n5n = 0, CombatMessage_1.CombatNet.Send(16854, e.CharacterActorComponent.Entity, t), !0)
  }
  GetNotifyName() {
    return "动画和子弹冻结"
  }
