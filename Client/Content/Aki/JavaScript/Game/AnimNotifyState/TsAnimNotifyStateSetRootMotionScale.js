...
class TsAnimNotifyStateSetRootMotionScale extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    var o, a, t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(o = t.CharacterActorComponent)?.Valid && !(o.GetSequenceBinding() || !o.IsAutonomousProxy || !o.Entity.GetComponent(205)?.HasTag(this.Tag.TagId) || (-451106150 === this.Tag?.TagId && (a = (a = o.Entity.GetComponent(173)) ? a.GetCurrentValue(Protocol_1.Aki.Protocol.Vks.Proto_Jump) / CharacterAttributeTypes_1.PER_TEN_THOUSAND : 1, t.SetAnimRootMotionTranslationScale(a), t = o.Entity.GetComponent(178)) && (t.JumpUpRate = MathUtils_1.MathUtils.Clamp(MIN_JUMP_UP_RATE + 1 / a, MIN_JUMP_UP_RATE, MAX_JUMP_UP_RATE)), 0))
  }
  K2_NotifyEnd(t, e) {
    var r, t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !(!(r = t.CharacterActorComponent)?.Valid || r.GetSequenceBinding() || !r.IsAutonomousProxy || ((r = r.Entity.GetComponent(178)) && (r.JumpUpRate = 1), t.SetAnimRootMotionTranslationScale(), 0))
  }
  GetNotifyName() {
