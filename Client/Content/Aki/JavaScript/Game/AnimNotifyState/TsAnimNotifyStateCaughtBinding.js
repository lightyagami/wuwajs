...
class TsAnimNotifyStateCaughtBinding extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.CaughtIds = void 0, this.DetectionRadius = 500
  }
  Constructor() {}
  K2_NotifyBegin(e, t, i) {
    var r, e = e.GetOwner();
    return e instanceof TsBaseCharacter_1.default && !!(e = e.CharacterActorComponent.Entity) && (t = e.GetComponent(209)?.CreateAnimNotifyContent(t.GetName(), this.exportIndex), r = e.GetComponent(40), !!(e = e.GetComponent(52))) && (0 < this.DetectionRadius && this.CheckPosition(e), e.SetCaughtBindingAnsInfo(t), e.BeginCaught(this.CaughtIds, r?.CurrentSkill?.SkillId ?? 0), !0)
  }
  CheckPosition(i) {
    for (let e = 0; e < this.CaughtIds.Num(); e++) {
      ...
      var n = o?.ActorLocationProxy,
        ...
        s = (TraceElementCommon_1.TraceElementCommon.SetStartLocation(a, n), TraceElementCommon_1.TraceElementCommon.SetEndLocation(a, n), a.Radius = this.DetectionRadius, TraceElementCommon_1.TraceElementCommon.SphereTrace(a, PROFILE_KEY));
      if (!s) return;
      let t = !1;
...
TsAnimNotifyStateCaughtBinding.SphereTrace = void 0, exports.default = TsAnimNotifyStateCaughtBinding;
