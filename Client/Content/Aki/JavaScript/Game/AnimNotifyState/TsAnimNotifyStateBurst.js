...
class TsAnimNotifyStateBurst extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    ...
    if (t instanceof TsBaseCharacter_1.default) {
      ...
      if (s) {
        if ((s = s.GetComponent(205)) && (this.不能切人 && s.TagContainer.UpdateExactTag(2, -1697149502, 1), this.是否无敌)) {
  ...
  K2_NotifyEnd(t, e) {
    ...
    if (t instanceof TsBaseCharacter_1.default) {
      ...
      if (r) {
        if ((r = r.GetComponent(205)) && (this.不能切人 && r.TagContainer.UpdateExactTag(2, -1697149502, -1), this.是否无敌)) {
          r.TagContainer.UpdateExactTag(2, 501201000, -1);
        }
        t.GetEntityNoBlueprint().GetComponent(178).ResetHitPriorityAndGoThrough();
        return true;
      }
      if (Log_1.Log.CheckWarn()) {
        Log_1.Log.Warn("Test", 20, "No Entity for TsBaseCharacter", ["Name", t.GetName()]);
