...
class TsAnimNotifyStateSetCollisionChannel extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(e, t, r) {
    ...
    if (s instanceof TsBaseCharacter_1.default) {
      ...
      for (let e = 0; e < a; e++) s.CapsuleComponent.SetCollisionResponseToChannel(this.IgnoreChannels.Get(e), 0);
      return !0
    }
    return !1
  }
  K2_NotifyEnd(e, t) {
    ...
    if (r instanceof TsBaseCharacter_1.default) {
      ...
      for (let e = 0; e < s; e++) r.CapsuleComponent.SetCollisionResponseToChannel(this.IgnoreChannels.Get(e), 2);
      return !0
    }
    return !1
  }
