...
class TsAnimNotifyStateSimpleDisableCollision extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(a, e, i) {
    ...
    if (s instanceof TsBaseCharacter_1.default) {
      s = s.CharacterActorComponent.DisableCollision("TsAnimNotifyStateSimpleDisableCollision.K2_NotifyBegin");
      let e = collisionDisableHandleMap.get(a);
      e || (e = new Map, collisionDisableHandleMap.set(a, e)), e.set(this, s)
    }
    return !0
  }
  K2_NotifyEnd(e, a) {
    ...
    if (i instanceof TsBaseCharacter_1.default) {
      ...
      if (s) {
        var l = s.get(this);
        if (!l) return !0;
        ModelManager_1.ModelManager.CharacterModel.GetHandle(i.EntityId)?.Valid && i.CharacterActorComponent.EnableCollision(l), s.delete(this), s.size || collisionDisableHandleMap.delete(e)
      }
    }
    return !0
  }
