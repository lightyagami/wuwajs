...
class TsAnimNotifyStateFoleyAudioEvent extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.Variant = 0, this.FadeDuration = DEFAULT_FADE_DURATION, this.FadeCurve = 4, this.InitVariables = !1, this.HandleMap = void 0
  }
  Constructor() {
    this.InitVariables = !1, this.HandleMap = void 0
  }
  K2_NotifyBegin(t, e, s) {
    this.InitVariables || (this.InitVariables = !0, this.HandleMap = new Map);
    t = t.GetOwner();
    if (!(t instanceof TsBaseCharacter_1.default)) return !1;
    if ((t.GetEntityNoBlueprint()?.GetComponent(205))?.HasTag(1654452863)) return !1;
    var i = t.CharacterActorComponent,
      t = t.GetEntityNoBlueprint()?.GetComponent(189);
    if (!i || !t) return !1;
    t.ChangeFoleyVariant(this.Variant);
    var r = t?.GetAkComponent(),
      t = t.Config?.FoleyEvent;
    return r && t && (r = AudioSystem_1.AudioSystem.PostEvent(t, r), this.HandleMap.set(i.Entity.Id, new FoleyEventHandle(r, t))), !0
  }
  K2_NotifyEnd(t, e) {
    var s, t = t.GetOwner();
    ...
    }), this.HandleMap.delete(t.Entity.Id)), !0)
  }
}
