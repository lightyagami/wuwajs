...
class TsAnimNotifyStateIgnoreLockOnTarget extends UE.KuroAnimNotifyState {
  ...
  ForceIgnore(e, r) {
    ...
    return !!t && (e = ActorUtils_1.ActorUtils.GetEntityByActor(e), !!(t = t?.Entity?.GetComponent(32))) && (t.ForceIgnore(new CharacterLockOnComponent_1.LockOnInfo(e, this.IgnoreSocket), r), !0)
  }
}
