...
class TsAnimNotifyStateControllerShake extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyEnd(e, r) {
    e = e.GetOwner();
    return e instanceof TsBaseCharacter_1.default && e.CharacterActorComponent?.IsAutonomousProxy && Global_1.Global.CharacterController && Global_1.Global.CharacterController.StopKuroForceFeedback(this.Effect, this.Name), !0
  }
  GetNotifyName() {
    return "手柄震动"
  }
