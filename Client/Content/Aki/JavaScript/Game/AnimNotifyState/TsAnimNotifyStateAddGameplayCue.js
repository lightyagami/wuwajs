...
class TsAnimNotifyStateAddGameplayCue extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.Buff特效Id列表 = void 0, this.GameplayCueHandleIdList = void 0
  }
  Constructor() {}
    ...
    if (this.Buff特效Id列表)
      for (let e = 0; e < this.Buff特效Id列表.Num(); e++) {
        var i = this.Buff特效Id列表.Get(e),
          i = a.AddCue(Number(i));
        i !== GameplayCueController_1.INVALID_CUE_HANDLE && (this.GameplayCueHandleIdList || (this.GameplayCueHandleIdList = []), this.GameplayCueHandleIdList.push(i))
      }
    return !0
  }
  K2_NotifyEnd(e, r) {
    ...
    if (this.GameplayCueHandleIdList) {
      for (const a of this.GameplayCueHandleIdList) t?.GetCueByHandle(a)?.Destroy();
