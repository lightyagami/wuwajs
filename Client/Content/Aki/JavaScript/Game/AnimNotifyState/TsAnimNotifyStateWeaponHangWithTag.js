...
class TsAnimNotifyStateWeaponHangWithTag extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, s, e) {
    var i;
    var t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(i = t?.CharacterActorComponent?.Entity?.GetComponent(206)) && !!i.HasTag(this.ActivateTag.TagId) && !(t?.CharacterActorComponent?.Entity?.GetComponent(81)?.ChangeWeaponHangState(this.Id, this.新的挂载点名, this.挂载相对位置, this.缓冲时间), 0);
  }
  K2_NotifyEnd(t, s) {
    t = t.GetOwner();
