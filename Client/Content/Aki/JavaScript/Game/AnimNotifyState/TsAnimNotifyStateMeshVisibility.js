...
class TsAnimNotifyStateMeshVisibility extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.HideMeshName = "", this.Visibility = !0, this.EntityMeshMap = void 0
  }
  Constructor() {
  ...
  K2_NotifyBegin(t, i, e) {
    ...
    if (1 !== h && 3 !== h) o && o.SetVisibility(this.Visibility);
      ...
      h = t, t = h.GetEntityId();
      if (this.EntityMeshMap.has(t) || this.EntityMeshMap.set(t, new Array), !h) return Log_1.Log.CheckError() && Log_1.Log.Error("Render", 4, "TsAnimNotifyStateHideMesh,该Actor不是一个实体"), !1;
      if (!r) return Log_1.Log.CheckError() && Log_1.Log.Error("Render", 4, "TsAnimNotifyStateHideMesh无法找到Mesh", ["填入Mesh名", this.HideMeshName]), !1;
  ...
  K2_NotifyEnd(t, i) {
    ...
    if (1 !== e && 3 !== e) {
      ...
      e = t.GetEntityId();
      this.EntityMeshMap.has(e) && (t = this.EntityMeshMap.get(e).find(t => t.GetName() === this.HideMeshName)) && t.SetVisibility(!this.Visibility)
    }
    return !0
  }
  GetNotifyName() {
