...
class TsAnimNotifyStateRunRotateBoneToLocation extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.TurnLimit = void 0, this.LookUpLimit = void 0, this.TurnSpeed = void 0, this.LookUpSpeed = void 0, this.TurnOffset = -0, this.LookUpOffset = -0
  }
  Constructor() {}
  K2_NotifyBegin(i, t, e) {
    ...
    if (i instanceof TsBaseCharacter_1.default) {
      ...
      if (!(i && i.MainAnimInstance && i.MainAnimInstance instanceof UE.KuroAnimInstance)) return !1;
      let t = 1,
        e = (this.TurnSpeed && (t = this.TurnSpeed.GetFloatValue(0)), 1);
      this.LookUpSpeed && (e = this.LookUpSpeed.GetFloatValue(0)), i.MainAnimInstance.SetBoneRotateToLocationInfoRunBegin(t, e, this.TurnLimit, this.LookUpLimit, this.TurnOffset, this.LookUpOffset)
    }
    return !0
  }
  K2_NotifyEnd(t, e) {
    ...
    if (t instanceof TsBaseCharacter_1.default) {
      ...
      if (!(t && t.MainAnimInstance && t.MainAnimInstance instanceof UE.KuroAnimInstance)) return !1;
  ...
  K2_NotifyTick(i, t, e) {
    ...
    if (i instanceof TsBaseCharacter_1.default) {
      ...
      this.LookUpSpeed && (e = this.LookUpSpeed.GetFloatValue(s)), i.MainAnimInstance.SetBoneRotateToLocationInfoRunTick(t, e)
    }
    return !0
  }
  GetNotifyName() {
