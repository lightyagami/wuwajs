...
class TsAnimNotifyStateInteractionRotateToLocation extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    ...
    o.GetInteractionTargetLocation().Subtraction(t.ActorLocationProxy, a), this.Rotator = a.HeadingAngle() * MathCommon_1.MathCommon.RadToDeg;
    let i = t.ActorRotationProxy.Yaw - this.Rotator;
    return 180 < i && (i = 360 - i), i = Math.abs(i), this.RotateSpeed = i / r, !0
  }
  K2_NotifyTick(t, e, r) {
    var t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(t = t.CharacterActorComponent?.Entity?.GetComponent(178)) && (t.SmoothCharacterRotationByValue(0, this.Rotator, 0, this.RotateSpeed, r, "TsAnimNotifyStateInteractionRotateToLocation"), !0)
  }
  GetNotifyName() {
    return "设置交互动作旋转和位置"
  }
