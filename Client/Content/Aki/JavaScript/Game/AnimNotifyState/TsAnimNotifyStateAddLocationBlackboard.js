...
class AddLocationBlackboardParams {
  constructor() {
    this.TotalDuration = -0, this.AddOffset = Vector_1.Vector.Create(), this.RunTime = -0
  }
}
...
class TsAnimNotifyStateAddLocationBlackboard extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.AddLocationKey = "", this.Curve = void 0, this.NeedChangeToFlying = !1, this.黑板类型 = 0
  }
  Constructor() {}
  K2_NotifyBegin(t, r, e) {
    ...
    var i = 0 < paramsPool.length ? paramsPool.pop() : new AddLocationBlackboardParams;
    switch (i.TotalDuration = e, i.RunTime = 0, this.黑板类型) {
      ...
      case 1:
        ...
        if (!n) return !1;
        i.AddOffset.FromUeVector(n), i.AddOffset.SubtractionEqual(a.CharacterActorComponent.ActorLocationProxy);
        break;
      case 2:
      case 3: {
        let t = void 0;
        if (!(t = 2 === this.黑板类型 ? ControllerHolder_1.ControllerHolder.BlackboardController.GetEntityIdByEntity(s, this.AddLocationKey) : ControllerHolder_1.ControllerHolder.BlackboardController.GetIntValueByEntity(s, this.AddLocationKey))) return !1;
        n = EntitySystem_1.EntitySystem.Get(t);
        if (!n?.Valid) return !1;
        n = n.GetComponent(1);
        i.AddOffset.DeepCopy(n.ActorLocationProxy), i.AddOffset.SubtractionEqual(a.CharacterActorComponent.ActorLocationProxy);
        break
      }
      default:
        return !1
    }
    return o.set(s, i), this.NeedChangeToFlying && a.KuroSetMovementMode({
      Mode: 5,
  ...
  K2_NotifyTick(r, t, e) {
    ...
    if (!(s.RunTime >= s.TotalDuration)) {
      ...
      s.AddOffset.Multiply(t, tmpVector), r.MoveCharacter(tmpVector, e), s.RunTime = a
    }
    return !0
  }
  K2_NotifyEnd(t, r) {
    var e, a, t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(e = paramsMaps.get(this.AddLocationKey)) && (t = t.CharacterActorComponent.Entity.Id, (a = e.get(t)) && (paramsPool.push(a), e.delete(t)), !0)
  }
  GetNotifyName() {
    return "黑板位置设置角色位置偏移"
  }
