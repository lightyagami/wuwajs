...
class TsAnimNotifyStateHideBone extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(e, t, s) {
    if (this.IgnoreTsBaseCharacter) {
      ...
      e.CharacterActorComponent.Entity.GetComponent(177)?.HideBone(FNameUtil_1.FNameUtil.GetDynamicFName(this.BoneName), true, false);
    }
    return true;
  }
  K2_NotifyEnd(e, t) {
    if (this.IgnoreTsBaseCharacter) {
      ...
      e.CharacterActorComponent.Entity.GetComponent(177)?.HideBone(FNameUtil_1.FNameUtil.GetDynamicFName(this.BoneName), false, false);
    }
    return true;
  }
  GetNotifyName() {
