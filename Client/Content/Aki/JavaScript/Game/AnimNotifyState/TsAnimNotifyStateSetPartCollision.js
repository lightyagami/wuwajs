...
class TsAnimNotifyStateSetPartCollision extends UE.KuroAnimNotifyState {
  constructor() {
    super(...arguments), this.CompName = "", this.CompNames = void 0, this.IsBlockPawn = !1, this.IsBulletDetect = !1, this.IsBlockCamera = !1
  }
  Constructor() {}
  K2_NotifyBegin(t, s, i) {
    var e = t.GetOwner();
    if (e instanceof TsBaseCharacter_1.default) {
      this.CompName && this.SetPartCollisionSwitch(e, this.CompName, this.IsBlockPawn, this.IsBulletDetect, this.IsBlockCamera);
      for (let t = 0; t < this.CompNames.Num(); t++) {
        var r = this.CompNames.Get(t);
        r && this.SetPartCollisionSwitch(e, r, this.IsBlockPawn, this.IsBulletDetect, this.IsBlockCamera)
      }
      return !0
    }
    return !1
  ...
  K2_NotifyEnd(t, s) {
    ...
    if (i instanceof TsBaseCharacter_1.default) {
      ...
      t && this.SetPartCollisionSwitch(i, this.CompName, t.IsBlockPawn, t.IsBulletDetect, t.IsBlockCamera);
      for (let t = 0; t < this.CompNames.Num(); t++) {
        var e = this.CompNames.Get(t),
          r = i.CharacterActorComponent.GetPartConf(e);
        r && this.SetPartCollisionSwitch(i, e, r.IsBlockPawn, r.IsBulletDetect, r.IsBlockCamera)
      }
      return !0
    }
    return !1
