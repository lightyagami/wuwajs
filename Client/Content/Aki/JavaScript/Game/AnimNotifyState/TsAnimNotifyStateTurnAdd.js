...
class TurningParams {
  constructor(t) {
    this.NeedTurn = !1, this.AddRate = 0, this.TotalTime = 0, this.StartAngle = 0, this.EndAngle = 0, this.PreFrameAngle = 0, this.IsInit = !1, this.TotalTime = t
  }
  CalcTurningRate(t, e, i) {
    var r, n = t.Entity.GetComponent(177),
      n = (this.EndAngle = n.MainAnimInstance.GetMainAnimsCurveValueWithDelta(CharacterNameDefines_1.CharacterNameDefines.ROOT_LOOK, this.TotalTime), this.StartAngle = n.MainAnimInstance.GetMainAnimsCurveValueWithDelta(CharacterNameDefines_1.CharacterNameDefines.ROOT_LOOK, 0), Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "TurnAdd 1058338", ["EntityId", t.Entity.Id], ["endAngle", this.EndAngle], ["startTime", e], ["startAngle", this.StartAngle]), this.EndAngle - this.StartAngle);
    MathUtils_1.MathUtils.IsNearlyZero(n) || (e = MathUtils_1.MathUtils.WrapAngle(GravityUtils_1.GravityUtils.GetAngleOffsetFromCurrentToInput(t)), this.AddRate = (r = e - n) / n, this.NeedTurn = !0, this.PreFrameAngle = this.StartAngle, this.IsInit = !0, Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "TurnAdd 1058338", ["EntityId", t.Entity.Id], ["needAddAngle", r], ["Current", t.ActorRotationProxy], ["Input", t.InputRotatorProxy], ["Delta", e]))
  }
}
class TsAnimNotifyStateTurnAdd extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyEnd(t, e) {
    ...
    return t && (t.IsTurning = !1), Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "TurnAdd End", ["EntityId", i.Entity.Id], ["Current", i.ActorRotationProxy], ["Input", i.InputRotatorProxy]), !0
  }
  GetNotifyName() {
    return "根据RootLook曲线控制角色转向"
  }
  static Initialize() {
    TsAnimNotifyStateTurnAdd.IsInit || (TsAnimNotifyStateTurnAdd.CachedMap = new Map, TsAnimNotifyStateTurnAdd.TmpRotator = new UE.Rotator(0, 0, 0), TsAnimNotifyStateTurnAdd.IsInit = !0)
  }
}
TsAnimNotifyStateTurnAdd.IsInit = !1, TsAnimNotifyStateTurnAdd.CachedMap = void 0, TsAnimNotifyStateTurnAdd.TmpRotator = void 0, exports.default = TsAnimNotifyStateTurnAdd;
