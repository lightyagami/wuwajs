...
class TsAnimNotifyStateBonesShowControl extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, r) {
    ...
    if (s instanceof TsBaseCharacter_1.default) {
      ...
      if (!s?.Valid) return !1;
      t.IsBoneHiddenByName(this.BoneName) || (t.HideBoneByName(this.BoneName, 0), s.GetComponent(81)?.HideWeaponsWhenHideBones(!0, this.BoneName))
    }
    return !1
  }
  K2_NotifyEnd(t, e) {
    ...
    if (r instanceof TsBaseCharacter_1.default) {
      ...
      if (!r?.Valid) return !1;
      t.IsBoneHiddenByName(this.BoneName) && (t.UnHideBoneByName(this.BoneName), r.GetComponent(81)?.HideWeaponsWhenHideBones(!1, this.BoneName))
    }
    return !1
  }
  GetNotifyName() {
