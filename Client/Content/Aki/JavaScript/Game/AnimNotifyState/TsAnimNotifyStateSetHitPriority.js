...
class TsAnimNotifyStateSetHitPriority extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e) {
    t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && (t.CharacterMovement.HitPriority = this.HitPriority, !0)
  }
  K2_NotifyEnd(t, e) {
    t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && (t.GetEntityNoBlueprint().GetComponent(178).ResetHitPriorityAndGoThrough(), !0)
  }
  GetNotifyName() {
