...
class TsAnimNotifyStateAttach extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, i, a) {
    ...
    var s = e.Entity.GetComponent(43);
    ...
    if (!s.GetComponent(191)?.Valid) {
      return false;
    }
    var o = t.GetEntityNoBlueprint()?.GetComponent(191);
    if (!o?.Valid) {
      return false;
    }
    s = s.GetComponent(74);
  ...
  K2_NotifyEnd(t, i) {
    ...
    var h;
    var t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && !!(a = t.CharacterActorComponent)?.Valid && !!a.IsAutonomousProxy && !!(e = a.Entity.GetComponent(43))?.Valid && !!e.SkillTarget?.Entity && !!(e = e.SkillTarget.Entity).GetComponent(191)?.Valid && !!(s = e.GetComponent(3))?.Valid && !!(r = t.GetEntityNoBlueprint()?.GetComponent(191))?.Valid && !!(h = TsAnimNotifyStateAttach.CacheMap.get(t)) && !(i = a.Entity.GetComponent(222).CreateAnimNotifyContent(i.GetName(), this.exportIndex), h.UpdateAttachLocation(a, this.GetAttachTargetLocation(s)), a.AddActorWorldOffset(h.StepFrameLocationOffset(a, MAX_ANIM_TIME).ToUeVector(), "TsAnimNotifyStateAttach", false), r.AttachToTarget(ModelManager_1.ModelManager.CharacterModel.GetHandleByEntity(e), i, true), TsAnimNotifyStateAttach.CacheMap?.delete(t), 0);
  }
  GetAttachSocketName() {
