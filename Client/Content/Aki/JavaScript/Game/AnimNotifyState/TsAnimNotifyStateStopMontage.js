...
class TsAnimNotifyStateStopMontage extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyTick(e, t, r) {
    var e = e.GetOwner();
    return e instanceof TsBaseCharacter_1.default && !!(e = e.CharacterActorComponent?.Entity) && (e.GetComponent(182)?.HasMoveInput && (e = e.GetComponent(181)) && e.MainAnimInstance.Montage_Stop(QUIT_BLEND_TIME), true);
  }
}
