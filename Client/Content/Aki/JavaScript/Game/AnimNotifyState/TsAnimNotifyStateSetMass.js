...
class TsAnimNotifyStateSetMass extends UE.KuroAnimNotifyState {
  ...
  K2_NotifyBegin(t, e, s) {
    t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && (this.OldMass = t.CharacterMovement.Mass, t.CharacterMovement.Mass = this.NewMass, !0)
  }
  K2_NotifyEnd(t, e) {
    t = t.GetOwner();
    return t instanceof TsBaseCharacter_1.default && (t.CharacterMovement.Mass = this.OldMass, !0)
  }
  GetNotifyName() {
    return "设置质量"
  }
