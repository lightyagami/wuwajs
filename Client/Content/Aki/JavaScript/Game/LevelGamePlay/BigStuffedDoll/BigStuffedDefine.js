...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.ContinuousArea = exports.Area = exports.BigStuffedRingInfo = exports.BigStuffedGameInfo = exports.calculateCellSize = exports.SINGLECELL_ANGLE = exports.BIGSTUFFEDDOLL_RINGCELLCOUNT = void 0, exports.BIGSTUFFEDDOLL_RINGCELLCOUNT = 36, exports.SINGLECELL_ANGLE = 10, exports.calculateCellSize = calculateCellSize;
class BigStuffedGameInfo {
  constructor() {
    this.rfl = new Map, this.ofl = [], this.CurrentArrowStayTotalIndex = -1, this.CurrentArrowStayRingId = -1, this.CurrentArrowStayRelativeValidAreaIndex = -1, this.CurrentArrowStayCellIndex = 0
  }
  AddRingInfo(t, s) {
  ...
  Clear() {
    ...
    this.rfl.clear(), this.ofl.length = 0, this.CurrentArrowStayTotalIndex = -1, this.CurrentArrowStayRingId = -1, this.CurrentArrowStayRelativeValidAreaIndex = -1, this.CurrentArrowStayCellIndex = 0
  }
  GetRingInfo(t) {
    ...
    if (0 !== this.ofl.length) {
      ...
      for (const e of this.ofl) {
        if (t += e.ValidAreas.length, this.CurrentArrowStayTotalIndex < t) {
          this.CurrentArrowStayRingId = e.RingId, this.CurrentArrowStayRelativeValidAreaIndex = this.CurrentArrowStayTotalIndex - s;
          break
        }
        s = t
      }
...
class BigStuffedRingInfo {
  constructor(t, s) {
    this.RingId = t, this.ArrowDirection = s, this.ValidAreas = [], this.Sbl = new Map, this.Mbl = new Map, this.ybl = new Map
  }
  Clear() {
    this.ValidAreas.length = 0, this.Sbl.clear(), this.Mbl.clear(), this.ybl.clear()
  }
  GetValidAreas() {
...
class Area {
  constructor(t, s, e) {
    this.StartCellIndex = t, this.EndCellIndex = s, this.ArrowDirection = e
  }
  OnArrowDirectionReverse() {
    switch (this.ArrowDirection) {
      case 0:
...
class ContinuousArea extends(exports.Area = Area) {
  constructor(t, s, e, r) {
    super(s, e, r), this.ContinuousIndex = t, this.StartCellIndex = s, this.EndCellIndex = e, this.ArrowDirection = r
  }
}
