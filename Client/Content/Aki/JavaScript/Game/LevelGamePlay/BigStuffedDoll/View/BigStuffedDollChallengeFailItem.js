...
class BigStuffedDollChallengeFailItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.LevelSequencePlayer = void 0, this.yct = e => {
      switch (e) {
        case "Start":
          this.LevelSequencePlayer.PlayLevelSequenceByName("Close");
          break;
        case "Close":
          this.HideAsync(), ModelManager_1.ModelManager.BigStuffedDollModel.SetGameStage(5)
      }
    }
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    super.OnStart(), this.LevelSequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.LevelSequencePlayer.BindSequenceCloseEvent(this.yct)
  }
  OnBeforeDestroy() {
  ...
  ShowTip(e) {
    ...
    LguiUtil_1.LguiUtil.SetLocalTextNew(t, e), this.ShowAsync(), this.LevelSequencePlayer.PlayLevelSequenceByName("Start")
  }
}
