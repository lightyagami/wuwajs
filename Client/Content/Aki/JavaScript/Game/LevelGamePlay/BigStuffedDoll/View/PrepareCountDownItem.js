...
class PrepareCountDownItem extends UiPanelBase_1.UiPanelBase {
  constructor() {
    super(...arguments), this.RemainTime = 0, this.LevelSequencePlayer = void 0, this.yct = e => {
      "Start" === e && (this.HideAsync(), ModelManager_1.ModelManager.BigStuffedDollModel.EnterNextGameStage())
    }
  }
  OnRegisterComponent() {}
  OnStart() {
