...
class FishingQteModel extends ModelBase_1.ModelBase {
  ...
  EnterNextRound() {
    this.GameInfo.CurrentRound = Math.min(this.GameInfo.CurrentRound + 1, this.GameInfo.MaxRound), this.GameInfo.CurrentRound !== this.GameInfo.MaxRound ? this.GameInfo.CurrentScore -= this.GameConfig.MaxScore : this.GameInfo.SetGameStage(4)
  }
  get ScoreUp() {
  ...
  OnQteOn() {
    this.GameInfo.CurrentScore += this.HitAreaScore, this.AccumulatePerfectCombo++
  }
  OnPerfectOn() {
    this.GameInfo.CurrentScore += this.PerfectScore, this.AccumulatePerfectCombo++
  }
  OnMissOn() {
    this.GameInfo.CurrentScore = Math.max(0, this.GameInfo.CurrentScore - this.GameConfig.MistakeScore), this.AccumulatePerfectCombo = 0
  }
  C7_() {
    var t = this.AccumulatePerfectCombo;
    this.GameInfo.CursorSpeed = this.p7_(t, this.GameConfig.CursorSpeed), this.GameInfo.RingSpeed = this.p7_(t, this.GameConfig.RouletteRotateSpeed), this.GameInfo.PerfectAppearRate = this.p7_(t, this.GameConfig.PerfectAppearRate), Log_1.Log.CheckDebug() && Log_1.Log.Debug("LevelPlay", 37, "[FishingQte] ComboInfoChange", ["Combo", this.AccumulatePerfectCombo], ["CursorSpeed", this.GameInfo.CursorSpeed], ["RingSpeed", this.GameInfo.RingSpeed], ["PerfectAppearRate", this.GameInfo.PerfectAppearRate])
  }
  p7_(e, t) {
