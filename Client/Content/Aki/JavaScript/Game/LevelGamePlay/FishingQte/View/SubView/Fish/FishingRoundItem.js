...
class FishingRoundItem extends GridProxyAbstract_1.GridProxyAbstract {
  ...
  OnStart() {
    this.LevelSequencePlayer = new LevelSequencePlayer_1.LevelSequencePlayer(this.RootItem), this.GetSprite(1).SetUIActive(!1)
  }
  Refresh(e, i, r) {}
  ShowIcon(e) {
    const i = this.GetSprite(1);
    e = fishingIconPath[e], e = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(e);
    this.SetSpriteByPath(e, i, !1, void 0, () => {
      i.SetUIActive(!0), this.LevelSequencePlayer.PlayLevelSequenceByName("Fish")
    })
  }
}
