...
exports.ContinuousRingArea = exports.RingArea = exports.FishingQteRingInfo = exports.FishingQteGameInfo = exports.fixedCellIndex = exports.calculateCellSize = exports.FISHINGQTE_SINGLECELL_ANGLE = exports.FISHINGQTE_RING_ANGLE = exports.FISHINGQTE_RINGCELLCOUNT = undefined;
...
function calculateCellSize(e, t) {
  if (e <= t) {
    ...
    return exports.FISHINGQTE_RINGCELLCOUNT - e + t + 1;
  }
}
function fixedCellIndex(e) {
  var t;
  if (e > exports.FISHINGQTE_RINGCELLCOUNT) {
    if ((t = e % exports.FISHINGQTE_RINGCELLCOUNT) == 0) {
      return exports.FISHINGQTE_RINGCELLCOUNT;
    } else {
      return t;
    }
  } else if (e <= 0) {
...
exports.FISHINGQTE_SINGLECELL_ANGLE = exports.FISHINGQTE_RING_ANGLE / exports.FISHINGQTE_RINGCELLCOUNT;
...
class FishingQteGameInfo {
  ...
  SetGameStage(e) {
    this.afl = e;
    EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingQteStageUpdate, this.afl);
  }
  GetGameStage() {
    return this.afl;
  }
...
class FishingQteRingInfo {
  ...
  AddQteArea(e, t, s) {
    ...
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("SceneGameplay", 37, "[FishingQte] AddQteArea", ["Index", e], ["Start", t], ["End", s]);
    }
  }
  RemoveQteArea(e) {
    this.ft_.delete(e);
  ...
  AddPerfectArea(e, t, s) {
    ...
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("SceneGameplay", 37, "[FishingQte] AddPerfectArea", ["Index", e], ["Start", t], ["End", s]);
    }
  }
  RemovePerfectArea(e) {
    this.Mbl.delete(e);
  ...
  CheckInArea(e, t) {
    for (var [, s] of e) {
      ...
      var r = s.EndCellIndex;
      if (i <= r) {
        if (i <= t && t <= r) {
          return s;
        }
      } else if (i <= t && t <= exports.FISHINGQTE_RINGCELLCOUNT || t >= 1 && t <= r) {
        return s;
      }
    }
  }
  EnterNextValidArea() {
    ...
    if (e) {
      ...
      EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnFishingQteAreaChange, this.CurrentArrowStayRelativeValidAreaIndex);
    }
  }
