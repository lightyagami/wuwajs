...
class GuaranteeActionUnLimitPlayerOperation extends GuaranteeActionBase_1.GuaranteeActionBase {
  OnExecute(e) {
    ...
    if (t?.Valid && ((t = t.GetComponent(205))?.HasTag(r = 477750727) && (t.RemoveTag(r), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Test", 29, "[GuaranteeActionUnLimitPlayerOperation.OnExecute] RemoveTag 禁止冲刺"), t?.HasTag(r = -63548288) && t.RemoveTag(r), t?.HasTag(r = 229513169))) {
      t.RemoveTag(r);
    }
