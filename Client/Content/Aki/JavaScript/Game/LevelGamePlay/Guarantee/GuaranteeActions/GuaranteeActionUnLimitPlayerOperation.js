...
class GuaranteeActionUnLimitPlayerOperation extends GuaranteeActionBase_1.GuaranteeActionBase {
  OnExecute(e) {
    ControllerHolder_1.ControllerHolder.InputController.SetMoveControlEnabled(!0, !0, !0, !0), LevelEventLockInputState_1.LevelEventLockInputState.Unlock(), ControllerHolder_1.ControllerHolder.InputDistributeController.RefreshInputTag(), ModelManager_1.ModelManager.BattleUiModel.ChildViewData.ShowBattleView(1), ModelManager_1.ModelManager.BattleInputModel.SetAllInputEnable(!0, 0), LevelEventLockInputState_1.LevelEventLockInputState.InputLimitView = [];
    var r, t = Global_1.Global.BaseCharacter?.CharacterActorComponent?.Entity;
    t?.Valid && ((t = t.GetComponent(205))?.HasTag(r = 477750727) && (t.RemoveTag(r), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Test", 29, "[GuaranteeActionUnLimitPlayerOperation.OnExecute] RemoveTag 禁止冲刺"), t?.HasTag(r = -63548288) && t.RemoveTag(r), t?.HasTag(r = 229513169)) && t.RemoveTag(r), ModelManager_1.ModelManager.LevelFuncFlagModel.SetFuncFlagEnable(0, !0)
  }
}
