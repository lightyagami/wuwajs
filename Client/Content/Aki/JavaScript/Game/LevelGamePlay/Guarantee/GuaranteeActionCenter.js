...
class GuaranteeActionCenter {
  static RegGuaranteeActions() {
    ...
    e("RestorePlayerCameraAdjustment", GuaranteeActionRestorePlayerCameraAdjustment_1.GuaranteeActionRestorePlayerCameraAdjustment), e("EnablePlayerMoveControl", GuaranteeActionEnablePlayerMoveControl_1.GuaranteeActionEnablePlayerMoveControl), e("UnLimitPlayerOperation", GuaranteeActionUnLimitPlayerOperation_1.GuaranteeActionUnLimitPlayerOperation), e("ExitOrbitalCamera", GuaranteeActionExitOrbitalCamera_1.GuaranteeActionExitOrbitalCamera), e("ActionBlackScreenFadeOut", GuaranteeActionBlackScreenFadeOut_1.GuaranteeActionBlackScreenFadeOut)
  }
...
}(exports.GuaranteeActionCenter = GuaranteeActionCenter).iIe = new Map, GuaranteeActionCenter.oIe = new Map, GuaranteeActionCenter.tIe = (e, t, a = 1) => {
  GuaranteeActionCenter.iIe.has(e) || GuaranteeActionCenter.iIe.set(e, t), GuaranteeActionCenter.oIe.has(e) || GuaranteeActionCenter.oIe.set(e, a)
};
