...
class TicTacToeGame {
  ...
  Init(t, i) {
    this.Board.Init(this.WinLineCount, this.OnGameOverCallback, this.OnEndRoundCallback), this.Controller.Init(this.Board, this.PlayerCamp), this.AiController.InitAi(this.Board, this.AiCamp, this.PlayerCamp), this.Controller.RegisterEvent(i), this.AiController.RegisterEvent(i), this.SetOffensive(t)
  }
  RefreshAiEnable(t) {
    this.L5a !== t && (this.L5a || this.CurrentCamp !== this.AiCamp || this.StartRound(), this.L5a = t)
  }
  StartRound() {
    this.CurrentCamp === this.PlayerCamp ? this.Controller.OnStartRound() : this.CurrentCamp === this.AiCamp ? this.L5a && this.AiController.OnStartRound() : Log_1.Log.CheckError() && Log_1.Log.Error("LevelPlay", 36, "[TicTacToe]当前回合阵营错误")
  }
  OnIndexSelect(t) {
    return this.Controller.IsSelecting ? !!this.Controller.ResetSelectPiece(t) || this.Controller.MovePiece(t) : this.Controller.SelectPiece(t)
  }
  OnIndexMove(t, i) {
    return this.Controller.SelectPiece(t), !!this.Controller.IsSelecting && this.Controller.MovePiece(i)
  }
  NextRound() {
    this.QOa++;
  ...
  SetCurrentRound(t) {
    ...
    this.CurrentCamp = this.CampLoop[this.QOa % t], this.KOa = 0, this.StartRound()
  }
  get IsPlayerRound() {
  ...
  StartGame() {
    this.QOa = 0, this.CurrentCamp = this.CampLoop[0], this.KOa = 0, this.StartRound()
  }
  ResetGame() {
    this.Controller.OnResetGame(), this.AiController.OnResetGame(), this.Board.ResetGame(), this.StartGame()
  }
  OnGameOver(t) {
    this.KOa = t
  }
