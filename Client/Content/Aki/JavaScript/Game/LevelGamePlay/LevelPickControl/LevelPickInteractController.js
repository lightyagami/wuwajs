...
class LevelPickInteractController extends ControllerBase_1.ControllerBase {
  ...
  static EnterPickInteractModel(e, t = false) {
    ...
    if (r) {
      ...
      this.A6l = 0;
      this.JOa = t;
      if (EntitySystem_1.EntitySystem.GetComponent(r.Id, 0)?.GetPbModelConfig()?.EntityType === "Chessboard" && (r = EntitySystem_1.EntitySystem.GetComponent(r.Id, 148))) {
        this.YOa(r);
      }
