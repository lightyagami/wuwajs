...
class CipherKey extends UiPanelBase_1.UiPanelBase {
  constructor(t, i) {
    super(), this.yye = void 0, this.Iye = void 0, this.Tye = void 0, this.Lye = void 0, this.Dye = void 0, this.Rye = 0, this.Uye = (t, i, e) => {
      t = new CipherCircleAttachItem_1.CipherCircleAttachItem(t);
      return t.InitData(this.KeyIndex, this.Dye), this.Lye.push(t), t
    }, this.KeyIndex = i, this.CreateThenShowByActor(t.GetOwner())
  }
  OnRegisterComponent() {
  ...
  OnStart() {
    ...
    this.Lye = new Array, this.Dye = t => {
      this.Aye(t)
    }, this.Iye?.Clear(), this.Iye = void 0, this.Iye = new CircleAttachView_1.CircleAttachView(this.GetItem(0).GetOwner()), this.Iye.SetAudioEvent("ui_cipher_picker_tick"), this.Iye.CreateItems(this.GetItem(1).GetOwner(), INITGP, this.Uye, 1), this.GetItem(1).SetUIActive(!1), this.Iye.ReloadView(LEN, this.Tye), this.Iye.AttachToIndex(0), this.AddEvent()
  }
  OnBeforeDestroy() {
