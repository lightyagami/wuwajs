...
class CipherModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.Pye = "", this.xye = void 0, this.wye = void 0, this.Bye = void 0
  }
  InitCipherConfig(e) {
    if (this.Pye = e, this.GetCipherConfig(e)) {
      this.xye || (this.xye = new Array), this.wye || (this.wye = new Array), this.Bye || (this.Bye = new Map), this.xye.length = 0, this.wye.length = 0, this.Bye.clear();
