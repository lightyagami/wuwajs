...
class CipherCircleAttachItem extends AutoAttachItem_1.AutoAttachItem {
  constructor() {
    super(...arguments), this.fye = 0, this.pye = void 0, this.vye = UE.Color.FromHex(WRONG_COLOR), this.Mye = UE.Color.FromHex(RIGHT_COLOR), this.Eye = UE.Color.FromHex(NORMAL_COLOR), this.Sye = void 0
  }
  OnMoveItem() {}
  OnRegisterComponent() {
  ...
  OnRefreshItem(t) {
    this.pye = t, void 0 !== this.pye && this.GetText(0).SetText(this.pye.toString())
  }
  OnSelect() {
