...
class GravityFlipModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.GravityFlipEntity = void 0, this.GravityFlipComp = void 0, this.CacheCorrectDirection = Protocol_1.Aki.Protocol.AY_.Proto_GravityDown, this.CurrentGravityDirection = 0, this.ValidGravityDirections = [], this.ViewCallBackCache = void 0
  }
  OnInit() {
    return !0
  }
  ...
  InitGravityFlipParams(e) {
    this.GravityFlipComp = e, this.GravityFlipEntity = e.Entity, this.ValidGravityDirections = [], this.CurrentGravityDirection = e.CurGravityDirection;
    var t = e.GetGravityFlipDirection();
    if (!t || t.length <= 0) Log_1.Log.CheckError() && Log_1.Log.Error("SceneItem", 31, "[GravityFlipModel] 未找到重力方向配置", ["PbDataId", e.Entity.GetComponent(0)?.GetPbDataId()]);
    else {
  ...
  get TargetDirection() {
    ...
    return !e || 1 !== e.GetTagCount(-1377409745) ? -1 : e.HasTag(1937741205) ? 180 : e.HasTag(590629922) ? 0 : e.HasTag(-231334097) ? 90 : e.HasTag(-584695776) ? 270 : -1
  }
  OnChangeMode() {
    var e;
    return this.GravityFlipComp?.IsInteracting && (e = {
      SelectCallback: this.ViewCallBackCache
    }, UiManager_1.UiManager.OpenView("GravityFlipView", e)), !0
  }
}
