...
class SceneItemSplineMoveTask extends SplineMoveTaskBase_1.SplineMoveTaskBase {
  ...
  OnStartTask() {
    ...
    if (!(this.aYu >= 1)) {
      this.aYu = 1;
      if ((e = this.EntityHandle.Entity?.GetComponent(137))?.Valid) {
  ...
  OnEndTask(e) {
    if (!(this.aYu >= 6)) {
      ...
      const i = this.EntityHandle.Entity?.GetComponent(137);
      i?.StopMove();
  ...
  _Yu() {
    var e;
    var t = this.EntityHandle.Entity?.GetComponent(137);
  ...
  yi1() {
    if (!(this.aYu >= 2)) {
      ...
      if (this.EntityHandle?.Valid) {
        const n = this.EntityHandle.Entity.GetComponent(137);
        if (n?.Valid) {
          if (this.ICl) {
            this.enh = new Map();
            this.TCl = new Map();
