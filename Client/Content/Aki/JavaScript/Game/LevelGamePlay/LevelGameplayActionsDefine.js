...
exports.CommonInteractActions = CommonInteractActions, exports.optionTypeLogString = {
  [0]: "基础交互",
  1: "动态交互",
  2: "随机交互"
};
class CommonInteractOption {
  constructor() {
    this.Type = void 0, this.Icon = void 0, this.DoIntactType = void 0, this.Range = 0, this.Context = void 0, this.InstanceId = 0, this.OptionType = 0, this.ContentType = 0, this.CustomOptionType = 0, this.k_h = !1, this.IsUniqueness = !1, this.UniequenessType = IAction_1.EInteractUniqueness.Closest, this.OptionContentId = 0, this.SortWeight = 0, this.DelayRemove = !1, this.ConditionCheck = !1, this.LockTips = void 0, this.Offset = void 0
  }
  get Disabled() {
    let t = 0;
    return 6 === this.Context?.Type && this.Context.BtType === Protocol_1.Aki.Protocol.hps.Proto_BtTypeQuest ? t = this.Context.TreeConfigId : 2 === this.Context?.Type && (t = this.Context.QuestId), t ? ModelManager_1.ModelManager.QuestNewModel.IsInFocusMode() && !ModelManager_1.ModelManager.QuestNewModel.IsInFocusOnQuest(t) : this.k_h
  }
  Init(t, o, s, i, e, r, c = 0, n = 0, h = !1, a) {
    this.InstanceId = t, this.Guid = o.Guid, this.Type = o.Type, this.Icon = o.Icon, this.TidContent = o.TidContent, this.Condition = o.Condition, this.Context = LevelGeneralContextDefine_1.GeneralContext.Copy(s), this.Range = i, this.DoIntactType = e, this.OptionType = r, this.CustomOptionType = c, this.ContentType = n, this.DelayRemove = h, this.LockTips = a, this.Offset = Vector_1.Vector.Create(o.InteractPointOffset?.X ?? 0, o.InteractPointOffset?.Y ?? 0, o.InteractPointOffset?.Z ?? 0), this.ConditionCheck = !1, o.UniquenessTest ? (this.IsUniqueness = !0, this.UniequenessType = o.UniquenessTest) : this.IsUniqueness = !1
  }
  Dispose() {
    this.Context && (this.Context.Release(), this.Context = void 0), this.Condition = void 0, this.TidContent = void 0
  }
  SetDisable(t) {
    this.k_h = t
  }
...
class ActionMoveToLocation {
  constructor() {
    this.ToLocation = void 0, this.MoveState = 0, this.IsNavigation = !1, this.IsFly = !1, this.DebugMode = !1, this.MoveSpeed = 0
  }
}
