...
class TimeTrackControlModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.zxe = void 0, this.Zxe = void 0, this.ewe = void 0, this.twe = 0, this.iwe = 0, this.owe = !1, this.rwe = 0, this.FBn = 0, this.nwe = void 0, this.swe = void 0
  }
  get CreatureDataId() {
    return this.twe
  }
  ...
  SetCurrentTimeTrackControl(t, i) {
    this.zxe = ModelManager_1.ModelManager.CreatureModel.GetEntity(t), this.Zxe = i;
    t = this.zxe?.Entity.GetComponent(0);
    this.twe = t?.GetCreatureDataId() ?? 0, this.awe(), this.owe = !0
  }
  awe() {
    var t;
    this.zxe && void 0 !== this.Zxe && (t = this.zxe.Entity.GetComponent(134)) && (this.ewe = t.GetTimeTrackControlConfig(this.Zxe))
  }
  ...
  GetConfigSegmentTime() {
    return this.ewe && this.ewe.SegmentTime || .5
  }
  InitControlInfo(t) {
  ...
  UpdatePointsUsable() {
    ...
    if (i) {
      ...
      for (let t = this.iwe - 1; 0 <= t; t--) s.gGs && this.swe[t + 1] ? this.swe[t] = this.nwe[t + 1].gGs ?? !1 : this.swe[t] = !1;
      for (let t = this.iwe + 1; t < i; t++) s.fGs && this.swe[t - 1] ? this.swe[t] = this.nwe[t - 1].fGs ?? !1 : this.swe[t] = !1
    }
  }
