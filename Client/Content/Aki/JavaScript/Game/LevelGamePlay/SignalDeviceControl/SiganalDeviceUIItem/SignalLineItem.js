...
class LinkingLineItem extends UiPanelBase_1.UiPanelBase {
  constructor(i) {
    super(), this.LineType = 3, this.SprBg = void 0, this.SprLine = void 0, this.SprLineHalf = void 0, this.SprSpot = void 0, this.SprRay = void 0, this.SprRayHalf = void 0, this.LineType = i
  }
  static Create(i) {
  ...
  OnStart() {
    this.SprBg = this.GetSprite(0), this.SprLine = this.GetSprite(1), this.SprLineHalf = this.GetSprite(2), this.SprSpot = this.GetSprite(3), this.SprRay = this.GetSprite(4), this.SprRayHalf = this.GetSprite(5), this.SprBg.SetUIActive(!1), this.SprLine.SetUIActive(!1), this.SprLineHalf.SetUIActive(!1), this.SprSpot.SetUIActive(!1), this.SprRay.SetUIActive(!1), this.SprRayHalf.SetUIActive(!1)
  }
  InitIcon(i, e = !1) {
    ...
    var o = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(a),
      t = (this.SetSpriteByPath(o, this.SprRay, !1), this.SetSpriteByPath(o, this.SprRayHalf, !1), LinkingLineItem.ColorMap.get(n)),
      o = (1 === ModelManager_1.ModelManager.SignalDeviceModel.ViewType ? (o = LinkingLineItem.ColorSprBgMap.get(n), n = ConfigManager_1.ConfigManager.UiResourceConfig.GetResourcePath(o), this.SetSpriteByPath(n, this.SprBg, !1)) : this.SprBg.SetColor(UE.Color.FromHex(t)), this.SprLine.SetColor(UE.Color.FromHex(t)), this.SprLineHalf.SetColor(UE.Color.FromHex(t)), this.RotateLine(i), 3 === this.LineType || 4 === this.LineType);
    this.SprBg.SetUIActive(!0), this.SprLine.SetUIActive(!e), this.SprLineHalf.SetUIActive(e), this.SprRay.SetUIActive(!e), this.SprRayHalf.SetUIActive(e || !o), this.SprSpot.SetUIActive(!0)
  }
  RotateLine(i) {
    ...
    e.Yaw = i, this.GetRootItem().SetUIRelativeRotation(e.ToUeRotator()), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Temp", 35, "RotateLine", ["angle", i])
  }
  SetLineHalf(i) {
    this.SprLine.SetUIActive(!1), this.SprLineHalf.SetUIActive(!0), this.SprRay.SetUIActive(!1), this.SprRayHalf.SetUIActive(!0);
