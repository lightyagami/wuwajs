...
class LevelConditionCheckBuff extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    var t = UE.KismetStringLibrary.Conv_StringToInt(e.LimitParams.get("PbDataId")),
      a = UE.KismetStringLibrary.Conv_StringToInt(e.LimitParams.get("IsPlayer")),
      e = Number(UE.KismetStringLibrary.Conv_StringToInt64(e.LimitParams.get("BuffId")));
    if (a) {
      a = Global_1.Global.BaseCharacter.GetEntityIdNoBlueprint();
      const l = EntitySystem_1.EntitySystem.Get(a)?.GetComponent(174);
      return !!l?.GetBuffTotalStackById(e)
    }
    const l = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(t)?.Entity?.GetComponent(174);
    return !!l?.GetBuffTotalStackById(e)
  }
}
