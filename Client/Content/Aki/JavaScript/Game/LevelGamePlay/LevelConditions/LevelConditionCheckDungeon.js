...
exports.LevelConditionCheckDungeon = undefined;
const ModelManager_1 = require("../../Manager/ModelManager");
const LevelGeneralBase_1 = require("../LevelGeneralBase");
class LevelConditionCheckDungeon extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    var r;
    return !!e.LimitParams && !!(e = e.LimitParams.get("Id")) && (r = ModelManager_1.ModelManager.CreatureModel.GetInstanceId(), parseInt(e) === r);
  }
}
