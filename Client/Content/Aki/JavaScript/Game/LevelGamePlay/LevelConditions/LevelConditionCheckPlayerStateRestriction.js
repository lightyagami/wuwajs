...
class LevelConditionCheckPlayerStateRestriction extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, r) {
    ...
    if (!t) return Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelCondition", 36, "[CheckPlayerStateRestriction]无法获取当前角色"), !1;
    var a = t.Entity.GetComponent(205);
    if (!a) return Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelCondition", 36, "[CheckPlayerStateRestriction]无法获取当前角色BaseTagComponent组件"), !1;
    t = PlayerStateRestrictionById_1.configPlayerStateRestrictionById.GetConfig(e.RestrictionId);
    if (t) {
      for (const o of t.IncludedTags)
        if (!a.HasTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(o))) return !1;
      for (const i of t.ExcludedTags)
        if (a.HasTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(i))) return !1
    }
    return !0
  }
}
