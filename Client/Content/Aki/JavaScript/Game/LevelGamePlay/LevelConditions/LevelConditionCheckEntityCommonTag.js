...
class LevelConditionCheckEntityCommonTag extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    ...
    for (const i of e) {
      ...
      if (o.GetPbDataId() === n)
        if (!i.Entity.GetComponent(196)?.ContainsTagByName(a)) return !1
    }
    return !0
  }
  CheckNew(e, r) {
    ...
    return n && (n = EntitySystem_1.EntitySystem.GetComponent(n.Id, 196)) && (t = n.HasTag(e.TagId)), e.IsContain ? t : !t
  }
}
