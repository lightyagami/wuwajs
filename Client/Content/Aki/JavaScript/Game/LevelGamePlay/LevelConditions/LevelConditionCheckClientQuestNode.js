...
exports.LevelConditionCheckClientQuestNode = undefined;
...
class LevelConditionCheckClientQuestNode extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    ...
    switch (n) {
      ...
      case 2:
        if (ModelManager_1.ModelManager.QuestNewModel.GetQuestState(o) === 3) {
          return true;
        } else {
          return !!(t = ModelManager_1.ModelManager.QuestNewModel.GetQuest(o)?.GetNode(a)) && t.IsSuccess;
        }
      default:
        return false;
    }
