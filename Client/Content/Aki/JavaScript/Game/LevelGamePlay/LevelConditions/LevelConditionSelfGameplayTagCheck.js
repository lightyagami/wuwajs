...
class LevelConditionSelfGameplayTagCheck extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, a) {
    return !!e.LimitParams && !!a && !!(e = e.LimitParams.get("GamePlayTag")) && a instanceof TsBaseCharacter_1.default && (a.CharacterActorComponent?.Entity?.GetComponent(217)?.HasTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e)) ?? false);
  }
}
