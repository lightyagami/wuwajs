...
class LevelEventSetVar extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, r, t) {
    e ? (LevelGeneralNetworks_1.LevelGeneralNetworks.RequestDoAction(t, r), this.FinishExecute(!0)) : (Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 7, "LevelEventSetVar, 设定变量的值参数为空"), this.FinishExecute(!1))
  }
}
