...
class LevelConditionCheckFishingTechUnlock extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, o) {
    ...
    return !n || isNaN(n) ? (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 74, "CheckFishingTechUnlock条件参数错误, 无法解析为数值"), !1) : (e = "TRUE" === (e.LimitParams.get("ReverseUnlockCheck") ?? "FALSE").toUpperCase(), ModelManager_1.ModelManager.FishingModel.GetFishingTechUnlock(n) !== e)
  }
}
