...
class LevelConditionCheckFishingEntrustState extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, t) {
    ...
    return isNaN(r) || isNaN(e) ? (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 74, "CheckFishingEntrustState条件参数错误, 无法解析为数值"), !1) : void 0 === (r = ModelManager_1.ModelManager.FishingQuestModel.CurrentEntrusts.get(r)) ? e === NONE_OR_FINISHED : r === e
  }
}
