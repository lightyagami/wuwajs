...
class LevelConditionSelfState extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, r, t) {
    ...
    return !!(l = t && t.Type === 1 ? ModelManager_1.ModelManager.CreatureModel.GetEntityById(t.EntityId) : l)?.Valid && !!(r = l.Entity.GetComponent(197)) && (t = r.ContainsTagByName(e.State), e.Compare === "Eq" ? t : !t);
  }
}
