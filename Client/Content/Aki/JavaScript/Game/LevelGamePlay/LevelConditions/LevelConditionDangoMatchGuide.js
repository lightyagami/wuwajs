...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.LevelConditionCheckDangoMatchFinalEnd = exports.LevelConditionCheckDangoMatchPlayerNumType = exports.LevelConditionCheckDangoMatchState = exports.LevelConditionOnEnterDangoMatchView = void 0;
...
class LevelConditionCheckDangoMatchFinalEnd extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, a) {
    var n, t = ModelManager_1.ModelManager.RacingBetsModel.GetRacingBetsSeasonData();
    return !!t && !!(t = t.GetCurLegMatchData()) && (n = ModelManager_1.ModelManager.RacingBetsModel.IsFinalLegMatch(t.Id), t = 4 === t.GetLegMatchState(), n) && t
  }
}
