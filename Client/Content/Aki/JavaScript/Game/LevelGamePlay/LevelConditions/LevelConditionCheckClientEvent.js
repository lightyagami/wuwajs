...
class LevelConditionCheckClientEvent extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, t, n) {
    if (10 === n?.Type && (n.EventName === EventDefine_1.EEventName.CheckClientEvent && n.GetEventHandleParams()?.[0] === GameplayTagUtils_1.GameplayTagUtils.GetGameplayTagByName(e.EventName))) return !0;
    return !1
  }
}
