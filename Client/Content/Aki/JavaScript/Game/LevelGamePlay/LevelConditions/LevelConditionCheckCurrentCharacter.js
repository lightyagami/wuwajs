...
class LevelConditionCheckCurrentCharacter extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e) {
    var r;
    return !!e && (e = e, r = ModelManager_1.ModelManager.RoleModel.GetBattleTeamFirstRoleId(), r = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(r)?.Id, r = e.RoleId === r, "Eq" === e.Compare ? r : !r)
  }
}
