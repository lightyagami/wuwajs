...
class LevelConditionCheckInTodTimeSpan extends LevelGeneralBase_1.LevelConditionBase {
  ...
  CheckNew(e, r) {
    var n, o;
    return !!e && !(!(e = e).Start || !e.End) && (o = e.Start.Hour * CommonDefine_1.MINUTE_PER_HOUR + e.Start.Min, n = e.End.Hour * CommonDefine_1.MINUTE_PER_HOUR + e.End.Min, o = ControllerHolder_1.ControllerHolder.TimeOfDayController.CheckInMinuteSpan(o, n), "Eq" === e.Compare ? o : !o)
  }
}
