...
class LevelConditionCheckDungeonFinished extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    var a;
    return !!e.LimitParams && !!(a = e.LimitParams.get("InstanceId")) && (e = e.LimitParams.get("Finish"), !!a) && (a = parseInt(a), 1 === parseInt(e) === ModelManager_1.ModelManager.ExchangeRewardModel?.IsFinishInstance(a))
  }
}
