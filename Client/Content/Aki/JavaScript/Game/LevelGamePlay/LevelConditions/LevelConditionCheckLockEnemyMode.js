...
class LevelConditionCheckLockEnemyMode extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    var t = parseInt(e),
      a = GameSettingsManager_1.GameSettingsManager.GetCurrentValue(GameSettingsDefine_1.EFunction.KeyboardLockEnemyMode),
      r = GameSettingsManager_1.GameSettingsManager.GetCurrentValue(GameSettingsDefine_1.EFunction.GamepadLockEnemyMode);
