...
class LevelConditionCheckGamePlayTag extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, a) {
    var l;
    var r;
    return !!e && !!(l = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity?.Entity) && !!(l = l.GetComponent(217)) && (r = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e.GameplayTag), e.Compare === "Eq" && !!l.HasTag(r) || e.Compare === "Ne" && !l.HasTag(r));
  }
}
