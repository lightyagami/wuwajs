...
class LevelConditionOnSkillButtonDataRefresh extends LevelGeneralBase_1.LevelConditionBase {
  ...
  Check(e, t, ...s) {
    ...
    return void 0 !== e && 0 !== s.length && (s = s[0], this.yGl !== s && (this.yGl = s, this.MGl = -1, this.xk_ = -1), s = Number(e), e = i.GetSkillButtonIndexByButton(s), i = i.GetSkillButtonDataByButton(s)?.GetSkillId(), -1 === this.MGl && -1 === this.xk_ ? (this.MGl = e, this.xk_ = i ?? -1, !0) : this.MGl === e && this.xk_ === i)
  }
}
