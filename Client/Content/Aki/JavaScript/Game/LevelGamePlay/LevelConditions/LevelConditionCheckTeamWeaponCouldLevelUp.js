...
class LevelConditionCheckTeamWeaponCouldLevelUp extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, a) {
    for (const n of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems(!0)) {
      var o = n.GetConfigId,
        o = ModelManager_1.ModelManager.WeaponModel.GetWeaponDataByRoleDataId(o);
      if (o && typeof o == typeof WeaponInstance_1.WeaponInstance) {
        ...
        for (const r of ModelManager_1.ModelManager.WeaponModel.GetWeaponExpItemList(o.GetIncId()))
          if (0 < ModelManager_1.ModelManager.InventoryModel.GetItemCountByConfigId(r.GetConfigId())) {
            e = !0;
            break
