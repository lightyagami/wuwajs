...
const LevelConditionCheckPlayerRelativeAngle_1 = require("../LevelConditionCheckPlayerRelativeAngle");
const LevelConditionCheckPlayerRelativeDistance_1 = require("../LevelConditionCheckPlayerRelativeDistance");
...
const LevelConditionAlwaysTrue_1 = require("./LevelConditionAlwaysTrue");
...
const LevelConditionCheckCharacterVehicleTagByEvent_1 = require("./LevelConditionCheckCharacterVehicleTagByEvent");
...
const LevelConditionCheckDungeonTypes_1 = require("./LevelConditionCheckDungeonTypes");
...
const LevelConditionCheckIsHasRecommendActivity_1 = require("./LevelConditionCheckIsHasRecommendActivity");
...
const LevelConditionCheckRoleOwned_1 = require("./LevelConditionCheckRoleOwned");
...
const LevelConditionCheckTrafficBlocked_1 = require("./LevelConditionCheckTrafficBlocked");
...
const LevelConditionCheckUIShowDone_1 = require("./LevelConditionCheckUIShowDone");
...
const LevelConditionMotorMovieModeStateChange_1 = require("./LevelConditionMotorMovieModeStateChange");
...
const LevelConditionOnGuideTriggerEvent_1 = require("./LevelConditionOnGuideTriggerEvent");
...
const LevelConditionOnRollBlockDifficultyChanged_1 = require("./LevelConditionOnRollBlockDifficultyChanged");
...
class LevelConditionCenter {
  ...
  static RegistConditions() {
    ...
    this.$Te(E_LGC.CheckCharacterVehicleTagNotByEvent, LevelConditionCheckCharacterVehicleTagByEvent_1.LevelConditionCheckCharacterVehicleTagByEvent);
    this.$Te(E_LGC.CheckCharacterVehicleTagByEvent, LevelConditionCheckCharacterVehicleTagByEvent_1.LevelConditionCheckCharacterVehicleTagByEvent, [EventDefine_1.EEventName.OnGlobalGameplayTagChanged]);
    ...
    this.$Te(E_LGC.CheckRoleOwned, LevelConditionCheckRoleOwned_1.LevelConditionCheckRoleOwned);
    ...
    this.$Te(E_LGC.CheckUIShowDone, LevelConditionCheckUIShowDone_1.LevelConditionCheckUIShowDone, [EventDefine_1.EEventName.OnViewShow]);
    ...
    this.$Te(E_LGC.OnMapCustomMarkPanelShow, LevelConditionAlwaysTrue_1.LevelConditionAlwaysTrue, [EventDefine_1.EEventName.OnMapCustomMarkPanelShow]);
    this.$Te(E_LGC.OnPhantomArenaChooseCardPanelShow, LevelConditionAlwaysTrue_1.LevelConditionAlwaysTrue, [EventDefine_1.EEventName.OnPhantomArenaChooseCardPanelShow]);
    this.$Te(E_LGC.OnPhantomArenaDiscardCardPanelShow, LevelConditionAlwaysTrue_1.LevelConditionAlwaysTrue, [EventDefine_1.EEventName.OnPhantomArenaDiscardCardPanelShow]);
    this.$Te(E_LGC.OnMotorDiyViewShow, LevelConditionAlwaysTrue_1.LevelConditionAlwaysTrue, [EventDefine_1.EEventName.OnMotorDiyViewShow]);
    this.$Te(E_LGC.OnPhantomArenaPlayFieldEffect, LevelConditionAlwaysTrue_1.LevelConditionAlwaysTrue, [EventDefine_1.EEventName.OnPhantomArenaPlayFieldEffect]);
    this.$Te(E_LGC.OnRollBlockDifficultyChanged, LevelConditionOnRollBlockDifficultyChanged_1.LevelConditionOnRollBlockDifficultyChanged, [EventDefine_1.EEventName.OnRollBlockDifficultyChanged]);
    this.$Te(E_LGC.CheckDungeonTypes, LevelConditionCheckDungeonTypes_1.LevelConditionCheckDungeonTypes, [EventDefine_1.EEventName.WorldDone]);
    ...
    this.$Te("CheckPlayerEnterClientTriggerDir", LevelConditionCheckPlayerEnterClientTriggerDir_1.LevelConditionCheckPlayerEnterClientTriggerDir);
