...
class LevelConditionCheckHasFirstPhantomAtPosition extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    ...
    if (1 === parseInt(e.LimitParams.get("IsFull"))) {
      for (const t of o)
        if (0 === ControllerHolder_1.ControllerHolder.PhantomBattleController.GetEquipByIndex(t.GetConfigId, 0)) return !1;
      return !0
    }
    ...
    const t = o[n - 1];
    return 0 !== ControllerHolder_1.ControllerHolder.PhantomBattleController.GetEquipByIndex(t.GetConfigId, 0) == e
  }
}
