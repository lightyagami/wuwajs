...
exports.LevelConditionCheckPhantomMaxLevel = exports.LevelConditionCheckPhantomLevel = undefined;
const LevelGeneralBase_1 = require("../LevelGeneralBase");
const ControllerHolder_1 = require("../../Manager/ControllerHolder");
class LevelConditionCheckPhantomLevel extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    var l;
    return !!e.LimitParams && (l = e.LimitParams.get("ItemId"), e = e.LimitParams.get("Level"), l = l ? parseInt(l) : 0, e = e ? parseInt(e) : 0, ControllerHolder_1.ControllerHolder.PhantomBattleController.CheckPhantomLevelSatisfied(l, e));
  }
}
