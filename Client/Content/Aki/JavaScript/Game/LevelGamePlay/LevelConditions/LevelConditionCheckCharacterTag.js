...
class LevelConditionCheckCharacterTag extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, a) {
    var r;
    return !!e.LimitParams && !!(e = e.LimitParams.get("Tag")) && !!(r = (r = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity) && r.Entity.GetComponent(215)) && r.HasTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e));
  }
  CheckNew(e, a) {
    if (!e) {
      return false;
    ...
    if (l &&= l.Entity.GetComponent(215)) {
      r = l.HasTag(e.TagId);
    }
    if (e.IsContain) {
      return r;
