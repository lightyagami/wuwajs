...
class LevelConditionEntityState extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, a) {
    var t;
    return !!e && (e = e, !!(t = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.EntityId))?.Valid) && !!(t = t.Entity.GetComponent(196)) && (t = t.ContainsTagByName(e.State), e.Compare === "Eq" ? t : !t);
  }
}
