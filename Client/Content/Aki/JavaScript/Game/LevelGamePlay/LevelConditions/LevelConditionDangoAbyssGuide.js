...
class LevelConditionOnDangoAbyssPluginRoleSelect extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n, ...s) {
    ...
    return !(void 0 === e || isNaN(e) || !s || ModelManager_1.ModelManager.DangoAbyssModel.GetSlotLockState(s, e))
  }
}
...
class LevelConditionCheckDangoAbyssHasItemByType extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    return void 0 !== e && !isNaN(e) && 0 < ModelManager_1.ModelManager.DangoAbyssModel.GetPluginItemListByType(e).length
  }
}
...
class LevelConditionCheckDangoAbyssProgress extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    return void 0 !== e && !isNaN(e) && (ModelManager_1.ModelManager.DangoAbyssModel.GetCurrentOpenAbyssActivityData()?.GetCanChallengeIdList().length ?? 0) >= e + 1
  }
}
