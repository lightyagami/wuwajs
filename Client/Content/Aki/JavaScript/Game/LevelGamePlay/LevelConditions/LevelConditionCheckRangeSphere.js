...
class LevelConditionRangeSphere extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, r) {
    var o, l;
    return !!e && (e = e, o = Vector_1.Vector.Create(e.Center.X ?? 0, e.Center.Y ?? 0, e.Center.Z ?? 0), void 0 !== (l = Global_1.Global.BaseCharacter?.CharacterActorComponent?.ActorLocationProxy)) && Vector_1.Vector.DistSquared(o, l) <= Math.pow(e.Radius, 2)
  }
}
