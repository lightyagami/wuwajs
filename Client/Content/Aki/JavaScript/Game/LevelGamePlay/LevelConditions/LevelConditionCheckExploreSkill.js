...
class LevelConditionCheckExploreSkill extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, o) {
    var r;
    return 0 === e.LimitParams.size ? (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 16, "配置错误！条件的参数不应该为空", ["inConditionInfo.Id", e.Id]), !1) : (r = Number(e.LimitParams.get("探索技能Id"))) ? r === ModelManager_1.ModelManager.RouletteModel.CurrentExploreSkillId : (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 16, `配置错误！条件${e.Id}的探索技能Id应该是数字`), !1)
  }
}
