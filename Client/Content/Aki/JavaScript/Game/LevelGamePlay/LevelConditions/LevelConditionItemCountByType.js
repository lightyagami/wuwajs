...
class LevelConditionItemCountByType extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    var a, t;
    return !!e.LimitParams && void 0 !== (a = Number(e.LimitParams.get("ItemType"))) && (t = Number(e.LimitParams.get("Value")), !!(e = e.LimitParams.get("Op"))) && this.CheckCompareValue(e, ModelManager_1.ModelManager.InventoryModel.GetItemDataBaseByItemType(a).size, t)
  }
}
