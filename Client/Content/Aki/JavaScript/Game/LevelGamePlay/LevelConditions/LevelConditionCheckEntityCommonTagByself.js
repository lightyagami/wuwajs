...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.LevelConditionCheckEntityCommonTagBySelf = exports.ConditionExParamsCheckEntityCommonTagBySelf = void 0;
const UE = require("ue"),
  ...
  Check(e, t) {
    ...
    if (!n) {
      ...
      for (const a of o) {
        ...
        void 0 === r ? Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 17, "不存在Tag,请检查条件配置", ["tag", a], ["条件Id", e.Id]) : n.TagIds.push(r)
      }
      LevelConditionCenter_1.LevelConditionCenter.SetConditionExParams(e.Id, n)
    }
    if (n.TagIds && 0 < n.TagIds.length) {
      if (!UE.KuroStaticLibrary.IsImplementInterface(t.GetClass(), UE.BPI_CreatureInterface_C.StaticClass())) return !1;
      o = t, t = EntitySystem_1.EntitySystem.Get(o.GetEntityId());
      if (!t) return !1;
      var i = t.GetComponent(196);
      if (!i) return !1;
      for (const s of n.TagIds)
        if (!i.HasTag(s)) return !1
    }
    return !0
  }
}
