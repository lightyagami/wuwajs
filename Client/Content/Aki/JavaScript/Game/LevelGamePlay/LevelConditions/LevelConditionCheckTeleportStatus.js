...
class LevelConditionCheckTeleportStatus extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, a) {
    var r;
    return !!e.LimitParams && (r = e.LimitParams.get("TeleportId"), e = e.LimitParams.get("State"), !!r) && (1 === (e ? parseInt(e) : 0) ? ModelManager_1.ModelManager.MapModel.CheckTeleportUnlocked(parseInt(r)) ?? !1 : !ModelManager_1.ModelManager.MapModel.CheckTeleportUnlocked(parseInt(r)))
  }
}
