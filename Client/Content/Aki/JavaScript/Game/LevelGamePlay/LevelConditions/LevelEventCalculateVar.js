...
class LevelEventCalculateVar extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, l, r) {
    e ? (LevelGeneralNetworks_1.LevelGeneralNetworks.RequestDoAction(r, l), this.FinishExecute(!0)) : (Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 7, "LevelEventCalculateVar, 对变量进行运算参数为空"), this.FinishExecute(!1))
  }
}
