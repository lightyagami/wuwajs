...
class LevelConditionHpLowerThan extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    if (e.LimitParams.size === 0) {
      ...
      return !!(t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity) && !(i = t.Entity.GetComponent(182)?.GetCurrentValue(EAttributeId.Proto_Life), r = t.Entity.GetComponent(182)?.GetCurrentValue(EAttributeId.l5n), !i) && !!r && i / r < o / CommonDefine_1.RATE_10000;
    } else {
      if (Log_1.Log.CheckError()) {
