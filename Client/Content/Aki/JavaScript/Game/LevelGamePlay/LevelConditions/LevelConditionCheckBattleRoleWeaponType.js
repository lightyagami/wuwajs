...
class LevelConditionCheckBattleRoleWeaponType extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, o) {
    var n;
    return 0 === e.LimitParams.size ? (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 16, "配置错误！条件的参数不应该为空", ["inConditionInfo.Id", e.Id]), !1) : !!(e = e.LimitParams.get("WeaponType")) && (e = parseInt(e), !!(n = ModelManager_1.ModelManager.RoleModel.GetBattleTeamFirstRoleId())) && ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(n).WeaponType === e
  }
}
