...
class LevelConditionForMoonChasingCheckTargetBuiltCount extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    var e = e.LimitParams,
      ...
      e = e.get("Op");
    return void 0 !== o && void 0 !== e && (o = parseInt(o), this.CheckCompareValue(e, ModelManager_1.ModelManager.MoonChasingBuildingModel.GetBuiltBuildingCount(), o))
  }
}
...
class LevelConditionForMoonChasingCheckHasCanLevelUpBuilding extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    return void 0 !== ModelManager_1.ModelManager.MoonChasingBuildingModel.GetFirstCanLevelUpBuildingId()
  }
}
...
class LevelConditionForMoonChasingCheckNeedBranch extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    e = parseInt(e), e = ModelManager_1.ModelManager.MoonChasingRewardModel.GetTaskDataById(e);
    if (void 0 === e) return !1;
    let o = !1;
    for (const a of ConfigManager_1.ConfigManager.TaskConfig.GetAllBranchLineTask())
      if (1 === ModelManager_1.ModelManager.QuestNewModel.GetQuestState(a.TaskId)) {
        o = !0;
        break
...
class LevelConditionForMoonChasingCheckTaskState extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    var r = parseInt(o),
      o = parseInt(a);
    let t = 0;
    for (const i of ModelManager_1.ModelManager.MoonChasingBusinessModel.GetHelpEditTeamDataList()) i.GetTeamDataUnLockState() === r && ++t;
...
class LevelConditionForMoonChasingCheckMainlineTaskDone extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, n) {
    ...
    return void 0 !== e && 3 === ModelManager_1.ModelManager.MoonChasingTaskModel.GetMainLineState(parseInt(e))
  }
}
