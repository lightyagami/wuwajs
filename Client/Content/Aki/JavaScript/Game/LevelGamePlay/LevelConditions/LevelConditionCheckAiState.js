...
class LevelConditionCheckAiState extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, o, n) {
    if (!e) return Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 29, "参数不合法"), !1;
    if (!n) return Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 29, "上下文不合法"), !1;
    n = ModelManager_1.ModelManager.CreatureModel.GetEntityById(n.EntityId);
    if (!n?.Valid) return Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 29, "对象Entity不合法"), !1;
