...
class LevelConditionCheckSystemState extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, r) {
    var n;
    return !!e && (e = e.Config).Type === ICondition_1.ECheckSystemStateType.TrackMoonBuilding && (n = ModelManager_1.ModelManager.MoonChasingBuildingModel.GetBuildingDataById(e.BuildingId), e.IsBuilt === n.IsBuild)
  }
}
