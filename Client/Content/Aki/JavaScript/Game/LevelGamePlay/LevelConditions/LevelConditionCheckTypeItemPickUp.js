...
exports.LevelConditionCheckTypeItemPickUp = undefined;
const ConfigManager_1 = require("../../Manager/ConfigManager");
const LevelGeneralBase_1 = require("../LevelGeneralBase");
class LevelConditionCheckTypeItemPickUp extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r, ...n) {
    return !!e.LimitParams && !!(e = e.LimitParams.get("Type")) && (e = parseInt(e), ConfigManager_1.ConfigManager.ItemConfig.GetConfig(Number(n[0])).MainTypeId === e);
  }
}
