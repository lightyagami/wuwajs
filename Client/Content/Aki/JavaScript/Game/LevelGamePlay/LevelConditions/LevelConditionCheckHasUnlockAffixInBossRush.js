...
class LevelConditionCheckHasUnlockAffixInBossRush extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, s) {
    return !!e.LimitParams && !!(e = Number(e.LimitParams.get("ActivityId"))) && 1 < ModelManager_1.ModelManager.ActivityModel.GetActivityById(e).GetUnlockedBuffIndices().length
  }
}
