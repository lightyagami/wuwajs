...
class LevelConditionLiftLocation extends LevelGeneralBase_1.LevelConditionBase {
  CheckNew(e, r) {
    if (!e) return !1;
    let t = void 0;
    return e.IsSelf ? r && (t = ActorUtils_1.ActorUtils.GetEntityByActor(r)) : t = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.EntityId), !!t?.Valid && !!(r = t.Entity.GetComponent(139)) && (r = r.CurLiftFloor === e.Location, "Eq" === e.Compare ? r : !r)
  }
}
