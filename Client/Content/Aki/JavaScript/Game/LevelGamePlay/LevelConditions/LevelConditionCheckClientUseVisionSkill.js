...
class LevelConditionCheckClientUseVisionSkill extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, l) {
    ...
    if (e.LimitParams.size === 0) {
      ...
      return !!(n = Global_1.Global.BaseCharacter) && !!(i = n.GetEntityNoBlueprint()?.GetComponent(43)) && !!(n = n.GetEntityNoBlueprint()?.GetComponent(40)) && !!(i = i.GetVisionData(Number(o))) && !!n.GetSkill(i.技能ID)?.Active;
    } else {
      if (Log_1.Log.CheckError()) {
