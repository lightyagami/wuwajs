...
class LevelConditionCheckClientUseVisionSkill extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, l) {
    var o, n, i;
    return 0 === e.LimitParams.size ? (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 16, "配置错误！条件的参数不应该为空", ["inConditionInfo.Id", e.Id]), !1) : (o = e.LimitParams.get("PhantomSkillId")) ? !!(n = Global_1.Global.BaseCharacter) && !!((i = n.GetEntityNoBlueprint()?.GetComponent(43)) && (n = n.GetEntityNoBlueprint()?.GetComponent(40)) && (i = i.GetVisionData(Number(o))) && n.GetSkill(i.技能ID)?.Active) : (Log_1.Log.CheckError() && Log_1.Log.Error("LevelCondition", 16, `配置错误！条件${e.Id}的参数不符合条件类型${LevelGeneralDefine_1.ELevelGeneralCondition.CheckClientUseVisionSkill}的定义`), !1)
  }
}
