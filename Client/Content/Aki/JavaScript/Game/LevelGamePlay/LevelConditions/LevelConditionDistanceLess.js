...
class LevelConditionDistanceLess extends LevelGeneralBase_1.LevelConditionBase {
  Check(e, r) {
    ...
    if (!s || !n) return !1;
    let a = r;
    return !!(a = "Trigger" !== s ? LevelGeneralCommons_1.LevelGeneralCommons.FindTargetWithTag(s) : a) && !!(r = LevelGeneralCommons_1.LevelGeneralCommons.FindTargetWithTag(n)) && a.GetDistanceTo(r) < parseFloat(e)
  }
}
