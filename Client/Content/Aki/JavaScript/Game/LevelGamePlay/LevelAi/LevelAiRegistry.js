...
exports.LevelAiRegistry = undefined;
...
const LevelAiTaskEntityTurnTo_1 = require("./Tasks/LevelAiTaskEntityTurnTo");
...
class LevelAiRegistry {
  ...
  VZ() {
    ...
    this.STe.set("PlayRegisteredMontage", LevelAiTaskPlayMontage_1.LevelAiTaskPlayMontage);
    ...
    this.STe.set("EntityTurnTo", LevelAiTaskEntityTurnTo_1.LevelAiTaskEntityTurnTo);
    this.STe.set("NpcLeisureInteract", LevelAiTaskLeisureInteract_1.LevelAiTaskLeisureInteract);
  }
  HZ() {
    this.yTe.set("CompareVar", LevelAiDecoratorCompareVar_1.LevelAiDecoratorCompareVar);
    this.yTe.set("CompareQuestState", LevelAiDecoratorQuestState_1.LevelAiDecoratorQuestState);
    this.yTe.set("CompareEntityState", LevelAiDecoratorEntityState_1.LevelAiDecoratorEntityState);
    this.yTe.set("HourToHour", LevelAiDecoratorCheckInTodTimeSpan_1.LevelAiDecoratorCheckInTodTimeSpan);
    this.yTe.set("CompareWeather", LevelAiDecoratorCheckWeather_1.LevelAiDecoratorCheckWeather);
    this.yTe.set("CompareTimePeriod", LevelAiDecoratorCheckTodTimePeriod_1.LevelAiDecoratorCheckTodTimePeriod);
    this.yTe.set("CheckLevelPlayState", LevelAiDecoratorCheckLevelPlayState_1.LevelAiDecoratorCheckLevelPlayState);
...
(exports.LevelAiRegistry = LevelAiRegistry).cj = undefined;
