...
class LevelAiRegistry {
  ...
  static Instance() {
    return LevelAiRegistry.cj || (LevelAiRegistry.cj = new LevelAiRegistry, LevelAiRegistry.cj.RegisterLevelAi()), LevelAiRegistry.cj
  }
  RegisterLevelAi() {
    this.VZ(), this.HZ()
  }
  VZ() {
    this.STe.set("Log", LevelAiTaskLog_1.LevelAiTaskLog), this.STe.set("SetVar", LevelAiTaskSetVar_1.LevelAiTaskSetVar), this.STe.set("PlayRegisteredMontage", LevelAiTaskPlayMontage_1.LevelAiTaskPlayMontage), this.STe.set("PlayBubble", LevelAiTaskPlayBubble_1.LevelAiTaskPlayBubble), this.STe.set("EntityLookAt", LevelAiTaskTurnTo_1.LevelAiTaskTurnTo), this.STe.set("EntityTurnTo", LevelAiTaskEntityTurnTo_1.LevelAiTaskEntityTurnTo), this.STe.set("NpcLeisureInteract", LevelAiTaskLeisureInteract_1.LevelAiTaskLeisureInteract)
  }
  HZ() {
    this.yTe.set("CompareVar", LevelAiDecoratorCompareVar_1.LevelAiDecoratorCompareVar), this.yTe.set("CompareQuestState", LevelAiDecoratorQuestState_1.LevelAiDecoratorQuestState), this.yTe.set("CompareEntityState", LevelAiDecoratorEntityState_1.LevelAiDecoratorEntityState), this.yTe.set("HourToHour", LevelAiDecoratorCheckInTodTimeSpan_1.LevelAiDecoratorCheckInTodTimeSpan), this.yTe.set("CompareWeather", LevelAiDecoratorCheckWeather_1.LevelAiDecoratorCheckWeather), this.yTe.set("CompareTimePeriod", LevelAiDecoratorCheckTodTimePeriod_1.LevelAiDecoratorCheckTodTimePeriod), this.yTe.set("CheckLevelPlayState", LevelAiDecoratorCheckLevelPlayState_1.LevelAiDecoratorCheckLevelPlayState), this.yTe.set("CheckChildQuestFinished", LevelAiDecoratorQuestStepState_1.LevelAiDecoratorQuestStepState)
  }
  FindTaskCtor(e) {
