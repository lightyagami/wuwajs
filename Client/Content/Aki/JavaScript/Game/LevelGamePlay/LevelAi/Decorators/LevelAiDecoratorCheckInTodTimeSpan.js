...
class LevelAiDecoratorCheckInTodTimeSpan extends LevelAiDecorator_1.LevelAiDecorator {
  ...
  CheckCondition(e) {
    var o, r, n = this.Params;
    return !(!n.Start || !n.End) && (r = n.Start.Hour * CommonDefine_1.MINUTE_PER_HOUR + n.Start.Min, o = n.End.Hour * CommonDefine_1.MINUTE_PER_HOUR + n.End.Min, r = ControllerHolder_1.ControllerHolder.TimeOfDayController.CheckInMinuteSpan(r, o), "Eq" === n.Compare ? r : !r)
  }
}
