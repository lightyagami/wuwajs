...
class LevelAiDecoratorCheckTodTimePeriod extends LevelAiDecorator_1.LevelAiDecorator {
  ...
  CheckCondition(e) {
    ...
    let i = 0,
      o = 0;
    o = "DayTime" === r.TimePeriod ? (i = DAYTIME_HOUR_START * TimeOfDayDefine_1.TOD_MINUTE_PER_HOUR, DAYTIME_HOUR_END * TimeOfDayDefine_1.TOD_MINUTE_PER_HOUR) : (i = NIGHT_HOUR_START * TimeOfDayDefine_1.TOD_MINUTE_PER_HOUR, NIGHT_HOUR_END * TimeOfDayDefine_1.TOD_MINUTE_PER_HOUR);
