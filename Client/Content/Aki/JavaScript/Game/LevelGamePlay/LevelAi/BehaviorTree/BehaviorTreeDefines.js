...
class BehaviorTreeDefines {
  ...
  static set UseLevelAiBehaviorTree(e) {
    this.hIe || (this.hIe = !0, this.lIe = this._Ie()), this.lIe !== e && (this.lIe = e)
  }
  ...
  static GetLevelAiBehaviorTreeAssetPath(t) {
    ...
    if (t) {
      ...
      if (t && "" !== t) {
        let e = t.lastIndexOf("."); - 1 === e && (e = t.length);
  ...
  static _Ie() {
    ...
    return UE.KuroStaticLibrary.LoadFileToString(t, e) && "true" === (0, puerts_1.$unref)(t)
  }
...
}(exports.BehaviorTreeDefines = BehaviorTreeDefines).cIe = "/Game/Aki/AI/AINPC/LevelAiBT", BehaviorTreeDefines.uIe = "IsUseLevelAiBehaviorTree", BehaviorTreeDefines.BehaviorTreePatrolStateName = "PATROL_STATE", BehaviorTreeDefines.LevelAiSwitchName = "LEVEL_AI_STOP", BehaviorTreeDefines.PatrolFinishName = "PATROL_COMPLETE", BehaviorTreeDefines.DoOnceCheckName = "DO_ONCE_CHECK", BehaviorTreeDefines.lIe = !1, BehaviorTreeDefines.hIe = !1;
