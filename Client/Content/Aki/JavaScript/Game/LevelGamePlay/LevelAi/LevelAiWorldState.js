...
exports.LevelAiWorldState = undefined;
class LevelAiWorldState {
  ...
  MakeCopy() {
    ...
    for (const e of this.BooleanWorldState) {
      t.BooleanWorldState.set(e[0], e[1]);
    }
    for (const o of this.IntWorldState) {
      t.IntWorldState.set(o[0], o[1]);
    }
    return t;
  }
}
