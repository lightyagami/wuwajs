...
class LevelAiTaskSetItemCollision extends LevelAiTask_1.LevelAiTask {
  ...
  HTe(e, s) {
    ...
    let r = void 0;
    if (r = t && (t = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(t)) ? t.Entity.GetComponent(202) : e) {
      ...
      for (let e = 0; e < a; ++e) {
        var l = o.Get(e),
          ...
          n = _.Num();
        for (let e = 0; e < n; ++e) i.Actor.CapsuleComponent.IgnoreActorWhenMoving(_.Get(e), s)
      }
    }
  }
  VTe() {
    var e, s = this.ItemEntity.Entity.GetComponent(202);
    s && (e = this.CreatureDataComponent.Entity.GetComponent(2), this.HTe(s, !1), e.Actor.CapsuleComponent.SetCollisionResponseToChannel(2, 2))
  }
  FTe() {
    var e = this.ItemEntity.Entity.GetComponent(202);
    e && (this.HTe(e, !0), this.CreatureDataComponent.Entity.GetComponent(2).Actor.CapsuleComponent.SetCollisionResponseToChannel(2, 0))
  }
}
