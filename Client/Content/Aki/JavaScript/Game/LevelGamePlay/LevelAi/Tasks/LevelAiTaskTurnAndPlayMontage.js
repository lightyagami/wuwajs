...
class LevelAiTaskTurnAndPlayMontage extends LevelAiTask_1.LevelAiTask {
  ...
  AbortTask() {
    if (this.KTe < 3) {
      ...
      this.CreatureDataComponent.Entity.GetComponent(46).VolatileMontageStopByLoad(3, this.bTe, 0);
    }
    return 2;
  }
  OnTaskFinished(t) {
  ...
  QTe() {
    ...
    if (e) {
      if (t = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.EntityId)) {
        ...
        if ((t = t.Entity.GetComponent(45)?.CharacterMovement)?.IsValid()) {
  ...
  XTe() {
    ...
    if (i) {
      ...
      t = this.CreatureDataComponent.Entity.GetComponent(46);
      i = {
