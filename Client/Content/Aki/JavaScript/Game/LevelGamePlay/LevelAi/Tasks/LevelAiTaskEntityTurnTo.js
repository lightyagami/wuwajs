...
class LevelAiTaskEntityTurnTo extends LevelAiTask_1.LevelAiTask {
  constructor() {
    super(...arguments), this.Tae = void 0, this.WTe = 0, this.zLe = Vector_1.Vector.Create()
  }
  ExecuteTask() {
    var e = this.Params;
    if (!e) return 1;
    var r = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(e.EntityId);
    if (!r) return Log_1.Log.CheckError() && Log_1.Log.Error("LevelAi", 29, "执行转向动作时实体不存在:", ["PbDataId", e.EntityId]), 1;
    this.Tae = r.Entity.GetComponent(3);
    r = r.Entity.GetComponent(45)?.CharacterMovement;
    return r?.IsValid() && this.qJa(this.zLe, e) ? (this.WTe = r.MovementMode, r.MovementMode = 1, AiContollerLibrary_1.AiControllerLibrary.TurnToTarget(this.Tae, this.zLe, TURN_SPEED), this.NotifyTick = !0, 3) : 1
  }
  TickTask(e) {
    this.Tae.InputRotatorProxy.Equals(this.Tae.ActorRotationProxy, TOLERANCE) && (this.Tae.Entity.GetComponent(45).CharacterMovement.MovementMode = this.WTe, this.FinishLatentTask(0))
  }
  AbortTask() {
