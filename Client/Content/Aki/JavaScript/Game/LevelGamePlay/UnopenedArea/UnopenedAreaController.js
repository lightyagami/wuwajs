...
class UnopenedAreaController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return this.tBe = !PublicUtil_1.PublicUtil.GetIsSilentLogin(), this.tBe || this.PauseTick(), !0
  }
  static OnTick(e) {
...
}(exports.UnopenedAreaController = UnopenedAreaController).tBe = !1, UnopenedAreaController.iBe = new UnopenedAreaPullback_1.UnopenedAreaPullback, UnopenedAreaController.oBe = new UnopenedAreaCheck_1.UnopenedAreaCheck;
