    ...
    if (l)
      if (l.EntityIds && 0 !== l.EntityIds.length)
        for (const o of l.EntityIds) {
          ...
          r?.Valid ? ControllerHolder_1.ControllerHolder.CreatureController.SetEntityEnable(r, l.Visible, "LevelEventSetClientEntityVisible", !0) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelEvent", 31, "目标Entity不存在", ["PbDataId", o])
