...
class LevelEventSetExploreState extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, a, r) {
    var l;
    e && (l = e.Config.TeleControlType, "TeleControl" === e.Config.Type) && (0 === l ? ModelManager_1.ModelManager.ManipulaterModel.SetManipulateMode(0) : 1 === l && ModelManager_1.ModelManager.ManipulaterModel.SetManipulateMode(1))
  }
}
