...
class LevelEventSetPlayerMoveControl extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteNew(e, t) {
    e && (this.xRe = 1 === (e = e).Forward && 1 === e.Back && 1 === e.Left && 1 === e.Right, ControllerHolder_1.ControllerHolder.InputController.SetMoveControlEnabled(1 === e.Forward, 1 === e.Back, 1 === e.Left, 1 === e.Right))
  }
  OnUpdateGuarantee() {
