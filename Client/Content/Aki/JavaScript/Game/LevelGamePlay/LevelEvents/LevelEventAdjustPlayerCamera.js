      ...
      if (Log_1.Log.CheckInfo() && Log_1.Log.Info("Event", 38, "进入相机调整"), this.ILe(o)) {
        ...
        switch (o.Option.Type) {
          ...
          case IAction_1.EAdjustPlayerCamera.Dialog:
            ...
            ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.AdjustDialogueCamera(o.Option.CenterPos, e, t, l);
            break;
          case IAction_1.EAdjustPlayerCamera.Fixed:
            this.TLe(o, noAimGameplayTag);
            var l = Vector_1.Vector.Create(),
              i = Rotator_1.Rotator.Create();
            l.Set(o.Option.CenterPos.X ?? 0, o.Option.CenterPos.Y ?? 0, o.Option.CenterPos.Z ?? 0), i.Set(o.Option.CenterRot.Y ?? 0, o.Option.CenterRot.Z ?? 0, o.Option.CenterRot.X ?? 0), ControllerHolder_1.ControllerHolder.CameraController.SceneCamera.PlayerComponent.EnterFixSceneSubCamera(l, i, o.Option.Fov, o.Option.FadeInTime, o.Option.FadeOutTime, 1, void 0, o.Option.BlendIn?.Type, o.Option.BlendIn?.BlendExp, o.Option.BlendOut?.Type, o.Option.BlendOut?.BlendExp);
            break;
          case IAction_1.EAdjustPlayerCamera.Basic:
            o.Option.IsSynchronous && (r = !0, EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.AdjustCameraSync, this.N4l)), this.TLe(o), o.Option.SightUi && EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.SetCameraAimVisible, !0, 0, o.Option.SightUi);
            break;
          case IAction_1.EAdjustPlayerCamera.AxisLock:
            l = o.Option.AxisRotate.Y ?? 0, i = o.Option.AxisRotate.Z ?? 0;
            if (this.yLe.DefaultConfig.set(45, l), this.yLe.DefaultConfig.set(46, l), this.yLe.DefaultConfig.set(60, i), this.yLe.DefaultConfig.set(61, i), o.Option.ScreenConfig)
              if (Math.abs(ControllerHolder_1.ControllerHolder.CameraController.CameraRotator.Pitch - l) <= o.Option.ScreenConfig.TriggerAngle && Math.abs(ControllerHolder_1.ControllerHolder.CameraController.CameraRotator.Yaw - i) <= o.Option.ScreenConfig.TriggerAngle) this.TLe(o, noAimGameplayTag);
              else {
                ...
                ControllerHolder_1.ControllerHolder.LevelLoadingController.OpenLoading(0, 3, () => {
                  this.yLe.FadeInTime = IMMEDIATELY_FADE_CAMERA_TIME, this.TLe(o, noAimGameplayTag), ControllerHolder_1.ControllerHolder.LevelLoadingController.CloseLoading(0, void 0, a)
                }, l)
              }
            else this.TLe(o, noAimGameplayTag);
            break;
          case IAction_1.EAdjustPlayerCamera.FirstPerson:
            this.TLe(o, noAimGameplayTag), ControllerHolder_1.ControllerHolder.CameraController.SetFirstPersonEnable(!0)
        }
        r || this.N4l()
