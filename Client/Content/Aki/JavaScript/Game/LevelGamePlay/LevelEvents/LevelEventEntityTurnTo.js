...
class LevelEventEntityTurnTo extends LevelGeneralBase_1.LevelEventBase {
  constructor() {
    super(...arguments), this.pDe = void 0, this.sDe = void 0, this.zpe = (e, t) => {
      this.sDe === t && (Log_1.Log.CheckInfo() && Log_1.Log.Info("LevelEvent", 26, "实体被移除 LevelEventEntityTurnTo保底结束", ["PbDataId", t.PbDataId]), this.ej_())
    }, this.ej_ = () => {
      ...
      if (o) {
        ...
        if (e) {
          ...
          var r = Vector_1.Vector.Create(),
            ...
            r = (e.Subtraction(n.ActorLocationProxy, r), r.ToOrientationRotator(i), i.Pitch = 0, i.Roll = 0, Protocol_1.Aki.Protocol.ecs.create()),
            s = Protocol_1.Aki.Protocol.Zks.create();
          s.F4n = t.CreatureDataId, s.P5n = n.ActorLocationProxy, s.g8n = i, r.iVn = [s], Net_1.Net.Send(27928, r), this.IsAsync ? (o.PerformTurn(2, {
            TargetLocation: e
          }), this.FinishExecute(!0)) : (this.sDe = t, EventSystem_1.EventSystem.AddWithTarget(t, EventDefine_1.EEventName.RemoveEntity, this.zpe), o.PerformTurn(2, {
            TargetLocation: e
          }, void 0, this.ej_))
