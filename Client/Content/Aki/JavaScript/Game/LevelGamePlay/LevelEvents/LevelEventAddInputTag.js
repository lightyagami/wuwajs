...
class LevelEventAddInputTag extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteNew(t, e) {
    if (t) {
      ...
      switch (EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.ForceReleaseInput, this.pLe), n.Type.Type) {
        ...
        case IAction_1.ELimitPlayOperation.AllowMove:
          n.Type.IsOnlyForward && ControllerHolder_1.ControllerHolder.InputController.SetMoveControlEnabled(!0, !1, !1, !1), e = "FightInputRoot.FightInput.AxisInput.MoveInput";
          break;
        case IAction_1.ELimitPlayOperation.AllowMoveNew:
          ControllerHolder_1.ControllerHolder.InputController.SetMoveControlEnabled(n.Type.Forward, n.Type.Back, n.Type.Left, n.Type.Right), e = "FightInputRoot.FightInput.AxisInput.MoveInput", o?.Valid && (o.GetComponent(205)?.AddTag(477750727), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Test", 29, "[LevelEventAddInputTag.ExecuteNew] AddTag 禁止冲刺");
          break;
        ...
        case IAction_1.ELimitPlayOperation.BlockAll:
          ...
          break;
        default:
          return void(Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 24, "没有定义ELimitPlayOperation对应什么InputTag!", ["ELimitPlayOperation", n.Type]))
      }
