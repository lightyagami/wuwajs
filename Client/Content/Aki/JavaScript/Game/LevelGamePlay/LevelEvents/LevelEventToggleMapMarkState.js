...
class LevelEventToggleMapMarkState extends LevelGeneralBase_1.LevelEventBase {
  constructor() {
    super(...arguments), this.tUe = e => {
      "WorldMapView" === e && (this.Finish(), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.CloseView, this.tUe))
    }
  }
  ExecuteNew(e, r) {
    var a = e;
      ...
      case IAction_1.EMapMarkState.Show:
        ...
        if (this.iUe(n.MarkId) && n.IsFocusOnFirstShow) {
          ...
          if (t.IsShow && t.NeedFocus) {
            ...
            if (!t) return Log_1.Log.CheckError() && Log_1.Log.Error("Map", 49, "缺少MapMark表缺少地图配置", ["MarkId", n.MarkId]), void this.Finish();
            n = {
              MarkId: n.MarkId,
              MarkType: t.ObjectType,
              IsNotFocusTween: !0
            };
            if (UiManager_1.UiManager.OpenView("WorldMapView", n, () => {
                ControllerHolder_1.ControllerHolder.LevelLoadingController.CloseLoading(0), this.IsAsync || EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.CloseView, this.tUe)
              }), !this.IsAsync) return
          }
        }
        break;
  ...
  iUe(e) {
    return -1 === ConfigManager_1.ConfigManager.MapConfig.GetConfigMark(e)?.ShowCondition
  }
}
