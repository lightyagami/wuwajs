...
class LevelEventPlayBubble extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, r, o) {
    var a;
    e ? (a = e.EntityId, e = this.BTe(a, e.Flow), ControllerHolder_1.ControllerHolder.DynamicFlowController.AddDynamicFlow(e), 6 === r?.Type && ModelManager_1.ModelManager.GeneralLogicTreeModel.GetBehaviorTree(r.TreeIncId)?.AddDynamicFlowNpc(a), this.FinishExecute(!0)) : this.FinishExecute(!1)
  }
  BTe(e, r) {
