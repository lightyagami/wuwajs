  ...
  ExecuteAction(e, o, t) {
    if (1 === o.Type && o.ClientExecuteActions)
      for (const l of e.EntityIds) {
        var n = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(l)?.Entity?.GetComponent(196);
        n ? n.RemoveServerTagByIdLocal(-662723379, "LevelEventUnlockEntity") : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Plot", 31, "找不对对应的实体", ["pbDataId", l])
