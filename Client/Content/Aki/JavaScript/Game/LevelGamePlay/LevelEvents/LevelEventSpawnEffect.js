    ...
    if (t) {
      ...
      switch (l.Pos2.Type) {
        ...
        case 1:
          ...
          r = o?.Entity?.GetComponent(1)?.ActorLocationProxy, e = l.Pos2.Offset;
          break;
        case 0:
      ...
      t = Vector_1.Vector.Create(0, 0, 0), t = (e && t.Set(e.X, e.Y, e.Z), (r = a ? Vector_1.Vector.Create(a.X ?? 0, a.Y ?? 0, a.Z ?? 0) : r) && t.AdditionEqual(r), Transform_1.Transform.Create(Quat_1.Quat.IdentityProxy, t, Vector_1.Vector.OneVectorProxy));
