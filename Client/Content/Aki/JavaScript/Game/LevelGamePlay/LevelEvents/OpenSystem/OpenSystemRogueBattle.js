...
exports.OpenSystemRogueResMain = exports.OpenSystemRogueBattleShop = exports.OpenSystemRogueBattleAbilitySelect = undefined;
const ControllerHolder_1 = require("../../../Manager/ControllerHolder");
const ModelManager_1 = require("../../../Manager/ModelManager");
const ActivityPermanentRogueController_1 = require("../../../Module/PermanentRogue/ActivityPermanentRogueController");
...
class OpenSystemRogueBattleAbilitySelect extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, t) {
    ...
    return ControllerHolder_1.ControllerHolder.RogueBattleController.OpenBuffSelectViewById(e.BoardId);
  }
  GetViewName(e, t) {
    e = ModelManager_1.ModelManager.RogueBattleModel.GetOptionDataById(e.BoardId);
    return ControllerHolder_1.ControllerHolder.RogueBattleController.GetViewNameByGainType(e.hIc);
  }
}
...
class OpenSystemRogueBattleShop extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, t) {
    return ControllerHolder_1.ControllerHolder.RogueBattleController.OpenBuffSelectViewById(99);
  }
  GetViewName(e, t) {
