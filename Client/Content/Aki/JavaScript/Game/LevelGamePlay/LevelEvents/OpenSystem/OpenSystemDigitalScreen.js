...
class OpenSystemDigitalScreen extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, r) {
    ...
    return !(!e || !e.BoardId) && (t = {
      FadeBeforeHide: e.FadeInScreenWhenClose ?? !1
    }, await DigitalScreenController_1.DigitalScreenController.OpenDigitalScreenById(e.BoardId, t, 9 === r?.Type))
  }
  GetViewName(e) {
    e = ModelManager_1.ModelManager.DigitalScreenModel.GetDataConfig(e.BoardId);
    return 0 !== e?.Prefab && 1 === e?.Prefab ? "DigitalScreenB" : "DigitalScreenA"
  }
}
