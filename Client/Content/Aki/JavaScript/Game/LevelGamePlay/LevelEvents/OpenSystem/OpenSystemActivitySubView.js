...
class OpenSystemActivitySubView extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, i) {
    var t, r;
    return !e || ((t = ActivityViewNameById_1.configActivityViewNameById.GetConfig(e.BoardId)) ? (r = t.Type, !!(r = ActivityManager_1.ActivityManager.GetActivityController(r)) && await r.OpenViewByViewName(t.ViewName)) : (Log_1.Log.CheckError() && Log_1.Log.Error("Activity", 75, "OpenSystemActivitySubView Error", ["id", e.BoardId]), !1))
  }
  GetViewName(e, i) {
