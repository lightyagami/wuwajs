...
class OpenSystemVersionPreheat extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, t) {
    e = e.BoardId;
    return 0 !== e ? ActivityVersionPreheatController_1.ActivityVersionPreheatController.Instance.OpenTargetViewAsyncById(e, !0) : ActivityVersionPreheatController_1.ActivityVersionPreheatController.Instance.OpenTargetViewAsyncById(void 0, !1)
  }
  GetViewName() {
