...
class OpenSystemInstanceEntrance extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, r) {
    ...
    if (!ModelManager_1.ModelManager.GameModeModel.WorldDoneAndLoadingClosed) return !1;
    let n = void 0;
    switch (r.Type) {
      case 5:
        n = r.TriggerEntityId;
  ...
  GetViewName(e) {
    ...
    return 3 === e ? "SingleTimeTowerView" : 4 === e ? "CycleTowerView" : 7 === e ? "BossRushMainView" : 5 === e ? ModelManager_1.ModelManager.TowerModel.GetMaxDifficulty() !== TowerData_1.VARIATION_RISK_DIFFICULTY ? "TowerNormalView" : "TowerVariationView" : 9 !== e && 10 === e ? "ActivityInstanceEntranceView" : "InstanceDungeonEntranceView"
  }
}
