...
class OpenSystemRoguelikeActivity extends OpenSystemBase_1.OpenSystemBase {
  async ExecuteOpenView(e, i) {
    if (100 !== e.BoardId) return RoguelikeController_1.RoguelikeController.OpenRoguelikeActivityView();
    {
      const r = new CustomPromise_1.CustomPromise;
      return 0 === ModelManager_1.ModelManager.WeeklyRogueModel.CycleId ? !1 : (UiManager_1.UiManager.OpenView("WeeklyRogueActivityView", void 0, e => {
        r.SetResult(e)
      }), r.Promise)
    }
  }
  GetViewName(e) {
    return 100 === e.BoardId ? "WeeklyRogueActivityView" : "RoguelikeActivityView"
  }
}
