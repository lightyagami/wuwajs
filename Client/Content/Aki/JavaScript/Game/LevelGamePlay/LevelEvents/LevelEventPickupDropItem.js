...
class LevelEventPickupDropItem extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteNew(e, t) {
    e && (e = e.EntityId, (e = EntitySystem_1.EntitySystem.Get(e))?.Valid) && (e = e.GetComponent(0), ControllerHolder_1.ControllerHolder.RewardController.PickUpFightDrop(e.GetCreatureDataId(), e.GetPbDataId(), this.BJs)) || this.FinishExecute(!1)
  }
}
