...
class LevelEventRefreshInputTag extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, t) {
    ControllerHolder_1.ControllerHolder.InputController.SetMoveControlEnabled(!0, !0, !0, !0), LevelEventLockInputState_1.LevelEventLockInputState.Unlock(), ControllerHolder_1.ControllerHolder.InputDistributeController.RefreshInputTag();
    var r = Global_1.Global.BaseCharacter?.CharacterActorComponent?.Entity,
      n = 477750727;
    r?.Valid && (r = r.GetComponent(205))?.HasTag(n) && (r.RemoveTag(n), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("Test", 29, "[LevelEventRefreshInputTag.ExecuteNew] RemoveTag 禁止冲刺")
  }
  OnUpdateGuarantee() {
