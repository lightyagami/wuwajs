...
class LevelEventDeliverQuestBehavior extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(r, e) {
    if (r) {
      ...
      let e = "";
      l && (e = l.Entity.GetComponent(117)?.PawnName ?? ""), ControllerHolder_1.ControllerHolder.ItemDeliverController.OpenItemDeliverViewByHandInItem(r.Items, e, void 0, r.DescText)
    }
  }
}
