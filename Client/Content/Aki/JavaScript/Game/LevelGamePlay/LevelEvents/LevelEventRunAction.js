...
class LevelEventRunAction extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, t) {
    e ? (ControllerHolder_1.ControllerHolder.LevelGeneralController.ExecuteActionsNew(e.ActionList, LevelGeneralContextDefine_1.GeneralContext.Copy(t), this.IsAsync ? () => {} : e => {
