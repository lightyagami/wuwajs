...
class LevelEventUsePhantomSkill extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, l) {
    if (e && ModelManager_1.ModelManager.SceneTeamModel.IsPhantomTeam) {
      ...
      if (void 0 !== e.BlackboardPos && ControllerHolder_1.ControllerHolder.BlackboardController.SetVectorValueByEntity(r.Entity.Id, e.BlackboardPos.Key, e.BlackboardPos.Value.X ?? 0, e.BlackboardPos.Value.Y ?? 0, e.BlackboardPos.Value.Z ?? 0), void 0 !== e.BlackboardRot) {
      ...
      r.Entity.GetComponent(205).AddTag(GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e.SkillType))
    }
  }
}
