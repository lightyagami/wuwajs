...
class LevelEventMoveJigsawItem extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteWhenEntitiesReady() {
    ...
    var s = e.Entity.GetComponent(214);
    if (s) {
      if (e && t) {
        var n = e.Entity.GetComponent(149);
        var i = t.Entity.GetComponent(148);
        if (n && i) {
          var o = n.PutDownBase;
          if (o) {
            const a = o.Entity.GetComponent(172);
