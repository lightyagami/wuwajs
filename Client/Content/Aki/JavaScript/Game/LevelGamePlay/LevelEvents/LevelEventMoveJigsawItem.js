...
class LevelEventMoveJigsawItem extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteNew(e, t) {
    e ? (this.Lo = e.Config, (e = []).push(this.Lo.ItemEntityId), e.push(this.Lo.FoundationEntityId), this.CreateWaitEntityTask(e)) : this.FinishExecute(!1)
  }
  ExecuteWhenEntitiesReady() {
    var e = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(this.Lo.ItemEntityId),
      t = ModelManager_1.ModelManager.CreatureModel.GetEntityByPbDataId(this.Lo.FoundationEntityId),
      s = e.Entity.GetComponent(202);
    if (s)
      if (e && t) {
        ...
        if (n && i) {
          ...
          if (o) {
            const a = o.Entity.GetComponent(161),
              r = a?.Config.Config.Type ?? IComponent_1.EItemFoundation.BuildingBlock;
          ...
          const a = t.Entity.GetComponent(161),
            r = a?.Config.Config.Type ?? IComponent_1.EItemFoundation.BuildingBlock;
          i.PutDownItem(n, o, r);
          t = i.GetBlockLocationByIndex(o), s = (s.SetActorLocation(t.ToUeVector(), "LevelEventMoveJigsawItem"), e.Entity.GetComponent(158));
          s && s.CollectSampleAndSend(!0), i.RequestMoveItem(n, o), i.CheckFinish(), this.FinishExecute(!0)
