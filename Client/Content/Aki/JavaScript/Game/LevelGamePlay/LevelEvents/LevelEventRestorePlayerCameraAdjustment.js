...
class LevelEventRestorePlayerCameraAdjustment extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, r) {
    ...
    var t, o, n = Global_1.Global.BaseCharacter;
    n && e?.ResetFocus && (t = e.ResetFocus.FadeInTime, o = ConfigCurveUtils_1.ConfigCurveUtils.CreateCurveByBaseCurve(e.ResetFocus.FadeInCurve), n.GetEntityNoBlueprint().GetComponent(32).ResetPitch(t, o)), Log_1.Log.CheckInfo() && Log_1.Log.Info("Event", 38, "离开相机调整"), ControllerHolder_1.ControllerHolder.CameraController.FightCamera.LogicComponent.RestoreCameraFromAdjust(e?.ResetFocus?.FadeInTime)
  }
  OnUpdateGuarantee() {
