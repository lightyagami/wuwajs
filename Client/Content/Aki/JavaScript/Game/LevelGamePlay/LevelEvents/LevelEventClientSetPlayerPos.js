...
class LevelEventClientSetPlayerPos extends LevelGeneralBase_1.LevelEventBase {
  ...
  upl(t, r, e) {
    ...
    return LevelGeneralNetworks_1.LevelGeneralNetworks.RequestClientTeleportByClientTrigger(o, l, t, r, this.ActionIndex, 1 === e.TriggerType, e => {
      e && e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs || Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 50, "客户端传送请求失败", ["TriggerId", l], ["ActionId", this.ActionIndex], ["Location", t], ["Rotation", r])
    }), !0
  }
}
