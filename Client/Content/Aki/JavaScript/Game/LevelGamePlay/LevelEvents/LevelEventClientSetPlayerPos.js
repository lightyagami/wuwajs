  ...
  constructor() {
    ...
    this.cpl = () => {
      ...
      if (Global_1.Global.BaseCharacter?.IsValid() && this.hpl) {
        Global_1.Global.BaseCharacter.CharacterActorComponent?.Entity.GetComponent(70)?.SetEnableMovementSync(true);
        this.hpl = false;
      }
    };
  }
