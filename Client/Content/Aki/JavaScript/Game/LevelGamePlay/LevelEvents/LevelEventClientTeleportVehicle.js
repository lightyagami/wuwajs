...
class LevelEventClientTeleportVehicle extends LevelGeneralBase_1.LevelEventBase {
  constructor() {
    ...
    this._pl = () => {
      ...
      var r;
      var l;
      if (this.OPt && Global_1.Global.BaseCharacter?.IsValid() && (e = Global_1.Global.BaseCharacter.CharacterActorComponent) && (e = e.Entity.CheckGetComponent(242).VehicleEntity) && (l = (t = e.GetComponent(250)).Entity.GetComponent(72), (this.Sxf = l) && (l.CollectSampleAndSend(true), o = l.GetEnableMovementSync(), this.hpl = o) && l.SetEnableMovementSync(false), o = this.OPt.Pos, l = this.OPt.Rot, o = Vector_1.Vector.Create(o.X ?? 0, o.Y ?? 0, o.Z ?? 0), r = Rotator_1.Rotator.Create(), l ? (r.Pitch = l.X ?? 0, r.Yaw = l.Y ?? 0, r.Roll = l.Z ?? 0) : (l = t.ActorRotationProxy, r.Pitch = l?.Pitch ?? 0, r.Yaw = l?.Yaw ?? 0, r.Roll = l?.Roll ?? 0), this.STg(e.GetComponent(0).GetCreatureDataId(), o, r))) {
    ...
    this.cpl = () => {
      ...
      if (Global_1.Global.BaseCharacter?.IsValid() && this.hpl) {
        this.Sxf?.SetEnableMovementSync(true);
        this.hpl = false;
      }
    };
  }
