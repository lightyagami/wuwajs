...
class LevelEventChangeToVision extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, l) {
    var s;
    if (e && ((s = Global_1.Global.BaseCharacter.CharacterActorComponent.Entity).GetComponent(3).ClearInput(), s.GetComponent(205)?.AddTag(-1697149502), s = s.GetComponent(40))) {
