...
class LevelEventSwitchLevels extends LevelGeneralBase_1.LevelEventBase {
  ...
  KRe(e) {
    ...
    if (e.TeleportEntityId) {
      ...
      if (!o) return void(Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 3, "[ControllerHolder.CreatureController.SceneSubLevelsChangedNotify] 要传送的TeleportEntityId不存在。", ["TeleportEntityId", e.TeleportEntityId]));
      var l = o.Transform.Pos,
        l = (l && (r = Vector_1.Vector.Create(l.X ?? 0, l.Y ?? 0, l.Z ?? 0)), o.Transform.Rot);
