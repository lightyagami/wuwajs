...
class LevelEventToggleScanSplineEffect extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, o) {
    if (e) {
      6 === o.Type && o.BtType === Protocol_1.Aki.Protocol.hps.Proto_BtTypeQuest || Log_1.Log.CheckError() && Log_1.Log.Error("Event", 31, "该事件仅用于任务行为树内配置");
      var r = o,
        l = e;
      switch (l.Type) {
    ...
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Event", 31, "参数配置错误")
  }
}
