...
class LevelEventFocusOnMapMark extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, r, o) {
    var a = e;
    if (a) switch (a.MapMarkType.Type) {
      ...
      case IAction_1.EMapMarkType.Quest:
        ...
        break;
      default:
        Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 63, "[LevelEventFocusOnMapMark]未定义类型", ["MapMarkType", a.MapMarkType.Type]), this.Finish()
    } else this.Finish()
  }
  vu_(e) {
    var e = e.MarkId,
      r = ConfigManager_1.ConfigManager.MapConfig.SearchMarkConfig(e);
    void 0 === r ? Log_1.Log.CheckError() && Log_1.Log.Error("LevelEvent", 63, "[LevelEventFocusOnMapMark]HandleCustomMapFocus->找不到对应的标记配置", ["markId", e]) : (e = {
      MarkId: e,
      MarkType: r.ObjectType
    }, ControllerHolder_1.ControllerHolder.WorldMapController.OpenView(2, !1, e)), this.Finish()
  }
  yu_(e) {
    const r = e.QuestId;
    var e = ModelManager_1.ModelManager.MapModel.GetMarkByQuestId(r);
    void 0 === e ? WorldMapController_1.WorldMapController.StartListenChildQuestNodeStatusChangedAndOpenWorldMap(r) : (e = {
      MarkId: e.MarkId,
      MarkType: e.MarkType
