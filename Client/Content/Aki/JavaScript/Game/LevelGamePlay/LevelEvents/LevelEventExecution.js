...
class LevelEventExecution extends LevelGeneralBase_1.LevelEventBase {
  ...
  ExecuteNew(e, t) {
    1 === t.Type && EntitySystem_1.EntitySystem.Get(t.EntityId)?.Valid ? (this.E0 = t.EntityId, this.MDe(), this.FinishExecute(!0)) : this.FinishExecute(!1)
  }
  MDe() {
    var e = EntitySystem_1.EntitySystem.Get(this.E0);
    e && ((e = e.GetComponent(88)) ? e.StartExecution() : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Can not find ExecutionComponent"))
  }
  OnReset() {
    this.E0 = 0
  }
