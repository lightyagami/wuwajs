...
class LevelEventSetupSeqCamera extends LevelGeneralBase_1.LevelEventBase {
  ExecuteNew(e, r) {
    var l, a;
    e && 1 === ModelManager_1.ModelManager.CameraModel.CameraMode && (e = e, a = (l = ControllerHolder_1.ControllerHolder.CameraController.SequenceCamera.GetComponent(9).CineCamera).CameraComponent, ObjectUtils_1.ObjectUtils.IsValid(l)) && (l.D_K2_SetActorTransform(e.Transform.ToUeTransform(), !1, void 0, !1), e.Aperture && (a.CurrentAperture = e.Aperture), e.FocalLength && (a.CurrentFocalLength = e.FocalLength), e.FocusDistance) && (a.FocusSettings.ManualFocusDistance = e.FocusDistance)
  }
}
