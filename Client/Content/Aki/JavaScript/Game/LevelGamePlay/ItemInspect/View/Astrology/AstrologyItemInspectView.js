...
class AstrologyItemInspectView extends ItemInspectViewBase_1.ItemInspectViewBase {
  constructor() {
    ...
    this.Myd = () => {
      ...
      if (ModelManager_1.ModelManager.ItemInspectModel.CloseSkipConfirmBox) {
        ...
        t.ToggleText = this.yyd;
        t.SetToggleFunction(this.Eyd);
        t.FunctionMap.set(2, () => {
          ModelManager_1.ModelManager.ItemInspectModel.CloseSkipConfirmBox = this.Syd;
          this.Ezu();
        });
  ...
  OnRegisterComponent() {
    ...
    this.BtnBindInfo = [[12, this.Ezu], [14, this.Izu], [18, this.jtu], [19, this.Myd]];
  }
  async OnBeforeStartAsync() {
    ...
    for (const a of t) {
      ...
      o.Init(this.Mod, this.xzu, this.Iod);
      this._zu.push(o);
  ...
  OnStart() {
    ...
    this.yyd = ConfigManager_1.ConfigManager.TextConfig?.GetTextById("PlotSkipConfirmToggle") ?? "";
    ...
    if (this.czu) {
      ...
      if (i) {
        ...
        for (const d of ModelManager_1.ModelManager.ItemInspectModel.VisiblePoints) {
          if (!d.IsChecked) {
            e = d.Location;
            if (UE.GameplayStatics.D_ProjectWorldToScreen(i, e.ToUeVector(), this.gzu) && (s = (e = (0, puerts_1.$unref)(this.gzu)).X, e = e.Y, h = this.wzu(n, m, s, e), !this.yod.has(h)) && (r = d.TagId, o = this.Tod(r))) {
              (_ = this.Czu).Set(s * U, e * g);
              _.AdditionEqual(this.ZWc).MultiplyEqual(this.A$e);
              this.bod(o, h, _, r, d.IsChecked);
              this.yod.add(h);
              this.vod.add(r);
            }
          }
        ...
        for (let t = 0; t < this._zu.length; t++) {
          if (!this.yod.has(t)) {
            ...
            this.pod[t].SetLineActive(false);
          }
          var v = this.uzu[t];
          var E = v.GetPointTagId();
          if (E !== undefined && !this.vod.has(E)) {
    ...
    if (!(this.X7c > TimeUtil_1.TimeUtil.GetServerTimeStamp())) {
      if (t = this.pzu.pop()) {
        ...
        if (this.z7c) {
          ...
          this.B3d?.Remove();
          this.B3d = TimerSystem_1.TimerSystem.Delay(() => {
