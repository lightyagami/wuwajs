...
class FollowShooterHackController extends ControllerBase_1.ControllerBase {
  static AddRelationship(e, o) {
    var r;
    this.TW_.has(e) || this.TW_.set(e, new Set), this.TW_.get(e).has(o) || (r = ModelManager_1.ModelManager.CreatureModel.GetEntity(o)) && r.Entity?.Valid && (r = r.Entity.GetComponent(209)) && (r = r.AddGameplayCue([GAMEPLAY_CUE_ID], -1, "AddHackEffect"), this.bW_.set(o, r), this.TW_.get(e).add(o))
  }
...
}(exports.FollowShooterHackController = FollowShooterHackController).TW_ = new Map, FollowShooterHackController.bW_ = new Map;
