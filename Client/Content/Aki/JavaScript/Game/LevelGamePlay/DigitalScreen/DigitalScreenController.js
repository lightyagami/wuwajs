...
class DigitalScreenController extends UiControllerBase_1.UiControllerBase {
  static async OpenDigitalScreenById(e, r, a = !1) {
    ...
    if (!ModelManager_1.ModelManager.DigitalScreenModel.InitDigitalScreen(e)) return !1;
    let o = "DigitalScreenA";
    if (0 === i?.Prefab ? o = "DigitalScreenA" : 1 === i?.Prefab && (o = "DigitalScreenB"), UiManager_1.UiManager.IsViewOpen(o)) return !0;
    let t = void 0;
    if (a) {
