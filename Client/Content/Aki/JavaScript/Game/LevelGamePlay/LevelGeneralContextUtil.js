    ...
    if (t) {
      ...
      switch (t.fvs) {
        ...
        case Protocol_1.Aki.Protocol.TOs.Svs:
          e = LevelGeneralContextUtil.$Cd(t.fvs, t.Svs.eps, t.Svs.s0d);
          break;
        ...
        case Protocol_1.Aki.Protocol.TOs.Avs:
          e = LevelGeneralContextDefine_1.LevelPlayContext.Create(t.Avs._ps, t.fvs);
          break;
        case Protocol_1.Aki.Protocol.TOs.Pvs:
          e = LevelGeneralContextDefine_1.LevelPlayContext.Create(t.Pvs._ps, t.fvs);
          break;
