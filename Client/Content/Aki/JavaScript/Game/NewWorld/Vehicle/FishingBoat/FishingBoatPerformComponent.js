...
var __decorate = this && this.__decorate || function(t, e, r, i) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, r, i);
    ...
    for (var h = t.length - 1; 0 <= h; h--)(o = t[h]) && (s = (n < 3 ? o(s) : 3 < n ? o(e, r, s) : o(e, r)) || s);
...
let FishingBoatPerformComponent = class FishingBoatPerformComponent extends GongduolaPerformComponent_1.GongduolaPerformComponent {
  constructor() {
    super(...arguments), this.osn = void 0, this.fh_ = Vector_1.Vector.Create(), this.Vc_ = () => {
      this.IsSprint || this.Config.SetBaseStateMoveConfig(this.ActorComp.Actor.VehicleMovementComponent)
    }
  }
  OnInit() {
  ...
  OnStart() {
    return !!super.OnStart() && (this.osn = this.Entity.GetComponent(172), this.osn && this.osn.AddListener(CharacterAttributeTypes_1.EAttributeId.vVn, this.Vc_, "FishingBoatPerformComponent"), !0)
  }
  OnActivate() {
    super.OnActivate();
  ...
  OnEnd() {
    return this.osn && this.osn.RemoveListener(CharacterAttributeTypes_1.EAttributeId.vVn, this.Vc_), super.OnEnd()
  }
  InitVehicleConfig() {
  ...
  OnBulletHit(t, e) {
    this.ActorComp && ((e = e.AttackerActorComp)?.Valid && (this.ActorComp.ActorLocationProxy.Subtraction(e.ActorLocationProxy, this.fh_), this.fh_.Normalize()) || this.ActorComp.ActorForwardProxy.Multiply(-1, this.fh_), this.CollisionStrength = 1, this.fh_.GetSafeNormal2D(this.fh_), e = Math.acos(this.fh_.CosineAngle2D(this.ActorComp.ActorForwardProxy)) * MathUtils_1.MathUtils.RadToDeg, this.CollisionDirection = e * Math.sign(this.fh_.DotProduct(this.ActorComp.ActorRightProxy)), this.BeginCollisionPerform())
  }
...
FishingBoatPerformComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(274)], FishingBoatPerformComponent), exports.FishingBoatPerformComponent = FishingBoatPerformComponent;
