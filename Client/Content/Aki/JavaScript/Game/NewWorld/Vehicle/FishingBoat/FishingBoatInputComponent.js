...
var __decorate = this && this.__decorate || function(e, o, t, n) {
  var r, i = arguments.length,
    l = i < 3 ? o : null === n ? n = Object.getOwnPropertyDescriptor(o, t) : n;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) l = Reflect.decorate(e, o, t, n);
  else
    for (var p = e.length - 1; 0 <= p; p--)(r = e[p]) && (l = (i < 3 ? r(l) : 3 < i ? r(o, t, l) : r(o, t)) || l);
...
let FishingBoatInputComponent = class FishingBoatInputComponent extends GongduolaInputComponent_1.GongduolaInputComponent {
  ...
  WZo(e) {
    210012 === e ? PhotographController_1.PhotographController.PhotographFastScreenShot() : this.Entity.GetComponent(39).BeginSkill(e, {
  ...
  ExecuteSkillWithConfirmBox(e, o, t) {
    ...
    0 < t && o.ItemIdMap.set(t, 1), o.FunctionMap.set(2, () => {
      this.WZo(e)
    }), ControllerHolder_1.ControllerHolder.ConfirmBoxController.ShowConfirmBoxNew(o)
  }
};
FishingBoatInputComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(247)], FishingBoatInputComponent), exports.FishingBoatInputComponent = FishingBoatInputComponent;
