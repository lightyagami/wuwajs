...
class TsBaseVehicle extends UE.KuroBaseVehicle {
  constructor() {
    super(...arguments), this.EntityId = 0, this.VehicleActorComponent = void 0, this.CharRenderingComponent = void 0, this.RenderType = 7, this.InputComponentClass = void 0, this.PlatformActor = void 0, this.DitherEffectControllerInternal = void 0
  }
  Constructor() {
    this.VehicleActorComponent = void 0, this.DitherEffectControllerInternal = void 0
  }
  SetEntityId(t) {
    this.EntityId = t, this.EntityIdInternal = t
  }
  GetEntityId() {
    return this.VehicleActorComponent ? this.VehicleActorComponent.Entity.Id : 0
  }
  ...
  ReceiveDestroyed() {
    ObjectUtils_1.ObjectUtils.IsValid(this) && (this.InputComponentClass = void 0, this.VehicleActorComponent = void 0, this.CharRenderingComponent = void 0, this.DitherEffectControllerInternal = void 0, super.ReceiveDestroyed())
  }
