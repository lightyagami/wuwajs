...
var __decorate = this && this.__decorate || function(e, t, o, i) {
  var n, r = arguments.length,
    l = r < 3 ? t : null === i ? i = Object.getOwnPropertyDescriptor(t, o) : i;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) l = Reflect.decorate(e, t, o, i);
  else
    for (var s = e.length - 1; 0 <= s; s--)(n = e[s]) && (l = (r < 3 ? n(l) : 3 < r ? n(t, o, l) : n(t, o)) || l);
...
let VehicleSkillComponent = class VehicleSkillComponent extends BaseSkillComponent_1.BaseSkillComponent {
  ...
  OnInit() {
    return !!super.OnInit() && (this.oRe = this.Entity.GetComponent(235), this.Gce = this.Entity.GetComponent(236), !0)
  }
  GetMainAnimInstance() {
    return this.oRe.MainAnimInstance
  }
  DoSkillBeginMoveAction(e, t) {
    this.TagComp?.HasTag(1616400338) && this.Gce?.SetForceSpeed(Vector_1.Vector.ZeroVector)
  }
};
VehicleSkillComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(41)], VehicleSkillComponent), exports.VehicleSkillComponent = VehicleSkillComponent;
