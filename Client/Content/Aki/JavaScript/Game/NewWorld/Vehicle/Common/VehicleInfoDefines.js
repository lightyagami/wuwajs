...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.VehiclePassengerInfo = exports.VehicleRideSharingInfo = exports.ScenePlayerVehicleInfo = exports.EntityVehicleInfo = exports.VehicleInfoDefines = exports.INVALID_SEAT = void 0;
const UE = require("ue"),
...
class EntityVehicleInfo {
  constructor() {
    this.EntityCreatureId = 0, this.VehicleCreatureId = 0, this.Seat = -1, this.ExitType = 0
  }
  DeepCopy() {
    var e = new EntityVehicleInfo;
    return e.EntityCreatureId = this.EntityCreatureId, e.VehicleCreatureId = this.VehicleCreatureId, e.Seat = this.Seat, e
  }
  Equals(e) {
...
class ScenePlayerVehicleInfo extends(exports.EntityVehicleInfo = EntityVehicleInfo) {
  ...
  DeepCopy() {
    ...
    return e.PlayerId = this.PlayerId, e.EntityCreatureId = this.EntityCreatureId, e.VehicleCreatureId = this.VehicleCreatureId, e.Seat = this.Seat, e
  }
  Equals(e) {
...
class VehicleRideSharingInfo {
  constructor(e) {
    this.PlayerId = 0, this.RoleId = 0, this.RoleCreatureId = 0, this.Seat = -1, this.PlayerId = e.W5n, this.RoleId = e.Q6n, this.RoleCreatureId = MathUtils_1.MathUtils.LongToNumber(e.F4n), this.Seat = e.fhl
  }
}
exports.VehicleRideSharingInfo = VehicleRideSharingInfo;
class VehiclePassengerInfo {
  constructor() {
    this.VehicleEntity = void 0, this.PassengerEntity = void 0, this.VehicleType = "Gongduola", this.IsDriver = !1, this.Seat = -1, this.ExitType = 0
  }
  IsRolePassenger(e = !1) {
