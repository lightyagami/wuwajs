...
var __decorate = this && this.__decorate || function(e, t, i, r) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, i, r);
    ...
    for (var h = e.length - 1; 0 <= h; h--)(o = e[h]) && (s = (n < 3 ? o(s) : 3 < n ? o(t, i, s) : o(t, i)) || s);
...
let BaseVehiclePerformComponent = class BaseVehiclePerformComponent extends EntityComponent_1.EntityComponent {
  ...
  OnInitData(e) {
    ...
    if (t?.ComponentsData) {
      ...
      if (!i?.Category.VehicleType) return Log_1.Log.CheckError() && Log_1.Log.Error("Vehicle", 50, "无法获取载具类型", ["PbDataId", this.CreatureData.GetPbDataId()], ["CreatureId", this.CreatureData.GetCreatureDataId()]), !1;
      this.VehicleType = i.Category.VehicleType;
      i = (0, IComponent_1.getComponent)(t.ComponentsData, "VehicleComponent");
      i && (this.MaxSeatCount = i.SeatCount, this.DriverSeat = i.DriverSeat !== VehicleInfoDefines_1.INVALID_SEAT ? i.DriverSeat : -1)
    }
    return !0
  }
  OnStart() {
    return this.EntityHandle = ModelManager_1.ModelManager.CreatureModel.GetEntityById(this.Entity.Id), EventSystem_1.EventSystem.AddWithTarget(this.EntityHandle, EventDefine_1.EEventName.RemoveEntity, this.OnRemoveEntity), !0
  }
  OnActivate() {
  ...
  OnAfterTick(e) {
    for (const t of this.PassengerInfoMap.values())(t.PassengerEntity?.GetComponent(1))?.ResetAllCachedTime()
  }
  InitVehicleConfig() {
  ...
  LoadVehicleConfigAsset() {
    ...
    if (e?.ComponentsData) {
      ...
      if (e && "" !== e.Config && "None" !== e.Config) return this.LoadVehicleConfig(e.Config);
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Vehicle", 50, "载具初始化没有VehicleComp组件或没有配置载具DA", ["PbDataId", this.CreatureData?.GetPbDataId()], ["CreatureId", this.CreatureData?.GetCreatureDataId()])
    } else Log_1.Log.CheckError() && Log_1.Log.Error("Vehicle", 50, "载具初始化失败，没有组件信息", ["PbDataId", this.CreatureData?.GetPbDataId()], ["CreatureId", this.CreatureData?.GetCreatureDataId()])
  }
  LoadVehicleConfig(e) {
    var t = ResourceSystem_1.ResourceSystem.Load(e, UE.BP_VehicleConfig_C);
    if (t?.IsValid()) return t;
    Log_1.Log.CheckError() && Log_1.Log.Error("Vehicle", 50, "载具初始化失败，无法读取有效的载具DA配置", ["PbDataId", this.CreatureData?.GetPbDataId()], ["CreatureId", this.CreatureData?.GetCreatureDataId()], ["Path", e])
  }
  InitVehicleFeatures() {
    var e = this.CreatureData?.GetPbEntityInitData();
    if (e) {
  ...
  TryEnter(e, t) {
    var i, r, o;
    return !!this.EnterConditionCheck(e, t) && ((r = e.GetComponent(1))?.CreatureData?.IsRole() ? (i = this.Entity.GetComponent(0), r = ModelManager_1.ModelManager.GameModeModel.IsMulti ? ModelManager_1.ModelManager.OnlineModel.OwnerId : r.CreatureData.GetPlayerId(), (o = Protocol_1.Aki.Protocol.GC_.create()).F4n = MathUtils_1.MathUtils.NumberToLong(i.GetCreatureDataId()), o.ORs = r, o.phl = !0, o.fhl = t, Net_1.Net.Call(22092, o, () => {})) : this.Enter(e, t), !0)
  }
  Enter(e, t) {
    var i = this.DriverSeat === t,
      r = new VehicleInfoDefines_1.VehiclePassengerInfo,
      o = (r.VehicleEntity = this.Entity, r.PassengerEntity = e, r.VehicleType = this.VehicleType, r.IsDriver = i, r.Seat = t, e.GetComponent(0).GetPlayerId()),
      n = this.Entity.GetComponent(1),
      s = this.CreatureData.GetPbDataId(),
      n = (i && (n?.SetAutonomous(o === ModelManager_1.ModelManager.CreatureModel.GetPlayerId()), Log_1.Log.CheckInfo()) && Log_1.Log.Info("Vehicle", 50, "[BaseVehicleComp] 进入载具设置移动主控", ["v", o === ModelManager_1.ModelManager.CreatureModel.GetPlayerId()]), this.SeatInfoMap.get(t));
    if (n) {
      if (n.PassengerEntity === e) return;
      o = n.PassengerEntity.GetComponent(0);
      Log_1.Log.CheckError() && Log_1.Log.Error("Vehicle", 50, "[BaseVehicleComp] 进入载具时目标位置已有实体", ["Vehicle", s], ["OldPassenger", o?.GetPbDataId()], ["NewPassenger", e.GetComponent(0)?.GetPbDataId()], ["Seat", t]), this.Leave(n.PassengerEntity)
    }
    this.PassengerInfoMap.set(e.Id, r), this.SeatInfoMap.set(t, r), i && this.Drivers.add(e), Log_1.Log.CheckInfo() && Log_1.Log.Info("Vehicle", 50, "[BaseVehicleComp] 进入载具", ["V_PbDataId", s], ["V_CreatureId", this.CreatureData.GetCreatureDataId()], ["P_PbDataId", e.GetComponent(0)?.GetPbDataId()], ["P_PlayerId", e.GetComponent(0)?.GetPlayerId()], ["Seat", t], ["isDriver", i]), this.EnterVehiclePerform(r), EventSystem_1.EventSystem.EmitWithTarget(e, EventDefine_1.EEventName.OnEnterVehicle, r), EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.OnVehicleBeenEntered, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnEnterVehicle, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVehicleBeenEntered, r)
  }
  TryLeave(e, t = 0) {
    var i, r, o, n, s;
    return !!this.LeaveConditionCheck(e) && ((o = e.GetComponent(1))?.CreatureData?.IsRole() ? (i = this.Entity.GetComponent(0), r = this.PassengerInfoMap.get(e.Id), o = ModelManager_1.ModelManager.GameModeModel.IsMulti ? ModelManager_1.ModelManager.OnlineModel.OwnerId : o.CreatureData.GetPlayerId(), n = ControllerHolder_1.ControllerHolder.VehicleController.ToServerExitVehicleType(t), (s = Protocol_1.Aki.Protocol.GC_.create()).F4n = MathUtils_1.MathUtils.NumberToLong(i.GetCreatureDataId()), s.ORs = o, s.phl = !1, s.fhl = r.Seat, s.bI_ = n, Net_1.Net.Call(22092, s, () => {})) : this.Leave(e, t), !0)
  }
  Leave(e, t = 0) {
    var i = this.Entity.GetComponent(1)?.CreatureData.GetPbDataId(),
      r = this.PassengerInfoMap.get(e.Id);
    r ? (r.ExitType = t, 3 !== r.ExitType && (Log_1.Log.CheckInfo() && Log_1.Log.Info("Vehicle", 50, "[BaseVehicleComp] 退出载具", ["V_PbDataId", i], ["V_CreatureId", this.CreatureData.GetCreatureDataId()], ["P_PbDataId", e.GetComponent(0)?.GetPbDataId()], ["P_PlayerId", e.GetComponent(0)?.GetPlayerId()], ["Seat", r.Seat], ["isDriver", r.IsDriver], ["ExitType", r.ExitType]), this.LeaveVehiclePerform(r), EventSystem_1.EventSystem.EmitWithTarget(e, EventDefine_1.EEventName.OnLeaveVehicle, r), EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.OnVehicleBeenLeaved, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnLeaveVehicle, r), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnVehicleBeenLeaved, r), this.PassengerInfoMap.delete(e.Id), this.SeatInfoMap.delete(r.Seat), this.Drivers.delete(e))) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Vehicle", 50, "[BaseVehicleComp] 重复退出载具", ["V_PbDataId", i], ["P_PbDataId", e.GetComponent(0)?.GetPbDataId()], ["P_PlayerId", e.GetComponent(0)?.GetPlayerId()], ["Type", t])
  }
  ResetVehicleConfig(e = !1) {
    this.Config = this.ConfigInternal?.DeepCopy(), e && this.RefreshMoveConfigFromVehicleConfig()
  }
  ...
  IsVehicleInUse(e) {
    return e === VehicleInfoDefines_1.INVALID_SEAT ? !!this.PassengerInfoMap.size : this.SeatInfoMap.has(e)
  }
  GetVehicleVelocity(e) {}
};
BaseVehiclePerformComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(233)], BaseVehiclePerformComponent), exports.BaseVehiclePerformComponent = BaseVehiclePerformComponent;
