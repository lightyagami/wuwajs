...
var __decorate = this && this.__decorate || function(e, t, i, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, t, i, o);
    ...
    for (var l = e.length - 1; 0 <= l; l--)(n = e[l]) && (r = (s < 3 ? n(r) : 3 < s ? n(t, i, r) : n(t, i)) || r);
...
let VehicleSplineMoveComponent = class VehicleSplineMoveComponent extends BaseSplineMoveComponent_1.BaseSplineMoveComponent {
  constructor() {
    super(...arguments), this.CharActorComp = void 0, this.PerformComp = void 0, this.ExtraMoveParams = void 0, this.OnVehicleBeenLeaved = e => {
      e.IsRolePassenger(!0) && this.ForceStopSplineMove()
    }
  }
  OnStart() {
    return super.OnStart(), (0, RegisterComponent_1.isComponentInstance)(this.ActorComp, 234) && (this.CharActorComp = this.ActorComp), this.PerformComp = this.Entity.GetComponent(237), !0
  }
  OnTick(e) {
    var t = this.CurrentSplineMoveParams;
    t ? !this.SplineMoveParamsMap.has(t.Id) && t.EarliestLeaveTime <= Time_1.Time.NowSeconds && !this.SelectNextSplineMove() || (this.UpdateSplineLocationAndDirection(), this.UpdateLastSplineLocationAndDirection(), t = e * MathUtils_1.MathUtils.MillisecondToSecond, this.PositionAdjust(this.SplineTimeKey, t), this.InputAdjust(), this.LastLocation.DeepCopy(this.TargetLocation)) : (Log_1.Log.CheckError() && Log_1.Log.Error("Movement", 6, "Tick in No SplineMove!"), this.DisableKey = this.Disable("[SplineMoveComponent.OnTick] this.CurrentSplineMoveParams为false"))
  }
  OnEnd() {
  ...
  InputAdjust() {
    ...
    "SlideTrack" === this.CurrentSplineMoveType && this.InputAdjustSlideTrack(e)
  }
  ...
  OnSplineMoveEnable(e, t) {
    this.ApplySplineMoveDaConfig(), ControllerHolder_1.ControllerHolder.VehicleController.SetRideSharingEnable(!1), EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.OnVehicleBeenLeaved, this.OnVehicleBeenLeaved)
  }
  OnSplineMoveDisable() {
    this.ResetSplineMoveDaConfig(), ControllerHolder_1.ControllerHolder.VehicleController.SetRideSharingEnable(!0), EventSystem_1.EventSystem.HasWithTarget(this.Entity, EventDefine_1.EEventName.OnVehicleBeenLeaved, this.OnVehicleBeenLeaved) && EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.OnVehicleBeenLeaved, this.OnVehicleBeenLeaved)
  }
  OnSelectNextSplineMoveEnd() {
    this.CharActorComp?.ClearInput(), this.LastLocation.DeepCopy(this.ActorComp.ActorLocationProxy)
  }
};
VehicleSplineMoveComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(109)], VehicleSplineMoveComponent), exports.VehicleSplineMoveComponent = VehicleSplineMoveComponent;
