...
var __decorate = this && this.__decorate || function(e, t, o, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) i = Reflect.decorate(e, t, o, n);
    ...
    for (var a = e.length - 1; 0 <= a; a--)(r = e[a]) && (i = (s < 3 ? r(i) : 3 < s ? r(t, o, i) : r(t, o)) || i);
...
let VehicleMontageComponent = class VehicleMontageComponent extends BaseMontageComponent_1.BaseMontageComponent {
  ...
  OnStart() {
    return this.AnimationComponent = this.Entity.CheckGetComponent(235), !!super.OnStart()
  }
  GetMainAnimInstance() {
    return this.AnimationComponent.MainAnimInstance
  }
};
VehicleMontageComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(275)], VehicleMontageComponent), exports.VehicleMontageComponent = VehicleMontageComponent;
