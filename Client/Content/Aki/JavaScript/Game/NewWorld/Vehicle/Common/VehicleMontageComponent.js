...
let VehicleMontageComponent = class VehicleMontageComponent extends BaseMontageComponent_1.BaseMontageComponent {
  ...
  OnStart() {
    this.AnimationComponent = this.Entity.CheckGetComponent(248);
...
VehicleMontageComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(304)], VehicleMontageComponent);
