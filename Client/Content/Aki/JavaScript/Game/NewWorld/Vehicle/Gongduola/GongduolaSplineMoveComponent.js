...
let GongduolaSplineMoveComponent = class GongduolaSplineMoveComponent extends VehicleSplineMoveComponent_1.VehicleSplineMoveComponent {
  ...
  ApplySplineMoveDaConfig() {
    var t;
    if (this.ExtraMoveParams && (t = this.Entity.GetComponent(245))?.Config instanceof GongduolaConfig_1.GongduolaConfig) {
...
GongduolaSplineMoveComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(110)], GongduolaSplineMoveComponent);
