...
let PerformanceComponent = PerformanceComponent_1 = class PerformanceComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.Snn = t => {
      var e;
      return !this.rnn.has(t) && (e = GameplayTagUtils_1.GameplayTagUtils.GetGameplayTagById(t), (e = this.nXr.场景交互物特效列表.Get(e)) !== undefined) && !!(0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && (this.n$t.PlaySceneInteractionEffect(e), this.rnn.set(t, e), true);
    };
    this.ynn = t => {
      var e;
      if (!this.lnn.has(t)) {
  ...
  OnStart() {
    this.mnn = undefined;
    this.inn = this.Entity.CheckGetComponent(196);
  ...
  OnActivate() {
    ...
    this.xnn();
    this.rnn = new Map();
    if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && !this.n$t.GetIsSceneInteractionLoadCompleted()) {
  ...
  OnEnd() {
    ...
    if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && EventSystem_1.EventSystem.HasWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn)) {
  ...
  OnChangeTimeDilation(t) {
    var e = t * (this.Entity.GetComponent(122)?.CurrentTimeScale ?? 1);
  ...
  qnn(t) {
    ...
    if (e !== undefined) {
      ...
      if (e === this.nnn || this.nXr.场景交互物状态列表.Get(i) === undefined) {
        if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && this.n$t.GetSceneInteractionLevelHandleId() === -1) {
  ...
  Unn() {
    if (this.inn) {
      if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && this.rnn && this.rnn.size > 0) {
  ...
  Ann() {
    if (this.inn) {
      for (const e of this.inn.GetTagIds()) {
        ...
        if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && t !== undefined) {
  ...
  Mnn(t, e) {
    for (const s of e) {
      var i;
      if (this.rnn.has(s) && (i = this.rnn.get(s), this.rnn.delete(s), (0, RegisterComponent_1.isComponentInstance)(this.n$t, 202)) && i !== undefined) {
  ...
  Enn(t, e) {
    for (const h of e) {
      ...
      if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && i !== undefined) {
        this.n$t.StopExtraEffect(i);
      }
    }
    for (const n of t) {
      var s = GameplayTagUtils_1.GameplayTagUtils.GetGameplayTagById(n);
      if ((0, RegisterComponent_1.isComponentInstance)(this.n$t, 202) && s !== undefined) {
...
PerformanceComponent = PerformanceComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(105)], PerformanceComponent);
