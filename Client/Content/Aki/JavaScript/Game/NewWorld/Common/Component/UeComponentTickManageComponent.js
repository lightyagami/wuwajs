"use strict";
var UeComponentTickManageComponent_1, __decorate = this && this.__decorate || function(e, t, n, o) {
...
let UeComponentTickManageComponent = UeComponentTickManageComponent_1 = class UeComponentTickManageComponent extends EntityComponent_1.EntityComponent {
  ...
  OnInitData(e) {
    for (const t of e.GetParam(UeComponentTickManageComponent_1)) t instanceof UE.Class && this.vsn.push(t);
    return !0
  }
  OnActivate() {
    ...
    if (0 < this.vsn.length)
      for (const e of this.vsn) {
        ...
        for (let e = 0; e < o; ++e) {
          const t = n.Get(e);
          t instanceof UE.SkeletalMeshComponent || !t.IsComponentTickEnabled() || (this.LFr.push(t), t.SetComponentTickEnabled(!1))
        }
      } else {
...
UeComponentTickManageComponent = UeComponentTickManageComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(112)], UeComponentTickManageComponent), exports.UeComponentTickManageComponent = UeComponentTickManageComponent;
