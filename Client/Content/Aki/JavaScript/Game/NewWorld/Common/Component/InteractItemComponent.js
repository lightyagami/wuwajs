...
var __decorate = this && this.__decorate || function(t, e, r, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, r, n);
    ...
    for (var c = t.length - 1; 0 <= c; c--)(o = t[c]) && (s = (i < 3 ? o(s) : 3 < i ? o(e, r, s) : o(e, r)) || s);
...
let InteractItemComponent = class InteractItemComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.cC = void 0, this.Yrn = void 0, this.IsInit = !1
  }
  OnStart() {
    var t, e = WorldFunctionLibrary_1.default.GetDynamicEntity(this.Entity.Id);
    return e && ((t = e.GetComponentsByTag(UE.ChildActorComponent.StaticClass(), POSITION_TAG)) && 0 < t.Num() && (this.cC = t.Get(0)), this.Yrn = e.GetComponentByClass(UE.ArrowComponent.StaticClass()), this.IsInit = !0), !0
  }
  GetInteractPosition() {
...
InteractItemComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(103)], InteractItemComponent), exports.InteractItemComponent = InteractItemComponent;
