...
var __decorate = this && this.__decorate || function (e, t, i, n) {
  ...
  var o = s < 3 ? t : n === null ? n = Object.getOwnPropertyDescriptor(t, i) : n;
...
exports.BaseUnifiedStateComponent = undefined;
...
let BaseUnifiedStateComponent = BaseUnifiedStateComponent_1 = class BaseUnifiedStateComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.IsInGameInternal = undefined;
  }
  OnStart() {
  ...
  OnInit() {
    BaseUnifiedStateComponent_1.Load();
    return true;
  }
  OnEnable() {
  ...
  OnEnd() {
    EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.CharMovementModeChanged, this.Xrn);
    return true;
  }
  get IsInGame() {
  ...
  static Load() {
    if (this.BaseNeedLoad) {
      ...
      this.BaseNeedLoad = false;
    }
  }
  InitCharState() {
    this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.PositionEnumToTagId.get(CharacterUnifiedStateTypes_1.ECharPositionState.Ground));
    this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.MoveEnumToTagId.get(CharacterUnifiedStateTypes_1.ECharMoveState.Stand));
    this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.DirectionEnumToTagId.get(CharacterUnifiedStateTypes_1.ECharDirectionState.FaceDirection));
  }
  ResetCharState() {
  ...
  SetPositionState(e) {
    ...
    if (this.ActorComponent.IsAutonomousProxy) {
      if (t !== e) {
        ...
        this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.PositionEnumToTagId.get(e));
    ...
    if (!this.ActorComponent.IsAutonomousProxy) {
      for (const e of BaseUnifiedStateComponent_1.PositionTagIdList) {
        if (this.TagComponent?.HasTag(e)) {
          return BaseUnifiedStateComponent_1.PositionEnumToTagIdInverse.get(e);
        }
      }
    }
  ...
  OnPositionStateChange(e, t) {
    if (Log_1.Log.CheckDebug()) {
      Log_1.Log.Debug("Character", 6, "UnifiedState PositionStateChange", ["EntityId", this.Entity.Id], ["Name", this.ActorComponent?.Owner?.GetName()], ["From", CharacterUnifiedStateTypes_1.ECharPositionState[e]], ["To", CharacterUnifiedStateTypes_1.ECharPositionState[t]]);
    }
    if (t === CharacterUnifiedStateTypes_1.ECharPositionState.Ground) {
      this.OnLand();
    } else if (this.DirectionState === CharacterUnifiedStateTypes_1.ECharDirectionState.AimDirection) {
      this.SetDirectionState(CharacterUnifiedStateTypes_1.ECharDirectionState.FaceDirection);
    }
    EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharOnPositionStateChanged, e, t);
  }
  OnLand() {
    this.SetMoveState(CharacterUnifiedStateTypes_1.ECharMoveState.Other);
  }
  SetMoveState(e) {
    var t;
    if (this.ActorComponent.IsAutonomousProxy && (t = this.MoveState) !== e) {
      if (Log_1.Log.CheckDebug()) {
        Log_1.Log.Debug("Character", 6, "UnifiedState MoveStateChange", ["EntityId", this.Entity.Id], ["Name", this.ActorComponent?.Owner?.GetName()], ["From", CharacterUnifiedStateTypes_1.ECharMoveState[t]], ["To", CharacterUnifiedStateTypes_1.ECharPositionState[e]]);
      }
      this.TagComponent?.RemoveTag(-5899402);
      this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.MoveEnumToTagId.get(e));
      this.CachedMoveState = e;
      EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharOnUnifiedMoveStateChanged, t, e);
    }
  }
  get MoveState() {
    if (!this.ActorComponent.IsAutonomousProxy) {
  ...
  SetDirectionState(e) {
    var t;
    if (this.ActorComponent.IsAutonomousProxy && (t = this.DirectionState) !== e) {
      this.UpdateDirectionTag(t, e);
      EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharOnDirectionStateChanged, t, e);
    }
  }
  get DirectionState() {
    if (!this.ActorComponent.IsAutonomousProxy) {
      for (const e of BaseUnifiedStateComponent_1.DirectionTagIdList) {
        if (this.TagComponent?.HasTag(e)) {
          return BaseUnifiedStateComponent_1.DirectionEnumToTagIdInverse.get(e);
        }
      }
    }
  ...
  ClearDirectionTag(e) {
    if (e === CharacterUnifiedStateTypes_1.ECharDirectionState.AimDirection) {
      this.ExitAnimState();
    }
  ...
  AddDirectionTag(e) {
    ...
    this.TagComponent?.AddTag(BaseUnifiedStateComponent_1.DirectionEnumToTagId.get(e));
  }
  EnterAnimState() {
...
BaseUnifiedStateComponent.PositionEnumKeys = Object.values(CharacterUnifiedStateTypes_1.ECharPositionState).filter(e => typeof e == "number");
BaseUnifiedStateComponent.MoveEnumKeys = Object.values(CharacterUnifiedStateTypes_1.ECharMoveState).filter(e => typeof e == "number");
BaseUnifiedStateComponent.DirectionEnumKeys = Object.values(CharacterUnifiedStateTypes_1.ECharDirectionState).filter(e => typeof e == "number");
BaseUnifiedStateComponent.PositionTagIdList = undefined;
BaseUnifiedStateComponent.MoveTagIdList = undefined;
BaseUnifiedStateComponent.SubStateTagIdList = undefined;
BaseUnifiedStateComponent.DirectionTagIdList = undefined;
BaseUnifiedStateComponent.MoveEnumToTagId = undefined;
BaseUnifiedStateComponent.MoveEnumToTagIdInverse = undefined;
BaseUnifiedStateComponent.PositionEnumToTagId = undefined;
BaseUnifiedStateComponent.PositionEnumToTagIdInverse = undefined;
...
BaseUnifiedStateComponent = BaseUnifiedStateComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(102)], BaseUnifiedStateComponent);
