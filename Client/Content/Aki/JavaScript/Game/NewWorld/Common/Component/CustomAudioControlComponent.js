  ...
  OnStart() {
    switch (this.G1n) {
      ...
      case IComponent_1.EAudioRangeType.SceneActorRefComp:
        this.Hi_ = this.Entity.GetComponent(163);
        if (!this.Hi_) {
          if (Log_1.Log.CheckError()) {
...
CustomAudioControlComponent = CustomAudioControlComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(132)], CustomAudioControlComponent);
