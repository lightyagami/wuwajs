...
let UeSkeletalTickManageComponent = class UeSkeletalTickManageComponent extends EntityComponent_1.EntityComponent {
  ...
  OnActivate() {
    ...
    this.I5r = this.Entity.GetComponent(111);
  ...
  OnTick(t) {
    t = t * MathUtils_1.MathUtils.MillisecondToSecond * (this.Entity.GetComponent(133)?.CurrentTimeScale ?? 1);
  ...
  ProxyTick(t, e = false) {
    if (this.TickType === 1 || this.TickType === 2) {
      this.Rsn?.Start();
      this.d3r = Time_1.Time.Frame;
      var i = this.Entity.GetComponent(133)?.CurrentTimeScale;
  ...
  AfterProxyTick(t) {
    if (this.TickType === 1) {
      this.Rsn?.Start();
      var e = this.Entity.GetComponent(133)?.CurrentTimeScale;
...
UeSkeletalTickManageComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(125)], UeSkeletalTickManageComponent);
