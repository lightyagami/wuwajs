...
let UeSkeletalTickManageComponent = class UeSkeletalTickManageComponent extends EntityComponent_1.EntityComponent {
  ...
  OnActivate() {
    ...
    this.I5r = this.Entity.GetComponent(101);
...
UeSkeletalTickManageComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(114)], UeSkeletalTickManageComponent);
