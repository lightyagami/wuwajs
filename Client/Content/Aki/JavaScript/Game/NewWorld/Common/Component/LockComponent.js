...
var __decorate = this && this.__decorate || function(t, e, o, i) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) n = Reflect.decorate(t, e, o, i);
    ...
    for (var c = t.length - 1; 0 <= c; c--)(s = t[c]) && (n = (r < 3 ? s(n) : 3 < r ? s(e, o, n) : s(e, o)) || n);
...
let LockComponent = class LockComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.inn = void 0, this.u1t = void 0, this.onn = 0
  }
  OnStart() {
    this.inn = this.Entity.GetComponent(196), this.u1t = this.Entity.GetComponent(0);
...
LockComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(104)], LockComponent), exports.LockComponent = LockComponent;
