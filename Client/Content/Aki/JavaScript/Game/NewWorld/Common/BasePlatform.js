...
class SceneItemBasePlatform extends BasePlatform {
  constructor(t) {
    ...
    var t = this.EntityHandle?.Entity.GetComponent(214);
  ...
  CheckLeave(e, r) {
    if (this.EntityHandle?.Valid) {
      var s;
      var i = this.EntityHandle.Entity.GetComponent(214);
      var o = e?.GetComponent(189)?.CharacterMovement;
      let t = false;
      if (this.W$o) {
      ...
      i = this.EntityHandle.Entity?.GetComponent(340);
      if (i) {
  ...
  OnCharacterEnter(t, e) {
    if (this.EntityHandle.Valid) {
      var r = this.EntityHandle.Entity.GetComponent(214);
      var s = e?.GetOwner()?.GetEntityNoBlueprint();
      var i = s?.GetComponent(217);
      if (this.Z2u.length > 0) {
      ...
      var o = this.EntityHandle?.Entity?.GetComponent(340);
      if (o) {
...
class VehicleBasePlatform extends BasePlatform {
  ...
  CheckLeave(t, e) {
    ...
    if (r > this.LeaveSphereRadiusSq) {
      var s = Global_1.Global.BaseCharacter?.GetEntityNoBlueprint()?.GetComponent(217);
      if (this.Z2u.length > 0) {
  ...
  OnCharacterEnter(t, e) {
    if (this.EntityHandle.Valid) {
      this.EntityHandle.Entity.GetComponent(125)?.SetTakeOverTick(true);
