...
class SceneItemBuffModel extends ModelBase_1.ModelBase {
  ...
  Add(e, t, r) {
    ...
    return o || (o = new Array, s.set(t, o)), !o.includes(r) && (o.push(r), !0)
  }
  Remove(e, t, r, s) {
    let o = new Array;
    var n, i = this.Hsr.get(e);
    return i && ((n = i.get(t)) && (s ? -1 < (s = n.indexOf(s)) && (o = n.splice(s, r)) : o = n.splice(0, -1 === r ? n.length : r), 0 === n.length) && i.delete(t), 0 === i.size) && this.Hsr.delete(e), o
  }
  RemoveAll(e) {
