...
var SceneItemHitComponent_1, __decorate = this && this.__decorate || function(t, e, i, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, i, n);
    ...
    for (var h = t.length - 1; 0 <= h; h--)(s = t[h]) && (o = (r < 3 ? s(o) : 3 < r ? s(e, i, o) : s(e, i)) || o);
...
let SceneItemHitComponent = SceneItemHitComponent_1 = class SceneItemHitComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.inn = void 0, this.Hte = void 0, this.Ifn = void 0, this.Tfn = new Array, this.Lfn = new Map, this.Dfn = void 0, this.Rfn = void 0, this.Ufn = void 0, this.Afn = Rotator_1.Rotator.Create(), this.w0n = 0, this.AimParts = new Array, this.Pla = void 0, this.kSa = void 0, this.wla = t => SceneItemHitUtils_1.SceneItemHitUtils.CheckHitDataMatchPlayerAttack(t), this.Bla = t => SceneItemHitUtils_1.SceneItemHitUtils.CheckHitDataMatchFixedBulletId(this.Pla, t)
  }
  OnStart() {
    this.inn = this.Entity.GetComponent(196), this.Ifn = this.Entity.GetComponent(130), this.Hte = this.Entity.GetComponent(202), this.w0n = this.Entity.GetComponent(0).GetEntityOnlineInteractType();
    var t = ModelManager_1.ModelManager.CreatureModel.GetCompleteEntityData(this.Hte?.CreatureData.GetPbDataId());
    return t && (t = (0, IComponent_1.getComponent)(t.ComponentsData, "HitComponent")) && (this.kSa = t), !0
  }
  OnActivate() {
    if (this.kSa) {
      ...
      this.kSa?.AttackerHitTimeScaleRatio && (this.Dfn = this.kSa.AttackerHitTimeScaleRatio), this.kSa?.VictimHitTimeScaleRatio && (this.Rfn = this.kSa.VictimHitTimeScaleRatio)
    }
  }
  Pfn(t) {
  ...
  OnSceneItemHit(t, e) {
    ...
    if (i) {
      if (this.Entity.GetComponent(162)?.ReboundBullet(t, i)) return !1;
      if (0 !== t.CalculateType) return t.ReBulletData.TimeScale.TimeScaleOnHit && this.Ofn(t), !1;
      if (this.Pfn(t)) {
        this.bfn(t), this.WVr(t, i.EffectInfo.DisablePostProcess), this.Bfn(t, e), this.iwr(t);
        for (var [n] of this.Lfn) this.wfn(n, t) && this.xfn(n, t) && this.qfn(n, t);
        EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneItemEntityHit), EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneItemEntityHitByHitActorData, e), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.OnAnySceneItemEntityHit, this.Entity)
  ...
  WVr(t, e) {
    ...
    ((i = n && 0 < n.length && t.Attacker.GetComponent(205)?.HasTag(412116357) ? n : i) || (i = t.ReBulletData.Render.EffectOnHit.get(4)) && 0 !== i.length) && (n = new UE.TransformDouble(t.HitEffectRotation.ToUeRotator(), t.HitPosition.ToUeVector(), Vector_1.Vector.OneVectorDouble), BulletCollisionUtil_1.BulletCollisionUtil.PlaySceneItemHitEffect(t.Attacker, i, n, t.ReBulletData.Render.AudioOnHit, e))
  }
  Bfn(e, i) {
    ...
    if (n) {
      ...
      let t = void 0;
      s && 0 < s ? 1 === i.ValidProcessIndex && (t = SceneInteractionManager_1.SceneInteractionManager.Get().GetPartCollisionActorTag(this.Hte.GetSceneInteractionLevelHandleId(), i.Actor)?.TagId) : (i = (s = EntitySystem_1.EntitySystem.Get(e.BulletEntityId).GetBulletInfo()).CollisionInfo.BeHitEffect, e = ConfigManager_1.ConfigManager.BulletConfig.GetBulletHitData(s.Attacker, i), BulletUtil_1.BulletUtil.GetHitRotator(s, this.Hte, this.Afn), i = BulletUtil_1.BulletUtil.GetOverrideHitAnimByAngle(this.Hte, e?.被击动作, this.Afn.Yaw), t = this.Gfn(i)), void 0 !== this.Ufn && (n.RemoveTag(this.Ufn), this.Ufn = void 0), void 0 !== t && (n.AddTag(t), this.Ufn = t)
    }
  }
  bfn(t) {
    t.HitEffect && this.Hte.UpdateHitInfo(t.HitPosition, t.HitEffect.地面受击速度)
  }
  qfn(t, e) {
  ...
  Nfn(t) {
    ...
    i.TimeScaleOnAttackIgnoreAttacker ? 0 < n.时间膨胀时长 && (e = EntitySystem_1.EntitySystem.Get(t.BulletEntityId).GetBulletInfo(), BulletUtil_1.BulletUtil.SetTimeScale(e, n.优先级, n.时间膨胀值 * s, n.时间膨胀变化曲线, Math.min(n.时间膨胀时长 * r, n.时间膨胀时长 + o), 1)) : 0 < n.时间膨胀时长 && (t.Attacker.GetComponent(122)?.SetTimeScale(n.优先级 - 1, n.时间膨胀值 * s, n.时间膨胀变化曲线, Math.min(n.时间膨胀时长 * r, n.时间膨胀时长 + o), 1), e = i.CharacterCustomKeyTimeScale, StringUtils_1.StringUtils.IsEmpty(e) || (i = ModelManager_1.ModelManager.BulletModel.GetEntityIdByCustomKey(t.Attacker.Id, e, t.BulletId.toString())) && EntitySystem_1.EntitySystem.Get(i)?.GetComponent(122)?.SetTimeScale(n.优先级, n.时间膨胀值 * s, n.时间膨胀变化曲线, Math.min(n.时间膨胀时长 * r, n.时间膨胀时长 + o), 1))
  }
  Ofn(t) {
    var e, i, n, s, r, o;
    t.ReBulletData.Base.ContinuesCollision || (e = this.Entity.GetComponent(122)) && (n = (i = t.ReBulletData.TimeScale).TimeScaleOnHit, s = this.Rfn?.ValueRatio ?? 1, r = this.Rfn?.TimeRatio ?? 1, o = this.Rfn?.MaxExtraTime ?? 0, 0 < n.时间膨胀时长) && BulletUtil_1.BulletUtil.SetVictimTimeScale(t.BulletEntityId, this.Entity.Id, e, n.优先级, n.时间膨胀值 * s, n.时间膨胀变化曲线, Math.min(n.时间膨胀时长 * r, n.时间膨胀时长 + o), 2, i.RemoveHitTimeScaleOnDestroy, this.$vl(t))
  }
  $vl(t) {
    var e;
  ...
  RemoveHitCondition(t) {
    t = this.Tfn.indexOf(t); - 1 !== t && this.Tfn.splice(t, 1)
  }
  RegisterComponent(t, e) {
    var i;
    this.Lfn.has(t) || ((i = new ComponentHitReg).ComponentHitBaseConfig = e, this.Lfn.set(t, i), e && (this.kSa = e))
  }
...
SceneItemHitComponent.kfn = new Map([
  ...
  [11, -350051159],
  [2, -2061161961]
]), SceneItemHitComponent = SceneItemHitComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(154)], SceneItemHitComponent), exports.SceneItemHitComponent = SceneItemHitComponent;
