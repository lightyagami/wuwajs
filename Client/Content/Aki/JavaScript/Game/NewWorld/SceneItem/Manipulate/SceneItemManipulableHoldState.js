...
class SceneItemManipulableHoldState extends SceneItemManipulableBaseState_1.SceneItemManipulableBaseState {
  ...
  OnEnter() {
    ...
    var e = this.SceneItem.Entity.GetComponent(149);
    if (e?.Valid) {
      t.AddTag(882475449);
    } else {
      t.AddTag(1892366727);
  ...
  osr() {
    ...
    var t = this.SceneItem.Entity.GetComponent(149);
    if (t?.Valid) {
    ...
    if (this.msr) {
      ...
      if (this.Fga) {
        do {
          ...
          let t = undefined;
          _ = (t = (UE.KuroStaticLibrary.IsImplementInterface(_.GetClass(), UE.BPI_CreatureInterface_C.StaticClass()) ? ActorUtils_1.ActorUtils : ModelManager_1.ModelManager.SceneInteractionModel).GetEntityByActor(_))?.Entity?.GetComponent(228);
          if (_) {
