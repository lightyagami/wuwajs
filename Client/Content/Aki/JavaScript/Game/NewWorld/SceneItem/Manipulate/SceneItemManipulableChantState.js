...
class SceneItemManipulableChantState extends SceneItemManipulableBaseState_1.SceneItemManipulableBaseState {
  constructor(e, t, n) {
    super(e), this.pYi = void 0, this.Znr = void 0, this.pYi = t, this.Znr = n
  }
  OnEnter() {
    this.StartCameraShake(this.pYi), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.AddSubCameraTag, this.Znr), this.SceneItem.NeedRemoveControllerId = !0
  }
  OnExit() {
