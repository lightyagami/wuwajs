...
class SceneItemManipulableDropState extends SceneItemManipulableBaseState_1.SceneItemManipulableBaseState {
  ...
  OnEnter() {
    ...
    t.X *= .1, t.Y *= .1, e.SetPhysicsLinearVelocity(t.ToUeVectorOld()), this.SceneItem.NeedRemoveControllerId = !0, LevelGamePlayController_1.LevelGamePlayController.ManipulatableBeCastOrDrop2Server(this.SceneItem.Entity.Id, Protocol_1.Aki.Protocol.Zw_.Proto_EControlStateLetGo), FNameUtil_1.FNameUtil.IsNothing(this.SceneItem.ManipulateBaseConfig.待机状态碰撞预设) || this.SceneItem.ActorComp.GetPrimitiveComponent().SetCollisionProfileName(this.SceneItem.ManipulateBaseConfig.待机状态碰撞预设), this.EnterCallback && this.EnterCallback()
  }
}
