...
class SceneItemManipulablePrecastState extends SceneItemManipulableBaseState_1.SceneItemManipulableBaseState {
  constructor() {
    super(...arguments), this.fgt = 0, this.Tsr = "", this.Lsr = void 0, this.Dsr = Vector_1.Vector.Create()
  }
  SetDirection(e) {
    this.fgt = e
  }
  ...
  OnTick(e) {
    ...
    var e = ConfigManager_1.ConfigManager.ManipulateConfig.GetPrecastLineValue(this.Tsr, this.Timer / ConfigManager_1.ConfigManager.ManipulateConfig.PrecastTime),
      ...
      i = this.ari();
    return this.Rsr(), this.Lsr.Multiply(e.X, t), this.Dsr.Multiply(e.Z, a), a.AdditionEqual(t), a.AdditionEqual(i), this.SceneItem.ActorComp.SetActorLocation(a.ToUeVector()), !0
  }
  ari() {
    var e = Global_1.Global.BaseCharacter.CharacterActorComponent.ActorTransform,
      t = this.SceneItem.UsingAssistantHoldOffset ? this.SceneItem.ConfigAssistantHoldOffset : this.SceneItem.ConfigHoldOffset,
      e = e.TransformPositionNoScale(t);
    return Vector_1.Vector.Create(e)
  }
  Rsr() {
    var e = Vector_1.Vector.Create(),
      t = (this.Lsr = Global_1.Global.BaseCharacter?.CharacterActorComponent?.ActorForwardProxy, Global_1.Global.BaseCharacter?.CharacterActorComponent?.ActorUpProxy);
    this.Lsr.CrossProduct(t, e), e.CrossProduct(this.Lsr, this.Dsr), this.Dsr.Normalize()
  }
}
