...
class SceneItemManipulableMatchJigsawBaseState extends SceneItemManipulableMatchOutletState_1.SceneItemManipulableMatchOutletState {
  OnEnter() {
    this.SceneItem.TryAddTagById(this.Ssr() ? 741712776 : 1488947861), this.SceneItem.IsCanBeHeld = !0, this.OpenPhysicsSplit()
  }
  OnExit() {
    this.SceneItem.TryRemoveTagById(741712776), this.SceneItem.TryRemoveTagById(1488947861), this.ClosePhysicsSplit()
  }
  Ssr() {
