...
exports.SceneItemHitUtils = undefined;
...
class SceneItemHitUtils {
  ...
  static CheckHitDataMatchOnlyDropAttack(t, e) {
    return !!t.ReBulletData.Logic.PresentTagIds.includes(1994027462) && !(t = Global_1.Global.BaseCharacter?.CharacterActorComponent, e = e.GetComponent(1), !t) && !!e && !(Vector_1.Vector.DistSquared2D(e.ActorLocationProxy, t.ActorLocationProxy) > DROP_ATTACK_VALID_RANGE);
  }
  ...
  static CheckHitDataMatchPlayerAttack(t) {
    var e;
    return !!t.Attacker?.Valid && (!!(e = t.Attacker?.GetComponent(0))?.IsRole() || !!e?.IsVision() || !!ModelManager_1.ModelManager.CreatureModel.GetEntity(e.GetSummonerId())?.Entity?.GetComponent(0)?.IsRole() || !!t.Attacker?.GetComponent(250)?.Driver?.CheckGetComponent(0)?.IsRole() || !!t.Attacker?.GetComponent(269) || !!t.Attacker?.GetComponent(235)?.Valid);
  }
