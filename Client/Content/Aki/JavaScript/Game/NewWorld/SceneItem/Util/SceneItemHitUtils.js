...
class SceneItemHitUtils {
  ...
  static CheckHitDataMatchPlayerAttack(t) {
    var e;
    return !!t.Attacker?.Valid && (!!(e = t.Attacker?.GetComponent(0))?.IsRole() || !!e?.IsVision() || !!ModelManager_1.ModelManager.CreatureModel.GetEntity(e.GetSummonerId())?.Entity?.GetComponent(0)?.IsRole() || !!t.Attacker?.GetComponent(222)?.Valid);
  }
