...
let SceneItemGravityFlipComponent = SceneItemGravityFlipComponent_1 = class SceneItemGravityFlipComponent extends EntityComponent_1.EntityComponent {
  ...
  Rtn() {
    ...
    if (!this.JK_) {
      ...
      if (e = this.Entity.GetComponent(209)) {
...
SceneItemGravityFlipComponent = SceneItemGravityFlipComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(310)], SceneItemGravityFlipComponent);
