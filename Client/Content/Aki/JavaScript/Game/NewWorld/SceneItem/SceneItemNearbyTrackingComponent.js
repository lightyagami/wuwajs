"use strict";
var SceneItemNearbyTrackingComponent_1, __decorate = this && this.__decorate || function(e, t, i, n) {
...
let SceneItemNearbyTrackingComponent = SceneItemNearbyTrackingComponent_1 = class SceneItemNearbyTrackingComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.Lo = void 0, this.Tvn = !1, this.Lvn = void 0, this.Xte = void 0, this.E9 = void 0, this.Dvn = void 0, this.Rvn = void 0, this.w1n = e => {
      this.Xte && this.Uvn(e)
    }, this.Avn = () => {
      this.Lo?.IsEnbaleWhileHoming && "Icon" === this.Lvn?.Type && this.Lvn.Duration && (this.EnableTracking = !0, this.Dvn && TimerSystem_1.TimerSystem.Has(this.Dvn) && (TimerSystem_1.TimerSystem.Remove(this.Dvn), this.Dvn = void 0), this.Dvn = TimerSystem_1.TimerSystem.Delay(() => {
        this.EnableTracking = !1
      }, this.Lvn.Duration * CommonDefine_1.MILLIONSECOND_PER_SECOND))
    }
  }
  get ShowRange() {
    return "AudioPoint" === this.Lvn?.Type ? this.Lvn.FarRadius : this.Lvn?.ShowRange
  }
  get HideRange() {
    return "AudioPoint" === this.Lvn?.Type ? this.Lvn.FarRadius : this.Lvn?.HideRange
  }
  get IconOffset() {
    return this.Rvn
  }
  ...
  set EnableTracking(e) {
    this.Tvn = e, EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.OnUpdateNearbyEnable, e), e || EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RemoveNearbyTrack, this.Entity)
  }
  get IconPath() {
  ...
  get CompassNearbyShowRange() {
    if ("Compass" === this.Lvn?.Type) return this.Lvn?.IconTrackingConfig?.ShowRange
  }
  get CompassNearbyHideRange() {
    if ("Compass" === this.Lvn?.Type) return this.Lvn?.IconTrackingConfig?.HideRange
  }
...
SceneItemNearbyTrackingComponent = SceneItemNearbyTrackingComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(160)], SceneItemNearbyTrackingComponent), exports.SceneItemNearbyTrackingComponent = SceneItemNearbyTrackingComponent;
