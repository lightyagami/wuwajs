...
class PortalController extends ControllerBase_1.ControllerBase {
  static RegisterPair(t, e, r = false, a = true) {
    ...
    if (!ModelManager_1.ModelManager.PortalModel?.GetPortal(t) && (!r || !this.mBn)) {
      i = ModelManager_1.ModelManager.CreatureModel?.GetEntity(t)?.Entity?.GetComponent(219);
      s = ModelManager_1.ModelManager.CreatureModel?.GetEntity(i?.GetPairCreatureDataId() ?? 0)?.Entity?.GetComponent(219);
  ...
  static RegisterDynamicPortals() {
    if (this.GSa[0] && this.GSa[1]) {
      if (this.mBn && this.Hla) {
        var t = ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.Hla)?.Entity?.GetComponent(219);
  ...
  static UnRegisterDynamicPortals(t = false) {
    ...
    if (this.mBn && this.Hla) {
      e = this.Hla;
      r = ModelManager_1.ModelManager.CreatureModel?.GetEntity(e)?.Entity?.GetComponent(219);
      a = ModelManager_1.ModelManager.CreatureModel?.GetEntity(r?.GetPairCreatureDataId() ?? 0)?.Entity?.GetComponent(219);
    ...
    switch (t.GetPortalModel()) {
      case "A":
        if (this.GSa[0] === e && this.GSa[1]) {
          return ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[1])?.Entity?.GetComponent(219);
        }
        break;
      case "B":
        if (this.GSa[1] === e && this.GSa[0]) {
          return ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[0])?.Entity?.GetComponent(219);
        }
    }
  }
