...
class PortalPairParams {
  constructor(t, e, r, a, i, s) {
    this.Trans = t, this.PairTrans = e, this.Owner = r, this.PairOwner = a, this.PortalBounds = i, this.PairPortalBounds = s, this.ACapture = void 0, this.BCapture = void 0
  }
}
...
class PortalController extends ControllerBase_1.ControllerBase {
  ...
  static RegisterDynamicPortals() {
    if (this.GSa[0] && this.GSa[1]) {
      if (this.mBn && this.Hla) {
        ...
        if (this.Hla === this.GSa[0] && t?.GetPairCreatureDataId() === this.GSa[1]) return;
      ...
      var t = ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[0])?.Entity,
        ...
        r = ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[1])?.Entity,
        a = r?.GetComponent(215);
      e?.CanRegisterPortal() && a?.CanRegisterPortal() && (t = new PortalPairParams(e.PortalCapture.Plane.D_K2_GetComponentToWorld(), a.PortalCapture.Plane.D_K2_GetComponentToWorld(), t.GetComponent(1).Owner, r.GetComponent(1).Owner, e.PortalBounds, a.PortalBounds), e?.SetPairCreatureDataId(this.GSa[1]), a?.SetPairCreatureDataId(this.GSa[0]), this.RegisterPair(this.GSa[0], t, !0, !1))
    }
  }
  static UnRegisterDynamicPortals(t = !1) {
    var e, r, a;
    this.mBn && this.Hla && (e = this.Hla, r = (ModelManager_1.ModelManager.CreatureModel?.GetEntity(e))?.Entity?.GetComponent(215), a = (ModelManager_1.ModelManager.CreatureModel?.GetEntity(r?.GetPairCreatureDataId() ?? 0))?.Entity?.GetComponent(215), this.UnRegisterPair(e, !0, !1, t), r?.SetPairCreatureDataId(0), a?.SetPairCreatureDataId(0))
  }
  static GetPairDynamicPortal(t) {
    var e = t.GetCreatureDataId();
    switch (t.GetPortalModel()) {
      case "A":
        if (this.GSa[0] === e && this.GSa[1]) return ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[1])?.Entity?.GetComponent(215);
        break;
      case "B":
        if (this.GSa[1] === e && this.GSa[0]) return ModelManager_1.ModelManager.CreatureModel?.GetEntity(this.GSa[0])?.Entity?.GetComponent(215)
    }
  }
  ...
  static AfterDeleteDynamicPortal(t) {
    ...
    this.GSa[0] === t ? this.GSa[0] = void 0 : this.GSa[1] === t && (this.GSa[1] = void 0)
  }
  static OnInit() {
    return EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnChangeModuleDebugLevel, this.OnChangeModuleDebugLevel), !0
  }
  static OnClear() {
    return EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnChangeModuleDebugLevel, this.OnChangeModuleDebugLevel), this.CBn.clear(), this.Vla.Clear(), this.GSa.length = 0, this.Hla = 0, !(this.mBn = !1)
  }
}(exports.PortalController = PortalController).GSa = [], PortalController.CBn = new Map, PortalController.Vla = new Stack_1.Stack, PortalController.Hla = void 0, PortalController.mBn = !1, PortalController.OnChangeModuleDebugLevel = (t, e) => {
  t === PORTAL_DEBUG_KEY && ModelManager_1.ModelManager.PortalModel?.GetPortals().forEach(t => {
