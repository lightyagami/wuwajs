...
class SceneItemMoveController extends ControllerBase_1.ControllerBase {
  ...
  static mIn(e, o = 1) {
    ...
    if (t) {
      ...
      if (n) {
        e = t.Points.slice();
        if (e.reverse(), 0 < o && e.splice(0, o), t.MoveMotion?.Type === IAction_1.EMoveMotion.VariableMotion)
          for (const i of e) {
        ...
        t.IsLoop ? n.AddStopMoveCallbackWithEntity(SceneItemMoveController.dIn) : n.AddStopMoveCallbackWithEntity(SceneItemMoveController.OnStopCallback)
      }
    }
  }
  static cIn(e, t = 1) {
    ...
    if (n) {
      ...
      if (r) {
        e = n.Points.slice();
        if (0 < t && e.splice(0, t), n.MoveMotion?.Type === IAction_1.EMoveMotion.VariableMotion) {
          let o = 0 < t;
          for (const i of e) {
            var v = Vector_1.Vector.Create(i.X ?? 0, i.Y ?? 0, i.Z ?? 0);
            let e = n.StopTime;
            o || (e = 0, o = !0), r.AddMoveTarget(new SceneItemMoveComponent_1.MoveTarget(v, -1, e, n.MoveMotion.MaxSpeed ?? -1, n.MoveMotion.Acceleration ?? -1))
          }
        } else
          for (const c of e) {
        ...
        n.IsLoop ? r.AddStopMoveCallbackWithEntity(SceneItemMoveController.CIn) : r.AddStopMoveCallbackWithEntity(SceneItemMoveController.OnStopCallback)
      }
    }
  }
}
exports.SceneItemMoveController = SceneItemMoveController, (_a = SceneItemMoveController)._In = new Map, SceneItemMoveController.CIn = e => {
  var o = e.GetComponent(128);
  o && (o?.RemoveStopMoveCallbackWithEntity(_a.CIn), Log_1.Log.CheckInfo() && Log_1.Log.Info("Event", 31, "[LevelEventSceneItemMove] MoveToStartCallback"), SceneItemMoveController.mIn(e))
}, SceneItemMoveController.dIn = e => {
  var o = e.GetComponent(128);
  o && (o?.RemoveStopMoveCallbackWithEntity(_a.dIn), Log_1.Log.CheckInfo() && Log_1.Log.Info("Event", 31, "[LevelEventSceneItemMove] MoveToEndCallback"), SceneItemMoveController.cIn(e))
}, SceneItemMoveController.OnStopCallback = e => {
  var o = e.GetComponent(128);
  o && (o?.RemoveStopMoveCallbackWithEntity(_a.OnStopCallback), EventSystem_1.EventSystem.HasWithTarget(e, EventDefine_1.EEventName.OnSceneItemMoveEventBroken, _a.OnStopCallback) && EventSystem_1.EventSystem.RemoveWithTarget(e, EventDefine_1.EEventName.OnSceneItemMoveEventBroken, _a.OnStopCallback), SceneItemMoveController._In.delete(e))
};
