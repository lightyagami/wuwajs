...
let SceneItemFishingPointComponent = class SceneItemFishingPointComponent extends EntityComponent_1.EntityComponent {
  ...
  OnStart() {
    ...
    this.FP_ = this.Entity.GetComponent(87);
...
SceneItemFishingPointComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(302)], SceneItemFishingPointComponent);
