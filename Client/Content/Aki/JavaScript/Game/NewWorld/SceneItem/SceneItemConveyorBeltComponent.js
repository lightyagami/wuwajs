...
let SceneItemConveyorBeltComponent = SceneItemConveyorBeltComponent_1 = class SceneItemConveyorBeltComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.Vdn = (t, e) => {
      ...
      if (o === Protocol_1.Aki.Protocol.kks.Proto_Player) {
        if (this.kdn = t) {
          this.qdn = e.GetComponent(189);
          this.Gdn = e.GetComponent(111);
          this.qdn.DeltaConveyBeltSpeed = this.iun.ToUeVector();
        } else {
  ...
  Kdn() {
    this.Bdn = undefined;
    var t = this.Entity.GetComponent(144).State;
    let e = "";
    if (t === 1) {
      e = "常态";
    } else if (t === 2) {
...
SceneItemConveyorBeltComponent = SceneItemConveyorBeltComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(158)], SceneItemConveyorBeltComponent);
