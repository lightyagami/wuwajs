"use strict";
var SceneItemPickInteractComponent_1, __decorate = this && this.__decorate || function(t, e, n, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, e, n, o);
    ...
    for (var s = t.length - 1; 0 <= s; s--)(c = t[s]) && (r = (i < 3 ? c(r) : 3 < i ? c(e, n, r) : c(e, n)) || r);
...
let SceneItemPickInteractComponent = SceneItemPickInteractComponent_1 = class SceneItemPickInteractComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.DGa = void 0, this.xGa = new Array, this.PGa = void 0
  }
  OnInitData(t) {
  ...
  OnStart() {
    return this.DGa = this.Entity.GetComponent(138), !0
  }
  get Index() {
    ...
    if (this.DGa) {
      ...
      if (t && this.PGa)
        for (const n of t) {
          ...
          EffectSystem_1.EffectSystem.IsValid(e) && (EffectSystem_1.EffectSystem.GetEffectActor(e)?.D_K2_SetActorLocation(n.ToUeVector(), !1, void 0, !0), this.xGa.push(e))
        }
    }
  }
  OnSelectEnd() {
    for (const t of this.xGa) EffectSystem_1.EffectSystem.StopEffectById(t, "PickInteractComponent.OnSelectEnd", !1);
    this.xGa.length = 0
  }
};
SceneItemPickInteractComponent = SceneItemPickInteractComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(254)], SceneItemPickInteractComponent), exports.SceneItemPickInteractComponent = SceneItemPickInteractComponent;
