...
let AiGearStrategyComponent = AiGearStrategyComponent_1 = class AiGearStrategyComponent extends EntityComponent_1.EntityComponent {
  ...
  x5a(e) {
    this.A5a = EntitySystem_1.EntitySystem.GetComponent(e.Id, 148);
    if (this.A5a) {
  ...
  uK_(e) {
    this._K_ = this.Entity.GetComponent(309);
    if (this._K_) {
...
AiGearStrategyComponent = AiGearStrategyComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(284)], AiGearStrategyComponent);
