...
let SceneItemReboundComponent = SceneItemReboundComponent_1 = class SceneItemReboundComponent extends EntityComponent_1.EntityComponent {
  ...
  p9r() {
    ...
    this.l9r.WorldContextObject = this.Entity.GetComponent(206)?.Owner;
  }
...
SceneItemReboundComponent = SceneItemReboundComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(166)], SceneItemReboundComponent);
