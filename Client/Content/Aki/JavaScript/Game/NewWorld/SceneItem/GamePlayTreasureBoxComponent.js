...
let SceneItemTreasureBoxComponent = SceneItemTreasureBoxComponent_1 = class SceneItemTreasureBoxComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.m1n = () => {
      this.ccn();
      if (this.Entity.CheckGetComponent(142).IsInState(2)) {
        this.mcn();
      }
    };
    this.dcn = e => {
  ...
  OnActivate() {
    ...
    this.ucn = undefined;
    if (!this.Entity.CheckGetComponent(142).IsInState(0)) {
      this.m1n();
    }
    return true;
  }
  ...
  ccn() {
    var e = this.Entity.CheckGetComponent(142);
    var t = this.Entity.CheckGetComponent(206);
    let n = undefined;
    let r = undefined;
    switch (e.State) {
      case 1:
        n = this.Entity.CheckGetComponent(139).IsLocked ? (r = -1107341031, -1491083225) : (r = -1491083225, -1107341031);
        break;
      case 2:
        r = -1107341031;
        n = -1526657280;
  ...
  CloseAllCollisions() {
    var e = this.Entity.GetComponent(212);
...
SceneItemTreasureBoxComponent = SceneItemTreasureBoxComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(150)], SceneItemTreasureBoxComponent);
