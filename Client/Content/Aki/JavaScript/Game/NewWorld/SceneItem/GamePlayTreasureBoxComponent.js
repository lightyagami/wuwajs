...
let SceneItemTreasureBoxComponent = SceneItemTreasureBoxComponent_1 = class SceneItemTreasureBoxComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.m1n = () => {
      this.ccn();
      if (this.Entity.CheckGetComponent(133).IsInState(2)) {
        this.mcn();
      }
    };
    this.dcn = e => {
  ...
  OnActivate() {
    ...
    this.ucn = undefined;
    if (!this.Entity.CheckGetComponent(133).IsInState(0)) {
      this.m1n();
    }
    return true;
  }
  ...
  ccn() {
    ...
    var t = this.Entity.CheckGetComponent(196);
    let n = undefined;
    let r = undefined;
    switch (e.State) {
      case 1:
...
SceneItemTreasureBoxComponent = SceneItemTreasureBoxComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(141)], SceneItemTreasureBoxComponent);
