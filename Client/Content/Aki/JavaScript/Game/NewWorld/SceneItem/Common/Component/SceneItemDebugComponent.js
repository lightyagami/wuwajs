...
var __decorate = this && this.__decorate || function(e, t, n, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) c = Reflect.decorate(e, t, n, o);
    ...
    for (var s = e.length - 1; 0 <= s; s--)(r = e[s]) && (c = (i < 3 ? r(c) : 3 < i ? r(t, n, c) : r(t, n)) || c);
...
let SceneItemDebugComponent = class SceneItemDebugComponent extends EntityComponent_1.EntityComponent {
  GetTagDebugStrings() {
    return this.Entity.GetComponent(196).GetTagDebugStrings()
  }
};
SceneItemDebugComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(126)], SceneItemDebugComponent), exports.SceneItemDebugComponent = SceneItemDebugComponent;
