...
let TemplateEntitySpawnerComponent = TemplateEntitySpawnerComponent_1 = class TemplateEntitySpawnerComponent extends EntityComponent_1.EntityComponent {
  ...
  SQ1() {
    for (const n of this.vQ1) {
      var t = n.GetComponent(206);
      if (t) {
        var e = n.GetComponent(209);
        if (e) {
          e.AddTag(1090344258);
...
TemplateEntitySpawnerComponent = TemplateEntitySpawnerComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(300)], TemplateEntitySpawnerComponent);
