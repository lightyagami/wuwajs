"use strict";
var SceneItemNoRenderPortalComponent_1, __decorate = this && this.__decorate || function(e, t, r, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, r, o);
    ...
    for (var n = e.length - 1; 0 <= n; n--)(i = e[n]) && (s = (a < 3 ? i(s) : 3 < a ? i(t, r, s) : i(t, r)) || s);
...
class NoRenderPortalTeleportParam {
  constructor(e, t, r, o) {
    this.OtherActor = e, this.IsRole = t, this.InPortalComp = r, this.AfterTeleportTransform = o, this.OriginEnableMovementSync = !1, this.AfterTeleportGravityDirect = void 0
  }
}
let SceneItemNoRenderPortalComponent = SceneItemNoRenderPortalComponent_1 = class SceneItemNoRenderPortalComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.IIl = "A", this.wDe = 0, this.Wpo = 0, this.TIl = INVALID_ENTITY, this.Tln = INVALID_ENTITY, this.ActorComp = void 0, this.Eel = void 0, this.Rd_ = void 0, this.IsPortalPrepared = !1, this.IsPortalConnected = !1, this.R0n = void 0, this.Rnn = () => {
      this.xka(), this.LIl()
    }, this._ln = (e, t) => {
      var r;
      t?.Valid && (r = t.Entity.GetComponent(0)?.GetPbDataId()) && this.TIl === r && (EventSystem_1.EventSystem.HasWithTarget(t, EventDefine_1.EEventName.RemoveEntity, this._ln) && EventSystem_1.EventSystem.RemoveWithTargetUseKey(this, t, EventDefine_1.EEventName.RemoveEntity, this._ln), this.RIl())
    }, this.Lll = void 0
  }
  GetPbDataId() {
    return this.wDe
  ...
  OnInitData(e) {
    ...
    return this.R0n = t, "Static" === this.R0n.Config.Type && (this.TIl = this.R0n.Config.LinkPortalEntityId), this.IIl = this.R0n.Config.PortalModel, e.EntityData && (this.wDe = e.EntityData?.v9n), this.Wpo = this.Entity.GetComponent(0).GetCreatureDataId(), !0
  }
  OnStart() {
    return this.ActorComp = this.Entity.GetComponent(202), !0
  }
  OnActivate() {
    return this.ActorComp?.Valid && (EventSystem_1.EventSystem.HasWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn) || EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn), this.ActorComp?.GetIsSceneInteractionLoadCompleted()) && this.Rnn(), !0
  }
  OnEnd() {
    return EventSystem_1.EventSystem.RemoveAllTargetUseKey(this), EventSystem_1.EventSystem.HasWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn) && EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn), this.RIl(), this.R6a(), !(this.Eel = void 0)
  }
  OnDisable(e) {
  ...
  U6a() {
    var e;
    return !!(4 & this.Entity.Flag && this.ActorComp && this.ActorComp?.GetIsSceneInteractionLoadCompleted() && (e = this.ActorComp.CreatureData.GetEntityOnlineInteractType(), LevelGamePlayController_1.LevelGamePlayController.MultiplayerLimitTypeCheck(e, !1)))
  }
  xka() {
    !this.U6a() || this.IsPortalPrepared || (Log_1.Log.CheckDebug() && Log_1.Log.Debug("SceneItem", 39, "无画面传送门: PreparePortal Success", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe], ["PlaneTransform", this.ActorComp?.ActorTransform]), this.IsPortalPrepared = !0)
  }
  R6a() {
    this.IsPortalPrepared && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("SceneItem", 39, "无画面传送门: UnPreparePortal Success", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]), this.IsPortalPrepared = !1)
  }
  CanConnectPortal() {
    var e;
  ...
  LIl() {
    var e, t, r;
    this.CanConnectPortal() && !this.IsPortalConnected && (e = ModelManager_1.ModelManager.CreatureModel?.GetEntityByPbDataId(this.TIl))?.Valid && (t = e.Entity.GetComponent(0).GetCreatureDataId(), r = e.Entity.GetComponent(216), this.SetTargetCreatureDataId(t), r?.SetTargetCreatureDataId(this.GetCreatureDataId()), this.AfterConnectPair(), r?.AfterConnectPair(), EventSystem_1.EventSystem.HasWithTarget(e, EventDefine_1.EEventName.RemoveEntity, this._ln) || EventSystem_1.EventSystem.AddWithTargetUseHoldKey(this, e, EventDefine_1.EEventName.RemoveEntity, this._ln))
  }
  RIl() {
    var e;
    this.IsPortalConnected && (e = (ModelManager_1.ModelManager.CreatureModel?.GetEntityByPbDataId(this.TIl)?.Entity)?.GetComponent(216), this.SetTargetCreatureDataId(0), e?.SetTargetCreatureDataId(0), this.AfterDisconnectPair(), e?.AfterDisconnectPair())
  }
  AfterConnectPair() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("SceneItem", 39, "无画面传送门: AfterConnectPair", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]), this.IsPortalConnected = !0, this.Nla()
  }
  AfterDisconnectPair() {
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("SceneItem", 39, "无画面传送门: AfterDisconnectPair", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]), this.IsPortalConnected = !1, this.tTa()
  }
  GetTriggerActor() {
  ...
  GetTeleportToSelfTransformProxy() {
    ...
    if (e) {
      ...
      if (t) return this.Rd_ || (this.Rd_ = Transform_1.Transform.Create()), this.Rd_.SetScale3D(Vector_1.Vector.OneVectorProxy), this.Rd_.GetLocation().FromConfigVector(t), this.Rd_.SetRotation(e.K2_GetActorRotation().Quaternion()), this.Rd_
    }
  }
  Nla() {
    var e = this.GetTriggerActor(),
      t = this.GetTriggerComp();
    e && t && (t.SetUseCCD(!0), e.OnActorBeginOverlap.Add((e, t) => {
      this.Fla(t)
    }))
  }
  tTa() {
  ...
  Fla(e) {
    ...
    if (t && (e === t || e instanceof UE.BP_BaseItem_C))
      if (SceneItemNoRenderPortalComponent_1.P6a.has(e)) Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: actor正在传送中，不允许重复触发", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]);
      else {
            ...
            if (o)
              if (this.Dll(e, e === t)) {
                if (r?.Valid) {
                  ...
                  if (o && o.CurrentState instanceof SceneItemManipulableCastProjectileState_1.SceneItemManipulatableCastProjectileState) return
                }
                e !== this.ActorComp?.Owner && this.g4a(e, e === t)
              } else Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: 无法安全通过传送门，忽略", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]);
            else Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: 不满足过门条件组，忽略", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe])
          } else(o = r?.Entity?.GetComponent(156)) && o.CurrentState instanceof SceneItemManipulableCastState_1.SceneItemManipulableCastState && (t = o.CurrentState).HasHitCallback() && t.CallHitCallback(e, this.ActorComp?.Owner), Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: 不是从正面进入传送门，忽略", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe])
        }
      }
  }
  g4a(r, o) {
    if (!SceneItemNoRenderPortalComponent_1.P6a.has(r)) {
      Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: BeforeTeleport", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe], ["ActorPos", Vector_1.Vector.Create(r?.D_GetTransform().GetLocation())], ["ActorRot", Rotator_1.Rotator.Create(r?.D_GetTransform().Rotator())]);
        ...
        if (o) {
          ...
          if (l?.Valid) {
            var _ = i?.R0n?.Config.GravityConfig?.GravityDirection,
              _ = GravityUtils_1.GravityUtils.GetGravityDirectionByConfigAndActor(_, i?.ActorComp);
            ...
            if (!t) {
              ...
              var c = Vector_1.Vector.Create(h.Velocity),
                ...
                h = (h.Multiply(m, MathUtils_1.MathUtils.CommonTempVector), c.AdditionEqual(MathUtils_1.MathUtils.CommonTempVector), r.D_GetActorForwardVector()),
                m = this.GetTriggerActor().D_GetActorForwardVector().op_Multiply(-1);
              let e = m;
              0 < MathUtils_1.MathUtils.DotProduct(m, c) ? e = c : 0 < MathUtils_1.MathUtils.DotProduct(m, h) && (e = h), t = PortalUtils_1.PortalUtils.GetMappingOffsetTransformByPortalTransform(n, a, s, _, e, PORTAL_TELEPORT_OFFSET)
            }
            const v = new NoRenderPortalTeleportParam(r, o, this, t);
            v.AfterTeleportGravityDirect = _;
            c = l.Entity?.GetComponent(67);
            c && (m = c.GetEnableMovementSync(), v.OriginEnableMovementSync = m) && c.SetEnableMovementSync(!1, "无画面传送门: 传送开始"), SceneItemNoRenderPortalComponent_1.P6a.add(r), this.p4a(v)
          } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("SceneItem", 7, "无画面传送门: 失败,找不到当前玩家角色")
        } else {
      ...
      } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("SceneItem", 39, "无画面传送门: 失败,传送门Transform不合法")
    }
  }
  p4a(e) {
    ...
    if (Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: ExecTeleport", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe], ["ActorPos", e.OtherActor?.D_GetTransform().GetLocation()], ["ActorRot", e.OtherActor?.D_GetTransform().Rotator()], ["TargetPos", t], ["TargetRot", r], ["TargetGravityDirect", o]), e.IsRole)
      if (this.v4a(e), TeleportController_1.TeleportController.QueryCanTeleportNoLoading(t, !0)) SceneItemNoRenderPortalComponent_1.PlayNoLoadingPassPortalEffects(this.R0n?.Config.TeleportSceneEffect?.ScreenEffectPath, this.R0n?.Config.TeleportSceneEffect?.WorldEffectPath, NO_LOADING_SCREEN_EFFECT_MAX_INTERVAL), ModelManager_1.ModelManager.TeleportModel.TeleportMode = 4, TeleportController_1.TeleportController.TeleportToPositionWithGravityNoLoading(t, r, o, "无画面传送门传送", !0, !0).finally().finally(() => {
        this.f4a(e)
      });
      else {
        ...
        switch (i.p5n) {
          ...
          case Protocol_1.Aki.Protocol.p5n.Proto_Seamless:
            ModelManager_1.ModelManager.TeleportModel.TeleportMode = 4, ModelManager_1.ModelManager.TeleportModel.SeamlessEndHandle && (TimerSystem_1.TimerSystem.Remove(ModelManager_1.ModelManager.TeleportModel.SeamlessEndHandle), ModelManager_1.ModelManager.TeleportModel.SeamlessEndHandle = void 0), ModelManager_1.ModelManager.TeleportModel.SeamlessConfig = new SeamlessTravelDefine_1.SeamlessTravelContext, ModelManager_1.ModelManager.TeleportModel.SeamlessConfig.ParseConfig(i.R$s);
            break;
        ...
        var a = new TeleportDefine_1.TeleportContext(Protocol_1.Aki.Protocol.v4s.Xvs, void 0, void 0, void 0, i);
  ...
  f4a(e) {
    var t;
    Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: AfterTeleport", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe], ["ActorPos", Vector_1.Vector.Create(e.OtherActor?.D_GetTransform().GetLocation())], ["ActorRot", Rotator_1.Rotator.Create(e.OtherActor?.D_GetTransform().Rotator())]), e.IsRole && ((t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity)?.Valid ? e.OriginEnableMovementSync && (t?.Entity?.GetComponent(67))?.SetEnableMovementSync(!0, "无画面传送门: 传送完成") : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Teleport", 7, "无画面传送门:失败,找不到当前玩家角色")), TimerSystem_1.TimerSystem.Next(() => {
  ...
  v4a(e) {
    if (e.AfterTeleportTransform) {
      ...
      LevelGeneralNetworks_1.LevelGeneralNetworks.RequestClientTeleportByNoRenderPortal(t, r, o, e => {
        e && e.Q4n === Protocol_1.Aki.Protocol.Q4n.KRs || Log_1.Log.CheckError() && Log_1.Log.Error("SceneItem", 39, "无画面传送门: RequestRolePassPortal请求失败", ["ConfigId", t], ["Location", r], ["Rotation", o], ["Code", e?.Q4n])
      })
    } else Log_1.Log.CheckError() && Log_1.Log.Error("SceneItem", 39, "无画面传送门: RequestRolePassPortal获取Transform出错", ["ConfigId", this.wDe])
  }
  dIa(e) {
    var t, r, o = this.GetTriggerActor();
  ...
  Ull(e) {
    var t, r, o, i = this.GetTriggerActor();
  ...
  Dll(t, r) {
    ...
    if (r) {
      ...
      var i = o?.R0n?.Config.GravityConfig?.GravityDirection,
        i = GravityUtils_1.GravityUtils.GetGravityDirectionByConfigAndActor(i, o?.ActorComp);
      ...
      if (!e) return !1;
      this.Rll(e.GetLocation(), e.GetLocation(), void 0, t.CharacterActorComponent) && (Log_1.Log.CheckInfo() && Log_1.Log.Info("SceneItem", 39, "无画面传送门: 检查到玩家出门位置有碰撞，有穿地风险", ["CreatureDataId", this.Wpo], ["PbDataId", this.wDe]), ModelManager_1.ModelManager.SundryModel?.GetModuleDebugLevel(PORTAL_DEBUG_KEY)) && ScrollingTipsController_1.ScrollingTipsController.ShowTipsByText("无画面传送门: 检查到玩家出门位置有碰撞，有穿地风险")
    }
    return !0
  }
  lFl(e) {
    var t, r = this.R0n?.Config.Condition;
...
SceneItemNoRenderPortalComponent.DIl = void 0, SceneItemNoRenderPortalComponent.AIl = void 0, SceneItemNoRenderPortalComponent.xIl = void 0, SceneItemNoRenderPortalComponent.P6a = new Set, SceneItemNoRenderPortalComponent = SceneItemNoRenderPortalComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(216)], SceneItemNoRenderPortalComponent), exports.SceneItemNoRenderPortalComponent = SceneItemNoRenderPortalComponent;
