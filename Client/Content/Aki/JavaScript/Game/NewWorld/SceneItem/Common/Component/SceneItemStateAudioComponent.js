...
let SceneItemStateAudioComponent = SceneItemStateAudioComponent_1 = class SceneItemStateAudioComponent extends EntityComponent_1.EntityComponent {
  ...
  OnStart() {
    var t;
    this.cen = this.Entity.GetComponent(133);
    if (!this.cen) {
  ...
  o_n(t, i) {
    ...
    if (this.N1n.Type === IComponent_1.EAkEventType.Default && t) {
      if ((e = this.Entity?.GetComponent(202)?.Owner)?.IsValid()) {
...
SceneItemStateAudioComponent = SceneItemStateAudioComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(131)], SceneItemStateAudioComponent);
