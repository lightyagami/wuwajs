...
let SceneItemTimeScaleComponent = class SceneItemTimeScaleComponent extends PawnTimeScaleComponent_1.PawnTimeScaleComponent {
  ...
  OnStart() {
    return !!super.OnStart() && (this.TimeScaleList.Empty && this.SetTimeScaleTicking(false, "[SceneItemTimeScaleComponent] OnStart, 初始关闭时间缩放"), this.Xte = this.Entity.GetComponent(208), true);
  }
  ...
  OnTick(e) {
    ...
    this.Entity.GetComponent(214)?.UpdateAkFinalTimeScale(i);
  ...
  OnChangeTimeDilation(t) {
    ...
    if (this.EIe && LevelGeneralNetworks_1.LevelGeneralNetworks.CheckEntityCanPushTimeDilation(this.EIe.GetEntityTimeScaleModifyStrategy())) {
      ...
      t = this.Entity.GetComponent(313);
...
SceneItemTimeScaleComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(216)], SceneItemTimeScaleComponent);
