...
let SceneItemResetPositionComponent = SceneItemResetPositionComponent_1 = class SceneItemResetPositionComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.rtn = (t, e) => {
      var i;
      if (!this.MMn) {
        if ((e = this.ftn(e))?.Valid && (!(i = e.Entity.GetComponent(214)) || i.IsReadyForOverlap && i.Active) && this.wS && (i = e.Entity.GetComponent(0)?.GetPbDataId() ?? 0, this.wS.includes(i)) && !this.vMn.includes(i)) {
    ...
    this.itn = (t, e, i, s) => {
      var o;
      if (!this.MMn) {
        if ((e = this.ftn(e))?.Valid && (!(o = e.Entity.GetComponent(214)) || o.IsReadyForOverlap && o.Active) && this.wS && (o = e.Entity.GetComponent(0)?.GetPbDataId() ?? 0, this.wS.includes(o)) && !this.vMn.includes(o)) {
          LevelGamePlayController_1.LevelGamePlayController.OnManipulatableItemExitAreaInternal(e, undefined, this.Entity.GetComponent(0).GetCreatureDataId());
        }
      }
    };
...
SceneItemResetPositionComponent = SceneItemResetPositionComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(176)], SceneItemResetPositionComponent);
