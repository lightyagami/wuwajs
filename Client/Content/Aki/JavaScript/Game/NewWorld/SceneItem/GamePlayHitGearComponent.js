...
let GamePlayHitGearComponent = GamePlayHitGearComponent_1 = class GamePlayHitGearComponent extends EntityComponent_1.EntityComponent {
  ...
  OnStart() {
    ...
    this.Jun = this.Entity.GetComponent(163);
    this.Jun.RegisterComponent(this, this.Lo);
    this._pn = this.Entity.GetComponent(70);
    ...
    if (this._Pl && !(this._Pl.size <= 0)) {
      ...
      if (t) {
        ...
        for (var [i, o] of this._Pl) {
          ...
          var n = i.Entity?.GetComponent(215);
          if (n) {
...
GamePlayHitGearComponent = GamePlayHitGearComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(149)], GamePlayHitGearComponent);
