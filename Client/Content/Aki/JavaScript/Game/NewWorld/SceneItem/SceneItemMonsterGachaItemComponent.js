"use strict";
var SceneItemMonsterGachaItemComponent_1, __decorate = this && this.__decorate || function(e, t, n, r) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) i = Reflect.decorate(e, t, n, r);
    ...
    for (var s = e.length - 1; 0 <= s; s--)(o = e[s]) && (i = (a < 3 ? o(i) : 3 < a ? o(t, n, i) : o(t, n)) || i);
...
let SceneItemMonsterGachaItemComponent = SceneItemMonsterGachaItemComponent_1 = class SceneItemMonsterGachaItemComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.Lo = void 0, this.Hte = void 0, this.Rnn = () => {
  ...
  OnStart() {
    return this.Hte = this.Entity.GetComponent(202), EventSystem_1.EventSystem.OnceWithTarget(this.Entity, EventDefine_1.EEventName.OnSceneInteractionLoadCompleted, this.Rnn), !0
  }
};
SceneItemMonsterGachaItemComponent = SceneItemMonsterGachaItemComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(157)], SceneItemMonsterGachaItemComponent), exports.SceneItemMonsterGachaItemComponent = SceneItemMonsterGachaItemComponent;
