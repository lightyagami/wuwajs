...
class TsSimpleInteractHookPoint extends TsSimpleInteractBase_1.default {
  ...
  OnDraw() {
    ...
    UE.KismetSystemLibrary.D_DrawDebugArrow(this, t, e.TransformPosition(forwardOffset), DEFAULT_ARROW_SIZE, redColor, DRAW_TIME, DEFAULT_THICKNESS), UE.KismetSystemLibrary.D_DrawDebugArrow(this, t, e.TransformPosition(upOffset), DEFAULT_ARROW_SIZE, blueColor, DRAW_TIME, DEFAULT_THICKNESS)
  }
  SetText(t) {
    this.Text.HorizontalAlignment = 1, this.Text.SetWorldSize(TEXT_SIZE), this.Text.SetTextRenderColor(textColor), this.Text.Text = "HookPoint " + this.TypeId
  }
  OnGetBestTransform(t, e, s, i) {
    return this.ActorLocation.FromUeVector(t.D_K2_GetActorLocation()), this.ActorLocation.Subtraction(this.SelfLocation, this.SelfToActor), this.TmpVector1.X = i, this.TmpVector1.Y = 0, this.TmpVector1.Z = 0, this.TmpLocation || (this.TmpLocation = Vector_1.Vector.Create()), this.SelfTransform.TransformPosition(this.TmpVector1, this.TmpLocation), this.TmpResult.Location = this.TmpLocation.ToUeVectorOld(), this.LineTrace.WorldContextObject = t, TraceElementCommon_1.TraceElementCommon.SetStartLocation(this.LineTrace, this.ActorLocation), TraceElementCommon_1.TraceElementCommon.SetEndLocation(this.LineTrace, this.TmpResult.Location), this.TmpResult.Success = !TraceElementCommon_1.TraceElementCommon.LineTrace(this.LineTrace, PROFILE_KEY), this.LineTrace.WorldContextObject = void 0, this.TmpResult.Success, this.TmpResult
  }
}
