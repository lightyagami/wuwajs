...
class TsSimpleInteractPoint extends TsSimpleInteractBase_1.default {
  constructor() {
    super(...arguments), this.OnWall = !0, this.OutRotator = void 0, this.TmpLocation = void 0
  }
  Constructor() {
    super.Constructor(), this.OutRotator = void 0, this.TmpLocation = void 0
  }
  OnBeginPlay() {
    this.OutRotator = Rotator_1.Rotator.Create(), this.TmpLocation = Vector_1.Vector.Create(), super.OnBeginPlay()
  }
  CheckLegal() {
    return !0
  }
