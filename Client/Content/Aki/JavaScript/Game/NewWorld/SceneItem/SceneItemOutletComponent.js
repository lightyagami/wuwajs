...
let SceneItemOutletComponent = SceneItemOutletComponent_1 = class SceneItemOutletComponent extends EntityComponent_1.EntityComponent {
        ...
        if (t) {
          if (!this.qVs && e.GetComponent(0)?.GetBaseInfo()) {
            ...
            if (t.Condition.EntityMatch === undefined || this.YCa(t.Condition.EntityMatch, e)) {
              ...
              if (e.GetComponent(1) && (i = e.GetComponent(165))) {
  ...
  OnActivate() {
    if (this.Config.Config.Type === IComponent_1.EItemFoundation.BuildingBlock || this.Config.Config.Type === IComponent_1.EItemFoundation.PulseDevice) {
      this.bvn = this.Entity.GetComponent(146);
      if (!this.bvn) {
        return false;
      }
    } else if (this.Config.Config.Type === IComponent_1.EItemFoundation.RangeAdsorption) {
  ...
  CheckRangeAdsorptionMatchManipulatable(t) {
    ...
    if (e.Condition.EntityMatch) {
      ...
      if (e.Condition.SelfState) {
        ...
        e = this.Entity.GetComponent(206);
        if (!e) {
          return false;
        }
        if (!e.HasTag(t)) {
  ...
  YCa(t, e) {
    ...
    if (t.State?.State && !e.GetComponent(206)?.ContainsTagByName(t.State.State)) {
      return false;
    }
  ...
  Kpn(t) {
    ...
    var n = t.GetComponent(212);
    const r = t.GetComponent(165);
  ...
  fza(t) {
    ...
    var s = t.GetComponent(147);
    var a = t.GetComponent(212);
    ...
    Net_1.Net.Call(15835, e, t => {
      if (t.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.G9n, 21037);
      }
    });
  }
  GetType() {
...
SceneItemOutletComponent = SceneItemOutletComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(170)], SceneItemOutletComponent);
