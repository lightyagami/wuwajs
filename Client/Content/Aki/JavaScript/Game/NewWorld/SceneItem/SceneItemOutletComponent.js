...
let SceneItemOutletComponent = SceneItemOutletComponent_1 = class SceneItemOutletComponent extends EntityComponent_1.EntityComponent {
        ...
        if (t) {
          if (!this.qVs && e.GetComponent(0)?.GetBaseInfo()) {
            ...
            if (t.Condition.EntityMatch === undefined || this.YCa(t.Condition.EntityMatch, e)) {
              ...
              if (e.GetComponent(1) && (i = e.GetComponent(167))) {
  ...
  OnActivate() {
    if (this.Config.Config.Type === IComponent_1.EItemFoundation.BuildingBlock || this.Config.Config.Type === IComponent_1.EItemFoundation.PulseDevice) {
      this.bvn = this.Entity.GetComponent(148);
      if (!this.bvn) {
        return false;
      }
    } else if (this.Config.Config.Type === IComponent_1.EItemFoundation.RangeAdsorption) {
  ...
  CheckRangeAdsorptionMatchManipulatable(t) {
    ...
    if (e.Condition.EntityMatch) {
      ...
      if (e.Condition.SelfState) {
        ...
        e = this.Entity.GetComponent(208);
        if (!e) {
          return false;
        }
        if (!e.HasTag(t)) {
  ...
  YCa(t, e) {
    ...
    if (t.State?.State && !e.GetComponent(208)?.ContainsTagByName(t.State.State)) {
      return false;
    }
  ...
  Kpn(t) {
    ...
    var n = t.GetComponent(214);
    const r = t.GetComponent(167);
  ...
  fza(t) {
    ...
    var s = t.GetComponent(149);
    var a = t.GetComponent(214);
    ...
    Net_1.Net.Call(21896, e, t => {
      if (t.G9n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.G9n, 29931);
      }
    });
  }
  GetType() {
...
SceneItemOutletComponent = SceneItemOutletComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(172)], SceneItemOutletComponent);
