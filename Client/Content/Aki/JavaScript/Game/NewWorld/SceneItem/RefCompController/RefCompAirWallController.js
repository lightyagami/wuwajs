...
class RefCompAirWallController extends RefCompControllerBase_1.RefCompControllerBase {
  ...
  OnStart() {
    this.$dd = UE.NewObject(UE.TraceLineElement.StaticClass());
    this.$dd.bIsSingle = true;
    this.$dd.bIgnoreSelf = true;
    this.$dd.AddObjectTypeQuery(QueryTypeDefine_1.KuroObjectTypeQuery.WorldStatic);
    this.$dd.AddObjectTypeQuery(QueryTypeDefine_1.KuroObjectTypeQuery.WorldStaticIgnoreBullet);
    this.$dd.SetTraceTypeQuery(QueryTypeDefine_1.KuroTraceTypeQuery.AcrossBlock);
  }
  OnEnd() {
    this.cMn();
    if (this.Yvn) {
  ...
  cMn() {
    if (this.Jvn?.length) {
      for (const t of this.Jvn) {
        ...
        if (e?.IsValid() && (RefCompAirWallController.Rsd(e), e.SetActorEnableCollision(false), EventSystem_1.EventSystem.HasWithTarget(e, EventDefine_1.EEventName.BulletHitAirWall, this.PKs))) {
  ...
  Wdd(e, t) {
    return !!this.$dd && (ModelManager_1.ModelManager.SundryModel.GetModuleDebugLevel(LOG_CATEGORY) >= 4 && UE.KismetSystemLibrary.D_DrawDebugArrow(Global_1.Global.BaseCharacter, e.ToUeVector(), t.ToUeVector(), 50, ColorUtils_1.ColorUtils.LinearBlue, DEBUG_DRAW_TIME), this.$dd.WorldContextObject = Global_1.Global.BaseCharacter, TraceElementCommon_1.TraceElementCommon.SetStartLocation(this.$dd, e), TraceElementCommon_1.TraceElementCommon.SetEndLocation(this.$dd, t), TraceElementCommon_1.TraceElementCommon.LineTrace(this.$dd, "NoAirWallBetweenTeamItemAndManager")) && (this.$dd.HitResult?.bBlockingHit ?? false);
  }
  Qdd(t, i) {
    if (t) {
              ...
              if (!l.IsControl()) {
                ...
                if (o) {
                  ...
                  if (r && r.GetTeamState() === 1) {
                    ...
                    if (!MathUtils_1.MathUtils.IsInsideBoxSphereBounds(t, r.ToUeVectorOld()) || this.Wdd(e, r)) {
        ...
        if ((l = this.ActorSubsystem.GetActor(r))?.IsValid() && l.IsA(UE.Brush.StaticClass())) {
          ...
          if (i) {
            ...
            if (t.Type === 1 && RefCompAirWallController.EnableTeleportIntoAirWall) {
              _.OnComponentHit.Add(RefCompAirWallController.Lsd.bind(undefined, t.EntityId));
            }
  ...
  Ivl(t, e, i) {
    RefCompAirWallController.Rsd(t);
...
RefCompAirWallController.Lsd = (e, t, i, o, r, l) => {
