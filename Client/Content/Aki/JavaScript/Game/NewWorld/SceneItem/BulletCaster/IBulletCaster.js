...
class BulletCasterInitParam {
  constructor(t, s, e, i, r) {
    this.OwnerEntity = t, this.CasterConfig = s, this.CasterRelTransform = e, this.BulletContextId = i, this.WarningEffect = r
  }
}
exports.BulletCasterInitParam = BulletCasterInitParam;
class BulletCasterBase {
  constructor(t) {
    this.BulletCasterInitParam = t, this.OwnerEntity = void 0, this.CasterConfig = void 0, this.CasterRelTransform = void 0, this.BulletContextId = BigInt(0), this.WarningEffect = "", this.sCl = [], this.OwnerEntity = t.OwnerEntity, this.CasterConfig = t.CasterConfig, this.CasterRelTransform = t.CasterRelTransform, this.BulletContextId = t.BulletContextId, this.WarningEffect = t.WarningEffect
  }
  Start() {
    var t;
    !this.CasterConfig.DelayTime || this.CasterConfig.DelayTime <= TimerSystem_1.MIN_TIME ? this.StartImmediately() : (t = TimerSystem_1.TimerSystem.Delay(() => {
      this.sCl.pop(), this.StartImmediately()
    }, this.CasterConfig.DelayTime)) && this.sCl.push(t), this.SetTimeDilationRespectOwnerEntity(), this.OnStart()
  }
  Stop() {
