...
class BulletCasterClassFactory {
  static GetInstance(t, s) {
    if (BulletCasterClassFactory.Rec.has(t)) return new(BulletCasterClassFactory.Rec.get(t))(s)
  }
  static Register(s) {
    return function(t) {
      BulletCasterClassFactory.Rec.has(s) || BulletCasterClassFactory.Rec.set(s, t)
    }
  }
