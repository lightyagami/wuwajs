...
let SceneItemGroupAiComponent = class SceneItemGroupAiComponent extends EntityComponent_1.EntityComponent {
  ...
  ePl(e = false) {
    for (const o of this.Bih) {
      ...
      if (t &&= ModelManager_1.ModelManager.CreatureModel?.GetEntityById(t)?.Entity?.GetComponent(217)) {
        if (e) {
...
SceneItemGroupAiComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(285)], SceneItemGroupAiComponent);
