...
let SceneItemGroupAiComponent = class SceneItemGroupAiComponent extends EntityComponent_1.EntityComponent {
  ...
  ePl(e = false) {
    for (const o of this.Bih) {
      ...
      if (t &&= ModelManager_1.ModelManager.CreatureModel?.GetEntityById(t)?.Entity?.GetComponent(205)) {
        if (e) {
...
SceneItemGroupAiComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(257)], SceneItemGroupAiComponent);
