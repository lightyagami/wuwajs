...
class LogicDataManipulatableCreateBullet extends LogicDataBase_1.default {
  constructor() {
    super(...arguments), this.ExistTagsCondition = void 0, this.UnExistTagsCondition = void 0, this.BulletOwner = 0, this.CreateBulletRowName = void 0, this.BulletTransform = 0
  }
  Constructor() {
    super.Constructor()
  }
