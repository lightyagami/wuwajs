...
class LogicDataCreateBullet extends LogicDataBase_1.default {
  constructor() {
    super(...arguments), this.BulletOwner = 0, this.CreateBulletRowName = "None", this.BulletTransform = 0, this.AttachToActor = 0, this.AttachToBoneName = "None", this.FlashBulletRowName = "None"
  }
  Constructor() {
    super.Constructor()
  }
