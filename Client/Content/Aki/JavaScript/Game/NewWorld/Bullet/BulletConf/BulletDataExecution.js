...
class BulletDataExecution {
  constructor(t) {
    this.Pe = void 0, this.Y6o = !1, this.J6o = void 0, this.MovementReplaced = !1, this.ReboundBitMask = 0, this.SupportCamp = void 0, this.HasReboundInternal = !1, this.hn_ = void 0, this.Hp1 = void 0, this.$p1 = !1, this.z6o = void 0, this.Z6o = void 0, this.e8o = void 0, this.t8o = void 0, this.i8o = void 0, this.o8o = void 0, this.r8o = void 0, this.n8o = void 0, this.s8o = void 0, this.Pe = t
  }
  get GbDataList() {
      ...
      if (t && 0 < t.length && "None" !== t) {
        ...
        if (0 < e) {
          ...
          for (let t = this.ReboundBitMask = 0; t < e; t++) {
            var s = i.Get(t);
            this.J6o.push(s), !this.HasReboundInternal && s instanceof LogicDataRebound_1.default && (this.HasReboundInternal = !0)
          }
        }
      }
    }
  ...
  get SendGameplayEventTagToVictim() {
    return void 0 === this.Z6o && (this.Z6o = this.Pe.命中后对受击者发射GameplayEvent标签), this.Z6o
  }
  ...
  get SendGameplayEventTagToAttacker() {
    return void 0 === this.i8o && (this.i8o = this.Pe.命中后对攻击者发射GameplayEvent标签), this.i8o
  }
  ...
  get SendGameplayEventTagToAttackerOnEnd() {
    return void 0 === this.r8o && (this.r8o = this.Pe.结束时对攻击者发射GameplayEvent标签), this.r8o
  }
  ...
  get SendGameplayEventTagToAttackerOnStart() {
    return void 0 === this.s8o && (this.s8o = this.Pe.生成时对攻击者发射GameplayEvent标签), this.s8o
  }
  Preload() {
