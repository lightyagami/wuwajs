...
class BulletDataScale {
  constructor(t) {
    this.M9o = void 0, this.E9o = void 0, this.S9o = !1, this.y9o = void 0, this.Pe = t
  }
  get SizeScale() {
    return this.M9o || (this.M9o = Vector_1.Vector.Create(this.Pe.缩放倍率)), this.M9o
  }
  get ScaleCurve() {
    return this.S9o || (this.S9o = !0, this.E9o = this.Pe.缩放倍率曲线), this.E9o
  }
  get ShapeSwitch() {
