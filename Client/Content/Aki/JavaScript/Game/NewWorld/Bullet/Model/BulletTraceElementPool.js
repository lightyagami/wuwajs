...
class BulletTraceElementPool {
  ...
  static Ljo(e, t, r, l, a) {
    if (0 < t.length) {
      ...
      return Info_1.Info.IsBuildDevelopmentOrDebug && (t = ModelManager_1.ModelManager.BulletModel.ShowBulletTrace(l), n.SetDrawDebugTrace(t ? 2 : 0), t) && (TraceElementCommon_1.TraceElementCommon.SetTraceColor(n, ColorUtils_1.ColorUtils.LinearGreen), TraceElementCommon_1.TraceElementCommon.SetTraceHitColor(n, ColorUtils_1.ColorUtils.LinearRed)), n
    }
  ...
  static NewTraceElementByTraceChannel(e, t, r = !1) {
    e = UE.NewObject(e);
    return e.WorldContextObject = GlobalData_1.GlobalData.World, e.SetTraceTypeQuery(t), e.bTraceComplex = !1, e.bIgnoreSelf = !0, e.bIsSingle = r, e
  }
  static Clear() {
    this.Djo.length = 0, this.Rjo.length = 0, this.Ujo.length = 0
  }
}(exports.BulletTraceElementPool = BulletTraceElementPool).Djo = new Array, BulletTraceElementPool.Rjo = new Array, BulletTraceElementPool.Ujo = new Array;
