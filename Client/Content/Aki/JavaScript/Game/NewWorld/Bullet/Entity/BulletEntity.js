...
class BulletEntity extends Entity_1.Entity {
  constructor() {
    super(...arguments), this.UsePool = !0, this.LAe = new BulletInfo_1.BulletInfo
  }
  ...
  OnCreate() {
    return !!this.AddComponent(BulletActorComponent_1.BulletActorComponent) && !!this.AddComponent(BulletActionLogicComponent_1.BulletActionLogicComponent) && (this.RegisterToGameBudgetController(void 0), !0)
  }
  OnStart() {
