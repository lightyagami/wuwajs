...
class BulletBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetSpecialBulletToSkillId(t, e) {
    return "" !== e ? e : (e = CharacterBuffIds_1.specialBulletToSkillIdMap.get(t)) ? e.toString() : ""
  }
  static CreateBulletFromGA(t, e, r, l, a = !0, o = void 0) {
    var i, l = BulletBlueprintFunctionLibrary.GetSpecialBulletToSkillId(e, l);
    return "" === l ? (Log_1.Log.CheckError() && Log_1.Log.Error("Bullet", 35, "CreateBulletFromGA的SkillId为空", ["bullet", e]), -1) : (i = BulletUtil_1.BulletUtil.GetSkillContextId(t.GetEntityNoBlueprint(), Number(l)), (e = BulletController_1.BulletController.CreateBulletCustomTarget(t, e, r, {
      SkillId: Number(l),
      SkillContextId: i,
      SyncType: a ? 1 : 0,
  ...
  static GetBulletActorById(t) {
    ...
    if (t?.Valid) return t.GetComponent(169).Owner
  }
  ...
  static SetBulletSummon(t) {
    BulletBlueprintFunctionLibrary.GetBulletInfo(t)?.ChildInfo?.SetIsActiveSummonChildBullet(!0)
  }
  ...
  static CalSectorPoints(e, t, r, l, a, o, i) {
    t.Normalize(MathCommon_1.MathCommon.SmallNumber), r.Normalize(MathCommon_1.MathCommon.SmallNumber);
    var u = 0 < o ? l / o : l;
  ...
  static CalcPipe(t, e, r, l, a, o, i, u, n) {
    e.Normalize(MathCommon_1.MathCommon.SmallNumber), r.Normalize(MathCommon_1.MathCommon.SmallNumber);
    var c = Vector_1.Vector.Create(r),
      ...
      _ = (BulletBlueprintFunctionLibrary.CalSectorPoints(t.ToUeVectorOld(), e, r, 360, a, i, o), o.Num()),
      C = (BulletBlueprintFunctionLibrary.CalSectorPoints(t.ToUeVectorOld(), e, r, 360, l, i, o), o.Num()),
      m = (BulletBlueprintFunctionLibrary.CalSectorPoints(s.ToUeVectorOld(), e, r, 360, a, i, o), o.Num());
    ...
    for (let t = 0; t < _ - 1; t++) {
      var M = C + t,
        ...
        y = m + t,
        h = m + t + 1;
      BulletBlueprintFunctionLibrary.RectangleTriangles(M, y, b, h, B), M = 0 + t + 1, b = 0 + t, y = _ + t + 1, h = _ + t, BulletBlueprintFunctionLibrary.RectangleTriangles(M, y, b, h, B), M = 0 + t, b = 0 + t + 1, y = C + t, h = C + t + 1, BulletBlueprintFunctionLibrary.RectangleTriangles(M, y, b, h, B), M = _ + t + 1, b = _ + t, y = m + t + 1, h = m + t, BulletBlueprintFunctionLibrary.RectangleTriangles(M, y, b, h, B)
    }
  }
  static CircleTriangles(e, r, l, a, o) {
    for (let t = r; t < l; t++) a ? (o.Add(e), o.Add(t + 1), o.Add(t)) : (o.Add(e), o.Add(t), o.Add(t + 1))
  }
  static CalcSector(t, e, r, l, a, o, i, u, n) {
    e.Normalize(MathCommon_1.MathCommon.SmallNumber), r.Normalize(MathCommon_1.MathCommon.SmallNumber);
    var u = (0, puerts_1.$unref)(u),
      c = (0, puerts_1.$unref)(n),
      n = l > MathCommon_1.MathCommon.RoundAngle ? MathCommon_1.MathCommon.RoundAngle : l,
      l = t.op_Subtraction(r.op_Multiply(o)),
      t = t.op_Addition(r.op_Multiply(o)),
      s = (u.Add(l), BulletBlueprintFunctionLibrary.CalSectorPoints(l, e, r, n, a, i, u), u.Num() - 1),
      B = u.Num(),
      o = (u.Add(t), BulletBlueprintFunctionLibrary.CalSectorPoints(t, e, r, n, a, i, u), u.Num() - 1);
    BulletBlueprintFunctionLibrary.CircleTriangles(0, 1, s, !1, c), BulletBlueprintFunctionLibrary.CircleTriangles(B, B + 1, o, !0, c), MathUtils_1.MathUtils.IsNearlyEqual(n, MathCommon_1.MathCommon.RoundAngle) || (BulletBlueprintFunctionLibrary.RectangleTriangles(1, B + 1, 0, B, c), BulletBlueprintFunctionLibrary.RectangleTriangles(0, B, s, o, c));
    for (let t = 1; t < s; t++) {
      var _ = t,
        C = t + 1,
        m = B + _,
  ...
  static CalcBulletInitLocation(a, o, i) {
    ...
    if (Rotator_1.Rotator.Create(0, 90, 0).Quaternion(o), u.SetRotation(o.ToUeQuat()), 3 === a.移动设置.运动轨迹类型) {
      let t = void 0,
        e = 0,
        r = void 0;
      r = 0 === a.移动设置.运动轨迹参数目标 || 6 === a.移动设置.运动轨迹参数目标 || 1 === a.移动设置.运动轨迹参数目标 ? (t = u.GetLocation(), e = u.Rotator().Yaw, u.GetRotation().GetForwardVectorDouble()) : (t = i.GetLocation(), e = i.GetRotation().Rotator().Yaw, i.GetRotation().VectorDouble());
      o = a.移动设置.运动轨迹参数数据.Get(0);
      let l = r.RotateAngleAxis(o.Y, Vector_1.Vector.UpVectorDouble);
      return l.Z = -Math.sin((e + o.Y) * MathCommon_1.MathCommon.DegToRad) * Math.tan(o.Z * MathCommon_1.MathCommon.DegToRad), l.Normalize(MathCommon_1.MathCommon.SmallNumber), l = (l = l.op_Multiply(o.X)).op_Addition(t)
    }
    var t = Vector_1.Vector.Create(),
      e = Vector_1.Vector.Create();
    switch (e.FromUeVector(a.基础设置.出生位置偏移), a.基础设置.出生位置基准) {
      case 0:
      case 6:
  ...
  static AttachToBone(t, e, r) {
    var l = r.移动设置.子弹跟随类型;
    0 === l ? e.K2_AttachToComponent(t, r.移动设置.骨骼名字, 1, 1, 1, !0) : 3 === l && (e.K2_AttachToComponent(t, r.移动设置.骨骼名字, 1, 1, 1, !0), l = UE.KismetMathLibrary.Conv_VectorToVectorDouble(r.基础设置.出生位置偏移), e.D_K2_SetActorRelativeLocation(l, !1, void 0, !1), e.K2_SetActorRelativeRotation(Rotator_1.Rotator.ZeroRotator, !1, void 0, !0))
  }
  static CalcBulletInitRotator(t, e, r, l, a) {
    ...
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Bullet", 20, "CalcBulletInitRotator", ["ret", o]), o.ToUeRotator()
  }
    ...
    switch (e.移动设置.运动轨迹类型) {
      ...
      case 3: {
        var u = e.移动设置.运动轨迹参数数据.Get(0),
          n = e.移动设置.移动速度 * o * MathCommon_1.MathCommon.RadToDeg / u.X;
        i.Set(0, Math.sin(u.Z * MathCommon_1.MathCommon.DegToRad), Math.cos(u.Z * MathCommon_1.MathCommon.DegToRad));
        let t = void 0;
        u = (t = 0 === e.移动设置.运动轨迹参数目标 || 6 === e.移动设置.运动轨迹参数目标 || 1 === e.移动设置.运动轨迹参数目标 ? l.D_K2_GetActorLocation() : a).op_Subtraction(r.D_K2_GetActorLocation()).RotateAngleAxis(n, i.ToUeVector()), n = t.op_Addition(u);
        r.K2_SetActorRotation(UE.KismetMathLibrary.D_FindLookAtRotation(t, n), !1), r.D_K2_SetActorLocation(n, !1, void 0, !0);
        break
      }
    }
