...
class BulletCollisionUtil {
  ...
  static EntityLeave(t, l) {
    ...
    if (e?.Valid) {
      ...
      if (l.Type === 1) {
        ...
        if (_ !== undefined && !((s = n.GetComponent(3)) && (this.tHo(t, n, s.IsRoleAndCtrlByMe), _ > 0) && n.GetComponent(122)?.RemoveTimeScale(_), e.CharacterEntityMap.delete(n), t.CollisionInfo.IntervalMs <= 0 && e.ObjectsHitCurrent.delete(n.Id), e.CharacterEntityMap.size)) {
  ...
  static prh(t, l, e, o) {
    ...
    if (!StringUtils_1.StringUtils.IsBlank(i) && e?.HasTag(501201000)) {
      ...
      if (!StringUtils_1.StringUtils.IsBlank(e) && o?.GetComponent(205)?.HasTag(412116357)) {
        return e;
      } else {
  ...
  static PlayHitEffect(l, e, o, i, a, r, t) {
    ...
    var u = e.Entity.GetComponent(205);
    ...
    if (i.size > 0) {
      ...
      let e = 2;
      if ((0, RegisterComponent_1.isComponentInstance)(n, 189)) {
        e = n.CurrentPriority;
      }
      ...
      let t = 2;
      if ((0, RegisterComponent_1.isComponentInstance)(s, 189)) {
        t = s.CurrentPriority;
      }
  ...
  static PlaySceneItemHitEffect(t, l, e, o, i) {
    ...
    let n = 2;
    if ((0, RegisterComponent_1.isComponentInstance)(_, 189)) {
      n = _.CurrentPriority;
    }
  ...
  static PlayVehicleHitEffect(i, a, r) {
    ...
    if (_ && !(_.length <= 0) && _ !== "None") {
      ...
      let e = 2;
      if ((0, RegisterComponent_1.isComponentInstance)(r, 189)) {
        e = r.CurrentPriority;
      }
