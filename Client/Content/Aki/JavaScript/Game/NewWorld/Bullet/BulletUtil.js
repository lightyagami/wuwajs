...
class BulletUtil {
      ...
      if (o.GetEntityType() === Protocol_1.Aki.Protocol.kks.Proto_Vision) {
        ...
        if (ModelManager_1.ModelManager.CharacterModel.IsValid(l)) {
          ...
          if (Log_1.Log.CheckError()) {
            Log_1.Log.Error("Bullet", 20, "子弹对小队攻击，找不到当前控制玩家", ["Id", t.BulletRowName], ["Attacker", t.AttackerActorComp?.Actor?.GetName()], ["CurrentEntityId", l]);
          }
          return false;
        }
      }
  ...
  static BulletUnfrozen(t) {
    t.IsFrozen = false;
    var e = t.ActorComponent;
    var o = t.Attacker.GetComponent(122)?.GetTopForeverTimeScale(1) ?? 1;
  ...
  static SetVictimTimeScale(t, e, o, l, r, a, i, n, _, u = false) {
    if (!(i <= 0)) {
  ...
  static GetHitRotator(t, e, o) {
    ...
    if ((0, RegisterComponent_1.isComponentInstance)(e, 3) && e.Entity.GetComponent(205)?.HasTag(855966206)) {
      return false;
    }
    ...
    switch (l) {
      ...
      case 1:
        ...
        break;
      case 2:
        var i = t.AttackerMoveComp?.IsStandardGravity ?? true;
        if (t.MoveInfo.BulletSpeedDir.Equals(Vector_1.Vector.ZeroVectorProxy, MathCommon_1.MathCommon.KindaSmallNumber)) {
          if (i) {
            ...
            Vector_1.Vector.VectorPlaneProject(t.ActorComponent.ActorForwardProxy, t.AttackerMoveComp.GravityUp, a);
          }
          a.MultiplyEqual(-1);
        } else if (i) {
          a.Set(-t.MoveInfo.BulletSpeedDir.X, -t.MoveInfo.BulletSpeedDir.Y, 0);
        } else {
          Vector_1.Vector.VectorPlaneProject(t.MoveInfo.BulletSpeedDir, t.AttackerMoveComp.GravityUp, a);
          a.MultiplyEqual(-1);
        }
        MathUtils_1.MathUtils.LookRotationUpFirst(a, e.ActorUpProxy, o);
        break;
  ...
  static SetHitRotator(t, e, o) {
    if (BulletUtil.GetHitRotator(t, e, this.TmpRotator) && !e.Entity.GetComponent(205)?.HasTag(1447214865) && (this.TmpRotator2.Set(0, o, 0), this.TmpRotator.Quaternion(this.TmpQuat), this.TmpRotator2.Quaternion(this.TmpQuat2), this.TmpQuat.Multiply(this.TmpQuat2, this.TmpQuat), this.TmpQuat.Rotator(this.TmpRotator), e.SetActorRotation(this.TmpRotator.ToUeRotator(), this.constructor.name, false), (0, RegisterComponent_1.isComponentInstance)(e, 3))) {
  ...
  static CheckBulletAttackerExist(t) {
    var e;
    return !!t.AttackerHandle?.Valid && (!!(e = t.AttackerCreatureDataComp?.GetCreatureDataId()) && e === ModelManager_1.ModelManager.BulletModel?.SceneBulletOwnerId || t.AttackerActorComp?.Actor !== undefined);
  }
  static FindLookAtRotDouble(t, e, o, l) {
    ...
    if (o) {
      const a = UE.KismetMathLibrary.D_MakeRotFromZX(l, r.ToUeVector(true));
    ...
    const a = UE.KismetMathLibrary.D_MakeRotFromZX(t.ToUeVector(), r.ToUeVector(true));
  ...
  static Gh1(o) {
    ...
    if (!(l.size <= 0)) {
      ...
      let t = a.Pitch;
      if ((n = l.get(0)) !== undefined && t < MathCommon_1.MathCommon.FlatAngle) {
        t = Math.min(t, n);
      }
      if ((n = l.get(1)) !== undefined && t > MathCommon_1.MathCommon.FlatAngle) {
      ...
      var i;
      var n = l.get(3);
      var _ = (_ = r.Yaw) > MathCommon_1.MathCommon.FlatAngle ? _ - MathCommon_1.MathCommon.RoundAngle : _;
      if (n !== undefined && (i = e - _) > 0 && i < MathCommon_1.MathCommon.FlatAngle && n < i) {
        e = Rotator_1.Rotator.ClampAxis(r.Yaw + n);
      }
      if ((n = l.get(2)) !== undefined && (i = _ - e) > 0 && i < MathCommon_1.MathCommon.FlatAngle && n < i) {
        e = Rotator_1.Rotator.ClampAxis(r.Yaw - n);
      }
  ...
  static CreateBulletFromAN(t, e, o, l, r, a, i, n, _) {
    ...
    var u = this.GetSkillContextId(u, l);
  ...
  static AroundBulletAxisAndBeginVector(t, e, o, l, r, a = undefined) {
    var i;
    if (r) {
      i = BulletPool_1.BulletPool.CreateVector();
      if (e.X > 0) {
        i.Set(Math.cos(t.Z * MathCommon_1.MathCommon.DegToRad), 0, Math.sin(t.Z * MathCommon_1.MathCommon.DegToRad));
        r.ActorQuatProxy.RotateVector(i, o);
        l.FromUeVector(r.ActorRightProxy);
      } else if (e.Y > 0) {
        i.Set(Math.sin(t.Z * MathCommon_1.MathCommon.DegToRad), Math.cos(t.Z * MathCommon_1.MathCommon.DegToRad), 0);
        r.ActorQuatProxy.RotateVector(i, o);
        l.FromUeVector(r.ActorUpProxy);
      } else {
        i.Set(0, Math.sin(t.Z * MathCommon_1.MathCommon.DegToRad), Math.cos(t.Z * MathCommon_1.MathCommon.DegToRad));
        r.ActorQuatProxy.RotateVector(i, o);
      ...
      r = t.Z;
      if (e.X > 0) {
        Vector_1.Vector.Lerp(Vector_1.Vector.ForwardVectorProxy, a, MathUtils_1.MathUtils.Clamp(r, 0, 180), o);
        a.CrossProduct(Vector_1.Vector.ForwardVectorProxy, l);
      } else if (e.Y > 0) {
        i = BulletPool_1.BulletPool.CreateVector();
        a.CrossProduct(Vector_1.Vector.ForwardVectorProxy, i);
        Vector_1.Vector.Lerp(i, Vector_1.Vector.ForwardVectorProxy, MathUtils_1.MathUtils.Clamp(r, 0, 180), o);
        BulletPool_1.BulletPool.RecycleVector(i);
        l.FromUeVector(a);
      } else {
        i = BulletPool_1.BulletPool.CreateVector();
        a.CrossProduct(Vector_1.Vector.ForwardVectorProxy, i);
        Vector_1.Vector.Lerp(a, i, MathUtils_1.MathUtils.Clamp(r, 0, 180), o);
        BulletPool_1.BulletPool.RecycleVector(i);
