...
class BulletLogicForceController extends BulletLogicController_1.BulletLogicController {
  constructor(t, i) {
    super(t, i), this.g7o = !1, this.f7o = void 0, this.p7o = !1, this.v7o = new Set, this.M7o = new Set, this.E7o = Vector_1.Vector.Create(), this.h7o = t, this.a7o = i.GetBulletInfo(), this.S7o = i.GetComponent(169), this.y7o = new Map, this.I7o = new Map, this.NeedTick = !0, this.g7o = this.h7o.ConstantForce, this.p7o = this.h7o.IsLaunching, this.T7o = 0 < this.LogicController.WorkHaveTag.GameplayTags.Num(), this.KIa = this.LogicController.ImmuneStopDuration
  }
  OnInit() {
    this.L7o()
  }
  L7o() {
    var t;
    this.g7o && (t = this.a7o.AttackerMoveComp?.IsStandardGravity ?? !0, this.f7o = t ? Vector_1.Vector.Create(this.h7o.TowardsBullet ? this.S7o.ActorUpProxy : Vector_1.Vector.UpVector) : Vector_1.Vector.Create(this.h7o.TowardsBullet ? this.S7o.ActorUpProxy : this.a7o.AttackerMoveComp.GravityUp), this.f7o.MultiplyEqual(this.h7o.ForceBase))
  }
  Update(t) {
  ...
  D7o() {
    var t, i, e = GameplayTagUtils_1.GameplayTagUtils.ConvertFromUeContainer(this.LogicController.WorkHaveTag);
    if (this.g7o) {
      this.p7o || (t = this.v7o, this.v7o = this.M7o, this.M7o = t, this.v7o.clear());
      for ([i] of this.a7o.CollisionInfo.CharacterEntityMap) !i || this.T7o && !i.GetComponent(205).HasAnyTag(e) || this.R7o(i)
    } else
      for (var [s] of this.a7o.CollisionInfo.CharacterEntityMap) {
        var o = s.GetComponent(205);
        !s || this.T7o && !o.HasAnyTag(e) || o.HasTag(1077681329) || this.U7o(s)
      }
  }
  U7o(t) {
    var i, e, s, o = t.GetComponent(178);
    !o?.Valid || o.CharacterWeight > this.h7o.LimitWeight || (s = t.GetComponent(3).ActorLocationProxy, (e = Vector_1.Vector.Dist(this.S7o.ActorLocationProxy, s)) > this.h7o.OuterRadius) || e < this.h7o.InnerRadius || this.h7o.OuterRadius <= 0 || (i = Math.max(MIN_WEIGHT, o.CharacterWeight) - WEIGHT_COEFFICIENT, e = Math.exp(-(e / this.h7o.OuterRadius * this.h7o.ForceDampingRatio * FORCE_DAMPING_RATIO)) * this.h7o.ForceBase * FORCE_RATIO / (i * i) * LENGTH_CONVERSION, (i = Vector_1.Vector.Create(this.S7o.ActorLocation)).SubtractionEqual(s), i.Normalize(TOLERANCE), i.MultiplyEqual(e), s = this.y7o.get(t), s = o.SetAddMoveWorld(i.ToUeVector(), MOVE_TIME, void 0, s), this.y7o.set(t, s), 0 < this.KIa && (e = t.GetComponent(61)) && !e.IsImmuneTimeScaleEffect() && e.AddImmuneTimeScaleEffectTimer(this.KIa * CommonDefine_1.MILLIONSECOND_PER_SECOND))
  }
  R7o(s) {
    var o = s.GetComponent(175),
      h = s.GetComponent(178);
    if (o?.Valid && h?.Valid) {
      let i = CustomMovementDefine_1.CUSTOM_MOVEMENTMODE_GLIDE;
      if (this.p7o) o.PositionState === CharacterUnifiedStateTypes_1.ECharPositionState.Air && o.MoveState === CharacterUnifiedStateTypes_1.ECharMoveState.Other || h.ActorComp?.Actor.KuroSetMovementMode({
        Mode: 3,
        Context: "[BulletLogicForceController.TowardsConstantForce]"
      }), i = void 0;
      else {
        if (o.MoveState !== CharacterUnifiedStateTypes_1.ECharMoveState.Glide) return void this.v7o.add(s);
