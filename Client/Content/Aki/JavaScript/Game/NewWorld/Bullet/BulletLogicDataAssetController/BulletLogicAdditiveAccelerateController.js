...
class BulletLogicAdditiveAccelerateController extends BulletLogicController_1.BulletLogicController {
  ...
  BulletLogicAction() {
    var e, t = this.LogicController;
    2 !== this.a7o.BulletDataMain.Move.Trajectory && ((e = this.a7o.MoveInfo).AdditiveAccelerateCurve = t.AccelerationCurve, e.BaseAdditiveAccelerate.FromUeVector(t.Acceleration), e.AdditiveAccelerate.FromUeVector(t.Acceleration))
  }
}
