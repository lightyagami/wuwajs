...
class BulletLogicSpeedReduceController extends BulletLogicController_1.BulletLogicController {
  ...
  BulletLogicAction(t = 0) {
    var e, l = (l = this.a7o.AttackerMoveComp.CharacterWeight) < MIN_WEIGHT ? MIN_WEIGHT : l,
      o = this.a7o.CollisionInfo.GetFirstVictim([1]);
    o?.Valid && (e = l - .1 * (o = (o = o?.GetComponent(178).CharacterWeight) < MIN_WEIGHT ? MIN_WEIGHT : o) * this.h7o.SpeedDampingRatio, o = (o = 0 < (o = (l = l + .1 * o * this.h7o.SpeedDampingRatio) < TOLERANCE || e < 0 ? 0 : this.a7o.MoveInfo.BulletSpeed * (e / l)) ? o : 0) < this.h7o.MinSpeed ? 0 : o, this.a7o.MoveInfo.BulletSpeed = o)
  }
