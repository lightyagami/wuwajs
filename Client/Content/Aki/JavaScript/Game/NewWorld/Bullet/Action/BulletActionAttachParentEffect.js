...
class BulletActionAttachParentEffect extends BulletActionBase_1.BulletActionBase {
  OnTick(t) {
    var e, l = this.BulletInfo;
    l.NeedDestroy || (e = EffectSystem_1.EffectSystem.GetSureEffectActor(l.ParentEffect)) && (BulletUtil_1.BulletUtil.AttachParentEffectSkeleton(l, e, l.ParentEffect), this.IsFinish = !0)
  }
}
