...
class BulletActionInitCollision extends BulletActionBase_1.BulletActionBase {
  ...
  V5o() {
    ...
    if (i) {
      ...
      let t = false;
      if (t = !this.CollisionInfo.HasObstaclesCollision && s ? !l : !l && this.BulletInfo.ActorComponent.NeedDetach && !this.BulletInfo.ActorComponent.NeedDetachForBaseMovement) {
