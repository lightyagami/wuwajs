...
class SubEntityInteractLogicController {
  constructor(t) {
    ...
    this.InteractComp = this.Entity.GetComponent(207)?.GetInteractController();
  }
  Possess(t, r = 0) {
    return true;
  }
...
class PawnChairController extends SubEntityInteractLogicController {
  ...
  ResetCollision() {
    if (this.Entity.GetComponent(212)) {
      this.drr(false);
    }
  }
  IgnoreCollision() {
