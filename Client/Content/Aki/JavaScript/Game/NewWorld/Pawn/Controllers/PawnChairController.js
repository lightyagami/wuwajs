...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PawnChairController = exports.SubEntityInteractLogicController = void 0;
...
class SubEntityInteractLogicController {
  constructor(t) {
    this.MasterEntity = void 0, this.Entity = void 0, this.CreatureDataComp = void 0, this.InteractComp = void 0, this.CreatureDataComp = t, this.Entity = t.Entity, this.InteractComp = this.Entity.GetComponent(197)?.GetInteractController()
  }
  Possess(t, r = 0) {
    return !0
  }
  ...
  Dispose() {
    this.MasterEntity = void 0, this.Entity = void 0, this.CreatureDataComp = void 0, this.InteractComp = void 0
  }
}(exports.SubEntityInteractLogicController = SubEntityInteractLogicController).TmpVector = Vector_1.Vector.Create(), SubEntityInteractLogicController.TmpVector2 = Vector_1.Vector.Create();
class PawnChairController extends SubEntityInteractLogicController {
  ...
  GetSitLocation() {
    ...
    return (this.mrr || s).ActorRightProxy.Multiply(this.x4a, t), r.Z = this.mrr ? this.mrr.ActorLocationProxy.Z + e : i.Z, t.AdditionEqual(r), t
  }
  GetForwardDirection() {
  ...
  drr(r) {
    if (this.mrr && this.MasterEntity && this.mrr.GetIsSceneInteractionLoadCompleted()) {
      var s = r ? 0 : 2,
        ...
        o = e.Num();
      0 === o && Log_1.Log.CheckWarn() && Log_1.Log.Warn("AI", 50, "[PawnChairController.IgnoreChairActorsCollision] 场景交互物体未加载完全", ["itemPbDataId", this.CreatureDataComp.GetPbDataId()], ["OwnerPbDataId", this.mrr.CreatureData.GetPbDataId()]);
      for (let t = 0; t < o; ++t) {
        var n = e.Get(t),
        ...
        for (let t = 0; t < l; ++t) {
          var u = a.Get(t);
          u.IsValid() && (i.Actor.IgnoreActorWhenMoving(a.Get(t), r, !0), (u = u)?.IsValid()) && u.GetComponentByClass(UE.StaticMeshComponent.StaticClass())?.SetCollisionResponseToChannel(2, s)
        }
      }
    }
  }
  ResetCollision() {
    this.Entity.GetComponent(202) && this.drr(!1)
  }
  IgnoreCollision() {
    this.Entity.GetComponent(202) && this.drr(!0)
  }
  IsSceneInteractionLoadCompleted() {
    var t, r = this.Entity.GetComponent(202);
