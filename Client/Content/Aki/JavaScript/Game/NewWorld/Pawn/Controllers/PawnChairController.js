...
class SubEntityInteractLogicController {
  constructor(t) {
    ...
    this.InteractComp = this.Entity.GetComponent(209)?.GetInteractController();
  }
  Possess(t, r = 0) {
    return true;
  }
...
class PawnChairController extends SubEntityInteractLogicController {
  ...
  ResetCollision() {
    if (this.Entity.GetComponent(214)) {
      this.drr(false);
    }
  }
  IgnoreCollision() {
