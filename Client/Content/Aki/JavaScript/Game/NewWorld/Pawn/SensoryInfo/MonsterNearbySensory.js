...
class MonsterNearbySensory extends BaseSensoryInfo_1.BaseSensoryInfo {
  constructor() {
    super(...arguments), this.SensoryInfoType = 1, this.CacheEntityList = [], this.LastFindEntities = new Set, this.OnEnterSensoryRange = void 0, this.OnExitSensoryRange = void 0
  }
  OnInit(...s) {
  ...
  OnTick(s) {}
  OnClear() {
    this.LastFindEntities.clear(), this.CacheEntityList.length = 0, this.OnEnterSensoryRange = void 0, this.OnExitSensoryRange = void 0
  }
  ClearCacheList() {
  ...
  EnterRange(s) {
    this.InRange = !0, !this.LastFindEntities.has(s.Id) && 1 & this.SensoryInfoType && !this.OnEnterSensoryRange(s) || (this.CacheEntityList.push(s.Id), this.LastFindEntities.delete(s.Id))
  }
  ExitRange() {
    if (this.InRange = 0 !== this.CacheEntityList.length, 1 & this.SensoryInfoType)
