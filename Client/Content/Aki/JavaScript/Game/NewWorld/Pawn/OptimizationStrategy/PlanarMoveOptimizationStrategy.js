...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.PlanarMoveOptimizationStrategy = void 0;
...
class PlanarMoveOptimizationStrategy extends BaseOptimizationStrategy_1.BaseOptimizationStrategy {
  OnEntityInOutRangeLocal(t, e) {
    var a;
    e?.Valid && (a = e.Entity.GetComponent(178))?.Valid && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Optimization", 57, "[PlanarMoveOptimizationStrategy] 角色", ["handleId", e.Id], ["isEnter", t]), a.SetKuroPlanarPhysWalking(t), a.SetKuroAsyncRootMotion(t))
  }
}
