...
class AnimalPerformAlertState extends AnimalPerformStateBase_1.AnimalPerformStateBase {
  OnEnter(e) {
    this.EcologicalInterface?.IsValid() && (0 === e && this.AnimalEcologicalInterface.StateMachineInitializationComplete(), this.EcologicalInterface.AlertStart(), e = (0, puerts_1.$ref)(void 0), this.EcologicalInterface.GetCurrentActionTime(e), this.ActionTime = (0, puerts_1.$unref)(e))
  }
  OnUpdate(e) {}
  OnExit(e) {
