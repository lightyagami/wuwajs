...
let AnimalDeathSyncComponent = class AnimalDeathSyncComponent extends BaseDeathComponent_1.BaseDeathComponent {
  constructor() {
    ...
    this.gne = e => {
      if (e.DamageId !== 0 && !this.Xte.HasTag(501201000) && !this.Xte.HasTag(1008164187)) {
        this.Entity.GetComponent(50)?.DisableAi("动物死亡");
  ...
  OnStart() {
    return !!super.OnStart() && (this.Xte = this.Entity.CheckGetComponent(217), this.HBr = this.Entity.CheckGetComponent(111), EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.CharBeHitLocal, this.gne), this.Entity.CheckGetComponent(0).GetLivingStatus() === Protocol_1.Aki.Protocol.JEs.Proto_Dead && TimerSystem_1.TimerSystem.Next(() => {
...
AnimalDeathSyncComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(181)], AnimalDeathSyncComponent);
