...
class LimitTagHandler {
  constructor(t, i, s, e) {
    this.TagId = t, this.Priority = i, this.TagExist = s, this.CallBack = e, this.MutuallyTags = [], this.Active = !1, this.Priority = MathUtils_1.MathUtils.Clamp(this.Priority, 0, MAX_PRIORITY)
  }
}
class RoleForbidMovementHelper {
  constructor() {
    this.TagComp = void 0, this.Cer = new Array, this.CurrentActiveHandlers = new Array, this.Handlers = new Map, this.Eir = (t, i) => {
  ...
  RegisterMutuallyTags(t) {
    for (const s of t) {
      ...
      if (i)
        for (const e of t) e !== i.TagId && i.MutuallyTags.push(e)
    }
  }
  Awake() {
  ...
  ActiveHandler(t, i) {
    t.Active = i, t.CallBack(i), i ? this.CurrentActiveHandlers.push(t) : (i = this.CurrentActiveHandlers.indexOf(t)) < 0 || this.CurrentActiveHandlers.splice(i, 1)
  }
  CreateTagHandler(t, i, s) {
    var e = this.TagComp.HasTag(t);
    this.Handlers.set(t, new LimitTagHandler(t, i, e, s)), this.Cer.push(this.TagComp.ListenForTagAddOrRemove(t, this.Eir))
  }
  Clear() {
