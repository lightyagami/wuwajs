...
let RoleQteComponent = class RoleQteComponent extends EntityComponent_1.EntityComponent {
  ...
  OnStart() {
    ...
    this.gon = this.Entity.CheckGetComponent(101);
    this.tRr = this.Entity.CheckGetComponent(43);
    this.gFe = this.Entity.CheckGetComponent(99);
  ...
  UseExitSkill(t) {
    var e = t.Entity.GetComponent(106).GetQteTagData();
  ...
  ExecuteQte(t) {
    ...
    var r = t.Entity.GetComponent(99);
  ...
  Uon(e, t, i) {
    ...
    var r = i.Entity.GetComponent(61)?.GetAttributeSharerActors();
    if (r) {
  ...
  SetQtePosition(s) {
    ...
    if (a) {
      ...
      if ((0, RegisterComponent_1.isComponentInstance)(t, 3)) {
        e = t.ScaledRadius;
        i = t.HalfHeight;
      } else if ((0, RegisterComponent_1.isComponentInstance)(t, 214)) {
        h = t.GetRadius();
        e = h;
        i = h;
      }
  ...
  QZr(t) {
    var t = t.Entity;
    var e = t.GetComponent(70)?.IsManipulating();
    var i = t.GetComponent(43);
    var r = i.SkillTarget;
    if (!e && r?.Valid && r.Entity?.Active && !r.Entity.GetComponent(217)?.HasTag(1008164187)) {
      this.tRr.SkillTarget = r;
      this.tRr.SkillTargetSocket = i.SkillTargetSocket;
    } else {
      (e = t.GetComponent(34)).DetectSoftLockTarget({
  ...
  R7a(t) {
    ...
    CombatMessage_1.CombatNet.Send(23728, this.Entity, e, undefined, t);
    return t;
  }
...
RoleQteComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(106)], RoleQteComponent);
