...
let RoleAudioComponent = RoleAudioComponent_1 = class RoleAudioComponent extends CharacterAudioComponent_1.CharacterAudioComponent {
  constructor() {
    ...
    this.sk_ = e => {
      if (this.ActorComp?.Owner) {
        this.UTu = e === 1 ? "cloud" : "default";
        if (Log_1.Log.CheckDebug()) {
          Log_1.Log.Debug("Audio", 42, "[Game.Role] OnInteractionWaterTypeChange", ["EntityId", this.Entity.Id], ["Owner", this.ActorComp?.Owner?.GetName()], ["WaterTypeState", this.UTu]);
        }
        AudioSystem_1.AudioSystem.SetSwitch("role_interact_water", this.UTu, this.ActorComp.Owner);
      }
    };
    this.Hqr = (e, t, i, o, s) => {
  ...
  OnInit() {
    super.OnInit();
    this.lUr();
    this.mBe = this.Entity.CheckGetComponent(176);
  ...
  OnAkComponentCreated() {
    ...
    if (this.ActorComp?.Owner) {
      ...
      AudioSystem_1.AudioSystem.SetSwitch("footstep_texture", this.ATu, this.ActorComp.Owner);
      AudioSystem_1.AudioSystem.SetSwitch("footstep_variant", this.PTu, this.ActorComp.Owner);
      AudioSystem_1.AudioSystem.SetSwitch("foley_variant", this.xTu, this.ActorComp.Owner);
      AudioSystem_1.AudioSystem.SetSwitch("role_interact_water", this.UTu, this.ActorComp.Owner);
    }
  }
  ChangeRoleName(e) {
  ...
  ChangeFootstepVariant(e) {
    if (this.ActorComp?.Owner) {
      if (footstepVariantMap.has(e)) {
        this.PTu = footstepVariantMap.get(e);
        AudioSystem_1.AudioSystem.SetSwitch("footstep_variant", this.PTu, this.ActorComp.Owner);
  ...
  ChangeFoleyVariant(e) {
    if (this.ActorComp?.Owner) {
      if (foleyVariantMap.has(e)) {
        this.xTu = foleyVariantMap.get(e);
        AudioSystem_1.AudioSystem.SetSwitch("foley_variant", this.xTu, this.ActorComp.Owner);
      } else if (Log_1.Log.CheckError()) {
...
RoleAudioComponent = RoleAudioComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(190)], RoleAudioComponent);
