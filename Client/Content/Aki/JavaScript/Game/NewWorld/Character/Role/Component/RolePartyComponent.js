...
var __decorate = this && this.__decorate || function(e, t, o, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, o, n);
    ...
    for (var s = e.length - 1; 0 <= s; s--)(r = e[s]) && (a = (i < 3 ? r(a) : 3 < i ? r(t, o, a) : r(t, o)) || a);
...
let RolePartyComponent = class RolePartyComponent extends EntityComponent_1.EntityComponent {
  OnStart() {
    var e = this.Entity.GetComponent(0),
      t = this.Entity.CheckGetComponent(205),
      o = ConfigManager_1.ConfigManager.RoleConfig.GetRoleConfig(e.GetRoleId()),
      o = ConfigManager_1.ConfigManager.InfluenceConfig.GetInfluenceConfig(o.PartyId);
    if (o)
      for (const n of o.PartyTags) t.AddTag(n);
    else Log_1.Log.CheckError() && Log_1.Log.Error("Role", 28, "势力.xlsx配置不存在", ["RoleId", e.GetRoleId()]);
    return !0
  }
};
RolePartyComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(269)], RolePartyComponent), exports.RolePartyComponent = RolePartyComponent;
