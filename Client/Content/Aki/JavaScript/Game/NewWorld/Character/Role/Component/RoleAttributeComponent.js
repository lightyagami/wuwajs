...
let RoleAttributeComponent = class RoleAttributeComponent extends CharacterAttributeComponent_1.CharacterAttributeComponent {
  *GetAllBoundsLocker(e) {
    ...
    var t = FormationDataController_1.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(208);
    if (t) {
...
RoleAttributeComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(198)], RoleAttributeComponent);
