...
var __decorate = this && this.__decorate || function(e, t, o, r) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, o, r);
    ...
    for (var l = e.length - 1; 0 <= l; l--)(n = e[l]) && (a = (i < 3 ? n(a) : 3 < i ? n(t, o, a) : n(t, o)) || a);
...
let RoleAttributeComponent = class RoleAttributeComponent extends CharacterAttributeComponent_1.CharacterAttributeComponent {
  * GetAllBoundsLocker(e) {
    ...
    var t = FormationDataController_1.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(198);
    if (t)
      for (const r of t.GetAllBoundsLocker(e)) yield r
  }* GetAllModifiers(e) {
    for (const o of super.GetAllModifiers(e)) yield o;
    var t = FormationDataController_1.FormationDataController.GetPlayerEntity(ModelManager_1.ModelManager.CreatureModel.GetPlayerId())?.GetComponent(198);
    if (t)
      for (const r of t.GetAllModifiers(e)) yield r
  }
};
RoleAttributeComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(188)], RoleAttributeComponent), exports.RoleAttributeComponent = RoleAttributeComponent;
