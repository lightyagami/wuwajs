...
let RoleInheritComponent = class RoleInheritComponent extends EntityComponent_1.EntityComponent {
  ...
  static StateInherit(e, t, o, n) {
    if (e && t) {
      ...
      EventSystem_1.EventSystem.EmitWithTarget(t.Entity, EventDefine_1.EEventName.RoleOnStateInherit, e.Entity, o === 1 || n || (t.Entity.GetComponent(209)?.HasAnyTag([-1388400236, 1144073280]) ?? false));
    }
  }
  static non(t, o) {
...
RoleInheritComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(99)], RoleInheritComponent);
