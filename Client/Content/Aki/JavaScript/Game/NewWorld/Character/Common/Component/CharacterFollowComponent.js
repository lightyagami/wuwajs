...
var __decorate = this && this.__decorate || function(t, e, o, r) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, o, r);
    ...
    for (var h = t.length - 1; 0 <= h; h--)(i = t[h]) && (s = (n < 3 ? i(s) : 3 < n ? i(e, o, s) : i(e, o)) || s);
...
let CharacterFollowComponent = class CharacterFollowComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.u1t = void 0, this.v5r = [], this.RJl = 0, this.PJl = !1
  }
  get FollowIds() {
    return this.v5r
  }
  ...
  kZl(t) {
    this.RJl = t, 0 !== this.RJl && (t = EntitySystem_1.EntitySystem.Get(this.RJl)?.GetComponent(95)) && this.Entity.GetComponent(40)?.ResetRoleGrowComponent(t)
  }
  GetRoleActor() {
  ...
  SetFollowId(t) {
    -1 !== this.v5r.indexOf(t) ? Log_1.Log.CheckDebug() && Log_1.Log.Debug("Character", 22, "Add the Same Summon Id:", ["id", t]) : this.v5r.push(t)
  }
  DeleteFollowEntity() {
    var t = ModelManager_1.ModelManager.CreatureModel.GetEntity(this.u1t.GetSummonerId());
    t?.Valid && t.Entity.GetComponent(56).pJs(this.Entity.Id)
  }
  GetAttributeHolder() {
    if (0 !== this.RJl) {
      var t = EntitySystem_1.EntitySystem.Get(this.RJl);
      if (t?.Valid) return t;
      Log_1.Log.CheckError() && Log_1.Log.Error("Character", 20, "FollowComp role is inValid", ["Id", this.RJl], ["SelfId", this.u1t?.GetCreatureDataId()])
    }
  }
  ...
  GetToRoleDistance() {
    var t;
    return this.RJl && (t = EntitySystem_1.EntitySystem.Get(this.RJl)) && this.Entity && this.Entity.GetComponent(1) && t.GetComponent(1) ? UE.VectorDouble.Dist(this.Entity.GetComponent(1).ActorLocation, t.GetComponent(1).ActorLocation) : -1
  }
  fJs() {
    var t = ModelManager_1.ModelManager.CreatureModel.GetEntity(this.u1t.GetSummonerId());
    if (t?.Valid) {
      this.u1t.SummonType === EProtoSummonType.Proto_ESummonTypeConcomitantVision ? ((e = this.u1t.GetVisionComponent()) && (e = PhantomUtil_1.PhantomUtil.GetVisionData(e.VisionId)) && (this.PJl = 0 === e.类型), this.OZl(t)) : this.u1t.SummonType === EProtoSummonType.Proto_ESummonTypeConcomitantCustom && this.u1t.SummonCfgId && SummonCfgById_1.configSummonCfgById.GetConfig(this.u1t.SummonCfgId)?.ShareDamage && this.OZl(t);
      var e, o = this.Entity.GetComponent(205);
      if (o) switch (o.RemoveTag(-1615796724), this.u1t?.SummonType) {
  ...
  pJs(t) {
    0 !== t ? -1 !== (t = this.v5r.indexOf(t)) && this.v5r.splice(t, 1) : this.v5r = []
  }
  OZl(t) {
    this.kZl(t.Id), t.Entity.GetComponent(56).SetFollowId(this.Entity.Id)
  }
};
CharacterFollowComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(56)], CharacterFollowComponent), exports.CharacterFollowComponent = CharacterFollowComponent;
