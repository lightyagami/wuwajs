"use strict";
var NpcMoveComponent_1, __decorate = this && this.__decorate || function(t, e, i, s) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, e, i, s);
    ...
    for (var o = t.length - 1; 0 <= o; o--)(h = t[o]) && (r = (n < 3 ? h(r) : 3 < n ? h(e, i, r) : h(e, i)) || r);
...
let NpcMoveComponent = NpcMoveComponent_1 = class NpcMoveComponent extends BaseMoveComponent_1.BaseMoveComponent {
  constructor() {
    super(...arguments), this.CanResponseInputTasks = new Array, this.CachedDeltaYaw = 0, this.IsTurningInternal = !1, this.OnPositionStateChanged = (t, e) => {
      switch (t === CharacterUnifiedStateTypes_1.ECharPositionState.Air && (this.IsFallingIntoWater = !1, this.StopAddMove(this.AirInertiaHandler), this.AirInertiaHandler = 0), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Character", 20, "OnPositionStateChanged:", ["NPCName:", this.ActorComp.Actor.GetName()], ["oldPositionState->", t], ["newPositionState", e]), e) {
        ...
        case CharacterUnifiedStateTypes_1.ECharPositionState.Air:
          this.HasBaseMovement && !this.ActorComp.Actor.BasedMovement.bRelativeRotation && this.DeltaBaseMovementSpeed && (this.AirInertiaHandler = this.SetAddMoveWorld(this.DeltaBaseMovementSpeed, BASE_MOVE_INHERIT_TIME, NpcMoveComponent_1.BaseMoveInheritCurve, this.AirInertiaHandler))
      }
  ...
  set IsTurning(t) {
    this.IsTurningInternal !== t && ((this.IsTurningInternal = t) ? EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharTurnBegin) : EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharTurnEnd))
  }
  SetMaxSpeed(t) {
  ...
  OnClear() {
    return super.OnClear(), this.JumpDelayTimer && TimerSystem_1.TimerSystem.Remove(this.JumpDelayTimer), this.MoveController?.Dispose(), !0
  }
  OnInit() {
    return super.OnInit()
  }
  ...
  OnTick(i) {
    if (super.OnTick(i), this.ActorComp && (this.DeltaTimeSeconds = i * MathUtils_1.MathUtils.MillisecondToSecond, this.MoveController?.UpdateMove(this.DeltaTimeSeconds), 0 < this.SpeedLockFrame && --this.SpeedLockFrame, this.IsJump && --this.JumpFrameCount, this.LerpMaxAcceleration(), this.UpdateBaseMovement(), !this.IsSpecialMove))
      if (this.IsStopInternal ? this.Speed = 0 : this.Speed = this.ActorComp.ActorVelocityProxy.Size2D(), this.IsMoving = this.Speed > MIN_MOVE_SPEED, this.ActorComp.IsMoveAutonomousProxy) {
  ...
  UpdateFacing() {
    this.CanUpdateMovingRotation() && (this.ActorComp.OverrideTurnSpeed ? (this.SmoothCharacterRotation(this.ActorComp.InputRotatorProxy, this.ActorComp.OverrideTurnSpeed, this.DeltaTimeSeconds, !1, "Movement.UpdateFacing"), this.ActorComp.SetOverrideTurnSpeed(void 0)) : this.UpdateGroundedRotation())
  }
};
NpcMoveComponent = NpcMoveComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(181)], NpcMoveComponent), exports.NpcMoveComponent = NpcMoveComponent;
