...
let CharacterFootEffectComponent = CharacterFootEffectComponent_1 = class CharacterFootEffectComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.Bq_ = (t, e, i, o) => {
      if ((!this.Dq_ || !(i < this.Dq_.Frame)) && (!this.Dq_ || i !== this.Dq_.Frame || !(o < this.Dq_.Index))) {
        if (t) {
          ...
          ControllerHolder_1.ControllerHolder.WorldController.EnvironmentInfoUpdate(this.P5r.ToUeVector(), this.Hte.IsRoleAndCtrlByMe);
        } else if (Log_1.Log.CheckWarn()) {
    ...
    this.qq_ = (t, e, i, o) => {
      if ((!this.kq_ || !(i < this.kq_.Frame)) && (!this.kq_ || i !== this.kq_.Frame || !(o < this.kq_.Index))) {
        if (t) {
          ...
          ControllerHolder_1.ControllerHolder.WorldController.EnvironmentInfoUpdate(this.x5r.ToUeVector(), this.Hte.IsRoleAndCtrlByMe);
        } else if (Log_1.Log.CheckWarn()) {
          Log_1.Log.Warn("Test", 6, "Detect Footprint Failed", ["location", this.Hte?.ActorLocationProxy], ["start", this._ae], ["end", this.uae]);
        }
      }
    ...
    this.oCu = undefined;
    this.nCu = (t, e, i, o) => {
      if (this.oCu && i < this.oCu.Frame || this.oCu && i === this.oCu.Frame && o < this.oCu.Index) {
        this.sCu();
      } else if (t) {
        TraceElementCommon_1.TraceElementCommon.GetHitLocation(e.HitResult, 0, this.kTn);
        this.sCu();
  ...
  OnStart() {
    ...
    if (!this.Entity.GetComponent(177)?.Valid) {
      return false;
    }
    ...
    t = this.Hte?.Actor;
    if (t?.IsValid()) {
      this.vK1 = t.GetComponentByClass(UE.KuroEnviInteractionComponent.StaticClass());
    }
    ...
    this.rCu = (0, puerts_1.toManualReleaseDelegate)(this.nCu);
    return true;
  }
  OnEnd() {
    this.Hte = undefined;
    ...
    this.wq_ = undefined;
    this.Rq_ = undefined;
    return !(this.rCu = undefined);
  }
  OnTick(t) {
    this.k5r();
  }
  FTn(t, e) {
    this.iCu = Time_1.Time.Now;
  ...
  PostFootstepVoice() {
    if (Time_1.Time.Now - this.iCu < FOOTPRINT_DETECT_DURATION) {
      this.sCu();
    } else {
      this.iCu = Time_1.Time.Now;
      ...
      TraceElementCommon_1.TraceElementCommon.SetStartLocation(this.R5r, this._ae);
      TraceElementCommon_1.TraceElementCommon.SetEndLocation(this.R5r, this.uae);
      this.oCu = TraceElementCommon_1.TraceElementCommon.AsyncSphereTrace(this.R5r, PROFILE_KEY, this.rCu);
    }
  }
  FWc(t) {
  ...
  VWc(t, e, i) {
    var o;
    if (i && this.vK1 && this.Hte && this.vK1 && i.SurfaceType !== 10 && this.vK1.GetRainWalkOcclusionParam() < 1 - MathCommon_1.MathCommon.ThreshPointOnPlane && (i = this.vK1.GetEnviInteractionData()) && !i.bInWater) {
      i = this.fHo;
  ...
  VTn(t) {
    ...
    if (!!t?.bBlockingHit && !(Time_1.Time.Now - this.B5r < FOOTPRINT_SPAWN_DURATION) && !(e = this.kTn, TraceElementCommon_1.TraceElementCommon.GetHitLocation(t, 0, e), Vector_1.Vector.DistSquared(e, this.b5r) < FOOTPRINT_SPAWN_MIN_DISTANCE_SQUARED) && !!t.PhysMaterials && !(t.PhysMaterials.Num() <= 0)) {
      if (i = t.PhysMaterials.Get(0)) {
        this.NWc(t, e, this.fHo, this.Gue);
        this.VWc(this.fHo, this.Gue, i);
  ...
  TriggerFootprint(t) {
    var e;
    if (!!this.R5r?.HitResult?.bBlockingHit && !(Time_1.Time.Now - this.B5r < FOOTPRINT_SPAWN_DURATION) && !(t ? this.GWc.FromUeVector(this.Hte.Actor.Mesh.D_GetSocketLocation(CharacterFootEffectComponent_1.LeftFootSocketName)) : this.GWc.FromUeVector(this.Hte.Actor.Mesh.D_GetSocketLocation(CharacterFootEffectComponent_1.RightFootSocketName)), Vector_1.Vector.DistSquared(this.GWc, this.b5r) < FOOTPRINT_SPAWN_MIN_DISTANCE_SQUARED)) {
      e = this.R5r.HitResult.PhysMaterials?.Get(0);
      e = this.FWc(e);
      this.NWc(this.R5r.HitResult, this.GWc, this.fHo, this.Gue);
      if (e) {
  ...
  sCu() {
    var t = this.aCu();
    this.Entity.GetComponent(189)?.PostFootstepAudio(t);
  }
  k5r() {
