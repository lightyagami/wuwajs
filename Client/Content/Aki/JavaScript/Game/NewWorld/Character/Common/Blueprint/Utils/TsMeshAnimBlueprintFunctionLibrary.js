...
class TsMeshAnimBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static MainAnimInstance(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 177)?.MainAnimInstance
  }
  ...
  static GetBattleIdleTime(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 177)?.BattleIdleEndTime
  }
  static EnterBattleIdle(t) {
    EntitySystem_1.EntitySystem.GetComponent(t, 177)?.EnterBattleIdle()
  }
  static SetTransformWithModelBuffer(t, e, i) {
    EntitySystem_1.EntitySystem.GetComponent(t, 177)?.SetTransformWithModelBuffer(e, i)
  }
  ...
  static GetIsCurrentWeaponHideEffectPlaying(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 81)?.IsCurrentWeaponHideEffectPlaying() ?? !1
  }
  ...
  static GetRandomStandActionIndex(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 177)?.GetRandomStandActionIndex()
  }
  static HideWeapon(t, e, i, n, r = !1) {
    EntitySystem_1.EntitySystem.GetComponent(t, 81)?.HideWeapon(i, e, n, !1, r ? 1 : 0)
  }
  static HideHulu(t, e) {
  ...
  static GetDegMovementSlope(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 177)?.DegMovementSlope
  }
  static GetRoleFootStepState(t) {
    ...
    if (e === Protocol_1.Aki.Protocol.kks.Proto_Player) {
      e = t.GetPlayerId(), e = ModelManager_1.ModelManager.PlayerInfoModel.GetId() === e, t = t.GetRoleId(), t = ModelManager_1.ModelManager.RoleModel.GetRoleDataById(t, e);
      if (t) {
        e = t.GetRoleConfig();
  ...
  static SetIkMeshOffset(t, e) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    t && (t.IkMeshOffset = e)
  }
        ...
        if (a instanceof TsBaseCharacter_1.default) {
          ...
          if (e?.Valid) {
            ...
            if (s?.IsValid()) {
              ...
              let t = "";
              if (a.CharRenderingComponent.GetInWater()) UE.AkGameplayStatics.SetRTPCValue(void 0, e.WaterDepth, 0, void 0, FNameUtil_1.FNameUtil.NONE), t = "WaterSurface";
              else {
              ...
              s.SetSwitch(void 0, "FootStep_Ground_Texture", t), e.FootSwitch = t, s.SetSwitch(void 0, "FootStep_Shoes", TsMeshAnimBlueprintFunctionLibrary.GetRoleFootStepState(i)), n["状态-地面-Walk"] || n["状态-跑停-WalkStop"] ? s.PostAkEvent(n.WalkAkAudioEvent, 0, void 0, "") : n["状态-地面-Run"] || n["状态-跑停-RunStop"] ? s.PostAkEvent(n.RunAkAudioEvent, 0, void 0, "") : n["状态-地面-Sprint"] || n["状态-跑停-SprintStop"] ? s.PostAkEvent(n.SprintAkAudioEvent, 0, void 0, "") : s.PostAkEvent(n.FallbackAkAudioEvent, 0, void 0, "")
            }
          }
        }
      }
  ...
  static ChangeTickOverlap(t, e) {
    EntitySystem_1.EntitySystem.GetComponent(t, 114).SetTakeOverTick(e)
  }
  static AnimTurnLog(t) {
    var e = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "AnimTurn 1058338", ["EntityId", t], ["CurrentFacing", e.ActorRotationProxy], ["InputFace", e.InputRotatorProxy])
  }
  static IsNpcTurning(t) {
    return !!EntitySystem_1.EntitySystem.GetComponent(t, 181)?.IsTurning
  }
  static UpdateAndGetRotateBonesMap(t, e, i, n) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    t && t.RotateBonesToTargetMgr && (t.RotateBonesToTargetMgr.Update(e), t.RotateBonesToTargetMgr.GetActivateBones((0, puerts_1.$unref)(i)), t.RotateBonesToTargetMgr.GetTargetOffset((0, puerts_1.$unref)(n)))
  }
}
