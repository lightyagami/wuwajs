...
class GameplayCueHitEffect extends GameplayCueBase_1.GameplayCueBase {
  ...
  Uoa(e) {
    var t;
    return !!e && !!this.EntityHandle.Valid && !!(t = this.EntityHandle.Entity.GetComponent(66)) && t.ReplaceHitEffect(e);
  }
  Kgl() {
    var e;
    if (this.EntityHandle.Valid && (e = this.EntityHandle.Entity.GetComponent(66))) {
