...
let CharacterPendulumComponent = CharacterPendulumComponent_1 = class CharacterPendulumComponent extends EntityComponent_1.EntityComponent {
  ...
  OnStart() {
    ...
    var t = this.Entity.GetComponent(182).CharacterMovement;
  ...
  yjr(t) {
    ...
    if (this.cjr) {
      ...
      t = this.Entity.GetComponent(182).CharacterMovement;
  ...
  Sjr() {
    this.cjr = false;
    this.Entity.GetComponent(182).CharacterMovement.AirControl = this.vjr;
  }
