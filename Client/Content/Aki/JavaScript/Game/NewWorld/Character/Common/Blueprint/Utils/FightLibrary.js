...
class FightLibrary {
  ...
  static GetHitMapConfig(r) {
    ...
    if (UE.DataTableUtil_C.LoadHitMapConfig(r, GlobalData_1.GlobalData.GameInstance, e, t), (0, puerts_1.$unref)(t)) return (0, puerts_1.$unref)(e);
    Log_1.Log.CheckError() && Log_1.Log.Error("Config", 4, "找不到受击映射配置", ["selfCamp:", r.toString()])
  }
}
