...
let CharacterPlanComponent = class CharacterPlanComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.u1t = void 0, this.ConfigId = 0, this.Pjr = void 0, this.xjr = void 0, this.wjr = void 0, this.Bjr = void 0, this.OPt = void 0, this.bjr = !0, this.qjr = !0, this.Gjr = !1, this.sxr = void 0, this.DisableAiHandle = void 0, this.EFr = new Map, this.Nza = (e, t) => {
      if (this.Fza(e, t)) switch ((0, IVar_1.getVarTypeByIndex)(t.iTs)) {
        case "Boolean":
  ...
  OnInitData() {
    this.u1t = this.Entity.GetComponent(0), this.ConfigId = this.u1t.GetPbDataId();
    var e = this.u1t.GetPbEntityInitData();
    if (!e?.ComponentsData) return !(this.bjr = !1);
    if (this.OPt = (0, IComponent_1.getComponent)(e.ComponentsData, "LevelAiComponent"), !this.OPt?.States) return !(this.bjr = !1);
    if (BehaviorTreeDefines_1.BehaviorTreeDefines.CanUseLevelAiBehaviorTree(this.Entity)) return !(this.bjr = !1);
    this.wjr = new LevelAiWorldState_1.LevelAiWorldState, this.DisableAiHandle = new BaseActorComponent_1.DisableEntityHandle("SetLevelAiDisableInGame");
    var t, e = (0, IComponent_1.getComponent)(e.ComponentsData, "VarComponent");
    if (e) {
      for (const i of e.Vars) "Int" === i.Type && (t = i.Value, this.wjr.SetIntWorldState(i.Name, t));
      EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.EntityVarUpdate, this.Nza)
    } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelAi", 42, "实体未勾选VarComponent组件，请检查是否确定不使用配置变量。", ["实体ID", this.ConfigId]);
    return !0
  }
  OnStart() {
    if (this.bjr && this.OPt?.States) {
      this.xjr = new LevelAiPlanInstance_1.LevelAiPlanInstance, this.xjr.Initialize(this), this.Pjr = new LevelAi_1.LevelAi;
      let e = 1;
  ...
  OnActivate() {
    this.bjr && this.Entity.GetComponent(46)?.InLevelAiControl() && this.StartLevelAi()
  }
  OnTick(e) {
    this.bjr && this.qjr && this.xjr.Tick(e)
  }
  OnEnd() {
    return this.bjr && (this.xjr.Stop(), EventSystem_1.EventSystem.HasWithTarget(this.Entity, EventDefine_1.EEventName.EntityVarUpdate, this.Nza)) && EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.EntityVarUpdate, this.Nza), !0
  }
  StartLevelAi() {
  ...
  Pause(e) {
    var t;
    return !!this.bjr && (this.EFr.has(e) ? (Log_1.Log.CheckWarn() && Log_1.Log.Warn("LevelAi", 50, "[CharacterPlanComponent] 重复使用关闭Ai的Key", ["entity", this.constructor.name], ["PbDataId", this.ConfigId], ["Key", e]), !1) : (t = this.DisableAiHandle.Disable(e, this.constructor.name), this.EFr.set(e, t), void 0 === this.sxr && (this.Gjr = !0, this.qjr = !1, this.xjr.Pause(), this.sxr = this.Disable("[CharacterPlanComponent.PauseAi]")), !0))
  }
  Resume(e) {
    var t;
    return !(!this.bjr || (t = this.EFr.get(e), this.EFr.delete(e) ? !this.DisableAiHandle.Enable(t, this.constructor.name) || (this.DisableAiHandle.Empty && (this.Gjr = !1, this.qjr = !0, this.xjr.Resume(), this.Enable(this.sxr, "CharacterPlanComponent.Resume"), this.sxr = void 0), 0) : (Log_1.Log.CheckDebug() && Log_1.Log.Debug("LevelAi", 50, "[CharacterPlanComponent] 开启Ai使用了未定义的Key", ["entity", this.constructor.name], ["PbDataId", this.ConfigId], ["Key", e]), 1)))
  }
  ...
  FindActiveTaskInfo(t) {
    let i = void 0;
    var e = this.FindPlanInstanceBy(e => void 0 !== (i = e.FindActiveTaskInfo(t)));
    if (e && i.PlanInstance === e) return i
  }
  FindActiveDecoratorInfo(t) {
    let i = void 0;
    var e = this.FindPlanInstanceBy(e => void 0 !== (i = e.FindActiveDecoratorInfo(t)));
    if (e && i.PlanInstance === e) return i
  }
  Njr(e, t) {
    if ("Actions" === e.Behaviour.Type) {
      ...
      n.Serialize(this, this.u1t, "状态" + t), n.Actions = e.Behaviour.Actions;
  ...
  Ojr(e, t) {
    if ("Spline" === e.Behaviour.Type && e.Behaviour.SplineEntityId) {
      ...
      n.Serialize(this, this.u1t, "状态" + t), n.SplineId = e.Behaviour.SplineEntityId;
      for (const r of e.Condition.Conditions) {
        var s = new(i.FindDecoratorCtor(r.Type));
        s.Serialize(this, this.u1t, "状态" + t, r), n.Decorators.push(s)
      }
...
CharacterPlanComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(73)], CharacterPlanComponent), exports.CharacterPlanComponent = CharacterPlanComponent;
