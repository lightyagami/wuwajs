...
class GameplayCueSkillTargetBeam extends GameplayCueBase_1.GameplayCueBase {
  ...
  OnTick(t) {
    ...
    let s = "";
    var h;
    var a = this.EntityHandle.Entity.GetComponent(34);
    var m = this.EntityHandle.Entity.GetComponent(3);
    s = a && m?.IsAutonomousProxy ? (e = a.GetCurrentTarget(), a.GetCurrentTargetSocketName()) : (m = this.EntityHandle.Entity.GetComponent(43), e = m.SkillTarget, m.SkillTargetSocket);
    if (e) {
      if (s) {
