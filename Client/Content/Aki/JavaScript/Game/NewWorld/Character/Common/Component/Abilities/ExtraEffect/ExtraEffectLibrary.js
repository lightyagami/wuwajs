      ...
      switch (i) {
        case 3:
          ...
          s.Requirements.push({
            ...
            RequireInterval: new CharacterAttributeIntervalCheck_1.AttributeIntervalCheck(Number(b), Number(p), Number(l), Number(y) === 1)
          });
          break;
        case 6:
          s.Requirements.push({
        ...
        case 21:
          s.Requirements.push({
            Type: i,
            RequireTargetType1: Number(u[0]),
            RequireTargetType2: Number(u[1]),
            Relationship: Number(u[2])
          });
          break;
        default:
