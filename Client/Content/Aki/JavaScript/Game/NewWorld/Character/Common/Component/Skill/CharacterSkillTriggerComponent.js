...
var __decorate = this && this.__decorate || function(e, t, r, i) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, r, i);
    ...
    for (var l = e.length - 1; 0 <= l; l--)(o = e[l]) && (s = (n < 3 ? o(s) : 3 < n ? o(t, r, s) : o(t, r)) || s);
...
let CharacterSkillTriggerComponent = class CharacterSkillTriggerComponent extends EntityComponent_1.EntityComponent {
  ...
  OnInit() {
    return this.cBe = this.Entity.CheckGetComponent(39), this.dHs = this.Entity.CheckGetComponent(28), !0
  }
  OnStart() {
    return !0
  }
    ...
    if (t)
      for (let e = 0; e < t.SkillTriggers.Num(); e++) {
        ...
        if (i.TriggerType in TriggerType_1.ETriggerEvent) {
          var o, n = [];
          if (i.TriggerPreset)
            for (let e = 0; e < i.TriggerPreset.Num(); e++) n.push(i.TriggerPreset.Get(e));
          TriggerType_1.ETriggerEvent[i.TriggerType] === TriggerType_1.ETriggerEvent.GlobalDamageTrigger ? CombatLog_1.CombatLog.Error("Skill", this.Entity, "禁止白名单之外的技能使用全局伤害监听", ["skillId", r]) : (o = this.dHs.AddTrigger({
            Type: i.TriggerType,
            Preset: n,
        ...
        } else CombatLog_1.CombatLog.Error("Skill", this.Entity, "技能触发器类型不合法", ["技能Id", r], ["触发器类型", i.TriggerType])
      }
  }
...
CharacterSkillTriggerComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(208)], CharacterSkillTriggerComponent), exports.CharacterSkillTriggerComponent = CharacterSkillTriggerComponent;
