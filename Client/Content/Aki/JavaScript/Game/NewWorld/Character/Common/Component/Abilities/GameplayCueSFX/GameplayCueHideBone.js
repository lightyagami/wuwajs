...
class GameplayCueHideBone extends GameplayCueBase_1.GameplayCueBase {
  ...
  Q$o(e) {
    ...
    e || (s = !s), this.ActorInternal.Mesh.IsBoneHiddenByName(t) !== s && (s ? this.ActorInternal.Mesh.HideBoneByName(t, Number(this.CueConfig.Parameters[1]) ?? 0) : this.ActorInternal.Mesh.UnHideBoneByName(t))
  }
}
