...
class MeshComponentUtils {
  ...
  static RelativeAttachComponentOnSafe(t, e, i = FNameUtil_1.FNameUtil.EMPTY) {
    return e !== t.GetAttachParent() && (MeshComponentUtils.RelativeAttachComponent(t, e, i), !0)
  }
  static HideBone(t, e, i) {
    e = FNameUtil_1.FNameUtil.GetDynamicFName(e);
    FNameUtil_1.FNameUtil.IsEmpty(t.GetParentBone(e)) ? t.SetHiddenInGame(i) : t.IsBoneHiddenByName(e) !== i && (i ? t.HideBoneByName(e, 0) : t.UnHideBoneByName(e))
  }
}
