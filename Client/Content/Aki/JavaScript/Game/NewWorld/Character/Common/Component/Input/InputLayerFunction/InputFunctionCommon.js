...
exports.hasEnoughEnergy = exports.createInputCommandFromDataTable = exports.canCharacterResponseInput = exports.canVehicleResponseInput = exports.canResponseInput = exports.createSkillCommand = undefined;
const UE = require("ue");
...
function createSkillCommand(e, t) {
  if (t !== 0) {
    ...
    if (e && e.Valid) {
      r = e.GetSkillInfo(t);
      n = e.GetPriority(t);
      o = e.GetSkillIdWithGroupId(1);
      if ((o = e.GetActivePriority(o)) < n || e.IsMainSkillReadyEnd || n === o && e.SkillAcceptInput || r && r.GroupId !== 1) {
          ...
          if (o.HasTag(a.Tag.TagId)) {
            ...
            if (e = a.BehaviorConditionGroup.Num() === 0 || SkillBehaviorCondition_1.SkillBehaviorCondition.SatisfyGroup(a.BehaviorConditionGroup, a.BehaviorConditionFormula, {
              ...
              if (a.Command.CommandType === 1) {
                return createSkillCommand(n, a.Command.IntValue);
              } else {
...
exports.canCharacterResponseInput = canCharacterResponseInput;
