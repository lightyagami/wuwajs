...
var __decorate = this && this.__decorate || function(t, e, o, a) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(t, e, o, a);
    ...
    for (var s = t.length - 1; 0 <= s; s--)(n = t[s]) && (r = (i < 3 ? n(r) : 3 < i ? n(e, o, r) : n(e, o)) || r);
...
let CharacterStateMachineNewComponent = class CharacterStateMachineNewComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.StateMachineName = "", this.StateMachineJsonObject = void 0, this.StateMachineGroup = void 0
  }
  OnTick(t) {
    this.StateMachineGroup.OnTick(t)
  }
  OnInit() {
    return this.StateMachineGroup = new AiStateMachineGroup_1.AiStateMachineGroup(this), !0
  }
  OnActivate() {
  ...
  static ChangeStateNotify(t, e, o) {
    ...
    (t?.GetComponent(76))?.StateMachineGroup.HandleSwitch(e.$4n, e.J4n, e.z4n, o)
  }
  ...
  static FsmResetNotify(t, e, o) {
    o = MathUtils_1.MathUtils.LongToBigInt(o.$8n);
    (t?.GetComponent(76))?.StateMachineGroup.ResetStateMachine(e.Uys, o)
  }
...
__decorate([CombatMessage_1.CombatNet.Listen("e3n", !0)], CharacterStateMachineNewComponent, "ChangeStateNotify", null), __decorate([CombatMessage_1.CombatNet.Listen("t3n", !0)], CharacterStateMachineNewComponent, "ChangeStateConfirmNotify", null), __decorate([CombatMessage_1.CombatNet.Listen("n3n", !0)], CharacterStateMachineNewComponent, "FsmResetNotify", null), __decorate([CombatMessage_1.CombatNet.Listen("h3n", !0)], CharacterStateMachineNewComponent, "FsmBlackboardNotify", null), __decorate([CombatMessage_1.CombatNet.Listen("I3n", !0)], CharacterStateMachineNewComponent, "FsmCustomBlackboardNotify", null), CharacterStateMachineNewComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(76)], CharacterStateMachineNewComponent), exports.CharacterStateMachineNewComponent = CharacterStateMachineNewComponent;
