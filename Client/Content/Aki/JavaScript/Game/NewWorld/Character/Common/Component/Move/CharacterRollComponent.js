...
var __decorate = this && this.__decorate || function(e, t, n, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, t, n, o);
    ...
    for (var h = e.length - 1; 0 <= h; h--)(i = e[h]) && (r = (s < 3 ? i(r) : 3 < s ? i(t, n, r) : i(t, n)) || r);
...
let CharacterRollComponent = class CharacterRollComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.Gce = void 0, this.Ixa = (0, puerts_1.$ref)(void 0), this.Txa = 1200, this.Lxa = .1, this.Dxa = 1e3, this.Axa = 1960, this.Rxa = 100, this.nun = 4e3, this.Uxa = e => {
  ...
  OnStart() {
    return this.Gce = this.Entity.GetComponent(178), EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.CustomMoveRoll, this.Uxa), !0
  }
  OnEnd() {
    return EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.CustomMoveRoll, this.Uxa), !0
  }
  EnterRoll(e, t, n, o, i, s) {
    this.Txa = e, this.Lxa = t, this.Dxa = n, this.Axa = o, this.Rxa = i, this.nun = s, this.Gce?.ActorComp?.Actor.KuroSetMovementMode({
      Mode: 6,
...
CharacterRollComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(37)], CharacterRollComponent), exports.CharacterRollComponent = CharacterRollComponent;
