...
class SceneComponentPool {
  constructor() {
    this.iJo = new Array, this.oJo = new Array, this.AttachComponentInternal = void 0, this.ActorInternal = void 0, this.MaxPoolSize = 0
  }
  ActiveComponent(t) {}
  CleanComponent(t) {}
  CreateComponent() {}
  GetComponents(t, i = !0, e = !1) {
    ...
    if (i) {
      ...
      for (let t = 0; t < s; ++t) this.PoolPushInternal(this.oJo[t], o, !1), e && this.CleanComponent(this.oJo[t])
    }
    if (0 < h) {
      let s = 0;
      i = this.iJo.length;
  ...
  BackComponent(t) {
    ...
    for (const e of t) {
      var i;
      this.oJo.concat(e) ? (i = this.oJo.indexOf(e), this.iJo.push(e), this.oJo.slice(i, 1)) : s = !1
    }
    return s
  }
  Init(t, s, i, e, h = !1, o = !1) {
    if (s && i && 0 < t) {
      this.ActorInternal = i, this.MaxPoolSize = t, this.AttachComponentInternal = s;
      var i = e.length,
        r = t < i ? t : i;
      for (let t = 0; t < r; ++t) {
        var n = e[t];
        if (MeshComponentUtils_1.MeshComponentUtils.RelativeAttachComponentOnSafe(n, this.AttachComponentInternal), this.iJo.push(), !this.PoolPush(n, h, o)) break
      }
    }
  }
  CheckPoolRange() {
  ...
  PoolPush(t, s = !1, i = !0) {
    return !!this.CheckPoolRange() && (s ? this.BasePoolPush(t, i) : this.UsedPoolPush(t, i), !0)
  }
  BasePoolPush(t, s = !0) {
