...
class AbilityUtils {
  static GetLevelValue(t, e, r) {
    return t && 0 !== t.length ? 1 <= e && e - 1 < t.length ? t[e - 1] : 0 === e ? t[0] : t[t.length - 1] : r
  }
  static GetArrayValue(t, e, r) {
    return !t || 0 === t.length || e < 0 ? r : e < t.length ? t[e] : t[t.length - 1]
  }
  ...
  static SetSpecialEnergyAttrValue(t, e, r) {
    CharacterAttributeTypes_1.specialEnergyIds.includes(e) && (t = EntitySystem_1.EntitySystem.GetComponent(t, 172))?.Valid && t.SetBaseValue(e, r)
  }
}
