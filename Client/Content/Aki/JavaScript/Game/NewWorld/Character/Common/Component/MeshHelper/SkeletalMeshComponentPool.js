...
class SkeletalMeshComponentPool extends SceneComponentPool_1.SceneComponentPool {
  ...
  CleanComponent(e) {
    e.SetSkeletalMesh(void 0), e.SetAnimClass(void 0), e.SetHiddenInGame(!0), e.SetComponentTickEnabled(!1)
  }
  CreateComponent() {
    var e;
    if (this.CheckPoolRange()) return e = this.ActorInternal.AddComponentByClass(UE.SkeletalMeshComponent.StaticClass(), !1, MathUtils_1.MathUtils.DefaultTransform, !1), MeshComponentUtils_1.MeshComponentUtils.RelativeAttachComponentOnSafe(e, this.AttachComponentInternal), e
  }
}
