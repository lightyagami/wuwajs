...
let CharacterSwimComponent = CharacterSwimComponent_1 = class CharacterSwimComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.hWr = (t, i) => {
      ...
      if (this.EnterSwimFromAirBuffIndex) {
        this.Entity.GetComponent(185)?.RemoveBuffByHandle(this.EnterSwimFromAirBuffIndex, -1, "空中入水结束");
  ...
  GWr() {
    ...
    this.RWr = this.Entity.GetComponent(36);
  ...
  zWr(i) {
    ...
    for (let t = 0; t < _; ++t) {
      ...
      if (a?.IsValid()) {
        if (UE.KuroCollisionLibrary.ActorHasTag(a, CharacterSwimComponent_1.ZWr, i.ItemArray.Get(t))) {
          e = true;
      ...
      if (!s) {
        ...
        if (t) {
          ...
          if (!!this.rKr(this.IWr) && !((s = this.UWr).DeepCopy(this.yWr), (i = this.AWr).FromUeVector(s), GravityUtils_1.GravityUtils.AddZnInGravityForActor(this.Hte, i, -this.vWr * ENTER_SWIM_BIGGER_THAN_THIS * 2), this.eKr(s, i))) {
            ...
            if (h = this.Entity.GetComponent(185)) {
...
CharacterSwimComponent = CharacterSwimComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(82)], CharacterSwimComponent);
