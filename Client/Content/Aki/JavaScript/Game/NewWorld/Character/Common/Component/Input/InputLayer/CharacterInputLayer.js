...
exports.CharacterInputLayer = undefined;
const UE = require("ue");
...
class CharacterInputLayer extends InputLayer_1.InputLayer {
  ...
  Init(s) {
    ...
    if (!this.Aia) {
      if (s = t.InputComponentClass?.AssetPathName.toString() ?? "") {
...
CharacterInputLayer.q0l = Stats_1.Stat.Create("CharacterInputLayer.HandleRelease"); //# sourceMappingURL=CharacterInputLayer.js.map