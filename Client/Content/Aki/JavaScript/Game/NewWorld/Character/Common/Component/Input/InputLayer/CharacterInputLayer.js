...
class CharacterInputLayer extends InputLayer_1.InputLayer {
  constructor() {
    super(...arguments), this.Aia = void 0, this.Xmu = void 0
  }
  Init(s) {
    const t = s.Entity.GetComponent(3).Actor;
    this.ResetBpInputComp(), this.Aia || ((s = t.InputComponentClass?.AssetPathName.toString() ?? "") ? ResourceSystem_1.ResourceSystem.LoadAsync(s, UE.Class, s => {
      this.Aia = t.AddComponentByClass(s, !1, MathUtils_1.MathUtils.DefaultTransform, !1), this.Aia.OwnerActor = t, this.Xmu = this.Aia
    }) : Log_1.Log.CheckError() && Log_1.Log.Error("Input", 67, "[CharacterInputLayer]加载BpInput失败", ["Role", t.GetName()]))
  }
  Clear() {
    this.Aia = void 0, this.Xmu = void 0
  }
  GetLayerType() {
    return 1
  }
...
}(exports.CharacterInputLayer = CharacterInputLayer).b0l = Stats_1.Stat.Create("CharacterInputLayer.HandlePress"), CharacterInputLayer.q0l = Stats_1.Stat.Create("CharacterInputLayer.HandleRelease");
