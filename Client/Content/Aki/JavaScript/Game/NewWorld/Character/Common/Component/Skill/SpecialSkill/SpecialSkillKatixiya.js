...
class SpecialSkillKatixiya extends SpecialSkillBase_1.SpecialSkillBase {
  constructor() {
    ...
    this.eNu = new Set();
    this.lF1 = (e, t) => {
      if (e.Entity?.Id === this.SpecialSkillComponent.Entity.Id && this.zIu?.IsMorphing() && !this.UBu?.IsInQte && t?.Entity?.GetComponent(176)?.PositionState !== CharacterUnifiedStateTypes_1.ECharPositionState.Ground && this.EAu) {
  ...
  OnStart() {
    ...
    this.zIu = e.GetComponent(283);
    this.aeu = e.GetComponent(226);
    this.UBu = e.GetComponent(99);
    this.yqu = e.GetComponent(93);
    this.EAu = [];
    ...
    this.h0d = this.Lie?.ListenForTagAddOrRemove(262865373, this.l0d);
  }
  OnEnd() {
    var e = this.SpecialSkillComponent.Entity;
