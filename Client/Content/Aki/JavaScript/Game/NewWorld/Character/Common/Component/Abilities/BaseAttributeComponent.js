"use strict";
var BaseAttributeComponent_1, __decorate = this && this.__decorate || function(t, e, r, i) {
  var s, a = arguments.length,
    o = a < 3 ? e : null === i ? i = Object.getOwnPropertyDescriptor(e, r) : i;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, r, i);
  else
    for (var n = t.length - 1; 0 <= n; n--)(s = t[n]) && (o = (a < 3 ? s(o) : 3 < a ? s(e, r, o) : s(e, r)) || o);
...
let BaseAttributeComponent = BaseAttributeComponent_1 = class BaseAttributeComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.BaseValues = new Array(CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX), this.CurrentValues = new Array(CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX), this.ModifierLists = new Array(CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX), this.BoundsLockerMap = new Map, this.CreatureDataComponent = void 0, this.BuffComponent = void 0, this.CurrentValueListenerMap = new Map, this.AnyCurrentValueListenerSet = new Set
  }
  OnInit() {
    return super.OnInit(), this.CreatureDataComponent = this.Entity.CheckGetComponent(0), this.BuffComponent = this.Entity.GetComponent(209), !0
  }
  OnCreate() {
    for (let t = 0; t < CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX; ++t) this.BaseValues[t] = 0;
    for (let t = 0; t < CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX; ++t) this.CurrentValues[t] = 0;
    for (let t = 0; t < CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX; ++t) this.ModifierLists[t] = new Map;
    return !0
  }
  OnTick(t) {
  ...
  IsWritableAttribute(t) {
    if (CharacterAttributeTypes_1.attrsAutoRecoverSpeedMap.has(t) || CharacterAttributeTypes_1.attrsAutoRecoverMaxMap.has(t)) return !0;
    switch (t) {
      case CharacterAttributeTypes_1.EAttributeId.Proto_Tough:
      case CharacterAttributeTypes_1.EAttributeId.Proto_Jump:
        return !0;
      default:
        return CharacterAttributeTypes_1.specialEnergyIds.includes(t) ? !this.BuffComponent || this.BuffComponent.HasBuffAuthority() : !1
    }
    return !1
  }
  IsLocalAttribute(t) {
  ...
  SetBaseValue(e, r) {
    if (this.IsWritableAttribute(e)) {
      let t = r;
      var i, r = this.mbr(e),
        r = (void 0 !== r && (t = this.dbr(e, t, r)), CharacterAttributeTypes_1.attrsNotClampZero.includes(e) || (t = Math.max(t, 0)), t = Math.floor(t), this.BaseValues[e]);
      r !== t && (this.BaseValues[e] = t, r = this.CurrentValues[e], this.UpdateCurrentValue(e), i = this.CurrentValues[e], this.DispatchCurrentValueEvent(e, i, r))
    }
  }
  AddBaseValue(t, e) {
  ...
  SyncValueFromServer(t, e, r) {
    !this.IsLocalAttribute(t) && (this.BaseValues[t] !== e && (this.BaseValues[t] = e), e = this.CurrentValues[t], this.CurrentValues[t] = r, this.DispatchCurrentValueEvent(t, r, e), r = CharacterAttributeTypes_1.attributeIdsMaxToAttrId.get(t)) && this.SetBaseValue(r, this.BaseValues[r])
  }
  UpdateCurrentValue(e) {
    if (BaseAttributeComponent_1.s__.Start(), this.IsWritableAttribute(e)) {
      ...
      var r = CharacterAttributeTypes_1.attrsCurrentValueClamp.get(e),
        r;
      r && (t = Math.min(t, r)), CharacterAttributeTypes_1.attrsNotClampZero.includes(e) || (t = Math.max(t, 0)), (r = this.CurrentValues[e]) !== t && (this.CurrentValues[e] = t)
    }
  ...
  TakeSnapshot() {
    ...
    for (let t = 1; t < CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX; t++) {
      ...
      r && (e.BaseValues[r] = this.BaseValues[t] ?? 0, e.CurrentValues[r] = this.CurrentValues[t] ?? 0)
    }
    return e
  }
  AddModifier(t, e) {
    var r, i;
    return BaseAttributeComponent_1.a__.Start(), !this.IsWritableAttribute(t) || t <= CharacterAttributeTypes_1.EAttributeId.Proto_EAttributeType_None || t >= CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX ? (BaseAttributeComponent_1.a__.Stop(), -1) : (r = BaseAttributeComponent_1.ModifierHandleGenerator++, this.ModifierLists[t] = this.ModifierLists[t] ?? new Map, this.ModifierLists[t].set(r, e), e = this.CurrentValues[t], this.UpdateCurrentValue(t), i = this.CurrentValues[t], this.DispatchCurrentValueEvent(t, i, e), BaseAttributeComponent_1.a__.Stop(), r)
  }
  RemoveModifier(t, e) {
    var r;
    BaseAttributeComponent_1.h__.Start(), this.ModifierLists[t]?.delete(e) && (e = this.CurrentValues[t], this.UpdateCurrentValue(t), r = this.CurrentValues[t], this.DispatchCurrentValueEvent(t, r, e)), BaseAttributeComponent_1.h__.Stop()
  }* GetAllModifiers(t) {
    ...
    for (const n of this.GetAllModifiers(t)) {
      ...
      switch (n.Type) {
        ...
        case 9: {
          ...
          void 0 === t && (t = AbilityUtils_1.AbilityUtils.GetAttrValue(0 === n.SourceEntity ? this : ModelManager_1.ModelManager.CreatureModel.GetEntity(n.SourceEntity)?.Entity?.GetComponent(173), n.SourceAttributeId, n.SourceCalculationType));
          var o = n.Min;
          if (o && (t -= o) <= 0) break;
          o = n.Ratio;
          if (o && (t /= o), 9 === n.Type) {
      ...
      0 !== e && (a ? s *= e * CharacterAttributeTypes_1.DIVIDED_TEN_THOUSAND + 1 : r += e)
    }
  ...
  SyncRecoverPropFromServer(t, e, r, i, s) {
    ...
    a && o ? (this.SyncValueFromServer(a, i, i), this.SyncValueFromServer(o, r, r), a = e + i * s * CommonDefine_1.SECOND_PER_MILLIONSECOND, this.SyncValueFromServer(t, a, a)) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 35, "自动属性未注册", ["属性", t])
  }
  AutoRecoverAttr(t) {
    BaseAttributeComponent_1.___.Start();
    var e, r, i = t * Time_1.Time.FlowTimeDilation * CommonDefine_1.SECOND_PER_MILLIONSECOND;
  ...
  AddBoundsLocker(t, e, r) {
    ...
    return i || this.BoundsLockerMap.set(t, i = new Map), i.has(r) ? Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 22, "重复添加属性BoundsLock", ["attrId", t], ["handle", r]) : (i.set(r, e), this.SetBaseValue(t, this.BaseValues[t])), r
  }
  RemoveBoundsLocker(t, e) {
    var r = this.BoundsLockerMap.get(t);
    return !!r && !!r.delete(e) && (this.SetBaseValue(t, this.BaseValues[t]), !0)
  }* GetAllBoundsLocker(t) {
    t = this.BoundsLockerMap.get(t);
    if (t)
      for (const e of t.values()) yield e
  }
  dbr(t, e, r) {
    let i = e,
      s = void 0,
    ...
    for (const n of this.GetAllBoundsLocker(t)) {
      var o;
      n.LockLowerBounds && (o = n.LowerPercent * r + n.LowerOffset, s = Math.max(s ?? o, o)), n.LockUpperBounds && (o = n.UpperPercent * r + n.UpperOffset, a = Math.min(a ?? o, o))
    }
    return void 0 !== a && (i = Math.min(a, i)), i = void 0 !== s ? Math.max(s, i) : i
  }
  AddIntervalLock(t, e, r, i, s) {
    var a;
    r !== CharacterAttributeTypes_1.EAttributeId.Proto_Life && (i = {
      LockUpperBounds: !(a = {
        LockUpperBounds: !0,
        LockLowerBounds: !1,
  ...
  AddListener(t, e, r) {
    ...
    i ? i.add(e) : ((i = new Set).add(e), this.CurrentValueListenerMap.set(t, i))
  }
  AddListeners(t, e, r) {
    t.forEach(t => {
  ...
  DispatchCurrentValueEvent(e, r, i) {
    if (BaseAttributeComponent_1.c__.Start(), i !== r) {
      ...
      if (s) {
        ...
        t || BaseAttributeComponent_1.pbr.set(e, t = Stats_1.Stat.CreateNoFlameGraph(`CurrentAttr#${e} event`, StatDefine_1.BATTLESTAT_GROUP));
        for (const a of s) {
          t?.Start();
          try {
            a(e, r, i)
  ...
  GetDebugString() {
    ...
    for (let t = 1; t < CharacterAttributeTypes_1.ATTRIBUTE_ID_MAX; ++t) {
      var r = t;
      0 === this.BaseValues[r] && 0 === this.CurrentValues[r] || e.push(`${r} ${this.BaseValues[r]} ` + this.CurrentValues[r])
    }
    return e.join("|")
  }
  GetLockDebugString() {
    let i = "";
    return this.BoundsLockerMap.forEach((t, r) => {
      t.forEach((t, e) => {
        t.LockLowerBounds && (i += `属性:${r} 下限:${100*t.LowerPercent}%+${t.LowerOffset} handle:${e}
