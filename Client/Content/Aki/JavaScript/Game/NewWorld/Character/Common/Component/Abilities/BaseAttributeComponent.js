...
let BaseAttributeComponent = BaseAttributeComponent_1 = class BaseAttributeComponent extends EntityComponent_1.EntityComponent {
  ...
  OnInit() {
    ...
    this.BuffComponent = this.Entity.GetComponent(222);
    return true;
  }
  OnCreate() {
  ...
  IsWritableAttribute(t) {
    ...
    switch (t) {
      ...
      case CharacterAttributeTypes_1.EAttributeId.jIm:
        return true;
      default:
  ...
  IsLocalAttribute(t) {
    return t === CharacterAttributeTypes_1.EAttributeId.jIm || !!CharacterAttributeTypes_1.specialEnergyIds.includes(t) && (!this.BuffComponent || this.BuffComponent.HasBuffAuthority());
  }
  SetBaseValue(e, r) {
        ...
        case 9:
          {
            ...
            if (t === undefined) {
              t = AbilityUtils_1.AbilityUtils.GetAttrValue(n.SourceEntity === 0 ? this : ModelManager_1.ModelManager.CreatureModel.GetEntity(n.SourceEntity)?.Entity?.GetComponent(184), n.SourceAttributeId, n.SourceCalculationType);
            }
            var o = n.Min;
            if (o && (t -= o) <= 0) {
              break;
...
BaseAttributeComponent = BaseAttributeComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(183)], BaseAttributeComponent);
