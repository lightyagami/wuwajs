...
class TsGameplayBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static AddTagByName(t, e) {
    ...
    i?.Valid && void 0 !== (e = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e)) && (i.AddTag(e), i = ModelManager_1.ModelManager.CreatureModel.GetCreatureDataId(t), t = StringUtils_1.StringUtils.Format("GmAddTag {0} {1} 1", i.toString(), e.toString()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RunGm, t))
  }
  ...
  static RemoveTagByName(t, e) {
    var i = EntitySystem_1.EntitySystem.GetComponent(t, 205);
    i?.Valid && void 0 !== (e = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e)) && (i.RemoveTag(e), i = ModelManager_1.ModelManager.CreatureModel.GetCreatureDataId(t), t = StringUtils_1.StringUtils.Format("GmRemoveTag {0} {1}", i.toString(), e.toString()), EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.RunGm, t))
  }
  static AddCue(t, e, i) {
    var r = EntitySystem_1.EntitySystem.GetComponent(e, 21);
    r?.Valid && (t = ModelManager_1.ModelManager.CreatureModel.GetEntityById(t || e), r.AddCue(Number(i), {
      Instigator: t
    }))
  }
  ...
  static IsLogicAutonomousProxy(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 3)?.IsAutonomousProxy ?? !1
  }
  ...
  static AddBuffForDebug(t, e, i) {
    var r, t = ModelManager_1.ModelManager.CreatureModel.GetCreatureDataId(t);
    t && ((r = EntitySystem_1.EntitySystem.GetComponent(e, 174)) ? r.AddBuffForDebug(Number(i), {
      InstigatorId: t,
      Reason: "AddBuffForDebug"
    }) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 19, "添加buff对象没有BuffComponent", ["TargetEntityId", e], ["BuffId", i]))
  }
  static GetSpecialBuffToSkillId(t, e) {
    return "" !== e ? e : (e = CharacterBuffIds_1.specialBuffToSkillIdMap.get(t)) ? e.toString() : ""
  }
  ...
  static AddBuffFromGA(i, r, n, a, s) {
    ...
    if ("" === a && -1 === CharacterBuffIds_1.specialIgnoreGaBuff.findIndex(t => t === Number(n))) Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 35, "AddBuffFromGA的SkillId为空", ["buffId", n]);
    else {
      ...
      if (o) {
        ...
        t || (y = EntitySystem_1.EntitySystem.GetComponent(i, 0).GetSummonerId(), e = (0 < y ? (y = (ModelManager_1.ModelManager.CreatureModel.GetEntity(y)?.Entity)?.GetComponent(39), t = y?.GetSkill(Number(a))?.MNc, y?.GetSkill(Number(a))) : (y = TsGameplayBlueprintFunctionLibrary.TryGetSummonedEntitySkill(i, Number(a)), t = y?.MNc, y))?.AbilityClass?.GetName()), r instanceof TsBaseCharacter_1.default && ((i = r.CharacterActorComponent.Entity.CheckGetComponent(174)) ? i.AddBuff(Number(n), {
          InstigatorId: o,
          Reason: `技能${a}GA${e}的buff添加`,
          PreMessageId: t,
          OuterStackCount: s
        }) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 19, "添加buff对象没有BuffComponent", ["Target", r.GetName()], ["BuffId", n]))
      }
    }
  }
  ...
  static AddGameplayCueLocal(t, e, i) {
    ...
    t?.Valid && (i = [Number(i)], t.AddGameplayCue(i, e, "蓝图AddGameplayCueLocal"))
  }
  ...
  static GetServerDebugInfoDirty(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 22)?.ServerDebugInfoDirty ?? !1
  }
  ...
  static DebugResetBaseVal(t, e, i) {
    var r = EntitySystem_1.EntitySystem.GetComponent(t, 22),
      r = (r && r?.DebugResetBaseValue(e, i), ModelManager_1.ModelManager.CreatureModel.GetCreatureDataId(t)),
      t = StringUtils_1.StringUtils.Format("GmSetAttribute {0} {1} {2}", r.toString(), e.toString(), i.toString());
  ...
  static Record(t, e) {
    return Info_1.Info.IsBuildDevelopmentOrDebug ? e ? (CharacterGasDebugComponent_1.CharacterGasDebugComponent.BeginRecord(), "") : CharacterGasDebugComponent_1.CharacterGasDebugComponent.EndRecord() : ""
  }
  static RefreshEntityListView(e) {
    var t, i = e.GetListItems(),
      r = new Set;
    ...
    for (const s of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) r.has(s.Id) || (t = (t = s?.Entity?.GetComponent(3)?.Actor?.GetName()) ? `${s.constructor.name}_${s.Id}[${t}]` : s.constructor.name + "_" + s.Id, t = new UE.Layer(e, s.Id + "," + t), e.AddItem(t))
  }
  static RefreshEntityComboBox(e) {
    var t, i, r = e.GetOptionCount(),
      n = new Set;
    for (let t = r - 1; 0 <= t; t--) {
      var a = e.GetOptionAtIndex(t),
        s = Number(/_(?<entityId>\d+)$/.exec(a)?.groups.entityId ?? 0);
      0 === s || n.has(s) || !EntitySystem_1.EntitySystem.Get(s) ? e.RemoveOption(a) : n.add(s)
    }
    for (const o of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) n.has(o?.Id) || ((i = (t = o?.Entity)?.GetComponent(3)?.Actor?.GetName()) ? e.AddOption(i + "_" + o.Id) : (i = t?.GetComponent(233)) && i.VehicleFeatures.has(2) && (i = t?.GetComponent(1)?.Owner?.GetName(), e.AddOption(i + "_" + o.Id)))
  }
  static SetEntityComboBox(t, e) {
    var i = EntitySystem_1.EntitySystem.Get(e),
      r = i?.GetComponent(1)?.Owner?.GetName(),
      n = t.GetSelectedOption();
    i && r ? Number(/_(?<entityId>\d+)$/.exec(n)?.groups.entityId ?? -1) !== e && (t.FindOptionIndex(i = r + "_" + e) < 0 && t.AddOption(i), t.SetSelectedOption(i)) : n && t.ClearSelection()
  }
  ...
  static RefreshBuffListView(t, e, i = "") {
    var r = [...i.matchAll(/[0-9]+/g)].map(t => t[0] ?? ""),
      n = EntitySystem_1.EntitySystem.Get(t)?.GetComponent(209);
    if (n) {
      var a, s, o = e.GetListItems(),
        y = new Set;
      for (let t = o.Num() - 1; 0 <= t; t--) {
        var l = o.Get(t);
        const c = n.GetBuffByHandle(Number(l.GetName().split(",")[1]));
        void 0 === c || y.has(c.Handle) || 0 < r.length && !r.some(t => String(c.Id).startsWith(t)) ? e.RemoveItem(l) : y.add(c.Handle)
      }
      for (const S of n.GetAllBuffs()) y.has(S.Handle) || 0 < r.length && !r.some(t => String(S.Id).startsWith(t)) || (a = new UE.Layer(e, t + "," + S.Handle), e.AddItem(a));
      if ((0, RegisterComponent_1.isComponentInstance)(n, 190) && n.GetFormationBuffComp())
        for (const u of n.GetFormationBuffComp().GetAllBuffs()) y.has(u.Handle) || 0 < r.length && !r.some(t => String(u.Id).startsWith(t)) || (s = new UE.Layer(e, t + "," + u.Handle), e.AddItem(s))
  ...
  static GetDebugBuff(t, e) {
    ...
    return i || (!i && (0, RegisterComponent_1.isComponentInstance)(t, 190) ? t.GetFormationBuffComp().GetBuffByHandle(e) : void 0)
  }
  ...
  static GetBuffDescByHandle(t, e) {
    t = TsGameplayBlueprintFunctionLibrary.GetDebugBuff(t, e), e = t?.Config?.Desc ?? "Invalid";
    return (0, RegisterComponent_1.isComponentInstance)(t?.GetOwnerBuffComponent(), 199) ? `【编队buff】
` + e : e
  }
  static GetBuffActivateByHandle(t, e) {
    return TsGameplayBlueprintFunctionLibrary.GetDebugBuff(t, e)?.IsActive() ?? !1
  }
  ...
  static GetBuffPeriodStringByHandle(t, e) {
    t = TsGameplayBlueprintFunctionLibrary.GetDebugBuff(t, e);
    return void 0 !== t && 0 < t.Period ? t.GetRemainPeriod().toFixed(1) + "/" + t.Period.toFixed(1) : "无"
  }
  static GetBuffDurationStringByHandle(t, e) {
    t = TsGameplayBlueprintFunctionLibrary.GetDebugBuff(t, e);
    return void 0 !== t && 0 < t.Duration ? t.GetRemainDuration().toFixed(1) + "/" + t.Duration.toFixed(1) : "无限"
  }
  static GetBuffDurationProgress(t, e) {
    t = TsGameplayBlueprintFunctionLibrary.GetDebugBuff(t, e);
    return void 0 !== t && 0 < t.Duration ? t.GetRemainDuration() / t.Duration : 1
  }
...
`;
    for (const o of a.Config.EffectInfos) {
      ...
      ExtraEffectBaseTypes_1.periodExecutionIds.has(o.ExtraEffectId) && r && (n += "周期效果 \n")
    }
    return a.Config.Modifiers?.forEach(t => {
      var e = AbilityUtils_1.AbilityUtils.GetLevelValue(t.Value1 ?? [], a.Level, 0),
        i = AbilityUtils_1.AbilityUtils.GetLevelValue(t.Value2 ?? [], a.Level, 0),
        r = void 0;
...
`;
  ...
  static OnHit(t, e) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 61), e = BulletTypes_1.HitInformation.FromUeHitInformation(e);
  ...
  static CheckHasPart(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 69)?.IsMultiPart ?? !1
  }
  ...
  static GetAcceptedNewBeHitAndReset(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.GetAcceptedNewBeHitAndReset() ?? !1
  }
  static GetEnterFkAndReset(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.GetEnterFkAndReset() ?? !1
  }
  static IsStiff(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.IsStiff() ?? !1
  }
  ...
  static GetBeHitBone(t) {
    ...
    return t?.BeHitBones && 0 < t?.BeHitBones?.length ? t.BeHitBones[0] : FNameUtil_1.FNameUtil.EMPTY
  }
  ...
  static GetEnterFk(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.EnterFk ?? !1
  }
  ...
  static IsTriggerCounterAttack(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.IsTriggerCounterAttack ?? !1
  }
  ...
  static SetShowTarget(t, e) {
    ...
    t?.Valid && (e ? (e = ActorUtils_1.ActorUtils.GetEntityByActor(e)?.Entity, t.SetShowTarget(new EntityHandle_1.EntityHandle(e))) : t.SetShowTarget(void 0))
  }
  ...
  static ManipulateValid(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 65)?.Valid ?? !1
  }
  ...
  static GetDtSkillInfoMapForDebug(t) {
    ...
    if (t?.Valid) {
      ...
      return t.DtSkillInfoMapForDebug.forEach((t, e) => {
        i.Add(e, t)
      }), i
    }
  }
  ...
  static EndSkill(t, e, i, r) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && t.EndSkill(Number(e), "TsGameplayBlueprintFunctionLibrary.EndSkill")
  }
  ...
  static BeginSkillAsync(t, e, i, r, n) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && t.BeginSkillAsync(Number(e.toString()), {
      Target: i,
  ...
  static GetLocationByAction(t, e, i) {
    ...
    return t && r?.Valid && e ? (t = {
      ...
      SkillComponent: r,
      Skill: e
    }, SkillBehaviorAction_1.SkillBehaviorAction.CalculateLocation(i, t)) : Vector_1.Vector.ZeroVectorDouble
  }
  static GetRotationByAction(t, e, i) {
    ...
    return t && r?.Valid && e ? (t = {
      ...
      SkillComponent: r,
      Skill: e
    }, SkillBehaviorAction_1.SkillBehaviorAction.CalculateRotation(i, t)) : Rotator_1.Rotator.ZeroRotator
  }
  ...
  static GetSkillTarget(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    return t?.Valid && t.SkillTarget ? t.SkillTarget?.Entity?.GetComponent(1)?.Owner : void 0
  }
  static SetSkillTarget(t, e) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && (t.SkillTarget = void 0, e) && (e = ActorUtils_1.ActorUtils.GetEntityByActor(e)?.Entity) && (t.SkillTarget = new EntityHandle_1.EntityHandle(e))
  }
  ...
  static InterruptSkill(t, e, i) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && t.EndSkill(Number(e), "TsGameplayBlueprintFunctionLibrary.InterruptSkill")
  }
  static DeleteSkills(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && t.StopAllSkills("TsGameplayBlueprintFunctionLibrary.DeleteSkills")
  }
  static GetCurrentMontageCorrespondingSkillId(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    return t?.Valid ? t.GetCurrentMontageCorrespondingSkillId()?.toString() : ""
  }
  ...
  static GetPointTransform(t, e) {
    ...
    if (t?.Valid) return e = FNameUtil_1.FNameUtil.GetDynamicFName(e), (t = t.SkeletalMesh)?.DoesSocketExist(e) ? t.D_GetSocketTransform(e, 0) : void 0
  }
  ...
  static SlashHookPointHasLookAtConfig(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 99);
    return !!t?.Valid && void 0 !== t.GetCurrentTarget()?.GetSlashHookCharacterLookAtPoint()
  }
  static SlashHookPointCharacterLookAtPoint(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 99);
    return t?.Valid ? (t.GetCurrentTarget()?.GetSlashHookCharacterLookAtPoint() ?? Vector_1.Vector.ZeroVectorProxy).ToUeVector() : Vector_1.Vector.ZeroVectorDouble
  }
  static SlashHookPointIsTakeOverCamera(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 99);
    return !!t?.Valid && (t.GetCurrentTarget()?.GetLevelPlayTakeOverCamera() ?? !1)
  }
  ...
  static StartChargeSlash(t) {
    ...
    t?.Valid && ControllerHolder_1.ControllerHolder.ChargeSlashGameplayController.StartChargeSlash(t)
  }
  static StopChargeSlash(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 85);
    t?.Valid && ControllerHolder_1.ControllerHolder.ChargeSlashGameplayController.StopChargeSlash(t)
  }
  ...
  static DeleteIgnoreSocketName(t, e) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 39);
    t?.Valid && t.DeleteIgnoreSocketName(FNameUtil_1.FNameUtil.GetDynamicFName(e))
  }
  ...
  static GetIsInGame(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 101)?.IsInGame ?? !1
  }
  ...
  static StandPress(t) {
    ...
    e && e.PositionState === CharacterUnifiedStateTypes_1.ECharPositionState.Ground && EntitySystem_1.EntitySystem.GetComponent(t, 3)?.CreatureData.IsRole() && e.SetMoveState(CharacterUnifiedStateTypes_1.ECharMoveState.Stand)
  }
  static SwingPress(t) {
  ...
  static UpdateAnimInfoHit(t, e) {
    var i, r, n = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    n?.Valid && (t = EntitySystem_1.EntitySystem.GetComponent(t, 61)) && (e = e, n = n.AnimLogicParamsSetter, i = t.GetAcceptedNewBeHitAndReset(), n.AcceptedNewBeHit !== i && (n.AcceptedNewBeHit = i, e.AcceptedNewBeHitRef = i), r = t.BeHitAnim, n.BeHitAnim !== r && (n.BeHitAnim = r, e.BeHitAnimRef = r), i = t.GetEnterFkAndReset(), n.EnterFk !== i && (n.EnterFk = i, e.EnterFkRef = i), i = t.GetDoubleHitInAir(), n.DoubleHitInAir !== i) && (n.DoubleHitInAir = i, e.DoubleHitInAirRef = i)
  }
  static UpdateAnimInfoFk(e, i) {
    ...
    if (r?.Valid) {
      ...
      if (e) {
        ...
        let t = e.BeHitDirect;
        r.BeHitDirect.Equals(t) || (r.BeHitDirect.DeepCopy(t), i.BeHitDirectRef = t.ToUeVectorOld()), t = e.BeHitLocation, r.BeHitLocation.Equals(t) || (r.BeHitLocation.DeepCopy(t), i.BeHitLocationRef = t.ToUeVectorOld())
      }
    }
  }
  static UpdateAnimInfoUnifiedState(t, e) {
    var i, r = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    r?.Valid && (t = EntitySystem_1.EntitySystem.GetComponent(t, 101)) && (e = e, r = r.AnimLogicParamsSetter, i = t.MoveState, r.CharMoveState !== i && (r.CharMoveState = i, e.CharMoveStateRef = i), i = t.PositionState, r.CharPositionState !== i && (r.CharPositionState = i, e.CharPositionStateRef = i), i = t.DirectionState, r.CharCameraState !== i) && (r.CharCameraState = i, e.CharCameraStateRef = i)
  }
  static UpdateAnimInfoUnifiedStateRoleNpc(t, e) {
    var i = EntitySystem_1.EntitySystem.GetComponent(t, 177);
    i?.Valid && (t = EntitySystem_1.EntitySystem.GetComponent(t, 101)) && (e = e, i = i.AnimLogicParamsSetter, t = t.MoveState, i.CharMoveState !== t) && (i.CharMoveState = t, e.CharMoveStateRef = t)
  }
  ...
  static EnvironmentInfoDetect(t, e) {
    ...
    t && ControllerHolder_1.ControllerHolder.WorldController.EnvironmentInfoUpdate(e, t.IsRoleAndCtrlByMe)
  }
  static LockOnSpecifyTarget(t, e) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 32), e = EntitySystem_1.EntitySystem.Get(e);
    t?.Valid && e?.Valid && t.LockOnSpecifyTarget(new EntityHandle_1.EntityHandle(e))
  }
  ...
  static SendHookSkillUseLogData(t, e) {
    ...
    i.i_area_id = ModelManager_1.ModelManager.AreaModel.AreaInfo.AreaId, i.i_father_area_id = ModelManager_1.ModelManager.AreaModel.AreaInfo.Father, i.f_pos_x = t.X, i.f_pos_y = t.Y, i.f_pos_z = t.Z, i.i_has_target = e ? 1 : 0, LogReportController_1.LogReportController.UnitLogReport(i)
  }
  ...
  static DynamicAttachEntityToActor(e, i, r) {
    var n = EntitySystem_1.EntitySystem.Get(e),
      e = EntitySystem_1.EntitySystem.GetComponent(e, 125);
    if (n && e) {
      let t = new UE.TransformDouble;
      var a, i = EntitySystem_1.EntitySystem.Get(i),
        s = i?.GetComponent(1)?.Owner;
      s && (s.IsA(UE.Character.StaticClass()) ? (a = s).Mesh.DoesSocketExist(r) && (t = a.Mesh.D_GetSocketTransform(r, 0)) : t = s.D_GetTransform(), n.GetComponent(1)?.SetActorLocationAndRotation(t.GetLocation(), t.GetRotation().Rotator()), void 0 !== (a = i?.GetComponent(0)?.GetCreatureDataId())) && ((r = new SceneItemDynamicAttachTargetComponent_1.AttachParam).PosAttachType = 1, r.RotAttachType = 1, e.RegEntityTargetByCreatureDataId(a, void 0, r, "DynamicAttachEntityToActor"))
    }
  }
  static SetEntityEnable(t, e, i, r) {
    i?.IsValid() ? (i = `[蓝图:${i.GetName()}] ` + r, (r = EntitySystem_1.EntitySystem.Get(t))?.Valid && ControllerHolder_1.ControllerHolder.CreatureController.SetEntityEnable(r, e, i, !0)) : Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 28, "调用SetEntityEnable失败，因为callObject为空")
  }
  static SetActorVisible(t, e, i, r, n, a = !1) {
    t = EntitySystem_1.EntitySystem.Get(t);
    t?.Valid && ControllerHolder_1.ControllerHolder.CreatureController.SetActorVisible(t, e, i, r, n, a)
  }
  ...
  static ChangeAiControllerDebugDraw(t, e) {
    ...
    i?.Valid ? i.SetDebugDraw(e) : Log_1.Log.CheckError() && Log_1.Log.Error("AI", 42, "实体不含AiComp", ["entityId", t])
  }
  ...
  static ChangeBlueprintVariablesRef(e, t) {
    ...
    if (e instanceof UE.AnimBlueprint) {
      ...
      for (const c of r) {
        Log_1.Log.CheckDebug() && Log_1.Log.Debug("AI", 42, "FunctionGraphs", ["Name", c.GetName()]);
        var o = c?.Nodes;
        for (let t = 0; t < o.Num(); t++) {
          var y, l = o.Get(t);
          l instanceof UE.K2Node_Variable && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("AI", 42, "Change Graph Node", ["Name", l.GetName()], ["MemberName", l.VariableReference.MemberName], ["MemberGuid", l.VariableReference.MemberGuid], ["MemberScope", l.VariableReference.MemberScope], ["MemberParent", l.VariableReference.MemberParent?.GetName()]), y = l.VariableReference.MemberName.toString(), i.has(y)) && (l.VariableReference.MemberName = FNameUtil_1.FNameUtil.GetDynamicFName(i.get(y)), l.VariableReference.MemberGuid.A = 0, l.VariableReference.MemberGuid.B = 0, l.VariableReference.MemberGuid.C = 0, l.VariableReference.MemberGuid.D = 0)
        }
      }
    }
    return e
  ...
  static TryGetDebugMovementComp(t) {
    ...
    try {
      ...
      return void(Log_1.Log.CheckError() && Log_1.Log.Error("AI", 42, "添加监听输入的PbDataId转number异常", ["pbDataId", t]))
    }
    if (0 !== e) {
      t = new Array;
      if (ModelManager_1.ModelManager.CreatureModel.GetEntitiesWithPbDataId(e, t), 0 !== t.length) {
  ...
  static TraceGround(t, e, i, r) {
    ...
    if (t) {
      i = UE.VectorDouble.Dist(e, i), t = (0, SkillBehaviorMisc_1.traceGroundWithGravity)(t, Vector_1.Vector.Create(e), r, i);
  ...
  static GetEntityDeltaMillisecond(t) {
    t = EntitySystem_1.EntitySystem.Get(t);
    return t ? Time_1.Time.DeltaTime * t.TimeDilation * (t.GetComponent(122)?.CurrentTimeScale ?? 1) : 1
  }
  static SyncTwoEntityLocationAndRotation(t, e) {
    ...
    t?.Valid && e?.Valid && (t = t.Entity?.GetComponent(1), e = e.Entity?.GetComponent(1), t) && e && e.SetActorLocationAndRotation(t.ActorLocation, t.ActorRotation, "SyncTwoEntityLocationAndRotation", !1)
  }
  ...
  static StartBattleQte(t, e, i) {
    var r = ModelManager_1.ModelManager.CreatureModel.GetEntityById(t),
      t = EntitySystem_1.EntitySystem.GetComponent(t, 40)?.GetSkill(e)?.MNc;
    r && t && ControllerHolder_1.ControllerHolder.BattleQteController.StartBattleQte(i, t, r, 1)
  }
