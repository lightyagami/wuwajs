...
class TsMoveBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static SetActorRotationWithPriority(t, e, i = !1, n = "unknown") {
    ...
    return !!t && t.SetActorRotationWithPriority(e, "BlueprintAPI." + n, 0, !0, i)
  }
  static SetActorLocationWithContext(t, e, i = !1, n = "unknown") {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    return !!t && t.SetActorLocation(e, "BlueprintAPI." + n, i)
  }
  static SetActorLocationAndRotationWithContext(t, e, i, n = !1, r = "unknown") {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 3);
  ...
  static SetActorLookAtWithContext(t, e, i) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    return !!t && (tmpVector.FromUeVector(e), tmpVector.SubtractionEqual(t.ActorLocationProxy), MathUtils_1.MathUtils.LookRotationUpFirst(tmpVector, t.MoveComp?.GravityUp ?? Vector_1.Vector.UpVectorProxy, tmpQuat), tmpQuat.Rotator(tmpRotator), t.SetActorRotation(tmpRotator.ToUeRotator(), `BlueprintAPI.${i}.LookAt`, !1))
  }
  ...
  static SetCharacterHidden(t, e, i, n) {
    i?.IsValid() ? (i = `[蓝图:${i.GetName()}] ` + n, (n = EntitySystem_1.EntitySystem.Get(t))?.Valid && ControllerHolder_1.ControllerHolder.CreatureController.SetActorVisible(n, !e, !e, !e, i, !0)) : Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "调用SetCharacterHidden失败，因为callObject为空")
  }
  ...
  static CanResponseInput(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.CanResponseInput() ?? !1
  }
  static CanJumpPress(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.CanJumpPress() ?? !1
  }
  static CanWalkPress(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.CanWalkPress() ?? !1
  }
  static GetHeightAboveGround(t, e) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.GetHeightAboveGround(500 < e ? e : void 0)
  }
  ...
  static SmoothCharacterRotation(t, e, i, n) {
    EntitySystem_1.EntitySystem.GetComponent(t, 45)?.SmoothCharacterRotation(e, i, Time_1.Time.DeltaTimeSeconds, !1, n)
  }
  static HasMoveInput(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.HasMoveInput ?? !1
  }
  static HasMoveInputOrTickIntervalAndModelBuffer(t) {
    var e;
    return !!EntitySystem_1.EntitySystem.GetComponent(t, 45)?.HasMoveInput || !(!(e = EntitySystem_1.EntitySystem.Get(t)) || e.GetTickInterval() <= 1) && (EntitySystem_1.EntitySystem.GetComponent(t, 177)?.HasLocationModelBuffer() ?? !1)
  }
  ...
  static IsMoving(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.IsMoving ?? !1
  }
  static IsJump(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.IsJump ?? !1
  }
  static GetSpeed(t) {
  ...
  static IsFallingIntoWater(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.IsFallingIntoWater ?? !1
  }
  ...
  static FixActorLocation(t, e, i) {
    ...
    if (t?.Valid) {
      var r = MathUtils_1.MathUtils.CommonTempVector,
        e = (r.FromUeVector(e), t.FixActorLocation(i, !0, r, "TsMoveBlueprintFunctionLibrary.FixActorLocation"));
      if (e[0]) return n.bBlockingHit = !0, n.Location = new UE.Vector(e[1].X, e[1].Y, e[1].Z), n
    }
  ...
  static CanClimbPress(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 34)?.CanClimbPress() ?? !1
  }
  ...
  static GetWaterVolume(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 77)?.GetWaterVolume() ?? !1
  }
  ...
  static GetLockedRotation(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 45)?.LockedRotation ?? !1
  }
  ...
  static DetectClimbWithDirect(t, e, i) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 34)?.DetectClimbWithDirect(e, i) ?? !1
  }
  static TurnToTarget(t, e, i) {
    var n, r = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    r && e instanceof TsBaseCharacter_1.default && ((n = EntitySystem_1.EntitySystem.GetComponent(t, 177)) && n.MontageManager.StopMontage({
      Method: 0,
      BlendOutTime: 0
    }), n = r.ActorLocationProxy, r = e.CharacterActorComponent.ActorLocationProxy, e = MathUtils_1.MathUtils.CommonTempVector, r.Subtraction(n, e), r = MathUtils_1.MathUtils.CommonTempRotator, n = EntitySystem_1.EntitySystem.GetComponent(t, 45), e.ToOrientationRotator(r), n?.SmoothCharacterRotation(r, i, Time_1.Time.DeltaTimeSeconds, !1))
  }
  static GetMonsterMoveDirection(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    return !t || t.InputDirectProxy.IsNearlyZero() ? 4 : (t.ActorQuatProxy.Inverse(tmpQuat), tmpQuat.RotateVector(t.InputDirectProxy, tmpVector), Math.abs(tmpVector.X) > Math.abs(tmpVector.Y) ? 0 < tmpVector.X ? 0 : 1 : 0 < tmpVector.Y ? 3 : 2)
  }
  static GetRoleBody(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 3);
    return t && t.CreatureData?.GetEntityType() === Protocol_1.Aki.Protocol.kks.Proto_Player ? t.CreatureData.GetRoleConfig().RoleBody : ""
  }
  ...
  static get WaterTrace() {
    var t;
    return TsMoveBlueprintFunctionLibrary.WaterTraceInternal || ((t = UE.NewObject(UE.TraceLineElement.StaticClass())).bIsSingle = !0, t.bIgnoreSelf = !0, t.SetTraceTypeQuery(QueryTypeDefine_1.KuroTraceTypeQuery.Water), TraceElementCommon_1.TraceElementCommon.SetTraceColor(t, ColorUtils_1.ColorUtils.LinearGreen), TraceElementCommon_1.TraceElementCommon.SetTraceHitColor(t, ColorUtils_1.ColorUtils.LinearRed), TsMoveBlueprintFunctionLibrary.WaterTraceInternal = t), TsMoveBlueprintFunctionLibrary.WaterTraceInternal
  }
  static get GroundTrace() {
    var t;
    return TsMoveBlueprintFunctionLibrary.GroundTraceInternal || ((t = UE.NewObject(UE.TraceLineElement.StaticClass())).bIsSingle = !0, t.bIgnoreSelf = !0, t.SetTraceTypeQuery(QueryTypeDefine_1.KuroTraceTypeQuery.IkGround), TraceElementCommon_1.TraceElementCommon.SetTraceColor(t, ColorUtils_1.ColorUtils.LinearGreen), TraceElementCommon_1.TraceElementCommon.SetTraceHitColor(t, ColorUtils_1.ColorUtils.LinearRed), TsMoveBlueprintFunctionLibrary.GroundTraceInternal = t), TsMoveBlueprintFunctionLibrary.GroundTraceInternal
  }
  static SimpleSwim(t, e, i, n) {
    ...
    r.WorldContextObject = t.Actor, t.ActorUpProxy.Multiply(i, tmpVector), tmpVector.AdditionEqual(t.ActorLocationProxy), TraceElementCommon_1.TraceElementCommon.SetStartLocation(r, tmpVector), t.ActorUpProxy.Multiply(-t.ScaledHalfHeight, tmpVector), tmpVector.AdditionEqual(t.ActorLocationProxy), TraceElementCommon_1.TraceElementCommon.SetEndLocation(r, tmpVector);
    let o = 0;
    if (TraceElementCommon_1.TraceElementCommon.LineTrace(r, "SimpleSwim")) {
      i = TsMoveBlueprintFunctionLibrary.GroundTrace;
      i.WorldContextObject = t.Actor, TraceElementCommon_1.TraceElementCommon.GetHitLocation(r.HitResult, 0, tmpVector), TraceElementCommon_1.TraceElementCommon.SetStartLocation(i, tmpVector), TraceElementCommon_1.TraceElementCommon.SetEndLocation(i, t.ActorLocationProxy), TraceElementCommon_1.TraceElementCommon.LineTrace(i, "SimpleSwim_Ground") || (tmpVector.SubtractionEqual(t.ActorLocationProxy), o = MathUtils_1.MathUtils.Clamp(tmpVector.DotProduct(t.ActorUpProxy) / t.ScaledHalfHeight * .5 + .5, 0, 1))
    } else {
      r = TsMoveBlueprintFunctionLibrary.GroundTrace;
      if (r.WorldContextObject = t.Actor, t.ActorUpProxy.Multiply(-t.ScaledHalfHeight - 2, tmpVector), tmpVector.AdditionEqual(t.ActorLocationProxy), TraceElementCommon_1.TraceElementCommon.SetStartLocation(r, t.ActorLocationProxy), TraceElementCommon_1.TraceElementCommon.SetEndLocation(r, tmpVector), TraceElementCommon_1.TraceElementCommon.LineTrace(r, "SimpleSwim_Ground")) return Vector_1.Vector.ZeroVectorDouble
    }
    i = t.Entity.GetComponent(45), tmpVector.FromUeVector(n), r = GravityUtils_1.GravityUtils.GetZnInGravityForActor(t, tmpVector);
    let s = r;
    i?.Valid ? s += i.CharacterMovement.GetGravityZ() * e * (1 - o * CharacterSwimComponent_1.SWIMMING_BUOYANCY) : s += 1960 * e * (1 - o * CharacterSwimComponent_1.SWIMMING_BUOYANCY);
    n = (r + (s *= Math.pow(CharacterSwimComponent_1.SWIMMING_DECELERATION, e))) / 2 * e, n = MathUtils_1.MathUtils.Clamp(n, 2 * (o - 1) * t.ScaledHalfHeight, 2 * o * t.ScaledHalfHeight);
    return tmpVector.Reset(), GravityUtils_1.GravityUtils.AddZnInGravityForActor(t, tmpVector, n), i?.Valid ? i.MoveCharacter(tmpVector, e, "SimpleSwim") : t.AddActorWorldOffset(tmpVector.ToUeVector(), "SimpleSwim", !0), tmpVector2.Reset(), GravityUtils_1.GravityUtils.AddZnInGravityForActor(t, tmpVector2, s), tmpVector2.ToUeVector()
  }
...
TsMoveBlueprintFunctionLibrary.WaterTraceInternal = void 0, TsMoveBlueprintFunctionLibrary.GroundTraceInternal = void 0, exports.default = TsMoveBlueprintFunctionLibrary;
