...
class CharacterWeapon {
  ...
  UpdateHideEffectStateInSelfCentered() {
    var e;
    if (this.EntityId && EffectSystem_1.EffectSystem.IsValid(this.WeaponHideEffect) && (e = EntitySystem_1.EntitySystem.GetComponent(this.EntityId, 133))?.Valid && (e = e.GetTopForeverTimeScaleConfig(0))) {
