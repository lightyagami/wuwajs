...
const builtinFunc = {
  ...
  RefreshBuffDuration: (t, i, e) => i ? (i.GetComponent(178)?.RefreshBuffDuration(e, "被动技能行为刷新buff时长"), true) : (CombatLog_1.CombatLog.Warn("PassiveSkill", t.Owner, "被动技能刷新buff持续时间失败", ["skillId", t.SkillId], ["target", i]), false),
  UpdateTag: (t, i, e, l, r) => {
    var a = i?.GetComponent(209);
    var o = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e[l] ?? "");
    if (a && o && i?.GetComponent(213)?.HasBuffAuthority()) {
