...
class TsVehicleBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static UpdateVehiclePerformData(t, e, i, r) {
    ...
    t && ((0, puerts_1.$set)(e, t.IsBeingImpacted), (0, puerts_1.$set)(i, t.CollisionDirection), (0, puerts_1.$set)(r, t.CollisionStrength))
  }
  ...
  static GetDrivedVehicleSeatRot(t, e) {
    ...
    if (!t?.IsWaterfallMove) {
      if (MathUtils_1.MathUtils.CommonTempRotator.Reset(), !t?.GetDrivedVehicleSeatLocalRot(i, MathUtils_1.MathUtils.CommonTempRotator)) return !1;
      t = (0, puerts_1.$unref)(e);
      t.Pitch = MathUtils_1.MathUtils.CommonTempRotator.Pitch, t.Yaw = MathUtils_1.MathUtils.CommonTempRotator.Yaw, t.Roll = MathUtils_1.MathUtils.CommonTempRotator.Roll
    }
    return !0
  }
  static ConvertAngleToPassengerSpace(t, e) {
    var t = EntitySystem_1.EntitySystem.GetComponent(t, 229);
    return t?.IsOnVehicle ? (t = -t.SeatReletiveTrans.GetRotation().Rotator().Yaw, MathUtils_1.MathUtils.WrapAngle(e + t)) : 0
  }
  ...
  static GetDrivedVehicleVelocity(t, e) {
    ...
    if (!t.VehicleEntity.GetComponent(234)?.Actor?.IsValid()) return !1;
    var i = MathUtils_1.MathUtils.CommonTempVector;
    i.Reset();
  ...
  static GetDrivedVehicleRotiationSpeed(t) {
    var t = EntitySystem_1.EntitySystem.GetComponent(t, 229);
    return t?.IsOnVehicle && (t = t.VehicleEntity.GetComponent(234))?.Actor?.IsValid() ? t.SimulatedRotYawSpeed : 0
  }
}
