...
function checkBuffInSpecialList(e) {
  if (exports.specialIgnoreBuff.includes(e)) {
    return true;
  }
  if (exports.specialIgnoreGaBuff.includes(e)) {
    return true;
  }
  if (exports.noBroadCastBuff.has(e)) {
    return true;
  }
...
exports.checkBulletInSpecialList = exports.specialIgnoreBullet = exports.specialBulletToSkillIdMap = exports.checkBuffInSpecialList = exports.specialIgnoreBuff = exports.specialIgnoreGaBuff = exports.specialBuffToSkillIdMap = exports.gameplayAbilityVisionBuffId = exports.noBroadCastBuff = exports.buffId = undefined;
exports.buffId = {
...
exports.noBroadCastBuff = new Set([1201, 1202, 1203, 12021, 12022, 12023, 1204, 1205, 1206, 1207, 1209, 1210, 1211, 3009, 3010, 3011, 3015, 3023, 1101003010, 1101003012, 1101003013, 90001003, 1001006001, 613670000, 7100000005, 7000000202, 7000000201, 7000000204]);
exports.gameplayAbilityVisionBuffId = {
  RoleSummonBuffId: 1900000014,
  VisionSummonBuffId: 1900000015,
  VisionAppearBuffId: 1900000017
};
exports.specialBuffToSkillIdMap = new Map([[1202002005, 120261], [1103200007, 11030012], [1404500003, 1404200], [1404500007, 1404307], [1403032004, 1403030], [1403020061, 1403050]]);
