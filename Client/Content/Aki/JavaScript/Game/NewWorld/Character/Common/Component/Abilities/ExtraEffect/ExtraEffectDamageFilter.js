...
class DamageFilter extends ExtraEffectBase_1.BuffEffect {
  ...
  static ApplyEffects(e, r, t, a, s, f, i) {
    var E = e.GetComponent(174),
      r = r.GetComponent(174);
    if (E && r) {
      var c = e.GetComponent(40),
        o = new ExtraEffectBaseTypes_1.RequirementPayload,
        s = (s && (o.SkillId = s, c = c.GetSkillInfo(s), o.SkillGenre = c?.SkillGenre ?? -1), f ? ModelManager_1.ModelManager.DamageModel?.GetDamageConfigById(f) : void 0);
      s && (o.DamageType = s.Type, o.DamageSubTypes = s.SubType, o.CalculateType = s.CalculateType, o.SmashType = s.SmashType, o.ElementType = ExtraEffectSnapModifier_1.ModifyDamageElement.ApplyEffects(E, s.Id) ?? s.Element), o.BulletId = BigInt(t), o.BulletTags = a ?? [], o.BattleFlags = i ?? [], o.WeaponType = e.GetComponent(95)?.GetWeaponType() ?? ExtraEffectBaseTypes_1.DEFAULT_WEAPON_TYPE_NOT_PASS;
