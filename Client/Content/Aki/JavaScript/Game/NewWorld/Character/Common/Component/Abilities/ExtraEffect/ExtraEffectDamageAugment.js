...
class DamageAugment extends ExtraEffectBase_1.BuffEffect {
  constructor() {
    super(...arguments), this.gXo = EAttributeId.Proto_EAttributeType_None, this.fXo = -0, this.pXo = 0, this.vXo = 0
  }
  InitParameters(t) {
    var e = t.ExtraEffectParameters,
      ...
      s = this.Level;
    this.gXo = Number(e[0]), this.vXo = Number(e[1]), this.fXo = AbilityUtils_1.AbilityUtils.GetLevelValue(r, s, 0), this.pXo = AbilityUtils_1.AbilityUtils.GetLevelValue(t, s, 0)
  }
  OnExecute() {
    var t = this.gXo,
      e = this.InstigatorEntity?.Entity?.CheckGetComponent(173),
      r = this.fXo,
      s = this.pXo,
  ...
  static ApplyEffects(t, e) {
    ...
    let i = 0;
    for (const a of r.BuffEffectManager.FilterById(9)) a.Check(t, s) && (i += a.Execute());
    return i
  }
}
