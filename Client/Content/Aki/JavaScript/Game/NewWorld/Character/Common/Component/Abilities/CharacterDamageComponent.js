...
var __decorate = this && this.__decorate || function(e, t, r, i) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, r, i);
    ...
    for (var n = e.length - 1; 0 <= n; n--)(a = e[n]) && (s = (o < 3 ? a(s) : 3 < o ? a(t, r, s) : a(t, r)) || s);
...
let CharacterDamageComponent = class CharacterDamageComponent extends BaseDamageComponent_1.BaseDamageComponent {
  constructor() {
    super(...arguments), this.ActorComponent = void 0, this.$br = void 0, this.HBr = void 0, this.o4o = void 0, this.eqr = 0, this.tqr = 0
  }
  OnStart() {
    return !!super.OnStart() && (this.ActorComponent = this.Entity.CheckGetComponent(3), this.$br = this.Entity.CheckGetComponent(61), this.HBr = this.Entity.GetComponent(175), this.o4o = this.Entity.GetComponent(178), this.eqr = this.oqr(), !0)
  }
  OnTick(e) {
    (this.o4o?.GravityDirect ?? Vector_1.Vector.DownVectorProxy).DotProduct(this.ActorComponent.ActorVelocityProxy) >= this.eqr ? 0 === this.tqr && (this.tqr = Time_1.Time.WorldTimeSeconds) : this.tqr = 0
  }
  FallInjure() {
    var e, t, r, i;
    this.TagComponent.HasTag(1918148596) || !this.HBr?.IsInGame || ModelManager_1.ModelManager.DeadReviveModel.SkipFallInjure || this.TagComponent.HasTag(560942831) || (r = this.o4o?.GravityUp ?? Vector_1.Vector.UpVectorProxy, (e = MathUtils_1.MathUtils.CommonTempVector).FromUeVector(this.ActorComponent.Actor.CharacterMovement.GetLastUpdateVelocity()), e = r.DotProduct(e), r = r.DotProduct(this.ActorComponent.ActorVelocityProxy), i = this.Pqr(), -e < this.eqr && (this.tqr = 0), t = this.tqr ? Time_1.Time.WorldTimeSeconds - this.tqr : 0, r = Math.ceil(this.xqr(-e, -r, i, t)), this.Entity.GetComponent(113)?.DumpVelocityCacheInfo("跌落伤害处理"), r <= 0) || (i = this.CreatureDataComponent.GetCreatureDataId(), this.Entity.GetComponent(68).CollectSampleAndSend(), ControllerHolder_1.ControllerHolder.CreatureController.LandingDamageRequest(i, e, t * CommonDefine_1.MILLIONSECOND_PER_SECOND), EventSystem_1.EventSystem.EmitWithTarget(this.Entity, EventDefine_1.EEventName.CharOnFallInjure, r, !1), this.BuffComponent?.RemoveBuffByEffectType(36, "跌落伤害移除冰冻buff"), this.$br.NeedCalculateFallInjure = !1)
  }
  xqr(e, t, r, i) {
    let a = 0;
    var o = this.AttributeComponent.GetCurrentValue(CharacterAttributeTypes_1.EAttributeId.l5n);
    return (a = this.CreatureDataComponent.IsRealMonster() ? CharacterDamageCalculations_1.Calculation.LandingDamageCalculationMonster(r, o) : CharacterDamageCalculations_1.Calculation.LandingDamageCalculationRole(e, t, i, o)) <= 0 ? 0 : a
  }
  Pqr() {
    var e, t;
...
CharacterDamageComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(20)], CharacterDamageComponent), exports.CharacterDamageComponent = CharacterDamageComponent;
