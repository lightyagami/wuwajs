...
exports.createFishingBoatSprintCommand = exports.fishingBoatVisionSkill1OnRelease = exports.fishingBoatVisionSkill1OnPress = undefined;
const UE = require("ue");
...
const needConfirmSkillMap = new Map([[0, 259], [2, 257]]);
        ...
        if (o && o.Valid && o.IsSkillInCd(n)) {
          ...
          if (o !== 0 && o !== 3) {
            if (Log_1.Log.CheckDebug()) {
              Log_1.Log.Debug("Fishing", 48, "捕鱼技能不满足使用条件", ["checkResult", o]);
            }
            ControllerHolder_1.ControllerHolder.FishingController.ShowFishingSkillTips(i, o);
          } else {
...
function createFishingBoatSprintCommand(n) {
  ...
  if (o?.Valid) {
    if ((e = o.GetComponent(274)) && e.CheckCanSprint()) {
      return (0, InputFunctionCommon_1.createSkillCommand)(o, n);
    } else {
      return undefined;
    }
  } else {
    return new UE.SInputCommand(1, n, undefined);
  }
}
...
exports.createFishingBoatSprintCommand = createFishingBoatSprintCommand; //# sourceMappingURL=InputFunctionFishingBoat.js.map