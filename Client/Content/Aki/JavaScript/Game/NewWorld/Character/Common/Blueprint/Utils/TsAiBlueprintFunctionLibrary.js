...
class TsAiBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static CheckPlayerGameplayTag(t, e) {
    ...
    return !!a && !!(a = a.CharacterActorComponent.Entity.GetComponent(217)) && a.HasTag(e?.TagId);
  }
  ...
  static NeedCheckPlayerImpact(t) {
    var t = EntitySystem_1.EntitySystem.GetComponent(t, 50);
  ...
  static UpdateInteractionComponent(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 129);
    if (t) {
      t.ForceUpdate();
    }
  }
  static OnPlayerAttack(t) {
    t = EntitySystem_1.EntitySystem.GetComponent(t, 198);
    if (t) {
      t.OnPlayerAttack();
    }
  }
  ...
  static GetAndResetNoTransitionSwitch(t) {
    var e;
    var t = EntitySystem_1.EntitySystem.GetComponent(t, 198);
  ...
  static GetRoleActor(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.GetRoleActor();
  }
  static SetFollowData(t, e, a) {}
  static GetFollowActor(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.GetAttributeSharerActors();
  }
  static Reset(t, e) {
    EntitySystem_1.EntitySystem.GetComponent(t, 61)?.Reset(e);
  }
  static GetToRoleDistance(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 61)?.GetToRoleDistance();
  }
