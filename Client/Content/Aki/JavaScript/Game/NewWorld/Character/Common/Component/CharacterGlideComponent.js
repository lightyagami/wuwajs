"use strict";
var CharacterGlideComponent_1, __decorate = this && this.__decorate || function(t, e, i, h) {
  var s, o = arguments.length,
    a = o < 3 ? e : null === h ? h = Object.getOwnPropertyDescriptor(e, i) : h;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(t, e, i, h);
  else
    for (var r = t.length - 1; 0 <= r; r--)(s = t[r]) && (a = (o < 3 ? s(a) : 3 < o ? s(e, i, a) : s(e, i)) || a);
  return 3 < o && a && Object.defineProperty(e, i, a), a
};
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.CharacterGlideComponent = exports.SoarConfigParams = exports.SOAR_CAMERA_SHAKE_SPEED_THRESHOLD_MAX = exports.SOAR_CAMERA_SHAKE_SPEED_THRESHOLD = exports.SOAR_AUTO_FLIGHT_PATH = exports.SOAR_CAMERA_SHAKE_CURVE_PATH = exports.SOAR_CAMERA_SHAKE_PATH = exports.SOAR_CONFIG_BASE_PATH = void 0;
...
let CharacterGlideComponent = CharacterGlideComponent_1 = class CharacterGlideComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.Hte = void 0, this.o4o = void 0, this.H5r = void 0, this.Xte = void 0, this.oRe = void 0, this.Xdl = void 0, this.j5r = void 0, this.e7l = void 0, this.t7l = !1, this.i7l = !1, this.r7l = !1, this.SoarBalanceOn = !1, this.Bnh = 0, this.Hkl = void 0, this.Ioh = 0, this.vTa = 0, this.K5r = Vector_1.Vector.Create(), this.Q5r = Quat_1.Quat.Create(), this.Ydl = Vector_1.Vector.Create(), this.DVr = () => {
      this.RefreshSoarBoost(), this.Z5l()
    }, this.hUe = (t, e) => {
      e === CharacterUnifiedStateTypes_1.ECharMoveState.Soar && (this.Hte.ClearInput(), this.CalculateSoarQuat(), this.Q5r.RotateVector(Vector_1.Vector.UpVectorProxy, this.K5r), this.t7l = !1, this.SoarBalanceOn = !1, this.zdl = !1, this.p$l = 1, this.Ioh = 0, this.vTa = 0, this.Xte?.AddTag(410756488), cpp_1.FKuroPerfSightHelper.BeginExtTag("Soar")), t === CharacterUnifiedStateTypes_1.ECharMoveState.Soar && cpp_1.FKuroPerfSightHelper.EndExtTag("Soar"), this.RefreshSoarBoost(), this.Z5l()
    }, this.Jdl = !1, this.JustEnterSoarSplineMove = !1, this.Zdl = Vector_1.Vector.Create(), this.b6l = !1, this.f$l = 1, this.J5r = t => {
      ModelManager_1.ModelManager.SeamlessTravelModel?.GetIsKeepingCurrentMovementMode() || (this.Xte?.HasTag(-8769906) ? this.ExitGlideState() : this.Xte?.HasTag(921953316) ? this.o4o.CharacterMovement.KuroFlying(t, 0, FLYING_FRICTION, FLYING_DECELERATION, FLYING_ACCELERATOR, FLYING_MAX_SPEED, FLYING_MAX_FALLING_SPEED) : this.o4o.CharacterMovement.KuroFlying(t, FLYING_GRAVITY, FLYING_FRICTION, FLYING_DECELERATION, FLYING_ACCELERATOR, FLYING_MAX_SPEED, FLYING_MAX_FALLING_SPEED))
    }, this.z5r = t => {
      if (!ModelManager_1.ModelManager.SeamlessTravelModel?.GetIsKeepingCurrentMovementMode())
        if (!this.Xte?.HasTag(1151923109) || this.Xte?.HasTag(1226693610)) this.Xte?.HasTag(-8769906) ? this.ExitSoarState() : (ScrollingTipsController_1.ScrollingTipsController.ShowTipsByTextId("Flying_Tip_001"), this.EnterGlideState());
        else {
          if (this.zdl = void 0 !== this.Xdl && this.Xdl.Active && "AirPassage" === this.Xdl.CurrentSplineMoveType, this.Xte.HasTag(-1956426709)) {
            let e = 0,
              i = 0;
            t > SOAR_MAX_DELTA * SOAR_MAX_ITER ? (i = SOAR_MAX_DELTA, e = SOAR_MAX_ITER) : (e = Math.ceil(t / SOAR_MAX_DELTA), i = t / e);
            for (let t = 0; t < e; ++t) this.E1l(i)
          } else this.E1l(Math.min(t, SOAR_MAX_DELTA));
          t = GravityUtils_1.GravityUtils.GetZnInGravityForActor(this.Hte, this.Hte.ActorVelocityProxy), t = Math.asin(t / this.Hte.ActorVelocityProxy.Size()) * MathUtils_1.MathUtils.RadToDeg;
          t > (CommonParamById_1.configCommonParamById.GetIntConfig("SoarUpwardThreshold") ?? 30) ? this.p$l = 2 : t > (CommonParamById_1.configCommonParamById.GetIntConfig("SoarDownwardThreshold") ?? -45) ? this.p$l = 1 : this.p$l = 0
        }
    }, this.OnStateInherit = (t, e) => {
      t?.Valid && (t = t.GetComponent(59))?.Valid && !e && (this.K5r.DeepCopy(t.K5r), this.Q5r.DeepCopy(t.Q5r), this.Ioh = t.Ioh, this.vTa = t.vTa, this.Bnh = t.Bnh)
    }, this.eVr = (t, e) => {
  ...
  RefreshSoarBoost() {
    var t = (this.t7l || this.i7l) && void 0 !== this.Xte && this.Xte.HasTag(-2027866845);
    this.r7l !== t && (this.r7l = t, this.r7l ? this.Xte?.AddTag(-54528961) : this.Xte?.RemoveTag(-54528961))
  }
  get zdl() {
    return this.Jdl
  }
  set zdl(t) {
    this.Jdl !== t && ((this.Jdl = t) ? (this.JustEnterSoarSplineMove = !0, this.K5r.CrossProduct(this.Hte.ActorForwardProxy, this.Zdl), this.Zdl.CrossProductEqual(this.K5r), this.Zdl.Normalize() || this.Zdl.DeepCopy(this.Hte.ActorForwardProxy), CharacterGlideComponent_1.Gue.Set(0, this.vTa, 0), CharacterGlideComponent_1.Gue.Quaternion(CharacterGlideComponent_1.az), this.Hte.ActorQuatProxy.Multiply(CharacterGlideComponent_1.az, CharacterGlideComponent_1.az), this.Hte.ActorQuatProxy.Inverse(CharacterGlideComponent_1.KJ), CharacterGlideComponent_1.KJ.RotateVector(this.Zdl, this.Zdl), CharacterGlideComponent_1.az.RotateVector(this.Zdl, this.Zdl), this.Xte?.AddTag(1200164239)) : (this.Q5r.RotateVector(Vector_1.Vector.UpVectorProxy, this.K5r), this.Ioh = 0, this.Hte.ActorQuatProxy.Inverse(CharacterGlideComponent_1.KJ), CharacterGlideComponent_1.KJ.RotateVector(this.Zdl, CharacterGlideComponent_1.Lz), this.vTa = Math.atan2(CharacterGlideComponent_1.Lz.Y, CharacterGlideComponent_1.Lz.X) * MathUtils_1.MathUtils.RadToDeg, this.Xte?.RemoveTag(1200164239)), this.Z5l())
  }
  get T6l() {
    return this.b6l
  }
  set T6l(t) {
    this.b6l !== t && ((this.b6l = t) ? (t = ResourceSystem_1.ResourceSystem.GetLoadedAsset(exports.SOAR_AUTO_FLIGHT_PATH, UE.BP_CameraDrivenAutoFlightData_C)) && this.Entity.GetComponent(62)?.TurnOnCameraDrivenAutoFlightMode(t) : this.Entity.GetComponent(62)?.TurnOffCameraDrivenAutoFlightMode())
  }
  Z5l() {
    this.T6l = !this.zdl && void 0 !== this.Xte && this.Xte.HasTag(-2027866845)
  }
  get p$l() {
    return this.f$l
  }
  set p$l(t) {
    this.f$l !== t && (this.Xte && (2 === this.f$l ? this.Xte.RemoveTag(-383538528) : 0 === this.f$l && this.Xte.RemoveTag(1886913275), 2 === t ? this.Xte.AddTag(-383538528) : 0 === t && this.Xte.AddTag(1886913275)), this.f$l = t)
  }
  E1l(e) {
    if (this.Hte && this.o4o) {
      this.Hkl.DebugDraw && Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 6, "Soar Move0", ["input", this.Hte.InputDirectProxy]);
      var i = this.o4o.CharacterMovement;
      if (i) {
        this.CalculateSoarQuat();
        let t = 0;
        switch (t = this.zdl ? this.eCl(e, i) : this.tCl(e, i), this.Hte.ResetAllCachedTime(), t) {
          case 2:
            this.ExitSoarState(1);
            break;
          case 1:
            this.Bnh + this.Hkl.SoarHitWallExitTimeLength < Time_1.Time.Now && this.ExitSoarState();
            break;
          default:
  ...
  EnterSoarState() {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "EnterSoarState", ["Entity", this.Entity.Id]), this.Hte.Actor.KuroSetMovementMode({
      Mode: 6,
  ...
  ExitSoarState(t = 3) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("Test", 6, "ExitSoarState", ["Entity", this.Entity.Id], ["NewMovementMode", t]), this.Hte.Actor.KuroSetMovementMode({
      Mode: t,
      CustomMode: 0,
  ...
  eCl(t, e) {
    ...
    if (a.Multiply(s / a.Size(), CharacterGlideComponent_1.Lz), i.SetActorVelocity(CharacterGlideComponent_1.Lz), t > MathUtils_1.MathUtils.SmallNumber && (h.SplineLocation.Subtraction(i.ActorLocationProxy, CharacterGlideComponent_1.Lz), r = CharacterGlideComponent_1.Lz.Size(), o = MathUtils_1.MathUtils.RangeClamp(r, this.Hkl.SoarSplinePushCenterDistMin, this.Hkl.SoarSplinePushCenterDistMax, this.Hkl.SoarSplinePushCenterSpeedMin, this.Hkl.SoarSplinePushCenterSpeedMax), CharacterGlideComponent_1.Lz.MultiplyEqual(Math.min(1, o * t / r)), i.MoveComp.MoveCharacter(CharacterGlideComponent_1.Lz, t, "Soar.Spline.Push")), this.SoarBoostOn && this.ija(e, t), this.Hkl.DebugDraw) {
      const a = i.ActorVelocityProxy;
      i.ActorLocationProxy.Addition(a, CharacterGlideComponent_1.Lz), UE.KismetSystemLibrary.D_DrawDebugArrow(i.Actor, i.ActorLocation, CharacterGlideComponent_1.Lz.ToUeVector(), 100, redColor, void 0, 10), this.Zdl.Multiply(100, CharacterGlideComponent_1.Lz), CharacterGlideComponent_1.Lz.AdditionEqual(i.ActorLocationProxy), UE.KismetSystemLibrary.D_DrawDebugArrow(i.Actor, i.ActorLocation, CharacterGlideComponent_1.Lz.ToUeVector(), 100, blueColor, void 0, 10);
      s = a;
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Movement", 6, "Soar Spline", ["Speed", s.Size()], ["Planar", s.Size2D()], ["Z", s.Z])
    }
    return UE.KuroMovementBPLibrary.KuroSoar(t, e, n.SoarFriction, 0, Vector_1.Vector.ZeroVector, Vector_1.Vector.ZeroVector, this.SoarBoostOn && 0 < n.SoarSprintLimit ? n.SoarSprintLimit : n.MaxSoarSplineSpeed)
  }
};
CharacterGlideComponent.Lz = Vector_1.Vector.Create(), CharacterGlideComponent.Tz = Vector_1.Vector.Create(), CharacterGlideComponent.Gue = Rotator_1.Rotator.Create(), CharacterGlideComponent.az = Quat_1.Quat.Create(), CharacterGlideComponent.KJ = Quat_1.Quat.Create(), CharacterGlideComponent = CharacterGlideComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(59)], CharacterGlideComponent), exports.CharacterGlideComponent = CharacterGlideComponent;
