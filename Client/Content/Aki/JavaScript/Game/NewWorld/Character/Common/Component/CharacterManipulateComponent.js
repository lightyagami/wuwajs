...
let CharacterManipulateComponent = CharacterManipulateComponent_1 = class CharacterManipulateComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.C7r = t => {
      var e = this.b9r?.GetComponent(208);
      if (e) {
        if (t) {
          e.AddTag(230094484);
        } else {
  ...
  OnStart() {
    ...
    this.o4o = this.Entity.GetComponent(189);
    this.w9r = undefined;
    this.B9r = undefined;
    this.b9r = undefined;
    this.q9r = undefined;
  ...
  GetDrawTargetChantTime() {
    var t;
    if (this.w9r?.Valid && (t = this.w9r.GetComponent(167))) {
  ...
  I7r(t) {
    ...
    this.Entity.GetComponent(48)?.SetForceSpeed(Vector_1.Vector.ZeroVectorProxy);
    var e = this.w9r?.GetComponent(214);
    if (!e) {
      this.T7r();
      this.StopManipulate();
      return false;
  ...
  Cast() {
    ...
    if (this.w9r?.Valid && !this.G9r.IsProjectileAimMode) {
      let t = false;
      var e = this.w9r.GetComponent(172);
      var i = this.w9r.GetComponent(148);
      if (e?.Valid) {
  ...
  Drop() {
    ...
    var t;
    var e = (this.b9r ?? this.w9r)?.GetComponent(167);
  ...
  Reset() {
    ...
    if (t) {
      var i = Vector_1.Vector.Create(t.GetComponent(214).ActorLocationProxy);
      ...
      if (Log_1.Log.CheckInfo()) {
        Log_1.Log.Info("Character", 31, "[CharacterManipulateComp] StopManipualte", ["Location", t.GetComponent(214).ActorLocationProxy], ["FloorName", e], ["id", this.Entity.Id]);
      }
    }
    if (this.ac !== 0) {
      this.Drop();
  ...
  R7r() {
    ...
    if (this.b9r?.Valid) {
      if (ModelManager_1.ModelManager.ManipulaterModel.NeedShowLandTips()) {
        this.b9r?.GetComponent(208)?.AddTag(230094484);
      }
  ...
  Sbo() {
    ...
    this.$9r = undefined;
    var t = this.b9r ?? this.w9r;
    t?.GetComponent(208)?.RemoveTag(230094484);
    if (this.J9r) {
  ...
  KWo(t) {
    ...
    if (this.Xte?.HasTag(-1898186757) && e) {
      switch (this.n7r) {
        case 2:
          this.U7r();
          this.A7r(e, t);
  ...
  A7r(i, s) {
    ...
    ModelManager_1.ModelManager.CreatureModel.GetEntitiesInRange(a, 7, this.DKo);
    for (const l of this.DKo) {
      var e = l.Entity;
      if (this.B0a(e, i, s)) {
        let t = Vector_1.Vector.Create(e.GetComponent(1).ActorLocationProxy);
        var h = e.GetComponent(172);
        if (h) {
    ...
    if (s) {
      ModelManager_1.ModelManager.CreatureModel.GetEntitiesInRange(a, 248, this.DKo);
  ...
  B0a(t, e, i) {
    ...
    var s = t.GetComponent(214);
    if (s && e === s.Owner) {
      return false;
    }
    if (!i && !t.GetComponent(167)?.Valid) {
      return false;
    }
    e = t.GetComponent(148);
    s = t.GetComponent(149);
    return !!(e?.Valid ?? s?.Valid) || !!t.GetComponent(214)?.GetIsSceneInteractionLoadCompleted();
  }
  q0a(e, i, s, a, h) {
    if (e) {
      ...
      if (r && r.Portal1Enable && r.Portal2Enable) {
        let t = undefined;
        var n = (t = (t = ModelManager_1.ModelManager.CreatureModel?.GetEntityByPbDataId(e)?.Entity) || EntitySystem_1.EntitySystem.Get(e))?.GetComponent(228);
        ...
        if (i ? n?.GetPbDataId() : o?.PbdataId) {
          ...
          var n = s - v;
          if (!(n <= 0)) {
            ModelManager_1.ModelManager.CreatureModel.GetEntitiesInRangeWithLocation(l, n, 7, this.DKo);
            for (const M of this.DKo) {
              var c;
              var C;
              var m = M.Entity;
              if (this.B0a(m, a, h) && (C = Vector_1.Vector.Create(m.GetComponent(214).ActorLocationProxy), c = Vector_1.Vector.Distance(C, l), (C = C.SubtractionEqual(l)).Z = 0, C.Normalize(), (C = Vector_1.Vector.DotProduct(_, C)) > 0.5)) {
                this.o7r.push(new FindedEntityWithPortalParam(m, i ? 1 : 2, c + v, C, e));
              }
            }
            if (h) {
              ModelManager_1.ModelManager.CreatureModel.GetEntitiesInRangeWithLocation(l, n, 248, this.DKo);
  ...
  P7r(t, e) {
    ...
    if (this.o7r) {
      while (i < MAX_CALC_WEIGTH_NUMBER_PER_FRAME) {
        ...
        if (a.Entity?.Valid) {
          if (!(s = a.Entity.GetComponent(214)) || t !== s.Owner) {
            this.i7r = undefined;
  ...
  x7r(t, e) {
    ...
    if (a !== this.w9r) {
      if (this.w9r?.Valid && this.b9r === undefined) {
        (i = this.w9r?.GetComponent(167))?.TryRemoveTagById(793256493);
        i?.TryRemoveSpecLockTag();
      }
      this.w9r = a;
      (i = this.w9r?.GetComponent(167))?.SetPassthroughPortalId(t?.PortalPairId ?? -1);
      ...
      if (this.w9r?.Valid) {
        this.B9r = this.w9r.GetComponent(167);
      }
      if (this.w9r?.Valid && this.b9r === undefined) {
  ...
  w7r(e, t) {
    ...
    var h = s.GetComponent(208);
    var r = s.GetComponent(167);
    ...
    if (t) {
      ...
      if (this.b9r.GetComponent(168)?.Valid) {
  ...
  N7r(t) {
    ...
    var h = e.Entity.GetComponent(159);
    if (h?.Valid) {
      a = h.GetHitPoint().ToUeVector();
    }
    var h = e.Entity.GetComponent(172);
    if (h?.Valid) {
      a = h.GetSocketLocation(this.b9r).ToUeVector();
    }
    var h = e.Entity.GetComponent(151);
    if (h?.Valid) {
      a = h.GetHitPoint().ToUeVector();
    }
    var h = e.Entity.GetComponent(167);
    if (h?.Valid) {
    ...
    if (this.uoe.HitResult.bBlockingHit) {
      for (let t = 0; t < this.uoe.HitResult.Actors.Num(); t++) {
        ...
        if (i !== undefined) {
          ...
          var a = this.uoe.HitResult.ItemArray.Get(t);
          if (this.H7r(i, s, a)) {
            return false;
          }
        }
  ...
  j7r(e, t) {
    ...
    var a = e?.Entity.GetComponent(167);
    if (!a?.Valid) {
      return t;
    }
    ...
    if (i && this.uoe.HitResult.bBlockingHit) {
      for (let t = 0; t < this.uoe.HitResult.Actors.Num(); t++) {
        ...
        if (h !== undefined) {
          if (this.b9r.GetComponent(170)?.IsChildrenActor(h)) {
            break;
          }
          ...
          var n = this.uoe.HitResult.ItemArray.Get(t);
          if (this.H7r(h, r, n)) {
            return false;
          }
        }
  ...
  H7r(t, e, i) {
    return this.q9r?.Owner !== t && !!e && !UE.KuroCollisionLibrary.ActorHasTag(t, MANIPULATE_CHECK_IGNORE_TAG, i) && !(t = UE.KuroCollisionLibrary.GetCollisionProfileName(e, i), RenderConfig_1.RenderConfig.WaterCollisionProfileName.op_Equality(t)) && !HIT_COLLISION_NAME.op_Equality(t);
  }
  E7r() {
    if (this.G9r?.Valid) {
      if (!this.K9r) {
      ...
      if (e && this.K9r.HitResult.bBlockingHit) {
        for (let t = 0; t < this.K9r.HitResult.Actors.Num(); t++) {
          ...
          if (i !== undefined && !this.V7r(i, this.q9r)) {
            ...
            var a = this.K9r.HitResult.ItemArray.Get(t);
            if (this.H7r(i, s, a)) {
  ...
  O7r(t, e, i, s = false) {
    let a = e;
    return a = i ? this.W7r(t, e) : t.Entity.GetComponent(149)?.Valid ? this.K7r(t, e, s) : this.Q7r(t, e, s);
  }
  Q7r(e, t, i) {
    var s = e.Entity.GetComponent(1);
    var a = Vector_1.Vector.Create(s.ActorLocationProxy);
    var h = s.Entity.GetComponent(172);
    if (h?.Valid) {
      a.DeepCopy(h.GetSocketLocation(this.b9r));
    }
    let r = -1;
    var a = s.Entity.GetComponent(167);
    var n = new Array();
    var o = new Array();
    if (i) {
  ...
  K7r(t, e, i) {
    var s = t.Entity.GetComponent(149);
    ...
    if (i) {
      ...
      var _ = t.Entity.GetComponent(167).ManipulateBaseConfig.被感知角度权重;
      for (let t = 0; t < _.Num(); t++) {
        var l = _.GetKey(t);
        var v = _.Get(l);
        r.push(l);
  ...
  SetDataFromOldRole(t) {
    var e = t.Entity.GetComponent(70);
    if (e.ac === 4) {
      t.Entity.GetComponent(43).SkillTarget = undefined;
      this.Entity.GetComponent(43).SkillTarget = undefined;
    }
    e.Reset();
    this.j9r = e.j9r;
    this.StopManipulate();
  ...
  b7r(t, e) {
    ...
    let h = undefined;
    for ([i, s] of t.GetComponent(74).GroupMapByBone) {
      if (s === e.toString()) {
  ...
  ExtraAction() {
    var t;
    if (this.ac === 4 && (this.b9r.Valid || this.G9r.Valid) && (t = this.b9r.GetComponent(149))?.Valid) {
  ...
  Ila() {
    ...
    return !!this.w9r && !!this.B9r && !!(t = this.Entity.GetComponent(43)).Valid && t.BeginSkill(CharacterManipulateComponent_1.SkillId, {
      Reason: "ManipulateSpecificTarget"
    });
  }
  CanManipulate() {
    return !!this.n$t.IsMoveAutonomousProxy && !!CharacterManipulateComponent_1.f7r && this.ac === 0 && !this.Q9r && !!this.Entity.GetComponent(43).Valid;
  }
  TryManipulateSpecificItem(t) {
    var e;
    return !!this.CanManipulate() && !!(e = t.GetComponent(167)) && !!t.GetComponent(144)?.Valid && !(this.w9r = t, this.B9r = e, this.Ela = 0, this.ac = 1, Log_1.Log.CheckDebug() && Log_1.Log.Debug("Character", 39, "[CharacterManipulateComp] TryManipulateSpecificItem", ["Id", this.Entity.Id], ["PbdataId", this.Entity.GetComponent(0)?.GetPbDataId()], ["TargetId", this.w9r?.Id]), 0);
  }
...
CharacterManipulateComponent = CharacterManipulateComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(70)], CharacterManipulateComponent);
