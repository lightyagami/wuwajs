...
const Info_1 = require("../../../../../../../Core/Common/Info"),
  ...
  actionsForbid = [InputEnums_1.EInputAction.攻击, InputEnums_1.EInputAction.幻象1, InputEnums_1.EInputAction.幻象2, InputEnums_1.EInputAction.技能1, InputEnums_1.EInputAction.瞄准, InputEnums_1.EInputAction.大招];
class ManipulateInputLayer extends InputLayer_1.InputLayer {
  ...
  Init(t) {
    t = t.Entity;
    this.Lie = t.GetComponent(193), this.cBe = t.GetComponent(40)
  }
  Clear() {
  ...
  HandlePress(t, e) {
    switch (t) {
      case InputEnums_1.EInputAction.攻击:
        return this.Lie.HasTag(-972568039) || this.cBe.BeginSkill(MANIPULATE_THROW_SKILL, {
      ...
      case InputEnums_1.EInputAction.幻象1:
        ...
        return this.Lie.HasTag(1278503102) || this.cBe.BeginSkill(MANIPULATE_RELEASE_SKILL, {
          Reason: "Manipulate InputLayer, Item Release"
        }), ManipulateInputLayer.GetSwallowCommand();
      case InputEnums_1.EInputAction.技能1:
        if (this.Lie.HasTag(-1070569477)) return this.cBe.BeginSkill(MANIPULATE_ROTATE_SKILL, {
          Reason: "Manipulate InputLayer, Item Rotate"
        }), ManipulateInputLayer.GetSwallowCommand();
        break;
      case InputEnums_1.EInputAction.瞄准:
        return this.cBe.BeginSkill(MANIPULATE_PARABOLA_SKILL, {
          Reason: "Manipulate InputLayer, Item Rotate"
        }), ManipulateInputLayer.GetSwallowCommand()
    }
    if (actionsForbid.includes(t) && this.Q0l()) return ManipulateInputLayer.GetSwallowCommand()
  }
  HandleRelease(t, e) {
    if (t === InputEnums_1.EInputAction.幻象1)
      if (Info_1.Info.IsInTouch()) return this.Lie.HasTag(1278503102) || this.cBe.BeginSkill(MANIPULATE_RELEASE_SKILL, {
        Reason: "Manipulate InputLayer, Item Release"
      }), ManipulateInputLayer.GetSwallowCommand();
