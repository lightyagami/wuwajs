...
let StackableChessComponent = class StackableChessComponent extends EntityComponent_1.EntityComponent {
  ...
  AttachToTarget(e) {
    var t, e = e.ActorComp;
    this.ActorComp?.Valid && e?.Valid && (t = this.GetAttachSocketName()) && this.ActorComp.Owner?.K2_AttachToComponent(e.SkeletalMesh, t, 1, 1, 1, !1)
  }
  DetachFromTarget(e) {
    this.ActorComp?.Valid && this.ActorComp.Owner?.K2_DetachFromActor(1, 1, 1)
  }
  Move(e, t, o) {
    this.ActorComp?.SetActorLocationAndRotation(e.ToUeVector(), t.ToUeRotator(), "ChessMove", !1), o()
  }
  Teleport(e, t) {
    this.ActorComp?.SetActorLocationAndRotation(e.ToUeVector(), t.ToUeRotator(), "ChessTeleport", !1)
  }
...
StackableChessComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(282)], StackableChessComponent), exports.StackableChessComponent = StackableChessComponent;
