...
let BaseFrozenComponent = class BaseFrozenComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.ActorComponent = void 0, this.$br = void 0, this.ybr = void 0, this.Ibr = void 0, this.Tbr = void 0, this.Lbr = (t, e) => {
      e && this.ActorComponent.Actor.StopAnimMontage()
    }, this.Dbr = new Map, this.FrozenLockSet = new Set
  }
  OnStart() {
    return this.ActorComponent = this.Entity.CheckGetComponent(3), this.$br = this.Entity.CheckGetComponent(61), this.ybr = this.Entity.CheckGetComponent(122), this.Ubr(), !0
  }
  OnEnd() {
    return this.Ibr && (this.Ibr.EndTask(), this.Ibr = void 0), this.Tbr && (this.Tbr.EndTask(), this.Tbr = void 0), !0
  }
  Ubr() {
  ...
  AddTimeScaleByBuff(t, e, i, s, o) {
    this.Dbr.has(t) || this.$br.IsImmuneTimeScaleEffect() || (e = this.ybr.SetTimeScale(e, i, o, s ?? ETERNAL_DURATION, 6), this.Dbr.set(t, e))
  }
...
BaseFrozenComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(16)], BaseFrozenComponent), exports.BaseFrozenComponent = BaseFrozenComponent;
