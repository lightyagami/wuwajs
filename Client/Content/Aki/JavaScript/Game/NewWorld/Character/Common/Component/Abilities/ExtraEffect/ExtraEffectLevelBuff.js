...
class ExtraEffectLevelBuff extends ExtraEffectBase_1.BuffEffect {
  ...
  InitParameters(e) {
    var t = e.ExtraEffectParameters[0],
      ...
      s = AbilityUtils_1.AbilityUtils.GetLevelValue(e.ExtraEffectGrowParameters1, this.Level, 0),
      e = AbilityUtils_1.AbilityUtils.GetLevelValue(e.ExtraEffectGrowParameters2, this.Level, 0),
      f = levelBuffClassMap[t];
    f ? this.EXo = new f(this.OwnerEntity, this.BuffId, l, s, e) : Log_1.Log.CheckError() && Log_1.Log.Error("Level", 28, "没有注册玩法效果", ["ClassName", t], ["Buff", this.BuffId])
  }
  OnCreated() {
    this.EXo?.OnCreated()
  }
