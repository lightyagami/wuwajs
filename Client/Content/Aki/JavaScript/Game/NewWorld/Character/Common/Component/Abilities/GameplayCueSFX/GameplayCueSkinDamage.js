...
class GameplayCueSkinDamage extends GameplayCueBase_1.GameplayCueBase {
  OnCreate() {
    ...
    e && (e.CuePath = this.GetPath(), e.ApplySkinDamage(e.CuePath, !1, "GameplayCueSkinDamage生成"))
  }
  OnDestroy() {
    var e = this.EntityHandle.Entity?.GetComponent(210);
    e && (e.CuePath = "", e.ApplySkinDamageByType(e.SkinDamageType, !1, "GameplayCueSkinDamage销毁"))
  }
}
