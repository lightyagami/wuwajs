...
class TsSceneInteractBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetSitDownState(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 29)?.GetSitDownState() ?? !1
  }
  ...
  static IsAiDriver(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 47)?.IsAiDriver ?? !1
  }
  static IsDropItem(t) {
    return void 0 !== EntitySystem_1.EntitySystem.GetComponent(t, 149)
  }
