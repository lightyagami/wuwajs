...
class RemoveBuff extends ExtraEffectBase_1.BuffEffect {
  constructor() {
    super(...arguments), this.LXo = void 0, this.DXo = () => {
      this.OwnerBuffComponent.HasBuffAuthority() && this.OwnerBuffComponent.RemoveBuffByHandle(this.ActiveHandleId, -1, "buff施加者死亡导致移除")
    }, this.RXo = (e, t) => {
      t === this.InstigatorEntity && this.OwnerBuffComponent.HasBuffAuthority() && this.OwnerBuffComponent.RemoveBuffByHandle(this.ActiveHandleId, -1, "buff施加者被移除导致移除")
    }
  }
  InitParameters(e) {
  ...
  OnCreated() {
    for (const e of this.LXo) switch (e) {
      case 0:
  ...
  OnRemoved(e) {
    if (this.InstigatorEntity?.Valid)
      for (const t of this.LXo) switch (t) {
        case 0:
