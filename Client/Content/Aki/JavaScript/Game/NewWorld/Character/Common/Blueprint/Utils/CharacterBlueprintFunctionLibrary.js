...
class CharacterBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static SetPartCollisionSwitch(t, e, a, r, i) {
    t?.IsValid() && t.CharacterActorComponent?.Valid ? t.CharacterActorComponent.SetPartCollisionSwitch(e, a, r, i) : Log_1.Log.CheckError() && Log_1.Log.Error("Character", 20, "传入的character为空")
  }
  static ResetPartCollisionSwitch(t, e) {
    var t = t.CharacterActorComponent,
      a = t.GetPartConf(e);
    a && t.SetPartCollisionSwitch(e, a.IsBlockPawn, a.IsBulletDetect, a.IsBlockCamera)
  }
  ...
  static CharacterOperationRecord(t) {
    CharacterStatisticsComponent_1.CharacterStatisticsComponent.OperationRecord(t), t ? CharacterGasDebugComponent_1.CharacterGasDebugComponent.BeginRecord() : CharacterGasDebugComponent_1.CharacterGasDebugComponent.EndRecord()
  }
  ...
  static SaveCharacterOperationRecord() {
    ...
    if (t) {
      if (UE.KuroStaticLibrary.SaveStringToFile(t, UE.BlueprintPathsLibrary.ProjectSavedDir() + SAVE_PATH + "OperationRecord.csv", !0) && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 20, "OperationRecord写入完成"), CharacterBlueprintFunctionLibrary.SaveCharacterStatisticsData())) return !0;
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 20, "OperationRecord写入失败")
    }
    return !1
  }
  static SaveCharacterStatisticsData() {
    var t = CharacterStatisticsComponent_1.CharacterStatisticsComponent.ExportStatisticsByAttackType(),
      e = CharacterStatisticsComponent_1.CharacterStatisticsComponent.ExportStatisticsBySkillType(),
      a = !t,
      r = !e;
    if (a || r) Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 20, "读取数据为空", ["A表为空", r], ["B表为空", a]);
    else {
      r = UE.BlueprintPathsLibrary.ProjectSavedDir(), a = UE.KuroStaticLibrary.SaveStringToFile(t, r + SAVE_PATH + "DamageStatisticsRecord_B.csv", !0), t = UE.KuroStaticLibrary.SaveStringToFile(e, r + SAVE_PATH + "DamageStatisticsRecord_A.csv", !0);
      if (a && t) return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 20, "DamageRecord_B写入完成"), !0;
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Test", 20, "DamageRecord_B写入失败", ["A", t], ["B", a])
    }
    return !1
  }
  ...
  static CleanupOperationRecord() {
    CharacterStatisticsComponent_1.CharacterStatisticsComponent.CleanupOperationRecord(), CharacterStatisticsComponent_1.CharacterStatisticsComponent.CleanupRecordData(), CharacterGasDebugComponent_1.CharacterGasDebugComponent.CleanupRecord()
  }
  ...
  static SetCombatStarted(t, e, a, r, i, s, o, c, n) {
    var C = new Array;
    r && C.push(0), i && C.push(1), s && C.push(2), o && C.push(3), c && C.push(4), n && C.push(5), CharacterStatisticsComponent_1.CharacterStatisticsComponent.SetCombatStarted(t, C, e, a)
  }
  static SetTypeOpen(t, e, a, r, i, s) {
    var o = new Array;
    t && o.push(0), e && o.push(1), a && o.push(2), r && o.push(3), i && o.push(4), s && o.push(5), CharacterStatisticsComponent_1.CharacterStatisticsComponent.SetTypeOpen(o)
  }
  ...
  static TestLeaveSplineMove(t) {
    t.GetEntityNoBlueprint().GetComponent(108).EndSplineMove(1), CameraController_1.CameraController.FightCamera.LogicComponent.ExitCameraSpline()
  }
  ...
  static DetachFromHost(t, e, a) {
    ...
    t?.Valid && (t = t.GetComponent(180))?.Valid && t.DetachFromHost(e, a, !0)
  }
  ...
  static SetGravityDirect(t, e) {
    ...
    t?.Valid && (t = t.Entity.GetComponent(178))?.Valid && t.SetGravityDirectByNumber(e.X, e.Y, e.Z)
  }
}
