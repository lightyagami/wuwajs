...
let CharacterCatapultComponent = CharacterCatapultComponent_1 = class CharacterCatapultComponent extends EntityComponent_1.EntityComponent {
  ...
  StartCatapult() {
    ...
    if (this.w$r && (t = this.Entity.GetComponent(43).GetSkillMontageInstance(Number(SUPER_CATAPULT_SKILL_ID), 0), i?.MainAnimInstance) && t?.IsValid()) {
...
CharacterCatapultComponent = CharacterCatapultComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(35)], CharacterCatapultComponent);
