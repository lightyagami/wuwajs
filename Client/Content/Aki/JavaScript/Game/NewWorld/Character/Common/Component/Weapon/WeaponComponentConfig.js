...
exports.WeaponComponentConfig = undefined;
...
class WeaponComponentConfig extends ConfigBase_1.ConfigBase {
  GetWeaponVisibleConfig(e) {
    ...
    if (e) {
      e = e.GetPbDataId();
      return this.GetWeaponVisibleConfigById(e);
    }
  }
  GetWeaponVisibleConfigById(e) {
    return WeaponVisibleConfigByIdWithZero_1.configWeaponVisibleConfigByIdWithZero.GetConfig(e, e, e);
  }
  GetHideWeaponTags(e) {
    return WeaponHideConfigByIdWithZero_1.configWeaponHideConfigByIdWithZero.GetConfig(e, e, e).HideWeaponTags.map(e => GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(e));
  }
}
