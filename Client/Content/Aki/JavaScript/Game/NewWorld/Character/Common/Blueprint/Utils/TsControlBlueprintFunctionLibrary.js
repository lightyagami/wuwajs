...
class TsControlBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetMoveVector(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 62).GetMoveVector(tmpVector), tmpVector2D.X = tmpVector.X, tmpVector2D.Y = tmpVector.Y, tmpVector2D
  }
  static GetMoveDirection(t) {
    return EntitySystem_1.EntitySystem.GetComponent(t, 62).GetMoveDirection(tmpVector), tmpVector2D.X = tmpVector.X, tmpVector2D.Y = tmpVector.Y, tmpVector2D
  }
  static PlayKuroForceFeedback(t, e, o, r, c) {
    Info_1.Info.IsInGamepad() && Global_1.Global.CharacterController && Global_1.Global.CharacterController.PlayKuroForceFeedback(t, e, o, r, c)
  }
  static StopKuroForceFeedback(t, e) {
    Global_1.Global.CharacterController && Global_1.Global.CharacterController.StopKuroForceFeedback(t, e)
  }
  static BpInputReceiveEndPlay(t) {
    t = EntitySystem_1.EntitySystem.Get(t);
    !t || t.IsEnd || UE.KuroStaticLibrary.IsWorldTearingDown(Info_1.Info.World) || Log_1.Log.CheckError() && Log_1.Log.Error("Test", 6, "Bp Input Destroy at Wrong Time.", ["Actor", t.GetComponent(3)?.Actor?.GetName()])
  }
