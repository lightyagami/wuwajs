...
class DamageShare extends ExtraEffectBase_1.BuffEffect {
  ...
  InitParameters(t) {
    ...
    this.ShareType = Number(e[0] ?? 0), this.ShareRate = AbilityUtils_1.AbilityUtils.GetLevelValue(t, this.Level, 0) * CharacterAttributeTypes_1.DIVIDED_TEN_THOUSAND
  }
  ...
  OnExecute(t) {
    return this.InstigatorEntityId === this.OwnerEntity.Id ? (Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 19, "[DamageShare] Cannot Share damage to oneself.", ["entityId", this.InstigatorEntityId]), [void 0, 0]) : t ? this.IsShareable(t.CalculateType) ? [this.InstigatorEntityId, this.ShareRate] : void 0 : [void 0, 0]
  }
  IsShareable(t) {
  ...
  static GetShareRateMap(t, e) {
    var r, i, s = t.GetComponent(174),
      t = s.BuffEffectManager.FilterById(18),
      a = new Map;
    for (const o of t) o.Check({}, s) && ([r, i] = o.Execute(e), void 0 !== r) && a.set(r, i + (a.get(r) ?? 0));
    return a
  }
}
