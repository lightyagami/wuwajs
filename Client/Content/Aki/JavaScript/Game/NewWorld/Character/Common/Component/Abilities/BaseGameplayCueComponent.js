...
var __decorate = this && this.__decorate || function(e, a, t, r) {
  var u, l = arguments.length,
    m = l < 3 ? a : null === r ? r = Object.getOwnPropertyDescriptor(a, t) : r;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) m = Reflect.decorate(e, a, t, r);
  else
    for (var C = e.length - 1; 0 <= C; C--)(u = e[C]) && (m = (l < 3 ? u(m) : 3 < l ? u(a, t, m) : u(a, t)) || m);
...
function getGameplayCueClass(e, a) {
  switch (e.CueType) {
    case 0:
      return e.bSoftFollow ? GameplayCueFollow_1.GameplayCueFollow : GameplayCueEffect_1.GameplayCueEffect;
    case 1:
...
let BaseGameplayCueComponent = class BaseGameplayCueComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.CueContainer = new Map, this.OtherCueMap = new Map
  }
  OnEnd() {
  ...
  AddCue(e, a = {}) {
    return this.CreateGameplayCueInner(e, a)?.Handle ?? GameplayCueController_1.INVALID_CUE_HANDLE
  }
  RemoveCue(e) {
    e = this.GetCueById(e);
    e && e.Destroy()
  ...
  AddToOtherCueMap(e, a, t) {
    this.OtherCueMap.has(e) || this.OtherCueMap.set(e, new Map), this.OtherCueMap.get(e).set(a, t)
  }
  RemoveFromOtherCueMap(e, a) {
    var t = this.OtherCueMap.get(e)?.get(a);
    t && (t.Destroy(), t = this.OtherCueMap.get(e)) && (t.delete(a), t.size <= 0) && this.OtherCueMap.delete(e)
  }* GetAllCurrentCueRef() {
  ...
  GetBuffByHandleId(e) {
    var a;
    let t = (this.GetEntityHandle()?.Entity?.GetComponent(174))?.GetBuffByHandle(e);
    return t || (a = this.GetEntityHandle()?.Entity?.GetComponent(190), t = a?.GetFormationBuffComp()?.GetBuffByHandle(e)), t
  }
  xJs(e) {
    var a = Protocol_1.Aki.Protocol.he_.create();
    a.TJs = MathUtils_1.MathUtils.NumberToLong(e), CombatMessage_1.CombatNet.Send(16635, this.GetEntityHandle().Entity, a)
  }
  ...
  CreateGameplayCueInner(e, a = {}) {
    var t, r, u, l = GameplayCueController_1.GameplayCueController.GetConfigById(e);
    if (l) return t = a.Buff, (u = getGameplayCueClass(l, r = a.Instant ?? !1)) ? (u = u.Spawn({
      CueConfig: l,
      ...
      Instigator: t?.GetInstigator() ? ModelManager_1.ModelManager.CharacterModel.GetHandleByEntity(t.GetInstigator()) : a.Instigator
    }), a.Sync && this.xJs(e), u) : void 0
  }
};
__decorate([CombatMessage_1.CombatNet.Listen("EJs", !0)], BaseGameplayCueComponent, "GameplayCueNotify", null), BaseGameplayCueComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(225)], BaseGameplayCueComponent), exports.BaseGameplayCueComponent = BaseGameplayCueComponent;
