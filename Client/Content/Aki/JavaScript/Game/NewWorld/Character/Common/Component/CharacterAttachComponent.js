...
let CharacterAttachComponent = CharacterAttachComponent_1 = class CharacterAttachComponent extends EntityComponent_1.EntityComponent {
  ...
  u4a(e, i, a = undefined) {
    for (let t = this.l4a.length - 1; t >= 0; --t) {
      var r = this.l4a[t];
      if (r.Entity?.Valid && (r = r.Entity.GetComponent(180))?.Valid) {
  ...
  _4a() {
    var t;
    if (this.r4a?.Valid && (t = this.r4a.Entity.GetComponent(180))?.Valid) {
  ...
  Uql(t) {
    ...
    CombatMessage_1.CombatNet.Call(18007, this.Entity, e, t => {
  ...
  static AddCombineEntitiesRelationNotify(t, e) {
    ...
    if (t && (i = t.GetComponent(180))?.Valid && (a = e.Dql)) {
  ...
  Aql(t) {
    ...
    CombatMessage_1.CombatNet.Call(28751, this.Entity, e, t => {
      if (t.Q4n !== Protocol_1.Aki.Protocol.Q4n.KRs) {
        if (CharacterAttachComponent_1.Lql && Log_1.Log.CheckDebug()) {
  ...
  static RemoveCombineRelationNotify(t, e) {
    ...
    if (t && (i = t.GetComponent(180))?.Valid && (i.DetachFromHost(false, false, false), CharacterAttachComponent_1.Lql) && Log_1.Log.CheckDebug()) {
...
CharacterAttachComponent = CharacterAttachComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(180)], CharacterAttachComponent);
