...
class PatrolMoveLogic {
  ...
  UpdateMove(t) {
    ...
    GlobalData_1.GlobalData.IsPlayInEditor && MoveToLocationLogic_1.MoveToLocationController.DebugDraw && this.IJo(), this.ezo();
    let i = 0;
    ...
    var s;
    return this.WJo.Normalize(), this.mBe && this.mBe.PositionState === CharacterUnifiedStateTypes_1.ECharPositionState.Climb ? (this.jJo.DeepCopy(this.Hte.ActorQuatProxy), this.jJo.Inverse(this.jJo), this.jJo.RotateVector(this.WJo, this.WJo), s = this.WJo.X, this.WJo.X = this.WJo.Z, this.WJo.Z = s, this.Hte.SetInputDirect(this.WJo)) : (this.Hte.SetOverrideTurnSpeed(this.lJo), this.sJo ? this.Hte.SetInputDirect(this.Hte.ActorForwardProxy) : this.Hte.SetInputDirect(this.WJo), AiContollerLibrary_1.AiControllerLibrary.TurnToDirect(this.Hte, this.WJo, this.lJo, this.sJo)), !0
  }
  ZJo(t) {
    this.XJo = this.NOe, this.NOe = t, this.$Jo = this.YJo[this.NOe], this.ezo(), Log_1.Log.CheckDebug() && Log_1.Log.Debug("AI", 42, "更新移动目标点", ["EntityId", this.Entity.Id], ["PbDataId", this.Hte.CreatureData.GetPbDataId()], ["CurrentIndex", this.NOe], ["CurrentToLocation", this.$Jo])
  }
  ezo() {
    var t;
    this.WJo.DeepCopy(this.$Jo), this.WJo.SubtractionEqual(this.Hte.ActorLocationProxy), this.c6a.DeepCopy(this.WJo), this.mBe?.PositionState === CharacterUnifiedStateTypes_1.ECharPositionState.Climb ? (this.jye.DeepCopy(this.WJo), t = this.jye.DotProduct(this.Hte.ActorForwardProxy), this.jye.DeepCopy(this.Hte.ActorForwardProxy), this.jye.MultiplyEqual(t), this.jye.UnaryNegation(this.jye), this.jye.AdditionEqual(this.WJo), this.WJo.DeepCopy(this.jye)) : this.sJo || (this.WJo.Z = 0), this.nRi = this.sJo ? this.c6a.Size() : this.c6a.Size2D()
  }
  tzo() {
    if (this.XJo === this.NOe || this.nRi <= this.nJo) return this.ozo(), Log_1.Log.CheckDebug() && Log_1.Log.Debug("AI", 42, "到达目标位置", ["EntityId", this.Entity.Id], ["PbDataId", this.Hte.CreatureData.GetPbDataId()], ["distance", this.nRi], ["index", this.NOe]), !0;
    this.$Jo.Subtraction(this.YJo[this.XJo], this.jye), GravityUtils_1.GravityUtils.SetZnInGravityForActor(this.Hte, this.jye, 0), this.RTe.DeepCopy(this.c6a), GravityUtils_1.GravityUtils.SetZnInGravityForActor(this.Hte, this.RTe, 0);
    var t = this.RTe.DotProduct(this.jye);
    return (t < 0 || this.nRi < this.nJo) && (this.ozo(), Log_1.Log.CheckDebug()) && Log_1.Log.Debug("AI", 42, "经过了目标位置", ["EntityId", this.Entity.Id], ["PbDataId", this.Hte.CreatureData.GetPbDataId()], ["distance", this.nRi], ["index", this.NOe], ["dotProduct", t]), t < 0 || this.nRi < this.nJo
  }
  ozo() {
    this.KJo.DeepCopy(this.$Jo), Log_1.Log.CheckDebug() && Log_1.Log.Debug("AI", 42, "经过目标位置，更新拉回点记录", ["EntityId", this.Entity.Id], ["PbDataId", this.Hte.CreatureData.GetPbDataId()], ["LastPatrolPoint", this.KJo], ["CurrentPoint", this.Hte.ActorLocationProxy])
  }
