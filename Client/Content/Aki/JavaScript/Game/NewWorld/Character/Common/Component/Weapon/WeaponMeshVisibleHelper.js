...
class WeaponMeshVisibleHelper {
  constructor(e) {
    this.Owner = e, this.WeaponVisibleTable = new Map, this.DefaultVisibleType = 0, this.DefaultVisibleState = new WeaponVisibleState, this.WeaponHiddenTag = new WeaponVisibleTagHelper_1.WeaponVisibleTagHelper, this.WeaponVisibleTag = new WeaponVisibleTagHelper_1.WeaponVisibleTagHelper
  }
  InitBaseTable(e) {
    this.DefaultVisibleType = e;
    e = new WeaponVisibleState(!1, !1, 0), this.WeaponVisibleTable.set(0, e), e = new WeaponVisibleState(!1, !1, 1), this.WeaponVisibleTable.set(1, e), e = new WeaponVisibleState(!1, !1, 2);
    this.WeaponVisibleTable.set(2, e)
  }
  InitTagHelper(e, i, t, s, a) {
    this.WeaponVisibleTag.Init(this.Owner, e, i?.split("#"), t), this.WeaponHiddenTag.Init(this.Owner, e, s?.split("#"), a)
  }
  ClearTagHelper() {
  ...
  RequestAndUpdateHiddenInGame(e, i = !0, t = 0) {
    ...
    t = this.uer();
    return t && (0 === t.Priority && i && t.Active ? t.Active = !1 : s = t.IsHidden), s
  }
  ...
  uer() {
    let e = -1,
      i = void 0;
    for (var [, t] of this.WeaponVisibleTable) t.Active && t.Priority > e && (e = t.Priority, i = t);
    return i
  }
}
