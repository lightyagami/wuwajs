...
class AddBulletTrigger extends ExtraEffectPassiveEffects_1.PassiveEffects {
  ...
  InitParameters(e) {
    ...
    this.EventType = Number(e[0]), this.TargetType = Number(e[1]), this.BulletIds = e[2].split("#").map(e => BigInt(e)), this.BulletDtType = Number(e[3] ?? -1)
  }
  OnExecute() {
    ...
    if (e && r && t) {
      ...
      for (const i of this.BulletIds) BulletController_1.BulletController.CreateBulletCustomTarget(r, String(i), t, {
        SyncType: 1,
