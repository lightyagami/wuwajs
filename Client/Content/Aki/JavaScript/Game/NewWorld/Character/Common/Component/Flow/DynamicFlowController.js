...
class DynamicFlowController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return this.jYo(), Net_1.Net.Register(19915, DynamicFlowController.WYo), Net_1.Net.Register(19899, DynamicFlowController.KYo), !0
  }
  static OnClear() {
    return Net_1.Net.UnRegister(19915), Net_1.Net.UnRegister(19899), !0
  }
  static jYo() {
    this.QYo.set(1, 5), this.QYo.set(2, 20), this.QYo.set(3, 20), this.QYo.set(4, 20)
  }
  ...
  static AddDynamicFlow(r) {
    ...
    a?.Entity?.IsInit && (a.Entity?.GetComponent(31))?.PlayDynamicFlowBegin(r), this.$Yo.set(o, r);
    for (const n of r.BubbleData.EntityIds) this.XYo.set(n, o);
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("NPC", 50, "添加动态冒泡", ["PbDataId", o], ["Type", r.Type], ["FlowName", r.BubbleData.Flow.FlowListName]), !0
  }
  static RemoveDynamicFlow(r) {
    ...
    return this.$Yo.delete(r), Log_1.Log.CheckDebug() && Log_1.Log.Debug("NPC", 50, "移除动态冒泡", ["PbDataId", r], ["Type", t.Type], ["FlowName", t.BubbleData.Flow.FlowListName]), !0
  }
...
}(exports.DynamicFlowController = DynamicFlowController).$Yo = new Map, DynamicFlowController.XYo = new Map, DynamicFlowController.QYo = new Map, DynamicFlowController.WYo = r => {
  var r = ConfigManager_1.ConfigManager.BubbleConfig.GetBubbleData(r.LIs);
  r && r.EntityIds.length && (r = DynamicFlowController.CreateCharacterFlowData(r), DynamicFlowController.AddDynamicFlow(r))
}, DynamicFlowController.KYo = r => {
  var r = ConfigManager_1.ConfigManager.BubbleConfig.GetBubbleData(r.LIs);
  r && r.EntityIds.length && (r = r.EntityIds[0], DynamicFlowController.RemoveDynamicFlow(r))
};
