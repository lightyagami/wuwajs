...
class FollowShooterInputLayer extends InputLayer_1.InputLayer {
  constructor() {
    super(...arguments), this.orl = void 0, this.Aia = void 0, this.nrl = new Set, this.YY_ = new Array, this.zY_ = new Set, this.JY_ = (t, s) => {
  ...
  Start(t) {
    ...
    s && s.InputComponentClass && ResourceSystem_1.ResourceSystem.LoadAsync(s.InputComponentClass.AssetPathName?.toString(), UE.Class, t => {
      this.Aia = s.AddComponentByClass(t, !1, MathUtils_1.MathUtils.DefaultTransform, !1), this.Aia.OwnerActor = s
    });
  ...
  HandlePress(s, e) {
    if (this.srl(s, 1)) {
      ...
      return this.orl.ExecuteCommand(t), FollowShooterInputLayer.GetSwallowCommand()
    }
  }
  HandleHold(s, e) {
    if (this.srl(s, 3)) {
