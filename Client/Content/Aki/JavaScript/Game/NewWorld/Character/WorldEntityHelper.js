...
const UE = require("ue"),
  ...
  InteractionSpotComponent_1 = require("../../Module/Interaction/InteractionSpotComponent"),
  ...
  SceneItemCurveControlComponent_1 = require("../SceneItem/Common/Component/SceneItemCurveControlComponent"),
  ...
  TemplateEntitySpawnerComponent_1 = require("../SceneItem/Common/Component/TemplateEntitySpawnerComponent"),
  ...
  UeSceneItemMoveTickManagerComponent_1 = require("../SceneItem/UeSceneItemMoveTickManagerComponent"),
  ...
  CharacterWalkOnAirComponent_1 = require("./Common/Component/CharacterWalkOnAirComponent"),
  ...
  CharacterRailSlideComponent_1 = require("./Common/Component/Move/CharacterRailSlideComponent"),
  ...
  OptimizationStrategyComponent_1 = require("../Pawn/OptimizationStrategy/OptimizationStrategyComponent"),
  ROLE_PRIORITY = 7,
  GLOBAL_PRIORITY = 7,
  VISION_PRIORITY = 11,
  MONSTER_PRIORITY = 10,
...
class WorldEntityHelper {
  static Initialize() {
    return this.Nor(), this.Oor(), this.xIc(), this.kor(), this.b_1(), this.yna(), !0
  }
  static Clear() {
    return this.ComponentPriority.clear(), this.For.clear(), this.DIc.clear(), this.R_1.clear(), !0
  }
  static CreateWorldEntity(e) {
    ...
    switch (n.zHn) {
      case Protocol_1.Aki.Protocol.kks.Proto_Monster:
        if (e.Priority = MONSTER_PRIORITY, this.GetMonsterComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_Player:
        if (e.Priority = ROLE_PRIORITY, e.ComponentDataMap.get("oI_")?.oI_?.fI_) {
      ...
      case Protocol_1.Aki.Protocol.kks.Proto_Vision:
        if (e.Priority = VISION_PRIORITY, this.GetVisionComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_Animal:
        if (e.Priority = OTHER_PRIORITY, this.GetAnimalComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_Custom:
        if (e.Priority = OTHER_PRIORITY, this.GetCustomComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_PlayerEntity:
        if (e.Priority = GLOBAL_PRIORITY, this.GetPlayerComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_SceneEntity:
        if (e.Priority = GLOBAL_PRIORITY, this.GetSceneEntityComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.Proto_Npc:
        switch (e.Priority = NPC_PRIORITY, n.oys || 0) {
          case 1:
            this.Hor && (t = ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(this.Hor), o = this.Hor);
            break;
          case 2:
            this.jor && (t = ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(this.jor), o = this.jor);
            break;
          case 3:
            this.w4l && (t = ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(this.w4l), o = this.w4l);
            break;
          case 4:
            this.Yo1 && (t = ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(this.Yo1), o = this.Yo1);
            break;
          default:
            this.Wor && (t = ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(this.Wor), o = this.Wor)
        }
      ...
      case Protocol_1.Aki.Protocol.kks.Proto_SceneItem:
        if (e.Priority = OTHER_PRIORITY, this.GetSceneItemComponentRecord(e)) break;
        return;
      case Protocol_1.Aki.Protocol.kks.HI_:
        if (e.Priority = VEHICLE_PRIORITY, this.GetVehicleComponentRecord(e)) break;
        return
    }
    if (o = e.ComponentsKey, t = t || ControllerHolder_1.ControllerHolder.CharacterController.SpawnEntity(o)) {
      if (!ControllerHolder_1.ControllerHolder.CharacterController.Respawn(t, t.Entity, e.Priority, e)) return
    } else t = ControllerHolder_1.ControllerHolder.CharacterController.CreateEntity(o, e);
    return t
  }
  static Destroy(e) {
    if (exports.USE_ENTITY_POOL) {
      var n = e.Entity.GetComponent(0);
      if (n.IsNpc()) switch (n.GetSubEntityType()) {
        case 1:
        ...
        case 3:
          ...
          break;
        case 4:
          this.Yo1 = n.GetComponentKey();
          break;
        default:
          this.Wor = n.GetComponentKey()
      }
      return ControllerHolder_1.ControllerHolder.CharacterController.DestroyToLru(e) ? !0 : !1
    }
    return !!ControllerHolder_1.ControllerHolder.CharacterController.Destroy(e)
  }
  static GetMonsterComponentRecord(e) {
    if (!e.AddComponent(CreatureDataComponent_1.CreatureDataComponent)) return !1;
    if (!e.AddComponent(CharacterActorComponent_1.CharacterActorComponent)) return !1;
    if (!e.AddComponent(CharacterLogicStateSyncComponent_1.CharacterLogicStateSyncComponent)) return !1;
    if (!e.AddComponent(CharacterBirthTagComponent_1.CharacterBirthTagComponent)) return !1;
    if (!e.AddComponent(CharacterStateMachineNewComponent_1.CharacterStateMachineNewComponent)) return !1;
    if (!e.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent)) return !1;
    if (!e.AddComponent(CharacterAbilityComponent_1.CharacterAbilityComponent)) return !1;
    if (!e.AddComponent(CharacterAttributeComponent_1.CharacterAttributeComponent)) return !1;
    if (CreateEntityData_1.CreateEntityData.IsFollowShooter(e) && !e.AddComponent(CharacterSkillCdComponent_1.CharacterSkillCdComponent)) return !1;
    if (!e.AddComponent(CharacterBuffComponent_1.CharacterBuffComponent)) return !1;
    if (!e.AddComponent(CharacterGameplayCueComponent_1.CharacterGameplayCueComponent)) return !1;
    if (Info_1.Info.IsBuildDevelopmentOrDebug) {
      if (!e.AddComponent(CharacterGasDebugComponent_1.CharacterGasDebugComponent)) return !1;
      if (!e.AddComponent(CharacterStatisticsComponent_1.CharacterStatisticsComponent)) return !1;
      if (!e.AddComponent(ActorDebugMovementComponent_1.ActorDebugMovementComponent)) return !1
    }
    if (!e.AddComponent(CharacterUnifiedStateComponent_1.CharacterUnifiedStateComponent)) return !1;
    if (!e.AddComponent(CharacterFightStateComponent_1.CharacterFightStateComponent)) return !1;
    if (!e.AddComponent(CharacterTriggerComponent_1.CharacterTriggerComponent)) return !1;
    if (!e.AddComponent(CharacterMontageComponent_1.CharacterMontageComponent)) return !1;
    if (!e.AddComponent(CharacterDamageComponent_1.CharacterDamageComponent)) return !1;
    if (!e.AddComponent(MonsterFrozenComponent_1.MonsterFrozenComponent)) return !1;
    if (!e.AddComponent(CharacterShieldComponent_1.CharacterShieldComponent)) return !1;
    if (!e.AddComponent(LevelTagComponent_1.LevelTagComponent)) return !1;
    if (!e.AddComponent(MonsterDeathComponent_1.MonsterDeathComponent)) return !1;
    if (!e.AddComponent(CharacterAnimationComponent_1.CharacterAnimationComponent)) return !1;
    if (!e.AddComponent(CharacterMoveComponent_1.CharacterMoveComponent)) return !1;
    if (!e.AddComponent(CharacterMovementSyncComponent_1.CharacterMovementSyncComponent)) return !1;
    if (!e.AddComponent(CharacterAnimationSyncComponent_1.CharacterAnimationSyncComponent)) return !1;
    if (!e.AddComponent(CharacterRoleTransitionComponent_1.CharacterRoleTransitionComponent)) return !1;
    if (!e.AddComponent(CharacterSkillComponent_1.CharacterSkillComponent)) return !1;
    if (!e.AddComponent(CharacterCustomValueComponent_1.CharacterCustomValueComponent)) return !1;
    if (!e.AddComponent(CharacterPassiveSkillComponent_1.CharacterPassiveSkillComponent)) return !1;
    if (!e.AddComponent(CharacterSkillTriggerComponent_1.CharacterSkillTriggerComponent)) return !1;
    if (!e.AddComponent(CharacterSpecialSkillComponent_1.CharacterSpecialSkillComponent)) return !1;
    if (!e.AddComponent(CharacterAiComponent_1.CharacterAiComponent)) return !1;
    if (!e.AddComponent(CharacterFollowComponent_1.CharacterFollowComponent)) return !1;
    if (!e.AddComponent(CharacterHitComponent_1.CharacterHitComponent)) return !1;
    if (!e.AddComponent(CharacterTimeScaleComponent_1.CharacterTimeScaleComponent)) return !1;
    if (!e.AddComponent(PawnPerceptionComponent_1.PawnPerceptionComponent)) return !1;
    if (!e.AddComponent(MonsterBehaviorComponent_1.MonsterBehaviorComponent)) return !1;
    if (!e.AddComponent(CharacterWeaponComponent_1.CharacterWeaponComponent)) return !1;
    if (!e.AddComponent(UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent)) return !1;
    if (!e.AddComponent(CharacterCaughtNewComponent_1.CharacterCaughtNewComponent)) return !1;
    if (!e.AddComponent(UeMovementTickManageComponent_1.UeMovementTickManageComponent)) return !1;
    if (!e.AddComponent(UeActorTickManageComponent_1.UeActorTickManageComponent)) return !1;
    if (GlobalData_1.GlobalData.IsPlayInEditor) {
      if (!e.AddComponent(UeComponentTickManageComponent_1.UeComponentTickManageComponent)) return !1;
      e.SetParam(UeComponentTickManageComponent_1.UeComponentTickManageComponent, UE.TsCharacterDebugComponent_C.StaticClass())
    }
    if (!e.AddComponent(CharacterPartComponent_1.CharacterPartComponent)) return !1;
    if (!e.AddComponent(CharacterPartScanComponent_1.CharacterPartScanComponent)) return !1;
    if (CreateEntityData_1.CreateEntityData.HasScanInfo(e) && !e.AddComponent(ScanComponent_1.ScanComponent)) return !1;
    if (!e.AddComponent(CharacterAudioComponent_1.CharacterAudioComponent)) return !1;
    if (!e.AddComponent(CharacterSwimComponent_1.CharacterSwimComponent)) return !1;
    var n = CreateEntityData_1.CreateEntityData.GetAnimalComponentConfig(e);
    if (n) {
      if (!e.AddComponent(AnimalStateMachineComponent_1.AnimalStateMachineComponent)) return !1;
      if (!e.AddComponent(AnimalPerformComponent_1.AnimalPerformComponent)) return !1;
      e.SetParam(AnimalPerformComponent_1.AnimalPerformComponent, n)
    }
    if (!e.AddComponent(PawnInteractNewComponent_1.PawnInteractNewComponent)) return !1;
    if (!e.AddComponent(InteractionSpotComponent_1.InteractionSpotComponent)) return !1;
    do {
    ...
    if (CreateEntityData_1.CreateEntityData.IsRobot(e) && !e.AddComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent)) return !1;
    if (CreateEntityData_1.CreateEntityData.IsFollowShooter(e) && !e.AddComponent(FollowShooterComponent_1.FollowShooterComponent)) return !1;
    if (!e.AddComponent(PawnInfoManageComponent_1.PawnInfoManageComponent)) return !1;
    if (!e.AddComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent)) return !1;
    if (!e.AddComponent(MonsterFlowComponent_1.MonsterFlowComponent)) return !1;
    if (!e.AddComponent(CharacterPatrolComponent_1.CharacterPatrolComponent)) return !1;
    if (!e.AddComponent(CharacterAttachComponent_1.CharacterAttachComponent)) return !1;
    if (!e.AddComponent(CharacterCombatMessageComponent_1.CharacterCombatMessageComponent)) return !1;
    if (4 === CreateEntityData_1.CreateEntityData.GetBaseInfo(e)?.Category.MonsterMatchType) {
      if (!e.AddComponent(CharacterGaitComponent_1.CharacterGaitComponent)) return !1;
      if (!e.AddComponent(SubMeshComponent_1.SubMeshComponent)) return !1
    }
    return this.UIc(e, this.Ina), !!e.AddComponent(RolePreloadComponent_1.RolePreloadComponent)
  }
  static GetRoleComponentRecord(e) {
    ...
    if (!e.AddComponent(CharacterLogicStateSyncComponent_1.CharacterLogicStateSyncComponent)) return !1;
    if (!e.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent)) return !1;
    if (!e.AddComponent(RoleDriveVehicleComponent_1.RoleDriveVehicleComponent)) return !1;
    if (!e.AddComponent(CharacterStateMachineNewComponent_1.CharacterStateMachineNewComponent)) return !1;
    if (!e.AddComponent(CharacterAbilityComponent_1.CharacterAbilityComponent)) return !1;
    if (!e.AddComponent(RoleGrowComponent_1.RoleGrowComponent)) return !1;
    if (!e.AddComponent(RoleAttributeComponent_1.RoleAttributeComponent)) return !1;
    if (!e.AddComponent(CharacterSkillCdComponent_1.CharacterSkillCdComponent)) return !1;
    ...
    if (!e.AddComponent(RoleStrengthComponent_1.RoleStrengthComponent)) return !1;
    if (!e.AddComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent)) return !1;
    if (!e.AddComponent(CharacterSkillComponent_1.CharacterSkillComponent)) return !1;
    if (!e.AddComponent(CharacterCustomValueComponent_1.CharacterCustomValueComponent)) return !1;
    if (!e.AddComponent(CharacterPassiveSkillComponent_1.CharacterPassiveSkillComponent)) return !1;
    ...
    if (!e.AddComponent(CharacterAnimationComponent_1.CharacterAnimationComponent)) return !1;
    if (!e.AddComponent(CharacterMoveComponent_1.CharacterMoveComponent)) return !1;
    if (!e.AddComponent(CharacterPendulumComponent_1.CharacterPendulumComponent)) return !1;
    if (!e.AddComponent(CharacterThrowComponent_1.CharacterThrowComponent)) return !1;
    if (!e.AddComponent(CharacterCaughtNewComponent_1.CharacterCaughtNewComponent)) return !1;
    if (!e.AddComponent(RoleGaitComponent_1.RoleGaitComponent)) return !1;
    if (!e.AddComponent(CharacterInputComponent_1.CharacterInputComponent)) return !1;
    if (!e.AddComponent(CharacterSplineMoveComponent_1.CharacterSplineMoveComponent)) return !1;
    if (!e.AddComponent(CharacterMovementSyncComponent_1.CharacterMovementSyncComponent)) return !1;
    if (!e.AddComponent(CharacterAnimationSyncComponent_1.CharacterAnimationSyncComponent)) return !1;
    if (!e.AddComponent(CharacterWeaponComponent_1.CharacterWeaponComponent)) return !1;
    if (!e.AddComponent(RoleSceneInteractComponent_1.RoleSceneInteractComponent)) return !1;
    if (!e.AddComponent(CharacterLockOnComponent_1.CharacterLockOnComponent)) return !1;
    if (!e.AddComponent(CharacterFollowComponent_1.CharacterFollowComponent)) return !1;
    if (!e.AddComponent(CharacterManipulateComponent_1.CharacterManipulateComponent)) return !1;
    if (!e.AddComponent(CharacterManipulateInteractComponent_1.CharacterManipulateInteractComponent)) return !1;
    if (!e.AddComponent(CharacterLevelShootComponent_1.CharacterLevelShootComponent)) return !1;
    if (!e.AddComponent(CharacterExploreComponent_1.CharacterExploreComponent)) return !1;
    if (!e.AddComponent(CharacterHitComponent_1.CharacterHitComponent)) return !1;
    if (!e.AddComponent(RoleQteComponent_1.RoleQteComponent)) return !1;
    if (!e.AddComponent(CharacterTimeScaleComponent_1.CharacterTimeScaleComponent)) return !1;
    if (!e.AddComponent(CharacterSwimComponent_1.CharacterSwimComponent)) return !1;
    if (!e.AddComponent(CharacterWalkOnWaterComponent_1.CharacterWalkOnWaterComponent)) return !1;
    if (!e.AddComponent(CharacterWalkOnAirComponent_1.CharacterWalkOnAirComponent)) return !1;
    if (!e.AddComponent(CharacterClimbComponent_1.CharacterClimbComponent)) return !1;
    if (!e.AddComponent(CharacterGlideComponent_1.CharacterGlideComponent)) return !1;
    if (!e.AddComponent(CharacterSlideComponent_1.CharacterSlideComponent)) return !1;
    if (!e.AddComponent(CharacterRailSlideComponent_1.CharacterRailSlideComponent)) return !1;
    if (!e.AddComponent(CharacterCatapultComponent_1.CharacterCatapultComponent)) return !1;
    if (!e.AddComponent(CharacterRollComponent_1.CharacterRollComponent)) return !1;
    if (!e.AddComponent(CharacterKiteComponent_1.CharacterKiteComponent)) return !1;
    if (!e.AddComponent(CharacterActionComponent_1.CharacterActionComponent)) return !1;
    if (!e.AddComponent(UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent)) return !1;
    if (!e.AddComponent(UeMovementTickManageComponent_1.UeMovementTickManageComponent)) return !1;
    if (!e.AddComponent(UeActorTickManageComponent_1.UeActorTickManageComponent)) return !1;
    if (GlobalData_1.GlobalData.IsPlayInEditor) {
  ...
  static GetVisionComponentRecord(e) {
    ...
    return !!(e.AddComponent(CharacterPartComponent_1.CharacterPartComponent) && e.AddComponent(CharacterAudioComponent_1.CharacterAudioComponent) && e.AddComponent(CharacterCombatMessageComponent_1.CharacterCombatMessageComponent) && e.AddComponent(RolePreloadComponent_1.RolePreloadComponent)) && (e.RegisterToGameBudgetController = !0)
  }
  static GetAnimalComponentRecord(e) {
    if (!e.AddComponent(CreatureDataComponent_1.CreatureDataComponent)) return !1;
    if (!e.AddComponent(CharacterActorComponent_1.CharacterActorComponent)) return !1;
    if (Info_1.Info.IsBuildDevelopmentOrDebug && !e.AddComponent(ActorDebugMovementComponent_1.ActorDebugMovementComponent)) return !1;
    if (!e.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent)) return !1;
    if (!e.AddComponent(CharacterMontageComponent_1.CharacterMontageComponent)) return !1;
    if (!e.AddComponent(BaseTagComponent_1.BaseTagComponent)) return !1;
    if (!e.AddComponent(BaseUnifiedStateComponent_1.BaseUnifiedStateComponent)) return !1;
    if (!e.AddComponent(CharacterAnimationComponent_1.CharacterAnimationComponent)) return !1;
    if (!e.AddComponent(AnimalStateMachineComponent_1.AnimalStateMachineComponent)) return !1;
    if (!e.AddComponent(CharacterMoveComponent_1.CharacterMoveComponent)) return !1;
    if (!e.AddComponent(CharacterAudioComponent_1.CharacterAudioComponent)) return !1;
    if (!e.AddComponent(CharacterAiComponent_1.CharacterAiComponent)) return !1;
    if (!e.AddComponent(CharacterHitComponent_1.CharacterHitComponent)) return !1;
    if (!e.AddComponent(AnimalDeathSyncComponent_1.AnimalDeathSyncComponent)) return !1;
    if (!e.AddComponent(PawnPerceptionComponent_1.PawnPerceptionComponent)) return !1;
    ...
    if (!e.AddComponent(CharacterPlanComponent_1.CharacterPlanComponent)) return !1;
    if (!e.AddComponent(UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent)) return !1;
    if (!e.AddComponent(UeMovementTickManageComponent_1.UeMovementTickManageComponent)) return !1;
    if (!e.AddComponent(UeActorTickManageComponent_1.UeActorTickManageComponent)) return !1;
    if (GlobalData_1.GlobalData.IsPlayInEditor) {
  ...
  static GetCustomComponentRecord(e) {
    ...
    for (const a of o) switch (a) {
      ...
      case "TriggerComponent":
        ...
        if (t.ClientPrePerformance && !e.AddComponent(ClientTriggerComponent_1.ClientTriggerComponent)) return !1;
      ...
      case "LocationSafetyComponent":
        ...
        if (!r) return !1;
        if (!e.AddComponent(SafetyLocationComponent_1.SafetyLocationComponent)) return !1;
      ...
      case "ClientTriggerComponent":
        ...
        if (!r) return !1;
        if (!e.AddComponent(ClientTriggerComponent_1.ClientTriggerComponent)) return !1;
      ...
      case "EntityCustomAudioComponent":
        ...
        if (!m) return !1;
        if (!e.AddComponent(CustomAudioControlComponent_1.CustomAudioControlComponent)) return !1;
        e.SetParam(CustomAudioControlComponent_1.CustomAudioControlComponent, m);
        break;
      case "PerformanceOptimizationComponent":
        var C = (0, IComponent_1.getComponent)(n, "PerformanceOptimizationComponent");
        if (!C) return !1;
        if (!e.AddComponent(OptimizationStrategyComponent_1.OptimizationStrategyComponent)) return !1;
        ...
        if (n)
          if (n.ComponentsData) {
            var n = e.EntityData,
              n = n.oys || 0,
              o = this.For.get(n);
            if (!o) return Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 3, "初始化NpcEntity类型" + n + "失败，没有对应的组件预设配置", ["CreatureDataId", e.CreatureDataId], ["PbDataId", e.PbDataId]), !1;
            for (const t of o)
  ...
  static GetSceneItemComponentRecord(n) {
    ...
    if (n.EnableMovement = !1, !n.AddComponent(CreatureDataComponent_1.CreatureDataComponent)) return !1;
    if (!n.AddComponent(SceneItemActorComponent_1.SceneItemActorComponent)) return !1;
    if (!n.AddComponent(PawnSensoryInfoComponent_1.PawnSensoryInfoComponent)) return !1;
    if (!n.AddComponent(PawnInfoManageComponent_1.PawnInfoManageComponent)) return !1;
    if (!n.AddComponent(LevelTagComponent_1.LevelTagComponent)) return !1;
    if (!n.AddComponent(SceneItemStateComponent_1.SceneItemStateComponent)) return !1;
    if (!n.AddComponent(SceneItemPropertyComponent_1.SceneItemPropertyComponent)) return !1;
    if (!n.AddComponent(PerformanceComponent_1.PerformanceComponent)) return !1;
    if (!n.AddComponent(SceneItemTimeScaleComponent_1.SceneItemTimeScaleComponent)) return !1;
    if (GlobalData_1.GlobalData.IsPlayInEditor && !n.AddComponent(SceneItemDebugComponent_1.SceneItemDebugComponent)) return !1;
    if (!this.UIc(n, this.DIc, this.R_1)) return !1;
    if (o?.ComponentsData) {
      if ((0, IComponent_1.getComponent)(o.ComponentsData, "InteractComponent")) {
        if (!n.AddComponent(PawnInteractNewComponent_1.PawnInteractNewComponent)) return !1;
        if (!n.AddComponent(InteractionSpotComponent_1.InteractionSpotComponent)) return !1
      }
    } else Log_1.Log.CheckWarn() && Log_1.Log.Warn("Interaction", 36, "SceneItemEntity.AddInteractComponents 旧版交互已经废除");
    if (!n.AddComponent(PawnPerceptionComponent_1.PawnPerceptionComponent)) return !1;
    if (!n.AddComponent(InteractItemComponent_1.InteractItemComponent)) return !1;
    var t = CreateEntityData_1.CreateEntityData.GetBaseInfo(n);
    if (t?.IsShowNameOnHead && !n.HasComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent) && !n.AddComponent(PawnHeadInfoComponent_1.PawnHeadInfoComponent)) return !1;
    t = t?.Category?.FishingMechanismType;
    if (("FishingPoint" === t || "DynamicFishingPoint" === t) && !n.AddComponent(SceneItemFishingPointComponent_1.SceneItemFishingPointComponent)) return !1;
    if (CreateEntityData_1.CreateEntityData.HasScanInfo(n) && !n.AddComponent(ScanComponent_1.ScanComponent)) return !1;
    if (o) {
      let e = !1;
      t = (0, IComponent_1.getComponent)(o.ComponentsData, "WeaponComponent");
      if (t?.WeaponId && (e = !0, !n.AddComponent(AiWeaponMovementComponent_1.AiWeaponMovementComponent))) return !1;
      if (e) {
        if (!n.AddComponent(SceneItemAiInteractionComponent_1.SceneItemAiInteractionComponent)) return !1;
        n.EnableMovement = !0
      }
    }
    if (o) {
      t = (0, IComponent_1.getComponent)(o.ComponentsData, "AiGearStrategyComponent");
      if (t?.StrategyType.Type === IComponent_1.EAiGearStrategy.RaceStrategy && !n.AddComponent(SceneItemAiRacingMoveComponent_1.SceneItemAiRacingMoveComponent)) return !1
    }
  ...
  static UIc(n, e, o) {
    ...
    if (t && r) {
      ...
      if (t) {
        var m = t.EntityType,
          t = IEntity_1.componentsByEntityAki[m];
        if (t)
          for (const _ of t) {
            var C = r[_];
            if (!C) return Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 31, "初始化Entity找不到对应的prefab配置", ["entityType", m], ["creatureDataId", n.CreatureDataId], ["pbDataId", n.PbDataId], ["componentType", _]), !1;
            if (!C.Disabled) {
              var a = e.get(_);
              if (a) {
                var i = o?.get(_);
                if (i && i.length !== a.length) return Log_1.Log.CheckError() && Log_1.Log.Error("Entity", 79, "组件和条件配置数量不一致", ["ctorArrayLength", a.length], ["conditionFuncArrayLength", i.length], ["componentType", _]), !1;
                for (let e = 0; e < a.length; e++) {
                  var p = a[e];
                  if (!n.HasComponent(p)) {
                    if (void 0 !== i) {
                      var c = i[e];
                      if (void 0 !== c && !c(n)) continue
                    }
                    if (!n.AddComponent(p)) return !1;
                    n.SetParam(p, C)
                  }
                }
              }
  ...
  static Kor(e) {
    GlobalData_1.GlobalData.IsPlayInEditor && e.SetParam(UeComponentTickManageComponent_1.UeComponentTickManageComponent, UE.TsCharacterDebugComponent_C.StaticClass())
  }
  static Nor() {
    this.ComponentPriority.set(CharacterActorComponent_1.CharacterActorComponent, CharacterComponentPriorityDefine_1.ACTOR_TICK_PRIORITY), this.ComponentPriority.set(SimpleNpcActorComponent_1.SimpleNpcActorComponent, CharacterComponentPriorityDefine_1.ACTOR_TICK_PRIORITY), this.ComponentPriority.set(NpcMoveComponent_1.NpcMoveComponent, CharacterComponentPriorityDefine_1.MOVE_TICK_PRIORITY), this.ComponentPriority.set(CharacterMovementSyncComponent_1.CharacterMovementSyncComponent, CharacterComponentPriorityDefine_1.MOVEMENT_SYNC_TICK_PRIORITY), this.ComponentPriority.set(UeActorTickManageComponent_1.UeActorTickManageComponent, CharacterComponentPriorityDefine_1.UE_ACTOR_TICK_PRIOTITY), this.ComponentPriority.set(UeMovementTickManageComponent_1.UeMovementTickManageComponent, CharacterComponentPriorityDefine_1.UE_MOVE_TICK_PRIORITY), this.ComponentPriority.set(UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, CharacterComponentPriorityDefine_1.UE_SKELETAL_TICK_PRIORITY), this.ComponentPriority.set(CharacterMoveComponent_1.CharacterMoveComponent, CharacterComponentPriorityDefine_1.MOVE_TICK_PRIORITY), this.ComponentPriority.set(RoleGaitComponent_1.RoleGaitComponent, CharacterComponentPriorityDefine_1.GAIT_TICK_PRIORITY), this.ComponentPriority.set(CharacterInputComponent_1.CharacterInputComponent, CharacterComponentPriorityDefine_1.INPUT_TICK_PRIORITY), this.ComponentPriority.set(CharacterSplineMoveComponent_1.CharacterSplineMoveComponent, CharacterComponentPriorityDefine_1.SPLINE_MOVE_TICK_PRIORITY), this.ComponentPriority.set(CharacterClimbComponent_1.CharacterClimbComponent, CharacterComponentPriorityDefine_1.CLIMB_TICK_PRIORITY), this.ComponentPriority.set(CharacterSlideComponent_1.CharacterSlideComponent, CharacterComponentPriorityDefine_1.SLIDE_TICK_PRIORITY), this.ComponentPriority.set(UeComponentTickManageComponent_1.UeComponentTickManageComponent, CharacterComponentPriorityDefine_1.UE_OTHER_COMPONENT_TICK_PRIORITY), this.ComponentPriority.set(UeVehicleMovementTickManageComponent_1.UeVehicleMovementTickManageComponent, CharacterComponentPriorityDefine_1.UE_MOVE_TICK_PRIORITY), this.ComponentPriority.set(VehicleActorComponent_1.VehicleActorComponent, CharacterComponentPriorityDefine_1.ACTOR_TICK_PRIORITY), this.ComponentPriority.set(VehicleSplineMoveComponent_1.VehicleSplineMoveComponent, CharacterComponentPriorityDefine_1.SPLINE_MOVE_TICK_PRIORITY), this.ComponentPriority.set(VehicleInputComponent_1.VehicleInputComponent, CharacterComponentPriorityDefine_1.VEHICLE_INPUT_PRIORITY), this.ComponentPriority.set(VehicleMoveComponent_1.VehicleMoveComponent, CharacterComponentPriorityDefine_1.MOVE_TICK_PRIORITY), this.ComponentPriority.set(GongduolaSplineMoveComponent_1.GongduolaSplineMoveComponent, CharacterComponentPriorityDefine_1.SPLINE_MOVE_TICK_PRIORITY)
  }
  static Oor() {
    this.For.set(3, [CharacterActorComponent_1.CharacterActorComponent, PawnSensoryInfoComponent_1.PawnSensoryInfoComponent, BaseUnifiedStateComponent_1.BaseUnifiedStateComponent, NpcMoveComponent_1.NpcMoveComponent, CharacterPatrolComponent_1.CharacterPatrolComponent, CharacterAnimationComponent_1.CharacterAnimationComponent, CharacterAnimationSyncComponent_1.CharacterAnimationSyncComponent, VehicleTagComponent_1.VehicleTagComponent, PawnSensoryComponent_1.PawnSensoryComponent, VehicleInputComponent_1.VehicleInputComponent, CommonNpcPerformComponent_1.CommonNpcPerformComponent, NpcVehiclePerformComponent_1.NpcVehiclePerformComponent, PawnInteractNewComponent_1.PawnInteractNewComponent, InteractionSpotComponent_1.InteractionSpotComponent, PawnPerceptionComponent_1.PawnPerceptionComponent, PawnInfoManageComponent_1.PawnInfoManageComponent, PawnHeadInfoComponent_1.PawnHeadInfoComponent, CharacterAiComponent_1.CharacterAiComponent, CharacterPlanComponent_1.CharacterPlanComponent, NpcFlowComponent_1.NpcFlowComponent, UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, UeMovementTickManageComponent_1.UeMovementTickManageComponent, UeActorTickManageComponent_1.UeActorTickManageComponent, CharacterAudioComponent_1.CharacterAudioComponent, ScanComponent_1.ScanComponent]), this.For.set(0, [CharacterActorComponent_1.CharacterActorComponent, PawnSensoryInfoComponent_1.PawnSensoryInfoComponent, BaseUnifiedStateComponent_1.BaseUnifiedStateComponent, NpcMoveComponent_1.NpcMoveComponent, CharacterPatrolComponent_1.CharacterPatrolComponent, CharacterAnimationComponent_1.CharacterAnimationComponent, CharacterAnimationSyncComponent_1.CharacterAnimationSyncComponent, LevelTagComponent_1.LevelTagComponent, PawnSensoryComponent_1.PawnSensoryComponent, CommonNpcPerformComponent_1.CommonNpcPerformComponent, PawnInteractNewComponent_1.PawnInteractNewComponent, InteractionSpotComponent_1.InteractionSpotComponent, PawnPerceptionComponent_1.PawnPerceptionComponent, PawnInfoManageComponent_1.PawnInfoManageComponent, PawnHeadInfoComponent_1.PawnHeadInfoComponent, CharacterAiComponent_1.CharacterAiComponent, CharacterPlanComponent_1.CharacterPlanComponent, NpcFlowComponent_1.NpcFlowComponent, UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, UeMovementTickManageComponent_1.UeMovementTickManageComponent, UeActorTickManageComponent_1.UeActorTickManageComponent, CharacterAudioComponent_1.CharacterAudioComponent, ScanComponent_1.ScanComponent, NpcDriveVehicleComponent_1.NpcDriveVehicleComponent]), Info_1.Info.IsBuildDevelopmentOrDebug && this.For.get(0)?.push(ActorDebugMovementComponent_1.ActorDebugMovementComponent), this.For.set(1, [SimpleNpcActorComponent_1.SimpleNpcActorComponent, SimpleNpcAnimationComponent_1.SimpleNpcAnimationComponent, PawnSensoryInfoComponent_1.PawnSensoryInfoComponent, CommonNpcPerformComponent_1.CommonNpcPerformComponent, PawnPerceptionComponent_1.PawnPerceptionComponent, PawnInfoManageComponent_1.PawnInfoManageComponent, PawnHeadInfoComponent_1.PawnHeadInfoComponent, NpcFlowComponent_1.NpcFlowComponent, UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, UeActorTickManageComponent_1.UeActorTickManageComponent, ScanComponent_1.ScanComponent]), this.For.set(2, [CharacterActorComponent_1.CharacterActorComponent, BaseUnifiedStateComponent_1.BaseUnifiedStateComponent, NpcMoveComponent_1.NpcMoveComponent, NpcPerformComponent_1.NpcPerformComponent, CharacterAnimationComponent_1.CharacterAnimationComponent, NpcPasserbyComponent_1.NpcPasserbyComponent, UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, UeMovementTickManageComponent_1.UeMovementTickManageComponent, UeActorTickManageComponent_1.UeActorTickManageComponent]), this.For.set(4, [CharacterActorComponent_1.CharacterActorComponent, CharacterAnimationComponent_1.CharacterAnimationComponent, UeSkeletalTickManageComponent_1.UeSkeletalTickManageComponent, UeActorTickManageComponent_1.UeActorTickManageComponent, DangoPerformComponent_1.DangoPerformComponent])
  }
  static xIc() {
    this.BIc.set("NearbyTrackingComponent", [SceneItemNearbyTrackingComponent_1.SceneItemNearbyTrackingComponent])
  }
  static b_1() {
    this.R_1.set("TriggerComponent", [void 0, e => {
      var n = e.PbEntityInitData?.ComponentsData;
  ...
  static kor() {
    this.DIc.set("TreasureBoxComponent", [GamePlayTreasureBoxComponent_1.SceneItemTreasureBoxComponent]), this.DIc.set("TeleControl2", [SceneItemHitComponent_1.SceneItemHitComponent, SceneItemManipulatableComponent_1.SceneItemManipulatableComponent, SceneItemMovementSyncComponent_1.SceneItemMovementSyncComponent, SceneItemDynamicAttachTargetComponent_1.SceneItemDynamicAttachTargetComponent]), this.DIc.set("ItemFoundation2", [SceneItemOutletComponent_1.SceneItemOutletComponent]), this.DIc.set("DestructibleItem", [SceneItemHitComponent_1.SceneItemHitComponent, DurablityComponent_1.DurabilityComponent, SceneItemDamageComponent_1.SceneItemDamageComponent]), this.DIc.set("AdsorbComponent", [PawnAdsorbComponent_1.PawnAdsorbComponent]), this.DIc.set("RangeComponent", [RangeComponent_1.RangeComponent]), this.DIc.set("TriggerComponent", [TriggerComponent_1.TriggerComponent, ClientTriggerComponent_1.ClientTriggerComponent]), this.DIc.set("TrampleComponent", [SceneItemGravityComponent_1.SceneItemGravityComponent]), this.DIc.set("TargetGearComponent", [SceneItemMoveComponent_1.SceneItemMoveComponent, UeSceneItemMoveTickManagerComponent_1.UeSceneItemMoveTickManagerComponent, SceneItemHitComponent_1.SceneItemHitComponent, GamePlayHitGearComponent_1.GamePlayHitGearComponent, SceneItemMovementSyncComponent_1.SceneItemMovementSyncComponent]), this.DIc.set("LiftComponent", [GamePlayElevatorComponent_1.GamePlayElevatorComponent]), this.DIc.set("ConveyorBeltComponent", [SceneItemConveyorBeltComponent_1.SceneItemConveyorBeltComponent]), this.DIc.set("FollowTrackComponent", [SceneItemMoveComponent_1.SceneItemMoveComponent, UeSceneItemMoveTickManagerComponent_1.UeSceneItemMoveTickManagerComponent, SceneItemTrackGuideComponent_1.SceneItemTrackGuideComponent, SceneItemMovementSyncComponent_1.SceneItemMovementSyncComponent]), this.DIc.set("NearbyTrackingComponent", [SceneItemNearbyTrackingComponent_1.SceneItemNearbyTrackingComponent]), this.DIc.set("SkyboxComponent", [PostProcessBridgeComponent_1.PostProcessBridgeComponent]), this.DIc.set("DungeonEntryComponent", [DungeonEntranceComponent_1.DungeonEntranceComponent]), this.DIc.set("BuffProducerComponent", [SceneItemBuffProducerComponent_1.SceneItemBuffProducerComponent]), this.DIc.set("BuffConsumerComponent", [SceneItemHitComponent_1.SceneItemHitComponent, SceneItemBuffConsumerComponent_1.SceneItemBuffConsumerComponent]), this.DIc.set("ResetEntitiesPosComponent", [SceneItemResetPositionComponent_1.SceneItemResetPositionComponent]), this.DIc.set("RotatorComponent2", [SceneItemRotatorComponent_1.SceneItemRotatorComponent, UeSceneItemMoveTickManagerComponent_1.UeSceneItemMoveTickManagerComponent]), this.DIc.set("VisionItemComponent", [SceneItemCaptureComponent_1.SceneItemCaptureComponent]), this.DIc.set("GuideLineCreatorComponent", [SceneItemGuidePathComponent_1.SceneItemGuidePathComponent]), this.DIc.set("SceneItemMovementComponent", [SceneItemMoveComponent_1.SceneItemMoveComponent, UeSceneItemMoveTickManagerComponent_1.UeSceneItemMoveTickManagerComponent, SceneItemMovementSyncComponent_1.SceneItemMovementSyncComponent]), this.DIc.set("AdviseItemComponent", [SceneItemAdviceComponent_1.SceneItemAdviceComponent]), this.DIc.set("EntityStateAudioComponent", [SceneItemStateAudioComponent_1.SceneItemStateAudioComponent]), this.DIc.set("InteractAudioComponent", [SceneItemInteractAudioComponent_1.SceneItemInteractAudioComponent]), this.DIc.set("EntityCustomAudioComponent", [CustomAudioControlComponent_1.CustomAudioControlComponent]), this.DIc.set("TimelineTrackControlComponent", [SceneItemTimeTrackControlComponent_1.SceneItemTimeTrackControlComponent]), this.DIc.set("SceneActorRefComponent", [SceneItemReferenceComponent_1.SceneItemReferenceComponent]), this.DIc.set("LevelSequenceFrameEventComponent", [LevelSequenceFrameEventComponent_1.LevelSequenceFrameEventComponent]), this.DIc.set("AttachTargetComponent", [SceneItemDynamicAttachTargetComponent_1.SceneItemDynamicAttachTargetComponent, SceneItemAttachTargetComponent_1.SceneItemAttachTargetComponent]), this.DIc.set("ReboundComponent", [SceneItemReboundComponent_1.SceneItemReboundComponent]), this.DIc.set("TurntableControlComponent", [SceneItemTurntableControllerComponent_1.SceneItemTurntableControllerComponent]), this.DIc.set("JigsawFoundation", [SceneItemJigsawBaseComponent_1.SceneItemJigsawBaseComponent, SceneItemMultiInteractionActorComponent_1.SceneItemMultiInteractionActorComponent]), this.DIc.set("JigsawItem", [SceneItemJigsawItemComponent_1.SceneItemJigsawItemComponent, SceneItemMultiInteractionActorComponent_1.SceneItemMultiInteractionActorComponent]), this.DIc.set("SceneBulletComponent", [SceneBulletComponent_1.SceneBulletComponent]), this.DIc.set("LevitateMagnetComponent", [SceneItemHitComponent_1.SceneItemHitComponent, SceneItemMoveComponent_1.SceneItemMoveComponent, UeSceneItemMoveTickManagerComponent_1.UeSceneItemMoveTickManagerComponent, SceneItemLevitateMagnetComponent_1.SceneItemLevitateMagnetComponent, SceneItemMovementSyncComponent_1.SceneItemMovementSyncComponent]), this.DIc.set("AiAlertNotifyComponent", [SmartObjectComponent_1.SmartObjectComponent]), this.DIc.set("MonsterGachaItemComponent", [SceneItemMonsterGachaItemComponent_1.SceneItemMonsterGachaItemComponent]), this.DIc.set("ProgressBarControlComponent", [SceneItemProgressControlComponent_1.SceneItemProgressControlComponent]), this.DIc.set("ExploreSkillInteractComponent", [SceneItemExploreInteractComponent_1.SceneItemExploreInteractComponent]), this.DIc.set("HookLockPoint", [GrapplingHookPointComponent_1.GrapplingHookPointComponent, SceneItemDynamicAttachTargetComponent_1.SceneItemDynamicAttachTargetComponent]), this.DIc.set("FanComponent", [SceneItemFanComponent_1.SceneItemFanComponent, SceneItemHitComponent_1.SceneItemHitComponent, PawnInteractNewComponent_1.PawnInteractNewComponent, InteractionSpotComponent_1.InteractionSpotComponent, RangeComponent_1.RangeComponent]), this.DIc.set("PickInteractComponent", [SceneItemPickInteractComponent_1.SceneItemPickInteractComponent]), this.DIc.set("AiGearStrategyComponent", [AiGearStrategyComponent_1.AiGearStrategyComponent]), this.DIc.set("ChessmanComponent", [SceneItemChessmanComponent_1.SceneItemChessmanComponent]), this.DIc.set("ResetSelfPosComponent", [SceneItemResetSelfPositionComponent_1.SceneItemResetSelfPositionComponent]), this.DIc.set("TimeStopComponent", [SceneItemTimeStopMachineComponent_1.SceneItemTimeStopMachineComponent]), this.DIc.set("BeamCastComponent", [SceneItemBeamCastComponent_1.SceneItemBeamCastComponent, RangeComponent_1.RangeComponent]), this.DIc.set("BeamReceiveComponent", [SceneItemBeamReceiveComponent_1.SceneItemBeamReceiveComponent]), this.DIc.set("PortalComponent", [SceneItemPortalComponent_1.SceneItemPortalComponent]), this.DIc.set("NoRenderPortalComponent", [SceneItemNoRenderPortalComponent_1.SceneItemNoRenderPortalComponent]), this.DIc.set("BubbleComponent", [CharacterFlowComponent_1.CharacterFlowComponent, PawnHeadInfoComponent_1.PawnHeadInfoComponent]), this.DIc.set("PasserbyNpcSpawnComponent", [PasserbyGeneratorComponent_1.PasserbyGeneratorComponent]), this.DIc.set("EffectAreaComponent", [EffectAreaComponent_1.EffectAreaComponent]), this.DIc.set("PhysicsConstraintComponent", [SceneItemHitComponent_1.SceneItemHitComponent, SceneItemPhysicalAttachComponent_1.SceneItemPhysicalAttachComponent]), this.DIc.set("ConnectorComponent", [CommonConnectComponent_1.CommonConnectComponent]), this.DIc.set("HitComponent", [SceneItemHitComponent_1.SceneItemHitComponent]), this.DIc.set("ClientTriggerComponent", [ClientTriggerComponent_1.ClientTriggerComponent]), this.DIc.set("DynamicPortalCreatorComponent", [DynamicPortalCreatorComponent_1.DynamicPortalCreatorComponent]), this.DIc.set("LocationSafetyComponent", [SafetyLocationComponent_1.SafetyLocationComponent]), this.DIc.set("CollectComponent", [CollectComponent_1.CollectComponent]), this.DIc.set("RenderSpecifiedRangeComponent", [RenderMaskComponent_1.RenderMaskComponent]), this.DIc.set("MonitorComponent", [SceneItemCameraAlertComponent_1.SceneItemCameraAlertComponent, RangeComponent_1.RangeComponent]), this.DIc.set("GroupAiComponent", [SceneItemGroupAiComponent_1.SceneItemGroupAiComponent]), this.DIc.set("BatchBulletCasterComponent", [BatchBulletCasterComponent_1.BatchBulletCasterComponent]), this.DIc.set("ClientConditionListenerComponent", [ClientConditionListenerComponent_1.ClientConditionListenerComponent]), this.DIc.set("AirPassageComponent", [SceneItemWindPipelineComponent_1.SceneItemWindPipelineComponent]), this.DIc.set("InhalationAbilityComponent", [SceneItemInhalationComponent_1.SceneItemInhalationComponent]), this.DIc.set("InhaledItemComponent", [SceneItemInhaledItemComponent_1.SceneItemInhaledItemComponent]), this.DIc.set("PullingObjectFoundation", [SceneItemGenericOutletComponent_1.SceneItemGenericOutletComponent]), this.DIc.set("LevelPrefabPerformComponent", [SubActorPerformanceComponent_1.SubActorPerformanceComponent]), this.DIc.set("SceneItemAiComponent", [SmartObjectComponent_1.SmartObjectComponent]), this.DIc.set("LevelQteComponent", [LevelQteComponent_1.LevelQteComponent]), this.DIc.set("WalkingPatternComponent", [GamePlayWalkingPatternComponent_1.GamePlayWalkingPatternComponent]), this.DIc.set("VehicleComponent", [VehicleSceneItemPerformComponent_1.VehicleSceneItemPerformComponent, SceneItemVehicleComponent_1.SceneItemVehicleComponent]), this.DIc.set("GravityFlipComponent", [SceneItemGravityFlipComponent_1.SceneItemGravityFlipComponent]), this.DIc.set("WindSourceComponent", [WindDirectionalSourceComponent_1.WindDirectionalSourceComponent]), this.DIc.set("TemplateEntitySpawnerComponent", [TemplateEntitySpawnerComponent_1.TemplateEntitySpawnerComponent]), this.DIc.set("CurveControlComponent", [SceneItemCurveControlComponent_1.SceneItemCurveControlComponent])
  }
  static yna() {
    this.Ina.set("CharacterConnectorComponent", [PawnSensoryComponent_1.PawnSensoryComponent, CommonConnectComponent_1.CommonConnectComponent]), this.Ina.set("HackManagementComponent", [HackManagementComponent_1.HackManagementComponent])
  }
}(exports.WorldEntityHelper = WorldEntityHelper).Hor = 0n, WorldEntityHelper.Wor = 0n, WorldEntityHelper.jor = 0n, WorldEntityHelper.w4l = 0n, WorldEntityHelper.Yo1 = 0n, WorldEntityHelper.For = new Map, WorldEntityHelper.ComponentPriority = new Map, WorldEntityHelper.BIc = new Map, WorldEntityHelper.DIc = new Map, WorldEntityHelper.R_1 = new Map, WorldEntityHelper.Ina = new Map, Global_1.Global.WorldEntityHelper = WorldEntityHelper;
