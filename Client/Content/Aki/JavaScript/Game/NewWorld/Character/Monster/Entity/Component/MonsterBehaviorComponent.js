...
let MonsterBehaviorComponent = class MonsterBehaviorComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    ...
    this.Kqr = (t, e) => {
      ...
      if (e === CharacterUnifiedStateTypes_1.ECharPositionState.Water && !this.Xte.HasTag(-1714966381)) {
        ...
        CombatMessage_1.CombatNet.Send(15894, this.Entity, i);
      }
    };
    this.qtn = () => {
  ...
  OnActivate() {
    ...
    if (this.K1_) {
      ...
      this.Entity.GetComponent(113)?.Disable("怪物固定位置");
    }
  }
  OnEnd() {
...
MonsterBehaviorComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(89)], MonsterBehaviorComponent);
