...
let ExecutionComponent = class ExecutionComponent extends EntityComponent_1.EntityComponent {
  ...
  xtn(e, t) {
    t = e.GetComponent(43)?.BeginSkill(t.ExecutionSkillId, {
  ...
  btn(e) {
    e.GetComponent(185)?.RemoveBuff(CharacterBuffIds_1.buffId.ChangeRoleBuff, -1, "处决换人失败");
  }
};
ExecutionComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(93)], ExecutionComponent);
