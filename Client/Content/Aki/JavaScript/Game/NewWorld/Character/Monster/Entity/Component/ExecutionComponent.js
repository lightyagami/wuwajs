...
var __decorate = this && this.__decorate || function(e, t, o, n) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, o, n);
    ...
    for (var l = e.length - 1; 0 <= l; l--)(r = e[l]) && (a = (i < 3 ? r(a) : 3 < i ? r(t, o, a) : r(t, o)) || a);
...
let ExecutionComponent = class ExecutionComponent extends EntityComponent_1.EntityComponent {
  constructor() {
    super(...arguments), this.ytn = void 0, this.Itn = void 0, this.vzi = void 0, this.Ttn = void 0, this.Ltn = (e, t) => {
      var o = this.Entity.GetComponent(197);
      o ? (this.vzi = o.GetInteractController(), this.vzi ? t ? this.Dtn() ? this.Rtn() : Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "队伍内没有符合处决条件的角色") : this.Itn && (this.vzi.RemoveClientInteractOption(this.Itn), this.Itn = void 0) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Can not find interactController")) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Can not find PawnInteractNewComponent")
    }
  }
  OnStart() {
    return !0
  ...
  OnActivate() {
    ...
    this.Ttn = MonsterBattleConfById_1.configMonsterBattleConfById.GetConfig(o), this.ytn = e.ListenForTagAddOrRemove(-121513115, this.Ltn), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "处决组件初始化完成", ["EntityId", this.Entity.Id], ["CreatureDataId", t.GetCreatureDataId()], ["PbDataId", t.GetPbDataId()], ["ExecutionId", this.Ttn.ExecutionId])
  }
  Utn() {
    ...
    for (const r of this.Ttn.ExecutionId) {
      ...
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Execution can not find ExecutionConf", ["ExecutionId", r])
    }
    Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "不存在合适的处决配置项", ["MonsterBattleConfigId", this.Ttn.Id])
  }
  Rtn() {
    var e, t, o = new LevelGameplayActionsDefine_1.ActionExecution,
      n = this.Utn(),
      r = new CodeDefineLevelConditionInfo_1.LevelConditionGroup;
    r.Type = 0;
    for (const i of n.LimitExecutionTags) i && 0 !== i.length && (e = GameplayTagUtils_1.GameplayTagUtils.GetTagIdByName(i)) && ((t = new CodeDefineLevelConditionInfo_1.LevelConditionCheckCharacterTagInfo).TagId = e, t.IsContain = !1, r.Conditions.push(t));
    this.Itn = this.vzi.AddClientInteractOption(o, r, "Direct", this.Ttn.ExecutionRadius, void 0, 1)
  }
  Dtn() {
    ...
    for (const n of this.Ttn.ExecutionId) {
      ...
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Execution can not find ExecutionConf", ["ExecutionId", n])
    }
    return !1
  }
  OnEnd() {
    ...
    for (const l of this.Ttn.ExecutionId) {
      ...
      if (n) {
        if (n.ExecutionRoleId === e || this.Atn(e, n.ExecutionRoleId)) {
          if (!this.Ptn(ModelManager_1.ModelManager.SceneTeamModel.GetCurrentTeamItem.GetCreatureDataId())) return;
        ...
        if (r) {
          ...
          }), t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity, this.wtn(t.Entity), this.xtn(t.Entity, n) || this.btn(ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity), o = !0;
          break
        }
        for (const s of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItems()) {
          ...
          if (i > MAX_CHARACTERID) {
            ...
            if (a && a.ParentId === n.ExecutionRoleId) {
              ...
              let e = !1;
              t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity, ModelManager_1.ModelManager.SceneTeamModel.GetCurrentTeamItem.GetCreatureDataId() !== a && (SceneTeamController_1.SceneTeamController.RequestChangeRole(a, {
                FilterSameRole: !1,
                GoDownWaitSkillEnd: !0,
                ForceInheritTransform: !1
              }), t = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity, this.wtn(t.Entity), e = !0), !this.xtn(t.Entity, n) && e && this.btn(ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity.Entity), o = !0;
              break
            }
          }
        }
      } else Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Execution can not find ExecutionConf", ["ExecutionId", l])
    }
    o || Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Execution can not find execution role", ["MonsterBattleConfigId", this.Ttn.Id])
  }
  Atn(e, t) {
  ...
  Ptn(e) {
    ...
    return t?.IsMyRole() ? !t.IsDead() || (ScrollingTipsController_1.ScrollingTipsController.ShowTipsById("Execution_Error_Die"), Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "Execution character is dead!", ["CreatureDataId", e]), !1) : (Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "Execution character is not Player!", ["CreatureDataId", e]), !1)
  }
  xtn(e, t) {
    t = e.GetComponent(40)?.BeginSkill(t.ExecutionSkillId, {
      Reason: "ExecutionComponent.UseExecutionSkill"
    });
    return Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 4, "触发处决技能！", ["触发者", e.Id], ["处决对象", this.Entity.Id], ["是否成功执行", t]), t ?? !1
  }
  wtn(e) {
  ...
  btn(e) {
    e.GetComponent(174)?.RemoveBuff(CharacterBuffIds_1.buffId.ChangeRoleBuff, -1, "处决换人失败")
  }
};
ExecutionComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(88)], ExecutionComponent), exports.ExecutionComponent = ExecutionComponent;
