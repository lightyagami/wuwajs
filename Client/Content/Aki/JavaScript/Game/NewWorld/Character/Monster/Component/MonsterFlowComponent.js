...
let MonsterFlowComponent = class MonsterFlowComponent extends CharacterFlowComponent_1.CharacterFlowComponent {
  ...
  OnStart() {
    return this.I5r = this.Entity.GetComponent(175), this.Stn = this.Entity.GetComponent(121), super.OnStart(), !0
  }
  InitFlowLogicRange(e, t) {
    return !!super.InitFlowLogicRange(e, t) && (this.Stn?.SetLogicRange(t ?? CharacterFlowComponent_1.DEFAULT_BUBBLE_LEAVE_RANGE), !0)
  }
  CheckCondition() {
    return !!super.CheckCondition() && !!this.Stn && (this.Stn.IsInLogicRange && !this.I5r.IsInFightState() || (this.ForceStopFlow(), !1))
  }
};
MonsterFlowComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(182)], MonsterFlowComponent), exports.MonsterFlowComponent = MonsterFlowComponent;
