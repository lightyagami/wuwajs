  ...
  static Jil(r) {
    if (r?.Valid) {
      var t = r.Entity.GetComponent(0),
        a = r.Entity.GetComponent(40),
        o = r.Entity.GetComponent(205);
      let e = void 0;
      r = t.GetMonsterComponent()?.FightConfigId, r = (r && (e = MonsterBattleConfById_1.configMonsterBattleConfById.GetConfig(r)), t.GetRoleId()), t = ConfigManager_1.ConfigManager.RoleConfig.GetBaseRoleId(r);
