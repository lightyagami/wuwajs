...
var __decorate = this && this.__decorate || function(e, t, r, o) {
  var i, n = arguments.length,
    s = n < 3 ? t : null === o ? o = Object.getOwnPropertyDescriptor(t, r) : o;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, r, o);
  else
    for (var c = e.length - 1; 0 <= c; c--)(i = e[c]) && (s = (n < 3 ? i(s) : 3 < n ? i(t, r, s) : i(t, r)) || s);
...
let NpcDriveVehicleComponent = class NpcDriveVehicleComponent extends CharacterDriveVehicleComponent_1.CharacterDriveVehicleComponent {
  ...
  OnStart() {
    return !!super.OnStart() && (this.NpcPerformComp = this.Entity.GetComponent(187), !0)
  }
  OnActivate() {
    this.NpcPerformComp?.IsBaseRoleNpc || this.AttachOffset.Set(DRIVE_MONTAGE_DEFAULT_OFFSET_X, 0, 0), super.OnActivate();
    var e, t = this.Entity.GetComponent(0),
      r = t.ComponentDataMap.get(VEHICLE_PB)?.dI_;
    r && ((e = new VehicleInfoDefines_1.EntityVehicleInfo).EntityCreatureId = t.GetCreatureDataId(), e.VehicleCreatureId = MathUtils_1.MathUtils.LongToNumber(r.TI_), e.Seat = r.fhl, ControllerHolder_1.ControllerHolder.VehicleController.VehicleUpdateEntity(e))
  }
...
NpcDriveVehicleComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(231)], NpcDriveVehicleComponent), exports.NpcDriveVehicleComponent = NpcDriveVehicleComponent;
