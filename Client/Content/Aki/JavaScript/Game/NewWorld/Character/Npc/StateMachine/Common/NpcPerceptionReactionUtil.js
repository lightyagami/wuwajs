...
class NpcPerceptionReactionUtil {
  static TurnToPlayer(e) {
    var t = e.GetComponent(2),
      ...
      i = (i.Subtraction(r, o), o.Z = 0, o.Normalize(), Rotator_1.Rotator.Create()),
      r = (o.ToOrientationRotator(i), e.GetComponent(45));
    r ? r.SmoothCharacterRotation(i, TURN_SPEED, Time_1.Time.DeltaTimeSeconds) : t.SetActorRotation(i.ToUeRotator(), "NpcPerformUnderAttackState.TurnToPlayer")
  }
  static ShowHeadDialog(e, t, r) {
    t < MathUtils_1.MathUtils.GetRandomFloatNumber(0, BUBBLE_RANDOM_MAX) || (t = e.GetComponent(82)) && (e = ConfigManager_1.ConfigManager.FlowConfig.GetRandomFlow(r.FlowListName, r.FlowId, e.GetComponent(2).Actor.ActorLabel, r.StateId)) && 0 !== e.TalkItems.length && (r = e.TalkItems[0], StringUtils_1.StringUtils.IsEmpty(r.TidTalk) || (e = MultiTextLang_1.configMultiTextLang.GetLocalTextNew(r.TidTalk), r.WaitTime && 0 < r.WaitTime ? t.SetDialogueText(e, r.WaitTime) : t.SetDialogueText(e, BUBBLE_TIME)))
  }
}
