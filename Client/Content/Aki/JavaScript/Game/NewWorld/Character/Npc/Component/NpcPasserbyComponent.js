...
let NpcPasserbyComponent = class NpcPasserbyComponent extends EntityComponent_1.EntityComponent {
  ...
  SendMessage() {
    ...
    if (!this.cf1) {
      ...
      Net_1.Net.Call(25477, t, t => {
        if (t && t.Cvs !== Protocol_1.Aki.Protocol.Q4n.KRs) {
          ControllerHolder_1.ControllerHolder.ErrorCodeController.OpenErrorCodeTipView(t.Cvs, 17699);
        }
      });
    }
  }
  ...
  InitMatFromGenerator() {
    if (this.SBu) {
      this.Entity.GetComponent(187)?.MaterialController?.ApplyMaterialEffect(this.SBu);
    }
  }
};
