...
class NpcPerformInteractState extends NpcPerformBaseState_1.NpcPerformBaseState {
  constructor() {
    super(...arguments), this.Atr = "", this.Qer = void 0, this.Ptr = !1, this.xtr = () => {
  ...
  OnCreate(e) {
    super.OnCreate(e), e?.ShowOnInteract?.Montage ? (this.Ptr = !0, this.Atr = e.ShowOnInteract.Montage) : this.Ptr = !1
  }
  OnEnter(e) {
    ResourceSystem_1.ResourceSystem.LoadAsync(this.Atr, UE.AnimMontage, e => {
      e?.IsValid() && this?.Owner?.Valid && (this.PlayMontage({
        MontageAsset: e
      }), this.Qer = e)
  ...
  OnUpdate(e) {}
  OnExit(e) {
    EventSystem_1.EventSystem.RemoveWithTarget(this.Owner, EventDefine_1.EEventName.OnInteractPlotEnd, this.xtr), this.Owner.Entity.GetComponent(3).ClearInput(), this.StopMontage({
      Method: 0,
      BlendOutTime: .5,
      Montage: this.Qer
    }), this.Qer = void 0
