...
class PlayMontageUtils {
  ...
  static LoadAndPlayMontage(e, t, i, s = undefined, a = undefined, o = undefined) {
    if (this.Uud.has(e.Entity.Id) && (n = this.Uud.get(e.Entity.Id), this.ClearAndStopMontage(n), Log_1.Log.CheckWarn())) {
  ...
  static Bud(t) {
    if (t && (t.OnClearInfo(), this.Uud.delete(t.EntityId), this.G2r.delete(t.Uid), this.Aqd.has(t.Uid) && (t.AnimComp && (t.AnimComp.EnableLowerBlend = false), this.Aqd.delete(t.Uid)), Log_1.Log.CheckDebug())) {
...
(_a = PlayMontageUtils).xud = 0;
PlayMontageUtils.G2r = new Map();
PlayMontageUtils.Uud = new Map();
PlayMontageUtils.Aqd = new Set();
