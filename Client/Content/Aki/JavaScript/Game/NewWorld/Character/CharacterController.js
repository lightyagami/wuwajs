...
class CharacterController extends ControllerBase_1.ControllerBase {
  ...
  static OnTick(t) {
    CharacterController.dKo() || CharacterController.CKo(), Net_1.Net.IsFinishLogin() && this.Rqn()
  }
  static async Rqn() {
    var t, e = new Date;
  ...
  static InitData(t, e, r) {
    return !!EntitySystem_1.EntitySystem.InitData(e, r) || (ModelManager_1.ModelManager.CharacterModel.ClearHandle(t), !1)
  }
  static Respawn(t, e, r = 0, a) {
    return !!EntitySystem_1.EntitySystem.Respawn(e, !0, r, a) || (ModelManager_1.ModelManager.CharacterModel.ClearHandle(t), !1)
  }
  static AddEntityToAwakeQueue(t, e) {
    ModelManager_1.ModelManager.CreatureModel.EnableEntityLog && Log_1.Log.CheckInfo() && Log_1.Log.Info("Entity", 3, "[实体生命周期:创建实体] 进入唤醒队列", ["EntityId", t.Id], ["CreatureDataId", t.CreatureDataId], ["PbDataId", t.PbDataId], ["Priority", t.Priority]);
    let r = !1;
    ModelManager_1.ModelManager.CharacterModel.PushAwakeHandler(t, () => this.InitEntity(t) ? r = !0 : (e(!1), !1), () => !!r && (this.StartEntity(t) ? (e(!0), !0) : (e(!1), !1)))
  }
  static InitEntity(t) {
    var e, r;
  ...
  static ActivateEntity(t) {
    t.Valid && (t = t.Entity, EntitySystem_1.EntitySystem.Activate(t), t.SetTimeDilation(Time_1.Time.TimeDilation))
  }
  static Destroy(t) {
    if (!t?.Valid) return Log_1.Log.CheckError() && Log_1.Log.Error("Character", 1, "Destroy的entity无效，可能的原因有:1、创建失败 2、实体重复销毁", ["Id", t?.Id]), !1;
    ModelManager_1.ModelManager.CharacterModel.ClearHandle(t);
    var e = t.Entity;
    return t.Entity = void 0, ModelManager_1.ModelManager.CharacterModel.EntityPool.RemoveExternal(e), EntitySystem_1.EntitySystem.Destroy(e)
  }
  static DestroyToLru(t) {
    if (!t?.Valid) return Log_1.Log.CheckError() && Log_1.Log.Error("Character", 3, "Destroy的entity无效，可能的原因有:1、创建失败 2、实体重复销毁", ["Id", t?.Id]), !1;
    var e = t.Entity;
    if (!t.IsInit) return this.Destroy(t);
    ModelManager_1.ModelManager.CharacterModel.ClearHandle(t);
    const r = t.Entity;
    return t.Entity = void 0, EntitySystem_1.EntitySystem.DeSpawn(e) ? (TimerSystem_1.TimerSystem.Next(() => {
      TimerSystem_1.TimerSystem.Next(() => {
        ModelManager_1.ModelManager.CharacterModel.EntityPool.Put(r)
      })
    }), !0) : (ModelManager_1.ModelManager.CharacterModel.EntityPool.RemoveExternal(r), !1)
  }
  static CreateEntity(t, e) {
    t = ModelManager_1.ModelManager.CharacterModel.EntityPool.Create(t);
    if (EntitySystem_1.EntitySystem.CreateExternal(WorldEntity_1.WorldEntity, t, e.Priority, e)) return ModelManager_1.ModelManager.CharacterModel.CreateHandle(t)
  }
  static SpawnEntity(t) {
    t = ModelManager_1.ModelManager.CharacterModel.EntityPool.Get(t);
    if (t && ObjectSystem_1.ObjectSystem.CreateExternal(t)) return ModelManager_1.ModelManager.CharacterModel.CreateHandle(t)
  }
  ...
  static GetCharacter(t) {
    return t?.Valid && (t = t.GetComponent(3))?.Valid && t.Actor ? t.Actor : void 0
  }
  static GetActor(t) {
  ...
  static SetTimeDilation(t) {
    ...
    for (const a of e.DelayRemoveContainer.GetAllEntities()) a.IsInit && a.Entity.SetTimeDilation(t)
  }
  static CN() {
    return !this.gKo && 0 === ModelManager_1.ModelManager.CharacterModel.AwakeQueue.Size
  }
  static AwakeEntity() {
  ...
  static SortItem(t) {
    !t?.Valid || 2 & t.Entity.Flag || t.Entity.GetComponent(0).GetRemoveState() || ModelManager_1.ModelManager.CharacterModel.SortItem(t)
  }
  static OnChangeMode() {
    if (!ModelManager_1.ModelManager.GameModeModel.IsMulti)
      for (const t of ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) t.Entity.GetComponent(47)?.SwitchControl(!0);
    return !0
  }
  static SetSelfCenteredMode(t) {
    ModelManager_1.ModelManager.CharacterModel?.SetSelfCentered(t)
  }
}(exports.CharacterController = CharacterController).IsTickEvenPausedInternal = !0, CharacterController.gKo = void 0, CharacterController.Uqn = void 0, CharacterController.dKo = () => CharacterController.CN(), CharacterController.CKo = () => {
