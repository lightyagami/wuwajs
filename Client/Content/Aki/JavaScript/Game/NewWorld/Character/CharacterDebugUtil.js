...
class CharacterDebugUtil {
  static LoadFightDtDebug(e = 0) {
    ...
    let r = [];
    for (const o of r = e ? [e] : ModelManager_1.ModelManager.CreatureModel.GetAllEntities()) o.IsInit && this.LoadCharacterFightDtNewPreload(o.Entity).then(() => {
      Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "测试加载战斗DT完成", ["entityId", o.Entity.Id])
    }, e => {})
  }
  static async LoadCharacterFightDtNewPreload(e) {
    var r = e.GetComponent(0),
      o = e.GetComponent(40),
      a = e.GetComponent(207),
      t = e.GetComponent(1),
      l = e.GetComponent(208),
      i = ModelManager_1.ModelManager.PreloadModelNew.GetEntityAssetElement(r.GetCreatureDataId());
    if (i) {
      ...
      if (n) {
        o.DtSkillInfoMapForDebug.set(0, o.DtSkillInfo), o.DtSkillInfoExtraList = [], o.DtBulletInfoExtraList = [], o.DtHitEffectExtraList = [];
        for (let e = 0; e < n.SkillDataTableMap.Num(); ++e) {
          ...
          g = n?.HitEffectTableMap.Get(s)?.ToAssetPathName(), s = (g && 0 < g.length && "None" !== g && (_ = ResourceSystem_1.ResourceSystem.Load(g, UE.DataTable)) && o.DtHitEffectExtraList.push(_), new GameModePromise_1.GameModePromise);
          PreloadControllerNew_1.PreloadControllerNew.LoadAssetAsync(i.MainAsset, i.LoadPriority, !1, s), await s.Promise;
          for (const M of o.GetAllSkillData(4)) {
            var u = o.GetSkillInfo(M);
            u && (Log_1.Log.CheckDebug() && Log_1.Log.Debug("Battle", 17, "【debug】加载额外技能", ["skillId", M]), o.GiveSkillDebug(M), l.AddSkillTriggerDebug(M, u), a.InitSkillCdBySkillInfo(M, u))
          }
        }
      } else Log_1.Log.CheckDebug() && Log_1.Log.Debug("Character", 17, "找不到当前角色的FightInfo配置", ["actorPath", r])
    }
  }
}
