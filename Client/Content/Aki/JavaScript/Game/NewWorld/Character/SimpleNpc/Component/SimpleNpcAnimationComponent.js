...
let SimpleNpcAnimationComponent = class SimpleNpcAnimationComponent extends BaseAnimationComponent_1.BaseAnimationComponent {
  ...
  OnStart() {
    this.ActorComp = this.Entity.CheckGetComponent(206);
...
SimpleNpcAnimationComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(207)], SimpleNpcAnimationComponent);
