...
class ReferenceTriggerVolumeLogic {
  constructor(e) {
    this.Ksr = new Map, this.Qsr = new Set, this.Xc1 = new Set, this.$sr = [];
    for (const i of e) {
  ...
  RemoveVolume(e) {
    this.Qsr.has(e) && (this.kre(e, this.Ksr.get(e)), this.Ksr.delete(e), this.Xc1.delete(e))
  }
  Clear() {
    for (var [e, t] of this.Ksr) this.kre(e, t);
    this.Xc1.size && (this.Xc1.clear(), this.Ysr(!1)), this.Qsr.clear(), this.Ksr.clear(), this.$sr.length = 0
  }
  Destroy() {
    this.Clear()
  }
  IsPlayerOverlapped() {
    return 0 < this.Xc1.size
  }
  AddOnPlayerOverlapCallback(e, t = !1) {
    this.$sr.push(e), this.Xc1.size && t && e(!0)
  }
  ...
  OnCollisionEnterFunc(e, t) {
    this.Jsr(t) && (t = this.Xc1.size, this.Xc1.add(e), t || this.Ysr(!0))
  }
  OnCollisionExitFunc(e, t) {
    this.Jsr(t) && (this.Xc1.delete(e), this.Xc1.size || this.Ysr(!1))
  }
  Jsr(e) {
  ...
  kre(e, t) {
    t?.IsValid() && (this.Xc1.has(e) && this.OnCollisionExitFunc(e, RoleTriggerController_1.RoleTriggerController.GetMyRoleTrigger()), t.OnActorBeginOverlap.Clear(), t.OnActorEndOverlap.Clear())
  }
  Ysr(t) {
    if (this.$sr?.length)
