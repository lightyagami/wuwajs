    ...
    this.OnAnyExactTagChanged = (e, t, o) => {
      ...
      if (e !== undefined && o !== t) {
        for (const n of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItemsByPlayer(this.PlayerId)) {
          n.EntityHandle?.Entity?.GetComponent(205)?.TagContainer.UpdateExactTag(5, e, t - o);
        }
      }
  ...
  OnClear() {
    ...
    for (const e of this.TagContainer.GetAllExactTags()) {
      for (const t of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItemsByPlayer(this.PlayerId)) {
        t.EntityHandle?.Entity?.GetComponent(205)?.TagContainer.RemoveExactTag(5, e);
      }
    }
    return true;
  }
...
PlayerTagComponent = PlayerTagComponent_1 = __decorate([(0, RegisterComponent_1.RegisterComponent)(200)], PlayerTagComponent);
