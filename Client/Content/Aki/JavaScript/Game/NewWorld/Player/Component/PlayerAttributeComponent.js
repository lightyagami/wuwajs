...
var __decorate = this && this.__decorate || function(e, t, r, o) {
  ...
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) i = Reflect.decorate(e, t, r, o);
    ...
    for (var s = e.length - 1; 0 <= s; s--)(n = e[s]) && (i = (a < 3 ? n(i) : 3 < a ? n(t, r, i) : n(t, r)) || i);
...
let PlayerAttributeComponent = class PlayerAttributeComponent extends BaseAttributeComponent_1.BaseAttributeComponent {
  ...
  UpdateCurrentValue(e) {
    ...
    for (const t of ModelManager_1.ModelManager.SceneTeamModel.GetTeamItemsByPlayer(this.PlayerId)) ModelManager_1.ModelManager.CreatureModel.GetEntity(t.GetCreatureDataId())?.Entity?.GetComponent(172)?.UpdateCurrentValue(e)
  }
};
PlayerAttributeComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(198)], PlayerAttributeComponent), exports.PlayerAttributeComponent = PlayerAttributeComponent;
