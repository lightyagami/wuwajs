...
class RenderModuleController extends ControllerBase_1.ControllerBase {
  ...
  static SetBattleState(e, t, r = !1) {
    ModelManager_1.ModelManager.RenderModuleModel && ModelManager_1.ModelManager.RenderModuleModel.SetBattleState(e, t, r)
  }
  ...
  static AddWuYinQuBattleActorWaiting(e) {
    void 0 === this.WaitingForAddWuYinQuBattleActors && (this.WaitingForAddWuYinQuBattleActors = []), this.WaitingForAddWuYinQuBattleActors.push(e)
  }
  ...
  static RemoveCharRenderShell(e) {
    return ModelManager_1.ModelManager.RenderModuleModel?.RemoveCharRenderShell(e) ?? !1
  }
  static GetRainIntensity() {
    return ModelManager_1.ModelManager.RenderModuleModel ? ModelManager_1.ModelManager.RenderModuleModel.GetRainIntensity() : 0
  }
  static GetSnowIntensity() {
    return ModelManager_1.ModelManager.RenderModuleModel ? ModelManager_1.ModelManager.RenderModuleModel.GetSnowIntensity() : 0
  }
  static IsRuntime() {
    return this.tZ
  }
  static OnInit() {
    return RenderModuleConfig_1.RenderStats.Init(), this.DebugUiSceneLoadOffset = new UE.VectorDouble, this.UiSceneOffsetTransform = new UE.TransformDouble, this.tZ = !0, EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnBossFight, this.N1r), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.OnBattleStateChanged, this.yK), this.O1r || TickSystem_1.TickSystem.Add(this.k1r.bind(this), "RenderModuleController", 3, !0), UE.KuroStaticLibrary.IsLowMemoryDevice() && UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "wp.Runtime.UseUnloadCache false"), !0
  }
  static OnClear() {
    return this.tZ = !1, EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnBossFight, this.N1r), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.OnBattleStateChanged, this.yK), !0
  }
  static OnTick(e) {
    this.O1r && this.k1r(e)
  }
  static k1r(e) {
    this.tZ && (this.GlobalTimeDilation = 1, this.IsGamePaused = MathUtils_1.MathUtils.IsNearlyEqual(this.GlobalTimeDilation, 0), void 0 !== this.WaitingForAddWuYinQuBattleActors && 0 !== this.WaitingForAddWuYinQuBattleActors.length && (this.WaitingForAddWuYinQuBattleActors.forEach(e => {
      this.AddWuYinQuBattleActor(e)
    }), this.WaitingForAddWuYinQuBattleActors = []), ModelManager_1.ModelManager.RenderModuleModel.Tick(e))
  }
}(exports.RenderModuleController = RenderModuleController).IsTickEvenPausedInternal = !0, RenderModuleController.tZ = !1, RenderModuleController.O1r = !1, RenderModuleController.WaitingForAddWuYinQuBattleActors = void 0, RenderModuleController.IsGamePaused = !1, RenderModuleController.GlobalTimeDilation = 1, RenderModuleController.DebugNewUiSceneWorkflow = !0, RenderModuleController.DebugUiSceneLoadOffset = void 0, RenderModuleController.UiSceneOffsetTransform = void 0, RenderModuleController.DebugStartShowingUiSceneRendering = !1, RenderModuleController.DebugInUiSceneRendering = !1, RenderModuleController.IsDynamicOffset = !1, RenderModuleController.N1r = e => {
  ...
  e || UE.KismetSystemLibrary.ExecuteConsoleCommand(GlobalData_1.GlobalData.World, "r.Kuro.GlobalGIRenderQuality 0")
};
