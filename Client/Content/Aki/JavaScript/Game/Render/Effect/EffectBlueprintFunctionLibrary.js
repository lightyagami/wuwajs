...
class EffectBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static SetMaterialControllerDataSync(e, t, a) {
    if (!(t.length <= 0 || "None" === t)) {
      var r, o = ModelManager_1.ModelManager.CreatureModel.GetEntityById(e)?.Entity;
      const c = o?.GetComponent(3)?.Actor?.CharRenderingComponent;
      c ? (a ? ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.PD_CharacterControllerDataGroup_C, e => {
        e ? c?.AddMaterialControllerDataGroup(e) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "无法找到材质效果组", ["materialDataPath", t])
      }) : ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.PD_CharacterControllerData_C, e => {
        e ? c?.AddMaterialControllerData(e) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 4, "无法找到材质效果", ["materialDataPath", t])
      }), (r = Protocol_1.Aki.Protocol.ae_.create()).sVn = new Protocol_1.Aki.Protocol.sVn, r.sVn.nVn = t, r.sVn.aVn = a, CombatMessage_1.CombatNet.Send(20061, o, r)) : Log_1.Log.CheckError() && Log_1.Log.Error("Battle", 19, "无法找到角色渲染组件", ["entityId", e])
    }
  }
  static RecycleEffect(e) {}
  static AddDebugLineFromPlayer(e, t, a) {
    return DebugDrawManager_1.DebugDrawManager.AddDebugLineFromPlayer(Vector_1.Vector.Create(e), t, a)
  }
  ...
  static BeginDebugDrawFoliageDetect(e, t) {
    FoliageClusteredEffectManager_1.FoliageClusteredEffectManager.Get().BeginDebugDraw(e, t)
  }
  ...
  static SetTsWriteTimeToCollectionEnabled(e) {
    Info_1.Info.IsGameRunning() && RenderDataManager_1.RenderDataManager.Get().SetWriteTime(e)
  }
  ...
  static ChangeMaterialTextures(a, e) {
    a && ResourceSystem_1.ResourceSystem.LoadAsync(e, UE.KuroChangeMaterialsTextures, t => {
      if (t?.IsValid()) {
        let e = a.GetComponentByClass(UE.KuroChangeSkeletalMaterialsComponent.StaticClass());
        (e = e || a.AddComponentByClass(UE.KuroChangeSkeletalMaterialsComponent.StaticClass(), !1, void 0, !1)).ChangeMaterialsWithDataAsset(t)
      } else Log_1.Log.CheckError() && Log_1.Log.Error("RenderCharacter", 25, "ChangeMaterialTextures失败，因为asset无效", ["Path", e], ["actor", a?.GetName()])
    })
  }
}
