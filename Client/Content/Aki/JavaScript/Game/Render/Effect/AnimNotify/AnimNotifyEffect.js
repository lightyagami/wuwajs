...
class AnimNotifyEffect extends UE.KuroEffectMakerAN {
  constructor() {
    super(...arguments), this.NeedAnyTag = !1, this.PlayNeedTags = void 0, this.EffectDataAssetRef = void 0, this.IsSyncEffectTimeScale = !1, this.LocationType = 0, this.RightOrLeftFoot = !0, this.DebugTrace = !1, this.SocketName = void 0, this.UseSocketTransform = !1, this.TraceFrom = void 0, this.TraceTo = void 0, this.UseClipboardTransform = !1, this.DetachWhenSkillEnd = !1, this.WhenSkillEnd = 0, this.WhenSkillEndEnableTime = 0, this.IgnoreWhenInvisible = !1, this.LastSkeletalMesh = void 0
  }
  Constructor() {
  ...
  K2_Notify(t, e) {
    if (AnimNotifyEffect.NotifyStat.Start(), this.LastSkeletalMesh = t, this.IgnoreWhenInvisible && !t.IsVisible()) return !1;
    var i = this.LastSkeletalMesh.GetOwner(),
      f = this.EffectDataAssetRef.ToAssetPathName();
    if (!f?.length) return Log_1.Log.CheckError() && Log_1.Log.Error("RenderEffect", 3, "特效路径无效", ["meshComp", t?.GetName()], ["outer", i?.GetName()], ["animation", e?.GetName()]), AnimNotifyEffect.NotifyStat.Stop(), !1;
    if (!Info_1.Info.IsInCg() && i instanceof TsBaseCharacter_1.default && !this.GameplayTagsCheck(i)) return Log_1.Log.CheckDebug() && Log_1.Log.Debug("RenderEffect", 50, "AnimNotifyEffect: 特效GameplayTag检查失败", ["meshComp", t?.GetName()], ["outer", i?.GetName()], ["animation", e?.GetName()]), AnimNotifyEffect.NotifyStat.Stop(), !1;
    EffectSystem_1.EffectSystem.InitializeWithPreview(!1);
    let o = Info_1.Info.IsGameRunning() ? 3 : 0,
      n = (Info_1.Info.IsInCg() && (o = 0), GlobalData_1.GlobalData.IsUiSceneOpen || i.Tags.Contains(RenderConfig_1.RenderConfig.UIName) ? o = 1 : (i instanceof TsBaseCharacter_1.default && i.CharacterActorComponent?.Entity?.GetComponent(39) || i instanceof TsEffectActor_1.default && 0 === i.GetEffectType() || i?.IsA(UE.EffectSystemActor.StaticClass()) && 0 === i.GetEffectType()) && (o = 0), AnimNotifyEffect.CreateEffectContextStat.Start(), void 0),
      s = (i instanceof TsBaseCharacter_1.default && i.CharacterActorComponent?.Entity ? n = new SkeletalMeshEffectContext_1.SkeletalMeshEffectContext(i.CharacterActorComponent?.Entity.Id) : i.IsA(UE.TsEffectActor_C.StaticClass()) ? (n = new SkeletalMeshEffectContext_1.SkeletalMeshEffectContext(i.OwnerEntityId)).IsSyncEffectTimeScale = this.IsSyncEffectTimeScale : i.IsA(UE.EffectSystemActor.StaticClass()) ? (n = new SkeletalMeshEffectContext_1.SkeletalMeshEffectContext(i.GetOwnerEntityId())).IsSyncEffectTimeScale = this.IsSyncEffectTimeScale : n = new SkeletalMeshEffectContext_1.SkeletalMeshEffectContext(void 0), n.SkeletalMeshComp = t, n.SourceObject = i, n.DisablePostProcess = this.IsDisablePostProcess(t), n.CreateFromType = 1, i?.ActorHasTag(AnimNotifyEffect.TagFlagNoNiagara) && (n.PlayFlag |= 1), AnimNotifyEffect.CreateEffectContextStat.Stop(), AnimNotifyEffect.SpawnEffectStat.Start(), void 0);
    Info_1.Info.IsGameRunning() ? i instanceof TsBaseCharacter_1.default && (s = i.CharacterActorComponent?.GetReplaceEffect(f)) : s = EffectUtil_1.EffectUtil.GetPreviewReplaceEffectPath(f);
    e = EffectSystem_1.EffectSystem.SpawnUnloopedEffect(i, new UE.TransformDouble, s || f, "[AnimNotifyEffect.K2_Notify]", n, o);
    return EffectSystem_1.EffectSystem.SetEffectNotRecord(e, !0), AnimNotifyEffect.SpawnEffectStat.Stop(), this.AttachEffectAndSetupTransform(i, e), AnimNotifyEffect.NotifyStat.Stop(), !0
  }
  AttachEffectAndSetupTransform(t, e) {
    e && EffectSystem_1.EffectSystem.IsValid(e) && (AnimNotifyEffect.AttachEffectToSkillStat.Start(), this.AttachEffectToSkill(t, e), AnimNotifyEffect.AttachEffectToSkillStat.Stop(), AnimNotifyEffect.SetupTransformStat.Start(), this.SetupTransform(EffectSystem_1.EffectSystem.GetEffectActor(e), t), AnimNotifyEffect.SetupTransformStat.Stop(), EffectSystem_1.EffectSystem.ForceCheckPendingInit(e))
  }
  GameplayTagsCheck(t) {
  ...
  AttachEffectToSkill(e, i) {
    if (e instanceof TsBaseCharacter_1.default) {
      ...
      if (e) {
        let t = 0;
        !this.DetachWhenSkillEnd && 0 === this.WhenSkillEnd || (this.DetachWhenSkillEnd && 0 === this.WhenSkillEnd ? t = 2 : this.DetachWhenSkillEnd || 0 !== this.WhenSkillEnd ? this.DetachWhenSkillEnd && 1 === this.WhenSkillEnd ? t = 3 : this.DetachWhenSkillEnd && 2 === this.WhenSkillEnd ? t = 4 : this.DetachWhenSkillEnd || 1 !== this.WhenSkillEnd ? this.DetachWhenSkillEnd || 2 !== this.WhenSkillEnd || (t = 6) : t = 5 : t = 1), e.AttachEffectToSkill(i, t, this.SocketName, this.WhenSkillEndEnableTime)
      }
    }
  }
  K2_PostChangeProperty(t) {
    if (t.op_Equality(RenderConfig_1.RenderConfig.UseSocketTransform)) this.UseSocketTransform = !1, this.LastSkeletalMesh && (e = this.LastSkeletalMesh.D_GetSocketTransform(this.SocketName, 3), this.Location = e.GetLocation().op_ToVector(), this.Rotation = e.GetRotation().Rotator(), this.Scale = e.GetScale3D().op_ToVector());
      ...
      var e = t => {
        ...
        f = (0, puerts_1.$ref)(!1),
        t = (UE.KismetStringLibrary.Conv_StringToVector(t, i, f), (0, puerts_1.$unref)(f) && (this.Location = (0, puerts_1.$unref)(i)), e("Rotation=(")),
        i = (0, puerts_1.$ref)(this.Rotation),
        t = (UE.KismetStringLibrary.Conv_StringToRotator(t, i, f), (0, puerts_1.$unref)(f) && (this.Rotation = (0, puerts_1.$unref)(i)), e("Scale3D=(")),
        i = (0, puerts_1.$ref)(this.Scale);
      UE.KismetStringLibrary.Conv_StringToVector(t, i, f), (0, puerts_1.$unref)(f) && (this.Scale = (0, puerts_1.$unref)(i))
    }
    return !0
  }
  GetNotifyName() {
  ...
  SetupTransform(t, e) {
    switch (this.LocationType) {
      case 0:
        this.Attached && this.SocketName !== AnimNotifyEffect.NameNone ? (t.K2_AttachToComponent(this.LastSkeletalMesh, this.SocketName, 0, 0, 0, !1), f = UE.KismetMathLibrary.Conv_VectorToVectorDouble(this.Location), i = UE.KismetMathLibrary.Conv_VectorToVectorDouble(this.Scale), f = new UE.TransformDouble(this.Rotation, f, i), t.D_K2_SetActorRelativeTransform(f, !1, void 0, !0)) : (i = this.LastSkeletalMesh.D_GetSocketTransform(this.SocketName, 0), f = UE.KismetMathLibrary.Conv_VectorToVectorDouble(this.Location), t.D_K2_SetActorLocationAndRotation(i.TransformPosition(f), i.TransformRotation(this.Rotation.Quaternion()).Rotator(), !1, void 0, !0), f = UE.KismetMathLibrary.Conv_VectorToVectorDouble(this.Scale), t.D_SetActorScale3D(f));
        break;
      case 1:
