...
class AnimNotifyAddMeshMaterialControllerData extends UE.KuroAnimNotifyState {
    ...
    if (GlobalData_1.GlobalData.World) {
      if (UE.KismetSystemLibrary.IsValid(e)) {
        ...
        if (this.IsAllValid(e, r)) {
          ...
          o.HandleId = o.CharRenderingComponent.AddMaterialControllerData(this.MaterialAssetData);
  ...
  K2_NotifyEnd(t, e) {
    var r;
    var a;
    return !!GlobalData_1.GlobalData.World && ((r = materialControllerStateHandleMap.get(t)) && (a = r.get(this)) && (r.delete(this), r.size || materialControllerStateHandleMap.delete(t), a.CharRenderingComponent && a.HandleId >= 0 && a.CharRenderingComponent.RemoveMaterialControllerData(a.HandleId), a.RenderActor && (a.CharRenderingComponent.Destroy(), a.RenderActor.K2_DestroyActor()), this.HideMeshAfterPlay) && t.SetHiddenInGame(true), true);
  }
  GetNotifyName() {
    var t = this.MaterialAssetData.GetName();
    if (t) {
      return "召唤物/NPC材质控制器:" + UE.BlueprintPathsLibrary.GetBaseFilename(t, true);
    } else {
      return "召唤物/NPC材质控制器";
    }
  }
