...
class CharSceneInteraction extends CharRenderBase_1.CharRenderBase {
  constructor() {
    super(...arguments), this.OwnerCharacter = void 0, this.CharacterInteraction = void 0
  }
  Start() {
    super.Start(), this.OwnerCharacter = this.RenderComponent.GetOwner(), this.CharacterInteraction = void 0, this.PossCharacter(this.RenderComponent.InteractionConfig), this.OnInitSuccess()
  }
  Update() {
    this.CharacterInteraction && this.CharacterInteraction.Update(this.GetDeltaTime())
  }
  Destroy() {
  ...
  PossCharacter(e, t = 1) {
    e && this.OwnerCharacter && (this.CharacterInteraction = new SceneCharacterInteraction_1.default, this.CharacterInteraction.Start(this.OwnerCharacter, e, t))
  }
  UnpossCharacter() {
    this.CharacterInteraction && (this.CharacterInteraction.Destroy(), this.CharacterInteraction = void 0)
  }
  GetComponentId() {
