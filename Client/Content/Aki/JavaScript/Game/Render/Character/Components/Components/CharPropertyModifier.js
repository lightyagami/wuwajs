...
class PropertyTimeCounter {
  constructor() {
    this.Id = 0, this.Factor = -0, this.WholeTime = -0, this.Counter = -0, this.BodyType = 0, this.SectionIndex = 0, this.SlotType = 0, this.PropertyName = void 0, this.CurveFloatData = void 0, this.CurveColorData = void 0, this.DataType = 0
  }
  Init(t, e, i, r, o, s, n, a, h) {
    switch (this.Id = t, this.BodyType = e, this.SectionIndex = i, this.SlotType = r, this.PropertyName = o, this.WholeTime = a, this.DataType = h, this.Counter = 0, this.DataType) {
      case 0:
