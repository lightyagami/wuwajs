...
class CharDitherEffect extends CharRenderBase_1.CharRenderBase {
    ...
    if (i !== this.phr) {
      ...
      if (t) {
        ...
        this.Mhr.forEach((t, i) => {
          e = e || t, t && h < i && (h = i)
        }), this.fhr = h, !e && this.vhr && this.RemoveDitherEffect()
      } else this.Mhr.set(s, !0), (this.fhr === s || this.fhr < s) && (this.fhr = s, this.vhr || this.yhr(), this.Shr(i))
    }
  }
  SetDitherMask(t, i) {
    this.Jxl = t, this.jO_ = i, this.vhr && (this.Ihr(), this.Thr(), this.Lhr(this.mhr))
  }
  RemoveDitherEffect() {
  ...
  Shr(t) {
    this.mhr = MathUtils_1.MathUtils.RangeClamp(t, 0, 1, this.dhr, this.Chr), Math.abs(this.phr - t) < 1e-6 || (this.Lhr(this.mhr), this.phr = t)
  }
  Thr() {
    if (3 === this.GetRenderingComponent().RenderType ? Log_1.Log.CheckDebug() && Log_1.Log.Debug("RenderCharacter", 25, "NpcEnableDither", ["CharName", this.GetRenderingComponent()?.GetCachedOwnerName()], ["Entity", this.GetRenderingComponent()?.GetCachedOwnerEntity()?.Id], ["Type", this.fhr]) : Log_1.Log.CheckInfo() && Log_1.Log.Info("RenderCharacter", 25, "CharacterEnableDither", ["CharName", this.GetRenderingComponent()?.GetCachedOwnerName()], ["Entity", this.GetRenderingComponent()?.GetCachedOwnerEntity()?.Id], ["Type", this.fhr]), this.MaterialContainer instanceof CharMaterialContainerV2_1.CharMaterialContainerV2)
      if (this.MaterialContainer.AddAlphaTestCount(0), 0 < this.Jxl.length)
        for (const t of this.Jxl) this.MaterialContainer.SetFloatUpdateParamPermanent(RenderConfig_1.RenderConfig.UseDitherEffect, 1, 0, 0, t);
      else this.MaterialContainer.SetFloatUpdateParamPermanent(RenderConfig_1.RenderConfig.UseDitherEffect, 1, 0, 0);
    else this.MaterialContainer instanceof CharMaterialContainer_1.CharMaterialContainer && (this.MaterialContainer.UseAlphaTestCommon(), this.MaterialContainer.SetFloat(RenderConfig_1.RenderConfig.UseDitherEffect, 1, 0, 0))
  }
  Lhr(t) {
    this.MaterialContainer instanceof CharMaterialContainerV2_1.CharMaterialContainerV2 ? (this.MaterialContainer.SetFloatUpdateParamPermanent(RenderConfig_1.RenderConfig.DitherValue, this.jO_ ? 1.2 : t, 0, 0), this.MaterialContainer.SetFloatUpdateParamPermanent(RenderConfig_1.RenderConfig.DitherValueMainPass, this.jO_ ? t : 1.2, 0, 0)) : this.MaterialContainer instanceof CharMaterialContainer_1.CharMaterialContainer && (this.MaterialContainer.SetFloat(RenderConfig_1.RenderConfig.DitherValue, this.jO_ ? 1.2 : t, 0, 0), this.MaterialContainer.SetFloat(RenderConfig_1.RenderConfig.DitherValueMainPass, this.jO_ ? t : 1.2, 0, 0))
  }
  Ihr() {
