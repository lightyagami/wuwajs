...
class PostProcessTriggerStateInsideToOutside extends PostProcessTriggerStateBase_1.default {
  ...
  OnUpdate(s) {
    ...
    if (this.Timer > this.Owner.TransitionTime) {
      ...
      this.Timer += s / 1000;
      s = MathUtils_1.MathUtils.Clamp(this.Timer / this.Owner.TransitionTime, 0, 1);
      t = this.GetTargetDefaultValue();
      this.Owner.GetPostProcessComponent().BlendWeight = MathUtils_1.MathUtils.Clamp(1 - s, 0, t);
    }
  }
}
