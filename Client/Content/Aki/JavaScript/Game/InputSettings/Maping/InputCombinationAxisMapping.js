...
class InputCombinationAxisMapping {
  ...
  AddKeyMap(t, i) {
    for (var [e, s] of i) {
      ...
      n || (n = [], i.set(e, n)), n.push(t), Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "[AddKeyMap]", ["mainKeyName", s], ["secondaryKeyName", e], ["MainKeySet", this.zEe]), this.zEe.add(s)
    }
  }
