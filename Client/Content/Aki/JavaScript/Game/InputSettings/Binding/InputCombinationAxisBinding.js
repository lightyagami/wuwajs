...
class InputCombinationAxisBinding {
  constructor() {
    this.Mne = 0, this.hEe = new Map, this.lEe = new Map, this.uEe = new Map, this.sEe = void 0, this.Lo = void 0, this.aEe = 0, this.mEe = void 0, this.Xih = 0, this.Yih = 0
  }
  Initialize(t) {
    this.Mne = t.Id, this.sEe = t.AxisName, this.Lo = t, this.aEe = this.Lo.AxisType, this.mEe = this.Lo.SecondaryKeyScaleMap;
  ...
  Clear() {
    this.hEe = void 0, this.lEe = void 0, this.uEe = void 0, this.sEe = void 0, this.aEe = 0, this.Lo = void 0, this.Xih = 0, this.Yih = 0
  }
  dEe() {
    this.hEe.clear(), this.lEe.clear();
    for (var [t, i] of this.uEe) {
      var s = InputSettings_1.InputSettings.GetKey(i);
      s && ((s.IsKeyboardKey || s.IsMouseButton) && this.hEe.set(t, i), s.IsGamepadKey) && this.lEe.set(t, i)
    }
  }
  GetAxisName() {
    return this.sEe
