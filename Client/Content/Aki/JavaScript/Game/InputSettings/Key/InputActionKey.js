...
class InputActionKey {
  constructor() {
    this.ActionName = "", this.IsAlt = !1, this.IsCmd = !1, this.IsCtrl = !1, this.IsShift = !1, this.KeyName = ""
  }
  static New(t, e, i, s, n, r) {
    var u = new InputActionKey;
    return u.ActionName = t, u.IsShift = e, u.IsCtrl = i, u.IsAlt = s, u.IsCmd = n, u.KeyName = r, u
  }
  static NewByInputActionKeyMapping(t) {
    var e = new InputActionKey;
    return e.ActionName = t.ActionName.toString(), e.IsShift = t.bShift, e.IsCtrl = t.bCtrl, e.IsAlt = t.bAlt, e.IsCmd = t.bCmd, e.KeyName = t.Key.KeyName.toString(), e
  }
