...
class InputSettingsManager {
  ...
  static set DeviceLang(t) {
    StringUtils_1.StringUtils.IsBlank(t) ? this.frh = "Default" : this.frh = t
  }
  static Initialize() {
    this.qEe = new InputActionMapping_1.InputActionMapping, this.qEe.Initialize(), this.GEe = new InputAxisMapping_1.InputAxisMapping, this.GEe.Initialize(), this.NEe = new InputCombinationActionMapping_1.InputCombinationActionMapping, this.OEe = new InputCombinationAxisMapping_1.InputCombinationAxisMapping, this.RefreshAllActionKeys(), this.RefreshAllAxisKeys(), this.dZa(), this.RefreshCombinationActionKeys(), this.RefreshCombinationAxisKeys(), this.ConvertInputActionSort(), this.psh(), this.vsh()
  }
  static Clear() {
    this.Xkn(), this.$kn(), this.CZa(), this.qEe.Clear(), this.qEe = void 0, this.GEe.Clear(), this.GEe = void 0, this.NEe.Clear(), this.NEe = void 0, this.OEe.Clear(), this.OEe = void 0
  }
  static get CheckUseFrenchKeyboard() {
    return "French" === InputSettings_1.InputSettings.GetKeyboardPrimaryLangId()
  }
  static gZa() {
    this.fZa.clear(), this.pZa.clear();
    for (const t of ConfigManager_1.ConfigManager.InputSettingsConfig.GetPcKeyConfigList()) StringUtils_1.StringUtils.IsBlank(t.FrenchKeyName) || (this.fZa.set(t.KeyName, t.FrenchKeyName), this.pZa.set(t.FrenchKeyName, t.KeyName))
  }
  static dZa() {
    var t;
    Platform_1.Platform.IsPcPlatform() ? (this.frh = InputSettings_1.InputSettings.GetKeyboardPrimaryLangId(), this.gZa(), t = (0, puerts_1.toManualReleaseDelegate)(InputSettingsManager.vZa), UE.KuroStaticLibrary.BindDeviceLangChangeDelegate(t)) : this.frh = "Default"
  }
  static CZa() {
    Platform_1.Platform.IsPcPlatform() && (UE.KuroStaticLibrary.UnBindDeviceLangChangeDelegate(), (0, puerts_1.releaseManualReleaseDelegate)(InputSettingsManager.vZa))
  }
  static yZa(t, i) {
    if ("French" === t) {
    ...
    for (const i of ConfigManager_1.ConfigManager.InputSettingsConfig.GetAllActionMappingConfig()) {
      ...
      if (!(n.Num() <= 0)) {
        ...
        for (let t = n.Num() - 1; 0 <= t; t--) {
          ...
          InputSettings_1.InputSettings.GetKey(s)?.IsKeyboardKey ? (i = !0, a.push(this.yZa(e, s))) : a.push(s)
        }
      ...
      if (!(n.Num() <= 0)) {
        ...
        for (let t = n.Num() - 1; 0 <= t; t--) {
          var s = n.Get(t),
            ...
            s = s.Scale;
          InputSettings_1.InputSettings.GetKey(o)?.IsKeyboardKey ? (i = !0, a.set(this.yZa(e, o), s)) : a.set(o, s)
        }
  ...
  static CheckGetActionKeyIconPath(t) {
    ...
    if (i) {
      ...
      Log_1.Log.CheckError() && Log_1.Log.Error("InputSettings", 10, "此按键配置了空的图标路径", ["KeyName", i.GetKeyName()])
    } else Log_1.Log.CheckError() && Log_1.Log.Error("InputSettings", 10, "Action找不到对应按键", ["ActionName", t.GetActionName()], ["KeyName", void 0])
  }
  ...
  static SetActionKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "设置Action按键", ["actionName", t]), this.qEe.SetKeys(t, i)
  }
  static RefreshActionKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "刷新Action按键", ["actionName", t]), this.qEe.RefreshKeysByActionMappings(t, i)
  }
  static AddActionKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "添加Action按键", ["actionName", t]), this.qEe.AddKeys(t, i)
  }
  static RemoveActionKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "删除按键", ["actionName", t]), this.qEe.RemoveKeys(t, i)
  }
  static RemoveActionKeysByCondition(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "删除Action中符合条件的按键映射", ["actionName", t]), this.qEe.RemoveKeysByCondition(t, i)
  }
  ...
  static CheckGetAxisKeyIconPath(t) {
    ...
    if (i) {
      var e = i.GetKeyIconPath();
      if (!StringUtils_1.StringUtils.IsEmpty(e)) return e;
      Log_1.Log.CheckError() && Log_1.Log.Error("InputSettings", 10, "此按键配置了空的图标路径", ["KeyName", i.KeyName])
    } else Log_1.Log.CheckError() && Log_1.Log.Error("InputSettings", 10, "Axis找不到对应按键", ["AxisName", t.GetAxisName()], ["KeyName", void 0])
  }
  static ContainAxisKeyByType(t, i) {
    for (const e of this.GEe.GetAxisBindingByAxisMappingType(t))
      if (e.HasKey(i)) return {
        IsContain: !0,
        ContainAxisBinding: e
      };
    return {
      IsContain: !1,
      ContainAxisBinding: void 0
    }
  }
  static SetAxisKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "设置Axis按键", ["axisName", t]), this.GEe.SetKeys(t, i)
  }
  static RefreshAxisKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "刷新Axis按键", ["axisName", t]), this.GEe.RefreshKeys(t, i)
  }
  static AddAxisKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "添加Axis按键", ["actionName", t]), this.GEe.AddKeys(t, i)
  }
  static RemoveAxisKeys(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "删除按键", ["axisName", t]), this.GEe.RemoveKeys(t, i)
  }
  static RemoveAxisKeysByCondition(t, i) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "删除Axis中符合条件的按键映射", ["axisName", t]), this.GEe.RemoveKeysByCondition(t, i)
  }
  static RefreshCombinationActionKeys(t = !1) {
    if (this.ClearCombinationActionKeyMap(), this.kEe.clear(), this.Ykn(), this.drh(), !t) {
      t = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.CombineAction, void 0);
      if (t && (this.kEe = t), this.kEe && 0 < this.kEe.size)
        for (var [i, e] of this.kEe)
          for (const s of e) {
            var n = this._Sl(i, s[0], s[1]),
              a = ConfigManager_1.ConfigManager.InputSettingsConfig.GetCombinationActionConfigByActionNameInList(i);
            a && (n?.SetKeyboardVersion(a.KeyboardVersion), n?.SetGamepadVersion(a.GamepadVersion))
          }
    }
  }
  static drh() {
    ...
    if (t)
      for (const o of t) {
        var i, e, n, a, s = o.ActionName;
        for ([i, e] of o.PcKeys) this.AddCombinationActionKeyMap(s, i, e)?.SetKeyboardVersion(o.KeyboardVersion);
        for ([n, a] of o.GamepadKeys) this.AddCombinationActionKeyMap(s, n, a)?.SetGamepadVersion(o.GamepadVersion)
      }
  }
  static SetCombinationActionKeyboardKeys(t, i) {
    var e = this.GetCombinationActionBindingByActionName(t);
    if (e) {
      var n, a, s, o, r = new Map;
      e.GetPcKeyNameMap(r);
      for ([n, a] of r) InputSettingsManager.RemoveCombinationActionKeyMap(t, n, a);
      for ([s, o] of i) InputSettingsManager.AddCombinationActionKeyMap(t, s, o);
      return e
    }
  }
  ...
  static ConvertInputActionSort() {
    var t = LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsConvertInputActionSort, !1);
    if (!t && this.qEe) {
      for (const i of (this.qEe?.GetActionBindingMap()).values()) i.ConvertSort();
      InputSettings_1.InputSettings.SaveKeyMappings(), LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsConvertInputActionSort, !0)
    }
  }
  static psh() {
    LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsConvertInput, !1) || (this.Msh(), LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsConvertInput, !0))
  }
  static vsh() {
    LocalStorage_1.LocalStorage.GetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsSavedKeyMappings, !1) || (InputSettings_1.InputSettings.SaveKeyMappings(), LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.IsSavedKeyMappings, !0))
  }
  static Msh() {
    var t, i = this.GetActionBinding(InputMappingsDefine_1.actionMappings.幻象2);
    i && i.HasKey("Gamepad_LeftTrigger") && (t = this.GetCombinationActionBindingByActionName(InputMappingsDefine_1.actionMappings.幻象2)) && t.HasKey("Gamepad_LeftShoulder", "Gamepad_FaceButton_Left") && (i.RemoveKeys(["Gamepad_LeftTrigger"]), (t = this.GetActionBinding(InputMappingsDefine_1.actionMappings.瞄准)) && !t.HasKey("Gamepad_LeftTrigger") && t.AddKeys(["Gamepad_LeftTrigger"]), i = this.GetCombinationActionBindingByActionName(InputMappingsDefine_1.actionMappings.瞄准)) && (t = new Map, i.GetGamepadKeyNameMap(t), "Gamepad_FaceButton_Left" === t.get("Gamepad_LeftShoulder")) && i.RemoveKey("Gamepad_LeftShoulder")
  }
  ...
  static _Sl(t, i, e) {
    var n, a = this.TryGetCombinationActionBinding(t);
    if (a) return (n = a.GetSecondaryKeyNameByMainKey(i)) && n !== e && (Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "组合键主键已存在,删除旧的组合键数据", ["ActionName", a.GetActionName()], ["mainKeyName", i], ["secondaryKeyName", n]), this.RemoveCombinationActionKeyMap(t, i, n)), this.FEe(t, i, e)
  }
  static FEe(t, i, e) {
    var n = this.TryGetCombinationActionBinding(t);
    if (n) return Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "添加组合键按键", ["ActionName", n.GetActionName()], ["mainKeyName", i], ["secondaryKeyName", e]), this.NEe?.AddKey(n, i, e), InputSettings_1.InputSettings.NewInputCombinationActionKey(n.GetActionName(), i, e), this.PrintCurrentCombinationActionBinding(t), n
  }
  ...
  static VEe(t, i, e) {
    ...
    t && (Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "删除组合键按键", ["ActionName", t.GetActionName()], ["RemoveMainKey", i], ["RemoveSecondaryKeyName", e]), this.NEe?.RemoveKey(t, i, e), InputSettings_1.InputSettings.RemoveCombinationActionMapping(t.GetActionName(), i, e))
  }
  ...
  static RefreshCombinationAxisKeys() {
    ...
    if (t)
      for (const i of t) this.OEe?.NewCombinationAxisBinding(i)
  }
  static mrh() {
    this.OEe?.Clear()
  }
  ...
  static GetActionKeyDisplayData(t, i) {
    ...
    if (e) {
      var n = new Map;
      if (e.GetCurrentPlatformKeyNameMap(n), n && 0 < n.size) return t.RefreshCombinationInput(i, n), !0
    }
    e = InputSettingsManager.GetActionBinding(i);
    if (e) {
      n = [];
      if (e.GetCurrentPlatformKeyNameList(n), 0 < n.length) return t.RefreshInput(i, n), !0
    }
    return !1
  }
  ...
  static zkn() {
    this.Zkn() || (this.eFn = TimerSystem_1.TimerSystem.Delay(() => {
      this.$kn() && this.Xkn()
    }, CHECK_COMBINATIONACTIONKEYMAP_SAVE_INTERVAL))
  }
  static Xkn() {
    void 0 !== this.eFn && (TimerSystem_1.TimerSystem.Remove(this.eFn), this.eFn = void 0)
  }
  static Zkn() {
    return void 0 !== this.eFn
  }
  static $kn() {
    return !(!this.Jkn || (LocalStorage_1.LocalStorage.SetGlobal(LocalStorageDefine_1.ELocalStorageGlobalKey.CombineAction, this.kEe), this.Jkn = !1))
  }
}
exports.InputSettingsManager = InputSettingsManager, (_a = InputSettingsManager).qEe = void 0, InputSettingsManager.GEe = void 0, InputSettingsManager.NEe = void 0, InputSettingsManager.OEe = void 0, InputSettingsManager.kEe = new Map, InputSettingsManager.Jkn = void 0, InputSettingsManager.eFn = void 0, InputSettingsManager.fZa = new Map, InputSettingsManager.pZa = new Map, InputSettingsManager.frh = "", InputSettingsManager.SkipGlobalSdkCheck = !1, InputSettingsManager.vZa = () => {
