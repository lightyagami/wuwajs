...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.EntityToLoadFilter = exports.LOADING_INTERVAL = exports.MAX_LOADING_ENTITY_COUNT = void 0;
...
class EntityToLoadFilter extends Filter_1.Filter {
  constructor() {
    super(...arguments), this.MOc = exports.MAX_LOADING_ENTITY_COUNT, this.EOc = exports.LOADING_INTERVAL, this.MaxLoadingDebugName = this.DebugName, this.LoadingIntervalDebugName = this.DebugName
  }
  get DebugName() {
  ...
  set MaxLoadingCount(t) {
    this.MOc !== t && (this.MOc = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.EntityToLoadParamUpdated, this))
  }
  get LoadingInterval() {
    return this.EOc
  }
  set LoadingInterval(t) {
    this.EOc !== t && (this.EOc = t, EventSystem_1.EventSystem.Emit(EventDefine_1.EEventName.EntityToLoadParamUpdated, this))
  }
  OnInit() {
