...
class PlayerSoarMonitorFilter extends EntityToLoadFilter_1.EntityToLoadFilter {
  constructor() {
    super(...arguments), this.ROc = e => {
      this.MaxLoadingCount = e ? SOAR_MAX_LOADING_ENTITY_COUNT : EntityToLoadFilter_1.MAX_LOADING_ENTITY_COUNT, this.LoadingInterval = e ? SOAR_LOADING_INTERVAL : EntityToLoadFilter_1.LOADING_INTERVAL
    }, this.qJl = e => {
  ...
  Init() {
    super.Init(), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.PlayerSoarChanged, this.ROc), EventSystem_1.EventSystem.Add(EventDefine_1.EEventName.SlowStreamingBySoar, this.qJl)
  }
  Cleanup() {
    EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.PlayerSoarChanged, this.ROc), EventSystem_1.EventSystem.Remove(EventDefine_1.EEventName.SlowStreamingBySoar, this.qJl), super.Cleanup()
  }
}
