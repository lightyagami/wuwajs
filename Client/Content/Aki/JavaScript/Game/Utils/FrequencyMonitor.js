...
class FrequencyMonitor {
  constructor(e, o, r, ...t) {
    this.Ql = e, this.t6 = o, this.vgr = r, this.OPt = void 0, this.Mgr = new Queue_1.Queue, this.OPt = t
  }
  Execute() {
    if (Info_1.Info.IsBuildDevelopmentOrDebug) {
      for (this.Mgr.Push(Time_1.Time.NowSeconds); !this.Mgr.Empty && Time_1.Time.NowSeconds - this.Mgr.Front > this.Ql;) this.Mgr.Pop();
      if (this.Mgr.Size > this.t6) {
        ...
        this.OPt && (e = e.concat(this.OPt)), Log_1.Log.CheckWarn() && Log_1.Log.Warn("FrequencyMonitor", 14, "业务逻辑执行频率过高", ...e);
        var o, r, t = {};
        for ([o, r] of e) t[o] = r;
