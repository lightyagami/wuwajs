...
class PortalUtils {
  ...
  static GetMappingPosByPortalTransform(t, r, a, i) {
    if (r && a) return r = r.InverseTransformPosition(t.ToUeVector()), t = PortalUtils.HWs.TransformPosition(r), r = a.TransformPosition(t), i.DeepCopy(r), i
  }
  static GetMappingVecByPortalTransform(t, r, a, i) {
    if (r && a) return r = r.InverseTransformVector(t.ToUeVector()), t = PortalUtils.HWs.TransformVector(r), r = a.TransformVector(t), i.DeepCopy(r), i
  }
  static GetMappingTransformToOtherPortal(t, r, a) {
    ...
    if (r && r.Portal1Enable && r.Portal2Enable) {
      var [a, r] = a ? [r.PortalWorldTransform1, r.PortalWorldTransform2] : [r.PortalWorldTransform2, r.PortalWorldTransform1];
      if (a && r) return PortalUtils.GetMappingTransformByPortalTransform(t, a, r)
    }
  }
  static GetMappingTransformByPortalTransform(t, r, a) {
    if (r && a && t) return t.GetRelativeTransform(r).op_Multiply(PortalUtils.HWs).op_Multiply(a)
  }
  static GetMappingOffsetTransformToOtherPortal(t, r, a, i = void 0, e = 0) {
    ...
    if (r && r.Portal1Enable && r.Portal2Enable) {
      var [a, r] = a ? [r.PortalWorldTransform1, r.PortalWorldTransform2] : [r.PortalWorldTransform2, r.PortalWorldTransform1];
      if (a && r) return PortalUtils.GetMappingOffsetTransformByPortalTransform(t, a, r, void 0, i, e)
    }
  }
  static GetMappingOffsetTransformByPortalTransform(t, r, a, i = Vector_1.Vector.DownVectorProxy, e = void 0, s = 200) {
