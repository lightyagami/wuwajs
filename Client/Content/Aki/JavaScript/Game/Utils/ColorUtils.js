...
const MAX_BYTE = 255;
class ColorUtils {}
(exports.ColorUtils = ColorUtils).LinearYellow = new UE.LinearColor(1, 1, 0, 0);
...
ColorUtils.LinearClear = new UE.LinearColor(0, 0, 0, 0);
ColorUtils.ColorWhile = new UE.Color(MAX_BYTE, MAX_BYTE, MAX_BYTE, MAX_BYTE);
ColorUtils.ColorBlack = new UE.Color(0, 0, 0, MAX_BYTE);
ColorUtils.ColorYellow = new UE.Color(MAX_BYTE, MAX_BYTE, 0, 0);
ColorUtils.ColorRed = new UE.Color(MAX_BYTE, 0, 0, 0); //# sourceMappingURL=ColorUtils.js.map