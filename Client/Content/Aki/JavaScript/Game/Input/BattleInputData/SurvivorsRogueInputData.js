...
class SurvivorsRogueInputData extends BattleInputData_1.BattleInputData {
  constructor() {
    super(...arguments);
    this.dYu = new Map([[InputMappingsDefine_1.actionMappings.技能1, InputEnums_1.EInputAction.技能1], [InputMappingsDefine_1.actionMappings.闪避, InputEnums_1.EInputAction.闪避], [InputMappingsDefine_1.actionMappings.走跑切换, InputEnums_1.EInputAction.走跑切换]]);
