...
class InputBlueprintFunctionLibrary extends UE.BlueprintFunctionLibrary {
  ...
  static GetCommandInterval(t, n = 1) {
    return (Global_1.Global.BaseCharacter?.GetEntityNoBlueprint()?.GetComponent(62))?.GetCommandInterval(t) ?? n
  }
  ...
  static GetAllInputDistributeTag() {
    ...
    for (const n of InputDistributeDefine_1.initializeInputDistributeTagDefine) t.Add(n.Tag);
    return t
  }
  static HasMoveAxisInput() {
    var t, n;
    return !(1 !== Info_1.Info.OperationType || !ModelManager_1.ModelManager.BattleUiModel?.IsPressJoyStick) || !!((t = ModelManager_1.ModelManager.InputModel?.GetAxisValues()) && ((n = t.get(InputEnums_1.EInputAxis.MoveForward)) || (t = t.get(InputEnums_1.EInputAxis.MoveRight)) || 0 !== n && 0 !== t && (n = Global_1.Global.BaseCharacter?.GetEntityNoBlueprint()?.GetComponent(62)) && (n.QueryInputAxis(InputEnums_1.EInputAxis.MoveForward) || n.QueryInputAxis(InputEnums_1.EInputAxis.MoveRight))))
  }
  static HasRightMoveAxisInput() {
    var t = ModelManager_1.ModelManager.InputModel?.GetAxisValues();
    return t && t.get(InputEnums_1.EInputAxis.MoveRight) || 0
  }
