...
class InputModel extends ModelBase_1.ModelBase {
  constructor() {
    super(...arguments), this.jMe = new Map([
      [2, 0],
      [3, 0],
      [4, 0],
      [5, 0],
      ...
      [9, 0],
      [10, 0]
    ]), this.WMe = new Array, this.KMe = new Map, this.QMe = new Map, this.whh = new Map, this.OnlyMoveForward = new Switcher_1.Switcher(!1), this.IsOpenInputAxisLog = !1, this.Ze_ = void 0, this.et_ = !1, this.eKa = !1
  }
  GetHandlers() {
    return this.WMe
  }
  ...
  AddInputHandler(t) {
    this.WMe.includes(t) || (this.WMe.push(t), this.WMe.sort((t, e) => e.GetPriority() - t.GetPriority()))
  }
  IsAxisBlock(t) {
    for (const e of this.WMe)
      if (e.GetInputFilter().BlockAxis(t)) return !0;
    return !1
  }
  RemoveInputHandler(t) {
    t = this.WMe.indexOf(t); - 1 !== t && this.WMe.splice(t, 1)
  }
  OnClear() {
  ...
  AddInputLayer(t, e) {
    ...
    s || (s = new InputLayer_1.InputLayerUnit, this.whh.set(t, s)), s.Add(e)
  }
  RemoveInputLayer(t) {
  ...
  GetInputCommandTransformData(t, e) {
    if (this.et_ || this.InitInputCommandTransformMap(), this.Ze_) return this.Ze_.get(t)?.get(e)
  }
  InitInputCommandTransformMap() {
    if (!this.et_) {
      this.et_ = !0;
      var t, e = new Map;
      for (const s of DataTableUtil_1.DataTableUtil.GetDataTableAllRow(23)) 0 !== s.Action && 0 !== s.State && "None" !== s.Tag.TagName && (e.has(s.Action) || e.set(s.Action, new Map), (t = e.get(s.Action)).has(s.State) ? t.get(s.State).push(s) : t.set(s.State, [s]));
      this.Ze_ = e
    }
  }
}
