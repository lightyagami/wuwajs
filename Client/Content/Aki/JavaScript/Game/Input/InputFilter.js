...
class InputFilter {
  constructor(t, i, e, s) {
    this.Actions = new Set(t), this.BlockActions = new Set(i), this.Axes = new Set(e), this.BlockAxes = new Set(s)
  }
  ListenToAction(t) {
  ...
  Union(t) {
    ...
    return SetUtility_1.SetUtility.AddToSet(i.Actions, t.Actions), SetUtility_1.SetUtility.AddToSet(i.BlockActions, t.BlockActions), SetUtility_1.SetUtility.AddToSet(i.Axes, t.Axes), SetUtility_1.SetUtility.AddToSet(i.BlockAxes, t.BlockAxes), i
  }
}
