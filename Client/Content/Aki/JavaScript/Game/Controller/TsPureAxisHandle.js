...
class TsPureAxisHandle {
  constructor() {
    this.R$e = void 0, this.sEe = void 0, this.fDa = void 0, this.pDa = void 0, this.ABo = i => {
  ...
  Initialize(i) {
    this.R$e = i, this.fDa = Stats_1.Stat.Create("TsPureAxisHandle.OnInputAxis", "", StatDefine_1.BATTLESTAT_GROUP)
  }
  Reset() {
    this.R$e = void 0, this.sEe = void 0, this.pDa = void 0
  }
  AddAxisBinding(i, t) {
    t ? (this.sEe = i, this.pDa = t, TsPureAxisHandle.bDa.includes(i) ? cpp_1.FKuroInputInterface.RegisterAxisBinding(FNameUtil_1.FNameUtil.GetDynamicFName(i), this.R$e, this, this.ABo) : cpp_1.FKuroInputInterface.RegisterAxisBinding(FNameUtil_1.FNameUtil.GetDynamicFName(i), this.R$e, this, this.BDa)) : Log_1.Log.CheckError() && Log_1.Log.Error("Controller", 10, "添加Axis输入绑定时，回调不存在", ["axisName", i])
  }
