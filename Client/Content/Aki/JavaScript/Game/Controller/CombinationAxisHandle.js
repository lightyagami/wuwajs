...
class CombinationAxisHandle {
  constructor() {
    this.Hde = void 0, this.PressMainKeyTimeStamp = 0, this.Jde = void 0, this.zde = !1, this.M7a = new Set
  }
  Clear() {
    this.Jde = void 0
  }
  PressAnyKey(t) {
    this.Hde || (InputSettingsManager_1.InputSettingsManager.IsCombinationAxisMainKey(t) ? this.Xde(t) : this.zde = !0)
  }
  ReleaseAnyKey(t) {
    this.Hde === t ? this.Yde() : this.zde = !1
  }
  Xde(t) {
    Log_1.Log.CheckInfo() && Log_1.Log.Info("InputSettings", 10, "[Input]按下组合Axis主键", ["MainKeyName", t]), this.Hde = t, this.PressMainKeyTimeStamp = TimeUtil_1.TimeUtil.GetServerTimeStamp(), this.Jde = InputSettingsManager_1.InputSettingsManager.GetCombinationAxisBindingMapByMainKeyName(t)
  }
  Yde() {
    ...
    if (!this.zde && this.Jde && !(this.Jde.size <= 0)) {
      ...
      if (Info_1.Info.AxisInputOptimize) {
        ...
        for (var [i, o] of this.Jde) {
          ...
          for (const p of o) {
            var n, a = p.GetAxisName();
            a && !this.M7a.has(a) && (0 !== r && this.M7a.add(a), n = r * p.GetSourceAxisValue(i), ControllerHolder_1.ControllerHolder.InputDistributeController.InputAxis(a, n))
          }
        }
      } else
