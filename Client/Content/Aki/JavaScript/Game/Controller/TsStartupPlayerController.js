...
exports.TsStartupPlayerController = undefined;
...
class TsStartupPlayerController extends TsBasePlayerController_1.TsBasePlayerController {
  ...
  BindActionHandle() {
    ...
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘G手柄特右);
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘X手柄特左);
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘U手柄左摇杆);
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘G手柄右摇杆);
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘Y手柄特右);
    this.AddActionHandle(InputMappingsDefine_1.actionMappings.UI键盘H手柄特左);
  ...
  BindAxisHandle() {
    ...
    this.AddAxisHandle(InputMappingsDefine_1.axisMappings.NavigationLeftRight);
...
exports.default = TsStartupPlayerController; //# sourceMappingURL=TsStartupPlayerController.js.map